...
newAccountCount 
    ::  AccountCount
newAccountCount = AccountCount {account = Core.Nothing, count = Core.Nothing}

instance Core.FromJSON AccountCount where
        parseJSON
          = Core.withObject "AccountCount"
              (\ o ->
                 AccountCount Core.<$>
                   (o Core..:? "account") Core.<*>
                     (o Core..:? "count" Core.<&>
...
newAccountCountError 
    ::  AccountCountError
newAccountCountError =
  AccountCountError {account = Core.Nothing, errorType = Core.Nothing}

instance Core.FromJSON AccountCountError where
        parseJSON
          = Core.withObject "AccountCountError"
              (\ o ->
                 AccountCountError Core.<$>
                   (o Core..:? "account") Core.<*>
                     (o Core..:? "errorType"))
...
newAddHeldAccountResult 
    ::  AddHeldAccountResult
newAddHeldAccountResult =
  AddHeldAccountResult {account = Core.Nothing, status = Core.Nothing}

instance Core.FromJSON AddHeldAccountResult where
        parseJSON
          = Core.withObject "AddHeldAccountResult"
              (\ o ->
                 AddHeldAccountResult Core.<$>
                   (o Core..:? "account") Core.<*>
                     (o Core..:? "status"))
...
newAddHeldAccountsRequest 
    ::  AddHeldAccountsRequest
newAddHeldAccountsRequest =
  AddHeldAccountsRequest {accountIds = Core.Nothing, emails = Core.Nothing}

instance Core.FromJSON AddHeldAccountsRequest where
        parseJSON
          = Core.withObject "AddHeldAccountsRequest"
              (\ o ->
                 AddHeldAccountsRequest Core.<$>
                   (o Core..:? "accountIds") Core.<*>
                     (o Core..:? "emails"))
...
newAddHeldAccountsResponse 
    ::  AddHeldAccountsResponse
newAddHeldAccountsResponse = AddHeldAccountsResponse {responses = Core.Nothing}

instance Core.FromJSON AddHeldAccountsResponse where
        parseJSON
          = Core.withObject "AddHeldAccountsResponse"
              (\ o ->
                 AddHeldAccountsResponse Core.<$>
                   (o Core..:? "responses"))
...
instance Core.FromJSON AddMatterPermissionsRequest
         where
        parseJSON
          = Core.withObject "AddMatterPermissionsRequest"
              (\ o ->
                 AddMatterPermissionsRequest Core.<$>
                   (o Core..:? "ccMe") Core.<*>
                     (o Core..:? "matterPermission")
                     Core.<*> (o Core..:? "sendEmails"))

instance Core.ToJSON AddMatterPermissionsRequest
         where
        toJSON AddMatterPermissionsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("ccMe" Core..=) Core.<$> ccMe,
                  ("matterPermission" Core..=) Core.<$>
                    matterPermission,
...
instance Core.FromJSON CloseMatterRequest where
        parseJSON
          = Core.withObject "CloseMatterRequest"
...
instance Core.FromJSON CloseMatterResponse where
        parseJSON
          = Core.withObject "CloseMatterResponse"
              (\ o ->
                 CloseMatterResponse Core.<$> (o Core..:? "matter"))

instance Core.ToJSON CloseMatterResponse where
        toJSON CloseMatterResponse{..}
          = Core.object
              (Core.catMaybes [("matter" Core..=) Core.<$> matter])
...
data CloudStorageFile = CloudStorageFile
    {
      -- | The name of the Cloud Storage bucket for the export file. You can use this value in the <https://cloud.google.com/storage/docs/apis Cloud Storage JSON or XML APIs>, but not to list the bucket contents. Instead, you can <https://cloud.google.com/storage/docs/json_api/v1/objects/get get individual export files> by object name.
      bucketName :: (Core.Maybe Core.Text)
      -- | The md5 hash of the file.
    , md5Hash :: (Core.Maybe Core.Text)
      -- | The name of the Cloud Storage object for the export file. You can use this value in the <https://cloud.google.com/storage/docs/apis Cloud Storage JSON or XML APIs>.
...
instance Core.FromJSON CloudStorageFile where
        parseJSON
          = Core.withObject "CloudStorageFile"
              (\ o ->
                 CloudStorageFile Core.<$>
...
instance Core.FromJSON CloudStorageSink where
        parseJSON
          = Core.withObject "CloudStorageSink"
              (\ o ->
...
instance Core.FromJSON CorpusQuery where
        parseJSON
          = Core.withObject "CorpusQuery"
              (\ o ->
                 CorpusQuery Core.<$>
                   (o Core..:? "driveQuery") Core.<*>
                     (o Core..:? "groupsQuery")
...
instance Core.FromJSON CountArtifactsMetadata where
        parseJSON
          = Core.withObject "CountArtifactsMetadata"
              (\ o ->
                 CountArtifactsMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*>
                     (o Core..:? "matterId")
                     Core.<*> (o Core..:? "query")
...
instance Core.FromJSON CountArtifactsRequest where
        parseJSON
          = Core.withObject "CountArtifactsRequest"
              (\ o ->
                 CountArtifactsRequest Core.<$>
                   (o Core..:? "query") Core.<*> (o Core..:? "view"))
...
instance Core.FromJSON CountArtifactsResponse where
        parseJSON
          = Core.withObject "CountArtifactsResponse"
              (\ o ->
                 CountArtifactsResponse Core.<$>
                   (o Core..:? "groupsCountResult") Core.<*>
                     (o Core..:? "mailCountResult")
                     Core.<*>
...
newDriveExportOptions 
    ::  DriveExportOptions
newDriveExportOptions = DriveExportOptions {includeAccessInfo = Core.Nothing}

instance Core.FromJSON DriveExportOptions where
        parseJSON
          = Core.withObject "DriveExportOptions"
              (\ o ->
                 DriveExportOptions Core.<$>
                   (o Core..:? "includeAccessInfo"))

instance Core.ToJSON DriveExportOptions where
        toJSON DriveExportOptions{..}
          = Core.object
              (Core.catMaybes
                 [("includeAccessInfo" Core..=) Core.<$>
                    includeAccessInfo])
...
instance Core.FromJSON DriveOptions where
        parseJSON
          = Core.withObject "DriveOptions"
              (\ o ->
                 DriveOptions Core.<$>
                   (o Core..:? "clientSideEncryptedOption") Core.<*>
                     (o Core..:? "includeSharedDrives")
...
instance Core.ToJSON DriveOptions where
        toJSON DriveOptions{..}
          = Core.object
              (Core.catMaybes
                 [("clientSideEncryptedOption" Core..=) Core.<$>
                    clientSideEncryptedOption,
                  ("includeSharedDrives" Core..=) Core.<$>
                    includeSharedDrives,
                  ("includeTeamDrives" Core..=) Core.<$>
                    includeTeamDrives,
...
instance Core.FromJSON Export where
        parseJSON
          = Core.withObject "Export"
              (\ o ->
                 Export Core.<$>
                   (o Core..:? "cloudStorageSink") Core.<*>
                     (o Core..:? "createTime")
...
instance Core.FromJSON ExportOptions where
        parseJSON
          = Core.withObject "ExportOptions"
              (\ o ->
                 ExportOptions Core.<$>
                   (o Core..:? "driveOptions") Core.<*>
                     (o Core..:? "groupsOptions")
...
instance Core.FromJSON ExportStats where
        parseJSON
          = Core.withObject "ExportStats"
              (\ o ->
                 ExportStats Core.<$>
                   (o Core..:? "exportedArtifactCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "sizeInBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalArtifactCount" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON ExportStats where
        toJSON ExportStats{..}
          = Core.object
              (Core.catMaybes
                 [("exportedArtifactCount" Core..=) Core.. Core.AsText
                    Core.<$> exportedArtifactCount,
                  ("sizeInBytes" Core..=) Core.. Core.AsText Core.<$>
                    sizeInBytes,
                  ("totalArtifactCount" Core..=) Core.. Core.AsText
...
instance Core.FromJSON GroupsCountResult where
        parseJSON
          = Core.withObject "GroupsCountResult"
              (\ o ->
                 GroupsCountResult Core.<$>
                   (o Core..:? "accountCountErrors") Core.<*>
                     (o Core..:? "accountCounts")
                     Core.<*>
                     (o Core..:? "matchingAccountsCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "nonQueryableAccounts")
                     Core.<*>
                     (o Core..:? "queriedAccountsCount" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON GroupsCountResult where
        toJSON GroupsCountResult{..}
          = Core.object
              (Core.catMaybes
                 [("accountCountErrors" Core..=) Core.<$>
                    accountCountErrors,
                  ("accountCounts" Core..=) Core.<$> accountCounts,
                  ("matchingAccountsCount" Core..=) Core.. Core.AsText
                    Core.<$> matchingAccountsCount,
                  ("nonQueryableAccounts" Core..=) Core.<$>
                    nonQueryableAccounts,
                  ("queriedAccountsCount" Core..=) Core.. Core.AsText
...
newGroupsExportOptions 
    ::  GroupsExportOptions
newGroupsExportOptions = GroupsExportOptions {exportFormat = Core.Nothing}

instance Core.FromJSON GroupsExportOptions where
        parseJSON
          = Core.withObject "GroupsExportOptions"
              (\ o ->
                 GroupsExportOptions Core.<$>
                   (o Core..:? "exportFormat"))
...
instance Core.FromJSON HangoutsChatExportOptions
         where
        parseJSON
          = Core.withObject "HangoutsChatExportOptions"
              (\ o ->
                 HangoutsChatExportOptions Core.<$>
                   (o Core..:? "exportFormat"))
...
instance Core.FromJSON HangoutsChatInfo where
        parseJSON
          = Core.withObject "HangoutsChatInfo"
              (\ o ->
...
instance Core.ToJSON HangoutsChatInfo where
        toJSON HangoutsChatInfo{..}
          = Core.object
              (Core.catMaybes [("roomId" Core..=) Core.<$> roomId])
...
newHangoutsChatOptions 
    ::  HangoutsChatOptions
newHangoutsChatOptions = HangoutsChatOptions {includeRooms = Core.Nothing}

instance Core.FromJSON HangoutsChatOptions where
        parseJSON
          = Core.withObject "HangoutsChatOptions"
              (\ o ->
                 HangoutsChatOptions Core.<$>
                   (o Core..:? "includeRooms"))
...
instance Core.ToJSON HangoutsChatOptions where
        toJSON HangoutsChatOptions{..}
          = Core.object
              (Core.catMaybes
                 [("includeRooms" Core..=) Core.<$> includeRooms])
...
instance Core.FromJSON HeldDriveQuery where
        parseJSON
          = Core.withObject "HeldDriveQuery"
              (\ o ->
                 HeldDriveQuery Core.<$>
                   (o Core..:? "includeSharedDriveFiles") Core.<*>
                     (o Core..:? "includeTeamDriveFiles"))

instance Core.ToJSON HeldDriveQuery where
        toJSON HeldDriveQuery{..}
          = Core.object
              (Core.catMaybes
                 [("includeSharedDriveFiles" Core..=) Core.<$>
                    includeSharedDriveFiles,
                  ("includeTeamDriveFiles" Core..=) Core.<$>
...
newHeldGroupsQuery =
  HeldGroupsQuery
    {endTime = Core.Nothing, startTime = Core.Nothing, terms = Core.Nothing}

instance Core.FromJSON HeldGroupsQuery where
        parseJSON
          = Core.withObject "HeldGroupsQuery"
              (\ o ->
                 HeldGroupsQuery Core.<$>
                   (o Core..:? "endTime") Core.<*>
                     (o Core..:? "startTime")
                     Core.<*> (o Core..:? "terms"))
...
newHeldHangoutsChatQuery 
    ::  HeldHangoutsChatQuery
newHeldHangoutsChatQuery = HeldHangoutsChatQuery {includeRooms = Core.Nothing}

instance Core.FromJSON HeldHangoutsChatQuery where
        parseJSON
          = Core.withObject "HeldHangoutsChatQuery"
              (\ o ->
                 HeldHangoutsChatQuery Core.<$>
                   (o Core..:? "includeRooms"))
...
newHeldOrgUnit 
    ::  HeldOrgUnit
newHeldOrgUnit = HeldOrgUnit {holdTime = Core.Nothing, orgUnitId = Core.Nothing}

instance Core.FromJSON HeldOrgUnit where
        parseJSON
          = Core.withObject "HeldOrgUnit"
              (\ o ->
                 HeldOrgUnit Core.<$>
                   (o Core..:? "holdTime") Core.<*>
                     (o Core..:? "orgUnitId"))
...
instance Core.FromJSON HeldVoiceQuery where
        parseJSON
          = Core.withObject "HeldVoiceQuery"
              (\ o ->
...
instance Core.ToJSON HeldVoiceQuery where
        toJSON HeldVoiceQuery{..}
          = Core.object
              (Core.catMaybes
                 [("coveredData" Core..=) Core.<$> coveredData])
...
instance Core.FromJSON Hold where
        parseJSON
          = Core.withObject "Hold"
              (\ o ->
                 Hold Core.<$>
                   (o Core..:? "accounts") Core.<*>
                     (o Core..:? "corpus")
                     Core.<*> (o Core..:? "holdId")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "orgUnit")
...
newListExportsResponse 
    ::  ListExportsResponse
newListExportsResponse =
  ListExportsResponse {exports = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListExportsResponse where
        parseJSON
          = Core.withObject "ListExportsResponse"
              (\ o ->
...
newListHeldAccountsResponse 
    ::  ListHeldAccountsResponse
newListHeldAccountsResponse = ListHeldAccountsResponse {accounts = Core.Nothing}

instance Core.FromJSON ListHeldAccountsResponse where
        parseJSON
          = Core.withObject "ListHeldAccountsResponse"
              (\ o ->
                 ListHeldAccountsResponse Core.<$>
                   (o Core..:? "accounts"))
...
newListHoldsResponse 
    ::  ListHoldsResponse
newListHoldsResponse =
  ListHoldsResponse {holds = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListHoldsResponse where
        parseJSON
          = Core.withObject "ListHoldsResponse"
              (\ o ->
                 ListHoldsResponse Core.<$>
                   (o Core..:? "holds") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListMattersResponse 
    ::  ListMattersResponse
newListMattersResponse =
  ListMattersResponse {matters = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListMattersResponse where
        parseJSON
          = Core.withObject "ListMattersResponse"
              (\ o ->
                 ListMattersResponse Core.<$>
                   (o Core..:? "matters") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListSavedQueriesResponse =
  ListSavedQueriesResponse
    {nextPageToken = Core.Nothing, savedQueries = Core.Nothing}
...
instance Core.FromJSON MailCountResult where
        parseJSON
          = Core.withObject "MailCountResult"
              (\ o ->
                 MailCountResult Core.<$>
                   (o Core..:? "accountCountErrors") Core.<*>
                     (o Core..:? "accountCounts")
                     Core.<*>
                     (o Core..:? "matchingAccountsCount" Core.<&>
...
instance Core.FromJSON MailExportOptions where
        parseJSON
          = Core.withObject "MailExportOptions"
              (\ o ->
                 MailExportOptions Core.<$>
                   (o Core..:? "exportFormat") Core.<*>
                     (o Core..:? "showConfidentialModeContent")
...
instance Core.ToJSON MailExportOptions where
        toJSON MailExportOptions{..}
          = Core.object
              (Core.catMaybes
                 [("exportFormat" Core..=) Core.<$> exportFormat,
                  ("showConfidentialModeContent" Core..=) Core.<$>
...
newMailOptions =
  MailOptions
    {clientSideEncryptedOption = Core.Nothing, excludeDrafts = Core.Nothing}

instance Core.FromJSON MailOptions where
        parseJSON
          = Core.withObject "MailOptions"
              (\ o ->
                 MailOptions Core.<$>
                   (o Core..:? "clientSideEncryptedOption") Core.<*>
                     (o Core..:? "excludeDrafts"))
...
instance Core.FromJSON MatterPermission where
        parseJSON
          = Core.withObject "MatterPermission"
              (\ o ->
                 MatterPermission Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "role"))
...
instance Core.FromJSON OrgUnitInfo where
        parseJSON
          = Core.withObject "OrgUnitInfo"
              (\ o ->
                 OrgUnitInfo Core.<$> (o Core..:? "orgUnitId"))
...
instance Core.FromJSON RemoveHeldAccountsRequest
         where
        parseJSON
          = Core.withObject "RemoveHeldAccountsRequest"
              (\ o ->
                 RemoveHeldAccountsRequest Core.<$>
                   (o Core..:? "accountIds"))
...
instance Core.FromJSON RemoveHeldAccountsResponse
         where
        parseJSON
          = Core.withObject "RemoveHeldAccountsResponse"
              (\ o ->
                 RemoveHeldAccountsResponse Core.<$>
                   (o Core..:? "statuses"))
...
instance Core.FromJSON RemoveMatterPermissionsRequest
         where
        parseJSON
          = Core.withObject "RemoveMatterPermissionsRequest"
              (\ o ->
                 RemoveMatterPermissionsRequest Core.<$>
                   (o Core..:? "accountId"))

instance Core.ToJSON RemoveMatterPermissionsRequest
         where
...
instance Core.FromJSON ReopenMatterRequest where
        parseJSON
          = Core.withObject "ReopenMatterRequest"
...
newReopenMatterResponse 
    ::  ReopenMatterResponse
newReopenMatterResponse = ReopenMatterResponse {matter = Core.Nothing}

instance Core.FromJSON ReopenMatterResponse where
        parseJSON
          = Core.withObject "ReopenMatterResponse"
              (\ o ->
                 ReopenMatterResponse Core.<$> (o Core..:? "matter"))
...
instance Core.FromJSON SharedDriveInfo where
        parseJSON
          = Core.withObject "SharedDriveInfo"
              (\ o ->
                 SharedDriveInfo Core.<$>
                   (o Core..:? "sharedDriveIds"))
...
instance Core.ToJSON TeamDriveInfo where
        toJSON TeamDriveInfo{..}
          = Core.object
              (Core.catMaybes
                 [("teamDriveIds" Core..=) Core.<$> teamDriveIds])
...
instance Core.FromJSON UndeleteMatterRequest where
        parseJSON
          = Core.withObject "UndeleteMatterRequest"
...
newUserInfo 
    ::  UserInfo
newUserInfo = UserInfo {displayName = Core.Nothing, email = Core.Nothing}
...
newVoiceExportOptions 
    ::  VoiceExportOptions
newVoiceExportOptions = VoiceExportOptions {exportFormat = Core.Nothing}

instance Core.FromJSON VoiceExportOptions where
        parseJSON
          = Core.withObject "VoiceExportOptions"
              (\ o ->
                 VoiceExportOptions Core.<$>
                   (o Core..:? "exportFormat"))
