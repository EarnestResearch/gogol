                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ListUptimeCheckIpsResponse
...
instance Core.GoogleRequest
           MonitoringUptimeCheckIpsList
         where
        type Rs MonitoringUptimeCheckIpsList =
             ListUptimeCheckIpsResponse
        type Scopes MonitoringUptimeCheckIpsList =
        ...
        requestClient MonitoringUptimeCheckIpsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringUptimeCheckIpsListResource)
                      Core.mempty
