                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] UptimeCheckConfig Core.:>
                         Core.Patch '[Core.JSON] UptimeCheckConfig
...
instance Core.GoogleRequest
           MonitoringProjectsUptimeCheckConfigsPatch
         where
        type Rs MonitoringProjectsUptimeCheckConfigsPatch =
             UptimeCheckConfig
        type Scopes MonitoringProjectsUptimeCheckConfigsPatch
             =
