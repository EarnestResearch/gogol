...
newAggregation 
    ::  Aggregation
newAggregation
  = Aggregation{alignmentPeriod = Core.Nothing,
                crossSeriesReducer = Core.Nothing, groupByFields = Core.Nothing,
...
newAlertPolicy 
    ::  AlertPolicy
newAlertPolicy
  = AlertPolicy{alertStrategy = Core.Nothing,
                combiner = Core.Nothing, conditions = Core.Nothing,
                creationRecord = Core.Nothing, displayName = Core.Nothing,
                documentation = Core.Nothing, enabled = Core.Nothing,
                mutationRecord = Core.Nothing, name = Core.Nothing,
                notificationChannels = Core.Nothing, severity = Core.Nothing,
                userLabels = Core.Nothing, validity = Core.Nothing}
instance Core.FromJSON AlertPolicy where
        parseJSON
          = Core.withObject "AlertPolicy"
              (\ o ->
                 AlertPolicy Core.<$>
                   (o Core..:? "alertStrategy") Core.<*> (o Core..:? "combiner")
...
newAlertStrategy 
    ::  AlertStrategy
newAlertStrategy
  = AlertStrategy{autoClose = Core.Nothing,
              ...
              (\ o ->
                 AlertStrategy Core.<$>
                   (o Core..:? "autoClose") Core.<*>
                     (o Core..:? "notificationChannelStrategy")
          ...
          = Core.object
              (Core.catMaybes
                 [("autoClose" Core..=) Core.<$> autoClose,
                  ("notificationChannelStrategy" Core..=) Core.<$>
                    notificationChannelStrategy,
...
newBasicAuthentication 
    ::  BasicAuthentication
newBasicAuthentication
  = BasicAuthentication{password = Core.Nothing,
          ...
          = Core.withObject "BasicAuthentication"
              (\ o ->
                 BasicAuthentication Core.<$>
                   (o Core..:? "password") Core.<*> (o Core..:? "username"))
...
newBasicService 
    ::  BasicService
newBasicService
  = BasicService{serviceLabels = Core.Nothing,
                 serviceType = Core.Nothing}
instance Core.FromJSON BasicService where
        parseJSON
          = Core.withObject "BasicService"
              (\ o ->
                 BasicService Core.<$>
                   (o Core..:? "serviceLabels") Core.<*> (o Core..:? "serviceType"))
...
instance Core.FromJSON BasicService_ServiceLabels where
        parseJSON
          = Core.withObject "BasicService_ServiceLabels"
              (\ o ->
...
newBasicSli 
    ::  BasicSli
newBasicSli
  = BasicSli{availability = Core.Nothing, latency = Core.Nothing,
             location = Core.Nothing, method = Core.Nothing,
...
instance Core.FromJSON BasicSli where
        parseJSON
          = Core.withObject "BasicSli"
              (\ o ->
                 BasicSli Core.<$>
                   (o Core..:? "availability") Core.<*> (o Core..:? "latency")
...
newCloudFunctionV2Target 
    ::  CloudFunctionV2Target
newCloudFunctionV2Target
  = CloudFunctionV2Target{cloudRunRevision = Core.Nothing,
                          name = Core.Nothing}
instance Core.FromJSON CloudFunctionV2Target where
        parseJSON
          = Core.withObject "CloudFunctionV2Target"
              (\ o ->
                 CloudFunctionV2Target Core.<$>
                   (o Core..:? "cloudRunRevision") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON CloudRun where
        parseJSON
          = Core.withObject "CloudRun"
              (\ o ->
                 CloudRun Core.<$>
                   (o Core..:? "location") Core.<*> (o Core..:? "serviceName"))
...
newClusterIstio 
    ::  ClusterIstio
newClusterIstio
  = ClusterIstio{clusterName = Core.Nothing, location = Core.Nothing,
                 serviceName = Core.Nothing, serviceNamespace = Core.Nothing}
instance Core.FromJSON ClusterIstio where
        parseJSON
          = Core.withObject "ClusterIstio"
              (\ o ->
                 ClusterIstio Core.<$>
                   (o Core..:? "clusterName") Core.<*> (o Core..:? "location")
...
newCollectdPayload 
    ::  CollectdPayload
newCollectdPayload
  = CollectdPayload{endTime = Core.Nothing, metadata = Core.Nothing,
                    plugin = Core.Nothing, pluginInstance = Core.Nothing,
                    startTime = Core.Nothing, type' = Core.Nothing,
                    typeInstance = Core.Nothing, values = Core.Nothing}
instance Core.FromJSON CollectdPayload where
        parseJSON
          = Core.withObject "CollectdPayload"
              (\ o ->
                 CollectdPayload Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "metadata") Core.<*>
                     (o Core..:? "plugin")
...
newCollectdPayloadError 
    ::  CollectdPayloadError
newCollectdPayloadError
  = CollectdPayloadError{error = Core.Nothing, index = Core.Nothing,
          ...
          = Core.withObject "CollectdPayloadError"
              (\ o ->
                 CollectdPayloadError Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "index") Core.<*>
                     (o Core..:? "valueErrors"))
...
newCollectdValue 
    ::  CollectdValue
newCollectdValue
  = CollectdValue{dataSourceName = Core.Nothing,
                  dataSourceType = Core.Nothing, value = Core.Nothing}
...
newCondition 
    ::  Condition
newCondition
  = Condition{conditionAbsent = Core.Nothing,
              ...
              conditionSql = Core.Nothing, conditionThreshold = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("conditionAbsent" Core..=) Core.<$> conditionAbsent,
                  ...
                  ("conditionPrometheusQueryLanguage" Core..=) Core.<$>
...
newContentMatcher 
    ::  ContentMatcher
newContentMatcher
  = ContentMatcher{content = Core.Nothing,
                   jsonPathMatcher = Core.Nothing, matcher = Core.Nothing}
instance Core.FromJSON ContentMatcher where
        parseJSON
          = Core.withObject "ContentMatcher"
              (\ o ->
                 ContentMatcher Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "jsonPathMatcher")
                     Core.<*> (o Core..:? "matcher"))
...
newCreateCollectdTimeSeriesRequest 
    :: 
                                   CreateCollectdTimeSeriesRequest
newCreateCollectdTimeSeriesRequest
  = CreateCollectdTimeSeriesRequest{collectdPayloads = Core.Nothing,
                                    collectdVersion = Core.Nothing, resource = Core.Nothing}
          ...
          = Core.withObject "CreateCollectdTimeSeriesRequest"
              (\ o ->
                 CreateCollectdTimeSeriesRequest Core.<$>
                   (o Core..:? "collectdPayloads") Core.<*>
                     (o Core..:? "collectdVersion")
...
newCreateCollectdTimeSeriesResponse 
    :: 
                                    CreateCollectdTimeSeriesResponse
newCreateCollectdTimeSeriesResponse
  = CreateCollectdTimeSeriesResponse{payloadErrors = Core.Nothing,
          ...
          = Core.withObject "CreateCollectdTimeSeriesResponse"
              (\ o ->
                 CreateCollectdTimeSeriesResponse Core.<$>
                   (o Core..:? "payloadErrors") Core.<*> (o Core..:? "summary"))
...
newCreateTimeSeriesSummary 
    ::  CreateTimeSeriesSummary
newCreateTimeSeriesSummary
  = CreateTimeSeriesSummary{errors = Core.Nothing,
                            successPointCount = Core.Nothing, totalPointCount = Core.Nothing}
instance Core.FromJSON CreateTimeSeriesSummary where
        parseJSON
          = Core.withObject "CreateTimeSeriesSummary"
              (\ o ->
                 CreateTimeSeriesSummary Core.<$>
                   (o Core..:? "errors") Core.<*> (o Core..:? "successPointCount")
...
instance Core.FromJSON Criteria where
        parseJSON
          = Core.withObject "Criteria"
              (\ o ->
                 Criteria Core.<$>
                   (o Core..:? "filter") Core.<*> (o Core..:? "policies"))
...
instance Core.FromJSON Daily where
        parseJSON
          = Core.withObject "Daily"
              (\ o ->
                 Daily Core.<$>
                   (o Core..:? "executionTime") Core.<*> (o Core..:? "periodicity"))
...
newDistribution 
    ::  Distribution
newDistribution
  = Distribution{bucketCounts = Core.Nothing,
                 bucketOptions = Core.Nothing, count = Core.Nothing,
                 exemplars = Core.Nothing, mean = Core.Nothing,
                 range = Core.Nothing, sumOfSquaredDeviation = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("bucketCounts" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                  ...
                  ("mean" Core..=) Core.<$> mean, ("range" Core..=) Core.<$> range,
...
newDistributionCut 
    ::  DistributionCut
newDistributionCut
  = DistributionCut{distributionFilter = Core.Nothing,
                    range = Core.Nothing}
          ...
          = Core.withObject "DistributionCut"
              (\ o ->
                 DistributionCut Core.<$>
                   (o Core..:? "distributionFilter") Core.<*> (o Core..:? "range"))
...
newDocumentation 
    ::  Documentation
newDocumentation
  = Documentation{content = Core.Nothing, links = Core.Nothing,
                  mimeType = Core.Nothing, subject = Core.Nothing}
instance Core.FromJSON Documentation where
        parseJSON
          = Core.withObject "Documentation"
              (\ o ->
                 Documentation Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "links") Core.<*>
                     (o Core..:? "mimeType")
                     Core.<*> (o Core..:? "subject"))
...
instance Core.FromJSON Error' where
        parseJSON
          = Core.withObject "Error'"
              (\ o ->
                 Error' Core.<$>
                   (o Core..:? "pointCount") Core.<*> (o Core..:? "status"))
...
newExemplar 
    ::  Exemplar
newExemplar
  = Exemplar{attachments = Core.Nothing, timestamp = Core.Nothing,
             value = Core.Nothing}
instance Core.FromJSON Exemplar where
        parseJSON
          = Core.withObject "Exemplar"
              (\ o ->
                 Exemplar Core.<$>
                   (o Core..:? "attachments") Core.<*> (o Core..:? "timestamp")
                     Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON ForecastOptions where
        parseJSON
          = Core.withObject "ForecastOptions"
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GetNotificationChannelVerificationCodeRequest"
              (\ o ->
                 GetNotificationChannelVerificationCodeRequest Core.<$>
                   (o Core..:? "expireTime"))

instance Core.ToJSON GetNotificationChannelVerificationCodeRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GetNotificationChannelVerificationCodeResponse"
              (\ o ->
                 GetNotificationChannelVerificationCodeResponse Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "expireTime"))

instance Core.ToJSON GetNotificationChannelVerificationCodeResponse
         where
...
newGkeNamespace 
    ::  GkeNamespace
newGkeNamespace
  = GkeNamespace{clusterName = Core.Nothing, location = Core.Nothing,
                 namespaceName = Core.Nothing, projectId = Core.Nothing}
instance Core.FromJSON GkeNamespace where
        parseJSON
          = Core.withObject "GkeNamespace"
              (\ o ->
                 GkeNamespace Core.<$>
                   (o Core..:? "clusterName") Core.<*> (o Core..:? "location")
...
newGkeService 
    ::  GkeService
newGkeService
  = GkeService{clusterName = Core.Nothing, location = Core.Nothing,
               namespaceName = Core.Nothing, projectId = Core.Nothing,
               serviceName = Core.Nothing}
instance Core.FromJSON GkeService where
        parseJSON
          = Core.withObject "GkeService"
              (\ o ->
                 GkeService Core.<$>
                   (o Core..:? "clusterName") Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "namespaceName")
          ...
          = Core.object
              (Core.catMaybes
                 [("clusterName" Core..=) Core.<$> clusterName,
                  ...
                  ("topLevelControllerType" Core..=) Core.<$>
...
newGroup 
    ::  Group
newGroup
  = Group{displayName = Core.Nothing, filter = Core.Nothing,
          isCluster = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Group where
        parseJSON
          = Core.withObject "Group"
              (\ o ->
                 Group Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "filter") Core.<*>
                     (o Core..:? "isCluster")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON Hourly where
        parseJSON
          = Core.withObject "Hourly"
              (\ o ->
                 Hourly Core.<$>
                   (o Core..:? "minuteOffset") Core.<*> (o Core..:? "periodicity"))
...
newHttpCheck 
    ::  HttpCheck
newHttpCheck
  = HttpCheck{acceptedResponseStatusCodes = Core.Nothing,
              authInfo = Core.Nothing, body = Core.Nothing,
              contentType = Core.Nothing, customContentType = Core.Nothing,
              headers = Core.Nothing, maskHeaders = Core.Nothing,
              path = Core.Nothing, pingConfig = Core.Nothing,
              port = Core.Nothing, requestMethod = Core.Nothing,
              serviceAgentAuthentication = Core.Nothing, useSsl = Core.Nothing,
...
instance Core.FromJSON HttpCheck where
        parseJSON
          = Core.withObject "HttpCheck"
              (\ o ->
                 HttpCheck Core.<$>
                   (o Core..:? "acceptedResponseStatusCodes") Core.<*>
                     (o Core..:? "authInfo")
                     Core.<*> (o Core..:? "body")
...
instance Core.ToJSON HttpCheck where
        toJSON HttpCheck{..}
          = Core.object
              (Core.catMaybes
                 [("acceptedResponseStatusCodes" Core..=) Core.<$>
                  ...
                  ("serviceAgentAuthentication" Core..=) Core.<$>
                    serviceAgentAuthentication,
...
newInternalChecker 
    ::  InternalChecker
newInternalChecker
  = InternalChecker{displayName = Core.Nothing,
                    gcpZone = Core.Nothing, name = Core.Nothing,
                    network = Core.Nothing, peerProjectId = Core.Nothing,
                    state = Core.Nothing}
          ...
          = Core.withObject "InternalChecker"
              (\ o ->
                 InternalChecker Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "gcpZone") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "network")
...
newIstioCanonicalService 
    ::  IstioCanonicalService
newIstioCanonicalService
  = IstioCanonicalService{canonicalService = Core.Nothing,
                          canonicalServiceNamespace = Core.Nothing, meshUid = Core.Nothing}
...
newJsonPathMatcher 
    ::  JsonPathMatcher
newJsonPathMatcher
  = JsonPathMatcher{jsonMatcher = Core.Nothing,
                    jsonPath = Core.Nothing}
instance Core.FromJSON JsonPathMatcher where
        parseJSON
          = Core.withObject "JsonPathMatcher"
              (\ o ->
                 JsonPathMatcher Core.<$>
                   (o Core..:? "jsonMatcher") Core.<*> (o Core..:? "jsonPath"))
...
newLabelValue 
    ::  LabelValue
newLabelValue
  = LabelValue{boolValue = Core.Nothing, int64Value = Core.Nothing,
...
instance Core.FromJSON Link where
        parseJSON
          = Core.withObject "Link"
              (\ o ->
                 Link Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "url"))
...
newListAlertPoliciesResponse 
    ::  ListAlertPoliciesResponse
newListAlertPoliciesResponse
  = ListAlertPoliciesResponse{alertPolicies = Core.Nothing,
          ...
          = Core.withObject "ListAlertPoliciesResponse"
              (\ o ->
                 ListAlertPoliciesResponse Core.<$>
                   (o Core..:? "alertPolicies") Core.<*> (o Core..:? "nextPageToken")
          ...
          = Core.withObject "ListGroupMembersResponse"
              (\ o ->
                 ListGroupMembersResponse Core.<$>
                   (o Core..:? "members") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
...
newListGroupsResponse 
    ::  ListGroupsResponse
newListGroupsResponse
  = ListGroupsResponse{group' = Core.Nothing,
          ...
          = Core.withObject "ListGroupsResponse"
              (\ o ->
                 ListGroupsResponse Core.<$>
                   (o Core..:? "group") Core.<*> (o Core..:? "nextPageToken"))
...
newListMetricDescriptorsResponse 
    ::  ListMetricDescriptorsResponse
newListMetricDescriptorsResponse
  = ListMetricDescriptorsResponse{metricDescriptors = Core.Nothing,
                                  nextPageToken = Core.Nothing}
...
newListNotificationChannelDescriptorsResponse
  = ListNotificationChannelDescriptorsResponse{channelDescriptors =
                                                 Core.Nothing,
                                               nextPageToken = Core.Nothing}
instance Core.FromJSON ListNotificationChannelDescriptorsResponse
         where
        parseJSON
          = Core.withObject "ListNotificationChannelDescriptorsResponse"
              (\ o ->
                 ListNotificationChannelDescriptorsResponse Core.<$>
                   (o Core..:? "channelDescriptors") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListNotificationChannelDescriptorsResponse
         where
...
newListNotificationChannelsResponse 
    :: 
                                    ListNotificationChannelsResponse
newListNotificationChannelsResponse
  = ListNotificationChannelsResponse{nextPageToken = Core.Nothing,
                                     notificationChannels = Core.Nothing, totalSize = Core.Nothing}
...
newListServiceLevelObjectivesResponse 
    :: 
                                      ListServiceLevelObjectivesResponse
newListServiceLevelObjectivesResponse
  = ListServiceLevelObjectivesResponse{nextPageToken = Core.Nothing,
                                       serviceLevelObjectives = Core.Nothing}
instance Core.FromJSON ListServiceLevelObjectivesResponse where
        parseJSON
          = Core.withObject "ListServiceLevelObjectivesResponse"
              (\ o ->
                 ListServiceLevelObjectivesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "serviceLevelObjectives"))
...
newListSnoozesResponse 
    ::  ListSnoozesResponse
newListSnoozesResponse
  = ListSnoozesResponse{nextPageToken = Core.Nothing,
                        snoozes = Core.Nothing}
instance Core.FromJSON ListSnoozesResponse where
        parseJSON
          = Core.withObject "ListSnoozesResponse"
              (\ o ->
                 ListSnoozesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "snoozes"))
...
newListTimeSeriesResponse 
    ::  ListTimeSeriesResponse
newListTimeSeriesResponse
  = ListTimeSeriesResponse{executionErrors = Core.Nothing,
                           nextPageToken = Core.Nothing, timeSeries = Core.Nothing,
                           unit = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListTimeSeriesResponse where
        parseJSON
          = Core.withObject "ListTimeSeriesResponse"
              (\ o ->
                 ListTimeSeriesResponse Core.<$>
                   (o Core..:? "executionErrors") Core.<*>
                     (o Core..:? "nextPageToken")
...
newListUptimeCheckConfigsResponse 
    ::  ListUptimeCheckConfigsResponse
newListUptimeCheckConfigsResponse
  = ListUptimeCheckConfigsResponse{nextPageToken = Core.Nothing,
                                   totalSize = Core.Nothing, uptimeCheckConfigs = Core.Nothing}
...
newListUptimeCheckIpsResponse 
    ::  ListUptimeCheckIpsResponse
newListUptimeCheckIpsResponse
  = ListUptimeCheckIpsResponse{nextPageToken = Core.Nothing,
...
instance Core.FromJSON LogMatch where
        parseJSON
          = Core.withObject "LogMatch"
              (\ o ->
                 LogMatch Core.<$>
                   (o Core..:? "filter") Core.<*> (o Core..:? "labelExtractors"))
...
newMeshIstio 
    ::  MeshIstio
newMeshIstio
  = MeshIstio{meshUid = Core.Nothing, serviceName = Core.Nothing,
...
instance Core.FromJSON MeshIstio where
        parseJSON
          = Core.withObject "MeshIstio"
              (\ o ->
                 MeshIstio Core.<$>
                   (o Core..:? "meshUid") Core.<*> (o Core..:? "serviceName") Core.<*>
                     (o Core..:? "serviceNamespace"))
...
newMetricAbsence 
    ::  MetricAbsence
newMetricAbsence
  = MetricAbsence{aggregations = Core.Nothing,
                  duration = Core.Nothing, filter = Core.Nothing,
...
instance Core.FromJSON MetricAbsence where
        parseJSON
          = Core.withObject "MetricAbsence"
              (\ o ->
                 MetricAbsence Core.<$>
                   (o Core..:? "aggregations") Core.<*> (o Core..:? "duration")
                     Core.<*> (o Core..:? "filter")
                     Core.<*> (o Core..:? "trigger"))
...
instance Core.FromJSON MetricRange where
        parseJSON
          = Core.withObject "MetricRange"
              (\ o ->
                 MetricRange Core.<$>
                   (o Core..:? "range") Core.<*> (o Core..:? "timeSeries"))
...
newMetricThreshold 
    ::  MetricThreshold
newMetricThreshold
  = MetricThreshold{aggregations = Core.Nothing,
                    comparison = Core.Nothing, denominatorAggregations = Core.Nothing,
                    denominatorFilter = Core.Nothing, duration = Core.Nothing,
                    evaluationMissingData = Core.Nothing, filter = Core.Nothing,
                    forecastOptions = Core.Nothing, thresholdValue = Core.Nothing,
                    trigger = Core.Nothing}
          ...
          = Core.withObject "MetricThreshold"
              (\ o ->
                 MetricThreshold Core.<$>
                   (o Core..:? "aggregations") Core.<*> (o Core..:? "comparison")
...
newMonitoringQueryLanguageCondition 
    :: 
                                    MonitoringQueryLanguageCondition
newMonitoringQueryLanguageCondition
  = MonitoringQueryLanguageCondition{duration = Core.Nothing,
                                     evaluationMissingData = Core.Nothing, query = Core.Nothing,
                                     trigger = Core.Nothing}
...
newMutationRecord 
    ::  MutationRecord
newMutationRecord
  = MutationRecord{mutateTime = Core.Nothing,
...
instance Core.FromJSON MutationRecord where
        parseJSON
          = Core.withObject "MutationRecord"
              (\ o ->
                 MutationRecord Core.<$>
                   (o Core..:? "mutateTime") Core.<*> (o Core..:? "mutatedBy"))
...
newNotificationChannel 
    ::  NotificationChannel
newNotificationChannel
  = NotificationChannel{creationRecord = Core.Nothing,
                        description = Core.Nothing, displayName = Core.Nothing,
                        enabled = Core.Nothing, labels = Core.Nothing,
                        mutationRecords = Core.Nothing, name = Core.Nothing,
                        type' = Core.Nothing, userLabels = Core.Nothing,
          ...
          = Core.withObject "NotificationChannel"
              (\ o ->
                 NotificationChannel Core.<$>
                   (o Core..:? "creationRecord") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "enabled")
                     Core.<*> (o Core..:? "labels")
...
newNotificationChannelDescriptor 
    ::  NotificationChannelDescriptor
newNotificationChannelDescriptor
  = NotificationChannelDescriptor{description = Core.Nothing,
                                  displayName = Core.Nothing, labels = Core.Nothing,
                                  launchStage = Core.Nothing, name = Core.Nothing,
                                  supportedTiers = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON NotificationChannelStrategy where
        parseJSON
          = Core.withObject "NotificationChannelStrategy"
              (\ o ->
                 NotificationChannelStrategy Core.<$>
                   (o Core..:? "notificationChannelNames") Core.<*>
                     (o Core..:? "renotifyInterval"))

instance Core.ToJSON NotificationChannelStrategy where
        toJSON NotificationChannelStrategy{..}
          = Core.object
              (Core.catMaybes
                 [("notificationChannelNames" Core..=) Core.<$>
...
newPerformanceThreshold 
    ::  PerformanceThreshold
newPerformanceThreshold
  = PerformanceThreshold{basicSliPerformance = Core.Nothing,
                         performance = Core.Nothing, threshold = Core.Nothing}
...
instance Core.FromJSON Point where
        parseJSON
          = Core.withObject "Point"
              (\ o ->
                 Point Core.<$>
                   (o Core..:? "interval") Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON PointData where
        parseJSON
          = Core.withObject "PointData"
              (\ o ->
                 PointData Core.<$>
                   (o Core..:? "timeInterval") Core.<*> (o Core..:? "values"))
...
newPrometheusQueryLanguageCondition 
    :: 
                                    PrometheusQueryLanguageCondition
newPrometheusQueryLanguageCondition
  = PrometheusQueryLanguageCondition{alertRule = Core.Nothing,
                                     disableMetricValidation = Core.Nothing,
                                     duration = Core.Nothing, evaluationInterval = Core.Nothing,
                                     labels = Core.Nothing, query = Core.Nothing,
                                     ruleGroup = Core.Nothing}
instance Core.FromJSON PrometheusQueryLanguageCondition where
        parseJSON
          = Core.withObject "PrometheusQueryLanguageCondition"
              (\ o ->
                 PrometheusQueryLanguageCondition Core.<$>
                   (o Core..:? "alertRule") Core.<*>
                     (o Core..:? "disableMetricValidation")
                     Core.<*> (o Core..:? "duration")
          ...
          = Core.object
              (Core.catMaybes
                 [("alertRule" Core..=) Core.<$> alertRule,
                  ("disableMetricValidation" Core..=) Core.<$>
...
instance Core.FromJSON PrometheusQueryLanguageCondition_Labels
         where
        parseJSON
          = Core.withObject "PrometheusQueryLanguageCondition_Labels"
              (\ o ->
                 PrometheusQueryLanguageCondition_Labels Core.<$>
                   (Core.parseJSONObject o))
...
newQueryTimeSeriesRequest 
    ::  QueryTimeSeriesRequest
newQueryTimeSeriesRequest
  = QueryTimeSeriesRequest{pageSize = Core.Nothing,
                           pageToken = Core.Nothing, query = Core.Nothing}
...
newQueryTimeSeriesResponse 
    ::  QueryTimeSeriesResponse
newQueryTimeSeriesResponse
  = QueryTimeSeriesResponse{nextPageToken = Core.Nothing,
                            partialErrors = Core.Nothing, timeSeriesData = Core.Nothing,
          ...
          = Core.withObject "QueryTimeSeriesResponse"
              (\ o ->
                 QueryTimeSeriesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "partialErrors")
...
newRequestBasedSli 
    ::  RequestBasedSli
newRequestBasedSli
  = RequestBasedSli{distributionCut = Core.Nothing,
...
newResourceGroup 
    ::  ResourceGroup
newResourceGroup
  = ResourceGroup{groupId = Core.Nothing,
...
instance Core.FromJSON ResourceGroup where
        parseJSON
          = Core.withObject "ResourceGroup"
              (\ o ->
                 ResourceGroup Core.<$>
                   (o Core..:? "groupId") Core.<*> (o Core..:? "resourceType"))
...
newResponseStatusCode 
    ::  ResponseStatusCode
newResponseStatusCode
  = ResponseStatusCode{statusClass = Core.Nothing,
                       statusValue = Core.Nothing}
instance Core.FromJSON ResponseStatusCode where
        parseJSON
          = Core.withObject "ResponseStatusCode"
              (\ o ->
                 ResponseStatusCode Core.<$>
                   (o Core..:? "statusClass") Core.<*> (o Core..:? "statusValue"))
...
instance Core.FromJSON RowCountTest where
        parseJSON
          = Core.withObject "RowCountTest"
              (\ o ->
                 RowCountTest Core.<$>
                   (o Core..:? "comparison") Core.<*>
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "SendNotificationChannelVerificationCodeRequest"
              (\ o -> Core.pure SendNotificationChannelVerificationCodeRequest)

instance Core.ToJSON SendNotificationChannelVerificationCodeRequest
         where
        toJSON = Core.const Core.emptyObject
...
newService 
    ::  Service
newService
  = Service{appEngine = Core.Nothing, basicService = Core.Nothing,
            cloudEndpoints = Core.Nothing, cloudRun = Core.Nothing,
            clusterIstio = Core.Nothing, custom = Core.Nothing,
            displayName = Core.Nothing, gkeNamespace = Core.Nothing,
            gkeService = Core.Nothing, gkeWorkload = Core.Nothing,
            istioCanonicalService = Core.Nothing, meshIstio = Core.Nothing,
            name = Core.Nothing, telemetry = Core.Nothing,
            userLabels = Core.Nothing}
instance Core.FromJSON Service where
        parseJSON
          = Core.withObject "Service"
              (\ o ->
                 Service Core.<$>
                   (o Core..:? "appEngine") Core.<*> (o Core..:? "basicService")
...
instance Core.FromJSON ServiceAgentAuthentication where
        parseJSON
          = Core.withObject "ServiceAgentAuthentication"
...
newServiceLevelIndicator 
    ::  ServiceLevelIndicator
newServiceLevelIndicator
  = ServiceLevelIndicator{basicSli = Core.Nothing,
                          requestBased = Core.Nothing, windowsBased = Core.Nothing}
instance Core.FromJSON ServiceLevelIndicator where
        parseJSON
          = Core.withObject "ServiceLevelIndicator"
              (\ o ->
                 ServiceLevelIndicator Core.<$>
                   (o Core..:? "basicSli") Core.<*> (o Core..:? "requestBased")
...
newServiceLevelObjective 
    ::  ServiceLevelObjective
newServiceLevelObjective
  = ServiceLevelObjective{calendarPeriod = Core.Nothing,
                          displayName = Core.Nothing, goal = Core.Nothing,
                          name = Core.Nothing, rollingPeriod = Core.Nothing,
                          serviceLevelIndicator = Core.Nothing, userLabels = Core.Nothing}
instance Core.FromJSON ServiceLevelObjective where
        parseJSON
          = Core.withObject "ServiceLevelObjective"
              (\ o ->
                 ServiceLevelObjective Core.<$>
                   (o Core..:? "calendarPeriod") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "goal")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("calendarPeriod" Core..=) Core.<$> calendarPeriod,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("goal" Core..=) Core.<$> goal, ("name" Core..=) Core.<$> name,
...
newSnooze 
    ::  Snooze
newSnooze
  = Snooze{criteria = Core.Nothing, displayName = Core.Nothing,
           interval = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON Snooze where
        parseJSON
          = Core.withObject "Snooze"
              (\ o ->
                 Snooze Core.<$>
                   (o Core..:? "criteria") Core.<*> (o Core..:? "displayName")
...
newSqlCondition 
    ::  SqlCondition
newSqlCondition
  = SqlCondition{booleanTest = Core.Nothing, daily = Core.Nothing,
                 hourly = Core.Nothing, minutes = Core.Nothing,
                 query = Core.Nothing, rowCountTest = Core.Nothing}
instance Core.FromJSON SqlCondition where
        parseJSON
          = Core.withObject "SqlCondition"
              (\ o ->
                 SqlCondition Core.<$>
                   (o Core..:? "booleanTest") Core.<*> (o Core..:? "daily") Core.<*>
                     (o Core..:? "hourly")
                     Core.<*> (o Core..:? "minutes")
                     Core.<*> (o Core..:? "query")
...
instance Core.FromJSON SyntheticMonitorTarget where
        parseJSON
          = Core.withObject "SyntheticMonitorTarget"
              (\ o ->
...
instance Core.FromJSON TcpCheck where
        parseJSON
          = Core.withObject "TcpCheck"
              (\ o ->
                 TcpCheck Core.<$>
                   (o Core..:? "pingConfig") Core.<*> (o Core..:? "port"))
...
newTimeSeries 
    ::  TimeSeries
newTimeSeries
  = TimeSeries{description = Core.Nothing, metadata = Core.Nothing,
               metric = Core.Nothing, metricKind = Core.Nothing,
               points = Core.Nothing, resource = Core.Nothing,
               unit = Core.Nothing, valueType = Core.Nothing}
instance Core.FromJSON TimeSeries where
        parseJSON
          = Core.withObject "TimeSeries"
              (\ o ->
                 TimeSeries Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "metric")
                     Core.<*> (o Core..:? "metricKind")
                     Core.<*> (o Core..:? "points")
                     Core.<*> (o Core..:? "resource")
...
newTimeSeriesData 
    ::  TimeSeriesData
newTimeSeriesData
  = TimeSeriesData{labelValues = Core.Nothing,
...
instance Core.FromJSON TimeSeriesData where
        parseJSON
          = Core.withObject "TimeSeriesData"
              (\ o ->
                 TimeSeriesData Core.<$>
                   (o Core..:? "labelValues") Core.<*> (o Core..:? "pointData"))
...
newTimeSeriesDescriptor 
    ::  TimeSeriesDescriptor
newTimeSeriesDescriptor
  = TimeSeriesDescriptor{labelDescriptors = Core.Nothing,
          ...
          = Core.withObject "TimeSeriesDescriptor"
              (\ o ->
                 TimeSeriesDescriptor Core.<$>
                   (o Core..:? "labelDescriptors") Core.<*>
                     (o Core..:? "pointDescriptors"))
...
newTimeSeriesRatio 
    ::  TimeSeriesRatio
newTimeSeriesRatio
  = TimeSeriesRatio{badServiceFilter = Core.Nothing,
...
newTypedValue 
    ::  TypedValue
newTypedValue
  = TypedValue{boolValue = Core.Nothing,
               distributionValue = Core.Nothing, doubleValue = Core.Nothing,
...
instance Core.FromJSON TypedValue where
        parseJSON
          = Core.withObject "TypedValue"
              (\ o ->
                 TypedValue Core.<$>
                   (o Core..:? "boolValue") Core.<*> (o Core..:? "distributionValue")
...
newUptimeCheckConfig 
    ::  UptimeCheckConfig
newUptimeCheckConfig
  = UptimeCheckConfig{checkerType = Core.Nothing,
                      contentMatchers = Core.Nothing, disabled = Core.Nothing,
                      displayName = Core.Nothing, httpCheck = Core.Nothing,
                      internalCheckers = Core.Nothing, isInternal = Core.Nothing,
                      logCheckFailures = Core.Nothing, monitoredResource = Core.Nothing,
                      name = Core.Nothing, period = Core.Nothing,
                      resourceGroup = Core.Nothing, selectedRegions = Core.Nothing,
                      syntheticMonitor = Core.Nothing, tcpCheck = Core.Nothing,
                      timeout = Core.Nothing, userLabels = Core.Nothing}
instance Core.FromJSON UptimeCheckConfig where
        parseJSON
          = Core.withObject "UptimeCheckConfig"
              (\ o ->
                 UptimeCheckConfig Core.<$>
                   (o Core..:? "checkerType") Core.<*> (o Core..:? "contentMatchers")
          ...
          = Core.object
              (Core.catMaybes
                 [("checkerType" Core..=) Core.<$> checkerType,
                  ...
                  ("name" Core..=) Core.<$> name, ("period" Core..=) Core.<$> period,
...
instance Core.FromJSON UptimeCheckConfig_UserLabels where
        parseJSON
          = Core.withObject "UptimeCheckConfig_UserLabels"
              (\ o ->
...
newUptimeCheckIp 
    ::  UptimeCheckIp
newUptimeCheckIp
  = UptimeCheckIp{ipAddress = Core.Nothing, location = Core.Nothing,
                  region = Core.Nothing}
instance Core.FromJSON UptimeCheckIp where
        parseJSON
          = Core.withObject "UptimeCheckIp"
              (\ o ->
                 UptimeCheckIp Core.<$>
                   (o Core..:? "ipAddress") Core.<*> (o Core..:? "location") Core.<*>
                     (o Core..:? "region"))
...
newValueDescriptor 
    ::  ValueDescriptor
newValueDescriptor
  = ValueDescriptor{key = Core.Nothing, metricKind = Core.Nothing,
                    unit = Core.Nothing, valueType = Core.Nothing}
          ...
          = Core.withObject "ValueDescriptor"
              (\ o ->
                 ValueDescriptor Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "metricKind") Core.<*>
                     (o Core..:? "unit")
                     Core.<*> (o Core..:? "valueType"))
...
newWindowsBasedSli 
    ::  WindowsBasedSli
newWindowsBasedSli
  = WindowsBasedSli{goodBadMetricFilter = Core.Nothing,
                    goodTotalRatioThreshold = Core.Nothing,
                    metricMeanInRange = Core.Nothing, metricSumInRange = Core.Nothing,
