...
instance Core.FromJSON BasicService_ServiceLabels
         where
        parseJSON
          = Core.withObject "BasicService_ServiceLabels"
              (\ o ->
                 BasicService_ServiceLabels Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON ForecastOptions where
        parseJSON
          = Core.withObject "ForecastOptions"
              (\ o ->
                 ForecastOptions Core.<$>
                   (o Core..:? "forecastHorizon"))

instance Core.ToJSON ForecastOptions where
        toJSON ForecastOptions{..}
          = Core.object
              (Core.catMaybes
                 [("forecastHorizon" Core..=) Core.<$>
                    forecastHorizon])
          ...
          = Core.object
              (Core.catMaybes
                 [("clusterName" Core..=) Core.<$> clusterName,
                  ...
                  ("namespaceName" Core..=) Core.<$> namespaceName,
                  ("projectId" Core..=) Core.<$> projectId,
                  ("topLevelControllerName" Core..=) Core.<$>
...
newHttpCheck_Headers 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> HttpCheck_Headers
newHttpCheck_Headers additional = HttpCheck_Headers {additional = additional}
...
newMetric_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Metric_Labels
newMetric_Labels additional = Metric_Labels {additional = additional}
...
newNotificationChannelStrategy =
  NotificationChannelStrategy
    {notificationChannelNames = Core.Nothing, renotifyInterval = Core.Nothing}

instance Core.FromJSON NotificationChannelStrategy
         where
        parseJSON
...
instance Core.ToJSON NotificationChannelStrategy
         where
...
newService_UserLabels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Service_UserLabels
newService_UserLabels additional = Service_UserLabels {additional = additional}
...
instance Core.FromJSON UptimeCheckConfig_UserLabels
         where
        parseJSON
          = Core.withObject "UptimeCheckConfig_UserLabels"
              (\ o ->
                 UptimeCheckConfig_UserLabels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON UptimeCheckConfig_UserLabels
         where
