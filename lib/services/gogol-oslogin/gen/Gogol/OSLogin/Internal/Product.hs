...
newImportSshPublicKeyResponse 
    ::  ImportSshPublicKeyResponse
newImportSshPublicKeyResponse
  = ImportSshPublicKeyResponse{details = Core.Nothing,
                               loginProfile = Core.Nothing}
instance Core.FromJSON ImportSshPublicKeyResponse where
        parseJSON
          = Core.withObject "ImportSshPublicKeyResponse"
              (\ o ->
                 ImportSshPublicKeyResponse Core.<$>
                   (o Core..:? "details") Core.<*> (o Core..:? "loginProfile"))
...
newLoginProfile 
    ::  LoginProfile
newLoginProfile
  = LoginProfile{name = Core.Nothing, posixAccounts = Core.Nothing,
                 sshPublicKeys = Core.Nothing}
instance Core.FromJSON LoginProfile where
        parseJSON
          = Core.withObject "LoginProfile"
              (\ o ->
                 LoginProfile Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "posixAccounts") Core.<*>
                     (o Core..:? "sshPublicKeys"))
...
instance Core.FromJSON LoginProfile_SshPublicKeys where
        parseJSON
          = Core.withObject "LoginProfile_SshPublicKeys"
              (\ o ->
...
newPosixAccount 
    ::  PosixAccount
newPosixAccount
  = PosixAccount{accountId = Core.Nothing, gecos = Core.Nothing,
                 gid = Core.Nothing, homeDirectory = Core.Nothing,
                 name = Core.Nothing, operatingSystemType = Core.Nothing,
                 primary = Core.Nothing, shell = Core.Nothing,
                 systemId = Core.Nothing, uid = Core.Nothing,
                 username = Core.Nothing}
instance Core.FromJSON PosixAccount where
        parseJSON
          = Core.withObject "PosixAccount"
              (\ o ->
                 PosixAccount Core.<$>
...
data SshPublicKey = SshPublicKey
    ...
    , fingerprint :: (Core.Maybe Core.Text)
      -- | Required. Public key text in SSH format, defined by <https://www.ietf.org/rfc/rfc4253.txt RFC4253> section 6.6.
