...
type OSLoginUsersImportSshPublicKeyResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "importSshPublicKey"
         Core.Text
         Core.:>
                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] SshPublicKey Core.:>
                         Core.Post '[Core.JSON] ImportSshPublicKeyResponse
...
instance Core.GoogleRequest
           OSLoginUsersImportSshPublicKey
         where
        type Rs OSLoginUsersImportSshPublicKey =
             ImportSshPublicKeyResponse
        type Scopes OSLoginUsersImportSshPublicKey =
