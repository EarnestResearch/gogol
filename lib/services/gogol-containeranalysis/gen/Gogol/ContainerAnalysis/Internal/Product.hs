...
newArtifact 
    ::  Artifact
newArtifact
  = Artifact{checksum = Core.Nothing, id = Core.Nothing,
             names = Core.Nothing}
instance Core.FromJSON Artifact where
        parseJSON
          = Core.withObject "Artifact"
              (\ o ->
                 Artifact Core.<$>
                   (o Core..:? "checksum") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "names"))
          ...
          = Core.object
              (Core.catMaybes
                 [("checksum" Core..=) Core.<$> checksum,
                  ("id" Core..=) Core.<$> id, ("names" Core..=) Core.<$> names])
...
newAssessment 
    ::  Assessment
newAssessment
  = Assessment{cve = Core.Nothing, impacts = Core.Nothing,
               justification = Core.Nothing, longDescription = Core.Nothing,
               relatedUris = Core.Nothing, remediations = Core.Nothing,
               shortDescription = Core.Nothing, state = Core.Nothing,
...
instance Core.FromJSON Assessment where
        parseJSON
          = Core.withObject "Assessment"
              (\ o ->
                 Assessment Core.<$>
                   (o Core..:? "cve") Core.<*> (o Core..:? "impacts") Core.<*>
                     (o Core..:? "justification")
          ...
          = Core.object
              (Core.catMaybes
                 [("cve" Core..=) Core.<$> cve,
                  ...
                  ("vulnerabilityId" Core..=) Core.<$> vulnerabilityId])
...
instance Core.ToJSON AttestationNote where
        toJSON AttestationNote{..}
          = Core.object (Core.catMaybes [("hint" Core..=) Core.<$> hint])
...
newAttestationOccurrence 
    ::  AttestationOccurrence
newAttestationOccurrence
  = AttestationOccurrence{jwts = Core.Nothing,
                          serializedPayload = Core.Nothing, signatures = Core.Nothing}
instance Core.FromJSON AttestationOccurrence where
        parseJSON
          = Core.withObject "AttestationOccurrence"
              (\ o ->
                 AttestationOccurrence Core.<$>
                   (o Core..:? "jwts") Core.<*> (o Core..:? "serializedPayload")
...
instance Core.ToJSON AttestationOccurrence where
        toJSON AttestationOccurrence{..}
          = Core.object
              (Core.catMaybes
                 [("jwts" Core..=) Core.<$> jwts,
                  ("serializedPayload" Core..=) Core.<$> serializedPayload,
                  ("signatures" Core..=) Core.<$> signatures])


-- | BaseImage describes a base image of a container image.
--
-- /See:/ 'newBaseImage' smart constructor.
data BaseImage = BaseImage
    {
      -- | The number of layers that the base image is composed of.
      layerCount :: (Core.Maybe Core.Int32)
...
-- | Creates a value of 'BaseImage' with the minimum fields required to make a request.
newBaseImage 
    ::  BaseImage
newBaseImage
  = BaseImage{layerCount = Core.Nothing, name = Core.Nothing,
              repository = Core.Nothing}
instance Core.FromJSON BaseImage where
        parseJSON
          = Core.withObject "BaseImage"
              (\ o ->
                 BaseImage Core.<$>
                   (o Core..:? "layerCount") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "repository"))

instance Core.ToJSON BaseImage where
        toJSON BaseImage{..}
          = Core.object
              (Core.catMaybes
                 [("layerCount" Core..=) Core.<$> layerCount,
                  ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON BatchCreateNotesRequest_Notes where
        parseJSON
          = Core.withObject "BatchCreateNotesRequest_Notes"
              (\ o ->
                 BatchCreateNotesRequest_Notes Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON BatchCreateNotesRequest_Notes where
        toJSON BatchCreateNotesRequest_Notes{..} = Core.toJSON additional
...
instance Core.FromJSON BatchCreateOccurrencesRequest where
        parseJSON
          = Core.withObject "BatchCreateOccurrencesRequest"
              (\ o ->
                 BatchCreateOccurrencesRequest Core.<$> (o Core..:? "occurrences"))

instance Core.ToJSON BatchCreateOccurrencesRequest where
        toJSON BatchCreateOccurrencesRequest{..}
          = Core.object
              (Core.catMaybes [("occurrences" Core..=) Core.<$> occurrences])
...
instance Core.FromJSON BatchCreateOccurrencesResponse where
        parseJSON
          = Core.withObject "BatchCreateOccurrencesResponse"
              (\ o ->
                 BatchCreateOccurrencesResponse Core.<$> (o Core..:? "occurrences"))
...
newBuildDefinition 
    ::  BuildDefinition
newBuildDefinition
  = BuildDefinition{buildType = Core.Nothing,
          ...
          = Core.withObject "BuildDefinition"
              (\ o ->
                 BuildDefinition Core.<$>
                   (o Core..:? "buildType") Core.<*> (o Core..:? "externalParameters")
          ...
          = Core.object
              (Core.catMaybes
                 [("buildType" Core..=) Core.<$> buildType,
                  ("externalParameters" Core..=) Core.<$> externalParameters,
                  ("internalParameters" Core..=) Core.<$> internalParameters,
                  ("resolvedDependencies" Core..=) Core.<$> resolvedDependencies])
...
instance Core.FromJSON BuildDefinition_ExternalParameters where
        parseJSON
          = Core.withObject "BuildDefinition_ExternalParameters"
              (\ o ->
                 BuildDefinition_ExternalParameters Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON BuildDefinition_ExternalParameters where
...
instance Core.FromJSON BuildDefinition_InternalParameters where
        parseJSON
          = Core.withObject "BuildDefinition_InternalParameters"
              (\ o ->
                 BuildDefinition_InternalParameters Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON BuildDefinition_InternalParameters where
...
newBuildMetadata 
    ::  BuildMetadata
newBuildMetadata
  = BuildMetadata{finishedOn = Core.Nothing,
                  invocationId = Core.Nothing, startedOn = Core.Nothing}
instance Core.FromJSON BuildMetadata where
        parseJSON
          = Core.withObject "BuildMetadata"
              (\ o ->
                 BuildMetadata Core.<$>
                   (o Core..:? "finishedOn") Core.<*> (o Core..:? "invocationId")
...
instance Core.FromJSON BuildNote where
        parseJSON
          = Core.withObject "BuildNote"
              (\ o -> BuildNote Core.<$> (o Core..:? "builderVersion"))
...
newBuildOccurrence 
    ::  BuildOccurrence
newBuildOccurrence
  = BuildOccurrence{inTotoSlsaProvenanceV1 = Core.Nothing,
                    intotoProvenance = Core.Nothing, intotoStatement = Core.Nothing,
                    provenance = Core.Nothing, provenanceBytes = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("inTotoSlsaProvenanceV1" Core..=) Core.<$>
                    inTotoSlsaProvenanceV1,
                  ("intotoProvenance" Core..=) Core.<$> intotoProvenance,
                  ("intotoStatement" Core..=) Core.<$> intotoStatement,
                  ("provenance" Core..=) Core.<$> provenance,
                  ("provenanceBytes" Core..=) Core.<$> provenanceBytes])
...
newBuildProvenance 
    ::  BuildProvenance
newBuildProvenance
  = BuildProvenance{buildOptions = Core.Nothing,
                    builderVersion = Core.Nothing, builtArtifacts = Core.Nothing,
                    commands = Core.Nothing, createTime = Core.Nothing,
                    creator = Core.Nothing, endTime = Core.Nothing, id = Core.Nothing,
                    logsUri = Core.Nothing, projectId = Core.Nothing,
                    sourceProvenance = Core.Nothing, startTime = Core.Nothing,
          ...
          = Core.withObject "BuildProvenance"
              (\ o ->
                 BuildProvenance Core.<$>
                   (o Core..:? "buildOptions") Core.<*> (o Core..:? "builderVersion")
          ...
          = Core.object
              (Core.catMaybes
                 [("buildOptions" Core..=) Core.<$> buildOptions,
                  ...
                  ("endTime" Core..=) Core.<$> endTime, ("id" Core..=) Core.<$> id,
...
instance Core.FromJSON BuildProvenance_BuildOptions where
        parseJSON
          = Core.withObject "BuildProvenance_BuildOptions"
              (\ o ->
                 BuildProvenance_BuildOptions Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON BuildProvenance_BuildOptions where
        toJSON BuildProvenance_BuildOptions{..} = Core.toJSON additional
...
newBuildStep 
    ::  BuildStep
newBuildStep
  = BuildStep{allowExitCodes = Core.Nothing,
              ...
              exitCode = Core.Nothing, id = Core.Nothing, name = Core.Nothing,
              pullTiming = Core.Nothing, results = Core.Nothing,
...
newCVSS 
    ::  CVSS
newCVSS
  = CVSS{attackComplexity = Core.Nothing,
         attackVector = Core.Nothing, authentication = Core.Nothing,
         availabilityImpact = Core.Nothing, baseScore = Core.Nothing,
         confidentialityImpact = Core.Nothing,
         exploitabilityScore = Core.Nothing, impactScore = Core.Nothing,
         integrityImpact = Core.Nothing, privilegesRequired = Core.Nothing,
         scope = Core.Nothing, userInteraction = Core.Nothing}
...
instance Core.ToJSON CVSS where
        toJSON CVSS{..}
          = Core.object
              (Core.catMaybes
                 [("attackComplexity" Core..=) Core.<$> attackComplexity,
                  ...
                  ("confidentialityImpact" Core..=) Core.<$> confidentialityImpact,
                  ("exploitabilityScore" Core..=) Core.<$> exploitabilityScore,
                  ("impactScore" Core..=) Core.<$> impactScore,
                  ("integrityImpact" Core..=) Core.<$> integrityImpact,
                  ("privilegesRequired" Core..=) Core.<$> privilegesRequired,
                  ("scope" Core..=) Core.<$> scope,
                  ("userInteraction" Core..=) Core.<$> userInteraction])
...
newCVSSv3 
    ::  CVSSv3
newCVSSv3
  = CVSSv3{attackComplexity = Core.Nothing,
           attackVector = Core.Nothing, availabilityImpact = Core.Nothing,
           baseScore = Core.Nothing, confidentialityImpact = Core.Nothing,
           exploitabilityScore = Core.Nothing, impactScore = Core.Nothing,
           integrityImpact = Core.Nothing, privilegesRequired = Core.Nothing,
           scope = Core.Nothing, userInteraction = Core.Nothing}
...
newCategory 
    ::  Category
newCategory
  = Category{categoryId = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON Category where
        parseJSON
          = Core.withObject "Category"
              (\ o ->
                 Category Core.<$>
                   (o Core..:? "categoryId") Core.<*> (o Core..:? "name"))
...
newCisBenchmark 
    ::  CisBenchmark
newCisBenchmark
  = CisBenchmark{profileLevel = Core.Nothing,
...
instance Core.FromJSON CisBenchmark where
        parseJSON
          = Core.withObject "CisBenchmark"
              (\ o ->
                 CisBenchmark Core.<$>
                   (o Core..:? "profileLevel") Core.<*> (o Core..:? "severity"))
...
newCloudRepoSourceContext 
    ::  CloudRepoSourceContext
newCloudRepoSourceContext
  = CloudRepoSourceContext{aliasContext = Core.Nothing,
                           repoId = Core.Nothing, revisionId = Core.Nothing}
instance Core.FromJSON CloudRepoSourceContext where
        parseJSON
          = Core.withObject "CloudRepoSourceContext"
              (\ o ->
                 CloudRepoSourceContext Core.<$>
                   (o Core..:? "aliasContext") Core.<*> (o Core..:? "repoId") Core.<*>
                     (o Core..:? "revisionId"))
...
newCommand 
    ::  Command
newCommand
  = Command{args = Core.Nothing, dir = Core.Nothing,
            env = Core.Nothing, id = Core.Nothing, name = Core.Nothing,
            waitFor = Core.Nothing}
instance Core.FromJSON Command where
        parseJSON
          = Core.withObject "Command"
              (\ o ->
                 Command Core.<$>
                   (o Core..:? "args") Core.<*> (o Core..:? "dir") Core.<*>
                     (o Core..:? "env")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "waitFor"))
...
instance Core.ToJSON Command where
        toJSON Command{..}
          = Core.object
              (Core.catMaybes
                 [("args" Core..=) Core.<$> args, ("dir" Core..=) Core.<$> dir,
                  ("env" Core..=) Core.<$> env, ("id" Core..=) Core.<$> id,
                  ("name" Core..=) Core.<$> name,
                  ("waitFor" Core..=) Core.<$> waitFor])
...
newCompleteness 
    ::  Completeness
newCompleteness
  = Completeness{arguments = Core.Nothing,
                 environment = Core.Nothing, materials = Core.Nothing}
instance Core.FromJSON Completeness where
        parseJSON
          = Core.withObject "Completeness"
              (\ o ->
                 Completeness Core.<$>
                   (o Core..:? "arguments") Core.<*> (o Core..:? "environment")
...
newComplianceNote 
    ::  ComplianceNote
newComplianceNote
  = ComplianceNote{cisBenchmark = Core.Nothing,
                   description = Core.Nothing, impact = Core.Nothing,
                   rationale = Core.Nothing, remediation = Core.Nothing,
                   scanInstructions = Core.Nothing, title = Core.Nothing,
...
instance Core.FromJSON ComplianceNote where
        parseJSON
          = Core.withObject "ComplianceNote"
              (\ o ->
                 ComplianceNote Core.<$>
                   (o Core..:? "cisBenchmark") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "impact")
          ...
          = Core.object
              (Core.catMaybes
                 [("cisBenchmark" Core..=) Core.<$> cisBenchmark,
                  ...
                  ("scanInstructions" Core..=) Core.<$> scanInstructions,
...
newComplianceOccurrence 
    ::  ComplianceOccurrence
newComplianceOccurrence
  = ComplianceOccurrence{nonComplianceReason = Core.Nothing,
                         nonCompliantFiles = Core.Nothing, version = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("nonComplianceReason" Core..=) Core.<$> nonComplianceReason,
                  ("nonCompliantFiles" Core..=) Core.<$> nonCompliantFiles,
                  ("version" Core..=) Core.<$> version])
...
newComplianceVersion 
    ::  ComplianceVersion
newComplianceVersion
  = ComplianceVersion{benchmarkDocument = Core.Nothing,
                      cpeUri = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON ComplianceVersion where
        parseJSON
          = Core.withObject "ComplianceVersion"
              (\ o ->
                 ComplianceVersion Core.<$>
                   (o Core..:? "benchmarkDocument") Core.<*> (o Core..:? "cpeUri")
                     Core.<*> (o Core..:? "version"))
...
instance Core.ToJSON ComplianceVersion where
        toJSON ComplianceVersion{..}
          = Core.object
              (Core.catMaybes
                 [("benchmarkDocument" Core..=) Core.<$> benchmarkDocument,
...
newContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalConfig 
    :: 
                                                             ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalConfig
newContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalConfig
  = ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalConfig{approvalRequired
                                                                = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalConfig"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalConfig Core.<$>
...
newContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult 
    :: 
                                                             ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult
newContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult
  = ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult{approvalTime
                                                                = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult Core.<$>
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts 
    :: 
                                                        ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts
newContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts{goModules =
                                                           Core.Nothing,
                                                         images = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts Core.<$>
...
newContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsArtifactObjects 
    :: 
                                                                       ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsArtifactObjects
newContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsArtifactObjects
  = ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsArtifactObjects{location
                                                                          = Core.Nothing,
                                                                        paths = Core.Nothing,
                                                                        timing = Core.Nothing}
instance Core.FromJSON
...
newContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsGoModule 
    :: 
                                                                ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsGoModule
newContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsGoModule
  = ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsGoModule{modulePath
                                                                   = Core.Nothing,
...
newContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsMavenArtifact 
    :: 
                                                                     ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsMavenArtifact
newContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsMavenArtifact
  = ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsMavenArtifact{artifactId
                                                                        = Core.Nothing,
...
newContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsNpmPackage 
    :: 
                                                                  ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsNpmPackage
newContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsNpmPackage
  = ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsNpmPackage{packagePath
                                                                     = Core.Nothing,
                                                                   repository = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsNpmPackage
...
newContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsPythonPackage 
    :: 
                                                                     ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsPythonPackage
newContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsPythonPackage
  = ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsPythonPackage{paths
                                                                        = Core.Nothing,
                                                                      repository = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsPythonPackage
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsPythonPackage
                   Core.<$> (o Core..:? "paths") Core.<*> (o Core..:? "repository"))
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Build 
    :: 
                                                    ContaineranalysisGoogleDevtoolsCloudbuildV1Build
newContaineranalysisGoogleDevtoolsCloudbuildV1Build
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Build{approval =
                                                       Core.Nothing,
                                                     ...
                                                     gitConfig = Core.Nothing, id = Core.Nothing,
                                                     images = Core.Nothing, logUrl = Core.Nothing,
                                                     logsBucket = Core.Nothing, name = Core.Nothing,
                                                     options = Core.Nothing,
                                                     projectId = Core.Nothing,
                                                     queueTtl = Core.Nothing,
                                                     results = Core.Nothing, secrets = Core.Nothing,
                                                     ...
                                                     timing = Core.Nothing, warnings = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Build
         where
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1Build"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1Build Core.<$>
...
instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Build
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1Build{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Build_Substitutions
  additional
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Build_Substitutions{additional
                                                                     = additional}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Build_Substitutions
         where
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Build_Timing
  additional
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Build_Timing{additional
                                                              = additional}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Build_Timing
         where
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1Build_Timing"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1Build_Timing Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Build_Timing
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1Build_Timing{..}
          = Core.toJSON additional
...
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval 
    :: 
                                                            ContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval
  = ContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval{config =
                                                               Core.Nothing,
                                                             result = Core.Nothing,
                                                             state = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval Core.<$>
...
instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildFailureInfo 
    :: 
                                                               ContaineranalysisGoogleDevtoolsCloudbuildV1BuildFailureInfo
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildFailureInfo
  = ContaineranalysisGoogleDevtoolsCloudbuildV1BuildFailureInfo{detail
                                                                  = Core.Nothing,
                                                                type' = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1BuildFailureInfo
...
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions 
    :: 
                                                           ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions
  = ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions{automapSubstitutions
                                                              = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions Core.<$>
...
instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions{..}
          = Core.object
              (Core.catMaybes
                 [("automapSubstitutions" Core..=) Core.<$> automapSubstitutions,
...
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptionsPoolOption 
    :: 
                                                                     ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptionsPoolOption
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptionsPoolOption
  = ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptionsPoolOption{name
                                                                        = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptionsPoolOption
         where
...
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep 
    :: 
                                                        ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep
  = ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep{allowExitCodes
                                                           = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep Core.<$>
                   (o Core..:? "allowExitCodes") Core.<*> (o Core..:? "allowFailure")
                     Core.<*> (o Core..:? "args")
                     Core.<*> (o Core..:? "automapSubstitutions")
                     Core.<*> (o Core..:? "dir")
...
instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep{..}
          = Core.object
              (Core.catMaybes
                 [("allowExitCodes" Core..=) Core.<$> allowExitCodes,
                  ("allowFailure" Core..=) Core.<$> allowFailure,
...
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning 
    :: 
                                                           ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning
newContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning
  = ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning{priority
                                                              = Core.Nothing,
                                                            text = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning Core.<$>
                   (o Core..:? "priority") Core.<*> (o Core..:? "text"))

instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1BuiltImage 
    :: 
                                                         ContaineranalysisGoogleDevtoolsCloudbuildV1BuiltImage
newContaineranalysisGoogleDevtoolsCloudbuildV1BuiltImage
  = ContaineranalysisGoogleDevtoolsCloudbuildV1BuiltImage{digest =
                                                            Core.Nothing,
                                                          name = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1BuiltImage"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1BuiltImage Core.<$>
...
instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1BuiltImage
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1BuiltImage{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1ConnectedRepository 
    :: 
                                                                  ContaineranalysisGoogleDevtoolsCloudbuildV1ConnectedRepository
newContaineranalysisGoogleDevtoolsCloudbuildV1ConnectedRepository
  = ContaineranalysisGoogleDevtoolsCloudbuildV1ConnectedRepository{dir
                                                                     = Core.Nothing,
                                                                   repository = Core.Nothing,
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Dependency 
    :: 
                                                         ContaineranalysisGoogleDevtoolsCloudbuildV1Dependency
newContaineranalysisGoogleDevtoolsCloudbuildV1Dependency
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Dependency{empty =
                                                            Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1Dependency"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1Dependency Core.<$>
...
newContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceDependency 
    :: 
                                                                            ContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceDependency
newContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceDependency
  = ContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceDependency{depth
                                                                               = Core.Nothing,
                                                                             destPath =
                                                                               Core.Nothing,
                                                                             recurseSubmodules =
...
newContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceRepository 
    :: 
                                                                            ContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceRepository
newContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceRepository
  = ContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceRepository{developerConnect
                                                                               = Core.Nothing,
                                                                             url = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceRepository
...
newContaineranalysisGoogleDevtoolsCloudbuildV1DeveloperConnectConfig 
    :: 
                                                                     ContaineranalysisGoogleDevtoolsCloudbuildV1DeveloperConnectConfig
newContaineranalysisGoogleDevtoolsCloudbuildV1DeveloperConnectConfig
  = ContaineranalysisGoogleDevtoolsCloudbuildV1DeveloperConnectConfig{dir
                                                                        = Core.Nothing,
                                                                      gitRepositoryLink =
                                                                        Core.Nothing,
                                                                      revision = Core.Nothing}
...
newContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes 
    :: 
                                                         ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes
newContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes
  = ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes{fileHash =
                                                            Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes
         where
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes Core.<$>
                   (o Core..:? "fileHash"))

instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes{..}
          = Core.object
...
newContaineranalysisGoogleDevtoolsCloudbuildV1GitConfig 
    :: 
                                                        ContaineranalysisGoogleDevtoolsCloudbuildV1GitConfig
newContaineranalysisGoogleDevtoolsCloudbuildV1GitConfig
  = ContaineranalysisGoogleDevtoolsCloudbuildV1GitConfig{http =
                                                           Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1GitConfig
         where
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1GitConfig"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1GitConfig Core.<$>
                   (o Core..:? "http"))

instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1GitConfig
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1GitConfig{..}
...
newContaineranalysisGoogleDevtoolsCloudbuildV1GitSource 
    :: 
                                                        ContaineranalysisGoogleDevtoolsCloudbuildV1GitSource
newContaineranalysisGoogleDevtoolsCloudbuildV1GitSource
  = ContaineranalysisGoogleDevtoolsCloudbuildV1GitSource{dir =
                                                           Core.Nothing,
                                                         revision = Core.Nothing,
                                                         url = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1GitSource"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1GitSource Core.<$>
...
instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1GitSource
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1GitSource{..}
          = Core.object
              (Core.catMaybes
                 [("dir" Core..=) Core.<$> dir,
                  ("revision" Core..=) Core.<$> revision,
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Hash 
    :: 
                                                   ContaineranalysisGoogleDevtoolsCloudbuildV1Hash
newContaineranalysisGoogleDevtoolsCloudbuildV1Hash
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Hash{type' =
                                                      Core.Nothing,
                                                    value = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Hash
         where
        parseJSON
          = Core.withObject "ContaineranalysisGoogleDevtoolsCloudbuildV1Hash"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1Hash Core.<$>
                   (o Core..:? "type") Core.<*> (o Core..:? "value"))

instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Hash
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1Hash{..}
          = Core.object
              (Core.catMaybes
                 [("type" Core..=) Core.<$> type',
...
newContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret 
    :: 
                                                           ContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret
newContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret
  = ContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret{envMap =
                                                              Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret Core.<$>
                   (o Core..:? "envMap") Core.<*> (o Core..:? "kmsKeyName"))

instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret_EnvMap
  additional
  = ContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret_EnvMap{additional
                                                                     = additional}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret_EnvMap
         where
...
newContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource 
    :: 
                                                         ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource
newContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource
  = ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource{branchName
                                                            = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource Core.<$>
...
instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource_Substitutions
  additional
  = ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource_Substitutions{additional
                                                                          = additional}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource_Substitutions
         where
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Results 
    :: 
                                                      ContaineranalysisGoogleDevtoolsCloudbuildV1Results
newContaineranalysisGoogleDevtoolsCloudbuildV1Results
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Results{artifactManifest
                                                         = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1Results"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1Results Core.<$>
...
instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Results
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1Results{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Secret 
    :: 
                                                     ContaineranalysisGoogleDevtoolsCloudbuildV1Secret
newContaineranalysisGoogleDevtoolsCloudbuildV1Secret
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Secret{kmsKeyName =
                                                        Core.Nothing,
                                                      secretEnv = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Secret
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1Secret"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1Secret Core.<$>
                   (o Core..:? "kmsKeyName") Core.<*> (o Core..:? "secretEnv"))

instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Secret
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1Secret{..}
          = Core.object
              (Core.catMaybes
                 [("kmsKeyName" Core..=) Core.<$> kmsKeyName,
                  ("secretEnv" Core..=) Core.<$> secretEnv])
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Secret_SecretEnv
  additional
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Secret_SecretEnv{additional
                                                                  = additional}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Secret_SecretEnv
         where
...
newContaineranalysisGoogleDevtoolsCloudbuildV1SecretManagerSecret 
    :: 
                                                                  ContaineranalysisGoogleDevtoolsCloudbuildV1SecretManagerSecret
newContaineranalysisGoogleDevtoolsCloudbuildV1SecretManagerSecret
  = ContaineranalysisGoogleDevtoolsCloudbuildV1SecretManagerSecret{env
                                                                     = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1SecretManagerSecret
                   Core.<$> (o Core..:? "env") Core.<*> (o Core..:? "versionName"))
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Secrets 
    :: 
                                                      ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets
newContaineranalysisGoogleDevtoolsCloudbuildV1Secrets
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets{inline =
                                                         Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets Core.<$>
                   (o Core..:? "inline") Core.<*> (o Core..:? "secretManager"))

instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Source 
    :: 
                                                     ContaineranalysisGoogleDevtoolsCloudbuildV1Source
newContaineranalysisGoogleDevtoolsCloudbuildV1Source
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Source{connectedRepository
                                                        = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1Source"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1Source Core.<$>
...
instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Source
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1Source{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance 
    :: 
                                                               ContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance
newContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance
  = ContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance{fileHashes
                                                                  = Core.Nothing,
...
newContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance_FileHashes
  additional
  = ContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance_FileHashes{additional
                                                                             = additional}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance_FileHashes
         where
...
newContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource 
    :: 
                                                            ContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource
newContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource
  = ContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource{bucket =
                                                               Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource Core.<$>
                   (o Core..:? "bucket") Core.<*>
...
instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1StorageSourceManifest 
    :: 
                                                                    ContaineranalysisGoogleDevtoolsCloudbuildV1StorageSourceManifest
newContaineranalysisGoogleDevtoolsCloudbuildV1StorageSourceManifest
  = ContaineranalysisGoogleDevtoolsCloudbuildV1StorageSourceManifest{bucket
                                                                       = Core.Nothing,
                                                                     generation = Core.Nothing,
                                                                     object = Core.Nothing}
instance Core.FromJSON
...
newContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan 
    :: 
                                                       ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan
newContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan
  = ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan{endTime =
                                                          Core.Nothing,
                                                        startTime = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "startTime"))

instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan{..}
          = Core.object
              (Core.catMaybes
...
newContaineranalysisGoogleDevtoolsCloudbuildV1UploadedGoModule 
    :: 
                                                               ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedGoModule
newContaineranalysisGoogleDevtoolsCloudbuildV1UploadedGoModule
  = ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedGoModule{fileHashes
                                                                  = Core.Nothing,
                                                                pushTiming = Core.Nothing,
                                                                uri = Core.Nothing}
instance Core.FromJSON
...
newContaineranalysisGoogleDevtoolsCloudbuildV1UploadedMavenArtifact 
    :: 
                                                                    ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedMavenArtifact
newContaineranalysisGoogleDevtoolsCloudbuildV1UploadedMavenArtifact
  = ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedMavenArtifact{fileHashes
                                                                       = Core.Nothing,
                                                                     pushTiming = Core.Nothing,
                                                                     uri = Core.Nothing}
instance Core.FromJSON
...
newContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage 
    :: 
                                                                 ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage
newContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage
  = ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage{fileHashes
                                                                    = Core.Nothing,
                                                                  pushTiming = Core.Nothing,
                                                                  uri = Core.Nothing}
instance Core.FromJSON
...
newContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage 
    :: 
                                                                    ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage
newContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage
  = ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage{fileHashes
                                                                       = Core.Nothing,
                                                                     pushTiming = Core.Nothing,
                                                                     uri = Core.Nothing}
instance Core.FromJSON
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Volume 
    :: 
                                                     ContaineranalysisGoogleDevtoolsCloudbuildV1Volume
newContaineranalysisGoogleDevtoolsCloudbuildV1Volume
  = ContaineranalysisGoogleDevtoolsCloudbuildV1Volume{name =
                                                        Core.Nothing,
                                                      path = Core.Nothing}
instance Core.FromJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Volume
        ...
        parseJSON
          = Core.withObject
              "ContaineranalysisGoogleDevtoolsCloudbuildV1Volume"
              (\ o ->
                 ContaineranalysisGoogleDevtoolsCloudbuildV1Volume Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "path"))

instance Core.ToJSON
           ContaineranalysisGoogleDevtoolsCloudbuildV1Volume
         where
        toJSON ContaineranalysisGoogleDevtoolsCloudbuildV1Volume{..}
          = Core.object
              (Core.catMaybes
...
instance Core.FromJSON DSSEAttestationNote where
        parseJSON
          = Core.withObject "DSSEAttestationNote"
              (\ o -> DSSEAttestationNote Core.<$> (o Core..:? "hint"))
...
newDSSEAttestationOccurrence 
    ::  DSSEAttestationOccurrence
newDSSEAttestationOccurrence
  = DSSEAttestationOccurrence{envelope = Core.Nothing,
          ...
          = Core.withObject "DSSEAttestationOccurrence"
              (\ o ->
                 DSSEAttestationOccurrence Core.<$>
                   (o Core..:? "envelope") Core.<*> (o Core..:? "statement"))
...
instance Core.FromJSON DSSEHint where
        parseJSON
          = Core.withObject "DSSEHint"
              (\ o -> DSSEHint Core.<$> (o Core..:? "humanReadableName"))

instance Core.ToJSON DSSEHint where
        toJSON DSSEHint{..}
          = Core.object
              (Core.catMaybes
                 [("humanReadableName" Core..=) Core.<$> humanReadableName])
...
instance Core.FromJSON DeploymentNote where
        parseJSON
          = Core.withObject "DeploymentNote"
              (\ o -> DeploymentNote Core.<$> (o Core..:? "resourceUri"))

instance Core.ToJSON DeploymentNote where
        toJSON DeploymentNote{..}
          = Core.object
              (Core.catMaybes [("resourceUri" Core..=) Core.<$> resourceUri])
...
newDeploymentOccurrence 
    ::  DeploymentOccurrence
newDeploymentOccurrence
  = DeploymentOccurrence{address = Core.Nothing,
                         config = Core.Nothing, deployTime = Core.Nothing,
                         platform = Core.Nothing, resourceUri = Core.Nothing,
                         undeployTime = Core.Nothing, userEmail = Core.Nothing}
instance Core.FromJSON DeploymentOccurrence where
        parseJSON
          = Core.withObject "DeploymentOccurrence"
              (\ o ->
                 DeploymentOccurrence Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "config") Core.<*>
                     (o Core..:? "deployTime")
...
newDetail 
    ::  Detail
newDetail
  = Detail{affectedCpeUri = Core.Nothing,
           affectedPackage = Core.Nothing, affectedVersionEnd = Core.Nothing,
           affectedVersionStart = Core.Nothing, description = Core.Nothing,
           fixedCpeUri = Core.Nothing, fixedPackage = Core.Nothing,
           fixedVersion = Core.Nothing, isObsolete = Core.Nothing,
           packageType = Core.Nothing, severityName = Core.Nothing,
           source = Core.Nothing, sourceUpdateTime = Core.Nothing,
           vendor = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("affectedCpeUri" Core..=) Core.<$> affectedCpeUri,
                  ...
                  ("affectedVersionEnd" Core..=) Core.<$> affectedVersionEnd,
                  ("affectedVersionStart" Core..=) Core.<$> affectedVersionStart,
                  ("description" Core..=) Core.<$> description,
                  ...
                  ("source" Core..=) Core.<$> source,
                  ("sourceUpdateTime" Core..=) Core.<$> sourceUpdateTime,
...
instance Core.FromJSON Digest where
        parseJSON
          = Core.withObject "Digest"
              (\ o ->
                 Digest Core.<$>
                   (o Core..:? "algo") Core.<*> (o Core..:? "digestBytes"))
...
instance Core.FromJSON DiscoveryNote where
        parseJSON
          = Core.withObject "DiscoveryNote"
              (\ o -> DiscoveryNote Core.<$> (o Core..:? "analysisKind"))

instance Core.ToJSON DiscoveryNote where
        toJSON DiscoveryNote{..}
          = Core.object
              (Core.catMaybes [("analysisKind" Core..=) Core.<$> analysisKind])
...
newDiscoveryOccurrence 
    ::  DiscoveryOccurrence
newDiscoveryOccurrence
  = DiscoveryOccurrence{analysisCompleted = Core.Nothing,
                        analysisError = Core.Nothing, analysisStatus = Core.Nothing,
                        analysisStatusError = Core.Nothing, archiveTime = Core.Nothing,
                        continuousAnalysis = Core.Nothing, cpe = Core.Nothing,
                        files = Core.Nothing, lastScanTime = Core.Nothing,
...
instance Core.ToJSON DiscoveryOccurrence where
        toJSON DiscoveryOccurrence{..}
          = Core.object
              (Core.catMaybes
                 [("analysisCompleted" Core..=) Core.<$> analysisCompleted,
                  ("analysisError" Core..=) Core.<$> analysisError,
                  ("analysisStatus" Core..=) Core.<$> analysisStatus,
                  ("analysisStatusError" Core..=) Core.<$> analysisStatusError,
                  ("archiveTime" Core..=) Core.<$> archiveTime,
                  ("continuousAnalysis" Core..=) Core.<$> continuousAnalysis,
                  ("cpe" Core..=) Core.<$> cpe, ("files" Core..=) Core.<$> files,
...
newDistribution 
    ::  Distribution
newDistribution
  = Distribution{architecture = Core.Nothing, cpeUri = Core.Nothing,
                 description = Core.Nothing, latestVersion = Core.Nothing,
                 maintainer = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Distribution where
        parseJSON
          = Core.withObject "Distribution"
              (\ o ->
                 Distribution Core.<$>
                   (o Core..:? "architecture") Core.<*> (o Core..:? "cpeUri") Core.<*>
                     (o Core..:? "description")
...
newEnvelope 
    ::  Envelope
newEnvelope
  = Envelope{payload = Core.Nothing, payloadType = Core.Nothing,
...
instance Core.FromJSON Envelope where
        parseJSON
          = Core.withObject "Envelope"
              (\ o ->
                 Envelope Core.<$>
                   (o Core..:? "payload") Core.<*> (o Core..:? "payloadType") Core.<*>
                     (o Core..:? "signatures"))
...
instance Core.ToJSON EnvelopeSignature where
        toJSON EnvelopeSignature{..}
          = Core.object
              (Core.catMaybes
                 [("keyid" Core..=) Core.<$> keyid, ("sig" Core..=) Core.<$> sig])
...
newExportSBOMRequest 
    ::  ExportSBOMRequest
newExportSBOMRequest
  = ExportSBOMRequest{cloudStorageLocation = Core.Nothing}
instance Core.FromJSON ExportSBOMRequest where
        parseJSON
          = Core.withObject "ExportSBOMRequest"
              (\ o ->
                 ExportSBOMRequest Core.<$> (o Core..:? "cloudStorageLocation"))

instance Core.ToJSON ExportSBOMRequest where
        toJSON ExportSBOMRequest{..}
          = Core.object
              (Core.catMaybes
                 [("cloudStorageLocation" Core..=) Core.<$> cloudStorageLocation])
...
newFile 
    ::  File
newFile = File{digest = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON File where
        parseJSON
          = Core.withObject "File"
              (\ o ->
                 File Core.<$> (o Core..:? "digest") Core.<*> (o Core..:? "name"))
...
--
-- /See:/ 'newFile_Digest' smart constructor.
newtype File_Digest = File_Digest
    {
...
-- | Creates a value of 'File_Digest' with the minimum fields required to make a request.
newFile_Digest 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> File_Digest
newFile_Digest additional = File_Digest{additional = additional}
instance Core.FromJSON File_Digest where
        parseJSON
          = Core.withObject "File_Digest"
              (\ o -> File_Digest Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON File_Digest where
        toJSON File_Digest{..} = Core.toJSON additional
...
newFingerprint 
    ::  Fingerprint
newFingerprint
  = Fingerprint{v1Name = Core.Nothing, v2Blob = Core.Nothing,
                v2Name = Core.Nothing}
instance Core.FromJSON Fingerprint where
        parseJSON
          = Core.withObject "Fingerprint"
              (\ o ->
                 Fingerprint Core.<$>
                   (o Core..:? "v1Name") Core.<*> (o Core..:? "v2Blob") Core.<*>
                     (o Core..:? "v2Name"))
...
newFixableTotalByDigest 
    ::  FixableTotalByDigest
newFixableTotalByDigest
  = FixableTotalByDigest{fixableCount = Core.Nothing,
                         resourceUri = Core.Nothing, severity = Core.Nothing,
          ...
          = Core.withObject "FixableTotalByDigest"
              (\ o ->
                 FixableTotalByDigest Core.<$>
                   (o Core..:? "fixableCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "resourceUri")
                     Core.<*> (o Core..:? "severity")
                     Core.<*>
                     (o Core..:? "totalCount" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON FixableTotalByDigest where
        toJSON FixableTotalByDigest{..}
          = Core.object
              (Core.catMaybes
                 [("fixableCount" Core..=) Core.. Core.AsText Core.<$> fixableCount,
                  ("resourceUri" Core..=) Core.<$> resourceUri,
                  ("severity" Core..=) Core.<$> severity,
...
newGerritSourceContext 
    ::  GerritSourceContext
newGerritSourceContext
  = GerritSourceContext{aliasContext = Core.Nothing,
                        gerritProject = Core.Nothing, hostUri = Core.Nothing,
          ...
          = Core.withObject "GerritSourceContext"
              (\ o ->
                 GerritSourceContext Core.<$>
                   (o Core..:? "aliasContext") Core.<*> (o Core..:? "gerritProject")
                     Core.<*> (o Core..:? "hostUri")
          ...
          = Core.withObject "GitSourceContext"
              (\ o ->
                 GitSourceContext Core.<$>
                   (o Core..:? "revisionId") Core.<*> (o Core..:? "url"))
...
newGoogleDevtoolsContaineranalysisV1alpha1OperationMetadata 
    :: 
                                                            GoogleDevtoolsContaineranalysisV1alpha1OperationMetadata
newGoogleDevtoolsContaineranalysisV1alpha1OperationMetadata
  = GoogleDevtoolsContaineranalysisV1alpha1OperationMetadata{createTime
                                                               = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsContaineranalysisV1alpha1OperationMetadata"
              (\ o ->
                 GoogleDevtoolsContaineranalysisV1alpha1OperationMetadata Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "endTime"))

instance Core.ToJSON
           GoogleDevtoolsContaineranalysisV1alpha1OperationMetadata
         where
        toJSON GoogleDevtoolsContaineranalysisV1alpha1OperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("endTime" Core..=) Core.<$> endTime])
...
data GrafeasV1FileLocation = GrafeasV1FileLocation
    {
    ...
    , layerDetails :: (Core.Maybe LayerDetails)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
          ...
          = Core.object
              (Core.catMaybes
                 [("filePath" Core..=) Core.<$> filePath,
                  ("layerDetails" Core..=) Core.<$> layerDetails])
...
instance Core.FromJSON GrafeasV1SlsaProvenanceZeroTwoSlsaBuilder
         where
        parseJSON
          = Core.withObject "GrafeasV1SlsaProvenanceZeroTwoSlsaBuilder"
              (\ o ->
                 GrafeasV1SlsaProvenanceZeroTwoSlsaBuilder Core.<$>
                   (o Core..:? "id"))

instance Core.ToJSON GrafeasV1SlsaProvenanceZeroTwoSlsaBuilder
         where
...
newGrafeasV1SlsaProvenanceZeroTwoSlsaCompleteness 
    :: 
                                                  GrafeasV1SlsaProvenanceZeroTwoSlsaCompleteness
newGrafeasV1SlsaProvenanceZeroTwoSlsaCompleteness
  = GrafeasV1SlsaProvenanceZeroTwoSlsaCompleteness{environment =
                                                     Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GrafeasV1SlsaProvenanceZeroTwoSlsaCompleteness"
              (\ o ->
                 GrafeasV1SlsaProvenanceZeroTwoSlsaCompleteness Core.<$>
                   (o Core..:? "environment") Core.<*> (o Core..:? "materials")
                     Core.<*> (o Core..:? "parameters"))

instance Core.ToJSON GrafeasV1SlsaProvenanceZeroTwoSlsaCompleteness
         where
        toJSON GrafeasV1SlsaProvenanceZeroTwoSlsaCompleteness{..}
          = Core.object
              (Core.catMaybes
                 [("environment" Core..=) Core.<$> environment,
                  ("materials" Core..=) Core.<$> materials,
...
newGrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource 
    :: 
                                                  GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource
newGrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource
  = GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource{digest =
                                                     Core.Nothing,
                                                   entryPoint = Core.Nothing, uri = Core.Nothing}
instance Core.FromJSON
           GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource
         where
        parseJSON
          = Core.withObject "GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource"
              (\ o ->
                 GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource Core.<$>
                   (o Core..:? "digest") Core.<*> (o Core..:? "entryPoint") Core.<*>
                     (o Core..:? "uri"))

instance Core.ToJSON GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource
         where
        toJSON GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource{..}
          = Core.object
              (Core.catMaybes
                 [("digest" Core..=) Core.<$> digest,
                  ("entryPoint" Core..=) Core.<$> entryPoint,
...
newGrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource_Digest additional
  = GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource_Digest{additional
                                                            = additional}
instance Core.FromJSON
           GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource_Digest
         where
        parseJSON
          = Core.withObject
              "GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource_Digest"
              (\ o ->
                 GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource_Digest Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource_Digest
         where
        toJSON GrafeasV1SlsaProvenanceZeroTwoSlsaConfigSource_Digest{..}
          = Core.toJSON additional
...
newGrafeasV1SlsaProvenanceZeroTwoSlsaInvocation 
    :: 
                                                GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation
newGrafeasV1SlsaProvenanceZeroTwoSlsaInvocation
  = GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation{configSource =
                                                   Core.Nothing,
                                                 environment = Core.Nothing,
                                                 parameters = Core.Nothing}
instance Core.FromJSON GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation
         where
        parseJSON
          = Core.withObject "GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation"
              (\ o ->
                 GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation Core.<$>
                   (o Core..:? "configSource") Core.<*> (o Core..:? "environment")
                     Core.<*> (o Core..:? "parameters"))

instance Core.ToJSON GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation
         where
        toJSON GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation{..}
          = Core.object
              (Core.catMaybes
...
newGrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Environment
  additional
  = GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Environment{additional
                                                               = additional}
instance Core.FromJSON
           GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Environment
         where
        parseJSON
          = Core.withObject
              "GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Environment"
              (\ o ->
                 GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Environment Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Environment
         where
        toJSON GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Environment{..}
          = Core.toJSON additional
...
newGrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Parameters
  additional
  = GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Parameters{additional
                                                              = additional}
instance Core.FromJSON
           GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Parameters
         where
        parseJSON
          = Core.withObject
              "GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Parameters"
              (\ o ->
                 GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Parameters Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Parameters
         where
        toJSON GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation_Parameters{..}
          = Core.toJSON additional
...
newGrafeasV1SlsaProvenanceZeroTwoSlsaMaterial 
    :: 
                                              GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial
newGrafeasV1SlsaProvenanceZeroTwoSlsaMaterial
  = GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial{digest = Core.Nothing,
                                               uri = Core.Nothing}
instance Core.FromJSON GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial
         where
        parseJSON
          = Core.withObject "GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial"
              (\ o ->
                 GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial Core.<$>
                   (o Core..:? "digest") Core.<*> (o Core..:? "uri"))

instance Core.ToJSON GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial
         where
        toJSON GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial{..}
          = Core.object
              (Core.catMaybes
                 [("digest" Core..=) Core.<$> digest, ("uri" Core..=) Core.<$> uri])
...
newGrafeasV1SlsaProvenanceZeroTwoSlsaMaterial_Digest additional
  = GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial_Digest{additional =
                                                        additional}
instance Core.FromJSON
           GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial_Digest
         where
        parseJSON
          = Core.withObject
              "GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial_Digest"
              (\ o ->
                 GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial_Digest Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial_Digest
         where
        toJSON GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial_Digest{..}
          = Core.toJSON additional
...
newGrafeasV1SlsaProvenanceZeroTwoSlsaMetadata 
    :: 
                                              GrafeasV1SlsaProvenanceZeroTwoSlsaMetadata
newGrafeasV1SlsaProvenanceZeroTwoSlsaMetadata
  = GrafeasV1SlsaProvenanceZeroTwoSlsaMetadata{buildFinishedOn =
                                                 Core.Nothing,
                                               buildInvocationId = Core.Nothing,
                                               buildStartedOn = Core.Nothing,
                                               completeness = Core.Nothing,
                                               reproducible = Core.Nothing}
instance Core.FromJSON GrafeasV1SlsaProvenanceZeroTwoSlsaMetadata
         where
        parseJSON
          = Core.withObject "GrafeasV1SlsaProvenanceZeroTwoSlsaMetadata"
              (\ o ->
...
instance Core.ToJSON GrafeasV1SlsaProvenanceZeroTwoSlsaMetadata
         where
        toJSON GrafeasV1SlsaProvenanceZeroTwoSlsaMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("buildFinishedOn" Core..=) Core.<$> buildFinishedOn,
                  ("buildInvocationId" Core..=) Core.<$> buildInvocationId,
...
instance Core.FromJSON Hash where
        parseJSON
          = Core.withObject "Hash"
              (\ o ->
                 Hash Core.<$> (o Core..:? "type") Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON Hint where
        parseJSON
          = Core.withObject "Hint"
              (\ o -> Hint Core.<$> (o Core..:? "humanReadableName"))
...
newIdentity 
    ::  Identity
newIdentity
  = Identity{revision = Core.Nothing, updateId = Core.Nothing}
instance Core.FromJSON Identity where
        parseJSON
          = Core.withObject "Identity"
              (\ o ->
                 Identity Core.<$>
                   (o Core..:? "revision") Core.<*> (o Core..:? "updateId"))
...
instance Core.FromJSON ImageNote where
        parseJSON
          = Core.withObject "ImageNote"
              (\ o ->
                 ImageNote Core.<$>
                   (o Core..:? "fingerprint") Core.<*> (o Core..:? "resourceUrl"))
...
newImageOccurrence 
    ::  ImageOccurrence
newImageOccurrence
  = ImageOccurrence{baseResourceUrl = Core.Nothing,
                    distance = Core.Nothing, fingerprint = Core.Nothing,
          ...
          = Core.withObject "ImageOccurrence"
              (\ o ->
                 ImageOccurrence Core.<$>
                   (o Core..:? "baseResourceUrl") Core.<*> (o Core..:? "distance")
...
instance Core.ToJSON ImageOccurrence where
        toJSON ImageOccurrence{..}
          = Core.object
              (Core.catMaybes
                 [("baseResourceUrl" Core..=) Core.<$> baseResourceUrl,
...
newInTotoProvenance 
    ::  InTotoProvenance
newInTotoProvenance
  = InTotoProvenance{builderConfig = Core.Nothing,
                     materials = Core.Nothing, metadata = Core.Nothing,
                     recipe = Core.Nothing}
          ...
          = Core.withObject "InTotoProvenance"
              (\ o ->
                 InTotoProvenance Core.<$>
                   (o Core..:? "builderConfig") Core.<*> (o Core..:? "materials")
...
newInTotoSlsaProvenanceV1 
    ::  InTotoSlsaProvenanceV1
newInTotoSlsaProvenanceV1
  = InTotoSlsaProvenanceV1{type' = Core.Nothing,
                           predicate = Core.Nothing, predicateType = Core.Nothing,
          ...
          = Core.withObject "InTotoSlsaProvenanceV1"
              (\ o ->
                 InTotoSlsaProvenanceV1 Core.<$>
                   (o Core..:? "_type") Core.<*> (o Core..:? "predicate") Core.<*>
...
newInTotoStatement 
    ::  InTotoStatement
newInTotoStatement
  = InTotoStatement{type' = Core.Nothing,
                    predicateType = Core.Nothing, provenance = Core.Nothing,
                    slsaProvenance = Core.Nothing,
                    slsaProvenanceZeroTwo = Core.Nothing, subject = Core.Nothing}
instance Core.FromJSON InTotoStatement where
        parseJSON
          = Core.withObject "InTotoStatement"
              (\ o ->
                 InTotoStatement Core.<$>
                   (o Core..:? "_type") Core.<*> (o Core..:? "predicateType") Core.<*>
                     (o Core..:? "provenance")
          ...
          = Core.object
              (Core.catMaybes
                 [("_type" Core..=) Core.<$> type',
                  ...
                  ("slsaProvenanceZeroTwo" Core..=) Core.<$> slsaProvenanceZeroTwo,
                  ("subject" Core..=) Core.<$> subject])
...
newJustification 
    ::  Justification
newJustification
  = Justification{details = Core.Nothing,
                  justificationType = Core.Nothing}
instance Core.FromJSON Justification where
        parseJSON
          = Core.withObject "Justification"
              (\ o ->
                 Justification Core.<$>
                   (o Core..:? "details") Core.<*> (o Core..:? "justificationType"))
          ...
          = Core.object
              (Core.catMaybes
                 [("details" Core..=) Core.<$> details,
                  ("justificationType" Core..=) Core.<$> justificationType])
...
instance Core.ToJSON Jwt where
        toJSON Jwt{..}
          = Core.object
              (Core.catMaybes [("compactJwt" Core..=) Core.<$> compactJwt])
...
newKnowledgeBase 
    ::  KnowledgeBase
newKnowledgeBase
  = KnowledgeBase{name = Core.Nothing, url = Core.Nothing}
...
newLayer 
    ::  Layer
newLayer
  = Layer{arguments = Core.Nothing, directive = Core.Nothing}
instance Core.FromJSON Layer where
        parseJSON
          = Core.withObject "Layer"
              (\ o ->
                 Layer Core.<$>
                   (o Core..:? "arguments") Core.<*> (o Core..:? "directive"))
...
--
-- /See:/ 'newLayerDetails' smart constructor.
data LayerDetails = LayerDetails
    {
      -- | The base images the layer is found within.
      baseImages :: (Core.Maybe [BaseImage])
    ...
    , chainId :: (Core.Maybe Core.Text)
      -- | The layer build command that was used to build the layer. This may not be found in all layers depending on how the container image is built.
    , command :: (Core.Maybe Core.Text)
      -- | The diff ID (typically a sha256 hash) of the layer in the container image.
    , diffId :: (Core.Maybe Core.Text)
      -- | The index of the layer in the container image.
    , index :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'LayerDetails' with the minimum fields required to make a request.
newLayerDetails 
    ::  LayerDetails
newLayerDetails
  = LayerDetails{baseImages = Core.Nothing, chainId = Core.Nothing,
                 command = Core.Nothing, diffId = Core.Nothing,
                 index = Core.Nothing}
instance Core.FromJSON LayerDetails where
        parseJSON
          = Core.withObject "LayerDetails"
              (\ o ->
                 LayerDetails Core.<$>
                   (o Core..:? "baseImages") Core.<*> (o Core..:? "chainId") Core.<*>
                     (o Core..:? "command")
                     Core.<*> (o Core..:? "diffId")
                     Core.<*> (o Core..:? "index"))

instance Core.ToJSON LayerDetails where
        toJSON LayerDetails{..}
          = Core.object
              (Core.catMaybes
                 [("baseImages" Core..=) Core.<$> baseImages,
                  ("chainId" Core..=) Core.<$> chainId,
                  ("command" Core..=) Core.<$> command,
                  ("diffId" Core..=) Core.<$> diffId,
...
newLicense 
    ::  License
newLicense
  = License{comments = Core.Nothing, expression = Core.Nothing}
instance Core.FromJSON License where
        parseJSON
          = Core.withObject "License"
              (\ o ->
                 License Core.<$>
                   (o Core..:? "comments") Core.<*> (o Core..:? "expression"))
...
newListNoteOccurrencesResponse 
    ::  ListNoteOccurrencesResponse
newListNoteOccurrencesResponse
  = ListNoteOccurrencesResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListNoteOccurrencesResponse"
              (\ o ->
                 ListNoteOccurrencesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "occurrences"))
...
newListNotesResponse 
    ::  ListNotesResponse
newListNotesResponse
  = ListNotesResponse{nextPageToken = Core.Nothing,
                      notes = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListNotesResponse where
        parseJSON
          = Core.withObject "ListNotesResponse"
              (\ o ->
                 ListNotesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "notes") Core.<*>
                     (o Core..:? "unreachable"))
...
newListOccurrencesResponse 
    ::  ListOccurrencesResponse
newListOccurrencesResponse
  = ListOccurrencesResponse{nextPageToken = Core.Nothing,
                            occurrences = Core.Nothing, unreachable = Core.Nothing}
...
newLocation 
    ::  Location
newLocation
  = Location{cpeUri = Core.Nothing, path = Core.Nothing,
             version = Core.Nothing}
instance Core.FromJSON Location where
        parseJSON
          = Core.withObject "Location"
              (\ o ->
                 Location Core.<$>
                   (o Core..:? "cpeUri") Core.<*> (o Core..:? "path") Core.<*>
                     (o Core..:? "version"))
...
newMaterial_Digest 
    :: 
       ...
       -- ^  See 'additional'.
    -> Material_Digest
newMaterial_Digest additional
  = Material_Digest{additional = additional}
instance Core.FromJSON Material_Digest where
        parseJSON
          = Core.withObject "Material_Digest"
              (\ o -> Material_Digest Core.<$> (Core.parseJSONObject o))
...
newMetadata 
    ::  Metadata
newMetadata
  = Metadata{buildFinishedOn = Core.Nothing,
             buildInvocationId = Core.Nothing, buildStartedOn = Core.Nothing,
             completeness = Core.Nothing, reproducible = Core.Nothing}
...
newNonCompliantFile 
    ::  NonCompliantFile
newNonCompliantFile
  = NonCompliantFile{displayCommand = Core.Nothing,
                     path = Core.Nothing, reason = Core.Nothing}
instance Core.FromJSON NonCompliantFile where
        parseJSON
          = Core.withObject "NonCompliantFile"
              (\ o ->
                 NonCompliantFile Core.<$>
                   (o Core..:? "displayCommand") Core.<*> (o Core..:? "path") Core.<*>
                     (o Core..:? "reason"))
...
newNote 
    ::  Note
newNote
  = Note{attestation = Core.Nothing, build = Core.Nothing,
         compliance = Core.Nothing, createTime = Core.Nothing,
         deployment = Core.Nothing, discovery = Core.Nothing,
         dsseAttestation = Core.Nothing, expirationTime = Core.Nothing,
         image = Core.Nothing, kind = Core.Nothing,
         longDescription = Core.Nothing, name = Core.Nothing,
         package = Core.Nothing, relatedNoteNames = Core.Nothing,
         relatedUrl = Core.Nothing, sbomReference = Core.Nothing,
         secret = Core.Nothing, shortDescription = Core.Nothing,
         updateTime = Core.Nothing, upgrade = Core.Nothing,
...
instance Core.FromJSON Note where
        parseJSON
          = Core.withObject "Note"
              (\ o ->
                 Note Core.<$>
                   (o Core..:? "attestation") Core.<*> (o Core..:? "build") Core.<*>
                     (o Core..:? "compliance")
                     Core.<*> (o Core..:? "createTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("attestation" Core..=) Core.<$> attestation,
                  ...
                  ("image" Core..=) Core.<$> image, ("kind" Core..=) Core.<$> kind,
                  ("longDescription" Core..=) Core.<$> longDescription,
                  ("name" Core..=) Core.<$> name,
                  ("package" Core..=) Core.<$> package,
                  ("relatedNoteNames" Core..=) Core.<$> relatedNoteNames,
...
data Occurrence = Occurrence
    ...
    , sbomReference :: (Core.Maybe SBOMReferenceOccurrence)
      -- | Describes a secret.
    , secret :: (Core.Maybe SecretOccurrence)
...
newOccurrence 
    ::  Occurrence
newOccurrence
  = Occurrence{attestation = Core.Nothing, build = Core.Nothing,
               compliance = Core.Nothing, createTime = Core.Nothing,
               deployment = Core.Nothing, discovery = Core.Nothing,
               dsseAttestation = Core.Nothing, envelope = Core.Nothing,
               image = Core.Nothing, kind = Core.Nothing, name = Core.Nothing,
               noteName = Core.Nothing, package = Core.Nothing,
               remediation = Core.Nothing, resourceUri = Core.Nothing,
               sbomReference = Core.Nothing, secret = Core.Nothing,
               updateTime = Core.Nothing, upgrade = Core.Nothing,
               vulnerability = Core.Nothing}
...
newPackageIssue 
    ::  PackageIssue
newPackageIssue
  = PackageIssue{affectedCpeUri = Core.Nothing,
                 affectedPackage = Core.Nothing, affectedVersion = Core.Nothing,
                 effectiveSeverity = Core.Nothing, fileLocation = Core.Nothing,
                 fixAvailable = Core.Nothing, fixedCpeUri = Core.Nothing,
                 fixedPackage = Core.Nothing, fixedVersion = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("affectedCpeUri" Core..=) Core.<$> affectedCpeUri,
                  ...
                  ("effectiveSeverity" Core..=) Core.<$> effectiveSeverity,
...
newPackageNote 
    ::  PackageNote
newPackageNote
  = PackageNote{architecture = Core.Nothing, cpeUri = Core.Nothing,
                description = Core.Nothing, digest = Core.Nothing,
                distribution = Core.Nothing, license = Core.Nothing,
                maintainer = Core.Nothing, name = Core.Nothing,
                packageType = Core.Nothing, url = Core.Nothing,
                version = Core.Nothing}
...
newPackageOccurrence 
    ::  PackageOccurrence
newPackageOccurrence
  = PackageOccurrence{architecture = Core.Nothing,
                      cpeUri = Core.Nothing, license = Core.Nothing,
                      location = Core.Nothing, name = Core.Nothing,
                      packageType = Core.Nothing, version = Core.Nothing}
...
newProduct 
    ::  Product
newProduct
  = Product{genericUri = Core.Nothing, id = Core.Nothing,
            name = Core.Nothing}
instance Core.FromJSON Product where
        parseJSON
          = Core.withObject "Product"
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "genericUri") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "name"))
...
instance Core.FromJSON ProjectRepoId where
        parseJSON
          = Core.withObject "ProjectRepoId"
              (\ o ->
                 ProjectRepoId Core.<$>
                   (o Core..:? "projectId") Core.<*> (o Core..:? "repoName"))
...
newProvenanceBuilder 
    ::  ProvenanceBuilder
newProvenanceBuilder
  = ProvenanceBuilder{builderDependencies = Core.Nothing,
                      id = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON ProvenanceBuilder where
        parseJSON
          = Core.withObject "ProvenanceBuilder"
              (\ o ->
                 ProvenanceBuilder Core.<$>
                   (o Core..:? "builderDependencies") Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "version"))
...
instance Core.ToJSON ProvenanceBuilder where
        toJSON ProvenanceBuilder{..}
          = Core.object
              (Core.catMaybes
                 [("builderDependencies" Core..=) Core.<$> builderDependencies,
...
instance Core.FromJSON ProvenanceBuilder_Version where
        parseJSON
          = Core.withObject "ProvenanceBuilder_Version"
              (\ o ->
                 ProvenanceBuilder_Version Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON ProvenanceBuilder_Version where
        toJSON ProvenanceBuilder_Version{..} = Core.toJSON additional
...
newPublisher 
    ::  Publisher
newPublisher
  = Publisher{issuingAuthority = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Publisher where
        parseJSON
          = Core.withObject "Publisher"
              (\ o ->
                 Publisher Core.<$>
                   (o Core..:? "issuingAuthority") Core.<*> (o Core..:? "name")
...
instance Core.ToJSON Publisher where
        toJSON Publisher{..}
          = Core.object
              (Core.catMaybes
                 [("issuingAuthority" Core..=) Core.<$> issuingAuthority,
                  ("name" Core..=) Core.<$> name,
...
newRecipe 
    ::  Recipe
newRecipe
  = Recipe{arguments = Core.Nothing,
           definedInMaterial = Core.Nothing, entryPoint = Core.Nothing,
           environment = Core.Nothing, type' = Core.Nothing}
              ...
              (\ o ->
                 Recipe Core.<$>
                   (o Core..:? "arguments") Core.<*>
                     (o Core..:? "definedInMaterial" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "entryPoint")
...
instance Core.ToJSON Recipe where
        toJSON Recipe{..}
          = Core.object
              (Core.catMaybes
                 [("arguments" Core..=) Core.<$> arguments,
                  ("definedInMaterial" Core..=) Core.. Core.AsText Core.<$>
                    definedInMaterial,
                  ("entryPoint" Core..=) Core.<$> entryPoint,
                  ("environment" Core..=) Core.<$> environment,
                  ("type" Core..=) Core.<$> type'])
...
instance Core.FromJSON Recipe_ArgumentsItem where
        parseJSON
          = Core.withObject "Recipe_ArgumentsItem"
              (\ o -> Recipe_ArgumentsItem Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Recipe_ArgumentsItem where
        toJSON Recipe_ArgumentsItem{..} = Core.toJSON additional
...
instance Core.FromJSON Recipe_EnvironmentItem where
        parseJSON
          = Core.withObject "Recipe_EnvironmentItem"
              (\ o -> Recipe_EnvironmentItem Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Recipe_EnvironmentItem where
        toJSON Recipe_EnvironmentItem{..} = Core.toJSON additional
...
newRelatedUrl 
    ::  RelatedUrl
newRelatedUrl
  = RelatedUrl{label = Core.Nothing, url = Core.Nothing}
...
instance Core.ToJSON RelatedUrl where
        toJSON RelatedUrl{..}
          = Core.object
              (Core.catMaybes
                 [("label" Core..=) Core.<$> label, ("url" Core..=) Core.<$> url])
...
newRemediation 
    ::  Remediation
newRemediation
  = Remediation{details = Core.Nothing,
                remediationType = Core.Nothing, remediationUri = Core.Nothing}
instance Core.FromJSON Remediation where
        parseJSON
          = Core.withObject "Remediation"
              (\ o ->
                 Remediation Core.<$>
                   (o Core..:? "details") Core.<*> (o Core..:? "remediationType")
...
instance Core.FromJSON RepoId where
        parseJSON
          = Core.withObject "RepoId"
              (\ o ->
                 RepoId Core.<$>
                   (o Core..:? "projectRepoId") Core.<*> (o Core..:? "uid"))
...
newResourceDescriptor 
    ::  ResourceDescriptor
newResourceDescriptor
  = ResourceDescriptor{annotations = Core.Nothing,
                       content = Core.Nothing, digest = Core.Nothing,
                       downloadLocation = Core.Nothing, mediaType = Core.Nothing,
          ...
          = Core.withObject "ResourceDescriptor"
              (\ o ->
                 ResourceDescriptor Core.<$>
                   (o Core..:? "annotations") Core.<*> (o Core..:? "content") Core.<*>
                     (o Core..:? "digest")
          ...
          = Core.object
              (Core.catMaybes
                 [("annotations" Core..=) Core.<$> annotations,
                  ...
                  ("digest" Core..=) Core.<$> digest,
                  ("downloadLocation" Core..=) Core.<$> downloadLocation,
...
instance Core.FromJSON ResourceDescriptor_Annotations where
        parseJSON
          = Core.withObject "ResourceDescriptor_Annotations"
              (\ o ->
                 ResourceDescriptor_Annotations Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON ResourceDescriptor_Annotations where
        toJSON ResourceDescriptor_Annotations{..} = Core.toJSON additional
...
instance Core.FromJSON ResourceDescriptor_Digest where
        parseJSON
          = Core.withObject "ResourceDescriptor_Digest"
              (\ o ->
                 ResourceDescriptor_Digest Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON ResourceDescriptor_Digest where
        toJSON ResourceDescriptor_Digest{..} = Core.toJSON additional
...
newRunDetails 
    ::  RunDetails
newRunDetails
  = RunDetails{builder = Core.Nothing, byproducts = Core.Nothing,
...
instance Core.FromJSON RunDetails where
        parseJSON
          = Core.withObject "RunDetails"
              (\ o ->
                 RunDetails Core.<$>
                   (o Core..:? "builder") Core.<*> (o Core..:? "byproducts") Core.<*>
                     (o Core..:? "metadata"))
          ...
          = Core.withObject "SBOMReferenceNote"
              (\ o ->
                 SBOMReferenceNote Core.<$>
                   (o Core..:? "format") Core.<*> (o Core..:? "version"))
...
newSBOMReferenceOccurrence 
    ::  SBOMReferenceOccurrence
newSBOMReferenceOccurrence
  = SBOMReferenceOccurrence{payload = Core.Nothing,
                            payloadType = Core.Nothing, signatures = Core.Nothing}
...
newSBOMStatus 
    ::  SBOMStatus
newSBOMStatus
  = SBOMStatus{error = Core.Nothing, sbomState = Core.Nothing}
instance Core.FromJSON SBOMStatus where
        parseJSON
          = Core.withObject "SBOMStatus"
              (\ o ->
                 SBOMStatus Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "sbomState"))
...
newSbomReferenceIntotoPayload 
    ::  SbomReferenceIntotoPayload
newSbomReferenceIntotoPayload
  = SbomReferenceIntotoPayload{type' = Core.Nothing,
                               predicate = Core.Nothing, predicateType = Core.Nothing,
                               subject = Core.Nothing}
instance Core.FromJSON SbomReferenceIntotoPayload where
        parseJSON
...
newSbomReferenceIntotoPredicate 
    ::  SbomReferenceIntotoPredicate
newSbomReferenceIntotoPredicate
  = SbomReferenceIntotoPredicate{digest = Core.Nothing,
                                 location = Core.Nothing, mimeType = Core.Nothing,
                                 referrerId = Core.Nothing}
instance Core.FromJSON SbomReferenceIntotoPredicate where
        parseJSON
          = Core.withObject "SbomReferenceIntotoPredicate"
              (\ o ->
                 SbomReferenceIntotoPredicate Core.<$>
                   (o Core..:? "digest") Core.<*> (o Core..:? "location") Core.<*>
                     (o Core..:? "mimeType")
                     Core.<*> (o Core..:? "referrerId"))

instance Core.ToJSON SbomReferenceIntotoPredicate where
...
instance Core.FromJSON SbomReferenceIntotoPredicate_Digest where
        parseJSON
          = Core.withObject "SbomReferenceIntotoPredicate_Digest"
              (\ o ->
                 SbomReferenceIntotoPredicate_Digest Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SbomReferenceIntotoPredicate_Digest where
...
--
-- /See:/ 'newSecretLocation' smart constructor.
newtype SecretLocation = SecretLocation
    {
...
-- | Creates a value of 'SecretLocation' with the minimum fields required to make a request.
newSecretLocation 
    ::  SecretLocation
newSecretLocation = SecretLocation{fileLocation = Core.Nothing}
instance Core.FromJSON SecretLocation where
        parseJSON
          = Core.withObject "SecretLocation"
              (\ o -> SecretLocation Core.<$> (o Core..:? "fileLocation"))

instance Core.ToJSON SecretLocation where
        toJSON SecretLocation{..}
          = Core.object
              (Core.catMaybes [("fileLocation" Core..=) Core.<$> fileLocation])


-- | The note representing a secret.
--
-- /See:/ 'newSecretNote' smart constructor.
data SecretNote = SecretNote
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SecretNote' with the minimum fields required to make a request.
newSecretNote 
    ::  SecretNote
newSecretNote = SecretNote
instance Core.FromJSON SecretNote where
        parseJSON
          = Core.withObject "SecretNote" (\ o -> Core.pure SecretNote)

instance Core.ToJSON SecretNote where
        toJSON = Core.const Core.emptyObject


-- | The occurrence provides details of a secret.
--
-- /See:/ 'newSecretOccurrence' smart constructor.
data SecretOccurrence = SecretOccurrence
    {
      -- | Required. Type of secret.
      kind :: (Core.Maybe SecretOccurrence_Kind)
      -- | Optional. Locations where the secret is detected.
    , locations :: (Core.Maybe [SecretLocation])
      -- | Optional. Status of the secret.
    , statuses :: (Core.Maybe [SecretStatus])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SecretOccurrence' with the minimum fields required to make a request.
newSecretOccurrence 
    ::  SecretOccurrence
newSecretOccurrence
  = SecretOccurrence{kind = Core.Nothing, locations = Core.Nothing,
                     statuses = Core.Nothing}
instance Core.FromJSON SecretOccurrence where
        parseJSON
          = Core.withObject "SecretOccurrence"
              (\ o ->
                 SecretOccurrence Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "locations") Core.<*>
                     (o Core..:? "statuses"))

instance Core.ToJSON SecretOccurrence where
        toJSON SecretOccurrence{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
...
--
-- /See:/ 'newSecretStatus' smart constructor.
data SecretStatus = SecretStatus
    {
      -- | Optional. Optional message about the status code.
      message :: (Core.Maybe Core.Text)
      -- | Optional. The status of the secret.
    , status :: (Core.Maybe SecretStatus_Status)
      -- | Optional. The time the secret status was last updated.
    , updateTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SecretStatus' with the minimum fields required to make a request.
newSecretStatus 
    ::  SecretStatus
newSecretStatus
  = SecretStatus{message = Core.Nothing, status = Core.Nothing,
                 updateTime = Core.Nothing}
instance Core.FromJSON SecretStatus where
        parseJSON
          = Core.withObject "SecretStatus"
              (\ o ->
                 SecretStatus Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "status") Core.<*>
                     (o Core..:? "updateTime"))

instance Core.ToJSON SecretStatus where
        toJSON SecretStatus{..}
          = Core.object
              (Core.catMaybes
...
newSignature 
    ::  Signature
newSignature
  = Signature{publicKeyId = Core.Nothing, signature = Core.Nothing}
instance Core.FromJSON Signature where
        parseJSON
          = Core.withObject "Signature"
              (\ o ->
                 Signature Core.<$>
                   (o Core..:? "publicKeyId") Core.<*> (o Core..:? "signature"))
...
newSlsaCompleteness 
    ::  SlsaCompleteness
newSlsaCompleteness
  = SlsaCompleteness{arguments = Core.Nothing,
                     environment = Core.Nothing, materials = Core.Nothing}
...
newSlsaMetadata 
    ::  SlsaMetadata
newSlsaMetadata
  = SlsaMetadata{buildFinishedOn = Core.Nothing,
                 buildInvocationId = Core.Nothing, buildStartedOn = Core.Nothing,
                 completeness = Core.Nothing, reproducible = Core.Nothing}
...
newSlsaProvenance 
    ::  SlsaProvenance
newSlsaProvenance
  = SlsaProvenance{builder = Core.Nothing, materials = Core.Nothing,
                   metadata = Core.Nothing, recipe = Core.Nothing}
instance Core.FromJSON SlsaProvenance where
        parseJSON
          = Core.withObject "SlsaProvenance"
              (\ o ->
                 SlsaProvenance Core.<$>
                   (o Core..:? "builder") Core.<*> (o Core..:? "materials") Core.<*>
                     (o Core..:? "metadata")
                     Core.<*> (o Core..:? "recipe"))
...
newSlsaProvenanceZeroTwo 
    ::  SlsaProvenanceZeroTwo
newSlsaProvenanceZeroTwo
  = SlsaProvenanceZeroTwo{buildConfig = Core.Nothing,
                          buildType = Core.Nothing, builder = Core.Nothing,
                          invocation = Core.Nothing, materials = Core.Nothing,
                          metadata = Core.Nothing}
          ...
          = Core.withObject "SlsaProvenanceZeroTwo"
              (\ o ->
                 SlsaProvenanceZeroTwo Core.<$>
                   (o Core..:? "buildConfig") Core.<*> (o Core..:? "buildType")
                     Core.<*> (o Core..:? "builder")
...
instance Core.FromJSON SlsaProvenanceZeroTwo_BuildConfig where
        parseJSON
...
instance Core.ToJSON SlsaProvenanceZeroTwo_BuildConfig where
...
newSlsaRecipe 
    ::  SlsaRecipe
newSlsaRecipe
  = SlsaRecipe{arguments = Core.Nothing,
               definedInMaterial = Core.Nothing, entryPoint = Core.Nothing,
               environment = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON SlsaRecipe_Arguments where
        parseJSON
          = Core.withObject "SlsaRecipe_Arguments"
              (\ o -> SlsaRecipe_Arguments Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON SlsaRecipe_Arguments where
        toJSON SlsaRecipe_Arguments{..} = Core.toJSON additional
...
instance Core.FromJSON SlsaRecipe_Environment where
        parseJSON
          = Core.withObject "SlsaRecipe_Environment"
              (\ o -> SlsaRecipe_Environment Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON SlsaRecipe_Environment where
        toJSON SlsaRecipe_Environment{..} = Core.toJSON additional
...
newSource 
    ::  Source
newSource
  = Source{additionalContexts = Core.Nothing,
           artifactStorageSourceUri = Core.Nothing, context = Core.Nothing,
...
instance Core.ToJSON Source where
        toJSON Source{..}
          = Core.object
              (Core.catMaybes
                 [("additionalContexts" Core..=) Core.<$> additionalContexts,
...
newSource_FileHashes 
    :: 
       ...
       -- ^  See 'additional'.
    -> Source_FileHashes
newSource_FileHashes additional
  = Source_FileHashes{additional = additional}
instance Core.FromJSON Source_FileHashes where
        parseJSON
          = Core.withObject "Source_FileHashes"
              (\ o -> Source_FileHashes Core.<$> (Core.parseJSONObject o))
...
newSourceContext 
    ::  SourceContext
newSourceContext
  = SourceContext{cloudRepo = Core.Nothing, gerrit = Core.Nothing,
                  git = Core.Nothing, labels = Core.Nothing}
instance Core.FromJSON SourceContext where
        parseJSON
          = Core.withObject "SourceContext"
              (\ o ->
                 SourceContext Core.<$>
                   (o Core..:? "cloudRepo") Core.<*> (o Core..:? "gerrit") Core.<*>
                     (o Core..:? "git")
                     Core.<*> (o Core..:? "labels"))
          ...
          = Core.object
              (Core.catMaybes
                 [("cloudRepo" Core..=) Core.<$> cloudRepo,
                  ("gerrit" Core..=) Core.<$> gerrit, ("git" Core..=) Core.<$> git,
...
instance Core.FromJSON SourceContext_Labels where
        parseJSON
          = Core.withObject "SourceContext_Labels"
              (\ o -> SourceContext_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON SourceContext_Labels where
        toJSON SourceContext_Labels{..} = Core.toJSON additional
...
--
-- /See:/ 'newStepResult' smart constructor.
data StepResult = StepResult
    {

      attestationContentName :: (Core.Maybe Core.Text)

    , attestationType :: (Core.Maybe Core.Text)

    , name :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'StepResult' with the minimum fields required to make a request.
newStepResult 
    ::  StepResult
newStepResult
  = StepResult{attestationContentName = Core.Nothing,
               attestationType = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON StepResult where
        parseJSON
          = Core.withObject "StepResult"
              (\ o ->
                 StepResult Core.<$>
                   (o Core..:? "attestationContentName") Core.<*>
                     (o Core..:? "attestationType")
                     Core.<*> (o Core..:? "name"))

instance Core.ToJSON StepResult where
        toJSON StepResult{..}
          = Core.object
              (Core.catMaybes
                 [("attestationContentName" Core..=) Core.<$>
                    attestationContentName,
                  ("attestationType" Core..=) Core.<$> attestationType,
                  ("name" Core..=) Core.<$> name])
...
newSubject_Digest 
    :: 
       ...
       -- ^  See 'additional'.
    -> Subject_Digest
newSubject_Digest additional
  = Subject_Digest{additional = additional}
instance Core.FromJSON Subject_Digest where
        parseJSON
          = Core.withObject "Subject_Digest"
              (\ o -> Subject_Digest Core.<$> (Core.parseJSONObject o))
...
newTimeSpan 
    ::  TimeSpan
newTimeSpan
  = TimeSpan{endTime = Core.Nothing, startTime = Core.Nothing}
...
newUpgradeDistribution 
    ::  UpgradeDistribution
newUpgradeDistribution
  = UpgradeDistribution{classification = Core.Nothing,
                        cpeUri = Core.Nothing, cve = Core.Nothing, severity = Core.Nothing}
instance Core.FromJSON UpgradeDistribution where
        parseJSON
          = Core.withObject "UpgradeDistribution"
              (\ o ->
                 UpgradeDistribution Core.<$>
                   (o Core..:? "classification") Core.<*> (o Core..:? "cpeUri")
                     Core.<*> (o Core..:? "cve")
                     Core.<*> (o Core..:? "severity"))
          ...
          = Core.object
              (Core.catMaybes
                 [("classification" Core..=) Core.<$> classification,
                  ("cpeUri" Core..=) Core.<$> cpeUri, ("cve" Core..=) Core.<$> cve,
                  ("severity" Core..=) Core.<$> severity])
...
newUpgradeNote 
    ::  UpgradeNote
newUpgradeNote
  = UpgradeNote{distributions = Core.Nothing, package = Core.Nothing,
                version = Core.Nothing, windowsUpdate = Core.Nothing}
instance Core.FromJSON UpgradeNote where
        parseJSON
          = Core.withObject "UpgradeNote"
              (\ o ->
                 UpgradeNote Core.<$>
                   (o Core..:? "distributions") Core.<*> (o Core..:? "package")
                     Core.<*> (o Core..:? "version")
...
newUpgradeOccurrence 
    ::  UpgradeOccurrence
newUpgradeOccurrence
  = UpgradeOccurrence{distribution = Core.Nothing,
                      package = Core.Nothing, parsedVersion = Core.Nothing,
          ...
          = Core.withObject "UpgradeOccurrence"
              (\ o ->
                 UpgradeOccurrence Core.<$>
                   (o Core..:? "distribution") Core.<*> (o Core..:? "package")
...
newVersion 
    ::  Version
newVersion
  = Version{epoch = Core.Nothing, fullName = Core.Nothing,
            inclusive = Core.Nothing, kind = Core.Nothing, name = Core.Nothing,
            revision = Core.Nothing}
instance Core.FromJSON Version where
        parseJSON
          = Core.withObject "Version"
              (\ o ->
                 Version Core.<$>
                   (o Core..:? "epoch") Core.<*> (o Core..:? "fullName") Core.<*>
                     (o Core..:? "inclusive")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "revision"))
...
newVexAssessment 
    ::  VexAssessment
newVexAssessment
  = VexAssessment{cve = Core.Nothing, impacts = Core.Nothing,
                  justification = Core.Nothing, noteName = Core.Nothing,
                  relatedUris = Core.Nothing, remediations = Core.Nothing,
                  state = Core.Nothing, vulnerabilityId = Core.Nothing}
...
instance Core.FromJSON Volume where
        parseJSON
          = Core.withObject "Volume"
              (\ o ->
                 Volume Core.<$> (o Core..:? "name") Core.<*> (o Core..:? "path"))
...
newVulnerabilityAssessmentNote 
    ::  VulnerabilityAssessmentNote
newVulnerabilityAssessmentNote
  = VulnerabilityAssessmentNote{assessment = Core.Nothing,
                                languageCode = Core.Nothing, longDescription = Core.Nothing,
                                product = Core.Nothing, publisher = Core.Nothing,
          ...
          = Core.withObject "VulnerabilityAssessmentNote"
              (\ o ->
                 VulnerabilityAssessmentNote Core.<$>
                   (o Core..:? "assessment") Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "longDescription")
                     Core.<*> (o Core..:? "product")
...
newVulnerabilityNote 
    ::  VulnerabilityNote
newVulnerabilityNote
  = VulnerabilityNote{cvssScore = Core.Nothing,
                      cvssV2 = Core.Nothing, cvssV3 = Core.Nothing,
                      cvssVersion = Core.Nothing, details = Core.Nothing,
                      severity = Core.Nothing, sourceUpdateTime = Core.Nothing,
          ...
          = Core.withObject "VulnerabilityNote"
              (\ o ->
                 VulnerabilityNote Core.<$>
                   (o Core..:? "cvssScore") Core.<*> (o Core..:? "cvssV2") Core.<*>
                     (o Core..:? "cvssV3")
...
newVulnerabilityOccurrence 
    ::  VulnerabilityOccurrence
newVulnerabilityOccurrence
  = VulnerabilityOccurrence{cvssScore = Core.Nothing,
                            cvssV2 = Core.Nothing, cvssVersion = Core.Nothing,
                            cvssv3 = Core.Nothing, effectiveSeverity = Core.Nothing,
                            extraDetails = Core.Nothing, fixAvailable = Core.Nothing,
                            longDescription = Core.Nothing, packageIssue = Core.Nothing,
                            relatedUrls = Core.Nothing, severity = Core.Nothing,
                            shortDescription = Core.Nothing, type' = Core.Nothing,
...
data VulnerabilityOccurrencesSummary = VulnerabilityOccurrencesSummary
    {
...
instance Core.FromJSON VulnerabilityOccurrencesSummary where
        parseJSON
          = Core.withObject "VulnerabilityOccurrencesSummary"
              (\ o ->
                 VulnerabilityOccurrencesSummary Core.<$>
                   (o Core..:? "counts") Core.<*> (o Core..:? "unreachable"))
...
newWindowsDetail 
    ::  WindowsDetail
newWindowsDetail
  = WindowsDetail{cpeUri = Core.Nothing, description = Core.Nothing,
                  fixingKbs = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON WindowsDetail where
        parseJSON
          = Core.withObject "WindowsDetail"
              (\ o ->
                 WindowsDetail Core.<$>
                   (o Core..:? "cpeUri") Core.<*> (o Core..:? "description") Core.<*>
                     (o Core..:? "fixingKbs")
                     Core.<*> (o Core..:? "name"))
...
newWindowsUpdate 
    ::  WindowsUpdate
newWindowsUpdate
  = WindowsUpdate{categories = Core.Nothing,
                  description = Core.Nothing, identity = Core.Nothing,
                  kbArticleIds = Core.Nothing, lastPublishedTimestamp = Core.Nothing,
                  supportUrl = Core.Nothing, title = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("categories" Core..=) Core.<$> categories,
                  ...
                  ("lastPublishedTimestamp" Core..=) Core.<$> lastPublishedTimestamp,
