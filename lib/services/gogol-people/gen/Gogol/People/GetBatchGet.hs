...
type PeoplePeopleGetBatchGetResource =
     "v1" Core.:>
       "people:batchGet" Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "personFields" Core.FieldMask Core.:>
                 Core.QueryParam "requestMask.includeField"
                   Core.FieldMask
                   Core.:>
                   Core.QueryParams "resourceNames" Core.Text Core.:>
                     Core.QueryParams "sources" PeopleGetBatchGetSources
                       Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GetPeopleResponse
...
instance Core.GoogleRequest PeoplePeopleGetBatchGet
         where
        type Rs PeoplePeopleGetBatchGet = GetPeopleResponse
        type Scopes PeoplePeopleGetBatchGet =
             '[Contacts'FullControl, Contacts'Readonly,
               Directory'Readonly, User'Addresses'Read,
               User'Birthday'Read, User'Emails'Read,
               User'Gender'Read, User'Organization'Read,
               User'Phonenumbers'Read, Userinfo'Email,
               Userinfo'Profile]
