...
instance Core.FromJSON BatchDocumentInputConfig where
        parseJSON
          = Core.withObject "BatchDocumentInputConfig"
              (\ o ->
                 BatchDocumentInputConfig Core.<$>
                   (o Core..:? "gcsSource"))
...
newtype BatchDocumentOutputConfig = BatchDocumentOutputConfig
    {
      ...
      -- and @glossary_error_output@ are the translated output\/error when we apply glossaries. They could also be empty if we have no content to output. Once a row is present in index.csv, the input\/output matching never changes. Callers should also expect all the content in input/file are processed and ready to be consumed (that is, no partial output file is written). Since index.csv will be keeping updated during the process, please make sure there is no custom retention policy applied on the output bucket that may avoid file updating. (https:\/\/cloud.google.com\/storage\/docs\/bucket-lock#retention-policy) The naming format of translation output files follows (for target language code [trg]): @translation_output@: gs:\/\/translation/output\/a/b/c/[trg]/translation.[extension] @glossary_translation_output@: gs:\/\/translation/test\/a/b/c/[trg]/glossary/translation.[extension] The output document will maintain the same file format as the input document. The naming format of error output files follows (for target
      -- language code [trg]): @error_output@: gs:\/\/translation/test\/a/b/c/[trg]/errors.txt @glossary_error_output@: gs:\/\/translation/test\/a/b/c/[trg]/glossary_translation.txt The error output is a txt file containing error details.
...
instance Core.FromJSON BatchDocumentOutputConfig
         where
        parseJSON
          = Core.withObject "BatchDocumentOutputConfig"
              (\ o ->
                 BatchDocumentOutputConfig Core.<$>
...
instance Core.FromJSON BatchTranslateDocumentRequest
         where
        parseJSON
          = Core.withObject "BatchTranslateDocumentRequest"
              (\ o ->
                 BatchTranslateDocumentRequest Core.<$>
                   (o Core..:? "customizedAttribution") Core.<*>
                     (o Core..:? "enableShadowRemovalNativePdf")
...
instance Core.ToJSON BatchTranslateDocumentRequest
         where
        toJSON BatchTranslateDocumentRequest{..}
          = Core.object
              (Core.catMaybes
                 [("customizedAttribution" Core..=) Core.<$>
                    customizedAttribution,
                  ("enableShadowRemovalNativePdf" Core..=) Core.<$>
                    enableShadowRemovalNativePdf,
                  ("formatConversions" Core..=) Core.<$>
                    formatConversions,
                  ...
                  ("sourceLanguageCode" Core..=) Core.<$>
                    sourceLanguageCode,
                  ("targetLanguageCodes" Core..=) Core.<$>
                    targetLanguageCodes])
...
newBatchTranslateDocumentRequest_FormatConversions additional =
  BatchTranslateDocumentRequest_FormatConversions {additional = additional}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BatchTranslateDocumentRequest_Glossaries"
              (\ o ->
                 BatchTranslateDocumentRequest_Glossaries Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BatchTranslateDocumentRequest_Models"
              (\ o ->
                 BatchTranslateDocumentRequest_Models Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON BatchTranslateTextRequest
         where
        parseJSON
          = Core.withObject "BatchTranslateTextRequest"
              (\ o ->
                 BatchTranslateTextRequest Core.<$>
                   (o Core..:? "glossaries") Core.<*>
                     (o Core..:? "inputConfigs")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "models")
                     Core.<*> (o Core..:? "outputConfig")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BatchTranslateTextRequest_Glossaries"
              (\ o ->
                 BatchTranslateTextRequest_Glossaries Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "BatchTranslateTextRequest_Labels"
              (\ o ->
                 BatchTranslateTextRequest_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON BatchTranslateTextRequest_Labels
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "BatchTranslateTextRequest_Models"
              (\ o ->
                 BatchTranslateTextRequest_Models Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON BatchTranslateTextRequest_Models
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("sourceLanguageCode" Core..=) Core.<$>
                    sourceLanguageCode,
                  ("targetLanguageCode" Core..=) Core.<$>
                    targetLanguageCode,
                  ("testExampleCount" Core..=) Core.<$>
                    testExampleCount,
                  ("trainExampleCount" Core..=) Core.<$>
                    trainExampleCount,
                  ("updateTime" Core..=) Core.<$> updateTime,
                  ("validateExampleCount" Core..=) Core.<$>
...
newDatasetInputConfig 
    ::  DatasetInputConfig
newDatasetInputConfig = DatasetInputConfig {inputFiles = Core.Nothing}

instance Core.FromJSON DatasetInputConfig where
        parseJSON
          = Core.withObject "DatasetInputConfig"
              (\ o ->
                 DatasetInputConfig Core.<$>
                   (o Core..:? "inputFiles"))
...
instance Core.ToJSON DatasetInputConfig where
        toJSON DatasetInputConfig{..}
          = Core.object
              (Core.catMaybes
                 [("inputFiles" Core..=) Core.<$> inputFiles])
...
newDatasetOutputConfig 
    ::  DatasetOutputConfig
newDatasetOutputConfig = DatasetOutputConfig {gcsDestination = Core.Nothing}

instance Core.FromJSON DatasetOutputConfig where
        parseJSON
          = Core.withObject "DatasetOutputConfig"
              (\ o ->
                 DatasetOutputConfig Core.<$>
                   (o Core..:? "gcsDestination"))
...
instance Core.FromJSON DetectLanguageRequest where
        parseJSON
          = Core.withObject "DetectLanguageRequest"
              (\ o ->
                 DetectLanguageRequest Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "labels")
...
instance Core.FromJSON DetectLanguageRequest_Labels
         where
        parseJSON
          = Core.withObject "DetectLanguageRequest_Labels"
              (\ o ->
                 DetectLanguageRequest_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DetectLanguageRequest_Labels
         where
...
instance Core.FromJSON DetectLanguageResponse where
        parseJSON
          = Core.withObject "DetectLanguageResponse"
              (\ o ->
                 DetectLanguageResponse Core.<$>
                   (o Core..:? "languages"))
...
instance Core.FromJSON DocumentInputConfig where
        parseJSON
          = Core.withObject "DocumentInputConfig"
              (\ o ->
...
instance Core.FromJSON DocumentOutputConfig where
        parseJSON
          = Core.withObject "DocumentOutputConfig"
              (\ o ->
...
instance Core.FromJSON DocumentTranslation where
        parseJSON
          = Core.withObject "DocumentTranslation"
              (\ o ->
                 DocumentTranslation Core.<$>
                   (o Core..:? "byteStreamOutputs") Core.<*>
                     (o Core..:? "detectedLanguageCode")
                     Core.<*> (o Core..:? "mimeType"))
...
instance Core.ToJSON DocumentTranslation where
        toJSON DocumentTranslation{..}
          = Core.object
              (Core.catMaybes
                 [("byteStreamOutputs" Core..=) Core.<$>
                    byteStreamOutputs,
                  ("detectedLanguageCode" Core..=) Core.<$>
...
data Example = Example
    {
      -- | Output only. The resource name of the example, in form of \`projects\/{project-number-or-id}\/locations\/{location/id}\/datasets\/{dataset/id}\/examples\/{example_id}\'
      name :: (Core.Maybe Core.Text)
...
newExportDataRequest 
    ::  ExportDataRequest
newExportDataRequest = ExportDataRequest {outputConfig = Core.Nothing}

instance Core.FromJSON ExportDataRequest where
        parseJSON
          = Core.withObject "ExportDataRequest"
              (\ o ->
                 ExportDataRequest Core.<$>
                   (o Core..:? "outputConfig"))
...
instance Core.FromJSON GcsInputSource where
        parseJSON
          = Core.withObject "GcsInputSource"
              (\ o ->
                 GcsInputSource Core.<$> (o Core..:? "inputUri"))
...
newGcsOutputDestination 
    ::  GcsOutputDestination
newGcsOutputDestination = GcsOutputDestination {outputUriPrefix = Core.Nothing}

instance Core.FromJSON GcsOutputDestination where
        parseJSON
          = Core.withObject "GcsOutputDestination"
              (\ o ->
                 GcsOutputDestination Core.<$>
                   (o Core..:? "outputUriPrefix"))
...
instance Core.FromJSON GlossaryInputConfig where
        parseJSON
          = Core.withObject "GlossaryInputConfig"
              (\ o ->
                 GlossaryInputConfig Core.<$>
                   (o Core..:? "gcsSource"))
...
newGlossaryTermsPair 
    ::  GlossaryTermsPair
newGlossaryTermsPair =
  GlossaryTermsPair {sourceTerm = Core.Nothing, targetTerm = Core.Nothing}

instance Core.FromJSON GlossaryTermsPair where
        parseJSON
          = Core.withObject "GlossaryTermsPair"
              (\ o ->
                 GlossaryTermsPair Core.<$>
                   (o Core..:? "sourceTerm") Core.<*>
                     (o Core..:? "targetTerm"))
...
instance Core.FromJSON GlossaryTermsSet where
        parseJSON
          = Core.withObject "GlossaryTermsSet"
              (\ o ->
                 GlossaryTermsSet Core.<$> (o Core..:? "terms"))
...
newImportDataRequest 
    ::  ImportDataRequest
newImportDataRequest = ImportDataRequest {inputConfig = Core.Nothing}

instance Core.FromJSON ImportDataRequest where
        parseJSON
          = Core.withObject "ImportDataRequest"
              (\ o ->
                 ImportDataRequest Core.<$>
                   (o Core..:? "inputConfig"))
...
newInputFile 
    ::  InputFile
newInputFile = InputFile {gcsSource = Core.Nothing, usage = Core.Nothing}

instance Core.FromJSON InputFile where
        parseJSON
          = Core.withObject "InputFile"
              (\ o ->
                 InputFile Core.<$>
                   (o Core..:? "gcsSource") Core.<*>
                     (o Core..:? "usage"))
...
newLanguageCodePair =
  LanguageCodePair
    {sourceLanguageCode = Core.Nothing, targetLanguageCode = Core.Nothing}

instance Core.FromJSON LanguageCodePair where
        parseJSON
          = Core.withObject "LanguageCodePair"
              (\ o ->
                 LanguageCodePair Core.<$>
                   (o Core..:? "sourceLanguageCode") Core.<*>
                     (o Core..:? "targetLanguageCode"))
...
instance Core.FromJSON LanguageCodesSet where
        parseJSON
          = Core.withObject "LanguageCodesSet"
              (\ o ->
                 LanguageCodesSet Core.<$>
                   (o Core..:? "languageCodes"))
...
newListExamplesResponse 
    ::  ListExamplesResponse
newListExamplesResponse =
  ListExamplesResponse {examples = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListExamplesResponse where
        parseJSON
          = Core.withObject "ListExamplesResponse"
              (\ o ->
                 ListExamplesResponse Core.<$>
                   (o Core..:? "examples") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListGlossariesResponse =
  ListGlossariesResponse
    {glossaries = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListGlossariesResponse where
        parseJSON
          = Core.withObject "ListGlossariesResponse"
              (\ o ->
                 ListGlossariesResponse Core.<$>
                   (o Core..:? "glossaries") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListGlossaryEntriesResponse =
  ListGlossaryEntriesResponse
    {glossaryEntries = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListGlossaryEntriesResponse
         where
        parseJSON
          = Core.withObject "ListGlossaryEntriesResponse"
              (\ o ->
                 ListGlossaryEntriesResponse Core.<$>
                   (o Core..:? "glossaryEntries") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListGlossaryEntriesResponse
         where
        toJSON ListGlossaryEntriesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("glossaryEntries" Core..=) Core.<$>
                    glossaryEntries,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
instance Core.FromJSON SupportedLanguage where
        parseJSON
          = Core.withObject "SupportedLanguage"
              (\ o ->
                 SupportedLanguage Core.<$>
                   (o Core..:? "displayName") Core.<*>
                     (o Core..:? "languageCode")
...
instance Core.FromJSON SupportedLanguages where
        parseJSON
          = Core.withObject "SupportedLanguages"
              (\ o ->
...
instance Core.FromJSON TranslateDocumentRequest where
        parseJSON
          = Core.withObject "TranslateDocumentRequest"
              (\ o ->
                 TranslateDocumentRequest Core.<$>
                   (o Core..:? "customizedAttribution") Core.<*>
                     (o Core..:? "documentInputConfig")
        ...
        toJSON TranslateDocumentRequest{..}
          = Core.object
              (Core.catMaybes
                 [("customizedAttribution" Core..=) Core.<$>
                    customizedAttribution,
                  ("documentInputConfig" Core..=) Core.<$>
                    documentInputConfig,
                  ("documentOutputConfig" Core..=) Core.<$>
                    documentOutputConfig,
                  ("enableRotationCorrection" Core..=) Core.<$>
                    enableRotationCorrection,
                  ("enableShadowRemovalNativePdf" Core..=) Core.<$>
                    enableShadowRemovalNativePdf,
                  ("glossaryConfig" Core..=) Core.<$> glossaryConfig,
                  ("isTranslateNativePdfOnly" Core..=) Core.<$>
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "TranslateDocumentRequest_Labels"
              (\ o ->
                 TranslateDocumentRequest_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON TranslateDocumentRequest_Labels
         where
...
instance Core.FromJSON TranslateDocumentResponse
         where
        parseJSON
          = Core.withObject "TranslateDocumentResponse"
              (\ o ->
                 TranslateDocumentResponse Core.<$>
                   (o Core..:? "documentTranslation") Core.<*>
                     (o Core..:? "glossaryConfig")
...
instance Core.ToJSON TranslateDocumentResponse where
        toJSON TranslateDocumentResponse{..}
          = Core.object
              (Core.catMaybes
                 [("documentTranslation" Core..=) Core.<$>
                    documentTranslation,
                  ("glossaryConfig" Core..=) Core.<$> glossaryConfig,
                  ("glossaryDocumentTranslation" Core..=) Core.<$>
...
newTranslateTextGlossaryConfig =
  TranslateTextGlossaryConfig
    {glossary = Core.Nothing, ignoreCase = Core.Nothing}

instance Core.FromJSON TranslateTextGlossaryConfig
         where
        parseJSON
          = Core.withObject "TranslateTextGlossaryConfig"
              (\ o ->
                 TranslateTextGlossaryConfig Core.<$>
                   (o Core..:? "glossary") Core.<*>
                     (o Core..:? "ignoreCase"))

instance Core.ToJSON TranslateTextGlossaryConfig
         where
...
instance Core.FromJSON TranslateTextRequest where
        parseJSON
          = Core.withObject "TranslateTextRequest"
              (\ o ->
                 TranslateTextRequest Core.<$>
...
instance Core.FromJSON TranslateTextRequest_Labels
         where
        parseJSON
          = Core.withObject "TranslateTextRequest_Labels"
              (\ o ->
                 TranslateTextRequest_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON TranslateTextRequest_Labels
         where
...
newTranslateTextResponse =
  TranslateTextResponse
    {glossaryTranslations = Core.Nothing, translations = Core.Nothing}

instance Core.FromJSON TranslateTextResponse where
        parseJSON
          = Core.withObject "TranslateTextResponse"
              (\ o ->
                 TranslateTextResponse Core.<$>
                   (o Core..:? "glossaryTranslations") Core.<*>
                     (o Core..:? "translations"))
...
instance Core.ToJSON TranslateTextResponse where
        toJSON TranslateTextResponse{..}
          = Core.object
              (Core.catMaybes
                 [("glossaryTranslations" Core..=) Core.<$>
...
instance Core.FromJSON Translation where
        parseJSON
          = Core.withObject "Translation"
              (\ o ->
                 Translation Core.<$>
                   (o Core..:? "detectedLanguageCode") Core.<*>
                     (o Core..:? "glossaryConfig")
                     Core.<*> (o Core..:? "model")
...
instance Core.FromJSON WaitOperationRequest where
        parseJSON
          = Core.withObject "WaitOperationRequest"
              (\ o ->
