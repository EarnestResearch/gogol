...
-- |
-- Module      : Gogol.Healthcare.Projects.Locations.Datasets.GetIamPolicy
...
-- 'HealthcareProjectsLocationsDatasetsGetIamPolicy' request conforms to.
type HealthcareProjectsLocationsDatasetsGetIamPolicyResource
     =
     "v1" Core.:>
...
-- | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
--
-- /See:/ 'newHealthcareProjectsLocationsDatasetsGetIamPolicy' smart constructor.
data HealthcareProjectsLocationsDatasetsGetIamPolicy = HealthcareProjectsLocationsDatasetsGetIamPolicy
    {
      -- | V1 error format.
...
-- | Creates a value of 'HealthcareProjectsLocationsDatasetsGetIamPolicy' with the minimum fields required to make a request.
newHealthcareProjectsLocationsDatasetsGetIamPolicy 
    ::  Core.Text
    ...
    -> HealthcareProjectsLocationsDatasetsGetIamPolicy
newHealthcareProjectsLocationsDatasetsGetIamPolicy resource =
  HealthcareProjectsLocationsDatasetsGetIamPolicy
    { xgafv = Core.Nothing
