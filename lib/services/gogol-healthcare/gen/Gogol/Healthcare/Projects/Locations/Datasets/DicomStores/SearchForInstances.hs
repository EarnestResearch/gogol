...
-- |
-- Module      : Gogol.Healthcare.Projects.Locations.Datasets.DicomStores.SearchForInstances
...
-- 'HealthcareProjectsLocationsDatasetsDicomStoresSearchForInstances' request conforms to.
type HealthcareProjectsLocationsDatasetsDicomStoresSearchForInstancesResource
     =
     "v1" Core.:>
...
-- | SearchForInstances returns a list of matching instances. See [Search Transaction] (http:\/\/dicom.nema.org\/medical\/dicom\/current\/output\/html\/part18.html#sect_10.6). For details on the implementation of SearchForInstances, see <https://cloud.google.com/healthcare/docs/dicom#search_transaction Search transaction> in the Cloud Healthcare API conformance statement. For samples that show how to call SearchForInstances, see <https://cloud.google.com/healthcare/docs/how-tos/dicomweb#search-dicom Search for DICOM data>.
--
-- /See:/ 'newHealthcareProjectsLocationsDatasetsDicomStoresSearchForInstances' smart constructor.
data HealthcareProjectsLocationsDatasetsDicomStoresSearchForInstances = HealthcareProjectsLocationsDatasetsDicomStoresSearchForInstances
    {
      -- | V1 error format.
...
-- | Creates a value of 'HealthcareProjectsLocationsDatasetsDicomStoresSearchForInstances' with the minimum fields required to make a request.
newHealthcareProjectsLocationsDatasetsDicomStoresSearchForInstances 
    :: 
                                                                    Core.Text
       -- ^  Required. The path of the SearchForInstancesRequest DICOMweb request. For example, @instances@, @series\/{series_uid}\/instances@, or @studies\/{study_uid}\/instances@. See 'dicomWebPath'.
    -> Core.Text
...
newHealthcareProjectsLocationsDatasetsDicomStoresSearchForInstances
  dicomWebPath parent
  = HealthcareProjectsLocationsDatasetsDicomStoresSearchForInstances{xgafv
                                                                       = Core.Nothing,
