...
newHealthcareProjectsLocationsDatasetsConsentStoresAttributeDefinitionsPatch 
    ::  Core.Text
       -- ^  Resource name of the Attribute definition, of the form @projects\/{project_id}\/locations\/{location_id}\/datasets\/{dataset_id}\/consentStores\/{consent_store_id}\/attributeDefinitions\/{attribute_definition_id}@. Cannot be changed after creation. See 'name'.
    -> AttributeDefinition
