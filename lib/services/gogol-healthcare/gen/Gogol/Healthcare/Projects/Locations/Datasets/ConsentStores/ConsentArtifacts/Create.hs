                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] ConsentArtifact Core.:>
                         Core.Post '[Core.JSON] ConsentArtifact
...
newHealthcareProjectsLocationsDatasetsConsentStoresConsentArtifactsCreate 
    ...
    -> HealthcareProjectsLocationsDatasetsConsentStoresConsentArtifactsCreate
newHealthcareProjectsLocationsDatasetsConsentStoresConsentArtifactsCreate parent payload =
  HealthcareProjectsLocationsDatasetsConsentStoresConsentArtifactsCreate
    { xgafv = Core.Nothing
