...
type HealthcareProjectsLocationsDatasetsDicomStoresDeidentifyResource
     =
     "v1" Core.:>
       Core.CaptureMode "sourceStore" "deidentify" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DeidentifyDicomStoreRequest
...
newHealthcareProjectsLocationsDatasetsDicomStoresDeidentify 
    ...
    -> Core.Text
       -- ^  Source DICOM store resource name. For example, @projects\/{project_id}\/locations\/{location_id}\/datasets\/{dataset_id}\/dicomStores\/{dicom_store_id}@. See 'sourceStore'.
    -> HealthcareProjectsLocationsDatasetsDicomStoresDeidentify
newHealthcareProjectsLocationsDatasetsDicomStoresDeidentify payload sourceStore =
  HealthcareProjectsLocationsDatasetsDicomStoresDeidentify
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsDicomStoresDeidentify{..}
          = go sourceStore xgafv accessToken callback
              uploadType
              uploadProtocol
