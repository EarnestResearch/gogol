...
-- |
-- Module      : Gogol.Healthcare.Projects.Locations.Datasets.ConsentStores.Consents.ListRevisions
...
type HealthcareProjectsLocationsDatasetsConsentStoresConsentsListRevisionsResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "listRevisions" Core.Text
         Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListConsentRevisionsResponse
