...
newHealthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesRetrieveMetadata 
    ::  Core.Text
       -- ^  The path of the RetrieveSeriesMetadata DICOMweb request. For example, @studies\/{study_uid}\/series\/{series_uid}\/metadata@. See 'dicomWebPath'.
    -> Core.Text
    ...
    -> HealthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesRetrieveMetadata
newHealthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesRetrieveMetadata dicomWebPath parent =
  HealthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesRetrieveMetadata
    { xgafv = Core.Nothing
