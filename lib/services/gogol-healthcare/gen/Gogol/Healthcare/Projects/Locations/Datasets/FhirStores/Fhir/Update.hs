...
--
-- Updates the entire contents of a resource. Implements the FHIR standard update interaction (<https://hl7.org/fhir/DSTU2/http.html#update DSTU2>, <https://hl7.org/fhir/STU3/http.html#update STU3>, <https://hl7.org/fhir/R4/http.html#update R4>, <https://hl7.org/fhir/R5/http.html#update R5>). If the specified resource does not exist and the FHIR store has enable/update/create set, creates the resource with the client-specified ID. It is strongly advised not to include or encode any sensitive data such as patient identifiers in client-specified resource IDs. Those IDs are part of the FHIR resource path recorded in Cloud Audit Logs and Pub\/Sub notifications. Those IDs can also be contained in reference fields within other resources. The request body must contain a JSON-encoded FHIR resource, and the request headers must contain @Content-Type: application\/fhir+json@. The resource must contain an @id@ element having an identical value to the ID in the REST path of the request. On success, the response body
...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirUpdate 
    ...
    -> HealthcareProjectsLocationsDatasetsFhirStoresFhirUpdate
newHealthcareProjectsLocationsDatasetsFhirStoresFhirUpdate name
  payload
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirUpdate{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresFhirUpdate
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresFhirUpdate =
             HttpBody
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresFhirUpdate
