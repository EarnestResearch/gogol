           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "_count" Core.Int32 Core.:>
               Core.QueryParam "_page_token" Core.Text Core.:>
                 Core.QueryParam "_since" Core.Text Core.:>
                   Core.QueryParam "_type" Core.Text Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "end" Core.Text Core.:>
                           Core.QueryParam "start" Core.Text Core.:>
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresFhirPatienteverything{..}
          = go name xgafv count pageToken since type'
              accessToken
              callback
              end
              start
