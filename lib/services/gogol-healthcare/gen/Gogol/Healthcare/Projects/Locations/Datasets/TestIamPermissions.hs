...
-- |
-- Module      : Gogol.Healthcare.Projects.Locations.Datasets.TestIamPermissions
...
-- 'HealthcareProjectsLocationsDatasetsTestIamPermissions' request conforms to.
type HealthcareProjectsLocationsDatasetsTestIamPermissionsResource
     =
     "v1" Core.:>
...
-- | Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a @NOT_FOUND@ error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may \"fail open\" without warning.
--
-- /See:/ 'newHealthcareProjectsLocationsDatasetsTestIamPermissions' smart constructor.
data HealthcareProjectsLocationsDatasetsTestIamPermissions = HealthcareProjectsLocationsDatasetsTestIamPermissions
    {
      -- | V1 error format.
...
-- | Creates a value of 'HealthcareProjectsLocationsDatasetsTestIamPermissions' with the minimum fields required to make a request.
newHealthcareProjectsLocationsDatasetsTestIamPermissions 
    ...
    -> HealthcareProjectsLocationsDatasetsTestIamPermissions
newHealthcareProjectsLocationsDatasetsTestIamPermissions payload resource =
  HealthcareProjectsLocationsDatasetsTestIamPermissions
    { xgafv = Core.Nothing
