...
-- |
-- Module      : Gogol.Healthcare.Projects.Locations.Datasets.DicomStores.TestIamPermissions
...
-- 'HealthcareProjectsLocationsDatasetsDicomStoresTestIamPermissions' request conforms to.
type HealthcareProjectsLocationsDatasetsDicomStoresTestIamPermissionsResource
     =
     "v1" Core.:>
...
-- | Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a @NOT_FOUND@ error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may \"fail open\" without warning.
--
-- /See:/ 'newHealthcareProjectsLocationsDatasetsDicomStoresTestIamPermissions' smart constructor.
data HealthcareProjectsLocationsDatasetsDicomStoresTestIamPermissions = HealthcareProjectsLocationsDatasetsDicomStoresTestIamPermissions
    {
      -- | V1 error format.
...
-- | Creates a value of 'HealthcareProjectsLocationsDatasetsDicomStoresTestIamPermissions' with the minimum fields required to make a request.
newHealthcareProjectsLocationsDatasetsDicomStoresTestIamPermissions 
    ...
    -> HealthcareProjectsLocationsDatasetsDicomStoresTestIamPermissions
newHealthcareProjectsLocationsDatasetsDicomStoresTestIamPermissions payload resource =
  HealthcareProjectsLocationsDatasetsDicomStoresTestIamPermissions
    { xgafv = Core.Nothing
