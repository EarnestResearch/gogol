...
-- |
-- Module      : Gogol.Healthcare.Projects.Locations.Datasets.Hl7V2Stores.SetIamPolicy
...
-- 'HealthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy' request conforms to.
type HealthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicyResource
     =
     "v1" Core.:>
...
-- | Sets the access control policy on the specified resource. Replaces any existing policy. Can return @NOT_FOUND@, @INVALID_ARGUMENT@, and @PERMISSION_DENIED@ errors.
--
-- /See:/ 'newHealthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy' smart constructor.
data HealthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy = HealthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy
    {
      -- | V1 error format.
...
-- | Creates a value of 'HealthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy' with the minimum fields required to make a request.
newHealthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy 
    ::  SetIamPolicyRequest
    ...
    -> HealthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy
newHealthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy payload resource =
  HealthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy
    { xgafv = Core.Nothing
