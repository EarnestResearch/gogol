...
newHealthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesInstancesRetrieveMetadata 
    :: 
                                                                                        Core.Text
       -- ^  Required. The path of the RetrieveInstanceMetadata DICOMweb request. For example, @studies\/{study_uid}\/series\/{series_uid}\/instances\/{instance_uid}\/metadata@. See 'dicomWebPath'.
    -> Core.Text
...
newHealthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesInstancesRetrieveMetadata
  dicomWebPath parent
  = HealthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesInstancesRetrieveMetadata{xgafv
                                                                                           =
                                                                                           Core.Nothing,
                                                                                         accessToken
                                                                                           =
