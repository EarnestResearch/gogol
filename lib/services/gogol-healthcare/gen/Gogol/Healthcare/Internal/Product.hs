...
newAnalyzeEntitiesRequest =
  AnalyzeEntitiesRequest
    {documentContent = Core.Nothing, licensedVocabularies = Core.Nothing}
          ...
          = Core.withObject "AnalyzeEntitiesRequest"
              (\ o ->
                 AnalyzeEntitiesRequest Core.<$>
                   (o Core..:? "documentContent") Core.<*>
                     (o Core..:? "licensedVocabularies"))

instance Core.ToJSON AnalyzeEntitiesRequest where
        toJSON AnalyzeEntitiesRequest{..}
          = Core.object
              (Core.catMaybes
                 [("documentContent" Core..=) Core.<$>
                    documentContent,
                  ("licensedVocabularies" Core..=) Core.<$>
          ...
          = Core.withObject "AnalyzeEntitiesResponse"
              (\ o ->
                 AnalyzeEntitiesResponse Core.<$>
                   (o Core..:? "entities") Core.<*>
                     (o Core..:? "entityMentions")
...
instance Core.FromJSON ArchiveUserDataMappingRequest
         where
        parseJSON
          = Core.withObject "ArchiveUserDataMappingRequest"
              (\ o -> Core.pure ArchiveUserDataMappingRequest)

instance Core.ToJSON ArchiveUserDataMappingRequest
         where
...
instance Core.FromJSON ArchiveUserDataMappingResponse
         where
        parseJSON
          = Core.withObject "ArchiveUserDataMappingResponse"
              (\ o -> Core.pure ArchiveUserDataMappingResponse)

instance Core.ToJSON ArchiveUserDataMappingResponse
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.ToJSON Attribute where
        toJSON Attribute{..}
          = Core.object
              (Core.catMaybes
                 [("attributeDefinitionId" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("allowedValues" Core..=) Core.<$> allowedValues,
                  ...
                  ("consentDefaultValues" Core..=) Core.<$>
...
newCheckDataAccessResponse =
  CheckDataAccessResponse
    {consentDetails = Core.Nothing, consented = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("consentContentScreenshots" Core..=) Core.<$>
                  ...
                  ("consentContentVersion" Core..=) Core.<$>
                    consentContentVersion,
                  ("guardianSignature" Core..=) Core.<$>
                    guardianSignature,
                  ("metadata" Core..=) Core.<$> metadata,
                  ("name" Core..=) Core.<$> name,
                  ("userId" Core..=) Core.<$> userId,
                  ("userSignature" Core..=) Core.<$> userSignature,
                  ("witnessSignature" Core..=) Core.<$>
                    witnessSignature])
...
instance Core.FromJSON ConsentEvaluation where
        parseJSON
          = Core.withObject "ConsentEvaluation"
              (\ o ->
                 ConsentEvaluation Core.<$>
                   (o Core..:? "evaluationResult"))
...
instance Core.FromJSON Dataset where
        parseJSON
          = Core.withObject "Dataset"
              (\ o ->
                 Dataset Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "timeZone"))
...
instance Core.FromJSON DeidentifiedStoreDestination
         where
        parseJSON
...
instance Core.ToJSON DeidentifiedStoreDestination
         where
...
instance Core.FromJSON DeidentifyDicomStoreRequest
         where
        parseJSON
          = Core.withObject "DeidentifyDicomStoreRequest"
              (\ o ->
                 DeidentifyDicomStoreRequest Core.<$>
                   (o Core..:? "config") Core.<*>
                     (o Core..:? "destinationStore")
                     Core.<*> (o Core..:? "filterConfig")
                     Core.<*> (o Core..:? "gcsConfigUri"))

instance Core.ToJSON DeidentifyDicomStoreRequest
         where
        toJSON DeidentifyDicomStoreRequest{..}
          = Core.object
              (Core.catMaybes
                 [("config" Core..=) Core.<$> config,
                  ("destinationStore" Core..=) Core.<$>
                    destinationStore,
...
instance Core.FromJSON DeidentifyFhirStoreRequest
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("config" Core..=) Core.<$> config,
                  ...
                  ("skipModifiedResources" Core..=) Core.<$>
...
instance Core.FromJSON DicomFilterConfig where
        parseJSON
          = Core.withObject "DicomFilterConfig"
              (\ o ->
                 DicomFilterConfig Core.<$>
                   (o Core..:? "resourcePathsGcsUri"))

instance Core.ToJSON DicomFilterConfig where
        toJSON DicomFilterConfig{..}
          = Core.object
              (Core.catMaybes
                 [("resourcePathsGcsUri" Core..=) Core.<$>
                    resourcePathsGcsUri])
...
instance Core.FromJSON EntityMentionRelationship
         where
        parseJSON
...
instance Core.FromJSON EvaluateUserConsentsRequest
         where
        parseJSON
...
instance Core.ToJSON EvaluateUserConsentsRequest
         where
...
newEvaluateUserConsentsResponse =
  EvaluateUserConsentsResponse
    {nextPageToken = Core.Nothing, results = Core.Nothing}

instance Core.FromJSON EvaluateUserConsentsResponse
         where
        parseJSON
...
instance Core.ToJSON EvaluateUserConsentsResponse
         where
...
newExportDicomDataRequest =
  ExportDicomDataRequest
    {bigqueryDestination = Core.Nothing, gcsDestination = Core.Nothing}
          ...
          = Core.withObject "ExportResourcesRequest"
              (\ o ->
                 ExportResourcesRequest Core.<$>
                   (o Core..:? "_since") Core.<*> (o Core..:? "_type")
...
newFhirConfig =
  FhirConfig
    {defaultKeepExtensions = Core.Nothing, fieldMetadataList = Core.Nothing}
...
instance Core.ToJSON FhirConfig where
        toJSON FhirConfig{..}
          = Core.object
              (Core.catMaybes
                 [("defaultKeepExtensions" Core..=) Core.<$>
                    defaultKeepExtensions,
                  ("fieldMetadataList" Core..=) Core.<$>
                    fieldMetadataList])
...
data FhirNotificationConfig = FhirNotificationConfig
    {
      ...
      -- errors are logged to Cloud Logging. For more information, see <https://cloud.google.com/healthcare-api/docs/how-tos/logging Viewing error logs in Cloud Logging>.
          ...
          = Core.object
              (Core.catMaybes
                 [("complexDataTypeReferenceParsing" Core..=) Core.<$>
                  ...
                  ("enableUpdateCreate" Core..=) Core.<$>
                    enableUpdateCreate,
                  ("labels" Core..=) Core.<$> labels,
                  ("name" Core..=) Core.<$> name,
                  ("notificationConfig" Core..=) Core.<$>
                    notificationConfig,
                  ("notificationConfigs" Core..=) Core.<$>
                    notificationConfigs,
                  ("streamConfigs" Core..=) Core.<$> streamConfigs,
                  ("validationConfig" Core..=) Core.<$>
                    validationConfig,
          ...
          = Core.object
              (Core.catMaybes
                 [("count" Core..=) Core.. Core.AsText Core.<$> count,
                  ...
                  ("structuredStorageSizeBytes" Core..=) Core..
                    Core.AsText
...
newGoogleCloudHealthcareV1ConsentPolicy =
  GoogleCloudHealthcareV1ConsentPolicy
    {authorizationRule = Core.Nothing, resourceAttributes = Core.Nothing}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudHealthcareV1DicomBigQueryDestination
                   Core.<$>
                   (o Core..:? "force") Core.<*> (o Core..:? "tableUri")
...
newGoogleCloudHealthcareV1DicomGcsDestination =
  GoogleCloudHealthcareV1DicomGcsDestination
    {mimeType = Core.Nothing, uriPrefix = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudHealthcareV1DicomGcsSource"
              (\ o ->
                 GoogleCloudHealthcareV1DicomGcsSource Core.<$>
                   (o Core..:? "uri"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudHealthcareV1FhirGcsSource"
              (\ o ->
                 GoogleCloudHealthcareV1FhirGcsSource Core.<$>
                   (o Core..:? "uri"))
...
instance Core.ToJSON Hl7SchemaConfig where
        toJSON Hl7SchemaConfig{..}
          = Core.object
              (Core.catMaybes
                 [("messageSchemaConfigs" Core..=) Core.<$>
...
instance Core.FromJSON ImageConfig where
        parseJSON
          = Core.withObject "ImageConfig"
              (\ o ->
                 ImageConfig Core.<$>
                   (o Core..:? "textRedactionMode"))

instance Core.ToJSON ImageConfig where
        toJSON ImageConfig{..}
          = Core.object
              (Core.catMaybes
                 [("textRedactionMode" Core..=) Core.<$>
                    textRedactionMode])
...
newImportResourcesRequest =
  ImportResourcesRequest
    {contentStructure = Core.Nothing, gcsSource = Core.Nothing}
...
newListAttributeDefinitionsResponse =
  ListAttributeDefinitionsResponse
    {attributeDefinitions = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.ToJSON ListAttributeDefinitionsResponse
         where
        toJSON ListAttributeDefinitionsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("attributeDefinitions" Core..=) Core.<$>
...
newListConsentArtifactsResponse =
  ListConsentArtifactsResponse
    {consentArtifacts = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListConsentArtifactsResponse
         where
        parseJSON
...
instance Core.ToJSON ListConsentArtifactsResponse
         where
        toJSON ListConsentArtifactsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("consentArtifacts" Core..=) Core.<$>
                    consentArtifacts,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListConsentRevisionsResponse =
  ListConsentRevisionsResponse
    {consents = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListConsentRevisionsResponse
         where
        parseJSON
          = Core.withObject "ListConsentRevisionsResponse"
              (\ o ->
                 ListConsentRevisionsResponse Core.<$>
                   (o Core..:? "consents") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListConsentRevisionsResponse
         where
...
newListConsentStoresResponse =
  ListConsentStoresResponse
    {consentStores = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListConsentStoresResponse
         where
        parseJSON
          = Core.withObject "ListConsentStoresResponse"
              (\ o ->
                 ListConsentStoresResponse Core.<$>
                   (o Core..:? "consentStores") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListDicomStoresResponse =
  ListDicomStoresResponse
    {dicomStores = Core.Nothing, nextPageToken = Core.Nothing}
...
newListFhirStoresResponse =
  ListFhirStoresResponse
    {fhirStores = Core.Nothing, nextPageToken = Core.Nothing}
...
newListHl7V2StoresResponse =
  ListHl7V2StoresResponse
    {hl7V2Stores = Core.Nothing, nextPageToken = Core.Nothing}
...
newListMessagesResponse =
  ListMessagesResponse
    {hl7V2Messages = Core.Nothing, nextPageToken = Core.Nothing}
...
newListUserDataMappingsResponse =
  ListUserDataMappingsResponse
    {nextPageToken = Core.Nothing, userDataMappings = Core.Nothing}

instance Core.FromJSON ListUserDataMappingsResponse
         where
        parseJSON
...
instance Core.ToJSON ListUserDataMappingsResponse
         where
        toJSON ListUserDataMappingsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("userDataMappings" Core..=) Core.<$>
                    userDataMappings])
...
instance Core.ToJSON ParserConfig where
        toJSON ParserConfig{..}
          = Core.object
              (Core.catMaybes
                 [("allowNullHeader" Core..=) Core.<$>
                    allowNullHeader,
                  ("schema" Core..=) Core.<$> schema,
                  ("segmentTerminator" Core..=) Core.<$>
                    segmentTerminator,
                  ("version" Core..=) Core.<$> version])
...
newProgressCounter =
  ProgressCounter
    {failure = Core.Nothing, pending = Core.Nothing, success = Core.Nothing}
...
instance Core.ToJSON ProgressCounter where
        toJSON ProgressCounter{..}
          = Core.object
              (Core.catMaybes
                 [("failure" Core..=) Core.. Core.AsText Core.<$>
                    failure,
                  ("pending" Core..=) Core.. Core.AsText Core.<$>
                    pending,
                  ("success" Core..=) Core.. Core.AsText Core.<$>
                    success])
...
instance Core.FromJSON QueryAccessibleDataRequest
         where
        parseJSON
...
instance Core.FromJSON QueryAccessibleDataResponse
         where
        parseJSON
          = Core.withObject "QueryAccessibleDataResponse"
              (\ o ->
                 QueryAccessibleDataResponse Core.<$>
                   (o Core..:? "gcsUris"))

instance Core.ToJSON QueryAccessibleDataResponse
         where
...
instance Core.FromJSON RejectConsentRequest where
        parseJSON
          = Core.withObject "RejectConsentRequest"
              (\ o ->
                 RejectConsentRequest Core.<$>
                   (o Core..:? "consentArtifact"))
...
instance Core.FromJSON ReplaceWithInfoTypeConfig
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("lastUpdatedPartitionConfig" Core..=) Core.<$>
                  ...
                  ("recursiveStructureDepth" Core..=) Core..
                    Core.AsText
...
instance Core.ToJSON SchemaPackage where
        toJSON SchemaPackage{..}
          = Core.object
              (Core.catMaybes
                 [("ignoreMinOccurs" Core..=) Core.<$>
                    ignoreMinOccurs,
                  ("schemas" Core..=) Core.<$> schemas,
                  ("schematizedParsingType" Core..=) Core.<$>
...
newSchemaSegment =
  SchemaSegment
    {maxOccurs = Core.Nothing, minOccurs = Core.Nothing, type' = Core.Nothing}
...
newSegment =
  Segment
    {fields = Core.Nothing, segmentId = Core.Nothing, setId = Core.Nothing}
...
instance Core.FromJSON Signature where
        parseJSON
          = Core.withObject "Signature"
              (\ o ->
                 Signature Core.<$>
                   (o Core..:? "image") Core.<*> (o Core..:? "metadata")
...
newTextConfig =
  TextConfig
    { additionalTransformations = Core.Nothing
    , excludeInfoTypes = Core.Nothing
    , transformations = Core.Nothing
    }
              ...
              (\ o ->
                 ValidationConfig Core.<$>
                   (o Core..:? "disableFhirpathValidation") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "disableReferenceTypeValidation")
                     Core.<*>
                     (o Core..:? "disableRequiredFieldValidation")
