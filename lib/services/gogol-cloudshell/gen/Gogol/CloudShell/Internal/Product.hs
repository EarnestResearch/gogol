...
instance Core.FromJSON AddPublicKeyMetadata where
        parseJSON
          = Core.withObject "AddPublicKeyMetadata"
...
instance Core.FromJSON AddPublicKeyRequest where
        parseJSON
          = Core.withObject "AddPublicKeyRequest"
...
instance Core.FromJSON AddPublicKeyResponse where
        parseJSON
          = Core.withObject "AddPublicKeyResponse"
...
instance Core.FromJSON AuthorizeEnvironmentMetadata where
        parseJSON
          = Core.withObject "AuthorizeEnvironmentMetadata"
...
newAuthorizeEnvironmentRequest 
    ::  AuthorizeEnvironmentRequest
newAuthorizeEnvironmentRequest
  = AuthorizeEnvironmentRequest{accessToken = Core.Nothing,
                                expireTime = Core.Nothing, idToken = Core.Nothing}
instance Core.FromJSON AuthorizeEnvironmentRequest where
        parseJSON
          = Core.withObject "AuthorizeEnvironmentRequest"
              (\ o ->
                 AuthorizeEnvironmentRequest Core.<$>
                   (o Core..:? "accessToken") Core.<*> (o Core..:? "expireTime")
                     Core.<*> (o Core..:? "idToken"))
...
instance Core.FromJSON AuthorizeEnvironmentResponse where
        parseJSON
          = Core.withObject "AuthorizeEnvironmentResponse"
...
instance Core.FromJSON CreateEnvironmentMetadata where
        parseJSON
          = Core.withObject "CreateEnvironmentMetadata"
...
instance Core.FromJSON DeleteEnvironmentMetadata where
        parseJSON
          = Core.withObject "DeleteEnvironmentMetadata"
...
newEnvironment 
    ::  Environment
newEnvironment
  = Environment{dockerImage = Core.Nothing, id = Core.Nothing,
                name = Core.Nothing, publicKeys = Core.Nothing,
                sshHost = Core.Nothing, sshPort = Core.Nothing,
                sshUsername = Core.Nothing, state = Core.Nothing,
...
instance Core.FromJSON Environment where
        parseJSON
          = Core.withObject "Environment"
              (\ o ->
                 Environment Core.<$>
                   (o Core..:? "dockerImage") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "name")
...
instance Core.FromJSON RemovePublicKeyMetadata where
        parseJSON
          = Core.withObject "RemovePublicKeyMetadata"
...
instance Core.FromJSON RemovePublicKeyRequest where
        parseJSON
          = Core.withObject "RemovePublicKeyRequest"
...
instance Core.FromJSON RemovePublicKeyResponse where
        parseJSON
          = Core.withObject "RemovePublicKeyResponse"
...
instance Core.FromJSON StartEnvironmentMetadata where
        parseJSON
          = Core.withObject "StartEnvironmentMetadata"
...
newStartEnvironmentRequest 
    ::  StartEnvironmentRequest
newStartEnvironmentRequest
  = StartEnvironmentRequest{accessToken = Core.Nothing,
                            publicKeys = Core.Nothing}
instance Core.FromJSON StartEnvironmentRequest where
        parseJSON
          = Core.withObject "StartEnvironmentRequest"
              (\ o ->
                 StartEnvironmentRequest Core.<$>
                   (o Core..:? "accessToken") Core.<*> (o Core..:? "publicKeys"))
...
instance Core.FromJSON StartEnvironmentResponse where
        parseJSON
          = Core.withObject "StartEnvironmentResponse"
              (\ o ->
