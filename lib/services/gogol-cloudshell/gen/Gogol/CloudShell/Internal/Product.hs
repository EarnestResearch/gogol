...
instance Core.FromJSON AuthorizeEnvironmentMetadata
         where
        parseJSON
          = Core.withObject "AuthorizeEnvironmentMetadata"
              (\ o -> Core.pure AuthorizeEnvironmentMetadata)

instance Core.ToJSON AuthorizeEnvironmentMetadata
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON AuthorizeEnvironmentRequest
         where
        parseJSON
...
instance Core.ToJSON AuthorizeEnvironmentRequest
         where
...
instance Core.FromJSON AuthorizeEnvironmentResponse
         where
        parseJSON
          = Core.withObject "AuthorizeEnvironmentResponse"
              (\ o -> Core.pure AuthorizeEnvironmentResponse)

instance Core.ToJSON AuthorizeEnvironmentResponse
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON CreateEnvironmentMetadata
         where
        parseJSON
...
instance Core.FromJSON DeleteEnvironmentMetadata
         where
        parseJSON
...
instance Core.FromJSON Environment where
        parseJSON
          = Core.withObject "Environment"
              (\ o ->
                 Environment Core.<$>
                   (o Core..:? "dockerImage") Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "name")
...
newStartEnvironmentRequest =
  StartEnvironmentRequest
    {accessToken = Core.Nothing, publicKeys = Core.Nothing}
