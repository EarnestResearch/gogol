...
-- |
-- Module      : Gogol.YouTube.Internal.Product
...
import Gogol.YouTube.Internal.Sum
...
instance Core.FromJSON AbuseReport where
        parseJSON
          = Core.withObject "AbuseReport"
              (\ o ->
                 AbuseReport Core.<$>
                   (o Core..:? "abuseTypes") Core.<*>
                     (o Core..:? "description")
              ...
              (\ o ->
                 Activity Core.<$>
                   (o Core..:? "contentDetails") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#activity")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON ActivityContentDetails where
        parseJSON
          = Core.withObject "ActivityContentDetails"
              (\ o ->
                 ActivityContentDetails Core.<$>
                   (o Core..:? "bulletin") Core.<*>
                     (o Core..:? "channelItem")
                     Core.<*> (o Core..:? "comment")
...
instance Core.FromJSON ActivityContentDetailsBulletin
         where
        parseJSON
          = Core.withObject "ActivityContentDetailsBulletin"
              (\ o ->
                 ActivityContentDetailsBulletin Core.<$>
                   (o Core..:? "resourceId"))

instance Core.ToJSON ActivityContentDetailsBulletin
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ActivityContentDetailsChannelItem"
              (\ o ->
                 ActivityContentDetailsChannelItem Core.<$>
                   (o Core..:? "resourceId"))
...
instance Core.FromJSON ActivityContentDetailsComment
         where
        parseJSON
          = Core.withObject "ActivityContentDetailsComment"
              (\ o ->
                 ActivityContentDetailsComment Core.<$>
                   (o Core..:? "resourceId"))

instance Core.ToJSON ActivityContentDetailsComment
         where
...
instance Core.FromJSON ActivityContentDetailsFavorite
         where
        parseJSON
          = Core.withObject "ActivityContentDetailsFavorite"
              (\ o ->
                 ActivityContentDetailsFavorite Core.<$>
                   (o Core..:? "resourceId"))

instance Core.ToJSON ActivityContentDetailsFavorite
         where
...
instance Core.FromJSON ActivityContentDetailsLike
         where
        parseJSON
          = Core.withObject "ActivityContentDetailsLike"
              (\ o ->
                 ActivityContentDetailsLike Core.<$>
                   (o Core..:? "resourceId"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ActivityContentDetailsPlaylistItem"
              (\ o ->
                 ActivityContentDetailsPlaylistItem Core.<$>
                   (o Core..:? "playlistId") Core.<*>
                     (o Core..:? "playlistItemId")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ActivityContentDetailsPromotedItem"
              (\ o ->
                 ActivityContentDetailsPromotedItem Core.<$>
                   (o Core..:? "adTag") Core.<*>
                     (o Core..:? "clickTrackingUrl")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ActivityContentDetailsRecommendation"
              (\ o ->
                 ActivityContentDetailsRecommendation Core.<$>
                   (o Core..:? "reason") Core.<*>
                     (o Core..:? "resourceId")
...
instance Core.FromJSON ActivityContentDetailsSocial
         where
        parseJSON
          = Core.withObject "ActivityContentDetailsSocial"
              (\ o ->
                 ActivityContentDetailsSocial Core.<$>
                   (o Core..:? "author") Core.<*>
                     (o Core..:? "imageUrl")
...
instance Core.ToJSON ActivityContentDetailsSocial
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ActivityContentDetailsSubscription"
              (\ o ->
                 ActivityContentDetailsSubscription Core.<$>
                   (o Core..:? "resourceId"))
...
instance Core.FromJSON ActivityContentDetailsUpload
         where
        parseJSON
          = Core.withObject "ActivityContentDetailsUpload"
              (\ o ->
                 ActivityContentDetailsUpload Core.<$>
                   (o Core..:? "videoId"))

instance Core.ToJSON ActivityContentDetailsUpload
         where
...
instance Core.FromJSON ActivityListResponse where
        parseJSON
          = Core.withObject "ActivityListResponse"
              (\ o ->
                 ActivityListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON ActivitySnippet where
        parseJSON
          = Core.withObject "ActivitySnippet"
              (\ o ->
                 ActivitySnippet Core.<$>
...
instance Core.FromJSON Caption where
        parseJSON
          = Core.withObject "Caption"
              (\ o ->
                 Caption Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#caption")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON CaptionListResponse where
        parseJSON
          = Core.withObject "CaptionListResponse"
              (\ o ->
                 CaptionListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON CaptionSnippet where
        parseJSON
          = Core.withObject "CaptionSnippet"
              (\ o ->
                 CaptionSnippet Core.<$>
                   (o Core..:? "audioTrackType") Core.<*>
                     (o Core..:? "failureReason")
...
instance Core.FromJSON Channel where
        parseJSON
          = Core.withObject "Channel"
              (\ o ->
                 Channel Core.<$>
                   (o Core..:? "auditDetails") Core.<*>
                     (o Core..:? "brandingSettings")
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#channel")
          ...
          = Core.object
              (Core.catMaybes
                 [("auditDetails" Core..=) Core.<$> auditDetails,
                  ("brandingSettings" Core..=) Core.<$>
                    brandingSettings,
                  ("contentDetails" Core..=) Core.<$> contentDetails,
                  ("contentOwnerDetails" Core..=) Core.<$>
                    contentOwnerDetails,
...
newtype Channel_Localizations = Channel_Localizations
    {
      -- | 
      additional :: (Core.HashMap Core.Text ChannelLocalization)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newChannel_Localizations 
    ::  Core.HashMap Core.Text ChannelLocalization
       -- ^  See 'additional'.
    -> Channel_Localizations
newChannel_Localizations additional =
  Channel_Localizations {additional = additional}

instance Core.FromJSON Channel_Localizations where
        parseJSON
          = Core.withObject "Channel_Localizations"
              (\ o ->
                 Channel_Localizations Core.<$>
...
instance Core.FromJSON ChannelAuditDetails where
        parseJSON
          = Core.withObject "ChannelAuditDetails"
              (\ o ->
                 ChannelAuditDetails Core.<$>
                   (o Core..:? "communityGuidelinesGoodStanding")
...
instance Core.ToJSON ChannelAuditDetails where
        toJSON ChannelAuditDetails{..}
          = Core.object
              (Core.catMaybes
                 [("communityGuidelinesGoodStanding" Core..=) Core.<$>
                    communityGuidelinesGoodStanding,
                  ("contentIdClaimsGoodStanding" Core..=) Core.<$>
                    contentIdClaimsGoodStanding,
                  ("copyrightStrikesGoodStanding" Core..=) Core.<$>
...
instance Core.FromJSON ChannelBannerResource where
        parseJSON
          = Core.withObject "ChannelBannerResource"
              (\ o ->
                 ChannelBannerResource Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON ChannelBrandingSettings where
        parseJSON
          = Core.withObject "ChannelBrandingSettings"
              (\ o ->
                 ChannelBrandingSettings Core.<$>
                   (o Core..:? "channel") Core.<*> (o Core..:? "hints")
                     Core.<*> (o Core..:? "image")
                     Core.<*> (o Core..:? "watch"))
...
instance Core.FromJSON ChannelContentDetails where
        parseJSON
          = Core.withObject "ChannelContentDetails"
              (\ o ->
                 ChannelContentDetails Core.<$>
                   (o Core..:? "relatedPlaylists"))

instance Core.ToJSON ChannelContentDetails where
        toJSON ChannelContentDetails{..}
          = Core.object
              (Core.catMaybes
                 [("relatedPlaylists" Core..=) Core.<$>
                    relatedPlaylists])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ChannelContentDetails_RelatedPlaylists"
              (\ o ->
                 ChannelContentDetails_RelatedPlaylists Core.<$>
                   (o Core..:? "favorites") Core.<*>
                     (o Core..:? "likes")
                     Core.<*> (o Core..:? "uploads")
...
newChannelContentOwnerDetails =
  ChannelContentOwnerDetails
    {contentOwner = Core.Nothing, timeLinked = Core.Nothing}

instance Core.FromJSON ChannelContentOwnerDetails
         where
        parseJSON
          = Core.withObject "ChannelContentOwnerDetails"
              (\ o ->
                 ChannelContentOwnerDetails Core.<$>
                   (o Core..:? "contentOwner") Core.<*>
                     (o Core..:? "timeLinked"))
...
instance Core.FromJSON ChannelConversionPing where
        parseJSON
          = Core.withObject "ChannelConversionPing"
              (\ o ->
                 ChannelConversionPing Core.<$>
                   (o Core..:? "context") Core.<*>
                     (o Core..:? "conversionUrl"))
...
instance Core.FromJSON ChannelConversionPings where
        parseJSON
          = Core.withObject "ChannelConversionPings"
              (\ o ->
...
instance Core.FromJSON ChannelListResponse where
        parseJSON
          = Core.withObject "ChannelListResponse"
              (\ o ->
                 ChannelListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON ChannelLocalization where
        parseJSON
          = Core.withObject "ChannelLocalization"
              (\ o ->
                 ChannelLocalization Core.<$>
...
instance Core.FromJSON ChannelProfileDetails where
        parseJSON
          = Core.withObject "ChannelProfileDetails"
              (\ o ->
                 ChannelProfileDetails Core.<$>
                   (o Core..:? "channelId") Core.<*>
                     (o Core..:? "channelUrl")
...
instance Core.FromJSON ChannelSection where
        parseJSON
          = Core.withObject "ChannelSection"
              (\ o ->
                 ChannelSection Core.<$>
                   (o Core..:? "contentDetails") Core.<*>
                     (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#channelSection")
                     Core.<*> (o Core..:? "localizations")
                     Core.<*> (o Core..:? "snippet")
...
newtype ChannelSection_Localizations = ChannelSection_Localizations
    {
      -- | 
      additional :: (Core.HashMap Core.Text ChannelSectionLocalization)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newChannelSection_Localizations 
    ::  Core.HashMap Core.Text ChannelSectionLocalization
       -- ^  See 'additional'.
    -> ChannelSection_Localizations
newChannelSection_Localizations additional =
  ChannelSection_Localizations {additional = additional}

instance Core.FromJSON ChannelSection_Localizations
         where
        parseJSON
          = Core.withObject "ChannelSection_Localizations"
              (\ o ->
                 ChannelSection_Localizations Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ChannelSection_Localizations
         where
...
newChannelSectionContentDetails =
  ChannelSectionContentDetails
    {channels = Core.Nothing, playlists = Core.Nothing}

instance Core.FromJSON ChannelSectionContentDetails
         where
        parseJSON
          = Core.withObject "ChannelSectionContentDetails"
              (\ o ->
                 ChannelSectionContentDetails Core.<$>
                   (o Core..:? "channels") Core.<*>
                     (o Core..:? "playlists"))

instance Core.ToJSON ChannelSectionContentDetails
         where
...
instance Core.FromJSON ChannelSectionListResponse
         where
        parseJSON
          = Core.withObject "ChannelSectionListResponse"
              (\ o ->
                 ChannelSectionListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON ChannelSectionLocalization
         where
        parseJSON
          = Core.withObject "ChannelSectionLocalization"
              (\ o ->
                 ChannelSectionLocalization Core.<$>
                   (o Core..:? "title"))
...
instance Core.FromJSON ChannelSectionSnippet where
        parseJSON
          = Core.withObject "ChannelSectionSnippet"
              (\ o ->
                 ChannelSectionSnippet Core.<$>
                   (o Core..:? "channelId") Core.<*>
                     (o Core..:? "defaultLanguage")
...
newChannelSectionTargeting =
  ChannelSectionTargeting
    {countries = Core.Nothing, languages = Core.Nothing, regions = Core.Nothing}

instance Core.FromJSON ChannelSectionTargeting where
        parseJSON
          = Core.withObject "ChannelSectionTargeting"
              (\ o ->
                 ChannelSectionTargeting Core.<$>
...
instance Core.FromJSON ChannelSettings where
        parseJSON
          = Core.withObject "ChannelSettings"
              (\ o ->
                 ChannelSettings Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "defaultLanguage")
          ...
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ...
                  ("description" Core..=) Core.<$> description,
                  ("featuredChannelsTitle" Core..=) Core.<$>
                    featuredChannelsTitle,
                  ("featuredChannelsUrls" Core..=) Core.<$>
                    featuredChannelsUrls,
                  ("keywords" Core..=) Core.<$> keywords,
                  ("moderateComments" Core..=) Core.<$>
                    moderateComments,
                  ("profileColor" Core..=) Core.<$> profileColor,
                  ("showBrowseView" Core..=) Core.<$> showBrowseView,
                  ("showRelatedChannels" Core..=) Core.<$>
                    showRelatedChannels,
                  ("title" Core..=) Core.<$> title,
                  ("trackingAnalyticsAccountId" Core..=) Core.<$>
                    trackingAnalyticsAccountId,
                  ("unsubscribedTrailer" Core..=) Core.<$>
                    unsubscribedTrailer])
...
instance Core.FromJSON ChannelSnippet where
        parseJSON
          = Core.withObject "ChannelSnippet"
              (\ o ->
                 ChannelSnippet Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "customUrl")
...
instance Core.FromJSON ChannelStatistics where
        parseJSON
          = Core.withObject "ChannelStatistics"
              (\ o ->
                 ChannelStatistics Core.<$>
                   (o Core..:? "commentCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "hiddenSubscriberCount")
                     Core.<*>
                     (o Core..:? "subscriberCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "videoCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.ToJSON ChannelStatistics where
        toJSON ChannelStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("commentCount" Core..=) Core.. Core.AsText Core.<$>
                    commentCount,
                  ("hiddenSubscriberCount" Core..=) Core.<$>
                    hiddenSubscriberCount,
                  ("subscriberCount" Core..=) Core.. Core.AsText
                    Core.<$> subscriberCount,
                  ("videoCount" Core..=) Core.. Core.AsText Core.<$>
                    videoCount,
...
instance Core.FromJSON ChannelStatus where
        parseJSON
          = Core.withObject "ChannelStatus"
              (\ o ->
                 ChannelStatus Core.<$>
                   (o Core..:? "isLinked") Core.<*>
                     (o Core..:? "longUploadsStatus")
...
instance Core.FromJSON ChannelToStoreLinkDetails
         where
        parseJSON
          = Core.withObject "ChannelToStoreLinkDetails"
              (\ o ->
                 ChannelToStoreLinkDetails Core.<$>
...
instance Core.FromJSON ChannelTopicDetails where
        parseJSON
          = Core.withObject "ChannelTopicDetails"
              (\ o ->
                 ChannelTopicDetails Core.<$>
                   (o Core..:? "topicCategories") Core.<*>
                     (o Core..:? "topicIds"))
          ...
          = Core.withObject "Comment"
              (\ o ->
                 Comment Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#comment")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON CommentListResponse where
        parseJSON
          = Core.withObject "CommentListResponse"
              (\ o ->
                 CommentListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON CommentSnippet where
        parseJSON
          = Core.withObject "CommentSnippet"
              (\ o ->
                 CommentSnippet Core.<$>
                   (o Core..:? "authorChannelId") Core.<*>
                     (o Core..:? "authorChannelUrl")
...
instance Core.ToJSON CommentSnippet where
        toJSON CommentSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("authorChannelId" Core..=) Core.<$>
                    authorChannelId,
                  ("authorChannelUrl" Core..=) Core.<$>
                    authorChannelUrl,
                  ("authorDisplayName" Core..=) Core.<$>
                    authorDisplayName,
                  ("authorProfileImageUrl" Core..=) Core.<$>
                    authorProfileImageUrl,
                  ("canRate" Core..=) Core.<$> canRate,
                  ("channelId" Core..=) Core.<$> channelId,
                  ("likeCount" Core..=) Core.<$> likeCount,
                  ("moderationStatus" Core..=) Core.<$>
                    moderationStatus,
...
instance Core.FromJSON CommentSnippetAuthorChannelId
         where
        parseJSON
          = Core.withObject "CommentSnippetAuthorChannelId"
              (\ o ->
                 CommentSnippetAuthorChannelId Core.<$>
                   (o Core..:? "value"))

instance Core.ToJSON CommentSnippetAuthorChannelId
         where
...
instance Core.FromJSON CommentThread where
        parseJSON
          = Core.withObject "CommentThread"
              (\ o ->
                 CommentThread Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#commentThread")
                     Core.<*> (o Core..:? "replies")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON CommentThreadListResponse
         where
        parseJSON
          = Core.withObject "CommentThreadListResponse"
              (\ o ->
                 CommentThreadListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON CommentThreadReplies where
        parseJSON
          = Core.withObject "CommentThreadReplies"
              (\ o ->
                 CommentThreadReplies Core.<$>
                   (o Core..:? "comments"))
...
instance Core.FromJSON CommentThreadSnippet where
        parseJSON
          = Core.withObject "CommentThreadSnippet"
              (\ o ->
                 CommentThreadSnippet Core.<$>
                   (o Core..:? "canReply") Core.<*>
                     (o Core..:? "channelId")
...
instance Core.FromJSON ContentRating where
        parseJSON
          = Core.withObject "ContentRating"
              (\ o ->
                 ContentRating Core.<$>
                   (o Core..:? "acbRating") Core.<*>
                     (o Core..:? "agcomRating")
          ...
          = Core.object
              (Core.catMaybes
                 [("acbRating" Core..=) Core.<$> acbRating,
                  ...
                  ("resorteviolenciaRating" Core..=) Core.<$>
              ...
              (\ o ->
                 Cuepoint Core.<$>
                   (o Core..:? "cueType") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "insertionOffsetTimeMs" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "walltimeMs" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("cueType" Core..=) Core.<$> cueType,
                  ...
                  ("walltimeMs" Core..=) Core.. Core.AsText Core.<$>
                    walltimeMs])
...
instance Core.FromJSON I18nLanguage where
        parseJSON
          = Core.withObject "I18nLanguage"
              (\ o ->
                 I18nLanguage Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#i18nLanguage")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON I18nLanguageListResponse where
        parseJSON
          = Core.withObject "I18nLanguageListResponse"
              (\ o ->
                 I18nLanguageListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON I18nLanguageSnippet where
        parseJSON
          = Core.withObject "I18nLanguageSnippet"
              (\ o ->
                 I18nLanguageSnippet Core.<$>
                   (o Core..:? "hl") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON I18nRegion where
        parseJSON
          = Core.withObject "I18nRegion"
              (\ o ->
                 I18nRegion Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#i18nRegion")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON I18nRegionListResponse where
        parseJSON
          = Core.withObject "I18nRegionListResponse"
              (\ o ->
                 I18nRegionListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON I18nRegionSnippet where
        parseJSON
          = Core.withObject "I18nRegionSnippet"
              (\ o ->
                 I18nRegionSnippet Core.<$>
                   (o Core..:? "gl") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON ImageSettings where
        parseJSON
          = Core.withObject "ImageSettings"
              (\ o ->
                 ImageSettings Core.<$>
                   (o Core..:? "backgroundImageUrl") Core.<*>
                     (o Core..:? "bannerExternalUrl")
                     ...
                     Core.<*>
                     (o Core..:? "largeBrandedBannerImageImapScript")
                     Core.<*> (o Core..:? "largeBrandedBannerImageUrl")
                     Core.<*>
                     (o Core..:? "smallBrandedBannerImageImapScript")
...
instance Core.ToJSON ImageSettings where
        toJSON ImageSettings{..}
          = Core.object
              (Core.catMaybes
                 [("backgroundImageUrl" Core..=) Core.<$>
                    backgroundImageUrl,
                  ("bannerExternalUrl" Core..=) Core.<$>
                    bannerExternalUrl,
                  ("bannerImageUrl" Core..=) Core.<$> bannerImageUrl,
                  ("bannerMobileExtraHdImageUrl" Core..=) Core.<$>
                    bannerMobileExtraHdImageUrl,
                  ("bannerMobileHdImageUrl" Core..=) Core.<$>
                    bannerMobileHdImageUrl,
                  ("bannerMobileImageUrl" Core..=) Core.<$>
                    bannerMobileImageUrl,
                  ("bannerMobileLowImageUrl" Core..=) Core.<$>
                    bannerMobileLowImageUrl,
                  ("bannerMobileMediumHdImageUrl" Core..=) Core.<$>
                    bannerMobileMediumHdImageUrl,
                  ("bannerTabletExtraHdImageUrl" Core..=) Core.<$>
                    bannerTabletExtraHdImageUrl,
                  ("bannerTabletHdImageUrl" Core..=) Core.<$>
                    bannerTabletHdImageUrl,
                  ("bannerTabletImageUrl" Core..=) Core.<$>
                    bannerTabletImageUrl,
                  ("bannerTabletLowImageUrl" Core..=) Core.<$>
                    bannerTabletLowImageUrl,
                  ("bannerTvHighImageUrl" Core..=) Core.<$>
                    bannerTvHighImageUrl,
                  ("bannerTvImageUrl" Core..=) Core.<$>
                    bannerTvImageUrl,
                  ("bannerTvLowImageUrl" Core..=) Core.<$>
                    bannerTvLowImageUrl,
                  ("bannerTvMediumImageUrl" Core..=) Core.<$>
                    bannerTvMediumImageUrl,
                  ("largeBrandedBannerImageImapScript" Core..=)
                    Core.<$> largeBrandedBannerImageImapScript,
                  ("largeBrandedBannerImageUrl" Core..=) Core.<$>
                    largeBrandedBannerImageUrl,
                  ("smallBrandedBannerImageImapScript" Core..=)
                    Core.<$> smallBrandedBannerImageImapScript,
                  ("smallBrandedBannerImageUrl" Core..=) Core.<$>
                    smallBrandedBannerImageUrl,
                  ("trackingImageUrl" Core..=) Core.<$>
                    trackingImageUrl,
                  ("watchIconImageUrl" Core..=) Core.<$>
                    watchIconImageUrl])
...
instance Core.FromJSON IngestionInfo where
        parseJSON
          = Core.withObject "IngestionInfo"
              (\ o ->
                 IngestionInfo Core.<$>
                   (o Core..:? "backupIngestionAddress") Core.<*>
                     (o Core..:? "ingestionAddress")
...
instance Core.ToJSON IngestionInfo where
        toJSON IngestionInfo{..}
          = Core.object
              (Core.catMaybes
                 [("backupIngestionAddress" Core..=) Core.<$>
                    backupIngestionAddress,
                  ("ingestionAddress" Core..=) Core.<$>
                    ingestionAddress,
                  ("rtmpsBackupIngestionAddress" Core..=) Core.<$>
                    rtmpsBackupIngestionAddress,
                  ("rtmpsIngestionAddress" Core..=) Core.<$>
...
instance Core.FromJSON InvideoBranding where
        parseJSON
          = Core.withObject "InvideoBranding"
              (\ o ->
                 InvideoBranding Core.<$>
                   (o Core..:? "imageBytes") Core.<*>
                     (o Core..:? "imageUrl")
                     Core.<*> (o Core..:? "position")
...
instance Core.FromJSON InvideoPosition where
        parseJSON
          = Core.withObject "InvideoPosition"
              (\ o ->
                 InvideoPosition Core.<$>
                   (o Core..:? "cornerPosition") Core.<*>
                     (o Core..:? "type"))
...
newInvideoTiming =
  InvideoTiming
    {durationMs = Core.Nothing, offsetMs = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON InvideoTiming where
        parseJSON
          = Core.withObject "InvideoTiming"
              (\ o ->
                 InvideoTiming Core.<$>
                   (o Core..:? "durationMs" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "offsetMs" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("durationMs" Core..=) Core.. Core.AsText Core.<$>
                    durationMs,
                  ("offsetMs" Core..=) Core.. Core.AsText Core.<$>
                    offsetMs,
                  ("type" Core..=) Core.<$> type'])
              ...
              (\ o ->
                 LiveBroadcast Core.<$>
                   (o Core..:? "contentDetails") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#liveBroadcast")
                     Core.<*> (o Core..:? "snippet")
                     Core.<*> (o Core..:? "statistics")
                     Core.<*> (o Core..:? "status"))
...
instance Core.FromJSON LiveBroadcastContentDetails
         where
        parseJSON
          = Core.withObject "LiveBroadcastContentDetails"
              (\ o ->
                 LiveBroadcastContentDetails Core.<$>
                   (o Core..:? "boundStreamId") Core.<*>
                     (o Core..:? "boundStreamLastUpdateTimeMs")
...
instance Core.ToJSON LiveBroadcastContentDetails
         where
        toJSON LiveBroadcastContentDetails{..}
          = Core.object
              (Core.catMaybes
                 [("boundStreamId" Core..=) Core.<$> boundStreamId,
                  ("boundStreamLastUpdateTimeMs" Core..=) Core.<$>
                    boundStreamLastUpdateTimeMs,
                  ("closedCaptionsType" Core..=) Core.<$>
                    closedCaptionsType,
                  ("enableAutoStart" Core..=) Core.<$> enableAutoStart,
                  ("enableAutoStop" Core..=) Core.<$> enableAutoStop,
                  ("enableClosedCaptions" Core..=) Core.<$>
                    enableClosedCaptions,
                  ("enableContentEncryption" Core..=) Core.<$>
                    enableContentEncryption,
                  ("enableDvr" Core..=) Core.<$> enableDvr,
                  ("enableEmbed" Core..=) Core.<$> enableEmbed,
                  ("enableLowLatency" Core..=) Core.<$>
                    enableLowLatency,
                  ("latencyPreference" Core..=) Core.<$>
                    latencyPreference,
                  ("mesh" Core..=) Core.<$> mesh,
...
instance Core.FromJSON LiveBroadcastListResponse
         where
        parseJSON
          = Core.withObject "LiveBroadcastListResponse"
              (\ o ->
                 LiveBroadcastListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON LiveBroadcastSnippet where
        parseJSON
          = Core.withObject "LiveBroadcastSnippet"
              (\ o ->
                 LiveBroadcastSnippet Core.<$>
                   (o Core..:? "actualEndTime") Core.<*>
                     (o Core..:? "actualStartTime")
                     Core.<*> (o Core..:? "channelId")
                     Core.<*> (o Core..:? "description")
          ...
          = Core.object
              (Core.catMaybes
                 [("actualEndTime" Core..=) Core.<$> actualEndTime,
                  ...
                  ("channelId" Core..=) Core.<$> channelId,
                  ("description" Core..=) Core.<$> description,
                  ("isDefaultBroadcast" Core..=) Core.<$>
                    isDefaultBroadcast,
                  ("liveChatId" Core..=) Core.<$> liveChatId,
                  ("publishedAt" Core..=) Core.<$> publishedAt,
                  ("scheduledEndTime" Core..=) Core.<$>
                    scheduledEndTime,
                  ("scheduledStartTime" Core..=) Core.<$>
                    scheduledStartTime,
                  ("thumbnails" Core..=) Core.<$> thumbnails,
                  ("title" Core..=) Core.<$> title])
...
instance Core.FromJSON LiveBroadcastStatistics where
        parseJSON
          = Core.withObject "LiveBroadcastStatistics"
              (\ o ->
                 LiveBroadcastStatistics Core.<$>
                   (o Core..:? "concurrentViewers" Core.<&>
                      Core.fmap Core.fromAsText))
...
instance Core.FromJSON LiveBroadcastStatus where
        parseJSON
          = Core.withObject "LiveBroadcastStatus"
              (\ o ->
                 LiveBroadcastStatus Core.<$>
                   (o Core..:? "lifeCycleStatus") Core.<*>
                     (o Core..:? "liveBroadcastPriority")
                     Core.<*> (o Core..:? "madeForKids")
                     Core.<*> (o Core..:? "privacyStatus")
...
instance Core.ToJSON LiveBroadcastStatus where
        toJSON LiveBroadcastStatus{..}
          = Core.object
              (Core.catMaybes
                 [("lifeCycleStatus" Core..=) Core.<$>
                    lifeCycleStatus,
                  ("liveBroadcastPriority" Core..=) Core.<$>
...
instance Core.FromJSON LiveChatBan where
        parseJSON
          = Core.withObject "LiveChatBan"
              (\ o ->
                 LiveChatBan Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#liveChatBan")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON LiveChatBanSnippet where
        parseJSON
          = Core.withObject "LiveChatBanSnippet"
              (\ o ->
                 LiveChatBanSnippet Core.<$>
                   (o Core..:? "banDurationSeconds" Core.<&>
                      Core.fmap Core.fromAsText)
...
instance Core.FromJSON LiveChatFanFundingEventDetails
         where
        parseJSON
          = Core.withObject "LiveChatFanFundingEventDetails"
              (\ o ->
                 LiveChatFanFundingEventDetails Core.<$>
                   (o Core..:? "amountDisplayString") Core.<*>
                     (o Core..:? "amountMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "currency")
                     Core.<*> (o Core..:? "userComment"))

instance Core.ToJSON LiveChatFanFundingEventDetails
         where
        toJSON LiveChatFanFundingEventDetails{..}
          = Core.object
              (Core.catMaybes
                 [("amountDisplayString" Core..=) Core.<$>
                    amountDisplayString,
                  ("amountMicros" Core..=) Core.. Core.AsText Core.<$>
                    amountMicros,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "LiveChatGiftMembershipReceivedDetails"
              (\ o ->
                 LiveChatGiftMembershipReceivedDetails Core.<$>
                   (o Core..:? "associatedMembershipGiftingMessageId")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "LiveChatMemberMilestoneChatDetails"
              (\ o ->
                 LiveChatMemberMilestoneChatDetails Core.<$>
                   (o Core..:? "memberLevelName") Core.<*>
                     (o Core..:? "memberMonth")
                     Core.<*> (o Core..:? "userComment"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "LiveChatMembershipGiftingDetails"
              (\ o ->
                 LiveChatMembershipGiftingDetails Core.<$>
                   (o Core..:? "giftMembershipsCount") Core.<*>
                     (o Core..:? "giftMembershipsLevelName"))

instance Core.ToJSON LiveChatMembershipGiftingDetails
         where
        toJSON LiveChatMembershipGiftingDetails{..}
          = Core.object
              (Core.catMaybes
                 [("giftMembershipsCount" Core..=) Core.<$>
                    giftMembershipsCount,
                  ("giftMembershipsLevelName" Core..=) Core.<$>
...
instance Core.FromJSON LiveChatMessage where
        parseJSON
          = Core.withObject "LiveChatMessage"
              (\ o ->
                 LiveChatMessage Core.<$>
                   (o Core..:? "authorDetails") Core.<*>
                     (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON LiveChatMessageAuthorDetails
         where
        parseJSON
          = Core.withObject "LiveChatMessageAuthorDetails"
              (\ o ->
                 LiveChatMessageAuthorDetails Core.<$>
                   (o Core..:? "channelId") Core.<*>
                     (o Core..:? "channelUrl")
                     Core.<*> (o Core..:? "displayName")
...
instance Core.ToJSON LiveChatMessageAuthorDetails
         where
...
instance Core.FromJSON LiveChatMessageDeletedDetails
         where
        parseJSON
          = Core.withObject "LiveChatMessageDeletedDetails"
              (\ o ->
                 LiveChatMessageDeletedDetails Core.<$>
                   (o Core..:? "deletedMessageId"))

instance Core.ToJSON LiveChatMessageDeletedDetails
         where
        toJSON LiveChatMessageDeletedDetails{..}
          = Core.object
              (Core.catMaybes
                 [("deletedMessageId" Core..=) Core.<$>
                    deletedMessageId])
...
instance Core.FromJSON LiveChatMessageListResponse
         where
        parseJSON
          = Core.withObject "LiveChatMessageListResponse"
              (\ o ->
                 LiveChatMessageListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.ToJSON LiveChatMessageListResponse
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag,
                  ...
                  ("pageInfo" Core..=) Core.<$> pageInfo,
                  ("pollingIntervalMillis" Core..=) Core.<$>
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "LiveChatMessageRetractedDetails"
              (\ o ->
                 LiveChatMessageRetractedDetails Core.<$>
                   (o Core..:? "retractedMessageId"))

instance Core.ToJSON LiveChatMessageRetractedDetails
         where
        toJSON LiveChatMessageRetractedDetails{..}
          = Core.object
              (Core.catMaybes
                 [("retractedMessageId" Core..=) Core.<$>
                    retractedMessageId])
...
instance Core.FromJSON LiveChatMessageSnippet where
        parseJSON
          = Core.withObject "LiveChatMessageSnippet"
              (\ o ->
                 LiveChatMessageSnippet Core.<$>
                   (o Core..:? "authorChannelId") Core.<*>
                     (o Core..:? "displayMessage")
          ...
          = Core.object
              (Core.catMaybes
                 [("authorChannelId" Core..=) Core.<$>
                  ...
                  ("fanFundingEventDetails" Core..=) Core.<$>
                    fanFundingEventDetails,
                  ("giftMembershipReceivedDetails" Core..=) Core.<$>
                    giftMembershipReceivedDetails,
                  ("hasDisplayContent" Core..=) Core.<$>
                    hasDisplayContent,
                  ("liveChatId" Core..=) Core.<$> liveChatId,
                  ("memberMilestoneChatDetails" Core..=) Core.<$>
                    memberMilestoneChatDetails,
                  ("membershipGiftingDetails" Core..=) Core.<$>
                    membershipGiftingDetails,
                  ("messageDeletedDetails" Core..=) Core.<$>
                    messageDeletedDetails,
                  ("messageRetractedDetails" Core..=) Core.<$>
                    messageRetractedDetails,
                  ("newSponsorDetails" Core..=) Core.<$>
                    newSponsorDetails',
                  ("publishedAt" Core..=) Core.<$> publishedAt,
                  ("superChatDetails" Core..=) Core.<$>
                    superChatDetails,
                  ("superStickerDetails" Core..=) Core.<$>
                    superStickerDetails,
                  ("textMessageDetails" Core..=) Core.<$>
                    textMessageDetails,
                  ("type" Core..=) Core.<$> type',
                  ("userBannedDetails" Core..=) Core.<$>
                    userBannedDetails])
...
instance Core.FromJSON LiveChatModerator where
        parseJSON
          = Core.withObject "LiveChatModerator"
              (\ o ->
                 LiveChatModerator Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON LiveChatModeratorListResponse
         where
        parseJSON
          = Core.withObject "LiveChatModeratorListResponse"
              (\ o ->
                 LiveChatModeratorListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.ToJSON LiveChatModeratorListResponse
         where
...
newLiveChatModeratorSnippet =
  LiveChatModeratorSnippet
    {liveChatId = Core.Nothing, moderatorDetails = Core.Nothing}

instance Core.FromJSON LiveChatModeratorSnippet where
        parseJSON
          = Core.withObject "LiveChatModeratorSnippet"
              (\ o ->
                 LiveChatModeratorSnippet Core.<$>
                   (o Core..:? "liveChatId") Core.<*>
                     (o Core..:? "moderatorDetails"))
...
newLiveChatNewSponsorDetails =
  LiveChatNewSponsorDetails
    {isUpgrade = Core.Nothing, memberLevelName = Core.Nothing}

instance Core.FromJSON LiveChatNewSponsorDetails
         where
        parseJSON
          = Core.withObject "LiveChatNewSponsorDetails"
              (\ o ->
                 LiveChatNewSponsorDetails Core.<$>
                   (o Core..:? "isUpgrade") Core.<*>
                     (o Core..:? "memberLevelName"))
...
instance Core.FromJSON LiveChatSuperChatDetails where
        parseJSON
          = Core.withObject "LiveChatSuperChatDetails"
              (\ o ->
                 LiveChatSuperChatDetails Core.<$>
                   (o Core..:? "amountDisplayString") Core.<*>
                     (o Core..:? "amountMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "currency")
...
instance Core.FromJSON LiveChatSuperStickerDetails
         where
        parseJSON
          = Core.withObject "LiveChatSuperStickerDetails"
              (\ o ->
                 LiveChatSuperStickerDetails Core.<$>
                   (o Core..:? "amountDisplayString") Core.<*>
                     (o Core..:? "amountMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "currency")
...
instance Core.ToJSON LiveChatSuperStickerDetails
         where
              ...
              (Core.catMaybes
                 [("amountDisplayString" Core..=) Core.<$>
                  ...
                  ("amountMicros" Core..=) Core.. Core.AsText Core.<$>
                    amountMicros,
                  ("currency" Core..=) Core.<$> currency,
                  ("superStickerMetadata" Core..=) Core.<$>
                    superStickerMetadata,
                  ("tier" Core..=) Core.<$> tier])
...
instance Core.FromJSON LiveChatTextMessageDetails
         where
        parseJSON
          = Core.withObject "LiveChatTextMessageDetails"
              (\ o ->
                 LiveChatTextMessageDetails Core.<$>
                   (o Core..:? "messageText"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "LiveChatUserBannedMessageDetails"
              (\ o ->
                 LiveChatUserBannedMessageDetails Core.<$>
                   (o Core..:? "banDurationSeconds" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "banType")
                     Core.<*> (o Core..:? "bannedUserDetails"))

instance Core.ToJSON LiveChatUserBannedMessageDetails
         where
...
instance Core.FromJSON LiveStream where
        parseJSON
          = Core.withObject "LiveStream"
              (\ o ->
                 LiveStream Core.<$>
                   (o Core..:? "cdn") Core.<*>
                     (o Core..:? "contentDetails")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#liveStream")
                     Core.<*> (o Core..:? "snippet")
                     Core.<*> (o Core..:? "status"))
...
instance Core.FromJSON LiveStreamConfigurationIssue
         where
        parseJSON
          = Core.withObject "LiveStreamConfigurationIssue"
              (\ o ->
                 LiveStreamConfigurationIssue Core.<$>
                   (o Core..:? "description") Core.<*>
                     (o Core..:? "reason")
                     Core.<*> (o Core..:? "severity")
                     Core.<*> (o Core..:? "type"))

instance Core.ToJSON LiveStreamConfigurationIssue
         where
...
newLiveStreamContentDetails =
  LiveStreamContentDetails
    {closedCaptionsIngestionUrl = Core.Nothing, isReusable = Core.Nothing}

instance Core.FromJSON LiveStreamContentDetails where
        parseJSON
          = Core.withObject "LiveStreamContentDetails"
              (\ o ->
                 LiveStreamContentDetails Core.<$>
                   (o Core..:? "closedCaptionsIngestionUrl") Core.<*>
                     (o Core..:? "isReusable"))
...
instance Core.ToJSON LiveStreamContentDetails where
        toJSON LiveStreamContentDetails{..}
          = Core.object
              (Core.catMaybes
                 [("closedCaptionsIngestionUrl" Core..=) Core.<$>
...
instance Core.FromJSON LiveStreamHealthStatus where
        parseJSON
          = Core.withObject "LiveStreamHealthStatus"
              (\ o ->
                 LiveStreamHealthStatus Core.<$>
                   (o Core..:? "configurationIssues") Core.<*>
                     (o Core..:? "lastUpdateTimeSeconds" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "status"))
...
instance Core.FromJSON LiveStreamListResponse where
        parseJSON
          = Core.withObject "LiveStreamListResponse"
              (\ o ->
                 LiveStreamListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON LiveStreamSnippet where
        parseJSON
          = Core.withObject "LiveStreamSnippet"
              (\ o ->
                 LiveStreamSnippet Core.<$>
                   (o Core..:? "channelId") Core.<*>
                     (o Core..:? "description")
...
instance Core.FromJSON LiveStreamStatus where
        parseJSON
          = Core.withObject "LiveStreamStatus"
              (\ o ->
                 LiveStreamStatus Core.<$>
                   (o Core..:? "healthStatus") Core.<*>
                     (o Core..:? "streamStatus"))
...
instance Core.FromJSON LocalizedProperty where
        parseJSON
          = Core.withObject "LocalizedProperty"
              (\ o ->
                 LocalizedProperty Core.<$>
                   (o Core..:? "default") Core.<*>
                     (o Core..:? "defaultLanguage")
                     Core.<*> (o Core..:? "localized"))
        ...
        parseJSON
          = Core.withObject "Member"
              (\ o ->
                 Member Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#member")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON MemberListResponse where
        parseJSON
          = Core.withObject "MemberListResponse"
              (\ o ->
                 MemberListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON MemberSnippet where
        parseJSON
          = Core.withObject "MemberSnippet"
              (\ o ->
                 MemberSnippet Core.<$>
                   (o Core..:? "creatorChannelId") Core.<*>
                     (o Core..:? "memberDetails")
...
instance Core.ToJSON MemberSnippet where
        toJSON MemberSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("creatorChannelId" Core..=) Core.<$>
                    creatorChannelId,
                  ("memberDetails" Core..=) Core.<$> memberDetails,
                  ("membershipsDetails" Core..=) Core.<$>
                    membershipsDetails])
...
instance Core.FromJSON MembershipsDetails where
        parseJSON
          = Core.withObject "MembershipsDetails"
              (\ o ->
                 MembershipsDetails Core.<$>
                   (o Core..:? "accessibleLevels") Core.<*>
                     (o Core..:? "highestAccessibleLevel")
                     Core.<*>
                     (o Core..:? "highestAccessibleLevelDisplayName")
...
instance Core.ToJSON MembershipsDetails where
        toJSON MembershipsDetails{..}
          = Core.object
              (Core.catMaybes
                 [("accessibleLevels" Core..=) Core.<$>
                    accessibleLevels,
                  ("highestAccessibleLevel" Core..=) Core.<$>
                    highestAccessibleLevel,
                  ("highestAccessibleLevelDisplayName" Core..=)
                    Core.<$> highestAccessibleLevelDisplayName,
                  ("membershipsDuration" Core..=) Core.<$>
                    membershipsDuration,
                  ("membershipsDurationAtLevels" Core..=) Core.<$>
...
newMembershipsDuration =
  MembershipsDuration
    {memberSince = Core.Nothing, memberTotalDurationMonths = Core.Nothing}

instance Core.FromJSON MembershipsDuration where
        parseJSON
          = Core.withObject "MembershipsDuration"
              (\ o ->
                 MembershipsDuration Core.<$>
                   (o Core..:? "memberSince") Core.<*>
                     (o Core..:? "memberTotalDurationMonths"))
          ...
          = Core.object
              (Core.catMaybes
                 [("memberSince" Core..=) Core.<$> memberSince,
                  ("memberTotalDurationMonths" Core..=) Core.<$>
...
instance Core.FromJSON MembershipsDurationAtLevel
         where
        parseJSON
          = Core.withObject "MembershipsDurationAtLevel"
              (\ o ->
                 MembershipsDurationAtLevel Core.<$>
                   (o Core..:? "level") Core.<*>
                     (o Core..:? "memberSince")
...
instance Core.FromJSON MembershipsLevel where
        parseJSON
          = Core.withObject "MembershipsLevel"
              (\ o ->
                 MembershipsLevel Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON MembershipsLevelListResponse
         where
        parseJSON
          = Core.withObject "MembershipsLevelListResponse"
              (\ o ->
                 MembershipsLevelListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.ToJSON MembershipsLevelListResponse
         where
...
newMembershipsLevelSnippet =
  MembershipsLevelSnippet
    {creatorChannelId = Core.Nothing, levelDetails = Core.Nothing}

instance Core.FromJSON MembershipsLevelSnippet where
        parseJSON
          = Core.withObject "MembershipsLevelSnippet"
              (\ o ->
                 MembershipsLevelSnippet Core.<$>
                   (o Core..:? "creatorChannelId") Core.<*>
                     (o Core..:? "levelDetails"))
...
instance Core.FromJSON MonitorStreamInfo where
        parseJSON
          = Core.withObject "MonitorStreamInfo"
              (\ o ->
                 MonitorStreamInfo Core.<$>
                   (o Core..:? "broadcastStreamDelayMs") Core.<*>
                     (o Core..:? "embedHtml")
...
instance Core.ToJSON MonitorStreamInfo where
        toJSON MonitorStreamInfo{..}
          = Core.object
              (Core.catMaybes
                 [("broadcastStreamDelayMs" Core..=) Core.<$>
                    broadcastStreamDelayMs,
                  ("embedHtml" Core..=) Core.<$> embedHtml,
                  ("enableMonitorStream" Core..=) Core.<$>
                    enableMonitorStream])
              ...
              (\ o ->
                 Playlist Core.<$>
                   (o Core..:? "contentDetails") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#playlist")
                     Core.<*> (o Core..:? "localizations")
                     Core.<*> (o Core..:? "player")
                     Core.<*> (o Core..:? "snippet")
                     Core.<*> (o Core..:? "status"))
...
newtype Playlist_Localizations = Playlist_Localizations
    {
      -- | 
      additional :: (Core.HashMap Core.Text PlaylistLocalization)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newPlaylist_Localizations 
    ::  Core.HashMap Core.Text PlaylistLocalization
       -- ^  See 'additional'.
    -> Playlist_Localizations
newPlaylist_Localizations additional =
  Playlist_Localizations {additional = additional}

instance Core.FromJSON Playlist_Localizations where
        parseJSON
          = Core.withObject "Playlist_Localizations"
              (\ o ->
                 Playlist_Localizations Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON PlaylistContentDetails where
        parseJSON
          = Core.withObject "PlaylistContentDetails"
              (\ o ->
                 PlaylistContentDetails Core.<$>
                   (o Core..:? "itemCount"))
              ...
              (\ o ->
                 PlaylistItem Core.<$>
                   (o Core..:? "contentDetails") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#playlistItem")
                     Core.<*> (o Core..:? "snippet")
                     Core.<*> (o Core..:? "status"))
...
instance Core.FromJSON PlaylistItemContentDetails
         where
        parseJSON
          = Core.withObject "PlaylistItemContentDetails"
              (\ o ->
                 PlaylistItemContentDetails Core.<$>
                   (o Core..:? "endAt") Core.<*> (o Core..:? "note")
                     Core.<*> (o Core..:? "startAt")
                     Core.<*> (o Core..:? "videoId")
...
instance Core.FromJSON PlaylistItemListResponse where
        parseJSON
          = Core.withObject "PlaylistItemListResponse"
              (\ o ->
                 PlaylistItemListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON PlaylistItemSnippet where
        parseJSON
          = Core.withObject "PlaylistItemSnippet"
              (\ o ->
                 PlaylistItemSnippet Core.<$>
                   (o Core..:? "channelId") Core.<*>
                     (o Core..:? "channelTitle")
                     Core.<*> (o Core..:? "description")
          ...
          = Core.object
              (Core.catMaybes
                 [("channelId" Core..=) Core.<$> channelId,
                  ...
                  ("thumbnails" Core..=) Core.<$> thumbnails,
                  ("title" Core..=) Core.<$> title,
                  ("videoOwnerChannelId" Core..=) Core.<$>
                    videoOwnerChannelId,
                  ("videoOwnerChannelTitle" Core..=) Core.<$>
...
instance Core.FromJSON PlaylistItemStatus where
        parseJSON
          = Core.withObject "PlaylistItemStatus"
              (\ o ->
                 PlaylistItemStatus Core.<$>
                   (o Core..:? "privacyStatus"))
...
instance Core.FromJSON PlaylistListResponse where
        parseJSON
          = Core.withObject "PlaylistListResponse"
              (\ o ->
                 PlaylistListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON PlaylistLocalization where
        parseJSON
          = Core.withObject "PlaylistLocalization"
              (\ o ->
                 PlaylistLocalization Core.<$>
                   (o Core..:? "description") Core.<*>
                     (o Core..:? "title"))
...
instance Core.FromJSON PlaylistPlayer where
        parseJSON
          = Core.withObject "PlaylistPlayer"
              (\ o ->
...
instance Core.FromJSON PlaylistSnippet where
        parseJSON
          = Core.withObject "PlaylistSnippet"
              (\ o ->
                 PlaylistSnippet Core.<$>
                   (o Core..:? "channelId") Core.<*>
                     (o Core..:? "channelTitle")
                     Core.<*> (o Core..:? "defaultLanguage")
                     Core.<*> (o Core..:? "description")
...
instance Core.FromJSON PlaylistStatus where
        parseJSON
          = Core.withObject "PlaylistStatus"
              (\ o ->
...
instance Core.FromJSON PropertyValue where
        parseJSON
          = Core.withObject "PropertyValue"
              (\ o ->
                 PropertyValue Core.<$>
                   (o Core..:? "property") Core.<*>
                     (o Core..:? "value"))
...
instance Core.FromJSON ResourceId where
        parseJSON
          = Core.withObject "ResourceId"
              (\ o ->
                 ResourceId Core.<$>
                   (o Core..:? "channelId") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "playlistId")
                     Core.<*> (o Core..:? "videoId"))
...
instance Core.FromJSON SearchListResponse where
        parseJSON
          = Core.withObject "SearchListResponse"
              (\ o ->
                 SearchListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON SearchResult where
        parseJSON
          = Core.withObject "SearchResult"
              (\ o ->
                 SearchResult Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#searchResult")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON SearchResultSnippet where
        parseJSON
          = Core.withObject "SearchResultSnippet"
              (\ o ->
                 SearchResultSnippet Core.<$>
                   (o Core..:? "channelId") Core.<*>
                     (o Core..:? "channelTitle")
                     Core.<*> (o Core..:? "description")
          ...
          = Core.object
              (Core.catMaybes
                 [("channelId" Core..=) Core.<$> channelId,
                  ("channelTitle" Core..=) Core.<$> channelTitle,
                  ("description" Core..=) Core.<$> description,
                  ("liveBroadcastContent" Core..=) Core.<$>
              ...
              (\ o ->
                 Subscription Core.<$>
                   (o Core..:? "contentDetails") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#subscription")
                     Core.<*> (o Core..:? "snippet")
...
instance Core.FromJSON SubscriptionContentDetails
         where
        parseJSON
          = Core.withObject "SubscriptionContentDetails"
              (\ o ->
                 SubscriptionContentDetails Core.<$>
                   (o Core..:? "activityType") Core.<*>
                     (o Core..:? "newItemCount")
...
instance Core.FromJSON SubscriptionListResponse where
        parseJSON
          = Core.withObject "SubscriptionListResponse"
              (\ o ->
                 SubscriptionListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON SubscriptionSnippet where
        parseJSON
          = Core.withObject "SubscriptionSnippet"
              (\ o ->
                 SubscriptionSnippet Core.<$>
                   (o Core..:? "channelId") Core.<*>
                     (o Core..:? "channelTitle")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "publishedAt")
...
instance Core.FromJSON SubscriptionSubscriberSnippet
         where
        parseJSON
          = Core.withObject "SubscriptionSubscriberSnippet"
              (\ o ->
                 SubscriptionSubscriberSnippet Core.<$>
                   (o Core..:? "channelId") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "thumbnails")
                     Core.<*> (o Core..:? "title"))

instance Core.ToJSON SubscriptionSubscriberSnippet
         where
...
instance Core.FromJSON SuperChatEvent where
        parseJSON
          = Core.withObject "SuperChatEvent"
              (\ o ->
                 SuperChatEvent Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#superChatEvent")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON SuperChatEventListResponse
         where
        parseJSON
          = Core.withObject "SuperChatEventListResponse"
              (\ o ->
                 SuperChatEventListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON SuperChatEventSnippet where
        parseJSON
          = Core.withObject "SuperChatEventSnippet"
              (\ o ->
                 SuperChatEventSnippet Core.<$>
                   (o Core..:? "amountMicros" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "channelId")
          ...
          = Core.object
              (Core.catMaybes
                 [("amountMicros" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("isSuperStickerEvent" Core..=) Core.<$>
                    isSuperStickerEvent,
                  ("messageType" Core..=) Core.<$> messageType,
                  ("superStickerMetadata" Core..=) Core.<$>
                    superStickerMetadata,
                  ("supporterDetails" Core..=) Core.<$>
                    supporterDetails])
...
instance Core.FromJSON SuperStickerMetadata where
        parseJSON
          = Core.withObject "SuperStickerMetadata"
              (\ o ->
                 SuperStickerMetadata Core.<$>
                   (o Core..:? "altText") Core.<*>
                     (o Core..:? "altTextLanguage")
...
instance Core.FromJSON TestItem where
        parseJSON
          = Core.withObject "TestItem"
              (\ o ->
                 TestItem Core.<$>
                   (o Core..:? "featuredPart") Core.<*>
                     (o Core..:? "gaia" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON TestItemTestItemSnippet where
        parseJSON
          = Core.withObject "TestItemTestItemSnippet"
...
instance Core.FromJSON ThirdPartyLink where
        parseJSON
          = Core.withObject "ThirdPartyLink"
              (\ o ->
                 ThirdPartyLink Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#thirdPartyLink")
...
instance Core.FromJSON ThirdPartyLinkListResponse
         where
        parseJSON
          = Core.withObject "ThirdPartyLinkListResponse"
              (\ o ->
                 ThirdPartyLinkListResponse Core.<$>
...
newThirdPartyLinkSnippet =
  ThirdPartyLinkSnippet
    {channelToStoreLink = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON ThirdPartyLinkSnippet where
        parseJSON
          = Core.withObject "ThirdPartyLinkSnippet"
              (\ o ->
                 ThirdPartyLinkSnippet Core.<$>
                   (o Core..:? "channelToStoreLink") Core.<*>
                     (o Core..:? "type"))
...
instance Core.FromJSON ThirdPartyLinkStatus where
        parseJSON
          = Core.withObject "ThirdPartyLinkStatus"
              (\ o ->
                 ThirdPartyLinkStatus Core.<$>
                   (o Core..:? "linkStatus"))
...
instance Core.FromJSON ThumbnailDetails where
        parseJSON
          = Core.withObject "ThumbnailDetails"
              (\ o ->
                 ThumbnailDetails Core.<$>
                   (o Core..:? "default") Core.<*> (o Core..:? "high")
                     Core.<*> (o Core..:? "maxres")
                     Core.<*> (o Core..:? "medium")
...
instance Core.FromJSON ThumbnailSetResponse where
        parseJSON
          = Core.withObject "ThumbnailSetResponse"
              (\ o ->
                 ThumbnailSetResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON Video where
        parseJSON
          = Core.withObject "Video"
              (\ o ->
                 Video Core.<$>
                   (o Core..:? "ageGating") Core.<*>
                     (o Core..:? "contentDetails")
                     Core.<*> (o Core..:? "etag")
          ...
          = Core.object
              (Core.catMaybes
                 [("ageGating" Core..=) Core.<$> ageGating,
                  ...
                  ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
                  ("liveStreamingDetails" Core..=) Core.<$>
                    liveStreamingDetails,
                  ("localizations" Core..=) Core.<$> localizations,
                  ("monetizationDetails" Core..=) Core.<$>
                    monetizationDetails,
                  ("player" Core..=) Core.<$> player,
                  ("processingDetails" Core..=) Core.<$>
                    processingDetails,
                  ("projectDetails" Core..=) Core.<$> projectDetails,
                  ("recordingDetails" Core..=) Core.<$>
                    recordingDetails,
                  ("snippet" Core..=) Core.<$> snippet,
                  ("statistics" Core..=) Core.<$> statistics,
                  ("status" Core..=) Core.<$> status,
...
newtype Video_Localizations = Video_Localizations
    {
      -- | 
      additional :: (Core.HashMap Core.Text VideoLocalization)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newVideo_Localizations 
    ::  Core.HashMap Core.Text VideoLocalization
       -- ^  See 'additional'.
    -> Video_Localizations
newVideo_Localizations additional =
  Video_Localizations {additional = additional}

instance Core.FromJSON Video_Localizations where
        parseJSON
          = Core.withObject "Video_Localizations"
              (\ o ->
                 Video_Localizations Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON VideoAbuseReport where
        parseJSON
          = Core.withObject "VideoAbuseReport"
              (\ o ->
                 VideoAbuseReport Core.<$>
...
instance Core.FromJSON VideoAbuseReportReason where
        parseJSON
          = Core.withObject "VideoAbuseReportReason"
              (\ o ->
                 VideoAbuseReportReason Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "VideoAbuseReportReasonListResponse"
              (\ o ->
                 VideoAbuseReportReasonListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
newVideoAbuseReportReasonSnippet =
  VideoAbuseReportReasonSnippet
    {label = Core.Nothing, secondaryReasons = Core.Nothing}

instance Core.FromJSON VideoAbuseReportReasonSnippet
         where
        parseJSON
          = Core.withObject "VideoAbuseReportReasonSnippet"
              (\ o ->
                 VideoAbuseReportReasonSnippet Core.<$>
                   (o Core..:? "label") Core.<*>
                     (o Core..:? "secondaryReasons"))

instance Core.ToJSON VideoAbuseReportReasonSnippet
         where
        toJSON VideoAbuseReportReasonSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("label" Core..=) Core.<$> label,
                  ("secondaryReasons" Core..=) Core.<$>
                    secondaryReasons])
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "VideoAbuseReportSecondaryReason"
              (\ o ->
                 VideoAbuseReportSecondaryReason Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "label"))

instance Core.ToJSON VideoAbuseReportSecondaryReason
         where
...
instance Core.FromJSON VideoAgeGating where
        parseJSON
          = Core.withObject "VideoAgeGating"
              (\ o ->
                 VideoAgeGating Core.<$>
                   (o Core..:? "alcoholContent") Core.<*>
                     (o Core..:? "restricted")
...
instance Core.FromJSON VideoCategory where
        parseJSON
          = Core.withObject "VideoCategory"
              (\ o ->
                 VideoCategory Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#videoCategory")
                     Core.<*> (o Core..:? "snippet"))
...
instance Core.FromJSON VideoCategoryListResponse
         where
        parseJSON
          = Core.withObject "VideoCategoryListResponse"
              (\ o ->
                 VideoCategoryListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON VideoCategorySnippet where
        parseJSON
          = Core.withObject "VideoCategorySnippet"
              (\ o ->
                 VideoCategorySnippet Core.<$>
                   (o Core..:? "assignable") Core.<*>
                     (o Core..:? "channelId" Core..!=
...
instance Core.FromJSON VideoContentDetails where
        parseJSON
          = Core.withObject "VideoContentDetails"
              (\ o ->
                 VideoContentDetails Core.<$>
                   (o Core..:? "caption") Core.<*>
                     (o Core..:? "contentRating")
...
newVideoContentDetailsRegionRestriction =
  VideoContentDetailsRegionRestriction
    {allowed = Core.Nothing, blocked = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "VideoContentDetailsRegionRestriction"
              (\ o ->
                 VideoContentDetailsRegionRestriction Core.<$>
                   (o Core..:? "allowed") Core.<*>
                     (o Core..:? "blocked"))
...
instance Core.FromJSON VideoFileDetails where
        parseJSON
          = Core.withObject "VideoFileDetails"
              (\ o ->
                 VideoFileDetails Core.<$>
                   (o Core..:? "audioStreams") Core.<*>
                     (o Core..:? "bitrateBps" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("audioStreams" Core..=) Core.<$> audioStreams,
                  ("bitrateBps" Core..=) Core.. Core.AsText Core.<$>
                    bitrateBps,
...
instance Core.FromJSON VideoFileDetailsAudioStream
         where
        parseJSON
          = Core.withObject "VideoFileDetailsAudioStream"
              (\ o ->
                 VideoFileDetailsAudioStream Core.<$>
                   (o Core..:? "bitrateBps" Core.<&>
                      Core.fmap Core.fromAsText)
...
instance Core.ToJSON VideoFileDetailsAudioStream
         where
...
instance Core.FromJSON VideoFileDetailsVideoStream
         where
        parseJSON
          = Core.withObject "VideoFileDetailsVideoStream"
              (\ o ->
                 VideoFileDetailsVideoStream Core.<$>
...
instance Core.ToJSON VideoFileDetailsVideoStream
         where
...
instance Core.FromJSON VideoGetRatingResponse where
        parseJSON
          = Core.withObject "VideoGetRatingResponse"
              (\ o ->
                 VideoGetRatingResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON VideoListResponse where
        parseJSON
          = Core.withObject "VideoListResponse"
              (\ o ->
                 VideoListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON VideoLiveStreamingDetails
         where
        parseJSON
          = Core.withObject "VideoLiveStreamingDetails"
              (\ o ->
                 VideoLiveStreamingDetails Core.<$>
                   (o Core..:? "activeLiveChatId") Core.<*>
                     (o Core..:? "actualEndTime")
...
instance Core.FromJSON VideoLocalization where
        parseJSON
          = Core.withObject "VideoLocalization"
              (\ o ->
                 VideoLocalization Core.<$>
                   (o Core..:? "description") Core.<*>
                     (o Core..:? "title"))
...
instance Core.FromJSON VideoMonetizationDetails where
        parseJSON
          = Core.withObject "VideoMonetizationDetails"
              (\ o ->
                 VideoMonetizationDetails Core.<$>
                   (o Core..:? "access"))
...
instance Core.FromJSON VideoPlayer where
        parseJSON
          = Core.withObject "VideoPlayer"
              (\ o ->
                 VideoPlayer Core.<$>
                   (o Core..:? "embedHeight" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "embedHtml")
                     Core.<*>
                     (o Core..:? "embedWidth" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON VideoPlayer where
        toJSON VideoPlayer{..}
          = Core.object
              (Core.catMaybes
                 [("embedHeight" Core..=) Core.. Core.AsText Core.<$>
                    embedHeight,
                  ("embedHtml" Core..=) Core.<$> embedHtml,
                  ("embedWidth" Core..=) Core.. Core.AsText Core.<$>
                    embedWidth])
...
instance Core.FromJSON VideoProcessingDetails where
        parseJSON
          = Core.withObject "VideoProcessingDetails"
              (\ o ->
                 VideoProcessingDetails Core.<$>
                   (o Core..:? "editorSuggestionsAvailability") Core.<*>
                     (o Core..:? "fileDetailsAvailability")
...
instance Core.ToJSON VideoProcessingDetails where
        toJSON VideoProcessingDetails{..}
          = Core.object
              (Core.catMaybes
                 [("editorSuggestionsAvailability" Core..=) Core.<$>
                    editorSuggestionsAvailability,
                  ("fileDetailsAvailability" Core..=) Core.<$>
                    fileDetailsAvailability,
                  ("processingFailureReason" Core..=) Core.<$>
                    processingFailureReason,
                  ("processingIssuesAvailability" Core..=) Core.<$>
                    processingIssuesAvailability,
                  ("processingProgress" Core..=) Core.<$>
                    processingProgress,
                  ("processingStatus" Core..=) Core.<$>
                    processingStatus,
                  ("tagSuggestionsAvailability" Core..=) Core.<$>
                    tagSuggestionsAvailability,
                  ("thumbnailsAvailability" Core..=) Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "VideoProcessingDetailsProcessingProgress"
              (\ o ->
                 VideoProcessingDetailsProcessingProgress Core.<$>
                   (o Core..:? "partsProcessed" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "partsTotal" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "timeLeftMs" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("partsProcessed" Core..=) Core.. Core.AsText
                    Core.<$> partsProcessed,
                  ("partsTotal" Core..=) Core.. Core.AsText Core.<$>
                    partsTotal,
                  ("timeLeftMs" Core..=) Core.. Core.AsText Core.<$>
                    timeLeftMs])
...
instance Core.FromJSON VideoProjectDetails where
        parseJSON
          = Core.withObject "VideoProjectDetails"
...
instance Core.FromJSON VideoRecordingDetails where
        parseJSON
          = Core.withObject "VideoRecordingDetails"
              (\ o ->
                 VideoRecordingDetails Core.<$>
                   (o Core..:? "location") Core.<*>
                     (o Core..:? "locationDescription")
          ...
          = Core.object
              (Core.catMaybes
                 [("categoryId" Core..=) Core.<$> categoryId,
                  ("channelId" Core..=) Core.<$> channelId,
                  ("channelTitle" Core..=) Core.<$> channelTitle,
                  ("defaultAudioLanguage" Core..=) Core.<$>
...
instance Core.FromJSON VideoStatistics where
        parseJSON
          = Core.withObject "VideoStatistics"
              (\ o ->
                 VideoStatistics Core.<$>
                   (o Core..:? "commentCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "dislikeCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "favoriteCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "likeCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "viewCount" Core.<&>
                        Core.fmap Core.fromAsText))
        ...
        toJSON VideoStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("commentCount" Core..=) Core.. Core.AsText Core.<$>
                    commentCount,
                  ("dislikeCount" Core..=) Core.. Core.AsText Core.<$>
                    dislikeCount,
                  ("favoriteCount" Core..=) Core.. Core.AsText Core.<$>
                    favoriteCount,
                  ("likeCount" Core..=) Core.. Core.AsText Core.<$>
                    likeCount,
                  ("viewCount" Core..=) Core.. Core.AsText Core.<$>
                    viewCount])
...
instance Core.FromJSON VideoStatus where
        parseJSON
          = Core.withObject "VideoStatus"
              (\ o ->
                 VideoStatus Core.<$>
                   (o Core..:? "embeddable") Core.<*>
                     (o Core..:? "failureReason")
                     Core.<*> (o Core..:? "license")
                     Core.<*> (o Core..:? "madeForKids")
                     Core.<*> (o Core..:? "privacyStatus")
...
instance Core.FromJSON VideoSuggestions where
        parseJSON
          = Core.withObject "VideoSuggestions"
              (\ o ->
                 VideoSuggestions Core.<$>
                   (o Core..:? "editorSuggestions") Core.<*>
                     (o Core..:? "processingErrors")
...
instance Core.ToJSON VideoSuggestions where
        toJSON VideoSuggestions{..}
          = Core.object
              (Core.catMaybes
                 [("editorSuggestions" Core..=) Core.<$>
                    editorSuggestions,
                  ("processingErrors" Core..=) Core.<$>
                    processingErrors,
                  ("processingHints" Core..=) Core.<$> processingHints,
                  ("processingWarnings" Core..=) Core.<$>
                    processingWarnings,
...
newVideoSuggestionsTagSuggestion =
  VideoSuggestionsTagSuggestion
    {categoryRestricts = Core.Nothing, tag = Core.Nothing}

instance Core.FromJSON VideoSuggestionsTagSuggestion
         where
        parseJSON
          = Core.withObject "VideoSuggestionsTagSuggestion"
              (\ o ->
                 VideoSuggestionsTagSuggestion Core.<$>
                   (o Core..:? "categoryRestricts") Core.<*>
                     (o Core..:? "tag"))

instance Core.ToJSON VideoSuggestionsTagSuggestion
         where
        toJSON VideoSuggestionsTagSuggestion{..}
          = Core.object
              (Core.catMaybes
                 [("categoryRestricts" Core..=) Core.<$>
                    categoryRestricts,
                  ("tag" Core..=) Core.<$> tag])
...
instance Core.FromJSON VideoTopicDetails where
        parseJSON
          = Core.withObject "VideoTopicDetails"
              (\ o ->
                 VideoTopicDetails Core.<$>
                   (o Core..:? "relevantTopicIds") Core.<*>
                     (o Core..:? "topicCategories")
...
instance Core.FromJSON WatchSettings where
        parseJSON
          = Core.withObject "WatchSettings"
              (\ o ->
                 WatchSettings Core.<$>
                   (o Core..:? "backgroundColor") Core.<*>
                     (o Core..:? "featuredPlaylistId")
