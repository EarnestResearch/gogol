                       ...
                       Core.QueryParam "hl" Core.Text Core.:>
                         Core.QueryParam "maxResults" Core.Word32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "profileImageSize" Core.Word32
                               Core.:>
...
instance Core.GoogleRequest
           YouTubeLiveChatMessagesList
         where
        type Rs YouTubeLiveChatMessagesList =
             LiveChatMessageListResponse
        type Scopes YouTubeLiveChatMessagesList =
             '[Youtube'FullControl, Youtube'ForceSsl,
               Youtube'Readonly]
        requestClient YouTubeLiveChatMessagesList{..}
          = go (Core.Just liveChatId) part xgafv accessToken
              callback
              hl
