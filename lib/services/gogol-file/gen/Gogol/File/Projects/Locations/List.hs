...
newFileProjectsLocationsList name
  = FileProjectsLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest FileProjectsLocationsList where
        type Rs FileProjectsLocationsList = ListLocationsResponse
        type Scopes FileProjectsLocationsList =
        ...
        requestClient FileProjectsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy FileProjectsLocationsListResource)
                      Core.mempty
