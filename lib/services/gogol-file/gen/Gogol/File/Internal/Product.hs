...
instance Core.FromJSON Backup where
        parseJSON
          = Core.withObject "Backup"
              (\ o ->
                 Backup Core.<$>
                   (o Core..:? "capacityGb" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "downloadBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "kmsKey")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
...
instance Core.ToJSON Backup where
        toJSON Backup{..}
          = Core.object
              (Core.catMaybes
                 [("capacityGb" Core..=) Core.. Core.AsText Core.<$>
                    capacityGb,
                  ...
                  ("sourceInstanceTier" Core..=) Core.<$>
                    sourceInstanceTier,
                  ("state" Core..=) Core.<$> state,
                  ("storageBytes" Core..=) Core.. Core.AsText Core.<$>
                    storageBytes])
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("consumerDefinedName" Core..=) Core.<$>
                    consumerDefinedName,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("instanceType" Core..=) Core.<$> instanceType,
                  ("labels" Core..=) Core.<$> labels,
                  ("maintenancePolicyNames" Core..=) Core.<$>
                    maintenancePolicyNames,
                  ("maintenanceSchedules" Core..=) Core.<$>
                    maintenanceSchedules,
                  ("maintenanceSettings" Core..=) Core.<$>
                    maintenanceSettings,
                  ("name" Core..=) Core.<$> name,
                  ("notificationParameters" Core..=) Core.<$>
                    notificationParameters,
                  ("producerMetadata" Core..=) Core.<$>
                    producerMetadata,
                  ("provisionedResources" Core..=) Core.<$>
                    provisionedResources,
                  ("slmInstanceTemplate" Core..=) Core.<$>
                    slmInstanceTemplate,
                  ("sloMetadata" Core..=) Core.<$> sloMetadata,
                  ("softwareVersions" Core..=) Core.<$>
                    softwareVersions,
                  ("state" Core..=) Core.<$> state,
...
newGoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource =
  GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource
    {resourceType = Core.Nothing, resourceUrl = Core.Nothing}
...
newGoogleCloudSaasacceleratorManagementProvidersV1SloEligibility =
  GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility
    {eligible = Core.Nothing, reason = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("accessMode" Core..=) Core.<$> accessMode,
                  ("anonGid" Core..=) Core.. Core.AsText Core.<$>
                    anonGid,
                  ("anonUid" Core..=) Core.. Core.AsText Core.<$>
                    anonUid,
...
newtype RevertInstanceRequest = RevertInstanceRequest
    {
      -- | Required. The snapshot resource ID, in the format \'my-snapshot\', where the specified ID is the {snapshot/id} of the fully qualified name like projects\/{project/id}\/locations\/{location/id}\/instances\/{instance/id}\/snapshots\/{snapshot_id}
...
newSchedule =
  Schedule
    {day = Core.Nothing, duration = Core.Nothing, startTime = Core.Nothing}
...
instance Core.FromJSON Schedule where
        parseJSON
          = Core.withObject "Schedule"
              (\ o ->
                 Schedule Core.<$>
                   (o Core..:? "day") Core.<*> (o Core..:? "duration")
                     Core.<*> (o Core..:? "startTime"))
