...
data Backup = Backup
    ...
    , fileSystemProtocol :: (Core.Maybe Backup_FileSystemProtocol)
    ...
    , storageBytes :: (Core.Maybe Core.Int64)
      -- | Optional. Input only. Immutable. Tag key-value pairs bound to this resource. Each key must be a namespaced name and each value a short name. Example: \"123456789012\/environment\" : \"production\", \"123456789013\/costCenter\" : \"marketing\" See the documentation for more information: - Namespaced name: https:\/\/cloud.google.com\/resource-manager\/docs\/tags\/tags-creating-and-managing#retrieving/tag/key - Short name: https:\/\/cloud.google.com\/resource-manager\/docs\/tags\/tags-creating-and-managing#retrieving/tag/value
    , tags :: (Core.Maybe Backup_Tags)
    }
...
newBackup 
    ::  Backup
newBackup
  = Backup{capacityGb = Core.Nothing, createTime = Core.Nothing,
           description = Core.Nothing, downloadBytes = Core.Nothing,
           fileSystemProtocol = Core.Nothing, kmsKey = Core.Nothing,
           labels = Core.Nothing, name = Core.Nothing,
           satisfiesPzi = Core.Nothing, satisfiesPzs = Core.Nothing,
           sourceFileShare = Core.Nothing, sourceInstance = Core.Nothing,
           sourceInstanceTier = Core.Nothing, state = Core.Nothing,
           storageBytes = Core.Nothing, tags = Core.Nothing}
instance Core.FromJSON Backup where
        parseJSON
          = Core.withObject "Backup"
              (\ o ->
                 Backup Core.<$>
                   (o Core..:? "capacityGb" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "downloadBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "fileSystemProtocol")
                     Core.<*> (o Core..:? "kmsKey")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
                     ...
                     Core.<*> (o Core..:? "state")
                     Core.<*>
                     (o Core..:? "storageBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "tags"))
...
instance Core.ToJSON Backup where
        toJSON Backup{..}
          = Core.object
              (Core.catMaybes
                 [("capacityGb" Core..=) Core.. Core.AsText Core.<$> capacityGb,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("description" Core..=) Core.<$> description,
                  ("downloadBytes" Core..=) Core.. Core.AsText Core.<$>
                    downloadBytes,
                  ("fileSystemProtocol" Core..=) Core.<$> fileSystemProtocol,
                  ...
                  ("sourceInstanceTier" Core..=) Core.<$> sourceInstanceTier,
                  ("state" Core..=) Core.<$> state,
                  ("storageBytes" Core..=) Core.. Core.AsText Core.<$> storageBytes,
                  ("tags" Core..=) Core.<$> tags])
...
newBackup_Labels 
    :: 
       ...
       -- ^  See 'additional'.
    -> Backup_Labels
newBackup_Labels additional
  = Backup_Labels{additional = additional}
instance Core.FromJSON Backup_Labels where
        parseJSON
          = Core.withObject "Backup_Labels"
              (\ o -> Backup_Labels Core.<$> (Core.parseJSONObject o))
...
-- | Optional. Input only. Immutable. Tag key-value pairs bound to this resource. Each key must be a namespaced name and each value a short name. Example: \"123456789012\/environment\" : \"production\", \"123456789013\/costCenter\" : \"marketing\" See the documentation for more information: - Namespaced name: https:\/\/cloud.google.com\/resource-manager\/docs\/tags\/tags-creating-and-managing#retrieving/tag/key - Short name: https:\/\/cloud.google.com\/resource-manager\/docs\/tags\/tags-creating-and-managing#retrieving/tag/value
--
-- /See:/ 'newBackup_Tags' smart constructor.
newtype Backup_Tags = Backup_Tags
    {
...
-- | Creates a value of 'Backup_Tags' with the minimum fields required to make a request.
newBackup_Tags 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Backup_Tags
newBackup_Tags additional = Backup_Tags{additional = additional}
instance Core.FromJSON Backup_Tags where
        parseJSON
          = Core.withObject "Backup_Tags"
              (\ o -> Backup_Tags Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Backup_Tags where
        toJSON Backup_Tags{..} = Core.toJSON additional
...
newDailyCycle 
    ::  DailyCycle
newDailyCycle
  = DailyCycle{duration = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON DailyCycle where
        parseJSON
          = Core.withObject "DailyCycle"
              (\ o ->
                 DailyCycle Core.<$>
...
newFileShareConfig 
    ::  FileShareConfig
newFileShareConfig
  = FileShareConfig{capacityGb = Core.Nothing, name = Core.Nothing,
                    nfsExportOptions = Core.Nothing, sourceBackup = Core.Nothing}
instance Core.FromJSON FileShareConfig where
        parseJSON
          = Core.withObject "FileShareConfig"
              (\ o ->
                 FileShareConfig Core.<$>
                   (o Core..:? "capacityGb" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
        ...
        toJSON FileShareConfig{..}
          = Core.object
              (Core.catMaybes
                 [("capacityGb" Core..=) Core.. Core.AsText Core.<$> capacityGb,
                  ("name" Core..=) Core.<$> name,
                  ("nfsExportOptions" Core..=) Core.<$> nfsExportOptions,
                  ("sourceBackup" Core..=) Core.<$> sourceBackup])


-- | Fixed IOPS (input\/output operations per second) parameters.
--
-- /See:/ 'newFixedIOPS' smart constructor.
newtype FixedIOPS = FixedIOPS
    {
...
-- | Creates a value of 'FixedIOPS' with the minimum fields required to make a request.
newFixedIOPS 
    ::  FixedIOPS
newFixedIOPS = FixedIOPS{maxIops = Core.Nothing}
instance Core.FromJSON FixedIOPS where
        parseJSON
          = Core.withObject "FixedIOPS"
              (\ o ->
                 FixedIOPS Core.<$>
                   (o Core..:? "maxIops" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON FixedIOPS where
        toJSON FixedIOPS{..}
          = Core.object
              (Core.catMaybes
...
data GoogleCloudSaasacceleratorManagementProvidersV1Instance = GoogleCloudSaasacceleratorManagementProvidersV1Instance
    {
      ...
      -- | Optional. The consumer/project/number associated with this Apigee instance. This field is added specifically to support Apigee integration with SLM Rollout and UMM. It represents the numerical project ID of the GCP project that consumes this Apigee instance. It is used for SLM rollout notifications and UMM integration, enabling proper mapping to customer projects and log delivery for Apigee instances. This field complements consumer/project/id and may be used for specific Apigee scenarios where the numerical ID is required.
    , consumerProjectNumber :: (Core.Maybe Core.Text)
    ...
    , labels :: (Core.Maybe
   GoogleCloudSaasacceleratorManagementProvidersV1Instance_Labels)
      -- | Optional. The MaintenancePolicies that have been attached to the instance. The key must be of the type name of the oneof policy name defined in MaintenancePolicy, and the referenced policy must define the same policy type. For details, please refer to go\/mr-user-guide. Should not be set if maintenance/settings.maintenance/policies is set.
    , maintenancePolicyNames :: (Core.Maybe
   GoogleCloudSaasacceleratorManagementProvidersV1Instance_MaintenancePolicyNames)
      -- | The MaintenanceSchedule contains the scheduling information of published maintenance schedule with same key as software_versions.
    , maintenanceSchedules :: (Core.Maybe
   GoogleCloudSaasacceleratorManagementProvidersV1Instance_MaintenanceSchedules)
      -- | Optional. The MaintenanceSettings associated with instance.
    , maintenanceSettings :: (Core.Maybe
   GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings)
...
newGoogleCloudSaasacceleratorManagementProvidersV1Instance 
    :: 
                                                           GoogleCloudSaasacceleratorManagementProvidersV1Instance
newGoogleCloudSaasacceleratorManagementProvidersV1Instance
  = GoogleCloudSaasacceleratorManagementProvidersV1Instance{consumerDefinedName
                                                              = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudSaasacceleratorManagementProvidersV1Instance"
              (\ o ->
                 GoogleCloudSaasacceleratorManagementProvidersV1Instance Core.<$>
                   (o Core..:? "consumerDefinedName") Core.<*>
                     (o Core..:? "consumerProjectNumber")
                     Core.<*> (o Core..:? "createTime")
...
instance Core.ToJSON
           GoogleCloudSaasacceleratorManagementProvidersV1Instance
         where
        toJSON GoogleCloudSaasacceleratorManagementProvidersV1Instance{..}
          = Core.object
              (Core.catMaybes
                 [("consumerDefinedName" Core..=) Core.<$> consumerDefinedName,
                  ("consumerProjectNumber" Core..=) Core.<$> consumerProjectNumber,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("instanceType" Core..=) Core.<$> instanceType,
                  ("labels" Core..=) Core.<$> labels,
                  ("maintenancePolicyNames" Core..=) Core.<$> maintenancePolicyNames,
                  ("maintenanceSchedules" Core..=) Core.<$> maintenanceSchedules,
                  ("maintenanceSettings" Core..=) Core.<$> maintenanceSettings,
                  ("name" Core..=) Core.<$> name,
                  ("notificationParameters" Core..=) Core.<$> notificationParameters,
                  ("producerMetadata" Core..=) Core.<$> producerMetadata,
                  ("provisionedResources" Core..=) Core.<$> provisionedResources,
                  ("slmInstanceTemplate" Core..=) Core.<$> slmInstanceTemplate,
                  ("sloMetadata" Core..=) Core.<$> sloMetadata,
                  ("softwareVersions" Core..=) Core.<$> softwareVersions,
                  ("state" Core..=) Core.<$> state,
...
newGoogleCloudSaasacceleratorManagementProvidersV1Instance_Labels
  additional
  = GoogleCloudSaasacceleratorManagementProvidersV1Instance_Labels{additional
                                                                     = additional}
instance Core.FromJSON
           GoogleCloudSaasacceleratorManagementProvidersV1Instance_Labels
         where
...
newGoogleCloudSaasacceleratorManagementProvidersV1Instance_MaintenancePolicyNames
  additional
  = GoogleCloudSaasacceleratorManagementProvidersV1Instance_MaintenancePolicyNames{additional
                                                                                     = additional}
instance Core.FromJSON
           GoogleCloudSaasacceleratorManagementProvidersV1Instance_MaintenancePolicyNames
         where
...
newGoogleCloudSaasacceleratorManagementProvidersV1Instance_MaintenanceSchedules
  additional
  = GoogleCloudSaasacceleratorManagementProvidersV1Instance_MaintenanceSchedules{additional
                                                                                   = additional}
instance Core.FromJSON
           GoogleCloudSaasacceleratorManagementProvidersV1Instance_MaintenanceSchedules
         where
...
newGoogleCloudSaasacceleratorManagementProvidersV1Instance_NotificationParameters
  additional
  = GoogleCloudSaasacceleratorManagementProvidersV1Instance_NotificationParameters{additional
                                                                                     = additional}
instance Core.FromJSON
           GoogleCloudSaasacceleratorManagementProvidersV1Instance_NotificationParameters
         where
...
newGoogleCloudSaasacceleratorManagementProvidersV1Instance_SoftwareVersions
  additional
  = GoogleCloudSaasacceleratorManagementProvidersV1Instance_SoftwareVersions{additional
                                                                               = additional}
instance Core.FromJSON
           GoogleCloudSaasacceleratorManagementProvidersV1Instance_SoftwareVersions
         where
...
newGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule 
    :: 
                                                                      GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule
newGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule
  = GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule{canReschedule
                                                                         = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("canReschedule" Core..=) Core.<$> canReschedule,
                  ...
                  ("rolloutManagementPolicy" Core..=) Core.<$>
                    rolloutManagementPolicy,
...
data GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings = GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings
    ...
    , isRollback :: (Core.Maybe Core.Bool)
      -- | Optional. The MaintenancePolicies that have been attached to the instance. The key must be of the type name of the oneof policy name defined in MaintenancePolicy, and the embedded policy must define the same policy type. For details, please refer to go\/mr-user-guide. Should not be set if maintenance/policy/names is set. If only the name is needed, then only populate MaintenancePolicy.name.
    , maintenancePolicies :: (Core.Maybe
   GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings_MaintenancePolicies)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings 
    :: 
                                                                      GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings
newGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings
  = GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings{exclude
                                                                         = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings
                   Core.<$>
                   (o Core..:? "exclude") Core.<*> (o Core..:? "isRollback") Core.<*>
                     (o Core..:? "maintenancePolicies"))
          ...
          = Core.object
              (Core.catMaybes
                 [("exclude" Core..=) Core.<$> exclude,
                  ...
                  ("maintenancePolicies" Core..=) Core.<$> maintenancePolicies])
...
newGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings_MaintenancePolicies
  additional
  = GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings_MaintenancePolicies{additional
                                                                                             =
                                                                                             additional}
instance Core.FromJSON
           GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings_MaintenancePolicies
...
newGoogleCloudSaasacceleratorManagementProvidersV1NodeSloMetadata 
    :: 
                                                                  GoogleCloudSaasacceleratorManagementProvidersV1NodeSloMetadata
newGoogleCloudSaasacceleratorManagementProvidersV1NodeSloMetadata
  = GoogleCloudSaasacceleratorManagementProvidersV1NodeSloMetadata{location
                                                                     = Core.Nothing,
                                                                   nodeId = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudSaasacceleratorManagementProvidersV1NodeSloMetadata
                   Core.<$>
                   (o Core..:? "location") Core.<*> (o Core..:? "nodeId") Core.<*>
                     (o Core..:? "perSliEligibility"))
          ...
          = Core.object
              (Core.catMaybes
                 [("location" Core..=) Core.<$> location,
                  ...
                  ("perSliEligibility" Core..=) Core.<$> perSliEligibility])
...
newGoogleCloudSaasacceleratorManagementProvidersV1NotificationParameter 
    :: 
                                                                        GoogleCloudSaasacceleratorManagementProvidersV1NotificationParameter
newGoogleCloudSaasacceleratorManagementProvidersV1NotificationParameter
  = GoogleCloudSaasacceleratorManagementProvidersV1NotificationParameter{values
                                                                           = Core.Nothing}
instance Core.FromJSON
           GoogleCloudSaasacceleratorManagementProvidersV1NotificationParameter
         where
...
newGoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility 
    :: 
                                                                       GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility
newGoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility
  = GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility{eligibilities
                                                                          = Core.Nothing}
instance Core.FromJSON
           GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility
         where
...
instance Core.ToJSON
        ...
        toJSON
          GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility{..}
          = Core.object
              (Core.catMaybes [("eligibilities" Core..=) Core.<$> eligibilities])
...
newGoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility_Eligibilities
  additional
  = GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility_Eligibilities{additional
                                                                                        =
                                                                                        additional}
instance Core.FromJSON
           GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility_Eligibilities
...
newGoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource 
    :: 
                                                                      GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource
newGoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource
  = GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource{resourceType
                                                                         = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource
                   Core.<$>
                   (o Core..:? "resourceType") Core.<*> (o Core..:? "resourceUrl"))
...
newGoogleCloudSaasacceleratorManagementProvidersV1SloEligibility 
    :: 
                                                                 GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility
newGoogleCloudSaasacceleratorManagementProvidersV1SloEligibility
  = GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility{eligible
                                                                    = Core.Nothing,
                                                                  reason = Core.Nothing}
instance Core.FromJSON
           GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility
                   Core.<$> (o Core..:? "eligible") Core.<*> (o Core..:? "reason"))
...
newGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata 
    :: 
                                                              GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata
newGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata
  = GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata{nodes
                                                                 = Core.Nothing,
                                                               perSliEligibility = Core.Nothing,
                                                               tier = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata"
              (\ o ->
                 GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata Core.<$>
                   (o Core..:? "nodes") Core.<*> (o Core..:? "perSliEligibility")
                     Core.<*> (o Core..:? "tier"))
...
--
-- /See:/ 'newIOPSPerTB' smart constructor.
newtype IOPSPerTB = IOPSPerTB
    {
      -- | Required. Maximum IOPS per TiB.
      maxIopsPerTb :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'IOPSPerTB' with the minimum fields required to make a request.
newIOPSPerTB 
    ::  IOPSPerTB
newIOPSPerTB = IOPSPerTB{maxIopsPerTb = Core.Nothing}
instance Core.FromJSON IOPSPerTB where
        parseJSON
          = Core.withObject "IOPSPerTB"
              (\ o ->
                 IOPSPerTB Core.<$>
                   (o Core..:? "maxIopsPerTb" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON IOPSPerTB where
        toJSON IOPSPerTB{..}
          = Core.object
              (Core.catMaybes
                 [("maxIopsPerTb" Core..=) Core.. Core.AsText Core.<$>
                    maxIopsPerTb])
...
data Instance = Instance
    ...
    , deletionProtectionReason :: (Core.Maybe Core.Text)
    ...
    , performanceConfig :: (Core.Maybe PerformanceConfig)
      -- | Output only. Used for getting performance limits.
    , performanceLimits :: (Core.Maybe PerformanceLimits)
      -- | Immutable. The protocol indicates the access protocol for all shares in the instance. This field is immutable and it cannot be changed after the instance has been created. Default value: @NFS_V3@.
    , protocol :: (Core.Maybe Instance_Protocol)
...
newInstance 
    ::  Instance
newInstance
  = Instance{createTime = Core.Nothing,
             ...
             fileShares = Core.Nothing, kmsKeyName = Core.Nothing,
             labels = Core.Nothing, name = Core.Nothing,
             networks = Core.Nothing, performanceConfig = Core.Nothing,
             performanceLimits = Core.Nothing, protocol = Core.Nothing,
             replication = Core.Nothing, satisfiesPzi = Core.Nothing,
             satisfiesPzs = Core.Nothing, state = Core.Nothing,
              ...
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "createTime") Core.<*>
                     (o Core..:? "customPerformanceSupported")
                     ...
                     Core.<*> (o Core..:? "performanceConfig")
                     Core.<*> (o Core..:? "performanceLimits")
...
instance Core.ToJSON Instance where
        toJSON Instance{..}
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("customPerformanceSupported" Core..=) Core.<$>
                    customPerformanceSupported,
                  ("deletionProtectionEnabled" Core..=) Core.<$>
                    deletionProtectionEnabled,
                  ("deletionProtectionReason" Core..=) Core.<$>
                  ...
                  ("performanceConfig" Core..=) Core.<$> performanceConfig,
                  ("performanceLimits" Core..=) Core.<$> performanceLimits,
...
newListSnapshotsResponse 
    ::  ListSnapshotsResponse
newListSnapshotsResponse
  = ListSnapshotsResponse{nextPageToken = Core.Nothing,
                          snapshots = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListSnapshotsResponse where
        parseJSON
          = Core.withObject "ListSnapshotsResponse"
              (\ o ->
                 ListSnapshotsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "snapshots")
                     Core.<*> (o Core..:? "unreachable"))
...
newMaintenancePolicy
  = MaintenancePolicy{createTime = Core.Nothing,
                      ...
                      updatePolicy = Core.Nothing, updateTime = Core.Nothing}
...
instance Core.FromJSON MaintenancePolicy_Labels where
        parseJSON
          = Core.withObject "MaintenancePolicy_Labels"
              (\ o -> MaintenancePolicy_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON MaintenancePolicy_Labels where
        toJSON MaintenancePolicy_Labels{..} = Core.toJSON additional
...
newMaintenanceWindow 
    ::  MaintenanceWindow
newMaintenanceWindow
  = MaintenanceWindow{dailyCycle = Core.Nothing,
                      weeklyCycle = Core.Nothing}
instance Core.FromJSON MaintenanceWindow where
        parseJSON
          = Core.withObject "MaintenanceWindow"
              (\ o ->
                 MaintenanceWindow Core.<$>
                   (o Core..:? "dailyCycle") Core.<*> (o Core..:? "weeklyCycle"))
...
newNetworkConfig 
    ::  NetworkConfig
newNetworkConfig
  = NetworkConfig{connectMode = Core.Nothing,
                  ipAddresses = Core.Nothing, modes = Core.Nothing,
                  network = Core.Nothing, reservedIpRange = Core.Nothing}
instance Core.FromJSON NetworkConfig where
        parseJSON
          = Core.withObject "NetworkConfig"
              (\ o ->
                 NetworkConfig Core.<$>
                   (o Core..:? "connectMode") Core.<*> (o Core..:? "ipAddresses")
                     Core.<*> (o Core..:? "modes")
                     Core.<*> (o Core..:? "network")
...
newNfsExportOptions 
    ::  NfsExportOptions
newNfsExportOptions
  = NfsExportOptions{accessMode = Core.Nothing,
                     anonGid = Core.Nothing, anonUid = Core.Nothing,
                     ipRanges = Core.Nothing, squashMode = Core.Nothing}
instance Core.FromJSON NfsExportOptions where
        parseJSON
          = Core.withObject "NfsExportOptions"
              (\ o ->
                 NfsExportOptions Core.<$>
                   (o Core..:? "accessMode") Core.<*>
                     (o Core..:? "anonGid" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "anonUid" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("accessMode" Core..=) Core.<$> accessMode,
                  ("anonGid" Core..=) Core.. Core.AsText Core.<$> anonGid,
                  ("anonUid" Core..=) Core.. Core.AsText Core.<$> anonUid,
...
--
-- /See:/ 'newPerformanceConfig' smart constructor.
...
-- | Creates a value of 'PerformanceConfig' with the minimum fields required to make a request.
newPerformanceConfig 
    ::  PerformanceConfig
newPerformanceConfig
  = PerformanceConfig{fixedIops = Core.Nothing,
                      iopsPerTb = Core.Nothing}
instance Core.FromJSON PerformanceConfig where
        parseJSON
          = Core.withObject "PerformanceConfig"
              (\ o ->
                 PerformanceConfig Core.<$>
                   (o Core..:? "fixedIops") Core.<*> (o Core..:? "iopsPerTb"))

instance Core.ToJSON PerformanceConfig where
        toJSON PerformanceConfig{..}
          = Core.object
              (Core.catMaybes
                 [("fixedIops" Core..=) Core.<$> fixedIops,
                  ("iopsPerTb" Core..=) Core.<$> iopsPerTb])
...
data PerformanceLimits = PerformanceLimits
    ...
    , maxWriteIops :: (Core.Maybe Core.Int64)
      -- | Output only. The max write throughput in bytes per second.
    , maxWriteThroughputBps :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PerformanceLimits' with the minimum fields required to make a request.
newPerformanceLimits 
    ::  PerformanceLimits
newPerformanceLimits
  = PerformanceLimits{maxIops = Core.Nothing,
                      maxReadIops = Core.Nothing, maxReadThroughputBps = Core.Nothing,
                      maxWriteIops = Core.Nothing, maxWriteThroughputBps = Core.Nothing}
instance Core.FromJSON PerformanceLimits where
        parseJSON
          = Core.withObject "PerformanceLimits"
              (\ o ->
                 PerformanceLimits Core.<$>
                   (o Core..:? "maxIops" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "maxReadIops" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxReadThroughputBps" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxWriteIops" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxWriteThroughputBps" Core.<&>
                        Core.fmap Core.fromAsText))

instance Core.ToJSON PerformanceLimits where
        toJSON PerformanceLimits{..}
          = Core.object
              (Core.catMaybes
                 [("maxIops" Core..=) Core.. Core.AsText Core.<$> maxIops,
                  ("maxReadIops" Core..=) Core.. Core.AsText Core.<$> maxReadIops,
                  ("maxReadThroughputBps" Core..=) Core.. Core.AsText Core.<$>
                    maxReadThroughputBps,
                  ("maxWriteIops" Core..=) Core.. Core.AsText Core.<$> maxWriteIops,
                  ("maxWriteThroughputBps" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON PromoteReplicaRequest where
        parseJSON
          = Core.withObject "PromoteReplicaRequest"
...
--
-- /See:/ 'newReplicaConfig' smart constructor.
data ReplicaConfig = ReplicaConfig
    {
      -- | Output only. The timestamp of the latest replication snapshot taken on the active instance and is already replicated safely.
      lastActiveSyncTime :: (Core.Maybe Core.DateTime)
      -- | Optional. The peer instance.
    , peerInstance :: (Core.Maybe Core.Text)
      -- | Output only. The replica state.
    , state :: (Core.Maybe ReplicaConfig_State)
      -- | Output only. Additional information about the replication state, if available.
    , stateReasons :: (Core.Maybe [ReplicaConfig_StateReasonsItem])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ReplicaConfig' with the minimum fields required to make a request.
newReplicaConfig 
    ::  ReplicaConfig
newReplicaConfig
  = ReplicaConfig{lastActiveSyncTime = Core.Nothing,
                  peerInstance = Core.Nothing, state = Core.Nothing,
                  stateReasons = Core.Nothing}
instance Core.FromJSON ReplicaConfig where
        parseJSON
          = Core.withObject "ReplicaConfig"
              (\ o ->
                 ReplicaConfig Core.<$>
                   (o Core..:? "lastActiveSyncTime") Core.<*>
                     (o Core..:? "peerInstance")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "stateReasons"))

instance Core.ToJSON ReplicaConfig where
        toJSON ReplicaConfig{..}
          = Core.object
              (Core.catMaybes
                 [("lastActiveSyncTime" Core..=) Core.<$> lastActiveSyncTime,
                  ("peerInstance" Core..=) Core.<$> peerInstance,
                  ("state" Core..=) Core.<$> state,
                  ("stateReasons" Core..=) Core.<$> stateReasons])
...
data Replication = Replication
    {
      ...
      replicas :: (Core.Maybe [ReplicaConfig])
      -- | Optional. The replication role.
    , role' :: (Core.Maybe Replication_Role)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newReplication 
    ::  Replication
newReplication
  = Replication{replicas = Core.Nothing, role' = Core.Nothing}
instance Core.FromJSON Replication where
        parseJSON
          = Core.withObject "Replication"
              (\ o ->
                 Replication Core.<$>
                   (o Core..:? "replicas") Core.<*> (o Core..:? "role"))
...
newRestoreInstanceRequest 
    ::  RestoreInstanceRequest
newRestoreInstanceRequest
  = RestoreInstanceRequest{fileShare = Core.Nothing,
                           sourceBackup = Core.Nothing}
instance Core.FromJSON RestoreInstanceRequest where
        parseJSON
          = Core.withObject "RestoreInstanceRequest"
              (\ o ->
                 RestoreInstanceRequest Core.<$>
                   (o Core..:? "fileShare") Core.<*> (o Core..:? "sourceBackup"))
...
--
-- /See:/ 'newRevertInstanceRequest' smart constructor.
newtype RevertInstanceRequest = RevertInstanceRequest
    {
      ...
      targetSnapshotId :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RevertInstanceRequest' with the minimum fields required to make a request.
newRevertInstanceRequest 
    ::  RevertInstanceRequest
newRevertInstanceRequest
  = RevertInstanceRequest{targetSnapshotId = Core.Nothing}
instance Core.FromJSON RevertInstanceRequest where
        parseJSON
          = Core.withObject "RevertInstanceRequest"
              (\ o ->
                 RevertInstanceRequest Core.<$> (o Core..:? "targetSnapshotId"))

instance Core.ToJSON RevertInstanceRequest where
        toJSON RevertInstanceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("targetSnapshotId" Core..=) Core.<$> targetSnapshotId])
...
newSchedule 
    ::  Schedule
newSchedule
  = Schedule{day = Core.Nothing, duration = Core.Nothing,
             startTime = Core.Nothing}
instance Core.FromJSON Schedule where
        parseJSON
          = Core.withObject "Schedule"
              (\ o ->
                 Schedule Core.<$>
...
newSnapshot 
    ::  Snapshot
newSnapshot
  = Snapshot{createTime = Core.Nothing, description = Core.Nothing,
             filesystemUsedBytes = Core.Nothing, labels = Core.Nothing,
             name = Core.Nothing, state = Core.Nothing, tags = Core.Nothing}
          ...
          = Core.withObject "Snapshot"
              (\ o ->
                 Snapshot Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "filesystemUsedBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "state")
        ...
        toJSON Snapshot{..}
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("description" Core..=) Core.<$> description,
                  ("filesystemUsedBytes" Core..=) Core.. Core.AsText Core.<$>
                    filesystemUsedBytes,
                  ("labels" Core..=) Core.<$> labels, ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON Snapshot_Labels where
        parseJSON
          = Core.withObject "Snapshot_Labels"
...
-- | Optional. Input only. Immutable. Tag key-value pairs bound to this resource. Each key must be a namespaced name and each value a short name. Example: \"123456789012\/environment\" : \"production\", \"123456789013\/costCenter\" : \"marketing\" See the documentation for more information: - Namespaced name: https:\/\/cloud.google.com\/resource-manager\/docs\/tags\/tags-creating-and-managing#retrieving/tag/key - Short name: https:\/\/cloud.google.com\/resource-manager\/docs\/tags\/tags-creating-and-managing#retrieving/tag/value
--
-- /See:/ 'newSnapshot_Tags' smart constructor.
newtype Snapshot_Tags = Snapshot_Tags
    {
...
-- | Creates a value of 'Snapshot_Tags' with the minimum fields required to make a request.
newSnapshot_Tags 
    :: 
                 Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Snapshot_Tags
newSnapshot_Tags additional
  = Snapshot_Tags{additional = additional}
instance Core.FromJSON Snapshot_Tags where
        parseJSON
          = Core.withObject "Snapshot_Tags"
              (\ o -> Snapshot_Tags Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Snapshot_Tags where
        toJSON Snapshot_Tags{..} = Core.toJSON additional
...
newUpdatePolicy 
    ::  UpdatePolicy
newUpdatePolicy
  = UpdatePolicy{channel = Core.Nothing,
                 denyMaintenancePeriods = Core.Nothing, window = Core.Nothing}
instance Core.FromJSON UpdatePolicy where
        parseJSON
          = Core.withObject "UpdatePolicy"
              (\ o ->
                 UpdatePolicy Core.<$>
                   (o Core..:? "channel") Core.<*>
                     (o Core..:? "denyMaintenancePeriods")
                     Core.<*> (o Core..:? "window"))
