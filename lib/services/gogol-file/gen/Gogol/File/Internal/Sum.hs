...
module Gogol.File.Internal.Sum
  (
    ...
    Backup_FileSystemProtocol
      (
        Backup_FileSystemProtocol_FILEPROTOCOLUNSPECIFIED,
        Backup_FileSystemProtocol_NFS_V3,
        Backup_FileSystemProtocol_NFS_V4_1,
        ..
      ),
    ...
    Instance_Protocol
      (
        Instance_Protocol_FILEPROTOCOLUNSPECIFIED,
        Instance_Protocol_NFS_V3,
        Instance_Protocol_NFS_V4_1,
        ..
      ),
    ...
    Instance_State
      (
        ...
        Instance_State_Reverting,
        Instance_State_Promoting,
        ..
      ),
    ...
    ReplicaConfig_State
      (
        ReplicaConfig_State_STATEUNSPECIFIED,
        ReplicaConfig_State_Creating,
        ReplicaConfig_State_Ready,
        ReplicaConfig_State_Removing,
        ReplicaConfig_State_Failed,
        ..
      ),
    ...
    Replication_Role
      (
        Replication_Role_ROLEUNSPECIFIED,
        Replication_Role_Active,
        Replication_Role_Standby,
        ..
      ),
...
newtype Backup_FileSystemProtocol = Backup_FileSystemProtocol { fromBackup_FileSystemProtocol :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
-- | FILE/PROTOCOL/UNSPECIFIED serves a \"not set\" default value when a FileProtocol is a separate field in a message.
pattern Backup_FileSystemProtocol_FILEPROTOCOLUNSPECIFIED :: Backup_FileSystemProtocol
pattern Backup_FileSystemProtocol_FILEPROTOCOLUNSPECIFIED = Backup_FileSystemProtocol "FILE_PROTOCOL_UNSPECIFIED"

-- | NFS 3.0.
pattern Backup_FileSystemProtocol_NFS_V3 :: Backup_FileSystemProtocol
pattern Backup_FileSystemProtocol_NFS_V3 = Backup_FileSystemProtocol "NFS_V3"

-- | NFS 4.1.
pattern Backup_FileSystemProtocol_NFS_V4_1 :: Backup_FileSystemProtocol
pattern Backup_FileSystemProtocol_NFS_V4_1 = Backup_FileSystemProtocol "NFS_V4_1"
...
pattern Backup_SourceInstanceTier_Zonal :: Backup_SourceInstanceTier
pattern Backup_SourceInstanceTier_Zonal = Backup_SourceInstanceTier "ZONAL"

-- | REGIONAL instances offer the features and availability needed for mission-critical workloads.
pattern Backup_SourceInstanceTier_Regional :: Backup_SourceInstanceTier
pattern Backup_SourceInstanceTier_Regional = Backup_SourceInstanceTier "REGIONAL"
...
pattern Backup_State_Invalid :: Backup_State
pattern Backup_State_Invalid = Backup_State "INVALID"
...
newtype Instance_Protocol = Instance_Protocol { fromInstance_Protocol :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
-- | FILE/PROTOCOL/UNSPECIFIED serves a \"not set\" default value when a FileProtocol is a separate field in a message.
pattern Instance_Protocol_FILEPROTOCOLUNSPECIFIED :: Instance_Protocol
pattern Instance_Protocol_FILEPROTOCOLUNSPECIFIED = Instance_Protocol "FILE_PROTOCOL_UNSPECIFIED"

-- | NFS 3.0.
pattern Instance_Protocol_NFS_V3 :: Instance_Protocol
pattern Instance_Protocol_NFS_V3 = Instance_Protocol "NFS_V3"

-- | NFS 4.1.
pattern Instance_Protocol_NFS_V4_1 :: Instance_Protocol
pattern Instance_Protocol_NFS_V4_1 = Instance_Protocol "NFS_V4_1"
...
pattern Instance_State_Reverting :: Instance_State
pattern Instance_State_Reverting = Instance_State "REVERTING"

-- | The replica instance is being promoted.
pattern Instance_State_Promoting :: Instance_State
pattern Instance_State_Promoting = Instance_State "PROMOTING"
...
-- | ZONAL instances offer expanded capacity and performance scaling capabilities.
pattern Instance_Tier_Zonal :: Instance_Tier
pattern Instance_Tier_Zonal = Instance_Tier "ZONAL"

-- | REGIONAL instances offer the features and availability needed for mission-critical workloads.
pattern Instance_Tier_Regional :: Instance_Tier
pattern Instance_Tier_Regional = Instance_Tier "REGIONAL"
...
newtype ReplicaConfig_State = ReplicaConfig_State { fromReplicaConfig_State :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
-- | State not set.
pattern ReplicaConfig_State_STATEUNSPECIFIED :: ReplicaConfig_State
pattern ReplicaConfig_State_STATEUNSPECIFIED = ReplicaConfig_State "STATE_UNSPECIFIED"

-- | The replica is being created.
pattern ReplicaConfig_State_Creating :: ReplicaConfig_State
pattern ReplicaConfig_State_Creating = ReplicaConfig_State "CREATING"

-- | The replica is ready.
pattern ReplicaConfig_State_Ready :: ReplicaConfig_State
pattern ReplicaConfig_State_Ready = ReplicaConfig_State "READY"

-- | The replica is being removed.
pattern ReplicaConfig_State_Removing :: ReplicaConfig_State
pattern ReplicaConfig_State_Removing = ReplicaConfig_State "REMOVING"
...
pattern ReplicaConfig_State_Failed :: ReplicaConfig_State
pattern ReplicaConfig_State_Failed = ReplicaConfig_State "FAILED"
...
newtype ReplicaConfig_StateReasonsItem = ReplicaConfig_StateReasonsItem { fromReplicaConfig_StateReasonsItem :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
pattern ReplicaConfig_StateReasonsItem_STATEREASONUNSPECIFIED :: ReplicaConfig_StateReasonsItem
pattern ReplicaConfig_StateReasonsItem_STATEREASONUNSPECIFIED = ReplicaConfig_StateReasonsItem "STATE_REASON_UNSPECIFIED"
...
newtype Replication_Role = Replication_Role { fromReplication_Role :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
-- | Role not set.
pattern Replication_Role_ROLEUNSPECIFIED :: Replication_Role
pattern Replication_Role_ROLEUNSPECIFIED = Replication_Role "ROLE_UNSPECIFIED"

-- | The instance is the @ACTIVE@ replication member, functions as the replication source instance.
pattern Replication_Role_Active :: Replication_Role
pattern Replication_Role_Active = Replication_Role "ACTIVE"

-- | The instance is the @STANDBY@ replication member, functions as the replication destination instance.
pattern Replication_Role_Standby :: Replication_Role
pattern Replication_Role_Standby = Replication_Role "STANDBY"
