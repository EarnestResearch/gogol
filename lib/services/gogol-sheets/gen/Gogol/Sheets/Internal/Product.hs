...
instance Core.FromJSON AddBandingRequest where
        parseJSON
          = Core.withObject "AddBandingRequest"
              (\ o ->
                 AddBandingRequest Core.<$>
                   (o Core..:? "bandedRange"))
...
instance Core.FromJSON AddBandingResponse where
        parseJSON
          = Core.withObject "AddBandingResponse"
              (\ o ->
                 AddBandingResponse Core.<$>
                   (o Core..:? "bandedRange"))
...
instance Core.FromJSON AddChartRequest where
        parseJSON
          = Core.withObject "AddChartRequest"
              (\ o ->
...
instance Core.FromJSON AddChartResponse where
        parseJSON
          = Core.withObject "AddChartResponse"
              (\ o ->
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "AddConditionalFormatRuleRequest"
              (\ o ->
                 AddConditionalFormatRuleRequest Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "rule"))

instance Core.ToJSON AddConditionalFormatRuleRequest
         where
...
instance Core.FromJSON AddDataSourceRequest where
        parseJSON
          = Core.withObject "AddDataSourceRequest"
              (\ o ->
                 AddDataSourceRequest Core.<$>
                   (o Core..:? "dataSource"))
...
newAddDataSourceResponse =
  AddDataSourceResponse
    {dataExecutionStatus = Core.Nothing, dataSource = Core.Nothing}

instance Core.FromJSON AddDataSourceResponse where
        parseJSON
          = Core.withObject "AddDataSourceResponse"
              (\ o ->
                 AddDataSourceResponse Core.<$>
                   (o Core..:? "dataExecutionStatus") Core.<*>
                     (o Core..:? "dataSource"))
...
instance Core.FromJSON AddDimensionGroupRequest where
        parseJSON
          = Core.withObject "AddDimensionGroupRequest"
              (\ o ->
                 AddDimensionGroupRequest Core.<$>
                   (o Core..:? "range"))
...
instance Core.FromJSON AddDimensionGroupResponse
         where
        parseJSON
          = Core.withObject "AddDimensionGroupResponse"
              (\ o ->
                 AddDimensionGroupResponse Core.<$>
                   (o Core..:? "dimensionGroups"))

instance Core.ToJSON AddDimensionGroupResponse where
        toJSON AddDimensionGroupResponse{..}
          = Core.object
              (Core.catMaybes
                 [("dimensionGroups" Core..=) Core.<$>
                    dimensionGroups])
...
instance Core.FromJSON AddFilterViewRequest where
        parseJSON
          = Core.withObject "AddFilterViewRequest"
              (\ o ->
...
instance Core.FromJSON AddFilterViewResponse where
        parseJSON
          = Core.withObject "AddFilterViewResponse"
              (\ o ->
...
instance Core.FromJSON AddNamedRangeRequest where
        parseJSON
          = Core.withObject "AddNamedRangeRequest"
              (\ o ->
                 AddNamedRangeRequest Core.<$>
                   (o Core..:? "namedRange"))
...
instance Core.FromJSON AddNamedRangeResponse where
        parseJSON
          = Core.withObject "AddNamedRangeResponse"
              (\ o ->
                 AddNamedRangeResponse Core.<$>
                   (o Core..:? "namedRange"))
...
instance Core.FromJSON AddProtectedRangeRequest where
        parseJSON
          = Core.withObject "AddProtectedRangeRequest"
              (\ o ->
                 AddProtectedRangeRequest Core.<$>
                   (o Core..:? "protectedRange"))
...
instance Core.FromJSON AddProtectedRangeResponse
         where
        parseJSON
          = Core.withObject "AddProtectedRangeResponse"
              (\ o ->
                 AddProtectedRangeResponse Core.<$>
                   (o Core..:? "protectedRange"))
...
instance Core.FromJSON AddSheetRequest where
        parseJSON
          = Core.withObject "AddSheetRequest"
              (\ o ->
...
instance Core.FromJSON AddSheetResponse where
        parseJSON
          = Core.withObject "AddSheetResponse"
              (\ o ->
...
instance Core.FromJSON AddSlicerRequest where
        parseJSON
          = Core.withObject "AddSlicerRequest"
              (\ o ->
...
instance Core.FromJSON AddSlicerResponse where
        parseJSON
          = Core.withObject "AddSlicerResponse"
              (\ o ->
...
newAppendCellsRequest =
  AppendCellsRequest
    {fields = Core.Nothing, rows = Core.Nothing, sheetId = Core.Nothing}

instance Core.FromJSON AppendCellsRequest where
        parseJSON
          = Core.withObject "AppendCellsRequest"
              (\ o ->
                 AppendCellsRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "rows")
                     Core.<*> (o Core..:? "sheetId"))
...
newAppendDimensionRequest =
  AppendDimensionRequest
    {dimension = Core.Nothing, length = Core.Nothing, sheetId = Core.Nothing}

instance Core.FromJSON AppendDimensionRequest where
        parseJSON
          = Core.withObject "AppendDimensionRequest"
              (\ o ->
                 AppendDimensionRequest Core.<$>
...
instance Core.FromJSON AppendValuesResponse where
        parseJSON
          = Core.withObject "AppendValuesResponse"
              (\ o ->
                 AppendValuesResponse Core.<$>
                   (o Core..:? "spreadsheetId") Core.<*>
                     (o Core..:? "tableRange")
                     Core.<*> (o Core..:? "updates"))
...
instance Core.FromJSON AutoFillRequest where
        parseJSON
          = Core.withObject "AutoFillRequest"
              (\ o ->
                 AutoFillRequest Core.<$>
                   (o Core..:? "range") Core.<*>
                     (o Core..:? "sourceAndDestination")
          ...
          = Core.object
              (Core.catMaybes
                 [("range" Core..=) Core.<$> range,
                  ("sourceAndDestination" Core..=) Core.<$>
                    sourceAndDestination,
                  ("useAlternateSeries" Core..=) Core.<$>
                    useAlternateSeries])
...
newAutoResizeDimensionsRequest =
  AutoResizeDimensionsRequest
    {dataSourceSheetDimensions = Core.Nothing, dimensions = Core.Nothing}

instance Core.FromJSON AutoResizeDimensionsRequest
         where
        parseJSON
          = Core.withObject "AutoResizeDimensionsRequest"
              (\ o ->
                 AutoResizeDimensionsRequest Core.<$>
                   (o Core..:? "dataSourceSheetDimensions") Core.<*>
                     (o Core..:? "dimensions"))

instance Core.ToJSON AutoResizeDimensionsRequest
         where
        toJSON AutoResizeDimensionsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("dataSourceSheetDimensions" Core..=) Core.<$>
...
instance Core.FromJSON BandedRange where
        parseJSON
          = Core.withObject "BandedRange"
              (\ o ->
                 BandedRange Core.<$>
                   (o Core..:? "bandedRangeId") Core.<*>
                     (o Core..:? "columnProperties")
                     Core.<*> (o Core..:? "range")
...
instance Core.FromJSON BandingProperties where
        parseJSON
          = Core.withObject "BandingProperties"
              (\ o ->
                 BandingProperties Core.<$>
                   (o Core..:? "firstBandColor") Core.<*>
                     (o Core..:? "firstBandColorStyle")
          ...
          = Core.object
              (Core.catMaybes
                 [("firstBandColor" Core..=) Core.<$> firstBandColor,
                  ("firstBandColorStyle" Core..=) Core.<$>
                    firstBandColorStyle,
                  ("footerColor" Core..=) Core.<$> footerColor,
                  ("footerColorStyle" Core..=) Core.<$>
                    footerColorStyle,
                  ("headerColor" Core..=) Core.<$> headerColor,
                  ("headerColorStyle" Core..=) Core.<$>
                    headerColorStyle,
                  ("secondBandColor" Core..=) Core.<$> secondBandColor,
                  ("secondBandColorStyle" Core..=) Core.<$>
...
instance Core.FromJSON BaselineValueFormat where
        parseJSON
          = Core.withObject "BaselineValueFormat"
              (\ o ->
                 BaselineValueFormat Core.<$>
                   (o Core..:? "comparisonType") Core.<*>
                     (o Core..:? "description")
...
instance Core.FromJSON BasicChartAxis where
        parseJSON
          = Core.withObject "BasicChartAxis"
              (\ o ->
                 BasicChartAxis Core.<$>
                   (o Core..:? "format") Core.<*>
                     (o Core..:? "position")
          ...
          = Core.object
              (Core.catMaybes
                 [("format" Core..=) Core.<$> format,
                  ...
                  ("titleTextPosition" Core..=) Core.<$>
                    titleTextPosition,
                  ("viewWindowOptions" Core..=) Core.<$>
                    viewWindowOptions])
...
instance Core.FromJSON BasicChartDomain where
        parseJSON
          = Core.withObject "BasicChartDomain"
              (\ o ->
                 BasicChartDomain Core.<$>
                   (o Core..:? "domain") Core.<*>
                     (o Core..:? "reversed"))
...
instance Core.FromJSON BasicChartSeries where
        parseJSON
          = Core.withObject "BasicChartSeries"
              (\ o ->
                 BasicChartSeries Core.<$>
                   (o Core..:? "color") Core.<*>
                     (o Core..:? "colorStyle")
...
instance Core.FromJSON BasicChartSpec where
        parseJSON
          = Core.withObject "BasicChartSpec"
              (\ o ->
                 BasicChartSpec Core.<$>
                   (o Core..:? "axis") Core.<*> (o Core..:? "chartType")
...
instance Core.FromJSON BasicFilter where
        parseJSON
          = Core.withObject "BasicFilter"
              (\ o ->
                 BasicFilter Core.<$>
                   (o Core..:? "criteria") Core.<*>
                     (o Core..:? "filterSpecs")
                     Core.<*> (o Core..:? "range")
...
instance Core.FromJSON BasicFilter_Criteria where
        parseJSON
          = Core.withObject "BasicFilter_Criteria"
              (\ o ->
                 BasicFilter_Criteria Core.<$>
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "BasicSeriesDataPointStyleOverride"
              (\ o ->
                 BasicSeriesDataPointStyleOverride Core.<$>
                   (o Core..:? "color") Core.<*>
                     (o Core..:? "colorStyle")
                     Core.<*> (o Core..:? "index")
                     Core.<*> (o Core..:? "pointStyle"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BatchClearValuesByDataFilterRequest"
              (\ o ->
                 BatchClearValuesByDataFilterRequest Core.<$>
                   (o Core..:? "dataFilters"))
...
newBatchClearValuesByDataFilterResponse =
  BatchClearValuesByDataFilterResponse
    {clearedRanges = Core.Nothing, spreadsheetId = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BatchClearValuesByDataFilterResponse"
              (\ o ->
                 BatchClearValuesByDataFilterResponse Core.<$>
                   (o Core..:? "clearedRanges") Core.<*>
                     (o Core..:? "spreadsheetId"))
...
instance Core.FromJSON BatchClearValuesRequest where
        parseJSON
          = Core.withObject "BatchClearValuesRequest"
              (\ o ->
                 BatchClearValuesRequest Core.<$>
                   (o Core..:? "ranges"))
...
instance Core.FromJSON BatchClearValuesResponse where
        parseJSON
          = Core.withObject "BatchClearValuesResponse"
              (\ o ->
                 BatchClearValuesResponse Core.<$>
                   (o Core..:? "clearedRanges") Core.<*>
                     (o Core..:? "spreadsheetId"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "BatchGetValuesByDataFilterRequest"
              (\ o ->
                 BatchGetValuesByDataFilterRequest Core.<$>
                   (o Core..:? "dataFilters") Core.<*>
                     (o Core..:? "dateTimeRenderOption")
...
instance Core.ToJSON
        ...
        toJSON BatchGetValuesByDataFilterRequest{..}
          = Core.object
              (Core.catMaybes
                 [("dataFilters" Core..=) Core.<$> dataFilters,
                  ("dateTimeRenderOption" Core..=) Core.<$>
                    dateTimeRenderOption,
                  ("majorDimension" Core..=) Core.<$> majorDimension,
                  ("valueRenderOption" Core..=) Core.<$>
                    valueRenderOption])
...
newBatchGetValuesByDataFilterResponse =
  BatchGetValuesByDataFilterResponse
    {spreadsheetId = Core.Nothing, valueRanges = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BatchGetValuesByDataFilterResponse"
              (\ o ->
                 BatchGetValuesByDataFilterResponse Core.<$>
                   (o Core..:? "spreadsheetId") Core.<*>
                     (o Core..:? "valueRanges"))
...
instance Core.FromJSON BatchGetValuesResponse where
        parseJSON
          = Core.withObject "BatchGetValuesResponse"
              (\ o ->
                 BatchGetValuesResponse Core.<$>
                   (o Core..:? "spreadsheetId") Core.<*>
                     (o Core..:? "valueRanges"))
...
instance Core.FromJSON BatchUpdateSpreadsheetRequest
         where
        parseJSON
          = Core.withObject "BatchUpdateSpreadsheetRequest"
              (\ o ->
                 BatchUpdateSpreadsheetRequest Core.<$>
                   (o Core..:? "includeSpreadsheetInResponse") Core.<*>
                     (o Core..:? "requests")
                     Core.<*> (o Core..:? "responseIncludeGridData")
                     Core.<*> (o Core..:? "responseRanges"))

instance Core.ToJSON BatchUpdateSpreadsheetRequest
         where
        toJSON BatchUpdateSpreadsheetRequest{..}
          = Core.object
              (Core.catMaybes
                 [("includeSpreadsheetInResponse" Core..=) Core.<$>
                    includeSpreadsheetInResponse,
                  ("requests" Core..=) Core.<$> requests,
                  ("responseIncludeGridData" Core..=) Core.<$>
...
instance Core.FromJSON BatchUpdateSpreadsheetResponse
         where
        parseJSON
          = Core.withObject "BatchUpdateSpreadsheetResponse"
              (\ o ->
                 BatchUpdateSpreadsheetResponse Core.<$>
                   (o Core..:? "replies") Core.<*>
                     (o Core..:? "spreadsheetId")
                     Core.<*> (o Core..:? "updatedSpreadsheet"))

instance Core.ToJSON BatchUpdateSpreadsheetResponse
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BatchUpdateValuesByDataFilterRequest"
              (\ o ->
                 BatchUpdateValuesByDataFilterRequest Core.<$>
                   (o Core..:? "data") Core.<*>
                     (o Core..:? "includeValuesInResponse")
...
instance Core.ToJSON
        ...
        toJSON BatchUpdateValuesByDataFilterRequest{..}
          = Core.object
              (Core.catMaybes
                 [("data" Core..=) Core.<$> data',
                  ("includeValuesInResponse" Core..=) Core.<$>
                    includeValuesInResponse,
                  ("responseDateTimeRenderOption" Core..=) Core.<$>
                    responseDateTimeRenderOption,
                  ("responseValueRenderOption" Core..=) Core.<$>
                    responseValueRenderOption,
                  ("valueInputOption" Core..=) Core.<$>
                    valueInputOption])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BatchUpdateValuesByDataFilterResponse"
              (\ o ->
                 BatchUpdateValuesByDataFilterResponse Core.<$>
                   (o Core..:? "responses") Core.<*>
                     (o Core..:? "spreadsheetId")
          ...
          = Core.object
              (Core.catMaybes
                 [("responses" Core..=) Core.<$> responses,
                  ("spreadsheetId" Core..=) Core.<$> spreadsheetId,
                  ("totalUpdatedCells" Core..=) Core.<$>
                    totalUpdatedCells,
                  ("totalUpdatedColumns" Core..=) Core.<$>
                    totalUpdatedColumns,
                  ("totalUpdatedRows" Core..=) Core.<$>
                    totalUpdatedRows,
                  ("totalUpdatedSheets" Core..=) Core.<$>
                    totalUpdatedSheets])
...
instance Core.FromJSON BatchUpdateValuesRequest where
        parseJSON
          = Core.withObject "BatchUpdateValuesRequest"
              (\ o ->
                 BatchUpdateValuesRequest Core.<$>
                   (o Core..:? "data") Core.<*>
                     (o Core..:? "includeValuesInResponse")
                     Core.<*> (o Core..:? "responseDateTimeRenderOption")
                     Core.<*> (o Core..:? "responseValueRenderOption")
...
instance Core.FromJSON BatchUpdateValuesResponse
         where
        parseJSON
          = Core.withObject "BatchUpdateValuesResponse"
              (\ o ->
                 BatchUpdateValuesResponse Core.<$>
                   (o Core..:? "responses") Core.<*>
                     (o Core..:? "spreadsheetId")
                     Core.<*> (o Core..:? "totalUpdatedCells")
                     Core.<*> (o Core..:? "totalUpdatedColumns")
...
instance Core.FromJSON BigQueryDataSourceSpec where
        parseJSON
          = Core.withObject "BigQueryDataSourceSpec"
              (\ o ->
                 BigQueryDataSourceSpec Core.<$>
...
instance Core.FromJSON BigQueryQuerySpec where
        parseJSON
          = Core.withObject "BigQueryQuerySpec"
              (\ o ->
...
instance Core.FromJSON BigQueryTableSpec where
        parseJSON
          = Core.withObject "BigQueryTableSpec"
              (\ o ->
                 BigQueryTableSpec Core.<$>
...
instance Core.FromJSON BooleanCondition where
        parseJSON
          = Core.withObject "BooleanCondition"
              (\ o ->
                 BooleanCondition Core.<$>
                   (o Core..:? "type") Core.<*> (o Core..:? "values"))
...
instance Core.FromJSON Borders where
        parseJSON
          = Core.withObject "Borders"
              (\ o ->
                 Borders Core.<$>
                   (o Core..:? "bottom") Core.<*> (o Core..:? "left")
                     Core.<*> (o Core..:? "right")
                     Core.<*> (o Core..:? "top"))
...
instance Core.FromJSON BubbleChartSpec where
        parseJSON
          = Core.withObject "BubbleChartSpec"
              (\ o ->
                 BubbleChartSpec Core.<$>
                   (o Core..:? "bubbleBorderColor") Core.<*>
                     (o Core..:? "bubbleBorderColorStyle")
...
instance Core.ToJSON BubbleChartSpec where
        toJSON BubbleChartSpec{..}
          = Core.object
              (Core.catMaybes
                 [("bubbleBorderColor" Core..=) Core.<$>
                    bubbleBorderColor,
                  ("bubbleBorderColorStyle" Core..=) Core.<$>
                    bubbleBorderColorStyle,
                  ("bubbleLabels" Core..=) Core.<$> bubbleLabels,
                  ("bubbleMaxRadiusSize" Core..=) Core.<$>
                    bubbleMaxRadiusSize,
                  ("bubbleMinRadiusSize" Core..=) Core.<$>
                    bubbleMinRadiusSize,
...
instance Core.FromJSON CandlestickChartSpec where
        parseJSON
          = Core.withObject "CandlestickChartSpec"
              (\ o ->
                 CandlestickChartSpec Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "domain"))
...
instance Core.FromJSON CandlestickData where
        parseJSON
          = Core.withObject "CandlestickData"
              (\ o ->
                 CandlestickData Core.<$>
                   (o Core..:? "closeSeries") Core.<*>
                     (o Core..:? "highSeries")
...
instance Core.FromJSON CandlestickDomain where
        parseJSON
          = Core.withObject "CandlestickDomain"
              (\ o ->
                 CandlestickDomain Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "reversed"))
...
instance Core.FromJSON CandlestickSeries where
        parseJSON
          = Core.withObject "CandlestickSeries"
              (\ o ->
...
instance Core.FromJSON CellData where
        parseJSON
          = Core.withObject "CellData"
              (\ o ->
                 CellData Core.<$>
                   (o Core..:? "dataSourceFormula") Core.<*>
                     (o Core..:? "dataSourceTable")
          ...
          = Core.object
              (Core.catMaybes
                 [("dataSourceFormula" Core..=) Core.<$>
                  ...
                  ("userEnteredFormat" Core..=) Core.<$>
                    userEnteredFormat,
                  ("userEnteredValue" Core..=) Core.<$>
                    userEnteredValue])
...
instance Core.FromJSON CellFormat where
        parseJSON
          = Core.withObject "CellFormat"
              (\ o ->
                 CellFormat Core.<$>
                   (o Core..:? "backgroundColor") Core.<*>
                     (o Core..:? "backgroundColorStyle")
                     Core.<*> (o Core..:? "borders")
          ...
          = Core.object
              (Core.catMaybes
                 [("backgroundColor" Core..=) Core.<$>
                    backgroundColor,
                  ("backgroundColorStyle" Core..=) Core.<$>
                    backgroundColorStyle,
                  ("borders" Core..=) Core.<$> borders,
                  ("horizontalAlignment" Core..=) Core.<$>
                    horizontalAlignment,
                  ("hyperlinkDisplayType" Core..=) Core.<$>
...
instance Core.FromJSON ChartAxisViewWindowOptions
         where
        parseJSON
          = Core.withObject "ChartAxisViewWindowOptions"
              (\ o ->
                 ChartAxisViewWindowOptions Core.<$>
                   (o Core..:? "viewWindowMax") Core.<*>
                     (o Core..:? "viewWindowMin")
...
instance Core.FromJSON ChartCustomNumberFormatOptions
         where
        parseJSON
          = Core.withObject "ChartCustomNumberFormatOptions"
              (\ o ->
                 ChartCustomNumberFormatOptions Core.<$>
                   (o Core..:? "prefix") Core.<*> (o Core..:? "suffix"))

instance Core.ToJSON ChartCustomNumberFormatOptions
         where
...
instance Core.FromJSON ChartData where
        parseJSON
          = Core.withObject "ChartData"
              (\ o ->
                 ChartData Core.<$>
                   (o Core..:? "aggregateType") Core.<*>
                     (o Core..:? "columnReference")
...
instance Core.FromJSON ChartDateTimeRule where
        parseJSON
          = Core.withObject "ChartDateTimeRule"
              (\ o ->
...
instance Core.FromJSON ChartGroupRule where
        parseJSON
          = Core.withObject "ChartGroupRule"
              (\ o ->
                 ChartGroupRule Core.<$>
                   (o Core..:? "dateTimeRule") Core.<*>
                     (o Core..:? "histogramRule"))
...
instance Core.FromJSON ChartHistogramRule where
        parseJSON
          = Core.withObject "ChartHistogramRule"
              (\ o ->
                 ChartHistogramRule Core.<$>
                   (o Core..:? "intervalSize") Core.<*>
                     (o Core..:? "maxValue")
...
instance Core.FromJSON ChartSourceRange where
        parseJSON
          = Core.withObject "ChartSourceRange"
              (\ o ->
...
instance Core.FromJSON ChartSpec where
        parseJSON
          = Core.withObject "ChartSpec"
              (\ o ->
                 ChartSpec Core.<$>
                   (o Core..:? "altText") Core.<*>
                     (o Core..:? "backgroundColor")
          ...
          = Core.object
              (Core.catMaybes
                 [("altText" Core..=) Core.<$> altText,
                  ...
                  ("candlestickChart" Core..=) Core.<$>
                    candlestickChart,
                  ("dataSourceChartProperties" Core..=) Core.<$>
                    dataSourceChartProperties,
                  ("filterSpecs" Core..=) Core.<$> filterSpecs,
                  ("fontName" Core..=) Core.<$> fontName,
                  ("hiddenDimensionStrategy" Core..=) Core.<$>
                  ...
                  ("subtitleTextFormat" Core..=) Core.<$>
                    subtitleTextFormat,
                  ("subtitleTextPosition" Core..=) Core.<$>
...
instance Core.FromJSON ClearBasicFilterRequest where
        parseJSON
          = Core.withObject "ClearBasicFilterRequest"
              (\ o ->
                 ClearBasicFilterRequest Core.<$>
                   (o Core..:? "sheetId"))
...
instance Core.FromJSON ClearValuesRequest where
        parseJSON
          = Core.withObject "ClearValuesRequest"
...
newClearValuesResponse =
  ClearValuesResponse
    {clearedRange = Core.Nothing, spreadsheetId = Core.Nothing}

instance Core.FromJSON ClearValuesResponse where
        parseJSON
          = Core.withObject "ClearValuesResponse"
              (\ o ->
                 ClearValuesResponse Core.<$>
                   (o Core..:? "clearedRange") Core.<*>
                     (o Core..:? "spreadsheetId"))
...
instance Core.FromJSON ColorStyle where
        parseJSON
          = Core.withObject "ColorStyle"
              (\ o ->
                 ColorStyle Core.<$>
                   (o Core..:? "rgbColor") Core.<*>
                     (o Core..:? "themeColor"))
...
instance Core.FromJSON ConditionValue where
        parseJSON
          = Core.withObject "ConditionValue"
              (\ o ->
                 ConditionValue Core.<$>
                   (o Core..:? "relativeDate") Core.<*>
                     (o Core..:? "userEnteredValue"))
...
instance Core.FromJSON ConditionalFormatRule where
        parseJSON
          = Core.withObject "ConditionalFormatRule"
              (\ o ->
                 ConditionalFormatRule Core.<$>
                   (o Core..:? "booleanRule") Core.<*>
                     (o Core..:? "gradientRule")
                     Core.<*> (o Core..:? "ranges"))
...
instance Core.FromJSON CopyPasteRequest where
        parseJSON
          = Core.withObject "CopyPasteRequest"
              (\ o ->
                 CopyPasteRequest Core.<$>
                   (o Core..:? "destination") Core.<*>
                     (o Core..:? "pasteOrientation")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "CopySheetToAnotherSpreadsheetRequest"
              (\ o ->
                 CopySheetToAnotherSpreadsheetRequest Core.<$>
                   (o Core..:? "destinationSpreadsheetId"))
...
instance Core.ToJSON
        ...
        toJSON CopySheetToAnotherSpreadsheetRequest{..}
          = Core.object
              (Core.catMaybes
                 [("destinationSpreadsheetId" Core..=) Core.<$>
...
instance Core.FromJSON CreateDeveloperMetadataRequest
         where
        parseJSON
          = Core.withObject "CreateDeveloperMetadataRequest"
              (\ o ->
                 CreateDeveloperMetadataRequest Core.<$>
                   (o Core..:? "developerMetadata"))

instance Core.ToJSON CreateDeveloperMetadataRequest
         where
        toJSON CreateDeveloperMetadataRequest{..}
          = Core.object
              (Core.catMaybes
                 [("developerMetadata" Core..=) Core.<$>
                    developerMetadata])
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "CreateDeveloperMetadataResponse"
              (\ o ->
                 CreateDeveloperMetadataResponse Core.<$>
                   (o Core..:? "developerMetadata"))

instance Core.ToJSON CreateDeveloperMetadataResponse
         where
...
instance Core.FromJSON CutPasteRequest where
        parseJSON
          = Core.withObject "CutPasteRequest"
              (\ o ->
                 CutPasteRequest Core.<$>
                   (o Core..:? "destination") Core.<*>
                     (o Core..:? "pasteType")
                     Core.<*> (o Core..:? "source"))
...
instance Core.FromJSON DataExecutionStatus where
        parseJSON
          = Core.withObject "DataExecutionStatus"
              (\ o ->
                 DataExecutionStatus Core.<$>
                   (o Core..:? "errorCode") Core.<*>
                     (o Core..:? "errorMessage")
...
instance Core.FromJSON DataFilter where
        parseJSON
          = Core.withObject "DataFilter"
              (\ o ->
                 DataFilter Core.<$>
                   (o Core..:? "a1Range") Core.<*>
                     (o Core..:? "developerMetadataLookup")
          ...
          = Core.object
              (Core.catMaybes
                 [("a1Range" Core..=) Core.<$> a1Range,
                  ("developerMetadataLookup" Core..=) Core.<$>
                    developerMetadataLookup,
...
instance Core.FromJSON DataFilterValueRange where
        parseJSON
          = Core.withObject "DataFilterValueRange"
              (\ o ->
                 DataFilterValueRange Core.<$>
                   (o Core..:? "dataFilter") Core.<*>
                     (o Core..:? "majorDimension")
                     Core.<*> (o Core..:? "values"))
...
instance Core.FromJSON DataLabel where
        parseJSON
          = Core.withObject "DataLabel"
              (\ o ->
                 DataLabel Core.<$>
                   (o Core..:? "customLabelData") Core.<*>
                     (o Core..:? "placement")
                     Core.<*> (o Core..:? "textFormat")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON DataSource where
        parseJSON
          = Core.withObject "DataSource"
              (\ o ->
                 DataSource Core.<$>
                   (o Core..:? "calculatedColumns") Core.<*>
                     (o Core..:? "dataSourceId")
                     Core.<*> (o Core..:? "sheetId")
                     Core.<*> (o Core..:? "spec"))
...
newDataSourceChartProperties =
  DataSourceChartProperties
    {dataExecutionStatus = Core.Nothing, dataSourceId = Core.Nothing}

instance Core.FromJSON DataSourceChartProperties
         where
        parseJSON
          = Core.withObject "DataSourceChartProperties"
              (\ o ->
...
instance Core.FromJSON DataSourceColumn where
        parseJSON
          = Core.withObject "DataSourceColumn"
              (\ o ->
                 DataSourceColumn Core.<$>
                   (o Core..:? "formula") Core.<*>
                     (o Core..:? "reference"))
...
instance Core.FromJSON DataSourceColumnReference
         where
        parseJSON
          = Core.withObject "DataSourceColumnReference"
              (\ o ->
...
instance Core.FromJSON DataSourceFormula where
        parseJSON
          = Core.withObject "DataSourceFormula"
              (\ o ->
...
instance Core.FromJSON DataSourceObjectReference
         where
        parseJSON
          = Core.withObject "DataSourceObjectReference"
              (\ o ->
                 DataSourceObjectReference Core.<$>
                   (o Core..:? "chartId") Core.<*>
                     (o Core..:? "dataSourceFormulaCell")
                     Core.<*>
                     (o Core..:? "dataSourcePivotTableAnchorCell")
          ...
          = Core.object
              (Core.catMaybes
                 [("chartId" Core..=) Core.<$> chartId,
                  ("dataSourceFormulaCell" Core..=) Core.<$>
                    dataSourceFormulaCell,
                  ("dataSourcePivotTableAnchorCell" Core..=) Core.<$>
                    dataSourcePivotTableAnchorCell,
                  ("dataSourceTableAnchorCell" Core..=) Core.<$>
...
instance Core.FromJSON DataSourceObjectReferences
         where
        parseJSON
          = Core.withObject "DataSourceObjectReferences"
              (\ o ->
                 DataSourceObjectReferences Core.<$>
                   (o Core..:? "references"))
...
newDataSourceParameter =
  DataSourceParameter
    {name = Core.Nothing, namedRangeId = Core.Nothing, range = Core.Nothing}

instance Core.FromJSON DataSourceParameter where
        parseJSON
          = Core.withObject "DataSourceParameter"
              (\ o ->
                 DataSourceParameter Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "namedRangeId")
                     Core.<*> (o Core..:? "range"))
...
instance Core.FromJSON DataSourceRefreshDailySchedule
         where
        parseJSON
          = Core.withObject "DataSourceRefreshDailySchedule"
              (\ o ->
                 DataSourceRefreshDailySchedule Core.<$>
                   (o Core..:? "startTime"))

instance Core.ToJSON DataSourceRefreshDailySchedule
         where
...
newDataSourceRefreshMonthlySchedule =
  DataSourceRefreshMonthlySchedule
    {daysOfMonth = Core.Nothing, startTime = Core.Nothing}

instance Core.FromJSON
           DataSourceRefreshMonthlySchedule
         where
        parseJSON
          = Core.withObject "DataSourceRefreshMonthlySchedule"
              (\ o ->
                 DataSourceRefreshMonthlySchedule Core.<$>
                   (o Core..:? "daysOfMonth") Core.<*>
                     (o Core..:? "startTime"))

instance Core.ToJSON DataSourceRefreshMonthlySchedule
         where
...
instance Core.FromJSON DataSourceRefreshSchedule
         where
        parseJSON
          = Core.withObject "DataSourceRefreshSchedule"
              (\ o ->
                 DataSourceRefreshSchedule Core.<$>
                   (o Core..:? "dailySchedule") Core.<*>
                     (o Core..:? "enabled")
...
newDataSourceRefreshWeeklySchedule =
  DataSourceRefreshWeeklySchedule
    {daysOfWeek = Core.Nothing, startTime = Core.Nothing}

instance Core.FromJSON
           DataSourceRefreshWeeklySchedule
         where
        parseJSON
          = Core.withObject "DataSourceRefreshWeeklySchedule"
              (\ o ->
                 DataSourceRefreshWeeklySchedule Core.<$>
                   (o Core..:? "daysOfWeek") Core.<*>
                     (o Core..:? "startTime"))

instance Core.ToJSON DataSourceRefreshWeeklySchedule
         where
...
newDataSourceSheetDimensionRange =
  DataSourceSheetDimensionRange
    {columnReferences = Core.Nothing, sheetId = Core.Nothing}

instance Core.FromJSON DataSourceSheetDimensionRange
         where
        parseJSON
          = Core.withObject "DataSourceSheetDimensionRange"
              (\ o ->
                 DataSourceSheetDimensionRange Core.<$>
                   (o Core..:? "columnReferences") Core.<*>
                     (o Core..:? "sheetId"))

instance Core.ToJSON DataSourceSheetDimensionRange
         where
...
instance Core.FromJSON DataSourceSheetProperties
         where
        parseJSON
          = Core.withObject "DataSourceSheetProperties"
              (\ o ->
                 DataSourceSheetProperties Core.<$>
                   (o Core..:? "columns") Core.<*>
                     (o Core..:? "dataExecutionStatus")
...
instance Core.FromJSON DataSourceSpec where
        parseJSON
          = Core.withObject "DataSourceSpec"
              (\ o ->
                 DataSourceSpec Core.<$>
                   (o Core..:? "bigQuery") Core.<*>
                     (o Core..:? "parameters"))
...
instance Core.FromJSON DataSourceTable where
        parseJSON
          = Core.withObject "DataSourceTable"
              (\ o ->
                 DataSourceTable Core.<$>
                   (o Core..:? "columnSelectionType") Core.<*>
                     (o Core..:? "columns")
...
instance Core.FromJSON DataValidationRule where
        parseJSON
          = Core.withObject "DataValidationRule"
              (\ o ->
                 DataValidationRule Core.<$>
                   (o Core..:? "condition") Core.<*>
                     (o Core..:? "inputMessage")
...
instance Core.FromJSON DeleteBandingRequest where
        parseJSON
          = Core.withObject "DeleteBandingRequest"
              (\ o ->
                 DeleteBandingRequest Core.<$>
                   (o Core..:? "bandedRangeId"))
...
newDeleteConditionalFormatRuleRequest =
  DeleteConditionalFormatRuleRequest
    {index = Core.Nothing, sheetId = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "DeleteConditionalFormatRuleRequest"
              (\ o ->
                 DeleteConditionalFormatRuleRequest Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "sheetId"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "DeleteConditionalFormatRuleResponse"
              (\ o ->
                 DeleteConditionalFormatRuleResponse Core.<$>
                   (o Core..:? "rule"))
...
instance Core.FromJSON DeleteDataSourceRequest where
        parseJSON
          = Core.withObject "DeleteDataSourceRequest"
              (\ o ->
                 DeleteDataSourceRequest Core.<$>
                   (o Core..:? "dataSourceId"))
...
instance Core.FromJSON DeleteDeveloperMetadataRequest
         where
        parseJSON
          = Core.withObject "DeleteDeveloperMetadataRequest"
              (\ o ->
                 DeleteDeveloperMetadataRequest Core.<$>
                   (o Core..:? "dataFilter"))

instance Core.ToJSON DeleteDeveloperMetadataRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "DeleteDeveloperMetadataResponse"
              (\ o ->
                 DeleteDeveloperMetadataResponse Core.<$>
                   (o Core..:? "deletedDeveloperMetadata"))

instance Core.ToJSON DeleteDeveloperMetadataResponse
         where
        toJSON DeleteDeveloperMetadataResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deletedDeveloperMetadata" Core..=) Core.<$>
...
instance Core.FromJSON DeleteDimensionGroupRequest
         where
        parseJSON
          = Core.withObject "DeleteDimensionGroupRequest"
              (\ o ->
                 DeleteDimensionGroupRequest Core.<$>
                   (o Core..:? "range"))

instance Core.ToJSON DeleteDimensionGroupRequest
         where
...
instance Core.FromJSON DeleteDimensionGroupResponse
         where
        parseJSON
          = Core.withObject "DeleteDimensionGroupResponse"
              (\ o ->
                 DeleteDimensionGroupResponse Core.<$>
                   (o Core..:? "dimensionGroups"))

instance Core.ToJSON DeleteDimensionGroupResponse
         where
...
instance Core.FromJSON DeleteDimensionRequest where
        parseJSON
          = Core.withObject "DeleteDimensionRequest"
              (\ o ->
...
newDeleteDuplicatesRequest =
  DeleteDuplicatesRequest
    {comparisonColumns = Core.Nothing, range = Core.Nothing}

instance Core.FromJSON DeleteDuplicatesRequest where
        parseJSON
          = Core.withObject "DeleteDuplicatesRequest"
              (\ o ->
                 DeleteDuplicatesRequest Core.<$>
                   (o Core..:? "comparisonColumns") Core.<*>
                     (o Core..:? "range"))
...
instance Core.FromJSON DeleteDuplicatesResponse where
        parseJSON
          = Core.withObject "DeleteDuplicatesResponse"
              (\ o ->
                 DeleteDuplicatesResponse Core.<$>
                   (o Core..:? "duplicatesRemovedCount"))

instance Core.ToJSON DeleteDuplicatesResponse where
        toJSON DeleteDuplicatesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("duplicatesRemovedCount" Core..=) Core.<$>
...
instance Core.FromJSON DeleteEmbeddedObjectRequest
         where
        parseJSON
          = Core.withObject "DeleteEmbeddedObjectRequest"
              (\ o ->
                 DeleteEmbeddedObjectRequest Core.<$>
                   (o Core..:? "objectId"))

instance Core.ToJSON DeleteEmbeddedObjectRequest
         where
...
instance Core.FromJSON DeleteFilterViewRequest where
        parseJSON
          = Core.withObject "DeleteFilterViewRequest"
              (\ o ->
                 DeleteFilterViewRequest Core.<$>
                   (o Core..:? "filterId"))
...
instance Core.FromJSON DeleteProtectedRangeRequest
         where
        parseJSON
          = Core.withObject "DeleteProtectedRangeRequest"
              (\ o ->
                 DeleteProtectedRangeRequest Core.<$>
                   (o Core..:? "protectedRangeId"))

instance Core.ToJSON DeleteProtectedRangeRequest
         where
        toJSON DeleteProtectedRangeRequest{..}
          = Core.object
              (Core.catMaybes
                 [("protectedRangeId" Core..=) Core.<$>
                    protectedRangeId])
...
instance Core.FromJSON DeleteRangeRequest where
        parseJSON
          = Core.withObject "DeleteRangeRequest"
              (\ o ->
                 DeleteRangeRequest Core.<$>
                   (o Core..:? "range") Core.<*>
                     (o Core..:? "shiftDimension"))
...
instance Core.FromJSON DeleteSheetRequest where
        parseJSON
          = Core.withObject "DeleteSheetRequest"
              (\ o ->
...
instance Core.FromJSON DeveloperMetadata where
        parseJSON
          = Core.withObject "DeveloperMetadata"
              (\ o ->
...
instance Core.FromJSON DeveloperMetadataLocation
         where
        parseJSON
          = Core.withObject "DeveloperMetadataLocation"
              (\ o ->
                 DeveloperMetadataLocation Core.<$>
                   (o Core..:? "dimensionRange") Core.<*>
                     (o Core..:? "locationType")
                     Core.<*> (o Core..:? "sheetId")
...
instance Core.FromJSON DeveloperMetadataLookup where
        parseJSON
          = Core.withObject "DeveloperMetadataLookup"
              (\ o ->
                 DeveloperMetadataLookup Core.<$>
                   (o Core..:? "locationMatchingStrategy") Core.<*>
                     (o Core..:? "locationType")
...
instance Core.ToJSON DeveloperMetadataLookup where
        toJSON DeveloperMetadataLookup{..}
          = Core.object
              (Core.catMaybes
                 [("locationMatchingStrategy" Core..=) Core.<$>
...
newDimensionGroup =
  DimensionGroup
    {collapsed = Core.Nothing, depth = Core.Nothing, range = Core.Nothing}

instance Core.FromJSON DimensionGroup where
        parseJSON
          = Core.withObject "DimensionGroup"
              (\ o ->
                 DimensionGroup Core.<$>
                   (o Core..:? "collapsed") Core.<*>
                     (o Core..:? "depth")
                     Core.<*> (o Core..:? "range"))
...
instance Core.FromJSON DimensionProperties where
        parseJSON
          = Core.withObject "DimensionProperties"
              (\ o ->
                 DimensionProperties Core.<$>
                   (o Core..:? "dataSourceColumnReference") Core.<*>
                     (o Core..:? "developerMetadata")
...
instance Core.ToJSON DimensionProperties where
        toJSON DimensionProperties{..}
          = Core.object
              (Core.catMaybes
                 [("dataSourceColumnReference" Core..=) Core.<$>
                    dataSourceColumnReference,
                  ("developerMetadata" Core..=) Core.<$>
                    developerMetadata,
...
instance Core.FromJSON DimensionRange where
        parseJSON
          = Core.withObject "DimensionRange"
              (\ o ->
                 DimensionRange Core.<$>
                   (o Core..:? "dimension") Core.<*>
                     (o Core..:? "endIndex")
...
instance Core.FromJSON DuplicateFilterViewRequest
         where
        parseJSON
          = Core.withObject "DuplicateFilterViewRequest"
              (\ o ->
                 DuplicateFilterViewRequest Core.<$>
                   (o Core..:? "filterId"))
...
instance Core.FromJSON DuplicateFilterViewResponse
         where
        parseJSON
          = Core.withObject "DuplicateFilterViewResponse"
              (\ o ->
                 DuplicateFilterViewResponse Core.<$>
                   (o Core..:? "filter"))

instance Core.ToJSON DuplicateFilterViewResponse
         where
...
instance Core.FromJSON DuplicateSheetRequest where
        parseJSON
          = Core.withObject "DuplicateSheetRequest"
              (\ o ->
                 DuplicateSheetRequest Core.<$>
                   (o Core..:? "insertSheetIndex") Core.<*>
                     (o Core..:? "newSheetId")
...
instance Core.FromJSON DuplicateSheetResponse where
        parseJSON
          = Core.withObject "DuplicateSheetResponse"
              (\ o ->
                 DuplicateSheetResponse Core.<$>
                   (o Core..:? "properties"))
...
instance Core.FromJSON Editors where
        parseJSON
          = Core.withObject "Editors"
              (\ o ->
                 Editors Core.<$>
                   (o Core..:? "domainUsersCanEdit") Core.<*>
                     (o Core..:? "groups")
                     Core.<*> (o Core..:? "users"))
...
instance Core.FromJSON EmbeddedChart where
        parseJSON
          = Core.withObject "EmbeddedChart"
              (\ o ->
                 EmbeddedChart Core.<$>
                   (o Core..:? "border") Core.<*> (o Core..:? "chartId")
                     Core.<*> (o Core..:? "position")
                     Core.<*> (o Core..:? "spec"))
...
instance Core.FromJSON EmbeddedObjectPosition where
        parseJSON
          = Core.withObject "EmbeddedObjectPosition"
              (\ o ->
                 EmbeddedObjectPosition Core.<$>
                   (o Core..:? "newSheet") Core.<*>
                     (o Core..:? "overlayPosition")
                     Core.<*> (o Core..:? "sheetId"))
...
instance Core.FromJSON ErrorValue where
        parseJSON
          = Core.withObject "ErrorValue"
              (\ o ->
                 ErrorValue Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON FilterCriteria where
        parseJSON
          = Core.withObject "FilterCriteria"
              (\ o ->
                 FilterCriteria Core.<$>
                   (o Core..:? "condition") Core.<*>
                     (o Core..:? "hiddenValues")
          ...
          = Core.object
              (Core.catMaybes
                 [("condition" Core..=) Core.<$> condition,
                  ...
                  ("visibleBackgroundColor" Core..=) Core.<$>
                    visibleBackgroundColor,
                  ("visibleBackgroundColorStyle" Core..=) Core.<$>
                    visibleBackgroundColorStyle,
                  ("visibleForegroundColor" Core..=) Core.<$>
                    visibleForegroundColor,
                  ("visibleForegroundColorStyle" Core..=) Core.<$>
...
instance Core.FromJSON FilterSpec where
        parseJSON
          = Core.withObject "FilterSpec"
              (\ o ->
                 FilterSpec Core.<$>
                   (o Core..:? "columnIndex") Core.<*>
                     (o Core..:? "dataSourceColumnReference")
...
instance Core.FromJSON FilterView_Criteria where
        parseJSON
          = Core.withObject "FilterView_Criteria"
              (\ o ->
                 FilterView_Criteria Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON FindReplaceRequest where
        parseJSON
          = Core.withObject "FindReplaceRequest"
              (\ o ->
                 FindReplaceRequest Core.<$>
                   (o Core..:? "allSheets") Core.<*> (o Core..:? "find")
...
instance Core.FromJSON FindReplaceResponse where
        parseJSON
          = Core.withObject "FindReplaceResponse"
              (\ o ->
                 FindReplaceResponse Core.<$>
                   (o Core..:? "formulasChanged") Core.<*>
                     (o Core..:? "occurrencesChanged")
...
instance Core.ToJSON FindReplaceResponse where
        toJSON FindReplaceResponse{..}
          = Core.object
              (Core.catMaybes
                 [("formulasChanged" Core..=) Core.<$>
                    formulasChanged,
                  ("occurrencesChanged" Core..=) Core.<$>
                    occurrencesChanged,
...
newGetSpreadsheetByDataFilterRequest =
  GetSpreadsheetByDataFilterRequest
    {dataFilters = Core.Nothing, includeGridData = Core.Nothing}

instance Core.FromJSON
           GetSpreadsheetByDataFilterRequest
         where
        parseJSON
          = Core.withObject "GetSpreadsheetByDataFilterRequest"
              (\ o ->
                 GetSpreadsheetByDataFilterRequest Core.<$>
                   (o Core..:? "dataFilters") Core.<*>
                     (o Core..:? "includeGridData"))
...
newGradientRule =
  GradientRule
    {maxpoint = Core.Nothing, midpoint = Core.Nothing, minpoint = Core.Nothing}

instance Core.FromJSON GradientRule where
        parseJSON
          = Core.withObject "GradientRule"
              (\ o ->
                 GradientRule Core.<$>
                   (o Core..:? "maxpoint") Core.<*>
                     (o Core..:? "midpoint")
...
instance Core.FromJSON GridCoordinate where
        parseJSON
          = Core.withObject "GridCoordinate"
              (\ o ->
                 GridCoordinate Core.<$>
                   (o Core..:? "columnIndex") Core.<*>
                     (o Core..:? "rowIndex")
...
instance Core.FromJSON GridData where
        parseJSON
          = Core.withObject "GridData"
              (\ o ->
                 GridData Core.<$>
                   (o Core..:? "columnMetadata") Core.<*>
                     (o Core..:? "rowData")
...
instance Core.FromJSON GridProperties where
        parseJSON
          = Core.withObject "GridProperties"
              (\ o ->
                 GridProperties Core.<$>
                   (o Core..:? "columnCount") Core.<*>
                     (o Core..:? "columnGroupControlAfter")
...
instance Core.FromJSON GridRange where
        parseJSON
          = Core.withObject "GridRange"
              (\ o ->
                 GridRange Core.<$>
                   (o Core..:? "endColumnIndex") Core.<*>
                     (o Core..:? "endRowIndex")
                     Core.<*> (o Core..:? "sheetId")
...
instance Core.FromJSON HistogramChartSpec where
        parseJSON
          = Core.withObject "HistogramChartSpec"
              (\ o ->
                 HistogramChartSpec Core.<$>
                   (o Core..:? "bucketSize") Core.<*>
                     (o Core..:? "legendPosition")
          ...
          = Core.object
              (Core.catMaybes
                 [("bucketSize" Core..=) Core.<$> bucketSize,
                  ("legendPosition" Core..=) Core.<$> legendPosition,
                  ("outlierPercentile" Core..=) Core.<$>
                    outlierPercentile,
                  ("series" Core..=) Core.<$> series,
                  ("showItemDividers" Core..=) Core.<$>
                    showItemDividers])
...
instance Core.FromJSON HistogramRule where
        parseJSON
          = Core.withObject "HistogramRule"
              (\ o ->
                 HistogramRule Core.<$>
                   (o Core..:? "end") Core.<*> (o Core..:? "interval")
                     Core.<*> (o Core..:? "start"))
...
instance Core.FromJSON HistogramSeries where
        parseJSON
          = Core.withObject "HistogramSeries"
              (\ o ->
                 HistogramSeries Core.<$>
                   (o Core..:? "barColor") Core.<*>
                     (o Core..:? "barColorStyle")
                     Core.<*> (o Core..:? "data"))
...
newInsertDimensionRequest =
  InsertDimensionRequest
    {inheritFromBefore = Core.Nothing, range = Core.Nothing}

instance Core.FromJSON InsertDimensionRequest where
        parseJSON
          = Core.withObject "InsertDimensionRequest"
              (\ o ->
                 InsertDimensionRequest Core.<$>
                   (o Core..:? "inheritFromBefore") Core.<*>
                     (o Core..:? "range"))
...
instance Core.FromJSON InsertRangeRequest where
        parseJSON
          = Core.withObject "InsertRangeRequest"
              (\ o ->
                 InsertRangeRequest Core.<$>
                   (o Core..:? "range") Core.<*>
                     (o Core..:? "shiftDimension"))
...
instance Core.FromJSON InterpolationPoint where
        parseJSON
          = Core.withObject "InterpolationPoint"
              (\ o ->
                 InterpolationPoint Core.<$>
                   (o Core..:? "color") Core.<*>
                     (o Core..:? "colorStyle")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "value"))
...
newIterativeCalculationSettings =
  IterativeCalculationSettings
    {convergenceThreshold = Core.Nothing, maxIterations = Core.Nothing}

instance Core.FromJSON IterativeCalculationSettings
         where
        parseJSON
          = Core.withObject "IterativeCalculationSettings"
              (\ o ->
                 IterativeCalculationSettings Core.<$>
                   (o Core..:? "convergenceThreshold") Core.<*>
                     (o Core..:? "maxIterations"))

instance Core.ToJSON IterativeCalculationSettings
         where
        toJSON IterativeCalculationSettings{..}
          = Core.object
              (Core.catMaybes
                 [("convergenceThreshold" Core..=) Core.<$>
...
instance Core.FromJSON KeyValueFormat where
        parseJSON
          = Core.withObject "KeyValueFormat"
              (\ o ->
                 KeyValueFormat Core.<$>
                   (o Core..:? "position") Core.<*>
                     (o Core..:? "textFormat"))
...
instance Core.FromJSON ManualRuleGroup where
        parseJSON
          = Core.withObject "ManualRuleGroup"
              (\ o ->
                 ManualRuleGroup Core.<$>
                   (o Core..:? "groupName") Core.<*>
                     (o Core..:? "items"))
...
newMatchedDeveloperMetadata =
  MatchedDeveloperMetadata
    {dataFilters = Core.Nothing, developerMetadata = Core.Nothing}

instance Core.FromJSON MatchedDeveloperMetadata where
        parseJSON
          = Core.withObject "MatchedDeveloperMetadata"
              (\ o ->
...
instance Core.FromJSON MatchedValueRange where
        parseJSON
          = Core.withObject "MatchedValueRange"
              (\ o ->
                 MatchedValueRange Core.<$>
                   (o Core..:? "dataFilters") Core.<*>
                     (o Core..:? "valueRange"))
...
instance Core.FromJSON MergeCellsRequest where
        parseJSON
          = Core.withObject "MergeCellsRequest"
              (\ o ->
                 MergeCellsRequest Core.<$>
                   (o Core..:? "mergeType") Core.<*>
                     (o Core..:? "range"))
...
instance Core.FromJSON MoveDimensionRequest where
        parseJSON
          = Core.withObject "MoveDimensionRequest"
              (\ o ->
                 MoveDimensionRequest Core.<$>
                   (o Core..:? "destinationIndex") Core.<*>
                     (o Core..:? "source"))
...
instance Core.FromJSON NumberFormat where
        parseJSON
          = Core.withObject "NumberFormat"
              (\ o ->
                 NumberFormat Core.<$>
                   (o Core..:? "pattern") Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("labels" Core..=) Core.<$> labels,
                  ...
                  ("selectedNodeColor" Core..=) Core.<$>
                    selectedNodeColor,
                  ("selectedNodeColorStyle" Core..=) Core.<$>
...
instance Core.FromJSON OverlayPosition where
        parseJSON
          = Core.withObject "OverlayPosition"
              (\ o ->
                 OverlayPosition Core.<$>
                   (o Core..:? "anchorCell") Core.<*>
                     (o Core..:? "heightPixels")
...
instance Core.FromJSON PasteDataRequest where
        parseJSON
          = Core.withObject "PasteDataRequest"
              (\ o ->
                 PasteDataRequest Core.<$>
                   (o Core..:? "coordinate") Core.<*>
                     (o Core..:? "data")
...
instance Core.FromJSON PivotFilterCriteria where
        parseJSON
          = Core.withObject "PivotFilterCriteria"
              (\ o ->
                 PivotFilterCriteria Core.<$>
                   (o Core..:? "condition") Core.<*>
                     (o Core..:? "visibleByDefault")
...
instance Core.FromJSON PivotFilterSpec where
        parseJSON
          = Core.withObject "PivotFilterSpec"
              (\ o ->
                 PivotFilterSpec Core.<$>
                   (o Core..:? "columnOffsetIndex") Core.<*>
                     (o Core..:? "dataSourceColumnReference")
                     Core.<*> (o Core..:? "filterCriteria"))
...
instance Core.FromJSON PivotGroupLimit where
        parseJSON
          = Core.withObject "PivotGroupLimit"
              (\ o ->
                 PivotGroupLimit Core.<$>
                   (o Core..:? "applyOrder") Core.<*>
                     (o Core..:? "countLimit"))
...
instance Core.FromJSON PivotGroupRule where
        parseJSON
          = Core.withObject "PivotGroupRule"
              (\ o ->
                 PivotGroupRule Core.<$>
                   (o Core..:? "dateTimeRule") Core.<*>
                     (o Core..:? "histogramRule")
...
instance Core.FromJSON PivotGroupSortValueBucket
         where
        parseJSON
          = Core.withObject "PivotGroupSortValueBucket"
              (\ o ->
                 PivotGroupSortValueBucket Core.<$>
                   (o Core..:? "buckets") Core.<*>
                     (o Core..:? "valuesIndex"))
...
instance Core.FromJSON PivotGroupValueMetadata where
        parseJSON
          = Core.withObject "PivotGroupValueMetadata"
              (\ o ->
                 PivotGroupValueMetadata Core.<$>
                   (o Core..:? "collapsed") Core.<*>
                     (o Core..:? "value"))
...
instance Core.FromJSON PivotTable_Criteria where
        parseJSON
          = Core.withObject "PivotTable_Criteria"
              (\ o ->
                 PivotTable_Criteria Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON PivotValue where
        parseJSON
          = Core.withObject "PivotValue"
              (\ o ->
                 PivotValue Core.<$>
                   (o Core..:? "calculatedDisplayType") Core.<*>
                     (o Core..:? "dataSourceColumnReference")
                     Core.<*> (o Core..:? "formula")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "sourceColumnOffset")
...
instance Core.ToJSON PivotValue where
        toJSON PivotValue{..}
          = Core.object
              (Core.catMaybes
                 [("calculatedDisplayType" Core..=) Core.<$>
...
instance Core.FromJSON ProtectedRange where
        parseJSON
          = Core.withObject "ProtectedRange"
              (\ o ->
                 ProtectedRange Core.<$>
              ...
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ...
                  ("protectedRangeId" Core..=) Core.<$>
                    protectedRangeId,
                  ("range" Core..=) Core.<$> range,
                  ("requestingUserCanEdit" Core..=) Core.<$>
                    requestingUserCanEdit,
                  ("unprotectedRanges" Core..=) Core.<$>
                    unprotectedRanges,
...
instance Core.FromJSON RandomizeRangeRequest where
        parseJSON
          = Core.withObject "RandomizeRangeRequest"
              (\ o ->
...
newRefreshDataSourceObjectExecutionStatus =
  RefreshDataSourceObjectExecutionStatus
    {dataExecutionStatus = Core.Nothing, reference = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RefreshDataSourceObjectExecutionStatus"
              (\ o ->
                 RefreshDataSourceObjectExecutionStatus Core.<$>
                   (o Core..:? "dataExecutionStatus") Core.<*>
                     (o Core..:? "reference"))
...
instance Core.FromJSON RefreshDataSourceRequest where
        parseJSON
          = Core.withObject "RefreshDataSourceRequest"
              (\ o ->
                 RefreshDataSourceRequest Core.<$>
                   (o Core..:? "dataSourceId") Core.<*>
                     (o Core..:? "force")
                     Core.<*> (o Core..:? "isAll")
...
instance Core.FromJSON RefreshDataSourceResponse
         where
        parseJSON
          = Core.withObject "RefreshDataSourceResponse"
              (\ o ->
                 RefreshDataSourceResponse Core.<$>
                   (o Core..:? "statuses"))
...
newRepeatCellRequest =
  RepeatCellRequest
    {cell = Core.Nothing, fields = Core.Nothing, range = Core.Nothing}

instance Core.FromJSON RepeatCellRequest where
        parseJSON
          = Core.withObject "RepeatCellRequest"
              (\ o ->
                 RepeatCellRequest Core.<$>
                   (o Core..:? "cell") Core.<*> (o Core..:? "fields")
                     Core.<*> (o Core..:? "range"))
          ...
          = Core.object
              (Core.catMaybes
                 [("addBanding" Core..=) Core.<$> addBanding,
                  ...
                  ("autoResizeDimensions" Core..=) Core.<$>
                    autoResizeDimensions,
                  ("clearBasicFilter" Core..=) Core.<$>
                    clearBasicFilter,
                  ("copyPaste" Core..=) Core.<$> copyPaste,
                  ("createDeveloperMetadata" Core..=) Core.<$>
                    createDeveloperMetadata,
                  ("cutPaste" Core..=) Core.<$> cutPaste,
                  ("deleteBanding" Core..=) Core.<$> deleteBanding,
                  ("deleteConditionalFormatRule" Core..=) Core.<$>
                    deleteConditionalFormatRule,
                  ("deleteDataSource" Core..=) Core.<$>
                    deleteDataSource,
                  ("deleteDeveloperMetadata" Core..=) Core.<$>
                    deleteDeveloperMetadata,
                  ("deleteDimension" Core..=) Core.<$> deleteDimension,
                  ("deleteDimensionGroup" Core..=) Core.<$>
                    deleteDimensionGroup,
                  ("deleteDuplicates" Core..=) Core.<$>
                    deleteDuplicates,
                  ("deleteEmbeddedObject" Core..=) Core.<$>
                    deleteEmbeddedObject,
                  ("deleteFilterView" Core..=) Core.<$>
                    deleteFilterView,
                  ("deleteNamedRange" Core..=) Core.<$>
                    deleteNamedRange,
                  ("deleteProtectedRange" Core..=) Core.<$>
                    deleteProtectedRange,
                  ("deleteRange" Core..=) Core.<$> deleteRange,
                  ("deleteSheet" Core..=) Core.<$> deleteSheet,
                  ("duplicateFilterView" Core..=) Core.<$>
                    duplicateFilterView,
                  ...
                  ("updateConditionalFormatRule" Core..=) Core.<$>
                    updateConditionalFormatRule,
                  ("updateDataSource" Core..=) Core.<$>
                    updateDataSource,
                  ("updateDeveloperMetadata" Core..=) Core.<$>
                    updateDeveloperMetadata,
                  ("updateDimensionGroup" Core..=) Core.<$>
                    updateDimensionGroup,
                  ("updateDimensionProperties" Core..=) Core.<$>
                    updateDimensionProperties,
                  ("updateEmbeddedObjectBorder" Core..=) Core.<$>
                    updateEmbeddedObjectBorder,
                  ("updateEmbeddedObjectPosition" Core..=) Core.<$>
                    updateEmbeddedObjectPosition,
                  ("updateFilterView" Core..=) Core.<$>
                    updateFilterView,
                  ("updateNamedRange" Core..=) Core.<$>
                    updateNamedRange,
                  ("updateProtectedRange" Core..=) Core.<$>
                    updateProtectedRange,
                  ("updateSheetProperties" Core..=) Core.<$>
                    updateSheetProperties,
                  ("updateSlicerSpec" Core..=) Core.<$>
                    updateSlicerSpec,
                  ("updateSpreadsheetProperties" Core..=) Core.<$>
...
instance Core.FromJSON ScorecardChartSpec where
        parseJSON
          = Core.withObject "ScorecardChartSpec"
              (\ o ->
                 ScorecardChartSpec Core.<$>
                   (o Core..:? "aggregateType") Core.<*>
                     (o Core..:? "baselineValueData")
...
instance Core.ToJSON ScorecardChartSpec where
        toJSON ScorecardChartSpec{..}
          = Core.object
              (Core.catMaybes
                 [("aggregateType" Core..=) Core.<$> aggregateType,
                  ("baselineValueData" Core..=) Core.<$>
                    baselineValueData,
                  ("baselineValueFormat" Core..=) Core.<$>
                    baselineValueFormat,
                  ("customFormatOptions" Core..=) Core.<$>
                    customFormatOptions,
                  ("keyValueData" Core..=) Core.<$> keyValueData,
                  ("keyValueFormat" Core..=) Core.<$> keyValueFormat,
                  ("numberFormatSource" Core..=) Core.<$>
                    numberFormatSource,
...
instance Core.FromJSON SearchDeveloperMetadataRequest
         where
        parseJSON
          = Core.withObject "SearchDeveloperMetadataRequest"
              (\ o ->
                 SearchDeveloperMetadataRequest Core.<$>
                   (o Core..:? "dataFilters"))

instance Core.ToJSON SearchDeveloperMetadataRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "SearchDeveloperMetadataResponse"
              (\ o ->
                 SearchDeveloperMetadataResponse Core.<$>
                   (o Core..:? "matchedDeveloperMetadata"))

instance Core.ToJSON SearchDeveloperMetadataResponse
         where
        toJSON SearchDeveloperMetadataResponse{..}
          = Core.object
              (Core.catMaybes
                 [("matchedDeveloperMetadata" Core..=) Core.<$>
                    matchedDeveloperMetadata])
...
instance Core.FromJSON SetBasicFilterRequest where
        parseJSON
          = Core.withObject "SetBasicFilterRequest"
              (\ o ->
...
instance Core.FromJSON SetDataValidationRequest where
        parseJSON
          = Core.withObject "SetDataValidationRequest"
              (\ o ->
                 SetDataValidationRequest Core.<$>
                   (o Core..:? "range") Core.<*> (o Core..:? "rule"))
...
instance Core.FromJSON Sheet where
        parseJSON
          = Core.withObject "Sheet"
              (\ o ->
                 Sheet Core.<$>
                   (o Core..:? "bandedRanges") Core.<*>
                     (o Core..:? "basicFilter")
                     Core.<*> (o Core..:? "charts")
...
instance Core.FromJSON SheetProperties where
        parseJSON
          = Core.withObject "SheetProperties"
              (\ o ->
                 SheetProperties Core.<$>
                   (o Core..:? "dataSourceSheetProperties") Core.<*>
                     (o Core..:? "gridProperties")
                     Core.<*> (o Core..:? "hidden")
                     Core.<*> (o Core..:? "index")
...
instance Core.ToJSON SheetProperties where
        toJSON SheetProperties{..}
          = Core.object
              (Core.catMaybes
                 [("dataSourceSheetProperties" Core..=) Core.<$>
                    dataSourceSheetProperties,
...
instance Core.FromJSON SlicerSpec where
        parseJSON
          = Core.withObject "SlicerSpec"
              (\ o ->
                 SlicerSpec Core.<$>
                   (o Core..:? "applyToPivotTables") Core.<*>
                     (o Core..:? "backgroundColor")
                     Core.<*> (o Core..:? "backgroundColorStyle")
...
instance Core.FromJSON SortRangeRequest where
        parseJSON
          = Core.withObject "SortRangeRequest"
              (\ o ->
                 SortRangeRequest Core.<$>
                   (o Core..:? "range") Core.<*>
                     (o Core..:? "sortSpecs"))
          ...
          = Core.object
              (Core.catMaybes
                 [("backgroundColor" Core..=) Core.<$>
                  ...
                  ("foregroundColorStyle" Core..=) Core.<$>
...
newSourceAndDestination =
  SourceAndDestination
    {dimension = Core.Nothing, fillLength = Core.Nothing, source = Core.Nothing}

instance Core.FromJSON SourceAndDestination where
        parseJSON
          = Core.withObject "SourceAndDestination"
              (\ o ->
...
instance Core.FromJSON Spreadsheet where
        parseJSON
          = Core.withObject "Spreadsheet"
              (\ o ->
                 Spreadsheet Core.<$>
                   (o Core..:? "dataSourceSchedules") Core.<*>
                     (o Core..:? "dataSources")
                     Core.<*> (o Core..:? "developerMetadata")
...
instance Core.FromJSON SpreadsheetProperties where
        parseJSON
          = Core.withObject "SpreadsheetProperties"
              (\ o ->
                 SpreadsheetProperties Core.<$>
                   (o Core..:? "autoRecalc") Core.<*>
                     (o Core..:? "defaultFormat")
          ...
          = Core.object
              (Core.catMaybes
                 [("autoRecalc" Core..=) Core.<$> autoRecalc,
                  ...
                  ("iterativeCalculationSettings" Core..=) Core.<$>
                    iterativeCalculationSettings,
                  ("locale" Core..=) Core.<$> locale,
                  ("spreadsheetTheme" Core..=) Core.<$>
                    spreadsheetTheme,
...
newSpreadsheetTheme =
  SpreadsheetTheme
    {primaryFontFamily = Core.Nothing, themeColors = Core.Nothing}

instance Core.FromJSON SpreadsheetTheme where
        parseJSON
          = Core.withObject "SpreadsheetTheme"
              (\ o ->
                 SpreadsheetTheme Core.<$>
                   (o Core..:? "primaryFontFamily") Core.<*>
                     (o Core..:? "themeColors"))
...
instance Core.FromJSON TextPosition where
        parseJSON
          = Core.withObject "TextPosition"
              (\ o ->
                 TextPosition Core.<$>
                   (o Core..:? "horizontalAlignment"))
...
instance Core.FromJSON TextToColumnsRequest where
        parseJSON
          = Core.withObject "TextToColumnsRequest"
              (\ o ->
                 TextToColumnsRequest Core.<$>
                   (o Core..:? "delimiter") Core.<*>
                     (o Core..:? "delimiterType")
                     Core.<*> (o Core..:? "source"))
...
instance Core.FromJSON ThemeColorPair where
        parseJSON
          = Core.withObject "ThemeColorPair"
              (\ o ->
                 ThemeColorPair Core.<$>
                   (o Core..:? "color") Core.<*>
                     (o Core..:? "colorType"))
...
instance Core.FromJSON TreemapChartColorScale where
        parseJSON
          = Core.withObject "TreemapChartColorScale"
              (\ o ->
                 TreemapChartColorScale Core.<$>
                   (o Core..:? "maxValueColor") Core.<*>
                     (o Core..:? "maxValueColorStyle")
          ...
          = Core.object
              (Core.catMaybes
                 [("maxValueColor" Core..=) Core.<$> maxValueColor,
                  ("maxValueColorStyle" Core..=) Core.<$>
                    maxValueColorStyle,
                  ("midValueColor" Core..=) Core.<$> midValueColor,
                  ("midValueColorStyle" Core..=) Core.<$>
                    midValueColorStyle,
                  ("minValueColor" Core..=) Core.<$> minValueColor,
                  ("minValueColorStyle" Core..=) Core.<$>
                    minValueColorStyle,
                  ("noDataColor" Core..=) Core.<$> noDataColor,
                  ("noDataColorStyle" Core..=) Core.<$>
                    noDataColorStyle])
...
instance Core.FromJSON TreemapChartSpec where
        parseJSON
          = Core.withObject "TreemapChartSpec"
              (\ o ->
                 TreemapChartSpec Core.<$>
                   (o Core..:? "colorData") Core.<*>
                     (o Core..:? "colorScale")
                     Core.<*> (o Core..:? "headerColor")
                     Core.<*> (o Core..:? "headerColorStyle")
...
instance Core.FromJSON TrimWhitespaceRequest where
        parseJSON
          = Core.withObject "TrimWhitespaceRequest"
              (\ o ->
...
instance Core.FromJSON TrimWhitespaceResponse where
        parseJSON
          = Core.withObject "TrimWhitespaceResponse"
              (\ o ->
                 TrimWhitespaceResponse Core.<$>
                   (o Core..:? "cellsChangedCount"))

instance Core.ToJSON TrimWhitespaceResponse where
        toJSON TrimWhitespaceResponse{..}
          = Core.object
              (Core.catMaybes
                 [("cellsChangedCount" Core..=) Core.<$>
                    cellsChangedCount])
...
instance Core.FromJSON UnmergeCellsRequest where
        parseJSON
          = Core.withObject "UnmergeCellsRequest"
              (\ o ->
...
instance Core.FromJSON UpdateBandingRequest where
        parseJSON
          = Core.withObject "UpdateBandingRequest"
              (\ o ->
                 UpdateBandingRequest Core.<$>
                   (o Core..:? "bandedRange") Core.<*>
                     (o Core..:? "fields"))
...
instance Core.FromJSON UpdateBordersRequest where
        parseJSON
          = Core.withObject "UpdateBordersRequest"
              (\ o ->
                 UpdateBordersRequest Core.<$>
                   (o Core..:? "bottom") Core.<*>
                     (o Core..:? "innerHorizontal")
...
instance Core.FromJSON UpdateCellsRequest where
        parseJSON
          = Core.withObject "UpdateCellsRequest"
              (\ o ->
                 UpdateCellsRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "range")
                     Core.<*> (o Core..:? "rows")
                     Core.<*> (o Core..:? "start"))
...
instance Core.FromJSON UpdateChartSpecRequest where
        parseJSON
          = Core.withObject "UpdateChartSpecRequest"
              (\ o ->
                 UpdateChartSpecRequest Core.<$>
                   (o Core..:? "chartId") Core.<*> (o Core..:? "spec"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "UpdateConditionalFormatRuleRequest"
              (\ o ->
                 UpdateConditionalFormatRuleRequest Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "newIndex")
                     Core.<*> (o Core..:? "rule")
                     Core.<*> (o Core..:? "sheetId"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "UpdateConditionalFormatRuleResponse"
              (\ o ->
                 UpdateConditionalFormatRuleResponse Core.<$>
                   (o Core..:? "newIndex") Core.<*>
                     (o Core..:? "newRule")
...
instance Core.FromJSON UpdateDataSourceRequest where
        parseJSON
          = Core.withObject "UpdateDataSourceRequest"
              (\ o ->
                 UpdateDataSourceRequest Core.<$>
...
instance Core.FromJSON UpdateDataSourceResponse where
        parseJSON
          = Core.withObject "UpdateDataSourceResponse"
              (\ o ->
...
instance Core.FromJSON UpdateDeveloperMetadataRequest
         where
        parseJSON
          = Core.withObject "UpdateDeveloperMetadataRequest"
              (\ o ->
                 UpdateDeveloperMetadataRequest Core.<$>
                   (o Core..:? "dataFilters") Core.<*>
                     (o Core..:? "developerMetadata")
                     Core.<*> (o Core..:? "fields"))

instance Core.ToJSON UpdateDeveloperMetadataRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "UpdateDeveloperMetadataResponse"
              (\ o ->
                 UpdateDeveloperMetadataResponse Core.<$>
                   (o Core..:? "developerMetadata"))

instance Core.ToJSON UpdateDeveloperMetadataResponse
         where
...
newUpdateDimensionGroupRequest =
  UpdateDimensionGroupRequest
    {dimensionGroup = Core.Nothing, fields = Core.Nothing}

instance Core.FromJSON UpdateDimensionGroupRequest
         where
        parseJSON
          = Core.withObject "UpdateDimensionGroupRequest"
              (\ o ->
                 UpdateDimensionGroupRequest Core.<$>
                   (o Core..:? "dimensionGroup") Core.<*>
                     (o Core..:? "fields"))

instance Core.ToJSON UpdateDimensionGroupRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "UpdateDimensionPropertiesRequest"
              (\ o ->
                 UpdateDimensionPropertiesRequest Core.<$>
                   (o Core..:? "dataSourceSheetRange") Core.<*>
                     (o Core..:? "fields")
                     Core.<*> (o Core..:? "properties")
                     Core.<*> (o Core..:? "range"))

instance Core.ToJSON UpdateDimensionPropertiesRequest
         where
        toJSON UpdateDimensionPropertiesRequest{..}
          = Core.object
              (Core.catMaybes
                 [("dataSourceSheetRange" Core..=) Core.<$>
...
newUpdateEmbeddedObjectBorderRequest =
  UpdateEmbeddedObjectBorderRequest
    {border = Core.Nothing, fields = Core.Nothing, objectId = Core.Nothing}

instance Core.FromJSON
           UpdateEmbeddedObjectBorderRequest
         where
        parseJSON
          = Core.withObject "UpdateEmbeddedObjectBorderRequest"
              (\ o ->
                 UpdateEmbeddedObjectBorderRequest Core.<$>
                   (o Core..:? "border") Core.<*> (o Core..:? "fields")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "UpdateEmbeddedObjectPositionRequest"
              (\ o ->
                 UpdateEmbeddedObjectPositionRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "newPosition")
                     Core.<*> (o Core..:? "objectId"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "UpdateEmbeddedObjectPositionResponse"
              (\ o ->
                 UpdateEmbeddedObjectPositionResponse Core.<$>
                   (o Core..:? "position"))
...
instance Core.FromJSON UpdateFilterViewRequest where
        parseJSON
          = Core.withObject "UpdateFilterViewRequest"
              (\ o ->
                 UpdateFilterViewRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "filter"))
...
instance Core.FromJSON UpdateNamedRangeRequest where
        parseJSON
          = Core.withObject "UpdateNamedRangeRequest"
              (\ o ->
                 UpdateNamedRangeRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "namedRange"))
...
newUpdateProtectedRangeRequest =
  UpdateProtectedRangeRequest
    {fields = Core.Nothing, protectedRange = Core.Nothing}

instance Core.FromJSON UpdateProtectedRangeRequest
         where
        parseJSON
          = Core.withObject "UpdateProtectedRangeRequest"
              (\ o ->
                 UpdateProtectedRangeRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "protectedRange"))

instance Core.ToJSON UpdateProtectedRangeRequest
         where
...
newUpdateSheetPropertiesRequest =
  UpdateSheetPropertiesRequest
    {fields = Core.Nothing, properties = Core.Nothing}

instance Core.FromJSON UpdateSheetPropertiesRequest
         where
        parseJSON
          = Core.withObject "UpdateSheetPropertiesRequest"
              (\ o ->
                 UpdateSheetPropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "properties"))

instance Core.ToJSON UpdateSheetPropertiesRequest
         where
...
newUpdateSlicerSpecRequest =
  UpdateSlicerSpecRequest
    {fields = Core.Nothing, slicerId = Core.Nothing, spec = Core.Nothing}

instance Core.FromJSON UpdateSlicerSpecRequest where
        parseJSON
          = Core.withObject "UpdateSlicerSpecRequest"
              (\ o ->
                 UpdateSlicerSpecRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "slicerId")
                     Core.<*> (o Core..:? "spec"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "UpdateSpreadsheetPropertiesRequest"
              (\ o ->
                 UpdateSpreadsheetPropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "properties"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "UpdateValuesByDataFilterResponse"
              (\ o ->
                 UpdateValuesByDataFilterResponse Core.<$>
                   (o Core..:? "dataFilter") Core.<*>
                     (o Core..:? "updatedCells")
...
instance Core.ToJSON UpdateValuesByDataFilterResponse
         where
...
instance Core.FromJSON UpdateValuesResponse where
        parseJSON
          = Core.withObject "UpdateValuesResponse"
              (\ o ->
                 UpdateValuesResponse Core.<$>
                   (o Core..:? "spreadsheetId") Core.<*>
                     (o Core..:? "updatedCells")
                     Core.<*> (o Core..:? "updatedColumns")
                     Core.<*> (o Core..:? "updatedData")
...
newValueRange =
  ValueRange
    {majorDimension = Core.Nothing, range = Core.Nothing, values = Core.Nothing}

instance Core.FromJSON ValueRange where
        parseJSON
          = Core.withObject "ValueRange"
              (\ o ->
                 ValueRange Core.<$>
                   (o Core..:? "majorDimension") Core.<*>
                     (o Core..:? "range")
                     Core.<*> (o Core..:? "values"))
...
newWaterfallChartColumnStyle =
  WaterfallChartColumnStyle
    {color = Core.Nothing, colorStyle = Core.Nothing, label = Core.Nothing}

instance Core.FromJSON WaterfallChartColumnStyle
         where
        parseJSON
          = Core.withObject "WaterfallChartColumnStyle"
              (\ o ->
                 WaterfallChartColumnStyle Core.<$>
                   (o Core..:? "color") Core.<*>
                     (o Core..:? "colorStyle")
                     Core.<*> (o Core..:? "label"))
...
instance Core.FromJSON WaterfallChartCustomSubtotal
         where
        parseJSON
          = Core.withObject "WaterfallChartCustomSubtotal"
              (\ o ->
                 WaterfallChartCustomSubtotal Core.<$>
                   (o Core..:? "dataIsSubtotal") Core.<*>
                     (o Core..:? "label")
                     Core.<*> (o Core..:? "subtotalIndex"))

instance Core.ToJSON WaterfallChartCustomSubtotal
         where
...
instance Core.FromJSON WaterfallChartDomain where
        parseJSON
          = Core.withObject "WaterfallChartDomain"
              (\ o ->
                 WaterfallChartDomain Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "reversed"))
...
instance Core.FromJSON WaterfallChartSeries where
        parseJSON
          = Core.withObject "WaterfallChartSeries"
              (\ o ->
                 WaterfallChartSeries Core.<$>
                   (o Core..:? "customSubtotals") Core.<*>
                     (o Core..:? "data")
                     Core.<*> (o Core..:? "dataLabel")
...
instance Core.ToJSON WaterfallChartSeries where
        toJSON WaterfallChartSeries{..}
          = Core.object
              (Core.catMaybes
                 [("customSubtotals" Core..=) Core.<$>
                    customSubtotals,
                  ("data" Core..=) Core.<$> data',
                  ("dataLabel" Core..=) Core.<$> dataLabel,
                  ("hideTrailingSubtotal" Core..=) Core.<$>
                    hideTrailingSubtotal,
                  ("negativeColumnsStyle" Core..=) Core.<$>
                    negativeColumnsStyle,
                  ("positiveColumnsStyle" Core..=) Core.<$>
                    positiveColumnsStyle,
                  ("subtotalColumnsStyle" Core..=) Core.<$>
...
instance Core.FromJSON WaterfallChartSpec where
        parseJSON
          = Core.withObject "WaterfallChartSpec"
              (\ o ->
                 WaterfallChartSpec Core.<$>
                   (o Core..:? "connectorLineStyle") Core.<*>
                     (o Core..:? "domain")
...
instance Core.ToJSON WaterfallChartSpec where
        toJSON WaterfallChartSpec{..}
          = Core.object
              (Core.catMaybes
                 [("connectorLineStyle" Core..=) Core.<$>
                    connectorLineStyle,
                  ("domain" Core..=) Core.<$> domain,
                  ("firstValueIsTotal" Core..=) Core.<$>
                    firstValueIsTotal,
                  ("hideConnectorLines" Core..=) Core.<$>
                    hideConnectorLines,
                  ("series" Core..=) Core.<$> series,
                  ("stackedType" Core..=) Core.<$> stackedType,
                  ("totalDataLabel" Core..=) Core.<$> totalDataLabel])
