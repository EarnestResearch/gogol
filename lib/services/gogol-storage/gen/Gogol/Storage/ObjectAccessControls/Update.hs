                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "userProject" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ObjectAccessControl
...
instance Core.GoogleRequest
           StorageObjectAccessControlsUpdate
         where
        type Rs StorageObjectAccessControlsUpdate =
             ObjectAccessControl
        type Scopes StorageObjectAccessControlsUpdate =
             '[CloudPlatform'FullControl, Devstorage'FullControl]
        requestClient StorageObjectAccessControlsUpdate{..}
          = go bucket object entity generation uploadType
              userProject
