...
instance Core.FromJSON Bucket where
        parseJSON
          = Core.withObject "Bucket"
              (\ o ->
                 Bucket Core.<$>
                   (o Core..:? "acl") Core.<*> (o Core..:? "autoclass")
                     Core.<*> (o Core..:? "billing")
                     Core.<*> (o Core..:? "cors")
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "storage#bucket")
                     Core.<*> (o Core..:? "labels")
          ...
          = Core.object
              (Core.catMaybes
                 [("acl" Core..=) Core.<$> acl,
                  ...
                  ("cors" Core..=) Core.<$> cors,
                  ("customPlacementConfig" Core..=) Core.<$>
                    customPlacementConfig,
                  ("defaultEventBasedHold" Core..=) Core.<$>
                    defaultEventBasedHold,
                  ("defaultObjectAcl" Core..=) Core.<$>
                    defaultObjectAcl,
                  ("encryption" Core..=) Core.<$> encryption,
                  ("etag" Core..=) Core.<$> etag,
                  ("iamConfiguration" Core..=) Core.<$>
                    iamConfiguration,
                  ("id" Core..=) Core.<$> id,
...
instance Core.FromJSON Bucket_CustomPlacementConfig
         where
        parseJSON
          = Core.withObject "Bucket_CustomPlacementConfig"
              (\ o ->
                 Bucket_CustomPlacementConfig Core.<$>
                   (o Core..:? "dataLocations"))

instance Core.ToJSON Bucket_CustomPlacementConfig
         where
...
instance Core.FromJSON Bucket_Encryption where
        parseJSON
          = Core.withObject "Bucket_Encryption"
              (\ o ->
                 Bucket_Encryption Core.<$>
                   (o Core..:? "defaultKmsKeyName"))

instance Core.ToJSON Bucket_Encryption where
        toJSON Bucket_Encryption{..}
          = Core.object
              (Core.catMaybes
                 [("defaultKmsKeyName" Core..=) Core.<$>
                    defaultKmsKeyName])
...
instance Core.ToJSON Bucket_IamConfiguration where
        toJSON Bucket_IamConfiguration{..}
          = Core.object
              (Core.catMaybes
                 [("bucketPolicyOnly" Core..=) Core.<$>
                    bucketPolicyOnly,
                  ("publicAccessPrevention" Core..=) Core.<$>
...
newBucket_IamConfiguration_BucketPolicyOnly =
  Bucket_IamConfiguration_BucketPolicyOnly
    {enabled = Core.Nothing, lockedTime = Core.Nothing}
...
instance Core.FromJSON Bucket_Lifecycle_RuleItem
         where
        parseJSON
...
newBucket_Lifecycle_RuleItem_Action =
  Bucket_Lifecycle_RuleItem_Action
    {storageClass = Core.Nothing, type' = Core.Nothing}
          ...
          = Core.withObject "Bucket_Lifecycle_RuleItem_Action"
              (\ o ->
                 Bucket_Lifecycle_RuleItem_Action Core.<$>
                   (o Core..:? "storageClass") Core.<*>
                     (o Core..:? "type"))

instance Core.ToJSON Bucket_Lifecycle_RuleItem_Action
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("age" Core..=) Core.<$> age,
                  ...
                  ("customTimeBefore" Core..=) Core.<$>
                    customTimeBefore,
                  ("daysSinceCustomTime" Core..=) Core.<$>
                    daysSinceCustomTime,
                  ...
                  ("matchesStorageClass" Core..=) Core.<$>
                    matchesStorageClass,
                  ("matchesSuffix" Core..=) Core.<$> matchesSuffix,
                  ("noncurrentTimeBefore" Core..=) Core.<$>
                    noncurrentTimeBefore,
                  ("numNewerVersions" Core..=) Core.<$>
                    numNewerVersions])
...
instance Core.FromJSON Bucket_Logging where
        parseJSON
          = Core.withObject "Bucket_Logging"
              (\ o ->
                 Bucket_Logging Core.<$>
                   (o Core..:? "logBucket") Core.<*>
                     (o Core..:? "logObjectPrefix"))
          ...
          = Core.withObject "BucketAccessControl"
              (\ o ->
                 BucketAccessControl Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "domain")
                     Core.<*> (o Core..:? "email")
                     Core.<*> (o Core..:? "entity")
...
newBucketAccessControl_ProjectTeam =
  BucketAccessControl_ProjectTeam
    {projectNumber = Core.Nothing, team = Core.Nothing}
...
instance Core.ToJSON BucketAccessControl_ProjectTeam
         where
...
newBucketAccessControls =
  BucketAccessControls
    {items = Core.Nothing, kind = "storage#bucketAccessControls"}
...
instance Core.ToJSON ComposeRequest_SourceObjectsItem
         where
...
newHmacKey =
  HmacKey
    {kind = "storage#hmacKey", metadata = Core.Nothing, secret = Core.Nothing}
...
instance Core.FromJSON HmacKey where
        parseJSON
          = Core.withObject "HmacKey"
              (\ o ->
                 HmacKey Core.<$>
                   (o Core..:? "kind" Core..!= "storage#hmacKey")
          ...
          = Core.withObject "HmacKeyMetadata"
              (\ o ->
                 HmacKeyMetadata Core.<$>
                   (o Core..:? "accessId") Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON Notification where
        parseJSON
          = Core.withObject "Notification"
              (\ o ->
                 Notification Core.<$>
                   (o Core..:? "custom_attributes") Core.<*>
                     (o Core..:? "etag")
                     Core.<*> (o Core..:? "event_types")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "storage#notification")
                     Core.<*> (o Core..:? "object_name_prefix")
                     Core.<*>
                     (o Core..:? "payload_format" Core..!= "JSON_API_V1")
                     Core.<*> (o Core..:? "selfLink")
                     Core.<*> (o Core..:? "topic"))
...
instance Core.ToJSON Notification where
        toJSON Notification{..}
          = Core.object
              (Core.catMaybes
                 [("custom_attributes" Core..=) Core.<$>
                    customAttributes,
                  ("etag" Core..=) Core.<$> etag,
                  ("event_types" Core..=) Core.<$> eventTypes,
                  ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
                  ("object_name_prefix" Core..=) Core.<$>
                    objectNamePrefix,
...
instance Core.FromJSON Notification_Custom_attributes
         where
        parseJSON
          = Core.withObject "Notification_Custom_attributes"
              (\ o ->
                 Notification_Custom_attributes Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Notification_Custom_attributes
         where
              ...
              (\ o ->
                 Object Core.<$>
                   (o Core..:? "acl") Core.<*> (o Core..:? "bucket")
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "storage#object")
...
newObject_CustomerEncryption =
  Object_CustomerEncryption
    {encryptionAlgorithm = Core.Nothing, keySha256 = Core.Nothing}

instance Core.FromJSON Object_CustomerEncryption
         where
        parseJSON
...
instance Core.ToJSON ObjectAccessControl_ProjectTeam
         where
...
newObjectAccessControls =
  ObjectAccessControls
    {items = Core.Nothing, kind = "storage#objectAccessControls"}
        ...
        toJSON RewriteResponse{..}
          = Core.object
              (Core.catMaybes
                 [("done" Core..=) Core.<$> done,
                  Core.Just ("kind" Core..= kind),
                  ("objectSize" Core..=) Core.. Core.AsText Core.<$>
                    objectSize,
...
newTestIamPermissionsResponse =
  TestIamPermissionsResponse
    {kind = "storage#testIamPermissionsResponse", permissions = Core.Nothing}
