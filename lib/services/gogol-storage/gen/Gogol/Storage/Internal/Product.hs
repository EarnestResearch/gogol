...
newAdvanceRelocateBucketOperationRequest 
    :: 
                                         AdvanceRelocateBucketOperationRequest
newAdvanceRelocateBucketOperationRequest
  = AdvanceRelocateBucketOperationRequest{expireTime = Core.Nothing,
                                          ttl = Core.Nothing}
instance Core.FromJSON AdvanceRelocateBucketOperationRequest where
        parseJSON
          = Core.withObject "AdvanceRelocateBucketOperationRequest"
              (\ o ->
                 AdvanceRelocateBucketOperationRequest Core.<$>
                   (o Core..:? "expireTime") Core.<*> (o Core..:? "ttl"))
...
newAnywhereCache 
    ::  AnywhereCache
newAnywhereCache
  = AnywhereCache{admissionPolicy = Core.Nothing,
                  anywhereCacheId = Core.Nothing, bucket = Core.Nothing,
                  createTime = Core.Nothing, id = Core.Nothing,
                  kind = "storage#anywhereCache", pendingUpdate = Core.Nothing,
                  selfLink = Core.Nothing, state = Core.Nothing, ttl = Core.Nothing,
                  updateTime = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON AnywhereCache where
        parseJSON
          = Core.withObject "AnywhereCache"
              (\ o ->
                 AnywhereCache Core.<$>
                   (o Core..:? "admissionPolicy") Core.<*>
                     (o Core..:? "anywhereCacheId")
                     Core.<*> (o Core..:? "bucket")
...
newAnywhereCaches 
    ::  AnywhereCaches
newAnywhereCaches
  = AnywhereCaches{items = Core.Nothing,
                   kind = "storage#anywhereCaches", nextPageToken = Core.Nothing}
instance Core.FromJSON AnywhereCaches where
        parseJSON
          = Core.withObject "AnywhereCaches"
              (\ o ->
                 AnywhereCaches Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#anywhereCaches")
...
newBucket 
    ::  Bucket
newBucket
  = Bucket{acl = Core.Nothing, autoclass = Core.Nothing,
           billing = Core.Nothing, cors = Core.Nothing,
           customPlacementConfig = Core.Nothing,
           defaultEventBasedHold = Core.Nothing,
           defaultObjectAcl = Core.Nothing, encryption = Core.Nothing,
           etag = Core.Nothing, generation = Core.Nothing,
           hardDeleteTime = Core.Nothing,
           hierarchicalNamespace = Core.Nothing,
           iamConfiguration = Core.Nothing, id = Core.Nothing,
           ipFilter = Core.Nothing, kind = "storage#bucket",
           labels = Core.Nothing, lifecycle = Core.Nothing,
           location = Core.Nothing, locationType = Core.Nothing,
           logging = Core.Nothing, metageneration = Core.Nothing,
           name = Core.Nothing, objectRetention = Core.Nothing,
           owner = Core.Nothing, projectNumber = Core.Nothing,
           retentionPolicy = Core.Nothing, rpo = Core.Nothing,
           satisfiesPZI = Core.Nothing, satisfiesPZS = Core.Nothing,
           selfLink = Core.Nothing, softDeletePolicy = Core.Nothing,
           softDeleteTime = Core.Nothing, storageClass = Core.Nothing,
           timeCreated = Core.Nothing, updated = Core.Nothing,
           versioning = Core.Nothing, website = Core.Nothing}
instance Core.FromJSON Bucket where
        parseJSON
          = Core.withObject "Bucket"
              (\ o ->
                 Bucket Core.<$>
                   (o Core..:? "acl") Core.<*> (o Core..:? "autoclass") Core.<*>
                     (o Core..:? "billing")
                     Core.<*> (o Core..:? "cors")
                     ...
                     Core.<*> (o Core..:? "logging")
                     Core.<*>
                     (o Core..:? "metageneration" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("acl" Core..=) Core.<$> acl,
                  ...
                  ("id" Core..=) Core.<$> id, ("ipFilter" Core..=) Core.<$> ipFilter,
                  ...
                  ("metageneration" Core..=) Core.. Core.AsText Core.<$>
                    metageneration,
                  ("name" Core..=) Core.<$> name,
...
newBucket_Autoclass 
    ::  Bucket_Autoclass
newBucket_Autoclass
  = Bucket_Autoclass{enabled = Core.Nothing,
...
instance Core.FromJSON Bucket_Autoclass where
        parseJSON
          = Core.withObject "Bucket_Autoclass"
              (\ o ->
                 Bucket_Autoclass Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "terminalStorageClass")
          ...
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ...
                  ("terminalStorageClassUpdateTime" Core..=) Core.<$>
...
instance Core.FromJSON Bucket_Billing where
        parseJSON
          = Core.withObject "Bucket_Billing"
...
newBucket_CorsItem 
    ::  Bucket_CorsItem
newBucket_CorsItem
  = Bucket_CorsItem{maxAgeSeconds = Core.Nothing,
                    method = Core.Nothing, origin = Core.Nothing,
                    responseHeader = Core.Nothing}
instance Core.FromJSON Bucket_CorsItem where
        parseJSON
          = Core.withObject "Bucket_CorsItem"
              (\ o ->
                 Bucket_CorsItem Core.<$>
                   (o Core..:? "maxAgeSeconds") Core.<*> (o Core..:? "method")
                     Core.<*> (o Core..:? "origin")
...
instance Core.FromJSON Bucket_CustomPlacementConfig where
        parseJSON
          = Core.withObject "Bucket_CustomPlacementConfig"
              (\ o ->
...
instance Core.FromJSON Bucket_Encryption where
        parseJSON
          = Core.withObject "Bucket_Encryption"
              (\ o ->
...
instance Core.FromJSON Bucket_HierarchicalNamespace where
        parseJSON
          = Core.withObject "Bucket_HierarchicalNamespace"
              (\ o ->
...
newBucket_IamConfiguration 
    ::  Bucket_IamConfiguration
newBucket_IamConfiguration
  = Bucket_IamConfiguration{bucketPolicyOnly = Core.Nothing,
...
instance Core.FromJSON Bucket_IamConfiguration where
        parseJSON
          = Core.withObject "Bucket_IamConfiguration"
              (\ o ->
                 Bucket_IamConfiguration Core.<$>
                   (o Core..:? "bucketPolicyOnly") Core.<*>
                     (o Core..:? "publicAccessPrevention")
          ...
          = Core.object
              (Core.catMaybes
                 [("bucketPolicyOnly" Core..=) Core.<$> bucketPolicyOnly,
                  ...
                  ("uniformBucketLevelAccess" Core..=) Core.<$>
...
newBucket_IamConfiguration_BucketPolicyOnly 
    :: 
                                            Bucket_IamConfiguration_BucketPolicyOnly
newBucket_IamConfiguration_BucketPolicyOnly
  = Bucket_IamConfiguration_BucketPolicyOnly{enabled = Core.Nothing,
                                             lockedTime = Core.Nothing}
instance Core.FromJSON Bucket_IamConfiguration_BucketPolicyOnly
         where
        parseJSON
          = Core.withObject "Bucket_IamConfiguration_BucketPolicyOnly"
              (\ o ->
                 Bucket_IamConfiguration_BucketPolicyOnly Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "lockedTime"))
...
newBucket_IamConfiguration_UniformBucketLevelAccess 
    :: 
                                                    Bucket_IamConfiguration_UniformBucketLevelAccess
newBucket_IamConfiguration_UniformBucketLevelAccess
  = Bucket_IamConfiguration_UniformBucketLevelAccess{enabled =
                                                       Core.Nothing,
                                                     lockedTime = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "Bucket_IamConfiguration_UniformBucketLevelAccess"
              (\ o ->
                 Bucket_IamConfiguration_UniformBucketLevelAccess Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "lockedTime"))
...
data Bucket_IpFilter = Bucket_IpFilter
    {
      ...
      allowAllServiceAgentAccess :: (Core.Maybe Core.Bool)
      -- | Whether to allow cross-org VPCs in the bucket\'s IP filter configuration.
    , allowCrossOrgVpcs :: (Core.Maybe Core.Bool)
...
newBucket_IpFilter 
    ::  Bucket_IpFilter
newBucket_IpFilter
  = Bucket_IpFilter{allowAllServiceAgentAccess = Core.Nothing,
                    allowCrossOrgVpcs = Core.Nothing, mode = Core.Nothing,
                    publicNetworkSource = Core.Nothing,
                    vpcNetworkSources = Core.Nothing}
instance Core.FromJSON Bucket_IpFilter where
        parseJSON
          = Core.withObject "Bucket_IpFilter"
              (\ o ->
                 Bucket_IpFilter Core.<$>
                   (o Core..:? "allowAllServiceAgentAccess") Core.<*>
                     (o Core..:? "allowCrossOrgVpcs")
                     Core.<*> (o Core..:? "mode")
...
instance Core.ToJSON Bucket_IpFilter where
        toJSON Bucket_IpFilter{..}
          = Core.object
              (Core.catMaybes
                 [("allowAllServiceAgentAccess" Core..=) Core.<$>
                    allowAllServiceAgentAccess,
                  ("allowCrossOrgVpcs" Core..=) Core.<$> allowCrossOrgVpcs,
                  ("mode" Core..=) Core.<$> mode,
...
newBucket_IpFilter_PublicNetworkSource 
    :: 
                                       Bucket_IpFilter_PublicNetworkSource
newBucket_IpFilter_PublicNetworkSource
  = Bucket_IpFilter_PublicNetworkSource{allowedIpCidrRanges =
                                          Core.Nothing}
instance Core.FromJSON Bucket_IpFilter_PublicNetworkSource where
        parseJSON
          = Core.withObject "Bucket_IpFilter_PublicNetworkSource"
              (\ o ->
                 Bucket_IpFilter_PublicNetworkSource Core.<$>
                   (o Core..:? "allowedIpCidrRanges"))
...
newBucket_IpFilter_VpcNetworkSourcesItem 
    :: 
                                         Bucket_IpFilter_VpcNetworkSourcesItem
newBucket_IpFilter_VpcNetworkSourcesItem
  = Bucket_IpFilter_VpcNetworkSourcesItem{allowedIpCidrRanges =
                                            Core.Nothing,
                                          network = Core.Nothing}
instance Core.FromJSON Bucket_IpFilter_VpcNetworkSourcesItem where
        parseJSON
          = Core.withObject "Bucket_IpFilter_VpcNetworkSourcesItem"
              (\ o ->
                 Bucket_IpFilter_VpcNetworkSourcesItem Core.<$>
                   (o Core..:? "allowedIpCidrRanges") Core.<*> (o Core..:? "network"))
...
instance Core.FromJSON Bucket_Lifecycle where
        parseJSON
          = Core.withObject "Bucket_Lifecycle"
...
newBucket_Lifecycle_RuleItem 
    ::  Bucket_Lifecycle_RuleItem
newBucket_Lifecycle_RuleItem
  = Bucket_Lifecycle_RuleItem{action = Core.Nothing,
                              condition = Core.Nothing}
instance Core.FromJSON Bucket_Lifecycle_RuleItem where
        parseJSON
          = Core.withObject "Bucket_Lifecycle_RuleItem"
              (\ o ->
                 Bucket_Lifecycle_RuleItem Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "condition"))
...
newBucket_Lifecycle_RuleItem_Action 
    :: 
                                    Bucket_Lifecycle_RuleItem_Action
newBucket_Lifecycle_RuleItem_Action
  = Bucket_Lifecycle_RuleItem_Action{storageClass = Core.Nothing,
                                     type' = Core.Nothing}
instance Core.FromJSON Bucket_Lifecycle_RuleItem_Action where
        parseJSON
          = Core.withObject "Bucket_Lifecycle_RuleItem_Action"
              (\ o ->
                 Bucket_Lifecycle_RuleItem_Action Core.<$>
                   (o Core..:? "storageClass") Core.<*> (o Core..:? "type"))
...
newBucket_Lifecycle_RuleItem_Condition 
    :: 
                                       Bucket_Lifecycle_RuleItem_Condition
newBucket_Lifecycle_RuleItem_Condition
  = Bucket_Lifecycle_RuleItem_Condition{age = Core.Nothing,
                                        ...
                                        isLive = Core.Nothing, matchesPattern = Core.Nothing,
...
instance Core.FromJSON Bucket_Lifecycle_RuleItem_Condition where
        parseJSON
          = Core.withObject "Bucket_Lifecycle_RuleItem_Condition"
              (\ o ->
                 Bucket_Lifecycle_RuleItem_Condition Core.<$>
                   (o Core..:? "age") Core.<*> (o Core..:? "createdBefore") Core.<*>
                     (o Core..:? "customTimeBefore")
          ...
          = Core.object
              (Core.catMaybes
                 [("age" Core..=) Core.<$> age,
                  ...
                  ("daysSinceNoncurrentTime" Core..=) Core.<$>
...
newBucket_Logging 
    ::  Bucket_Logging
newBucket_Logging
  = Bucket_Logging{logBucket = Core.Nothing,
                   logObjectPrefix = Core.Nothing}
instance Core.FromJSON Bucket_Logging where
        parseJSON
          = Core.withObject "Bucket_Logging"
              (\ o ->
                 Bucket_Logging Core.<$>
                   (o Core..:? "logBucket") Core.<*> (o Core..:? "logObjectPrefix"))
...
instance Core.FromJSON Bucket_ObjectRetention where
        parseJSON
          = Core.withObject "Bucket_ObjectRetention"
...
instance Core.FromJSON Bucket_Owner where
        parseJSON
          = Core.withObject "Bucket_Owner"
              (\ o ->
                 Bucket_Owner Core.<$>
                   (o Core..:? "entity") Core.<*> (o Core..:? "entityId"))
...
newBucket_RetentionPolicy 
    ::  Bucket_RetentionPolicy
newBucket_RetentionPolicy
  = Bucket_RetentionPolicy{effectiveTime = Core.Nothing,
                           isLocked = Core.Nothing, retentionPeriod = Core.Nothing}
instance Core.FromJSON Bucket_RetentionPolicy where
        parseJSON
          = Core.withObject "Bucket_RetentionPolicy"
              (\ o ->
                 Bucket_RetentionPolicy Core.<$>
                   (o Core..:? "effectiveTime") Core.<*> (o Core..:? "isLocked")
                     Core.<*>
                     (o Core..:? "retentionPeriod" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("effectiveTime" Core..=) Core.<$> effectiveTime,
                  ...
                  ("retentionPeriod" Core..=) Core.. Core.AsText Core.<$>
                    retentionPeriod])
...
newBucket_SoftDeletePolicy 
    ::  Bucket_SoftDeletePolicy
newBucket_SoftDeletePolicy
  = Bucket_SoftDeletePolicy{effectiveTime = Core.Nothing,
                            retentionDurationSeconds = Core.Nothing}
instance Core.FromJSON Bucket_SoftDeletePolicy where
        parseJSON
          = Core.withObject "Bucket_SoftDeletePolicy"
              (\ o ->
                 Bucket_SoftDeletePolicy Core.<$>
                   (o Core..:? "effectiveTime") Core.<*>
                     (o Core..:? "retentionDurationSeconds" Core.<&>
...
instance Core.ToJSON Bucket_SoftDeletePolicy where
        toJSON Bucket_SoftDeletePolicy{..}
          = Core.object
              (Core.catMaybes
                 [("effectiveTime" Core..=) Core.<$> effectiveTime,
                  ("retentionDurationSeconds" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON Bucket_Versioning where
        parseJSON
          = Core.withObject "Bucket_Versioning"
...
newBucket_Website 
    ::  Bucket_Website
newBucket_Website
  = Bucket_Website{mainPageSuffix = Core.Nothing,
                   notFoundPage = Core.Nothing}
instance Core.FromJSON Bucket_Website where
        parseJSON
          = Core.withObject "Bucket_Website"
              (\ o ->
                 Bucket_Website Core.<$>
                   (o Core..:? "mainPageSuffix") Core.<*> (o Core..:? "notFoundPage"))
...
newBucketAccessControl 
    ::  BucketAccessControl
newBucketAccessControl
  = BucketAccessControl{bucket = Core.Nothing, domain = Core.Nothing,
                        email = Core.Nothing, entity = Core.Nothing,
                        entityId = Core.Nothing, etag = Core.Nothing, id = Core.Nothing,
                        kind = "storage#bucketAccessControl", projectTeam = Core.Nothing,
                        role' = Core.Nothing, selfLink = Core.Nothing}
instance Core.FromJSON BucketAccessControl where
        parseJSON
          = Core.withObject "BucketAccessControl"
              (\ o ->
                 BucketAccessControl Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "domain") Core.<*>
                     (o Core..:? "email")
                     Core.<*> (o Core..:? "entity")
...
newBucketAccessControl_ProjectTeam 
    :: 
                                   BucketAccessControl_ProjectTeam
newBucketAccessControl_ProjectTeam
  = BucketAccessControl_ProjectTeam{projectNumber = Core.Nothing,
                                    team = Core.Nothing}
instance Core.FromJSON BucketAccessControl_ProjectTeam where
        parseJSON
          = Core.withObject "BucketAccessControl_ProjectTeam"
              (\ o ->
                 BucketAccessControl_ProjectTeam Core.<$>
                   (o Core..:? "projectNumber") Core.<*> (o Core..:? "team"))
...
newBucketAccessControls 
    ::  BucketAccessControls
newBucketAccessControls
  = BucketAccessControls{items = Core.Nothing,
                         kind = "storage#bucketAccessControls"}
instance Core.FromJSON BucketAccessControls where
        parseJSON
          = Core.withObject "BucketAccessControls"
              (\ o ->
                 BucketAccessControls Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#bucketAccessControls"))
...
newBucketStorageLayout 
    ::  BucketStorageLayout
newBucketStorageLayout
  = BucketStorageLayout{bucket = Core.Nothing,
                        customPlacementConfig = Core.Nothing,
                        hierarchicalNamespace = Core.Nothing,
                        kind = "storage#storageLayout", location = Core.Nothing,
                        locationType = Core.Nothing}
instance Core.FromJSON BucketStorageLayout where
        parseJSON
          = Core.withObject "BucketStorageLayout"
              (\ o ->
                 BucketStorageLayout Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "customPlacementConfig")
                     Core.<*> (o Core..:? "hierarchicalNamespace")
...
newBucketStorageLayout_CustomPlacementConfig 
    :: 
                                             BucketStorageLayout_CustomPlacementConfig
newBucketStorageLayout_CustomPlacementConfig
  = BucketStorageLayout_CustomPlacementConfig{dataLocations =
                                                Core.Nothing}
instance Core.FromJSON BucketStorageLayout_CustomPlacementConfig
         where
        parseJSON
          = Core.withObject "BucketStorageLayout_CustomPlacementConfig"
              (\ o ->
                 BucketStorageLayout_CustomPlacementConfig Core.<$>
                   (o Core..:? "dataLocations"))

instance Core.ToJSON BucketStorageLayout_CustomPlacementConfig
         where
...
instance Core.FromJSON BucketStorageLayout_HierarchicalNamespace
         where
        parseJSON
          = Core.withObject "BucketStorageLayout_HierarchicalNamespace"
              (\ o ->
                 BucketStorageLayout_HierarchicalNamespace Core.<$>
                   (o Core..:? "enabled"))

instance Core.ToJSON BucketStorageLayout_HierarchicalNamespace
         where
...
newBuckets 
    ::  Buckets
newBuckets
  = Buckets{items = Core.Nothing, kind = "storage#buckets",
            nextPageToken = Core.Nothing}
instance Core.FromJSON Buckets where
        parseJSON
          = Core.withObject "Buckets"
              (\ o ->
                 Buckets Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#buckets")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newBulkRestoreObjectsRequest 
    ::  BulkRestoreObjectsRequest
newBulkRestoreObjectsRequest
  = BulkRestoreObjectsRequest{allowOverwrite = Core.Nothing,
                              copySourceAcl = Core.Nothing, matchGlobs = Core.Nothing,
...
instance Core.FromJSON BulkRestoreObjectsRequest where
        parseJSON
          = Core.withObject "BulkRestoreObjectsRequest"
              (\ o ->
                 BulkRestoreObjectsRequest Core.<$>
                   (o Core..:? "allowOverwrite") Core.<*> (o Core..:? "copySourceAcl")
...
newComposeRequest 
    ::  ComposeRequest
newComposeRequest
  = ComposeRequest{destination = Core.Nothing,
                   kind = "storage#composeRequest", sourceObjects = Core.Nothing}
instance Core.FromJSON ComposeRequest where
        parseJSON
          = Core.withObject "ComposeRequest"
              (\ o ->
                 ComposeRequest Core.<$>
                   (o Core..:? "destination") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#composeRequest")
...
newComposeRequest_SourceObjectsItem 
    :: 
                                    ComposeRequest_SourceObjectsItem
newComposeRequest_SourceObjectsItem
  = ComposeRequest_SourceObjectsItem{generation = Core.Nothing,
                                     name = Core.Nothing, objectPreconditions = Core.Nothing}
instance Core.FromJSON ComposeRequest_SourceObjectsItem where
        parseJSON
          = Core.withObject "ComposeRequest_SourceObjectsItem"
              (\ o ->
                 ComposeRequest_SourceObjectsItem Core.<$>
                   (o Core..:? "generation" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
...
newComposeRequest_SourceObjectsItem_ObjectPreconditions 
    :: 
                                                        ComposeRequest_SourceObjectsItem_ObjectPreconditions
newComposeRequest_SourceObjectsItem_ObjectPreconditions
  = ComposeRequest_SourceObjectsItem_ObjectPreconditions{ifGenerationMatch
                                                           = Core.Nothing}
instance Core.FromJSON
           ComposeRequest_SourceObjectsItem_ObjectPreconditions
         where
        parseJSON
          = Core.withObject
              "ComposeRequest_SourceObjectsItem_ObjectPreconditions"
              (\ o ->
                 ComposeRequest_SourceObjectsItem_ObjectPreconditions Core.<$>
                   (o Core..:? "ifGenerationMatch" Core.<&>
                      Core.fmap Core.fromAsText))
...
instance Core.ToJSON
        ...
        toJSON ComposeRequest_SourceObjectsItem_ObjectPreconditions{..}
          = Core.object
              (Core.catMaybes
                 [("ifGenerationMatch" Core..=) Core.. Core.AsText Core.<$>
                    ifGenerationMatch])
...
newFolder 
    ::  Folder
newFolder
  = Folder{bucket = Core.Nothing, createTime = Core.Nothing,
           id = Core.Nothing, kind = "storage#folder",
           metageneration = Core.Nothing, name = Core.Nothing,
           pendingRenameInfo = Core.Nothing, selfLink = Core.Nothing,
...
instance Core.FromJSON Folder where
        parseJSON
          = Core.withObject "Folder"
              (\ o ->
                 Folder Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "createTime") Core.<*>
                     (o Core..:? "id")
...
instance Core.FromJSON Folder_PendingRenameInfo where
        parseJSON
          = Core.withObject "Folder_PendingRenameInfo"
              (\ o ->
...
newFolders 
    ::  Folders
newFolders
  = Folders{items = Core.Nothing, kind = "storage#folders",
            nextPageToken = Core.Nothing}
instance Core.FromJSON Folders where
        parseJSON
          = Core.withObject "Folders"
              (\ o ->
                 Folders Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#folders")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newGoogleLongrunningListOperationsResponse 
    :: 
                                           GoogleLongrunningListOperationsResponse
newGoogleLongrunningListOperationsResponse
  = GoogleLongrunningListOperationsResponse{kind =
                                              "storage#operations",
          ...
          = Core.withObject "GoogleLongrunningListOperationsResponse"
              (\ o ->
                 GoogleLongrunningListOperationsResponse Core.<$>
                   (o Core..:? "kind" Core..!= "storage#operations") Core.<*>
...
newGoogleLongrunningOperation
  = GoogleLongrunningOperation{done = Core.Nothing,
                               error = Core.Nothing, kind = "storage#operation",
                               metadata = Core.Nothing, name = Core.Nothing,
                               response = Core.Nothing, selfLink = Core.Nothing}
              ...
              (\ o ->
                 GoogleLongrunningOperation Core.<$>
                   (o Core..:? "done") Core.<*> (o Core..:? "error") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#operation")
...
newHmacKey 
    ::  HmacKey
newHmacKey
  = HmacKey{kind = "storage#hmacKey", metadata = Core.Nothing,
            secret = Core.Nothing}
instance Core.FromJSON HmacKey where
        parseJSON
          = Core.withObject "HmacKey"
              (\ o ->
                 HmacKey Core.<$>
                   (o Core..:? "kind" Core..!= "storage#hmacKey") Core.<*>
                     (o Core..:? "metadata")
                     Core.<*> (o Core..:? "secret"))
...
newHmacKeyMetadata 
    ::  HmacKeyMetadata
newHmacKeyMetadata
  = HmacKeyMetadata{accessId = Core.Nothing, etag = Core.Nothing,
                    id = Core.Nothing, kind = "storage#hmacKeyMetadata",
                    projectId = Core.Nothing, selfLink = Core.Nothing,
                    serviceAccountEmail = Core.Nothing, state = Core.Nothing,
                    timeCreated = Core.Nothing, updated = Core.Nothing}
instance Core.FromJSON HmacKeyMetadata where
        parseJSON
          = Core.withObject "HmacKeyMetadata"
              (\ o ->
                 HmacKeyMetadata Core.<$>
                   (o Core..:? "accessId") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "id")
...
newHmacKeysMetadata 
    ::  HmacKeysMetadata
newHmacKeysMetadata
  = HmacKeysMetadata{items = Core.Nothing,
                     kind = "storage#hmacKeysMetadata", nextPageToken = Core.Nothing}
instance Core.FromJSON HmacKeysMetadata where
        parseJSON
          = Core.withObject "HmacKeysMetadata"
              (\ o ->
                 HmacKeysMetadata Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#hmacKeysMetadata")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newManagedFolder 
    ::  ManagedFolder
newManagedFolder
  = ManagedFolder{bucket = Core.Nothing, createTime = Core.Nothing,
                  id = Core.Nothing, kind = "storage#managedFolder",
                  metageneration = Core.Nothing, name = Core.Nothing,
                  selfLink = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON ManagedFolder where
        parseJSON
          = Core.withObject "ManagedFolder"
              (\ o ->
                 ManagedFolder Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "createTime") Core.<*>
                     (o Core..:? "id")
...
newManagedFolders 
    ::  ManagedFolders
newManagedFolders
  = ManagedFolders{items = Core.Nothing,
                   kind = "storage#managedFolders", nextPageToken = Core.Nothing}
instance Core.FromJSON ManagedFolders where
        parseJSON
          = Core.withObject "ManagedFolders"
              (\ o ->
                 ManagedFolders Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#managedFolders")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newNotification 
    ::  Notification
newNotification
  = Notification{customAttributes = Core.Nothing,
                 etag = Core.Nothing, eventTypes = Core.Nothing, id = Core.Nothing,
                 kind = "storage#notification", objectNamePrefix = Core.Nothing,
                 payloadFormat = "JSON_API_V1", selfLink = Core.Nothing,
                 topic = Core.Nothing}
instance Core.FromJSON Notification where
        parseJSON
          = Core.withObject "Notification"
              (\ o ->
                 Notification Core.<$>
                   (o Core..:? "custom_attributes") Core.<*> (o Core..:? "etag")
...
instance Core.FromJSON Notification_Custom_attributes where
        parseJSON
          = Core.withObject "Notification_Custom_attributes"
              (\ o ->
...
newNotifications 
    ::  Notifications
newNotifications
  = Notifications{items = Core.Nothing,
                  kind = "storage#notifications"}
instance Core.FromJSON Notifications where
        parseJSON
          = Core.withObject "Notifications"
              (\ o ->
                 Notifications Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#notifications"))
...
newObject 
    ::  Object
newObject
  = Object{acl = Core.Nothing, bucket = Core.Nothing,
           cacheControl = Core.Nothing, componentCount = Core.Nothing,
           contentDisposition = Core.Nothing, contentEncoding = Core.Nothing,
           contentLanguage = Core.Nothing, contentType = Core.Nothing,
           crc32c = Core.Nothing, customTime = Core.Nothing,
           customerEncryption = Core.Nothing, etag = Core.Nothing,
           eventBasedHold = Core.Nothing, generation = Core.Nothing,
           hardDeleteTime = Core.Nothing, id = Core.Nothing,
           kind = "storage#object", kmsKeyName = Core.Nothing,
           md5Hash = Core.Nothing, mediaLink = Core.Nothing,
           metadata = Core.Nothing, metageneration = Core.Nothing,
           name = Core.Nothing, owner = Core.Nothing,
           restoreToken = Core.Nothing, retention = Core.Nothing,
           retentionExpirationTime = Core.Nothing, selfLink = Core.Nothing,
           size = Core.Nothing, softDeleteTime = Core.Nothing,
           storageClass = Core.Nothing, temporaryHold = Core.Nothing,
           timeCreated = Core.Nothing, timeDeleted = Core.Nothing,
           timeFinalized = Core.Nothing,
           timeStorageClassUpdated = Core.Nothing, updated = Core.Nothing}
instance Core.FromJSON Object where
        parseJSON
          = Core.withObject "Object"
              (\ o ->
                 Object Core.<$>
                   (o Core..:? "acl") Core.<*> (o Core..:? "bucket") Core.<*>
                     (o Core..:? "cacheControl")
...
instance Core.ToJSON Object where
        toJSON Object{..}
          = Core.object
              (Core.catMaybes
                 [("acl" Core..=) Core.<$> acl, ("bucket" Core..=) Core.<$> bucket,
                  ...
                  ("retentionExpirationTime" Core..=) Core.<$>
                  ...
                  ("timeStorageClassUpdated" Core..=) Core.<$>
...
newObject_CustomerEncryption 
    ::  Object_CustomerEncryption
newObject_CustomerEncryption
  = Object_CustomerEncryption{encryptionAlgorithm = Core.Nothing,
                              keySha256 = Core.Nothing}
instance Core.FromJSON Object_CustomerEncryption where
        parseJSON
          = Core.withObject "Object_CustomerEncryption"
              (\ o ->
                 Object_CustomerEncryption Core.<$>
                   (o Core..:? "encryptionAlgorithm") Core.<*>
                     (o Core..:? "keySha256"))
...
instance Core.FromJSON Object_Metadata where
        parseJSON
          = Core.withObject "Object_Metadata"
...
newObject_Retention 
    ::  Object_Retention
newObject_Retention
  = Object_Retention{mode = Core.Nothing,
                     retainUntilTime = Core.Nothing}
instance Core.FromJSON Object_Retention where
        parseJSON
          = Core.withObject "Object_Retention"
              (\ o ->
                 Object_Retention Core.<$>
                   (o Core..:? "mode") Core.<*> (o Core..:? "retainUntilTime"))
...
newObjectAccessControl 
    ::  ObjectAccessControl
newObjectAccessControl
  = ObjectAccessControl{bucket = Core.Nothing, domain = Core.Nothing,
                        email = Core.Nothing, entity = Core.Nothing,
                        entityId = Core.Nothing, etag = Core.Nothing,
                        generation = Core.Nothing, id = Core.Nothing,
                        kind = "storage#objectAccessControl", object = Core.Nothing,
                        projectTeam = Core.Nothing, role' = Core.Nothing,
                        selfLink = Core.Nothing}
instance Core.FromJSON ObjectAccessControl where
        parseJSON
          = Core.withObject "ObjectAccessControl"
              (\ o ->
                 ObjectAccessControl Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "domain") Core.<*>
                     (o Core..:? "email")
                     Core.<*> (o Core..:? "entity")
                     Core.<*> (o Core..:? "entityId")
...
newObjectAccessControl_ProjectTeam 
    :: 
                                   ObjectAccessControl_ProjectTeam
newObjectAccessControl_ProjectTeam
  = ObjectAccessControl_ProjectTeam{projectNumber = Core.Nothing,
                                    team = Core.Nothing}
instance Core.FromJSON ObjectAccessControl_ProjectTeam where
        parseJSON
          = Core.withObject "ObjectAccessControl_ProjectTeam"
              (\ o ->
                 ObjectAccessControl_ProjectTeam Core.<$>
                   (o Core..:? "projectNumber") Core.<*> (o Core..:? "team"))
...
newObjectAccessControls 
    ::  ObjectAccessControls
newObjectAccessControls
  = ObjectAccessControls{items = Core.Nothing,
                         kind = "storage#objectAccessControls"}
instance Core.FromJSON ObjectAccessControls where
        parseJSON
          = Core.withObject "ObjectAccessControls"
              (\ o ->
                 ObjectAccessControls Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#objectAccessControls"))
...
newObjects 
    ::  Objects
newObjects
  = Objects{items = Core.Nothing, kind = "storage#objects",
            nextPageToken = Core.Nothing, prefixes = Core.Nothing}
instance Core.FromJSON Objects where
        parseJSON
          = Core.withObject "Objects"
              (\ o ->
                 Objects Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#objects")
                     Core.<*> (o Core..:? "nextPageToken")
...
newPolicy
  = Policy{bindings = Core.Nothing, etag = Core.Nothing,
           kind = "storage#policy", resourceId = Core.Nothing,
              ...
              (\ o ->
                 Policy Core.<$>
                   (o Core..:? "bindings") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#policy")
                     Core.<*> (o Core..:? "resourceId")
                     Core.<*> (o Core..:? "version"))
...
newPolicy_BindingsItem 
    ::  Policy_BindingsItem
newPolicy_BindingsItem
  = Policy_BindingsItem{condition = Core.Nothing,
                        members = Core.Nothing, role' = Core.Nothing}
instance Core.FromJSON Policy_BindingsItem where
        parseJSON
          = Core.withObject "Policy_BindingsItem"
              (\ o ->
                 Policy_BindingsItem Core.<$>
...
newRelocateBucketRequest
  = RelocateBucketRequest{destinationCustomPlacementConfig =
                            Core.Nothing,
                          destinationLocation = Core.Nothing, validateOnly = Core.Nothing}
instance Core.FromJSON RelocateBucketRequest where
        parseJSON
          = Core.withObject "RelocateBucketRequest"
              (\ o ->
                 RelocateBucketRequest Core.<$>
                   (o Core..:? "destinationCustomPlacementConfig") Core.<*>
                     (o Core..:? "destinationLocation")
...
instance Core.ToJSON RelocateBucketRequest where
        toJSON RelocateBucketRequest{..}
          = Core.object
              (Core.catMaybes
                 [("destinationCustomPlacementConfig" Core..=) Core.<$>
...
newRelocateBucketRequest_DestinationCustomPlacementConfig 
    :: 
                                                          RelocateBucketRequest_DestinationCustomPlacementConfig
newRelocateBucketRequest_DestinationCustomPlacementConfig
  = RelocateBucketRequest_DestinationCustomPlacementConfig{dataLocations
                                                             = Core.Nothing}
instance Core.FromJSON
           RelocateBucketRequest_DestinationCustomPlacementConfig
         where
        parseJSON
          = Core.withObject
              "RelocateBucketRequest_DestinationCustomPlacementConfig"
              (\ o ->
                 RelocateBucketRequest_DestinationCustomPlacementConfig Core.<$>
                   (o Core..:? "dataLocations"))
...
newRewriteResponse 
    ::  RewriteResponse
newRewriteResponse
  = RewriteResponse{done = Core.Nothing,
                    kind = "storage#rewriteResponse", objectSize = Core.Nothing,
                    resource = Core.Nothing, rewriteToken = Core.Nothing,
                    totalBytesRewritten = Core.Nothing}
instance Core.FromJSON RewriteResponse where
        parseJSON
          = Core.withObject "RewriteResponse"
              (\ o ->
                 RewriteResponse Core.<$>
                   (o Core..:? "done") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#rewriteResponse")
                     Core.<*>
                     (o Core..:? "objectSize" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "resource")
                     Core.<*> (o Core..:? "rewriteToken")
                     Core.<*>
                     (o Core..:? "totalBytesRewritten" Core.<&>
                        Core.fmap Core.fromAsText))
...
newServiceAccount 
    ::  ServiceAccount
newServiceAccount
  = ServiceAccount{emailAddress = Core.Nothing,
...
instance Core.FromJSON ServiceAccount where
        parseJSON
          = Core.withObject "ServiceAccount"
              (\ o ->
                 ServiceAccount Core.<$>
                   (o Core..:? "email_address") Core.<*>
                     (o Core..:? "kind" Core..!= "storage#serviceAccount"))
...
newTestIamPermissionsResponse 
    ::  TestIamPermissionsResponse
newTestIamPermissionsResponse
  = TestIamPermissionsResponse{kind =
          ...
          = Core.withObject "TestIamPermissionsResponse"
              (\ o ->
                 TestIamPermissionsResponse Core.<$>
                   (o Core..:? "kind" Core..!= "storage#testIamPermissionsResponse")
