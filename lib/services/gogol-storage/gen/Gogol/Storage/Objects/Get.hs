                     ...
                     Core.QueryParam "ifGenerationNotMatch" Core.Int64
                       ...
                       Core.QueryParam "ifMetagenerationMatch" Core.Int64
                         ...
                         Core.QueryParam "ifMetagenerationNotMatch" Core.Int64
                           Core.:>
                           Core.QueryParam "projection" ObjectsGetProjection
                             Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "userProject" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] Object
       Core.:<|>
       "storage" Core.:>
         "v1" Core.:>
           "b" Core.:>
...
instance Core.GoogleRequest
         ...
         where
        type Rs (Core.MediaDownload StorageObjectsGet) =
             Core.Stream
        type Scopes (Core.MediaDownload StorageObjectsGet) =
