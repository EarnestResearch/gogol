             ...
             "o" Core.:>
               Core.QueryParam "delimiter" Core.Text Core.:>
                 Core.QueryParam "endOffset" Core.Text Core.:>
                   Core.QueryParam "includeFoldersAsPrefixes" Core.Bool Core.:>
                     Core.QueryParam "includeTrailingDelimiter" Core.Bool Core.:>
                       Core.QueryParam "matchGlob" Core.Text Core.:>
                         Core.QueryParam "maxResults" Core.Word32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "prefix" Core.Text Core.:>
                               Core.QueryParam "projection" ObjectsListProjection Core.:>
                                 Core.QueryParam "softDeleted" Core.Bool Core.:>
                                   Core.QueryParam "startOffset" Core.Text Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "userProject" Core.Text Core.:>
                                         Core.QueryParam "versions" Core.Bool Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] Objects
...
newStorageObjectsList bucket
  = StorageObjectsList{bucket = bucket, delimiter = Core.Nothing,
                       endOffset = Core.Nothing, includeFoldersAsPrefixes = Core.Nothing,
                       includeTrailingDelimiter = Core.Nothing, matchGlob = Core.Nothing,
                       maxResults = 1000, pageToken = Core.Nothing, prefix = Core.Nothing,
                       projection = Core.Nothing, softDeleted = Core.Nothing,
                       startOffset = Core.Nothing, uploadType = Core.Nothing,
                       userProject = Core.Nothing, versions = Core.Nothing}
instance Core.GoogleRequest StorageObjectsList where
        type Rs StorageObjectsList = Objects
        type Scopes StorageObjectsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Devstorage'FullControl, Devstorage'ReadOnly, Devstorage'ReadWrite]
        requestClient StorageObjectsList{..}
          = go bucket delimiter endOffset includeFoldersAsPrefixes
