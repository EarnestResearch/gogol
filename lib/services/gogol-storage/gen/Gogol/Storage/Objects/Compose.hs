                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "userProject" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] ComposeRequest
...
instance Core.GoogleRequest StorageObjectsCompose
         where
        type Rs StorageObjectsCompose = Object
        type Scopes StorageObjectsCompose =
             '[CloudPlatform'FullControl, Devstorage'FullControl,
               Devstorage'ReadWrite]
        requestClient StorageObjectsCompose{..}
          = go destinationBucket destinationObject
