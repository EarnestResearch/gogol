       ...
       "v1" Core.:>
         "b" Core.:>
           Core.Capture "bucket" Core.Text Core.:>
             "o" Core.:>
               Core.QueryParam "contentEncoding" Core.Text Core.:>
                   ...
                   Core.QueryParam "ifGenerationNotMatch" Core.Int64
                     ...
                     Core.QueryParam "ifMetagenerationMatch" Core.Int64
                       ...
                       Core.QueryParam "ifMetagenerationNotMatch" Core.Int64
                         Core.:>
                         Core.QueryParam "kmsKeyName" Core.Text Core.:>
                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "userProject" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] Object Core.:>
                                         Core.Post '[Core.JSON] Object
       Core.:<|>
       "upload" Core.:>
         "storage" Core.:>
           "v1" Core.:>
...
instance Core.GoogleRequest StorageObjectsInsert
         where
        type Rs StorageObjectsInsert = Object
        type Scopes StorageObjectsInsert =
             '[CloudPlatform'FullControl, Devstorage'FullControl,
               Devstorage'ReadWrite]
        requestClient StorageObjectsInsert{..}
          = go bucket contentEncoding ifGenerationMatch
...
instance Core.GoogleRequest
         ...
         where
        type Rs (Core.MediaUpload StorageObjectsInsert) =
             Object
        type Scopes (Core.MediaUpload StorageObjectsInsert) =
