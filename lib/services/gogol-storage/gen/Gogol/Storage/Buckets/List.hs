             ...
             Core.QueryParam "maxResults" Core.Word32 Core.:>
               Core.QueryParam "pageToken" Core.Text Core.:>
                 Core.QueryParam "prefix" Core.Text Core.:>
                   Core.QueryParam "projection" BucketsListProjection Core.:>
...
newStorageBucketsList project
  = StorageBucketsList{maxResults = 1000, pageToken = Core.Nothing,
                       prefix = Core.Nothing, project = project,
                       projection = Core.Nothing, softDeleted = Core.Nothing,
                       uploadType = Core.Nothing, userProject = Core.Nothing}
instance Core.GoogleRequest StorageBucketsList where
        ...
        requestClient StorageBucketsList{..}
          = go (Core.Just project) (Core.Just maxResults) pageToken prefix
              projection
              softDeleted
              uploadType
              userProject
