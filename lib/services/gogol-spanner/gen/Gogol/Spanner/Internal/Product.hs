...
newAdaptMessageRequest 
    ::  AdaptMessageRequest
newAdaptMessageRequest
  = AdaptMessageRequest{attachments = Core.Nothing,
                        payload = Core.Nothing, protocol = Core.Nothing}
instance Core.FromJSON AdaptMessageRequest where
        parseJSON
          = Core.withObject "AdaptMessageRequest"
              (\ o ->
                 AdaptMessageRequest Core.<$>
                   (o Core..:? "attachments") Core.<*> (o Core..:? "payload") Core.<*>
                     (o Core..:? "protocol"))
...
instance Core.FromJSON AdaptMessageRequest_Attachments where
        parseJSON
          = Core.withObject "AdaptMessageRequest_Attachments"
              (\ o ->
...
newAdaptMessageResponse 
    ::  AdaptMessageResponse
newAdaptMessageResponse
  = AdaptMessageResponse{payload = Core.Nothing,
                         stateUpdates = Core.Nothing}
instance Core.FromJSON AdaptMessageResponse where
        parseJSON
          = Core.withObject "AdaptMessageResponse"
              (\ o ->
                 AdaptMessageResponse Core.<$>
                   (o Core..:? "payload") Core.<*> (o Core..:? "stateUpdates"))
...
instance Core.FromJSON AdaptMessageResponse_StateUpdates where
        parseJSON
          = Core.withObject "AdaptMessageResponse_StateUpdates"
              (\ o ->
                 AdaptMessageResponse_StateUpdates Core.<$>
...
instance Core.FromJSON AdapterSession where
        parseJSON
          = Core.withObject "AdapterSession"
...
data AddSplitPointsRequest = AddSplitPointsRequest
    {
      -- | Optional. A user-supplied tag associated with the split points. For example, \"initial/data/load\", \"special/event/1\". Defaults to \"CloudAddSplitPointsAPI\" if not specified. The length of the tag must not exceed 50 characters, or else it is trimmed. Only valid UTF8 characters are allowed.
...
newAddSplitPointsRequest 
    ::  AddSplitPointsRequest
newAddSplitPointsRequest
  = AddSplitPointsRequest{initiator = Core.Nothing,
                          splitPoints = Core.Nothing}
instance Core.FromJSON AddSplitPointsRequest where
        parseJSON
          = Core.withObject "AddSplitPointsRequest"
              (\ o ->
                 AddSplitPointsRequest Core.<$>
                   (o Core..:? "initiator") Core.<*> (o Core..:? "splitPoints"))
...
instance Core.FromJSON AddSplitPointsResponse where
        parseJSON
          = Core.withObject "AddSplitPointsResponse"
...
newAsymmetricAutoscalingOption 
    ::  AsymmetricAutoscalingOption
newAsymmetricAutoscalingOption
  = AsymmetricAutoscalingOption{overrides = Core.Nothing,
                                replicaSelection = Core.Nothing}
instance Core.FromJSON AsymmetricAutoscalingOption where
        parseJSON
          = Core.withObject "AsymmetricAutoscalingOption"
              (\ o ->
                 AsymmetricAutoscalingOption Core.<$>
                   (o Core..:? "overrides") Core.<*> (o Core..:? "replicaSelection"))
...
newAutoscalingConfig 
    ::  AutoscalingConfig
newAutoscalingConfig
  = AutoscalingConfig{asymmetricAutoscalingOptions = Core.Nothing,
          ...
          = Core.withObject "AutoscalingConfig"
              (\ o ->
                 AutoscalingConfig Core.<$>
                   (o Core..:? "asymmetricAutoscalingOptions") Core.<*>
                     (o Core..:? "autoscalingLimits")
...
instance Core.ToJSON AutoscalingConfig where
        toJSON AutoscalingConfig{..}
          = Core.object
              (Core.catMaybes
                 [("asymmetricAutoscalingOptions" Core..=) Core.<$>
...
newAutoscalingConfigOverrides 
    ::  AutoscalingConfigOverrides
newAutoscalingConfigOverrides
  = AutoscalingConfigOverrides{autoscalingLimits = Core.Nothing,
                               autoscalingTargetHighPriorityCpuUtilizationPercent = Core.Nothing}
instance Core.FromJSON AutoscalingConfigOverrides where
        parseJSON
          = Core.withObject "AutoscalingConfigOverrides"
              (\ o ->
                 AutoscalingConfigOverrides Core.<$>
                   (o Core..:? "autoscalingLimits") Core.<*>
                     (o Core..:? "autoscalingTargetHighPriorityCpuUtilizationPercent"))
...
newAutoscalingLimits 
    ::  AutoscalingLimits
newAutoscalingLimits
  = AutoscalingLimits{maxNodes = Core.Nothing,
                      maxProcessingUnits = Core.Nothing, minNodes = Core.Nothing,
          ...
          = Core.withObject "AutoscalingLimits"
              (\ o ->
                 AutoscalingLimits Core.<$>
                   (o Core..:? "maxNodes") Core.<*> (o Core..:? "maxProcessingUnits")
          ...
          = Core.withObject "AutoscalingTargets"
              (\ o ->
                 AutoscalingTargets Core.<$>
                   (o Core..:? "highPriorityCpuUtilizationPercent") Core.<*>
                     (o Core..:? "storageUtilizationPercent"))

instance Core.ToJSON AutoscalingTargets where
        toJSON AutoscalingTargets{..}
          = Core.object
              (Core.catMaybes
                 [("highPriorityCpuUtilizationPercent" Core..=) Core.<$>
                    highPriorityCpuUtilizationPercent,
                  ("storageUtilizationPercent" Core..=) Core.<$>
...
newBackup 
    ::  Backup
newBackup
  = Backup{backupSchedules = Core.Nothing, createTime = Core.Nothing,
           database = Core.Nothing, databaseDialect = Core.Nothing,
           encryptionInfo = Core.Nothing,
           encryptionInformation = Core.Nothing,
           exclusiveSizeBytes = Core.Nothing, expireTime = Core.Nothing,
           freeableSizeBytes = Core.Nothing,
           incrementalBackupChainId = Core.Nothing,
           instancePartitions = Core.Nothing, maxExpireTime = Core.Nothing,
           name = Core.Nothing, oldestVersionTime = Core.Nothing,
           referencingBackups = Core.Nothing,
           referencingDatabases = Core.Nothing, sizeBytes = Core.Nothing,
           state = Core.Nothing, versionTime = Core.Nothing}
instance Core.FromJSON Backup where
        parseJSON
          = Core.withObject "Backup"
              (\ o ->
                 Backup Core.<$>
                   (o Core..:? "backupSchedules") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "database")
                     Core.<*> (o Core..:? "databaseDialect")
                     Core.<*> (o Core..:? "encryptionInfo")
                     Core.<*> (o Core..:? "encryptionInformation")
                     Core.<*>
                     (o Core..:? "exclusiveSizeBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "expireTime")
                     Core.<*>
                     (o Core..:? "freeableSizeBytes" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("backupSchedules" Core..=) Core.<$> backupSchedules,
                  ...
                  ("exclusiveSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    exclusiveSizeBytes,
                  ("expireTime" Core..=) Core.<$> expireTime,
                  ("freeableSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    freeableSizeBytes,
                  ("incrementalBackupChainId" Core..=) Core.<$>
...
newBackupInfo 
    ::  BackupInfo
newBackupInfo
  = BackupInfo{backup = Core.Nothing, createTime = Core.Nothing,
               sourceDatabase = Core.Nothing, versionTime = Core.Nothing}
instance Core.FromJSON BackupInfo where
        parseJSON
          = Core.withObject "BackupInfo"
              (\ o ->
                 BackupInfo Core.<$>
                   (o Core..:? "backup") Core.<*> (o Core..:? "createTime") Core.<*>
                     (o Core..:? "sourceDatabase")
                     Core.<*> (o Core..:? "versionTime"))
...
instance Core.FromJSON BackupInstancePartition where
        parseJSON
          = Core.withObject "BackupInstancePartition"
              (\ o ->
...
newBackupSchedule 
    ::  BackupSchedule
newBackupSchedule
  = BackupSchedule{encryptionConfig = Core.Nothing,
                   fullBackupSpec = Core.Nothing,
                   incrementalBackupSpec = Core.Nothing, name = Core.Nothing,
                   retentionDuration = Core.Nothing, spec = Core.Nothing,
                   updateTime = Core.Nothing}
instance Core.FromJSON BackupSchedule where
        parseJSON
          = Core.withObject "BackupSchedule"
              (\ o ->
                 BackupSchedule Core.<$>
                   (o Core..:? "encryptionConfig") Core.<*>
                     (o Core..:? "fullBackupSpec")
...
instance Core.FromJSON BackupScheduleSpec where
        parseJSON
          = Core.withObject "BackupScheduleSpec"
...
newBatchCreateSessionsRequest 
    ::  BatchCreateSessionsRequest
newBatchCreateSessionsRequest
  = BatchCreateSessionsRequest{sessionCount = Core.Nothing,
                               sessionTemplate = Core.Nothing}
instance Core.FromJSON BatchCreateSessionsRequest where
        parseJSON
          = Core.withObject "BatchCreateSessionsRequest"
              (\ o ->
                 BatchCreateSessionsRequest Core.<$>
                   (o Core..:? "sessionCount") Core.<*>
                     (o Core..:? "sessionTemplate"))
...
instance Core.FromJSON BatchCreateSessionsResponse where
        parseJSON
          = Core.withObject "BatchCreateSessionsResponse"
              (\ o ->
...
newBatchWriteRequest 
    ::  BatchWriteRequest
newBatchWriteRequest
  = BatchWriteRequest{excludeTxnFromChangeStreams = Core.Nothing,
                      mutationGroups = Core.Nothing, requestOptions = Core.Nothing}
instance Core.FromJSON BatchWriteRequest where
        parseJSON
          = Core.withObject "BatchWriteRequest"
              (\ o ->
                 BatchWriteRequest Core.<$>
                   (o Core..:? "excludeTxnFromChangeStreams") Core.<*>
                     (o Core..:? "mutationGroups")
...
instance Core.ToJSON BatchWriteRequest where
        toJSON BatchWriteRequest{..}
          = Core.object
              (Core.catMaybes
                 [("excludeTxnFromChangeStreams" Core..=) Core.<$>
...
newBatchWriteResponse 
    ::  BatchWriteResponse
newBatchWriteResponse
  = BatchWriteResponse{commitTimestamp = Core.Nothing,
                       indexes = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON BatchWriteResponse where
        parseJSON
          = Core.withObject "BatchWriteResponse"
              (\ o ->
                 BatchWriteResponse Core.<$>
                   (o Core..:? "commitTimestamp") Core.<*> (o Core..:? "indexes")
                     Core.<*> (o Core..:? "status"))
...
newBeginTransactionRequest 
    ::  BeginTransactionRequest
newBeginTransactionRequest
  = BeginTransactionRequest{mutationKey = Core.Nothing,
                            options = Core.Nothing, requestOptions = Core.Nothing}
instance Core.FromJSON BeginTransactionRequest where
        parseJSON
          = Core.withObject "BeginTransactionRequest"
              (\ o ->
                 BeginTransactionRequest Core.<$>
                   (o Core..:? "mutationKey") Core.<*> (o Core..:? "options") Core.<*>
                     (o Core..:? "requestOptions"))
...
newChangeQuorumMetadata 
    ::  ChangeQuorumMetadata
newChangeQuorumMetadata
  = ChangeQuorumMetadata{endTime = Core.Nothing,
                         request' = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON ChangeQuorumMetadata where
        parseJSON
          = Core.withObject "ChangeQuorumMetadata"
              (\ o ->
                 ChangeQuorumMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "request") Core.<*>
                     (o Core..:? "startTime"))
...
newChangeQuorumRequest 
    ::  ChangeQuorumRequest
newChangeQuorumRequest
  = ChangeQuorumRequest{etag = Core.Nothing, name = Core.Nothing,
                        quorumType = Core.Nothing}
instance Core.FromJSON ChangeQuorumRequest where
        parseJSON
          = Core.withObject "ChangeQuorumRequest"
              (\ o ->
                 ChangeQuorumRequest Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "quorumType"))
...
newChildLink 
    ::  ChildLink
newChildLink
  = ChildLink{childIndex = Core.Nothing, type' = Core.Nothing,
              variable = Core.Nothing}
instance Core.FromJSON ChildLink where
        parseJSON
          = Core.withObject "ChildLink"
              (\ o ->
                 ChildLink Core.<$>
                   (o Core..:? "childIndex") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "variable"))
...
newCommitRequest 
    ::  CommitRequest
newCommitRequest
  = CommitRequest{maxCommitDelay = Core.Nothing,
                  mutations = Core.Nothing, precommitToken = Core.Nothing,
                  requestOptions = Core.Nothing, returnCommitStats = Core.Nothing,
                  singleUseTransaction = Core.Nothing, transactionId = Core.Nothing}
instance Core.FromJSON CommitRequest where
        parseJSON
          = Core.withObject "CommitRequest"
              (\ o ->
                 CommitRequest Core.<$>
                   (o Core..:? "maxCommitDelay") Core.<*> (o Core..:? "mutations")
...
newCommitResponse 
    ::  CommitResponse
newCommitResponse
  = CommitResponse{commitStats = Core.Nothing,
                   commitTimestamp = Core.Nothing, precommitToken = Core.Nothing}
instance Core.FromJSON CommitResponse where
        parseJSON
          = Core.withObject "CommitResponse"
              (\ o ->
                 CommitResponse Core.<$>
                   (o Core..:? "commitStats") Core.<*> (o Core..:? "commitTimestamp")
                     Core.<*> (o Core..:? "precommitToken"))
...
instance Core.FromJSON CommitStats where
        parseJSON
          = Core.withObject "CommitStats"
              (\ o ->
                 CommitStats Core.<$>
                   (o Core..:? "mutationCount" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON CommitStats where
        toJSON CommitStats{..}
          = Core.object
              (Core.catMaybes
                 [("mutationCount" Core..=) Core.. Core.AsText Core.<$>
                    mutationCount])
...
newContextValue 
    ::  ContextValue
newContextValue
  = ContextValue{label = Core.Nothing, severity = Core.Nothing,
                 unit = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON ContextValue where
        parseJSON
          = Core.withObject "ContextValue"
              (\ o ->
                 ContextValue Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "severity") Core.<*>
                     (o Core..:? "unit")
                     Core.<*> (o Core..:? "value"))
...
newCopyBackupEncryptionConfig 
    ::  CopyBackupEncryptionConfig
newCopyBackupEncryptionConfig
  = CopyBackupEncryptionConfig{encryptionType = Core.Nothing,
                               kmsKeyName = Core.Nothing, kmsKeyNames = Core.Nothing}
instance Core.FromJSON CopyBackupEncryptionConfig where
        parseJSON
          = Core.withObject "CopyBackupEncryptionConfig"
              (\ o ->
                 CopyBackupEncryptionConfig Core.<$>
                   (o Core..:? "encryptionType") Core.<*> (o Core..:? "kmsKeyName")
...
newCopyBackupMetadata 
    ::  CopyBackupMetadata
newCopyBackupMetadata
  = CopyBackupMetadata{cancelTime = Core.Nothing,
          ...
          = Core.withObject "CopyBackupMetadata"
              (\ o ->
                 CopyBackupMetadata Core.<$>
                   (o Core..:? "cancelTime") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "progress")
...
newCopyBackupRequest 
    ::  CopyBackupRequest
newCopyBackupRequest
  = CopyBackupRequest{backupId = Core.Nothing,
                      encryptionConfig = Core.Nothing, expireTime = Core.Nothing,
                      sourceBackup = Core.Nothing}
          ...
          = Core.withObject "CopyBackupRequest"
              (\ o ->
                 CopyBackupRequest Core.<$>
                   (o Core..:? "backupId") Core.<*> (o Core..:? "encryptionConfig")
                     Core.<*> (o Core..:? "expireTime")
                     Core.<*> (o Core..:? "sourceBackup"))
...
newCreateBackupEncryptionConfig 
    ::  CreateBackupEncryptionConfig
newCreateBackupEncryptionConfig
  = CreateBackupEncryptionConfig{encryptionType = Core.Nothing,
                                 kmsKeyName = Core.Nothing, kmsKeyNames = Core.Nothing}
instance Core.FromJSON CreateBackupEncryptionConfig where
        parseJSON
          = Core.withObject "CreateBackupEncryptionConfig"
              (\ o ->
                 CreateBackupEncryptionConfig Core.<$>
                   (o Core..:? "encryptionType") Core.<*> (o Core..:? "kmsKeyName")
                     Core.<*> (o Core..:? "kmsKeyNames"))
...
newCreateBackupMetadata 
    ::  CreateBackupMetadata
newCreateBackupMetadata
  = CreateBackupMetadata{cancelTime = Core.Nothing,
                         database = Core.Nothing, name = Core.Nothing,
          ...
          = Core.withObject "CreateBackupMetadata"
              (\ o ->
                 CreateBackupMetadata Core.<$>
                   (o Core..:? "cancelTime") Core.<*> (o Core..:? "database") Core.<*>
                     (o Core..:? "name")
...
instance Core.FromJSON CreateDatabaseMetadata where
        parseJSON
          = Core.withObject "CreateDatabaseMetadata"
...
newCreateDatabaseRequest 
    ::  CreateDatabaseRequest
newCreateDatabaseRequest
  = CreateDatabaseRequest{createStatement = Core.Nothing,
                          databaseDialect = Core.Nothing, encryptionConfig = Core.Nothing,
                          extraStatements = Core.Nothing, protoDescriptors = Core.Nothing}
instance Core.FromJSON CreateDatabaseRequest where
        parseJSON
          = Core.withObject "CreateDatabaseRequest"
              (\ o ->
                 CreateDatabaseRequest Core.<$>
                   (o Core..:? "createStatement") Core.<*>
                     (o Core..:? "databaseDialect")
...
newCreateInstanceConfigMetadata 
    ::  CreateInstanceConfigMetadata
newCreateInstanceConfigMetadata
  = CreateInstanceConfigMetadata{cancelTime = Core.Nothing,
                                 instanceConfig = Core.Nothing, progress = Core.Nothing}
instance Core.FromJSON CreateInstanceConfigMetadata where
        parseJSON
          = Core.withObject "CreateInstanceConfigMetadata"
              (\ o ->
                 CreateInstanceConfigMetadata Core.<$>
                   (o Core..:? "cancelTime") Core.<*> (o Core..:? "instanceConfig")
                     Core.<*> (o Core..:? "progress"))
...
newCreateInstanceConfigRequest 
    ::  CreateInstanceConfigRequest
newCreateInstanceConfigRequest
  = CreateInstanceConfigRequest{instanceConfig = Core.Nothing,
                                instanceConfigId = Core.Nothing, validateOnly = Core.Nothing}
instance Core.FromJSON CreateInstanceConfigRequest where
        parseJSON
          = Core.withObject "CreateInstanceConfigRequest"
              (\ o ->
                 CreateInstanceConfigRequest Core.<$>
                   (o Core..:? "instanceConfig") Core.<*>
                     (o Core..:? "instanceConfigId")
...
newCreateInstanceMetadata 
    ::  CreateInstanceMetadata
newCreateInstanceMetadata
  = CreateInstanceMetadata{cancelTime = Core.Nothing,
                           endTime = Core.Nothing, expectedFulfillmentPeriod = Core.Nothing,
                           instance' = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON CreateInstanceMetadata where
        parseJSON
          = Core.withObject "CreateInstanceMetadata"
              (\ o ->
                 CreateInstanceMetadata Core.<$>
                   (o Core..:? "cancelTime") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "expectedFulfillmentPeriod")
        ...
        toJSON CreateInstanceMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("cancelTime" Core..=) Core.<$> cancelTime,
                  ("endTime" Core..=) Core.<$> endTime,
                  ("expectedFulfillmentPeriod" Core..=) Core.<$>
...
newCreateInstancePartitionMetadata 
    :: 
                                   CreateInstancePartitionMetadata
newCreateInstancePartitionMetadata
  = CreateInstancePartitionMetadata{cancelTime = Core.Nothing,
                                    endTime = Core.Nothing, instancePartition = Core.Nothing,
                                    startTime = Core.Nothing}
instance Core.FromJSON CreateInstancePartitionMetadata where
        parseJSON
          = Core.withObject "CreateInstancePartitionMetadata"
              (\ o ->
                 CreateInstancePartitionMetadata Core.<$>
                   (o Core..:? "cancelTime") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "instancePartition")
                     Core.<*> (o Core..:? "startTime"))
...
newCreateInstancePartitionRequest 
    ::  CreateInstancePartitionRequest
newCreateInstancePartitionRequest
  = CreateInstancePartitionRequest{instancePartition = Core.Nothing,
                                   instancePartitionId = Core.Nothing}
instance Core.FromJSON CreateInstancePartitionRequest where
        parseJSON
          = Core.withObject "CreateInstancePartitionRequest"
              (\ o ->
                 CreateInstancePartitionRequest Core.<$>
                   (o Core..:? "instancePartition") Core.<*>
                     (o Core..:? "instancePartitionId"))
...
newCreateInstanceRequest 
    ::  CreateInstanceRequest
newCreateInstanceRequest
  = CreateInstanceRequest{instance' = Core.Nothing,
          ...
          = Core.withObject "CreateInstanceRequest"
              (\ o ->
                 CreateInstanceRequest Core.<$>
                   (o Core..:? "instance") Core.<*> (o Core..:? "instanceId"))
...
instance Core.FromJSON CreateSessionRequest where
        parseJSON
          = Core.withObject "CreateSessionRequest"
...
newCrontabSpec 
    ::  CrontabSpec
newCrontabSpec
  = CrontabSpec{creationWindow = Core.Nothing, text = Core.Nothing,
                timeZone = Core.Nothing}
instance Core.FromJSON CrontabSpec where
        parseJSON
          = Core.withObject "CrontabSpec"
              (\ o ->
                 CrontabSpec Core.<$>
                   (o Core..:? "creationWindow") Core.<*> (o Core..:? "text") Core.<*>
                     (o Core..:? "timeZone"))
...
newDatabase 
    ::  Database
newDatabase
  = Database{createTime = Core.Nothing,
             databaseDialect = Core.Nothing, defaultLeader = Core.Nothing,
             earliestVersionTime = Core.Nothing,
             enableDropProtection = Core.Nothing,
             encryptionConfig = Core.Nothing, encryptionInfo = Core.Nothing,
             name = Core.Nothing, quorumInfo = Core.Nothing,
             reconciling = Core.Nothing, restoreInfo = Core.Nothing,
             state = Core.Nothing, versionRetentionPeriod = Core.Nothing}
instance Core.FromJSON Database where
        parseJSON
          = Core.withObject "Database"
              (\ o ->
                 Database Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "databaseDialect")
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("state" Core..=) Core.<$> state,
                  ("versionRetentionPeriod" Core..=) Core.<$>
                    versionRetentionPeriod])


-- | The configuration for each database in the target instance configuration.
--
-- /See:/ 'newDatabaseMoveConfig' smart constructor.
data DatabaseMoveConfig = DatabaseMoveConfig
    {
      ...
      -- | Optional. Encryption configuration to be used for the database in target configuration. Should be specified for every database which currently uses CMEK encryption. If a database currently uses GOOGLE/MANAGED encryption and a target encryption config is not specified, it defaults to GOOGLE/MANAGED. If a database currently uses Google-managed encryption and a target encryption config is specified, the request is rejected. If a database currently uses CMEK encryption, a target encryption config must be specified. You cannot move a CMEK database to a Google-managed encryption database by MoveInstance.
    , encryptionConfig :: (Core.Maybe InstanceEncryptionConfig)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DatabaseMoveConfig' with the minimum fields required to make a request.
newDatabaseMoveConfig 
    ::  DatabaseMoveConfig
newDatabaseMoveConfig
  = DatabaseMoveConfig{databaseId = Core.Nothing,
                       encryptionConfig = Core.Nothing}
instance Core.FromJSON DatabaseMoveConfig where
        parseJSON
          = Core.withObject "DatabaseMoveConfig"
              (\ o ->
                 DatabaseMoveConfig Core.<$>
                   (o Core..:? "databaseId") Core.<*> (o Core..:? "encryptionConfig"))

instance Core.ToJSON DatabaseMoveConfig where
        toJSON DatabaseMoveConfig{..}
          = Core.object
              (Core.catMaybes
...
newDdlStatementActionInfo 
    ::  DdlStatementActionInfo
newDdlStatementActionInfo
  = DdlStatementActionInfo{action = Core.Nothing,
                           entityNames = Core.Nothing, entityType = Core.Nothing}
instance Core.FromJSON DdlStatementActionInfo where
        parseJSON
          = Core.withObject "DdlStatementActionInfo"
              (\ o ->
                 DdlStatementActionInfo Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "entityNames") Core.<*>
                     (o Core..:? "entityType"))
...
instance Core.FromJSON Delete' where
        parseJSON
          = Core.withObject "Delete'"
              (\ o ->
                 Delete' Core.<$>
                   (o Core..:? "keySet") Core.<*> (o Core..:? "table"))
...
newDerivedMetric 
    ::  DerivedMetric
newDerivedMetric
  = DerivedMetric{denominator = Core.Nothing,
                  numerator = Core.Nothing}
instance Core.FromJSON DerivedMetric where
        parseJSON
          = Core.withObject "DerivedMetric"
              (\ o ->
                 DerivedMetric Core.<$>
                   (o Core..:? "denominator") Core.<*> (o Core..:? "numerator"))
...
newDiagnosticMessage 
    ::  DiagnosticMessage
newDiagnosticMessage
  = DiagnosticMessage{info = Core.Nothing, metric = Core.Nothing,
                      metricSpecific = Core.Nothing, severity = Core.Nothing,
                      shortMessage = Core.Nothing}
instance Core.FromJSON DiagnosticMessage where
        parseJSON
          = Core.withObject "DiagnosticMessage"
              (\ o ->
                 DiagnosticMessage Core.<$>
                   (o Core..:? "info") Core.<*> (o Core..:? "metric") Core.<*>
                     (o Core..:? "metricSpecific")
...
newDirectedReadOptions 
    ::  DirectedReadOptions
newDirectedReadOptions
  = DirectedReadOptions{excludeReplicas = Core.Nothing,
                        includeReplicas = Core.Nothing}
instance Core.FromJSON DirectedReadOptions where
        parseJSON
          = Core.withObject "DirectedReadOptions"
              (\ o ->
                 DirectedReadOptions Core.<$>
                   (o Core..:? "excludeReplicas") Core.<*>
                     (o Core..:? "includeReplicas"))
...
instance Core.FromJSON DualRegionQuorum where
        parseJSON
          = Core.withObject "DualRegionQuorum"
...
newEncryptionConfig 
    ::  EncryptionConfig
newEncryptionConfig
  = EncryptionConfig{kmsKeyName = Core.Nothing,
          ...
          = Core.withObject "EncryptionConfig"
              (\ o ->
                 EncryptionConfig Core.<$>
                   (o Core..:? "kmsKeyName") Core.<*> (o Core..:? "kmsKeyNames"))
...
newEncryptionInfo 
    ::  EncryptionInfo
newEncryptionInfo
  = EncryptionInfo{encryptionStatus = Core.Nothing,
                   encryptionType = Core.Nothing, kmsKeyVersion = Core.Nothing}
...
instance Core.FromJSON ExcludeReplicas where
        parseJSON
          = Core.withObject "ExcludeReplicas"
...
newExecuteBatchDmlRequest 
    ::  ExecuteBatchDmlRequest
newExecuteBatchDmlRequest
  = ExecuteBatchDmlRequest{lastStatements = Core.Nothing,
                           requestOptions = Core.Nothing, seqno = Core.Nothing,
                           statements = Core.Nothing, transaction = Core.Nothing}
instance Core.FromJSON ExecuteBatchDmlRequest where
        parseJSON
          = Core.withObject "ExecuteBatchDmlRequest"
              (\ o ->
                 ExecuteBatchDmlRequest Core.<$>
                   (o Core..:? "lastStatements") Core.<*>
                     (o Core..:? "requestOptions")
...
newExecuteBatchDmlResponse 
    ::  ExecuteBatchDmlResponse
newExecuteBatchDmlResponse
  = ExecuteBatchDmlResponse{precommitToken = Core.Nothing,
                            resultSets = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON ExecuteBatchDmlResponse where
        parseJSON
          = Core.withObject "ExecuteBatchDmlResponse"
              (\ o ->
                 ExecuteBatchDmlResponse Core.<$>
                   (o Core..:? "precommitToken") Core.<*> (o Core..:? "resultSets")
                     Core.<*> (o Core..:? "status"))
...
newExecuteSqlRequest 
    ::  ExecuteSqlRequest
newExecuteSqlRequest
  = ExecuteSqlRequest{dataBoostEnabled = Core.Nothing,
                      directedReadOptions = Core.Nothing, lastStatement = Core.Nothing,
                      paramTypes = Core.Nothing, params = Core.Nothing,
                      partitionToken = Core.Nothing, queryMode = Core.Nothing,
                      queryOptions = Core.Nothing, requestOptions = Core.Nothing,
                      resumeToken = Core.Nothing, seqno = Core.Nothing,
                      sql = Core.Nothing, transaction = Core.Nothing}
instance Core.FromJSON ExecuteSqlRequest where
        parseJSON
          = Core.withObject "ExecuteSqlRequest"
              (\ o ->
                 ExecuteSqlRequest Core.<$>
                   (o Core..:? "dataBoostEnabled") Core.<*>
                     (o Core..:? "directedReadOptions")
...
instance Core.FromJSON ExecuteSqlRequest_ParamTypes where
        parseJSON
          = Core.withObject "ExecuteSqlRequest_ParamTypes"
              (\ o ->
...
instance Core.FromJSON ExecuteSqlRequest_Params where
        parseJSON
          = Core.withObject "ExecuteSqlRequest_Params"
...
newFreeInstanceMetadata 
    ::  FreeInstanceMetadata
newFreeInstanceMetadata
  = FreeInstanceMetadata{expireBehavior = Core.Nothing,
                         expireTime = Core.Nothing, upgradeTime = Core.Nothing}
instance Core.FromJSON FreeInstanceMetadata where
        parseJSON
          = Core.withObject "FreeInstanceMetadata"
              (\ o ->
                 FreeInstanceMetadata Core.<$>
                   (o Core..:? "expireBehavior") Core.<*> (o Core..:? "expireTime")
...
instance Core.FromJSON FullBackupSpec where
        parseJSON
          = Core.withObject "FullBackupSpec"
...
newGetDatabaseDdlResponse 
    ::  GetDatabaseDdlResponse
newGetDatabaseDdlResponse
  = GetDatabaseDdlResponse{protoDescriptors = Core.Nothing,
                           statements = Core.Nothing}
instance Core.FromJSON GetDatabaseDdlResponse where
        parseJSON
          = Core.withObject "GetDatabaseDdlResponse"
              (\ o ->
                 GetDatabaseDdlResponse Core.<$>
                   (o Core..:? "protoDescriptors") Core.<*> (o Core..:? "statements"))
...
newIncludeReplicas 
    ::  IncludeReplicas
newIncludeReplicas
  = IncludeReplicas{autoFailoverDisabled = Core.Nothing,
                    replicaSelections = Core.Nothing}
instance Core.FromJSON IncludeReplicas where
        parseJSON
          = Core.withObject "IncludeReplicas"
              (\ o ->
                 IncludeReplicas Core.<$>
                   (o Core..:? "autoFailoverDisabled") Core.<*>
                     (o Core..:? "replicaSelections"))
...
instance Core.FromJSON IncrementalBackupSpec where
        parseJSON
          = Core.withObject "IncrementalBackupSpec"
...
instance Core.FromJSON IndexAdvice where
        parseJSON
          = Core.withObject "IndexAdvice"
              (\ o ->
                 IndexAdvice Core.<$>
                   (o Core..:? "ddl") Core.<*> (o Core..:? "improvementFactor"))
...
instance Core.FromJSON IndexedHotKey_SparseHotKeys where
        parseJSON
          = Core.withObject "IndexedHotKey_SparseHotKeys"
              (\ o ->
...
instance Core.FromJSON IndexedKeyRangeInfos where
        parseJSON
          = Core.withObject "IndexedKeyRangeInfos"
...
instance Core.FromJSON IndexedKeyRangeInfos_KeyRangeInfos where
        parseJSON
          = Core.withObject "IndexedKeyRangeInfos_KeyRangeInfos"
              (\ o ->
                 IndexedKeyRangeInfos_KeyRangeInfos Core.<$>
                   (Core.parseJSONObject o))
...
newInstance 
    ::  Instance
newInstance
  = Instance{autoscalingConfig = Core.Nothing, config = Core.Nothing,
             createTime = Core.Nothing,
             defaultBackupScheduleType = Core.Nothing,
             displayName = Core.Nothing, edition = Core.Nothing,
             endpointUris = Core.Nothing, freeInstanceMetadata = Core.Nothing,
             instanceType = Core.Nothing, labels = Core.Nothing,
             name = Core.Nothing, nodeCount = Core.Nothing,
             processingUnits = Core.Nothing,
             replicaComputeCapacity = Core.Nothing, state = Core.Nothing,
             updateTime = Core.Nothing}
instance Core.FromJSON Instance where
        parseJSON
          = Core.withObject "Instance"
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "autoscalingConfig") Core.<*> (o Core..:? "config")
          ...
          = Core.object
              (Core.catMaybes
                 [("autoscalingConfig" Core..=) Core.<$> autoscalingConfig,
                  ...
                  ("createTime" Core..=) Core.<$> createTime,
                  ("defaultBackupScheduleType" Core..=) Core.<$>
...
newInstanceConfig 
    ::  InstanceConfig
newInstanceConfig
  = InstanceConfig{baseConfig = Core.Nothing,
                   configType = Core.Nothing, displayName = Core.Nothing,
                   etag = Core.Nothing, freeInstanceAvailability = Core.Nothing,
                   labels = Core.Nothing, leaderOptions = Core.Nothing,
                   name = Core.Nothing, optionalReplicas = Core.Nothing,
                   quorumType = Core.Nothing, reconciling = Core.Nothing,
                   replicas = Core.Nothing, state = Core.Nothing,
                   storageLimitPerProcessingUnit = Core.Nothing}
instance Core.FromJSON InstanceConfig where
        parseJSON
          = Core.withObject "InstanceConfig"
              (\ o ->
                 InstanceConfig Core.<$>
                   (o Core..:? "baseConfig") Core.<*> (o Core..:? "configType")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "etag")
                     ...
                     Core.<*> (o Core..:? "state")
                     Core.<*>
                     (o Core..:? "storageLimitPerProcessingUnit" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("baseConfig" Core..=) Core.<$> baseConfig,
                  ...
                  ("displayName" Core..=) Core.<$> displayName,
                  ("etag" Core..=) Core.<$> etag,
                  ("freeInstanceAvailability" Core..=) Core.<$>
                  ...
                  ("state" Core..=) Core.<$> state,
                  ("storageLimitPerProcessingUnit" Core..=) Core.. Core.AsText
...
instance Core.FromJSON InstanceConfig_Labels where
        parseJSON
          = Core.withObject "InstanceConfig_Labels"
...
-- | Encryption configuration for a Cloud Spanner database.
--
-- /See:/ 'newInstanceEncryptionConfig' smart constructor.
data InstanceEncryptionConfig = InstanceEncryptionConfig
    {
...
-- | Creates a value of 'InstanceEncryptionConfig' with the minimum fields required to make a request.
newInstanceEncryptionConfig 
    ::  InstanceEncryptionConfig
newInstanceEncryptionConfig
  = InstanceEncryptionConfig{kmsKeyName = Core.Nothing,
                             kmsKeyNames = Core.Nothing}
instance Core.FromJSON InstanceEncryptionConfig where
        parseJSON
          = Core.withObject "InstanceEncryptionConfig"
              (\ o ->
                 InstanceEncryptionConfig Core.<$>
                   (o Core..:? "kmsKeyName") Core.<*> (o Core..:? "kmsKeyNames"))

instance Core.ToJSON InstanceEncryptionConfig where
        toJSON InstanceEncryptionConfig{..}
          = Core.object
              (Core.catMaybes
                 [("kmsKeyName" Core..=) Core.<$> kmsKeyName,
                  ("kmsKeyNames" Core..=) Core.<$> kmsKeyNames])
...
newInstanceOperationProgress 
    ::  InstanceOperationProgress
newInstanceOperationProgress
  = InstanceOperationProgress{endTime = Core.Nothing,
                              progressPercent = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON InstanceOperationProgress where
        parseJSON
          = Core.withObject "InstanceOperationProgress"
              (\ o ->
                 InstanceOperationProgress Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "progressPercent")
                     Core.<*> (o Core..:? "startTime"))
...
newInstancePartition 
    ::  InstancePartition
newInstancePartition
  = InstancePartition{config = Core.Nothing,
                      createTime = Core.Nothing, displayName = Core.Nothing,
                      etag = Core.Nothing, name = Core.Nothing, nodeCount = Core.Nothing,
                      processingUnits = Core.Nothing, referencingBackups = Core.Nothing,
                      referencingDatabases = Core.Nothing, state = Core.Nothing,
                      updateTime = Core.Nothing}
instance Core.FromJSON InstancePartition where
        parseJSON
          = Core.withObject "InstancePartition"
              (\ o ->
                 InstancePartition Core.<$>
...
instance Core.FromJSON InstanceReplicaSelection where
        parseJSON
          = Core.withObject "InstanceReplicaSelection"
...
newKeyRange 
    ::  KeyRange
newKeyRange
  = KeyRange{endClosed = Core.Nothing, endOpen = Core.Nothing,
             startClosed = Core.Nothing, startOpen = Core.Nothing}
instance Core.FromJSON KeyRange where
        parseJSON
          = Core.withObject "KeyRange"
              (\ o ->
                 KeyRange Core.<$>
                   (o Core..:? "endClosed") Core.<*> (o Core..:? "endOpen") Core.<*>
                     (o Core..:? "startClosed")
...
newKeyRangeInfo 
    ::  KeyRangeInfo
newKeyRangeInfo
  = KeyRangeInfo{contextValues = Core.Nothing,
                 endKeyIndex = Core.Nothing, info = Core.Nothing,
                 keysCount = Core.Nothing, metric = Core.Nothing,
                 startKeyIndex = Core.Nothing, timeOffset = Core.Nothing,
                 unit = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON KeyRangeInfo where
        parseJSON
          = Core.withObject "KeyRangeInfo"
              (\ o ->
                 KeyRangeInfo Core.<$>
                   (o Core..:? "contextValues") Core.<*> (o Core..:? "endKeyIndex")
                     Core.<*> (o Core..:? "info")
                     Core.<*>
                     (o Core..:? "keysCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "metric")
...
instance Core.FromJSON KeyRangeInfos where
        parseJSON
          = Core.withObject "KeyRangeInfos"
              (\ o ->
                 KeyRangeInfos Core.<$>
                   (o Core..:? "infos") Core.<*> (o Core..:? "totalSize"))
...
newKeySet 
    ::  KeySet
newKeySet
  = KeySet{all = Core.Nothing, keys = Core.Nothing,
           ranges = Core.Nothing}
instance Core.FromJSON KeySet where
        parseJSON
          = Core.withObject "KeySet"
              (\ o ->
                 KeySet Core.<$>
                   (o Core..:? "all") Core.<*> (o Core..:? "keys") Core.<*>
                     (o Core..:? "ranges"))
...
instance Core.ToJSON KeySet where
        toJSON KeySet{..}
          = Core.object
              (Core.catMaybes
                 [("all" Core..=) Core.<$> all, ("keys" Core..=) Core.<$> keys,
...
newListBackupOperationsResponse 
    ::  ListBackupOperationsResponse
newListBackupOperationsResponse
  = ListBackupOperationsResponse{nextPageToken = Core.Nothing,
                                 operations = Core.Nothing}
instance Core.FromJSON ListBackupOperationsResponse where
        parseJSON
          = Core.withObject "ListBackupOperationsResponse"
              (\ o ->
                 ListBackupOperationsResponse Core.<$>
...
newListBackupSchedulesResponse 
    ::  ListBackupSchedulesResponse
newListBackupSchedulesResponse
  = ListBackupSchedulesResponse{backupSchedules = Core.Nothing,
                                nextPageToken = Core.Nothing}
instance Core.FromJSON ListBackupSchedulesResponse where
        parseJSON
          = Core.withObject "ListBackupSchedulesResponse"
              (\ o ->
                 ListBackupSchedulesResponse Core.<$>
                   (o Core..:? "backupSchedules") Core.<*>
...
newListBackupsResponse 
    ::  ListBackupsResponse
newListBackupsResponse
  = ListBackupsResponse{backups = Core.Nothing,
                        nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListBackupsResponse"
              (\ o ->
                 ListBackupsResponse Core.<$>
                   (o Core..:? "backups") Core.<*> (o Core..:? "nextPageToken"))
...
newListDatabaseOperationsResponse 
    ::  ListDatabaseOperationsResponse
newListDatabaseOperationsResponse
  = ListDatabaseOperationsResponse{nextPageToken = Core.Nothing,
                                   operations = Core.Nothing}
instance Core.FromJSON ListDatabaseOperationsResponse where
        parseJSON
          = Core.withObject "ListDatabaseOperationsResponse"
              (\ o ->
                 ListDatabaseOperationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "operations"))
...
newListDatabaseRolesResponse 
    ::  ListDatabaseRolesResponse
newListDatabaseRolesResponse
  = ListDatabaseRolesResponse{databaseRoles = Core.Nothing,
                              nextPageToken = Core.Nothing}
instance Core.FromJSON ListDatabaseRolesResponse where
        parseJSON
          = Core.withObject "ListDatabaseRolesResponse"
              (\ o ->
                 ListDatabaseRolesResponse Core.<$>
                   (o Core..:? "databaseRoles") Core.<*> (o Core..:? "nextPageToken"))
...
newListDatabasesResponse 
    ::  ListDatabasesResponse
newListDatabasesResponse
  = ListDatabasesResponse{databases = Core.Nothing,
                          nextPageToken = Core.Nothing}
instance Core.FromJSON ListDatabasesResponse where
        parseJSON
          = Core.withObject "ListDatabasesResponse"
              (\ o ->
                 ListDatabasesResponse Core.<$>
                   (o Core..:? "databases") Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListInstanceConfigOperationsResponse where
        parseJSON
          = Core.withObject "ListInstanceConfigOperationsResponse"
              (\ o ->
                 ListInstanceConfigOperationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "operations"))
...
newListInstanceConfigsResponse 
    ::  ListInstanceConfigsResponse
newListInstanceConfigsResponse
  = ListInstanceConfigsResponse{instanceConfigs = Core.Nothing,
                                nextPageToken = Core.Nothing}
instance Core.FromJSON ListInstanceConfigsResponse where
        parseJSON
          = Core.withObject "ListInstanceConfigsResponse"
              (\ o ->
                 ListInstanceConfigsResponse Core.<$>
                   (o Core..:? "instanceConfigs") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListInstancePartitionOperationsResponse
         where
        parseJSON
          = Core.withObject "ListInstancePartitionOperationsResponse"
              (\ o ->
                 ListInstancePartitionOperationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "operations")
        ...
        toJSON ListInstancePartitionOperationsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("operations" Core..=) Core.<$> operations,
                  ("unreachableInstancePartitions" Core..=) Core.<$>
...
newListInstancePartitionsResponse 
    ::  ListInstancePartitionsResponse
newListInstancePartitionsResponse
  = ListInstancePartitionsResponse{instancePartitions = Core.Nothing,
                                   nextPageToken = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListInstancePartitionsResponse where
        parseJSON
          = Core.withObject "ListInstancePartitionsResponse"
              (\ o ->
                 ListInstancePartitionsResponse Core.<$>
                   (o Core..:? "instancePartitions") Core.<*>
                     (o Core..:? "nextPageToken")
          ...
          = Core.withObject "ListInstancesResponse"
              (\ o ->
                 ListInstancesResponse Core.<$>
                   (o Core..:? "instances") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "unreachable"))
...
newListScansResponse 
    ::  ListScansResponse
newListScansResponse
  = ListScansResponse{nextPageToken = Core.Nothing,
                      scans = Core.Nothing}
instance Core.FromJSON ListScansResponse where
        parseJSON
          = Core.withObject "ListScansResponse"
              (\ o ->
                 ListScansResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "scans"))
...
newLocalizedString 
    ::  LocalizedString
newLocalizedString
  = LocalizedString{args = Core.Nothing, message = Core.Nothing,
                    token = Core.Nothing}
instance Core.FromJSON LocalizedString where
        parseJSON
          = Core.withObject "LocalizedString"
              (\ o ->
                 LocalizedString Core.<$>
                   (o Core..:? "args") Core.<*> (o Core..:? "message") Core.<*>
                     (o Core..:? "token"))
...
instance Core.FromJSON LocalizedString_Args where
        parseJSON
          = Core.withObject "LocalizedString_Args"
...
newMetric 
    ::  Metric
newMetric
  = Metric{aggregation = Core.Nothing, category = Core.Nothing,
           derived = Core.Nothing, displayLabel = Core.Nothing,
           hasNonzeroData = Core.Nothing, hotValue = Core.Nothing,
           indexedHotKeys = Core.Nothing, indexedKeyRangeInfos = Core.Nothing,
           info = Core.Nothing, matrix = Core.Nothing, unit = Core.Nothing,
...
instance Core.FromJSON Metric where
        parseJSON
          = Core.withObject "Metric"
              (\ o ->
                 Metric Core.<$>
                   (o Core..:? "aggregation") Core.<*> (o Core..:? "category")
                     Core.<*> (o Core..:? "derived")
          ...
          = Core.object
              (Core.catMaybes
                 [("aggregation" Core..=) Core.<$> aggregation,
                  ...
                  ("info" Core..=) Core.<$> info, ("matrix" Core..=) Core.<$> matrix,
                  ("unit" Core..=) Core.<$> unit,
...
instance Core.FromJSON Metric_IndexedHotKeys where
        parseJSON
          = Core.withObject "Metric_IndexedHotKeys"
...
instance Core.FromJSON Metric_IndexedKeyRangeInfos where
        parseJSON
          = Core.withObject "Metric_IndexedKeyRangeInfos"
              (\ o ->
...
instance Core.FromJSON MetricMatrixRow where
        parseJSON
          = Core.withObject "MetricMatrixRow"
...
data MoveInstanceRequest = MoveInstanceRequest
    {
    ...
    , targetDatabaseMoveConfigs :: (Core.Maybe [DatabaseMoveConfig])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newMoveInstanceRequest
  = MoveInstanceRequest{targetConfig = Core.Nothing,
                        targetDatabaseMoveConfigs = Core.Nothing}
instance Core.FromJSON MoveInstanceRequest where
        parseJSON
          = Core.withObject "MoveInstanceRequest"
              (\ o ->
                 MoveInstanceRequest Core.<$>
                   (o Core..:? "targetConfig") Core.<*>
                     (o Core..:? "targetDatabaseMoveConfigs"))

instance Core.ToJSON MoveInstanceRequest where
        toJSON MoveInstanceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("targetConfig" Core..=) Core.<$> targetConfig,
                  ("targetDatabaseMoveConfigs" Core..=) Core.<$>
...
newMultiplexedSessionPrecommitToken 
    :: 
                                    MultiplexedSessionPrecommitToken
newMultiplexedSessionPrecommitToken
  = MultiplexedSessionPrecommitToken{precommitToken = Core.Nothing,
                                     seqNum = Core.Nothing}
instance Core.FromJSON MultiplexedSessionPrecommitToken where
        parseJSON
          = Core.withObject "MultiplexedSessionPrecommitToken"
              (\ o ->
                 MultiplexedSessionPrecommitToken Core.<$>
                   (o Core..:? "precommitToken") Core.<*> (o Core..:? "seqNum"))
...
newMutation 
    ::  Mutation
newMutation
  = Mutation{delete = Core.Nothing, insert = Core.Nothing,
             insertOrUpdate = Core.Nothing, replace = Core.Nothing,
             update = Core.Nothing}
instance Core.FromJSON Mutation where
        parseJSON
          = Core.withObject "Mutation"
              (\ o ->
                 Mutation Core.<$>
                   (o Core..:? "delete") Core.<*> (o Core..:? "insert") Core.<*>
                     (o Core..:? "insertOrUpdate")
                     Core.<*> (o Core..:? "replace")
                     Core.<*> (o Core..:? "update"))
...
newOperationProgress 
    ::  OperationProgress
newOperationProgress
  = OperationProgress{endTime = Core.Nothing,
                      progressPercent = Core.Nothing, startTime = Core.Nothing}
...
newOptimizeRestoredDatabaseMetadata 
    :: 
                                    OptimizeRestoredDatabaseMetadata
newOptimizeRestoredDatabaseMetadata
  = OptimizeRestoredDatabaseMetadata{name = Core.Nothing,
                                     progress = Core.Nothing}
instance Core.FromJSON OptimizeRestoredDatabaseMetadata where
        parseJSON
          = Core.withObject "OptimizeRestoredDatabaseMetadata"
              (\ o ->
                 OptimizeRestoredDatabaseMetadata Core.<$>
...
newPartialResultSet 
    ::  PartialResultSet
newPartialResultSet
  = PartialResultSet{chunkedValue = Core.Nothing,
                     last = Core.Nothing, metadata = Core.Nothing,
                     precommitToken = Core.Nothing, resumeToken = Core.Nothing,
                     stats = Core.Nothing, values = Core.Nothing}
instance Core.FromJSON PartialResultSet where
        parseJSON
          = Core.withObject "PartialResultSet"
              (\ o ->
                 PartialResultSet Core.<$>
                   (o Core..:? "chunkedValue") Core.<*> (o Core..:? "last") Core.<*>
                     (o Core..:? "metadata")
                     Core.<*> (o Core..:? "precommitToken")
                     Core.<*> (o Core..:? "resumeToken")
                     Core.<*> (o Core..:? "stats")
...
data PartitionOptions = PartitionOptions
    {
      -- | __Note:__ This hint is currently ignored by @PartitionQuery@ and @PartitionRead@ requests. The desired maximum number of partitions to return. For example, this might be set to the number of workers available. The default for this option is currently 10,000. The maximum value is currently 200,000. This is only a hint. The actual number of partitions returned can be smaller or larger than this maximum count request.
      maxPartitions :: (Core.Maybe Core.Int64)
      -- | __Note:__ This hint is currently ignored by @PartitionQuery@ and @PartitionRead@ requests. The desired data size for each partition generated. The default for this option is currently 1 GiB. This is only a hint. The actual size of each partition can be smaller or larger than this size request.
...
newPartitionOptions 
    ::  PartitionOptions
newPartitionOptions
  = PartitionOptions{maxPartitions = Core.Nothing,
                     partitionSizeBytes = Core.Nothing}
instance Core.FromJSON PartitionOptions where
        parseJSON
          = Core.withObject "PartitionOptions"
              (\ o ->
                 PartitionOptions Core.<$>
                   (o Core..:? "maxPartitions" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "partitionSizeBytes" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON PartitionOptions where
        toJSON PartitionOptions{..}
          = Core.object
              (Core.catMaybes
                 [("maxPartitions" Core..=) Core.. Core.AsText Core.<$>
                    maxPartitions,
                  ("partitionSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    partitionSizeBytes])
...
newPartitionQueryRequest 
    ::  PartitionQueryRequest
newPartitionQueryRequest
  = PartitionQueryRequest{paramTypes = Core.Nothing,
                          params = Core.Nothing, partitionOptions = Core.Nothing,
                          sql = Core.Nothing, transaction = Core.Nothing}
          ...
          = Core.withObject "PartitionQueryRequest"
              (\ o ->
                 PartitionQueryRequest Core.<$>
                   (o Core..:? "paramTypes") Core.<*> (o Core..:? "params") Core.<*>
                     (o Core..:? "partitionOptions")
                     Core.<*> (o Core..:? "sql")
                     Core.<*> (o Core..:? "transaction"))
...
instance Core.FromJSON PartitionQueryRequest_ParamTypes where
        parseJSON
          = Core.withObject "PartitionQueryRequest_ParamTypes"
              (\ o ->
...
instance Core.FromJSON PartitionQueryRequest_Params where
        parseJSON
          = Core.withObject "PartitionQueryRequest_Params"
              (\ o ->
...
newPartitionReadRequest 
    ::  PartitionReadRequest
newPartitionReadRequest
  = PartitionReadRequest{columns = Core.Nothing,
                         index = Core.Nothing, keySet = Core.Nothing,
                         partitionOptions = Core.Nothing, table = Core.Nothing,
                         transaction = Core.Nothing}
instance Core.FromJSON PartitionReadRequest where
        parseJSON
          = Core.withObject "PartitionReadRequest"
              (\ o ->
                 PartitionReadRequest Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "index") Core.<*>
                     (o Core..:? "keySet")
...
newPartitionResponse 
    ::  PartitionResponse
newPartitionResponse
  = PartitionResponse{partitions = Core.Nothing,
                      transaction = Core.Nothing}
instance Core.FromJSON PartitionResponse where
        parseJSON
          = Core.withObject "PartitionResponse"
              (\ o ->
                 PartitionResponse Core.<$>
                   (o Core..:? "partitions") Core.<*> (o Core..:? "transaction"))
...
instance Core.FromJSON PartitionedDml where
        parseJSON
          = Core.withObject "PartitionedDml"
...
newPlanNode 
    ::  PlanNode
newPlanNode
  = PlanNode{childLinks = Core.Nothing, displayName = Core.Nothing,
             executionStats = Core.Nothing, index = Core.Nothing,
             kind = Core.Nothing, metadata = Core.Nothing,
             shortRepresentation = Core.Nothing}
instance Core.FromJSON PlanNode where
        parseJSON
          = Core.withObject "PlanNode"
              (\ o ->
                 PlanNode Core.<$>
                   (o Core..:? "childLinks") Core.<*> (o Core..:? "displayName")
          ...
          = Core.object
              (Core.catMaybes
                 [("childLinks" Core..=) Core.<$> childLinks,
                  ...
                  ("index" Core..=) Core.<$> index, ("kind" Core..=) Core.<$> kind,
                  ("metadata" Core..=) Core.<$> metadata,
...
instance Core.FromJSON PlanNode_ExecutionStats where
        parseJSON
          = Core.withObject "PlanNode_ExecutionStats"
...
instance Core.FromJSON PlanNode_Metadata where
        parseJSON
          = Core.withObject "PlanNode_Metadata"
...
newPrefixNode 
    ::  PrefixNode
newPrefixNode
  = PrefixNode{dataSourceNode = Core.Nothing, depth = Core.Nothing,
               endIndex = Core.Nothing, startIndex = Core.Nothing,
               word = Core.Nothing}
instance Core.FromJSON PrefixNode where
        parseJSON
          = Core.withObject "PrefixNode"
              (\ o ->
                 PrefixNode Core.<$>
                   (o Core..:? "dataSourceNode") Core.<*> (o Core..:? "depth")
...
instance Core.FromJSON QueryAdvisorResult where
        parseJSON
          = Core.withObject "QueryAdvisorResult"
...
newQueryOptions 
    ::  QueryOptions
newQueryOptions
  = QueryOptions{optimizerStatisticsPackage = Core.Nothing,
                 optimizerVersion = Core.Nothing}
instance Core.FromJSON QueryOptions where
        parseJSON
          = Core.withObject "QueryOptions"
              (\ o ->
                 QueryOptions Core.<$>
                   (o Core..:? "optimizerStatisticsPackage") Core.<*>
                     (o Core..:? "optimizerVersion"))

instance Core.ToJSON QueryOptions where
        toJSON QueryOptions{..}
          = Core.object
              (Core.catMaybes
                 [("optimizerStatisticsPackage" Core..=) Core.<$>
...
instance Core.FromJSON QueryPlan where
        parseJSON
          = Core.withObject "QueryPlan"
              (\ o ->
                 QueryPlan Core.<$>
                   (o Core..:? "planNodes") Core.<*> (o Core..:? "queryAdvice"))
...
newQuorumInfo 
    ::  QuorumInfo
newQuorumInfo
  = QuorumInfo{etag = Core.Nothing, initiator = Core.Nothing,
               quorumType = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON QuorumInfo where
        parseJSON
          = Core.withObject "QuorumInfo"
              (\ o ->
                 QuorumInfo Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "initiator") Core.<*>
                     (o Core..:? "quorumType")
                     Core.<*> (o Core..:? "startTime"))
...
newQuorumType 
    ::  QuorumType
newQuorumType
  = QuorumType{dualRegion = Core.Nothing,
               singleRegion = Core.Nothing}
instance Core.FromJSON QuorumType where
        parseJSON
          = Core.withObject "QuorumType"
              (\ o ->
                 QuorumType Core.<$>
                   (o Core..:? "dualRegion") Core.<*> (o Core..:? "singleRegion"))
...
newReadOnly 
    ::  ReadOnly
newReadOnly
  = ReadOnly{exactStaleness = Core.Nothing,
             maxStaleness = Core.Nothing, minReadTimestamp = Core.Nothing,
             readTimestamp = Core.Nothing, returnReadTimestamp = Core.Nothing,
             strong = Core.Nothing}
instance Core.FromJSON ReadOnly where
        parseJSON
          = Core.withObject "ReadOnly"
              (\ o ->
                 ReadOnly Core.<$>
                   (o Core..:? "exactStaleness") Core.<*> (o Core..:? "maxStaleness")
...
newReadRequest 
    ::  ReadRequest
newReadRequest
  = ReadRequest{columns = Core.Nothing,
                dataBoostEnabled = Core.Nothing,
                directedReadOptions = Core.Nothing, index = Core.Nothing,
                keySet = Core.Nothing, limit = Core.Nothing,
                lockHint = Core.Nothing, orderBy = Core.Nothing,
                partitionToken = Core.Nothing, requestOptions = Core.Nothing,
                resumeToken = Core.Nothing, table = Core.Nothing,
                transaction = Core.Nothing}
instance Core.FromJSON ReadRequest where
        parseJSON
          = Core.withObject "ReadRequest"
              (\ o ->
                 ReadRequest Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "dataBoostEnabled")
...
newReadWrite 
    ::  ReadWrite
newReadWrite
  = ReadWrite{multiplexedSessionPreviousTransactionId = Core.Nothing,
...
instance Core.FromJSON ReadWrite where
        parseJSON
          = Core.withObject "ReadWrite"
              (\ o ->
                 ReadWrite Core.<$>
                   (o Core..:? "multiplexedSessionPreviousTransactionId") Core.<*>
                     (o Core..:? "readLockMode"))
...
instance Core.ToJSON ReadWrite where
        toJSON ReadWrite{..}
          = Core.object
              (Core.catMaybes
                 [("multiplexedSessionPreviousTransactionId" Core..=) Core.<$>
...
newReplicaComputeCapacity 
    ::  ReplicaComputeCapacity
newReplicaComputeCapacity
  = ReplicaComputeCapacity{nodeCount = Core.Nothing,
                           processingUnits = Core.Nothing, replicaSelection = Core.Nothing}
instance Core.FromJSON ReplicaComputeCapacity where
        parseJSON
          = Core.withObject "ReplicaComputeCapacity"
              (\ o ->
                 ReplicaComputeCapacity Core.<$>
                   (o Core..:? "nodeCount") Core.<*> (o Core..:? "processingUnits")
...
newReplicaInfo 
    ::  ReplicaInfo
newReplicaInfo
  = ReplicaInfo{defaultLeaderLocation = Core.Nothing,
                location = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON ReplicaInfo where
        parseJSON
          = Core.withObject "ReplicaInfo"
              (\ o ->
                 ReplicaInfo Core.<$>
                   (o Core..:? "defaultLeaderLocation") Core.<*>
                     (o Core..:? "location")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON ReplicaSelection where
        parseJSON
          = Core.withObject "ReplicaSelection"
              (\ o ->
                 ReplicaSelection Core.<$>
                   (o Core..:? "location") Core.<*> (o Core..:? "type"))
...
data RequestOptions = RequestOptions
    {
      ...
      -- | A per-request tag which can be applied to queries or reads, used for statistics collection. Both @request_tag@ and @transaction_tag@ can be specified for a read or query that belongs to a transaction. This field is ignored for requests where it\'s not applicable (for example, @CommitRequest@). Legal characters for @request_tag@ values are all printable characters (ASCII 32 - 126) and the length of a request/tag is limited to 50 characters. Values that exceed this limit are truncated. Any leading underscore (/) characters are removed from the string.
    , requestTag :: (Core.Maybe Core.Text)
      -- | A tag used for statistics collection about this transaction. Both @request_tag@ and @transaction_tag@ can be specified for a read or query that belongs to a transaction. The value of transaction/tag should be the same for all requests belonging to the same transaction. If this request doesn\'t belong to any transaction, @transaction_tag@ is ignored. Legal characters for @transaction_tag@ values are all printable characters (ASCII 32 - 126) and the length of a @transaction_tag@ is limited to 50 characters. Values that exceed this limit are truncated. Any leading underscore (/) characters are removed from the string.
...
newRequestOptions 
    ::  RequestOptions
newRequestOptions
  = RequestOptions{priority = Core.Nothing,
                   requestTag = Core.Nothing, transactionTag = Core.Nothing}
instance Core.FromJSON RequestOptions where
        parseJSON
          = Core.withObject "RequestOptions"
              (\ o ->
                 RequestOptions Core.<$>
                   (o Core..:? "priority") Core.<*> (o Core..:? "requestTag") Core.<*>
                     (o Core..:? "transactionTag"))
...
newRestoreDatabaseEncryptionConfig 
    :: 
                                   RestoreDatabaseEncryptionConfig
newRestoreDatabaseEncryptionConfig
  = RestoreDatabaseEncryptionConfig{encryptionType = Core.Nothing,
                                    kmsKeyName = Core.Nothing, kmsKeyNames = Core.Nothing}
instance Core.FromJSON RestoreDatabaseEncryptionConfig where
        parseJSON
          = Core.withObject "RestoreDatabaseEncryptionConfig"
              (\ o ->
                 RestoreDatabaseEncryptionConfig Core.<$>
                   (o Core..:? "encryptionType") Core.<*> (o Core..:? "kmsKeyName")
                     Core.<*> (o Core..:? "kmsKeyNames"))
...
newRestoreDatabaseMetadata 
    ::  RestoreDatabaseMetadata
newRestoreDatabaseMetadata
  = RestoreDatabaseMetadata{backupInfo = Core.Nothing,
                            cancelTime = Core.Nothing, name = Core.Nothing,
                            optimizeDatabaseOperationName = Core.Nothing,
                            progress = Core.Nothing, sourceType = Core.Nothing}
instance Core.FromJSON RestoreDatabaseMetadata where
        parseJSON
          = Core.withObject "RestoreDatabaseMetadata"
              (\ o ->
                 RestoreDatabaseMetadata Core.<$>
                   (o Core..:? "backupInfo") Core.<*> (o Core..:? "cancelTime")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("backupInfo" Core..=) Core.<$> backupInfo,
                  ("cancelTime" Core..=) Core.<$> cancelTime,
                  ("name" Core..=) Core.<$> name,
                  ("optimizeDatabaseOperationName" Core..=) Core.<$>
...
newRestoreDatabaseRequest 
    ::  RestoreDatabaseRequest
newRestoreDatabaseRequest
  = RestoreDatabaseRequest{backup = Core.Nothing,
                           databaseId = Core.Nothing, encryptionConfig = Core.Nothing}
instance Core.FromJSON RestoreDatabaseRequest where
        parseJSON
          = Core.withObject "RestoreDatabaseRequest"
              (\ o ->
                 RestoreDatabaseRequest Core.<$>
                   (o Core..:? "backup") Core.<*> (o Core..:? "databaseId") Core.<*>
                     (o Core..:? "encryptionConfig"))
...
instance Core.FromJSON RestoreInfo where
        parseJSON
          = Core.withObject "RestoreInfo"
              (\ o ->
                 RestoreInfo Core.<$>
                   (o Core..:? "backupInfo") Core.<*> (o Core..:? "sourceType"))
...
newResultSet 
    ::  ResultSet
newResultSet
  = ResultSet{metadata = Core.Nothing, precommitToken = Core.Nothing,
              rows = Core.Nothing, stats = Core.Nothing}
instance Core.FromJSON ResultSet where
        parseJSON
          = Core.withObject "ResultSet"
              (\ o ->
                 ResultSet Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "precommitToken")
                     Core.<*> (o Core..:? "rows")
                     Core.<*> (o Core..:? "stats"))
        ...
        toJSON ResultSet{..}
          = Core.object
              (Core.catMaybes
                 [("metadata" Core..=) Core.<$> metadata,
                  ("precommitToken" Core..=) Core.<$> precommitToken,
                  ("rows" Core..=) Core.<$> rows, ("stats" Core..=) Core.<$> stats])
...
newResultSetMetadata 
    ::  ResultSetMetadata
newResultSetMetadata
  = ResultSetMetadata{rowType = Core.Nothing,
                      transaction = Core.Nothing, undeclaredParameters = Core.Nothing}
instance Core.FromJSON ResultSetMetadata where
        parseJSON
          = Core.withObject "ResultSetMetadata"
              (\ o ->
                 ResultSetMetadata Core.<$>
                   (o Core..:? "rowType") Core.<*> (o Core..:? "transaction") Core.<*>
                     (o Core..:? "undeclaredParameters"))
...
newResultSetStats 
    ::  ResultSetStats
newResultSetStats
  = ResultSetStats{queryPlan = Core.Nothing,
                   queryStats = Core.Nothing, rowCountExact = Core.Nothing,
                   rowCountLowerBound = Core.Nothing}
instance Core.FromJSON ResultSetStats where
        parseJSON
          = Core.withObject "ResultSetStats"
              (\ o ->
                 ResultSetStats Core.<$>
                   (o Core..:? "queryPlan") Core.<*> (o Core..:? "queryStats")
                     Core.<*>
                     (o Core..:? "rowCountExact" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "rowCountLowerBound" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("queryPlan" Core..=) Core.<$> queryPlan,
                  ...
                  ("rowCountExact" Core..=) Core.. Core.AsText Core.<$>
                    rowCountExact,
                  ("rowCountLowerBound" Core..=) Core.. Core.AsText Core.<$>
                    rowCountLowerBound])
...
instance Core.FromJSON ResultSetStats_QueryStats where
        parseJSON
          = Core.withObject "ResultSetStats_QueryStats"
              (\ o ->
...
newScan 
    ::  Scan
newScan
  = Scan{details = Core.Nothing, endTime = Core.Nothing,
         name = Core.Nothing, scanData = Core.Nothing,
         startTime = Core.Nothing}
instance Core.FromJSON Scan where
        parseJSON
          = Core.withObject "Scan"
              (\ o ->
                 Scan Core.<$>
                   (o Core..:? "details") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "name")
...
newScanData 
    ::  ScanData
newScanData
  = ScanData{data' = Core.Nothing, endTime = Core.Nothing,
             startTime = Core.Nothing}
instance Core.FromJSON ScanData where
        parseJSON
          = Core.withObject "ScanData"
              (\ o ->
                 ScanData Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "startTime"))
...
newSession 
    ::  Session
newSession
  = Session{approximateLastUseTime = Core.Nothing,
            createTime = Core.Nothing, creatorRole = Core.Nothing,
            labels = Core.Nothing, multiplexed = Core.Nothing,
            name = Core.Nothing}
instance Core.FromJSON Session where
        parseJSON
          = Core.withObject "Session"
              (\ o ->
                 Session Core.<$>
                   (o Core..:? "approximateLastUseTime") Core.<*>
                     (o Core..:? "createTime")
...
instance Core.ToJSON Session where
        toJSON Session{..}
          = Core.object
              (Core.catMaybes
                 [("approximateLastUseTime" Core..=) Core.<$>
...
newShortRepresentation 
    ::  ShortRepresentation
newShortRepresentation
  = ShortRepresentation{description = Core.Nothing,
                        subqueries = Core.Nothing}
instance Core.FromJSON ShortRepresentation where
        parseJSON
          = Core.withObject "ShortRepresentation"
              (\ o ->
                 ShortRepresentation Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "subqueries"))
...
instance Core.FromJSON ShortRepresentation_Subqueries where
        parseJSON
          = Core.withObject "ShortRepresentation_Subqueries"
              (\ o ->
...
instance Core.FromJSON SingleRegionQuorum where
        parseJSON
          = Core.withObject "SingleRegionQuorum"
...
newSplitPoints 
    ::  SplitPoints
newSplitPoints
  = SplitPoints{expireTime = Core.Nothing, index = Core.Nothing,
                keys = Core.Nothing, table = Core.Nothing}
instance Core.FromJSON SplitPoints where
        parseJSON
          = Core.withObject "SplitPoints"
              (\ o ->
                 SplitPoints Core.<$>
                   (o Core..:? "expireTime") Core.<*> (o Core..:? "index") Core.<*>
                     (o Core..:? "keys")
                     Core.<*> (o Core..:? "table"))
...
instance Core.ToJSON SplitPoints where
        toJSON SplitPoints{..}
          = Core.object
              (Core.catMaybes
                 [("expireTime" Core..=) Core.<$> expireTime,
                  ("index" Core..=) Core.<$> index, ("keys" Core..=) Core.<$> keys,
                  ("table" Core..=) Core.<$> table])
...
newStatement 
    ::  Statement
newStatement
  = Statement{paramTypes = Core.Nothing, params = Core.Nothing,
              sql = Core.Nothing}
...
instance Core.ToJSON Statement where
        toJSON Statement{..}
          = Core.object
              (Core.catMaybes
                 [("paramTypes" Core..=) Core.<$> paramTypes,
                  ("params" Core..=) Core.<$> params, ("sql" Core..=) Core.<$> sql])
...
instance Core.FromJSON Statement_ParamTypes where
        parseJSON
          = Core.withObject "Statement_ParamTypes"
...
instance Core.FromJSON Statement_Params where
        parseJSON
          = Core.withObject "Statement_Params"
...
newTransaction 
    ::  Transaction
newTransaction
  = Transaction{id = Core.Nothing, precommitToken = Core.Nothing,
                readTimestamp = Core.Nothing}
instance Core.FromJSON Transaction where
        parseJSON
          = Core.withObject "Transaction"
              (\ o ->
                 Transaction Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "precommitToken") Core.<*>
                     (o Core..:? "readTimestamp"))
...
-- | Transactions: Each session can have at most one active transaction at a time (note that standalone reads and queries use a transaction internally and do count towards the one transaction limit). After the active transaction is completed, the session can immediately be re-used for the next transaction. It is not necessary to create a new session for each transaction. Transaction modes: Cloud Spanner supports three transaction modes: 1. Locking read-write. This type of transaction is the only way to write data into Cloud Spanner. These transactions rely on pessimistic locking and, if necessary, two-phase commit. Locking read-write transactions may abort, requiring the application to retry. 2. Snapshot read-only. Snapshot read-only transactions provide guaranteed consistency across several reads, but do not allow writes. Snapshot read-only transactions can be configured to read at timestamps in the past, or configured to perform a strong read (where Spanner selects a timestamp such that the read is guaranteed to
...
-- database. They may, however, read-write data in different tables within that database. Locking read-write transactions: Locking transactions may be used to atomically read-modify-write data anywhere in a database. This type of transaction is externally consistent. Clients should attempt to minimize the amount of time a transaction is active. Faster transactions commit with higher probability and cause less contention. Cloud Spanner attempts to keep read locks active as long as the transaction continues to do reads, and the transaction has not been terminated by Commit or Rollback. Long periods of inactivity at the client may cause Cloud Spanner to release a transaction\'s locks and abort it. Conceptually, a read-write transaction consists of zero or more reads or SQL statements followed by Commit. At any time before Commit, the client can send a Rollback request to abort the transaction. Semantics: Cloud Spanner can commit the transaction if all read locks it acquired are still valid at commit time, and it is
-- able to acquire write locks for all writes. Cloud Spanner can abort the transaction for any reason. If a commit attempt returns @ABORTED@, Cloud Spanner guarantees that the transaction has not modified any user data in Cloud Spanner. Unless the transaction commits, Cloud Spanner makes no guarantees about how long the transaction\'s locks were held for. It is an error to use Cloud Spanner locks for any sort of mutual exclusion other than between Cloud Spanner transactions themselves. Retrying aborted transactions: When a transaction aborts, the application can choose to retry the whole transaction again. To maximize the chances of successfully committing the retry, the client should execute the retry in the same session as the original attempt. The original session\'s lock priority increases with each consecutive abort, meaning that each attempt has a slightly better chance of success than the previous. Note that the lock priority is preserved per session (not per transaction). Lock priority is set by the
-- first read or write in the first attempt of a read-write transaction. If the application starts a new session to retry the whole transaction, the transaction loses its original lock priority. Moreover, the lock priority is only preserved if the transaction fails with an @ABORTED@ error. Under some circumstances (for example, many transactions attempting to modify the same row(s)), a transaction can abort many times in a short period before successfully committing. Thus, it is not a good idea to cap the number of retries a transaction can attempt; instead, it is better to limit the total amount of time spent retrying. Idle transactions: A transaction is considered idle if it has no outstanding reads or SQL queries and has not started a read or SQL query within the last 10 seconds. Idle transactions can be aborted by Cloud Spanner so that they don\'t hold on to locks indefinitely. If an idle transaction is aborted, the commit fails with error @ABORTED@. If this behavior is undesirable, periodically executing a
-- simple SQL query in the transaction (for example, @SELECT 1@) prevents the transaction from becoming idle. Snapshot read-only transactions: Snapshot read-only transactions provides a simpler method than locking read-write transactions for doing several consistent reads. However, this type of transaction does not support writes. Snapshot transactions do not take locks. Instead, they work by choosing a Cloud Spanner timestamp, then executing all reads at that timestamp. Since they do not acquire locks, they do not block concurrent read-write transactions. Unlike locking read-write transactions, snapshot read-only transactions never abort. They can fail if the chosen read timestamp is garbage collected; however, the default garbage collection policy is generous enough that most applications do not need to worry about this in practice. Snapshot read-only transactions do not need to call Commit or Rollback (and in fact are not permitted to do so). To execute a snapshot transaction, the client specifies a timestamp
-- bound, which tells Cloud Spanner how to choose a read timestamp. The types of timestamp bound are: - Strong (the default). - Bounded staleness. - Exact staleness. If the Cloud Spanner database to be read is geographically distributed, stale read-only transactions can execute more quickly than strong or read-write transactions, because they are able to execute far from the leader replica. Each type of timestamp bound is discussed in detail below. Strong: Strong reads are guaranteed to see the effects of all transactions that have committed before the start of the read. Furthermore, all rows yielded by a single read are consistent with each other -- if any part of the read observes a transaction, all parts of the read see the transaction. Strong reads are not repeatable: two consecutive strong read-only transactions might return inconsistent results if there are concurrent writes. If consistency across reads is required, the reads should be executed within a transaction or at an exact read timestamp. Queries on
...
data TransactionOptions = TransactionOptions
    ...
    , isolationLevel :: (Core.Maybe TransactionOptions_IsolationLevel)
...
newTransactionOptions 
    ::  TransactionOptions
newTransactionOptions
  = TransactionOptions{excludeTxnFromChangeStreams = Core.Nothing,
                       isolationLevel = Core.Nothing, partitionedDml = Core.Nothing,
                       readOnly = Core.Nothing, readWrite = Core.Nothing}
        ...
        toJSON TransactionOptions{..}
          = Core.object
              (Core.catMaybes
                 [("excludeTxnFromChangeStreams" Core..=) Core.<$>
                    excludeTxnFromChangeStreams,
                  ("isolationLevel" Core..=) Core.<$> isolationLevel,
...
newTransactionSelector 
    ::  TransactionSelector
newTransactionSelector
  = TransactionSelector{begin = Core.Nothing, id = Core.Nothing,
                        singleUse = Core.Nothing}
instance Core.FromJSON TransactionSelector where
        parseJSON
          = Core.withObject "TransactionSelector"
              (\ o ->
                 TransactionSelector Core.<$>
                   (o Core..:? "begin") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "singleUse"))
...
instance Core.ToJSON TransactionSelector where
        toJSON TransactionSelector{..}
          = Core.object
              (Core.catMaybes
                 [("begin" Core..=) Core.<$> begin, ("id" Core..=) Core.<$> id,
...
newType 
    ::  Type
newType
  = Type{arrayElementType = Core.Nothing, code = Core.Nothing,
         protoTypeFqn = Core.Nothing, structType = Core.Nothing,
...
instance Core.FromJSON Type where
        parseJSON
          = Core.withObject "Type"
              (\ o ->
                 Type Core.<$>
                   (o Core..:? "arrayElementType") Core.<*> (o Core..:? "code")
...
newUpdateDatabaseDdlMetadata 
    ::  UpdateDatabaseDdlMetadata
newUpdateDatabaseDdlMetadata
  = UpdateDatabaseDdlMetadata{actions = Core.Nothing,
                              commitTimestamps = Core.Nothing, database = Core.Nothing,
                              progress = Core.Nothing, statements = Core.Nothing,
                              throttled = Core.Nothing}
instance Core.FromJSON UpdateDatabaseDdlMetadata where
        parseJSON
          = Core.withObject "UpdateDatabaseDdlMetadata"
              (\ o ->
                 UpdateDatabaseDdlMetadata Core.<$>
                   (o Core..:? "actions") Core.<*> (o Core..:? "commitTimestamps")
                     Core.<*> (o Core..:? "database")
                     Core.<*> (o Core..:? "progress")
                     Core.<*> (o Core..:? "statements")
...
newUpdateDatabaseDdlRequest 
    ::  UpdateDatabaseDdlRequest
newUpdateDatabaseDdlRequest
  = UpdateDatabaseDdlRequest{operationId = Core.Nothing,
                             protoDescriptors = Core.Nothing, statements = Core.Nothing}
instance Core.FromJSON UpdateDatabaseDdlRequest where
        parseJSON
          = Core.withObject "UpdateDatabaseDdlRequest"
              (\ o ->
                 UpdateDatabaseDdlRequest Core.<$>
                   (o Core..:? "operationId") Core.<*> (o Core..:? "protoDescriptors")
                     Core.<*> (o Core..:? "statements"))
...
newUpdateDatabaseMetadata 
    ::  UpdateDatabaseMetadata
newUpdateDatabaseMetadata
  = UpdateDatabaseMetadata{cancelTime = Core.Nothing,
                           progress = Core.Nothing, request' = Core.Nothing}
instance Core.FromJSON UpdateDatabaseMetadata where
        parseJSON
          = Core.withObject "UpdateDatabaseMetadata"
              (\ o ->
                 UpdateDatabaseMetadata Core.<$>
                   (o Core..:? "cancelTime") Core.<*> (o Core..:? "progress") Core.<*>
                     (o Core..:? "request"))
...
newUpdateDatabaseRequest 
    ::  UpdateDatabaseRequest
newUpdateDatabaseRequest
  = UpdateDatabaseRequest{database = Core.Nothing,
                          updateMask = Core.Nothing}
instance Core.FromJSON UpdateDatabaseRequest where
        parseJSON
          = Core.withObject "UpdateDatabaseRequest"
              (\ o ->
                 UpdateDatabaseRequest Core.<$>
                   (o Core..:? "database") Core.<*> (o Core..:? "updateMask"))
...
newUpdateInstanceConfigMetadata 
    ::  UpdateInstanceConfigMetadata
newUpdateInstanceConfigMetadata
  = UpdateInstanceConfigMetadata{cancelTime = Core.Nothing,
                                 instanceConfig = Core.Nothing, progress = Core.Nothing}
instance Core.FromJSON UpdateInstanceConfigMetadata where
        parseJSON
          = Core.withObject "UpdateInstanceConfigMetadata"
              (\ o ->
                 UpdateInstanceConfigMetadata Core.<$>
                   (o Core..:? "cancelTime") Core.<*> (o Core..:? "instanceConfig")
                     Core.<*> (o Core..:? "progress"))
...
newUpdateInstanceConfigRequest 
    ::  UpdateInstanceConfigRequest
newUpdateInstanceConfigRequest
  = UpdateInstanceConfigRequest{instanceConfig = Core.Nothing,
                                updateMask = Core.Nothing, validateOnly = Core.Nothing}
instance Core.FromJSON UpdateInstanceConfigRequest where
        parseJSON
          = Core.withObject "UpdateInstanceConfigRequest"
              (\ o ->
                 UpdateInstanceConfigRequest Core.<$>
                   (o Core..:? "instanceConfig") Core.<*> (o Core..:? "updateMask")
                     Core.<*> (o Core..:? "validateOnly"))
...
newUpdateInstanceMetadata 
    ::  UpdateInstanceMetadata
newUpdateInstanceMetadata
  = UpdateInstanceMetadata{cancelTime = Core.Nothing,
                           endTime = Core.Nothing, expectedFulfillmentPeriod = Core.Nothing,
                           instance' = Core.Nothing, startTime = Core.Nothing}
...
newUpdateInstancePartitionMetadata 
    :: 
                                   UpdateInstancePartitionMetadata
newUpdateInstancePartitionMetadata
  = UpdateInstancePartitionMetadata{cancelTime = Core.Nothing,
                                    endTime = Core.Nothing, instancePartition = Core.Nothing,
                                    startTime = Core.Nothing}
instance Core.FromJSON UpdateInstancePartitionMetadata where
        parseJSON
          = Core.withObject "UpdateInstancePartitionMetadata"
              (\ o ->
                 UpdateInstancePartitionMetadata Core.<$>
                   (o Core..:? "cancelTime") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "instancePartition")
                     Core.<*> (o Core..:? "startTime"))
...
newUpdateInstancePartitionRequest 
    ::  UpdateInstancePartitionRequest
newUpdateInstancePartitionRequest
  = UpdateInstancePartitionRequest{fieldMask = Core.Nothing,
                                   instancePartition = Core.Nothing}
instance Core.FromJSON UpdateInstancePartitionRequest where
        parseJSON
          = Core.withObject "UpdateInstancePartitionRequest"
              (\ o ->
                 UpdateInstancePartitionRequest Core.<$>
                   (o Core..:? "fieldMask") Core.<*> (o Core..:? "instancePartition"))
...
newUpdateInstanceRequest 
    ::  UpdateInstanceRequest
newUpdateInstanceRequest
  = UpdateInstanceRequest{fieldMask = Core.Nothing,
                          instance' = Core.Nothing}
instance Core.FromJSON UpdateInstanceRequest where
        parseJSON
          = Core.withObject "UpdateInstanceRequest"
              (\ o ->
                 UpdateInstanceRequest Core.<$>
                   (o Core..:? "fieldMask") Core.<*> (o Core..:? "instance"))
...
newVisualizationData 
    ::  VisualizationData
newVisualizationData
  = VisualizationData{dataSourceEndToken = Core.Nothing,
                      dataSourceSeparatorToken = Core.Nothing,
                      diagnosticMessages = Core.Nothing, endKeyStrings = Core.Nothing,
                      hasPii = Core.Nothing, indexedKeys = Core.Nothing,
                      keySeparator = Core.Nothing, keyUnit = Core.Nothing,
                      metrics = Core.Nothing, prefixNodes = Core.Nothing}
instance Core.FromJSON VisualizationData where
        parseJSON
          = Core.withObject "VisualizationData"
              (\ o ->
                 VisualizationData Core.<$>
                   (o Core..:? "dataSourceEndToken") Core.<*>
                     (o Core..:? "dataSourceSeparatorToken")
          ...
          = Core.object
              (Core.catMaybes
                 [("dataSourceEndToken" Core..=) Core.<$> dataSourceEndToken,
                  ("dataSourceSeparatorToken" Core..=) Core.<$>
...
newWrite 
    ::  Write
newWrite
  = Write{columns = Core.Nothing, table = Core.Nothing,
          values = Core.Nothing}
instance Core.FromJSON Write where
        parseJSON
          = Core.withObject "Write"
              (\ o ->
                 Write Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "table") Core.<*>
                     (o Core..:? "values"))
