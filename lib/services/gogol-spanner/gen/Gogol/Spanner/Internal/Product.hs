          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("referencingBackups" Core..=) Core.<$>
                    referencingBackups,
                  ("referencingDatabases" Core..=) Core.<$>
...
newBatchCreateSessionsRequest =
  BatchCreateSessionsRequest
    {sessionCount = Core.Nothing, sessionTemplate = Core.Nothing}

instance Core.FromJSON BatchCreateSessionsRequest
         where
        parseJSON
...
instance Core.FromJSON BatchCreateSessionsResponse
         where
        parseJSON
          = Core.withObject "BatchCreateSessionsResponse"
              (\ o ->
                 BatchCreateSessionsResponse Core.<$>
                   (o Core..:? "session"))

instance Core.ToJSON BatchCreateSessionsResponse
         where
...
newChildLink =
  ChildLink
    {childIndex = Core.Nothing, type' = Core.Nothing, variable = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("mutations" Core..=) Core.<$> mutations,
                  ("requestOptions" Core..=) Core.<$> requestOptions,
                  ("returnCommitStats" Core..=) Core.<$>
                    returnCommitStats,
                  ("singleUseTransaction" Core..=) Core.<$>
...
instance Core.FromJSON CommitResponse where
        parseJSON
          = Core.withObject "CommitResponse"
              (\ o ->
                 CommitResponse Core.<$>
                   (o Core..:? "commitStats") Core.<*>
                     (o Core..:? "commitTimestamp"))
...
instance Core.FromJSON ContextValue where
        parseJSON
          = Core.withObject "ContextValue"
              (\ o ->
                 ContextValue Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "severity")
                     Core.<*> (o Core..:? "unit")
                     Core.<*> (o Core..:? "value"))
...
newCopyBackupEncryptionConfig =
  CopyBackupEncryptionConfig
    {encryptionType = Core.Nothing, kmsKeyName = Core.Nothing}

instance Core.FromJSON CopyBackupEncryptionConfig
         where
        parseJSON
...
instance Core.ToJSON CreateDatabaseRequest where
        toJSON CreateDatabaseRequest{..}
          = Core.object
              (Core.catMaybes
                 [("createStatement" Core..=) Core.<$>
                    createStatement,
                  ("databaseDialect" Core..=) Core.<$> databaseDialect,
                  ("encryptionConfig" Core..=) Core.<$>
                    encryptionConfig,
                  ("extraStatements" Core..=) Core.<$> extraStatements,
                  ("protoDescriptors" Core..=) Core.<$>
                    protoDescriptors])
...
instance Core.FromJSON CreateInstanceConfigMetadata
         where
        parseJSON
          = Core.withObject "CreateInstanceConfigMetadata"
              (\ o ->
                 CreateInstanceConfigMetadata Core.<$>
                   (o Core..:? "cancelTime") Core.<*>
                     (o Core..:? "instanceConfig")
                     Core.<*> (o Core..:? "progress"))

instance Core.ToJSON CreateInstanceConfigMetadata
         where
...
instance Core.FromJSON CreateInstanceConfigRequest
         where
        parseJSON
...
instance Core.ToJSON CreateInstanceConfigRequest
         where
        toJSON CreateInstanceConfigRequest{..}
          = Core.object
              (Core.catMaybes
                 [("instanceConfig" Core..=) Core.<$> instanceConfig,
                  ("instanceConfigId" Core..=) Core.<$>
                    instanceConfigId,
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("earliestVersionTime" Core..=) Core.<$>
                    earliestVersionTime,
                  ("enableDropProtection" Core..=) Core.<$>
          ...
          = Core.withObject "DiagnosticMessage"
              (\ o ->
                 DiagnosticMessage Core.<$>
                   (o Core..:? "info") Core.<*> (o Core..:? "metric")
...
instance Core.FromJSON ExecuteSqlRequest_ParamTypes
         where
        parseJSON
          = Core.withObject "ExecuteSqlRequest_ParamTypes"
              (\ o ->
                 ExecuteSqlRequest_ParamTypes Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ExecuteSqlRequest_ParamTypes
         where
...
instance Core.FromJSON IndexedHotKey_SparseHotKeys
         where
        parseJSON
          = Core.withObject "IndexedHotKey_SparseHotKeys"
              (\ o ->
                 IndexedHotKey_SparseHotKeys Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON IndexedHotKey_SparseHotKeys
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("config" Core..=) Core.<$> config,
                  ...
                  ("freeInstanceMetadata" Core..=) Core.<$>
                    freeInstanceMetadata,
...
instance Core.FromJSON InstanceOperationProgress
         where
        parseJSON
...
instance Core.FromJSON KeyRangeInfo where
        parseJSON
          = Core.withObject "KeyRangeInfo"
              (\ o ->
                 KeyRangeInfo Core.<$>
                   (o Core..:? "contextValues") Core.<*>
                     (o Core..:? "endKeyIndex")
                     Core.<*> (o Core..:? "info")
                     Core.<*>
                     (o Core..:? "keysCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "metric")
          ...
          = Core.object
              (Core.catMaybes
                 [("contextValues" Core..=) Core.<$> contextValues,
                  ...
                  ("info" Core..=) Core.<$> info,
                  ("keysCount" Core..=) Core.. Core.AsText Core.<$>
                    keysCount,
                  ("metric" Core..=) Core.<$> metric,
...
instance Core.FromJSON ListBackupOperationsResponse
         where
        parseJSON
...
instance Core.ToJSON ListBackupOperationsResponse
         where
...
instance Core.FromJSON ListDatabaseOperationsResponse
         where
        parseJSON
...
instance Core.ToJSON ListDatabaseOperationsResponse
         where
...
newListDatabaseRolesResponse =
  ListDatabaseRolesResponse
    {databaseRoles = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListDatabaseRolesResponse
         where
        parseJSON
          = Core.withObject "ListDatabaseRolesResponse"
              (\ o ->
                 ListDatabaseRolesResponse Core.<$>
                   (o Core..:? "databaseRoles") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListInstanceConfigsResponse =
  ListInstanceConfigsResponse
    {instanceConfigs = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListInstanceConfigsResponse
         where
        parseJSON
...
instance Core.ToJSON ListInstanceConfigsResponse
         where
        toJSON ListInstanceConfigsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("instanceConfigs" Core..=) Core.<$>
                    instanceConfigs,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newLocalizedString =
  LocalizedString
    {args = Core.Nothing, message = Core.Nothing, token = Core.Nothing}
          ...
          = Core.withObject "LocalizedString"
              (\ o ->
                 LocalizedString Core.<$>
                   (o Core..:? "args") Core.<*> (o Core..:? "message")
                     Core.<*> (o Core..:? "token"))
          ...
          = Core.object
              (Core.catMaybes
                 [("aggregation" Core..=) Core.<$> aggregation,
                  ...
                  ("indexedKeyRangeInfos" Core..=) Core.<$>
                    indexedKeyRangeInfos,
                  ("info" Core..=) Core.<$> info,
...
instance Core.FromJSON Metric_IndexedKeyRangeInfos
         where
        parseJSON
          = Core.withObject "Metric_IndexedKeyRangeInfos"
              (\ o ->
                 Metric_IndexedKeyRangeInfos Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Metric_IndexedKeyRangeInfos
         where
...
instance Core.FromJSON Mutation where
        parseJSON
          = Core.withObject "Mutation"
              (\ o ->
                 Mutation Core.<$>
                   (o Core..:? "delete") Core.<*> (o Core..:? "insert")
...
instance Core.ToJSON OptimizeRestoredDatabaseMetadata
         where
...
newPartitionOptions =
  PartitionOptions
    {maxPartitions = Core.Nothing, partitionSizeBytes = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "PartitionQueryRequest_ParamTypes"
              (\ o ->
                 PartitionQueryRequest_ParamTypes Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON PartitionQueryRequest_ParamTypes
         where
...
instance Core.FromJSON PartitionQueryRequest_Params
         where
        parseJSON
          = Core.withObject "PartitionQueryRequest_Params"
              (\ o ->
                 PartitionQueryRequest_Params Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON PartitionQueryRequest_Params
         where
          ...
          = Core.withObject "PartitionReadRequest"
              (\ o ->
                 PartitionReadRequest Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "index")
                     Core.<*> (o Core..:? "keySet")
                     Core.<*> (o Core..:? "partitionOptions")
                     Core.<*> (o Core..:? "table")
                     Core.<*> (o Core..:? "transaction"))
...
newPlanNode_Metadata 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. See 'additional'.
    -> PlanNode_Metadata
newPlanNode_Metadata additional = PlanNode_Metadata {additional = additional}
...
newQueryOptions =
  QueryOptions
    {optimizerStatisticsPackage = Core.Nothing, optimizerVersion = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("exactStaleness" Core..=) Core.<$> exactStaleness,
                  ...
                  ("minReadTimestamp" Core..=) Core.<$>
                    minReadTimestamp,
                  ("readTimestamp" Core..=) Core.<$> readTimestamp,
                  ("returnReadTimestamp" Core..=) Core.<$>
                    returnReadTimestamp,
...
instance Core.ToJSON ReplicaInfo where
        toJSON ReplicaInfo{..}
          = Core.object
              (Core.catMaybes
                 [("defaultLeaderLocation" Core..=) Core.<$>
...
instance Core.ToJSON RestoreDatabaseEncryptionConfig
         where
...
instance Core.FromJSON ResultSet where
        parseJSON
          = Core.withObject "ResultSet"
              (\ o ->
                 ResultSet Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "rows")
                     Core.<*> (o Core..:? "stats"))
          ...
          = Core.object
              (Core.catMaybes
                 [("rowType" Core..=) Core.<$> rowType,
                  ("transaction" Core..=) Core.<$> transaction,
                  ("undeclaredParameters" Core..=) Core.<$>
...
instance Core.FromJSON ResultSetStats where
        parseJSON
          = Core.withObject "ResultSetStats"
              (\ o ->
                 ResultSetStats Core.<$>
                   (o Core..:? "queryPlan") Core.<*>
                     (o Core..:? "queryStats")
                     Core.<*>
                     (o Core..:? "rowCountExact" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.FromJSON ResultSetStats_QueryStats
         where
        parseJSON
          = Core.withObject "ResultSetStats_QueryStats"
              (\ o ->
                 ResultSetStats_QueryStats Core.<$>
                   (Core.parseJSONObject o))
...
newScanData =
  ScanData
    {data' = Core.Nothing, endTime = Core.Nothing, startTime = Core.Nothing}
...
instance Core.FromJSON ScanData where
        parseJSON
          = Core.withObject "ScanData"
              (\ o ->
                 ScanData Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "endTime")
                     Core.<*> (o Core..:? "startTime"))
...
newSession_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Session_Labels
newSession_Labels additional = Session_Labels {additional = additional}
...
instance Core.FromJSON ShortRepresentation_Subqueries
         where
        parseJSON
          = Core.withObject "ShortRepresentation_Subqueries"
              (\ o ->
                 ShortRepresentation_Subqueries Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ShortRepresentation_Subqueries
         where
...
newStatement =
  Statement
    {paramTypes = Core.Nothing, params = Core.Nothing, sql = Core.Nothing}
...
newStatement_Params 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. See 'additional'.
    -> Statement_Params
newStatement_Params additional = Statement_Params {additional = additional}
...
newTransactionSelector =
  TransactionSelector
    {begin = Core.Nothing, id = Core.Nothing, singleUse = Core.Nothing}
...
instance Core.FromJSON UpdateDatabaseDdlMetadata
         where
        parseJSON
          = Core.withObject "UpdateDatabaseDdlMetadata"
              (\ o ->
                 UpdateDatabaseDdlMetadata Core.<$>
                   (o Core..:? "commitTimestamps") Core.<*>
                     (o Core..:? "database")
                     Core.<*> (o Core..:? "progress")
                     Core.<*> (o Core..:? "statements")
          ...
          = Core.withObject "UpdateDatabaseDdlRequest"
              (\ o ->
                 UpdateDatabaseDdlRequest Core.<$>
                   (o Core..:? "operationId") Core.<*>
                     (o Core..:? "protoDescriptors")
                     Core.<*> (o Core..:? "statements"))
...
newUpdateDatabaseRequest 
    ::  UpdateDatabaseRequest
newUpdateDatabaseRequest =
  UpdateDatabaseRequest {database = Core.Nothing, updateMask = Core.Nothing}
...
instance Core.FromJSON UpdateInstanceConfigMetadata
         where
        parseJSON
...
instance Core.ToJSON UpdateInstanceConfigMetadata
         where
...
instance Core.FromJSON UpdateInstanceConfigRequest
         where
        parseJSON
...
instance Core.ToJSON UpdateInstanceConfigRequest
         where
...
instance Core.FromJSON Write where
        parseJSON
          = Core.withObject "Write"
              (\ o ->
                 Write Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "table")
                     Core.<*> (o Core..:? "values"))
