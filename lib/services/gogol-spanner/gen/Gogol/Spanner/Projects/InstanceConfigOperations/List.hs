...
newSpannerProjectsInstanceConfigOperationsList 
    ::  Core.Text
       -- ^  Required. The project of the instance config operations. Values are of the form @projects\/@. See 'parent'.
    -> SpannerProjectsInstanceConfigOperationsList
...
instance Core.GoogleRequest
           SpannerProjectsInstanceConfigOperationsList
         where
        type Rs SpannerProjectsInstanceConfigOperationsList =
             ListInstanceConfigOperationsResponse
        type Scopes
               SpannerProjectsInstanceConfigOperationsList
