               ...
               Core.QueryParam "backupId" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "encryptionConfig.encryptionType"
                     ...
                     Core.:>
                     Core.QueryParam "encryptionConfig.kmsKeyName" Core.Text Core.:>
                       Core.QueryParams "encryptionConfig.kmsKeyNames" Core.Text Core.:>
...
newSpannerProjectsInstancesBackupsCreate parent payload
  = SpannerProjectsInstancesBackupsCreate{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, backupId = Core.Nothing,
...
instance Core.GoogleRequest SpannerProjectsInstancesBackupsCreate
         where
        type Rs SpannerProjectsInstancesBackupsCreate = Operation
        type Scopes SpannerProjectsInstancesBackupsCreate =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesBackupsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesBackupsCreateResource)
                      Core.mempty
