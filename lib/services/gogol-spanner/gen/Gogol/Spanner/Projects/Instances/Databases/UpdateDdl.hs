                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] UpdateDatabaseDdlRequest Core.:>
...
newSpannerProjectsInstancesDatabasesUpdateDdl database payload
  = SpannerProjectsInstancesDatabasesUpdateDdl{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesUpdateDdl
         where
        type Rs SpannerProjectsInstancesDatabasesUpdateDdl = Operation
        type Scopes SpannerProjectsInstancesDatabasesUpdateDdl =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesDatabasesUpdateDdl{..}
          = go database xgafv accessToken callback uploadType uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesDatabasesUpdateDdlResource)
                      Core.mempty
