...
instance Core.FromJSON ListReposResponse where
        parseJSON
          = Core.withObject "ListReposResponse"
              (\ o ->
                 ListReposResponse Core.<$>
...
newMirrorConfig =
  MirrorConfig
    {deployKeyId = Core.Nothing, url = Core.Nothing, webhookId = Core.Nothing}

instance Core.FromJSON MirrorConfig where
        parseJSON
          = Core.withObject "MirrorConfig"
              (\ o ->
                 MirrorConfig Core.<$>
                   (o Core..:? "deployKeyId") Core.<*>
                     (o Core..:? "url")
...
instance Core.FromJSON ProjectConfig where
        parseJSON
          = Core.withObject "ProjectConfig"
              (\ o ->
                 ProjectConfig Core.<$>
                   (o Core..:? "enablePrivateKeyCheck") Core.<*>
                     (o Core..:? "name")
...
instance Core.ToJSON ProjectConfig where
        toJSON ProjectConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enablePrivateKeyCheck" Core..=) Core.<$>
...
newtype ProjectConfig_PubsubConfigs = ProjectConfig_PubsubConfigs
    {
      -- | 
      additional :: (Core.HashMap Core.Text PubsubConfig)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newProjectConfig_PubsubConfigs 
    ::  Core.HashMap Core.Text PubsubConfig
       -- ^  See 'additional'.
    -> ProjectConfig_PubsubConfigs
newProjectConfig_PubsubConfigs additional =
  ProjectConfig_PubsubConfigs {additional = additional}

instance Core.FromJSON ProjectConfig_PubsubConfigs
         where
        parseJSON
          = Core.withObject "ProjectConfig_PubsubConfigs"
              (\ o ->
                 ProjectConfig_PubsubConfigs Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ProjectConfig_PubsubConfigs
         where
...
instance Core.FromJSON Repo where
        parseJSON
          = Core.withObject "Repo"
              (\ o ->
                 Repo Core.<$>
                   (o Core..:? "mirrorConfig") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "pubsubConfigs")
                     Core.<*>
                     (o Core..:? "size" Core.<&>
...
instance Core.FromJSON SyncRepoMetadata where
        parseJSON
          = Core.withObject "SyncRepoMetadata"
              (\ o ->
                 SyncRepoMetadata Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "startTime")
...
instance Core.FromJSON SyncRepoRequest where
        parseJSON
          = Core.withObject "SyncRepoRequest"
...
newUpdateProjectConfigRequest =
  UpdateProjectConfigRequest
    {projectConfig = Core.Nothing, updateMask = Core.Nothing}

instance Core.FromJSON UpdateProjectConfigRequest
         where
        parseJSON
          = Core.withObject "UpdateProjectConfigRequest"
              (\ o ->
                 UpdateProjectConfigRequest Core.<$>
...
instance Core.FromJSON UpdateRepoRequest where
        parseJSON
          = Core.withObject "UpdateRepoRequest"
              (\ o ->
                 UpdateRepoRequest Core.<$>
                   (o Core..:? "repo") Core.<*>
                     (o Core..:? "updateMask"))
