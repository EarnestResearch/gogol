...
instance Core.FromJSON ExecuteAirflowCommandRequest
         where
        parseJSON
...
instance Core.ToJSON ExecuteAirflowCommandRequest
         where
...
instance Core.FromJSON ExecuteAirflowCommandResponse
         where
        parseJSON
...
instance Core.ToJSON ExecuteAirflowCommandResponse
         where
...
newExitInfo 
    ::  ExitInfo
newExitInfo = ExitInfo {error = Core.Nothing, exitCode = Core.Nothing}
...
newFetchDatabasePropertiesResponse =
  FetchDatabasePropertiesResponse
    { isFailoverReplicaAvailable = Core.Nothing
...
newListEnvironmentsResponse =
  ListEnvironmentsResponse
    {environments = Core.Nothing, nextPageToken = Core.Nothing}
...
newListImageVersionsResponse =
  ListImageVersionsResponse
    {imageVersions = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListImageVersionsResponse
         where
        parseJSON
          = Core.withObject "ListImageVersionsResponse"
              (\ o ->
                 ListImageVersionsResponse Core.<$>
                   (o Core..:? "imageVersions") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newMasterAuthorizedNetworksConfig =
  MasterAuthorizedNetworksConfig
    {cidrBlocks = Core.Nothing, enabled = Core.Nothing}
...
instance Core.FromJSON PollAirflowCommandRequest
         where
        parseJSON
...
newPollAirflowCommandResponse =
  PollAirflowCommandResponse
    {exitInfo = Core.Nothing, output = Core.Nothing, outputEnd = Core.Nothing}

instance Core.FromJSON PollAirflowCommandResponse
         where
        parseJSON
          = Core.withObject "PollAirflowCommandResponse"
              (\ o ->
                 PollAirflowCommandResponse Core.<$>
                   (o Core..:? "exitInfo") Core.<*>
                     (o Core..:? "output")
          ...
          = Core.withObject "PrivateEnvironmentConfig"
              (\ o ->
                 PrivateEnvironmentConfig Core.<$>
                   (o Core..:? "cloudComposerConnectionSubnetwork")
                     Core.<*>
                     (o Core..:? "cloudComposerNetworkIpv4CidrBlock")
                     Core.<*>
                     (o Core..:? "cloudComposerNetworkIpv4ReservedRange")
...
instance Core.FromJSON RecoveryConfig where
        parseJSON
          = Core.withObject "RecoveryConfig"
              (\ o ->
                 RecoveryConfig Core.<$>
                   (o Core..:? "scheduledSnapshotsConfig"))
...
instance Core.FromJSON SaveSnapshotRequest where
        parseJSON
          = Core.withObject "SaveSnapshotRequest"
              (\ o ->
                 SaveSnapshotRequest Core.<$>
                   (o Core..:? "snapshotLocation"))

instance Core.ToJSON SaveSnapshotRequest where
        toJSON SaveSnapshotRequest{..}
          = Core.object
              (Core.catMaybes
                 [("snapshotLocation" Core..=) Core.<$>
                    snapshotLocation])
...
instance Core.FromJSON SoftwareConfig_EnvVariables
         where
        parseJSON
          = Core.withObject "SoftwareConfig_EnvVariables"
              (\ o ->
                 SoftwareConfig_EnvVariables Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SoftwareConfig_EnvVariables
         where
...
instance Core.FromJSON SoftwareConfig_PypiPackages
         where
        parseJSON
          = Core.withObject "SoftwareConfig_PypiPackages"
              (\ o ->
                 SoftwareConfig_PypiPackages Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SoftwareConfig_PypiPackages
         where
...
instance Core.FromJSON StopAirflowCommandRequest
         where
        parseJSON
...
newStopAirflowCommandResponse 
    ::  StopAirflowCommandResponse
newStopAirflowCommandResponse =
  StopAirflowCommandResponse {isDone = Core.Nothing, output = Core.Nothing}

instance Core.FromJSON StopAirflowCommandResponse
         where
        parseJSON
...
instance Core.FromJSON WebServerNetworkAccessControl
         where
        parseJSON
...
instance Core.ToJSON WebServerNetworkAccessControl
         where
        toJSON WebServerNetworkAccessControl{..}
          = Core.object
              (Core.catMaybes
                 [("allowedIpRanges" Core..=) Core.<$>
                    allowedIpRanges])
...
newWebServerResource =
  WebServerResource
    {cpu = Core.Nothing, memoryGb = Core.Nothing, storageGb = Core.Nothing}
          ...
          = Core.withObject "WebServerResource"
              (\ o ->
                 WebServerResource Core.<$>
                   (o Core..:? "cpu") Core.<*> (o Core..:? "memoryGb")
                     Core.<*> (o Core..:? "storageGb"))
...
instance Core.FromJSON WorkerResource where
        parseJSON
          = Core.withObject "WorkerResource"
              (\ o ->
                 WorkerResource Core.<$>
                   (o Core..:? "cpu") Core.<*> (o Core..:? "maxCount")
                     Core.<*> (o Core..:? "memoryGb")
...
newWorkloadsConfig =
  WorkloadsConfig
    {scheduler = Core.Nothing, webServer = Core.Nothing, worker = Core.Nothing}
