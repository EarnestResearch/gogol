...
instance Core.FromJSON AirflowMetadataRetentionPolicyConfig where
        parseJSON
          = Core.withObject "AirflowMetadataRetentionPolicyConfig"
              (\ o ->
                 AirflowMetadataRetentionPolicyConfig Core.<$>
                   (o Core..:? "retentionDays") Core.<*> (o Core..:? "retentionMode"))
...
instance Core.FromJSON AllowedIpRange where
        parseJSON
          = Core.withObject "AllowedIpRange"
              (\ o ->
                 AllowedIpRange Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON CheckUpgradeRequest where
        parseJSON
          = Core.withObject "CheckUpgradeRequest"
...
newCheckUpgradeResponse 
    ::  CheckUpgradeResponse
newCheckUpgradeResponse
  = CheckUpgradeResponse{buildLogUri = Core.Nothing,
...
instance Core.FromJSON CheckUpgradeResponse where
        parseJSON
          = Core.withObject "CheckUpgradeResponse"
              (\ o ->
                 CheckUpgradeResponse Core.<$>
                   (o Core..:? "buildLogUri") Core.<*>
                     (o Core..:? "containsPypiModulesConflict")
          ...
          = Core.object
              (Core.catMaybes
                 [("buildLogUri" Core..=) Core.<$> buildLogUri,
                  ("containsPypiModulesConflict" Core..=) Core.<$>
                    containsPypiModulesConflict,
                  ("imageVersion" Core..=) Core.<$> imageVersion,
                  ("pypiConflictBuildLogExtract" Core..=) Core.<$>
...
instance Core.FromJSON CheckUpgradeResponse_PypiDependencies where
        parseJSON
          = Core.withObject "CheckUpgradeResponse_PypiDependencies"
              (\ o ->
                 CheckUpgradeResponse_PypiDependencies Core.<$>
...
instance Core.FromJSON CloudDataLineageIntegration where
        parseJSON
          = Core.withObject "CloudDataLineageIntegration"
              (\ o ->
...
newComposerWorkload 
    ::  ComposerWorkload
newComposerWorkload
  = ComposerWorkload{name = Core.Nothing, status = Core.Nothing,
                     type' = Core.Nothing}
instance Core.FromJSON ComposerWorkload where
        parseJSON
          = Core.withObject "ComposerWorkload"
              (\ o ->
                 ComposerWorkload Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "status") Core.<*>
                     (o Core..:? "type"))
...
newComposerWorkloadStatus 
    ::  ComposerWorkloadStatus
newComposerWorkloadStatus
  = ComposerWorkloadStatus{detailedStatusMessage = Core.Nothing,
                           state = Core.Nothing, statusMessage = Core.Nothing}
instance Core.FromJSON ComposerWorkloadStatus where
        parseJSON
          = Core.withObject "ComposerWorkloadStatus"
              (\ o ->
                 ComposerWorkloadStatus Core.<$>
                   (o Core..:? "detailedStatusMessage") Core.<*> (o Core..:? "state")
...
newDagProcessorResource 
    ::  DagProcessorResource
newDagProcessorResource
  = DagProcessorResource{count = Core.Nothing, cpu = Core.Nothing,
                         memoryGb = Core.Nothing, storageGb = Core.Nothing}
instance Core.FromJSON DagProcessorResource where
        parseJSON
          = Core.withObject "DagProcessorResource"
              (\ o ->
                 DagProcessorResource Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "cpu") Core.<*>
                     (o Core..:? "memoryGb")
...
instance Core.ToJSON DagProcessorResource where
        toJSON DagProcessorResource{..}
          = Core.object
              (Core.catMaybes
                 [("count" Core..=) Core.<$> count, ("cpu" Core..=) Core.<$> cpu,
...
instance Core.FromJSON DataRetentionConfig where
        parseJSON
          = Core.withObject "DataRetentionConfig"
              (\ o ->
                 DataRetentionConfig Core.<$>
                   (o Core..:? "airflowMetadataRetentionConfig") Core.<*>
                     (o Core..:? "taskLogsRetentionConfig"))

instance Core.ToJSON DataRetentionConfig where
        toJSON DataRetentionConfig{..}
          = Core.object
              (Core.catMaybes
                 [("airflowMetadataRetentionConfig" Core..=) Core.<$>
                    airflowMetadataRetentionConfig,
                  ("taskLogsRetentionConfig" Core..=) Core.<$>
                    taskLogsRetentionConfig])
...
instance Core.FromJSON DatabaseConfig where
        parseJSON
          = Core.withObject "DatabaseConfig"
              (\ o ->
                 DatabaseConfig Core.<$>
                   (o Core..:? "machineType") Core.<*> (o Core..:? "zone"))
...
instance Core.FromJSON DatabaseFailoverRequest where
        parseJSON
          = Core.withObject "DatabaseFailoverRequest"
...
instance Core.FromJSON DatabaseFailoverResponse where
        parseJSON
          = Core.withObject "DatabaseFailoverResponse"
...
newEnvironment 
    ::  Environment
newEnvironment
  = Environment{config = Core.Nothing, createTime = Core.Nothing,
                labels = Core.Nothing, name = Core.Nothing,
                satisfiesPzi = Core.Nothing, satisfiesPzs = Core.Nothing,
                state = Core.Nothing, storageConfig = Core.Nothing,
...
instance Core.FromJSON Environment_Labels where
        parseJSON
          = Core.withObject "Environment_Labels"
...
newEnvironmentConfig 
    ::  EnvironmentConfig
newEnvironmentConfig
  = EnvironmentConfig{airflowByoidUri = Core.Nothing,
                      airflowUri = Core.Nothing, dagGcsPrefix = Core.Nothing,
                      dataRetentionConfig = Core.Nothing, databaseConfig = Core.Nothing,
                      encryptionConfig = Core.Nothing, environmentSize = Core.Nothing,
                      gkeCluster = Core.Nothing, maintenanceWindow = Core.Nothing,
                      masterAuthorizedNetworksConfig = Core.Nothing,
                      nodeConfig = Core.Nothing, nodeCount = Core.Nothing,
                      privateEnvironmentConfig = Core.Nothing,
                      recoveryConfig = Core.Nothing, resilienceMode = Core.Nothing,
                      softwareConfig = Core.Nothing, webServerConfig = Core.Nothing,
          ...
          = Core.withObject "EnvironmentConfig"
              (\ o ->
                 EnvironmentConfig Core.<$>
                   (o Core..:? "airflowByoidUri") Core.<*> (o Core..:? "airflowUri")
          ...
          = Core.object
              (Core.catMaybes
                 [("airflowByoidUri" Core..=) Core.<$> airflowByoidUri,
                  ...
                  ("privateEnvironmentConfig" Core..=) Core.<$>
                    privateEnvironmentConfig,
                  ...
                  ("webServerNetworkAccessControl" Core..=) Core.<$>
                    webServerNetworkAccessControl,
...
newExecuteAirflowCommandRequest 
    ::  ExecuteAirflowCommandRequest
newExecuteAirflowCommandRequest
  = ExecuteAirflowCommandRequest{command = Core.Nothing,
                                 parameters = Core.Nothing, subcommand = Core.Nothing}
instance Core.FromJSON ExecuteAirflowCommandRequest where
        parseJSON
          = Core.withObject "ExecuteAirflowCommandRequest"
              (\ o ->
                 ExecuteAirflowCommandRequest Core.<$>
                   (o Core..:? "command") Core.<*> (o Core..:? "parameters") Core.<*>
                     (o Core..:? "subcommand"))
...
newExecuteAirflowCommandResponse 
    ::  ExecuteAirflowCommandResponse
newExecuteAirflowCommandResponse
  = ExecuteAirflowCommandResponse{error = Core.Nothing,
                                  executionId = Core.Nothing, pod = Core.Nothing,
                                  podNamespace = Core.Nothing}
instance Core.FromJSON ExecuteAirflowCommandResponse where
        parseJSON
          = Core.withObject "ExecuteAirflowCommandResponse"
              (\ o ->
                 ExecuteAirflowCommandResponse Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "executionId") Core.<*>
                     (o Core..:? "pod")
...
instance Core.FromJSON ExitInfo where
        parseJSON
          = Core.withObject "ExitInfo"
              (\ o ->
                 ExitInfo Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "exitCode"))
...
newFetchDatabasePropertiesResponse
  = FetchDatabasePropertiesResponse{isFailoverReplicaAvailable =
                                      Core.Nothing,
                                    primaryGceZone = Core.Nothing, secondaryGceZone = Core.Nothing}
instance Core.FromJSON FetchDatabasePropertiesResponse where
        parseJSON
          = Core.withObject "FetchDatabasePropertiesResponse"
              (\ o ->
                 FetchDatabasePropertiesResponse Core.<$>
                   (o Core..:? "isFailoverReplicaAvailable") Core.<*>
                     (o Core..:? "primaryGceZone")
...
instance Core.ToJSON FetchDatabasePropertiesResponse where
        toJSON FetchDatabasePropertiesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("isFailoverReplicaAvailable" Core..=) Core.<$>
...
newIPAllocationPolicy 
    ::  IPAllocationPolicy
newIPAllocationPolicy
  = IPAllocationPolicy{clusterIpv4CidrBlock = Core.Nothing,
          ...
          = Core.withObject "IPAllocationPolicy"
              (\ o ->
                 IPAllocationPolicy Core.<$>
                   (o Core..:? "clusterIpv4CidrBlock") Core.<*>
                     (o Core..:? "clusterSecondaryRangeName")
...
newImageVersion 
    ::  ImageVersion
newImageVersion
  = ImageVersion{creationDisabled = Core.Nothing,
                 imageVersionId = Core.Nothing, isDefault = Core.Nothing,
                 releaseDate = Core.Nothing, supportedPythonVersions = Core.Nothing,
                 upgradeDisabled = Core.Nothing}
instance Core.FromJSON ImageVersion where
        parseJSON
          = Core.withObject "ImageVersion"
              (\ o ->
                 ImageVersion Core.<$>
                   (o Core..:? "creationDisabled") Core.<*>
                     (o Core..:? "imageVersionId")
          ...
          = Core.object
              (Core.catMaybes
                 [("creationDisabled" Core..=) Core.<$> creationDisabled,
                  ...
                  ("supportedPythonVersions" Core..=) Core.<$>
...
instance Core.FromJSON Line where
        parseJSON
          = Core.withObject "Line"
              (\ o ->
                 Line Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "lineNumber"))
...
newListEnvironmentsResponse 
    ::  ListEnvironmentsResponse
newListEnvironmentsResponse
  = ListEnvironmentsResponse{environments = Core.Nothing,
          ...
          = Core.withObject "ListEnvironmentsResponse"
              (\ o ->
                 ListEnvironmentsResponse Core.<$>
                   (o Core..:? "environments") Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListImageVersionsResponse where
        parseJSON
          = Core.withObject "ListImageVersionsResponse"
              (\ o ->
                 ListImageVersionsResponse Core.<$>
                   (o Core..:? "imageVersions") Core.<*> (o Core..:? "nextPageToken"))
...
newListUserWorkloadsConfigMapsResponse 
    :: 
                                       ListUserWorkloadsConfigMapsResponse
newListUserWorkloadsConfigMapsResponse
  = ListUserWorkloadsConfigMapsResponse{nextPageToken = Core.Nothing,
                                        userWorkloadsConfigMaps = Core.Nothing}
instance Core.FromJSON ListUserWorkloadsConfigMapsResponse where
        parseJSON
          = Core.withObject "ListUserWorkloadsConfigMapsResponse"
              (\ o ->
                 ListUserWorkloadsConfigMapsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "userWorkloadsConfigMaps"))
...
instance Core.ToJSON ListUserWorkloadsConfigMapsResponse where
        toJSON ListUserWorkloadsConfigMapsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("userWorkloadsConfigMaps" Core..=) Core.<$>
...
newListUserWorkloadsSecretsResponse 
    :: 
                                    ListUserWorkloadsSecretsResponse
newListUserWorkloadsSecretsResponse
  = ListUserWorkloadsSecretsResponse{nextPageToken = Core.Nothing,
                                     userWorkloadsSecrets = Core.Nothing}
instance Core.FromJSON ListUserWorkloadsSecretsResponse where
        parseJSON
          = Core.withObject "ListUserWorkloadsSecretsResponse"
              (\ o ->
                 ListUserWorkloadsSecretsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "userWorkloadsSecrets"))
...
newListWorkloadsResponse 
    ::  ListWorkloadsResponse
newListWorkloadsResponse
  = ListWorkloadsResponse{nextPageToken = Core.Nothing,
                          workloads = Core.Nothing}
instance Core.FromJSON ListWorkloadsResponse where
        parseJSON
          = Core.withObject "ListWorkloadsResponse"
              (\ o ->
                 ListWorkloadsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "workloads"))
...
newLoadSnapshotRequest 
    ::  LoadSnapshotRequest
newLoadSnapshotRequest
  = LoadSnapshotRequest{skipAirflowOverridesSetting = Core.Nothing,
...
instance Core.FromJSON LoadSnapshotRequest where
        parseJSON
          = Core.withObject "LoadSnapshotRequest"
              (\ o ->
                 LoadSnapshotRequest Core.<$>
                   (o Core..:? "skipAirflowOverridesSetting") Core.<*>
                     (o Core..:? "skipEnvironmentVariablesSetting")
...
instance Core.ToJSON LoadSnapshotRequest where
        toJSON LoadSnapshotRequest{..}
          = Core.object
              (Core.catMaybes
                 [("skipAirflowOverridesSetting" Core..=) Core.<$>
                    skipAirflowOverridesSetting,
                  ("skipEnvironmentVariablesSetting" Core..=) Core.<$>
                    skipEnvironmentVariablesSetting,
                  ("skipGcsDataCopying" Core..=) Core.<$> skipGcsDataCopying,
                  ("skipPypiPackagesInstallation" Core..=) Core.<$>
...
instance Core.FromJSON LoadSnapshotResponse where
        parseJSON
          = Core.withObject "LoadSnapshotResponse"
...
newMaintenanceWindow 
    ::  MaintenanceWindow
newMaintenanceWindow
  = MaintenanceWindow{endTime = Core.Nothing,
          ...
          = Core.withObject "MaintenanceWindow"
              (\ o ->
                 MaintenanceWindow Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "recurrence") Core.<*>
                     (o Core..:? "startTime"))
          ...
          = Core.withObject "MasterAuthorizedNetworksConfig"
              (\ o ->
                 MasterAuthorizedNetworksConfig Core.<$>
                   (o Core..:? "cidrBlocks") Core.<*> (o Core..:? "enabled"))
...
instance Core.FromJSON NetworkingConfig where
        parseJSON
          = Core.withObject "NetworkingConfig"
...
newNodeConfig 
    ::  NodeConfig
newNodeConfig
  = NodeConfig{composerInternalIpv4CidrBlock = Core.Nothing,
               composerNetworkAttachment = Core.Nothing,
               diskSizeGb = Core.Nothing, enableIpMasqAgent = Core.Nothing,
               ipAllocationPolicy = Core.Nothing, location = Core.Nothing,
               machineType = Core.Nothing, network = Core.Nothing,
...
instance Core.FromJSON NodeConfig where
        parseJSON
          = Core.withObject "NodeConfig"
              (\ o ->
                 NodeConfig Core.<$>
                   (o Core..:? "composerInternalIpv4CidrBlock") Core.<*>
                     (o Core..:? "composerNetworkAttachment")
...
instance Core.ToJSON NodeConfig where
        toJSON NodeConfig{..}
          = Core.object
              (Core.catMaybes
                 [("composerInternalIpv4CidrBlock" Core..=) Core.<$>
                    composerInternalIpv4CidrBlock,
                  ("composerNetworkAttachment" Core..=) Core.<$>
...
newOperationMetadata
  = OperationMetadata{createTime = Core.Nothing,
                      ...
                      resource = Core.Nothing, resourceUuid = Core.Nothing,
                      state = Core.Nothing}
...
newPollAirflowCommandRequest 
    ::  PollAirflowCommandRequest
newPollAirflowCommandRequest
  = PollAirflowCommandRequest{executionId = Core.Nothing,
                              nextLineNumber = Core.Nothing, pod = Core.Nothing,
                              podNamespace = Core.Nothing}
instance Core.FromJSON PollAirflowCommandRequest where
        parseJSON
          = Core.withObject "PollAirflowCommandRequest"
              (\ o ->
                 PollAirflowCommandRequest Core.<$>
                   (o Core..:? "executionId") Core.<*> (o Core..:? "nextLineNumber")
                     Core.<*> (o Core..:? "pod")
                     Core.<*> (o Core..:? "podNamespace"))
...
newPollAirflowCommandResponse 
    ::  PollAirflowCommandResponse
newPollAirflowCommandResponse
  = PollAirflowCommandResponse{exitInfo = Core.Nothing,
                               output = Core.Nothing, outputEnd = Core.Nothing}
instance Core.FromJSON PollAirflowCommandResponse where
        parseJSON
          = Core.withObject "PollAirflowCommandResponse"
              (\ o ->
                 PollAirflowCommandResponse Core.<$>
                   (o Core..:? "exitInfo") Core.<*> (o Core..:? "output") Core.<*>
                     (o Core..:? "outputEnd"))
          ...
          = Core.object
              (Core.catMaybes
                 [("enablePrivateEndpoint" Core..=) Core.<$> enablePrivateEndpoint,
                  ...
                  ("masterIpv4ReservedRange" Core..=) Core.<$>
...
instance Core.FromJSON PrivateEnvironmentConfig where
        parseJSON
          = Core.withObject "PrivateEnvironmentConfig"
              (\ o ->
                 PrivateEnvironmentConfig Core.<$>
                   (o Core..:? "cloudComposerConnectionSubnetwork") Core.<*>
                     (o Core..:? "cloudComposerNetworkIpv4CidrBlock")
...
instance Core.ToJSON PrivateEnvironmentConfig where
        toJSON PrivateEnvironmentConfig{..}
          = Core.object
              (Core.catMaybes
                 [("cloudComposerConnectionSubnetwork" Core..=) Core.<$>
                    cloudComposerConnectionSubnetwork,
                  ("cloudComposerNetworkIpv4CidrBlock" Core..=) Core.<$>
                    cloudComposerNetworkIpv4CidrBlock,
                  ("cloudComposerNetworkIpv4ReservedRange" Core..=) Core.<$>
                    cloudComposerNetworkIpv4ReservedRange,
                  ("cloudSqlIpv4CidrBlock" Core..=) Core.<$> cloudSqlIpv4CidrBlock,
                  ("enablePrivateBuildsOnly" Core..=) Core.<$>
                    enablePrivateBuildsOnly,
                  ("enablePrivateEnvironment" Core..=) Core.<$>
                    enablePrivateEnvironment,
                  ("enablePrivatelyUsedPublicIps" Core..=) Core.<$>
                  ...
                  ("webServerIpv4ReservedRange" Core..=) Core.<$>
...
instance Core.FromJSON RecoveryConfig where
        parseJSON
          = Core.withObject "RecoveryConfig"
              (\ o ->
...
instance Core.ToJSON RecoveryConfig where
        toJSON RecoveryConfig{..}
          = Core.object
              (Core.catMaybes
                 [("scheduledSnapshotsConfig" Core..=) Core.<$>
                    scheduledSnapshotsConfig])


-- | Restart Airflow web server.
--
-- /See:/ 'newRestartWebServerRequest' smart constructor.
data RestartWebServerRequest = RestartWebServerRequest
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RestartWebServerRequest' with the minimum fields required to make a request.
newRestartWebServerRequest 
    ::  RestartWebServerRequest
newRestartWebServerRequest = RestartWebServerRequest
instance Core.FromJSON RestartWebServerRequest where
        parseJSON
          = Core.withObject "RestartWebServerRequest"
              (\ o -> Core.pure RestartWebServerRequest)

instance Core.ToJSON RestartWebServerRequest where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON SaveSnapshotRequest where
        parseJSON
          = Core.withObject "SaveSnapshotRequest"
              (\ o ->
...
instance Core.FromJSON SaveSnapshotResponse where
        parseJSON
          = Core.withObject "SaveSnapshotResponse"
...
newScheduledSnapshotsConfig 
    ::  ScheduledSnapshotsConfig
newScheduledSnapshotsConfig
  = ScheduledSnapshotsConfig{enabled = Core.Nothing,
                             snapshotCreationSchedule = Core.Nothing,
                             snapshotLocation = Core.Nothing, timeZone = Core.Nothing}
instance Core.FromJSON ScheduledSnapshotsConfig where
        parseJSON
          = Core.withObject "ScheduledSnapshotsConfig"
              (\ o ->
                 ScheduledSnapshotsConfig Core.<$>
                   (o Core..:? "enabled") Core.<*>
                     (o Core..:? "snapshotCreationSchedule")
...
instance Core.ToJSON ScheduledSnapshotsConfig where
        toJSON ScheduledSnapshotsConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ("snapshotCreationSchedule" Core..=) Core.<$>
...
newSchedulerResource 
    ::  SchedulerResource
newSchedulerResource
  = SchedulerResource{count = Core.Nothing, cpu = Core.Nothing,
                      memoryGb = Core.Nothing, storageGb = Core.Nothing}
instance Core.FromJSON SchedulerResource where
        parseJSON
          = Core.withObject "SchedulerResource"
              (\ o ->
                 SchedulerResource Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "cpu") Core.<*>
                     (o Core..:? "memoryGb")
                     Core.<*> (o Core..:? "storageGb"))
...
newSoftwareConfig 
    ::  SoftwareConfig
newSoftwareConfig
  = SoftwareConfig{airflowConfigOverrides = Core.Nothing,
                   cloudDataLineageIntegration = Core.Nothing,
                   envVariables = Core.Nothing, imageVersion = Core.Nothing,
                   pypiPackages = Core.Nothing, pythonVersion = Core.Nothing,
                   schedulerCount = Core.Nothing, webServerPluginsMode = Core.Nothing}
instance Core.FromJSON SoftwareConfig where
        parseJSON
          = Core.withObject "SoftwareConfig"
              (\ o ->
                 SoftwareConfig Core.<$>
                   (o Core..:? "airflowConfigOverrides") Core.<*>
                     (o Core..:? "cloudDataLineageIntegration")
...
instance Core.ToJSON SoftwareConfig where
        toJSON SoftwareConfig{..}
          = Core.object
              (Core.catMaybes
                 [("airflowConfigOverrides" Core..=) Core.<$>
                    airflowConfigOverrides,
                  ("cloudDataLineageIntegration" Core..=) Core.<$>
                    cloudDataLineageIntegration,
...
instance Core.FromJSON SoftwareConfig_AirflowConfigOverrides where
        parseJSON
          = Core.withObject "SoftwareConfig_AirflowConfigOverrides"
              (\ o ->
                 SoftwareConfig_AirflowConfigOverrides Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON SoftwareConfig_EnvVariables where
        parseJSON
          = Core.withObject "SoftwareConfig_EnvVariables"
              (\ o ->
...
instance Core.FromJSON SoftwareConfig_PypiPackages where
        parseJSON
          = Core.withObject "SoftwareConfig_PypiPackages"
              (\ o ->
...
newStopAirflowCommandRequest 
    ::  StopAirflowCommandRequest
newStopAirflowCommandRequest
  = StopAirflowCommandRequest{executionId = Core.Nothing,
                              force = Core.Nothing, pod = Core.Nothing,
                              podNamespace = Core.Nothing}
instance Core.FromJSON StopAirflowCommandRequest where
        parseJSON
          = Core.withObject "StopAirflowCommandRequest"
              (\ o ->
                 StopAirflowCommandRequest Core.<$>
                   (o Core..:? "executionId") Core.<*> (o Core..:? "force") Core.<*>
                     (o Core..:? "pod")
                     Core.<*> (o Core..:? "podNamespace"))
...
instance Core.ToJSON StopAirflowCommandRequest where
        toJSON StopAirflowCommandRequest{..}
          = Core.object
              (Core.catMaybes
                 [("executionId" Core..=) Core.<$> executionId,
                  ("force" Core..=) Core.<$> force, ("pod" Core..=) Core.<$> pod,
                  ("podNamespace" Core..=) Core.<$> podNamespace])
...
newStopAirflowCommandResponse 
    ::  StopAirflowCommandResponse
newStopAirflowCommandResponse
  = StopAirflowCommandResponse{isDone = Core.Nothing,
                               output = Core.Nothing}
instance Core.FromJSON StopAirflowCommandResponse where
        parseJSON
          = Core.withObject "StopAirflowCommandResponse"
              (\ o ->
                 StopAirflowCommandResponse Core.<$>
                   (o Core..:? "isDone") Core.<*> (o Core..:? "output"))
...
instance Core.FromJSON TaskLogsRetentionConfig where
        parseJSON
          = Core.withObject "TaskLogsRetentionConfig"
              (\ o ->
...
newTriggererResource 
    ::  TriggererResource
newTriggererResource
  = TriggererResource{count = Core.Nothing, cpu = Core.Nothing,
                      memoryGb = Core.Nothing}
instance Core.FromJSON TriggererResource where
        parseJSON
          = Core.withObject "TriggererResource"
              (\ o ->
                 TriggererResource Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "cpu") Core.<*>
                     (o Core..:? "memoryGb"))
...
instance Core.FromJSON UserWorkloadsConfigMap where
        parseJSON
          = Core.withObject "UserWorkloadsConfigMap"
              (\ o ->
                 UserWorkloadsConfigMap Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON UserWorkloadsConfigMap_Data where
        parseJSON
          = Core.withObject "UserWorkloadsConfigMap_Data"
              (\ o ->
...
instance Core.FromJSON UserWorkloadsSecret where
        parseJSON
          = Core.withObject "UserWorkloadsSecret"
              (\ o ->
                 UserWorkloadsSecret Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON UserWorkloadsSecret_Data where
        parseJSON
          = Core.withObject "UserWorkloadsSecret_Data"
...
instance Core.FromJSON WebServerConfig where
        parseJSON
          = Core.withObject "WebServerConfig"
...
instance Core.FromJSON WebServerNetworkAccessControl where
        parseJSON
          = Core.withObject "WebServerNetworkAccessControl"
              (\ o ->
                 WebServerNetworkAccessControl Core.<$>
                   (o Core..:? "allowedIpRanges"))
...
newWebServerResource 
    ::  WebServerResource
newWebServerResource
  = WebServerResource{cpu = Core.Nothing, memoryGb = Core.Nothing,
                      storageGb = Core.Nothing}
instance Core.FromJSON WebServerResource where
        parseJSON
          = Core.withObject "WebServerResource"
              (\ o ->
                 WebServerResource Core.<$>
                   (o Core..:? "cpu") Core.<*> (o Core..:? "memoryGb") Core.<*>
                     (o Core..:? "storageGb"))
...
newWorkerResource 
    ::  WorkerResource
newWorkerResource
  = WorkerResource{cpu = Core.Nothing, maxCount = Core.Nothing,
                   memoryGb = Core.Nothing, minCount = Core.Nothing,
                   storageGb = Core.Nothing}
instance Core.FromJSON WorkerResource where
        parseJSON
          = Core.withObject "WorkerResource"
              (\ o ->
                 WorkerResource Core.<$>
                   (o Core..:? "cpu") Core.<*> (o Core..:? "maxCount") Core.<*>
                     (o Core..:? "memoryGb")
...
newWorkloadsConfig 
    ::  WorkloadsConfig
newWorkloadsConfig
  = WorkloadsConfig{dagProcessor = Core.Nothing,
                    scheduler = Core.Nothing, triggerer = Core.Nothing,
                    webServer = Core.Nothing, worker = Core.Nothing}
instance Core.FromJSON WorkloadsConfig where
        parseJSON
          = Core.withObject "WorkloadsConfig"
              (\ o ->
                 WorkloadsConfig Core.<$>
                   (o Core..:? "dagProcessor") Core.<*> (o Core..:? "scheduler")
