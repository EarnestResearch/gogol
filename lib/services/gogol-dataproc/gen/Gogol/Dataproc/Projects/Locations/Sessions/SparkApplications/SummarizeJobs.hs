...
type DataprocProjectsLocationsSessionsSparkApplicationsSummarizeJobsResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "summarizeJobs" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] SummarizeSessionSparkApplicationJobsResponse
...
newDataprocProjectsLocationsSessionsSparkApplicationsSummarizeJobs
  name
  = DataprocProjectsLocationsSessionsSparkApplicationsSummarizeJobs{xgafv
                                                                      = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          DataprocProjectsLocationsSessionsSparkApplicationsSummarizeJobs{..}
          = go name xgafv accessToken callback parent uploadType
              uploadProtocol
