...
newDataprocProjectsLocationsSessionTemplatesPatch name payload
  = DataprocProjectsLocationsSessionTemplatesPatch{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsSessionTemplatesPatch
         where
        type Rs DataprocProjectsLocationsSessionTemplatesPatch =
             SessionTemplate
        type Scopes DataprocProjectsLocationsSessionTemplatesPatch =
