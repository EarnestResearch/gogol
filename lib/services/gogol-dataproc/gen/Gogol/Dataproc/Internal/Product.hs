...
module Gogol.Dataproc.Internal.Product
  (
    ...
    -- * PropertiesInfo_AutotuningProperties
    PropertiesInfo_AutotuningProperties (..),
    newPropertiesInfo_AutotuningProperties,
...
newAcceleratorConfig 
    ::  AcceleratorConfig
newAcceleratorConfig
  = AcceleratorConfig{acceleratorCount = Core.Nothing,
...
newAccessSessionSparkApplicationEnvironmentInfoResponse 
    :: 
                                                        AccessSessionSparkApplicationEnvironmentInfoResponse
newAccessSessionSparkApplicationEnvironmentInfoResponse
  = AccessSessionSparkApplicationEnvironmentInfoResponse{applicationEnvironmentInfo
                                                           = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "AccessSessionSparkApplicationEnvironmentInfoResponse"
              (\ o ->
                 AccessSessionSparkApplicationEnvironmentInfoResponse Core.<$>
                   (o Core..:? "applicationEnvironmentInfo"))
...
instance Core.ToJSON
        ...
        toJSON AccessSessionSparkApplicationEnvironmentInfoResponse{..}
          = Core.object
              (Core.catMaybes
                 [("applicationEnvironmentInfo" Core..=) Core.<$>
                    applicationEnvironmentInfo])
...
instance Core.FromJSON AccessSessionSparkApplicationJobResponse
         where
        parseJSON
          = Core.withObject "AccessSessionSparkApplicationJobResponse"
              (\ o ->
                 AccessSessionSparkApplicationJobResponse Core.<$>
                   (o Core..:? "jobData"))
...
instance Core.FromJSON AccessSessionSparkApplicationResponse where
        parseJSON
          = Core.withObject "AccessSessionSparkApplicationResponse"
              (\ o ->
                 AccessSessionSparkApplicationResponse Core.<$>
                   (o Core..:? "application"))
...
newAccessSessionSparkApplicationSqlQueryResponse 
    :: 
                                                 AccessSessionSparkApplicationSqlQueryResponse
newAccessSessionSparkApplicationSqlQueryResponse
  = AccessSessionSparkApplicationSqlQueryResponse{executionData =
                                                    Core.Nothing}
instance Core.FromJSON
           AccessSessionSparkApplicationSqlQueryResponse
         where
        parseJSON
          = Core.withObject "AccessSessionSparkApplicationSqlQueryResponse"
              (\ o ->
                 AccessSessionSparkApplicationSqlQueryResponse Core.<$>
                   (o Core..:? "executionData"))

instance Core.ToJSON AccessSessionSparkApplicationSqlQueryResponse
         where
...
newAccessSessionSparkApplicationSqlSparkPlanGraphResponse 
    :: 
                                                          AccessSessionSparkApplicationSqlSparkPlanGraphResponse
newAccessSessionSparkApplicationSqlSparkPlanGraphResponse
  = AccessSessionSparkApplicationSqlSparkPlanGraphResponse{sparkPlanGraph
                                                             = Core.Nothing}
instance Core.FromJSON
           AccessSessionSparkApplicationSqlSparkPlanGraphResponse
         where
        parseJSON
          = Core.withObject
              "AccessSessionSparkApplicationSqlSparkPlanGraphResponse"
              (\ o ->
                 AccessSessionSparkApplicationSqlSparkPlanGraphResponse Core.<$>
                   (o Core..:? "sparkPlanGraph"))
...
newAccessSessionSparkApplicationStageAttemptResponse 
    :: 
                                                     AccessSessionSparkApplicationStageAttemptResponse
newAccessSessionSparkApplicationStageAttemptResponse
  = AccessSessionSparkApplicationStageAttemptResponse{stageData =
                                                        Core.Nothing}
instance Core.FromJSON
           AccessSessionSparkApplicationStageAttemptResponse
         where
        parseJSON
          = Core.withObject
              "AccessSessionSparkApplicationStageAttemptResponse"
              (\ o ->
                 AccessSessionSparkApplicationStageAttemptResponse Core.<$>
                   (o Core..:? "stageData"))
...
newAccessSessionSparkApplicationStageRddOperationGraphResponse 
    :: 
                                                               AccessSessionSparkApplicationStageRddOperationGraphResponse
newAccessSessionSparkApplicationStageRddOperationGraphResponse
  = AccessSessionSparkApplicationStageRddOperationGraphResponse{rddOperationGraph
                                                                  = Core.Nothing}
instance Core.FromJSON
           AccessSessionSparkApplicationStageRddOperationGraphResponse
         where
...
newAccessSparkApplicationEnvironmentInfoResponse 
    :: 
                                                 AccessSparkApplicationEnvironmentInfoResponse
newAccessSparkApplicationEnvironmentInfoResponse
  = AccessSparkApplicationEnvironmentInfoResponse{applicationEnvironmentInfo
                                                    = Core.Nothing}
instance Core.FromJSON
           AccessSparkApplicationEnvironmentInfoResponse
         where
        parseJSON
          = Core.withObject "AccessSparkApplicationEnvironmentInfoResponse"
              (\ o ->
                 AccessSparkApplicationEnvironmentInfoResponse Core.<$>
                   (o Core..:? "applicationEnvironmentInfo"))

instance Core.ToJSON AccessSparkApplicationEnvironmentInfoResponse
         where
...
instance Core.FromJSON AccessSparkApplicationJobResponse where
        parseJSON
          = Core.withObject "AccessSparkApplicationJobResponse"
              (\ o ->
...
instance Core.FromJSON AccessSparkApplicationResponse where
        parseJSON
          = Core.withObject "AccessSparkApplicationResponse"
              (\ o ->
...
newAccessSparkApplicationSqlQueryResponse 
    :: 
                                          AccessSparkApplicationSqlQueryResponse
newAccessSparkApplicationSqlQueryResponse
  = AccessSparkApplicationSqlQueryResponse{executionData =
                                             Core.Nothing}
instance Core.FromJSON AccessSparkApplicationSqlQueryResponse where
        parseJSON
          = Core.withObject "AccessSparkApplicationSqlQueryResponse"
              (\ o ->
                 AccessSparkApplicationSqlQueryResponse Core.<$>
                   (o Core..:? "executionData"))
...
newAccessSparkApplicationSqlSparkPlanGraphResponse 
    :: 
                                                   AccessSparkApplicationSqlSparkPlanGraphResponse
newAccessSparkApplicationSqlSparkPlanGraphResponse
  = AccessSparkApplicationSqlSparkPlanGraphResponse{sparkPlanGraph =
                                                      Core.Nothing}
instance Core.FromJSON
           AccessSparkApplicationSqlSparkPlanGraphResponse
         where
        parseJSON
          = Core.withObject "AccessSparkApplicationSqlSparkPlanGraphResponse"
              (\ o ->
                 AccessSparkApplicationSqlSparkPlanGraphResponse Core.<$>
                   (o Core..:? "sparkPlanGraph"))
...
newAccessSparkApplicationStageAttemptResponse 
    :: 
                                              AccessSparkApplicationStageAttemptResponse
newAccessSparkApplicationStageAttemptResponse
  = AccessSparkApplicationStageAttemptResponse{stageData =
                                                 Core.Nothing}
instance Core.FromJSON AccessSparkApplicationStageAttemptResponse
         where
        parseJSON
          = Core.withObject "AccessSparkApplicationStageAttemptResponse"
              (\ o ->
                 AccessSparkApplicationStageAttemptResponse Core.<$>
                   (o Core..:? "stageData"))

instance Core.ToJSON AccessSparkApplicationStageAttemptResponse
         where
...
newAccessSparkApplicationStageRddOperationGraphResponse 
    :: 
                                                        AccessSparkApplicationStageRddOperationGraphResponse
newAccessSparkApplicationStageRddOperationGraphResponse
  = AccessSparkApplicationStageRddOperationGraphResponse{rddOperationGraph
                                                           = Core.Nothing}
instance Core.FromJSON
           AccessSparkApplicationStageRddOperationGraphResponse
         where
        parseJSON
          = Core.withObject
              "AccessSparkApplicationStageRddOperationGraphResponse"
              (\ o ->
                 AccessSparkApplicationStageRddOperationGraphResponse Core.<$>
                   (o Core..:? "rddOperationGraph"))
...
newAccumulableInfo 
    ::  AccumulableInfo
newAccumulableInfo
  = AccumulableInfo{accumullableInfoId = Core.Nothing,
                    name = Core.Nothing, update = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON AccumulableInfo where
        parseJSON
          = Core.withObject "AccumulableInfo"
              (\ o ->
                 AccumulableInfo Core.<$>
                   (o Core..:? "accumullableInfoId" Core.<&>
...
instance Core.ToJSON AccumulableInfo where
        toJSON AccumulableInfo{..}
          = Core.object
              (Core.catMaybes
                 [("accumullableInfoId" Core..=) Core.. Core.AsText Core.<$>
                    accumullableInfoId,
                  ("name" Core..=) Core.<$> name, ("update" Core..=) Core.<$> update,
...
instance Core.FromJSON AnalyzeBatchRequest where
        parseJSON
          = Core.withObject "AnalyzeBatchRequest"
...
newAnalyzeOperationMetadata 
    ::  AnalyzeOperationMetadata
newAnalyzeOperationMetadata
  = AnalyzeOperationMetadata{analyzedWorkloadName = Core.Nothing,
                             analyzedWorkloadType = Core.Nothing,
                             analyzedWorkloadUuid = Core.Nothing, createTime = Core.Nothing,
                             description = Core.Nothing, doneTime = Core.Nothing,
                             labels = Core.Nothing, warnings = Core.Nothing}
instance Core.FromJSON AnalyzeOperationMetadata where
        parseJSON
          = Core.withObject "AnalyzeOperationMetadata"
              (\ o ->
                 AnalyzeOperationMetadata Core.<$>
                   (o Core..:? "analyzedWorkloadName") Core.<*>
                     (o Core..:? "analyzedWorkloadType")
...
instance Core.FromJSON AnalyzeOperationMetadata_Labels where
        parseJSON
          = Core.withObject "AnalyzeOperationMetadata_Labels"
              (\ o ->
...
newAppSummary 
    ::  AppSummary
newAppSummary
  = AppSummary{numCompletedJobs = Core.Nothing,
               numCompletedStages = Core.Nothing}
instance Core.FromJSON AppSummary where
        parseJSON
          = Core.withObject "AppSummary"
              (\ o ->
                 AppSummary Core.<$>
                   (o Core..:? "numCompletedJobs") Core.<*>
                     (o Core..:? "numCompletedStages"))
...
newApplicationAttemptInfo 
    ::  ApplicationAttemptInfo
newApplicationAttemptInfo
  = ApplicationAttemptInfo{appSparkVersion = Core.Nothing,
                           attemptId = Core.Nothing, completed = Core.Nothing,
                           durationMillis = Core.Nothing, endTime = Core.Nothing,
                           lastUpdated = Core.Nothing, sparkUser = Core.Nothing,
                           startTime = Core.Nothing}
instance Core.FromJSON ApplicationAttemptInfo where
        parseJSON
          = Core.withObject "ApplicationAttemptInfo"
              (\ o ->
                 ApplicationAttemptInfo Core.<$>
                   (o Core..:? "appSparkVersion") Core.<*> (o Core..:? "attemptId")
                     Core.<*> (o Core..:? "completed")
                     Core.<*>
                     (o Core..:? "durationMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "endTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("appSparkVersion" Core..=) Core.<$> appSparkVersion,
                  ...
                  ("durationMillis" Core..=) Core.. Core.AsText Core.<$>
                    durationMillis,
...
newApplicationEnvironmentInfo 
    ::  ApplicationEnvironmentInfo
newApplicationEnvironmentInfo
  = ApplicationEnvironmentInfo{classpathEntries = Core.Nothing,
                               hadoopProperties = Core.Nothing, metricsProperties = Core.Nothing,
                               resourceProfiles = Core.Nothing, runtime = Core.Nothing,
                               sparkProperties = Core.Nothing, systemProperties = Core.Nothing}
instance Core.FromJSON ApplicationEnvironmentInfo where
        parseJSON
          = Core.withObject "ApplicationEnvironmentInfo"
              (\ o ->
                 ApplicationEnvironmentInfo Core.<$>
                   (o Core..:? "classpathEntries") Core.<*>
                     (o Core..:? "hadoopProperties")
...
newApplicationEnvironmentInfo_ClasspathEntries additional
  = ApplicationEnvironmentInfo_ClasspathEntries{additional =
                                                  additional}
instance Core.FromJSON ApplicationEnvironmentInfo_ClasspathEntries
         where
        parseJSON
          = Core.withObject "ApplicationEnvironmentInfo_ClasspathEntries"
              (\ o ->
                 ApplicationEnvironmentInfo_ClasspathEntries Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ApplicationEnvironmentInfo_ClasspathEntries
         where
...
newApplicationEnvironmentInfo_HadoopProperties additional
  = ApplicationEnvironmentInfo_HadoopProperties{additional =
                                                  additional}
instance Core.FromJSON ApplicationEnvironmentInfo_HadoopProperties
         where
        parseJSON
          = Core.withObject "ApplicationEnvironmentInfo_HadoopProperties"
              (\ o ->
                 ApplicationEnvironmentInfo_HadoopProperties Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ApplicationEnvironmentInfo_HadoopProperties
         where
...
newApplicationEnvironmentInfo_MetricsProperties additional
  = ApplicationEnvironmentInfo_MetricsProperties{additional =
                                                   additional}
instance Core.FromJSON ApplicationEnvironmentInfo_MetricsProperties
         where
        parseJSON
          = Core.withObject "ApplicationEnvironmentInfo_MetricsProperties"
              (\ o ->
                 ApplicationEnvironmentInfo_MetricsProperties Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ApplicationEnvironmentInfo_MetricsProperties
         where
...
newApplicationEnvironmentInfo_SparkProperties additional
  = ApplicationEnvironmentInfo_SparkProperties{additional =
                                                 additional}
instance Core.FromJSON ApplicationEnvironmentInfo_SparkProperties
         where
        parseJSON
          = Core.withObject "ApplicationEnvironmentInfo_SparkProperties"
              (\ o ->
                 ApplicationEnvironmentInfo_SparkProperties Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ApplicationEnvironmentInfo_SparkProperties
         where
...
newApplicationEnvironmentInfo_SystemProperties additional
  = ApplicationEnvironmentInfo_SystemProperties{additional =
                                                  additional}
instance Core.FromJSON ApplicationEnvironmentInfo_SystemProperties
         where
        parseJSON
          = Core.withObject "ApplicationEnvironmentInfo_SystemProperties"
              (\ o ->
                 ApplicationEnvironmentInfo_SystemProperties Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ApplicationEnvironmentInfo_SystemProperties
         where
...
newApplicationInfo 
    ::  ApplicationInfo
newApplicationInfo
  = ApplicationInfo{applicationContextIngestionStatus = Core.Nothing,
                    applicationId = Core.Nothing, attempts = Core.Nothing,
                    coresGranted = Core.Nothing, coresPerExecutor = Core.Nothing,
                    maxCores = Core.Nothing, memoryPerExecutorMb = Core.Nothing,
                    name = Core.Nothing, quantileDataStatus = Core.Nothing}
instance Core.FromJSON ApplicationInfo where
        parseJSON
          = Core.withObject "ApplicationInfo"
              (\ o ->
                 ApplicationInfo Core.<$>
                   (o Core..:? "applicationContextIngestionStatus") Core.<*>
                     (o Core..:? "applicationId")
...
instance Core.ToJSON ApplicationInfo where
        toJSON ApplicationInfo{..}
          = Core.object
              (Core.catMaybes
                 [("applicationContextIngestionStatus" Core..=) Core.<$>
...
newtype AuthenticationConfig = AuthenticationConfig
    {
      -- | Optional. Authentication type for the user workload running in containers.
      userWorkloadAuthenticationType :: (Core.Maybe AuthenticationConfig_UserWorkloadAuthenticationType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AuthenticationConfig' with the minimum fields required to make a request.
newAuthenticationConfig 
    ::  AuthenticationConfig
newAuthenticationConfig
...
instance Core.FromJSON AuthenticationConfig where
        parseJSON
          = Core.withObject "AuthenticationConfig"
              (\ o ->
                 AuthenticationConfig Core.<$>
                   (o Core..:? "userWorkloadAuthenticationType"))

instance Core.ToJSON AuthenticationConfig where
        toJSON AuthenticationConfig{..}
          = Core.object
              (Core.catMaybes
                 [("userWorkloadAuthenticationType" Core..=) Core.<$>
...
instance Core.FromJSON AutoscalingConfig where
        parseJSON
          = Core.withObject "AutoscalingConfig"
...
data AutoscalingPolicy = AutoscalingPolicy
    ...
    , clusterType :: (Core.Maybe AutoscalingPolicy_ClusterType)
...
newAutoscalingPolicy 
    ::  AutoscalingPolicy
newAutoscalingPolicy
  = AutoscalingPolicy{basicAlgorithm = Core.Nothing,
                      clusterType = Core.Nothing, id = Core.Nothing,
                      labels = Core.Nothing, name = Core.Nothing,
                      secondaryWorkerConfig = Core.Nothing, workerConfig = Core.Nothing}
instance Core.FromJSON AutoscalingPolicy where
        parseJSON
          = Core.withObject "AutoscalingPolicy"
              (\ o ->
                 AutoscalingPolicy Core.<$>
                   (o Core..:? "basicAlgorithm") Core.<*> (o Core..:? "clusterType")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("basicAlgorithm" Core..=) Core.<$> basicAlgorithm,
                  ("clusterType" Core..=) Core.<$> clusterType,
                  ("id" Core..=) Core.<$> id, ("labels" Core..=) Core.<$> labels,
                  ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON AutoscalingPolicy_Labels where
        parseJSON
          = Core.withObject "AutoscalingPolicy_Labels"
...
instance Core.FromJSON AutotuningConfig where
        parseJSON
          = Core.withObject "AutotuningConfig"
...
newAuxiliaryNodeGroup 
    ::  AuxiliaryNodeGroup
newAuxiliaryNodeGroup
  = AuxiliaryNodeGroup{nodeGroup = Core.Nothing,
                       nodeGroupId = Core.Nothing}
instance Core.FromJSON AuxiliaryNodeGroup where
        parseJSON
          = Core.withObject "AuxiliaryNodeGroup"
              (\ o ->
                 AuxiliaryNodeGroup Core.<$>
                   (o Core..:? "nodeGroup") Core.<*> (o Core..:? "nodeGroupId"))
...
newAuxiliaryServicesConfig 
    ::  AuxiliaryServicesConfig
newAuxiliaryServicesConfig
  = AuxiliaryServicesConfig{metastoreConfig = Core.Nothing,
                            sparkHistoryServerConfig = Core.Nothing}
instance Core.FromJSON AuxiliaryServicesConfig where
        parseJSON
          = Core.withObject "AuxiliaryServicesConfig"
              (\ o ->
                 AuxiliaryServicesConfig Core.<$>
                   (o Core..:? "metastoreConfig") Core.<*>
                     (o Core..:? "sparkHistoryServerConfig"))
          ...
          = Core.object
              (Core.catMaybes
                 [("metastoreConfig" Core..=) Core.<$> metastoreConfig,
                  ("sparkHistoryServerConfig" Core..=) Core.<$>
                    sparkHistoryServerConfig])
...
newBasicAutoscalingAlgorithm 
    ::  BasicAutoscalingAlgorithm
newBasicAutoscalingAlgorithm
  = BasicAutoscalingAlgorithm{cooldownPeriod = Core.Nothing,
                              sparkStandaloneConfig = Core.Nothing, yarnConfig = Core.Nothing}
instance Core.FromJSON BasicAutoscalingAlgorithm where
        parseJSON
          = Core.withObject "BasicAutoscalingAlgorithm"
              (\ o ->
                 BasicAutoscalingAlgorithm Core.<$>
                   (o Core..:? "cooldownPeriod") Core.<*>
                     (o Core..:? "sparkStandaloneConfig")
...
instance Core.FromJSON BasicYarnAutoscalingConfig where
        parseJSON
          = Core.withObject "BasicYarnAutoscalingConfig"
              (\ o ->
                 BasicYarnAutoscalingConfig Core.<$>
...
instance Core.ToJSON BasicYarnAutoscalingConfig where
        toJSON BasicYarnAutoscalingConfig{..}
          = Core.object
              (Core.catMaybes
                 [("gracefulDecommissionTimeout" Core..=) Core.<$>
                    gracefulDecommissionTimeout,
                  ("scaleDownFactor" Core..=) Core.<$> scaleDownFactor,
                  ("scaleDownMinWorkerFraction" Core..=) Core.<$>
                    scaleDownMinWorkerFraction,
                  ("scaleUpFactor" Core..=) Core.<$> scaleUpFactor,
                  ("scaleUpMinWorkerFraction" Core..=) Core.<$>
...
newBatch 
    ::  Batch
newBatch
  = Batch{createTime = Core.Nothing, creator = Core.Nothing,
          environmentConfig = Core.Nothing, labels = Core.Nothing,
          name = Core.Nothing, operation = Core.Nothing,
          pysparkBatch = Core.Nothing, runtimeConfig = Core.Nothing,
          runtimeInfo = Core.Nothing, sparkBatch = Core.Nothing,
          sparkRBatch = Core.Nothing, sparkSqlBatch = Core.Nothing,
          state = Core.Nothing, stateHistory = Core.Nothing,
          stateMessage = Core.Nothing, stateTime = Core.Nothing,
          uuid = Core.Nothing}
instance Core.FromJSON Batch where
        parseJSON
          = Core.withObject "Batch"
              (\ o ->
                 Batch Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "creator") Core.<*>
                     (o Core..:? "environmentConfig")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
...
newBatchOperationMetadata 
    ::  BatchOperationMetadata
newBatchOperationMetadata
  = BatchOperationMetadata{batch = Core.Nothing,
                           batchUuid = Core.Nothing, createTime = Core.Nothing,
                           description = Core.Nothing, doneTime = Core.Nothing,
                           labels = Core.Nothing, operationType = Core.Nothing,
                           warnings = Core.Nothing}
instance Core.FromJSON BatchOperationMetadata where
        parseJSON
          = Core.withObject "BatchOperationMetadata"
              (\ o ->
                 BatchOperationMetadata Core.<$>
                   (o Core..:? "batch") Core.<*> (o Core..:? "batchUuid") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "doneTime")
                     Core.<*> (o Core..:? "labels")
...
instance Core.FromJSON BatchOperationMetadata_Labels where
        parseJSON
          = Core.withObject "BatchOperationMetadata_Labels"
              (\ o ->
...
instance Core.FromJSON BuildInfo where
        parseJSON
          = Core.withObject "BuildInfo"
              (\ o ->
                 BuildInfo Core.<$>
                   (o Core..:? "buildKey") Core.<*> (o Core..:? "buildValue"))
...
instance Core.FromJSON CancelJobRequest where
        parseJSON
          = Core.withObject "CancelJobRequest"
...
newCluster 
    ::  Cluster
newCluster
  = Cluster{clusterName = Core.Nothing, clusterUuid = Core.Nothing,
            config = Core.Nothing, labels = Core.Nothing,
            metrics = Core.Nothing, projectId = Core.Nothing,
            status = Core.Nothing, statusHistory = Core.Nothing,
...
instance Core.FromJSON Cluster where
        parseJSON
          = Core.withObject "Cluster"
              (\ o ->
                 Cluster Core.<$>
                   (o Core..:? "clusterName") Core.<*> (o Core..:? "clusterUuid")
                     Core.<*> (o Core..:? "config")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "metrics")
...
instance Core.FromJSON Cluster_Labels where
        parseJSON
          = Core.withObject "Cluster_Labels"
...
data ClusterConfig = ClusterConfig
    ...
    , clusterTier :: (Core.Maybe ClusterConfig_ClusterTier)
      -- | Optional. The type of the cluster.
    , clusterType :: (Core.Maybe ClusterConfig_ClusterType)
...
newClusterConfig 
    ::  ClusterConfig
newClusterConfig
  = ClusterConfig{autoscalingConfig = Core.Nothing,
                  auxiliaryNodeGroups = Core.Nothing, clusterTier = Core.Nothing,
                  clusterType = Core.Nothing, configBucket = Core.Nothing,
                  dataprocMetricConfig = Core.Nothing,
                  encryptionConfig = Core.Nothing, endpointConfig = Core.Nothing,
                  gceClusterConfig = Core.Nothing, gkeClusterConfig = Core.Nothing,
                  initializationActions = Core.Nothing,
                  lifecycleConfig = Core.Nothing, masterConfig = Core.Nothing,
                  metastoreConfig = Core.Nothing,
                  secondaryWorkerConfig = Core.Nothing,
                  securityConfig = Core.Nothing, softwareConfig = Core.Nothing,
                  tempBucket = Core.Nothing, workerConfig = Core.Nothing}
instance Core.FromJSON ClusterConfig where
        parseJSON
          = Core.withObject "ClusterConfig"
              (\ o ->
                 ClusterConfig Core.<$>
                   (o Core..:? "autoscalingConfig") Core.<*>
                     (o Core..:? "auxiliaryNodeGroups")
                     Core.<*> (o Core..:? "clusterTier")
                     Core.<*> (o Core..:? "clusterType")
...
newClusterMetrics 
    ::  ClusterMetrics
newClusterMetrics
  = ClusterMetrics{hdfsMetrics = Core.Nothing,
                   yarnMetrics = Core.Nothing}
instance Core.FromJSON ClusterMetrics where
        parseJSON
          = Core.withObject "ClusterMetrics"
              (\ o ->
                 ClusterMetrics Core.<$>
                   (o Core..:? "hdfsMetrics") Core.<*> (o Core..:? "yarnMetrics"))
...
instance Core.FromJSON ClusterMetrics_HdfsMetrics where
        parseJSON
          = Core.withObject "ClusterMetrics_HdfsMetrics"
              (\ o ->
...
instance Core.FromJSON ClusterMetrics_YarnMetrics where
        parseJSON
          = Core.withObject "ClusterMetrics_YarnMetrics"
              (\ o ->
...
newClusterOperation 
    ::  ClusterOperation
newClusterOperation
  = ClusterOperation{done = Core.Nothing, error = Core.Nothing,
                     operationId = Core.Nothing}
instance Core.FromJSON ClusterOperation where
        parseJSON
          = Core.withObject "ClusterOperation"
              (\ o ->
                 ClusterOperation Core.<$>
                   (o Core..:? "done") Core.<*> (o Core..:? "error") Core.<*>
                     (o Core..:? "operationId"))
...
instance Core.ToJSON ClusterOperation where
        toJSON ClusterOperation{..}
          = Core.object
              (Core.catMaybes
                 [("done" Core..=) Core.<$> done, ("error" Core..=) Core.<$> error,
...
newClusterOperationMetadata 
    ::  ClusterOperationMetadata
newClusterOperationMetadata
  = ClusterOperationMetadata{childOperationIds = Core.Nothing,
                             clusterName = Core.Nothing, clusterUuid = Core.Nothing,
                             description = Core.Nothing, labels = Core.Nothing,
                             operationType = Core.Nothing, status = Core.Nothing,
                             statusHistory = Core.Nothing, warnings = Core.Nothing}
instance Core.FromJSON ClusterOperationMetadata where
        parseJSON
          = Core.withObject "ClusterOperationMetadata"
              (\ o ->
                 ClusterOperationMetadata Core.<$>
                   (o Core..:? "childOperationIds") Core.<*>
                     (o Core..:? "clusterName")
...
instance Core.FromJSON ClusterOperationMetadata_Labels where
        parseJSON
          = Core.withObject "ClusterOperationMetadata_Labels"
              (\ o ->
...
newClusterOperationStatus 
    ::  ClusterOperationStatus
newClusterOperationStatus
  = ClusterOperationStatus{details = Core.Nothing,
                           innerState = Core.Nothing, state = Core.Nothing,
                           stateStartTime = Core.Nothing}
instance Core.FromJSON ClusterOperationStatus where
        parseJSON
          = Core.withObject "ClusterOperationStatus"
              (\ o ->
                 ClusterOperationStatus Core.<$>
                   (o Core..:? "details") Core.<*> (o Core..:? "innerState") Core.<*>
                     (o Core..:? "state")
...
newClusterSelector 
    ::  ClusterSelector
newClusterSelector
  = ClusterSelector{clusterLabels = Core.Nothing,
                    zone = Core.Nothing}
instance Core.FromJSON ClusterSelector where
        parseJSON
          = Core.withObject "ClusterSelector"
              (\ o ->
                 ClusterSelector Core.<$>
                   (o Core..:? "clusterLabels") Core.<*> (o Core..:? "zone"))
...
instance Core.FromJSON ClusterSelector_ClusterLabels where
        parseJSON
          = Core.withObject "ClusterSelector_ClusterLabels"
              (\ o ->
...
newClusterStatus 
    ::  ClusterStatus
newClusterStatus
  = ClusterStatus{detail = Core.Nothing, state = Core.Nothing,
                  stateStartTime = Core.Nothing, substate = Core.Nothing}
instance Core.FromJSON ClusterStatus where
        parseJSON
          = Core.withObject "ClusterStatus"
              (\ o ->
                 ClusterStatus Core.<$>
                   (o Core..:? "detail") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "stateStartTime")
...
instance Core.FromJSON ClusterToRepair where
        parseJSON
          = Core.withObject "ClusterToRepair"
              (\ o ->
...
newConsolidatedExecutorSummary 
    ::  ConsolidatedExecutorSummary
newConsolidatedExecutorSummary
  = ConsolidatedExecutorSummary{activeTasks = Core.Nothing,
                                completedTasks = Core.Nothing, count = Core.Nothing,
                                diskUsed = Core.Nothing, failedTasks = Core.Nothing,
                                isExcluded = Core.Nothing, maxMemory = Core.Nothing,
                                memoryMetrics = Core.Nothing, memoryUsed = Core.Nothing,
                                rddBlocks = Core.Nothing, totalCores = Core.Nothing,
                                totalDurationMillis = Core.Nothing,
                                totalGcTimeMillis = Core.Nothing, totalInputBytes = Core.Nothing,
                                totalShuffleRead = Core.Nothing, totalShuffleWrite = Core.Nothing,
                                totalTasks = Core.Nothing}
instance Core.FromJSON ConsolidatedExecutorSummary where
        parseJSON
          = Core.withObject "ConsolidatedExecutorSummary"
              (\ o ->
                 ConsolidatedExecutorSummary Core.<$>
                   (o Core..:? "activeTasks") Core.<*> (o Core..:? "completedTasks")
                     Core.<*> (o Core..:? "count")
                     Core.<*> (o Core..:? "diskUsed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "failedTasks")
                     Core.<*> (o Core..:? "isExcluded")
                     Core.<*>
                     (o Core..:? "maxMemory" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "memoryMetrics")
                     Core.<*>
                     (o Core..:? "memoryUsed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "rddBlocks")
                     Core.<*> (o Core..:? "totalCores")
                     Core.<*>
                     (o Core..:? "totalDurationMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalGcTimeMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalInputBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalShuffleRead" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalShuffleWrite" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("activeTasks" Core..=) Core.<$> activeTasks,
                  ...
                  ("totalDurationMillis" Core..=) Core.. Core.AsText Core.<$>
                    totalDurationMillis,
                  ("totalGcTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    totalGcTimeMillis,
                  ("totalInputBytes" Core..=) Core.. Core.AsText Core.<$>
                    totalInputBytes,
                  ("totalShuffleRead" Core..=) Core.. Core.AsText Core.<$>
                    totalShuffleRead,
                  ("totalShuffleWrite" Core..=) Core.. Core.AsText Core.<$>
                    totalShuffleWrite,
...
instance Core.FromJSON DataprocMetricConfig where
        parseJSON
          = Core.withObject "DataprocMetricConfig"
...
newDiagnoseClusterRequest 
    ::  DiagnoseClusterRequest
newDiagnoseClusterRequest
  = DiagnoseClusterRequest{diagnosisInterval = Core.Nothing,
                           job = Core.Nothing, jobs = Core.Nothing,
                           tarballAccess = Core.Nothing, tarballGcsDir = Core.Nothing,
                           yarnApplicationId = Core.Nothing,
                           yarnApplicationIds = Core.Nothing}
instance Core.FromJSON DiagnoseClusterRequest where
        parseJSON
          = Core.withObject "DiagnoseClusterRequest"
              (\ o ->
                 DiagnoseClusterRequest Core.<$>
                   (o Core..:? "diagnosisInterval") Core.<*> (o Core..:? "job")
                     Core.<*> (o Core..:? "jobs")
          ...
          = Core.object
              (Core.catMaybes
                 [("diagnosisInterval" Core..=) Core.<$> diagnosisInterval,
                  ("job" Core..=) Core.<$> job, ("jobs" Core..=) Core.<$> jobs,
...
instance Core.FromJSON DiagnoseClusterResults where
        parseJSON
          = Core.withObject "DiagnoseClusterResults"
...
newDiskConfig 
    ::  DiskConfig
newDiskConfig
  = DiskConfig{bootDiskProvisionedIops = Core.Nothing,
               bootDiskProvisionedThroughput = Core.Nothing,
               bootDiskSizeGb = Core.Nothing, bootDiskType = Core.Nothing,
               localSsdInterface = Core.Nothing, numLocalSsds = Core.Nothing}
instance Core.FromJSON DiskConfig where
        parseJSON
          = Core.withObject "DiskConfig"
              (\ o ->
                 DiskConfig Core.<$>
                   (o Core..:? "bootDiskProvisionedIops" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "bootDiskProvisionedThroughput" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON DiskConfig where
        toJSON DiskConfig{..}
          = Core.object
              (Core.catMaybes
                 [("bootDiskProvisionedIops" Core..=) Core.. Core.AsText Core.<$>
                    bootDiskProvisionedIops,
                  ("bootDiskProvisionedThroughput" Core..=) Core.. Core.AsText
...
newDriverSchedulingConfig 
    ::  DriverSchedulingConfig
newDriverSchedulingConfig
  = DriverSchedulingConfig{memoryMb = Core.Nothing,
                           vcores = Core.Nothing}
instance Core.FromJSON DriverSchedulingConfig where
        parseJSON
          = Core.withObject "DriverSchedulingConfig"
              (\ o ->
                 DriverSchedulingConfig Core.<$>
                   (o Core..:? "memoryMb") Core.<*> (o Core..:? "vcores"))
...
newEncryptionConfig 
    ::  EncryptionConfig
newEncryptionConfig
  = EncryptionConfig{gcePdKmsKeyName = Core.Nothing,
                     kmsKey = Core.Nothing}
          ...
          = Core.withObject "EncryptionConfig"
              (\ o ->
                 EncryptionConfig Core.<$>
                   (o Core..:? "gcePdKmsKeyName") Core.<*> (o Core..:? "kmsKey"))
...
newEndpointConfig 
    ::  EndpointConfig
newEndpointConfig
  = EndpointConfig{enableHttpPortAccess = Core.Nothing,
                   httpPorts = Core.Nothing}
instance Core.FromJSON EndpointConfig where
        parseJSON
          = Core.withObject "EndpointConfig"
              (\ o ->
                 EndpointConfig Core.<$>
                   (o Core..:? "enableHttpPortAccess") Core.<*>
                     (o Core..:? "httpPorts"))
...
instance Core.FromJSON EndpointConfig_HttpPorts where
        parseJSON
          = Core.withObject "EndpointConfig_HttpPorts"
...
newEnvironmentConfig 
    ::  EnvironmentConfig
newEnvironmentConfig
  = EnvironmentConfig{executionConfig = Core.Nothing,
                      peripheralsConfig = Core.Nothing}
instance Core.FromJSON EnvironmentConfig where
        parseJSON
          = Core.withObject "EnvironmentConfig"
              (\ o ->
                 EnvironmentConfig Core.<$>
                   (o Core..:? "executionConfig") Core.<*>
                     (o Core..:? "peripheralsConfig"))
...
data ExecutionConfig = ExecutionConfig
    {
      ...
      authenticationConfig :: (Core.Maybe AuthenticationConfig)
...
newExecutionConfig 
    ::  ExecutionConfig
newExecutionConfig
  = ExecutionConfig{authenticationConfig = Core.Nothing,
                    idleTtl = Core.Nothing, kmsKey = Core.Nothing,
                    networkTags = Core.Nothing, networkUri = Core.Nothing,
                    serviceAccount = Core.Nothing, stagingBucket = Core.Nothing,
                    subnetworkUri = Core.Nothing, ttl = Core.Nothing}
instance Core.FromJSON ExecutionConfig where
        parseJSON
          = Core.withObject "ExecutionConfig"
              (\ o ->
                 ExecutionConfig Core.<$>
                   (o Core..:? "authenticationConfig") Core.<*> (o Core..:? "idleTtl")
                     Core.<*> (o Core..:? "kmsKey")
...
instance Core.ToJSON ExecutionConfig where
        toJSON ExecutionConfig{..}
          = Core.object
              (Core.catMaybes
                 [("authenticationConfig" Core..=) Core.<$> authenticationConfig,
...
instance Core.FromJSON ExecutorMetrics where
        parseJSON
          = Core.withObject "ExecutorMetrics"
...
instance Core.FromJSON ExecutorMetrics_Metrics where
        parseJSON
          = Core.withObject "ExecutorMetrics_Metrics"
...
newExecutorMetricsDistributions 
    ::  ExecutorMetricsDistributions
newExecutorMetricsDistributions
  = ExecutorMetricsDistributions{diskBytesSpilled = Core.Nothing,
                                 failedTasks = Core.Nothing, inputBytes = Core.Nothing,
                                 inputRecords = Core.Nothing, killedTasks = Core.Nothing,
                                 memoryBytesSpilled = Core.Nothing, outputBytes = Core.Nothing,
                                 outputRecords = Core.Nothing, peakMemoryMetrics = Core.Nothing,
                                 quantiles = Core.Nothing, shuffleRead = Core.Nothing,
                                 shuffleReadRecords = Core.Nothing, shuffleWrite = Core.Nothing,
                                 shuffleWriteRecords = Core.Nothing, succeededTasks = Core.Nothing,
                                 taskTimeMillis = Core.Nothing}
instance Core.FromJSON ExecutorMetricsDistributions where
        parseJSON
          = Core.withObject "ExecutorMetricsDistributions"
              (\ o ->
                 ExecutorMetricsDistributions Core.<$>
                   (o Core..:? "diskBytesSpilled") Core.<*> (o Core..:? "failedTasks")
...
newExecutorPeakMetricsDistributions 
    :: 
                                    ExecutorPeakMetricsDistributions
newExecutorPeakMetricsDistributions
  = ExecutorPeakMetricsDistributions{executorMetrics = Core.Nothing,
                                     quantiles = Core.Nothing}
instance Core.FromJSON ExecutorPeakMetricsDistributions where
        parseJSON
          = Core.withObject "ExecutorPeakMetricsDistributions"
              (\ o ->
                 ExecutorPeakMetricsDistributions Core.<$>
                   (o Core..:? "executorMetrics") Core.<*> (o Core..:? "quantiles"))
...
newExecutorResourceRequest 
    ::  ExecutorResourceRequest
newExecutorResourceRequest
  = ExecutorResourceRequest{amount = Core.Nothing,
                            discoveryScript = Core.Nothing, resourceName = Core.Nothing,
                            vendor = Core.Nothing}
instance Core.FromJSON ExecutorResourceRequest where
        parseJSON
          = Core.withObject "ExecutorResourceRequest"
              (\ o ->
                 ExecutorResourceRequest Core.<$>
                   (o Core..:? "amount" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "discoveryScript")
...
newExecutorStageSummary 
    ::  ExecutorStageSummary
newExecutorStageSummary
  = ExecutorStageSummary{diskBytesSpilled = Core.Nothing,
                         executorId = Core.Nothing, failedTasks = Core.Nothing,
                         inputBytes = Core.Nothing, inputRecords = Core.Nothing,
                         isExcludedForStage = Core.Nothing, killedTasks = Core.Nothing,
                         memoryBytesSpilled = Core.Nothing, outputBytes = Core.Nothing,
                         outputRecords = Core.Nothing, peakMemoryMetrics = Core.Nothing,
                         shuffleRead = Core.Nothing, shuffleReadRecords = Core.Nothing,
                         shuffleWrite = Core.Nothing, shuffleWriteRecords = Core.Nothing,
                         stageAttemptId = Core.Nothing, stageId = Core.Nothing,
                         succeededTasks = Core.Nothing, taskTimeMillis = Core.Nothing}
instance Core.FromJSON ExecutorStageSummary where
        parseJSON
          = Core.withObject "ExecutorStageSummary"
              (\ o ->
                 ExecutorStageSummary Core.<$>
                   (o Core..:? "diskBytesSpilled" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "executorId")
                     Core.<*> (o Core..:? "failedTasks")
                     Core.<*>
                     (o Core..:? "inputBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "inputRecords" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "isExcludedForStage")
                     Core.<*> (o Core..:? "killedTasks")
                     Core.<*>
                     (o Core..:? "memoryBytesSpilled" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "outputBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "outputRecords" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "peakMemoryMetrics")
                     Core.<*>
                     (o Core..:? "shuffleRead" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shuffleReadRecords" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shuffleWrite" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shuffleWriteRecords" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "stageAttemptId")
                     Core.<*> (o Core..:? "stageId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "succeededTasks")
                     Core.<*>
                     (o Core..:? "taskTimeMillis" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON ExecutorStageSummary where
        toJSON ExecutorStageSummary{..}
          = Core.object
              (Core.catMaybes
                 [("diskBytesSpilled" Core..=) Core.. Core.AsText Core.<$>
                    diskBytesSpilled,
...
newExecutorSummary 
    ::  ExecutorSummary
newExecutorSummary
  = ExecutorSummary{activeTasks = Core.Nothing,
                    addTime = Core.Nothing, attributes = Core.Nothing,
                    completedTasks = Core.Nothing, diskUsed = Core.Nothing,
                    excludedInStages = Core.Nothing, executorId = Core.Nothing,
                    executorLogs = Core.Nothing, failedTasks = Core.Nothing,
                    hostPort = Core.Nothing, isActive = Core.Nothing,
                    isExcluded = Core.Nothing, maxMemory = Core.Nothing,
                    maxTasks = Core.Nothing, memoryMetrics = Core.Nothing,
                    memoryUsed = Core.Nothing, peakMemoryMetrics = Core.Nothing,
                    rddBlocks = Core.Nothing, removeReason = Core.Nothing,
                    removeTime = Core.Nothing, resourceProfileId = Core.Nothing,
                    resources = Core.Nothing, totalCores = Core.Nothing,
                    totalDurationMillis = Core.Nothing,
                    totalGcTimeMillis = Core.Nothing, totalInputBytes = Core.Nothing,
                    totalShuffleRead = Core.Nothing, totalShuffleWrite = Core.Nothing,
                    totalTasks = Core.Nothing}
instance Core.FromJSON ExecutorSummary where
        parseJSON
          = Core.withObject "ExecutorSummary"
              (\ o ->
                 ExecutorSummary Core.<$>
                   (o Core..:? "activeTasks") Core.<*> (o Core..:? "addTime") Core.<*>
                     (o Core..:? "attributes")
                     Core.<*> (o Core..:? "completedTasks")
                     Core.<*> (o Core..:? "diskUsed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "excludedInStages" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("activeTasks" Core..=) Core.<$> activeTasks,
                  ...
                  ("completedTasks" Core..=) Core.<$> completedTasks,
                  ("diskUsed" Core..=) Core.. Core.AsText Core.<$> diskUsed,
                  ("excludedInStages" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    excludedInStages,
                  ("executorId" Core..=) Core.<$> executorId,
...
instance Core.FromJSON ExecutorSummary_Attributes where
        parseJSON
          = Core.withObject "ExecutorSummary_Attributes"
              (\ o ->
...
instance Core.FromJSON ExecutorSummary_ExecutorLogs where
        parseJSON
          = Core.withObject "ExecutorSummary_ExecutorLogs"
              (\ o ->
...
instance Core.FromJSON ExecutorSummary_Resources where
        parseJSON
          = Core.withObject "ExecutorSummary_Resources"
              (\ o ->
...
newFallbackReason 
    ::  FallbackReason
newFallbackReason
  = FallbackReason{fallbackNode = Core.Nothing,
                   fallbackReason = Core.Nothing}
instance Core.FromJSON FallbackReason where
        parseJSON
          = Core.withObject "FallbackReason"
              (\ o ->
                 FallbackReason Core.<$>
                   (o Core..:? "fallbackNode") Core.<*> (o Core..:? "fallbackReason"))
...
newFlinkJob 
    ::  FlinkJob
newFlinkJob
  = FlinkJob{args = Core.Nothing, jarFileUris = Core.Nothing,
             loggingConfig = Core.Nothing, mainClass = Core.Nothing,
             mainJarFileUri = Core.Nothing, properties = Core.Nothing,
             savepointUri = Core.Nothing}
instance Core.FromJSON FlinkJob where
        parseJSON
          = Core.withObject "FlinkJob"
              (\ o ->
                 FlinkJob Core.<$>
                   (o Core..:? "args") Core.<*> (o Core..:? "jarFileUris") Core.<*>
                     (o Core..:? "loggingConfig")
...
instance Core.FromJSON FlinkJob_Properties where
        parseJSON
          = Core.withObject "FlinkJob_Properties"
...
newGceClusterConfig 
    ::  GceClusterConfig
newGceClusterConfig
  = GceClusterConfig{confidentialInstanceConfig = Core.Nothing,
                     internalIpOnly = Core.Nothing, metadata = Core.Nothing,
                     networkUri = Core.Nothing, nodeGroupAffinity = Core.Nothing,
                     privateIpv6GoogleAccess = Core.Nothing,
                     reservationAffinity = Core.Nothing,
                     resourceManagerTags = Core.Nothing, serviceAccount = Core.Nothing,
                     serviceAccountScopes = Core.Nothing,
                     shieldedInstanceConfig = Core.Nothing,
                     subnetworkUri = Core.Nothing, tags = Core.Nothing,
                     zoneUri = Core.Nothing}
instance Core.FromJSON GceClusterConfig where
        parseJSON
          = Core.withObject "GceClusterConfig"
              (\ o ->
                 GceClusterConfig Core.<$>
                   (o Core..:? "confidentialInstanceConfig") Core.<*>
                     (o Core..:? "internalIpOnly")
...
instance Core.FromJSON GceClusterConfig_Metadata where
        parseJSON
          = Core.withObject "GceClusterConfig_Metadata"
              (\ o ->
...
instance Core.FromJSON GceClusterConfig_ResourceManagerTags where
        parseJSON
          = Core.withObject "GceClusterConfig_ResourceManagerTags"
              (\ o ->
                 GceClusterConfig_ResourceManagerTags Core.<$>
                   (Core.parseJSONObject o))
...
newGkeClusterConfig 
    ::  GkeClusterConfig
newGkeClusterConfig
  = GkeClusterConfig{gkeClusterTarget = Core.Nothing,
                     namespacedGkeDeploymentTarget = Core.Nothing,
                     nodePoolTarget = Core.Nothing}
instance Core.FromJSON GkeClusterConfig where
        parseJSON
          = Core.withObject "GkeClusterConfig"
              (\ o ->
                 GkeClusterConfig Core.<$>
                   (o Core..:? "gkeClusterTarget") Core.<*>
                     (o Core..:? "namespacedGkeDeploymentTarget")
          ...
          = Core.object
              (Core.catMaybes
                 [("gkeClusterTarget" Core..=) Core.<$> gkeClusterTarget,
                  ("namespacedGkeDeploymentTarget" Core..=) Core.<$>
                    namespacedGkeDeploymentTarget,
...
newGkeNodeConfig 
    ::  GkeNodeConfig
newGkeNodeConfig
  = GkeNodeConfig{accelerators = Core.Nothing,
                  bootDiskKmsKey = Core.Nothing, localSsdCount = Core.Nothing,
                  machineType = Core.Nothing, minCpuPlatform = Core.Nothing,
                  preemptible = Core.Nothing, spot = Core.Nothing}
instance Core.FromJSON GkeNodeConfig where
        parseJSON
          = Core.withObject "GkeNodeConfig"
              (\ o ->
                 GkeNodeConfig Core.<$>
                   (o Core..:? "accelerators") Core.<*> (o Core..:? "bootDiskKmsKey")
...
newGkeNodePoolAcceleratorConfig 
    ::  GkeNodePoolAcceleratorConfig
newGkeNodePoolAcceleratorConfig
  = GkeNodePoolAcceleratorConfig{acceleratorCount = Core.Nothing,
                                 acceleratorType = Core.Nothing, gpuPartitionSize = Core.Nothing}
instance Core.FromJSON GkeNodePoolAcceleratorConfig where
        parseJSON
          = Core.withObject "GkeNodePoolAcceleratorConfig"
              (\ o ->
                 GkeNodePoolAcceleratorConfig Core.<$>
                   (o Core..:? "acceleratorCount" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON GkeNodePoolAcceleratorConfig where
        toJSON GkeNodePoolAcceleratorConfig{..}
          = Core.object
              (Core.catMaybes
                 [("acceleratorCount" Core..=) Core.. Core.AsText Core.<$>
                    acceleratorCount,
...
newGkeNodePoolAutoscalingConfig 
    ::  GkeNodePoolAutoscalingConfig
newGkeNodePoolAutoscalingConfig
  = GkeNodePoolAutoscalingConfig{maxNodeCount = Core.Nothing,
                                 minNodeCount = Core.Nothing}
instance Core.FromJSON GkeNodePoolAutoscalingConfig where
        parseJSON
          = Core.withObject "GkeNodePoolAutoscalingConfig"
              (\ o ->
                 GkeNodePoolAutoscalingConfig Core.<$>
                   (o Core..:? "maxNodeCount") Core.<*> (o Core..:? "minNodeCount"))
...
newGkeNodePoolConfig 
    ::  GkeNodePoolConfig
newGkeNodePoolConfig
  = GkeNodePoolConfig{autoscaling = Core.Nothing,
                      config = Core.Nothing, locations = Core.Nothing}
instance Core.FromJSON GkeNodePoolConfig where
        parseJSON
          = Core.withObject "GkeNodePoolConfig"
              (\ o ->
                 GkeNodePoolConfig Core.<$>
                   (o Core..:? "autoscaling") Core.<*> (o Core..:? "config") Core.<*>
                     (o Core..:? "locations"))
...
newGkeNodePoolTarget 
    ::  GkeNodePoolTarget
newGkeNodePoolTarget
  = GkeNodePoolTarget{nodePool = Core.Nothing,
                      nodePoolConfig = Core.Nothing, roles = Core.Nothing}
instance Core.FromJSON GkeNodePoolTarget where
        parseJSON
          = Core.withObject "GkeNodePoolTarget"
              (\ o ->
                 GkeNodePoolTarget Core.<$>
                   (o Core..:? "nodePool") Core.<*> (o Core..:? "nodePoolConfig")
                     Core.<*> (o Core..:? "roles"))
...
newGoogleCloudDataprocV1WorkflowTemplateEncryptionConfig 
    :: 
                                                         GoogleCloudDataprocV1WorkflowTemplateEncryptionConfig
newGoogleCloudDataprocV1WorkflowTemplateEncryptionConfig
  = GoogleCloudDataprocV1WorkflowTemplateEncryptionConfig{kmsKey =
                                                            Core.Nothing}
instance Core.FromJSON
           GoogleCloudDataprocV1WorkflowTemplateEncryptionConfig
         where
        parseJSON
          = Core.withObject
              "GoogleCloudDataprocV1WorkflowTemplateEncryptionConfig"
              (\ o ->
                 GoogleCloudDataprocV1WorkflowTemplateEncryptionConfig Core.<$>
                   (o Core..:? "kmsKey"))
...
newHadoopJob 
    ::  HadoopJob
newHadoopJob
  = HadoopJob{archiveUris = Core.Nothing, args = Core.Nothing,
              fileUris = Core.Nothing, jarFileUris = Core.Nothing,
              loggingConfig = Core.Nothing, mainClass = Core.Nothing,
              mainJarFileUri = Core.Nothing, properties = Core.Nothing}
instance Core.FromJSON HadoopJob where
        parseJSON
          = Core.withObject "HadoopJob"
              (\ o ->
                 HadoopJob Core.<$>
                   (o Core..:? "archiveUris") Core.<*> (o Core..:? "args") Core.<*>
                     (o Core..:? "fileUris")
...
instance Core.FromJSON HadoopJob_Properties where
        parseJSON
          = Core.withObject "HadoopJob_Properties"
...
newHiveJob 
    ::  HiveJob
newHiveJob
  = HiveJob{continueOnFailure = Core.Nothing,
            jarFileUris = Core.Nothing, properties = Core.Nothing,
            queryFileUri = Core.Nothing, queryList = Core.Nothing,
            scriptVariables = Core.Nothing}
instance Core.FromJSON HiveJob where
        parseJSON
          = Core.withObject "HiveJob"
              (\ o ->
                 HiveJob Core.<$>
                   (o Core..:? "continueOnFailure") Core.<*>
                     (o Core..:? "jarFileUris")
                     Core.<*> (o Core..:? "properties")
...
instance Core.FromJSON HiveJob_Properties where
        parseJSON
          = Core.withObject "HiveJob_Properties"
...
instance Core.FromJSON HiveJob_ScriptVariables where
        parseJSON
          = Core.withObject "HiveJob_ScriptVariables"
...
instance Core.FromJSON IdentityConfig where
        parseJSON
          = Core.withObject "IdentityConfig"
              (\ o ->
...
instance Core.ToJSON IdentityConfig where
        toJSON IdentityConfig{..}
          = Core.object
              (Core.catMaybes
                 [("userServiceAccountMapping" Core..=) Core.<$>
...
instance Core.FromJSON IdentityConfig_UserServiceAccountMapping
         where
        parseJSON
          = Core.withObject "IdentityConfig_UserServiceAccountMapping"
              (\ o ->
                 IdentityConfig_UserServiceAccountMapping Core.<$>
                   (Core.parseJSONObject o))
...
newInjectCredentialsRequest 
    ::  InjectCredentialsRequest
newInjectCredentialsRequest
  = InjectCredentialsRequest{clusterUuid = Core.Nothing,
                             credentialsCiphertext = Core.Nothing}
instance Core.FromJSON InjectCredentialsRequest where
        parseJSON
          = Core.withObject "InjectCredentialsRequest"
              (\ o ->
                 InjectCredentialsRequest Core.<$>
                   (o Core..:? "clusterUuid") Core.<*>
                     (o Core..:? "credentialsCiphertext"))
...
newInputMetrics 
    ::  InputMetrics
newInputMetrics
  = InputMetrics{bytesRead = Core.Nothing,
                 recordsRead = Core.Nothing}
instance Core.FromJSON InputMetrics where
        parseJSON
          = Core.withObject "InputMetrics"
              (\ o ->
                 InputMetrics Core.<$>
                   (o Core..:? "bytesRead" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "recordsRead" Core.<&> Core.fmap Core.fromAsText))
...
newInputQuantileMetrics 
    ::  InputQuantileMetrics
newInputQuantileMetrics
  = InputQuantileMetrics{bytesRead = Core.Nothing,
                         recordsRead = Core.Nothing}
instance Core.FromJSON InputQuantileMetrics where
        parseJSON
          = Core.withObject "InputQuantileMetrics"
              (\ o ->
                 InputQuantileMetrics Core.<$>
                   (o Core..:? "bytesRead") Core.<*> (o Core..:? "recordsRead"))
...
newInstanceFlexibilityPolicy 
    ::  InstanceFlexibilityPolicy
newInstanceFlexibilityPolicy
  = InstanceFlexibilityPolicy{instanceSelectionList = Core.Nothing,
...
instance Core.FromJSON InstanceFlexibilityPolicy where
        parseJSON
          = Core.withObject "InstanceFlexibilityPolicy"
              (\ o ->
                 InstanceFlexibilityPolicy Core.<$>
                   (o Core..:? "instanceSelectionList") Core.<*>
                     (o Core..:? "instanceSelectionResults")
          ...
          = Core.object
              (Core.catMaybes
                 [("instanceSelectionList" Core..=) Core.<$> instanceSelectionList,
                  ("instanceSelectionResults" Core..=) Core.<$>
...
newInstanceGroupAutoscalingPolicyConfig 
    :: 
                                        InstanceGroupAutoscalingPolicyConfig
newInstanceGroupAutoscalingPolicyConfig
  = InstanceGroupAutoscalingPolicyConfig{maxInstances = Core.Nothing,
                                         minInstances = Core.Nothing, weight = Core.Nothing}
instance Core.FromJSON InstanceGroupAutoscalingPolicyConfig where
        parseJSON
          = Core.withObject "InstanceGroupAutoscalingPolicyConfig"
              (\ o ->
                 InstanceGroupAutoscalingPolicyConfig Core.<$>
                   (o Core..:? "maxInstances") Core.<*> (o Core..:? "minInstances")
                     Core.<*> (o Core..:? "weight"))
...
newInstanceGroupConfig 
    ::  InstanceGroupConfig
newInstanceGroupConfig
  = InstanceGroupConfig{accelerators = Core.Nothing,
                        diskConfig = Core.Nothing, imageUri = Core.Nothing,
                        instanceFlexibilityPolicy = Core.Nothing,
                        instanceNames = Core.Nothing, instanceReferences = Core.Nothing,
                        isPreemptible = Core.Nothing, machineTypeUri = Core.Nothing,
                        managedGroupConfig = Core.Nothing, minCpuPlatform = Core.Nothing,
                        minNumInstances = Core.Nothing, numInstances = Core.Nothing,
                        preemptibility = Core.Nothing, startupConfig = Core.Nothing}
instance Core.FromJSON InstanceGroupConfig where
        parseJSON
          = Core.withObject "InstanceGroupConfig"
              (\ o ->
                 InstanceGroupConfig Core.<$>
                   (o Core..:? "accelerators") Core.<*> (o Core..:? "diskConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("accelerators" Core..=) Core.<$> accelerators,
                  ...
                  ("instanceFlexibilityPolicy" Core..=) Core.<$>
                    instanceFlexibilityPolicy,
...
newInstanceReference 
    ::  InstanceReference
newInstanceReference
  = InstanceReference{instanceId = Core.Nothing,
                      instanceName = Core.Nothing, publicEciesKey = Core.Nothing,
                      publicKey = Core.Nothing}
instance Core.FromJSON InstanceReference where
        parseJSON
          = Core.withObject "InstanceReference"
              (\ o ->
                 InstanceReference Core.<$>
                   (o Core..:? "instanceId") Core.<*> (o Core..:? "instanceName")
...
newInstanceSelection 
    ::  InstanceSelection
newInstanceSelection
  = InstanceSelection{machineTypes = Core.Nothing,
                      rank = Core.Nothing}
instance Core.FromJSON InstanceSelection where
        parseJSON
          = Core.withObject "InstanceSelection"
              (\ o ->
                 InstanceSelection Core.<$>
                   (o Core..:? "machineTypes") Core.<*> (o Core..:? "rank"))
...
newInstanceSelectionResult 
    ::  InstanceSelectionResult
newInstanceSelectionResult
  = InstanceSelectionResult{machineType = Core.Nothing,
                            vmCount = Core.Nothing}
instance Core.FromJSON InstanceSelectionResult where
        parseJSON
          = Core.withObject "InstanceSelectionResult"
              (\ o ->
                 InstanceSelectionResult Core.<$>
                   (o Core..:? "machineType") Core.<*> (o Core..:? "vmCount"))
...
newInstantiateWorkflowTemplateRequest 
    :: 
                                      InstantiateWorkflowTemplateRequest
newInstantiateWorkflowTemplateRequest
  = InstantiateWorkflowTemplateRequest{parameters = Core.Nothing,
                                       requestId = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON InstantiateWorkflowTemplateRequest where
        parseJSON
          = Core.withObject "InstantiateWorkflowTemplateRequest"
              (\ o ->
                 InstantiateWorkflowTemplateRequest Core.<$>
                   (o Core..:? "parameters") Core.<*> (o Core..:? "requestId")
                     Core.<*> (o Core..:? "version"))
...
newInstantiateWorkflowTemplateRequest_Parameters additional
  = InstantiateWorkflowTemplateRequest_Parameters{additional =
                                                    additional}
instance Core.FromJSON
           InstantiateWorkflowTemplateRequest_Parameters
         where
        parseJSON
          = Core.withObject "InstantiateWorkflowTemplateRequest_Parameters"
              (\ o ->
                 InstantiateWorkflowTemplateRequest_Parameters Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON InstantiateWorkflowTemplateRequest_Parameters
         where
...
instance Core.FromJSON Interval where
        parseJSON
          = Core.withObject "Interval"
              (\ o ->
                 Interval Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "startTime"))
...
newJob 
    ::  Job
newJob
  = Job{done = Core.Nothing, driverControlFilesUri = Core.Nothing,
        driverOutputResourceUri = Core.Nothing,
        driverSchedulingConfig = Core.Nothing, flinkJob = Core.Nothing,
        hadoopJob = Core.Nothing, hiveJob = Core.Nothing,
        jobUuid = Core.Nothing, labels = Core.Nothing,
        pigJob = Core.Nothing, placement = Core.Nothing,
        prestoJob = Core.Nothing, pysparkJob = Core.Nothing,
        reference = Core.Nothing, scheduling = Core.Nothing,
        sparkJob = Core.Nothing, sparkRJob = Core.Nothing,
        sparkSqlJob = Core.Nothing, status = Core.Nothing,
        statusHistory = Core.Nothing, trinoJob = Core.Nothing,
...
instance Core.FromJSON Job where
        parseJSON
          = Core.withObject "Job"
              (\ o ->
                 Job Core.<$>
                   (o Core..:? "done") Core.<*> (o Core..:? "driverControlFilesUri")
          ...
          = Core.object
              (Core.catMaybes
                 [("done" Core..=) Core.<$> done,
                  ...
                  ("driverOutputResourceUri" Core..=) Core.<$>
...
newJobData 
    ::  JobData
newJobData
  = JobData{completionTime = Core.Nothing,
            description = Core.Nothing, jobGroup = Core.Nothing,
            jobId = Core.Nothing, killTasksSummary = Core.Nothing,
            name = Core.Nothing, numActiveStages = Core.Nothing,
            numActiveTasks = Core.Nothing, numCompletedIndices = Core.Nothing,
            numCompletedStages = Core.Nothing,
            numCompletedTasks = Core.Nothing, numFailedStages = Core.Nothing,
            numFailedTasks = Core.Nothing, numKilledTasks = Core.Nothing,
            numSkippedStages = Core.Nothing, numSkippedTasks = Core.Nothing,
            numTasks = Core.Nothing, skippedStages = Core.Nothing,
            sqlExecutionId = Core.Nothing, stageIds = Core.Nothing,
            status = Core.Nothing, submissionTime = Core.Nothing}
instance Core.FromJSON JobData where
        parseJSON
          = Core.withObject "JobData"
              (\ o ->
                 JobData Core.<$>
                   (o Core..:? "completionTime") Core.<*> (o Core..:? "description")
                     ...
                     Core.<*>
                     (o Core..:? "sqlExecutionId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "stageIds" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*> (o Core..:? "status")
          ...
          = Core.object
              (Core.catMaybes
                 [("completionTime" Core..=) Core.<$> completionTime,
                  ...
                  ("sqlExecutionId" Core..=) Core.. Core.AsText Core.<$>
                    sqlExecutionId,
                  ("stageIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    stageIds,
                  ("status" Core..=) Core.<$> status,
...
instance Core.FromJSON JobData_KillTasksSummary where
        parseJSON
          = Core.withObject "JobData_KillTasksSummary"
...
newJobMetadata 
    ::  JobMetadata
newJobMetadata
  = JobMetadata{jobId = Core.Nothing, operationType = Core.Nothing,
...
instance Core.FromJSON JobMetadata where
        parseJSON
          = Core.withObject "JobMetadata"
              (\ o ->
                 JobMetadata Core.<$>
                   (o Core..:? "jobId") Core.<*> (o Core..:? "operationType") Core.<*>
                     (o Core..:? "startTime")
                     Core.<*> (o Core..:? "status"))
...
newJobPlacement 
    ::  JobPlacement
newJobPlacement
  = JobPlacement{clusterLabels = Core.Nothing,
                 clusterName = Core.Nothing, clusterUuid = Core.Nothing}
instance Core.FromJSON JobPlacement where
        parseJSON
          = Core.withObject "JobPlacement"
              (\ o ->
                 JobPlacement Core.<$>
                   (o Core..:? "clusterLabels") Core.<*> (o Core..:? "clusterName")
                     Core.<*> (o Core..:? "clusterUuid"))
...
instance Core.FromJSON JobPlacement_ClusterLabels where
        parseJSON
          = Core.withObject "JobPlacement_ClusterLabels"
              (\ o ->
...
instance Core.FromJSON JobReference where
        parseJSON
          = Core.withObject "JobReference"
              (\ o ->
                 JobReference Core.<$>
                   (o Core..:? "jobId") Core.<*> (o Core..:? "projectId"))
...
newJobScheduling 
    ::  JobScheduling
newJobScheduling
  = JobScheduling{maxFailuresPerHour = Core.Nothing,
                  maxFailuresTotal = Core.Nothing}
instance Core.FromJSON JobScheduling where
        parseJSON
          = Core.withObject "JobScheduling"
              (\ o ->
                 JobScheduling Core.<$>
                   (o Core..:? "maxFailuresPerHour") Core.<*>
                     (o Core..:? "maxFailuresTotal"))
...
newJobStatus 
    ::  JobStatus
newJobStatus
  = JobStatus{details = Core.Nothing, state = Core.Nothing,
              stateStartTime = Core.Nothing, substate = Core.Nothing}
instance Core.FromJSON JobStatus where
        parseJSON
          = Core.withObject "JobStatus"
              (\ o ->
                 JobStatus Core.<$>
                   (o Core..:? "details") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "stateStartTime")
                     Core.<*> (o Core..:? "substate"))
...
newJobsSummary 
    ::  JobsSummary
newJobsSummary
  = JobsSummary{activeJobs = Core.Nothing,
                applicationId = Core.Nothing, attempts = Core.Nothing,
                completedJobs = Core.Nothing, failedJobs = Core.Nothing,
                schedulingMode = Core.Nothing}
instance Core.FromJSON JobsSummary where
        parseJSON
          = Core.withObject "JobsSummary"
              (\ o ->
                 JobsSummary Core.<$>
                   (o Core..:? "activeJobs") Core.<*> (o Core..:? "applicationId")
                     Core.<*> (o Core..:? "attempts")
...
instance Core.FromJSON JupyterConfig where
        parseJSON
          = Core.withObject "JupyterConfig"
              (\ o ->
                 JupyterConfig Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "kernel"))
...
newKerberosConfig 
    ::  KerberosConfig
newKerberosConfig
  = KerberosConfig{crossRealmTrustAdminServer = Core.Nothing,
                   crossRealmTrustKdc = Core.Nothing,
                   crossRealmTrustRealm = Core.Nothing,
                   crossRealmTrustSharedPasswordUri = Core.Nothing,
                   enableKerberos = Core.Nothing, kdcDbKeyUri = Core.Nothing,
                   keyPasswordUri = Core.Nothing, keystorePasswordUri = Core.Nothing,
                   keystoreUri = Core.Nothing, kmsKeyUri = Core.Nothing,
                   realm = Core.Nothing, rootPrincipalPasswordUri = Core.Nothing,
                   tgtLifetimeHours = Core.Nothing,
                   truststorePasswordUri = Core.Nothing, truststoreUri = Core.Nothing}
instance Core.FromJSON KerberosConfig where
        parseJSON
          = Core.withObject "KerberosConfig"
              (\ o ->
                 KerberosConfig Core.<$>
                   (o Core..:? "crossRealmTrustAdminServer") Core.<*>
                     (o Core..:? "crossRealmTrustKdc")
          ...
          = Core.object
              (Core.catMaybes
                 [("crossRealmTrustAdminServer" Core..=) Core.<$>
                  ...
                  ("rootPrincipalPasswordUri" Core..=) Core.<$>
...
newKubernetesClusterConfig 
    ::  KubernetesClusterConfig
newKubernetesClusterConfig
  = KubernetesClusterConfig{gkeClusterConfig = Core.Nothing,
...
instance Core.FromJSON KubernetesClusterConfig where
        parseJSON
          = Core.withObject "KubernetesClusterConfig"
              (\ o ->
                 KubernetesClusterConfig Core.<$>
                   (o Core..:? "gkeClusterConfig") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("gkeClusterConfig" Core..=) Core.<$> gkeClusterConfig,
                  ...
                  ("kubernetesSoftwareConfig" Core..=) Core.<$>
                    kubernetesSoftwareConfig])
...
newKubernetesSoftwareConfig 
    ::  KubernetesSoftwareConfig
newKubernetesSoftwareConfig
  = KubernetesSoftwareConfig{componentVersion = Core.Nothing,
                             properties = Core.Nothing}
instance Core.FromJSON KubernetesSoftwareConfig where
        parseJSON
          = Core.withObject "KubernetesSoftwareConfig"
              (\ o ->
                 KubernetesSoftwareConfig Core.<$>
                   (o Core..:? "componentVersion") Core.<*> (o Core..:? "properties"))
...
newKubernetesSoftwareConfig_ComponentVersion additional
  = KubernetesSoftwareConfig_ComponentVersion{additional =
                                                additional}
instance Core.FromJSON KubernetesSoftwareConfig_ComponentVersion
         where
        parseJSON
          = Core.withObject "KubernetesSoftwareConfig_ComponentVersion"
              (\ o ->
                 KubernetesSoftwareConfig_ComponentVersion Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON KubernetesSoftwareConfig_ComponentVersion
         where
...
instance Core.FromJSON KubernetesSoftwareConfig_Properties where
        parseJSON
          = Core.withObject "KubernetesSoftwareConfig_Properties"
              (\ o ->
                 KubernetesSoftwareConfig_Properties Core.<$>
                   (Core.parseJSONObject o))
...
newLifecycleConfig 
    ::  LifecycleConfig
newLifecycleConfig
  = LifecycleConfig{autoDeleteTime = Core.Nothing,
                    autoDeleteTtl = Core.Nothing, idleDeleteTtl = Core.Nothing,
                    idleStartTime = Core.Nothing}
instance Core.FromJSON LifecycleConfig where
        parseJSON
          = Core.withObject "LifecycleConfig"
              (\ o ->
                 LifecycleConfig Core.<$>
                   (o Core..:? "autoDeleteTime") Core.<*> (o Core..:? "autoDeleteTtl")
...
newListAutoscalingPoliciesResponse 
    :: 
                                   ListAutoscalingPoliciesResponse
newListAutoscalingPoliciesResponse
  = ListAutoscalingPoliciesResponse{nextPageToken = Core.Nothing,
                                    policies = Core.Nothing}
instance Core.FromJSON ListAutoscalingPoliciesResponse where
        parseJSON
          = Core.withObject "ListAutoscalingPoliciesResponse"
              (\ o ->
                 ListAutoscalingPoliciesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "policies"))
...
newListBatchesResponse 
    ::  ListBatchesResponse
newListBatchesResponse
  = ListBatchesResponse{batches = Core.Nothing,
                        nextPageToken = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListBatchesResponse where
        parseJSON
          = Core.withObject "ListBatchesResponse"
              (\ o ->
                 ListBatchesResponse Core.<$>
                   (o Core..:? "batches") Core.<*> (o Core..:? "nextPageToken")
          ...
          = Core.withObject "ListClustersResponse"
              (\ o ->
                 ListClustersResponse Core.<$>
                   (o Core..:? "clusters") Core.<*> (o Core..:? "nextPageToken"))
...
newListJobsResponse 
    ::  ListJobsResponse
newListJobsResponse
  = ListJobsResponse{jobs = Core.Nothing,
                     nextPageToken = Core.Nothing, unreachable = Core.Nothing}
          ...
          = Core.withObject "ListJobsResponse"
              (\ o ->
                 ListJobsResponse Core.<$>
                   (o Core..:? "jobs") Core.<*> (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "unreachable"))
...
newListOperationsResponse 
    ::  ListOperationsResponse
newListOperationsResponse
  = ListOperationsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListOperationsResponse"
              (\ o ->
                 ListOperationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "operations"))
...
newListSessionTemplatesResponse 
    ::  ListSessionTemplatesResponse
newListSessionTemplatesResponse
  = ListSessionTemplatesResponse{nextPageToken = Core.Nothing,
                                 sessionTemplates = Core.Nothing}
instance Core.FromJSON ListSessionTemplatesResponse where
        parseJSON
          = Core.withObject "ListSessionTemplatesResponse"
              (\ o ->
                 ListSessionTemplatesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sessionTemplates"))
...
newListSessionsResponse 
    ::  ListSessionsResponse
newListSessionsResponse
  = ListSessionsResponse{nextPageToken = Core.Nothing,
                         sessions = Core.Nothing}
instance Core.FromJSON ListSessionsResponse where
        parseJSON
          = Core.withObject "ListSessionsResponse"
              (\ o ->
                 ListSessionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "sessions"))
...
newListWorkflowTemplatesResponse 
    ::  ListWorkflowTemplatesResponse
newListWorkflowTemplatesResponse
  = ListWorkflowTemplatesResponse{nextPageToken = Core.Nothing,
                                  templates = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListWorkflowTemplatesResponse where
        parseJSON
          = Core.withObject "ListWorkflowTemplatesResponse"
              (\ o ->
                 ListWorkflowTemplatesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "templates")
                     Core.<*> (o Core..:? "unreachable"))
...
instance Core.FromJSON LoggingConfig_DriverLogLevels where
        parseJSON
          = Core.withObject "LoggingConfig_DriverLogLevels"
              (\ o ->
...
newManagedCluster 
    ::  ManagedCluster
newManagedCluster
  = ManagedCluster{clusterName = Core.Nothing, config = Core.Nothing,
                   labels = Core.Nothing}
instance Core.FromJSON ManagedCluster where
        parseJSON
          = Core.withObject "ManagedCluster"
              (\ o ->
                 ManagedCluster Core.<$>
                   (o Core..:? "clusterName") Core.<*> (o Core..:? "config") Core.<*>
                     (o Core..:? "labels"))
...
instance Core.FromJSON ManagedCluster_Labels where
        parseJSON
          = Core.withObject "ManagedCluster_Labels"
...
newManagedGroupConfig 
    ::  ManagedGroupConfig
newManagedGroupConfig
  = ManagedGroupConfig{instanceGroupManagerName = Core.Nothing,
                       instanceGroupManagerUri = Core.Nothing,
                       instanceTemplateName = Core.Nothing}
instance Core.FromJSON ManagedGroupConfig where
        parseJSON
          = Core.withObject "ManagedGroupConfig"
              (\ o ->
                 ManagedGroupConfig Core.<$>
                   (o Core..:? "instanceGroupManagerName") Core.<*>
                     (o Core..:? "instanceGroupManagerUri")
...
instance Core.ToJSON ManagedGroupConfig where
        toJSON ManagedGroupConfig{..}
          = Core.object
              (Core.catMaybes
                 [("instanceGroupManagerName" Core..=) Core.<$>
                    instanceGroupManagerName,
                  ("instanceGroupManagerUri" Core..=) Core.<$>
...
newMemoryMetrics 
    ::  MemoryMetrics
newMemoryMetrics
  = MemoryMetrics{totalOffHeapStorageMemory = Core.Nothing,
...
instance Core.FromJSON MemoryMetrics where
        parseJSON
          = Core.withObject "MemoryMetrics"
              (\ o ->
                 MemoryMetrics Core.<$>
                   (o Core..:? "totalOffHeapStorageMemory" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalOnHeapStorageMemory" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "usedOffHeapStorageMemory" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "usedOnHeapStorageMemory" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON MemoryMetrics where
        toJSON MemoryMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("totalOffHeapStorageMemory" Core..=) Core.. Core.AsText Core.<$>
                    totalOffHeapStorageMemory,
                  ("totalOnHeapStorageMemory" Core..=) Core.. Core.AsText Core.<$>
                    totalOnHeapStorageMemory,
                  ("usedOffHeapStorageMemory" Core..=) Core.. Core.AsText Core.<$>
                    usedOffHeapStorageMemory,
                  ("usedOnHeapStorageMemory" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON MetastoreConfig where
        parseJSON
          = Core.withObject "MetastoreConfig"
              (\ o ->
...
instance Core.ToJSON MetastoreConfig where
        toJSON MetastoreConfig{..}
          = Core.object
              (Core.catMaybes
                 [("dataprocMetastoreService" Core..=) Core.<$>
...
newMetric 
    ::  Metric
newMetric
  = Metric{metricOverrides = Core.Nothing,
...
newNamespacedGkeDeploymentTarget 
    ::  NamespacedGkeDeploymentTarget
newNamespacedGkeDeploymentTarget
  = NamespacedGkeDeploymentTarget{clusterNamespace = Core.Nothing,
                                  targetGkeCluster = Core.Nothing}
instance Core.FromJSON NamespacedGkeDeploymentTarget where
        parseJSON
          = Core.withObject "NamespacedGkeDeploymentTarget"
              (\ o ->
                 NamespacedGkeDeploymentTarget Core.<$>
                   (o Core..:? "clusterNamespace") Core.<*>
                     (o Core..:? "targetGkeCluster"))
...
newNativeBuildInfoUiData 
    ::  NativeBuildInfoUiData
newNativeBuildInfoUiData
  = NativeBuildInfoUiData{buildClass = Core.Nothing,
                          buildInfo = Core.Nothing}
instance Core.FromJSON NativeBuildInfoUiData where
        parseJSON
          = Core.withObject "NativeBuildInfoUiData"
              (\ o ->
                 NativeBuildInfoUiData Core.<$>
                   (o Core..:? "buildClass") Core.<*> (o Core..:? "buildInfo"))
...
newNativeSqlExecutionUiData 
    ::  NativeSqlExecutionUiData
newNativeSqlExecutionUiData
  = NativeSqlExecutionUiData{description = Core.Nothing,
                             executionId = Core.Nothing, fallbackDescription = Core.Nothing,
                             fallbackNodeToReason = Core.Nothing,
                             numFallbackNodes = Core.Nothing, numNativeNodes = Core.Nothing}
instance Core.FromJSON NativeSqlExecutionUiData where
        parseJSON
          = Core.withObject "NativeSqlExecutionUiData"
              (\ o ->
                 NativeSqlExecutionUiData Core.<$>
                   (o Core..:? "description") Core.<*>
                     (o Core..:? "executionId" Core.<&> Core.fmap Core.fromAsText)
...
newNodeGroup 
    ::  NodeGroup
newNodeGroup
  = NodeGroup{labels = Core.Nothing, name = Core.Nothing,
              nodeGroupConfig = Core.Nothing, roles = Core.Nothing}
instance Core.FromJSON NodeGroup where
        parseJSON
          = Core.withObject "NodeGroup"
              (\ o ->
                 NodeGroup Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "nodeGroupConfig")
                     Core.<*> (o Core..:? "roles"))
...
instance Core.FromJSON NodeGroup_Labels where
        parseJSON
          = Core.withObject "NodeGroup_Labels"
...
instance Core.FromJSON NodeGroupAffinity where
        parseJSON
          = Core.withObject "NodeGroupAffinity"
...
newNodeGroupOperationMetadata 
    ::  NodeGroupOperationMetadata
newNodeGroupOperationMetadata
  = NodeGroupOperationMetadata{clusterUuid = Core.Nothing,
                               description = Core.Nothing, labels = Core.Nothing,
                               nodeGroupId = Core.Nothing, operationType = Core.Nothing,
                               status = Core.Nothing, statusHistory = Core.Nothing,
                               warnings = Core.Nothing}
instance Core.FromJSON NodeGroupOperationMetadata where
        parseJSON
          = Core.withObject "NodeGroupOperationMetadata"
              (\ o ->
                 NodeGroupOperationMetadata Core.<$>
                   (o Core..:? "clusterUuid") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "labels")
...
instance Core.FromJSON NodeGroupOperationMetadata_Labels where
        parseJSON
          = Core.withObject "NodeGroupOperationMetadata_Labels"
              (\ o ->
                 NodeGroupOperationMetadata_Labels Core.<$>
                   (Core.parseJSONObject o))
...
newNodeInitializationAction 
    ::  NodeInitializationAction
newNodeInitializationAction
  = NodeInitializationAction{executableFile = Core.Nothing,
                             executionTimeout = Core.Nothing}
instance Core.FromJSON NodeInitializationAction where
        parseJSON
          = Core.withObject "NodeInitializationAction"
              (\ o ->
                 NodeInitializationAction Core.<$>
                   (o Core..:? "executableFile") Core.<*>
                     (o Core..:? "executionTimeout"))
...
newNodePool 
    ::  NodePool
newNodePool
  = NodePool{id = Core.Nothing, instanceNames = Core.Nothing,
             repairAction = Core.Nothing}
instance Core.FromJSON NodePool where
        parseJSON
          = Core.withObject "NodePool"
              (\ o ->
                 NodePool Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "instanceNames") Core.<*>
                     (o Core..:? "repairAction"))
...
newOperation 
    ::  Operation
newOperation
  = Operation{done = Core.Nothing, error = Core.Nothing,
...
newOrderedJob 
    ::  OrderedJob
newOrderedJob
  = OrderedJob{flinkJob = Core.Nothing, hadoopJob = Core.Nothing,
               hiveJob = Core.Nothing, labels = Core.Nothing,
               pigJob = Core.Nothing, prerequisiteStepIds = Core.Nothing,
               prestoJob = Core.Nothing, pysparkJob = Core.Nothing,
               scheduling = Core.Nothing, sparkJob = Core.Nothing,
               sparkRJob = Core.Nothing, sparkSqlJob = Core.Nothing,
               stepId = Core.Nothing, trinoJob = Core.Nothing}
instance Core.FromJSON OrderedJob where
        parseJSON
          = Core.withObject "OrderedJob"
              (\ o ->
                 OrderedJob Core.<$>
                   (o Core..:? "flinkJob") Core.<*> (o Core..:? "hadoopJob") Core.<*>
                     (o Core..:? "hiveJob")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "pigJob")
...
instance Core.FromJSON OrderedJob_Labels where
        parseJSON
          = Core.withObject "OrderedJob_Labels"
...
newOutputMetrics 
    ::  OutputMetrics
newOutputMetrics
  = OutputMetrics{bytesWritten = Core.Nothing,
                  recordsWritten = Core.Nothing}
instance Core.FromJSON OutputMetrics where
        parseJSON
          = Core.withObject "OutputMetrics"
              (\ o ->
                 OutputMetrics Core.<$>
                   (o Core..:? "bytesWritten" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "recordsWritten" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("bytesWritten" Core..=) Core.. Core.AsText Core.<$> bytesWritten,
                  ("recordsWritten" Core..=) Core.. Core.AsText Core.<$>
                    recordsWritten])
...
newOutputQuantileMetrics 
    ::  OutputQuantileMetrics
newOutputQuantileMetrics
  = OutputQuantileMetrics{bytesWritten = Core.Nothing,
                          recordsWritten = Core.Nothing}
instance Core.FromJSON OutputQuantileMetrics where
        parseJSON
          = Core.withObject "OutputQuantileMetrics"
              (\ o ->
                 OutputQuantileMetrics Core.<$>
                   (o Core..:? "bytesWritten") Core.<*> (o Core..:? "recordsWritten"))
...
instance Core.FromJSON ParameterValidation where
        parseJSON
          = Core.withObject "ParameterValidation"
              (\ o ->
                 ParameterValidation Core.<$>
                   (o Core..:? "regex") Core.<*> (o Core..:? "values"))
...
newPeripheralsConfig 
    ::  PeripheralsConfig
newPeripheralsConfig
  = PeripheralsConfig{metastoreService = Core.Nothing,
                      sparkHistoryServerConfig = Core.Nothing}
instance Core.FromJSON PeripheralsConfig where
        parseJSON
          = Core.withObject "PeripheralsConfig"
              (\ o ->
                 PeripheralsConfig Core.<$>
                   (o Core..:? "metastoreService") Core.<*>
                     (o Core..:? "sparkHistoryServerConfig"))
...
newPigJob 
    ::  PigJob
newPigJob
  = PigJob{continueOnFailure = Core.Nothing,
           jarFileUris = Core.Nothing, loggingConfig = Core.Nothing,
           properties = Core.Nothing, queryFileUri = Core.Nothing,
           queryList = Core.Nothing, scriptVariables = Core.Nothing}
instance Core.FromJSON PigJob where
        parseJSON
          = Core.withObject "PigJob"
              (\ o ->
                 PigJob Core.<$>
                   (o Core..:? "continueOnFailure") Core.<*>
                     (o Core..:? "jarFileUris")
...
instance Core.FromJSON PigJob_Properties where
        parseJSON
          = Core.withObject "PigJob_Properties"
...
instance Core.FromJSON PigJob_ScriptVariables where
        parseJSON
          = Core.withObject "PigJob_ScriptVariables"
...
newPolicy 
    ::  Policy
newPolicy
  = Policy{bindings = Core.Nothing, etag = Core.Nothing,
...
instance Core.FromJSON Policy where
        parseJSON
          = Core.withObject "Policy"
              (\ o ->
                 Policy Core.<$>
                   (o Core..:? "bindings") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "version"))
...
newPrestoJob 
    ::  PrestoJob
newPrestoJob
  = PrestoJob{clientTags = Core.Nothing,
              continueOnFailure = Core.Nothing, loggingConfig = Core.Nothing,
              outputFormat = Core.Nothing, properties = Core.Nothing,
              queryFileUri = Core.Nothing, queryList = Core.Nothing}
instance Core.FromJSON PrestoJob where
        parseJSON
          = Core.withObject "PrestoJob"
              (\ o ->
                 PrestoJob Core.<$>
                   (o Core..:? "clientTags") Core.<*> (o Core..:? "continueOnFailure")
                     Core.<*> (o Core..:? "loggingConfig")
...
instance Core.FromJSON PrestoJob_Properties where
        parseJSON
          = Core.withObject "PrestoJob_Properties"
...
newProcessSummary 
    ::  ProcessSummary
newProcessSummary
  = ProcessSummary{addTime = Core.Nothing, hostPort = Core.Nothing,
                   isActive = Core.Nothing, processId = Core.Nothing,
                   processLogs = Core.Nothing, removeTime = Core.Nothing,
                   totalCores = Core.Nothing}
instance Core.FromJSON ProcessSummary where
        parseJSON
          = Core.withObject "ProcessSummary"
              (\ o ->
                 ProcessSummary Core.<$>
                   (o Core..:? "addTime") Core.<*> (o Core..:? "hostPort") Core.<*>
                     (o Core..:? "isActive")
...
instance Core.FromJSON ProcessSummary_ProcessLogs where
        parseJSON
          = Core.withObject "ProcessSummary_ProcessLogs"
              (\ o ->
...
--
-- /See:/ 'newPropertiesInfo' smart constructor.
newtype PropertiesInfo = PropertiesInfo
    {
      -- | Output only. Properties set by autotuning engine.
      autotuningProperties :: (Core.Maybe PropertiesInfo_AutotuningProperties)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PropertiesInfo' with the minimum fields required to make a request.
newPropertiesInfo 
    ::  PropertiesInfo
newPropertiesInfo
  = PropertiesInfo{autotuningProperties = Core.Nothing}
instance Core.FromJSON PropertiesInfo where
        parseJSON
          = Core.withObject "PropertiesInfo"
              (\ o ->
                 PropertiesInfo Core.<$> (o Core..:? "autotuningProperties"))

instance Core.ToJSON PropertiesInfo where
        toJSON PropertiesInfo{..}
          = Core.object
              (Core.catMaybes
                 [("autotuningProperties" Core..=) Core.<$> autotuningProperties])


-- | Output only. Properties set by autotuning engine.
--
-- /See:/ 'newPropertiesInfo_AutotuningProperties' smart constructor.
newtype PropertiesInfo_AutotuningProperties = PropertiesInfo_AutotuningProperties
    {

      additional :: (Core.HashMap Core.Text ValueInfo)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PropertiesInfo_AutotuningProperties' with the minimum fields required to make a request.
newPropertiesInfo_AutotuningProperties 
    :: 
                                       Core.HashMap Core.Text ValueInfo
       -- ^  See 'additional'.
    -> PropertiesInfo_AutotuningProperties
newPropertiesInfo_AutotuningProperties additional
  = PropertiesInfo_AutotuningProperties{additional = additional}
instance Core.FromJSON PropertiesInfo_AutotuningProperties where
        parseJSON
          = Core.withObject "PropertiesInfo_AutotuningProperties"
              (\ o ->
                 PropertiesInfo_AutotuningProperties Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON PropertiesInfo_AutotuningProperties where
        toJSON PropertiesInfo_AutotuningProperties{..}
          = Core.toJSON additional
...
newProvisioningModelMix 
    ::  ProvisioningModelMix
newProvisioningModelMix
  = ProvisioningModelMix{standardCapacityBase = Core.Nothing,
                         standardCapacityPercentAboveBase = Core.Nothing}
instance Core.FromJSON ProvisioningModelMix where
        parseJSON
          = Core.withObject "ProvisioningModelMix"
              (\ o ->
                 ProvisioningModelMix Core.<$>
                   (o Core..:? "standardCapacityBase") Core.<*>
                     (o Core..:? "standardCapacityPercentAboveBase"))
          ...
          = Core.object
              (Core.catMaybes
                 [("standardCapacityBase" Core..=) Core.<$> standardCapacityBase,
                  ("standardCapacityPercentAboveBase" Core..=) Core.<$>
...
instance Core.FromJSON PyPiRepositoryConfig where
        parseJSON
          = Core.withObject "PyPiRepositoryConfig"
              (\ o ->
...
newPySparkBatch 
    ::  PySparkBatch
newPySparkBatch
  = PySparkBatch{archiveUris = Core.Nothing, args = Core.Nothing,
                 fileUris = Core.Nothing, jarFileUris = Core.Nothing,
                 mainPythonFileUri = Core.Nothing, pythonFileUris = Core.Nothing}
instance Core.FromJSON PySparkBatch where
        parseJSON
          = Core.withObject "PySparkBatch"
              (\ o ->
                 PySparkBatch Core.<$>
                   (o Core..:? "archiveUris") Core.<*> (o Core..:? "args") Core.<*>
                     (o Core..:? "fileUris")
...
newPySparkJob 
    ::  PySparkJob
newPySparkJob
  = PySparkJob{archiveUris = Core.Nothing, args = Core.Nothing,
               fileUris = Core.Nothing, jarFileUris = Core.Nothing,
               loggingConfig = Core.Nothing, mainPythonFileUri = Core.Nothing,
               properties = Core.Nothing, pythonFileUris = Core.Nothing}
instance Core.FromJSON PySparkJob where
        parseJSON
          = Core.withObject "PySparkJob"
              (\ o ->
                 PySparkJob Core.<$>
                   (o Core..:? "archiveUris") Core.<*> (o Core..:? "args") Core.<*>
                     (o Core..:? "fileUris")
...
instance Core.FromJSON PySparkJob_Properties where
        parseJSON
          = Core.withObject "PySparkJob_Properties"
...
newQuantiles 
    ::  Quantiles
newQuantiles
  = Quantiles{count = Core.Nothing, maximum = Core.Nothing,
              minimum = Core.Nothing, percentile25 = Core.Nothing,
              percentile50 = Core.Nothing, percentile75 = Core.Nothing,
              sum = Core.Nothing}
instance Core.FromJSON Quantiles where
        parseJSON
          = Core.withObject "Quantiles"
              (\ o ->
                 Quantiles Core.<$>
                   (o Core..:? "count" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "maximum" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "minimum" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "percentile25" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "percentile50" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "percentile75" Core.<&> Core.fmap Core.fromAsText)
...
newRddDataDistribution 
    ::  RddDataDistribution
newRddDataDistribution
  = RddDataDistribution{address = Core.Nothing,
                        diskUsed = Core.Nothing, memoryRemaining = Core.Nothing,
                        memoryUsed = Core.Nothing, offHeapMemoryRemaining = Core.Nothing,
...
instance Core.FromJSON RddDataDistribution where
        parseJSON
          = Core.withObject "RddDataDistribution"
              (\ o ->
                 RddDataDistribution Core.<$>
                   (o Core..:? "address") Core.<*>
                     (o Core..:? "diskUsed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "memoryRemaining" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "memoryUsed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "offHeapMemoryRemaining" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "offHeapMemoryUsed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "onHeapMemoryRemaining" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "onHeapMemoryUsed" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ("diskUsed" Core..=) Core.. Core.AsText Core.<$> diskUsed,
                  ("memoryRemaining" Core..=) Core.. Core.AsText Core.<$>
                    memoryRemaining,
                  ("memoryUsed" Core..=) Core.. Core.AsText Core.<$> memoryUsed,
                  ("offHeapMemoryRemaining" Core..=) Core.. Core.AsText Core.<$>
                    offHeapMemoryRemaining,
                  ("offHeapMemoryUsed" Core..=) Core.. Core.AsText Core.<$>
                    offHeapMemoryUsed,
                  ("onHeapMemoryRemaining" Core..=) Core.. Core.AsText Core.<$>
                    onHeapMemoryRemaining,
                  ("onHeapMemoryUsed" Core..=) Core.. Core.AsText Core.<$>
                    onHeapMemoryUsed])
...
newRddOperationCluster 
    ::  RddOperationCluster
newRddOperationCluster
  = RddOperationCluster{childClusters = Core.Nothing,
                        childNodes = Core.Nothing, name = Core.Nothing,
                        rddClusterId = Core.Nothing}
instance Core.FromJSON RddOperationCluster where
        parseJSON
          = Core.withObject "RddOperationCluster"
              (\ o ->
                 RddOperationCluster Core.<$>
                   (o Core..:? "childClusters") Core.<*> (o Core..:? "childNodes")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON RddOperationEdge where
        parseJSON
          = Core.withObject "RddOperationEdge"
              (\ o ->
                 RddOperationEdge Core.<$>
                   (o Core..:? "fromId") Core.<*> (o Core..:? "toId"))
...
newRddOperationGraph 
    ::  RddOperationGraph
newRddOperationGraph
  = RddOperationGraph{edges = Core.Nothing,
                      incomingEdges = Core.Nothing, outgoingEdges = Core.Nothing,
                      rootCluster = Core.Nothing, stageId = Core.Nothing}
instance Core.FromJSON RddOperationGraph where
        parseJSON
          = Core.withObject "RddOperationGraph"
              (\ o ->
                 RddOperationGraph Core.<$>
                   (o Core..:? "edges") Core.<*> (o Core..:? "incomingEdges") Core.<*>
                     (o Core..:? "outgoingEdges")
...
newRddOperationNode 
    ::  RddOperationNode
newRddOperationNode
  = RddOperationNode{barrier = Core.Nothing, cached = Core.Nothing,
                     callsite = Core.Nothing, name = Core.Nothing,
                     nodeId = Core.Nothing, outputDeterministicLevel = Core.Nothing}
instance Core.FromJSON RddOperationNode where
        parseJSON
          = Core.withObject "RddOperationNode"
              (\ o ->
                 RddOperationNode Core.<$>
                   (o Core..:? "barrier") Core.<*> (o Core..:? "cached") Core.<*>
                     (o Core..:? "callsite")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "nodeId")
          ...
          = Core.object
              (Core.catMaybes
                 [("barrier" Core..=) Core.<$> barrier,
                  ...
                  ("name" Core..=) Core.<$> name, ("nodeId" Core..=) Core.<$> nodeId,
                  ("outputDeterministicLevel" Core..=) Core.<$>
...
newRddPartitionInfo 
    ::  RddPartitionInfo
newRddPartitionInfo
  = RddPartitionInfo{blockName = Core.Nothing,
                     diskUsed = Core.Nothing, executors = Core.Nothing,
                     memoryUsed = Core.Nothing, storageLevel = Core.Nothing}
instance Core.FromJSON RddPartitionInfo where
        parseJSON
          = Core.withObject "RddPartitionInfo"
              (\ o ->
                 RddPartitionInfo Core.<$>
                   (o Core..:? "blockName") Core.<*>
                     (o Core..:? "diskUsed" Core.<&> Core.fmap Core.fromAsText)
...
newRddStorageInfo 
    ::  RddStorageInfo
newRddStorageInfo
  = RddStorageInfo{dataDistribution = Core.Nothing,
                   diskUsed = Core.Nothing, memoryUsed = Core.Nothing,
                   name = Core.Nothing, numCachedPartitions = Core.Nothing,
                   numPartitions = Core.Nothing, partitions = Core.Nothing,
                   rddStorageId = Core.Nothing, storageLevel = Core.Nothing}
instance Core.FromJSON RddStorageInfo where
        parseJSON
          = Core.withObject "RddStorageInfo"
              (\ o ->
                 RddStorageInfo Core.<$>
                   (o Core..:? "dataDistribution") Core.<*>
                     (o Core..:? "diskUsed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "memoryUsed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON RegexValidation where
        parseJSON
          = Core.withObject "RegexValidation"
...
newRepairClusterRequest 
    ::  RepairClusterRequest
newRepairClusterRequest
  = RepairClusterRequest{cluster = Core.Nothing,
                         clusterUuid = Core.Nothing,
                         gracefulDecommissionTimeout = Core.Nothing,
                         nodePools = Core.Nothing, parentOperationId = Core.Nothing,
                         requestId = Core.Nothing}
instance Core.FromJSON RepairClusterRequest where
        parseJSON
          = Core.withObject "RepairClusterRequest"
              (\ o ->
                 RepairClusterRequest Core.<$>
                   (o Core..:? "cluster") Core.<*> (o Core..:? "clusterUuid") Core.<*>
                     (o Core..:? "gracefulDecommissionTimeout")
...
newRepairNodeGroupRequest 
    ::  RepairNodeGroupRequest
newRepairNodeGroupRequest
  = RepairNodeGroupRequest{instanceNames = Core.Nothing,
                           repairAction = Core.Nothing, requestId = Core.Nothing}
instance Core.FromJSON RepairNodeGroupRequest where
        parseJSON
          = Core.withObject "RepairNodeGroupRequest"
              (\ o ->
                 RepairNodeGroupRequest Core.<$>
                   (o Core..:? "instanceNames") Core.<*> (o Core..:? "repairAction")
                     Core.<*> (o Core..:? "requestId"))
...
instance Core.FromJSON RepositoryConfig where
        parseJSON
          = Core.withObject "RepositoryConfig"
              (\ o ->
...
newReservationAffinity 
    ::  ReservationAffinity
newReservationAffinity
  = ReservationAffinity{consumeReservationType = Core.Nothing,
                        key = Core.Nothing, values = Core.Nothing}
instance Core.FromJSON ReservationAffinity where
        parseJSON
          = Core.withObject "ReservationAffinity"
              (\ o ->
                 ReservationAffinity Core.<$>
                   (o Core..:? "consumeReservationType") Core.<*> (o Core..:? "key")
                     Core.<*> (o Core..:? "values"))
...
instance Core.ToJSON ReservationAffinity where
        toJSON ReservationAffinity{..}
          = Core.object
              (Core.catMaybes
                 [("consumeReservationType" Core..=) Core.<$>
...
newResizeNodeGroupRequest
  = ResizeNodeGroupRequest{gracefulDecommissionTimeout =
                             Core.Nothing,
                           parentOperationId = Core.Nothing, requestId = Core.Nothing,
                           size = Core.Nothing}
instance Core.FromJSON ResizeNodeGroupRequest where
        parseJSON
          = Core.withObject "ResizeNodeGroupRequest"
              (\ o ->
                 ResizeNodeGroupRequest Core.<$>
                   (o Core..:? "gracefulDecommissionTimeout") Core.<*>
                     (o Core..:? "parentOperationId")
                     Core.<*> (o Core..:? "requestId")
                     Core.<*> (o Core..:? "size"))
...
newResourceInformation 
    ::  ResourceInformation
newResourceInformation
  = ResourceInformation{addresses = Core.Nothing,
                        name = Core.Nothing}
instance Core.FromJSON ResourceInformation where
        parseJSON
          = Core.withObject "ResourceInformation"
              (\ o ->
                 ResourceInformation Core.<$>
                   (o Core..:? "addresses") Core.<*> (o Core..:? "name"))
...
newResourceProfileInfo 
    ::  ResourceProfileInfo
newResourceProfileInfo
  = ResourceProfileInfo{executorResources = Core.Nothing,
                        resourceProfileId = Core.Nothing, taskResources = Core.Nothing}
instance Core.FromJSON ResourceProfileInfo where
        parseJSON
          = Core.withObject "ResourceProfileInfo"
              (\ o ->
                 ResourceProfileInfo Core.<$>
                   (o Core..:? "executorResources") Core.<*>
                     (o Core..:? "resourceProfileId")
...
instance Core.FromJSON ResourceProfileInfo_ExecutorResources where
        parseJSON
          = Core.withObject "ResourceProfileInfo_ExecutorResources"
              (\ o ->
                 ResourceProfileInfo_ExecutorResources Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON ResourceProfileInfo_TaskResources where
        parseJSON
          = Core.withObject "ResourceProfileInfo_TaskResources"
              (\ o ->
                 ResourceProfileInfo_TaskResources Core.<$>
                   (Core.parseJSONObject o))
...
newRuntimeConfig 
    ::  RuntimeConfig
newRuntimeConfig
  = RuntimeConfig{autotuningConfig = Core.Nothing,
                  cohort = Core.Nothing, containerImage = Core.Nothing,
                  properties = Core.Nothing, repositoryConfig = Core.Nothing,
                  version = Core.Nothing}
instance Core.FromJSON RuntimeConfig where
        parseJSON
          = Core.withObject "RuntimeConfig"
              (\ o ->
                 RuntimeConfig Core.<$>
                   (o Core..:? "autotuningConfig") Core.<*> (o Core..:? "cohort")
...
instance Core.FromJSON RuntimeConfig_Properties where
        parseJSON
          = Core.withObject "RuntimeConfig_Properties"
...
data RuntimeInfo = RuntimeInfo
    ...
    , propertiesInfo :: (Core.Maybe PropertiesInfo)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newRuntimeInfo 
    ::  RuntimeInfo
newRuntimeInfo
  = RuntimeInfo{approximateUsage = Core.Nothing,
                currentUsage = Core.Nothing, diagnosticOutputUri = Core.Nothing,
                endpoints = Core.Nothing, outputUri = Core.Nothing,
                propertiesInfo = Core.Nothing}
instance Core.FromJSON RuntimeInfo where
        parseJSON
          = Core.withObject "RuntimeInfo"
              (\ o ->
                 RuntimeInfo Core.<$>
                   (o Core..:? "approximateUsage") Core.<*>
                     (o Core..:? "currentUsage")
                     Core.<*> (o Core..:? "diagnosticOutputUri")
                     Core.<*> (o Core..:? "endpoints")
                     Core.<*> (o Core..:? "outputUri")
                     Core.<*> (o Core..:? "propertiesInfo"))
          ...
          = Core.object
              (Core.catMaybes
                 [("approximateUsage" Core..=) Core.<$> approximateUsage,
                  ...
                  ("propertiesInfo" Core..=) Core.<$> propertiesInfo])
...
instance Core.FromJSON RuntimeInfo_Endpoints where
        parseJSON
          = Core.withObject "RuntimeInfo_Endpoints"
...
newSearchSessionSparkApplicationExecutorStageSummaryResponse 
    :: 
                                                             SearchSessionSparkApplicationExecutorStageSummaryResponse
newSearchSessionSparkApplicationExecutorStageSummaryResponse
  = SearchSessionSparkApplicationExecutorStageSummaryResponse{nextPageToken
                                                                = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "SearchSessionSparkApplicationExecutorStageSummaryResponse"
              (\ o ->
                 SearchSessionSparkApplicationExecutorStageSummaryResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationStageExecutors"))
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("sparkApplicationStageExecutors" Core..=) Core.<$>
                    sparkApplicationStageExecutors])
...
newSearchSessionSparkApplicationExecutorsResponse 
    :: 
                                                  SearchSessionSparkApplicationExecutorsResponse
newSearchSessionSparkApplicationExecutorsResponse
  = SearchSessionSparkApplicationExecutorsResponse{nextPageToken =
                                                     Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "SearchSessionSparkApplicationExecutorsResponse"
              (\ o ->
                 SearchSessionSparkApplicationExecutorsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationExecutors"))

instance Core.ToJSON SearchSessionSparkApplicationExecutorsResponse
         where
        toJSON SearchSessionSparkApplicationExecutorsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("sparkApplicationExecutors" Core..=) Core.<$>
...
newSearchSessionSparkApplicationJobsResponse 
    :: 
                                             SearchSessionSparkApplicationJobsResponse
newSearchSessionSparkApplicationJobsResponse
  = SearchSessionSparkApplicationJobsResponse{nextPageToken =
                                                Core.Nothing,
                                              sparkApplicationJobs = Core.Nothing}
instance Core.FromJSON SearchSessionSparkApplicationJobsResponse
         where
        parseJSON
          = Core.withObject "SearchSessionSparkApplicationJobsResponse"
              (\ o ->
                 SearchSessionSparkApplicationJobsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationJobs"))

instance Core.ToJSON SearchSessionSparkApplicationJobsResponse
         where
...
newSearchSessionSparkApplicationSqlQueriesResponse 
    :: 
                                                   SearchSessionSparkApplicationSqlQueriesResponse
newSearchSessionSparkApplicationSqlQueriesResponse
  = SearchSessionSparkApplicationSqlQueriesResponse{nextPageToken =
                                                      Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "SearchSessionSparkApplicationSqlQueriesResponse"
              (\ o ->
                 SearchSessionSparkApplicationSqlQueriesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationSqlQueries"))
...
instance Core.ToJSON
        ...
        toJSON SearchSessionSparkApplicationSqlQueriesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("sparkApplicationSqlQueries" Core..=) Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "SearchSessionSparkApplicationStageAttemptTasksResponse"
              (\ o ->
                 SearchSessionSparkApplicationStageAttemptTasksResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationStageAttemptTasks"))
...
instance Core.ToJSON
        ...
        toJSON SearchSessionSparkApplicationStageAttemptTasksResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("sparkApplicationStageAttemptTasks" Core..=) Core.<$>
                    sparkApplicationStageAttemptTasks])
...
newSearchSessionSparkApplicationStageAttemptsResponse 
    :: 
                                                      SearchSessionSparkApplicationStageAttemptsResponse
newSearchSessionSparkApplicationStageAttemptsResponse
  = SearchSessionSparkApplicationStageAttemptsResponse{nextPageToken
                                                         = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "SearchSessionSparkApplicationStageAttemptsResponse"
              (\ o ->
                 SearchSessionSparkApplicationStageAttemptsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationStageAttempts"))
...
instance Core.ToJSON
        ...
        toJSON SearchSessionSparkApplicationStageAttemptsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("sparkApplicationStageAttempts" Core..=) Core.<$>
...
newSearchSessionSparkApplicationStagesResponse 
    :: 
                                               SearchSessionSparkApplicationStagesResponse
newSearchSessionSparkApplicationStagesResponse
  = SearchSessionSparkApplicationStagesResponse{nextPageToken =
                                                  Core.Nothing,
                                                sparkApplicationStages = Core.Nothing}
instance Core.FromJSON SearchSessionSparkApplicationStagesResponse
         where
        parseJSON
          = Core.withObject "SearchSessionSparkApplicationStagesResponse"
              (\ o ->
                 SearchSessionSparkApplicationStagesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationStages"))

instance Core.ToJSON SearchSessionSparkApplicationStagesResponse
         where
        toJSON SearchSessionSparkApplicationStagesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("sparkApplicationStages" Core..=) Core.<$>
...
newSearchSessionSparkApplicationsResponse 
    :: 
                                          SearchSessionSparkApplicationsResponse
newSearchSessionSparkApplicationsResponse
  = SearchSessionSparkApplicationsResponse{nextPageToken =
                                             Core.Nothing,
                                           sparkApplications = Core.Nothing}
instance Core.FromJSON SearchSessionSparkApplicationsResponse where
        parseJSON
          = Core.withObject "SearchSessionSparkApplicationsResponse"
              (\ o ->
                 SearchSessionSparkApplicationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplications"))
...
newSearchSparkApplicationExecutorStageSummaryResponse 
    :: 
                                                      SearchSparkApplicationExecutorStageSummaryResponse
newSearchSparkApplicationExecutorStageSummaryResponse
  = SearchSparkApplicationExecutorStageSummaryResponse{nextPageToken
                                                         = Core.Nothing,
                                                       sparkApplicationStageExecutors =
                                                         Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "SearchSparkApplicationExecutorStageSummaryResponse"
              (\ o ->
                 SearchSparkApplicationExecutorStageSummaryResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationStageExecutors"))
...
newSearchSparkApplicationExecutorsResponse 
    :: 
                                           SearchSparkApplicationExecutorsResponse
newSearchSparkApplicationExecutorsResponse
  = SearchSparkApplicationExecutorsResponse{nextPageToken =
                                              Core.Nothing,
                                            sparkApplicationExecutors = Core.Nothing}
instance Core.FromJSON SearchSparkApplicationExecutorsResponse
         where
        parseJSON
          = Core.withObject "SearchSparkApplicationExecutorsResponse"
              (\ o ->
                 SearchSparkApplicationExecutorsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationExecutors"))
...
newSearchSparkApplicationJobsResponse 
    :: 
                                      SearchSparkApplicationJobsResponse
newSearchSparkApplicationJobsResponse
  = SearchSparkApplicationJobsResponse{nextPageToken = Core.Nothing,
                                       sparkApplicationJobs = Core.Nothing}
instance Core.FromJSON SearchSparkApplicationJobsResponse where
        parseJSON
          = Core.withObject "SearchSparkApplicationJobsResponse"
              (\ o ->
                 SearchSparkApplicationJobsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationJobs"))
...
newSearchSparkApplicationSqlQueriesResponse 
    :: 
                                            SearchSparkApplicationSqlQueriesResponse
newSearchSparkApplicationSqlQueriesResponse
  = SearchSparkApplicationSqlQueriesResponse{nextPageToken =
                                               Core.Nothing,
                                             sparkApplicationSqlQueries = Core.Nothing}
instance Core.FromJSON SearchSparkApplicationSqlQueriesResponse
         where
        parseJSON
          = Core.withObject "SearchSparkApplicationSqlQueriesResponse"
              (\ o ->
                 SearchSparkApplicationSqlQueriesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationSqlQueries"))
...
newSearchSparkApplicationStageAttemptTasksResponse 
    :: 
                                                   SearchSparkApplicationStageAttemptTasksResponse
newSearchSparkApplicationStageAttemptTasksResponse
  = SearchSparkApplicationStageAttemptTasksResponse{nextPageToken =
                                                      Core.Nothing,
                                                    sparkApplicationStageAttemptTasks =
                                                      Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "SearchSparkApplicationStageAttemptTasksResponse"
              (\ o ->
                 SearchSparkApplicationStageAttemptTasksResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationStageAttemptTasks"))
...
newSearchSparkApplicationStageAttemptsResponse 
    :: 
                                               SearchSparkApplicationStageAttemptsResponse
newSearchSparkApplicationStageAttemptsResponse
  = SearchSparkApplicationStageAttemptsResponse{nextPageToken =
                                                  Core.Nothing,
                                                sparkApplicationStageAttempts = Core.Nothing}
instance Core.FromJSON SearchSparkApplicationStageAttemptsResponse
         where
        parseJSON
          = Core.withObject "SearchSparkApplicationStageAttemptsResponse"
              (\ o ->
                 SearchSparkApplicationStageAttemptsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationStageAttempts"))

instance Core.ToJSON SearchSparkApplicationStageAttemptsResponse
         where
...
newSearchSparkApplicationStagesResponse 
    :: 
                                        SearchSparkApplicationStagesResponse
newSearchSparkApplicationStagesResponse
  = SearchSparkApplicationStagesResponse{nextPageToken =
                                           Core.Nothing,
                                         sparkApplicationStages = Core.Nothing}
instance Core.FromJSON SearchSparkApplicationStagesResponse where
        parseJSON
          = Core.withObject "SearchSparkApplicationStagesResponse"
              (\ o ->
                 SearchSparkApplicationStagesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplicationStages"))
...
newSearchSparkApplicationsResponse 
    :: 
                                   SearchSparkApplicationsResponse
newSearchSparkApplicationsResponse
  = SearchSparkApplicationsResponse{nextPageToken = Core.Nothing,
                                    sparkApplications = Core.Nothing}
instance Core.FromJSON SearchSparkApplicationsResponse where
        parseJSON
          = Core.withObject "SearchSparkApplicationsResponse"
              (\ o ->
                 SearchSparkApplicationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sparkApplications"))
...
newSecurityConfig 
    ::  SecurityConfig
newSecurityConfig
  = SecurityConfig{identityConfig = Core.Nothing,
                   kerberosConfig = Core.Nothing}
instance Core.FromJSON SecurityConfig where
        parseJSON
          = Core.withObject "SecurityConfig"
              (\ o ->
                 SecurityConfig Core.<$>
                   (o Core..:? "identityConfig") Core.<*>
                     (o Core..:? "kerberosConfig"))
...
newSession 
    ::  Session
newSession
  = Session{createTime = Core.Nothing, creator = Core.Nothing,
            environmentConfig = Core.Nothing, jupyterSession = Core.Nothing,
            labels = Core.Nothing, name = Core.Nothing,
            runtimeConfig = Core.Nothing, runtimeInfo = Core.Nothing,
            sessionTemplate = Core.Nothing, sparkConnectSession = Core.Nothing,
            state = Core.Nothing, stateHistory = Core.Nothing,
            stateMessage = Core.Nothing, stateTime = Core.Nothing,
            user = Core.Nothing, uuid = Core.Nothing}
instance Core.FromJSON Session where
        parseJSON
          = Core.withObject "Session"
              (\ o ->
                 Session Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "creator") Core.<*>
                     (o Core..:? "environmentConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("stateMessage" Core..=) Core.<$> stateMessage,
                  ("stateTime" Core..=) Core.<$> stateTime,
                  ("user" Core..=) Core.<$> user, ("uuid" Core..=) Core.<$> uuid])
...
instance Core.FromJSON Session_Labels where
        parseJSON
          = Core.withObject "Session_Labels"
...
newSessionOperationMetadata 
    ::  SessionOperationMetadata
newSessionOperationMetadata
  = SessionOperationMetadata{createTime = Core.Nothing,
                             description = Core.Nothing, doneTime = Core.Nothing,
                             labels = Core.Nothing, operationType = Core.Nothing,
                             session = Core.Nothing, sessionUuid = Core.Nothing,
                             warnings = Core.Nothing}
instance Core.FromJSON SessionOperationMetadata where
        parseJSON
          = Core.withObject "SessionOperationMetadata"
              (\ o ->
                 SessionOperationMetadata Core.<$>
...
instance Core.FromJSON SessionOperationMetadata_Labels where
        parseJSON
          = Core.withObject "SessionOperationMetadata_Labels"
              (\ o ->
...
newSessionStateHistory 
    ::  SessionStateHistory
newSessionStateHistory
  = SessionStateHistory{state = Core.Nothing,
                        stateMessage = Core.Nothing, stateStartTime = Core.Nothing}
instance Core.FromJSON SessionStateHistory where
        parseJSON
          = Core.withObject "SessionStateHistory"
              (\ o ->
                 SessionStateHistory Core.<$>
                   (o Core..:? "state") Core.<*> (o Core..:? "stateMessage") Core.<*>
                     (o Core..:? "stateStartTime"))
...
newSessionTemplate 
    ::  SessionTemplate
newSessionTemplate
  = SessionTemplate{createTime = Core.Nothing,
                    creator = Core.Nothing, description = Core.Nothing,
                    environmentConfig = Core.Nothing, jupyterSession = Core.Nothing,
                    labels = Core.Nothing, name = Core.Nothing,
                    runtimeConfig = Core.Nothing, sparkConnectSession = Core.Nothing,
                    updateTime = Core.Nothing, uuid = Core.Nothing}
instance Core.FromJSON SessionTemplate where
        parseJSON
          = Core.withObject "SessionTemplate"
              (\ o ->
...
instance Core.FromJSON SessionTemplate_Labels where
        parseJSON
          = Core.withObject "SessionTemplate_Labels"
...
newShieldedInstanceConfig 
    ::  ShieldedInstanceConfig
newShieldedInstanceConfig
  = ShieldedInstanceConfig{enableIntegrityMonitoring = Core.Nothing,
                           enableSecureBoot = Core.Nothing, enableVtpm = Core.Nothing}
instance Core.FromJSON ShieldedInstanceConfig where
        parseJSON
          = Core.withObject "ShieldedInstanceConfig"
              (\ o ->
                 ShieldedInstanceConfig Core.<$>
                   (o Core..:? "enableIntegrityMonitoring") Core.<*>
...
instance Core.ToJSON ShieldedInstanceConfig where
        toJSON ShieldedInstanceConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enableIntegrityMonitoring" Core..=) Core.<$>
...
newShufflePushReadMetrics 
    ::  ShufflePushReadMetrics
newShufflePushReadMetrics
  = ShufflePushReadMetrics{corruptMergedBlockChunks = Core.Nothing,
...
instance Core.FromJSON ShufflePushReadMetrics where
        parseJSON
          = Core.withObject "ShufflePushReadMetrics"
              (\ o ->
                 ShufflePushReadMetrics Core.<$>
                   (o Core..:? "corruptMergedBlockChunks" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "localMergedBlocksFetched" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "localMergedBytesRead" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "localMergedChunksFetched" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "mergedFetchFallbackCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "remoteMergedBlocksFetched" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "remoteMergedBytesRead" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "remoteMergedChunksFetched" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "remoteMergedReqsDuration" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON ShufflePushReadMetrics where
        toJSON ShufflePushReadMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("corruptMergedBlockChunks" Core..=) Core.. Core.AsText Core.<$>
                    corruptMergedBlockChunks,
                  ("localMergedBlocksFetched" Core..=) Core.. Core.AsText Core.<$>
                    localMergedBlocksFetched,
                  ("localMergedBytesRead" Core..=) Core.. Core.AsText Core.<$>
                    localMergedBytesRead,
                  ("localMergedChunksFetched" Core..=) Core.. Core.AsText Core.<$>
                    localMergedChunksFetched,
                  ("mergedFetchFallbackCount" Core..=) Core.. Core.AsText Core.<$>
                    mergedFetchFallbackCount,
                  ("remoteMergedBlocksFetched" Core..=) Core.. Core.AsText Core.<$>
                    remoteMergedBlocksFetched,
                  ("remoteMergedBytesRead" Core..=) Core.. Core.AsText Core.<$>
                    remoteMergedBytesRead,
                  ("remoteMergedChunksFetched" Core..=) Core.. Core.AsText Core.<$>
                    remoteMergedChunksFetched,
                  ("remoteMergedReqsDuration" Core..=) Core.. Core.AsText Core.<$>
...
newShufflePushReadQuantileMetrics 
    ::  ShufflePushReadQuantileMetrics
newShufflePushReadQuantileMetrics
  = ShufflePushReadQuantileMetrics{corruptMergedBlockChunks =
                                     Core.Nothing,
                                   localMergedBlocksFetched = Core.Nothing,
                                   localMergedBytesRead = Core.Nothing,
                                   localMergedChunksFetched = Core.Nothing,
...
instance Core.FromJSON ShufflePushReadQuantileMetrics where
        parseJSON
          = Core.withObject "ShufflePushReadQuantileMetrics"
              (\ o ->
                 ShufflePushReadQuantileMetrics Core.<$>
                   (o Core..:? "corruptMergedBlockChunks") Core.<*>
                     (o Core..:? "localMergedBlocksFetched")
...
instance Core.ToJSON ShufflePushReadQuantileMetrics where
        toJSON ShufflePushReadQuantileMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("corruptMergedBlockChunks" Core..=) Core.<$>
                    corruptMergedBlockChunks,
                  ("localMergedBlocksFetched" Core..=) Core.<$>
                    localMergedBlocksFetched,
                  ("localMergedBytesRead" Core..=) Core.<$> localMergedBytesRead,
                  ("localMergedChunksFetched" Core..=) Core.<$>
                    localMergedChunksFetched,
                  ("mergedFetchFallbackCount" Core..=) Core.<$>
                    mergedFetchFallbackCount,
                  ("remoteMergedBlocksFetched" Core..=) Core.<$>
                    remoteMergedBlocksFetched,
                  ("remoteMergedBytesRead" Core..=) Core.<$> remoteMergedBytesRead,
                  ("remoteMergedChunksFetched" Core..=) Core.<$>
                    remoteMergedChunksFetched,
                  ("remoteMergedReqsDuration" Core..=) Core.<$>
                    remoteMergedReqsDuration])
...
newShuffleReadMetrics 
    ::  ShuffleReadMetrics
newShuffleReadMetrics
  = ShuffleReadMetrics{fetchWaitTimeMillis = Core.Nothing,
                       localBlocksFetched = Core.Nothing, localBytesRead = Core.Nothing,
                       recordsRead = Core.Nothing, remoteBlocksFetched = Core.Nothing,
...
instance Core.FromJSON ShuffleReadMetrics where
        parseJSON
          = Core.withObject "ShuffleReadMetrics"
              (\ o ->
                 ShuffleReadMetrics Core.<$>
                   (o Core..:? "fetchWaitTimeMillis" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "localBlocksFetched" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "localBytesRead" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "recordsRead" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "remoteBlocksFetched" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "remoteBytesRead" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "remoteBytesReadToDisk" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "remoteReqsDuration" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON ShuffleReadMetrics where
        toJSON ShuffleReadMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("fetchWaitTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    fetchWaitTimeMillis,
                  ("localBlocksFetched" Core..=) Core.. Core.AsText Core.<$>
                    localBlocksFetched,
                  ("localBytesRead" Core..=) Core.. Core.AsText Core.<$>
                    localBytesRead,
                  ("recordsRead" Core..=) Core.. Core.AsText Core.<$> recordsRead,
                  ("remoteBlocksFetched" Core..=) Core.. Core.AsText Core.<$>
                    remoteBlocksFetched,
                  ("remoteBytesRead" Core..=) Core.. Core.AsText Core.<$>
                    remoteBytesRead,
                  ("remoteBytesReadToDisk" Core..=) Core.. Core.AsText Core.<$>
                    remoteBytesReadToDisk,
                  ("remoteReqsDuration" Core..=) Core.. Core.AsText Core.<$>
                    remoteReqsDuration,
                  ("shufflePushReadMetrics" Core..=) Core.<$>
                    shufflePushReadMetrics])
...
newShuffleReadQuantileMetrics 
    ::  ShuffleReadQuantileMetrics
newShuffleReadQuantileMetrics
  = ShuffleReadQuantileMetrics{fetchWaitTimeMillis = Core.Nothing,
                               localBlocksFetched = Core.Nothing, readBytes = Core.Nothing,
                               readRecords = Core.Nothing, remoteBlocksFetched = Core.Nothing,
                               remoteBytesRead = Core.Nothing,
                               remoteBytesReadToDisk = Core.Nothing,
                               remoteReqsDuration = Core.Nothing,
                               shufflePushReadMetrics = Core.Nothing,
...
instance Core.FromJSON ShuffleReadQuantileMetrics where
        parseJSON
          = Core.withObject "ShuffleReadQuantileMetrics"
              (\ o ->
                 ShuffleReadQuantileMetrics Core.<$>
                   (o Core..:? "fetchWaitTimeMillis") Core.<*>
                     (o Core..:? "localBlocksFetched")
...
newShuffleWriteMetrics 
    ::  ShuffleWriteMetrics
newShuffleWriteMetrics
  = ShuffleWriteMetrics{bytesWritten = Core.Nothing,
                        recordsWritten = Core.Nothing, writeTimeNanos = Core.Nothing}
instance Core.FromJSON ShuffleWriteMetrics where
        parseJSON
          = Core.withObject "ShuffleWriteMetrics"
              (\ o ->
                 ShuffleWriteMetrics Core.<$>
                   (o Core..:? "bytesWritten" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "recordsWritten" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "writeTimeNanos" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("bytesWritten" Core..=) Core.. Core.AsText Core.<$> bytesWritten,
                  ("recordsWritten" Core..=) Core.. Core.AsText Core.<$>
                    recordsWritten,
                  ("writeTimeNanos" Core..=) Core.. Core.AsText Core.<$>
                    writeTimeNanos])
...
newShuffleWriteQuantileMetrics 
    ::  ShuffleWriteQuantileMetrics
newShuffleWriteQuantileMetrics
  = ShuffleWriteQuantileMetrics{writeBytes = Core.Nothing,
                                writeRecords = Core.Nothing, writeTimeNanos = Core.Nothing}
instance Core.FromJSON ShuffleWriteQuantileMetrics where
        parseJSON
          = Core.withObject "ShuffleWriteQuantileMetrics"
              (\ o ->
                 ShuffleWriteQuantileMetrics Core.<$>
                   (o Core..:? "writeBytes") Core.<*> (o Core..:? "writeRecords")
...
newSinkProgress 
    ::  SinkProgress
newSinkProgress
  = SinkProgress{description = Core.Nothing, metrics = Core.Nothing,
                 numOutputRows = Core.Nothing}
instance Core.FromJSON SinkProgress where
        parseJSON
          = Core.withObject "SinkProgress"
              (\ o ->
                 SinkProgress Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "metrics") Core.<*>
                     (o Core..:? "numOutputRows" Core.<&> Core.fmap Core.fromAsText))
        ...
        toJSON SinkProgress{..}
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("metrics" Core..=) Core.<$> metrics,
                  ("numOutputRows" Core..=) Core.. Core.AsText Core.<$>
                    numOutputRows])
...
instance Core.FromJSON SinkProgress_Metrics where
        parseJSON
          = Core.withObject "SinkProgress_Metrics"
...
newSoftwareConfig 
    ::  SoftwareConfig
newSoftwareConfig
  = SoftwareConfig{imageVersion = Core.Nothing,
                   optionalComponents = Core.Nothing, properties = Core.Nothing}
instance Core.FromJSON SoftwareConfig where
        parseJSON
          = Core.withObject "SoftwareConfig"
              (\ o ->
                 SoftwareConfig Core.<$>
                   (o Core..:? "imageVersion") Core.<*>
                     (o Core..:? "optionalComponents")
                     Core.<*> (o Core..:? "properties"))
...
instance Core.FromJSON SoftwareConfig_Properties where
        parseJSON
          = Core.withObject "SoftwareConfig_Properties"
              (\ o ->
...
newSourceProgress 
    ::  SourceProgress
newSourceProgress
  = SourceProgress{description = Core.Nothing,
                   endOffset = Core.Nothing, inputRowsPerSecond = Core.Nothing,
                   latestOffset = Core.Nothing, metrics = Core.Nothing,
                   numInputRows = Core.Nothing, processedRowsPerSecond = Core.Nothing,
                   startOffset = Core.Nothing}
instance Core.FromJSON SourceProgress where
        parseJSON
          = Core.withObject "SourceProgress"
              (\ o ->
                 SourceProgress Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "endOffset")
                     Core.<*> (o Core..:? "inputRowsPerSecond")
                     Core.<*> (o Core..:? "latestOffset")
                     Core.<*> (o Core..:? "metrics")
                     Core.<*>
                     (o Core..:? "numInputRows" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.FromJSON SourceProgress_Metrics where
        parseJSON
          = Core.withObject "SourceProgress_Metrics"
...
instance Core.FromJSON SparkApplication where
        parseJSON
          = Core.withObject "SparkApplication"
              (\ o ->
                 SparkApplication Core.<$>
                   (o Core..:? "application") Core.<*> (o Core..:? "name"))
...
newSparkBatch 
    ::  SparkBatch
newSparkBatch
  = SparkBatch{archiveUris = Core.Nothing, args = Core.Nothing,
               fileUris = Core.Nothing, jarFileUris = Core.Nothing,
               mainClass = Core.Nothing, mainJarFileUri = Core.Nothing}
instance Core.FromJSON SparkBatch where
        parseJSON
          = Core.withObject "SparkBatch"
              (\ o ->
                 SparkBatch Core.<$>
                   (o Core..:? "archiveUris") Core.<*> (o Core..:? "args") Core.<*>
                     (o Core..:? "fileUris")
...
instance Core.FromJSON SparkConnectConfig where
        parseJSON
          = Core.withObject "SparkConnectConfig"
...
instance Core.FromJSON SparkHistoryServerConfig where
        parseJSON
          = Core.withObject "SparkHistoryServerConfig"
              (\ o ->
...
newSparkJob 
    ::  SparkJob
newSparkJob
  = SparkJob{archiveUris = Core.Nothing, args = Core.Nothing,
             fileUris = Core.Nothing, jarFileUris = Core.Nothing,
             loggingConfig = Core.Nothing, mainClass = Core.Nothing,
             mainJarFileUri = Core.Nothing, properties = Core.Nothing}
instance Core.FromJSON SparkJob where
        parseJSON
          = Core.withObject "SparkJob"
              (\ o ->
                 SparkJob Core.<$>
                   (o Core..:? "archiveUris") Core.<*> (o Core..:? "args") Core.<*>
                     (o Core..:? "fileUris")
...
instance Core.FromJSON SparkJob_Properties where
        parseJSON
          = Core.withObject "SparkJob_Properties"
...
newSparkPlanGraph 
    ::  SparkPlanGraph
newSparkPlanGraph
  = SparkPlanGraph{edges = Core.Nothing, executionId = Core.Nothing,
                   nodes = Core.Nothing}
instance Core.FromJSON SparkPlanGraph where
        parseJSON
          = Core.withObject "SparkPlanGraph"
              (\ o ->
                 SparkPlanGraph Core.<$>
                   (o Core..:? "edges") Core.<*>
                     (o Core..:? "executionId" Core.<&> Core.fmap Core.fromAsText)
...
newSparkPlanGraphCluster 
    ::  SparkPlanGraphCluster
newSparkPlanGraphCluster
  = SparkPlanGraphCluster{desc = Core.Nothing,
                          metrics = Core.Nothing, name = Core.Nothing, nodes = Core.Nothing,
                          sparkPlanGraphClusterId = Core.Nothing}
instance Core.FromJSON SparkPlanGraphCluster where
        parseJSON
          = Core.withObject "SparkPlanGraphCluster"
              (\ o ->
                 SparkPlanGraphCluster Core.<$>
                   (o Core..:? "desc") Core.<*> (o Core..:? "metrics") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "nodes")
                     Core.<*>
                     (o Core..:? "sparkPlanGraphClusterId" Core.<&>
                        Core.fmap Core.fromAsText))
        ...
        toJSON SparkPlanGraphCluster{..}
          = Core.object
              (Core.catMaybes
                 [("desc" Core..=) Core.<$> desc,
                  ("metrics" Core..=) Core.<$> metrics,
                  ("name" Core..=) Core.<$> name, ("nodes" Core..=) Core.<$> nodes,
                  ("sparkPlanGraphClusterId" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON SparkPlanGraphEdge where
        parseJSON
          = Core.withObject "SparkPlanGraphEdge"
              (\ o ->
                 SparkPlanGraphEdge Core.<$>
                   (o Core..:? "fromId" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "toId" Core.<&> Core.fmap Core.fromAsText))
...
newSparkPlanGraphNode 
    ::  SparkPlanGraphNode
newSparkPlanGraphNode
  = SparkPlanGraphNode{desc = Core.Nothing, metrics = Core.Nothing,
                       name = Core.Nothing, sparkPlanGraphNodeId = Core.Nothing}
instance Core.FromJSON SparkPlanGraphNode where
        parseJSON
          = Core.withObject "SparkPlanGraphNode"
              (\ o ->
                 SparkPlanGraphNode Core.<$>
                   (o Core..:? "desc") Core.<*> (o Core..:? "metrics") Core.<*>
                     (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "sparkPlanGraphNodeId" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("desc" Core..=) Core.<$> desc,
                  ("metrics" Core..=) Core.<$> metrics,
                  ("name" Core..=) Core.<$> name,
                  ("sparkPlanGraphNodeId" Core..=) Core.. Core.AsText Core.<$>
...
newSparkPlanGraphNodeWrapper 
    ::  SparkPlanGraphNodeWrapper
newSparkPlanGraphNodeWrapper
  = SparkPlanGraphNodeWrapper{cluster = Core.Nothing,
                              node = Core.Nothing}
instance Core.FromJSON SparkPlanGraphNodeWrapper where
        parseJSON
          = Core.withObject "SparkPlanGraphNodeWrapper"
              (\ o ->
                 SparkPlanGraphNodeWrapper Core.<$>
                   (o Core..:? "cluster") Core.<*> (o Core..:? "node"))
...
newSparkRBatch 
    ::  SparkRBatch
newSparkRBatch
  = SparkRBatch{archiveUris = Core.Nothing, args = Core.Nothing,
                fileUris = Core.Nothing, mainRFileUri = Core.Nothing}
instance Core.FromJSON SparkRBatch where
        parseJSON
          = Core.withObject "SparkRBatch"
              (\ o ->
                 SparkRBatch Core.<$>
                   (o Core..:? "archiveUris") Core.<*> (o Core..:? "args") Core.<*>
                     (o Core..:? "fileUris")
...
newSparkRJob 
    ::  SparkRJob
newSparkRJob
  = SparkRJob{archiveUris = Core.Nothing, args = Core.Nothing,
              fileUris = Core.Nothing, loggingConfig = Core.Nothing,
              mainRFileUri = Core.Nothing, properties = Core.Nothing}
instance Core.FromJSON SparkRJob where
        parseJSON
          = Core.withObject "SparkRJob"
              (\ o ->
                 SparkRJob Core.<$>
                   (o Core..:? "archiveUris") Core.<*> (o Core..:? "args") Core.<*>
                     (o Core..:? "fileUris")
...
instance Core.FromJSON SparkRJob_Properties where
        parseJSON
          = Core.withObject "SparkRJob_Properties"
...
newSparkRuntimeInfo 
    ::  SparkRuntimeInfo
newSparkRuntimeInfo
  = SparkRuntimeInfo{javaHome = Core.Nothing,
                     javaVersion = Core.Nothing, scalaVersion = Core.Nothing}
instance Core.FromJSON SparkRuntimeInfo where
        parseJSON
          = Core.withObject "SparkRuntimeInfo"
              (\ o ->
                 SparkRuntimeInfo Core.<$>
                   (o Core..:? "javaHome") Core.<*> (o Core..:? "javaVersion")
...
newSparkSqlBatch 
    ::  SparkSqlBatch
newSparkSqlBatch
  = SparkSqlBatch{jarFileUris = Core.Nothing,
                  queryFileUri = Core.Nothing, queryVariables = Core.Nothing}
instance Core.FromJSON SparkSqlBatch where
        parseJSON
          = Core.withObject "SparkSqlBatch"
              (\ o ->
                 SparkSqlBatch Core.<$>
                   (o Core..:? "jarFileUris") Core.<*> (o Core..:? "queryFileUri")
...
instance Core.FromJSON SparkSqlBatch_QueryVariables where
        parseJSON
          = Core.withObject "SparkSqlBatch_QueryVariables"
              (\ o ->
...
newSparkSqlJob 
    ::  SparkSqlJob
newSparkSqlJob
  = SparkSqlJob{jarFileUris = Core.Nothing,
                loggingConfig = Core.Nothing, properties = Core.Nothing,
                queryFileUri = Core.Nothing, queryList = Core.Nothing,
                scriptVariables = Core.Nothing}
instance Core.FromJSON SparkSqlJob where
        parseJSON
          = Core.withObject "SparkSqlJob"
              (\ o ->
                 SparkSqlJob Core.<$>
                   (o Core..:? "jarFileUris") Core.<*> (o Core..:? "loggingConfig")
                     Core.<*> (o Core..:? "properties")
                     Core.<*> (o Core..:? "queryFileUri")
                     Core.<*> (o Core..:? "queryList")
                     Core.<*> (o Core..:? "scriptVariables"))
...
instance Core.FromJSON SparkSqlJob_Properties where
        parseJSON
          = Core.withObject "SparkSqlJob_Properties"
...
instance Core.FromJSON SparkSqlJob_ScriptVariables where
        parseJSON
          = Core.withObject "SparkSqlJob_ScriptVariables"
              (\ o ->
...
newSparkStandaloneAutoscalingConfig 
    :: 
                                    SparkStandaloneAutoscalingConfig
newSparkStandaloneAutoscalingConfig
  = SparkStandaloneAutoscalingConfig{gracefulDecommissionTimeout =
                                       Core.Nothing,
...
instance Core.FromJSON SparkStandaloneAutoscalingConfig where
        parseJSON
          = Core.withObject "SparkStandaloneAutoscalingConfig"
              (\ o ->
                 SparkStandaloneAutoscalingConfig Core.<$>
                   (o Core..:? "gracefulDecommissionTimeout") Core.<*>
                     (o Core..:? "removeOnlyIdleWorkers")
...
newSparkWrapperObject 
    ::  SparkWrapperObject
newSparkWrapperObject
  = SparkWrapperObject{appSummary = Core.Nothing,
                       applicationEnvironmentInfo = Core.Nothing,
                       applicationId = Core.Nothing, applicationInfo = Core.Nothing,
                       eventTimestamp = Core.Nothing, executorStageSummary = Core.Nothing,
                       executorSummary = Core.Nothing, jobData = Core.Nothing,
                       nativeBuildInfoUiData = Core.Nothing,
                       nativeSqlExecutionUiData = Core.Nothing, poolData = Core.Nothing,
                       processSummary = Core.Nothing, rddOperationGraph = Core.Nothing,
                       rddStorageInfo = Core.Nothing, resourceProfileInfo = Core.Nothing,
                       sparkPlanGraph = Core.Nothing,
                       speculationStageSummary = Core.Nothing,
                       sqlExecutionUiData = Core.Nothing, stageData = Core.Nothing,
                       streamBlockData = Core.Nothing, streamingQueryData = Core.Nothing,
                       streamingQueryProgress = Core.Nothing, taskData = Core.Nothing}
instance Core.FromJSON SparkWrapperObject where
        parseJSON
          = Core.withObject "SparkWrapperObject"
              (\ o ->
                 SparkWrapperObject Core.<$>
                   (o Core..:? "appSummary") Core.<*>
                     (o Core..:? "applicationEnvironmentInfo")
          ...
          = Core.object
              (Core.catMaybes
                 [("appSummary" Core..=) Core.<$> appSummary,
                  ...
                  ("nativeSqlExecutionUiData" Core..=) Core.<$>
                    nativeSqlExecutionUiData,
                  ...
                  ("sparkPlanGraph" Core..=) Core.<$> sparkPlanGraph,
                  ("speculationStageSummary" Core..=) Core.<$>
                    speculationStageSummary,
...
newSpeculationStageSummary 
    ::  SpeculationStageSummary
newSpeculationStageSummary
  = SpeculationStageSummary{numActiveTasks = Core.Nothing,
                            numCompletedTasks = Core.Nothing, numFailedTasks = Core.Nothing,
                            numKilledTasks = Core.Nothing, numTasks = Core.Nothing,
                            stageAttemptId = Core.Nothing, stageId = Core.Nothing}
instance Core.FromJSON SpeculationStageSummary where
        parseJSON
          = Core.withObject "SpeculationStageSummary"
              (\ o ->
                 SpeculationStageSummary Core.<$>
                   (o Core..:? "numActiveTasks") Core.<*>
                     (o Core..:? "numCompletedTasks")
                     Core.<*> (o Core..:? "numFailedTasks")
                     Core.<*> (o Core..:? "numKilledTasks")
                     Core.<*> (o Core..:? "numTasks")
                     Core.<*> (o Core..:? "stageAttemptId")
...
newSqlExecutionUiData 
    ::  SqlExecutionUiData
newSqlExecutionUiData
  = SqlExecutionUiData{completionTime = Core.Nothing,
                       description = Core.Nothing, details = Core.Nothing,
                       errorMessage = Core.Nothing, executionId = Core.Nothing,
                       jobs = Core.Nothing, metricValues = Core.Nothing,
                       metricValuesIsNull = Core.Nothing, metrics = Core.Nothing,
                       modifiedConfigs = Core.Nothing,
                       physicalPlanDescription = Core.Nothing,
                       rootExecutionId = Core.Nothing, stages = Core.Nothing,
                       submissionTime = Core.Nothing}
instance Core.FromJSON SqlExecutionUiData where
        parseJSON
          = Core.withObject "SqlExecutionUiData"
              (\ o ->
                 SqlExecutionUiData Core.<$>
                   (o Core..:? "completionTime") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "details")
                     ...
                     Core.<*>
                     (o Core..:? "rootExecutionId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "stages" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*> (o Core..:? "submissionTime"))
          ...
          = Core.object
              (Core.catMaybes
                 [("completionTime" Core..=) Core.<$> completionTime,
                  ...
                  ("physicalPlanDescription" Core..=) Core.<$>
                    physicalPlanDescription,
                  ("rootExecutionId" Core..=) Core.. Core.AsText Core.<$>
                    rootExecutionId,
...
instance Core.FromJSON SqlExecutionUiData_Jobs where
        parseJSON
          = Core.withObject "SqlExecutionUiData_Jobs"
...
instance Core.FromJSON SqlExecutionUiData_MetricValues where
        parseJSON
          = Core.withObject "SqlExecutionUiData_MetricValues"
              (\ o ->
...
instance Core.FromJSON SqlExecutionUiData_ModifiedConfigs where
        parseJSON
          = Core.withObject "SqlExecutionUiData_ModifiedConfigs"
              (\ o ->
                 SqlExecutionUiData_ModifiedConfigs Core.<$>
                   (Core.parseJSONObject o))
...
newSqlPlanMetric 
    ::  SqlPlanMetric
newSqlPlanMetric
  = SqlPlanMetric{accumulatorId = Core.Nothing,
                  metricType = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON SqlPlanMetric where
        parseJSON
          = Core.withObject "SqlPlanMetric"
              (\ o ->
                 SqlPlanMetric Core.<$>
                   (o Core..:? "accumulatorId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON SqlPlanMetric where
        toJSON SqlPlanMetric{..}
          = Core.object
              (Core.catMaybes
                 [("accumulatorId" Core..=) Core.. Core.AsText Core.<$>
                    accumulatorId,
...
newStageAttemptTasksSummary 
    ::  StageAttemptTasksSummary
newStageAttemptTasksSummary
  = StageAttemptTasksSummary{applicationId = Core.Nothing,
                             numFailedTasks = Core.Nothing, numKilledTasks = Core.Nothing,
                             numPendingTasks = Core.Nothing, numRunningTasks = Core.Nothing,
                             numSuccessTasks = Core.Nothing, numTasks = Core.Nothing,
                             stageAttemptId = Core.Nothing, stageId = Core.Nothing}
instance Core.FromJSON StageAttemptTasksSummary where
        parseJSON
          = Core.withObject "StageAttemptTasksSummary"
              (\ o ->
                 StageAttemptTasksSummary Core.<$>
                   (o Core..:? "applicationId") Core.<*> (o Core..:? "numFailedTasks")
                     Core.<*> (o Core..:? "numKilledTasks")
...
newStageData 
    ::  StageData
newStageData
  = StageData{accumulatorUpdates = Core.Nothing,
              completionTime = Core.Nothing, description = Core.Nothing,
              details = Core.Nothing,
              executorMetricsDistributions = Core.Nothing,
              executorSummary = Core.Nothing, failureReason = Core.Nothing,
              firstTaskLaunchedTime = Core.Nothing,
              isShufflePushEnabled = Core.Nothing, jobIds = Core.Nothing,
              killedTasksSummary = Core.Nothing, locality = Core.Nothing,
              name = Core.Nothing, numActiveTasks = Core.Nothing,
              numCompleteTasks = Core.Nothing,
              numCompletedIndices = Core.Nothing, numFailedTasks = Core.Nothing,
              numKilledTasks = Core.Nothing, numTasks = Core.Nothing,
              parentStageIds = Core.Nothing, peakExecutorMetrics = Core.Nothing,
              rddIds = Core.Nothing, resourceProfileId = Core.Nothing,
              schedulingPool = Core.Nothing, shuffleMergersCount = Core.Nothing,
              speculationSummary = Core.Nothing, stageAttemptId = Core.Nothing,
              stageId = Core.Nothing, stageMetrics = Core.Nothing,
              status = Core.Nothing, submissionTime = Core.Nothing,
              taskQuantileMetrics = Core.Nothing, tasks = Core.Nothing}
instance Core.FromJSON StageData where
        parseJSON
          = Core.withObject "StageData"
              (\ o ->
                 StageData Core.<$>
                   (o Core..:? "accumulatorUpdates") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("accumulatorUpdates" Core..=) Core.<$> accumulatorUpdates,
                  ...
                  ("description" Core..=) Core.<$> description,
                  ("details" Core..=) Core.<$> details,
                  ("executorMetricsDistributions" Core..=) Core.<$>
                    executorMetricsDistributions,
                  ("executorSummary" Core..=) Core.<$> executorSummary,
                  ...
                  ("numKilledTasks" Core..=) Core.<$> numKilledTasks,
                  ("numTasks" Core..=) Core.<$> numTasks,
                  ("parentStageIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    parentStageIds,
...
instance Core.FromJSON StageData_ExecutorSummary where
        parseJSON
          = Core.withObject "StageData_ExecutorSummary"
              (\ o ->
...
instance Core.FromJSON StageData_KilledTasksSummary where
        parseJSON
          = Core.withObject "StageData_KilledTasksSummary"
              (\ o ->
...
instance Core.FromJSON StageData_Locality where
        parseJSON
          = Core.withObject "StageData_Locality"
...
instance Core.FromJSON StageData_Tasks where
        parseJSON
          = Core.withObject "StageData_Tasks"
...
newStageInputMetrics 
    ::  StageInputMetrics
newStageInputMetrics
  = StageInputMetrics{bytesRead = Core.Nothing,
                      recordsRead = Core.Nothing}
instance Core.FromJSON StageInputMetrics where
        parseJSON
          = Core.withObject "StageInputMetrics"
              (\ o ->
                 StageInputMetrics Core.<$>
                   (o Core..:? "bytesRead" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "recordsRead" Core.<&> Core.fmap Core.fromAsText))
...
newStageMetrics 
    ::  StageMetrics
newStageMetrics
  = StageMetrics{diskBytesSpilled = Core.Nothing,
                 ...
                 jvmGcTimeMillis = Core.Nothing, memoryBytesSpilled = Core.Nothing,
                 peakExecutionMemoryBytes = Core.Nothing,
                 resultSerializationTimeMillis = Core.Nothing,
                 resultSize = Core.Nothing, stageInputMetrics = Core.Nothing,
...
instance Core.FromJSON StageMetrics where
        parseJSON
          = Core.withObject "StageMetrics"
              (\ o ->
                 StageMetrics Core.<$>
                   (o Core..:? "diskBytesSpilled" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "executorCpuTimeNanos" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "executorDeserializeCpuTimeNanos" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "executorDeserializeTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "executorRunTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "jvmGcTimeMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "memoryBytesSpilled" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "peakExecutionMemoryBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "resultSerializationTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "resultSize" Core.<&> Core.fmap Core.fromAsText)
        ...
        toJSON StageMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("diskBytesSpilled" Core..=) Core.. Core.AsText Core.<$>
                    diskBytesSpilled,
                  ("executorCpuTimeNanos" Core..=) Core.. Core.AsText Core.<$>
                    executorCpuTimeNanos,
                  ("executorDeserializeCpuTimeNanos" Core..=) Core.. Core.AsText
                    Core.<$> executorDeserializeCpuTimeNanos,
                  ("executorDeserializeTimeMillis" Core..=) Core.. Core.AsText
                    Core.<$> executorDeserializeTimeMillis,
                  ("executorRunTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    executorRunTimeMillis,
                  ("jvmGcTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    jvmGcTimeMillis,
                  ("memoryBytesSpilled" Core..=) Core.. Core.AsText Core.<$>
                    memoryBytesSpilled,
                  ("peakExecutionMemoryBytes" Core..=) Core.. Core.AsText Core.<$>
                    peakExecutionMemoryBytes,
                  ("resultSerializationTimeMillis" Core..=) Core.. Core.AsText
                  ...
                  ("stageShuffleReadMetrics" Core..=) Core.<$>
                    stageShuffleReadMetrics,
                  ("stageShuffleWriteMetrics" Core..=) Core.<$>
                    stageShuffleWriteMetrics])
...
newStageOutputMetrics 
    ::  StageOutputMetrics
newStageOutputMetrics
  = StageOutputMetrics{bytesWritten = Core.Nothing,
                       recordsWritten = Core.Nothing}
instance Core.FromJSON StageOutputMetrics where
        parseJSON
          = Core.withObject "StageOutputMetrics"
              (\ o ->
                 StageOutputMetrics Core.<$>
                   (o Core..:? "bytesWritten" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "recordsWritten" Core.<&> Core.fmap Core.fromAsText))
...
newStageShufflePushReadMetrics 
    ::  StageShufflePushReadMetrics
newStageShufflePushReadMetrics
  = StageShufflePushReadMetrics{corruptMergedBlockChunks =
                                  Core.Nothing,
                                localMergedBlocksFetched = Core.Nothing,
                                localMergedBytesRead = Core.Nothing,
                                localMergedChunksFetched = Core.Nothing,
...
instance Core.FromJSON StageShufflePushReadMetrics where
        parseJSON
          = Core.withObject "StageShufflePushReadMetrics"
              (\ o ->
...
newStageShuffleReadMetrics 
    ::  StageShuffleReadMetrics
newStageShuffleReadMetrics
  = StageShuffleReadMetrics{bytesRead = Core.Nothing,
...
instance Core.FromJSON StageShuffleReadMetrics where
        parseJSON
          = Core.withObject "StageShuffleReadMetrics"
              (\ o ->
          ...
          = Core.object
              (Core.catMaybes
                 [("bytesRead" Core..=) Core.. Core.AsText Core.<$> bytesRead,
                  ...
                  ("remoteReqsDuration" Core..=) Core.. Core.AsText Core.<$>
                    remoteReqsDuration,
                  ("stageShufflePushReadMetrics" Core..=) Core.<$>
                    stageShufflePushReadMetrics])
...
newStageShuffleWriteMetrics 
    ::  StageShuffleWriteMetrics
newStageShuffleWriteMetrics
  = StageShuffleWriteMetrics{bytesWritten = Core.Nothing,
                             recordsWritten = Core.Nothing, writeTimeNanos = Core.Nothing}
instance Core.FromJSON StageShuffleWriteMetrics where
        parseJSON
          = Core.withObject "StageShuffleWriteMetrics"
              (\ o ->
...
newStagesSummary 
    ::  StagesSummary
newStagesSummary
  = StagesSummary{applicationId = Core.Nothing,
                  numActiveStages = Core.Nothing, numCompletedStages = Core.Nothing,
                  numFailedStages = Core.Nothing, numPendingStages = Core.Nothing,
                  numSkippedStages = Core.Nothing}
instance Core.FromJSON StagesSummary where
        parseJSON
          = Core.withObject "StagesSummary"
              (\ o ->
                 StagesSummary Core.<$>
                   (o Core..:? "applicationId") Core.<*>
                     (o Core..:? "numActiveStages")
                     Core.<*> (o Core..:? "numCompletedStages")
                     Core.<*> (o Core..:? "numFailedStages")
...
newStartClusterRequest 
    ::  StartClusterRequest
newStartClusterRequest
  = StartClusterRequest{clusterUuid = Core.Nothing,
                        requestId = Core.Nothing}
instance Core.FromJSON StartClusterRequest where
        parseJSON
          = Core.withObject "StartClusterRequest"
              (\ o ->
                 StartClusterRequest Core.<$>
                   (o Core..:? "clusterUuid") Core.<*> (o Core..:? "requestId"))
...
instance Core.ToJSON StartupConfig where
        toJSON StartupConfig{..}
          = Core.object
              (Core.catMaybes
                 [("requiredRegistrationFraction" Core..=) Core.<$>
...
newStateHistory 
    ::  StateHistory
newStateHistory
  = StateHistory{state = Core.Nothing, stateMessage = Core.Nothing,
                 stateStartTime = Core.Nothing}
...
newStateOperatorProgress 
    ::  StateOperatorProgress
newStateOperatorProgress
  = StateOperatorProgress{allRemovalsTimeMs = Core.Nothing,
                          allUpdatesTimeMs = Core.Nothing, commitTimeMs = Core.Nothing,
                          customMetrics = Core.Nothing, memoryUsedBytes = Core.Nothing,
                          numRowsDroppedByWatermark = Core.Nothing,
                          numRowsRemoved = Core.Nothing, numRowsTotal = Core.Nothing,
                          numRowsUpdated = Core.Nothing, numShufflePartitions = Core.Nothing,
                          numStateStoreInstances = Core.Nothing, operatorName = Core.Nothing}
instance Core.FromJSON StateOperatorProgress where
        parseJSON
          = Core.withObject "StateOperatorProgress"
              (\ o ->
                 StateOperatorProgress Core.<$>
                   (o Core..:? "allRemovalsTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "allUpdatesTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "commitTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "customMetrics")
                     Core.<*>
                     (o Core..:? "memoryUsedBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsDroppedByWatermark" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsRemoved" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsTotal" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsUpdated" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numShufflePartitions" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numStateStoreInstances" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON StateOperatorProgress where
        toJSON StateOperatorProgress{..}
          = Core.object
              (Core.catMaybes
                 [("allRemovalsTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    allRemovalsTimeMs,
                  ("allUpdatesTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    allUpdatesTimeMs,
                  ("commitTimeMs" Core..=) Core.. Core.AsText Core.<$> commitTimeMs,
                  ("customMetrics" Core..=) Core.<$> customMetrics,
                  ("memoryUsedBytes" Core..=) Core.. Core.AsText Core.<$>
                    memoryUsedBytes,
                  ("numRowsDroppedByWatermark" Core..=) Core.. Core.AsText Core.<$>
                    numRowsDroppedByWatermark,
                  ("numRowsRemoved" Core..=) Core.. Core.AsText Core.<$>
                    numRowsRemoved,
                  ("numRowsTotal" Core..=) Core.. Core.AsText Core.<$> numRowsTotal,
                  ("numRowsUpdated" Core..=) Core.. Core.AsText Core.<$>
                    numRowsUpdated,
                  ("numShufflePartitions" Core..=) Core.. Core.AsText Core.<$>
                    numShufflePartitions,
                  ("numStateStoreInstances" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON StateOperatorProgress_CustomMetrics where
        parseJSON
          = Core.withObject "StateOperatorProgress_CustomMetrics"
              (\ o ->
                 StateOperatorProgress_CustomMetrics Core.<$>
                   (Core.parseJSONObject o))
...
newStatus 
    ::  Status
newStatus
  = Status{code = Core.Nothing, details = Core.Nothing,
...
newStopClusterRequest 
    ::  StopClusterRequest
newStopClusterRequest
  = StopClusterRequest{clusterUuid = Core.Nothing,
                       requestId = Core.Nothing}
instance Core.FromJSON StopClusterRequest where
        parseJSON
          = Core.withObject "StopClusterRequest"
              (\ o ->
                 StopClusterRequest Core.<$>
                   (o Core..:? "clusterUuid") Core.<*> (o Core..:? "requestId"))
...
newStreamBlockData 
    ::  StreamBlockData
newStreamBlockData
  = StreamBlockData{deserialized = Core.Nothing,
                    diskSize = Core.Nothing, executorId = Core.Nothing,
                    hostPort = Core.Nothing, memSize = Core.Nothing,
                    name = Core.Nothing, storageLevel = Core.Nothing,
                    useDisk = Core.Nothing, useMemory = Core.Nothing}
instance Core.FromJSON StreamBlockData where
        parseJSON
          = Core.withObject "StreamBlockData"
              (\ o ->
                 StreamBlockData Core.<$>
                   (o Core..:? "deserialized") Core.<*>
                     (o Core..:? "diskSize" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "executorId")
                     Core.<*> (o Core..:? "hostPort")
...
newStreamingQueryData 
    ::  StreamingQueryData
newStreamingQueryData
  = StreamingQueryData{endTimestamp = Core.Nothing,
                       exception = Core.Nothing, isActive = Core.Nothing,
                       name = Core.Nothing, runId = Core.Nothing,
                       startTimestamp = Core.Nothing, streamingQueryId = Core.Nothing}
instance Core.FromJSON StreamingQueryData where
        parseJSON
          = Core.withObject "StreamingQueryData"
              (\ o ->
                 StreamingQueryData Core.<$>
                   (o Core..:? "endTimestamp" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "exception")
                     Core.<*> (o Core..:? "isActive")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "runId")
                     Core.<*>
                     (o Core..:? "startTimestamp" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("endTimestamp" Core..=) Core.. Core.AsText Core.<$> endTimestamp,
                  ...
                  ("isActive" Core..=) Core.<$> isActive,
                  ("name" Core..=) Core.<$> name, ("runId" Core..=) Core.<$> runId,
                  ("startTimestamp" Core..=) Core.. Core.AsText Core.<$>
                    startTimestamp,
...
newStreamingQueryProgress 
    ::  StreamingQueryProgress
newStreamingQueryProgress
  = StreamingQueryProgress{batchDuration = Core.Nothing,
                           batchId = Core.Nothing, durationMillis = Core.Nothing,
                           eventTime = Core.Nothing, name = Core.Nothing,
                           observedMetrics = Core.Nothing, runId = Core.Nothing,
                           sink = Core.Nothing, sources = Core.Nothing,
                           stateOperators = Core.Nothing,
                           streamingQueryProgressId = Core.Nothing, timestamp = Core.Nothing}
instance Core.FromJSON StreamingQueryProgress where
        parseJSON
          = Core.withObject "StreamingQueryProgress"
              (\ o ->
                 StreamingQueryProgress Core.<$>
                   (o Core..:? "batchDuration" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON StreamingQueryProgress where
        toJSON StreamingQueryProgress{..}
          = Core.object
              (Core.catMaybes
                 [("batchDuration" Core..=) Core.. Core.AsText Core.<$>
                    batchDuration,
                  ...
                  ("runId" Core..=) Core.<$> runId, ("sink" Core..=) Core.<$> sink,
                  ("sources" Core..=) Core.<$> sources,
                  ("stateOperators" Core..=) Core.<$> stateOperators,
                  ("streamingQueryProgressId" Core..=) Core.<$>
...
instance Core.FromJSON StreamingQueryProgress_DurationMillis where
        parseJSON
          = Core.withObject "StreamingQueryProgress_DurationMillis"
              (\ o ->
                 StreamingQueryProgress_DurationMillis Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON StreamingQueryProgress_EventTime where
        parseJSON
          = Core.withObject "StreamingQueryProgress_EventTime"
              (\ o ->
...
instance Core.FromJSON StreamingQueryProgress_ObservedMetrics where
        parseJSON
          = Core.withObject "StreamingQueryProgress_ObservedMetrics"
              (\ o ->
                 StreamingQueryProgress_ObservedMetrics Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON SubmitJobRequest where
        parseJSON
          = Core.withObject "SubmitJobRequest"
              (\ o ->
                 SubmitJobRequest Core.<$>
                   (o Core..:? "job") Core.<*> (o Core..:? "requestId"))
...
newSummarizeSessionSparkApplicationExecutorsResponse 
    :: 
                                                     SummarizeSessionSparkApplicationExecutorsResponse
newSummarizeSessionSparkApplicationExecutorsResponse
  = SummarizeSessionSparkApplicationExecutorsResponse{activeExecutorSummary
                                                        = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "SummarizeSessionSparkApplicationExecutorsResponse"
              (\ o ->
                 SummarizeSessionSparkApplicationExecutorsResponse Core.<$>
                   (o Core..:? "activeExecutorSummary") Core.<*>
                     (o Core..:? "applicationId")
...
newSummarizeSessionSparkApplicationJobsResponse 
    :: 
                                                SummarizeSessionSparkApplicationJobsResponse
newSummarizeSessionSparkApplicationJobsResponse
  = SummarizeSessionSparkApplicationJobsResponse{jobsSummary =
                                                   Core.Nothing}
instance Core.FromJSON SummarizeSessionSparkApplicationJobsResponse
         where
        parseJSON
          = Core.withObject "SummarizeSessionSparkApplicationJobsResponse"
              (\ o ->
                 SummarizeSessionSparkApplicationJobsResponse Core.<$>
                   (o Core..:? "jobsSummary"))

instance Core.ToJSON SummarizeSessionSparkApplicationJobsResponse
         where
...
newSummarizeSessionSparkApplicationStageAttemptTasksResponse 
    :: 
                                                             SummarizeSessionSparkApplicationStageAttemptTasksResponse
newSummarizeSessionSparkApplicationStageAttemptTasksResponse
  = SummarizeSessionSparkApplicationStageAttemptTasksResponse{stageAttemptTasksSummary
                                                                = Core.Nothing}
instance Core.FromJSON
           SummarizeSessionSparkApplicationStageAttemptTasksResponse
         where
        parseJSON
          = Core.withObject
              "SummarizeSessionSparkApplicationStageAttemptTasksResponse"
              (\ o ->
                 SummarizeSessionSparkApplicationStageAttemptTasksResponse Core.<$>
                   (o Core..:? "stageAttemptTasksSummary"))
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("stageAttemptTasksSummary" Core..=) Core.<$>
                    stageAttemptTasksSummary])
...
newSummarizeSessionSparkApplicationStagesResponse 
    :: 
                                                  SummarizeSessionSparkApplicationStagesResponse
newSummarizeSessionSparkApplicationStagesResponse
  = SummarizeSessionSparkApplicationStagesResponse{stagesSummary =
                                                     Core.Nothing}
instance Core.FromJSON
           SummarizeSessionSparkApplicationStagesResponse
         where
        parseJSON
          = Core.withObject "SummarizeSessionSparkApplicationStagesResponse"
              (\ o ->
                 SummarizeSessionSparkApplicationStagesResponse Core.<$>
                   (o Core..:? "stagesSummary"))

instance Core.ToJSON SummarizeSessionSparkApplicationStagesResponse
         where
...
newSummarizeSparkApplicationExecutorsResponse 
    :: 
                                              SummarizeSparkApplicationExecutorsResponse
newSummarizeSparkApplicationExecutorsResponse
  = SummarizeSparkApplicationExecutorsResponse{activeExecutorSummary
                                                 = Core.Nothing,
                                               applicationId = Core.Nothing,
                                               deadExecutorSummary = Core.Nothing,
                                               totalExecutorSummary = Core.Nothing}
instance Core.FromJSON SummarizeSparkApplicationExecutorsResponse
         where
        parseJSON
          = Core.withObject "SummarizeSparkApplicationExecutorsResponse"
              (\ o ->
                 SummarizeSparkApplicationExecutorsResponse Core.<$>
                   (o Core..:? "activeExecutorSummary") Core.<*>
                     (o Core..:? "applicationId")
                     Core.<*> (o Core..:? "deadExecutorSummary")
                     Core.<*> (o Core..:? "totalExecutorSummary"))

instance Core.ToJSON SummarizeSparkApplicationExecutorsResponse
         where
...
instance Core.FromJSON SummarizeSparkApplicationJobsResponse where
        parseJSON
          = Core.withObject "SummarizeSparkApplicationJobsResponse"
              (\ o ->
                 SummarizeSparkApplicationJobsResponse Core.<$>
                   (o Core..:? "jobsSummary"))
...
newSummarizeSparkApplicationStageAttemptTasksResponse 
    :: 
                                                      SummarizeSparkApplicationStageAttemptTasksResponse
newSummarizeSparkApplicationStageAttemptTasksResponse
  = SummarizeSparkApplicationStageAttemptTasksResponse{stageAttemptTasksSummary
                                                         = Core.Nothing}
instance Core.FromJSON
           SummarizeSparkApplicationStageAttemptTasksResponse
         where
        parseJSON
          = Core.withObject
              "SummarizeSparkApplicationStageAttemptTasksResponse"
              (\ o ->
                 SummarizeSparkApplicationStageAttemptTasksResponse Core.<$>
                   (o Core..:? "stageAttemptTasksSummary"))
...
newSummarizeSparkApplicationStagesResponse 
    :: 
                                           SummarizeSparkApplicationStagesResponse
newSummarizeSparkApplicationStagesResponse
  = SummarizeSparkApplicationStagesResponse{stagesSummary =
                                              Core.Nothing}
instance Core.FromJSON SummarizeSparkApplicationStagesResponse
         where
        parseJSON
          = Core.withObject "SummarizeSparkApplicationStagesResponse"
              (\ o ->
                 SummarizeSparkApplicationStagesResponse Core.<$>
                   (o Core..:? "stagesSummary"))
...
newTaskData 
    ::  TaskData
newTaskData
  = TaskData{accumulatorUpdates = Core.Nothing,
             attempt = Core.Nothing, durationMillis = Core.Nothing,
             errorMessage = Core.Nothing, executorId = Core.Nothing,
             executorLogs = Core.Nothing,
             gettingResultTimeMillis = Core.Nothing, hasMetrics = Core.Nothing,
             host = Core.Nothing, index = Core.Nothing,
             launchTime = Core.Nothing, partitionId = Core.Nothing,
             resultFetchStart = Core.Nothing,
             schedulerDelayMillis = Core.Nothing, speculative = Core.Nothing,
             stageAttemptId = Core.Nothing, stageId = Core.Nothing,
             status = Core.Nothing, taskId = Core.Nothing,
             taskLocality = Core.Nothing, taskMetrics = Core.Nothing}
instance Core.FromJSON TaskData where
        parseJSON
          = Core.withObject "TaskData"
              (\ o ->
                 TaskData Core.<$>
                   (o Core..:? "accumulatorUpdates") Core.<*> (o Core..:? "attempt")
                     Core.<*>
                     (o Core..:? "durationMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "errorMessage")
                     Core.<*> (o Core..:? "executorId")
                     Core.<*> (o Core..:? "executorLogs")
                     Core.<*>
                     (o Core..:? "gettingResultTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "schedulerDelayMillis" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.FromJSON TaskData_ExecutorLogs where
        parseJSON
          = Core.withObject "TaskData_ExecutorLogs"
...
newTaskMetrics 
    ::  TaskMetrics
newTaskMetrics
  = TaskMetrics{diskBytesSpilled = Core.Nothing,
                executorCpuTimeNanos = Core.Nothing,
                executorDeserializeCpuTimeNanos = Core.Nothing,
                executorDeserializeTimeMillis = Core.Nothing,
                executorRunTimeMillis = Core.Nothing, inputMetrics = Core.Nothing,
                jvmGcTimeMillis = Core.Nothing, memoryBytesSpilled = Core.Nothing,
                outputMetrics = Core.Nothing,
                peakExecutionMemoryBytes = Core.Nothing,
                resultSerializationTimeMillis = Core.Nothing,
                resultSize = Core.Nothing, shuffleReadMetrics = Core.Nothing,
                shuffleWriteMetrics = Core.Nothing}
instance Core.FromJSON TaskMetrics where
        parseJSON
          = Core.withObject "TaskMetrics"
              (\ o ->
                 TaskMetrics Core.<$>
                   (o Core..:? "diskBytesSpilled" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
...
newTaskQuantileMetrics 
    ::  TaskQuantileMetrics
newTaskQuantileMetrics
  = TaskQuantileMetrics{diskBytesSpilled = Core.Nothing,
                        durationMillis = Core.Nothing, executorCpuTimeNanos = Core.Nothing,
                        executorDeserializeCpuTimeNanos = Core.Nothing,
                        executorDeserializeTimeMillis = Core.Nothing,
                        executorRunTimeMillis = Core.Nothing,
                        gettingResultTimeMillis = Core.Nothing,
                        inputMetrics = Core.Nothing, jvmGcTimeMillis = Core.Nothing,
                        memoryBytesSpilled = Core.Nothing, outputMetrics = Core.Nothing,
                        peakExecutionMemoryBytes = Core.Nothing,
                        resultSerializationTimeMillis = Core.Nothing,
                        resultSize = Core.Nothing, schedulerDelayMillis = Core.Nothing,
                        shuffleReadMetrics = Core.Nothing,
                        shuffleWriteMetrics = Core.Nothing}
instance Core.FromJSON TaskQuantileMetrics where
        parseJSON
          = Core.withObject "TaskQuantileMetrics"
              (\ o ->
                 TaskQuantileMetrics Core.<$>
                   (o Core..:? "diskBytesSpilled") Core.<*>
                     (o Core..:? "durationMillis")
          ...
          = Core.object
              (Core.catMaybes
                 [("diskBytesSpilled" Core..=) Core.<$> diskBytesSpilled,
                  ...
                  ("executorDeserializeCpuTimeNanos" Core..=) Core.<$>
                    executorDeserializeCpuTimeNanos,
                  ("executorDeserializeTimeMillis" Core..=) Core.<$>
                    executorDeserializeTimeMillis,
                  ("executorRunTimeMillis" Core..=) Core.<$> executorRunTimeMillis,
                  ("gettingResultTimeMillis" Core..=) Core.<$>
                    gettingResultTimeMillis,
                  ("inputMetrics" Core..=) Core.<$> inputMetrics,
                  ("jvmGcTimeMillis" Core..=) Core.<$> jvmGcTimeMillis,
                  ("memoryBytesSpilled" Core..=) Core.<$> memoryBytesSpilled,
                  ("outputMetrics" Core..=) Core.<$> outputMetrics,
                  ("peakExecutionMemoryBytes" Core..=) Core.<$>
                    peakExecutionMemoryBytes,
                  ("resultSerializationTimeMillis" Core..=) Core.<$>
...
newTaskResourceRequest 
    ::  TaskResourceRequest
newTaskResourceRequest
  = TaskResourceRequest{amount = Core.Nothing,
                        resourceName = Core.Nothing}
instance Core.FromJSON TaskResourceRequest where
        parseJSON
          = Core.withObject "TaskResourceRequest"
              (\ o ->
                 TaskResourceRequest Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "resourceName"))
...
newTemplateParameter 
    ::  TemplateParameter
newTemplateParameter
  = TemplateParameter{description = Core.Nothing,
                      fields = Core.Nothing, name = Core.Nothing,
                      validation = Core.Nothing}
instance Core.FromJSON TemplateParameter where
        parseJSON
          = Core.withObject "TemplateParameter"
              (\ o ->
                 TemplateParameter Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "fields") Core.<*>
                     (o Core..:? "name")
...
instance Core.ToJSON TemplateParameter where
        toJSON TemplateParameter{..}
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("fields" Core..=) Core.<$> fields, ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON TerminateSessionRequest where
        parseJSON
          = Core.withObject "TerminateSessionRequest"
...
newTrinoJob 
    ::  TrinoJob
newTrinoJob
  = TrinoJob{clientTags = Core.Nothing,
             continueOnFailure = Core.Nothing, loggingConfig = Core.Nothing,
             outputFormat = Core.Nothing, properties = Core.Nothing,
             queryFileUri = Core.Nothing, queryList = Core.Nothing}
instance Core.FromJSON TrinoJob where
        parseJSON
          = Core.withObject "TrinoJob"
              (\ o ->
                 TrinoJob Core.<$>
                   (o Core..:? "clientTags") Core.<*> (o Core..:? "continueOnFailure")
                     Core.<*> (o Core..:? "loggingConfig")
...
instance Core.FromJSON TrinoJob_Properties where
        parseJSON
          = Core.withObject "TrinoJob_Properties"
...
data UsageMetrics = UsageMetrics
    ...
    , milliSlotSeconds :: (Core.Maybe Core.Int64)
...
newUsageMetrics 
    ::  UsageMetrics
newUsageMetrics
  = UsageMetrics{acceleratorType = Core.Nothing,
                 milliAcceleratorSeconds = Core.Nothing,
                 milliDcuSeconds = Core.Nothing, milliSlotSeconds = Core.Nothing,
                 shuffleStorageGbSeconds = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON UsageMetrics where
        parseJSON
          = Core.withObject "UsageMetrics"
              (\ o ->
                 UsageMetrics Core.<$>
                   (o Core..:? "acceleratorType") Core.<*>
                     (o Core..:? "milliAcceleratorSeconds" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "milliDcuSeconds" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "milliSlotSeconds" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shuffleStorageGbSeconds" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "updateTime"))
...
instance Core.ToJSON UsageMetrics where
        toJSON UsageMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("acceleratorType" Core..=) Core.<$> acceleratorType,
                  ("milliAcceleratorSeconds" Core..=) Core.. Core.AsText Core.<$>
                    milliAcceleratorSeconds,
                  ("milliDcuSeconds" Core..=) Core.. Core.AsText Core.<$>
                    milliDcuSeconds,
                  ("milliSlotSeconds" Core..=) Core.. Core.AsText Core.<$>
                    milliSlotSeconds,
                  ("shuffleStorageGbSeconds" Core..=) Core.. Core.AsText Core.<$>
...
data UsageSnapshot = UsageSnapshot
    ...
    , milliSlot :: (Core.Maybe Core.Int64)
...
newUsageSnapshot 
    ::  UsageSnapshot
newUsageSnapshot
  = UsageSnapshot{acceleratorType = Core.Nothing,
                  milliAccelerator = Core.Nothing, milliDcu = Core.Nothing,
                  milliDcuPremium = Core.Nothing, milliSlot = Core.Nothing,
...
instance Core.FromJSON UsageSnapshot where
        parseJSON
          = Core.withObject "UsageSnapshot"
              (\ o ->
                 UsageSnapshot Core.<$>
                   (o Core..:? "acceleratorType") Core.<*>
                     (o Core..:? "milliAccelerator" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "milliDcu" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "milliDcuPremium" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "milliSlot" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shuffleStorageGb" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shuffleStorageGbPremium" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON UsageSnapshot where
        toJSON UsageSnapshot{..}
          = Core.object
              (Core.catMaybes
                 [("acceleratorType" Core..=) Core.<$> acceleratorType,
                  ("milliAccelerator" Core..=) Core.. Core.AsText Core.<$>
                    milliAccelerator,
                  ("milliDcu" Core..=) Core.. Core.AsText Core.<$> milliDcu,
                  ("milliDcuPremium" Core..=) Core.. Core.AsText Core.<$>
                    milliDcuPremium,
                  ("milliSlot" Core..=) Core.. Core.AsText Core.<$> milliSlot,
                  ("shuffleStorageGb" Core..=) Core.. Core.AsText Core.<$>
                    shuffleStorageGb,
                  ("shuffleStorageGbPremium" Core..=) Core.. Core.AsText Core.<$>
...
--
-- /See:/ 'newValueInfo' smart constructor.
data ValueInfo = ValueInfo
    ...
    , overriddenValue :: (Core.Maybe Core.Text)
      -- | Property value.
    , value :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ValueInfo' with the minimum fields required to make a request.
newValueInfo 
    ::  ValueInfo
newValueInfo
  = ValueInfo{annotation = Core.Nothing,
              overriddenValue = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON ValueInfo where
        parseJSON
          = Core.withObject "ValueInfo"
              (\ o ->
                 ValueInfo Core.<$>
                   (o Core..:? "annotation") Core.<*> (o Core..:? "overriddenValue")
                     Core.<*> (o Core..:? "value"))

instance Core.ToJSON ValueInfo where
        toJSON ValueInfo{..}
          = Core.object
              (Core.catMaybes
                 [("annotation" Core..=) Core.<$> annotation,
                  ("overriddenValue" Core..=) Core.<$> overriddenValue,
                  ("value" Core..=) Core.<$> value])
...
instance Core.FromJSON ValueValidation where
        parseJSON
          = Core.withObject "ValueValidation"
...
newVirtualClusterConfig 
    ::  VirtualClusterConfig
newVirtualClusterConfig
  = VirtualClusterConfig{auxiliaryServicesConfig = Core.Nothing,
                         kubernetesClusterConfig = Core.Nothing,
                         stagingBucket = Core.Nothing}
instance Core.FromJSON VirtualClusterConfig where
        parseJSON
          = Core.withObject "VirtualClusterConfig"
              (\ o ->
                 VirtualClusterConfig Core.<$>
                   (o Core..:? "auxiliaryServicesConfig") Core.<*>
                     (o Core..:? "kubernetesClusterConfig")
                     Core.<*> (o Core..:? "stagingBucket"))
...
instance Core.ToJSON VirtualClusterConfig where
        toJSON VirtualClusterConfig{..}
          = Core.object
              (Core.catMaybes
                 [("auxiliaryServicesConfig" Core..=) Core.<$>
                    auxiliaryServicesConfig,
                  ("kubernetesClusterConfig" Core..=) Core.<$>
                    kubernetesClusterConfig,
                  ("stagingBucket" Core..=) Core.<$> stagingBucket])
...
newWorkflowMetadata 
    ::  WorkflowMetadata
newWorkflowMetadata
  = WorkflowMetadata{clusterName = Core.Nothing,
                     clusterUuid = Core.Nothing, createCluster = Core.Nothing,
                     dagEndTime = Core.Nothing, dagStartTime = Core.Nothing,
                     dagTimeout = Core.Nothing, deleteCluster = Core.Nothing,
                     endTime = Core.Nothing, graph = Core.Nothing,
                     parameters = Core.Nothing, startTime = Core.Nothing,
                     state = Core.Nothing, template = Core.Nothing,
                     version = Core.Nothing}
instance Core.FromJSON WorkflowMetadata where
        parseJSON
          = Core.withObject "WorkflowMetadata"
              (\ o ->
                 WorkflowMetadata Core.<$>
                   (o Core..:? "clusterName") Core.<*> (o Core..:? "clusterUuid")
...
instance Core.FromJSON WorkflowMetadata_Parameters where
        parseJSON
          = Core.withObject "WorkflowMetadata_Parameters"
              (\ o ->
...
newWorkflowNode 
    ::  WorkflowNode
newWorkflowNode
  = WorkflowNode{error = Core.Nothing, jobId = Core.Nothing,
                 prerequisiteStepIds = Core.Nothing, state = Core.Nothing,
                 stepId = Core.Nothing}
instance Core.FromJSON WorkflowNode where
        parseJSON
          = Core.withObject "WorkflowNode"
              (\ o ->
                 WorkflowNode Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "jobId") Core.<*>
                     (o Core..:? "prerequisiteStepIds")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "stepId"))
...
newWorkflowTemplate 
    ::  WorkflowTemplate
newWorkflowTemplate
  = WorkflowTemplate{createTime = Core.Nothing,
                     dagTimeout = Core.Nothing, encryptionConfig = Core.Nothing,
                     id = Core.Nothing, jobs = Core.Nothing, labels = Core.Nothing,
                     name = Core.Nothing, parameters = Core.Nothing,
                     placement = Core.Nothing, updateTime = Core.Nothing,
                     version = Core.Nothing}
instance Core.FromJSON WorkflowTemplate where
        parseJSON
          = Core.withObject "WorkflowTemplate"
              (\ o ->
                 WorkflowTemplate Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "dagTimeout")
                     Core.<*> (o Core..:? "encryptionConfig")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "jobs")
                     Core.<*> (o Core..:? "labels")
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("dagTimeout" Core..=) Core.<$> dagTimeout,
                  ("encryptionConfig" Core..=) Core.<$> encryptionConfig,
                  ("id" Core..=) Core.<$> id, ("jobs" Core..=) Core.<$> jobs,
                  ("labels" Core..=) Core.<$> labels, ("name" Core..=) Core.<$> name,
                  ("parameters" Core..=) Core.<$> parameters,
                  ("placement" Core..=) Core.<$> placement,
                  ("updateTime" Core..=) Core.<$> updateTime,
...
instance Core.FromJSON WorkflowTemplate_Labels where
        parseJSON
          = Core.withObject "WorkflowTemplate_Labels"
...
newWorkflowTemplatePlacement 
    ::  WorkflowTemplatePlacement
newWorkflowTemplatePlacement
  = WorkflowTemplatePlacement{clusterSelector = Core.Nothing,
                              managedCluster = Core.Nothing}
instance Core.FromJSON WorkflowTemplatePlacement where
        parseJSON
          = Core.withObject "WorkflowTemplatePlacement"
              (\ o ->
                 WorkflowTemplatePlacement Core.<$>
                   (o Core..:? "clusterSelector") Core.<*>
                     (o Core..:? "managedCluster"))
...
newWriteSessionSparkApplicationContextRequest 
    :: 
                                              WriteSessionSparkApplicationContextRequest
newWriteSessionSparkApplicationContextRequest
  = WriteSessionSparkApplicationContextRequest{parent = Core.Nothing,
                                               sparkWrapperObjects = Core.Nothing}
instance Core.FromJSON WriteSessionSparkApplicationContextRequest
         where
        parseJSON
          = Core.withObject "WriteSessionSparkApplicationContextRequest"
              (\ o ->
                 WriteSessionSparkApplicationContextRequest Core.<$>
                   (o Core..:? "parent") Core.<*> (o Core..:? "sparkWrapperObjects"))

instance Core.ToJSON WriteSessionSparkApplicationContextRequest
         where
...
newWriteSessionSparkApplicationContextResponse
  = WriteSessionSparkApplicationContextResponse
instance Core.FromJSON WriteSessionSparkApplicationContextResponse
         where
        parseJSON
          = Core.withObject "WriteSessionSparkApplicationContextResponse"
...
newWriteSparkApplicationContextRequest 
    :: 
                                       WriteSparkApplicationContextRequest
newWriteSparkApplicationContextRequest
  = WriteSparkApplicationContextRequest{parent = Core.Nothing,
                                        sparkWrapperObjects = Core.Nothing}
instance Core.FromJSON WriteSparkApplicationContextRequest where
        parseJSON
          = Core.withObject "WriteSparkApplicationContextRequest"
              (\ o ->
                 WriteSparkApplicationContextRequest Core.<$>
                   (o Core..:? "parent") Core.<*> (o Core..:? "sparkWrapperObjects"))
...
instance Core.FromJSON WriteSparkApplicationContextResponse where
        parseJSON
          = Core.withObject "WriteSparkApplicationContextResponse"
...
newYarnApplication 
    ::  YarnApplication
newYarnApplication
  = YarnApplication{name = Core.Nothing, progress = Core.Nothing,
                    state = Core.Nothing, trackingUrl = Core.Nothing}
instance Core.FromJSON YarnApplication where
        parseJSON
          = Core.withObject "YarnApplication"
              (\ o ->
                 YarnApplication Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "progress") Core.<*>
                     (o Core..:? "state")
