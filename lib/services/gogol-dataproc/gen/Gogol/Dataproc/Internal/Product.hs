...
newAcceleratorConfig =
  AcceleratorConfig
    {acceleratorCount = Core.Nothing, acceleratorTypeUri = Core.Nothing}
...
instance Core.ToJSON AcceleratorConfig where
        toJSON AcceleratorConfig{..}
          = Core.object
              (Core.catMaybes
                 [("acceleratorCount" Core..=) Core.<$>
                    acceleratorCount,
                  ("acceleratorTypeUri" Core..=) Core.<$>
                    acceleratorTypeUri])
          ...
          = Core.object
              (Core.catMaybes
                 [("basicAlgorithm" Core..=) Core.<$> basicAlgorithm,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("secondaryWorkerConfig" Core..=) Core.<$>
...
newAuxiliaryServicesConfig =
  AuxiliaryServicesConfig
    {metastoreConfig = Core.Nothing, sparkHistoryServerConfig = Core.Nothing}
...
instance Core.FromJSON BasicAutoscalingAlgorithm
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("cooldownPeriod" Core..=) Core.<$> cooldownPeriod,
                  ("sparkStandaloneConfig" Core..=) Core.<$>
...
instance Core.FromJSON BasicYarnAutoscalingConfig
         where
        parseJSON
...
instance Core.FromJSON BatchOperationMetadata_Labels
         where
        parseJSON
          = Core.withObject "BatchOperationMetadata_Labels"
              (\ o ->
                 BatchOperationMetadata_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON BatchOperationMetadata_Labels
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("clusterName" Core..=) Core.<$> clusterName,
                  ...
                  ("virtualClusterConfig" Core..=) Core.<$>
                    virtualClusterConfig])
...
newCluster_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Cluster_Labels
newCluster_Labels additional = Cluster_Labels {additional = additional}
...
instance Core.ToJSON ClusterConfig where
        toJSON ClusterConfig{..}
          = Core.object
              (Core.catMaybes
                 [("autoscalingConfig" Core..=) Core.<$>
                    autoscalingConfig,
                  ("auxiliaryNodeGroups" Core..=) Core.<$>
                    auxiliaryNodeGroups,
                  ("configBucket" Core..=) Core.<$> configBucket,
                  ("dataprocMetricConfig" Core..=) Core.<$>
                    dataprocMetricConfig,
                  ("encryptionConfig" Core..=) Core.<$>
                    encryptionConfig,
                  ("endpointConfig" Core..=) Core.<$> endpointConfig,
                  ("gceClusterConfig" Core..=) Core.<$>
                    gceClusterConfig,
                  ("gkeClusterConfig" Core..=) Core.<$>
                    gkeClusterConfig,
                  ("initializationActions" Core..=) Core.<$>
...
instance Core.FromJSON ClusterMetrics_HdfsMetrics
         where
        parseJSON
          = Core.withObject "ClusterMetrics_HdfsMetrics"
              (\ o ->
                 ClusterMetrics_HdfsMetrics Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON ClusterMetrics_YarnMetrics
         where
        parseJSON
          = Core.withObject "ClusterMetrics_YarnMetrics"
              (\ o ->
                 ClusterMetrics_YarnMetrics Core.<$>
                   (Core.parseJSONObject o))
...
newClusterOperation =
  ClusterOperation
    {done = Core.Nothing, error = Core.Nothing, operationId = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "ClusterOperationMetadata_Labels"
              (\ o ->
                 ClusterOperationMetadata_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ClusterOperationMetadata_Labels
         where
...
instance Core.FromJSON ClusterSelector_ClusterLabels
         where
        parseJSON
          = Core.withObject "ClusterSelector_ClusterLabels"
              (\ o ->
                 ClusterSelector_ClusterLabels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ClusterSelector_ClusterLabels
         where
...
instance Core.FromJSON ClusterStatus where
        parseJSON
          = Core.withObject "ClusterStatus"
              (\ o ->
                 ClusterStatus Core.<$>
                   (o Core..:? "detail") Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "stateStartTime")
...
instance Core.FromJSON ConfidentialInstanceConfig
         where
        parseJSON
...
instance Core.ToJSON DiagnoseClusterRequest where
        toJSON DiagnoseClusterRequest{..}
          = Core.object
              (Core.catMaybes
                 [("diagnosisInterval" Core..=) Core.<$>
                    diagnosisInterval,
                  ("job" Core..=) Core.<$> job,
                  ("jobs" Core..=) Core.<$> jobs,
                  ("yarnApplicationId" Core..=) Core.<$>
                    yarnApplicationId,
                  ("yarnApplicationIds" Core..=) Core.<$>
                    yarnApplicationIds])
...
instance Core.ToJSON EndpointConfig where
        toJSON EndpointConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enableHttpPortAccess" Core..=) Core.<$>
...
newEnvironmentConfig =
  EnvironmentConfig
    {executionConfig = Core.Nothing, peripheralsConfig = Core.Nothing}
...
instance Core.ToJSON EnvironmentConfig where
        toJSON EnvironmentConfig{..}
          = Core.object
              (Core.catMaybes
                 [("executionConfig" Core..=) Core.<$>
                    executionConfig,
                  ("peripheralsConfig" Core..=) Core.<$>
                    peripheralsConfig])
          ...
          = Core.withObject "ExecutionConfig"
              (\ o ->
                 ExecutionConfig Core.<$>
                   (o Core..:? "idleTtl") Core.<*> (o Core..:? "kmsKey")
              ...
              (Core.catMaybes
                 [("confidentialInstanceConfig" Core..=) Core.<$>
                  ...
                  ("reservationAffinity" Core..=) Core.<$>
                    reservationAffinity,
                  ("serviceAccount" Core..=) Core.<$> serviceAccount,
                  ("serviceAccountScopes" Core..=) Core.<$>
...
instance Core.FromJSON GceClusterConfig_Metadata
         where
        parseJSON
          = Core.withObject "GceClusterConfig_Metadata"
              (\ o ->
                 GceClusterConfig_Metadata Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON GkeNodePoolAcceleratorConfig
         where
        parseJSON
...
instance Core.ToJSON GkeNodePoolAcceleratorConfig
         where
...
instance Core.FromJSON GkeNodePoolAutoscalingConfig
         where
        parseJSON
          = Core.withObject "GkeNodePoolAutoscalingConfig"
              (\ o ->
                 GkeNodePoolAutoscalingConfig Core.<$>
                   (o Core..:? "maxNodeCount") Core.<*>
                     (o Core..:? "minNodeCount"))

instance Core.ToJSON GkeNodePoolAutoscalingConfig
         where
          ...
          = Core.withObject "GkeNodePoolTarget"
              (\ o ->
                 GkeNodePoolTarget Core.<$>
                   (o Core..:? "nodePool") Core.<*>
                     (o Core..:? "nodePoolConfig")
                     Core.<*> (o Core..:? "roles"))
...
newHiveJob_Properties 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> HiveJob_Properties
newHiveJob_Properties additional = HiveJob_Properties {additional = additional}
...
instance Core.FromJSON IdentityConfig where
        parseJSON
          = Core.withObject "IdentityConfig"
              (\ o ->
                 IdentityConfig Core.<$>
                   (o Core..:? "userServiceAccountMapping"))
...
newInjectCredentialsRequest =
  InjectCredentialsRequest
    {clusterUuid = Core.Nothing, credentialsCiphertext = Core.Nothing}
...
instance Core.ToJSON InjectCredentialsRequest where
        toJSON InjectCredentialsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("clusterUuid" Core..=) Core.<$> clusterUuid,
                  ("credentialsCiphertext" Core..=) Core.<$>
...
newInstantiateWorkflowTemplateRequest_Parameters additional =
  InstantiateWorkflowTemplateRequest_Parameters {additional = additional}
...
instance Core.ToJSON Job where
        toJSON Job{..}
          = Core.object
              (Core.catMaybes
                 [("done" Core..=) Core.<$> done,
                  ("driverControlFilesUri" Core..=) Core.<$>
                    driverControlFilesUri,
                  ("driverOutputResourceUri" Core..=) Core.<$>
                    driverOutputResourceUri,
                  ("driverSchedulingConfig" Core..=) Core.<$>
                    driverSchedulingConfig,
...
instance Core.FromJSON JobPlacement_ClusterLabels
         where
        parseJSON
          = Core.withObject "JobPlacement_ClusterLabels"
              (\ o ->
                 JobPlacement_ClusterLabels Core.<$>
                   (Core.parseJSONObject o))
...
newJobScheduling =
  JobScheduling
    {maxFailuresPerHour = Core.Nothing, maxFailuresTotal = Core.Nothing}
...
instance Core.ToJSON JobScheduling where
        toJSON JobScheduling{..}
          = Core.object
              (Core.catMaybes
                 [("maxFailuresPerHour" Core..=) Core.<$>
                    maxFailuresPerHour,
                  ("maxFailuresTotal" Core..=) Core.<$>
                    maxFailuresTotal])
...
instance Core.FromJSON JobStatus where
        parseJSON
          = Core.withObject "JobStatus"
              (\ o ->
                 JobStatus Core.<$>
                   (o Core..:? "details") Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "stateStartTime")
                     Core.<*> (o Core..:? "substate"))
              ...
              (\ o ->
                 KerberosConfig Core.<$>
                   (o Core..:? "crossRealmTrustAdminServer") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "crossRealmTrustSharedPasswordUri")
          ...
          = Core.object
              (Core.catMaybes
                 [("crossRealmTrustAdminServer" Core..=) Core.<$>
                  ...
                  ("crossRealmTrustKdc" Core..=) Core.<$>
                    crossRealmTrustKdc,
                  ("crossRealmTrustRealm" Core..=) Core.<$>
                  ...
                  ("tgtLifetimeHours" Core..=) Core.<$>
                    tgtLifetimeHours,
                  ("truststorePasswordUri" Core..=) Core.<$>
...
newKubernetesSoftwareConfig =
  KubernetesSoftwareConfig
    {componentVersion = Core.Nothing, properties = Core.Nothing}
          ...
          = Core.withObject "LifecycleConfig"
              (\ o ->
                 LifecycleConfig Core.<$>
                   (o Core..:? "autoDeleteTime") Core.<*>
                     (o Core..:? "autoDeleteTtl")
...
newListAutoscalingPoliciesResponse =
  ListAutoscalingPoliciesResponse
    {nextPageToken = Core.Nothing, policies = Core.Nothing}
...
instance Core.ToJSON ListAutoscalingPoliciesResponse
         where
...
newListWorkflowTemplatesResponse =
  ListWorkflowTemplatesResponse
    {nextPageToken = Core.Nothing, templates = Core.Nothing}

instance Core.FromJSON ListWorkflowTemplatesResponse
         where
        parseJSON
...
instance Core.ToJSON ListWorkflowTemplatesResponse
         where
...
instance Core.FromJSON LoggingConfig_DriverLogLevels
         where
        parseJSON
          = Core.withObject "LoggingConfig_DriverLogLevels"
              (\ o ->
                 LoggingConfig_DriverLogLevels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON LoggingConfig_DriverLogLevels
         where
...
newManagedCluster =
  ManagedCluster
    {clusterName = Core.Nothing, config = Core.Nothing, labels = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("instanceGroupManagerName" Core..=) Core.<$>
                  ...
                  ("instanceTemplateName" Core..=) Core.<$>
          ...
          = Core.withObject "MetastoreConfig"
              (\ o ->
                 MetastoreConfig Core.<$>
                   (o Core..:? "dataprocMetastoreService"))
...
newNamespacedGkeDeploymentTarget =
  NamespacedGkeDeploymentTarget
    {clusterNamespace = Core.Nothing, targetGkeCluster = Core.Nothing}

instance Core.FromJSON NamespacedGkeDeploymentTarget
         where
        parseJSON
...
instance Core.ToJSON NamespacedGkeDeploymentTarget
         where
        toJSON NamespacedGkeDeploymentTarget{..}
          = Core.object
              (Core.catMaybes
                 [("clusterNamespace" Core..=) Core.<$>
                    clusterNamespace,
                  ("targetGkeCluster" Core..=) Core.<$>
                    targetGkeCluster])
...
instance Core.FromJSON NodeGroup where
        parseJSON
          = Core.withObject "NodeGroup"
              (\ o ->
                 NodeGroup Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "name")
...
instance Core.FromJSON NodeGroupOperationMetadata
         where
        parseJSON
...
newNodeInitializationAction =
  NodeInitializationAction
    {executableFile = Core.Nothing, executionTimeout = Core.Nothing}
...
newOrderedJob_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> OrderedJob_Labels
newOrderedJob_Labels additional = OrderedJob_Labels {additional = additional}
...
newPeripheralsConfig =
  PeripheralsConfig
    {metastoreService = Core.Nothing, sparkHistoryServerConfig = Core.Nothing}
...
newPigJob_Properties 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> PigJob_Properties
newPigJob_Properties additional = PigJob_Properties {additional = additional}
...
instance Core.FromJSON PrestoJob where
        parseJSON
          = Core.withObject "PrestoJob"
              (\ o ->
                 PrestoJob Core.<$>
                   (o Core..:? "clientTags") Core.<*>
                     (o Core..:? "continueOnFailure")
                     Core.<*> (o Core..:? "loggingConfig")
...
instance Core.ToJSON RuntimeInfo where
        toJSON RuntimeInfo{..}
          = Core.object
              (Core.catMaybes
                 [("approximateUsage" Core..=) Core.<$>
                    approximateUsage,
                  ("currentUsage" Core..=) Core.<$> currentUsage,
                  ("diagnosticOutputUri" Core..=) Core.<$>
                    diagnosticOutputUri,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "SessionOperationMetadata_Labels"
              (\ o ->
                 SessionOperationMetadata_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SessionOperationMetadata_Labels
         where
...
instance Core.FromJSON SoftwareConfig_Properties
         where
        parseJSON
          = Core.withObject "SoftwareConfig_Properties"
              (\ o ->
                 SoftwareConfig_Properties Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON SparkSqlBatch_QueryVariables
         where
        parseJSON
          = Core.withObject "SparkSqlBatch_QueryVariables"
              (\ o ->
                 SparkSqlBatch_QueryVariables Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SparkSqlBatch_QueryVariables
         where
...
instance Core.FromJSON SparkSqlJob_ScriptVariables
         where
        parseJSON
          = Core.withObject "SparkSqlJob_ScriptVariables"
              (\ o ->
                 SparkSqlJob_ScriptVariables Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SparkSqlJob_ScriptVariables
         where
...
instance Core.ToJSON SparkStandaloneAutoscalingConfig
         where
...
newUsageMetrics =
  UsageMetrics
    {milliDcuSeconds = Core.Nothing, shuffleStorageGbSeconds = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("milliDcuSeconds" Core..=) Core.. Core.AsText
                  ...
                  ("shuffleStorageGbSeconds" Core..=) Core..
                    Core.AsText
...
instance Core.FromJSON UsageSnapshot where
        parseJSON
          = Core.withObject "UsageSnapshot"
              (\ o ->
                 UsageSnapshot Core.<$>
                   (o Core..:? "milliDcu" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shuffleStorageGb" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON UsageSnapshot where
        toJSON UsageSnapshot{..}
          = Core.object
              (Core.catMaybes
                 [("milliDcu" Core..=) Core.. Core.AsText Core.<$>
                    milliDcu,
...
instance Core.FromJSON WorkflowMetadata_Parameters
         where
        parseJSON
          = Core.withObject "WorkflowMetadata_Parameters"
              (\ o ->
                 WorkflowMetadata_Parameters Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON WorkflowMetadata_Parameters
         where
...
instance Core.FromJSON WorkflowNode where
        parseJSON
          = Core.withObject "WorkflowNode"
              (\ o ->
                 WorkflowNode Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "jobId")
                     Core.<*> (o Core..:? "prerequisiteStepIds")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "stepId"))
...
newWorkflowTemplatePlacement =
  WorkflowTemplatePlacement
    {clusterSelector = Core.Nothing, managedCluster = Core.Nothing}

instance Core.FromJSON WorkflowTemplatePlacement
         where
        parseJSON
