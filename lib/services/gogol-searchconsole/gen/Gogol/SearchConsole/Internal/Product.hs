...
newAmpInspectionResult 
    ::  AmpInspectionResult
newAmpInspectionResult
  = AmpInspectionResult{ampIndexStatusVerdict = Core.Nothing,
                        ampUrl = Core.Nothing, indexingState = Core.Nothing,
                        issues = Core.Nothing, lastCrawlTime = Core.Nothing,
                        pageFetchState = Core.Nothing, robotsTxtState = Core.Nothing,
                        verdict = Core.Nothing}
instance Core.FromJSON AmpInspectionResult where
        parseJSON
          = Core.withObject "AmpInspectionResult"
              (\ o ->
                 AmpInspectionResult Core.<$>
                   (o Core..:? "ampIndexStatusVerdict") Core.<*> (o Core..:? "ampUrl")
...
instance Core.ToJSON AmpInspectionResult where
        toJSON AmpInspectionResult{..}
          = Core.object
              (Core.catMaybes
                 [("ampIndexStatusVerdict" Core..=) Core.<$> ampIndexStatusVerdict,
...
newAmpIssue 
    ::  AmpIssue
newAmpIssue
  = AmpIssue{issueMessage = Core.Nothing, severity = Core.Nothing}
instance Core.FromJSON AmpIssue where
        parseJSON
          = Core.withObject "AmpIssue"
              (\ o ->
                 AmpIssue Core.<$>
                   (o Core..:? "issueMessage") Core.<*> (o Core..:? "severity"))
...
newApiDataRow 
    ::  ApiDataRow
newApiDataRow
  = ApiDataRow{clicks = Core.Nothing, ctr = Core.Nothing,
               impressions = Core.Nothing, keys = Core.Nothing,
               position = Core.Nothing}
instance Core.FromJSON ApiDataRow where
        parseJSON
          = Core.withObject "ApiDataRow"
              (\ o ->
                 ApiDataRow Core.<$>
                   (o Core..:? "clicks") Core.<*> (o Core..:? "ctr") Core.<*>
                     (o Core..:? "impressions")
                     Core.<*> (o Core..:? "keys")
...
instance Core.ToJSON ApiDataRow where
        toJSON ApiDataRow{..}
          = Core.object
              (Core.catMaybes
                 [("clicks" Core..=) Core.<$> clicks, ("ctr" Core..=) Core.<$> ctr,
...
newApiDimensionFilter 
    ::  ApiDimensionFilter
newApiDimensionFilter
  = ApiDimensionFilter{dimension = Core.Nothing,
                       expression = Core.Nothing, operator = Core.Nothing}
instance Core.FromJSON ApiDimensionFilter where
        parseJSON
          = Core.withObject "ApiDimensionFilter"
              (\ o ->
                 ApiDimensionFilter Core.<$>
                   (o Core..:? "dimension") Core.<*> (o Core..:? "expression")
...
newApiDimensionFilterGroup 
    ::  ApiDimensionFilterGroup
newApiDimensionFilterGroup
  = ApiDimensionFilterGroup{filters = Core.Nothing,
                            groupType = Core.Nothing}
instance Core.FromJSON ApiDimensionFilterGroup where
        parseJSON
          = Core.withObject "ApiDimensionFilterGroup"
              (\ o ->
                 ApiDimensionFilterGroup Core.<$>
                   (o Core..:? "filters") Core.<*> (o Core..:? "groupType"))
...
instance Core.FromJSON BlockedResource where
        parseJSON
          = Core.withObject "BlockedResource"
...
newDetectedItems 
    ::  DetectedItems
newDetectedItems
  = DetectedItems{items = Core.Nothing,
                  richResultType = Core.Nothing}
instance Core.FromJSON DetectedItems where
        parseJSON
          = Core.withObject "DetectedItems"
              (\ o ->
                 DetectedItems Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "richResultType"))
...
instance Core.FromJSON Image where
        parseJSON
          = Core.withObject "Image"
              (\ o ->
                 Image Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "mimeType"))
...
newIndexStatusInspectionResult 
    ::  IndexStatusInspectionResult
newIndexStatusInspectionResult
  = IndexStatusInspectionResult{coverageState = Core.Nothing,
                                crawledAs = Core.Nothing, googleCanonical = Core.Nothing,
                                indexingState = Core.Nothing, lastCrawlTime = Core.Nothing,
                                pageFetchState = Core.Nothing, referringUrls = Core.Nothing,
                                robotsTxtState = Core.Nothing, sitemap = Core.Nothing,
                                userCanonical = Core.Nothing, verdict = Core.Nothing}
instance Core.FromJSON IndexStatusInspectionResult where
        parseJSON
          = Core.withObject "IndexStatusInspectionResult"
              (\ o ->
                 IndexStatusInspectionResult Core.<$>
                   (o Core..:? "coverageState") Core.<*> (o Core..:? "crawledAs")
...
newInspectUrlIndexRequest 
    ::  InspectUrlIndexRequest
newInspectUrlIndexRequest
  = InspectUrlIndexRequest{inspectionUrl = Core.Nothing,
                           languageCode = Core.Nothing, siteUrl = Core.Nothing}
instance Core.FromJSON InspectUrlIndexRequest where
        parseJSON
          = Core.withObject "InspectUrlIndexRequest"
              (\ o ->
                 InspectUrlIndexRequest Core.<$>
                   (o Core..:? "inspectionUrl") Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "siteUrl"))
...
instance Core.FromJSON InspectUrlIndexResponse where
        parseJSON
          = Core.withObject "InspectUrlIndexResponse"
              (\ o ->
                 InspectUrlIndexResponse Core.<$> (o Core..:? "inspectionResult"))

instance Core.ToJSON InspectUrlIndexResponse where
        toJSON InspectUrlIndexResponse{..}
          = Core.object
              (Core.catMaybes
                 [("inspectionResult" Core..=) Core.<$> inspectionResult])
...
instance Core.FromJSON Item where
        parseJSON
          = Core.withObject "Item"
              (\ o ->
                 Item Core.<$> (o Core..:? "issues") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON MobileFriendlyIssue where
        parseJSON
          = Core.withObject "MobileFriendlyIssue"
              (\ o -> MobileFriendlyIssue Core.<$> (o Core..:? "rule"))
...
newMobileUsabilityInspectionResult 
    :: 
                                   MobileUsabilityInspectionResult
newMobileUsabilityInspectionResult
  = MobileUsabilityInspectionResult{issues = Core.Nothing,
                                    verdict = Core.Nothing}
instance Core.FromJSON MobileUsabilityInspectionResult where
        parseJSON
          = Core.withObject "MobileUsabilityInspectionResult"
              (\ o ->
                 MobileUsabilityInspectionResult Core.<$>
                   (o Core..:? "issues") Core.<*> (o Core..:? "verdict"))
...
newMobileUsabilityIssue 
    ::  MobileUsabilityIssue
newMobileUsabilityIssue
  = MobileUsabilityIssue{issueType = Core.Nothing,
                         message = Core.Nothing, severity = Core.Nothing}
instance Core.FromJSON MobileUsabilityIssue where
        parseJSON
          = Core.withObject "MobileUsabilityIssue"
              (\ o ->
                 MobileUsabilityIssue Core.<$>
                   (o Core..:? "issueType") Core.<*> (o Core..:? "message") Core.<*>
                     (o Core..:? "severity"))
...
instance Core.FromJSON ResourceIssue where
        parseJSON
          = Core.withObject "ResourceIssue"
              (\ o -> ResourceIssue Core.<$> (o Core..:? "blockedResource"))

instance Core.ToJSON ResourceIssue where
        toJSON ResourceIssue{..}
          = Core.object
              (Core.catMaybes
                 [("blockedResource" Core..=) Core.<$> blockedResource])
...
newRichResultsInspectionResult 
    ::  RichResultsInspectionResult
newRichResultsInspectionResult
  = RichResultsInspectionResult{detectedItems = Core.Nothing,
                                verdict = Core.Nothing}
instance Core.FromJSON RichResultsInspectionResult where
        parseJSON
          = Core.withObject "RichResultsInspectionResult"
              (\ o ->
                 RichResultsInspectionResult Core.<$>
                   (o Core..:? "detectedItems") Core.<*> (o Core..:? "verdict"))
...
newRichResultsIssue 
    ::  RichResultsIssue
newRichResultsIssue
  = RichResultsIssue{issueMessage = Core.Nothing,
                     severity = Core.Nothing}
instance Core.FromJSON RichResultsIssue where
        parseJSON
          = Core.withObject "RichResultsIssue"
              (\ o ->
                 RichResultsIssue Core.<$>
                   (o Core..:? "issueMessage") Core.<*> (o Core..:? "severity"))
...
newRunMobileFriendlyTestRequest 
    ::  RunMobileFriendlyTestRequest
newRunMobileFriendlyTestRequest
  = RunMobileFriendlyTestRequest{requestScreenshot = Core.Nothing,
                                 url = Core.Nothing}
instance Core.FromJSON RunMobileFriendlyTestRequest where
        parseJSON
          = Core.withObject "RunMobileFriendlyTestRequest"
              (\ o ->
                 RunMobileFriendlyTestRequest Core.<$>
                   (o Core..:? "requestScreenshot") Core.<*> (o Core..:? "url"))

instance Core.ToJSON RunMobileFriendlyTestRequest where
        toJSON RunMobileFriendlyTestRequest{..}
          = Core.object
              (Core.catMaybes
                 [("requestScreenshot" Core..=) Core.<$> requestScreenshot,
                  ("url" Core..=) Core.<$> url])
...
newRunMobileFriendlyTestResponse 
    ::  RunMobileFriendlyTestResponse
newRunMobileFriendlyTestResponse
  = RunMobileFriendlyTestResponse{mobileFriendliness = Core.Nothing,
                                  mobileFriendlyIssues = Core.Nothing,
                                  resourceIssues = Core.Nothing, screenshot = Core.Nothing,
                                  testStatus = Core.Nothing}
instance Core.FromJSON RunMobileFriendlyTestResponse where
        parseJSON
          = Core.withObject "RunMobileFriendlyTestResponse"
              (\ o ->
                 RunMobileFriendlyTestResponse Core.<$>
                   (o Core..:? "mobileFriendliness") Core.<*>
                     (o Core..:? "mobileFriendlyIssues")
...
instance Core.ToJSON RunMobileFriendlyTestResponse where
        toJSON RunMobileFriendlyTestResponse{..}
          = Core.object
              (Core.catMaybes
                 [("mobileFriendliness" Core..=) Core.<$> mobileFriendliness,
                  ("mobileFriendlyIssues" Core..=) Core.<$> mobileFriendlyIssues,
...
newSearchAnalyticsQueryRequest 
    ::  SearchAnalyticsQueryRequest
newSearchAnalyticsQueryRequest
  = SearchAnalyticsQueryRequest{aggregationType = Core.Nothing,
                                dataState = Core.Nothing, dimensionFilterGroups = Core.Nothing,
                                dimensions = Core.Nothing, endDate = Core.Nothing,
                                rowLimit = Core.Nothing, searchType = Core.Nothing,
                                startDate = Core.Nothing, startRow = Core.Nothing,
                                type' = Core.Nothing}
instance Core.FromJSON SearchAnalyticsQueryRequest where
        parseJSON
          = Core.withObject "SearchAnalyticsQueryRequest"
              (\ o ->
                 SearchAnalyticsQueryRequest Core.<$>
                   (o Core..:? "aggregationType") Core.<*> (o Core..:? "dataState")
...
newSearchAnalyticsQueryResponse 
    ::  SearchAnalyticsQueryResponse
newSearchAnalyticsQueryResponse
  = SearchAnalyticsQueryResponse{responseAggregationType =
                                   Core.Nothing,
                                 rows = Core.Nothing}
instance Core.FromJSON SearchAnalyticsQueryResponse where
        parseJSON
          = Core.withObject "SearchAnalyticsQueryResponse"
              (\ o ->
                 SearchAnalyticsQueryResponse Core.<$>
                   (o Core..:? "responseAggregationType") Core.<*>
                     (o Core..:? "rows"))
...
instance Core.ToJSON SearchAnalyticsQueryResponse where
        toJSON SearchAnalyticsQueryResponse{..}
          = Core.object
              (Core.catMaybes
                 [("responseAggregationType" Core..=) Core.<$>
...
instance Core.FromJSON SitemapsListResponse where
        parseJSON
          = Core.withObject "SitemapsListResponse"
...
newTestStatus 
    ::  TestStatus
newTestStatus
  = TestStatus{details = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON TestStatus where
        parseJSON
          = Core.withObject "TestStatus"
              (\ o ->
                 TestStatus Core.<$>
                   (o Core..:? "details") Core.<*> (o Core..:? "status"))
...
newUrlInspectionResult 
    ::  UrlInspectionResult
newUrlInspectionResult
  = UrlInspectionResult{ampResult = Core.Nothing,
...
instance Core.FromJSON UrlInspectionResult where
        parseJSON
          = Core.withObject "UrlInspectionResult"
              (\ o ->
                 UrlInspectionResult Core.<$>
                   (o Core..:? "ampResult") Core.<*> (o Core..:? "indexStatusResult")
          ...
          = Core.object
              (Core.catMaybes
                 [("ampResult" Core..=) Core.<$> ampResult,
                  ("indexStatusResult" Core..=) Core.<$> indexStatusResult,
                  ("inspectionResultLink" Core..=) Core.<$> inspectionResultLink,
                  ("mobileUsabilityResult" Core..=) Core.<$> mobileUsabilityResult,
                  ("richResultsResult" Core..=) Core.<$> richResultsResult])
...
instance Core.FromJSON WmxSite where
        parseJSON
          = Core.withObject "WmxSite"
              (\ o ->
                 WmxSite Core.<$>
                   (o Core..:? "permissionLevel") Core.<*> (o Core..:? "siteUrl"))
...
newWmxSitemap 
    ::  WmxSitemap
newWmxSitemap
  = WmxSitemap{contents = Core.Nothing, errors = Core.Nothing,
               isPending = Core.Nothing, isSitemapsIndex = Core.Nothing,
               lastDownloaded = Core.Nothing, lastSubmitted = Core.Nothing,
               path = Core.Nothing, type' = Core.Nothing, warnings = Core.Nothing}
instance Core.FromJSON WmxSitemap where
        parseJSON
          = Core.withObject "WmxSitemap"
              (\ o ->
                 WmxSitemap Core.<$>
                   (o Core..:? "contents") Core.<*>
                     (o Core..:? "errors" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "type")
                     Core.<*>
                     (o Core..:? "warnings" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("contents" Core..=) Core.<$> contents,
                  ...
                  ("path" Core..=) Core.<$> path, ("type" Core..=) Core.<$> type',
...
newWmxSitemapContent 
    ::  WmxSitemapContent
newWmxSitemapContent
  = WmxSitemapContent{indexed = Core.Nothing,
                      submitted = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON WmxSitemapContent where
        parseJSON
          = Core.withObject "WmxSitemapContent"
              (\ o ->
                 WmxSitemapContent Core.<$>
                   (o Core..:? "indexed" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "submitted" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "type"))
