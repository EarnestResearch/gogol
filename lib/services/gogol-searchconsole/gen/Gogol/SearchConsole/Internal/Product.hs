          ...
          = Core.withObject "AmpInspectionResult"
              (\ o ->
                 AmpInspectionResult Core.<$>
                   (o Core..:? "ampIndexStatusVerdict") Core.<*>
                     (o Core..:? "ampUrl")
...
instance Core.ToJSON AmpInspectionResult where
        toJSON AmpInspectionResult{..}
          = Core.object
              (Core.catMaybes
                 [("ampIndexStatusVerdict" Core..=) Core.<$>
...
instance Core.FromJSON IndexStatusInspectionResult
         where
        parseJSON
          = Core.withObject "IndexStatusInspectionResult"
              (\ o ->
                 IndexStatusInspectionResult Core.<$>
                   (o Core..:? "coverageState") Core.<*>
                     (o Core..:? "crawledAs")
...
instance Core.ToJSON IndexStatusInspectionResult
         where
...
instance Core.FromJSON Item where
        parseJSON
          = Core.withObject "Item"
              (\ o ->
                 Item Core.<$>
                   (o Core..:? "issues") Core.<*> (o Core..:? "name"))
...
newMobileUsabilityInspectionResult =
  MobileUsabilityInspectionResult
    {issues = Core.Nothing, verdict = Core.Nothing}
...
instance Core.ToJSON MobileUsabilityInspectionResult
         where
...
newMobileUsabilityIssue =
  MobileUsabilityIssue
    {issueType = Core.Nothing, message = Core.Nothing, severity = Core.Nothing}
...
newRichResultsInspectionResult =
  RichResultsInspectionResult
    {detectedItems = Core.Nothing, verdict = Core.Nothing}

instance Core.FromJSON RichResultsInspectionResult
         where
        parseJSON
          = Core.withObject "RichResultsInspectionResult"
              (\ o ->
                 RichResultsInspectionResult Core.<$>
                   (o Core..:? "detectedItems") Core.<*>
                     (o Core..:? "verdict"))

instance Core.ToJSON RichResultsInspectionResult
         where
...
newRunMobileFriendlyTestRequest =
  RunMobileFriendlyTestRequest
    {requestScreenshot = Core.Nothing, url = Core.Nothing}

instance Core.FromJSON RunMobileFriendlyTestRequest
         where
        parseJSON
          = Core.withObject "RunMobileFriendlyTestRequest"
              (\ o ->
                 RunMobileFriendlyTestRequest Core.<$>
                   (o Core..:? "requestScreenshot") Core.<*>
                     (o Core..:? "url"))

instance Core.ToJSON RunMobileFriendlyTestRequest
         where
        toJSON RunMobileFriendlyTestRequest{..}
          = Core.object
              (Core.catMaybes
                 [("requestScreenshot" Core..=) Core.<$>
                    requestScreenshot,
                  ("url" Core..=) Core.<$> url])
...
instance Core.FromJSON RunMobileFriendlyTestResponse
         where
        parseJSON
...
instance Core.ToJSON RunMobileFriendlyTestResponse
         where
        toJSON RunMobileFriendlyTestResponse{..}
          = Core.object
              (Core.catMaybes
                 [("mobileFriendliness" Core..=) Core.<$>
                    mobileFriendliness,
                  ("mobileFriendlyIssues" Core..=) Core.<$>
...
instance Core.FromJSON SearchAnalyticsQueryRequest
         where
        parseJSON
          = Core.withObject "SearchAnalyticsQueryRequest"
              (\ o ->
                 SearchAnalyticsQueryRequest Core.<$>
                   (o Core..:? "aggregationType") Core.<*>
                     (o Core..:? "dataState")
...
instance Core.ToJSON SearchAnalyticsQueryRequest
         where
        toJSON SearchAnalyticsQueryRequest{..}
          = Core.object
              (Core.catMaybes
                 [("aggregationType" Core..=) Core.<$>
                    aggregationType,
                  ("dataState" Core..=) Core.<$> dataState,
                  ("dimensionFilterGroups" Core..=) Core.<$>
...
newSearchAnalyticsQueryResponse =
  SearchAnalyticsQueryResponse
    {responseAggregationType = Core.Nothing, rows = Core.Nothing}

instance Core.FromJSON SearchAnalyticsQueryResponse
         where
        parseJSON
...
instance Core.ToJSON SearchAnalyticsQueryResponse
         where
          ...
          = Core.withObject "UrlInspectionResult"
              (\ o ->
                 UrlInspectionResult Core.<$>
                   (o Core..:? "ampResult") Core.<*>
                     (o Core..:? "indexStatusResult")
          ...
          = Core.object
              (Core.catMaybes
                 [("ampResult" Core..=) Core.<$> ampResult,
                  ("indexStatusResult" Core..=) Core.<$>
                    indexStatusResult,
                  ("inspectionResultLink" Core..=) Core.<$>
                    inspectionResultLink,
                  ("mobileUsabilityResult" Core..=) Core.<$>
                    mobileUsabilityResult,
                  ("richResultsResult" Core..=) Core.<$>
                    richResultsResult])
          ...
          = Core.object
              (Core.catMaybes
                 [("contents" Core..=) Core.<$> contents,
                  ("errors" Core..=) Core.. Core.AsText Core.<$>
                    errors,
                  ...
                  ("path" Core..=) Core.<$> path,
                  ("type" Core..=) Core.<$> type',
                  ("warnings" Core..=) Core.. Core.AsText Core.<$>
                    warnings])
...
newWmxSitemapContent =
  WmxSitemapContent
    {indexed = Core.Nothing, submitted = Core.Nothing, type' = Core.Nothing}
...
instance Core.ToJSON WmxSitemapContent where
        toJSON WmxSitemapContent{..}
          = Core.object
              (Core.catMaybes
                 [("indexed" Core..=) Core.. Core.AsText Core.<$>
                    indexed,
                  ("submitted" Core..=) Core.. Core.AsText Core.<$>
                    submitted,
                  ("type" Core..=) Core.<$> type'])
