               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "sitemapIndex" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] SitemapsListResponse
...
instance Core.GoogleRequest WebmastersSitemapsList
         where
        type Rs WebmastersSitemapsList = SitemapsListResponse
        type Scopes WebmastersSitemapsList =
             '[Webmasters'FullControl, Webmasters'Readonly]
        requestClient WebmastersSitemapsList{..}
          = go siteUrl xgafv accessToken callback sitemapIndex
              uploadType
              uploadProtocol
