...
type SearchCseSiterestrictListResource =
     "customsearch" Core.:>
       "v1" Core.:>
         "siterestrict" Core.:>
                             ...
                             Core.QueryParam "fileType" Core.Text Core.:>
                               Core.QueryParam "filter" Core.Text Core.:>
                                 Core.QueryParam "gl" Core.Text Core.:>
                                   Core.QueryParam "googlehost" Core.Text
                                     Core.:>
                                     Core.QueryParam "highRange" Core.Text
                                       Core.:>
...
-- | Returns metadata about the search performed, metadata about the engine used for the search, and the search results. Uses a small set of url patterns.
--
-- /See:/ 'newSearchCseSiterestrictList' smart constructor.
data SearchCseSiterestrictList = SearchCseSiterestrictList
    {
      -- | V1 error format.
    ...
    , imgColorType :: (Core.Maybe CseSiterestrictListImgColorType)
    ...
    , safe :: (Core.Maybe CseSiterestrictListSafe)
    ...
    , searchType :: (Core.Maybe CseSiterestrictListSearchType)
    ...
    , siteSearchFilter :: (Core.Maybe CseSiterestrictListSiteSearchFilter)
...
-- | Creates a value of 'SearchCseSiterestrictList' with the minimum fields required to make a request.
newSearchCseSiterestrictList 
    ::  SearchCseSiterestrictList
newSearchCseSiterestrictList =
  SearchCseSiterestrictList
...
instance Core.GoogleRequest SearchCseSiterestrictList
         where
        type Rs SearchCseSiterestrictList = Search
        type Scopes SearchCseSiterestrictList = '[]
        requestClient SearchCseSiterestrictList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SearchCseSiterestrictListResource)
                      Core.mempty
