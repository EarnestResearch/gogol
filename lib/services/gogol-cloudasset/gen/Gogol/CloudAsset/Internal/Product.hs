...
instance Core.FromJSON AnalyzeIamPolicyLongrunningMetadata where
        parseJSON
          = Core.withObject "AnalyzeIamPolicyLongrunningMetadata"
              (\ o ->
                 AnalyzeIamPolicyLongrunningMetadata Core.<$>
                   (o Core..:? "createTime"))

instance Core.ToJSON AnalyzeIamPolicyLongrunningMetadata where
        toJSON AnalyzeIamPolicyLongrunningMetadata{..}
          = Core.object
              (Core.catMaybes [("createTime" Core..=) Core.<$> createTime])
...
newAnalyzeIamPolicyLongrunningResponse
  = AnalyzeIamPolicyLongrunningResponse
instance Core.FromJSON AnalyzeIamPolicyLongrunningResponse where
        parseJSON
          = Core.withObject "AnalyzeIamPolicyLongrunningResponse"
              (\ o -> Core.pure AnalyzeIamPolicyLongrunningResponse)

instance Core.ToJSON AnalyzeIamPolicyLongrunningResponse where
...
newGoogleCloudAssetV1p7beta1Asset 
    ::  GoogleCloudAssetV1p7beta1Asset
newGoogleCloudAssetV1p7beta1Asset
  = GoogleCloudAssetV1p7beta1Asset{accessLevel = Core.Nothing,
                                   accessPolicy = Core.Nothing, ancestors = Core.Nothing,
                                   assetType = Core.Nothing, iamPolicy = Core.Nothing,
                                   name = Core.Nothing, orgPolicy = Core.Nothing,
                                   relatedAssets = Core.Nothing, resource = Core.Nothing,
                                   servicePerimeter = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON GoogleCloudAssetV1p7beta1Asset where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1Asset"
              (\ o ->
                 GoogleCloudAssetV1p7beta1Asset Core.<$>
                   (o Core..:? "accessLevel") Core.<*> (o Core..:? "accessPolicy")
          ...
          = Core.object
              (Core.catMaybes
                 [("accessLevel" Core..=) Core.<$> accessLevel,
                  ...
                  ("servicePerimeter" Core..=) Core.<$> servicePerimeter,
...
newGoogleCloudAssetV1p7beta1BigQueryDestination 
    :: 
                                                GoogleCloudAssetV1p7beta1BigQueryDestination
newGoogleCloudAssetV1p7beta1BigQueryDestination
  = GoogleCloudAssetV1p7beta1BigQueryDestination{dataset =
                                                   Core.Nothing,
                                                 force = Core.Nothing, partitionSpec = Core.Nothing,
                                                 separateTablesPerAssetType = Core.Nothing,
                                                 table = Core.Nothing}
instance Core.FromJSON GoogleCloudAssetV1p7beta1BigQueryDestination
         where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1BigQueryDestination"
              (\ o ->
                 GoogleCloudAssetV1p7beta1BigQueryDestination Core.<$>
                   (o Core..:? "dataset") Core.<*> (o Core..:? "force") Core.<*>
                     (o Core..:? "partitionSpec")
                     Core.<*> (o Core..:? "separateTablesPerAssetType")
                     Core.<*> (o Core..:? "table"))

instance Core.ToJSON GoogleCloudAssetV1p7beta1BigQueryDestination
         where
        toJSON GoogleCloudAssetV1p7beta1BigQueryDestination{..}
          = Core.object
              (Core.catMaybes
                 [("dataset" Core..=) Core.<$> dataset,
                  ("force" Core..=) Core.<$> force,
                  ("partitionSpec" Core..=) Core.<$> partitionSpec,
                  ("separateTablesPerAssetType" Core..=) Core.<$>
...
newGoogleCloudAssetV1p7beta1ExportAssetsRequest 
    :: 
                                                GoogleCloudAssetV1p7beta1ExportAssetsRequest
newGoogleCloudAssetV1p7beta1ExportAssetsRequest
  = GoogleCloudAssetV1p7beta1ExportAssetsRequest{assetTypes =
                                                   Core.Nothing,
                                                 contentType = Core.Nothing,
                                                 outputConfig = Core.Nothing,
                                                 readTime = Core.Nothing,
                                                 relationshipTypes = Core.Nothing}
instance Core.FromJSON GoogleCloudAssetV1p7beta1ExportAssetsRequest
         where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1ExportAssetsRequest"
              (\ o ->
                 GoogleCloudAssetV1p7beta1ExportAssetsRequest Core.<$>
                   (o Core..:? "assetTypes") Core.<*> (o Core..:? "contentType")
                     Core.<*> (o Core..:? "outputConfig")
                     Core.<*> (o Core..:? "readTime")
                     Core.<*> (o Core..:? "relationshipTypes"))

instance Core.ToJSON GoogleCloudAssetV1p7beta1ExportAssetsRequest
         where
        toJSON GoogleCloudAssetV1p7beta1ExportAssetsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("assetTypes" Core..=) Core.<$> assetTypes,
                  ...
                  ("relationshipTypes" Core..=) Core.<$> relationshipTypes])
...
newGoogleCloudAssetV1p7beta1GcsDestination 
    :: 
                                           GoogleCloudAssetV1p7beta1GcsDestination
newGoogleCloudAssetV1p7beta1GcsDestination
  = GoogleCloudAssetV1p7beta1GcsDestination{uri = Core.Nothing,
                                            uriPrefix = Core.Nothing}
instance Core.FromJSON GoogleCloudAssetV1p7beta1GcsDestination
         where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1GcsDestination"
              (\ o ->
                 GoogleCloudAssetV1p7beta1GcsDestination Core.<$>
                   (o Core..:? "uri") Core.<*> (o Core..:? "uriPrefix"))

instance Core.ToJSON GoogleCloudAssetV1p7beta1GcsDestination where
...
newGoogleCloudAssetV1p7beta1OutputConfig 
    :: 
                                         GoogleCloudAssetV1p7beta1OutputConfig
newGoogleCloudAssetV1p7beta1OutputConfig
  = GoogleCloudAssetV1p7beta1OutputConfig{bigqueryDestination =
                                            Core.Nothing,
                                          gcsDestination = Core.Nothing}
instance Core.FromJSON GoogleCloudAssetV1p7beta1OutputConfig where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1OutputConfig"
              (\ o ->
                 GoogleCloudAssetV1p7beta1OutputConfig Core.<$>
                   (o Core..:? "bigqueryDestination") Core.<*>
                     (o Core..:? "gcsDestination"))

instance Core.ToJSON GoogleCloudAssetV1p7beta1OutputConfig where
...
newGoogleCloudAssetV1p7beta1PartitionSpec 
    :: 
                                          GoogleCloudAssetV1p7beta1PartitionSpec
newGoogleCloudAssetV1p7beta1PartitionSpec
  = GoogleCloudAssetV1p7beta1PartitionSpec{partitionKey =
                                             Core.Nothing}
instance Core.FromJSON GoogleCloudAssetV1p7beta1PartitionSpec where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1PartitionSpec"
              (\ o ->
                 GoogleCloudAssetV1p7beta1PartitionSpec Core.<$>
                   (o Core..:? "partitionKey"))

instance Core.ToJSON GoogleCloudAssetV1p7beta1PartitionSpec where
        toJSON GoogleCloudAssetV1p7beta1PartitionSpec{..}
          = Core.object
              (Core.catMaybes [("partitionKey" Core..=) Core.<$> partitionKey])
...
newGoogleCloudAssetV1p7beta1RelatedAsset 
    :: 
                                         GoogleCloudAssetV1p7beta1RelatedAsset
newGoogleCloudAssetV1p7beta1RelatedAsset
  = GoogleCloudAssetV1p7beta1RelatedAsset{ancestors = Core.Nothing,
                                          asset = Core.Nothing, assetType = Core.Nothing}
instance Core.FromJSON GoogleCloudAssetV1p7beta1RelatedAsset where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1RelatedAsset"
              (\ o ->
                 GoogleCloudAssetV1p7beta1RelatedAsset Core.<$>
                   (o Core..:? "ancestors") Core.<*> (o Core..:? "asset") Core.<*>
                     (o Core..:? "assetType"))

instance Core.ToJSON GoogleCloudAssetV1p7beta1RelatedAsset where
...
newGoogleCloudAssetV1p7beta1RelatedAssets 
    :: 
                                          GoogleCloudAssetV1p7beta1RelatedAssets
newGoogleCloudAssetV1p7beta1RelatedAssets
  = GoogleCloudAssetV1p7beta1RelatedAssets{assets = Core.Nothing,
                                           relationshipAttributes = Core.Nothing}
instance Core.FromJSON GoogleCloudAssetV1p7beta1RelatedAssets where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1RelatedAssets"
              (\ o ->
                 GoogleCloudAssetV1p7beta1RelatedAssets Core.<$>
                   (o Core..:? "assets") Core.<*>
                     (o Core..:? "relationshipAttributes"))

instance Core.ToJSON GoogleCloudAssetV1p7beta1RelatedAssets where
        toJSON GoogleCloudAssetV1p7beta1RelatedAssets{..}
          = Core.object
              (Core.catMaybes
                 [("assets" Core..=) Core.<$> assets,
                  ("relationshipAttributes" Core..=) Core.<$>
...
newGoogleCloudAssetV1p7beta1RelationshipAttributes 
    :: 
                                                   GoogleCloudAssetV1p7beta1RelationshipAttributes
newGoogleCloudAssetV1p7beta1RelationshipAttributes
  = GoogleCloudAssetV1p7beta1RelationshipAttributes{action =
                                                      Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1RelationshipAttributes"
              (\ o ->
                 GoogleCloudAssetV1p7beta1RelationshipAttributes Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "sourceResourceType")
...
instance Core.ToJSON
           GoogleCloudAssetV1p7beta1RelationshipAttributes
         where
        toJSON GoogleCloudAssetV1p7beta1RelationshipAttributes{..}
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("sourceResourceType" Core..=) Core.<$> sourceResourceType,
                  ("targetResourceType" Core..=) Core.<$> targetResourceType,
                  ("type" Core..=) Core.<$> type'])
...
newGoogleCloudAssetV1p7beta1Resource 
    :: 
                                     GoogleCloudAssetV1p7beta1Resource
newGoogleCloudAssetV1p7beta1Resource
  = GoogleCloudAssetV1p7beta1Resource{data' = Core.Nothing,
                                      discoveryDocumentUri = Core.Nothing,
                                      discoveryName = Core.Nothing, location = Core.Nothing,
                                      parent = Core.Nothing, resourceUrl = Core.Nothing,
                                      version = Core.Nothing}
instance Core.FromJSON GoogleCloudAssetV1p7beta1Resource where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1Resource"
              (\ o ->
                 GoogleCloudAssetV1p7beta1Resource Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "discoveryDocumentUri")
...
instance Core.ToJSON GoogleCloudAssetV1p7beta1Resource where
        toJSON GoogleCloudAssetV1p7beta1Resource{..}
          = Core.object
              (Core.catMaybes
                 [("data" Core..=) Core.<$> data',
                  ("discoveryDocumentUri" Core..=) Core.<$> discoveryDocumentUri,
...
newGoogleCloudAssetV1p7beta1Resource_Data 
    ...
    -> GoogleCloudAssetV1p7beta1Resource_Data
newGoogleCloudAssetV1p7beta1Resource_Data additional
  = GoogleCloudAssetV1p7beta1Resource_Data{additional = additional}
instance Core.FromJSON GoogleCloudAssetV1p7beta1Resource_Data where
        parseJSON
          = Core.withObject "GoogleCloudAssetV1p7beta1Resource_Data"
              (\ o ->
                 GoogleCloudAssetV1p7beta1Resource_Data Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GoogleCloudAssetV1p7beta1Resource_Data where
...
instance Core.FromJSON GoogleCloudOrgpolicyV1BooleanPolicy where
        parseJSON
          = Core.withObject "GoogleCloudOrgpolicyV1BooleanPolicy"
              (\ o ->
                 GoogleCloudOrgpolicyV1BooleanPolicy Core.<$>
                   (o Core..:? "enforced"))

instance Core.ToJSON GoogleCloudOrgpolicyV1BooleanPolicy where
        toJSON GoogleCloudOrgpolicyV1BooleanPolicy{..}
          = Core.object
              (Core.catMaybes [("enforced" Core..=) Core.<$> enforced])
...
newGoogleCloudOrgpolicyV1ListPolicy 
    :: 
                                    GoogleCloudOrgpolicyV1ListPolicy
newGoogleCloudOrgpolicyV1ListPolicy
  = GoogleCloudOrgpolicyV1ListPolicy{allValues = Core.Nothing,
                                     allowedValues = Core.Nothing, deniedValues = Core.Nothing,
                                     inheritFromParent = Core.Nothing,
                                     suggestedValue = Core.Nothing}
instance Core.FromJSON GoogleCloudOrgpolicyV1ListPolicy where
        parseJSON
          = Core.withObject "GoogleCloudOrgpolicyV1ListPolicy"
              (\ o ->
                 GoogleCloudOrgpolicyV1ListPolicy Core.<$>
                   (o Core..:? "allValues") Core.<*> (o Core..:? "allowedValues")
...
newGoogleCloudOrgpolicyV1Policy 
    ::  GoogleCloudOrgpolicyV1Policy
newGoogleCloudOrgpolicyV1Policy
  = GoogleCloudOrgpolicyV1Policy{booleanPolicy = Core.Nothing,
                                 constraint = Core.Nothing, etag = Core.Nothing,
                                 listPolicy = Core.Nothing, restoreDefault = Core.Nothing,
                                 updateTime = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON GoogleCloudOrgpolicyV1Policy where
        parseJSON
          = Core.withObject "GoogleCloudOrgpolicyV1Policy"
              (\ o ->
                 GoogleCloudOrgpolicyV1Policy Core.<$>
                   (o Core..:? "booleanPolicy") Core.<*> (o Core..:? "constraint")
                     Core.<*> (o Core..:? "etag")
...
newGoogleCloudOrgpolicyV1RestoreDefault
  = GoogleCloudOrgpolicyV1RestoreDefault
instance Core.FromJSON GoogleCloudOrgpolicyV1RestoreDefault where
        parseJSON
          = Core.withObject "GoogleCloudOrgpolicyV1RestoreDefault"
              (\ o -> Core.pure GoogleCloudOrgpolicyV1RestoreDefault)

instance Core.ToJSON GoogleCloudOrgpolicyV1RestoreDefault where
        toJSON = Core.const Core.emptyObject
...
newGoogleIdentityAccesscontextmanagerV1AccessLevel 
    :: 
                                                   GoogleIdentityAccesscontextmanagerV1AccessLevel
newGoogleIdentityAccesscontextmanagerV1AccessLevel
  = GoogleIdentityAccesscontextmanagerV1AccessLevel{basic =
                                                      Core.Nothing,
                                                    custom = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleIdentityAccesscontextmanagerV1AccessLevel"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1AccessLevel Core.<$>
                   (o Core..:? "basic") Core.<*> (o Core..:? "custom") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "title"))
...
instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1AccessLevel
         where
        toJSON GoogleIdentityAccesscontextmanagerV1AccessLevel{..}
          = Core.object
              (Core.catMaybes
                 [("basic" Core..=) Core.<$> basic,
                  ("custom" Core..=) Core.<$> custom,
                  ("description" Core..=) Core.<$> description,
                  ("name" Core..=) Core.<$> name, ("title" Core..=) Core.<$> title])
...
newGoogleIdentityAccesscontextmanagerV1AccessPolicy 
    :: 
                                                    GoogleIdentityAccesscontextmanagerV1AccessPolicy
newGoogleIdentityAccesscontextmanagerV1AccessPolicy
  = GoogleIdentityAccesscontextmanagerV1AccessPolicy{etag =
                                                       Core.Nothing,
                                                     name = Core.Nothing, parent = Core.Nothing,
                                                     scopes = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON
           GoogleIdentityAccesscontextmanagerV1AccessPolicy
         where
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1AccessPolicy"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1AccessPolicy Core.<$>
...
instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1AccessPolicy
         where
        toJSON GoogleIdentityAccesscontextmanagerV1AccessPolicy{..}
          = Core.object
              (Core.catMaybes
...
newGoogleIdentityAccesscontextmanagerV1ApiOperation 
    :: 
                                                    GoogleIdentityAccesscontextmanagerV1ApiOperation
newGoogleIdentityAccesscontextmanagerV1ApiOperation
  = GoogleIdentityAccesscontextmanagerV1ApiOperation{methodSelectors
                                                       = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1ApiOperation"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1ApiOperation Core.<$>
                   (o Core..:? "methodSelectors") Core.<*> (o Core..:? "serviceName"))

instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1ApiOperation
         where
        toJSON GoogleIdentityAccesscontextmanagerV1ApiOperation{..}
          = Core.object
              (Core.catMaybes
...
newGoogleIdentityAccesscontextmanagerV1BasicLevel 
    :: 
                                                  GoogleIdentityAccesscontextmanagerV1BasicLevel
newGoogleIdentityAccesscontextmanagerV1BasicLevel
  = GoogleIdentityAccesscontextmanagerV1BasicLevel{combiningFunction
                                                     = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleIdentityAccesscontextmanagerV1BasicLevel"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1BasicLevel Core.<$>
                   (o Core..:? "combiningFunction") Core.<*>
                     (o Core..:? "conditions"))

instance Core.ToJSON GoogleIdentityAccesscontextmanagerV1BasicLevel
         where
        toJSON GoogleIdentityAccesscontextmanagerV1BasicLevel{..}
          = Core.object
              (Core.catMaybes
...
data GoogleIdentityAccesscontextmanagerV1Condition = GoogleIdentityAccesscontextmanagerV1Condition
    ...
    , vpcNetworkSources :: (Core.Maybe [GoogleIdentityAccesscontextmanagerV1VpcNetworkSource])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleIdentityAccesscontextmanagerV1Condition 
    :: 
                                                 GoogleIdentityAccesscontextmanagerV1Condition
newGoogleIdentityAccesscontextmanagerV1Condition
  = GoogleIdentityAccesscontextmanagerV1Condition{devicePolicy =
                                                    Core.Nothing,
                                                  ipSubnetworks = Core.Nothing,
                                                  members = Core.Nothing, negate = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleIdentityAccesscontextmanagerV1Condition"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1Condition Core.<$>
                   (o Core..:? "devicePolicy") Core.<*> (o Core..:? "ipSubnetworks")
                     Core.<*> (o Core..:? "members")
                     Core.<*> (o Core..:? "negate")
                     Core.<*> (o Core..:? "regions")
...
instance Core.ToJSON GoogleIdentityAccesscontextmanagerV1Condition
         where
        toJSON GoogleIdentityAccesscontextmanagerV1Condition{..}
          = Core.object
              (Core.catMaybes
...
newGoogleIdentityAccesscontextmanagerV1CustomLevel 
    :: 
                                                   GoogleIdentityAccesscontextmanagerV1CustomLevel
newGoogleIdentityAccesscontextmanagerV1CustomLevel
  = GoogleIdentityAccesscontextmanagerV1CustomLevel{expr =
                                                      Core.Nothing}
instance Core.FromJSON
           GoogleIdentityAccesscontextmanagerV1CustomLevel
         where
        parseJSON
          = Core.withObject "GoogleIdentityAccesscontextmanagerV1CustomLevel"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1CustomLevel Core.<$>
                   (o Core..:? "expr"))

instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1CustomLevel
         where
        toJSON GoogleIdentityAccesscontextmanagerV1CustomLevel{..}
...
newGoogleIdentityAccesscontextmanagerV1DevicePolicy 
    :: 
                                                    GoogleIdentityAccesscontextmanagerV1DevicePolicy
newGoogleIdentityAccesscontextmanagerV1DevicePolicy
  = GoogleIdentityAccesscontextmanagerV1DevicePolicy{allowedDeviceManagementLevels
                                                       = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1DevicePolicy"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1DevicePolicy Core.<$>
                   (o Core..:? "allowedDeviceManagementLevels") Core.<*>
                     (o Core..:? "allowedEncryptionStatuses")
...
instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1DevicePolicy
         where
        toJSON GoogleIdentityAccesscontextmanagerV1DevicePolicy{..}
          = Core.object
              (Core.catMaybes
                 [("allowedDeviceManagementLevels" Core..=) Core.<$>
                    allowedDeviceManagementLevels,
                  ("allowedEncryptionStatuses" Core..=) Core.<$>
...
data GoogleIdentityAccesscontextmanagerV1EgressFrom = GoogleIdentityAccesscontextmanagerV1EgressFrom
   ...
   GoogleIdentityAccesscontextmanagerV1EgressFrom_SourceRestriction)
    ...
    , sources :: (Core.Maybe [GoogleIdentityAccesscontextmanagerV1EgressSource])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleIdentityAccesscontextmanagerV1EgressFrom 
    :: 
                                                  GoogleIdentityAccesscontextmanagerV1EgressFrom
newGoogleIdentityAccesscontextmanagerV1EgressFrom
  = GoogleIdentityAccesscontextmanagerV1EgressFrom{identities =
                                                     Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleIdentityAccesscontextmanagerV1EgressFrom"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1EgressFrom Core.<$>
                   (o Core..:? "identities") Core.<*> (o Core..:? "identityType")
                     Core.<*> (o Core..:? "sourceRestriction")
                     Core.<*> (o Core..:? "sources"))

instance Core.ToJSON GoogleIdentityAccesscontextmanagerV1EgressFrom
         where
        toJSON GoogleIdentityAccesscontextmanagerV1EgressFrom{..}
          = Core.object
              (Core.catMaybes
...
newGoogleIdentityAccesscontextmanagerV1EgressPolicy 
    :: 
                                                    GoogleIdentityAccesscontextmanagerV1EgressPolicy
newGoogleIdentityAccesscontextmanagerV1EgressPolicy
  = GoogleIdentityAccesscontextmanagerV1EgressPolicy{egressFrom =
                                                       Core.Nothing,
                                                     egressTo = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON
           GoogleIdentityAccesscontextmanagerV1EgressPolicy
         where
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1EgressPolicy"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1EgressPolicy Core.<$>
                   (o Core..:? "egressFrom") Core.<*> (o Core..:? "egressTo") Core.<*>
                     (o Core..:? "title"))

instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1EgressPolicy
         where
        toJSON GoogleIdentityAccesscontextmanagerV1EgressPolicy{..}
          = Core.object
              (Core.catMaybes
...
-- | Creates a value of 'GoogleIdentityAccesscontextmanagerV1EgressSource' with the minimum fields required to make a request.
newGoogleIdentityAccesscontextmanagerV1EgressSource 
    :: 
                                                    GoogleIdentityAccesscontextmanagerV1EgressSource
newGoogleIdentityAccesscontextmanagerV1EgressSource
  = GoogleIdentityAccesscontextmanagerV1EgressSource{accessLevel =
                                                       Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1EgressSource"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1EgressSource Core.<$>
                   (o Core..:? "accessLevel") Core.<*> (o Core..:? "resource"))
...
newGoogleIdentityAccesscontextmanagerV1EgressTo 
    :: 
                                                GoogleIdentityAccesscontextmanagerV1EgressTo
newGoogleIdentityAccesscontextmanagerV1EgressTo
  = GoogleIdentityAccesscontextmanagerV1EgressTo{externalResources =
                                                   Core.Nothing,
                                                 operations = Core.Nothing,
                                                 resources = Core.Nothing, roles = Core.Nothing}
instance Core.FromJSON GoogleIdentityAccesscontextmanagerV1EgressTo
         where
        parseJSON
          = Core.withObject "GoogleIdentityAccesscontextmanagerV1EgressTo"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1EgressTo Core.<$>
                   (o Core..:? "externalResources") Core.<*> (o Core..:? "operations")
                     Core.<*> (o Core..:? "resources")
                     Core.<*> (o Core..:? "roles"))

instance Core.ToJSON GoogleIdentityAccesscontextmanagerV1EgressTo
         where
        toJSON GoogleIdentityAccesscontextmanagerV1EgressTo{..}
          = Core.object
              (Core.catMaybes
...
newGoogleIdentityAccesscontextmanagerV1IngressFrom 
    :: 
                                                   GoogleIdentityAccesscontextmanagerV1IngressFrom
newGoogleIdentityAccesscontextmanagerV1IngressFrom
  = GoogleIdentityAccesscontextmanagerV1IngressFrom{identities =
                                                      Core.Nothing,
                                                    identityType = Core.Nothing,
                                                    sources = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleIdentityAccesscontextmanagerV1IngressFrom"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1IngressFrom Core.<$>
                   (o Core..:? "identities") Core.<*> (o Core..:? "identityType")
                     Core.<*> (o Core..:? "sources"))
...
instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1IngressFrom
         where
        toJSON GoogleIdentityAccesscontextmanagerV1IngressFrom{..}
          = Core.object
              (Core.catMaybes
                 [("identities" Core..=) Core.<$> identities,
                  ("identityType" Core..=) Core.<$> identityType,
...
newGoogleIdentityAccesscontextmanagerV1IngressPolicy 
    :: 
                                                     GoogleIdentityAccesscontextmanagerV1IngressPolicy
newGoogleIdentityAccesscontextmanagerV1IngressPolicy
  = GoogleIdentityAccesscontextmanagerV1IngressPolicy{ingressFrom =
                                                        Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1IngressPolicy"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1IngressPolicy Core.<$>
                   (o Core..:? "ingressFrom") Core.<*> (o Core..:? "ingressTo")
                     Core.<*> (o Core..:? "title"))

instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1IngressPolicy
         where
        toJSON GoogleIdentityAccesscontextmanagerV1IngressPolicy{..}
          = Core.object
              (Core.catMaybes
...
newGoogleIdentityAccesscontextmanagerV1IngressSource 
    :: 
                                                     GoogleIdentityAccesscontextmanagerV1IngressSource
newGoogleIdentityAccesscontextmanagerV1IngressSource
  = GoogleIdentityAccesscontextmanagerV1IngressSource{accessLevel =
                                                        Core.Nothing,
                                                      resource = Core.Nothing}
instance Core.FromJSON
           GoogleIdentityAccesscontextmanagerV1IngressSource
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1IngressSource"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1IngressSource Core.<$>
                   (o Core..:? "accessLevel") Core.<*> (o Core..:? "resource"))

instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1IngressSource
         where
        toJSON GoogleIdentityAccesscontextmanagerV1IngressSource{..}
          = Core.object
              (Core.catMaybes
                 [("accessLevel" Core..=) Core.<$> accessLevel,
                  ("resource" Core..=) Core.<$> resource])
...
newGoogleIdentityAccesscontextmanagerV1IngressTo 
    :: 
                                                 GoogleIdentityAccesscontextmanagerV1IngressTo
newGoogleIdentityAccesscontextmanagerV1IngressTo
  = GoogleIdentityAccesscontextmanagerV1IngressTo{operations =
                                                    Core.Nothing,
                                                  resources = Core.Nothing, roles = Core.Nothing}
instance Core.FromJSON
           GoogleIdentityAccesscontextmanagerV1IngressTo
         where
        parseJSON
          = Core.withObject "GoogleIdentityAccesscontextmanagerV1IngressTo"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1IngressTo Core.<$>
                   (o Core..:? "operations") Core.<*> (o Core..:? "resources")
                     Core.<*> (o Core..:? "roles"))

instance Core.ToJSON GoogleIdentityAccesscontextmanagerV1IngressTo
         where
        toJSON GoogleIdentityAccesscontextmanagerV1IngressTo{..}
          = Core.object
              (Core.catMaybes
                 [("operations" Core..=) Core.<$> operations,
                  ("resources" Core..=) Core.<$> resources,
...
newGoogleIdentityAccesscontextmanagerV1MethodSelector 
    :: 
                                                      GoogleIdentityAccesscontextmanagerV1MethodSelector
newGoogleIdentityAccesscontextmanagerV1MethodSelector
  = GoogleIdentityAccesscontextmanagerV1MethodSelector{method =
                                                         Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1MethodSelector"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1MethodSelector Core.<$>
                   (o Core..:? "method") Core.<*> (o Core..:? "permission"))

instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1MethodSelector
         where
        toJSON GoogleIdentityAccesscontextmanagerV1MethodSelector{..}
          = Core.object
              (Core.catMaybes
...
newGoogleIdentityAccesscontextmanagerV1OsConstraint 
    :: 
                                                    GoogleIdentityAccesscontextmanagerV1OsConstraint
newGoogleIdentityAccesscontextmanagerV1OsConstraint
  = GoogleIdentityAccesscontextmanagerV1OsConstraint{minimumVersion =
                                                       Core.Nothing,
                                                     osType = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1OsConstraint"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1OsConstraint Core.<$>
                   (o Core..:? "minimumVersion") Core.<*> (o Core..:? "osType")
                     Core.<*> (o Core..:? "requireVerifiedChromeOs"))

instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1OsConstraint
         where
        toJSON GoogleIdentityAccesscontextmanagerV1OsConstraint{..}
          = Core.object
              (Core.catMaybes
                 [("minimumVersion" Core..=) Core.<$> minimumVersion,
                  ("osType" Core..=) Core.<$> osType,
                  ("requireVerifiedChromeOs" Core..=) Core.<$>
...
newGoogleIdentityAccesscontextmanagerV1ServicePerimeter 
    :: 
                                                        GoogleIdentityAccesscontextmanagerV1ServicePerimeter
newGoogleIdentityAccesscontextmanagerV1ServicePerimeter
  = GoogleIdentityAccesscontextmanagerV1ServicePerimeter{description
                                                           = Core.Nothing,
                                                         etag = Core.Nothing, name = Core.Nothing,
                                                         perimeterType = Core.Nothing,
                                                         spec = Core.Nothing, status = Core.Nothing,
                                                         title = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1ServicePerimeter"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1ServicePerimeter Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "name")
...
instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1ServicePerimeter
         where
        toJSON GoogleIdentityAccesscontextmanagerV1ServicePerimeter{..}
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("etag" Core..=) Core.<$> etag, ("name" Core..=) Core.<$> name,
                  ("perimeterType" Core..=) Core.<$> perimeterType,
                  ("spec" Core..=) Core.<$> spec, ("status" Core..=) Core.<$> status,
                  ("title" Core..=) Core.<$> title,
...
data GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig = GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig
    ...
    , vpcAccessibleServices :: (Core.Maybe
   GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig 
    :: 
                                                              GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig
newGoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig
  = GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig{accessLevels
                                                                 = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig Core.<$>
                   (o Core..:? "accessLevels") Core.<*> (o Core..:? "egressPolicies")
...
newGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices 
    :: 
                                                             GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices
newGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices
  = GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices{allowedServices
                                                                = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices Core.<$>
                   (o Core..:? "allowedServices") Core.<*>
                     (o Core..:? "enableRestriction"))
...
--
-- /See:/ 'newGoogleIdentityAccesscontextmanagerV1VpcNetworkSource' smart constructor.
newtype GoogleIdentityAccesscontextmanagerV1VpcNetworkSource = GoogleIdentityAccesscontextmanagerV1VpcNetworkSource
    {
      -- | Sub-segment ranges of a VPC network.
      vpcSubnetwork :: (Core.Maybe GoogleIdentityAccesscontextmanagerV1VpcSubNetwork)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleIdentityAccesscontextmanagerV1VpcNetworkSource' with the minimum fields required to make a request.
newGoogleIdentityAccesscontextmanagerV1VpcNetworkSource 
    :: 
                                                        GoogleIdentityAccesscontextmanagerV1VpcNetworkSource
newGoogleIdentityAccesscontextmanagerV1VpcNetworkSource
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1VpcNetworkSource"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1VpcNetworkSource Core.<$>
                   (o Core..:? "vpcSubnetwork"))

instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1VpcNetworkSource
         where
        toJSON GoogleIdentityAccesscontextmanagerV1VpcNetworkSource{..}
          = Core.object
...
--
-- /See:/ 'newGoogleIdentityAccesscontextmanagerV1VpcSubNetwork' smart constructor.
data GoogleIdentityAccesscontextmanagerV1VpcSubNetwork = GoogleIdentityAccesscontextmanagerV1VpcSubNetwork
    {
...
-- | Creates a value of 'GoogleIdentityAccesscontextmanagerV1VpcSubNetwork' with the minimum fields required to make a request.
newGoogleIdentityAccesscontextmanagerV1VpcSubNetwork 
    :: 
                                                     GoogleIdentityAccesscontextmanagerV1VpcSubNetwork
newGoogleIdentityAccesscontextmanagerV1VpcSubNetwork
  = GoogleIdentityAccesscontextmanagerV1VpcSubNetwork{network =
                                                        Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIdentityAccesscontextmanagerV1VpcSubNetwork"
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1VpcSubNetwork Core.<$>
                   (o Core..:? "network") Core.<*> (o Core..:? "vpcIpSubnetworks"))

instance Core.ToJSON
           GoogleIdentityAccesscontextmanagerV1VpcSubNetwork
         where
        toJSON GoogleIdentityAccesscontextmanagerV1VpcSubNetwork{..}
          = Core.object
              (Core.catMaybes
