...
instance Core.FromJSON GoogleCloudAssetV1p7beta1Asset
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudAssetV1p7beta1Asset
         where
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudAssetV1p7beta1BigQueryDestination Core.<$>
                   (o Core..:? "dataset") Core.<*> (o Core..:? "force")
...
newGoogleCloudAssetV1p7beta1GcsDestination =
  GoogleCloudAssetV1p7beta1GcsDestination
    {uri = Core.Nothing, uriPrefix = Core.Nothing}
...
newGoogleCloudAssetV1p7beta1RelatedAsset =
  GoogleCloudAssetV1p7beta1RelatedAsset
    {ancestors = Core.Nothing, asset = Core.Nothing, assetType = Core.Nothing}
...
newGoogleCloudAssetV1p7beta1RelatedAssets =
  GoogleCloudAssetV1p7beta1RelatedAssets
    {assets = Core.Nothing, relationshipAttributes = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("sourceResourceType" Core..=) Core.<$>
                    sourceResourceType,
                  ("targetResourceType" Core..=) Core.<$>
                    targetResourceType,
                  ("type" Core..=) Core.<$> type'])
...
instance Core.ToJSON
        ...
        toJSON GoogleCloudAssetV1p7beta1Resource{..}
          = Core.object
              (Core.catMaybes
                 [("data" Core..=) Core.<$> data',
                  ("discoveryDocumentUri" Core..=) Core.<$>
          ...
          = Core.withObject "GoogleCloudOrgpolicyV1ListPolicy"
              (\ o ->
                 GoogleCloudOrgpolicyV1ListPolicy Core.<$>
                   (o Core..:? "allValues") Core.<*>
                     (o Core..:? "allowedValues")
                     Core.<*> (o Core..:? "deniedValues")
                     Core.<*> (o Core..:? "inheritFromParent")
                     Core.<*> (o Core..:? "suggestedValue"))

instance Core.ToJSON GoogleCloudOrgpolicyV1ListPolicy
         where
...
instance Core.ToJSON GoogleCloudOrgpolicyV1Policy
         where
...
newGoogleIdentityAccesscontextmanagerV1ApiOperation =
  GoogleIdentityAccesscontextmanagerV1ApiOperation
    {methodSelectors = Core.Nothing, serviceName = Core.Nothing}
...
newGoogleIdentityAccesscontextmanagerV1BasicLevel =
  GoogleIdentityAccesscontextmanagerV1BasicLevel
    {combiningFunction = Core.Nothing, conditions = Core.Nothing}
...
newGoogleIdentityAccesscontextmanagerV1EgressFrom =
  GoogleIdentityAccesscontextmanagerV1EgressFrom
    {identities = Core.Nothing, identityType = Core.Nothing}
...
newGoogleIdentityAccesscontextmanagerV1EgressPolicy =
  GoogleIdentityAccesscontextmanagerV1EgressPolicy
    {egressFrom = Core.Nothing, egressTo = Core.Nothing}
...
newGoogleIdentityAccesscontextmanagerV1IngressPolicy =
  GoogleIdentityAccesscontextmanagerV1IngressPolicy
    {ingressFrom = Core.Nothing, ingressTo = Core.Nothing}
...
newGoogleIdentityAccesscontextmanagerV1IngressSource =
  GoogleIdentityAccesscontextmanagerV1IngressSource
    {accessLevel = Core.Nothing, resource = Core.Nothing}
...
newGoogleIdentityAccesscontextmanagerV1MethodSelector =
  GoogleIdentityAccesscontextmanagerV1MethodSelector
    {method = Core.Nothing, permission = Core.Nothing}
