...
instance Core.FromJSON AdbShellCommandEvent where
        parseJSON
          = Core.withObject "AdbShellCommandEvent"
...
instance Core.FromJSON AdbShellInteractiveEvent where
        parseJSON
          = Core.withObject "AdbShellInteractiveEvent"
...
--
-- /See:/ 'newAddEsimParams' smart constructor.
data AddEsimParams = AddEsimParams
    {
    ...
    , activationState :: (Core.Maybe AddEsimParams_ActivationState)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AddEsimParams' with the minimum fields required to make a request.
newAddEsimParams 
    ::  AddEsimParams
newAddEsimParams
  = AddEsimParams{activationCode = Core.Nothing,
                  activationState = Core.Nothing}
instance Core.FromJSON AddEsimParams where
        parseJSON
          = Core.withObject "AddEsimParams"
              (\ o ->
                 AddEsimParams Core.<$>
                   (o Core..:? "activationCode") Core.<*>
                     (o Core..:? "activationState"))

instance Core.ToJSON AddEsimParams where
        toJSON AddEsimParams{..}
          = Core.object
              (Core.catMaybes
                 [("activationCode" Core..=) Core.<$> activationCode,
                  ("activationState" Core..=) Core.<$> activationState])
...
newAdvancedSecurityOverrides 
    ::  AdvancedSecurityOverrides
newAdvancedSecurityOverrides
  = AdvancedSecurityOverrides{commonCriteriaMode = Core.Nothing,
...
instance Core.FromJSON AdvancedSecurityOverrides where
        parseJSON
          = Core.withObject "AdvancedSecurityOverrides"
              (\ o ->
                 AdvancedSecurityOverrides Core.<$>
                   (o Core..:? "commonCriteriaMode") Core.<*>
                     (o Core..:? "contentProtectionPolicy")
          ...
          = Core.object
              (Core.catMaybes
                 [("commonCriteriaMode" Core..=) Core.<$> commonCriteriaMode,
                  ("contentProtectionPolicy" Core..=) Core.<$>
                    contentProtectionPolicy,
                  ("developerSettings" Core..=) Core.<$> developerSettings,
                  ("googlePlayProtectVerifyApps" Core..=) Core.<$>
                    googlePlayProtectVerifyApps,
                  ("mtePolicy" Core..=) Core.<$> mtePolicy,
                  ("personalAppsThatCanReadWorkNotifications" Core..=) Core.<$>
...
newAlwaysOnVpnPackage 
    ::  AlwaysOnVpnPackage
newAlwaysOnVpnPackage
  = AlwaysOnVpnPackage{lockdownEnabled = Core.Nothing,
                       packageName = Core.Nothing}
instance Core.FromJSON AlwaysOnVpnPackage where
        parseJSON
          = Core.withObject "AlwaysOnVpnPackage"
              (\ o ->
                 AlwaysOnVpnPackage Core.<$>
                   (o Core..:? "lockdownEnabled") Core.<*> (o Core..:? "packageName"))
...
instance Core.FromJSON ApiLevelCondition where
        parseJSON
          = Core.withObject "ApiLevelCondition"
...
-- | Access Point Name (APN) policy. Configuration for Access Point Names (APNs) which may override any other APNs on the device. See OVERRIDE/APNS/ENABLED and overrideApns for details.
--
-- /See:/ 'newApnPolicy' smart constructor.
data ApnPolicy = ApnPolicy
    {
      -- | Optional. APN settings for override APNs. There must not be any conflict between any of APN settings provided, otherwise the policy will be rejected. Two ApnSettings are considered to conflict when all of the following fields match on both: numericOperatorId, apn, proxyAddress, proxyPort, mmsProxyAddress, mmsProxyPort, mmsc, mvnoType, protocol, roamingProtocol. If some of the APN settings result in non-compliance of INVALID/VALUE , they will be ignored. This can be set on fully managed devices on Android 10 and above. This can also be set on work profiles on Android 13 and above and only with ApnSetting\'s with ENTERPRISE APN type. A NonComplianceDetail with API/LEVEL is reported if the Android version is less than 10. A NonComplianceDetail with MANAGEMENT_MODE is reported for work profiles on Android versions less than 13.
      apnSettings :: (Core.Maybe [ApnSetting])
    ...
    , overrideApns :: (Core.Maybe ApnPolicy_OverrideApns)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ApnPolicy' with the minimum fields required to make a request.
newApnPolicy 
    ::  ApnPolicy
newApnPolicy
  = ApnPolicy{apnSettings = Core.Nothing,
              overrideApns = Core.Nothing}
instance Core.FromJSON ApnPolicy where
        parseJSON
          = Core.withObject "ApnPolicy"
              (\ o ->
                 ApnPolicy Core.<$>
                   (o Core..:? "apnSettings") Core.<*> (o Core..:? "overrideApns"))

instance Core.ToJSON ApnPolicy where
        toJSON ApnPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("apnSettings" Core..=) Core.<$> apnSettings,
                  ("overrideApns" Core..=) Core.<$> overrideApns])
...
--
-- /See:/ 'newApnSetting' smart constructor.
data ApnSetting = ApnSetting
    {
      ...
      alwaysOnSetting :: (Core.Maybe ApnSetting_AlwaysOnSetting)
      -- | Required. Name of the APN. Policy will be rejected if this field is empty.
    , apn :: (Core.Maybe Core.Text)
      -- | Required. Usage categories for the APN. Policy will be rejected if this field is empty or contains APN/TYPE/UNSPECIFIED or duplicates. Multiple APN types can be set on fully managed devices. ENTERPRISE is the only allowed APN type on work profiles. A NonComplianceDetail with MANAGEMENT/MODE is reported for any other value on work profiles. APN types that are not supported on the device or management mode will be ignored. If this results in the empty list, the APN setting will be ignored, because apnTypes is a required field. A NonComplianceDetail with INVALID/VALUE is reported if none of the APN types are supported on the device or management mode.
    , apnTypes :: (Core.Maybe [ApnSetting_ApnTypesItem])
      -- | Optional. Authentication type of the APN.
    , authType :: (Core.Maybe ApnSetting_AuthType)
      -- | Optional. Carrier ID for the APN. A value of 0 (default) means not set and negative values are rejected.
    , carrierId :: (Core.Maybe Core.Int32)
    ...
    , mmsProxyAddress :: (Core.Maybe Core.Text)
    ...
    , mtuV6 :: (Core.Maybe Core.Int32)
      -- | Optional. MVNO match type for the APN.
    , mvnoType :: (Core.Maybe ApnSetting_MvnoType)
      -- | Optional. Radio technologies (network types) the APN may use. Policy will be rejected if this field contains NETWORK/TYPE/UNSPECIFIED or duplicates.
    , networkTypes :: (Core.Maybe [ApnSetting_NetworkTypesItem])
    ...
    , numericOperatorId :: (Core.Maybe Core.Text)
      -- | Optional. APN password of the APN.
    , password :: (Core.Maybe Core.Text)
      -- | Optional. The protocol to use to connect to this APN.
    , protocol :: (Core.Maybe ApnSetting_Protocol)
      -- | Optional. The proxy address of the APN.
    , proxyAddress :: (Core.Maybe Core.Text)
      -- | Optional. The proxy port of the APN. A value of 0 (default) means not set and negative values are rejected.
    , proxyPort :: (Core.Maybe Core.Int32)
      -- | Optional. The protocol to use to connect to this APN while the device is roaming.
    , roamingProtocol :: (Core.Maybe ApnSetting_RoamingProtocol)
      -- | Optional. APN username of the APN.
    , username :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ApnSetting' with the minimum fields required to make a request.
newApnSetting 
    ::  ApnSetting
newApnSetting
  = ApnSetting{alwaysOnSetting = Core.Nothing, apn = Core.Nothing,
               apnTypes = Core.Nothing, authType = Core.Nothing,
               carrierId = Core.Nothing, displayName = Core.Nothing,
               mmsProxyAddress = Core.Nothing, mmsProxyPort = Core.Nothing,
               mmsc = Core.Nothing, mtuV4 = Core.Nothing, mtuV6 = Core.Nothing,
               mvnoType = Core.Nothing, networkTypes = Core.Nothing,
               numericOperatorId = Core.Nothing, password = Core.Nothing,
               protocol = Core.Nothing, proxyAddress = Core.Nothing,
               proxyPort = Core.Nothing, roamingProtocol = Core.Nothing,
               username = Core.Nothing}
instance Core.FromJSON ApnSetting where
        parseJSON
          = Core.withObject "ApnSetting"
              (\ o ->
                 ApnSetting Core.<$>
                   (o Core..:? "alwaysOnSetting") Core.<*> (o Core..:? "apn") Core.<*>
                     (o Core..:? "apnTypes")
                     Core.<*> (o Core..:? "authType")
                     Core.<*> (o Core..:? "carrierId")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "mmsProxyAddress")
                     Core.<*> (o Core..:? "mmsProxyPort")
                     Core.<*> (o Core..:? "mmsc")
                     Core.<*> (o Core..:? "mtuV4")
                     Core.<*> (o Core..:? "mtuV6")
                     Core.<*> (o Core..:? "mvnoType")
                     Core.<*> (o Core..:? "networkTypes")
                     Core.<*> (o Core..:? "numericOperatorId")
                     Core.<*> (o Core..:? "password")
                     Core.<*> (o Core..:? "protocol")
                     Core.<*> (o Core..:? "proxyAddress")
                     Core.<*> (o Core..:? "proxyPort")
                     Core.<*> (o Core..:? "roamingProtocol")
                     Core.<*> (o Core..:? "username"))

instance Core.ToJSON ApnSetting where
        toJSON ApnSetting{..}
          = Core.object
              (Core.catMaybes
                 [("alwaysOnSetting" Core..=) Core.<$> alwaysOnSetting,
                  ("apn" Core..=) Core.<$> apn,
                  ("apnTypes" Core..=) Core.<$> apnTypes,
                  ("authType" Core..=) Core.<$> authType,
                  ("carrierId" Core..=) Core.<$> carrierId,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("mmsProxyAddress" Core..=) Core.<$> mmsProxyAddress,
                  ("mmsProxyPort" Core..=) Core.<$> mmsProxyPort,
                  ("mmsc" Core..=) Core.<$> mmsc, ("mtuV4" Core..=) Core.<$> mtuV4,
                  ("mtuV6" Core..=) Core.<$> mtuV6,
                  ("mvnoType" Core..=) Core.<$> mvnoType,
                  ("networkTypes" Core..=) Core.<$> networkTypes,
                  ("numericOperatorId" Core..=) Core.<$> numericOperatorId,
                  ("password" Core..=) Core.<$> password,
                  ("protocol" Core..=) Core.<$> protocol,
                  ("proxyAddress" Core..=) Core.<$> proxyAddress,
                  ("proxyPort" Core..=) Core.<$> proxyPort,
                  ("roamingProtocol" Core..=) Core.<$> roamingProtocol,
...
newAppProcessInfo 
    ::  AppProcessInfo
newAppProcessInfo
  = AppProcessInfo{apkSha256Hash = Core.Nothing,
                   packageNames = Core.Nothing, pid = Core.Nothing,
                   processName = Core.Nothing, seinfo = Core.Nothing,
                   startTime = Core.Nothing, uid = Core.Nothing}
instance Core.FromJSON AppProcessInfo where
        parseJSON
          = Core.withObject "AppProcessInfo"
              (\ o ->
                 AppProcessInfo Core.<$>
                   (o Core..:? "apkSha256Hash") Core.<*> (o Core..:? "packageNames")
                     Core.<*> (o Core..:? "pid")
...
instance Core.FromJSON AppProcessStartEvent where
        parseJSON
          = Core.withObject "AppProcessStartEvent"
...
instance Core.FromJSON AppTrackInfo where
        parseJSON
          = Core.withObject "AppTrackInfo"
              (\ o ->
                 AppTrackInfo Core.<$>
                   (o Core..:? "trackAlias") Core.<*> (o Core..:? "trackId"))
...
newAppVersion 
    ::  AppVersion
newAppVersion
  = AppVersion{production = Core.Nothing, trackIds = Core.Nothing,
               versionCode = Core.Nothing, versionString = Core.Nothing}
instance Core.FromJSON AppVersion where
        parseJSON
          = Core.withObject "AppVersion"
              (\ o ->
                 AppVersion Core.<$>
                   (o Core..:? "production") Core.<*> (o Core..:? "trackIds") Core.<*>
                     (o Core..:? "versionCode")
...
newApplication 
    ::  Application
newApplication
  = Application{appPricing = Core.Nothing, appTracks = Core.Nothing,
                appVersions = Core.Nothing, author = Core.Nothing,
                availableCountries = Core.Nothing, category = Core.Nothing,
                contentRating = Core.Nothing, description = Core.Nothing,
                distributionChannel = Core.Nothing, features = Core.Nothing,
                fullDescription = Core.Nothing, iconUrl = Core.Nothing,
                managedProperties = Core.Nothing,
                minAndroidSdkVersion = Core.Nothing, name = Core.Nothing,
                permissions = Core.Nothing, playStoreUrl = Core.Nothing,
                recentChanges = Core.Nothing, screenshotUrls = Core.Nothing,
                smallIconUrl = Core.Nothing, title = Core.Nothing,
                updateTime = Core.Nothing}
instance Core.FromJSON Application where
        parseJSON
          = Core.withObject "Application"
              (\ o ->
                 Application Core.<$>
                   (o Core..:? "appPricing") Core.<*> (o Core..:? "appTracks")
...
newApplicationEvent 
    ::  ApplicationEvent
newApplicationEvent
  = ApplicationEvent{createTime = Core.Nothing,
                     eventType = Core.Nothing}
instance Core.FromJSON ApplicationEvent where
        parseJSON
          = Core.withObject "ApplicationEvent"
              (\ o ->
                 ApplicationEvent Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "eventType"))
...
newApplicationPermission 
    ::  ApplicationPermission
newApplicationPermission
  = ApplicationPermission{description = Core.Nothing,
                          name = Core.Nothing, permissionId = Core.Nothing}
instance Core.FromJSON ApplicationPermission where
        parseJSON
          = Core.withObject "ApplicationPermission"
              (\ o ->
                 ApplicationPermission Core.<$>
...
data ApplicationPolicy = ApplicationPolicy
    ...
    , preferentialNetworkId :: (Core.Maybe ApplicationPolicy_PreferentialNetworkId)
...
newApplicationPolicy 
    ::  ApplicationPolicy
newApplicationPolicy
  = ApplicationPolicy{accessibleTrackIds = Core.Nothing,
                      ...
                      delegatedScopes = Core.Nothing, disabled = Core.Nothing,
                      extensionConfig = Core.Nothing, installConstraint = Core.Nothing,
                      installPriority = Core.Nothing, installType = Core.Nothing,
                      lockTaskAllowed = Core.Nothing,
                      managedConfiguration = Core.Nothing,
                      managedConfigurationTemplate = Core.Nothing,
                      minimumVersionCode = Core.Nothing, packageName = Core.Nothing,
                      permissionGrants = Core.Nothing,
                      preferentialNetworkId = Core.Nothing,
                      userControlSettings = Core.Nothing,
                      workProfileWidgets = Core.Nothing}
instance Core.FromJSON ApplicationPolicy where
        parseJSON
          = Core.withObject "ApplicationPolicy"
              (\ o ->
                 ApplicationPolicy Core.<$>
                   (o Core..:? "accessibleTrackIds") Core.<*>
                     (o Core..:? "alwaysOnVpnLockdownExemption")
                     ...
                     Core.<*> (o Core..:? "preferentialNetworkId")
          ...
          = Core.object
              (Core.catMaybes
                 [("accessibleTrackIds" Core..=) Core.<$> accessibleTrackIds,
                  ("alwaysOnVpnLockdownExemption" Core..=) Core.<$>
                    alwaysOnVpnLockdownExemption,
                  ("autoUpdateMode" Core..=) Core.<$> autoUpdateMode,
                  ("connectedWorkAndPersonalApp" Core..=) Core.<$>
                    connectedWorkAndPersonalApp,
                  ("credentialProviderPolicy" Core..=) Core.<$>
                    credentialProviderPolicy,
                  ("defaultPermissionPolicy" Core..=) Core.<$>
                  ...
                  ("managedConfigurationTemplate" Core..=) Core.<$>
                    managedConfigurationTemplate,
                  ("minimumVersionCode" Core..=) Core.<$> minimumVersionCode,
                  ("packageName" Core..=) Core.<$> packageName,
                  ("permissionGrants" Core..=) Core.<$> permissionGrants,
                  ("preferentialNetworkId" Core..=) Core.<$> preferentialNetworkId,
...
instance Core.FromJSON ApplicationPolicy_ManagedConfiguration where
        parseJSON
          = Core.withObject "ApplicationPolicy_ManagedConfiguration"
              (\ o ->
                 ApplicationPolicy_ManagedConfiguration Core.<$>
...
--
-- /See:/ 'newApplicationPolicyChange' smart constructor.
data ApplicationPolicyChange = ApplicationPolicyChange
    {
      ...
      application :: (Core.Maybe ApplicationPolicy)
      -- | The field mask indicating the fields to update. If omitted, all modifiable fields are updated.
    , updateMask :: (Core.Maybe Core.FieldMask)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ApplicationPolicyChange' with the minimum fields required to make a request.
newApplicationPolicyChange 
    ::  ApplicationPolicyChange
newApplicationPolicyChange
  = ApplicationPolicyChange{application = Core.Nothing,
                            updateMask = Core.Nothing}
instance Core.FromJSON ApplicationPolicyChange where
        parseJSON
          = Core.withObject "ApplicationPolicyChange"
              (\ o ->
                 ApplicationPolicyChange Core.<$>
                   (o Core..:? "application") Core.<*> (o Core..:? "updateMask"))

instance Core.ToJSON ApplicationPolicyChange where
        toJSON ApplicationPolicyChange{..}
          = Core.object
              (Core.catMaybes
...
newApplicationReport 
    ::  ApplicationReport
newApplicationReport
  = ApplicationReport{applicationSource = Core.Nothing,
                      displayName = Core.Nothing, events = Core.Nothing,
                      installerPackageName = Core.Nothing, keyedAppStates = Core.Nothing,
                      packageName = Core.Nothing, packageSha256Hash = Core.Nothing,
                      signingKeyCertFingerprints = Core.Nothing, state = Core.Nothing,
                      userFacingType = Core.Nothing, versionCode = Core.Nothing,
                      versionName = Core.Nothing}
instance Core.FromJSON ApplicationReport where
        parseJSON
          = Core.withObject "ApplicationReport"
              (\ o ->
                 ApplicationReport Core.<$>
                   (o Core..:? "applicationSource") Core.<*>
                     (o Core..:? "displayName")
                     Core.<*> (o Core..:? "events")
          ...
          = Core.object
              (Core.catMaybes
                 [("applicationSource" Core..=) Core.<$> applicationSource,
                  ...
                  ("signingKeyCertFingerprints" Core..=) Core.<$>
...
instance Core.FromJSON ApplicationReportingSettings where
        parseJSON
          = Core.withObject "ApplicationReportingSettings"
              (\ o ->
                 ApplicationReportingSettings Core.<$>
                   (o Core..:? "includeRemovedApps"))
...
--
-- /See:/ 'newBackupServiceToggledEvent' smart constructor.
data BackupServiceToggledEvent = BackupServiceToggledEvent
    {
    ...
    , backupServiceState :: (Core.Maybe BackupServiceToggledEvent_BackupServiceState)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BackupServiceToggledEvent' with the minimum fields required to make a request.
newBackupServiceToggledEvent 
    ::  BackupServiceToggledEvent
newBackupServiceToggledEvent
  = BackupServiceToggledEvent{adminPackageName = Core.Nothing,
                              adminUserId = Core.Nothing, backupServiceState = Core.Nothing}
instance Core.FromJSON BackupServiceToggledEvent where
        parseJSON
          = Core.withObject "BackupServiceToggledEvent"
              (\ o ->
                 BackupServiceToggledEvent Core.<$>
                   (o Core..:? "adminPackageName") Core.<*> (o Core..:? "adminUserId")
                     Core.<*> (o Core..:? "backupServiceState"))

instance Core.ToJSON BackupServiceToggledEvent where
        toJSON BackupServiceToggledEvent{..}
          = Core.object
              (Core.catMaybes
                 [("adminPackageName" Core..=) Core.<$> adminPackageName,
                  ("adminUserId" Core..=) Core.<$> adminUserId,
                  ("backupServiceState" Core..=) Core.<$> backupServiceState])
...
newBatchUsageLogEvents 
    ::  BatchUsageLogEvents
newBatchUsageLogEvents
  = BatchUsageLogEvents{device = Core.Nothing,
                        retrievalTime = Core.Nothing, usageLogEvents = Core.Nothing,
                        user = Core.Nothing}
instance Core.FromJSON BatchUsageLogEvents where
        parseJSON
          = Core.withObject "BatchUsageLogEvents"
              (\ o ->
                 BatchUsageLogEvents Core.<$>
                   (o Core..:? "device") Core.<*> (o Core..:? "retrievalTime")
...
newBlockAction 
    ::  BlockAction
newBlockAction
  = BlockAction{blockAfterDays = Core.Nothing,
                blockScope = Core.Nothing}
instance Core.FromJSON BlockAction where
        parseJSON
          = Core.withObject "BlockAction"
              (\ o ->
                 BlockAction Core.<$>
                   (o Core..:? "blockAfterDays") Core.<*> (o Core..:? "blockScope"))
...
newCertAuthorityInstalledEvent 
    ::  CertAuthorityInstalledEvent
newCertAuthorityInstalledEvent
  = CertAuthorityInstalledEvent{certificate = Core.Nothing,
                                success = Core.Nothing, userId = Core.Nothing}
instance Core.FromJSON CertAuthorityInstalledEvent where
        parseJSON
          = Core.withObject "CertAuthorityInstalledEvent"
              (\ o ->
                 CertAuthorityInstalledEvent Core.<$>
                   (o Core..:? "certificate") Core.<*> (o Core..:? "success") Core.<*>
                     (o Core..:? "userId"))
...
newCertAuthorityRemovedEvent 
    ::  CertAuthorityRemovedEvent
newCertAuthorityRemovedEvent
  = CertAuthorityRemovedEvent{certificate = Core.Nothing,
                              success = Core.Nothing, userId = Core.Nothing}
instance Core.FromJSON CertAuthorityRemovedEvent where
        parseJSON
          = Core.withObject "CertAuthorityRemovedEvent"
              (\ o ->
...
instance Core.FromJSON CertValidationFailureEvent where
        parseJSON
          = Core.withObject "CertValidationFailureEvent"
              (\ o ->
...
newChoosePrivateKeyRule 
    ::  ChoosePrivateKeyRule
newChoosePrivateKeyRule
  = ChoosePrivateKeyRule{packageNames = Core.Nothing,
                         privateKeyAlias = Core.Nothing, urlPattern = Core.Nothing}
instance Core.FromJSON ChoosePrivateKeyRule where
        parseJSON
          = Core.withObject "ChoosePrivateKeyRule"
              (\ o ->
                 ChoosePrivateKeyRule Core.<$>
                   (o Core..:? "packageNames") Core.<*> (o Core..:? "privateKeyAlias")
...
instance Core.FromJSON ClearAppsDataParams where
        parseJSON
          = Core.withObject "ClearAppsDataParams"
...
instance Core.FromJSON ClearAppsDataStatus where
        parseJSON
          = Core.withObject "ClearAppsDataStatus"
...
instance Core.FromJSON ClearAppsDataStatus_Results where
        parseJSON
          = Core.withObject "ClearAppsDataStatus_Results"
              (\ o ->
...
data Command = Command
    {
      -- | Optional. Parameters for the ADD/ESIM command to add an eSIM profile to the device. If this is set, then it is suggested that type should not be set. In this case, the server automatically sets it to ADD/ESIM. It is also acceptable to explicitly set type to ADD_ESIM.
      addEsimParams :: (Core.Maybe AddEsimParams)
    ...
    , esimStatus :: (Core.Maybe EsimCommandStatus)
    ...
    , newPassword' :: (Core.Maybe Core.Text)
      -- | Optional. Parameters for the REMOVE/ESIM command to remove an eSIM profile from the device. If this is set, then it is suggested that type should not be set. In this case, the server automatically sets it to REMOVE/ESIM. It is also acceptable to explicitly set type to REMOVE_ESIM.
    , removeEsimParams :: (Core.Maybe RemoveEsimParams)
      -- | Optional. Parameters for the REQUEST/DEVICE/INFO command to get device related information. If this is set, then it is suggested that type should not be set. In this case, the server automatically sets it to REQUEST/DEVICE/INFO . It is also acceptable to explicitly set type to REQUEST/DEVICE/INFO.
    , requestDeviceInfoParams :: (Core.Maybe RequestDeviceInfoParams)
      -- | Output only. Status of the REQUEST/DEVICE/INFO command.
    , requestDeviceInfoStatus :: (Core.Maybe RequestDeviceInfoStatus)
...
newCommand 
    ::  Command
newCommand
  = Command{addEsimParams = Core.Nothing,
            clearAppsDataParams = Core.Nothing,
            clearAppsDataStatus = Core.Nothing, createTime = Core.Nothing,
            duration = Core.Nothing, errorCode = Core.Nothing,
            esimStatus = Core.Nothing, newPassword' = Core.Nothing,
            removeEsimParams = Core.Nothing,
            requestDeviceInfoParams = Core.Nothing,
            requestDeviceInfoStatus = Core.Nothing,
            ...
            stopLostModeStatus = Core.Nothing, type' = Core.Nothing,
            userName = Core.Nothing}
instance Core.FromJSON Command where
        parseJSON
          = Core.withObject "Command"
              (\ o ->
                 Command Core.<$>
                   (o Core..:? "addEsimParams") Core.<*>
                     (o Core..:? "clearAppsDataParams")
                     Core.<*> (o Core..:? "clearAppsDataStatus")
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "duration")
                     Core.<*> (o Core..:? "errorCode")
                     Core.<*> (o Core..:? "esimStatus")
                     Core.<*> (o Core..:? "newPassword")
                     Core.<*> (o Core..:? "removeEsimParams")
                     Core.<*> (o Core..:? "requestDeviceInfoParams")
                     Core.<*> (o Core..:? "requestDeviceInfoStatus")
...
instance Core.ToJSON Command where
        toJSON Command{..}
          = Core.object
              (Core.catMaybes
                 [("addEsimParams" Core..=) Core.<$> addEsimParams,
                  ...
                  ("esimStatus" Core..=) Core.<$> esimStatus,
                  ("newPassword" Core..=) Core.<$> newPassword',
                  ("removeEsimParams" Core..=) Core.<$> removeEsimParams,
                  ("requestDeviceInfoParams" Core..=) Core.<$>
                    requestDeviceInfoParams,
                  ("requestDeviceInfoStatus" Core..=) Core.<$>
                    requestDeviceInfoStatus,
...
data CommonCriteriaModeInfo = CommonCriteriaModeInfo
    ...
    , policySignatureVerificationStatus :: (Core.Maybe
...
instance Core.FromJSON CommonCriteriaModeInfo where
        parseJSON
          = Core.withObject "CommonCriteriaModeInfo"
              (\ o ->
                 CommonCriteriaModeInfo Core.<$>
                   (o Core..:? "commonCriteriaModeStatus") Core.<*>
                     (o Core..:? "policySignatureVerificationStatus"))

instance Core.ToJSON CommonCriteriaModeInfo where
        toJSON CommonCriteriaModeInfo{..}
          = Core.object
              (Core.catMaybes
                 [("commonCriteriaModeStatus" Core..=) Core.<$>
                    commonCriteriaModeStatus,
                  ("policySignatureVerificationStatus" Core..=) Core.<$>
...
newComplianceRule 
    ::  ComplianceRule
newComplianceRule
  = ComplianceRule{apiLevelCondition = Core.Nothing,
...
instance Core.FromJSON ComplianceRule where
        parseJSON
          = Core.withObject "ComplianceRule"
              (\ o ->
                 ComplianceRule Core.<$>
                   (o Core..:? "apiLevelCondition") Core.<*>
                     (o Core..:? "disableApps")
          ...
          = Core.object
              (Core.catMaybes
                 [("apiLevelCondition" Core..=) Core.<$> apiLevelCondition,
                  ...
                  ("nonComplianceDetailCondition" Core..=) Core.<$>
                    nonComplianceDetailCondition,
...
newConnectEvent 
    ::  ConnectEvent
newConnectEvent
  = ConnectEvent{destinationIpAddress = Core.Nothing,
                 destinationPort = Core.Nothing, packageName = Core.Nothing}
instance Core.FromJSON ConnectEvent where
        parseJSON
          = Core.withObject "ConnectEvent"
              (\ o ->
                 ConnectEvent Core.<$>
                   (o Core..:? "destinationIpAddress") Core.<*>
                     (o Core..:? "destinationPort")
                     Core.<*> (o Core..:? "packageName"))
...
newContactInfo 
    ::  ContactInfo
newContactInfo
  = ContactInfo{contactEmail = Core.Nothing,
...
instance Core.FromJSON ContactInfo where
        parseJSON
          = Core.withObject "ContactInfo"
              (\ o ->
                 ContactInfo Core.<$>
                   (o Core..:? "contactEmail") Core.<*>
                     (o Core..:? "dataProtectionOfficerEmail")
          ...
          = Core.object
              (Core.catMaybes
                 [("contactEmail" Core..=) Core.<$> contactEmail,
                  ("dataProtectionOfficerEmail" Core..=) Core.<$>
                    dataProtectionOfficerEmail,
                  ("dataProtectionOfficerName" Core..=) Core.<$>
                    dataProtectionOfficerName,
                  ("dataProtectionOfficerPhone" Core..=) Core.<$>
...
newContentProviderEndpoint 
    ::  ContentProviderEndpoint
newContentProviderEndpoint
  = ContentProviderEndpoint{packageName = Core.Nothing,
                            signingCertsSha256 = Core.Nothing, uri = Core.Nothing}
instance Core.FromJSON ContentProviderEndpoint where
        parseJSON
          = Core.withObject "ContentProviderEndpoint"
              (\ o ->
                 ContentProviderEndpoint Core.<$>
                   (o Core..:? "packageName") Core.<*>
                     (o Core..:? "signingCertsSha256")
                     Core.<*> (o Core..:? "uri"))
...
data CrossProfilePolicies = CrossProfilePolicies
    {
      ...
      crossProfileAppFunctions :: (Core.Maybe CrossProfilePolicies_CrossProfileAppFunctions)
...
newCrossProfilePolicies 
    ::  CrossProfilePolicies
newCrossProfilePolicies
  = CrossProfilePolicies{crossProfileAppFunctions = Core.Nothing,
...
instance Core.FromJSON CrossProfilePolicies where
        parseJSON
          = Core.withObject "CrossProfilePolicies"
              (\ o ->
                 CrossProfilePolicies Core.<$>
                   (o Core..:? "crossProfileAppFunctions") Core.<*>
                     (o Core..:? "crossProfileCopyPaste")
                     Core.<*> (o Core..:? "crossProfileDataSharing")
                     Core.<*>
                     (o Core..:? "exemptionsToShowWorkContactsInPersonalProfile")
...
instance Core.ToJSON CrossProfilePolicies where
        toJSON CrossProfilePolicies{..}
          = Core.object
              (Core.catMaybes
                 [("crossProfileAppFunctions" Core..=) Core.<$>
                    crossProfileAppFunctions,
                  ("crossProfileCopyPaste" Core..=) Core.<$> crossProfileCopyPaste,
                  ("crossProfileDataSharing" Core..=) Core.<$>
                    crossProfileDataSharing,
                  ("exemptionsToShowWorkContactsInPersonalProfile" Core..=) Core.<$>
                    exemptionsToShowWorkContactsInPersonalProfile,
                  ("showWorkContactsInPersonalProfile" Core..=) Core.<$>
                    showWorkContactsInPersonalProfile,
                  ("workProfileWidgetsDefault" Core..=) Core.<$>
...
instance Core.FromJSON CryptoSelfTestCompletedEvent where
        parseJSON
          = Core.withObject "CryptoSelfTestCompletedEvent"
              (\ o ->
...
newDevice 
    ::  Device
newDevice
  = Device{apiLevel = Core.Nothing,
           applicationReports = Core.Nothing,
           appliedPasswordPolicies = Core.Nothing,
           appliedPolicyName = Core.Nothing,
           appliedPolicyVersion = Core.Nothing, appliedState = Core.Nothing,
           commonCriteriaModeInfo = Core.Nothing,
           deviceSettings = Core.Nothing, disabledReason = Core.Nothing,
           displays = Core.Nothing, dpcMigrationInfo = Core.Nothing,
           enrollmentTime = Core.Nothing, enrollmentTokenData = Core.Nothing,
           enrollmentTokenName = Core.Nothing, hardwareInfo = Core.Nothing,
           hardwareStatusSamples = Core.Nothing,
           lastPolicyComplianceReportTime = Core.Nothing,
           lastPolicySyncTime = Core.Nothing,
           lastStatusReportTime = Core.Nothing, managementMode = Core.Nothing,
           memoryEvents = Core.Nothing, memoryInfo = Core.Nothing,
           name = Core.Nothing, networkInfo = Core.Nothing,
           nonComplianceDetails = Core.Nothing, ownership = Core.Nothing,
           policyCompliant = Core.Nothing, policyName = Core.Nothing,
           powerManagementEvents = Core.Nothing,
           previousDeviceNames = Core.Nothing, securityPosture = Core.Nothing,
           softwareInfo = Core.Nothing, state = Core.Nothing,
           systemProperties = Core.Nothing, user = Core.Nothing,
           userName = Core.Nothing}
instance Core.FromJSON Device where
        parseJSON
          = Core.withObject "Device"
              (\ o ->
                 Device Core.<$>
                   (o Core..:? "apiLevel") Core.<*> (o Core..:? "applicationReports")
                     Core.<*> (o Core..:? "appliedPasswordPolicies")
                     Core.<*> (o Core..:? "appliedPolicyName")
                     Core.<*>
                     (o Core..:? "appliedPolicyVersion" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("apiLevel" Core..=) Core.<$> apiLevel,
                  ...
                  ("appliedPasswordPolicies" Core..=) Core.<$>
                    appliedPasswordPolicies,
                  ("appliedPolicyName" Core..=) Core.<$> appliedPolicyName,
                  ("appliedPolicyVersion" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("lastPolicyComplianceReportTime" Core..=) Core.<$>
...
instance Core.FromJSON Device_SystemProperties where
        parseJSON
          = Core.withObject "Device_SystemProperties"
...
data DeviceConnectivityManagement = DeviceConnectivityManagement
    {
      -- | Optional. Access Point Name (APN) policy. Configuration for Access Point Names (APNs) which may override any other APNs on the device. See OVERRIDE/APNS/ENABLED and overrideApns for details.
      apnPolicy :: (Core.Maybe ApnPolicy)
      -- | Optional. Controls whether Bluetooth sharing is allowed.
    , bluetoothSharing :: (Core.Maybe DeviceConnectivityManagement_BluetoothSharing)
    ...
    , preferentialNetworkServiceSettings :: (Core.Maybe PreferentialNetworkServiceSettings)
...
newDeviceConnectivityManagement 
    ::  DeviceConnectivityManagement
newDeviceConnectivityManagement
  = DeviceConnectivityManagement{apnPolicy = Core.Nothing,
                                 bluetoothSharing = Core.Nothing, configureWifi = Core.Nothing,
                                 preferentialNetworkServiceSettings = Core.Nothing,
                                 tetheringSettings = Core.Nothing, usbDataAccess = Core.Nothing,
                                 wifiDirectSettings = Core.Nothing,
                                 wifiRoamingPolicy = Core.Nothing, wifiSsidPolicy = Core.Nothing}
instance Core.FromJSON DeviceConnectivityManagement where
        parseJSON
          = Core.withObject "DeviceConnectivityManagement"
              (\ o ->
                 DeviceConnectivityManagement Core.<$>
                   (o Core..:? "apnPolicy") Core.<*> (o Core..:? "bluetoothSharing")
                     Core.<*> (o Core..:? "configureWifi")
                     Core.<*> (o Core..:? "preferentialNetworkServiceSettings")
...
instance Core.ToJSON DeviceConnectivityManagement where
        toJSON DeviceConnectivityManagement{..}
          = Core.object
              (Core.catMaybes
                 [("apnPolicy" Core..=) Core.<$> apnPolicy,
                  ("bluetoothSharing" Core..=) Core.<$> bluetoothSharing,
                  ("configureWifi" Core..=) Core.<$> configureWifi,
                  ("preferentialNetworkServiceSettings" Core..=) Core.<$>
                    preferentialNetworkServiceSettings,
...
newDeviceRadioState 
    ::  DeviceRadioState
newDeviceRadioState
  = DeviceRadioState{airplaneModeState = Core.Nothing,
                     cellularTwoGState = Core.Nothing,
                     minimumWifiSecurityLevel = Core.Nothing,
                     ultraWidebandState = Core.Nothing, wifiState = Core.Nothing}
instance Core.FromJSON DeviceRadioState where
        parseJSON
          = Core.withObject "DeviceRadioState"
              (\ o ->
                 DeviceRadioState Core.<$>
                   (o Core..:? "airplaneModeState") Core.<*>
                     (o Core..:? "cellularTwoGState")
          ...
          = Core.object
              (Core.catMaybes
                 [("airplaneModeState" Core..=) Core.<$> airplaneModeState,
                  ...
                  ("minimumWifiSecurityLevel" Core..=) Core.<$>
...
newDeviceSettings 
    ::  DeviceSettings
newDeviceSettings
  = DeviceSettings{adbEnabled = Core.Nothing,
                   developmentSettingsEnabled = Core.Nothing,
                   encryptionStatus = Core.Nothing, isDeviceSecure = Core.Nothing,
                   isEncrypted = Core.Nothing, unknownSourcesEnabled = Core.Nothing,
                   verifyAppsEnabled = Core.Nothing}
instance Core.FromJSON DeviceSettings where
        parseJSON
          = Core.withObject "DeviceSettings"
              (\ o ->
                 DeviceSettings Core.<$>
                   (o Core..:? "adbEnabled") Core.<*>
                     (o Core..:? "developmentSettingsEnabled")
          ...
          = Core.object
              (Core.catMaybes
                 [("adbEnabled" Core..=) Core.<$> adbEnabled,
                  ("developmentSettingsEnabled" Core..=) Core.<$>
...
newDisplay 
    ::  Display
newDisplay
  = Display{density = Core.Nothing, displayId = Core.Nothing,
            height = Core.Nothing, name = Core.Nothing,
            refreshRate = Core.Nothing, state = Core.Nothing,
            width = Core.Nothing}
instance Core.FromJSON Display where
        parseJSON
          = Core.withObject "Display"
              (\ o ->
                 Display Core.<$>
                   (o Core..:? "density") Core.<*> (o Core..:? "displayId") Core.<*>
                     (o Core..:? "height")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("density" Core..=) Core.<$> density,
                  ...
                  ("height" Core..=) Core.<$> height, ("name" Core..=) Core.<$> name,
...
newDisplaySettings 
    ::  DisplaySettings
newDisplaySettings
  = DisplaySettings{screenBrightnessSettings = Core.Nothing,
                    screenTimeoutSettings = Core.Nothing}
instance Core.FromJSON DisplaySettings where
        parseJSON
          = Core.withObject "DisplaySettings"
              (\ o ->
                 DisplaySettings Core.<$>
                   (o Core..:? "screenBrightnessSettings") Core.<*>
                     (o Core..:? "screenTimeoutSettings"))

instance Core.ToJSON DisplaySettings where
        toJSON DisplaySettings{..}
          = Core.object
              (Core.catMaybes
                 [("screenBrightnessSettings" Core..=) Core.<$>
                    screenBrightnessSettings,
...
newDnsEvent 
    ::  DnsEvent
newDnsEvent
  = DnsEvent{hostname = Core.Nothing, ipAddresses = Core.Nothing,
             packageName = Core.Nothing,
             totalIpAddressesReturned = Core.Nothing}
instance Core.FromJSON DnsEvent where
        parseJSON
          = Core.withObject "DnsEvent"
              (\ o ->
                 DnsEvent Core.<$>
                   (o Core..:? "hostname") Core.<*> (o Core..:? "ipAddresses")
                     Core.<*> (o Core..:? "packageName")
                     Core.<*>
                     (o Core..:? "totalIpAddressesReturned" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("hostname" Core..=) Core.<$> hostname,
                  ...
                  ("packageName" Core..=) Core.<$> packageName,
                  ("totalIpAddressesReturned" Core..=) Core.. Core.AsText Core.<$>
...
newDpcMigrationInfo 
    ::  DpcMigrationInfo
newDpcMigrationInfo
  = DpcMigrationInfo{additionalData = Core.Nothing,
                     previousDpc = Core.Nothing}
instance Core.FromJSON DpcMigrationInfo where
        parseJSON
          = Core.withObject "DpcMigrationInfo"
              (\ o ->
                 DpcMigrationInfo Core.<$>
                   (o Core..:? "additionalData") Core.<*> (o Core..:? "previousDpc"))
...
--
-- /See:/ 'newEid' smart constructor.
newtype Eid = Eid
    {
      -- | Output only. The EID
      eid :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'Eid' with the minimum fields required to make a request.
newEid 
    ::  Eid
newEid = Eid{eid = Core.Nothing}
instance Core.FromJSON Eid where
        parseJSON
          = Core.withObject "Eid" (\ o -> Eid Core.<$> (o Core..:? "eid"))

instance Core.ToJSON Eid where
        toJSON Eid{..}
          = Core.object (Core.catMaybes [("eid" Core..=) Core.<$> eid])


-- | Information related to the EIDs of the device.
--
-- /See:/ 'newEidInfo' smart constructor.
newtype EidInfo = EidInfo
    {
...
-- | Creates a value of 'EidInfo' with the minimum fields required to make a request.
newEidInfo 
    ::  EidInfo
newEidInfo = EidInfo{eids = Core.Nothing}
instance Core.FromJSON EidInfo where
        parseJSON
          = Core.withObject "EidInfo"
              (\ o -> EidInfo Core.<$> (o Core..:? "eids"))

instance Core.ToJSON EidInfo where
        toJSON EidInfo{..}
          = Core.object (Core.catMaybes [("eids" Core..=) Core.<$> eids])
...
instance Core.FromJSON EnrollmentCompleteEvent where
        parseJSON
          = Core.withObject "EnrollmentCompleteEvent"
...
newEnrollmentToken 
    ::  EnrollmentToken
newEnrollmentToken
  = EnrollmentToken{additionalData = Core.Nothing,
                    allowPersonalUsage = Core.Nothing, duration = Core.Nothing,
                    expirationTimestamp = Core.Nothing, name = Core.Nothing,
                    oneTimeOnly = Core.Nothing, policyName = Core.Nothing,
                    qrCode = Core.Nothing, user = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON EnrollmentToken where
        parseJSON
          = Core.withObject "EnrollmentToken"
              (\ o ->
                 EnrollmentToken Core.<$>
                   (o Core..:? "additionalData") Core.<*>
                     (o Core..:? "allowPersonalUsage")
                     Core.<*> (o Core..:? "duration")
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalData" Core..=) Core.<$> additionalData,
                  ...
                  ("policyName" Core..=) Core.<$> policyName,
                  ("qrCode" Core..=) Core.<$> qrCode, ("user" Core..=) Core.<$> user,
...
newEnterprise 
    ::  Enterprise
newEnterprise
  = Enterprise{appAutoApprovalEnabled = Core.Nothing,
               ...
               googleAuthenticationSettings = Core.Nothing, logo = Core.Nothing,
               managedGoogleDomainType = Core.Nothing,
               managedGooglePlayAccountsEnterpriseType = Core.Nothing,
               name = Core.Nothing, primaryColor = Core.Nothing,
               pubsubTopic = Core.Nothing, signinDetails = Core.Nothing,
               termsAndConditions = Core.Nothing}
instance Core.FromJSON Enterprise where
        parseJSON
          = Core.withObject "Enterprise"
              (\ o ->
                 Enterprise Core.<$>
                   (o Core..:? "appAutoApprovalEnabled") Core.<*>
                     (o Core..:? "contactInfo")
...
instance Core.ToJSON Enterprise where
        toJSON Enterprise{..}
          = Core.object
              (Core.catMaybes
                 [("appAutoApprovalEnabled" Core..=) Core.<$>
                    appAutoApprovalEnabled,
                  ("contactInfo" Core..=) Core.<$> contactInfo,
                  ("enabledNotificationTypes" Core..=) Core.<$>
                    enabledNotificationTypes,
                  ("enterpriseDisplayName" Core..=) Core.<$> enterpriseDisplayName,
                  ("enterpriseType" Core..=) Core.<$> enterpriseType,
                  ("googleAuthenticationSettings" Core..=) Core.<$>
                    googleAuthenticationSettings,
                  ("logo" Core..=) Core.<$> logo,
                  ("managedGoogleDomainType" Core..=) Core.<$>
                    managedGoogleDomainType,
                  ("managedGooglePlayAccountsEnterpriseType" Core..=) Core.<$>
...
data EnterpriseUpgradeEvent = EnterpriseUpgradeEvent
    {
...
newEnterpriseUpgradeEvent 
    ::  EnterpriseUpgradeEvent
newEnterpriseUpgradeEvent
  = EnterpriseUpgradeEvent{enterprise = Core.Nothing,
                           upgradeState = Core.Nothing}
instance Core.FromJSON EnterpriseUpgradeEvent where
        parseJSON
          = Core.withObject "EnterpriseUpgradeEvent"
              (\ o ->
                 EnterpriseUpgradeEvent Core.<$>
                   (o Core..:? "enterprise") Core.<*> (o Core..:? "upgradeState"))
          ...
          = Core.object
              (Core.catMaybes
                 [("enterprise" Core..=) Core.<$> enterprise,
                  ("upgradeState" Core..=) Core.<$> upgradeState])


-- | Status and error details (if present) of an ADD/ESIM or REMOVE/ESIM command.
--
-- /See:/ 'newEsimCommandStatus' smart constructor.
data EsimCommandStatus = EsimCommandStatus
    {
      -- | Output only. Information about the eSIM added or removed. This is populated only when the eSIM operation status is SUCCESS.
      esimInfo :: (Core.Maybe EsimInfo)
      -- | Output only. Details of the error if the status is set to INTERNAL_ERROR.
    , internalErrorDetails :: (Core.Maybe InternalErrorDetails)
      -- | Output only. Status of an ADD/ESIM or REMOVE/ESIM command.
    , status :: (Core.Maybe EsimCommandStatus_Status)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'EsimCommandStatus' with the minimum fields required to make a request.
newEsimCommandStatus 
    ::  EsimCommandStatus
newEsimCommandStatus
  = EsimCommandStatus{esimInfo = Core.Nothing,
                      internalErrorDetails = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON EsimCommandStatus where
        parseJSON
          = Core.withObject "EsimCommandStatus"
              (\ o ->
                 EsimCommandStatus Core.<$>
                   (o Core..:? "esimInfo") Core.<*>
                     (o Core..:? "internalErrorDetails")
                     Core.<*> (o Core..:? "status"))

instance Core.ToJSON EsimCommandStatus where
        toJSON EsimCommandStatus{..}
          = Core.object
              (Core.catMaybes
                 [("esimInfo" Core..=) Core.<$> esimInfo,
                  ("internalErrorDetails" Core..=) Core.<$> internalErrorDetails,
                  ("status" Core..=) Core.<$> status])


-- | Details of the eSIM added or removed.
--
-- /See:/ 'newEsimInfo' smart constructor.
newtype EsimInfo = EsimInfo
    {
...
-- | Creates a value of 'EsimInfo' with the minimum fields required to make a request.
newEsimInfo 
    ::  EsimInfo
newEsimInfo = EsimInfo{iccId = Core.Nothing}
instance Core.FromJSON EsimInfo where
        parseJSON
          = Core.withObject "EsimInfo"
              (\ o -> EsimInfo Core.<$> (o Core..:? "iccId"))

instance Core.ToJSON EsimInfo where
        toJSON EsimInfo{..}
          = Core.object (Core.catMaybes [("iccId" Core..=) Core.<$> iccId])


-- | Information related to the eUICC chip.
--
-- /See:/ 'newEuiccChipInfo' smart constructor.
newtype EuiccChipInfo = EuiccChipInfo
    {
...
-- | Creates a value of 'EuiccChipInfo' with the minimum fields required to make a request.
newEuiccChipInfo 
    ::  EuiccChipInfo
newEuiccChipInfo = EuiccChipInfo{eid = Core.Nothing}
instance Core.FromJSON EuiccChipInfo where
        parseJSON
          = Core.withObject "EuiccChipInfo"
              (\ o -> EuiccChipInfo Core.<$> (o Core..:? "eid"))

instance Core.ToJSON EuiccChipInfo where
        toJSON EuiccChipInfo{..}
          = Core.object (Core.catMaybes [("eid" Core..=) Core.<$> eid])
...
newExtensionConfig 
    ::  ExtensionConfig
newExtensionConfig
  = ExtensionConfig{notificationReceiver = Core.Nothing,
                    signingKeyFingerprintsSha256 = Core.Nothing}
instance Core.FromJSON ExtensionConfig where
        parseJSON
          = Core.withObject "ExtensionConfig"
              (\ o ->
                 ExtensionConfig Core.<$>
                   (o Core..:? "notificationReceiver") Core.<*>
                     (o Core..:? "signingKeyFingerprintsSha256"))
          ...
          = Core.object
              (Core.catMaybes
                 [("notificationReceiver" Core..=) Core.<$> notificationReceiver,
                  ("signingKeyFingerprintsSha256" Core..=) Core.<$>
...
instance Core.FromJSON ExternalData where
        parseJSON
          = Core.withObject "ExternalData"
              (\ o ->
                 ExternalData Core.<$>
                   (o Core..:? "sha256Hash") Core.<*> (o Core..:? "url"))
...
instance Core.FromJSON FilePulledEvent where
        parseJSON
          = Core.withObject "FilePulledEvent"
...
instance Core.FromJSON FilePushedEvent where
        parseJSON
          = Core.withObject "FilePushedEvent"
...
instance Core.FromJSON FreezePeriod where
        parseJSON
          = Core.withObject "FreezePeriod"
              (\ o ->
                 FreezePeriod Core.<$>
                   (o Core..:? "endDate") Core.<*> (o Core..:? "startDate"))
...
newGenerateEnterpriseUpgradeUrlRequest 
    :: 
                                       GenerateEnterpriseUpgradeUrlRequest
newGenerateEnterpriseUpgradeUrlRequest
  = GenerateEnterpriseUpgradeUrlRequest{adminEmail = Core.Nothing,
                                        allowedDomains = Core.Nothing}
instance Core.FromJSON GenerateEnterpriseUpgradeUrlRequest where
        parseJSON
          = Core.withObject "GenerateEnterpriseUpgradeUrlRequest"
              (\ o ->
                 GenerateEnterpriseUpgradeUrlRequest Core.<$>
                   (o Core..:? "adminEmail") Core.<*> (o Core..:? "allowedDomains"))
...
instance Core.FromJSON GenerateEnterpriseUpgradeUrlResponse where
        parseJSON
          = Core.withObject "GenerateEnterpriseUpgradeUrlResponse"
              (\ o ->
...
newtype GoogleAuthenticationSettings = GoogleAuthenticationSettings
    {
      ...
      googleAuthenticationRequired :: (Core.Maybe
...
data HardwareInfo = HardwareInfo
    ...
    , euiccChipInfo :: (Core.Maybe [EuiccChipInfo])
...
newHardwareInfo 
    ::  HardwareInfo
newHardwareInfo
  = HardwareInfo{batteryShutdownTemperatures = Core.Nothing,
                 batteryThrottlingTemperatures = Core.Nothing, brand = Core.Nothing,
                 cpuShutdownTemperatures = Core.Nothing,
                 cpuThrottlingTemperatures = Core.Nothing,
                 deviceBasebandVersion = Core.Nothing,
                 enterpriseSpecificId = Core.Nothing, euiccChipInfo = Core.Nothing,
                 gpuShutdownTemperatures = Core.Nothing,
                 gpuThrottlingTemperatures = Core.Nothing, hardware = Core.Nothing,
                 manufacturer = Core.Nothing, model = Core.Nothing,
...
instance Core.FromJSON HardwareInfo where
        parseJSON
          = Core.withObject "HardwareInfo"
              (\ o ->
                 HardwareInfo Core.<$>
                   (o Core..:? "batteryShutdownTemperatures") Core.<*>
                     (o Core..:? "batteryThrottlingTemperatures")
                     Core.<*> (o Core..:? "brand")
...
instance Core.ToJSON HardwareInfo where
        toJSON HardwareInfo{..}
          = Core.object
              (Core.catMaybes
                 [("batteryShutdownTemperatures" Core..=) Core.<$>
                    batteryShutdownTemperatures,
                  ("batteryThrottlingTemperatures" Core..=) Core.<$>
                    batteryThrottlingTemperatures,
                  ("brand" Core..=) Core.<$> brand,
                  ("cpuShutdownTemperatures" Core..=) Core.<$>
                    cpuShutdownTemperatures,
                  ("cpuThrottlingTemperatures" Core..=) Core.<$>
                    cpuThrottlingTemperatures,
                  ("deviceBasebandVersion" Core..=) Core.<$> deviceBasebandVersion,
                  ("enterpriseSpecificId" Core..=) Core.<$> enterpriseSpecificId,
                  ("euiccChipInfo" Core..=) Core.<$> euiccChipInfo,
                  ("gpuShutdownTemperatures" Core..=) Core.<$>
                    gpuShutdownTemperatures,
                  ("gpuThrottlingTemperatures" Core..=) Core.<$>
                  ...
                  ("skinShutdownTemperatures" Core..=) Core.<$>
                    skinShutdownTemperatures,
                  ("skinThrottlingTemperatures" Core..=) Core.<$>
...
newHardwareStatus 
    ::  HardwareStatus
newHardwareStatus
  = HardwareStatus{batteryTemperatures = Core.Nothing,
                   cpuTemperatures = Core.Nothing, cpuUsages = Core.Nothing,
                   createTime = Core.Nothing, fanSpeeds = Core.Nothing,
                   gpuTemperatures = Core.Nothing, skinTemperatures = Core.Nothing}
instance Core.FromJSON HardwareStatus where
        parseJSON
          = Core.withObject "HardwareStatus"
              (\ o ->
                 HardwareStatus Core.<$>
                   (o Core..:? "batteryTemperatures") Core.<*>
                     (o Core..:? "cpuTemperatures")
...
newInstallConstraint 
    ::  InstallConstraint
newInstallConstraint
  = InstallConstraint{chargingConstraint = Core.Nothing,
                      deviceIdleConstraint = Core.Nothing,
                      networkTypeConstraint = Core.Nothing}
instance Core.FromJSON InstallConstraint where
        parseJSON
          = Core.withObject "InstallConstraint"
              (\ o ->
                 InstallConstraint Core.<$>
                   (o Core..:? "chargingConstraint") Core.<*>
                     (o Core..:? "deviceIdleConstraint")
...
-- | Internal error details if present for the ADD/ESIM or REMOVE/ESIM command.
--
-- /See:/ 'newInternalErrorDetails' smart constructor.
data InternalErrorDetails = InternalErrorDetails
    {
      -- | Output only. Integer representation of the error code as specified here (https:\/\/developer.android.com\/reference\/android\/telephony\/euicc\/EuiccManager#EXTRA/EMBEDDED/SUBSCRIPTION/DETAILED/CODE). See also, OPERATION/SMDX/SUBJECT/REASON/CODE. See error/code/detail for more details.
      errorCode :: (Core.Maybe Core.Int64)
      -- | Output only. The error code detail corresponding to the error_code.
    , errorCodeDetail :: (Core.Maybe InternalErrorDetails_ErrorCodeDetail)
      -- | Output only. Integer representation of the operation code as specified here (https:\/\/developer.android.com\/reference\/android\/telephony\/euicc\/EuiccManager#EXTRA/EMBEDDED/SUBSCRIPTION/DETAILED/CODE). See operation/code/detail for more details.
    , operationCode :: (Core.Maybe Core.Int64)
      -- | Output only. The operation code detail corresponding to the operation_code.
    , operationCodeDetail :: (Core.Maybe InternalErrorDetails_OperationCodeDetail)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'InternalErrorDetails' with the minimum fields required to make a request.
newInternalErrorDetails 
    ::  InternalErrorDetails
newInternalErrorDetails
  = InternalErrorDetails{errorCode = Core.Nothing,
                         errorCodeDetail = Core.Nothing, operationCode = Core.Nothing,
                         operationCodeDetail = Core.Nothing}
instance Core.FromJSON InternalErrorDetails where
        parseJSON
          = Core.withObject "InternalErrorDetails"
              (\ o ->
                 InternalErrorDetails Core.<$>
                   (o Core..:? "errorCode" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "errorCodeDetail")
                     Core.<*>
                     (o Core..:? "operationCode" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "operationCodeDetail"))

instance Core.ToJSON InternalErrorDetails where
        toJSON InternalErrorDetails{..}
          = Core.object
              (Core.catMaybes
                 [("errorCode" Core..=) Core.. Core.AsText Core.<$> errorCode,
                  ("errorCodeDetail" Core..=) Core.<$> errorCodeDetail,
                  ("operationCode" Core..=) Core.. Core.AsText Core.<$>
                    operationCode,
                  ("operationCodeDetail" Core..=) Core.<$> operationCodeDetail])
...
instance Core.FromJSON IssueCommandResponse where
        parseJSON
          = Core.withObject "IssueCommandResponse"
...
newKeyDestructionEvent 
    ::  KeyDestructionEvent
newKeyDestructionEvent
  = KeyDestructionEvent{applicationUid = Core.Nothing,
                        keyAlias = Core.Nothing, success = Core.Nothing}
instance Core.FromJSON KeyDestructionEvent where
        parseJSON
          = Core.withObject "KeyDestructionEvent"
              (\ o ->
                 KeyDestructionEvent Core.<$>
                   (o Core..:? "applicationUid") Core.<*> (o Core..:? "keyAlias")
                     Core.<*> (o Core..:? "success"))
...
newKeyGeneratedEvent 
    ::  KeyGeneratedEvent
newKeyGeneratedEvent
  = KeyGeneratedEvent{applicationUid = Core.Nothing,
                      keyAlias = Core.Nothing, success = Core.Nothing}
instance Core.FromJSON KeyGeneratedEvent where
        parseJSON
          = Core.withObject "KeyGeneratedEvent"
              (\ o ->
...
newKeyImportEvent 
    ::  KeyImportEvent
newKeyImportEvent
  = KeyImportEvent{applicationUid = Core.Nothing,
                   keyAlias = Core.Nothing, success = Core.Nothing}
instance Core.FromJSON KeyImportEvent where
        parseJSON
          = Core.withObject "KeyImportEvent"
              (\ o ->
                 KeyImportEvent Core.<$>
                   (o Core..:? "applicationUid") Core.<*> (o Core..:? "keyAlias")
                     Core.<*> (o Core..:? "success"))
...
newKeyIntegrityViolationEvent 
    ::  KeyIntegrityViolationEvent
newKeyIntegrityViolationEvent
  = KeyIntegrityViolationEvent{applicationUid = Core.Nothing,
                               keyAlias = Core.Nothing}
instance Core.FromJSON KeyIntegrityViolationEvent where
        parseJSON
          = Core.withObject "KeyIntegrityViolationEvent"
              (\ o ->
...
newKeyedAppState 
    ::  KeyedAppState
newKeyedAppState
  = KeyedAppState{createTime = Core.Nothing, data' = Core.Nothing,
                  key = Core.Nothing, lastUpdateTime = Core.Nothing,
                  message = Core.Nothing, severity = Core.Nothing}
instance Core.FromJSON KeyedAppState where
        parseJSON
          = Core.withObject "KeyedAppState"
              (\ o ->
                 KeyedAppState Core.<$>
...
instance Core.ToJSON KeyedAppState where
        toJSON KeyedAppState{..}
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("data" Core..=) Core.<$> data', ("key" Core..=) Core.<$> key,
...
newKeyguardDismissAuthAttemptEvent 
    :: 
                                   KeyguardDismissAuthAttemptEvent
newKeyguardDismissAuthAttemptEvent
  = KeyguardDismissAuthAttemptEvent{strongAuthMethodUsed =
                                      Core.Nothing,
                                    success = Core.Nothing}
instance Core.FromJSON KeyguardDismissAuthAttemptEvent where
        parseJSON
          = Core.withObject "KeyguardDismissAuthAttemptEvent"
              (\ o ->
                 KeyguardDismissAuthAttemptEvent Core.<$>
                   (o Core..:? "strongAuthMethodUsed") Core.<*>
                     (o Core..:? "success"))
...
instance Core.FromJSON KeyguardDismissedEvent where
        parseJSON
          = Core.withObject "KeyguardDismissedEvent"
...
instance Core.FromJSON KeyguardSecuredEvent where
        parseJSON
          = Core.withObject "KeyguardSecuredEvent"
...
newKioskCustomization 
    ::  KioskCustomization
newKioskCustomization
  = KioskCustomization{deviceSettings = Core.Nothing,
                       powerButtonActions = Core.Nothing, statusBar = Core.Nothing,
                       systemErrorWarnings = Core.Nothing,
                       systemNavigation = Core.Nothing}
instance Core.FromJSON KioskCustomization where
        parseJSON
          = Core.withObject "KioskCustomization"
              (\ o ->
                 KioskCustomization Core.<$>
                   (o Core..:? "deviceSettings") Core.<*>
                     (o Core..:? "powerButtonActions")
...
instance Core.FromJSON LaunchAppAction where
        parseJSON
          = Core.withObject "LaunchAppAction"
          ...
          = Core.withObject "ListDevicesResponse"
              (\ o ->
                 ListDevicesResponse Core.<$>
                   (o Core..:? "devices") Core.<*> (o Core..:? "nextPageToken"))
...
newListEnrollmentTokensResponse 
    ::  ListEnrollmentTokensResponse
newListEnrollmentTokensResponse
  = ListEnrollmentTokensResponse{enrollmentTokens = Core.Nothing,
                                 nextPageToken = Core.Nothing}
instance Core.FromJSON ListEnrollmentTokensResponse where
        parseJSON
          = Core.withObject "ListEnrollmentTokensResponse"
              (\ o ->
                 ListEnrollmentTokensResponse Core.<$>
                   (o Core..:? "enrollmentTokens") Core.<*>
...
newListEnterprisesResponse 
    ::  ListEnterprisesResponse
newListEnterprisesResponse
  = ListEnterprisesResponse{enterprises = Core.Nothing,
                            nextPageToken = Core.Nothing}
instance Core.FromJSON ListEnterprisesResponse where
        parseJSON
          = Core.withObject "ListEnterprisesResponse"
              (\ o ->
                 ListEnterprisesResponse Core.<$>
                   (o Core..:? "enterprises") Core.<*> (o Core..:? "nextPageToken"))
...
newListMigrationTokensResponse 
    ::  ListMigrationTokensResponse
newListMigrationTokensResponse
  = ListMigrationTokensResponse{migrationTokens = Core.Nothing,
                                nextPageToken = Core.Nothing}
instance Core.FromJSON ListMigrationTokensResponse where
        parseJSON
          = Core.withObject "ListMigrationTokensResponse"
              (\ o ->
                 ListMigrationTokensResponse Core.<$>
                   (o Core..:? "migrationTokens") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListPoliciesResponse 
    ::  ListPoliciesResponse
newListPoliciesResponse
  = ListPoliciesResponse{nextPageToken = Core.Nothing,
...
newListWebAppsResponse 
    ::  ListWebAppsResponse
newListWebAppsResponse
  = ListWebAppsResponse{nextPageToken = Core.Nothing,
                        webApps = Core.Nothing}
instance Core.FromJSON ListWebAppsResponse where
        parseJSON
          = Core.withObject "ListWebAppsResponse"
              (\ o ->
                 ListWebAppsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "webApps"))
...
instance Core.FromJSON LogBufferSizeCriticalEvent where
        parseJSON
          = Core.withObject "LogBufferSizeCriticalEvent"
...
instance Core.FromJSON LoggingStartedEvent where
        parseJSON
          = Core.withObject "LoggingStartedEvent"
...
instance Core.FromJSON LoggingStoppedEvent where
        parseJSON
          = Core.withObject "LoggingStoppedEvent"
...
newLostModeLocationEvent 
    ::  LostModeLocationEvent
newLostModeLocationEvent
  = LostModeLocationEvent{batteryLevel = Core.Nothing,
                          location = Core.Nothing}
instance Core.FromJSON LostModeLocationEvent where
        parseJSON
          = Core.withObject "LostModeLocationEvent"
              (\ o ->
                 LostModeLocationEvent Core.<$>
                   (o Core..:? "batteryLevel") Core.<*> (o Core..:? "location"))
...
instance Core.FromJSON LostModeOutgoingPhoneCallEvent where
        parseJSON
          = Core.withObject "LostModeOutgoingPhoneCallEvent"
...
instance Core.FromJSON ManagedConfigurationTemplate where
        parseJSON
          = Core.withObject "ManagedConfigurationTemplate"
              (\ o ->
                 ManagedConfigurationTemplate Core.<$>
                   (o Core..:? "configurationVariables") Core.<*>
                     (o Core..:? "templateId"))
...
instance Core.ToJSON ManagedConfigurationTemplate where
        toJSON ManagedConfigurationTemplate{..}
          = Core.object
              (Core.catMaybes
                 [("configurationVariables" Core..=) Core.<$>
...
newManagedConfigurationTemplate_ConfigurationVariables additional
  = ManagedConfigurationTemplate_ConfigurationVariables{additional =
                                                          additional}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ManagedConfigurationTemplate_ConfigurationVariables"
              (\ o ->
                 ManagedConfigurationTemplate_ConfigurationVariables Core.<$>
                   (Core.parseJSONObject o))
...
newManagedProperty 
    ::  ManagedProperty
newManagedProperty
  = ManagedProperty{defaultValue = Core.Nothing,
                    description = Core.Nothing, entries = Core.Nothing,
                    key = Core.Nothing, nestedProperties = Core.Nothing,
                    title = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON ManagedProperty where
        parseJSON
          = Core.withObject "ManagedProperty"
              (\ o ->
                 ManagedProperty Core.<$>
                   (o Core..:? "defaultValue") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "entries")
                     Core.<*> (o Core..:? "key")
          ...
          = Core.object
              (Core.catMaybes
                 [("defaultValue" Core..=) Core.<$> defaultValue,
                  ("description" Core..=) Core.<$> description,
                  ("entries" Core..=) Core.<$> entries, ("key" Core..=) Core.<$> key,
...
instance Core.FromJSON ManagedPropertyEntry where
        parseJSON
          = Core.withObject "ManagedPropertyEntry"
              (\ o ->
                 ManagedPropertyEntry Core.<$>
...
newMediaMountEvent 
    ::  MediaMountEvent
newMediaMountEvent
  = MediaMountEvent{mountPoint = Core.Nothing,
                    volumeLabel = Core.Nothing}
instance Core.FromJSON MediaMountEvent where
        parseJSON
          = Core.withObject "MediaMountEvent"
              (\ o ->
                 MediaMountEvent Core.<$>
                   (o Core..:? "mountPoint") Core.<*> (o Core..:? "volumeLabel"))
...
newMediaUnmountEvent 
    ::  MediaUnmountEvent
newMediaUnmountEvent
  = MediaUnmountEvent{mountPoint = Core.Nothing,
                      volumeLabel = Core.Nothing}
instance Core.FromJSON MediaUnmountEvent where
        parseJSON
          = Core.withObject "MediaUnmountEvent"
              (\ o ->
...
newMemoryEvent 
    ::  MemoryEvent
newMemoryEvent
  = MemoryEvent{byteCount = Core.Nothing, createTime = Core.Nothing,
                eventType = Core.Nothing}
instance Core.FromJSON MemoryEvent where
        parseJSON
          = Core.withObject "MemoryEvent"
              (\ o ->
                 MemoryEvent Core.<$>
                   (o Core..:? "byteCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "createTime")
...
newMemoryInfo 
    ::  MemoryInfo
newMemoryInfo
  = MemoryInfo{totalInternalStorage = Core.Nothing,
               totalRam = Core.Nothing}
instance Core.FromJSON MemoryInfo where
        parseJSON
          = Core.withObject "MemoryInfo"
              (\ o ->
                 MemoryInfo Core.<$>
                   (o Core..:? "totalInternalStorage" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalRam" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON MemoryInfo where
        toJSON MemoryInfo{..}
          = Core.object
              (Core.catMaybes
                 [("totalInternalStorage" Core..=) Core.. Core.AsText Core.<$>
...
newMigrationToken 
    ::  MigrationToken
newMigrationToken
  = MigrationToken{additionalData = Core.Nothing,
                   createTime = Core.Nothing, device = Core.Nothing,
                   deviceId = Core.Nothing, expireTime = Core.Nothing,
                   managementMode = Core.Nothing, name = Core.Nothing,
                   policy = Core.Nothing, ttl = Core.Nothing, userId = Core.Nothing,
                   value = Core.Nothing}
instance Core.FromJSON MigrationToken where
        parseJSON
          = Core.withObject "MigrationToken"
              (\ o ->
                 MigrationToken Core.<$>
                   (o Core..:? "additionalData") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "device")
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalData" Core..=) Core.<$> additionalData,
                  ...
                  ("managementMode" Core..=) Core.<$> managementMode,
                  ("name" Core..=) Core.<$> name, ("policy" Core..=) Core.<$> policy,
                  ("ttl" Core..=) Core.<$> ttl, ("userId" Core..=) Core.<$> userId,
                  ("value" Core..=) Core.<$> value])


-- | Request to update or create ApplicationPolicy objects in the given Policy.
--
-- /See:/ 'newModifyPolicyApplicationsRequest' smart constructor.
newtype ModifyPolicyApplicationsRequest = ModifyPolicyApplicationsRequest
    {
      -- | Required. The changes to be made to the ApplicationPolicy objects. There must be at least one ApplicationPolicyChange.
      changes :: (Core.Maybe [ApplicationPolicyChange])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ModifyPolicyApplicationsRequest' with the minimum fields required to make a request.
newModifyPolicyApplicationsRequest 
    :: 
                                   ModifyPolicyApplicationsRequest
newModifyPolicyApplicationsRequest
  = ModifyPolicyApplicationsRequest{changes = Core.Nothing}
instance Core.FromJSON ModifyPolicyApplicationsRequest where
        parseJSON
          = Core.withObject "ModifyPolicyApplicationsRequest"
              (\ o ->
                 ModifyPolicyApplicationsRequest Core.<$> (o Core..:? "changes"))

instance Core.ToJSON ModifyPolicyApplicationsRequest where
        toJSON ModifyPolicyApplicationsRequest{..}
          = Core.object
              (Core.catMaybes [("changes" Core..=) Core.<$> changes])


-- | Response to a request to update or create ApplicationPolicy objects in the given policy.
--
-- /See:/ 'newModifyPolicyApplicationsResponse' smart constructor.
newtype ModifyPolicyApplicationsResponse = ModifyPolicyApplicationsResponse
    {
      -- | The updated policy.
...
-- | Creates a value of 'ModifyPolicyApplicationsResponse' with the minimum fields required to make a request.
newModifyPolicyApplicationsResponse 
    :: 
                                    ModifyPolicyApplicationsResponse
newModifyPolicyApplicationsResponse
  = ModifyPolicyApplicationsResponse{policy = Core.Nothing}
instance Core.FromJSON ModifyPolicyApplicationsResponse where
        parseJSON
          = Core.withObject "ModifyPolicyApplicationsResponse"
              (\ o ->
                 ModifyPolicyApplicationsResponse Core.<$> (o Core..:? "policy"))

instance Core.ToJSON ModifyPolicyApplicationsResponse where
        toJSON ModifyPolicyApplicationsResponse{..}
...
newNetworkInfo 
    ::  NetworkInfo
newNetworkInfo
  = NetworkInfo{imei = Core.Nothing, meid = Core.Nothing,
                networkOperatorName = Core.Nothing, telephonyInfos = Core.Nothing,
                wifiMacAddress = Core.Nothing}
instance Core.FromJSON NetworkInfo where
        parseJSON
          = Core.withObject "NetworkInfo"
              (\ o ->
                 NetworkInfo Core.<$>
                   (o Core..:? "imei") Core.<*> (o Core..:? "meid") Core.<*>
                     (o Core..:? "networkOperatorName")
...
instance Core.ToJSON NetworkInfo where
        toJSON NetworkInfo{..}
          = Core.object
              (Core.catMaybes
                 [("imei" Core..=) Core.<$> imei, ("meid" Core..=) Core.<$> meid,
...
newNonComplianceDetail 
    ::  NonComplianceDetail
newNonComplianceDetail
  = NonComplianceDetail{currentValue = Core.Nothing,
                        fieldPath = Core.Nothing, installationFailureReason = Core.Nothing,
                        nonComplianceReason = Core.Nothing, packageName = Core.Nothing,
...
instance Core.FromJSON NonComplianceDetail where
        parseJSON
          = Core.withObject "NonComplianceDetail"
              (\ o ->
                 NonComplianceDetail Core.<$>
                   (o Core..:? "currentValue") Core.<*> (o Core..:? "fieldPath")
          ...
          = Core.object
              (Core.catMaybes
                 [("currentValue" Core..=) Core.<$> currentValue,
                  ...
                  ("installationFailureReason" Core..=) Core.<$>
                    installationFailureReason,
                  ("nonComplianceReason" Core..=) Core.<$> nonComplianceReason,
                  ("packageName" Core..=) Core.<$> packageName,
                  ("settingName" Core..=) Core.<$> settingName,
                  ("specificNonComplianceContext" Core..=) Core.<$>
                    specificNonComplianceContext,
                  ("specificNonComplianceReason" Core..=) Core.<$>
...
newNonComplianceDetailCondition 
    ::  NonComplianceDetailCondition
newNonComplianceDetailCondition
  = NonComplianceDetailCondition{nonComplianceReason = Core.Nothing,
                                 packageName = Core.Nothing, settingName = Core.Nothing}
instance Core.FromJSON NonComplianceDetailCondition where
        parseJSON
          = Core.withObject "NonComplianceDetailCondition"
              (\ o ->
...
newOncCertificateProvider 
    ::  OncCertificateProvider
newOncCertificateProvider
  = OncCertificateProvider{certificateReferences = Core.Nothing,
                           contentProviderEndpoint = Core.Nothing}
instance Core.FromJSON OncCertificateProvider where
        parseJSON
          = Core.withObject "OncCertificateProvider"
              (\ o ->
                 OncCertificateProvider Core.<$>
                   (o Core..:? "certificateReferences") Core.<*>
                     (o Core..:? "contentProviderEndpoint"))
          ...
          = Core.object
              (Core.catMaybes
                 [("certificateReferences" Core..=) Core.<$> certificateReferences,
                  ("contentProviderEndpoint" Core..=) Core.<$>
                    contentProviderEndpoint])
...
instance Core.FromJSON OncWifiContext where
        parseJSON
          = Core.withObject "OncWifiContext"
...
instance Core.FromJSON OsShutdownEvent where
        parseJSON
          = Core.withObject "OsShutdownEvent"
...
newOsStartupEvent 
    ::  OsStartupEvent
newOsStartupEvent
  = OsStartupEvent{verifiedBootState = Core.Nothing,
                   verityMode = Core.Nothing}
instance Core.FromJSON OsStartupEvent where
        parseJSON
          = Core.withObject "OsStartupEvent"
              (\ o ->
                 OsStartupEvent Core.<$>
                   (o Core..:? "verifiedBootState") Core.<*>
                     (o Core..:? "verityMode"))
...
instance Core.FromJSON PackageNameList where
        parseJSON
          = Core.withObject "PackageNameList"
...
instance Core.FromJSON PasswordPoliciesContext where
        parseJSON
          = Core.withObject "PasswordPoliciesContext"
              (\ o ->
                 PasswordPoliciesContext Core.<$>
                   (o Core..:? "passwordPolicyScope"))
...
newPasswordRequirements
  = PasswordRequirements{maximumFailedPasswordsForWipe =
                         ...
                         passwordQuality = Core.Nothing, passwordScope = Core.Nothing,
                         requirePasswordUnlock = Core.Nothing,
                         unifiedLockSettings = Core.Nothing}
instance Core.FromJSON PasswordRequirements where
        parseJSON
          = Core.withObject "PasswordRequirements"
              (\ o ->
                 PasswordRequirements Core.<$>
                   (o Core..:? "maximumFailedPasswordsForWipe") Core.<*>
                     (o Core..:? "passwordExpirationTimeout")
...
instance Core.ToJSON PasswordRequirements where
        toJSON PasswordRequirements{..}
          = Core.object
              (Core.catMaybes
                 [("maximumFailedPasswordsForWipe" Core..=) Core.<$>
                    maximumFailedPasswordsForWipe,
                  ("passwordExpirationTimeout" Core..=) Core.<$>
...
instance Core.FromJSON PermissionGrant where
        parseJSON
          = Core.withObject "PermissionGrant"
              (\ o ->
                 PermissionGrant Core.<$>
                   (o Core..:? "permission") Core.<*> (o Core..:? "policy"))
...
newPersistentPreferredActivity 
    ::  PersistentPreferredActivity
newPersistentPreferredActivity
  = PersistentPreferredActivity{actions = Core.Nothing,
                                categories = Core.Nothing, receiverActivity = Core.Nothing}
instance Core.FromJSON PersistentPreferredActivity where
        parseJSON
          = Core.withObject "PersistentPreferredActivity"
              (\ o ->
                 PersistentPreferredActivity Core.<$>
                   (o Core..:? "actions") Core.<*> (o Core..:? "categories") Core.<*>
                     (o Core..:? "receiverActivity"))
...
newPersonalApplicationPolicy 
    ::  PersonalApplicationPolicy
newPersonalApplicationPolicy
  = PersonalApplicationPolicy{installType = Core.Nothing,
                              packageName = Core.Nothing}
instance Core.FromJSON PersonalApplicationPolicy where
        parseJSON
          = Core.withObject "PersonalApplicationPolicy"
              (\ o ->
                 PersonalApplicationPolicy Core.<$>
                   (o Core..:? "installType") Core.<*> (o Core..:? "packageName"))
...
data PersonalUsagePolicies = PersonalUsagePolicies
    ...
    , bluetoothSharing :: (Core.Maybe PersonalUsagePolicies_BluetoothSharing)
...
newPersonalUsagePolicies
  = PersonalUsagePolicies{accountTypesWithManagementDisabled =
                            Core.Nothing,
                          bluetoothSharing = Core.Nothing, cameraDisabled = Core.Nothing,
...
instance Core.FromJSON PersonalUsagePolicies where
        parseJSON
          = Core.withObject "PersonalUsagePolicies"
              (\ o ->
                 PersonalUsagePolicies Core.<$>
                   (o Core..:? "accountTypesWithManagementDisabled") Core.<*>
                     (o Core..:? "bluetoothSharing")
...
instance Core.ToJSON PersonalUsagePolicies where
        toJSON PersonalUsagePolicies{..}
          = Core.object
              (Core.catMaybes
                 [("accountTypesWithManagementDisabled" Core..=) Core.<$>
...
data Policy = Policy
    ...
    , appFunctions :: (Core.Maybe Policy_AppFunctions)
    ...
    , enterpriseDisplayNameVisibility :: (Core.Maybe Policy_EnterpriseDisplayNameVisibility)
    ...
    , wipeDataFlags :: (Core.Maybe [Policy_WipeDataFlagsItem])
    ...
    , workAccountSetupConfig :: (Core.Maybe WorkAccountSetupConfig)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newPolicy 
    ::  Policy
newPolicy
  = Policy{accountTypesWithManagementDisabled = Core.Nothing,
           ...
           appAutoUpdatePolicy = Core.Nothing, appFunctions = Core.Nothing,
           applications = Core.Nothing, assistContentPolicy = Core.Nothing,
           ...
           bluetoothDisabled = Core.Nothing, cameraAccess = Core.Nothing,
           ...
           deviceRadioState = Core.Nothing, displaySettings = Core.Nothing,
           encryptionPolicy = Core.Nothing,
           ensureVerifyAppsEnabled = Core.Nothing,
           enterpriseDisplayNameVisibility = Core.Nothing,
           factoryResetDisabled = Core.Nothing, frpAdminEmails = Core.Nothing,
           funDisabled = Core.Nothing, installAppsDisabled = Core.Nothing,
           ...
           kioskCustomization = Core.Nothing, locationMode = Core.Nothing,
           longSupportMessage = Core.Nothing,
           maximumTimeToLock = Core.Nothing, microphoneAccess = Core.Nothing,
           minimumApiLevel = Core.Nothing,
           mobileNetworksConfigDisabled = Core.Nothing,
           modifyAccountsDisabled = Core.Nothing,
           mountPhysicalMediaDisabled = Core.Nothing, name = Core.Nothing,
           ...
           personalUsagePolicies = Core.Nothing, playStoreMode = Core.Nothing,
           ...
           removeUserDisabled = Core.Nothing, safeBootDisabled = Core.Nothing,
           screenCaptureDisabled = Core.Nothing,
           setUserIconDisabled = Core.Nothing,
           setWallpaperDisabled = Core.Nothing, setupActions = Core.Nothing,
           shareLocationDisabled = Core.Nothing,
           shortSupportMessage = Core.Nothing,
           skipFirstUseHintsEnabled = Core.Nothing,
           smsDisabled = Core.Nothing, statusBarDisabled = Core.Nothing,
           statusReportingSettings = Core.Nothing,
           stayOnPluggedModes = Core.Nothing, systemUpdate = Core.Nothing,
           tetheringConfigDisabled = Core.Nothing,
           uninstallAppsDisabled = Core.Nothing,
           unmuteMicrophoneDisabled = Core.Nothing, usageLog = Core.Nothing,
           usbFileTransferDisabled = Core.Nothing,
           usbMassStorageEnabled = Core.Nothing, version = Core.Nothing,
           ...
           workAccountSetupConfig = Core.Nothing}
              ...
              (\ o ->
                 Policy Core.<$>
                   (o Core..:? "accountTypesWithManagementDisabled") Core.<*>
                     ...
                     Core.<*> (o Core..:? "enterpriseDisplayNameVisibility")
                     ...
                     Core.<*>
                     (o Core..:? "maximumTimeToLock" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "wipeDataFlags")
                     Core.<*> (o Core..:? "workAccountSetupConfig"))
          ...
          = Core.object
              (Core.catMaybes
                 [("accountTypesWithManagementDisabled" Core..=) Core.<$>
                  ...
                  ("advancedSecurityOverrides" Core..=) Core.<$>
                    advancedSecurityOverrides,
                  ("alwaysOnVpnPackage" Core..=) Core.<$> alwaysOnVpnPackage,
                  ("androidDevicePolicyTracks" Core..=) Core.<$>
                    androidDevicePolicyTracks,
                  ("appAutoUpdatePolicy" Core..=) Core.<$> appAutoUpdatePolicy,
                  ("appFunctions" Core..=) Core.<$> appFunctions,
                  ...
                  ("blockApplicationsEnabled" Core..=) Core.<$>
                    blockApplicationsEnabled,
                  ("bluetoothConfigDisabled" Core..=) Core.<$>
                    bluetoothConfigDisabled,
                  ("bluetoothContactSharingDisabled" Core..=) Core.<$>
                    bluetoothContactSharingDisabled,
                  ("bluetoothDisabled" Core..=) Core.<$> bluetoothDisabled,
                  ("cameraAccess" Core..=) Core.<$> cameraAccess,
                  ("cameraDisabled" Core..=) Core.<$> cameraDisabled,
                  ("cellBroadcastsConfigDisabled" Core..=) Core.<$>
                  ...
                  ("credentialProviderPolicyDefault" Core..=) Core.<$>
                    credentialProviderPolicyDefault,
                  ("credentialsConfigDisabled" Core..=) Core.<$>
                    credentialsConfigDisabled,
                  ("crossProfilePolicies" Core..=) Core.<$> crossProfilePolicies,
                  ("dataRoamingDisabled" Core..=) Core.<$> dataRoamingDisabled,
                  ("debuggingFeaturesAllowed" Core..=) Core.<$>
                    debuggingFeaturesAllowed,
                  ("defaultPermissionPolicy" Core..=) Core.<$>
                    defaultPermissionPolicy,
                  ("deviceConnectivityManagement" Core..=) Core.<$>
                    deviceConnectivityManagement,
                  ("deviceOwnerLockScreenInfo" Core..=) Core.<$>
                  ...
                  ("ensureVerifyAppsEnabled" Core..=) Core.<$>
                    ensureVerifyAppsEnabled,
                  ("enterpriseDisplayNameVisibility" Core..=) Core.<$>
                  ...
                  ("installUnknownSourcesAllowed" Core..=) Core.<$>
                    installUnknownSourcesAllowed,
                  ("keyguardDisabled" Core..=) Core.<$> keyguardDisabled,
                  ("keyguardDisabledFeatures" Core..=) Core.<$>
                    keyguardDisabledFeatures,
                  ("kioskCustomLauncherEnabled" Core..=) Core.<$>
                  ...
                  ("maximumTimeToLock" Core..=) Core.. Core.AsText Core.<$>
                    maximumTimeToLock,
                  ("microphoneAccess" Core..=) Core.<$> microphoneAccess,
                  ("minimumApiLevel" Core..=) Core.<$> minimumApiLevel,
                  ("mobileNetworksConfigDisabled" Core..=) Core.<$>
                    mobileNetworksConfigDisabled,
                  ("modifyAccountsDisabled" Core..=) Core.<$> modifyAccountsDisabled,
                  ("mountPhysicalMediaDisabled" Core..=) Core.<$>
                    mountPhysicalMediaDisabled,
                  ("name" Core..=) Core.<$> name,
                  ("networkEscapeHatchEnabled" Core..=) Core.<$>
                    networkEscapeHatchEnabled,
                  ("networkResetDisabled" Core..=) Core.<$> networkResetDisabled,
                  ("oncCertificateProviders" Core..=) Core.<$>
                    oncCertificateProviders,
                  ("openNetworkConfiguration" Core..=) Core.<$>
                  ...
                  ("permissionGrants" Core..=) Core.<$> permissionGrants,
                  ("permittedAccessibilityServices" Core..=) Core.<$>
                    permittedAccessibilityServices,
                  ("permittedInputMethods" Core..=) Core.<$> permittedInputMethods,
                  ("persistentPreferredActivities" Core..=) Core.<$>
                  ...
                  ("preferentialNetworkService" Core..=) Core.<$>
                    preferentialNetworkService,
                  ("printingPolicy" Core..=) Core.<$> printingPolicy,
                  ("privateKeySelectionEnabled" Core..=) Core.<$>
                  ...
                  ("wifiConfigsLockdownEnabled" Core..=) Core.<$>
                    wifiConfigsLockdownEnabled,
                  ("wipeDataFlags" Core..=) Core.<$> wipeDataFlags,
                  ("workAccountSetupConfig" Core..=) Core.<$>
                    workAccountSetupConfig])
...
instance Core.FromJSON Policy_OpenNetworkConfiguration where
        parseJSON
          = Core.withObject "Policy_OpenNetworkConfiguration"
              (\ o ->
...
newPolicyEnforcementRule 
    ::  PolicyEnforcementRule
newPolicyEnforcementRule
  = PolicyEnforcementRule{blockAction = Core.Nothing,
                          settingName = Core.Nothing, wipeAction = Core.Nothing}
instance Core.FromJSON PolicyEnforcementRule where
        parseJSON
          = Core.withObject "PolicyEnforcementRule"
              (\ o ->
                 PolicyEnforcementRule Core.<$>
                   (o Core..:? "blockAction") Core.<*> (o Core..:? "settingName")
...
instance Core.FromJSON PostureDetail where
        parseJSON
          = Core.withObject "PostureDetail"
              (\ o ->
                 PostureDetail Core.<$>
                   (o Core..:? "advice") Core.<*> (o Core..:? "securityRisk"))
...
newPowerManagementEvent 
    ::  PowerManagementEvent
newPowerManagementEvent
  = PowerManagementEvent{batteryLevel = Core.Nothing,
                         createTime = Core.Nothing, eventType = Core.Nothing}
instance Core.FromJSON PowerManagementEvent where
        parseJSON
          = Core.withObject "PowerManagementEvent"
              (\ o ->
                 PowerManagementEvent Core.<$>
                   (o Core..:? "batteryLevel") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "eventType"))
...
--
-- /See:/ 'newPreferentialNetworkServiceConfig' smart constructor.
data PreferentialNetworkServiceConfig = PreferentialNetworkServiceConfig
    {
      ...
      fallbackToDefaultConnection :: (Core.Maybe
   PreferentialNetworkServiceConfig_FallbackToDefaultConnection)
    ...
    , nonMatchingNetworks :: (Core.Maybe PreferentialNetworkServiceConfig_NonMatchingNetworks)
    ...
    , preferentialNetworkId :: (Core.Maybe PreferentialNetworkServiceConfig_PreferentialNetworkId)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PreferentialNetworkServiceConfig' with the minimum fields required to make a request.
newPreferentialNetworkServiceConfig 
    :: 
                                    PreferentialNetworkServiceConfig
newPreferentialNetworkServiceConfig
  = PreferentialNetworkServiceConfig{fallbackToDefaultConnection =
                                       Core.Nothing,
                                     nonMatchingNetworks = Core.Nothing,
                                     preferentialNetworkId = Core.Nothing}
instance Core.FromJSON PreferentialNetworkServiceConfig where
        parseJSON
          = Core.withObject "PreferentialNetworkServiceConfig"
              (\ o ->
                 PreferentialNetworkServiceConfig Core.<$>
                   (o Core..:? "fallbackToDefaultConnection") Core.<*>
                     (o Core..:? "nonMatchingNetworks")
                     Core.<*> (o Core..:? "preferentialNetworkId"))

instance Core.ToJSON PreferentialNetworkServiceConfig where
        toJSON PreferentialNetworkServiceConfig{..}
          = Core.object
              (Core.catMaybes
                 [("fallbackToDefaultConnection" Core..=) Core.<$>
                    fallbackToDefaultConnection,
                  ("nonMatchingNetworks" Core..=) Core.<$> nonMatchingNetworks,
                  ("preferentialNetworkId" Core..=) Core.<$> preferentialNetworkId])


-- | Preferential network service settings.
--
-- /See:/ 'newPreferentialNetworkServiceSettings' smart constructor.
data PreferentialNetworkServiceSettings = PreferentialNetworkServiceSettings
    {
      ...
      defaultPreferentialNetworkId :: (Core.Maybe
   PreferentialNetworkServiceSettings_DefaultPreferentialNetworkId)
    ...
    , preferentialNetworkServiceConfigs :: (Core.Maybe [PreferentialNetworkServiceConfig])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PreferentialNetworkServiceSettings' with the minimum fields required to make a request.
newPreferentialNetworkServiceSettings 
    :: 
                                      PreferentialNetworkServiceSettings
newPreferentialNetworkServiceSettings
  = PreferentialNetworkServiceSettings{defaultPreferentialNetworkId =
                                         Core.Nothing,
                                       preferentialNetworkServiceConfigs = Core.Nothing}
instance Core.FromJSON PreferentialNetworkServiceSettings where
        parseJSON
          = Core.withObject "PreferentialNetworkServiceSettings"
              (\ o ->
                 PreferentialNetworkServiceSettings Core.<$>
                   (o Core..:? "defaultPreferentialNetworkId") Core.<*>
                     (o Core..:? "preferentialNetworkServiceConfigs"))

instance Core.ToJSON PreferentialNetworkServiceSettings where
        toJSON PreferentialNetworkServiceSettings{..}
          = Core.object
              (Core.catMaybes
                 [("defaultPreferentialNetworkId" Core..=) Core.<$>
                    defaultPreferentialNetworkId,
                  ("preferentialNetworkServiceConfigs" Core..=) Core.<$>
...
newProvisioningInfo 
    ::  ProvisioningInfo
newProvisioningInfo
  = ProvisioningInfo{apiLevel = Core.Nothing,
                     authenticatedUserEmail = Core.Nothing, brand = Core.Nothing,
                     enterprise = Core.Nothing, imei = Core.Nothing,
                     managementMode = Core.Nothing, meid = Core.Nothing,
                     model = Core.Nothing, name = Core.Nothing,
                     ownership = Core.Nothing, serialNumber = Core.Nothing}
instance Core.FromJSON ProvisioningInfo where
        parseJSON
          = Core.withObject "ProvisioningInfo"
              (\ o ->
                 ProvisioningInfo Core.<$>
                   (o Core..:? "apiLevel") Core.<*>
                     (o Core..:? "authenticatedUserEmail")
                     Core.<*> (o Core..:? "brand")
          ...
          = Core.object
              (Core.catMaybes
                 [("apiLevel" Core..=) Core.<$> apiLevel,
                  ...
                  ("imei" Core..=) Core.<$> imei,
                  ("managementMode" Core..=) Core.<$> managementMode,
                  ("meid" Core..=) Core.<$> meid, ("model" Core..=) Core.<$> model,
                  ("name" Core..=) Core.<$> name,
                  ("ownership" Core..=) Core.<$> ownership,
                  ("serialNumber" Core..=) Core.<$> serialNumber])
...
newProxyInfo 
    ::  ProxyInfo
newProxyInfo
  = ProxyInfo{excludedHosts = Core.Nothing, host = Core.Nothing,
              pacUri = Core.Nothing, port = Core.Nothing}
instance Core.FromJSON ProxyInfo where
        parseJSON
          = Core.withObject "ProxyInfo"
              (\ o ->
                 ProxyInfo Core.<$>
                   (o Core..:? "excludedHosts") Core.<*> (o Core..:? "host") Core.<*>
                     (o Core..:? "pacUri")
                     Core.<*> (o Core..:? "port"))
          ...
          = Core.object
              (Core.catMaybes
                 [("excludedHosts" Core..=) Core.<$> excludedHosts,
                  ("host" Core..=) Core.<$> host, ("pacUri" Core..=) Core.<$> pacUri,
                  ("port" Core..=) Core.<$> port])
...
newRemoteLockEvent 
    ::  RemoteLockEvent
newRemoteLockEvent
  = RemoteLockEvent{adminPackageName = Core.Nothing,
                    adminUserId = Core.Nothing, targetUserId = Core.Nothing}
instance Core.FromJSON RemoteLockEvent where
        parseJSON
          = Core.withObject "RemoteLockEvent"
              (\ o ->
                 RemoteLockEvent Core.<$>
                   (o Core..:? "adminPackageName") Core.<*> (o Core..:? "adminUserId")
...
--
-- /See:/ 'newRemoveEsimParams' smart constructor.
newtype RemoveEsimParams = RemoveEsimParams
    {
...
-- | Creates a value of 'RemoveEsimParams' with the minimum fields required to make a request.
newRemoveEsimParams 
    ::  RemoveEsimParams
newRemoveEsimParams = RemoveEsimParams{iccId = Core.Nothing}
instance Core.FromJSON RemoveEsimParams where
        parseJSON
          = Core.withObject "RemoveEsimParams"
              (\ o -> RemoveEsimParams Core.<$> (o Core..:? "iccId"))

instance Core.ToJSON RemoveEsimParams where
        toJSON RemoveEsimParams{..}
          = Core.object (Core.catMaybes [("iccId" Core..=) Core.<$> iccId])


-- | Request to remove ApplicationPolicy objects in the given policy.
--
-- /See:/ 'newRemovePolicyApplicationsRequest' smart constructor.
newtype RemovePolicyApplicationsRequest = RemovePolicyApplicationsRequest
    {
...
-- | Creates a value of 'RemovePolicyApplicationsRequest' with the minimum fields required to make a request.
newRemovePolicyApplicationsRequest 
    :: 
                                   RemovePolicyApplicationsRequest
newRemovePolicyApplicationsRequest
  = RemovePolicyApplicationsRequest{packageNames = Core.Nothing}
instance Core.FromJSON RemovePolicyApplicationsRequest where
        parseJSON
          = Core.withObject "RemovePolicyApplicationsRequest"
              (\ o ->
                 RemovePolicyApplicationsRequest Core.<$>
                   (o Core..:? "packageNames"))

instance Core.ToJSON RemovePolicyApplicationsRequest where
        toJSON RemovePolicyApplicationsRequest{..}
          = Core.object
              (Core.catMaybes [("packageNames" Core..=) Core.<$> packageNames])
...
--
-- /See:/ 'newRemovePolicyApplicationsResponse' smart constructor.
newtype RemovePolicyApplicationsResponse = RemovePolicyApplicationsResponse
    {
...
-- | Creates a value of 'RemovePolicyApplicationsResponse' with the minimum fields required to make a request.
newRemovePolicyApplicationsResponse 
    :: 
                                    RemovePolicyApplicationsResponse
newRemovePolicyApplicationsResponse
  = RemovePolicyApplicationsResponse{policy = Core.Nothing}
instance Core.FromJSON RemovePolicyApplicationsResponse where
        parseJSON
          = Core.withObject "RemovePolicyApplicationsResponse"
              (\ o ->
                 RemovePolicyApplicationsResponse Core.<$> (o Core..:? "policy"))

instance Core.ToJSON RemovePolicyApplicationsResponse where
        toJSON RemovePolicyApplicationsResponse{..}
          = Core.object (Core.catMaybes [("policy" Core..=) Core.<$> policy])


-- | Parameters associated with the REQUEST/DEVICE/INFO command to get device related information.
--
-- /See:/ 'newRequestDeviceInfoParams' smart constructor.
newtype RequestDeviceInfoParams = RequestDeviceInfoParams
    {
      -- | Required. Type of device information to be requested.
      deviceInfo :: (Core.Maybe RequestDeviceInfoParams_DeviceInfo)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RequestDeviceInfoParams' with the minimum fields required to make a request.
newRequestDeviceInfoParams 
    ::  RequestDeviceInfoParams
newRequestDeviceInfoParams
  = RequestDeviceInfoParams{deviceInfo = Core.Nothing}
instance Core.FromJSON RequestDeviceInfoParams where
        parseJSON
          = Core.withObject "RequestDeviceInfoParams"
              (\ o -> RequestDeviceInfoParams Core.<$> (o Core..:? "deviceInfo"))

instance Core.ToJSON RequestDeviceInfoParams where
        toJSON RequestDeviceInfoParams{..}
          = Core.object
              (Core.catMaybes [("deviceInfo" Core..=) Core.<$> deviceInfo])


-- | Status of the REQUEST/DEVICE/INFO command.
--
-- /See:/ 'newRequestDeviceInfoStatus' smart constructor.
data RequestDeviceInfoStatus = RequestDeviceInfoStatus
    {
      -- | Information related to the EIDs of the device.
      eidInfo :: (Core.Maybe EidInfo)
      -- | Output only. Status of a REQUEST/DEVICE/INFO command.
    , status :: (Core.Maybe RequestDeviceInfoStatus_Status)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RequestDeviceInfoStatus' with the minimum fields required to make a request.
newRequestDeviceInfoStatus 
    ::  RequestDeviceInfoStatus
newRequestDeviceInfoStatus
  = RequestDeviceInfoStatus{eidInfo = Core.Nothing,
                            status = Core.Nothing}
instance Core.FromJSON RequestDeviceInfoStatus where
        parseJSON
          = Core.withObject "RequestDeviceInfoStatus"
              (\ o ->
                 RequestDeviceInfoStatus Core.<$>
                   (o Core..:? "eidInfo") Core.<*> (o Core..:? "status"))

instance Core.ToJSON RequestDeviceInfoStatus where
        toJSON RequestDeviceInfoStatus{..}
          = Core.object
              (Core.catMaybes
                 [("eidInfo" Core..=) Core.<$> eidInfo,
                  ("status" Core..=) Core.<$> status])
...
newScreenBrightnessSettings 
    ::  ScreenBrightnessSettings
newScreenBrightnessSettings
  = ScreenBrightnessSettings{screenBrightness = Core.Nothing,
                             screenBrightnessMode = Core.Nothing}
instance Core.FromJSON ScreenBrightnessSettings where
        parseJSON
          = Core.withObject "ScreenBrightnessSettings"
              (\ o ->
                 ScreenBrightnessSettings Core.<$>
                   (o Core..:? "screenBrightness") Core.<*>
                     (o Core..:? "screenBrightnessMode"))
...
newScreenTimeoutSettings 
    ::  ScreenTimeoutSettings
newScreenTimeoutSettings
  = ScreenTimeoutSettings{screenTimeout = Core.Nothing,
                          screenTimeoutMode = Core.Nothing}
instance Core.FromJSON ScreenTimeoutSettings where
        parseJSON
          = Core.withObject "ScreenTimeoutSettings"
              (\ o ->
                 ScreenTimeoutSettings Core.<$>
                   (o Core..:? "screenTimeout") Core.<*>
                     (o Core..:? "screenTimeoutMode"))
...
newSecurityPosture 
    ::  SecurityPosture
newSecurityPosture
  = SecurityPosture{devicePosture = Core.Nothing,
                    postureDetails = Core.Nothing}
instance Core.FromJSON SecurityPosture where
        parseJSON
          = Core.withObject "SecurityPosture"
              (\ o ->
                 SecurityPosture Core.<$>
                   (o Core..:? "devicePosture") Core.<*>
                     (o Core..:? "postureDetails"))
...
newSetupAction 
    ::  SetupAction
newSetupAction
  = SetupAction{description = Core.Nothing, launchApp = Core.Nothing,
                title = Core.Nothing}
instance Core.FromJSON SetupAction where
        parseJSON
          = Core.withObject "SetupAction"
              (\ o ->
                 SetupAction Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "launchApp")
                     Core.<*> (o Core..:? "title"))
...
newSigninDetail 
    ::  SigninDetail
newSigninDetail
  = SigninDetail{allowPersonalUsage = Core.Nothing,
                 defaultStatus = Core.Nothing, qrCode = Core.Nothing,
                 signinEnrollmentToken = Core.Nothing, signinUrl = Core.Nothing,
                 tokenTag = Core.Nothing}
instance Core.FromJSON SigninDetail where
        parseJSON
          = Core.withObject "SigninDetail"
              (\ o ->
                 SigninDetail Core.<$>
                   (o Core..:? "allowPersonalUsage") Core.<*>
                     (o Core..:? "defaultStatus")
                     Core.<*> (o Core..:? "qrCode")
          ...
          = Core.object
              (Core.catMaybes
                 [("androidBuildNumber" Core..=) Core.<$> androidBuildNumber,
                  ...
                  ("androidDevicePolicyVersionCode" Core..=) Core.<$>
                    androidDevicePolicyVersionCode,
                  ("androidDevicePolicyVersionName" Core..=) Core.<$>
...
newSpecificNonComplianceContext 
    ::  SpecificNonComplianceContext
newSpecificNonComplianceContext
  = SpecificNonComplianceContext{oncWifiContext = Core.Nothing,
                                 passwordPoliciesContext = Core.Nothing}
instance Core.FromJSON SpecificNonComplianceContext where
        parseJSON
          = Core.withObject "SpecificNonComplianceContext"
              (\ o ->
                 SpecificNonComplianceContext Core.<$>
                   (o Core..:? "oncWifiContext") Core.<*>
                     (o Core..:? "passwordPoliciesContext"))
          ...
          = Core.object
              (Core.catMaybes
                 [("oncWifiContext" Core..=) Core.<$> oncWifiContext,
                  ("passwordPoliciesContext" Core..=) Core.<$>
                    passwordPoliciesContext])
...
newStartLostModeParams 
    ::  StartLostModeParams
newStartLostModeParams
  = StartLostModeParams{lostEmailAddress = Core.Nothing,
                        lostMessage = Core.Nothing, lostOrganization = Core.Nothing,
                        lostPhoneNumber = Core.Nothing, lostStreetAddress = Core.Nothing}
instance Core.FromJSON StartLostModeParams where
        parseJSON
          = Core.withObject "StartLostModeParams"
              (\ o ->
                 StartLostModeParams Core.<$>
                   (o Core..:? "lostEmailAddress") Core.<*> (o Core..:? "lostMessage")
...
instance Core.FromJSON StartLostModeStatus where
        parseJSON
          = Core.withObject "StartLostModeStatus"
...
instance Core.FromJSON StatusReportingSettings where
        parseJSON
          = Core.withObject "StatusReportingSettings"
              (\ o ->
                 StatusReportingSettings Core.<$>
                   (o Core..:? "applicationReportingSettings") Core.<*>
                     (o Core..:? "applicationReportsEnabled")
...
instance Core.ToJSON StatusReportingSettings where
        toJSON StatusReportingSettings{..}
          = Core.object
              (Core.catMaybes
                 [("applicationReportingSettings" Core..=) Core.<$>
                    applicationReportingSettings,
                  ("applicationReportsEnabled" Core..=) Core.<$>
                    applicationReportsEnabled,
                  ("commonCriteriaModeEnabled" Core..=) Core.<$>
                  ...
                  ("powerManagementEventsEnabled" Core..=) Core.<$>
                    powerManagementEventsEnabled,
                  ("softwareInfoEnabled" Core..=) Core.<$> softwareInfoEnabled,
                  ("systemPropertiesEnabled" Core..=) Core.<$>
...
instance Core.FromJSON StopLostModeParams where
        parseJSON
          = Core.withObject "StopLostModeParams"
...
instance Core.FromJSON StopLostModeStatus where
        parseJSON
          = Core.withObject "StopLostModeStatus"
...
instance Core.FromJSON StopLostModeUserAttemptEvent where
        parseJSON
          = Core.withObject "StopLostModeUserAttemptEvent"
              (\ o ->
...
newSystemUpdate 
    ::  SystemUpdate
newSystemUpdate
  = SystemUpdate{endMinutes = Core.Nothing,
                 freezePeriods = Core.Nothing, startMinutes = Core.Nothing,
                 type' = Core.Nothing}
instance Core.FromJSON SystemUpdate where
        parseJSON
          = Core.withObject "SystemUpdate"
              (\ o ->
                 SystemUpdate Core.<$>
                   (o Core..:? "endMinutes") Core.<*> (o Core..:? "freezePeriods")
...
newSystemUpdateInfo 
    ::  SystemUpdateInfo
newSystemUpdateInfo
  = SystemUpdateInfo{updateReceivedTime = Core.Nothing,
                     updateStatus = Core.Nothing}
instance Core.FromJSON SystemUpdateInfo where
        parseJSON
          = Core.withObject "SystemUpdateInfo"
              (\ o ->
                 SystemUpdateInfo Core.<$>
                   (o Core..:? "updateReceivedTime") Core.<*>
                     (o Core..:? "updateStatus"))
...
data TelephonyInfo = TelephonyInfo
    {
      ...
      activationState :: (Core.Maybe TelephonyInfo_ActivationState)
    ...
    , configMode :: (Core.Maybe TelephonyInfo_ConfigMode)
...
newTelephonyInfo 
    ::  TelephonyInfo
newTelephonyInfo
  = TelephonyInfo{activationState = Core.Nothing,
                  carrierName = Core.Nothing, configMode = Core.Nothing,
                  iccId = Core.Nothing, phoneNumber = Core.Nothing}
instance Core.FromJSON TelephonyInfo where
        parseJSON
          = Core.withObject "TelephonyInfo"
              (\ o ->
                 TelephonyInfo Core.<$>
                   (o Core..:? "activationState") Core.<*> (o Core..:? "carrierName")
                     Core.<*> (o Core..:? "configMode")
                     Core.<*> (o Core..:? "iccId")
          ...
          = Core.object
              (Core.catMaybes
                 [("activationState" Core..=) Core.<$> activationState,
                  ...
                  ("configMode" Core..=) Core.<$> configMode,
...
instance Core.FromJSON TermsAndConditions where
        parseJSON
          = Core.withObject "TermsAndConditions"
              (\ o ->
                 TermsAndConditions Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "header"))
...
newUsageLog 
    ::  UsageLog
newUsageLog
  = UsageLog{enabledLogTypes = Core.Nothing,
             uploadOnCellularAllowed = Core.Nothing}
instance Core.FromJSON UsageLog where
        parseJSON
          = Core.withObject "UsageLog"
              (\ o ->
                 UsageLog Core.<$>
                   (o Core..:? "enabledLogTypes") Core.<*>
                     (o Core..:? "uploadOnCellularAllowed"))
          ...
          = Core.object
              (Core.catMaybes
                 [("enabledLogTypes" Core..=) Core.<$> enabledLogTypes,
                  ("uploadOnCellularAllowed" Core..=) Core.<$>
...
data UsageLogEvent = UsageLogEvent
    ...
    , backupServiceToggledEvent :: (Core.Maybe BackupServiceToggledEvent)
...
newUsageLogEvent 
    ::  UsageLogEvent
newUsageLogEvent
  = UsageLogEvent{adbShellCommandEvent = Core.Nothing,
                  adbShellInteractiveEvent = Core.Nothing,
                  appProcessStartEvent = Core.Nothing,
                  backupServiceToggledEvent = Core.Nothing,
                  ...
                  dnsEvent = Core.Nothing, enrollmentCompleteEvent = Core.Nothing,
                  eventId = Core.Nothing, eventTime = Core.Nothing,
                  eventType = Core.Nothing, filePulledEvent = Core.Nothing,
                  filePushedEvent = Core.Nothing, keyDestructionEvent = Core.Nothing,
                  keyGeneratedEvent = Core.Nothing, keyImportEvent = Core.Nothing,
                  ...
                  mediaMountEvent = Core.Nothing, mediaUnmountEvent = Core.Nothing,
                  osShutdownEvent = Core.Nothing, osStartupEvent = Core.Nothing,
...
instance Core.FromJSON UsageLogEvent where
        parseJSON
          = Core.withObject "UsageLogEvent"
              (\ o ->
                 UsageLogEvent Core.<$>
                   (o Core..:? "adbShellCommandEvent") Core.<*>
                     (o Core..:? "adbShellInteractiveEvent")
                     Core.<*> (o Core..:? "appProcessStartEvent")
                     Core.<*> (o Core..:? "backupServiceToggledEvent")
          ...
          = Core.object
              (Core.catMaybes
                 [("adbShellCommandEvent" Core..=) Core.<$> adbShellCommandEvent,
                  ("adbShellInteractiveEvent" Core..=) Core.<$>
                    adbShellInteractiveEvent,
                  ("appProcessStartEvent" Core..=) Core.<$> appProcessStartEvent,
                  ("backupServiceToggledEvent" Core..=) Core.<$>
                    backupServiceToggledEvent,
                  ("certAuthorityInstalledEvent" Core..=) Core.<$>
                    certAuthorityInstalledEvent,
                  ("certAuthorityRemovedEvent" Core..=) Core.<$>
                    certAuthorityRemovedEvent,
                  ("certValidationFailureEvent" Core..=) Core.<$>
                    certValidationFailureEvent,
                  ("connectEvent" Core..=) Core.<$> connectEvent,
                  ("cryptoSelfTestCompletedEvent" Core..=) Core.<$>
                    cryptoSelfTestCompletedEvent,
                  ("dnsEvent" Core..=) Core.<$> dnsEvent,
                  ("enrollmentCompleteEvent" Core..=) Core.<$>
                    enrollmentCompleteEvent,
                  ...
                  ("keyIntegrityViolationEvent" Core..=) Core.<$>
                    keyIntegrityViolationEvent,
                  ("keyguardDismissAuthAttemptEvent" Core..=) Core.<$>
                    keyguardDismissAuthAttemptEvent,
                  ("keyguardDismissedEvent" Core..=) Core.<$> keyguardDismissedEvent,
                  ("keyguardSecuredEvent" Core..=) Core.<$> keyguardSecuredEvent,
                  ("logBufferSizeCriticalEvent" Core..=) Core.<$>
                    logBufferSizeCriticalEvent,
                  ...
                  ("lostModeOutgoingPhoneCallEvent" Core..=) Core.<$>
                    lostModeOutgoingPhoneCallEvent,
                  ...
                  ("stopLostModeUserAttemptEvent" Core..=) Core.<$>
                    stopLostModeUserAttemptEvent,
...
newUserFacingMessage 
    ::  UserFacingMessage
newUserFacingMessage
  = UserFacingMessage{defaultMessage = Core.Nothing,
                      localizedMessages = Core.Nothing}
instance Core.FromJSON UserFacingMessage where
        parseJSON
          = Core.withObject "UserFacingMessage"
              (\ o ->
                 UserFacingMessage Core.<$>
                   (o Core..:? "defaultMessage") Core.<*>
                     (o Core..:? "localizedMessages"))
...
instance Core.FromJSON UserFacingMessage_LocalizedMessages where
        parseJSON
          = Core.withObject "UserFacingMessage_LocalizedMessages"
              (\ o ->
                 UserFacingMessage_LocalizedMessages Core.<$>
                   (Core.parseJSONObject o))
...
newWebApp 
    ::  WebApp
newWebApp
  = WebApp{displayMode = Core.Nothing, icons = Core.Nothing,
           name = Core.Nothing, startUrl = Core.Nothing, title = Core.Nothing,
           versionCode = Core.Nothing}
instance Core.FromJSON WebApp where
        parseJSON
          = Core.withObject "WebApp"
              (\ o ->
                 WebApp Core.<$>
                   (o Core..:? "displayMode") Core.<*> (o Core..:? "icons") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "startUrl")
                     Core.<*> (o Core..:? "title")
                     Core.<*>
                     (o Core..:? "versionCode" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("displayMode" Core..=) Core.<$> displayMode,
                  ("icons" Core..=) Core.<$> icons, ("name" Core..=) Core.<$> name,
...
newWebToken 
    ::  WebToken
newWebToken
  = WebToken{enabledFeatures = Core.Nothing, name = Core.Nothing,
             parentFrameUrl = Core.Nothing, permissions = Core.Nothing,
             value = Core.Nothing}
instance Core.FromJSON WebToken where
        parseJSON
          = Core.withObject "WebToken"
              (\ o ->
                 WebToken Core.<$>
                   (o Core..:? "enabledFeatures") Core.<*> (o Core..:? "name")
...
instance Core.FromJSON WifiRoamingPolicy where
        parseJSON
          = Core.withObject "WifiRoamingPolicy"
              (\ o ->
...
newWifiRoamingSetting 
    ::  WifiRoamingSetting
newWifiRoamingSetting
  = WifiRoamingSetting{wifiRoamingMode = Core.Nothing,
                       wifiSsid = Core.Nothing}
instance Core.FromJSON WifiRoamingSetting where
        parseJSON
          = Core.withObject "WifiRoamingSetting"
              (\ o ->
                 WifiRoamingSetting Core.<$>
                   (o Core..:? "wifiRoamingMode") Core.<*> (o Core..:? "wifiSsid"))
...
newWifiSsidPolicy 
    ::  WifiSsidPolicy
newWifiSsidPolicy
  = WifiSsidPolicy{wifiSsidPolicyType = Core.Nothing,
                   wifiSsids = Core.Nothing}
instance Core.FromJSON WifiSsidPolicy where
        parseJSON
          = Core.withObject "WifiSsidPolicy"
              (\ o ->
                 WifiSsidPolicy Core.<$>
                   (o Core..:? "wifiSsidPolicyType") Core.<*>
                     (o Core..:? "wifiSsids"))
...
newWipeAction 
    ::  WipeAction
newWipeAction
  = WipeAction{preserveFrp = Core.Nothing,
               wipeAfterDays = Core.Nothing}
instance Core.FromJSON WipeAction where
        parseJSON
          = Core.withObject "WipeAction"
              (\ o ->
                 WipeAction Core.<$>
                   (o Core..:? "preserveFrp") Core.<*> (o Core..:? "wipeAfterDays"))
...
instance Core.FromJSON WipeFailureEvent where
        parseJSON
          = Core.withObject "WipeFailureEvent"
...
--
-- /See:/ 'newWorkAccountSetupConfig' smart constructor.
data WorkAccountSetupConfig = WorkAccountSetupConfig
    {
      -- | Optional. The authentication type of the user on the device.
      authenticationType :: (Core.Maybe WorkAccountSetupConfig_AuthenticationType)
    ...
    , requiredAccountEmail :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'WorkAccountSetupConfig' with the minimum fields required to make a request.
newWorkAccountSetupConfig 
    ::  WorkAccountSetupConfig
newWorkAccountSetupConfig
  = WorkAccountSetupConfig{authenticationType = Core.Nothing,
                           requiredAccountEmail = Core.Nothing}
instance Core.FromJSON WorkAccountSetupConfig where
        parseJSON
          = Core.withObject "WorkAccountSetupConfig"
              (\ o ->
                 WorkAccountSetupConfig Core.<$>
                   (o Core..:? "authenticationType") Core.<*>
                     (o Core..:? "requiredAccountEmail"))

instance Core.ToJSON WorkAccountSetupConfig where
        toJSON WorkAccountSetupConfig{..}
          = Core.object
              (Core.catMaybes
                 [("authenticationType" Core..=) Core.<$> authenticationType,
                  ("requiredAccountEmail" Core..=) Core.<$> requiredAccountEmail])
