...
instance Core.FromJSON AdvancedSecurityOverrides
         where
        parseJSON
...
instance Core.ToJSON AdvancedSecurityOverrides where
        toJSON AdvancedSecurityOverrides{..}
          = Core.object
              (Core.catMaybes
                 [("commonCriteriaMode" Core..=) Core.<$>
                    commonCriteriaMode,
                  ("developerSettings" Core..=) Core.<$>
                    developerSettings,
...
newAlwaysOnVpnPackage =
  AlwaysOnVpnPackage
    {lockdownEnabled = Core.Nothing, packageName = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("accessibleTrackIds" Core..=) Core.<$>
                  ...
                  ("managedConfiguration" Core..=) Core.<$>
                    managedConfiguration,
                  ("managedConfigurationTemplate" Core..=) Core.<$>
                    managedConfigurationTemplate,
                  ("minimumVersionCode" Core..=) Core.<$>
                    minimumVersionCode,
                  ("packageName" Core..=) Core.<$> packageName,
                  ("permissionGrants" Core..=) Core.<$>
                    permissionGrants,
                  ("workProfileWidgets" Core..=) Core.<$>
                    workProfileWidgets])
...
instance Core.ToJSON ApplicationReport where
        toJSON ApplicationReport{..}
          = Core.object
              (Core.catMaybes
                 [("applicationSource" Core..=) Core.<$>
                    applicationSource,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("events" Core..=) Core.<$> events,
                  ("installerPackageName" Core..=) Core.<$>
                    installerPackageName,
                  ("keyedAppStates" Core..=) Core.<$> keyedAppStates,
                  ("packageName" Core..=) Core.<$> packageName,
                  ("packageSha256Hash" Core..=) Core.<$>
                    packageSha256Hash,
...
instance Core.FromJSON ApplicationReportingSettings
         where
        parseJSON
...
instance Core.ToJSON ApplicationReportingSettings
         where
        toJSON ApplicationReportingSettings{..}
          = Core.object
              (Core.catMaybes
                 [("includeRemovedApps" Core..=) Core.<$>
                    includeRemovedApps])
...
newCertAuthorityInstalledEvent =
  CertAuthorityInstalledEvent
    {certificate = Core.Nothing, success = Core.Nothing, userId = Core.Nothing}

instance Core.FromJSON CertAuthorityInstalledEvent
         where
        parseJSON
...
instance Core.ToJSON CertAuthorityInstalledEvent
         where
...
instance Core.FromJSON CertAuthorityRemovedEvent
         where
        parseJSON
...
instance Core.FromJSON CertValidationFailureEvent
         where
        parseJSON
          ...
          = Core.withObject "ChoosePrivateKeyRule"
              (\ o ->
                 ChoosePrivateKeyRule Core.<$>
                   (o Core..:? "packageNames") Core.<*>
                     (o Core..:? "privateKeyAlias")
...
instance Core.FromJSON ClearAppsDataStatus_Results
         where
        parseJSON
          = Core.withObject "ClearAppsDataStatus_Results"
              (\ o ->
                 ClearAppsDataStatus_Results Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ClearAppsDataStatus_Results
         where
...
instance Core.FromJSON Command where
        parseJSON
          = Core.withObject "Command"
              (\ o ->
                 Command Core.<$>
                   (o Core..:? "clearAppsDataParams") Core.<*>
                     (o Core..:? "clearAppsDataStatus")
...
instance Core.ToJSON Command where
        toJSON Command{..}
          = Core.object
              (Core.catMaybes
                 [("clearAppsDataParams" Core..=) Core.<$>
                    clearAppsDataParams,
                  ("clearAppsDataStatus" Core..=) Core.<$>
                    clearAppsDataStatus,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("duration" Core..=) Core.<$> duration,
                  ("errorCode" Core..=) Core.<$> errorCode,
                  ("newPassword" Core..=) Core.<$> newPassword',
                  ("resetPasswordFlags" Core..=) Core.<$>
                    resetPasswordFlags,
                  ("type" Core..=) Core.<$> type',
          ...
          = Core.withObject "CommonCriteriaModeInfo"
              (\ o ->
                 CommonCriteriaModeInfo Core.<$>
                   (o Core..:? "commonCriteriaModeStatus"))
...
instance Core.ToJSON ConnectEvent where
        toJSON ConnectEvent{..}
          = Core.object
              (Core.catMaybes
                 [("destinationIpAddress" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("contactEmail" Core..=) Core.<$> contactEmail,
                  ...
                  ("euRepresentativeEmail" Core..=) Core.<$>
                    euRepresentativeEmail,
                  ("euRepresentativeName" Core..=) Core.<$>
                    euRepresentativeName,
                  ("euRepresentativePhone" Core..=) Core.<$>
          ...
          = Core.withObject "CrossProfilePolicies"
              (\ o ->
                 CrossProfilePolicies Core.<$>
                   (o Core..:? "crossProfileCopyPaste") Core.<*>
                     (o Core..:? "crossProfileDataSharing")
                     Core.<*>
                     (o Core..:? "showWorkContactsInPersonalProfile")
...
instance Core.ToJSON CrossProfilePolicies where
        toJSON CrossProfilePolicies{..}
          = Core.object
              (Core.catMaybes
                 [("crossProfileCopyPaste" Core..=) Core.<$>
...
instance Core.FromJSON CryptoSelfTestCompletedEvent
         where
        parseJSON
...
instance Core.ToJSON CryptoSelfTestCompletedEvent
         where
              ...
              (\ o ->
                 Device Core.<$>
                   (o Core..:? "apiLevel") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "lastPolicyComplianceReportTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("apiLevel" Core..=) Core.<$> apiLevel,
                  ...
                  ("enrollmentTokenData" Core..=) Core.<$>
                    enrollmentTokenData,
                  ("enrollmentTokenName" Core..=) Core.<$>
                    enrollmentTokenName,
                  ("hardwareInfo" Core..=) Core.<$> hardwareInfo,
                  ("hardwareStatusSamples" Core..=) Core.<$>
                    hardwareStatusSamples,
                  ("lastPolicyComplianceReportTime" Core..=) Core.<$>
                    lastPolicyComplianceReportTime,
                  ("lastPolicySyncTime" Core..=) Core.<$>
                    lastPolicySyncTime,
                  ("lastStatusReportTime" Core..=) Core.<$>
...
newtype DeviceConnectivityManagement = DeviceConnectivityManagement
    {
...
newDeviceConnectivityManagement 
    ::  DeviceConnectivityManagement
newDeviceConnectivityManagement =
  DeviceConnectivityManagement {usbDataAccess = Core.Nothing}

instance Core.FromJSON DeviceConnectivityManagement
         where
        parseJSON
          = Core.withObject "DeviceConnectivityManagement"
              (\ o ->
                 DeviceConnectivityManagement Core.<$>
                   (o Core..:? "usbDataAccess"))

instance Core.ToJSON DeviceConnectivityManagement
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("adbEnabled" Core..=) Core.<$> adbEnabled,
                  ...
                  ("unknownSourcesEnabled" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("hostname" Core..=) Core.<$> hostname,
                  ...
                  ("packageName" Core..=) Core.<$> packageName,
                  ("totalIpAddressesReturned" Core..=) Core..
                    Core.AsText
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalData" Core..=) Core.<$> additionalData,
                  ("allowPersonalUsage" Core..=) Core.<$>
                    allowPersonalUsage,
                  ("duration" Core..=) Core.<$> duration,
                  ("expirationTimestamp" Core..=) Core.<$>
                    expirationTimestamp,
                  ("name" Core..=) Core.<$> name,
          ...
          = Core.object
              (Core.catMaybes
                 [("appAutoApprovalEnabled" Core..=) Core.<$>
                  ...
                  ("enterpriseDisplayName" Core..=) Core.<$>
...
instance Core.ToJSON ExtensionConfig where
        toJSON ExtensionConfig{..}
          = Core.object
              (Core.catMaybes
                 [("notificationReceiver" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("batteryShutdownTemperatures" Core..=) Core.<$>
                  ...
                  ("deviceBasebandVersion" Core..=) Core.<$>
                    deviceBasebandVersion,
                  ("enterpriseSpecificId" Core..=) Core.<$>
...
newKeyIntegrityViolationEvent =
  KeyIntegrityViolationEvent
    {applicationUid = Core.Nothing, keyAlias = Core.Nothing}

instance Core.FromJSON KeyIntegrityViolationEvent
         where
        parseJSON
...
newKeyguardDismissAuthAttemptEvent =
  KeyguardDismissAuthAttemptEvent
    {strongAuthMethodUsed = Core.Nothing, success = Core.Nothing}
...
instance Core.ToJSON KeyguardDismissAuthAttemptEvent
         where
        toJSON KeyguardDismissAuthAttemptEvent{..}
          = Core.object
              (Core.catMaybes
                 [("strongAuthMethodUsed" Core..=) Core.<$>
...
instance Core.ToJSON KioskCustomization where
        toJSON KioskCustomization{..}
          = Core.object
              (Core.catMaybes
                 [("deviceSettings" Core..=) Core.<$> deviceSettings,
                  ("powerButtonActions" Core..=) Core.<$>
                    powerButtonActions,
                  ("statusBar" Core..=) Core.<$> statusBar,
                  ("systemErrorWarnings" Core..=) Core.<$>
                    systemErrorWarnings,
                  ("systemNavigation" Core..=) Core.<$>
                    systemNavigation])
...
newListEnrollmentTokensResponse =
  ListEnrollmentTokensResponse
    {enrollmentTokens = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListEnrollmentTokensResponse
         where
        parseJSON
...
instance Core.ToJSON ListEnrollmentTokensResponse
         where
        toJSON ListEnrollmentTokensResponse{..}
          = Core.object
              (Core.catMaybes
                 [("enrollmentTokens" Core..=) Core.<$>
                    enrollmentTokens,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListEnterprisesResponse =
  ListEnterprisesResponse
    {enterprises = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.FromJSON LogBufferSizeCriticalEvent
         where
        parseJSON
...
newManagedConfigurationTemplate =
  ManagedConfigurationTemplate
    {configurationVariables = Core.Nothing, templateId = Core.Nothing}

instance Core.FromJSON ManagedConfigurationTemplate
         where
        parseJSON
...
instance Core.ToJSON ManagedConfigurationTemplate
         where
...
newManagedConfigurationTemplate_ConfigurationVariables additional =
  ManagedConfigurationTemplate_ConfigurationVariables {additional = additional}
...
instance Core.ToJSON MemoryEvent where
        toJSON MemoryEvent{..}
          = Core.object
              (Core.catMaybes
                 [("byteCount" Core..=) Core.. Core.AsText Core.<$>
                    byteCount,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("eventType" Core..=) Core.<$> eventType])
          ...
          = Core.object
              (Core.catMaybes
                 [("totalInternalStorage" Core..=) Core.. Core.AsText
                  ...
                  ("totalRam" Core..=) Core.. Core.AsText Core.<$>
                    totalRam])
...
instance Core.FromJSON NonComplianceDetailCondition
         where
        parseJSON
...
instance Core.ToJSON NonComplianceDetailCondition
         where
...
instance Core.ToJSON OncCertificateProvider where
        toJSON OncCertificateProvider{..}
          = Core.object
              (Core.catMaybes
                 [("certificateReferences" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("maximumFailedPasswordsForWipe" Core..=) Core.<$>
                  ...
                  ("passwordHistoryLength" Core..=) Core.<$>
                    passwordHistoryLength,
                  ("passwordMinimumLength" Core..=) Core.<$>
                    passwordMinimumLength,
                  ("passwordMinimumLetters" Core..=) Core.<$>
                    passwordMinimumLetters,
                  ("passwordMinimumLowerCase" Core..=) Core.<$>
                    passwordMinimumLowerCase,
                  ("passwordMinimumNonLetter" Core..=) Core.<$>
                    passwordMinimumNonLetter,
                  ("passwordMinimumNumeric" Core..=) Core.<$>
                    passwordMinimumNumeric,
                  ("passwordMinimumSymbols" Core..=) Core.<$>
                    passwordMinimumSymbols,
                  ("passwordMinimumUpperCase" Core..=) Core.<$>
                    passwordMinimumUpperCase,
                  ("passwordQuality" Core..=) Core.<$> passwordQuality,
                  ("passwordScope" Core..=) Core.<$> passwordScope,
                  ("requirePasswordUnlock" Core..=) Core.<$>
                    requirePasswordUnlock,
                  ("unifiedLockSettings" Core..=) Core.<$>
                    unifiedLockSettings])
...
instance Core.FromJSON PersistentPreferredActivity
         where
        parseJSON
...
instance Core.ToJSON PersistentPreferredActivity
         where
...
newPersonalApplicationPolicy =
  PersonalApplicationPolicy
    {installType = Core.Nothing, packageName = Core.Nothing}

instance Core.FromJSON PersonalApplicationPolicy
         where
        parseJSON
          = Core.withObject "PersonalApplicationPolicy"
              (\ o ->
                 PersonalApplicationPolicy Core.<$>
                   (o Core..:? "installType") Core.<*>
                     (o Core..:? "packageName"))
          ...
          = Core.withObject "PersonalUsagePolicies"
              (\ o ->
                 PersonalUsagePolicies Core.<$>
                   (o Core..:? "accountTypesWithManagementDisabled")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountTypesWithManagementDisabled" Core..=)
                  ...
                  ("maxDaysWithWorkOff" Core..=) Core.<$>
                    maxDaysWithWorkOff,
                  ("personalApplications" Core..=) Core.<$>
                    personalApplications,
                  ("personalPlayStoreMode" Core..=) Core.<$>
                    personalPlayStoreMode,
                  ("screenCaptureDisabled" Core..=) Core.<$>
              ...
              (\ o ->
                 Policy Core.<$>
                   (o Core..:? "accountTypesWithManagementDisabled")
                     ...
                     Core.<*>
                     (o Core..:? "bluetoothContactSharingDisabled")
                     ...
                     Core.<*> (o Core..:? "permissionGrants")
                     Core.<*>
                     (o Core..:? "permittedAccessibilityServices")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountTypesWithManagementDisabled" Core..=)
                  ...
                  ("adjustVolumeDisabled" Core..=) Core.<$>
                    adjustVolumeDisabled,
                  ("advancedSecurityOverrides" Core..=) Core.<$>
                    advancedSecurityOverrides,
                  ("alwaysOnVpnPackage" Core..=) Core.<$>
                    alwaysOnVpnPackage,
                  ("androidDevicePolicyTracks" Core..=) Core.<$>
                    androidDevicePolicyTracks,
                  ("appAutoUpdatePolicy" Core..=) Core.<$>
                    appAutoUpdatePolicy,
                  ("applications" Core..=) Core.<$> applications,
                  ("autoDateAndTimeZone" Core..=) Core.<$>
                    autoDateAndTimeZone,
                  ("autoTimeRequired" Core..=) Core.<$>
                    autoTimeRequired,
                  ...
                  ("networkResetDisabled" Core..=) Core.<$>
                    networkResetDisabled,
                  ("oncCertificateProviders" Core..=) Core.<$>
                    oncCertificateProviders,
                  ("openNetworkConfiguration" Core..=) Core.<$>
                    openNetworkConfiguration,
                  ("outgoingBeamDisabled" Core..=) Core.<$>
                    outgoingBeamDisabled,
                  ("outgoingCallsDisabled" Core..=) Core.<$>
                    outgoingCallsDisabled,
                  ("passwordPolicies" Core..=) Core.<$>
                    passwordPolicies,
                  ("passwordRequirements" Core..=) Core.<$>
                    passwordRequirements,
                  ("permissionGrants" Core..=) Core.<$>
                    permissionGrants,
                  ("permittedAccessibilityServices" Core..=) Core.<$>
                    permittedAccessibilityServices,
                  ("permittedInputMethods" Core..=) Core.<$>
                    permittedInputMethods,
                  ("persistentPreferredActivities" Core..=) Core.<$>
                    persistentPreferredActivities,
                  ("personalUsagePolicies" Core..=) Core.<$>
                    personalUsagePolicies,
                  ("playStoreMode" Core..=) Core.<$> playStoreMode,
                  ("policyEnforcementRules" Core..=) Core.<$>
                    policyEnforcementRules,
                  ("preferentialNetworkService" Core..=) Core.<$>
                    preferentialNetworkService,
                  ("privateKeySelectionEnabled" Core..=) Core.<$>
                    privateKeySelectionEnabled,
                  ("recommendedGlobalProxy" Core..=) Core.<$>
                    recommendedGlobalProxy,
                  ("removeUserDisabled" Core..=) Core.<$>
                    removeUserDisabled,
                  ("safeBootDisabled" Core..=) Core.<$>
                    safeBootDisabled,
                  ("screenCaptureDisabled" Core..=) Core.<$>
                    screenCaptureDisabled,
                  ("setUserIconDisabled" Core..=) Core.<$>
                    setUserIconDisabled,
                  ("setWallpaperDisabled" Core..=) Core.<$>
                    setWallpaperDisabled,
                  ("setupActions" Core..=) Core.<$> setupActions,
                  ("shareLocationDisabled" Core..=) Core.<$>
                    shareLocationDisabled,
                  ("shortSupportMessage" Core..=) Core.<$>
                    shortSupportMessage,
                  ("skipFirstUseHintsEnabled" Core..=) Core.<$>
                    skipFirstUseHintsEnabled,
                  ("smsDisabled" Core..=) Core.<$> smsDisabled,
                  ("statusBarDisabled" Core..=) Core.<$>
                    statusBarDisabled,
                  ("statusReportingSettings" Core..=) Core.<$>
                    statusReportingSettings,
                  ("stayOnPluggedModes" Core..=) Core.<$>
                    stayOnPluggedModes,
                  ("systemUpdate" Core..=) Core.<$> systemUpdate,
                  ("tetheringConfigDisabled" Core..=) Core.<$>
                    tetheringConfigDisabled,
                  ("uninstallAppsDisabled" Core..=) Core.<$>
                  ...
                  ("usbMassStorageEnabled" Core..=) Core.<$>
                    usbMassStorageEnabled,
                  ("version" Core..=) Core.. Core.AsText Core.<$>
                    version,
                  ("vpnConfigDisabled" Core..=) Core.<$>
                    vpnConfigDisabled,
                  ("wifiConfigDisabled" Core..=) Core.<$>
                    wifiConfigDisabled,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "Policy_OpenNetworkConfiguration"
              (\ o ->
                 Policy_OpenNetworkConfiguration Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Policy_OpenNetworkConfiguration
         where
...
newSetupAction =
  SetupAction
    {description = Core.Nothing, launchApp = Core.Nothing, title = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("allowPersonalUsage" Core..=) Core.<$>
                    allowPersonalUsage,
                  ("qrCode" Core..=) Core.<$> qrCode,
                  ("signinEnrollmentToken" Core..=) Core.<$>
              ...
              (\ o ->
                 SoftwareInfo Core.<$>
                   (o Core..:? "androidBuildNumber") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "androidDevicePolicyVersionCode")
                     Core.<*>
                     (o Core..:? "androidDevicePolicyVersionName")
...
instance Core.ToJSON SoftwareInfo where
        toJSON SoftwareInfo{..}
          = Core.object
              (Core.catMaybes
                 [("androidBuildNumber" Core..=) Core.<$>
                    androidBuildNumber,
                  ("androidBuildTime" Core..=) Core.<$>
                    androidBuildTime,
                  ...
                  ("bootloaderVersion" Core..=) Core.<$>
                    bootloaderVersion,
                  ("deviceBuildSignature" Core..=) Core.<$>
                    deviceBuildSignature,
                  ("deviceKernelVersion" Core..=) Core.<$>
                    deviceKernelVersion,
                  ("primaryLanguageCode" Core..=) Core.<$>
                    primaryLanguageCode,
                  ("securityPatchLevel" Core..=) Core.<$>
                    securityPatchLevel,
                  ("systemUpdateInfo" Core..=) Core.<$>
                    systemUpdateInfo])
...
newSpecificNonComplianceContext =
  SpecificNonComplianceContext
    {oncWifiContext = Core.Nothing, passwordPoliciesContext = Core.Nothing}

instance Core.FromJSON SpecificNonComplianceContext
         where
        parseJSON
...
instance Core.ToJSON SpecificNonComplianceContext
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("applicationReportingSettings" Core..=) Core.<$>
                  ...
                  ("deviceSettingsEnabled" Core..=) Core.<$>
                    deviceSettingsEnabled,
                  ("displayInfoEnabled" Core..=) Core.<$>
                    displayInfoEnabled,
                  ("hardwareStatusEnabled" Core..=) Core.<$>
                    hardwareStatusEnabled,
                  ("memoryInfoEnabled" Core..=) Core.<$>
                    memoryInfoEnabled,
                  ("networkInfoEnabled" Core..=) Core.<$>
                    networkInfoEnabled,
                  ("powerManagementEventsEnabled" Core..=) Core.<$>
                    powerManagementEventsEnabled,
                  ("softwareInfoEnabled" Core..=) Core.<$>
                    softwareInfoEnabled,
...
instance Core.FromJSON SystemUpdate where
        parseJSON
          = Core.withObject "SystemUpdate"
              (\ o ->
                 SystemUpdate Core.<$>
                   (o Core..:? "endMinutes") Core.<*>
                     (o Core..:? "freezePeriods")
...
newSystemUpdateInfo =
  SystemUpdateInfo
    {updateReceivedTime = Core.Nothing, updateStatus = Core.Nothing}
...
newUsageLog =
  UsageLog
    {enabledLogTypes = Core.Nothing, uploadOnCellularAllowed = Core.Nothing}
              ...
              (\ o ->
                 UsageLogEvent Core.<$>
                   (o Core..:? "adbShellCommandEvent") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "keyguardDismissAuthAttemptEvent")
...
instance Core.ToJSON UsageLogEvent where
        toJSON UsageLogEvent{..}
          = Core.object
              (Core.catMaybes
                 [("adbShellCommandEvent" Core..=) Core.<$>
                    adbShellCommandEvent,
                  ("adbShellInteractiveEvent" Core..=) Core.<$>
                    adbShellInteractiveEvent,
                  ("appProcessStartEvent" Core..=) Core.<$>
                    appProcessStartEvent,
                  ...
                  ("keyguardDismissAuthAttemptEvent" Core..=) Core.<$>
                    keyguardDismissAuthAttemptEvent,
                  ("keyguardDismissedEvent" Core..=) Core.<$>
                    keyguardDismissedEvent,
                  ("keyguardSecuredEvent" Core..=) Core.<$>
                    keyguardSecuredEvent,
                  ("logBufferSizeCriticalEvent" Core..=) Core.<$>
                    logBufferSizeCriticalEvent,
                  ("loggingStartedEvent" Core..=) Core.<$>
                    loggingStartedEvent,
                  ("loggingStoppedEvent" Core..=) Core.<$>
                    loggingStoppedEvent,
                  ("mediaMountEvent" Core..=) Core.<$> mediaMountEvent,
                  ("mediaUnmountEvent" Core..=) Core.<$>
                    mediaUnmountEvent,
...
newUserFacingMessage =
  UserFacingMessage
    {defaultMessage = Core.Nothing, localizedMessages = Core.Nothing}
...
instance Core.FromJSON WebApp where
        parseJSON
          = Core.withObject "WebApp"
              (\ o ->
                 WebApp Core.<$>
                   (o Core..:? "displayMode") Core.<*>
                     (o Core..:? "icons")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "startUrl")
                     Core.<*> (o Core..:? "title")
                     Core.<*>
                     (o Core..:? "versionCode" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("displayMode" Core..=) Core.<$> displayMode,
                  ...
                  ("title" Core..=) Core.<$> title,
                  ("versionCode" Core..=) Core.. Core.AsText Core.<$>
                    versionCode])
...
instance Core.FromJSON WipeAction where
        parseJSON
          = Core.withObject "WipeAction"
              (\ o ->
                 WipeAction Core.<$>
                   (o Core..:? "preserveFrp") Core.<*>
                     (o Core..:? "wipeAfterDays"))
