...
-- | Unspecified. Defaults to ALLOW/USB/DATA/TRANSFER, unless usbFileTransferDisabled is set to true. If usbFileTransferDisabled is set to true, this is equivalent to DISALLOW/USB/FILE/TRANSFER.
