...
newAndroidManagementEnterprisesDevicesList parent
  = AndroidManagementEnterprisesDevicesList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            parent = parent, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidManagementEnterprisesDevicesList
         where
        type Rs AndroidManagementEnterprisesDevicesList =
             ListDevicesResponse
        type Scopes AndroidManagementEnterprisesDevicesList =
