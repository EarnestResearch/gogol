...
newAndroidManagementEnterprisesDevicesOperationsList name
  = AndroidManagementEnterprisesDevicesOperationsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesDevicesOperationsList
         where
        type Rs AndroidManagementEnterprisesDevicesOperationsList =
             ListOperationsResponse
        type Scopes AndroidManagementEnterprisesDevicesOperationsList =
             '[Androidmanagement'FullControl]
        requestClient AndroidManagementEnterprisesDevicesOperationsList{..}
