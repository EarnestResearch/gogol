...
newCloudSchedulerProjectsLocationsList name
  = CloudSchedulerProjectsLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudSchedulerProjectsLocationsList
         where
        type Rs CloudSchedulerProjectsLocationsList = ListLocationsResponse
        type Scopes CloudSchedulerProjectsLocationsList =
        ...
        requestClient CloudSchedulerProjectsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSchedulerProjectsLocationsListResource)
                      Core.mempty
