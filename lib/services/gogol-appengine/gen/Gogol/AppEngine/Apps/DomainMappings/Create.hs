...
newAppEngineAppsDomainMappingsCreate appsId payload
  = AppEngineAppsDomainMappingsCreate{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, appsId = appsId,
                                      callback = Core.Nothing, overrideStrategy = Core.Nothing,
...
instance Core.GoogleRequest AppEngineAppsDomainMappingsCreate where
        ...
        requestClient AppEngineAppsDomainMappingsCreate{..}
          = go appsId xgafv accessToken callback overrideStrategy uploadType
              uploadProtocol
