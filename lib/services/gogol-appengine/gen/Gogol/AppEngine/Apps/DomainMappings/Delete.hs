...
newAppEngineAppsDomainMappingsDelete appsId domainMappingsId
  = AppEngineAppsDomainMappingsDelete{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, appsId = appsId,
                                      callback = Core.Nothing, domainMappingsId = domainMappingsId,
...
instance Core.GoogleRequest AppEngineAppsDomainMappingsDelete where
        ...
        requestClient AppEngineAppsDomainMappingsDelete{..}
          = go appsId domainMappingsId xgafv accessToken callback uploadType
              uploadProtocol
