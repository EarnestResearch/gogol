                   ...
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" AppsAuthorizedCertificatesGetView Core.:>
...
newAppEngineAppsAuthorizedCertificatesGet 
    ...
    -> AppEngineAppsAuthorizedCertificatesGet
newAppEngineAppsAuthorizedCertificatesGet appsId
  authorizedCertificatesId
  = AppEngineAppsAuthorizedCertificatesGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, appsId = appsId,
                                           authorizedCertificatesId = authorizedCertificatesId,
                                           callback = Core.Nothing, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing, view = Core.Nothing}
instance Core.GoogleRequest AppEngineAppsAuthorizedCertificatesGet
         where
        ...
        requestClient AppEngineAppsAuthorizedCertificatesGet{..}
          = go appsId authorizedCertificatesId xgafv accessToken callback
              uploadType
              uploadProtocol
              view
