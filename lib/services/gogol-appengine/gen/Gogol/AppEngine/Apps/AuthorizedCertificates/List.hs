                     ...
                     Core.QueryParam "pageToken" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "view" AppsAuthorizedCertificatesListView Core.:>
...
newAppEngineAppsAuthorizedCertificatesList appsId
  = AppEngineAppsAuthorizedCertificatesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AppEngineAppsAuthorizedCertificatesList
         where
        type Rs AppEngineAppsAuthorizedCertificatesList =
             ListAuthorizedCertificatesResponse
        type Scopes AppEngineAppsAuthorizedCertificatesList =
             '[Appengine'Admin, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient AppEngineAppsAuthorizedCertificatesList{..}
          = go appsId xgafv accessToken callback pageSize pageToken
              uploadType
              uploadProtocol
              view
