...
newAppEngineAppsServicesVersionsInstancesDelete 
    ...
    -> AppEngineAppsServicesVersionsInstancesDelete
newAppEngineAppsServicesVersionsInstancesDelete appsId instancesId
  servicesId versionsId
  = AppEngineAppsServicesVersionsInstancesDelete{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AppEngineAppsServicesVersionsInstancesDelete =
