...
newAppEngineAppsServicesVersionsInstancesGet 
    ...
    -> AppEngineAppsServicesVersionsInstancesGet
newAppEngineAppsServicesVersionsInstancesGet appsId instancesId
  servicesId versionsId
  = AppEngineAppsServicesVersionsInstancesGet{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, appsId = appsId,
                                              callback = Core.Nothing, instancesId = instancesId,
                                              servicesId = servicesId, uploadType = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AppEngineAppsServicesVersionsInstancesGet =
