...
newAppEngineAppsServicesPatch appsId payload servicesId
  = AppEngineAppsServicesPatch{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, appsId = appsId,
                               callback = Core.Nothing, migrateTraffic = Core.Nothing,
...
instance Core.GoogleRequest AppEngineAppsServicesPatch where
        ...
        type Scopes AppEngineAppsServicesPatch =
             '[CloudPlatform'FullControl]
        requestClient AppEngineAppsServicesPatch{..}
          = go appsId servicesId xgafv accessToken callback migrateTraffic
              updateMask
              uploadType
              uploadProtocol
