                         ...
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "view" AppsServicesVersionsListView Core.:>
...
newAppEngineAppsServicesVersionsList appsId servicesId
  = AppEngineAppsServicesVersionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AppEngineAppsServicesVersionsList where
        ...
        type Scopes AppEngineAppsServicesVersionsList =
             '[Appengine'Admin, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient AppEngineAppsServicesVersionsList{..}
          = go appsId servicesId xgafv accessToken callback pageSize
              pageToken
              uploadType
              uploadProtocol
              view
