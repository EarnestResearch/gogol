...
newAppEngineAppsServicesVersionsCreate appsId payload servicesId
  = AppEngineAppsServicesVersionsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AppEngineAppsServicesVersionsCreate
         where
        ...
        requestClient AppEngineAppsServicesVersionsCreate{..}
          = go appsId servicesId xgafv accessToken callback uploadType
              uploadProtocol
