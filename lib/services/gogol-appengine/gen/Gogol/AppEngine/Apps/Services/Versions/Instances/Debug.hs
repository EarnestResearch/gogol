             ...
             Core.Capture "servicesId" Core.Text Core.:>
               "versions" Core.:>
                 Core.Capture "versionsId" Core.Text Core.:>
                   "instances" Core.:>
                     Core.CaptureMode "instancesId" "debug" Core.Text Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] DebugInstanceRequest Core.:>
...
newAppEngineAppsServicesVersionsInstancesDebug 
    ...
    -> AppEngineAppsServicesVersionsInstancesDebug
newAppEngineAppsServicesVersionsInstancesDebug appsId instancesId
  payload servicesId versionsId
  = AppEngineAppsServicesVersionsInstancesDebug{xgafv = Core.Nothing,
                                                accessToken = Core.Nothing, appsId = appsId,
                                                callback = Core.Nothing, instancesId = instancesId,
                                                payload = payload, servicesId = servicesId,
...
instance Core.GoogleRequest
        ...
        type Scopes AppEngineAppsServicesVersionsInstancesDebug =
             '[CloudPlatform'FullControl]
        requestClient AppEngineAppsServicesVersionsInstancesDebug{..}
          = go appsId servicesId versionsId instancesId xgafv accessToken
              callback
              uploadType
              uploadProtocol
