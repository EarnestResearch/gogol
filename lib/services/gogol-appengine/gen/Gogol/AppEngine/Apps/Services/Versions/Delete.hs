...
newAppEngineAppsServicesVersionsDelete appsId servicesId versionsId
  = AppEngineAppsServicesVersionsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AppEngineAppsServicesVersionsDelete
         where
        type Rs AppEngineAppsServicesVersionsDelete = Operation
        type Scopes AppEngineAppsServicesVersionsDelete =
