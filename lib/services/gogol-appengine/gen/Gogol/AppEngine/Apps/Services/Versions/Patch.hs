...
newAppEngineAppsServicesVersionsPatch 
    ...
    -> AppEngineAppsServicesVersionsPatch
newAppEngineAppsServicesVersionsPatch appsId payload servicesId
  versionsId
  = AppEngineAppsServicesVersionsPatch{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, appsId = appsId,
                                       callback = Core.Nothing, payload = payload,
                                       servicesId = servicesId, updateMask = Core.Nothing,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                       versionsId = versionsId}
instance Core.GoogleRequest AppEngineAppsServicesVersionsPatch
         where
        type Rs AppEngineAppsServicesVersionsPatch = Operation
        type Scopes AppEngineAppsServicesVersionsPatch =
