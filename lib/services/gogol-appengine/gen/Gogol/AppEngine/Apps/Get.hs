           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "includeExtraData" AppsGetIncludeExtraData Core.:>
...
newAppEngineAppsGet appsId
  = AppEngineAppsGet{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, appsId = appsId,
                     callback = Core.Nothing, includeExtraData = Core.Nothing,
...
instance Core.GoogleRequest AppEngineAppsGet where
        ...
        type Scopes AppEngineAppsGet =
             '[Appengine'Admin, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient AppEngineAppsGet{..}
          = go appsId xgafv accessToken callback includeExtraData uploadType
              uploadProtocol
