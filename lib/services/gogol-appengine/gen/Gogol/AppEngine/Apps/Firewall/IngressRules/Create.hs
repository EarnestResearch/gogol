                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] FirewallRule Core.:>
                             Core.Post '[Core.JSON] FirewallRule
...
newAppEngineAppsFirewallIngressRulesCreate appsId payload
  = AppEngineAppsFirewallIngressRulesCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, appsId = appsId,
                                            callback = Core.Nothing, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AppEngineAppsFirewallIngressRulesCreate
         where
        type Rs AppEngineAppsFirewallIngressRulesCreate = FirewallRule
        type Scopes AppEngineAppsFirewallIngressRulesCreate =
             '[CloudPlatform'FullControl]
        requestClient AppEngineAppsFirewallIngressRulesCreate{..}
          = go appsId xgafv accessToken callback uploadType uploadProtocol
