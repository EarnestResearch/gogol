...
newAppEngineProjectsLocationsApplicationsServicesDelete
  ...
  = AppEngineProjectsLocationsApplicationsServicesDelete{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           AppEngineProjectsLocationsApplicationsServicesDelete
         where
        type Rs AppEngineProjectsLocationsApplicationsServicesDelete =
             Operation
        type Scopes AppEngineProjectsLocationsApplicationsServicesDelete =
