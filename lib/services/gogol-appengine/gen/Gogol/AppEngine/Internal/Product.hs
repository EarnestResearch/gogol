...
newApiEndpointHandler 
    ::  ApiEndpointHandler
newApiEndpointHandler = ApiEndpointHandler {scriptPath = Core.Nothing}

instance Core.FromJSON ApiEndpointHandler where
        parseJSON
          = Core.withObject "ApiEndpointHandler"
              (\ o ->
                 ApiEndpointHandler Core.<$>
                   (o Core..:? "scriptPath"))
...
instance Core.ToJSON ApiEndpointHandler where
        toJSON ApiEndpointHandler{..}
          = Core.object
              (Core.catMaybes
                 [("scriptPath" Core..=) Core.<$> scriptPath])
...
instance Core.ToJSON AuthorizedCertificate where
        toJSON AuthorizedCertificate{..}
          = Core.object
              (Core.catMaybes
                 [("certificateRawData" Core..=) Core.<$>
                    certificateRawData,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("domainMappingsCount" Core..=) Core.<$>
                    domainMappingsCount,
                  ("domainNames" Core..=) Core.<$> domainNames,
                  ("expireTime" Core..=) Core.<$> expireTime,
                  ("id" Core..=) Core.<$> id,
                  ("managedCertificate" Core..=) Core.<$>
                    managedCertificate,
                  ("name" Core..=) Core.<$> name,
                  ("visibleDomainMappings" Core..=) Core.<$>
...
newAuthorizedDomain 
    ::  AuthorizedDomain
newAuthorizedDomain = AuthorizedDomain {id = Core.Nothing, name = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("coolDownPeriod" Core..=) Core.<$> coolDownPeriod,
                  ...
                  ("maxConcurrentRequests" Core..=) Core.<$>
                    maxConcurrentRequests,
                  ("maxIdleInstances" Core..=) Core.<$>
                    maxIdleInstances,
                  ("maxPendingLatency" Core..=) Core.<$>
                    maxPendingLatency,
                  ("maxTotalInstances" Core..=) Core.<$>
                    maxTotalInstances,
                  ("minIdleInstances" Core..=) Core.<$>
                    minIdleInstances,
                  ("minPendingLatency" Core..=) Core.<$>
                    minPendingLatency,
                  ("minTotalInstances" Core..=) Core.<$>
                    minTotalInstances,
                  ("networkUtilization" Core..=) Core.<$>
                    networkUtilization,
                  ("requestUtilization" Core..=) Core.<$>
                    requestUtilization,
...
newBasicScaling 
    ::  BasicScaling
newBasicScaling =
  BasicScaling {idleTimeout = Core.Nothing, maxInstances = Core.Nothing}
...
instance Core.FromJSON BatchUpdateIngressRulesRequest
         where
        parseJSON
...
instance Core.ToJSON BatchUpdateIngressRulesRequest
         where
...
instance Core.ToJSON BatchUpdateIngressRulesResponse
         where
...
newCertificateRawData =
  CertificateRawData
    {privateKey = Core.Nothing, publicCertificate = Core.Nothing}
...
newCloudBuildOptions =
  CloudBuildOptions
    {appYamlPath = Core.Nothing, cloudBuildTimeout = Core.Nothing}
...
newCpuUtilization =
  CpuUtilization
    {aggregationWindowLength = Core.Nothing, targetUtilization = Core.Nothing}
...
instance Core.ToJSON CreateVersionMetadataV1 where
        toJSON CreateVersionMetadataV1{..}
          = Core.object
              (Core.catMaybes
                 [("cloudBuildId" Core..=) Core.<$> cloudBuildId])
...
instance Core.FromJSON CreateVersionMetadataV1Alpha
         where
        parseJSON
          = Core.withObject "CreateVersionMetadataV1Alpha"
              (\ o ->
                 CreateVersionMetadataV1Alpha Core.<$>
                   (o Core..:? "cloudBuildId"))

instance Core.ToJSON CreateVersionMetadataV1Alpha
         where
...
instance Core.FromJSON CreateVersionMetadataV1Beta
         where
        parseJSON
          = Core.withObject "CreateVersionMetadataV1Beta"
              (\ o ->
                 CreateVersionMetadataV1Beta Core.<$>
                   (o Core..:? "cloudBuildId"))

instance Core.ToJSON CreateVersionMetadataV1Beta
         where
...
newDeployment_Files 
    ::  Core.HashMap Core.Text FileInfo
       -- ^  See 'additional'.
    -> Deployment_Files
newDeployment_Files additional = Deployment_Files {additional = additional}

instance Core.FromJSON Deployment_Files where
        parseJSON
          = Core.withObject "Deployment_Files"
              (\ o ->
                 Deployment_Files Core.<$> (Core.parseJSONObject o))
          ...
          = Core.object
              (Core.catMaybes
                 [("targetReadBytesPerSecond" Core..=) Core.<$>
                  ...
                  ("targetReadOpsPerSecond" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("configId" Core..=) Core.<$> configId,
                  ("disableTraceSampling" Core..=) Core.<$>
                    disableTraceSampling,
                  ("name" Core..=) Core.<$> name,
                  ("rolloutStrategy" Core..=) Core.<$>
                    rolloutStrategy])
...
instance Core.ToJSON Entrypoint where
        toJSON Entrypoint{..}
          = Core.object
              (Core.catMaybes [("shell" Core..=) Core.<$> shell])
...
newFeatureSettings =
  FeatureSettings
    {splitHealthChecks = Core.Nothing, useContainerOptimizedOs = Core.Nothing}
...
newFileInfo =
  FileInfo
    {mimeType = Core.Nothing, sha1Sum = Core.Nothing, sourceUrl = Core.Nothing}
...
newFlexibleRuntimeSettings =
  FlexibleRuntimeSettings
    {operatingSystem = Core.Nothing, runtimeVersion = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("checkInterval" Core..=) Core.<$> checkInterval,
                  ("disableHealthCheck" Core..=) Core.<$>
                    disableHealthCheck,
                  ("healthyThreshold" Core..=) Core.<$>
                    healthyThreshold,
                  ("host" Core..=) Core.<$> host,
                  ("restartThreshold" Core..=) Core.<$>
                    restartThreshold,
                  ("timeout" Core..=) Core.<$> timeout,
                  ("unhealthyThreshold" Core..=) Core.<$>
                    unhealthyThreshold])
...
newListAuthorizedCertificatesResponse =
  ListAuthorizedCertificatesResponse
    {certificates = Core.Nothing, nextPageToken = Core.Nothing}
...
newListAuthorizedDomainsResponse =
  ListAuthorizedDomainsResponse
    {domains = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListAuthorizedDomainsResponse
         where
        parseJSON
...
instance Core.ToJSON ListAuthorizedDomainsResponse
         where
...
newListDomainMappingsResponse =
  ListDomainMappingsResponse
    {domainMappings = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListDomainMappingsResponse
         where
        parseJSON
...
newListIngressRulesResponse =
  ListIngressRulesResponse
    {ingressRules = Core.Nothing, nextPageToken = Core.Nothing}
...
newListInstancesResponse 
    ::  ListInstancesResponse
newListInstancesResponse =
  ListInstancesResponse {instances = Core.Nothing, nextPageToken = Core.Nothing}
...
newManagedCertificate 
    ::  ManagedCertificate
newManagedCertificate =
  ManagedCertificate {lastRenewalTime = Core.Nothing, status = Core.Nothing}
...
instance Core.FromJSON ManualScaling where
        parseJSON
          = Core.withObject "ManualScaling"
              (\ o ->
                 ManualScaling Core.<$> (o Core..:? "instances"))
...
newNetworkSettings 
    ::  NetworkSettings
newNetworkSettings = NetworkSettings {ingressTrafficAllowed = Core.Nothing}

instance Core.FromJSON NetworkSettings where
        parseJSON
          = Core.withObject "NetworkSettings"
              (\ o ->
                 NetworkSettings Core.<$>
                   (o Core..:? "ingressTrafficAllowed"))

instance Core.ToJSON NetworkSettings where
        toJSON NetworkSettings{..}
          = Core.object
              (Core.catMaybes
                 [("ingressTrafficAllowed" Core..=) Core.<$>
...
instance Core.ToJSON OperationMetadataV1 where
        toJSON OperationMetadataV1{..}
          = Core.object
              (Core.catMaybes
                 [("createVersionMetadata" Core..=) Core.<$>
                    createVersionMetadata,
                  ("endTime" Core..=) Core.<$> endTime,
                  ("ephemeralMessage" Core..=) Core.<$>
                    ephemeralMessage,
...
instance Core.FromJSON ProjectEvent where
        parseJSON
          = Core.withObject "ProjectEvent"
              (\ o ->
                 ProjectEvent Core.<$>
                   (o Core..:? "eventId") Core.<*> (o Core..:? "phase")
...
instance Core.FromJSON Reasons where
        parseJSON
          = Core.withObject "Reasons"
              (\ o ->
                 Reasons Core.<$>
                   (o Core..:? "abuse") Core.<*> (o Core..:? "billing")
...
newResourceRecord =
  ResourceRecord
    {name = Core.Nothing, rrdata = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON ResourceRecord where
        parseJSON
          = Core.withObject "ResourceRecord"
              (\ o ->
                 ResourceRecord Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "rrdata")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON ScriptHandler where
        parseJSON
          = Core.withObject "ScriptHandler"
              (\ o ->
                 ScriptHandler Core.<$> (o Core..:? "scriptPath"))
...
newService_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Service_Labels
newService_Labels additional = Service_Labels {additional = additional}

instance Core.FromJSON Service_Labels where
        parseJSON
          = Core.withObject "Service_Labels"
              (\ o ->
                 Service_Labels Core.<$> (Core.parseJSONObject o))
...
instance Core.FromJSON StandardSchedulerSettings
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("maxInstances" Core..=) Core.<$> maxInstances,
                  ...
                  ("targetCpuUtilization" Core..=) Core.<$>
...
instance Core.ToJSON StaticFilesHandler where
        toJSON StaticFilesHandler{..}
          = Core.object
              (Core.catMaybes
                 [("applicationReadable" Core..=) Core.<$>
                    applicationReadable,
                  ("expiration" Core..=) Core.<$> expiration,
                  ("httpHeaders" Core..=) Core.<$> httpHeaders,
                  ("mimeType" Core..=) Core.<$> mimeType,
                  ("path" Core..=) Core.<$> path,
                  ("requireMatchingFile" Core..=) Core.<$>
                    requireMatchingFile,
                  ("uploadPathRegex" Core..=) Core.<$>
                    uploadPathRegex])
...
instance Core.FromJSON StaticFilesHandler_HttpHeaders
         where
        parseJSON
          = Core.withObject "StaticFilesHandler_HttpHeaders"
              (\ o ->
                 StaticFilesHandler_HttpHeaders Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON StaticFilesHandler_HttpHeaders
         where
        toJSON StaticFilesHandler_HttpHeaders{..}
          = Core.toJSON additional
...
instance Core.FromJSON TrafficSplit_Allocations where
        parseJSON
          = Core.withObject "TrafficSplit_Allocations"
              (\ o ->
                 TrafficSplit_Allocations Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON TrafficSplit_Allocations where
        toJSON TrafficSplit_Allocations{..}
          = Core.toJSON additional
...
newUrlDispatchRule =
  UrlDispatchRule
    {domain = Core.Nothing, path = Core.Nothing, service = Core.Nothing}
          ...
          = Core.withObject "UrlDispatchRule"
              (\ o ->
                 UrlDispatchRule Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "path")
                     Core.<*> (o Core..:? "service"))
...
instance Core.FromJSON UrlMap where
        parseJSON
          = Core.withObject "UrlMap"
              (\ o ->
                 UrlMap Core.<$>
                   (o Core..:? "apiEndpoint") Core.<*>
                     (o Core..:? "authFailAction")
                     Core.<*> (o Core..:? "login")
...
instance Core.FromJSON Version where
        parseJSON
          = Core.withObject "Version"
              (\ o ->
                 Version Core.<$>
                   (o Core..:? "apiConfig") Core.<*>
                     (o Core..:? "appEngineApis")
          ...
          = Core.object
              (Core.catMaybes
                 [("apiConfig" Core..=) Core.<$> apiConfig,
                  ...
                  ("automaticScaling" Core..=) Core.<$>
                    automaticScaling,
                  ("basicScaling" Core..=) Core.<$> basicScaling,
                  ("betaSettings" Core..=) Core.<$> betaSettings,
                  ("buildEnvVariables" Core..=) Core.<$>
                    buildEnvVariables,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("createdBy" Core..=) Core.<$> createdBy,
                  ("defaultExpiration" Core..=) Core.<$>
                    defaultExpiration,
                  ("deployment" Core..=) Core.<$> deployment,
                  ("diskUsageBytes" Core..=) Core.. Core.AsText
                    Core.<$> diskUsageBytes,
                  ("endpointsApiService" Core..=) Core.<$>
                    endpointsApiService,
...
instance Core.FromJSON Version_BetaSettings where
        parseJSON
          = Core.withObject "Version_BetaSettings"
              (\ o ->
                 Version_BetaSettings Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Version_BetaSettings where
        toJSON Version_BetaSettings{..}
          = Core.toJSON additional
...
instance Core.FromJSON Version_BuildEnvVariables
         where
        parseJSON
          = Core.withObject "Version_BuildEnvVariables"
              (\ o ->
                 Version_BuildEnvVariables Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Version_BuildEnvVariables where
        toJSON Version_BuildEnvVariables{..}
          = Core.toJSON additional
...
instance Core.FromJSON Version_EnvVariables where
        parseJSON
          = Core.withObject "Version_EnvVariables"
              (\ o ->
                 Version_EnvVariables Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Version_EnvVariables where
        toJSON Version_EnvVariables{..}
          = Core.toJSON additional
...
newVolume 
    ::  Volume
newVolume =
  Volume {name = Core.Nothing, sizeGb = Core.Nothing, volumeType = Core.Nothing}
...
instance Core.FromJSON Volume where
        parseJSON
          = Core.withObject "Volume"
              (\ o ->
                 Volume Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "sizeGb")
...
newVpcAccessConnector 
    ::  VpcAccessConnector
newVpcAccessConnector =
  VpcAccessConnector {egressSetting = Core.Nothing, name = Core.Nothing}
...
newZipInfo 
    ::  ZipInfo
newZipInfo = ZipInfo {filesCount = Core.Nothing, sourceUrl = Core.Nothing}
