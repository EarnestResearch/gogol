...
newApiConfigHandler 
    ::  ApiConfigHandler
newApiConfigHandler
  = ApiConfigHandler{authFailAction = Core.Nothing,
                     login = Core.Nothing, script = Core.Nothing,
                     securityLevel = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON ApiConfigHandler where
        parseJSON
          = Core.withObject "ApiConfigHandler"
              (\ o ->
                 ApiConfigHandler Core.<$>
                   (o Core..:? "authFailAction") Core.<*> (o Core..:? "login")
                     Core.<*> (o Core..:? "script")
...
instance Core.FromJSON ApiEndpointHandler where
        parseJSON
          = Core.withObject "ApiEndpointHandler"
...
newApplication 
    ::  Application
newApplication
  = Application{authDomain = Core.Nothing, codeBucket = Core.Nothing,
                databaseType = Core.Nothing, defaultBucket = Core.Nothing,
                defaultCookieExpiration = Core.Nothing,
                defaultHostname = Core.Nothing, dispatchRules = Core.Nothing,
                featureSettings = Core.Nothing, gcrDomain = Core.Nothing,
                generatedCustomerMetadata = Core.Nothing, iap = Core.Nothing,
                id = Core.Nothing, locationId = Core.Nothing, name = Core.Nothing,
                serviceAccount = Core.Nothing, servingStatus = Core.Nothing,
...
instance Core.FromJSON Application where
        parseJSON
          = Core.withObject "Application"
              (\ o ->
                 Application Core.<$>
                   (o Core..:? "authDomain") Core.<*> (o Core..:? "codeBucket")
          ...
          = Core.object
              (Core.catMaybes
                 [("authDomain" Core..=) Core.<$> authDomain,
                  ...
                  ("defaultCookieExpiration" Core..=) Core.<$>
                  ...
                  ("generatedCustomerMetadata" Core..=) Core.<$>
                    generatedCustomerMetadata,
                  ("iap" Core..=) Core.<$> iap, ("id" Core..=) Core.<$> id,
...
instance Core.FromJSON Application_GeneratedCustomerMetadata where
        parseJSON
          = Core.withObject "Application_GeneratedCustomerMetadata"
              (\ o ->
                 Application_GeneratedCustomerMetadata Core.<$>
...
newAuthorizedCertificate 
    ::  AuthorizedCertificate
newAuthorizedCertificate
  = AuthorizedCertificate{certificateRawData = Core.Nothing,
                          displayName = Core.Nothing, domainMappingsCount = Core.Nothing,
                          domainNames = Core.Nothing, expireTime = Core.Nothing,
                          id = Core.Nothing, managedCertificate = Core.Nothing,
                          name = Core.Nothing, visibleDomainMappings = Core.Nothing}
instance Core.FromJSON AuthorizedCertificate where
        parseJSON
          = Core.withObject "AuthorizedCertificate"
              (\ o ->
                 AuthorizedCertificate Core.<$>
                   (o Core..:? "certificateRawData") Core.<*>
                     (o Core..:? "displayName")
...
instance Core.FromJSON AuthorizedDomain where
        parseJSON
          = Core.withObject "AuthorizedDomain"
              (\ o ->
                 AuthorizedDomain Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "name"))
...
newAutomaticScaling 
    ::  AutomaticScaling
newAutomaticScaling
  = AutomaticScaling{coolDownPeriod = Core.Nothing,
                     cpuUtilization = Core.Nothing, diskUtilization = Core.Nothing,
                     maxConcurrentRequests = Core.Nothing,
                     maxIdleInstances = Core.Nothing, maxPendingLatency = Core.Nothing,
                     maxTotalInstances = Core.Nothing, minIdleInstances = Core.Nothing,
                     minPendingLatency = Core.Nothing, minTotalInstances = Core.Nothing,
...
instance Core.FromJSON AutomaticScaling where
        parseJSON
          = Core.withObject "AutomaticScaling"
              (\ o ->
                 AutomaticScaling Core.<$>
                   (o Core..:? "coolDownPeriod") Core.<*>
                     (o Core..:? "cpuUtilization")
          ...
          = Core.object
              (Core.catMaybes
                 [("coolDownPeriod" Core..=) Core.<$> coolDownPeriod,
                  ...
                  ("standardSchedulerSettings" Core..=) Core.<$>
                    standardSchedulerSettings])
...
newBasicScaling 
    ::  BasicScaling
newBasicScaling
  = BasicScaling{idleTimeout = Core.Nothing,
                 maxInstances = Core.Nothing}
instance Core.FromJSON BasicScaling where
        parseJSON
          = Core.withObject "BasicScaling"
              (\ o ->
                 BasicScaling Core.<$>
                   (o Core..:? "idleTimeout") Core.<*> (o Core..:? "maxInstances"))
...
instance Core.FromJSON BatchUpdateIngressRulesRequest where
        parseJSON
          = Core.withObject "BatchUpdateIngressRulesRequest"
              (\ o ->
                 BatchUpdateIngressRulesRequest Core.<$>
                   (o Core..:? "ingressRules"))
...
instance Core.FromJSON BatchUpdateIngressRulesResponse where
        parseJSON
          = Core.withObject "BatchUpdateIngressRulesResponse"
              (\ o ->
                 BatchUpdateIngressRulesResponse Core.<$>
                   (o Core..:? "ingressRules"))
...
newCertificateRawData 
    ::  CertificateRawData
newCertificateRawData
  = CertificateRawData{privateKey = Core.Nothing,
                       publicCertificate = Core.Nothing}
instance Core.FromJSON CertificateRawData where
        parseJSON
          = Core.withObject "CertificateRawData"
              (\ o ->
                 CertificateRawData Core.<$>
                   (o Core..:? "privateKey") Core.<*>
                     (o Core..:? "publicCertificate"))
...
newCloudBuildOptions 
    ::  CloudBuildOptions
newCloudBuildOptions
  = CloudBuildOptions{appYamlPath = Core.Nothing,
                      cloudBuildTimeout = Core.Nothing}
instance Core.FromJSON CloudBuildOptions where
        parseJSON
          = Core.withObject "CloudBuildOptions"
              (\ o ->
                 CloudBuildOptions Core.<$>
                   (o Core..:? "appYamlPath") Core.<*>
                     (o Core..:? "cloudBuildTimeout"))
...
newContainerState 
    ::  ContainerState
newContainerState
  = ContainerState{currentReasons = Core.Nothing,
                   previousReasons = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON ContainerState where
        parseJSON
          = Core.withObject "ContainerState"
              (\ o ->
                 ContainerState Core.<$>
                   (o Core..:? "currentReasons") Core.<*>
                     (o Core..:? "previousReasons")
                     Core.<*> (o Core..:? "state"))
...
newCpuUtilization 
    ::  CpuUtilization
newCpuUtilization
  = CpuUtilization{aggregationWindowLength = Core.Nothing,
                   targetUtilization = Core.Nothing}
instance Core.FromJSON CpuUtilization where
        parseJSON
          = Core.withObject "CpuUtilization"
              (\ o ->
                 CpuUtilization Core.<$>
                   (o Core..:? "aggregationWindowLength") Core.<*>
                     (o Core..:? "targetUtilization"))

instance Core.ToJSON CpuUtilization where
        toJSON CpuUtilization{..}
          = Core.object
              (Core.catMaybes
                 [("aggregationWindowLength" Core..=) Core.<$>
...
instance Core.FromJSON CreateVersionMetadataV1 where
        parseJSON
          = Core.withObject "CreateVersionMetadataV1"
              (\ o ->
...
instance Core.FromJSON CreateVersionMetadataV1Alpha where
        parseJSON
          = Core.withObject "CreateVersionMetadataV1Alpha"
              (\ o ->
...
instance Core.FromJSON CreateVersionMetadataV1Beta where
        parseJSON
          = Core.withObject "CreateVersionMetadataV1Beta"
              (\ o ->
...
instance Core.FromJSON DebugInstanceRequest where
        parseJSON
          = Core.withObject "DebugInstanceRequest"
...
newDeployment 
    ::  Deployment
newDeployment
  = Deployment{cloudBuildOptions = Core.Nothing,
               container = Core.Nothing, files = Core.Nothing, zip = Core.Nothing}
instance Core.FromJSON Deployment where
        parseJSON
          = Core.withObject "Deployment"
              (\ o ->
                 Deployment Core.<$>
                   (o Core..:? "cloudBuildOptions") Core.<*> (o Core..:? "container")
                     Core.<*> (o Core..:? "files")
                     Core.<*> (o Core..:? "zip"))
          ...
          = Core.object
              (Core.catMaybes
                 [("cloudBuildOptions" Core..=) Core.<$> cloudBuildOptions,
                  ...
                  ("files" Core..=) Core.<$> files, ("zip" Core..=) Core.<$> zip])
...
instance Core.FromJSON Deployment_Files where
        parseJSON
          = Core.withObject "Deployment_Files"
...
newDiskUtilization 
    ::  DiskUtilization
newDiskUtilization
  = DiskUtilization{targetReadBytesPerSecond = Core.Nothing,
...
instance Core.FromJSON DiskUtilization where
        parseJSON
          = Core.withObject "DiskUtilization"
              (\ o ->
                 DiskUtilization Core.<$>
                   (o Core..:? "targetReadBytesPerSecond") Core.<*>
                     (o Core..:? "targetReadOpsPerSecond")
...
instance Core.ToJSON DiskUtilization where
        toJSON DiskUtilization{..}
          = Core.object
              (Core.catMaybes
                 [("targetReadBytesPerSecond" Core..=) Core.<$>
                    targetReadBytesPerSecond,
                  ("targetReadOpsPerSecond" Core..=) Core.<$> targetReadOpsPerSecond,
                  ("targetWriteBytesPerSecond" Core..=) Core.<$>
                    targetWriteBytesPerSecond,
                  ("targetWriteOpsPerSecond" Core..=) Core.<$>
...
newDomainMapping 
    ::  DomainMapping
newDomainMapping
  = DomainMapping{id = Core.Nothing, name = Core.Nothing,
                  resourceRecords = Core.Nothing, sslSettings = Core.Nothing}
instance Core.FromJSON DomainMapping where
        parseJSON
          = Core.withObject "DomainMapping"
              (\ o ->
                 DomainMapping Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "resourceRecords")
...
newEndpointsApiService 
    ::  EndpointsApiService
newEndpointsApiService
  = EndpointsApiService{configId = Core.Nothing,
                        disableTraceSampling = Core.Nothing, name = Core.Nothing,
                        rolloutStrategy = Core.Nothing}
instance Core.FromJSON EndpointsApiService where
        parseJSON
          = Core.withObject "EndpointsApiService"
              (\ o ->
                 EndpointsApiService Core.<$>
                   (o Core..:? "configId") Core.<*>
                     (o Core..:? "disableTraceSampling")
                     Core.<*> (o Core..:? "name")
...
newErrorHandler 
    ::  ErrorHandler
newErrorHandler
  = ErrorHandler{errorCode = Core.Nothing, mimeType = Core.Nothing,
                 staticFile = Core.Nothing}
instance Core.FromJSON ErrorHandler where
        parseJSON
          = Core.withObject "ErrorHandler"
              (\ o ->
                 ErrorHandler Core.<$>
                   (o Core..:? "errorCode") Core.<*> (o Core..:? "mimeType") Core.<*>
                     (o Core..:? "staticFile"))
...
newFeatureSettings 
    ::  FeatureSettings
newFeatureSettings
  = FeatureSettings{splitHealthChecks = Core.Nothing,
                    useContainerOptimizedOs = Core.Nothing}
instance Core.FromJSON FeatureSettings where
        parseJSON
          = Core.withObject "FeatureSettings"
              (\ o ->
                 FeatureSettings Core.<$>
                   (o Core..:? "splitHealthChecks") Core.<*>
                     (o Core..:? "useContainerOptimizedOs"))
          ...
          = Core.object
              (Core.catMaybes
                 [("splitHealthChecks" Core..=) Core.<$> splitHealthChecks,
                  ("useContainerOptimizedOs" Core..=) Core.<$>
...
newFileInfo 
    ::  FileInfo
newFileInfo
  = FileInfo{mimeType = Core.Nothing, sha1Sum = Core.Nothing,
             sourceUrl = Core.Nothing}
instance Core.FromJSON FileInfo where
        parseJSON
          = Core.withObject "FileInfo"
              (\ o ->
                 FileInfo Core.<$>
                   (o Core..:? "mimeType") Core.<*> (o Core..:? "sha1Sum") Core.<*>
                     (o Core..:? "sourceUrl"))
...
newFirewallRule 
    ::  FirewallRule
newFirewallRule
  = FirewallRule{action = Core.Nothing, description = Core.Nothing,
                 priority = Core.Nothing, sourceRange = Core.Nothing}
instance Core.FromJSON FirewallRule where
        parseJSON
          = Core.withObject "FirewallRule"
              (\ o ->
                 FirewallRule Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "description") Core.<*>
                     (o Core..:? "priority")
...
newFlexibleRuntimeSettings 
    ::  FlexibleRuntimeSettings
newFlexibleRuntimeSettings
  = FlexibleRuntimeSettings{operatingSystem = Core.Nothing,
                            runtimeVersion = Core.Nothing}
instance Core.FromJSON FlexibleRuntimeSettings where
        parseJSON
          = Core.withObject "FlexibleRuntimeSettings"
              (\ o ->
                 FlexibleRuntimeSettings Core.<$>
                   (o Core..:? "operatingSystem") Core.<*>
...
newGoogleAppengineV1betaLocationMetadata 
    :: 
                                         GoogleAppengineV1betaLocationMetadata
newGoogleAppengineV1betaLocationMetadata
  = GoogleAppengineV1betaLocationMetadata{flexibleEnvironmentAvailable
                                            = Core.Nothing,
...
instance Core.FromJSON GoogleAppengineV1betaLocationMetadata where
        parseJSON
          = Core.withObject "GoogleAppengineV1betaLocationMetadata"
              (\ o ->
                 GoogleAppengineV1betaLocationMetadata Core.<$>
                   (o Core..:? "flexibleEnvironmentAvailable") Core.<*>
                     (o Core..:? "searchApiAvailable")
...
instance Core.ToJSON GoogleAppengineV1betaLocationMetadata where
        toJSON GoogleAppengineV1betaLocationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("flexibleEnvironmentAvailable" Core..=) Core.<$>
                    flexibleEnvironmentAvailable,
                  ("searchApiAvailable" Core..=) Core.<$> searchApiAvailable,
                  ("standardEnvironmentAvailable" Core..=) Core.<$>
...
newHealthCheck 
    ::  HealthCheck
newHealthCheck
  = HealthCheck{checkInterval = Core.Nothing,
                disableHealthCheck = Core.Nothing, healthyThreshold = Core.Nothing,
                host = Core.Nothing, restartThreshold = Core.Nothing,
                timeout = Core.Nothing, unhealthyThreshold = Core.Nothing}
instance Core.FromJSON HealthCheck where
        parseJSON
          = Core.withObject "HealthCheck"
              (\ o ->
                 HealthCheck Core.<$>
                   (o Core..:? "checkInterval") Core.<*>
                     (o Core..:? "disableHealthCheck")
...
newIdentityAwareProxy 
    ::  IdentityAwareProxy
newIdentityAwareProxy
  = IdentityAwareProxy{enabled = Core.Nothing,
                       oauth2ClientId = Core.Nothing, oauth2ClientSecret = Core.Nothing,
                       oauth2ClientSecretSha256 = Core.Nothing}
instance Core.FromJSON IdentityAwareProxy where
        parseJSON
          = Core.withObject "IdentityAwareProxy"
              (\ o ->
                 IdentityAwareProxy Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "oauth2ClientId")
          ...
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ...
                  ("oauth2ClientSecretSha256" Core..=) Core.<$>
...
newInstance 
    ::  Instance
newInstance
  = Instance{appEngineRelease = Core.Nothing,
             availability = Core.Nothing, averageLatency = Core.Nothing,
             errors = Core.Nothing, id = Core.Nothing,
             memoryUsage = Core.Nothing, name = Core.Nothing,
             qps = Core.Nothing, requests = Core.Nothing,
             startTime = Core.Nothing, vmDebugEnabled = Core.Nothing,
             vmId = Core.Nothing, vmIp = Core.Nothing,
             vmLiveness = Core.Nothing, vmName = Core.Nothing,
             vmStatus = Core.Nothing, vmZoneName = Core.Nothing}
instance Core.FromJSON Instance where
        parseJSON
          = Core.withObject "Instance"
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "appEngineRelease") Core.<*>
                     (o Core..:? "availability")
                     Core.<*> (o Core..:? "averageLatency")
                     Core.<*> (o Core..:? "errors")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "memoryUsage" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "qps")
...
newListAuthorizedCertificatesResponse 
    :: 
                                      ListAuthorizedCertificatesResponse
newListAuthorizedCertificatesResponse
  = ListAuthorizedCertificatesResponse{certificates = Core.Nothing,
                                       nextPageToken = Core.Nothing}
instance Core.FromJSON ListAuthorizedCertificatesResponse where
        parseJSON
          = Core.withObject "ListAuthorizedCertificatesResponse"
              (\ o ->
                 ListAuthorizedCertificatesResponse Core.<$>
                   (o Core..:? "certificates") Core.<*> (o Core..:? "nextPageToken"))
...
newListAuthorizedDomainsResponse 
    ::  ListAuthorizedDomainsResponse
newListAuthorizedDomainsResponse
  = ListAuthorizedDomainsResponse{domains = Core.Nothing,
                                  nextPageToken = Core.Nothing}
instance Core.FromJSON ListAuthorizedDomainsResponse where
        parseJSON
          = Core.withObject "ListAuthorizedDomainsResponse"
              (\ o ->
                 ListAuthorizedDomainsResponse Core.<$>
                   (o Core..:? "domains") Core.<*> (o Core..:? "nextPageToken"))
...
newListDomainMappingsResponse 
    ::  ListDomainMappingsResponse
newListDomainMappingsResponse
  = ListDomainMappingsResponse{domainMappings = Core.Nothing,
                               nextPageToken = Core.Nothing}
instance Core.FromJSON ListDomainMappingsResponse where
        parseJSON
          = Core.withObject "ListDomainMappingsResponse"
              (\ o ->
                 ListDomainMappingsResponse Core.<$>
                   (o Core..:? "domainMappings") Core.<*>
...
newListIngressRulesResponse 
    ::  ListIngressRulesResponse
newListIngressRulesResponse
  = ListIngressRulesResponse{ingressRules = Core.Nothing,
                             nextPageToken = Core.Nothing}
instance Core.FromJSON ListIngressRulesResponse where
        parseJSON
          = Core.withObject "ListIngressRulesResponse"
              (\ o ->
                 ListIngressRulesResponse Core.<$>
                   (o Core..:? "ingressRules") Core.<*> (o Core..:? "nextPageToken"))
...
newListRuntimesResponse 
    ::  ListRuntimesResponse
newListRuntimesResponse
  = ListRuntimesResponse{nextPageToken = Core.Nothing,
                         runtimes = Core.Nothing}
instance Core.FromJSON ListRuntimesResponse where
        parseJSON
          = Core.withObject "ListRuntimesResponse"
              (\ o ->
                 ListRuntimesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "runtimes"))
...
newListVersionsResponse 
    ::  ListVersionsResponse
newListVersionsResponse
  = ListVersionsResponse{nextPageToken = Core.Nothing,
                         versions = Core.Nothing}
instance Core.FromJSON ListVersionsResponse where
        parseJSON
          = Core.withObject "ListVersionsResponse"
              (\ o ->
                 ListVersionsResponse Core.<$>
...
newLivenessCheck 
    ::  LivenessCheck
newLivenessCheck
  = LivenessCheck{checkInterval = Core.Nothing,
                  failureThreshold = Core.Nothing, host = Core.Nothing,
                  initialDelay = Core.Nothing, path = Core.Nothing,
                  successThreshold = Core.Nothing, timeout = Core.Nothing}
instance Core.FromJSON LivenessCheck where
        parseJSON
          = Core.withObject "LivenessCheck"
              (\ o ->
                 LivenessCheck Core.<$>
                   (o Core..:? "checkInterval") Core.<*>
                     (o Core..:? "failureThreshold")
                     Core.<*> (o Core..:? "host")
...
newLocationMetadata 
    ::  LocationMetadata
newLocationMetadata
  = LocationMetadata{flexibleEnvironmentAvailable = Core.Nothing,
                     searchApiAvailable = Core.Nothing,
                     standardEnvironmentAvailable = Core.Nothing}
...
newManagedCertificate 
    ::  ManagedCertificate
newManagedCertificate
  = ManagedCertificate{lastRenewalTime = Core.Nothing,
                       status = Core.Nothing}
instance Core.FromJSON ManagedCertificate where
        parseJSON
          = Core.withObject "ManagedCertificate"
              (\ o ->
                 ManagedCertificate Core.<$>
                   (o Core..:? "lastRenewalTime") Core.<*> (o Core..:? "status"))
...
newNetwork 
    ::  Network
newNetwork
  = Network{forwardedPorts = Core.Nothing,
            instanceIpMode = Core.Nothing, instanceTag = Core.Nothing,
            name = Core.Nothing, sessionAffinity = Core.Nothing,
            subnetworkName = Core.Nothing}
instance Core.FromJSON Network where
        parseJSON
          = Core.withObject "Network"
              (\ o ->
                 Network Core.<$>
                   (o Core..:? "forwardedPorts") Core.<*>
                     (o Core..:? "instanceIpMode")
...
instance Core.FromJSON NetworkSettings where
        parseJSON
          = Core.withObject "NetworkSettings"
              (\ o ->
...
newNetworkUtilization 
    ::  NetworkUtilization
newNetworkUtilization
  = NetworkUtilization{targetReceivedBytesPerSecond = Core.Nothing,
...
instance Core.FromJSON NetworkUtilization where
        parseJSON
          = Core.withObject "NetworkUtilization"
              (\ o ->
                 NetworkUtilization Core.<$>
                   (o Core..:? "targetReceivedBytesPerSecond") Core.<*>
                     (o Core..:? "targetReceivedPacketsPerSecond")
...
instance Core.ToJSON NetworkUtilization where
        toJSON NetworkUtilization{..}
          = Core.object
              (Core.catMaybes
                 [("targetReceivedBytesPerSecond" Core..=) Core.<$>
                    targetReceivedBytesPerSecond,
                  ("targetReceivedPacketsPerSecond" Core..=) Core.<$>
                    targetReceivedPacketsPerSecond,
                  ("targetSentBytesPerSecond" Core..=) Core.<$>
                    targetSentBytesPerSecond,
                  ("targetSentPacketsPerSecond" Core..=) Core.<$>
...
newOperationMetadataV1 
    ::  OperationMetadataV1
newOperationMetadataV1
  = OperationMetadataV1{createVersionMetadata = Core.Nothing,
                        endTime = Core.Nothing, ephemeralMessage = Core.Nothing,
                        insertTime = Core.Nothing, method = Core.Nothing,
                        target = Core.Nothing, user = Core.Nothing, warning = Core.Nothing}
instance Core.FromJSON OperationMetadataV1 where
        parseJSON
          = Core.withObject "OperationMetadataV1"
              (\ o ->
                 OperationMetadataV1 Core.<$>
                   (o Core..:? "createVersionMetadata") Core.<*>
                     (o Core..:? "endTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("createVersionMetadata" Core..=) Core.<$> createVersionMetadata,
                  ...
                  ("target" Core..=) Core.<$> target, ("user" Core..=) Core.<$> user,
...
newOperationMetadataV1Alpha 
    ::  OperationMetadataV1Alpha
newOperationMetadataV1Alpha
  = OperationMetadataV1Alpha{createVersionMetadata = Core.Nothing,
                             endTime = Core.Nothing, ephemeralMessage = Core.Nothing,
                             insertTime = Core.Nothing, method = Core.Nothing,
                             target = Core.Nothing, user = Core.Nothing, warning = Core.Nothing}
instance Core.FromJSON OperationMetadataV1Alpha where
        parseJSON
          = Core.withObject "OperationMetadataV1Alpha"
              (\ o ->
                 OperationMetadataV1Alpha Core.<$>
                   (o Core..:? "createVersionMetadata") Core.<*>
                     (o Core..:? "endTime")
                     Core.<*> (o Core..:? "ephemeralMessage")
                     Core.<*> (o Core..:? "insertTime")
...
newOperationMetadataV1Beta 
    ::  OperationMetadataV1Beta
newOperationMetadataV1Beta
  = OperationMetadataV1Beta{createVersionMetadata = Core.Nothing,
                            endTime = Core.Nothing, ephemeralMessage = Core.Nothing,
                            insertTime = Core.Nothing, method = Core.Nothing,
                            target = Core.Nothing, user = Core.Nothing, warning = Core.Nothing}
instance Core.FromJSON OperationMetadataV1Beta where
        parseJSON
          = Core.withObject "OperationMetadataV1Beta"
              (\ o ->
                 OperationMetadataV1Beta Core.<$>
                   (o Core..:? "createVersionMetadata") Core.<*>
                     (o Core..:? "endTime")
                     Core.<*> (o Core..:? "ephemeralMessage")
                     Core.<*> (o Core..:? "insertTime")
...
newProjectEvent 
    ::  ProjectEvent
newProjectEvent
  = ProjectEvent{eventId = Core.Nothing, phase = Core.Nothing,
                 projectMetadata = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON ProjectEvent where
        parseJSON
          = Core.withObject "ProjectEvent"
              (\ o ->
                 ProjectEvent Core.<$>
                   (o Core..:? "eventId") Core.<*> (o Core..:? "phase") Core.<*>
                     (o Core..:? "projectMetadata")
                     Core.<*> (o Core..:? "state"))
...
newProjectsMetadata 
    ::  ProjectsMetadata
newProjectsMetadata
  = ProjectsMetadata{consumerProjectId = Core.Nothing,
                     consumerProjectNumber = Core.Nothing,
                     consumerProjectState = Core.Nothing, gceTag = Core.Nothing,
                     p4ServiceAccount = Core.Nothing, producerProjectId = Core.Nothing,
                     producerProjectNumber = Core.Nothing,
                     tenantProjectId = Core.Nothing, tenantProjectNumber = Core.Nothing}
instance Core.FromJSON ProjectsMetadata where
        parseJSON
          = Core.withObject "ProjectsMetadata"
              (\ o ->
                 ProjectsMetadata Core.<$>
                   (o Core..:? "consumerProjectId") Core.<*>
                     (o Core..:? "consumerProjectNumber" Core.<&>
                     ...
                     Core.<*>
                     (o Core..:? "producerProjectNumber" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "tenantProjectId")
                     Core.<*>
                     (o Core..:? "tenantProjectNumber" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("consumerProjectId" Core..=) Core.<$> consumerProjectId,
                  ("consumerProjectNumber" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("producerProjectNumber" Core..=) Core.. Core.AsText Core.<$>
                    producerProjectNumber,
                  ("tenantProjectId" Core..=) Core.<$> tenantProjectId,
                  ("tenantProjectNumber" Core..=) Core.. Core.AsText Core.<$>
                    tenantProjectNumber])
...
newReadinessCheck 
    ::  ReadinessCheck
newReadinessCheck
  = ReadinessCheck{appStartTimeout = Core.Nothing,
                   checkInterval = Core.Nothing, failureThreshold = Core.Nothing,
                   host = Core.Nothing, path = Core.Nothing,
                   successThreshold = Core.Nothing, timeout = Core.Nothing}
instance Core.FromJSON ReadinessCheck where
        parseJSON
          = Core.withObject "ReadinessCheck"
              (\ o ->
                 ReadinessCheck Core.<$>
                   (o Core..:? "appStartTimeout") Core.<*>
                     (o Core..:? "checkInterval")
          ...
          = Core.object
              (Core.catMaybes
                 [("appStartTimeout" Core..=) Core.<$> appStartTimeout,
                  ("checkInterval" Core..=) Core.<$> checkInterval,
                  ("failureThreshold" Core..=) Core.<$> failureThreshold,
                  ("host" Core..=) Core.<$> host, ("path" Core..=) Core.<$> path,
                  ("successThreshold" Core..=) Core.<$> successThreshold,
                  ("timeout" Core..=) Core.<$> timeout])
...
newReasons 
    ::  Reasons
newReasons
  = Reasons{abuse = Core.Nothing, billing = Core.Nothing,
            dataGovernance = Core.Nothing, serviceActivation = Core.Nothing,
            serviceManagement = Core.Nothing}
instance Core.FromJSON Reasons where
        parseJSON
          = Core.withObject "Reasons"
              (\ o ->
                 Reasons Core.<$>
                   (o Core..:? "abuse") Core.<*> (o Core..:? "billing") Core.<*>
                     (o Core..:? "dataGovernance")
...
instance Core.FromJSON RepairApplicationRequest where
        parseJSON
          = Core.withObject "RepairApplicationRequest"
...
newRequestUtilization 
    ::  RequestUtilization
newRequestUtilization
  = RequestUtilization{targetConcurrentRequests = Core.Nothing,
                       targetRequestCountPerSecond = Core.Nothing}
instance Core.FromJSON RequestUtilization where
        parseJSON
          = Core.withObject "RequestUtilization"
              (\ o ->
                 RequestUtilization Core.<$>
                   (o Core..:? "targetConcurrentRequests") Core.<*>
                     (o Core..:? "targetRequestCountPerSecond"))

instance Core.ToJSON RequestUtilization where
        toJSON RequestUtilization{..}
          = Core.object
              (Core.catMaybes
                 [("targetConcurrentRequests" Core..=) Core.<$>
                    targetConcurrentRequests,
                  ("targetRequestCountPerSecond" Core..=) Core.<$>
...
newResourceEvent 
    ::  ResourceEvent
newResourceEvent
  = ResourceEvent{eventId = Core.Nothing, name = Core.Nothing,
                  state = Core.Nothing}
instance Core.FromJSON ResourceEvent where
        parseJSON
          = Core.withObject "ResourceEvent"
              (\ o ->
                 ResourceEvent Core.<$>
                   (o Core..:? "eventId") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "state"))
...
newResourceRecord 
    ::  ResourceRecord
newResourceRecord
  = ResourceRecord{name = Core.Nothing, rrdata = Core.Nothing,
                   type' = Core.Nothing}
instance Core.FromJSON ResourceRecord where
        parseJSON
          = Core.withObject "ResourceRecord"
              (\ o ->
                 ResourceRecord Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "rrdata") Core.<*>
                     (o Core..:? "type"))
...
newResources 
    ::  Resources
newResources
  = Resources{cpu = Core.Nothing, diskGb = Core.Nothing,
              kmsKeyReference = Core.Nothing, memoryGb = Core.Nothing,
...
instance Core.FromJSON Resources where
        parseJSON
          = Core.withObject "Resources"
              (\ o ->
                 Resources Core.<$>
                   (o Core..:? "cpu") Core.<*> (o Core..:? "diskGb") Core.<*>
                     (o Core..:? "kmsKeyReference")
...
instance Core.ToJSON Resources where
        toJSON Resources{..}
          = Core.object
              (Core.catMaybes
                 [("cpu" Core..=) Core.<$> cpu, ("diskGb" Core..=) Core.<$> diskGb,
...
newRuntime 
    ::  Runtime
newRuntime
  = Runtime{decommissionedDate = Core.Nothing,
            deprecationDate = Core.Nothing, displayName = Core.Nothing,
            endOfSupportDate = Core.Nothing, environment = Core.Nothing,
            name = Core.Nothing, stage = Core.Nothing,
            supportedOperatingSystems = Core.Nothing, warnings = Core.Nothing}
instance Core.FromJSON Runtime where
        parseJSON
          = Core.withObject "Runtime"
              (\ o ->
                 Runtime Core.<$>
                   (o Core..:? "decommissionedDate") Core.<*>
                     (o Core..:? "deprecationDate")
          ...
          = Core.object
              (Core.catMaybes
                 [("decommissionedDate" Core..=) Core.<$> decommissionedDate,
                  ...
                  ("name" Core..=) Core.<$> name, ("stage" Core..=) Core.<$> stage,
                  ("supportedOperatingSystems" Core..=) Core.<$>
...
newService 
    ::  Service
newService
  = Service{generatedCustomerMetadata = Core.Nothing,
            id = Core.Nothing, labels = Core.Nothing, name = Core.Nothing,
            networkSettings = Core.Nothing, split = Core.Nothing}
instance Core.FromJSON Service where
        parseJSON
          = Core.withObject "Service"
              (\ o ->
                 Service Core.<$>
                   (o Core..:? "generatedCustomerMetadata") Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON Service_GeneratedCustomerMetadata where
        parseJSON
          = Core.withObject "Service_GeneratedCustomerMetadata"
              (\ o ->
                 Service_GeneratedCustomerMetadata Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON Service_Labels where
        parseJSON
          = Core.withObject "Service_Labels"
...
newSslSettings 
    ::  SslSettings
newSslSettings
  = SslSettings{certificateId = Core.Nothing,
                pendingManagedCertificateId = Core.Nothing,
                sslManagementType = Core.Nothing}
instance Core.FromJSON SslSettings where
        parseJSON
          = Core.withObject "SslSettings"
              (\ o ->
                 SslSettings Core.<$>
                   (o Core..:? "certificateId") Core.<*>
                     (o Core..:? "pendingManagedCertificateId")
          ...
          = Core.object
              (Core.catMaybes
                 [("certificateId" Core..=) Core.<$> certificateId,
                  ("pendingManagedCertificateId" Core..=) Core.<$>
...
newStandardSchedulerSettings 
    ::  StandardSchedulerSettings
newStandardSchedulerSettings
  = StandardSchedulerSettings{maxInstances = Core.Nothing,
                              minInstances = Core.Nothing, targetCpuUtilization = Core.Nothing,
                              targetThroughputUtilization = Core.Nothing}
instance Core.FromJSON StandardSchedulerSettings where
        parseJSON
          = Core.withObject "StandardSchedulerSettings"
              (\ o ->
          ...
          = Core.object
              (Core.catMaybes
                 [("maxInstances" Core..=) Core.<$> maxInstances,
                  ...
                  ("targetThroughputUtilization" Core..=) Core.<$>
...
newStaticFilesHandler 
    ::  StaticFilesHandler
newStaticFilesHandler
  = StaticFilesHandler{applicationReadable = Core.Nothing,
                       expiration = Core.Nothing, httpHeaders = Core.Nothing,
                       mimeType = Core.Nothing, path = Core.Nothing,
                       requireMatchingFile = Core.Nothing, uploadPathRegex = Core.Nothing}
instance Core.FromJSON StaticFilesHandler where
        parseJSON
          = Core.withObject "StaticFilesHandler"
              (\ o ->
                 StaticFilesHandler Core.<$>
                   (o Core..:? "applicationReadable") Core.<*>
                     (o Core..:? "expiration")
...
instance Core.FromJSON StaticFilesHandler_HttpHeaders where
        parseJSON
          = Core.withObject "StaticFilesHandler_HttpHeaders"
              (\ o ->
...
instance Core.FromJSON TrafficSplit where
        parseJSON
          = Core.withObject "TrafficSplit"
              (\ o ->
                 TrafficSplit Core.<$>
                   (o Core..:? "allocations") Core.<*> (o Core..:? "shardBy"))
...
instance Core.FromJSON TrafficSplit_Allocations where
        parseJSON
          = Core.withObject "TrafficSplit_Allocations"
...
newUrlDispatchRule 
    ::  UrlDispatchRule
newUrlDispatchRule
  = UrlDispatchRule{domain = Core.Nothing, path = Core.Nothing,
                    service = Core.Nothing}
instance Core.FromJSON UrlDispatchRule where
        parseJSON
          = Core.withObject "UrlDispatchRule"
              (\ o ->
                 UrlDispatchRule Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "path") Core.<*>
                     (o Core..:? "service"))
...
newUrlMap 
    ::  UrlMap
newUrlMap
  = UrlMap{apiEndpoint = Core.Nothing, authFailAction = Core.Nothing,
           login = Core.Nothing, redirectHttpResponseCode = Core.Nothing,
           script = Core.Nothing, securityLevel = Core.Nothing,
           staticFiles = Core.Nothing, urlRegex = Core.Nothing}
instance Core.FromJSON UrlMap where
        parseJSON
          = Core.withObject "UrlMap"
              (\ o ->
                 UrlMap Core.<$>
                   (o Core..:? "apiEndpoint") Core.<*> (o Core..:? "authFailAction")
                     Core.<*> (o Core..:? "login")
          ...
          = Core.object
              (Core.catMaybes
                 [("apiEndpoint" Core..=) Core.<$> apiEndpoint,
                  ("authFailAction" Core..=) Core.<$> authFailAction,
                  ("login" Core..=) Core.<$> login,
                  ("redirectHttpResponseCode" Core..=) Core.<$>
...
newVersion 
    ::  Version
newVersion
  = Version{apiConfig = Core.Nothing, appEngineApis = Core.Nothing,
            automaticScaling = Core.Nothing, basicScaling = Core.Nothing,
            betaSettings = Core.Nothing, buildEnvVariables = Core.Nothing,
            createTime = Core.Nothing, createdBy = Core.Nothing,
            defaultExpiration = Core.Nothing, deployment = Core.Nothing,
            diskUsageBytes = Core.Nothing, endpointsApiService = Core.Nothing,
            entrypoint = Core.Nothing, env = Core.Nothing,
            envVariables = Core.Nothing, errorHandlers = Core.Nothing,
            flexibleRuntimeSettings = Core.Nothing,
            generatedCustomerMetadata = Core.Nothing, handlers = Core.Nothing,
            healthCheck = Core.Nothing, id = Core.Nothing,
            inboundServices = Core.Nothing, instanceClass = Core.Nothing,
            libraries = Core.Nothing, livenessCheck = Core.Nothing,
            manualScaling = Core.Nothing, name = Core.Nothing,
            network = Core.Nothing, nobuildFilesRegex = Core.Nothing,
            readinessCheck = Core.Nothing, resources = Core.Nothing,
            runtime = Core.Nothing, runtimeApiVersion = Core.Nothing,
            runtimeChannel = Core.Nothing,
            runtimeMainExecutablePath = Core.Nothing,
            serviceAccount = Core.Nothing, servingStatus = Core.Nothing,
            threadsafe = Core.Nothing, versionUrl = Core.Nothing,
            vm = Core.Nothing, vpcAccessConnector = Core.Nothing,
            zones = Core.Nothing}
instance Core.FromJSON Version where
        parseJSON
          = Core.withObject "Version"
              (\ o ->
                 Version Core.<$>
                   (o Core..:? "apiConfig") Core.<*> (o Core..:? "appEngineApis")
                     ...
                     Core.<*>
                     (o Core..:? "diskUsageBytes" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("apiConfig" Core..=) Core.<$> apiConfig,
                  ...
                  ("diskUsageBytes" Core..=) Core.. Core.AsText Core.<$>
                    diskUsageBytes,
                  ...
                  ("flexibleRuntimeSettings" Core..=) Core.<$>
                    flexibleRuntimeSettings,
                  ("generatedCustomerMetadata" Core..=) Core.<$>
                    generatedCustomerMetadata,
                  ...
                  ("runtimeMainExecutablePath" Core..=) Core.<$>
...
instance Core.FromJSON Version_BetaSettings where
        parseJSON
          = Core.withObject "Version_BetaSettings"
...
instance Core.FromJSON Version_BuildEnvVariables where
        parseJSON
          = Core.withObject "Version_BuildEnvVariables"
              (\ o ->
...
instance Core.FromJSON Version_EnvVariables where
        parseJSON
          = Core.withObject "Version_EnvVariables"
...
instance Core.FromJSON Version_GeneratedCustomerMetadata where
        parseJSON
          = Core.withObject "Version_GeneratedCustomerMetadata"
              (\ o ->
                 Version_GeneratedCustomerMetadata Core.<$>
                   (Core.parseJSONObject o))
...
newVolume 
    ::  Volume
newVolume
  = Volume{name = Core.Nothing, sizeGb = Core.Nothing,
...
instance Core.FromJSON Volume where
        parseJSON
          = Core.withObject "Volume"
              (\ o ->
                 Volume Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "sizeGb") Core.<*>
                     (o Core..:? "volumeType"))
...
newVpcAccessConnector 
    ::  VpcAccessConnector
newVpcAccessConnector
  = VpcAccessConnector{egressSetting = Core.Nothing,
                       name = Core.Nothing}
instance Core.FromJSON VpcAccessConnector where
        parseJSON
          = Core.withObject "VpcAccessConnector"
              (\ o ->
                 VpcAccessConnector Core.<$>
                   (o Core..:? "egressSetting") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON ZipInfo where
        parseJSON
          = Core.withObject "ZipInfo"
              (\ o ->
                 ZipInfo Core.<$>
                   (o Core..:? "filesCount") Core.<*> (o Core..:? "sourceUrl"))
