...
module Gogol.CloudSearch
    ...
    , AddOnFrameStartingState (..)
    , newAddOnFrameStartingState

    -- ** AddOnStartingState
    , AddOnStartingState (..)
    , newAddOnStartingState

    -- ** AddOnStartingState_AddOnFrameStartingStates
    , AddOnStartingState_AddOnFrameStartingStates (..)
    , newAddOnStartingState_AddOnFrameStartingStates
    ...
    , AppsDynamiteSharedMessageSearchInfo (..)
    , newAppsDynamiteSharedMessageSearchInfo
