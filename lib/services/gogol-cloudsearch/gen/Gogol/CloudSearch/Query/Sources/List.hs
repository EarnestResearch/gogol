               ...
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "pageToken" Core.Text Core.:>
                   Core.QueryParam
                     ...
                     Core.Bool
                     Core.:>
                     Core.QueryParam "requestOptions.languageCode"
                       Core.Text
                       Core.:>
                       Core.QueryParam "requestOptions.searchApplicationId"
                         Core.Text
                         Core.:>
                         Core.QueryParam "requestOptions.timeZone" Core.Text
                           Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListQuerySourcesResponse
