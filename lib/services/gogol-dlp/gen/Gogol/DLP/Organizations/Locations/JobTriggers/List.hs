...
-- |
-- Module      : Gogol.DLP.Organizations.Locations.JobTriggers.List
...
-- 'DLPOrganizationsLocationsJobTriggersList' request conforms to.
type DLPOrganizationsLocationsJobTriggersListResource
     =
     "v2" Core.:>
...
-- | Lists job triggers. See https:\/\/cloud.google.com\/dlp\/docs\/creating-job-triggers to learn more.
--
-- /See:/ 'newDLPOrganizationsLocationsJobTriggersList' smart constructor.
data DLPOrganizationsLocationsJobTriggersList = DLPOrganizationsLocationsJobTriggersList
    {
      -- | V1 error format.
    ...
    , type' :: (Core.Maybe OrganizationsLocationsJobTriggersListType)
...
-- | Creates a value of 'DLPOrganizationsLocationsJobTriggersList' with the minimum fields required to make a request.
newDLPOrganizationsLocationsJobTriggersList 
    ::  Core.Text
       -- ^  Required. Parent resource name. The format of this value varies depending on whether you have <https://cloud.google.com/dlp/docs/specifying-location specified a processing location>: + Projects scope, location specified: @projects\/@PROJECT/ID@\/locations\/@LOCATION/ID + Projects scope, no location specified (defaults to global): @projects\/@PROJECT_ID The following example @parent@ string specifies a parent project with the identifier @example-project@, and specifies the @europe-west3@ location for processing data: parent=projects\/example-project\/locations\/europe-west3 See 'parent'.
    -> DLPOrganizationsLocationsJobTriggersList
newDLPOrganizationsLocationsJobTriggersList parent =
  DLPOrganizationsLocationsJobTriggersList
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsJobTriggersList
         where
        type Rs DLPOrganizationsLocationsJobTriggersList =
             GooglePrivacyDlpV2ListJobTriggersResponse
        type Scopes DLPOrganizationsLocationsJobTriggersList
