...
-- |
-- Module      : Gogol.DLP.Projects.InspectTemplates.Delete
...
-- 'DLPProjectsInspectTemplatesDelete' request conforms to.
type DLPProjectsInspectTemplatesDeleteResource =
     "v2" Core.:>
...
-- | Deletes an InspectTemplate. See https:\/\/cloud.google.com\/dlp\/docs\/creating-templates to learn more.
--
-- /See:/ 'newDLPProjectsInspectTemplatesDelete' smart constructor.
data DLPProjectsInspectTemplatesDelete = DLPProjectsInspectTemplatesDelete
    {
      -- | V1 error format.
...
-- | Creates a value of 'DLPProjectsInspectTemplatesDelete' with the minimum fields required to make a request.
newDLPProjectsInspectTemplatesDelete 
    ::  Core.Text
    ...
    -> DLPProjectsInspectTemplatesDelete
newDLPProjectsInspectTemplatesDelete name =
  DLPProjectsInspectTemplatesDelete
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           DLPProjectsInspectTemplatesDelete
         where
        type Rs DLPProjectsInspectTemplatesDelete =
             GoogleProtobufEmpty
        type Scopes DLPProjectsInspectTemplatesDelete =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsInspectTemplatesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsInspectTemplatesDeleteResource)
                      Core.mempty
