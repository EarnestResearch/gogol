...
-- |
-- Module      : Gogol.DLP.Projects.Locations.Content.Inspect
...
-- 'DLPProjectsLocationsContentInspect' request conforms to.
type DLPProjectsLocationsContentInspectResource =
     "v2" Core.:>
...
-- | Finds potentially sensitive info in content. This method has limits on input size, processing time, and output size. When no InfoTypes or CustomInfoTypes are specified in this request, the system will automatically choose what detectors to run. By default this may be all types, but may change over time as detectors are updated. For how to guides, see https:\/\/cloud.google.com\/dlp\/docs\/inspecting-images and https:\/\/cloud.google.com\/dlp\/docs\/inspecting-text,
--
-- /See:/ 'newDLPProjectsLocationsContentInspect' smart constructor.
data DLPProjectsLocationsContentInspect = DLPProjectsLocationsContentInspect
    {
      -- | V1 error format.
...
-- | Creates a value of 'DLPProjectsLocationsContentInspect' with the minimum fields required to make a request.
newDLPProjectsLocationsContentInspect 
    ::  Core.Text
    ...
    -> DLPProjectsLocationsContentInspect
newDLPProjectsLocationsContentInspect parent payload =
  DLPProjectsLocationsContentInspect
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           DLPProjectsLocationsContentInspect
         where
        type Rs DLPProjectsLocationsContentInspect =
             GooglePrivacyDlpV2InspectContentResponse
        type Scopes DLPProjectsLocationsContentInspect =
