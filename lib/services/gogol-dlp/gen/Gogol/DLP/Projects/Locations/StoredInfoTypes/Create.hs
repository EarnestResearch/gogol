...
-- |
-- Module      : Gogol.DLP.Projects.Locations.StoredInfoTypes.Create
...
-- 'DLPProjectsLocationsStoredInfoTypesCreate' request conforms to.
type DLPProjectsLocationsStoredInfoTypesCreateResource
     =
     "v2" Core.:>
...
-- | Creates a pre-built stored infoType to be used for inspection. See https:\/\/cloud.google.com\/dlp\/docs\/creating-stored-infotypes to learn more.
--
-- /See:/ 'newDLPProjectsLocationsStoredInfoTypesCreate' smart constructor.
data DLPProjectsLocationsStoredInfoTypesCreate = DLPProjectsLocationsStoredInfoTypesCreate
    {
      -- | V1 error format.
...
-- | Creates a value of 'DLPProjectsLocationsStoredInfoTypesCreate' with the minimum fields required to make a request.
newDLPProjectsLocationsStoredInfoTypesCreate 
    ::  Core.Text
    ...
    -> DLPProjectsLocationsStoredInfoTypesCreate
newDLPProjectsLocationsStoredInfoTypesCreate parent payload =
  DLPProjectsLocationsStoredInfoTypesCreate
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           DLPProjectsLocationsStoredInfoTypesCreate
         where
        type Rs DLPProjectsLocationsStoredInfoTypesCreate =
             GooglePrivacyDlpV2StoredInfoType
