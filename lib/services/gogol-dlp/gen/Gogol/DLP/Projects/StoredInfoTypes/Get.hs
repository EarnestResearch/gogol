...
-- |
-- Module      : Gogol.DLP.Projects.StoredInfoTypes.Get
...
-- 'DLPProjectsStoredInfoTypesGet' request conforms to.
type DLPProjectsStoredInfoTypesGetResource =
     "v2" Core.:>
...
-- | Gets a stored infoType. See https:\/\/cloud.google.com\/dlp\/docs\/creating-stored-infotypes to learn more.
--
-- /See:/ 'newDLPProjectsStoredInfoTypesGet' smart constructor.
data DLPProjectsStoredInfoTypesGet = DLPProjectsStoredInfoTypesGet
    {
      -- | V1 error format.
...
-- | Creates a value of 'DLPProjectsStoredInfoTypesGet' with the minimum fields required to make a request.
newDLPProjectsStoredInfoTypesGet 
    ::  Core.Text
    ...
    -> DLPProjectsStoredInfoTypesGet
newDLPProjectsStoredInfoTypesGet name =
  DLPProjectsStoredInfoTypesGet
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           DLPProjectsStoredInfoTypesGet
         where
        type Rs DLPProjectsStoredInfoTypesGet =
             GooglePrivacyDlpV2StoredInfoType
        type Scopes DLPProjectsStoredInfoTypesGet =
        ...
        requestClient DLPProjectsStoredInfoTypesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsStoredInfoTypesGetResource)
                      Core.mempty
