...
-- |
-- Module      : Gogol.DLP.Projects.DlpJobs.List
                     ...
                     Core.QueryParam "orderBy" Core.Text Core.:>
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "type" ProjectsDlpJobsListType
                             Core.:>
...
instance Core.GoogleRequest DLPProjectsDlpJobsList
         where
        type Rs DLPProjectsDlpJobsList =
             GooglePrivacyDlpV2ListDlpJobsResponse
        type Scopes DLPProjectsDlpJobsList =
