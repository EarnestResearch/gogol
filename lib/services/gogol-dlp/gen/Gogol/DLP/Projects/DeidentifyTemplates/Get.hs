...
-- |
-- Module      : Gogol.DLP.Projects.DeidentifyTemplates.Get
...
-- 'DLPProjectsDeidentifyTemplatesGet' request conforms to.
type DLPProjectsDeidentifyTemplatesGetResource =
     "v2" Core.:>
...
-- | Gets a DeidentifyTemplate. See https:\/\/cloud.google.com\/dlp\/docs\/creating-templates-deid to learn more.
--
-- /See:/ 'newDLPProjectsDeidentifyTemplatesGet' smart constructor.
data DLPProjectsDeidentifyTemplatesGet = DLPProjectsDeidentifyTemplatesGet
    {
      -- | V1 error format.
...
-- | Creates a value of 'DLPProjectsDeidentifyTemplatesGet' with the minimum fields required to make a request.
newDLPProjectsDeidentifyTemplatesGet 
    ::  Core.Text
    ...
    -> DLPProjectsDeidentifyTemplatesGet
newDLPProjectsDeidentifyTemplatesGet name =
  DLPProjectsDeidentifyTemplatesGet
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           DLPProjectsDeidentifyTemplatesGet
         where
        type Rs DLPProjectsDeidentifyTemplatesGet =
             GooglePrivacyDlpV2DeidentifyTemplate
        type Scopes DLPProjectsDeidentifyTemplatesGet =
        ...
        requestClient DLPProjectsDeidentifyTemplatesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsDeidentifyTemplatesGetResource)
                      Core.mempty
