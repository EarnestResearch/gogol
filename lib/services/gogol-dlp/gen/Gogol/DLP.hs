...
module Gogol.DLP
    ...
    , DLPProjectsLocationsInfoTypesListResource
    , DLPProjectsLocationsInfoTypesList (..)
    , newDLPProjectsLocationsInfoTypesList
...
import Gogol.DLP.Organizations.Locations.InfoTypes.List
...
import Gogol.DLP.Projects.Locations.InfoTypes.List
