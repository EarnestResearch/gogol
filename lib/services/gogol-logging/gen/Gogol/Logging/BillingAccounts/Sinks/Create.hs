...
-- |
-- Module      : Gogol.Logging.BillingAccounts.Sinks.Create
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.billingAccounts.sinks.create@.
module Gogol.Logging.BillingAccounts.Sinks.Create
    (
    -- * Resource
...
-- 'LoggingBillingAccountsSinksCreate' request conforms to.
type LoggingBillingAccountsSinksCreateResource =
     "v2" Core.:>
...
-- | Creates a sink that exports specified log entries to a destination. The export of newly-ingested log entries begins immediately, unless the sink\'s writer_identity is not permitted to write to the destination. A sink can export log entries only from the resource owning the sink.
--
-- /See:/ 'newLoggingBillingAccountsSinksCreate' smart constructor.
data LoggingBillingAccountsSinksCreate = LoggingBillingAccountsSinksCreate
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingBillingAccountsSinksCreate' with the minimum fields required to make a request.
newLoggingBillingAccountsSinksCreate 
    ::  Core.Text
    ...
    -> LoggingBillingAccountsSinksCreate
newLoggingBillingAccountsSinksCreate parent payload =
  LoggingBillingAccountsSinksCreate
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingBillingAccountsSinksCreate =
        ...
        requestClient LoggingBillingAccountsSinksCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingBillingAccountsSinksCreateResource)
                      Core.mempty
