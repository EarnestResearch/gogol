...
-- |
-- Module      : Gogol.Logging.BillingAccounts.Sinks.Update
...
-- 'LoggingBillingAccountsSinksUpdate' request conforms to.
type LoggingBillingAccountsSinksUpdateResource =
     "v2" Core.:>
                     ...
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] LogSink Core.:>
                           Core.Put '[Core.JSON] LogSink

-- | Updates a sink. This method replaces the following fields in the existing sink with values from the new sink: destination, and filter.The updated sink might also have a new writer/identity; see the unique/writer_identity field.
--
-- /See:/ 'newLoggingBillingAccountsSinksUpdate' smart constructor.
data LoggingBillingAccountsSinksUpdate = LoggingBillingAccountsSinksUpdate
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingBillingAccountsSinksUpdate' with the minimum fields required to make a request.
newLoggingBillingAccountsSinksUpdate 
    ::  LogSink
    ...
    -> LoggingBillingAccountsSinksUpdate
newLoggingBillingAccountsSinksUpdate payload sinkName =
  LoggingBillingAccountsSinksUpdate
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           LoggingBillingAccountsSinksUpdate
         where
        type Rs LoggingBillingAccountsSinksUpdate = LogSink
        type Scopes LoggingBillingAccountsSinksUpdate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingBillingAccountsSinksUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingBillingAccountsSinksUpdateResource)
                      Core.mempty
