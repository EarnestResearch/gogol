...
newLoggingBillingAccountsLocationsList name
  = LoggingBillingAccountsLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingBillingAccountsLocationsList
         where
        type Rs LoggingBillingAccountsLocationsList = ListLocationsResponse
        type Scopes LoggingBillingAccountsLocationsList =
        ...
        requestClient LoggingBillingAccountsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingBillingAccountsLocationsListResource)
                      Core.mempty
