...
instance Core.ToJSON BigQueryOptions where
        toJSON BigQueryOptions{..}
          = Core.object
              (Core.catMaybes
                 [("usePartitionedTables" Core..=) Core.<$>
...
instance Core.FromJSON BucketMetadata where
        parseJSON
          = Core.withObject "BucketMetadata"
              (\ o ->
                 BucketMetadata Core.<$>
                   (o Core..:? "createBucketRequest") Core.<*>
                     (o Core..:? "endTime")
...
instance Core.ToJSON BucketMetadata where
        toJSON BucketMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("createBucketRequest" Core..=) Core.<$>
                    createBucketRequest,
                  ("endTime" Core..=) Core.<$> endTime,
                  ("startTime" Core..=) Core.<$> startTime,
                  ("state" Core..=) Core.<$> state,
                  ("updateBucketRequest" Core..=) Core.<$>
                    updateBucketRequest])
...
instance Core.ToJSON CopyLogEntriesMetadata where
        toJSON CopyLogEntriesMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("cancellationRequested" Core..=) Core.<$>
...
newCopyLogEntriesRequest =
  CopyLogEntriesRequest
    {destination = Core.Nothing, filter = Core.Nothing, name = Core.Nothing}
...
newCreateBucketRequest =
  CreateBucketRequest
    {bucket = Core.Nothing, bucketId = Core.Nothing, parent = Core.Nothing}
...
newCreateLinkRequest =
  CreateLinkRequest
    {link = Core.Nothing, linkId = Core.Nothing, parent = Core.Nothing}
          ...
          = Core.withObject "CreateLinkRequest"
              (\ o ->
                 CreateLinkRequest Core.<$>
                   (o Core..:? "link") Core.<*> (o Core..:? "linkId")
                     Core.<*> (o Core..:? "parent"))
...
newIndexConfig =
  IndexConfig
    {createTime = Core.Nothing, fieldPath = Core.Nothing, type' = Core.Nothing}
...
instance Core.ToJSON LinkMetadata where
        toJSON LinkMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("createLinkRequest" Core..=) Core.<$>
                    createLinkRequest,
                  ("deleteLinkRequest" Core..=) Core.<$>
                    deleteLinkRequest,
                  ("endTime" Core..=) Core.<$> endTime,
                  ("startTime" Core..=) Core.<$> startTime,
                  ("state" Core..=) Core.<$> state])
...
newListExclusionsResponse =
  ListExclusionsResponse
    {exclusions = Core.Nothing, nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListLogEntriesRequest"
              (\ o ->
                 ListLogEntriesRequest Core.<$>
                   (o Core..:? "filter") Core.<*> (o Core..:? "orderBy")
...
instance Core.FromJSON LogMetric_LabelExtractors
         where
        parseJSON
          = Core.withObject "LogMetric_LabelExtractors"
              (\ o ->
                 LogMetric_LabelExtractors Core.<$>
                   (Core.parseJSONObject o))
...
newLogSplit =
  LogSplit
    {index = Core.Nothing, totalSplits = Core.Nothing, uid = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("appEngineRelease" Core..=) Core.<$>
                  ...
                  ("latency" Core..=) Core.<$> latency,
                  ("line" Core..=) Core.<$> line,
                  ("megaCycles" Core..=) Core.. Core.AsText Core.<$>
                    megaCycles,
...
instance Core.FromJSON Settings where
        parseJSON
          = Core.withObject "Settings"
              (\ o ->
                 Settings Core.<$>
                   (o Core..:? "disableDefaultSink") Core.<*>
                     (o Core..:? "kmsKeyName")
...
instance Core.ToJSON Settings where
        toJSON Settings{..}
          = Core.object
              (Core.catMaybes
                 [("disableDefaultSink" Core..=) Core.<$>
                    disableDefaultSink,
                  ("kmsKeyName" Core..=) Core.<$> kmsKeyName,
                  ("kmsServiceAccountId" Core..=) Core.<$>
                    kmsServiceAccountId,
                  ("name" Core..=) Core.<$> name,
                  ("storageLocation" Core..=) Core.<$>
                    storageLocation])
...
newSourceLocation =
  SourceLocation
    {file = Core.Nothing, functionName = Core.Nothing, line = Core.Nothing}
...
newTailLogEntriesResponse =
  TailLogEntriesResponse
    {entries = Core.Nothing, suppressionInfo = Core.Nothing}
...
newUpdateBucketRequest =
  UpdateBucketRequest
    {bucket = Core.Nothing, name = Core.Nothing, updateMask = Core.Nothing}
          ...
          = Core.withObject "UpdateBucketRequest"
              (\ o ->
                 UpdateBucketRequest Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "name")
          ...
          = Core.withObject "WriteLogEntriesRequest"
              (\ o ->
                 WriteLogEntriesRequest Core.<$>
                   (o Core..:? "dryRun") Core.<*> (o Core..:? "entries")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "logName")
...
instance Core.FromJSON WriteLogEntriesRequest_Labels
         where
        parseJSON
          = Core.withObject "WriteLogEntriesRequest_Labels"
              (\ o ->
                 WriteLogEntriesRequest_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON WriteLogEntriesRequest_Labels
         where
