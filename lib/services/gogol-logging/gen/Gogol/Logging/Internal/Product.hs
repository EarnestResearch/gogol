...
--
-- /See:/ 'newAppHub' smart constructor.
data AppHub = AppHub
    {
      -- | Metadata associated with the application.
      application :: (Core.Maybe AppHubApplication)
      -- | Metadata associated with the service.
    , service :: (Core.Maybe AppHubService)
      -- | Metadata associated with the workload.
    , workload :: (Core.Maybe AppHubWorkload)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AppHub' with the minimum fields required to make a request.
newAppHub 
    ::  AppHub
newAppHub
  = AppHub{application = Core.Nothing, service = Core.Nothing,
           workload = Core.Nothing}
instance Core.FromJSON AppHub where
        parseJSON
          = Core.withObject "AppHub"
              (\ o ->
                 AppHub Core.<$>
                   (o Core..:? "application") Core.<*> (o Core..:? "service") Core.<*>
                     (o Core..:? "workload"))

instance Core.ToJSON AppHub where
        toJSON AppHub{..}
          = Core.object
              (Core.catMaybes
                 [("application" Core..=) Core.<$> application,
                  ("service" Core..=) Core.<$> service,
                  ("workload" Core..=) Core.<$> workload])
...
--
-- /See:/ 'newAppHubApplication' smart constructor.
data AppHubApplication = AppHubApplication
    {
...
-- | Creates a value of 'AppHubApplication' with the minimum fields required to make a request.
newAppHubApplication 
    ::  AppHubApplication
newAppHubApplication
  = AppHubApplication{container = Core.Nothing, id = Core.Nothing,
                      location = Core.Nothing}
instance Core.FromJSON AppHubApplication where
        parseJSON
          = Core.withObject "AppHubApplication"
              (\ o ->
                 AppHubApplication Core.<$>
                   (o Core..:? "container") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "location"))

instance Core.ToJSON AppHubApplication where
        toJSON AppHubApplication{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newAppHubService' smart constructor.
data AppHubService = AppHubService
    {
      -- | Service criticality type Example: \"CRITICAL\"
      criticalityType :: (Core.Maybe Core.Text)
      -- | Service environment type Example: \"DEV\"
    , environmentType :: (Core.Maybe Core.Text)
      -- | Service Id. Example: \"my-service\"
    , id :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AppHubService' with the minimum fields required to make a request.
newAppHubService 
    ::  AppHubService
newAppHubService
  = AppHubService{criticalityType = Core.Nothing,
                  environmentType = Core.Nothing, id = Core.Nothing}
instance Core.FromJSON AppHubService where
        parseJSON
          = Core.withObject "AppHubService"
              (\ o ->
                 AppHubService Core.<$>
                   (o Core..:? "criticalityType") Core.<*>
                     (o Core..:? "environmentType")
                     Core.<*> (o Core..:? "id"))

instance Core.ToJSON AppHubService where
        toJSON AppHubService{..}
          = Core.object
              (Core.catMaybes
                 [("criticalityType" Core..=) Core.<$> criticalityType,
                  ("environmentType" Core..=) Core.<$> environmentType,
                  ("id" Core..=) Core.<$> id])


-- | Metadata associated with an App Hub workload.
--
-- /See:/ 'newAppHubWorkload' smart constructor.
data AppHubWorkload = AppHubWorkload
    {
...
-- | Creates a value of 'AppHubWorkload' with the minimum fields required to make a request.
newAppHubWorkload 
    ::  AppHubWorkload
newAppHubWorkload
  = AppHubWorkload{criticalityType = Core.Nothing,
                   environmentType = Core.Nothing, id = Core.Nothing}
instance Core.FromJSON AppHubWorkload where
        parseJSON
          = Core.withObject "AppHubWorkload"
              (\ o ->
                 AppHubWorkload Core.<$>
                   (o Core..:? "criticalityType") Core.<*>
                     (o Core..:? "environmentType")
...
instance Core.ToJSON AppHubWorkload where
        toJSON AppHubWorkload{..}
          = Core.object
              (Core.catMaybes
                 [("criticalityType" Core..=) Core.<$> criticalityType,
                  ("environmentType" Core..=) Core.<$> environmentType,
...
instance Core.FromJSON BigQueryDataset where
        parseJSON
          = Core.withObject "BigQueryDataset"
...
newBigQueryOptions 
    ::  BigQueryOptions
newBigQueryOptions
  = BigQueryOptions{usePartitionedTables = Core.Nothing,
                    usesTimestampColumnPartitioning = Core.Nothing}
instance Core.FromJSON BigQueryOptions where
        parseJSON
          = Core.withObject "BigQueryOptions"
              (\ o ->
                 BigQueryOptions Core.<$>
                   (o Core..:? "usePartitionedTables") Core.<*>
                     (o Core..:? "usesTimestampColumnPartitioning"))
          ...
          = Core.object
              (Core.catMaybes
                 [("usePartitionedTables" Core..=) Core.<$> usePartitionedTables,
                  ("usesTimestampColumnPartitioning" Core..=) Core.<$>
...
newBucketMetadata 
    ::  BucketMetadata
newBucketMetadata
  = BucketMetadata{createBucketRequest = Core.Nothing,
                   endTime = Core.Nothing, startTime = Core.Nothing,
                   state = Core.Nothing, updateBucketRequest = Core.Nothing}
instance Core.FromJSON BucketMetadata where
        parseJSON
          = Core.withObject "BucketMetadata"
              (\ o ->
                 BucketMetadata Core.<$>
                   (o Core..:? "createBucketRequest") Core.<*> (o Core..:? "endTime")
...
newBucketOptions 
    ::  BucketOptions
newBucketOptions
  = BucketOptions{explicitBuckets = Core.Nothing,
                  exponentialBuckets = Core.Nothing, linearBuckets = Core.Nothing}
...
newCmekSettings 
    ::  CmekSettings
newCmekSettings
  = CmekSettings{kmsKeyName = Core.Nothing,
                 kmsKeyVersionName = Core.Nothing, name = Core.Nothing,
                 serviceAccountId = Core.Nothing}
instance Core.FromJSON CmekSettings where
        parseJSON
          = Core.withObject "CmekSettings"
              (\ o ->
                 CmekSettings Core.<$>
                   (o Core..:? "kmsKeyName") Core.<*> (o Core..:? "kmsKeyVersionName")
                     Core.<*> (o Core..:? "name")
...
newCopyLogEntriesMetadata 
    ::  CopyLogEntriesMetadata
newCopyLogEntriesMetadata
  = CopyLogEntriesMetadata{cancellationRequested = Core.Nothing,
                           destination = Core.Nothing, endTime = Core.Nothing,
                           progress = Core.Nothing, request' = Core.Nothing,
                           source = Core.Nothing, startTime = Core.Nothing,
                           state = Core.Nothing, verb = Core.Nothing,
                           writerIdentity = Core.Nothing}
instance Core.FromJSON CopyLogEntriesMetadata where
        parseJSON
          = Core.withObject "CopyLogEntriesMetadata"
              (\ o ->
                 CopyLogEntriesMetadata Core.<$>
                   (o Core..:? "cancellationRequested") Core.<*>
                     (o Core..:? "destination")
                     Core.<*> (o Core..:? "endTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("cancellationRequested" Core..=) Core.<$> cancellationRequested,
                  ...
                  ("startTime" Core..=) Core.<$> startTime,
                  ("state" Core..=) Core.<$> state, ("verb" Core..=) Core.<$> verb,
...
newCopyLogEntriesRequest 
    ::  CopyLogEntriesRequest
newCopyLogEntriesRequest
  = CopyLogEntriesRequest{destination = Core.Nothing,
                          filter = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON CopyLogEntriesRequest where
        parseJSON
          = Core.withObject "CopyLogEntriesRequest"
              (\ o ->
                 CopyLogEntriesRequest Core.<$>
                   (o Core..:? "destination") Core.<*> (o Core..:? "filter") Core.<*>
                     (o Core..:? "name"))
...
instance Core.FromJSON CopyLogEntriesResponse where
        parseJSON
          = Core.withObject "CopyLogEntriesResponse"
              (\ o ->
                 CopyLogEntriesResponse Core.<$>
                   (o Core..:? "logEntriesCopiedCount" Core.<&>
...
instance Core.ToJSON CopyLogEntriesResponse where
        toJSON CopyLogEntriesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("logEntriesCopiedCount" Core..=) Core.. Core.AsText Core.<$>
...
newCreateBucketRequest 
    ::  CreateBucketRequest
newCreateBucketRequest
  = CreateBucketRequest{bucket = Core.Nothing,
                        bucketId = Core.Nothing, parent = Core.Nothing}
instance Core.FromJSON CreateBucketRequest where
        parseJSON
          = Core.withObject "CreateBucketRequest"
              (\ o ->
                 CreateBucketRequest Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "bucketId") Core.<*>
                     (o Core..:? "parent"))
...
data CreateLinkRequest = CreateLinkRequest
    ...
    , linkId :: (Core.Maybe Core.Text)
      -- | Required. The full resource name of the bucket to create a link for. \"projects\/[PROJECT/ID]\/locations\/[LOCATION/ID]\/buckets\/[BUCKET_ID]\"
    , parent :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newCreateLinkRequest 
    ::  CreateLinkRequest
newCreateLinkRequest
  = CreateLinkRequest{link = Core.Nothing, linkId = Core.Nothing,
                      parent = Core.Nothing}
instance Core.FromJSON CreateLinkRequest where
        parseJSON
          = Core.withObject "CreateLinkRequest"
              (\ o ->
                 CreateLinkRequest Core.<$>
                   (o Core..:? "link") Core.<*> (o Core..:? "linkId") Core.<*>
                     (o Core..:? "parent"))
...
newDefaultSinkConfig 
    ::  DefaultSinkConfig
newDefaultSinkConfig
  = DefaultSinkConfig{exclusions = Core.Nothing,
                      filter = Core.Nothing, mode = Core.Nothing}
instance Core.FromJSON DefaultSinkConfig where
        parseJSON
          = Core.withObject "DefaultSinkConfig"
              (\ o ->
                 DefaultSinkConfig Core.<$>
                   (o Core..:? "exclusions") Core.<*> (o Core..:? "filter") Core.<*>
                     (o Core..:? "mode"))
...
instance Core.FromJSON DeleteLinkRequest where
        parseJSON
          = Core.withObject "DeleteLinkRequest"
...
newExponential 
    ::  Exponential
newExponential
  = Exponential{growthFactor = Core.Nothing,
                numFiniteBuckets = Core.Nothing, scale = Core.Nothing}
...
newHttpRequest 
    ::  HttpRequest
newHttpRequest
  = HttpRequest{cacheFillBytes = Core.Nothing,
                cacheHit = Core.Nothing, cacheLookup = Core.Nothing,
                cacheValidatedWithOriginServer = Core.Nothing,
                latency = Core.Nothing, protocol = Core.Nothing,
                referer = Core.Nothing, remoteIp = Core.Nothing,
                requestMethod = Core.Nothing, requestSize = Core.Nothing,
                requestUrl = Core.Nothing, responseSize = Core.Nothing,
                serverIp = Core.Nothing, status = Core.Nothing,
...
instance Core.FromJSON HttpRequest where
        parseJSON
          = Core.withObject "HttpRequest"
              (\ o ->
                 HttpRequest Core.<$>
                   (o Core..:? "cacheFillBytes" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "requestSize" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "requestUrl")
                     Core.<*>
                     (o Core..:? "responseSize" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON HttpRequest where
        toJSON HttpRequest{..}
          = Core.object
              (Core.catMaybes
                 [("cacheFillBytes" Core..=) Core.. Core.AsText Core.<$>
                    cacheFillBytes,
...
newIndexConfig 
    ::  IndexConfig
newIndexConfig
  = IndexConfig{createTime = Core.Nothing, fieldPath = Core.Nothing,
                type' = Core.Nothing}
instance Core.FromJSON IndexConfig where
        parseJSON
          = Core.withObject "IndexConfig"
              (\ o ->
                 IndexConfig Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "fieldPath")
                     Core.<*> (o Core..:? "type"))
...
newLinear 
    ::  Linear
newLinear
  = Linear{numFiniteBuckets = Core.Nothing, offset = Core.Nothing,
           width = Core.Nothing}
instance Core.FromJSON Linear where
        parseJSON
          = Core.withObject "Linear"
              (\ o ->
                 Linear Core.<$>
                   (o Core..:? "numFiniteBuckets") Core.<*> (o Core..:? "offset")
                     Core.<*> (o Core..:? "width"))
...
newLink 
    ::  Link
newLink
  = Link{bigqueryDataset = Core.Nothing, createTime = Core.Nothing,
         description = Core.Nothing, lifecycleState = Core.Nothing,
         name = Core.Nothing}
instance Core.FromJSON Link where
        parseJSON
          = Core.withObject "Link"
              (\ o ->
                 Link Core.<$>
                   (o Core..:? "bigqueryDataset") Core.<*> (o Core..:? "createTime")
...
newLinkMetadata 
    ::  LinkMetadata
newLinkMetadata
  = LinkMetadata{createLinkRequest = Core.Nothing,
                 deleteLinkRequest = Core.Nothing, endTime = Core.Nothing,
                 startTime = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON LinkMetadata where
        parseJSON
          = Core.withObject "LinkMetadata"
              (\ o ->
                 LinkMetadata Core.<$>
                   (o Core..:? "createLinkRequest") Core.<*>
                     (o Core..:? "deleteLinkRequest")
                     Core.<*> (o Core..:? "endTime")
                     Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "state"))
...
instance Core.FromJSON ListBucketsResponse where
        parseJSON
          = Core.withObject "ListBucketsResponse"
              (\ o ->
                 ListBucketsResponse Core.<$>
                   (o Core..:? "buckets") Core.<*> (o Core..:? "nextPageToken"))
...
newListExclusionsResponse 
    ::  ListExclusionsResponse
newListExclusionsResponse
  = ListExclusionsResponse{exclusions = Core.Nothing,
                           nextPageToken = Core.Nothing}
instance Core.FromJSON ListExclusionsResponse where
        parseJSON
          = Core.withObject "ListExclusionsResponse"
              (\ o ->
                 ListExclusionsResponse Core.<$>
                   (o Core..:? "exclusions") Core.<*> (o Core..:? "nextPageToken"))
...
newListLinksResponse 
    ::  ListLinksResponse
newListLinksResponse
  = ListLinksResponse{links = Core.Nothing,
                      nextPageToken = Core.Nothing}
instance Core.FromJSON ListLinksResponse where
        parseJSON
          = Core.withObject "ListLinksResponse"
              (\ o ->
                 ListLinksResponse Core.<$>
                   (o Core..:? "links") Core.<*> (o Core..:? "nextPageToken"))
...
newListLogEntriesRequest 
    ::  ListLogEntriesRequest
newListLogEntriesRequest
  = ListLogEntriesRequest{filter = Core.Nothing,
                          orderBy = Core.Nothing, pageSize = Core.Nothing,
                          pageToken = Core.Nothing, projectIds = Core.Nothing,
                          resourceNames = Core.Nothing}
instance Core.FromJSON ListLogEntriesRequest where
        parseJSON
          = Core.withObject "ListLogEntriesRequest"
              (\ o ->
                 ListLogEntriesRequest Core.<$>
                   (o Core..:? "filter") Core.<*> (o Core..:? "orderBy") Core.<*>
                     (o Core..:? "pageSize")
...
newListLogEntriesResponse 
    ::  ListLogEntriesResponse
newListLogEntriesResponse
  = ListLogEntriesResponse{entries = Core.Nothing,
                           nextPageToken = Core.Nothing}
instance Core.FromJSON ListLogEntriesResponse where
        parseJSON
          = Core.withObject "ListLogEntriesResponse"
              (\ o ->
                 ListLogEntriesResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "nextPageToken"))
...
newListLogMetricsResponse 
    ::  ListLogMetricsResponse
newListLogMetricsResponse
  = ListLogMetricsResponse{metrics = Core.Nothing,
                           nextPageToken = Core.Nothing}
instance Core.FromJSON ListLogMetricsResponse where
        parseJSON
          = Core.withObject "ListLogMetricsResponse"
              (\ o ->
                 ListLogMetricsResponse Core.<$>
                   (o Core..:? "metrics") Core.<*> (o Core..:? "nextPageToken"))
...
newListLogScopesResponse 
    ::  ListLogScopesResponse
newListLogScopesResponse
  = ListLogScopesResponse{logScopes = Core.Nothing,
                          nextPageToken = Core.Nothing}
instance Core.FromJSON ListLogScopesResponse where
        parseJSON
          = Core.withObject "ListLogScopesResponse"
              (\ o ->
                 ListLogScopesResponse Core.<$>
                   (o Core..:? "logScopes") Core.<*> (o Core..:? "nextPageToken"))
...
newListLogsResponse 
    ::  ListLogsResponse
newListLogsResponse
  = ListLogsResponse{logNames = Core.Nothing,
                     nextPageToken = Core.Nothing}
instance Core.FromJSON ListLogsResponse where
        parseJSON
          = Core.withObject "ListLogsResponse"
              (\ o ->
                 ListLogsResponse Core.<$>
                   (o Core..:? "logNames") Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListMonitoredResourceDescriptorsResponse
         where
        parseJSON
          = Core.withObject "ListMonitoredResourceDescriptorsResponse"
              (\ o ->
                 ListMonitoredResourceDescriptorsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "resourceDescriptors"))
...
newListRecentQueriesResponse 
    ::  ListRecentQueriesResponse
newListRecentQueriesResponse
  = ListRecentQueriesResponse{nextPageToken = Core.Nothing,
                              recentQueries = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListRecentQueriesResponse where
        parseJSON
          = Core.withObject "ListRecentQueriesResponse"
              (\ o ->
                 ListRecentQueriesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "recentQueries")
...
newListSavedQueriesResponse 
    ::  ListSavedQueriesResponse
newListSavedQueriesResponse
  = ListSavedQueriesResponse{nextPageToken = Core.Nothing,
                             savedQueries = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListSavedQueriesResponse where
        parseJSON
          = Core.withObject "ListSavedQueriesResponse"
              (\ o ->
                 ListSavedQueriesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "savedQueries")
                     Core.<*> (o Core..:? "unreachable"))
...
newListSinksResponse 
    ::  ListSinksResponse
newListSinksResponse
  = ListSinksResponse{nextPageToken = Core.Nothing,
                      sinks = Core.Nothing}
instance Core.FromJSON ListSinksResponse where
        parseJSON
          = Core.withObject "ListSinksResponse"
              (\ o ->
                 ListSinksResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "sinks"))
...
newListViewsResponse 
    ::  ListViewsResponse
newListViewsResponse
  = ListViewsResponse{nextPageToken = Core.Nothing,
                      views = Core.Nothing}
instance Core.FromJSON ListViewsResponse where
        parseJSON
          = Core.withObject "ListViewsResponse"
              (\ o ->
                 ListViewsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "views"))
...
newLogBucket 
    ::  LogBucket
newLogBucket
  = LogBucket{analyticsEnabled = Core.Nothing,
              cmekSettings = Core.Nothing, createTime = Core.Nothing,
              description = Core.Nothing, indexConfigs = Core.Nothing,
              lifecycleState = Core.Nothing, locked = Core.Nothing,
              name = Core.Nothing, restrictedFields = Core.Nothing,
              retentionDays = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON LogBucket where
        parseJSON
          = Core.withObject "LogBucket"
              (\ o ->
                 LogBucket Core.<$>
                   (o Core..:? "analyticsEnabled") Core.<*>
                     (o Core..:? "cmekSettings")
          ...
          = Core.object
              (Core.catMaybes
                 [("analyticsEnabled" Core..=) Core.<$> analyticsEnabled,
                  ...
                  ("lifecycleState" Core..=) Core.<$> lifecycleState,
                  ("locked" Core..=) Core.<$> locked, ("name" Core..=) Core.<$> name,
...
data LogEntry = LogEntry
    ...
    , apphubDestination :: (Core.Maybe AppHub)
...
newLogEntry 
    ::  LogEntry
newLogEntry
  = LogEntry{apphub = Core.Nothing, apphubDestination = Core.Nothing,
             errorGroups = Core.Nothing, httpRequest = Core.Nothing,
             insertId = Core.Nothing, jsonPayload = Core.Nothing,
             labels = Core.Nothing, logName = Core.Nothing,
             metadata = Core.Nothing, operation = Core.Nothing,
             protoPayload = Core.Nothing, receiveTimestamp = Core.Nothing,
             resource = Core.Nothing, severity = Core.Nothing,
             sourceLocation = Core.Nothing, spanId = Core.Nothing,
             split = Core.Nothing, textPayload = Core.Nothing,
             timestamp = Core.Nothing, trace = Core.Nothing,
             traceSampled = Core.Nothing}
instance Core.FromJSON LogEntry where
        parseJSON
          = Core.withObject "LogEntry"
              (\ o ->
                 LogEntry Core.<$>
                   (o Core..:? "apphub") Core.<*> (o Core..:? "apphubDestination")
...
instance Core.ToJSON LogEntry where
        toJSON LogEntry{..}
          = Core.object
              (Core.catMaybes
                 [("apphub" Core..=) Core.<$> apphub,
                  ("apphubDestination" Core..=) Core.<$> apphubDestination,
...
instance Core.FromJSON LogEntry_JsonPayload where
        parseJSON
          = Core.withObject "LogEntry_JsonPayload"
...
instance Core.FromJSON LogEntry_Labels where
        parseJSON
          = Core.withObject "LogEntry_Labels"
...
instance Core.FromJSON LogEntry_ProtoPayload where
        parseJSON
          = Core.withObject "LogEntry_ProtoPayload"
...
newLogEntryOperation 
    ::  LogEntryOperation
newLogEntryOperation
  = LogEntryOperation{first = Core.Nothing, id = Core.Nothing,
                      last = Core.Nothing, producer = Core.Nothing}
instance Core.FromJSON LogEntryOperation where
        parseJSON
          = Core.withObject "LogEntryOperation"
              (\ o ->
                 LogEntryOperation Core.<$>
                   (o Core..:? "first") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "last")
...
instance Core.ToJSON LogEntryOperation where
        toJSON LogEntryOperation{..}
          = Core.object
              (Core.catMaybes
                 [("first" Core..=) Core.<$> first, ("id" Core..=) Core.<$> id,
                  ("last" Core..=) Core.<$> last,
...
newLogEntrySourceLocation 
    ::  LogEntrySourceLocation
newLogEntrySourceLocation
  = LogEntrySourceLocation{file = Core.Nothing,
                           function = Core.Nothing, line = Core.Nothing}
instance Core.FromJSON LogEntrySourceLocation where
        parseJSON
          = Core.withObject "LogEntrySourceLocation"
              (\ o ->
                 LogEntrySourceLocation Core.<$>
                   (o Core..:? "file") Core.<*> (o Core..:? "function") Core.<*>
                     (o Core..:? "line" Core.<&> Core.fmap Core.fromAsText))
...
newLogExclusion 
    ::  LogExclusion
newLogExclusion
  = LogExclusion{createTime = Core.Nothing,
                 description = Core.Nothing, disabled = Core.Nothing,
                 filter = Core.Nothing, name = Core.Nothing,
                 updateTime = Core.Nothing}
instance Core.FromJSON LogExclusion where
        parseJSON
          = Core.withObject "LogExclusion"
              (\ o ->
                 LogExclusion Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("filter" Core..=) Core.<$> filter, ("name" Core..=) Core.<$> name,
                  ("updateTime" Core..=) Core.<$> updateTime])
...
newLogLine 
    ::  LogLine
newLogLine
  = LogLine{logMessage = Core.Nothing, severity = Core.Nothing,
            sourceLocation = Core.Nothing, time = Core.Nothing}
instance Core.FromJSON LogLine where
        parseJSON
          = Core.withObject "LogLine"
              (\ o ->
                 LogLine Core.<$>
                   (o Core..:? "logMessage") Core.<*> (o Core..:? "severity") Core.<*>
...
newLogMetric 
    ::  LogMetric
newLogMetric
  = LogMetric{bucketName = Core.Nothing,
              bucketOptions = Core.Nothing, createTime = Core.Nothing,
              description = Core.Nothing, disabled = Core.Nothing,
              filter = Core.Nothing, labelExtractors = Core.Nothing,
              metricDescriptor = Core.Nothing, name = Core.Nothing,
              resourceName = Core.Nothing, updateTime = Core.Nothing,
              valueExtractor = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON LogMetric where
        parseJSON
          = Core.withObject "LogMetric"
              (\ o ->
                 LogMetric Core.<$>
                   (o Core..:? "bucketName") Core.<*> (o Core..:? "bucketOptions")
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "disabled")
                     Core.<*> (o Core..:? "filter")
...
instance Core.FromJSON LogMetric_LabelExtractors where
        parseJSON
          = Core.withObject "LogMetric_LabelExtractors"
              (\ o ->
...
newLogScope 
    ::  LogScope
newLogScope
  = LogScope{createTime = Core.Nothing, description = Core.Nothing,
             name = Core.Nothing, resourceNames = Core.Nothing,
             updateTime = Core.Nothing}
instance Core.FromJSON LogScope where
        parseJSON
          = Core.withObject "LogScope"
              (\ o ->
                 LogScope Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "name")
...
newLogSink 
    ::  LogSink
newLogSink
  = LogSink{bigqueryOptions = Core.Nothing,
            createTime = Core.Nothing, description = Core.Nothing,
            destination = Core.Nothing, disabled = Core.Nothing,
            exclusions = Core.Nothing, filter = Core.Nothing,
            includeChildren = Core.Nothing, interceptChildren = Core.Nothing,
            name = Core.Nothing, outputVersionFormat = Core.Nothing,
            resourceName = Core.Nothing, updateTime = Core.Nothing,
            writerIdentity = Core.Nothing}
instance Core.FromJSON LogSink where
        parseJSON
          = Core.withObject "LogSink"
              (\ o ->
                 LogSink Core.<$>
                   (o Core..:? "bigqueryOptions") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "description")
...
newLogSplit 
    ::  LogSplit
newLogSplit
  = LogSplit{index = Core.Nothing, totalSplits = Core.Nothing,
             uid = Core.Nothing}
instance Core.FromJSON LogSplit where
        parseJSON
          = Core.withObject "LogSplit"
              (\ o ->
                 LogSplit Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "totalSplits") Core.<*>
                     (o Core..:? "uid"))
...
newLogView 
    ::  LogView
newLogView
  = LogView{createTime = Core.Nothing, description = Core.Nothing,
            filter = Core.Nothing, name = Core.Nothing,
            updateTime = Core.Nothing}
instance Core.FromJSON LogView where
        parseJSON
          = Core.withObject "LogView"
              (\ o ->
                 LogView Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "filter")
...
newLoggingQuery 
    ::  LoggingQuery
newLoggingQuery
  = LoggingQuery{filter = Core.Nothing,
                 summaryFieldEnd = Core.Nothing, summaryFieldStart = Core.Nothing,
                 summaryFields = Core.Nothing}
instance Core.FromJSON LoggingQuery where
        parseJSON
          = Core.withObject "LoggingQuery"
              (\ o ->
                 LoggingQuery Core.<$>
                   (o Core..:? "filter") Core.<*> (o Core..:? "summaryFieldEnd")
...
newMonitoredResourceMetadata 
    ::  MonitoredResourceMetadata
newMonitoredResourceMetadata
  = MonitoredResourceMetadata{systemLabels = Core.Nothing,
          ...
          = Core.withObject "MonitoredResourceMetadata"
              (\ o ->
                 MonitoredResourceMetadata Core.<$>
                   (o Core..:? "systemLabels") Core.<*> (o Core..:? "userLabels"))
...
instance Core.FromJSON MonitoredResourceMetadata_SystemLabels where
        parseJSON
          = Core.withObject "MonitoredResourceMetadata_SystemLabels"
              (\ o ->
...
instance Core.FromJSON MonitoredResourceMetadata_UserLabels where
        parseJSON
          = Core.withObject "MonitoredResourceMetadata_UserLabels"
              (\ o ->
...
instance Core.FromJSON OpsAnalyticsQuery where
        parseJSON
          = Core.withObject "OpsAnalyticsQuery"
...
data RecentQuery = RecentQuery
    ...
    , loggingQuery :: (Core.Maybe LoggingQuery)
      -- | Optional. Resource name of the recent query.In the format: \"projects\/[PROJECT/ID]\/locations\/[LOCATION/ID]\/recentQueries\/[QUERY/ID]\" For a list of supported locations, see Supported Regions (https:\/\/cloud.google.com\/logging\/docs\/region-support)The QUERY/ID is a system generated alphanumeric ID.
    , name :: (Core.Maybe Core.Text)
...
newRecentQuery 
    ::  RecentQuery
newRecentQuery
  = RecentQuery{lastRunTime = Core.Nothing,
                loggingQuery = Core.Nothing, name = Core.Nothing,
                opsAnalyticsQuery = Core.Nothing}
instance Core.FromJSON RecentQuery where
        parseJSON
          = Core.withObject "RecentQuery"
              (\ o ->
                 RecentQuery Core.<$>
                   (o Core..:? "lastRunTime") Core.<*> (o Core..:? "loggingQuery")
                     Core.<*> (o Core..:? "name")
...
newRequestLog 
    ::  RequestLog
newRequestLog
  = RequestLog{appEngineRelease = Core.Nothing, appId = Core.Nothing,
               cost = Core.Nothing, endTime = Core.Nothing,
               finished = Core.Nothing, first = Core.Nothing, host = Core.Nothing,
               httpVersion = Core.Nothing, instanceId = Core.Nothing,
               instanceIndex = Core.Nothing, ip = Core.Nothing,
               latency = Core.Nothing, line = Core.Nothing,
               megaCycles = Core.Nothing, method = Core.Nothing,
               moduleId = Core.Nothing, nickname = Core.Nothing,
               pendingTime = Core.Nothing, referrer = Core.Nothing,
               requestId = Core.Nothing, resource = Core.Nothing,
               responseSize = Core.Nothing, sourceReference = Core.Nothing,
               spanId = Core.Nothing, startTime = Core.Nothing,
               status = Core.Nothing, taskName = Core.Nothing,
               taskQueueName = Core.Nothing, traceId = Core.Nothing,
               traceSampled = Core.Nothing, urlMapEntry = Core.Nothing,
               userAgent = Core.Nothing, versionId = Core.Nothing,
               wasLoadingRequest = Core.Nothing}
instance Core.FromJSON RequestLog where
        parseJSON
          = Core.withObject "RequestLog"
              (\ o ->
                 RequestLog Core.<$>
                   (o Core..:? "appEngineRelease") Core.<*> (o Core..:? "appId")
                     Core.<*> (o Core..:? "cost")
                     Core.<*> (o Core..:? "endTime")
                     ...
                     Core.<*> (o Core..:? "line")
                     Core.<*>
                     (o Core..:? "megaCycles" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "method")
          ...
          = Core.object
              (Core.catMaybes
                 [("appEngineRelease" Core..=) Core.<$> appEngineRelease,
                  ("appId" Core..=) Core.<$> appId, ("cost" Core..=) Core.<$> cost,
                  ("endTime" Core..=) Core.<$> endTime,
                  ("finished" Core..=) Core.<$> finished,
                  ("first" Core..=) Core.<$> first, ("host" Core..=) Core.<$> host,
                  ("httpVersion" Core..=) Core.<$> httpVersion,
                  ("instanceId" Core..=) Core.<$> instanceId,
                  ("instanceIndex" Core..=) Core.<$> instanceIndex,
                  ("ip" Core..=) Core.<$> ip, ("latency" Core..=) Core.<$> latency,
                  ("line" Core..=) Core.<$> line,
...
newSavedQuery 
    ::  SavedQuery
newSavedQuery
  = SavedQuery{createTime = Core.Nothing, description = Core.Nothing,
               displayName = Core.Nothing, loggingQuery = Core.Nothing,
               name = Core.Nothing, opsAnalyticsQuery = Core.Nothing,
               updateTime = Core.Nothing, visibility = Core.Nothing}
instance Core.FromJSON SavedQuery where
        parseJSON
          = Core.withObject "SavedQuery"
              (\ o ->
                 SavedQuery Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "description")
...
newSettings 
    ::  Settings
newSettings
  = Settings{defaultSinkConfig = Core.Nothing,
             disableDefaultSink = Core.Nothing, kmsKeyName = Core.Nothing,
             kmsServiceAccountId = Core.Nothing,
             loggingServiceAccountId = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Settings where
        parseJSON
          = Core.withObject "Settings"
              (\ o ->
                 Settings Core.<$>
                   (o Core..:? "defaultSinkConfig") Core.<*>
                     (o Core..:? "disableDefaultSink")
          ...
          = Core.object
              (Core.catMaybes
                 [("defaultSinkConfig" Core..=) Core.<$> defaultSinkConfig,
                  ...
                  ("loggingServiceAccountId" Core..=) Core.<$>
...
newSourceLocation 
    ::  SourceLocation
newSourceLocation
  = SourceLocation{file = Core.Nothing, functionName = Core.Nothing,
                   line = Core.Nothing}
instance Core.FromJSON SourceLocation where
        parseJSON
          = Core.withObject "SourceLocation"
              (\ o ->
                 SourceLocation Core.<$>
                   (o Core..:? "file") Core.<*> (o Core..:? "functionName") Core.<*>
                     (o Core..:? "line" Core.<&> Core.fmap Core.fromAsText))
...
newSourceReference 
    ::  SourceReference
newSourceReference
  = SourceReference{repository = Core.Nothing,
                    revisionId = Core.Nothing}
instance Core.FromJSON SourceReference where
        parseJSON
          = Core.withObject "SourceReference"
              (\ o ->
                 SourceReference Core.<$>
                   (o Core..:? "repository") Core.<*> (o Core..:? "revisionId"))
...
newSuppressionInfo 
    ::  SuppressionInfo
newSuppressionInfo
  = SuppressionInfo{reason = Core.Nothing,
                    suppressedCount = Core.Nothing}
instance Core.FromJSON SuppressionInfo where
        parseJSON
          = Core.withObject "SuppressionInfo"
              (\ o ->
                 SuppressionInfo Core.<$>
                   (o Core..:? "reason") Core.<*> (o Core..:? "suppressedCount"))
...
newTailLogEntriesRequest 
    ::  TailLogEntriesRequest
newTailLogEntriesRequest
  = TailLogEntriesRequest{bufferWindow = Core.Nothing,
                          filter = Core.Nothing, resourceNames = Core.Nothing}
instance Core.FromJSON TailLogEntriesRequest where
        parseJSON
          = Core.withObject "TailLogEntriesRequest"
              (\ o ->
                 TailLogEntriesRequest Core.<$>
                   (o Core..:? "bufferWindow") Core.<*> (o Core..:? "filter") Core.<*>
...
newTailLogEntriesResponse 
    ::  TailLogEntriesResponse
newTailLogEntriesResponse
  = TailLogEntriesResponse{entries = Core.Nothing,
                           suppressionInfo = Core.Nothing}
instance Core.FromJSON TailLogEntriesResponse where
        parseJSON
          = Core.withObject "TailLogEntriesResponse"
              (\ o ->
                 TailLogEntriesResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "suppressionInfo"))
...
instance Core.FromJSON UndeleteBucketRequest where
        parseJSON
          = Core.withObject "UndeleteBucketRequest"
...
newUpdateBucketRequest 
    ::  UpdateBucketRequest
newUpdateBucketRequest
  = UpdateBucketRequest{bucket = Core.Nothing, name = Core.Nothing,
                        updateMask = Core.Nothing}
instance Core.FromJSON UpdateBucketRequest where
        parseJSON
          = Core.withObject "UpdateBucketRequest"
              (\ o ->
                 UpdateBucketRequest Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "updateMask"))
...
newWriteLogEntriesRequest 
    ::  WriteLogEntriesRequest
newWriteLogEntriesRequest
  = WriteLogEntriesRequest{dryRun = Core.Nothing,
                           entries = Core.Nothing, labels = Core.Nothing,
                           logName = Core.Nothing, partialSuccess = Core.Nothing,
                           resource = Core.Nothing}
instance Core.FromJSON WriteLogEntriesRequest where
        parseJSON
          = Core.withObject "WriteLogEntriesRequest"
              (\ o ->
                 WriteLogEntriesRequest Core.<$>
                   (o Core..:? "dryRun") Core.<*> (o Core..:? "entries") Core.<*>
                     (o Core..:? "labels")
                     Core.<*> (o Core..:? "logName")
...
instance Core.FromJSON WriteLogEntriesRequest_Labels where
        parseJSON
          = Core.withObject "WriteLogEntriesRequest_Labels"
              (\ o ->
...
instance Core.FromJSON WriteLogEntriesResponse where
        parseJSON
          = Core.withObject "WriteLogEntriesResponse"
