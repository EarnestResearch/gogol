...
-- |
-- Module      : Gogol.Logging.Folders.Locations.Buckets.Links.Get
...
-- Gets a link.
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.folders.locations.buckets.links.get@.
module Gogol.Logging.Folders.Locations.Buckets.Links.Get
    (
    -- * Resource
...
-- | A resource alias for @logging.folders.locations.buckets.links.get@ method which the
-- 'LoggingFoldersLocationsBucketsLinksGet' request conforms to.
type LoggingFoldersLocationsBucketsLinksGetResource =
     "v2" Core.:>
...
-- | Gets a link.
--
-- /See:/ 'newLoggingFoldersLocationsBucketsLinksGet' smart constructor.
data LoggingFoldersLocationsBucketsLinksGet = LoggingFoldersLocationsBucketsLinksGet
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingFoldersLocationsBucketsLinksGet' with the minimum fields required to make a request.
newLoggingFoldersLocationsBucketsLinksGet 
    ::  Core.Text
    ...
    -> LoggingFoldersLocationsBucketsLinksGet
newLoggingFoldersLocationsBucketsLinksGet name =
  LoggingFoldersLocationsBucketsLinksGet
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsLinksGet
         where
        type Rs LoggingFoldersLocationsBucketsLinksGet = Link
        type Scopes LoggingFoldersLocationsBucketsLinksGet =
