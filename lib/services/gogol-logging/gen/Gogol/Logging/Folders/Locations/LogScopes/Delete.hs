...
newLoggingFoldersLocationsLogScopesDelete name
  = LoggingFoldersLocationsLogScopesDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsLogScopesDelete
         where
        type Rs LoggingFoldersLocationsLogScopesDelete = Empty
        type Scopes LoggingFoldersLocationsLogScopesDelete =
