...
-- |
-- Module      : Gogol.Logging.Folders.Locations.Buckets.Create
...
-- 'LoggingFoldersLocationsBucketsCreate' request conforms to.
type LoggingFoldersLocationsBucketsCreateResource =
     "v2" Core.:>
...
-- | Creates a log bucket that can be used to store log entries. After a bucket has been created, the bucket\'s location cannot be changed.
--
-- /See:/ 'newLoggingFoldersLocationsBucketsCreate' smart constructor.
data LoggingFoldersLocationsBucketsCreate = LoggingFoldersLocationsBucketsCreate
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingFoldersLocationsBucketsCreate' with the minimum fields required to make a request.
newLoggingFoldersLocationsBucketsCreate 
    ::  Core.Text
    ...
    -> LoggingFoldersLocationsBucketsCreate
newLoggingFoldersLocationsBucketsCreate parent payload =
  LoggingFoldersLocationsBucketsCreate
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsCreate
         where
        type Rs LoggingFoldersLocationsBucketsCreate =
             LogBucket
        type Scopes LoggingFoldersLocationsBucketsCreate =
