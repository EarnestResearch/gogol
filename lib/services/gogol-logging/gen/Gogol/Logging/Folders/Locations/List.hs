...
-- |
-- Module      : Gogol.Logging.Folders.Locations.List
...
newLoggingFoldersLocationsList name
  = LoggingFoldersLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingFoldersLocationsList where
        type Rs LoggingFoldersLocationsList = ListLocationsResponse
        type Scopes LoggingFoldersLocationsList =
        ...
        requestClient LoggingFoldersLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersLocationsListResource)
                      Core.mempty
