...
newLoggingFoldersLocationsLogScopesGet name
  = LoggingFoldersLocationsLogScopesGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsLogScopesGet
         where
        type Rs LoggingFoldersLocationsLogScopesGet = LogScope
        ...
        requestClient LoggingFoldersLocationsLogScopesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsLogScopesGetResource)
                      Core.mempty
