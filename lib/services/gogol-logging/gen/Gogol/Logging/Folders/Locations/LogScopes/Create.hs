...
newLoggingFoldersLocationsLogScopesCreate parent payload
  = LoggingFoldersLocationsLogScopesCreate{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           logScopeId = Core.Nothing, parent = parent,
                                           payload = payload, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsLogScopesCreate
         where
        type Rs LoggingFoldersLocationsLogScopesCreate = LogScope
        type Scopes LoggingFoldersLocationsLogScopesCreate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsLogScopesCreate{..}
          = go parent xgafv accessToken callback logScopeId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsLogScopesCreateResource)
                      Core.mempty
