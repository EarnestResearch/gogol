...
-- |
-- Module      : Gogol.Logging.Folders.Locations.Buckets.Views.Get
...
-- 'LoggingFoldersLocationsBucketsViewsGet' request conforms to.
type LoggingFoldersLocationsBucketsViewsGetResource =
     "v2" Core.:>
...
-- | Gets a view on a log bucket..
--
-- /See:/ 'newLoggingFoldersLocationsBucketsViewsGet' smart constructor.
data LoggingFoldersLocationsBucketsViewsGet = LoggingFoldersLocationsBucketsViewsGet
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingFoldersLocationsBucketsViewsGet' with the minimum fields required to make a request.
newLoggingFoldersLocationsBucketsViewsGet 
    ::  Core.Text
    ...
    -> LoggingFoldersLocationsBucketsViewsGet
newLoggingFoldersLocationsBucketsViewsGet name =
  LoggingFoldersLocationsBucketsViewsGet
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsViewsGet
         where
        type Rs LoggingFoldersLocationsBucketsViewsGet =
             LogView
        type Scopes LoggingFoldersLocationsBucketsViewsGet =
