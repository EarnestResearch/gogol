...
-- |
-- Module      : Gogol.Logging.Folders.Sinks.Patch
...
-- 'LoggingFoldersSinksPatch' request conforms to.
type LoggingFoldersSinksPatchResource =
     "v2" Core.:>
...
-- | Updates a sink. This method replaces the following fields in the existing sink with values from the new sink: destination, and filter.The updated sink might also have a new writer/identity; see the unique/writer_identity field.
--
-- /See:/ 'newLoggingFoldersSinksPatch' smart constructor.
data LoggingFoldersSinksPatch = LoggingFoldersSinksPatch
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingFoldersSinksPatch' with the minimum fields required to make a request.
newLoggingFoldersSinksPatch 
    ::  LogSink
    ...
    -> LoggingFoldersSinksPatch
newLoggingFoldersSinksPatch payload sinkName =
  LoggingFoldersSinksPatch
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest LoggingFoldersSinksPatch
         where
        type Rs LoggingFoldersSinksPatch = LogSink
        type Scopes LoggingFoldersSinksPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersSinksPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersSinksPatchResource)
                      Core.mempty
