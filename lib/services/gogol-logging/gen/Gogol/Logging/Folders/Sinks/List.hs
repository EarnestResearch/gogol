...
-- |
-- Module      : Gogol.Logging.Folders.Sinks.List
...
-- 'LoggingFoldersSinksList' request conforms to.
type LoggingFoldersSinksListResource =
     "v2" Core.:>
...
-- | Lists sinks.
--
-- /See:/ 'newLoggingFoldersSinksList' smart constructor.
data LoggingFoldersSinksList = LoggingFoldersSinksList
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingFoldersSinksList' with the minimum fields required to make a request.
newLoggingFoldersSinksList 
    ::  Core.Text
    ...
    -> LoggingFoldersSinksList
newLoggingFoldersSinksList parent =
  LoggingFoldersSinksList
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest LoggingFoldersSinksList
         where
        type Rs LoggingFoldersSinksList = ListSinksResponse
        type Scopes LoggingFoldersSinksList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Logging'Admin, Logging'Read]
        requestClient LoggingFoldersSinksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersSinksListResource)
                      Core.mempty
