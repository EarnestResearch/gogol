...
-- |
-- Module      : Gogol.Logging.Folders.Sinks.Update
...
-- 'LoggingFoldersSinksUpdate' request conforms to.
type LoggingFoldersSinksUpdateResource =
     "v2" Core.:>
...
-- | Updates a sink. This method replaces the following fields in the existing sink with values from the new sink: destination, and filter.The updated sink might also have a new writer/identity; see the unique/writer_identity field.
--
-- /See:/ 'newLoggingFoldersSinksUpdate' smart constructor.
data LoggingFoldersSinksUpdate = LoggingFoldersSinksUpdate
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingFoldersSinksUpdate' with the minimum fields required to make a request.
newLoggingFoldersSinksUpdate 
    ::  LogSink
    ...
    -> LoggingFoldersSinksUpdate
newLoggingFoldersSinksUpdate payload sinkName =
  LoggingFoldersSinksUpdate
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest LoggingFoldersSinksUpdate
         where
        type Rs LoggingFoldersSinksUpdate = LogSink
        type Scopes LoggingFoldersSinksUpdate =
        ...
        requestClient LoggingFoldersSinksUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersSinksUpdateResource)
                      Core.mempty
