...
-- |
-- Module      : Gogol.Logging.Organizations.Sinks.Update
...
-- 'LoggingOrganizationsSinksUpdate' request conforms to.
type LoggingOrganizationsSinksUpdateResource =
     "v2" Core.:>
...
-- | Updates a sink. This method replaces the following fields in the existing sink with values from the new sink: destination, and filter.The updated sink might also have a new writer/identity; see the unique/writer_identity field.
--
-- /See:/ 'newLoggingOrganizationsSinksUpdate' smart constructor.
data LoggingOrganizationsSinksUpdate = LoggingOrganizationsSinksUpdate
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingOrganizationsSinksUpdate' with the minimum fields required to make a request.
newLoggingOrganizationsSinksUpdate 
    ::  LogSink
    ...
    -> LoggingOrganizationsSinksUpdate
newLoggingOrganizationsSinksUpdate payload sinkName =
  LoggingOrganizationsSinksUpdate
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingOrganizationsSinksUpdate =
        ...
        requestClient LoggingOrganizationsSinksUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsSinksUpdateResource)
                      Core.mempty
