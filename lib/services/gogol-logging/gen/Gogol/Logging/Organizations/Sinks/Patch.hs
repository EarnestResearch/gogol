...
-- |
-- Module      : Gogol.Logging.Organizations.Sinks.Patch
...
-- 'LoggingOrganizationsSinksPatch' request conforms to.
type LoggingOrganizationsSinksPatchResource =
     "v2" Core.:>
...
-- | Updates a sink. This method replaces the following fields in the existing sink with values from the new sink: destination, and filter.The updated sink might also have a new writer/identity; see the unique/writer_identity field.
--
-- /See:/ 'newLoggingOrganizationsSinksPatch' smart constructor.
data LoggingOrganizationsSinksPatch = LoggingOrganizationsSinksPatch
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingOrganizationsSinksPatch' with the minimum fields required to make a request.
newLoggingOrganizationsSinksPatch 
    ::  LogSink
    ...
    -> LoggingOrganizationsSinksPatch
newLoggingOrganizationsSinksPatch payload sinkName =
  LoggingOrganizationsSinksPatch
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           LoggingOrganizationsSinksPatch
         where
        type Rs LoggingOrganizationsSinksPatch = LogSink
        type Scopes LoggingOrganizationsSinksPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingOrganizationsSinksPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsSinksPatchResource)
                      Core.mempty
