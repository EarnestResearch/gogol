...
newLoggingOrganizationsLocationsLogScopesCreate parent payload
  = LoggingOrganizationsLocationsLogScopesCreate{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing, logScopeId = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingOrganizationsLocationsLogScopesCreate =
