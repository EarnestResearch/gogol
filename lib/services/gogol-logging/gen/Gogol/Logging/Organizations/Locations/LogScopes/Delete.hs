...
newLoggingOrganizationsLocationsLogScopesDelete name
  = LoggingOrganizationsLocationsLogScopesDelete{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsLogScopesDelete
         where
        type Rs LoggingOrganizationsLocationsLogScopesDelete = Empty
        type Scopes LoggingOrganizationsLocationsLogScopesDelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingOrganizationsLocationsLogScopesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsLogScopesDeleteResource)
                      Core.mempty
