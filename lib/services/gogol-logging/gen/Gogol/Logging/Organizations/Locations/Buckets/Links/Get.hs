...
-- |
-- Module      : Gogol.Logging.Organizations.Locations.Buckets.Links.Get
...
-- Gets a link.
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.organizations.locations.buckets.links.get@.
module Gogol.Logging.Organizations.Locations.Buckets.Links.Get
    (
    -- * Resource
...
-- | A resource alias for @logging.organizations.locations.buckets.links.get@ method which the
-- 'LoggingOrganizationsLocationsBucketsLinksGet' request conforms to.
type LoggingOrganizationsLocationsBucketsLinksGetResource
     =
     "v2" Core.:>
...
-- | Gets a link.
--
-- /See:/ 'newLoggingOrganizationsLocationsBucketsLinksGet' smart constructor.
data LoggingOrganizationsLocationsBucketsLinksGet = LoggingOrganizationsLocationsBucketsLinksGet
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingOrganizationsLocationsBucketsLinksGet' with the minimum fields required to make a request.
newLoggingOrganizationsLocationsBucketsLinksGet 
    ::  Core.Text
    ...
    -> LoggingOrganizationsLocationsBucketsLinksGet
newLoggingOrganizationsLocationsBucketsLinksGet name =
  LoggingOrganizationsLocationsBucketsLinksGet
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsLinksGet
         where
        type Rs LoggingOrganizationsLocationsBucketsLinksGet
             = Link
        type Scopes
               LoggingOrganizationsLocationsBucketsLinksGet
             =
