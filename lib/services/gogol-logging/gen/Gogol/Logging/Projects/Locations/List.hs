...
newLoggingProjectsLocationsList name
  = LoggingProjectsLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingProjectsLocationsList where
        type Rs LoggingProjectsLocationsList = ListLocationsResponse
        ...
        requestClient LoggingProjectsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingProjectsLocationsListResource)
                      Core.mempty
