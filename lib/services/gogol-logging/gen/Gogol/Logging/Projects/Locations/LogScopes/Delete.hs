...
newLoggingProjectsLocationsLogScopesDelete name
  = LoggingProjectsLocationsLogScopesDelete{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsLocationsLogScopesDelete
         where
        type Rs LoggingProjectsLocationsLogScopesDelete = Empty
        type Scopes LoggingProjectsLocationsLogScopesDelete =
