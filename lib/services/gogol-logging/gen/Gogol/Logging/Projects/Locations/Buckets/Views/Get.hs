...
-- |
-- Module      : Gogol.Logging.Projects.Locations.Buckets.Views.Get
...
-- 'LoggingProjectsLocationsBucketsViewsGet' request conforms to.
type LoggingProjectsLocationsBucketsViewsGetResource
     =
     "v2" Core.:>
...
-- | Gets a view on a log bucket..
--
-- /See:/ 'newLoggingProjectsLocationsBucketsViewsGet' smart constructor.
data LoggingProjectsLocationsBucketsViewsGet = LoggingProjectsLocationsBucketsViewsGet
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingProjectsLocationsBucketsViewsGet' with the minimum fields required to make a request.
newLoggingProjectsLocationsBucketsViewsGet 
    ::  Core.Text
    ...
    -> LoggingProjectsLocationsBucketsViewsGet
newLoggingProjectsLocationsBucketsViewsGet name =
  LoggingProjectsLocationsBucketsViewsGet
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           LoggingProjectsLocationsBucketsViewsGet
         where
        type Rs LoggingProjectsLocationsBucketsViewsGet =
             LogView
        type Scopes LoggingProjectsLocationsBucketsViewsGet =
