...
newLoggingProjectsLocationsLogScopesCreate parent payload
  = LoggingProjectsLocationsLogScopesCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            logScopeId = Core.Nothing, parent = parent,
                                            payload = payload, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsLocationsLogScopesCreate
         where
        type Rs LoggingProjectsLocationsLogScopesCreate = LogScope
        type Scopes LoggingProjectsLocationsLogScopesCreate =
