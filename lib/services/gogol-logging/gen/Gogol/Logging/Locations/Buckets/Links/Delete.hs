...
-- |
-- Module      : Gogol.Logging.Locations.Buckets.Links.Delete
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.locations.buckets.links.delete@.
module Gogol.Logging.Locations.Buckets.Links.Delete
    (
    -- * Resource
...
-- | A resource alias for @logging.locations.buckets.links.delete@ method which the
-- 'LoggingLocationsBucketsLinksDelete' request conforms to.
type LoggingLocationsBucketsLinksDeleteResource =
     "v2" Core.:>
...
-- | Deletes a link. This will also delete the corresponding BigQuery linked dataset.
--
-- /See:/ 'newLoggingLocationsBucketsLinksDelete' smart constructor.
data LoggingLocationsBucketsLinksDelete = LoggingLocationsBucketsLinksDelete
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingLocationsBucketsLinksDelete' with the minimum fields required to make a request.
newLoggingLocationsBucketsLinksDelete 
    ::  Core.Text
    ...
    -> LoggingLocationsBucketsLinksDelete
newLoggingLocationsBucketsLinksDelete name =
  LoggingLocationsBucketsLinksDelete
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           LoggingLocationsBucketsLinksDelete
         where
        type Rs LoggingLocationsBucketsLinksDelete =
             Operation
        type Scopes LoggingLocationsBucketsLinksDelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingLocationsBucketsLinksDelete{..}
