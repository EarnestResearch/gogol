...
-- |
-- Module      : Gogol.Logging.Sinks.List
...
-- 'LoggingSinksList' request conforms to.
type LoggingSinksListResource =
     "v2" Core.:>
...
-- | Lists sinks.
--
-- /See:/ 'newLoggingSinksList' smart constructor.
data LoggingSinksList = LoggingSinksList
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingSinksList' with the minimum fields required to make a request.
newLoggingSinksList 
    ::  Core.Text
...
instance Core.GoogleRequest LoggingSinksList where
        type Rs LoggingSinksList = ListSinksResponse
        type Scopes LoggingSinksList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Logging'Admin, Logging'Read]
        requestClient LoggingSinksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingSinksListResource)
                      Core.mempty
