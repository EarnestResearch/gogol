           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "currencyCode" Core.Text Core.:>
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListSkusResponse
...
instance Core.GoogleRequest
           CloudbillingServicesSkusList
         where
        type Rs CloudbillingServicesSkusList =
             ListSkusResponse
        type Scopes CloudbillingServicesSkusList =
             '[CloudBilling'FullControl, CloudBilling'Readonly,
               CloudPlatform'FullControl]
        requestClient CloudbillingServicesSkusList{..}
          = go parent xgafv accessToken callback currencyCode
              endTime
              pageSize
              pageToken
              startTime
