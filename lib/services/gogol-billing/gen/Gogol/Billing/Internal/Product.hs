...
instance Core.FromJSON AggregationInfo where
        parseJSON
          = Core.withObject "AggregationInfo"
              (\ o ->
                 AggregationInfo Core.<$>
                   (o Core..:? "aggregationCount") Core.<*>
                     (o Core..:? "aggregationInterval")
...
instance Core.ToJSON AggregationInfo where
        toJSON AggregationInfo{..}
          = Core.object
              (Core.catMaybes
                 [("aggregationCount" Core..=) Core.<$>
                    aggregationCount,
                  ("aggregationInterval" Core..=) Core.<$>
                    aggregationInterval,
...
instance Core.FromJSON BillingAccount where
        parseJSON
          = Core.withObject "BillingAccount"
              (\ o ->
                 BillingAccount Core.<$>
                   (o Core..:? "displayName") Core.<*>
                     (o Core..:? "masterBillingAccount")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "open"))
          ...
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ("masterBillingAccount" Core..=) Core.<$>
...
instance Core.FromJSON Category where
        parseJSON
          = Core.withObject "Category"
              (\ o ->
                 Category Core.<$>
                   (o Core..:? "resourceFamily") Core.<*>
                     (o Core..:? "resourceGroup")
...
instance Core.FromJSON GeoTaxonomy where
        parseJSON
          = Core.withObject "GeoTaxonomy"
              (\ o ->
                 GeoTaxonomy Core.<$>
                   (o Core..:? "regions") Core.<*> (o Core..:? "type"))
...
newListBillingAccountsResponse =
  ListBillingAccountsResponse
    {billingAccounts = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListBillingAccountsResponse
         where
        parseJSON
          = Core.withObject "ListBillingAccountsResponse"
              (\ o ->
                 ListBillingAccountsResponse Core.<$>
                   (o Core..:? "billingAccounts") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListBillingAccountsResponse
         where
        toJSON ListBillingAccountsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("billingAccounts" Core..=) Core.<$>
                    billingAccounts,
...
newListProjectBillingInfoResponse =
  ListProjectBillingInfoResponse
    {nextPageToken = Core.Nothing, projectBillingInfo = Core.Nothing}

instance Core.FromJSON ListProjectBillingInfoResponse
         where
        parseJSON
          = Core.withObject "ListProjectBillingInfoResponse"
              (\ o ->
                 ListProjectBillingInfoResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "projectBillingInfo"))

instance Core.ToJSON ListProjectBillingInfoResponse
         where
        toJSON ListProjectBillingInfoResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("projectBillingInfo" Core..=) Core.<$>
                    projectBillingInfo])
...
instance Core.FromJSON ListSkusResponse where
        parseJSON
          = Core.withObject "ListSkusResponse"
              (\ o ->
                 ListSkusResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "skus"))
...
instance Core.FromJSON PricingExpression where
        parseJSON
          = Core.withObject "PricingExpression"
              (\ o ->
                 PricingExpression Core.<$>
                   (o Core..:? "baseUnit") Core.<*>
                     (o Core..:? "baseUnitConversionFactor")
...
instance Core.FromJSON PricingInfo where
        parseJSON
          = Core.withObject "PricingInfo"
              (\ o ->
                 PricingInfo Core.<$>
                   (o Core..:? "aggregationInfo") Core.<*>
                     (o Core..:? "currencyConversionRate")
...
instance Core.ToJSON PricingInfo where
        toJSON PricingInfo{..}
          = Core.object
              (Core.catMaybes
                 [("aggregationInfo" Core..=) Core.<$>
                    aggregationInfo,
                  ("currencyConversionRate" Core..=) Core.<$>
                    currencyConversionRate,
                  ("effectiveTime" Core..=) Core.<$> effectiveTime,
                  ("pricingExpression" Core..=) Core.<$>
                    pricingExpression,
...
instance Core.FromJSON ProjectBillingInfo where
        parseJSON
          = Core.withObject "ProjectBillingInfo"
              (\ o ->
                 ProjectBillingInfo Core.<$>
                   (o Core..:? "billingAccountName") Core.<*>
                     (o Core..:? "billingEnabled")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON Service where
        parseJSON
          = Core.withObject "Service"
              (\ o ->
                 Service Core.<$>
                   (o Core..:? "businessEntityName") Core.<*>
                     (o Core..:? "displayName")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON TierRate where
        parseJSON
          = Core.withObject "TierRate"
              (\ o ->
                 TierRate Core.<$>
                   (o Core..:? "startUsageAmount") Core.<*>
                     (o Core..:? "unitPrice"))
