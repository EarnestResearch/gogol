               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] SpaceReadState
...
newChatUsersSpacesGetSpaceReadState name
  = ChatUsersSpacesGetSpaceReadState{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ChatUsersSpacesGetSpaceReadState where
        ...
        type Scopes ChatUsersSpacesGetSpaceReadState =
