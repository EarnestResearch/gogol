...
--
-- Returns details about a user\'s read state within a thread, used to identify read and unread messages. For an example, see <https://developers.google.com/workspace/chat/get-thread-read-state Get details about a user\'s thread read state>. Requires <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user user authentication> with one of the following <https://developers.google.com/workspace/chat/authenticate-authorize#chat-api-scopes authorization scopes>: - @https:\/\/www.googleapis.com\/auth\/chat.users.readstate.readonly@ - @https:\/\/www.googleapis.com\/auth\/chat.users.readstate@
--
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] ThreadReadState
...
newChatUsersSpacesThreadsGetThreadReadState name
  = ChatUsersSpacesThreadsGetThreadReadState{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ChatUsersSpacesThreadsGetThreadReadState =
