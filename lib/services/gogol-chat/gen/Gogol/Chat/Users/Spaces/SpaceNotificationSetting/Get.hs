               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] SpaceNotificationSetting
...
newChatUsersSpacesSpaceNotificationSettingGet name
  = ChatUsersSpacesSpaceNotificationSettingGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ChatUsersSpacesSpaceNotificationSettingGet
         where
        type Rs ChatUsersSpacesSpaceNotificationSettingGet =
             SpaceNotificationSetting
        type Scopes ChatUsersSpacesSpaceNotificationSettingGet =
