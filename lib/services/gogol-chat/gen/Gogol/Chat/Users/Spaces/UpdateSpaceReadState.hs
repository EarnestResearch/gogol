...
--
-- Updates a user\'s read state within a space, used to identify read and unread messages. For an example, see <https://developers.google.com/workspace/chat/update-space-read-state Update a user\'s space read state>. Requires <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user user authentication> with the <https://developers.google.com/workspace/chat/authenticate-authorize#chat-api-scopes authorization scope>: - @https:\/\/www.googleapis.com\/auth\/chat.users.readstate@
--
...
newChatUsersSpacesUpdateSpaceReadState name payload
  = ChatUsersSpacesUpdateSpaceReadState{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, payload = payload, updateMask = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ChatUsersSpacesUpdateSpaceReadState
         where
