...
--
-- Updates the space notification setting. For an example, see <https://developers.google.com/workspace/chat/update-space-notification-setting Update the caller\'s space notification setting>. Requires <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user user authentication> with the <https://developers.google.com/workspace/chat/authenticate-authorize#chat-api-scopes authorization scope>: - @https:\/\/www.googleapis.com\/auth\/chat.users.spacesettings@
--
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] SpaceNotificationSetting Core.:>
                         Core.Patch '[Core.JSON] SpaceNotificationSetting
...
newChatUsersSpacesSpaceNotificationSettingPatch name payload
  = ChatUsersSpacesSpaceNotificationSettingPatch{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           ChatUsersSpacesSpaceNotificationSettingPatch
         where
        type Rs ChatUsersSpacesSpaceNotificationSettingPatch =
             SpaceNotificationSetting
        type Scopes ChatUsersSpacesSpaceNotificationSettingPatch =
