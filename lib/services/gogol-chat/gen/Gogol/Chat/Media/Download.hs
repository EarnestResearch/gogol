...
newChatMediaDownload resourceName
  = ChatMediaDownload{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, callback = Core.Nothing,
                      resourceName = resourceName, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ChatMediaDownload where
        ...
        requestClient ChatMediaDownload{..}
          = go resourceName xgafv accessToken callback uploadType
              uploadProtocol
...
instance Core.GoogleRequest (Core.MediaDownload ChatMediaDownload)
         where
        type Rs (Core.MediaDownload ChatMediaDownload) = Core.Stream
        type Scopes (Core.MediaDownload ChatMediaDownload) =
             Core.Scopes ChatMediaDownload
        requestClient (Core.MediaDownload ChatMediaDownload{..})
          = go resourceName xgafv accessToken callback uploadType
              uploadProtocol
