...
--
-- Uploads an attachment. For an example, see <https://developers.google.com/workspace/chat/upload-media-attachments Upload media as a file attachment>. Requires user <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user authentication> with one of the following <https://developers.google.com/workspace/chat/authenticate-authorize#chat-api-scopes authorization scopes>: - @https:\/\/www.googleapis.com\/auth\/chat.messages.create@ - @https:\/\/www.googleapis.com\/auth\/chat.messages@ - @https:\/\/www.googleapis.com\/auth\/chat.import@ (import mode spaces only) You can upload attachments up to 200 MB. Certain file types aren\'t supported. For details, see <https://support.google.com/chat/answer/7651457?&co=GENIE.Platform%3DDesktop#File%20types%20blocked%20in%20Google%20Chat File types blocked by Google Chat>.
--
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] UploadAttachmentRequest Core.:>
                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.QueryParam "uploadType" Core.Multipart Core.:>
                             Core.MultipartRelated '[Core.JSON] UploadAttachmentRequest Core.:>
                               Core.Post '[Core.JSON] UploadAttachmentResponse
...
newChatMediaUpload parent payload
  = ChatMediaUpload{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    callback = Core.Nothing, parent = parent, payload = payload,
