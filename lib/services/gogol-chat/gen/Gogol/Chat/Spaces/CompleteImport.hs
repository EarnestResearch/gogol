...
--
-- Completes the <https://developers.google.com/workspace/chat/import-data import process> for the specified space and makes it visible to users. Requires <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user user authentication> and domain-wide delegation with the <https://developers.google.com/workspace/chat/authenticate-authorize#chat-api-scopes authorization scope>: - @https:\/\/www.googleapis.com\/auth\/chat.import@ For more information, see <https://developers.google.com/workspace/chat/authorize-import Authorize Google Chat apps to import data>.
--
...
type ChatSpacesCompleteImportResource =
     "v1" Core.:>
       Core.CaptureMode "name" "completeImport" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CompleteImportSpaceRequest Core.:>
                       Core.Post '[Core.JSON] CompleteImportSpaceResponse
...
newChatSpacesCompleteImport name payload
  = ChatSpacesCompleteImport{xgafv = Core.Nothing,
