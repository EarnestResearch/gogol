...
--
-- Deletes a reaction to a message. For an example, see <https://developers.google.com/workspace/chat/delete-reactions Delete a reaction>. Requires <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user user authentication> with one of the following <https://developers.google.com/workspace/chat/authenticate-authorize#chat-api-scopes authorization scopes>: - @https:\/\/www.googleapis.com\/auth\/chat.messages.reactions@ - @https:\/\/www.googleapis.com\/auth\/chat.messages@ - @https:\/\/www.googleapis.com\/auth\/chat.import@ (import mode spaces only)
--
...
newChatSpacesMessagesReactionsDelete name
  = ChatSpacesMessagesReactionsDelete{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      name = name, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ChatSpacesMessagesReactionsDelete where
