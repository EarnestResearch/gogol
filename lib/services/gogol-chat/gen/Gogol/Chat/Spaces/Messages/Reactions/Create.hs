...
--
-- Creates a reaction and adds it to a message. For an example, see <https://developers.google.com/workspace/chat/create-reactions Add a reaction to a message>. Requires <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user user authentication> with one of the following <https://developers.google.com/workspace/chat/authenticate-authorize#chat-api-scopes authorization scopes>: - @https:\/\/www.googleapis.com\/auth\/chat.messages.reactions.create@ - @https:\/\/www.googleapis.com\/auth\/chat.messages.reactions@ - @https:\/\/www.googleapis.com\/auth\/chat.messages@ - @https:\/\/www.googleapis.com\/auth\/chat.import@ (import mode spaces only)
--
...
newChatSpacesMessagesReactionsCreate parent payload
  = ChatSpacesMessagesReactionsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ChatSpacesMessagesReactionsCreate where
        ...
        type Scopes ChatSpacesMessagesReactionsCreate =
             '[Chat'Import, Chat'Messages, Chat'Messages'Reactions,
