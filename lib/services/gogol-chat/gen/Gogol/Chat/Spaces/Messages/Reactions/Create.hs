...
--
-- <https://developers.google.com/workspace/preview Developer Preview>: Creates a reaction and adds it to a message. Requires <https://developers.google.com/chat/api/guides/auth/users user authentication> and the @chat.messages@, @chat.messages.reactions@, or @chat.messages.reactions.create@ scope. Only unicode emoji are supported.
--
