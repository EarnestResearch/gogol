...
--
-- Lists reactions to a message. For an example, see <https://developers.google.com/workspace/chat/list-reactions List reactions for a message>. Requires <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user user authentication> with one of the following <https://developers.google.com/workspace/chat/authenticate-authorize#chat-api-scopes authorization scopes>: - @https:\/\/www.googleapis.com\/auth\/chat.messages.reactions.readonly@ - @https:\/\/www.googleapis.com\/auth\/chat.messages.reactions@ - @https:\/\/www.googleapis.com\/auth\/chat.messages.readonly@ - @https:\/\/www.googleapis.com\/auth\/chat.messages@
--
...
newChatSpacesMessagesReactionsList parent
  = ChatSpacesMessagesReactionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ChatSpacesMessagesReactionsList where
        type Rs ChatSpacesMessagesReactionsList = ListReactionsResponse
        ...
        requestClient ChatSpacesMessagesReactionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ChatSpacesMessagesReactionsListResource)
                      Core.mempty
