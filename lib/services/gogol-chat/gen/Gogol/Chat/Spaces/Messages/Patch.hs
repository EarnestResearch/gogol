...
data ChatSpacesMessagesPatch = ChatSpacesMessagesPatch
    ...
    , accessToken :: (Core.Maybe Core.Text)
      -- | Optional. If @true@ and the message isn\'t found, a new message is created and @updateMask@ is ignored. The specified message ID must be <https://developers.google.com/chat/api/guides/crudl/messages#name_a_created_message client-assigned> or the request fails.
...
instance Core.GoogleRequest ChatSpacesMessagesPatch
         where
        type Rs ChatSpacesMessagesPatch = Message
        type Scopes ChatSpacesMessagesPatch =
