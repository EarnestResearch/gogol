...
newChatSpacesMessagesCreate parent payload
  = ChatSpacesMessagesCreate{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             messageId = Core.Nothing, messageReplyOption = Core.Nothing,
                             parent = parent, payload = payload, requestId = Core.Nothing,
                             threadKey = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ChatSpacesMessagesCreate where
        ...
        type Scopes ChatSpacesMessagesCreate =
             '[Chat'Bot, Chat'Import, Chat'Messages, Chat'Messages'Create]
        requestClient ChatSpacesMessagesCreate{..}
          = go parent xgafv accessToken callback messageId messageReplyOption
              requestId
              threadKey
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ChatSpacesMessagesCreateResource)
                      Core.mempty
