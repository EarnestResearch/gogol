...
newChatSpacesMessagesUpdate name payload
  = ChatSpacesMessagesUpdate{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, allowMissing = Core.Nothing,
                             callback = Core.Nothing, name = name, payload = payload,
...
instance Core.GoogleRequest ChatSpacesMessagesUpdate where
        ...
        requestClient ChatSpacesMessagesUpdate{..}
          = go name xgafv accessToken allowMissing callback updateMask
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ChatSpacesMessagesUpdateResource)
                      Core.mempty
