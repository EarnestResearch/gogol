...
--
-- Deletes a named space. Always performs a cascading delete, which means that the space\'s child resources—like messages posted in the space and memberships in the space—are also deleted. For an example, see <https://developers.google.com/workspace/chat/delete-spaces Delete a space>. Supports the following types of <https://developers.google.com/workspace/chat/authenticate-authorize authentication>: - <https://developers.google.com/workspace/chat/authenticate-authorize-chat-app App authentication> with <https://support.google.com/a?p=chat-app-auth administrator approval> in <https://developers.google.com/workspace/preview Developer Preview> and the authorization scope: - @https:\/\/www.googleapis.com\/auth\/chat.app.delete@ (only in spaces the app created) - <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user User authentication> with one of the following authorization scopes: - @https:\/\/www.googleapis.com\/auth\/chat.delete@ - @https:\/\/www.googleapis.com\/auth\/chat.import@
-- (import mode spaces only) - User authentication grants administrator privileges when an administrator account authenticates, @use_admin_access@ is @true@, and the following authorization scope is used: - @https:\/\/www.googleapis.com\/auth\/chat.admin.delete@
--
...
newChatSpacesDelete name
  = ChatSpacesDelete{xgafv = Core.Nothing,
