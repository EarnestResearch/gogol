                 ...
                 Core.QueryParam "filter" Core.Text Core.:>
                   Core.QueryParam "pageSize" Core.Int32 Core.:>
                     Core.QueryParam "pageToken" Core.Text Core.:>
                       Core.QueryParam "showGroups" Core.Bool Core.:>
...
newChatSpacesMembersList parent
  = ChatSpacesMembersList{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          filter = Core.Nothing, pageSize = Core.Nothing,
                          pageToken = Core.Nothing, parent = parent,
                          showGroups = Core.Nothing, showInvited = Core.Nothing,
...
instance Core.GoogleRequest ChatSpacesMembersList where
        ...
        type Scopes ChatSpacesMembersList =
             '[Chat'Admin'Memberships, Chat'Admin'Memberships'Readonly,
               Chat'App'Memberships, Chat'Bot, Chat'Import, Chat'Memberships,
