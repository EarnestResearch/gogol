                     ...
                     Core.QueryParam "useAdminAccess" Core.Bool Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Membership Core.:>
                           Core.Patch '[Core.JSON] Membership
...
newChatSpacesMembersPatch name payload
  = ChatSpacesMembersPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ChatSpacesMembersPatch where
        ...
        type Scopes ChatSpacesMembersPatch =
