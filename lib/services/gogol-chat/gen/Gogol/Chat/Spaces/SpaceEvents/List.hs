...
--
-- Lists events from a Google Chat space. For each event, the <https://developers.google.com/workspace/chat/api/reference/rest/v1/spaces.spaceEvents#SpaceEvent.FIELDS.oneof_payload payload> contains the most recent version of the Chat resource. For example, if you list events about new space members, the server returns @Membership@ resources that contain the latest membership details. If new members were removed during the requested period, the event payload contains an empty @Membership@ resource. Requires <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user user authentication> with an <https://developers.google.com/workspace/chat/authenticate-authorize#chat-api-scopes authorization scope> appropriate for reading the requested data: - @https:\/\/www.googleapis.com\/auth\/chat.spaces.readonly@ - @https:\/\/www.googleapis.com\/auth\/chat.spaces@ - @https:\/\/www.googleapis.com\/auth\/chat.messages.readonly@ - @https:\/\/www.googleapis.com\/auth\/chat.messages@ -
...
newChatSpacesSpaceEventsList parent
  = ChatSpacesSpaceEventsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ChatSpacesSpaceEventsList where
        type Rs ChatSpacesSpaceEventsList = ListSpaceEventsResponse
        type Scopes ChatSpacesSpaceEventsList =
             '[Chat'App'Memberships, Chat'App'Spaces, Chat'Memberships,
               Chat'Memberships'Readonly, Chat'Messages, Chat'Messages'Reactions,
               Chat'Messages'Reactions'Readonly, Chat'Messages'Readonly,
        ...
        requestClient ChatSpacesSpaceEventsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ChatSpacesSpaceEventsListResource)
                      Core.mempty
