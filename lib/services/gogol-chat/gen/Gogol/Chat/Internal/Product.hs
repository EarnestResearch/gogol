...
newAccessSettings 
    ::  AccessSettings
newAccessSettings
  = AccessSettings{accessState = Core.Nothing,
...
instance Core.FromJSON AccessSettings where
        parseJSON
          = Core.withObject "AccessSettings"
              (\ o ->
                 AccessSettings Core.<$>
                   (o Core..:? "accessState") Core.<*> (o Core..:? "audience"))
...
instance Core.FromJSON AccessoryWidget where
        parseJSON
          = Core.withObject "AccessoryWidget"
              (\ o -> AccessoryWidget Core.<$> (o Core..:? "buttonList"))

instance Core.ToJSON AccessoryWidget where
        toJSON AccessoryWidget{..}
          = Core.object
              (Core.catMaybes [("buttonList" Core..=) Core.<$> buttonList])
...
newActionParameter 
    ::  ActionParameter
newActionParameter
  = ActionParameter{key = Core.Nothing, value = Core.Nothing}
...
newActionResponse 
    ::  ActionResponse
newActionResponse
  = ActionResponse{dialogAction = Core.Nothing, type' = Core.Nothing,
                   updatedWidget = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON ActionResponse where
        parseJSON
          = Core.withObject "ActionResponse"
              (\ o ->
                 ActionResponse Core.<$>
                   (o Core..:? "dialogAction") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "updatedWidget")
                     Core.<*> (o Core..:? "url"))
...
newActionStatus 
    ::  ActionStatus
newActionStatus
  = ActionStatus{statusCode = Core.Nothing,
                 userFacingMessage = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("statusCode" Core..=) Core.<$> statusCode,
                  ("userFacingMessage" Core..=) Core.<$> userFacingMessage])
...
newAnnotation 
    ::  Annotation
newAnnotation
  = Annotation{customEmojiMetadata = Core.Nothing,
               length = Core.Nothing, richLinkMetadata = Core.Nothing,
               slashCommand = Core.Nothing, startIndex = Core.Nothing,
               type' = Core.Nothing, userMention = Core.Nothing}
instance Core.FromJSON Annotation where
        parseJSON
          = Core.withObject "Annotation"
              (\ o ->
                 Annotation Core.<$>
                   (o Core..:? "customEmojiMetadata") Core.<*> (o Core..:? "length")
                     Core.<*> (o Core..:? "richLinkMetadata")
...
instance Core.ToJSON Annotation where
        toJSON Annotation{..}
          = Core.object
              (Core.catMaybes
                 [("customEmojiMetadata" Core..=) Core.<$> customEmojiMetadata,
                  ("length" Core..=) Core.<$> length,
                  ("richLinkMetadata" Core..=) Core.<$> richLinkMetadata,
...
-- | Metadata about a <https://developers.google.com/workspace/chat/commands Chat app command>.
--
-- /See:/ 'newAppCommandMetadata' smart constructor.
data AppCommandMetadata = AppCommandMetadata
    {
      -- | The ID for the command specified in the Chat API configuration.
      appCommandId :: (Core.Maybe Core.Int32)
      -- | The type of Chat app command.
    , appCommandType :: (Core.Maybe AppCommandMetadata_AppCommandType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AppCommandMetadata' with the minimum fields required to make a request.
newAppCommandMetadata 
    ::  AppCommandMetadata
newAppCommandMetadata
  = AppCommandMetadata{appCommandId = Core.Nothing,
                       appCommandType = Core.Nothing}
instance Core.FromJSON AppCommandMetadata where
        parseJSON
          = Core.withObject "AppCommandMetadata"
              (\ o ->
                 AppCommandMetadata Core.<$>
                   (o Core..:? "appCommandId") Core.<*> (o Core..:? "appCommandType"))

instance Core.ToJSON AppCommandMetadata where
        toJSON AppCommandMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("appCommandId" Core..=) Core.<$> appCommandId,
                  ("appCommandType" Core..=) Core.<$> appCommandType])
...
newAttachment 
    ::  Attachment
newAttachment
  = Attachment{attachmentDataRef = Core.Nothing,
               contentName = Core.Nothing, contentType = Core.Nothing,
               downloadUri = Core.Nothing, driveDataRef = Core.Nothing,
               name = Core.Nothing, source = Core.Nothing,
...
instance Core.ToJSON Attachment where
        toJSON Attachment{..}
          = Core.object
              (Core.catMaybes
                 [("attachmentDataRef" Core..=) Core.<$> attachmentDataRef,
                  ...
                  ("name" Core..=) Core.<$> name, ("source" Core..=) Core.<$> source,
...
newAttachmentDataRef 
    ::  AttachmentDataRef
newAttachmentDataRef
  = AttachmentDataRef{attachmentUploadToken = Core.Nothing,
...
instance Core.ToJSON AttachmentDataRef where
        toJSON AttachmentDataRef{..}
          = Core.object
              (Core.catMaybes
                 [("attachmentUploadToken" Core..=) Core.<$> attachmentUploadToken,
...
newButton 
    ::  Button
newButton
  = Button{imageButton = Core.Nothing, textButton = Core.Nothing}
instance Core.FromJSON Button where
        parseJSON
          = Core.withObject "Button"
              (\ o ->
                 Button Core.<$>
                   (o Core..:? "imageButton") Core.<*> (o Core..:? "textButton"))
...
newCard 
    ::  Card
newCard
  = Card{cardActions = Core.Nothing, header = Core.Nothing,
         name = Core.Nothing, sections = Core.Nothing}
instance Core.FromJSON Card where
        parseJSON
          = Core.withObject "Card"
              (\ o ->
                 Card Core.<$>
                   (o Core..:? "cardActions") Core.<*> (o Core..:? "header") Core.<*>
                     (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("cardActions" Core..=) Core.<$> cardActions,
                  ("header" Core..=) Core.<$> header, ("name" Core..=) Core.<$> name,
...
newCardAction 
    ::  CardAction
newCardAction
  = CardAction{actionLabel = Core.Nothing, onClick = Core.Nothing}
instance Core.FromJSON CardAction where
        parseJSON
          = Core.withObject "CardAction"
              (\ o ->
                 CardAction Core.<$>
                   (o Core..:? "actionLabel") Core.<*> (o Core..:? "onClick"))
...
newCardHeader 
    ::  CardHeader
newCardHeader
  = CardHeader{imageStyle = Core.Nothing, imageUrl = Core.Nothing,
               subtitle = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON CardHeader where
        parseJSON
          = Core.withObject "CardHeader"
              (\ o ->
                 CardHeader Core.<$>
                   (o Core..:? "imageStyle") Core.<*> (o Core..:? "imageUrl") Core.<*>
                     (o Core..:? "subtitle")
                     Core.<*> (o Core..:? "title"))
...
newCardWithId 
    ::  CardWithId
newCardWithId
  = CardWithId{card = Core.Nothing, cardId = Core.Nothing}
...
newChatAppLogEntry 
    ::  ChatAppLogEntry
newChatAppLogEntry
  = ChatAppLogEntry{deployment = Core.Nothing,
                    deploymentFunction = Core.Nothing, error = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("deployment" Core..=) Core.<$> deployment,
                  ("deploymentFunction" Core..=) Core.<$> deploymentFunction,
...
instance Core.FromJSON ChatClientDataSourceMarkup where
        parseJSON
          = Core.withObject "ChatClientDataSourceMarkup"
              (\ o ->
                 ChatClientDataSourceMarkup Core.<$> (o Core..:? "spaceDataSource"))

instance Core.ToJSON ChatClientDataSourceMarkup where
        toJSON ChatClientDataSourceMarkup{..}
          = Core.object
              (Core.catMaybes
                 [("spaceDataSource" Core..=) Core.<$> spaceDataSource])
...
newChatSpaceLinkData 
    ::  ChatSpaceLinkData
newChatSpaceLinkData
  = ChatSpaceLinkData{message = Core.Nothing, space = Core.Nothing,
                      thread = Core.Nothing}
          ...
          = Core.withObject "ChatSpaceLinkData"
              (\ o ->
                 ChatSpaceLinkData Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "space") Core.<*>
                     (o Core..:? "thread"))
...
newCommonEventObject 
    ::  CommonEventObject
newCommonEventObject
  = CommonEventObject{formInputs = Core.Nothing,
                      hostApp = Core.Nothing, invokedFunction = Core.Nothing,
                      parameters = Core.Nothing, platform = Core.Nothing,
                      timeZone = Core.Nothing, userLocale = Core.Nothing}
instance Core.FromJSON CommonEventObject where
        parseJSON
          = Core.withObject "CommonEventObject"
              (\ o ->
                 CommonEventObject Core.<$>
                   (o Core..:? "formInputs") Core.<*> (o Core..:? "hostApp") Core.<*>
                     (o Core..:? "invokedFunction")
...
instance Core.FromJSON CommonEventObject_FormInputs where
        parseJSON
          = Core.withObject "CommonEventObject_FormInputs"
              (\ o ->
                 CommonEventObject_FormInputs Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON CommonEventObject_FormInputs where
        toJSON CommonEventObject_FormInputs{..} = Core.toJSON additional
...
instance Core.FromJSON CommonEventObject_Parameters where
        parseJSON
          = Core.withObject "CommonEventObject_Parameters"
              (\ o ->
                 CommonEventObject_Parameters Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON CommonEventObject_Parameters where
        toJSON CommonEventObject_Parameters{..} = Core.toJSON additional
...
instance Core.FromJSON CompleteImportSpaceRequest where
        parseJSON
...
instance Core.FromJSON CompleteImportSpaceResponse where
        parseJSON
          = Core.withObject "CompleteImportSpaceResponse"
              (\ o -> CompleteImportSpaceResponse Core.<$> (o Core..:? "space"))

instance Core.ToJSON CompleteImportSpaceResponse where
        toJSON CompleteImportSpaceResponse{..}
          = Core.object (Core.catMaybes [("space" Core..=) Core.<$> space])


-- | Represents a <https://support.google.com/chat/answer/12800149 custom emoji>.
--
...
data CustomEmoji = CustomEmoji
    {
      ...
      emojiName :: (Core.Maybe Core.Text)
    ...
    , payload :: (Core.Maybe CustomEmojiPayload)
    ...
    , temporaryImageUri :: (Core.Maybe Core.Text)
...
newCustomEmoji 
    ::  CustomEmoji
newCustomEmoji
  = CustomEmoji{emojiName = Core.Nothing, name = Core.Nothing,
                payload = Core.Nothing, temporaryImageUri = Core.Nothing,
                uid = Core.Nothing}
instance Core.FromJSON CustomEmoji where
        parseJSON
          = Core.withObject "CustomEmoji"
              (\ o ->
                 CustomEmoji Core.<$>
                   (o Core..:? "emojiName") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "payload")
                     Core.<*> (o Core..:? "temporaryImageUri")
                     Core.<*> (o Core..:? "uid"))
...
instance Core.ToJSON CustomEmoji where
        toJSON CustomEmoji{..}
          = Core.object
              (Core.catMaybes
                 [("emojiName" Core..=) Core.<$> emojiName,
                  ("name" Core..=) Core.<$> name,
                  ("payload" Core..=) Core.<$> payload,
                  ("temporaryImageUri" Core..=) Core.<$> temporaryImageUri,
                  ("uid" Core..=) Core.<$> uid])
...
newCustomEmojiMetadata 
    ::  CustomEmojiMetadata
newCustomEmojiMetadata
  = CustomEmojiMetadata{customEmoji = Core.Nothing}
instance Core.FromJSON CustomEmojiMetadata where
        parseJSON
          = Core.withObject "CustomEmojiMetadata"
              (\ o -> CustomEmojiMetadata Core.<$> (o Core..:? "customEmoji"))

instance Core.ToJSON CustomEmojiMetadata where
        toJSON CustomEmojiMetadata{..}
          = Core.object
              (Core.catMaybes [("customEmoji" Core..=) Core.<$> customEmoji])


-- | Payload data for the custom emoji.
--
-- /See:/ 'newCustomEmojiPayload' smart constructor.
data CustomEmojiPayload = CustomEmojiPayload
    {
...
-- | Creates a value of 'CustomEmojiPayload' with the minimum fields required to make a request.
newCustomEmojiPayload 
    ::  CustomEmojiPayload
newCustomEmojiPayload
  = CustomEmojiPayload{fileContent = Core.Nothing,
                       filename = Core.Nothing}
instance Core.FromJSON CustomEmojiPayload where
        parseJSON
          = Core.withObject "CustomEmojiPayload"
              (\ o ->
                 CustomEmojiPayload Core.<$>
                   (o Core..:? "fileContent") Core.<*> (o Core..:? "filename"))

instance Core.ToJSON CustomEmojiPayload where
        toJSON CustomEmojiPayload{..}
          = Core.object
              (Core.catMaybes
...
instance Core.FromJSON DateInput where
        parseJSON
          = Core.withObject "DateInput"
              (\ o ->
                 DateInput Core.<$>
                   (o Core..:? "msSinceEpoch" Core.<&> Core.fmap Core.fromAsText))
...
newDateTimeInput 
    ::  DateTimeInput
newDateTimeInput
  = DateTimeInput{hasDate = Core.Nothing, hasTime = Core.Nothing,
...
instance Core.FromJSON DateTimeInput where
        parseJSON
          = Core.withObject "DateTimeInput"
              (\ o ->
                 DateTimeInput Core.<$>
                   (o Core..:? "hasDate") Core.<*> (o Core..:? "hasTime") Core.<*>
                     (o Core..:? "msSinceEpoch" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("hasDate" Core..=) Core.<$> hasDate,
                  ...
                  ("msSinceEpoch" Core..=) Core.. Core.AsText Core.<$> msSinceEpoch])
...
instance Core.FromJSON DeletionMetadata where
        parseJSON
          = Core.withObject "DeletionMetadata"
              (\ o -> DeletionMetadata Core.<$> (o Core..:? "deletionType"))

instance Core.ToJSON DeletionMetadata where
        toJSON DeletionMetadata{..}
          = Core.object
              (Core.catMaybes [("deletionType" Core..=) Core.<$> deletionType])
...
data DeprecatedEvent = DeprecatedEvent
    ...
    , appCommandMetadata :: (Core.Maybe AppCommandMetadata)
    ...
    , common :: (Core.Maybe CommonEventObject)
      -- | This URL is populated for @MESSAGE@, @ADDED_TO_SPACE@, and @APP_COMMAND@ interaction events. After completing an authorization or configuration flow outside of Google Chat, users must be redirected to this URL to signal to Google Chat that the authorization or configuration flow was successful. For more information, see <https://developers.google.com/workspace/chat/connect-web-services-tools Connect a Chat app with other services and tools>.
...
newDeprecatedEvent 
    ::  DeprecatedEvent
newDeprecatedEvent
  = DeprecatedEvent{action = Core.Nothing,
                    appCommandMetadata = Core.Nothing, common = Core.Nothing,
                    configCompleteRedirectUrl = Core.Nothing,
                    dialogEventType = Core.Nothing, eventTime = Core.Nothing,
                    isDialogEvent = Core.Nothing, message = Core.Nothing,
                    space = Core.Nothing, thread = Core.Nothing,
                    threadKey = Core.Nothing, token = Core.Nothing,
                    type' = Core.Nothing, user = Core.Nothing}
instance Core.FromJSON DeprecatedEvent where
        parseJSON
          = Core.withObject "DeprecatedEvent"
              (\ o ->
                 DeprecatedEvent Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "appCommandMetadata")
                     Core.<*> (o Core..:? "common")
          ...
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("appCommandMetadata" Core..=) Core.<$> appCommandMetadata,
...
instance Core.FromJSON DriveDataRef where
        parseJSON
          = Core.withObject "DriveDataRef"
              (\ o -> DriveDataRef Core.<$> (o Core..:? "driveFileId"))

instance Core.ToJSON DriveDataRef where
        toJSON DriveDataRef{..}
          = Core.object
              (Core.catMaybes [("driveFileId" Core..=) Core.<$> driveFileId])
...
newDriveLinkData 
    ::  DriveLinkData
newDriveLinkData
  = DriveLinkData{driveDataRef = Core.Nothing,
...
instance Core.FromJSON DriveLinkData where
        parseJSON
          = Core.withObject "DriveLinkData"
              (\ o ->
                 DriveLinkData Core.<$>
                   (o Core..:? "driveDataRef") Core.<*> (o Core..:? "mimeType"))
...
newEmoji 
    ::  Emoji
newEmoji
  = Emoji{customEmoji = Core.Nothing, unicode = Core.Nothing}
instance Core.FromJSON Emoji where
        parseJSON
          = Core.withObject "Emoji"
              (\ o ->
                 Emoji Core.<$>
                   (o Core..:? "customEmoji") Core.<*> (o Core..:? "unicode"))
...
newFormAction 
    ::  FormAction
newFormAction
  = FormAction{actionMethodName = Core.Nothing,
...
instance Core.FromJSON FormAction where
        parseJSON
          = Core.withObject "FormAction"
              (\ o ->
                 FormAction Core.<$>
                   (o Core..:? "actionMethodName") Core.<*> (o Core..:? "parameters"))

instance Core.ToJSON FormAction where
        toJSON FormAction{..}
          = Core.object
              (Core.catMaybes
                 [("actionMethodName" Core..=) Core.<$> actionMethodName,
                  ("parameters" Core..=) Core.<$> parameters])
...
data GoogleAppsCardV1Action = GoogleAppsCardV1Action
    {
      -- | Optional. If this is true, then all widgets are considered required by this action. <https://developers.google.com/workspace/extend Google Workspace add-ons and Chat apps>:
      allWidgetsAreRequired :: (Core.Maybe Core.Bool)
    ...
    , persistValues :: (Core.Maybe Core.Bool)
      -- | Optional. Fill this list with the names of widgets that this Action needs for a valid submission. If the widgets listed here don\'t have a value when this Action is invoked, the form submission is aborted. <https://developers.google.com/workspace/extend Google Workspace add-ons and Chat apps>:
    , requiredWidgets :: (Core.Maybe [Core.Text])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleAppsCardV1Action 
    ::  GoogleAppsCardV1Action
newGoogleAppsCardV1Action
  = GoogleAppsCardV1Action{allWidgetsAreRequired = Core.Nothing,
                           function = Core.Nothing, interaction = Core.Nothing,
                           loadIndicator = Core.Nothing, parameters = Core.Nothing,
                           persistValues = Core.Nothing, requiredWidgets = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Action where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Action"
              (\ o ->
                 GoogleAppsCardV1Action Core.<$>
                   (o Core..:? "allWidgetsAreRequired") Core.<*>
                     (o Core..:? "function")
                     Core.<*> (o Core..:? "interaction")
                     Core.<*> (o Core..:? "loadIndicator")
                     Core.<*> (o Core..:? "parameters")
                     Core.<*> (o Core..:? "persistValues")
                     Core.<*> (o Core..:? "requiredWidgets"))

instance Core.ToJSON GoogleAppsCardV1Action where
        toJSON GoogleAppsCardV1Action{..}
          = Core.object
              (Core.catMaybes
                 [("allWidgetsAreRequired" Core..=) Core.<$> allWidgetsAreRequired,
                  ...
                  ("requiredWidgets" Core..=) Core.<$> requiredWidgets])
...
newGoogleAppsCardV1ActionParameter 
    :: 
                                   GoogleAppsCardV1ActionParameter
newGoogleAppsCardV1ActionParameter
  = GoogleAppsCardV1ActionParameter{key = Core.Nothing,
                                    value = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1ActionParameter where
        parseJSON
...
newGoogleAppsCardV1BorderStyle 
    ::  GoogleAppsCardV1BorderStyle
newGoogleAppsCardV1BorderStyle
  = GoogleAppsCardV1BorderStyle{cornerRadius = Core.Nothing,
                                strokeColor = Core.Nothing, type' = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1BorderStyle"
              (\ o ->
                 GoogleAppsCardV1BorderStyle Core.<$>
                   (o Core..:? "cornerRadius") Core.<*> (o Core..:? "strokeColor")
                     Core.<*> (o Core..:? "type"))
...
newGoogleAppsCardV1Button 
    ::  GoogleAppsCardV1Button
newGoogleAppsCardV1Button
  = GoogleAppsCardV1Button{altText = Core.Nothing,
                           color = Core.Nothing, disabled = Core.Nothing, icon = Core.Nothing,
                           onClick = Core.Nothing, text = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Button where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Button"
              (\ o ->
                 GoogleAppsCardV1Button Core.<$>
                   (o Core..:? "altText") Core.<*> (o Core..:? "color") Core.<*>
                     (o Core..:? "disabled")
                     Core.<*> (o Core..:? "icon")
                     Core.<*> (o Core..:? "onClick")
                     Core.<*> (o Core..:? "text")
...
instance Core.FromJSON GoogleAppsCardV1ButtonList where
        parseJSON
          = Core.withObject "GoogleAppsCardV1ButtonList"
              (\ o -> GoogleAppsCardV1ButtonList Core.<$> (o Core..:? "buttons"))

instance Core.ToJSON GoogleAppsCardV1ButtonList where
        toJSON GoogleAppsCardV1ButtonList{..}
          = Core.object
              (Core.catMaybes [("buttons" Core..=) Core.<$> buttons])
...
newGoogleAppsCardV1Card 
    ::  GoogleAppsCardV1Card
newGoogleAppsCardV1Card
  = GoogleAppsCardV1Card{cardActions = Core.Nothing,
                         displayStyle = Core.Nothing, fixedFooter = Core.Nothing,
                         header = Core.Nothing, name = Core.Nothing,
                         peekCardHeader = Core.Nothing, sectionDividerStyle = Core.Nothing,
          ...
          = Core.withObject "GoogleAppsCardV1Card"
              (\ o ->
                 GoogleAppsCardV1Card Core.<$>
                   (o Core..:? "cardActions") Core.<*> (o Core..:? "displayStyle")
          ...
          = Core.object
              (Core.catMaybes
                 [("cardActions" Core..=) Core.<$> cardActions,
                  ...
                  ("sectionDividerStyle" Core..=) Core.<$> sectionDividerStyle,
                  ("sections" Core..=) Core.<$> sections])
...
newGoogleAppsCardV1CardAction 
    ::  GoogleAppsCardV1CardAction
newGoogleAppsCardV1CardAction
  = GoogleAppsCardV1CardAction{actionLabel = Core.Nothing,
...
newGoogleAppsCardV1CardFixedFooter 
    :: 
                                   GoogleAppsCardV1CardFixedFooter
newGoogleAppsCardV1CardFixedFooter
  = GoogleAppsCardV1CardFixedFooter{primaryButton = Core.Nothing,
                                    secondaryButton = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1CardFixedFooter where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("primaryButton" Core..=) Core.<$> primaryButton,
                  ("secondaryButton" Core..=) Core.<$> secondaryButton])
...
newGoogleAppsCardV1CardHeader 
    ::  GoogleAppsCardV1CardHeader
newGoogleAppsCardV1CardHeader
  = GoogleAppsCardV1CardHeader{imageAltText = Core.Nothing,
                               imageType = Core.Nothing, imageUrl = Core.Nothing,
                               subtitle = Core.Nothing, title = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1CardHeader"
              (\ o ->
                 GoogleAppsCardV1CardHeader Core.<$>
                   (o Core..:? "imageAltText") Core.<*> (o Core..:? "imageType")
...
instance Core.FromJSON GoogleAppsCardV1Carousel where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Carousel"
              (\ o ->
                 GoogleAppsCardV1Carousel Core.<$> (o Core..:? "carouselCards"))

instance Core.ToJSON GoogleAppsCardV1Carousel where
        toJSON GoogleAppsCardV1Carousel{..}
          = Core.object
              (Core.catMaybes [("carouselCards" Core..=) Core.<$> carouselCards])
...
newGoogleAppsCardV1CarouselCard 
    ::  GoogleAppsCardV1CarouselCard
newGoogleAppsCardV1CarouselCard
  = GoogleAppsCardV1CarouselCard{footerWidgets = Core.Nothing,
                                 widgets = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1CarouselCard where
        parseJSON
          = Core.withObject "GoogleAppsCardV1CarouselCard"
              (\ o ->
                 GoogleAppsCardV1CarouselCard Core.<$>
                   (o Core..:? "footerWidgets") Core.<*> (o Core..:? "widgets"))

instance Core.ToJSON GoogleAppsCardV1CarouselCard where
...
-- | A text, icon, or text and icon chip that users can click. <https://developers.google.com/workspace/extend Google Workspace add-ons and Chat apps>:
--
...
newGoogleAppsCardV1Chip 
    ::  GoogleAppsCardV1Chip
newGoogleAppsCardV1Chip
  = GoogleAppsCardV1Chip{altText = Core.Nothing,
                         disabled = Core.Nothing, enabled = Core.Nothing,
                         icon = Core.Nothing, label = Core.Nothing, onClick = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Chip where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Chip"
              (\ o ->
                 GoogleAppsCardV1Chip Core.<$>
                   (o Core..:? "altText") Core.<*> (o Core..:? "disabled") Core.<*>
                     (o Core..:? "enabled")
                     Core.<*> (o Core..:? "icon")
                     Core.<*> (o Core..:? "label")
                     Core.<*> (o Core..:? "onClick"))
          ...
          = Core.object
              (Core.catMaybes
                 [("altText" Core..=) Core.<$> altText,
                  ...
                  ("icon" Core..=) Core.<$> icon, ("label" Core..=) Core.<$> label,
                  ("onClick" Core..=) Core.<$> onClick])


-- | A list of chips layed out horizontally, which can either scroll horizontally or wrap to the next line. <https://developers.google.com/workspace/extend Google Workspace add-ons and Chat apps>:
--
...
newGoogleAppsCardV1ChipList 
    ::  GoogleAppsCardV1ChipList
newGoogleAppsCardV1ChipList
  = GoogleAppsCardV1ChipList{chips = Core.Nothing,
                             layout = Core.Nothing}
...
-- | Represent an expand and collapse control. <https://developers.google.com/workspace/extend Google Workspace add-ons and Chat apps>:
--
...
newGoogleAppsCardV1CollapseControl 
    :: 
                                   GoogleAppsCardV1CollapseControl
newGoogleAppsCardV1CollapseControl
  = GoogleAppsCardV1CollapseControl{collapseButton = Core.Nothing,
                                    expandButton = Core.Nothing, horizontalAlignment = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1CollapseControl where
        parseJSON
          = Core.withObject "GoogleAppsCardV1CollapseControl"
              (\ o ->
                 GoogleAppsCardV1CollapseControl Core.<$>
                   (o Core..:? "collapseButton") Core.<*> (o Core..:? "expandButton")
                     Core.<*> (o Core..:? "horizontalAlignment"))

instance Core.ToJSON GoogleAppsCardV1CollapseControl where
...
newGoogleAppsCardV1Column 
    ::  GoogleAppsCardV1Column
newGoogleAppsCardV1Column
  = GoogleAppsCardV1Column{horizontalAlignment = Core.Nothing,
                           horizontalSizeStyle = Core.Nothing,
                           verticalAlignment = Core.Nothing, widgets = Core.Nothing}
...
instance Core.ToJSON GoogleAppsCardV1Column where
        toJSON GoogleAppsCardV1Column{..}
          = Core.object
              (Core.catMaybes
                 [("horizontalAlignment" Core..=) Core.<$> horizontalAlignment,
                  ("horizontalSizeStyle" Core..=) Core.<$> horizontalSizeStyle,
...
instance Core.FromJSON GoogleAppsCardV1Columns where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Columns"
              (\ o ->
                 GoogleAppsCardV1Columns Core.<$> (o Core..:? "columnItems"))

instance Core.ToJSON GoogleAppsCardV1Columns where
        toJSON GoogleAppsCardV1Columns{..}
          = Core.object
              (Core.catMaybes [("columnItems" Core..=) Core.<$> columnItems])
...
newGoogleAppsCardV1DateTimePicker 
    ::  GoogleAppsCardV1DateTimePicker
newGoogleAppsCardV1DateTimePicker
  = GoogleAppsCardV1DateTimePicker{label = Core.Nothing,
                                   name = Core.Nothing, onChangeAction = Core.Nothing,
                                   timezoneOffsetDate = Core.Nothing, type' = Core.Nothing,
          ...
          = Core.withObject "GoogleAppsCardV1DateTimePicker"
              (\ o ->
                 GoogleAppsCardV1DateTimePicker Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "onChangeAction")
                     Core.<*> (o Core..:? "timezoneOffsetDate")
                     Core.<*> (o Core..:? "type")
                     Core.<*>
                     (o Core..:? "valueMsEpoch" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("label" Core..=) Core.<$> label, ("name" Core..=) Core.<$> name,
                  ...
                  ("timezoneOffsetDate" Core..=) Core.<$> timezoneOffsetDate,
                  ("type" Core..=) Core.<$> type',
                  ("valueMsEpoch" Core..=) Core.. Core.AsText Core.<$> valueMsEpoch])
...
newGoogleAppsCardV1DecoratedText 
    ::  GoogleAppsCardV1DecoratedText
newGoogleAppsCardV1DecoratedText
  = GoogleAppsCardV1DecoratedText{bottomLabel = Core.Nothing,
                                  button = Core.Nothing, endIcon = Core.Nothing,
                                  icon = Core.Nothing, onClick = Core.Nothing,
                                  startIcon = Core.Nothing, switchControl = Core.Nothing,
                                  text = Core.Nothing, topLabel = Core.Nothing,
          ...
          = Core.withObject "GoogleAppsCardV1DecoratedText"
              (\ o ->
                 GoogleAppsCardV1DecoratedText Core.<$>
                   (o Core..:? "bottomLabel") Core.<*> (o Core..:? "button") Core.<*>
                     (o Core..:? "endIcon")
                     Core.<*> (o Core..:? "icon")
                     Core.<*> (o Core..:? "onClick")
...
newGoogleAppsCardV1Grid 
    ::  GoogleAppsCardV1Grid
newGoogleAppsCardV1Grid
  = GoogleAppsCardV1Grid{borderStyle = Core.Nothing,
                         columnCount = Core.Nothing, items = Core.Nothing,
                         onClick = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Grid where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Grid"
              (\ o ->
                 GoogleAppsCardV1Grid Core.<$>
                   (o Core..:? "borderStyle") Core.<*> (o Core..:? "columnCount")
                     Core.<*> (o Core..:? "items")
                     Core.<*> (o Core..:? "onClick")
                     Core.<*> (o Core..:? "title"))
...
newGoogleAppsCardV1GridItem 
    ::  GoogleAppsCardV1GridItem
newGoogleAppsCardV1GridItem
  = GoogleAppsCardV1GridItem{id = Core.Nothing, image = Core.Nothing,
                             layout = Core.Nothing, subtitle = Core.Nothing,
                             title = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1GridItem"
              (\ o ->
                 GoogleAppsCardV1GridItem Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "image") Core.<*>
                     (o Core..:? "layout")
                     Core.<*> (o Core..:? "subtitle")
                     Core.<*> (o Core..:? "title"))
...
instance Core.ToJSON GoogleAppsCardV1GridItem where
        toJSON GoogleAppsCardV1GridItem{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("image" Core..=) Core.<$> image,
                  ("layout" Core..=) Core.<$> layout,
                  ("subtitle" Core..=) Core.<$> subtitle,
                  ("title" Core..=) Core.<$> title])
...
newGoogleAppsCardV1Icon 
    ::  GoogleAppsCardV1Icon
newGoogleAppsCardV1Icon
  = GoogleAppsCardV1Icon{altText = Core.Nothing,
                         iconUrl = Core.Nothing, imageType = Core.Nothing,
                         knownIcon = Core.Nothing, materialIcon = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Icon where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Icon"
              (\ o ->
                 GoogleAppsCardV1Icon Core.<$>
                   (o Core..:? "altText") Core.<*> (o Core..:? "iconUrl") Core.<*>
                     (o Core..:? "imageType")
...
newGoogleAppsCardV1Image 
    ::  GoogleAppsCardV1Image
newGoogleAppsCardV1Image
  = GoogleAppsCardV1Image{altText = Core.Nothing,
                          imageUrl = Core.Nothing, onClick = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Image where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Image"
              (\ o ->
                 GoogleAppsCardV1Image Core.<$>
                   (o Core..:? "altText") Core.<*> (o Core..:? "imageUrl") Core.<*>
                     (o Core..:? "onClick"))
...
newGoogleAppsCardV1ImageComponent 
    ::  GoogleAppsCardV1ImageComponent
newGoogleAppsCardV1ImageComponent
  = GoogleAppsCardV1ImageComponent{altText = Core.Nothing,
                                   borderStyle = Core.Nothing, cropStyle = Core.Nothing,
          ...
          = Core.withObject "GoogleAppsCardV1ImageComponent"
              (\ o ->
                 GoogleAppsCardV1ImageComponent Core.<$>
                   (o Core..:? "altText") Core.<*> (o Core..:? "borderStyle") Core.<*>
                     (o Core..:? "cropStyle")
...
newGoogleAppsCardV1ImageCropStyle 
    ::  GoogleAppsCardV1ImageCropStyle
newGoogleAppsCardV1ImageCropStyle
  = GoogleAppsCardV1ImageCropStyle{aspectRatio = Core.Nothing,
                                   type' = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1ImageCropStyle"
              (\ o ->
                 GoogleAppsCardV1ImageCropStyle Core.<$>
                   (o Core..:? "aspectRatio") Core.<*> (o Core..:? "type"))
...
newGoogleAppsCardV1MaterialIcon 
    ::  GoogleAppsCardV1MaterialIcon
newGoogleAppsCardV1MaterialIcon
  = GoogleAppsCardV1MaterialIcon{fill = Core.Nothing,
                                 grade = Core.Nothing, name = Core.Nothing, weight = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1MaterialIcon where
        parseJSON
          = Core.withObject "GoogleAppsCardV1MaterialIcon"
              (\ o ->
                 GoogleAppsCardV1MaterialIcon Core.<$>
                   (o Core..:? "fill") Core.<*> (o Core..:? "grade") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "weight"))

instance Core.ToJSON GoogleAppsCardV1MaterialIcon where
        toJSON GoogleAppsCardV1MaterialIcon{..}
          = Core.object
              (Core.catMaybes
                 [("fill" Core..=) Core.<$> fill, ("grade" Core..=) Core.<$> grade,
                  ("name" Core..=) Core.<$> name,
...
newGoogleAppsCardV1NestedWidget 
    ::  GoogleAppsCardV1NestedWidget
newGoogleAppsCardV1NestedWidget
  = GoogleAppsCardV1NestedWidget{buttonList = Core.Nothing,
                                 image = Core.Nothing, textParagraph = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1NestedWidget where
        parseJSON
          = Core.withObject "GoogleAppsCardV1NestedWidget"
              (\ o ->
                 GoogleAppsCardV1NestedWidget Core.<$>
                   (o Core..:? "buttonList") Core.<*> (o Core..:? "image") Core.<*>
                     (o Core..:? "textParagraph"))

instance Core.ToJSON GoogleAppsCardV1NestedWidget where
...
newGoogleAppsCardV1OnClick 
    ::  GoogleAppsCardV1OnClick
newGoogleAppsCardV1OnClick
  = GoogleAppsCardV1OnClick{action = Core.Nothing,
                            card = Core.Nothing, openDynamicLinkAction = Core.Nothing,
                            openLink = Core.Nothing, overflowMenu = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1OnClick where
        parseJSON
          = Core.withObject "GoogleAppsCardV1OnClick"
              (\ o ->
                 GoogleAppsCardV1OnClick Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "card") Core.<*>
                     (o Core..:? "openDynamicLinkAction")
        ...
        toJSON GoogleAppsCardV1OnClick{..}
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("card" Core..=) Core.<$> card,
                  ("openDynamicLinkAction" Core..=) Core.<$> openDynamicLinkAction,
...
newGoogleAppsCardV1OpenLink 
    ::  GoogleAppsCardV1OpenLink
newGoogleAppsCardV1OpenLink
  = GoogleAppsCardV1OpenLink{onClose = Core.Nothing,
                             openAs = Core.Nothing, url = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1OpenLink"
              (\ o ->
                 GoogleAppsCardV1OpenLink Core.<$>
                   (o Core..:? "onClose") Core.<*> (o Core..:? "openAs") Core.<*>
                     (o Core..:? "url"))
          ...
          = Core.object
              (Core.catMaybes
                 [("onClose" Core..=) Core.<$> onClose,
                  ("openAs" Core..=) Core.<$> openAs, ("url" Core..=) Core.<$> url])


-- | A widget that presents a pop-up menu with one or more actions that users can invoke. For example, showing non-primary actions in a card. You can use this widget when actions don\'t fit in the available space. To use, specify this widget in the @OnClick@ action of widgets that support it. For example, in a @Button@. <https://developers.google.com/workspace/extend Google Workspace add-ons and Chat apps>:
--
...
instance Core.FromJSON GoogleAppsCardV1OverflowMenu where
        parseJSON
          = Core.withObject "GoogleAppsCardV1OverflowMenu"
              (\ o -> GoogleAppsCardV1OverflowMenu Core.<$> (o Core..:? "items"))

instance Core.ToJSON GoogleAppsCardV1OverflowMenu where
        toJSON GoogleAppsCardV1OverflowMenu{..}
          = Core.object (Core.catMaybes [("items" Core..=) Core.<$> items])


-- | An option that users can invoke in an overflow menu. <https://developers.google.com/workspace/extend Google Workspace add-ons and Chat apps>:
--
...
newGoogleAppsCardV1OverflowMenuItem 
    :: 
                                    GoogleAppsCardV1OverflowMenuItem
newGoogleAppsCardV1OverflowMenuItem
  = GoogleAppsCardV1OverflowMenuItem{disabled = Core.Nothing,
                                     onClick = Core.Nothing, startIcon = Core.Nothing,
                                     text = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1OverflowMenuItem where
        parseJSON
          = Core.withObject "GoogleAppsCardV1OverflowMenuItem"
              (\ o ->
                 GoogleAppsCardV1OverflowMenuItem Core.<$>
                   (o Core..:? "disabled") Core.<*> (o Core..:? "onClick") Core.<*>
                     (o Core..:? "startIcon")
                     Core.<*> (o Core..:? "text"))

instance Core.ToJSON GoogleAppsCardV1OverflowMenuItem where
...
newGoogleAppsCardV1PlatformDataSource 
    :: 
                                      GoogleAppsCardV1PlatformDataSource
newGoogleAppsCardV1PlatformDataSource
  = GoogleAppsCardV1PlatformDataSource{commonDataSource =
                                         Core.Nothing,
                                       hostAppDataSource = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1PlatformDataSource where
        parseJSON
          = Core.withObject "GoogleAppsCardV1PlatformDataSource"
              (\ o ->
                 GoogleAppsCardV1PlatformDataSource Core.<$>
                   (o Core..:? "commonDataSource") Core.<*>
                     (o Core..:? "hostAppDataSource"))

instance Core.ToJSON GoogleAppsCardV1PlatformDataSource where
        toJSON GoogleAppsCardV1PlatformDataSource{..}
          = Core.object
              (Core.catMaybes
                 [("commonDataSource" Core..=) Core.<$> commonDataSource,
                  ("hostAppDataSource" Core..=) Core.<$> hostAppDataSource])
...
newGoogleAppsCardV1Section 
    ::  GoogleAppsCardV1Section
newGoogleAppsCardV1Section
  = GoogleAppsCardV1Section{collapseControl = Core.Nothing,
                            collapsible = Core.Nothing, header = Core.Nothing,
                            uncollapsibleWidgetsCount = Core.Nothing, widgets = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Section where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Section"
              (\ o ->
                 GoogleAppsCardV1Section Core.<$>
                   (o Core..:? "collapseControl") Core.<*> (o Core..:? "collapsible")
                     Core.<*> (o Core..:? "header")
...
instance Core.ToJSON GoogleAppsCardV1Section where
        toJSON GoogleAppsCardV1Section{..}
          = Core.object
              (Core.catMaybes
                 [("collapseControl" Core..=) Core.<$> collapseControl,
...
newGoogleAppsCardV1SelectionInput 
    ::  GoogleAppsCardV1SelectionInput
newGoogleAppsCardV1SelectionInput
  = GoogleAppsCardV1SelectionInput{externalDataSource = Core.Nothing,
                                   items = Core.Nothing, label = Core.Nothing,
                                   multiSelectMaxSelectedItems = Core.Nothing,
                                   multiSelectMinQueryLength = Core.Nothing, name = Core.Nothing,
                                   onChangeAction = Core.Nothing, platformDataSource = Core.Nothing,
                                   type' = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1SelectionInput"
              (\ o ->
                 GoogleAppsCardV1SelectionInput Core.<$>
                   (o Core..:? "externalDataSource") Core.<*> (o Core..:? "items")
                     Core.<*> (o Core..:? "label")
...
instance Core.ToJSON GoogleAppsCardV1SelectionInput where
        toJSON GoogleAppsCardV1SelectionInput{..}
          = Core.object
              (Core.catMaybes
                 [("externalDataSource" Core..=) Core.<$> externalDataSource,
                  ("items" Core..=) Core.<$> items, ("label" Core..=) Core.<$> label,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("onChangeAction" Core..=) Core.<$> onChangeAction,
                  ("platformDataSource" Core..=) Core.<$> platformDataSource,
                  ("type" Core..=) Core.<$> type'])
...
newGoogleAppsCardV1SelectionItem 
    ::  GoogleAppsCardV1SelectionItem
newGoogleAppsCardV1SelectionItem
  = GoogleAppsCardV1SelectionItem{bottomText = Core.Nothing,
                                  selected = Core.Nothing, startIconUri = Core.Nothing,
                                  text = Core.Nothing, value = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1SelectionItem"
              (\ o ->
                 GoogleAppsCardV1SelectionItem Core.<$>
                   (o Core..:? "bottomText") Core.<*> (o Core..:? "selected") Core.<*>
                     (o Core..:? "startIconUri")
                     Core.<*> (o Core..:? "text")
                     Core.<*> (o Core..:? "value"))
          ...
          = Core.object
              (Core.catMaybes
                 [("bottomText" Core..=) Core.<$> bottomText,
                  ...
                  ("text" Core..=) Core.<$> text, ("value" Core..=) Core.<$> value])
...
instance Core.FromJSON GoogleAppsCardV1SuggestionItem where
        parseJSON
          = Core.withObject "GoogleAppsCardV1SuggestionItem"
              (\ o ->
                 GoogleAppsCardV1SuggestionItem Core.<$> (o Core..:? "text"))
...
instance Core.FromJSON GoogleAppsCardV1Suggestions where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Suggestions"
              (\ o -> GoogleAppsCardV1Suggestions Core.<$> (o Core..:? "items"))
...
newGoogleAppsCardV1SwitchControl 
    ::  GoogleAppsCardV1SwitchControl
newGoogleAppsCardV1SwitchControl
  = GoogleAppsCardV1SwitchControl{controlType = Core.Nothing,
                                  name = Core.Nothing, onChangeAction = Core.Nothing,
                                  selected = Core.Nothing, value = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1SwitchControl"
              (\ o ->
                 GoogleAppsCardV1SwitchControl Core.<$>
                   (o Core..:? "controlType") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "onChangeAction")
...
data GoogleAppsCardV1TextInput = GoogleAppsCardV1TextInput
    ...
    , type' :: (Core.Maybe GoogleAppsCardV1TextInput_Type)
      -- | Specify the input format validation necessary for this text field. <https://developers.google.com/workspace/extend Google Workspace add-ons and Chat apps>:
    , validation :: (Core.Maybe GoogleAppsCardV1Validation)
      -- | The value entered by a user, returned as part of a form input event. For details about working with form inputs, see <https://developers.google.com/workspace/chat/read-form-data Receive form data>.
    , value :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleAppsCardV1TextInput 
    ::  GoogleAppsCardV1TextInput
newGoogleAppsCardV1TextInput
  = GoogleAppsCardV1TextInput{autoCompleteAction = Core.Nothing,
                              hintText = Core.Nothing, initialSuggestions = Core.Nothing,
                              label = Core.Nothing, name = Core.Nothing,
                              onChangeAction = Core.Nothing, placeholderText = Core.Nothing,
                              type' = Core.Nothing, validation = Core.Nothing,
                              value = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1TextInput"
              (\ o ->
                 GoogleAppsCardV1TextInput Core.<$>
                   (o Core..:? "autoCompleteAction") Core.<*> (o Core..:? "hintText")
...
instance Core.ToJSON GoogleAppsCardV1TextInput where
        toJSON GoogleAppsCardV1TextInput{..}
          = Core.object
              (Core.catMaybes
                 [("autoCompleteAction" Core..=) Core.<$> autoCompleteAction,
                  ("hintText" Core..=) Core.<$> hintText,
                  ("initialSuggestions" Core..=) Core.<$> initialSuggestions,
                  ("label" Core..=) Core.<$> label, ("name" Core..=) Core.<$> name,
                  ("onChangeAction" Core..=) Core.<$> onChangeAction,
...
newGoogleAppsCardV1TextParagraph 
    ::  GoogleAppsCardV1TextParagraph
newGoogleAppsCardV1TextParagraph
  = GoogleAppsCardV1TextParagraph{maxLines = Core.Nothing,
                                  text = Core.Nothing}
...
-- | Represents the necessary data for validating the widget it\'s attached to. <https://developers.google.com/workspace/extend Google Workspace add-ons and Chat apps>:
--
-- /See:/ 'newGoogleAppsCardV1Validation' smart constructor.
data GoogleAppsCardV1Validation = GoogleAppsCardV1Validation
    {
      -- | Specify the character limit for text input widgets. Note that this is only used for text input and is ignored for other widgets. <https://developers.google.com/workspace/extend Google Workspace add-ons and Chat apps>:
      characterLimit :: (Core.Maybe Core.Int32)
    ...
    , inputType :: (Core.Maybe GoogleAppsCardV1Validation_InputType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleAppsCardV1Validation' with the minimum fields required to make a request.
newGoogleAppsCardV1Validation 
    ::  GoogleAppsCardV1Validation
newGoogleAppsCardV1Validation
  = GoogleAppsCardV1Validation{characterLimit = Core.Nothing,
                               inputType = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Validation where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Validation"
              (\ o ->
                 GoogleAppsCardV1Validation Core.<$>
                   (o Core..:? "characterLimit") Core.<*> (o Core..:? "inputType"))

instance Core.ToJSON GoogleAppsCardV1Validation where
        toJSON GoogleAppsCardV1Validation{..}
          = Core.object
              (Core.catMaybes
                 [("characterLimit" Core..=) Core.<$> characterLimit,
...
newGoogleAppsCardV1Widget 
    ::  GoogleAppsCardV1Widget
newGoogleAppsCardV1Widget
  = GoogleAppsCardV1Widget{buttonList = Core.Nothing,
                           carousel = Core.Nothing, chipList = Core.Nothing,
                           columns = Core.Nothing, dateTimePicker = Core.Nothing,
                           decoratedText = Core.Nothing, divider = Core.Nothing,
                           grid = Core.Nothing, horizontalAlignment = Core.Nothing,
                           image = Core.Nothing, selectionInput = Core.Nothing,
                           textInput = Core.Nothing, textParagraph = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Widget where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Widget"
              (\ o ->
                 GoogleAppsCardV1Widget Core.<$>
                   (o Core..:? "buttonList") Core.<*> (o Core..:? "carousel") Core.<*>
                     (o Core..:? "chipList")
                     Core.<*> (o Core..:? "columns")
...
newGoogleAppsCardV1Widgets 
    ::  GoogleAppsCardV1Widgets
newGoogleAppsCardV1Widgets
  = GoogleAppsCardV1Widgets{buttonList = Core.Nothing,
                            chipList = Core.Nothing, dateTimePicker = Core.Nothing,
                            decoratedText = Core.Nothing, image = Core.Nothing,
                            selectionInput = Core.Nothing, textInput = Core.Nothing,
          ...
          = Core.withObject "GoogleAppsCardV1Widgets"
              (\ o ->
                 GoogleAppsCardV1Widgets Core.<$>
                   (o Core..:? "buttonList") Core.<*> (o Core..:? "chipList") Core.<*>
...
instance Core.FromJSON HostAppDataSourceMarkup where
        parseJSON
          = Core.withObject "HostAppDataSourceMarkup"
              (\ o ->
                 HostAppDataSourceMarkup Core.<$> (o Core..:? "chatDataSource"))
...
newImage 
    ::  Image
newImage
  = Image{aspectRatio = Core.Nothing, imageUrl = Core.Nothing,
          onClick = Core.Nothing}
instance Core.FromJSON Image where
        parseJSON
          = Core.withObject "Image"
              (\ o ->
                 Image Core.<$>
                   (o Core..:? "aspectRatio") Core.<*> (o Core..:? "imageUrl")
                     Core.<*> (o Core..:? "onClick"))
...
newImageButton 
    ::  ImageButton
newImageButton
  = ImageButton{icon = Core.Nothing, iconUrl = Core.Nothing,
                name = Core.Nothing, onClick = Core.Nothing}
instance Core.FromJSON ImageButton where
        parseJSON
          = Core.withObject "ImageButton"
              (\ o ->
                 ImageButton Core.<$>
                   (o Core..:? "icon") Core.<*> (o Core..:? "iconUrl") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "onClick"))
...
newInputs 
    ::  Inputs
newInputs
  = Inputs{dateInput = Core.Nothing, dateTimeInput = Core.Nothing,
           stringInputs = Core.Nothing, timeInput = Core.Nothing}
instance Core.FromJSON Inputs where
        parseJSON
          = Core.withObject "Inputs"
              (\ o ->
                 Inputs Core.<$>
                   (o Core..:? "dateInput") Core.<*> (o Core..:? "dateTimeInput")
...
newKeyValue 
    ::  KeyValue
newKeyValue
  = KeyValue{bottomLabel = Core.Nothing, button = Core.Nothing,
             content = Core.Nothing, contentMultiline = Core.Nothing,
             icon = Core.Nothing, iconUrl = Core.Nothing,
             onClick = Core.Nothing, topLabel = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("bottomLabel" Core..=) Core.<$> bottomLabel,
                  ...
                  ("contentMultiline" Core..=) Core.<$> contentMultiline,
                  ("icon" Core..=) Core.<$> icon,
                  ("iconUrl" Core..=) Core.<$> iconUrl,
                  ("onClick" Core..=) Core.<$> onClick,
                  ("topLabel" Core..=) Core.<$> topLabel])
...
--
-- /See:/ 'newListCustomEmojisResponse' smart constructor.
data ListCustomEmojisResponse = ListCustomEmojisResponse
    {
      -- | Unordered list. List of custom emojis.
      customEmojis :: (Core.Maybe [CustomEmoji])
      -- | A token that you can send as @pageToken@ to retrieve the next page of results. If empty, there are no subsequent pages.
    , nextPageToken :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ListCustomEmojisResponse' with the minimum fields required to make a request.
newListCustomEmojisResponse 
    ::  ListCustomEmojisResponse
newListCustomEmojisResponse
  = ListCustomEmojisResponse{customEmojis = Core.Nothing,
                             nextPageToken = Core.Nothing}
instance Core.FromJSON ListCustomEmojisResponse where
        parseJSON
          = Core.withObject "ListCustomEmojisResponse"
              (\ o ->
                 ListCustomEmojisResponse Core.<$>
                   (o Core..:? "customEmojis") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON ListCustomEmojisResponse where
        toJSON ListCustomEmojisResponse{..}
          = Core.object
              (Core.catMaybes
                 [("customEmojis" Core..=) Core.<$> customEmojis,
...
newListMembershipsResponse 
    ::  ListMembershipsResponse
newListMembershipsResponse
  = ListMembershipsResponse{memberships = Core.Nothing,
                            nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListMembershipsResponse"
              (\ o ->
                 ListMembershipsResponse Core.<$>
                   (o Core..:? "memberships") Core.<*> (o Core..:? "nextPageToken"))
...
newListMessagesResponse 
    ::  ListMessagesResponse
newListMessagesResponse
  = ListMessagesResponse{messages = Core.Nothing,
                         nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListMessagesResponse"
              (\ o ->
                 ListMessagesResponse Core.<$>
                   (o Core..:? "messages") Core.<*> (o Core..:? "nextPageToken"))
...
newListReactionsResponse 
    ::  ListReactionsResponse
newListReactionsResponse
  = ListReactionsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListReactionsResponse"
              (\ o ->
                 ListReactionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "reactions"))
...
newListSpacesResponse 
    ::  ListSpacesResponse
newListSpacesResponse
  = ListSpacesResponse{nextPageToken = Core.Nothing,
                       spaces = Core.Nothing}
          ...
          = Core.withObject "ListSpacesResponse"
              (\ o ->
                 ListSpacesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "spaces"))
...
newMembership 
    ::  Membership
newMembership
  = Membership{createTime = Core.Nothing, deleteTime = Core.Nothing,
               groupMember = Core.Nothing, member = Core.Nothing,
               name = Core.Nothing, role' = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON Membership where
        parseJSON
          = Core.withObject "Membership"
              (\ o ->
                 Membership Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "deleteTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("member" Core..=) Core.<$> member, ("name" Core..=) Core.<$> name,
                  ("role" Core..=) Core.<$> role', ("state" Core..=) Core.<$> state])
...
instance Core.FromJSON MembershipBatchCreatedEventData where
        parseJSON
...
instance Core.ToJSON MembershipBatchCreatedEventData where
        toJSON MembershipBatchCreatedEventData{..}
          = Core.object
              (Core.catMaybes [("memberships" Core..=) Core.<$> memberships])
...
instance Core.FromJSON MembershipBatchDeletedEventData where
        parseJSON
...
instance Core.ToJSON MembershipBatchDeletedEventData where
...
instance Core.FromJSON MembershipBatchUpdatedEventData where
        parseJSON
...
instance Core.ToJSON MembershipBatchUpdatedEventData where
...
newMembershipCount 
    ::  MembershipCount
newMembershipCount
  = MembershipCount{joinedDirectHumanUserCount = Core.Nothing,
                    joinedGroupCount = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("joinedDirectHumanUserCount" Core..=) Core.<$>
                  ...
                  ("joinedGroupCount" Core..=) Core.<$> joinedGroupCount])
...
instance Core.FromJSON MembershipCreatedEventData where
        parseJSON
          = Core.withObject "MembershipCreatedEventData"
              (\ o ->
                 MembershipCreatedEventData Core.<$> (o Core..:? "membership"))

instance Core.ToJSON MembershipCreatedEventData where
        toJSON MembershipCreatedEventData{..}
          = Core.object
              (Core.catMaybes [("membership" Core..=) Core.<$> membership])
...
instance Core.FromJSON MembershipDeletedEventData where
        parseJSON
          = Core.withObject "MembershipDeletedEventData"
              (\ o ->
                 MembershipDeletedEventData Core.<$> (o Core..:? "membership"))
...
instance Core.FromJSON MembershipUpdatedEventData where
        parseJSON
          = Core.withObject "MembershipUpdatedEventData"
              (\ o ->
                 MembershipUpdatedEventData Core.<$> (o Core..:? "membership"))
...
newMessage 
    ::  Message
newMessage
  = Message{accessoryWidgets = Core.Nothing,
            actionResponse = Core.Nothing, annotations = Core.Nothing,
            argumentText = Core.Nothing, attachedGifs = Core.Nothing,
            attachment = Core.Nothing, cards = Core.Nothing,
            cardsV2 = Core.Nothing, clientAssignedMessageId = Core.Nothing,
            createTime = Core.Nothing, deleteTime = Core.Nothing,
            deletionMetadata = Core.Nothing,
            emojiReactionSummaries = Core.Nothing, fallbackText = Core.Nothing,
            formattedText = Core.Nothing, lastUpdateTime = Core.Nothing,
            matchedUrl = Core.Nothing, name = Core.Nothing,
            privateMessageViewer = Core.Nothing,
            quotedMessageMetadata = Core.Nothing, sender = Core.Nothing,
            slashCommand = Core.Nothing, space = Core.Nothing,
            text = Core.Nothing, thread = Core.Nothing,
...
instance Core.ToJSON Message where
        toJSON Message{..}
          = Core.object
              (Core.catMaybes
                 [("accessoryWidgets" Core..=) Core.<$> accessoryWidgets,
                  ...
                  ("createTime" Core..=) Core.<$> createTime,
                  ("deleteTime" Core..=) Core.<$> deleteTime,
                  ("deletionMetadata" Core..=) Core.<$> deletionMetadata,
                  ("emojiReactionSummaries" Core..=) Core.<$> emojiReactionSummaries,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("privateMessageViewer" Core..=) Core.<$> privateMessageViewer,
                  ("quotedMessageMetadata" Core..=) Core.<$> quotedMessageMetadata,
                  ("sender" Core..=) Core.<$> sender,
                  ("slashCommand" Core..=) Core.<$> slashCommand,
                  ("space" Core..=) Core.<$> space, ("text" Core..=) Core.<$> text,
                  ("thread" Core..=) Core.<$> thread,
...
instance Core.FromJSON MessageBatchCreatedEventData where
        parseJSON
          = Core.withObject "MessageBatchCreatedEventData"
              (\ o ->
                 MessageBatchCreatedEventData Core.<$> (o Core..:? "messages"))

instance Core.ToJSON MessageBatchCreatedEventData where
...
instance Core.FromJSON MessageBatchDeletedEventData where
        parseJSON
          = Core.withObject "MessageBatchDeletedEventData"
              (\ o ->
                 MessageBatchDeletedEventData Core.<$> (o Core..:? "messages"))

instance Core.ToJSON MessageBatchDeletedEventData where
...
instance Core.FromJSON MessageBatchUpdatedEventData where
        parseJSON
          = Core.withObject "MessageBatchUpdatedEventData"
              (\ o ->
                 MessageBatchUpdatedEventData Core.<$> (o Core..:? "messages"))

instance Core.ToJSON MessageBatchUpdatedEventData where
...
newOnClick 
    ::  OnClick
newOnClick
  = OnClick{action = Core.Nothing, openLink = Core.Nothing}
instance Core.FromJSON OnClick where
        parseJSON
          = Core.withObject "OnClick"
              (\ o ->
                 OnClick Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "openLink"))
...
newPermissionSetting 
    ::  PermissionSetting
newPermissionSetting
  = PermissionSetting{managersAllowed = Core.Nothing,
                      membersAllowed = Core.Nothing}
...
instance Core.ToJSON PermissionSetting where
        toJSON PermissionSetting{..}
          = Core.object
              (Core.catMaybes
                 [("managersAllowed" Core..=) Core.<$> managersAllowed,
...
newPermissionSettings 
    ::  PermissionSettings
newPermissionSettings
  = PermissionSettings{manageApps = Core.Nothing,
                       manageMembersAndGroups = Core.Nothing,
                       manageWebhooks = Core.Nothing, modifySpaceDetails = Core.Nothing,
                       postMessages = Core.Nothing, replyMessages = Core.Nothing,
                       toggleHistory = Core.Nothing, useAtMentionAll = Core.Nothing}
...
newQuotedMessageMetadata 
    ::  QuotedMessageMetadata
newQuotedMessageMetadata
  = QuotedMessageMetadata{lastUpdateTime = Core.Nothing,
                          name = Core.Nothing}
          ...
          = Core.withObject "QuotedMessageMetadata"
              (\ o ->
                 QuotedMessageMetadata Core.<$>
                   (o Core..:? "lastUpdateTime") Core.<*> (o Core..:? "name"))
...
newReaction 
    ::  Reaction
newReaction
  = Reaction{emoji = Core.Nothing, name = Core.Nothing,
             user = Core.Nothing}
instance Core.FromJSON Reaction where
        parseJSON
          = Core.withObject "Reaction"
              (\ o ->
                 Reaction Core.<$>
                   (o Core..:? "emoji") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "user"))
...
instance Core.ToJSON Reaction where
        toJSON Reaction{..}
          = Core.object
              (Core.catMaybes
                 [("emoji" Core..=) Core.<$> emoji, ("name" Core..=) Core.<$> name,
                  ("user" Core..=) Core.<$> user])
...
instance Core.FromJSON ReactionBatchCreatedEventData where
        parseJSON
          = Core.withObject "ReactionBatchCreatedEventData"
              (\ o ->
                 ReactionBatchCreatedEventData Core.<$> (o Core..:? "reactions"))

instance Core.ToJSON ReactionBatchCreatedEventData where
        toJSON ReactionBatchCreatedEventData{..}
          = Core.object
              (Core.catMaybes [("reactions" Core..=) Core.<$> reactions])
...
instance Core.FromJSON ReactionBatchDeletedEventData where
        parseJSON
          = Core.withObject "ReactionBatchDeletedEventData"
              (\ o ->
                 ReactionBatchDeletedEventData Core.<$> (o Core..:? "reactions"))

instance Core.ToJSON ReactionBatchDeletedEventData where
...
newReactionDeletedEventData 
    ::  ReactionDeletedEventData
newReactionDeletedEventData
  = ReactionDeletedEventData{reaction = Core.Nothing}
instance Core.FromJSON ReactionDeletedEventData where
        parseJSON
          = Core.withObject "ReactionDeletedEventData"
              (\ o -> ReactionDeletedEventData Core.<$> (o Core..:? "reaction"))
...
newRichLinkMetadata 
    ::  RichLinkMetadata
newRichLinkMetadata
  = RichLinkMetadata{chatSpaceLinkData = Core.Nothing,
                     driveLinkData = Core.Nothing, richLinkType = Core.Nothing,
                     uri = Core.Nothing}
...
instance Core.ToJSON RichLinkMetadata where
        toJSON RichLinkMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("chatSpaceLinkData" Core..=) Core.<$> chatSpaceLinkData,
...
newSearchSpacesResponse 
    ::  SearchSpacesResponse
newSearchSpacesResponse
  = SearchSpacesResponse{nextPageToken = Core.Nothing,
                         spaces = Core.Nothing, totalSize = Core.Nothing}
...
instance Core.FromJSON Section where
        parseJSON
          = Core.withObject "Section"
              (\ o ->
                 Section Core.<$>
                   (o Core..:? "header") Core.<*> (o Core..:? "widgets"))
...
newSetUpSpaceRequest 
    ::  SetUpSpaceRequest
newSetUpSpaceRequest
  = SetUpSpaceRequest{memberships = Core.Nothing,
                      requestId = Core.Nothing, space = Core.Nothing}
instance Core.FromJSON SetUpSpaceRequest where
        parseJSON
          = Core.withObject "SetUpSpaceRequest"
              (\ o ->
                 SetUpSpaceRequest Core.<$>
                   (o Core..:? "memberships") Core.<*> (o Core..:? "requestId")
                     Core.<*> (o Core..:? "space"))
...
-- | Metadata about a <https://developers.google.com/workspace/chat/commands slash command> in Google Chat.
--
...
newSlashCommandMetadata 
    ::  SlashCommandMetadata
newSlashCommandMetadata
  = SlashCommandMetadata{bot = Core.Nothing,
                         commandId = Core.Nothing, commandName = Core.Nothing,
                         triggersDialog = Core.Nothing, type' = Core.Nothing}
...
newSpace 
    ::  Space
newSpace
  = Space{accessSettings = Core.Nothing,
          adminInstalled = Core.Nothing, createTime = Core.Nothing,
          displayName = Core.Nothing, externalUserAllowed = Core.Nothing,
          importMode = Core.Nothing, importModeExpireTime = Core.Nothing,
          lastActiveTime = Core.Nothing, membershipCount = Core.Nothing,
          name = Core.Nothing, permissionSettings = Core.Nothing,
          predefinedPermissionSettings = Core.Nothing,
          singleUserBotDm = Core.Nothing, spaceDetails = Core.Nothing,
          spaceHistoryState = Core.Nothing,
          spaceThreadingState = Core.Nothing, spaceType = Core.Nothing,
          spaceUri = Core.Nothing, threaded = Core.Nothing,
          type' = Core.Nothing}
...
instance Core.FromJSON SpaceBatchUpdatedEventData where
        parseJSON
          = Core.withObject "SpaceBatchUpdatedEventData"
              (\ o -> SpaceBatchUpdatedEventData Core.<$> (o Core..:? "spaces"))

instance Core.ToJSON SpaceBatchUpdatedEventData where
        toJSON SpaceBatchUpdatedEventData{..}
          = Core.object (Core.catMaybes [("spaces" Core..=) Core.<$> spaces])
...
newSpaceDataSource 
    ::  SpaceDataSource
newSpaceDataSource
  = SpaceDataSource{defaultToCurrentSpace = Core.Nothing}
instance Core.FromJSON SpaceDataSource where
        parseJSON
          = Core.withObject "SpaceDataSource"
              (\ o ->
                 SpaceDataSource Core.<$> (o Core..:? "defaultToCurrentSpace"))

instance Core.ToJSON SpaceDataSource where
        toJSON SpaceDataSource{..}
          = Core.object
              (Core.catMaybes
                 [("defaultToCurrentSpace" Core..=) Core.<$> defaultToCurrentSpace])
...
newSpaceDetails 
    ::  SpaceDetails
newSpaceDetails
  = SpaceDetails{description = Core.Nothing,
...
instance Core.FromJSON SpaceDetails where
        parseJSON
          = Core.withObject "SpaceDetails"
              (\ o ->
                 SpaceDetails Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "guidelines"))
...
newSpaceEvent 
    ::  SpaceEvent
newSpaceEvent
  = SpaceEvent{eventTime = Core.Nothing, eventType = Core.Nothing,
               ...
               messageUpdatedEventData = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON SpaceEvent where
        parseJSON
          = Core.withObject "SpaceEvent"
              (\ o ->
                 SpaceEvent Core.<$>
                   (o Core..:? "eventTime") Core.<*> (o Core..:? "eventType") Core.<*>
                     (o Core..:? "membershipBatchCreatedEventData")
                     Core.<*> (o Core..:? "membershipBatchDeletedEventData")
                     Core.<*> (o Core..:? "membershipBatchUpdatedEventData")
              ...
              (Core.catMaybes
                 [("eventTime" Core..=) Core.<$> eventTime,
                  ...
                  ("spaceBatchUpdatedEventData" Core..=) Core.<$>
                    spaceBatchUpdatedEventData,
                  ("spaceUpdatedEventData" Core..=) Core.<$> spaceUpdatedEventData])


-- | The notification setting of a user in a space.
--
-- /See:/ 'newSpaceNotificationSetting' smart constructor.
data SpaceNotificationSetting = SpaceNotificationSetting
    {
      -- | The space notification mute setting.
      muteSetting :: (Core.Maybe SpaceNotificationSetting_MuteSetting)
    ...
    , notificationSetting :: (Core.Maybe SpaceNotificationSetting_NotificationSetting)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SpaceNotificationSetting' with the minimum fields required to make a request.
newSpaceNotificationSetting 
    ::  SpaceNotificationSetting
newSpaceNotificationSetting
  = SpaceNotificationSetting{muteSetting = Core.Nothing,
                             name = Core.Nothing, notificationSetting = Core.Nothing}
instance Core.FromJSON SpaceNotificationSetting where
        parseJSON
          = Core.withObject "SpaceNotificationSetting"
              (\ o ->
                 SpaceNotificationSetting Core.<$>
                   (o Core..:? "muteSetting") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "notificationSetting"))

instance Core.ToJSON SpaceNotificationSetting where
        toJSON SpaceNotificationSetting{..}
          = Core.object
              (Core.catMaybes
                 [("muteSetting" Core..=) Core.<$> muteSetting,
                  ("name" Core..=) Core.<$> name,
                  ("notificationSetting" Core..=) Core.<$> notificationSetting])
...
instance Core.FromJSON SpaceReadState where
        parseJSON
          = Core.withObject "SpaceReadState"
              (\ o ->
                 SpaceReadState Core.<$>
                   (o Core..:? "lastReadTime") Core.<*> (o Core..:? "name"))
...
newTextButton 
    ::  TextButton
newTextButton
  = TextButton{onClick = Core.Nothing, text = Core.Nothing}
...
instance Core.FromJSON Thread where
        parseJSON
          = Core.withObject "Thread"
              (\ o ->
                 Thread Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "threadKey"))
...
newTimeInput 
    ::  TimeInput
newTimeInput
  = TimeInput{hours = Core.Nothing, minutes = Core.Nothing}
...
instance Core.FromJSON TimeZone where
        parseJSON
          = Core.withObject "TimeZone"
              (\ o ->
                 TimeZone Core.<$> (o Core..:? "id") Core.<*> (o Core..:? "offset"))

instance Core.ToJSON TimeZone where
        toJSON TimeZone{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("offset" Core..=) Core.<$> offset])
...
instance Core.FromJSON UpdatedWidget where
        parseJSON
          = Core.withObject "UpdatedWidget"
              (\ o ->
                 UpdatedWidget Core.<$>
                   (o Core..:? "suggestions") Core.<*> (o Core..:? "widget"))
...
newUploadAttachmentRequest 
    ::  UploadAttachmentRequest
newUploadAttachmentRequest
  = UploadAttachmentRequest{filename = Core.Nothing}
instance Core.FromJSON UploadAttachmentRequest where
        parseJSON
          = Core.withObject "UploadAttachmentRequest"
              (\ o -> UploadAttachmentRequest Core.<$> (o Core..:? "filename"))
...
instance Core.FromJSON UploadAttachmentResponse where
        parseJSON
          = Core.withObject "UploadAttachmentResponse"
              (\ o ->
                 UploadAttachmentResponse Core.<$> (o Core..:? "attachmentDataRef"))
...
newUser 
    ::  User
newUser
  = User{displayName = Core.Nothing, domainId = Core.Nothing,
         isAnonymous = Core.Nothing, name = Core.Nothing,
         type' = Core.Nothing}
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User"
              (\ o ->
                 User Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "domainId")
...
instance Core.ToJSON UserMentionMetadata where
        toJSON UserMentionMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("type" Core..=) Core.<$> type', ("user" Core..=) Core.<$> user])
...
newWidgetMarkup 
    ::  WidgetMarkup
newWidgetMarkup
  = WidgetMarkup{buttons = Core.Nothing, image = Core.Nothing,
                 keyValue = Core.Nothing, textParagraph = Core.Nothing}
instance Core.FromJSON WidgetMarkup where
        parseJSON
          = Core.withObject "WidgetMarkup"
              (\ o ->
                 WidgetMarkup Core.<$>
                   (o Core..:? "buttons") Core.<*> (o Core..:? "image") Core.<*>
                     (o Core..:? "keyValue")
                     Core.<*> (o Core..:? "textParagraph"))
