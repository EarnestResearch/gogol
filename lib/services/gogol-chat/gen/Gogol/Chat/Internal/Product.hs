...
data AttachmentDataRef = AttachmentDataRef
    {
      -- | Opaque token containing a reference to an uploaded attachment. Treated by clients as an opaque string and used to create or update Chat messages with attachments. <https://developers.google.com/workspace/preview Developer Preview>.
...
-- | Represents a custom emoji. <https://developers.google.com/workspace/preview Developer Preview>.
--
...
-- | Information about a deleted message. A message is deleted when @delete_time@ is set. <https://developers.google.com/workspace/preview Developer Preview>.
--
...
-- | An emoji that is used as a reaction to a message. <https://developers.google.com/workspace/preview Developer Preview>.
--
...
-- | The number of people who reacted to a message with a specific emoji. <https://developers.google.com/workspace/preview Developer Preview>.
--
...
data GoogleAppsCardV1Action = GoogleAppsCardV1Action
    {
      ...
      -- | Optional. Required when opening a <https://developers.google.com/chat/how-tos/dialogs dialog>. What to do in response to an interaction with a user, such as a user clicking a button in a card message. If unspecified, the app responds by executing an @action@—like opening a link or running a function—as normal. By specifying an @interaction@, the app can respond in special interactive ways. For example, by setting @interaction@ to @OPEN_DIALOG@, the app can open a <https://developers.google.com/chat/how-tos/dialogs dialog>. When specified, a loading indicator isn\'t shown. Supported by Chat apps, but not Google Workspace Add-ons. If specified for an add-on, the entire card is stripped and nothing is shown in the client.
...
-- | List of string parameters to supply when the action method is invoked. For example, consider three snooze buttons: snooze now, snooze one day, or snooze next week. You might use @action method = snooze()@, passing the snooze type and snooze time in the list of string parameters. To learn more, see <https://developers.google.com/chat/api/reference/rest/v1/Event#commoneventobject CommonEventObject>.
--
...
-- | Cards support a defined layout, interactive UI elements like buttons, and rich media like images. Use cards to present detailed information, gather information from users, and guide users to take a next step. In Google Chat, cards appear in several places: - As stand-alone messages. - Accompanying a text message, just beneath the text message. - As a <https://developers.google.com/chat/how-tos/dialogs dialog>. The following example JSON creates a \"contact card\" that features: - A header with the contact\'s name, job title, and avatar picture. - A section with the contact information, including formatted text. - Buttons that users can click to share the contact, or see more or less information. <<https://developers.google.com/chat/images/card_api_reference.png Example contact card>>
...
data GoogleAppsCardV1CardFixedFooter = GoogleAppsCardV1CardFixedFooter
    ...
    , secondaryButton :: (Core.Maybe GoogleAppsCardV1Button)
      -- | A list of widgets included in the card footer. Primary button and secondary button are rendered below these widgets.
    , widgets :: (Core.Maybe [GoogleAppsCardV1FooterWidget])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
data GoogleAppsCardV1DateTimePicker = GoogleAppsCardV1DateTimePicker
    {
      ...
      -- | The name by which the @DateTimePicker@ is identified in a form input event. For details about working with form inputs, see <https://developers.google.com/chat/how-tos/dialogs#receive_form_data_from_dialogs Receive form data>.
    , name :: (Core.Maybe Core.Text)
...
data GoogleAppsCardV1DecoratedText = GoogleAppsCardV1DecoratedText
    ...
    , switchControl :: (Core.Maybe GoogleAppsCardV1SwitchControl)
      -- | Required. The primary text. Supports simple formatting. For more information about formatting text, see <https://developers.google.com/chat/api/guides/message-formats/cards#card_text_formatting Formatting text in Google Chat apps> and <https://developers.google.com/apps-script/add-ons/concepts/widgets#text_formatting Formatting text in Google Workspace Add-ons>.
    , text :: (Core.Maybe Core.Text)
...
--
-- /See:/ 'newGoogleAppsCardV1FooterWidget' smart constructor.
data GoogleAppsCardV1FooterWidget = GoogleAppsCardV1FooterWidget
    {
      -- | ButtonList widget.
...
-- | Creates a value of 'GoogleAppsCardV1FooterWidget' with the minimum fields required to make a request.
newGoogleAppsCardV1FooterWidget 
    ::  GoogleAppsCardV1FooterWidget
newGoogleAppsCardV1FooterWidget =
  GoogleAppsCardV1FooterWidget
...
instance Core.FromJSON GoogleAppsCardV1FooterWidget
         where
        parseJSON
          = Core.withObject "GoogleAppsCardV1FooterWidget"
              (\ o ->
                 GoogleAppsCardV1FooterWidget Core.<$>
...
instance Core.ToJSON GoogleAppsCardV1FooterWidget
         where
        toJSON GoogleAppsCardV1FooterWidget{..}
          = Core.object
              (Core.catMaybes
...
data GoogleAppsCardV1Section = GoogleAppsCardV1Section
    {
      ...
      -- | Text that appears at the top of a section. Supports simple HTML formatted text. For more information about formatting text, see <https://developers.google.com/chat/api/guides/message-formats/cards#card_text_formatting Formatting text in Google Chat apps> and <https://developers.google.com/apps-script/add-ons/concepts/widgets#text_formatting Formatting text in Google Workspace Add-ons>.
...
-- | A widget that creates one or more UI items that users can select. For example, a dropdown menu or checkboxes. You can use this widget to collect data that can be predicted or enumerated. Chat apps can process the value of items that users select or input. For details about working with form inputs, see <https://developers.google.com/chat/how-tos/dialogs#receive_form_data_from_dialogs Receive form data>. To collect undefined or abstract data from users, use the TextInput widget.
--
...
data GoogleAppsCardV1SelectionInput = GoogleAppsCardV1SelectionInput
    ...
    , label :: (Core.Maybe Core.Text)
      -- | The name that identifies the selection input in a form input event. For details about working with form inputs, see <https://developers.google.com/chat/how-tos/dialogs#receive_form_data_from_dialogs Receive form data>.
    , name :: (Core.Maybe Core.Text)
          ...
          = Core.withObject "GoogleAppsCardV1SelectionInput"
              (\ o ->
                 GoogleAppsCardV1SelectionInput Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "label")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "onChangeAction")
                     Core.<*> (o Core..:? "type"))
...
data GoogleAppsCardV1TextInput = GoogleAppsCardV1TextInput
    ...
    , name :: (Core.Maybe Core.Text)
      -- | What to do when a change occurs in the text input field. For example, a user adding to the field or deleting text. Examples of actions to take include running a custom function or opening a <https://developers.google.com/chat/how-tos/dialogs dialog> in Google Chat.
    , onChangeAction :: (Core.Maybe GoogleAppsCardV1Action)
...
-- | A paragraph of text that supports formatting. For more information about formatting text, see <https://developers.google.com/chat/api/guides/message-formats/cards#card_text_formatting Formatting text in Google Chat apps> and <https://developers.google.com/apps-script/add-ons/concepts/widgets#text_formatting Formatting text in Google Workspace Add-ons>.
--
...
data GoogleAppsCardV1Widget = GoogleAppsCardV1Widget
    ...
    , textInput :: (Core.Maybe GoogleAppsCardV1TextInput)
      -- | Displays a text paragraph. Supports simple HTML formatted text. For more information about formatting text, see <https://developers.google.com/chat/api/guides/message-formats/cards#card_text_formatting Formatting text in Google Chat apps> and <https://developers.google.com/apps-script/add-ons/concepts/widgets#text_formatting Formatting text in Google Workspace Add-ons>. For example, the following JSON creates a bolded text: @\"textParagraph\": { \"text\": \" *bold text*\" }@
    , textParagraph :: (Core.Maybe GoogleAppsCardV1TextParagraph)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
data KeyValue = KeyValue
    {
      -- | The text of the bottom label. Formatted text supported. For more information about formatting text, see <https://developers.google.com/chat/api/guides/message-formats/cards#card_text_formatting Formatting text in Google Chat apps> and <https://developers.google.com/apps-script/add-ons/concepts/widgets#text_formatting Formatting text in Google Workspace Add-ons>.
      bottomLabel :: (Core.Maybe Core.Text)
      -- | A button that can be clicked to trigger an action.
    , button :: (Core.Maybe Button)
      -- | The text of the content. Formatted text supported and always required. For more information about formatting text, see <https://developers.google.com/chat/api/guides/message-formats/cards#card_text_formatting Formatting text in Google Chat apps> and <https://developers.google.com/apps-script/add-ons/concepts/widgets#text_formatting Formatting text in Google Workspace Add-ons>.
    ...
    , onClick :: (Core.Maybe OnClick)
      -- | The text of the top label. Formatted text supported. For more information about formatting text, see <https://developers.google.com/chat/api/guides/message-formats/cards#card_text_formatting Formatting text in Google Chat apps> and <https://developers.google.com/apps-script/add-ons/concepts/widgets#text_formatting Formatting text in Google Workspace Add-ons>.
    , topLabel :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
data Membership = Membership
    {
      ...
      -- | The Google Chat user or app the membership corresponds to. If your Chat app <https://developers.google.com/chat/api/guides/auth/users authenticates as a user>, the output populates the <https://developers.google.com/chat/api/reference/rest/v1/User user> @name@ and @type@.
...
data Message = Message
    ...
    , createTime :: (Core.Maybe Core.DateTime)
      -- | Output only. The time at which the message was deleted in Google Chat server. If the message is never deleted, this field is empty. <https://developers.google.com/workspace/preview Developer Preview>.
    , deleteTime :: (Core.Maybe Core.DateTime)
      -- | Output only. Information about a deleted message. A message is deleted when @delete_time@ is set. <https://developers.google.com/workspace/preview Developer Preview>.
    , deletionMetadata :: (Core.Maybe DeletionMetadata)
      -- | Output only. The list of emoji reaction summaries on the message. <https://developers.google.com/workspace/preview Developer Preview>.
    ...
    , lastUpdateTime :: (Core.Maybe Core.DateTime)
      -- | Output only. A URL in @spaces.messages.text@ that matches a link preview pattern. For more information, see <https://developers.google.com/chat/how-tos/preview-links Preview links>.
...
-- | A reaction to a message. <https://developers.google.com/workspace/preview Developer Preview>.
--
...
data Section = Section
    {
      -- | The header of the section. Formatted text is supported. For more information about formatting text, see <https://developers.google.com/chat/api/guides/message-formats/cards#card_text_formatting Formatting text in Google Chat apps> and <https://developers.google.com/apps-script/add-ons/concepts/widgets#text_formatting Formatting text in Google Workspace Add-ons>.
      header :: (Core.Maybe Core.Text)
...
data Space = Space
    {
      ...
      -- | The space\'s display name. Required when <https://developers.google.com/chat/api/reference/rest/v1/spaces/create creating a space>. For direct messages, this field might be empty. Supports up to 128 characters.
    ...
    , spaceDetails :: (Core.Maybe SpaceDetails)
      -- | The message history state for messages and threads in this space. <https://developers.google.com/workspace/preview Developer Preview>.
    , spaceHistoryState :: (Core.Maybe Space_SpaceHistoryState)
      -- | Output only. The threading state in the Chat space.
    , spaceThreadingState :: (Core.Maybe Space_SpaceThreadingState)
      -- | The type of space. Required when creating or updating a space. Output only for other usage. <https://developers.google.com/workspace/preview Developer Preview>.
...
-- | A paragraph of text. Formatted text supported. For more information about formatting text, see <https://developers.google.com/chat/api/guides/message-formats/cards#card_text_formatting Formatting text in Google Chat apps> and <https://developers.google.com/apps-script/add-ons/concepts/widgets#text_formatting Formatting text in Google Workspace Add-ons>.
--
