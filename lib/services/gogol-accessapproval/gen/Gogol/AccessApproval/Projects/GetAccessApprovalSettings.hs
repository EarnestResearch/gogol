...
newAccessApprovalProjectsGetAccessApprovalSettings name
  = AccessApprovalProjectsGetAccessApprovalSettings{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalProjectsGetAccessApprovalSettings
         where
        type Rs AccessApprovalProjectsGetAccessApprovalSettings =
             AccessApprovalSettings
        type Scopes AccessApprovalProjectsGetAccessApprovalSettings =
