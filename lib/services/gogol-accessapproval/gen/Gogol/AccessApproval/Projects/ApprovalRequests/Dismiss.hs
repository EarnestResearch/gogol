...
newAccessApprovalProjectsApprovalRequestsDismiss name payload
  = AccessApprovalProjectsApprovalRequestsDismiss{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs AccessApprovalProjectsApprovalRequestsDismiss =
             ApprovalRequest
        type Scopes AccessApprovalProjectsApprovalRequestsDismiss =
             '[CloudPlatform'FullControl]
        requestClient AccessApprovalProjectsApprovalRequestsDismiss{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessApprovalProjectsApprovalRequestsDismissResource)
                      Core.mempty
