...
newAccessApprovalProjectsApprovalRequestsInvalidate name payload
  = AccessApprovalProjectsApprovalRequestsInvalidate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalProjectsApprovalRequestsInvalidate
         where
        type Rs AccessApprovalProjectsApprovalRequestsInvalidate =
             ApprovalRequest
        type Scopes AccessApprovalProjectsApprovalRequestsInvalidate =
             '[CloudPlatform'FullControl]
        requestClient AccessApprovalProjectsApprovalRequestsInvalidate{..}
