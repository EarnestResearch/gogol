...
newAccessApprovalServiceAccount =
  AccessApprovalServiceAccount
    {accountEmail = Core.Nothing, name = Core.Nothing}

instance Core.FromJSON AccessApprovalServiceAccount
         where
        parseJSON
...
instance Core.ToJSON AccessApprovalServiceAccount
         where
              ...
              (\ o ->
                 AccessApprovalSettings Core.<$>
                   (o Core..:? "activeKeyVersion") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "preferredRequestExpirationDays"))

instance Core.ToJSON AccessApprovalSettings where
        toJSON AccessApprovalSettings{..}
          = Core.object
              (Core.catMaybes
                 [("activeKeyVersion" Core..=) Core.<$>
                    activeKeyVersion,
                  ("ancestorHasActiveKeyVersion" Core..=) Core.<$>
                    ancestorHasActiveKeyVersion,
                  ("enrolledAncestor" Core..=) Core.<$>
                    enrolledAncestor,
                  ("enrolledServices" Core..=) Core.<$>
                    enrolledServices,
                  ("invalidKeyVersion" Core..=) Core.<$>
                    invalidKeyVersion,
                  ("name" Core..=) Core.<$> name,
                  ("notificationEmails" Core..=) Core.<$>
                    notificationEmails,
          ...
          = Core.object
              (Core.catMaybes
                 [("approve" Core..=) Core.<$> approve,
                  ...
                  ("requestedExpiration" Core..=) Core.<$>
                    requestedExpiration,
                  ("requestedLocations" Core..=) Core.<$>
                    requestedLocations,
                  ("requestedReason" Core..=) Core.<$> requestedReason,
                  ("requestedResourceName" Core..=) Core.<$>
...
instance Core.FromJSON ApproveApprovalRequestMessage
         where
        parseJSON
          = Core.withObject "ApproveApprovalRequestMessage"
              (\ o ->
                 ApproveApprovalRequestMessage Core.<$>
                   (o Core..:? "expireTime"))

instance Core.ToJSON ApproveApprovalRequestMessage
         where
...
instance Core.FromJSON DismissApprovalRequestMessage
         where
        parseJSON
          = Core.withObject "DismissApprovalRequestMessage"
              (\ o -> Core.pure DismissApprovalRequestMessage)

instance Core.ToJSON DismissApprovalRequestMessage
         where
...
instance Core.ToJSON InvalidateApprovalRequestMessage
         where
        toJSON = Core.const Core.emptyObject
...
newListApprovalRequestsResponse =
  ListApprovalRequestsResponse
    {approvalRequests = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListApprovalRequestsResponse
         where
        parseJSON
...
instance Core.ToJSON ListApprovalRequestsResponse
         where
        toJSON ListApprovalRequestsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("approvalRequests" Core..=) Core.<$>
                    approvalRequests,
...
instance Core.ToJSON SignatureInfo where
        toJSON SignatureInfo{..}
          = Core.object
              (Core.catMaybes
                 [("customerKmsKeyVersion" Core..=) Core.<$>
                    customerKmsKeyVersion,
                  ("googlePublicKeyPem" Core..=) Core.<$>
                    googlePublicKeyPem,
