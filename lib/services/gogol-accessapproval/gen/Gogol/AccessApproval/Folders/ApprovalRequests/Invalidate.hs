...
newAccessApprovalFoldersApprovalRequestsInvalidate name payload
  = AccessApprovalFoldersApprovalRequestsInvalidate{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalFoldersApprovalRequestsInvalidate
         where
        type Rs AccessApprovalFoldersApprovalRequestsInvalidate =
             ApprovalRequest
        type Scopes AccessApprovalFoldersApprovalRequestsInvalidate =
