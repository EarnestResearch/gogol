...
newAccessApprovalFoldersGetAccessApprovalSettings name
  = AccessApprovalFoldersGetAccessApprovalSettings{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalFoldersGetAccessApprovalSettings
         where
        type Rs AccessApprovalFoldersGetAccessApprovalSettings =
             AccessApprovalSettings
        type Scopes AccessApprovalFoldersGetAccessApprovalSettings =
