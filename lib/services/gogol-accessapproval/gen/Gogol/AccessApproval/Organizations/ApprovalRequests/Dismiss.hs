...
--
-- /See:/ <https://cloud.google.com/assured-workloads/access-approval/docs Access Approval API Reference> for @accessapproval.organizations.approvalRequests.dismiss@.
module Gogol.AccessApproval.Organizations.ApprovalRequests.Dismiss
    (
    -- * Resource
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DismissApprovalRequestMessage Core.:>
                       Core.Post '[Core.JSON] ApprovalRequest
...
newAccessApprovalOrganizationsApprovalRequestsDismiss name payload
  = AccessApprovalOrganizationsApprovalRequestsDismiss{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalOrganizationsApprovalRequestsDismiss
         where
        type Rs AccessApprovalOrganizationsApprovalRequestsDismiss =
             ApprovalRequest
        type Scopes AccessApprovalOrganizationsApprovalRequestsDismiss =
