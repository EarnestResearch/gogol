...
type AccessApprovalOrganizationsApprovalRequestsInvalidateResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "invalidate" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] InvalidateApprovalRequestMessage Core.:>
...
newAccessApprovalOrganizationsApprovalRequestsInvalidate 
    ...
    -> AccessApprovalOrganizationsApprovalRequestsInvalidate
newAccessApprovalOrganizationsApprovalRequestsInvalidate name
  payload
  = AccessApprovalOrganizationsApprovalRequestsInvalidate{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalOrganizationsApprovalRequestsInvalidate
         where
        type Rs AccessApprovalOrganizationsApprovalRequestsInvalidate =
             ApprovalRequest
        type Scopes AccessApprovalOrganizationsApprovalRequestsInvalidate =
