...
instance Core.FromJSON Groups where
        parseJSON
          = Core.withObject "Groups"
              (\ o ->
                 Groups Core.<$>
                   (o Core..:? "allowExternalMembers") Core.<*>
                     (o Core..:? "allowGoogleCommunication")
                     ...
                     Core.<*>
                     (o Core..:? "defaultMessageDenyNotificationText")
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "groupsSettings#groups")
                     ...
                     Core.<*>
                     (o Core..:? "whoCanMarkFavoriteReplyOnAnyTopic")
                     Core.<*>
                     (o Core..:? "whoCanMarkFavoriteReplyOnOwnTopic")
                     ...
                     Core.<*>
                     (o Core..:? "whoCanUnmarkFavoriteReplyOnAnyTopic")
...
instance Core.ToJSON Groups where
        toJSON Groups{..}
          = Core.object
              (Core.catMaybes
                 [("allowExternalMembers" Core..=) Core.<$>
                    allowExternalMembers,
                  ("allowGoogleCommunication" Core..=) Core.<$>
                    allowGoogleCommunication,
                  ("allowWebPosting" Core..=) Core.<$> allowWebPosting,
                  ("archiveOnly" Core..=) Core.<$> archiveOnly,
                  ("customFooterText" Core..=) Core.<$>
                    customFooterText,
                  ...
                  ("enableCollaborativeInbox" Core..=) Core.<$>
                    enableCollaborativeInbox,
                  ("favoriteRepliesOnTop" Core..=) Core.<$>
                    favoriteRepliesOnTop,
                  ("includeCustomFooter" Core..=) Core.<$>
                    includeCustomFooter,
                  ...
                  ("membersCanPostAsTheGroup" Core..=) Core.<$>
                    membersCanPostAsTheGroup,
                  ("messageDisplayFont" Core..=) Core.<$>
                    messageDisplayFont,
                  ("messageModerationLevel" Core..=) Core.<$>
                    messageModerationLevel,
                  ("name" Core..=) Core.<$> name,
                  ("primaryLanguage" Core..=) Core.<$> primaryLanguage,
                  ("replyTo" Core..=) Core.<$> replyTo,
                  ("sendMessageDenyNotification" Core..=) Core.<$>
                    sendMessageDenyNotification,
                  ("showInGroupDirectory" Core..=) Core.<$>
                    showInGroupDirectory,
                  ("spamModerationLevel" Core..=) Core.<$>
                    spamModerationLevel,
                  ("whoCanAdd" Core..=) Core.<$> whoCanAdd,
                  ("whoCanAddReferences" Core..=) Core.<$>
                    whoCanAddReferences,
                  ("whoCanApproveMembers" Core..=) Core.<$>
                    whoCanApproveMembers,
                  ("whoCanApproveMessages" Core..=) Core.<$>
                    whoCanApproveMessages,
                  ("whoCanAssignTopics" Core..=) Core.<$>
                    whoCanAssignTopics,
                  ("whoCanAssistContent" Core..=) Core.<$>
                    whoCanAssistContent,
                  ("whoCanBanUsers" Core..=) Core.<$> whoCanBanUsers,
                  ("whoCanContactOwner" Core..=) Core.<$>
                    whoCanContactOwner,
                  ("whoCanDeleteAnyPost" Core..=) Core.<$>
                    whoCanDeleteAnyPost,
                  ("whoCanDeleteTopics" Core..=) Core.<$>
                    whoCanDeleteTopics,
                  ("whoCanDiscoverGroup" Core..=) Core.<$>
                    whoCanDiscoverGroup,
                  ("whoCanEnterFreeFormTags" Core..=) Core.<$>
                    whoCanEnterFreeFormTags,
                  ("whoCanHideAbuse" Core..=) Core.<$> whoCanHideAbuse,
                  ("whoCanInvite" Core..=) Core.<$> whoCanInvite,
                  ("whoCanJoin" Core..=) Core.<$> whoCanJoin,
                  ("whoCanLeaveGroup" Core..=) Core.<$>
                    whoCanLeaveGroup,
                  ("whoCanLockTopics" Core..=) Core.<$>
                    whoCanLockTopics,
                  ("whoCanMakeTopicsSticky" Core..=) Core.<$>
                    whoCanMakeTopicsSticky,
                  ("whoCanMarkDuplicate" Core..=) Core.<$>
                    whoCanMarkDuplicate,
                  ...
                  ("whoCanMarkNoResponseNeeded" Core..=) Core.<$>
                    whoCanMarkNoResponseNeeded,
                  ("whoCanModerateContent" Core..=) Core.<$>
                    whoCanModerateContent,
                  ("whoCanModerateMembers" Core..=) Core.<$>
                    whoCanModerateMembers,
                  ("whoCanModifyMembers" Core..=) Core.<$>
                    whoCanModifyMembers,
                  ("whoCanModifyTagsAndCategories" Core..=) Core.<$>
                    whoCanModifyTagsAndCategories,
                  ("whoCanMoveTopicsIn" Core..=) Core.<$>
                    whoCanMoveTopicsIn,
                  ("whoCanMoveTopicsOut" Core..=) Core.<$>
                    whoCanMoveTopicsOut,
                  ("whoCanPostAnnouncements" Core..=) Core.<$>
                    whoCanPostAnnouncements,
                  ("whoCanPostMessage" Core..=) Core.<$>
                    whoCanPostMessage,
                  ("whoCanTakeTopics" Core..=) Core.<$>
                    whoCanTakeTopics,
                  ("whoCanUnassignTopic" Core..=) Core.<$>
                    whoCanUnassignTopic,
                  ...
                  ("whoCanViewMembership" Core..=) Core.<$>
