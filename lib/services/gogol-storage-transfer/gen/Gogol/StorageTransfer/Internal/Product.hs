...
instance Core.FromJSON AwsAccessKey where
        parseJSON
          = Core.withObject "AwsAccessKey"
              (\ o ->
                 AwsAccessKey Core.<$>
                   (o Core..:? "accessKeyId") Core.<*>
                     (o Core..:? "secretAccessKey"))
...
newAwsS3Data =
  AwsS3Data
    ...
    , bucketName = Core.Nothing
    , credentialsSecret = Core.Nothing
    , path = Core.Nothing
...
instance Core.ToJSON BandwidthLimit where
        toJSON BandwidthLimit{..}
          = Core.object
              (Core.catMaybes
                 [("limitMbps" Core..=) Core.. Core.AsText Core.<$>
                    limitMbps])
          ...
          = Core.object
              (Core.catMaybes
                 [("eventStreamExpirationTime" Core..=) Core.<$>
                  ...
                  ("eventStreamStartTime" Core..=) Core.<$>
...
newListAgentPoolsResponse =
  ListAgentPoolsResponse
    {agentPools = Core.Nothing, nextPageToken = Core.Nothing}
...
newListTransferJobsResponse =
  ListTransferJobsResponse
    {nextPageToken = Core.Nothing, transferJobs = Core.Nothing}
          ...
          = Core.withObject "NotificationConfig"
              (\ o ->
                 NotificationConfig Core.<$>
                   (o Core..:? "eventTypes") Core.<*>
                     (o Core..:? "payloadFormat")
              ...
              (\ o ->
                 ObjectConditions Core.<$>
                   (o Core..:? "excludePrefixes") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "maxTimeElapsedSinceLastModification")
                     Core.<*>
                     (o Core..:? "minTimeElapsedSinceLastModification"))

instance Core.ToJSON ObjectConditions where
        toJSON ObjectConditions{..}
          = Core.object
              (Core.catMaybes
                 [("excludePrefixes" Core..=) Core.<$>
                    excludePrefixes,
                  ("includePrefixes" Core..=) Core.<$> includePrefixes,
                  ("lastModifiedBefore" Core..=) Core.<$>
                    lastModifiedBefore,
                  ("lastModifiedSince" Core..=) Core.<$>
                    lastModifiedSince,
...
instance Core.FromJSON PauseTransferOperationRequest
         where
        parseJSON
          = Core.withObject "PauseTransferOperationRequest"
              (\ o -> Core.pure PauseTransferOperationRequest)

instance Core.ToJSON PauseTransferOperationRequest
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON PosixFilesystem where
        parseJSON
          = Core.withObject "PosixFilesystem"
              (\ o ->
                 PosixFilesystem Core.<$>
                   (o Core..:? "rootDirectory"))
...
instance Core.FromJSON ResumeTransferOperationRequest
         where
        parseJSON
          = Core.withObject "ResumeTransferOperationRequest"
              (\ o -> Core.pure ResumeTransferOperationRequest)

instance Core.ToJSON ResumeTransferOperationRequest
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON Schedule where
        parseJSON
          = Core.withObject "Schedule"
              (\ o ->
                 Schedule Core.<$>
                   (o Core..:? "endTimeOfDay") Core.<*>
                     (o Core..:? "repeatInterval")
                 ...
                 TransferCounters Core.<$>
                   (o Core..:? "bytesCopiedToSink" Core.<&>
                     ...
                     (o Core..:? "bytesFromSourceSkippedBySync" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "directoriesFailedToListFromSource"
                        Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "directoriesFoundFromSource" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "directoriesSuccessfullyListedFromSource"
                        Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "intermediateObjectsCleanedUp" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "intermediateObjectsFailedCleanedUp"
                        Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("bytesCopiedToSink" Core..=) Core.. Core.AsText
                  ...
                  ("bytesFailedToDeleteFromSink" Core..=) Core..
                    Core.AsText
          ...
          = Core.object
              (Core.catMaybes
                 [("creationTime" Core..=) Core.<$> creationTime,
                  ...
                  ("lastModificationTime" Core..=) Core.<$>
                    lastModificationTime,
                  ("latestOperationName" Core..=) Core.<$>
                    latestOperationName,
          ...
          = Core.withObject "TransferOptions"
              (\ o ->
                 TransferOptions Core.<$>
                   (o Core..:? "deleteObjectsFromSourceAfterTransfer")
                     Core.<*> (o Core..:? "deleteObjectsUniqueInSink")
                     Core.<*> (o Core..:? "metadataOptions")
                     Core.<*>
                     (o Core..:? "overwriteObjectsAlreadyExistingInSink")
          ...
          = Core.object
              (Core.catMaybes
                 [("awsS3CompatibleDataSource" Core..=) Core.<$>
                  ...
                  ("objectConditions" Core..=) Core.<$>
                    objectConditions,
                  ("posixDataSink" Core..=) Core.<$> posixDataSink,
                  ("posixDataSource" Core..=) Core.<$> posixDataSource,
                  ("sinkAgentPoolName" Core..=) Core.<$>
                    sinkAgentPoolName,
                  ("sourceAgentPoolName" Core..=) Core.<$>
                    sourceAgentPoolName,
                  ("transferManifest" Core..=) Core.<$>
                    transferManifest,
                  ("transferOptions" Core..=) Core.<$>
                    transferOptions])
