...
newAgentPool 
    ::  AgentPool
newAgentPool
  = AgentPool{bandwidthLimit = Core.Nothing,
              displayName = Core.Nothing, name = Core.Nothing,
              state = Core.Nothing}
instance Core.FromJSON AgentPool where
        parseJSON
          = Core.withObject "AgentPool"
              (\ o ->
                 AgentPool Core.<$>
                   (o Core..:? "bandwidthLimit") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "state"))
...
newAwsAccessKey 
    ::  AwsAccessKey
newAwsAccessKey
  = AwsAccessKey{accessKeyId = Core.Nothing,
                 secretAccessKey = Core.Nothing}
instance Core.FromJSON AwsAccessKey where
        parseJSON
          = Core.withObject "AwsAccessKey"
              (\ o ->
                 AwsAccessKey Core.<$>
                   (o Core..:? "accessKeyId") Core.<*> (o Core..:? "secretAccessKey"))
          ...
          = Core.object
              (Core.catMaybes
                 [("accessKeyId" Core..=) Core.<$> accessKeyId,
                  ("secretAccessKey" Core..=) Core.<$> secretAccessKey])
...
newAwsS3CompatibleData 
    ::  AwsS3CompatibleData
newAwsS3CompatibleData
  = AwsS3CompatibleData{bucketName = Core.Nothing,
                        endpoint = Core.Nothing, path = Core.Nothing,
                        region = Core.Nothing, s3Metadata = Core.Nothing}
instance Core.FromJSON AwsS3CompatibleData where
        parseJSON
          = Core.withObject "AwsS3CompatibleData"
              (\ o ->
                 AwsS3CompatibleData Core.<$>
                   (o Core..:? "bucketName") Core.<*> (o Core..:? "endpoint") Core.<*>
                     (o Core..:? "path")
                     Core.<*> (o Core..:? "region")
          ...
          = Core.object
              (Core.catMaybes
                 [("bucketName" Core..=) Core.<$> bucketName,
                  ...
                  ("path" Core..=) Core.<$> path, ("region" Core..=) Core.<$> region,
...
data AwsS3Data = AwsS3Data
    ...
    , bucketName :: (Core.Maybe Core.Text)
      -- | Optional. The CloudFront distribution domain name pointing to this bucket, to use when fetching. See <https://cloud.google.com/storage-transfer/docs/s3-cloudfront Transfer from S3 via CloudFront> for more information. Format: @https:\/\/{id}.cloudfront.net@ or any valid custom domain. Must begin with @https:\/\/@.
    , cloudfrontDomain :: (Core.Maybe Core.Text)
      -- | Optional. The Resource name of a secret in Secret Manager. AWS credentials must be stored in Secret Manager in JSON format: { \"access/key/id\": \"ACCESS/KEY/ID\", \"secret/access/key\": \"SECRET/ACCESS/KEY\" } GoogleServiceAccount must be granted @roles\/secretmanager.secretAccessor@ for the resource. See [Configure access to a source: Amazon S3] (https:\/\/cloud.google.com\/storage-transfer\/docs\/source-amazon-s3#secret/manager) for more information. If @credentials_secret@ is specified, do not specify role/arn or aws/access/key. Format: @projects\/{project_number}\/secrets\/{secret_name}@
    , credentialsSecret :: (Core.Maybe Core.Text)
      -- | Egress bytes over a Google-managed private network. This network is shared between other users of Storage Transfer Service.
    , managedPrivateNetwork :: (Core.Maybe Core.Bool)
...
newAwsS3Data 
    ::  AwsS3Data
newAwsS3Data
  = AwsS3Data{awsAccessKey = Core.Nothing, bucketName = Core.Nothing,
              cloudfrontDomain = Core.Nothing, credentialsSecret = Core.Nothing,
              managedPrivateNetwork = Core.Nothing, path = Core.Nothing,
              roleArn = Core.Nothing}
instance Core.FromJSON AwsS3Data where
        parseJSON
          = Core.withObject "AwsS3Data"
              (\ o ->
                 AwsS3Data Core.<$>
                   (o Core..:? "awsAccessKey") Core.<*> (o Core..:? "bucketName")
                     Core.<*> (o Core..:? "cloudfrontDomain")
                     Core.<*> (o Core..:? "credentialsSecret")
                     Core.<*> (o Core..:? "managedPrivateNetwork")
                     Core.<*> (o Core..:? "path")
                     Core.<*> (o Core..:? "roleArn"))
          ...
          = Core.object
              (Core.catMaybes
                 [("awsAccessKey" Core..=) Core.<$> awsAccessKey,
                  ("bucketName" Core..=) Core.<$> bucketName,
                  ("cloudfrontDomain" Core..=) Core.<$> cloudfrontDomain,
                  ("credentialsSecret" Core..=) Core.<$> credentialsSecret,
                  ("managedPrivateNetwork" Core..=) Core.<$> managedPrivateNetwork,
                  ("path" Core..=) Core.<$> path,
...
data AzureBlobStorageData = AzureBlobStorageData
    ...
    , container :: (Core.Maybe Core.Text)
      -- | Optional. The Resource name of a secret in Secret Manager. The Azure SAS token must be stored in Secret Manager in JSON format: { \"sas/token\" : \"SAS/TOKEN\" } GoogleServiceAccount must be granted @roles\/secretmanager.secretAccessor@ for the resource. See [Configure access to a source: Microsoft Azure Blob Storage] (https:\/\/cloud.google.com\/storage-transfer\/docs\/source-microsoft-azure#secret/manager) for more information. If @credentials_secret@ is specified, do not specify azure/credentials. Format: @projects\/{project_number}\/secrets\/{secret_name}@
    , credentialsSecret :: (Core.Maybe Core.Text)
      -- | Optional. Federated identity config of a user registered Azure application. If @federated_identity_config@ is specified, do not specify azure/credentials or credentials/secret.
    , federatedIdentityConfig :: (Core.Maybe FederatedIdentityConfig)
      -- | Root path to transfer objects. Must be an empty string or full path name that ends with a \'\/\'. This field is treated as an object prefix. As such, it should generally not begin with a \'\/\'.
    , path :: (Core.Maybe Core.Text)
...
newAzureBlobStorageData 
    ::  AzureBlobStorageData
newAzureBlobStorageData
  = AzureBlobStorageData{azureCredentials = Core.Nothing,
                         container = Core.Nothing, credentialsSecret = Core.Nothing,
                         federatedIdentityConfig = Core.Nothing, path = Core.Nothing,
                         storageAccount = Core.Nothing}
instance Core.FromJSON AzureBlobStorageData where
        parseJSON
          = Core.withObject "AzureBlobStorageData"
              (\ o ->
                 AzureBlobStorageData Core.<$>
                   (o Core..:? "azureCredentials") Core.<*> (o Core..:? "container")
                     Core.<*> (o Core..:? "credentialsSecret")
                     Core.<*> (o Core..:? "federatedIdentityConfig")
                     Core.<*> (o Core..:? "path")
...
instance Core.ToJSON AzureBlobStorageData where
        toJSON AzureBlobStorageData{..}
          = Core.object
              (Core.catMaybes
                 [("azureCredentials" Core..=) Core.<$> azureCredentials,
                  ("container" Core..=) Core.<$> container,
                  ("credentialsSecret" Core..=) Core.<$> credentialsSecret,
                  ("federatedIdentityConfig" Core..=) Core.<$>
                    federatedIdentityConfig,
                  ("path" Core..=) Core.<$> path,
...
instance Core.FromJSON AzureCredentials where
        parseJSON
          = Core.withObject "AzureCredentials"
              (\ o -> AzureCredentials Core.<$> (o Core..:? "sasToken"))

instance Core.ToJSON AzureCredentials where
        toJSON AzureCredentials{..}
          = Core.object
              (Core.catMaybes [("sasToken" Core..=) Core.<$> sasToken])
...
instance Core.FromJSON BandwidthLimit where
        parseJSON
          = Core.withObject "BandwidthLimit"
              (\ o ->
                 BandwidthLimit Core.<$>
                   (o Core..:? "limitMbps" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON BandwidthLimit where
        toJSON BandwidthLimit{..}
          = Core.object
              (Core.catMaybes
                 [("limitMbps" Core..=) Core.. Core.AsText Core.<$> limitMbps])
...
instance Core.FromJSON ErrorLogEntry where
        parseJSON
          = Core.withObject "ErrorLogEntry"
              (\ o ->
                 ErrorLogEntry Core.<$>
                   (o Core..:? "errorDetails") Core.<*> (o Core..:? "url"))
...
newErrorSummary 
    ::  ErrorSummary
newErrorSummary
  = ErrorSummary{errorCode = Core.Nothing, errorCount = Core.Nothing,
                 errorLogEntries = Core.Nothing}
instance Core.FromJSON ErrorSummary where
        parseJSON
          = Core.withObject "ErrorSummary"
              (\ o ->
                 ErrorSummary Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("errorCode" Core..=) Core.<$> errorCode,
                  ...
                  ("errorLogEntries" Core..=) Core.<$> errorLogEntries])
...
newEventStream 
    ::  EventStream
newEventStream
  = EventStream{eventStreamExpirationTime = Core.Nothing,
                eventStreamStartTime = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON EventStream where
        parseJSON
          = Core.withObject "EventStream"
              (\ o ->
                 EventStream Core.<$>
                   (o Core..:? "eventStreamExpirationTime") Core.<*>
                     (o Core..:? "eventStreamStartTime")
                     Core.<*> (o Core..:? "name"))
...
instance Core.ToJSON EventStream where
        toJSON EventStream{..}
          = Core.object
              (Core.catMaybes
                 [("eventStreamExpirationTime" Core..=) Core.<$>
                    eventStreamExpirationTime,
                  ("eventStreamStartTime" Core..=) Core.<$> eventStreamStartTime,
                  ("name" Core..=) Core.<$> name])


-- | The identity of an Azure application through which Storage Transfer Service can authenticate requests using Azure workload identity federation. Storage Transfer Service can issue requests to Azure Storage through registered Azure applications, eliminating the need to pass credentials to Storage Transfer Service directly. To configure federated identity, see <https://cloud.google.com/storage-transfer/docs/source-microsoft-azure#option_3_authenticate_using_federated_identity Configure access to Microsoft Azure Storage>.
--
-- /See:/ 'newFederatedIdentityConfig' smart constructor.
data FederatedIdentityConfig = FederatedIdentityConfig
    {
...
-- | Creates a value of 'FederatedIdentityConfig' with the minimum fields required to make a request.
newFederatedIdentityConfig 
    ::  FederatedIdentityConfig
newFederatedIdentityConfig
  = FederatedIdentityConfig{clientId = Core.Nothing,
                            tenantId = Core.Nothing}
instance Core.FromJSON FederatedIdentityConfig where
        parseJSON
          = Core.withObject "FederatedIdentityConfig"
              (\ o ->
                 FederatedIdentityConfig Core.<$>
                   (o Core..:? "clientId") Core.<*> (o Core..:? "tenantId"))

instance Core.ToJSON FederatedIdentityConfig where
        toJSON FederatedIdentityConfig{..}
          = Core.object
              (Core.catMaybes
...
data GcsData = GcsData
    {
      ...
      bucketName :: (Core.Maybe Core.Text)
      -- | Preview. Enables the transfer of managed folders between Cloud Storage buckets. Set this option on the gcs/data/source. If set to true: - Managed folders in the source bucket are transferred to the destination bucket. - Managed folders in the destination bucket are overwritten. Other OVERWRITE options are not supported. See </storage-transfer/docs/managed-folders Transfer Cloud Storage managed folders>.
    , managedFolderTransferEnabled :: (Core.Maybe Core.Bool)
...
newGcsData 
    ::  GcsData
newGcsData
  = GcsData{bucketName = Core.Nothing,
            managedFolderTransferEnabled = Core.Nothing, path = Core.Nothing}
instance Core.FromJSON GcsData where
        parseJSON
          = Core.withObject "GcsData"
              (\ o ->
                 GcsData Core.<$>
                   (o Core..:? "bucketName") Core.<*>
                     (o Core..:? "managedFolderTransferEnabled")
                     Core.<*> (o Core..:? "path"))
...
instance Core.ToJSON GcsData where
        toJSON GcsData{..}
          = Core.object
              (Core.catMaybes
                 [("bucketName" Core..=) Core.<$> bucketName,
                  ("managedFolderTransferEnabled" Core..=) Core.<$>
...
newGoogleServiceAccount 
    ::  GoogleServiceAccount
newGoogleServiceAccount
  = GoogleServiceAccount{accountEmail = Core.Nothing,
                         subjectId = Core.Nothing}
instance Core.FromJSON GoogleServiceAccount where
        parseJSON
          = Core.withObject "GoogleServiceAccount"
              (\ o ->
                 GoogleServiceAccount Core.<$>
                   (o Core..:? "accountEmail") Core.<*> (o Core..:? "subjectId"))
...
--
-- /See:/ 'newHdfsData' smart constructor.
newtype HdfsData = HdfsData
    {
...
-- | Creates a value of 'HdfsData' with the minimum fields required to make a request.
newHdfsData 
    ::  HdfsData
newHdfsData = HdfsData{path = Core.Nothing}
instance Core.FromJSON HdfsData where
        parseJSON
          = Core.withObject "HdfsData"
              (\ o -> HdfsData Core.<$> (o Core..:? "path"))

instance Core.ToJSON HdfsData where
        toJSON HdfsData{..}
...
newListAgentPoolsResponse 
    ::  ListAgentPoolsResponse
newListAgentPoolsResponse
  = ListAgentPoolsResponse{agentPools = Core.Nothing,
                           nextPageToken = Core.Nothing}
instance Core.FromJSON ListAgentPoolsResponse where
        parseJSON
          = Core.withObject "ListAgentPoolsResponse"
              (\ o ->
                 ListAgentPoolsResponse Core.<$>
                   (o Core..:? "agentPools") Core.<*> (o Core..:? "nextPageToken"))
...
newListTransferJobsResponse 
    ::  ListTransferJobsResponse
newListTransferJobsResponse
  = ListTransferJobsResponse{nextPageToken = Core.Nothing,
                             transferJobs = Core.Nothing}
instance Core.FromJSON ListTransferJobsResponse where
        parseJSON
          = Core.withObject "ListTransferJobsResponse"
              (\ o ->
                 ListTransferJobsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "transferJobs"))
...
-- | Specifies the logging behavior for transfer operations. Logs can be sent to Cloud Logging for all transfer types. See <https://cloud.google.com/storage-transfer/docs/read-transfer-logs Read transfer logs> for details.
--
-- /See:/ 'newLoggingConfig' smart constructor.
data LoggingConfig = LoggingConfig
    {
      -- | For PosixFilesystem transfers, enables <https://cloud.google.com/storage-transfer/docs/on-prem-transfer-log-format file system transfer logs> instead of, or in addition to, Cloud Logging. This option ignores [LoggableAction] and [LoggableActionState]. If these are set, Cloud Logging will also be enabled for this transfer.
...
newLoggingConfig 
    ::  LoggingConfig
newLoggingConfig
  = LoggingConfig{enableOnpremGcsTransferLogs = Core.Nothing,
                  logActionStates = Core.Nothing, logActions = Core.Nothing}
instance Core.FromJSON LoggingConfig where
        parseJSON
          = Core.withObject "LoggingConfig"
              (\ o ->
                 LoggingConfig Core.<$>
                   (o Core..:? "enableOnpremGcsTransferLogs") Core.<*>
                     (o Core..:? "logActionStates")
...
instance Core.ToJSON LoggingConfig where
        toJSON LoggingConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enableOnpremGcsTransferLogs" Core..=) Core.<$>
...
newMetadataOptions 
    ::  MetadataOptions
newMetadataOptions
  = MetadataOptions{acl = Core.Nothing, gid = Core.Nothing,
                    kmsKey = Core.Nothing, mode = Core.Nothing,
                    storageClass = Core.Nothing, symlink = Core.Nothing,
                    temporaryHold = Core.Nothing, timeCreated = Core.Nothing,
                    uid = Core.Nothing}
instance Core.FromJSON MetadataOptions where
        parseJSON
          = Core.withObject "MetadataOptions"
              (\ o ->
                 MetadataOptions Core.<$>
                   (o Core..:? "acl") Core.<*> (o Core..:? "gid") Core.<*>
                     (o Core..:? "kmsKey")
                     Core.<*> (o Core..:? "mode")
...
instance Core.ToJSON MetadataOptions where
        toJSON MetadataOptions{..}
          = Core.object
              (Core.catMaybes
                 [("acl" Core..=) Core.<$> acl, ("gid" Core..=) Core.<$> gid,
                  ("kmsKey" Core..=) Core.<$> kmsKey, ("mode" Core..=) Core.<$> mode,
...
newNotificationConfig 
    ::  NotificationConfig
newNotificationConfig
  = NotificationConfig{eventTypes = Core.Nothing,
                       payloadFormat = Core.Nothing, pubsubTopic = Core.Nothing}
instance Core.FromJSON NotificationConfig where
        parseJSON
          = Core.withObject "NotificationConfig"
              (\ o ->
                 NotificationConfig Core.<$>
                   (o Core..:? "eventTypes") Core.<*> (o Core..:? "payloadFormat")
...
newObjectConditions 
    ::  ObjectConditions
newObjectConditions
  = ObjectConditions{excludePrefixes = Core.Nothing,
                     includePrefixes = Core.Nothing, lastModifiedBefore = Core.Nothing,
...
instance Core.FromJSON ObjectConditions where
        parseJSON
          = Core.withObject "ObjectConditions"
              (\ o ->
                 ObjectConditions Core.<$>
                   (o Core..:? "excludePrefixes") Core.<*>
                     (o Core..:? "includePrefixes")
...
instance Core.ToJSON ObjectConditions where
        toJSON ObjectConditions{..}
          = Core.object
              (Core.catMaybes
                 [("excludePrefixes" Core..=) Core.<$> excludePrefixes,
                  ("includePrefixes" Core..=) Core.<$> includePrefixes,
                  ("lastModifiedBefore" Core..=) Core.<$> lastModifiedBefore,
                  ("lastModifiedSince" Core..=) Core.<$> lastModifiedSince,
                  ("maxTimeElapsedSinceLastModification" Core..=) Core.<$>
                    maxTimeElapsedSinceLastModification,
                  ("minTimeElapsedSinceLastModification" Core..=) Core.<$>
...
instance Core.FromJSON PauseTransferOperationRequest where
        parseJSON
          = Core.withObject "PauseTransferOperationRequest"
...
instance Core.FromJSON PosixFilesystem where
        parseJSON
          = Core.withObject "PosixFilesystem"
              (\ o -> PosixFilesystem Core.<$> (o Core..:? "rootDirectory"))

instance Core.ToJSON PosixFilesystem where
        toJSON PosixFilesystem{..}
          = Core.object
              (Core.catMaybes [("rootDirectory" Core..=) Core.<$> rootDirectory])
...
--
-- /See:/ 'newReplicationSpec' smart constructor.
data ReplicationSpec = ReplicationSpec
    {
...
-- | Creates a value of 'ReplicationSpec' with the minimum fields required to make a request.
newReplicationSpec 
    ::  ReplicationSpec
newReplicationSpec
  = ReplicationSpec{gcsDataSink = Core.Nothing,
                    gcsDataSource = Core.Nothing, objectConditions = Core.Nothing,
                    transferOptions = Core.Nothing}
instance Core.FromJSON ReplicationSpec where
        parseJSON
          = Core.withObject "ReplicationSpec"
              (\ o ->
                 ReplicationSpec Core.<$>
                   (o Core..:? "gcsDataSink") Core.<*> (o Core..:? "gcsDataSource")
                     Core.<*> (o Core..:? "objectConditions")
                     Core.<*> (o Core..:? "transferOptions"))

instance Core.ToJSON ReplicationSpec where
        toJSON ReplicationSpec{..}
          = Core.object
              (Core.catMaybes
                 [("gcsDataSink" Core..=) Core.<$> gcsDataSink,
                  ("gcsDataSource" Core..=) Core.<$> gcsDataSource,
                  ("objectConditions" Core..=) Core.<$> objectConditions,
                  ("transferOptions" Core..=) Core.<$> transferOptions])
...
instance Core.FromJSON ResumeTransferOperationRequest where
        parseJSON
          = Core.withObject "ResumeTransferOperationRequest"
...
newRunTransferJobRequest 
    ::  RunTransferJobRequest
newRunTransferJobRequest
  = RunTransferJobRequest{projectId = Core.Nothing}
instance Core.FromJSON RunTransferJobRequest where
        parseJSON
          = Core.withObject "RunTransferJobRequest"
              (\ o -> RunTransferJobRequest Core.<$> (o Core..:? "projectId"))
...
newS3CompatibleMetadata 
    ::  S3CompatibleMetadata
newS3CompatibleMetadata
  = S3CompatibleMetadata{authMethod = Core.Nothing,
                         listApi = Core.Nothing, protocol = Core.Nothing,
                         requestModel = Core.Nothing}
instance Core.FromJSON S3CompatibleMetadata where
        parseJSON
          = Core.withObject "S3CompatibleMetadata"
              (\ o ->
                 S3CompatibleMetadata Core.<$>
                   (o Core..:? "authMethod") Core.<*> (o Core..:? "listApi") Core.<*>
                     (o Core..:? "protocol")
...
newSchedule 
    ::  Schedule
newSchedule
  = Schedule{endTimeOfDay = Core.Nothing,
             repeatInterval = Core.Nothing, scheduleEndDate = Core.Nothing,
             scheduleStartDate = Core.Nothing, startTimeOfDay = Core.Nothing}
instance Core.FromJSON Schedule where
        parseJSON
          = Core.withObject "Schedule"
              (\ o ->
                 Schedule Core.<$>
                   (o Core..:? "endTimeOfDay") Core.<*> (o Core..:? "repeatInterval")
          ...
          = Core.object
              (Core.catMaybes
                 [("endTimeOfDay" Core..=) Core.<$> endTimeOfDay,
                  ...
                  ("scheduleStartDate" Core..=) Core.<$> scheduleStartDate,
...
newTransferCounters 
    ::  TransferCounters
newTransferCounters
  = TransferCounters{bytesCopiedToSink = Core.Nothing,
...
instance Core.FromJSON TransferCounters where
        parseJSON
          = Core.withObject "TransferCounters"
              (\ o ->
                 TransferCounters Core.<$>
                   (o Core..:? "bytesCopiedToSink" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "bytesDeletedFromSink" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "bytesDeletedFromSource" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "bytesFailedToDeleteFromSink" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "bytesFoundFromSource" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "bytesFoundOnlyFromSink" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "bytesFromSourceFailed" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "bytesFromSourceSkippedBySync" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "directoriesFailedToListFromSource" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "directoriesFoundFromSource" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "directoriesSuccessfullyListedFromSource" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "intermediateObjectsCleanedUp" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "intermediateObjectsFailedCleanedUp" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "objectsCopiedToSink" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "objectsDeletedFromSink" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "objectsDeletedFromSource" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "objectsFailedToDeleteFromSink" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "objectsFoundFromSource" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "objectsFoundOnlyFromSink" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "objectsFromSourceFailed" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "objectsFromSourceSkippedBySync" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON TransferCounters where
        toJSON TransferCounters{..}
          = Core.object
              (Core.catMaybes
                 [("bytesCopiedToSink" Core..=) Core.. Core.AsText Core.<$>
                    bytesCopiedToSink,
                  ("bytesDeletedFromSink" Core..=) Core.. Core.AsText Core.<$>
                    bytesDeletedFromSink,
                  ("bytesDeletedFromSource" Core..=) Core.. Core.AsText Core.<$>
                    bytesDeletedFromSource,
                  ("bytesFailedToDeleteFromSink" Core..=) Core.. Core.AsText Core.<$>
                    bytesFailedToDeleteFromSink,
                  ("bytesFoundFromSource" Core..=) Core.. Core.AsText Core.<$>
                    bytesFoundFromSource,
                  ("bytesFoundOnlyFromSink" Core..=) Core.. Core.AsText Core.<$>
                    bytesFoundOnlyFromSink,
                  ("bytesFromSourceFailed" Core..=) Core.. Core.AsText Core.<$>
                    bytesFromSourceFailed,
                  ("bytesFromSourceSkippedBySync" Core..=) Core.. Core.AsText
                    Core.<$> bytesFromSourceSkippedBySync,
                  ("directoriesFailedToListFromSource" Core..=) Core.. Core.AsText
                    Core.<$> directoriesFailedToListFromSource,
                  ("directoriesFoundFromSource" Core..=) Core.. Core.AsText Core.<$>
                    directoriesFoundFromSource,
                  ("directoriesSuccessfullyListedFromSource" Core..=) Core..
                    Core.AsText
                    Core.<$> directoriesSuccessfullyListedFromSource,
                  ("intermediateObjectsCleanedUp" Core..=) Core.. Core.AsText
                    Core.<$> intermediateObjectsCleanedUp,
                  ("intermediateObjectsFailedCleanedUp" Core..=) Core.. Core.AsText
                    Core.<$> intermediateObjectsFailedCleanedUp,
                  ("objectsCopiedToSink" Core..=) Core.. Core.AsText Core.<$>
                    objectsCopiedToSink,
                  ("objectsDeletedFromSink" Core..=) Core.. Core.AsText Core.<$>
                    objectsDeletedFromSink,
                  ("objectsDeletedFromSource" Core..=) Core.. Core.AsText Core.<$>
                    objectsDeletedFromSource,
                  ("objectsFailedToDeleteFromSink" Core..=) Core.. Core.AsText
                    Core.<$> objectsFailedToDeleteFromSink,
                  ("objectsFoundFromSource" Core..=) Core.. Core.AsText Core.<$>
                    objectsFoundFromSource,
                  ("objectsFoundOnlyFromSink" Core..=) Core.. Core.AsText Core.<$>
                    objectsFoundOnlyFromSink,
                  ("objectsFromSourceFailed" Core..=) Core.. Core.AsText Core.<$>
                    objectsFromSourceFailed,
                  ("objectsFromSourceSkippedBySync" Core..=) Core.. Core.AsText
...
data TransferJob = TransferJob
    ...
    , replicationSpec :: (Core.Maybe ReplicationSpec)
...
newTransferJob 
    ::  TransferJob
newTransferJob
  = TransferJob{creationTime = Core.Nothing,
                deletionTime = Core.Nothing, description = Core.Nothing,
                eventStream = Core.Nothing, lastModificationTime = Core.Nothing,
                latestOperationName = Core.Nothing, loggingConfig = Core.Nothing,
                name = Core.Nothing, notificationConfig = Core.Nothing,
                projectId = Core.Nothing, replicationSpec = Core.Nothing,
                schedule = Core.Nothing, serviceAccount = Core.Nothing,
                status = Core.Nothing, transferSpec = Core.Nothing}
instance Core.FromJSON TransferJob where
        parseJSON
          = Core.withObject "TransferJob"
              (\ o ->
                 TransferJob Core.<$>
                   (o Core..:? "creationTime") Core.<*> (o Core..:? "deletionTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("creationTime" Core..=) Core.<$> creationTime,
                  ...
                  ("lastModificationTime" Core..=) Core.<$> lastModificationTime,
                  ("latestOperationName" Core..=) Core.<$> latestOperationName,
                  ("loggingConfig" Core..=) Core.<$> loggingConfig,
                  ("name" Core..=) Core.<$> name,
                  ("notificationConfig" Core..=) Core.<$> notificationConfig,
                  ("projectId" Core..=) Core.<$> projectId,
                  ("replicationSpec" Core..=) Core.<$> replicationSpec,
...
instance Core.FromJSON TransferManifest where
        parseJSON
          = Core.withObject "TransferManifest"
              (\ o -> TransferManifest Core.<$> (o Core..:? "location"))
...
newTransferOperation 
    ::  TransferOperation
newTransferOperation
  = TransferOperation{counters = Core.Nothing,
                      endTime = Core.Nothing, errorBreakdowns = Core.Nothing,
                      loggingConfig = Core.Nothing, name = Core.Nothing,
                      notificationConfig = Core.Nothing, projectId = Core.Nothing,
                      startTime = Core.Nothing, status = Core.Nothing,
                      transferJobName = Core.Nothing, transferSpec = Core.Nothing}
instance Core.FromJSON TransferOperation where
        parseJSON
          = Core.withObject "TransferOperation"
              (\ o ->
                 TransferOperation Core.<$>
                   (o Core..:? "counters") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "errorBreakdowns")
                     Core.<*> (o Core..:? "loggingConfig")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "notificationConfig")
                     Core.<*> (o Core..:? "projectId")
...
instance Core.FromJSON TransferOptions where
        parseJSON
          = Core.withObject "TransferOptions"
              (\ o ->
                 TransferOptions Core.<$>
                   (o Core..:? "deleteObjectsFromSourceAfterTransfer") Core.<*>
                     (o Core..:? "deleteObjectsUniqueInSink")
...
instance Core.ToJSON TransferOptions where
        toJSON TransferOptions{..}
          = Core.object
              (Core.catMaybes
                 [("deleteObjectsFromSourceAfterTransfer" Core..=) Core.<$>
                    deleteObjectsFromSourceAfterTransfer,
                  ("deleteObjectsUniqueInSink" Core..=) Core.<$>
                    deleteObjectsUniqueInSink,
                  ("metadataOptions" Core..=) Core.<$> metadataOptions,
                  ("overwriteObjectsAlreadyExistingInSink" Core..=) Core.<$>
...
data TransferSpec = TransferSpec
    ...
    , gcsDataSource :: (Core.Maybe GcsData)
      -- | For transfers between file systems, specifies a Cloud Storage bucket to be used as an intermediate location through which to transfer data. See <https://cloud.google.com/storage-transfer/docs/file-to-file Transfer data between file systems> for more information.
    , gcsIntermediateDataLocation :: (Core.Maybe GcsData)
      -- | An HDFS cluster data source.
    , hdfsDataSource :: (Core.Maybe HdfsData)
...
newTransferSpec 
    ::  TransferSpec
newTransferSpec
  = TransferSpec{awsS3CompatibleDataSource = Core.Nothing,
                 awsS3DataSource = Core.Nothing,
                 azureBlobStorageDataSource = Core.Nothing,
                 gcsDataSink = Core.Nothing, gcsDataSource = Core.Nothing,
                 gcsIntermediateDataLocation = Core.Nothing,
                 hdfsDataSource = Core.Nothing, httpDataSource = Core.Nothing,
                 objectConditions = Core.Nothing, posixDataSink = Core.Nothing,
                 posixDataSource = Core.Nothing, sinkAgentPoolName = Core.Nothing,
                 sourceAgentPoolName = Core.Nothing,
                 transferManifest = Core.Nothing, transferOptions = Core.Nothing}
instance Core.FromJSON TransferSpec where
        parseJSON
          = Core.withObject "TransferSpec"
              (\ o ->
                 TransferSpec Core.<$>
                   (o Core..:? "awsS3CompatibleDataSource") Core.<*>
                     (o Core..:? "awsS3DataSource")
...
instance Core.ToJSON TransferSpec where
        toJSON TransferSpec{..}
          = Core.object
              (Core.catMaybes
                 [("awsS3CompatibleDataSource" Core..=) Core.<$>
                    awsS3CompatibleDataSource,
                  ("awsS3DataSource" Core..=) Core.<$> awsS3DataSource,
                  ("azureBlobStorageDataSource" Core..=) Core.<$>
                    azureBlobStorageDataSource,
                  ("gcsDataSink" Core..=) Core.<$> gcsDataSink,
                  ("gcsDataSource" Core..=) Core.<$> gcsDataSource,
                  ("gcsIntermediateDataLocation" Core..=) Core.<$>
                    gcsIntermediateDataLocation,
                  ("hdfsDataSource" Core..=) Core.<$> hdfsDataSource,
                  ("httpDataSource" Core..=) Core.<$> httpDataSource,
                  ("objectConditions" Core..=) Core.<$> objectConditions,
                  ("posixDataSink" Core..=) Core.<$> posixDataSink,
                  ("posixDataSource" Core..=) Core.<$> posixDataSource,
                  ("sinkAgentPoolName" Core..=) Core.<$> sinkAgentPoolName,
                  ("sourceAgentPoolName" Core..=) Core.<$> sourceAgentPoolName,
                  ("transferManifest" Core..=) Core.<$> transferManifest,
                  ("transferOptions" Core..=) Core.<$> transferOptions])
...
newUpdateTransferJobRequest 
    ::  UpdateTransferJobRequest
newUpdateTransferJobRequest
  = UpdateTransferJobRequest{projectId = Core.Nothing,
                             transferJob = Core.Nothing,
                             updateTransferJobFieldMask = Core.Nothing}
instance Core.FromJSON UpdateTransferJobRequest where
        parseJSON
          = Core.withObject "UpdateTransferJobRequest"
              (\ o ->
                 UpdateTransferJobRequest Core.<$>
                   (o Core..:? "projectId") Core.<*> (o Core..:? "transferJob")
          ...
          = Core.object
              (Core.catMaybes
                 [("projectId" Core..=) Core.<$> projectId,
                  ...
                  ("updateTransferJobFieldMask" Core..=) Core.<$>
