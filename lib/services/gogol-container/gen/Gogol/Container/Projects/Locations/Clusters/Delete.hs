         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "clusterId" Core.Text Core.:>
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersDelete
         where
        type Rs ContainerProjectsLocationsClustersDelete =
             Operation
        type Scopes ContainerProjectsLocationsClustersDelete
             = '[CloudPlatform'FullControl]
        requestClient
          ContainerProjectsLocationsClustersDelete{..}
          = go name xgafv accessToken callback clusterId
              projectId
              uploadType
              uploadProtocol
              zone
