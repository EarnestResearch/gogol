...
-- |
-- Module      : Gogol.Container.Projects.Zones.Clusters.Create
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] CreateClusterRequest
...
instance Core.GoogleRequest
           ContainerProjectsZonesClustersCreate
         where
        type Rs ContainerProjectsZonesClustersCreate =
             Operation
        type Scopes ContainerProjectsZonesClustersCreate =
             '[CloudPlatform'FullControl]
        requestClient
          ContainerProjectsZonesClustersCreate{..}
          = go projectId zone xgafv accessToken callback
              uploadType
              uploadProtocol
