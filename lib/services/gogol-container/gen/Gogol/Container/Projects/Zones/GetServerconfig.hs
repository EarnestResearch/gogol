                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ServerConfig
...
instance Core.GoogleRequest
           ContainerProjectsZonesGetServerconfig
         where
        type Rs ContainerProjectsZonesGetServerconfig =
             ServerConfig
        type Scopes ContainerProjectsZonesGetServerconfig =
             '[CloudPlatform'FullControl]
        requestClient
          ContainerProjectsZonesGetServerconfig{..}
          = go projectId zone xgafv accessToken callback name
              uploadType
              uploadProtocol
