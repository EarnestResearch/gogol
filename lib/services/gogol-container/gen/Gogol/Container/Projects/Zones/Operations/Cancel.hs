...
-- |
-- Module      : Gogol.Container.Projects.Zones.Operations.Cancel
         ...
         Core.Capture "projectId" Core.Text Core.:>
           "zones" Core.:>
             Core.Capture "zone" Core.Text Core.:>
               "operations" Core.:>
                 Core.CaptureMode "operationId" "cancel" Core.Text
                   Core.:>
...
instance Core.GoogleRequest
           ContainerProjectsZonesOperationsCancel
         where
        type Rs ContainerProjectsZonesOperationsCancel =
             Empty
        type Scopes ContainerProjectsZonesOperationsCancel =
