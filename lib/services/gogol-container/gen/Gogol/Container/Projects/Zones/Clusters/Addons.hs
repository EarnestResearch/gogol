...
-- |
-- Module      : Gogol.Container.Projects.Zones.Clusters.Addons
...
-- 'ContainerProjectsZonesClustersAddons' request conforms to.
type ContainerProjectsZonesClustersAddonsResource =
     "v1" Core.:>
       "projects" Core.:>
...
-- | Sets the addons for a specific cluster.
--
-- /See:/ 'newContainerProjectsZonesClustersAddons' smart constructor.
data ContainerProjectsZonesClustersAddons = ContainerProjectsZonesClustersAddons
    {
      -- | V1 error format.
...
-- | Creates a value of 'ContainerProjectsZonesClustersAddons' with the minimum fields required to make a request.
newContainerProjectsZonesClustersAddons 
    ::  Core.Text
    ...
    -> ContainerProjectsZonesClustersAddons
newContainerProjectsZonesClustersAddons clusterId payload projectId zone =
  ContainerProjectsZonesClustersAddons
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           ContainerProjectsZonesClustersAddons
         where
        type Rs ContainerProjectsZonesClustersAddons =
             Operation
        type Scopes ContainerProjectsZonesClustersAddons =
