          ...
          = Core.object
              (Core.catMaybes
                 [("acceleratorCount" Core..=) Core.. Core.AsText
                  ...
                  ("gpuPartitionSize" Core..=) Core.<$>
                    gpuPartitionSize,
                  ("gpuSharingConfig" Core..=) Core.<$>
                    gpuSharingConfig])
...
newtype AdditionalPodRangesConfig = AdditionalPodRangesConfig
    {
...
newAdditionalPodRangesConfig 
    ::  AdditionalPodRangesConfig
newAdditionalPodRangesConfig =
  AdditionalPodRangesConfig {podRangeNames = Core.Nothing}

instance Core.FromJSON AdditionalPodRangesConfig
         where
        parseJSON
          = Core.withObject "AdditionalPodRangesConfig"
              (\ o ->
                 AdditionalPodRangesConfig Core.<$>
                   (o Core..:? "podRangeNames"))
              ...
              (\ o ->
                 AddonsConfig Core.<$>
                   (o Core..:? "cloudRunConfig") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "gcePersistentDiskCsiDriverConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("cloudRunConfig" Core..=) Core.<$> cloudRunConfig,
                  ("configConnectorConfig" Core..=) Core.<$>
                    configConnectorConfig,
                  ...
                  ("gcpFilestoreCsiDriverConfig" Core..=) Core.<$>
                    gcpFilestoreCsiDriverConfig,
                  ("gkeBackupAgentConfig" Core..=) Core.<$>
                    gkeBackupAgentConfig,
                  ("horizontalPodAutoscaling" Core..=) Core.<$>
                    horizontalPodAutoscaling,
                  ("httpLoadBalancing" Core..=) Core.<$>
                    httpLoadBalancing,
                  ("kubernetesDashboard" Core..=) Core.<$>
                    kubernetesDashboard,
                  ("networkPolicyConfig" Core..=) Core.<$>
                    networkPolicyConfig])
...
newAuthenticatorGroupsConfig =
  AuthenticatorGroupsConfig
    {enabled = Core.Nothing, securityGroup = Core.Nothing}

instance Core.FromJSON AuthenticatorGroupsConfig
         where
        parseJSON
...
newAutoUpgradeOptions =
  AutoUpgradeOptions
    {autoUpgradeStartTime = Core.Nothing, description = Core.Nothing}
...
instance Core.ToJSON AutoUpgradeOptions where
        toJSON AutoUpgradeOptions{..}
          = Core.object
              (Core.catMaybes
                 [("autoUpgradeStartTime" Core..=) Core.<$>
...
instance Core.ToJSON AutoprovisioningNodePoolDefaults
         where
...
instance Core.ToJSON BlueGreenInfo where
        toJSON BlueGreenInfo{..}
          = Core.object
              (Core.catMaybes
                 [("blueInstanceGroupUrls" Core..=) Core.<$>
                    blueInstanceGroupUrls,
                  ("bluePoolDeletionStartTime" Core..=) Core.<$>
                    bluePoolDeletionStartTime,
                  ("greenInstanceGroupUrls" Core..=) Core.<$>
                    greenInstanceGroupUrls,
                  ("greenPoolVersion" Core..=) Core.<$>
                    greenPoolVersion,
...
newBlueGreenSettings =
  BlueGreenSettings
    {nodePoolSoakDuration = Core.Nothing, standardRolloutPolicy = Core.Nothing}
...
instance Core.ToJSON BlueGreenSettings where
        toJSON BlueGreenSettings{..}
          = Core.object
              (Core.catMaybes
                 [("nodePoolSoakDuration" Core..=) Core.<$>
                    nodePoolSoakDuration,
                  ("standardRolloutPolicy" Core..=) Core.<$>
                    standardRolloutPolicy])
              ...
              (\ o ->
                 Cluster Core.<$>
                   (o Core..:? "addonsConfig") Core.<*>
                     (o Core..:? "authenticatorGroupsConfig")
                     ...
                     Core.<*>
                     (o Core..:? "masterAuthorizedNetworksConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("addonsConfig" Core..=) Core.<$> addonsConfig,
                  ...
                  ("confidentialNodes" Core..=) Core.<$>
                    confidentialNodes,
                  ("costManagementConfig" Core..=) Core.<$>
                    costManagementConfig,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("currentMasterVersion" Core..=) Core.<$>
                    currentMasterVersion,
                  ("currentNodeCount" Core..=) Core.<$>
                    currentNodeCount,
                  ("currentNodeVersion" Core..=) Core.<$>
                    currentNodeVersion,
                  ("databaseEncryption" Core..=) Core.<$>
                    databaseEncryption,
                  ("defaultMaxPodsConstraint" Core..=) Core.<$>
                    defaultMaxPodsConstraint,
                  ("description" Core..=) Core.<$> description,
                  ("enableKubernetesAlpha" Core..=) Core.<$>
                  ...
                  ("id" Core..=) Core.<$> id,
                  ("identityServiceConfig" Core..=) Core.<$>
                    identityServiceConfig,
                  ("initialClusterVersion" Core..=) Core.<$>
                    initialClusterVersion,
                  ("initialNodeCount" Core..=) Core.<$>
                    initialNodeCount,
                  ("instanceGroupUrls" Core..=) Core.<$>
                    instanceGroupUrls,
                  ("ipAllocationPolicy" Core..=) Core.<$>
                    ipAllocationPolicy,
                  ("labelFingerprint" Core..=) Core.<$>
                    labelFingerprint,
                  ...
                  ("maintenancePolicy" Core..=) Core.<$>
                    maintenancePolicy,
                  ("masterAuth" Core..=) Core.<$> masterAuth,
                  ("masterAuthorizedNetworksConfig" Core..=) Core.<$>
                    masterAuthorizedNetworksConfig,
                  ("meshCertificates" Core..=) Core.<$>
                    meshCertificates,
                  ("monitoringConfig" Core..=) Core.<$>
                    monitoringConfig,
                  ("monitoringService" Core..=) Core.<$>
                    monitoringService,
                  ("name" Core..=) Core.<$> name,
                  ...
                  ("nodeIpv4CidrSize" Core..=) Core.<$>
                    nodeIpv4CidrSize,
                  ("nodePoolAutoConfig" Core..=) Core.<$>
                    nodePoolAutoConfig,
                  ("nodePoolDefaults" Core..=) Core.<$>
                    nodePoolDefaults,
                  ("nodePools" Core..=) Core.<$> nodePools,
                  ("notificationConfig" Core..=) Core.<$>
                    notificationConfig,
                  ("privateClusterConfig" Core..=) Core.<$>
                    privateClusterConfig,
                  ...
                  ("servicesIpv4Cidr" Core..=) Core.<$>
                    servicesIpv4Cidr,
                  ("shieldedNodes" Core..=) Core.<$> shieldedNodes,
                  ("status" Core..=) Core.<$> status,
                  ("statusMessage" Core..=) Core.<$> statusMessage,
                  ("subnetwork" Core..=) Core.<$> subnetwork,
                  ("tpuIpv4CidrBlock" Core..=) Core.<$>
                    tpuIpv4CidrBlock,
                  ("verticalPodAutoscaling" Core..=) Core.<$>
                    verticalPodAutoscaling,
                  ("workloadIdentityConfig" Core..=) Core.<$>
                    workloadIdentityConfig,
                  ("zone" Core..=) Core.<$> zone])
              ...
              (\ o ->
                 ClusterUpdate Core.<$>
                   (o Core..:? "additionalPodRangesConfig") Core.<*>
                     (o Core..:? "desiredAddonsConfig")
                     Core.<*>
                     (o Core..:? "desiredAuthenticatorGroupsConfig")
                     ...
                     Core.<*>
                     (o Core..:? "desiredIntraNodeVisibilityConfig")
                     ...
                     Core.<*>
                     (o Core..:? "desiredMasterAuthorizedNetworksConfig")
                     ...
                     Core.<*>
                     (o Core..:? "desiredNodePoolAutoConfigNetworkTags")
                     ...
                     Core.<*>
                     (o Core..:? "desiredPrivateIpv6GoogleAccess")
                     Core.<*> (o Core..:? "desiredReleaseChannel")
                     Core.<*>
                     (o Core..:? "desiredResourceUsageExportConfig")
                     Core.<*>
                     (o Core..:? "desiredServiceExternalIpsConfig")
                     ...
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "removedAdditionalPodRangesConfig"))
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalPodRangesConfig" Core..=) Core.<$>
                  ...
                  ("desiredNodePoolId" Core..=) Core.<$>
                    desiredNodePoolId,
                  ("desiredNodePoolLoggingConfig" Core..=) Core.<$>
                    desiredNodePoolLoggingConfig,
                  ("desiredNodeVersion" Core..=) Core.<$>
                    desiredNodeVersion,
...
instance Core.FromJSON CompleteIPRotationRequest
         where
        parseJSON
          = Core.withObject "CompleteIPRotationRequest"
              (\ o ->
                 CompleteIPRotationRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
instance Core.FromJSON CompleteNodePoolUpgradeRequest
         where
        parseJSON
          = Core.withObject "CompleteNodePoolUpgradeRequest"
              (\ o -> Core.pure CompleteNodePoolUpgradeRequest)

instance Core.ToJSON CompleteNodePoolUpgradeRequest
         where
...
instance Core.FromJSON ConsumptionMeteringConfig
         where
        parseJSON
          ...
          = Core.withObject "CreateClusterRequest"
              (\ o ->
                 CreateClusterRequest Core.<$>
                   (o Core..:? "cluster") Core.<*> (o Core..:? "parent")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
instance Core.FromJSON DNSConfig where
        parseJSON
          = Core.withObject "DNSConfig"
              (\ o ->
                 DNSConfig Core.<$>
                   (o Core..:? "clusterDns") Core.<*>
                     (o Core..:? "clusterDnsDomain")
          ...
          = Core.object
              (Core.catMaybes
                 [("clusterDns" Core..=) Core.<$> clusterDns,
                  ("clusterDnsDomain" Core..=) Core.<$>
                    clusterDnsDomain,
                  ("clusterDnsScope" Core..=) Core.<$>
                    clusterDnsScope])
          ...
          = Core.withObject "DatabaseEncryption"
              (\ o ->
                 DatabaseEncryption Core.<$>
                   (o Core..:? "keyName") Core.<*> (o Core..:? "state"))
...
instance Core.FromJSON EphemeralStorageLocalSsdConfig
         where
        parseJSON
...
instance Core.ToJSON EphemeralStorageLocalSsdConfig
         where
...
instance Core.FromJSON Fleet where
        parseJSON
          = Core.withObject "Fleet"
              (\ o ->
                 Fleet Core.<$>
                   (o Core..:? "membership") Core.<*>
                     (o Core..:? "preRegistered")
                     Core.<*> (o Core..:? "project"))
...
newGPUSharingConfig =
  GPUSharingConfig
    {gpuSharingStrategy = Core.Nothing, maxSharedClientsPerGpu = Core.Nothing}
...
instance Core.ToJSON GcePersistentDiskCsiDriverConfig
         where
...
instance Core.FromJSON GcpFilestoreCsiDriverConfig
         where
        parseJSON
...
instance Core.ToJSON GcpFilestoreCsiDriverConfig
         where
          ...
          = Core.withObject "GetOpenIDConfigResponse"
              (\ o ->
                 GetOpenIDConfigResponse Core.<$>
                   (o Core..:? "cacheHeader") Core.<*>
                     (o Core..:? "claims_supported")
                     Core.<*> (o Core..:? "grant_types")
                     Core.<*>
                     (o Core..:? "id_token_signing_alg_values_supported")
                     Core.<*> (o Core..:? "issuer")
...
newHttpCacheControlResponseHeader =
  HttpCacheControlResponseHeader
    {age = Core.Nothing, directive = Core.Nothing, expires = Core.Nothing}

instance Core.FromJSON HttpCacheControlResponseHeader
         where
        parseJSON
          = Core.withObject "HttpCacheControlResponseHeader"
              (\ o ->
                 HttpCacheControlResponseHeader Core.<$>
                   (o Core..:? "age" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "directive")
                     Core.<*> (o Core..:? "expires"))

instance Core.ToJSON HttpCacheControlResponseHeader
         where
...
instance Core.FromJSON IntraNodeVisibilityConfig
         where
        parseJSON
          = Core.withObject "IntraNodeVisibilityConfig"
              (\ o ->
                 IntraNodeVisibilityConfig Core.<$>
                   (o Core..:? "enabled"))
...
newListOperationsResponse =
  ListOperationsResponse
    {missingZones = Core.Nothing, operations = Core.Nothing}
...
newListUsableSubnetworksResponse =
  ListUsableSubnetworksResponse
    {nextPageToken = Core.Nothing, subnetworks = Core.Nothing}

instance Core.FromJSON ListUsableSubnetworksResponse
         where
        parseJSON
...
instance Core.ToJSON ListUsableSubnetworksResponse
         where
...
instance Core.FromJSON MaintenanceExclusionOptions
         where
        parseJSON
...
instance Core.ToJSON MaintenanceExclusionOptions
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("dailyMaintenanceWindow" Core..=) Core.<$>
                    dailyMaintenanceWindow,
                  ("maintenanceExclusions" Core..=) Core.<$>
                    maintenanceExclusions,
                  ("recurringWindow" Core..=) Core.<$>
                    recurringWindow])
...
instance Core.FromJSON MasterAuthorizedNetworksConfig
         where
        parseJSON
          = Core.withObject "MasterAuthorizedNetworksConfig"
              (\ o ->
                 MasterAuthorizedNetworksConfig Core.<$>
                   (o Core..:? "cidrBlocks") Core.<*>
                     (o Core..:? "enabled")
                     Core.<*> (o Core..:? "gcpPublicCidrsAccessEnabled"))

instance Core.ToJSON MasterAuthorizedNetworksConfig
         where
...
instance Core.FromJSON MonitoringComponentConfig
         where
        parseJSON
          = Core.withObject "MonitoringComponentConfig"
              (\ o ->
                 MonitoringComponentConfig Core.<$>
                   (o Core..:? "enableComponents"))
...
newMonitoringConfig =
  MonitoringConfig
    {componentConfig = Core.Nothing, managedPrometheusConfig = Core.Nothing}
          ...
          = Core.withObject "MonitoringConfig"
              (\ o ->
                 MonitoringConfig Core.<$>
                   (o Core..:? "componentConfig") Core.<*>
                     (o Core..:? "managedPrometheusConfig"))
...
instance Core.ToJSON NetworkConfig where
        toJSON NetworkConfig{..}
          = Core.object
              (Core.catMaybes
                 [("datapathProvider" Core..=) Core.<$>
                    datapathProvider,
                  ("defaultSnatStatus" Core..=) Core.<$>
                    defaultSnatStatus,
                  ("dnsConfig" Core..=) Core.<$> dnsConfig,
                  ("enableIntraNodeVisibility" Core..=) Core.<$>
                    enableIntraNodeVisibility,
                  ("enableL4ilbSubsetting" Core..=) Core.<$>
                    enableL4ilbSubsetting,
                  ("gatewayApiConfig" Core..=) Core.<$>
                    gatewayApiConfig,
                  ("network" Core..=) Core.<$> network,
              ...
              (\ o ->
                 NodeConfig Core.<$>
                   (o Core..:? "accelerators") Core.<*>
                     ...
                     Core.<*> (o Core..:? "diskType")
                     Core.<*>
                     (o Core..:? "ephemeralStorageLocalSsdConfig")
...
instance Core.FromJSON NodeConfig_ResourceLabels
         where
        parseJSON
          = Core.withObject "NodeConfig_ResourceLabels"
              (\ o ->
                 NodeConfig_ResourceLabels Core.<$>
                   (Core.parseJSONObject o))
          ...
          = Core.withObject "NodeKubeletConfig"
              (\ o ->
                 NodeKubeletConfig Core.<$>
                   (o Core..:? "cpuCfsQuota") Core.<*>
                     (o Core..:? "cpuCfsQuotaPeriod")
                     Core.<*> (o Core..:? "cpuManagerPolicy")
                     Core.<*>
                     (o Core..:? "podPidsLimit" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("cpuCfsQuota" Core..=) Core.<$> cpuCfsQuota,
                  ("cpuCfsQuotaPeriod" Core..=) Core.<$>
                    cpuCfsQuotaPeriod,
                  ("cpuManagerPolicy" Core..=) Core.<$>
                    cpuManagerPolicy,
                  ("podPidsLimit" Core..=) Core.. Core.AsText Core.<$>
                    podPidsLimit])
          ...
          = Core.object
              (Core.catMaybes
                 [("createPodRange" Core..=) Core.<$> createPodRange,
                  ("enablePrivateNodes" Core..=) Core.<$>
                    enablePrivateNodes,
                  ("networkPerformanceConfig" Core..=) Core.<$>
                    networkPerformanceConfig,
                  ("podCidrOverprovisionConfig" Core..=) Core.<$>
                    podCidrOverprovisionConfig,
                  ("podIpv4CidrBlock" Core..=) Core.<$>
                    podIpv4CidrBlock,
...
instance Core.FromJSON NodePoolLoggingConfig where
        parseJSON
          = Core.withObject "NodePoolLoggingConfig"
              (\ o ->
                 NodePoolLoggingConfig Core.<$>
                   (o Core..:? "variantConfig"))
...
instance Core.FromJSON PodCIDROverprovisionConfig
         where
        parseJSON
...
instance Core.ToJSON PrivateClusterConfig where
        toJSON PrivateClusterConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enablePrivateEndpoint" Core..=) Core.<$>
                    enablePrivateEndpoint,
                  ("enablePrivateNodes" Core..=) Core.<$>
                    enablePrivateNodes,
                  ("masterGlobalAccessConfig" Core..=) Core.<$>
                    masterGlobalAccessConfig,
                  ("masterIpv4CidrBlock" Core..=) Core.<$>
                    masterIpv4CidrBlock,
...
instance Core.FromJSON PubSub where
        parseJSON
          = Core.withObject "PubSub"
              (\ o ->
                 PubSub Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "filter")
                     Core.<*> (o Core..:? "topic"))
          ...
          = Core.withObject "ReservationAffinity"
              (\ o ->
                 ReservationAffinity Core.<$>
                   (o Core..:? "consumeReservationType") Core.<*>
                     (o Core..:? "key")
                     Core.<*> (o Core..:? "values"))
...
instance Core.ToJSON ResourceLimit where
        toJSON ResourceLimit{..}
          = Core.object
              (Core.catMaybes
                 [("maximum" Core..=) Core.. Core.AsText Core.<$>
                    maximum,
                  ("minimum" Core..=) Core.. Core.AsText Core.<$>
                    minimum,
...
instance Core.FromJSON ResourceUsageExportConfig
         where
        parseJSON
...
instance Core.FromJSON RollbackNodePoolUpgradeRequest
         where
        parseJSON
...
instance Core.ToJSON RollbackNodePoolUpgradeRequest
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("channels" Core..=) Core.<$> channels,
                  ("defaultClusterVersion" Core..=) Core.<$>
                    defaultClusterVersion,
                  ("defaultImageType" Core..=) Core.<$>
                    defaultImageType,
                  ("validImageTypes" Core..=) Core.<$> validImageTypes,
                  ("validMasterVersions" Core..=) Core.<$>
                    validMasterVersions,
                  ("validNodeVersions" Core..=) Core.<$>
                    validNodeVersions])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "SetLabelsRequest_ResourceLabels"
              (\ o ->
                 SetLabelsRequest_ResourceLabels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SetLabelsRequest_ResourceLabels
         where
...
instance Core.FromJSON SetMaintenancePolicyRequest
         where
        parseJSON
          = Core.withObject "SetMaintenancePolicyRequest"
              (\ o ->
                 SetMaintenancePolicyRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*>
                     (o Core..:? "maintenancePolicy")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))

instance Core.ToJSON SetMaintenancePolicyRequest
         where
...
instance Core.FromJSON SetMonitoringServiceRequest
         where
        parseJSON
          = Core.withObject "SetMonitoringServiceRequest"
              (\ o ->
                 SetMonitoringServiceRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*>
                     (o Core..:? "monitoringService")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))

instance Core.ToJSON SetMonitoringServiceRequest
         where
...
instance Core.FromJSON SetNodePoolAutoscalingRequest
         where
        parseJSON
...
instance Core.ToJSON SetNodePoolAutoscalingRequest
         where
...
instance Core.FromJSON SetNodePoolManagementRequest
         where
        parseJSON
...
instance Core.ToJSON SetNodePoolManagementRequest
         where
...
newShieldedInstanceConfig =
  ShieldedInstanceConfig
    {enableIntegrityMonitoring = Core.Nothing, enableSecureBoot = Core.Nothing}
...
newStatusCondition =
  StatusCondition
    {canonicalCode = Core.Nothing, code = Core.Nothing, message = Core.Nothing}
...
instance Core.FromJSON UsableSubnetworkSecondaryRange
         where
        parseJSON
...
instance Core.ToJSON UsableSubnetworkSecondaryRange
         where
