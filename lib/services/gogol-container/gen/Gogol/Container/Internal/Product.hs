...
module Gogol.Container.Internal.Product
  (
    ...
    AnonymousAuthenticationConfig (..),
    newAnonymousAuthenticationConfig,
    ...
    DesiredAdditionalIPRangesConfig (..),
    newDesiredAdditionalIPRangesConfig,
    ...
    HighScaleCheckpointingConfig (..),
    newHighScaleCheckpointingConfig,
...
data AcceleratorConfig = AcceleratorConfig
    {
      ...
      -- | The accelerator type resource name. List of supported accelerators <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/gpus here>
...
newAcceleratorConfig
  = AcceleratorConfig{acceleratorCount = Core.Nothing,
                      ...
                      gpuPartitionSize = Core.Nothing, gpuSharingConfig = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("acceleratorCount" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("gpuDriverInstallationConfig" Core..=) Core.<$>
                    gpuDriverInstallationConfig,
...
--
-- /See:/ 'newAdditionalIPRangesConfig' smart constructor.
data AdditionalIPRangesConfig = AdditionalIPRangesConfig
    {
      ...
      podIpv4RangeNames :: (Core.Maybe [Core.Text])
...
-- | Creates a value of 'AdditionalIPRangesConfig' with the minimum fields required to make a request.
newAdditionalIPRangesConfig 
    ::  AdditionalIPRangesConfig
newAdditionalIPRangesConfig
  = AdditionalIPRangesConfig{podIpv4RangeNames = Core.Nothing,
                             subnetwork = Core.Nothing}
instance Core.FromJSON AdditionalIPRangesConfig where
        parseJSON
          = Core.withObject "AdditionalIPRangesConfig"
              (\ o ->
                 AdditionalIPRangesConfig Core.<$>
                   (o Core..:? "podIpv4RangeNames") Core.<*>
                     (o Core..:? "subnetwork"))

instance Core.ToJSON AdditionalIPRangesConfig where
        toJSON AdditionalIPRangesConfig{..}
          = Core.object
              (Core.catMaybes
                 [("podIpv4RangeNames" Core..=) Core.<$> podIpv4RangeNames,
...
newAdditionalNodeNetworkConfig 
    ::  AdditionalNodeNetworkConfig
newAdditionalNodeNetworkConfig
  = AdditionalNodeNetworkConfig{network = Core.Nothing,
                                subnetwork = Core.Nothing}
instance Core.FromJSON AdditionalNodeNetworkConfig where
        parseJSON
          = Core.withObject "AdditionalNodeNetworkConfig"
              (\ o ->
                 AdditionalNodeNetworkConfig Core.<$>
                   (o Core..:? "network") Core.<*> (o Core..:? "subnetwork"))
...
newAdditionalPodNetworkConfig 
    ::  AdditionalPodNetworkConfig
newAdditionalPodNetworkConfig
  = AdditionalPodNetworkConfig{maxPodsPerNode = Core.Nothing,
                               networkAttachment = Core.Nothing, secondaryPodRange = Core.Nothing,
                               subnetwork = Core.Nothing}
instance Core.FromJSON AdditionalPodNetworkConfig where
        parseJSON
          = Core.withObject "AdditionalPodNetworkConfig"
              (\ o ->
                 AdditionalPodNetworkConfig Core.<$>
                   (o Core..:? "maxPodsPerNode") Core.<*>
                     (o Core..:? "networkAttachment")
...
newAdditionalPodRangesConfig 
    ::  AdditionalPodRangesConfig
newAdditionalPodRangesConfig
  = AdditionalPodRangesConfig{podRangeInfo = Core.Nothing,
                              podRangeNames = Core.Nothing}
instance Core.FromJSON AdditionalPodRangesConfig where
        parseJSON
          = Core.withObject "AdditionalPodRangesConfig"
              (\ o ->
                 AdditionalPodRangesConfig Core.<$>
                   (o Core..:? "podRangeInfo") Core.<*> (o Core..:? "podRangeNames"))
...
data AddonsConfig = AddonsConfig
    ...
    , highScaleCheckpointingConfig :: (Core.Maybe HighScaleCheckpointingConfig)
    ...
    , httpLoadBalancing :: (Core.Maybe HttpLoadBalancing)
      -- | Configuration for the Kubernetes Dashboard. This addon is deprecated, and will be disabled in 1.15. It is recommended to use the Cloud Console to manage and monitor your Kubernetes clusters, workloads and applications. For more information, see: https:\/\/{$universe.dns/names.final/documentation_domain}\/kubernetes-engine\/docs\/concepts\/dashboards
...
newAddonsConfig 
    ::  AddonsConfig
newAddonsConfig
  = AddonsConfig{cloudRunConfig = Core.Nothing,
                 ...
                 highScaleCheckpointingConfig = Core.Nothing,
                 ...
                 rayOperatorConfig = Core.Nothing, statefulHaConfig = Core.Nothing}
instance Core.FromJSON AddonsConfig where
        parseJSON
          = Core.withObject "AddonsConfig"
              (\ o ->
                 AddonsConfig Core.<$>
                   (o Core..:? "cloudRunConfig") Core.<*>
                     (o Core..:? "configConnectorConfig")
                     ...
                     Core.<*> (o Core..:? "highScaleCheckpointingConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("cloudRunConfig" Core..=) Core.<$> cloudRunConfig,
                  ...
                  ("gcePersistentDiskCsiDriverConfig" Core..=) Core.<$>
                    gcePersistentDiskCsiDriverConfig,
                  ("gcpFilestoreCsiDriverConfig" Core..=) Core.<$>
                    gcpFilestoreCsiDriverConfig,
                  ("gcsFuseCsiDriverConfig" Core..=) Core.<$> gcsFuseCsiDriverConfig,
                  ("gkeBackupAgentConfig" Core..=) Core.<$> gkeBackupAgentConfig,
                  ("highScaleCheckpointingConfig" Core..=) Core.<$>
                    highScaleCheckpointingConfig,
                  ("horizontalPodAutoscaling" Core..=) Core.<$>
                    horizontalPodAutoscaling,
                  ...
                  ("parallelstoreCsiDriverConfig" Core..=) Core.<$>
                    parallelstoreCsiDriverConfig,
...
newAdvancedDatapathObservabilityConfig 
    :: 
                                       AdvancedDatapathObservabilityConfig
newAdvancedDatapathObservabilityConfig
  = AdvancedDatapathObservabilityConfig{enableMetrics = Core.Nothing,
                                        enableRelay = Core.Nothing, relayMode = Core.Nothing}
instance Core.FromJSON AdvancedDatapathObservabilityConfig where
        parseJSON
          = Core.withObject "AdvancedDatapathObservabilityConfig"
              (\ o ->
                 AdvancedDatapathObservabilityConfig Core.<$>
                   (o Core..:? "enableMetrics") Core.<*> (o Core..:? "enableRelay")
...
data AdvancedMachineFeatures = AdvancedMachineFeatures
    ...
    , performanceMonitoringUnit :: (Core.Maybe AdvancedMachineFeatures_PerformanceMonitoringUnit)
...
newAdvancedMachineFeatures
  = AdvancedMachineFeatures{enableNestedVirtualization =
                              Core.Nothing,
                            performanceMonitoringUnit = Core.Nothing,
                            threadsPerCore = Core.Nothing}
instance Core.FromJSON AdvancedMachineFeatures where
        parseJSON
          = Core.withObject "AdvancedMachineFeatures"
              (\ o ->
                 AdvancedMachineFeatures Core.<$>
                   (o Core..:? "enableNestedVirtualization") Core.<*>
                     (o Core..:? "performanceMonitoringUnit")
                     Core.<*>
                     (o Core..:? "threadsPerCore" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON AdvancedMachineFeatures where
        toJSON AdvancedMachineFeatures{..}
          = Core.object
              (Core.catMaybes
                 [("enableNestedVirtualization" Core..=) Core.<$>
                    enableNestedVirtualization,
                  ("performanceMonitoringUnit" Core..=) Core.<$>
                    performanceMonitoringUnit,
                  ("threadsPerCore" Core..=) Core.. Core.AsText Core.<$>
                    threadsPerCore])


-- | AnonymousAuthenticationConfig defines the settings needed to limit endpoints that allow anonymous authentication.
--
-- /See:/ 'newAnonymousAuthenticationConfig' smart constructor.
newtype AnonymousAuthenticationConfig = AnonymousAuthenticationConfig
    {
      -- | Defines the mode of limiting anonymous access in the cluster.
      mode :: (Core.Maybe AnonymousAuthenticationConfig_Mode)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AnonymousAuthenticationConfig' with the minimum fields required to make a request.
newAnonymousAuthenticationConfig 
    ::  AnonymousAuthenticationConfig
newAnonymousAuthenticationConfig
  = AnonymousAuthenticationConfig{mode = Core.Nothing}
instance Core.FromJSON AnonymousAuthenticationConfig where
        parseJSON
          = Core.withObject "AnonymousAuthenticationConfig"
              (\ o -> AnonymousAuthenticationConfig Core.<$> (o Core..:? "mode"))

instance Core.ToJSON AnonymousAuthenticationConfig where
        toJSON AnonymousAuthenticationConfig{..}
...
newAuthenticatorGroupsConfig 
    ::  AuthenticatorGroupsConfig
newAuthenticatorGroupsConfig
  = AuthenticatorGroupsConfig{enabled = Core.Nothing,
                              securityGroup = Core.Nothing}
instance Core.FromJSON AuthenticatorGroupsConfig where
        parseJSON
          = Core.withObject "AuthenticatorGroupsConfig"
              (\ o ->
                 AuthenticatorGroupsConfig Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "securityGroup"))
...
--
-- /See:/ 'newAutoIpamConfig' smart constructor.
data AutoIpamConfig = AutoIpamConfig
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AutoIpamConfig' with the minimum fields required to make a request.
newAutoIpamConfig 
    ::  AutoIpamConfig
newAutoIpamConfig = AutoIpamConfig
instance Core.FromJSON AutoIpamConfig where
        parseJSON
          = Core.withObject "AutoIpamConfig"
              (\ o -> Core.pure AutoIpamConfig)

instance Core.ToJSON AutoIpamConfig where
...
instance Core.FromJSON AutoMonitoringConfig where
        parseJSON
          = Core.withObject "AutoMonitoringConfig"
...
newAutoUpgradeOptions 
    ::  AutoUpgradeOptions
newAutoUpgradeOptions
  = AutoUpgradeOptions{autoUpgradeStartTime = Core.Nothing,
                       description = Core.Nothing}
instance Core.FromJSON AutoUpgradeOptions where
        parseJSON
          = Core.withObject "AutoUpgradeOptions"
              (\ o ->
                 AutoUpgradeOptions Core.<$>
                   (o Core..:? "autoUpgradeStartTime") Core.<*>
                     (o Core..:? "description"))
...
newAutopilot 
    ::  Autopilot
newAutopilot
  = Autopilot{enabled = Core.Nothing,
              workloadPolicyConfig = Core.Nothing}
instance Core.FromJSON Autopilot where
        parseJSON
          = Core.withObject "Autopilot"
              (\ o ->
                 Autopilot Core.<$>
                   (o Core..:? "enabled") Core.<*>
                     (o Core..:? "workloadPolicyConfig"))
...
newAutopilotCompatibilityIssue 
    ::  AutopilotCompatibilityIssue
newAutopilotCompatibilityIssue
  = AutopilotCompatibilityIssue{constraintType = Core.Nothing,
                                description = Core.Nothing, documentationUrl = Core.Nothing,
                                incompatibilityType = Core.Nothing, lastObservation = Core.Nothing,
                                subjects = Core.Nothing}
instance Core.FromJSON AutopilotCompatibilityIssue where
        parseJSON
          = Core.withObject "AutopilotCompatibilityIssue"
              (\ o ->
                 AutopilotCompatibilityIssue Core.<$>
                   (o Core..:? "constraintType") Core.<*> (o Core..:? "description")
...
instance Core.FromJSON AutopilotConfig where
        parseJSON
          = Core.withObject "AutopilotConfig"
...
data AutoprovisioningNodePoolDefaults = AutoprovisioningNodePoolDefaults
    {
      -- | The Customer Managed Encryption Key used to encrypt the boot disk attached to each node in the node pool. This should be of the form projects\/[KEY/PROJECT/ID]\/locations\/[LOCATION]\/keyRings\/[RING/NAME]\/cryptoKeys\/[KEY/NAME]. For more information about protecting resources with Cloud KMS Keys please see: https:\/\/{$universe.dns/names.final/documentation_domain}\/compute\/docs\/disks\/customer-managed-encryption
    ...
    , diskType :: (Core.Maybe Core.Text)
      -- | The image type to use for NAP created node. Please see https:\/\/{$universe.dns/names.final/documentation_domain}\/kubernetes-engine\/docs\/concepts\/node-images for available image types.
    ...
    , management :: (Core.Maybe NodeManagement)
      -- | Deprecated. Minimum CPU platform to be used for NAP created node pools. The instance may be scheduled on the specified or newer CPU platform. Applicable values are the friendly names of CPU platforms, such as minCpuPlatform: Intel Haswell or minCpuPlatform: Intel Sandy Bridge. For more information, read <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/instances/specify-min-cpu-platform how to specify min CPU platform>. This field is deprecated, min/cpu/platform should be specified using @cloud.google.com\/requested-min-cpu-platform@ label selector on the pod. To unset the min cpu platform field pass \"automatic\" as field value.
...
newAutoprovisioningNodePoolDefaults 
    :: 
                                    AutoprovisioningNodePoolDefaults
newAutoprovisioningNodePoolDefaults
  = AutoprovisioningNodePoolDefaults{bootDiskKmsKey = Core.Nothing,
                                     diskSizeGb = Core.Nothing, diskType = Core.Nothing,
                                     imageType = Core.Nothing,
                                     insecureKubeletReadonlyPortEnabled = Core.Nothing,
                                     management = Core.Nothing, minCpuPlatform = Core.Nothing,
                                     oauthScopes = Core.Nothing, serviceAccount = Core.Nothing,
...
instance Core.FromJSON AutoprovisioningNodePoolDefaults where
        parseJSON
          = Core.withObject "AutoprovisioningNodePoolDefaults"
              (\ o ->
                 AutoprovisioningNodePoolDefaults Core.<$>
                   (o Core..:? "bootDiskKmsKey") Core.<*> (o Core..:? "diskSizeGb")
          ...
          = Core.object
              (Core.catMaybes
                 [("bootDiskKmsKey" Core..=) Core.<$> bootDiskKmsKey,
                  ...
                  ("insecureKubeletReadonlyPortEnabled" Core..=) Core.<$>
...
newBestEffortProvisioning 
    ::  BestEffortProvisioning
newBestEffortProvisioning
  = BestEffortProvisioning{enabled = Core.Nothing,
                           minProvisionNodes = Core.Nothing}
instance Core.FromJSON BestEffortProvisioning where
        parseJSON
          = Core.withObject "BestEffortProvisioning"
              (\ o ->
                 BestEffortProvisioning Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "minProvisionNodes"))
...
instance Core.FromJSON BigQueryDestination where
        parseJSON
          = Core.withObject "BigQueryDestination"
...
newBinaryAuthorization 
    ::  BinaryAuthorization
newBinaryAuthorization
  = BinaryAuthorization{enabled = Core.Nothing,
                        evaluationMode = Core.Nothing}
instance Core.FromJSON BinaryAuthorization where
        parseJSON
          = Core.withObject "BinaryAuthorization"
              (\ o ->
                 BinaryAuthorization Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "evaluationMode"))
...
newBlueGreenInfo 
    ::  BlueGreenInfo
newBlueGreenInfo
  = BlueGreenInfo{blueInstanceGroupUrls = Core.Nothing,
                  bluePoolDeletionStartTime = Core.Nothing,
                  greenInstanceGroupUrls = Core.Nothing,
                  greenPoolVersion = Core.Nothing, phase = Core.Nothing}
instance Core.FromJSON BlueGreenInfo where
        parseJSON
          = Core.withObject "BlueGreenInfo"
              (\ o ->
                 BlueGreenInfo Core.<$>
                   (o Core..:? "blueInstanceGroupUrls") Core.<*>
                     (o Core..:? "bluePoolDeletionStartTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("blueInstanceGroupUrls" Core..=) Core.<$> blueInstanceGroupUrls,
                  ("bluePoolDeletionStartTime" Core..=) Core.<$>
...
newBlueGreenSettings 
    ::  BlueGreenSettings
newBlueGreenSettings
  = BlueGreenSettings{nodePoolSoakDuration = Core.Nothing,
                      standardRolloutPolicy = Core.Nothing}
instance Core.FromJSON BlueGreenSettings where
        parseJSON
          = Core.withObject "BlueGreenSettings"
              (\ o ->
                 BlueGreenSettings Core.<$>
                   (o Core..:? "nodePoolSoakDuration") Core.<*>
                     (o Core..:? "standardRolloutPolicy"))
...
data CancelOperationRequest = CancelOperationRequest
    ...
    , operationId :: (Core.Maybe Core.Text)
      -- | Deprecated. The Google Developers Console <https://%7B$universe.dns_names.final_documentation_domain%7D/resource-manager/docs/creating-managing-projects project ID or project number>. This field has been deprecated and replaced by the name field.
    , projectId :: (Core.Maybe Core.Text)
      -- | Deprecated. The name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zone> in which the operation resides. This field has been deprecated and replaced by the name field.
...
newCancelOperationRequest 
    ::  CancelOperationRequest
newCancelOperationRequest
  = CancelOperationRequest{name = Core.Nothing,
                           operationId = Core.Nothing, projectId = Core.Nothing,
                           zone = Core.Nothing}
instance Core.FromJSON CancelOperationRequest where
        parseJSON
          = Core.withObject "CancelOperationRequest"
              (\ o ->
                 CancelOperationRequest Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "operationId") Core.<*>
                     (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
          ...
          = Core.object
              (Core.catMaybes
                 [("fqdns" Core..=) Core.<$> fqdns,
                  ("gcpSecretManagerCertificateConfig" Core..=) Core.<$>
                    gcpSecretManagerCertificateConfig])
...
newCheckAutopilotCompatibilityResponse 
    :: 
                                       CheckAutopilotCompatibilityResponse
newCheckAutopilotCompatibilityResponse
  = CheckAutopilotCompatibilityResponse{issues = Core.Nothing,
                                        summary = Core.Nothing}
instance Core.FromJSON CheckAutopilotCompatibilityResponse where
        parseJSON
          = Core.withObject "CheckAutopilotCompatibilityResponse"
              (\ o ->
                 CheckAutopilotCompatibilityResponse Core.<$>
                   (o Core..:? "issues") Core.<*> (o Core..:? "summary"))
...
instance Core.FromJSON CidrBlock where
        parseJSON
          = Core.withObject "CidrBlock"
              (\ o ->
                 CidrBlock Core.<$>
                   (o Core..:? "cidrBlock") Core.<*> (o Core..:? "displayName"))
...
newCloudRunConfig 
    ::  CloudRunConfig
newCloudRunConfig
  = CloudRunConfig{disabled = Core.Nothing,
                   loadBalancerType = Core.Nothing}
instance Core.FromJSON CloudRunConfig where
        parseJSON
          = Core.withObject "CloudRunConfig"
              (\ o ->
                 CloudRunConfig Core.<$>
                   (o Core..:? "disabled") Core.<*> (o Core..:? "loadBalancerType"))
...
data Cluster = Cluster
    ...
    , alphaClusterFeatureGates :: (Core.Maybe [Core.Text])
      -- | Configuration for limiting anonymous access to all endpoints except the health checks.
    , anonymousAuthenticationConfig :: (Core.Maybe AnonymousAuthenticationConfig)
    ...
    , currentNodeCount :: (Core.Maybe Core.Int32)
      -- | Output only. Deprecated, use <https://%7B$universe.dns_names.final_documentation_domain%7D/kubernetes-engine/docs/reference/rest/v1/projects.locations.clusters.nodePools NodePools.version> instead. The current version of the node software components. If they are currently at multiple versions because they\'re in the process of being upgraded, this reflects the minimum version of all nodes.
    ...
    , gkeAutoUpgradeConfig :: (Core.Maybe GkeAutoUpgradeConfig)
    ...
    , legacyAbac :: (Core.Maybe LegacyAbac)
      -- | Output only. The name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/regions-zones/regions-zones#available zone> or <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/regions-zones/regions-zones#available region> in which the cluster resides.
    , location :: (Core.Maybe Core.Text)
      -- | The list of Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zones> in which the cluster\'s nodes should be located. This field provides a default value if <https://%7B$universe.dns_names.final_documentation_domain%7D/kubernetes-engine/docs/reference/rest/v1/projects.locations.clusters.nodePools#NodePool.FIELDS.locations NodePool.Locations> are not specified during node pool creation. Warning: changing cluster locations will update the <https://%7B$universe.dns_names.final_documentation_domain%7D/kubernetes-engine/docs/reference/rest/v1/projects.locations.clusters.nodePools#NodePool.FIELDS.locations NodePool.Locations> of all node pools and will result in nodes being added and\/or removed.
    ...
    , name :: (Core.Maybe Core.Text)
      -- | The name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/networks-and-firewalls#networks network> to which the cluster is connected. If left unspecified, the @default@ network will be used.
    , network :: (Core.Maybe Core.Text)
    ...
    , podAutoscaling :: (Core.Maybe PodAutoscaling)
    ...
    , statusMessage :: (Core.Maybe Core.Text)
      -- | The name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/subnetworks subnetwork> to which the cluster is connected.
    , subnetwork :: (Core.Maybe Core.Text)
    ...
    , workloadIdentityConfig :: (Core.Maybe WorkloadIdentityConfig)
      -- | Output only. The name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zone> in which the cluster resides. This field is deprecated, use location instead.
    , zone :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newCluster 
    ::  Cluster
newCluster
  = Cluster{addonsConfig = Core.Nothing,
            alphaClusterFeatureGates = Core.Nothing,
            anonymousAuthenticationConfig = Core.Nothing,
            authenticatorGroupsConfig = Core.Nothing, autopilot = Core.Nothing,
            autoscaling = Core.Nothing, binaryAuthorization = Core.Nothing,
            clusterIpv4Cidr = Core.Nothing,
            compliancePostureConfig = Core.Nothing, conditions = Core.Nothing,
            confidentialNodes = Core.Nothing,
            controlPlaneEndpointsConfig = Core.Nothing,
            costManagementConfig = Core.Nothing, createTime = Core.Nothing,
            currentMasterVersion = Core.Nothing,
            currentNodeCount = Core.Nothing, currentNodeVersion = Core.Nothing,
            databaseEncryption = Core.Nothing,
            defaultMaxPodsConstraint = Core.Nothing,
            description = Core.Nothing, enableK8sBetaApis = Core.Nothing,
            enableKubernetesAlpha = Core.Nothing, enableTpu = Core.Nothing,
            endpoint = Core.Nothing, enterpriseConfig = Core.Nothing,
            etag = Core.Nothing, expireTime = Core.Nothing,
            fleet = Core.Nothing, gkeAutoUpgradeConfig = Core.Nothing,
            id = Core.Nothing, identityServiceConfig = Core.Nothing,
            initialClusterVersion = Core.Nothing,
            initialNodeCount = Core.Nothing, instanceGroupUrls = Core.Nothing,
            ipAllocationPolicy = Core.Nothing, labelFingerprint = Core.Nothing,
            legacyAbac = Core.Nothing, location = Core.Nothing,
            locations = Core.Nothing, loggingConfig = Core.Nothing,
            loggingService = Core.Nothing, maintenancePolicy = Core.Nothing,
            masterAuth = Core.Nothing,
            masterAuthorizedNetworksConfig = Core.Nothing,
            meshCertificates = Core.Nothing, monitoringConfig = Core.Nothing,
            monitoringService = Core.Nothing, name = Core.Nothing,
            network = Core.Nothing, networkConfig = Core.Nothing,
            networkPolicy = Core.Nothing, nodeConfig = Core.Nothing,
            nodeIpv4CidrSize = Core.Nothing, nodePoolAutoConfig = Core.Nothing,
            nodePoolDefaults = Core.Nothing, nodePools = Core.Nothing,
            notificationConfig = Core.Nothing,
            parentProductConfig = Core.Nothing, podAutoscaling = Core.Nothing,
            privateClusterConfig = Core.Nothing,
            rbacBindingConfig = Core.Nothing, releaseChannel = Core.Nothing,
            resourceLabels = Core.Nothing,
            resourceUsageExportConfig = Core.Nothing,
            satisfiesPzi = Core.Nothing, satisfiesPzs = Core.Nothing,
            secretManagerConfig = Core.Nothing,
            securityPostureConfig = Core.Nothing, selfLink = Core.Nothing,
            servicesIpv4Cidr = Core.Nothing, shieldedNodes = Core.Nothing,
            status = Core.Nothing, statusMessage = Core.Nothing,
            subnetwork = Core.Nothing, tpuIpv4CidrBlock = Core.Nothing,
            userManagedKeysConfig = Core.Nothing,
            verticalPodAutoscaling = Core.Nothing,
            workloadIdentityConfig = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON Cluster where
        parseJSON
          = Core.withObject "Cluster"
              (\ o ->
                 Cluster Core.<$>
                   (o Core..:? "addonsConfig") Core.<*>
                     (o Core..:? "alphaClusterFeatureGates")
                     Core.<*> (o Core..:? "anonymousAuthenticationConfig")
                     ...
                     Core.<*> (o Core..:? "fleet")
                     Core.<*> (o Core..:? "gkeAutoUpgradeConfig")
                     Core.<*> (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("addonsConfig" Core..=) Core.<$> addonsConfig,
                  ("alphaClusterFeatureGates" Core..=) Core.<$>
                    alphaClusterFeatureGates,
                  ("anonymousAuthenticationConfig" Core..=) Core.<$>
                    anonymousAuthenticationConfig,
                  ("authenticatorGroupsConfig" Core..=) Core.<$>
                    authenticatorGroupsConfig,
                  ...
                  ("defaultMaxPodsConstraint" Core..=) Core.<$>
                  ...
                  ("gkeAutoUpgradeConfig" Core..=) Core.<$> gkeAutoUpgradeConfig,
                  ("id" Core..=) Core.<$> id,
                  ...
                  ("masterAuthorizedNetworksConfig" Core..=) Core.<$>
                    masterAuthorizedNetworksConfig,
                  ...
                  ("podAutoscaling" Core..=) Core.<$> podAutoscaling,
                  ...
                  ("resourceUsageExportConfig" Core..=) Core.<$>
                    resourceUsageExportConfig,
...
instance Core.FromJSON Cluster_ResourceLabels where
        parseJSON
          = Core.withObject "Cluster_ResourceLabels"
...
data ClusterAutoscaling = ClusterAutoscaling
    {
      -- | The list of Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zones> in which the NodePool\'s nodes can be created by NAP.
...
newClusterAutoscaling 
    ::  ClusterAutoscaling
newClusterAutoscaling
  = ClusterAutoscaling{autoprovisioningLocations = Core.Nothing,
...
instance Core.FromJSON ClusterAutoscaling where
        parseJSON
          = Core.withObject "ClusterAutoscaling"
              (\ o ->
                 ClusterAutoscaling Core.<$>
                   (o Core..:? "autoprovisioningLocations") Core.<*>
                     (o Core..:? "autoprovisioningNodePoolDefaults")
...
instance Core.ToJSON ClusterAutoscaling where
        toJSON ClusterAutoscaling{..}
          = Core.object
              (Core.catMaybes
                 [("autoprovisioningLocations" Core..=) Core.<$>
                    autoprovisioningLocations,
                  ("autoprovisioningNodePoolDefaults" Core..=) Core.<$>
                    autoprovisioningNodePoolDefaults,
                  ("autoscalingProfile" Core..=) Core.<$> autoscalingProfile,
                  ("enableNodeAutoprovisioning" Core..=) Core.<$>
...
newtype ClusterNetworkPerformanceConfig = ClusterNetworkPerformanceConfig
    {
      ...
      totalEgressBandwidthTier :: (Core.Maybe
...
instance Core.FromJSON ClusterNetworkPerformanceConfig where
        parseJSON
          = Core.withObject "ClusterNetworkPerformanceConfig"
              (\ o ->
                 ClusterNetworkPerformanceConfig Core.<$>
                   (o Core..:? "totalEgressBandwidthTier"))

instance Core.ToJSON ClusterNetworkPerformanceConfig where
        toJSON ClusterNetworkPerformanceConfig{..}
          = Core.object
              (Core.catMaybes
                 [("totalEgressBandwidthTier" Core..=) Core.<$>
...
data ClusterUpdate = ClusterUpdate
    ...
    , desiredAdditionalIpRangesConfig :: (Core.Maybe DesiredAdditionalIPRangesConfig)
      -- | Configurations for the various addons available to run in the cluster.
    , desiredAddonsConfig :: (Core.Maybe AddonsConfig)
      -- | Configuration for limiting anonymous access to all endpoints except the health checks.
    , desiredAnonymousAuthenticationConfig :: (Core.Maybe AnonymousAuthenticationConfig)
      -- | The desired authenticator groups config for the cluster.
    , desiredAuthenticatorGroupsConfig :: (Core.Maybe AuthenticatorGroupsConfig)
      -- | AutoIpamConfig contains all information related to Auto IPAM
    , desiredAutoIpamConfig :: (Core.Maybe AutoIpamConfig)
      -- | WorkloadPolicyConfig is the configuration related to GCW workload policy
    ...
    , desiredL4ilbSubsettingConfig :: (Core.Maybe ILBSubsettingConfig)
      -- | The desired list of Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zones> in which the cluster\'s nodes should be located. This list must always include the cluster\'s primary zone. Warning: changing cluster locations will update the locations of all node pools and will result in nodes being added and\/or removed.
    ...
    , desiredPodAutoscaling :: (Core.Maybe PodAutoscaling)
    ...
    , desiredUserManagedKeysConfig :: (Core.Maybe UserManagedKeysConfig)
      -- | Cluster-level Vertical Pod Autoscaling configuration.
    ...
    , removedAdditionalPodRangesConfig :: (Core.Maybe AdditionalPodRangesConfig)
      -- | The Custom keys configuration for the cluster. This field is deprecated. Use ClusterUpdate.desired/user/managed/keys/config instead.
    , userManagedKeysConfig :: (Core.Maybe UserManagedKeysConfig)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newClusterUpdate 
    ::  ClusterUpdate
newClusterUpdate
  = ClusterUpdate{additionalPodRangesConfig = Core.Nothing,
                  desiredAdditionalIpRangesConfig = Core.Nothing,
                  desiredAddonsConfig = Core.Nothing,
                  desiredAnonymousAuthenticationConfig = Core.Nothing,
                  desiredAuthenticatorGroupsConfig = Core.Nothing,
                  desiredAutoIpamConfig = Core.Nothing,
                  ...
                  desiredPodAutoscaling = Core.Nothing,
                  ...
                  desiredUserManagedKeysConfig = Core.Nothing,
                  desiredVerticalPodAutoscaling = Core.Nothing,
                  desiredWorkloadIdentityConfig = Core.Nothing,
                  enableK8sBetaApis = Core.Nothing, etag = Core.Nothing,
                  gkeAutoUpgradeConfig = Core.Nothing,
                  removedAdditionalPodRangesConfig = Core.Nothing,
                  userManagedKeysConfig = Core.Nothing}
instance Core.FromJSON ClusterUpdate where
        parseJSON
          = Core.withObject "ClusterUpdate"
              (\ o ->
                 ClusterUpdate Core.<$>
                   (o Core..:? "additionalPodRangesConfig") Core.<*>
                     (o Core..:? "desiredAdditionalIpRangesConfig")
                     Core.<*> (o Core..:? "desiredAddonsConfig")
                     Core.<*> (o Core..:? "desiredAnonymousAuthenticationConfig")
                     Core.<*> (o Core..:? "desiredAuthenticatorGroupsConfig")
                     Core.<*> (o Core..:? "desiredAutoIpamConfig")
                     ...
                     Core.<*>
                     (o Core..:? "desiredNodePoolAutoConfigResourceManagerTags")
                     ...
                     Core.<*> (o Core..:? "desiredPodAutoscaling")
                     ...
                     Core.<*> (o Core..:? "desiredUserManagedKeysConfig")
...
instance Core.ToJSON ClusterUpdate where
        toJSON ClusterUpdate{..}
          = Core.object
              (Core.catMaybes
                 [("additionalPodRangesConfig" Core..=) Core.<$>
                    additionalPodRangesConfig,
                  ("desiredAdditionalIpRangesConfig" Core..=) Core.<$>
                    desiredAdditionalIpRangesConfig,
                  ("desiredAddonsConfig" Core..=) Core.<$> desiredAddonsConfig,
                  ("desiredAnonymousAuthenticationConfig" Core..=) Core.<$>
                    desiredAnonymousAuthenticationConfig,
                  ("desiredAuthenticatorGroupsConfig" Core..=) Core.<$>
                    desiredAuthenticatorGroupsConfig,
                  ("desiredAutoIpamConfig" Core..=) Core.<$> desiredAutoIpamConfig,
                  ("desiredAutopilotWorkloadPolicyConfig" Core..=) Core.<$>
                    desiredAutopilotWorkloadPolicyConfig,
                  ("desiredBinaryAuthorization" Core..=) Core.<$>
                    desiredBinaryAuthorization,
                  ("desiredClusterAutoscaling" Core..=) Core.<$>
                    desiredClusterAutoscaling,
                  ("desiredCompliancePostureConfig" Core..=) Core.<$>
                    desiredCompliancePostureConfig,
                  ("desiredContainerdConfig" Core..=) Core.<$>
                    desiredContainerdConfig,
                  ("desiredControlPlaneEndpointsConfig" Core..=) Core.<$>
                    desiredControlPlaneEndpointsConfig,
                  ("desiredCostManagementConfig" Core..=) Core.<$>
                    desiredCostManagementConfig,
                  ("desiredDatabaseEncryption" Core..=) Core.<$>
                    desiredDatabaseEncryption,
                  ("desiredDatapathProvider" Core..=) Core.<$>
                    desiredDatapathProvider,
                  ("desiredDefaultEnablePrivateNodes" Core..=) Core.<$>
                    desiredDefaultEnablePrivateNodes,
                  ("desiredDefaultSnatStatus" Core..=) Core.<$>
                    desiredDefaultSnatStatus,
                  ("desiredDisableL4LbFirewallReconciliation" Core..=) Core.<$>
                    desiredDisableL4LbFirewallReconciliation,
                  ("desiredDnsConfig" Core..=) Core.<$> desiredDnsConfig,
                  ("desiredEnableCiliumClusterwideNetworkPolicy" Core..=) Core.<$>
                    desiredEnableCiliumClusterwideNetworkPolicy,
                  ("desiredEnableFqdnNetworkPolicy" Core..=) Core.<$>
                    desiredEnableFqdnNetworkPolicy,
                  ("desiredEnableMultiNetworking" Core..=) Core.<$>
                    desiredEnableMultiNetworking,
                  ("desiredEnablePrivateEndpoint" Core..=) Core.<$>
                    desiredEnablePrivateEndpoint,
                  ("desiredEnterpriseConfig" Core..=) Core.<$>
                    desiredEnterpriseConfig,
                  ("desiredFleet" Core..=) Core.<$> desiredFleet,
                  ("desiredGatewayApiConfig" Core..=) Core.<$>
                    desiredGatewayApiConfig,
                  ("desiredGcfsConfig" Core..=) Core.<$> desiredGcfsConfig,
                  ("desiredIdentityServiceConfig" Core..=) Core.<$>
                    desiredIdentityServiceConfig,
                  ("desiredImageType" Core..=) Core.<$> desiredImageType,
                  ("desiredInTransitEncryptionConfig" Core..=) Core.<$>
                    desiredInTransitEncryptionConfig,
                  ("desiredIntraNodeVisibilityConfig" Core..=) Core.<$>
                    desiredIntraNodeVisibilityConfig,
                  ("desiredK8sBetaApis" Core..=) Core.<$> desiredK8sBetaApis,
                  ("desiredL4ilbSubsettingConfig" Core..=) Core.<$>
                  ...
                  ("desiredMasterAuthorizedNetworksConfig" Core..=) Core.<$>
                    desiredMasterAuthorizedNetworksConfig,
                  ("desiredMasterVersion" Core..=) Core.<$> desiredMasterVersion,
                  ("desiredMeshCertificates" Core..=) Core.<$>
                    desiredMeshCertificates,
                  ("desiredMonitoringConfig" Core..=) Core.<$>
                    desiredMonitoringConfig,
                  ("desiredMonitoringService" Core..=) Core.<$>
                    desiredMonitoringService,
                  ("desiredNetworkPerformanceConfig" Core..=) Core.<$>
                    desiredNetworkPerformanceConfig,
                  ("desiredNodeKubeletConfig" Core..=) Core.<$>
                    desiredNodeKubeletConfig,
                  ("desiredNodePoolAutoConfigKubeletConfig" Core..=) Core.<$>
                    desiredNodePoolAutoConfigKubeletConfig,
                  ("desiredNodePoolAutoConfigLinuxNodeConfig" Core..=) Core.<$>
                    desiredNodePoolAutoConfigLinuxNodeConfig,
                  ("desiredNodePoolAutoConfigNetworkTags" Core..=) Core.<$>
                    desiredNodePoolAutoConfigNetworkTags,
                  ("desiredNodePoolAutoConfigResourceManagerTags" Core..=) Core.<$>
                    desiredNodePoolAutoConfigResourceManagerTags,
                  ("desiredNodePoolAutoscaling" Core..=) Core.<$>
                    desiredNodePoolAutoscaling,
                  ("desiredNodePoolId" Core..=) Core.<$> desiredNodePoolId,
                  ("desiredNodePoolLoggingConfig" Core..=) Core.<$>
                    desiredNodePoolLoggingConfig,
                  ("desiredNodeVersion" Core..=) Core.<$> desiredNodeVersion,
                  ("desiredNotificationConfig" Core..=) Core.<$>
                    desiredNotificationConfig,
                  ("desiredParentProductConfig" Core..=) Core.<$>
                    desiredParentProductConfig,
                  ("desiredPodAutoscaling" Core..=) Core.<$> desiredPodAutoscaling,
                  ("desiredPrivateClusterConfig" Core..=) Core.<$>
                    desiredPrivateClusterConfig,
                  ("desiredPrivateIpv6GoogleAccess" Core..=) Core.<$>
                    desiredPrivateIpv6GoogleAccess,
                  ("desiredRbacBindingConfig" Core..=) Core.<$>
                    desiredRbacBindingConfig,
                  ("desiredReleaseChannel" Core..=) Core.<$> desiredReleaseChannel,
                  ("desiredResourceUsageExportConfig" Core..=) Core.<$>
                    desiredResourceUsageExportConfig,
                  ("desiredSecretManagerConfig" Core..=) Core.<$>
                    desiredSecretManagerConfig,
                  ("desiredSecurityPostureConfig" Core..=) Core.<$>
                    desiredSecurityPostureConfig,
                  ("desiredServiceExternalIpsConfig" Core..=) Core.<$>
                    desiredServiceExternalIpsConfig,
                  ("desiredShieldedNodes" Core..=) Core.<$> desiredShieldedNodes,
                  ("desiredStackType" Core..=) Core.<$> desiredStackType,
                  ("desiredUserManagedKeysConfig" Core..=) Core.<$>
                    desiredUserManagedKeysConfig,
                  ("desiredVerticalPodAutoscaling" Core..=) Core.<$>
                    desiredVerticalPodAutoscaling,
                  ("desiredWorkloadIdentityConfig" Core..=) Core.<$>
                    desiredWorkloadIdentityConfig,
                  ("enableK8sBetaApis" Core..=) Core.<$> enableK8sBetaApis,
                  ("etag" Core..=) Core.<$> etag,
                  ("gkeAutoUpgradeConfig" Core..=) Core.<$> gkeAutoUpgradeConfig,
                  ("removedAdditionalPodRangesConfig" Core..=) Core.<$>
...
--
-- /See:/ 'newClusterUpgradeInfo' smart constructor.
data ClusterUpgradeInfo = ClusterUpgradeInfo
    {
      -- | The auto upgrade status.
      autoUpgradeStatus :: (Core.Maybe [ClusterUpgradeInfo_AutoUpgradeStatusItem])
      -- | The cluster\'s current minor version\'s end of extended support timestamp.
    , endOfExtendedSupportTimestamp :: (Core.Maybe Core.Text)
      -- | The cluster\'s current minor version\'s end of standard support timestamp.
    , endOfStandardSupportTimestamp :: (Core.Maybe Core.Text)
      -- | minor/target/version indicates the target version for minor upgrade.
    , minorTargetVersion :: (Core.Maybe Core.Text)
      -- | patch/target/version indicates the target version for patch upgrade.
    , patchTargetVersion :: (Core.Maybe Core.Text)
      -- | The auto upgrade paused reason.
    , pausedReason :: (Core.Maybe [ClusterUpgradeInfo_PausedReasonItem])
      -- | The list of past auto upgrades.
    , upgradeDetails :: (Core.Maybe [UpgradeDetails])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ClusterUpgradeInfo' with the minimum fields required to make a request.
newClusterUpgradeInfo 
    ::  ClusterUpgradeInfo
newClusterUpgradeInfo
  = ClusterUpgradeInfo{autoUpgradeStatus = Core.Nothing,
                       endOfExtendedSupportTimestamp = Core.Nothing,
                       endOfStandardSupportTimestamp = Core.Nothing,
                       minorTargetVersion = Core.Nothing,
                       patchTargetVersion = Core.Nothing, pausedReason = Core.Nothing,
                       upgradeDetails = Core.Nothing}
instance Core.FromJSON ClusterUpgradeInfo where
        parseJSON
          = Core.withObject "ClusterUpgradeInfo"
              (\ o ->
                 ClusterUpgradeInfo Core.<$>
                   (o Core..:? "autoUpgradeStatus") Core.<*>
                     (o Core..:? "endOfExtendedSupportTimestamp")
                     Core.<*> (o Core..:? "endOfStandardSupportTimestamp")
                     Core.<*> (o Core..:? "minorTargetVersion")
                     Core.<*> (o Core..:? "patchTargetVersion")
                     Core.<*> (o Core..:? "pausedReason")
                     Core.<*> (o Core..:? "upgradeDetails"))

instance Core.ToJSON ClusterUpgradeInfo where
        toJSON ClusterUpgradeInfo{..}
          = Core.object
              (Core.catMaybes
                 [("autoUpgradeStatus" Core..=) Core.<$> autoUpgradeStatus,
                  ("endOfExtendedSupportTimestamp" Core..=) Core.<$>
                    endOfExtendedSupportTimestamp,
                  ("endOfStandardSupportTimestamp" Core..=) Core.<$>
                    endOfStandardSupportTimestamp,
                  ("minorTargetVersion" Core..=) Core.<$> minorTargetVersion,
                  ("patchTargetVersion" Core..=) Core.<$> patchTargetVersion,
                  ("pausedReason" Core..=) Core.<$> pausedReason,
                  ("upgradeDetails" Core..=) Core.<$> upgradeDetails])
...
data CompleteIPRotationRequest = CompleteIPRotationRequest
    ...
    , name :: (Core.Maybe Core.Text)
      -- | Deprecated. The Google Developers Console <https://%7B$universe.dns_names.final_documentation_domain%7D/resource-manager/docs/creating-managing-projects project ID or project number>. This field has been deprecated and replaced by the name field.
    , projectId :: (Core.Maybe Core.Text)
      -- | Deprecated. The name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zone> in which the cluster resides. This field has been deprecated and replaced by the name field.
    , zone :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newCompleteIPRotationRequest 
    ::  CompleteIPRotationRequest
newCompleteIPRotationRequest
  = CompleteIPRotationRequest{clusterId = Core.Nothing,
                              name = Core.Nothing, projectId = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON CompleteIPRotationRequest where
        parseJSON
          = Core.withObject "CompleteIPRotationRequest"
              (\ o ->
                 CompleteIPRotationRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
instance Core.FromJSON CompleteNodePoolUpgradeRequest where
        parseJSON
          = Core.withObject "CompleteNodePoolUpgradeRequest"
...
newCompliancePostureConfig 
    ::  CompliancePostureConfig
newCompliancePostureConfig
  = CompliancePostureConfig{complianceStandards = Core.Nothing,
                            mode = Core.Nothing}
instance Core.FromJSON CompliancePostureConfig where
        parseJSON
          = Core.withObject "CompliancePostureConfig"
              (\ o ->
                 CompliancePostureConfig Core.<$>
                   (o Core..:? "complianceStandards") Core.<*> (o Core..:? "mode"))
...
instance Core.FromJSON ComplianceStandard where
        parseJSON
          = Core.withObject "ComplianceStandard"
...
data ConfidentialNodes = ConfidentialNodes
    {
      -- | Defines the type of technology used by the confidential node.
      confidentialInstanceType :: (Core.Maybe ConfidentialNodes_ConfidentialInstanceType)
...
newConfidentialNodes 
    ::  ConfidentialNodes
newConfidentialNodes
  = ConfidentialNodes{confidentialInstanceType = Core.Nothing,
                      enabled = Core.Nothing}
instance Core.FromJSON ConfidentialNodes where
        parseJSON
          = Core.withObject "ConfidentialNodes"
              (\ o ->
                 ConfidentialNodes Core.<$>
                   (o Core..:? "confidentialInstanceType") Core.<*>
                     (o Core..:? "enabled"))
...
instance Core.ToJSON ConfidentialNodes where
        toJSON ConfidentialNodes{..}
          = Core.object
              (Core.catMaybes
                 [("confidentialInstanceType" Core..=) Core.<$>
...
instance Core.FromJSON ConfigConnectorConfig where
        parseJSON
          = Core.withObject "ConfigConnectorConfig"
...
instance Core.FromJSON ConsumptionMeteringConfig where
        parseJSON
          = Core.withObject "ConsumptionMeteringConfig"
...
instance Core.FromJSON ContainerdConfig where
        parseJSON
          = Core.withObject "ContainerdConfig"
              (\ o ->
                 ContainerdConfig Core.<$>
                   (o Core..:? "privateRegistryAccessConfig"))

instance Core.ToJSON ContainerdConfig where
        toJSON ContainerdConfig{..}
          = Core.object
              (Core.catMaybes
                 [("privateRegistryAccessConfig" Core..=) Core.<$>
                    privateRegistryAccessConfig])
...
newControlPlaneEndpointsConfig 
    ::  ControlPlaneEndpointsConfig
newControlPlaneEndpointsConfig
  = ControlPlaneEndpointsConfig{dnsEndpointConfig = Core.Nothing,
                                ipEndpointsConfig = Core.Nothing}
instance Core.FromJSON ControlPlaneEndpointsConfig where
        parseJSON
          = Core.withObject "ControlPlaneEndpointsConfig"
              (\ o ->
                 ControlPlaneEndpointsConfig Core.<$>
                   (o Core..:? "dnsEndpointConfig") Core.<*>
                     (o Core..:? "ipEndpointsConfig"))
...
instance Core.FromJSON CostManagementConfig where
        parseJSON
          = Core.withObject "CostManagementConfig"
...
data CreateClusterRequest = CreateClusterRequest
    {
      -- | Required. A <https://%7B$universe.dns_names.final_documentation_domain%7D/container-engine/reference/rest/v1/projects.locations.clusters cluster resource>
      cluster :: (Core.Maybe Cluster)
      -- | The parent (project and location) where the cluster will be created. Specified in the format @projects\/*\/locations\/*@.
    , parent :: (Core.Maybe Core.Text)
      -- | Deprecated. The Google Developers Console <https://%7B$universe.dns_names.final_documentation_domain%7D/resource-manager/docs/creating-managing-projects project ID or project number>. This field has been deprecated and replaced by the parent field.
    , projectId :: (Core.Maybe Core.Text)
      -- | Deprecated. The name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zone> in which the cluster resides. This field has been deprecated and replaced by the parent field.
    , zone :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newCreateClusterRequest 
    ::  CreateClusterRequest
newCreateClusterRequest
  = CreateClusterRequest{cluster = Core.Nothing,
                         parent = Core.Nothing, projectId = Core.Nothing,
                         zone = Core.Nothing}
          ...
          = Core.withObject "CreateClusterRequest"
              (\ o ->
                 CreateClusterRequest Core.<$>
                   (o Core..:? "cluster") Core.<*> (o Core..:? "parent") Core.<*>
                     (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
newCreateNodePoolRequest 
    ::  CreateNodePoolRequest
newCreateNodePoolRequest
  = CreateNodePoolRequest{clusterId = Core.Nothing,
                          nodePool = Core.Nothing, parent = Core.Nothing,
                          projectId = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON CreateNodePoolRequest where
        parseJSON
          = Core.withObject "CreateNodePoolRequest"
              (\ o ->
                 CreateNodePoolRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "nodePool") Core.<*>
                     (o Core..:? "parent")
...
newDNSConfig 
    ::  DNSConfig
newDNSConfig
  = DNSConfig{additiveVpcScopeDnsDomain = Core.Nothing,
              clusterDns = Core.Nothing, clusterDnsDomain = Core.Nothing,
              clusterDnsScope = Core.Nothing}
instance Core.FromJSON DNSConfig where
        parseJSON
          = Core.withObject "DNSConfig"
              (\ o ->
                 DNSConfig Core.<$>
                   (o Core..:? "additiveVpcScopeDnsDomain") Core.<*>
                     (o Core..:? "clusterDns")
...
instance Core.ToJSON DNSConfig where
        toJSON DNSConfig{..}
          = Core.object
              (Core.catMaybes
                 [("additiveVpcScopeDnsDomain" Core..=) Core.<$>
...
newDNSEndpointConfig 
    ::  DNSEndpointConfig
newDNSEndpointConfig
  = DNSEndpointConfig{allowExternalTraffic = Core.Nothing,
                      endpoint = Core.Nothing}
instance Core.FromJSON DNSEndpointConfig where
        parseJSON
          = Core.withObject "DNSEndpointConfig"
              (\ o ->
                 DNSEndpointConfig Core.<$>
                   (o Core..:? "allowExternalTraffic") Core.<*>
                     (o Core..:? "endpoint"))
...
newDailyMaintenanceWindow 
    ::  DailyMaintenanceWindow
newDailyMaintenanceWindow
  = DailyMaintenanceWindow{duration = Core.Nothing,
                           startTime = Core.Nothing}
instance Core.FromJSON DailyMaintenanceWindow where
        parseJSON
          = Core.withObject "DailyMaintenanceWindow"
              (\ o ->
                 DailyMaintenanceWindow Core.<$>
                   (o Core..:? "duration") Core.<*> (o Core..:? "startTime"))
...
newDatabaseEncryption 
    ::  DatabaseEncryption
newDatabaseEncryption
  = DatabaseEncryption{currentState = Core.Nothing,
                       decryptionKeys = Core.Nothing, keyName = Core.Nothing,
                       lastOperationErrors = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON DatabaseEncryption where
        parseJSON
          = Core.withObject "DatabaseEncryption"
              (\ o ->
                 DatabaseEncryption Core.<$>
                   (o Core..:? "currentState") Core.<*> (o Core..:? "decryptionKeys")
                     Core.<*> (o Core..:? "keyName")
...
instance Core.FromJSON DefaultSnatStatus where
        parseJSON
          = Core.withObject "DefaultSnatStatus"
...
--
-- /See:/ 'newDesiredAdditionalIPRangesConfig' smart constructor.
newtype DesiredAdditionalIPRangesConfig = DesiredAdditionalIPRangesConfig
    {
      -- | List of additional IP ranges configs where each AdditionalIPRangesConfig corresponds to one subnetwork\'s IP ranges
      additionalIpRangesConfigs :: (Core.Maybe [AdditionalIPRangesConfig])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DesiredAdditionalIPRangesConfig' with the minimum fields required to make a request.
newDesiredAdditionalIPRangesConfig 
    :: 
                                   DesiredAdditionalIPRangesConfig
newDesiredAdditionalIPRangesConfig
  = DesiredAdditionalIPRangesConfig{additionalIpRangesConfigs =
                                      Core.Nothing}
instance Core.FromJSON DesiredAdditionalIPRangesConfig where
        parseJSON
          = Core.withObject "DesiredAdditionalIPRangesConfig"
              (\ o ->
                 DesiredAdditionalIPRangesConfig Core.<$>
                   (o Core..:? "additionalIpRangesConfigs"))

instance Core.ToJSON DesiredAdditionalIPRangesConfig where
        toJSON DesiredAdditionalIPRangesConfig{..}
          = Core.object
              (Core.catMaybes
                 [("additionalIpRangesConfigs" Core..=) Core.<$>
...
instance Core.FromJSON DesiredEnterpriseConfig where
        parseJSON
          = Core.withObject "DesiredEnterpriseConfig"
              (\ o ->
...
instance Core.FromJSON DnsCacheConfig where
        parseJSON
          = Core.withObject "DnsCacheConfig"
...
newEnterpriseConfig 
    ::  EnterpriseConfig
newEnterpriseConfig
  = EnterpriseConfig{clusterTier = Core.Nothing,
                     desiredTier = Core.Nothing}
instance Core.FromJSON EnterpriseConfig where
        parseJSON
          = Core.withObject "EnterpriseConfig"
              (\ o ->
                 EnterpriseConfig Core.<$>
                   (o Core..:? "clusterTier") Core.<*> (o Core..:? "desiredTier"))
...
data EphemeralStorageLocalSsdConfig = EphemeralStorageLocalSsdConfig
    {
      -- | Number of local SSDs to use for GKE Data Cache.
      dataCacheCount :: (Core.Maybe Core.Int32)
      -- | Number of local SSDs to use to back ephemeral storage. Uses NVMe interfaces. A zero (or unset) value has different meanings depending on machine type being used: 1. For pre-Gen3 machines, which support flexible numbers of local ssds, zero (or unset) means to disable using local SSDs as ephemeral storage. The limit for this value is dependent upon the maximum number of disk available on a machine per zone. See: https:\/\/{$universe.dns/names.final/documentation/domain}\/compute\/docs\/disks\/local-ssd for more information. 2. For Gen3 machines which dictate a specific number of local ssds, zero (or unset) means to use the default number of local ssds that goes with that machine type. For example, for a c3-standard-8-lssd machine, 2 local ssds would be provisioned. For c3-standard-8 (which doesn\'t support local ssds), 0 will be provisioned. See https:\/\/{$universe.dns/names.final/documentation/domain}\/compute\/docs\/disks\/local-ssd#choose/number/local_ssds for more info.
...
newFleet 
    ::  Fleet
newFleet
  = Fleet{membership = Core.Nothing, preRegistered = Core.Nothing,
          project = Core.Nothing}
instance Core.FromJSON Fleet where
        parseJSON
          = Core.withObject "Fleet"
              (\ o ->
                 Fleet Core.<$>
                   (o Core..:? "membership") Core.<*> (o Core..:? "preRegistered")
                     Core.<*> (o Core..:? "project"))
...
-- | GCPSecretManagerCertificateConfig configures a secret from <https://%7B$universe.dns_names.final_documentation_domain%7D/secret-manager Google Secret Manager>.
--
...
instance Core.FromJSON GCPSecretManagerCertificateConfig where
        parseJSON
          = Core.withObject "GCPSecretManagerCertificateConfig"
              (\ o ->
...
instance Core.FromJSON GPUDriverInstallationConfig where
        parseJSON
          = Core.withObject "GPUDriverInstallationConfig"
              (\ o ->
                 GPUDriverInstallationConfig Core.<$>
                   (o Core..:? "gpuDriverVersion"))
...
newGPUSharingConfig 
    ::  GPUSharingConfig
newGPUSharingConfig
  = GPUSharingConfig{gpuSharingStrategy = Core.Nothing,
                     maxSharedClientsPerGpu = Core.Nothing}
instance Core.FromJSON GPUSharingConfig where
        parseJSON
          = Core.withObject "GPUSharingConfig"
              (\ o ->
                 GPUSharingConfig Core.<$>
                   (o Core..:? "gpuSharingStrategy") Core.<*>
                     (o Core..:? "maxSharedClientsPerGpu" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("gpuSharingStrategy" Core..=) Core.<$> gpuSharingStrategy,
                  ("maxSharedClientsPerGpu" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON GatewayAPIConfig where
        parseJSON
          = Core.withObject "GatewayAPIConfig"
...
instance Core.FromJSON GcePersistentDiskCsiDriverConfig where
        parseJSON
          = Core.withObject "GcePersistentDiskCsiDriverConfig"
              (\ o ->
...
instance Core.FromJSON GcpFilestoreCsiDriverConfig where
        parseJSON
          = Core.withObject "GcpFilestoreCsiDriverConfig"
              (\ o ->
...
instance Core.FromJSON GcsFuseCsiDriverConfig where
        parseJSON
          = Core.withObject "GcsFuseCsiDriverConfig"
...
newGetJSONWebKeysResponse 
    ::  GetJSONWebKeysResponse
newGetJSONWebKeysResponse
  = GetJSONWebKeysResponse{cacheHeader = Core.Nothing,
                           keys = Core.Nothing}
instance Core.FromJSON GetJSONWebKeysResponse where
        parseJSON
          = Core.withObject "GetJSONWebKeysResponse"
              (\ o ->
                 GetJSONWebKeysResponse Core.<$>
                   (o Core..:? "cacheHeader") Core.<*> (o Core..:? "keys"))
...
newGetOpenIDConfigResponse 
    ::  GetOpenIDConfigResponse
newGetOpenIDConfigResponse
  = GetOpenIDConfigResponse{cacheHeader = Core.Nothing,
                            claimsSupported = Core.Nothing, grantTypes = Core.Nothing,
                            idTokenSigningAlgValuesSupported = Core.Nothing,
                            issuer = Core.Nothing, jwksUri = Core.Nothing,
...
instance Core.FromJSON GetOpenIDConfigResponse where
        parseJSON
          = Core.withObject "GetOpenIDConfigResponse"
              (\ o ->
                 GetOpenIDConfigResponse Core.<$>
                   (o Core..:? "cacheHeader") Core.<*> (o Core..:? "claims_supported")
          ...
          = Core.object
              (Core.catMaybes
                 [("cacheHeader" Core..=) Core.<$> cacheHeader,
                  ...
                  ("id_token_signing_alg_values_supported" Core..=) Core.<$>
                    idTokenSigningAlgValuesSupported,
                  ("issuer" Core..=) Core.<$> issuer,
                  ("jwks_uri" Core..=) Core.<$> jwksUri,
                  ("response_types_supported" Core..=) Core.<$>
                    responseTypesSupported,
                  ("subject_types_supported" Core..=) Core.<$>
                    subjectTypesSupported])


-- | GkeAutoUpgradeConfig is the configuration for GKE auto upgrades.
--
-- /See:/ 'newGkeAutoUpgradeConfig' smart constructor.
newtype GkeAutoUpgradeConfig = GkeAutoUpgradeConfig
    {
      -- | PatchMode specifies how auto upgrade patch builds should be selected.
      patchMode :: (Core.Maybe GkeAutoUpgradeConfig_PatchMode)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GkeAutoUpgradeConfig' with the minimum fields required to make a request.
newGkeAutoUpgradeConfig 
    ::  GkeAutoUpgradeConfig
newGkeAutoUpgradeConfig
  = GkeAutoUpgradeConfig{patchMode = Core.Nothing}
instance Core.FromJSON GkeAutoUpgradeConfig where
        parseJSON
          = Core.withObject "GkeAutoUpgradeConfig"
              (\ o -> GkeAutoUpgradeConfig Core.<$> (o Core..:? "patchMode"))

instance Core.ToJSON GkeAutoUpgradeConfig where
        toJSON GkeAutoUpgradeConfig{..}
          = Core.object
              (Core.catMaybes [("patchMode" Core..=) Core.<$> patchMode])
...
instance Core.FromJSON GkeBackupAgentConfig where
        parseJSON
          = Core.withObject "GkeBackupAgentConfig"
...
--
-- /See:/ 'newHighScaleCheckpointingConfig' smart constructor.
newtype HighScaleCheckpointingConfig = HighScaleCheckpointingConfig
    {
...
-- | Creates a value of 'HighScaleCheckpointingConfig' with the minimum fields required to make a request.
newHighScaleCheckpointingConfig 
    ::  HighScaleCheckpointingConfig
newHighScaleCheckpointingConfig
  = HighScaleCheckpointingConfig{enabled = Core.Nothing}
instance Core.FromJSON HighScaleCheckpointingConfig where
        parseJSON
          = Core.withObject "HighScaleCheckpointingConfig"
              (\ o ->
                 HighScaleCheckpointingConfig Core.<$> (o Core..:? "enabled"))

instance Core.ToJSON HighScaleCheckpointingConfig where
        toJSON HighScaleCheckpointingConfig{..}
          = Core.object
              (Core.catMaybes [("enabled" Core..=) Core.<$> enabled])
...
instance Core.FromJSON HorizontalPodAutoscaling where
        parseJSON
          = Core.withObject "HorizontalPodAutoscaling"
...
newHttpCacheControlResponseHeader 
    ::  HttpCacheControlResponseHeader
newHttpCacheControlResponseHeader
  = HttpCacheControlResponseHeader{age = Core.Nothing,
                                   directive = Core.Nothing, expires = Core.Nothing}
instance Core.FromJSON HttpCacheControlResponseHeader where
        parseJSON
          = Core.withObject "HttpCacheControlResponseHeader"
              (\ o ->
                 HttpCacheControlResponseHeader Core.<$>
                   (o Core..:? "age" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "directive")
                     Core.<*> (o Core..:? "expires"))
...
instance Core.FromJSON HttpLoadBalancing where
        parseJSON
          = Core.withObject "HttpLoadBalancing"
...
newHugepagesConfig 
    ::  HugepagesConfig
newHugepagesConfig
  = HugepagesConfig{hugepageSize1g = Core.Nothing,
                    hugepageSize2m = Core.Nothing}
instance Core.FromJSON HugepagesConfig where
        parseJSON
          = Core.withObject "HugepagesConfig"
              (\ o ->
                 HugepagesConfig Core.<$>
                   (o Core..:? "hugepageSize1g") Core.<*>
                     (o Core..:? "hugepageSize2m"))
...
instance Core.FromJSON ILBSubsettingConfig where
        parseJSON
          = Core.withObject "ILBSubsettingConfig"
...
data IPAllocationPolicy = IPAllocationPolicy
    ...
    , autoIpamConfig :: (Core.Maybe AutoIpamConfig)
...
newIPAllocationPolicy 
    ::  IPAllocationPolicy
newIPAllocationPolicy
  = IPAllocationPolicy{additionalIpRangesConfigs = Core.Nothing,
                       additionalPodRangesConfig = Core.Nothing,
                       autoIpamConfig = Core.Nothing, clusterIpv4Cidr = Core.Nothing,
                       ...
                       ipv6AccessType = Core.Nothing, nodeIpv4Cidr = Core.Nothing,
                       ...
                       stackType = Core.Nothing, subnetIpv6CidrBlock = Core.Nothing,
                       subnetworkName = Core.Nothing, tpuIpv4CidrBlock = Core.Nothing,
                       useIpAliases = Core.Nothing, useRoutes = Core.Nothing}
instance Core.FromJSON IPAllocationPolicy where
        parseJSON
          = Core.withObject "IPAllocationPolicy"
              (\ o ->
                 IPAllocationPolicy Core.<$>
                   (o Core..:? "additionalIpRangesConfigs") Core.<*>
                     (o Core..:? "additionalPodRangesConfig")
                     Core.<*> (o Core..:? "autoIpamConfig")
                     Core.<*> (o Core..:? "clusterIpv4Cidr")
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalIpRangesConfigs" Core..=) Core.<$>
                  ...
                  ("additionalPodRangesConfig" Core..=) Core.<$>
                    additionalPodRangesConfig,
                  ("autoIpamConfig" Core..=) Core.<$> autoIpamConfig,
                  ("clusterIpv4Cidr" Core..=) Core.<$> clusterIpv4Cidr,
                  ("clusterIpv4CidrBlock" Core..=) Core.<$> clusterIpv4CidrBlock,
                  ("clusterSecondaryRangeName" Core..=) Core.<$>
                    clusterSecondaryRangeName,
                  ("createSubnetwork" Core..=) Core.<$> createSubnetwork,
                  ("defaultPodIpv4RangeUtilization" Core..=) Core.<$>
...
newIPEndpointsConfig 
    ::  IPEndpointsConfig
newIPEndpointsConfig
  = IPEndpointsConfig{authorizedNetworksConfig = Core.Nothing,
                      enablePublicEndpoint = Core.Nothing, enabled = Core.Nothing,
                      globalAccess = Core.Nothing, privateEndpoint = Core.Nothing,
                      privateEndpointSubnetwork = Core.Nothing,
                      publicEndpoint = Core.Nothing}
instance Core.FromJSON IPEndpointsConfig where
        parseJSON
          = Core.withObject "IPEndpointsConfig"
              (\ o ->
                 IPEndpointsConfig Core.<$>
                   (o Core..:? "authorizedNetworksConfig") Core.<*>
                     (o Core..:? "enablePublicEndpoint")
                     Core.<*> (o Core..:? "enabled")
...
instance Core.ToJSON IPEndpointsConfig where
        toJSON IPEndpointsConfig{..}
          = Core.object
              (Core.catMaybes
                 [("authorizedNetworksConfig" Core..=) Core.<$>
                  ...
                  ("privateEndpointSubnetwork" Core..=) Core.<$>
...
instance Core.FromJSON IdentityServiceConfig where
        parseJSON
          = Core.withObject "IdentityServiceConfig"
...
instance Core.FromJSON IntraNodeVisibilityConfig where
        parseJSON
          = Core.withObject "IntraNodeVisibilityConfig"
...
newJwk 
    ::  Jwk
newJwk
  = Jwk{alg = Core.Nothing, crv = Core.Nothing, e = Core.Nothing,
        kid = Core.Nothing, kty = Core.Nothing, n = Core.Nothing,
        use = Core.Nothing, x = Core.Nothing, y = Core.Nothing}
instance Core.FromJSON Jwk where
        parseJSON
          = Core.withObject "Jwk"
              (\ o ->
                 Jwk Core.<$>
                   (o Core..:? "alg") Core.<*> (o Core..:? "crv") Core.<*>
                     (o Core..:? "e")
                     Core.<*> (o Core..:? "kid")
                     Core.<*> (o Core..:? "kty")
                     Core.<*> (o Core..:? "n")
...
instance Core.ToJSON Jwk where
        toJSON Jwk{..}
          = Core.object
              (Core.catMaybes
                 [("alg" Core..=) Core.<$> alg, ("crv" Core..=) Core.<$> crv,
                  ("e" Core..=) Core.<$> e, ("kid" Core..=) Core.<$> kid,
                  ("kty" Core..=) Core.<$> kty, ("n" Core..=) Core.<$> n,
                  ("use" Core..=) Core.<$> use, ("x" Core..=) Core.<$> x,
                  ("y" Core..=) Core.<$> y])
...
instance Core.FromJSON K8sBetaAPIConfig where
        parseJSON
          = Core.withObject "K8sBetaAPIConfig"
...
instance Core.FromJSON KubernetesDashboard where
        parseJSON
          = Core.withObject "KubernetesDashboard"
...
newLinuxNodeConfig 
    ::  LinuxNodeConfig
newLinuxNodeConfig
  = LinuxNodeConfig{cgroupMode = Core.Nothing,
                    hugepages = Core.Nothing, sysctls = Core.Nothing}
instance Core.FromJSON LinuxNodeConfig where
        parseJSON
          = Core.withObject "LinuxNodeConfig"
              (\ o ->
                 LinuxNodeConfig Core.<$>
                   (o Core..:? "cgroupMode") Core.<*> (o Core..:? "hugepages")
                     Core.<*> (o Core..:? "sysctls"))
...
instance Core.FromJSON LinuxNodeConfig_Sysctls where
        parseJSON
          = Core.withObject "LinuxNodeConfig_Sysctls"
          ...
          = Core.withObject "ListClustersResponse"
              (\ o ->
                 ListClustersResponse Core.<$>
                   (o Core..:? "clusters") Core.<*> (o Core..:? "missingZones"))
...
instance Core.FromJSON ListNodePoolsResponse where
        parseJSON
          = Core.withObject "ListNodePoolsResponse"
...
newListOperationsResponse 
    ::  ListOperationsResponse
newListOperationsResponse
  = ListOperationsResponse{missingZones = Core.Nothing,
          ...
          = Core.withObject "ListOperationsResponse"
              (\ o ->
                 ListOperationsResponse Core.<$>
                   (o Core..:? "missingZones") Core.<*> (o Core..:? "operations"))
...
newListUsableSubnetworksResponse 
    ::  ListUsableSubnetworksResponse
newListUsableSubnetworksResponse
  = ListUsableSubnetworksResponse{nextPageToken = Core.Nothing,
                                  subnetworks = Core.Nothing}
instance Core.FromJSON ListUsableSubnetworksResponse where
        parseJSON
          = Core.withObject "ListUsableSubnetworksResponse"
              (\ o ->
                 ListUsableSubnetworksResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "subnetworks"))
...
newtype LocalNvmeSsdBlockConfig = LocalNvmeSsdBlockConfig
    {
      -- | Number of local NVMe SSDs to use. The limit for this value is dependent upon the maximum number of disk available on a machine per zone. See: https:\/\/{$universe.dns/names.final/documentation/domain}\/compute\/docs\/disks\/local-ssd for more information. A zero (or unset) value has different meanings depending on machine type being used: 1. For pre-Gen3 machines, which support flexible numbers of local ssds, zero (or unset) means to disable using local SSDs as ephemeral storage. 2. For Gen3 machines which dictate a specific number of local ssds, zero (or unset) means to use the default number of local ssds that goes with that machine type. For example, for a c3-standard-8-lssd machine, 2 local ssds would be provisioned. For c3-standard-8 (which doesn\'t support local ssds), 0 will be provisioned. See https:\/\/{$universe.dns/names.final/documentation/domain}\/compute\/docs\/disks\/local-ssd#choose/number/local_ssds for more info.
      localSsdCount :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
instance Core.FromJSON LocalNvmeSsdBlockConfig where
        parseJSON
          = Core.withObject "LocalNvmeSsdBlockConfig"
              (\ o ->
...
instance Core.FromJSON LoggingComponentConfig where
        parseJSON
          = Core.withObject "LoggingComponentConfig"
              (\ o ->
...
instance Core.FromJSON LoggingVariantConfig where
        parseJSON
          = Core.withObject "LoggingVariantConfig"
...
instance Core.FromJSON MaintenanceExclusionOptions where
        parseJSON
          = Core.withObject "MaintenanceExclusionOptions"
...
newMaintenancePolicy 
    ::  MaintenancePolicy
newMaintenancePolicy
  = MaintenancePolicy{resourceVersion = Core.Nothing,
                      window = Core.Nothing}
instance Core.FromJSON MaintenancePolicy where
        parseJSON
          = Core.withObject "MaintenancePolicy"
              (\ o ->
                 MaintenancePolicy Core.<$>
                   (o Core..:? "resourceVersion") Core.<*> (o Core..:? "window"))
...
newMaintenanceWindow 
    ::  MaintenanceWindow
newMaintenanceWindow
  = MaintenanceWindow{dailyMaintenanceWindow = Core.Nothing,
                      maintenanceExclusions = Core.Nothing,
                      recurringWindow = Core.Nothing}
instance Core.FromJSON MaintenanceWindow where
        parseJSON
          = Core.withObject "MaintenanceWindow"
              (\ o ->
                 MaintenanceWindow Core.<$>
                   (o Core..:? "dailyMaintenanceWindow") Core.<*>
                     (o Core..:? "maintenanceExclusions")
...
instance Core.ToJSON MaintenanceWindow where
        toJSON MaintenanceWindow{..}
          = Core.object
              (Core.catMaybes
                 [("dailyMaintenanceWindow" Core..=) Core.<$>
                    dailyMaintenanceWindow,
...
instance Core.FromJSON MaintenanceWindow_MaintenanceExclusions
         where
        parseJSON
          = Core.withObject "MaintenanceWindow_MaintenanceExclusions"
              (\ o ->
                 MaintenanceWindow_MaintenanceExclusions Core.<$>
...
newManagedPrometheusConfig 
    ::  ManagedPrometheusConfig
newManagedPrometheusConfig
  = ManagedPrometheusConfig{autoMonitoringConfig = Core.Nothing,
                            enabled = Core.Nothing}
instance Core.FromJSON ManagedPrometheusConfig where
        parseJSON
          = Core.withObject "ManagedPrometheusConfig"
              (\ o ->
                 ManagedPrometheusConfig Core.<$>
                   (o Core..:? "autoMonitoringConfig") Core.<*>
                     (o Core..:? "enabled"))
...
data MasterAuth = MasterAuth
    ...
    , clusterCaCertificate :: (Core.Maybe Core.Text)
      -- | The password to use for HTTP basic authentication to the master endpoint. Because the master endpoint is open to the Internet, you should create a strong password. If a password is provided for cluster creation, username must be non-empty. Warning: basic authentication is deprecated, and will be removed in GKE control plane versions 1.19 and newer. For a list of recommended authentication methods, see: https:\/\/{$universe.dns/names.final/documentation_domain}\/kubernetes-engine\/docs\/how-to\/api-server-authentication
...
newMasterAuth 
    ::  MasterAuth
newMasterAuth
  = MasterAuth{clientCertificate = Core.Nothing,
               clientCertificateConfig = Core.Nothing, clientKey = Core.Nothing,
               clusterCaCertificate = Core.Nothing, password = Core.Nothing,
               username = Core.Nothing}
instance Core.FromJSON MasterAuth where
        parseJSON
          = Core.withObject "MasterAuth"
              (\ o ->
                 MasterAuth Core.<$>
                   (o Core..:? "clientCertificate") Core.<*>
                     (o Core..:? "clientCertificateConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("clientCertificate" Core..=) Core.<$> clientCertificate,
                  ("clientCertificateConfig" Core..=) Core.<$>
                    clientCertificateConfig,
...
newMasterAuthorizedNetworksConfig 
    ::  MasterAuthorizedNetworksConfig
newMasterAuthorizedNetworksConfig
  = MasterAuthorizedNetworksConfig{cidrBlocks = Core.Nothing,
                                   enabled = Core.Nothing,
...
instance Core.FromJSON MasterAuthorizedNetworksConfig where
        parseJSON
          = Core.withObject "MasterAuthorizedNetworksConfig"
              (\ o ->
                 MasterAuthorizedNetworksConfig Core.<$>
                   (o Core..:? "cidrBlocks") Core.<*> (o Core..:? "enabled") Core.<*>
                     (o Core..:? "gcpPublicCidrsAccessEnabled")
          ...
          = Core.object
              (Core.catMaybes
                 [("cidrBlocks" Core..=) Core.<$> cidrBlocks,
                  ("enabled" Core..=) Core.<$> enabled,
                  ("gcpPublicCidrsAccessEnabled" Core..=) Core.<$>
                    gcpPublicCidrsAccessEnabled,
                  ("privateEndpointEnforcementEnabled" Core..=) Core.<$>
...
instance Core.FromJSON MaxPodsConstraint where
        parseJSON
          = Core.withObject "MaxPodsConstraint"
              (\ o ->
                 MaxPodsConstraint Core.<$>
                   (o Core..:? "maxPodsPerNode" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON MaxPodsConstraint where
        toJSON MaxPodsConstraint{..}
          = Core.object
              (Core.catMaybes
                 [("maxPodsPerNode" Core..=) Core.. Core.AsText Core.<$>
                    maxPodsPerNode])


-- | The option enables the Kubernetes NUMA-aware Memory Manager feature. Detailed description about the feature can be found <https://kubernetes.io/docs/tasks/administer-cluster/memory-manager/ here>.
--
-- /See:/ 'newMemoryManager' smart constructor.
newtype MemoryManager = MemoryManager
    {
...
-- | Creates a value of 'MemoryManager' with the minimum fields required to make a request.
newMemoryManager 
    ::  MemoryManager
newMemoryManager = MemoryManager{policy = Core.Nothing}
instance Core.FromJSON MemoryManager where
        parseJSON
          = Core.withObject "MemoryManager"
              (\ o -> MemoryManager Core.<$> (o Core..:? "policy"))

instance Core.ToJSON MemoryManager where
        toJSON MemoryManager{..}
...
instance Core.FromJSON MeshCertificates where
        parseJSON
          = Core.withObject "MeshCertificates"
              (\ o ->
...
newMetric 
    ::  Metric
newMetric
  = Metric{doubleValue = Core.Nothing, intValue = Core.Nothing,
           name = Core.Nothing, stringValue = Core.Nothing}
...
instance Core.FromJSON MonitoringComponentConfig where
        parseJSON
          = Core.withObject "MonitoringComponentConfig"
              (\ o ->
...
instance Core.FromJSON MonitoringConfig where
        parseJSON
          = Core.withObject "MonitoringConfig"
              (\ o ->
                 MonitoringConfig Core.<$>
                   (o Core..:? "advancedDatapathObservabilityConfig") Core.<*>
                     (o Core..:? "componentConfig")
...
instance Core.ToJSON MonitoringConfig where
        toJSON MonitoringConfig{..}
          = Core.object
              (Core.catMaybes
                 [("advancedDatapathObservabilityConfig" Core..=) Core.<$>
                    advancedDatapathObservabilityConfig,
                  ("componentConfig" Core..=) Core.<$> componentConfig,
                  ("managedPrometheusConfig" Core..=) Core.<$>
                    managedPrometheusConfig])
...
data NetworkConfig = NetworkConfig
    ...
    , inTransitEncryptionConfig :: (Core.Maybe NetworkConfig_InTransitEncryptionConfig)
      -- | Output only. The relative name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/networks-and-firewalls#networks network> to which the cluster is connected. Example: projects\/my-project\/global\/networks\/my-network
    , network :: (Core.Maybe Core.Text)
    ...
    , serviceExternalIpsConfig :: (Core.Maybe ServiceExternalIPsConfig)
      -- | Output only. The relative name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/vpc subnetwork> to which the cluster is connected. Example: projects\/my-project\/regions\/us-central1\/subnetworks\/my-subnet
    , subnetwork :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newNetworkConfig 
    ::  NetworkConfig
newNetworkConfig
  = NetworkConfig{datapathProvider = Core.Nothing,
                  ...
                  inTransitEncryptionConfig = Core.Nothing, network = Core.Nothing,
                  networkPerformanceConfig = Core.Nothing,
                  privateIpv6GoogleAccess = Core.Nothing,
                  serviceExternalIpsConfig = Core.Nothing, subnetwork = Core.Nothing}
instance Core.FromJSON NetworkConfig where
        parseJSON
          = Core.withObject "NetworkConfig"
              (\ o ->
                 NetworkConfig Core.<$>
                   (o Core..:? "datapathProvider") Core.<*>
                     (o Core..:? "defaultEnablePrivateNodes")
          ...
          = Core.object
              (Core.catMaybes
                 [("datapathProvider" Core..=) Core.<$> datapathProvider,
                  ("defaultEnablePrivateNodes" Core..=) Core.<$>
                    defaultEnablePrivateNodes,
                  ("defaultSnatStatus" Core..=) Core.<$> defaultSnatStatus,
                  ("disableL4LbFirewallReconciliation" Core..=) Core.<$>
                    disableL4LbFirewallReconciliation,
                  ("dnsConfig" Core..=) Core.<$> dnsConfig,
                  ("enableCiliumClusterwideNetworkPolicy" Core..=) Core.<$>
                    enableCiliumClusterwideNetworkPolicy,
                  ("enableFqdnNetworkPolicy" Core..=) Core.<$>
                    enableFqdnNetworkPolicy,
                  ("enableIntraNodeVisibility" Core..=) Core.<$>
                  ...
                  ("inTransitEncryptionConfig" Core..=) Core.<$>
                    inTransitEncryptionConfig,
                  ("network" Core..=) Core.<$> network,
                  ("networkPerformanceConfig" Core..=) Core.<$>
                    networkPerformanceConfig,
                  ("privateIpv6GoogleAccess" Core..=) Core.<$>
                    privateIpv6GoogleAccess,
                  ("serviceExternalIpsConfig" Core..=) Core.<$>
                    serviceExternalIpsConfig,
                  ("subnetwork" Core..=) Core.<$> subnetwork])
...
instance Core.FromJSON NetworkPerformanceConfig where
        parseJSON
          = Core.withObject "NetworkPerformanceConfig"
              (\ o ->
...
instance Core.FromJSON NetworkPolicy where
        parseJSON
          = Core.withObject "NetworkPolicy"
              (\ o ->
                 NetworkPolicy Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "provider"))
...
instance Core.FromJSON NetworkPolicyConfig where
        parseJSON
          = Core.withObject "NetworkPolicyConfig"
...
-- | Specifies the NodeAffinity key, values, and affinity operator according to <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/nodes/sole-tenant-nodes#node_affinity_and_anti-affinity shared sole tenant node group affinities>.
--
...
newNodeAffinity 
    ::  NodeAffinity
newNodeAffinity
  = NodeAffinity{key = Core.Nothing, operator = Core.Nothing,
                 values = Core.Nothing}
instance Core.FromJSON NodeAffinity where
        parseJSON
          = Core.withObject "NodeAffinity"
              (\ o ->
                 NodeAffinity Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "operator") Core.<*>
                     (o Core..:? "values"))
...
data NodeConfig = NodeConfig
    {
      -- | A list of hardware accelerators to be attached to each node. See https:\/\/{$universe.dns/names.final/documentation_domain}\/compute\/docs\/gpus for more information about support for GPUs.
    ...
    , flexStart :: (Core.Maybe Core.Bool)
      -- | Google Container File System (image streaming) configs.
    , gcfsConfig :: (Core.Maybe GcfsConfig)
      -- | Enable or disable gvnic in the node pool.
    , gvnic :: (Core.Maybe VirtualNIC)
      -- | The image type to use for this node. Note that for a given image type, the latest version of it will be used. Please see https:\/\/{$universe.dns/names.final/documentation_domain}\/kubernetes-engine\/docs\/concepts\/node-images for available image types.
    , imageType :: (Core.Maybe Core.Text)
    ...
    , localNvmeSsdBlockConfig :: (Core.Maybe LocalNvmeSsdBlockConfig)
      -- | The number of local SSD disks to be attached to the node. The limit for this value is dependent upon the maximum number of disks available on a machine per zone. See: https:\/\/{$universe.dns/names.final/documentation_domain}\/compute\/docs\/disks\/local-ssd for more information.
    , localSsdCount :: (Core.Maybe Core.Int32)
    ...
    , loggingConfig :: (Core.Maybe NodePoolLoggingConfig)
      -- | The name of a Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/machine-types machine type> If unspecified, the default machine type is @e2-medium@.
    ...
    , metadata :: (Core.Maybe NodeConfig_Metadata)
      -- | Minimum CPU platform to be used by this instance. The instance may be scheduled on the specified or newer CPU platform. Applicable values are the friendly names of CPU platforms, such as @minCpuPlatform: \"Intel Haswell\"@ or @minCpuPlatform: \"Intel Sandy Bridge\"@. For more information, read <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/instances/specify-min-cpu-platform how to specify min CPU platform>
    , minCpuPlatform :: (Core.Maybe Core.Text)
      -- | Setting this field will assign instances of this pool to run on the specified node group. This is useful for running workloads on <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/nodes/sole-tenant-nodes sole tenant nodes>.
    , nodeGroup :: (Core.Maybe Core.Text)
      -- | The set of Google API scopes to be made available on all of the node VMs under the \"default\" service account. The following scopes are recommended, but not required, and by default are not included: * @https:\/\/www.googleapis.com\/auth\/compute@ is required for mounting persistent storage on your nodes. * @https:\/\/www.googleapis.com\/auth\/devstorage.read_only@ is required for communicating with __gcr.io__ (the <https://%7B$universe.dns_names.final_documentation_domain%7D/container-registry/ Google Container Registry>). If unspecified, no scopes are added, unless Cloud Logging or Cloud Monitoring are enabled, in which case their required scopes will be added.
    , oauthScopes :: (Core.Maybe [Core.Text])
      -- | Whether the nodes are created as preemptible VM instances. See: https:\/\/{$universe.dns/names.final/documentation_domain}\/compute\/docs\/instances\/preemptible for more information about preemptible VM instances.
    , preemptible :: (Core.Maybe Core.Bool)
      -- | The optional reservation affinity. Setting this field will apply the specified <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/instances/reserving-zonal-resources Zonal Compute Reservation> to this node pool.
...
newNodeConfig 
    ::  NodeConfig
newNodeConfig
  = NodeConfig{accelerators = Core.Nothing,
               advancedMachineFeatures = Core.Nothing,
               bootDiskKmsKey = Core.Nothing, confidentialNodes = Core.Nothing,
               containerdConfig = Core.Nothing, diskSizeGb = Core.Nothing,
               diskType = Core.Nothing, effectiveCgroupMode = Core.Nothing,
               enableConfidentialStorage = Core.Nothing,
               ephemeralStorageLocalSsdConfig = Core.Nothing,
               fastSocket = Core.Nothing, flexStart = Core.Nothing,
               gcfsConfig = Core.Nothing, gvnic = Core.Nothing,
               imageType = Core.Nothing, kubeletConfig = Core.Nothing,
               labels = Core.Nothing, linuxNodeConfig = Core.Nothing,
               localNvmeSsdBlockConfig = Core.Nothing,
               localSsdCount = Core.Nothing,
               localSsdEncryptionMode = Core.Nothing,
               loggingConfig = Core.Nothing, machineType = Core.Nothing,
               maxRunDuration = Core.Nothing, metadata = Core.Nothing,
               minCpuPlatform = Core.Nothing, nodeGroup = Core.Nothing,
               oauthScopes = Core.Nothing, preemptible = Core.Nothing,
               reservationAffinity = Core.Nothing, resourceLabels = Core.Nothing,
               resourceManagerTags = Core.Nothing, sandboxConfig = Core.Nothing,
               secondaryBootDiskUpdateStrategy = Core.Nothing,
               secondaryBootDisks = Core.Nothing, serviceAccount = Core.Nothing,
               shieldedInstanceConfig = Core.Nothing,
               soleTenantConfig = Core.Nothing, spot = Core.Nothing,
               storagePools = Core.Nothing, tags = Core.Nothing,
               taints = Core.Nothing, windowsNodeConfig = Core.Nothing,
               workloadMetadataConfig = Core.Nothing}
instance Core.FromJSON NodeConfig where
        parseJSON
          = Core.withObject "NodeConfig"
              (\ o ->
                 NodeConfig Core.<$>
                   (o Core..:? "accelerators") Core.<*>
                     (o Core..:? "advancedMachineFeatures")
          ...
          = Core.object
              (Core.catMaybes
                 [("accelerators" Core..=) Core.<$> accelerators,
                  ("advancedMachineFeatures" Core..=) Core.<$>
                    advancedMachineFeatures,
                  ("bootDiskKmsKey" Core..=) Core.<$> bootDiskKmsKey,
                  ("confidentialNodes" Core..=) Core.<$> confidentialNodes,
                  ...
                  ("enableConfidentialStorage" Core..=) Core.<$>
                    enableConfidentialStorage,
                  ("ephemeralStorageLocalSsdConfig" Core..=) Core.<$>
                    ephemeralStorageLocalSsdConfig,
                  ("fastSocket" Core..=) Core.<$> fastSocket,
                  ("flexStart" Core..=) Core.<$> flexStart,
                  ...
                  ("localNvmeSsdBlockConfig" Core..=) Core.<$>
                    localNvmeSsdBlockConfig,
                  ("localSsdCount" Core..=) Core.<$> localSsdCount,
                  ...
                  ("secondaryBootDiskUpdateStrategy" Core..=) Core.<$>
                    secondaryBootDiskUpdateStrategy,
                  ...
                  ("tags" Core..=) Core.<$> tags, ("taints" Core..=) Core.<$> taints,
                  ("windowsNodeConfig" Core..=) Core.<$> windowsNodeConfig,
                  ("workloadMetadataConfig" Core..=) Core.<$>
                    workloadMetadataConfig])
...
instance Core.FromJSON NodeConfig_Labels where
        parseJSON
          = Core.withObject "NodeConfig_Labels"
...
instance Core.FromJSON NodeConfig_Metadata where
        parseJSON
          = Core.withObject "NodeConfig_Metadata"
...
instance Core.FromJSON NodeConfig_ResourceLabels where
        parseJSON
          = Core.withObject "NodeConfig_ResourceLabels"
              (\ o ->
...
newNodeConfigDefaults 
    ::  NodeConfigDefaults
newNodeConfigDefaults
  = NodeConfigDefaults{containerdConfig = Core.Nothing,
                       gcfsConfig = Core.Nothing, loggingConfig = Core.Nothing,
                       nodeKubeletConfig = Core.Nothing}
instance Core.FromJSON NodeConfigDefaults where
        parseJSON
          = Core.withObject "NodeConfigDefaults"
              (\ o ->
                 NodeConfigDefaults Core.<$>
                   (o Core..:? "containerdConfig") Core.<*> (o Core..:? "gcfsConfig")
                     Core.<*> (o Core..:? "loggingConfig")
...
data NodeKubeletConfig = NodeKubeletConfig
    ...
    , memoryManager :: (Core.Maybe MemoryManager)
    ...
    , topologyManager :: (Core.Maybe TopologyManager)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newNodeKubeletConfig 
    ::  NodeKubeletConfig
newNodeKubeletConfig
  = NodeKubeletConfig{allowedUnsafeSysctls = Core.Nothing,
                      containerLogMaxFiles = Core.Nothing,
                      containerLogMaxSize = Core.Nothing, cpuCfsQuota = Core.Nothing,
                      cpuCfsQuotaPeriod = Core.Nothing, cpuManagerPolicy = Core.Nothing,
                      imageGcHighThresholdPercent = Core.Nothing,
                      imageGcLowThresholdPercent = Core.Nothing,
                      imageMaximumGcAge = Core.Nothing, imageMinimumGcAge = Core.Nothing,
                      insecureKubeletReadonlyPortEnabled = Core.Nothing,
                      memoryManager = Core.Nothing, podPidsLimit = Core.Nothing,
                      topologyManager = Core.Nothing}
instance Core.FromJSON NodeKubeletConfig where
        parseJSON
          = Core.withObject "NodeKubeletConfig"
              (\ o ->
                 NodeKubeletConfig Core.<$>
                   (o Core..:? "allowedUnsafeSysctls") Core.<*>
                     (o Core..:? "containerLogMaxFiles")
                     ...
                     Core.<*> (o Core..:? "insecureKubeletReadonlyPortEnabled")
                     Core.<*> (o Core..:? "memoryManager")
                     Core.<*>
                     (o Core..:? "podPidsLimit" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "topologyManager"))
...
instance Core.FromJSON NodeLabels_Labels where
        parseJSON
          = Core.withObject "NodeLabels_Labels"
...
newNodeManagement 
    ::  NodeManagement
newNodeManagement
  = NodeManagement{autoRepair = Core.Nothing,
                   autoUpgrade = Core.Nothing, upgradeOptions = Core.Nothing}
instance Core.FromJSON NodeManagement where
        parseJSON
          = Core.withObject "NodeManagement"
              (\ o ->
                 NodeManagement Core.<$>
                   (o Core..:? "autoRepair") Core.<*> (o Core..:? "autoUpgrade")
...
newNodeNetworkConfig 
    ::  NodeNetworkConfig
newNodeNetworkConfig
  = NodeNetworkConfig{additionalNodeNetworkConfigs = Core.Nothing,
                      additionalPodNetworkConfigs = Core.Nothing,
                      createPodRange = Core.Nothing, enablePrivateNodes = Core.Nothing,
                      networkPerformanceConfig = Core.Nothing,
                      podCidrOverprovisionConfig = Core.Nothing,
                      podIpv4CidrBlock = Core.Nothing,
                      podIpv4RangeUtilization = Core.Nothing, podRange = Core.Nothing}
instance Core.FromJSON NodeNetworkConfig where
        parseJSON
          = Core.withObject "NodeNetworkConfig"
              (\ o ->
                 NodeNetworkConfig Core.<$>
                   (o Core..:? "additionalNodeNetworkConfigs") Core.<*>
                     (o Core..:? "additionalPodNetworkConfigs")
...
instance Core.ToJSON NodeNetworkConfig where
        toJSON NodeNetworkConfig{..}
          = Core.object
              (Core.catMaybes
                 [("additionalNodeNetworkConfigs" Core..=) Core.<$>
                    additionalNodeNetworkConfigs,
                  ("additionalPodNetworkConfigs" Core..=) Core.<$>
                  ...
                  ("podIpv4RangeUtilization" Core..=) Core.<$>
...
data NodePool = NodePool
    ...
    , etag :: (Core.Maybe Core.Text)
      -- | The initial node count for the pool. You must ensure that your Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/quotas resource quota> is sufficient for this number of instances. You must also have available firewall and routes quota.
    , initialNodeCount :: (Core.Maybe Core.Int32)
      -- | Output only. The resource URLs of the <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/instance-groups/creating-groups-of-managed-instances managed instance groups> associated with this node pool. During the node pool blue-green upgrade operation, the URLs contain both blue and green resources.
    , instanceGroupUrls :: (Core.Maybe [Core.Text])
      -- | The list of Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zones> in which the NodePool\'s nodes should be located. If this value is unspecified during node pool creation, the <https://%7B$universe.dns_names.final_documentation_domain%7D/kubernetes-engine/docs/reference/rest/v1/projects.locations.clusters#Cluster.FIELDS.locations Cluster.Locations> value will be used, instead. Warning: changing node pool locations will result in nodes being added and\/or removed.
    , locations :: (Core.Maybe [Core.Text])
    ...
    , upgradeSettings :: (Core.Maybe UpgradeSettings)
      -- | The version of Kubernetes running on this NodePool\'s nodes. If unspecified, it defaults as described <https://%7B$universe.dns_names.final_documentation_domain%7D/kubernetes-engine/versioning#specifying_node_version here>.
...
newNodePool 
    ::  NodePool
newNodePool
  = NodePool{autopilotConfig = Core.Nothing,
             autoscaling = Core.Nothing, bestEffortProvisioning = Core.Nothing,
             conditions = Core.Nothing, config = Core.Nothing,
             etag = Core.Nothing, initialNodeCount = Core.Nothing,
             instanceGroupUrls = Core.Nothing, locations = Core.Nothing,
             management = Core.Nothing, maxPodsConstraint = Core.Nothing,
             name = Core.Nothing, networkConfig = Core.Nothing,
             placementPolicy = Core.Nothing, podIpv4CidrSize = Core.Nothing,
             queuedProvisioning = Core.Nothing, selfLink = Core.Nothing,
             status = Core.Nothing, statusMessage = Core.Nothing,
             updateInfo = Core.Nothing, upgradeSettings = Core.Nothing,
...
instance Core.FromJSON NodePool where
        parseJSON
          = Core.withObject "NodePool"
              (\ o ->
                 NodePool Core.<$>
                   (o Core..:? "autopilotConfig") Core.<*> (o Core..:? "autoscaling")
          ...
          = Core.object
              (Core.catMaybes
                 [("autopilotConfig" Core..=) Core.<$> autopilotConfig,
                  ...
                  ("conditions" Core..=) Core.<$> conditions,
                  ("config" Core..=) Core.<$> config, ("etag" Core..=) Core.<$> etag,
                  ("initialNodeCount" Core..=) Core.<$> initialNodeCount,
                  ("instanceGroupUrls" Core..=) Core.<$> instanceGroupUrls,
                  ("locations" Core..=) Core.<$> locations,
                  ("management" Core..=) Core.<$> management,
...
newNodePoolAutoConfig 
    ::  NodePoolAutoConfig
newNodePoolAutoConfig
  = NodePoolAutoConfig{linuxNodeConfig = Core.Nothing,
                       networkTags = Core.Nothing, nodeKubeletConfig = Core.Nothing,
                       resourceManagerTags = Core.Nothing}
instance Core.FromJSON NodePoolAutoConfig where
        parseJSON
          = Core.withObject "NodePoolAutoConfig"
              (\ o ->
                 NodePoolAutoConfig Core.<$>
                   (o Core..:? "linuxNodeConfig") Core.<*> (o Core..:? "networkTags")
                     Core.<*> (o Core..:? "nodeKubeletConfig")
                     Core.<*> (o Core..:? "resourceManagerTags"))
...
newNodePoolAutoscaling 
    ::  NodePoolAutoscaling
newNodePoolAutoscaling
  = NodePoolAutoscaling{autoprovisioned = Core.Nothing,
                        enabled = Core.Nothing, locationPolicy = Core.Nothing,
                        maxNodeCount = Core.Nothing, minNodeCount = Core.Nothing,
                        totalMaxNodeCount = Core.Nothing, totalMinNodeCount = Core.Nothing}
instance Core.FromJSON NodePoolAutoscaling where
        parseJSON
          = Core.withObject "NodePoolAutoscaling"
              (\ o ->
                 NodePoolAutoscaling Core.<$>
                   (o Core..:? "autoprovisioned") Core.<*> (o Core..:? "enabled")
...
instance Core.FromJSON NodePoolDefaults where
        parseJSON
          = Core.withObject "NodePoolDefaults"
              (\ o ->
...
instance Core.FromJSON NodePoolLoggingConfig where
        parseJSON
          = Core.withObject "NodePoolLoggingConfig"
              (\ o ->
...
--
-- /See:/ 'newNodePoolUpgradeInfo' smart constructor.
data NodePoolUpgradeInfo = NodePoolUpgradeInfo
    {
      -- | The auto upgrade status.
      autoUpgradeStatus :: (Core.Maybe [NodePoolUpgradeInfo_AutoUpgradeStatusItem])
    ...
    , patchTargetVersion :: (Core.Maybe Core.Text)
      -- | The auto upgrade paused reason.
    , pausedReason :: (Core.Maybe [NodePoolUpgradeInfo_PausedReasonItem])
      -- | The list of past auto upgrades.
    , upgradeDetails :: (Core.Maybe [UpgradeDetails])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'NodePoolUpgradeInfo' with the minimum fields required to make a request.
newNodePoolUpgradeInfo 
    ::  NodePoolUpgradeInfo
newNodePoolUpgradeInfo
  = NodePoolUpgradeInfo{autoUpgradeStatus = Core.Nothing,
                        endOfExtendedSupportTimestamp = Core.Nothing,
                        endOfStandardSupportTimestamp = Core.Nothing,
                        minorTargetVersion = Core.Nothing,
                        patchTargetVersion = Core.Nothing, pausedReason = Core.Nothing,
                        upgradeDetails = Core.Nothing}
instance Core.FromJSON NodePoolUpgradeInfo where
        parseJSON
          = Core.withObject "NodePoolUpgradeInfo"
              (\ o ->
                 NodePoolUpgradeInfo Core.<$>
                   (o Core..:? "autoUpgradeStatus") Core.<*>
                     (o Core..:? "endOfExtendedSupportTimestamp")
                     Core.<*> (o Core..:? "endOfStandardSupportTimestamp")
                     Core.<*> (o Core..:? "minorTargetVersion")
...
instance Core.ToJSON NodePoolUpgradeInfo where
        toJSON NodePoolUpgradeInfo{..}
          = Core.object
              (Core.catMaybes
                 [("autoUpgradeStatus" Core..=) Core.<$> autoUpgradeStatus,
                  ("endOfExtendedSupportTimestamp" Core..=) Core.<$>
...
newNodeTaint 
    ::  NodeTaint
newNodeTaint
  = NodeTaint{effect = Core.Nothing, key = Core.Nothing,
              value = Core.Nothing}
instance Core.FromJSON NodeTaint where
        parseJSON
          = Core.withObject "NodeTaint"
              (\ o ->
                 NodeTaint Core.<$>
                   (o Core..:? "effect") Core.<*> (o Core..:? "key") Core.<*>
                     (o Core..:? "value"))
...
instance Core.ToJSON NodeTaint where
        toJSON NodeTaint{..}
          = Core.object
              (Core.catMaybes
                 [("effect" Core..=) Core.<$> effect, ("key" Core..=) Core.<$> key,
...
instance Core.FromJSON NotificationConfig where
        parseJSON
          = Core.withObject "NotificationConfig"
...
data Operation = Operation
    ...
    , targetLink :: (Core.Maybe Core.Text)
      -- | Output only. The name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zone> in which the operation is taking place. This field is deprecated, use location instead.
    , zone :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newOperation 
    ::  Operation
newOperation
  = Operation{clusterConditions = Core.Nothing,
              detail = Core.Nothing, endTime = Core.Nothing,
              error = Core.Nothing, location = Core.Nothing, name = Core.Nothing,
              nodepoolConditions = Core.Nothing, operationType = Core.Nothing,
              progress = Core.Nothing, selfLink = Core.Nothing,
              startTime = Core.Nothing, status = Core.Nothing,
              statusMessage = Core.Nothing, targetLink = Core.Nothing,
              zone = Core.Nothing}
instance Core.FromJSON Operation where
        parseJSON
          = Core.withObject "Operation"
              (\ o ->
                 Operation Core.<$>
                   (o Core..:? "clusterConditions") Core.<*> (o Core..:? "detail")
                     Core.<*> (o Core..:? "endTime")
                     Core.<*> (o Core..:? "error")
                     Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "name")
...
newOperationError 
    ::  OperationError
newOperationError
  = OperationError{errorMessage = Core.Nothing,
                   keyName = Core.Nothing, timestamp = Core.Nothing}
instance Core.FromJSON OperationError where
        parseJSON
          = Core.withObject "OperationError"
              (\ o ->
                 OperationError Core.<$>
                   (o Core..:? "errorMessage") Core.<*> (o Core..:? "keyName")
...
newOperationProgress 
    ::  OperationProgress
newOperationProgress
  = OperationProgress{metrics = Core.Nothing, name = Core.Nothing,
                      stages = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON OperationProgress where
        parseJSON
          = Core.withObject "OperationProgress"
              (\ o ->
                 OperationProgress Core.<$>
                   (o Core..:? "metrics") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "stages")
                     Core.<*> (o Core..:? "status"))
          ...
          = Core.object
              (Core.catMaybes
                 [("metrics" Core..=) Core.<$> metrics,
                  ("name" Core..=) Core.<$> name, ("stages" Core..=) Core.<$> stages,
                  ("status" Core..=) Core.<$> status])
...
instance Core.FromJSON ParallelstoreCsiDriverConfig where
        parseJSON
          = Core.withObject "ParallelstoreCsiDriverConfig"
              (\ o ->
...
newParentProductConfig 
    ::  ParentProductConfig
newParentProductConfig
  = ParentProductConfig{labels = Core.Nothing,
                        productName = Core.Nothing}
instance Core.FromJSON ParentProductConfig where
        parseJSON
          = Core.withObject "ParentProductConfig"
              (\ o ->
                 ParentProductConfig Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "productName"))
...
instance Core.FromJSON ParentProductConfig_Labels where
        parseJSON
          = Core.withObject "ParentProductConfig_Labels"
              (\ o ->
...
data PlacementPolicy = PlacementPolicy
    {
      ...
      -- | Optional. TPU placement topology for pod slice node pool. https:\/\/{$universe.dns/names.final/documentation/domain}\/tpu\/docs\/types-topologies#tpu/topologies
...
newPlacementPolicy 
    ::  PlacementPolicy
newPlacementPolicy
  = PlacementPolicy{policyName = Core.Nothing,
                    tpuTopology = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON PlacementPolicy where
        parseJSON
          = Core.withObject "PlacementPolicy"
              (\ o ->
                 PlacementPolicy Core.<$>
                   (o Core..:? "policyName") Core.<*> (o Core..:? "tpuTopology")
                     Core.<*> (o Core..:? "type"))
...
--
-- /See:/ 'newPodAutoscaling' smart constructor.
newtype PodAutoscaling = PodAutoscaling
    {
      -- | Selected Horizontal Pod Autoscaling profile.
      hpaProfile :: (Core.Maybe PodAutoscaling_HpaProfile)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PodAutoscaling' with the minimum fields required to make a request.
newPodAutoscaling 
    ::  PodAutoscaling
newPodAutoscaling = PodAutoscaling{hpaProfile = Core.Nothing}
instance Core.FromJSON PodAutoscaling where
        parseJSON
          = Core.withObject "PodAutoscaling"
              (\ o -> PodAutoscaling Core.<$> (o Core..:? "hpaProfile"))

instance Core.ToJSON PodAutoscaling where
        toJSON PodAutoscaling{..}
          = Core.object
              (Core.catMaybes [("hpaProfile" Core..=) Core.<$> hpaProfile])
...
instance Core.FromJSON PodCIDROverprovisionConfig where
        parseJSON
          = Core.withObject "PodCIDROverprovisionConfig"
...
newPrivateClusterConfig 
    ::  PrivateClusterConfig
newPrivateClusterConfig
  = PrivateClusterConfig{enablePrivateEndpoint = Core.Nothing,
                         enablePrivateNodes = Core.Nothing,
                         masterGlobalAccessConfig = Core.Nothing,
                         masterIpv4CidrBlock = Core.Nothing, peeringName = Core.Nothing,
                         privateEndpoint = Core.Nothing,
                         privateEndpointSubnetwork = Core.Nothing,
                         publicEndpoint = Core.Nothing}
instance Core.FromJSON PrivateClusterConfig where
        parseJSON
          = Core.withObject "PrivateClusterConfig"
              (\ o ->
                 PrivateClusterConfig Core.<$>
                   (o Core..:? "enablePrivateEndpoint") Core.<*>
                     (o Core..:? "enablePrivateNodes")
          ...
          = Core.object
              (Core.catMaybes
                 [("enablePrivateEndpoint" Core..=) Core.<$> enablePrivateEndpoint,
                  ("enablePrivateNodes" Core..=) Core.<$> enablePrivateNodes,
                  ("masterGlobalAccessConfig" Core..=) Core.<$>
...
instance Core.FromJSON PrivateClusterMasterGlobalAccessConfig where
        parseJSON
          = Core.withObject "PrivateClusterMasterGlobalAccessConfig"
              (\ o ->
                 PrivateClusterMasterGlobalAccessConfig Core.<$>
                   (o Core..:? "enabled"))
...
instance Core.FromJSON PrivateRegistryAccessConfig where
        parseJSON
          = Core.withObject "PrivateRegistryAccessConfig"
              (\ o ->
                 PrivateRegistryAccessConfig Core.<$>
                   (o Core..:? "certificateAuthorityDomainConfig") Core.<*>
                     (o Core..:? "enabled"))
...
instance Core.ToJSON PrivateRegistryAccessConfig where
        toJSON PrivateRegistryAccessConfig{..}
          = Core.object
              (Core.catMaybes
                 [("certificateAuthorityDomainConfig" Core..=) Core.<$>
                    certificateAuthorityDomainConfig,
                  ("enabled" Core..=) Core.<$> enabled])
...
newPubSub 
    ::  PubSub
newPubSub
  = PubSub{enabled = Core.Nothing, filter = Core.Nothing,
           topic = Core.Nothing}
instance Core.FromJSON PubSub where
        parseJSON
          = Core.withObject "PubSub"
              (\ o ->
                 PubSub Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "filter") Core.<*>
                     (o Core..:? "topic"))
...
instance Core.FromJSON QueuedProvisioning where
        parseJSON
          = Core.withObject "QueuedProvisioning"
...
instance Core.FromJSON RBACBindingConfig where
        parseJSON
          = Core.withObject "RBACBindingConfig"
              (\ o ->
                 RBACBindingConfig Core.<$>
                   (o Core..:? "enableInsecureBindingSystemAuthenticated") Core.<*>
                     (o Core..:? "enableInsecureBindingSystemUnauthenticated"))

instance Core.ToJSON RBACBindingConfig where
        toJSON RBACBindingConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enableInsecureBindingSystemAuthenticated" Core..=) Core.<$>
                    enableInsecureBindingSystemAuthenticated,
                  ("enableInsecureBindingSystemUnauthenticated" Core..=) Core.<$>
...
instance Core.FromJSON RangeInfo where
        parseJSON
          = Core.withObject "RangeInfo"
              (\ o ->
                 RangeInfo Core.<$>
                   (o Core..:? "rangeName") Core.<*> (o Core..:? "utilization"))
...
instance Core.FromJSON RayClusterLoggingConfig where
        parseJSON
          = Core.withObject "RayClusterLoggingConfig"
...
instance Core.FromJSON RayClusterMonitoringConfig where
        parseJSON
          = Core.withObject "RayClusterMonitoringConfig"
...
newRayOperatorConfig 
    ::  RayOperatorConfig
newRayOperatorConfig
  = RayOperatorConfig{enabled = Core.Nothing,
...
instance Core.FromJSON RayOperatorConfig where
        parseJSON
          = Core.withObject "RayOperatorConfig"
              (\ o ->
                 RayOperatorConfig Core.<$>
                   (o Core..:? "enabled") Core.<*>
                     (o Core..:? "rayClusterLoggingConfig")
...
instance Core.ToJSON RayOperatorConfig where
        toJSON RayOperatorConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ("rayClusterLoggingConfig" Core..=) Core.<$>
                    rayClusterLoggingConfig,
                  ("rayClusterMonitoringConfig" Core..=) Core.<$>
                    rayClusterMonitoringConfig])
...
newRecurringTimeWindow 
    ::  RecurringTimeWindow
newRecurringTimeWindow
  = RecurringTimeWindow{recurrence = Core.Nothing,
                        window = Core.Nothing}
instance Core.FromJSON RecurringTimeWindow where
        parseJSON
          = Core.withObject "RecurringTimeWindow"
              (\ o ->
                 RecurringTimeWindow Core.<$>
                   (o Core..:? "recurrence") Core.<*> (o Core..:? "window"))
...
instance Core.FromJSON ReleaseChannel where
        parseJSON
          = Core.withObject "ReleaseChannel"
...
newReleaseChannelConfig 
    ::  ReleaseChannelConfig
newReleaseChannelConfig
  = ReleaseChannelConfig{channel = Core.Nothing,
                         defaultVersion = Core.Nothing, upgradeTargetVersion = Core.Nothing,
                         validVersions = Core.Nothing}
instance Core.FromJSON ReleaseChannelConfig where
        parseJSON
          = Core.withObject "ReleaseChannelConfig"
              (\ o ->
                 ReleaseChannelConfig Core.<$>
                   (o Core..:? "channel") Core.<*> (o Core..:? "defaultVersion")
...
-- | <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/instances/reserving-zonal-resources ReservationAffinity> is the configuration of desired reservation which instances could take capacity from.
--
...
-- | Collection of <https://%7B$universe.dns_names.final_documentation_domain%7D/resource-manager/docs/creating-managing-labels GCP labels>.
--
...
instance Core.FromJSON ResourceLabels where
        parseJSON
          = Core.withObject "ResourceLabels"
...
instance Core.FromJSON ResourceLabels_Labels where
        parseJSON
          = Core.withObject "ResourceLabels_Labels"
...
newResourceLimit 
    ::  ResourceLimit
newResourceLimit
  = ResourceLimit{maximum = Core.Nothing, minimum = Core.Nothing,
                  resourceType = Core.Nothing}
instance Core.FromJSON ResourceLimit where
        parseJSON
          = Core.withObject "ResourceLimit"
              (\ o ->
                 ResourceLimit Core.<$>
                   (o Core..:? "maximum" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "minimum" Core.<&> Core.fmap Core.fromAsText)
...
-- | A map of resource manager tag keys and values to be attached to the nodes for managing Compute Engine firewalls using Network Firewall Policies. Tags must be according to specifications in https:\/\/{$universe.dns/names.final/documentation_domain}\/vpc\/docs\/tags-firewalls-overview#specifications. A maximum of 5 tag key-value pairs can be specified. Existing tags will be replaced with new values.
--
...
instance Core.FromJSON ResourceManagerTags where
        parseJSON
          = Core.withObject "ResourceManagerTags"
...
instance Core.FromJSON ResourceManagerTags_Tags where
        parseJSON
          = Core.withObject "ResourceManagerTags_Tags"
...
newResourceUsageExportConfig 
    ::  ResourceUsageExportConfig
newResourceUsageExportConfig
  = ResourceUsageExportConfig{bigqueryDestination = Core.Nothing,
...
instance Core.FromJSON ResourceUsageExportConfig where
        parseJSON
          = Core.withObject "ResourceUsageExportConfig"
              (\ o ->
                 ResourceUsageExportConfig Core.<$>
                   (o Core..:? "bigqueryDestination") Core.<*>
                     (o Core..:? "consumptionMeteringConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("bigqueryDestination" Core..=) Core.<$> bigqueryDestination,
                  ("consumptionMeteringConfig" Core..=) Core.<$>
                    consumptionMeteringConfig,
                  ("enableNetworkEgressMetering" Core..=) Core.<$>
...
newRollbackNodePoolUpgradeRequest 
    ::  RollbackNodePoolUpgradeRequest
newRollbackNodePoolUpgradeRequest
  = RollbackNodePoolUpgradeRequest{clusterId = Core.Nothing,
                                   name = Core.Nothing, nodePoolId = Core.Nothing,
                                   projectId = Core.Nothing, respectPdb = Core.Nothing,
                                   zone = Core.Nothing}
instance Core.FromJSON RollbackNodePoolUpgradeRequest where
        parseJSON
          = Core.withObject "RollbackNodePoolUpgradeRequest"
              (\ o ->
                 RollbackNodePoolUpgradeRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "nodePoolId")
                     Core.<*> (o Core..:? "projectId")
...
instance Core.FromJSON SecondaryBootDisk where
        parseJSON
          = Core.withObject "SecondaryBootDisk"
              (\ o ->
                 SecondaryBootDisk Core.<$>
                   (o Core..:? "diskImage") Core.<*> (o Core..:? "mode"))
...
instance Core.FromJSON SecondaryBootDiskUpdateStrategy where
        parseJSON
          = Core.withObject "SecondaryBootDiskUpdateStrategy"
...
instance Core.FromJSON SecretManagerConfig where
        parseJSON
          = Core.withObject "SecretManagerConfig"
...
data SecurityBulletinEvent = SecurityBulletinEvent
    ...
    , mitigatedVersions :: (Core.Maybe [Core.Text])
...
newSecurityBulletinEvent 
    ::  SecurityBulletinEvent
newSecurityBulletinEvent
  = SecurityBulletinEvent{affectedSupportedMinors = Core.Nothing,
                          briefDescription = Core.Nothing, bulletinId = Core.Nothing,
                          bulletinUri = Core.Nothing, cveIds = Core.Nothing,
                          manualStepsRequired = Core.Nothing,
                          mitigatedVersions = Core.Nothing, patchedVersions = Core.Nothing,
                          resourceTypeAffected = Core.Nothing, severity = Core.Nothing,
                          suggestedUpgradeTarget = Core.Nothing}
instance Core.FromJSON SecurityBulletinEvent where
        parseJSON
          = Core.withObject "SecurityBulletinEvent"
              (\ o ->
                 SecurityBulletinEvent Core.<$>
                   (o Core..:? "affectedSupportedMinors") Core.<*>
                     (o Core..:? "briefDescription")
                     Core.<*> (o Core..:? "bulletinId")
                     Core.<*> (o Core..:? "bulletinUri")
                     Core.<*> (o Core..:? "cveIds")
                     Core.<*> (o Core..:? "manualStepsRequired")
                     Core.<*> (o Core..:? "mitigatedVersions")
...
instance Core.ToJSON SecurityBulletinEvent where
        toJSON SecurityBulletinEvent{..}
          = Core.object
              (Core.catMaybes
                 [("affectedSupportedMinors" Core..=) Core.<$>
...
newSecurityPostureConfig 
    ::  SecurityPostureConfig
newSecurityPostureConfig
  = SecurityPostureConfig{mode = Core.Nothing,
                          vulnerabilityMode = Core.Nothing}
instance Core.FromJSON SecurityPostureConfig where
        parseJSON
          = Core.withObject "SecurityPostureConfig"
              (\ o ->
                 SecurityPostureConfig Core.<$>
                   (o Core..:? "mode") Core.<*> (o Core..:? "vulnerabilityMode"))
...
newServerConfig 
    ::  ServerConfig
newServerConfig
  = ServerConfig{channels = Core.Nothing,
                 defaultClusterVersion = Core.Nothing,
                 defaultImageType = Core.Nothing, validImageTypes = Core.Nothing,
                 validMasterVersions = Core.Nothing,
                 validNodeVersions = Core.Nothing}
instance Core.FromJSON ServerConfig where
        parseJSON
          = Core.withObject "ServerConfig"
              (\ o ->
                 ServerConfig Core.<$>
                   (o Core..:? "channels") Core.<*>
                     (o Core..:? "defaultClusterVersion")
...
instance Core.FromJSON ServiceExternalIPsConfig where
        parseJSON
          = Core.withObject "ServiceExternalIPsConfig"
...
newSetAddonsConfigRequest 
    ::  SetAddonsConfigRequest
newSetAddonsConfigRequest
  = SetAddonsConfigRequest{addonsConfig = Core.Nothing,
                           clusterId = Core.Nothing, name = Core.Nothing,
                           projectId = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON SetAddonsConfigRequest where
        parseJSON
          = Core.withObject "SetAddonsConfigRequest"
              (\ o ->
                 SetAddonsConfigRequest Core.<$>
                   (o Core..:? "addonsConfig") Core.<*> (o Core..:? "clusterId")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
newSetLabelsRequest 
    ::  SetLabelsRequest
newSetLabelsRequest
  = SetLabelsRequest{clusterId = Core.Nothing,
                     labelFingerprint = Core.Nothing, name = Core.Nothing,
                     projectId = Core.Nothing, resourceLabels = Core.Nothing,
                     zone = Core.Nothing}
instance Core.FromJSON SetLabelsRequest where
        parseJSON
          = Core.withObject "SetLabelsRequest"
              (\ o ->
                 SetLabelsRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "labelFingerprint")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "resourceLabels")
                     Core.<*> (o Core..:? "zone"))
...
instance Core.FromJSON SetLabelsRequest_ResourceLabels where
        parseJSON
          = Core.withObject "SetLabelsRequest_ResourceLabels"
              (\ o ->
...
newSetLegacyAbacRequest 
    ::  SetLegacyAbacRequest
newSetLegacyAbacRequest
  = SetLegacyAbacRequest{clusterId = Core.Nothing,
                         enabled = Core.Nothing, name = Core.Nothing,
                         projectId = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON SetLegacyAbacRequest where
        parseJSON
          = Core.withObject "SetLegacyAbacRequest"
              (\ o ->
                 SetLegacyAbacRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "enabled") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
data SetLocationsRequest = SetLocationsRequest
    {
      -- | Deprecated. The name of the cluster to upgrade. This field has been deprecated and replaced by the name field.
      clusterId :: (Core.Maybe Core.Text)
      -- | Required. The desired list of Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zones> in which the cluster\'s nodes should be located. Changing the locations a cluster is in will result in nodes being either created or removed from the cluster, depending on whether locations are being added or removed. This list must always include the cluster\'s primary zone.
    , locations :: (Core.Maybe [Core.Text])
...
newSetLocationsRequest 
    ::  SetLocationsRequest
newSetLocationsRequest
  = SetLocationsRequest{clusterId = Core.Nothing,
                        locations = Core.Nothing, name = Core.Nothing,
                        projectId = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON SetLocationsRequest where
        parseJSON
          = Core.withObject "SetLocationsRequest"
              (\ o ->
                 SetLocationsRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "locations") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
newSetLoggingServiceRequest 
    ::  SetLoggingServiceRequest
newSetLoggingServiceRequest
  = SetLoggingServiceRequest{clusterId = Core.Nothing,
                             loggingService = Core.Nothing, name = Core.Nothing,
                             projectId = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON SetLoggingServiceRequest where
        parseJSON
          = Core.withObject "SetLoggingServiceRequest"
              (\ o ->
                 SetLoggingServiceRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "loggingService")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
data SetMaintenancePolicyRequest = SetMaintenancePolicyRequest
    ...
    , name :: (Core.Maybe Core.Text)
      -- | Required. The Google Developers Console <https://%7B$universe.dns_names.final_documentation_domain%7D/resource-manager/docs/creating-managing-projects project ID or project number>.
    , projectId :: (Core.Maybe Core.Text)
      -- | Required. The name of the Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zone> in which the cluster resides.
    , zone :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newSetMaintenancePolicyRequest 
    ::  SetMaintenancePolicyRequest
newSetMaintenancePolicyRequest
  = SetMaintenancePolicyRequest{clusterId = Core.Nothing,
                                maintenancePolicy = Core.Nothing, name = Core.Nothing,
                                projectId = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON SetMaintenancePolicyRequest where
        parseJSON
          = Core.withObject "SetMaintenancePolicyRequest"
              (\ o ->
                 SetMaintenancePolicyRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "maintenancePolicy")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
newSetMasterAuthRequest 
    ::  SetMasterAuthRequest
newSetMasterAuthRequest
  = SetMasterAuthRequest{action = Core.Nothing,
                         clusterId = Core.Nothing, name = Core.Nothing,
                         projectId = Core.Nothing, update = Core.Nothing,
                         zone = Core.Nothing}
instance Core.FromJSON SetMasterAuthRequest where
        parseJSON
          = Core.withObject "SetMasterAuthRequest"
              (\ o ->
                 SetMasterAuthRequest Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "clusterId") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "update")
                     Core.<*> (o Core..:? "zone"))
...
newSetMonitoringServiceRequest 
    ::  SetMonitoringServiceRequest
newSetMonitoringServiceRequest
  = SetMonitoringServiceRequest{clusterId = Core.Nothing,
                                monitoringService = Core.Nothing, name = Core.Nothing,
                                projectId = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON SetMonitoringServiceRequest where
        parseJSON
          = Core.withObject "SetMonitoringServiceRequest"
              (\ o ->
                 SetMonitoringServiceRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "monitoringService")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
newSetNetworkPolicyRequest 
    ::  SetNetworkPolicyRequest
newSetNetworkPolicyRequest
  = SetNetworkPolicyRequest{clusterId = Core.Nothing,
                            name = Core.Nothing, networkPolicy = Core.Nothing,
                            projectId = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON SetNetworkPolicyRequest where
        parseJSON
          = Core.withObject "SetNetworkPolicyRequest"
              (\ o ->
                 SetNetworkPolicyRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "networkPolicy")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
newSetNodePoolAutoscalingRequest 
    ::  SetNodePoolAutoscalingRequest
newSetNodePoolAutoscalingRequest
  = SetNodePoolAutoscalingRequest{autoscaling = Core.Nothing,
                                  clusterId = Core.Nothing, name = Core.Nothing,
                                  nodePoolId = Core.Nothing, projectId = Core.Nothing,
                                  zone = Core.Nothing}
instance Core.FromJSON SetNodePoolAutoscalingRequest where
        parseJSON
          = Core.withObject "SetNodePoolAutoscalingRequest"
              (\ o ->
                 SetNodePoolAutoscalingRequest Core.<$>
                   (o Core..:? "autoscaling") Core.<*> (o Core..:? "clusterId")
                     Core.<*> (o Core..:? "name")
...
newSetNodePoolManagementRequest 
    ::  SetNodePoolManagementRequest
newSetNodePoolManagementRequest
  = SetNodePoolManagementRequest{clusterId = Core.Nothing,
                                 management = Core.Nothing, name = Core.Nothing,
                                 nodePoolId = Core.Nothing, projectId = Core.Nothing,
                                 zone = Core.Nothing}
instance Core.FromJSON SetNodePoolManagementRequest where
        parseJSON
          = Core.withObject "SetNodePoolManagementRequest"
              (\ o ->
                 SetNodePoolManagementRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "management")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "nodePoolId")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
newSetNodePoolSizeRequest 
    ::  SetNodePoolSizeRequest
newSetNodePoolSizeRequest
  = SetNodePoolSizeRequest{clusterId = Core.Nothing,
                           name = Core.Nothing, nodeCount = Core.Nothing,
                           nodePoolId = Core.Nothing, projectId = Core.Nothing,
                           zone = Core.Nothing}
instance Core.FromJSON SetNodePoolSizeRequest where
        parseJSON
          = Core.withObject "SetNodePoolSizeRequest"
              (\ o ->
                 SetNodePoolSizeRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "nodeCount")
                     Core.<*> (o Core..:? "nodePoolId")
                     Core.<*> (o Core..:? "projectId")
...
instance Core.FromJSON SoleTenantConfig where
        parseJSON
          = Core.withObject "SoleTenantConfig"
...
newStandardRolloutPolicy 
    ::  StandardRolloutPolicy
newStandardRolloutPolicy
  = StandardRolloutPolicy{batchNodeCount = Core.Nothing,
                          batchPercentage = Core.Nothing, batchSoakDuration = Core.Nothing}
instance Core.FromJSON StandardRolloutPolicy where
        parseJSON
          = Core.withObject "StandardRolloutPolicy"
              (\ o ->
                 StandardRolloutPolicy Core.<$>
                   (o Core..:? "batchNodeCount") Core.<*>
                     (o Core..:? "batchPercentage")
...
newStartIPRotationRequest 
    ::  StartIPRotationRequest
newStartIPRotationRequest
  = StartIPRotationRequest{clusterId = Core.Nothing,
                           name = Core.Nothing, projectId = Core.Nothing,
                           rotateCredentials = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON StartIPRotationRequest where
        parseJSON
          = Core.withObject "StartIPRotationRequest"
              (\ o ->
                 StartIPRotationRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "projectId")
...
instance Core.FromJSON StatefulHAConfig where
        parseJSON
          = Core.withObject "StatefulHAConfig"
...
newStatusCondition 
    ::  StatusCondition
newStatusCondition
  = StatusCondition{canonicalCode = Core.Nothing,
                    code = Core.Nothing, message = Core.Nothing}
instance Core.FromJSON StatusCondition where
        parseJSON
          = Core.withObject "StatusCondition"
              (\ o ->
                 StatusCondition Core.<$>
                   (o Core..:? "canonicalCode") Core.<*> (o Core..:? "code") Core.<*>
                     (o Core..:? "message"))
...
newTimeWindow 
    ::  TimeWindow
newTimeWindow
  = TimeWindow{endTime = Core.Nothing,
               maintenanceExclusionOptions = Core.Nothing,
               startTime = Core.Nothing}
instance Core.FromJSON TimeWindow where
        parseJSON
          = Core.withObject "TimeWindow"
              (\ o ->
                 TimeWindow Core.<$>
                   (o Core..:? "endTime") Core.<*>
                     (o Core..:? "maintenanceExclusionOptions")
                     Core.<*> (o Core..:? "startTime"))
...
instance Core.ToJSON TimeWindow where
        toJSON TimeWindow{..}
          = Core.object
              (Core.catMaybes
                 [("endTime" Core..=) Core.<$> endTime,
                  ("maintenanceExclusionOptions" Core..=) Core.<$>
                    maintenanceExclusionOptions,
                  ("startTime" Core..=) Core.<$> startTime])
...
--
-- /See:/ 'newTopologyManager' smart constructor.
data TopologyManager = TopologyManager
    {
      ...
      -- <https://kubernetes.io/docs/tasks/administer-cluster/topology-manager/#topology-manager-policies here>.
      policy :: (Core.Maybe Core.Text)
...
-- | Creates a value of 'TopologyManager' with the minimum fields required to make a request.
newTopologyManager 
    ::  TopologyManager
newTopologyManager
  = TopologyManager{policy = Core.Nothing, scope = Core.Nothing}
instance Core.FromJSON TopologyManager where
        parseJSON
          = Core.withObject "TopologyManager"
              (\ o ->
                 TopologyManager Core.<$>
                   (o Core..:? "policy") Core.<*> (o Core..:? "scope"))

instance Core.ToJSON TopologyManager where
        toJSON TopologyManager{..}
          = Core.object
              (Core.catMaybes
...
newUpdateClusterRequest 
    ::  UpdateClusterRequest
newUpdateClusterRequest
  = UpdateClusterRequest{clusterId = Core.Nothing,
                         name = Core.Nothing, projectId = Core.Nothing,
                         update = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON UpdateClusterRequest where
        parseJSON
          = Core.withObject "UpdateClusterRequest"
              (\ o ->
                 UpdateClusterRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "projectId")
                     Core.<*> (o Core..:? "update")
                     Core.<*> (o Core..:? "zone"))
...
newUpdateMasterRequest 
    ::  UpdateMasterRequest
newUpdateMasterRequest
  = UpdateMasterRequest{clusterId = Core.Nothing,
                        masterVersion = Core.Nothing, name = Core.Nothing,
                        projectId = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON UpdateMasterRequest where
        parseJSON
          = Core.withObject "UpdateMasterRequest"
              (\ o ->
                 UpdateMasterRequest Core.<$>
                   (o Core..:? "clusterId") Core.<*> (o Core..:? "masterVersion")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "zone"))
...
data UpdateNodePoolRequest = UpdateNodePoolRequest
    ...
    , gvnic :: (Core.Maybe VirtualNIC)
      -- | Required. The desired image type for the node pool. Please see https:\/\/{$universe.dns/names.final/documentation_domain}\/kubernetes-engine\/docs\/concepts\/node-images for available image types.
    , imageType :: (Core.Maybe Core.Text)
      -- | Node kubelet configs.
    , kubeletConfig :: (Core.Maybe NodeKubeletConfig)
    ...
    , labels :: (Core.Maybe NodeLabels)
      -- | Parameters that can be configured on Linux nodes.
    , linuxNodeConfig :: (Core.Maybe LinuxNodeConfig)
      -- | The desired list of Google Compute Engine <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/zones#available zones> in which the node pool\'s nodes should be located. Changing the locations for a node pool will result in nodes being either created or removed from the node pool, depending on whether locations are being added or removed.
    , locations :: (Core.Maybe [Core.Text])
      -- | Logging configuration.
    , loggingConfig :: (Core.Maybe NodePoolLoggingConfig)
      -- | Optional. The desired <https://%7B$universe.dns_names.final_documentation_domain%7D/compute/docs/machine-types Google Compute Engine machine type> for nodes in the node pool. Initiates an upgrade operation that migrates the nodes in the node pool to the specified machine type.
    , machineType :: (Core.Maybe Core.Text)
      -- | The maximum duration for the nodes to exist. If unspecified, the nodes can exist indefinitely.
    , maxRunDuration :: (Core.Maybe Core.Duration)
...
newUpdateNodePoolRequest 
    ::  UpdateNodePoolRequest
newUpdateNodePoolRequest
  = UpdateNodePoolRequest{accelerators = Core.Nothing,
                          clusterId = Core.Nothing, confidentialNodes = Core.Nothing,
                          containerdConfig = Core.Nothing, diskSizeGb = Core.Nothing,
                          diskType = Core.Nothing, etag = Core.Nothing,
                          fastSocket = Core.Nothing, flexStart = Core.Nothing,
                          gcfsConfig = Core.Nothing, gvnic = Core.Nothing,
                          imageType = Core.Nothing, kubeletConfig = Core.Nothing,
                          labels = Core.Nothing, linuxNodeConfig = Core.Nothing,
                          locations = Core.Nothing, loggingConfig = Core.Nothing,
                          machineType = Core.Nothing, maxRunDuration = Core.Nothing,
                          name = Core.Nothing, nodeNetworkConfig = Core.Nothing,
                          nodePoolId = Core.Nothing, nodeVersion = Core.Nothing,
                          projectId = Core.Nothing, queuedProvisioning = Core.Nothing,
                          resourceLabels = Core.Nothing, resourceManagerTags = Core.Nothing,
                          storagePools = Core.Nothing, tags = Core.Nothing,
                          taints = Core.Nothing, upgradeSettings = Core.Nothing,
                          windowsNodeConfig = Core.Nothing,
                          workloadMetadataConfig = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON UpdateNodePoolRequest where
        parseJSON
          = Core.withObject "UpdateNodePoolRequest"
              (\ o ->
                 UpdateNodePoolRequest Core.<$>
                   (o Core..:? "accelerators") Core.<*> (o Core..:? "clusterId")
                     Core.<*> (o Core..:? "confidentialNodes")
                     Core.<*> (o Core..:? "containerdConfig")
                     Core.<*>
                     (o Core..:? "diskSizeGb" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "diskType")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "fastSocket")
                     Core.<*> (o Core..:? "flexStart")
...
newUpgradeAvailableEvent 
    ::  UpgradeAvailableEvent
newUpgradeAvailableEvent
  = UpgradeAvailableEvent{releaseChannel = Core.Nothing,
                          resource = Core.Nothing, resourceType = Core.Nothing,
                          version = Core.Nothing}
instance Core.FromJSON UpgradeAvailableEvent where
        parseJSON
          = Core.withObject "UpgradeAvailableEvent"
              (\ o ->
                 UpgradeAvailableEvent Core.<$>
                   (o Core..:? "releaseChannel") Core.<*> (o Core..:? "resource")
                     Core.<*> (o Core..:? "resourceType")
                     Core.<*> (o Core..:? "version"))
...
--
-- /See:/ 'newUpgradeDetails' smart constructor.
data UpgradeDetails = UpgradeDetails
    {
      -- | The end timestamp of the upgrade.
      endTime :: (Core.Maybe Core.DateTime)
      -- | The version before the upgrade.
    , initialVersion :: (Core.Maybe Core.Text)
      -- | The start timestamp of the upgrade.
    , startTime :: (Core.Maybe Core.DateTime)
      -- | The start type of the upgrade.
    , startType :: (Core.Maybe UpgradeDetails_StartType)
      -- | Output only. The state of the upgrade.
    , state :: (Core.Maybe UpgradeDetails_State)
      -- | The version after the upgrade.
    , targetVersion :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'UpgradeDetails' with the minimum fields required to make a request.
newUpgradeDetails 
    ::  UpgradeDetails
newUpgradeDetails
  = UpgradeDetails{endTime = Core.Nothing,
                   initialVersion = Core.Nothing, startTime = Core.Nothing,
                   startType = Core.Nothing, state = Core.Nothing,
                   targetVersion = Core.Nothing}
instance Core.FromJSON UpgradeDetails where
        parseJSON
          = Core.withObject "UpgradeDetails"
              (\ o ->
                 UpgradeDetails Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "initialVersion")
                     Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "startType")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "targetVersion"))

instance Core.ToJSON UpgradeDetails where
        toJSON UpgradeDetails{..}
          = Core.object
              (Core.catMaybes
                 [("endTime" Core..=) Core.<$> endTime,
                  ("initialVersion" Core..=) Core.<$> initialVersion,
                  ("startTime" Core..=) Core.<$> startTime,
                  ("startType" Core..=) Core.<$> startType,
                  ("state" Core..=) Core.<$> state,
...
newUpgradeEvent 
    ::  UpgradeEvent
newUpgradeEvent
  = UpgradeEvent{currentVersion = Core.Nothing,
                 operation = Core.Nothing, operationStartTime = Core.Nothing,
                 resource = Core.Nothing, resourceType = Core.Nothing,
                 targetVersion = Core.Nothing}
instance Core.FromJSON UpgradeEvent where
        parseJSON
          = Core.withObject "UpgradeEvent"
              (\ o ->
                 UpgradeEvent Core.<$>
                   (o Core..:? "currentVersion") Core.<*> (o Core..:? "operation")
...
newUpgradeInfoEvent 
    ::  UpgradeInfoEvent
newUpgradeInfoEvent
  = UpgradeInfoEvent{currentVersion = Core.Nothing,
                     description = Core.Nothing, endTime = Core.Nothing,
                     eventType = Core.Nothing, extendedSupportEndTime = Core.Nothing,
                     operation = Core.Nothing, resource = Core.Nothing,
                     resourceType = Core.Nothing, standardSupportEndTime = Core.Nothing,
                     startTime = Core.Nothing, state = Core.Nothing,
                     targetVersion = Core.Nothing}
instance Core.FromJSON UpgradeInfoEvent where
        parseJSON
          = Core.withObject "UpgradeInfoEvent"
              (\ o ->
                 UpgradeInfoEvent Core.<$>
                   (o Core..:? "currentVersion") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "endTime")
...
newUpgradeSettings 
    ::  UpgradeSettings
newUpgradeSettings
  = UpgradeSettings{blueGreenSettings = Core.Nothing,
                    maxSurge = Core.Nothing, maxUnavailable = Core.Nothing,
                    strategy = Core.Nothing}
instance Core.FromJSON UpgradeSettings where
        parseJSON
          = Core.withObject "UpgradeSettings"
              (\ o ->
                 UpgradeSettings Core.<$>
                   (o Core..:? "blueGreenSettings") Core.<*> (o Core..:? "maxSurge")
...
newUsableSubnetwork 
    ::  UsableSubnetwork
newUsableSubnetwork
  = UsableSubnetwork{ipCidrRange = Core.Nothing,
                     network = Core.Nothing, secondaryIpRanges = Core.Nothing,
                     statusMessage = Core.Nothing, subnetwork = Core.Nothing}
instance Core.FromJSON UsableSubnetwork where
        parseJSON
          = Core.withObject "UsableSubnetwork"
              (\ o ->
                 UsableSubnetwork Core.<$>
                   (o Core..:? "ipCidrRange") Core.<*> (o Core..:? "network") Core.<*>
                     (o Core..:? "secondaryIpRanges")
                     Core.<*> (o Core..:? "statusMessage")
                     Core.<*> (o Core..:? "subnetwork"))
...
newUsableSubnetworkSecondaryRange 
    ::  UsableSubnetworkSecondaryRange
newUsableSubnetworkSecondaryRange
  = UsableSubnetworkSecondaryRange{ipCidrRange = Core.Nothing,
                                   rangeName = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON UsableSubnetworkSecondaryRange where
        parseJSON
          = Core.withObject "UsableSubnetworkSecondaryRange"
              (\ o ->
                 UsableSubnetworkSecondaryRange Core.<$>
                   (o Core..:? "ipCidrRange") Core.<*> (o Core..:? "rangeName")
                     Core.<*> (o Core..:? "status"))
...
newUserManagedKeysConfig 
    ::  UserManagedKeysConfig
newUserManagedKeysConfig
  = UserManagedKeysConfig{aggregationCa = Core.Nothing,
                          clusterCa = Core.Nothing,
                          controlPlaneDiskEncryptionKey = Core.Nothing,
                          etcdApiCa = Core.Nothing, etcdPeerCa = Core.Nothing,
...
instance Core.FromJSON UserManagedKeysConfig where
        parseJSON
          = Core.withObject "UserManagedKeysConfig"
              (\ o ->
                 UserManagedKeysConfig Core.<$>
                   (o Core..:? "aggregationCa") Core.<*> (o Core..:? "clusterCa")
          ...
          = Core.object
              (Core.catMaybes
                 [("aggregationCa" Core..=) Core.<$> aggregationCa,
                  ...
                  ("controlPlaneDiskEncryptionKey" Core..=) Core.<$>
                    controlPlaneDiskEncryptionKey,
                  ("etcdApiCa" Core..=) Core.<$> etcdApiCa,
                  ("etcdPeerCa" Core..=) Core.<$> etcdPeerCa,
                  ("gkeopsEtcdBackupEncryptionKey" Core..=) Core.<$>
                    gkeopsEtcdBackupEncryptionKey,
                  ("serviceAccountSigningKeys" Core..=) Core.<$>
                    serviceAccountSigningKeys,
                  ("serviceAccountVerificationKeys" Core..=) Core.<$>
...
instance Core.FromJSON VerticalPodAutoscaling where
        parseJSON
          = Core.withObject "VerticalPodAutoscaling"
...
instance Core.FromJSON WindowsNodeConfig where
        parseJSON
          = Core.withObject "WindowsNodeConfig"
...
instance Core.FromJSON WorkloadIdentityConfig where
        parseJSON
          = Core.withObject "WorkloadIdentityConfig"
              (\ o ->
...
instance Core.FromJSON WorkloadMetadataConfig where
        parseJSON
          = Core.withObject "WorkloadMetadataConfig"
...
instance Core.FromJSON WorkloadPolicyConfig where
        parseJSON
          = Core.withObject "WorkloadPolicyConfig"
              (\ o ->
                 WorkloadPolicyConfig Core.<$>
                   (o Core..:? "allowNetAdmin") Core.<*>
                     (o Core..:? "autopilotCompatibilityAuditingEnabled"))
          ...
          = Core.object
              (Core.catMaybes
                 [("allowNetAdmin" Core..=) Core.<$> allowNetAdmin,
                  ("autopilotCompatibilityAuditingEnabled" Core..=) Core.<$>
