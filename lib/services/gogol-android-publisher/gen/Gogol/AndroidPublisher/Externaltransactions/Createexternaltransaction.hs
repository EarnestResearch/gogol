     ...
     "androidpublisher" Core.:>
       "v3" Core.:>
         Core.Capture "parent" Core.Text Core.:>
           "externalTransactions" Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "externalTransactionId" Core.Text
                     Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ExternalTransaction Core.:>
                             Core.Post '[Core.JSON] ExternalTransaction
...
newAndroidPublisherExternaltransactionsCreateexternaltransaction 
    ...
    -> AndroidPublisherExternaltransactionsCreateexternaltransaction
newAndroidPublisherExternaltransactionsCreateexternaltransaction parent payload =
  AndroidPublisherExternaltransactionsCreateexternaltransaction
    { xgafv = Core.Nothing
