                 ...
                 "bundles" Core.:>
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "ackBundleInstallationWarning"
                         Core.Bool
                         Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "deviceTierConfigId" Core.Text
                             Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text
                                 Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Post '[Core.JSON] Bundle
       Core.:<|>
       "upload" Core.:>
         "androidpublisher" Core.:>
           "v3" Core.:>
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherEditsBundlesUpload =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherEditsBundlesUpload{..}
          = go packageName editId xgafv accessToken
...
instance Core.GoogleRequest
        ...
        requestClient
          (Core.MediaUpload
             AndroidPublisherEditsBundlesUpload{..} body)
          = go packageName editId xgafv accessToken
              ackBundleInstallationWarning
              callback
              deviceTierConfigId
