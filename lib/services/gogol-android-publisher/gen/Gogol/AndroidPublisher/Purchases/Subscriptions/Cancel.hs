...
newAndroidPublisherPurchasesSubscriptionsCancel 
    ...
    -> Core.Text
       -- ^  Note: Since May 21, 2025, subscription_id is not required, and not recommended for subscription with add-ons. The purchased subscription ID (for example, \'monthly001\'). See 'subscriptionId'.
    -> Core.Text
       -- ^  The token provided to the user\'s device when the subscription was purchased. See 'token'.
    -> AndroidPublisherPurchasesSubscriptionsCancel
newAndroidPublisherPurchasesSubscriptionsCancel packageName
  subscriptionId token
  = AndroidPublisherPurchasesSubscriptionsCancel{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing, packageName = packageName,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherPurchasesSubscriptionsCancel =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherPurchasesSubscriptionsCancel{..}
          = go packageName subscriptionId token xgafv accessToken callback
              uploadType
              uploadProtocol
