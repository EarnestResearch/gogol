...
instance Core.GoogleRequest
           AndroidPublisherPurchasesVoidedpurchasesList
         where
        type Rs AndroidPublisherPurchasesVoidedpurchasesList
             = VoidedPurchasesListResponse
        type Scopes
               AndroidPublisherPurchasesVoidedpurchasesList
        ...
        requestClient
          AndroidPublisherPurchasesVoidedpurchasesList{..}
          = go packageName xgafv accessToken callback endTime
              maxResults
              startIndex
              startTime
              token
