...
instance Core.ToJSON ActivateSubscriptionOfferRequest
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON ApksAddExternallyHostedRequest
         where
        parseJSON
...
instance Core.ToJSON ApksAddExternallyHostedRequest
         where
        toJSON ApksAddExternallyHostedRequest{..}
          = Core.object
              (Core.catMaybes
                 [("externallyHostedApk" Core..=) Core.<$>
                    externallyHostedApk])
...
instance Core.ToJSON ApksAddExternallyHostedResponse
         where
...
instance Core.FromJSON ArchiveSubscriptionRequest
         where
        parseJSON
              ...
              (\ o ->
                 AutoRenewingBasePlanType Core.<$>
                   (o Core..:? "billingPeriodDuration") Core.<*>
                     (o Core..:? "gracePeriodDuration")
                     Core.<*> (o Core..:? "legacyCompatible")
                     Core.<*>
                     (o Core..:? "legacyCompatibleSubscriptionOfferId")
...
newAutoRenewingPlan =
  AutoRenewingPlan
    {autoRenewEnabled = Core.Nothing, priceChangeDetails = Core.Nothing}
              ...
              (\ o ->
                 AutoRenewingPlan Core.<$>
                   (o Core..:? "autoRenewEnabled") Core.<*>
                     (o Core..:? "priceChangeDetails"))

instance Core.ToJSON AutoRenewingPlan where
        toJSON AutoRenewingPlan{..}
          = Core.object
              (Core.catMaybes
                 [("autoRenewEnabled" Core..=) Core.<$>
                    autoRenewEnabled,
                  ("priceChangeDetails" Core..=) Core.<$>
                    priceChangeDetails])
          ...
          = Core.object
              (Core.catMaybes
                 [("autoRenewingBasePlanType" Core..=) Core.<$>
                  ...
                  ("otherRegionsConfig" Core..=) Core.<$>
                    otherRegionsConfig,
                  ("prepaidBasePlanType" Core..=) Core.<$>
                    prepaidBasePlanType,
...
newBundle =
  Bundle
    {sha1 = Core.Nothing, sha256 = Core.Nothing, versionCode = Core.Nothing}
          ...
          = Core.withObject "CanceledStateContext"
              (\ o ->
                 CanceledStateContext Core.<$>
                   (o Core..:? "developerInitiatedCancellation")
...
instance Core.FromJSON ConvertRegionPricesRequest
         where
        parseJSON
          = Core.withObject "ConvertRegionPricesRequest"
              (\ o ->
                 ConvertRegionPricesRequest Core.<$>
                   (o Core..:? "price"))
...
instance Core.FromJSON ConvertRegionPricesResponse
         where
        parseJSON
...
instance Core.ToJSON ConvertRegionPricesResponse
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("convertedOtherRegionsPrice" Core..=) Core.<$>
                    convertedOtherRegionsPrice,
                  ("convertedRegionPrices" Core..=) Core.<$>
...
instance Core.FromJSON ConvertedOtherRegionsPrice
         where
        parseJSON
...
newConvertedRegionPrice =
  ConvertedRegionPrice
    {price = Core.Nothing, regionCode = Core.Nothing, taxAmount = Core.Nothing}
...
instance Core.FromJSON DeactivateBasePlanRequest
         where
        parseJSON
...
instance Core.ToJSON DeobfuscationFilesUploadResponse
         where
        toJSON DeobfuscationFilesUploadResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deobfuscationFile" Core..=) Core.<$>
                    deobfuscationFile])
...
instance Core.FromJSON DeveloperInitiatedCancellation
         where
        parseJSON
          = Core.withObject "DeveloperInitiatedCancellation"
              (\ o -> Core.pure DeveloperInitiatedCancellation)

instance Core.ToJSON DeveloperInitiatedCancellation
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON DeviceRam where
        parseJSON
          = Core.withObject "DeviceRam"
              (\ o ->
                 DeviceRam Core.<$>
                   (o Core..:? "maxBytes" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minBytes" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON DeviceRam where
        toJSON DeviceRam{..}
          = Core.object
              (Core.catMaybes
                 [("maxBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxBytes,
                  ("minBytes" Core..=) Core.. Core.AsText Core.<$>
                    minBytes])
...
instance Core.FromJSON DeviceSelector where
        parseJSON
          = Core.withObject "DeviceSelector"
              (\ o ->
                 DeviceSelector Core.<$>
                   (o Core..:? "deviceRam") Core.<*>
                     (o Core..:? "excludedDeviceIds")
          ...
          = Core.object
              (Core.catMaybes
                 [("deviceRam" Core..=) Core.<$> deviceRam,
                  ("excludedDeviceIds" Core..=) Core.<$>
                    excludedDeviceIds,
                  ("forbiddenSystemFeatures" Core..=) Core.<$>
                    forbiddenSystemFeatures,
                  ("includedDeviceIds" Core..=) Core.<$>
                    includedDeviceIds,
                  ("requiredSystemFeatures" Core..=) Core.<$>
...
instance Core.FromJSON DeviceSpec where
        parseJSON
          = Core.withObject "DeviceSpec"
              (\ o ->
                 DeviceSpec Core.<$>
                   (o Core..:? "screenDensity") Core.<*>
                     (o Core..:? "supportedAbis")
...
instance Core.FromJSON ExpansionFilesUploadResponse
         where
        parseJSON
          = Core.withObject "ExpansionFilesUploadResponse"
              (\ o ->
                 ExpansionFilesUploadResponse Core.<$>
                   (o Core..:? "expansionFile"))

instance Core.ToJSON ExpansionFilesUploadResponse
         where
...
instance Core.FromJSON ExternalAccountIdentifiers
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("currentPreTaxAmount" Core..=) Core.<$>
                    currentPreTaxAmount,
                  ("currentTaxAmount" Core..=) Core.<$>
                    currentTaxAmount,
                  ("externalTransactionId" Core..=) Core.<$>
                    externalTransactionId,
                  ("oneTimeTransaction" Core..=) Core.<$>
                    oneTimeTransaction,
                  ("originalPreTaxAmount" Core..=) Core.<$>
                    originalPreTaxAmount,
                  ("originalTaxAmount" Core..=) Core.<$>
                    originalTaxAmount,
                  ("packageName" Core..=) Core.<$> packageName,
                  ("recurringTransaction" Core..=) Core.<$>
                    recurringTransaction,
                  ("testPurchase" Core..=) Core.<$> testPurchase,
                  ("transactionState" Core..=) Core.<$>
                    transactionState,
...
newtype ExternalTransactionAddress = ExternalTransactionAddress
    {
...
newExternalTransactionAddress 
    ::  ExternalTransactionAddress
newExternalTransactionAddress =
  ExternalTransactionAddress {regionCode = Core.Nothing}

instance Core.FromJSON ExternalTransactionAddress
         where
        parseJSON
...
newExternalTransactionTestPurchase 
    ::  ExternalTransactionTestPurchase
newExternalTransactionTestPurchase = ExternalTransactionTestPurchase
...
instance Core.ToJSON ExternalTransactionTestPurchase
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.ToJSON ExternallyHostedApk where
        toJSON ExternallyHostedApk{..}
          = Core.object
              (Core.catMaybes
                 [("applicationLabel" Core..=) Core.<$>
                    applicationLabel,
                  ("certificateBase64s" Core..=) Core.<$>
                    certificateBase64s,
                  ("externallyHostedUrl" Core..=) Core.<$>
                    externallyHostedUrl,
                  ("fileSha1Base64" Core..=) Core.<$> fileSha1Base64,
                  ("fileSha256Base64" Core..=) Core.<$>
                    fileSha256Base64,
                  ("fileSize" Core..=) Core.. Core.AsText Core.<$>
                    fileSize,
...
instance Core.FromJSON FullRefund where
        parseJSON
          = Core.withObject "FullRefund"
              (\ o -> Core.pure FullRefund)
...
instance Core.FromJSON GeneratedApksListResponse
         where
        parseJSON
          = Core.withObject "GeneratedApksListResponse"
              (\ o ->
                 GeneratedApksListResponse Core.<$>
                   (o Core..:? "generatedApks"))
...
instance Core.FromJSON GeneratedApksPerSigningKey
         where
        parseJSON
...
instance Core.ToJSON GeneratedApksPerSigningKey where
        toJSON GeneratedApksPerSigningKey{..}
          = Core.object
              (Core.catMaybes
                 [("certificateSha256Hash" Core..=) Core.<$>
                    certificateSha256Hash,
                  ("generatedAssetPackSlices" Core..=) Core.<$>
                    generatedAssetPackSlices,
                  ("generatedSplitApks" Core..=) Core.<$>
                    generatedSplitApks,
                  ("generatedStandaloneApks" Core..=) Core.<$>
                    generatedStandaloneApks,
                  ("generatedUniversalApk" Core..=) Core.<$>
                    generatedUniversalApk])
...
instance Core.FromJSON Grant where
        parseJSON
          = Core.withObject "Grant"
              (\ o ->
                 Grant Core.<$>
                   (o Core..:? "appLevelPermissions") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "packageName"))
              ...
              (\ o ->
                 InAppProduct Core.<$>
                   (o Core..:? "defaultLanguage") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "subscriptionTaxesAndComplianceSettings")
...
newInAppProductListing =
  InAppProductListing
    {benefits = Core.Nothing, description = Core.Nothing, title = Core.Nothing}
...
instance Core.FromJSON InappproductsListResponse
         where
        parseJSON
          = Core.withObject "InappproductsListResponse"
              (\ o ->
                 InappproductsListResponse Core.<$>
                   (o Core..:? "inappproduct") Core.<*>
                     (o Core..:? "kind")
...
instance Core.FromJSON InternalAppSharingArtifact
         where
        parseJSON
...
instance Core.ToJSON IntroductoryPriceInfo where
        toJSON IntroductoryPriceInfo{..}
          = Core.object
              (Core.catMaybes
                 [("introductoryPriceAmountMicros" Core..=) Core..
                    Core.AsText
...
newListDeviceTierConfigsResponse =
  ListDeviceTierConfigsResponse
    {deviceTierConfigs = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListDeviceTierConfigsResponse
         where
        parseJSON
...
instance Core.ToJSON ListDeviceTierConfigsResponse
         where
        toJSON ListDeviceTierConfigsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deviceTierConfigs" Core..=) Core.<$>
                    deviceTierConfigs,
...
newListSubscriptionOffersResponse =
  ListSubscriptionOffersResponse
    {nextPageToken = Core.Nothing, subscriptionOffers = Core.Nothing}

instance Core.FromJSON ListSubscriptionOffersResponse
         where
        parseJSON
...
instance Core.ToJSON ListSubscriptionOffersResponse
         where
        toJSON ListSubscriptionOffersResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("subscriptionOffers" Core..=) Core.<$>
                    subscriptionOffers])
...
newListSubscriptionsResponse =
  ListSubscriptionsResponse
    {nextPageToken = Core.Nothing, subscriptions = Core.Nothing}

instance Core.FromJSON ListSubscriptionsResponse
         where
        parseJSON
              ...
              (\ o ->
                 ManagedProductTaxAndComplianceSettings Core.<$>
                   (o Core..:? "eeaWithdrawalRightType") Core.<*>
                     (o Core..:? "taxRateInfoByRegionCode"))
...
newMigrateBasePlanPricesRequest =
  MigrateBasePlanPricesRequest
    {regionalPriceMigrations = Core.Nothing, regionsVersion = Core.Nothing}

instance Core.FromJSON MigrateBasePlanPricesRequest
         where
        parseJSON
          = Core.withObject "MigrateBasePlanPricesRequest"
              (\ o ->
                 MigrateBasePlanPricesRequest Core.<$>
                   (o Core..:? "regionalPriceMigrations") Core.<*>
                     (o Core..:? "regionsVersion"))

instance Core.ToJSON MigrateBasePlanPricesRequest
         where
...
instance Core.FromJSON MigrateBasePlanPricesResponse
         where
        parseJSON
          = Core.withObject "MigrateBasePlanPricesResponse"
              (\ o -> Core.pure MigrateBasePlanPricesResponse)

instance Core.ToJSON MigrateBasePlanPricesResponse
         where
        toJSON = Core.const Core.emptyObject
...
newOneTimeExternalTransaction 
    ::  OneTimeExternalTransaction
newOneTimeExternalTransaction =
  OneTimeExternalTransaction {externalTransactionToken = Core.Nothing}

instance Core.FromJSON OneTimeExternalTransaction
         where
        parseJSON
...
instance Core.FromJSON OtherRegionsBasePlanConfig
         where
        parseJSON
          ...
          = Core.withObject
              ...
              (\ o ->
                 OtherRegionsSubscriptionOfferPhaseConfig Core.<$>
                   (o Core..:? "absoluteDiscounts") Core.<*>
                     (o Core..:? "otherRegionsPrices")
...
instance Core.ToJSON
        ...
        toJSON OtherRegionsSubscriptionOfferPhaseConfig{..}
          = Core.object
              (Core.catMaybes
                 [("absoluteDiscounts" Core..=) Core.<$>
                    absoluteDiscounts,
                  ("otherRegionsPrices" Core..=) Core.<$>
                    otherRegionsPrices,
                  ("relativeDiscount" Core..=) Core.<$>
                    relativeDiscount])
...
newOtherRegionsSubscriptionOfferPhasePrices =
  OtherRegionsSubscriptionOfferPhasePrices
    {eurPrice = Core.Nothing, usdPrice = Core.Nothing}
...
newPartialRefund 
    ::  PartialRefund
newPartialRefund =
  PartialRefund {refundId = Core.Nothing, refundPreTaxAmount = Core.Nothing}
...
instance Core.FromJSON PartialRefund where
        parseJSON
          = Core.withObject "PartialRefund"
              (\ o ->
                 PartialRefund Core.<$>
                   (o Core..:? "refundId") Core.<*>
                     (o Core..:? "refundPreTaxAmount"))
...
newPrepaidBasePlanType =
  PrepaidBasePlanType
    {billingPeriodDuration = Core.Nothing, timeExtension = Core.Nothing}
...
instance Core.FromJSON PrepaidPlan where
        parseJSON
          = Core.withObject "PrepaidPlan"
              (\ o ->
                 PrepaidPlan Core.<$>
                   (o Core..:? "allowExtendAfterTime"))

instance Core.ToJSON PrepaidPlan where
        toJSON PrepaidPlan{..}
          = Core.object
              (Core.catMaybes
                 [("allowExtendAfterTime" Core..=) Core.<$>
...
instance Core.ToJSON ProductPurchase where
        toJSON ProductPurchase{..}
          = Core.object
              (Core.catMaybes
                 [("acknowledgementState" Core..=) Core.<$>
                    acknowledgementState,
                  ("consumptionState" Core..=) Core.<$>
                    consumptionState,
                  ("developerPayload" Core..=) Core.<$>
                    developerPayload,
                  ("kind" Core..=) Core.<$> kind,
                  ("obfuscatedExternalAccountId" Core..=) Core.<$>
                    obfuscatedExternalAccountId,
...
instance Core.FromJSON RecurringExternalTransaction
         where
        parseJSON
...
instance Core.ToJSON RecurringExternalTransaction
         where
        toJSON RecurringExternalTransaction{..}
          = Core.object
              (Core.catMaybes
                 [("externalSubscription" Core..=) Core.<$>
                    externalSubscription,
                  ("externalTransactionToken" Core..=) Core.<$>
                    externalTransactionToken,
          ...
          = Core.withObject "RefundExternalTransactionRequest"
              (\ o ->
                 RefundExternalTransactionRequest Core.<$>
                   (o Core..:? "fullRefund") Core.<*>
                     (o Core..:? "partialRefund")
                     Core.<*> (o Core..:? "refundTime"))

instance Core.ToJSON RefundExternalTransactionRequest
         where
...
newRegionalPriceMigrationConfig =
  RegionalPriceMigrationConfig
    {oldestAllowedPriceVersionTime = Core.Nothing, regionCode = Core.Nothing}

instance Core.FromJSON RegionalPriceMigrationConfig
         where
        parseJSON
...
instance Core.ToJSON RegionalPriceMigrationConfig
         where
...
newRegionalSubscriptionOfferConfig =
  RegionalSubscriptionOfferConfig
    {newSubscriberAvailability' = Core.Nothing, regionCode = Core.Nothing}
...
instance Core.ToJSON RegionalSubscriptionOfferConfig
         where
          ...
          = Core.withObject "RegionalTaxRateInfo"
              (\ o ->
                 RegionalTaxRateInfo Core.<$>
                   (o Core..:? "eligibleForStreamingServiceTaxRate")
...
newSubscriptionCancelSurveyResult =
  SubscriptionCancelSurveyResult
    {cancelSurveyReason = Core.Nothing, userInputCancelReason = Core.Nothing}

instance Core.FromJSON SubscriptionCancelSurveyResult
         where
        parseJSON
...
instance Core.ToJSON SubscriptionCancelSurveyResult
         where
        toJSON SubscriptionCancelSurveyResult{..}
          = Core.object
              (Core.catMaybes
                 [("cancelSurveyReason" Core..=) Core.<$>
                    cancelSurveyReason,
                  ("userInputCancelReason" Core..=) Core.<$>
...
instance Core.ToJSON SubscriptionDeferralInfo where
        toJSON SubscriptionDeferralInfo{..}
          = Core.object
              (Core.catMaybes
                 [("desiredExpiryTimeMillis" Core..=) Core..
                    Core.AsText
                    Core.<$> desiredExpiryTimeMillis,
                  ("expectedExpiryTimeMillis" Core..=) Core..
                    Core.AsText
...
newSubscriptionOfferTargeting =
  SubscriptionOfferTargeting
    {acquisitionRule = Core.Nothing, upgradeRule = Core.Nothing}

instance Core.FromJSON SubscriptionOfferTargeting
         where
        parseJSON
          = Core.withObject "SubscriptionOfferTargeting"
              (\ o ->
                 SubscriptionOfferTargeting Core.<$>
                   (o Core..:? "acquisitionRule") Core.<*>
                     (o Core..:? "upgradeRule"))
          ...
          = Core.object
              (Core.catMaybes
                 [("acknowledgementState" Core..=) Core.<$>
                  ...
                  ("familyName" Core..=) Core.<$> familyName,
                  ("givenName" Core..=) Core.<$> givenName,
                  ("introductoryPriceInfo" Core..=) Core.<$>
                    introductoryPriceInfo,
                  ("kind" Core..=) Core.<$> kind,
                  ("linkedPurchaseToken" Core..=) Core.<$>
                    linkedPurchaseToken,
                  ("obfuscatedExternalAccountId" Core..=) Core.<$>
                    obfuscatedExternalAccountId,
                  ("obfuscatedExternalProfileId" Core..=) Core.<$>
                  ...
                  ("userCancellationTimeMillis" Core..=) Core..
                    Core.AsText
...
instance Core.FromJSON SubscriptionPurchaseLineItem
         where
        parseJSON
...
instance Core.ToJSON SubscriptionPurchaseLineItem
         where
        toJSON SubscriptionPurchaseLineItem{..}
          = Core.object
              (Core.catMaybes
                 [("autoRenewingPlan" Core..=) Core.<$>
                    autoRenewingPlan,
        ...
        toJSON SubscriptionPurchaseV2{..}
          = Core.object
              (Core.catMaybes
                 [("acknowledgementState" Core..=) Core.<$>
                    acknowledgementState,
                  ("canceledStateContext" Core..=) Core.<$>
                    canceledStateContext,
                  ...
                  ("linkedPurchaseToken" Core..=) Core.<$>
                    linkedPurchaseToken,
                  ("pausedStateContext" Core..=) Core.<$>
                    pausedStateContext,
                  ("regionCode" Core..=) Core.<$> regionCode,
                  ("startTime" Core..=) Core.<$> startTime,
                  ("subscribeWithGoogleInfo" Core..=) Core.<$>
                    subscribeWithGoogleInfo,
                  ("subscriptionState" Core..=) Core.<$>
                    subscriptionState,
                  ("testPurchase" Core..=) Core.<$> testPurchase])
...
instance Core.FromJSON SystemInitiatedCancellation
         where
        parseJSON
          = Core.withObject "SystemInitiatedCancellation"
              (\ o -> Core.pure SystemInitiatedCancellation)

instance Core.ToJSON SystemInitiatedCancellation
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.ToJSON Timestamp where
        toJSON Timestamp{..}
          = Core.object
              (Core.catMaybes
                 [("nanos" Core..=) Core.<$> nanos,
                  ("seconds" Core..=) Core.. Core.AsText Core.<$>
                    seconds])
...
newTokenPagination =
  TokenPagination
    {nextPageToken = Core.Nothing, previousPageToken = Core.Nothing}
...
instance Core.ToJSON TrackRelease where
        toJSON TrackRelease{..}
          = Core.object
              (Core.catMaybes
                 [("countryTargeting" Core..=) Core.<$>
                    countryTargeting,
                  ("inAppUpdatePriority" Core..=) Core.<$>
                    inAppUpdatePriority,
                  ("name" Core..=) Core.<$> name,
...
newUserInitiatedCancellation =
  UserInitiatedCancellation
    {cancelSurveyResult = Core.Nothing, cancelTime = Core.Nothing}

instance Core.FromJSON UserInitiatedCancellation
         where
        parseJSON
...
instance Core.FromJSON VoidedPurchase where
        parseJSON
          = Core.withObject "VoidedPurchase"
              (\ o ->
                 VoidedPurchase Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "orderId")
                     Core.<*>
                     (o Core..:? "purchaseTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "purchaseToken")
...
instance Core.FromJSON VoidedPurchasesListResponse
         where
        parseJSON
...
instance Core.ToJSON VoidedPurchasesListResponse
         where
