...
instance Core.FromJSON AbiTargeting where
        parseJSON
          = Core.withObject "AbiTargeting"
              (\ o ->
                 AbiTargeting Core.<$>
                   (o Core..:? "alternatives") Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON AcquisitionTargetingRule where
        parseJSON
          = Core.withObject "AcquisitionTargetingRule"
...
newActivateBasePlanRequest 
    ::  ActivateBasePlanRequest
newActivateBasePlanRequest
  = ActivateBasePlanRequest{basePlanId = Core.Nothing,
                            latencyTolerance = Core.Nothing, packageName = Core.Nothing,
                            productId = Core.Nothing}
instance Core.FromJSON ActivateBasePlanRequest where
        parseJSON
          = Core.withObject "ActivateBasePlanRequest"
              (\ o ->
                 ActivateBasePlanRequest Core.<$>
                   (o Core..:? "basePlanId") Core.<*> (o Core..:? "latencyTolerance")
...
newActivateSubscriptionOfferRequest 
    :: 
                                    ActivateSubscriptionOfferRequest
newActivateSubscriptionOfferRequest
  = ActivateSubscriptionOfferRequest{basePlanId = Core.Nothing,
                                     latencyTolerance = Core.Nothing, offerId = Core.Nothing,
                                     packageName = Core.Nothing, productId = Core.Nothing}
instance Core.FromJSON ActivateSubscriptionOfferRequest where
        parseJSON
          = Core.withObject "ActivateSubscriptionOfferRequest"
              (\ o ->
...
instance Core.FromJSON AddTargetingRequest where
        parseJSON
          = Core.withObject "AddTargetingRequest"
              (\ o ->
...
instance Core.FromJSON AddTargetingResponse where
        parseJSON
          = Core.withObject "AddTargetingResponse"
...
instance Core.FromJSON AndroidSdks where
        parseJSON
          = Core.withObject "AndroidSdks"
              (\ o ->
                 AndroidSdks Core.<$>
                   (o Core..:? "sdkLevels" Core.<&>
...
instance Core.ToJSON AndroidSdks where
        toJSON AndroidSdks{..}
          = Core.object
              (Core.catMaybes
                 [("sdkLevels" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    sdkLevels])
...
instance Core.FromJSON Apk where
        parseJSON
          = Core.withObject "Apk"
              (\ o ->
                 Apk Core.<$>
                   (o Core..:? "binary") Core.<*> (o Core..:? "versionCode"))
...
instance Core.FromJSON ApkBinary where
        parseJSON
          = Core.withObject "ApkBinary"
              (\ o ->
                 ApkBinary Core.<$>
                   (o Core..:? "sha1") Core.<*> (o Core..:? "sha256"))
...
newApkDescription 
    ::  ApkDescription
newApkDescription
  = ApkDescription{assetSliceMetadata = Core.Nothing,
                   instantApkMetadata = Core.Nothing, path = Core.Nothing,
                   splitApkMetadata = Core.Nothing,
                   standaloneApkMetadata = Core.Nothing, targeting = Core.Nothing}
instance Core.FromJSON ApkDescription where
        parseJSON
          = Core.withObject "ApkDescription"
              (\ o ->
                 ApkDescription Core.<$>
                   (o Core..:? "assetSliceMetadata") Core.<*>
                     (o Core..:? "instantApkMetadata")
                     Core.<*> (o Core..:? "path")
...
newApkSet 
    ::  ApkSet
newApkSet
  = ApkSet{apkDescription = Core.Nothing,
           moduleMetadata = Core.Nothing}
instance Core.FromJSON ApkSet where
        parseJSON
          = Core.withObject "ApkSet"
              (\ o ->
                 ApkSet Core.<$>
                   (o Core..:? "apkDescription") Core.<*>
                     (o Core..:? "moduleMetadata"))
...
newApkTargeting 
    ::  ApkTargeting
newApkTargeting
  = ApkTargeting{abiTargeting = Core.Nothing,
                 languageTargeting = Core.Nothing, multiAbiTargeting = Core.Nothing,
...
instance Core.FromJSON ApkTargeting where
        parseJSON
          = Core.withObject "ApkTargeting"
              (\ o ->
                 ApkTargeting Core.<$>
                   (o Core..:? "abiTargeting") Core.<*>
                     (o Core..:? "languageTargeting")
          ...
          = Core.object
              (Core.catMaybes
                 [("abiTargeting" Core..=) Core.<$> abiTargeting,
                  ...
                  ("textureCompressionFormatTargeting" Core..=) Core.<$>
                    textureCompressionFormatTargeting])
...
newApksAddExternallyHostedRequest 
    ::  ApksAddExternallyHostedRequest
newApksAddExternallyHostedRequest
  = ApksAddExternallyHostedRequest{externallyHostedApk =
                                     Core.Nothing}
instance Core.FromJSON ApksAddExternallyHostedRequest where
        parseJSON
          = Core.withObject "ApksAddExternallyHostedRequest"
              (\ o ->
                 ApksAddExternallyHostedRequest Core.<$>
                   (o Core..:? "externallyHostedApk"))
...
newApksAddExternallyHostedResponse 
    :: 
                                   ApksAddExternallyHostedResponse
newApksAddExternallyHostedResponse
  = ApksAddExternallyHostedResponse{externallyHostedApk =
                                      Core.Nothing}
instance Core.FromJSON ApksAddExternallyHostedResponse where
        parseJSON
          = Core.withObject "ApksAddExternallyHostedResponse"
              (\ o ->
                 ApksAddExternallyHostedResponse Core.<$>
                   (o Core..:? "externallyHostedApk"))
...
instance Core.FromJSON ApksListResponse where
        parseJSON
          = Core.withObject "ApksListResponse"
              (\ o ->
                 ApksListResponse Core.<$>
                   (o Core..:? "apks") Core.<*> (o Core..:? "kind"))
...
newAppDetails 
    ::  AppDetails
newAppDetails
  = AppDetails{contactEmail = Core.Nothing,
               contactPhone = Core.Nothing, contactWebsite = Core.Nothing,
               defaultLanguage = Core.Nothing}
instance Core.FromJSON AppDetails where
        parseJSON
          = Core.withObject "AppDetails"
              (\ o ->
                 AppDetails Core.<$>
                   (o Core..:? "contactEmail") Core.<*> (o Core..:? "contactPhone")
...
instance Core.FromJSON AppEdit where
        parseJSON
          = Core.withObject "AppEdit"
              (\ o ->
                 AppEdit Core.<$>
                   (o Core..:? "expiryTimeSeconds") Core.<*> (o Core..:? "id"))
...
newAppRecoveryAction 
    ::  AppRecoveryAction
newAppRecoveryAction
  = AppRecoveryAction{appRecoveryId = Core.Nothing,
                      cancelTime = Core.Nothing, createTime = Core.Nothing,
                      deployTime = Core.Nothing, lastUpdateTime = Core.Nothing,
                      remoteInAppUpdateData = Core.Nothing, status = Core.Nothing,
                      targeting = Core.Nothing}
instance Core.FromJSON AppRecoveryAction where
        parseJSON
          = Core.withObject "AppRecoveryAction"
              (\ o ->
                 AppRecoveryAction Core.<$>
                   (o Core..:? "appRecoveryId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON AppRecoveryAction where
        toJSON AppRecoveryAction{..}
          = Core.object
              (Core.catMaybes
                 [("appRecoveryId" Core..=) Core.. Core.AsText Core.<$>
                    appRecoveryId,
...
instance Core.FromJSON AppVersionList where
        parseJSON
          = Core.withObject "AppVersionList"
              (\ o ->
                 AppVersionList Core.<$>
                   (o Core..:? "versionCodes" Core.<&>
                      Core.fmap (Core.fmap Core.fromAsText)))
...
instance Core.ToJSON AppVersionList where
        toJSON AppVersionList{..}
          = Core.object
              (Core.catMaybes
                 [("versionCodes" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    versionCodes])
...
newAppVersionRange 
    ::  AppVersionRange
newAppVersionRange
  = AppVersionRange{versionCodeEnd = Core.Nothing,
                    versionCodeStart = Core.Nothing}
instance Core.FromJSON AppVersionRange where
        parseJSON
          = Core.withObject "AppVersionRange"
              (\ o ->
                 AppVersionRange Core.<$>
                   (o Core..:? "versionCodeEnd" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "versionCodeStart" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON AppVersionRange where
        toJSON AppVersionRange{..}
          = Core.object
              (Core.catMaybes
                 [("versionCodeEnd" Core..=) Core.. Core.AsText Core.<$>
                    versionCodeEnd,
                  ("versionCodeStart" Core..=) Core.. Core.AsText Core.<$>
                    versionCodeStart])
...
instance Core.FromJSON ArchiveSubscriptionRequest where
        parseJSON
          = Core.withObject "ArchiveSubscriptionRequest"
...
newAssetModuleMetadata 
    ::  AssetModuleMetadata
newAssetModuleMetadata
  = AssetModuleMetadata{deliveryType = Core.Nothing,
                        name = Core.Nothing}
instance Core.FromJSON AssetModuleMetadata where
        parseJSON
          = Core.withObject "AssetModuleMetadata"
              (\ o ->
                 AssetModuleMetadata Core.<$>
                   (o Core..:? "deliveryType") Core.<*> (o Core..:? "name"))
...
newAssetSliceSet 
    ::  AssetSliceSet
newAssetSliceSet
  = AssetSliceSet{apkDescription = Core.Nothing,
                  assetModuleMetadata = Core.Nothing}
instance Core.FromJSON AssetSliceSet where
        parseJSON
          = Core.withObject "AssetSliceSet"
              (\ o ->
                 AssetSliceSet Core.<$>
                   (o Core..:? "apkDescription") Core.<*>
                     (o Core..:? "assetModuleMetadata"))
...
newAutoRenewingBasePlanType 
    ::  AutoRenewingBasePlanType
newAutoRenewingBasePlanType
  = AutoRenewingBasePlanType{accountHoldDuration = Core.Nothing,
                             ...
                             prorationMode = Core.Nothing, resubscribeState = Core.Nothing}
instance Core.FromJSON AutoRenewingBasePlanType where
        parseJSON
          = Core.withObject "AutoRenewingBasePlanType"
              (\ o ->
                 AutoRenewingBasePlanType Core.<$>
                   (o Core..:? "accountHoldDuration") Core.<*>
                     (o Core..:? "billingPeriodDuration")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountHoldDuration" Core..=) Core.<$> accountHoldDuration,
                  ...
                  ("legacyCompatibleSubscriptionOfferId" Core..=) Core.<$>
...
newAutoRenewingPlan 
    ::  AutoRenewingPlan
newAutoRenewingPlan
  = AutoRenewingPlan{autoRenewEnabled = Core.Nothing,
                     installmentDetails = Core.Nothing,
                     priceChangeDetails = Core.Nothing, recurringPrice = Core.Nothing}
instance Core.FromJSON AutoRenewingPlan where
        parseJSON
          = Core.withObject "AutoRenewingPlan"
              (\ o ->
                 AutoRenewingPlan Core.<$>
                   (o Core..:? "autoRenewEnabled") Core.<*>
                     (o Core..:? "installmentDetails")
...
newBasePlan 
    ::  BasePlan
newBasePlan
  = BasePlan{autoRenewingBasePlanType = Core.Nothing,
             basePlanId = Core.Nothing, installmentsBasePlanType = Core.Nothing,
             offerTags = Core.Nothing, otherRegionsConfig = Core.Nothing,
             prepaidBasePlanType = Core.Nothing, regionalConfigs = Core.Nothing,
             state = Core.Nothing}
instance Core.FromJSON BasePlan where
        parseJSON
          = Core.withObject "BasePlan"
              (\ o ->
                 BasePlan Core.<$>
                   (o Core..:? "autoRenewingBasePlanType") Core.<*>
                     (o Core..:? "basePlanId")
...
instance Core.ToJSON BasePlan where
        toJSON BasePlan{..}
          = Core.object
              (Core.catMaybes
                 [("autoRenewingBasePlanType" Core..=) Core.<$>
                    autoRenewingBasePlanType,
                  ("basePlanId" Core..=) Core.<$> basePlanId,
                  ("installmentsBasePlanType" Core..=) Core.<$>
                    installmentsBasePlanType,
...
--
-- /See:/ 'newBatchGetOrdersResponse' smart constructor.
newtype BatchGetOrdersResponse = BatchGetOrdersResponse
    {
...
-- | Creates a value of 'BatchGetOrdersResponse' with the minimum fields required to make a request.
newBatchGetOrdersResponse 
    ::  BatchGetOrdersResponse
newBatchGetOrdersResponse
  = BatchGetOrdersResponse{orders = Core.Nothing}
instance Core.FromJSON BatchGetOrdersResponse where
        parseJSON
          = Core.withObject "BatchGetOrdersResponse"
              (\ o -> BatchGetOrdersResponse Core.<$> (o Core..:? "orders"))

instance Core.ToJSON BatchGetOrdersResponse where
        toJSON BatchGetOrdersResponse{..}
          = Core.object (Core.catMaybes [("orders" Core..=) Core.<$> orders])
...
instance Core.FromJSON BatchGetSubscriptionOffersRequest where
        parseJSON
          = Core.withObject "BatchGetSubscriptionOffersRequest"
              (\ o ->
...
newBatchGetSubscriptionOffersResponse 
    :: 
                                      BatchGetSubscriptionOffersResponse
newBatchGetSubscriptionOffersResponse
  = BatchGetSubscriptionOffersResponse{subscriptionOffers =
                                         Core.Nothing}
instance Core.FromJSON BatchGetSubscriptionOffersResponse where
        parseJSON
          = Core.withObject "BatchGetSubscriptionOffersResponse"
              (\ o ->
                 BatchGetSubscriptionOffersResponse Core.<$>
                   (o Core..:? "subscriptionOffers"))
...
instance Core.FromJSON BatchGetSubscriptionsResponse where
        parseJSON
          = Core.withObject "BatchGetSubscriptionsResponse"
              (\ o ->
                 BatchGetSubscriptionsResponse Core.<$>
                   (o Core..:? "subscriptions"))
...
instance Core.FromJSON BatchMigrateBasePlanPricesRequest where
        parseJSON
          = Core.withObject "BatchMigrateBasePlanPricesRequest"
              (\ o ->
...
instance Core.FromJSON BatchMigrateBasePlanPricesResponse where
        parseJSON
          = Core.withObject "BatchMigrateBasePlanPricesResponse"
              (\ o ->
                 BatchMigrateBasePlanPricesResponse Core.<$>
                   (o Core..:? "responses"))
...
instance Core.FromJSON BatchUpdateBasePlanStatesRequest where
        parseJSON
          = Core.withObject "BatchUpdateBasePlanStatesRequest"
              (\ o ->
...
instance Core.FromJSON BatchUpdateBasePlanStatesResponse where
        parseJSON
          = Core.withObject "BatchUpdateBasePlanStatesResponse"
              (\ o ->
                 BatchUpdateBasePlanStatesResponse Core.<$>
                   (o Core..:? "subscriptions"))
...
newBatchUpdateSubscriptionOfferStatesRequest 
    :: 
                                             BatchUpdateSubscriptionOfferStatesRequest
newBatchUpdateSubscriptionOfferStatesRequest
  = BatchUpdateSubscriptionOfferStatesRequest{requests =
                                                Core.Nothing}
instance Core.FromJSON BatchUpdateSubscriptionOfferStatesRequest
         where
        parseJSON
          = Core.withObject "BatchUpdateSubscriptionOfferStatesRequest"
              (\ o ->
                 BatchUpdateSubscriptionOfferStatesRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON BatchUpdateSubscriptionOfferStatesRequest
         where
...
newBatchUpdateSubscriptionOfferStatesResponse 
    :: 
                                              BatchUpdateSubscriptionOfferStatesResponse
newBatchUpdateSubscriptionOfferStatesResponse
  = BatchUpdateSubscriptionOfferStatesResponse{subscriptionOffers =
                                                 Core.Nothing}
instance Core.FromJSON BatchUpdateSubscriptionOfferStatesResponse
         where
        parseJSON
          = Core.withObject "BatchUpdateSubscriptionOfferStatesResponse"
              (\ o ->
                 BatchUpdateSubscriptionOfferStatesResponse Core.<$>
                   (o Core..:? "subscriptionOffers"))

instance Core.ToJSON BatchUpdateSubscriptionOfferStatesResponse
         where
...
instance Core.FromJSON BatchUpdateSubscriptionOffersRequest where
        parseJSON
          = Core.withObject "BatchUpdateSubscriptionOffersRequest"
              (\ o ->
                 BatchUpdateSubscriptionOffersRequest Core.<$>
                   (o Core..:? "requests"))
...
newBatchUpdateSubscriptionOffersResponse 
    :: 
                                         BatchUpdateSubscriptionOffersResponse
newBatchUpdateSubscriptionOffersResponse
  = BatchUpdateSubscriptionOffersResponse{subscriptionOffers =
                                            Core.Nothing}
instance Core.FromJSON BatchUpdateSubscriptionOffersResponse where
        parseJSON
          = Core.withObject "BatchUpdateSubscriptionOffersResponse"
              (\ o ->
                 BatchUpdateSubscriptionOffersResponse Core.<$>
                   (o Core..:? "subscriptionOffers"))
...
instance Core.FromJSON BatchUpdateSubscriptionsRequest where
        parseJSON
          = Core.withObject "BatchUpdateSubscriptionsRequest"
              (\ o ->
...
instance Core.FromJSON BatchUpdateSubscriptionsResponse where
        parseJSON
          = Core.withObject "BatchUpdateSubscriptionsResponse"
              (\ o ->
                 BatchUpdateSubscriptionsResponse Core.<$>
                   (o Core..:? "subscriptions"))
...
newBundle 
    ::  Bundle
newBundle
  = Bundle{sha1 = Core.Nothing, sha256 = Core.Nothing,
           versionCode = Core.Nothing}
instance Core.FromJSON Bundle where
        parseJSON
          = Core.withObject "Bundle"
              (\ o ->
                 Bundle Core.<$>
                   (o Core..:? "sha1") Core.<*> (o Core..:? "sha256") Core.<*>
                     (o Core..:? "versionCode"))
...
instance Core.FromJSON BundlesListResponse where
        parseJSON
          = Core.withObject "BundlesListResponse"
              (\ o ->
                 BundlesListResponse Core.<$>
                   (o Core..:? "bundles") Core.<*> (o Core..:? "kind"))
...
data BuyerAddress = BuyerAddress
    ...
    , buyerState :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BuyerAddress' with the minimum fields required to make a request.
newBuyerAddress 
    ::  BuyerAddress
newBuyerAddress
  = BuyerAddress{buyerCountry = Core.Nothing,
                 buyerPostcode = Core.Nothing, buyerState = Core.Nothing}
instance Core.FromJSON BuyerAddress where
        parseJSON
          = Core.withObject "BuyerAddress"
              (\ o ->
                 BuyerAddress Core.<$>
                   (o Core..:? "buyerCountry") Core.<*> (o Core..:? "buyerPostcode")
                     Core.<*> (o Core..:? "buyerState"))

instance Core.ToJSON BuyerAddress where
        toJSON BuyerAddress{..}
          = Core.object
              (Core.catMaybes
                 [("buyerCountry" Core..=) Core.<$> buyerCountry,
                  ("buyerPostcode" Core..=) Core.<$> buyerPostcode,
                  ("buyerState" Core..=) Core.<$> buyerState])
...
instance Core.FromJSON CancelAppRecoveryRequest where
        parseJSON
          = Core.withObject "CancelAppRecoveryRequest"
...
instance Core.FromJSON CancelAppRecoveryResponse where
        parseJSON
          = Core.withObject "CancelAppRecoveryResponse"
...
newCancelSurveyResult 
    ::  CancelSurveyResult
newCancelSurveyResult
  = CancelSurveyResult{reason = Core.Nothing,
                       reasonUserInput = Core.Nothing}
instance Core.FromJSON CancelSurveyResult where
        parseJSON
          = Core.withObject "CancelSurveyResult"
              (\ o ->
                 CancelSurveyResult Core.<$>
                   (o Core..:? "reason") Core.<*> (o Core..:? "reasonUserInput"))
...
newCanceledStateContext 
    ::  CanceledStateContext
newCanceledStateContext
  = CanceledStateContext{developerInitiatedCancellation =
                           Core.Nothing,
...
instance Core.FromJSON CanceledStateContext where
        parseJSON
          = Core.withObject "CanceledStateContext"
              (\ o ->
                 CanceledStateContext Core.<$>
                   (o Core..:? "developerInitiatedCancellation") Core.<*>
                     (o Core..:? "replacementCancellation")
...
instance Core.ToJSON CanceledStateContext where
        toJSON CanceledStateContext{..}
          = Core.object
              (Core.catMaybes
                 [("developerInitiatedCancellation" Core..=) Core.<$>
                    developerInitiatedCancellation,
                  ("replacementCancellation" Core..=) Core.<$>
                    replacementCancellation,
                  ("systemInitiatedCancellation" Core..=) Core.<$>
                    systemInitiatedCancellation,
                  ("userInitiatedCancellation" Core..=) Core.<$>
                    userInitiatedCancellation])


-- | Details of when the order was canceled.
--
-- /See:/ 'newCancellationEvent' smart constructor.
newtype CancellationEvent = CancellationEvent
    {
...
-- | Creates a value of 'CancellationEvent' with the minimum fields required to make a request.
newCancellationEvent 
    ::  CancellationEvent
newCancellationEvent = CancellationEvent{eventTime = Core.Nothing}
instance Core.FromJSON CancellationEvent where
        parseJSON
          = Core.withObject "CancellationEvent"
              (\ o -> CancellationEvent Core.<$> (o Core..:? "eventTime"))

instance Core.ToJSON CancellationEvent where
        toJSON CancellationEvent{..}
          = Core.object
              (Core.catMaybes [("eventTime" Core..=) Core.<$> eventTime])
...
newComment 
    ::  Comment
newComment
  = Comment{developerComment = Core.Nothing,
...
instance Core.FromJSON ConvertRegionPricesRequest where
        parseJSON
          = Core.withObject "ConvertRegionPricesRequest"
...
newConvertRegionPricesResponse 
    ::  ConvertRegionPricesResponse
newConvertRegionPricesResponse
  = ConvertRegionPricesResponse{convertedOtherRegionsPrice =
                                  Core.Nothing,
                                convertedRegionPrices = Core.Nothing, regionVersion = Core.Nothing}
instance Core.FromJSON ConvertRegionPricesResponse where
        parseJSON
          = Core.withObject "ConvertRegionPricesResponse"
              (\ o ->
                 ConvertRegionPricesResponse Core.<$>
                   (o Core..:? "convertedOtherRegionsPrice") Core.<*>
                     (o Core..:? "convertedRegionPrices")
...
instance Core.ToJSON ConvertRegionPricesResponse where
        toJSON ConvertRegionPricesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("convertedOtherRegionsPrice" Core..=) Core.<$>
                    convertedOtherRegionsPrice,
...
newConvertRegionPricesResponse_ConvertedRegionPrices additional
  = ConvertRegionPricesResponse_ConvertedRegionPrices{additional =
                                                        additional}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ConvertRegionPricesResponse_ConvertedRegionPrices"
              (\ o ->
                 ConvertRegionPricesResponse_ConvertedRegionPrices Core.<$>
...
newConvertedOtherRegionsPrice 
    ::  ConvertedOtherRegionsPrice
newConvertedOtherRegionsPrice
  = ConvertedOtherRegionsPrice{eurPrice = Core.Nothing,
                               usdPrice = Core.Nothing}
instance Core.FromJSON ConvertedOtherRegionsPrice where
        parseJSON
          = Core.withObject "ConvertedOtherRegionsPrice"
              (\ o ->
                 ConvertedOtherRegionsPrice Core.<$>
                   (o Core..:? "eurPrice") Core.<*> (o Core..:? "usdPrice"))
...
newConvertedRegionPrice 
    ::  ConvertedRegionPrice
newConvertedRegionPrice
  = ConvertedRegionPrice{price = Core.Nothing,
                         regionCode = Core.Nothing, taxAmount = Core.Nothing}
instance Core.FromJSON ConvertedRegionPrice where
        parseJSON
          = Core.withObject "ConvertedRegionPrice"
              (\ o ->
                 ConvertedRegionPrice Core.<$>
                   (o Core..:? "price") Core.<*> (o Core..:? "regionCode") Core.<*>
                     (o Core..:? "taxAmount"))
...
newCreateDraftAppRecoveryRequest 
    ::  CreateDraftAppRecoveryRequest
newCreateDraftAppRecoveryRequest
  = CreateDraftAppRecoveryRequest{remoteInAppUpdate = Core.Nothing,
                                  targeting = Core.Nothing}
instance Core.FromJSON CreateDraftAppRecoveryRequest where
        parseJSON
          = Core.withObject "CreateDraftAppRecoveryRequest"
              (\ o ->
                 CreateDraftAppRecoveryRequest Core.<$>
                   (o Core..:? "remoteInAppUpdate") Core.<*> (o Core..:? "targeting"))
...
newDeactivateBasePlanRequest 
    ::  DeactivateBasePlanRequest
newDeactivateBasePlanRequest
  = DeactivateBasePlanRequest{basePlanId = Core.Nothing,
                              latencyTolerance = Core.Nothing, packageName = Core.Nothing,
                              productId = Core.Nothing}
instance Core.FromJSON DeactivateBasePlanRequest where
        parseJSON
          = Core.withObject "DeactivateBasePlanRequest"
              (\ o ->
...
newDeactivateSubscriptionOfferRequest 
    :: 
                                      DeactivateSubscriptionOfferRequest
newDeactivateSubscriptionOfferRequest
  = DeactivateSubscriptionOfferRequest{basePlanId = Core.Nothing,
                                       latencyTolerance = Core.Nothing, offerId = Core.Nothing,
                                       packageName = Core.Nothing, productId = Core.Nothing}
instance Core.FromJSON DeactivateSubscriptionOfferRequest where
        parseJSON
          = Core.withObject "DeactivateSubscriptionOfferRequest"
              (\ o ->
...
instance Core.FromJSON DeferredItemReplacement where
        parseJSON
          = Core.withObject "DeferredItemReplacement"
...
instance Core.FromJSON DeobfuscationFile where
        parseJSON
          = Core.withObject "DeobfuscationFile"
...
newDeobfuscationFilesUploadResponse 
    :: 
                                    DeobfuscationFilesUploadResponse
newDeobfuscationFilesUploadResponse
  = DeobfuscationFilesUploadResponse{deobfuscationFile =
                                       Core.Nothing}
instance Core.FromJSON DeobfuscationFilesUploadResponse where
        parseJSON
          = Core.withObject "DeobfuscationFilesUploadResponse"
              (\ o ->
                 DeobfuscationFilesUploadResponse Core.<$>
                   (o Core..:? "deobfuscationFile"))
...
instance Core.FromJSON DeployAppRecoveryRequest where
        parseJSON
          = Core.withObject "DeployAppRecoveryRequest"
...
instance Core.FromJSON DeployAppRecoveryResponse where
        parseJSON
          = Core.withObject "DeployAppRecoveryResponse"
...
newDeveloperComment 
    ::  DeveloperComment
newDeveloperComment
  = DeveloperComment{lastModified = Core.Nothing,
                     text = Core.Nothing}
instance Core.FromJSON DeveloperComment where
        parseJSON
          = Core.withObject "DeveloperComment"
              (\ o ->
                 DeveloperComment Core.<$>
                   (o Core..:? "lastModified") Core.<*> (o Core..:? "text"))
...
instance Core.FromJSON DeveloperInitiatedCancellation where
        parseJSON
          = Core.withObject "DeveloperInitiatedCancellation"
...
newDeviceFeature 
    ::  DeviceFeature
newDeviceFeature
  = DeviceFeature{featureName = Core.Nothing,
                  featureVersion = Core.Nothing}
instance Core.FromJSON DeviceFeature where
        parseJSON
          = Core.withObject "DeviceFeature"
              (\ o ->
                 DeviceFeature Core.<$>
                   (o Core..:? "featureName") Core.<*> (o Core..:? "featureVersion"))
...
instance Core.FromJSON DeviceFeatureTargeting where
        parseJSON
          = Core.withObject "DeviceFeatureTargeting"
              (\ o ->
...
instance Core.FromJSON DeviceGroup where
        parseJSON
          = Core.withObject "DeviceGroup"
              (\ o ->
                 DeviceGroup Core.<$>
                   (o Core..:? "deviceSelectors") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON DeviceId where
        parseJSON
          = Core.withObject "DeviceId"
              (\ o ->
                 DeviceId Core.<$>
                   (o Core..:? "buildBrand") Core.<*> (o Core..:? "buildDevice"))
...
newDeviceMetadata 
    ::  DeviceMetadata
newDeviceMetadata
  = DeviceMetadata{cpuMake = Core.Nothing, cpuModel = Core.Nothing,
                   deviceClass = Core.Nothing, glEsVersion = Core.Nothing,
                   manufacturer = Core.Nothing, nativePlatform = Core.Nothing,
                   productName = Core.Nothing, ramMb = Core.Nothing,
                   screenDensityDpi = Core.Nothing, screenHeightPx = Core.Nothing,
                   screenWidthPx = Core.Nothing}
instance Core.FromJSON DeviceMetadata where
        parseJSON
          = Core.withObject "DeviceMetadata"
              (\ o ->
                 DeviceMetadata Core.<$>
                   (o Core..:? "cpuMake") Core.<*> (o Core..:? "cpuModel") Core.<*>
                     (o Core..:? "deviceClass")
...
instance Core.FromJSON DeviceRam where
        parseJSON
          = Core.withObject "DeviceRam"
              (\ o ->
                 DeviceRam Core.<$>
                   (o Core..:? "maxBytes" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "minBytes" Core.<&> Core.fmap Core.fromAsText))
...
newDeviceSelector 
    ::  DeviceSelector
newDeviceSelector
  = DeviceSelector{deviceRam = Core.Nothing,
...
instance Core.FromJSON DeviceSelector where
        parseJSON
          = Core.withObject "DeviceSelector"
              (\ o ->
                 DeviceSelector Core.<$>
                   (o Core..:? "deviceRam") Core.<*> (o Core..:? "excludedDeviceIds")
          ...
          = Core.object
              (Core.catMaybes
                 [("deviceRam" Core..=) Core.<$> deviceRam,
                  ...
                  ("forbiddenSystemFeatures" Core..=) Core.<$>
...
newDeviceSpec 
    ::  DeviceSpec
newDeviceSpec
  = DeviceSpec{screenDensity = Core.Nothing,
               supportedAbis = Core.Nothing, supportedLocales = Core.Nothing}
instance Core.FromJSON DeviceSpec where
        parseJSON
          = Core.withObject "DeviceSpec"
              (\ o ->
                 DeviceSpec Core.<$>
                   (o Core..:? "screenDensity") Core.<*> (o Core..:? "supportedAbis")
...
instance Core.FromJSON DeviceTier where
        parseJSON
          = Core.withObject "DeviceTier"
              (\ o ->
                 DeviceTier Core.<$>
                   (o Core..:? "deviceGroupNames") Core.<*> (o Core..:? "level"))
...
newDeviceTierConfig 
    ::  DeviceTierConfig
newDeviceTierConfig
  = DeviceTierConfig{deviceGroups = Core.Nothing,
                     deviceTierConfigId = Core.Nothing, deviceTierSet = Core.Nothing,
                     userCountrySets = Core.Nothing}
instance Core.FromJSON DeviceTierConfig where
        parseJSON
          = Core.withObject "DeviceTierConfig"
              (\ o ->
                 DeviceTierConfig Core.<$>
                   (o Core..:? "deviceGroups") Core.<*>
                     (o Core..:? "deviceTierConfigId" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("deviceGroups" Core..=) Core.<$> deviceGroups,
                  ("deviceTierConfigId" Core..=) Core.. Core.AsText Core.<$>
                    deviceTierConfigId,
...
newExpansionFile 
    ::  ExpansionFile
newExpansionFile
  = ExpansionFile{fileSize = Core.Nothing,
                  referencesVersion = Core.Nothing}
instance Core.FromJSON ExpansionFile where
        parseJSON
          = Core.withObject "ExpansionFile"
              (\ o ->
                 ExpansionFile Core.<$>
                   (o Core..:? "fileSize" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "referencesVersion"))
...
instance Core.FromJSON ExpansionFilesUploadResponse where
        parseJSON
          = Core.withObject "ExpansionFilesUploadResponse"
              (\ o ->
...
newExternalAccountIdentifiers 
    ::  ExternalAccountIdentifiers
newExternalAccountIdentifiers
  = ExternalAccountIdentifiers{externalAccountId = Core.Nothing,
...
instance Core.FromJSON ExternalAccountIdentifiers where
        parseJSON
          = Core.withObject "ExternalAccountIdentifiers"
              (\ o ->
                 ExternalAccountIdentifiers Core.<$>
                   (o Core..:? "externalAccountId") Core.<*>
                     (o Core..:? "obfuscatedExternalAccountId")
          ...
          = Core.object
              (Core.catMaybes
                 [("externalAccountId" Core..=) Core.<$> externalAccountId,
                  ("obfuscatedExternalAccountId" Core..=) Core.<$>
                    obfuscatedExternalAccountId,
                  ("obfuscatedExternalProfileId" Core..=) Core.<$>
...
instance Core.FromJSON ExternalSubscription where
        parseJSON
          = Core.withObject "ExternalSubscription"
              (\ o ->
...
newExternalTransaction 
    ::  ExternalTransaction
newExternalTransaction
  = ExternalTransaction{createTime = Core.Nothing,
                        ...
                        originalTaxAmount = Core.Nothing, packageName = Core.Nothing,
                        recurringTransaction = Core.Nothing, testPurchase = Core.Nothing,
                        transactionProgramCode = Core.Nothing,
                        transactionState = Core.Nothing, transactionTime = Core.Nothing,
                        userTaxAddress = Core.Nothing}
instance Core.FromJSON ExternalTransaction where
        parseJSON
          = Core.withObject "ExternalTransaction"
              (\ o ->
                 ExternalTransaction Core.<$>
                   (o Core..:? "createTime") Core.<*>
                     (o Core..:? "currentPreTaxAmount")
...
newExternalTransactionAddress 
    ::  ExternalTransactionAddress
newExternalTransactionAddress
  = ExternalTransactionAddress{administrativeArea = Core.Nothing,
                               regionCode = Core.Nothing}
instance Core.FromJSON ExternalTransactionAddress where
        parseJSON
          = Core.withObject "ExternalTransactionAddress"
              (\ o ->
                 ExternalTransactionAddress Core.<$>
                   (o Core..:? "administrativeArea") Core.<*>
                     (o Core..:? "regionCode"))
...
instance Core.FromJSON ExternalTransactionTestPurchase where
        parseJSON
          = Core.withObject "ExternalTransactionTestPurchase"
...
newExternallyHostedApk 
    ::  ExternallyHostedApk
newExternallyHostedApk
  = ExternallyHostedApk{applicationLabel = Core.Nothing,
                        certificateBase64s = Core.Nothing,
                        externallyHostedUrl = Core.Nothing, fileSha1Base64 = Core.Nothing,
                        fileSha256Base64 = Core.Nothing, fileSize = Core.Nothing,
                        iconBase64 = Core.Nothing, maximumSdk = Core.Nothing,
                        minimumSdk = Core.Nothing, nativeCodes = Core.Nothing,
                        packageName = Core.Nothing, usesFeatures = Core.Nothing,
                        usesPermissions = Core.Nothing, versionCode = Core.Nothing,
                        versionName = Core.Nothing}
instance Core.FromJSON ExternallyHostedApk where
        parseJSON
          = Core.withObject "ExternallyHostedApk"
              (\ o ->
                 ExternallyHostedApk Core.<$>
                   (o Core..:? "applicationLabel") Core.<*>
                     (o Core..:? "certificateBase64s")
...
instance Core.FromJSON GeneratedApksListResponse where
        parseJSON
          = Core.withObject "GeneratedApksListResponse"
              (\ o ->
...
newGeneratedApksPerSigningKey 
    ::  GeneratedApksPerSigningKey
newGeneratedApksPerSigningKey
  = GeneratedApksPerSigningKey{certificateSha256Hash = Core.Nothing,
                               ...
                               generatedUniversalApk = Core.Nothing, targetingInfo = Core.Nothing}
instance Core.FromJSON GeneratedApksPerSigningKey where
        parseJSON
          = Core.withObject "GeneratedApksPerSigningKey"
              (\ o ->
                 GeneratedApksPerSigningKey Core.<$>
                   (o Core..:? "certificateSha256Hash") Core.<*>
                     (o Core..:? "generatedAssetPackSlices")
          ...
          = Core.object
              (Core.catMaybes
                 [("certificateSha256Hash" Core..=) Core.<$> certificateSha256Hash,
                  ("generatedAssetPackSlices" Core..=) Core.<$>
                    generatedAssetPackSlices,
                  ("generatedRecoveryModules" Core..=) Core.<$>
                    generatedRecoveryModules,
                  ("generatedSplitApks" Core..=) Core.<$> generatedSplitApks,
                  ("generatedStandaloneApks" Core..=) Core.<$>
...
newGeneratedAssetPackSlice 
    ::  GeneratedAssetPackSlice
newGeneratedAssetPackSlice
  = GeneratedAssetPackSlice{downloadId = Core.Nothing,
                            moduleName = Core.Nothing, sliceId = Core.Nothing,
                            version = Core.Nothing}
instance Core.FromJSON GeneratedAssetPackSlice where
        parseJSON
          = Core.withObject "GeneratedAssetPackSlice"
              (\ o ->
                 GeneratedAssetPackSlice Core.<$>
                   (o Core..:? "downloadId") Core.<*> (o Core..:? "moduleName")
                     Core.<*> (o Core..:? "sliceId")
...
newGeneratedRecoveryApk 
    ::  GeneratedRecoveryApk
newGeneratedRecoveryApk
  = GeneratedRecoveryApk{downloadId = Core.Nothing,
                         moduleName = Core.Nothing, recoveryId = Core.Nothing,
                         recoveryStatus = Core.Nothing}
instance Core.FromJSON GeneratedRecoveryApk where
        parseJSON
          = Core.withObject "GeneratedRecoveryApk"
              (\ o ->
                 GeneratedRecoveryApk Core.<$>
                   (o Core..:? "downloadId") Core.<*> (o Core..:? "moduleName")
                     Core.<*>
                     (o Core..:? "recoveryId" Core.<&> Core.fmap Core.fromAsText)
...
newGeneratedSplitApk 
    ::  GeneratedSplitApk
newGeneratedSplitApk
  = GeneratedSplitApk{downloadId = Core.Nothing,
                      moduleName = Core.Nothing, splitId = Core.Nothing,
                      variantId = Core.Nothing}
instance Core.FromJSON GeneratedSplitApk where
        parseJSON
          = Core.withObject "GeneratedSplitApk"
              (\ o ->
                 GeneratedSplitApk Core.<$>
                   (o Core..:? "downloadId") Core.<*> (o Core..:? "moduleName")
                     Core.<*> (o Core..:? "splitId")
...
newGeneratedStandaloneApk 
    ::  GeneratedStandaloneApk
newGeneratedStandaloneApk
  = GeneratedStandaloneApk{downloadId = Core.Nothing,
                           variantId = Core.Nothing}
instance Core.FromJSON GeneratedStandaloneApk where
        parseJSON
          = Core.withObject "GeneratedStandaloneApk"
              (\ o ->
                 GeneratedStandaloneApk Core.<$>
                   (o Core..:? "downloadId") Core.<*> (o Core..:? "variantId"))
...
instance Core.FromJSON GeneratedUniversalApk where
        parseJSON
          = Core.withObject "GeneratedUniversalApk"
...
newGetSubscriptionOfferRequest 
    ::  GetSubscriptionOfferRequest
newGetSubscriptionOfferRequest
  = GetSubscriptionOfferRequest{basePlanId = Core.Nothing,
                                offerId = Core.Nothing, packageName = Core.Nothing,
                                productId = Core.Nothing}
instance Core.FromJSON GetSubscriptionOfferRequest where
        parseJSON
          = Core.withObject "GetSubscriptionOfferRequest"
              (\ o ->
                 GetSubscriptionOfferRequest Core.<$>
                   (o Core..:? "basePlanId") Core.<*> (o Core..:? "offerId") Core.<*>
                     (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId"))
...
newGrant 
    ::  Grant
newGrant
  = Grant{appLevelPermissions = Core.Nothing, name = Core.Nothing,
          packageName = Core.Nothing}
instance Core.FromJSON Grant where
        parseJSON
          = Core.withObject "Grant"
              (\ o ->
                 Grant Core.<$>
                   (o Core..:? "appLevelPermissions") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "packageName"))
...
newImage 
    ::  Image
newImage
  = Image{id = Core.Nothing, sha1 = Core.Nothing,
          sha256 = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Image where
        parseJSON
          = Core.withObject "Image"
              (\ o ->
                 Image Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "sha1") Core.<*>
                     (o Core..:? "sha256")
                     Core.<*> (o Core..:? "url"))
...
instance Core.ToJSON Image where
        toJSON Image{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("sha1" Core..=) Core.<$> sha1,
                  ("sha256" Core..=) Core.<$> sha256, ("url" Core..=) Core.<$> url])
...
instance Core.FromJSON ImagesDeleteAllResponse where
        parseJSON
          = Core.withObject "ImagesDeleteAllResponse"
...
instance Core.FromJSON ImagesListResponse where
        parseJSON
          = Core.withObject "ImagesListResponse"
...
instance Core.FromJSON ImagesUploadResponse where
        parseJSON
          = Core.withObject "ImagesUploadResponse"
...
newInAppProduct 
    ::  InAppProduct
newInAppProduct
  = InAppProduct{defaultLanguage = Core.Nothing,
                 defaultPrice = Core.Nothing, gracePeriod = Core.Nothing,
                 listings = Core.Nothing,
                 managedProductTaxesAndComplianceSettings = Core.Nothing,
                 packageName = Core.Nothing, prices = Core.Nothing,
                 purchaseType = Core.Nothing, sku = Core.Nothing,
                 status = Core.Nothing, subscriptionPeriod = Core.Nothing,
                 subscriptionTaxesAndComplianceSettings = Core.Nothing,
                 trialPeriod = Core.Nothing}
instance Core.FromJSON InAppProduct where
        parseJSON
          = Core.withObject "InAppProduct"
              (\ o ->
                 InAppProduct Core.<$>
                   (o Core..:? "defaultLanguage") Core.<*> (o Core..:? "defaultPrice")
          ...
          = Core.object
              (Core.catMaybes
                 [("defaultLanguage" Core..=) Core.<$> defaultLanguage,
                  ...
                  ("managedProductTaxesAndComplianceSettings" Core..=) Core.<$>
                    managedProductTaxesAndComplianceSettings,
                  ("packageName" Core..=) Core.<$> packageName,
                  ("prices" Core..=) Core.<$> prices,
                  ("purchaseType" Core..=) Core.<$> purchaseType,
                  ("sku" Core..=) Core.<$> sku, ("status" Core..=) Core.<$> status,
                  ("subscriptionPeriod" Core..=) Core.<$> subscriptionPeriod,
                  ("subscriptionTaxesAndComplianceSettings" Core..=) Core.<$>
...
instance Core.FromJSON InAppProduct_Listings where
        parseJSON
          = Core.withObject "InAppProduct_Listings"
...
instance Core.FromJSON InAppProduct_Prices where
        parseJSON
          = Core.withObject "InAppProduct_Prices"
...
newInAppProductListing 
    ::  InAppProductListing
newInAppProductListing
  = InAppProductListing{benefits = Core.Nothing,
                        description = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON InAppProductListing where
        parseJSON
          = Core.withObject "InAppProductListing"
              (\ o ->
                 InAppProductListing Core.<$>
                   (o Core..:? "benefits") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "title"))
...
instance Core.FromJSON InappproductsBatchDeleteRequest where
        parseJSON
          = Core.withObject "InappproductsBatchDeleteRequest"
              (\ o ->
...
instance Core.FromJSON InappproductsBatchGetResponse where
        parseJSON
          = Core.withObject "InappproductsBatchGetResponse"
              (\ o ->
...
instance Core.FromJSON InappproductsBatchUpdateRequest where
        parseJSON
          = Core.withObject "InappproductsBatchUpdateRequest"
              (\ o ->
...
instance Core.FromJSON InappproductsBatchUpdateResponse where
        parseJSON
          = Core.withObject "InappproductsBatchUpdateResponse"
              (\ o ->
                 InappproductsBatchUpdateResponse Core.<$>
                   (o Core..:? "inappproducts"))
...
newInappproductsDeleteRequest 
    ::  InappproductsDeleteRequest
newInappproductsDeleteRequest
  = InappproductsDeleteRequest{latencyTolerance = Core.Nothing,
                               packageName = Core.Nothing, sku = Core.Nothing}
instance Core.FromJSON InappproductsDeleteRequest where
        parseJSON
          = Core.withObject "InappproductsDeleteRequest"
              (\ o ->
                 InappproductsDeleteRequest Core.<$>
                   (o Core..:? "latencyTolerance") Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "sku"))
...
newInappproductsListResponse 
    ::  InappproductsListResponse
newInappproductsListResponse
  = InappproductsListResponse{inappproduct = Core.Nothing,
                              kind = Core.Nothing, pageInfo = Core.Nothing,
                              tokenPagination = Core.Nothing}
instance Core.FromJSON InappproductsListResponse where
        parseJSON
          = Core.withObject "InappproductsListResponse"
              (\ o ->
                 InappproductsListResponse Core.<$>
                   (o Core..:? "inappproduct") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "pageInfo")
...
newInappproductsUpdateRequest 
    ::  InappproductsUpdateRequest
newInappproductsUpdateRequest
  = InappproductsUpdateRequest{allowMissing = Core.Nothing,
                               autoConvertMissingPrices = Core.Nothing,
                               inappproduct = Core.Nothing, latencyTolerance = Core.Nothing,
                               packageName = Core.Nothing, sku = Core.Nothing}
instance Core.FromJSON InappproductsUpdateRequest where
        parseJSON
          = Core.withObject "InappproductsUpdateRequest"
              (\ o ->
                 InappproductsUpdateRequest Core.<$>
                   (o Core..:? "allowMissing") Core.<*>
                     (o Core..:? "autoConvertMissingPrices")
          ...
          = Core.object
              (Core.catMaybes
                 [("allowMissing" Core..=) Core.<$> allowMissing,
                  ("autoConvertMissingPrices" Core..=) Core.<$>
...
newInstallmentPlan 
    ::  InstallmentPlan
newInstallmentPlan
  = InstallmentPlan{initialCommittedPaymentsCount = Core.Nothing,
...
instance Core.FromJSON InstallmentPlan where
        parseJSON
          = Core.withObject "InstallmentPlan"
              (\ o ->
                 InstallmentPlan Core.<$>
                   (o Core..:? "initialCommittedPaymentsCount") Core.<*>
                     (o Core..:? "pendingCancellation")
...
instance Core.ToJSON InstallmentPlan where
        toJSON InstallmentPlan{..}
          = Core.object
              (Core.catMaybes
                 [("initialCommittedPaymentsCount" Core..=) Core.<$>
                    initialCommittedPaymentsCount,
                  ("pendingCancellation" Core..=) Core.<$> pendingCancellation,
                  ("remainingCommittedPaymentsCount" Core..=) Core.<$>
                    remainingCommittedPaymentsCount,
                  ("subsequentCommittedPaymentsCount" Core..=) Core.<$>
...
newInstallmentsBasePlanType 
    ::  InstallmentsBasePlanType
newInstallmentsBasePlanType
  = InstallmentsBasePlanType{accountHoldDuration = Core.Nothing,
                             billingPeriodDuration = Core.Nothing,
                             committedPaymentsCount = Core.Nothing,
                             gracePeriodDuration = Core.Nothing, prorationMode = Core.Nothing,
                             renewalType = Core.Nothing, resubscribeState = Core.Nothing}
instance Core.FromJSON InstallmentsBasePlanType where
        parseJSON
          = Core.withObject "InstallmentsBasePlanType"
              (\ o ->
...
newInternalAppSharingArtifact 
    ::  InternalAppSharingArtifact
newInternalAppSharingArtifact
  = InternalAppSharingArtifact{certificateFingerprint = Core.Nothing,
                               downloadUrl = Core.Nothing, sha256 = Core.Nothing}
instance Core.FromJSON InternalAppSharingArtifact where
        parseJSON
          = Core.withObject "InternalAppSharingArtifact"
              (\ o ->
                 InternalAppSharingArtifact Core.<$>
                   (o Core..:? "certificateFingerprint") Core.<*>
                     (o Core..:? "downloadUrl")
                     Core.<*> (o Core..:? "sha256"))
...
instance Core.FromJSON IntroductoryPriceInfo where
        parseJSON
          = Core.withObject "IntroductoryPriceInfo"
              (\ o ->
                 IntroductoryPriceInfo Core.<$>
                   (o Core..:? "introductoryPriceAmountMicros" Core.<&>
                      Core.fmap Core.fromAsText)
...
instance Core.ToJSON IntroductoryPriceInfo where
        toJSON IntroductoryPriceInfo{..}
          = Core.object
              (Core.catMaybes
                 [("introductoryPriceAmountMicros" Core..=) Core.. Core.AsText
                    Core.<$> introductoryPriceAmountMicros,
                  ("introductoryPriceCurrencyCode" Core..=) Core.<$>
                    introductoryPriceCurrencyCode,
                  ("introductoryPriceCycles" Core..=) Core.<$>
                    introductoryPriceCycles,
                  ("introductoryPricePeriod" Core..=) Core.<$>
...
data LineItem = LineItem
    {
      ...
      listingPrice :: (Core.Maybe Money)
      -- | Details of a one-time purchase.
    , oneTimePurchaseDetails :: (Core.Maybe OneTimePurchaseDetails)
      -- | Details of a paid app purchase.
    , paidAppDetails :: (Core.Maybe PaidAppDetails)
    ...
    , subscriptionDetails :: (Core.Maybe SubscriptionDetails)
      -- | The tax paid for this line item.
    , tax :: (Core.Maybe Money)
      -- | The total amount paid by the user for this line item, taking into account discounts and tax.
    , total :: (Core.Maybe Money)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'LineItem' with the minimum fields required to make a request.
newLineItem 
    ::  LineItem
newLineItem
  = LineItem{listingPrice = Core.Nothing,
             oneTimePurchaseDetails = Core.Nothing,
             paidAppDetails = Core.Nothing, productId = Core.Nothing,
             productTitle = Core.Nothing, subscriptionDetails = Core.Nothing,
             tax = Core.Nothing, total = Core.Nothing}
instance Core.FromJSON LineItem where
        parseJSON
          = Core.withObject "LineItem"
              (\ o ->
                 LineItem Core.<$>
                   (o Core..:? "listingPrice") Core.<*>
                     (o Core..:? "oneTimePurchaseDetails")
                     Core.<*> (o Core..:? "paidAppDetails")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "productTitle")
                     Core.<*> (o Core..:? "subscriptionDetails")
                     Core.<*> (o Core..:? "tax")
                     Core.<*> (o Core..:? "total"))

instance Core.ToJSON LineItem where
        toJSON LineItem{..}
          = Core.object
              (Core.catMaybes
                 [("listingPrice" Core..=) Core.<$> listingPrice,
                  ("oneTimePurchaseDetails" Core..=) Core.<$> oneTimePurchaseDetails,
                  ("paidAppDetails" Core..=) Core.<$> paidAppDetails,
                  ("productId" Core..=) Core.<$> productId,
                  ("productTitle" Core..=) Core.<$> productTitle,
                  ("subscriptionDetails" Core..=) Core.<$> subscriptionDetails,
                  ("tax" Core..=) Core.<$> tax, ("total" Core..=) Core.<$> total])
...
instance Core.FromJSON ListAppRecoveriesResponse where
        parseJSON
          = Core.withObject "ListAppRecoveriesResponse"
              (\ o ->
...
newListDeviceTierConfigsResponse 
    ::  ListDeviceTierConfigsResponse
newListDeviceTierConfigsResponse
  = ListDeviceTierConfigsResponse{deviceTierConfigs = Core.Nothing,
                                  nextPageToken = Core.Nothing}
instance Core.FromJSON ListDeviceTierConfigsResponse where
        parseJSON
          = Core.withObject "ListDeviceTierConfigsResponse"
              (\ o ->
                 ListDeviceTierConfigsResponse Core.<$>
                   (o Core..:? "deviceTierConfigs") Core.<*>
...
newListSubscriptionOffersResponse 
    ::  ListSubscriptionOffersResponse
newListSubscriptionOffersResponse
  = ListSubscriptionOffersResponse{nextPageToken = Core.Nothing,
                                   subscriptionOffers = Core.Nothing}
instance Core.FromJSON ListSubscriptionOffersResponse where
        parseJSON
          = Core.withObject "ListSubscriptionOffersResponse"
              (\ o ->
                 ListSubscriptionOffersResponse Core.<$>
...
newListSubscriptionsResponse 
    ::  ListSubscriptionsResponse
newListSubscriptionsResponse
  = ListSubscriptionsResponse{nextPageToken = Core.Nothing,
                              subscriptions = Core.Nothing}
instance Core.FromJSON ListSubscriptionsResponse where
        parseJSON
          = Core.withObject "ListSubscriptionsResponse"
              (\ o ->
                 ListSubscriptionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "subscriptions"))
...
newListUsersResponse 
    ::  ListUsersResponse
newListUsersResponse
  = ListUsersResponse{nextPageToken = Core.Nothing,
                      users = Core.Nothing}
instance Core.FromJSON ListUsersResponse where
        parseJSON
          = Core.withObject "ListUsersResponse"
              (\ o ->
                 ListUsersResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "users"))
...
newListing 
    ::  Listing
newListing
  = Listing{fullDescription = Core.Nothing, language = Core.Nothing,
            shortDescription = Core.Nothing, title = Core.Nothing,
            video = Core.Nothing}
instance Core.FromJSON Listing where
        parseJSON
          = Core.withObject "Listing"
              (\ o ->
                 Listing Core.<$>
                   (o Core..:? "fullDescription") Core.<*> (o Core..:? "language")
...
newListingsListResponse 
    ::  ListingsListResponse
newListingsListResponse
  = ListingsListResponse{kind = Core.Nothing,
                         listings = Core.Nothing}
instance Core.FromJSON ListingsListResponse where
        parseJSON
          = Core.withObject "ListingsListResponse"
              (\ o ->
                 ListingsListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "listings"))
...
instance Core.FromJSON LocalizedText where
        parseJSON
          = Core.withObject "LocalizedText"
              (\ o ->
                 LocalizedText Core.<$>
                   (o Core..:? "language") Core.<*> (o Core..:? "text"))
...
data ManagedProductTaxAndComplianceSettings = ManagedProductTaxAndComplianceSettings
    {
      ...
      eeaWithdrawalRightType :: (Core.Maybe
   ManagedProductTaxAndComplianceSettings_EeaWithdrawalRightType)
    ...
    , taxRateInfoByRegionCode :: (Core.Maybe
   ManagedProductTaxAndComplianceSettings_TaxRateInfoByRegionCode)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
instance Core.FromJSON ManagedProductTaxAndComplianceSettings where
        parseJSON
          = Core.withObject "ManagedProductTaxAndComplianceSettings"
              (\ o ->
                 ManagedProductTaxAndComplianceSettings Core.<$>
                   (o Core..:? "eeaWithdrawalRightType") Core.<*>
                     (o Core..:? "isTokenizedDigitalAsset")
...
instance Core.ToJSON ManagedProductTaxAndComplianceSettings where
        toJSON ManagedProductTaxAndComplianceSettings{..}
          = Core.object
              (Core.catMaybes
                 [("eeaWithdrawalRightType" Core..=) Core.<$>
                    eeaWithdrawalRightType,
                  ("isTokenizedDigitalAsset" Core..=) Core.<$>
                    isTokenizedDigitalAsset,
                  ("taxRateInfoByRegionCode" Core..=) Core.<$>
...
newManagedProductTaxAndComplianceSettings_TaxRateInfoByRegionCode
  additional
  = ManagedProductTaxAndComplianceSettings_TaxRateInfoByRegionCode{additional
                                                                     = additional}
instance Core.FromJSON
           ManagedProductTaxAndComplianceSettings_TaxRateInfoByRegionCode
         where
...
newMigrateBasePlanPricesRequest 
    ::  MigrateBasePlanPricesRequest
newMigrateBasePlanPricesRequest
  = MigrateBasePlanPricesRequest{basePlanId = Core.Nothing,
                                 latencyTolerance = Core.Nothing, packageName = Core.Nothing,
                                 productId = Core.Nothing, regionalPriceMigrations = Core.Nothing,
                                 regionsVersion = Core.Nothing}
instance Core.FromJSON MigrateBasePlanPricesRequest where
        parseJSON
          = Core.withObject "MigrateBasePlanPricesRequest"
              (\ o ->
                 MigrateBasePlanPricesRequest Core.<$>
                   (o Core..:? "basePlanId") Core.<*> (o Core..:? "latencyTolerance")
                     Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId")
          ...
          = Core.object
              (Core.catMaybes
                 [("basePlanId" Core..=) Core.<$> basePlanId,
                  ...
                  ("packageName" Core..=) Core.<$> packageName,
                  ("productId" Core..=) Core.<$> productId,
                  ("regionalPriceMigrations" Core..=) Core.<$>
...
instance Core.FromJSON MigrateBasePlanPricesResponse where
        parseJSON
          = Core.withObject "MigrateBasePlanPricesResponse"
...
newModuleMetadata 
    ::  ModuleMetadata
newModuleMetadata
  = ModuleMetadata{deliveryType = Core.Nothing,
                   dependencies = Core.Nothing, moduleType = Core.Nothing,
                   name = Core.Nothing, targeting = Core.Nothing}
instance Core.FromJSON ModuleMetadata where
        parseJSON
          = Core.withObject "ModuleMetadata"
              (\ o ->
                 ModuleMetadata Core.<$>
                   (o Core..:? "deliveryType") Core.<*> (o Core..:? "dependencies")
...
newModuleTargeting 
    ::  ModuleTargeting
newModuleTargeting
  = ModuleTargeting{deviceFeatureTargeting = Core.Nothing,
                    sdkVersionTargeting = Core.Nothing,
                    userCountriesTargeting = Core.Nothing}
instance Core.FromJSON ModuleTargeting where
        parseJSON
          = Core.withObject "ModuleTargeting"
              (\ o ->
                 ModuleTargeting Core.<$>
                   (o Core..:? "deviceFeatureTargeting") Core.<*>
                     (o Core..:? "sdkVersionTargeting")
...
instance Core.ToJSON ModuleTargeting where
        toJSON ModuleTargeting{..}
          = Core.object
              (Core.catMaybes
                 [("deviceFeatureTargeting" Core..=) Core.<$>
                    deviceFeatureTargeting,
                  ("sdkVersionTargeting" Core..=) Core.<$> sdkVersionTargeting,
                  ("userCountriesTargeting" Core..=) Core.<$>
                    userCountriesTargeting])
...
newMultiAbiTargeting 
    ::  MultiAbiTargeting
newMultiAbiTargeting
  = MultiAbiTargeting{alternatives = Core.Nothing,
                      value = Core.Nothing}
instance Core.FromJSON MultiAbiTargeting where
        parseJSON
          = Core.withObject "MultiAbiTargeting"
              (\ o ->
                 MultiAbiTargeting Core.<$>
                   (o Core..:? "alternatives") Core.<*> (o Core..:? "value"))
...
newOfferDetails 
    ::  OfferDetails
newOfferDetails
  = OfferDetails{basePlanId = Core.Nothing, offerId = Core.Nothing,
                 offerTags = Core.Nothing}
instance Core.FromJSON OfferDetails where
        parseJSON
          = Core.withObject "OfferDetails"
              (\ o ->
                 OfferDetails Core.<$>
                   (o Core..:? "basePlanId") Core.<*> (o Core..:? "offerId") Core.<*>
                     (o Core..:? "offerTags"))
...
newOneTimeExternalTransaction 
    ::  OneTimeExternalTransaction
newOneTimeExternalTransaction
  = OneTimeExternalTransaction{externalTransactionToken =
                                 Core.Nothing}
instance Core.FromJSON OneTimeExternalTransaction where
        parseJSON
          = Core.withObject "OneTimeExternalTransaction"
              (\ o ->
                 OneTimeExternalTransaction Core.<$>
                   (o Core..:? "externalTransactionToken"))

instance Core.ToJSON OneTimeExternalTransaction where
        toJSON OneTimeExternalTransaction{..}
          = Core.object
              (Core.catMaybes
                 [("externalTransactionToken" Core..=) Core.<$>
                    externalTransactionToken])


-- | Details of a one-time purchase.
--
-- /See:/ 'newOneTimePurchaseDetails' smart constructor.
data OneTimePurchaseDetails = OneTimePurchaseDetails
    {
...
-- | Creates a value of 'OneTimePurchaseDetails' with the minimum fields required to make a request.
newOneTimePurchaseDetails 
    ::  OneTimePurchaseDetails
newOneTimePurchaseDetails
  = OneTimePurchaseDetails{offerId = Core.Nothing,
                           quantity = Core.Nothing}
instance Core.FromJSON OneTimePurchaseDetails where
        parseJSON
          = Core.withObject "OneTimePurchaseDetails"
              (\ o ->
                 OneTimePurchaseDetails Core.<$>
                   (o Core..:? "offerId") Core.<*> (o Core..:? "quantity"))

instance Core.ToJSON OneTimePurchaseDetails where
        toJSON OneTimePurchaseDetails{..}
          = Core.object
              (Core.catMaybes
                 [("offerId" Core..=) Core.<$> offerId,
...
data Order = Order
    {
      ...
      buyerAddress :: (Core.Maybe BuyerAddress)
    ...
    , developerRevenueInBuyerCurrency :: (Core.Maybe Money)
...
newOrder 
    ::  Order
newOrder
  = Order{buyerAddress = Core.Nothing, createTime = Core.Nothing,
          developerRevenueInBuyerCurrency = Core.Nothing,
          lastEventTime = Core.Nothing, lineItems = Core.Nothing,
          orderDetails = Core.Nothing, orderHistory = Core.Nothing,
          orderId = Core.Nothing, pointsDetails = Core.Nothing,
          purchaseToken = Core.Nothing, state = Core.Nothing,
          tax = Core.Nothing, total = Core.Nothing}
instance Core.FromJSON Order where
        parseJSON
          = Core.withObject "Order"
              (\ o ->
                 Order Core.<$>
                   (o Core..:? "buyerAddress") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "developerRevenueInBuyerCurrency")
                     Core.<*> (o Core..:? "lastEventTime")
                     Core.<*> (o Core..:? "lineItems")
                     Core.<*> (o Core..:? "orderDetails")
                     Core.<*> (o Core..:? "orderHistory")
                     Core.<*> (o Core..:? "orderId")
                     Core.<*> (o Core..:? "pointsDetails")
...
instance Core.ToJSON Order where
        toJSON Order{..}
          = Core.object
              (Core.catMaybes
                 [("buyerAddress" Core..=) Core.<$> buyerAddress,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("developerRevenueInBuyerCurrency" Core..=) Core.<$>
                    developerRevenueInBuyerCurrency,
                  ("lastEventTime" Core..=) Core.<$> lastEventTime,
                  ("lineItems" Core..=) Core.<$> lineItems,
                  ("orderDetails" Core..=) Core.<$> orderDetails,
                  ("orderHistory" Core..=) Core.<$> orderHistory,
                  ("orderId" Core..=) Core.<$> orderId,
                  ("pointsDetails" Core..=) Core.<$> pointsDetails,
                  ("purchaseToken" Core..=) Core.<$> purchaseToken,
                  ("state" Core..=) Core.<$> state, ("tax" Core..=) Core.<$> tax,
                  ("total" Core..=) Core.<$> total])


-- | Detailed information about the order at creation time.
--
-- /See:/ 'newOrderDetails' smart constructor.
newtype OrderDetails = OrderDetails
    {
      -- | Indicates whether the listed price was tax inclusive or not.
      taxInclusive :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OrderDetails' with the minimum fields required to make a request.
newOrderDetails 
    ::  OrderDetails
newOrderDetails = OrderDetails{taxInclusive = Core.Nothing}
instance Core.FromJSON OrderDetails where
        parseJSON
          = Core.withObject "OrderDetails"
              (\ o -> OrderDetails Core.<$> (o Core..:? "taxInclusive"))

instance Core.ToJSON OrderDetails where
        toJSON OrderDetails{..}
          = Core.object
              (Core.catMaybes [("taxInclusive" Core..=) Core.<$> taxInclusive])


-- | Details about events which modified the order.
--
-- /See:/ 'newOrderHistory' smart constructor.
data OrderHistory = OrderHistory
    {
      -- | Details of when the order was canceled.
      cancellationEvent :: (Core.Maybe CancellationEvent)
      -- | Details of the partial refund events for this order.
    , partialRefundEvents :: (Core.Maybe [PartialRefundEvent])
      -- | Details of when the order was processed.
    , processedEvent :: (Core.Maybe ProcessedEvent)
      -- | Details of when the order was fully refunded.
    , refundEvent :: (Core.Maybe RefundEvent)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OrderHistory' with the minimum fields required to make a request.
newOrderHistory 
    ::  OrderHistory
newOrderHistory
  = OrderHistory{cancellationEvent = Core.Nothing,
                 partialRefundEvents = Core.Nothing, processedEvent = Core.Nothing,
                 refundEvent = Core.Nothing}
instance Core.FromJSON OrderHistory where
        parseJSON
          = Core.withObject "OrderHistory"
              (\ o ->
                 OrderHistory Core.<$>
                   (o Core..:? "cancellationEvent") Core.<*>
                     (o Core..:? "partialRefundEvents")
                     Core.<*> (o Core..:? "processedEvent")
                     Core.<*> (o Core..:? "refundEvent"))

instance Core.ToJSON OrderHistory where
        toJSON OrderHistory{..}
          = Core.object
              (Core.catMaybes
                 [("cancellationEvent" Core..=) Core.<$> cancellationEvent,
                  ("partialRefundEvents" Core..=) Core.<$> partialRefundEvents,
                  ("processedEvent" Core..=) Core.<$> processedEvent,
                  ("refundEvent" Core..=) Core.<$> refundEvent])
...
instance Core.FromJSON OtherRecurringProduct where
        parseJSON
          = Core.withObject "OtherRecurringProduct"
...
newOtherRegionsBasePlanConfig 
    ::  OtherRegionsBasePlanConfig
newOtherRegionsBasePlanConfig
  = OtherRegionsBasePlanConfig{eurPrice = Core.Nothing,
                               newSubscriberAvailability' = Core.Nothing, usdPrice = Core.Nothing}
instance Core.FromJSON OtherRegionsBasePlanConfig where
        parseJSON
          = Core.withObject "OtherRegionsBasePlanConfig"
              (\ o ->
                 OtherRegionsBasePlanConfig Core.<$>
                   (o Core..:? "eurPrice") Core.<*>
                     (o Core..:? "newSubscriberAvailability")
...
instance Core.ToJSON OtherRegionsBasePlanConfig where
        toJSON OtherRegionsBasePlanConfig{..}
          = Core.object
              (Core.catMaybes
                 [("eurPrice" Core..=) Core.<$> eurPrice,
                  ("newSubscriberAvailability" Core..=) Core.<$>
...
newOtherRegionsSubscriptionOfferConfig 
    :: 
                                       OtherRegionsSubscriptionOfferConfig
newOtherRegionsSubscriptionOfferConfig
  = OtherRegionsSubscriptionOfferConfig{otherRegionsNewSubscriberAvailability
                                          = Core.Nothing}
instance Core.FromJSON OtherRegionsSubscriptionOfferConfig where
        parseJSON
          = Core.withObject "OtherRegionsSubscriptionOfferConfig"
              (\ o ->
                 OtherRegionsSubscriptionOfferConfig Core.<$>
                   (o Core..:? "otherRegionsNewSubscriberAvailability"))

instance Core.ToJSON OtherRegionsSubscriptionOfferConfig where
        toJSON OtherRegionsSubscriptionOfferConfig{..}
          = Core.object
              (Core.catMaybes
                 [("otherRegionsNewSubscriberAvailability" Core..=) Core.<$>
...
newOtherRegionsSubscriptionOfferPhaseConfig 
    :: 
                                            OtherRegionsSubscriptionOfferPhaseConfig
newOtherRegionsSubscriptionOfferPhaseConfig
  = OtherRegionsSubscriptionOfferPhaseConfig{absoluteDiscounts =
                                               Core.Nothing,
                                             free = Core.Nothing, otherRegionsPrices = Core.Nothing,
                                             relativeDiscount = Core.Nothing}
instance Core.FromJSON OtherRegionsSubscriptionOfferPhaseConfig
         where
        parseJSON
          = Core.withObject "OtherRegionsSubscriptionOfferPhaseConfig"
              (\ o ->
                 OtherRegionsSubscriptionOfferPhaseConfig Core.<$>
                   (o Core..:? "absoluteDiscounts") Core.<*> (o Core..:? "free")
...
newOtherRegionsSubscriptionOfferPhasePrices 
    :: 
                                            OtherRegionsSubscriptionOfferPhasePrices
newOtherRegionsSubscriptionOfferPhasePrices
  = OtherRegionsSubscriptionOfferPhasePrices{eurPrice = Core.Nothing,
                                             usdPrice = Core.Nothing}
instance Core.FromJSON OtherRegionsSubscriptionOfferPhasePrices
         where
        parseJSON
          = Core.withObject "OtherRegionsSubscriptionOfferPhasePrices"
              (\ o ->
                 OtherRegionsSubscriptionOfferPhasePrices Core.<$>
                   (o Core..:? "eurPrice") Core.<*> (o Core..:? "usdPrice"))
...
newPageInfo 
    ::  PageInfo
newPageInfo
  = PageInfo{resultPerPage = Core.Nothing, startIndex = Core.Nothing,
             totalResults = Core.Nothing}
instance Core.FromJSON PageInfo where
        parseJSON
          = Core.withObject "PageInfo"
              (\ o ->
                 PageInfo Core.<$>
                   (o Core..:? "resultPerPage") Core.<*> (o Core..:? "startIndex")
...
-- | Details of a paid app purchase.
--
-- /See:/ 'newPaidAppDetails' smart constructor.
data PaidAppDetails = PaidAppDetails
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PaidAppDetails' with the minimum fields required to make a request.
newPaidAppDetails 
    ::  PaidAppDetails
newPaidAppDetails = PaidAppDetails
instance Core.FromJSON PaidAppDetails where
        parseJSON
          = Core.withObject "PaidAppDetails"
              (\ o -> Core.pure PaidAppDetails)

instance Core.ToJSON PaidAppDetails where
        toJSON = Core.const Core.emptyObject
...
newPartialRefund 
    ::  PartialRefund
newPartialRefund
  = PartialRefund{refundId = Core.Nothing,
                  refundPreTaxAmount = Core.Nothing}
instance Core.FromJSON PartialRefund where
        parseJSON
          = Core.withObject "PartialRefund"
              (\ o ->
                 PartialRefund Core.<$>
                   (o Core..:? "refundId") Core.<*> (o Core..:? "refundPreTaxAmount"))
...
-- | Details of the partial refund events for this order.
--
-- /See:/ 'newPartialRefundEvent' smart constructor.
data PartialRefundEvent = PartialRefundEvent
    {
      -- | The time when the partial refund was created.
      createTime :: (Core.Maybe Core.DateTime)
      -- | The time when the partial refund was processed.
    , processTime :: (Core.Maybe Core.DateTime)
      -- | Details for the partial refund.
    , refundDetails :: (Core.Maybe RefundDetails)
      -- | The state of the partial refund.
    , state :: (Core.Maybe PartialRefundEvent_State)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PartialRefundEvent' with the minimum fields required to make a request.
newPartialRefundEvent 
    ::  PartialRefundEvent
newPartialRefundEvent
  = PartialRefundEvent{createTime = Core.Nothing,
                       processTime = Core.Nothing, refundDetails = Core.Nothing,
                       state = Core.Nothing}
instance Core.FromJSON PartialRefundEvent where
        parseJSON
          = Core.withObject "PartialRefundEvent"
              (\ o ->
                 PartialRefundEvent Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "processTime")
                     Core.<*> (o Core..:? "refundDetails")
                     Core.<*> (o Core..:? "state"))

instance Core.ToJSON PartialRefundEvent where
        toJSON PartialRefundEvent{..}
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("processTime" Core..=) Core.<$> processTime,
                  ("refundDetails" Core..=) Core.<$> refundDetails,
                  ("state" Core..=) Core.<$> state])
...
instance Core.FromJSON PausedStateContext where
        parseJSON
          = Core.withObject "PausedStateContext"
...
instance Core.FromJSON PendingCancellation where
        parseJSON
          = Core.withObject "PendingCancellation"
...
--
-- /See:/ 'newPointsDetails' smart constructor.
data PointsDetails = PointsDetails
    {
      ...
      pointsCouponValue :: (Core.Maybe Money)
    ...
    , pointsDiscountRateMicros :: (Core.Maybe Core.Int64)
      -- | ID unique to the play points offer in use for this order.
    , pointsOfferId :: (Core.Maybe Core.Text)
    ...
    , pointsSpent :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PointsDetails' with the minimum fields required to make a request.
newPointsDetails 
    ::  PointsDetails
newPointsDetails
  = PointsDetails{pointsCouponValue = Core.Nothing,
                  pointsDiscountRateMicros = Core.Nothing,
                  pointsOfferId = Core.Nothing, pointsSpent = Core.Nothing}
instance Core.FromJSON PointsDetails where
        parseJSON
          = Core.withObject "PointsDetails"
              (\ o ->
                 PointsDetails Core.<$>
                   (o Core..:? "pointsCouponValue") Core.<*>
                     (o Core..:? "pointsDiscountRateMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "pointsOfferId")
                     Core.<*>
                     (o Core..:? "pointsSpent" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON PointsDetails where
        toJSON PointsDetails{..}
          = Core.object
              (Core.catMaybes
                 [("pointsCouponValue" Core..=) Core.<$> pointsCouponValue,
                  ("pointsDiscountRateMicros" Core..=) Core.. Core.AsText Core.<$>
                    pointsDiscountRateMicros,
                  ("pointsOfferId" Core..=) Core.<$> pointsOfferId,
                  ("pointsSpent" Core..=) Core.. Core.AsText Core.<$> pointsSpent])
...
newPrepaidBasePlanType 
    ::  PrepaidBasePlanType
newPrepaidBasePlanType
  = PrepaidBasePlanType{billingPeriodDuration = Core.Nothing,
                        timeExtension = Core.Nothing}
instance Core.FromJSON PrepaidBasePlanType where
        parseJSON
          = Core.withObject "PrepaidBasePlanType"
              (\ o ->
                 PrepaidBasePlanType Core.<$>
                   (o Core..:? "billingPeriodDuration") Core.<*>
                     (o Core..:? "timeExtension"))
...
instance Core.FromJSON Price where
        parseJSON
          = Core.withObject "Price"
              (\ o ->
                 Price Core.<$>
                   (o Core..:? "currency") Core.<*> (o Core..:? "priceMicros"))
...
-- | Details of when the order was processed.
--
-- /See:/ 'newProcessedEvent' smart constructor.
newtype ProcessedEvent = ProcessedEvent
    {
...
-- | Creates a value of 'ProcessedEvent' with the minimum fields required to make a request.
newProcessedEvent 
    ::  ProcessedEvent
newProcessedEvent = ProcessedEvent{eventTime = Core.Nothing}
instance Core.FromJSON ProcessedEvent where
        parseJSON
          = Core.withObject "ProcessedEvent"
              (\ o -> ProcessedEvent Core.<$> (o Core..:? "eventTime"))

instance Core.ToJSON ProcessedEvent where
        toJSON ProcessedEvent{..}
          = Core.object
              (Core.catMaybes [("eventTime" Core..=) Core.<$> eventTime])
...
newProductPurchase 
    ::  ProductPurchase
newProductPurchase
  = ProductPurchase{acknowledgementState = Core.Nothing,
                    consumptionState = Core.Nothing, developerPayload = Core.Nothing,
                    kind = Core.Nothing, obfuscatedExternalAccountId = Core.Nothing,
                    obfuscatedExternalProfileId = Core.Nothing, orderId = Core.Nothing,
                    productId = Core.Nothing, purchaseState = Core.Nothing,
                    purchaseTimeMillis = Core.Nothing, purchaseToken = Core.Nothing,
                    purchaseType = Core.Nothing, quantity = Core.Nothing,
                    refundableQuantity = Core.Nothing, regionCode = Core.Nothing}
instance Core.FromJSON ProductPurchase where
        parseJSON
          = Core.withObject "ProductPurchase"
              (\ o ->
                 ProductPurchase Core.<$>
                   (o Core..:? "acknowledgementState") Core.<*>
                     (o Core..:? "consumptionState")
                     ...
                     Core.<*>
                     (o Core..:? "purchaseTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "purchaseToken")
                     Core.<*> (o Core..:? "purchaseType")
          ...
          = Core.object
              (Core.catMaybes
                 [("acknowledgementState" Core..=) Core.<$> acknowledgementState,
                  ...
                  ("purchaseTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    purchaseTimeMillis,
                  ("purchaseToken" Core..=) Core.<$> purchaseToken,
                  ("purchaseType" Core..=) Core.<$> purchaseType,
                  ("quantity" Core..=) Core.<$> quantity,
...
newProductPurchasesAcknowledgeRequest 
    :: 
                                      ProductPurchasesAcknowledgeRequest
newProductPurchasesAcknowledgeRequest
  = ProductPurchasesAcknowledgeRequest{developerPayload =
                                         Core.Nothing}
instance Core.FromJSON ProductPurchasesAcknowledgeRequest where
        parseJSON
          = Core.withObject "ProductPurchasesAcknowledgeRequest"
              (\ o ->
                 ProductPurchasesAcknowledgeRequest Core.<$>
                   (o Core..:? "developerPayload"))
...
data RecurringExternalTransaction = RecurringExternalTransaction
    ...
    , migratedTransactionProgram :: (Core.Maybe
...
newRecurringExternalTransaction 
    ::  RecurringExternalTransaction
newRecurringExternalTransaction
  = RecurringExternalTransaction{externalSubscription = Core.Nothing,
...
instance Core.FromJSON RecurringExternalTransaction where
        parseJSON
          = Core.withObject "RecurringExternalTransaction"
              (\ o ->
                 RecurringExternalTransaction Core.<$>
                   (o Core..:? "externalSubscription") Core.<*>
                     (o Core..:? "externalTransactionToken")
          ...
          = Core.object
              (Core.catMaybes
                 [("externalSubscription" Core..=) Core.<$> externalSubscription,
                  ("externalTransactionToken" Core..=) Core.<$>
                    externalTransactionToken,
                  ("initialExternalTransactionId" Core..=) Core.<$>
                    initialExternalTransactionId,
                  ("migratedTransactionProgram" Core..=) Core.<$>
...
--
-- /See:/ 'newRefundDetails' smart constructor.
...
-- | Creates a value of 'RefundDetails' with the minimum fields required to make a request.
newRefundDetails 
    ::  RefundDetails
newRefundDetails
  = RefundDetails{tax = Core.Nothing, total = Core.Nothing}
instance Core.FromJSON RefundDetails where
        parseJSON
          = Core.withObject "RefundDetails"
              (\ o ->
                 RefundDetails Core.<$>
                   (o Core..:? "tax") Core.<*> (o Core..:? "total"))

instance Core.ToJSON RefundDetails where
        toJSON RefundDetails{..}
          = Core.object
              (Core.catMaybes
                 [("tax" Core..=) Core.<$> tax, ("total" Core..=) Core.<$> total])
...
-- | Details of when the order was fully refunded.
--
-- /See:/ 'newRefundEvent' smart constructor.
data RefundEvent = RefundEvent
    {
    ...
    , refundReason :: (Core.Maybe RefundEvent_RefundReason)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RefundEvent' with the minimum fields required to make a request.
newRefundEvent 
    ::  RefundEvent
newRefundEvent
  = RefundEvent{eventTime = Core.Nothing,
                refundDetails = Core.Nothing, refundReason = Core.Nothing}
instance Core.FromJSON RefundEvent where
        parseJSON
          = Core.withObject "RefundEvent"
              (\ o ->
                 RefundEvent Core.<$>
                   (o Core..:? "eventTime") Core.<*> (o Core..:? "refundDetails")
                     Core.<*> (o Core..:? "refundReason"))

instance Core.ToJSON RefundEvent where
        toJSON RefundEvent{..}
          = Core.object
              (Core.catMaybes
                 [("eventTime" Core..=) Core.<$> eventTime,
                  ("refundDetails" Core..=) Core.<$> refundDetails,
                  ("refundReason" Core..=) Core.<$> refundReason])
...
newRefundExternalTransactionRequest 
    :: 
                                    RefundExternalTransactionRequest
newRefundExternalTransactionRequest
  = RefundExternalTransactionRequest{fullRefund = Core.Nothing,
                                     partialRefund = Core.Nothing, refundTime = Core.Nothing}
instance Core.FromJSON RefundExternalTransactionRequest where
        parseJSON
          = Core.withObject "RefundExternalTransactionRequest"
              (\ o ->
                 RefundExternalTransactionRequest Core.<$>
                   (o Core..:? "fullRefund") Core.<*> (o Core..:? "partialRefund")
...
newRegionalBasePlanConfig 
    ::  RegionalBasePlanConfig
newRegionalBasePlanConfig
  = RegionalBasePlanConfig{newSubscriberAvailability' = Core.Nothing,
                           price = Core.Nothing, regionCode = Core.Nothing}
instance Core.FromJSON RegionalBasePlanConfig where
        parseJSON
          = Core.withObject "RegionalBasePlanConfig"
              (\ o ->
                 RegionalBasePlanConfig Core.<$>
                   (o Core..:? "newSubscriberAvailability") Core.<*>
                     (o Core..:? "price")
                     Core.<*> (o Core..:? "regionCode"))
...
newRegionalPriceMigrationConfig 
    ::  RegionalPriceMigrationConfig
newRegionalPriceMigrationConfig
  = RegionalPriceMigrationConfig{oldestAllowedPriceVersionTime =
                                   Core.Nothing,
                                 priceIncreaseType = Core.Nothing, regionCode = Core.Nothing}
instance Core.FromJSON RegionalPriceMigrationConfig where
        parseJSON
          = Core.withObject "RegionalPriceMigrationConfig"
              (\ o ->
                 RegionalPriceMigrationConfig Core.<$>
                   (o Core..:? "oldestAllowedPriceVersionTime") Core.<*>
                     (o Core..:? "priceIncreaseType")
                     Core.<*> (o Core..:? "regionCode"))
...
instance Core.ToJSON RegionalPriceMigrationConfig where
        toJSON RegionalPriceMigrationConfig{..}
          = Core.object
              (Core.catMaybes
                 [("oldestAllowedPriceVersionTime" Core..=) Core.<$>
...
newRegionalSubscriptionOfferConfig 
    :: 
                                   RegionalSubscriptionOfferConfig
newRegionalSubscriptionOfferConfig
  = RegionalSubscriptionOfferConfig{newSubscriberAvailability' =
                                      Core.Nothing,
                                    regionCode = Core.Nothing}
instance Core.FromJSON RegionalSubscriptionOfferConfig where
        parseJSON
          = Core.withObject "RegionalSubscriptionOfferConfig"
              (\ o ->
                 RegionalSubscriptionOfferConfig Core.<$>
                   (o Core..:? "newSubscriberAvailability") Core.<*>
                     (o Core..:? "regionCode"))
...
newRegionalSubscriptionOfferPhaseConfig 
    :: 
                                        RegionalSubscriptionOfferPhaseConfig
newRegionalSubscriptionOfferPhaseConfig
  = RegionalSubscriptionOfferPhaseConfig{absoluteDiscount =
                                           Core.Nothing,
                                         free = Core.Nothing, price = Core.Nothing,
                                         regionCode = Core.Nothing, relativeDiscount = Core.Nothing}
instance Core.FromJSON RegionalSubscriptionOfferPhaseConfig where
        parseJSON
          = Core.withObject "RegionalSubscriptionOfferPhaseConfig"
              (\ o ->
                 RegionalSubscriptionOfferPhaseConfig Core.<$>
                   (o Core..:? "absoluteDiscount") Core.<*> (o Core..:? "free")
                     Core.<*> (o Core..:? "price")
                     Core.<*> (o Core..:? "regionCode")
                     Core.<*> (o Core..:? "relativeDiscount"))
          ...
          = Core.object
              (Core.catMaybes
                 [("absoluteDiscount" Core..=) Core.<$> absoluteDiscount,
                  ("free" Core..=) Core.<$> free, ("price" Core..=) Core.<$> price,
                  ("regionCode" Core..=) Core.<$> regionCode,
                  ("relativeDiscount" Core..=) Core.<$> relativeDiscount])
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "RegionalSubscriptionOfferPhaseFreePriceOverride"
...
newRegionalTaxRateInfo 
    ::  RegionalTaxRateInfo
newRegionalTaxRateInfo
  = RegionalTaxRateInfo{eligibleForStreamingServiceTaxRate =
                          Core.Nothing,
                        streamingTaxType = Core.Nothing, taxTier = Core.Nothing}
instance Core.FromJSON RegionalTaxRateInfo where
        parseJSON
          = Core.withObject "RegionalTaxRateInfo"
              (\ o ->
                 RegionalTaxRateInfo Core.<$>
                   (o Core..:? "eligibleForStreamingServiceTaxRate") Core.<*>
                     (o Core..:? "streamingTaxType")
                     Core.<*> (o Core..:? "taxTier"))
...
instance Core.ToJSON RegionalTaxRateInfo where
        toJSON RegionalTaxRateInfo{..}
          = Core.object
              (Core.catMaybes
                 [("eligibleForStreamingServiceTaxRate" Core..=) Core.<$>
...
instance Core.FromJSON RegionsVersion where
        parseJSON
          = Core.withObject "RegionsVersion"
...
instance Core.FromJSON RemoteInAppUpdate where
        parseJSON
          = Core.withObject "RemoteInAppUpdate"
              (\ o ->
                 RemoteInAppUpdate Core.<$>
                   (o Core..:? "isRemoteInAppUpdateRequested"))

instance Core.ToJSON RemoteInAppUpdate where
        toJSON RemoteInAppUpdate{..}
          = Core.object
              (Core.catMaybes
                 [("isRemoteInAppUpdateRequested" Core..=) Core.<$>
...
newRemoteInAppUpdateData 
    ::  RemoteInAppUpdateData
newRemoteInAppUpdateData
  = RemoteInAppUpdateData{remoteAppUpdateDataPerBundle =
                            Core.Nothing}
instance Core.FromJSON RemoteInAppUpdateData where
        parseJSON
          = Core.withObject "RemoteInAppUpdateData"
              (\ o ->
                 RemoteInAppUpdateData Core.<$>
                   (o Core..:? "remoteAppUpdateDataPerBundle"))

instance Core.ToJSON RemoteInAppUpdateData where
        toJSON RemoteInAppUpdateData{..}
          = Core.object
              (Core.catMaybes
                 [("remoteAppUpdateDataPerBundle" Core..=) Core.<$>
...
newRemoteInAppUpdateDataPerBundle 
    ::  RemoteInAppUpdateDataPerBundle
newRemoteInAppUpdateDataPerBundle
  = RemoteInAppUpdateDataPerBundle{recoveredDeviceCount =
                                     Core.Nothing,
                                   totalDeviceCount = Core.Nothing, versionCode = Core.Nothing}
instance Core.FromJSON RemoteInAppUpdateDataPerBundle where
        parseJSON
          = Core.withObject "RemoteInAppUpdateDataPerBundle"
              (\ o ->
                 RemoteInAppUpdateDataPerBundle Core.<$>
                   (o Core..:? "recoveredDeviceCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalDeviceCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.ToJSON RemoteInAppUpdateDataPerBundle where
        toJSON RemoteInAppUpdateDataPerBundle{..}
          = Core.object
              (Core.catMaybes
                 [("recoveredDeviceCount" Core..=) Core.. Core.AsText Core.<$>
                    recoveredDeviceCount,
                  ("totalDeviceCount" Core..=) Core.. Core.AsText Core.<$>
                    totalDeviceCount,
...
instance Core.FromJSON ReplacementCancellation where
        parseJSON
          = Core.withObject "ReplacementCancellation"
...
instance Core.FromJSON RestrictedPaymentCountries where
        parseJSON
          = Core.withObject "RestrictedPaymentCountries"
              (\ o ->
...
newReview 
    ::  Review
newReview
  = Review{authorName = Core.Nothing, comments = Core.Nothing,
           reviewId = Core.Nothing}
instance Core.FromJSON Review where
        parseJSON
          = Core.withObject "Review"
              (\ o ->
                 Review Core.<$>
                   (o Core..:? "authorName") Core.<*> (o Core..:? "comments") Core.<*>
                     (o Core..:? "reviewId"))
...
newReviewReplyResult 
    ::  ReviewReplyResult
newReviewReplyResult
  = ReviewReplyResult{lastEdited = Core.Nothing,
                      replyText = Core.Nothing}
instance Core.FromJSON ReviewReplyResult where
        parseJSON
          = Core.withObject "ReviewReplyResult"
              (\ o ->
                 ReviewReplyResult Core.<$>
                   (o Core..:? "lastEdited") Core.<*> (o Core..:? "replyText"))
...
newReviewsListResponse 
    ::  ReviewsListResponse
newReviewsListResponse
  = ReviewsListResponse{pageInfo = Core.Nothing,
                        reviews = Core.Nothing, tokenPagination = Core.Nothing}
instance Core.FromJSON ReviewsListResponse where
        parseJSON
          = Core.withObject "ReviewsListResponse"
              (\ o ->
                 ReviewsListResponse Core.<$>
                   (o Core..:? "pageInfo") Core.<*> (o Core..:? "reviews") Core.<*>
                     (o Core..:? "tokenPagination"))
...
instance Core.FromJSON ReviewsReplyRequest where
        parseJSON
          = Core.withObject "ReviewsReplyRequest"
...
instance Core.FromJSON ReviewsReplyResponse where
        parseJSON
          = Core.withObject "ReviewsReplyResponse"
...
data RevocationContext = RevocationContext
    ...
    , itemBasedRefund :: (Core.Maybe RevocationContextItemBasedRefund)
...
newRevocationContext 
    ::  RevocationContext
newRevocationContext
  = RevocationContext{fullRefund = Core.Nothing,
                      itemBasedRefund = Core.Nothing, proratedRefund = Core.Nothing}
instance Core.FromJSON RevocationContext where
        parseJSON
          = Core.withObject "RevocationContext"
              (\ o ->
                 RevocationContext Core.<$>
                   (o Core..:? "fullRefund") Core.<*> (o Core..:? "itemBasedRefund")
...
instance Core.ToJSON RevocationContext where
        toJSON RevocationContext{..}
          = Core.object
              (Core.catMaybes
                 [("fullRefund" Core..=) Core.<$> fullRefund,
                  ("itemBasedRefund" Core..=) Core.<$> itemBasedRefund,
...
instance Core.FromJSON RevocationContextFullRefund where
        parseJSON
          = Core.withObject "RevocationContextFullRefund"
...
--
-- /See:/ 'newRevocationContextItemBasedRefund' smart constructor.
newtype RevocationContextItemBasedRefund = RevocationContextItemBasedRefund
    {
...
-- | Creates a value of 'RevocationContextItemBasedRefund' with the minimum fields required to make a request.
newRevocationContextItemBasedRefund 
    :: 
                                    RevocationContextItemBasedRefund
newRevocationContextItemBasedRefund
  = RevocationContextItemBasedRefund{productId = Core.Nothing}
instance Core.FromJSON RevocationContextItemBasedRefund where
        parseJSON
          = Core.withObject "RevocationContextItemBasedRefund"
              (\ o ->
                 RevocationContextItemBasedRefund Core.<$> (o Core..:? "productId"))

instance Core.ToJSON RevocationContextItemBasedRefund where
        toJSON RevocationContextItemBasedRefund{..}
          = Core.object
              (Core.catMaybes [("productId" Core..=) Core.<$> productId])
...
instance Core.FromJSON RevocationContextProratedRefund where
        parseJSON
          = Core.withObject "RevocationContextProratedRefund"
...
newRevokeSubscriptionPurchaseRequest 
    :: 
                                     RevokeSubscriptionPurchaseRequest
newRevokeSubscriptionPurchaseRequest
  = RevokeSubscriptionPurchaseRequest{revocationContext =
                                        Core.Nothing}
instance Core.FromJSON RevokeSubscriptionPurchaseRequest where
        parseJSON
          = Core.withObject "RevokeSubscriptionPurchaseRequest"
              (\ o ->
                 RevokeSubscriptionPurchaseRequest Core.<$>
                   (o Core..:? "revocationContext"))
...
instance Core.FromJSON RevokeSubscriptionPurchaseResponse where
        parseJSON
          = Core.withObject "RevokeSubscriptionPurchaseResponse"
...
instance Core.FromJSON SafetyLabelsUpdateRequest where
        parseJSON
          = Core.withObject "SafetyLabelsUpdateRequest"
              (\ o ->
...
instance Core.FromJSON SafetyLabelsUpdateResponse where
        parseJSON
          = Core.withObject "SafetyLabelsUpdateResponse"
...
newScreenDensity 
    ::  ScreenDensity
newScreenDensity
  = ScreenDensity{densityAlias = Core.Nothing,
                  densityDpi = Core.Nothing}
instance Core.FromJSON ScreenDensity where
        parseJSON
          = Core.withObject "ScreenDensity"
              (\ o ->
                 ScreenDensity Core.<$>
                   (o Core..:? "densityAlias") Core.<*> (o Core..:? "densityDpi"))
...
newScreenDensityTargeting 
    ::  ScreenDensityTargeting
newScreenDensityTargeting
  = ScreenDensityTargeting{alternatives = Core.Nothing,
                           value = Core.Nothing}
instance Core.FromJSON ScreenDensityTargeting where
        parseJSON
          = Core.withObject "ScreenDensityTargeting"
              (\ o ->
                 ScreenDensityTargeting Core.<$>
                   (o Core..:? "alternatives") Core.<*> (o Core..:? "value"))
...
newSdkVersionTargeting 
    ::  SdkVersionTargeting
newSdkVersionTargeting
  = SdkVersionTargeting{alternatives = Core.Nothing,
                        value = Core.Nothing}
instance Core.FromJSON SdkVersionTargeting where
        parseJSON
          = Core.withObject "SdkVersionTargeting"
              (\ o ->
                 SdkVersionTargeting Core.<$>
                   (o Core..:? "alternatives") Core.<*> (o Core..:? "value"))
...
newSignupPromotion 
    ::  SignupPromotion
newSignupPromotion
  = SignupPromotion{oneTimeCode = Core.Nothing,
                    vanityCode = Core.Nothing}
instance Core.FromJSON SignupPromotion where
        parseJSON
          = Core.withObject "SignupPromotion"
              (\ o ->
                 SignupPromotion Core.<$>
                   (o Core..:? "oneTimeCode") Core.<*> (o Core..:? "vanityCode"))
...
newSplitApkMetadata 
    ::  SplitApkMetadata
newSplitApkMetadata
  = SplitApkMetadata{isMasterSplit = Core.Nothing,
                     splitId = Core.Nothing}
instance Core.FromJSON SplitApkMetadata where
        parseJSON
          = Core.withObject "SplitApkMetadata"
              (\ o ->
                 SplitApkMetadata Core.<$>
                   (o Core..:? "isMasterSplit") Core.<*> (o Core..:? "splitId"))
...
newSplitApkVariant 
    ::  SplitApkVariant
newSplitApkVariant
  = SplitApkVariant{apkSet = Core.Nothing, targeting = Core.Nothing,
                    variantNumber = Core.Nothing}
instance Core.FromJSON SplitApkVariant where
        parseJSON
          = Core.withObject "SplitApkVariant"
              (\ o ->
                 SplitApkVariant Core.<$>
                   (o Core..:? "apkSet") Core.<*> (o Core..:? "targeting") Core.<*>
                     (o Core..:? "variantNumber"))
...
instance Core.FromJSON StandaloneApkMetadata where
        parseJSON
          = Core.withObject "StandaloneApkMetadata"
              (\ o ->
...
newSubscribeWithGoogleInfo 
    ::  SubscribeWithGoogleInfo
newSubscribeWithGoogleInfo
  = SubscribeWithGoogleInfo{emailAddress = Core.Nothing,
                            familyName = Core.Nothing, givenName = Core.Nothing,
                            profileId = Core.Nothing, profileName = Core.Nothing}
instance Core.FromJSON SubscribeWithGoogleInfo where
        parseJSON
          = Core.withObject "SubscribeWithGoogleInfo"
              (\ o ->
                 SubscribeWithGoogleInfo Core.<$>
                   (o Core..:? "emailAddress") Core.<*> (o Core..:? "familyName")
...
newSubscription 
    ::  Subscription
newSubscription
  = Subscription{archived = Core.Nothing, basePlans = Core.Nothing,
                 listings = Core.Nothing, packageName = Core.Nothing,
                 productId = Core.Nothing,
                 restrictedPaymentCountries = Core.Nothing,
                 taxAndComplianceSettings = Core.Nothing}
instance Core.FromJSON Subscription where
        parseJSON
          = Core.withObject "Subscription"
              (\ o ->
                 Subscription Core.<$>
                   (o Core..:? "archived") Core.<*> (o Core..:? "basePlans") Core.<*>
                     (o Core..:? "listings")
                     Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId")
          ...
          = Core.object
              (Core.catMaybes
                 [("archived" Core..=) Core.<$> archived,
                  ...
                  ("packageName" Core..=) Core.<$> packageName,
                  ("productId" Core..=) Core.<$> productId,
                  ("restrictedPaymentCountries" Core..=) Core.<$>
                    restrictedPaymentCountries,
                  ("taxAndComplianceSettings" Core..=) Core.<$>
...
newSubscriptionCancelSurveyResult 
    ::  SubscriptionCancelSurveyResult
newSubscriptionCancelSurveyResult
  = SubscriptionCancelSurveyResult{cancelSurveyReason = Core.Nothing,
                                   userInputCancelReason = Core.Nothing}
instance Core.FromJSON SubscriptionCancelSurveyResult where
        parseJSON
          = Core.withObject "SubscriptionCancelSurveyResult"
              (\ o ->
                 SubscriptionCancelSurveyResult Core.<$>
                   (o Core..:? "cancelSurveyReason") Core.<*>
                     (o Core..:? "userInputCancelReason"))
...
newSubscriptionDeferralInfo 
    ::  SubscriptionDeferralInfo
newSubscriptionDeferralInfo
  = SubscriptionDeferralInfo{desiredExpiryTimeMillis = Core.Nothing,
                             expectedExpiryTimeMillis = Core.Nothing}
instance Core.FromJSON SubscriptionDeferralInfo where
        parseJSON
          = Core.withObject "SubscriptionDeferralInfo"
              (\ o ->
                 SubscriptionDeferralInfo Core.<$>
                   (o Core..:? "desiredExpiryTimeMillis" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "expectedExpiryTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON SubscriptionDeferralInfo where
        toJSON SubscriptionDeferralInfo{..}
          = Core.object
              (Core.catMaybes
                 [("desiredExpiryTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    desiredExpiryTimeMillis,
                  ("expectedExpiryTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    expectedExpiryTimeMillis])


-- | Details of a subscription purchase.
--
-- /See:/ 'newSubscriptionDetails' smart constructor.
data SubscriptionDetails = SubscriptionDetails
    ...
    , offerPhase :: (Core.Maybe SubscriptionDetails_OfferPhase)
    ...
    , servicePeriodEndTime :: (Core.Maybe Core.DateTime)
    ...
    , servicePeriodStartTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SubscriptionDetails' with the minimum fields required to make a request.
newSubscriptionDetails 
    ::  SubscriptionDetails
newSubscriptionDetails
  = SubscriptionDetails{basePlanId = Core.Nothing,
                        offerId = Core.Nothing, offerPhase = Core.Nothing,
                        servicePeriodEndTime = Core.Nothing,
                        servicePeriodStartTime = Core.Nothing}
instance Core.FromJSON SubscriptionDetails where
        parseJSON
          = Core.withObject "SubscriptionDetails"
              (\ o ->
                 SubscriptionDetails Core.<$>
                   (o Core..:? "basePlanId") Core.<*> (o Core..:? "offerId") Core.<*>
                     (o Core..:? "offerPhase")
                     Core.<*> (o Core..:? "servicePeriodEndTime")
                     Core.<*> (o Core..:? "servicePeriodStartTime"))

instance Core.ToJSON SubscriptionDetails where
        toJSON SubscriptionDetails{..}
          = Core.object
              (Core.catMaybes
                 [("basePlanId" Core..=) Core.<$> basePlanId,
                  ("offerId" Core..=) Core.<$> offerId,
                  ("offerPhase" Core..=) Core.<$> offerPhase,
                  ("servicePeriodEndTime" Core..=) Core.<$> servicePeriodEndTime,
                  ("servicePeriodStartTime" Core..=) Core.<$>
...
newSubscriptionItemPriceChangeDetails 
    :: 
                                      SubscriptionItemPriceChangeDetails
newSubscriptionItemPriceChangeDetails
  = SubscriptionItemPriceChangeDetails{expectedNewPriceChargeTime =
                                         Core.Nothing,
                                       newPrice' = Core.Nothing, priceChangeMode = Core.Nothing,
                                       priceChangeState = Core.Nothing}
instance Core.FromJSON SubscriptionItemPriceChangeDetails where
        parseJSON
          = Core.withObject "SubscriptionItemPriceChangeDetails"
              (\ o ->
                 SubscriptionItemPriceChangeDetails Core.<$>
                   (o Core..:? "expectedNewPriceChargeTime") Core.<*>
                     (o Core..:? "newPrice")
...
instance Core.ToJSON SubscriptionItemPriceChangeDetails where
        toJSON SubscriptionItemPriceChangeDetails{..}
          = Core.object
              (Core.catMaybes
                 [("expectedNewPriceChargeTime" Core..=) Core.<$>
...
newSubscriptionListing 
    ::  SubscriptionListing
newSubscriptionListing
  = SubscriptionListing{benefits = Core.Nothing,
                        description = Core.Nothing, languageCode = Core.Nothing,
                        title = Core.Nothing}
instance Core.FromJSON SubscriptionListing where
        parseJSON
          = Core.withObject "SubscriptionListing"
              (\ o ->
                 SubscriptionListing Core.<$>
                   (o Core..:? "benefits") Core.<*> (o Core..:? "description")
...
newSubscriptionOffer 
    ::  SubscriptionOffer
newSubscriptionOffer
  = SubscriptionOffer{basePlanId = Core.Nothing,
                      offerId = Core.Nothing, offerTags = Core.Nothing,
                      otherRegionsConfig = Core.Nothing, packageName = Core.Nothing,
                      phases = Core.Nothing, productId = Core.Nothing,
                      regionalConfigs = Core.Nothing, state = Core.Nothing,
                      targeting = Core.Nothing}
instance Core.FromJSON SubscriptionOffer where
        parseJSON
          = Core.withObject "SubscriptionOffer"
              (\ o ->
                 SubscriptionOffer Core.<$>
                   (o Core..:? "basePlanId") Core.<*> (o Core..:? "offerId") Core.<*>
                     (o Core..:? "offerTags")
                     Core.<*> (o Core..:? "otherRegionsConfig")
                     Core.<*> (o Core..:? "packageName")
...
newSubscriptionOfferPhase 
    ::  SubscriptionOfferPhase
newSubscriptionOfferPhase
  = SubscriptionOfferPhase{duration = Core.Nothing,
                           otherRegionsConfig = Core.Nothing, recurrenceCount = Core.Nothing,
                           regionalConfigs = Core.Nothing}
instance Core.FromJSON SubscriptionOfferPhase where
        parseJSON
          = Core.withObject "SubscriptionOfferPhase"
              (\ o ->
                 SubscriptionOfferPhase Core.<$>
                   (o Core..:? "duration") Core.<*> (o Core..:? "otherRegionsConfig")
...
newSubscriptionOfferTargeting 
    ::  SubscriptionOfferTargeting
newSubscriptionOfferTargeting
  = SubscriptionOfferTargeting{acquisitionRule = Core.Nothing,
                               upgradeRule = Core.Nothing}
instance Core.FromJSON SubscriptionOfferTargeting where
        parseJSON
          = Core.withObject "SubscriptionOfferTargeting"
              (\ o ->
                 SubscriptionOfferTargeting Core.<$>
                   (o Core..:? "acquisitionRule") Core.<*> (o Core..:? "upgradeRule"))
...
newSubscriptionPriceChange 
    ::  SubscriptionPriceChange
newSubscriptionPriceChange
  = SubscriptionPriceChange{newPrice' = Core.Nothing,
                            state = Core.Nothing}
instance Core.FromJSON SubscriptionPriceChange where
        parseJSON
          = Core.withObject "SubscriptionPriceChange"
              (\ o ->
                 SubscriptionPriceChange Core.<$>
                   (o Core..:? "newPrice") Core.<*> (o Core..:? "state"))
...
newSubscriptionPurchase 
    ::  SubscriptionPurchase
newSubscriptionPurchase
  = SubscriptionPurchase{acknowledgementState = Core.Nothing,
                         autoRenewing = Core.Nothing, autoResumeTimeMillis = Core.Nothing,
                         cancelReason = Core.Nothing, cancelSurveyResult = Core.Nothing,
                         countryCode = Core.Nothing, developerPayload = Core.Nothing,
                         emailAddress = Core.Nothing, expiryTimeMillis = Core.Nothing,
                         externalAccountId = Core.Nothing, familyName = Core.Nothing,
                         givenName = Core.Nothing, introductoryPriceInfo = Core.Nothing,
                         kind = Core.Nothing, linkedPurchaseToken = Core.Nothing,
                         obfuscatedExternalAccountId = Core.Nothing,
                         obfuscatedExternalProfileId = Core.Nothing, orderId = Core.Nothing,
                         paymentState = Core.Nothing, priceAmountMicros = Core.Nothing,
                         priceChange = Core.Nothing, priceCurrencyCode = Core.Nothing,
                         profileId = Core.Nothing, profileName = Core.Nothing,
                         promotionCode = Core.Nothing, promotionType = Core.Nothing,
                         purchaseType = Core.Nothing, startTimeMillis = Core.Nothing,
                         userCancellationTimeMillis = Core.Nothing}
instance Core.FromJSON SubscriptionPurchase where
        parseJSON
          = Core.withObject "SubscriptionPurchase"
              (\ o ->
                 SubscriptionPurchase Core.<$>
                   (o Core..:? "acknowledgementState") Core.<*>
                     (o Core..:? "autoRenewing")
                     Core.<*>
                     (o Core..:? "autoResumeTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "expiryTimeMillis" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "priceAmountMicros" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "purchaseType")
                     Core.<*>
                     (o Core..:? "startTimeMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "userCancellationTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("acknowledgementState" Core..=) Core.<$> acknowledgementState,
                  ...
                  ("autoResumeTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("developerPayload" Core..=) Core.<$> developerPayload,
                  ("emailAddress" Core..=) Core.<$> emailAddress,
                  ("expiryTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    expiryTimeMillis,
                  ("externalAccountId" Core..=) Core.<$> externalAccountId,
                  ("familyName" Core..=) Core.<$> familyName,
                  ("givenName" Core..=) Core.<$> givenName,
                  ...
                  ("priceAmountMicros" Core..=) Core.. Core.AsText Core.<$>
                    priceAmountMicros,
                  ...
                  ("purchaseType" Core..=) Core.<$> purchaseType,
                  ("startTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    startTimeMillis,
                  ("userCancellationTimeMillis" Core..=) Core.. Core.AsText Core.<$>
...
data SubscriptionPurchaseLineItem = SubscriptionPurchaseLineItem
    ...
    , latestSuccessfulOrderId :: (Core.Maybe Core.Text)
...
newSubscriptionPurchaseLineItem 
    ::  SubscriptionPurchaseLineItem
newSubscriptionPurchaseLineItem
  = SubscriptionPurchaseLineItem{autoRenewingPlan = Core.Nothing,
                                 deferredItemReplacement = Core.Nothing, expiryTime = Core.Nothing,
                                 latestSuccessfulOrderId = Core.Nothing,
                                 offerDetails = Core.Nothing, prepaidPlan = Core.Nothing,
                                 productId = Core.Nothing, signupPromotion = Core.Nothing}
instance Core.FromJSON SubscriptionPurchaseLineItem where
        parseJSON
          = Core.withObject "SubscriptionPurchaseLineItem"
              (\ o ->
                 SubscriptionPurchaseLineItem Core.<$>
                   (o Core..:? "autoRenewingPlan") Core.<*>
                     (o Core..:? "deferredItemReplacement")
                     Core.<*> (o Core..:? "expiryTime")
                     Core.<*> (o Core..:? "latestSuccessfulOrderId")
          ...
          = Core.object
              (Core.catMaybes
                 [("autoRenewingPlan" Core..=) Core.<$> autoRenewingPlan,
                  ("deferredItemReplacement" Core..=) Core.<$>
                    deferredItemReplacement,
                  ("expiryTime" Core..=) Core.<$> expiryTime,
                  ("latestSuccessfulOrderId" Core..=) Core.<$>
...
data SubscriptionPurchaseV2 = SubscriptionPurchaseV2
    ...
    , kind :: (Core.Maybe Core.Text)
      -- | Deprecated: Use line/items.latest/successful/order/id instead. The order id of the latest order associated with the purchase of the subscription. For autoRenewing subscription, this is the order id of signup order if it is not renewed yet, or the last recurring order id (success, pending, or declined order). For prepaid subscription, this is the order id associated with the queried purchase token.
...
newSubscriptionPurchaseV2 
    ::  SubscriptionPurchaseV2
newSubscriptionPurchaseV2
  = SubscriptionPurchaseV2{acknowledgementState = Core.Nothing,
                           canceledStateContext = Core.Nothing,
                           externalAccountIdentifiers = Core.Nothing, kind = Core.Nothing,
                           latestOrderId = Core.Nothing, lineItems = Core.Nothing,
                           linkedPurchaseToken = Core.Nothing,
                           pausedStateContext = Core.Nothing, regionCode = Core.Nothing,
                           startTime = Core.Nothing, subscribeWithGoogleInfo = Core.Nothing,
                           subscriptionState = Core.Nothing, testPurchase = Core.Nothing}
instance Core.FromJSON SubscriptionPurchaseV2 where
        parseJSON
          = Core.withObject "SubscriptionPurchaseV2"
              (\ o ->
                 SubscriptionPurchaseV2 Core.<$>
                   (o Core..:? "acknowledgementState") Core.<*>
                     (o Core..:? "canceledStateContext")
          ...
          = Core.object
              (Core.catMaybes
                 [("acknowledgementState" Core..=) Core.<$> acknowledgementState,
                  ...
                  ("externalAccountIdentifiers" Core..=) Core.<$>
                    externalAccountIdentifiers,
                  ("kind" Core..=) Core.<$> kind,
                  ...
                  ("subscribeWithGoogleInfo" Core..=) Core.<$>
                    subscribeWithGoogleInfo,
...
newSubscriptionPurchasesAcknowledgeRequest 
    :: 
                                           SubscriptionPurchasesAcknowledgeRequest
newSubscriptionPurchasesAcknowledgeRequest
  = SubscriptionPurchasesAcknowledgeRequest{developerPayload =
                                              Core.Nothing}
instance Core.FromJSON SubscriptionPurchasesAcknowledgeRequest
         where
        parseJSON
          = Core.withObject "SubscriptionPurchasesAcknowledgeRequest"
              (\ o ->
                 SubscriptionPurchasesAcknowledgeRequest Core.<$>
                   (o Core..:? "developerPayload"))
...
instance Core.FromJSON SubscriptionPurchasesDeferRequest where
        parseJSON
          = Core.withObject "SubscriptionPurchasesDeferRequest"
              (\ o ->
                 SubscriptionPurchasesDeferRequest Core.<$>
                   (o Core..:? "deferralInfo"))
...
newSubscriptionPurchasesDeferResponse 
    :: 
                                      SubscriptionPurchasesDeferResponse
newSubscriptionPurchasesDeferResponse
  = SubscriptionPurchasesDeferResponse{newExpiryTimeMillis' =
                                         Core.Nothing}
instance Core.FromJSON SubscriptionPurchasesDeferResponse where
        parseJSON
          = Core.withObject "SubscriptionPurchasesDeferResponse"
              (\ o ->
                 SubscriptionPurchasesDeferResponse Core.<$>
                   (o Core..:? "newExpiryTimeMillis" Core.<&>
                      Core.fmap Core.fromAsText))
...
instance Core.ToJSON SubscriptionPurchasesDeferResponse where
        toJSON SubscriptionPurchasesDeferResponse{..}
          = Core.object
              (Core.catMaybes
                 [("newExpiryTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    newExpiryTimeMillis'])
...
instance Core.FromJSON SubscriptionTaxAndComplianceSettings where
        parseJSON
          = Core.withObject "SubscriptionTaxAndComplianceSettings"
              (\ o ->
                 SubscriptionTaxAndComplianceSettings Core.<$>
                   (o Core..:? "eeaWithdrawalRightType") Core.<*>
                     (o Core..:? "isTokenizedDigitalAsset")
                     Core.<*> (o Core..:? "taxRateInfoByRegionCode"))
...
newSubscriptionTaxAndComplianceSettings_TaxRateInfoByRegionCode
  additional
  = SubscriptionTaxAndComplianceSettings_TaxRateInfoByRegionCode{additional
                                                                   = additional}
instance Core.FromJSON
           SubscriptionTaxAndComplianceSettings_TaxRateInfoByRegionCode
         where
...
newSystemApkOptions 
    ::  SystemApkOptions
newSystemApkOptions
  = SystemApkOptions{rotated = Core.Nothing,
                     uncompressedDexFiles = Core.Nothing,
                     uncompressedNativeLibraries = Core.Nothing}
instance Core.FromJSON SystemApkOptions where
        parseJSON
          = Core.withObject "SystemApkOptions"
              (\ o ->
                 SystemApkOptions Core.<$>
                   (o Core..:? "rotated") Core.<*> (o Core..:? "uncompressedDexFiles")
          ...
          = Core.object
              (Core.catMaybes
                 [("rotated" Core..=) Core.<$> rotated,
                  ...
                  ("uncompressedNativeLibraries" Core..=) Core.<$>
...
instance Core.FromJSON SystemApksListResponse where
        parseJSON
          = Core.withObject "SystemApksListResponse"
...
instance Core.FromJSON SystemInitiatedCancellation where
        parseJSON
          = Core.withObject "SystemInitiatedCancellation"
...
instance Core.FromJSON SystemOnChip where
        parseJSON
          = Core.withObject "SystemOnChip"
              (\ o ->
                 SystemOnChip Core.<$>
                   (o Core..:? "manufacturer") Core.<*> (o Core..:? "model"))
...
newTargeting 
    ::  Targeting
newTargeting
  = Targeting{allUsers = Core.Nothing, androidSdks = Core.Nothing,
              regions = Core.Nothing, versionList = Core.Nothing,
              versionRange = Core.Nothing}
instance Core.FromJSON Targeting where
        parseJSON
          = Core.withObject "Targeting"
              (\ o ->
                 Targeting Core.<$>
                   (o Core..:? "allUsers") Core.<*> (o Core..:? "androidSdks")
                     Core.<*> (o Core..:? "regions")
...
newTargetingInfo 
    ::  TargetingInfo
newTargetingInfo
  = TargetingInfo{assetSliceSet = Core.Nothing,
                  packageName = Core.Nothing, variant = Core.Nothing}
instance Core.FromJSON TargetingInfo where
        parseJSON
          = Core.withObject "TargetingInfo"
              (\ o ->
                 TargetingInfo Core.<$>
                   (o Core..:? "assetSliceSet") Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "variant"))
...
newTargetingRuleScope 
    ::  TargetingRuleScope
newTargetingRuleScope
  = TargetingRuleScope{anySubscriptionInApp = Core.Nothing,
                       specificSubscriptionInApp = Core.Nothing,
                       thisSubscription = Core.Nothing}
instance Core.FromJSON TargetingRuleScope where
        parseJSON
          = Core.withObject "TargetingRuleScope"
              (\ o ->
                 TargetingRuleScope Core.<$>
                   (o Core..:? "anySubscriptionInApp") Core.<*>
                     (o Core..:? "specificSubscriptionInApp")
          ...
          = Core.object
              (Core.catMaybes
                 [("anySubscriptionInApp" Core..=) Core.<$> anySubscriptionInApp,
                  ("specificSubscriptionInApp" Core..=) Core.<$>
...
instance Core.FromJSON TargetingRuleScopeAnySubscriptionInApp where
        parseJSON
          = Core.withObject "TargetingRuleScopeAnySubscriptionInApp"
...
instance Core.FromJSON TargetingRuleScopeThisSubscription where
        parseJSON
          = Core.withObject "TargetingRuleScopeThisSubscription"
...
newTargetingUpdate 
    ::  TargetingUpdate
newTargetingUpdate
  = TargetingUpdate{allUsers = Core.Nothing,
                    androidSdks = Core.Nothing, regions = Core.Nothing}
instance Core.FromJSON TargetingUpdate where
        parseJSON
          = Core.withObject "TargetingUpdate"
              (\ o ->
                 TargetingUpdate Core.<$>
                   (o Core..:? "allUsers") Core.<*> (o Core..:? "androidSdks")
                     Core.<*> (o Core..:? "regions"))
...
instance Core.FromJSON TextureCompressionFormat where
        parseJSON
          = Core.withObject "TextureCompressionFormat"
...
newTextureCompressionFormatTargeting 
    :: 
                                     TextureCompressionFormatTargeting
newTextureCompressionFormatTargeting
  = TextureCompressionFormatTargeting{alternatives = Core.Nothing,
                                      value = Core.Nothing}
instance Core.FromJSON TextureCompressionFormatTargeting where
        parseJSON
          = Core.withObject "TextureCompressionFormatTargeting"
              (\ o ->
...
instance Core.FromJSON Timestamp where
        parseJSON
          = Core.withObject "Timestamp"
              (\ o ->
                 Timestamp Core.<$>
                   (o Core..:? "nanos") Core.<*>
                     (o Core..:? "seconds" Core.<&> Core.fmap Core.fromAsText))
...
newTokenPagination 
    ::  TokenPagination
newTokenPagination
  = TokenPagination{nextPageToken = Core.Nothing,
                    previousPageToken = Core.Nothing}
instance Core.FromJSON TokenPagination where
        parseJSON
          = Core.withObject "TokenPagination"
              (\ o ->
                 TokenPagination Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "previousPageToken"))
...
instance Core.FromJSON Track where
        parseJSON
          = Core.withObject "Track"
              (\ o ->
                 Track Core.<$>
                   (o Core..:? "releases") Core.<*> (o Core..:? "track"))
...
newTrackConfig 
    ::  TrackConfig
newTrackConfig
  = TrackConfig{formFactor = Core.Nothing, track = Core.Nothing,
                type' = Core.Nothing}
instance Core.FromJSON TrackConfig where
        parseJSON
          = Core.withObject "TrackConfig"
              (\ o ->
                 TrackConfig Core.<$>
                   (o Core..:? "formFactor") Core.<*> (o Core..:? "track") Core.<*>
                     (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("formFactor" Core..=) Core.<$> formFactor,
                  ("track" Core..=) Core.<$> track, ("type" Core..=) Core.<$> type'])
...
newTrackCountryAvailability 
    ::  TrackCountryAvailability
newTrackCountryAvailability
  = TrackCountryAvailability{countries = Core.Nothing,
                             restOfWorld = Core.Nothing, syncWithProduction = Core.Nothing}
instance Core.FromJSON TrackCountryAvailability where
        parseJSON
          = Core.withObject "TrackCountryAvailability"
              (\ o ->
                 TrackCountryAvailability Core.<$>
                   (o Core..:? "countries") Core.<*> (o Core..:? "restOfWorld")
...
newTrackRelease 
    ::  TrackRelease
newTrackRelease
  = TrackRelease{countryTargeting = Core.Nothing,
                 inAppUpdatePriority = Core.Nothing, name = Core.Nothing,
                 releaseNotes = Core.Nothing, status = Core.Nothing,
                 userFraction = Core.Nothing, versionCodes = Core.Nothing}
instance Core.FromJSON TrackRelease where
        parseJSON
          = Core.withObject "TrackRelease"
              (\ o ->
                 TrackRelease Core.<$>
                   (o Core..:? "countryTargeting") Core.<*>
                     (o Core..:? "inAppUpdatePriority")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON TrackTargetedCountry where
        parseJSON
          = Core.withObject "TrackTargetedCountry"
...
instance Core.FromJSON TracksListResponse where
        parseJSON
          = Core.withObject "TracksListResponse"
              (\ o ->
                 TracksListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "tracks"))
...
newUpdateBasePlanStateRequest 
    ::  UpdateBasePlanStateRequest
newUpdateBasePlanStateRequest
  = UpdateBasePlanStateRequest{activateBasePlanRequest =
                                 Core.Nothing,
                               deactivateBasePlanRequest = Core.Nothing}
instance Core.FromJSON UpdateBasePlanStateRequest where
        parseJSON
          = Core.withObject "UpdateBasePlanStateRequest"
              (\ o ->
                 UpdateBasePlanStateRequest Core.<$>
                   (o Core..:? "activateBasePlanRequest") Core.<*>
                     (o Core..:? "deactivateBasePlanRequest"))

instance Core.ToJSON UpdateBasePlanStateRequest where
        toJSON UpdateBasePlanStateRequest{..}
          = Core.object
              (Core.catMaybes
                 [("activateBasePlanRequest" Core..=) Core.<$>
                    activateBasePlanRequest,
                  ("deactivateBasePlanRequest" Core..=) Core.<$>
                    deactivateBasePlanRequest])
...
newUpdateSubscriptionOfferRequest 
    ::  UpdateSubscriptionOfferRequest
newUpdateSubscriptionOfferRequest
  = UpdateSubscriptionOfferRequest{allowMissing = Core.Nothing,
                                   latencyTolerance = Core.Nothing, regionsVersion = Core.Nothing,
                                   subscriptionOffer = Core.Nothing, updateMask = Core.Nothing}
instance Core.FromJSON UpdateSubscriptionOfferRequest where
        parseJSON
          = Core.withObject "UpdateSubscriptionOfferRequest"
              (\ o ->
                 UpdateSubscriptionOfferRequest Core.<$>
                   (o Core..:? "allowMissing") Core.<*>
                     (o Core..:? "latencyTolerance")
                     Core.<*> (o Core..:? "regionsVersion")
...
newUpdateSubscriptionOfferStateRequest 
    :: 
                                       UpdateSubscriptionOfferStateRequest
newUpdateSubscriptionOfferStateRequest
  = UpdateSubscriptionOfferStateRequest{activateSubscriptionOfferRequest
                                          = Core.Nothing,
                                        deactivateSubscriptionOfferRequest = Core.Nothing}
instance Core.FromJSON UpdateSubscriptionOfferStateRequest where
        parseJSON
          = Core.withObject "UpdateSubscriptionOfferStateRequest"
              (\ o ->
                 UpdateSubscriptionOfferStateRequest Core.<$>
                   (o Core..:? "activateSubscriptionOfferRequest") Core.<*>
                     (o Core..:? "deactivateSubscriptionOfferRequest"))

instance Core.ToJSON UpdateSubscriptionOfferStateRequest where
        toJSON UpdateSubscriptionOfferStateRequest{..}
          = Core.object
              (Core.catMaybes
                 [("activateSubscriptionOfferRequest" Core..=) Core.<$>
                    activateSubscriptionOfferRequest,
                  ("deactivateSubscriptionOfferRequest" Core..=) Core.<$>
                    deactivateSubscriptionOfferRequest])
...
newUpdateSubscriptionRequest 
    ::  UpdateSubscriptionRequest
newUpdateSubscriptionRequest
  = UpdateSubscriptionRequest{allowMissing = Core.Nothing,
                              latencyTolerance = Core.Nothing, regionsVersion = Core.Nothing,
                              subscription = Core.Nothing, updateMask = Core.Nothing}
instance Core.FromJSON UpdateSubscriptionRequest where
        parseJSON
          = Core.withObject "UpdateSubscriptionRequest"
              (\ o ->
                 UpdateSubscriptionRequest Core.<$>
                   (o Core..:? "allowMissing") Core.<*>
                     (o Core..:? "latencyTolerance")
                     Core.<*> (o Core..:? "regionsVersion")
...
newUpgradeTargetingRule 
    ::  UpgradeTargetingRule
newUpgradeTargetingRule
  = UpgradeTargetingRule{billingPeriodDuration = Core.Nothing,
                         oncePerUser = Core.Nothing, scope = Core.Nothing}
instance Core.FromJSON UpgradeTargetingRule where
        parseJSON
          = Core.withObject "UpgradeTargetingRule"
              (\ o ->
                 UpgradeTargetingRule Core.<$>
                   (o Core..:? "billingPeriodDuration") Core.<*>
                     (o Core..:? "oncePerUser")
                     Core.<*> (o Core..:? "scope"))
...
newUser 
    ::  User
newUser
  = User{accessState = Core.Nothing,
         developerAccountPermissions = Core.Nothing, email = Core.Nothing,
         expirationTime = Core.Nothing, grants = Core.Nothing,
         name = Core.Nothing, partial = Core.Nothing}
              ...
              (\ o ->
                 User Core.<$>
                   (o Core..:? "accessState") Core.<*>
                     (o Core..:? "developerAccountPermissions")
                     Core.<*> (o Core..:? "email")
          ...
          = Core.object
              (Core.catMaybes
                 [("accessState" Core..=) Core.<$> accessState,
                  ("developerAccountPermissions" Core..=) Core.<$>
                    developerAccountPermissions,
                  ("email" Core..=) Core.<$> email,
                  ("expirationTime" Core..=) Core.<$> expirationTime,
                  ("grants" Core..=) Core.<$> grants, ("name" Core..=) Core.<$> name,
...
newUserComment 
    ::  UserComment
newUserComment
  = UserComment{androidOsVersion = Core.Nothing,
                appVersionCode = Core.Nothing, appVersionName = Core.Nothing,
                device = Core.Nothing, deviceMetadata = Core.Nothing,
                lastModified = Core.Nothing, originalText = Core.Nothing,
                reviewerLanguage = Core.Nothing, starRating = Core.Nothing,
                text = Core.Nothing, thumbsDownCount = Core.Nothing,
                thumbsUpCount = Core.Nothing}
instance Core.FromJSON UserComment where
        parseJSON
          = Core.withObject "UserComment"
              (\ o ->
                 UserComment Core.<$>
                   (o Core..:? "androidOsVersion") Core.<*>
                     (o Core..:? "appVersionCode")
...
newUserCountriesTargeting 
    ::  UserCountriesTargeting
newUserCountriesTargeting
  = UserCountriesTargeting{countryCodes = Core.Nothing,
                           exclude = Core.Nothing}
instance Core.FromJSON UserCountriesTargeting where
        parseJSON
          = Core.withObject "UserCountriesTargeting"
              (\ o ->
                 UserCountriesTargeting Core.<$>
                   (o Core..:? "countryCodes") Core.<*> (o Core..:? "exclude"))
...
instance Core.FromJSON UserCountrySet where
        parseJSON
          = Core.withObject "UserCountrySet"
              (\ o ->
                 UserCountrySet Core.<$>
                   (o Core..:? "countryCodes") Core.<*> (o Core..:? "name"))
...
newUserInitiatedCancellation 
    ::  UserInitiatedCancellation
newUserInitiatedCancellation
  = UserInitiatedCancellation{cancelSurveyResult = Core.Nothing,
                              cancelTime = Core.Nothing}
instance Core.FromJSON UserInitiatedCancellation where
        parseJSON
          = Core.withObject "UserInitiatedCancellation"
              (\ o ->
                 UserInitiatedCancellation Core.<$>
                   (o Core..:? "cancelSurveyResult") Core.<*>
                     (o Core..:? "cancelTime"))
...
instance Core.FromJSON UsesPermission where
        parseJSON
          = Core.withObject "UsesPermission"
              (\ o ->
                 UsesPermission Core.<$>
                   (o Core..:? "maxSdkVersion") Core.<*> (o Core..:? "name"))
...
newVariant 
    ::  Variant
newVariant
  = Variant{deviceSpec = Core.Nothing, options = Core.Nothing,
            variantId = Core.Nothing}
instance Core.FromJSON Variant where
        parseJSON
          = Core.withObject "Variant"
              (\ o ->
                 Variant Core.<$>
                   (o Core..:? "deviceSpec") Core.<*> (o Core..:? "options") Core.<*>
                     (o Core..:? "variantId"))
...
newVariantTargeting 
    ::  VariantTargeting
newVariantTargeting
  = VariantTargeting{abiTargeting = Core.Nothing,
...
instance Core.FromJSON VariantTargeting where
        parseJSON
          = Core.withObject "VariantTargeting"
              (\ o ->
                 VariantTargeting Core.<$>
                   (o Core..:? "abiTargeting") Core.<*>
                     (o Core..:? "multiAbiTargeting")
                     Core.<*> (o Core..:? "screenDensityTargeting")
                     Core.<*> (o Core..:? "sdkVersionTargeting")
                     Core.<*> (o Core..:? "textureCompressionFormatTargeting"))
...
newVoidedPurchase 
    ::  VoidedPurchase
newVoidedPurchase
  = VoidedPurchase{kind = Core.Nothing, orderId = Core.Nothing,
                   purchaseTimeMillis = Core.Nothing, purchaseToken = Core.Nothing,
                   voidedQuantity = Core.Nothing, voidedReason = Core.Nothing,
                   voidedSource = Core.Nothing, voidedTimeMillis = Core.Nothing}
instance Core.FromJSON VoidedPurchase where
        parseJSON
          = Core.withObject "VoidedPurchase"
              (\ o ->
                 VoidedPurchase Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "orderId") Core.<*>
                     (o Core..:? "purchaseTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "purchaseToken")
                     ...
                     Core.<*>
                     (o Core..:? "voidedTimeMillis" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ...
                  ("voidedTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    voidedTimeMillis])
...
newVoidedPurchasesListResponse 
    ::  VoidedPurchasesListResponse
newVoidedPurchasesListResponse
  = VoidedPurchasesListResponse{pageInfo = Core.Nothing,
                                tokenPagination = Core.Nothing, voidedPurchases = Core.Nothing}
instance Core.FromJSON VoidedPurchasesListResponse where
        parseJSON
          = Core.withObject "VoidedPurchasesListResponse"
              (\ o ->
                 VoidedPurchasesListResponse Core.<$>
                   (o Core..:? "pageInfo") Core.<*> (o Core..:? "tokenPagination")
