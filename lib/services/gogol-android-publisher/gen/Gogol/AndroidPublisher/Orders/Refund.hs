       ...
       "v3" Core.:>
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "orders" Core.:>
               Core.CaptureMode "orderId" "refund" Core.Text Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "revoke" Core.Bool Core.:>
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherOrdersRefund =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherOrdersRefund{..}
          = go packageName orderId xgafv accessToken callback
              revoke
              uploadType
              uploadProtocol
