...
module Gogol.ServiceUsage.Internal.Product
  (
    ...
    -- * BatchingConfigProto
    BatchingConfigProto (..),
    newBatchingConfigProto,

    -- * BatchingDescriptorProto
    BatchingDescriptorProto (..),
    newBatchingDescriptorProto,

    -- * BatchingSettingsProto
    BatchingSettingsProto (..),
    newBatchingSettingsProto,
...
--
-- /See:/ 'newAddEnableRulesMetadata' smart constructor.
data AddEnableRulesMetadata = AddEnableRulesMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AddEnableRulesMetadata' with the minimum fields required to make a request.
newAddEnableRulesMetadata 
    ::  AddEnableRulesMetadata
newAddEnableRulesMetadata = AddEnableRulesMetadata
instance Core.FromJSON AddEnableRulesMetadata where
        parseJSON
          = Core.withObject "AddEnableRulesMetadata"
              (\ o -> Core.pure AddEnableRulesMetadata)

instance Core.ToJSON AddEnableRulesMetadata where
        toJSON = Core.const Core.emptyObject


-- | The response message of @AddEnableRules@ method.
--
-- /See:/ 'newAddEnableRulesResponse' smart constructor.
data AddEnableRulesResponse = AddEnableRulesResponse
    {
      -- | The values added to the parent consumer policy.
      addedValues :: (Core.Maybe [Core.Text])
...
-- | Creates a value of 'AddEnableRulesResponse' with the minimum fields required to make a request.
newAddEnableRulesResponse 
    ::  AddEnableRulesResponse
newAddEnableRulesResponse
  = AddEnableRulesResponse{addedValues = Core.Nothing,
                           parent = Core.Nothing}
instance Core.FromJSON AddEnableRulesResponse where
        parseJSON
          = Core.withObject "AddEnableRulesResponse"
              (\ o ->
                 AddEnableRulesResponse Core.<$>
                   (o Core..:? "addedValues") Core.<*> (o Core..:? "parent"))

instance Core.ToJSON AddEnableRulesResponse where
        toJSON AddEnableRulesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("addedValues" Core..=) Core.<$> addedValues,
...
newAdminQuotaPolicy 
    ::  AdminQuotaPolicy
newAdminQuotaPolicy
  = AdminQuotaPolicy{container = Core.Nothing,
                     dimensions = Core.Nothing, metric = Core.Nothing,
                     name = Core.Nothing, policyValue = Core.Nothing,
                     unit = Core.Nothing}
          ...
          = Core.withObject "AdminQuotaPolicy"
              (\ o ->
                 AdminQuotaPolicy Core.<$>
                   (o Core..:? "container") Core.<*> (o Core..:? "dimensions")
                     Core.<*> (o Core..:? "metric")
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "policyValue" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "unit"))
          ...
          = Core.object
              (Core.catMaybes
                 [("container" Core..=) Core.<$> container,
                  ...
                  ("metric" Core..=) Core.<$> metric, ("name" Core..=) Core.<$> name,
...
newAdminQuotaPolicy_Dimensions 
    :: 
       ...
       -- ^  See 'additional'.
    -> AdminQuotaPolicy_Dimensions
newAdminQuotaPolicy_Dimensions additional
  = AdminQuotaPolicy_Dimensions{additional = additional}
instance Core.FromJSON AdminQuotaPolicy_Dimensions where
        parseJSON
          = Core.withObject "AdminQuotaPolicy_Dimensions"
              (\ o ->
                 AdminQuotaPolicy_Dimensions Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON AdminQuotaPolicy_Dimensions where
        toJSON AdminQuotaPolicy_Dimensions{..} = Core.toJSON additional
...
data Analysis = Analysis
    {
      ...
      analysis :: (Core.Maybe AnalysisResult)
      -- | Output only. The type of analysis.
    , analysisType :: (Core.Maybe Analysis_AnalysisType)
...
-- | Creates a value of 'Analysis' with the minimum fields required to make a request.
newAnalysis 
    ::  Analysis
newAnalysis
  = Analysis{analysis = Core.Nothing, analysisType = Core.Nothing,
             displayName = Core.Nothing, service = Core.Nothing}
instance Core.FromJSON Analysis where
        parseJSON
          = Core.withObject "Analysis"
              (\ o ->
                 Analysis Core.<$>
                   (o Core..:? "analysis") Core.<*> (o Core..:? "analysisType")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "service"))

instance Core.ToJSON Analysis where
        toJSON Analysis{..}
          = Core.object
              (Core.catMaybes
...
data AnalysisResult = AnalysisResult
    {
      ...
      blockers :: (Core.Maybe [Impact])
      -- | Warning information indicating that the policy changes might be unsafe, but will not block the changes at runtime.
    , warnings :: (Core.Maybe [Impact])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AnalysisResult' with the minimum fields required to make a request.
newAnalysisResult 
    ::  AnalysisResult
newAnalysisResult
  = AnalysisResult{blockers = Core.Nothing, warnings = Core.Nothing}
instance Core.FromJSON AnalysisResult where
        parseJSON
          = Core.withObject "AnalysisResult"
              (\ o ->
                 AnalysisResult Core.<$>
                   (o Core..:? "blockers") Core.<*> (o Core..:? "warnings"))

instance Core.ToJSON AnalysisResult where
...
--
-- /See:/ 'newAnalyzeConsumerPolicyMetadata' smart constructor.
data AnalyzeConsumerPolicyMetadata = AnalyzeConsumerPolicyMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AnalyzeConsumerPolicyMetadata' with the minimum fields required to make a request.
newAnalyzeConsumerPolicyMetadata 
    ::  AnalyzeConsumerPolicyMetadata
newAnalyzeConsumerPolicyMetadata = AnalyzeConsumerPolicyMetadata
instance Core.FromJSON AnalyzeConsumerPolicyMetadata where
        parseJSON
          = Core.withObject "AnalyzeConsumerPolicyMetadata"
              (\ o -> Core.pure AnalyzeConsumerPolicyMetadata)

instance Core.ToJSON AnalyzeConsumerPolicyMetadata where
        toJSON = Core.const Core.emptyObject


-- | The response of analyzing a consumer policy update.
--
-- /See:/ 'newAnalyzeConsumerPolicyResponse' smart constructor.
newtype AnalyzeConsumerPolicyResponse = AnalyzeConsumerPolicyResponse
    {
      ...
      analysis :: (Core.Maybe [Analysis])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AnalyzeConsumerPolicyResponse' with the minimum fields required to make a request.
newAnalyzeConsumerPolicyResponse 
    ::  AnalyzeConsumerPolicyResponse
newAnalyzeConsumerPolicyResponse
  = AnalyzeConsumerPolicyResponse{analysis = Core.Nothing}
instance Core.FromJSON AnalyzeConsumerPolicyResponse where
        parseJSON
          = Core.withObject "AnalyzeConsumerPolicyResponse"
              (\ o ->
                 AnalyzeConsumerPolicyResponse Core.<$> (o Core..:? "analysis"))

instance Core.ToJSON AnalyzeConsumerPolicyResponse where
        toJSON AnalyzeConsumerPolicyResponse{..}
          = Core.object
              (Core.catMaybes [("analysis" Core..=) Core.<$> analysis])
...
newApi 
    ::  Api
newApi
  = Api{methods = Core.Nothing, mixins = Core.Nothing,
        name = Core.Nothing, options = Core.Nothing,
        sourceContext = Core.Nothing, syntax = Core.Nothing,
...
instance Core.FromJSON Api where
        parseJSON
          = Core.withObject "Api"
              (\ o ->
                 Api Core.<$>
                   (o Core..:? "methods") Core.<*> (o Core..:? "mixins") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "options")
          ...
          = Core.object
              (Core.catMaybes
                 [("methods" Core..=) Core.<$> methods,
                  ("mixins" Core..=) Core.<$> mixins, ("name" Core..=) Core.<$> name,
...
newAuthProvider 
    ::  AuthProvider
newAuthProvider
  = AuthProvider{audiences = Core.Nothing,
                 authorizationUrl = Core.Nothing, id = Core.Nothing,
...
instance Core.FromJSON AuthProvider where
        parseJSON
          = Core.withObject "AuthProvider"
              (\ o ->
                 AuthProvider Core.<$>
                   (o Core..:? "audiences") Core.<*> (o Core..:? "authorizationUrl")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "issuer")
                     Core.<*> (o Core..:? "jwksUri")
          ...
          = Core.object
              (Core.catMaybes
                 [("audiences" Core..=) Core.<$> audiences,
                  ...
                  ("id" Core..=) Core.<$> id, ("issuer" Core..=) Core.<$> issuer,
...
newAuthRequirement 
    ::  AuthRequirement
newAuthRequirement
  = AuthRequirement{audiences = Core.Nothing,
          ...
          = Core.withObject "AuthRequirement"
              (\ o ->
                 AuthRequirement Core.<$>
                   (o Core..:? "audiences") Core.<*> (o Core..:? "providerId"))
...
instance Core.FromJSON Authentication where
        parseJSON
          = Core.withObject "Authentication"
              (\ o ->
                 Authentication Core.<$>
                   (o Core..:? "providers") Core.<*> (o Core..:? "rules"))
...
newAuthenticationRule 
    ::  AuthenticationRule
newAuthenticationRule
  = AuthenticationRule{allowWithoutCredential = Core.Nothing,
                       oauth = Core.Nothing, requirements = Core.Nothing,
          ...
          = Core.withObject "AuthenticationRule"
              (\ o ->
                 AuthenticationRule Core.<$>
                   (o Core..:? "allowWithoutCredential") Core.<*> (o Core..:? "oauth")
...
newBackendRule 
    ::  BackendRule
newBackendRule
  = BackendRule{address = Core.Nothing, deadline = Core.Nothing,
                disableAuth = Core.Nothing, jwtAudience = Core.Nothing,
                loadBalancingPolicy = Core.Nothing, minDeadline = Core.Nothing,
                operationDeadline = Core.Nothing,
                overridesByRequestProtocol = Core.Nothing,
                pathTranslation = Core.Nothing, protocol = Core.Nothing,
                selector = Core.Nothing}
instance Core.FromJSON BackendRule where
        parseJSON
          = Core.withObject "BackendRule"
              (\ o ->
                 BackendRule Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "deadline") Core.<*>
                     (o Core..:? "disableAuth")
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ...
                  ("overridesByRequestProtocol" Core..=) Core.<$>
...
instance Core.FromJSON BackendRule_OverridesByRequestProtocol where
        parseJSON
          = Core.withObject "BackendRule_OverridesByRequestProtocol"
              (\ o ->
                 BackendRule_OverridesByRequestProtocol Core.<$>
...
instance Core.FromJSON BatchCreateAdminOverridesResponse where
        parseJSON
...
instance Core.ToJSON BatchCreateAdminOverridesResponse where
...
instance Core.FromJSON BatchCreateConsumerOverridesResponse where
        parseJSON
          = Core.withObject "BatchCreateConsumerOverridesResponse"
              (\ o ->
                 BatchCreateConsumerOverridesResponse Core.<$>
                   (o Core..:? "overrides"))

instance Core.ToJSON BatchCreateConsumerOverridesResponse where
...
instance Core.FromJSON BatchEnableServicesRequest where
        parseJSON
          = Core.withObject "BatchEnableServicesRequest"
              (\ o ->
                 BatchEnableServicesRequest Core.<$> (o Core..:? "serviceIds"))

instance Core.ToJSON BatchEnableServicesRequest where
        toJSON BatchEnableServicesRequest{..}
          = Core.object
              (Core.catMaybes [("serviceIds" Core..=) Core.<$> serviceIds])
...
newBatchEnableServicesResponse 
    ::  BatchEnableServicesResponse
newBatchEnableServicesResponse
  = BatchEnableServicesResponse{failures = Core.Nothing,
                                services = Core.Nothing}
instance Core.FromJSON BatchEnableServicesResponse where
        parseJSON
          = Core.withObject "BatchEnableServicesResponse"
              (\ o ->
                 BatchEnableServicesResponse Core.<$>
                   (o Core..:? "failures") Core.<*> (o Core..:? "services"))

instance Core.ToJSON BatchEnableServicesResponse where
...
newBatchGetServicesResponse 
    ::  BatchGetServicesResponse
newBatchGetServicesResponse
  = BatchGetServicesResponse{services = Core.Nothing}
instance Core.FromJSON BatchGetServicesResponse where
        parseJSON
          = Core.withObject "BatchGetServicesResponse"
              (\ o -> BatchGetServicesResponse Core.<$> (o Core..:? "services"))
...
--
-- /See:/ 'newBatchingConfigProto' smart constructor.
data BatchingConfigProto = BatchingConfigProto
    {
      -- | The request and response fields used in batching.
      batchDescriptor :: (Core.Maybe BatchingDescriptorProto)
      -- | The thresholds which trigger a batched request to be sent.
    , thresholds :: (Core.Maybe BatchingSettingsProto)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchingConfigProto' with the minimum fields required to make a request.
newBatchingConfigProto 
    ::  BatchingConfigProto
newBatchingConfigProto
  = BatchingConfigProto{batchDescriptor = Core.Nothing,
                        thresholds = Core.Nothing}
instance Core.FromJSON BatchingConfigProto where
        parseJSON
          = Core.withObject "BatchingConfigProto"
              (\ o ->
                 BatchingConfigProto Core.<$>
                   (o Core..:? "batchDescriptor") Core.<*> (o Core..:? "thresholds"))

instance Core.ToJSON BatchingConfigProto where
        toJSON BatchingConfigProto{..}
          = Core.object
              (Core.catMaybes
                 [("batchDescriptor" Core..=) Core.<$> batchDescriptor,
                  ("thresholds" Core..=) Core.<$> thresholds])
...
--
-- /See:/ 'newBatchingDescriptorProto' smart constructor.
data BatchingDescriptorProto = BatchingDescriptorProto
    {
      -- | The repeated field in the request message to be aggregated by batching.
      batchedField :: (Core.Maybe Core.Text)
    ...
    , discriminatorFields :: (Core.Maybe [Core.Text])
    ...
    , subresponseField :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchingDescriptorProto' with the minimum fields required to make a request.
newBatchingDescriptorProto 
    ::  BatchingDescriptorProto
newBatchingDescriptorProto
  = BatchingDescriptorProto{batchedField = Core.Nothing,
                            discriminatorFields = Core.Nothing,
                            subresponseField = Core.Nothing}
instance Core.FromJSON BatchingDescriptorProto where
        parseJSON
          = Core.withObject "BatchingDescriptorProto"
              (\ o ->
                 BatchingDescriptorProto Core.<$>
                   (o Core..:? "batchedField") Core.<*>
                     (o Core..:? "discriminatorFields")
                     Core.<*> (o Core..:? "subresponseField"))

instance Core.ToJSON BatchingDescriptorProto where
        toJSON BatchingDescriptorProto{..}
          = Core.object
              (Core.catMaybes
                 [("batchedField" Core..=) Core.<$> batchedField,
                  ("discriminatorFields" Core..=) Core.<$> discriminatorFields,
                  ("subresponseField" Core..=) Core.<$> subresponseField])
...
--
-- /See:/ 'newBatchingSettingsProto' smart constructor.
data BatchingSettingsProto = BatchingSettingsProto
    {
      -- | The duration after which a batch should be sent, starting from the addition of the first message to that batch.
      delayThreshold :: (Core.Maybe Core.Duration)
      -- | The maximum number of elements collected in a batch that could be accepted by server.
    , elementCountLimit :: (Core.Maybe Core.Int32)
      -- | The number of elements of a field collected into a batch which, if exceeded, causes the batch to be sent.
    , elementCountThreshold :: (Core.Maybe Core.Int32)
      -- | The maximum size of data allowed by flow control.
    , flowControlByteLimit :: (Core.Maybe Core.Int32)
      -- | The maximum number of elements allowed by flow control.
    , flowControlElementLimit :: (Core.Maybe Core.Int32)
      -- | The behavior to take when the flow control limit is exceeded.
    , flowControlLimitExceededBehavior :: (Core.Maybe BatchingSettingsProto_FlowControlLimitExceededBehavior)
      -- | The maximum size of the request that could be accepted by server.
    , requestByteLimit :: (Core.Maybe Core.Int32)
      -- | The aggregated size of the batched field which, if exceeded, causes the batch to be sent. This size is computed by aggregating the sizes of the request field to be batched, not of the entire request message.
    , requestByteThreshold :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchingSettingsProto' with the minimum fields required to make a request.
newBatchingSettingsProto 
    ::  BatchingSettingsProto
newBatchingSettingsProto
  = BatchingSettingsProto{delayThreshold = Core.Nothing,
                          elementCountLimit = Core.Nothing,
                          elementCountThreshold = Core.Nothing,
                          flowControlByteLimit = Core.Nothing,
                          flowControlElementLimit = Core.Nothing,
                          flowControlLimitExceededBehavior = Core.Nothing,
                          requestByteLimit = Core.Nothing,
                          requestByteThreshold = Core.Nothing}
instance Core.FromJSON BatchingSettingsProto where
        parseJSON
          = Core.withObject "BatchingSettingsProto"
              (\ o ->
                 BatchingSettingsProto Core.<$>
                   (o Core..:? "delayThreshold") Core.<*>
                     (o Core..:? "elementCountLimit")
                     Core.<*> (o Core..:? "elementCountThreshold")
                     Core.<*> (o Core..:? "flowControlByteLimit")
                     Core.<*> (o Core..:? "flowControlElementLimit")
                     Core.<*> (o Core..:? "flowControlLimitExceededBehavior")
                     Core.<*> (o Core..:? "requestByteLimit")
                     Core.<*>
                     (o Core..:? "requestByteThreshold" Core.<&>
                        Core.fmap Core.fromAsText))

instance Core.ToJSON BatchingSettingsProto where
        toJSON BatchingSettingsProto{..}
          = Core.object
              (Core.catMaybes
                 [("delayThreshold" Core..=) Core.<$> delayThreshold,
                  ("elementCountLimit" Core..=) Core.<$> elementCountLimit,
                  ("elementCountThreshold" Core..=) Core.<$> elementCountThreshold,
                  ("flowControlByteLimit" Core..=) Core.<$> flowControlByteLimit,
                  ("flowControlElementLimit" Core..=) Core.<$>
                    flowControlElementLimit,
                  ("flowControlLimitExceededBehavior" Core..=) Core.<$>
                    flowControlLimitExceededBehavior,
                  ("requestByteLimit" Core..=) Core.<$> requestByteLimit,
                  ("requestByteThreshold" Core..=) Core.. Core.AsText Core.<$>
...
newBillingDestination 
    ::  BillingDestination
newBillingDestination
  = BillingDestination{metrics = Core.Nothing,
          ...
          = Core.withObject "BillingDestination"
              (\ o ->
                 BillingDestination Core.<$>
                   (o Core..:? "metrics") Core.<*> (o Core..:? "monitoredResource"))
...
newClientLibrarySettings 
    ::  ClientLibrarySettings
newClientLibrarySettings
  = ClientLibrarySettings{cppSettings = Core.Nothing,
                          dotnetSettings = Core.Nothing, goSettings = Core.Nothing,
                          javaSettings = Core.Nothing, launchStage = Core.Nothing,
                          nodeSettings = Core.Nothing, phpSettings = Core.Nothing,
                          pythonSettings = Core.Nothing, restNumericEnums = Core.Nothing,
                          rubySettings = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON ClientLibrarySettings where
        parseJSON
          = Core.withObject "ClientLibrarySettings"
              (\ o ->
                 ClientLibrarySettings Core.<$>
                   (o Core..:? "cppSettings") Core.<*> (o Core..:? "dotnetSettings")
...
newCommonLanguageSettings 
    ::  CommonLanguageSettings
newCommonLanguageSettings
  = CommonLanguageSettings{destinations = Core.Nothing,
                           referenceDocsUri = Core.Nothing,
                           selectiveGapicGeneration = Core.Nothing}
instance Core.FromJSON CommonLanguageSettings where
        parseJSON
          = Core.withObject "CommonLanguageSettings"
              (\ o ->
                 CommonLanguageSettings Core.<$>
                   (o Core..:? "destinations") Core.<*>
                     (o Core..:? "referenceDocsUri")
          ...
          = Core.object
              (Core.catMaybes
                 [("destinations" Core..=) Core.<$> destinations,
                  ...
                  ("selectiveGapicGeneration" Core..=) Core.<$>
                    selectiveGapicGeneration])


-- | Consumer Policy is a set of rules that define what services or service groups can be used for a cloud resource hierarchy.
--
-- /See:/ 'newConsumerPolicy' smart constructor.
data ConsumerPolicy = ConsumerPolicy
    {
      -- | Optional. Annotations is an unstructured key-value map stored with a policy that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. <https://google.aip.dev/128#annotations AIP-128>
      annotations :: (Core.Maybe ConsumerPolicy_Annotations)
      -- | Enable rules define usable services and service groups.
    , enableRules :: (Core.Maybe [EnableRule])
...
-- | Creates a value of 'ConsumerPolicy' with the minimum fields required to make a request.
newConsumerPolicy 
    ::  ConsumerPolicy
newConsumerPolicy
  = ConsumerPolicy{annotations = Core.Nothing,
                   enableRules = Core.Nothing, etag = Core.Nothing,
                   name = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON ConsumerPolicy where
        parseJSON
          = Core.withObject "ConsumerPolicy"
              (\ o ->
                 ConsumerPolicy Core.<$>
                   (o Core..:? "annotations") Core.<*> (o Core..:? "enableRules")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "updateTime"))

instance Core.ToJSON ConsumerPolicy where
        toJSON ConsumerPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("annotations" Core..=) Core.<$> annotations,
                  ("enableRules" Core..=) Core.<$> enableRules,
...
-- | Optional. Annotations is an unstructured key-value map stored with a policy that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. <https://google.aip.dev/128#annotations AIP-128>
--
-- /See:/ 'newConsumerPolicy_Annotations' smart constructor.
newtype ConsumerPolicy_Annotations = ConsumerPolicy_Annotations
    {
...
-- | Creates a value of 'ConsumerPolicy_Annotations' with the minimum fields required to make a request.
newConsumerPolicy_Annotations 
    :: 
                              Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> ConsumerPolicy_Annotations
newConsumerPolicy_Annotations additional
  = ConsumerPolicy_Annotations{additional = additional}
instance Core.FromJSON ConsumerPolicy_Annotations where
        parseJSON
          = Core.withObject "ConsumerPolicy_Annotations"
              (\ o ->
                 ConsumerPolicy_Annotations Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON ConsumerPolicy_Annotations where
        toJSON ConsumerPolicy_Annotations{..} = Core.toJSON additional
...
newContextRule 
    ::  ContextRule
newContextRule
  = ContextRule{allowedRequestExtensions = Core.Nothing,
                allowedResponseExtensions = Core.Nothing, provided = Core.Nothing,
                requested = Core.Nothing, selector = Core.Nothing}
...
newControl 
    ::  Control
newControl
  = Control{environment = Core.Nothing,
...
instance Core.FromJSON Control where
        parseJSON
          = Core.withObject "Control"
              (\ o ->
                 Control Core.<$>
                   (o Core..:? "environment") Core.<*> (o Core..:? "methodPolicies"))
...
instance Core.FromJSON CreateAdminQuotaPolicyMetadata where
        parseJSON
          = Core.withObject "CreateAdminQuotaPolicyMetadata"
              (\ o -> Core.pure CreateAdminQuotaPolicyMetadata)

instance Core.ToJSON CreateAdminQuotaPolicyMetadata where
        toJSON = Core.const Core.emptyObject
...
newCustomErrorRule 
    ::  CustomErrorRule
newCustomErrorRule
  = CustomErrorRule{isErrorType = Core.Nothing,
                    selector = Core.Nothing}
          ...
          = Core.withObject "CustomErrorRule"
              (\ o ->
                 CustomErrorRule Core.<$>
                   (o Core..:? "isErrorType") Core.<*> (o Core..:? "selector"))
...
instance Core.FromJSON DeleteAdminQuotaPolicyMetadata where
        parseJSON
          = Core.withObject "DeleteAdminQuotaPolicyMetadata"
              (\ o -> Core.pure DeleteAdminQuotaPolicyMetadata)

instance Core.ToJSON DeleteAdminQuotaPolicyMetadata where
        toJSON = Core.const Core.emptyObject
...
newDisableServiceRequest 
    ::  DisableServiceRequest
newDisableServiceRequest
  = DisableServiceRequest{checkIfServiceHasUsage = Core.Nothing,
...
newDocumentation 
    ::  Documentation
newDocumentation
  = Documentation{additionalIamInfo = Core.Nothing,
                  documentationRootUrl = Core.Nothing, overview = Core.Nothing,
                  pages = Core.Nothing, rules = Core.Nothing,
                  sectionOverrides = Core.Nothing, serviceRootUrl = Core.Nothing,
...
instance Core.FromJSON Documentation where
        parseJSON
          = Core.withObject "Documentation"
              (\ o ->
                 Documentation Core.<$>
                   (o Core..:? "additionalIamInfo") Core.<*>
                     (o Core..:? "documentationRootUrl")
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalIamInfo" Core..=) Core.<$> additionalIamInfo,
                  ...
                  ("pages" Core..=) Core.<$> pages, ("rules" Core..=) Core.<$> rules,
...
newDocumentationRule 
    ::  DocumentationRule
newDocumentationRule
  = DocumentationRule{deprecationDescription = Core.Nothing,
                      description = Core.Nothing, disableReplacementWords = Core.Nothing,
                      selector = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("deprecationDescription" Core..=) Core.<$>
                  ...
                  ("disableReplacementWords" Core..=) Core.<$>
...
newDotnetSettings 
    ::  DotnetSettings
newDotnetSettings
  = DotnetSettings{common = Core.Nothing,
                   forcedNamespaceAliases = Core.Nothing,
                   handwrittenSignatures = Core.Nothing,
                   ignoredResources = Core.Nothing, renamedResources = Core.Nothing,
                   renamedServices = Core.Nothing}
instance Core.FromJSON DotnetSettings where
        parseJSON
          = Core.withObject "DotnetSettings"
              (\ o ->
                 DotnetSettings Core.<$>
                   (o Core..:? "common") Core.<*>
                     (o Core..:? "forcedNamespaceAliases")
...
instance Core.FromJSON DotnetSettings_RenamedResources where
        parseJSON
          = Core.withObject "DotnetSettings_RenamedResources"
              (\ o ->
...
instance Core.FromJSON DotnetSettings_RenamedServices where
        parseJSON
          = Core.withObject "DotnetSettings_RenamedServices"
              (\ o ->
...
newEnableFailure 
    ::  EnableFailure
newEnableFailure
  = EnableFailure{errorMessage = Core.Nothing,
...
instance Core.FromJSON EnableFailure where
        parseJSON
          = Core.withObject "EnableFailure"
              (\ o ->
                 EnableFailure Core.<$>
                   (o Core..:? "errorMessage") Core.<*> (o Core..:? "serviceId"))
...
data EnableRule = EnableRule
    {
      ...
      enableType :: (Core.Maybe EnableRule_EnableType)
...
newEnableRule 
    ::  EnableRule
newEnableRule
  = EnableRule{enableType = Core.Nothing, groups = Core.Nothing,
               services = Core.Nothing, values = Core.Nothing}
instance Core.FromJSON EnableRule where
        parseJSON
          = Core.withObject "EnableRule"
              (\ o ->
                 EnableRule Core.<$>
                   (o Core..:? "enableType") Core.<*> (o Core..:? "groups") Core.<*>
                     (o Core..:? "services")
                     Core.<*> (o Core..:? "values"))
...
instance Core.ToJSON EnableRule where
        toJSON EnableRule{..}
          = Core.object
              (Core.catMaybes
                 [("enableType" Core..=) Core.<$> enableType,
...
newEndpoint 
    ::  Endpoint
newEndpoint
  = Endpoint{aliases = Core.Nothing, allowCors = Core.Nothing,
             name = Core.Nothing, target = Core.Nothing}
instance Core.FromJSON Endpoint where
        parseJSON
          = Core.withObject "Endpoint"
              (\ o ->
                 Endpoint Core.<$>
                   (o Core..:? "aliases") Core.<*> (o Core..:? "allowCors") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "target"))
...
newEnum 
    ::  Enum'
newEnum
  = Enum'{edition = Core.Nothing, enumvalue = Core.Nothing,
          name = Core.Nothing, options = Core.Nothing,
          sourceContext = Core.Nothing, syntax = Core.Nothing}
instance Core.FromJSON Enum' where
        parseJSON
          = Core.withObject "Enum'"
              (\ o ->
                 Enum' Core.<$>
                   (o Core..:? "edition") Core.<*> (o Core..:? "enumvalue") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "options")
                     Core.<*> (o Core..:? "sourceContext")
                     Core.<*> (o Core..:? "syntax"))
...
newEnumValue 
    ::  EnumValue
newEnumValue
  = EnumValue{name = Core.Nothing, number = Core.Nothing,
...
instance Core.FromJSON EnumValue where
        parseJSON
          = Core.withObject "EnumValue"
              (\ o ->
                 EnumValue Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "number") Core.<*>
                     (o Core..:? "options"))
...
newExperimentalFeatures 
    ::  ExperimentalFeatures
newExperimentalFeatures
  = ExperimentalFeatures{protobufPythonicTypesEnabled = Core.Nothing,
                         restAsyncIoEnabled = Core.Nothing,
                         unversionedPackageDisabled = Core.Nothing}
instance Core.FromJSON ExperimentalFeatures where
        parseJSON
          = Core.withObject "ExperimentalFeatures"
              (\ o ->
                 ExperimentalFeatures Core.<$>
                   (o Core..:? "protobufPythonicTypesEnabled") Core.<*>
                     (o Core..:? "restAsyncIoEnabled")
...
instance Core.ToJSON ExperimentalFeatures where
        toJSON ExperimentalFeatures{..}
          = Core.object
              (Core.catMaybes
                 [("protobufPythonicTypesEnabled" Core..=) Core.<$>
                    protobufPythonicTypesEnabled,
                  ("restAsyncIoEnabled" Core..=) Core.<$> restAsyncIoEnabled,
                  ("unversionedPackageDisabled" Core..=) Core.<$>
...
newField 
    ::  Field
newField
  = Field{cardinality = Core.Nothing, defaultValue = Core.Nothing,
          jsonName = Core.Nothing, kind = Core.Nothing, name = Core.Nothing,
          number = Core.Nothing, oneofIndex = Core.Nothing,
          options = Core.Nothing, packed = Core.Nothing,
...
instance Core.FromJSON Field where
        parseJSON
          = Core.withObject "Field"
              (\ o ->
                 Field Core.<$>
                   (o Core..:? "cardinality") Core.<*> (o Core..:? "defaultValue")
...
newFieldPolicy 
    ::  FieldPolicy
newFieldPolicy
  = FieldPolicy{resourcePermission = Core.Nothing,
                resourceType = Core.Nothing, selector = Core.Nothing}
instance Core.FromJSON FieldPolicy where
        parseJSON
          = Core.withObject "FieldPolicy"
              (\ o ->
                 FieldPolicy Core.<$>
                   (o Core..:? "resourcePermission") Core.<*>
                     (o Core..:? "resourceType")
                     Core.<*> (o Core..:? "selector"))
...
instance Core.FromJSON GetServiceIdentityMetadata where
        parseJSON
...
newGetServiceIdentityResponse 
    ::  GetServiceIdentityResponse
newGetServiceIdentityResponse
  = GetServiceIdentityResponse{identity = Core.Nothing,
                               state = Core.Nothing}
instance Core.FromJSON GetServiceIdentityResponse where
        parseJSON
          = Core.withObject "GetServiceIdentityResponse"
              (\ o ->
                 GetServiceIdentityResponse Core.<$>
                   (o Core..:? "identity") Core.<*> (o Core..:? "state"))
...
instance Core.FromJSON GoSettings where
        parseJSON
          = Core.withObject "GoSettings"
              (\ o ->
                 GoSettings Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "renamedServices"))
...
instance Core.FromJSON GoSettings_RenamedServices where
        parseJSON
          = Core.withObject "GoSettings_RenamedServices"
              (\ o ->
...
newGoogleApiService 
    ::  GoogleApiService
newGoogleApiService
  = GoogleApiService{apis = Core.Nothing, aspects = Core.Nothing,
                     authentication = Core.Nothing, backend = Core.Nothing,
                     billing = Core.Nothing, configVersion = Core.Nothing,
                     context = Core.Nothing, control = Core.Nothing,
                     customError = Core.Nothing, documentation = Core.Nothing,
                     endpoints = Core.Nothing, enums = Core.Nothing,
                     http = Core.Nothing, id = Core.Nothing, logging = Core.Nothing,
                     logs = Core.Nothing, metrics = Core.Nothing,
                     monitoredResources = Core.Nothing, monitoring = Core.Nothing,
                     name = Core.Nothing, producerProjectId = Core.Nothing,
                     publishing = Core.Nothing, quota = Core.Nothing,
                     sourceInfo = Core.Nothing, systemParameters = Core.Nothing,
                     systemTypes = Core.Nothing, title = Core.Nothing,
                     types = Core.Nothing, usage = Core.Nothing}
instance Core.FromJSON GoogleApiService where
        parseJSON
          = Core.withObject "GoogleApiService"
              (\ o ->
                 GoogleApiService Core.<$>
                   (o Core..:? "apis") Core.<*> (o Core..:? "aspects") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("apis" Core..=) Core.<$> apis,
                  ...
                  ("enums" Core..=) Core.<$> enums, ("http" Core..=) Core.<$> http,
                  ("id" Core..=) Core.<$> id, ("logging" Core..=) Core.<$> logging,
                  ("logs" Core..=) Core.<$> logs,
                  ("metrics" Core..=) Core.<$> metrics,
                  ...
                  ("title" Core..=) Core.<$> title, ("types" Core..=) Core.<$> types,
...
newGoogleApiServiceusageV1OperationMetadata 
    :: 
                                            GoogleApiServiceusageV1OperationMetadata
newGoogleApiServiceusageV1OperationMetadata
  = GoogleApiServiceusageV1OperationMetadata{resourceNames =
                                               Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV1OperationMetadata
         where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV1OperationMetadata"
              (\ o ->
                 GoogleApiServiceusageV1OperationMetadata Core.<$>
                   (o Core..:? "resourceNames"))

instance Core.ToJSON GoogleApiServiceusageV1OperationMetadata where
        toJSON GoogleApiServiceusageV1OperationMetadata{..}
          = Core.object
              (Core.catMaybes [("resourceNames" Core..=) Core.<$> resourceNames])
...
newGoogleApiServiceusageV1Service 
    ::  GoogleApiServiceusageV1Service
newGoogleApiServiceusageV1Service
  = GoogleApiServiceusageV1Service{config = Core.Nothing,
                                   name = Core.Nothing, parent = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV1Service where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV1Service"
              (\ o ->
                 GoogleApiServiceusageV1Service Core.<$>
                   (o Core..:? "config") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "parent")
                     Core.<*> (o Core..:? "state"))

instance Core.ToJSON GoogleApiServiceusageV1Service where
        toJSON GoogleApiServiceusageV1Service{..}
          = Core.object
              (Core.catMaybes
                 [("config" Core..=) Core.<$> config,
                  ("name" Core..=) Core.<$> name, ("parent" Core..=) Core.<$> parent,
                  ("state" Core..=) Core.<$> state])
...
newGoogleApiServiceusageV1ServiceConfig 
    :: 
                                        GoogleApiServiceusageV1ServiceConfig
newGoogleApiServiceusageV1ServiceConfig
  = GoogleApiServiceusageV1ServiceConfig{apis = Core.Nothing,
                                         authentication = Core.Nothing,
                                         documentation = Core.Nothing, endpoints = Core.Nothing,
                                         monitoredResources = Core.Nothing,
                                         monitoring = Core.Nothing, name = Core.Nothing,
                                         quota = Core.Nothing, title = Core.Nothing,
                                         usage = Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV1ServiceConfig where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV1ServiceConfig"
              (\ o ->
                 GoogleApiServiceusageV1ServiceConfig Core.<$>
                   (o Core..:? "apis") Core.<*> (o Core..:? "authentication") Core.<*>
                     (o Core..:? "documentation")
                     Core.<*> (o Core..:? "endpoints")
                     Core.<*> (o Core..:? "monitoredResources")
                     Core.<*> (o Core..:? "monitoring")
                     Core.<*> (o Core..:? "name")
...
instance Core.ToJSON GoogleApiServiceusageV1ServiceConfig where
          ...
          = Core.object
              (Core.catMaybes
                 [("apis" Core..=) Core.<$> apis,
                  ...
                  ("monitoredResources" Core..=) Core.<$> monitoredResources,
                  ("monitoring" Core..=) Core.<$> monitoring,
                  ("name" Core..=) Core.<$> name, ("quota" Core..=) Core.<$> quota,
...
newGoogleApiServiceusageV1beta1GetServiceIdentityResponse 
    :: 
                                                          GoogleApiServiceusageV1beta1GetServiceIdentityResponse
newGoogleApiServiceusageV1beta1GetServiceIdentityResponse
  = GoogleApiServiceusageV1beta1GetServiceIdentityResponse{identity =
                                                             Core.Nothing,
                                                           state = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleApiServiceusageV1beta1GetServiceIdentityResponse"
              (\ o ->
                 GoogleApiServiceusageV1beta1GetServiceIdentityResponse Core.<$>
                   (o Core..:? "identity") Core.<*> (o Core..:? "state"))

instance Core.ToJSON
           GoogleApiServiceusageV1beta1GetServiceIdentityResponse
         where
        toJSON GoogleApiServiceusageV1beta1GetServiceIdentityResponse{..}
          = Core.object
              (Core.catMaybes
                 [("identity" Core..=) Core.<$> identity,
                  ("state" Core..=) Core.<$> state])
...
newGoogleApiServiceusageV1beta1ServiceIdentity 
    :: 
                                               GoogleApiServiceusageV1beta1ServiceIdentity
newGoogleApiServiceusageV1beta1ServiceIdentity
  = GoogleApiServiceusageV1beta1ServiceIdentity{email = Core.Nothing,
                                                uniqueId = Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV1beta1ServiceIdentity
         where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV1beta1ServiceIdentity"
              (\ o ->
                 GoogleApiServiceusageV1beta1ServiceIdentity Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "uniqueId"))

instance Core.ToJSON GoogleApiServiceusageV1beta1ServiceIdentity
         where
        toJSON GoogleApiServiceusageV1beta1ServiceIdentity{..}
          = Core.object
              (Core.catMaybes
...
-- | Consumer Policy is a set of rules that define what services or service groups can be used for a cloud resource hierarchy.
--
-- /See:/ 'newGoogleApiServiceusageV2alphaConsumerPolicy' smart constructor.
data GoogleApiServiceusageV2alphaConsumerPolicy = GoogleApiServiceusageV2alphaConsumerPolicy
    {
      -- | Optional. Annotations is an unstructured key-value map stored with a policy that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. <https://google.aip.dev/128#annotations AIP-128>
      annotations :: (Core.Maybe GoogleApiServiceusageV2alphaConsumerPolicy_Annotations)
    ...
    , enableRules :: (Core.Maybe [GoogleApiServiceusageV2alphaEnableRule])
...
-- | Creates a value of 'GoogleApiServiceusageV2alphaConsumerPolicy' with the minimum fields required to make a request.
newGoogleApiServiceusageV2alphaConsumerPolicy 
    :: 
                                              GoogleApiServiceusageV2alphaConsumerPolicy
newGoogleApiServiceusageV2alphaConsumerPolicy
  = GoogleApiServiceusageV2alphaConsumerPolicy{annotations =
                                                 Core.Nothing,
                                               createTime = Core.Nothing,
                                               enableRules = Core.Nothing, etag = Core.Nothing,
                                               name = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV2alphaConsumerPolicy
         where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV2alphaConsumerPolicy"
              (\ o ->
                 GoogleApiServiceusageV2alphaConsumerPolicy Core.<$>
                   (o Core..:? "annotations") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "enableRules")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "updateTime"))

instance Core.ToJSON GoogleApiServiceusageV2alphaConsumerPolicy
         where
        toJSON GoogleApiServiceusageV2alphaConsumerPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("annotations" Core..=) Core.<$> annotations,
...
-- | Optional. Annotations is an unstructured key-value map stored with a policy that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. <https://google.aip.dev/128#annotations AIP-128>
--
-- /See:/ 'newGoogleApiServiceusageV2alphaConsumerPolicy_Annotations' smart constructor.
newtype GoogleApiServiceusageV2alphaConsumerPolicy_Annotations = GoogleApiServiceusageV2alphaConsumerPolicy_Annotations
    {
...
-- | Creates a value of 'GoogleApiServiceusageV2alphaConsumerPolicy_Annotations' with the minimum fields required to make a request.
newGoogleApiServiceusageV2alphaConsumerPolicy_Annotations 
    :: 
                                                          Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
...
newGoogleApiServiceusageV2alphaConsumerPolicy_Annotations
  additional
  = GoogleApiServiceusageV2alphaConsumerPolicy_Annotations{additional
                                                             = additional}
instance Core.FromJSON
           GoogleApiServiceusageV2alphaConsumerPolicy_Annotations
         where
        parseJSON
          = Core.withObject
              "GoogleApiServiceusageV2alphaConsumerPolicy_Annotations"
              (\ o ->
                 GoogleApiServiceusageV2alphaConsumerPolicy_Annotations Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           GoogleApiServiceusageV2alphaConsumerPolicy_Annotations
         where
        toJSON GoogleApiServiceusageV2alphaConsumerPolicy_Annotations{..}
          = Core.toJSON additional


-- | The consumer policy rule that defines enabled services, groups, and categories.
--
-- /See:/ 'newGoogleApiServiceusageV2alphaEnableRule' smart constructor.
newtype GoogleApiServiceusageV2alphaEnableRule = GoogleApiServiceusageV2alphaEnableRule
    {
...
-- | Creates a value of 'GoogleApiServiceusageV2alphaEnableRule' with the minimum fields required to make a request.
newGoogleApiServiceusageV2alphaEnableRule 
    :: 
                                          GoogleApiServiceusageV2alphaEnableRule
newGoogleApiServiceusageV2alphaEnableRule
  = GoogleApiServiceusageV2alphaEnableRule{services = Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV2alphaEnableRule where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV2alphaEnableRule"
              (\ o ->
                 GoogleApiServiceusageV2alphaEnableRule Core.<$>
                   (o Core..:? "services"))

instance Core.ToJSON GoogleApiServiceusageV2alphaEnableRule where
        toJSON GoogleApiServiceusageV2alphaEnableRule{..}
          = Core.object
              (Core.catMaybes [("services" Core..=) Core.<$> services])
...
--
-- /See:/ 'newGoogleApiServiceusageV2alphaUpdateConsumerPolicyMetadata' smart constructor.
data GoogleApiServiceusageV2alphaUpdateConsumerPolicyMetadata = GoogleApiServiceusageV2alphaUpdateConsumerPolicyMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleApiServiceusageV2alphaUpdateConsumerPolicyMetadata' with the minimum fields required to make a request.
newGoogleApiServiceusageV2alphaUpdateConsumerPolicyMetadata 
    :: 
                                                            GoogleApiServiceusageV2alphaUpdateConsumerPolicyMetadata
newGoogleApiServiceusageV2alphaUpdateConsumerPolicyMetadata
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleApiServiceusageV2alphaUpdateConsumerPolicyMetadata"
              (\ o ->
                 Core.pure GoogleApiServiceusageV2alphaUpdateConsumerPolicyMetadata)
...
-- | Creates a value of 'GoogleApiServiceusageV2betaAnalysis' with the minimum fields required to make a request.
newGoogleApiServiceusageV2betaAnalysis 
    :: 
                                       GoogleApiServiceusageV2betaAnalysis
newGoogleApiServiceusageV2betaAnalysis
  = GoogleApiServiceusageV2betaAnalysis{analysisResult =
                                          Core.Nothing,
                                        analysisType = Core.Nothing, displayName = Core.Nothing,
                                        service = Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV2betaAnalysis where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV2betaAnalysis"
              (\ o ->
                 GoogleApiServiceusageV2betaAnalysis Core.<$>
                   (o Core..:? "analysisResult") Core.<*> (o Core..:? "analysisType")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "service"))

instance Core.ToJSON GoogleApiServiceusageV2betaAnalysis where
...
-- | An analysis result including blockers and warnings.
--
-- /See:/ 'newGoogleApiServiceusageV2betaAnalysisResult' smart constructor.
data GoogleApiServiceusageV2betaAnalysisResult = GoogleApiServiceusageV2betaAnalysisResult
    {
      -- | Blocking information that would prevent the policy changes at runtime.
      blockers :: (Core.Maybe [GoogleApiServiceusageV2betaImpact])
      -- | Warning information indicating that the policy changes might be unsafe, but will not block the changes at runtime.
    , warnings :: (Core.Maybe [GoogleApiServiceusageV2betaImpact])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleApiServiceusageV2betaAnalysisResult' with the minimum fields required to make a request.
newGoogleApiServiceusageV2betaAnalysisResult 
    :: 
                                             GoogleApiServiceusageV2betaAnalysisResult
newGoogleApiServiceusageV2betaAnalysisResult
  = GoogleApiServiceusageV2betaAnalysisResult{blockers =
                                                Core.Nothing,
                                              warnings = Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV2betaAnalysisResult
         where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV2betaAnalysisResult"
              (\ o ->
                 GoogleApiServiceusageV2betaAnalysisResult Core.<$>
                   (o Core..:? "blockers") Core.<*> (o Core..:? "warnings"))

instance Core.ToJSON GoogleApiServiceusageV2betaAnalysisResult
         where
        toJSON GoogleApiServiceusageV2betaAnalysisResult{..}
          = Core.object
              (Core.catMaybes
                 [("blockers" Core..=) Core.<$> blockers,
                  ("warnings" Core..=) Core.<$> warnings])
...
-- | Metadata for the @AnalyzeConsumerPolicy@ method.
--
-- /See:/ 'newGoogleApiServiceusageV2betaAnalyzeConsumerPolicyMetadata' smart constructor.
data GoogleApiServiceusageV2betaAnalyzeConsumerPolicyMetadata = GoogleApiServiceusageV2betaAnalyzeConsumerPolicyMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleApiServiceusageV2betaAnalyzeConsumerPolicyMetadata' with the minimum fields required to make a request.
newGoogleApiServiceusageV2betaAnalyzeConsumerPolicyMetadata 
    :: 
                                                            GoogleApiServiceusageV2betaAnalyzeConsumerPolicyMetadata
newGoogleApiServiceusageV2betaAnalyzeConsumerPolicyMetadata
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleApiServiceusageV2betaAnalyzeConsumerPolicyMetadata"
              (\ o ->
                 Core.pure GoogleApiServiceusageV2betaAnalyzeConsumerPolicyMetadata)
...
-- | The response of analyzing a consumer policy update.
--
-- /See:/ 'newGoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse' smart constructor.
newtype GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse = GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse
    {
      -- | The list of analyses returned from performing the intended policy update analysis. The analysis is grouped by service name and different analysis types. The empty analysis list means that the consumer policy can be updated without any warnings or blockers.
      analysis :: (Core.Maybe [GoogleApiServiceusageV2betaAnalysis])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse' with the minimum fields required to make a request.
newGoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse 
    :: 
                                                            GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse
newGoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse
  = GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse{analysis
                                                               = Core.Nothing}
instance Core.FromJSON
           GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse
         where
        parseJSON
          = Core.withObject
              "GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse"
              (\ o ->
                 GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse Core.<$>
                   (o Core..:? "analysis"))

instance Core.ToJSON
           GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse
         where
        toJSON GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse{..}
          = Core.object
              (Core.catMaybes [("analysis" Core..=) Core.<$> analysis])
...
-- | Consumer Policy is a set of rules that define what services or service groups can be used for a cloud resource hierarchy.
--
-- /See:/ 'newGoogleApiServiceusageV2betaConsumerPolicy' smart constructor.
data GoogleApiServiceusageV2betaConsumerPolicy = GoogleApiServiceusageV2betaConsumerPolicy
    {
      -- | Optional. Annotations is an unstructured key-value map stored with a policy that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. <https://google.aip.dev/128#annotations AIP-128>
      annotations :: (Core.Maybe GoogleApiServiceusageV2betaConsumerPolicy_Annotations)
      -- | Output only. The time the policy was created. For singleton policies, this is the first touch of the policy.
    , createTime :: (Core.Maybe Core.DateTime)
      -- | Enable rules define usable services, groups, and categories. There can currently be at most one @EnableRule@. This restriction will be lifted in later releases.
    , enableRules :: (Core.Maybe [GoogleApiServiceusageV2betaEnableRule])
      -- | Output only. An opaque tag indicating the current version of the policy, used for concurrency control.
    , etag :: (Core.Maybe Core.Text)
      -- | Output only. The resource name of the policy. Only the @default@ policy is supported: @projects\/12345\/consumerPolicies\/default@, @folders\/12345\/consumerPolicies\/default@, @organizations\/12345\/consumerPolicies\/default@.
    , name :: (Core.Maybe Core.Text)
...
-- | Creates a value of 'GoogleApiServiceusageV2betaConsumerPolicy' with the minimum fields required to make a request.
newGoogleApiServiceusageV2betaConsumerPolicy 
    :: 
                                             GoogleApiServiceusageV2betaConsumerPolicy
newGoogleApiServiceusageV2betaConsumerPolicy
  = GoogleApiServiceusageV2betaConsumerPolicy{annotations =
                                                Core.Nothing,
                                              createTime = Core.Nothing, enableRules = Core.Nothing,
                                              etag = Core.Nothing, name = Core.Nothing,
                                              updateTime = Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV2betaConsumerPolicy
         where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV2betaConsumerPolicy"
              (\ o ->
                 GoogleApiServiceusageV2betaConsumerPolicy Core.<$>
                   (o Core..:? "annotations") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "enableRules")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "name")
...
instance Core.ToJSON GoogleApiServiceusageV2betaConsumerPolicy
         where
        toJSON GoogleApiServiceusageV2betaConsumerPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("annotations" Core..=) Core.<$> annotations,
                  ("createTime" Core..=) Core.<$> createTime,
...
-- | Optional. Annotations is an unstructured key-value map stored with a policy that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. <https://google.aip.dev/128#annotations AIP-128>
--
-- /See:/ 'newGoogleApiServiceusageV2betaConsumerPolicy_Annotations' smart constructor.
newtype GoogleApiServiceusageV2betaConsumerPolicy_Annotations = GoogleApiServiceusageV2betaConsumerPolicy_Annotations
    {
...
-- | Creates a value of 'GoogleApiServiceusageV2betaConsumerPolicy_Annotations' with the minimum fields required to make a request.
newGoogleApiServiceusageV2betaConsumerPolicy_Annotations 
    :: 
                                                         Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> GoogleApiServiceusageV2betaConsumerPolicy_Annotations
newGoogleApiServiceusageV2betaConsumerPolicy_Annotations additional
  = GoogleApiServiceusageV2betaConsumerPolicy_Annotations{additional
                                                            = additional}
instance Core.FromJSON
           GoogleApiServiceusageV2betaConsumerPolicy_Annotations
         where
        parseJSON
          = Core.withObject
              "GoogleApiServiceusageV2betaConsumerPolicy_Annotations"
              (\ o ->
                 GoogleApiServiceusageV2betaConsumerPolicy_Annotations Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           GoogleApiServiceusageV2betaConsumerPolicy_Annotations
         where
        toJSON GoogleApiServiceusageV2betaConsumerPolicy_Annotations{..}
          = Core.toJSON additional


-- | The consumer policy rule that defines enabled services, groups, and categories.
--
-- /See:/ 'newGoogleApiServiceusageV2betaEnableRule' smart constructor.
newtype GoogleApiServiceusageV2betaEnableRule = GoogleApiServiceusageV2betaEnableRule
    {
      -- | The names of the services that are enabled. Example: @services\/storage.googleapis.com@.
      services :: (Core.Maybe [Core.Text])
    }
...
-- | Creates a value of 'GoogleApiServiceusageV2betaEnableRule' with the minimum fields required to make a request.
newGoogleApiServiceusageV2betaEnableRule 
    :: 
                                         GoogleApiServiceusageV2betaEnableRule
newGoogleApiServiceusageV2betaEnableRule
  = GoogleApiServiceusageV2betaEnableRule{services = Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV2betaEnableRule where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV2betaEnableRule"
              (\ o ->
                 GoogleApiServiceusageV2betaEnableRule Core.<$>
                   (o Core..:? "services"))

instance Core.ToJSON GoogleApiServiceusageV2betaEnableRule where
        toJSON GoogleApiServiceusageV2betaEnableRule{..}
          = Core.object
              (Core.catMaybes [("services" Core..=) Core.<$> services])
...
--
-- /See:/ 'newGoogleApiServiceusageV2betaImpact' smart constructor.
data GoogleApiServiceusageV2betaImpact = GoogleApiServiceusageV2betaImpact
    {
      -- | Output only. User friendly impact detail in a free form message.
      detail :: (Core.Maybe Core.Text)
      -- | Output only. The type of impact.
    , impactType :: (Core.Maybe GoogleApiServiceusageV2betaImpact_ImpactType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleApiServiceusageV2betaImpact' with the minimum fields required to make a request.
newGoogleApiServiceusageV2betaImpact 
    :: 
                                     GoogleApiServiceusageV2betaImpact
newGoogleApiServiceusageV2betaImpact
  = GoogleApiServiceusageV2betaImpact{detail = Core.Nothing,
                                      impactType = Core.Nothing}
instance Core.FromJSON GoogleApiServiceusageV2betaImpact where
        parseJSON
          = Core.withObject "GoogleApiServiceusageV2betaImpact"
              (\ o ->
                 GoogleApiServiceusageV2betaImpact Core.<$>
                   (o Core..:? "detail") Core.<*> (o Core..:? "impactType"))

instance Core.ToJSON GoogleApiServiceusageV2betaImpact where
        toJSON GoogleApiServiceusageV2betaImpact{..}
          = Core.object
              (Core.catMaybes
...
-- | Metadata for the @UpdateConsumerPolicy@ method.
--
-- /See:/ 'newGoogleApiServiceusageV2betaUpdateConsumerPolicyMetadata' smart constructor.
data GoogleApiServiceusageV2betaUpdateConsumerPolicyMetadata = GoogleApiServiceusageV2betaUpdateConsumerPolicyMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleApiServiceusageV2betaUpdateConsumerPolicyMetadata' with the minimum fields required to make a request.
newGoogleApiServiceusageV2betaUpdateConsumerPolicyMetadata 
    :: 
                                                           GoogleApiServiceusageV2betaUpdateConsumerPolicyMetadata
newGoogleApiServiceusageV2betaUpdateConsumerPolicyMetadata
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleApiServiceusageV2betaUpdateConsumerPolicyMetadata"
              (\ o ->
                 Core.pure GoogleApiServiceusageV2betaUpdateConsumerPolicyMetadata)
...
newHttp 
    ::  Http
newHttp
  = Http{fullyDecodeReservedExpansion = Core.Nothing,
         rules = Core.Nothing}
...
newHttpRule 
    ::  HttpRule
newHttpRule
  = HttpRule{additionalBindings = Core.Nothing, body = Core.Nothing,
             custom = Core.Nothing, delete = Core.Nothing, get = Core.Nothing,
             patch = Core.Nothing, post = Core.Nothing, put = Core.Nothing,
             responseBody = Core.Nothing, selector = Core.Nothing}
instance Core.FromJSON HttpRule where
        parseJSON
          = Core.withObject "HttpRule"
              (\ o ->
                 HttpRule Core.<$>
                   (o Core..:? "additionalBindings") Core.<*> (o Core..:? "body")
                     Core.<*> (o Core..:? "custom")
                     Core.<*> (o Core..:? "delete")
                     Core.<*> (o Core..:? "get")
                     Core.<*> (o Core..:? "patch")
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalBindings" Core..=) Core.<$> additionalBindings,
                  ("body" Core..=) Core.<$> body, ("custom" Core..=) Core.<$> custom,
                  ("delete" Core..=) Core.<$> delete, ("get" Core..=) Core.<$> get,
                  ("patch" Core..=) Core.<$> patch, ("post" Core..=) Core.<$> post,
                  ("put" Core..=) Core.<$> put,
...
instance Core.FromJSON Impact where
        parseJSON
          = Core.withObject "Impact"
              (\ o ->
                 Impact Core.<$>
                   (o Core..:? "detail") Core.<*> (o Core..:? "impactType") Core.<*>
                     (o Core..:? "parent"))
...
instance Core.FromJSON ImportAdminOverridesMetadata where
        parseJSON
          = Core.withObject "ImportAdminOverridesMetadata"
              (\ o -> Core.pure ImportAdminOverridesMetadata)

instance Core.ToJSON ImportAdminOverridesMetadata where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON ImportAdminOverridesResponse where
        parseJSON
          = Core.withObject "ImportAdminOverridesResponse"
              (\ o ->
                 ImportAdminOverridesResponse Core.<$> (o Core..:? "overrides"))

instance Core.ToJSON ImportAdminOverridesResponse where
...
newImportAdminQuotaPoliciesMetadata
  = ImportAdminQuotaPoliciesMetadata
instance Core.FromJSON ImportAdminQuotaPoliciesMetadata where
        parseJSON
          = Core.withObject "ImportAdminQuotaPoliciesMetadata"
              (\ o -> Core.pure ImportAdminQuotaPoliciesMetadata)

instance Core.ToJSON ImportAdminQuotaPoliciesMetadata where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON ImportAdminQuotaPoliciesResponse where
        parseJSON
          = Core.withObject "ImportAdminQuotaPoliciesResponse"
              (\ o ->
                 ImportAdminQuotaPoliciesResponse Core.<$> (o Core..:? "policies"))

instance Core.ToJSON ImportAdminQuotaPoliciesResponse where
...
newImportConsumerOverridesMetadata
  = ImportConsumerOverridesMetadata
instance Core.FromJSON ImportConsumerOverridesMetadata where
        parseJSON
          = Core.withObject "ImportConsumerOverridesMetadata"
              (\ o -> Core.pure ImportConsumerOverridesMetadata)

instance Core.ToJSON ImportConsumerOverridesMetadata where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON ImportConsumerOverridesResponse where
        parseJSON
          = Core.withObject "ImportConsumerOverridesResponse"
              (\ o ->
                 ImportConsumerOverridesResponse Core.<$> (o Core..:? "overrides"))

instance Core.ToJSON ImportConsumerOverridesResponse where
...
newJavaSettings 
    ::  JavaSettings
newJavaSettings
  = JavaSettings{common = Core.Nothing,
                 libraryPackage = Core.Nothing, serviceClassNames = Core.Nothing}
instance Core.FromJSON JavaSettings where
        parseJSON
          = Core.withObject "JavaSettings"
              (\ o ->
                 JavaSettings Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "libraryPackage")
...
instance Core.FromJSON JavaSettings_ServiceClassNames where
        parseJSON
          = Core.withObject "JavaSettings_ServiceClassNames"
              (\ o ->
...
newJwtLocation 
    ::  JwtLocation
newJwtLocation
  = JwtLocation{cookie = Core.Nothing, header = Core.Nothing,
                query = Core.Nothing, valuePrefix = Core.Nothing}
instance Core.FromJSON JwtLocation where
        parseJSON
          = Core.withObject "JwtLocation"
              (\ o ->
                 JwtLocation Core.<$>
                   (o Core..:? "cookie") Core.<*> (o Core..:? "header") Core.<*>
                     (o Core..:? "query")
...
newLabelDescriptor 
    ::  LabelDescriptor
newLabelDescriptor
  = LabelDescriptor{description = Core.Nothing, key = Core.Nothing,
          ...
          = Core.withObject "LabelDescriptor"
              (\ o ->
                 LabelDescriptor Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "key") Core.<*>
                     (o Core..:? "valueType"))
...
newListServicesResponse 
    ::  ListServicesResponse
newListServicesResponse
  = ListServicesResponse{nextPageToken = Core.Nothing,
                         services = Core.Nothing}
...
newLogDescriptor 
    ::  LogDescriptor
newLogDescriptor
  = LogDescriptor{description = Core.Nothing,
                  displayName = Core.Nothing, labels = Core.Nothing,
                  name = Core.Nothing}
...
newLogging 
    ::  Logging
newLogging
  = Logging{consumerDestinations = Core.Nothing,
...
newLoggingDestination 
    ::  LoggingDestination
newLoggingDestination
  = LoggingDestination{logs = Core.Nothing,
                       monitoredResource = Core.Nothing}
          ...
          = Core.withObject "LoggingDestination"
              (\ o ->
                 LoggingDestination Core.<$>
                   (o Core..:? "logs") Core.<*> (o Core..:? "monitoredResource"))
...
newLongRunning 
    ::  LongRunning
newLongRunning
  = LongRunning{initialPollDelay = Core.Nothing,
                maxPollDelay = Core.Nothing, pollDelayMultiplier = Core.Nothing,
                totalPollTimeout = Core.Nothing}
instance Core.FromJSON LongRunning where
        parseJSON
          = Core.withObject "LongRunning"
              (\ o ->
                 LongRunning Core.<$>
                   (o Core..:? "initialPollDelay") Core.<*>
                     (o Core..:? "maxPollDelay")
...
newMethod 
    ::  Method
newMethod
  = Method{name = Core.Nothing, options = Core.Nothing,
           requestStreaming = Core.Nothing, requestTypeUrl = Core.Nothing,
           responseStreaming = Core.Nothing, responseTypeUrl = Core.Nothing,
           syntax = Core.Nothing}
instance Core.FromJSON Method where
        parseJSON
          = Core.withObject "Method"
              (\ o ->
                 Method Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "options") Core.<*>
                     (o Core..:? "requestStreaming")
...
newMethodPolicy 
    ::  MethodPolicy
newMethodPolicy
  = MethodPolicy{requestPolicies = Core.Nothing,
                 selector = Core.Nothing}
instance Core.FromJSON MethodPolicy where
        parseJSON
          = Core.withObject "MethodPolicy"
              (\ o ->
                 MethodPolicy Core.<$>
                   (o Core..:? "requestPolicies") Core.<*> (o Core..:? "selector"))
...
data MethodSettings = MethodSettings
    {
      ...
      -- | Batching configuration for an API method in client libraries. Example of a YAML configuration: publishing: method/settings: - selector: google.example.v1.ExampleService.BatchCreateExample batching: element/count/threshold: 1000 request/byte/threshold: 100000000 delay/threshold_millis: 10
    , batching :: (Core.Maybe BatchingConfigProto)
...
newMethodSettings 
    ::  MethodSettings
newMethodSettings
  = MethodSettings{autoPopulatedFields = Core.Nothing,
                   batching = Core.Nothing, longRunning = Core.Nothing,
                   selector = Core.Nothing}
instance Core.FromJSON MethodSettings where
        parseJSON
          = Core.withObject "MethodSettings"
              (\ o ->
                 MethodSettings Core.<$>
                   (o Core..:? "autoPopulatedFields") Core.<*> (o Core..:? "batching")
...
newMetricDescriptor 
    ::  MetricDescriptor
newMetricDescriptor
  = MetricDescriptor{description = Core.Nothing,
                     displayName = Core.Nothing, labels = Core.Nothing,
                     launchStage = Core.Nothing, metadata = Core.Nothing,
                     metricKind = Core.Nothing, monitoredResourceTypes = Core.Nothing,
                     name = Core.Nothing, type' = Core.Nothing, unit = Core.Nothing,
                     valueType = Core.Nothing}
...
data MetricDescriptorMetadata = MetricDescriptorMetadata
    ...
    , timeSeriesResourceHierarchyLevel :: (Core.Maybe
...
newMetricDescriptorMetadata 
    ::  MetricDescriptorMetadata
newMetricDescriptorMetadata
  = MetricDescriptorMetadata{ingestDelay = Core.Nothing,
                             launchStage = Core.Nothing, samplePeriod = Core.Nothing,
          ...
          = Core.withObject "MetricDescriptorMetadata"
              (\ o ->
                 MetricDescriptorMetadata Core.<$>
                   (o Core..:? "ingestDelay") Core.<*> (o Core..:? "launchStage")
          ...
          = Core.object
              (Core.catMaybes
                 [("ingestDelay" Core..=) Core.<$> ingestDelay,
                  ...
                  ("timeSeriesResourceHierarchyLevel" Core..=) Core.<$>
...
instance Core.FromJSON MetricRule where
        parseJSON
          = Core.withObject "MetricRule"
              (\ o ->
                 MetricRule Core.<$>
                   (o Core..:? "metricCosts") Core.<*> (o Core..:? "selector"))
...
newMonitoredResourceDescriptor 
    ::  MonitoredResourceDescriptor
newMonitoredResourceDescriptor
  = MonitoredResourceDescriptor{description = Core.Nothing,
                                displayName = Core.Nothing, labels = Core.Nothing,
...
newMonitoring 
    ::  Monitoring
newMonitoring
  = Monitoring{consumerDestinations = Core.Nothing,
               producerDestinations = Core.Nothing}
...
newMonitoringDestination 
    ::  MonitoringDestination
newMonitoringDestination
  = MonitoringDestination{metrics = Core.Nothing,
                          monitoredResource = Core.Nothing}
...
newOperationMetadata 
    ::  OperationMetadata
newOperationMetadata
  = OperationMetadata{resourceNames = Core.Nothing}
instance Core.FromJSON OperationMetadata where
        parseJSON
          = Core.withObject "OperationMetadata"
              (\ o -> OperationMetadata Core.<$> (o Core..:? "resourceNames"))
...
newPage 
    ::  Page
newPage
  = Page{content = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Page where
        parseJSON
          = Core.withObject "Page"
              (\ o ->
                 Page Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "subpages"))
...
newPublishing 
    ::  Publishing
newPublishing
  = Publishing{apiShortName = Core.Nothing,
               codeownerGithubTeams = Core.Nothing, docTagPrefix = Core.Nothing,
               documentationUri = Core.Nothing, githubLabel = Core.Nothing,
               librarySettings = Core.Nothing, methodSettings = Core.Nothing,
               newIssueUri' = Core.Nothing, organization = Core.Nothing,
...
instance Core.FromJSON Publishing where
        parseJSON
          = Core.withObject "Publishing"
              (\ o ->
                 Publishing Core.<$>
                   (o Core..:? "apiShortName") Core.<*>
                     (o Core..:? "codeownerGithubTeams")
          ...
          = Core.object
              (Core.catMaybes
                 [("apiShortName" Core..=) Core.<$> apiShortName,
                  ...
                  ("protoReferenceDocumentationUri" Core..=) Core.<$>
                    protoReferenceDocumentationUri,
                  ("restReferenceDocumentationUri" Core..=) Core.<$>
...
newPythonSettings 
    ::  PythonSettings
newPythonSettings
  = PythonSettings{common = Core.Nothing,
                   experimentalFeatures = Core.Nothing}
instance Core.FromJSON PythonSettings where
        parseJSON
          = Core.withObject "PythonSettings"
              (\ o ->
                 PythonSettings Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "experimentalFeatures"))
...
instance Core.FromJSON Quota where
        parseJSON
          = Core.withObject "Quota"
              (\ o ->
                 Quota Core.<$>
                   (o Core..:? "limits") Core.<*> (o Core..:? "metricRules"))
...
newQuotaLimit 
    ::  QuotaLimit
newQuotaLimit
  = QuotaLimit{defaultLimit = Core.Nothing,
               description = Core.Nothing, displayName = Core.Nothing,
               duration = Core.Nothing, freeTier = Core.Nothing,
               maxLimit = Core.Nothing, metric = Core.Nothing,
               name = Core.Nothing, unit = Core.Nothing, values = Core.Nothing}
instance Core.FromJSON QuotaLimit where
        parseJSON
          = Core.withObject "QuotaLimit"
              (\ o ->
                 QuotaLimit Core.<$>
                   (o Core..:? "defaultLimit" Core.<&> Core.fmap Core.fromAsText)
...
newQuotaOverride 
    ::  QuotaOverride
newQuotaOverride
  = QuotaOverride{adminOverrideAncestor = Core.Nothing,
                  dimensions = Core.Nothing, metric = Core.Nothing,
                  name = Core.Nothing, overrideValue = Core.Nothing,
                  unit = Core.Nothing}
              ...
              (\ o ->
                 QuotaOverride Core.<$>
                   (o Core..:? "adminOverrideAncestor") Core.<*>
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "overrideValue" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "unit"))
...
newQuotaOverride_Dimensions 
    :: 
       ...
       -- ^  See 'additional'.
    -> QuotaOverride_Dimensions
newQuotaOverride_Dimensions additional
  = QuotaOverride_Dimensions{additional = additional}
instance Core.FromJSON QuotaOverride_Dimensions where
        parseJSON
          = Core.withObject "QuotaOverride_Dimensions"
              (\ o -> QuotaOverride_Dimensions Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON QuotaOverride_Dimensions where
        toJSON QuotaOverride_Dimensions{..} = Core.toJSON additional


-- | Metadata for the @RemoveEnableRules@ method.
--
-- /See:/ 'newRemoveEnableRulesMetadata' smart constructor.
data RemoveEnableRulesMetadata = RemoveEnableRulesMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RemoveEnableRulesMetadata' with the minimum fields required to make a request.
newRemoveEnableRulesMetadata 
    ::  RemoveEnableRulesMetadata
newRemoveEnableRulesMetadata = RemoveEnableRulesMetadata
instance Core.FromJSON RemoveEnableRulesMetadata where
        parseJSON
          = Core.withObject "RemoveEnableRulesMetadata"
              (\ o -> Core.pure RemoveEnableRulesMetadata)

instance Core.ToJSON RemoveEnableRulesMetadata where
        toJSON = Core.const Core.emptyObject


-- | The response message of @RemoveEnableRules@ method.
--
-- /See:/ 'newRemoveEnableRulesResponse' smart constructor.
data RemoveEnableRulesResponse = RemoveEnableRulesResponse
    {
      -- | The parent consumer policy. It can be @projects\/12345\/consumerPolicies\/default@, or @folders\/12345\/consumerPolicies\/default@, or @organizations\/12345\/consumerPolicies\/default@.
      parent :: (Core.Maybe Core.Text)
      -- | The values removed from the parent consumer policy.
    , removedValues :: (Core.Maybe [Core.Text])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RemoveEnableRulesResponse' with the minimum fields required to make a request.
newRemoveEnableRulesResponse 
    ::  RemoveEnableRulesResponse
newRemoveEnableRulesResponse
  = RemoveEnableRulesResponse{parent = Core.Nothing,
                              removedValues = Core.Nothing}
instance Core.FromJSON RemoveEnableRulesResponse where
        parseJSON
          = Core.withObject "RemoveEnableRulesResponse"
              (\ o ->
                 RemoveEnableRulesResponse Core.<$>
                   (o Core..:? "parent") Core.<*> (o Core..:? "removedValues"))

instance Core.ToJSON RemoveEnableRulesResponse where
        toJSON RemoveEnableRulesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("parent" Core..=) Core.<$> parent,
                  ("removedValues" Core..=) Core.<$> removedValues])
...
instance Core.FromJSON SelectiveGapicGeneration where
        parseJSON
          = Core.withObject "SelectiveGapicGeneration"
              (\ o ->
                 SelectiveGapicGeneration Core.<$>
                   (o Core..:? "generateOmittedAsInternal") Core.<*>
                     (o Core..:? "methods"))
...
instance Core.ToJSON SelectiveGapicGeneration where
        toJSON SelectiveGapicGeneration{..}
          = Core.object
              (Core.catMaybes
                 [("generateOmittedAsInternal" Core..=) Core.<$>
...
newSystemParameter 
    ::  SystemParameter
newSystemParameter
  = SystemParameter{httpHeader = Core.Nothing, name = Core.Nothing,
          ...
          = Core.withObject "SystemParameter"
              (\ o ->
                 SystemParameter Core.<$>
                   (o Core..:? "httpHeader") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "urlQueryParameter"))
...
newSystemParameterRule 
    ::  SystemParameterRule
newSystemParameterRule
  = SystemParameterRule{parameters = Core.Nothing,
                        selector = Core.Nothing}
          ...
          = Core.withObject "SystemParameterRule"
              (\ o ->
                 SystemParameterRule Core.<$>
                   (o Core..:? "parameters") Core.<*> (o Core..:? "selector"))
...
newType 
    ::  Type
newType
  = Type{edition = Core.Nothing, fields = Core.Nothing,
         name = Core.Nothing, oneofs = Core.Nothing, options = Core.Nothing,
         sourceContext = Core.Nothing, syntax = Core.Nothing}
instance Core.FromJSON Type where
        parseJSON
          = Core.withObject "Type"
              (\ o ->
                 Type Core.<$>
                   (o Core..:? "edition") Core.<*> (o Core..:? "fields") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "oneofs")
                     Core.<*> (o Core..:? "options")
                     Core.<*> (o Core..:? "sourceContext")
...
instance Core.FromJSON UpdateAdminQuotaPolicyMetadata where
        parseJSON
          = Core.withObject "UpdateAdminQuotaPolicyMetadata"
              (\ o -> Core.pure UpdateAdminQuotaPolicyMetadata)

instance Core.ToJSON UpdateAdminQuotaPolicyMetadata where
        toJSON = Core.const Core.emptyObject


-- | Metadata for the @UpdateConsumerPolicy@ method.
--
-- /See:/ 'newUpdateConsumerPolicyMetadata' smart constructor.
data UpdateConsumerPolicyMetadata = UpdateConsumerPolicyMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'UpdateConsumerPolicyMetadata' with the minimum fields required to make a request.
newUpdateConsumerPolicyMetadata 
    ::  UpdateConsumerPolicyMetadata
newUpdateConsumerPolicyMetadata = UpdateConsumerPolicyMetadata
instance Core.FromJSON UpdateConsumerPolicyMetadata where
        parseJSON
          = Core.withObject "UpdateConsumerPolicyMetadata"
              (\ o -> Core.pure UpdateConsumerPolicyMetadata)

instance Core.ToJSON UpdateConsumerPolicyMetadata where
        toJSON = Core.const Core.emptyObject
...
newUsage 
    ::  Usage
newUsage
  = Usage{producerNotificationChannel = Core.Nothing,
          requirements = Core.Nothing, rules = Core.Nothing}
...
newUsageRule 
    ::  UsageRule
newUsageRule
  = UsageRule{allowUnregisteredCalls = Core.Nothing,
              selector = Core.Nothing, skipServiceControl = Core.Nothing}
