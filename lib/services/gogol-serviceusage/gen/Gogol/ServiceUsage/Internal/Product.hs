...
module Gogol.ServiceUsage.Internal.Product
  (
    ...
    UpdateConsumerPolicyLROMetadata (..),
    newUpdateConsumerPolicyLROMetadata,
...
newAddEnableRulesResponse 
    ::  AddEnableRulesResponse
newAddEnableRulesResponse =
  AddEnableRulesResponse {parent = Core.Nothing, values = Core.Nothing}
          ...
          = Core.withObject "AddEnableRulesResponse"
              (\ o ->
                 AddEnableRulesResponse Core.<$>
                   (o Core..:? "parent") Core.<*> (o Core..:? "values"))
          ...
          = Core.withObject "ClientLibrarySettings"
              (\ o ->
                 ClientLibrarySettings Core.<$>
                   (o Core..:? "cppSettings") Core.<*>
                     (o Core..:? "dotnetSettings")
...
newCommonLanguageSettings =
  CommonLanguageSettings
    {destinations = Core.Nothing, referenceDocsUri = Core.Nothing}
...
instance Core.FromJSON ConsumerPolicy_Annotations
         where
        parseJSON
          = Core.withObject "ConsumerPolicy_Annotations"
              (\ o ->
                 ConsumerPolicy_Annotations Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ConsumerPolicy_Annotations where
        toJSON ConsumerPolicy_Annotations{..}
          = Core.toJSON additional
          ...
          = Core.object
              (Core.catMaybes
                 [("common" Core..=) Core.<$> common,
                  ("forcedNamespaceAliases" Core..=) Core.<$>
                    forcedNamespaceAliases,
                  ("handwrittenSignatures" Core..=) Core.<$>
                    handwrittenSignatures,
                  ("ignoredResources" Core..=) Core.<$>
                    ignoredResources,
                  ("renamedResources" Core..=) Core.<$>
                    renamedResources,
                  ("renamedServices" Core..=) Core.<$>
                    renamedServices])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "DotnetSettings_RenamedResources"
              (\ o ->
                 DotnetSettings_RenamedResources Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DotnetSettings_RenamedResources
         where
...
instance Core.FromJSON DotnetSettings_RenamedServices
         where
        parseJSON
          = Core.withObject "DotnetSettings_RenamedServices"
              (\ o ->
                 DotnetSettings_RenamedServices Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DotnetSettings_RenamedServices
         where
...
--
-- /See:/ 'newGroupValue' smart constructor.
newtype GroupValue = GroupValue
    {
...
-- | Creates a value of 'GroupValue' with the minimum fields required to make a request.
newGroupValue 
    ::  GroupValue
newGroupValue = GroupValue {name = Core.Nothing}

instance Core.FromJSON GroupValue where
        parseJSON
          = Core.withObject "GroupValue"
              (\ o -> GroupValue Core.<$> (o Core..:? "name"))

instance Core.ToJSON GroupValue where
        toJSON GroupValue{..}
          = Core.object
...
instance Core.FromJSON JavaSettings_ServiceClassNames
         where
        parseJSON
          = Core.withObject "JavaSettings_ServiceClassNames"
              (\ o ->
                 JavaSettings_ServiceClassNames Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON JavaSettings_ServiceClassNames
         where
...
instance Core.FromJSON JwtLocation where
        parseJSON
          = Core.withObject "JwtLocation"
              (\ o ->
                 JwtLocation Core.<$>
                   (o Core..:? "cookie") Core.<*> (o Core..:? "header")
                     Core.<*> (o Core..:? "query")
...
instance Core.ToJSON LongRunning where
        toJSON LongRunning{..}
          = Core.object
              (Core.catMaybes
                 [("initialPollDelay" Core..=) Core.<$>
                    initialPollDelay,
                  ("maxPollDelay" Core..=) Core.<$> maxPollDelay,
                  ("pollDelayMultiplier" Core..=) Core.<$>
                    pollDelayMultiplier,
                  ("totalPollTimeout" Core..=) Core.<$>
                    totalPollTimeout])
              ...
              (\ o ->
                 Publishing Core.<$>
                   (o Core..:? "apiShortName") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "protoReferenceDocumentationUri"))
          ...
          = Core.object
              (Core.catMaybes
                 [("apiShortName" Core..=) Core.<$> apiShortName,
                  ("codeownerGithubTeams" Core..=) Core.<$>
                    codeownerGithubTeams,
                  ("docTagPrefix" Core..=) Core.<$> docTagPrefix,
                  ("documentationUri" Core..=) Core.<$>
                    documentationUri,
...
instance Core.FromJSON RemoveEnableRulesMetadata
         where
        parseJSON
...
newtype RemoveEnableRulesResponse = RemoveEnableRulesResponse
    {
      -- | The parent consumer policy. It can be @projects\/12345\/consumerPolicies\/default@, or @folders\/12345\/consumerPolicies\/default@, or @organizations\/12345\/consumerPolicies\/default@.
      parent :: (Core.Maybe Core.Text)
    }
...
newRemoveEnableRulesResponse 
    ::  RemoveEnableRulesResponse
newRemoveEnableRulesResponse = RemoveEnableRulesResponse {parent = Core.Nothing}

instance Core.FromJSON RemoveEnableRulesResponse
         where
        parseJSON
...
--
-- /See:/ 'newServiceValue' smart constructor.
data ServiceValue = ServiceValue
    {
      -- | The DNS address at which this service is available.
      dnsAddress :: (Core.Maybe Core.Text)
    ...
    , pricingLink :: (Core.Maybe Core.Text)
      -- | Terms of Service
    , tos :: (Core.Maybe [TermsOfService])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ServiceValue' with the minimum fields required to make a request.
newServiceValue 
    ::  ServiceValue
newServiceValue =
  ServiceValue
    { dnsAddress = Core.Nothing
    , name = Core.Nothing
    , pricingLink = Core.Nothing
    , tos = Core.Nothing
    }

instance Core.FromJSON ServiceValue where
        parseJSON
          = Core.withObject "ServiceValue"
              (\ o ->
                 ServiceValue Core.<$>
                   (o Core..:? "dnsAddress") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "pricingLink")
                     Core.<*> (o Core..:? "tos"))

instance Core.ToJSON ServiceValue where
        toJSON ServiceValue{..}
          = Core.object
              (Core.catMaybes
                 [("dnsAddress" Core..=) Core.<$> dnsAddress,
                  ("name" Core..=) Core.<$> name,
                  ("pricingLink" Core..=) Core.<$> pricingLink,
                  ("tos" Core..=) Core.<$> tos])
...
--
-- /See:/ 'newTermsOfService' smart constructor.
...
-- | Creates a value of 'TermsOfService' with the minimum fields required to make a request.
newTermsOfService 
    ::  TermsOfService
newTermsOfService = TermsOfService {title = Core.Nothing, uri = Core.Nothing}

instance Core.FromJSON TermsOfService where
        parseJSON
          = Core.withObject "TermsOfService"
              (\ o ->
                 TermsOfService Core.<$>
                   (o Core..:? "title") Core.<*> (o Core..:? "uri"))

instance Core.ToJSON TermsOfService where
...
instance Core.FromJSON Type where
        parseJSON
          = Core.withObject "Type"
              (\ o ->
                 Type Core.<$>
                   (o Core..:? "edition") Core.<*> (o Core..:? "fields")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "oneofs")
                     Core.<*> (o Core..:? "options")
                     Core.<*> (o Core..:? "sourceContext")
...
--
-- /See:/ 'newUpdateConsumerPolicyLROMetadata' smart constructor.
data UpdateConsumerPolicyLROMetadata = UpdateConsumerPolicyLROMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'UpdateConsumerPolicyLROMetadata' with the minimum fields required to make a request.
newUpdateConsumerPolicyLROMetadata 
    ::  UpdateConsumerPolicyLROMetadata
newUpdateConsumerPolicyLROMetadata = UpdateConsumerPolicyLROMetadata

instance Core.FromJSON
           UpdateConsumerPolicyLROMetadata
         where
        parseJSON
          = Core.withObject "UpdateConsumerPolicyLROMetadata"
              (\ o -> Core.pure UpdateConsumerPolicyLROMetadata)

instance Core.ToJSON UpdateConsumerPolicyLROMetadata
         where
        toJSON = Core.const Core.emptyObject
...
data ValueInfo = ValueInfo
    {
      ...
      groupValue :: (Core.Maybe GroupValue)
    ...
    , learnmoreLink :: (Core.Maybe Core.Text)
      -- | The information related to the value if it is a service.
    , serviceValue :: (Core.Maybe ServiceValue)
...
newValueInfo =
  ValueInfo
    { groupValue = Core.Nothing
    , learnmoreLink = Core.Nothing
    , serviceValue = Core.Nothing
    , summary = Core.Nothing
    , title = Core.Nothing
    }
...
instance Core.FromJSON ValueInfo where
        parseJSON
          = Core.withObject "ValueInfo"
              (\ o ->
                 ValueInfo Core.<$>
                   (o Core..:? "groupValue") Core.<*>
                     (o Core..:? "learnmoreLink")
                     Core.<*> (o Core..:? "serviceValue")
                     Core.<*> (o Core..:? "summary")
                     Core.<*> (o Core..:? "title"))
...
instance Core.ToJSON ValueInfo where
        toJSON ValueInfo{..}
          = Core.object
              (Core.catMaybes
                 [("groupValue" Core..=) Core.<$> groupValue,
                  ("learnmoreLink" Core..=) Core.<$> learnmoreLink,
                  ("serviceValue" Core..=) Core.<$> serviceValue,
                  ("summary" Core..=) Core.<$> summary,
                  ("title" Core..=) Core.<$> title])
