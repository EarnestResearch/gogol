                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] TargetPoolsRemoveHealthCheckRequest
...
newComputeTargetPoolsRemoveHealthCheck 
    ...
    -> ComputeTargetPoolsRemoveHealthCheck
newComputeTargetPoolsRemoveHealthCheck payload project region
  targetPool
  = ComputeTargetPoolsRemoveHealthCheck{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, project = project, region = region,
                                        requestId = Core.Nothing, targetPool = targetPool,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeTargetPoolsRemoveHealthCheck
         where
        type Rs ComputeTargetPoolsRemoveHealthCheck = Operation
        type Scopes ComputeTargetPoolsRemoveHealthCheck =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeTargetPoolsRemoveHealthCheck{..}
          = go project region targetPool xgafv accessToken callback requestId
              uploadType
              uploadProtocol
