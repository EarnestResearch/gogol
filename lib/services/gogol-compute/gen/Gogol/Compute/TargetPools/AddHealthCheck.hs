                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] TargetPoolsAddHealthCheckRequest
...
newComputeTargetPoolsAddHealthCheck 
    ...
    -> ComputeTargetPoolsAddHealthCheck
newComputeTargetPoolsAddHealthCheck payload project region
  targetPool
  = ComputeTargetPoolsAddHealthCheck{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetPoolsAddHealthCheck where
        ...
        type Scopes ComputeTargetPoolsAddHealthCheck =
