                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] TargetPoolsRemoveInstanceRequest
...
newComputeTargetPoolsRemoveInstance 
    ...
    -> ComputeTargetPoolsRemoveInstance
newComputeTargetPoolsRemoveInstance payload project region
  targetPool
  = ComputeTargetPoolsRemoveInstance{xgafv = Core.Nothing,
