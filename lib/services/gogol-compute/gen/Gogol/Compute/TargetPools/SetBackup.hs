                       ...
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "failoverRatio" Core.Double Core.:>
                               Core.QueryParam "requestId" Core.Text Core.:>
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] TargetReference Core.:>
...
newComputeTargetPoolsSetBackup payload project region targetPool
  = ComputeTargetPoolsSetBackup{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                failoverRatio = Core.Nothing, payload = payload, project = project,
                                region = region, requestId = Core.Nothing, targetPool = targetPool,
...
instance Core.GoogleRequest ComputeTargetPoolsSetBackup where
        ...
        type Scopes ComputeTargetPoolsSetBackup =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeTargetPoolsSetBackup{..}
          = go project region targetPool xgafv accessToken callback
              failoverRatio
              requestId
              uploadType
              uploadProtocol
