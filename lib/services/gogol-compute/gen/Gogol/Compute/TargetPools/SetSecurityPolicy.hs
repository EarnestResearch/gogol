                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] SecurityPolicyReference Core.:>
...
newComputeTargetPoolsSetSecurityPolicy 
    ...
    -> ComputeTargetPoolsSetSecurityPolicy
newComputeTargetPoolsSetSecurityPolicy payload project region
  targetPool
  = ComputeTargetPoolsSetSecurityPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetPoolsSetSecurityPolicy
         where
        type Rs ComputeTargetPoolsSetSecurityPolicy = Operation
        type Scopes ComputeTargetPoolsSetSecurityPolicy =
