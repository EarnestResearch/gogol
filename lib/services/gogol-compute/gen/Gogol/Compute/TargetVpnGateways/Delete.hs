             ...
             "regions" Core.:>
               Core.Capture "region" Core.Text Core.:>
                 "targetVpnGateways" Core.:>
                   Core.Capture "targetVpnGateway" Core.Text Core.:>
