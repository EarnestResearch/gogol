                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] TargetVpnGatewayAggregatedList
...
newComputeTargetVpnGatewaysAggregatedList project
  = ComputeTargetVpnGatewaysAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetVpnGatewaysAggregatedList
         where
        type Rs ComputeTargetVpnGatewaysAggregatedList =
             TargetVpnGatewayAggregatedList
        type Scopes ComputeTargetVpnGatewaysAggregatedList =
