...
newComputeTargetVpnGatewaysSetLabels 
    ...
    -> ComputeTargetVpnGatewaysSetLabels
newComputeTargetVpnGatewaysSetLabels payload project region
  resource
  = ComputeTargetVpnGatewaysSetLabels{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetVpnGatewaysSetLabels where
        ...
        type Scopes ComputeTargetVpnGatewaysSetLabels =
