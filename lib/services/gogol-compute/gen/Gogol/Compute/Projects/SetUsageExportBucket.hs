                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] UsageExportLocation Core.:>
...
newComputeProjectsSetUsageExportBucket payload project
  = ComputeProjectsSetUsageExportBucket{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, project = project,
                                        requestId = Core.Nothing, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeProjectsSetUsageExportBucket
         where
        type Rs ComputeProjectsSetUsageExportBucket = Operation
        type Scopes ComputeProjectsSetUsageExportBucket =
