                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ProjectsSetDefaultNetworkTierRequest
...
newComputeProjectsSetDefaultNetworkTier payload project
  = ComputeProjectsSetDefaultNetworkTier{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         payload = payload, project = project,
                                         requestId = Core.Nothing, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeProjectsSetDefaultNetworkTier
         where
        type Rs ComputeProjectsSetDefaultNetworkTier = Operation
        type Scopes ComputeProjectsSetDefaultNetworkTier =
