                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] ProjectsListXpnHostsRequest Core.:>
                                       Core.Post '[Core.JSON] XpnHostList
...
newComputeProjectsListXpnHosts payload project
  = ComputeProjectsListXpnHosts{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                filter = Core.Nothing, maxResults = 500, orderBy = Core.Nothing,
                                pageToken = Core.Nothing, payload = payload, project = project,
...
instance Core.GoogleRequest ComputeProjectsListXpnHosts where
        ...
        type Scopes ComputeProjectsListXpnHosts =
