                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ProjectsDisableXpnResourceRequest Core.:>
...
newComputeProjectsDisableXpnResource payload project
  = ComputeProjectsDisableXpnResource{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeProjectsDisableXpnResource where
        ...
        type Scopes ComputeProjectsDisableXpnResource =
