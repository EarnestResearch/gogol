                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ProjectsSetCloudArmorTierRequest Core.:>
...
newComputeProjectsSetCloudArmorTier payload project
  = ComputeProjectsSetCloudArmorTier{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeProjectsSetCloudArmorTier where
        ...
        type Scopes ComputeProjectsSetCloudArmorTier =
