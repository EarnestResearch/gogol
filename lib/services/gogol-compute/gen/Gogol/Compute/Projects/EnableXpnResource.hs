                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ProjectsEnableXpnResourceRequest Core.:>
...
newComputeProjectsEnableXpnResource payload project
  = ComputeProjectsEnableXpnResource{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeProjectsEnableXpnResource where
        ...
        type Scopes ComputeProjectsEnableXpnResource =
