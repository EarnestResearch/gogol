           ...
           Core.Capture "project" Core.Text Core.:>
             "global" Core.:>
               "interconnectRemoteLocations" Core.:>
                 Core.Capture "interconnectRemoteLocation" Core.Text Core.:>
...
newComputeInterconnectRemoteLocationsGet 
    ...
    -> ComputeInterconnectRemoteLocationsGet
newComputeInterconnectRemoteLocationsGet interconnectRemoteLocation
  project
  = ComputeInterconnectRemoteLocationsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          interconnectRemoteLocation = interconnectRemoteLocation,
                                          project = project, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeInterconnectRemoteLocationsGet
         where
        ...
        requestClient ComputeInterconnectRemoteLocationsGet{..}
          = go project interconnectRemoteLocation xgafv accessToken callback
              uploadType
              uploadProtocol
