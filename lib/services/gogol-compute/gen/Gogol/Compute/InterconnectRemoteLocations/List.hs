                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] InterconnectRemoteLocationList
...
newComputeInterconnectRemoteLocationsList project
  = ComputeInterconnectRemoteLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInterconnectRemoteLocationsList
         where
        type Rs ComputeInterconnectRemoteLocationsList =
