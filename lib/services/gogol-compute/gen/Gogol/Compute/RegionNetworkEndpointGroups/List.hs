...
newComputeRegionNetworkEndpointGroupsList project region
  = ComputeRegionNetworkEndpointGroupsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionNetworkEndpointGroupsList
         where
        type Rs ComputeRegionNetworkEndpointGroupsList =
             NetworkEndpointGroupList
        type Scopes ComputeRegionNetworkEndpointGroupsList =
