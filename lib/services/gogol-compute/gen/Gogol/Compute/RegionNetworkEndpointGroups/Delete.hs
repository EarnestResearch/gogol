...
newComputeRegionNetworkEndpointGroupsDelete 
    ...
    -> ComputeRegionNetworkEndpointGroupsDelete
newComputeRegionNetworkEndpointGroupsDelete networkEndpointGroup
  project region
  = ComputeRegionNetworkEndpointGroupsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNetworkEndpointGroupsDelete =
