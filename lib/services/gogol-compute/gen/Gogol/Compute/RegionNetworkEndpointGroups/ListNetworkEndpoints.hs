...
newComputeRegionNetworkEndpointGroupsListNetworkEndpoints
  ...
  = ComputeRegionNetworkEndpointGroupsListNetworkEndpoints{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionNetworkEndpointGroupsListNetworkEndpoints
         where
        type Rs ComputeRegionNetworkEndpointGroupsListNetworkEndpoints =
             NetworkEndpointGroupsListNetworkEndpoints
        type Scopes ComputeRegionNetworkEndpointGroupsListNetworkEndpoints
             =
