...
newComputeRegionNetworkEndpointGroupsAttachNetworkEndpoints 
    ...
    -> ComputeRegionNetworkEndpointGroupsAttachNetworkEndpoints
newComputeRegionNetworkEndpointGroupsAttachNetworkEndpoints
  networkEndpointGroup payload project region
  = ComputeRegionNetworkEndpointGroupsAttachNetworkEndpoints{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionNetworkEndpointGroupsAttachNetworkEndpoints
         where
        type Rs ComputeRegionNetworkEndpointGroupsAttachNetworkEndpoints =
             Operation
        type Scopes
               ComputeRegionNetworkEndpointGroupsAttachNetworkEndpoints
        ...
        requestClient
          ComputeRegionNetworkEndpointGroupsAttachNetworkEndpoints{..}
          = go project region networkEndpointGroup xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
