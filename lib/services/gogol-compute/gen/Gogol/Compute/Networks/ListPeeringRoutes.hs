             ...
             "global" Core.:>
               "networks" Core.:>
                 Core.Capture "network" Core.Text Core.:>
                   "listPeeringRoutes" Core.:>
                     Core.QueryParam "$.xgafv" Xgafv Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "direction" NetworksListPeeringRoutesDirection
                             Core.:>
                             Core.QueryParam "filter" Core.Text Core.:>
                               Core.QueryParam "maxResults" Core.Word32 Core.:>
                                 Core.QueryParam "orderBy" Core.Text Core.:>
                                   Core.QueryParam "pageToken" Core.Text Core.:>
                                     Core.QueryParam "peeringName" Core.Text Core.:>
                                       Core.QueryParam "region" Core.Text Core.:>
                                         Core.QueryParam "returnPartialSuccess" Core.Bool Core.:>
                                           Core.QueryParam "uploadType" Core.Text Core.:>
                                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                                 Core.Get '[Core.JSON] ExchangedPeeringRoutesList
...
newComputeNetworksListPeeringRoutes network project
  = ComputeNetworksListPeeringRoutes{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     direction = Core.Nothing, filter = Core.Nothing,
                                     maxResults = 500, network = network, orderBy = Core.Nothing,
                                     pageToken = Core.Nothing, peeringName = Core.Nothing,
                                     project = project, region = Core.Nothing,
...
instance Core.GoogleRequest ComputeNetworksListPeeringRoutes where
        type Rs ComputeNetworksListPeeringRoutes =
             ExchangedPeeringRoutesList
        type Scopes ComputeNetworksListPeeringRoutes =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeNetworksListPeeringRoutes{..}
          = go project network xgafv accessToken callback direction filter
