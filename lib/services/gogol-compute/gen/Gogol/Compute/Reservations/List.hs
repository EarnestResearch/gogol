                                   ...
                                   Core.QueryParam "uploadType" Core.Text
                                     ...
                                     Core.QueryParam "upload_protocol" Core.Text
                                       ...
                                       Core.QueryParam "alt" Core.AltJSON
                                         Core.:>
                                         Core.Get '[Core.JSON] ReservationList
...
instance Core.GoogleRequest ComputeReservationsList
         where
        type Rs ComputeReservationsList = ReservationList
        type Scopes ComputeReservationsList =
        ...
        requestClient ComputeReservationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeReservationsListResource)
                      Core.mempty
