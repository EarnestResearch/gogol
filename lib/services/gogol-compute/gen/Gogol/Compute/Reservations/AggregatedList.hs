                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] ReservationAggregatedList
...
newComputeReservationsAggregatedList project
  = ComputeReservationsAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeReservationsAggregatedList where
        type Rs ComputeReservationsAggregatedList =
             ReservationAggregatedList
        type Scopes ComputeReservationsAggregatedList =
