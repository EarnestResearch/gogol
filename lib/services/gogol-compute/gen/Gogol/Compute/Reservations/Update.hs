                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] Reservation Core.:>
...
newComputeReservationsUpdate payload project reservation zone
  = ComputeReservationsUpdate{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              paths = Core.Nothing, payload = payload, project = project,
...
instance Core.GoogleRequest ComputeReservationsUpdate where
        ...
        type Scopes ComputeReservationsUpdate =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeReservationsUpdate{..}
          = go project zone reservation xgafv accessToken callback
