...
newComputeFirewallPoliciesPatchRule firewallPolicy payload
  = ComputeFirewallPoliciesPatchRule{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     firewallPolicy = firewallPolicy, payload = payload,
                                     priority = Core.Nothing, requestId = Core.Nothing,
...
instance Core.GoogleRequest ComputeFirewallPoliciesPatchRule where
        ...
        type Scopes ComputeFirewallPoliciesPatchRule =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeFirewallPoliciesPatchRule{..}
          = go firewallPolicy xgafv accessToken callback priority requestId
              uploadType
              uploadProtocol
