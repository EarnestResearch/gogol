                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] FirewallPolicyList
...
instance Core.GoogleRequest
           ComputeFirewallPoliciesList
         where
        type Rs ComputeFirewallPoliciesList =
             FirewallPolicyList
        type Scopes ComputeFirewallPoliciesList =
             '[CloudPlatform'FullControl, Compute'FullControl,
               Compute'Readonly]
        requestClient ComputeFirewallPoliciesList{..}
          = go xgafv accessToken callback filter
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeFirewallPoliciesListResource)
                      Core.mempty
