...
newComputeFirewallPoliciesRemoveAssociation firewallPolicy
  = ComputeFirewallPoliciesRemoveAssociation{xgafv = Core.Nothing,
                                             accessToken = Core.Nothing, callback = Core.Nothing,
                                             firewallPolicy = firewallPolicy, name = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeFirewallPoliciesRemoveAssociation =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeFirewallPoliciesRemoveAssociation{..}
          = go firewallPolicy xgafv accessToken callback name requestId
              uploadType
              uploadProtocol
