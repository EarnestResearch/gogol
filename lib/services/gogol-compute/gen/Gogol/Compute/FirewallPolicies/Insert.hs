...
newComputeFirewallPoliciesInsert payload
  = ComputeFirewallPoliciesInsert{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  parentId = Core.Nothing, payload = payload,
...
instance Core.GoogleRequest ComputeFirewallPoliciesInsert where
        ...
        type Scopes ComputeFirewallPoliciesInsert =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeFirewallPoliciesInsert{..}
          = go xgafv accessToken callback parentId requestId uploadType
              uploadProtocol
