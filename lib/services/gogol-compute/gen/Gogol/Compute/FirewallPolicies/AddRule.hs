...
newComputeFirewallPoliciesAddRule firewallPolicy payload
  = ComputeFirewallPoliciesAddRule{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeFirewallPoliciesAddRule where
        ...
        type Scopes ComputeFirewallPoliciesAddRule =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeFirewallPoliciesAddRule{..}
          = go firewallPolicy xgafv accessToken callback requestId uploadType
              uploadProtocol
