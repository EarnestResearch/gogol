...
newComputeFirewallPoliciesMove firewallPolicy
  = ComputeFirewallPoliciesMove{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                firewallPolicy = firewallPolicy, parentId = Core.Nothing,
...
instance Core.GoogleRequest ComputeFirewallPoliciesMove where
        ...
        requestClient ComputeFirewallPoliciesMove{..}
          = go firewallPolicy xgafv accessToken callback parentId requestId
              uploadType
              uploadProtocol
