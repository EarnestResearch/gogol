                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] TargetGrpcProxyList
...
instance Core.GoogleRequest
           ComputeTargetGrpcProxiesList
         where
        type Rs ComputeTargetGrpcProxiesList =
             TargetGrpcProxyList
        type Scopes ComputeTargetGrpcProxiesList =
        ...
        requestClient ComputeTargetGrpcProxiesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeTargetGrpcProxiesListResource)
                      Core.mempty
