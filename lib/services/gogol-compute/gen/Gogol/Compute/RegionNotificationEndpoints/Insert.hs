                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] NotificationEndpoint Core.:>
...
newComputeRegionNotificationEndpointsInsert payload project region
  = ComputeRegionNotificationEndpointsInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNotificationEndpointsInsert =
