             ...
             "regions" Core.:>
               Core.Capture "region" Core.Text Core.:>
                 "notificationEndpoints" Core.:>
                   Core.Capture "notificationEndpoint" Core.Text Core.:>
...
newComputeRegionNotificationEndpointsDelete 
    ...
    -> ComputeRegionNotificationEndpointsDelete
newComputeRegionNotificationEndpointsDelete notificationEndpoint
  project region
  = ComputeRegionNotificationEndpointsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNotificationEndpointsDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionNotificationEndpointsDelete{..}
          = go project region notificationEndpoint xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
