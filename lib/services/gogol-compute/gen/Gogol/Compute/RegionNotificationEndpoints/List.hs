                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] NotificationEndpointList
...
newComputeRegionNotificationEndpointsList project region
  = ComputeRegionNotificationEndpointsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionNotificationEndpointsList
         where
        type Rs ComputeRegionNotificationEndpointsList =
             NotificationEndpointList
        type Scopes ComputeRegionNotificationEndpointsList =
