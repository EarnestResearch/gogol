             ...
             "regions" Core.:>
               Core.Capture "region" Core.Text Core.:>
                 "interconnectAttachments" Core.:>
                   Core.Capture "interconnectAttachment" Core.Text Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] InterconnectAttachment Core.:>
...
newComputeInterconnectAttachmentsPatch 
    ...
    -> ComputeInterconnectAttachmentsPatch
newComputeInterconnectAttachmentsPatch interconnectAttachment
  payload project region
  = ComputeInterconnectAttachmentsPatch{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        interconnectAttachment = interconnectAttachment,
                                        payload = payload, project = project, region = region,
                                        requestId = Core.Nothing, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeInterconnectAttachmentsPatch
         where
        ...
        requestClient ComputeInterconnectAttachmentsPatch{..}
          = go project region interconnectAttachment xgafv accessToken
              callback
              requestId
              uploadType
              uploadProtocol
