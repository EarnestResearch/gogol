...
newComputeInterconnectAttachmentsDelete 
    ...
    -> ComputeInterconnectAttachmentsDelete
newComputeInterconnectAttachmentsDelete interconnectAttachment
  project region
  = ComputeInterconnectAttachmentsDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         interconnectAttachment = interconnectAttachment,
                                         project = project, region = region,
                                         requestId = Core.Nothing, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeInterconnectAttachmentsDelete
         where
        type Rs ComputeInterconnectAttachmentsDelete = Operation
        type Scopes ComputeInterconnectAttachmentsDelete =
