                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] InterconnectAttachmentList
...
newComputeInterconnectAttachmentsList project region
  = ComputeInterconnectAttachmentsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInterconnectAttachmentsList
         where
        type Rs ComputeInterconnectAttachmentsList =
