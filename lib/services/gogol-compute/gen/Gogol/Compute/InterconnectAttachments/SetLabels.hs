                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] RegionSetLabelsRequest Core.:>
...
newComputeInterconnectAttachmentsSetLabels 
    ...
    -> ComputeInterconnectAttachmentsSetLabels
newComputeInterconnectAttachmentsSetLabels payload project region
  resource
  = ComputeInterconnectAttachmentsSetLabels{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, project = project, region = region,
                                            requestId = Core.Nothing, resource = resource,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeInterconnectAttachmentsSetLabels
         where
        type Rs ComputeInterconnectAttachmentsSetLabels = Operation
        type Scopes ComputeInterconnectAttachmentsSetLabels =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInterconnectAttachmentsSetLabels{..}
          = go project region resource xgafv accessToken callback requestId
              uploadType
              uploadProtocol
