...
newComputeInterconnectAttachmentsAggregatedList project
  = ComputeInterconnectAttachmentsAggregatedList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           ComputeInterconnectAttachmentsAggregatedList
         where
        type Rs ComputeInterconnectAttachmentsAggregatedList =
             InterconnectAttachmentAggregatedList
        type Scopes ComputeInterconnectAttachmentsAggregatedList =
