...
newComputePublicDelegatedPrefixesAnnounce 
    ...
    -> ComputePublicDelegatedPrefixesAnnounce
newComputePublicDelegatedPrefixesAnnounce project
  publicDelegatedPrefix region
  = ComputePublicDelegatedPrefixesAnnounce{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputePublicDelegatedPrefixesAnnounce
         where
        type Rs ComputePublicDelegatedPrefixesAnnounce = Operation
        type Scopes ComputePublicDelegatedPrefixesAnnounce =
