                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] PublicDelegatedPrefixAggregatedList
...
newComputePublicDelegatedPrefixesAggregatedList project
  = ComputePublicDelegatedPrefixesAggregatedList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           ComputePublicDelegatedPrefixesAggregatedList
         where
        type Rs ComputePublicDelegatedPrefixesAggregatedList =
             PublicDelegatedPrefixAggregatedList
        type Scopes ComputePublicDelegatedPrefixesAggregatedList =
