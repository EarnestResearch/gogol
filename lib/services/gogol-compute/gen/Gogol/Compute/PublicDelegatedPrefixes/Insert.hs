...
newComputePublicDelegatedPrefixesInsert payload project region
  = ComputePublicDelegatedPrefixesInsert{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         payload = payload, project = project, region = region,
                                         requestId = Core.Nothing, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputePublicDelegatedPrefixesInsert
         where
        type Rs ComputePublicDelegatedPrefixesInsert = Operation
        type Scopes ComputePublicDelegatedPrefixesInsert =
