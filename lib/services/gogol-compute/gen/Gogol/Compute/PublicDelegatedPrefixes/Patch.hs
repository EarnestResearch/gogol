             ...
             "regions" Core.:>
               Core.Capture "region" Core.Text Core.:>
                 "publicDelegatedPrefixes" Core.:>
                   Core.Capture "publicDelegatedPrefix" Core.Text Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] PublicDelegatedPrefix Core.:>
...
newComputePublicDelegatedPrefixesPatch 
    ...
    -> ComputePublicDelegatedPrefixesPatch
newComputePublicDelegatedPrefixesPatch payload project
  publicDelegatedPrefix region
  = ComputePublicDelegatedPrefixesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputePublicDelegatedPrefixesPatch
         where
        type Rs ComputePublicDelegatedPrefixesPatch = Operation
        type Scopes ComputePublicDelegatedPrefixesPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputePublicDelegatedPrefixesPatch{..}
          = go project region publicDelegatedPrefix xgafv accessToken
              callback
              requestId
              uploadType
              uploadProtocol
