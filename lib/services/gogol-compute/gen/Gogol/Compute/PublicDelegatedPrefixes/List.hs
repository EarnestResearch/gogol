                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] PublicDelegatedPrefixList
...
newComputePublicDelegatedPrefixesList project region
  = ComputePublicDelegatedPrefixesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputePublicDelegatedPrefixesList
         where
        type Rs ComputePublicDelegatedPrefixesList =
             PublicDelegatedPrefixList
        type Scopes ComputePublicDelegatedPrefixesList =
