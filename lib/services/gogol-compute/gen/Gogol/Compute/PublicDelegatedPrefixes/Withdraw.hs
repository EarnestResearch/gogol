...
newComputePublicDelegatedPrefixesWithdraw 
    ...
    -> ComputePublicDelegatedPrefixesWithdraw
newComputePublicDelegatedPrefixesWithdraw project
  publicDelegatedPrefix region
  = ComputePublicDelegatedPrefixesWithdraw{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputePublicDelegatedPrefixesWithdraw
         where
        type Rs ComputePublicDelegatedPrefixesWithdraw = Operation
        type Scopes ComputePublicDelegatedPrefixesWithdraw =
