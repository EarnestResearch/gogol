...
newComputePublicDelegatedPrefixesDelete 
    ...
    -> ComputePublicDelegatedPrefixesDelete
newComputePublicDelegatedPrefixesDelete project
  publicDelegatedPrefix region
  = ComputePublicDelegatedPrefixesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputePublicDelegatedPrefixesDelete
         where
