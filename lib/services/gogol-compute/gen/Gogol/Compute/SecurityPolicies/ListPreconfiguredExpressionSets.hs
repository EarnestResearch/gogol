           ...
           Core.Capture "project" Core.Text Core.:>
             "global" Core.:>
               "securityPolicies" Core.:>
                 "listPreconfiguredExpressionSets" Core.:>
...
newComputeSecurityPoliciesListPreconfiguredExpressionSets project
  = ComputeSecurityPoliciesListPreconfiguredExpressionSets{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           ComputeSecurityPoliciesListPreconfiguredExpressionSets
         where
        type Rs ComputeSecurityPoliciesListPreconfiguredExpressionSets =
             SecurityPoliciesListPreconfiguredExpressionSetsResponse
        type Scopes ComputeSecurityPoliciesListPreconfiguredExpressionSets
             =
