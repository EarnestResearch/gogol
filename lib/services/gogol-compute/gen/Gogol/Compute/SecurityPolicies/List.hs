                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] SecurityPolicyList
...
instance Core.GoogleRequest
           ComputeSecurityPoliciesList
         where
        type Rs ComputeSecurityPoliciesList =
             SecurityPolicyList
        type Scopes ComputeSecurityPoliciesList =
        ...
        requestClient ComputeSecurityPoliciesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeSecurityPoliciesListResource)
                      Core.mempty
