                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] SecurityPoliciesAggregatedList
...
newComputeSecurityPoliciesAggregatedList project
  = ComputeSecurityPoliciesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeSecurityPoliciesAggregatedList
         where
        type Rs ComputeSecurityPoliciesAggregatedList =
             SecurityPoliciesAggregatedList
        type Scopes ComputeSecurityPoliciesAggregatedList =
