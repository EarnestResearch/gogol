       ...
       "v1" Core.:>
         "projects" Core.:>
           Core.Capture "project" Core.Text Core.:>
             "global" Core.:>
               "routes" Core.:>
                 Core.Capture "route" Core.Text Core.:>
...
newComputeRoutesDelete project route
  = ComputeRoutesDelete{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        project = project, requestId = Core.Nothing, route = route,
...
instance Core.GoogleRequest ComputeRoutesDelete where
        ...
        type Scopes ComputeRoutesDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRoutesDelete{..}
          = go project route xgafv accessToken callback requestId uploadType
              uploadProtocol
