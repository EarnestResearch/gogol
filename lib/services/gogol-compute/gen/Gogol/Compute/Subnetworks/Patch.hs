                     ...
                     Core.QueryParam "$.xgafv" Xgafv Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "drainTimeoutSeconds" Core.Int32 Core.:>
                             Core.QueryParam "requestId" Core.Text Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] Subnetwork Core.:>
...
newComputeSubnetworksPatch payload project region subnetwork
  = ComputeSubnetworksPatch{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing,
                            drainTimeoutSeconds = Core.Nothing, payload = payload,
                            project = project, region = region, requestId = Core.Nothing,
                            subnetwork = subnetwork, uploadType = Core.Nothing,
                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeSubnetworksPatch where
        type Rs ComputeSubnetworksPatch = Operation
        type Scopes ComputeSubnetworksPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeSubnetworksPatch{..}
          = go project region subnetwork xgafv accessToken callback
              drainTimeoutSeconds
              requestId
              uploadType
              uploadProtocol
