...
newComputeSubnetworksSetPrivateIpGoogleAccess 
    ...
    -> ComputeSubnetworksSetPrivateIpGoogleAccess
newComputeSubnetworksSetPrivateIpGoogleAccess payload project
  region subnetwork
  = ComputeSubnetworksSetPrivateIpGoogleAccess{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeSubnetworksSetPrivateIpGoogleAccess =
