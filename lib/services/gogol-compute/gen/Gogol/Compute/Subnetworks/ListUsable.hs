                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] UsableSubnetworksAggregatedList
...
newComputeSubnetworksListUsable project
  = ComputeSubnetworksListUsable{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeSubnetworksListUsable where
        type Rs ComputeSubnetworksListUsable =
             UsableSubnetworksAggregatedList
        type Scopes ComputeSubnetworksListUsable =
