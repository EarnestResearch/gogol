                                   ...
                                   Core.QueryParam "uploadType" Core.Text
                                     ...
                                     Core.QueryParam "upload_protocol" Core.Text
                                       ...
                                       Core.QueryParam "alt" Core.AltJSON
                                         Core.:>
                                         Core.Get '[Core.JSON] AutoscalerList
...
instance Core.GoogleRequest ComputeAutoscalersList
         where
        type Rs ComputeAutoscalersList = AutoscalerList
        type Scopes ComputeAutoscalersList =
        ...
        requestClient ComputeAutoscalersList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeAutoscalersListResource)
                      Core.mempty
