...
newComputeRegionHealthCheckServicesDelete 
    ...
    -> ComputeRegionHealthCheckServicesDelete
newComputeRegionHealthCheckServicesDelete healthCheckService
  project region
  = ComputeRegionHealthCheckServicesDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           healthCheckService = healthCheckService,
                                           project = project, region = region,
                                           requestId = Core.Nothing, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionHealthCheckServicesDelete
         where
        type Rs ComputeRegionHealthCheckServicesDelete = Operation
        type Scopes ComputeRegionHealthCheckServicesDelete =
