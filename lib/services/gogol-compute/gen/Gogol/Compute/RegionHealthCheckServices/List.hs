                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] HealthCheckServicesList
...
newComputeRegionHealthCheckServicesList project region
  = ComputeRegionHealthCheckServicesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionHealthCheckServicesList
         where
        type Rs ComputeRegionHealthCheckServicesList =
             HealthCheckServicesList
        type Scopes ComputeRegionHealthCheckServicesList =
