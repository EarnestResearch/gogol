                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] HealthCheckService Core.:>
...
newComputeRegionHealthCheckServicesPatch 
    ...
    -> ComputeRegionHealthCheckServicesPatch
newComputeRegionHealthCheckServicesPatch healthCheckService payload
  project region
  = ComputeRegionHealthCheckServicesPatch{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          healthCheckService = healthCheckService,
                                          payload = payload, project = project, region = region,
                                          requestId = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionHealthCheckServicesPatch
         where
        type Rs ComputeRegionHealthCheckServicesPatch = Operation
        type Scopes ComputeRegionHealthCheckServicesPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionHealthCheckServicesPatch{..}
          = go project region healthCheckService xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
