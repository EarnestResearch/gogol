...
newComputeRegionHealthCheckServicesInsert payload project region
  = ComputeRegionHealthCheckServicesInsert{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           payload = payload, project = project, region = region,
                                           requestId = Core.Nothing, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionHealthCheckServicesInsert
         where
        type Rs ComputeRegionHealthCheckServicesInsert = Operation
        type Scopes ComputeRegionHealthCheckServicesInsert =
