...
newComputeInstanceGroupManagersPatch 
    ...
    -> ComputeInstanceGroupManagersPatch
newComputeInstanceGroupManagersPatch instanceGroupManager payload
  project zone
  = ComputeInstanceGroupManagersPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstanceGroupManagersPatch where
        ...
        type Scopes ComputeInstanceGroupManagersPatch =
