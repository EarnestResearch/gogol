...
newComputeInstanceGroupManagersDeleteInstances 
    ...
    -> ComputeInstanceGroupManagersDeleteInstances
newComputeInstanceGroupManagersDeleteInstances instanceGroupManager
  payload project zone
  = ComputeInstanceGroupManagersDeleteInstances{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeInstanceGroupManagersDeleteInstances =
