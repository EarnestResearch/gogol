...
newComputeInstanceGroupManagersPatchPerInstanceConfigs 
    ...
    -> ComputeInstanceGroupManagersPatchPerInstanceConfigs
newComputeInstanceGroupManagersPatchPerInstanceConfigs
  instanceGroupManager payload project zone
  = ComputeInstanceGroupManagersPatchPerInstanceConfigs{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ComputeInstanceGroupManagersPatchPerInstanceConfigs
         where
        type Rs ComputeInstanceGroupManagersPatchPerInstanceConfigs =
             Operation
        type Scopes ComputeInstanceGroupManagersPatchPerInstanceConfigs =
