...
newComputeInstanceGroupManagersSetTargetPools 
    ...
    -> ComputeInstanceGroupManagersSetTargetPools
newComputeInstanceGroupManagersSetTargetPools instanceGroupManager
  payload project zone
  = ComputeInstanceGroupManagersSetTargetPools{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeInstanceGroupManagersSetTargetPools =
