...
newComputeInstanceGroupManagersDeletePerInstanceConfigs
  ...
  = ComputeInstanceGroupManagersDeletePerInstanceConfigs{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           ComputeInstanceGroupManagersDeletePerInstanceConfigs
         where
        type Rs ComputeInstanceGroupManagersDeletePerInstanceConfigs =
             Operation
        type Scopes ComputeInstanceGroupManagersDeletePerInstanceConfigs =
