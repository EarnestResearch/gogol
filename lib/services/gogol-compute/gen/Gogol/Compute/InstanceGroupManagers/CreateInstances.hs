...
newComputeInstanceGroupManagersCreateInstances 
    ...
    -> ComputeInstanceGroupManagersCreateInstances
newComputeInstanceGroupManagersCreateInstances instanceGroupManager
  payload project zone
  = ComputeInstanceGroupManagersCreateInstances{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeInstanceGroupManagersCreateInstances =
