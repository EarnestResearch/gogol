...
newComputeInstanceGroupManagersStartInstances 
    ...
    -> ComputeInstanceGroupManagersStartInstances
newComputeInstanceGroupManagersStartInstances instanceGroupManager
  payload project zone
  = ComputeInstanceGroupManagersStartInstances{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeInstanceGroupManagersStartInstances =
