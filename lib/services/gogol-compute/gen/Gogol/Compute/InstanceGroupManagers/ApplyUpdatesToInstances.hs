...
newComputeInstanceGroupManagersApplyUpdatesToInstances
  ...
  = ComputeInstanceGroupManagersApplyUpdatesToInstances{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ComputeInstanceGroupManagersApplyUpdatesToInstances
         where
        type Rs ComputeInstanceGroupManagersApplyUpdatesToInstances =
             Operation
        type Scopes ComputeInstanceGroupManagersApplyUpdatesToInstances =
