...
newComputeInstanceGroupManagersResize 
    ...
    -> ComputeInstanceGroupManagersResize
newComputeInstanceGroupManagersResize instanceGroupManager project
  size zone
  = ComputeInstanceGroupManagersResize{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       instanceGroupManager = instanceGroupManager,
                                       project = project, requestId = Core.Nothing, size = size,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                       zone = zone}
instance Core.GoogleRequest ComputeInstanceGroupManagersResize
         where
        ...
        requestClient ComputeInstanceGroupManagersResize{..}
          = go project zone instanceGroupManager (Core.Just size) xgafv
              accessToken
              callback
              requestId
              uploadType
