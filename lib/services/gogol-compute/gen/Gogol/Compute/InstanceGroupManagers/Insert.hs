...
newComputeInstanceGroupManagersInsert payload project zone
  = ComputeInstanceGroupManagersInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstanceGroupManagersInsert
         where
        type Rs ComputeInstanceGroupManagersInsert = Operation
        type Scopes ComputeInstanceGroupManagersInsert =
