...
newComputeInstanceGroupManagersResumeInstances 
    ...
    -> ComputeInstanceGroupManagersResumeInstances
newComputeInstanceGroupManagersResumeInstances instanceGroupManager
  payload project zone
  = ComputeInstanceGroupManagersResumeInstances{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeInstanceGroupManagersResumeInstances =
