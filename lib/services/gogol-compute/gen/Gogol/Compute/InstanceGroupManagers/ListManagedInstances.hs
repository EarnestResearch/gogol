...
newComputeInstanceGroupManagersListManagedInstances
  ...
  = ComputeInstanceGroupManagersListManagedInstances{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ComputeInstanceGroupManagersListManagedInstances
         where
        type Rs ComputeInstanceGroupManagersListManagedInstances =
             InstanceGroupManagersListManagedInstancesResponse
        type Scopes ComputeInstanceGroupManagersListManagedInstances =
