                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] InstanceGroupManagerAggregatedList
...
newComputeInstanceGroupManagersAggregatedList project
  = ComputeInstanceGroupManagersAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeInstanceGroupManagersAggregatedList
         where
        type Rs ComputeInstanceGroupManagersAggregatedList =
             InstanceGroupManagerAggregatedList
        type Scopes ComputeInstanceGroupManagersAggregatedList =
