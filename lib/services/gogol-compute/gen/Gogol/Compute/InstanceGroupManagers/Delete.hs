...
newComputeInstanceGroupManagersDelete 
    ...
    -> ComputeInstanceGroupManagersDelete
newComputeInstanceGroupManagersDelete instanceGroupManager project
  zone
  = ComputeInstanceGroupManagersDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       instanceGroupManager = instanceGroupManager,
                                       project = project, requestId = Core.Nothing,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                       zone = zone}
instance Core.GoogleRequest ComputeInstanceGroupManagersDelete
         where
        type Rs ComputeInstanceGroupManagersDelete = Operation
        type Scopes ComputeInstanceGroupManagersDelete =
