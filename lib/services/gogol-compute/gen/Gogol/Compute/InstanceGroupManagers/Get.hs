...
newComputeInstanceGroupManagersGet 
    ...
    -> ComputeInstanceGroupManagersGet
newComputeInstanceGroupManagersGet instanceGroupManager project
  zone
  = ComputeInstanceGroupManagersGet{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    instanceGroupManager = instanceGroupManager, project = project,
