...
newComputeInstanceGroupManagersUpdatePerInstanceConfigs
  ...
  = ComputeInstanceGroupManagersUpdatePerInstanceConfigs{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           ComputeInstanceGroupManagersUpdatePerInstanceConfigs
         where
        type Rs ComputeInstanceGroupManagersUpdatePerInstanceConfigs =
             Operation
        type Scopes ComputeInstanceGroupManagersUpdatePerInstanceConfigs =
