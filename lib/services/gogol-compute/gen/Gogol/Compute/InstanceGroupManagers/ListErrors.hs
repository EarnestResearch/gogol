...
newComputeInstanceGroupManagersListErrors 
    ...
    -> ComputeInstanceGroupManagersListErrors
newComputeInstanceGroupManagersListErrors instanceGroupManager
  project zone
  = ComputeInstanceGroupManagersListErrors{xgafv = Core.Nothing,
                                           ...
                                           zone = zone}
instance Core.GoogleRequest ComputeInstanceGroupManagersListErrors
         where
        type Rs ComputeInstanceGroupManagersListErrors =
             InstanceGroupManagersListErrorsResponse
        type Scopes ComputeInstanceGroupManagersListErrors =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeInstanceGroupManagersListErrors{..}
          = go project zone instanceGroupManager xgafv accessToken callback
              filter
