                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] CommitmentAggregatedList
...
newComputeRegionCommitmentsAggregatedList project
  = ComputeRegionCommitmentsAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionCommitmentsAggregatedList
         where
        type Rs ComputeRegionCommitmentsAggregatedList =
             CommitmentAggregatedList
        type Scopes ComputeRegionCommitmentsAggregatedList =
