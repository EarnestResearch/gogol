                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] Commitment Core.:>
...
newComputeRegionCommitmentsUpdate commitment payload project region
  = ComputeRegionCommitmentsUpdate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   commitment = commitment, paths = Core.Nothing, payload = payload,
...
instance Core.GoogleRequest ComputeRegionCommitmentsUpdate where
        ...
        requestClient ComputeRegionCommitmentsUpdate{..}
          = go project region commitment xgafv accessToken callback
