...
newComputeSslPoliciesListAvailableFeatures project
  = ComputeSslPoliciesListAvailableFeatures{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeSslPoliciesListAvailableFeatures
         where
        type Rs ComputeSslPoliciesListAvailableFeatures =
             SslPoliciesListAvailableFeaturesResponse
        type Scopes ComputeSslPoliciesListAvailableFeatures =
