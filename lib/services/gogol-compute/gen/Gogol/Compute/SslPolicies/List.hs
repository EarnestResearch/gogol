                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] SslPoliciesList
...
instance Core.GoogleRequest ComputeSslPoliciesList
         where
        type Rs ComputeSslPoliciesList = SslPoliciesList
        type Scopes ComputeSslPoliciesList =
        ...
        requestClient ComputeSslPoliciesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeSslPoliciesListResource)
                      Core.mempty
