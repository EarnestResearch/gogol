                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] SslPoliciesAggregatedList
...
newComputeSslPoliciesAggregatedList project
  = ComputeSslPoliciesAggregatedList{xgafv = Core.Nothing,
                                     ...
                                     serviceProjectNumber = Core.Nothing, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeSslPoliciesAggregatedList where
        type Rs ComputeSslPoliciesAggregatedList =
             SslPoliciesAggregatedList
        type Scopes ComputeSslPoliciesAggregatedList =
