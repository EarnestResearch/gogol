...
newComputeTargetSslProxiesSetSslCertificates 
    ...
    -> ComputeTargetSslProxiesSetSslCertificates
newComputeTargetSslProxiesSetSslCertificates payload project
  targetSslProxy
  = ComputeTargetSslProxiesSetSslCertificates{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeTargetSslProxiesSetSslCertificates =
