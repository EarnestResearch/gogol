                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] TargetSslProxyList
...
instance Core.GoogleRequest
           ComputeTargetSslProxiesList
         where
        type Rs ComputeTargetSslProxiesList =
             TargetSslProxyList
        type Scopes ComputeTargetSslProxiesList =
        ...
        requestClient ComputeTargetSslProxiesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeTargetSslProxiesListResource)
                      Core.mempty
