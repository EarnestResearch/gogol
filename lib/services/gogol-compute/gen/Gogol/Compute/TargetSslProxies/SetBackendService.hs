...
newComputeTargetSslProxiesSetBackendService 
    ...
    -> ComputeTargetSslProxiesSetBackendService
newComputeTargetSslProxiesSetBackendService payload project
  targetSslProxy
  = ComputeTargetSslProxiesSetBackendService{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeTargetSslProxiesSetBackendService =
