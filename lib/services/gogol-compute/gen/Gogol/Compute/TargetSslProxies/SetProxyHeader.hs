                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] TargetSslProxiesSetProxyHeaderRequest
...
newComputeTargetSslProxiesSetProxyHeader 
    ...
    -> ComputeTargetSslProxiesSetProxyHeader
newComputeTargetSslProxiesSetProxyHeader payload project
  targetSslProxy
  = ComputeTargetSslProxiesSetProxyHeader{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, project = project,
                                          requestId = Core.Nothing, targetSslProxy = targetSslProxy,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeTargetSslProxiesSetProxyHeader
         where
        type Rs ComputeTargetSslProxiesSetProxyHeader = Operation
        type Scopes ComputeTargetSslProxiesSetProxyHeader =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeTargetSslProxiesSetProxyHeader{..}
          = go project targetSslProxy xgafv accessToken callback requestId
              uploadType
              uploadProtocol
