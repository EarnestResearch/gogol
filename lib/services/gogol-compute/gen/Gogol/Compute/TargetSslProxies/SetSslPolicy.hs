                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] SslPolicyReference Core.:>
...
newComputeTargetSslProxiesSetSslPolicy 
    ...
    -> ComputeTargetSslProxiesSetSslPolicy
newComputeTargetSslProxiesSetSslPolicy payload project
  targetSslProxy
  = ComputeTargetSslProxiesSetSslPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetSslProxiesSetSslPolicy
         where
