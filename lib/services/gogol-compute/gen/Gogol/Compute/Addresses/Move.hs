                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] RegionAddressesMoveRequest Core.:>
...
newComputeAddressesMove address payload project region
  = ComputeAddressesMove{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, address = address,
...
instance Core.GoogleRequest ComputeAddressesMove where
        ...
        type Scopes ComputeAddressesMove =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeAddressesMove{..}
          = go project region address xgafv accessToken callback requestId
              uploadType
              uploadProtocol
