                                   ...
                                   Core.QueryParam "uploadType" Core.Text
                                     ...
                                     Core.QueryParam "upload_protocol" Core.Text
                                       ...
                                       Core.QueryParam "alt" Core.AltJSON
                                         Core.:>
                                         Core.Get '[Core.JSON] DiskTypeList
...
instance Core.GoogleRequest ComputeDiskTypesList
         where
        type Rs ComputeDiskTypesList = DiskTypeList
        type Scopes ComputeDiskTypesList =
        ...
        requestClient ComputeDiskTypesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeDiskTypesListResource)
                      Core.mempty
