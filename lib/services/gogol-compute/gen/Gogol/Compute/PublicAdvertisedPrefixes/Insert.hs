...
newComputePublicAdvertisedPrefixesInsert payload project
  = ComputePublicAdvertisedPrefixesInsert{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, project = project,
                                          requestId = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputePublicAdvertisedPrefixesInsert
         where
        type Rs ComputePublicAdvertisedPrefixesInsert = Operation
        type Scopes ComputePublicAdvertisedPrefixesInsert =
