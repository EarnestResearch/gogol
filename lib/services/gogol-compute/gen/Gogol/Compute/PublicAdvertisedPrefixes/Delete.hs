...
newComputePublicAdvertisedPrefixesDelete 
    ...
    -> ComputePublicAdvertisedPrefixesDelete
newComputePublicAdvertisedPrefixesDelete project
  publicAdvertisedPrefix
  = ComputePublicAdvertisedPrefixesDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          project = project,
                                          publicAdvertisedPrefix = publicAdvertisedPrefix,
                                          requestId = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputePublicAdvertisedPrefixesDelete
         where
        type Rs ComputePublicAdvertisedPrefixesDelete = Operation
        type Scopes ComputePublicAdvertisedPrefixesDelete =
