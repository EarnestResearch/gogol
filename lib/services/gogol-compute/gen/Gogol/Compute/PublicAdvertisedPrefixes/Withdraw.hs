...
newComputePublicAdvertisedPrefixesWithdraw 
    ...
    -> ComputePublicAdvertisedPrefixesWithdraw
newComputePublicAdvertisedPrefixesWithdraw project
  publicAdvertisedPrefix
  = ComputePublicAdvertisedPrefixesWithdraw{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            project = project,
                                            publicAdvertisedPrefix = publicAdvertisedPrefix,
                                            requestId = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputePublicAdvertisedPrefixesWithdraw
         where
        type Rs ComputePublicAdvertisedPrefixesWithdraw = Operation
        type Scopes ComputePublicAdvertisedPrefixesWithdraw =
