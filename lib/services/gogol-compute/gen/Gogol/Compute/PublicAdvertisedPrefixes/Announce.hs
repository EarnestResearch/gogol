...
newComputePublicAdvertisedPrefixesAnnounce 
    ...
    -> ComputePublicAdvertisedPrefixesAnnounce
newComputePublicAdvertisedPrefixesAnnounce project
  publicAdvertisedPrefix
  = ComputePublicAdvertisedPrefixesAnnounce{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            project = project,
                                            publicAdvertisedPrefix = publicAdvertisedPrefix,
                                            requestId = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputePublicAdvertisedPrefixesAnnounce
         where
        type Rs ComputePublicAdvertisedPrefixesAnnounce = Operation
        type Scopes ComputePublicAdvertisedPrefixesAnnounce =
