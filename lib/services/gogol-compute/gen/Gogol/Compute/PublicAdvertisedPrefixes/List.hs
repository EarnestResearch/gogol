                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] PublicAdvertisedPrefixList
...
newComputePublicAdvertisedPrefixesList project
  = ComputePublicAdvertisedPrefixesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputePublicAdvertisedPrefixesList
         where
        type Rs ComputePublicAdvertisedPrefixesList =
             PublicAdvertisedPrefixList
        type Scopes ComputePublicAdvertisedPrefixesList =
