           ...
           Core.Capture "project" Core.Text Core.:>
             "global" Core.:>
               "publicAdvertisedPrefixes" Core.:>
                 Core.Capture "publicAdvertisedPrefix" Core.Text Core.:>
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] PublicAdvertisedPrefix Core.:>
...
newComputePublicAdvertisedPrefixesPatch 
    ...
    -> ComputePublicAdvertisedPrefixesPatch
newComputePublicAdvertisedPrefixesPatch payload project
  publicAdvertisedPrefix
  = ComputePublicAdvertisedPrefixesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputePublicAdvertisedPrefixesPatch
         where
        type Rs ComputePublicAdvertisedPrefixesPatch = Operation
        type Scopes ComputePublicAdvertisedPrefixesPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputePublicAdvertisedPrefixesPatch{..}
          = go project publicAdvertisedPrefix xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
