...
newComputeRegionBackendServicesPatch 
    ...
    -> ComputeRegionBackendServicesPatch
newComputeRegionBackendServicesPatch backendService payload project
  region
  = ComputeRegionBackendServicesPatch{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, backendService = backendService,
                                      callback = Core.Nothing, payload = payload, project = project,
...
instance Core.GoogleRequest ComputeRegionBackendServicesPatch where
        ...
        type Scopes ComputeRegionBackendServicesPatch =
