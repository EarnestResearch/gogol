...
newComputeRegionBackendServicesInsert payload project region
  = ComputeRegionBackendServicesInsert{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, project = project, region = region,
                                       requestId = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionBackendServicesInsert
         where
        type Rs ComputeRegionBackendServicesInsert = Operation
        type Scopes ComputeRegionBackendServicesInsert =
