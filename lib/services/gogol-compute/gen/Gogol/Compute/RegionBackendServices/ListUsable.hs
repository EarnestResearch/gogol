                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] BackendServiceListUsable
...
newComputeRegionBackendServicesListUsable project region
  = ComputeRegionBackendServicesListUsable{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionBackendServicesListUsable
         where
        type Rs ComputeRegionBackendServicesListUsable =
             BackendServiceListUsable
        type Scopes ComputeRegionBackendServicesListUsable =
