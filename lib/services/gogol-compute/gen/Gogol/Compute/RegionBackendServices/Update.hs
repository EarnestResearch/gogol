                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] BackendService Core.:>
...
newComputeRegionBackendServicesUpdate 
    ...
    -> ComputeRegionBackendServicesUpdate
newComputeRegionBackendServicesUpdate backendService payload
  project region
  = ComputeRegionBackendServicesUpdate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, backendService = backendService,
                                       callback = Core.Nothing, payload = payload,
                                       project = project, region = region, requestId = Core.Nothing,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionBackendServicesUpdate
         where
        type Rs ComputeRegionBackendServicesUpdate = Operation
        type Scopes ComputeRegionBackendServicesUpdate =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionBackendServicesUpdate{..}
          = go project region backendService xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
