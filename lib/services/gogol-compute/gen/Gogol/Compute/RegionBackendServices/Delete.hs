...
newComputeRegionBackendServicesDelete backendService project region
  = ComputeRegionBackendServicesDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, backendService = backendService,
                                       callback = Core.Nothing, project = project, region = region,
                                       requestId = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionBackendServicesDelete
         where
        type Rs ComputeRegionBackendServicesDelete = Operation
        type Scopes ComputeRegionBackendServicesDelete =
