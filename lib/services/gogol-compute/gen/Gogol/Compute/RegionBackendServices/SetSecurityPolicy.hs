...
newComputeRegionBackendServicesSetSecurityPolicy 
    ...
    -> ComputeRegionBackendServicesSetSecurityPolicy
newComputeRegionBackendServicesSetSecurityPolicy backendService
  payload project region
  = ComputeRegionBackendServicesSetSecurityPolicy{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionBackendServicesSetSecurityPolicy =
