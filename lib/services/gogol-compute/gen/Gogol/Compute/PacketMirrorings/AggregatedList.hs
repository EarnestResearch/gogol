                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] PacketMirroringAggregatedList
...
newComputePacketMirroringsAggregatedList project
  = ComputePacketMirroringsAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputePacketMirroringsAggregatedList
         where
        type Rs ComputePacketMirroringsAggregatedList =
             PacketMirroringAggregatedList
        type Scopes ComputePacketMirroringsAggregatedList =
