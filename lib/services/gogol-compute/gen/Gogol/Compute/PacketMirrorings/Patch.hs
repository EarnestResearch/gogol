                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] PacketMirroring Core.:>
...
newComputePacketMirroringsPatch 
    ...
    -> ComputePacketMirroringsPatch
newComputePacketMirroringsPatch packetMirroring payload project
  region
  = ComputePacketMirroringsPatch{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 packetMirroring = packetMirroring, payload = payload,
...
instance Core.GoogleRequest ComputePacketMirroringsPatch where
        ...
        type Scopes ComputePacketMirroringsPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputePacketMirroringsPatch{..}
          = go project region packetMirroring xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
