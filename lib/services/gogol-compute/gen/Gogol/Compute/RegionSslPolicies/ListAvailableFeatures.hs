...
newComputeRegionSslPoliciesListAvailableFeatures project region
  = ComputeRegionSslPoliciesListAvailableFeatures{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionSslPoliciesListAvailableFeatures
         where
        type Rs ComputeRegionSslPoliciesListAvailableFeatures =
             SslPoliciesListAvailableFeaturesResponse
        type Scopes ComputeRegionSslPoliciesListAvailableFeatures =
