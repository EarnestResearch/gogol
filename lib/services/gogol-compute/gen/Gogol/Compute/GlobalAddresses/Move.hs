                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] GlobalAddressesMoveRequest Core.:>
...
newComputeGlobalAddressesMove address payload project
  = ComputeGlobalAddressesMove{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeGlobalAddressesMove where
        ...
        type Scopes ComputeGlobalAddressesMove =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeGlobalAddressesMove{..}
          = go project address xgafv accessToken callback requestId
              uploadType
              uploadProtocol
