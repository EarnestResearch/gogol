                     ...
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "requestId" Core.Text Core.:>
                           Core.QueryParam "sourceImage" Core.Text Core.:>
...
newComputeRegionDisksInsert payload project region
  = ComputeRegionDisksInsert{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             payload = payload, project = project, region = region,
                             requestId = Core.Nothing, sourceImage = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionDisksInsert where
        ...
        type Scopes ComputeRegionDisksInsert =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionDisksInsert{..}
          = go project region xgafv accessToken callback requestId
              sourceImage
              uploadType
              uploadProtocol
