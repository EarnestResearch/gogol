...
newComputeRegionDisksRemoveResourcePolicies 
    ...
    -> ComputeRegionDisksRemoveResourcePolicies
newComputeRegionDisksRemoveResourcePolicies disk payload project
  region
  = ComputeRegionDisksRemoveResourcePolicies{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionDisksRemoveResourcePolicies =
