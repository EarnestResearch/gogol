           ...
           Core.Capture "project" Core.Text Core.:>
             "regions" Core.:>
               Core.Capture "region" Core.Text Core.:>
                 "disks" Core.:>
                   "stopGroupAsyncReplication" Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] DisksStopGroupAsyncReplicationResource
...
newComputeRegionDisksStopGroupAsyncReplication 
    ...
    -> ComputeRegionDisksStopGroupAsyncReplication
newComputeRegionDisksStopGroupAsyncReplication payload project
  region
  = ComputeRegionDisksStopGroupAsyncReplication{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionDisksStopGroupAsyncReplication =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionDisksStopGroupAsyncReplication{..}
          = go project region xgafv accessToken callback requestId uploadType
              uploadProtocol
