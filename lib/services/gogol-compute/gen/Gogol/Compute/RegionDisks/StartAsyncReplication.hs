...
newComputeRegionDisksStartAsyncReplication 
    ...
    -> ComputeRegionDisksStartAsyncReplication
newComputeRegionDisksStartAsyncReplication disk payload project
  region
  = ComputeRegionDisksStartAsyncReplication{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            disk = disk, payload = payload, project = project,
                                            region = region, requestId = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionDisksStartAsyncReplication
         where
        type Rs ComputeRegionDisksStartAsyncReplication = Operation
        type Scopes ComputeRegionDisksStartAsyncReplication =
