                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] RegionDisksAddResourcePoliciesRequest
...
newComputeRegionDisksAddResourcePolicies 
    ...
    -> ComputeRegionDisksAddResourcePolicies
newComputeRegionDisksAddResourcePolicies disk payload project
  region
  = ComputeRegionDisksAddResourcePolicies{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          disk = disk, payload = payload, project = project,
                                          region = region, requestId = Core.Nothing,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionDisksAddResourcePolicies
         where
        type Rs ComputeRegionDisksAddResourcePolicies = Operation
        type Scopes ComputeRegionDisksAddResourcePolicies =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionDisksAddResourcePolicies{..}
          = go project region disk xgafv accessToken callback requestId
              uploadType
              uploadProtocol
