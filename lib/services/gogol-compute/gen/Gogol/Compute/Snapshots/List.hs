                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] SnapshotList
...
instance Core.GoogleRequest ComputeSnapshotsList
         where
        type Rs ComputeSnapshotsList = SnapshotList
        type Scopes ComputeSnapshotsList =
        ...
        requestClient ComputeSnapshotsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeSnapshotsListResource)
                      Core.mempty
