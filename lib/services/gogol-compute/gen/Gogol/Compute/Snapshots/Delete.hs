       ...
       "v1" Core.:>
         "projects" Core.:>
           Core.Capture "project" Core.Text Core.:>
             "global" Core.:>
               "snapshots" Core.:>
                 Core.Capture "snapshot" Core.Text Core.:>
...
newComputeSnapshotsDelete project snapshot
  = ComputeSnapshotsDelete{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           project = project, requestId = Core.Nothing, snapshot = snapshot,
...
instance Core.GoogleRequest ComputeSnapshotsDelete where
        ...
        type Scopes ComputeSnapshotsDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeSnapshotsDelete{..}
          = go project snapshot xgafv accessToken callback requestId
              uploadType
              uploadProtocol
