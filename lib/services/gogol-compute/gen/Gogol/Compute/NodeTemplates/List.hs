                                   ...
                                   Core.QueryParam "uploadType" Core.Text
                                     ...
                                     Core.QueryParam "upload_protocol" Core.Text
                                       ...
                                       Core.QueryParam "alt" Core.AltJSON
                                         Core.:>
                                         Core.Get '[Core.JSON] NodeTemplateList
...
instance Core.GoogleRequest ComputeNodeTemplatesList
         where
        type Rs ComputeNodeTemplatesList = NodeTemplateList
        type Scopes ComputeNodeTemplatesList =
        ...
        requestClient ComputeNodeTemplatesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeNodeTemplatesListResource)
                      Core.mempty
