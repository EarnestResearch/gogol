                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] NodeTemplateAggregatedList
...
newComputeNodeTemplatesAggregatedList project
  = ComputeNodeTemplatesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeNodeTemplatesAggregatedList
         where
        type Rs ComputeNodeTemplatesAggregatedList =
             NodeTemplateAggregatedList
        type Scopes ComputeNodeTemplatesAggregatedList =
