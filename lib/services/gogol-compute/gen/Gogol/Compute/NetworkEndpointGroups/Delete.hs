...
newComputeNetworkEndpointGroupsDelete networkEndpointGroup project
  zone
  = ComputeNetworkEndpointGroupsDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       networkEndpointGroup = networkEndpointGroup,
                                       project = project, requestId = Core.Nothing,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                       zone = zone}
instance Core.GoogleRequest ComputeNetworkEndpointGroupsDelete
         where
        type Rs ComputeNetworkEndpointGroupsDelete = Operation
        type Scopes ComputeNetworkEndpointGroupsDelete =
