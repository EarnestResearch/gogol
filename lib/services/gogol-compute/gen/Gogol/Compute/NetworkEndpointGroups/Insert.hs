                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] NetworkEndpointGroup Core.:>
...
newComputeNetworkEndpointGroupsInsert payload project zone
  = ComputeNetworkEndpointGroupsInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeNetworkEndpointGroupsInsert
         where
        type Rs ComputeNetworkEndpointGroupsInsert = Operation
        type Scopes ComputeNetworkEndpointGroupsInsert =
