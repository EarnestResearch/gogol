...
newComputeNetworkEndpointGroupsDetachNetworkEndpoints
  ...
  = ComputeNetworkEndpointGroupsDetachNetworkEndpoints{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkEndpointGroupsDetachNetworkEndpoints
         where
        type Rs ComputeNetworkEndpointGroupsDetachNetworkEndpoints =
             Operation
        type Scopes ComputeNetworkEndpointGroupsDetachNetworkEndpoints =
