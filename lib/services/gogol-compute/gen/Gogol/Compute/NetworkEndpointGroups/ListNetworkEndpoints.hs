...
newComputeNetworkEndpointGroupsListNetworkEndpoints 
    ...
    -> ComputeNetworkEndpointGroupsListNetworkEndpoints
newComputeNetworkEndpointGroupsListNetworkEndpoints
  networkEndpointGroup payload project zone
  = ComputeNetworkEndpointGroupsListNetworkEndpoints{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkEndpointGroupsListNetworkEndpoints
         where
        type Rs ComputeNetworkEndpointGroupsListNetworkEndpoints =
             NetworkEndpointGroupsListNetworkEndpoints
        type Scopes ComputeNetworkEndpointGroupsListNetworkEndpoints =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeNetworkEndpointGroupsListNetworkEndpoints{..}
          = go project zone networkEndpointGroup xgafv accessToken callback
              filter
