                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] NetworkEndpointGroupAggregatedList
...
newComputeNetworkEndpointGroupsAggregatedList project
  = ComputeNetworkEndpointGroupsAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkEndpointGroupsAggregatedList
         where
        type Rs ComputeNetworkEndpointGroupsAggregatedList =
             NetworkEndpointGroupAggregatedList
        type Scopes ComputeNetworkEndpointGroupsAggregatedList =
