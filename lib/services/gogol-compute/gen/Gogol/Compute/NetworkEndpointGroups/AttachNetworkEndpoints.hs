...
newComputeNetworkEndpointGroupsAttachNetworkEndpoints
  ...
  = ComputeNetworkEndpointGroupsAttachNetworkEndpoints{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkEndpointGroupsAttachNetworkEndpoints
         where
        type Rs ComputeNetworkEndpointGroupsAttachNetworkEndpoints =
             Operation
        type Scopes ComputeNetworkEndpointGroupsAttachNetworkEndpoints =
