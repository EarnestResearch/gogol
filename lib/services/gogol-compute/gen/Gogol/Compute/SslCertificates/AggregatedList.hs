                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] SslCertificateAggregatedList
...
newComputeSslCertificatesAggregatedList project
  = ComputeSslCertificatesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeSslCertificatesAggregatedList
         where
        type Rs ComputeSslCertificatesAggregatedList =
             SslCertificateAggregatedList
        type Scopes ComputeSslCertificatesAggregatedList =
