                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] SslCertificateList
...
instance Core.GoogleRequest
           ComputeSslCertificatesList
         where
        type Rs ComputeSslCertificatesList =
             SslCertificateList
        type Scopes ComputeSslCertificatesList =
        ...
        requestClient ComputeSslCertificatesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeSslCertificatesListResource)
                      Core.mempty
