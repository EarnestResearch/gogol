...
newComputeRegionTargetTcpProxiesDelete 
    ...
    -> ComputeRegionTargetTcpProxiesDelete
newComputeRegionTargetTcpProxiesDelete project region
  targetTcpProxy
  = ComputeRegionTargetTcpProxiesDelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        project = project, region = region,
                                        requestId = Core.Nothing, targetTcpProxy = targetTcpProxy,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionTargetTcpProxiesDelete
         where
        type Rs ComputeRegionTargetTcpProxiesDelete = Operation
        type Scopes ComputeRegionTargetTcpProxiesDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionTargetTcpProxiesDelete{..}
          = go project region targetTcpProxy xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
