                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] OperationAggregatedList
...
newComputeGlobalOperationsAggregatedList project
  = ComputeGlobalOperationsAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeGlobalOperationsAggregatedList
         where
        type Rs ComputeGlobalOperationsAggregatedList =
             OperationAggregatedList
        type Scopes ComputeGlobalOperationsAggregatedList =
