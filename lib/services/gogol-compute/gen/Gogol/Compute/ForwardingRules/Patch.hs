                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] ForwardingRule Core.:>
...
newComputeForwardingRulesPatch 
    ...
    -> ComputeForwardingRulesPatch
newComputeForwardingRulesPatch forwardingRule payload project
  region
  = ComputeForwardingRulesPatch{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                forwardingRule = forwardingRule, payload = payload,
...
instance Core.GoogleRequest ComputeForwardingRulesPatch where
        ...
        type Scopes ComputeForwardingRulesPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeForwardingRulesPatch{..}
          = go project region forwardingRule xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
