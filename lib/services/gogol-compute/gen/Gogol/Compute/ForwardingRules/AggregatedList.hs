                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] ForwardingRuleAggregatedList
...
newComputeForwardingRulesAggregatedList project
  = ComputeForwardingRulesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeForwardingRulesAggregatedList
         where
        type Rs ComputeForwardingRulesAggregatedList =
             ForwardingRuleAggregatedList
        type Scopes ComputeForwardingRulesAggregatedList =
