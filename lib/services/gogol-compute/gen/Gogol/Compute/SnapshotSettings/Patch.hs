                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] SnapshotSettings Core.:>
...
newComputeSnapshotSettingsPatch payload project
  = ComputeSnapshotSettingsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeSnapshotSettingsPatch where
        ...
        type Scopes ComputeSnapshotSettingsPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeSnapshotSettingsPatch{..}
          = go project xgafv accessToken callback requestId updateMask
              uploadType
              uploadProtocol
