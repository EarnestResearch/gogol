               ...
               Core.Capture "region" Core.Text Core.:>
                 "routers" Core.:>
                   Core.Capture "router" Core.Text Core.:>
                     "deleteRoutePolicy" Core.:>
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "policy" Core.Text Core.:>
...
newComputeRoutersDeleteRoutePolicy project region router
  = ComputeRoutersDeleteRoutePolicy{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    policy = Core.Nothing, project = project, region = region,
                                    requestId = Core.Nothing, router = router,
...
instance Core.GoogleRequest ComputeRoutersDeleteRoutePolicy where
        ...
        type Scopes ComputeRoutersDeleteRoutePolicy =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRoutersDeleteRoutePolicy{..}
          = go project region router xgafv accessToken callback policy
              requestId
              uploadType
              uploadProtocol
