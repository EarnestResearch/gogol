                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] RoutePolicy Core.:>
...
newComputeRoutersUpdateRoutePolicy payload project region router
  = ComputeRoutersUpdateRoutePolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRoutersUpdateRoutePolicy where
        ...
        type Scopes ComputeRoutersUpdateRoutePolicy =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRoutersUpdateRoutePolicy{..}
          = go project region router xgafv accessToken callback requestId
              uploadType
              uploadProtocol
