                                       ...
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] RoutersListRoutePolicies
...
newComputeRoutersListRoutePolicies project region router
  = ComputeRoutersListRoutePolicies{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    filter = Core.Nothing, maxResults = 500, orderBy = Core.Nothing,
                                    pageToken = Core.Nothing, project = project, region = region,
...
instance Core.GoogleRequest ComputeRoutersListRoutePolicies where
        ...
        type Scopes ComputeRoutersListRoutePolicies =
