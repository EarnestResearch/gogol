                     ...
                     "listBgpRoutes" Core.:>
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "addressFamily" RoutersListBgpRoutesAddressFamily
                             Core.:>
                             Core.QueryParam "callback" Core.Text Core.:>
                               Core.QueryParam "destinationPrefix" Core.Text Core.:>
                                 Core.QueryParam "filter" Core.Text Core.:>
                                   Core.QueryParam "maxResults" Core.Word32 Core.:>
                                     Core.QueryParam "orderBy" Core.Text Core.:>
                                       Core.QueryParam "pageToken" Core.Text Core.:>
                                         Core.QueryParam "peer" Core.Text Core.:>
                                           Core.QueryParam "policyApplied" Core.Bool Core.:>
                                             Core.QueryParam "returnPartialSuccess" Core.Bool
                                               Core.:>
                                               Core.QueryParam "routeType"
                                                 ...
                                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                                   Core.QueryParam "upload_protocol" Core.Text
                                                     ...
                                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                                       Core.Get '[Core.JSON] RoutersListBgpRoutes
...
newComputeRoutersListBgpRoutes project region router
  = ComputeRoutersListBgpRoutes{xgafv = Core.Nothing,
                                accessToken = Core.Nothing,
                                addressFamily =
                                  RoutersListBgpRoutesAddressFamily_UNSPECIFIEDIPVERSION,
                                callback = Core.Nothing, destinationPrefix = Core.Nothing,
                                filter = Core.Nothing, maxResults = 500, orderBy = Core.Nothing,
                                pageToken = Core.Nothing, peer = Core.Nothing,
                                policyApplied = Core.True, project = project, region = region,
                                returnPartialSuccess = Core.Nothing,
                                routeType = RoutersListBgpRoutesRouteType_UNSPECIFIEDROUTETYPE,
                                router = router, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ComputeRoutersListBgpRoutes where
        ...
        type Scopes ComputeRoutersListBgpRoutes =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeRoutersListBgpRoutes{..}
          = go project region router xgafv accessToken
