                                         ...
                                         Core.QueryParam "uploadType" Core.Text Core.:>
                                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                                             Core.QueryParam "alt" Core.AltJSON Core.:>
                                               Core.Get '[Core.JSON] VmEndpointNatMappingsList
...
newComputeRoutersGetNatMappingInfo project region router
  = ComputeRoutersGetNatMappingInfo{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    filter = Core.Nothing, maxResults = 500, natName = Core.Nothing,
                                    orderBy = Core.Nothing, pageToken = Core.Nothing,
                                    project = project, region = region,
                                    returnPartialSuccess = Core.Nothing, router = router,
...
instance Core.GoogleRequest ComputeRoutersGetNatMappingInfo where
        ...
        type Scopes ComputeRoutersGetNatMappingInfo =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeRoutersGetNatMappingInfo{..}
          = go project region router xgafv accessToken callback filter
