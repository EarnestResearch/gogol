                   ...
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "filter" Core.Text Core.:>
                         Core.QueryParam "includeAllScopes" Core.Bool Core.:>
                             ...
                             Core.QueryParam "orderBy" Core.Text Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "returnPartialSuccess" Core.Bool Core.:>
                                   Core.QueryParam "serviceProjectNumber" Core.Int64 Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] NetworkAttachmentAggregatedList
...
newComputeNetworkAttachmentsAggregatedList project
  = ComputeNetworkAttachmentsAggregatedList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            filter = Core.Nothing, includeAllScopes = Core.Nothing,
                                            maxResults = 500, orderBy = Core.Nothing,
                                            pageToken = Core.Nothing, project = project,
                                            returnPartialSuccess = Core.Nothing,
                                            serviceProjectNumber = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeNetworkAttachmentsAggregatedList
         where
        type Rs ComputeNetworkAttachmentsAggregatedList =
             NetworkAttachmentAggregatedList
        type Scopes ComputeNetworkAttachmentsAggregatedList =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeNetworkAttachmentsAggregatedList{..}
          = go project xgafv accessToken callback filter includeAllScopes
