                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] NetworkAttachment Core.:>
...
newComputeNetworkAttachmentsPatch 
    ...
    -> ComputeNetworkAttachmentsPatch
newComputeNetworkAttachmentsPatch networkAttachment payload project
  region
  = ComputeNetworkAttachmentsPatch{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   networkAttachment = networkAttachment, payload = payload,
...
instance Core.GoogleRequest ComputeNetworkAttachmentsPatch where
        ...
        requestClient ComputeNetworkAttachmentsPatch{..}
          = go project region networkAttachment xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
