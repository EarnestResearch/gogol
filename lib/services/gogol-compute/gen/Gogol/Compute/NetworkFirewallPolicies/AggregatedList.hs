                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] NetworkFirewallPolicyAggregatedList
...
newComputeNetworkFirewallPoliciesAggregatedList project
  = ComputeNetworkFirewallPoliciesAggregatedList{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing, filter = Core.Nothing,
                                                 includeAllScopes = Core.Nothing, maxResults = 500,
...
instance Core.GoogleRequest
           ComputeNetworkFirewallPoliciesAggregatedList
         where
        type Rs ComputeNetworkFirewallPoliciesAggregatedList =
             NetworkFirewallPolicyAggregatedList
        type Scopes ComputeNetworkFirewallPoliciesAggregatedList =
