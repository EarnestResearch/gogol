...
newComputeNetworkFirewallPoliciesAddPacketMirroringRule
  ...
  = ComputeNetworkFirewallPoliciesAddPacketMirroringRule{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkFirewallPoliciesAddPacketMirroringRule
         where
        type Rs ComputeNetworkFirewallPoliciesAddPacketMirroringRule =
             Operation
        type Scopes ComputeNetworkFirewallPoliciesAddPacketMirroringRule =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient
          ComputeNetworkFirewallPoliciesAddPacketMirroringRule{..}
          = go project firewallPolicy xgafv accessToken callback maxPriority
              minPriority
              requestId
              uploadType
              uploadProtocol
