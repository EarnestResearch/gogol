...
newComputeNetworkFirewallPoliciesAddRule 
    ...
    -> ComputeNetworkFirewallPoliciesAddRule
newComputeNetworkFirewallPoliciesAddRule firewallPolicy payload
  project
  = ComputeNetworkFirewallPoliciesAddRule{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeNetworkFirewallPoliciesAddRule
         where
        type Rs ComputeNetworkFirewallPoliciesAddRule = Operation
        type Scopes ComputeNetworkFirewallPoliciesAddRule =
