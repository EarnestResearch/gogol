                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] FirewallPolicy Core.:>
...
newComputeNetworkFirewallPoliciesPatch 
    ...
    -> ComputeNetworkFirewallPoliciesPatch
newComputeNetworkFirewallPoliciesPatch firewallPolicy payload
  project
  = ComputeNetworkFirewallPoliciesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeNetworkFirewallPoliciesPatch
         where
        type Rs ComputeNetworkFirewallPoliciesPatch = Operation
        type Scopes ComputeNetworkFirewallPoliciesPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeNetworkFirewallPoliciesPatch{..}
          = go project firewallPolicy xgafv accessToken callback requestId
              uploadType
              uploadProtocol
