...
newComputeNetworkFirewallPoliciesPatchPacketMirroringRule 
    ...
    -> ComputeNetworkFirewallPoliciesPatchPacketMirroringRule
newComputeNetworkFirewallPoliciesPatchPacketMirroringRule
  firewallPolicy payload project
  = ComputeNetworkFirewallPoliciesPatchPacketMirroringRule{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkFirewallPoliciesPatchPacketMirroringRule
         where
        type Rs ComputeNetworkFirewallPoliciesPatchPacketMirroringRule =
             Operation
        type Scopes ComputeNetworkFirewallPoliciesPatchPacketMirroringRule
