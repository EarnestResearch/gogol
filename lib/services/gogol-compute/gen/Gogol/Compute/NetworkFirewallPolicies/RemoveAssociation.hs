...
newComputeNetworkFirewallPoliciesRemoveAssociation 
    ...
    -> ComputeNetworkFirewallPoliciesRemoveAssociation
newComputeNetworkFirewallPoliciesRemoveAssociation firewallPolicy
  project
  = ComputeNetworkFirewallPoliciesRemoveAssociation{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeNetworkFirewallPoliciesRemoveAssociation =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeNetworkFirewallPoliciesRemoveAssociation{..}
          = go project firewallPolicy xgafv accessToken callback name
              requestId
              uploadType
              uploadProtocol
