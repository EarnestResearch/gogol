                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] FirewallPolicyRule Core.:>
...
newComputeNetworkFirewallPoliciesPatchRule 
    ...
    -> ComputeNetworkFirewallPoliciesPatchRule
newComputeNetworkFirewallPoliciesPatchRule firewallPolicy payload
  project
  = ComputeNetworkFirewallPoliciesPatchRule{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            firewallPolicy = firewallPolicy, payload = payload,
                                            priority = Core.Nothing, project = project,
                                            requestId = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeNetworkFirewallPoliciesPatchRule
         where
        type Rs ComputeNetworkFirewallPoliciesPatchRule = Operation
        type Scopes ComputeNetworkFirewallPoliciesPatchRule =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeNetworkFirewallPoliciesPatchRule{..}
          = go project firewallPolicy xgafv accessToken callback priority
              requestId
              uploadType
              uploadProtocol
