...
newComputeNetworkFirewallPoliciesList project
  = ComputeNetworkFirewallPoliciesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeNetworkFirewallPoliciesList
         where
        type Rs ComputeNetworkFirewallPoliciesList = FirewallPolicyList
        type Scopes ComputeNetworkFirewallPoliciesList =
