             ...
             "global" Core.:>
               "firewallPolicies" Core.:>
                 Core.Capture "firewallPolicy" Core.Text Core.:>
                   "removePacketMirroringRule" Core.:>
...
newComputeNetworkFirewallPoliciesRemovePacketMirroringRule
  ...
  = ComputeNetworkFirewallPoliciesRemovePacketMirroringRule{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkFirewallPoliciesRemovePacketMirroringRule
         where
        type Rs ComputeNetworkFirewallPoliciesRemovePacketMirroringRule =
             Operation
        type Scopes ComputeNetworkFirewallPoliciesRemovePacketMirroringRule
