...
newComputeNetworkFirewallPoliciesDelete firewallPolicy project
  = ComputeNetworkFirewallPoliciesDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         firewallPolicy = firewallPolicy, project = project,
                                         requestId = Core.Nothing, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeNetworkFirewallPoliciesDelete
         where
        type Rs ComputeNetworkFirewallPoliciesDelete = Operation
        type Scopes ComputeNetworkFirewallPoliciesDelete =
