...
newComputeNetworkFirewallPoliciesAddAssociation 
    ...
    -> ComputeNetworkFirewallPoliciesAddAssociation
newComputeNetworkFirewallPoliciesAddAssociation firewallPolicy
  payload project
  = ComputeNetworkFirewallPoliciesAddAssociation{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeNetworkFirewallPoliciesAddAssociation =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeNetworkFirewallPoliciesAddAssociation{..}
          = go project firewallPolicy xgafv accessToken callback
