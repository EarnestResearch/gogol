                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] BackendBucketList
...
instance Core.GoogleRequest ComputeBackendBucketsList
         where
        type Rs ComputeBackendBucketsList = BackendBucketList
        type Scopes ComputeBackendBucketsList =
        ...
        requestClient ComputeBackendBucketsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeBackendBucketsListResource)
                      Core.mempty
