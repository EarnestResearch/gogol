...
newComputeBackendBucketsAddSignedUrlKey 
    ...
    -> ComputeBackendBucketsAddSignedUrlKey
newComputeBackendBucketsAddSignedUrlKey backendBucket payload
  project
  = ComputeBackendBucketsAddSignedUrlKey{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, backendBucket = backendBucket,
...
instance Core.GoogleRequest ComputeBackendBucketsAddSignedUrlKey
         where
        type Rs ComputeBackendBucketsAddSignedUrlKey = Operation
        type Scopes ComputeBackendBucketsAddSignedUrlKey =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeBackendBucketsAddSignedUrlKey{..}
          = go project backendBucket xgafv accessToken callback requestId
              uploadType
              uploadProtocol
