             ...
             "global" Core.:>
               "backendBuckets" Core.:>
                 Core.Capture "backendBucket" Core.Text Core.:>
                   "deleteSignedUrlKey" Core.:>
                     Core.QueryParam "keyName" Core.Text Core.:>
...
newComputeBackendBucketsDeleteSignedUrlKey 
    ...
    -> ComputeBackendBucketsDeleteSignedUrlKey
newComputeBackendBucketsDeleteSignedUrlKey backendBucket keyName
  project
  = ComputeBackendBucketsDeleteSignedUrlKey{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing,
                                            backendBucket = backendBucket, callback = Core.Nothing,
                                            keyName = keyName, project = project,
                                            requestId = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeBackendBucketsDeleteSignedUrlKey
         where
        type Rs ComputeBackendBucketsDeleteSignedUrlKey = Operation
        type Scopes ComputeBackendBucketsDeleteSignedUrlKey =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeBackendBucketsDeleteSignedUrlKey{..}
          = go project backendBucket (Core.Just keyName) xgafv accessToken
              callback
              requestId
              uploadType
              uploadProtocol
