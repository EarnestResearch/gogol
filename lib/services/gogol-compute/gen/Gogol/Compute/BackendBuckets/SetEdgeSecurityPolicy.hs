...
newComputeBackendBucketsSetEdgeSecurityPolicy 
    ...
    -> ComputeBackendBucketsSetEdgeSecurityPolicy
newComputeBackendBucketsSetEdgeSecurityPolicy backendBucket payload
  project
  = ComputeBackendBucketsSetEdgeSecurityPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeBackendBucketsSetEdgeSecurityPolicy =
