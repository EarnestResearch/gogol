                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] BackendServiceAggregatedList
...
newComputeBackendServicesAggregatedList project
  = ComputeBackendServicesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeBackendServicesAggregatedList
         where
        type Rs ComputeBackendServicesAggregatedList =
             BackendServiceAggregatedList
        type Scopes ComputeBackendServicesAggregatedList =
