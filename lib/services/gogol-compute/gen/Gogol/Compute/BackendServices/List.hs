                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] BackendServiceList
...
instance Core.GoogleRequest
           ComputeBackendServicesList
         where
        type Rs ComputeBackendServicesList =
             BackendServiceList
        type Scopes ComputeBackendServicesList =
        ...
        requestClient ComputeBackendServicesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeBackendServicesListResource)
                      Core.mempty
