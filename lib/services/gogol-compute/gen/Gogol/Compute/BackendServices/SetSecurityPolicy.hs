...
newComputeBackendServicesSetSecurityPolicy 
    ...
    -> ComputeBackendServicesSetSecurityPolicy
newComputeBackendServicesSetSecurityPolicy backendService payload
  project
  = ComputeBackendServicesSetSecurityPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeBackendServicesSetSecurityPolicy
         where
