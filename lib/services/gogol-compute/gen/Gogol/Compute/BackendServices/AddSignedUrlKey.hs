                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] SignedUrlKey Core.:>
...
newComputeBackendServicesAddSignedUrlKey 
    ...
    -> ComputeBackendServicesAddSignedUrlKey
newComputeBackendServicesAddSignedUrlKey backendService payload
  project
  = ComputeBackendServicesAddSignedUrlKey{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing,
                                          backendService = backendService, callback = Core.Nothing,
                                          payload = payload, project = project,
                                          requestId = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeBackendServicesAddSignedUrlKey
         where
        type Rs ComputeBackendServicesAddSignedUrlKey = Operation
        type Scopes ComputeBackendServicesAddSignedUrlKey =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeBackendServicesAddSignedUrlKey{..}
          = go project backendService xgafv accessToken callback requestId
              uploadType
              uploadProtocol
