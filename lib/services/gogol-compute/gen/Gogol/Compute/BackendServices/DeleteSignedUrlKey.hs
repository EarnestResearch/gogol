...
newComputeBackendServicesDeleteSignedUrlKey 
    ...
    -> ComputeBackendServicesDeleteSignedUrlKey
newComputeBackendServicesDeleteSignedUrlKey backendService keyName
  project
  = ComputeBackendServicesDeleteSignedUrlKey{xgafv = Core.Nothing,
                                             accessToken = Core.Nothing,
                                             backendService = backendService,
                                             callback = Core.Nothing, keyName = keyName,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeBackendServicesDeleteSignedUrlKey =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeBackendServicesDeleteSignedUrlKey{..}
          = go project backendService (Core.Just keyName) xgafv accessToken
              callback
              requestId
              uploadType
              uploadProtocol
