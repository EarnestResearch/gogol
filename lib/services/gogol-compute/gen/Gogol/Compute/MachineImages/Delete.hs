       ...
       "v1" Core.:>
         "projects" Core.:>
           Core.Capture "project" Core.Text Core.:>
             "global" Core.:>
               "machineImages" Core.:>
                 Core.Capture "machineImage" Core.Text Core.:>
...
newComputeMachineImagesDelete machineImage project
  = ComputeMachineImagesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeMachineImagesDelete where
        ...
        type Scopes ComputeMachineImagesDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeMachineImagesDelete{..}
          = go project machineImage xgafv accessToken callback requestId
              uploadType
              uploadProtocol
