                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] MachineImageList
...
instance Core.GoogleRequest ComputeMachineImagesList
         where
        type Rs ComputeMachineImagesList = MachineImageList
        type Scopes ComputeMachineImagesList =
        ...
        requestClient ComputeMachineImagesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeMachineImagesListResource)
                      Core.mempty
