...
newComputeMachineImagesInsert payload project
  = ComputeMachineImagesInsert{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               payload = payload, project = project, requestId = Core.Nothing,
                               sourceInstance = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ComputeMachineImagesInsert where
        ...
        requestClient ComputeMachineImagesInsert{..}
          = go project xgafv accessToken callback requestId sourceInstance
              uploadType
              uploadProtocol
