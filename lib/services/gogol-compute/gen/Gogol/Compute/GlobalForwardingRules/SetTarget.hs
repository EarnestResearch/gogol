...
newComputeGlobalForwardingRulesSetTarget 
    ...
    -> ComputeGlobalForwardingRulesSetTarget
newComputeGlobalForwardingRulesSetTarget forwardingRule payload
  project
  = ComputeGlobalForwardingRulesSetTarget{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeGlobalForwardingRulesSetTarget
         where
        ...
        requestClient ComputeGlobalForwardingRulesSetTarget{..}
          = go project forwardingRule xgafv accessToken callback requestId
              uploadType
              uploadProtocol
