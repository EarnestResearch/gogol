...
newComputeGlobalForwardingRulesInsert payload project
  = ComputeGlobalForwardingRulesInsert{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, project = project,
                                       requestId = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeGlobalForwardingRulesInsert
         where
        type Rs ComputeGlobalForwardingRulesInsert = Operation
        type Scopes ComputeGlobalForwardingRulesInsert =
