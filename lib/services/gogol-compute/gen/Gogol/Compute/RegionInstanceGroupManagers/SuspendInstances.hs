...
newComputeRegionInstanceGroupManagersSuspendInstances
  ...
  = ComputeRegionInstanceGroupManagersSuspendInstances{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupManagersSuspendInstances
         where
        type Rs ComputeRegionInstanceGroupManagersSuspendInstances =
             Operation
        type Scopes ComputeRegionInstanceGroupManagersSuspendInstances =
