...
newComputeRegionInstanceGroupManagersSetInstanceTemplate 
    ...
    -> ComputeRegionInstanceGroupManagersSetInstanceTemplate
newComputeRegionInstanceGroupManagersSetInstanceTemplate
  instanceGroupManager payload project region
  = ComputeRegionInstanceGroupManagersSetInstanceTemplate{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupManagersSetInstanceTemplate
         where
        type Rs ComputeRegionInstanceGroupManagersSetInstanceTemplate =
             Operation
        type Scopes ComputeRegionInstanceGroupManagersSetInstanceTemplate =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient
          ComputeRegionInstanceGroupManagersSetInstanceTemplate{..}
          = go project region instanceGroupManager xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
