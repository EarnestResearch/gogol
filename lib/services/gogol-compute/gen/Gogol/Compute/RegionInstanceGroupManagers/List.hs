                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] RegionInstanceGroupManagerList
...
newComputeRegionInstanceGroupManagersList project region
  = ComputeRegionInstanceGroupManagersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionInstanceGroupManagersList
         where
        type Rs ComputeRegionInstanceGroupManagersList =
             RegionInstanceGroupManagerList
        type Scopes ComputeRegionInstanceGroupManagersList =
