...
newComputeRegionInstanceGroupManagersResize 
    ...
    -> ComputeRegionInstanceGroupManagersResize
newComputeRegionInstanceGroupManagersResize instanceGroupManager
  project region size
  = ComputeRegionInstanceGroupManagersResize{xgafv = Core.Nothing,
                                             accessToken = Core.Nothing, callback = Core.Nothing,
                                             instanceGroupManager = instanceGroupManager,
                                             project = project, region = region,
                                             requestId = Core.Nothing, size = size,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionInstanceGroupManagersResize =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionInstanceGroupManagersResize{..}
          = go project region instanceGroupManager (Core.Just size) xgafv
              accessToken
              callback
              requestId
              uploadType
