...
newComputeRegionInstanceGroupManagersSetTargetPools
  ...
  = ComputeRegionInstanceGroupManagersSetTargetPools{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupManagersSetTargetPools
         where
        type Rs ComputeRegionInstanceGroupManagersSetTargetPools =
             Operation
        type Scopes ComputeRegionInstanceGroupManagersSetTargetPools =
