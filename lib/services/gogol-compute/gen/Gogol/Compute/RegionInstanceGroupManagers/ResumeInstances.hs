...
newComputeRegionInstanceGroupManagersResumeInstances
  ...
  = ComputeRegionInstanceGroupManagersResumeInstances{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupManagersResumeInstances
         where
        type Rs ComputeRegionInstanceGroupManagersResumeInstances =
             Operation
        type Scopes ComputeRegionInstanceGroupManagersResumeInstances =
