...
newComputeRegionInstanceGroupManagersAbandonInstances
  ...
  = ComputeRegionInstanceGroupManagersAbandonInstances{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupManagersAbandonInstances
         where
        type Rs ComputeRegionInstanceGroupManagersAbandonInstances =
             Operation
        type Scopes ComputeRegionInstanceGroupManagersAbandonInstances =
