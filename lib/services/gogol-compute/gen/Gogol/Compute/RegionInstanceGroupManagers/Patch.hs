                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] InstanceGroupManager Core.:>
...
newComputeRegionInstanceGroupManagersPatch 
    ...
    -> ComputeRegionInstanceGroupManagersPatch
newComputeRegionInstanceGroupManagersPatch instanceGroupManager
  payload project region
  = ComputeRegionInstanceGroupManagersPatch{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            instanceGroupManager = instanceGroupManager,
                                            payload = payload, project = project, region = region,
                                            requestId = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionInstanceGroupManagersPatch
         where
