...
newComputeRegionInstanceGroupManagersCreateInstances
  ...
  = ComputeRegionInstanceGroupManagersCreateInstances{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupManagersCreateInstances
         where
        type Rs ComputeRegionInstanceGroupManagersCreateInstances =
             Operation
        type Scopes ComputeRegionInstanceGroupManagersCreateInstances =
