...
newComputeRegionInstanceGroupManagersListManagedInstances
  ...
  = ComputeRegionInstanceGroupManagersListManagedInstances{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupManagersListManagedInstances
         where
        type Rs ComputeRegionInstanceGroupManagersListManagedInstances =
             RegionInstanceGroupManagersListInstancesResponse
        type Scopes ComputeRegionInstanceGroupManagersListManagedInstances
             =
