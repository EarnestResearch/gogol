...
newComputeRegionInstanceGroupManagersListErrors
  ...
  = ComputeRegionInstanceGroupManagersListErrors{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupManagersListErrors
         where
        type Rs ComputeRegionInstanceGroupManagersListErrors =
             RegionInstanceGroupManagersListErrorsResponse
        type Scopes ComputeRegionInstanceGroupManagersListErrors =
