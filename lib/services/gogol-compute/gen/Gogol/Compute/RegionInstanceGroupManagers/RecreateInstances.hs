...
newComputeRegionInstanceGroupManagersRecreateInstances
  ...
  = ComputeRegionInstanceGroupManagersRecreateInstances{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupManagersRecreateInstances
         where
        type Rs ComputeRegionInstanceGroupManagersRecreateInstances =
             Operation
        type Scopes ComputeRegionInstanceGroupManagersRecreateInstances =
