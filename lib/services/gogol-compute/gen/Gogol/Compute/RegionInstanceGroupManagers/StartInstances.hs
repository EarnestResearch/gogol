...
newComputeRegionInstanceGroupManagersStartInstances
  ...
  = ComputeRegionInstanceGroupManagersStartInstances{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupManagersStartInstances
         where
        type Rs ComputeRegionInstanceGroupManagersStartInstances =
             Operation
        type Scopes ComputeRegionInstanceGroupManagersStartInstances =
