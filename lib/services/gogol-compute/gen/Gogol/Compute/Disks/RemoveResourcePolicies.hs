                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] DisksRemoveResourcePoliciesRequest
...
newComputeDisksRemoveResourcePolicies disk payload project zone
  = ComputeDisksRemoveResourcePolicies{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeDisksRemoveResourcePolicies
         where
