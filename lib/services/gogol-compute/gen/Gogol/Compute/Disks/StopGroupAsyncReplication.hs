...
newComputeDisksStopGroupAsyncReplication payload project zone
  = ComputeDisksStopGroupAsyncReplication{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeDisksStopGroupAsyncReplication
         where
        type Rs ComputeDisksStopGroupAsyncReplication = Operation
        type Scopes ComputeDisksStopGroupAsyncReplication =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeDisksStopGroupAsyncReplication{..}
          = go project zone xgafv accessToken callback requestId uploadType
              uploadProtocol
