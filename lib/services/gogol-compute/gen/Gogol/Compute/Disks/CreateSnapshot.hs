                       ...
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "guestFlush" Core.Bool Core.:>
                               Core.QueryParam "requestId" Core.Text Core.:>
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] Snapshot Core.:>
...
newComputeDisksCreateSnapshot disk payload project zone
  = ComputeDisksCreateSnapshot{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing, disk = disk,
                               guestFlush = Core.Nothing, payload = payload, project = project,
...
instance Core.GoogleRequest ComputeDisksCreateSnapshot where
        ...
        requestClient ComputeDisksCreateSnapshot{..}
          = go project zone disk xgafv accessToken callback guestFlush
              requestId
              uploadType
              uploadProtocol
