                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] DisksStartAsyncReplicationRequest
...
newComputeDisksStartAsyncReplication disk payload project zone
  = ComputeDisksStartAsyncReplication{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeDisksStartAsyncReplication where
        ...
        type Scopes ComputeDisksStartAsyncReplication =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeDisksStartAsyncReplication{..}
          = go project zone disk xgafv accessToken callback requestId
              uploadType
              uploadProtocol
