...
newComputeDisksInsert payload project zone
  = ComputeDisksInsert{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, callback = Core.Nothing,
                       payload = payload, project = project, requestId = Core.Nothing,
                       sourceImage = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ComputeDisksInsert where
        ...
        type Scopes ComputeDisksInsert =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeDisksInsert{..}
          = go project zone xgafv accessToken callback requestId sourceImage
              uploadType
              uploadProtocol
