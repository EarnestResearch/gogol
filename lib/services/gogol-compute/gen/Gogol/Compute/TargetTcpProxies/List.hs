                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] TargetTcpProxyList
...
instance Core.GoogleRequest
           ComputeTargetTcpProxiesList
         where
        type Rs ComputeTargetTcpProxiesList =
             TargetTcpProxyList
        type Scopes ComputeTargetTcpProxiesList =
        ...
        requestClient ComputeTargetTcpProxiesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeTargetTcpProxiesListResource)
                      Core.mempty
