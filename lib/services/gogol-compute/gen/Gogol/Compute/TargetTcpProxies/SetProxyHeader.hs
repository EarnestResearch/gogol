                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] TargetTcpProxiesSetProxyHeaderRequest
...
newComputeTargetTcpProxiesSetProxyHeader 
    ...
    -> ComputeTargetTcpProxiesSetProxyHeader
newComputeTargetTcpProxiesSetProxyHeader payload project
  targetTcpProxy
  = ComputeTargetTcpProxiesSetProxyHeader{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, project = project,
                                          requestId = Core.Nothing, targetTcpProxy = targetTcpProxy,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeTargetTcpProxiesSetProxyHeader
         where
        type Rs ComputeTargetTcpProxiesSetProxyHeader = Operation
        type Scopes ComputeTargetTcpProxiesSetProxyHeader =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeTargetTcpProxiesSetProxyHeader{..}
          = go project targetTcpProxy xgafv accessToken callback requestId
              uploadType
              uploadProtocol
