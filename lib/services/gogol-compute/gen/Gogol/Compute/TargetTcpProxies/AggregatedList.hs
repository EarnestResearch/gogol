                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] TargetTcpProxyAggregatedList
...
newComputeTargetTcpProxiesAggregatedList project
  = ComputeTargetTcpProxiesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetTcpProxiesAggregatedList
         where
        type Rs ComputeTargetTcpProxiesAggregatedList =
             TargetTcpProxyAggregatedList
        type Scopes ComputeTargetTcpProxiesAggregatedList =
