                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] InstantSnapshotAggregatedList
...
newComputeInstantSnapshotsAggregatedList project
  = ComputeInstantSnapshotsAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstantSnapshotsAggregatedList
         where
        type Rs ComputeInstantSnapshotsAggregatedList =
             InstantSnapshotAggregatedList
        type Scopes ComputeInstantSnapshotsAggregatedList =
