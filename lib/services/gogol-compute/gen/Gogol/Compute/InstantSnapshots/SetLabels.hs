                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] ZoneSetLabelsRequest Core.:>
...
newComputeInstantSnapshotsSetLabels payload project resource zone
  = ComputeInstantSnapshotsSetLabels{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstantSnapshotsSetLabels where
        ...
        type Scopes ComputeInstantSnapshotsSetLabels =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInstantSnapshotsSetLabels{..}
          = go project zone resource xgafv accessToken callback requestId
              uploadType
              uploadProtocol
