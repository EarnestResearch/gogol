                                   ...
                                   Core.QueryParam "uploadType" Core.Text
                                     ...
                                     Core.QueryParam "upload_protocol" Core.Text
                                       ...
                                       Core.QueryParam "alt" Core.AltJSON
                                         Core.:>
                                         Core.Get '[Core.JSON] NodeTypeList
...
instance Core.GoogleRequest ComputeNodeTypesList
         where
        type Rs ComputeNodeTypesList = NodeTypeList
        type Scopes ComputeNodeTypesList =
        ...
        requestClient ComputeNodeTypesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeNodeTypesListResource)
                      Core.mempty
