                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] Interconnect Core.:>
...
newComputeInterconnectsPatch interconnect payload project
  = ComputeInterconnectsPatch{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              interconnect = interconnect, payload = payload, project = project,
...
instance Core.GoogleRequest ComputeInterconnectsPatch where
        ...
        type Scopes ComputeInterconnectsPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInterconnectsPatch{..}
          = go project interconnect xgafv accessToken callback requestId
              uploadType
              uploadProtocol
