                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] InterconnectsGetDiagnosticsResponse
...
newComputeInterconnectsGetDiagnostics interconnect project
  = ComputeInterconnectsGetDiagnostics{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       interconnect = interconnect, project = project,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeInterconnectsGetDiagnostics
         where
        type Rs ComputeInterconnectsGetDiagnostics =
             InterconnectsGetDiagnosticsResponse
        type Scopes ComputeInterconnectsGetDiagnostics =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeInterconnectsGetDiagnostics{..}
          = go project interconnect xgafv accessToken callback uploadType
              uploadProtocol
