                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] HealthCheckList
...
instance Core.GoogleRequest ComputeHealthChecksList
         where
        type Rs ComputeHealthChecksList = HealthCheckList
        type Scopes ComputeHealthChecksList =
        ...
        requestClient ComputeHealthChecksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeHealthChecksListResource)
                      Core.mempty
