...
newComputeHealthChecksDelete healthCheck project
  = ComputeHealthChecksDelete{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              healthCheck = healthCheck, project = project,
...
instance Core.GoogleRequest ComputeHealthChecksDelete where
        ...
        type Scopes ComputeHealthChecksDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeHealthChecksDelete{..}
          = go project healthCheck xgafv accessToken callback requestId
              uploadType
              uploadProtocol
