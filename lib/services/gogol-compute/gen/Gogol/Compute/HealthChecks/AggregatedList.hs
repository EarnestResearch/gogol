                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] HealthChecksAggregatedList
...
newComputeHealthChecksAggregatedList project
  = ComputeHealthChecksAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeHealthChecksAggregatedList where
        type Rs ComputeHealthChecksAggregatedList =
             HealthChecksAggregatedList
        type Scopes ComputeHealthChecksAggregatedList =
