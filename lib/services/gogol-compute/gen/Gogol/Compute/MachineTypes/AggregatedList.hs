                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] MachineTypeAggregatedList
...
newComputeMachineTypesAggregatedList project
  = ComputeMachineTypesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeMachineTypesAggregatedList where
        type Rs ComputeMachineTypesAggregatedList =
             MachineTypeAggregatedList
        type Scopes ComputeMachineTypesAggregatedList =
