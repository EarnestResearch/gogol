                                   ...
                                   Core.QueryParam "uploadType" Core.Text
                                     ...
                                     Core.QueryParam "upload_protocol" Core.Text
                                       ...
                                       Core.QueryParam "alt" Core.AltJSON
                                         Core.:>
                                         Core.Get '[Core.JSON] MachineTypeList
...
instance Core.GoogleRequest ComputeMachineTypesList
         where
        type Rs ComputeMachineTypesList = MachineTypeList
        type Scopes ComputeMachineTypesList =
        ...
        requestClient ComputeMachineTypesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeMachineTypesListResource)
                      Core.mempty
