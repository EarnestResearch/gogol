                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] HttpsHealthCheck Core.:>
...
newComputeHttpsHealthChecksUpdate httpsHealthCheck payload project
  = ComputeHttpsHealthChecksUpdate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   httpsHealthCheck = httpsHealthCheck, payload = payload,
...
instance Core.GoogleRequest ComputeHttpsHealthChecksUpdate where
        ...
        type Scopes ComputeHttpsHealthChecksUpdate =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeHttpsHealthChecksUpdate{..}
          = go project httpsHealthCheck xgafv accessToken callback requestId
              uploadType
              uploadProtocol
