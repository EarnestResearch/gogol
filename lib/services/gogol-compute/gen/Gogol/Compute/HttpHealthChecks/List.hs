                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] HttpHealthCheckList
...
instance Core.GoogleRequest
           ComputeHttpHealthChecksList
         where
        type Rs ComputeHttpHealthChecksList =
             HttpHealthCheckList
        type Scopes ComputeHttpHealthChecksList =
        ...
        requestClient ComputeHttpHealthChecksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeHttpHealthChecksListResource)
                      Core.mempty
