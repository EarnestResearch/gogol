...
newComputeHttpHealthChecksUpdate httpHealthCheck payload project
  = ComputeHttpHealthChecksUpdate{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  httpHealthCheck = httpHealthCheck, payload = payload,
...
instance Core.GoogleRequest ComputeHttpHealthChecksUpdate where
        ...
        type Scopes ComputeHttpHealthChecksUpdate =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeHttpHealthChecksUpdate{..}
          = go project httpHealthCheck xgafv accessToken callback requestId
              uploadType
              uploadProtocol
