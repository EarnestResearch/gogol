           ...
           Core.Capture "project" Core.Text Core.:>
             "regions" Core.:>
               Core.Capture "region" Core.Text Core.:>
                 "autoscalers" Core.:>
                   Core.Capture "autoscaler" Core.Text Core.:>
...
newComputeRegionAutoscalersDelete autoscaler project region
  = ComputeRegionAutoscalersDelete{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, autoscaler = autoscaler,
...
instance Core.GoogleRequest ComputeRegionAutoscalersDelete where
        ...
        type Scopes ComputeRegionAutoscalersDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionAutoscalersDelete{..}
          = go project region autoscaler xgafv accessToken callback requestId
              uploadType
              uploadProtocol
