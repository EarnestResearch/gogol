...
newComputeRegionAutoscalersUpdate payload project region
  = ComputeRegionAutoscalersUpdate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, autoscaler = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionAutoscalersUpdate where
        ...
        type Scopes ComputeRegionAutoscalersUpdate =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionAutoscalersUpdate{..}
          = go project region xgafv accessToken autoscaler callback requestId
              uploadType
              uploadProtocol
