                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] StoragePoolTypeAggregatedList
...
newComputeStoragePoolTypesAggregatedList project
  = ComputeStoragePoolTypesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeStoragePoolTypesAggregatedList
         where
        type Rs ComputeStoragePoolTypesAggregatedList =
             StoragePoolTypeAggregatedList
        type Scopes ComputeStoragePoolTypesAggregatedList =
