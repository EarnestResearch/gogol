                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] TargetHttpProxyList
...
instance Core.GoogleRequest
           ComputeTargetHttpProxiesList
         where
        type Rs ComputeTargetHttpProxiesList =
             TargetHttpProxyList
        type Scopes ComputeTargetHttpProxiesList =
        ...
        requestClient ComputeTargetHttpProxiesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeTargetHttpProxiesListResource)
                      Core.mempty
