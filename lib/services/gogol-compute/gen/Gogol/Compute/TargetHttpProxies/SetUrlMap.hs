...
newComputeTargetHttpProxiesSetUrlMap 
    ...
    -> ComputeTargetHttpProxiesSetUrlMap
newComputeTargetHttpProxiesSetUrlMap payload project
  targetHttpProxy
  = ComputeTargetHttpProxiesSetUrlMap{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      payload = payload, project = project,
                                      requestId = Core.Nothing, targetHttpProxy = targetHttpProxy,
...
instance Core.GoogleRequest ComputeTargetHttpProxiesSetUrlMap where
        ...
        type Scopes ComputeTargetHttpProxiesSetUrlMap =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeTargetHttpProxiesSetUrlMap{..}
          = go project targetHttpProxy xgafv accessToken callback requestId
              uploadType
              uploadProtocol
