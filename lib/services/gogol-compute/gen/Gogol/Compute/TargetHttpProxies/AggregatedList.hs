                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] TargetHttpProxyAggregatedList
...
newComputeTargetHttpProxiesAggregatedList project
  = ComputeTargetHttpProxiesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetHttpProxiesAggregatedList
         where
        type Rs ComputeTargetHttpProxiesAggregatedList =
             TargetHttpProxyAggregatedList
        type Scopes ComputeTargetHttpProxiesAggregatedList =
