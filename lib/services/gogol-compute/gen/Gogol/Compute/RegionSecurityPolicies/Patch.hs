...
newComputeRegionSecurityPoliciesPatch 
    ...
    -> ComputeRegionSecurityPoliciesPatch
newComputeRegionSecurityPoliciesPatch payload project region
  securityPolicy
  = ComputeRegionSecurityPoliciesPatch{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, project = project, region = region,
                                       requestId = Core.Nothing, securityPolicy = securityPolicy,
                                       updateMask = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionSecurityPoliciesPatch
         where
        type Rs ComputeRegionSecurityPoliciesPatch = Operation
        type Scopes ComputeRegionSecurityPoliciesPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionSecurityPoliciesPatch{..}
          = go project region securityPolicy xgafv accessToken callback
              requestId
              updateMask
              uploadType
              uploadProtocol
