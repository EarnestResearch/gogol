...
newComputeRegionSecurityPoliciesInsert payload project region
  = ComputeRegionSecurityPoliciesInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionSecurityPoliciesInsert
         where
        type Rs ComputeRegionSecurityPoliciesInsert = Operation
        type Scopes ComputeRegionSecurityPoliciesInsert =
