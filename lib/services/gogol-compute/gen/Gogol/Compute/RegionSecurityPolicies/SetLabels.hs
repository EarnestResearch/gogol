...
newComputeRegionSecurityPoliciesSetLabels 
    ...
    -> ComputeRegionSecurityPoliciesSetLabels
newComputeRegionSecurityPoliciesSetLabels payload project region
  resource
  = ComputeRegionSecurityPoliciesSetLabels{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionSecurityPoliciesSetLabels
         where
        type Rs ComputeRegionSecurityPoliciesSetLabels = Operation
        type Scopes ComputeRegionSecurityPoliciesSetLabels =
