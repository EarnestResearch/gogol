...
newComputeRegionSecurityPoliciesDelete 
    ...
    -> ComputeRegionSecurityPoliciesDelete
newComputeRegionSecurityPoliciesDelete project region
  securityPolicy
  = ComputeRegionSecurityPoliciesDelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        project = project, region = region,
                                        requestId = Core.Nothing, securityPolicy = securityPolicy,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionSecurityPoliciesDelete
         where
        type Rs ComputeRegionSecurityPoliciesDelete = Operation
        type Scopes ComputeRegionSecurityPoliciesDelete =
