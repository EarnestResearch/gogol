                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] TargetInstanceAggregatedList
...
newComputeTargetInstancesAggregatedList project
  = ComputeTargetInstancesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetInstancesAggregatedList
         where
        type Rs ComputeTargetInstancesAggregatedList =
             TargetInstanceAggregatedList
        type Scopes ComputeTargetInstancesAggregatedList =
