                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] FirewallList
...
instance Core.GoogleRequest ComputeFirewallsList
         where
        type Rs ComputeFirewallsList = FirewallList
        type Scopes ComputeFirewallsList =
        ...
        requestClient ComputeFirewallsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeFirewallsListResource)
                      Core.mempty
