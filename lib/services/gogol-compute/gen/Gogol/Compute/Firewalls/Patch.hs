...
newComputeFirewallsPatch firewall payload project
  = ComputeFirewallsPatch{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          firewall = firewall, payload = payload, project = project,
...
instance Core.GoogleRequest ComputeFirewallsPatch where
        ...
        type Scopes ComputeFirewallsPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeFirewallsPatch{..}
          = go project firewall xgafv accessToken callback requestId
              uploadType
              uploadProtocol
