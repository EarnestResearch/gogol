...
newComputeNodeGroupsInsert initialNodeCount payload project zone
  = ComputeNodeGroupsInsert{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing,
                            initialNodeCount = initialNodeCount, payload = payload,
...
instance Core.GoogleRequest ComputeNodeGroupsInsert where
        ...
        requestClient ComputeNodeGroupsInsert{..}
          = go project zone (Core.Just initialNodeCount) xgafv accessToken
              callback
              requestId
              uploadType
              uploadProtocol
