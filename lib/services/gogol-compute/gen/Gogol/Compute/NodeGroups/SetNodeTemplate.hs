                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] NodeGroupsSetNodeTemplateRequest
...
newComputeNodeGroupsSetNodeTemplate nodeGroup payload project zone
  = ComputeNodeGroupsSetNodeTemplate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeNodeGroupsSetNodeTemplate where
        ...
        type Scopes ComputeNodeGroupsSetNodeTemplate =
