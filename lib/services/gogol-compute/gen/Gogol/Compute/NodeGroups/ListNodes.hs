                                       ...
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Post '[Core.JSON] NodeGroupsListNodes
...
newComputeNodeGroupsListNodes nodeGroup project zone
  = ComputeNodeGroupsListNodes{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               filter = Core.Nothing, maxResults = 500, nodeGroup = nodeGroup,
...
instance Core.GoogleRequest ComputeNodeGroupsListNodes where
        ...
        type Scopes ComputeNodeGroupsListNodes =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeNodeGroupsListNodes{..}
          = go project zone nodeGroup xgafv accessToken callback filter
