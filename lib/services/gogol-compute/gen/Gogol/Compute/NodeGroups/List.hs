                                   ...
                                   Core.QueryParam "uploadType" Core.Text
                                     ...
                                     Core.QueryParam "upload_protocol" Core.Text
                                       ...
                                       Core.QueryParam "alt" Core.AltJSON
                                         Core.:>
                                         Core.Get '[Core.JSON] NodeGroupList
...
instance Core.GoogleRequest ComputeNodeGroupsList
         where
        type Rs ComputeNodeGroupsList = NodeGroupList
        type Scopes ComputeNodeGroupsList =
        ...
        requestClient ComputeNodeGroupsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeNodeGroupsListResource)
                      Core.mempty
