           ...
           Core.Capture "project" Core.Text Core.:>
             "zones" Core.:>
               Core.Capture "zone" Core.Text Core.:>
                 "nodeGroups" Core.:>
                   Core.Capture "nodeGroup" Core.Text Core.:>
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] NodeGroupsPerformMaintenanceRequest
...
newComputeNodeGroupsPerformMaintenance 
    ...
    -> ComputeNodeGroupsPerformMaintenance
newComputeNodeGroupsPerformMaintenance nodeGroup payload project
  zone
  = ComputeNodeGroupsPerformMaintenance{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        nodeGroup = nodeGroup, payload = payload, project = project,
                                        requestId = Core.Nothing, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing, zone = zone}
instance Core.GoogleRequest ComputeNodeGroupsPerformMaintenance
         where
        type Rs ComputeNodeGroupsPerformMaintenance = Operation
        type Scopes ComputeNodeGroupsPerformMaintenance =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeNodeGroupsPerformMaintenance{..}
          = go project zone nodeGroup xgafv accessToken callback requestId
              uploadType
              uploadProtocol
