...
newComputeNodeGroupsSimulateMaintenanceEvent 
    ...
    -> ComputeNodeGroupsSimulateMaintenanceEvent
newComputeNodeGroupsSimulateMaintenanceEvent nodeGroup payload
  project zone
  = ComputeNodeGroupsSimulateMaintenanceEvent{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              nodeGroup = nodeGroup, payload = payload,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeNodeGroupsSimulateMaintenanceEvent =
