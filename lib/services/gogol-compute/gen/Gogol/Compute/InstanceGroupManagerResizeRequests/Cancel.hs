...
newComputeInstanceGroupManagerResizeRequestsCancel
  ...
  = ComputeInstanceGroupManagerResizeRequestsCancel{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeInstanceGroupManagerResizeRequestsCancel =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInstanceGroupManagerResizeRequestsCancel{..}
          = go project zone instanceGroupManager resizeRequest xgafv
              accessToken
              callback
              requestId
              uploadType
