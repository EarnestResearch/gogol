                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] AcceleratorTypeAggregatedList
...
newComputeAcceleratorTypesAggregatedList project
  = ComputeAcceleratorTypesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeAcceleratorTypesAggregatedList
         where
        type Rs ComputeAcceleratorTypesAggregatedList =
             AcceleratorTypeAggregatedList
        type Scopes ComputeAcceleratorTypesAggregatedList =
