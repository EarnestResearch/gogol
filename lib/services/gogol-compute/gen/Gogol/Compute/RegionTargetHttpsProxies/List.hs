                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] TargetHttpsProxyList
...
newComputeRegionTargetHttpsProxiesList project region
  = ComputeRegionTargetHttpsProxiesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionTargetHttpsProxiesList
         where
        type Rs ComputeRegionTargetHttpsProxiesList = TargetHttpsProxyList
        type Scopes ComputeRegionTargetHttpsProxiesList =
