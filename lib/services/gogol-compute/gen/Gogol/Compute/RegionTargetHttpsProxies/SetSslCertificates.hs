...
newComputeRegionTargetHttpsProxiesSetSslCertificates 
    ...
    -> ComputeRegionTargetHttpsProxiesSetSslCertificates
newComputeRegionTargetHttpsProxiesSetSslCertificates payload
  project region targetHttpsProxy
  = ComputeRegionTargetHttpsProxiesSetSslCertificates{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionTargetHttpsProxiesSetSslCertificates
         where
        type Rs ComputeRegionTargetHttpsProxiesSetSslCertificates =
             Operation
        type Scopes ComputeRegionTargetHttpsProxiesSetSslCertificates =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionTargetHttpsProxiesSetSslCertificates{..}
          = go project region targetHttpsProxy xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
