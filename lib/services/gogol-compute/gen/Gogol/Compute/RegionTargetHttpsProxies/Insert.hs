...
newComputeRegionTargetHttpsProxiesInsert payload project region
  = ComputeRegionTargetHttpsProxiesInsert{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, project = project, region = region,
                                          requestId = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionTargetHttpsProxiesInsert
         where
        type Rs ComputeRegionTargetHttpsProxiesInsert = Operation
        type Scopes ComputeRegionTargetHttpsProxiesInsert =
