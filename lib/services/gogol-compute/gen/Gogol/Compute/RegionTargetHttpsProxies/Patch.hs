                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] TargetHttpsProxy Core.:>
...
newComputeRegionTargetHttpsProxiesPatch 
    ...
    -> ComputeRegionTargetHttpsProxiesPatch
newComputeRegionTargetHttpsProxiesPatch payload project region
  targetHttpsProxy
  = ComputeRegionTargetHttpsProxiesPatch{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         payload = payload, project = project, region = region,
                                         requestId = Core.Nothing,
                                         targetHttpsProxy = targetHttpsProxy,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionTargetHttpsProxiesPatch
         where
