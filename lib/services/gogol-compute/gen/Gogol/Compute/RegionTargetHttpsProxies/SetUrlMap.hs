...
newComputeRegionTargetHttpsProxiesSetUrlMap 
    ...
    -> ComputeRegionTargetHttpsProxiesSetUrlMap
newComputeRegionTargetHttpsProxiesSetUrlMap payload project region
  targetHttpsProxy
  = ComputeRegionTargetHttpsProxiesSetUrlMap{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionTargetHttpsProxiesSetUrlMap =
