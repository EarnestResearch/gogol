...
newComputeRegionTargetHttpsProxiesDelete 
    ...
    -> ComputeRegionTargetHttpsProxiesDelete
newComputeRegionTargetHttpsProxiesDelete project region
  targetHttpsProxy
  = ComputeRegionTargetHttpsProxiesDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          project = project, region = region,
                                          requestId = Core.Nothing,
                                          targetHttpsProxy = targetHttpsProxy,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionTargetHttpsProxiesDelete
         where
