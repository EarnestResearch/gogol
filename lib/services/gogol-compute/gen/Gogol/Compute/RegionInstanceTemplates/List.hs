                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] InstanceTemplateList
...
newComputeRegionInstanceTemplatesList project region
  = ComputeRegionInstanceTemplatesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionInstanceTemplatesList
         where
        type Rs ComputeRegionInstanceTemplatesList = InstanceTemplateList
        type Scopes ComputeRegionInstanceTemplatesList =
