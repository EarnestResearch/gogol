...
newComputeRegionInstanceTemplatesDelete 
    ...
    -> ComputeRegionInstanceTemplatesDelete
newComputeRegionInstanceTemplatesDelete instanceTemplate project
  region
  = ComputeRegionInstanceTemplatesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionInstanceTemplatesDelete
         where
        type Rs ComputeRegionInstanceTemplatesDelete = Operation
        type Scopes ComputeRegionInstanceTemplatesDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionInstanceTemplatesDelete{..}
          = go project region instanceTemplate xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
