                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] InstanceTemplate Core.:>
...
newComputeRegionInstanceTemplatesInsert payload project region
  = ComputeRegionInstanceTemplatesInsert{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         payload = payload, project = project, region = region,
                                         requestId = Core.Nothing, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionInstanceTemplatesInsert
         where
        type Rs ComputeRegionInstanceTemplatesInsert = Operation
        type Scopes ComputeRegionInstanceTemplatesInsert =
