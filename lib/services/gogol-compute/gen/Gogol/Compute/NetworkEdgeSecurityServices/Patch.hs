             ...
             "regions" Core.:>
               Core.Capture "region" Core.Text Core.:>
                 "networkEdgeSecurityServices" Core.:>
                   Core.Capture "networkEdgeSecurityService" Core.Text Core.:>
                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] NetworkEdgeSecurityService Core.:>
...
newComputeNetworkEdgeSecurityServicesPatch 
    ...
    -> ComputeNetworkEdgeSecurityServicesPatch
newComputeNetworkEdgeSecurityServicesPatch
  networkEdgeSecurityService payload project region
  = ComputeNetworkEdgeSecurityServicesPatch{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            networkEdgeSecurityService = networkEdgeSecurityService,
                                            paths = Core.Nothing, payload = payload,
                                            project = project, region = region,
                                            requestId = Core.Nothing, updateMask = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeNetworkEdgeSecurityServicesPatch
         where
        type Rs ComputeNetworkEdgeSecurityServicesPatch = Operation
        type Scopes ComputeNetworkEdgeSecurityServicesPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeNetworkEdgeSecurityServicesPatch{..}
          = go project region networkEdgeSecurityService xgafv accessToken
              callback
