...
newComputeNetworkEdgeSecurityServicesAggregatedList project
  = ComputeNetworkEdgeSecurityServicesAggregatedList{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkEdgeSecurityServicesAggregatedList
         where
        type Rs ComputeNetworkEdgeSecurityServicesAggregatedList =
             NetworkEdgeSecurityServiceAggregatedList
        type Scopes ComputeNetworkEdgeSecurityServicesAggregatedList =
