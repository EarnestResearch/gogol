...
newComputeLicensesGet license project
  = ComputeLicensesGet{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, callback = Core.Nothing,
                       license = license, project = project, uploadType = Core.Nothing,
                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeLicensesGet where
        type Rs ComputeLicensesGet = License
        type Scopes ComputeLicensesGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeLicensesGet{..}
          = go project license xgafv accessToken callback uploadType
              uploadProtocol
