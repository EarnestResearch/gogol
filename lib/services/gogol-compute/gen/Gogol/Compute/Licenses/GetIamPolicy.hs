                     ...
                     Core.QueryParam "$.xgafv" Xgafv Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "optionsRequestedPolicyVersion" Core.Int32 Core.:>
...
newComputeLicensesGetIamPolicy project resource
  = ComputeLicensesGetIamPolicy{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                optionsRequestedPolicyVersion = Core.Nothing, project = project,
...
instance Core.GoogleRequest ComputeLicensesGetIamPolicy where
        ...
        type Scopes ComputeLicensesGetIamPolicy =
