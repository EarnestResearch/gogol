                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] UrlMapReference Core.:>
...
newComputeRegionTargetHttpProxiesSetUrlMap 
    ...
    -> ComputeRegionTargetHttpProxiesSetUrlMap
newComputeRegionTargetHttpProxiesSetUrlMap payload project region
  targetHttpProxy
  = ComputeRegionTargetHttpProxiesSetUrlMap{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionTargetHttpProxiesSetUrlMap
         where
        type Rs ComputeRegionTargetHttpProxiesSetUrlMap = Operation
        type Scopes ComputeRegionTargetHttpProxiesSetUrlMap =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionTargetHttpProxiesSetUrlMap{..}
          = go project region targetHttpProxy xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
