...
newComputeRegionTargetHttpProxiesDelete 
    ...
    -> ComputeRegionTargetHttpProxiesDelete
newComputeRegionTargetHttpProxiesDelete project region
  targetHttpProxy
  = ComputeRegionTargetHttpProxiesDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         project = project, region = region,
                                         requestId = Core.Nothing,
                                         targetHttpProxy = targetHttpProxy,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionTargetHttpProxiesDelete
         where
        type Rs ComputeRegionTargetHttpProxiesDelete = Operation
        type Scopes ComputeRegionTargetHttpProxiesDelete =
