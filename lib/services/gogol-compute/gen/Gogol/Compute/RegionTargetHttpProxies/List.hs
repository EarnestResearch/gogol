...
newComputeRegionTargetHttpProxiesList project region
  = ComputeRegionTargetHttpProxiesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionTargetHttpProxiesList
         where
        type Rs ComputeRegionTargetHttpProxiesList = TargetHttpProxyList
        type Scopes ComputeRegionTargetHttpProxiesList =
