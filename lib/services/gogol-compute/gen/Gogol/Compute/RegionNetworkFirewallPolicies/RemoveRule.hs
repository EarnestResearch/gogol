...
newComputeRegionNetworkFirewallPoliciesRemoveRule 
    ...
    -> ComputeRegionNetworkFirewallPoliciesRemoveRule
newComputeRegionNetworkFirewallPoliciesRemoveRule firewallPolicy
  project region
  = ComputeRegionNetworkFirewallPoliciesRemoveRule{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNetworkFirewallPoliciesRemoveRule =
