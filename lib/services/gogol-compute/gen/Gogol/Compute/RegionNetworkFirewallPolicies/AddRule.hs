...
newComputeRegionNetworkFirewallPoliciesAddRule 
    ...
    -> ComputeRegionNetworkFirewallPoliciesAddRule
newComputeRegionNetworkFirewallPoliciesAddRule firewallPolicy
  payload project region
  = ComputeRegionNetworkFirewallPoliciesAddRule{xgafv = Core.Nothing,
                                                accessToken = Core.Nothing, callback = Core.Nothing,
                                                firewallPolicy = firewallPolicy,
                                                maxPriority = Core.Nothing,
                                                minPriority = Core.Nothing, payload = payload,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNetworkFirewallPoliciesAddRule =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionNetworkFirewallPoliciesAddRule{..}
          = go project region firewallPolicy xgafv accessToken callback
              maxPriority
              minPriority
              requestId
              uploadType
