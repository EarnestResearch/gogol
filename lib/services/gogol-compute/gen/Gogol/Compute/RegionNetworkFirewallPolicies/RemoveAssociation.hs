...
newComputeRegionNetworkFirewallPoliciesRemoveAssociation
  ...
  = ComputeRegionNetworkFirewallPoliciesRemoveAssociation{xgafv =
                                                            Core.Nothing,
                                                          accessToken = Core.Nothing,
                                                          callback = Core.Nothing,
                                                          firewallPolicy = firewallPolicy,
                                                          name = Core.Nothing, project = project,
...
instance Core.GoogleRequest
           ComputeRegionNetworkFirewallPoliciesRemoveAssociation
         where
        type Rs ComputeRegionNetworkFirewallPoliciesRemoveAssociation =
             Operation
        type Scopes ComputeRegionNetworkFirewallPoliciesRemoveAssociation =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient
          ComputeRegionNetworkFirewallPoliciesRemoveAssociation{..}
          = go project region firewallPolicy xgafv accessToken callback name
              requestId
              uploadType
              uploadProtocol
