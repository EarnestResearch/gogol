...
newComputeRegionNetworkFirewallPoliciesPatchRule 
    ...
    -> ComputeRegionNetworkFirewallPoliciesPatchRule
newComputeRegionNetworkFirewallPoliciesPatchRule firewallPolicy
  payload project region
  = ComputeRegionNetworkFirewallPoliciesPatchRule{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing,
                                                  firewallPolicy = firewallPolicy,
                                                  payload = payload, priority = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNetworkFirewallPoliciesPatchRule =
