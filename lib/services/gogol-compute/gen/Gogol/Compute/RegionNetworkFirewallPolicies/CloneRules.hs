                         ...
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "requestId" Core.Text Core.:>
                               Core.QueryParam "sourceFirewallPolicy" Core.Text Core.:>
...
newComputeRegionNetworkFirewallPoliciesCloneRules 
    ...
    -> ComputeRegionNetworkFirewallPoliciesCloneRules
newComputeRegionNetworkFirewallPoliciesCloneRules firewallPolicy
  project region
  = ComputeRegionNetworkFirewallPoliciesCloneRules{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNetworkFirewallPoliciesCloneRules =
