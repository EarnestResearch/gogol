...
newComputeRegionNetworkFirewallPoliciesDelete 
    ...
    -> ComputeRegionNetworkFirewallPoliciesDelete
newComputeRegionNetworkFirewallPoliciesDelete firewallPolicy
  project region
  = ComputeRegionNetworkFirewallPoliciesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNetworkFirewallPoliciesDelete =
