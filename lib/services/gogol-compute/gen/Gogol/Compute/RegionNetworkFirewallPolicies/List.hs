...
newComputeRegionNetworkFirewallPoliciesList project region
  = ComputeRegionNetworkFirewallPoliciesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionNetworkFirewallPoliciesList
         where
        type Rs ComputeRegionNetworkFirewallPoliciesList =
             FirewallPolicyList
        type Scopes ComputeRegionNetworkFirewallPoliciesList =
