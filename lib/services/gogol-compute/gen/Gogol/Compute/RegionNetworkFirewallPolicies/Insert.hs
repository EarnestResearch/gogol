...
newComputeRegionNetworkFirewallPoliciesInsert 
    ...
    -> ComputeRegionNetworkFirewallPoliciesInsert
newComputeRegionNetworkFirewallPoliciesInsert payload project
  region
  = ComputeRegionNetworkFirewallPoliciesInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNetworkFirewallPoliciesInsert =
