                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] FirewallPolicyAssociation Core.:>
...
newComputeRegionNetworkFirewallPoliciesAddAssociation 
    ...
    -> ComputeRegionNetworkFirewallPoliciesAddAssociation
newComputeRegionNetworkFirewallPoliciesAddAssociation
  firewallPolicy payload project region
  = ComputeRegionNetworkFirewallPoliciesAddAssociation{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionNetworkFirewallPoliciesAddAssociation
         where
        type Rs ComputeRegionNetworkFirewallPoliciesAddAssociation =
             Operation
        type Scopes ComputeRegionNetworkFirewallPoliciesAddAssociation =
