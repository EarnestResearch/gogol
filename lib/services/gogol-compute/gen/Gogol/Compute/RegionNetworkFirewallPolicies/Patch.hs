...
newComputeRegionNetworkFirewallPoliciesPatch 
    ...
    -> ComputeRegionNetworkFirewallPoliciesPatch
newComputeRegionNetworkFirewallPoliciesPatch firewallPolicy payload
  project region
  = ComputeRegionNetworkFirewallPoliciesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNetworkFirewallPoliciesPatch =
