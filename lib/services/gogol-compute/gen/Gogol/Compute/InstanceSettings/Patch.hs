                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] InstanceSettings Core.:>
...
newComputeInstanceSettingsPatch payload project zone
  = ComputeInstanceSettingsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstanceSettingsPatch where
        ...
        requestClient ComputeInstanceSettingsPatch{..}
          = go project zone xgafv accessToken callback requestId updateMask
              uploadType
              uploadProtocol
