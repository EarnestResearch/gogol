                     ...
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "requestId" Core.Text Core.:>
                           Core.QueryParam "sourceInstanceTemplate" Core.Text Core.:>
                             Core.QueryParam "sourceMachineImage" Core.Text Core.:>
...
instance Core.GoogleRequest ComputeInstancesInsert where
        ...
        type Scopes ComputeInstancesInsert =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInstancesInsert{..}
          = go project zone xgafv accessToken callback requestId
