                       ...
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "deletionProtection" Core.Bool Core.:>
...
newComputeInstancesSetDeletionProtection project resource zone
  = ComputeInstancesSetDeletionProtection{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          deletionProtection = Core.True, project = project,
                                          requestId = Core.Nothing, resource = resource,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                          zone = zone}
instance Core.GoogleRequest ComputeInstancesSetDeletionProtection
         where
