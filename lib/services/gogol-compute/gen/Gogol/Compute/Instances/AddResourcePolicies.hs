                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] InstancesAddResourcePoliciesRequest
...
newComputeInstancesAddResourcePolicies 
    ...
    -> ComputeInstancesAddResourcePolicies
newComputeInstancesAddResourcePolicies instance' payload project
  zone
  = ComputeInstancesAddResourcePolicies{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstancesAddResourcePolicies
         where
        type Rs ComputeInstancesAddResourcePolicies = Operation
        type Scopes ComputeInstancesAddResourcePolicies =
