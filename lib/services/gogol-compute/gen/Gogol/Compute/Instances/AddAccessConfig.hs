...
newComputeInstancesAddAccessConfig 
    ...
    -> ComputeInstancesAddAccessConfig
newComputeInstancesAddAccessConfig instance' networkInterface
  payload project zone
  = ComputeInstancesAddAccessConfig{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstancesAddAccessConfig where
        ...
        type Scopes ComputeInstancesAddAccessConfig =
