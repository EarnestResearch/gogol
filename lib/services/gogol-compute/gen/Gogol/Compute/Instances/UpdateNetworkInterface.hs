                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] NetworkInterface Core.:>
...
newComputeInstancesUpdateNetworkInterface 
    ...
    -> ComputeInstancesUpdateNetworkInterface
newComputeInstancesUpdateNetworkInterface instance'
  networkInterface payload project zone
  = ComputeInstancesUpdateNetworkInterface{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           instance' = instance',
                                           networkInterface = networkInterface, payload = payload,
                                           project = project, requestId = Core.Nothing,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                           zone = zone}
instance Core.GoogleRequest ComputeInstancesUpdateNetworkInterface
         where
        type Rs ComputeInstancesUpdateNetworkInterface = Operation
        type Scopes ComputeInstancesUpdateNetworkInterface =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInstancesUpdateNetworkInterface{..}
          = go project zone instance' (Core.Just networkInterface) xgafv
              accessToken
              callback
              requestId
              uploadType
