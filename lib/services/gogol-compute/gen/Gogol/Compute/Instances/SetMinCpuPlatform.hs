                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] InstancesSetMinCpuPlatformRequest
...
newComputeInstancesSetMinCpuPlatform instance' payload project zone
  = ComputeInstancesSetMinCpuPlatform{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstancesSetMinCpuPlatform where
        ...
        type Scopes ComputeInstancesSetMinCpuPlatform =
