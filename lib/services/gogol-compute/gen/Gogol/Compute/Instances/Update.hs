                     ...
                     Core.QueryParam "$.xgafv" Xgafv Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "minimalAction" InstancesUpdateMinimalAction
                             Core.:>
...
newComputeInstancesUpdate instance' payload project zone
  = ComputeInstancesUpdate{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           instance' = instance', minimalAction = Core.Nothing,
                           mostDisruptiveAllowedAction = Core.Nothing, payload = payload,
