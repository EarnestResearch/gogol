                       ...
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "forceAttach" Core.Bool Core.:>
                               Core.QueryParam "requestId" Core.Text Core.:>
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] AttachedDisk Core.:>
...
newComputeInstancesAttachDisk instance' payload project zone
  = ComputeInstancesAttachDisk{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               forceAttach = Core.Nothing, instance' = instance',
...
instance Core.GoogleRequest ComputeInstancesAttachDisk where
        ...
        type Scopes ComputeInstancesAttachDisk =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInstancesAttachDisk{..}
          = go project zone instance' xgafv accessToken callback forceAttach
              requestId
              uploadType
              uploadProtocol
