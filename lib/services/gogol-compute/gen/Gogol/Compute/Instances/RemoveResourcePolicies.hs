...
newComputeInstancesRemoveResourcePolicies 
    ...
    -> ComputeInstancesRemoveResourcePolicies
newComputeInstancesRemoveResourcePolicies instance' payload project
  zone
  = ComputeInstancesRemoveResourcePolicies{xgafv = Core.Nothing,
                                           ...
                                           zone = zone}
instance Core.GoogleRequest ComputeInstancesRemoveResourcePolicies
         where
        type Rs ComputeInstancesRemoveResourcePolicies = Operation
        type Scopes ComputeInstancesRemoveResourcePolicies =
