               ...
               Core.Capture "zone" Core.Text Core.:>
                 "instances" Core.:>
                   Core.Capture "instance" Core.Text Core.:>
                     "setDiskAutoDelete" Core.:>
                       Core.QueryParam "autoDelete" Core.Bool Core.:>
                         Core.QueryParam "deviceName" Core.Text Core.:>
...
newComputeInstancesSetDiskAutoDelete 
    ...
    -> ComputeInstancesSetDiskAutoDelete
newComputeInstancesSetDiskAutoDelete autoDelete deviceName
  instance' project zone
  = ComputeInstancesSetDiskAutoDelete{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, autoDelete = autoDelete,
                                      callback = Core.Nothing, deviceName = deviceName,
...
instance Core.GoogleRequest ComputeInstancesSetDiskAutoDelete where
        ...
        type Scopes ComputeInstancesSetDiskAutoDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInstancesSetDiskAutoDelete{..}
          = go project zone instance' (Core.Just autoDelete)
