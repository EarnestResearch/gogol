                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] DisplayDevice Core.:>
...
newComputeInstancesUpdateDisplayDevice 
    ...
    -> ComputeInstancesUpdateDisplayDevice
newComputeInstancesUpdateDisplayDevice instance' payload project
  zone
  = ComputeInstancesUpdateDisplayDevice{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstancesUpdateDisplayDevice
         where
