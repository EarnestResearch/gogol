               ...
               Core.Capture "zone" Core.Text Core.:>
                 "instances" Core.:>
                   Core.Capture "instance" Core.Text Core.:>
                     "deleteAccessConfig" Core.:>
                       Core.QueryParam "accessConfig" Core.Text Core.:>
                         Core.QueryParam "networkInterface" Core.Text Core.:>
...
newComputeInstancesDeleteAccessConfig 
    ...
    -> ComputeInstancesDeleteAccessConfig
newComputeInstancesDeleteAccessConfig accessConfig instance'
  networkInterface project zone
  = ComputeInstancesDeleteAccessConfig{xgafv = Core.Nothing,
                                       accessConfig = accessConfig, accessToken = Core.Nothing,
                                       callback = Core.Nothing, instance' = instance',
                                       networkInterface = networkInterface, project = project,
                                       requestId = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing, zone = zone}
instance Core.GoogleRequest ComputeInstancesDeleteAccessConfig
         where
        type Rs ComputeInstancesDeleteAccessConfig = Operation
        type Scopes ComputeInstancesDeleteAccessConfig =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInstancesDeleteAccessConfig{..}
          = go project zone instance' (Core.Just accessConfig)
