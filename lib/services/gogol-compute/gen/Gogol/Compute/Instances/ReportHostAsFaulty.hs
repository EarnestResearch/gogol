                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] InstancesReportHostAsFaultyRequest
...
newComputeInstancesReportHostAsFaulty 
    ...
    -> ComputeInstancesReportHostAsFaulty
newComputeInstancesReportHostAsFaulty instance' payload project
  zone
  = ComputeInstancesReportHostAsFaulty{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstancesReportHostAsFaulty
         where
        type Rs ComputeInstancesReportHostAsFaulty = Operation
        type Scopes ComputeInstancesReportHostAsFaulty =
