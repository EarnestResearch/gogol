                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] ShieldedInstanceConfig Core.:>
...
newComputeInstancesUpdateShieldedInstanceConfig 
    ...
    -> ComputeInstancesUpdateShieldedInstanceConfig
newComputeInstancesUpdateShieldedInstanceConfig instance' payload
  project zone
  = ComputeInstancesUpdateShieldedInstanceConfig{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeInstancesUpdateShieldedInstanceConfig =
