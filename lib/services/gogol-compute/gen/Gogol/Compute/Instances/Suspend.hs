                       ...
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "discardLocalSsd" Core.Bool Core.:>
...
newComputeInstancesSuspend instance' project zone
  = ComputeInstancesSuspend{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing,
                            discardLocalSsd = Core.Nothing, instance' = instance',
...
instance Core.GoogleRequest ComputeInstancesSuspend where
        ...
        type Scopes ComputeInstancesSuspend =
