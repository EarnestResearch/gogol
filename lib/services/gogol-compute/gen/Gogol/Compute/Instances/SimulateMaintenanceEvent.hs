                             ...
                             Core.QueryParam "requestId" Core.Text Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "withExtendedNotifications" Core.Bool Core.:>
...
newComputeInstancesSimulateMaintenanceEvent instance' project zone
  = ComputeInstancesSimulateMaintenanceEvent{xgafv = Core.Nothing,
                                             accessToken = Core.Nothing, callback = Core.Nothing,
                                             instance' = instance', project = project,
                                             requestId = Core.Nothing, uploadType = Core.Nothing,
                                             uploadProtocol = Core.Nothing,
                                             withExtendedNotifications = Core.Nothing, zone = zone}
instance Core.GoogleRequest
           ComputeInstancesSimulateMaintenanceEvent
         where
        type Rs ComputeInstancesSimulateMaintenanceEvent = Operation
        type Scopes ComputeInstancesSimulateMaintenanceEvent =
