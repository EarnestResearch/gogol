...
newComputeInstancesPerformMaintenance instance' project zone
  = ComputeInstancesPerformMaintenance{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       instance' = instance', project = project,
                                       requestId = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing, zone = zone}
instance Core.GoogleRequest ComputeInstancesPerformMaintenance
         where
        type Rs ComputeInstancesPerformMaintenance = Operation
        type Scopes ComputeInstancesPerformMaintenance =
