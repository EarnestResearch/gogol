                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] InstancesSetServiceAccountRequest
...
newComputeInstancesSetServiceAccount instance' payload project zone
  = ComputeInstancesSetServiceAccount{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstancesSetServiceAccount where
        ...
        type Scopes ComputeInstancesSetServiceAccount =
