...
newComputeInstancesGetSerialPortOutput instance' project zone
  = ComputeInstancesGetSerialPortOutput{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        instance' = instance', port = 1, project = project,
                                        start = Core.Nothing, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing, zone = zone}
instance Core.GoogleRequest ComputeInstancesGetSerialPortOutput
         where
        ...
        requestClient ComputeInstancesGetSerialPortOutput{..}
          = go project zone instance' xgafv accessToken callback
              (Core.Just port)
              start
              uploadType
              uploadProtocol
