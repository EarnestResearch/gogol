                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] ShieldedInstanceIntegrityPolicy
...
newComputeInstancesSetShieldedInstanceIntegrityPolicy 
    ...
    -> ComputeInstancesSetShieldedInstanceIntegrityPolicy
newComputeInstancesSetShieldedInstanceIntegrityPolicy instance'
  payload project zone
  = ComputeInstancesSetShieldedInstanceIntegrityPolicy{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ComputeInstancesSetShieldedInstanceIntegrityPolicy
         where
        type Rs ComputeInstancesSetShieldedInstanceIntegrityPolicy =
             Operation
        type Scopes ComputeInstancesSetShieldedInstanceIntegrityPolicy =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient
          ComputeInstancesSetShieldedInstanceIntegrityPolicy{..}
          = go project zone instance' xgafv accessToken callback requestId
              uploadType
              uploadProtocol
