                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] InstancesSetMachineResourcesRequest
...
newComputeInstancesSetMachineResources 
    ...
    -> ComputeInstancesSetMachineResources
newComputeInstancesSetMachineResources instance' payload project
  zone
  = ComputeInstancesSetMachineResources{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstancesSetMachineResources
         where
        type Rs ComputeInstancesSetMachineResources = Operation
        type Scopes ComputeInstancesSetMachineResources =
