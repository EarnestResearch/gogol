...
newComputeInstancesDetachDisk deviceName instance' project zone
  = ComputeInstancesDetachDisk{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               deviceName = deviceName, instance' = instance', project = project,
...
instance Core.GoogleRequest ComputeInstancesDetachDisk where
        ...
        type Scopes ComputeInstancesDetachDisk =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInstancesDetachDisk{..}
          = go project zone instance' (Core.Just deviceName) xgafv
              accessToken
              callback
              requestId
              uploadType
