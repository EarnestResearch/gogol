...
newComputeInstancesStartWithEncryptionKey 
    ...
    -> ComputeInstancesStartWithEncryptionKey
newComputeInstancesStartWithEncryptionKey instance' payload project
  zone
  = ComputeInstancesStartWithEncryptionKey{xgafv = Core.Nothing,
                                           ...
                                           zone = zone}
instance Core.GoogleRequest ComputeInstancesStartWithEncryptionKey
         where
        type Rs ComputeInstancesStartWithEncryptionKey = Operation
        type Scopes ComputeInstancesStartWithEncryptionKey =
