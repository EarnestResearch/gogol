                                       ...
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] InstanceListReferrers
...
newComputeInstancesListReferrers instance' project zone
  = ComputeInstancesListReferrers{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  filter = Core.Nothing, instance' = instance', maxResults = 500,
...
instance Core.GoogleRequest ComputeInstancesListReferrers where
        ...
        type Scopes ComputeInstancesListReferrers =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeInstancesListReferrers{..}
          = go project zone instance' xgafv accessToken callback filter
