                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] AccessConfig Core.:>
...
newComputeInstancesUpdateAccessConfig 
    ...
    -> ComputeInstancesUpdateAccessConfig
newComputeInstancesUpdateAccessConfig instance' networkInterface
  payload project zone
  = ComputeInstancesUpdateAccessConfig{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       instance' = instance', networkInterface = networkInterface,
                                       payload = payload, project = project,
                                       requestId = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing, zone = zone}
instance Core.GoogleRequest ComputeInstancesUpdateAccessConfig
         where
        type Rs ComputeInstancesUpdateAccessConfig = Operation
        type Scopes ComputeInstancesUpdateAccessConfig =
