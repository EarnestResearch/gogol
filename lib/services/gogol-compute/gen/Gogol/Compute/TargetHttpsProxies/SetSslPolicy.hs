...
newComputeTargetHttpsProxiesSetSslPolicy 
    ...
    -> ComputeTargetHttpsProxiesSetSslPolicy
newComputeTargetHttpsProxiesSetSslPolicy payload project
  targetHttpsProxy
  = ComputeTargetHttpsProxiesSetSslPolicy{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, project = project,
                                          requestId = Core.Nothing,
                                          targetHttpsProxy = targetHttpsProxy,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeTargetHttpsProxiesSetSslPolicy
         where
