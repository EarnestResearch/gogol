...
newComputeTargetHttpsProxiesSetUrlMap 
    ...
    -> ComputeTargetHttpsProxiesSetUrlMap
newComputeTargetHttpsProxiesSetUrlMap payload project
  targetHttpsProxy
  = ComputeTargetHttpsProxiesSetUrlMap{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, project = project,
                                       requestId = Core.Nothing,
                                       targetHttpsProxy = targetHttpsProxy,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeTargetHttpsProxiesSetUrlMap
         where
        type Rs ComputeTargetHttpsProxiesSetUrlMap = Operation
        type Scopes ComputeTargetHttpsProxiesSetUrlMap =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeTargetHttpsProxiesSetUrlMap{..}
          = go project targetHttpsProxy xgafv accessToken callback requestId
              uploadType
              uploadProtocol
