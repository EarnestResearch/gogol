...
newComputeTargetHttpsProxiesSetCertificateMap 
    ...
    -> ComputeTargetHttpsProxiesSetCertificateMap
newComputeTargetHttpsProxiesSetCertificateMap payload project
  targetHttpsProxy
  = ComputeTargetHttpsProxiesSetCertificateMap{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeTargetHttpsProxiesSetCertificateMap =
