...
newComputeTargetHttpsProxiesSetSslCertificates 
    ...
    -> ComputeTargetHttpsProxiesSetSslCertificates
newComputeTargetHttpsProxiesSetSslCertificates payload project
  targetHttpsProxy
  = ComputeTargetHttpsProxiesSetSslCertificates{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeTargetHttpsProxiesSetSslCertificates =
