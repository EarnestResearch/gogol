                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] TargetHttpsProxyAggregatedList
...
newComputeTargetHttpsProxiesAggregatedList project
  = ComputeTargetHttpsProxiesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetHttpsProxiesAggregatedList
         where
        type Rs ComputeTargetHttpsProxiesAggregatedList =
             TargetHttpsProxyAggregatedList
        type Scopes ComputeTargetHttpsProxiesAggregatedList =
