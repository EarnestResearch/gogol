...
newComputeRegionHealthChecksUpdate 
    ...
    -> ComputeRegionHealthChecksUpdate
newComputeRegionHealthChecksUpdate healthCheck payload project
  region
  = ComputeRegionHealthChecksUpdate{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    healthCheck = healthCheck, payload = payload, project = project,
...
instance Core.GoogleRequest ComputeRegionHealthChecksUpdate where
        ...
        type Scopes ComputeRegionHealthChecksUpdate =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionHealthChecksUpdate{..}
          = go project region healthCheck xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
