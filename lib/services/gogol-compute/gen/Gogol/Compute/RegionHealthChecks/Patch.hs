...
newComputeRegionHealthChecksPatch 
    ...
    -> ComputeRegionHealthChecksPatch
newComputeRegionHealthChecksPatch healthCheck payload project
  region
  = ComputeRegionHealthChecksPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionHealthChecksPatch where
        ...
        type Scopes ComputeRegionHealthChecksPatch =
