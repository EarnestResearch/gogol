                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] InstanceGroupsSetNamedPortsRequest
...
newComputeInstanceGroupsSetNamedPorts 
    ...
    -> ComputeInstanceGroupsSetNamedPorts
newComputeInstanceGroupsSetNamedPorts instanceGroup payload project
  zone
  = ComputeInstanceGroupsSetNamedPorts{xgafv = Core.Nothing,
                                       ...
                                       zone = zone}
instance Core.GoogleRequest ComputeInstanceGroupsSetNamedPorts
         where
        type Rs ComputeInstanceGroupsSetNamedPorts = Operation
        type Scopes ComputeInstanceGroupsSetNamedPorts =
