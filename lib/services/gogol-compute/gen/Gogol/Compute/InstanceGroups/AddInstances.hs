                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] InstanceGroupsAddInstancesRequest
...
newComputeInstanceGroupsAddInstances 
    ...
    -> ComputeInstanceGroupsAddInstances
newComputeInstanceGroupsAddInstances instanceGroup payload project
  zone
  = ComputeInstanceGroupsAddInstances{xgafv = Core.Nothing,
