                                         ...
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.ReqBody '[Core.JSON]
                                               ...
                                               Core.:>
                                               Core.Post '[Core.JSON] InstanceGroupsListInstances
...
newComputeInstanceGroupsListInstances 
    ...
    -> ComputeInstanceGroupsListInstances
newComputeInstanceGroupsListInstances instanceGroup payload project
  zone
  = ComputeInstanceGroupsListInstances{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       filter = Core.Nothing, instanceGroup = instanceGroup,
                                       ...
                                       zone = zone}
instance Core.GoogleRequest ComputeInstanceGroupsListInstances
         where
        type Rs ComputeInstanceGroupsListInstances =
             InstanceGroupsListInstances
        type Scopes ComputeInstanceGroupsListInstances =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeInstanceGroupsListInstances{..}
          = go project zone instanceGroup xgafv accessToken callback filter
