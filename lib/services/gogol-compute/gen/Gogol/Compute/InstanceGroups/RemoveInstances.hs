                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] InstanceGroupsRemoveInstancesRequest
...
newComputeInstanceGroupsRemoveInstances 
    ...
    -> ComputeInstanceGroupsRemoveInstances
newComputeInstanceGroupsRemoveInstances instanceGroup payload
  project zone
  = ComputeInstanceGroupsRemoveInstances{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         instanceGroup = instanceGroup, payload = payload,
                                         project = project, requestId = Core.Nothing,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                         zone = zone}
instance Core.GoogleRequest ComputeInstanceGroupsRemoveInstances
         where
        type Rs ComputeInstanceGroupsRemoveInstances = Operation
        type Scopes ComputeInstanceGroupsRemoveInstances =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInstanceGroupsRemoveInstances{..}
          = go project zone instanceGroup xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
