                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] InstanceGroup
...
newComputeInstanceGroupsGet instanceGroup project zone
  = ComputeInstanceGroupsGet{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             instanceGroup = instanceGroup, project = project,
...
instance Core.GoogleRequest ComputeInstanceGroupsGet where
        ...
        type Scopes ComputeInstanceGroupsGet =
