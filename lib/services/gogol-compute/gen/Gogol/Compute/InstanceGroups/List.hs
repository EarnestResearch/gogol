                                   ...
                                   Core.QueryParam "uploadType" Core.Text
                                     ...
                                     Core.QueryParam "upload_protocol" Core.Text
                                       ...
                                       Core.QueryParam "alt" Core.AltJSON
                                         Core.:>
                                         Core.Get '[Core.JSON] InstanceGroupList
...
instance Core.GoogleRequest ComputeInstanceGroupsList
         where
        type Rs ComputeInstanceGroupsList = InstanceGroupList
        type Scopes ComputeInstanceGroupsList =
             '[CloudPlatform'FullControl, Compute'FullControl,
               Compute'Readonly]
        requestClient ComputeInstanceGroupsList{..}
          = go project zone xgafv accessToken callback filter
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeInstanceGroupsListResource)
                      Core.mempty
