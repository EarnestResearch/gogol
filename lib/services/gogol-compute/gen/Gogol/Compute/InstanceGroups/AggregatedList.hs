                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] InstanceGroupAggregatedList
...
newComputeInstanceGroupsAggregatedList project
  = ComputeInstanceGroupsAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstanceGroupsAggregatedList
         where
        type Rs ComputeInstanceGroupsAggregatedList =
