...
newComputeGlobalNetworkEndpointGroupsListNetworkEndpoints
  ...
  = ComputeGlobalNetworkEndpointGroupsListNetworkEndpoints{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           ComputeGlobalNetworkEndpointGroupsListNetworkEndpoints
         where
        type Rs ComputeGlobalNetworkEndpointGroupsListNetworkEndpoints =
             NetworkEndpointGroupsListNetworkEndpoints
        type Scopes ComputeGlobalNetworkEndpointGroupsListNetworkEndpoints
             =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient
          ComputeGlobalNetworkEndpointGroupsListNetworkEndpoints{..}
          = go project networkEndpointGroup xgafv accessToken callback filter
