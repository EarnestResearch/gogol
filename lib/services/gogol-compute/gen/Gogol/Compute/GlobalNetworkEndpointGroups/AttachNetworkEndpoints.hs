...
newComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints 
    ...
    -> ComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints
newComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints
  networkEndpointGroup payload project
  = ComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           ComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints
         where
        type Rs ComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints =
             Operation
        type Scopes
               ComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints
        ...
        requestClient
          ComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints{..}
          = go project networkEndpointGroup xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
