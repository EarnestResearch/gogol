                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] NetworkEndpointGroupList
...
newComputeGlobalNetworkEndpointGroupsList project
  = ComputeGlobalNetworkEndpointGroupsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeGlobalNetworkEndpointGroupsList
         where
        type Rs ComputeGlobalNetworkEndpointGroupsList =
             NetworkEndpointGroupList
        type Scopes ComputeGlobalNetworkEndpointGroupsList =
