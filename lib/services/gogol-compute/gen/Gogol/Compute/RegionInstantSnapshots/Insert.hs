                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] InstantSnapshot Core.:>
...
newComputeRegionInstantSnapshotsInsert payload project region
  = ComputeRegionInstantSnapshotsInsert{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, project = project, region = region,
                                        requestId = Core.Nothing, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionInstantSnapshotsInsert
         where
        type Rs ComputeRegionInstantSnapshotsInsert = Operation
        type Scopes ComputeRegionInstantSnapshotsInsert =
