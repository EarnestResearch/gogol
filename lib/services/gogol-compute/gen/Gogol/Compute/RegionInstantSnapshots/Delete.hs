...
newComputeRegionInstantSnapshotsDelete 
    ...
    -> ComputeRegionInstantSnapshotsDelete
newComputeRegionInstantSnapshotsDelete instantSnapshot project
  region
  = ComputeRegionInstantSnapshotsDelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        instantSnapshot = instantSnapshot, project = project,
                                        region = region, requestId = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionInstantSnapshotsDelete
         where
        type Rs ComputeRegionInstantSnapshotsDelete = Operation
        type Scopes ComputeRegionInstantSnapshotsDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionInstantSnapshotsDelete{..}
          = go project region instantSnapshot xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
