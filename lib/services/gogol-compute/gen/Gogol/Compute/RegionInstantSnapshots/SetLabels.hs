...
newComputeRegionInstantSnapshotsSetLabels 
    ...
    -> ComputeRegionInstantSnapshotsSetLabels
newComputeRegionInstantSnapshotsSetLabels payload project region
  resource
  = ComputeRegionInstantSnapshotsSetLabels{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionInstantSnapshotsSetLabels
         where
        type Rs ComputeRegionInstantSnapshotsSetLabels = Operation
        type Scopes ComputeRegionInstantSnapshotsSetLabels =
