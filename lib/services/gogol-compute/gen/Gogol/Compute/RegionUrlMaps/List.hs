...
instance Core.GoogleRequest ComputeRegionUrlMapsList
         where
        type Rs ComputeRegionUrlMapsList = UrlMapList
        type Scopes ComputeRegionUrlMapsList =
        ...
        requestClient ComputeRegionUrlMapsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeRegionUrlMapsListResource)
                      Core.mempty
