                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] ServiceAttachment Core.:>
...
newComputeServiceAttachmentsPatch 
    ...
    -> ComputeServiceAttachmentsPatch
newComputeServiceAttachmentsPatch payload project region
  serviceAttachment
  = ComputeServiceAttachmentsPatch{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   payload = payload, project = project, region = region,
                                   requestId = Core.Nothing, serviceAttachment = serviceAttachment,
...
instance Core.GoogleRequest ComputeServiceAttachmentsPatch where
        ...
        type Scopes ComputeServiceAttachmentsPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeServiceAttachmentsPatch{..}
          = go project region serviceAttachment xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
