                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ServiceAttachment
...
newComputeServiceAttachmentsGet project region serviceAttachment
  = ComputeServiceAttachmentsGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 project = project, region = region,
                                 serviceAttachment = serviceAttachment, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ComputeServiceAttachmentsGet where
        ...
        type Scopes ComputeServiceAttachmentsGet =
