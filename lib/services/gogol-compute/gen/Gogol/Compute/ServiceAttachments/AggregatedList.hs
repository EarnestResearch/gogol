                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] ServiceAttachmentAggregatedList
...
newComputeServiceAttachmentsAggregatedList project
  = ComputeServiceAttachmentsAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeServiceAttachmentsAggregatedList
         where
        type Rs ComputeServiceAttachmentsAggregatedList =
             ServiceAttachmentAggregatedList
        type Scopes ComputeServiceAttachmentsAggregatedList =
