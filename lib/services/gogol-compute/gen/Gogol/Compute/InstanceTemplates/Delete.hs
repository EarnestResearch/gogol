...
newComputeInstanceTemplatesDelete instanceTemplate project
  = ComputeInstanceTemplatesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstanceTemplatesDelete where
        ...
        type Scopes ComputeInstanceTemplatesDelete =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeInstanceTemplatesDelete{..}
          = go project instanceTemplate xgafv accessToken callback requestId
              uploadType
              uploadProtocol
