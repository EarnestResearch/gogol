                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] InstanceTemplateAggregatedList
...
newComputeInstanceTemplatesAggregatedList project
  = ComputeInstanceTemplatesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeInstanceTemplatesAggregatedList
         where
        type Rs ComputeInstanceTemplatesAggregatedList =
             InstanceTemplateAggregatedList
        type Scopes ComputeInstanceTemplatesAggregatedList =
