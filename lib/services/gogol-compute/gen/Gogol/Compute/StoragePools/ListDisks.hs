                                       ...
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] StoragePoolListDisks
...
newComputeStoragePoolsListDisks project storagePool zone
  = ComputeStoragePoolsListDisks{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 filter = Core.Nothing, maxResults = 500, orderBy = Core.Nothing,
                                 pageToken = Core.Nothing, project = project,
                                 returnPartialSuccess = Core.Nothing, storagePool = storagePool,
...
instance Core.GoogleRequest ComputeStoragePoolsListDisks where
        ...
        type Scopes ComputeStoragePoolsListDisks =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeStoragePoolsListDisks{..}
          = go project zone storagePool xgafv accessToken callback filter
