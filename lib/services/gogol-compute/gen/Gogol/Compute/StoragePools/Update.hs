                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] StoragePool Core.:>
...
newComputeStoragePoolsUpdate payload project storagePool zone
  = ComputeStoragePoolsUpdate{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              payload = payload, project = project, requestId = Core.Nothing,
                              storagePool = storagePool, updateMask = Core.Nothing,
...
instance Core.GoogleRequest ComputeStoragePoolsUpdate where
        ...
        requestClient ComputeStoragePoolsUpdate{..}
          = go project zone storagePool xgafv accessToken callback requestId
              updateMask
              uploadType
              uploadProtocol
