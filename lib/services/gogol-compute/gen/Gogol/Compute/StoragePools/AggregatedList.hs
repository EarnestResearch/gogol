                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] StoragePoolAggregatedList
...
newComputeStoragePoolsAggregatedList project
  = ComputeStoragePoolsAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeStoragePoolsAggregatedList where
        type Rs ComputeStoragePoolsAggregatedList =
             StoragePoolAggregatedList
        type Scopes ComputeStoragePoolsAggregatedList =
