...
newComputeGlobalPublicDelegatedPrefixesPatch 
    ...
    -> ComputeGlobalPublicDelegatedPrefixesPatch
newComputeGlobalPublicDelegatedPrefixesPatch payload project
  publicDelegatedPrefix
  = ComputeGlobalPublicDelegatedPrefixesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeGlobalPublicDelegatedPrefixesPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeGlobalPublicDelegatedPrefixesPatch{..}
          = go project publicDelegatedPrefix xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
