...
newComputeGlobalPublicDelegatedPrefixesDelete 
    ...
    -> ComputeGlobalPublicDelegatedPrefixesDelete
newComputeGlobalPublicDelegatedPrefixesDelete project
  publicDelegatedPrefix
  = ComputeGlobalPublicDelegatedPrefixesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeGlobalPublicDelegatedPrefixesDelete =
