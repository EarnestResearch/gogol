...
newComputeGlobalPublicDelegatedPrefixesList project
  = ComputeGlobalPublicDelegatedPrefixesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeGlobalPublicDelegatedPrefixesList
         where
        type Rs ComputeGlobalPublicDelegatedPrefixesList =
             PublicDelegatedPrefixList
        type Scopes ComputeGlobalPublicDelegatedPrefixesList =
