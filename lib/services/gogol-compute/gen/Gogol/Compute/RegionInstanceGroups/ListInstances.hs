...
newComputeRegionInstanceGroupsListInstances 
    ...
    -> ComputeRegionInstanceGroupsListInstances
newComputeRegionInstanceGroupsListInstances instanceGroup payload
  project region
  = ComputeRegionInstanceGroupsListInstances{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstanceGroupsListInstances
         where
        type Rs ComputeRegionInstanceGroupsListInstances =
             RegionInstanceGroupsListInstances
        type Scopes ComputeRegionInstanceGroupsListInstances =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeRegionInstanceGroupsListInstances{..}
          = go project region instanceGroup xgafv accessToken callback filter
