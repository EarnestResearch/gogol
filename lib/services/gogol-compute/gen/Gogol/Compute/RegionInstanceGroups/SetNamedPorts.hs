...
newComputeRegionInstanceGroupsSetNamedPorts 
    ...
    -> ComputeRegionInstanceGroupsSetNamedPorts
newComputeRegionInstanceGroupsSetNamedPorts instanceGroup payload
  project region
  = ComputeRegionInstanceGroupsSetNamedPorts{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionInstanceGroupsSetNamedPorts =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionInstanceGroupsSetNamedPorts{..}
          = go project region instanceGroup xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
