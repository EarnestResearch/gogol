             ...
             "regions" Core.:>
               Core.Capture "region" Core.Text Core.:>
                 "resourcePolicies" Core.:>
                   Core.Capture "resourcePolicy" Core.Text Core.:>
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] ResourcePolicy Core.:>
...
newComputeResourcePoliciesPatch 
    ...
    -> ComputeResourcePoliciesPatch
newComputeResourcePoliciesPatch payload project region
  resourcePolicy
  = ComputeResourcePoliciesPatch{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 payload = payload, project = project, region = region,
                                 requestId = Core.Nothing, resourcePolicy = resourcePolicy,
...
instance Core.GoogleRequest ComputeResourcePoliciesPatch where
        ...
        type Scopes ComputeResourcePoliciesPatch =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeResourcePoliciesPatch{..}
          = go project region resourcePolicy xgafv accessToken callback
              requestId
              updateMask
              uploadType
              uploadProtocol
