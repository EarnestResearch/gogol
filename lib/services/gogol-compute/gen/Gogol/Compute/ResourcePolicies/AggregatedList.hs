                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] ResourcePolicyAggregatedList
...
newComputeResourcePoliciesAggregatedList project
  = ComputeResourcePoliciesAggregatedList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeResourcePoliciesAggregatedList
         where
        type Rs ComputeResourcePoliciesAggregatedList =
             ResourcePolicyAggregatedList
        type Scopes ComputeResourcePoliciesAggregatedList =
