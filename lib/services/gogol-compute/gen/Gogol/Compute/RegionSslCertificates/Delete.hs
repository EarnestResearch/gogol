...
newComputeRegionSslCertificatesDelete project region sslCertificate
  = ComputeRegionSslCertificatesDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       project = project, region = region, requestId = Core.Nothing,
                                       sslCertificate = sslCertificate, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionSslCertificatesDelete
         where
        ...
        requestClient ComputeRegionSslCertificatesDelete{..}
          = go project region sslCertificate xgafv accessToken callback
              requestId
              uploadType
              uploadProtocol
