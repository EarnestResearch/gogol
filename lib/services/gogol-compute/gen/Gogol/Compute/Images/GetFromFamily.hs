...
newComputeImagesGetFromFamily family project
  = ComputeImagesGetFromFamily{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               family = family, project = project, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ComputeImagesGetFromFamily where
        ...
        requestClient ComputeImagesGetFromFamily{..}
          = go project family xgafv accessToken callback uploadType
              uploadProtocol
