                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] DeprecationStatus Core.:>
...
newComputeImagesDeprecate image payload project
  = ComputeImagesDeprecate{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing, image = image,
...
instance Core.GoogleRequest ComputeImagesDeprecate where
        ...
        type Scopes ComputeImagesDeprecate =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeImagesDeprecate{..}
          = go project image xgafv accessToken callback requestId uploadType
              uploadProtocol
