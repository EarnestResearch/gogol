...
newComputeImagesInsert payload project
  = ComputeImagesInsert{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        forceCreate = Core.Nothing, payload = payload, project = project,
...
instance Core.GoogleRequest ComputeImagesInsert where
        ...
        requestClient ComputeImagesInsert{..}
          = go project xgafv accessToken callback forceCreate requestId
              uploadType
              uploadProtocol
