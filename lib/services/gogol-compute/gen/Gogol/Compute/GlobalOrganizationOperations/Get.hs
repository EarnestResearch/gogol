...
newComputeGlobalOrganizationOperationsGet operation
  = ComputeGlobalOrganizationOperationsGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           operation = operation, parentId = Core.Nothing,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeGlobalOrganizationOperationsGet
         where
        type Rs ComputeGlobalOrganizationOperationsGet = Operation
        type Scopes ComputeGlobalOrganizationOperationsGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeGlobalOrganizationOperationsGet{..}
          = go operation xgafv accessToken callback parentId uploadType
              uploadProtocol
