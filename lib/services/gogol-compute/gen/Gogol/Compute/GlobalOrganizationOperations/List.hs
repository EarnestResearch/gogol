...
newComputeGlobalOrganizationOperationsList 
    :: 
                                           ComputeGlobalOrganizationOperationsList
newComputeGlobalOrganizationOperationsList
  = ComputeGlobalOrganizationOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeGlobalOrganizationOperationsList
         where
        type Rs ComputeGlobalOrganizationOperationsList = OperationList
        type Scopes ComputeGlobalOrganizationOperationsList =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeGlobalOrganizationOperationsList{..}
          = go xgafv accessToken callback filter (Core.Just maxResults)
              orderBy
              pageToken
              parentId
