                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] UrlMapsAggregatedList
...
newComputeUrlMapsAggregatedList project
  = ComputeUrlMapsAggregatedList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 filter = Core.Nothing, includeAllScopes = Core.Nothing,
                                 maxResults = 500, orderBy = Core.Nothing, pageToken = Core.Nothing,
...
instance Core.GoogleRequest ComputeUrlMapsAggregatedList where
        ...
        type Scopes ComputeUrlMapsAggregatedList =
