                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] CacheInvalidationRule Core.:>
...
newComputeUrlMapsInvalidateCache payload project urlMap
  = ComputeUrlMapsInvalidateCache{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeUrlMapsInvalidateCache where
        ...
        type Scopes ComputeUrlMapsInvalidateCache =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeUrlMapsInvalidateCache{..}
          = go project urlMap xgafv accessToken callback requestId uploadType
              uploadProtocol
