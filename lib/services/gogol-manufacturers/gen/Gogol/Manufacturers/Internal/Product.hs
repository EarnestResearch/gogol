...
newAttributes 
    ::  Attributes
newAttributes
  = Attributes{additionalImageLink = Core.Nothing,
               ageGroup = Core.Nothing, brand = Core.Nothing,
               capacity = Core.Nothing, certification = Core.Nothing,
               color = Core.Nothing, count = Core.Nothing,
               description = Core.Nothing, disclosureDate = Core.Nothing,
               excludedDestination = Core.Nothing,
               featureDescription = Core.Nothing, flavor = Core.Nothing,
               format = Core.Nothing, gender = Core.Nothing,
               grocery = Core.Nothing, gtin = Core.Nothing,
               imageLink = Core.Nothing, includedDestination = Core.Nothing,
               intendedCountry = Core.Nothing, itemGroupId = Core.Nothing,
               material = Core.Nothing, mpn = Core.Nothing,
               nutrition = Core.Nothing, pattern' = Core.Nothing,
               productDetail = Core.Nothing, productHighlight = Core.Nothing,
               productLine = Core.Nothing, productName = Core.Nothing,
               productPageUrl = Core.Nothing, productType = Core.Nothing,
               releaseDate = Core.Nothing, richProductContent = Core.Nothing,
               scent = Core.Nothing, size = Core.Nothing,
               sizeSystem = Core.Nothing, sizeType = Core.Nothing,
               suggestedRetailPrice = Core.Nothing, targetClientId = Core.Nothing,
               theme = Core.Nothing, title = Core.Nothing,
               videoLink = Core.Nothing, virtualModelLink = Core.Nothing}
instance Core.FromJSON Attributes where
        parseJSON
          = Core.withObject "Attributes"
              (\ o ->
                 Attributes Core.<$>
                   (o Core..:? "additionalImageLink") Core.<*> (o Core..:? "ageGroup")
                     Core.<*> (o Core..:? "brand")
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalImageLink" Core..=) Core.<$> additionalImageLink,
                  ...
                  ("color" Core..=) Core.<$> color, ("count" Core..=) Core.<$> count,
                  ...
                  ("scent" Core..=) Core.<$> scent, ("size" Core..=) Core.<$> size,
                  ...
                  ("theme" Core..=) Core.<$> theme, ("title" Core..=) Core.<$> title,
...
newCertification 
    ::  Certification
newCertification
  = Certification{authority = Core.Nothing, code = Core.Nothing,
                  link = Core.Nothing, logo = Core.Nothing, name = Core.Nothing,
                  validUntil = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON Certification where
        parseJSON
          = Core.withObject "Certification"
              (\ o ->
                 Certification Core.<$>
                   (o Core..:? "authority") Core.<*> (o Core..:? "code") Core.<*>
                     (o Core..:? "link")
                     Core.<*> (o Core..:? "logo")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("authority" Core..=) Core.<$> authority,
                  ("code" Core..=) Core.<$> code, ("link" Core..=) Core.<$> link,
                  ("logo" Core..=) Core.<$> logo, ("name" Core..=) Core.<$> name,
...
newDestinationStatus 
    ::  DestinationStatus
newDestinationStatus
  = DestinationStatus{approvedCountries = Core.Nothing,
                      destination = Core.Nothing, disapprovedCountries = Core.Nothing,
                      pendingCountries = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON DestinationStatus where
        parseJSON
          = Core.withObject "DestinationStatus"
              (\ o ->
                 DestinationStatus Core.<$>
                   (o Core..:? "approvedCountries") Core.<*>
                     (o Core..:? "destination")
...
newFeatureDescription 
    ::  FeatureDescription
newFeatureDescription
  = FeatureDescription{headline = Core.Nothing, image = Core.Nothing,
                       text = Core.Nothing}
instance Core.FromJSON FeatureDescription where
        parseJSON
          = Core.withObject "FeatureDescription"
              (\ o ->
                 FeatureDescription Core.<$>
                   (o Core..:? "headline") Core.<*> (o Core..:? "image") Core.<*>
                     (o Core..:? "text"))
...
instance Core.FromJSON FloatUnit where
        parseJSON
          = Core.withObject "FloatUnit"
              (\ o ->
                 FloatUnit Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "unit"))
...
newGoogleShoppingManufacturersV1ProductCertification 
    :: 
                                                     GoogleShoppingManufacturersV1ProductCertification
newGoogleShoppingManufacturersV1ProductCertification
  = GoogleShoppingManufacturersV1ProductCertification{authority =
                                                        Core.Nothing,
                                                      code = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleShoppingManufacturersV1ProductCertification"
              (\ o ->
                 GoogleShoppingManufacturersV1ProductCertification Core.<$>
                   (o Core..:? "authority") Core.<*> (o Core..:? "code") Core.<*>
                     (o Core..:? "name"))
...
newGrocery 
    ::  Grocery
newGrocery
  = Grocery{activeIngredients = Core.Nothing,
            alcoholByVolume = Core.Nothing, allergens = Core.Nothing,
            derivedNutritionClaim = Core.Nothing, directions = Core.Nothing,
            indications = Core.Nothing, ingredients = Core.Nothing,
            nutritionClaim = Core.Nothing, storageInstructions = Core.Nothing}
instance Core.FromJSON Grocery where
        parseJSON
          = Core.withObject "Grocery"
              (\ o ->
                 Grocery Core.<$>
                   (o Core..:? "activeIngredients") Core.<*>
                     (o Core..:? "alcoholByVolume")
...
newImage 
    ::  Image
newImage
  = Image{imageUrl = Core.Nothing, status = Core.Nothing,
          type' = Core.Nothing}
instance Core.FromJSON Image where
        parseJSON
          = Core.withObject "Image"
              (\ o ->
                 Image Core.<$>
                   (o Core..:? "imageUrl") Core.<*> (o Core..:? "status") Core.<*>
                     (o Core..:? "type"))
...
newIssue 
    ::  Issue
newIssue
  = Issue{applicableCountries = Core.Nothing,
          attribute = Core.Nothing, description = Core.Nothing,
          destination = Core.Nothing, resolution = Core.Nothing,
          severity = Core.Nothing, timestamp = Core.Nothing,
          title = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Issue where
        parseJSON
          = Core.withObject "Issue"
              (\ o ->
                 Issue Core.<$>
                   (o Core..:? "applicableCountries") Core.<*>
                     (o Core..:? "attribute")
                     Core.<*> (o Core..:? "description")
...
newListProductCertificationsResponse 
    :: 
                                     ListProductCertificationsResponse
newListProductCertificationsResponse
  = ListProductCertificationsResponse{nextPageToken = Core.Nothing,
                                      productCertifications = Core.Nothing}
instance Core.FromJSON ListProductCertificationsResponse where
        parseJSON
          = Core.withObject "ListProductCertificationsResponse"
              (\ o ->
                 ListProductCertificationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "productCertifications"))
...
newListProductsResponse 
    ::  ListProductsResponse
newListProductsResponse
  = ListProductsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListProductsResponse"
              (\ o ->
                 ListProductsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "products"))
...
newNutrition 
    ::  Nutrition
newNutrition
  = Nutrition{addedSugars = Core.Nothing,
              addedSugarsDailyPercentage = Core.Nothing, calcium = Core.Nothing,
              calciumDailyPercentage = Core.Nothing, cholesterol = Core.Nothing,
              cholesterolDailyPercentage = Core.Nothing,
              dietaryFiber = Core.Nothing,
              dietaryFiberDailyPercentage = Core.Nothing, energy = Core.Nothing,
              energyFromFat = Core.Nothing, folateDailyPercentage = Core.Nothing,
              folateFolicAcid = Core.Nothing, folateMcgDfe = Core.Nothing,
              iron = Core.Nothing, ironDailyPercentage = Core.Nothing,
              monounsaturatedFat = Core.Nothing,
              nutritionFactMeasure = Core.Nothing, polyols = Core.Nothing,
              polyunsaturatedFat = Core.Nothing, potassium = Core.Nothing,
              potassiumDailyPercentage = Core.Nothing,
              preparedSizeDescription = Core.Nothing, protein = Core.Nothing,
              proteinDailyPercentage = Core.Nothing, saturatedFat = Core.Nothing,
              saturatedFatDailyPercentage = Core.Nothing,
              servingSizeDescription = Core.Nothing,
              servingSizeMeasure = Core.Nothing,
              servingsPerContainer = Core.Nothing, sodium = Core.Nothing,
              sodiumDailyPercentage = Core.Nothing, starch = Core.Nothing,
              totalCarbohydrate = Core.Nothing,
              totalCarbohydrateDailyPercentage = Core.Nothing,
              totalFat = Core.Nothing, totalFatDailyPercentage = Core.Nothing,
              totalSugars = Core.Nothing,
              totalSugarsDailyPercentage = Core.Nothing, transFat = Core.Nothing,
              transFatDailyPercentage = Core.Nothing, vitaminD = Core.Nothing,
              vitaminDDailyPercentage = Core.Nothing,
              voluntaryNutritionFact = Core.Nothing}
instance Core.FromJSON Nutrition where
        parseJSON
          = Core.withObject "Nutrition"
              (\ o ->
                 Nutrition Core.<$>
                   (o Core..:? "addedSugars") Core.<*>
                     (o Core..:? "addedSugarsDailyPercentage")
                     Core.<*> (o Core..:? "calcium")
          ...
          = Core.object
              (Core.catMaybes
                 [("addedSugars" Core..=) Core.<$> addedSugars,
                  ("addedSugarsDailyPercentage" Core..=) Core.<$>
                  ...
                  ("cholesterolDailyPercentage" Core..=) Core.<$>
                    cholesterolDailyPercentage,
                  ("dietaryFiber" Core..=) Core.<$> dietaryFiber,
                  ("dietaryFiberDailyPercentage" Core..=) Core.<$>
                  ...
                  ("potassiumDailyPercentage" Core..=) Core.<$>
                    potassiumDailyPercentage,
                  ("preparedSizeDescription" Core..=) Core.<$>
                  ...
                  ("saturatedFatDailyPercentage" Core..=) Core.<$>
...
instance Core.FromJSON Price where
        parseJSON
          = Core.withObject "Price"
              (\ o ->
                 Price Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "currency"))
...
newProduct 
    ::  Product
newProduct
  = Product{attributes = Core.Nothing,
            contentLanguage = Core.Nothing, destinationStatuses = Core.Nothing,
            feedLabel = Core.Nothing, issues = Core.Nothing,
            name = Core.Nothing, parent = Core.Nothing,
            productId = Core.Nothing, targetCountry = Core.Nothing}
instance Core.FromJSON Product where
        parseJSON
          = Core.withObject "Product"
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "attributes") Core.<*> (o Core..:? "contentLanguage")
          ...
          = Core.object
              (Core.catMaybes
                 [("attributes" Core..=) Core.<$> attributes,
                  ...
                  ("issues" Core..=) Core.<$> issues, ("name" Core..=) Core.<$> name,
...
newProductCertification 
    ::  ProductCertification
newProductCertification
  = ProductCertification{brand = Core.Nothing,
                         certification = Core.Nothing, countryCode = Core.Nothing,
                         destinationStatuses = Core.Nothing, issues = Core.Nothing,
                         mpn = Core.Nothing, name = Core.Nothing,
                         productCode = Core.Nothing, productType = Core.Nothing,
                         title = Core.Nothing}
instance Core.FromJSON ProductCertification where
        parseJSON
          = Core.withObject "ProductCertification"
              (\ o ->
                 ProductCertification Core.<$>
                   (o Core..:? "brand") Core.<*> (o Core..:? "certification") Core.<*>
                     (o Core..:? "countryCode")
                     Core.<*> (o Core..:? "destinationStatuses")
                     Core.<*> (o Core..:? "issues")
                     Core.<*> (o Core..:? "mpn")
          ...
          = Core.object
              (Core.catMaybes
                 [("brand" Core..=) Core.<$> brand,
                  ...
                  ("destinationStatuses" Core..=) Core.<$> destinationStatuses,
                  ("issues" Core..=) Core.<$> issues, ("mpn" Core..=) Core.<$> mpn,
                  ("name" Core..=) Core.<$> name,
...
newProductDetail 
    ::  ProductDetail
newProductDetail
  = ProductDetail{attributeName = Core.Nothing,
                  attributeValue = Core.Nothing, sectionName = Core.Nothing}
instance Core.FromJSON ProductDetail where
        parseJSON
          = Core.withObject "ProductDetail"
              (\ o ->
                 ProductDetail Core.<$>
                   (o Core..:? "attributeName") Core.<*> (o Core..:? "attributeValue")
...
newVoluntaryNutritionFact 
    ::  VoluntaryNutritionFact
newVoluntaryNutritionFact
  = VoluntaryNutritionFact{dailyPercentage = Core.Nothing,
                           name = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON VoluntaryNutritionFact where
        parseJSON
          = Core.withObject "VoluntaryNutritionFact"
              (\ o ->
                 VoluntaryNutritionFact Core.<$>
                   (o Core..:? "dailyPercentage") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "value"))
