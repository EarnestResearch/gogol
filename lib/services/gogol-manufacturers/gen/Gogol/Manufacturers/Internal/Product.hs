...
instance Core.FromJSON Attributes where
        parseJSON
          = Core.withObject "Attributes"
              (\ o ->
                 Attributes Core.<$>
                   (o Core..:? "additionalImageLink") Core.<*>
                     (o Core..:? "ageGroup")
                     Core.<*> (o Core..:? "brand")
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalImageLink" Core..=) Core.<$>
                  ...
                  ("excludedDestination" Core..=) Core.<$>
                    excludedDestination,
                  ("featureDescription" Core..=) Core.<$>
                    featureDescription,
...
instance Core.FromJSON Certification where
        parseJSON
          = Core.withObject "Certification"
              (\ o ->
                 Certification Core.<$>
                   (o Core..:? "authority") Core.<*> (o Core..:? "link")
                     Core.<*> (o Core..:? "logo")
                     Core.<*> (o Core..:? "name")
...
newFeatureDescription =
  FeatureDescription
    {headline = Core.Nothing, image = Core.Nothing, text = Core.Nothing}
          ...
          = Core.withObject "FeatureDescription"
              (\ o ->
                 FeatureDescription Core.<$>
                   (o Core..:? "headline") Core.<*> (o Core..:? "image")
                     Core.<*> (o Core..:? "text"))
...
newListProductCertificationsResponse =
  ListProductCertificationsResponse
    {nextPageToken = Core.Nothing, productCertifications = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("productCertifications" Core..=) Core.<$>
              ...
              (\ o ->
                 Nutrition Core.<$>
                   (o Core..:? "addedSugars") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "totalCarbohydrateDailyPercentage")
          ...
          = Core.object
              (Core.catMaybes
                 [("addedSugars" Core..=) Core.<$> addedSugars,
                  ...
                  ("calciumDailyPercentage" Core..=) Core.<$>
                  ...
                  ("folateDailyPercentage" Core..=) Core.<$>
                    folateDailyPercentage,
                  ("folateFolicAcid" Core..=) Core.<$> folateFolicAcid,
                  ("folateMcgDfe" Core..=) Core.<$> folateMcgDfe,
                  ("iron" Core..=) Core.<$> iron,
                  ("ironDailyPercentage" Core..=) Core.<$>
                    ironDailyPercentage,
                  ("monounsaturatedFat" Core..=) Core.<$>
                    monounsaturatedFat,
                  ("nutritionFactMeasure" Core..=) Core.<$>
                    nutritionFactMeasure,
                  ("polyols" Core..=) Core.<$> polyols,
                  ("polyunsaturatedFat" Core..=) Core.<$>
                    polyunsaturatedFat,
                  ...
                  ("proteinDailyPercentage" Core..=) Core.<$>
                  ...
                  ("servingSizeDescription" Core..=) Core.<$>
                    servingSizeDescription,
                  ("servingSizeMeasure" Core..=) Core.<$>
                    servingSizeMeasure,
                  ("servingsPerContainer" Core..=) Core.<$>
                    servingsPerContainer,
                  ("sodium" Core..=) Core.<$> sodium,
                  ("sodiumDailyPercentage" Core..=) Core.<$>
                    sodiumDailyPercentage,
                  ("starch" Core..=) Core.<$> starch,
                  ("totalCarbohydrate" Core..=) Core.<$>
                    totalCarbohydrate,
...
instance Core.FromJSON ProductDetail where
        parseJSON
          = Core.withObject "ProductDetail"
              (\ o ->
                 ProductDetail Core.<$>
                   (o Core..:? "attributeName") Core.<*>
                     (o Core..:? "attributeValue")
...
newVoluntaryNutritionFact =
  VoluntaryNutritionFact
    {dailyPercentage = Core.Nothing, name = Core.Nothing, value = Core.Nothing}
