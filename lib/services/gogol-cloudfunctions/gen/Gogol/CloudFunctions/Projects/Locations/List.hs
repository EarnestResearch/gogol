...
newCloudFunctionsProjectsLocationsList name
  = CloudFunctionsProjectsLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudFunctionsProjectsLocationsList
         where
        type Rs CloudFunctionsProjectsLocationsList = ListLocationsResponse
        type Scopes CloudFunctionsProjectsLocationsList =
        ...
        requestClient CloudFunctionsProjectsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudFunctionsProjectsLocationsListResource)
                      Core.mempty
