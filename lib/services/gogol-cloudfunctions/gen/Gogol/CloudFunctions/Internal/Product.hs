...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "BuildConfig_EnvironmentVariables"
              (\ o ->
                 BuildConfig_EnvironmentVariables Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON BuildConfig_EnvironmentVariables
         where
...
newEventFilter =
  EventFilter
    {attribute = Core.Nothing, operator = Core.Nothing, value = Core.Nothing}
...
newFunction_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Function_Labels
newFunction_Labels additional = Function_Labels {additional = additional}
...
instance Core.FromJSON GenerateDownloadUrlRequest
         where
        parseJSON
...
instance Core.FromJSON GenerateDownloadUrlResponse
         where
        parseJSON
          = Core.withObject "GenerateDownloadUrlResponse"
              (\ o ->
                 GenerateDownloadUrlResponse Core.<$>
                   (o Core..:? "downloadUrl"))

instance Core.ToJSON GenerateDownloadUrlResponse
         where
...
newGenerateUploadUrlResponse =
  GenerateUploadUrlResponse
    {storageSource = Core.Nothing, uploadUrl = Core.Nothing}

instance Core.FromJSON GenerateUploadUrlResponse
         where
        parseJSON
          = Core.withObject "GenerateUploadUrlResponse"
              (\ o ->
                 GenerateUploadUrlResponse Core.<$>
                   (o Core..:? "storageSource") Core.<*>
                     (o Core..:? "uploadUrl"))
...
newGoogleCloudFunctionsV2LocationMetadata 
    ::  GoogleCloudFunctionsV2LocationMetadata
newGoogleCloudFunctionsV2LocationMetadata =
  GoogleCloudFunctionsV2LocationMetadata {environments = Core.Nothing}
...
instance Core.FromJSON GoogleCloudFunctionsV2Stage
         where
        parseJSON
          = Core.withObject "GoogleCloudFunctionsV2Stage"
              (\ o ->
                 GoogleCloudFunctionsV2Stage Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "resource")
                     Core.<*> (o Core..:? "resourceUri")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "stateMessages"))

instance Core.ToJSON GoogleCloudFunctionsV2Stage
         where
...
newGoogleCloudFunctionsV2StateMessage =
  GoogleCloudFunctionsV2StateMessage
    {message = Core.Nothing, severity = Core.Nothing, type' = Core.Nothing}
...
-- | Extra GCF specific location information.
--
-- /See:/ 'newGoogleCloudFunctionsV2alphaLocationMetadata' smart constructor.
newtype GoogleCloudFunctionsV2alphaLocationMetadata = GoogleCloudFunctionsV2alphaLocationMetadata
    {
      -- | The Cloud Function environments this location supports.
      environments :: (Core.Maybe
...
-- | Creates a value of 'GoogleCloudFunctionsV2alphaLocationMetadata' with the minimum fields required to make a request.
newGoogleCloudFunctionsV2alphaLocationMetadata 
    ::  GoogleCloudFunctionsV2alphaLocationMetadata
newGoogleCloudFunctionsV2alphaLocationMetadata =
  GoogleCloudFunctionsV2alphaLocationMetadata {environments = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudFunctionsV2alphaLocationMetadata"
              (\ o ->
                 GoogleCloudFunctionsV2alphaLocationMetadata Core.<$>
                   (o Core..:? "environments"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudFunctionsV2alphaOperationMetadata"
              (\ o ->
                 GoogleCloudFunctionsV2alphaOperationMetadata Core.<$>
                   (o Core..:? "apiVersion") Core.<*>
                     (o Core..:? "cancelRequested")
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "endTime")
...
newGoogleCloudFunctionsV2alphaOperationMetadata_RequestResource 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. Contains field \@type with type URL. See 'additional'.
    -> GoogleCloudFunctionsV2alphaOperationMetadata_RequestResource
newGoogleCloudFunctionsV2alphaOperationMetadata_RequestResource additional =
  GoogleCloudFunctionsV2alphaOperationMetadata_RequestResource
    {additional = additional}
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudFunctionsV2alphaStage"
              (\ o ->
                 GoogleCloudFunctionsV2alphaStage Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "resource")
                     Core.<*> (o Core..:? "resourceUri")
                     Core.<*> (o Core..:? "state")
...
instance Core.ToJSON GoogleCloudFunctionsV2alphaStage
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudFunctionsV2alphaStateMessage"
              (\ o ->
                 GoogleCloudFunctionsV2alphaStateMessage Core.<$>
                   (o Core..:? "message") Core.<*>
                     (o Core..:? "severity")
                     Core.<*> (o Core..:? "type"))
...
-- | Extra GCF specific location information.
--
-- /See:/ 'newGoogleCloudFunctionsV2betaLocationMetadata' smart constructor.
newtype GoogleCloudFunctionsV2betaLocationMetadata = GoogleCloudFunctionsV2betaLocationMetadata
    {
      -- | The Cloud Function environments this location supports.
      environments :: (Core.Maybe
...
-- | Creates a value of 'GoogleCloudFunctionsV2betaLocationMetadata' with the minimum fields required to make a request.
newGoogleCloudFunctionsV2betaLocationMetadata 
    ::  GoogleCloudFunctionsV2betaLocationMetadata
newGoogleCloudFunctionsV2betaLocationMetadata =
  GoogleCloudFunctionsV2betaLocationMetadata {environments = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudFunctionsV2betaLocationMetadata"
              (\ o ->
                 GoogleCloudFunctionsV2betaLocationMetadata Core.<$>
                   (o Core..:? "environments"))

instance Core.ToJSON
           GoogleCloudFunctionsV2betaLocationMetadata
         where
        toJSON GoogleCloudFunctionsV2betaLocationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("environments" Core..=) Core.<$> environments])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudFunctionsV2betaOperationMetadata"
              (\ o ->
                 GoogleCloudFunctionsV2betaOperationMetadata Core.<$>
                   (o Core..:? "apiVersion") Core.<*>
                     (o Core..:? "cancelRequested")
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "endTime")
...
newGoogleCloudFunctionsV2betaOperationMetadata_RequestResource 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. Contains field \@type with type URL. See 'additional'.
    -> GoogleCloudFunctionsV2betaOperationMetadata_RequestResource
newGoogleCloudFunctionsV2betaOperationMetadata_RequestResource additional =
  GoogleCloudFunctionsV2betaOperationMetadata_RequestResource
    {additional = additional}
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudFunctionsV2betaStage"
              (\ o ->
                 GoogleCloudFunctionsV2betaStage Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "resource")
                     Core.<*> (o Core..:? "resourceUri")
                     Core.<*> (o Core..:? "state")
...
instance Core.ToJSON GoogleCloudFunctionsV2betaStage
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudFunctionsV2betaStateMessage"
              (\ o ->
                 GoogleCloudFunctionsV2betaStateMessage Core.<$>
                   (o Core..:? "message") Core.<*>
                     (o Core..:? "severity")
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("buildId" Core..=) Core.<$> buildId,
                  ...
                  ("type" Core..=) Core.<$> type',
                  ("updateTime" Core..=) Core.<$> updateTime,
                  ("versionId" Core..=) Core.. Core.AsText Core.<$>
                    versionId])
...
instance Core.FromJSON OperationMetadataV1_Request
         where
        parseJSON
          = Core.withObject "OperationMetadataV1_Request"
              (\ o ->
                 OperationMetadataV1_Request Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON OperationMetadataV1_Request
         where
...
instance Core.FromJSON SecretEnvVar where
        parseJSON
          = Core.withObject "SecretEnvVar"
              (\ o ->
                 SecretEnvVar Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "secret")
                     Core.<*> (o Core..:? "version"))
...
newSourceProvenance =
  SourceProvenance
    {resolvedRepoSource = Core.Nothing, resolvedStorageSource = Core.Nothing}
          ...
          = Core.withObject "SourceProvenance"
              (\ o ->
                 SourceProvenance Core.<$>
                   (o Core..:? "resolvedRepoSource") Core.<*>
                     (o Core..:? "resolvedStorageSource"))
