...
--
-- /See:/ 'newAbortFunctionUpgradeRequest' smart constructor.
data AbortFunctionUpgradeRequest = AbortFunctionUpgradeRequest
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AbortFunctionUpgradeRequest' with the minimum fields required to make a request.
newAbortFunctionUpgradeRequest 
    ::  AbortFunctionUpgradeRequest
newAbortFunctionUpgradeRequest = AbortFunctionUpgradeRequest
instance Core.FromJSON AbortFunctionUpgradeRequest where
        parseJSON
          = Core.withObject "AbortFunctionUpgradeRequest"
              (\ o -> Core.pure AbortFunctionUpgradeRequest)

instance Core.ToJSON AbortFunctionUpgradeRequest where
...
--
-- /See:/ 'newAutomaticUpdatePolicy' smart constructor.
data AutomaticUpdatePolicy = AutomaticUpdatePolicy
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AutomaticUpdatePolicy' with the minimum fields required to make a request.
newAutomaticUpdatePolicy 
    ::  AutomaticUpdatePolicy
newAutomaticUpdatePolicy = AutomaticUpdatePolicy
instance Core.FromJSON AutomaticUpdatePolicy where
        parseJSON
          = Core.withObject "AutomaticUpdatePolicy"
              (\ o -> Core.pure AutomaticUpdatePolicy)

instance Core.ToJSON AutomaticUpdatePolicy where
        toJSON = Core.const Core.emptyObject
...
data BuildConfig = BuildConfig
    ...
    , onDeployUpdatePolicy :: (Core.Maybe OnDeployUpdatePolicy)
...
newBuildConfig 
    ::  BuildConfig
newBuildConfig
  = BuildConfig{automaticUpdatePolicy = Core.Nothing,
                build = Core.Nothing, dockerRegistry = Core.Nothing,
                dockerRepository = Core.Nothing, entryPoint = Core.Nothing,
                environmentVariables = Core.Nothing,
                onDeployUpdatePolicy = Core.Nothing, runtime = Core.Nothing,
                serviceAccount = Core.Nothing, source = Core.Nothing,
                sourceProvenance = Core.Nothing, sourceToken = Core.Nothing,
                workerPool = Core.Nothing}
instance Core.FromJSON BuildConfig where
        parseJSON
          = Core.withObject "BuildConfig"
              (\ o ->
                 BuildConfig Core.<$>
                   (o Core..:? "automaticUpdatePolicy") Core.<*> (o Core..:? "build")
                     Core.<*> (o Core..:? "dockerRegistry")
                     Core.<*> (o Core..:? "dockerRepository")
                     Core.<*> (o Core..:? "entryPoint")
                     Core.<*> (o Core..:? "environmentVariables")
                     Core.<*> (o Core..:? "onDeployUpdatePolicy")
                     Core.<*> (o Core..:? "runtime")
...
instance Core.ToJSON BuildConfig where
        toJSON BuildConfig{..}
          = Core.object
              (Core.catMaybes
                 [("automaticUpdatePolicy" Core..=) Core.<$> automaticUpdatePolicy,
                  ("build" Core..=) Core.<$> build,
                  ("dockerRegistry" Core..=) Core.<$> dockerRegistry,
                  ("dockerRepository" Core..=) Core.<$> dockerRepository,
                  ("entryPoint" Core..=) Core.<$> entryPoint,
                  ("environmentVariables" Core..=) Core.<$> environmentVariables,
                  ("onDeployUpdatePolicy" Core..=) Core.<$> onDeployUpdatePolicy,
...
newBuildConfig_EnvironmentVariables 
    :: 
       ...
       -- ^  See 'additional'.
    -> BuildConfig_EnvironmentVariables
newBuildConfig_EnvironmentVariables additional
  = BuildConfig_EnvironmentVariables{additional = additional}
instance Core.FromJSON BuildConfig_EnvironmentVariables where
        parseJSON
          = Core.withObject "BuildConfig_EnvironmentVariables"
              (\ o ->
                 BuildConfig_EnvironmentVariables Core.<$> (Core.parseJSONObject o))
...
--
-- /See:/ 'newCommitFunctionUpgradeRequest' smart constructor.
data CommitFunctionUpgradeRequest = CommitFunctionUpgradeRequest
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CommitFunctionUpgradeRequest' with the minimum fields required to make a request.
newCommitFunctionUpgradeRequest 
    ::  CommitFunctionUpgradeRequest
newCommitFunctionUpgradeRequest = CommitFunctionUpgradeRequest
instance Core.FromJSON CommitFunctionUpgradeRequest where
        parseJSON
          = Core.withObject "CommitFunctionUpgradeRequest"
              (\ o -> Core.pure CommitFunctionUpgradeRequest)

instance Core.ToJSON CommitFunctionUpgradeRequest where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON DetachFunctionRequest where
        parseJSON
          = Core.withObject "DetachFunctionRequest"
...
newEventFilter 
    ::  EventFilter
newEventFilter
  = EventFilter{attribute = Core.Nothing, operator = Core.Nothing,
                value = Core.Nothing}
instance Core.FromJSON EventFilter where
        parseJSON
          = Core.withObject "EventFilter"
              (\ o ->
                 EventFilter Core.<$>
                   (o Core..:? "attribute") Core.<*> (o Core..:? "operator") Core.<*>
                     (o Core..:? "value"))
...
newEventTrigger 
    ::  EventTrigger
newEventTrigger
  = EventTrigger{channel = Core.Nothing, eventFilters = Core.Nothing,
                 eventType = Core.Nothing, pubsubTopic = Core.Nothing,
                 retryPolicy = Core.Nothing, service = Core.Nothing,
                 serviceAccountEmail = Core.Nothing, trigger = Core.Nothing,
                 triggerRegion = Core.Nothing}
instance Core.FromJSON EventTrigger where
        parseJSON
          = Core.withObject "EventTrigger"
              (\ o ->
                 EventTrigger Core.<$>
                   (o Core..:? "channel") Core.<*> (o Core..:? "eventFilters")
...
data Function = Function
    ...
    , upgradeInfo :: (Core.Maybe UpgradeInfo)
...
newFunction 
    ::  Function
newFunction
  = Function{buildConfig = Core.Nothing, createTime = Core.Nothing,
             description = Core.Nothing, environment = Core.Nothing,
             eventTrigger = Core.Nothing, kmsKeyName = Core.Nothing,
             labels = Core.Nothing, name = Core.Nothing,
             satisfiesPzi = Core.Nothing, satisfiesPzs = Core.Nothing,
             serviceConfig = Core.Nothing, state = Core.Nothing,
             stateMessages = Core.Nothing, updateTime = Core.Nothing,
             upgradeInfo = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Function where
        parseJSON
          = Core.withObject "Function"
              (\ o ->
                 Function Core.<$>
                   (o Core..:? "buildConfig") Core.<*> (o Core..:? "createTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("buildConfig" Core..=) Core.<$> buildConfig,
                  ...
                  ("upgradeInfo" Core..=) Core.<$> upgradeInfo,
                  ("url" Core..=) Core.<$> url])
...
newFunction_Labels 
    :: 
       ...
       -- ^  See 'additional'.
    -> Function_Labels
newFunction_Labels additional
  = Function_Labels{additional = additional}
instance Core.FromJSON Function_Labels where
        parseJSON
          = Core.withObject "Function_Labels"
              (\ o -> Function_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Function_Labels where
        toJSON Function_Labels{..} = Core.toJSON additional
...
instance Core.FromJSON GenerateDownloadUrlRequest where
        parseJSON
          = Core.withObject "GenerateDownloadUrlRequest"
...
instance Core.FromJSON GenerateDownloadUrlResponse where
        parseJSON
          = Core.withObject "GenerateDownloadUrlResponse"
              (\ o ->
                 GenerateDownloadUrlResponse Core.<$> (o Core..:? "downloadUrl"))

instance Core.ToJSON GenerateDownloadUrlResponse where
        toJSON GenerateDownloadUrlResponse{..}
          = Core.object
              (Core.catMaybes [("downloadUrl" Core..=) Core.<$> downloadUrl])
...
data GenerateUploadUrlRequest = GenerateUploadUrlRequest
    {
      ...
      environment :: (Core.Maybe GenerateUploadUrlRequest_Environment)
...
newGenerateUploadUrlRequest 
    ::  GenerateUploadUrlRequest
newGenerateUploadUrlRequest
  = GenerateUploadUrlRequest{environment = Core.Nothing,
                             kmsKeyName = Core.Nothing}
instance Core.FromJSON GenerateUploadUrlRequest where
        parseJSON
          = Core.withObject "GenerateUploadUrlRequest"
              (\ o ->
                 GenerateUploadUrlRequest Core.<$>
                   (o Core..:? "environment") Core.<*> (o Core..:? "kmsKeyName"))
...
newGenerateUploadUrlResponse 
    ::  GenerateUploadUrlResponse
newGenerateUploadUrlResponse
  = GenerateUploadUrlResponse{storageSource = Core.Nothing,
                              uploadUrl = Core.Nothing}
instance Core.FromJSON GenerateUploadUrlResponse where
        parseJSON
          = Core.withObject "GenerateUploadUrlResponse"
              (\ o ->
                 GenerateUploadUrlResponse Core.<$>
                   (o Core..:? "storageSource") Core.<*> (o Core..:? "uploadUrl"))
...
--
-- /See:/ 'newGoogleCloudFunctionsV2LocationMetadata' smart constructor.
newtype GoogleCloudFunctionsV2LocationMetadata = GoogleCloudFunctionsV2LocationMetadata
    {
      -- | The Cloud Function environments this location supports.
      environments :: (Core.Maybe
   [GoogleCloudFunctionsV2LocationMetadata_EnvironmentsItem])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleCloudFunctionsV2LocationMetadata' with the minimum fields required to make a request.
newGoogleCloudFunctionsV2LocationMetadata 
    :: 
                                          GoogleCloudFunctionsV2LocationMetadata
newGoogleCloudFunctionsV2LocationMetadata
  = GoogleCloudFunctionsV2LocationMetadata{environments =
                                             Core.Nothing}
instance Core.FromJSON GoogleCloudFunctionsV2LocationMetadata where
        parseJSON
          = Core.withObject "GoogleCloudFunctionsV2LocationMetadata"
              (\ o ->
                 GoogleCloudFunctionsV2LocationMetadata Core.<$>
                   (o Core..:? "environments"))

instance Core.ToJSON GoogleCloudFunctionsV2LocationMetadata where
        toJSON GoogleCloudFunctionsV2LocationMetadata{..}
          = Core.object
              (Core.catMaybes [("environments" Core..=) Core.<$> environments])
...
data GoogleCloudFunctionsV2OperationMetadata = GoogleCloudFunctionsV2OperationMetadata
    ...
    , endTime :: (Core.Maybe Core.DateTime)
      -- | The operation type.
    , operationType :: (Core.Maybe GoogleCloudFunctionsV2OperationMetadata_OperationType)
      -- | The original request that started the operation.
    , requestResource :: (Core.Maybe
   GoogleCloudFunctionsV2OperationMetadata_RequestResource)
      -- | An identifier for Firebase function sources. Disclaimer: This field is only supported for Firebase function deployments.
    , sourceToken :: (Core.Maybe Core.Text)
...
newGoogleCloudFunctionsV2OperationMetadata 
    :: 
                                           GoogleCloudFunctionsV2OperationMetadata
newGoogleCloudFunctionsV2OperationMetadata
  = GoogleCloudFunctionsV2OperationMetadata{apiVersion =
                                              Core.Nothing,
                                            buildName = Core.Nothing,
                                            cancelRequested = Core.Nothing,
                                            createTime = Core.Nothing,
                                            customIamRoleDetected = Core.Nothing,
                                            endTime = Core.Nothing, operationType = Core.Nothing,
                                            requestResource = Core.Nothing,
                                            sourceToken = Core.Nothing, stages = Core.Nothing,
                                            statusDetail = Core.Nothing, target = Core.Nothing,
                                            verb = Core.Nothing}
instance Core.FromJSON GoogleCloudFunctionsV2OperationMetadata
         where
        parseJSON
          = Core.withObject "GoogleCloudFunctionsV2OperationMetadata"
              (\ o ->
                 GoogleCloudFunctionsV2OperationMetadata Core.<$>
                   (o Core..:? "apiVersion") Core.<*> (o Core..:? "buildName")
...
instance Core.ToJSON GoogleCloudFunctionsV2OperationMetadata where
...
newGoogleCloudFunctionsV2OperationMetadata_RequestResource
  additional
  = GoogleCloudFunctionsV2OperationMetadata_RequestResource{additional
                                                              = additional}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudFunctionsV2OperationMetadata_RequestResource"
              (\ o ->
                 GoogleCloudFunctionsV2OperationMetadata_RequestResource Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           GoogleCloudFunctionsV2OperationMetadata_RequestResource
         where
        toJSON GoogleCloudFunctionsV2OperationMetadata_RequestResource{..}
          = Core.toJSON additional
...
newGoogleCloudFunctionsV2Stage 
    ::  GoogleCloudFunctionsV2Stage
newGoogleCloudFunctionsV2Stage
  = GoogleCloudFunctionsV2Stage{message = Core.Nothing,
                                name = Core.Nothing, resource = Core.Nothing,
                                resourceUri = Core.Nothing, state = Core.Nothing,
                                stateMessages = Core.Nothing}
instance Core.FromJSON GoogleCloudFunctionsV2Stage where
        parseJSON
          = Core.withObject "GoogleCloudFunctionsV2Stage"
              (\ o ->
                 GoogleCloudFunctionsV2Stage Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "resource")
...
newGoogleCloudFunctionsV2StateMessage 
    :: 
                                      GoogleCloudFunctionsV2StateMessage
newGoogleCloudFunctionsV2StateMessage
  = GoogleCloudFunctionsV2StateMessage{message = Core.Nothing,
                                       severity = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON GoogleCloudFunctionsV2StateMessage where
        parseJSON
          = Core.withObject "GoogleCloudFunctionsV2StateMessage"
              (\ o ->
                 GoogleCloudFunctionsV2StateMessage Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "severity") Core.<*>
                     (o Core..:? "type"))

instance Core.ToJSON GoogleCloudFunctionsV2StateMessage where
...
instance Core.FromJSON ListFunctionsResponse where
        parseJSON
          = Core.withObject "ListFunctionsResponse"
              (\ o ->
                 ListFunctionsResponse Core.<$>
                   (o Core..:? "functions") Core.<*> (o Core..:? "nextPageToken")
...
--
-- /See:/ 'newOnDeployUpdatePolicy' smart constructor.
newtype OnDeployUpdatePolicy = OnDeployUpdatePolicy
    {
...
-- | Creates a value of 'OnDeployUpdatePolicy' with the minimum fields required to make a request.
newOnDeployUpdatePolicy 
    ::  OnDeployUpdatePolicy
newOnDeployUpdatePolicy
  = OnDeployUpdatePolicy{runtimeVersion = Core.Nothing}
instance Core.FromJSON OnDeployUpdatePolicy where
        parseJSON
          = Core.withObject "OnDeployUpdatePolicy"
              (\ o ->
                 OnDeployUpdatePolicy Core.<$> (o Core..:? "runtimeVersion"))

instance Core.ToJSON OnDeployUpdatePolicy where
        toJSON OnDeployUpdatePolicy{..}
          = Core.object
              (Core.catMaybes
...
newOperationMetadataV1 
    ::  OperationMetadataV1
newOperationMetadataV1
  = OperationMetadataV1{buildId = Core.Nothing,
                        buildName = Core.Nothing, request' = Core.Nothing,
                        sourceToken = Core.Nothing, target = Core.Nothing,
          ...
          = Core.withObject "OperationMetadataV1"
              (\ o ->
                 OperationMetadataV1 Core.<$>
                   (o Core..:? "buildId") Core.<*> (o Core..:? "buildName") Core.<*>
                     (o Core..:? "request")
                     Core.<*> (o Core..:? "sourceToken")
                     Core.<*> (o Core..:? "target")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "updateTime")
                     Core.<*>
                     (o Core..:? "versionId" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("buildId" Core..=) Core.<$> buildId,
                  ...
                  ("type" Core..=) Core.<$> type',
                  ("updateTime" Core..=) Core.<$> updateTime,
                  ("versionId" Core..=) Core.. Core.AsText Core.<$> versionId])
...
newOperationMetadataV1_Request 
    :: 
       ...
       -- ^  Properties of the object. Contains field \@type with type URL. See 'additional'.
    -> OperationMetadataV1_Request
newOperationMetadataV1_Request additional
  = OperationMetadataV1_Request{additional = additional}
instance Core.FromJSON OperationMetadataV1_Request where
        parseJSON
          = Core.withObject "OperationMetadataV1_Request"
              (\ o ->
                 OperationMetadataV1_Request Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON OperationMetadataV1_Request where
        toJSON OperationMetadataV1_Request{..} = Core.toJSON additional
...
--
-- /See:/ 'newRedirectFunctionUpgradeTrafficRequest' smart constructor.
data RedirectFunctionUpgradeTrafficRequest = RedirectFunctionUpgradeTrafficRequest
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RedirectFunctionUpgradeTrafficRequest' with the minimum fields required to make a request.
newRedirectFunctionUpgradeTrafficRequest 
    :: 
                                         RedirectFunctionUpgradeTrafficRequest
newRedirectFunctionUpgradeTrafficRequest
  = RedirectFunctionUpgradeTrafficRequest
instance Core.FromJSON RedirectFunctionUpgradeTrafficRequest where
        parseJSON
          = Core.withObject "RedirectFunctionUpgradeTrafficRequest"
              (\ o -> Core.pure RedirectFunctionUpgradeTrafficRequest)

instance Core.ToJSON RedirectFunctionUpgradeTrafficRequest where
        toJSON = Core.const Core.emptyObject
...
newRepoSource 
    ::  RepoSource
newRepoSource
  = RepoSource{branchName = Core.Nothing, commitSha = Core.Nothing,
               dir = Core.Nothing, projectId = Core.Nothing,
               repoName = Core.Nothing, tagName = Core.Nothing}
instance Core.FromJSON RepoSource where
        parseJSON
          = Core.withObject "RepoSource"
              (\ o ->
                 RepoSource Core.<$>
...
--
-- /See:/ 'newRollbackFunctionUpgradeTrafficRequest' smart constructor.
data RollbackFunctionUpgradeTrafficRequest = RollbackFunctionUpgradeTrafficRequest
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RollbackFunctionUpgradeTrafficRequest' with the minimum fields required to make a request.
newRollbackFunctionUpgradeTrafficRequest 
    :: 
                                         RollbackFunctionUpgradeTrafficRequest
newRollbackFunctionUpgradeTrafficRequest
  = RollbackFunctionUpgradeTrafficRequest
instance Core.FromJSON RollbackFunctionUpgradeTrafficRequest where
        parseJSON
          = Core.withObject "RollbackFunctionUpgradeTrafficRequest"
              (\ o -> Core.pure RollbackFunctionUpgradeTrafficRequest)

instance Core.ToJSON RollbackFunctionUpgradeTrafficRequest where
        toJSON = Core.const Core.emptyObject
...
data Runtime = Runtime
    {
      ...
      decommissionDate :: (Core.Maybe Date)
...
instance Core.ToJSON Runtime where
        toJSON Runtime{..}
          = Core.object
              (Core.catMaybes
                 [("decommissionDate" Core..=) Core.<$> decommissionDate,
...
newSecretEnvVar 
    ::  SecretEnvVar
newSecretEnvVar
  = SecretEnvVar{key = Core.Nothing, projectId = Core.Nothing,
                 secret = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON SecretEnvVar where
        parseJSON
          = Core.withObject "SecretEnvVar"
              (\ o ->
                 SecretEnvVar Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "projectId") Core.<*>
                     (o Core..:? "secret")
                     Core.<*> (o Core..:? "version"))
...
newSecretVersion 
    ::  SecretVersion
newSecretVersion
  = SecretVersion{path = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON SecretVersion where
        parseJSON
          = Core.withObject "SecretVersion"
              (\ o ->
                 SecretVersion Core.<$>
                   (o Core..:? "path") Core.<*> (o Core..:? "version"))
...
newSecretVolume 
    ::  SecretVolume
newSecretVolume
  = SecretVolume{mountPath = Core.Nothing, projectId = Core.Nothing,
                 secret = Core.Nothing, versions = Core.Nothing}
instance Core.FromJSON SecretVolume where
        parseJSON
          = Core.withObject "SecretVolume"
              (\ o ->
                 SecretVolume Core.<$>
                   (o Core..:? "mountPath") Core.<*> (o Core..:? "projectId") Core.<*>
                     (o Core..:? "secret")
...
data ServiceConfig = ServiceConfig
    ...
    , binaryAuthorizationPolicy :: (Core.Maybe Core.Text)
...
newServiceConfig 
    ::  ServiceConfig
newServiceConfig
  = ServiceConfig{allTrafficOnLatestRevision = Core.Nothing,
                  availableCpu = Core.Nothing, availableMemory = Core.Nothing,
                  binaryAuthorizationPolicy = Core.Nothing,
                  environmentVariables = Core.Nothing,
                  ingressSettings = Core.Nothing, maxInstanceCount = Core.Nothing,
                  maxInstanceRequestConcurrency = Core.Nothing,
                  minInstanceCount = Core.Nothing, revision = Core.Nothing,
                  secretEnvironmentVariables = Core.Nothing,
                  secretVolumes = Core.Nothing, securityLevel = Core.Nothing,
                  service = Core.Nothing, serviceAccountEmail = Core.Nothing,
                  timeoutSeconds = Core.Nothing, uri = Core.Nothing,
                  vpcConnector = Core.Nothing,
                  vpcConnectorEgressSettings = Core.Nothing}
instance Core.FromJSON ServiceConfig where
        parseJSON
          = Core.withObject "ServiceConfig"
              (\ o ->
                 ServiceConfig Core.<$>
                   (o Core..:? "allTrafficOnLatestRevision") Core.<*>
                     (o Core..:? "availableCpu")
                     Core.<*> (o Core..:? "availableMemory")
                     Core.<*> (o Core..:? "binaryAuthorizationPolicy")
                     Core.<*> (o Core..:? "environmentVariables")
          ...
          = Core.object
              (Core.catMaybes
                 [("allTrafficOnLatestRevision" Core..=) Core.<$>
                  ...
                  ("secretEnvironmentVariables" Core..=) Core.<$>
                  ...
                  ("vpcConnectorEgressSettings" Core..=) Core.<$>
...
newServiceConfig_EnvironmentVariables 
    :: 
       ...
       -- ^  See 'additional'.
    -> ServiceConfig_EnvironmentVariables
newServiceConfig_EnvironmentVariables additional
  = ServiceConfig_EnvironmentVariables{additional = additional}
instance Core.FromJSON ServiceConfig_EnvironmentVariables where
        parseJSON
          = Core.withObject "ServiceConfig_EnvironmentVariables"
              (\ o ->
                 ServiceConfig_EnvironmentVariables Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ServiceConfig_EnvironmentVariables where
...
--
-- /See:/ 'newSetupFunctionUpgradeConfigRequest' smart constructor.
newtype SetupFunctionUpgradeConfigRequest = SetupFunctionUpgradeConfigRequest
    {
      ...
      triggerServiceAccount :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SetupFunctionUpgradeConfigRequest' with the minimum fields required to make a request.
newSetupFunctionUpgradeConfigRequest 
    :: 
                                     SetupFunctionUpgradeConfigRequest
newSetupFunctionUpgradeConfigRequest
  = SetupFunctionUpgradeConfigRequest{triggerServiceAccount =
                                        Core.Nothing}
instance Core.FromJSON SetupFunctionUpgradeConfigRequest where
        parseJSON
          = Core.withObject "SetupFunctionUpgradeConfigRequest"
              (\ o ->
                 SetupFunctionUpgradeConfigRequest Core.<$>
                   (o Core..:? "triggerServiceAccount"))

instance Core.ToJSON SetupFunctionUpgradeConfigRequest where
        toJSON SetupFunctionUpgradeConfigRequest{..}
          = Core.object
              (Core.catMaybes
                 [("triggerServiceAccount" Core..=) Core.<$> triggerServiceAccount])
...
newSource 
    ::  Source
newSource
  = Source{gitUri = Core.Nothing, repoSource = Core.Nothing,
...
instance Core.FromJSON Source where
        parseJSON
          = Core.withObject "Source"
              (\ o ->
                 Source Core.<$>
                   (o Core..:? "gitUri") Core.<*> (o Core..:? "repoSource") Core.<*>
                     (o Core..:? "storageSource"))

instance Core.ToJSON Source where
        toJSON Source{..}
          = Core.object
              (Core.catMaybes
                 [("gitUri" Core..=) Core.<$> gitUri,
...
data StorageSource = StorageSource
    ...
    , sourceUploadUrl :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newStorageSource 
    ::  StorageSource
newStorageSource
  = StorageSource{bucket = Core.Nothing, generation = Core.Nothing,
                  object = Core.Nothing, sourceUploadUrl = Core.Nothing}
instance Core.FromJSON StorageSource where
        parseJSON
          = Core.withObject "StorageSource"
              (\ o ->
                 StorageSource Core.<$>
                   (o Core..:? "bucket") Core.<*>
                     (o Core..:? "generation" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "object")
                     Core.<*> (o Core..:? "sourceUploadUrl"))
          ...
          = Core.object
              (Core.catMaybes
                 [("bucket" Core..=) Core.<$> bucket,
                  ...
                  ("sourceUploadUrl" Core..=) Core.<$> sourceUploadUrl])
...
data UpgradeInfo = UpgradeInfo
    ...
    , upgradeState :: (Core.Maybe UpgradeInfo_UpgradeState)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'UpgradeInfo' with the minimum fields required to make a request.
newUpgradeInfo 
    ::  UpgradeInfo
newUpgradeInfo
  = UpgradeInfo{buildConfig = Core.Nothing,
                eventTrigger = Core.Nothing, serviceConfig = Core.Nothing,
                upgradeState = Core.Nothing}
instance Core.FromJSON UpgradeInfo where
        parseJSON
          = Core.withObject "UpgradeInfo"
              (\ o ->
                 UpgradeInfo Core.<$>
                   (o Core..:? "buildConfig") Core.<*> (o Core..:? "eventTrigger")
                     Core.<*> (o Core..:? "serviceConfig")
                     Core.<*> (o Core..:? "upgradeState"))

instance Core.ToJSON UpgradeInfo where
        toJSON UpgradeInfo{..}
          = Core.object
              (Core.catMaybes
                 [("buildConfig" Core..=) Core.<$> buildConfig,
