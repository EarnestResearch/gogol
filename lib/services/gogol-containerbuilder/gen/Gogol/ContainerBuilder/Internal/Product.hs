...
instance Core.FromJSON ApprovalConfig where
        parseJSON
          = Core.withObject "ApprovalConfig"
              (\ o ->
                 ApprovalConfig Core.<$>
...
instance Core.FromJSON ApprovalResult where
        parseJSON
          = Core.withObject "ApprovalResult"
              (\ o ->
                 ApprovalResult Core.<$>
...
instance Core.FromJSON ApproveBuildRequest where
        parseJSON
          = Core.withObject "ApproveBuildRequest"
              (\ o ->
                 ApproveBuildRequest Core.<$>
                   (o Core..:? "approvalResult"))
...
instance Core.FromJSON ArtifactObjects where
        parseJSON
          = Core.withObject "ArtifactObjects"
              (\ o ->
                 ArtifactObjects Core.<$>
...
instance Core.FromJSON ArtifactResult where
        parseJSON
          = Core.withObject "ArtifactResult"
              (\ o ->
                 ArtifactResult Core.<$>
                   (o Core..:? "fileHash") Core.<*>
                     (o Core..:? "location"))
...
data Artifacts = Artifacts
    ...
    , npmPackages :: (Core.Maybe [NpmPackage])
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 BatchCreateBitbucketServerConnectedRepositoriesResponse
                   Core.<$>
                   (o Core..:? "bitbucketServerConnectedRepositories"))
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("gitlabConnectedRepositories" Core..=) Core.<$>
...
instance Core.FromJSON BitbucketServerConfig where
        parseJSON
          = Core.withObject "BitbucketServerConfig"
              (\ o ->
                 BitbucketServerConfig Core.<$>
                   (o Core..:? "apiKey") Core.<*>
                     (o Core..:? "connectedRepositories")
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "hostUri")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("apiKey" Core..=) Core.<$> apiKey,
                  ("connectedRepositories" Core..=) Core.<$>
...
newBitbucketServerConnectedRepository =
  BitbucketServerConnectedRepository
    {parent = Core.Nothing, repo = Core.Nothing, status = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 BitbucketServerConnectedRepository Core.<$>
                   (o Core..:? "parent") Core.<*> (o Core..:? "repo")
                     Core.<*> (o Core..:? "status"))
...
instance Core.FromJSON BitbucketServerRepository
         where
        parseJSON
          = Core.withObject "BitbucketServerRepository"
              (\ o ->
                 BitbucketServerRepository Core.<$>
                   (o Core..:? "browseUri") Core.<*>
                     (o Core..:? "description")
...
instance Core.FromJSON BitbucketServerRepositoryId
         where
        parseJSON
          = Core.withObject "BitbucketServerRepositoryId"
              (\ o ->
                 BitbucketServerRepositoryId Core.<$>
                   (o Core..:? "projectKey") Core.<*>
                     (o Core..:? "repoSlug")
                     Core.<*> (o Core..:? "webhookId"))

instance Core.ToJSON BitbucketServerRepositoryId
         where
...
instance Core.FromJSON BitbucketServerSecrets where
        parseJSON
          = Core.withObject "BitbucketServerSecrets"
              (\ o ->
                 BitbucketServerSecrets Core.<$>
                   (o Core..:? "adminAccessTokenVersionName") Core.<*>
                     (o Core..:? "readAccessTokenVersionName")
...
instance Core.ToJSON BitbucketServerSecrets where
        toJSON BitbucketServerSecrets{..}
          = Core.object
              (Core.catMaybes
                 [("adminAccessTokenVersionName" Core..=) Core.<$>
                    adminAccessTokenVersionName,
                  ("readAccessTokenVersionName" Core..=) Core.<$>
                    readAccessTokenVersionName,
                  ("webhookSecretVersionName" Core..=) Core.<$>
...
instance Core.FromJSON BitbucketServerTriggerConfig
         where
        parseJSON
          = Core.withObject "BitbucketServerTriggerConfig"
              (\ o ->
                 BitbucketServerTriggerConfig Core.<$>
                   (o Core..:? "bitbucketServerConfig") Core.<*>
                     (o Core..:? "bitbucketServerConfigResource")
                     Core.<*> (o Core..:? "projectKey")
                     Core.<*> (o Core..:? "pullRequest")
                     Core.<*> (o Core..:? "push")
                     Core.<*> (o Core..:? "repoSlug"))

instance Core.ToJSON BitbucketServerTriggerConfig
         where
        toJSON BitbucketServerTriggerConfig{..}
          = Core.object
              (Core.catMaybes
                 [("bitbucketServerConfig" Core..=) Core.<$>
                    bitbucketServerConfig,
                  ("bitbucketServerConfigResource" Core..=) Core.<$>
...
instance Core.FromJSON Build_Substitutions where
        parseJSON
          = Core.withObject "Build_Substitutions"
              (\ o ->
                 Build_Substitutions Core.<$>
...
instance Core.FromJSON BuildOperationMetadata where
        parseJSON
          = Core.withObject "BuildOperationMetadata"
              (\ o ->
...
instance Core.FromJSON BuildOptions where
        parseJSON
          = Core.withObject "BuildOptions"
              (\ o ->
                 BuildOptions Core.<$>
                   (o Core..:? "defaultLogsBucketBehavior") Core.<*>
...
instance Core.FromJSON BuildTrigger where
        parseJSON
          = Core.withObject "BuildTrigger"
              (\ o ->
                 BuildTrigger Core.<$>
                   (o Core..:? "approvalConfig") Core.<*>
                     (o Core..:? "autodetect")
          ...
          = Core.object
              (Core.catMaybes
                 [("approvalConfig" Core..=) Core.<$> approvalConfig,
                  ...
                  ("bitbucketServerTriggerConfig" Core..=) Core.<$>
                    bitbucketServerTriggerConfig,
...
instance Core.FromJSON BuildTrigger_Substitutions
         where
        parseJSON
          = Core.withObject "BuildTrigger_Substitutions"
              (\ o ->
                 BuildTrigger_Substitutions Core.<$>
                   (Core.parseJSONObject o))
...
newCancelBuildRequest =
  CancelBuildRequest
    {id = Core.Nothing, name = Core.Nothing, projectId = Core.Nothing}

instance Core.FromJSON CancelBuildRequest where
        parseJSON
          = Core.withObject "CancelBuildRequest"
              (\ o ->
                 CancelBuildRequest Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "CreateBitbucketServerConfigOperationMetadata"
              (\ o ->
                 CreateBitbucketServerConfigOperationMetadata Core.<$>
                   (o Core..:? "bitbucketServerConfig") Core.<*>
                     (o Core..:? "completeTime")
                     Core.<*> (o Core..:? "createTime"))
...
newCreateBitbucketServerConnectedRepositoryRequest =
  CreateBitbucketServerConnectedRepositoryRequest
    {bitbucketServerConnectedRepository = Core.Nothing, parent = Core.Nothing}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 CreateBitbucketServerConnectedRepositoryRequest
                   Core.<$>
                   (o Core..:? "bitbucketServerConnectedRepository")
                     Core.<*> (o Core..:? "parent"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "CreateGitLabConfigOperationMetadata"
              (\ o ->
                 CreateGitLabConfigOperationMetadata Core.<$>
                   (o Core..:? "completeTime") Core.<*>
                     (o Core..:? "createTime")
...
newCreateGitLabConnectedRepositoryRequest =
  CreateGitLabConnectedRepositoryRequest
    {gitlabConnectedRepository = Core.Nothing, parent = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "CreateGitLabConnectedRepositoryRequest"
              (\ o ->
                 CreateGitLabConnectedRepositoryRequest Core.<$>
                   (o Core..:? "gitlabConnectedRepository") Core.<*>
                     (o Core..:? "parent"))
...
instance Core.ToJSON
        ...
        toJSON CreateGitLabConnectedRepositoryRequest{..}
          = Core.object
              (Core.catMaybes
                 [("gitlabConnectedRepository" Core..=) Core.<$>
                    gitlabConnectedRepository,
                  ("parent" Core..=) Core.<$> parent])
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "CreateWorkerPoolOperationMetadata"
              (\ o ->
                 CreateWorkerPoolOperationMetadata Core.<$>
                   (o Core..:? "completeTime") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "workerPool"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "DeleteBitbucketServerConfigOperationMetadata"
              (\ o ->
                 DeleteBitbucketServerConfigOperationMetadata Core.<$>
                   (o Core..:? "bitbucketServerConfig") Core.<*>
                     (o Core..:? "completeTime")
                     Core.<*> (o Core..:? "createTime"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "DeleteGitLabConfigOperationMetadata"
              (\ o ->
                 DeleteGitLabConfigOperationMetadata Core.<$>
                   (o Core..:? "completeTime") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "gitlabConfig"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "DeleteWorkerPoolOperationMetadata"
              (\ o ->
                 DeleteWorkerPoolOperationMetadata Core.<$>
                   (o Core..:? "completeTime") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "workerPool"))
...
instance Core.FromJSON GitFileSource where
        parseJSON
          = Core.withObject "GitFileSource"
              (\ o ->
                 GitFileSource Core.<$>
                   (o Core..:? "bitbucketServerConfig") Core.<*>
                     (o Core..:? "githubEnterpriseConfig")
                     Core.<*> (o Core..:? "path")
...
instance Core.FromJSON GitHubEnterpriseConfig where
        parseJSON
          = Core.withObject "GitHubEnterpriseConfig"
              (\ o ->
...
instance Core.FromJSON GitHubEnterpriseSecrets where
        parseJSON
          = Core.withObject "GitHubEnterpriseSecrets"
              (\ o ->
                 GitHubEnterpriseSecrets Core.<$>
                   (o Core..:? "oauthClientIdName") Core.<*>
                     (o Core..:? "oauthClientIdVersionName")
...
instance Core.ToJSON GitHubEnterpriseSecrets where
        toJSON GitHubEnterpriseSecrets{..}
          = Core.object
              (Core.catMaybes
                 [("oauthClientIdName" Core..=) Core.<$>
                    oauthClientIdName,
                  ("oauthClientIdVersionName" Core..=) Core.<$>
                    oauthClientIdVersionName,
                  ("oauthSecretName" Core..=) Core.<$> oauthSecretName,
                  ("oauthSecretVersionName" Core..=) Core.<$>
                    oauthSecretVersionName,
                  ("privateKeyName" Core..=) Core.<$> privateKeyName,
                  ("privateKeyVersionName" Core..=) Core.<$>
                    privateKeyVersionName,
                  ("webhookSecretName" Core..=) Core.<$>
                    webhookSecretName,
                  ("webhookSecretVersionName" Core..=) Core.<$>
                    webhookSecretVersionName])
...
instance Core.FromJSON GitHubEventsConfig where
        parseJSON
          = Core.withObject "GitHubEventsConfig"
              (\ o ->
                 GitHubEventsConfig Core.<$>
                   (o Core..:? "enterpriseConfigResourceName") Core.<*>
                     (o Core..:? "installationId" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "owner")
                     Core.<*> (o Core..:? "pullRequest")
...
instance Core.ToJSON GitHubEventsConfig where
        toJSON GitHubEventsConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enterpriseConfigResourceName" Core..=) Core.<$>
...
instance Core.FromJSON GitLabConfig where
        parseJSON
          = Core.withObject "GitLabConfig"
              (\ o ->
                 GitLabConfig Core.<$>
                   (o Core..:? "connectedRepositories") Core.<*>
                     (o Core..:? "createTime")
...
instance Core.FromJSON GitLabConnectedRepository
         where
        parseJSON
          = Core.withObject "GitLabConnectedRepository"
              (\ o ->
...
instance Core.FromJSON GitLabEnterpriseConfig where
        parseJSON
          = Core.withObject "GitLabEnterpriseConfig"
              (\ o ->
                 GitLabEnterpriseConfig Core.<$>
                   (o Core..:? "hostUri") Core.<*>
                     (o Core..:? "serviceDirectoryConfig")
                     Core.<*> (o Core..:? "sslCa"))
...
instance Core.FromJSON GitLabEventsConfig where
        parseJSON
          = Core.withObject "GitLabEventsConfig"
              (\ o ->
                 GitLabEventsConfig Core.<$>
                   (o Core..:? "gitlabConfig") Core.<*>
                     (o Core..:? "gitlabConfigResource")
...
instance Core.ToJSON GitLabEventsConfig where
        toJSON GitLabEventsConfig{..}
          = Core.object
              (Core.catMaybes
                 [("gitlabConfig" Core..=) Core.<$> gitlabConfig,
                  ("gitlabConfigResource" Core..=) Core.<$>
                    gitlabConfigResource,
                  ("projectNamespace" Core..=) Core.<$>
                    projectNamespace,
                  ("pullRequest" Core..=) Core.<$> pullRequest,
                  ("push" Core..=) Core.<$> push])
...
instance Core.FromJSON GitLabRepository where
        parseJSON
          = Core.withObject "GitLabRepository"
              (\ o ->
                 GitLabRepository Core.<$>
                   (o Core..:? "browseUri") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON GitLabRepositoryId where
        parseJSON
          = Core.withObject "GitLabRepositoryId"
              (\ o ->
                 GitLabRepositoryId Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "webhookId"))
...
instance Core.FromJSON GitLabSecrets where
        parseJSON
          = Core.withObject "GitLabSecrets"
              (\ o ->
                 GitLabSecrets Core.<$>
                   (o Core..:? "apiAccessTokenVersion") Core.<*>
                     (o Core..:? "apiKeyVersion")
...
instance Core.ToJSON GitLabSecrets where
        toJSON GitLabSecrets{..}
          = Core.object
              (Core.catMaybes
                 [("apiAccessTokenVersion" Core..=) Core.<$>
                    apiAccessTokenVersion,
                  ("apiKeyVersion" Core..=) Core.<$> apiKeyVersion,
                  ("readAccessTokenVersion" Core..=) Core.<$>
                    readAccessTokenVersion,
                  ("webhookSecretVersion" Core..=) Core.<$>
...
--
-- /See:/ 'newGitSource' smart constructor.
...
-- | Creates a value of 'GitSource' with the minimum fields required to make a request.
newGitSource 
    ::  GitSource
newGitSource =
  GitSource {dir = Core.Nothing, revision = Core.Nothing, url = Core.Nothing}

instance Core.FromJSON GitSource where
        parseJSON
          = Core.withObject "GitSource"
              (\ o ->
                 GitSource Core.<$>
                   (o Core..:? "dir") Core.<*> (o Core..:? "revision")
                     Core.<*> (o Core..:? "url"))

instance Core.ToJSON GitSource where
        toJSON GitSource{..}
          = Core.object
              (Core.catMaybes
                 [("dir" Core..=) Core.<$> dir,
...
instance Core.FromJSON InlineSecret_EnvMap where
        parseJSON
          = Core.withObject "InlineSecret_EnvMap"
              (\ o ->
                 InlineSecret_EnvMap Core.<$>
                   (Core.parseJSONObject o))
...
newListBitbucketServerConfigsResponse =
  ListBitbucketServerConfigsResponse
    {bitbucketServerConfigs = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ListBitbucketServerConfigsResponse"
              (\ o ->
                 ListBitbucketServerConfigsResponse Core.<$>
                   (o Core..:? "bitbucketServerConfigs") Core.<*>
...
instance Core.ToJSON
        ...
        toJSON ListBitbucketServerConfigsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("bitbucketServerConfigs" Core..=) Core.<$>
...
newListBitbucketServerRepositoriesResponse =
  ListBitbucketServerRepositoriesResponse
    {bitbucketServerRepositories = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ListBitbucketServerRepositoriesResponse"
              (\ o ->
                 ListBitbucketServerRepositoriesResponse Core.<$>
                   (o Core..:? "bitbucketServerRepositories") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.ToJSON
        ...
        toJSON ListBitbucketServerRepositoriesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("bitbucketServerRepositories" Core..=) Core.<$>
...
newListBuildTriggersResponse =
  ListBuildTriggersResponse
    {nextPageToken = Core.Nothing, triggers = Core.Nothing}

instance Core.FromJSON ListBuildTriggersResponse
         where
        parseJSON
          = Core.withObject "ListBuildTriggersResponse"
              (\ o ->
                 ListBuildTriggersResponse Core.<$>
...
instance Core.FromJSON ListBuildsResponse where
        parseJSON
          = Core.withObject "ListBuildsResponse"
              (\ o ->
...
newListGitLabConfigsResponse =
  ListGitLabConfigsResponse
    {gitlabConfigs = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListGitLabConfigsResponse
         where
        parseJSON
          = Core.withObject "ListGitLabConfigsResponse"
              (\ o ->
                 ListGitLabConfigsResponse Core.<$>
                   (o Core..:? "gitlabConfigs") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListGitLabRepositoriesResponse =
  ListGitLabRepositoriesResponse
    {gitlabRepositories = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListGitLabRepositoriesResponse
         where
        parseJSON
          = Core.withObject "ListGitLabRepositoriesResponse"
              (\ o ->
                 ListGitLabRepositoriesResponse Core.<$>
                   (o Core..:? "gitlabRepositories") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListGitLabRepositoriesResponse
         where
        toJSON ListGitLabRepositoriesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("gitlabRepositories" Core..=) Core.<$>
                    gitlabRepositories,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ListGithubEnterpriseConfigsResponse"
              (\ o ->
                 ListGithubEnterpriseConfigsResponse Core.<$>
                   (o Core..:? "configs"))
...
newListWorkerPoolsResponse =
  ListWorkerPoolsResponse
    {nextPageToken = Core.Nothing, workerPools = Core.Nothing}

instance Core.FromJSON ListWorkerPoolsResponse where
        parseJSON
          = Core.withObject "ListWorkerPoolsResponse"
              (\ o ->
                 ListWorkerPoolsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "workerPools"))
...
instance Core.FromJSON NetworkConfig where
        parseJSON
          = Core.withObject "NetworkConfig"
              (\ o ->
                 NetworkConfig Core.<$>
                   (o Core..:? "egressOption") Core.<*>
                     (o Core..:? "peeredNetwork")
          ...
          = Core.object
              (Core.catMaybes
                 [("egressOption" Core..=) Core.<$> egressOption,
                  ("peeredNetwork" Core..=) Core.<$> peeredNetwork,
                  ("peeredNetworkIpRange" Core..=) Core.<$>
                    peeredNetworkIpRange])


-- | Npm package to upload to Artifact Registry upon successful completion of all build steps.
--
-- /See:/ 'newNpmPackage' smart constructor.
...
-- | Creates a value of 'NpmPackage' with the minimum fields required to make a request.
newNpmPackage 
    ::  NpmPackage
newNpmPackage =
  NpmPackage {packagePath = Core.Nothing, repository = Core.Nothing}

instance Core.FromJSON NpmPackage where
        parseJSON
          = Core.withObject "NpmPackage"
              (\ o ->
                 NpmPackage Core.<$>
                   (o Core..:? "packagePath") Core.<*>
                     (o Core..:? "repository"))

instance Core.ToJSON NpmPackage where
        toJSON NpmPackage{..}
          = Core.object
              (Core.catMaybes
...
newPrivatePoolV1Config =
  PrivatePoolV1Config
    {networkConfig = Core.Nothing, workerConfig = Core.Nothing}

instance Core.FromJSON PrivatePoolV1Config where
        parseJSON
          = Core.withObject "PrivatePoolV1Config"
              (\ o ->
                 PrivatePoolV1Config Core.<$>
                   (o Core..:? "networkConfig") Core.<*>
                     (o Core..:? "workerConfig"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ProcessAppManifestCallbackOperationMetadata"
              (\ o ->
                 ProcessAppManifestCallbackOperationMetadata Core.<$>
                   (o Core..:? "completeTime") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "githubEnterpriseConfig"))
...
instance Core.FromJSON PubsubConfig where
        parseJSON
          = Core.withObject "PubsubConfig"
              (\ o ->
                 PubsubConfig Core.<$>
                   (o Core..:? "serviceAccountEmail") Core.<*>
                     (o Core..:? "state")
...
instance Core.FromJSON PullRequestFilter where
        parseJSON
          = Core.withObject "PullRequestFilter"
              (\ o ->
                 PullRequestFilter Core.<$>
                   (o Core..:? "branch") Core.<*>
                     (o Core..:? "commentControl")
...
newPushFilter =
  PushFilter
    {branch = Core.Nothing, invertRegex = Core.Nothing, tag = Core.Nothing}

instance Core.FromJSON PushFilter where
        parseJSON
          = Core.withObject "PushFilter"
              (\ o ->
                 PushFilter Core.<$>
                   (o Core..:? "branch") Core.<*>
                     (o Core..:? "invertRegex")
...
instance Core.FromJSON ReceiveTriggerWebhookResponse
         where
        parseJSON
          = Core.withObject "ReceiveTriggerWebhookResponse"
              (\ o -> Core.pure ReceiveTriggerWebhookResponse)

instance Core.ToJSON ReceiveTriggerWebhookResponse
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RemoveGitLabConnectedRepositoryRequest"
              (\ o ->
                 RemoveGitLabConnectedRepositoryRequest Core.<$>
                   (o Core..:? "connectedRepository"))
...
instance Core.FromJSON RepoSource_Substitutions where
        parseJSON
          = Core.withObject "RepoSource_Substitutions"
              (\ o ->
                 RepoSource_Substitutions Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON RepositoryEventConfig where
        parseJSON
          = Core.withObject "RepositoryEventConfig"
              (\ o ->
                 RepositoryEventConfig Core.<$>
                   (o Core..:? "pullRequest") Core.<*>
                     (o Core..:? "push")
                     Core.<*> (o Core..:? "repository")
...
data Results = Results
    ...
    , npmPackages :: (Core.Maybe [UploadedNpmPackage])
...
instance Core.FromJSON RetryBuildRequest where
        parseJSON
          = Core.withObject "RetryBuildRequest"
              (\ o ->
                 RetryBuildRequest Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "projectId"))
...
newRunBuildTriggerRequest =
  RunBuildTriggerRequest
    {projectId = Core.Nothing, source = Core.Nothing, triggerId = Core.Nothing}

instance Core.FromJSON RunBuildTriggerRequest where
        parseJSON
          = Core.withObject "RunBuildTriggerRequest"
              (\ o ->
                 RunBuildTriggerRequest Core.<$>
...
instance Core.FromJSON Secret_SecretEnv where
        parseJSON
          = Core.withObject "Secret_SecretEnv"
              (\ o ->
...
instance Core.FromJSON SecretManagerSecret where
        parseJSON
          = Core.withObject "SecretManagerSecret"
              (\ o ->
                 SecretManagerSecret Core.<$>
                   (o Core..:? "env") Core.<*>
                     (o Core..:? "versionName"))
...
instance Core.FromJSON ServiceDirectoryConfig where
        parseJSON
          = Core.withObject "ServiceDirectoryConfig"
              (\ o ->
...
data Source = Source
    {
      ...
      gitSource :: (Core.Maybe GitSource)
...
instance Core.FromJSON SourceProvenance_FileHashes
         where
        parseJSON
          = Core.withObject "SourceProvenance_FileHashes"
              (\ o ->
                 SourceProvenance_FileHashes Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SourceProvenance_FileHashes
         where
...
data StorageSourceManifest = StorageSourceManifest
    {
      -- | Cloud Storage bucket containing the source manifest (see <https://cloud.google.com/storage/docs/bucket-naming#requirements Bucket Name Requirements>).
      bucket :: (Core.Maybe Core.Text)
      -- | Cloud Storage generation for the object. If the generation is omitted, the latest generation will be used.
    , generation :: (Core.Maybe Core.Int64)
...
instance Core.FromJSON StorageSourceManifest where
        parseJSON
          = Core.withObject "StorageSourceManifest"
              (\ o ->
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "UpdateBitbucketServerConfigOperationMetadata"
              (\ o ->
                 UpdateBitbucketServerConfigOperationMetadata Core.<$>
                   (o Core..:? "bitbucketServerConfig") Core.<*>
                     (o Core..:? "completeTime")
                     Core.<*> (o Core..:? "createTime"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "UpdateGitLabConfigOperationMetadata"
              (\ o ->
                 UpdateGitLabConfigOperationMetadata Core.<$>
                   (o Core..:? "completeTime") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "gitlabConfig"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "UpdateWorkerPoolOperationMetadata"
              (\ o ->
                 UpdateWorkerPoolOperationMetadata Core.<$>
                   (o Core..:? "completeTime") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "workerPool"))
...
instance Core.FromJSON UploadedMavenArtifact where
        parseJSON
          = Core.withObject "UploadedMavenArtifact"
              (\ o ->
                 UploadedMavenArtifact Core.<$>
                   (o Core..:? "fileHashes") Core.<*>
                     (o Core..:? "pushTiming")
                     Core.<*> (o Core..:? "uri"))
...
--
-- /See:/ 'newUploadedNpmPackage' smart constructor.
data UploadedNpmPackage = UploadedNpmPackage
    {
...
-- | Creates a value of 'UploadedNpmPackage' with the minimum fields required to make a request.
newUploadedNpmPackage 
    ::  UploadedNpmPackage
newUploadedNpmPackage =
  UploadedNpmPackage
...
instance Core.FromJSON UploadedNpmPackage where
        parseJSON
          = Core.withObject "UploadedNpmPackage"
              (\ o ->
                 UploadedNpmPackage Core.<$>
                   (o Core..:? "fileHashes") Core.<*>
                     (o Core..:? "pushTiming")
                     Core.<*> (o Core..:? "uri"))

instance Core.ToJSON UploadedNpmPackage where
        toJSON UploadedNpmPackage{..}
          = Core.object
              (Core.catMaybes
                 [("fileHashes" Core..=) Core.<$> fileHashes,
                  ("pushTiming" Core..=) Core.<$> pushTiming,
...
instance Core.FromJSON UploadedPythonPackage where
        parseJSON
          = Core.withObject "UploadedPythonPackage"
              (\ o ->
                 UploadedPythonPackage Core.<$>
                   (o Core..:? "fileHashes") Core.<*>
                     (o Core..:? "pushTiming")
                     Core.<*> (o Core..:? "uri"))
...
instance Core.FromJSON WebhookConfig where
        parseJSON
          = Core.withObject "WebhookConfig"
              (\ o ->
                 WebhookConfig Core.<$>
                   (o Core..:? "secret") Core.<*> (o Core..:? "state"))
...
instance Core.FromJSON WorkerPool_Annotations where
        parseJSON
          = Core.withObject "WorkerPool_Annotations"
              (\ o ->
                 WorkerPool_Annotations Core.<$>
                   (Core.parseJSONObject o))
