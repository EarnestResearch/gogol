...
newBitbucketCloudConfig 
    ::  BitbucketCloudConfig
newBitbucketCloudConfig
  = BitbucketCloudConfig{authorizerCredential = Core.Nothing,
...
newBitbucketDataCenterConfig 
    ::  BitbucketDataCenterConfig
newBitbucketDataCenterConfig
  = BitbucketDataCenterConfig{authorizerCredential = Core.Nothing,
                              hostUri = Core.Nothing, readAuthorizerCredential = Core.Nothing,
                              serverVersion = Core.Nothing,
                              serviceDirectoryConfig = Core.Nothing, sslCa = Core.Nothing,
                              webhookSecretSecretVersion = Core.Nothing}
          ...
          = Core.withObject "BitbucketDataCenterConfig"
              (\ o ->
                 BitbucketDataCenterConfig Core.<$>
                   (o Core..:? "authorizerCredential") Core.<*> (o Core..:? "hostUri")
...
newChildStatusReference 
    ::  ChildStatusReference
newChildStatusReference
  = ChildStatusReference{name = Core.Nothing,
                         pipelineTaskName = Core.Nothing, type' = Core.Nothing,
          ...
          = Core.withObject "ChildStatusReference"
              (\ o ->
                 ChildStatusReference Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "pipelineTaskName")
                     Core.<*> (o Core..:? "type")
...
newConnection 
    ::  Connection
newConnection
  = Connection{annotations = Core.Nothing,
               bitbucketCloudConfig = Core.Nothing,
               bitbucketDataCenterConfig = Core.Nothing,
               createTime = Core.Nothing, disabled = Core.Nothing,
               etag = Core.Nothing, githubConfig = Core.Nothing,
               githubEnterpriseConfig = Core.Nothing, gitlabConfig = Core.Nothing,
               installationState = Core.Nothing, name = Core.Nothing,
               reconciling = Core.Nothing, updateTime = Core.Nothing}
...
newCreateRepositoryRequest 
    ::  CreateRepositoryRequest
newCreateRepositoryRequest
  = CreateRepositoryRequest{parent = Core.Nothing,
                            repository = Core.Nothing, repositoryId = Core.Nothing}
instance Core.FromJSON CreateRepositoryRequest where
        parseJSON
          = Core.withObject "CreateRepositoryRequest"
              (\ o ->
                 CreateRepositoryRequest Core.<$>
                   (o Core..:? "parent") Core.<*> (o Core..:? "repository") Core.<*>
                     (o Core..:? "repositoryId"))
...
instance Core.FromJSON EmbeddedTask where
        parseJSON
          = Core.withObject "EmbeddedTask"
              (\ o ->
                 EmbeddedTask Core.<$>
                   (o Core..:? "annotations") Core.<*> (o Core..:? "taskSpec"))
...
newFetchGitRefsResponse 
    ::  FetchGitRefsResponse
newFetchGitRefsResponse
  = FetchGitRefsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "FetchGitRefsResponse"
              (\ o ->
                 FetchGitRefsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "refNames"))
...
newFetchLinkableRepositoriesResponse 
    :: 
                                     FetchLinkableRepositoriesResponse
newFetchLinkableRepositoriesResponse
  = FetchLinkableRepositoriesResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "FetchLinkableRepositoriesResponse"
              (\ o ->
                 FetchLinkableRepositoriesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "repositories"))
...
newFetchReadTokenResponse 
    ::  FetchReadTokenResponse
newFetchReadTokenResponse
  = FetchReadTokenResponse{expirationTime = Core.Nothing,
                           token = Core.Nothing}
          ...
          = Core.withObject "FetchReadTokenResponse"
              (\ o ->
                 FetchReadTokenResponse Core.<$>
                   (o Core..:? "expirationTime") Core.<*> (o Core..:? "token"))
...
newFetchReadWriteTokenResponse 
    ::  FetchReadWriteTokenResponse
newFetchReadWriteTokenResponse
  = FetchReadWriteTokenResponse{expirationTime = Core.Nothing,
                                token = Core.Nothing}
...
newGitHubConfig 
    ::  GitHubConfig
newGitHubConfig
  = GitHubConfig{appInstallationId = Core.Nothing,
...
instance Core.FromJSON GitHubConfig where
        parseJSON
          = Core.withObject "GitHubConfig"
              (\ o ->
                 GitHubConfig Core.<$>
                   (o Core..:? "appInstallationId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON GitHubConfig where
        toJSON GitHubConfig{..}
          = Core.object
              (Core.catMaybes
                 [("appInstallationId" Core..=) Core.. Core.AsText Core.<$>
                    appInstallationId,
                  ("authorizerCredential" Core..=) Core.<$> authorizerCredential])
...
newGoogleDevtoolsCloudbuildV2Condition 
    :: 
                                       GoogleDevtoolsCloudbuildV2Condition
newGoogleDevtoolsCloudbuildV2Condition
  = GoogleDevtoolsCloudbuildV2Condition{lastTransitionTime =
                                          Core.Nothing,
                                        message = Core.Nothing, reason = Core.Nothing,
                                        severity = Core.Nothing, status = Core.Nothing,
                                        type' = Core.Nothing}
instance Core.FromJSON GoogleDevtoolsCloudbuildV2Condition where
        parseJSON
          = Core.withObject "GoogleDevtoolsCloudbuildV2Condition"
              (\ o ->
                 GoogleDevtoolsCloudbuildV2Condition Core.<$>
                   (o Core..:? "lastTransitionTime") Core.<*> (o Core..:? "message")
                     Core.<*> (o Core..:? "reason")
...
newGoogleDevtoolsCloudbuildV2GitHubEnterpriseConfig 
    :: 
                                                    GoogleDevtoolsCloudbuildV2GitHubEnterpriseConfig
newGoogleDevtoolsCloudbuildV2GitHubEnterpriseConfig
  = GoogleDevtoolsCloudbuildV2GitHubEnterpriseConfig{apiKey =
                                                       Core.Nothing,
                                                     appId = Core.Nothing,
                                                     appInstallationId = Core.Nothing,
                                                     appSlug = Core.Nothing, hostUri = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsCloudbuildV2GitHubEnterpriseConfig"
              (\ o ->
                 GoogleDevtoolsCloudbuildV2GitHubEnterpriseConfig Core.<$>
                   (o Core..:? "apiKey") Core.<*>
                     (o Core..:? "appId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "appInstallationId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "appSlug")
                     Core.<*> (o Core..:? "hostUri")
...
newGoogleDevtoolsCloudbuildV2GitLabConfig 
    :: 
                                          GoogleDevtoolsCloudbuildV2GitLabConfig
newGoogleDevtoolsCloudbuildV2GitLabConfig
  = GoogleDevtoolsCloudbuildV2GitLabConfig{authorizerCredential =
                                             Core.Nothing,
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV2GitLabConfig where
        parseJSON
          = Core.withObject "GoogleDevtoolsCloudbuildV2GitLabConfig"
              (\ o ->
...
newGoogleDevtoolsCloudbuildV2OperationMetadata 
    :: 
                                               GoogleDevtoolsCloudbuildV2OperationMetadata
newGoogleDevtoolsCloudbuildV2OperationMetadata
  = GoogleDevtoolsCloudbuildV2OperationMetadata{apiVersion =
                                                  Core.Nothing,
                                                createTime = Core.Nothing, endTime = Core.Nothing,
                                                requestedCancellation = Core.Nothing,
                                                statusMessage = Core.Nothing, target = Core.Nothing,
                                                verb = Core.Nothing}
instance Core.FromJSON GoogleDevtoolsCloudbuildV2OperationMetadata
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsCloudbuildV2OperationMetadata"
              (\ o ->
...
instance Core.ToJSON GoogleDevtoolsCloudbuildV2OperationMetadata
         where
...
newGoogleDevtoolsCloudbuildV2ServiceDirectoryConfig 
    :: 
                                                    GoogleDevtoolsCloudbuildV2ServiceDirectoryConfig
newGoogleDevtoolsCloudbuildV2ServiceDirectoryConfig
  = GoogleDevtoolsCloudbuildV2ServiceDirectoryConfig{service =
                                                       Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsCloudbuildV2ServiceDirectoryConfig
         where
        parseJSON
          = Core.withObject
              "GoogleDevtoolsCloudbuildV2ServiceDirectoryConfig"
              (\ o ->
                 GoogleDevtoolsCloudbuildV2ServiceDirectoryConfig Core.<$>
                   (o Core..:? "service"))
...
newInstallationState 
    ::  InstallationState
newInstallationState
  = InstallationState{actionUri = Core.Nothing,
                      message = Core.Nothing, stage = Core.Nothing}
instance Core.FromJSON InstallationState where
        parseJSON
          = Core.withObject "InstallationState"
              (\ o ->
                 InstallationState Core.<$>
                   (o Core..:? "actionUri") Core.<*> (o Core..:? "message") Core.<*>
                     (o Core..:? "stage"))
...
newListRepositoriesResponse 
    ::  ListRepositoriesResponse
newListRepositoriesResponse
  = ListRepositoriesResponse{nextPageToken = Core.Nothing,
                             repositories = Core.Nothing, unreachable = Core.Nothing}
...
newOAuthCredential 
    ::  OAuthCredential
newOAuthCredential
  = OAuthCredential{oauthTokenSecretVersion = Core.Nothing,
...
newParamSpec 
    ::  ParamSpec
newParamSpec
  = ParamSpec{default' = Core.Nothing, description = Core.Nothing,
...
instance Core.FromJSON ParamSpec where
        parseJSON
          = Core.withObject "ParamSpec"
              (\ o ->
                 ParamSpec Core.<$>
                   (o Core..:? "default") Core.<*> (o Core..:? "description") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "type"))
...
newParamValue 
    ::  ParamValue
newParamValue
  = ParamValue{arrayVal = Core.Nothing, objectVal = Core.Nothing,
               stringVal = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON ParamValue where
        parseJSON
          = Core.withObject "ParamValue"
              (\ o ->
                 ParamValue Core.<$>
                   (o Core..:? "arrayVal") Core.<*> (o Core..:? "objectVal") Core.<*>
                     (o Core..:? "stringVal")
                     Core.<*> (o Core..:? "type"))
...
newPipelineRef 
    ::  PipelineRef
newPipelineRef
  = PipelineRef{name = Core.Nothing, params = Core.Nothing,
...
instance Core.FromJSON PipelineRef where
        parseJSON
          = Core.withObject "PipelineRef"
              (\ o ->
                 PipelineRef Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "params") Core.<*>
                     (o Core..:? "resolver"))
...
newPipelineResult 
    ::  PipelineResult
newPipelineResult
  = PipelineResult{description = Core.Nothing, name = Core.Nothing,
...
newPipelineRun 
    ::  PipelineRun
newPipelineRun
  = PipelineRun{annotations = Core.Nothing,
                childReferences = Core.Nothing, completionTime = Core.Nothing,
                conditions = Core.Nothing, createTime = Core.Nothing,
                etag = Core.Nothing, finallyStartTime = Core.Nothing,
                gcbParams = Core.Nothing, name = Core.Nothing,
                params = Core.Nothing, pipelineRef = Core.Nothing,
                pipelineRunStatus = Core.Nothing, pipelineSpec = Core.Nothing,
                pipelineSpecYaml = Core.Nothing, provenance = Core.Nothing,
                record = Core.Nothing, resolvedPipelineSpec = Core.Nothing,
                results = Core.Nothing, security = Core.Nothing,
                serviceAccount = Core.Nothing, skippedTasks = Core.Nothing,
                startTime = Core.Nothing, timeouts = Core.Nothing,
                uid = Core.Nothing, updateTime = Core.Nothing,
                worker = Core.Nothing, workerPool = Core.Nothing,
                workflow = Core.Nothing, workspaces = Core.Nothing}
instance Core.FromJSON PipelineRun where
        parseJSON
          = Core.withObject "PipelineRun"
              (\ o ->
                 PipelineRun Core.<$>
                   (o Core..:? "annotations") Core.<*> (o Core..:? "childReferences")
          ...
          = Core.object
              (Core.catMaybes
                 [("annotations" Core..=) Core.<$> annotations,
                  ...
                  ("name" Core..=) Core.<$> name, ("params" Core..=) Core.<$> params,
...
newPipelineSpec 
    ::  PipelineSpec
newPipelineSpec
  = PipelineSpec{finallyTasks = Core.Nothing,
                 generatedYaml = Core.Nothing, params = Core.Nothing,
                 results = Core.Nothing, tasks = Core.Nothing,
...
instance Core.FromJSON PipelineSpec where
        parseJSON
          = Core.withObject "PipelineSpec"
              (\ o ->
                 PipelineSpec Core.<$>
                   (o Core..:? "finallyTasks") Core.<*> (o Core..:? "generatedYaml")
                     Core.<*> (o Core..:? "params")
                     Core.<*> (o Core..:? "results")
                     Core.<*> (o Core..:? "tasks")
                     Core.<*> (o Core..:? "workspaces"))
...
newPipelineTask 
    ::  PipelineTask
newPipelineTask
  = PipelineTask{name = Core.Nothing, params = Core.Nothing,
                 retries = Core.Nothing, runAfter = Core.Nothing,
                 taskRef = Core.Nothing, taskSpec = Core.Nothing,
                 timeout = Core.Nothing, whenExpressions = Core.Nothing,
                 workspaces = Core.Nothing}
...
newPipelineWorkspaceDeclaration 
    ::  PipelineWorkspaceDeclaration
newPipelineWorkspaceDeclaration
  = PipelineWorkspaceDeclaration{description = Core.Nothing,
                                 name = Core.Nothing, optional = Core.Nothing}
...
instance Core.FromJSON Probe where
        parseJSON
          = Core.withObject "Probe"
              (\ o ->
                 Probe Core.<$>
                   (o Core..:? "exec") Core.<*> (o Core..:? "periodSeconds"))
...
newProvenance 
    ::  Provenance
newProvenance
  = Provenance{enabled = Core.Nothing, region = Core.Nothing,
...
instance Core.FromJSON Provenance where
        parseJSON
          = Core.withObject "Provenance"
              (\ o ->
                 Provenance Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "region") Core.<*>
                     (o Core..:? "storage"))
...
newRepository 
    ::  Repository
newRepository
  = Repository{annotations = Core.Nothing, createTime = Core.Nothing,
               etag = Core.Nothing, name = Core.Nothing, remoteUri = Core.Nothing,
               updateTime = Core.Nothing, webhookId = Core.Nothing}
...
newResultValue 
    ::  ResultValue
newResultValue
  = ResultValue{arrayVal = Core.Nothing, objectVal = Core.Nothing,
                stringVal = Core.Nothing, type' = Core.Nothing}
...
newRunWorkflowCustomOperationMetadata 
    :: 
                                      RunWorkflowCustomOperationMetadata
newRunWorkflowCustomOperationMetadata
  = RunWorkflowCustomOperationMetadata{apiVersion = Core.Nothing,
                                       createTime = Core.Nothing, endTime = Core.Nothing,
                                       pipelineRunId = Core.Nothing,
                                       requestedCancellation = Core.Nothing, target = Core.Nothing,
                                       verb = Core.Nothing}
instance Core.FromJSON RunWorkflowCustomOperationMetadata where
        parseJSON
          = Core.withObject "RunWorkflowCustomOperationMetadata"
              (\ o ->
...
newSecretVolumeSource 
    ::  SecretVolumeSource
newSecretVolumeSource
  = SecretVolumeSource{secretName = Core.Nothing,
          ...
          = Core.withObject "SecretVolumeSource"
              (\ o ->
                 SecretVolumeSource Core.<$>
                   (o Core..:? "secretName") Core.<*> (o Core..:? "secretVersion"))
...
newSecurity 
    ::  Security
newSecurity
  = Security{privilegeMode = Core.Nothing,
...
newSecurityContext 
    ::  SecurityContext
newSecurityContext
  = SecurityContext{allowPrivilegeEscalation = Core.Nothing,
                    capabilities = Core.Nothing, privileged = Core.Nothing,
                    runAsGroup = Core.Nothing, runAsNonRoot = Core.Nothing,
              ...
              (\ o ->
                 SecurityContext Core.<$>
                   (o Core..:? "allowPrivilegeEscalation") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "runAsGroup" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "runAsNonRoot")
                     Core.<*>
                     (o Core..:? "runAsUser" Core.<&> Core.fmap Core.fromAsText))
...
newSidecar 
    ::  Sidecar
newSidecar
  = Sidecar{args = Core.Nothing, command = Core.Nothing,
            env = Core.Nothing, image = Core.Nothing, name = Core.Nothing,
            readinessProbe = Core.Nothing, script = Core.Nothing,
            securityContext = Core.Nothing, volumeMounts = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("args" Core..=) Core.<$> args,
                  ...
                  ("image" Core..=) Core.<$> image, ("name" Core..=) Core.<$> name,
...
newSkippedTask 
    ::  SkippedTask
newSkippedTask
  = SkippedTask{name = Core.Nothing, reason = Core.Nothing,
                whenExpressions = Core.Nothing}
instance Core.FromJSON SkippedTask where
        parseJSON
          = Core.withObject "SkippedTask"
              (\ o ->
                 SkippedTask Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "reason") Core.<*>
                     (o Core..:? "whenExpressions"))
...
newStep 
    ::  Step
newStep
  = Step{args = Core.Nothing, command = Core.Nothing,
         env = Core.Nothing, image = Core.Nothing, name = Core.Nothing,
         onError = Core.Nothing, params = Core.Nothing, ref = Core.Nothing,
         script = Core.Nothing, securityContext = Core.Nothing,
         timeout = Core.Nothing, volumeMounts = Core.Nothing,
         workingDir = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("args" Core..=) Core.<$> args,
                  ...
                  ("params" Core..=) Core.<$> params, ("ref" Core..=) Core.<$> ref,
                  ("script" Core..=) Core.<$> script,
                  ("securityContext" Core..=) Core.<$> securityContext,
                  ("timeout" Core..=) Core.<$> timeout,
                  ("volumeMounts" Core..=) Core.<$> volumeMounts,
...
newStepRef 
    ::  StepRef
newStepRef
  = StepRef{name = Core.Nothing, params = Core.Nothing,
            resolver = Core.Nothing}
...
instance Core.FromJSON StepTemplate where
        parseJSON
          = Core.withObject "StepTemplate"
              (\ o ->
                 StepTemplate Core.<$>
                   (o Core..:? "env") Core.<*> (o Core..:? "volumeMounts"))
...
newTaskRef 
    ::  TaskRef
newTaskRef
  = TaskRef{name = Core.Nothing, params = Core.Nothing,
            resolver = Core.Nothing}
...
newTaskResult 
    ::  TaskResult
newTaskResult
  = TaskResult{description = Core.Nothing, name = Core.Nothing,
               properties = Core.Nothing, type' = Core.Nothing,
               value = Core.Nothing}
...
newTaskSpec 
    ::  TaskSpec
newTaskSpec
  = TaskSpec{description = Core.Nothing,
             managedSidecars = Core.Nothing, params = Core.Nothing,
             results = Core.Nothing, sidecars = Core.Nothing,
             stepTemplate = Core.Nothing, steps = Core.Nothing,
             volumes = Core.Nothing, workspaces = Core.Nothing}
instance Core.FromJSON TaskSpec where
        parseJSON
          = Core.withObject "TaskSpec"
              (\ o ->
                 TaskSpec Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "managedSidecars")
                     Core.<*> (o Core..:? "params")
                     Core.<*> (o Core..:? "results")
...
newTimeoutFields 
    ::  TimeoutFields
newTimeoutFields
  = TimeoutFields{finally = Core.Nothing, pipeline = Core.Nothing,
                  tasks = Core.Nothing}
instance Core.FromJSON TimeoutFields where
        parseJSON
          = Core.withObject "TimeoutFields"
              (\ o ->
                 TimeoutFields Core.<$>
                   (o Core..:? "finally") Core.<*> (o Core..:? "pipeline") Core.<*>
                     (o Core..:? "tasks"))
...
newUserCredential 
    ::  UserCredential
newUserCredential
  = UserCredential{userTokenSecretVersion = Core.Nothing,
                   username = Core.Nothing}
...
newVolumeMount 
    ::  VolumeMount
newVolumeMount
  = VolumeMount{mountPath = Core.Nothing, name = Core.Nothing,
                readOnly = Core.Nothing, subPath = Core.Nothing,
...
instance Core.FromJSON VolumeMount where
        parseJSON
          = Core.withObject "VolumeMount"
              (\ o ->
                 VolumeMount Core.<$>
                   (o Core..:? "mountPath") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "readOnly")
                     Core.<*> (o Core..:? "subPath")
...
newWhenExpression 
    ::  WhenExpression
newWhenExpression
  = WhenExpression{expressionOperator = Core.Nothing,
                   input = Core.Nothing, values = Core.Nothing}
instance Core.FromJSON WhenExpression where
        parseJSON
          = Core.withObject "WhenExpression"
              (\ o ->
                 WhenExpression Core.<$>
                   (o Core..:? "expressionOperator") Core.<*> (o Core..:? "input")
                     Core.<*> (o Core..:? "values"))
...
newWorkspaceBinding 
    ::  WorkspaceBinding
newWorkspaceBinding
  = WorkspaceBinding{name = Core.Nothing, secret = Core.Nothing,
          ...
          = Core.withObject "WorkspaceBinding"
              (\ o ->
                 WorkspaceBinding Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "secret") Core.<*>
                     (o Core..:? "subPath"))
...
newWorkspaceDeclaration 
    ::  WorkspaceDeclaration
newWorkspaceDeclaration
  = WorkspaceDeclaration{description = Core.Nothing,
                         mountPath = Core.Nothing, name = Core.Nothing,
                         optional = Core.Nothing, readOnly = Core.Nothing}
instance Core.FromJSON WorkspaceDeclaration where
        parseJSON
          = Core.withObject "WorkspaceDeclaration"
              (\ o ->
                 WorkspaceDeclaration Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "mountPath")
                     Core.<*> (o Core..:? "name")
...
newWorkspacePipelineTaskBinding 
    ::  WorkspacePipelineTaskBinding
newWorkspacePipelineTaskBinding
  = WorkspacePipelineTaskBinding{name = Core.Nothing,
                                 subPath = Core.Nothing, workspace = Core.Nothing}
          ...
          = Core.withObject "WorkspacePipelineTaskBinding"
              (\ o ->
                 WorkspacePipelineTaskBinding Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "subPath") Core.<*>
                     (o Core..:? "workspace"))
