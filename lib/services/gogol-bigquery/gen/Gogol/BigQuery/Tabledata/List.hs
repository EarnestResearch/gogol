                                       ...
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] TableDataList
...
newBigQueryTabledataList datasetId projectId tableId
  = BigQueryTabledataList{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          datasetId = datasetId,
                          formatOptionsUseInt64Timestamp = Core.Nothing,
                          maxResults = Core.Nothing, pageToken = Core.Nothing,
                          projectId = projectId, selectedFields = Core.Nothing,
                          startIndex = Core.Nothing, tableId = tableId,
...
instance Core.GoogleRequest BigQueryTabledataList where
        ...
        type Scopes BigQueryTabledataList =
