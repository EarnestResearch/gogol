...
newAggregateClassificationMetrics 
    ::  AggregateClassificationMetrics
newAggregateClassificationMetrics
  = AggregateClassificationMetrics{accuracy = Core.Nothing,
                                   f1Score = Core.Nothing, logLoss = Core.Nothing,
                                   precision = Core.Nothing, recall = Core.Nothing,
                                   rocAuc = Core.Nothing, threshold = Core.Nothing}
          ...
          = Core.withObject "AggregateClassificationMetrics"
              (\ o ->
                 AggregateClassificationMetrics Core.<$>
                   (o Core..:? "accuracy") Core.<*> (o Core..:? "f1Score") Core.<*>
                     (o Core..:? "logLoss")
...
newArgument 
    ::  Argument
newArgument
  = Argument{argumentKind = Core.Nothing, dataType = Core.Nothing,
             isAggregate = Core.Nothing, mode = Core.Nothing,
             name = Core.Nothing}
instance Core.FromJSON Argument where
        parseJSON
          = Core.withObject "Argument"
              (\ o ->
                 Argument Core.<$>
                   (o Core..:? "argumentKind") Core.<*> (o Core..:? "dataType")
          ...
          = Core.object
              (Core.catMaybes
                 [("argumentKind" Core..=) Core.<$> argumentKind,
                  ...
                  ("mode" Core..=) Core.<$> mode, ("name" Core..=) Core.<$> name])
...
newArimaCoefficients 
    ::  ArimaCoefficients
newArimaCoefficients
  = ArimaCoefficients{autoRegressiveCoefficients = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("autoRegressiveCoefficients" Core..=) Core.<$>
                  ...
                  ("interceptCoefficient" Core..=) Core.<$> interceptCoefficient,
...
newArimaFittingMetrics 
    ::  ArimaFittingMetrics
newArimaFittingMetrics
  = ArimaFittingMetrics{aic = Core.Nothing,
                        logLikelihood = Core.Nothing, variance = Core.Nothing}
instance Core.FromJSON ArimaFittingMetrics where
        parseJSON
          = Core.withObject "ArimaFittingMetrics"
              (\ o ->
                 ArimaFittingMetrics Core.<$>
                   (o Core..:? "aic") Core.<*> (o Core..:? "logLikelihood") Core.<*>
                     (o Core..:? "variance"))
...
newArimaForecastingMetrics 
    ::  ArimaForecastingMetrics
newArimaForecastingMetrics
  = ArimaForecastingMetrics{arimaFittingMetrics = Core.Nothing,
                            arimaSingleModelForecastingMetrics = Core.Nothing,
                            hasDrift = Core.Nothing, nonSeasonalOrder = Core.Nothing,
                            seasonalPeriods = Core.Nothing, timeSeriesId = Core.Nothing}
...
instance Core.ToJSON ArimaForecastingMetrics where
        toJSON ArimaForecastingMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("arimaFittingMetrics" Core..=) Core.<$> arimaFittingMetrics,
                  ("arimaSingleModelForecastingMetrics" Core..=) Core.<$>
                    arimaSingleModelForecastingMetrics,
                  ("hasDrift" Core..=) Core.<$> hasDrift,
                  ("nonSeasonalOrder" Core..=) Core.<$> nonSeasonalOrder,
...
newArimaModelInfo 
    ::  ArimaModelInfo
newArimaModelInfo
  = ArimaModelInfo{arimaCoefficients = Core.Nothing,
                   arimaFittingMetrics = Core.Nothing, hasDrift = Core.Nothing,
                   hasHolidayEffect = Core.Nothing, hasSpikesAndDips = Core.Nothing,
                   hasStepChanges = Core.Nothing, nonSeasonalOrder = Core.Nothing,
                   seasonalPeriods = Core.Nothing, timeSeriesId = Core.Nothing,
...
instance Core.ToJSON ArimaModelInfo where
        toJSON ArimaModelInfo{..}
          = Core.object
              (Core.catMaybes
                 [("arimaCoefficients" Core..=) Core.<$> arimaCoefficients,
                  ("arimaFittingMetrics" Core..=) Core.<$> arimaFittingMetrics,
                  ("hasDrift" Core..=) Core.<$> hasDrift,
                  ("hasHolidayEffect" Core..=) Core.<$> hasHolidayEffect,
                  ("hasSpikesAndDips" Core..=) Core.<$> hasSpikesAndDips,
...
instance Core.FromJSON ArimaOrder where
        parseJSON
          = Core.withObject "ArimaOrder"
              (\ o ->
                 ArimaOrder Core.<$>
                   (o Core..:? "d" Core.<&> Core.fmap Core.fromAsText) Core.<*>
...
newArimaResult 
    ::  ArimaResult
newArimaResult
  = ArimaResult{arimaModelInfo = Core.Nothing,
...
newArimaSingleModelForecastingMetrics
  = ArimaSingleModelForecastingMetrics{arimaFittingMetrics =
                                         Core.Nothing,
                                       hasDrift = Core.Nothing, hasHolidayEffect = Core.Nothing,
                                       hasSpikesAndDips = Core.Nothing,
                                       hasStepChanges = Core.Nothing,
                                       nonSeasonalOrder = Core.Nothing,
                                       seasonalPeriods = Core.Nothing, timeSeriesId = Core.Nothing,
                                       timeSeriesIds = Core.Nothing}
instance Core.FromJSON ArimaSingleModelForecastingMetrics where
        parseJSON
          = Core.withObject "ArimaSingleModelForecastingMetrics"
              (\ o ->
                 ArimaSingleModelForecastingMetrics Core.<$>
                   (o Core..:? "arimaFittingMetrics") Core.<*> (o Core..:? "hasDrift")
                     Core.<*> (o Core..:? "hasHolidayEffect")
                     Core.<*> (o Core..:? "hasSpikesAndDips")
                     Core.<*> (o Core..:? "hasStepChanges")
                     Core.<*> (o Core..:? "nonSeasonalOrder")
...
instance Core.ToJSON ArimaSingleModelForecastingMetrics where
...
instance Core.FromJSON AvroOptions where
        parseJSON
          = Core.withObject "AvroOptions"
              (\ o -> AvroOptions Core.<$> (o Core..:? "useAvroLogicalTypes"))
...
newBatchDeleteRowAccessPoliciesRequest 
    :: 
                                       BatchDeleteRowAccessPoliciesRequest
newBatchDeleteRowAccessPoliciesRequest
  = BatchDeleteRowAccessPoliciesRequest{force = Core.Nothing,
                                        policyIds = Core.Nothing}
instance Core.FromJSON BatchDeleteRowAccessPoliciesRequest where
        parseJSON
          = Core.withObject "BatchDeleteRowAccessPoliciesRequest"
              (\ o ->
                 BatchDeleteRowAccessPoliciesRequest Core.<$>
                   (o Core..:? "force") Core.<*> (o Core..:? "policyIds"))
...
newBiEngineReason 
    ::  BiEngineReason
newBiEngineReason
  = BiEngineReason{code = Core.Nothing, message = Core.Nothing}
...
newBiEngineStatistics 
    ::  BiEngineStatistics
newBiEngineStatistics
  = BiEngineStatistics{accelerationMode = Core.Nothing,
                       biEngineMode = Core.Nothing, biEngineReasons = Core.Nothing}
...
instance Core.ToJSON BiEngineStatistics where
        toJSON BiEngineStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("accelerationMode" Core..=) Core.<$> accelerationMode,
                  ("biEngineMode" Core..=) Core.<$> biEngineMode,
                  ("biEngineReasons" Core..=) Core.<$> biEngineReasons])
...
newBigLakeConfiguration 
    ::  BigLakeConfiguration
newBigLakeConfiguration
  = BigLakeConfiguration{connectionId = Core.Nothing,
                         fileFormat = Core.Nothing, storageUri = Core.Nothing,
          ...
          = Core.withObject "BigLakeConfiguration"
              (\ o ->
                 BigLakeConfiguration Core.<$>
                   (o Core..:? "connectionId") Core.<*> (o Core..:? "fileFormat")
...
newBigQueryModelTraining 
    ::  BigQueryModelTraining
newBigQueryModelTraining
  = BigQueryModelTraining{currentIteration = Core.Nothing,
...
instance Core.ToJSON BigQueryModelTraining where
        toJSON BigQueryModelTraining{..}
          = Core.object
              (Core.catMaybes
                 [("currentIteration" Core..=) Core.<$> currentIteration,
                  ("expectedTotalIterations" Core..=) Core.. Core.AsText Core.<$>
...
newBigtableColumn 
    ::  BigtableColumn
newBigtableColumn
  = BigtableColumn{encoding = Core.Nothing, fieldName = Core.Nothing,
                   onlyReadLatest = Core.Nothing, qualifierEncoded = Core.Nothing,
                   qualifierString = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON BigtableColumn where
        parseJSON
          = Core.withObject "BigtableColumn"
              (\ o ->
                 BigtableColumn Core.<$>
                   (o Core..:? "encoding") Core.<*> (o Core..:? "fieldName") Core.<*>
                     (o Core..:? "onlyReadLatest")
          ...
          = Core.object
              (Core.catMaybes
                 [("encoding" Core..=) Core.<$> encoding,
                  ...
                  ("qualifierEncoded" Core..=) Core.<$> qualifierEncoded,
...
newBigtableColumnFamily 
    ::  BigtableColumnFamily
newBigtableColumnFamily
  = BigtableColumnFamily{columns = Core.Nothing,
                         encoding = Core.Nothing, familyId = Core.Nothing,
                         onlyReadLatest = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON BigtableColumnFamily where
        parseJSON
          = Core.withObject "BigtableColumnFamily"
              (\ o ->
                 BigtableColumnFamily Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "encoding") Core.<*>
                     (o Core..:? "familyId")
...
newBigtableOptions 
    ::  BigtableOptions
newBigtableOptions
  = BigtableOptions{columnFamilies = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("columnFamilies" Core..=) Core.<$> columnFamilies,
                  ...
                  ("readRowkeyAsString" Core..=) Core.<$> readRowkeyAsString])
...
newBinaryClassificationMetrics
  = BinaryClassificationMetrics{aggregateClassificationMetrics =
                                ...
                                negativeLabel = Core.Nothing, positiveLabel = Core.Nothing}
          ...
          = Core.withObject "BinaryClassificationMetrics"
              (\ o ->
                 BinaryClassificationMetrics Core.<$>
                   (o Core..:? "aggregateClassificationMetrics") Core.<*>
                     (o Core..:? "binaryConfusionMatrixList")
...
newBinaryConfusionMatrix 
    ::  BinaryConfusionMatrix
newBinaryConfusionMatrix
  = BinaryConfusionMatrix{accuracy = Core.Nothing,
                          f1Score = Core.Nothing, falseNegatives = Core.Nothing,
                          falsePositives = Core.Nothing,
                          positiveClassThreshold = Core.Nothing, precision = Core.Nothing,
                          recall = Core.Nothing, trueNegatives = Core.Nothing,
          ...
          = Core.withObject "BinaryConfusionMatrix"
              (\ o ->
                 BinaryConfusionMatrix Core.<$>
                   (o Core..:? "accuracy") Core.<*> (o Core..:? "f1Score") Core.<*>
                     (o Core..:? "falseNegatives" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "falsePositives" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "positiveClassThreshold")
                     Core.<*> (o Core..:? "precision")
                     Core.<*> (o Core..:? "recall")
                     Core.<*>
                     (o Core..:? "trueNegatives" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "truePositives" Core.<&> Core.fmap Core.fromAsText))
        ...
        toJSON BinaryConfusionMatrix{..}
          = Core.object
              (Core.catMaybes
                 [("accuracy" Core..=) Core.<$> accuracy,
                  ("f1Score" Core..=) Core.<$> f1Score,
                  ("falseNegatives" Core..=) Core.. Core.AsText Core.<$>
                    falseNegatives,
                  ("falsePositives" Core..=) Core.. Core.AsText Core.<$>
                    falsePositives,
                  ("positiveClassThreshold" Core..=) Core.<$> positiveClassThreshold,
                  ("precision" Core..=) Core.<$> precision,
                  ("recall" Core..=) Core.<$> recall,
...
newBqmlIterationResult 
    ::  BqmlIterationResult
newBqmlIterationResult
  = BqmlIterationResult{durationMs = Core.Nothing,
                        evalLoss = Core.Nothing, index = Core.Nothing,
                        learnRate = Core.Nothing, trainingLoss = Core.Nothing}
instance Core.FromJSON BqmlIterationResult where
        parseJSON
          = Core.withObject "BqmlIterationResult"
              (\ o ->
                 BqmlIterationResult Core.<$>
                   (o Core..:? "durationMs" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON BqmlIterationResult where
        toJSON BqmlIterationResult{..}
          = Core.object
              (Core.catMaybes
                 [("durationMs" Core..=) Core.. Core.AsText Core.<$> durationMs,
...
newBqmlTrainingRun 
    ::  BqmlTrainingRun
newBqmlTrainingRun
  = BqmlTrainingRun{iterationResults = Core.Nothing,
          ...
          = Core.withObject "BqmlTrainingRun"
              (\ o ->
                 BqmlTrainingRun Core.<$>
                   (o Core..:? "iterationResults") Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "state")
...
instance Core.ToJSON BqmlTrainingRun where
        toJSON BqmlTrainingRun{..}
          = Core.object
              (Core.catMaybes
                 [("iterationResults" Core..=) Core.<$> iterationResults,
...
newBqmlTrainingRun_TrainingOptions 
    :: 
                                   BqmlTrainingRun_TrainingOptions
newBqmlTrainingRun_TrainingOptions
  = BqmlTrainingRun_TrainingOptions{earlyStop = Core.Nothing,
                                    l1Reg = Core.Nothing, l2Reg = Core.Nothing,
                                    learnRate = Core.Nothing, learnRateStrategy = Core.Nothing,
                                    lineSearchInitLearnRate = Core.Nothing,
                                    maxIteration = Core.Nothing, minRelProgress = Core.Nothing,
                                    warmStart = Core.Nothing}
instance Core.FromJSON BqmlTrainingRun_TrainingOptions where
        parseJSON
          = Core.withObject "BqmlTrainingRun_TrainingOptions"
              (\ o ->
                 BqmlTrainingRun_TrainingOptions Core.<$>
                   (o Core..:? "earlyStop") Core.<*> (o Core..:? "l1Reg") Core.<*>
                     (o Core..:? "l2Reg")
                     Core.<*> (o Core..:? "learnRate")
                     Core.<*> (o Core..:? "learnRateStrategy")
                     Core.<*> (o Core..:? "lineSearchInitLearnRate")
                     Core.<*>
                     (o Core..:? "maxIteration" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("earlyStop" Core..=) Core.<$> earlyStop,
                  ("l1Reg" Core..=) Core.<$> l1Reg, ("l2Reg" Core..=) Core.<$> l2Reg,
                  ("learnRate" Core..=) Core.<$> learnRate,
                  ("learnRateStrategy" Core..=) Core.<$> learnRateStrategy,
                  ("lineSearchInitLearnRate" Core..=) Core.<$>
                    lineSearchInitLearnRate,
                  ("maxIteration" Core..=) Core.. Core.AsText Core.<$> maxIteration,
...
newCategoricalValue 
    ::  CategoricalValue
newCategoricalValue
  = CategoricalValue{categoryCounts = Core.Nothing}
instance Core.FromJSON CategoricalValue where
        parseJSON
          = Core.withObject "CategoricalValue"
              (\ o -> CategoricalValue Core.<$> (o Core..:? "categoryCounts"))
...
newCategoryCount 
    ::  CategoryCount
newCategoryCount
  = CategoryCount{category = Core.Nothing, count = Core.Nothing}
...
newCloneDefinition 
    ::  CloneDefinition
newCloneDefinition
  = CloneDefinition{baseTableReference = Core.Nothing,
                    cloneTime = Core.Nothing}
...
instance Core.ToJSON CloneDefinition where
        toJSON CloneDefinition{..}
          = Core.object
              (Core.catMaybes
                 [("baseTableReference" Core..=) Core.<$> baseTableReference,
...
newCluster 
    ::  Cluster
newCluster
  = Cluster{centroidId = Core.Nothing, count = Core.Nothing,
...
instance Core.FromJSON Cluster where
        parseJSON
          = Core.withObject "Cluster"
              (\ o ->
                 Cluster Core.<$>
                   (o Core..:? "centroidId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON Cluster where
        toJSON Cluster{..}
          = Core.object
              (Core.catMaybes
                 [("centroidId" Core..=) Core.. Core.AsText Core.<$> centroidId,
                  ("count" Core..=) Core.. Core.AsText Core.<$> count,
...
newClusterInfo 
    ::  ClusterInfo
newClusterInfo
  = ClusterInfo{centroidId = Core.Nothing,
                clusterRadius = Core.Nothing, clusterSize = Core.Nothing}
              ...
              (\ o ->
                 ClusterInfo Core.<$>
                   (o Core..:? "centroidId" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "clusterSize" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("centroidId" Core..=) Core.. Core.AsText Core.<$> centroidId,
                  ...
                  ("clusterSize" Core..=) Core.. Core.AsText Core.<$> clusterSize])
...
newClusteringMetrics 
    ::  ClusteringMetrics
newClusteringMetrics
  = ClusteringMetrics{clusters = Core.Nothing,
          ...
          = Core.withObject "ClusteringMetrics"
              (\ o ->
                 ClusteringMetrics Core.<$>
                   (o Core..:? "clusters") Core.<*> (o Core..:? "daviesBouldinIndex")
          ...
          = Core.object
              (Core.catMaybes
                 [("clusters" Core..=) Core.<$> clusters,
                  ("daviesBouldinIndex" Core..=) Core.<$> daviesBouldinIndex,
                  ("meanSquaredDistance" Core..=) Core.<$> meanSquaredDistance])
...
newConfusionMatrix 
    ::  ConfusionMatrix
newConfusionMatrix
  = ConfusionMatrix{confidenceThreshold = Core.Nothing,
                    rows = Core.Nothing}
          ...
          = Core.withObject "ConfusionMatrix"
              (\ o ->
                 ConfusionMatrix Core.<$>
                   (o Core..:? "confidenceThreshold") Core.<*> (o Core..:? "rows"))
...
data CsvOptions = CsvOptions
    ...
    , nullMarker :: (Core.Maybe Core.Text)
      -- | Optional. A list of strings represented as SQL NULL value in a CSV file. null/marker and null/markers can\'t be set at the same time. If null/marker is set, null/markers has to be not set. If null/markers is set, null/marker has to be not set. If both null/marker and null/markers are set at the same time, a user error would be thrown. Any strings listed in null_markers, including empty string would be interpreted as SQL NULL. This applies to all column types.
    , nullMarkers :: (Core.Maybe [Core.Text])
    ...
    , sourceColumnMatch :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newCsvOptions 
    ::  CsvOptions
newCsvOptions
  = CsvOptions{allowJaggedRows = Core.Nothing,
               allowQuotedNewlines = Core.Nothing, encoding = Core.Nothing,
               fieldDelimiter = Core.Nothing, nullMarker = Core.Nothing,
               nullMarkers = Core.Nothing,
               preserveAsciiControlCharacters = Core.Nothing, quote = "\"",
               skipLeadingRows = Core.Nothing, sourceColumnMatch = Core.Nothing}
              ...
              (\ o ->
                 CsvOptions Core.<$>
                   (o Core..:? "allowJaggedRows") Core.<*>
                     ...
                     Core.<*> (o Core..:? "nullMarkers")
                     Core.<*> (o Core..:? "preserveAsciiControlCharacters")
                     Core.<*> (o Core..:? "quote" Core..!= "\"")
                     Core.<*>
                     (o Core..:? "skipLeadingRows" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "sourceColumnMatch"))

instance Core.ToJSON CsvOptions where
        toJSON CsvOptions{..}
          = Core.object
              (Core.catMaybes
                 [("allowJaggedRows" Core..=) Core.<$> allowJaggedRows,
                  ("allowQuotedNewlines" Core..=) Core.<$> allowQuotedNewlines,
                  ("encoding" Core..=) Core.<$> encoding,
                  ("fieldDelimiter" Core..=) Core.<$> fieldDelimiter,
                  ("nullMarker" Core..=) Core.<$> nullMarker,
                  ("nullMarkers" Core..=) Core.<$> nullMarkers,
                  ("preserveAsciiControlCharacters" Core..=) Core.<$>
                    preserveAsciiControlCharacters,
                  Core.Just ("quote" Core..= quote),
                  ("skipLeadingRows" Core..=) Core.. Core.AsText Core.<$>
                    skipLeadingRows,
                  ("sourceColumnMatch" Core..=) Core.<$> sourceColumnMatch])
...
instance Core.FromJSON DataMaskingStatistics where
        parseJSON
          = Core.withObject "DataMaskingStatistics"
              (\ o ->
                 DataMaskingStatistics Core.<$> (o Core..:? "dataMaskingApplied"))

instance Core.ToJSON DataMaskingStatistics where
        toJSON DataMaskingStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("dataMaskingApplied" Core..=) Core.<$> dataMaskingApplied])
...
instance Core.FromJSON DataPolicyOption where
        parseJSON
          = Core.withObject "DataPolicyOption"
              (\ o -> DataPolicyOption Core.<$> (o Core..:? "name"))
...
newDataSplitResult 
    ::  DataSplitResult
newDataSplitResult
  = DataSplitResult{evaluationTable = Core.Nothing,
                    testTable = Core.Nothing, trainingTable = Core.Nothing}
instance Core.FromJSON DataSplitResult where
        parseJSON
          = Core.withObject "DataSplitResult"
              (\ o ->
                 DataSplitResult Core.<$>
                   (o Core..:? "evaluationTable") Core.<*> (o Core..:? "testTable")
...
instance Core.ToJSON DataSplitResult where
        toJSON DataSplitResult{..}
          = Core.object
              (Core.catMaybes
                 [("evaluationTable" Core..=) Core.<$> evaluationTable,
...
newDataset 
    ::  Dataset
newDataset
  = Dataset{access = Core.Nothing, creationTime = Core.Nothing,
            datasetReference = Core.Nothing, defaultCollation = Core.Nothing,
            ...
            description = Core.Nothing, etag = Core.Nothing,
            externalCatalogDatasetOptions = Core.Nothing,
            externalDatasetReference = Core.Nothing,
            friendlyName = Core.Nothing, id = Core.Nothing,
            isCaseInsensitive = Core.Nothing, kind = "bigquery#dataset",
            labels = Core.Nothing, lastModifiedTime = Core.Nothing,
            linkedDatasetMetadata = Core.Nothing,
            linkedDatasetSource = Core.Nothing, location = Core.Nothing,
            maxTimeTravelHours = Core.Nothing, resourceTags = Core.Nothing,
            restrictions = Core.Nothing, satisfiesPzi = Core.Nothing,
            satisfiesPzs = Core.Nothing, selfLink = Core.Nothing,
            storageBillingModel = Core.Nothing, tags = Core.Nothing,
            type' = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "Dataset"
              (\ o ->
                 Dataset Core.<$>
                   (o Core..:? "access") Core.<*>
                     (o Core..:? "creationTime" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "labels")
                     Core.<*>
                     (o Core..:? "lastModifiedTime" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("access" Core..=) Core.<$> access,
                  ...
                  ("datasetReference" Core..=) Core.<$> datasetReference,
                  ("defaultCollation" Core..=) Core.<$> defaultCollation,
                  ("defaultEncryptionConfiguration" Core..=) Core.<$>
                    defaultEncryptionConfiguration,
                  ("defaultPartitionExpirationMs" Core..=) Core.. Core.AsText
                    Core.<$> defaultPartitionExpirationMs,
                  ("defaultRoundingMode" Core..=) Core.<$> defaultRoundingMode,
                  ("defaultTableExpirationMs" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("id" Core..=) Core.<$> id,
                  ("isCaseInsensitive" Core..=) Core.<$> isCaseInsensitive,
                  Core.Just ("kind" Core..= kind),
                  ("labels" Core..=) Core.<$> labels,
                  ("lastModifiedTime" Core..=) Core.. Core.AsText Core.<$>
                    lastModifiedTime,
                  ("linkedDatasetMetadata" Core..=) Core.<$> linkedDatasetMetadata,
                  ("linkedDatasetSource" Core..=) Core.<$> linkedDatasetSource,
                  ("location" Core..=) Core.<$> location,
                  ("maxTimeTravelHours" Core..=) Core.. Core.AsText Core.<$>
                    maxTimeTravelHours,
                  ...
                  ("storageBillingModel" Core..=) Core.<$> storageBillingModel,
...
newDataset_AccessItem 
    ::  Dataset_AccessItem
newDataset_AccessItem
  = Dataset_AccessItem{condition = Core.Nothing,
                       dataset = Core.Nothing, domain = Core.Nothing,
                       groupByEmail = Core.Nothing, iamMember = Core.Nothing,
                       role' = Core.Nothing, routine = Core.Nothing,
                       specialGroup = Core.Nothing, userByEmail = Core.Nothing,
                       view = Core.Nothing}
          ...
          = Core.withObject "Dataset_AccessItem"
              (\ o ->
                 Dataset_AccessItem Core.<$>
                   (o Core..:? "condition") Core.<*> (o Core..:? "dataset") Core.<*>
                     (o Core..:? "domain")
...
newDataset_Labels 
    :: 
       ...
       -- ^  See 'additional'.
    -> Dataset_Labels
newDataset_Labels additional
  = Dataset_Labels{additional = additional}
instance Core.FromJSON Dataset_Labels where
        parseJSON
          = Core.withObject "Dataset_Labels"
              (\ o -> Dataset_Labels Core.<$> (Core.parseJSONObject o))
...
instance Core.FromJSON Dataset_ResourceTags where
        parseJSON
          = Core.withObject "Dataset_ResourceTags"
              (\ o -> Dataset_ResourceTags Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Dataset_ResourceTags where
        toJSON Dataset_ResourceTags{..} = Core.toJSON additional
          ...
          = Core.withObject "Dataset_TagsItem"
              (\ o ->
                 Dataset_TagsItem Core.<$>
                   (o Core..:? "tagKey") Core.<*> (o Core..:? "tagValue"))
...
newDatasetList 
    ::  DatasetList
newDatasetList
  = DatasetList{datasets = Core.Nothing, etag = Core.Nothing,
                kind = "bigquery#datasetList", nextPageToken = Core.Nothing,
...
instance Core.FromJSON DatasetList where
        parseJSON
          = Core.withObject "DatasetList"
              (\ o ->
                 DatasetList Core.<$>
                   (o Core..:? "datasets") Core.<*> (o Core..:? "etag") Core.<*>
...
newDatasetList_DatasetsItem 
    ::  DatasetList_DatasetsItem
newDatasetList_DatasetsItem
  = DatasetList_DatasetsItem{datasetReference = Core.Nothing,
                             externalDatasetReference = Core.Nothing,
                             friendlyName = Core.Nothing, id = Core.Nothing,
                             kind = Core.Nothing, labels = Core.Nothing,
              ...
              (\ o ->
                 DatasetList_DatasetsItem Core.<$>
                   (o Core..:? "datasetReference") Core.<*>
                     (o Core..:? "externalDatasetReference")
                     Core.<*> (o Core..:? "friendlyName")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "labels")
              ...
              (Core.catMaybes
                 [("datasetReference" Core..=) Core.<$> datasetReference,
                  ("externalDatasetReference" Core..=) Core.<$>
                    externalDatasetReference,
                  ("friendlyName" Core..=) Core.<$> friendlyName,
                  ("id" Core..=) Core.<$> id, ("kind" Core..=) Core.<$> kind,
                  ("labels" Core..=) Core.<$> labels,
                  ("location" Core..=) Core.<$> location])
...
instance Core.FromJSON DatasetList_DatasetsItem_Labels where
        parseJSON
          = Core.withObject "DatasetList_DatasetsItem_Labels"
              (\ o ->
                 DatasetList_DatasetsItem_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON DatasetList_DatasetsItem_Labels where
        toJSON DatasetList_DatasetsItem_Labels{..} = Core.toJSON additional
...
newDatasetReference 
    ::  DatasetReference
newDatasetReference
  = DatasetReference{datasetId = Core.Nothing,
          ...
          = Core.withObject "DatasetReference"
              (\ o ->
                 DatasetReference Core.<$>
                   (o Core..:? "datasetId") Core.<*> (o Core..:? "projectId"))
...
newDestinationTableProperties 
    ::  DestinationTableProperties
newDestinationTableProperties
  = DestinationTableProperties{description = Core.Nothing,
                               expirationTime = Core.Nothing, friendlyName = Core.Nothing,
                               labels = Core.Nothing}
          ...
          = Core.withObject "DestinationTableProperties"
              (\ o ->
                 DestinationTableProperties Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "expirationTime")
                     Core.<*> (o Core..:? "friendlyName")
                     Core.<*> (o Core..:? "labels"))
...
instance Core.FromJSON DestinationTableProperties_Labels where
        parseJSON
...
instance Core.ToJSON DestinationTableProperties_Labels where
...
newDifferentialPrivacyPolicy 
    ::  DifferentialPrivacyPolicy
newDifferentialPrivacyPolicy
  = DifferentialPrivacyPolicy{deltaBudget = Core.Nothing,
                              deltaBudgetRemaining = Core.Nothing, deltaPerQuery = Core.Nothing,
...
instance Core.FromJSON DifferentialPrivacyPolicy where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("deltaBudget" Core..=) Core.<$> deltaBudget,
                  ("deltaBudgetRemaining" Core..=) Core.<$> deltaBudgetRemaining,
                  ("deltaPerQuery" Core..=) Core.<$> deltaPerQuery,
                  ("epsilonBudget" Core..=) Core.<$> epsilonBudget,
                  ("epsilonBudgetRemaining" Core..=) Core.<$> epsilonBudgetRemaining,
                  ("maxEpsilonPerQuery" Core..=) Core.<$> maxEpsilonPerQuery,
                  ("maxGroupsContributed" Core..=) Core.. Core.AsText Core.<$>
                    maxGroupsContributed,
                  ("privacyUnitColumn" Core..=) Core.<$> privacyUnitColumn])
...
newDmlStatistics 
    ::  DmlStatistics
newDmlStatistics
  = DmlStatistics{deletedRowCount = Core.Nothing,
                  insertedRowCount = Core.Nothing, updatedRowCount = Core.Nothing}
instance Core.FromJSON DmlStatistics where
        parseJSON
          = Core.withObject "DmlStatistics"
              (\ o ->
                 DmlStatistics Core.<$>
                   (o Core..:? "deletedRowCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "insertedRowCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "updatedRowCount" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON DmlStatistics where
        toJSON DmlStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("deletedRowCount" Core..=) Core.. Core.AsText Core.<$>
                    deletedRowCount,
                  ("insertedRowCount" Core..=) Core.. Core.AsText Core.<$>
                    insertedRowCount,
                  ("updatedRowCount" Core..=) Core.. Core.AsText Core.<$>
                    updatedRowCount])
...
instance Core.FromJSON DoubleCandidates where
        parseJSON
          = Core.withObject "DoubleCandidates"
              (\ o -> DoubleCandidates Core.<$> (o Core..:? "candidates"))

instance Core.ToJSON DoubleCandidates where
        toJSON DoubleCandidates{..}
          = Core.object
              (Core.catMaybes [("candidates" Core..=) Core.<$> candidates])
...
newDoubleHparamSearchSpace 
    ::  DoubleHparamSearchSpace
newDoubleHparamSearchSpace
  = DoubleHparamSearchSpace{candidates = Core.Nothing,
                            range = Core.Nothing}
          ...
          = Core.withObject "DoubleHparamSearchSpace"
              (\ o ->
                 DoubleHparamSearchSpace Core.<$>
                   (o Core..:? "candidates") Core.<*> (o Core..:? "range"))
...
newDoubleRange 
    ::  DoubleRange
newDoubleRange
  = DoubleRange{max = Core.Nothing, min = Core.Nothing}
...
newEncryptionConfiguration 
    ::  EncryptionConfiguration
newEncryptionConfiguration
  = EncryptionConfiguration{kmsKeyName = Core.Nothing}
instance Core.FromJSON EncryptionConfiguration where
        parseJSON
          = Core.withObject "EncryptionConfiguration"
              (\ o -> EncryptionConfiguration Core.<$> (o Core..:? "kmsKeyName"))
...
newEntry 
    ::  Entry
newEntry
  = Entry{itemCount = Core.Nothing, predictedLabel = Core.Nothing}
instance Core.FromJSON Entry where
        parseJSON
          = Core.withObject "Entry"
              (\ o ->
                 Entry Core.<$>
                   (o Core..:? "itemCount" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON Entry where
        toJSON Entry{..}
          = Core.object
              (Core.catMaybes
                 [("itemCount" Core..=) Core.. Core.AsText Core.<$> itemCount,
...
newErrorProto 
    ::  ErrorProto
newErrorProto
  = ErrorProto{debugInfo = Core.Nothing, location = Core.Nothing,
               message = Core.Nothing, reason = Core.Nothing}
instance Core.FromJSON ErrorProto where
        parseJSON
          = Core.withObject "ErrorProto"
              (\ o ->
                 ErrorProto Core.<$>
                   (o Core..:? "debugInfo") Core.<*> (o Core..:? "location") Core.<*>
                     (o Core..:? "message")
                     Core.<*> (o Core..:? "reason"))
...
newEvaluationMetrics 
    ::  EvaluationMetrics
newEvaluationMetrics
  = EvaluationMetrics{arimaForecastingMetrics = Core.Nothing,
                      ...
                      rankingMetrics = Core.Nothing, regressionMetrics = Core.Nothing}
              ...
              (Core.catMaybes
                 [("arimaForecastingMetrics" Core..=) Core.<$>
                  ...
                  ("binaryClassificationMetrics" Core..=) Core.<$>
                    binaryClassificationMetrics,
                  ("clusteringMetrics" Core..=) Core.<$> clusteringMetrics,
...
newExplainQueryStage 
    ::  ExplainQueryStage
newExplainQueryStage
  = ExplainQueryStage{completedParallelInputs = Core.Nothing,
                      computeMode = Core.Nothing, computeMsAvg = Core.Nothing,
                      computeMsMax = Core.Nothing, computeRatioAvg = Core.Nothing,
                      computeRatioMax = Core.Nothing, endMs = Core.Nothing,
                      id = Core.Nothing, inputStages = Core.Nothing, name = Core.Nothing,
                      parallelInputs = Core.Nothing, readMsAvg = Core.Nothing,
                      readMsMax = Core.Nothing, readRatioAvg = Core.Nothing,
                      readRatioMax = Core.Nothing, recordsRead = Core.Nothing,
                      recordsWritten = Core.Nothing, shuffleOutputBytes = Core.Nothing,
                      shuffleOutputBytesSpilled = Core.Nothing, slotMs = Core.Nothing,
                      startMs = Core.Nothing, status = Core.Nothing,
                      steps = Core.Nothing, waitMsAvg = Core.Nothing,
                      waitMsMax = Core.Nothing, waitRatioAvg = Core.Nothing,
                      waitRatioMax = Core.Nothing, writeMsAvg = Core.Nothing,
                      writeMsMax = Core.Nothing, writeRatioAvg = Core.Nothing,
              ...
              (\ o ->
                 ExplainQueryStage Core.<$>
                   (o Core..:? "completedParallelInputs" Core.<&>
                     ...
                     Core.<*>
                     (o Core..:? "computeMsAvg" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "computeMsMax" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "computeRatioAvg")
                     Core.<*> (o Core..:? "computeRatioMax")
                     Core.<*> (o Core..:? "endMs" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "parallelInputs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "readMsAvg" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "readMsMax" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     (o Core..:? "shuffleOutputBytesSpilled" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "slotMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "startMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "status")
                     Core.<*> (o Core..:? "steps")
                     Core.<*>
                     (o Core..:? "waitMsAvg" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "waitMsMax" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "waitRatioAvg")
                     Core.<*> (o Core..:? "waitRatioMax")
                     Core.<*>
                     (o Core..:? "writeMsAvg" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "writeMsMax" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON ExplainQueryStage where
        toJSON ExplainQueryStage{..}
          = Core.object
              (Core.catMaybes
                 [("completedParallelInputs" Core..=) Core.. Core.AsText Core.<$>
                    completedParallelInputs,
                  ("computeMode" Core..=) Core.<$> computeMode,
                  ("computeMsAvg" Core..=) Core.. Core.AsText Core.<$> computeMsAvg,
                  ("computeMsMax" Core..=) Core.. Core.AsText Core.<$> computeMsMax,
                  ...
                  ("inputStages" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    inputStages,
                  ("name" Core..=) Core.<$> name,
                  ("parallelInputs" Core..=) Core.. Core.AsText Core.<$>
                    parallelInputs,
                  ("readMsAvg" Core..=) Core.. Core.AsText Core.<$> readMsAvg,
                  ("readMsMax" Core..=) Core.. Core.AsText Core.<$> readMsMax,
                  ...
                  ("recordsWritten" Core..=) Core.. Core.AsText Core.<$>
                    recordsWritten,
                  ("shuffleOutputBytes" Core..=) Core.. Core.AsText Core.<$>
                    shuffleOutputBytes,
                  ("shuffleOutputBytesSpilled" Core..=) Core.. Core.AsText Core.<$>
                    shuffleOutputBytesSpilled,
                  ("slotMs" Core..=) Core.. Core.AsText Core.<$> slotMs,
                  ("startMs" Core..=) Core.. Core.AsText Core.<$> startMs,
                  ("status" Core..=) Core.<$> status,
                  ("steps" Core..=) Core.<$> steps,
                  ("waitMsAvg" Core..=) Core.. Core.AsText Core.<$> waitMsAvg,
                  ("waitMsMax" Core..=) Core.. Core.AsText Core.<$> waitMsMax,
                  ("waitRatioAvg" Core..=) Core.<$> waitRatioAvg,
                  ("waitRatioMax" Core..=) Core.<$> waitRatioMax,
                  ("writeMsAvg" Core..=) Core.. Core.AsText Core.<$> writeMsAvg,
                  ("writeMsMax" Core..=) Core.. Core.AsText Core.<$> writeMsMax,
...
newExplanation 
    ::  Explanation
newExplanation
  = Explanation{attribution = Core.Nothing,
...
instance Core.FromJSON Explanation where
        parseJSON
          = Core.withObject "Explanation"
              (\ o ->
                 Explanation Core.<$>
                   (o Core..:? "attribution") Core.<*> (o Core..:? "featureName"))
...
newExportDataStatistics 
    ::  ExportDataStatistics
newExportDataStatistics
  = ExportDataStatistics{fileCount = Core.Nothing,
          ...
          = Core.withObject "ExportDataStatistics"
              (\ o ->
                 ExportDataStatistics Core.<$>
                   (o Core..:? "fileCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "rowCount" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON ExportDataStatistics where
        toJSON ExportDataStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("fileCount" Core..=) Core.. Core.AsText Core.<$> fileCount,
...
instance Core.FromJSON ExternalCatalogDatasetOptions where
        parseJSON
...
instance Core.ToJSON ExternalCatalogDatasetOptions where
...
instance Core.FromJSON ExternalCatalogDatasetOptions_Parameters
         where
        parseJSON
          = Core.withObject "ExternalCatalogDatasetOptions_Parameters"
              (\ o ->
                 ExternalCatalogDatasetOptions_Parameters Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ExternalCatalogDatasetOptions_Parameters where
...
newExternalCatalogTableOptions 
    ::  ExternalCatalogTableOptions
newExternalCatalogTableOptions
  = ExternalCatalogTableOptions{connectionId = Core.Nothing,
                                parameters = Core.Nothing, storageDescriptor = Core.Nothing}
instance Core.FromJSON ExternalCatalogTableOptions where
        parseJSON
          = Core.withObject "ExternalCatalogTableOptions"
              (\ o ->
                 ExternalCatalogTableOptions Core.<$>
                   (o Core..:? "connectionId") Core.<*> (o Core..:? "parameters")
                     Core.<*> (o Core..:? "storageDescriptor"))

instance Core.ToJSON ExternalCatalogTableOptions where
...
instance Core.FromJSON ExternalCatalogTableOptions_Parameters where
        parseJSON
          = Core.withObject "ExternalCatalogTableOptions_Parameters"
              (\ o ->
                 ExternalCatalogTableOptions_Parameters Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ExternalCatalogTableOptions_Parameters where
...
newExternalDataConfiguration 
    ::  ExternalDataConfiguration
newExternalDataConfiguration
  = ExternalDataConfiguration{autodetect = Core.Nothing,
                              avroOptions = Core.Nothing, bigtableOptions = Core.Nothing,
                              compression = Core.Nothing, connectionId = Core.Nothing,
                              csvOptions = Core.Nothing, dateFormat = Core.Nothing,
                              datetimeFormat = Core.Nothing, decimalTargetTypes = Core.Nothing,
                              fileSetSpecType = Core.Nothing, googleSheetsOptions = Core.Nothing,
                              hivePartitioningOptions = Core.Nothing,
                              ignoreUnknownValues = Core.Nothing, jsonExtension = Core.Nothing,
                              jsonOptions = Core.Nothing, maxBadRecords = Core.Nothing,
                              metadataCacheMode = Core.Nothing, objectMetadata = Core.Nothing,
                              parquetOptions = Core.Nothing,
                              referenceFileSchemaUri = Core.Nothing, schema = Core.Nothing,
                              sourceFormat = Core.Nothing, sourceUris = Core.Nothing,
                              timeFormat = Core.Nothing, timeZone = Core.Nothing,
          ...
          = Core.withObject "ExternalDataConfiguration"
              (\ o ->
                 ExternalDataConfiguration Core.<$>
                   (o Core..:? "autodetect") Core.<*> (o Core..:? "avroOptions")
...
newExternalDatasetReference 
    ::  ExternalDatasetReference
newExternalDatasetReference
  = ExternalDatasetReference{connection = Core.Nothing,
                             externalSource = Core.Nothing}
          ...
          = Core.withObject "ExternalDatasetReference"
              (\ o ->
                 ExternalDatasetReference Core.<$>
                   (o Core..:? "connection") Core.<*> (o Core..:? "externalSource"))
...
newExternalServiceCost 
    ::  ExternalServiceCost
newExternalServiceCost
  = ExternalServiceCost{bytesBilled = Core.Nothing,
                        bytesProcessed = Core.Nothing, externalService = Core.Nothing,
                        reservedSlotCount = Core.Nothing, slotMs = Core.Nothing}
instance Core.FromJSON ExternalServiceCost where
        parseJSON
          = Core.withObject "ExternalServiceCost"
              (\ o ->
                 ExternalServiceCost Core.<$>
                   (o Core..:? "bytesBilled" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "bytesProcessed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "externalService")
                     Core.<*>
                     (o Core..:? "reservedSlotCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "slotMs" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.ToJSON ExternalServiceCost where
        toJSON ExternalServiceCost{..}
          = Core.object
              (Core.catMaybes
                 [("bytesBilled" Core..=) Core.. Core.AsText Core.<$> bytesBilled,
                  ("bytesProcessed" Core..=) Core.. Core.AsText Core.<$>
                    bytesProcessed,
                  ("externalService" Core..=) Core.<$> externalService,
                  ("reservedSlotCount" Core..=) Core.. Core.AsText Core.<$>
                    reservedSlotCount,
                  ("slotMs" Core..=) Core.. Core.AsText Core.<$> slotMs])
...
newFeatureValue 
    ::  FeatureValue
newFeatureValue
  = FeatureValue{categoricalValue = Core.Nothing,
                 featureColumn = Core.Nothing, numericalValue = Core.Nothing}
...
instance Core.ToJSON FeatureValue where
        toJSON FeatureValue{..}
          = Core.object
              (Core.catMaybes
                 [("categoricalValue" Core..=) Core.<$> categoricalValue,
...
instance Core.FromJSON ForeignTypeInfo where
        parseJSON
          = Core.withObject "ForeignTypeInfo"
              (\ o -> ForeignTypeInfo Core.<$> (o Core..:? "typeSystem"))

instance Core.ToJSON ForeignTypeInfo where
        toJSON ForeignTypeInfo{..}
          = Core.object
              (Core.catMaybes [("typeSystem" Core..=) Core.<$> typeSystem])
...
newForeignViewDefinition 
    ::  ForeignViewDefinition
newForeignViewDefinition
  = ForeignViewDefinition{dialect = Core.Nothing,
                          query = Core.Nothing}
...
newGetQueryResultsResponse 
    ::  GetQueryResultsResponse
newGetQueryResultsResponse
  = GetQueryResultsResponse{cacheHit = Core.Nothing,
                            errors = Core.Nothing, etag = Core.Nothing,
                            jobComplete = Core.Nothing, jobReference = Core.Nothing,
                            kind = "bigquery#getQueryResultsResponse",
                            numDmlAffectedRows = Core.Nothing, pageToken = Core.Nothing,
                            rows = Core.Nothing, schema = Core.Nothing,
                            totalBytesProcessed = Core.Nothing, totalRows = Core.Nothing}
instance Core.FromJSON GetQueryResultsResponse where
        parseJSON
          = Core.withObject "GetQueryResultsResponse"
              (\ o ->
                 GetQueryResultsResponse Core.<$>
                   (o Core..:? "cacheHit") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "etag")
                     Core.<*> (o Core..:? "jobComplete")
                     Core.<*> (o Core..:? "jobReference")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "bigquery#getQueryResultsResponse")
                     Core.<*>
                     ...
                     (o Core..:? "totalBytesProcessed" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalRows" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("cacheHit" Core..=) Core.<$> cacheHit,
                  ("errors" Core..=) Core.<$> errors, ("etag" Core..=) Core.<$> etag,
                  ("jobComplete" Core..=) Core.<$> jobComplete,
                  ("jobReference" Core..=) Core.<$> jobReference,
                  Core.Just ("kind" Core..= kind),
                  ("numDmlAffectedRows" Core..=) Core.. Core.AsText Core.<$>
                    numDmlAffectedRows,
                  ("pageToken" Core..=) Core.<$> pageToken,
                  ("rows" Core..=) Core.<$> rows, ("schema" Core..=) Core.<$> schema,
                  ("totalBytesProcessed" Core..=) Core.. Core.AsText Core.<$>
                    totalBytesProcessed,
...
newGetServiceAccountResponse 
    ::  GetServiceAccountResponse
newGetServiceAccountResponse
  = GetServiceAccountResponse{email = Core.Nothing,
          ...
          = Core.withObject "GetServiceAccountResponse"
              (\ o ->
                 GetServiceAccountResponse Core.<$>
                   (o Core..:? "email") Core.<*>
                     (o Core..:? "kind" Core..!= "bigquery#getServiceAccountResponse"))
...
newGlobalExplanation 
    ::  GlobalExplanation
newGlobalExplanation
  = GlobalExplanation{classLabel = Core.Nothing,
          ...
          = Core.withObject "GlobalExplanation"
              (\ o ->
                 GlobalExplanation Core.<$>
                   (o Core..:? "classLabel") Core.<*> (o Core..:? "explanations"))
...
newGoogleSheetsOptions 
    ::  GoogleSheetsOptions
newGoogleSheetsOptions
  = GoogleSheetsOptions{range = Core.Nothing,
...
newHighCardinalityJoin 
    ::  HighCardinalityJoin
newHighCardinalityJoin
  = HighCardinalityJoin{leftRows = Core.Nothing,
                        outputRows = Core.Nothing, rightRows = Core.Nothing,
          ...
          = Core.withObject "HighCardinalityJoin"
              (\ o ->
                 HighCardinalityJoin Core.<$>
                   (o Core..:? "leftRows" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "outputRows" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "rightRows" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON HighCardinalityJoin where
        toJSON HighCardinalityJoin{..}
          = Core.object
              (Core.catMaybes
                 [("leftRows" Core..=) Core.. Core.AsText Core.<$> leftRows,
                  ("outputRows" Core..=) Core.. Core.AsText Core.<$> outputRows,
                  ("rightRows" Core..=) Core.. Core.AsText Core.<$> rightRows,
...
newHivePartitioningOptions 
    ::  HivePartitioningOptions
newHivePartitioningOptions
  = HivePartitioningOptions{fields = Core.Nothing,
                            mode = Core.Nothing, requirePartitionFilter = Core.False,
          ...
          = Core.withObject "HivePartitioningOptions"
              (\ o ->
                 HivePartitioningOptions Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "mode") Core.<*>
                     (o Core..:? "requirePartitionFilter" Core..!= Core.False)
          ...
          = Core.object
              (Core.catMaybes
                 [("fields" Core..=) Core.<$> fields,
                  ("mode" Core..=) Core.<$> mode,
                  Core.Just
                    ("requirePartitionFilter" Core..= requirePartitionFilter),
                  ("sourceUriPrefix" Core..=) Core.<$> sourceUriPrefix])
...
newHparamSearchSpaces 
    ::  HparamSearchSpaces
newHparamSearchSpaces
  = HparamSearchSpaces{activationFn = Core.Nothing,
                       batchSize = Core.Nothing, boosterType = Core.Nothing,
                       colsampleBylevel = Core.Nothing, colsampleBynode = Core.Nothing,
                       colsampleBytree = Core.Nothing, dartNormalizeType = Core.Nothing,
                       dropout = Core.Nothing, hiddenUnits = Core.Nothing,
                       l1Reg = Core.Nothing, l2Reg = Core.Nothing,
                       learnRate = Core.Nothing, maxTreeDepth = Core.Nothing,
                       minSplitLoss = Core.Nothing, minTreeChildWeight = Core.Nothing,
                       numClusters = Core.Nothing, numFactors = Core.Nothing,
                       numParallelTree = Core.Nothing, optimizer = Core.Nothing,
                       subsample = Core.Nothing, treeMethod = Core.Nothing,
          ...
          = Core.withObject "HparamSearchSpaces"
              (\ o ->
                 HparamSearchSpaces Core.<$>
                   (o Core..:? "activationFn") Core.<*> (o Core..:? "batchSize")
          ...
          = Core.object
              (Core.catMaybes
                 [("activationFn" Core..=) Core.<$> activationFn,
                  ...
                  ("colsampleBylevel" Core..=) Core.<$> colsampleBylevel,
                  ("colsampleBynode" Core..=) Core.<$> colsampleBynode,
                  ("colsampleBytree" Core..=) Core.<$> colsampleBytree,
                  ("dartNormalizeType" Core..=) Core.<$> dartNormalizeType,
                  ...
                  ("minTreeChildWeight" Core..=) Core.<$> minTreeChildWeight,
...
newHparamTuningTrial 
    ::  HparamTuningTrial
newHparamTuningTrial
  = HparamTuningTrial{endTimeMs = Core.Nothing,
                      errorMessage = Core.Nothing, evalLoss = Core.Nothing,
                      evaluationMetrics = Core.Nothing,
                      hparamTuningEvaluationMetrics = Core.Nothing,
                      hparams = Core.Nothing, startTimeMs = Core.Nothing,
                      status = Core.Nothing, trainingLoss = Core.Nothing,
          ...
          = Core.withObject "HparamTuningTrial"
              (\ o ->
                 HparamTuningTrial Core.<$>
                   (o Core..:? "endTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "hparams")
                     Core.<*>
                     (o Core..:? "startTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "status")
                     Core.<*> (o Core..:? "trainingLoss")
                     Core.<*> (o Core..:? "trialId" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("endTimeMs" Core..=) Core.. Core.AsText Core.<$> endTimeMs,
                  ...
                  ("status" Core..=) Core.<$> status,
                  ("trainingLoss" Core..=) Core.<$> trainingLoss,
                  ("trialId" Core..=) Core.. Core.AsText Core.<$> trialId])
...
newIndexUnusedReason 
    ::  IndexUnusedReason
newIndexUnusedReason
  = IndexUnusedReason{baseTable = Core.Nothing, code = Core.Nothing,
                      indexName = Core.Nothing, message = Core.Nothing}
instance Core.FromJSON IndexUnusedReason where
        parseJSON
          = Core.withObject "IndexUnusedReason"
              (\ o ->
                 IndexUnusedReason Core.<$>
                   (o Core..:? "baseTable") Core.<*> (o Core..:? "code") Core.<*>
                     (o Core..:? "indexName")
                     Core.<*> (o Core..:? "message"))
...
newInputDataChange 
    ::  InputDataChange
newInputDataChange
  = InputDataChange{recordsReadDiffPercentage = Core.Nothing}
instance Core.FromJSON InputDataChange where
        parseJSON
          = Core.withObject "InputDataChange"
              (\ o ->
                 InputDataChange Core.<$> (o Core..:? "recordsReadDiffPercentage"))
...
instance Core.ToJSON IntArray where
        toJSON IntArray{..}
          = Core.object
              (Core.catMaybes
                 [("elements" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    elements])
...
instance Core.FromJSON IntArrayHparamSearchSpace where
        parseJSON
          = Core.withObject "IntArrayHparamSearchSpace"
              (\ o ->
                 IntArrayHparamSearchSpace Core.<$> (o Core..:? "candidates"))
...
instance Core.ToJSON IntCandidates where
        toJSON IntCandidates{..}
          = Core.object
              (Core.catMaybes
                 [("candidates" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    candidates])
...
newIntHparamSearchSpace 
    ::  IntHparamSearchSpace
newIntHparamSearchSpace
  = IntHparamSearchSpace{candidates = Core.Nothing,
                         range = Core.Nothing}
...
instance Core.FromJSON IntRange where
        parseJSON
          = Core.withObject "IntRange"
              (\ o ->
                 IntRange Core.<$>
                   (o Core..:? "max" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "min" Core.<&> Core.fmap Core.fromAsText))
...
newIterationResult 
    ::  IterationResult
newIterationResult
  = IterationResult{arimaResult = Core.Nothing,
                    clusterInfos = Core.Nothing, durationMs = Core.Nothing,
                    evalLoss = Core.Nothing, index = Core.Nothing,
                    learnRate = Core.Nothing, principalComponentInfos = Core.Nothing,
          ...
          = Core.withObject "IterationResult"
              (\ o ->
                 IterationResult Core.<$>
                   (o Core..:? "arimaResult") Core.<*> (o Core..:? "clusterInfos")
                     Core.<*>
                     (o Core..:? "durationMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "evalLoss")
                     Core.<*> (o Core..:? "index")
...
newJob 
    ::  Job
newJob
  = Job{configuration = Core.Nothing, etag = Core.Nothing,
        id = Core.Nothing, jobCreationReason = Core.Nothing,
        jobReference = Core.Nothing, kind = "bigquery#job",
        principalSubject = Core.Nothing, selfLink = Core.Nothing,
...
instance Core.FromJSON Job where
        parseJSON
          = Core.withObject "Job"
              (\ o ->
                 Job Core.<$>
                   (o Core..:? "configuration") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("configuration" Core..=) Core.<$> configuration,
                  ("etag" Core..=) Core.<$> etag, ("id" Core..=) Core.<$> id,
                  ("jobCreationReason" Core..=) Core.<$> jobCreationReason,
                  ("jobReference" Core..=) Core.<$> jobReference,
                  Core.Just ("kind" Core..= kind),
                  ("principal_subject" Core..=) Core.<$> principalSubject,
                  ("selfLink" Core..=) Core.<$> selfLink,
...
newJobCancelResponse 
    ::  JobCancelResponse
newJobCancelResponse
  = JobCancelResponse{job = Core.Nothing,
          ...
          = Core.withObject "JobCancelResponse"
              (\ o ->
                 JobCancelResponse Core.<$>
                   (o Core..:? "job") Core.<*>
                     (o Core..:? "kind" Core..!= "bigquery#jobCancelResponse"))

instance Core.ToJSON JobCancelResponse where
        toJSON JobCancelResponse{..}
          = Core.object
              (Core.catMaybes
                 [("job" Core..=) Core.<$> job, Core.Just ("kind" Core..= kind)])
...
newJobConfiguration 
    ::  JobConfiguration
newJobConfiguration
  = JobConfiguration{copy = Core.Nothing, dryRun = Core.Nothing,
                     extract = Core.Nothing, jobTimeoutMs = Core.Nothing,
                     jobType = Core.Nothing, labels = Core.Nothing, load = Core.Nothing,
                     query = Core.Nothing, reservation = Core.Nothing}
instance Core.FromJSON JobConfiguration where
        parseJSON
          = Core.withObject "JobConfiguration"
              (\ o ->
                 JobConfiguration Core.<$>
                   (o Core..:? "copy") Core.<*> (o Core..:? "dryRun") Core.<*>
                     (o Core..:? "extract")
                     Core.<*>
                     (o Core..:? "jobTimeoutMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "jobType")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "load")
                     Core.<*> (o Core..:? "query")
          ...
          = Core.object
              (Core.catMaybes
                 [("copy" Core..=) Core.<$> copy,
                  ...
                  ("labels" Core..=) Core.<$> labels, ("load" Core..=) Core.<$> load,
                  ("query" Core..=) Core.<$> query,
...
instance Core.FromJSON JobConfiguration_Labels where
        parseJSON
          = Core.withObject "JobConfiguration_Labels"
              (\ o -> JobConfiguration_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON JobConfiguration_Labels where
        toJSON JobConfiguration_Labels{..} = Core.toJSON additional
...
newJobConfigurationExtract 
    ::  JobConfigurationExtract
newJobConfigurationExtract
  = JobConfigurationExtract{compression = Core.Nothing,
                            destinationFormat = Core.Nothing, destinationUri = Core.Nothing,
                            destinationUris = Core.Nothing, fieldDelimiter = Core.Nothing,
                            modelExtractOptions = Core.Nothing, printHeader = Core.True,
                            sourceModel = Core.Nothing, sourceTable = Core.Nothing,
...
instance Core.ToJSON JobConfigurationExtract where
        toJSON JobConfigurationExtract{..}
          = Core.object
              (Core.catMaybes
                 [("compression" Core..=) Core.<$> compression,
                  ("destinationFormat" Core..=) Core.<$> destinationFormat,
                  ("destinationUri" Core..=) Core.<$> destinationUri,
                  ("destinationUris" Core..=) Core.<$> destinationUris,
                  ("fieldDelimiter" Core..=) Core.<$> fieldDelimiter,
                  ("modelExtractOptions" Core..=) Core.<$> modelExtractOptions,
...
data JobConfigurationLoad = JobConfigurationLoad
    ...
    , sourceColumnMatch :: (Core.Maybe JobConfigurationLoad_SourceColumnMatch)
...
newJobConfigurationLoad 
    ::  JobConfigurationLoad
newJobConfigurationLoad
  = JobConfigurationLoad{allowJaggedRows = Core.Nothing,
                         allowQuotedNewlines = Core.Nothing, autodetect = Core.Nothing,
                         clustering = Core.Nothing, columnNameCharacterMap = Core.Nothing,
                         connectionProperties = Core.Nothing, copyFilesOnly = Core.Nothing,
                         createDisposition = Core.Nothing, createSession = Core.Nothing,
                         dateFormat = Core.Nothing, datetimeFormat = Core.Nothing,
                         decimalTargetTypes = Core.Nothing,
                         destinationEncryptionConfiguration = Core.Nothing,
                         destinationTable = Core.Nothing,
                         destinationTableProperties = Core.Nothing, encoding = Core.Nothing,
                         fieldDelimiter = Core.Nothing, fileSetSpecType = Core.Nothing,
                         hivePartitioningOptions = Core.Nothing,
                         ignoreUnknownValues = Core.Nothing, jsonExtension = Core.Nothing,
                         maxBadRecords = Core.Nothing, nullMarker = Core.Nothing,
                         nullMarkers = Core.Nothing, parquetOptions = Core.Nothing,
                         preserveAsciiControlCharacters = Core.Nothing,
                         projectionFields = Core.Nothing, quote = Core.Nothing,
                         rangePartitioning = Core.Nothing,
                         referenceFileSchemaUri = Core.Nothing, schema = Core.Nothing,
                         schemaInline = Core.Nothing, schemaInlineFormat = Core.Nothing,
                         schemaUpdateOptions = Core.Nothing, skipLeadingRows = Core.Nothing,
                         sourceColumnMatch = Core.Nothing, sourceFormat = Core.Nothing,
                         sourceUris = Core.Nothing, timeFormat = Core.Nothing,
                         timePartitioning = Core.Nothing, timeZone = Core.Nothing,
                         timestampFormat = Core.Nothing, useAvroLogicalTypes = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("allowJaggedRows" Core..=) Core.<$> allowJaggedRows,
                  ...
                  ("columnNameCharacterMap" Core..=) Core.<$> columnNameCharacterMap,
                  ("connectionProperties" Core..=) Core.<$> connectionProperties,
                  ...
                  ("datetimeFormat" Core..=) Core.<$> datetimeFormat,
                  ("decimalTargetTypes" Core..=) Core.<$> decimalTargetTypes,
                  ("destinationEncryptionConfiguration" Core..=) Core.<$>
                    destinationEncryptionConfiguration,
                  ("destinationTable" Core..=) Core.<$> destinationTable,
...
newJobConfigurationQuery 
    ::  JobConfigurationQuery
newJobConfigurationQuery
  = JobConfigurationQuery{allowLargeResults = Core.False,
                          clustering = Core.Nothing, connectionProperties = Core.Nothing,
                          continuous = Core.Nothing, createDisposition = Core.Nothing,
                          createSession = Core.Nothing, defaultDataset = Core.Nothing,
                          destinationEncryptionConfiguration = Core.Nothing,
                          destinationTable = Core.Nothing, flattenResults = Core.True,
                          maximumBillingTier = 1, maximumBytesBilled = Core.Nothing,
                          parameterMode = Core.Nothing, preserveNulls = Core.Nothing,
                          priority = Core.Nothing, query = Core.Nothing,
                          queryParameters = Core.Nothing, rangePartitioning = Core.Nothing,
                          schemaUpdateOptions = Core.Nothing, scriptOptions = Core.Nothing,
                          systemVariables = Core.Nothing, tableDefinitions = Core.Nothing,
                          timePartitioning = Core.Nothing, useLegacySql = Core.True,
          ...
          = Core.withObject "JobConfigurationQuery"
              (\ o ->
                 JobConfigurationQuery Core.<$>
                   (o Core..:? "allowLargeResults" Core..!= Core.False) Core.<*>
                     (o Core..:? "clustering")
                     Core.<*> (o Core..:? "connectionProperties")
...
instance Core.ToJSON JobConfigurationQuery where
        toJSON JobConfigurationQuery{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just ("allowLargeResults" Core..= allowLargeResults),
                  ("clustering" Core..=) Core.<$> clustering,
                  ("connectionProperties" Core..=) Core.<$> connectionProperties,
                  ...
                  Core.Just ("maximumBillingTier" Core..= maximumBillingTier),
                  ("maximumBytesBilled" Core..=) Core.. Core.AsText Core.<$>
                    maximumBytesBilled,
                  ...
                  ("tableDefinitions" Core..=) Core.<$> tableDefinitions,
                  ("timePartitioning" Core..=) Core.<$> timePartitioning,
                  ...
                  ("writeDisposition" Core..=) Core.<$> writeDisposition,
                  ("writeIncrementalResults" Core..=) Core.<$>
...
instance Core.FromJSON JobConfigurationQuery_TableDefinitions where
        parseJSON
          = Core.withObject "JobConfigurationQuery_TableDefinitions"
              (\ o ->
                 JobConfigurationQuery_TableDefinitions Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON JobConfigurationQuery_TableDefinitions where
...
newJobConfigurationTableCopy 
    ::  JobConfigurationTableCopy
newJobConfigurationTableCopy
  = JobConfigurationTableCopy{createDisposition = Core.Nothing,
                              destinationEncryptionConfiguration = Core.Nothing,
                              destinationExpirationTime = Core.Nothing,
                              destinationTable = Core.Nothing, operationType = Core.Nothing,
                              sourceTable = Core.Nothing, sourceTables = Core.Nothing,
                              writeDisposition = Core.Nothing}
...
instance Core.FromJSON JobCreationReason where
        parseJSON
          = Core.withObject "JobCreationReason"
              (\ o -> JobCreationReason Core.<$> (o Core..:? "code"))
...
newJobList 
    ::  JobList
newJobList
  = JobList{etag = Core.Nothing, jobs = Core.Nothing,
            kind = "bigquery#jobList", nextPageToken = Core.Nothing,
            unreachable = Core.Nothing}
instance Core.FromJSON JobList where
        parseJSON
          = Core.withObject "JobList"
              (\ o ->
                 JobList Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "jobs") Core.<*>
...
instance Core.ToJSON JobList where
        toJSON JobList{..}
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag, ("jobs" Core..=) Core.<$> jobs,
                  Core.Just ("kind" Core..= kind),
                  ("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("unreachable" Core..=) Core.<$> unreachable])
...
newJobList_JobsItem 
    ::  JobList_JobsItem
newJobList_JobsItem
  = JobList_JobsItem{configuration = Core.Nothing,
                     errorResult = Core.Nothing, id = Core.Nothing,
                     jobReference = Core.Nothing, kind = Core.Nothing,
                     principalSubject = Core.Nothing, state = Core.Nothing,
                     statistics = Core.Nothing, status = Core.Nothing,
                     userEmail = Core.Nothing}
          ...
          = Core.withObject "JobList_JobsItem"
              (\ o ->
                 JobList_JobsItem Core.<$>
                   (o Core..:? "configuration") Core.<*> (o Core..:? "errorResult")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "jobReference")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "principal_subject")
...
newJobReference 
    ::  JobReference
newJobReference
  = JobReference{jobId = Core.Nothing, location = Core.Nothing,
                 projectId = Core.Nothing}
instance Core.FromJSON JobReference where
        parseJSON
          = Core.withObject "JobReference"
              (\ o ->
                 JobReference Core.<$>
                   (o Core..:? "jobId") Core.<*> (o Core..:? "location") Core.<*>
                     (o Core..:? "projectId"))
...
newJobStatistics 
    ::  JobStatistics
newJobStatistics
  = JobStatistics{completionRatio = Core.Nothing,
                  copy = Core.Nothing, creationTime = Core.Nothing,
                  dataMaskingStatistics = Core.Nothing, edition = Core.Nothing,
                  endTime = Core.Nothing, extract = Core.Nothing,
                  finalExecutionDurationMs = Core.Nothing, load = Core.Nothing,
                  numChildJobs = Core.Nothing, parentJobId = Core.Nothing,
                  query = Core.Nothing, quotaDeferments = Core.Nothing,
                  reservationUsage = Core.Nothing, reservationId = Core.Nothing,
                  rowLevelSecurityStatistics = Core.Nothing,
                  scriptStatistics = Core.Nothing, sessionInfo = Core.Nothing,
                  startTime = Core.Nothing, totalBytesProcessed = Core.Nothing,
                  totalSlotMs = Core.Nothing, transactionInfo = Core.Nothing}
instance Core.FromJSON JobStatistics where
        parseJSON
          = Core.withObject "JobStatistics"
              (\ o ->
                 JobStatistics Core.<$>
                   (o Core..:? "completionRatio") Core.<*> (o Core..:? "copy")
                     Core.<*>
                     (o Core..:? "creationTime" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "load")
                     Core.<*>
                     (o Core..:? "numChildJobs" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "startTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalBytesProcessed" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalSlotMs" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON JobStatistics where
        toJSON JobStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("completionRatio" Core..=) Core.<$> completionRatio,
                  ("copy" Core..=) Core.<$> copy,
                  ("creationTime" Core..=) Core.. Core.AsText Core.<$> creationTime,
                  ("dataMaskingStatistics" Core..=) Core.<$> dataMaskingStatistics,
                  ("edition" Core..=) Core.<$> edition,
                  ("endTime" Core..=) Core.. Core.AsText Core.<$> endTime,
                  ("extract" Core..=) Core.<$> extract,
                  ("finalExecutionDurationMs" Core..=) Core.. Core.AsText Core.<$>
                    finalExecutionDurationMs,
                  ("load" Core..=) Core.<$> load,
                  ("numChildJobs" Core..=) Core.. Core.AsText Core.<$> numChildJobs,
                  ("parentJobId" Core..=) Core.<$> parentJobId,
                  ("query" Core..=) Core.<$> query,
                  ("quotaDeferments" Core..=) Core.<$> quotaDeferments,
                  ("reservationUsage" Core..=) Core.<$> reservationUsage,
                  ("reservation_id" Core..=) Core.<$> reservationId,
                  ("rowLevelSecurityStatistics" Core..=) Core.<$>
                    rowLevelSecurityStatistics,
                  ("scriptStatistics" Core..=) Core.<$> scriptStatistics,
                  ...
                  ("transactionInfo" Core..=) Core.<$> transactionInfo])
...
newJobStatistics_ReservationUsageItem 
    :: 
                                      JobStatistics_ReservationUsageItem
newJobStatistics_ReservationUsageItem
  = JobStatistics_ReservationUsageItem{name = Core.Nothing,
                                       slotMs = Core.Nothing}
instance Core.FromJSON JobStatistics_ReservationUsageItem where
        parseJSON
          = Core.withObject "JobStatistics_ReservationUsageItem"
              (\ o ->
                 JobStatistics_ReservationUsageItem Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "slotMs" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON JobStatistics_ReservationUsageItem where
...
newJobStatistics2 
    ::  JobStatistics2
newJobStatistics2
  = JobStatistics2{biEngineStatistics = Core.Nothing,
                   billingTier = Core.Nothing, cacheHit = Core.Nothing,
                   dclTargetDataset = Core.Nothing, dclTargetTable = Core.Nothing,
                   ...
                   ddlTargetDataset = Core.Nothing, ddlTargetRoutine = Core.Nothing,
                   ddlTargetRowAccessPolicy = Core.Nothing,
                   ddlTargetTable = Core.Nothing, dmlStats = Core.Nothing,
                   ...
                   mlStatistics = Core.Nothing, modelTraining = Core.Nothing,
                   ...
                   performanceInsights = Core.Nothing, queryInfo = Core.Nothing,
                   queryPlan = Core.Nothing, referencedRoutines = Core.Nothing,
                   referencedTables = Core.Nothing, reservationUsage = Core.Nothing,
                   schema = Core.Nothing, searchStatistics = Core.Nothing,
                   sparkStatistics = Core.Nothing, statementType = Core.Nothing,
                   timeline = Core.Nothing, totalBytesBilled = Core.Nothing,
                   totalBytesProcessed = Core.Nothing,
                   totalBytesProcessedAccuracy = Core.Nothing,
                   totalPartitionsProcessed = Core.Nothing,
                   totalSlotMs = Core.Nothing, transferredBytes = Core.Nothing,
              ...
              (\ o ->
                 JobStatistics2 Core.<$>
                   (o Core..:? "biEngineStatistics") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "ddlAffectedRowAccessPolicyCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "modelTrainingExpectedTotalIteration" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numDmlAffectedRows" Core.<&>
                        Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "totalBytesBilled" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalBytesProcessed" Core.<&>
                        Core.fmap Core.fromAsText)
                     ...
                     (o Core..:? "totalSlotMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "transferredBytes" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON JobStatistics2 where
        toJSON JobStatistics2{..}
          = Core.object
              (Core.catMaybes
                 [("biEngineStatistics" Core..=) Core.<$> biEngineStatistics,
                  ("billingTier" Core..=) Core.<$> billingTier,
                  ("cacheHit" Core..=) Core.<$> cacheHit,
                  ("dclTargetDataset" Core..=) Core.<$> dclTargetDataset,
                  ("dclTargetTable" Core..=) Core.<$> dclTargetTable,
                  ("dclTargetView" Core..=) Core.<$> dclTargetView,
                  ("ddlAffectedRowAccessPolicyCount" Core..=) Core.. Core.AsText
                    Core.<$> ddlAffectedRowAccessPolicyCount,
                  ("ddlDestinationTable" Core..=) Core.<$> ddlDestinationTable,
                  ("ddlOperationPerformed" Core..=) Core.<$> ddlOperationPerformed,
                  ("ddlTargetDataset" Core..=) Core.<$> ddlTargetDataset,
                  ("ddlTargetRoutine" Core..=) Core.<$> ddlTargetRoutine,
                  ("ddlTargetRowAccessPolicy" Core..=) Core.<$>
                    ddlTargetRowAccessPolicy,
                  ("ddlTargetTable" Core..=) Core.<$> ddlTargetTable,
                  ("dmlStats" Core..=) Core.<$> dmlStats,
                  ("estimatedBytesProcessed" Core..=) Core.. Core.AsText Core.<$>
                    estimatedBytesProcessed,
                  ("exportDataStatistics" Core..=) Core.<$> exportDataStatistics,
                  ("externalServiceCosts" Core..=) Core.<$> externalServiceCosts,
                  ("loadQueryStatistics" Core..=) Core.<$> loadQueryStatistics,
                  ...
                  ("modelTrainingExpectedTotalIteration" Core..=) Core.. Core.AsText
                    Core.<$> modelTrainingExpectedTotalIteration,
                  ("numDmlAffectedRows" Core..=) Core.. Core.AsText Core.<$>
                    numDmlAffectedRows,
                  ("performanceInsights" Core..=) Core.<$> performanceInsights,
                  ("queryInfo" Core..=) Core.<$> queryInfo,
                  ("queryPlan" Core..=) Core.<$> queryPlan,
                  ("referencedRoutines" Core..=) Core.<$> referencedRoutines,
                  ("referencedTables" Core..=) Core.<$> referencedTables,
                  ("reservationUsage" Core..=) Core.<$> reservationUsage,
                  ("schema" Core..=) Core.<$> schema,
                  ("searchStatistics" Core..=) Core.<$> searchStatistics,
                  ("sparkStatistics" Core..=) Core.<$> sparkStatistics,
                  ("statementType" Core..=) Core.<$> statementType,
                  ("timeline" Core..=) Core.<$> timeline,
                  ("totalBytesBilled" Core..=) Core.. Core.AsText Core.<$>
                    totalBytesBilled,
                  ("totalBytesProcessed" Core..=) Core.. Core.AsText Core.<$>
                    totalBytesProcessed,
                  ("totalBytesProcessedAccuracy" Core..=) Core.<$>
                    totalBytesProcessedAccuracy,
                  ("totalPartitionsProcessed" Core..=) Core.. Core.AsText Core.<$>
                    totalPartitionsProcessed,
                  ("totalSlotMs" Core..=) Core.. Core.AsText Core.<$> totalSlotMs,
                  ("transferredBytes" Core..=) Core.. Core.AsText Core.<$>
                    transferredBytes,
...
newJobStatistics2_ReservationUsageItem 
    :: 
                                       JobStatistics2_ReservationUsageItem
newJobStatistics2_ReservationUsageItem
  = JobStatistics2_ReservationUsageItem{name = Core.Nothing,
                                        slotMs = Core.Nothing}
instance Core.FromJSON JobStatistics2_ReservationUsageItem where
        parseJSON
          = Core.withObject "JobStatistics2_ReservationUsageItem"
              (\ o ->
                 JobStatistics2_ReservationUsageItem Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "slotMs" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON JobStatistics2_ReservationUsageItem where
...
newJobStatistics3 
    ::  JobStatistics3
newJobStatistics3
  = JobStatistics3{badRecords = Core.Nothing,
                   inputFileBytes = Core.Nothing, inputFiles = Core.Nothing,
                   outputBytes = Core.Nothing, outputRows = Core.Nothing,
...
instance Core.FromJSON JobStatistics3 where
        parseJSON
          = Core.withObject "JobStatistics3"
              (\ o ->
                 JobStatistics3 Core.<$>
                   (o Core..:? "badRecords" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "inputFileBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "inputFiles" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.ToJSON JobStatistics3 where
        toJSON JobStatistics3{..}
          = Core.object
              (Core.catMaybes
                 [("badRecords" Core..=) Core.. Core.AsText Core.<$> badRecords,
                  ("inputFileBytes" Core..=) Core.. Core.AsText Core.<$>
                    inputFileBytes,
                  ("inputFiles" Core..=) Core.. Core.AsText Core.<$> inputFiles,
...
newJobStatistics4 
    ::  JobStatistics4
newJobStatistics4
  = JobStatistics4{destinationUriFileCounts = Core.Nothing,
                   inputBytes = Core.Nothing, timeline = Core.Nothing}
...
instance Core.ToJSON JobStatistics4 where
        toJSON JobStatistics4{..}
          = Core.object
              (Core.catMaybes
                 [("destinationUriFileCounts" Core..=) Core.. Core.fmap Core.AsText
...
newJobStatistics5 
    ::  JobStatistics5
newJobStatistics5
  = JobStatistics5{copiedLogicalBytes = Core.Nothing,
                   copiedRows = Core.Nothing}
              ...
              (\ o ->
                 JobStatistics5 Core.<$>
                   (o Core..:? "copiedLogicalBytes" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "copiedRows" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON JobStatistics5 where
        toJSON JobStatistics5{..}
          = Core.object
              (Core.catMaybes
                 [("copiedLogicalBytes" Core..=) Core.. Core.AsText Core.<$>
                    copiedLogicalBytes,
                  ("copiedRows" Core..=) Core.. Core.AsText Core.<$> copiedRows])
...
newJobStatus 
    ::  JobStatus
newJobStatus
  = JobStatus{errorResult = Core.Nothing, errors = Core.Nothing,
              state = Core.Nothing}
instance Core.FromJSON JobStatus where
        parseJSON
          = Core.withObject "JobStatus"
              (\ o ->
                 JobStatus Core.<$>
                   (o Core..:? "errorResult") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "state"))
...
newJoinRestrictionPolicy 
    ::  JoinRestrictionPolicy
newJoinRestrictionPolicy
  = JoinRestrictionPolicy{joinAllowedColumns = Core.Nothing,
                          joinCondition = Core.Nothing}
...
instance Core.ToJSON JoinRestrictionPolicy where
        toJSON JoinRestrictionPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("joinAllowedColumns" Core..=) Core.<$> joinAllowedColumns,
...
newListModelsResponse 
    ::  ListModelsResponse
newListModelsResponse
  = ListModelsResponse{models = Core.Nothing,
          ...
          = Core.withObject "ListModelsResponse"
              (\ o ->
                 ListModelsResponse Core.<$>
                   (o Core..:? "models") Core.<*> (o Core..:? "nextPageToken"))
...
newListRowAccessPoliciesResponse 
    ::  ListRowAccessPoliciesResponse
newListRowAccessPoliciesResponse
  = ListRowAccessPoliciesResponse{nextPageToken = Core.Nothing,
...
instance Core.ToJSON ListRowAccessPoliciesResponse where
        toJSON ListRowAccessPoliciesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("rowAccessPolicies" Core..=) Core.<$> rowAccessPolicies])
...
newLoadQueryStatistics 
    ::  LoadQueryStatistics
newLoadQueryStatistics
  = LoadQueryStatistics{badRecords = Core.Nothing,
                        bytesTransferred = Core.Nothing, inputFileBytes = Core.Nothing,
                        inputFiles = Core.Nothing, outputBytes = Core.Nothing,
          ...
          = Core.withObject "LoadQueryStatistics"
              (\ o ->
                 LoadQueryStatistics Core.<$>
                   (o Core..:? "badRecords" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "bytesTransferred" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "inputFileBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "inputFiles" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON LoadQueryStatistics where
        toJSON LoadQueryStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("badRecords" Core..=) Core.. Core.AsText Core.<$> badRecords,
                  ("bytesTransferred" Core..=) Core.. Core.AsText Core.<$>
                    bytesTransferred,
                  ("inputFileBytes" Core..=) Core.. Core.AsText Core.<$>
                    inputFileBytes,
                  ("inputFiles" Core..=) Core.. Core.AsText Core.<$> inputFiles,
...
newMaterializedView 
    ::  MaterializedView
newMaterializedView
  = MaterializedView{chosen = Core.Nothing,
                     estimatedBytesSaved = Core.Nothing, rejectedReason = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("chosen" Core..=) Core.<$> chosen,
                  ("estimatedBytesSaved" Core..=) Core.. Core.AsText Core.<$>
                    estimatedBytesSaved,
...
newMaterializedViewDefinition
  = MaterializedViewDefinition{allowNonIncrementalDefinition =
                                 Core.Nothing,
                               enableRefresh = Core.Nothing, lastRefreshTime = Core.Nothing,
                               maxStaleness = Core.Nothing, query = Core.Nothing,
              ...
              (\ o ->
                 MaterializedViewDefinition Core.<$>
                   (o Core..:? "allowNonIncrementalDefinition") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "lastRefreshTime" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("allowNonIncrementalDefinition" Core..=) Core.<$>
                  ...
                  ("lastRefreshTime" Core..=) Core.. Core.AsText Core.<$>
                    lastRefreshTime,
                  ("maxStaleness" Core..=) Core.<$> maxStaleness,
                  ("query" Core..=) Core.<$> query,
                  ("refreshIntervalMs" Core..=) Core.. Core.AsText Core.<$>
                    refreshIntervalMs])
...
instance Core.FromJSON MaterializedViewStatistics where
        parseJSON
...
instance Core.ToJSON MaterializedViewStatistics where
        toJSON MaterializedViewStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("materializedView" Core..=) Core.<$> materializedView])
...
newMaterializedViewStatus 
    ::  MaterializedViewStatus
newMaterializedViewStatus
  = MaterializedViewStatus{lastRefreshStatus = Core.Nothing,
                           refreshWatermark = Core.Nothing}
...
instance Core.ToJSON MaterializedViewStatus where
        toJSON MaterializedViewStatus{..}
          = Core.object
              (Core.catMaybes
                 [("lastRefreshStatus" Core..=) Core.<$> lastRefreshStatus,
                  ("refreshWatermark" Core..=) Core.<$> refreshWatermark])
...
newMlStatistics 
    ::  MlStatistics
newMlStatistics
  = MlStatistics{hparamTrials = Core.Nothing,
                 iterationResults = Core.Nothing, maxIterations = Core.Nothing,
                 modelType = Core.Nothing, trainingType = Core.Nothing}
              ...
              (\ o ->
                 MlStatistics Core.<$>
                   (o Core..:? "hparamTrials") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "maxIterations" Core.<&> Core.fmap Core.fromAsText)
...
newModel 
    ::  Model
newModel
  = Model{bestTrialId = Core.Nothing, creationTime = Core.Nothing,
          defaultTrialId = Core.Nothing, description = Core.Nothing,
          encryptionConfiguration = Core.Nothing, etag = Core.Nothing,
          expirationTime = Core.Nothing, featureColumns = Core.Nothing,
          friendlyName = Core.Nothing, hparamSearchSpaces = Core.Nothing,
          hparamTrials = Core.Nothing, labelColumns = Core.Nothing,
          labels = Core.Nothing, lastModifiedTime = Core.Nothing,
          location = Core.Nothing, modelReference = Core.Nothing,
          modelType = Core.Nothing, optimalTrialIds = Core.Nothing,
          remoteModelInfo = Core.Nothing, trainingRuns = Core.Nothing,
...
instance Core.FromJSON Model where
        parseJSON
          = Core.withObject "Model"
              (\ o ->
                 Model Core.<$>
                   (o Core..:? "bestTrialId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "creationTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "defaultTrialId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "encryptionConfiguration")
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "expirationTime" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON Model where
        toJSON Model{..}
          = Core.object
              (Core.catMaybes
                 [("bestTrialId" Core..=) Core.. Core.AsText Core.<$> bestTrialId,
                  ("creationTime" Core..=) Core.. Core.AsText Core.<$> creationTime,
                  ("defaultTrialId" Core..=) Core.. Core.AsText Core.<$>
                    defaultTrialId,
                  ("description" Core..=) Core.<$> description,
                  ("encryptionConfiguration" Core..=) Core.<$>
                    encryptionConfiguration,
                  ("etag" Core..=) Core.<$> etag,
                  ("expirationTime" Core..=) Core.. Core.AsText Core.<$>
                    expirationTime,
                  ("featureColumns" Core..=) Core.<$> featureColumns,
                  ("friendlyName" Core..=) Core.<$> friendlyName,
                  ("hparamSearchSpaces" Core..=) Core.<$> hparamSearchSpaces,
                  ("hparamTrials" Core..=) Core.<$> hparamTrials,
                  ...
                  ("modelType" Core..=) Core.<$> modelType,
                  ("optimalTrialIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    optimalTrialIds,
                  ("remoteModelInfo" Core..=) Core.<$> remoteModelInfo,
                  ("trainingRuns" Core..=) Core.<$> trainingRuns,
                  ("transformColumns" Core..=) Core.<$> transformColumns])
...
instance Core.FromJSON Model_Labels where
        parseJSON
          = Core.withObject "Model_Labels"
              (\ o -> Model_Labels Core.<$> (Core.parseJSONObject o))
...
newModelDefinition 
    ::  ModelDefinition
newModelDefinition
  = ModelDefinition{modelOptions = Core.Nothing,
          ...
          = Core.withObject "ModelDefinition"
              (\ o ->
                 ModelDefinition Core.<$>
                   (o Core..:? "modelOptions") Core.<*> (o Core..:? "trainingRuns"))
...
newModelDefinition_ModelOptions 
    ::  ModelDefinition_ModelOptions
newModelDefinition_ModelOptions
  = ModelDefinition_ModelOptions{labels = Core.Nothing,
                                 lossType = Core.Nothing, modelType = Core.Nothing}
          ...
          = Core.withObject "ModelDefinition_ModelOptions"
              (\ o ->
                 ModelDefinition_ModelOptions Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "lossType") Core.<*>
                     (o Core..:? "modelType"))
...
newModelReference 
    ::  ModelReference
newModelReference
  = ModelReference{datasetId = Core.Nothing, modelId = Core.Nothing,
                   projectId = Core.Nothing}
instance Core.FromJSON ModelReference where
        parseJSON
          = Core.withObject "ModelReference"
              (\ o ->
                 ModelReference Core.<$>
                   (o Core..:? "datasetId") Core.<*> (o Core..:? "modelId") Core.<*>
                     (o Core..:? "projectId"))
...
instance Core.FromJSON MultiClassClassificationMetrics where
        parseJSON
          = Core.withObject "MultiClassClassificationMetrics"
              (\ o ->
                 MultiClassClassificationMetrics Core.<$>
                   (o Core..:? "aggregateClassificationMetrics") Core.<*>
                     (o Core..:? "confusionMatrixList"))
        ...
        toJSON MultiClassClassificationMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("aggregateClassificationMetrics" Core..=) Core.<$>
                    aggregateClassificationMetrics,
                  ("confusionMatrixList" Core..=) Core.<$> confusionMatrixList])
...
newParquetOptions 
    ::  ParquetOptions
newParquetOptions
  = ParquetOptions{enableListInference = Core.Nothing,
                   enumAsString = Core.Nothing, mapTargetType = Core.Nothing}
...
instance Core.ToJSON ParquetOptions where
        toJSON ParquetOptions{..}
          = Core.object
              (Core.catMaybes
                 [("enableListInference" Core..=) Core.<$> enableListInference,
...
instance Core.FromJSON PartitionSkew where
        parseJSON
          = Core.withObject "PartitionSkew"
              (\ o -> PartitionSkew Core.<$> (o Core..:? "skewSources"))

instance Core.ToJSON PartitionSkew where
        toJSON PartitionSkew{..}
          = Core.object
              (Core.catMaybes [("skewSources" Core..=) Core.<$> skewSources])
...
instance Core.FromJSON PartitionedColumn where
        parseJSON
          = Core.withObject "PartitionedColumn"
              (\ o -> PartitionedColumn Core.<$> (o Core..:? "field"))
...
instance Core.FromJSON PartitioningDefinition where
        parseJSON
          = Core.withObject "PartitioningDefinition"
              (\ o ->
                 PartitioningDefinition Core.<$> (o Core..:? "partitionedColumn"))

instance Core.ToJSON PartitioningDefinition where
        toJSON PartitioningDefinition{..}
          = Core.object
              (Core.catMaybes
                 [("partitionedColumn" Core..=) Core.<$> partitionedColumn])
...
newPerformanceInsights 
    ::  PerformanceInsights
newPerformanceInsights
  = PerformanceInsights{avgPreviousExecutionMs = Core.Nothing,
              ...
              (\ o ->
                 PerformanceInsights Core.<$>
                   (o Core..:? "avgPreviousExecutionMs" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "stagePerformanceChangeInsights")
                     Core.<*> (o Core..:? "stagePerformanceStandaloneInsights"))

instance Core.ToJSON PerformanceInsights where
        toJSON PerformanceInsights{..}
          = Core.object
              (Core.catMaybes
                 [("avgPreviousExecutionMs" Core..=) Core.. Core.AsText Core.<$>
                    avgPreviousExecutionMs,
                  ("stagePerformanceChangeInsights" Core..=) Core.<$>
                    stagePerformanceChangeInsights,
                  ("stagePerformanceStandaloneInsights" Core..=) Core.<$>
          ...
          = Core.withObject "PrincipalComponentInfo"
              (\ o ->
                 PrincipalComponentInfo Core.<$>
                   (o Core..:? "cumulativeExplainedVarianceRatio") Core.<*>
                     (o Core..:? "explainedVariance")
...
instance Core.ToJSON PrincipalComponentInfo where
        toJSON PrincipalComponentInfo{..}
          = Core.object
              (Core.catMaybes
                 [("cumulativeExplainedVarianceRatio" Core..=) Core.<$>
                    cumulativeExplainedVarianceRatio,
                  ("explainedVariance" Core..=) Core.<$> explainedVariance,
                  ("explainedVarianceRatio" Core..=) Core.<$> explainedVarianceRatio,
                  ("principalComponentId" Core..=) Core.. Core.AsText Core.<$>
...
newPrivacyPolicy 
    ::  PrivacyPolicy
newPrivacyPolicy
  = PrivacyPolicy{aggregationThresholdPolicy = Core.Nothing,
              ...
              (Core.catMaybes
                 [("aggregationThresholdPolicy" Core..=) Core.<$>
                  ...
                  ("differentialPrivacyPolicy" Core..=) Core.<$>
                    differentialPrivacyPolicy,
                  ("joinRestrictionPolicy" Core..=) Core.<$> joinRestrictionPolicy])
...
newProjectList 
    ::  ProjectList
newProjectList
  = ProjectList{etag = Core.Nothing, kind = "bigquery#projectList",
                nextPageToken = Core.Nothing, projects = Core.Nothing,
...
newProjectList_ProjectsItem 
    ::  ProjectList_ProjectsItem
newProjectList_ProjectsItem
  = ProjectList_ProjectsItem{friendlyName = Core.Nothing,
                             id = Core.Nothing, kind = Core.Nothing, numericId = Core.Nothing,
          ...
          = Core.withObject "ProjectList_ProjectsItem"
              (\ o ->
                 ProjectList_ProjectsItem Core.<$>
                   (o Core..:? "friendlyName") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "numericId" Core.<&> Core.fmap Core.fromAsText)
        ...
        toJSON ProjectList_ProjectsItem{..}
          = Core.object
              (Core.catMaybes
                 [("friendlyName" Core..=) Core.<$> friendlyName,
                  ("id" Core..=) Core.<$> id, ("kind" Core..=) Core.<$> kind,
                  ("numericId" Core..=) Core.. Core.AsText Core.<$> numericId,
                  ("projectReference" Core..=) Core.<$> projectReference])
...
instance Core.FromJSON ProjectReference where
        parseJSON
          = Core.withObject "ProjectReference"
              (\ o -> ProjectReference Core.<$> (o Core..:? "projectId"))

instance Core.ToJSON ProjectReference where
        toJSON ProjectReference{..}
          = Core.object
              (Core.catMaybes [("projectId" Core..=) Core.<$> projectId])
...
instance Core.FromJSON QueryInfo where
        parseJSON
          = Core.withObject "QueryInfo"
              (\ o -> QueryInfo Core.<$> (o Core..:? "optimizationDetails"))

instance Core.ToJSON QueryInfo where
        toJSON QueryInfo{..}
          = Core.object
              (Core.catMaybes
                 [("optimizationDetails" Core..=) Core.<$> optimizationDetails])
...
instance Core.FromJSON QueryInfo_OptimizationDetails where
        parseJSON
          = Core.withObject "QueryInfo_OptimizationDetails"
              (\ o ->
                 QueryInfo_OptimizationDetails Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON QueryInfo_OptimizationDetails where
        toJSON QueryInfo_OptimizationDetails{..} = Core.toJSON additional
...
newQueryParameter 
    ::  QueryParameter
newQueryParameter
  = QueryParameter{name = Core.Nothing, parameterType = Core.Nothing,
...
instance Core.FromJSON QueryParameter where
        parseJSON
          = Core.withObject "QueryParameter"
              (\ o ->
                 QueryParameter Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "parameterType") Core.<*>
                     (o Core..:? "parameterValue"))
...
newQueryParameterType 
    ::  QueryParameterType
newQueryParameterType
  = QueryParameterType{arrayType = Core.Nothing,
                       rangeElementType = Core.Nothing, structTypes = Core.Nothing,
                       type' = Core.Nothing}
          ...
          = Core.withObject "QueryParameterType"
              (\ o ->
                 QueryParameterType Core.<$>
                   (o Core..:? "arrayType") Core.<*> (o Core..:? "rangeElementType")
          ...
          = Core.object
              (Core.catMaybes
                 [("arrayType" Core..=) Core.<$> arrayType,
                  ("rangeElementType" Core..=) Core.<$> rangeElementType,
...
newQueryParameterType_StructTypesItem 
    :: 
                                      QueryParameterType_StructTypesItem
newQueryParameterType_StructTypesItem
  = QueryParameterType_StructTypesItem{description = Core.Nothing,
                                       name = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON QueryParameterType_StructTypesItem where
        parseJSON
          = Core.withObject "QueryParameterType_StructTypesItem"
              (\ o ->
                 QueryParameterType_StructTypesItem Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "type"))

instance Core.ToJSON QueryParameterType_StructTypesItem where
...
newQueryParameterValue 
    ::  QueryParameterValue
newQueryParameterValue
  = QueryParameterValue{arrayValues = Core.Nothing,
                        rangeValue = Core.Nothing, structValues = Core.Nothing,
                        value = Core.Nothing}
          ...
          = Core.withObject "QueryParameterValue"
              (\ o ->
                 QueryParameterValue Core.<$>
                   (o Core..:? "arrayValues") Core.<*> (o Core..:? "rangeValue")
...
instance Core.FromJSON QueryParameterValue_StructValues where
        parseJSON
          = Core.withObject "QueryParameterValue_StructValues"
              (\ o ->
                 QueryParameterValue_StructValues Core.<$> (Core.parseJSONObject o))
...
newQueryRequest 
    ::  QueryRequest
newQueryRequest
  = QueryRequest{connectionProperties = Core.Nothing,
                 continuous = Core.Nothing, createSession = Core.Nothing,
                 defaultDataset = Core.Nothing,
                 destinationEncryptionConfiguration = Core.Nothing,
                 dryRun = Core.Nothing, formatOptions = Core.Nothing,
                 jobCreationMode = Core.Nothing, jobTimeoutMs = Core.Nothing,
                 kind = "bigquery#queryRequest", labels = Core.Nothing,
                 location = Core.Nothing, maxResults = Core.Nothing,
                 maximumBytesBilled = Core.Nothing, parameterMode = Core.Nothing,
                 preserveNulls = Core.Nothing, query = Core.Nothing,
                 queryParameters = Core.Nothing, requestId = Core.Nothing,
                 reservation = Core.Nothing, timeoutMs = Core.Nothing,
                 useLegacySql = Core.True, useQueryCache = Core.True,
                 writeIncrementalResults = Core.Nothing}
...
instance Core.FromJSON QueryRequest_Labels where
        parseJSON
          = Core.withObject "QueryRequest_Labels"
              (\ o -> QueryRequest_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON QueryRequest_Labels where
        toJSON QueryRequest_Labels{..} = Core.toJSON additional
...
newQueryResponse 
    ::  QueryResponse
newQueryResponse
  = QueryResponse{cacheHit = Core.Nothing,
                  creationTime = Core.Nothing, dmlStats = Core.Nothing,
                  endTime = Core.Nothing, errors = Core.Nothing,
                  jobComplete = Core.Nothing, jobCreationReason = Core.Nothing,
                  jobReference = Core.Nothing, kind = "bigquery#queryResponse",
                  location = Core.Nothing, numDmlAffectedRows = Core.Nothing,
                  pageToken = Core.Nothing, queryId = Core.Nothing,
                  rows = Core.Nothing, schema = Core.Nothing,
                  sessionInfo = Core.Nothing, startTime = Core.Nothing,
...
data QueryTimelineSample = QueryTimelineSample
    ...
    , shuffleRamUsageRatio :: (Core.Maybe Core.Double)
...
newQueryTimelineSample 
    ::  QueryTimelineSample
newQueryTimelineSample
  = QueryTimelineSample{activeUnits = Core.Nothing,
                        completedUnits = Core.Nothing, elapsedMs = Core.Nothing,
                        estimatedRunnableUnits = Core.Nothing, pendingUnits = Core.Nothing,
                        shuffleRamUsageRatio = Core.Nothing, totalSlotMs = Core.Nothing}
instance Core.FromJSON QueryTimelineSample where
        parseJSON
          = Core.withObject "QueryTimelineSample"
              (\ o ->
                 QueryTimelineSample Core.<$>
                   (o Core..:? "activeUnits" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "completedUnits" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "elapsedMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "estimatedRunnableUnits" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "pendingUnits" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "shuffleRamUsageRatio")
                     Core.<*>
                     (o Core..:? "totalSlotMs" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.ToJSON QueryTimelineSample where
        toJSON QueryTimelineSample{..}
          = Core.object
              (Core.catMaybes
                 [("activeUnits" Core..=) Core.. Core.AsText Core.<$> activeUnits,
                  ("completedUnits" Core..=) Core.. Core.AsText Core.<$>
                    completedUnits,
                  ("elapsedMs" Core..=) Core.. Core.AsText Core.<$> elapsedMs,
                  ("estimatedRunnableUnits" Core..=) Core.. Core.AsText Core.<$>
                    estimatedRunnableUnits,
                  ("pendingUnits" Core..=) Core.. Core.AsText Core.<$> pendingUnits,
                  ("shuffleRamUsageRatio" Core..=) Core.<$> shuffleRamUsageRatio,
                  ("totalSlotMs" Core..=) Core.. Core.AsText Core.<$> totalSlotMs])
...
newRangePartitioning_Range 
    ::  RangePartitioning_Range
newRangePartitioning_Range
  = RangePartitioning_Range{end = Core.Nothing,
                            interval = Core.Nothing, start = Core.Nothing}
              ...
              (\ o ->
                 RangePartitioning_Range Core.<$>
                   (o Core..:? "end" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "interval" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("end" Core..=) Core.. Core.AsText Core.<$> end,
                  ("interval" Core..=) Core.. Core.AsText Core.<$> interval,
...
newRangeValue 
    ::  RangeValue
newRangeValue
  = RangeValue{end = Core.Nothing, start = Core.Nothing}
...
newRankingMetrics 
    ::  RankingMetrics
newRankingMetrics
  = RankingMetrics{averageRank = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("averageRank" Core..=) Core.<$> averageRank,
                  ...
                  ("normalizedDiscountedCumulativeGain" Core..=) Core.<$>
...
newRegressionMetrics 
    ::  RegressionMetrics
newRegressionMetrics
  = RegressionMetrics{meanAbsoluteError = Core.Nothing,
                      meanSquaredError = Core.Nothing,
                      meanSquaredLogError = Core.Nothing,
                      medianAbsoluteError = Core.Nothing, rSquared = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("meanAbsoluteError" Core..=) Core.<$> meanAbsoluteError,
                  ("meanSquaredError" Core..=) Core.<$> meanSquaredError,
                  ("meanSquaredLogError" Core..=) Core.<$> meanSquaredLogError,
                  ("medianAbsoluteError" Core..=) Core.<$> medianAbsoluteError,
...
newRemoteFunctionOptions 
    ::  RemoteFunctionOptions
newRemoteFunctionOptions
  = RemoteFunctionOptions{connection = Core.Nothing,
                          endpoint = Core.Nothing, maxBatchingRows = Core.Nothing,
          ...
          = Core.withObject "RemoteFunctionOptions"
              (\ o ->
                 RemoteFunctionOptions Core.<$>
                   (o Core..:? "connection") Core.<*> (o Core..:? "endpoint") Core.<*>
                     (o Core..:? "maxBatchingRows" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("connection" Core..=) Core.<$> connection,
                  ...
                  ("maxBatchingRows" Core..=) Core.. Core.AsText Core.<$>
                    maxBatchingRows,
                  ("userDefinedContext" Core..=) Core.<$> userDefinedContext])
...
instance Core.FromJSON RemoteFunctionOptions_UserDefinedContext
         where
        parseJSON
          = Core.withObject "RemoteFunctionOptions_UserDefinedContext"
              (\ o ->
                 RemoteFunctionOptions_UserDefinedContext Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON RemoteFunctionOptions_UserDefinedContext where
...
newRemoteModelInfo 
    ::  RemoteModelInfo
newRemoteModelInfo
  = RemoteModelInfo{connection = Core.Nothing,
                    endpoint = Core.Nothing, maxBatchingRows = Core.Nothing,
                    remoteModelVersion = Core.Nothing,
                    remoteServiceType = Core.Nothing, speechRecognizer = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("connection" Core..=) Core.<$> connection,
                  ...
                  ("maxBatchingRows" Core..=) Core.. Core.AsText Core.<$>
                    maxBatchingRows,
                  ("remoteModelVersion" Core..=) Core.<$> remoteModelVersion,
                  ("remoteServiceType" Core..=) Core.<$> remoteServiceType,
                  ("speechRecognizer" Core..=) Core.<$> speechRecognizer])
...
instance Core.FromJSON RestrictionConfig where
        parseJSON
          = Core.withObject "RestrictionConfig"
              (\ o -> RestrictionConfig Core.<$> (o Core..:? "type"))
...
newRoutine 
    ::  Routine
newRoutine
  = Routine{arguments = Core.Nothing, creationTime = Core.Nothing,
            dataGovernanceType = Core.Nothing, definitionBody = Core.Nothing,
            description = Core.Nothing, determinismLevel = Core.Nothing,
            etag = Core.Nothing, importedLibraries = Core.Nothing,
            language = Core.Nothing, lastModifiedTime = Core.Nothing,
            remoteFunctionOptions = Core.Nothing,
            returnTableType = Core.Nothing, returnType = Core.Nothing,
            routineReference = Core.Nothing, routineType = Core.Nothing,
            securityMode = Core.Nothing, sparkOptions = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("arguments" Core..=) Core.<$> arguments,
                  ("creationTime" Core..=) Core.. Core.AsText Core.<$> creationTime,
                  ("dataGovernanceType" Core..=) Core.<$> dataGovernanceType,
                  ("definitionBody" Core..=) Core.<$> definitionBody,
                  ("description" Core..=) Core.<$> description,
                  ("determinismLevel" Core..=) Core.<$> determinismLevel,
                  ("etag" Core..=) Core.<$> etag,
                  ("importedLibraries" Core..=) Core.<$> importedLibraries,
                  ("language" Core..=) Core.<$> language,
                  ("lastModifiedTime" Core..=) Core.. Core.AsText Core.<$>
                    lastModifiedTime,
                  ("remoteFunctionOptions" Core..=) Core.<$> remoteFunctionOptions,
                  ("returnTableType" Core..=) Core.<$> returnTableType,
                  ("returnType" Core..=) Core.<$> returnType,
                  ("routineReference" Core..=) Core.<$> routineReference,
...
newRoutineReference 
    ::  RoutineReference
newRoutineReference
  = RoutineReference{datasetId = Core.Nothing,
                     projectId = Core.Nothing, routineId = Core.Nothing}
...
instance Core.FromJSON Row where
        parseJSON
          = Core.withObject "Row"
              (\ o ->
                 Row Core.<$>
                   (o Core..:? "actualLabel") Core.<*> (o Core..:? "entries"))
...
newRowAccessPolicy 
    ::  RowAccessPolicy
newRowAccessPolicy
  = RowAccessPolicy{creationTime = Core.Nothing, etag = Core.Nothing,
                    filterPredicate = Core.Nothing, grantees = Core.Nothing,
          ...
          = Core.withObject "RowAccessPolicy"
              (\ o ->
                 RowAccessPolicy Core.<$>
                   (o Core..:? "creationTime") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "filterPredicate")
...
newRowAccessPolicyReference 
    ::  RowAccessPolicyReference
newRowAccessPolicyReference
  = RowAccessPolicyReference{datasetId = Core.Nothing,
                             policyId = Core.Nothing, projectId = Core.Nothing,
          ...
          = Core.withObject "RowAccessPolicyReference"
              (\ o ->
                 RowAccessPolicyReference Core.<$>
                   (o Core..:? "datasetId") Core.<*> (o Core..:? "policyId") Core.<*>
                     (o Core..:? "projectId")
                     Core.<*> (o Core..:? "tableId"))
...
newScriptOptions 
    ::  ScriptOptions
newScriptOptions
  = ScriptOptions{keyResultStatement = Core.Nothing,
...
instance Core.ToJSON ScriptOptions where
        toJSON ScriptOptions{..}
          = Core.object
              (Core.catMaybes
                 [("keyResultStatement" Core..=) Core.<$> keyResultStatement,
                  ("statementByteBudget" Core..=) Core.. Core.AsText Core.<$>
                    statementByteBudget,
                  ("statementTimeoutMs" Core..=) Core.. Core.AsText Core.<$>
                    statementTimeoutMs])
...
newScriptStackFrame 
    ::  ScriptStackFrame
newScriptStackFrame
  = ScriptStackFrame{endColumn = Core.Nothing,
                     endLine = Core.Nothing, procedureId = Core.Nothing,
                     startColumn = Core.Nothing, startLine = Core.Nothing,
                     text = Core.Nothing}
          ...
          = Core.withObject "ScriptStackFrame"
              (\ o ->
                 ScriptStackFrame Core.<$>
                   (o Core..:? "endColumn") Core.<*> (o Core..:? "endLine") Core.<*>
                     (o Core..:? "procedureId")
...
newScriptStatistics 
    ::  ScriptStatistics
newScriptStatistics
  = ScriptStatistics{evaluationKind = Core.Nothing,
          ...
          = Core.withObject "ScriptStatistics"
              (\ o ->
                 ScriptStatistics Core.<$>
                   (o Core..:? "evaluationKind") Core.<*> (o Core..:? "stackFrames"))
...
newSearchStatistics 
    ::  SearchStatistics
newSearchStatistics
  = SearchStatistics{indexUnusedReasons = Core.Nothing,
...
instance Core.FromJSON SerDeInfo_Parameters where
        parseJSON
          = Core.withObject "SerDeInfo_Parameters"
              (\ o -> SerDeInfo_Parameters Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON SerDeInfo_Parameters where
        toJSON SerDeInfo_Parameters{..} = Core.toJSON additional
...
instance Core.FromJSON SessionInfo where
        parseJSON
          = Core.withObject "SessionInfo"
              (\ o -> SessionInfo Core.<$> (o Core..:? "sessionId"))

instance Core.ToJSON SessionInfo where
        toJSON SessionInfo{..}
          = Core.object
              (Core.catMaybes [("sessionId" Core..=) Core.<$> sessionId])
...
instance Core.FromJSON SkewSource where
        parseJSON
          = Core.withObject "SkewSource"
              (\ o ->
                 SkewSource Core.<$>
                   (o Core..:? "stageId" Core.<&> Core.fmap Core.fromAsText))
...
newSnapshotDefinition 
    ::  SnapshotDefinition
newSnapshotDefinition
  = SnapshotDefinition{baseTableReference = Core.Nothing,
...
newSparkLoggingInfo 
    ::  SparkLoggingInfo
newSparkLoggingInfo
  = SparkLoggingInfo{projectId = Core.Nothing,
          ...
          = Core.withObject "SparkLoggingInfo"
              (\ o ->
                 SparkLoggingInfo Core.<$>
                   (o Core..:? "projectId") Core.<*> (o Core..:? "resourceType"))
...
newSparkOptions 
    ::  SparkOptions
newSparkOptions
  = SparkOptions{archiveUris = Core.Nothing,
                 connection = Core.Nothing, containerImage = Core.Nothing,
                 fileUris = Core.Nothing, jarUris = Core.Nothing,
                 mainClass = Core.Nothing, mainFileUri = Core.Nothing,
                 properties = Core.Nothing, pyFileUris = Core.Nothing,
...
instance Core.FromJSON SparkOptions where
        parseJSON
          = Core.withObject "SparkOptions"
              (\ o ->
                 SparkOptions Core.<$>
                   (o Core..:? "archiveUris") Core.<*> (o Core..:? "connection")
...
instance Core.FromJSON SparkOptions_Properties where
        parseJSON
          = Core.withObject "SparkOptions_Properties"
              (\ o -> SparkOptions_Properties Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON SparkOptions_Properties where
        toJSON SparkOptions_Properties{..} = Core.toJSON additional
...
newSparkStatistics 
    ::  SparkStatistics
newSparkStatistics
  = SparkStatistics{endpoints = Core.Nothing,
                    gcsStagingBucket = Core.Nothing, kmsKeyName = Core.Nothing,
                    loggingInfo = Core.Nothing, sparkJobId = Core.Nothing,
          ...
          = Core.withObject "SparkStatistics"
              (\ o ->
                 SparkStatistics Core.<$>
                   (o Core..:? "endpoints") Core.<*> (o Core..:? "gcsStagingBucket")
...
instance Core.FromJSON SparkStatistics_Endpoints where
        parseJSON
          = Core.withObject "SparkStatistics_Endpoints"
              (\ o ->
                 SparkStatistics_Endpoints Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON SparkStatistics_Endpoints where
        toJSON SparkStatistics_Endpoints{..} = Core.toJSON additional
...
newStagePerformanceChangeInsight 
    ::  StagePerformanceChangeInsight
newStagePerformanceChangeInsight
  = StagePerformanceChangeInsight{inputDataChange = Core.Nothing,
                                  stageId = Core.Nothing}
instance Core.FromJSON StagePerformanceChangeInsight where
        parseJSON
...
instance Core.ToJSON StagePerformanceChangeInsight where
        toJSON StagePerformanceChangeInsight{..}
          = Core.object
              (Core.catMaybes
                 [("inputDataChange" Core..=) Core.<$> inputDataChange,
                  ("stageId" Core..=) Core.. Core.AsText Core.<$> stageId])
...
newStagePerformanceStandaloneInsight 
    :: 
                                     StagePerformanceStandaloneInsight
newStagePerformanceStandaloneInsight
  = StagePerformanceStandaloneInsight{biEngineReasons = Core.Nothing,
                                      highCardinalityJoins = Core.Nothing,
                                      insufficientShuffleQuota = Core.Nothing,
                                      partitionSkew = Core.Nothing, slotContention = Core.Nothing,
                                      stageId = Core.Nothing}
instance Core.FromJSON StagePerformanceStandaloneInsight where
        parseJSON
...
instance Core.ToJSON StagePerformanceStandaloneInsight where
        toJSON StagePerformanceStandaloneInsight{..}
          = Core.object
              (Core.catMaybes
                 [("biEngineReasons" Core..=) Core.<$> biEngineReasons,
                  ("highCardinalityJoins" Core..=) Core.<$> highCardinalityJoins,
...
newStandardSqlDataType 
    ::  StandardSqlDataType
newStandardSqlDataType
  = StandardSqlDataType{arrayElementType = Core.Nothing,
                        rangeElementType = Core.Nothing, structType = Core.Nothing,
...
newStorageDescriptor 
    ::  StorageDescriptor
newStorageDescriptor
  = StorageDescriptor{inputFormat = Core.Nothing,
                      locationUri = Core.Nothing, outputFormat = Core.Nothing,
          ...
          = Core.withObject "StorageDescriptor"
              (\ o ->
                 StorageDescriptor Core.<$>
                   (o Core..:? "inputFormat") Core.<*> (o Core..:? "locationUri")
...
newStoredColumnsUnusedReason 
    ::  StoredColumnsUnusedReason
newStoredColumnsUnusedReason
  = StoredColumnsUnusedReason{code = Core.Nothing,
                              message = Core.Nothing, uncoveredColumns = Core.Nothing}
instance Core.FromJSON StoredColumnsUnusedReason where
        parseJSON
          = Core.withObject "StoredColumnsUnusedReason"
              (\ o ->
                 StoredColumnsUnusedReason Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "message") Core.<*>
                     (o Core..:? "uncoveredColumns"))
...
newStoredColumnsUsage 
    ::  StoredColumnsUsage
newStoredColumnsUsage
  = StoredColumnsUsage{baseTable = Core.Nothing,
                       isQueryAccelerated = Core.Nothing,
                       storedColumnsUnusedReasons = Core.Nothing}
instance Core.FromJSON StoredColumnsUsage where
        parseJSON
          = Core.withObject "StoredColumnsUsage"
              (\ o ->
                 StoredColumnsUsage Core.<$>
                   (o Core..:? "baseTable") Core.<*> (o Core..:? "isQueryAccelerated")
          ...
          = Core.object
              (Core.catMaybes
                 [("baseTable" Core..=) Core.<$> baseTable,
                  ...
                  ("storedColumnsUnusedReasons" Core..=) Core.<$>
...
newStreamingbuffer 
    ::  Streamingbuffer
newStreamingbuffer
  = Streamingbuffer{estimatedBytes = Core.Nothing,
                    estimatedRows = Core.Nothing, oldestEntryTime = Core.Nothing}
instance Core.FromJSON Streamingbuffer where
        parseJSON
          = Core.withObject "Streamingbuffer"
              (\ o ->
                 Streamingbuffer Core.<$>
                   (o Core..:? "estimatedBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "estimatedRows" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "oldestEntryTime" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON Streamingbuffer where
        toJSON Streamingbuffer{..}
          = Core.object
              (Core.catMaybes
                 [("estimatedBytes" Core..=) Core.. Core.AsText Core.<$>
                    estimatedBytes,
                  ("estimatedRows" Core..=) Core.. Core.AsText Core.<$>
                    estimatedRows,
                  ("oldestEntryTime" Core..=) Core.. Core.AsText Core.<$>
                    oldestEntryTime])
...
newStringHparamSearchSpace 
    ::  StringHparamSearchSpace
newStringHparamSearchSpace
  = StringHparamSearchSpace{candidates = Core.Nothing}
instance Core.FromJSON StringHparamSearchSpace where
        parseJSON
          = Core.withObject "StringHparamSearchSpace"
              (\ o -> StringHparamSearchSpace Core.<$> (o Core..:? "candidates"))
...
instance Core.FromJSON SystemVariables_Types where
        parseJSON
          = Core.withObject "SystemVariables_Types"
              (\ o -> SystemVariables_Types Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON SystemVariables_Types where
        toJSON SystemVariables_Types{..} = Core.toJSON additional
...
instance Core.FromJSON SystemVariables_Values where
        parseJSON
          = Core.withObject "SystemVariables_Values"
              (\ o -> SystemVariables_Values Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON SystemVariables_Values where
        toJSON SystemVariables_Values{..} = Core.toJSON additional
...
newTable 
    ::  Table
newTable
  = Table{biglakeConfiguration = Core.Nothing,
          cloneDefinition = Core.Nothing, clustering = Core.Nothing,
          creationTime = Core.Nothing, defaultCollation = Core.Nothing,
          defaultRoundingMode = Core.Nothing, description = Core.Nothing,
          encryptionConfiguration = Core.Nothing, etag = Core.Nothing,
          expirationTime = Core.Nothing,
          externalCatalogTableOptions = Core.Nothing,
          externalDataConfiguration = Core.Nothing,
          friendlyName = Core.Nothing, id = Core.Nothing,
          kind = "bigquery#table", labels = Core.Nothing,
          lastModifiedTime = Core.Nothing, location = Core.Nothing,
          managedTableType = Core.Nothing, materializedView = Core.Nothing,
          materializedViewStatus = Core.Nothing, maxStaleness = Core.Nothing,
          model = Core.Nothing, numActiveLogicalBytes = Core.Nothing,
          numActivePhysicalBytes = Core.Nothing, numBytes = Core.Nothing,
          ...
          numPartitions = Core.Nothing, numPhysicalBytes = Core.Nothing,
          numRows = Core.Nothing, numTimeTravelPhysicalBytes = Core.Nothing,
          numTotalLogicalBytes = Core.Nothing,
          numTotalPhysicalBytes = Core.Nothing,
          partitionDefinition = Core.Nothing,
          rangePartitioning = Core.Nothing, replicas = Core.Nothing,
          requirePartitionFilter = Core.Nothing, resourceTags = Core.Nothing,
          restrictions = Core.Nothing, schema = Core.Nothing,
          selfLink = Core.Nothing, snapshotDefinition = Core.Nothing,
          streamingBuffer = Core.Nothing, tableConstraints = Core.Nothing,
          tableReference = Core.Nothing, tableReplicationInfo = Core.Nothing,
          timePartitioning = Core.Nothing, type' = Core.Nothing,
          view = Core.Nothing}
                 ...
                 Table Core.<$>
                   (o Core..:? "biglakeConfiguration") Core.<*>
                     ...
                     (o Core..:? "numActivePhysicalBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "numBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numCurrentPhysicalBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numLongTermBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     ...
                     (o Core..:? "numLongTermPhysicalBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numPartitions" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numPhysicalBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "numRows" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.ToJSON Table where
        toJSON Table{..}
          = Core.object
              (Core.catMaybes
                 [("biglakeConfiguration" Core..=) Core.<$> biglakeConfiguration,
                  ...
                  ("lastModifiedTime" Core..=) Core.. Core.AsText Core.<$>
                    lastModifiedTime,
                  ("location" Core..=) Core.<$> location,
                  ("managedTableType" Core..=) Core.<$> managedTableType,
                  ("materializedView" Core..=) Core.<$> materializedView,
                  ("materializedViewStatus" Core..=) Core.<$> materializedViewStatus,
                  ("maxStaleness" Core..=) Core.<$> maxStaleness,
                  ("model" Core..=) Core.<$> model,
                  ("numActiveLogicalBytes" Core..=) Core.. Core.AsText Core.<$>
                    numActiveLogicalBytes,
                  ("numActivePhysicalBytes" Core..=) Core.. Core.AsText Core.<$>
                    numActivePhysicalBytes,
                  ("numBytes" Core..=) Core.. Core.AsText Core.<$> numBytes,
                  ("numCurrentPhysicalBytes" Core..=) Core.. Core.AsText Core.<$>
                    numCurrentPhysicalBytes,
                  ("numLongTermBytes" Core..=) Core.. Core.AsText Core.<$>
                    numLongTermBytes,
                  ("numLongTermLogicalBytes" Core..=) Core.. Core.AsText Core.<$>
                    numLongTermLogicalBytes,
                  ("numLongTermPhysicalBytes" Core..=) Core.. Core.AsText Core.<$>
                    numLongTermPhysicalBytes,
                  ("numPartitions" Core..=) Core.. Core.AsText Core.<$>
                    numPartitions,
                  ("numPhysicalBytes" Core..=) Core.. Core.AsText Core.<$>
                    numPhysicalBytes,
                  ("numRows" Core..=) Core.. Core.AsText Core.<$> numRows,
                  ("numTimeTravelPhysicalBytes" Core..=) Core.. Core.AsText Core.<$>
                    numTimeTravelPhysicalBytes,
                  ("numTotalLogicalBytes" Core..=) Core.. Core.AsText Core.<$>
                    numTotalLogicalBytes,
                  ("numTotalPhysicalBytes" Core..=) Core.. Core.AsText Core.<$>
                    numTotalPhysicalBytes,
                  ("partitionDefinition" Core..=) Core.<$> partitionDefinition,
                  ("rangePartitioning" Core..=) Core.<$> rangePartitioning,
                  ("replicas" Core..=) Core.<$> replicas,
                  ("requirePartitionFilter" Core..=) Core.<$> requirePartitionFilter,
                  ("resourceTags" Core..=) Core.<$> resourceTags,
                  ("restrictions" Core..=) Core.<$> restrictions,
                  ("schema" Core..=) Core.<$> schema,
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("snapshotDefinition" Core..=) Core.<$> snapshotDefinition,
                  ("streamingBuffer" Core..=) Core.<$> streamingBuffer,
                  ("tableConstraints" Core..=) Core.<$> tableConstraints,
                  ("tableReference" Core..=) Core.<$> tableReference,
                  ("tableReplicationInfo" Core..=) Core.<$> tableReplicationInfo,
                  ("timePartitioning" Core..=) Core.<$> timePartitioning,
                  ("type" Core..=) Core.<$> type', ("view" Core..=) Core.<$> view])
...
instance Core.FromJSON Table_Labels where
        parseJSON
          = Core.withObject "Table_Labels"
              (\ o -> Table_Labels Core.<$> (Core.parseJSONObject o))
...
newTable_ResourceTags 
    :: 
       ...
       -- ^  See 'additional'.
    -> Table_ResourceTags
newTable_ResourceTags additional
  = Table_ResourceTags{additional = additional}
instance Core.FromJSON Table_ResourceTags where
        parseJSON
          = Core.withObject "Table_ResourceTags"
              (\ o -> Table_ResourceTags Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Table_ResourceTags where
        toJSON Table_ResourceTags{..} = Core.toJSON additional
...
instance Core.ToJSON TableCell where
        toJSON TableCell{..}
          = Core.object (Core.catMaybes [("v" Core..=) Core.<$> v])
...
newTableConstraints 
    ::  TableConstraints
newTableConstraints
  = TableConstraints{foreignKeys = Core.Nothing,
                     primaryKey = Core.Nothing}
instance Core.FromJSON TableConstraints where
        parseJSON
          = Core.withObject "TableConstraints"
              (\ o ->
                 TableConstraints Core.<$>
                   (o Core..:? "foreignKeys") Core.<*> (o Core..:? "primaryKey"))
...
newTableConstraints_ForeignKeysItem 
    :: 
                                    TableConstraints_ForeignKeysItem
newTableConstraints_ForeignKeysItem
  = TableConstraints_ForeignKeysItem{columnReferences = Core.Nothing,
                                     name = Core.Nothing, referencedTable = Core.Nothing}
instance Core.FromJSON TableConstraints_ForeignKeysItem where
        parseJSON
          = Core.withObject "TableConstraints_ForeignKeysItem"
              (\ o ->
                 TableConstraints_ForeignKeysItem Core.<$>
                   (o Core..:? "columnReferences") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "referencedTable"))

instance Core.ToJSON TableConstraints_ForeignKeysItem where
        toJSON TableConstraints_ForeignKeysItem{..}
          = Core.object
              (Core.catMaybes
                 [("columnReferences" Core..=) Core.<$> columnReferences,
                  ("name" Core..=) Core.<$> name,
                  ("referencedTable" Core..=) Core.<$> referencedTable])
...
newTableConstraints_ForeignKeysItem_ColumnReferencesItem 
    :: 
                                                         TableConstraints_ForeignKeysItem_ColumnReferencesItem
newTableConstraints_ForeignKeysItem_ColumnReferencesItem
  = TableConstraints_ForeignKeysItem_ColumnReferencesItem{referencedColumn
                                                            = Core.Nothing,
                                                          referencingColumn = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "TableConstraints_ForeignKeysItem_ColumnReferencesItem"
              (\ o ->
                 TableConstraints_ForeignKeysItem_ColumnReferencesItem Core.<$>
...
instance Core.ToJSON
           TableConstraints_ForeignKeysItem_ColumnReferencesItem
         where
        toJSON TableConstraints_ForeignKeysItem_ColumnReferencesItem{..}
          = Core.object
              (Core.catMaybes
                 [("referencedColumn" Core..=) Core.<$> referencedColumn,
                  ("referencingColumn" Core..=) Core.<$> referencingColumn])
...
newTableConstraints_ForeignKeysItem_ReferencedTable 
    :: 
                                                    TableConstraints_ForeignKeysItem_ReferencedTable
newTableConstraints_ForeignKeysItem_ReferencedTable
  = TableConstraints_ForeignKeysItem_ReferencedTable{datasetId =
                                                       Core.Nothing,
                                                     projectId = Core.Nothing,
                                                     tableId = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "TableConstraints_ForeignKeysItem_ReferencedTable"
              (\ o ->
                 TableConstraints_ForeignKeysItem_ReferencedTable Core.<$>
                   (o Core..:? "datasetId") Core.<*> (o Core..:? "projectId") Core.<*>
                     (o Core..:? "tableId"))
...
instance Core.ToJSON
           TableConstraints_ForeignKeysItem_ReferencedTable
         where
        toJSON TableConstraints_ForeignKeysItem_ReferencedTable{..}
          = Core.object
              (Core.catMaybes
                 [("datasetId" Core..=) Core.<$> datasetId,
                  ("projectId" Core..=) Core.<$> projectId,
...
instance Core.FromJSON TableConstraints_PrimaryKey where
        parseJSON
          = Core.withObject "TableConstraints_PrimaryKey"
              (\ o ->
                 TableConstraints_PrimaryKey Core.<$> (o Core..:? "columns"))

instance Core.ToJSON TableConstraints_PrimaryKey where
...
newTableDataInsertAllRequest 
    ::  TableDataInsertAllRequest
newTableDataInsertAllRequest
  = TableDataInsertAllRequest{ignoreUnknownValues = Core.Nothing,
                              kind = "bigquery#tableDataInsertAllRequest", rows = Core.Nothing,
                              skipInvalidRows = Core.Nothing, templateSuffix = Core.Nothing,
              ...
              (\ o ->
                 TableDataInsertAllRequest Core.<$>
                   (o Core..:? "ignoreUnknownValues") Core.<*>
                     (o Core..:? "kind" Core..!= "bigquery#tableDataInsertAllRequest")
                     Core.<*> (o Core..:? "rows")
...
instance Core.ToJSON TableDataInsertAllRequest where
        toJSON TableDataInsertAllRequest{..}
          = Core.object
              (Core.catMaybes
                 [("ignoreUnknownValues" Core..=) Core.<$> ignoreUnknownValues,
                  Core.Just ("kind" Core..= kind), ("rows" Core..=) Core.<$> rows,
...
newTableDataInsertAllRequest_RowsItem 
    :: 
                                      TableDataInsertAllRequest_RowsItem
newTableDataInsertAllRequest_RowsItem
  = TableDataInsertAllRequest_RowsItem{insertId = Core.Nothing,
                                       json = Core.Nothing}
instance Core.FromJSON TableDataInsertAllRequest_RowsItem where
        parseJSON
          = Core.withObject "TableDataInsertAllRequest_RowsItem"
              (\ o ->
                 TableDataInsertAllRequest_RowsItem Core.<$>
                   (o Core..:? "insertId") Core.<*> (o Core..:? "json"))

instance Core.ToJSON TableDataInsertAllRequest_RowsItem where
...
newTableDataInsertAllResponse 
    ::  TableDataInsertAllResponse
newTableDataInsertAllResponse
  = TableDataInsertAllResponse{insertErrors = Core.Nothing,
              ...
              (\ o ->
                 TableDataInsertAllResponse Core.<$>
                   (o Core..:? "insertErrors") Core.<*>
                     (o Core..:? "kind" Core..!= "bigquery#tableDataInsertAllResponse"))
...
newTableDataInsertAllResponse_InsertErrorsItem 
    :: 
                                               TableDataInsertAllResponse_InsertErrorsItem
newTableDataInsertAllResponse_InsertErrorsItem
  = TableDataInsertAllResponse_InsertErrorsItem{errors =
                                                  Core.Nothing,
                                                index = Core.Nothing}
instance Core.FromJSON TableDataInsertAllResponse_InsertErrorsItem
         where
        parseJSON
          = Core.withObject "TableDataInsertAllResponse_InsertErrorsItem"
              (\ o ->
                 TableDataInsertAllResponse_InsertErrorsItem Core.<$>
                   (o Core..:? "errors") Core.<*> (o Core..:? "index"))

instance Core.ToJSON TableDataInsertAllResponse_InsertErrorsItem
         where
...
newTableDataList 
    ::  TableDataList
newTableDataList
  = TableDataList{etag = Core.Nothing,
                  kind = "bigquery#tableDataList", pageToken = Core.Nothing,
                  rows = Core.Nothing, totalRows = Core.Nothing}
...
newTableFieldSchema 
    ::  TableFieldSchema
newTableFieldSchema
  = TableFieldSchema{categories = Core.Nothing,
                     collation = Core.Nothing, dataPolicies = Core.Nothing,
                     defaultValueExpression = Core.Nothing, description = Core.Nothing,
                     fields = Core.Nothing, foreignTypeDefinition = Core.Nothing,
                     maxLength = Core.Nothing, mode = Core.Nothing, name = Core.Nothing,
                     policyTags = Core.Nothing, precision = Core.Nothing,
                     rangeElementType = Core.Nothing, roundingMode = Core.Nothing,
                     scale = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON TableFieldSchema where
        parseJSON
          = Core.withObject "TableFieldSchema"
              (\ o ->
                 TableFieldSchema Core.<$>
                   (o Core..:? "categories") Core.<*> (o Core..:? "collation")
                     ...
                     Core.<*>
                     (o Core..:? "maxLength" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "mode")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "policyTags")
                     Core.<*>
                     (o Core..:? "precision" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "rangeElementType")
                     Core.<*> (o Core..:? "roundingMode")
                     Core.<*> (o Core..:? "scale" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("categories" Core..=) Core.<$> categories,
                  ...
                  ("defaultValueExpression" Core..=) Core.<$> defaultValueExpression,
                  ("description" Core..=) Core.<$> description,
                  ("fields" Core..=) Core.<$> fields,
                  ("foreignTypeDefinition" Core..=) Core.<$> foreignTypeDefinition,
                  ("maxLength" Core..=) Core.. Core.AsText Core.<$> maxLength,
                  ("mode" Core..=) Core.<$> mode, ("name" Core..=) Core.<$> name,
                  ("policyTags" Core..=) Core.<$> policyTags,
                  ("precision" Core..=) Core.. Core.AsText Core.<$> precision,
                  ("rangeElementType" Core..=) Core.<$> rangeElementType,
...
instance Core.FromJSON TableFieldSchema_Categories where
        parseJSON
          = Core.withObject "TableFieldSchema_Categories"
              (\ o -> TableFieldSchema_Categories Core.<$> (o Core..:? "names"))
...
instance Core.FromJSON TableFieldSchema_PolicyTags where
        parseJSON
          = Core.withObject "TableFieldSchema_PolicyTags"
              (\ o -> TableFieldSchema_PolicyTags Core.<$> (o Core..:? "names"))
...
instance Core.FromJSON TableFieldSchema_RangeElementType where
        parseJSON
          = Core.withObject "TableFieldSchema_RangeElementType"
              (\ o ->
                 TableFieldSchema_RangeElementType Core.<$> (o Core..:? "type"))

instance Core.ToJSON TableFieldSchema_RangeElementType where
...
newTableList 
    ::  TableList
newTableList
  = TableList{etag = Core.Nothing, kind = "bigquery#tableList",
              nextPageToken = Core.Nothing, tables = Core.Nothing,
              totalItems = Core.Nothing}
...
newTableList_TablesItem 
    ::  TableList_TablesItem
newTableList_TablesItem
  = TableList_TablesItem{clustering = Core.Nothing,
                         creationTime = Core.Nothing, expirationTime = Core.Nothing,
                         friendlyName = Core.Nothing, id = Core.Nothing,
                         kind = Core.Nothing, labels = Core.Nothing,
                         rangePartitioning = Core.Nothing,
                         requirePartitionFilter = Core.False, tableReference = Core.Nothing,
                         timePartitioning = Core.Nothing, type' = Core.Nothing,
                         view = Core.Nothing}
              ...
              (\ o ->
                 TableList_TablesItem Core.<$>
                   (o Core..:? "clustering") Core.<*>
                     ...
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "rangePartitioning")
                     Core.<*> (o Core..:? "requirePartitionFilter" Core..!= Core.False)
                     Core.<*> (o Core..:? "tableReference")
                     Core.<*> (o Core..:? "timePartitioning")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "view"))
...
instance Core.FromJSON TableList_TablesItem_Labels where
        parseJSON
          = Core.withObject "TableList_TablesItem_Labels"
              (\ o ->
                 TableList_TablesItem_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON TableList_TablesItem_Labels where
        toJSON TableList_TablesItem_Labels{..} = Core.toJSON additional
...
newTableList_TablesItem_View 
    ::  TableList_TablesItem_View
newTableList_TablesItem_View
  = TableList_TablesItem_View{privacyPolicy = Core.Nothing,
          ...
          = Core.withObject "TableList_TablesItem_View"
              (\ o ->
                 TableList_TablesItem_View Core.<$>
                   (o Core..:? "privacyPolicy") Core.<*> (o Core..:? "useLegacySql"))
...
newTableMetadataCacheUsage 
    ::  TableMetadataCacheUsage
newTableMetadataCacheUsage
  = TableMetadataCacheUsage{explanation = Core.Nothing,
                            staleness = Core.Nothing, tableReference = Core.Nothing,
                            tableType = Core.Nothing, unusedReason = Core.Nothing}
instance Core.FromJSON TableMetadataCacheUsage where
        parseJSON
          = Core.withObject "TableMetadataCacheUsage"
              (\ o ->
                 TableMetadataCacheUsage Core.<$>
                   (o Core..:? "explanation") Core.<*> (o Core..:? "staleness")
                     Core.<*> (o Core..:? "tableReference")
...
newTableReference 
    ::  TableReference
newTableReference
  = TableReference{datasetId = Core.Nothing,
...
instance Core.ToJSON TableReplicationInfo where
        toJSON TableReplicationInfo{..}
          = Core.object
              (Core.catMaybes
                 [("replicatedSourceLastRefreshTime" Core..=) Core.. Core.AsText
                    Core.<$> replicatedSourceLastRefreshTime,
                  ("replicationError" Core..=) Core.<$> replicationError,
                  ("replicationIntervalMs" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.ToJSON TableRow where
        toJSON TableRow{..}
          = Core.object (Core.catMaybes [("f" Core..=) Core.<$> f])
...
newTableSchema 
    ::  TableSchema
newTableSchema
  = TableSchema{fields = Core.Nothing,
                foreignTypeInfo = Core.Nothing}
instance Core.FromJSON TableSchema where
        parseJSON
          = Core.withObject "TableSchema"
              (\ o ->
                 TableSchema Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "foreignTypeInfo"))
...
instance Core.ToJSON TableSchema where
        toJSON TableSchema{..}
          = Core.object
              (Core.catMaybes
                 [("fields" Core..=) Core.<$> fields,
                  ("foreignTypeInfo" Core..=) Core.<$> foreignTypeInfo])
...
newTimePartitioning 
    ::  TimePartitioning
newTimePartitioning
  = TimePartitioning{expirationMs = Core.Nothing,
                     field = Core.Nothing, requirePartitionFilter = Core.False,
                     type' = Core.Nothing}
          ...
          = Core.withObject "TimePartitioning"
              (\ o ->
                 TimePartitioning Core.<$>
                   (o Core..:? "expirationMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "field")
                     Core.<*> (o Core..:? "requirePartitionFilter" Core..!= Core.False)
                     Core.<*> (o Core..:? "type"))
...
instance Core.ToJSON TimePartitioning where
        toJSON TimePartitioning{..}
          = Core.object
              (Core.catMaybes
                 [("expirationMs" Core..=) Core.. Core.AsText Core.<$> expirationMs,
                  ("field" Core..=) Core.<$> field,
                  Core.Just
                    ("requirePartitionFilter" Core..= requirePartitionFilter),
                  ("type" Core..=) Core.<$> type'])
...
newTrainingOptions 
    ::  TrainingOptions
newTrainingOptions
  = TrainingOptions{activationFn = Core.Nothing,
                    adjustStepChanges = Core.Nothing,
                    approxGlobalFeatureContrib = Core.Nothing,
                    autoArima = Core.Nothing, autoArimaMaxOrder = Core.Nothing,
                    autoArimaMinOrder = Core.Nothing, autoClassWeights = Core.Nothing,
                    batchSize = Core.Nothing, boosterType = Core.Nothing,
                    budgetHours = Core.Nothing, calculatePValues = Core.Nothing,
                    categoryEncodingMethod = Core.Nothing,
                    cleanSpikesAndDips = Core.Nothing, colorSpace = Core.Nothing,
                    colsampleBylevel = Core.Nothing, colsampleBynode = Core.Nothing,
                    colsampleBytree = Core.Nothing, contributionMetric = Core.Nothing,
                    dartNormalizeType = Core.Nothing, dataFrequency = Core.Nothing,
                    dataSplitColumn = Core.Nothing,
                    dataSplitEvalFraction = Core.Nothing,
                    dataSplitMethod = Core.Nothing, decomposeTimeSeries = Core.Nothing,
                    dimensionIdColumns = Core.Nothing, distanceType = Core.Nothing,
                    dropout = Core.Nothing, earlyStop = Core.Nothing,
                    enableGlobalExplain = Core.Nothing, feedbackType = Core.Nothing,
                    fitIntercept = Core.Nothing,
                    forecastLimitLowerBound = Core.Nothing,
                    forecastLimitUpperBound = Core.Nothing, hiddenUnits = Core.Nothing,
                    holidayRegion = Core.Nothing, holidayRegions = Core.Nothing,
                    horizon = Core.Nothing, hparamTuningObjectives = Core.Nothing,
                    includeDrift = Core.Nothing, initialLearnRate = Core.Nothing,
                    inputLabelColumns = Core.Nothing,
                    instanceWeightColumn = Core.Nothing,
                    integratedGradientsNumSteps = Core.Nothing,
                    isTestColumn = Core.Nothing, itemColumn = Core.Nothing,
                    kmeansInitializationColumn = Core.Nothing,
                    kmeansInitializationMethod = Core.Nothing,
                    l1RegActivation = Core.Nothing, l1Regularization = Core.Nothing,
                    l2Regularization = Core.Nothing, labelClassWeights = Core.Nothing,
                    learnRate = Core.Nothing, learnRateStrategy = Core.Nothing,
                    lossType = Core.Nothing, maxIterations = Core.Nothing,
                    maxParallelTrials = Core.Nothing,
                    maxTimeSeriesLength = Core.Nothing, maxTreeDepth = Core.Nothing,
                    minAprioriSupport = Core.Nothing,
                    minRelativeProgress = Core.Nothing, minSplitLoss = Core.Nothing,
                    minTimeSeriesLength = Core.Nothing,
                    minTreeChildWeight = Core.Nothing, modelRegistry = Core.Nothing,
                    modelUri = Core.Nothing, nonSeasonalOrder = Core.Nothing,
                    numClusters = Core.Nothing, numFactors = Core.Nothing,
                    numParallelTree = Core.Nothing,
                    numPrincipalComponents = Core.Nothing, numTrials = Core.Nothing,
                    optimizationStrategy = Core.Nothing, optimizer = Core.Nothing,
                    pcaExplainedVarianceRatio = Core.Nothing, pcaSolver = Core.Nothing,
                    sampledShapleyNumPaths = Core.Nothing,
                    scaleFeatures = Core.Nothing, standardizeFeatures = Core.Nothing,
                    subsample = Core.Nothing, tfVersion = Core.Nothing,
                    ...
                    treeMethod = Core.Nothing, trendSmoothingWindowSize = Core.Nothing,
                    userColumn = Core.Nothing,
                    vertexAiModelVersionAliases = Core.Nothing,
                    walsAlpha = Core.Nothing, warmStart = Core.Nothing,
              ...
              (\ o ->
                 TrainingOptions Core.<$>
                   (o Core..:? "activationFn") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "autoArimaMaxOrder" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "autoArimaMinOrder" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "autoClassWeights")
                     Core.<*>
                     (o Core..:? "batchSize" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "boosterType")
                     ...
                     Core.<*> (o Core..:? "horizon" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     (o Core..:? "maxIterations" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxParallelTrials" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxTimeSeriesLength" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxTreeDepth" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "nonSeasonalOrder")
                     Core.<*>
                     (o Core..:? "numClusters" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numFactors" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numParallelTree" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numPrincipalComponents" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numTrials" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON TrainingOptions where
        toJSON TrainingOptions{..}
          = Core.object
              (Core.catMaybes
                 [("activationFn" Core..=) Core.<$> activationFn,
                  ("adjustStepChanges" Core..=) Core.<$> adjustStepChanges,
                  ("approxGlobalFeatureContrib" Core..=) Core.<$>
                    approxGlobalFeatureContrib,
                  ("autoArima" Core..=) Core.<$> autoArima,
                  ("autoArimaMaxOrder" Core..=) Core.. Core.AsText Core.<$>
                    autoArimaMaxOrder,
                  ("autoArimaMinOrder" Core..=) Core.. Core.AsText Core.<$>
                    autoArimaMinOrder,
                  ("autoClassWeights" Core..=) Core.<$> autoClassWeights,
                  ("batchSize" Core..=) Core.. Core.AsText Core.<$> batchSize,
                  ("boosterType" Core..=) Core.<$> boosterType,
                  ("budgetHours" Core..=) Core.<$> budgetHours,
                  ("calculatePValues" Core..=) Core.<$> calculatePValues,
                  ("categoryEncodingMethod" Core..=) Core.<$> categoryEncodingMethod,
                  ("cleanSpikesAndDips" Core..=) Core.<$> cleanSpikesAndDips,
                  ("colorSpace" Core..=) Core.<$> colorSpace,
                  ("colsampleBylevel" Core..=) Core.<$> colsampleBylevel,
                  ("colsampleBynode" Core..=) Core.<$> colsampleBynode,
                  ("colsampleBytree" Core..=) Core.<$> colsampleBytree,
                  ("contributionMetric" Core..=) Core.<$> contributionMetric,
                  ("dartNormalizeType" Core..=) Core.<$> dartNormalizeType,
                  ("dataFrequency" Core..=) Core.<$> dataFrequency,
                  ("dataSplitColumn" Core..=) Core.<$> dataSplitColumn,
                  ("dataSplitEvalFraction" Core..=) Core.<$> dataSplitEvalFraction,
                  ("dataSplitMethod" Core..=) Core.<$> dataSplitMethod,
                  ("decomposeTimeSeries" Core..=) Core.<$> decomposeTimeSeries,
                  ...
                  ("forecastLimitLowerBound" Core..=) Core.<$>
                    forecastLimitLowerBound,
                  ("forecastLimitUpperBound" Core..=) Core.<$>
                    forecastLimitUpperBound,
                  ("hiddenUnits" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    hiddenUnits,
                  ("holidayRegion" Core..=) Core.<$> holidayRegion,
                  ("holidayRegions" Core..=) Core.<$> holidayRegions,
                  ("horizon" Core..=) Core.. Core.AsText Core.<$> horizon,
                  ("hparamTuningObjectives" Core..=) Core.<$> hparamTuningObjectives,
                  ("includeDrift" Core..=) Core.<$> includeDrift,
                  ("initialLearnRate" Core..=) Core.<$> initialLearnRate,
                  ("inputLabelColumns" Core..=) Core.<$> inputLabelColumns,
                  ("instanceWeightColumn" Core..=) Core.<$> instanceWeightColumn,
                  ("integratedGradientsNumSteps" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("l1Regularization" Core..=) Core.<$> l1Regularization,
                  ("l2Regularization" Core..=) Core.<$> l2Regularization,
                  ("labelClassWeights" Core..=) Core.<$> labelClassWeights,
                  ("learnRate" Core..=) Core.<$> learnRate,
                  ("learnRateStrategy" Core..=) Core.<$> learnRateStrategy,
                  ("lossType" Core..=) Core.<$> lossType,
                  ("maxIterations" Core..=) Core.. Core.AsText Core.<$>
                    maxIterations,
                  ("maxParallelTrials" Core..=) Core.. Core.AsText Core.<$>
                    maxParallelTrials,
                  ("maxTimeSeriesLength" Core..=) Core.. Core.AsText Core.<$>
                    maxTimeSeriesLength,
                  ("maxTreeDepth" Core..=) Core.. Core.AsText Core.<$> maxTreeDepth,
                  ("minAprioriSupport" Core..=) Core.<$> minAprioriSupport,
                  ("minRelativeProgress" Core..=) Core.<$> minRelativeProgress,
                  ("minSplitLoss" Core..=) Core.<$> minSplitLoss,
                  ("minTimeSeriesLength" Core..=) Core.. Core.AsText Core.<$>
                    minTimeSeriesLength,
                  ("minTreeChildWeight" Core..=) Core.. Core.AsText Core.<$>
                    minTreeChildWeight,
                  ("modelRegistry" Core..=) Core.<$> modelRegistry,
                  ("modelUri" Core..=) Core.<$> modelUri,
                  ("nonSeasonalOrder" Core..=) Core.<$> nonSeasonalOrder,
                  ("numClusters" Core..=) Core.. Core.AsText Core.<$> numClusters,
                  ("numFactors" Core..=) Core.. Core.AsText Core.<$> numFactors,
                  ("numParallelTree" Core..=) Core.. Core.AsText Core.<$>
                    numParallelTree,
                  ("numPrincipalComponents" Core..=) Core.. Core.AsText Core.<$>
                    numPrincipalComponents,
                  ("numTrials" Core..=) Core.. Core.AsText Core.<$> numTrials,
                  ("optimizationStrategy" Core..=) Core.<$> optimizationStrategy,
                  ("optimizer" Core..=) Core.<$> optimizer,
                  ("pcaExplainedVarianceRatio" Core..=) Core.<$>
                    pcaExplainedVarianceRatio,
                  ("pcaSolver" Core..=) Core.<$> pcaSolver,
                  ("sampledShapleyNumPaths" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("timeSeriesDataColumn" Core..=) Core.<$> timeSeriesDataColumn,
                  ("timeSeriesIdColumn" Core..=) Core.<$> timeSeriesIdColumn,
                  ("timeSeriesIdColumns" Core..=) Core.<$> timeSeriesIdColumns,
                  ("timeSeriesLengthFraction" Core..=) Core.<$>
                    timeSeriesLengthFraction,
                  ("timeSeriesTimestampColumn" Core..=) Core.<$>
                    timeSeriesTimestampColumn,
                  ("treeMethod" Core..=) Core.<$> treeMethod,
                  ("trendSmoothingWindowSize" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON TrainingOptions_LabelClassWeights where
        parseJSON
...
instance Core.ToJSON TrainingOptions_LabelClassWeights where
...
newTrainingRun 
    ::  TrainingRun
newTrainingRun
  = TrainingRun{classLevelGlobalExplanations = Core.Nothing,
                dataSplitResult = Core.Nothing, evaluationMetrics = Core.Nothing,
                modelLevelGlobalExplanation = Core.Nothing, results = Core.Nothing,
                startTime = Core.Nothing, trainingOptions = Core.Nothing,
                trainingStartTime = Core.Nothing, vertexAiModelId = Core.Nothing,
              ...
              (\ o ->
                 TrainingRun Core.<$>
                   (o Core..:? "classLevelGlobalExplanations") Core.<*>
                     ...
                     Core.<*> (o Core..:? "trainingOptions")
                     Core.<*>
                     (o Core..:? "trainingStartTime" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("classLevelGlobalExplanations" Core..=) Core.<$>
                  ...
                  ("startTime" Core..=) Core.<$> startTime,
                  ("trainingOptions" Core..=) Core.<$> trainingOptions,
                  ("trainingStartTime" Core..=) Core.. Core.AsText Core.<$>
                    trainingStartTime,
                  ("vertexAiModelId" Core..=) Core.<$> vertexAiModelId,
                  ("vertexAiModelVersion" Core..=) Core.<$> vertexAiModelVersion])
...
instance Core.FromJSON TransactionInfo where
        parseJSON
          = Core.withObject "TransactionInfo"
              (\ o -> TransactionInfo Core.<$> (o Core..:? "transactionId"))
...
newTransformColumn 
    ::  TransformColumn
newTransformColumn
  = TransformColumn{name = Core.Nothing, transformSql = Core.Nothing,
                    type' = Core.Nothing}
          ...
          = Core.withObject "TransformColumn"
              (\ o ->
                 TransformColumn Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "transformSql") Core.<*>
                     (o Core..:? "type"))
...
newUserDefinedFunctionResource 
    ::  UserDefinedFunctionResource
newUserDefinedFunctionResource
  = UserDefinedFunctionResource{inlineCode = Core.Nothing,
          ...
          = Core.withObject "UserDefinedFunctionResource"
              (\ o ->
                 UserDefinedFunctionResource Core.<$>
                   (o Core..:? "inlineCode") Core.<*> (o Core..:? "resourceUri"))
...
newVectorSearchStatistics 
    ::  VectorSearchStatistics
newVectorSearchStatistics
  = VectorSearchStatistics{indexUnusedReasons = Core.Nothing,
                           indexUsageMode = Core.Nothing, storedColumnsUsages = Core.Nothing}
...
newViewDefinition 
    ::  ViewDefinition
newViewDefinition
  = ViewDefinition{foreignDefinitions = Core.Nothing,
                   privacyPolicy = Core.Nothing, query = Core.Nothing,
                   useExplicitColumnNames = Core.Nothing, useLegacySql = Core.Nothing,
                   userDefinedFunctionResources = Core.Nothing}
...
instance Core.ToJSON ViewDefinition where
        toJSON ViewDefinition{..}
          = Core.object
              (Core.catMaybes
                 [("foreignDefinitions" Core..=) Core.<$> foreignDefinitions,
                  ("privacyPolicy" Core..=) Core.<$> privacyPolicy,
                  ("query" Core..=) Core.<$> query,
                  ("useExplicitColumnNames" Core..=) Core.<$> useExplicitColumnNames,
                  ("useLegacySql" Core..=) Core.<$> useLegacySql,
                  ("userDefinedFunctionResources" Core..=) Core.<$>
                    userDefinedFunctionResources])
