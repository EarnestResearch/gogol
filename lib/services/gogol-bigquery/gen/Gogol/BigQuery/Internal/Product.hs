...
newBiEngineStatistics =
  BiEngineStatistics
    {accelerationMode = "", biEngineMode = "", biEngineReasons = Core.Nothing}
          ...
          = Core.withObject "BiEngineStatistics"
              (\ o ->
                 BiEngineStatistics Core.<$>
                   (o Core..:? "accelerationMode" Core..!= "") Core.<*>
                     (o Core..:? "biEngineMode" Core..!= "")
          ...
          = Core.withObject "DataMaskingStatistics"
              (\ o ->
                 DataMaskingStatistics Core.<$>
                   (o Core..:? "dataMaskingApplied" Core..!=
                      Core.False))
          ...
          = Core.withObject "Dataset_AccessItem"
              (\ o ->
                 Dataset_AccessItem Core.<$>
                   (o Core..:? "dataset") Core.<*> (o Core..:? "domain")
          ...
          = Core.withObject "IndexUnusedReason"
              (\ o ->
                 IndexUnusedReason Core.<$>
                   (o Core..:? "base_table") Core.<*>
                     (o Core..:? "code" Core..!= "$(reason.code)")
                     Core.<*>
                     (o Core..:? "index_name" Core..!=
                        "$(reason.index_name)")
                     Core.<*>
                     (o Core..:? "message" Core..!= "$(reason.message)"))
...
newJobStatistics4 =
  JobStatistics4
    {destinationUriFileCounts = Core.Nothing, inputBytes = Core.Nothing}
...
instance Core.FromJSON JobStatistics5 where
        parseJSON
          = Core.withObject "JobStatistics5"
              (\ o ->
                 JobStatistics5 Core.<$>
                   (o Core..:? "copied_logical_bytes" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "copied_rows" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("copied_logical_bytes" Core..=) Core.. Core.AsText
                  ...
                  ("copied_rows" Core..=) Core.. Core.AsText Core.<$>
                    copiedRows])
          ...
          = Core.withObject "MaterializedViewDefinition"
              (\ o ->
                 MaterializedViewDefinition Core.<$>
                   (o Core..:? "allow_non_incremental_definition")
...
newParquetOptions =
  ParquetOptions
    {enableListInference = Core.Nothing, enumAsString = Core.Nothing}
              ...
              (\ o ->
                 ProjectList_ProjectsItem Core.<$>
                   (o Core..:? "friendlyName") Core.<*>
                     (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "bigquery#project")
                     Core.<*>
...
newQueryParameterType =
  QueryParameterType
    {arrayType = Core.Nothing, structTypes = Core.Nothing, type' = Core.Nothing}
...
newSearchStatistics =
  SearchStatistics
    {indexUnusedReason = Core.Nothing, indexUsageMode = Core.Nothing}
          ...
          = Core.withObject "SparkLoggingInfo"
              (\ o ->
                 SparkLoggingInfo Core.<$>
                   (o Core..:? "project_id") Core.<*>
                     (o Core..:? "resource_type"))
                 ...
                 Table Core.<$>
                   (o Core..:? "cloneDefinition") Core.<*>
                     ...
                     (o Core..:? "numRows" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "num_active_logical_bytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "num_active_physical_bytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "num_long_term_logical_bytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "num_long_term_physical_bytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "num_partitions" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "num_time_travel_physical_bytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "num_total_logical_bytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "num_total_physical_bytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "rangePartitioning")
                     Core.<*> (o Core..:? "requirePartitionFilter")
                     Core.<*> (o Core..:? "schema")
              ...
              (Core.catMaybes
                 [("cloneDefinition" Core..=) Core.<$>
                  ...
                  ("numRows" Core..=) Core.. Core.AsText Core.<$>
                    numRows,
                  ("num_active_logical_bytes" Core..=) Core..
                    Core.AsText
                    Core.<$> numActiveLogicalBytes,
                  ("num_active_physical_bytes" Core..=) Core..
                    Core.AsText
                    Core.<$> numActivePhysicalBytes,
                  ("num_long_term_logical_bytes" Core..=) Core..
                    Core.AsText
                    Core.<$> numLongTermLogicalBytes,
                  ("num_long_term_physical_bytes" Core..=) Core..
                    Core.AsText
                    Core.<$> numLongTermPhysicalBytes,
                  ("num_partitions" Core..=) Core.. Core.AsText
                    Core.<$> numPartitions,
                  ("num_time_travel_physical_bytes" Core..=) Core..
                    Core.AsText
                    Core.<$> numTimeTravelPhysicalBytes,
                  ("num_total_logical_bytes" Core..=) Core..
                    Core.AsText
                    Core.<$> numTotalLogicalBytes,
                  ("num_total_physical_bytes" Core..=) Core..
                    Core.AsText
          ...
          = Core.object
              (Core.catMaybes
                 [("adjustStepChanges" Core..=) Core.<$>
                  ...
                  ("preserveInputStructs" Core..=) Core.<$>
