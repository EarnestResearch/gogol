               ...
               Core.Capture "datasetId" Core.Text Core.:>
                 "tables" Core.:>
                   Core.Capture "tableId" Core.Text Core.:>
                     "rowAccessPolicies:batchDelete" Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] BatchDeleteRowAccessPoliciesRequest
...
newBigQueryRowAccessPoliciesBatchDelete 
    ...
    -> BigQueryRowAccessPoliciesBatchDelete
newBigQueryRowAccessPoliciesBatchDelete datasetId payload projectId
  tableId
  = BigQueryRowAccessPoliciesBatchDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         datasetId = datasetId, payload = payload,
                                         projectId = projectId, tableId = tableId,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BigQueryRowAccessPoliciesBatchDelete
         where
        type Rs BigQueryRowAccessPoliciesBatchDelete = ()
        type Scopes BigQueryRowAccessPoliciesBatchDelete =
             '[Bigquery'FullControl, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient BigQueryRowAccessPoliciesBatchDelete{..}
          = go projectId datasetId tableId xgafv accessToken callback
              uploadType
              uploadProtocol
