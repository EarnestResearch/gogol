                 ...
                 "tables" Core.:>
                   Core.Capture "tableId" Core.Text Core.:>
                     "rowAccessPolicies" Core.:>
                       Core.Capture "policyId" Core.Text Core.:>
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] RowAccessPolicy Core.:>
                                       Core.Put '[Core.JSON] RowAccessPolicy
...
newBigQueryRowAccessPoliciesUpdate 
    ...
    -> BigQueryRowAccessPoliciesUpdate
newBigQueryRowAccessPoliciesUpdate datasetId payload policyId
  projectId tableId
  = BigQueryRowAccessPoliciesUpdate{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    datasetId = datasetId, payload = payload, policyId = policyId,
...
instance Core.GoogleRequest BigQueryRowAccessPoliciesUpdate where
        ...
        type Scopes BigQueryRowAccessPoliciesUpdate =
             '[Bigquery'FullControl, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient BigQueryRowAccessPoliciesUpdate{..}
          = go projectId datasetId tableId policyId xgafv accessToken
              callback
              uploadType
              uploadProtocol
