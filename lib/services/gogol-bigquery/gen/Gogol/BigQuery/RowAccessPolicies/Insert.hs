                               ...
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] RowAccessPolicy Core.:>
                                     Core.Post '[Core.JSON] RowAccessPolicy
...
newBigQueryRowAccessPoliciesInsert 
    ...
    -> BigQueryRowAccessPoliciesInsert
newBigQueryRowAccessPoliciesInsert datasetId payload projectId
  tableId
  = BigQueryRowAccessPoliciesInsert{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    datasetId = datasetId, payload = payload, projectId = projectId,
                                    tableId = tableId, uploadType = Core.Nothing,
...
instance Core.GoogleRequest BigQueryRowAccessPoliciesInsert where
        ...
        type Scopes BigQueryRowAccessPoliciesInsert =
