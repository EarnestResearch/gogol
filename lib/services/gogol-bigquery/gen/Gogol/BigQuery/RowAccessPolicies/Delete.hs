...
newBigQueryRowAccessPoliciesDelete 
    ...
    -> BigQueryRowAccessPoliciesDelete
newBigQueryRowAccessPoliciesDelete datasetId policyId projectId
  tableId
  = BigQueryRowAccessPoliciesDelete{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    datasetId = datasetId, force = Core.Nothing,
                                    policyId = policyId, projectId = projectId, tableId = tableId,
...
instance Core.GoogleRequest BigQueryRowAccessPoliciesDelete where
        ...
        type Scopes BigQueryRowAccessPoliciesDelete =
