                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "formatOptions.useInt64Timestamp" Core.Bool Core.:>
                         Core.QueryParam "location" Core.Text Core.:>
                           Core.QueryParam "maxResults" Core.Word32 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "startIndex" Core.Word64 Core.:>
                                 Core.QueryParam "timeoutMs" Core.Word32 Core.:>
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] GetQueryResultsResponse
...
newBigQueryJobsGetQueryResults jobId projectId
  = BigQueryJobsGetQueryResults{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                formatOptionsUseInt64Timestamp = Core.Nothing, jobId = jobId,
                                location = Core.Nothing, maxResults = Core.Nothing,
                                pageToken = Core.Nothing, projectId = projectId,
                                startIndex = Core.Nothing, timeoutMs = Core.Nothing,
...
instance Core.GoogleRequest BigQueryJobsGetQueryResults where
        ...
        type Scopes BigQueryJobsGetQueryResults =
