...
newApplicationInfo =
  ApplicationInfo
    {emails = Core.Nothing, instruction = Core.Nothing, uris = Core.Nothing}
...
instance Core.FromJSON BatchCreateJobsRequest where
        parseJSON
          = Core.withObject "BatchCreateJobsRequest"
              (\ o ->
...
instance Core.FromJSON BatchCreateJobsResponse where
        parseJSON
          = Core.withObject "BatchCreateJobsResponse"
              (\ o ->
                 BatchCreateJobsResponse Core.<$>
                   (o Core..:? "jobResults"))
...
instance Core.FromJSON BatchDeleteJobsRequest where
        parseJSON
          = Core.withObject "BatchDeleteJobsRequest"
              (\ o ->
...
instance Core.FromJSON BatchDeleteJobsResponse where
        parseJSON
          = Core.withObject "BatchDeleteJobsResponse"
              (\ o ->
                 BatchDeleteJobsResponse Core.<$>
                   (o Core..:? "jobResults"))
...
instance Core.FromJSON BatchUpdateJobsRequest where
        parseJSON
          = Core.withObject "BatchUpdateJobsRequest"
              (\ o ->
                 BatchUpdateJobsRequest Core.<$>
                   (o Core..:? "jobs") Core.<*>
                     (o Core..:? "updateMask"))
...
instance Core.FromJSON BatchUpdateJobsResponse where
        parseJSON
          = Core.withObject "BatchUpdateJobsResponse"
              (\ o ->
                 BatchUpdateJobsResponse Core.<$>
                   (o Core..:? "jobResults"))
...
data CommuteFilter = CommuteFilter
    ...
    , travelDuration :: (Core.Maybe Core.Duration)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
instance Core.FromJSON CommuteFilter where
        parseJSON
          = Core.withObject "CommuteFilter"
              (\ o ->
                 CommuteFilter Core.<$>
                   (o Core..:? "allowImpreciseAddresses") Core.<*>
                     (o Core..:? "commuteMethod")
...
instance Core.FromJSON CommuteInfo where
        parseJSON
          = Core.withObject "CommuteInfo"
              (\ o ->
                 CommuteInfo Core.<$>
                   (o Core..:? "jobLocation") Core.<*>
                     (o Core..:? "travelDuration"))
...
data Company = Company
    ...
    , imageUri :: (Core.Maybe Core.Text)
      -- | This field is deprecated. Please set the searchability of the custom attribute in the Job.custom/attributes going forward. A list of keys of filterable Job.custom/attributes, whose corresponding @string_values@ are used in keyword searches. Jobs with @string_values@ under these specified field keys are returned if any of the values match the search keyword. Custom field values with parenthesis, brackets and special symbols are not searchable as-is, and those keyword queries must be surrounded by quotes.
...
instance Core.FromJSON Company where
        parseJSON
          = Core.withObject "Company"
              (\ o ->
                 Company Core.<$>
                   (o Core..:? "careerSiteUri") Core.<*>
                     (o Core..:? "derivedInfo")
                     ...
                     Core.<*>
                     (o Core..:? "keywordSearchableJobCustomAttributes")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "size")
...
instance Core.FromJSON CompanyDerivedInfo where
        parseJSON
          = Core.withObject "CompanyDerivedInfo"
              (\ o ->
                 CompanyDerivedInfo Core.<$>
                   (o Core..:? "headquartersLocation"))

instance Core.ToJSON CompanyDerivedInfo where
        toJSON CompanyDerivedInfo{..}
          = Core.object
              (Core.catMaybes
                 [("headquartersLocation" Core..=) Core.<$>
...
instance Core.FromJSON CompensationEntry where
        parseJSON
          = Core.withObject "CompensationEntry"
              (\ o ->
                 CompensationEntry Core.<$>
                   (o Core..:? "amount") Core.<*>
                     (o Core..:? "description")
          ...
          = Core.object
              (Core.catMaybes
                 [("amount" Core..=) Core.<$> amount,
                  ...
                  ("expectedUnitsPerYear" Core..=) Core.<$>
...
instance Core.FromJSON CompensationFilter where
        parseJSON
          = Core.withObject "CompensationFilter"
              (\ o ->
...
instance Core.FromJSON CompensationInfo where
        parseJSON
          = Core.withObject "CompensationInfo"
              (\ o ->
                 CompensationInfo Core.<$>
                   (o Core..:? "annualizedBaseCompensationRange")
                     Core.<*>
                     (o Core..:? "annualizedTotalCompensationRange")
                     Core.<*> (o Core..:? "entries"))
...
instance Core.ToJSON CompensationInfo where
        toJSON CompensationInfo{..}
          = Core.object
              (Core.catMaybes
                 [("annualizedBaseCompensationRange" Core..=) Core.<$>
                    annualizedBaseCompensationRange,
                  ("annualizedTotalCompensationRange" Core..=) Core.<$>
...
newCompensationRange =
  CompensationRange
    {maxCompensation = Core.Nothing, minCompensation = Core.Nothing}

instance Core.FromJSON CompensationRange where
        parseJSON
          = Core.withObject "CompensationRange"
              (\ o ->
                 CompensationRange Core.<$>
                   (o Core..:? "maxCompensation") Core.<*>
                     (o Core..:? "minCompensation"))

instance Core.ToJSON CompensationRange where
        toJSON CompensationRange{..}
          = Core.object
              (Core.catMaybes
                 [("maxCompensation" Core..=) Core.<$>
                    maxCompensation,
                  ("minCompensation" Core..=) Core.<$>
                    minCompensation])
...
newCompleteQueryResponse =
  CompleteQueryResponse
    {completionResults = Core.Nothing, metadata = Core.Nothing}

instance Core.FromJSON CompleteQueryResponse where
        parseJSON
          = Core.withObject "CompleteQueryResponse"
              (\ o ->
                 CompleteQueryResponse Core.<$>
                   (o Core..:? "completionResults") Core.<*>
                     (o Core..:? "metadata"))
...
newCompletionResult =
  CompletionResult
    {imageUri = Core.Nothing, suggestion = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON CompletionResult where
        parseJSON
          = Core.withObject "CompletionResult"
              (\ o ->
                 CompletionResult Core.<$>
                   (o Core..:? "imageUri") Core.<*>
                     (o Core..:? "suggestion")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON CustomAttribute where
        parseJSON
          = Core.withObject "CustomAttribute"
              (\ o ->
                 CustomAttribute Core.<$>
                   (o Core..:? "filterable") Core.<*>
                     (o Core..:? "keywordSearchable")
                     Core.<*>
                     (o Core..:? "longValues" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("filterable" Core..=) Core.<$> filterable,
                  ("keywordSearchable" Core..=) Core.<$>
                    keywordSearchable,
                  ("longValues" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> longValues,
...
newCustomRankingInfo =
  CustomRankingInfo
    {importanceLevel = Core.Nothing, rankingExpression = Core.Nothing}

instance Core.FromJSON CustomRankingInfo where
        parseJSON
          = Core.withObject "CustomRankingInfo"
              (\ o ->
                 CustomRankingInfo Core.<$>
                   (o Core..:? "importanceLevel") Core.<*>
                     (o Core..:? "rankingExpression"))

instance Core.ToJSON CustomRankingInfo where
        toJSON CustomRankingInfo{..}
          = Core.object
              (Core.catMaybes
                 [("importanceLevel" Core..=) Core.<$>
                    importanceLevel,
                  ("rankingExpression" Core..=) Core.<$>
                    rankingExpression])
...
instance Core.FromJSON DeviceInfo where
        parseJSON
          = Core.withObject "DeviceInfo"
              (\ o ->
                 DeviceInfo Core.<$>
                   (o Core..:? "deviceType") Core.<*> (o Core..:? "id"))
...
instance Core.FromJSON HistogramQuery where
        parseJSON
          = Core.withObject "HistogramQuery"
              (\ o ->
                 HistogramQuery Core.<$>
                   (o Core..:? "histogramQuery"))
...
instance Core.FromJSON HistogramQueryResult where
        parseJSON
          = Core.withObject "HistogramQueryResult"
              (\ o ->
                 HistogramQueryResult Core.<$>
                   (o Core..:? "histogram") Core.<*>
                     (o Core..:? "histogramQuery"))
...
newHistogramQueryResult_Histogram 
    ::  Core.HashMap Core.Text Core.Int64
       -- ^  See 'additional'.
    -> HistogramQueryResult_Histogram
newHistogramQueryResult_Histogram additional =
  HistogramQueryResult_Histogram {additional = additional}

instance Core.FromJSON HistogramQueryResult_Histogram
         where
        parseJSON
          = Core.withObject "HistogramQueryResult_Histogram"
              (\ o ->
                 HistogramQueryResult_Histogram Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON HistogramQueryResult_Histogram
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("addresses" Core..=) Core.<$> addresses,
                  ...
                  ("companyDisplayName" Core..=) Core.<$>
                    companyDisplayName,
                  ("compensationInfo" Core..=) Core.<$>
                    compensationInfo,
                  ("customAttributes" Core..=) Core.<$>
                    customAttributes,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("postingCreateTime" Core..=) Core.<$>
                    postingCreateTime,
                  ("postingExpireTime" Core..=) Core.<$>
                    postingExpireTime,
                  ("postingPublishTime" Core..=) Core.<$>
                    postingPublishTime,
                  ("postingRegion" Core..=) Core.<$> postingRegion,
                  ("postingUpdateTime" Core..=) Core.<$>
                    postingUpdateTime,
                  ("processingOptions" Core..=) Core.<$>
                    processingOptions,
                  ("promotionValue" Core..=) Core.<$> promotionValue,
                  ("qualifications" Core..=) Core.<$> qualifications,
                  ("requisitionId" Core..=) Core.<$> requisitionId,
                  ("responsibilities" Core..=) Core.<$>
                    responsibilities,
...
newtype Job_CustomAttributes = Job_CustomAttributes
    {
      -- | 
      additional :: (Core.HashMap Core.Text CustomAttribute)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newJob_CustomAttributes 
    ::  Core.HashMap Core.Text CustomAttribute
       -- ^  See 'additional'.
    -> Job_CustomAttributes
newJob_CustomAttributes additional =
  Job_CustomAttributes {additional = additional}

instance Core.FromJSON Job_CustomAttributes where
        parseJSON
          = Core.withObject "Job_CustomAttributes"
              (\ o ->
                 Job_CustomAttributes Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON JobDerivedInfo where
        parseJSON
          = Core.withObject "JobDerivedInfo"
              (\ o ->
                 JobDerivedInfo Core.<$>
                   (o Core..:? "jobCategories") Core.<*>
                     (o Core..:? "locations"))
...
instance Core.FromJSON JobEvent where
        parseJSON
          = Core.withObject "JobEvent"
              (\ o ->
                 JobEvent Core.<$>
                   (o Core..:? "jobs") Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON JobQuery where
        parseJSON
          = Core.withObject "JobQuery"
              (\ o ->
                 JobQuery Core.<$>
                   (o Core..:? "commuteFilter") Core.<*>
                     (o Core..:? "companies")
          ...
          = Core.object
              (Core.catMaybes
                 [("commuteFilter" Core..=) Core.<$> commuteFilter,
                  ...
                  ("companyDisplayNames" Core..=) Core.<$>
                    companyDisplayNames,
                  ("compensationFilter" Core..=) Core.<$>
                    compensationFilter,
                  ("customAttributeFilter" Core..=) Core.<$>
                    customAttributeFilter,
                  ("disableSpellCheck" Core..=) Core.<$>
                    disableSpellCheck,
                  ("employmentTypes" Core..=) Core.<$> employmentTypes,
                  ...
                  ("publishTimeRange" Core..=) Core.<$>
                    publishTimeRange,
                  ("query" Core..=) Core.<$> query,
                  ("queryLanguageCode" Core..=) Core.<$>
                    queryLanguageCode])
...
instance Core.FromJSON JobResult where
        parseJSON
          = Core.withObject "JobResult"
              (\ o ->
                 JobResult Core.<$>
                   (o Core..:? "job") Core.<*> (o Core..:? "status"))
...
instance Core.FromJSON ListCompaniesResponse where
        parseJSON
          = Core.withObject "ListCompaniesResponse"
              (\ o ->
                 ListCompaniesResponse Core.<$>
                   (o Core..:? "companies") Core.<*>
                     (o Core..:? "metadata")
...
newListJobsResponse =
  ListJobsResponse
    {jobs = Core.Nothing, metadata = Core.Nothing, nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListJobsResponse"
              (\ o ->
                 ListJobsResponse Core.<$>
                   (o Core..:? "jobs") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListTenantsResponse where
        parseJSON
          = Core.withObject "ListTenantsResponse"
              (\ o ->
                 ListTenantsResponse Core.<$>
...
instance Core.FromJSON LocationFilter where
        parseJSON
          = Core.withObject "LocationFilter"
              (\ o ->
                 LocationFilter Core.<$>
                   (o Core..:? "address") Core.<*>
                     (o Core..:? "distanceInMiles")
                     Core.<*> (o Core..:? "latLng")
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ...
                  ("telecommutePreference" Core..=) Core.<$>
...
instance Core.FromJSON MatchingJob where
        parseJSON
          = Core.withObject "MatchingJob"
              (\ o ->
                 MatchingJob Core.<$>
                   (o Core..:? "commuteInfo") Core.<*>
                     (o Core..:? "job")
...
instance Core.FromJSON MendelDebugInput where
        parseJSON
          = Core.withObject "MendelDebugInput"
              (\ o ->
                 MendelDebugInput Core.<$>
                   (o Core..:? "namespacedDebugInput"))

instance Core.ToJSON MendelDebugInput where
        toJSON MendelDebugInput{..}
          = Core.object
              (Core.catMaybes
                 [("namespacedDebugInput" Core..=) Core.<$>
                    namespacedDebugInput])
...
newtype MendelDebugInput_NamespacedDebugInput = MendelDebugInput_NamespacedDebugInput
    {
      -- | 
      additional :: (Core.HashMap Core.Text NamespacedDebugInput)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newMendelDebugInput_NamespacedDebugInput 
    ::  Core.HashMap Core.Text NamespacedDebugInput
       -- ^  See 'additional'.
    -> MendelDebugInput_NamespacedDebugInput
newMendelDebugInput_NamespacedDebugInput additional =
  MendelDebugInput_NamespacedDebugInput {additional = additional}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "MendelDebugInput_NamespacedDebugInput"
              (\ o ->
                 MendelDebugInput_NamespacedDebugInput Core.<$>
                   (Core.parseJSONObject o))
...
data NamespacedDebugInput = NamespacedDebugInput
    ...
    , testingMode :: (Core.Maybe NamespacedDebugInput_TestingMode)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newNamespacedDebugInput =
  NamespacedDebugInput
    ...
    , testingMode = Core.Nothing
    }

instance Core.FromJSON NamespacedDebugInput where
        parseJSON
          = Core.withObject "NamespacedDebugInput"
              (\ o ->
                 NamespacedDebugInput Core.<$>
                   (o Core..:? "absolutelyForcedExpNames") Core.<*>
                     (o Core..:? "absolutelyForcedExpTags")
...
newNamespacedDebugInput_ForcedFlags 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> NamespacedDebugInput_ForcedFlags
newNamespacedDebugInput_ForcedFlags additional =
  NamespacedDebugInput_ForcedFlags {additional = additional}

instance Core.FromJSON
           NamespacedDebugInput_ForcedFlags
         where
        parseJSON
          = Core.withObject "NamespacedDebugInput_ForcedFlags"
              (\ o ->
                 NamespacedDebugInput_ForcedFlags Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON NamespacedDebugInput_ForcedFlags
         where
...
newtype NamespacedDebugInput_ForcedRollouts = NamespacedDebugInput_ForcedRollouts
    {
      -- | 
      additional :: (Core.HashMap Core.Text Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newNamespacedDebugInput_ForcedRollouts 
    ::  Core.HashMap Core.Text Core.Bool
       -- ^  See 'additional'.
    -> NamespacedDebugInput_ForcedRollouts
newNamespacedDebugInput_ForcedRollouts additional =
  NamespacedDebugInput_ForcedRollouts {additional = additional}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "NamespacedDebugInput_ForcedRollouts"
              (\ o ->
                 NamespacedDebugInput_ForcedRollouts Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON ProcessingOptions where
        parseJSON
          = Core.withObject "ProcessingOptions"
              (\ o ->
                 ProcessingOptions Core.<$>
                   (o Core..:? "disableStreetAddressResolution")
...
instance Core.ToJSON ProcessingOptions where
        toJSON ProcessingOptions{..}
          = Core.object
              (Core.catMaybes
                 [("disableStreetAddressResolution" Core..=) Core.<$>
                    disableStreetAddressResolution,
                  ("htmlSanitization" Core..=) Core.<$>
                    htmlSanitization])
...
data SearchJobsRequest = SearchJobsRequest
    ...
    , enableBroadening :: (Core.Maybe Core.Bool)
      ...
      -- function creates a bucket with range of start, end). Note that the end is exclusive, for example, bucket(1, MAX, \"positive number\") or bucket(1, 10). Job histogram facets: * company/display/name: histogram by [Job.company/display/name. * employment/type: histogram by Job.employment/types, for example, \"FULL/TIME\", \"PART/TIME\". * company/size (DEPRECATED): histogram by CompanySize, for example, \"SMALL\", \"MEDIUM\", \"BIG\". * publish/time/in/day: histogram by the Job.posting/publish/time in days. Must specify list of numeric buckets in spec. * publish/time/in/month: histogram by the Job.posting/publish/time in months. Must specify list of numeric buckets in spec. * publish/time/in/year: histogram by the Job.posting/publish/time in years. Must specify list of numeric buckets in spec. * degree/types: histogram by the Job.degree/types, for example, \"Bachelors\", \"Masters\". * job/level: histogram by the Job.job/level, for example, \"Entry Level\". * country: histogram by the country code of jobs, for
      -- example, \"US\", \"FR\". * admin1: histogram by the admin1 code of jobs, which is a global placeholder referring to the state, province, or the particular term a country uses to define the geographic structure below the country level, for example, \"CA\", \"IL\". * city: histogram by a combination of the \"city name, admin1 code\". For example, \"Mountain View, CA\", \"New York, NY\". * admin1/country: histogram by a combination of the \"admin1 code, country\", for example, \"CA, US\", \"IL, US\". * city/coordinate: histogram by the city center\'s GPS coordinates (latitude and longitude), for example, 37.4038522,-122.0987765. Since the coordinates of a city center can change, customers may need to refresh them periodically. * locale: histogram by the Job.language/code, for example, \"en-US\", \"fr-FR\". * language: histogram by the language subtag of the Job.language/code, for example, \"en\", \"fr\". * category: histogram by the JobCategory, for example, \"COMPUTER/AND/IT\", \"HEALTHCARE\". *
...
instance Core.FromJSON SearchJobsRequest where
        parseJSON
          = Core.withObject "SearchJobsRequest"
              (\ o ->
                 SearchJobsRequest Core.<$>
                   (o Core..:? "customRankingInfo") Core.<*>
                     (o Core..:? "disableKeywordMatch")
...
instance Core.ToJSON SearchJobsRequest where
        toJSON SearchJobsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("customRankingInfo" Core..=) Core.<$>
                    customRankingInfo,
                  ("disableKeywordMatch" Core..=) Core.<$>
                    disableKeywordMatch,
                  ("diversificationLevel" Core..=) Core.<$>
                    diversificationLevel,
                  ("enableBroadening" Core..=) Core.<$>
                    enableBroadening,
                  ("histogramQueries" Core..=) Core.<$>
                    histogramQueries,
                  ("jobQuery" Core..=) Core.<$> jobQuery,
                  ("jobView" Core..=) Core.<$> jobView,
                  ("keywordMatchMode" Core..=) Core.<$>
                    keywordMatchMode,
...
instance Core.FromJSON SearchJobsResponse where
        parseJSON
          = Core.withObject "SearchJobsResponse"
              (\ o ->
                 SearchJobsResponse Core.<$>
                   (o Core..:? "broadenedQueryJobsCount") Core.<*>
                     (o Core..:? "histogramQueryResults")
                     Core.<*> (o Core..:? "locationFilters")
...
instance Core.ToJSON SearchJobsResponse where
        toJSON SearchJobsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("broadenedQueryJobsCount" Core..=) Core.<$>
                    broadenedQueryJobsCount,
                  ("histogramQueryResults" Core..=) Core.<$>
...
instance Core.FromJSON SpellingCorrection where
        parseJSON
          = Core.withObject "SpellingCorrection"
              (\ o ->
                 SpellingCorrection Core.<$>
                   (o Core..:? "corrected") Core.<*>
                     (o Core..:? "correctedHtml")
...
instance Core.FromJSON Tenant where
        parseJSON
          = Core.withObject "Tenant"
              (\ o ->
                 Tenant Core.<$>
                   (o Core..:? "externalId") Core.<*>
                     (o Core..:? "name"))
...
instance Core.FromJSON TimestampRange where
        parseJSON
          = Core.withObject "TimestampRange"
              (\ o ->
                 TimestampRange Core.<$>
                   (o Core..:? "endTime") Core.<*>
                     (o Core..:? "startTime"))
