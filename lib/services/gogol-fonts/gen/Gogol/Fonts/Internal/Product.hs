...
newAxis 
    ::  Axis
newAxis
  = Axis{end = Core.Nothing, start = Core.Nothing,
         tag = Core.Nothing}
instance Core.FromJSON Axis where
        parseJSON
          = Core.withObject "Axis"
              (\ o ->
                 Axis Core.<$>
                   (o Core..:? "end") Core.<*> (o Core..:? "start") Core.<*>
                     (o Core..:? "tag"))
...
newWebfont 
    ::  Webfont
newWebfont
  = Webfont{axes = Core.Nothing, category = Core.Nothing,
            colorCapabilities = Core.Nothing, family = Core.Nothing,
            files = Core.Nothing, kind = Core.Nothing,
            lastModified = Core.Nothing, menu = Core.Nothing,
            subsets = Core.Nothing, variants = Core.Nothing,
            version = Core.Nothing}
instance Core.FromJSON Webfont where
        parseJSON
          = Core.withObject "Webfont"
              (\ o ->
                 Webfont Core.<$>
                   (o Core..:? "axes") Core.<*> (o Core..:? "category") Core.<*>
                     (o Core..:? "colorCapabilities")
                     Core.<*> (o Core..:? "family")
                     Core.<*> (o Core..:? "files")
                     Core.<*> (o Core..:? "kind")
          ...
          = Core.object
              (Core.catMaybes
                 [("axes" Core..=) Core.<$> axes,
                  ...
                  ("files" Core..=) Core.<$> files, ("kind" Core..=) Core.<$> kind,
