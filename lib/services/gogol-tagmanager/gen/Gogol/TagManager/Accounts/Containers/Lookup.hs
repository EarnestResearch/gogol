...
type TagManagerAccountsContainersLookupResource =
     "tagmanager" Core.:>
       "v2" Core.:>
         "accounts" Core.:>
           "containers:lookup" Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "destinationId" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] Container
...
instance Core.GoogleRequest
           TagManagerAccountsContainersLookup
         where
        type Rs TagManagerAccountsContainersLookup =
             Container
        type Scopes TagManagerAccountsContainersLookup =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersLookup{..}
          = go xgafv accessToken callback destinationId
              uploadType
              uploadProtocol
