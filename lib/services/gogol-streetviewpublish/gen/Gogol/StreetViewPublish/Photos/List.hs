...
data StreetViewPublishPhotosList = StreetViewPublishPhotosList
    ...
    , callback :: (Core.Maybe Core.Text)
      -- | Optional. The filter expression. For example: @placeId=ChIJj61dQgK6j4AR4GeTYWZsKWw@. The filters supported are: @placeId@, @min_latitude@, @max_latitude@, @min_longitude@, @max_longitude@, \'min/capture/time/seconds\', and \'max/capture/time/seconds\'. See https:\/\/google.aip.dev\/160 for more information.
