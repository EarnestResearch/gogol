...
instance Core.FromJSON AcknowledgeRequest where
        parseJSON
          = Core.withObject "AcknowledgeRequest"
              (\ o ->
...
newtype AvroConfig = AvroConfig
    {
      -- | When true, write the subscription name, message/id, publish/time, attributes, and ordering_key as additional fields in the output.
...
newAvroConfig 
    ::  AvroConfig
newAvroConfig = AvroConfig {writeMetadata = Core.Nothing}

instance Core.FromJSON AvroConfig where
        parseJSON
          = Core.withObject "AvroConfig"
              (\ o ->
                 AvroConfig Core.<$> (o Core..:? "writeMetadata"))
...
instance Core.FromJSON BigQueryConfig where
        parseJSON
          = Core.withObject "BigQueryConfig"
              (\ o ->
                 BigQueryConfig Core.<$>
                   (o Core..:? "dropUnknownFields") Core.<*>
                     (o Core..:? "state")
                     Core.<*> (o Core..:? "table")
...
data CloudStorageConfig = CloudStorageConfig
    ...
    , bucket :: (Core.Maybe Core.Text)
      -- | User-provided prefix for Cloud Storage filename. See the <https://cloud.google.com/storage/docs/objects#naming object naming requirements>.
    , filenamePrefix :: (Core.Maybe Core.Text)
      -- | User-provided suffix for Cloud Storage filename. See the <https://cloud.google.com/storage/docs/objects#naming object naming requirements>.
...
instance Core.FromJSON CloudStorageConfig where
        parseJSON
          = Core.withObject "CloudStorageConfig"
              (\ o ->
                 CloudStorageConfig Core.<$>
                   (o Core..:? "avroConfig") Core.<*>
                     (o Core..:? "bucket")
...
instance Core.FromJSON CommitSchemaRequest where
        parseJSON
          = Core.withObject "CommitSchemaRequest"
              (\ o ->
...
instance Core.FromJSON CreateSnapshotRequest where
        parseJSON
          = Core.withObject "CreateSnapshotRequest"
              (\ o ->
                 CreateSnapshotRequest Core.<$>
                   (o Core..:? "labels") Core.<*>
                     (o Core..:? "subscription"))
...
instance Core.FromJSON CreateSnapshotRequest_Labels
         where
        parseJSON
          = Core.withObject "CreateSnapshotRequest_Labels"
              (\ o ->
                 CreateSnapshotRequest_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON CreateSnapshotRequest_Labels
         where
...
newDeadLetterPolicy =
  DeadLetterPolicy
    {deadLetterTopic = Core.Nothing, maxDeliveryAttempts = Core.Nothing}

instance Core.FromJSON DeadLetterPolicy where
        parseJSON
          = Core.withObject "DeadLetterPolicy"
              (\ o ->
                 DeadLetterPolicy Core.<$>
                   (o Core..:? "deadLetterTopic") Core.<*>
                     (o Core..:? "maxDeliveryAttempts"))

instance Core.ToJSON DeadLetterPolicy where
        toJSON DeadLetterPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("deadLetterTopic" Core..=) Core.<$>
                    deadLetterTopic,
                  ("maxDeliveryAttempts" Core..=) Core.<$>
                    maxDeliveryAttempts])
...
instance Core.FromJSON DetachSubscriptionResponse
         where
        parseJSON
          = Core.withObject "DetachSubscriptionResponse"
...
instance Core.FromJSON ExpirationPolicy where
        parseJSON
          = Core.withObject "ExpirationPolicy"
...
newListSchemaRevisionsResponse =
  ListSchemaRevisionsResponse
    {nextPageToken = Core.Nothing, schemas = Core.Nothing}

instance Core.FromJSON ListSchemaRevisionsResponse
         where
        parseJSON
          = Core.withObject "ListSchemaRevisionsResponse"
              (\ o ->
                 ListSchemaRevisionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "schemas"))

instance Core.ToJSON ListSchemaRevisionsResponse
         where
...
instance Core.FromJSON ListSchemasResponse where
        parseJSON
          = Core.withObject "ListSchemasResponse"
              (\ o ->
...
newListTopicSnapshotsResponse =
  ListTopicSnapshotsResponse
    {nextPageToken = Core.Nothing, snapshots = Core.Nothing}

instance Core.FromJSON ListTopicSnapshotsResponse
         where
        parseJSON
          = Core.withObject "ListTopicSnapshotsResponse"
              (\ o ->
                 ListTopicSnapshotsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "snapshots"))
...
instance Core.FromJSON ListTopicSubscriptionsResponse
         where
        parseJSON
          = Core.withObject "ListTopicSubscriptionsResponse"
              (\ o ->
                 ListTopicSubscriptionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "subscriptions"))

instance Core.ToJSON ListTopicSubscriptionsResponse
         where
...
instance Core.FromJSON ListTopicsResponse where
        parseJSON
          = Core.withObject "ListTopicsResponse"
              (\ o ->
...
instance Core.FromJSON MessageStoragePolicy where
        parseJSON
          = Core.withObject "MessageStoragePolicy"
              (\ o ->
                 MessageStoragePolicy Core.<$>
                   (o Core..:? "allowedPersistenceRegions"))

instance Core.ToJSON MessageStoragePolicy where
        toJSON MessageStoragePolicy{..}
          = Core.object
              (Core.catMaybes
                 [("allowedPersistenceRegions" Core..=) Core.<$>
...
newModifyAckDeadlineRequest =
  ModifyAckDeadlineRequest
    {ackDeadlineSeconds = Core.Nothing, ackIds = Core.Nothing}

instance Core.FromJSON ModifyAckDeadlineRequest where
        parseJSON
          = Core.withObject "ModifyAckDeadlineRequest"
              (\ o ->
                 ModifyAckDeadlineRequest Core.<$>
                   (o Core..:? "ackDeadlineSeconds") Core.<*>
                     (o Core..:? "ackIds"))
...
instance Core.FromJSON ModifyPushConfigRequest where
        parseJSON
          = Core.withObject "ModifyPushConfigRequest"
              (\ o ->
                 ModifyPushConfigRequest Core.<$>
                   (o Core..:? "pushConfig"))
...
data OidcToken = OidcToken
    {
      ...
      -- | <https://cloud.google.com/iam/docs/service-accounts Service account email> used for generating the OIDC token. For more information on setting up authentication, see <https://cloud.google.com/pubsub/docs/push Push subscriptions>.
...
instance Core.FromJSON PublishRequest where
        parseJSON
          = Core.withObject "PublishRequest"
              (\ o ->
...
instance Core.FromJSON PublishResponse where
        parseJSON
          = Core.withObject "PublishResponse"
              (\ o ->
...
instance Core.FromJSON PullRequest where
        parseJSON
          = Core.withObject "PullRequest"
              (\ o ->
                 PullRequest Core.<$>
                   (o Core..:? "maxMessages") Core.<*>
                     (o Core..:? "returnImmediately"))
...
instance Core.FromJSON PullResponse where
        parseJSON
          = Core.withObject "PullResponse"
              (\ o ->
                 PullResponse Core.<$>
                   (o Core..:? "receivedMessages"))

instance Core.ToJSON PullResponse where
        toJSON PullResponse{..}
          = Core.object
              (Core.catMaybes
                 [("receivedMessages" Core..=) Core.<$>
                    receivedMessages])
...
instance Core.FromJSON PushConfig_Attributes where
        parseJSON
          = Core.withObject "PushConfig_Attributes"
              (\ o ->
                 PushConfig_Attributes Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON ReceivedMessage where
        parseJSON
          = Core.withObject "ReceivedMessage"
              (\ o ->
                 ReceivedMessage Core.<$>
                   (o Core..:? "ackId") Core.<*>
                     (o Core..:? "deliveryAttempt")
                     Core.<*> (o Core..:? "message"))
...
instance Core.FromJSON RetryPolicy where
        parseJSON
          = Core.withObject "RetryPolicy"
              (\ o ->
                 RetryPolicy Core.<$>
                   (o Core..:? "maximumBackoff") Core.<*>
                     (o Core..:? "minimumBackoff"))
...
instance Core.FromJSON RollbackSchemaRequest where
        parseJSON
          = Core.withObject "RollbackSchemaRequest"
              (\ o ->
                 RollbackSchemaRequest Core.<$>
                   (o Core..:? "revisionId"))
...
instance Core.FromJSON SchemaSettings where
        parseJSON
          = Core.withObject "SchemaSettings"
              (\ o ->
                 SchemaSettings Core.<$>
                   (o Core..:? "encoding") Core.<*>
                     (o Core..:? "firstRevisionId")
...
instance Core.FromJSON SeekRequest where
        parseJSON
          = Core.withObject "SeekRequest"
              (\ o ->
                 SeekRequest Core.<$>
                   (o Core..:? "snapshot") Core.<*> (o Core..:? "time"))
              ...
              (\ o ->
                 Subscription Core.<$>
                   (o Core..:? "ackDeadlineSeconds") Core.<*>
                     ...
                     Core.<*> (o Core..:? "topic")
                     Core.<*>
                     (o Core..:? "topicMessageRetentionDuration"))
          ...
          = Core.object
              (Core.catMaybes
                 [("ackDeadlineSeconds" Core..=) Core.<$>
                  ...
                  ("cloudStorageConfig" Core..=) Core.<$>
                    cloudStorageConfig,
                  ("deadLetterPolicy" Core..=) Core.<$>
                    deadLetterPolicy,
                  ("detached" Core..=) Core.<$> detached,
                  ("enableExactlyOnceDelivery" Core..=) Core.<$>
                    enableExactlyOnceDelivery,
                  ("enableMessageOrdering" Core..=) Core.<$>
                    enableMessageOrdering,
                  ("expirationPolicy" Core..=) Core.<$>
                    expirationPolicy,
                  ("filter" Core..=) Core.<$> filter,
                  ("labels" Core..=) Core.<$> labels,
                  ("messageRetentionDuration" Core..=) Core.<$>
                    messageRetentionDuration,
                  ("name" Core..=) Core.<$> name,
                  ("pushConfig" Core..=) Core.<$> pushConfig,
                  ("retainAckedMessages" Core..=) Core.<$>
                    retainAckedMessages,
                  ("retryPolicy" Core..=) Core.<$> retryPolicy,
                  ("state" Core..=) Core.<$> state,
                  ("topic" Core..=) Core.<$> topic,
                  ("topicMessageRetentionDuration" Core..=) Core.<$>
...
instance Core.FromJSON Subscription_Labels where
        parseJSON
          = Core.withObject "Subscription_Labels"
              (\ o ->
                 Subscription_Labels Core.<$>
                   (Core.parseJSONObject o))
          ...
          = Core.object
              (Core.catMaybes
                 [("kmsKeyName" Core..=) Core.<$> kmsKeyName,
                  ...
                  ("messageRetentionDuration" Core..=) Core.<$>
                    messageRetentionDuration,
                  ("messageStoragePolicy" Core..=) Core.<$>
                    messageStoragePolicy,
                  ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON UpdateSnapshotRequest where
        parseJSON
          = Core.withObject "UpdateSnapshotRequest"
              (\ o ->
                 UpdateSnapshotRequest Core.<$>
                   (o Core..:? "snapshot") Core.<*>
                     (o Core..:? "updateMask"))
...
instance Core.FromJSON UpdateSubscriptionRequest
         where
        parseJSON
...
instance Core.FromJSON UpdateTopicRequest where
        parseJSON
          = Core.withObject "UpdateTopicRequest"
              (\ o ->
                 UpdateTopicRequest Core.<$>
                   (o Core..:? "topic") Core.<*>
                     (o Core..:? "updateMask"))
...
instance Core.FromJSON ValidateMessageRequest where
        parseJSON
          = Core.withObject "ValidateMessageRequest"
              (\ o ->
                 ValidateMessageRequest Core.<$>
                   (o Core..:? "encoding") Core.<*>
                     (o Core..:? "message")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "schema"))
...
instance Core.FromJSON ValidateMessageResponse where
        parseJSON
          = Core.withObject "ValidateMessageResponse"
...
instance Core.FromJSON ValidateSchemaRequest where
        parseJSON
          = Core.withObject "ValidateSchemaRequest"
              (\ o ->
...
instance Core.FromJSON ValidateSchemaResponse where
        parseJSON
          = Core.withObject "ValidateSchemaResponse"
