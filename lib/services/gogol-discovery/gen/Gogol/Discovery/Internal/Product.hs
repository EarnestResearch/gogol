...
instance Core.FromJSON DirectoryList where
        parseJSON
          = Core.withObject "DirectoryList"
              (\ o ->
                 DirectoryList Core.<$>
                   (o Core..:? "discoveryVersion" Core..!= "v1")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON DirectoryList_ItemsItem where
        parseJSON
          = Core.withObject "DirectoryList_ItemsItem"
              (\ o ->
                 DirectoryList_ItemsItem Core.<$>
                   (o Core..:? "description") Core.<*>
                     (o Core..:? "discoveryLink")
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ...
                  ("discoveryRestUrl" Core..=) Core.<$>
                    discoveryRestUrl,
                  ("documentationLink" Core..=) Core.<$>
                    documentationLink,
...
instance Core.FromJSON DirectoryList_ItemsItem_Icons
         where
        parseJSON
          = Core.withObject "DirectoryList_ItemsItem_Icons"
              (\ o ->
                 DirectoryList_ItemsItem_Icons Core.<$>
                   (o Core..:? "x16") Core.<*> (o Core..:? "x32"))

instance Core.ToJSON DirectoryList_ItemsItem_Icons
         where
...
instance Core.FromJSON JsonSchema where
        parseJSON
          = Core.withObject "JsonSchema"
              (\ o ->
                 JsonSchema Core.<$>
                   (o Core..:? "$ref") Core.<*>
                     (o Core..:? "additionalProperties")
...
instance Core.FromJSON JsonSchema_Annotations where
        parseJSON
          = Core.withObject "JsonSchema_Annotations"
              (\ o ->
                 JsonSchema_Annotations Core.<$>
                   (o Core..:? "required"))
...
instance Core.FromJSON JsonSchema_Properties where
        parseJSON
          = Core.withObject "JsonSchema_Properties"
              (\ o ->
                 JsonSchema_Properties Core.<$>
...
instance Core.FromJSON JsonSchema_Variant where
        parseJSON
          = Core.withObject "JsonSchema_Variant"
              (\ o ->
                 JsonSchema_Variant Core.<$>
                   (o Core..:? "discriminant") Core.<*>
                     (o Core..:? "map"))
...
instance Core.FromJSON JsonSchema_Variant_MapItem
         where
        parseJSON
          = Core.withObject "JsonSchema_Variant_MapItem"
              (\ o ->
                 JsonSchema_Variant_MapItem Core.<$>
                   (o Core..:? "$ref") Core.<*>
                     (o Core..:? "type_value"))
...
instance Core.FromJSON RestDescription where
        parseJSON
          = Core.withObject "RestDescription"
              (\ o ->
                 RestDescription Core.<$>
                   (o Core..:? "auth") Core.<*> (o Core..:? "basePath")
                     Core.<*> (o Core..:? "baseUrl")
              ...
              (Core.catMaybes
                 [("auth" Core..=) Core.<$> auth,
                  ...
                  ("documentationLink" Core..=) Core.<$>
                    documentationLink,
                  ("etag" Core..=) Core.<$> etag,
                  ("exponentialBackoffDefault" Core..=) Core.<$>
...
instance Core.FromJSON RestDescription_Auth where
        parseJSON
          = Core.withObject "RestDescription_Auth"
              (\ o ->
...
instance Core.FromJSON RestDescription_Auth_Oauth2
         where
        parseJSON
          = Core.withObject "RestDescription_Auth_Oauth2"
              (\ o ->
                 RestDescription_Auth_Oauth2 Core.<$>
                   (o Core..:? "scopes"))

instance Core.ToJSON RestDescription_Auth_Oauth2
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RestDescription_Auth_Oauth2_Scopes"
              (\ o ->
                 RestDescription_Auth_Oauth2_Scopes Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RestDescription_Auth_Oauth2_ScopesAdditional"
              (\ o ->
                 RestDescription_Auth_Oauth2_ScopesAdditional Core.<$>
                   (o Core..:? "description"))
...
instance Core.FromJSON RestDescription_Icons where
        parseJSON
          = Core.withObject "RestDescription_Icons"
              (\ o ->
                 RestDescription_Icons Core.<$>
                   (o Core..:? "x16") Core.<*> (o Core..:? "x32"))
...
instance Core.FromJSON RestDescription_Methods where
        parseJSON
          = Core.withObject "RestDescription_Methods"
              (\ o ->
                 RestDescription_Methods Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON RestDescription_Parameters
         where
        parseJSON
          = Core.withObject "RestDescription_Parameters"
              (\ o ->
                 RestDescription_Parameters Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON RestDescription_Resources
         where
        parseJSON
          = Core.withObject "RestDescription_Resources"
              (\ o ->
                 RestDescription_Resources Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON RestDescription_Schemas where
        parseJSON
          = Core.withObject "RestDescription_Schemas"
              (\ o ->
                 RestDescription_Schemas Core.<$>
                   (Core.parseJSONObject o))
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ...
                  ("supportsMediaDownload" Core..=) Core.<$>
                    supportsMediaDownload,
                  ("supportsMediaUpload" Core..=) Core.<$>
                    supportsMediaUpload,
                  ("supportsSubscription" Core..=) Core.<$>
                    supportsSubscription,
                  ("useMediaDownloadService" Core..=) Core.<$>
...
newRestMethod_MediaUpload =
  RestMethod_MediaUpload
    {accept = Core.Nothing, maxSize = Core.Nothing, protocols = Core.Nothing}

instance Core.FromJSON RestMethod_MediaUpload where
        parseJSON
          = Core.withObject "RestMethod_MediaUpload"
              (\ o ->
                 RestMethod_MediaUpload Core.<$>
                   (o Core..:? "accept") Core.<*> (o Core..:? "maxSize")
...
newRestMethod_MediaUpload_Protocols =
  RestMethod_MediaUpload_Protocols
    {resumable = Core.Nothing, simple = Core.Nothing}

instance Core.FromJSON
           RestMethod_MediaUpload_Protocols
         where
        parseJSON
          = Core.withObject "RestMethod_MediaUpload_Protocols"
              (\ o ->
                 RestMethod_MediaUpload_Protocols Core.<$>
                   (o Core..:? "resumable") Core.<*>
                     (o Core..:? "simple"))

instance Core.ToJSON RestMethod_MediaUpload_Protocols
         where
...
newRestMethod_MediaUpload_Protocols_Resumable =
  RestMethod_MediaUpload_Protocols_Resumable
    {multipart = Core.True, path = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RestMethod_MediaUpload_Protocols_Resumable"
              (\ o ->
                 RestMethod_MediaUpload_Protocols_Resumable Core.<$>
                   (o Core..:? "multipart" Core..!= Core.True) Core.<*>
                     (o Core..:? "path"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RestMethod_MediaUpload_Protocols_Simple"
              (\ o ->
                 RestMethod_MediaUpload_Protocols_Simple Core.<$>
                   (o Core..:? "multipart" Core..!= Core.True) Core.<*>
                     (o Core..:? "path"))
...
instance Core.FromJSON RestMethod_Parameters where
        parseJSON
          = Core.withObject "RestMethod_Parameters"
              (\ o ->
                 RestMethod_Parameters Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON RestMethod_Request where
        parseJSON
          = Core.withObject "RestMethod_Request"
              (\ o ->
                 RestMethod_Request Core.<$>
                   (o Core..:? "$ref") Core.<*>
                     (o Core..:? "parameterName"))
...
instance Core.FromJSON RestMethod_Response where
        parseJSON
          = Core.withObject "RestMethod_Response"
              (\ o ->
...
instance Core.FromJSON RestResource_Methods where
        parseJSON
          = Core.withObject "RestResource_Methods"
              (\ o ->
                 RestResource_Methods Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON RestResource_Resources where
        parseJSON
          = Core.withObject "RestResource_Resources"
              (\ o ->
                 RestResource_Resources Core.<$>
                   (Core.parseJSONObject o))
