...
--
-- /See:/ <https://developers.google.com/workspace/docs/ Google Docs API Reference>
module Gogol.Docs
    (
    -- * Configuration
      docsService
...
import Gogol.Docs.Documents.BatchUpdate
import Gogol.Docs.Documents.Create
import Gogol.Docs.Documents.Get
