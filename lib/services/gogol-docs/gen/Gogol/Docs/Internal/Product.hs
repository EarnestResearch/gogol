...
newAutoText 
    ::  AutoText
newAutoText
  = AutoText{suggestedDeletionIds = Core.Nothing,
             suggestedInsertionIds = Core.Nothing,
             suggestedTextStyleChanges = Core.Nothing, textStyle = Core.Nothing,
             type' = Core.Nothing}
instance Core.FromJSON AutoText where
        parseJSON
          = Core.withObject "AutoText"
              (\ o ->
                 AutoText Core.<$>
                   (o Core..:? "suggestedDeletionIds") Core.<*>
                     (o Core..:? "suggestedInsertionIds")
          ...
          = Core.object
              (Core.catMaybes
                 [("suggestedDeletionIds" Core..=) Core.<$> suggestedDeletionIds,
                  ...
                  ("suggestedTextStyleChanges" Core..=) Core.<$>
...
instance Core.FromJSON AutoText_SuggestedTextStyleChanges where
        parseJSON
          = Core.withObject "AutoText_SuggestedTextStyleChanges"
              (\ o ->
                 AutoText_SuggestedTextStyleChanges Core.<$>
...
newBatchUpdateDocumentRequest 
    ::  BatchUpdateDocumentRequest
newBatchUpdateDocumentRequest
  = BatchUpdateDocumentRequest{requests = Core.Nothing,
                               writeControl = Core.Nothing}
instance Core.FromJSON BatchUpdateDocumentRequest where
        parseJSON
          = Core.withObject "BatchUpdateDocumentRequest"
              (\ o ->
                 BatchUpdateDocumentRequest Core.<$>
                   (o Core..:? "requests") Core.<*> (o Core..:? "writeControl"))
...
newBatchUpdateDocumentResponse 
    ::  BatchUpdateDocumentResponse
newBatchUpdateDocumentResponse
  = BatchUpdateDocumentResponse{documentId = Core.Nothing,
                                replies = Core.Nothing, writeControl = Core.Nothing}
instance Core.FromJSON BatchUpdateDocumentResponse where
        parseJSON
          = Core.withObject "BatchUpdateDocumentResponse"
              (\ o ->
                 BatchUpdateDocumentResponse Core.<$>
                   (o Core..:? "documentId") Core.<*> (o Core..:? "replies") Core.<*>
                     (o Core..:? "writeControl"))
...
instance Core.FromJSON BookmarkLink where
        parseJSON
          = Core.withObject "BookmarkLink"
              (\ o ->
                 BookmarkLink Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "tabId"))
...
newBullet 
    ::  Bullet
newBullet
  = Bullet{listId = Core.Nothing, nestingLevel = Core.Nothing,
           textStyle = Core.Nothing}
instance Core.FromJSON Bullet where
        parseJSON
          = Core.withObject "Bullet"
              (\ o ->
                 Bullet Core.<$>
                   (o Core..:? "listId") Core.<*> (o Core..:? "nestingLevel") Core.<*>
                     (o Core..:? "textStyle"))
...
newBulletSuggestionState 
    ::  BulletSuggestionState
newBulletSuggestionState
  = BulletSuggestionState{listIdSuggested = Core.Nothing,
...
instance Core.FromJSON BulletSuggestionState where
        parseJSON
          = Core.withObject "BulletSuggestionState"
              (\ o ->
                 BulletSuggestionState Core.<$>
                   (o Core..:? "listIdSuggested") Core.<*>
                     (o Core..:? "nestingLevelSuggested")
          ...
          = Core.object
              (Core.catMaybes
                 [("listIdSuggested" Core..=) Core.<$> listIdSuggested,
                  ...
                  ("textStyleSuggestionState" Core..=) Core.<$>
                    textStyleSuggestionState])
...
newColumnBreak 
    ::  ColumnBreak
newColumnBreak
  = ColumnBreak{suggestedDeletionIds = Core.Nothing,
                suggestedInsertionIds = Core.Nothing,
                suggestedTextStyleChanges = Core.Nothing, textStyle = Core.Nothing}
instance Core.FromJSON ColumnBreak where
        parseJSON
          = Core.withObject "ColumnBreak"
              (\ o ->
                 ColumnBreak Core.<$>
                   (o Core..:? "suggestedDeletionIds") Core.<*>
                     (o Core..:? "suggestedInsertionIds")
...
instance Core.FromJSON ColumnBreak_SuggestedTextStyleChanges where
        parseJSON
          = Core.withObject "ColumnBreak_SuggestedTextStyleChanges"
              (\ o ->
                 ColumnBreak_SuggestedTextStyleChanges Core.<$>
                   (Core.parseJSONObject o))
...
newCreateFooterRequest 
    ::  CreateFooterRequest
newCreateFooterRequest
  = CreateFooterRequest{sectionBreakLocation = Core.Nothing,
                        type' = Core.Nothing}
instance Core.FromJSON CreateFooterRequest where
        parseJSON
          = Core.withObject "CreateFooterRequest"
              (\ o ->
                 CreateFooterRequest Core.<$>
                   (o Core..:? "sectionBreakLocation") Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON CreateFooterResponse where
        parseJSON
          = Core.withObject "CreateFooterResponse"
...
newCreateFootnoteRequest 
    ::  CreateFootnoteRequest
newCreateFootnoteRequest
  = CreateFootnoteRequest{endOfSegmentLocation = Core.Nothing,
                          location = Core.Nothing}
instance Core.FromJSON CreateFootnoteRequest where
        parseJSON
          = Core.withObject "CreateFootnoteRequest"
              (\ o ->
                 CreateFootnoteRequest Core.<$>
                   (o Core..:? "endOfSegmentLocation") Core.<*>
                     (o Core..:? "location"))
...
instance Core.FromJSON CreateFootnoteResponse where
        parseJSON
          = Core.withObject "CreateFootnoteResponse"
...
newCreateHeaderRequest 
    ::  CreateHeaderRequest
newCreateHeaderRequest
  = CreateHeaderRequest{sectionBreakLocation = Core.Nothing,
                        type' = Core.Nothing}
instance Core.FromJSON CreateHeaderRequest where
        parseJSON
          = Core.withObject "CreateHeaderRequest"
              (\ o ->
                 CreateHeaderRequest Core.<$>
                   (o Core..:? "sectionBreakLocation") Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON CreateHeaderResponse where
        parseJSON
          = Core.withObject "CreateHeaderResponse"
...
newCreateNamedRangeRequest 
    ::  CreateNamedRangeRequest
newCreateNamedRangeRequest
  = CreateNamedRangeRequest{name = Core.Nothing,
                            range = Core.Nothing}
instance Core.FromJSON CreateNamedRangeRequest where
        parseJSON
          = Core.withObject "CreateNamedRangeRequest"
              (\ o ->
                 CreateNamedRangeRequest Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "range"))
...
instance Core.FromJSON CreateNamedRangeResponse where
        parseJSON
          = Core.withObject "CreateNamedRangeResponse"
              (\ o ->
...
newCreateParagraphBulletsRequest 
    ::  CreateParagraphBulletsRequest
newCreateParagraphBulletsRequest
  = CreateParagraphBulletsRequest{bulletPreset = Core.Nothing,
                                  range = Core.Nothing}
instance Core.FromJSON CreateParagraphBulletsRequest where
        parseJSON
          = Core.withObject "CreateParagraphBulletsRequest"
              (\ o ->
                 CreateParagraphBulletsRequest Core.<$>
                   (o Core..:? "bulletPreset") Core.<*> (o Core..:? "range"))
...
newCropProperties 
    ::  CropProperties
newCropProperties
  = CropProperties{angle = Core.Nothing, offsetBottom = Core.Nothing,
                   offsetLeft = Core.Nothing, offsetRight = Core.Nothing,
                   offsetTop = Core.Nothing}
instance Core.FromJSON CropProperties where
        parseJSON
          = Core.withObject "CropProperties"
              (\ o ->
                 CropProperties Core.<$>
                   (o Core..:? "angle") Core.<*> (o Core..:? "offsetBottom") Core.<*>
                     (o Core..:? "offsetLeft")
...
newCropPropertiesSuggestionState 
    ::  CropPropertiesSuggestionState
newCropPropertiesSuggestionState
  = CropPropertiesSuggestionState{angleSuggested = Core.Nothing,
...
instance Core.FromJSON CropPropertiesSuggestionState where
        parseJSON
          = Core.withObject "CropPropertiesSuggestionState"
              (\ o ->
                 CropPropertiesSuggestionState Core.<$>
                   (o Core..:? "angleSuggested") Core.<*>
                     (o Core..:? "offsetBottomSuggested")
...
instance Core.FromJSON DeleteContentRangeRequest where
        parseJSON
          = Core.withObject "DeleteContentRangeRequest"
...
newDeleteFooterRequest 
    ::  DeleteFooterRequest
newDeleteFooterRequest
  = DeleteFooterRequest{footerId = Core.Nothing,
                        tabId = Core.Nothing}
instance Core.FromJSON DeleteFooterRequest where
        parseJSON
          = Core.withObject "DeleteFooterRequest"
              (\ o ->
                 DeleteFooterRequest Core.<$>
                   (o Core..:? "footerId") Core.<*> (o Core..:? "tabId"))
...
newDeleteHeaderRequest 
    ::  DeleteHeaderRequest
newDeleteHeaderRequest
  = DeleteHeaderRequest{headerId = Core.Nothing,
                        tabId = Core.Nothing}
instance Core.FromJSON DeleteHeaderRequest where
        parseJSON
          = Core.withObject "DeleteHeaderRequest"
              (\ o ->
                 DeleteHeaderRequest Core.<$>
                   (o Core..:? "headerId") Core.<*> (o Core..:? "tabId"))
...
newDeleteNamedRangeRequest 
    ::  DeleteNamedRangeRequest
newDeleteNamedRangeRequest
  = DeleteNamedRangeRequest{name = Core.Nothing,
                            namedRangeId = Core.Nothing, tabsCriteria = Core.Nothing}
instance Core.FromJSON DeleteNamedRangeRequest where
        parseJSON
          = Core.withObject "DeleteNamedRangeRequest"
              (\ o ->
                 DeleteNamedRangeRequest Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "namedRangeId") Core.<*>
                     (o Core..:? "tabsCriteria"))
...
instance Core.FromJSON DeleteParagraphBulletsRequest where
        parseJSON
          = Core.withObject "DeleteParagraphBulletsRequest"
              (\ o ->
...
newDeletePositionedObjectRequest 
    ::  DeletePositionedObjectRequest
newDeletePositionedObjectRequest
  = DeletePositionedObjectRequest{objectId = Core.Nothing,
                                  tabId = Core.Nothing}
instance Core.FromJSON DeletePositionedObjectRequest where
        parseJSON
          = Core.withObject "DeletePositionedObjectRequest"
              (\ o ->
                 DeletePositionedObjectRequest Core.<$>
                   (o Core..:? "objectId") Core.<*> (o Core..:? "tabId"))
...
instance Core.FromJSON DeleteTableColumnRequest where
        parseJSON
          = Core.withObject "DeleteTableColumnRequest"
              (\ o ->
...
instance Core.FromJSON DeleteTableRowRequest where
        parseJSON
          = Core.withObject "DeleteTableRowRequest"
              (\ o ->
...
instance Core.FromJSON Dimension where
        parseJSON
          = Core.withObject "Dimension"
              (\ o ->
                 Dimension Core.<$>
                   (o Core..:? "magnitude") Core.<*> (o Core..:? "unit"))
...
newDocument 
    ::  Document
newDocument
  = Document{body = Core.Nothing, documentId = Core.Nothing,
             documentStyle = Core.Nothing, footers = Core.Nothing,
             footnotes = Core.Nothing, headers = Core.Nothing,
             inlineObjects = Core.Nothing, lists = Core.Nothing,
             namedRanges = Core.Nothing, namedStyles = Core.Nothing,
             positionedObjects = Core.Nothing, revisionId = Core.Nothing,
             suggestedDocumentStyleChanges = Core.Nothing,
             suggestedNamedStylesChanges = Core.Nothing,
             suggestionsViewMode = Core.Nothing, tabs = Core.Nothing,
             title = Core.Nothing}
instance Core.FromJSON Document where
        parseJSON
          = Core.withObject "Document"
              (\ o ->
                 Document Core.<$>
                   (o Core..:? "body") Core.<*> (o Core..:? "documentId") Core.<*>
                     (o Core..:? "documentStyle")
                     Core.<*> (o Core..:? "footers")
          ...
          = Core.object
              (Core.catMaybes
                 [("body" Core..=) Core.<$> body,
                  ...
                  ("suggestedDocumentStyleChanges" Core..=) Core.<$>
                    suggestedDocumentStyleChanges,
                  ("suggestedNamedStylesChanges" Core..=) Core.<$>
                    suggestedNamedStylesChanges,
                  ("suggestionsViewMode" Core..=) Core.<$> suggestionsViewMode,
                  ("tabs" Core..=) Core.<$> tabs, ("title" Core..=) Core.<$> title])
...
instance Core.FromJSON Document_Footers where
        parseJSON
          = Core.withObject "Document_Footers"
...
instance Core.FromJSON Document_Footnotes where
        parseJSON
          = Core.withObject "Document_Footnotes"
...
instance Core.FromJSON Document_Headers where
        parseJSON
          = Core.withObject "Document_Headers"
...
instance Core.FromJSON Document_InlineObjects where
        parseJSON
          = Core.withObject "Document_InlineObjects"
...
instance Core.FromJSON Document_Lists where
        parseJSON
          = Core.withObject "Document_Lists"
...
instance Core.FromJSON Document_NamedRanges where
        parseJSON
          = Core.withObject "Document_NamedRanges"
...
instance Core.FromJSON Document_PositionedObjects where
        parseJSON
          = Core.withObject "Document_PositionedObjects"
              (\ o ->
...
instance Core.FromJSON Document_SuggestedDocumentStyleChanges where
        parseJSON
          = Core.withObject "Document_SuggestedDocumentStyleChanges"
              (\ o ->
                 Document_SuggestedDocumentStyleChanges Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON Document_SuggestedNamedStylesChanges where
        parseJSON
          = Core.withObject "Document_SuggestedNamedStylesChanges"
              (\ o ->
                 Document_SuggestedNamedStylesChanges Core.<$>
                   (Core.parseJSONObject o))
...
newDocumentStyle 
    ::  DocumentStyle
newDocumentStyle
  = DocumentStyle{background = Core.Nothing,
                  defaultFooterId = Core.Nothing, defaultHeaderId = Core.Nothing,
                  evenPageFooterId = Core.Nothing, evenPageHeaderId = Core.Nothing,
                  firstPageFooterId = Core.Nothing, firstPageHeaderId = Core.Nothing,
                  flipPageOrientation = Core.Nothing, marginBottom = Core.Nothing,
                  marginFooter = Core.Nothing, marginHeader = Core.Nothing,
                  marginLeft = Core.Nothing, marginRight = Core.Nothing,
                  marginTop = Core.Nothing, pageNumberStart = Core.Nothing,
...
instance Core.FromJSON DocumentStyle where
        parseJSON
          = Core.withObject "DocumentStyle"
              (\ o ->
                 DocumentStyle Core.<$>
                   (o Core..:? "background") Core.<*> (o Core..:? "defaultFooterId")
          ...
          = Core.object
              (Core.catMaybes
                 [("background" Core..=) Core.<$> background,
                  ...
                  ("useCustomHeaderFooterMargins" Core..=) Core.<$>
                    useCustomHeaderFooterMargins,
                  ("useEvenPageHeaderFooter" Core..=) Core.<$>
                    useEvenPageHeaderFooter,
                  ("useFirstPageHeaderFooter" Core..=) Core.<$>
...
newDocumentStyleSuggestionState 
    ::  DocumentStyleSuggestionState
newDocumentStyleSuggestionState
  = DocumentStyleSuggestionState{backgroundSuggestionState =
                                   Core.Nothing,
...
instance Core.FromJSON DocumentStyleSuggestionState where
        parseJSON
          = Core.withObject "DocumentStyleSuggestionState"
              (\ o ->
                 DocumentStyleSuggestionState Core.<$>
                   (o Core..:? "backgroundSuggestionState") Core.<*>
                     (o Core..:? "defaultFooterIdSuggested")
...
instance Core.ToJSON DocumentStyleSuggestionState where
        toJSON DocumentStyleSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("backgroundSuggestionState" Core..=) Core.<$>
                    backgroundSuggestionState,
                  ("defaultFooterIdSuggested" Core..=) Core.<$>
                    defaultFooterIdSuggested,
                  ("defaultHeaderIdSuggested" Core..=) Core.<$>
                    defaultHeaderIdSuggested,
                  ("evenPageFooterIdSuggested" Core..=) Core.<$>
                    evenPageFooterIdSuggested,
                  ("evenPageHeaderIdSuggested" Core..=) Core.<$>
                    evenPageHeaderIdSuggested,
                  ("firstPageFooterIdSuggested" Core..=) Core.<$>
                    firstPageFooterIdSuggested,
                  ("firstPageHeaderIdSuggested" Core..=) Core.<$>
                    firstPageHeaderIdSuggested,
                  ("flipPageOrientationSuggested" Core..=) Core.<$>
                  ...
                  ("pageNumberStartSuggested" Core..=) Core.<$>
                    pageNumberStartSuggested,
                  ("pageSizeSuggestionState" Core..=) Core.<$>
                    pageSizeSuggestionState,
                  ("useCustomHeaderFooterMarginsSuggested" Core..=) Core.<$>
                    useCustomHeaderFooterMarginsSuggested,
                  ("useEvenPageHeaderFooterSuggested" Core..=) Core.<$>
                    useEvenPageHeaderFooterSuggested,
                  ("useFirstPageHeaderFooterSuggested" Core..=) Core.<$>
...
newDocumentTab 
    ::  DocumentTab
newDocumentTab
  = DocumentTab{body = Core.Nothing, documentStyle = Core.Nothing,
                footers = Core.Nothing, footnotes = Core.Nothing,
                headers = Core.Nothing, inlineObjects = Core.Nothing,
                lists = Core.Nothing, namedRanges = Core.Nothing,
                namedStyles = Core.Nothing, positionedObjects = Core.Nothing,
                suggestedDocumentStyleChanges = Core.Nothing,
                suggestedNamedStylesChanges = Core.Nothing}
instance Core.FromJSON DocumentTab where
        parseJSON
          = Core.withObject "DocumentTab"
              (\ o ->
                 DocumentTab Core.<$>
                   (o Core..:? "body") Core.<*> (o Core..:? "documentStyle") Core.<*>
                     (o Core..:? "footers")
                     Core.<*> (o Core..:? "footnotes")
                     Core.<*> (o Core..:? "headers")
                     Core.<*> (o Core..:? "inlineObjects")
...
instance Core.FromJSON DocumentTab_Footers where
        parseJSON
          = Core.withObject "DocumentTab_Footers"
...
instance Core.FromJSON DocumentTab_Footnotes where
        parseJSON
          = Core.withObject "DocumentTab_Footnotes"
...
instance Core.FromJSON DocumentTab_Headers where
        parseJSON
          = Core.withObject "DocumentTab_Headers"
...
instance Core.FromJSON DocumentTab_InlineObjects where
        parseJSON
          = Core.withObject "DocumentTab_InlineObjects"
              (\ o ->
...
instance Core.FromJSON DocumentTab_Lists where
        parseJSON
          = Core.withObject "DocumentTab_Lists"
...
instance Core.FromJSON DocumentTab_NamedRanges where
        parseJSON
          = Core.withObject "DocumentTab_NamedRanges"
...
instance Core.FromJSON DocumentTab_PositionedObjects where
        parseJSON
          = Core.withObject "DocumentTab_PositionedObjects"
              (\ o ->
...
newDocumentTab_SuggestedDocumentStyleChanges additional
  = DocumentTab_SuggestedDocumentStyleChanges{additional =
                                                additional}
instance Core.FromJSON DocumentTab_SuggestedDocumentStyleChanges
         where
        parseJSON
          = Core.withObject "DocumentTab_SuggestedDocumentStyleChanges"
              (\ o ->
                 DocumentTab_SuggestedDocumentStyleChanges Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DocumentTab_SuggestedDocumentStyleChanges
         where
...
instance Core.FromJSON DocumentTab_SuggestedNamedStylesChanges
         where
        parseJSON
          = Core.withObject "DocumentTab_SuggestedNamedStylesChanges"
              (\ o ->
                 DocumentTab_SuggestedNamedStylesChanges Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON EmbeddedDrawingProperties where
        parseJSON
          = Core.withObject "EmbeddedDrawingProperties"
...
newEmbeddedDrawingPropertiesSuggestionState
  = EmbeddedDrawingPropertiesSuggestionState
instance Core.FromJSON EmbeddedDrawingPropertiesSuggestionState
         where
        parseJSON
          = Core.withObject "EmbeddedDrawingPropertiesSuggestionState"
...
newEmbeddedObject 
    ::  EmbeddedObject
newEmbeddedObject
  = EmbeddedObject{description = Core.Nothing,
                   embeddedDrawingProperties = Core.Nothing,
                   embeddedObjectBorder = Core.Nothing,
                   imageProperties = Core.Nothing,
                   linkedContentReference = Core.Nothing, marginBottom = Core.Nothing,
                   marginLeft = Core.Nothing, marginRight = Core.Nothing,
                   marginTop = Core.Nothing, size = Core.Nothing,
                   title = Core.Nothing}
instance Core.FromJSON EmbeddedObject where
        parseJSON
          = Core.withObject "EmbeddedObject"
              (\ o ->
                 EmbeddedObject Core.<$>
                   (o Core..:? "description") Core.<*>
                     (o Core..:? "embeddedDrawingProperties")
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("embeddedDrawingProperties" Core..=) Core.<$>
                    embeddedDrawingProperties,
                  ...
                  ("marginRight" Core..=) Core.<$> marginRight,
                  ("marginTop" Core..=) Core.<$> marginTop,
                  ("size" Core..=) Core.<$> size, ("title" Core..=) Core.<$> title])
...
newEmbeddedObjectBorder 
    ::  EmbeddedObjectBorder
newEmbeddedObjectBorder
  = EmbeddedObjectBorder{color = Core.Nothing,
                         dashStyle = Core.Nothing, propertyState = Core.Nothing,
                         width = Core.Nothing}
instance Core.FromJSON EmbeddedObjectBorder where
        parseJSON
          = Core.withObject "EmbeddedObjectBorder"
              (\ o ->
                 EmbeddedObjectBorder Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "dashStyle") Core.<*>
                     (o Core..:? "propertyState")
                     Core.<*> (o Core..:? "width"))
...
newEmbeddedObjectBorderSuggestionState 
    :: 
                                       EmbeddedObjectBorderSuggestionState
newEmbeddedObjectBorderSuggestionState
  = EmbeddedObjectBorderSuggestionState{colorSuggested =
                                          Core.Nothing,
...
instance Core.FromJSON EmbeddedObjectBorderSuggestionState where
        parseJSON
          = Core.withObject "EmbeddedObjectBorderSuggestionState"
              (\ o ->
                 EmbeddedObjectBorderSuggestionState Core.<$>
                   (o Core..:? "colorSuggested") Core.<*>
                     (o Core..:? "dashStyleSuggested")
...
newEmbeddedObjectSuggestionState 
    ::  EmbeddedObjectSuggestionState
newEmbeddedObjectSuggestionState
  = EmbeddedObjectSuggestionState{descriptionSuggested =
                                    Core.Nothing,
                                  ...
                                  marginRightSuggested = Core.Nothing,
                                  marginTopSuggested = Core.Nothing,
                                  sizeSuggestionState = Core.Nothing, titleSuggested = Core.Nothing}
instance Core.FromJSON EmbeddedObjectSuggestionState where
        parseJSON
          = Core.withObject "EmbeddedObjectSuggestionState"
              (\ o ->
                 EmbeddedObjectSuggestionState Core.<$>
                   (o Core..:? "descriptionSuggested") Core.<*>
                     (o Core..:? "embeddedDrawingPropertiesSuggestionState")
          ...
          = Core.object
              (Core.catMaybes
                 [("descriptionSuggested" Core..=) Core.<$> descriptionSuggested,
                  ("embeddedDrawingPropertiesSuggestionState" Core..=) Core.<$>
                    embeddedDrawingPropertiesSuggestionState,
                  ("embeddedObjectBorderSuggestionState" Core..=) Core.<$>
                    embeddedObjectBorderSuggestionState,
                  ("imagePropertiesSuggestionState" Core..=) Core.<$>
                    imagePropertiesSuggestionState,
                  ("linkedContentReferenceSuggestionState" Core..=) Core.<$>
                    linkedContentReferenceSuggestionState,
                  ("marginBottomSuggested" Core..=) Core.<$> marginBottomSuggested,
                  ("marginLeftSuggested" Core..=) Core.<$> marginLeftSuggested,
                  ("marginRightSuggested" Core..=) Core.<$> marginRightSuggested,
...
newEndOfSegmentLocation 
    ::  EndOfSegmentLocation
newEndOfSegmentLocation
  = EndOfSegmentLocation{segmentId = Core.Nothing,
                         tabId = Core.Nothing}
instance Core.FromJSON EndOfSegmentLocation where
        parseJSON
          = Core.withObject "EndOfSegmentLocation"
              (\ o ->
                 EndOfSegmentLocation Core.<$>
                   (o Core..:? "segmentId") Core.<*> (o Core..:? "tabId"))
...
newEquation 
    ::  Equation
newEquation
  = Equation{suggestedDeletionIds = Core.Nothing,
             suggestedInsertionIds = Core.Nothing}
instance Core.FromJSON Equation where
        parseJSON
          = Core.withObject "Equation"
              (\ o ->
                 Equation Core.<$>
                   (o Core..:? "suggestedDeletionIds") Core.<*>
                     (o Core..:? "suggestedInsertionIds"))
...
instance Core.FromJSON Footer where
        parseJSON
          = Core.withObject "Footer"
              (\ o ->
                 Footer Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "footerId"))
...
instance Core.FromJSON Footnote where
        parseJSON
          = Core.withObject "Footnote"
              (\ o ->
                 Footnote Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "footnoteId"))
...
newFootnoteReference 
    ::  FootnoteReference
newFootnoteReference
  = FootnoteReference{footnoteId = Core.Nothing,
                      footnoteNumber = Core.Nothing, suggestedDeletionIds = Core.Nothing,
                      suggestedInsertionIds = Core.Nothing,
                      suggestedTextStyleChanges = Core.Nothing, textStyle = Core.Nothing}
instance Core.FromJSON FootnoteReference where
        parseJSON
          = Core.withObject "FootnoteReference"
              (\ o ->
                 FootnoteReference Core.<$>
                   (o Core..:? "footnoteId") Core.<*> (o Core..:? "footnoteNumber")
...
newFootnoteReference_SuggestedTextStyleChanges additional
  = FootnoteReference_SuggestedTextStyleChanges{additional =
                                                  additional}
instance Core.FromJSON FootnoteReference_SuggestedTextStyleChanges
         where
        parseJSON
          = Core.withObject "FootnoteReference_SuggestedTextStyleChanges"
              (\ o ->
                 FootnoteReference_SuggestedTextStyleChanges Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON FootnoteReference_SuggestedTextStyleChanges
         where
...
instance Core.FromJSON Header where
        parseJSON
          = Core.withObject "Header"
              (\ o ->
                 Header Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "headerId"))
...
newHorizontalRule 
    ::  HorizontalRule
newHorizontalRule
  = HorizontalRule{suggestedDeletionIds = Core.Nothing,
                   suggestedInsertionIds = Core.Nothing,
                   suggestedTextStyleChanges = Core.Nothing, textStyle = Core.Nothing}
instance Core.FromJSON HorizontalRule where
        parseJSON
          = Core.withObject "HorizontalRule"
              (\ o ->
                 HorizontalRule Core.<$>
                   (o Core..:? "suggestedDeletionIds") Core.<*>
                     (o Core..:? "suggestedInsertionIds")
...
instance Core.FromJSON HorizontalRule_SuggestedTextStyleChanges
         where
        parseJSON
          = Core.withObject "HorizontalRule_SuggestedTextStyleChanges"
              (\ o ->
                 HorizontalRule_SuggestedTextStyleChanges Core.<$>
                   (Core.parseJSONObject o))
...
newImageProperties 
    ::  ImageProperties
newImageProperties
  = ImageProperties{angle = Core.Nothing, brightness = Core.Nothing,
                    contentUri = Core.Nothing, contrast = Core.Nothing,
                    cropProperties = Core.Nothing, sourceUri = Core.Nothing,
          ...
          = Core.withObject "ImageProperties"
              (\ o ->
                 ImageProperties Core.<$>
                   (o Core..:? "angle") Core.<*> (o Core..:? "brightness") Core.<*>
                     (o Core..:? "contentUri")
...
newImagePropertiesSuggestionState 
    ::  ImagePropertiesSuggestionState
newImagePropertiesSuggestionState
  = ImagePropertiesSuggestionState{angleSuggested = Core.Nothing,
...
instance Core.FromJSON ImagePropertiesSuggestionState where
        parseJSON
          = Core.withObject "ImagePropertiesSuggestionState"
              (\ o ->
                 ImagePropertiesSuggestionState Core.<$>
                   (o Core..:? "angleSuggested") Core.<*>
                     (o Core..:? "brightnessSuggested")
          ...
          = Core.object
              (Core.catMaybes
                 [("angleSuggested" Core..=) Core.<$> angleSuggested,
                  ...
                  ("cropPropertiesSuggestionState" Core..=) Core.<$>
                    cropPropertiesSuggestionState,
...
newInlineObject 
    ::  InlineObject
newInlineObject
  = InlineObject{inlineObjectProperties = Core.Nothing,
                 objectId = Core.Nothing, suggestedDeletionIds = Core.Nothing,
...
instance Core.FromJSON InlineObject where
        parseJSON
          = Core.withObject "InlineObject"
              (\ o ->
                 InlineObject Core.<$>
                   (o Core..:? "inlineObjectProperties") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "suggestedDeletionIds")
...
instance Core.ToJSON InlineObject where
        toJSON InlineObject{..}
          = Core.object
              (Core.catMaybes
                 [("inlineObjectProperties" Core..=) Core.<$>
                    inlineObjectProperties,
                  ("objectId" Core..=) Core.<$> objectId,
                  ("suggestedDeletionIds" Core..=) Core.<$> suggestedDeletionIds,
                  ("suggestedInlineObjectPropertiesChanges" Core..=) Core.<$>
...
newInlineObject_SuggestedInlineObjectPropertiesChanges additional
  = InlineObject_SuggestedInlineObjectPropertiesChanges{additional =
                                                          additional}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "InlineObject_SuggestedInlineObjectPropertiesChanges"
              (\ o ->
                 InlineObject_SuggestedInlineObjectPropertiesChanges Core.<$>
                   (Core.parseJSONObject o))
...
newInlineObjectElement 
    ::  InlineObjectElement
newInlineObjectElement
  = InlineObjectElement{inlineObjectId = Core.Nothing,
                        suggestedDeletionIds = Core.Nothing,
                        suggestedInsertionIds = Core.Nothing,
                        suggestedTextStyleChanges = Core.Nothing, textStyle = Core.Nothing}
instance Core.FromJSON InlineObjectElement where
        parseJSON
          = Core.withObject "InlineObjectElement"
              (\ o ->
                 InlineObjectElement Core.<$>
                   (o Core..:? "inlineObjectId") Core.<*>
                     (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds")
                     Core.<*> (o Core..:? "suggestedTextStyleChanges")
                     Core.<*> (o Core..:? "textStyle"))
...
newInlineObjectElement_SuggestedTextStyleChanges additional
  = InlineObjectElement_SuggestedTextStyleChanges{additional =
                                                    additional}
instance Core.FromJSON
           InlineObjectElement_SuggestedTextStyleChanges
         where
        parseJSON
          = Core.withObject "InlineObjectElement_SuggestedTextStyleChanges"
              (\ o ->
                 InlineObjectElement_SuggestedTextStyleChanges Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON InlineObjectElement_SuggestedTextStyleChanges
         where
...
instance Core.FromJSON InlineObjectProperties where
        parseJSON
          = Core.withObject "InlineObjectProperties"
              (\ o ->
...
newInsertInlineImageRequest 
    ::  InsertInlineImageRequest
newInsertInlineImageRequest
  = InsertInlineImageRequest{endOfSegmentLocation = Core.Nothing,
                             location = Core.Nothing, objectSize = Core.Nothing,
                             uri = Core.Nothing}
instance Core.FromJSON InsertInlineImageRequest where
        parseJSON
          = Core.withObject "InsertInlineImageRequest"
              (\ o ->
                 InsertInlineImageRequest Core.<$>
                   (o Core..:? "endOfSegmentLocation") Core.<*>
                     (o Core..:? "location")
...
instance Core.FromJSON InsertInlineImageResponse where
        parseJSON
          = Core.withObject "InsertInlineImageResponse"
...
instance Core.FromJSON InsertInlineSheetsChartResponse where
        parseJSON
          = Core.withObject "InsertInlineSheetsChartResponse"
              (\ o ->
...
newInsertPageBreakRequest 
    ::  InsertPageBreakRequest
newInsertPageBreakRequest
  = InsertPageBreakRequest{endOfSegmentLocation = Core.Nothing,
                           location = Core.Nothing}
instance Core.FromJSON InsertPageBreakRequest where
        parseJSON
          = Core.withObject "InsertPageBreakRequest"
              (\ o ->
                 InsertPageBreakRequest Core.<$>
                   (o Core..:? "endOfSegmentLocation") Core.<*>
                     (o Core..:? "location"))
...
newInsertSectionBreakRequest 
    ::  InsertSectionBreakRequest
newInsertSectionBreakRequest
  = InsertSectionBreakRequest{endOfSegmentLocation = Core.Nothing,
                              location = Core.Nothing, sectionType = Core.Nothing}
instance Core.FromJSON InsertSectionBreakRequest where
        parseJSON
          = Core.withObject "InsertSectionBreakRequest"
              (\ o ->
                 InsertSectionBreakRequest Core.<$>
                   (o Core..:? "endOfSegmentLocation") Core.<*>
                     (o Core..:? "location")
...
newInsertTableColumnRequest 
    ::  InsertTableColumnRequest
newInsertTableColumnRequest
  = InsertTableColumnRequest{insertRight = Core.Nothing,
                             tableCellLocation = Core.Nothing}
instance Core.FromJSON InsertTableColumnRequest where
        parseJSON
          = Core.withObject "InsertTableColumnRequest"
              (\ o ->
                 InsertTableColumnRequest Core.<$>
                   (o Core..:? "insertRight") Core.<*>
...
newInsertTableRequest 
    ::  InsertTableRequest
newInsertTableRequest
  = InsertTableRequest{columns = Core.Nothing,
                       endOfSegmentLocation = Core.Nothing, location = Core.Nothing,
                       rows = Core.Nothing}
instance Core.FromJSON InsertTableRequest where
        parseJSON
          = Core.withObject "InsertTableRequest"
              (\ o ->
                 InsertTableRequest Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "endOfSegmentLocation")
...
newInsertTableRowRequest 
    ::  InsertTableRowRequest
newInsertTableRowRequest
  = InsertTableRowRequest{insertBelow = Core.Nothing,
                          tableCellLocation = Core.Nothing}
instance Core.FromJSON InsertTableRowRequest where
        parseJSON
          = Core.withObject "InsertTableRowRequest"
              (\ o ->
                 InsertTableRowRequest Core.<$>
                   (o Core..:? "insertBelow") Core.<*>
                     (o Core..:? "tableCellLocation"))
...
newInsertTextRequest 
    ::  InsertTextRequest
newInsertTextRequest
  = InsertTextRequest{endOfSegmentLocation = Core.Nothing,
                      location = Core.Nothing, text = Core.Nothing}
instance Core.FromJSON InsertTextRequest where
        parseJSON
          = Core.withObject "InsertTextRequest"
              (\ o ->
                 InsertTextRequest Core.<$>
                   (o Core..:? "endOfSegmentLocation") Core.<*>
                     (o Core..:? "location")
                     Core.<*> (o Core..:? "text"))
...
newLink 
    ::  Link
newLink
  = Link{bookmark = Core.Nothing, bookmarkId = Core.Nothing,
         heading = Core.Nothing, headingId = Core.Nothing,
         tabId = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Link where
        parseJSON
          = Core.withObject "Link"
              (\ o ->
                 Link Core.<$>
                   (o Core..:? "bookmark") Core.<*> (o Core..:? "bookmarkId") Core.<*>
                     (o Core..:? "heading")
          ...
          = Core.object
              (Core.catMaybes
                 [("bookmark" Core..=) Core.<$> bookmark,
                  ...
                  ("tabId" Core..=) Core.<$> tabId, ("url" Core..=) Core.<$> url])
...
instance Core.FromJSON LinkedContentReference where
        parseJSON
          = Core.withObject "LinkedContentReference"
              (\ o ->
                 LinkedContentReference Core.<$>
                   (o Core..:? "sheetsChartReference"))
...
newList 
    ::  List
newList
  = List{listProperties = Core.Nothing,
         suggestedDeletionIds = Core.Nothing,
         suggestedInsertionId = Core.Nothing,
         suggestedListPropertiesChanges = Core.Nothing}
instance Core.FromJSON List where
        parseJSON
          = Core.withObject "List"
              (\ o ->
                 List Core.<$>
                   (o Core..:? "listProperties") Core.<*>
                     (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionId")
          ...
          = Core.object
              (Core.catMaybes
                 [("listProperties" Core..=) Core.<$> listProperties,
                  ("suggestedDeletionIds" Core..=) Core.<$> suggestedDeletionIds,
                  ("suggestedInsertionId" Core..=) Core.<$> suggestedInsertionId,
                  ("suggestedListPropertiesChanges" Core..=) Core.<$>
...
instance Core.FromJSON List_SuggestedListPropertiesChanges where
        parseJSON
          = Core.withObject "List_SuggestedListPropertiesChanges"
              (\ o ->
                 List_SuggestedListPropertiesChanges Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON ListProperties where
        parseJSON
          = Core.withObject "ListProperties"
...
newLocation 
    ::  Location
newLocation
  = Location{index = Core.Nothing, segmentId = Core.Nothing,
             tabId = Core.Nothing}
instance Core.FromJSON Location where
        parseJSON
          = Core.withObject "Location"
              (\ o ->
                 Location Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "segmentId") Core.<*>
                     (o Core..:? "tabId"))
...
instance Core.FromJSON MergeTableCellsRequest where
        parseJSON
          = Core.withObject "MergeTableCellsRequest"
...
newNamedRange 
    ::  NamedRange
newNamedRange
  = NamedRange{name = Core.Nothing, namedRangeId = Core.Nothing,
               ranges = Core.Nothing}
instance Core.FromJSON NamedRange where
        parseJSON
          = Core.withObject "NamedRange"
              (\ o ->
                 NamedRange Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "namedRangeId") Core.<*>
                     (o Core..:? "ranges"))
...
instance Core.FromJSON NamedRanges where
        parseJSON
          = Core.withObject "NamedRanges"
              (\ o ->
                 NamedRanges Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "namedRanges"))
...
newNamedStyle 
    ::  NamedStyle
newNamedStyle
  = NamedStyle{namedStyleType = Core.Nothing,
               paragraphStyle = Core.Nothing, textStyle = Core.Nothing}
instance Core.FromJSON NamedStyle where
        parseJSON
          = Core.withObject "NamedStyle"
              (\ o ->
                 NamedStyle Core.<$>
                   (o Core..:? "namedStyleType") Core.<*>
                     (o Core..:? "paragraphStyle")
                     Core.<*> (o Core..:? "textStyle"))
...
newNamedStyleSuggestionState 
    ::  NamedStyleSuggestionState
newNamedStyleSuggestionState
  = NamedStyleSuggestionState{namedStyleType = Core.Nothing,
                              paragraphStyleSuggestionState = Core.Nothing,
                              textStyleSuggestionState = Core.Nothing}
instance Core.FromJSON NamedStyleSuggestionState where
        parseJSON
          = Core.withObject "NamedStyleSuggestionState"
              (\ o ->
                 NamedStyleSuggestionState Core.<$>
                   (o Core..:? "namedStyleType") Core.<*>
                     (o Core..:? "paragraphStyleSuggestionState")
                     Core.<*> (o Core..:? "textStyleSuggestionState"))
...
instance Core.ToJSON NamedStyleSuggestionState where
        toJSON NamedStyleSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("namedStyleType" Core..=) Core.<$> namedStyleType,
                  ("paragraphStyleSuggestionState" Core..=) Core.<$>
                    paragraphStyleSuggestionState,
                  ("textStyleSuggestionState" Core..=) Core.<$>
                    textStyleSuggestionState])
...
newNestingLevel 
    ::  NestingLevel
newNestingLevel
  = NestingLevel{bulletAlignment = Core.Nothing,
                 glyphFormat = Core.Nothing, glyphSymbol = Core.Nothing,
                 glyphType = Core.Nothing, indentFirstLine = Core.Nothing,
                 indentStart = Core.Nothing, startNumber = Core.Nothing,
                 textStyle = Core.Nothing}
instance Core.FromJSON NestingLevel where
        parseJSON
          = Core.withObject "NestingLevel"
              (\ o ->
                 NestingLevel Core.<$>
                   (o Core..:? "bulletAlignment") Core.<*> (o Core..:? "glyphFormat")
...
newNestingLevelSuggestionState 
    ::  NestingLevelSuggestionState
newNestingLevelSuggestionState
  = NestingLevelSuggestionState{bulletAlignmentSuggested =
                                  Core.Nothing,
...
instance Core.FromJSON NestingLevelSuggestionState where
        parseJSON
          = Core.withObject "NestingLevelSuggestionState"
              (\ o ->
                 NestingLevelSuggestionState Core.<$>
                   (o Core..:? "bulletAlignmentSuggested") Core.<*>
                     (o Core..:? "glyphFormatSuggested")
...
instance Core.ToJSON NestingLevelSuggestionState where
        toJSON NestingLevelSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("bulletAlignmentSuggested" Core..=) Core.<$>
                  ...
                  ("indentFirstLineSuggested" Core..=) Core.<$>
...
instance Core.FromJSON ObjectReferences where
        parseJSON
          = Core.withObject "ObjectReferences"
...
newPageBreak 
    ::  PageBreak
newPageBreak
  = PageBreak{suggestedDeletionIds = Core.Nothing,
              suggestedInsertionIds = Core.Nothing,
              suggestedTextStyleChanges = Core.Nothing, textStyle = Core.Nothing}
instance Core.FromJSON PageBreak where
        parseJSON
          = Core.withObject "PageBreak"
              (\ o ->
                 PageBreak Core.<$>
                   (o Core..:? "suggestedDeletionIds") Core.<*>
                     (o Core..:? "suggestedInsertionIds")
...
instance Core.FromJSON PageBreak_SuggestedTextStyleChanges where
        parseJSON
          = Core.withObject "PageBreak_SuggestedTextStyleChanges"
              (\ o ->
                 PageBreak_SuggestedTextStyleChanges Core.<$>
                   (Core.parseJSONObject o))
...
newParagraph 
    ::  Paragraph
newParagraph
  = Paragraph{bullet = Core.Nothing, elements = Core.Nothing,
              paragraphStyle = Core.Nothing, positionedObjectIds = Core.Nothing,
...
instance Core.FromJSON Paragraph where
        parseJSON
          = Core.withObject "Paragraph"
              (\ o ->
                 Paragraph Core.<$>
                   (o Core..:? "bullet") Core.<*> (o Core..:? "elements") Core.<*>
                     (o Core..:? "paragraphStyle")
          ...
          = Core.object
              (Core.catMaybes
                 [("bullet" Core..=) Core.<$> bullet,
                  ...
                  ("suggestedParagraphStyleChanges" Core..=) Core.<$>
                    suggestedParagraphStyleChanges,
                  ("suggestedPositionedObjectIds" Core..=) Core.<$>
...
instance Core.FromJSON Paragraph_SuggestedBulletChanges where
        parseJSON
          = Core.withObject "Paragraph_SuggestedBulletChanges"
              (\ o ->
...
instance Core.FromJSON Paragraph_SuggestedParagraphStyleChanges
         where
        parseJSON
          = Core.withObject "Paragraph_SuggestedParagraphStyleChanges"
              (\ o ->
                 Paragraph_SuggestedParagraphStyleChanges Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON Paragraph_SuggestedPositionedObjectIds where
        parseJSON
          = Core.withObject "Paragraph_SuggestedPositionedObjectIds"
              (\ o ->
                 Paragraph_SuggestedPositionedObjectIds Core.<$>
                   (Core.parseJSONObject o))
...
newParagraphBorder 
    ::  ParagraphBorder
newParagraphBorder
  = ParagraphBorder{color = Core.Nothing, dashStyle = Core.Nothing,
                    padding = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON ParagraphBorder where
        parseJSON
          = Core.withObject "ParagraphBorder"
              (\ o ->
                 ParagraphBorder Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "dashStyle") Core.<*>
                     (o Core..:? "padding")
                     Core.<*> (o Core..:? "width"))
...
newParagraphElement 
    ::  ParagraphElement
newParagraphElement
  = ParagraphElement{autoText = Core.Nothing,
                     columnBreak = Core.Nothing, endIndex = Core.Nothing,
                     equation = Core.Nothing, footnoteReference = Core.Nothing,
                     horizontalRule = Core.Nothing, inlineObjectElement = Core.Nothing,
                     pageBreak = Core.Nothing, person = Core.Nothing,
                     richLink = Core.Nothing, startIndex = Core.Nothing,
                     textRun = Core.Nothing}
instance Core.FromJSON ParagraphElement where
        parseJSON
          = Core.withObject "ParagraphElement"
              (\ o ->
                 ParagraphElement Core.<$>
                   (o Core..:? "autoText") Core.<*> (o Core..:? "columnBreak")
...
newParagraphStyle 
    ::  ParagraphStyle
newParagraphStyle
  = ParagraphStyle{alignment = Core.Nothing,
                   avoidWidowAndOrphan = Core.Nothing, borderBetween = Core.Nothing,
                   borderBottom = Core.Nothing, borderLeft = Core.Nothing,
                   borderRight = Core.Nothing, borderTop = Core.Nothing,
                   direction = Core.Nothing, headingId = Core.Nothing,
                   indentEnd = Core.Nothing, indentFirstLine = Core.Nothing,
                   indentStart = Core.Nothing, keepLinesTogether = Core.Nothing,
                   keepWithNext = Core.Nothing, lineSpacing = Core.Nothing,
                   namedStyleType = Core.Nothing, pageBreakBefore = Core.Nothing,
                   shading = Core.Nothing, spaceAbove = Core.Nothing,
                   spaceBelow = Core.Nothing, spacingMode = Core.Nothing,
                   tabStops = Core.Nothing}
instance Core.FromJSON ParagraphStyle where
        parseJSON
          = Core.withObject "ParagraphStyle"
              (\ o ->
                 ParagraphStyle Core.<$>
                   (o Core..:? "alignment") Core.<*>
                     (o Core..:? "avoidWidowAndOrphan")
...
newParagraphStyleSuggestionState 
    ::  ParagraphStyleSuggestionState
newParagraphStyleSuggestionState
  = ParagraphStyleSuggestionState{alignmentSuggested = Core.Nothing,
...
instance Core.FromJSON ParagraphStyleSuggestionState where
        parseJSON
          = Core.withObject "ParagraphStyleSuggestionState"
              (\ o ->
                 ParagraphStyleSuggestionState Core.<$>
                   (o Core..:? "alignmentSuggested") Core.<*>
                     (o Core..:? "avoidWidowAndOrphanSuggested")
          ...
          = Core.object
              (Core.catMaybes
                 [("alignmentSuggested" Core..=) Core.<$> alignmentSuggested,
                  ("avoidWidowAndOrphanSuggested" Core..=) Core.<$>
...
newPerson 
    ::  Person
newPerson
  = Person{personId = Core.Nothing, personProperties = Core.Nothing,
           suggestedDeletionIds = Core.Nothing,
           suggestedInsertionIds = Core.Nothing,
           suggestedTextStyleChanges = Core.Nothing, textStyle = Core.Nothing}
instance Core.FromJSON Person where
        parseJSON
          = Core.withObject "Person"
              (\ o ->
                 Person Core.<$>
                   (o Core..:? "personId") Core.<*> (o Core..:? "personProperties")
                     Core.<*> (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds")
                     Core.<*> (o Core..:? "suggestedTextStyleChanges")
                     Core.<*> (o Core..:? "textStyle"))
...
instance Core.FromJSON Person_SuggestedTextStyleChanges where
        parseJSON
          = Core.withObject "Person_SuggestedTextStyleChanges"
              (\ o ->
...
instance Core.FromJSON PersonProperties where
        parseJSON
          = Core.withObject "PersonProperties"
              (\ o ->
                 PersonProperties Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "name"))
...
newPinTableHeaderRowsRequest 
    ::  PinTableHeaderRowsRequest
newPinTableHeaderRowsRequest
  = PinTableHeaderRowsRequest{pinnedHeaderRowsCount = Core.Nothing,
                              tableStartLocation = Core.Nothing}
instance Core.FromJSON PinTableHeaderRowsRequest where
        parseJSON
          = Core.withObject "PinTableHeaderRowsRequest"
              (\ o ->
                 PinTableHeaderRowsRequest Core.<$>
                   (o Core..:? "pinnedHeaderRowsCount") Core.<*>
                     (o Core..:? "tableStartLocation"))
...
data PositionedObject = PositionedObject
    ...
    , suggestedPositionedObjectPropertiesChanges :: (Core.Maybe
   PositionedObject_SuggestedPositionedObjectPropertiesChanges)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newPositionedObject 
    ::  PositionedObject
newPositionedObject
  = PositionedObject{objectId = Core.Nothing,
...
instance Core.FromJSON PositionedObject where
        parseJSON
          = Core.withObject "PositionedObject"
              (\ o ->
                 PositionedObject Core.<$>
                   (o Core..:? "objectId") Core.<*>
                     (o Core..:? "positionedObjectProperties")
                     Core.<*> (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionId")
...
instance Core.ToJSON PositionedObject where
        toJSON PositionedObject{..}
          = Core.object
              (Core.catMaybes
                 [("objectId" Core..=) Core.<$> objectId,
                  ("positionedObjectProperties" Core..=) Core.<$>
                    positionedObjectProperties,
                  ("suggestedDeletionIds" Core..=) Core.<$> suggestedDeletionIds,
                  ("suggestedInsertionId" Core..=) Core.<$> suggestedInsertionId,
                  ("suggestedPositionedObjectPropertiesChanges" Core..=) Core.<$>
...
newPositionedObject_SuggestedPositionedObjectPropertiesChanges
  additional
  = PositionedObject_SuggestedPositionedObjectPropertiesChanges{additional
                                                                  = additional}
instance Core.FromJSON
           PositionedObject_SuggestedPositionedObjectPropertiesChanges
         where
...
newPositionedObjectPositioning 
    ::  PositionedObjectPositioning
newPositionedObjectPositioning
  = PositionedObjectPositioning{layout = Core.Nothing,
                                leftOffset = Core.Nothing, topOffset = Core.Nothing}
instance Core.FromJSON PositionedObjectPositioning where
        parseJSON
          = Core.withObject "PositionedObjectPositioning"
              (\ o ->
                 PositionedObjectPositioning Core.<$>
                   (o Core..:? "layout") Core.<*> (o Core..:? "leftOffset") Core.<*>
                     (o Core..:? "topOffset"))
...
newPositionedObjectPositioningSuggestionState 
    :: 
                                              PositionedObjectPositioningSuggestionState
newPositionedObjectPositioningSuggestionState
  = PositionedObjectPositioningSuggestionState{layoutSuggested =
                                                 Core.Nothing,
                                               leftOffsetSuggested = Core.Nothing,
                                               topOffsetSuggested = Core.Nothing}
instance Core.FromJSON PositionedObjectPositioningSuggestionState
         where
        parseJSON
          = Core.withObject "PositionedObjectPositioningSuggestionState"
              (\ o ->
                 PositionedObjectPositioningSuggestionState Core.<$>
                   (o Core..:? "layoutSuggested") Core.<*>
                     (o Core..:? "leftOffsetSuggested")
                     Core.<*> (o Core..:? "topOffsetSuggested"))

instance Core.ToJSON PositionedObjectPositioningSuggestionState
         where
...
newPositionedObjectProperties 
    ::  PositionedObjectProperties
newPositionedObjectProperties
  = PositionedObjectProperties{embeddedObject = Core.Nothing,
                               positioning = Core.Nothing}
instance Core.FromJSON PositionedObjectProperties where
        parseJSON
          = Core.withObject "PositionedObjectProperties"
              (\ o ->
                 PositionedObjectProperties Core.<$>
                   (o Core..:? "embeddedObject") Core.<*> (o Core..:? "positioning"))
...
instance Core.FromJSON PositionedObjectPropertiesSuggestionState
         where
        parseJSON
          = Core.withObject "PositionedObjectPropertiesSuggestionState"
              (\ o ->
                 PositionedObjectPropertiesSuggestionState Core.<$>
                   (o Core..:? "embeddedObjectSuggestionState") Core.<*>
                     (o Core..:? "positioningSuggestionState"))

instance Core.ToJSON PositionedObjectPropertiesSuggestionState
         where
        toJSON PositionedObjectPropertiesSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("embeddedObjectSuggestionState" Core..=) Core.<$>
                    embeddedObjectSuggestionState,
                  ("positioningSuggestionState" Core..=) Core.<$>
...
newRange 
    ::  Range
newRange
  = Range{endIndex = Core.Nothing, segmentId = Core.Nothing,
          startIndex = Core.Nothing, tabId = Core.Nothing}
instance Core.FromJSON Range where
        parseJSON
          = Core.withObject "Range"
              (\ o ->
                 Range Core.<$>
                   (o Core..:? "endIndex") Core.<*> (o Core..:? "segmentId") Core.<*>
                     (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "tabId"))
...
newReplaceAllTextRequest 
    ::  ReplaceAllTextRequest
newReplaceAllTextRequest
  = ReplaceAllTextRequest{containsText = Core.Nothing,
                          replaceText = Core.Nothing, tabsCriteria = Core.Nothing}
instance Core.FromJSON ReplaceAllTextRequest where
        parseJSON
          = Core.withObject "ReplaceAllTextRequest"
              (\ o ->
                 ReplaceAllTextRequest Core.<$>
                   (o Core..:? "containsText") Core.<*> (o Core..:? "replaceText")
...
instance Core.FromJSON ReplaceAllTextResponse where
        parseJSON
          = Core.withObject "ReplaceAllTextResponse"
              (\ o ->
...
newReplaceImageRequest 
    ::  ReplaceImageRequest
newReplaceImageRequest
  = ReplaceImageRequest{imageObjectId = Core.Nothing,
                        imageReplaceMethod = Core.Nothing, tabId = Core.Nothing,
                        uri = Core.Nothing}
instance Core.FromJSON ReplaceImageRequest where
        parseJSON
          = Core.withObject "ReplaceImageRequest"
              (\ o ->
                 ReplaceImageRequest Core.<$>
                   (o Core..:? "imageObjectId") Core.<*>
                     (o Core..:? "imageReplaceMethod")
                     Core.<*> (o Core..:? "tabId")
                     Core.<*> (o Core..:? "uri"))
          ...
          = Core.object
              (Core.catMaybes
                 [("imageObjectId" Core..=) Core.<$> imageObjectId,
                  ...
                  ("tabId" Core..=) Core.<$> tabId, ("uri" Core..=) Core.<$> uri])
...
newReplaceNamedRangeContentRequest 
    :: 
                                   ReplaceNamedRangeContentRequest
newReplaceNamedRangeContentRequest
  = ReplaceNamedRangeContentRequest{namedRangeId = Core.Nothing,
                                    namedRangeName = Core.Nothing, tabsCriteria = Core.Nothing,
                                    text = Core.Nothing}
instance Core.FromJSON ReplaceNamedRangeContentRequest where
        parseJSON
          = Core.withObject "ReplaceNamedRangeContentRequest"
              (\ o ->
                 ReplaceNamedRangeContentRequest Core.<$>
                   (o Core..:? "namedRangeId") Core.<*> (o Core..:? "namedRangeName")
                     Core.<*> (o Core..:? "tabsCriteria")
                     Core.<*> (o Core..:? "text"))
...
newRequest 
    ::  Request'
newRequest
  = Request'{createFooter = Core.Nothing,
             createFootnote = Core.Nothing, createHeader = Core.Nothing,
             createNamedRange = Core.Nothing,
             createParagraphBullets = Core.Nothing,
             deleteContentRange = Core.Nothing, deleteFooter = Core.Nothing,
             deleteHeader = Core.Nothing, deleteNamedRange = Core.Nothing,
             deleteParagraphBullets = Core.Nothing,
             deletePositionedObject = Core.Nothing,
             deleteTableColumn = Core.Nothing, deleteTableRow = Core.Nothing,
             insertInlineImage = Core.Nothing, insertPageBreak = Core.Nothing,
             insertSectionBreak = Core.Nothing, insertTable = Core.Nothing,
             insertTableColumn = Core.Nothing, insertTableRow = Core.Nothing,
             insertText = Core.Nothing, mergeTableCells = Core.Nothing,
             pinTableHeaderRows = Core.Nothing, replaceAllText = Core.Nothing,
             ...
             updateTableRowStyle = Core.Nothing, updateTextStyle = Core.Nothing}
instance Core.FromJSON Request' where
        parseJSON
          = Core.withObject "Request'"
              (\ o ->
                 Request' Core.<$>
                   (o Core..:? "createFooter") Core.<*> (o Core..:? "createFootnote")
          ...
          = Core.object
              (Core.catMaybes
                 [("createFooter" Core..=) Core.<$> createFooter,
                  ...
                  ("replaceNamedRangeContent" Core..=) Core.<$>
                  ...
                  ("updateTableColumnProperties" Core..=) Core.<$>
...
newResponse 
    ::  Response
newResponse
  = Response{createFooter = Core.Nothing,
             createFootnote = Core.Nothing, createHeader = Core.Nothing,
             createNamedRange = Core.Nothing, insertInlineImage = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("createFooter" Core..=) Core.<$> createFooter,
                  ...
                  ("createNamedRange" Core..=) Core.<$> createNamedRange,
                  ("insertInlineImage" Core..=) Core.<$> insertInlineImage,
                  ("insertInlineSheetsChart" Core..=) Core.<$>
...
newRgbColor 
    ::  RgbColor
newRgbColor
  = RgbColor{blue = Core.Nothing, green = Core.Nothing,
             red = Core.Nothing}
instance Core.FromJSON RgbColor where
        parseJSON
          = Core.withObject "RgbColor"
              (\ o ->
                 RgbColor Core.<$>
...
newRichLink 
    ::  RichLink
newRichLink
  = RichLink{richLinkId = Core.Nothing,
...
instance Core.FromJSON RichLink where
        parseJSON
          = Core.withObject "RichLink"
              (\ o ->
                 RichLink Core.<$>
                   (o Core..:? "richLinkId") Core.<*>
                     (o Core..:? "richLinkProperties")
                     Core.<*> (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds")
                     Core.<*> (o Core..:? "suggestedTextStyleChanges")
                     Core.<*> (o Core..:? "textStyle"))
...
instance Core.FromJSON RichLink_SuggestedTextStyleChanges where
        parseJSON
          = Core.withObject "RichLink_SuggestedTextStyleChanges"
              (\ o ->
                 RichLink_SuggestedTextStyleChanges Core.<$>
                   (Core.parseJSONObject o))
...
newRichLinkProperties 
    ::  RichLinkProperties
newRichLinkProperties
  = RichLinkProperties{mimeType = Core.Nothing, title = Core.Nothing,
                       uri = Core.Nothing}
instance Core.FromJSON RichLinkProperties where
        parseJSON
          = Core.withObject "RichLinkProperties"
              (\ o ->
                 RichLinkProperties Core.<$>
                   (o Core..:? "mimeType") Core.<*> (o Core..:? "title") Core.<*>
                     (o Core..:? "uri"))
          ...
          = Core.object
              (Core.catMaybes
                 [("mimeType" Core..=) Core.<$> mimeType,
                  ("title" Core..=) Core.<$> title, ("uri" Core..=) Core.<$> uri])
...
newSectionBreak 
    ::  SectionBreak
newSectionBreak
  = SectionBreak{sectionStyle = Core.Nothing,
                 suggestedDeletionIds = Core.Nothing,
                 suggestedInsertionIds = Core.Nothing}
instance Core.FromJSON SectionBreak where
        parseJSON
          = Core.withObject "SectionBreak"
              (\ o ->
                 SectionBreak Core.<$>
                   (o Core..:? "sectionStyle") Core.<*>
                     (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds"))
...
newSectionColumnProperties 
    ::  SectionColumnProperties
newSectionColumnProperties
  = SectionColumnProperties{paddingEnd = Core.Nothing,
                            width = Core.Nothing}
instance Core.FromJSON SectionColumnProperties where
        parseJSON
          = Core.withObject "SectionColumnProperties"
              (\ o ->
                 SectionColumnProperties Core.<$>
                   (o Core..:? "paddingEnd") Core.<*> (o Core..:? "width"))
...
newSectionStyle 
    ::  SectionStyle
newSectionStyle
  = SectionStyle{columnProperties = Core.Nothing,
                 columnSeparatorStyle = Core.Nothing,
                 contentDirection = Core.Nothing, defaultFooterId = Core.Nothing,
                 defaultHeaderId = Core.Nothing, evenPageFooterId = Core.Nothing,
                 evenPageHeaderId = Core.Nothing, firstPageFooterId = Core.Nothing,
...
instance Core.FromJSON SectionStyle where
        parseJSON
          = Core.withObject "SectionStyle"
              (\ o ->
                 SectionStyle Core.<$>
                   (o Core..:? "columnProperties") Core.<*>
                     (o Core..:? "columnSeparatorStyle")
...
instance Core.FromJSON ShadingSuggestionState where
        parseJSON
          = Core.withObject "ShadingSuggestionState"
              (\ o ->
...
newSheetsChartReference 
    ::  SheetsChartReference
newSheetsChartReference
  = SheetsChartReference{chartId = Core.Nothing,
                         spreadsheetId = Core.Nothing}
instance Core.FromJSON SheetsChartReference where
        parseJSON
          = Core.withObject "SheetsChartReference"
              (\ o ->
                 SheetsChartReference Core.<$>
                   (o Core..:? "chartId") Core.<*> (o Core..:? "spreadsheetId"))
...
newSheetsChartReferenceSuggestionState 
    :: 
                                       SheetsChartReferenceSuggestionState
newSheetsChartReferenceSuggestionState
  = SheetsChartReferenceSuggestionState{chartIdSuggested =
                                          Core.Nothing,
                                        spreadsheetIdSuggested = Core.Nothing}
instance Core.FromJSON SheetsChartReferenceSuggestionState where
        parseJSON
          = Core.withObject "SheetsChartReferenceSuggestionState"
              (\ o ->
                 SheetsChartReferenceSuggestionState Core.<$>
                   (o Core..:? "chartIdSuggested") Core.<*>
                     (o Core..:? "spreadsheetIdSuggested"))
          ...
          = Core.object
              (Core.catMaybes
                 [("chartIdSuggested" Core..=) Core.<$> chartIdSuggested,
                  ("spreadsheetIdSuggested" Core..=) Core.<$>
...
newSizeSuggestionState 
    ::  SizeSuggestionState
newSizeSuggestionState
  = SizeSuggestionState{heightSuggested = Core.Nothing,
                        widthSuggested = Core.Nothing}
instance Core.FromJSON SizeSuggestionState where
        parseJSON
          = Core.withObject "SizeSuggestionState"
              (\ o ->
                 SizeSuggestionState Core.<$>
                   (o Core..:? "heightSuggested") Core.<*>
                     (o Core..:? "widthSuggested"))
...
newStructuralElement 
    ::  StructuralElement
newStructuralElement
  = StructuralElement{endIndex = Core.Nothing,
                      paragraph = Core.Nothing, sectionBreak = Core.Nothing,
                      startIndex = Core.Nothing, table = Core.Nothing,
                      tableOfContents = Core.Nothing}
instance Core.FromJSON StructuralElement where
        parseJSON
          = Core.withObject "StructuralElement"
              (\ o ->
                 StructuralElement Core.<$>
                   (o Core..:? "endIndex") Core.<*> (o Core..:? "paragraph") Core.<*>
                     (o Core..:? "sectionBreak")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "table")
...
newSubstringMatchCriteria 
    ::  SubstringMatchCriteria
newSubstringMatchCriteria
  = SubstringMatchCriteria{matchCase = Core.Nothing,
                           searchByRegex = Core.Nothing, text = Core.Nothing}
instance Core.FromJSON SubstringMatchCriteria where
        parseJSON
          = Core.withObject "SubstringMatchCriteria"
              (\ o ->
                 SubstringMatchCriteria Core.<$>
                   (o Core..:? "matchCase") Core.<*> (o Core..:? "searchByRegex")
                     Core.<*> (o Core..:? "text"))
...
newSuggestedBullet 
    ::  SuggestedBullet
newSuggestedBullet
  = SuggestedBullet{bullet = Core.Nothing,
                    bulletSuggestionState = Core.Nothing}
instance Core.FromJSON SuggestedBullet where
        parseJSON
          = Core.withObject "SuggestedBullet"
              (\ o ->
                 SuggestedBullet Core.<$>
                   (o Core..:? "bullet") Core.<*>
                     (o Core..:? "bulletSuggestionState"))
...
newSuggestedDocumentStyle 
    ::  SuggestedDocumentStyle
newSuggestedDocumentStyle
  = SuggestedDocumentStyle{documentStyle = Core.Nothing,
                           documentStyleSuggestionState = Core.Nothing}
instance Core.FromJSON SuggestedDocumentStyle where
        parseJSON
          = Core.withObject "SuggestedDocumentStyle"
              (\ o ->
                 SuggestedDocumentStyle Core.<$>
                   (o Core..:? "documentStyle") Core.<*>
                     (o Core..:? "documentStyleSuggestionState"))
...
instance Core.ToJSON SuggestedDocumentStyle where
        toJSON SuggestedDocumentStyle{..}
          = Core.object
              (Core.catMaybes
                 [("documentStyle" Core..=) Core.<$> documentStyle,
                  ("documentStyleSuggestionState" Core..=) Core.<$>
                    documentStyleSuggestionState])
...
newSuggestedInlineObjectProperties 
    :: 
                                   SuggestedInlineObjectProperties
newSuggestedInlineObjectProperties
  = SuggestedInlineObjectProperties{inlineObjectProperties =
                                      Core.Nothing,
                                    inlineObjectPropertiesSuggestionState = Core.Nothing}
instance Core.FromJSON SuggestedInlineObjectProperties where
        parseJSON
          = Core.withObject "SuggestedInlineObjectProperties"
              (\ o ->
                 SuggestedInlineObjectProperties Core.<$>
                   (o Core..:? "inlineObjectProperties") Core.<*>
                     (o Core..:? "inlineObjectPropertiesSuggestionState"))
        ...
        toJSON SuggestedInlineObjectProperties{..}
          = Core.object
              (Core.catMaybes
                 [("inlineObjectProperties" Core..=) Core.<$>
                    inlineObjectProperties,
                  ("inlineObjectPropertiesSuggestionState" Core..=) Core.<$>
                    inlineObjectPropertiesSuggestionState])
...
newSuggestedListProperties 
    ::  SuggestedListProperties
newSuggestedListProperties
  = SuggestedListProperties{listProperties = Core.Nothing,
                            listPropertiesSuggestionState = Core.Nothing}
instance Core.FromJSON SuggestedListProperties where
        parseJSON
          = Core.withObject "SuggestedListProperties"
              (\ o ->
                 SuggestedListProperties Core.<$>
                   (o Core..:? "listProperties") Core.<*>
                     (o Core..:? "listPropertiesSuggestionState"))
...
instance Core.ToJSON SuggestedListProperties where
        toJSON SuggestedListProperties{..}
          = Core.object
              (Core.catMaybes
                 [("listProperties" Core..=) Core.<$> listProperties,
                  ("listPropertiesSuggestionState" Core..=) Core.<$>
                    listPropertiesSuggestionState])
...
newSuggestedNamedStyles 
    ::  SuggestedNamedStyles
newSuggestedNamedStyles
  = SuggestedNamedStyles{namedStyles = Core.Nothing,
                         namedStylesSuggestionState = Core.Nothing}
instance Core.FromJSON SuggestedNamedStyles where
        parseJSON
          = Core.withObject "SuggestedNamedStyles"
              (\ o ->
                 SuggestedNamedStyles Core.<$>
                   (o Core..:? "namedStyles") Core.<*>
                     (o Core..:? "namedStylesSuggestionState"))
...
instance Core.ToJSON SuggestedNamedStyles where
        toJSON SuggestedNamedStyles{..}
          = Core.object
              (Core.catMaybes
                 [("namedStyles" Core..=) Core.<$> namedStyles,
                  ("namedStylesSuggestionState" Core..=) Core.<$>
                    namedStylesSuggestionState])
...
newSuggestedParagraphStyle 
    ::  SuggestedParagraphStyle
newSuggestedParagraphStyle
  = SuggestedParagraphStyle{paragraphStyle = Core.Nothing,
                            paragraphStyleSuggestionState = Core.Nothing}
instance Core.FromJSON SuggestedParagraphStyle where
        parseJSON
          = Core.withObject "SuggestedParagraphStyle"
              (\ o ->
                 SuggestedParagraphStyle Core.<$>
                   (o Core..:? "paragraphStyle") Core.<*>
                     (o Core..:? "paragraphStyleSuggestionState"))
...
newSuggestedPositionedObjectProperties 
    :: 
                                       SuggestedPositionedObjectProperties
newSuggestedPositionedObjectProperties
  = SuggestedPositionedObjectProperties{positionedObjectProperties =
                                          Core.Nothing,
                                        positionedObjectPropertiesSuggestionState = Core.Nothing}
instance Core.FromJSON SuggestedPositionedObjectProperties where
        parseJSON
          = Core.withObject "SuggestedPositionedObjectProperties"
              (\ o ->
                 SuggestedPositionedObjectProperties Core.<$>
                   (o Core..:? "positionedObjectProperties") Core.<*>
                     (o Core..:? "positionedObjectPropertiesSuggestionState"))
        ...
        toJSON SuggestedPositionedObjectProperties{..}
          = Core.object
              (Core.catMaybes
                 [("positionedObjectProperties" Core..=) Core.<$>
                    positionedObjectProperties,
                  ("positionedObjectPropertiesSuggestionState" Core..=) Core.<$>
                    positionedObjectPropertiesSuggestionState])
...
newSuggestedTableCellStyle 
    ::  SuggestedTableCellStyle
newSuggestedTableCellStyle
  = SuggestedTableCellStyle{tableCellStyle = Core.Nothing,
                            tableCellStyleSuggestionState = Core.Nothing}
instance Core.FromJSON SuggestedTableCellStyle where
        parseJSON
          = Core.withObject "SuggestedTableCellStyle"
              (\ o ->
                 SuggestedTableCellStyle Core.<$>
                   (o Core..:? "tableCellStyle") Core.<*>
                     (o Core..:? "tableCellStyleSuggestionState"))
          ...
          = Core.object
              (Core.catMaybes
                 [("tableCellStyle" Core..=) Core.<$> tableCellStyle,
                  ("tableCellStyleSuggestionState" Core..=) Core.<$>
                    tableCellStyleSuggestionState])
...
newSuggestedTableRowStyle 
    ::  SuggestedTableRowStyle
newSuggestedTableRowStyle
  = SuggestedTableRowStyle{tableRowStyle = Core.Nothing,
                           tableRowStyleSuggestionState = Core.Nothing}
instance Core.FromJSON SuggestedTableRowStyle where
        parseJSON
          = Core.withObject "SuggestedTableRowStyle"
              (\ o ->
                 SuggestedTableRowStyle Core.<$>
                   (o Core..:? "tableRowStyle") Core.<*>
                     (o Core..:? "tableRowStyleSuggestionState"))
          ...
          = Core.object
              (Core.catMaybes
                 [("tableRowStyle" Core..=) Core.<$> tableRowStyle,
                  ("tableRowStyleSuggestionState" Core..=) Core.<$>
                    tableRowStyleSuggestionState])
...
newSuggestedTextStyle 
    ::  SuggestedTextStyle
newSuggestedTextStyle
  = SuggestedTextStyle{textStyle = Core.Nothing,
                       textStyleSuggestionState = Core.Nothing}
instance Core.FromJSON SuggestedTextStyle where
        parseJSON
          = Core.withObject "SuggestedTextStyle"
              (\ o ->
                 SuggestedTextStyle Core.<$>
                   (o Core..:? "textStyle") Core.<*>
                     (o Core..:? "textStyleSuggestionState"))
...
newTab 
    ::  Tab
newTab
  = Tab{childTabs = Core.Nothing, documentTab = Core.Nothing,
...
instance Core.FromJSON Tab where
        parseJSON
          = Core.withObject "Tab"
              (\ o ->
                 Tab Core.<$>
                   (o Core..:? "childTabs") Core.<*> (o Core..:? "documentTab")
...
newTabProperties 
    ::  TabProperties
newTabProperties
  = TabProperties{index = Core.Nothing, nestingLevel = Core.Nothing,
                  parentTabId = Core.Nothing, tabId = Core.Nothing,
                  title = Core.Nothing}
instance Core.FromJSON TabProperties where
        parseJSON
          = Core.withObject "TabProperties"
              (\ o ->
                 TabProperties Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "nestingLevel") Core.<*>
                     (o Core..:? "parentTabId")
                     Core.<*> (o Core..:? "tabId")
                     Core.<*> (o Core..:? "title"))
...
instance Core.FromJSON TabStop where
        parseJSON
          = Core.withObject "TabStop"
              (\ o ->
                 TabStop Core.<$>
                   (o Core..:? "alignment") Core.<*> (o Core..:? "offset"))
...
newTable 
    ::  Table
newTable
  = Table{columns = Core.Nothing, rows = Core.Nothing,
          suggestedDeletionIds = Core.Nothing,
          suggestedInsertionIds = Core.Nothing, tableRows = Core.Nothing,
...
instance Core.FromJSON Table where
        parseJSON
          = Core.withObject "Table"
              (\ o ->
                 Table Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "rows") Core.<*>
                     (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds")
...
newTableCell 
    ::  TableCell
newTableCell
  = TableCell{content = Core.Nothing, endIndex = Core.Nothing,
              startIndex = Core.Nothing, suggestedDeletionIds = Core.Nothing,
              suggestedInsertionIds = Core.Nothing,
...
instance Core.FromJSON TableCell where
        parseJSON
          = Core.withObject "TableCell"
              (\ o ->
                 TableCell Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "endIndex") Core.<*>
                     (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds")
          ...
          = Core.object
              (Core.catMaybes
                 [("content" Core..=) Core.<$> content,
                  ...
                  ("suggestedDeletionIds" Core..=) Core.<$> suggestedDeletionIds,
                  ("suggestedInsertionIds" Core..=) Core.<$> suggestedInsertionIds,
                  ("suggestedTableCellStyleChanges" Core..=) Core.<$>
...
instance Core.FromJSON TableCell_SuggestedTableCellStyleChanges
         where
        parseJSON
          = Core.withObject "TableCell_SuggestedTableCellStyleChanges"
              (\ o ->
                 TableCell_SuggestedTableCellStyleChanges Core.<$>
                   (Core.parseJSONObject o))
...
newTableCellBorder 
    ::  TableCellBorder
newTableCellBorder
  = TableCellBorder{color = Core.Nothing, dashStyle = Core.Nothing,
                    width = Core.Nothing}
instance Core.FromJSON TableCellBorder where
        parseJSON
          = Core.withObject "TableCellBorder"
              (\ o ->
                 TableCellBorder Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "dashStyle") Core.<*>
                     (o Core..:? "width"))
...
newTableCellLocation 
    ::  TableCellLocation
newTableCellLocation
  = TableCellLocation{columnIndex = Core.Nothing,
                      rowIndex = Core.Nothing, tableStartLocation = Core.Nothing}
instance Core.FromJSON TableCellLocation where
        parseJSON
          = Core.withObject "TableCellLocation"
              (\ o ->
                 TableCellLocation Core.<$>
                   (o Core..:? "columnIndex") Core.<*> (o Core..:? "rowIndex")
...
newTableCellStyle 
    ::  TableCellStyle
newTableCellStyle
  = TableCellStyle{backgroundColor = Core.Nothing,
                   borderBottom = Core.Nothing, borderLeft = Core.Nothing,
                   borderRight = Core.Nothing, borderTop = Core.Nothing,
                   columnSpan = Core.Nothing, contentAlignment = Core.Nothing,
                   paddingBottom = Core.Nothing, paddingLeft = Core.Nothing,
                   paddingRight = Core.Nothing, paddingTop = Core.Nothing,
                   rowSpan = Core.Nothing}
instance Core.FromJSON TableCellStyle where
        parseJSON
          = Core.withObject "TableCellStyle"
              (\ o ->
                 TableCellStyle Core.<$>
                   (o Core..:? "backgroundColor") Core.<*> (o Core..:? "borderBottom")
                     Core.<*> (o Core..:? "borderLeft")
                     Core.<*> (o Core..:? "borderRight")
                     Core.<*> (o Core..:? "borderTop")
...
newTableCellStyleSuggestionState 
    ::  TableCellStyleSuggestionState
newTableCellStyleSuggestionState
  = TableCellStyleSuggestionState{backgroundColorSuggested =
                                    Core.Nothing,
                                  borderBottomSuggested = Core.Nothing,
                                  borderLeftSuggested = Core.Nothing,
                                  borderRightSuggested = Core.Nothing,
...
instance Core.FromJSON TableCellStyleSuggestionState where
        parseJSON
          = Core.withObject "TableCellStyleSuggestionState"
              (\ o ->
                 TableCellStyleSuggestionState Core.<$>
                   (o Core..:? "backgroundColorSuggested") Core.<*>
                     (o Core..:? "borderBottomSuggested")
                     Core.<*> (o Core..:? "borderLeftSuggested")
                     Core.<*> (o Core..:? "borderRightSuggested")
                     Core.<*> (o Core..:? "borderTopSuggested")
          ...
          = Core.object
              (Core.catMaybes
                 [("backgroundColorSuggested" Core..=) Core.<$>
                  ...
                  ("contentAlignmentSuggested" Core..=) Core.<$>
...
newTableColumnProperties 
    ::  TableColumnProperties
newTableColumnProperties
  = TableColumnProperties{width = Core.Nothing,
                          widthType = Core.Nothing}
instance Core.FromJSON TableColumnProperties where
        parseJSON
          = Core.withObject "TableColumnProperties"
              (\ o ->
                 TableColumnProperties Core.<$>
                   (o Core..:? "width") Core.<*> (o Core..:? "widthType"))
...
newTableOfContents 
    ::  TableOfContents
newTableOfContents
  = TableOfContents{content = Core.Nothing,
                    suggestedDeletionIds = Core.Nothing,
                    suggestedInsertionIds = Core.Nothing}
instance Core.FromJSON TableOfContents where
        parseJSON
          = Core.withObject "TableOfContents"
              (\ o ->
                 TableOfContents Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds"))
...
newTableRange 
    ::  TableRange
newTableRange
  = TableRange{columnSpan = Core.Nothing, rowSpan = Core.Nothing,
               tableCellLocation = Core.Nothing}
instance Core.FromJSON TableRange where
        parseJSON
          = Core.withObject "TableRange"
              (\ o ->
                 TableRange Core.<$>
                   (o Core..:? "columnSpan") Core.<*> (o Core..:? "rowSpan") Core.<*>
                     (o Core..:? "tableCellLocation"))
...
newTableRow 
    ::  TableRow
newTableRow
  = TableRow{endIndex = Core.Nothing, startIndex = Core.Nothing,
             suggestedDeletionIds = Core.Nothing,
             suggestedInsertionIds = Core.Nothing,
             suggestedTableRowStyleChanges = Core.Nothing,
             tableCells = Core.Nothing, tableRowStyle = Core.Nothing}
instance Core.FromJSON TableRow where
        parseJSON
          = Core.withObject "TableRow"
              (\ o ->
                 TableRow Core.<$>
                   (o Core..:? "endIndex") Core.<*> (o Core..:? "startIndex") Core.<*>
                     (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds")
          ...
          = Core.object
              (Core.catMaybes
                 [("endIndex" Core..=) Core.<$> endIndex,
                  ...
                  ("suggestedDeletionIds" Core..=) Core.<$> suggestedDeletionIds,
                  ("suggestedInsertionIds" Core..=) Core.<$> suggestedInsertionIds,
                  ("suggestedTableRowStyleChanges" Core..=) Core.<$>
...
instance Core.FromJSON TableRow_SuggestedTableRowStyleChanges where
        parseJSON
          = Core.withObject "TableRow_SuggestedTableRowStyleChanges"
              (\ o ->
                 TableRow_SuggestedTableRowStyleChanges Core.<$>
                   (Core.parseJSONObject o))
...
newTableRowStyle 
    ::  TableRowStyle
newTableRowStyle
  = TableRowStyle{minRowHeight = Core.Nothing,
                  preventOverflow = Core.Nothing, tableHeader = Core.Nothing}
instance Core.FromJSON TableRowStyle where
        parseJSON
          = Core.withObject "TableRowStyle"
              (\ o ->
                 TableRowStyle Core.<$>
                   (o Core..:? "minRowHeight") Core.<*> (o Core..:? "preventOverflow")
...
newTableRowStyleSuggestionState 
    ::  TableRowStyleSuggestionState
newTableRowStyleSuggestionState
  = TableRowStyleSuggestionState{minRowHeightSuggested =
                                   Core.Nothing}
instance Core.FromJSON TableRowStyleSuggestionState where
        parseJSON
          = Core.withObject "TableRowStyleSuggestionState"
              (\ o ->
                 TableRowStyleSuggestionState Core.<$>
                   (o Core..:? "minRowHeightSuggested"))
...
newTextRun 
    ::  TextRun
newTextRun
  = TextRun{content = Core.Nothing,
            suggestedDeletionIds = Core.Nothing,
            suggestedInsertionIds = Core.Nothing,
            suggestedTextStyleChanges = Core.Nothing, textStyle = Core.Nothing}
instance Core.FromJSON TextRun where
        parseJSON
          = Core.withObject "TextRun"
              (\ o ->
                 TextRun Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds")
...
instance Core.FromJSON TextRun_SuggestedTextStyleChanges where
        parseJSON
          = Core.withObject "TextRun_SuggestedTextStyleChanges"
              (\ o ->
                 TextRun_SuggestedTextStyleChanges Core.<$>
                   (Core.parseJSONObject o))
...
newTextStyle 
    ::  TextStyle
newTextStyle
  = TextStyle{backgroundColor = Core.Nothing,
              baselineOffset = Core.Nothing, bold = Core.Nothing,
              fontSize = Core.Nothing, foregroundColor = Core.Nothing,
              italic = Core.Nothing, link = Core.Nothing,
              smallCaps = Core.Nothing, strikethrough = Core.Nothing,
              underline = Core.Nothing, weightedFontFamily = Core.Nothing}
instance Core.FromJSON TextStyle where
        parseJSON
          = Core.withObject "TextStyle"
              (\ o ->
                 TextStyle Core.<$>
                   (o Core..:? "backgroundColor") Core.<*>
                     (o Core..:? "baselineOffset")
                     Core.<*> (o Core..:? "bold")
          ...
          = Core.object
              (Core.catMaybes
                 [("backgroundColor" Core..=) Core.<$> backgroundColor,
                  ...
                  ("italic" Core..=) Core.<$> italic, ("link" Core..=) Core.<$> link,
...
newTextStyleSuggestionState 
    ::  TextStyleSuggestionState
newTextStyleSuggestionState
  = TextStyleSuggestionState{backgroundColorSuggested = Core.Nothing,
                             baselineOffsetSuggested = Core.Nothing,
                             boldSuggested = Core.Nothing, fontSizeSuggested = Core.Nothing,
                             foregroundColorSuggested = Core.Nothing,
                             italicSuggested = Core.Nothing, linkSuggested = Core.Nothing,
...
instance Core.FromJSON TextStyleSuggestionState where
        parseJSON
          = Core.withObject "TextStyleSuggestionState"
              (\ o ->
                 TextStyleSuggestionState Core.<$>
                   (o Core..:? "backgroundColorSuggested") Core.<*>
                     (o Core..:? "baselineOffsetSuggested")
          ...
          = Core.object
              (Core.catMaybes
                 [("backgroundColorSuggested" Core..=) Core.<$>
                  ...
                  ("weightedFontFamilySuggested" Core..=) Core.<$>
...
instance Core.FromJSON UnmergeTableCellsRequest where
        parseJSON
          = Core.withObject "UnmergeTableCellsRequest"
              (\ o ->
...
newUpdateDocumentStyleRequest 
    ::  UpdateDocumentStyleRequest
newUpdateDocumentStyleRequest
  = UpdateDocumentStyleRequest{documentStyle = Core.Nothing,
                               fields = Core.Nothing, tabId = Core.Nothing}
instance Core.FromJSON UpdateDocumentStyleRequest where
        parseJSON
          = Core.withObject "UpdateDocumentStyleRequest"
              (\ o ->
                 UpdateDocumentStyleRequest Core.<$>
                   (o Core..:? "documentStyle") Core.<*> (o Core..:? "fields")
                     Core.<*> (o Core..:? "tabId"))
...
newUpdateParagraphStyleRequest 
    ::  UpdateParagraphStyleRequest
newUpdateParagraphStyleRequest
  = UpdateParagraphStyleRequest{fields = Core.Nothing,
                                paragraphStyle = Core.Nothing, range = Core.Nothing}
instance Core.FromJSON UpdateParagraphStyleRequest where
        parseJSON
          = Core.withObject "UpdateParagraphStyleRequest"
              (\ o ->
                 UpdateParagraphStyleRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "paragraphStyle")
                     Core.<*> (o Core..:? "range"))
...
newUpdateSectionStyleRequest 
    ::  UpdateSectionStyleRequest
newUpdateSectionStyleRequest
  = UpdateSectionStyleRequest{fields = Core.Nothing,
                              range = Core.Nothing, sectionStyle = Core.Nothing}
instance Core.FromJSON UpdateSectionStyleRequest where
        parseJSON
          = Core.withObject "UpdateSectionStyleRequest"
              (\ o ->
                 UpdateSectionStyleRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "range") Core.<*>
                     (o Core..:? "sectionStyle"))
...
newUpdateTableCellStyleRequest 
    ::  UpdateTableCellStyleRequest
newUpdateTableCellStyleRequest
  = UpdateTableCellStyleRequest{fields = Core.Nothing,
                                tableCellStyle = Core.Nothing, tableRange = Core.Nothing,
                                tableStartLocation = Core.Nothing}
instance Core.FromJSON UpdateTableCellStyleRequest where
        parseJSON
          = Core.withObject "UpdateTableCellStyleRequest"
              (\ o ->
                 UpdateTableCellStyleRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "tableCellStyle")
...
newUpdateTableColumnPropertiesRequest 
    :: 
                                      UpdateTableColumnPropertiesRequest
newUpdateTableColumnPropertiesRequest
  = UpdateTableColumnPropertiesRequest{columnIndices = Core.Nothing,
                                       fields = Core.Nothing, tableColumnProperties = Core.Nothing,
                                       tableStartLocation = Core.Nothing}
instance Core.FromJSON UpdateTableColumnPropertiesRequest where
        parseJSON
          = Core.withObject "UpdateTableColumnPropertiesRequest"
              (\ o ->
                 UpdateTableColumnPropertiesRequest Core.<$>
                   (o Core..:? "columnIndices") Core.<*> (o Core..:? "fields")
...
newUpdateTableRowStyleRequest 
    ::  UpdateTableRowStyleRequest
newUpdateTableRowStyleRequest
  = UpdateTableRowStyleRequest{fields = Core.Nothing,
                               rowIndices = Core.Nothing, tableRowStyle = Core.Nothing,
                               tableStartLocation = Core.Nothing}
instance Core.FromJSON UpdateTableRowStyleRequest where
        parseJSON
          = Core.withObject "UpdateTableRowStyleRequest"
              (\ o ->
                 UpdateTableRowStyleRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "rowIndices") Core.<*>
                     (o Core..:? "tableRowStyle")
                     Core.<*> (o Core..:? "tableStartLocation"))
...
newUpdateTextStyleRequest 
    ::  UpdateTextStyleRequest
newUpdateTextStyleRequest
  = UpdateTextStyleRequest{fields = Core.Nothing,
                           range = Core.Nothing, textStyle = Core.Nothing}
instance Core.FromJSON UpdateTextStyleRequest where
        parseJSON
          = Core.withObject "UpdateTextStyleRequest"
              (\ o ->
                 UpdateTextStyleRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "range") Core.<*>
                     (o Core..:? "textStyle"))
...
newWeightedFontFamily 
    ::  WeightedFontFamily
newWeightedFontFamily
  = WeightedFontFamily{fontFamily = Core.Nothing,
                       weight = Core.Nothing}
instance Core.FromJSON WeightedFontFamily where
        parseJSON
          = Core.withObject "WeightedFontFamily"
              (\ o ->
                 WeightedFontFamily Core.<$>
                   (o Core..:? "fontFamily") Core.<*> (o Core..:? "weight"))
...
newWriteControl 
    ::  WriteControl
newWriteControl
  = WriteControl{requiredRevisionId = Core.Nothing,
                 targetRevisionId = Core.Nothing}
instance Core.FromJSON WriteControl where
        parseJSON
          = Core.withObject "WriteControl"
              (\ o ->
                 WriteControl Core.<$>
                   (o Core..:? "requiredRevisionId") Core.<*>
                     (o Core..:? "targetRevisionId"))
