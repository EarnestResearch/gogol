...
instance Core.ToJSON AutoText where
        toJSON AutoText{..}
          = Core.object
              (Core.catMaybes
                 [("suggestedDeletionIds" Core..=) Core.<$>
                    suggestedDeletionIds,
                  ("suggestedInsertionIds" Core..=) Core.<$>
...
instance Core.ToJSON Background where
        toJSON Background{..}
          = Core.object
              (Core.catMaybes [("color" Core..=) Core.<$> color])
...
newBackgroundSuggestionState 
    ::  BackgroundSuggestionState
newBackgroundSuggestionState =
  BackgroundSuggestionState {backgroundColorSuggested = Core.Nothing}

instance Core.FromJSON BackgroundSuggestionState
         where
        parseJSON
...
newBatchUpdateDocumentRequest =
  BatchUpdateDocumentRequest
    {requests = Core.Nothing, writeControl = Core.Nothing}

instance Core.FromJSON BatchUpdateDocumentRequest
         where
        parseJSON
          = Core.withObject "BatchUpdateDocumentRequest"
              (\ o ->
                 BatchUpdateDocumentRequest Core.<$>
                   (o Core..:? "requests") Core.<*>
                     (o Core..:? "writeControl"))
...
instance Core.FromJSON BatchUpdateDocumentResponse
         where
        parseJSON
...
instance Core.ToJSON BatchUpdateDocumentResponse
         where
...
instance Core.ToJSON BulletSuggestionState where
        toJSON BulletSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("listIdSuggested" Core..=) Core.<$>
                    listIdSuggested,
                  ("nestingLevelSuggested" Core..=) Core.<$>
...
newCreateFooterRequest =
  CreateFooterRequest
    {sectionBreakLocation = Core.Nothing, type' = Core.Nothing}
          ...
          = Core.withObject "CreateFooterRequest"
              (\ o ->
                 CreateFooterRequest Core.<$>
                   (o Core..:? "sectionBreakLocation") Core.<*>
                     (o Core..:? "type"))
...
instance Core.ToJSON CreateFooterRequest where
        toJSON CreateFooterRequest{..}
          = Core.object
              (Core.catMaybes
                 [("sectionBreakLocation" Core..=) Core.<$>
...
newCreateFooterResponse 
    ::  CreateFooterResponse
newCreateFooterResponse = CreateFooterResponse {footerId = Core.Nothing}

instance Core.FromJSON CreateFooterResponse where
        parseJSON
          = Core.withObject "CreateFooterResponse"
              (\ o ->
                 CreateFooterResponse Core.<$>
                   (o Core..:? "footerId"))
...
instance Core.ToJSON CreateFootnoteRequest where
        toJSON CreateFootnoteRequest{..}
          = Core.object
              (Core.catMaybes
                 [("endOfSegmentLocation" Core..=) Core.<$>
                    endOfSegmentLocation,
...
newCreateFootnoteResponse 
    ::  CreateFootnoteResponse
newCreateFootnoteResponse = CreateFootnoteResponse {footnoteId = Core.Nothing}

instance Core.FromJSON CreateFootnoteResponse where
        parseJSON
          = Core.withObject "CreateFootnoteResponse"
              (\ o ->
                 CreateFootnoteResponse Core.<$>
                   (o Core..:? "footnoteId"))
...
newCreateHeaderResponse 
    ::  CreateHeaderResponse
newCreateHeaderResponse = CreateHeaderResponse {headerId = Core.Nothing}

instance Core.FromJSON CreateHeaderResponse where
        parseJSON
          = Core.withObject "CreateHeaderResponse"
              (\ o ->
                 CreateHeaderResponse Core.<$>
                   (o Core..:? "headerId"))
...
newCreateNamedRangeRequest 
    ::  CreateNamedRangeRequest
newCreateNamedRangeRequest =
  CreateNamedRangeRequest {name = Core.Nothing, range = Core.Nothing}
...
newCreateParagraphBulletsRequest =
  CreateParagraphBulletsRequest
    {bulletPreset = Core.Nothing, range = Core.Nothing}

instance Core.FromJSON CreateParagraphBulletsRequest
         where
        parseJSON
          = Core.withObject "CreateParagraphBulletsRequest"
              (\ o ->
                 CreateParagraphBulletsRequest Core.<$>
                   (o Core..:? "bulletPreset") Core.<*>
                     (o Core..:? "range"))

instance Core.ToJSON CreateParagraphBulletsRequest
         where
...
instance Core.FromJSON CropPropertiesSuggestionState
         where
        parseJSON
...
instance Core.ToJSON CropPropertiesSuggestionState
         where
        toJSON CropPropertiesSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("angleSuggested" Core..=) Core.<$> angleSuggested,
                  ("offsetBottomSuggested" Core..=) Core.<$>
                    offsetBottomSuggested,
                  ("offsetLeftSuggested" Core..=) Core.<$>
                    offsetLeftSuggested,
                  ("offsetRightSuggested" Core..=) Core.<$>
                    offsetRightSuggested,
                  ("offsetTopSuggested" Core..=) Core.<$>
                    offsetTopSuggested])
...
newDeleteContentRangeRequest 
    ::  DeleteContentRangeRequest
newDeleteContentRangeRequest = DeleteContentRangeRequest {range = Core.Nothing}

instance Core.FromJSON DeleteContentRangeRequest
         where
        parseJSON
          = Core.withObject "DeleteContentRangeRequest"
              (\ o ->
                 DeleteContentRangeRequest Core.<$>
                   (o Core..:? "range"))
...
newtype DeleteFooterRequest = DeleteFooterRequest
    {
...
newDeleteFooterRequest 
    ::  DeleteFooterRequest
newDeleteFooterRequest = DeleteFooterRequest {footerId = Core.Nothing}

instance Core.FromJSON DeleteFooterRequest where
        parseJSON
          = Core.withObject "DeleteFooterRequest"
              (\ o ->
                 DeleteFooterRequest Core.<$> (o Core..:? "footerId"))
...
newtype DeleteHeaderRequest = DeleteHeaderRequest
    {
...
newDeleteHeaderRequest 
    ::  DeleteHeaderRequest
newDeleteHeaderRequest = DeleteHeaderRequest {headerId = Core.Nothing}

instance Core.FromJSON DeleteHeaderRequest where
        parseJSON
          = Core.withObject "DeleteHeaderRequest"
              (\ o ->
                 DeleteHeaderRequest Core.<$> (o Core..:? "headerId"))
...
newDeleteNamedRangeRequest 
    ::  DeleteNamedRangeRequest
newDeleteNamedRangeRequest =
  DeleteNamedRangeRequest {name = Core.Nothing, namedRangeId = Core.Nothing}
...
instance Core.FromJSON DeleteParagraphBulletsRequest
         where
        parseJSON
          = Core.withObject "DeleteParagraphBulletsRequest"
              (\ o ->
                 DeleteParagraphBulletsRequest Core.<$>
                   (o Core..:? "range"))

instance Core.ToJSON DeleteParagraphBulletsRequest
         where
...
newtype DeletePositionedObjectRequest = DeletePositionedObjectRequest
    {
...
instance Core.FromJSON DeletePositionedObjectRequest
         where
        parseJSON
...
instance Core.ToJSON DeletePositionedObjectRequest
         where
...
newDocument_Footers 
    ::  Core.HashMap Core.Text Footer
       -- ^  See 'additional'.
    -> Document_Footers
newDocument_Footers additional = Document_Footers {additional = additional}

instance Core.FromJSON Document_Footers where
        parseJSON
          = Core.withObject "Document_Footers"
              (\ o ->
                 Document_Footers Core.<$> (Core.parseJSONObject o))
...
newDocument_Footnotes 
    ::  Core.HashMap Core.Text Footnote
       -- ^  See 'additional'.
    -> Document_Footnotes
newDocument_Footnotes additional = Document_Footnotes {additional = additional}

instance Core.FromJSON Document_Footnotes where
        parseJSON
          = Core.withObject "Document_Footnotes"
              (\ o ->
                 Document_Footnotes Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Document_Footnotes where
        toJSON Document_Footnotes{..}
          = Core.toJSON additional
...
newDocument_Headers 
    ::  Core.HashMap Core.Text Header
       -- ^  See 'additional'.
    -> Document_Headers
newDocument_Headers additional = Document_Headers {additional = additional}

instance Core.FromJSON Document_Headers where
        parseJSON
          = Core.withObject "Document_Headers"
              (\ o ->
                 Document_Headers Core.<$> (Core.parseJSONObject o))
...
instance Core.FromJSON Document_InlineObjects where
        parseJSON
          = Core.withObject "Document_InlineObjects"
              (\ o ->
                 Document_InlineObjects Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Document_InlineObjects where
        toJSON Document_InlineObjects{..}
          = Core.toJSON additional
...
newDocument_Lists 
    ::  Core.HashMap Core.Text List
       -- ^  See 'additional'.
    -> Document_Lists
newDocument_Lists additional = Document_Lists {additional = additional}

instance Core.FromJSON Document_Lists where
        parseJSON
          = Core.withObject "Document_Lists"
              (\ o ->
                 Document_Lists Core.<$> (Core.parseJSONObject o))
...
instance Core.FromJSON Document_NamedRanges where
        parseJSON
          = Core.withObject "Document_NamedRanges"
              (\ o ->
                 Document_NamedRanges Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Document_NamedRanges where
        toJSON Document_NamedRanges{..}
          = Core.toJSON additional
...
instance Core.FromJSON Document_PositionedObjects
         where
        parseJSON
          = Core.withObject "Document_PositionedObjects"
              (\ o ->
                 Document_PositionedObjects Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Document_PositionedObjects where
        toJSON Document_PositionedObjects{..}
          = Core.toJSON additional
...
instance Core.FromJSON DocumentStyle where
        parseJSON
          = Core.withObject "DocumentStyle"
              (\ o ->
                 DocumentStyle Core.<$>
                   (o Core..:? "background") Core.<*>
                     (o Core..:? "defaultFooterId")
          ...
          = Core.object
              (Core.catMaybes
                 [("background" Core..=) Core.<$> background,
                  ...
                  ("evenPageFooterId" Core..=) Core.<$>
                    evenPageFooterId,
                  ("evenPageHeaderId" Core..=) Core.<$>
                    evenPageHeaderId,
                  ("firstPageFooterId" Core..=) Core.<$>
                    firstPageFooterId,
                  ("firstPageHeaderId" Core..=) Core.<$>
                    firstPageHeaderId,
...
newDocumentStyleSuggestionState =
  DocumentStyleSuggestionState
    { backgroundSuggestionState = Core.Nothing
...
instance Core.FromJSON DocumentStyleSuggestionState
         where
        parseJSON
              ...
              (\ o ->
                 DocumentStyleSuggestionState Core.<$>
                   (o Core..:? "backgroundSuggestionState") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "useCustomHeaderFooterMarginsSuggested")
                     Core.<*>
                     (o Core..:? "useEvenPageHeaderFooterSuggested")
                     Core.<*>
                     (o Core..:? "useFirstPageHeaderFooterSuggested"))
          ...
          = Core.object
              (Core.catMaybes
                 [("backgroundSuggestionState" Core..=) Core.<$>
                  ...
                  ("marginBottomSuggested" Core..=) Core.<$>
                    marginBottomSuggested,
                  ("marginFooterSuggested" Core..=) Core.<$>
                    marginFooterSuggested,
                  ("marginHeaderSuggested" Core..=) Core.<$>
                    marginHeaderSuggested,
                  ("marginLeftSuggested" Core..=) Core.<$>
                    marginLeftSuggested,
                  ("marginRightSuggested" Core..=) Core.<$>
                    marginRightSuggested,
                  ("marginTopSuggested" Core..=) Core.<$>
                    marginTopSuggested,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "EmbeddedDrawingPropertiesSuggestionState"
              (\ o ->
                 Core.pure EmbeddedDrawingPropertiesSuggestionState)
              ...
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("embeddedDrawingProperties" Core..=) Core.<$>
                    embeddedDrawingProperties,
                  ("embeddedObjectBorder" Core..=) Core.<$>
                    embeddedObjectBorder,
                  ("imageProperties" Core..=) Core.<$> imageProperties,
                  ("linkedContentReference" Core..=) Core.<$>
                    linkedContentReference,
                  ("marginBottom" Core..=) Core.<$> marginBottom,
                  ("marginLeft" Core..=) Core.<$> marginLeft,
                  ("marginRight" Core..=) Core.<$> marginRight,
          ...
          = Core.object
              (Core.catMaybes
                 [("colorSuggested" Core..=) Core.<$> colorSuggested,
                  ("dashStyleSuggested" Core..=) Core.<$>
                    dashStyleSuggested,
                  ("propertyStateSuggested" Core..=) Core.<$>
...
newEmbeddedObjectSuggestionState =
  EmbeddedObjectSuggestionState
    { descriptionSuggested = Core.Nothing
...
instance Core.FromJSON EmbeddedObjectSuggestionState
         where
        parseJSON
                 ...
                 EmbeddedObjectSuggestionState Core.<$>
                   (o Core..:? "descriptionSuggested") Core.<*>
                     (o Core..:?
                        "embeddedDrawingPropertiesSuggestionState")
                     Core.<*>
                     (o Core..:? "embeddedObjectBorderSuggestionState")
                     Core.<*>
                     (o Core..:? "imagePropertiesSuggestionState")
                     Core.<*>
                     (o Core..:? "linkedContentReferenceSuggestionState")
                     Core.<*> (o Core..:? "marginBottomSuggested")
                     Core.<*> (o Core..:? "marginLeftSuggested")
                     Core.<*> (o Core..:? "marginRightSuggested")
                     Core.<*> (o Core..:? "marginTopSuggested")
...
instance Core.ToJSON EmbeddedObjectSuggestionState
         where
        toJSON EmbeddedObjectSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("descriptionSuggested" Core..=) Core.<$>
...
newtype EndOfSegmentLocation = EndOfSegmentLocation
    {
...
newEndOfSegmentLocation 
    ::  EndOfSegmentLocation
newEndOfSegmentLocation = EndOfSegmentLocation {segmentId = Core.Nothing}
...
newEquation =
  Equation
    {suggestedDeletionIds = Core.Nothing, suggestedInsertionIds = Core.Nothing}
...
newFootnote 
    ::  Footnote
newFootnote = Footnote {content = Core.Nothing, footnoteId = Core.Nothing}
          ...
          = Core.withObject "FootnoteReference"
              (\ o ->
                 FootnoteReference Core.<$>
                   (o Core..:? "footnoteId") Core.<*>
                     (o Core..:? "footnoteNumber")
...
newFootnoteReference_SuggestedTextStyleChanges additional =
  FootnoteReference_SuggestedTextStyleChanges {additional = additional}
...
instance Core.FromJSON ImagePropertiesSuggestionState
         where
        parseJSON
...
instance Core.ToJSON ImagePropertiesSuggestionState
         where
        toJSON ImagePropertiesSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("angleSuggested" Core..=) Core.<$> angleSuggested,
                  ("brightnessSuggested" Core..=) Core.<$>
                    brightnessSuggested,
                  ("contentUriSuggested" Core..=) Core.<$>
                    contentUriSuggested,
                  ("contrastSuggested" Core..=) Core.<$>
                    contrastSuggested,
                  ("cropPropertiesSuggestionState" Core..=) Core.<$>
                    cropPropertiesSuggestionState,
                  ("sourceUriSuggested" Core..=) Core.<$>
                    sourceUriSuggested,
                  ("transparencySuggested" Core..=) Core.<$>
              ...
              (\ o ->
                 InlineObject Core.<$>
                   (o Core..:? "inlineObjectProperties") Core.<*>
                     ...
                     Core.<*> (o Core..:? "suggestedDeletionIds")
                     Core.<*>
                     (o Core..:? "suggestedInlineObjectPropertiesChanges")
          ...
          = Core.object
              (Core.catMaybes
                 [("inlineObjectProperties" Core..=) Core.<$>
                  ...
                  ("suggestedInsertionId" Core..=) Core.<$>
...
newInlineObject_SuggestedInlineObjectPropertiesChanges 
    ::  Core.HashMap Core.Text SuggestedInlineObjectProperties
       -- ^  See 'additional'.
    -> InlineObject_SuggestedInlineObjectPropertiesChanges
newInlineObject_SuggestedInlineObjectPropertiesChanges additional =
  InlineObject_SuggestedInlineObjectPropertiesChanges {additional = additional}
...
newInlineObjectElement_SuggestedTextStyleChanges additional =
  InlineObjectElement_SuggestedTextStyleChanges {additional = additional}
...
newInlineObjectPropertiesSuggestionState =
  InlineObjectPropertiesSuggestionState
    {embeddedObjectSuggestionState = Core.Nothing}
...
instance Core.FromJSON InsertInlineImageResponse
         where
        parseJSON
          = Core.withObject "InsertInlineImageResponse"
              (\ o ->
                 InsertInlineImageResponse Core.<$>
                   (o Core..:? "objectId"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "InsertInlineSheetsChartResponse"
              (\ o ->
                 InsertInlineSheetsChartResponse Core.<$>
                   (o Core..:? "objectId"))

instance Core.ToJSON InsertInlineSheetsChartResponse
         where
...
instance Core.FromJSON InsertSectionBreakRequest
         where
        parseJSON
...
newInsertTableColumnRequest =
  InsertTableColumnRequest
    {insertRight = Core.Nothing, tableCellLocation = Core.Nothing}
...
newInsertTableRowRequest =
  InsertTableRowRequest
    {insertBelow = Core.Nothing, tableCellLocation = Core.Nothing}
...
newLink 
    ::  Link
newLink =
  Link {bookmarkId = Core.Nothing, headingId = Core.Nothing, url = Core.Nothing}
...
instance Core.ToJSON LinkedContentReference where
        toJSON LinkedContentReference{..}
          = Core.object
              (Core.catMaybes
                 [("sheetsChartReference" Core..=) Core.<$>
                    sheetsChartReference])
...
newLinkedContentReferenceSuggestionState =
  LinkedContentReferenceSuggestionState
    {sheetsChartReferenceSuggestionState = Core.Nothing}
              ...
              (\ o ->
                 List Core.<$>
                   (o Core..:? "listProperties") Core.<*>
                     ...
                     Core.<*> (o Core..:? "suggestedInsertionId")
                     Core.<*>
                     (o Core..:? "suggestedListPropertiesChanges"))
...
newListPropertiesSuggestionState 
    ::  ListPropertiesSuggestionState
newListPropertiesSuggestionState =
  ListPropertiesSuggestionState {nestingLevelsSuggestionStates = Core.Nothing}

instance Core.FromJSON ListPropertiesSuggestionState
         where
        parseJSON
...
instance Core.ToJSON ListPropertiesSuggestionState
         where
...
newLocation 
    ::  Location
newLocation = Location {index = Core.Nothing, segmentId = Core.Nothing}
...
newMergeTableCellsRequest 
    ::  MergeTableCellsRequest
newMergeTableCellsRequest = MergeTableCellsRequest {tableRange = Core.Nothing}

instance Core.FromJSON MergeTableCellsRequest where
        parseJSON
          = Core.withObject "MergeTableCellsRequest"
              (\ o ->
                 MergeTableCellsRequest Core.<$>
                   (o Core..:? "tableRange"))
...
newNamedRange =
  NamedRange
    {name = Core.Nothing, namedRangeId = Core.Nothing, ranges = Core.Nothing}
...
newNamedRanges 
    ::  NamedRanges
newNamedRanges = NamedRanges {name = Core.Nothing, namedRanges = Core.Nothing}
...
instance Core.FromJSON NamedStyleSuggestionState
         where
        parseJSON
...
instance Core.ToJSON NamedStyles where
        toJSON NamedStyles{..}
          = Core.object
              (Core.catMaybes [("styles" Core..=) Core.<$> styles])
...
instance Core.FromJSON NamedStylesSuggestionState
         where
        parseJSON
...
newNestingLevelSuggestionState =
  NestingLevelSuggestionState
    { bulletAlignmentSuggested = Core.Nothing
...
instance Core.FromJSON NestingLevelSuggestionState
         where
        parseJSON
...
instance Core.ToJSON NestingLevelSuggestionState
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("bulletAlignmentSuggested" Core..=) Core.<$>
                  ...
                  ("glyphFormatSuggested" Core..=) Core.<$>
                    glyphFormatSuggested,
                  ("glyphSymbolSuggested" Core..=) Core.<$>
                    glyphSymbolSuggested,
                  ("glyphTypeSuggested" Core..=) Core.<$>
                    glyphTypeSuggested,
                  ("indentFirstLineSuggested" Core..=) Core.<$>
                    indentFirstLineSuggested,
                  ("indentStartSuggested" Core..=) Core.<$>
                    indentStartSuggested,
                  ("startNumberSuggested" Core..=) Core.<$>
              ...
              (\ o ->
                 Paragraph Core.<$>
                   (o Core..:? "bullet") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "suggestedParagraphStyleChanges")
          ...
          = Core.object
              (Core.catMaybes
                 [("bullet" Core..=) Core.<$> bullet,
                  ...
                  ("paragraphStyle" Core..=) Core.<$> paragraphStyle,
                  ("positionedObjectIds" Core..=) Core.<$>
                    positionedObjectIds,
                  ("suggestedBulletChanges" Core..=) Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "Paragraph_SuggestedBulletChanges"
              (\ o ->
                 Paragraph_SuggestedBulletChanges Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Paragraph_SuggestedBulletChanges
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("autoText" Core..=) Core.<$> autoText,
                  ...
                  ("footnoteReference" Core..=) Core.<$>
                    footnoteReference,
                  ("horizontalRule" Core..=) Core.<$> horizontalRule,
                  ("inlineObjectElement" Core..=) Core.<$>
                    inlineObjectElement,
...
instance Core.FromJSON ParagraphStyleSuggestionState
         where
        parseJSON
...
instance Core.ToJSON ParagraphStyleSuggestionState
         where
        toJSON ParagraphStyleSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("alignmentSuggested" Core..=) Core.<$>
                    alignmentSuggested,
                  ("avoidWidowAndOrphanSuggested" Core..=) Core.<$>
                    avoidWidowAndOrphanSuggested,
                  ("borderBetweenSuggested" Core..=) Core.<$>
                    borderBetweenSuggested,
                  ("borderBottomSuggested" Core..=) Core.<$>
                    borderBottomSuggested,
                  ("borderLeftSuggested" Core..=) Core.<$>
                    borderLeftSuggested,
                  ("borderRightSuggested" Core..=) Core.<$>
                    borderRightSuggested,
                  ("borderTopSuggested" Core..=) Core.<$>
                    borderTopSuggested,
                  ("directionSuggested" Core..=) Core.<$>
                    directionSuggested,
                  ("headingIdSuggested" Core..=) Core.<$>
                    headingIdSuggested,
                  ("indentEndSuggested" Core..=) Core.<$>
                    indentEndSuggested,
                  ("indentFirstLineSuggested" Core..=) Core.<$>
                    indentFirstLineSuggested,
                  ("indentStartSuggested" Core..=) Core.<$>
                  ...
                  ("keepWithNextSuggested" Core..=) Core.<$>
                    keepWithNextSuggested,
                  ("lineSpacingSuggested" Core..=) Core.<$>
                    lineSpacingSuggested,
                  ("namedStyleTypeSuggested" Core..=) Core.<$>
                    namedStyleTypeSuggested,
                  ("pageBreakBeforeSuggested" Core..=) Core.<$>
                    pageBreakBeforeSuggested,
                  ("shadingSuggestionState" Core..=) Core.<$>
                    shadingSuggestionState,
                  ("spaceAboveSuggested" Core..=) Core.<$>
                    spaceAboveSuggested,
                  ("spaceBelowSuggested" Core..=) Core.<$>
                    spaceBelowSuggested,
                  ("spacingModeSuggested" Core..=) Core.<$>
...
instance Core.FromJSON Person where
        parseJSON
          = Core.withObject "Person"
              (\ o ->
                 Person Core.<$>
                   (o Core..:? "personId") Core.<*>
                     (o Core..:? "personProperties")
                     Core.<*> (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds")
                     Core.<*> (o Core..:? "suggestedTextStyleChanges")
                     Core.<*> (o Core..:? "textStyle"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "Person_SuggestedTextStyleChanges"
              (\ o ->
                 Person_SuggestedTextStyleChanges Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Person_SuggestedTextStyleChanges
         where
...
newPinTableHeaderRowsRequest =
  PinTableHeaderRowsRequest
    {pinnedHeaderRowsCount = Core.Nothing, tableStartLocation = Core.Nothing}

instance Core.FromJSON PinTableHeaderRowsRequest
         where
        parseJSON
...
instance Core.ToJSON PinTableHeaderRowsRequest where
        toJSON PinTableHeaderRowsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("pinnedHeaderRowsCount" Core..=) Core.<$>
                    pinnedHeaderRowsCount,
                  ("tableStartLocation" Core..=) Core.<$>
                    tableStartLocation])
...
newPositionedObject_SuggestedPositionedObjectPropertiesChanges 
    ::  Core.HashMap Core.Text SuggestedPositionedObjectProperties
       -- ^  See 'additional'.
    -> PositionedObject_SuggestedPositionedObjectPropertiesChanges
newPositionedObject_SuggestedPositionedObjectPropertiesChanges additional =
  PositionedObject_SuggestedPositionedObjectPropertiesChanges
...
newPositionedObjectPositioning =
  PositionedObjectPositioning
    {layout = Core.Nothing, leftOffset = Core.Nothing, topOffset = Core.Nothing}

instance Core.FromJSON PositionedObjectPositioning
         where
        parseJSON
...
instance Core.ToJSON PositionedObjectPositioning
         where
...
instance Core.ToJSON
        ...
        toJSON PositionedObjectPositioningSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("layoutSuggested" Core..=) Core.<$>
                    layoutSuggested,
                  ("leftOffsetSuggested" Core..=) Core.<$>
                    leftOffsetSuggested,
                  ("topOffsetSuggested" Core..=) Core.<$>
                    topOffsetSuggested])
...
newPositionedObjectProperties =
  PositionedObjectProperties
    {embeddedObject = Core.Nothing, positioning = Core.Nothing}

instance Core.FromJSON PositionedObjectProperties
         where
        parseJSON
          = Core.withObject "PositionedObjectProperties"
              (\ o ->
                 PositionedObjectProperties Core.<$>
                   (o Core..:? "embeddedObject") Core.<*>
                     (o Core..:? "positioning"))
...
newReplaceAllTextRequest =
  ReplaceAllTextRequest
    {containsText = Core.Nothing, replaceText = Core.Nothing}
          ...
          = Core.withObject "ReplaceNamedRangeContentRequest"
              (\ o ->
                 ReplaceNamedRangeContentRequest Core.<$>
                   (o Core..:? "namedRangeId") Core.<*>
                     (o Core..:? "namedRangeName")
                     Core.<*> (o Core..:? "text"))

instance Core.ToJSON ReplaceNamedRangeContentRequest
         where
...
instance Core.FromJSON Request' where
        parseJSON
          = Core.withObject "Request'"
              (\ o ->
                 Request' Core.<$>
                   (o Core..:? "createFooter") Core.<*>
                     (o Core..:? "createFootnote")
...
newRichLinkProperties =
  RichLinkProperties
    {mimeType = Core.Nothing, title = Core.Nothing, uri = Core.Nothing}
          ...
          = Core.withObject "RichLinkProperties"
              (\ o ->
                 RichLinkProperties Core.<$>
                   (o Core..:? "mimeType") Core.<*> (o Core..:? "title")
                     Core.<*> (o Core..:? "uri"))
...
newSectionColumnProperties 
    ::  SectionColumnProperties
newSectionColumnProperties =
  SectionColumnProperties {paddingEnd = Core.Nothing, width = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("columnProperties" Core..=) Core.<$>
                    columnProperties,
                  ("columnSeparatorStyle" Core..=) Core.<$>
                    columnSeparatorStyle,
                  ("contentDirection" Core..=) Core.<$>
                    contentDirection,
                  ("defaultFooterId" Core..=) Core.<$> defaultFooterId,
                  ("defaultHeaderId" Core..=) Core.<$> defaultHeaderId,
                  ("evenPageFooterId" Core..=) Core.<$>
...
instance Core.FromJSON Shading where
        parseJSON
          = Core.withObject "Shading"
              (\ o ->
                 Shading Core.<$> (o Core..:? "backgroundColor"))
...
newSheetsChartReference 
    ::  SheetsChartReference
newSheetsChartReference =
  SheetsChartReference {chartId = Core.Nothing, spreadsheetId = Core.Nothing}
...
newSheetsChartReferenceSuggestionState =
  SheetsChartReferenceSuggestionState
    {chartIdSuggested = Core.Nothing, spreadsheetIdSuggested = Core.Nothing}
...
instance Core.FromJSON Size where
        parseJSON
          = Core.withObject "Size"
              (\ o ->
                 Size Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "width"))
...
newSizeSuggestionState =
  SizeSuggestionState
    {heightSuggested = Core.Nothing, widthSuggested = Core.Nothing}
...
newSuggestedBullet 
    ::  SuggestedBullet
newSuggestedBullet =
  SuggestedBullet {bullet = Core.Nothing, bulletSuggestionState = Core.Nothing}
...
instance Core.ToJSON SuggestedBullet where
        toJSON SuggestedBullet{..}
          = Core.object
              (Core.catMaybes
                 [("bullet" Core..=) Core.<$> bullet,
                  ("bulletSuggestionState" Core..=) Core.<$>
                    bulletSuggestionState])
...
newSuggestedDocumentStyle =
  SuggestedDocumentStyle
    {documentStyle = Core.Nothing, documentStyleSuggestionState = Core.Nothing}
...
instance Core.ToJSON SuggestedInlineObjectProperties
         where
...
newSuggestedNamedStyles =
  SuggestedNamedStyles
    {namedStyles = Core.Nothing, namedStylesSuggestionState = Core.Nothing}
...
newSuggestedTableRowStyle =
  SuggestedTableRowStyle
    {tableRowStyle = Core.Nothing, tableRowStyleSuggestionState = Core.Nothing}
...
newSuggestedTextStyle =
  SuggestedTextStyle
    {textStyle = Core.Nothing, textStyleSuggestionState = Core.Nothing}
...
newTabStop 
    ::  TabStop
newTabStop = TabStop {alignment = Core.Nothing, offset = Core.Nothing}
...
instance Core.FromJSON Table where
        parseJSON
          = Core.withObject "Table"
              (\ o ->
                 Table Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "rows")
                     Core.<*> (o Core..:? "suggestedDeletionIds")
                     Core.<*> (o Core..:? "suggestedInsertionIds")
              ...
              (\ o ->
                 TableCell Core.<$>
                   (o Core..:? "content") Core.<*>
                     ...
                     Core.<*> (o Core..:? "suggestedInsertionIds")
                     Core.<*>
                     (o Core..:? "suggestedTableCellStyleChanges")
...
newTableCellBorder =
  TableCellBorder
    {color = Core.Nothing, dashStyle = Core.Nothing, width = Core.Nothing}
...
instance Core.FromJSON TableCellStyleSuggestionState
         where
        parseJSON
...
instance Core.ToJSON TableCellStyleSuggestionState
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("backgroundColorSuggested" Core..=) Core.<$>
                  ...
                  ("borderTopSuggested" Core..=) Core.<$>
                    borderTopSuggested,
                  ("columnSpanSuggested" Core..=) Core.<$>
                    columnSpanSuggested,
                  ("contentAlignmentSuggested" Core..=) Core.<$>
                    contentAlignmentSuggested,
                  ("paddingBottomSuggested" Core..=) Core.<$>
                    paddingBottomSuggested,
                  ("paddingLeftSuggested" Core..=) Core.<$>
                    paddingLeftSuggested,
                  ("paddingRightSuggested" Core..=) Core.<$>
                    paddingRightSuggested,
                  ("paddingTopSuggested" Core..=) Core.<$>
                    paddingTopSuggested,
                  ("rowSpanSuggested" Core..=) Core.<$>
                    rowSpanSuggested])
...
newTableColumnProperties 
    ::  TableColumnProperties
newTableColumnProperties =
  TableColumnProperties {width = Core.Nothing, widthType = Core.Nothing}
...
instance Core.FromJSON TableRowStyle where
        parseJSON
          = Core.withObject "TableRowStyle"
              (\ o ->
                 TableRowStyle Core.<$>
                   (o Core..:? "minRowHeight") Core.<*>
                     (o Core..:? "preventOverflow")
...
newTableRowStyleSuggestionState 
    ::  TableRowStyleSuggestionState
newTableRowStyleSuggestionState =
  TableRowStyleSuggestionState {minRowHeightSuggested = Core.Nothing}

instance Core.FromJSON TableRowStyleSuggestionState
         where
        parseJSON
...
instance Core.ToJSON TableRowStyleSuggestionState
         where
        toJSON TableRowStyleSuggestionState{..}
          = Core.object
              (Core.catMaybes
                 [("minRowHeightSuggested" Core..=) Core.<$>
...
instance Core.FromJSON TableStyle where
        parseJSON
          = Core.withObject "TableStyle"
              (\ o ->
                 TableStyle Core.<$>
                   (o Core..:? "tableColumnProperties"))

instance Core.ToJSON TableStyle where
        toJSON TableStyle{..}
          = Core.object
              (Core.catMaybes
                 [("tableColumnProperties" Core..=) Core.<$>
                    tableColumnProperties])
...
newUpdateDocumentStyleRequest =
  UpdateDocumentStyleRequest
    {documentStyle = Core.Nothing, fields = Core.Nothing}

instance Core.FromJSON UpdateDocumentStyleRequest
         where
        parseJSON
...
newUpdateParagraphStyleRequest =
  UpdateParagraphStyleRequest
    {fields = Core.Nothing, paragraphStyle = Core.Nothing, range = Core.Nothing}

instance Core.FromJSON UpdateParagraphStyleRequest
         where
        parseJSON
...
instance Core.ToJSON UpdateParagraphStyleRequest
         where
...
newUpdateSectionStyleRequest =
  UpdateSectionStyleRequest
    {fields = Core.Nothing, range = Core.Nothing, sectionStyle = Core.Nothing}

instance Core.FromJSON UpdateSectionStyleRequest
         where
        parseJSON
...
instance Core.FromJSON UpdateTableCellStyleRequest
         where
        parseJSON
          = Core.withObject "UpdateTableCellStyleRequest"
              (\ o ->
                 UpdateTableCellStyleRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "tableCellStyle")
                     Core.<*> (o Core..:? "tableRange")
                     Core.<*> (o Core..:? "tableStartLocation"))

instance Core.ToJSON UpdateTableCellStyleRequest
         where
...
instance Core.FromJSON UpdateTableRowStyleRequest
         where
        parseJSON
...
newUpdateTextStyleRequest =
  UpdateTextStyleRequest
    {fields = Core.Nothing, range = Core.Nothing, textStyle = Core.Nothing}
...
newWriteControl =
  WriteControl
    {requiredRevisionId = Core.Nothing, targetRevisionId = Core.Nothing}
...
instance Core.ToJSON WriteControl where
        toJSON WriteControl{..}
          = Core.object
              (Core.catMaybes
                 [("requiredRevisionId" Core..=) Core.<$>
                    requiredRevisionId,
                  ("targetRevisionId" Core..=) Core.<$>
                    targetRevisionId])
