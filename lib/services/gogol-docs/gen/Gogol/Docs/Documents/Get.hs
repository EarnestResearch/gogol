...
type DocsDocumentsGetResource =
     "v1" Core.:>
       "documents" Core.:>
         Core.Capture "documentId" Core.Text Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "suggestionsViewMode"
...
instance Core.GoogleRequest DocsDocumentsGet where
        ...
        type Scopes DocsDocumentsGet =
             '[Documents'FullControl, Documents'Readonly,
               Drive'FullControl, Drive'File, Drive'Readonly]
        requestClient DocsDocumentsGet{..}
          = go documentId xgafv accessToken callback
              suggestionsViewMode
              uploadType
              uploadProtocol
