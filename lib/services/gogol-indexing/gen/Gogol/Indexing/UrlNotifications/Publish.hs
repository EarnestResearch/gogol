               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UrlNotification Core.:>
                       Core.Post '[Core.JSON] PublishUrlNotificationResponse
...
instance Core.GoogleRequest
           IndexingUrlNotificationsPublish
         where
        type Rs IndexingUrlNotificationsPublish =
             PublishUrlNotificationResponse
        type Scopes IndexingUrlNotificationsPublish =
