                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "url" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] UrlNotificationMetadata
...
instance Core.GoogleRequest
           IndexingUrlNotificationsGetMetadata
         where
        type Rs IndexingUrlNotificationsGetMetadata =
             UrlNotificationMetadata
        type Scopes IndexingUrlNotificationsGetMetadata =
