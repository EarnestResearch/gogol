                 ...
                 Availability Core.<$>
                   (o Core..:? "advertiserId" Core.<&>
                     ...
                     (o Core..:? "agencyId" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "availabilityTimestamp" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "customerId")
                     Core.<*>
                     (o Core..:? "segmentationId" Core.<&>
                        Core.fmap Core.fromAsText)
              ...
              (Core.catMaybes
                 [("advertiserId" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("segmentationId" Core..=) Core.. Core.AsText
                    Core.<$> segmentationId,
                  ("segmentationName" Core..=) Core.<$>
                    segmentationName,
                  ("segmentationType" Core..=) Core.<$>
                    segmentationType])
              ...
              (\ o ->
                 Conversion Core.<$>
                   (o Core..:? "adGroupId" Core.<&>
                     ...
                     Core.<*>
                     (o Core..:? "conversionModifiedTimestamp" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "conversionTimestamp")
                     Core.<*>
                     (o Core..:? "countMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "dsConversionId" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "engineAccountId" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "floodlightOrderId")
                     Core.<*>
                     (o Core..:? "inventoryAccountId" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "productCountry")
                     Core.<*>
                     (o Core..:? "productGroupId" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "productLanguage")
                     Core.<*>
                     (o Core..:? "quantityMillis" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON Conversion where
        toJSON Conversion{..}
          = Core.object
              (Core.catMaybes
                 [("adGroupId" Core..=) Core.. Core.AsText Core.<$>
                    adGroupId,
                  ...
                  ("conversionModifiedTimestamp" Core..=) Core..
                    Core.AsText
                    Core.<$> conversionModifiedTimestamp,
                  ("conversionTimestamp" Core..=) Core.<$>
                    conversionTimestamp,
                  ("countMillis" Core..=) Core.. Core.AsText Core.<$>
                    countMillis,
                  ("criterionId" Core..=) Core.. Core.AsText Core.<$>
                    criterionId,
...
instance Core.FromJSON ConversionList where
        parseJSON
          = Core.withObject "ConversionList"
              (\ o ->
                 ConversionList Core.<$>
...
instance Core.FromJSON CustomDimension where
        parseJSON
          = Core.withObject "CustomDimension"
              (\ o ->
                 CustomDimension Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("files" Core..=) Core.<$> files,
                  ...
                  ("rows" Core..=) Core.<$> rows,
                  ("statisticsCurrencyCode" Core..=) Core.<$>
                    statisticsCurrencyCode,
                  ("statisticsTimeZone" Core..=) Core.<$>
                    statisticsTimeZone])
...
instance Core.FromJSON Report_FilesItem where
        parseJSON
          = Core.withObject "Report_FilesItem"
              (\ o ->
                 Report_FilesItem Core.<$>
...
instance Core.FromJSON ReportApiColumnSpec where
        parseJSON
          = Core.withObject "ReportApiColumnSpec"
              (\ o ->
                 ReportApiColumnSpec Core.<$>
                   (o Core..:? "columnName") Core.<*>
                     (o Core..:? "customDimensionName")
          ...
          = Core.object
              (Core.catMaybes
                 [("columnName" Core..=) Core.<$> columnName,
                  ("customDimensionName" Core..=) Core.<$>
                    customDimensionName,
                  ("customMetricName" Core..=) Core.<$>
                    customMetricName,
                  ...
                  ("productReportPerspective" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("columns" Core..=) Core.<$> columns,
                  ...
                  ("includeDeletedEntities" Core..=) Core.<$>
                    includeDeletedEntities,
                  ("includeRemovedEntities" Core..=) Core.<$>
                  ...
                  ("statisticsCurrency" Core..=) Core.<$>
                    statisticsCurrency,
                  ("timeRange" Core..=) Core.<$> timeRange,
                  ("verifySingleTimeZone" Core..=) Core.<$>
...
newReportRequest_FiltersItem =
  ReportRequest_FiltersItem
    {column = Core.Nothing, operator = Core.Nothing, values = Core.Nothing}

instance Core.FromJSON ReportRequest_FiltersItem
         where
        parseJSON
          = Core.withObject "ReportRequest_FiltersItem"
              (\ o ->
                 ReportRequest_FiltersItem Core.<$>
                   (o Core..:? "column") Core.<*>
                     (o Core..:? "operator")
                     Core.<*> (o Core..:? "values"))
...
instance Core.FromJSON ReportRequest_OrderByItem
         where
        parseJSON
          = Core.withObject "ReportRequest_OrderByItem"
              (\ o ->
                 ReportRequest_OrderByItem Core.<$>
                   (o Core..:? "column") Core.<*>
                     (o Core..:? "sortOrder"))
...
instance Core.FromJSON ReportRequest_ReportScope
         where
        parseJSON
          = Core.withObject "ReportRequest_ReportScope"
              (\ o ->
                 ReportRequest_ReportScope Core.<$>
                   (o Core..:? "adGroupId" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "adId" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("adGroupId" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("engineAccountId" Core..=) Core.. Core.AsText
                    Core.<$> engineAccountId,
                  ("keywordId" Core..=) Core.. Core.AsText Core.<$>
                    keywordId])
...
instance Core.FromJSON ReportRequest_TimeRange where
        parseJSON
          = Core.withObject "ReportRequest_TimeRange"
              (\ o ->
                 ReportRequest_TimeRange Core.<$>
                   (o Core..:? "changedAttributesSinceTimestamp")
...
instance Core.ToJSON ReportRequest_TimeRange where
        toJSON ReportRequest_TimeRange{..}
          = Core.object
              (Core.catMaybes
                 [("changedAttributesSinceTimestamp" Core..=) Core.<$>
                    changedAttributesSinceTimestamp,
                  ("changedMetricsSinceTimestamp" Core..=) Core.<$>
...
newSavedColumn =
  SavedColumn
    {kind = Core.Nothing, savedColumnName = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON SavedColumn where
        parseJSON
          = Core.withObject "SavedColumn"
              (\ o ->
                 SavedColumn Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "savedColumnName")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON SavedColumnList where
        parseJSON
          = Core.withObject "SavedColumnList"
              (\ o ->
                 SavedColumnList Core.<$>
...
instance Core.FromJSON UpdateAvailabilityRequest
         where
        parseJSON
          = Core.withObject "UpdateAvailabilityRequest"
              (\ o ->
                 UpdateAvailabilityRequest Core.<$>
                   (o Core..:? "availabilities"))
...
instance Core.FromJSON UpdateAvailabilityResponse
         where
        parseJSON
          = Core.withObject "UpdateAvailabilityResponse"
              (\ o ->
                 UpdateAvailabilityResponse Core.<$>
                   (o Core..:? "availabilities"))
