...
instance Core.FromJSON AdministratorWebTokenSpec
         where
        parseJSON
          = Core.withObject "AdministratorWebTokenSpec"
              (\ o ->
                 AdministratorWebTokenSpec Core.<$>
                   (o Core..:? "managedConfigurations") Core.<*>
                     (o Core..:? "parent")
...
instance Core.ToJSON AdministratorWebTokenSpec where
        toJSON AdministratorWebTokenSpec{..}
          = Core.object
              (Core.catMaybes
                 [("managedConfigurations" Core..=) Core.<$>
...
newAdministratorWebTokenSpecPlaySearch =
  AdministratorWebTokenSpecPlaySearch
    {approveApps = Core.Nothing, enabled = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "AdministratorWebTokenSpecWebApps"
              (\ o ->
                 AdministratorWebTokenSpecWebApps Core.<$>
                   (o Core..:? "enabled"))

instance Core.ToJSON AdministratorWebTokenSpecWebApps
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "AdministratorWebTokenSpecZeroTouch"
              (\ o ->
                 AdministratorWebTokenSpecZeroTouch Core.<$>
                   (o Core..:? "enabled"))
...
instance Core.ToJSON AppRestrictionsSchemaChangeEvent
         where
...
instance Core.ToJSON AppRestrictionsSchemaRestriction
         where
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 AppRestrictionsSchemaRestrictionRestrictionValue
                   Core.<$>
                   (o Core..:? "type") Core.<*> (o Core..:? "valueBool")
          ...
          = Core.object
              (Core.catMaybes
                 [("chargingStateConstraint" Core..=) Core.<$>
                  ...
                  ("networkTypeConstraint" Core..=) Core.<$>
...
instance Core.ToJSON AutoInstallPolicy where
        toJSON AutoInstallPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("autoInstallConstraint" Core..=) Core.<$>
                    autoInstallConstraint,
                  ("autoInstallMode" Core..=) Core.<$> autoInstallMode,
                  ("autoInstallPriority" Core..=) Core.<$>
                    autoInstallPriority,
...
instance Core.FromJSON CreateEnrollmentTokenResponse
         where
        parseJSON
          = Core.withObject "CreateEnrollmentTokenResponse"
              (\ o ->
                 CreateEnrollmentTokenResponse Core.<$>
                   (o Core..:? "enrollmentToken"))

instance Core.ToJSON CreateEnrollmentTokenResponse
         where
        toJSON CreateEnrollmentTokenResponse{..}
          = Core.object
              (Core.catMaybes
                 [("enrollmentToken" Core..=) Core.<$>
                    enrollmentToken])
          ...
          = Core.object
              (Core.catMaybes
                 [("androidId" Core..=) Core.<$> androidId,
                  ...
                  ("latestBuildFingerprint" Core..=) Core.<$>
...
newDeviceReport =
  DeviceReport
    {appState = Core.Nothing, lastUpdatedTimestampMillis = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("appState" Core..=) Core.<$> appState,
                  ("lastUpdatedTimestampMillis" Core..=) Core..
                    Core.AsText
...
newDeviceReportUpdateEvent =
  DeviceReportUpdateEvent
    {deviceId = Core.Nothing, report = Core.Nothing, userId = Core.Nothing}
...
instance Core.FromJSON Enterprise where
        parseJSON
          = Core.withObject "Enterprise"
              (\ o ->
                 Enterprise Core.<$>
                   (o Core..:? "administrator") Core.<*>
                     (o Core..:? "googleAuthenticationSettings")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "EnterpriseAuthenticationAppLinkConfig"
              (\ o ->
                 EnterpriseAuthenticationAppLinkConfig Core.<$>
                   (o Core..:? "uri"))
...
newEnterprisesSendTestPushNotificationResponse =
  EnterprisesSendTestPushNotificationResponse
    {messageId = Core.Nothing, topicName = Core.Nothing}
...
instance Core.FromJSON GoogleAuthenticationSettings
         where
        parseJSON
...
instance Core.ToJSON GoogleAuthenticationSettings
         where
...
instance Core.FromJSON GroupLicenseUsersListResponse
         where
        parseJSON
          = Core.withObject "GroupLicenseUsersListResponse"
              (\ o ->
                 GroupLicenseUsersListResponse Core.<$>
                   (o Core..:? "user"))

instance Core.ToJSON GroupLicenseUsersListResponse
         where
...
instance Core.FromJSON GroupLicensesListResponse
         where
        parseJSON
          = Core.withObject "GroupLicensesListResponse"
              (\ o ->
                 GroupLicensesListResponse Core.<$>
                   (o Core..:? "groupLicense"))
...
newMaintenanceWindow =
  MaintenanceWindow
    {durationMs = Core.Nothing, startTimeAfterMidnightMs = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("durationMs" Core..=) Core.. Core.AsText Core.<$>
                    durationMs,
                  ("startTimeAfterMidnightMs" Core..=) Core..
                    Core.AsText
...
instance Core.FromJSON ManagedConfigurationsSettings
         where
        parseJSON
...
instance Core.ToJSON ManagedConfigurationsSettings
         where
          ...
          = Core.withObject "ManagedProperty"
              (\ o ->
                 ManagedProperty Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "valueBool")
          ...
          = Core.object
              (Core.catMaybes
                 [("key" Core..=) Core.<$> key,
                  ...
                  ("valueBundleArray" Core..=) Core.<$>
                    valueBundleArray,
                  ("valueInteger" Core..=) Core.<$> valueInteger,
                  ("valueString" Core..=) Core.<$> valueString,
                  ("valueStringArray" Core..=) Core.<$>
                    valueStringArray])
...
instance Core.ToJSON NewPermissionsEvent where
        toJSON NewPermissionsEvent{..}
          = Core.object
              (Core.catMaybes
                 [("approvedPermissions" Core..=) Core.<$>
                    approvedPermissions,
                  ("productId" Core..=) Core.<$> productId,
                  ("requestedPermissions" Core..=) Core.<$>
...
instance Core.FromJSON Notification where
        parseJSON
          = Core.withObject "Notification"
              (\ o ->
                 Notification Core.<$>
                   (o Core..:? "appRestrictionsSchemaChangeEvent")
                     ...
                     Core.<*>
                     (o Core..:? "productAvailabilityChangeEvent")
                     Core.<*>
                     (o Core..:? "timestampMillis" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("appRestrictionsSchemaChangeEvent" Core..=)
                  ...
                  ("installFailureEvent" Core..=) Core.<$>
                    installFailureEvent,
                  ("newDeviceEvent" Core..=) Core.<$> newDeviceEvent',
                  ("newPermissionsEvent" Core..=) Core.<$>
                    newPermissionsEvent',
                  ("notificationType" Core..=) Core.<$>
                    notificationType,
                  ("productApprovalEvent" Core..=) Core.<$>
                    productApprovalEvent,
...
newNotificationSet =
  NotificationSet
    {notification = Core.Nothing, notificationSetId = Core.Nothing}
...
instance Core.ToJSON Policy where
        toJSON Policy{..}
          = Core.object
              (Core.catMaybes
                 [("autoUpdatePolicy" Core..=) Core.<$>
                    autoUpdatePolicy,
                  ("deviceReportPolicy" Core..=) Core.<$>
                    deviceReportPolicy,
...
instance Core.ToJSON Product where
        toJSON Product{..}
          = Core.object
              (Core.catMaybes
                 [("appRestrictionsSchema" Core..=) Core.<$>
                    appRestrictionsSchema,
                  ...
                  ("requiresContainerApp" Core..=) Core.<$>
                    requiresContainerApp,
                  ("screenshotUrls" Core..=) Core.<$> screenshotUrls,
                  ("signingCertificate" Core..=) Core.<$>
                    signingCertificate,
...
newProductAvailabilityChangeEvent =
  ProductAvailabilityChangeEvent
    {availabilityStatus = Core.Nothing, productId = Core.Nothing}

instance Core.FromJSON ProductAvailabilityChangeEvent
         where
        parseJSON
...
instance Core.ToJSON ProductAvailabilityChangeEvent
         where
        toJSON ProductAvailabilityChangeEvent{..}
          = Core.object
              (Core.catMaybes
                 [("availabilityStatus" Core..=) Core.<$>
                    availabilityStatus,
                  ("productId" Core..=) Core.<$> productId])
              ...
              (\ o ->
                 ProductPolicy Core.<$>
                   (o Core..:? "autoInstallPolicy") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "enterpriseAuthenticationAppLinkConfigs")
...
instance Core.ToJSON ProductSet where
        toJSON ProductSet{..}
          = Core.object
              (Core.catMaybes
                 [("productId" Core..=) Core.<$> productId,
                  ("productSetBehavior" Core..=) Core.<$>
                    productSetBehavior,
                  ("productVisibility" Core..=) Core.<$>
                    productVisibility])
...
newProductSigningCertificate =
  ProductSigningCertificate
    {certificateHashSha1 = Core.Nothing, certificateHashSha256 = Core.Nothing}

instance Core.FromJSON ProductSigningCertificate
         where
        parseJSON
...
instance Core.ToJSON ProductSigningCertificate where
        toJSON ProductSigningCertificate{..}
          = Core.object
              (Core.catMaybes
                 [("certificateHashSha1" Core..=) Core.<$>
                    certificateHashSha1,
                  ("certificateHashSha256" Core..=) Core.<$>
...
newProductVisibility =
  ProductVisibility
    {productId = Core.Nothing, trackIds = Core.Nothing, tracks = Core.Nothing}
...
newProductsApproveRequest =
  ProductsApproveRequest
    {approvalUrlInfo = Core.Nothing, approvedPermissions = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ProductsGenerateApprovalUrlResponse"
              (\ o ->
                 ProductsGenerateApprovalUrlResponse Core.<$>
                   (o Core..:? "url"))
...
instance Core.FromJSON ServiceAccountKeysListResponse
         where
        parseJSON
...
instance Core.ToJSON ServiceAccountKeysListResponse
         where
        toJSON ServiceAccountKeysListResponse{..}
          = Core.object
              (Core.catMaybes
                 [("serviceAccountKey" Core..=) Core.<$>
                    serviceAccountKey])
...
newSignupInfo =
  SignupInfo
    {completionToken = Core.Nothing, kind = Core.Nothing, url = Core.Nothing}
...
instance Core.FromJSON StoreLayout where
        parseJSON
          = Core.withObject "StoreLayout"
              (\ o ->
                 StoreLayout Core.<$>
                   (o Core..:? "homepageId") Core.<*>
                     (o Core..:? "storeLayoutType"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "StoreLayoutClustersListResponse"
              (\ o ->
                 StoreLayoutClustersListResponse Core.<$>
                   (o Core..:? "cluster"))

instance Core.ToJSON StoreLayoutClustersListResponse
         where
...
instance Core.FromJSON StoreLayoutPagesListResponse
         where
        parseJSON
          = Core.withObject "StoreLayoutPagesListResponse"
              (\ o ->
                 StoreLayoutPagesListResponse Core.<$>
                   (o Core..:? "page"))

instance Core.ToJSON StoreLayoutPagesListResponse
         where
