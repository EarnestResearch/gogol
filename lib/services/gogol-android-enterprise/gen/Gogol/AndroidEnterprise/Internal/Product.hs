...
-- |
-- Module      : Gogol.AndroidEnterprise.Internal.Product
...
newAdministratorWebToken 
    ::  AdministratorWebToken
newAdministratorWebToken
  = AdministratorWebToken{token = Core.Nothing}
instance Core.FromJSON AdministratorWebToken where
        parseJSON
          = Core.withObject "AdministratorWebToken"
              (\ o -> AdministratorWebToken Core.<$> (o Core..:? "token"))

instance Core.ToJSON AdministratorWebToken where
        toJSON AdministratorWebToken{..}
          = Core.object (Core.catMaybes [("token" Core..=) Core.<$> token])
...
newAdministratorWebTokenSpec 
    ::  AdministratorWebTokenSpec
newAdministratorWebTokenSpec
  = AdministratorWebTokenSpec{managedConfigurations = Core.Nothing,
                              parent = Core.Nothing, permission = Core.Nothing,
                              playSearch = Core.Nothing, privateApps = Core.Nothing,
                              storeBuilder = Core.Nothing, webApps = Core.Nothing,
                              zeroTouch = Core.Nothing}
instance Core.FromJSON AdministratorWebTokenSpec where
        parseJSON
          = Core.withObject "AdministratorWebTokenSpec"
              (\ o ->
                 AdministratorWebTokenSpec Core.<$>
                   (o Core..:? "managedConfigurations") Core.<*> (o Core..:? "parent")
...
instance Core.ToJSON AdministratorWebTokenSpec where
        toJSON AdministratorWebTokenSpec{..}
          = Core.object
              (Core.catMaybes
                 [("managedConfigurations" Core..=) Core.<$> managedConfigurations,
...
newAdministratorWebTokenSpecManagedConfigurations 
    :: 
                                                  AdministratorWebTokenSpecManagedConfigurations
newAdministratorWebTokenSpecManagedConfigurations
  = AdministratorWebTokenSpecManagedConfigurations{enabled =
                                                     Core.Nothing}
instance Core.FromJSON
           AdministratorWebTokenSpecManagedConfigurations
         where
        parseJSON
          = Core.withObject "AdministratorWebTokenSpecManagedConfigurations"
              (\ o ->
                 AdministratorWebTokenSpecManagedConfigurations Core.<$>
                   (o Core..:? "enabled"))

instance Core.ToJSON AdministratorWebTokenSpecManagedConfigurations
         where
        toJSON AdministratorWebTokenSpecManagedConfigurations{..}
          = Core.object
...
newAdministratorWebTokenSpecPlaySearch 
    :: 
                                       AdministratorWebTokenSpecPlaySearch
newAdministratorWebTokenSpecPlaySearch
  = AdministratorWebTokenSpecPlaySearch{approveApps = Core.Nothing,
                                        enabled = Core.Nothing}
instance Core.FromJSON AdministratorWebTokenSpecPlaySearch where
        parseJSON
          = Core.withObject "AdministratorWebTokenSpecPlaySearch"
              (\ o ->
                 AdministratorWebTokenSpecPlaySearch Core.<$>
                   (o Core..:? "approveApps") Core.<*> (o Core..:? "enabled"))

instance Core.ToJSON AdministratorWebTokenSpecPlaySearch where
...
instance Core.FromJSON AdministratorWebTokenSpecPrivateApps where
        parseJSON
          = Core.withObject "AdministratorWebTokenSpecPrivateApps"
              (\ o ->
                 AdministratorWebTokenSpecPrivateApps Core.<$>
                   (o Core..:? "enabled"))

instance Core.ToJSON AdministratorWebTokenSpecPrivateApps where
...
instance Core.FromJSON AdministratorWebTokenSpecStoreBuilder where
        parseJSON
          = Core.withObject "AdministratorWebTokenSpecStoreBuilder"
              (\ o ->
                 AdministratorWebTokenSpecStoreBuilder Core.<$>
                   (o Core..:? "enabled"))

instance Core.ToJSON AdministratorWebTokenSpecStoreBuilder where
...
instance Core.FromJSON AdministratorWebTokenSpecWebApps where
        parseJSON
          = Core.withObject "AdministratorWebTokenSpecWebApps"
              (\ o ->
                 AdministratorWebTokenSpecWebApps Core.<$> (o Core..:? "enabled"))
...
instance Core.FromJSON AdministratorWebTokenSpecZeroTouch where
        parseJSON
          = Core.withObject "AdministratorWebTokenSpecZeroTouch"
              (\ o ->
                 AdministratorWebTokenSpecZeroTouch Core.<$> (o Core..:? "enabled"))

instance Core.ToJSON AdministratorWebTokenSpecZeroTouch where
...
newAppRestrictionsSchema 
    ::  AppRestrictionsSchema
newAppRestrictionsSchema
  = AppRestrictionsSchema{kind = Core.Nothing,
                          restrictions = Core.Nothing}
instance Core.FromJSON AppRestrictionsSchema where
        parseJSON
          = Core.withObject "AppRestrictionsSchema"
              (\ o ->
                 AppRestrictionsSchema Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "restrictions"))
...
instance Core.FromJSON AppRestrictionsSchemaChangeEvent where
        parseJSON
          = Core.withObject "AppRestrictionsSchemaChangeEvent"
              (\ o ->
                 AppRestrictionsSchemaChangeEvent Core.<$> (o Core..:? "productId"))
...
newAppRestrictionsSchemaRestriction 
    :: 
                                    AppRestrictionsSchemaRestriction
newAppRestrictionsSchemaRestriction
  = AppRestrictionsSchemaRestriction{defaultValue = Core.Nothing,
                                     description = Core.Nothing, entry = Core.Nothing,
                                     entryValue = Core.Nothing, key = Core.Nothing,
                                     nestedRestriction = Core.Nothing,
                                     restrictionType = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON AppRestrictionsSchemaRestriction where
        parseJSON
          = Core.withObject "AppRestrictionsSchemaRestriction"
              (\ o ->
                 AppRestrictionsSchemaRestriction Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("defaultValue" Core..=) Core.<$> defaultValue,
                  ...
                  ("key" Core..=) Core.<$> key,
                  ("nestedRestriction" Core..=) Core.<$> nestedRestriction,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "AppRestrictionsSchemaRestrictionRestrictionValue"
              (\ o ->
                 AppRestrictionsSchemaRestrictionRestrictionValue Core.<$>
                   (o Core..:? "type") Core.<*> (o Core..:? "valueBool") Core.<*>
                     (o Core..:? "valueInteger")
          ...
          = Core.object
              (Core.catMaybes
                 [("type" Core..=) Core.<$> type',
                  ...
                  ("valueMultiselect" Core..=) Core.<$> valueMultiselect,
...
newAppState 
    ::  AppState
newAppState
  = AppState{keyedAppState = Core.Nothing,
             packageName = Core.Nothing}
instance Core.FromJSON AppState where
        parseJSON
          = Core.withObject "AppState"
              (\ o ->
                 AppState Core.<$>
                   (o Core..:? "keyedAppState") Core.<*> (o Core..:? "packageName"))
...
instance Core.FromJSON AppUpdateEvent where
        parseJSON
          = Core.withObject "AppUpdateEvent"
              (\ o -> AppUpdateEvent Core.<$> (o Core..:? "productId"))
...
newAppVersion 
    ::  AppVersion
newAppVersion
  = AppVersion{isProduction = Core.Nothing,
               targetSdkVersion = Core.Nothing, track = Core.Nothing,
               trackId = Core.Nothing, versionCode = Core.Nothing,
...
instance Core.FromJSON AppVersion where
        parseJSON
          = Core.withObject "AppVersion"
              (\ o ->
                 AppVersion Core.<$>
                   (o Core..:? "isProduction") Core.<*>
                     (o Core..:? "targetSdkVersion")
                     Core.<*> (o Core..:? "track")
                     Core.<*> (o Core..:? "trackId")
...
instance Core.FromJSON ApprovalUrlInfo where
        parseJSON
          = Core.withObject "ApprovalUrlInfo"
              (\ o -> ApprovalUrlInfo Core.<$> (o Core..:? "approvalUrl"))

instance Core.ToJSON ApprovalUrlInfo where
        toJSON ApprovalUrlInfo{..}
          = Core.object
              (Core.catMaybes [("approvalUrl" Core..=) Core.<$> approvalUrl])
...
instance Core.FromJSON AuthenticationToken where
        parseJSON
          = Core.withObject "AuthenticationToken"
              (\ o -> AuthenticationToken Core.<$> (o Core..:? "token"))
...
newAutoInstallConstraint 
    ::  AutoInstallConstraint
newAutoInstallConstraint
  = AutoInstallConstraint{chargingStateConstraint = Core.Nothing,
...
instance Core.FromJSON AutoInstallConstraint where
        parseJSON
          = Core.withObject "AutoInstallConstraint"
              (\ o ->
                 AutoInstallConstraint Core.<$>
                   (o Core..:? "chargingStateConstraint") Core.<*>
                     (o Core..:? "deviceIdleStateConstraint")
...
instance Core.ToJSON AutoInstallConstraint where
        toJSON AutoInstallConstraint{..}
          = Core.object
              (Core.catMaybes
                 [("chargingStateConstraint" Core..=) Core.<$>
                    chargingStateConstraint,
                  ("deviceIdleStateConstraint" Core..=) Core.<$>
...
newAutoInstallPolicy 
    ::  AutoInstallPolicy
newAutoInstallPolicy
  = AutoInstallPolicy{autoInstallConstraint = Core.Nothing,
                      autoInstallMode = Core.Nothing, autoInstallPriority = Core.Nothing,
                      minimumVersionCode = Core.Nothing}
instance Core.FromJSON AutoInstallPolicy where
        parseJSON
          = Core.withObject "AutoInstallPolicy"
              (\ o ->
                 AutoInstallPolicy Core.<$>
                   (o Core..:? "autoInstallConstraint") Core.<*>
                     (o Core..:? "autoInstallMode")
...
instance Core.ToJSON AutoInstallPolicy where
        toJSON AutoInstallPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("autoInstallConstraint" Core..=) Core.<$> autoInstallConstraint,
                  ("autoInstallMode" Core..=) Core.<$> autoInstallMode,
                  ("autoInstallPriority" Core..=) Core.<$> autoInstallPriority,
...
newConfigurationVariables 
    ::  ConfigurationVariables
newConfigurationVariables
  = ConfigurationVariables{mcmId = Core.Nothing,
                           variableSet = Core.Nothing}
instance Core.FromJSON ConfigurationVariables where
        parseJSON
          = Core.withObject "ConfigurationVariables"
              (\ o ->
                 ConfigurationVariables Core.<$>
                   (o Core..:? "mcmId") Core.<*> (o Core..:? "variableSet"))
...
newDevice 
    ::  Device
newDevice
  = Device{androidId = Core.Nothing, device = Core.Nothing,
           latestBuildFingerprint = Core.Nothing, maker = Core.Nothing,
           managementType = Core.Nothing, model = Core.Nothing,
           policy = Core.Nothing, product = Core.Nothing,
           report = Core.Nothing, retailBrand = Core.Nothing,
...
instance Core.FromJSON Device where
        parseJSON
          = Core.withObject "Device"
              (\ o ->
                 Device Core.<$>
                   (o Core..:? "androidId") Core.<*> (o Core..:? "device") Core.<*>
                     (o Core..:? "latestBuildFingerprint")
                     Core.<*> (o Core..:? "maker")
          ...
          = Core.object
              (Core.catMaybes
                 [("androidId" Core..=) Core.<$> androidId,
                  ...
                  ("latestBuildFingerprint" Core..=) Core.<$> latestBuildFingerprint,
...
newDeviceReport 
    ::  DeviceReport
newDeviceReport
  = DeviceReport{appState = Core.Nothing,
                 lastUpdatedTimestampMillis = Core.Nothing}
instance Core.FromJSON DeviceReport where
        parseJSON
          = Core.withObject "DeviceReport"
              (\ o ->
                 DeviceReport Core.<$>
                   (o Core..:? "appState") Core.<*>
                     (o Core..:? "lastUpdatedTimestampMillis" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("appState" Core..=) Core.<$> appState,
                  ("lastUpdatedTimestampMillis" Core..=) Core.. Core.AsText Core.<$>
...
newDeviceReportUpdateEvent 
    ::  DeviceReportUpdateEvent
newDeviceReportUpdateEvent
  = DeviceReportUpdateEvent{deviceId = Core.Nothing,
                            report = Core.Nothing, userId = Core.Nothing}
instance Core.FromJSON DeviceReportUpdateEvent where
        parseJSON
          = Core.withObject "DeviceReportUpdateEvent"
              (\ o ->
                 DeviceReportUpdateEvent Core.<$>
                   (o Core..:? "deviceId") Core.<*> (o Core..:? "report") Core.<*>
                     (o Core..:? "userId"))
...
instance Core.FromJSON DeviceState where
        parseJSON
          = Core.withObject "DeviceState"
              (\ o -> DeviceState Core.<$> (o Core..:? "accountState"))

instance Core.ToJSON DeviceState where
        toJSON DeviceState{..}
          = Core.object
              (Core.catMaybes [("accountState" Core..=) Core.<$> accountState])
...
instance Core.FromJSON DevicesListResponse where
        parseJSON
          = Core.withObject "DevicesListResponse"
              (\ o -> DevicesListResponse Core.<$> (o Core..:? "device"))
...
data EnrollmentToken = EnrollmentToken
    ...
    , enrollmentTokenType :: (Core.Maybe EnrollmentToken_EnrollmentTokenType)
...
newEnrollmentToken 
    ::  EnrollmentToken
newEnrollmentToken
  = EnrollmentToken{duration = Core.Nothing,
                    enrollmentTokenType = Core.Nothing, token = Core.Nothing}
instance Core.FromJSON EnrollmentToken where
        parseJSON
          = Core.withObject "EnrollmentToken"
              (\ o ->
                 EnrollmentToken Core.<$>
                   (o Core..:? "duration") Core.<*> (o Core..:? "enrollmentTokenType")
                     Core.<*> (o Core..:? "token"))
          ...
          = Core.object
              (Core.catMaybes
                 [("duration" Core..=) Core.<$> duration,
                  ("enrollmentTokenType" Core..=) Core.<$> enrollmentTokenType,
...
newEnterprise 
    ::  Enterprise
newEnterprise
  = Enterprise{administrator = Core.Nothing,
               enterpriseType = Core.Nothing,
               googleAuthenticationSettings = Core.Nothing, id = Core.Nothing,
               managedGoogleDomainType = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Enterprise where
        parseJSON
          = Core.withObject "Enterprise"
              (\ o ->
                 Enterprise Core.<$>
                   (o Core..:? "administrator") Core.<*> (o Core..:? "enterpriseType")
...
newEnterpriseAccount 
    ::  EnterpriseAccount
newEnterpriseAccount
  = EnterpriseAccount{accountEmail = Core.Nothing}
instance Core.FromJSON EnterpriseAccount where
        parseJSON
          = Core.withObject "EnterpriseAccount"
              (\ o -> EnterpriseAccount Core.<$> (o Core..:? "accountEmail"))

instance Core.ToJSON EnterpriseAccount where
        toJSON EnterpriseAccount{..}
          = Core.object
              (Core.catMaybes [("accountEmail" Core..=) Core.<$> accountEmail])
...
instance Core.FromJSON EnterpriseAuthenticationAppLinkConfig where
        parseJSON
          = Core.withObject "EnterpriseAuthenticationAppLinkConfig"
              (\ o ->
                 EnterpriseAuthenticationAppLinkConfig Core.<$> (o Core..:? "uri"))
...
newEnterprisesListResponse 
    ::  EnterprisesListResponse
newEnterprisesListResponse
  = EnterprisesListResponse{enterprise = Core.Nothing}
instance Core.FromJSON EnterprisesListResponse where
        parseJSON
          = Core.withObject "EnterprisesListResponse"
              (\ o -> EnterprisesListResponse Core.<$> (o Core..:? "enterprise"))

instance Core.ToJSON EnterprisesListResponse where
        toJSON EnterprisesListResponse{..}
          = Core.object
              (Core.catMaybes [("enterprise" Core..=) Core.<$> enterprise])
...
newEnterprisesSendTestPushNotificationResponse 
    :: 
                                               EnterprisesSendTestPushNotificationResponse
newEnterprisesSendTestPushNotificationResponse
  = EnterprisesSendTestPushNotificationResponse{messageId =
                                                  Core.Nothing,
                                                topicName = Core.Nothing}
instance Core.FromJSON EnterprisesSendTestPushNotificationResponse
         where
        parseJSON
          = Core.withObject "EnterprisesSendTestPushNotificationResponse"
              (\ o ->
                 EnterprisesSendTestPushNotificationResponse Core.<$>
                   (o Core..:? "messageId") Core.<*> (o Core..:? "topicName"))

instance Core.ToJSON EnterprisesSendTestPushNotificationResponse
         where
...
newEntitlement 
    ::  Entitlement
newEntitlement
  = Entitlement{productId = Core.Nothing, reason = Core.Nothing}
instance Core.FromJSON Entitlement where
        parseJSON
          = Core.withObject "Entitlement"
              (\ o ->
                 Entitlement Core.<$>
                   (o Core..:? "productId") Core.<*> (o Core..:? "reason"))
...
instance Core.FromJSON EntitlementsListResponse where
        parseJSON
          = Core.withObject "EntitlementsListResponse"
              (\ o ->
                 EntitlementsListResponse Core.<$> (o Core..:? "entitlement"))
          ...
          = Core.withObject "GoogleAuthenticationSettings"
              (\ o ->
                 GoogleAuthenticationSettings Core.<$>
                   (o Core..:? "dedicatedDevicesAllowed") Core.<*>
...
instance Core.ToJSON GoogleAuthenticationSettings where
        toJSON GoogleAuthenticationSettings{..}
          = Core.object
              (Core.catMaybes
                 [("dedicatedDevicesAllowed" Core..=) Core.<$>
...
newGroupLicense 
    ::  GroupLicense
newGroupLicense
  = GroupLicense{acquisitionKind = Core.Nothing,
                 approval = Core.Nothing, numProvisioned = Core.Nothing,
                 numPurchased = Core.Nothing, permissions = Core.Nothing,
                 productId = Core.Nothing}
instance Core.FromJSON GroupLicense where
        parseJSON
          = Core.withObject "GroupLicense"
              (\ o ->
                 GroupLicense Core.<$>
                   (o Core..:? "acquisitionKind") Core.<*> (o Core..:? "approval")
...
instance Core.ToJSON GroupLicense where
        toJSON GroupLicense{..}
          = Core.object
              (Core.catMaybes
                 [("acquisitionKind" Core..=) Core.<$> acquisitionKind,
...
instance Core.FromJSON GroupLicenseUsersListResponse where
        parseJSON
          = Core.withObject "GroupLicenseUsersListResponse"
              (\ o -> GroupLicenseUsersListResponse Core.<$> (o Core..:? "user"))

instance Core.ToJSON GroupLicenseUsersListResponse where
        toJSON GroupLicenseUsersListResponse{..}
          = Core.object (Core.catMaybes [("user" Core..=) Core.<$> user])
...
instance Core.FromJSON GroupLicensesListResponse where
        parseJSON
          = Core.withObject "GroupLicensesListResponse"
              (\ o ->
                 GroupLicensesListResponse Core.<$> (o Core..:? "groupLicense"))

instance Core.ToJSON GroupLicensesListResponse where
        toJSON GroupLicensesListResponse{..}
          = Core.object
              (Core.catMaybes [("groupLicense" Core..=) Core.<$> groupLicense])
...
newInstall 
    ::  Install
newInstall
  = Install{installState = Core.Nothing, productId = Core.Nothing,
            versionCode = Core.Nothing}
instance Core.FromJSON Install where
        parseJSON
          = Core.withObject "Install"
              (\ o ->
                 Install Core.<$>
                   (o Core..:? "installState") Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "versionCode"))
...
newInstallFailureEvent 
    ::  InstallFailureEvent
newInstallFailureEvent
  = InstallFailureEvent{deviceId = Core.Nothing,
                        failureDetails = Core.Nothing, failureReason = Core.Nothing,
                        productId = Core.Nothing, userId = Core.Nothing}
instance Core.FromJSON InstallFailureEvent where
        parseJSON
          = Core.withObject "InstallFailureEvent"
              (\ o ->
                 InstallFailureEvent Core.<$>
                   (o Core..:? "deviceId") Core.<*> (o Core..:? "failureDetails")
...
newInstallsListResponse 
    ::  InstallsListResponse
newInstallsListResponse
  = InstallsListResponse{install = Core.Nothing}
instance Core.FromJSON InstallsListResponse where
        parseJSON
          = Core.withObject "InstallsListResponse"
              (\ o -> InstallsListResponse Core.<$> (o Core..:? "install"))

instance Core.ToJSON InstallsListResponse where
        toJSON InstallsListResponse{..}
          = Core.object
              (Core.catMaybes [("install" Core..=) Core.<$> install])
...
newKeyedAppState 
    ::  KeyedAppState
newKeyedAppState
  = KeyedAppState{data' = Core.Nothing, key = Core.Nothing,
...
instance Core.FromJSON KeyedAppState where
        parseJSON
          = Core.withObject "KeyedAppState"
              (\ o ->
                 KeyedAppState Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "key") Core.<*>
                     (o Core..:? "message")
                     Core.<*> (o Core..:? "severity")
                     Core.<*>
                     (o Core..:? "stateTimestampMillis" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("data" Core..=) Core.<$> data', ("key" Core..=) Core.<$> key,
                  ...
                  ("stateTimestampMillis" Core..=) Core.. Core.AsText Core.<$>
...
newLocalizedText 
    ::  LocalizedText
newLocalizedText
  = LocalizedText{locale = Core.Nothing, text = Core.Nothing}
instance Core.FromJSON LocalizedText where
        parseJSON
          = Core.withObject "LocalizedText"
              (\ o ->
                 LocalizedText Core.<$>
                   (o Core..:? "locale") Core.<*> (o Core..:? "text"))
...
newMaintenanceWindow 
    ::  MaintenanceWindow
newMaintenanceWindow
  = MaintenanceWindow{durationMs = Core.Nothing,
              ...
              (\ o ->
                 MaintenanceWindow Core.<$>
                   (o Core..:? "durationMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "startTimeAfterMidnightMs" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("durationMs" Core..=) Core.. Core.AsText Core.<$> durationMs,
                  ("startTimeAfterMidnightMs" Core..=) Core.. Core.AsText Core.<$>
...
newManagedConfiguration 
    ::  ManagedConfiguration
newManagedConfiguration
  = ManagedConfiguration{configurationVariables = Core.Nothing,
                         kind = Core.Nothing, managedProperty = Core.Nothing,
                         productId = Core.Nothing}
instance Core.FromJSON ManagedConfiguration where
        parseJSON
          = Core.withObject "ManagedConfiguration"
              (\ o ->
                 ManagedConfiguration Core.<$>
                   (o Core..:? "configurationVariables") Core.<*> (o Core..:? "kind")
...
newManagedConfigurationsForDeviceListResponse 
    :: 
                                              ManagedConfigurationsForDeviceListResponse
newManagedConfigurationsForDeviceListResponse
  = ManagedConfigurationsForDeviceListResponse{managedConfigurationForDevice
                                                 = Core.Nothing}
instance Core.FromJSON ManagedConfigurationsForDeviceListResponse
         where
        parseJSON
          = Core.withObject "ManagedConfigurationsForDeviceListResponse"
              (\ o ->
                 ManagedConfigurationsForDeviceListResponse Core.<$>
                   (o Core..:? "managedConfigurationForDevice"))

instance Core.ToJSON ManagedConfigurationsForDeviceListResponse
         where
        toJSON ManagedConfigurationsForDeviceListResponse{..}
          = Core.object
              (Core.catMaybes
                 [("managedConfigurationForDevice" Core..=) Core.<$>
...
newManagedConfigurationsForUserListResponse
  = ManagedConfigurationsForUserListResponse{managedConfigurationForUser
                                               = Core.Nothing}
instance Core.FromJSON ManagedConfigurationsForUserListResponse
         where
        parseJSON
          = Core.withObject "ManagedConfigurationsForUserListResponse"
              (\ o ->
                 ManagedConfigurationsForUserListResponse Core.<$>
                   (o Core..:? "managedConfigurationForUser"))

instance Core.ToJSON ManagedConfigurationsForUserListResponse where
        toJSON ManagedConfigurationsForUserListResponse{..}
          = Core.object
              (Core.catMaybes
                 [("managedConfigurationForUser" Core..=) Core.<$>
...
newManagedConfigurationsSettings 
    ::  ManagedConfigurationsSettings
newManagedConfigurationsSettings
  = ManagedConfigurationsSettings{lastUpdatedTimestampMillis =
                                    Core.Nothing,
                                  mcmId = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON ManagedConfigurationsSettings where
        parseJSON
          = Core.withObject "ManagedConfigurationsSettings"
              (\ o ->
        ...
        toJSON ManagedConfigurationsSettings{..}
          = Core.object
              (Core.catMaybes
                 [("lastUpdatedTimestampMillis" Core..=) Core.. Core.AsText Core.<$>
                    lastUpdatedTimestampMillis,
                  ("mcmId" Core..=) Core.<$> mcmId, ("name" Core..=) Core.<$> name])
...
newManagedConfigurationsSettingsListResponse 
    :: 
                                             ManagedConfigurationsSettingsListResponse
newManagedConfigurationsSettingsListResponse
  = ManagedConfigurationsSettingsListResponse{managedConfigurationsSettings
                                                = Core.Nothing}
instance Core.FromJSON ManagedConfigurationsSettingsListResponse
         where
        parseJSON
          = Core.withObject "ManagedConfigurationsSettingsListResponse"
              (\ o ->
                 ManagedConfigurationsSettingsListResponse Core.<$>
                   (o Core..:? "managedConfigurationsSettings"))

instance Core.ToJSON ManagedConfigurationsSettingsListResponse
         where
        toJSON ManagedConfigurationsSettingsListResponse{..}
          = Core.object
              (Core.catMaybes
                 [("managedConfigurationsSettings" Core..=) Core.<$>
                    managedConfigurationsSettings])
...
newManagedProperty 
    ::  ManagedProperty
newManagedProperty
  = ManagedProperty{key = Core.Nothing, valueBool = Core.Nothing,
                    valueBundle = Core.Nothing, valueBundleArray = Core.Nothing,
                    valueInteger = Core.Nothing, valueString = Core.Nothing,
          ...
          = Core.withObject "ManagedProperty"
              (\ o ->
                 ManagedProperty Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "valueBool") Core.<*>
                     (o Core..:? "valueBundle")
          ...
          = Core.object
              (Core.catMaybes
                 [("key" Core..=) Core.<$> key,
                  ...
                  ("valueBundleArray" Core..=) Core.<$> valueBundleArray,
                  ("valueInteger" Core..=) Core.<$> valueInteger,
                  ("valueString" Core..=) Core.<$> valueString,
                  ("valueStringArray" Core..=) Core.<$> valueStringArray])
...
instance Core.FromJSON ManagedPropertyBundle where
        parseJSON
          = Core.withObject "ManagedPropertyBundle"
              (\ o ->
                 ManagedPropertyBundle Core.<$> (o Core..:? "managedProperty"))
...
newNewDeviceEvent 
    ::  NewDeviceEvent
newNewDeviceEvent
  = NewDeviceEvent{deviceId = Core.Nothing,
                   dpcPackageName = Core.Nothing, managementType = Core.Nothing,
                   userId = Core.Nothing}
instance Core.FromJSON NewDeviceEvent where
        parseJSON
          = Core.withObject "NewDeviceEvent"
              (\ o ->
                 NewDeviceEvent Core.<$>
                   (o Core..:? "deviceId") Core.<*> (o Core..:? "dpcPackageName")
                     Core.<*> (o Core..:? "managementType")
                     Core.<*> (o Core..:? "userId"))
...
newNewPermissionsEvent 
    ::  NewPermissionsEvent
newNewPermissionsEvent
  = NewPermissionsEvent{approvedPermissions = Core.Nothing,
                        productId = Core.Nothing, requestedPermissions = Core.Nothing}
instance Core.FromJSON NewPermissionsEvent where
        parseJSON
          = Core.withObject "NewPermissionsEvent"
              (\ o ->
                 NewPermissionsEvent Core.<$>
                   (o Core..:? "approvedPermissions") Core.<*>
                     (o Core..:? "productId")
...
instance Core.ToJSON NewPermissionsEvent where
        toJSON NewPermissionsEvent{..}
          = Core.object
              (Core.catMaybes
                 [("approvedPermissions" Core..=) Core.<$> approvedPermissions,
                  ("productId" Core..=) Core.<$> productId,
                  ("requestedPermissions" Core..=) Core.<$> requestedPermissions])
...
newNotification 
    ::  Notification
newNotification
  = Notification{appRestrictionsSchemaChangeEvent = Core.Nothing,
                 appUpdateEvent = Core.Nothing,
                 deviceReportUpdateEvent = Core.Nothing,
                 enterpriseId = Core.Nothing, enterpriseUpgradeEvent = Core.Nothing,
                 installFailureEvent = Core.Nothing, newDeviceEvent' = Core.Nothing,
...
instance Core.FromJSON Notification where
        parseJSON
          = Core.withObject "Notification"
              (\ o ->
                 Notification Core.<$>
                   (o Core..:? "appRestrictionsSchemaChangeEvent") Core.<*>
                     (o Core..:? "appUpdateEvent")
                     ...
                     Core.<*>
                     (o Core..:? "timestampMillis" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON Notification where
        toJSON Notification{..}
          = Core.object
              (Core.catMaybes
                 [("appRestrictionsSchemaChangeEvent" Core..=) Core.<$>
                    appRestrictionsSchemaChangeEvent,
                  ("appUpdateEvent" Core..=) Core.<$> appUpdateEvent,
                  ("deviceReportUpdateEvent" Core..=) Core.<$>
                    deviceReportUpdateEvent,
                  ...
                  ("productApprovalEvent" Core..=) Core.<$> productApprovalEvent,
                  ("productAvailabilityChangeEvent" Core..=) Core.<$>
                    productAvailabilityChangeEvent,
                  ("timestampMillis" Core..=) Core.. Core.AsText Core.<$>
                    timestampMillis])
...
newNotificationSet 
    ::  NotificationSet
newNotificationSet
  = NotificationSet{notification = Core.Nothing,
                    notificationSetId = Core.Nothing}
instance Core.FromJSON NotificationSet where
        parseJSON
          = Core.withObject "NotificationSet"
              (\ o ->
                 NotificationSet Core.<$>
                   (o Core..:? "notification") Core.<*>
                     (o Core..:? "notificationSetId"))
          ...
          = Core.object
              (Core.catMaybes
                 [("notification" Core..=) Core.<$> notification,
                  ("notificationSetId" Core..=) Core.<$> notificationSetId])
...
newPermission 
    ::  Permission
newPermission
  = Permission{description = Core.Nothing, name = Core.Nothing,
...
newPolicy 
    ::  Policy
newPolicy
  = Policy{autoUpdatePolicy = Core.Nothing,
           deviceReportPolicy = Core.Nothing,
           maintenanceWindow = Core.Nothing, policyId = Core.Nothing,
...
instance Core.FromJSON Policy where
        parseJSON
          = Core.withObject "Policy"
              (\ o ->
                 Policy Core.<$>
                   (o Core..:? "autoUpdatePolicy") Core.<*>
                     (o Core..:? "deviceReportPolicy")
...
instance Core.ToJSON Policy where
        toJSON Policy{..}
          = Core.object
              (Core.catMaybes
                 [("autoUpdatePolicy" Core..=) Core.<$> autoUpdatePolicy,
                  ("deviceReportPolicy" Core..=) Core.<$> deviceReportPolicy,
                  ("maintenanceWindow" Core..=) Core.<$> maintenanceWindow,
                  ("policyId" Core..=) Core.<$> policyId,
                  ("productAvailabilityPolicy" Core..=) Core.<$>
...
newProduct 
    ::  Product
newProduct
  = Product{appRestrictionsSchema = Core.Nothing,
            appTracks = Core.Nothing, appVersion = Core.Nothing,
            authorName = Core.Nothing, availableCountries = Core.Nothing,
            availableTracks = Core.Nothing, category = Core.Nothing,
            contentRating = Core.Nothing, description = Core.Nothing,
            detailsUrl = Core.Nothing, distributionChannel = Core.Nothing,
            features = Core.Nothing, fullDescription = Core.Nothing,
            iconUrl = Core.Nothing, lastUpdatedTimestampMillis = Core.Nothing,
            minAndroidSdkVersion = Core.Nothing, permissions = Core.Nothing,
            productId = Core.Nothing, productPricing = Core.Nothing,
            recentChanges = Core.Nothing, requiresContainerApp = Core.Nothing,
            screenshotUrls = Core.Nothing, signingCertificate = Core.Nothing,
...
instance Core.FromJSON Product where
        parseJSON
          = Core.withObject "Product"
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "appRestrictionsSchema") Core.<*>
                     (o Core..:? "appTracks")
...
instance Core.ToJSON Product where
        toJSON Product{..}
          = Core.object
              (Core.catMaybes
                 [("appRestrictionsSchema" Core..=) Core.<$> appRestrictionsSchema,
                  ...
                  ("requiresContainerApp" Core..=) Core.<$> requiresContainerApp,
                  ("screenshotUrls" Core..=) Core.<$> screenshotUrls,
                  ("signingCertificate" Core..=) Core.<$> signingCertificate,
...
newProductApprovalEvent 
    ::  ProductApprovalEvent
newProductApprovalEvent
  = ProductApprovalEvent{approved = Core.Nothing,
                         productId = Core.Nothing}
instance Core.FromJSON ProductApprovalEvent where
        parseJSON
          = Core.withObject "ProductApprovalEvent"
              (\ o ->
                 ProductApprovalEvent Core.<$>
                   (o Core..:? "approved") Core.<*> (o Core..:? "productId"))
...
newProductAvailabilityChangeEvent 
    ::  ProductAvailabilityChangeEvent
newProductAvailabilityChangeEvent
  = ProductAvailabilityChangeEvent{availabilityStatus = Core.Nothing,
                                   productId = Core.Nothing}
instance Core.FromJSON ProductAvailabilityChangeEvent where
        parseJSON
          = Core.withObject "ProductAvailabilityChangeEvent"
              (\ o ->
                 ProductAvailabilityChangeEvent Core.<$>
                   (o Core..:? "availabilityStatus") Core.<*>
                     (o Core..:? "productId"))
...
newProductPermission 
    ::  ProductPermission
newProductPermission
  = ProductPermission{permissionId = Core.Nothing,
                      state = Core.Nothing}
instance Core.FromJSON ProductPermission where
        parseJSON
          = Core.withObject "ProductPermission"
              (\ o ->
                 ProductPermission Core.<$>
                   (o Core..:? "permissionId") Core.<*> (o Core..:? "state"))
...
newProductPermissions 
    ::  ProductPermissions
newProductPermissions
  = ProductPermissions{permission = Core.Nothing,
                       productId = Core.Nothing}
instance Core.FromJSON ProductPermissions where
        parseJSON
          = Core.withObject "ProductPermissions"
              (\ o ->
                 ProductPermissions Core.<$>
                   (o Core..:? "permission") Core.<*> (o Core..:? "productId"))
...
newProductPolicy 
    ::  ProductPolicy
newProductPolicy
  = ProductPolicy{autoInstallPolicy = Core.Nothing,
                  autoUpdateMode = Core.Nothing,
                  enterpriseAuthenticationAppLinkConfigs = Core.Nothing,
                  managedConfiguration = Core.Nothing, productId = Core.Nothing,
                  trackIds = Core.Nothing, tracks = Core.Nothing}
instance Core.FromJSON ProductPolicy where
        parseJSON
          = Core.withObject "ProductPolicy"
              (\ o ->
                 ProductPolicy Core.<$>
                   (o Core..:? "autoInstallPolicy") Core.<*>
                     (o Core..:? "autoUpdateMode")
...
instance Core.ToJSON ProductPolicy where
        toJSON ProductPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("autoInstallPolicy" Core..=) Core.<$> autoInstallPolicy,
                  ("autoUpdateMode" Core..=) Core.<$> autoUpdateMode,
                  ("enterpriseAuthenticationAppLinkConfigs" Core..=) Core.<$>
...
newProductSet 
    ::  ProductSet
newProductSet
  = ProductSet{productId = Core.Nothing,
               productSetBehavior = Core.Nothing,
               productVisibility = Core.Nothing}
instance Core.FromJSON ProductSet where
        parseJSON
          = Core.withObject "ProductSet"
              (\ o ->
                 ProductSet Core.<$>
                   (o Core..:? "productId") Core.<*> (o Core..:? "productSetBehavior")
...
instance Core.ToJSON ProductSet where
        toJSON ProductSet{..}
          = Core.object
              (Core.catMaybes
                 [("productId" Core..=) Core.<$> productId,
                  ("productSetBehavior" Core..=) Core.<$> productSetBehavior,
                  ("productVisibility" Core..=) Core.<$> productVisibility])
...
newProductSigningCertificate 
    ::  ProductSigningCertificate
newProductSigningCertificate
  = ProductSigningCertificate{certificateHashSha1 = Core.Nothing,
                              certificateHashSha256 = Core.Nothing}
instance Core.FromJSON ProductSigningCertificate where
        parseJSON
          = Core.withObject "ProductSigningCertificate"
              (\ o ->
                 ProductSigningCertificate Core.<$>
                   (o Core..:? "certificateHashSha1") Core.<*>
                     (o Core..:? "certificateHashSha256"))

instance Core.ToJSON ProductSigningCertificate where
        toJSON ProductSigningCertificate{..}
          = Core.object
              (Core.catMaybes
                 [("certificateHashSha1" Core..=) Core.<$> certificateHashSha1,
                  ("certificateHashSha256" Core..=) Core.<$> certificateHashSha256])
...
newProductVisibility 
    ::  ProductVisibility
newProductVisibility
  = ProductVisibility{productId = Core.Nothing,
                      trackIds = Core.Nothing, tracks = Core.Nothing}
instance Core.FromJSON ProductVisibility where
        parseJSON
          = Core.withObject "ProductVisibility"
              (\ o ->
                 ProductVisibility Core.<$>
                   (o Core..:? "productId") Core.<*> (o Core..:? "trackIds") Core.<*>
                     (o Core..:? "tracks"))
...
newProductsApproveRequest 
    ::  ProductsApproveRequest
newProductsApproveRequest
  = ProductsApproveRequest{approvalUrlInfo = Core.Nothing,
                           approvedPermissions = Core.Nothing}
instance Core.FromJSON ProductsApproveRequest where
        parseJSON
          = Core.withObject "ProductsApproveRequest"
              (\ o ->
                 ProductsApproveRequest Core.<$>
                   (o Core..:? "approvalUrlInfo") Core.<*>
                     (o Core..:? "approvedPermissions"))

instance Core.ToJSON ProductsApproveRequest where
        toJSON ProductsApproveRequest{..}
          = Core.object
              (Core.catMaybes
                 [("approvalUrlInfo" Core..=) Core.<$> approvalUrlInfo,
                  ("approvedPermissions" Core..=) Core.<$> approvedPermissions])
...
instance Core.FromJSON ProductsGenerateApprovalUrlResponse where
        parseJSON
          = Core.withObject "ProductsGenerateApprovalUrlResponse"
              (\ o ->
                 ProductsGenerateApprovalUrlResponse Core.<$> (o Core..:? "url"))

instance Core.ToJSON ProductsGenerateApprovalUrlResponse where
...
newProductsListResponse 
    ::  ProductsListResponse
newProductsListResponse
  = ProductsListResponse{pageInfo = Core.Nothing,
                         product = Core.Nothing, tokenPagination = Core.Nothing}
instance Core.FromJSON ProductsListResponse where
        parseJSON
          = Core.withObject "ProductsListResponse"
              (\ o ->
                 ProductsListResponse Core.<$>
                   (o Core..:? "pageInfo") Core.<*> (o Core..:? "product") Core.<*>
...
newServiceAccount 
    ::  ServiceAccount
newServiceAccount
  = ServiceAccount{key = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON ServiceAccount where
        parseJSON
          = Core.withObject "ServiceAccount"
              (\ o ->
                 ServiceAccount Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "name"))
...
newServiceAccountKey 
    ::  ServiceAccountKey
newServiceAccountKey
  = ServiceAccountKey{data' = Core.Nothing, id = Core.Nothing,
                      publicData = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON ServiceAccountKey where
        parseJSON
          = Core.withObject "ServiceAccountKey"
              (\ o ->
                 ServiceAccountKey Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "publicData")
                     Core.<*> (o Core..:? "type"))
...
instance Core.ToJSON ServiceAccountKey where
        toJSON ServiceAccountKey{..}
          = Core.object
              (Core.catMaybes
                 [("data" Core..=) Core.<$> data', ("id" Core..=) Core.<$> id,
...
instance Core.FromJSON ServiceAccountKeysListResponse where
        parseJSON
          = Core.withObject "ServiceAccountKeysListResponse"
              (\ o ->
                 ServiceAccountKeysListResponse Core.<$>
                   (o Core..:? "serviceAccountKey"))

instance Core.ToJSON ServiceAccountKeysListResponse where
        toJSON ServiceAccountKeysListResponse{..}
          = Core.object
              (Core.catMaybes
                 [("serviceAccountKey" Core..=) Core.<$> serviceAccountKey])
...
newSignupInfo 
    ::  SignupInfo
newSignupInfo
  = SignupInfo{completionToken = Core.Nothing, kind = Core.Nothing,
               url = Core.Nothing}
instance Core.FromJSON SignupInfo where
        parseJSON
          = Core.withObject "SignupInfo"
              (\ o ->
                 SignupInfo Core.<$>
                   (o Core..:? "completionToken") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "url"))
...
instance Core.ToJSON SignupInfo where
        toJSON SignupInfo{..}
          = Core.object
              (Core.catMaybes
                 [("completionToken" Core..=) Core.<$> completionToken,
                  ("kind" Core..=) Core.<$> kind, ("url" Core..=) Core.<$> url])
...
newStoreCluster 
    ::  StoreCluster
newStoreCluster
  = StoreCluster{id = Core.Nothing, name = Core.Nothing,
                 orderInPage = Core.Nothing, productId = Core.Nothing}
instance Core.FromJSON StoreCluster where
        parseJSON
          = Core.withObject "StoreCluster"
              (\ o ->
                 StoreCluster Core.<$>
...
newStoreLayout 
    ::  StoreLayout
newStoreLayout
  = StoreLayout{homepageId = Core.Nothing,
                storeLayoutType = Core.Nothing}
instance Core.FromJSON StoreLayout where
        parseJSON
          = Core.withObject "StoreLayout"
              (\ o ->
                 StoreLayout Core.<$>
                   (o Core..:? "homepageId") Core.<*> (o Core..:? "storeLayoutType"))
          ...
          = Core.object
              (Core.catMaybes
                 [("homepageId" Core..=) Core.<$> homepageId,
                  ("storeLayoutType" Core..=) Core.<$> storeLayoutType])
...
instance Core.FromJSON StoreLayoutClustersListResponse where
        parseJSON
          = Core.withObject "StoreLayoutClustersListResponse"
              (\ o ->
                 StoreLayoutClustersListResponse Core.<$> (o Core..:? "cluster"))
...
instance Core.FromJSON StoreLayoutPagesListResponse where
        parseJSON
          = Core.withObject "StoreLayoutPagesListResponse"
              (\ o -> StoreLayoutPagesListResponse Core.<$> (o Core..:? "page"))

instance Core.ToJSON StoreLayoutPagesListResponse where
        toJSON StoreLayoutPagesListResponse{..}
          = Core.object (Core.catMaybes [("page" Core..=) Core.<$> page])
...
newStorePage 
    ::  StorePage
newStorePage
  = StorePage{id = Core.Nothing, link = Core.Nothing,
              name = Core.Nothing}
instance Core.FromJSON StorePage where
        parseJSON
          = Core.withObject "StorePage"
              (\ o ->
                 StorePage Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "link") Core.<*>
                     (o Core..:? "name"))
...
instance Core.ToJSON StorePage where
        toJSON StorePage{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("link" Core..=) Core.<$> link,
                  ("name" Core..=) Core.<$> name])
...
newTrackInfo 
    ::  TrackInfo
newTrackInfo
  = TrackInfo{trackAlias = Core.Nothing, trackId = Core.Nothing}
instance Core.FromJSON TrackInfo where
        parseJSON
          = Core.withObject "TrackInfo"
              (\ o ->
                 TrackInfo Core.<$>
...
newUser 
    ::  User
newUser
  = User{accountIdentifier = Core.Nothing,
         accountType = Core.Nothing, displayName = Core.Nothing,
         id = Core.Nothing, managementType = Core.Nothing,
...
instance Core.FromJSON UsersListResponse where
        parseJSON
          = Core.withObject "UsersListResponse"
              (\ o -> UsersListResponse Core.<$> (o Core..:? "user"))
...
instance Core.FromJSON VariableSet where
        parseJSON
          = Core.withObject "VariableSet"
              (\ o ->
                 VariableSet Core.<$>
                   (o Core..:? "placeholder") Core.<*> (o Core..:? "userValue"))
...
newWebApp
  = WebApp{displayMode = Core.Nothing, icons = Core.Nothing,
           isPublished = Core.Nothing, startUrl = Core.Nothing,
           title = Core.Nothing, versionCode = Core.Nothing,
...
instance Core.FromJSON WebAppsListResponse where
        parseJSON
          = Core.withObject "WebAppsListResponse"
              (\ o -> WebAppsListResponse Core.<$> (o Core..:? "webApp"))

instance Core.ToJSON WebAppsListResponse where
        toJSON WebAppsListResponse{..}
          = Core.object (Core.catMaybes [("webApp" Core..=) Core.<$> webApp])
