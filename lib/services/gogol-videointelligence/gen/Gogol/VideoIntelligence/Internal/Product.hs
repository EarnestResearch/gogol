...
newGoogleCloudVideointelligenceV1_DetectedAttribute =
  GoogleCloudVideointelligenceV1_DetectedAttribute
    {confidence = Core.Nothing, name = Core.Nothing, value = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_DetectedLandmark =
  GoogleCloudVideointelligenceV1_DetectedLandmark
    {confidence = Core.Nothing, name = Core.Nothing, point = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_ExplicitContentAnnotation =
  GoogleCloudVideointelligenceV1_ExplicitContentAnnotation
    {frames = Core.Nothing, version = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_ExplicitContentFrame =
  GoogleCloudVideointelligenceV1_ExplicitContentFrame
    {pornographyLikelihood = Core.Nothing, timeOffset = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("pornographyLikelihood" Core..=) Core.<$>
...
newGoogleCloudVideointelligenceV1_FaceAnnotation =
  GoogleCloudVideointelligenceV1_FaceAnnotation
    {frames = Core.Nothing, segments = Core.Nothing, thumbnail = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_FaceDetectionAnnotation =
  GoogleCloudVideointelligenceV1_FaceDetectionAnnotation
    {thumbnail = Core.Nothing, tracks = Core.Nothing, version = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_FaceFrame =
  GoogleCloudVideointelligenceV1_FaceFrame
    {normalizedBoundingBoxes = Core.Nothing, timeOffset = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_LabelFrame =
  GoogleCloudVideointelligenceV1_LabelFrame
    {confidence = Core.Nothing, timeOffset = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_LogoRecognitionAnnotation =
  GoogleCloudVideointelligenceV1_LogoRecognitionAnnotation
    {entity = Core.Nothing, segments = Core.Nothing, tracks = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("confidence" Core..=) Core.<$> confidence,
                  ...
                  ("frames" Core..=) Core.<$> frames,
                  ("segment" Core..=) Core.<$> segment,
                  ("trackId" Core..=) Core.. Core.AsText Core.<$>
                    trackId,
                  ("version" Core..=) Core.<$> version])
...
newGoogleCloudVideointelligenceV1_ObjectTrackingFrame =
  GoogleCloudVideointelligenceV1_ObjectTrackingFrame
    {normalizedBoundingBox = Core.Nothing, timeOffset = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("normalizedBoundingBox" Core..=) Core.<$>
...
newGoogleCloudVideointelligenceV1_PersonDetectionAnnotation =
  GoogleCloudVideointelligenceV1_PersonDetectionAnnotation
    {tracks = Core.Nothing, version = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_SpeechRecognitionAlternative =
  GoogleCloudVideointelligenceV1_SpeechRecognitionAlternative
    {confidence = Core.Nothing, transcript = Core.Nothing, words = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_SpeechTranscription =
  GoogleCloudVideointelligenceV1_SpeechTranscription
    {alternatives = Core.Nothing, languageCode = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_TextAnnotation =
  GoogleCloudVideointelligenceV1_TextAnnotation
    {segments = Core.Nothing, text = Core.Nothing, version = Core.Nothing}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_TextAnnotation
                   Core.<$>
                   (o Core..:? "segments") Core.<*> (o Core..:? "text")
                     Core.<*> (o Core..:? "version"))
...
newGoogleCloudVideointelligenceV1_TextFrame =
  GoogleCloudVideointelligenceV1_TextFrame
    {rotatedBoundingBox = Core.Nothing, timeOffset = Core.Nothing}
...
newGoogleCloudVideointelligenceV1_TextSegment =
  GoogleCloudVideointelligenceV1_TextSegment
    {confidence = Core.Nothing, frames = Core.Nothing, segment = Core.Nothing}
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_VideoAnnotationResults
                   ...
                   (o Core..:? "error") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "segmentPresenceLabelAnnotations")
          ...
          = Core.object
              (Core.catMaybes
                 [("error" Core..=) Core.<$> error,
                  ...
                  ("shotLabelAnnotations" Core..=) Core.<$>
                    shotLabelAnnotations,
                  ("shotPresenceLabelAnnotations" Core..=) Core.<$>
                    shotPresenceLabelAnnotations,
                  ("speechTranscriptions" Core..=) Core.<$>
                    speechTranscriptions,
                  ("textAnnotations" Core..=) Core.<$>
                    textAnnotations])
...
newGoogleCloudVideointelligenceV1_VideoSegment =
  GoogleCloudVideointelligenceV1_VideoSegment
    {endTimeOffset = Core.Nothing, startTimeOffset = Core.Nothing}
...
newGoogleCloudVideointelligenceV1p3beta1_CelebrityRecognitionAnnotation =
  GoogleCloudVideointelligenceV1p3beta1_CelebrityRecognitionAnnotation
    {celebrityTracks = Core.Nothing, version = Core.Nothing}
...
newGoogleCloudVideointelligenceV1p3beta1_CelebrityTrack =
  GoogleCloudVideointelligenceV1p3beta1_CelebrityTrack
    {celebrities = Core.Nothing, faceTrack = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("includeAttributes" Core..=) Core.<$>
                    includeAttributes,
                  ("includeBoundingBoxes" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("frameConfidenceThreshold" Core..=) Core.<$>
                  ...
                  ("labelDetectionMode" Core..=) Core.<$>
                    labelDetectionMode,
                  ("model" Core..=) Core.<$> model,
                  ("stationaryCamera" Core..=) Core.<$>
                    stationaryCamera,
          ...
          = Core.object
              (Core.catMaybes
                 [("includeAttributes" Core..=) Core.<$>
                  ...
                  ("includeBoundingBoxes" Core..=) Core.<$>
                    includeBoundingBoxes,
                  ("includePoseLandmarks" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("audioTracks" Core..=) Core.<$> audioTracks,
                  ...
                  ("enableWordConfidence" Core..=) Core.<$>
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("annotationResults" Core..=) Core.<$>
                    annotationResults,
                  ("annotationResultsUri" Core..=) Core.<$>
...
newGoogleCloudVideointelligenceV1p3beta1_TextDetectionConfig =
  GoogleCloudVideointelligenceV1p3beta1_TextDetectionConfig
    {languageHints = Core.Nothing, model = Core.Nothing}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationResults
                   Core.<$>
                   (o Core..:? "celebrityRecognitionAnnotations")
                     Core.<*> (o Core..:? "error")
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1p3beta1_VideoContext
                   Core.<$>
                   (o Core..:? "explicitContentDetectionConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("explicitContentDetectionConfig" Core..=) Core.<$>
                  ...
                  ("faceDetectionConfig" Core..=) Core.<$>
                    faceDetectionConfig,
                  ("labelDetectionConfig" Core..=) Core.<$>
                    labelDetectionConfig,
                  ("objectTrackingConfig" Core..=) Core.<$>
                    objectTrackingConfig,
                  ("personDetectionConfig" Core..=) Core.<$>
...
instance Core.FromJSON GoogleLongrunning_Operation
         where
        parseJSON
...
instance Core.ToJSON GoogleLongrunning_Operation
         where
...
instance Core.FromJSON GoogleRpc_Status_DetailsItem
         where
        parseJSON
          = Core.withObject "GoogleRpc_Status_DetailsItem"
              (\ o ->
                 GoogleRpc_Status_DetailsItem Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GoogleRpc_Status_DetailsItem
         where
