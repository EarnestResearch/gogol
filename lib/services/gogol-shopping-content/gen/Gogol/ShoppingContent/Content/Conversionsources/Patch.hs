                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ConversionSource Core.:>
                               Core.Patch '[Core.JSON] ConversionSource
...
newContentConversionsourcesPatch 
    ...
    -> ContentConversionsourcesPatch
newContentConversionsourcesPatch conversionSourceId merchantId
  payload
  = ContentConversionsourcesPatch{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  conversionSourceId = conversionSourceId, merchantId = merchantId,
                                  payload = payload, updateMask = Core.Nothing,
                                  uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentConversionsourcesPatch where
        type Rs ContentConversionsourcesPatch = ConversionSource
        type Scopes ContentConversionsourcesPatch = '[Content'FullControl]
        requestClient ContentConversionsourcesPatch{..}
          = go merchantId conversionSourceId xgafv accessToken callback
              updateMask
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentConversionsourcesPatchResource)
                      Core.mempty
