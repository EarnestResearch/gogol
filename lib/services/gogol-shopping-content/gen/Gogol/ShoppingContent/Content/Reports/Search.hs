                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] SearchRequest Core.:>
                             Core.Post '[Core.JSON] SearchResponse
...
instance Core.GoogleRequest ContentReportsSearch
         where
        type Rs ContentReportsSearch = SearchResponse
        type Scopes ContentReportsSearch =
             '[Content'FullControl]
        requestClient ContentReportsSearch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContentReportsSearchResource)
                      Core.mempty
