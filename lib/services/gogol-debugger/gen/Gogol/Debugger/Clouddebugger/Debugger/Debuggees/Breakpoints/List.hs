             ...
             "breakpoints" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "action.value"
                     DebuggerDebuggeesBreakpointsListActionValue
                     Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "clientVersion" Core.Text Core.:>
                         Core.QueryParam "includeAllUsers" Core.Bool Core.:>
                           Core.QueryParam "includeInactive" Core.Bool Core.:>
                             Core.QueryParam "stripResults" Core.Bool Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text
                                   Core.:>
                                   Core.QueryParam "waitToken" Core.Text Core.:>
...
instance Core.GoogleRequest
           ClouddebuggerDebuggerDebuggeesBreakpointsList
         where
        type Rs ClouddebuggerDebuggerDebuggeesBreakpointsList
             = ListBreakpointsResponse
        type Scopes
               ClouddebuggerDebuggerDebuggeesBreakpointsList
             =
        ...
        requestClient
          ClouddebuggerDebuggerDebuggeesBreakpointsList{..}
          = go debuggeeId xgafv accessToken actionValue
              callback
              clientVersion
              includeAllUsers
              includeInactive
