                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListDebuggeesResponse
...
instance Core.GoogleRequest
           ClouddebuggerDebuggerDebuggeesList
         where
        type Rs ClouddebuggerDebuggerDebuggeesList =
             ListDebuggeesResponse
        type Scopes ClouddebuggerDebuggerDebuggeesList =
             '[CloudPlatform'FullControl,
               CloudDebugger'FullControl]
        requestClient ClouddebuggerDebuggerDebuggeesList{..}
          = go xgafv accessToken callback clientVersion
              includeInactive
              project
              uploadType
              uploadProtocol
