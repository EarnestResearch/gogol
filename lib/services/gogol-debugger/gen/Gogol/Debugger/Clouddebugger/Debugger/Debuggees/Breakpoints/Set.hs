                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] Breakpoint Core.:>
                                   Core.Post '[Core.JSON] SetBreakpointResponse
...
instance Core.GoogleRequest
           ClouddebuggerDebuggerDebuggeesBreakpointsSet
         where
        type Rs ClouddebuggerDebuggerDebuggeesBreakpointsSet
        ...
        requestClient
          ClouddebuggerDebuggerDebuggeesBreakpointsSet{..}
          = go debuggeeId xgafv accessToken callback
              canaryOption
              clientVersion
              uploadType
              uploadProtocol
