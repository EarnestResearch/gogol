           ...
           Core.Capture "calendarId" Core.Text Core.:>
             "events" Core.:>
               Core.QueryParam "alwaysIncludeEmail" Core.Bool
                 Core.:>
                 Core.QueryParams "eventTypes" Core.Text Core.:>
                   Core.QueryParam "iCalUID" Core.Text Core.:>
                     Core.QueryParam "maxAttendees" Core.Int32 Core.:>
                       Core.QueryParam "maxResults" Core.Int32 Core.:>
                         Core.QueryParam "orderBy" EventsListOrderBy Core.:>
...
data CalendarEventsList = CalendarEventsList
    ...
    , calendarId :: Core.Text
      -- | Event types to return. Optional. Possible values are: - \"default\" - \"focusTime\" - \"outOfOffice\"This parameter can be repeated multiple times to return events of different types. Currently, this is the only allowed value for this field: - [\"default\", \"focusTime\", \"outOfOffice\"] This value will be the default.
      -- 
      -- If you\'re enrolled in the Working Location developer preview program, in addition to the default value above you can also set the \"workingLocation\" event type: - [\"default\", \"focusTime\", \"outOfOffice\", \"workingLocation\"] - [\"workingLocation\"] Additional combinations of these 4 event types will be made available in later releases. Developer Preview.
