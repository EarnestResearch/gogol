...
instance Core.FromJSON AclRule where
        parseJSON
          = Core.withObject "AclRule"
              (\ o ->
                 AclRule Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "calendar#aclRule")
                     Core.<*> (o Core..:? "role")
                     Core.<*> (o Core..:? "scope"))
...
instance Core.FromJSON Calendar where
        parseJSON
          = Core.withObject "Calendar"
              (\ o ->
                 Calendar Core.<$>
                   (o Core..:? "conferenceProperties") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "calendar#calendar")
...
instance Core.ToJSON Calendar where
        toJSON Calendar{..}
          = Core.object
              (Core.catMaybes
                 [("conferenceProperties" Core..=) Core.<$>
                    conferenceProperties,
...
instance Core.FromJSON CalendarList where
        parseJSON
          = Core.withObject "CalendarList"
              (\ o ->
                 CalendarList Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "calendar#calendarList")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "nextSyncToken"))
...
instance Core.FromJSON CalendarListEntry where
        parseJSON
          = Core.withObject "CalendarListEntry"
              (\ o ->
                 CalendarListEntry Core.<$>
                   (o Core..:? "accessRole") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("accessRole" Core..=) Core.<$> accessRole,
                  ...
                  Core.Just ("kind" Core..= kind),
                  ("location" Core..=) Core.<$> location,
                  ("notificationSettings" Core..=) Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "CalendarListEntry_NotificationSettings"
              (\ o ->
                 CalendarListEntry_NotificationSettings Core.<$>
                   (o Core..:? "notifications"))
...
instance Core.FromJSON CalendarNotification where
        parseJSON
          = Core.withObject "CalendarNotification"
              (\ o ->
                 CalendarNotification Core.<$>
                   (o Core..:? "method") Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON ColorDefinition where
        parseJSON
          = Core.withObject "ColorDefinition"
              (\ o ->
                 ColorDefinition Core.<$>
...
instance Core.FromJSON Colors where
        parseJSON
          = Core.withObject "Colors"
              (\ o ->
                 Colors Core.<$>
                   (o Core..:? "calendar") Core.<*> (o Core..:? "event")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "calendar#colors")
                     Core.<*> (o Core..:? "updated"))
...
newColors_Calendar 
    ...
    -> Colors_Calendar
newColors_Calendar additional = Colors_Calendar {additional = additional}

instance Core.FromJSON Colors_Calendar where
        parseJSON
          = Core.withObject "Colors_Calendar"
              (\ o ->
...
instance Core.FromJSON ConferenceData where
        parseJSON
          = Core.withObject "ConferenceData"
              (\ o ->
                 ConferenceData Core.<$>
                   (o Core..:? "conferenceId") Core.<*>
                     (o Core..:? "conferenceSolution")
...
instance Core.FromJSON ConferenceParameters where
        parseJSON
          = Core.withObject "ConferenceParameters"
              (\ o ->
                 ConferenceParameters Core.<$>
                   (o Core..:? "addOnParameters"))

instance Core.ToJSON ConferenceParameters where
        toJSON ConferenceParameters{..}
          = Core.object
              (Core.catMaybes
                 [("addOnParameters" Core..=) Core.<$>
                    addOnParameters])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ConferenceParametersAddOnParameters"
              (\ o ->
                 ConferenceParametersAddOnParameters Core.<$>
                   (o Core..:? "parameters"))
...
newConferenceParametersAddOnParameters_Parameters additional =
  ConferenceParametersAddOnParameters_Parameters {additional = additional}
...
instance Core.FromJSON ConferenceProperties where
        parseJSON
          = Core.withObject "ConferenceProperties"
              (\ o ->
                 ConferenceProperties Core.<$>
                   (o Core..:? "allowedConferenceSolutionTypes"))

instance Core.ToJSON ConferenceProperties where
        toJSON ConferenceProperties{..}
          = Core.object
              (Core.catMaybes
                 [("allowedConferenceSolutionTypes" Core..=) Core.<$>
...
instance Core.FromJSON ConferenceRequestStatus where
        parseJSON
          = Core.withObject "ConferenceRequestStatus"
              (\ o ->
                 ConferenceRequestStatus Core.<$>
                   (o Core..:? "statusCode"))
...
newConferenceSolution =
  ConferenceSolution
    {iconUri = Core.Nothing, key = Core.Nothing, name = Core.Nothing}

instance Core.FromJSON ConferenceSolution where
        parseJSON
          = Core.withObject "ConferenceSolution"
              (\ o ->
                 ConferenceSolution Core.<$>
                   (o Core..:? "iconUri") Core.<*> (o Core..:? "key")
                     Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON ConferenceSolutionKey where
        parseJSON
          = Core.withObject "ConferenceSolutionKey"
              (\ o ->
...
instance Core.FromJSON CreateConferenceRequest where
        parseJSON
          = Core.withObject "CreateConferenceRequest"
              (\ o ->
                 CreateConferenceRequest Core.<$>
                   (o Core..:? "conferenceSolutionKey") Core.<*>
                     (o Core..:? "requestId")
                     Core.<*> (o Core..:? "status"))
...
instance Core.ToJSON CreateConferenceRequest where
        toJSON CreateConferenceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("conferenceSolutionKey" Core..=) Core.<$>
                    conferenceSolutionKey,
...
instance Core.FromJSON EntryPoint where
        parseJSON
          = Core.withObject "EntryPoint"
              (\ o ->
                 EntryPoint Core.<$>
                   (o Core..:? "accessCode") Core.<*>
                     (o Core..:? "entryPointFeatures")
...
instance Core.FromJSON Error' where
        parseJSON
          = Core.withObject "Error'"
              (\ o ->
                 Error' Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "reason"))
...
data Event = Event
    ...
    , etag :: (Core.Maybe Core.Text)
      ...
      -- - \"default\" - A regular event or not further specified. - \"outOfOffice\" - An out-of-office event. - \"focusTime\" - A focus-time event. - \"workingLocation\" - A working location event. Developer Preview.
    , eventType :: Core.Text
...
instance Core.FromJSON Event where
        parseJSON
          = Core.withObject "Event"
              (\ o ->
                 Event Core.<$>
                   (o Core..:? "anyoneCanAddSelf" Core..!= Core.False)
                     Core.<*> (o Core..:? "attachments")
                     Core.<*> (o Core..:? "attendees")
                     Core.<*>
                     (o Core..:? "attendeesOmitted" Core..!= Core.False)
                     Core.<*> (o Core..:? "colorId")
                     ...
                     Core.<*> (o Core..:? "end")
                     Core.<*>
                     (o Core..:? "endTimeUnspecified" Core..!= Core.False)
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "eventType" Core..!= "default")
                     Core.<*> (o Core..:? "extendedProperties")
                     Core.<*> (o Core..:? "gadget")
                     Core.<*>
                     (o Core..:? "guestsCanInviteOthers" Core..!=
                        Core.True)
                     Core.<*>
                     (o Core..:? "guestsCanModify" Core..!= Core.False)
                     Core.<*>
                     (o Core..:? "guestsCanSeeOtherGuests" Core..!=
                        Core.True)
                     ...
                     Core.<*> (o Core..:? "summary")
                     Core.<*>
                     (o Core..:? "transparency" Core..!= "opaque")
                     Core.<*> (o Core..:? "updated")
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just
                  ...
                  ("extendedProperties" Core..=) Core.<$>
                    extendedProperties,
                  ("gadget" Core..=) Core.<$> gadget,
                  Core.Just
                    ("guestsCanInviteOthers" Core..=
                       guestsCanInviteOthers),
                  Core.Just
                    ("guestsCanModify" Core..= guestsCanModify),
                  Core.Just
                    ("guestsCanSeeOtherGuests" Core..=
                  ...
                  ("workingLocationProperties" Core..=) Core.<$>
...
instance Core.FromJSON Event_ExtendedProperties where
        parseJSON
          = Core.withObject "Event_ExtendedProperties"
              (\ o ->
                 Event_ExtendedProperties Core.<$>
                   (o Core..:? "private") Core.<*>
                     (o Core..:? "shared"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "Event_ExtendedProperties_Private"
              (\ o ->
                 Event_ExtendedProperties_Private Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Event_ExtendedProperties_Private
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "Event_ExtendedProperties_Shared"
              (\ o ->
                 Event_ExtendedProperties_Shared Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Event_ExtendedProperties_Shared
         where
...
instance Core.FromJSON Event_Gadget where
        parseJSON
          = Core.withObject "Event_Gadget"
              (\ o ->
                 Event_Gadget Core.<$>
                   (o Core..:? "display") Core.<*> (o Core..:? "height")
...
instance Core.FromJSON Event_Gadget_Preferences where
        parseJSON
          = Core.withObject "Event_Gadget_Preferences"
              (\ o ->
                 Event_Gadget_Preferences Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON Event_Organizer where
        parseJSON
          = Core.withObject "Event_Organizer"
              (\ o ->
                 Event_Organizer Core.<$>
                   (o Core..:? "displayName") Core.<*>
                     (o Core..:? "email")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "self" Core..!= Core.False))
...
instance Core.FromJSON Event_Reminders where
        parseJSON
          = Core.withObject "Event_Reminders"
              (\ o ->
                 Event_Reminders Core.<$>
                   (o Core..:? "overrides") Core.<*>
                     (o Core..:? "useDefault"))
...
instance Core.FromJSON Event_Source where
        parseJSON
          = Core.withObject "Event_Source"
              (\ o ->
                 Event_Source Core.<$>
                   (o Core..:? "title") Core.<*> (o Core..:? "url"))
...
instance Core.FromJSON EventAttachment where
        parseJSON
          = Core.withObject "EventAttachment"
              (\ o ->
                 EventAttachment Core.<$>
                   (o Core..:? "fileId") Core.<*> (o Core..:? "fileUrl")
                     Core.<*> (o Core..:? "iconLink")
...
instance Core.FromJSON EventAttendee where
        parseJSON
          = Core.withObject "EventAttendee"
              (\ o ->
                 EventAttendee Core.<$>
                   (o Core..:? "additionalGuests" Core..!= 0) Core.<*>
                     (o Core..:? "comment")
...
newEventDateTime =
  EventDateTime
    {date = Core.Nothing, dateTime = Core.Nothing, timeZone = Core.Nothing}

instance Core.FromJSON EventDateTime where
        parseJSON
          = Core.withObject "EventDateTime"
              (\ o ->
                 EventDateTime Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "dateTime")
                     Core.<*> (o Core..:? "timeZone"))
...
instance Core.FromJSON EventWorkingLocationProperties
         where
        parseJSON
          = Core.withObject "EventWorkingLocationProperties"
              (\ o ->
                 EventWorkingLocationProperties Core.<$>
                   (o Core..:? "customLocation") Core.<*>
                     (o Core..:? "homeOffice")
                     Core.<*> (o Core..:? "officeLocation"))

instance Core.ToJSON EventWorkingLocationProperties
         where
...
newEventWorkingLocationProperties_CustomLocation 
    ::  EventWorkingLocationProperties_CustomLocation
newEventWorkingLocationProperties_CustomLocation =
  EventWorkingLocationProperties_CustomLocation {label = Core.Nothing}
...
instance Core.FromJSON Events where
        parseJSON
          = Core.withObject "Events"
              (\ o ->
                 Events Core.<$>
                   (o Core..:? "accessRole") Core.<*>
                     (o Core..:? "defaultReminders")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "calendar#events")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "nextSyncToken")
                     Core.<*> (o Core..:? "summary")
                     Core.<*> (o Core..:? "timeZone")
...
instance Core.FromJSON FreeBusyCalendar where
        parseJSON
          = Core.withObject "FreeBusyCalendar"
              (\ o ->
                 FreeBusyCalendar Core.<$>
                   (o Core..:? "busy") Core.<*> (o Core..:? "errors"))
...
instance Core.FromJSON FreeBusyGroup where
        parseJSON
          = Core.withObject "FreeBusyGroup"
              (\ o ->
                 FreeBusyGroup Core.<$>
                   (o Core..:? "calendars") Core.<*>
                     (o Core..:? "errors"))
...
instance Core.FromJSON FreeBusyRequest where
        parseJSON
          = Core.withObject "FreeBusyRequest"
              (\ o ->
                 FreeBusyRequest Core.<$>
                   (o Core..:? "calendarExpansionMax") Core.<*>
                     (o Core..:? "groupExpansionMax")
                     Core.<*> (o Core..:? "items")
                     Core.<*> (o Core..:? "timeMax")
                     Core.<*> (o Core..:? "timeMin")
...
instance Core.ToJSON FreeBusyRequest where
        toJSON FreeBusyRequest{..}
          = Core.object
              (Core.catMaybes
                 [("calendarExpansionMax" Core..=) Core.<$>
                    calendarExpansionMax,
                  ("groupExpansionMax" Core..=) Core.<$>
                    groupExpansionMax,
                  ("items" Core..=) Core.<$> items,
...
instance Core.FromJSON FreeBusyRequestItem where
        parseJSON
          = Core.withObject "FreeBusyRequestItem"
              (\ o ->
...
instance Core.FromJSON FreeBusyResponse where
        parseJSON
          = Core.withObject "FreeBusyResponse"
              (\ o ->
                 FreeBusyResponse Core.<$>
                   (o Core..:? "calendars") Core.<*>
                     (o Core..:? "groups")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "calendar#freeBusy")
                     Core.<*> (o Core..:? "timeMax")
                     Core.<*> (o Core..:? "timeMin"))
...
instance Core.FromJSON FreeBusyResponse_Calendars
         where
        parseJSON
          = Core.withObject "FreeBusyResponse_Calendars"
              (\ o ->
                 FreeBusyResponse_Calendars Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON FreeBusyResponse_Groups where
        parseJSON
          = Core.withObject "FreeBusyResponse_Groups"
              (\ o ->
                 FreeBusyResponse_Groups Core.<$>
                   (Core.parseJSONObject o))
          ...
          = Core.withObject "Setting"
              (\ o ->
                 Setting Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "calendar#setting")
                     Core.<*> (o Core..:? "value"))
          ...
          = Core.withObject "Settings"
              (\ o ->
                 Settings Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "calendar#settings")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "nextSyncToken"))
