...
instance Core.FromJSON Alias where
        parseJSON
          = Core.withObject "Alias"
              (\ o ->
                 Alias Core.<$>
                   (o Core..:? "alias") Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#alias")
...
instance Core.FromJSON Aliases where
        parseJSON
          = Core.withObject "Aliases"
              (\ o ->
                 Aliases Core.<$>
                   (o Core..:? "aliases") Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "admin#directory#aliases"))
              ...
              (\ o ->
                 Asp Core.<$>
                   (o Core..:? "codeId") Core.<*>
                     ...
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#asp")
                     Core.<*>
                     (o Core..:? "lastTimeUsed" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "userKey"))
          ...
          = Core.object
              (Core.catMaybes
                 [("codeId" Core..=) Core.<$> codeId,
                  ...
                  ("etag" Core..=) Core.<$> etag,
                  Core.Just ("kind" Core..= kind),
                  ("lastTimeUsed" Core..=) Core.. Core.AsText Core.<$>
                    lastTimeUsed,
                  ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON BatchCreatePrintServersRequest
         where
        parseJSON
          = Core.withObject "BatchCreatePrintServersRequest"
              (\ o ->
                 BatchCreatePrintServersRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON BatchCreatePrintServersRequest
         where
...
newBatchCreatePrintServersResponse =
  BatchCreatePrintServersResponse
    {failures = Core.Nothing, printServers = Core.Nothing}
          ...
          = Core.withObject "BatchCreatePrintServersResponse"
              (\ o ->
                 BatchCreatePrintServersResponse Core.<$>
                   (o Core..:? "failures") Core.<*>
                     (o Core..:? "printServers"))

instance Core.ToJSON BatchCreatePrintServersResponse
         where
...
instance Core.FromJSON BatchCreatePrintersRequest
         where
        parseJSON
          = Core.withObject "BatchCreatePrintersRequest"
              (\ o ->
                 BatchCreatePrintersRequest Core.<$>
                   (o Core..:? "requests"))
...
instance Core.FromJSON BatchCreatePrintersResponse
         where
        parseJSON
...
instance Core.ToJSON BatchCreatePrintersResponse
         where
...
instance Core.FromJSON BatchDeletePrintServersRequest
         where
        parseJSON
...
instance Core.ToJSON BatchDeletePrintServersRequest
         where
...
newBatchDeletePrintServersResponse =
  BatchDeletePrintServersResponse
    {failedPrintServers = Core.Nothing, printServerIds = Core.Nothing}
...
instance Core.ToJSON BatchDeletePrintServersResponse
         where
        toJSON BatchDeletePrintServersResponse{..}
          = Core.object
              (Core.catMaybes
                 [("failedPrintServers" Core..=) Core.<$>
                    failedPrintServers,
                  ("printServerIds" Core..=) Core.<$> printServerIds])
...
instance Core.FromJSON BatchDeletePrintersRequest
         where
        parseJSON
          = Core.withObject "BatchDeletePrintersRequest"
              (\ o ->
                 BatchDeletePrintersRequest Core.<$>
                   (o Core..:? "printerIds"))
...
newBatchDeletePrintersResponse =
  BatchDeletePrintersResponse
    {failedPrinters = Core.Nothing, printerIds = Core.Nothing}

instance Core.FromJSON BatchDeletePrintersResponse
         where
        parseJSON
          = Core.withObject "BatchDeletePrintersResponse"
              (\ o ->
                 BatchDeletePrintersResponse Core.<$>
                   (o Core..:? "failedPrinters") Core.<*>
                     (o Core..:? "printerIds"))

instance Core.ToJSON BatchDeletePrintersResponse
         where
...
instance Core.FromJSON Buildings where
        parseJSON
          = Core.withObject "Buildings"
              (\ o ->
                 Buildings Core.<$>
                   (o Core..:? "buildings") Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.ToJSON ChromeOsDevice where
        toJSON ChromeOsDevice{..}
          = Core.object
              (Core.catMaybes
                 [("activeTimeRanges" Core..=) Core.<$>
                    activeTimeRanges,
                  ("annotatedAssetId" Core..=) Core.<$>
                    annotatedAssetId,
                  ("annotatedLocation" Core..=) Core.<$>
                    annotatedLocation,
                  ...
                  ("cpuStatusReports" Core..=) Core.<$>
                    cpuStatusReports,
                  ("deprovisionReason" Core..=) Core.<$>
                    deprovisionReason,
                  ("deviceFiles" Core..=) Core.<$> deviceFiles,
                  ("deviceId" Core..=) Core.<$> deviceId,
                  ("diskVolumeReports" Core..=) Core.<$>
                    diskVolumeReports,
                  ("dockMacAddress" Core..=) Core.<$> dockMacAddress,
                  ("etag" Core..=) Core.<$> etag,
                  ("ethernetMacAddress" Core..=) Core.<$>
                    ethernetMacAddress,
                  ("ethernetMacAddress0" Core..=) Core.<$>
                    ethernetMacAddress0,
                  ("firmwareVersion" Core..=) Core.<$> firmwareVersion,
                  ("firstEnrollmentTime" Core..=) Core.<$>
                    firstEnrollmentTime,
                  Core.Just ("kind" Core..= kind),
                  ("lastDeprovisionTimestamp" Core..=) Core.<$>
                    lastDeprovisionTimestamp,
                  ("lastEnrollmentTime" Core..=) Core.<$>
                    lastEnrollmentTime,
                  ("lastKnownNetwork" Core..=) Core.<$>
                    lastKnownNetwork,
                  ...
                  ("systemRamFreeReports" Core..=) Core.<$>
...
newChromeOsDevice_ActiveTimeRangesItem =
  ChromeOsDevice_ActiveTimeRangesItem
    {activeTime = Core.Nothing, date = Core.Nothing}
...
instance Core.FromJSON ChromeOsDevice_CpuInfoItem
         where
        parseJSON
...
newChromeOsDevice_CpuInfoItem_LogicalCpusItem_CStatesItem =
  ChromeOsDevice_CpuInfoItem_LogicalCpusItem_CStatesItem
    {displayName = Core.Nothing, sessionDuration = Core.Nothing}
...
newChromeOsDevice_CpuStatusReportsItem_CpuTemperatureInfoItem =
  ChromeOsDevice_CpuStatusReportsItem_CpuTemperatureInfoItem
    {label = Core.Nothing, temperature = Core.Nothing}
...
instance Core.FromJSON ChromeOsDevice_DeviceFilesItem
         where
        parseJSON
...
instance Core.ToJSON ChromeOsDevice_DeviceFilesItem
         where
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 ChromeOsDevice_DiskVolumeReportsItem_VolumeInfoItem
                   Core.<$>
                   (o Core..:? "storageFree" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "storageTotal" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("storageFree" Core..=) Core.. Core.AsText Core.<$>
                    storageFree,
                  ("storageTotal" Core..=) Core.. Core.AsText Core.<$>
                    storageTotal,
...
newChromeOsDevice_LastKnownNetworkItem =
  ChromeOsDevice_LastKnownNetworkItem
    {ipAddress = Core.Nothing, wanIpAddress = Core.Nothing}
...
instance Core.FromJSON ChromeOsDevice_RecentUsersItem
         where
        parseJSON
...
instance Core.ToJSON ChromeOsDevice_RecentUsersItem
         where
...
newChromeOsDevice_SystemRamFreeReportsItem =
  ChromeOsDevice_SystemRamFreeReportsItem
    {reportTime = Core.Nothing, systemRamFreeInfo = Core.Nothing}
...
instance Core.FromJSON ChromeOsDevice_TpmVersionInfo
         where
        parseJSON
          ...
          = Core.withObject "ChromeOsDevices"
              (\ o ->
                 ChromeOsDevices Core.<$>
                   (o Core..:? "chromeosdevices") Core.<*>
                     (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "admin#directory#chromeosdevices")
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.object
              (Core.catMaybes
                 [("alternateEmail" Core..=) Core.<$> alternateEmail,
                  ("customerCreationTime" Core..=) Core.<$>
...
instance Core.ToJSON DirectoryChromeosdevicesCommand
         where
        toJSON DirectoryChromeosdevicesCommand{..}
          = Core.object
              (Core.catMaybes
                 [("commandExpireTime" Core..=) Core.<$>
                    commandExpireTime,
...
instance Core.ToJSON
        ...
        toJSON DirectoryChromeosdevicesCommandResult{..}
          = Core.object
              (Core.catMaybes
                 [("commandResultPayload" Core..=) Core.<$>
...
newDirectoryChromeosdevicesIssueCommandRequest =
  DirectoryChromeosdevicesIssueCommandRequest
    {commandType = Core.Nothing, payload = Core.Nothing}
...
instance Core.FromJSON DomainAliases where
        parseJSON
          = Core.withObject "DomainAliases"
              (\ o ->
                 DomainAliases Core.<$>
                   (o Core..:? "domainAliases") Core.<*>
                     (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "admin#directory#domainAliases"))
              ...
              (\ o ->
                 Domains Core.<$>
                   (o Core..:? "creationTime" Core.<&>
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#domain")
                     Core.<*> (o Core..:? "verified"))
...
instance Core.FromJSON Domains2 where
        parseJSON
          = Core.withObject "Domains2"
              (\ o ->
                 Domains2 Core.<$>
                   (o Core..:? "domains") Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON Features where
        parseJSON
          = Core.withObject "Features"
              (\ o ->
                 Features Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "features")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
              ...
              (\ o ->
                 Group Core.<$>
                   (o Core..:? "adminCreated") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#group")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON Groups where
        parseJSON
          = Core.withObject "Groups"
              (\ o ->
                 Groups Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "groups")
                     Core.<*>
...
newListPrintServersResponse =
  ListPrintServersResponse
    {nextPageToken = Core.Nothing, printServers = Core.Nothing}
...
newListPrinterModelsResponse =
  ListPrinterModelsResponse
    {nextPageToken = Core.Nothing, printerModels = Core.Nothing}

instance Core.FromJSON ListPrinterModelsResponse
         where
        parseJSON
...
instance Core.FromJSON Member where
        parseJSON
          = Core.withObject "Member"
              (\ o ->
                 Member Core.<$>
                   (o Core..:? "delivery_settings") Core.<*>
                     (o Core..:? "email")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#member")
                     Core.<*> (o Core..:? "role")
                     Core.<*> (o Core..:? "status")
                     Core.<*> (o Core..:? "type"))
              ...
              (\ o ->
                 MobileDevice Core.<$>
                   (o Core..:? "adbStatus") Core.<*>
                     ...
                     Core.<*> (o Core..:? "lastSync")
                     Core.<*>
                     (o Core..:? "managedAccountIsOnOwnerProfile")
                     Core.<*> (o Core..:? "manufacturer")
                     Core.<*> (o Core..:? "meid")
                     Core.<*> (o Core..:? "model")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("adbStatus" Core..=) Core.<$> adbStatus,
                  ...
                  ("developerOptionsStatus" Core..=) Core.<$>
                    developerOptionsStatus,
                  ("deviceCompromisedStatus" Core..=) Core.<$>
                    deviceCompromisedStatus,
                  ("deviceId" Core..=) Core.<$> deviceId,
                  ("devicePasswordStatus" Core..=) Core.<$>
                  ...
                  ("supportsWorkProfile" Core..=) Core.<$>
                    supportsWorkProfile,
                  ("type" Core..=) Core.<$> type',
                  ("unknownSourcesStatus" Core..=) Core.<$>
...
instance Core.FromJSON MobileDevice_ApplicationsItem
         where
        parseJSON
...
instance Core.ToJSON MobileDevice_ApplicationsItem
         where
...
data OrgUnit = OrgUnit
    {
      -- | Determines if a sub-organizational unit can inherit the settings of the parent organization. The default value is @false@, meaning a sub-organizational unit inherits the settings of the nearest parent organizational unit. We recommend using the default value because setting @block_inheritance@ to @true@ can have /unintended consequences/. For more information about inheritance and users in an organization structure, see the <https://support.google.com/a/answer/4352075 administration help center>.
          ...
          = Core.object
              (Core.catMaybes
                 [("rebootTime" Core..=) Core.<$> rebootTime,
                  ("state" Core..=) Core.<$> state,
                  ("targetKioskAppVersion" Core..=) Core.<$>
        ...
        parseJSON
          = Core.withObject "Role"
              (\ o ->
                 Role Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "isSuperAdminRole")
                     Core.<*> (o Core..:? "isSystemRole")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#role")
              ...
              (\ o ->
                 Schema Core.<$>
                   (o Core..:? "displayName") Core.<*>
                     ...
                     Core.<*> (o Core..:? "fields")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#schema")
...
instance Core.FromJSON Token where
        parseJSON
          = Core.withObject "Token"
              (\ o ->
                 Token Core.<$>
                   (o Core..:? "anonymous") Core.<*>
                     (o Core..:? "clientId")
                     Core.<*> (o Core..:? "displayText")
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#token")
...
-- | The Directory API allows you to create and manage your account\'s users, user aliases, and user Google profile photos. For more information about common tasks, see the </admin-sdk/directory/v1/guides/manage-users.html User Accounts Developer\'s Guide> and the </admin-sdk/directory/v1/guides/manage-user-aliases.html User Aliases Developer\'s Guide>.
--
...
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User"
              (\ o ->
                 User Core.<$>
                   (o Core..:? "addresses") Core.<*>
                     (o Core..:? "agreedToTerms")
                     Core.<*> (o Core..:? "aliases")
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#user")
              ...
              (Core.catMaybes
                 [("addresses" Core..=) Core.<$> addresses,
                  ...
                  ("suspensionReason" Core..=) Core.<$>
                    suspensionReason,
                  ("thumbnailPhotoEtag" Core..=) Core.<$>
                    thumbnailPhotoEtag,
                  ("thumbnailPhotoUrl" Core..=) Core.<$>
                    thumbnailPhotoUrl,
...
newUser_CustomSchemas 
    ::  Core.HashMap Core.Text UserCustomProperties
       -- ^  See 'additional'.
    -> User_CustomSchemas
newUser_CustomSchemas additional = User_CustomSchemas {additional = additional}
...
newUserExternalId =
  UserExternalId
    {customType = Core.Nothing, type' = Core.Nothing, value = Core.Nothing}
...
instance Core.FromJSON UserPhoto where
        parseJSON
          = Core.withObject "UserPhoto"
              (\ o ->
                 UserPhoto Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "height")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
              ...
              (\ o ->
                 UserPosixAccount Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "uid" Core.<&> Core.fmap Core.fromAsText)
