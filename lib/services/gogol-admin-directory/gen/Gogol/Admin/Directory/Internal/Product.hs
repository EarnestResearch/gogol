...
newAlias 
    ::  Alias
newAlias
  = Alias{alias = Core.Nothing, etag = Core.Nothing,
          id = Core.Nothing, kind = "admin#directory#alias",
          primaryEmail = Core.Nothing}
instance Core.FromJSON Alias where
        parseJSON
          = Core.withObject "Alias"
              (\ o ->
                 Alias Core.<$>
                   (o Core..:? "alias") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "id")
...
instance Core.ToJSON Alias where
        toJSON Alias{..}
          = Core.object
              (Core.catMaybes
                 [("alias" Core..=) Core.<$> alias, ("etag" Core..=) Core.<$> etag,
...
newAliases 
    ::  Aliases
newAliases
  = Aliases{aliases = Core.Nothing, etag = Core.Nothing,
            kind = "admin#directory#aliases"}
instance Core.FromJSON Aliases where
        parseJSON
          = Core.withObject "Aliases"
              (\ o ->
                 Aliases Core.<$>
                   (o Core..:? "aliases") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#aliases"))
...
newAsp 
    ::  Asp
newAsp
  = Asp{codeId = Core.Nothing, creationTime = Core.Nothing,
        etag = Core.Nothing, kind = "admin#directory#asp",
        lastTimeUsed = Core.Nothing, name = Core.Nothing,
              ...
              (\ o ->
                 Asp Core.<$>
                   (o Core..:? "codeId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "lastTimeUsed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "userKey"))
          ...
          = Core.object
              (Core.catMaybes
                 [("codeId" Core..=) Core.<$> codeId,
                  ...
                  ("etag" Core..=) Core.<$> etag, Core.Just ("kind" Core..= kind),
                  ("lastTimeUsed" Core..=) Core.. Core.AsText Core.<$> lastTimeUsed,
                  ("name" Core..=) Core.<$> name,
...
newAsps 
    ::  Asps
newAsps
  = Asps{etag = Core.Nothing, items = Core.Nothing,
         kind = "admin#directory#aspList"}
instance Core.FromJSON Asps where
        parseJSON
          = Core.withObject "Asps"
              (\ o ->
                 Asps Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#aspList"))
...
newAuxiliaryMessage 
    ::  AuxiliaryMessage
newAuxiliaryMessage
  = AuxiliaryMessage{auxiliaryMessage = Core.Nothing,
                     fieldMask = Core.Nothing, severity = Core.Nothing}
instance Core.FromJSON AuxiliaryMessage where
        parseJSON
          = Core.withObject "AuxiliaryMessage"
              (\ o ->
                 AuxiliaryMessage Core.<$>
                   (o Core..:? "auxiliaryMessage") Core.<*> (o Core..:? "fieldMask")
...
instance Core.ToJSON AuxiliaryMessage where
        toJSON AuxiliaryMessage{..}
          = Core.object
              (Core.catMaybes
                 [("auxiliaryMessage" Core..=) Core.<$> auxiliaryMessage,
...
--
-- /See:/ 'newBacklightInfo' smart constructor.
data BacklightInfo = BacklightInfo
    {
      -- | Output only. Current brightness of the backlight, between 0 and max_brightness.
      brightness :: (Core.Maybe Core.Int32)
      -- | Output only. Maximum brightness for the backlight.
    , maxBrightness :: (Core.Maybe Core.Int32)
      -- | Output only. Path to this backlight on the system. Useful if the caller needs to correlate with other information.
    , path :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BacklightInfo' with the minimum fields required to make a request.
newBacklightInfo 
    ::  BacklightInfo
newBacklightInfo
  = BacklightInfo{brightness = Core.Nothing,
                  maxBrightness = Core.Nothing, path = Core.Nothing}
instance Core.FromJSON BacklightInfo where
        parseJSON
          = Core.withObject "BacklightInfo"
              (\ o ->
                 BacklightInfo Core.<$>
                   (o Core..:? "brightness") Core.<*> (o Core..:? "maxBrightness")
                     Core.<*> (o Core..:? "path"))

instance Core.ToJSON BacklightInfo where
        toJSON BacklightInfo{..}
          = Core.object
              (Core.catMaybes
                 [("brightness" Core..=) Core.<$> brightness,
                  ("maxBrightness" Core..=) Core.<$> maxBrightness,
                  ("path" Core..=) Core.<$> path])


-- | A request for changing the status of a batch of ChromeOS devices.
--
-- /See:/ 'newBatchChangeChromeOsDeviceStatusRequest' smart constructor.
data BatchChangeChromeOsDeviceStatusRequest = BatchChangeChromeOsDeviceStatusRequest
    {
      -- | Required. The action to take on the ChromeOS device in order to change its status.
      changeChromeOsDeviceStatusAction :: (Core.Maybe
...
-- | Creates a value of 'BatchChangeChromeOsDeviceStatusRequest' with the minimum fields required to make a request.
newBatchChangeChromeOsDeviceStatusRequest 
    :: 
                                          BatchChangeChromeOsDeviceStatusRequest
newBatchChangeChromeOsDeviceStatusRequest
  = BatchChangeChromeOsDeviceStatusRequest{changeChromeOsDeviceStatusAction
                                             = Core.Nothing,
                                           deprovisionReason = Core.Nothing,
                                           deviceIds = Core.Nothing}
instance Core.FromJSON BatchChangeChromeOsDeviceStatusRequest where
        parseJSON
          = Core.withObject "BatchChangeChromeOsDeviceStatusRequest"
              (\ o ->
                 BatchChangeChromeOsDeviceStatusRequest Core.<$>
                   (o Core..:? "changeChromeOsDeviceStatusAction") Core.<*>
                     (o Core..:? "deprovisionReason")
                     Core.<*> (o Core..:? "deviceIds"))

instance Core.ToJSON BatchChangeChromeOsDeviceStatusRequest where
        toJSON BatchChangeChromeOsDeviceStatusRequest{..}
          = Core.object
              (Core.catMaybes
                 [("changeChromeOsDeviceStatusAction" Core..=) Core.<$>
                    changeChromeOsDeviceStatusAction,
                  ("deprovisionReason" Core..=) Core.<$> deprovisionReason,
                  ("deviceIds" Core..=) Core.<$> deviceIds])


-- | The response of changing the status of a batch of ChromeOS devices.
--
-- /See:/ 'newBatchChangeChromeOsDeviceStatusResponse' smart constructor.
newtype BatchChangeChromeOsDeviceStatusResponse = BatchChangeChromeOsDeviceStatusResponse
    {
...
-- | Creates a value of 'BatchChangeChromeOsDeviceStatusResponse' with the minimum fields required to make a request.
newBatchChangeChromeOsDeviceStatusResponse 
    :: 
                                           BatchChangeChromeOsDeviceStatusResponse
newBatchChangeChromeOsDeviceStatusResponse
  = BatchChangeChromeOsDeviceStatusResponse{changeChromeOsDeviceStatusResults
                                              = Core.Nothing}
instance Core.FromJSON BatchChangeChromeOsDeviceStatusResponse
         where
        parseJSON
          = Core.withObject "BatchChangeChromeOsDeviceStatusResponse"
              (\ o ->
                 BatchChangeChromeOsDeviceStatusResponse Core.<$>
                   (o Core..:? "changeChromeOsDeviceStatusResults"))

instance Core.ToJSON BatchChangeChromeOsDeviceStatusResponse where
        toJSON BatchChangeChromeOsDeviceStatusResponse{..}
          = Core.object
              (Core.catMaybes
                 [("changeChromeOsDeviceStatusResults" Core..=) Core.<$>
...
instance Core.FromJSON BatchCreatePrintServersRequest where
        parseJSON
          = Core.withObject "BatchCreatePrintServersRequest"
              (\ o ->
                 BatchCreatePrintServersRequest Core.<$> (o Core..:? "requests"))
...
newBatchCreatePrintServersResponse 
    :: 
                                   BatchCreatePrintServersResponse
newBatchCreatePrintServersResponse
  = BatchCreatePrintServersResponse{failures = Core.Nothing,
                                    printServers = Core.Nothing}
instance Core.FromJSON BatchCreatePrintServersResponse where
        parseJSON
          = Core.withObject "BatchCreatePrintServersResponse"
              (\ o ->
                 BatchCreatePrintServersResponse Core.<$>
                   (o Core..:? "failures") Core.<*> (o Core..:? "printServers"))
...
instance Core.FromJSON BatchCreatePrintersRequest where
        parseJSON
          = Core.withObject "BatchCreatePrintersRequest"
              (\ o ->
                 BatchCreatePrintersRequest Core.<$> (o Core..:? "requests"))
...
newBatchCreatePrintersResponse 
    ::  BatchCreatePrintersResponse
newBatchCreatePrintersResponse
  = BatchCreatePrintersResponse{failures = Core.Nothing,
                                printers = Core.Nothing}
instance Core.FromJSON BatchCreatePrintersResponse where
        parseJSON
          = Core.withObject "BatchCreatePrintersResponse"
              (\ o ->
                 BatchCreatePrintersResponse Core.<$>
                   (o Core..:? "failures") Core.<*> (o Core..:? "printers"))
...
instance Core.FromJSON BatchDeletePrintServersRequest where
        parseJSON
          = Core.withObject "BatchDeletePrintServersRequest"
              (\ o ->
                 BatchDeletePrintServersRequest Core.<$>
                   (o Core..:? "printServerIds"))
...
newBatchDeletePrintServersResponse 
    :: 
                                   BatchDeletePrintServersResponse
newBatchDeletePrintServersResponse
  = BatchDeletePrintServersResponse{failedPrintServers =
                                      Core.Nothing,
                                    printServerIds = Core.Nothing}
instance Core.FromJSON BatchDeletePrintServersResponse where
        parseJSON
          = Core.withObject "BatchDeletePrintServersResponse"
              (\ o ->
                 BatchDeletePrintServersResponse Core.<$>
                   (o Core..:? "failedPrintServers") Core.<*>
                     (o Core..:? "printServerIds"))
...
instance Core.ToJSON BatchDeletePrintServersResponse where
        toJSON BatchDeletePrintServersResponse{..}
          = Core.object
              (Core.catMaybes
                 [("failedPrintServers" Core..=) Core.<$> failedPrintServers,
                  ("printServerIds" Core..=) Core.<$> printServerIds])
...
instance Core.FromJSON BatchDeletePrintersRequest where
        parseJSON
          = Core.withObject "BatchDeletePrintersRequest"
              (\ o ->
                 BatchDeletePrintersRequest Core.<$> (o Core..:? "printerIds"))

instance Core.ToJSON BatchDeletePrintersRequest where
        toJSON BatchDeletePrintersRequest{..}
          = Core.object
              (Core.catMaybes [("printerIds" Core..=) Core.<$> printerIds])
...
newBatchDeletePrintersResponse 
    ::  BatchDeletePrintersResponse
newBatchDeletePrintersResponse
  = BatchDeletePrintersResponse{failedPrinters = Core.Nothing,
                                printerIds = Core.Nothing}
instance Core.FromJSON BatchDeletePrintersResponse where
        parseJSON
          = Core.withObject "BatchDeletePrintersResponse"
              (\ o ->
                 BatchDeletePrintersResponse Core.<$>
                   (o Core..:? "failedPrinters") Core.<*> (o Core..:? "printerIds"))
...
newBuilding 
    ::  Building
newBuilding
  = Building{address = Core.Nothing, buildingId = Core.Nothing,
             buildingName = Core.Nothing, coordinates = Core.Nothing,
             description = Core.Nothing, etags = Core.Nothing,
             floorNames = Core.Nothing,
             kind = "admin#directory#resources#buildings#Building"}
instance Core.FromJSON Building where
        parseJSON
          = Core.withObject "Building"
              (\ o ->
                 Building Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "buildingId") Core.<*>
                     (o Core..:? "buildingName")
...
newBuildingAddress 
    ::  BuildingAddress
newBuildingAddress
  = BuildingAddress{addressLines = Core.Nothing,
                    administrativeArea = Core.Nothing, languageCode = Core.Nothing,
                    locality = Core.Nothing, postalCode = Core.Nothing,
                    regionCode = Core.Nothing, sublocality = Core.Nothing}
instance Core.FromJSON BuildingAddress where
        parseJSON
          = Core.withObject "BuildingAddress"
              (\ o ->
                 BuildingAddress Core.<$>
...
newBuildingCoordinates 
    ::  BuildingCoordinates
newBuildingCoordinates
  = BuildingCoordinates{latitude = Core.Nothing,
                        longitude = Core.Nothing}
instance Core.FromJSON BuildingCoordinates where
        parseJSON
          = Core.withObject "BuildingCoordinates"
              (\ o ->
                 BuildingCoordinates Core.<$>
...
newBuildings 
    ::  Buildings
newBuildings
  = Buildings{buildings = Core.Nothing, etag = Core.Nothing,
              kind = "admin#directory#resources#buildings#buildingsList",
              nextPageToken = Core.Nothing}
instance Core.FromJSON Buildings where
        parseJSON
          = Core.withObject "Buildings"
              (\ o ->
                 Buildings Core.<$>
                   (o Core..:? "buildings") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!=
...
--
-- /See:/ 'newByteUsage' smart constructor.
data ByteUsage = ByteUsage
    {
      -- | Output only. The total capacity value, in bytes.
      capacityBytes :: (Core.Maybe Core.Int64)
      -- | Output only. The current usage value, in bytes.
    , usedBytes :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ByteUsage' with the minimum fields required to make a request.
newByteUsage 
    ::  ByteUsage
newByteUsage
  = ByteUsage{capacityBytes = Core.Nothing, usedBytes = Core.Nothing}
instance Core.FromJSON ByteUsage where
        parseJSON
          = Core.withObject "ByteUsage"
              (\ o ->
                 ByteUsage Core.<$>
                   (o Core..:? "capacityBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "usedBytes" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON ByteUsage where
        toJSON ByteUsage{..}
          = Core.object
              (Core.catMaybes
                 [("capacityBytes" Core..=) Core.. Core.AsText Core.<$>
                    capacityBytes,
                  ("usedBytes" Core..=) Core.. Core.AsText Core.<$> usedBytes])
...
newCalendarResource 
    ::  CalendarResource
newCalendarResource
  = CalendarResource{buildingId = Core.Nothing,
                     capacity = Core.Nothing, etags = Core.Nothing,
                     featureInstances = Core.Nothing, floorName = Core.Nothing,
                     floorSection = Core.Nothing, generatedResourceName = Core.Nothing,
                     kind = "admin#directory#resources#calendars#CalendarResource",
                     resourceCategory = Core.Nothing,
                     resourceDescription = Core.Nothing, resourceEmail = Core.Nothing,
                     resourceId = Core.Nothing, resourceName = Core.Nothing,
                     resourceType = Core.Nothing, userVisibleDescription = Core.Nothing}
instance Core.FromJSON CalendarResource where
        parseJSON
          = Core.withObject "CalendarResource"
              (\ o ->
                 CalendarResource Core.<$>
                   (o Core..:? "buildingId") Core.<*> (o Core..:? "capacity") Core.<*>
                     (o Core..:? "etags")
          ...
          = Core.object
              (Core.catMaybes
                 [("buildingId" Core..=) Core.<$> buildingId,
                  ...
                  ("etags" Core..=) Core.<$> etags,
                  ("featureInstances" Core..=) Core.<$> featureInstances,
                  ("floorName" Core..=) Core.<$> floorName,
                  ("floorSection" Core..=) Core.<$> floorSection,
                  ("generatedResourceName" Core..=) Core.<$> generatedResourceName,
                  Core.Just ("kind" Core..= kind),
                  ("resourceCategory" Core..=) Core.<$> resourceCategory,
                  ("resourceDescription" Core..=) Core.<$> resourceDescription,
                  ("resourceEmail" Core..=) Core.<$> resourceEmail,
                  ("resourceId" Core..=) Core.<$> resourceId,
                  ("resourceName" Core..=) Core.<$> resourceName,
                  ("resourceType" Core..=) Core.<$> resourceType,
                  ("userVisibleDescription" Core..=) Core.<$>
...
newCalendarResources 
    ::  CalendarResources
newCalendarResources
  = CalendarResources{etag = Core.Nothing, items = Core.Nothing,
                      kind = "admin#directory#resources#calendars#calendarResourcesList",
                      nextPageToken = Core.Nothing}
instance Core.FromJSON CalendarResources where
        parseJSON
          = Core.withObject "CalendarResources"
              (\ o ->
                 CalendarResources Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!=
...
--
-- /See:/ 'newChangeChromeOsDeviceStatusResult' smart constructor.
data ChangeChromeOsDeviceStatusResult = ChangeChromeOsDeviceStatusResult
    {
    ...
    , response :: (Core.Maybe ChangeChromeOsDeviceStatusSucceeded)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ChangeChromeOsDeviceStatusResult' with the minimum fields required to make a request.
newChangeChromeOsDeviceStatusResult 
    :: 
                                    ChangeChromeOsDeviceStatusResult
newChangeChromeOsDeviceStatusResult
  = ChangeChromeOsDeviceStatusResult{deviceId = Core.Nothing,
                                     error = Core.Nothing, response = Core.Nothing}
instance Core.FromJSON ChangeChromeOsDeviceStatusResult where
        parseJSON
          = Core.withObject "ChangeChromeOsDeviceStatusResult"
              (\ o ->
                 ChangeChromeOsDeviceStatusResult Core.<$>
                   (o Core..:? "deviceId") Core.<*> (o Core..:? "error") Core.<*>
                     (o Core..:? "response"))

instance Core.ToJSON ChangeChromeOsDeviceStatusResult where
        toJSON ChangeChromeOsDeviceStatusResult{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newChangeChromeOsDeviceStatusSucceeded' smart constructor.
data ChangeChromeOsDeviceStatusSucceeded = ChangeChromeOsDeviceStatusSucceeded
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ChangeChromeOsDeviceStatusSucceeded' with the minimum fields required to make a request.
newChangeChromeOsDeviceStatusSucceeded 
    :: 
                                       ChangeChromeOsDeviceStatusSucceeded
newChangeChromeOsDeviceStatusSucceeded
  = ChangeChromeOsDeviceStatusSucceeded
instance Core.FromJSON ChangeChromeOsDeviceStatusSucceeded where
        parseJSON
          = Core.withObject "ChangeChromeOsDeviceStatusSucceeded"
              (\ o -> Core.pure ChangeChromeOsDeviceStatusSucceeded)

instance Core.ToJSON ChangeChromeOsDeviceStatusSucceeded where
...
-- | Google Chrome devices run on the <https://support.google.com/chromeos Chrome OS>. For more information about common API tasks, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-chrome-devices Developer\'s Guide>.
--
...
data ChromeOsDevice = ChromeOsDevice
    ...
    , autoUpdateThrough :: (Core.Maybe Core.Text)
      -- | Output only. Contains backlight information for the device.
    , backlightInfo :: (Core.Maybe [BacklightInfo])
    ...
    , chromeOsType :: (Core.Maybe ChromeOsDevice_ChromeOsType)
    ...
    , deviceLicenseType :: (Core.Maybe ChromeOsDevice_DeviceLicenseType)
      -- | Output only. How much disk space the device has available and is currently using.
    , diskSpaceUsage :: (Core.Maybe ByteUsage)
    ...
    , manufactureDate :: (Core.Maybe Core.Text)
      -- | The Mobile Equipment Identifier (MEID) or the International Mobile Equipment Identity (IMEI) for the 3G mobile card in a mobile device. A MEID\/IMEI is typically used when adding a device to a wireless carrier\'s post-pay service plan. If the device does not have this information, this property is not included in the response. For more information on how to export a MEID\/IMEI list, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-chrome-devices.html#export_meid Developer\'s Guide>.
    ...
    , model :: (Core.Maybe Core.Text)
      -- | Notes about this device added by the administrator. This property can be <https://support.google.com/chrome/a/answer/1698333 searched> with the <https://developers.google.com/workspace/admin/directory/v1/reference/chromeosdevices/list list> method\'s @query@ parameter. Maximum length is 500 characters. Empty values are allowed.
    ...
    , orderNumber :: (Core.Maybe Core.Text)
      -- | The unique ID of the organizational unit. orgUnitPath is the human readable version of orgUnitId. While orgUnitPath may change by renaming an organizational unit within the path, orgUnitId is unchangeable for one organizational unit. This property can be <https://developers.google.com/workspace/admin/directory/v1/guides/manage-chrome-devices#move_chrome_devices_to_ou updated> using the API. For more information about how to create an organizational structure for your device, see the <https://support.google.com/a/answer/182433 administration help center>.
    , orgUnitId :: (Core.Maybe Core.Text)
      -- | The full parent path with the organizational unit\'s name associated with the device. Path names are case insensitive. If the parent organizational unit is the top-level organization, it is represented as a forward slash, @\/@. This property can be <https://developers.google.com/workspace/admin/directory/v1/guides/manage-chrome-devices#move_chrome_devices_to_ou updated> using the API. For more information about how to create an organizational structure for your device, see the <https://support.google.com/a/answer/182433 administration help center>.
...
newChromeOsDevice 
    ::  ChromeOsDevice
newChromeOsDevice
  = ChromeOsDevice{activeTimeRanges = Core.Nothing,
                   annotatedAssetId = Core.Nothing, annotatedLocation = Core.Nothing,
                   annotatedUser = Core.Nothing, autoUpdateExpiration = Core.Nothing,
                   autoUpdateThrough = Core.Nothing, backlightInfo = Core.Nothing,
                   bootMode = Core.Nothing, chromeOsType = Core.Nothing,
                   cpuInfo = Core.Nothing, cpuStatusReports = Core.Nothing,
                   deprovisionReason = Core.Nothing, deviceFiles = Core.Nothing,
                   deviceId = Core.Nothing, deviceLicenseType = Core.Nothing,
                   diskSpaceUsage = Core.Nothing, diskVolumeReports = Core.Nothing,
                   dockMacAddress = Core.Nothing, etag = Core.Nothing,
                   ethernetMacAddress = Core.Nothing,
                   ethernetMacAddress0 = Core.Nothing,
                   extendedSupportEligible = Core.Nothing,
                   extendedSupportEnabled = Core.Nothing,
                   extendedSupportStart = Core.Nothing, fanInfo = Core.Nothing,
                   firmwareVersion = Core.Nothing, firstEnrollmentTime = Core.Nothing,
                   kind = "admin#directory#chromeosdevice",
                   lastDeprovisionTimestamp = Core.Nothing,
                   lastEnrollmentTime = Core.Nothing, lastKnownNetwork = Core.Nothing,
                   lastSync = Core.Nothing, macAddress = Core.Nothing,
                   manufactureDate = Core.Nothing, meid = Core.Nothing,
                   model = Core.Nothing, notes = Core.Nothing,
                   orderNumber = Core.Nothing, orgUnitId = Core.Nothing,
                   orgUnitPath = Core.Nothing, osUpdateStatus = Core.Nothing,
                   osVersion = Core.Nothing, platformVersion = Core.Nothing,
                   recentUsers = Core.Nothing, screenshotFiles = Core.Nothing,
                   serialNumber = Core.Nothing, status = Core.Nothing,
                   supportEndDate = Core.Nothing, systemRamFreeReports = Core.Nothing,
                   systemRamTotal = Core.Nothing, tpmVersionInfo = Core.Nothing,
                   willAutoRenew = Core.Nothing}
instance Core.FromJSON ChromeOsDevice where
        parseJSON
          = Core.withObject "ChromeOsDevice"
              (\ o ->
                 ChromeOsDevice Core.<$>
                   (o Core..:? "activeTimeRanges") Core.<*>
                     (o Core..:? "annotatedAssetId")
                     Core.<*> (o Core..:? "annotatedLocation")
                     Core.<*> (o Core..:? "annotatedUser")
                     Core.<*>
                     (o Core..:? "autoUpdateExpiration" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "autoUpdateThrough")
                     Core.<*> (o Core..:? "backlightInfo")
                     Core.<*> (o Core..:? "bootMode")
                     Core.<*> (o Core..:? "chromeOsType")
                     Core.<*> (o Core..:? "cpuInfo")
                     Core.<*> (o Core..:? "cpuStatusReports")
                     Core.<*> (o Core..:? "deprovisionReason")
                     Core.<*> (o Core..:? "deviceFiles")
                     Core.<*> (o Core..:? "deviceId")
                     Core.<*> (o Core..:? "deviceLicenseType")
                     Core.<*> (o Core..:? "diskSpaceUsage")
                     Core.<*> (o Core..:? "diskVolumeReports")
                     Core.<*> (o Core..:? "dockMacAddress")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "ethernetMacAddress")
                     Core.<*> (o Core..:? "ethernetMacAddress0")
                     Core.<*> (o Core..:? "extendedSupportEligible")
                     Core.<*> (o Core..:? "extendedSupportEnabled")
                     Core.<*> (o Core..:? "extendedSupportStart")
                     Core.<*> (o Core..:? "fanInfo")
                     Core.<*> (o Core..:? "firmwareVersion")
                     Core.<*> (o Core..:? "firstEnrollmentTime")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#chromeosdevice")
                     ...
                     Core.<*>
                     (o Core..:? "systemRamTotal" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON ChromeOsDevice where
        toJSON ChromeOsDevice{..}
          = Core.object
              (Core.catMaybes
                 [("activeTimeRanges" Core..=) Core.<$> activeTimeRanges,
                  ("annotatedAssetId" Core..=) Core.<$> annotatedAssetId,
                  ("annotatedLocation" Core..=) Core.<$> annotatedLocation,
                  ("annotatedUser" Core..=) Core.<$> annotatedUser,
                  ("autoUpdateExpiration" Core..=) Core.. Core.AsText Core.<$>
                    autoUpdateExpiration,
                  ("autoUpdateThrough" Core..=) Core.<$> autoUpdateThrough,
                  ("backlightInfo" Core..=) Core.<$> backlightInfo,
                  ("bootMode" Core..=) Core.<$> bootMode,
                  ("chromeOsType" Core..=) Core.<$> chromeOsType,
                  ("cpuInfo" Core..=) Core.<$> cpuInfo,
                  ("cpuStatusReports" Core..=) Core.<$> cpuStatusReports,
                  ("deprovisionReason" Core..=) Core.<$> deprovisionReason,
                  ("deviceFiles" Core..=) Core.<$> deviceFiles,
                  ("deviceId" Core..=) Core.<$> deviceId,
                  ("deviceLicenseType" Core..=) Core.<$> deviceLicenseType,
                  ("diskSpaceUsage" Core..=) Core.<$> diskSpaceUsage,
                  ("diskVolumeReports" Core..=) Core.<$> diskVolumeReports,
                  ("dockMacAddress" Core..=) Core.<$> dockMacAddress,
                  ("etag" Core..=) Core.<$> etag,
                  ("ethernetMacAddress" Core..=) Core.<$> ethernetMacAddress,
                  ("ethernetMacAddress0" Core..=) Core.<$> ethernetMacAddress0,
                  ("extendedSupportEligible" Core..=) Core.<$>
                    extendedSupportEligible,
                  ("extendedSupportEnabled" Core..=) Core.<$> extendedSupportEnabled,
                  ("extendedSupportStart" Core..=) Core.<$> extendedSupportStart,
                  ("fanInfo" Core..=) Core.<$> fanInfo,
                  ("firmwareVersion" Core..=) Core.<$> firmwareVersion,
                  ("firstEnrollmentTime" Core..=) Core.<$> firstEnrollmentTime,
                  Core.Just ("kind" Core..= kind),
                  ("lastDeprovisionTimestamp" Core..=) Core.<$>
                    lastDeprovisionTimestamp,
                  ("lastEnrollmentTime" Core..=) Core.<$> lastEnrollmentTime,
                  ("lastKnownNetwork" Core..=) Core.<$> lastKnownNetwork,
                  ...
                  ("systemRamFreeReports" Core..=) Core.<$> systemRamFreeReports,
                  ("systemRamTotal" Core..=) Core.. Core.AsText Core.<$>
                    systemRamTotal,
...
data ChromeOsDevice_ActiveTimeRangesItem = ChromeOsDevice_ActiveTimeRangesItem
    {
      ...
      activeTime :: (Core.Maybe Core.Int64)
      -- | Date of usage
...
newChromeOsDevice_ActiveTimeRangesItem 
    :: 
                                       ChromeOsDevice_ActiveTimeRangesItem
newChromeOsDevice_ActiveTimeRangesItem
  = ChromeOsDevice_ActiveTimeRangesItem{activeTime = Core.Nothing,
                                        date = Core.Nothing}
instance Core.FromJSON ChromeOsDevice_ActiveTimeRangesItem where
        parseJSON
          = Core.withObject "ChromeOsDevice_ActiveTimeRangesItem"
              (\ o ->
                 ChromeOsDevice_ActiveTimeRangesItem Core.<$>
                   (o Core..:? "activeTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "date"))

instance Core.ToJSON ChromeOsDevice_ActiveTimeRangesItem where
        toJSON ChromeOsDevice_ActiveTimeRangesItem{..}
          = Core.object
              (Core.catMaybes
                 [("activeTime" Core..=) Core.. Core.AsText Core.<$> activeTime,
                  ("date" Core..=) Core.<$> date])
...
newChromeOsDevice_CpuInfoItem 
    ::  ChromeOsDevice_CpuInfoItem
newChromeOsDevice_CpuInfoItem
  = ChromeOsDevice_CpuInfoItem{architecture = Core.Nothing,
                               logicalCpus = Core.Nothing, maxClockSpeedKhz = Core.Nothing,
                               model = Core.Nothing}
instance Core.FromJSON ChromeOsDevice_CpuInfoItem where
        parseJSON
          = Core.withObject "ChromeOsDevice_CpuInfoItem"
              (\ o ->
                 ChromeOsDevice_CpuInfoItem Core.<$>
                   (o Core..:? "architecture") Core.<*> (o Core..:? "logicalCpus")
          ...
          = Core.object
              (Core.catMaybes
                 [("architecture" Core..=) Core.<$> architecture,
                  ...
                  ("maxClockSpeedKhz" Core..=) Core.<$> maxClockSpeedKhz,
...
newChromeOsDevice_CpuInfoItem_LogicalCpusItem 
    :: 
                                              ChromeOsDevice_CpuInfoItem_LogicalCpusItem
newChromeOsDevice_CpuInfoItem_LogicalCpusItem
  = ChromeOsDevice_CpuInfoItem_LogicalCpusItem{cStates =
                                                 Core.Nothing,
                                               currentScalingFrequencyKhz = Core.Nothing,
                                               idleDuration = Core.Nothing,
                                               maxScalingFrequencyKhz = Core.Nothing}
instance Core.FromJSON ChromeOsDevice_CpuInfoItem_LogicalCpusItem
         where
        parseJSON
          = Core.withObject "ChromeOsDevice_CpuInfoItem_LogicalCpusItem"
              (\ o ->
                 ChromeOsDevice_CpuInfoItem_LogicalCpusItem Core.<$>
                   (o Core..:? "cStates") Core.<*>
                     (o Core..:? "currentScalingFrequencyKhz")
                     Core.<*> (o Core..:? "idleDuration")
                     Core.<*> (o Core..:? "maxScalingFrequencyKhz"))

instance Core.ToJSON ChromeOsDevice_CpuInfoItem_LogicalCpusItem
         where
        toJSON ChromeOsDevice_CpuInfoItem_LogicalCpusItem{..}
          = Core.object
              (Core.catMaybes
                 [("cStates" Core..=) Core.<$> cStates,
                  ("currentScalingFrequencyKhz" Core..=) Core.<$>
                    currentScalingFrequencyKhz,
                  ("idleDuration" Core..=) Core.<$> idleDuration,
                  ("maxScalingFrequencyKhz" Core..=) Core.<$>
...
newChromeOsDevice_CpuInfoItem_LogicalCpusItem_CStatesItem 
    :: 
                                                          ChromeOsDevice_CpuInfoItem_LogicalCpusItem_CStatesItem
newChromeOsDevice_CpuInfoItem_LogicalCpusItem_CStatesItem
  = ChromeOsDevice_CpuInfoItem_LogicalCpusItem_CStatesItem{displayName
                                                             = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ChromeOsDevice_CpuInfoItem_LogicalCpusItem_CStatesItem"
              (\ o ->
                 ChromeOsDevice_CpuInfoItem_LogicalCpusItem_CStatesItem Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "sessionDuration"))

instance Core.ToJSON
           ChromeOsDevice_CpuInfoItem_LogicalCpusItem_CStatesItem
         where
        toJSON ChromeOsDevice_CpuInfoItem_LogicalCpusItem_CStatesItem{..}
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ("sessionDuration" Core..=) Core.<$> sessionDuration])
...
newChromeOsDevice_CpuStatusReportsItem 
    :: 
                                       ChromeOsDevice_CpuStatusReportsItem
newChromeOsDevice_CpuStatusReportsItem
  = ChromeOsDevice_CpuStatusReportsItem{cpuTemperatureInfo =
                                          Core.Nothing,
                                        cpuUtilizationPercentageInfo = Core.Nothing,
                                        reportTime = Core.Nothing}
instance Core.FromJSON ChromeOsDevice_CpuStatusReportsItem where
        parseJSON
          = Core.withObject "ChromeOsDevice_CpuStatusReportsItem"
              (\ o ->
                 ChromeOsDevice_CpuStatusReportsItem Core.<$>
                   (o Core..:? "cpuTemperatureInfo") Core.<*>
                     (o Core..:? "cpuUtilizationPercentageInfo")
                     Core.<*> (o Core..:? "reportTime"))

instance Core.ToJSON ChromeOsDevice_CpuStatusReportsItem where
        toJSON ChromeOsDevice_CpuStatusReportsItem{..}
          = Core.object
              (Core.catMaybes
                 [("cpuTemperatureInfo" Core..=) Core.<$> cpuTemperatureInfo,
                  ("cpuUtilizationPercentageInfo" Core..=) Core.<$>
...
newChromeOsDevice_CpuStatusReportsItem_CpuTemperatureInfoItem 
    :: 
                                                              ChromeOsDevice_CpuStatusReportsItem_CpuTemperatureInfoItem
newChromeOsDevice_CpuStatusReportsItem_CpuTemperatureInfoItem
  = ChromeOsDevice_CpuStatusReportsItem_CpuTemperatureInfoItem{label
                                                                 = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ChromeOsDevice_CpuStatusReportsItem_CpuTemperatureInfoItem"
              (\ o ->
                 ChromeOsDevice_CpuStatusReportsItem_CpuTemperatureInfoItem Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "temperature"))
...
newChromeOsDevice_DeviceFilesItem 
    ::  ChromeOsDevice_DeviceFilesItem
newChromeOsDevice_DeviceFilesItem
  = ChromeOsDevice_DeviceFilesItem{createTime = Core.Nothing,
                                   downloadUrl = Core.Nothing, name = Core.Nothing,
                                   type' = Core.Nothing}
instance Core.FromJSON ChromeOsDevice_DeviceFilesItem where
        parseJSON
          = Core.withObject "ChromeOsDevice_DeviceFilesItem"
              (\ o ->
                 ChromeOsDevice_DeviceFilesItem Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "downloadUrl")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON ChromeOsDevice_DiskVolumeReportsItem where
        parseJSON
          = Core.withObject "ChromeOsDevice_DiskVolumeReportsItem"
              (\ o ->
                 ChromeOsDevice_DiskVolumeReportsItem Core.<$>
                   (o Core..:? "volumeInfo"))

instance Core.ToJSON ChromeOsDevice_DiskVolumeReportsItem where
        toJSON ChromeOsDevice_DiskVolumeReportsItem{..}
          = Core.object
              (Core.catMaybes [("volumeInfo" Core..=) Core.<$> volumeInfo])
...
newChromeOsDevice_DiskVolumeReportsItem_VolumeInfoItem 
    :: 
                                                       ChromeOsDevice_DiskVolumeReportsItem_VolumeInfoItem
newChromeOsDevice_DiskVolumeReportsItem_VolumeInfoItem
  = ChromeOsDevice_DiskVolumeReportsItem_VolumeInfoItem{storageFree =
                                                          Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ChromeOsDevice_DiskVolumeReportsItem_VolumeInfoItem"
              (\ o ->
                 ChromeOsDevice_DiskVolumeReportsItem_VolumeInfoItem Core.<$>
                   (o Core..:? "storageFree" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "storageTotal" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "volumeId"))

instance Core.ToJSON
           ChromeOsDevice_DiskVolumeReportsItem_VolumeInfoItem
         where
        toJSON ChromeOsDevice_DiskVolumeReportsItem_VolumeInfoItem{..}
          = Core.object
              (Core.catMaybes
                 [("storageFree" Core..=) Core.. Core.AsText Core.<$> storageFree,
                  ("storageTotal" Core..=) Core.. Core.AsText Core.<$> storageTotal,
...
newChromeOsDevice_LastKnownNetworkItem 
    :: 
                                       ChromeOsDevice_LastKnownNetworkItem
newChromeOsDevice_LastKnownNetworkItem
  = ChromeOsDevice_LastKnownNetworkItem{ipAddress = Core.Nothing,
                                        wanIpAddress = Core.Nothing}
instance Core.FromJSON ChromeOsDevice_LastKnownNetworkItem where
        parseJSON
          = Core.withObject "ChromeOsDevice_LastKnownNetworkItem"
              (\ o ->
                 ChromeOsDevice_LastKnownNetworkItem Core.<$>
                   (o Core..:? "ipAddress") Core.<*> (o Core..:? "wanIpAddress"))

instance Core.ToJSON ChromeOsDevice_LastKnownNetworkItem where
...
newChromeOsDevice_RecentUsersItem 
    ::  ChromeOsDevice_RecentUsersItem
newChromeOsDevice_RecentUsersItem
  = ChromeOsDevice_RecentUsersItem{email = Core.Nothing,
                                   type' = Core.Nothing}
instance Core.FromJSON ChromeOsDevice_RecentUsersItem where
        parseJSON
          = Core.withObject "ChromeOsDevice_RecentUsersItem"
              (\ o ->
                 ChromeOsDevice_RecentUsersItem Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "type"))
...
newChromeOsDevice_ScreenshotFilesItem 
    :: 
                                      ChromeOsDevice_ScreenshotFilesItem
newChromeOsDevice_ScreenshotFilesItem
  = ChromeOsDevice_ScreenshotFilesItem{createTime = Core.Nothing,
                                       downloadUrl = Core.Nothing, name = Core.Nothing,
                                       type' = Core.Nothing}
instance Core.FromJSON ChromeOsDevice_ScreenshotFilesItem where
        parseJSON
          = Core.withObject "ChromeOsDevice_ScreenshotFilesItem"
              (\ o ->
                 ChromeOsDevice_ScreenshotFilesItem Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "downloadUrl")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "type"))

instance Core.ToJSON ChromeOsDevice_ScreenshotFilesItem where
...
newChromeOsDevice_SystemRamFreeReportsItem 
    :: 
                                           ChromeOsDevice_SystemRamFreeReportsItem
newChromeOsDevice_SystemRamFreeReportsItem
  = ChromeOsDevice_SystemRamFreeReportsItem{reportTime =
                                              Core.Nothing,
                                            systemRamFreeInfo = Core.Nothing}
instance Core.FromJSON ChromeOsDevice_SystemRamFreeReportsItem
         where
        parseJSON
          = Core.withObject "ChromeOsDevice_SystemRamFreeReportsItem"
              (\ o ->
                 ChromeOsDevice_SystemRamFreeReportsItem Core.<$>
                   (o Core..:? "reportTime") Core.<*>
                     (o Core..:? "systemRamFreeInfo" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText)))

instance Core.ToJSON ChromeOsDevice_SystemRamFreeReportsItem where
        toJSON ChromeOsDevice_SystemRamFreeReportsItem{..}
          = Core.object
              (Core.catMaybes
                 [("reportTime" Core..=) Core.<$> reportTime,
                  ("systemRamFreeInfo" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    systemRamFreeInfo])
...
newChromeOsDevice_TpmVersionInfo 
    ::  ChromeOsDevice_TpmVersionInfo
newChromeOsDevice_TpmVersionInfo
  = ChromeOsDevice_TpmVersionInfo{family = Core.Nothing,
                                  firmwareVersion = Core.Nothing, manufacturer = Core.Nothing,
                                  specLevel = Core.Nothing, tpmModel = Core.Nothing,
                                  vendorSpecific = Core.Nothing}
instance Core.FromJSON ChromeOsDevice_TpmVersionInfo where
        parseJSON
          = Core.withObject "ChromeOsDevice_TpmVersionInfo"
              (\ o ->
                 ChromeOsDevice_TpmVersionInfo Core.<$>
                   (o Core..:? "family") Core.<*> (o Core..:? "firmwareVersion")
...
newChromeOsDeviceAction 
    ::  ChromeOsDeviceAction
newChromeOsDeviceAction
  = ChromeOsDeviceAction{action = Core.Nothing,
                         deprovisionReason = Core.Nothing}
instance Core.FromJSON ChromeOsDeviceAction where
        parseJSON
          = Core.withObject "ChromeOsDeviceAction"
              (\ o ->
                 ChromeOsDeviceAction Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "deprovisionReason"))
...
newChromeOsDevices 
    ::  ChromeOsDevices
newChromeOsDevices
  = ChromeOsDevices{chromeosdevices = Core.Nothing,
                    etag = Core.Nothing, kind = "admin#directory#chromeosdevices",
                    nextPageToken = Core.Nothing}
instance Core.FromJSON ChromeOsDevices where
        parseJSON
          = Core.withObject "ChromeOsDevices"
              (\ o ->
                 ChromeOsDevices Core.<$>
                   (o Core..:? "chromeosdevices") Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#chromeosdevices")
                     Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.ToJSON ChromeOsDevices where
        toJSON ChromeOsDevices{..}
          = Core.object
              (Core.catMaybes
                 [("chromeosdevices" Core..=) Core.<$> chromeosdevices,
                  ("etag" Core..=) Core.<$> etag, Core.Just ("kind" Core..= kind),
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newChromeOsMoveDevicesToOu 
    ::  ChromeOsMoveDevicesToOu
newChromeOsMoveDevicesToOu
  = ChromeOsMoveDevicesToOu{deviceIds = Core.Nothing}
instance Core.FromJSON ChromeOsMoveDevicesToOu where
        parseJSON
          = Core.withObject "ChromeOsMoveDevicesToOu"
              (\ o -> ChromeOsMoveDevicesToOu Core.<$> (o Core..:? "deviceIds"))

instance Core.ToJSON ChromeOsMoveDevicesToOu where
        toJSON ChromeOsMoveDevicesToOu{..}
          = Core.object
              (Core.catMaybes [("deviceIds" Core..=) Core.<$> deviceIds])
...
data CreatePrintServerRequest = CreatePrintServerRequest
    {
      -- | Required. The <https://developers.google.com/workspace/admin/directory/reference/rest/v1/customers unique ID> of the customer\'s Google Workspace account. Format: @customers\/{id}@
      parent :: (Core.Maybe Core.Text)
      -- | Required. A print server to create. If you want to place the print server under a specific organizational unit (OU), then populate the @org_unit_id@. Otherwise the print server is created under the root OU. The @org_unit_id@ can be retrieved using the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-org-units Directory API>.
...
newCreatePrintServerRequest 
    ::  CreatePrintServerRequest
newCreatePrintServerRequest
  = CreatePrintServerRequest{parent = Core.Nothing,
                             printServer = Core.Nothing}
instance Core.FromJSON CreatePrintServerRequest where
        parseJSON
          = Core.withObject "CreatePrintServerRequest"
              (\ o ->
                 CreatePrintServerRequest Core.<$>
                   (o Core..:? "parent") Core.<*> (o Core..:? "printServer"))
...
newCreatePrinterRequest 
    ::  CreatePrinterRequest
newCreatePrinterRequest
  = CreatePrinterRequest{parent = Core.Nothing,
                         printer = Core.Nothing}
instance Core.FromJSON CreatePrinterRequest where
        parseJSON
          = Core.withObject "CreatePrinterRequest"
              (\ o ->
                 CreatePrinterRequest Core.<$>
                   (o Core..:? "parent") Core.<*> (o Core..:? "printer"))
...
data Customer = Customer
    ...
    , kind :: Core.Text
      -- | The customer\'s ISO 639-2 language code. See the <https://developers.google.com/workspace/admin/directory/v1/languages Language Codes> page for the list of supported codes. Valid language codes outside the supported set will be accepted by the API but may lead to unexpected behavior. The default value is @en@.
...
newCustomer 
    ::  Customer
newCustomer
  = Customer{alternateEmail = Core.Nothing,
             customerCreationTime = Core.Nothing, customerDomain = Core.Nothing,
             etag = Core.Nothing, id = Core.Nothing,
             kind = "admin#directory#customer", language = Core.Nothing,
             phoneNumber = Core.Nothing, postalAddress = Core.Nothing}
instance Core.FromJSON Customer where
        parseJSON
          = Core.withObject "Customer"
              (\ o ->
                 Customer Core.<$>
                   (o Core..:? "alternateEmail") Core.<*>
                     (o Core..:? "customerCreationTime")
                     Core.<*> (o Core..:? "customerDomain")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "admin#directory#customer")
          ...
          = Core.object
              (Core.catMaybes
                 [("alternateEmail" Core..=) Core.<$> alternateEmail,
                  ("customerCreationTime" Core..=) Core.<$> customerCreationTime,
...
newCustomerPostalAddress 
    ::  CustomerPostalAddress
newCustomerPostalAddress
  = CustomerPostalAddress{addressLine1 = Core.Nothing,
                          addressLine2 = Core.Nothing, addressLine3 = Core.Nothing,
                          contactName = Core.Nothing, countryCode = Core.Nothing,
                          locality = Core.Nothing, organizationName = Core.Nothing,
                          postalCode = Core.Nothing, region = Core.Nothing}
instance Core.FromJSON CustomerPostalAddress where
        parseJSON
          = Core.withObject "CustomerPostalAddress"
              (\ o ->
                 CustomerPostalAddress Core.<$>
...
newDirectoryChromeosdevicesCommand 
    :: 
                                   DirectoryChromeosdevicesCommand
newDirectoryChromeosdevicesCommand
  = DirectoryChromeosdevicesCommand{commandExpireTime = Core.Nothing,
                                    commandId = Core.Nothing, commandResult = Core.Nothing,
                                    issueTime = Core.Nothing, payload = Core.Nothing,
                                    state = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON DirectoryChromeosdevicesCommand where
        parseJSON
          = Core.withObject "DirectoryChromeosdevicesCommand"
              (\ o ->
                 DirectoryChromeosdevicesCommand Core.<$>
                   (o Core..:? "commandExpireTime") Core.<*>
                     (o Core..:? "commandId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON DirectoryChromeosdevicesCommand where
        toJSON DirectoryChromeosdevicesCommand{..}
          = Core.object
              (Core.catMaybes
                 [("commandExpireTime" Core..=) Core.<$> commandExpireTime,
                  ("commandId" Core..=) Core.. Core.AsText Core.<$> commandId,
...
newDirectoryChromeosdevicesCommandResult 
    :: 
                                         DirectoryChromeosdevicesCommandResult
newDirectoryChromeosdevicesCommandResult
  = DirectoryChromeosdevicesCommandResult{commandResultPayload =
                                            Core.Nothing,
                                          errorMessage = Core.Nothing, executeTime = Core.Nothing,
                                          result = Core.Nothing}
instance Core.FromJSON DirectoryChromeosdevicesCommandResult where
        parseJSON
          = Core.withObject "DirectoryChromeosdevicesCommandResult"
              (\ o ->
                 DirectoryChromeosdevicesCommandResult Core.<$>
                   (o Core..:? "commandResultPayload") Core.<*>
                     (o Core..:? "errorMessage")
                     Core.<*> (o Core..:? "executeTime")
                     Core.<*> (o Core..:? "result"))

instance Core.ToJSON DirectoryChromeosdevicesCommandResult where
        toJSON DirectoryChromeosdevicesCommandResult{..}
          = Core.object
              (Core.catMaybes
                 [("commandResultPayload" Core..=) Core.<$> commandResultPayload,
...
newDirectoryChromeosdevicesIssueCommandRequest 
    :: 
                                               DirectoryChromeosdevicesIssueCommandRequest
newDirectoryChromeosdevicesIssueCommandRequest
  = DirectoryChromeosdevicesIssueCommandRequest{commandType =
                                                  Core.Nothing,
                                                payload = Core.Nothing}
instance Core.FromJSON DirectoryChromeosdevicesIssueCommandRequest
         where
        parseJSON
          = Core.withObject "DirectoryChromeosdevicesIssueCommandRequest"
              (\ o ->
                 DirectoryChromeosdevicesIssueCommandRequest Core.<$>
                   (o Core..:? "commandType") Core.<*> (o Core..:? "payload"))

instance Core.ToJSON DirectoryChromeosdevicesIssueCommandRequest
         where
        toJSON DirectoryChromeosdevicesIssueCommandRequest{..}
          = Core.object
              (Core.catMaybes
...
newDirectoryChromeosdevicesIssueCommandResponse 
    :: 
                                                DirectoryChromeosdevicesIssueCommandResponse
newDirectoryChromeosdevicesIssueCommandResponse
  = DirectoryChromeosdevicesIssueCommandResponse{commandId =
                                                   Core.Nothing}
instance Core.FromJSON DirectoryChromeosdevicesIssueCommandResponse
         where
        parseJSON
          = Core.withObject "DirectoryChromeosdevicesIssueCommandResponse"
              (\ o ->
                 DirectoryChromeosdevicesIssueCommandResponse Core.<$>
                   (o Core..:? "commandId" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON DirectoryChromeosdevicesIssueCommandResponse
         where
        toJSON DirectoryChromeosdevicesIssueCommandResponse{..}
          = Core.object
              (Core.catMaybes
                 [("commandId" Core..=) Core.. Core.AsText Core.<$> commandId])
...
newDomainAlias 
    ::  DomainAlias
newDomainAlias
  = DomainAlias{creationTime = Core.Nothing,
                domainAliasName = Core.Nothing, etag = Core.Nothing,
                kind = "admin#directory#domainAlias",
                parentDomainName = Core.Nothing, verified = Core.Nothing}
instance Core.FromJSON DomainAlias where
        parseJSON
          = Core.withObject "DomainAlias"
              (\ o ->
                 DomainAlias Core.<$>
                   (o Core..:? "creationTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "domainAliasName")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "kind" Core..!= "admin#directory#domainAlias")
          ...
          = Core.object
              (Core.catMaybes
                 [("creationTime" Core..=) Core.. Core.AsText Core.<$> creationTime,
                  ...
                  ("etag" Core..=) Core.<$> etag, Core.Just ("kind" Core..= kind),
                  ("parentDomainName" Core..=) Core.<$> parentDomainName,
...
newDomainAliases 
    ::  DomainAliases
newDomainAliases
  = DomainAliases{domainAliases = Core.Nothing, etag = Core.Nothing,
                  kind = "admin#directory#domainAliases"}
instance Core.FromJSON DomainAliases where
        parseJSON
          = Core.withObject "DomainAliases"
              (\ o ->
                 DomainAliases Core.<$>
                   (o Core..:? "domainAliases") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#domainAliases"))
...
newDomains 
    ::  Domains
newDomains
  = Domains{creationTime = Core.Nothing,
            domainAliases = Core.Nothing, domainName = Core.Nothing,
            etag = Core.Nothing, isPrimary = Core.Nothing,
            kind = "admin#directory#domain", verified = Core.Nothing}
instance Core.FromJSON Domains where
        parseJSON
          = Core.withObject "Domains"
              (\ o ->
                 Domains Core.<$>
                   (o Core..:? "creationTime" Core.<&> Core.fmap Core.fromAsText)
...
newDomains2 
    ::  Domains2
newDomains2
  = Domains2{domains = Core.Nothing, etag = Core.Nothing,
             kind = "admin#directory#domains"}
instance Core.FromJSON Domains2 where
        parseJSON
          = Core.withObject "Domains2"
              (\ o ->
                 Domains2 Core.<$>
                   (o Core..:? "domains") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#domains"))
...
newFailureInfo 
    ::  FailureInfo
newFailureInfo
  = FailureInfo{errorCode = Core.Nothing,
                errorMessage = Core.Nothing, printer = Core.Nothing,
                printerId = Core.Nothing}
instance Core.FromJSON FailureInfo where
        parseJSON
          = Core.withObject "FailureInfo"
              (\ o ->
                 FailureInfo Core.<$>
                   (o Core..:? "errorCode") Core.<*> (o Core..:? "errorMessage")
                     Core.<*> (o Core..:? "printer")
...
--
-- /See:/ 'newFanInfo' smart constructor.
newtype FanInfo = FanInfo
    {
      -- | Output only. Fan speed in RPM.
      speedRpm :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'FanInfo' with the minimum fields required to make a request.
newFanInfo 
    ::  FanInfo
newFanInfo = FanInfo{speedRpm = Core.Nothing}
instance Core.FromJSON FanInfo where
        parseJSON
          = Core.withObject "FanInfo"
              (\ o -> FanInfo Core.<$> (o Core..:? "speedRpm"))

instance Core.ToJSON FanInfo where
        toJSON FanInfo{..}
          = Core.object
              (Core.catMaybes [("speedRpm" Core..=) Core.<$> speedRpm])
...
instance Core.ToJSON Feature where
        toJSON Feature{..}
          = Core.object
              (Core.catMaybes
                 [("etags" Core..=) Core.<$> etags, Core.Just ("kind" Core..= kind),
                  ("name" Core..=) Core.<$> name])
...
instance Core.FromJSON FeatureInstance where
        parseJSON
          = Core.withObject "FeatureInstance"
              (\ o -> FeatureInstance Core.<$> (o Core..:? "feature"))

instance Core.ToJSON FeatureInstance where
        toJSON FeatureInstance{..}
          = Core.object
              (Core.catMaybes [("feature" Core..=) Core.<$> feature])
...
instance Core.FromJSON FeatureRename where
        parseJSON
          = Core.withObject "FeatureRename"
              (\ o -> FeatureRename Core.<$> (o Core..:? "newName"))

instance Core.ToJSON FeatureRename where
        toJSON FeatureRename{..}
          = Core.object
              (Core.catMaybes [("newName" Core..=) Core.<$> newName'])
...
newFeatures 
    ::  Features
newFeatures
  = Features{etag = Core.Nothing, features = Core.Nothing,
             kind = "admin#directory#resources#features#featuresList",
             nextPageToken = Core.Nothing}
instance Core.FromJSON Features where
        parseJSON
          = Core.withObject "Features"
              (\ o ->
                 Features Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "features") Core.<*>
                     (o Core..:? "kind" Core..!=
...
-- | Google Groups provide your users the ability to send messages to groups of people using the group\'s email address. For more information about common tasks, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-groups Developer\'s Guide>. For information about other types of groups, see the <https://cloud.google.com/identity/docs/groups Cloud Identity Groups API documentation>. Note: The user calling the API (or being impersonated by a service account) must have an assigned <https://developers.google.com/workspace/admin/directory/v1/guides/manage-roles role> that includes Admin API Groups permissions, such as Super Admin or Groups Admin.
--
...
newGroup 
    ::  Group
newGroup
  = Group{adminCreated = Core.Nothing, aliases = Core.Nothing,
          description = Core.Nothing, directMembersCount = Core.Nothing,
          email = Core.Nothing, etag = Core.Nothing, id = Core.Nothing,
          kind = "admin#directory#group", name = Core.Nothing,
...
instance Core.FromJSON Group where
        parseJSON
          = Core.withObject "Group"
              (\ o ->
                 Group Core.<$>
                   (o Core..:? "adminCreated") Core.<*> (o Core..:? "aliases")
                     Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "directMembersCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "email")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("adminCreated" Core..=) Core.<$> adminCreated,
                  ("aliases" Core..=) Core.<$> aliases,
                  ("description" Core..=) Core.<$> description,
                  ("directMembersCount" Core..=) Core.. Core.AsText Core.<$>
                    directMembersCount,
                  ("email" Core..=) Core.<$> email, ("etag" Core..=) Core.<$> etag,
                  ("id" Core..=) Core.<$> id, Core.Just ("kind" Core..= kind),
                  ("name" Core..=) Core.<$> name,
                  ("nonEditableAliases" Core..=) Core.<$> nonEditableAliases])
...
newGroupAlias 
    ::  GroupAlias
newGroupAlias
  = GroupAlias{alias = Core.Nothing, etag = Core.Nothing,
               id = Core.Nothing, kind = Core.Nothing,
               primaryEmail = Core.Nothing}
instance Core.FromJSON GroupAlias where
        parseJSON
          = Core.withObject "GroupAlias"
              (\ o ->
                 GroupAlias Core.<$>
                   (o Core..:? "alias") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "id")
...
newGroups 
    ::  Groups
newGroups
  = Groups{etag = Core.Nothing, groups = Core.Nothing,
           kind = "admin#directory#groups", nextPageToken = Core.Nothing}
instance Core.FromJSON Groups where
        parseJSON
          = Core.withObject "Groups"
              (\ o ->
                 Groups Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "groups") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#groups")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newListPrintServersResponse 
    ::  ListPrintServersResponse
newListPrintServersResponse
  = ListPrintServersResponse{nextPageToken = Core.Nothing,
                             printServers = Core.Nothing}
instance Core.FromJSON ListPrintServersResponse where
        parseJSON
          = Core.withObject "ListPrintServersResponse"
              (\ o ->
                 ListPrintServersResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "printServers"))
...
newListPrinterModelsResponse 
    ::  ListPrinterModelsResponse
newListPrinterModelsResponse
  = ListPrinterModelsResponse{nextPageToken = Core.Nothing,
                              printerModels = Core.Nothing}
instance Core.FromJSON ListPrinterModelsResponse where
        parseJSON
          = Core.withObject "ListPrinterModelsResponse"
              (\ o ->
                 ListPrinterModelsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "printerModels"))
...
newListPrintersResponse 
    ::  ListPrintersResponse
newListPrintersResponse
  = ListPrintersResponse{nextPageToken = Core.Nothing,
                         printers = Core.Nothing}
instance Core.FromJSON ListPrintersResponse where
        parseJSON
          = Core.withObject "ListPrintersResponse"
              (\ o ->
                 ListPrintersResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "printers"))
...
-- | A Google Groups member can be a user or another group. This member can be inside or outside of your account\'s domains. For more information about common group member tasks, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-group-members Developer\'s Guide>.
--
...
newMember 
    ::  Member
newMember
  = Member{deliverySettings = Core.Nothing, email = Core.Nothing,
           etag = Core.Nothing, id = Core.Nothing,
           kind = "admin#directory#member", role' = Core.Nothing,
           status = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Member where
        parseJSON
          = Core.withObject "Member"
              (\ o ->
                 Member Core.<$>
                   (o Core..:? "delivery_settings") Core.<*> (o Core..:? "email")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
...
instance Core.ToJSON Member where
        toJSON Member{..}
          = Core.object
              (Core.catMaybes
                 [("delivery_settings" Core..=) Core.<$> deliverySettings,
                  ("email" Core..=) Core.<$> email, ("etag" Core..=) Core.<$> etag,
                  ("id" Core..=) Core.<$> id, Core.Just ("kind" Core..= kind),
                  ("role" Core..=) Core.<$> role',
                  ("status" Core..=) Core.<$> status,
...
newMembers 
    ::  Members
newMembers
  = Members{etag = Core.Nothing, kind = "admin#directory#members",
            members = Core.Nothing, nextPageToken = Core.Nothing}
instance Core.FromJSON Members where
        parseJSON
          = Core.withObject "Members"
              (\ o ->
                 Members Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#members")
                     Core.<*> (o Core..:? "members")
                     Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON MembersHasMember where
        parseJSON
          = Core.withObject "MembersHasMember"
              (\ o -> MembersHasMember Core.<$> (o Core..:? "isMember"))

instance Core.ToJSON MembersHasMember where
        toJSON MembersHasMember{..}
          = Core.object
              (Core.catMaybes [("isMember" Core..=) Core.<$> isMember])


-- | Google Workspace Mobile Management includes Android, <https://support.google.com/a/answer/135937 Google Sync>, and iOS devices. For more information about common group mobile device API tasks, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-mobile-devices.html Developer\'s Guide>.
--
...
data MobileDevice = MobileDevice
    ...
    , devicePasswordStatus :: (Core.Maybe Core.Text)
      -- | The list of the owner\'s email addresses. If your application needs the current list of user emails, use the <https://developers.google.com/workspace/admin/directory/v1/reference/mobiledevices/get.html get> method. For additional information, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-users#get_user retrieve a user> method.
    , email :: (Core.Maybe [Core.Text])
    ...
    , meid :: (Core.Maybe Core.Text)
      -- | The mobile device\'s model name, for example Nexus S. This property can be <https://developers.google.com/workspace/admin/directory/v1/reference/mobiledevices/update.html updated>. For more information, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-mobile=devices#update_mobile_device Developer\'s Guide>.
    , model :: (Core.Maybe Core.Text)
      -- | The list of the owner\'s user names. If your application needs the current list of device owner names, use the <https://developers.google.com/workspace/admin/directory/v1/reference/mobiledevices/get.html get> method. For more information about retrieving mobile device user information, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-users#get_user Developer\'s Guide>.
    , name :: (Core.Maybe [Core.Text])
      -- | Mobile Device mobile or network operator (if available) (Read-only)
    , networkOperator :: (Core.Maybe Core.Text)
      -- | The mobile device\'s operating system, for example IOS 4.3 or Android 2.3.5. This property can be <https://developers.google.com/workspace/admin/directory/v1/reference/mobiledevices/update.html updated>. For more information, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-mobile-devices#update_mobile_device Developer\'s Guide>.
    ...
    , unknownSourcesStatus :: (Core.Maybe Core.Bool)
      -- | Gives information about the device such as @os@ version. This property can be <https://developers.google.com/workspace/admin/directory/v1/reference/mobiledevices/update.html updated>. For more information, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-mobile-devices#update_mobile_device Developer\'s Guide>.
...
newMobileDevice 
    ::  MobileDevice
newMobileDevice
  = MobileDevice{adbStatus = Core.Nothing,
                 applications = Core.Nothing, basebandVersion = Core.Nothing,
                 bootloaderVersion = Core.Nothing, brand = Core.Nothing,
                 buildNumber = Core.Nothing, defaultLanguage = Core.Nothing,
                 developerOptionsStatus = Core.Nothing,
                 deviceCompromisedStatus = Core.Nothing, deviceId = Core.Nothing,
                 devicePasswordStatus = Core.Nothing, email = Core.Nothing,
                 encryptionStatus = Core.Nothing, etag = Core.Nothing,
                 firstSync = Core.Nothing, hardware = Core.Nothing,
                 hardwareId = Core.Nothing, imei = Core.Nothing,
                 kernelVersion = Core.Nothing,
                 kind = "admin#directory#mobiledevice", lastSync = Core.Nothing,
                 managedAccountIsOnOwnerProfile = Core.Nothing,
                 manufacturer = Core.Nothing, meid = Core.Nothing,
                 model = Core.Nothing, name = Core.Nothing,
                 networkOperator = Core.Nothing, os = Core.Nothing,
                 otherAccountsInfo = Core.Nothing, privilege = Core.Nothing,
                 releaseVersion = Core.Nothing, resourceId = Core.Nothing,
                 securityPatchLevel = Core.Nothing, serialNumber = Core.Nothing,
                 status = Core.Nothing, supportsWorkProfile = Core.Nothing,
                 type' = Core.Nothing, unknownSourcesStatus = Core.Nothing,
                 userAgent = Core.Nothing, wifiMacAddress = Core.Nothing}
instance Core.FromJSON MobileDevice where
        parseJSON
          = Core.withObject "MobileDevice"
              (\ o ->
                 MobileDevice Core.<$>
                   (o Core..:? "adbStatus") Core.<*> (o Core..:? "applications")
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#mobiledevice")
                     Core.<*> (o Core..:? "lastSync")
                     ...
                     Core.<*> (o Core..:? "resourceId")
                     Core.<*>
                     (o Core..:? "securityPatchLevel" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "serialNumber")
                     Core.<*> (o Core..:? "status")
          ...
          = Core.object
              (Core.catMaybes
                 [("adbStatus" Core..=) Core.<$> adbStatus,
                  ...
                  ("developerOptionsStatus" Core..=) Core.<$> developerOptionsStatus,
                  ("deviceCompromisedStatus" Core..=) Core.<$>
                    deviceCompromisedStatus,
                  ("deviceId" Core..=) Core.<$> deviceId,
                  ("devicePasswordStatus" Core..=) Core.<$> devicePasswordStatus,
                  ("email" Core..=) Core.<$> email,
                  ...
                  Core.Just ("kind" Core..= kind),
                  ("lastSync" Core..=) Core.<$> lastSync,
                  ("managedAccountIsOnOwnerProfile" Core..=) Core.<$>
                  ...
                  ("os" Core..=) Core.<$> os,
                  ("otherAccountsInfo" Core..=) Core.<$> otherAccountsInfo,
                  ("privilege" Core..=) Core.<$> privilege,
                  ("releaseVersion" Core..=) Core.<$> releaseVersion,
                  ("resourceId" Core..=) Core.<$> resourceId,
                  ("securityPatchLevel" Core..=) Core.. Core.AsText Core.<$>
                    securityPatchLevel,
                  ("serialNumber" Core..=) Core.<$> serialNumber,
                  ("status" Core..=) Core.<$> status,
                  ("supportsWorkProfile" Core..=) Core.<$> supportsWorkProfile,
                  ("type" Core..=) Core.<$> type',
                  ("unknownSourcesStatus" Core..=) Core.<$> unknownSourcesStatus,
...
newMobileDevice_ApplicationsItem 
    ::  MobileDevice_ApplicationsItem
newMobileDevice_ApplicationsItem
  = MobileDevice_ApplicationsItem{displayName = Core.Nothing,
                                  packageName = Core.Nothing, permission = Core.Nothing,
                                  versionCode = Core.Nothing, versionName = Core.Nothing}
instance Core.FromJSON MobileDevice_ApplicationsItem where
        parseJSON
          = Core.withObject "MobileDevice_ApplicationsItem"
              (\ o ->
                 MobileDevice_ApplicationsItem Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "packageName")
...
instance Core.FromJSON MobileDeviceAction where
        parseJSON
          = Core.withObject "MobileDeviceAction"
              (\ o -> MobileDeviceAction Core.<$> (o Core..:? "action"))
...
newMobileDevices 
    ::  MobileDevices
newMobileDevices
  = MobileDevices{etag = Core.Nothing,
                  kind = "admin#directory#mobiledevices",
                  mobiledevices = Core.Nothing, nextPageToken = Core.Nothing}
instance Core.FromJSON MobileDevices where
        parseJSON
          = Core.withObject "MobileDevices"
              (\ o ->
                 MobileDevices Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#mobiledevices")
...
-- | Managing your account\'s organizational units allows you to configure your users\' access to services and custom settings. For more information about common organizational unit tasks, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-org-units.html Developer\'s Guide>. The customer\'s organizational unit hierarchy is limited to 35 levels of depth.
--
...
newOrgUnit 
    ::  OrgUnit
newOrgUnit
  = OrgUnit{blockInheritance = Core.Nothing,
            description = Core.Nothing, etag = Core.Nothing,
            kind = "admin#directory#orgUnit", name = Core.Nothing,
            orgUnitId = Core.Nothing, orgUnitPath = Core.Nothing,
            parentOrgUnitId = Core.Nothing, parentOrgUnitPath = Core.Nothing}
instance Core.FromJSON OrgUnit where
        parseJSON
          = Core.withObject "OrgUnit"
              (\ o ->
                 OrgUnit Core.<$>
                   (o Core..:? "blockInheritance") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "kind" Core..!= "admin#directory#orgUnit")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "orgUnitId")
                     Core.<*> (o Core..:? "orgUnitPath")
...
instance Core.ToJSON OrgUnit where
        toJSON OrgUnit{..}
          = Core.object
              (Core.catMaybes
                 [("blockInheritance" Core..=) Core.<$> blockInheritance,
                  ("description" Core..=) Core.<$> description,
                  ("etag" Core..=) Core.<$> etag, Core.Just ("kind" Core..= kind),
                  ("name" Core..=) Core.<$> name,
                  ("orgUnitId" Core..=) Core.<$> orgUnitId,
                  ...
                  ("parentOrgUnitPath" Core..=) Core.<$> parentOrgUnitPath])
...
newOrgUnits 
    ::  OrgUnits
newOrgUnits
  = OrgUnits{etag = Core.Nothing, kind = "admin#directory#orgUnits",
             organizationUnits = Core.Nothing}
instance Core.FromJSON OrgUnits where
        parseJSON
          = Core.withObject "OrgUnits"
              (\ o ->
                 OrgUnits Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#orgUnits")
...
instance Core.ToJSON OrgUnits where
        toJSON OrgUnits{..}
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag, Core.Just ("kind" Core..= kind),
                  ("organizationUnits" Core..=) Core.<$> organizationUnits])
...
newOsUpdateStatus 
    ::  OsUpdateStatus
newOsUpdateStatus
  = OsUpdateStatus{rebootTime = Core.Nothing, state = Core.Nothing,
                   targetKioskAppVersion = Core.Nothing,
                   targetOsVersion = Core.Nothing, updateCheckTime = Core.Nothing,
                   updateTime = Core.Nothing}
instance Core.FromJSON OsUpdateStatus where
        parseJSON
          = Core.withObject "OsUpdateStatus"
              (\ o ->
                 OsUpdateStatus Core.<$>
                   (o Core..:? "rebootTime") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "targetKioskAppVersion")
          ...
          = Core.object
              (Core.catMaybes
                 [("rebootTime" Core..=) Core.<$> rebootTime,
                  ...
                  ("targetKioskAppVersion" Core..=) Core.<$> targetKioskAppVersion,
...
newPrintServer 
    ::  PrintServer
newPrintServer
  = PrintServer{createTime = Core.Nothing,
                description = Core.Nothing, displayName = Core.Nothing,
                id = Core.Nothing, name = Core.Nothing, orgUnitId = Core.Nothing,
                uri = Core.Nothing}
instance Core.FromJSON PrintServer where
        parseJSON
          = Core.withObject "PrintServer"
              (\ o ->
                 PrintServer Core.<$>
...
newPrintServerFailureInfo 
    ::  PrintServerFailureInfo
newPrintServerFailureInfo
  = PrintServerFailureInfo{errorCode = Core.Nothing,
                           errorMessage = Core.Nothing, printServer = Core.Nothing,
                           printServerId = Core.Nothing}
instance Core.FromJSON PrintServerFailureInfo where
        parseJSON
          = Core.withObject "PrintServerFailureInfo"
              (\ o ->
                 PrintServerFailureInfo Core.<$>
                   (o Core..:? "errorCode") Core.<*> (o Core..:? "errorMessage")
...
newPrinter 
    ::  Printer
newPrinter
  = Printer{auxiliaryMessages = Core.Nothing,
            createTime = Core.Nothing, description = Core.Nothing,
            displayName = Core.Nothing, id = Core.Nothing,
            makeAndModel = Core.Nothing, name = Core.Nothing,
            orgUnitId = Core.Nothing, uri = Core.Nothing,
            useDriverlessConfig = Core.Nothing}
instance Core.FromJSON Printer where
        parseJSON
          = Core.withObject "Printer"
              (\ o ->
                 Printer Core.<$>
                   (o Core..:? "auxiliaryMessages") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "id")
...
instance Core.ToJSON Printer where
        toJSON Printer{..}
          = Core.object
              (Core.catMaybes
                 [("auxiliaryMessages" Core..=) Core.<$> auxiliaryMessages,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("description" Core..=) Core.<$> description,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("id" Core..=) Core.<$> id,
                  ...
                  ("orgUnitId" Core..=) Core.<$> orgUnitId,
                  ("uri" Core..=) Core.<$> uri,
                  ("useDriverlessConfig" Core..=) Core.<$> useDriverlessConfig])
...
newPrinterModel 
    ::  PrinterModel
newPrinterModel
  = PrinterModel{displayName = Core.Nothing,
                 makeAndModel = Core.Nothing, manufacturer = Core.Nothing}
instance Core.FromJSON PrinterModel where
        parseJSON
          = Core.withObject "PrinterModel"
              (\ o ->
                 PrinterModel Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "makeAndModel")
                     Core.<*> (o Core..:? "manufacturer"))
...
data Privilege = Privilege
    ...
    , privilegeName :: (Core.Maybe Core.Text)
      -- | The obfuscated ID of the service this privilege is for. This value is returned with <https://developers.google.com/workspace/admin/directory/v1/reference/privileges/list Privileges.list()>.
...
newPrivilege 
    ::  Privilege
newPrivilege
  = Privilege{childPrivileges = Core.Nothing, etag = Core.Nothing,
              isOuScopable = Core.Nothing, kind = "admin#directory#privilege",
              privilegeName = Core.Nothing, serviceId = Core.Nothing,
              serviceName = Core.Nothing}
instance Core.FromJSON Privilege where
        parseJSON
          = Core.withObject "Privilege"
              (\ o ->
                 Privilege Core.<$>
                   (o Core..:? "childPrivileges") Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "isOuScopable")
                     Core.<*> (o Core..:? "kind" Core..!= "admin#directory#privilege")
...
instance Core.ToJSON Privilege where
        toJSON Privilege{..}
          = Core.object
              (Core.catMaybes
                 [("childPrivileges" Core..=) Core.<$> childPrivileges,
                  ("etag" Core..=) Core.<$> etag,
...
newPrivileges 
    ::  Privileges
newPrivileges
  = Privileges{etag = Core.Nothing, items = Core.Nothing,
               kind = "admin#directory#privileges"}
instance Core.FromJSON Privileges where
        parseJSON
          = Core.withObject "Privileges"
              (\ o ->
                 Privileges Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#privileges"))
...
newRole 
    ::  Role
newRole
  = Role{etag = Core.Nothing, isSuperAdminRole = Core.Nothing,
         isSystemRole = Core.Nothing, kind = "admin#directory#role",
         roleDescription = Core.Nothing, roleId = Core.Nothing,
         roleName = Core.Nothing, rolePrivileges = Core.Nothing}
instance Core.FromJSON Role where
        parseJSON
          = Core.withObject "Role"
              (\ o ->
                 Role Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "isSuperAdminRole")
                     Core.<*> (o Core..:? "isSystemRole")
                     Core.<*> (o Core..:? "kind" Core..!= "admin#directory#role")
                     Core.<*> (o Core..:? "roleDescription")
                     Core.<*> (o Core..:? "roleId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON Role where
        toJSON Role{..}
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag,
                  ("isSuperAdminRole" Core..=) Core.<$> isSuperAdminRole,
                  ("isSystemRole" Core..=) Core.<$> isSystemRole,
                  Core.Just ("kind" Core..= kind),
                  ("roleDescription" Core..=) Core.<$> roleDescription,
                  ("roleId" Core..=) Core.. Core.AsText Core.<$> roleId,
...
newRole_RolePrivilegesItem 
    ::  Role_RolePrivilegesItem
newRole_RolePrivilegesItem
  = Role_RolePrivilegesItem{privilegeName = Core.Nothing,
                            serviceId = Core.Nothing}
instance Core.FromJSON Role_RolePrivilegesItem where
        parseJSON
          = Core.withObject "Role_RolePrivilegesItem"
              (\ o ->
                 Role_RolePrivilegesItem Core.<$>
                   (o Core..:? "privilegeName") Core.<*> (o Core..:? "serviceId"))
...
data RoleAssignment = RoleAssignment
    {
      -- | The unique ID of the entity this role is assigned to—either the @user_id@ of a user, the @group_id@ of a group, or the @uniqueId@ of a service account as defined in <https://cloud.google.com/iam/docs/reference/rest/v1/projects.serviceAccounts Identity and Access Management (IAM)>.
    ...
    , assigneeType :: (Core.Maybe RoleAssignment_AssigneeType)
      -- | Optional. The condition associated with this role assignment. Note: Feature is available to Enterprise Standard, Enterprise Plus, Google Workspace for Education Plus and Cloud Identity Premium customers. A @RoleAssignment@ with the @condition@ field set will only take effect when the resource being accessed meets the condition. If @condition@ is empty, the role (@role_id@) is applied to the actor (@assigned_to@) at the scope (@scope_type@) unconditionally. Currently, the following conditions are supported: - To make the @RoleAssignment@ only applicable to <https://cloud.google.com/identity/docs/groups#group_types Security Groups>: @api.getAttribute(\'cloudidentity.googleapis.com\/groups.labels\', []).hasAny([\'groups.security\']) && resource.type == \'cloudidentity.googleapis.com\/Group\'@ - To make the @RoleAssignment@ not applicable to <https://cloud.google.com/identity/docs/groups#group_types Security Groups>:
      -- @!api.getAttribute(\'cloudidentity.googleapis.com\/groups.labels\', []).hasAny([\'groups.security\']) && resource.type == \'cloudidentity.googleapis.com\/Group\'@ Currently, the condition strings have to be verbatim and they only work with the following <https://support.google.com/a/answer/2405986 pre-built administrator roles>: - Groups Editor - Groups Reader The condition follows <https://cloud.google.com/iam/docs/conditions-overview Cloud IAM condition syntax>. Additional conditions related to Locked Groups are available under Open Beta. - To make the @RoleAssignment@ not applicable to <https://cloud.google.com/identity/docs/groups#group_types Locked Groups>: @!api.getAttribute(\'cloudidentity.googleapis.com\/groups.labels\', []).hasAny([\'groups.locked\']) && resource.type == \'cloudidentity.googleapis.com\/Group\'@ This condition can also be used in conjunction with a Security-related condition.
...
newRoleAssignment 
    ::  RoleAssignment
newRoleAssignment
  = RoleAssignment{assignedTo = Core.Nothing,
                   assigneeType = Core.Nothing, condition = Core.Nothing,
                   etag = Core.Nothing, kind = "admin#directory#roleAssignment",
                   orgUnitId = Core.Nothing, roleAssignmentId = Core.Nothing,
                   roleId = Core.Nothing, scopeType = Core.Nothing}
instance Core.FromJSON RoleAssignment where
        parseJSON
          = Core.withObject "RoleAssignment"
              (\ o ->
                 RoleAssignment Core.<$>
                   (o Core..:? "assignedTo") Core.<*> (o Core..:? "assigneeType")
                     Core.<*> (o Core..:? "condition")
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#roleAssignment")
                     Core.<*> (o Core..:? "orgUnitId")
                     Core.<*>
                     (o Core..:? "roleAssignmentId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "roleId" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("assignedTo" Core..=) Core.<$> assignedTo,
                  ...
                  ("etag" Core..=) Core.<$> etag, Core.Just ("kind" Core..= kind),
                  ("orgUnitId" Core..=) Core.<$> orgUnitId,
                  ("roleAssignmentId" Core..=) Core.. Core.AsText Core.<$>
                    roleAssignmentId,
                  ("roleId" Core..=) Core.. Core.AsText Core.<$> roleId,
...
newRoleAssignments 
    ::  RoleAssignments
newRoleAssignments
  = RoleAssignments{etag = Core.Nothing, items = Core.Nothing,
                    kind = "admin#directory#roleAssignments",
                    nextPageToken = Core.Nothing}
instance Core.FromJSON RoleAssignments where
        parseJSON
          = Core.withObject "RoleAssignments"
              (\ o ->
                 RoleAssignments Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#roleAssignments")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newRoles 
    ::  Roles
newRoles
  = Roles{etag = Core.Nothing, items = Core.Nothing,
          kind = "admin#directory#roles", nextPageToken = Core.Nothing}
instance Core.FromJSON Roles where
        parseJSON
          = Core.withObject "Roles"
              (\ o ->
                 Roles Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#roles")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newSchema 
    ::  Schema
newSchema
  = Schema{displayName = Core.Nothing, etag = Core.Nothing,
           fields = Core.Nothing, kind = "admin#directory#schema",
           schemaId = Core.Nothing, schemaName = Core.Nothing}
instance Core.FromJSON Schema where
        parseJSON
          = Core.withObject "Schema"
              (\ o ->
                 Schema Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "fields")
...
instance Core.ToJSON Schema where
        toJSON Schema{..}
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ("etag" Core..=) Core.<$> etag, ("fields" Core..=) Core.<$> fields,
                  Core.Just ("kind" Core..= kind),
                  ("schemaId" Core..=) Core.<$> schemaId,
                  ("schemaName" Core..=) Core.<$> schemaName])


-- | You can use schemas to add custom fields to user profiles. You can use these fields to store information such as the projects your users work on, their physical locations, their hire dates, or whatever else fits your business needs. For more information, see <https://developers.google.com/workspace/admin/directory/v1/guides/manage-schemas Custom User Fields>.
--
...
data SchemaFieldSpec = SchemaFieldSpec
    ...
    , numericIndexingSpec :: (Core.Maybe SchemaFieldSpec_NumericIndexingSpec)
      -- | Specifies who can view values of this field. See <https://developers.google.com/workspace/admin/directory/v1/guides/manage-users#retrieve_users_non_admin Retrieve users as a non-administrator> for more information. Note: It may take up to 24 hours for changes to this field to be reflected.
...
newSchemaFieldSpec 
    ::  SchemaFieldSpec
newSchemaFieldSpec
  = SchemaFieldSpec{displayName = Core.Nothing, etag = Core.Nothing,
                    fieldId = Core.Nothing, fieldName = Core.Nothing,
                    fieldType = Core.Nothing, indexed = Core.True,
                    kind = "admin#directory#schema#fieldspec",
                    multiValued = Core.Nothing, numericIndexingSpec = Core.Nothing,
                    readAccessType = "ALL_DOMAIN_USERS"}
instance Core.FromJSON SchemaFieldSpec where
        parseJSON
          = Core.withObject "SchemaFieldSpec"
              (\ o ->
                 SchemaFieldSpec Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "fieldId")
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#schema#fieldspec")
                     Core.<*> (o Core..:? "multiValued")
                     Core.<*> (o Core..:? "numericIndexingSpec")
                     Core.<*> (o Core..:? "readAccessType" Core..!= "ALL_DOMAIN_USERS"))
          ...
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ...
                  ("numericIndexingSpec" Core..=) Core.<$> numericIndexingSpec,
...
newSchemaFieldSpec_NumericIndexingSpec 
    :: 
                                       SchemaFieldSpec_NumericIndexingSpec
newSchemaFieldSpec_NumericIndexingSpec
  = SchemaFieldSpec_NumericIndexingSpec{maxValue = Core.Nothing,
                                        minValue = Core.Nothing}
instance Core.FromJSON SchemaFieldSpec_NumericIndexingSpec where
        parseJSON
          = Core.withObject "SchemaFieldSpec_NumericIndexingSpec"
              (\ o ->
                 SchemaFieldSpec_NumericIndexingSpec Core.<$>
                   (o Core..:? "maxValue") Core.<*> (o Core..:? "minValue"))

instance Core.ToJSON SchemaFieldSpec_NumericIndexingSpec where
...
newSchemas 
    ::  Schemas
newSchemas
  = Schemas{etag = Core.Nothing, kind = "admin#directory#schemas",
            schemas = Core.Nothing}
instance Core.FromJSON Schemas where
        parseJSON
          = Core.withObject "Schemas"
              (\ o ->
                 Schemas Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#schemas")
                     Core.<*> (o Core..:? "schemas"))
...
newToken 
    ::  Token
newToken
  = Token{anonymous = Core.Nothing, clientId = Core.Nothing,
          displayText = Core.Nothing, etag = Core.Nothing,
          kind = "admin#directory#token", nativeApp = Core.Nothing,
          scopes = Core.Nothing, userKey = Core.Nothing}
instance Core.FromJSON Token where
        parseJSON
          = Core.withObject "Token"
              (\ o ->
                 Token Core.<$>
...
newTokens 
    ::  Tokens
newTokens
  = Tokens{etag = Core.Nothing, items = Core.Nothing,
           kind = "admin#directory#tokenList"}
instance Core.FromJSON Tokens where
        parseJSON
          = Core.withObject "Tokens"
              (\ o ->
                 Tokens Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#tokenList"))
...
-- | The Directory API allows you to create and manage your account\'s users, user aliases, and user Google profile photos. For more information about common tasks, see the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-users.html User Accounts Developer\'s Guide> and the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-user-aliases.html User Aliases Developer\'s Guide>.
--
...
data User = User
    ...
    , customSchemas :: (Core.Maybe User_CustomSchemas)
      -- | Output only. The customer ID to <https://developers.google.com/workspace/admin/directory/v1/guides/manage-users.html#get_all_users retrieve all account users>. You can use the alias @my_customer@ to represent your account\'s @customerId@. As a reseller administrator, you can use the resold customer account\'s @customerId@. To get a @customerId@, use the account\'s primary domain in the @domain@ parameter of a <https://developers.google.com/workspace/admin/directory/v1/reference/users/list users.list> request.
    ...
    , ipWhitelisted :: (Core.Maybe Core.Bool)
      -- | Output only. Indicates a user with super administrator privileges. The @isAdmin@ property can only be edited in the <https://developers.google.com/workspace/admin/directory/v1/guides/manage-users.html#make_admin Make a user an administrator> operation ( <https://developers.google.com/workspace/admin/directory/v1/reference/users/makeAdmin.html makeAdmin> method). If edited in the user <https://developers.google.com/workspace/admin/directory/v1/reference/users/insert.html insert> or <https://developers.google.com/workspace/admin/directory/v1/reference/users/update.html update> methods, the edit is ignored by the API service.
...
newUser 
    ::  User
newUser
  = User{addresses = Core.Nothing, agreedToTerms = Core.Nothing,
         aliases = Core.Nothing, archived = Core.Nothing,
         changePasswordAtNextLogin = Core.Nothing,
         creationTime = Core.Nothing, customSchemas = Core.Nothing,
         customerId = Core.Nothing, deletionTime = Core.Nothing,
         emails = Core.Nothing, etag = Core.Nothing,
         externalIds = Core.Nothing, gender = Core.Nothing,
         hashFunction = Core.Nothing, id = Core.Nothing, ims = Core.Nothing,
         includeInGlobalAddressList = Core.Nothing,
         ipWhitelisted = Core.Nothing, isAdmin = Core.Nothing,
         isDelegatedAdmin = Core.Nothing, isEnforcedIn2Sv = Core.Nothing,
         isEnrolledIn2Sv = Core.Nothing, isMailboxSetup = Core.Nothing,
         keywords = Core.Nothing, kind = "admin#directory#user",
         languages = Core.Nothing, lastLoginTime = Core.Nothing,
         locations = Core.Nothing, name = Core.Nothing,
         nonEditableAliases = Core.Nothing, notes = Core.Nothing,
         orgUnitPath = Core.Nothing, organizations = Core.Nothing,
         password = Core.Nothing, phones = Core.Nothing,
         posixAccounts = Core.Nothing, primaryEmail = Core.Nothing,
         recoveryEmail = Core.Nothing, recoveryPhone = Core.Nothing,
         relations = Core.Nothing, sshPublicKeys = Core.Nothing,
         suspended = Core.Nothing, suspensionReason = Core.Nothing,
         thumbnailPhotoEtag = Core.Nothing,
         thumbnailPhotoUrl = Core.Nothing, websites = Core.Nothing}
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User"
              (\ o ->
                 User Core.<$>
                   (o Core..:? "addresses") Core.<*> (o Core..:? "agreedToTerms")
                     Core.<*> (o Core..:? "aliases")
          ...
          = Core.object
              (Core.catMaybes
                 [("addresses" Core..=) Core.<$> addresses,
                  ...
                  ("changePasswordAtNextLogin" Core..=) Core.<$>
                  ...
                  ("thumbnailPhotoEtag" Core..=) Core.<$> thumbnailPhotoEtag,
                  ("thumbnailPhotoUrl" Core..=) Core.<$> thumbnailPhotoUrl,
...
newtype User_CustomSchemas = User_CustomSchemas
    {
      ...
      additional :: (Core.HashMap Core.Text UserCustomProperties)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newUser_CustomSchemas 
    :: 
       ...
       -- ^  See 'additional'.
    -> User_CustomSchemas
newUser_CustomSchemas additional
  = User_CustomSchemas{additional = additional}
instance Core.FromJSON User_CustomSchemas where
        parseJSON
          = Core.withObject "User_CustomSchemas"
              (\ o -> User_CustomSchemas Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON User_CustomSchemas where
        toJSON User_CustomSchemas{..} = Core.toJSON additional
...
newUserAbout 
    ::  UserAbout
newUserAbout
  = UserAbout{contentType = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON UserAbout where
        parseJSON
          = Core.withObject "UserAbout"
              (\ o ->
                 UserAbout Core.<$>
                   (o Core..:? "contentType") Core.<*> (o Core..:? "value"))
...
newUserAddress 
    ::  UserAddress
newUserAddress
  = UserAddress{country = Core.Nothing, countryCode = Core.Nothing,
                customType = Core.Nothing, extendedAddress = Core.Nothing,
                formatted = Core.Nothing, locality = Core.Nothing,
                poBox = Core.Nothing, postalCode = Core.Nothing,
                primary = Core.Nothing, region = Core.Nothing,
                sourceIsStructured = Core.Nothing, streetAddress = Core.Nothing,
                type' = Core.Nothing}
instance Core.FromJSON UserAddress where
        parseJSON
          = Core.withObject "UserAddress"
              (\ o ->
                 UserAddress Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "countryCode") Core.<*>
                     (o Core..:? "customType")
          ...
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ...
                  ("region" Core..=) Core.<$> region,
                  ("sourceIsStructured" Core..=) Core.<$> sourceIsStructured,
...
newUserAlias 
    ::  UserAlias
newUserAlias
  = UserAlias{alias = Core.Nothing, etag = Core.Nothing,
              id = Core.Nothing, kind = Core.Nothing,
              primaryEmail = Core.Nothing}
instance Core.FromJSON UserAlias where
        parseJSON
          = Core.withObject "UserAlias"
              (\ o ->
                 UserAlias Core.<$>
                   (o Core..:? "alias") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "id")
...
newUserCustomProperties 
    :: 
       ...
       -- ^  See 'additional'.
    -> UserCustomProperties
newUserCustomProperties additional
  = UserCustomProperties{additional = additional}
instance Core.FromJSON UserCustomProperties where
        parseJSON
          = Core.withObject "UserCustomProperties"
              (\ o -> UserCustomProperties Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON UserCustomProperties where
        toJSON UserCustomProperties{..} = Core.toJSON additional
...
data UserEmail = UserEmail
    ...
    , publicKeyEncryptionCertificates :: (Core.Maybe UserEmail_Public_key_encryption_certificates)
...
newUserEmail 
    ::  UserEmail
newUserEmail
  = UserEmail{address = Core.Nothing, customType = Core.Nothing,
              primary = Core.Nothing,
              publicKeyEncryptionCertificates = Core.Nothing,
              type' = Core.Nothing}
instance Core.FromJSON UserEmail where
        parseJSON
          = Core.withObject "UserEmail"
              (\ o ->
                 UserEmail Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "customType") Core.<*>
                     (o Core..:? "primary")
                     Core.<*> (o Core..:? "public_key_encryption_certificates")
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ("customType" Core..=) Core.<$> customType,
                  ("primary" Core..=) Core.<$> primary,
                  ("public_key_encryption_certificates" Core..=) Core.<$>
...
-- | Public Key Encryption Certificates. Current limit: 1 per email address, and 5 per user.
--
-- /See:/ 'newUserEmail_Public_key_encryption_certificates' smart constructor.
data UserEmail_Public_key_encryption_certificates = UserEmail_Public_key_encryption_certificates
    {
...
-- | Creates a value of 'UserEmail_Public_key_encryption_certificates' with the minimum fields required to make a request.
newUserEmail_Public_key_encryption_certificates 
    :: 
                                                UserEmail_Public_key_encryption_certificates
newUserEmail_Public_key_encryption_certificates
  = UserEmail_Public_key_encryption_certificates{certificate =
                                                   Core.Nothing,
                                                 isDefault = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON UserEmail_Public_key_encryption_certificates
         where
        parseJSON
          = Core.withObject "UserEmail_Public_key_encryption_certificates"
              (\ o ->
                 UserEmail_Public_key_encryption_certificates Core.<$>
                   (o Core..:? "certificate") Core.<*> (o Core..:? "is_default")
                     Core.<*> (o Core..:? "state"))

instance Core.ToJSON UserEmail_Public_key_encryption_certificates
         where
        toJSON UserEmail_Public_key_encryption_certificates{..}
          = Core.object
              (Core.catMaybes
                 [("certificate" Core..=) Core.<$> certificate,
                  ("is_default" Core..=) Core.<$> isDefault,
                  ("state" Core..=) Core.<$> state])
...
newUserExternalId 
    ::  UserExternalId
newUserExternalId
  = UserExternalId{customType = Core.Nothing, type' = Core.Nothing,
                   value = Core.Nothing}
instance Core.FromJSON UserExternalId where
        parseJSON
          = Core.withObject "UserExternalId"
              (\ o ->
                 UserExternalId Core.<$>
                   (o Core..:? "customType") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "value"))
...
instance Core.ToJSON UserExternalId where
        toJSON UserExternalId{..}
          = Core.object
              (Core.catMaybes
                 [("customType" Core..=) Core.<$> customType,
                  ("type" Core..=) Core.<$> type', ("value" Core..=) Core.<$> value])
...
newUserGender 
    ::  UserGender
newUserGender
  = UserGender{addressMeAs = Core.Nothing,
               customGender = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON UserGender where
        parseJSON
          = Core.withObject "UserGender"
              (\ o ->
                 UserGender Core.<$>
                   (o Core..:? "addressMeAs") Core.<*> (o Core..:? "customGender")
                     Core.<*> (o Core..:? "type"))
...
newUserIm 
    ::  UserIm
newUserIm
  = UserIm{customProtocol = Core.Nothing, customType = Core.Nothing,
           im = Core.Nothing, primary = Core.Nothing, protocol = Core.Nothing,
           type' = Core.Nothing}
instance Core.FromJSON UserIm where
        parseJSON
          = Core.withObject "UserIm"
              (\ o ->
                 UserIm Core.<$>
                   (o Core..:? "customProtocol") Core.<*> (o Core..:? "customType")
                     Core.<*> (o Core..:? "im")
                     Core.<*> (o Core..:? "primary")
          ...
          = Core.object
              (Core.catMaybes
                 [("customProtocol" Core..=) Core.<$> customProtocol,
                  ("customType" Core..=) Core.<$> customType,
                  ("im" Core..=) Core.<$> im, ("primary" Core..=) Core.<$> primary,
...
newUserKeyword 
    ::  UserKeyword
newUserKeyword
  = UserKeyword{customType = Core.Nothing, type' = Core.Nothing,
                value = Core.Nothing}
instance Core.FromJSON UserKeyword where
        parseJSON
          = Core.withObject "UserKeyword"
              (\ o ->
                 UserKeyword Core.<$>
                   (o Core..:? "customType") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "value"))
...
newUserLanguage 
    ::  UserLanguage
newUserLanguage
  = UserLanguage{customLanguage = Core.Nothing,
                 languageCode = Core.Nothing, preference = Core.Nothing}
instance Core.FromJSON UserLanguage where
        parseJSON
          = Core.withObject "UserLanguage"
              (\ o ->
                 UserLanguage Core.<$>
                   (o Core..:? "customLanguage") Core.<*> (o Core..:? "languageCode")
...
newUserLocation 
    ::  UserLocation
newUserLocation
  = UserLocation{area = Core.Nothing, buildingId = Core.Nothing,
                 customType = Core.Nothing, deskCode = Core.Nothing,
                 floorName = Core.Nothing, floorSection = Core.Nothing,
                 type' = Core.Nothing}
instance Core.FromJSON UserLocation where
        parseJSON
          = Core.withObject "UserLocation"
              (\ o ->
                 UserLocation Core.<$>
                   (o Core..:? "area") Core.<*> (o Core..:? "buildingId") Core.<*>
                     (o Core..:? "customType")
...
newUserName 
    ::  UserName
newUserName
  = UserName{displayName = Core.Nothing, familyName = Core.Nothing,
             fullName = Core.Nothing, givenName = Core.Nothing}
instance Core.FromJSON UserName where
        parseJSON
          = Core.withObject "UserName"
              (\ o ->
                 UserName Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "familyName")
...
newUserOrganization 
    ::  UserOrganization
newUserOrganization
  = UserOrganization{costCenter = Core.Nothing,
                     customType = Core.Nothing, department = Core.Nothing,
                     description = Core.Nothing, domain = Core.Nothing,
                     fullTimeEquivalent = Core.Nothing, location = Core.Nothing,
                     name = Core.Nothing, primary = Core.Nothing, symbol = Core.Nothing,
                     title = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON UserOrganization where
        parseJSON
          = Core.withObject "UserOrganization"
              (\ o ->
                 UserOrganization Core.<$>
                   (o Core..:? "costCenter") Core.<*> (o Core..:? "customType")
          ...
          = Core.object
              (Core.catMaybes
                 [("costCenter" Core..=) Core.<$> costCenter,
                  ...
                  ("fullTimeEquivalent" Core..=) Core.<$> fullTimeEquivalent,
...
newUserPhone 
    ::  UserPhone
newUserPhone
  = UserPhone{customType = Core.Nothing, primary = Core.Nothing,
              type' = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON UserPhone where
        parseJSON
          = Core.withObject "UserPhone"
              (\ o ->
                 UserPhone Core.<$>
                   (o Core..:? "customType") Core.<*> (o Core..:? "primary") Core.<*>
                     (o Core..:? "type")
                     Core.<*> (o Core..:? "value"))
...
newUserPhoto 
    ::  UserPhoto
newUserPhoto
  = UserPhoto{etag = Core.Nothing, height = Core.Nothing,
              id = Core.Nothing, kind = "admin#directory#user#photo",
              mimeType = Core.Nothing, photoData = Core.Nothing,
              primaryEmail = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON UserPhoto where
        parseJSON
          = Core.withObject "UserPhoto"
              (\ o ->
                 UserPhoto Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "height") Core.<*>
                     (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "admin#directory#user#photo")
...
instance Core.ToJSON UserPhoto where
        toJSON UserPhoto{..}
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag,
                  ("height" Core..=) Core.<$> height, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
...
newUserPosixAccount 
    ::  UserPosixAccount
newUserPosixAccount
  = UserPosixAccount{accountId = Core.Nothing, gecos = Core.Nothing,
                     gid = Core.Nothing, homeDirectory = Core.Nothing,
                     operatingSystemType = Core.Nothing, primary = Core.Nothing,
                     shell = Core.Nothing, systemId = Core.Nothing, uid = Core.Nothing,
                     username = Core.Nothing}
instance Core.FromJSON UserPosixAccount where
        parseJSON
          = Core.withObject "UserPosixAccount"
              (\ o ->
                 UserPosixAccount Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "gecos") Core.<*>
                     (o Core..:? "gid" Core.<&> Core.fmap Core.fromAsText)
...
newUserRelation 
    ::  UserRelation
newUserRelation
  = UserRelation{customType = Core.Nothing, type' = Core.Nothing,
                 value = Core.Nothing}
instance Core.FromJSON UserRelation where
        parseJSON
          = Core.withObject "UserRelation"
              (\ o ->
                 UserRelation Core.<$>
                   (o Core..:? "customType") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "value"))
...
newUserSshPublicKey 
    ::  UserSshPublicKey
newUserSshPublicKey
  = UserSshPublicKey{expirationTimeUsec = Core.Nothing,
                     fingerprint = Core.Nothing, key = Core.Nothing}
instance Core.FromJSON UserSshPublicKey where
        parseJSON
          = Core.withObject "UserSshPublicKey"
              (\ o ->
                 UserSshPublicKey Core.<$>
                   (o Core..:? "expirationTimeUsec" Core.<&>
                      Core.fmap Core.fromAsText)
...
instance Core.ToJSON UserSshPublicKey where
        toJSON UserSshPublicKey{..}
          = Core.object
              (Core.catMaybes
                 [("expirationTimeUsec" Core..=) Core.. Core.AsText Core.<$>
                    expirationTimeUsec,
...
instance Core.FromJSON UserUndelete where
        parseJSON
          = Core.withObject "UserUndelete"
              (\ o -> UserUndelete Core.<$> (o Core..:? "orgUnitPath"))

instance Core.ToJSON UserUndelete where
        toJSON UserUndelete{..}
          = Core.object
              (Core.catMaybes [("orgUnitPath" Core..=) Core.<$> orgUnitPath])
...
newUserWebsite 
    ::  UserWebsite
newUserWebsite
  = UserWebsite{customType = Core.Nothing, primary = Core.Nothing,
                type' = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON UserWebsite where
        parseJSON
          = Core.withObject "UserWebsite"
              (\ o ->
                 UserWebsite Core.<$>
                   (o Core..:? "customType") Core.<*> (o Core..:? "primary") Core.<*>
                     (o Core..:? "type")
...
newUsers 
    ::  Users
newUsers
  = Users{etag = Core.Nothing, kind = "admin#directory#users",
          nextPageToken = Core.Nothing, triggerEvent = Core.Nothing,
          users = Core.Nothing}
instance Core.FromJSON Users where
        parseJSON
          = Core.withObject "Users"
              (\ o ->
                 Users Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#users")
                     Core.<*> (o Core..:? "nextPageToken")
...
newVerificationCode 
    ::  VerificationCode
newVerificationCode
  = VerificationCode{etag = Core.Nothing,
                     kind = "admin#directory#verificationCode", userId = Core.Nothing,
                     verificationCode = Core.Nothing}
instance Core.FromJSON VerificationCode where
        parseJSON
          = Core.withObject "VerificationCode"
              (\ o ->
                 VerificationCode Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#directory#verificationCode")
                     Core.<*> (o Core..:? "userId")
