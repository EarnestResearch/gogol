...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.calendars.list@.
module Gogol.Admin.Directory.Resources.Calendars.List
    (
    -- * Resource
...
newDirectoryResourcesCalendarsList customer
  = DirectoryResourcesCalendarsList{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    customer = customer, maxResults = Core.Nothing,
                                    orderBy = Core.Nothing, pageToken = Core.Nothing,
                                    query = Core.Nothing, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryResourcesCalendarsList where
        type Rs DirectoryResourcesCalendarsList = CalendarResources
        ...
        requestClient DirectoryResourcesCalendarsList{..}
          = go customer xgafv accessToken callback maxResults orderBy
              pageToken
              query
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryResourcesCalendarsListResource)
                      Core.mempty
