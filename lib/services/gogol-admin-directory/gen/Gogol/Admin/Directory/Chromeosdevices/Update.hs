                               ...
                               Core.QueryParam "upload_protocol" Core.Text
                                 ...
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] ChromeOsDevice
                                     Core.:>
                                     Core.Put '[Core.JSON] ChromeOsDevice
...
instance Core.GoogleRequest
           DirectoryChromeosdevicesUpdate
         where
        type Rs DirectoryChromeosdevicesUpdate =
             ChromeOsDevice
        type Scopes DirectoryChromeosdevicesUpdate =
        ...
        requestClient DirectoryChromeosdevicesUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DirectoryChromeosdevicesUpdateResource)
                      Core.mempty
