...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.groups.list@.
module Gogol.Admin.Directory.Groups.List
    (
    -- * Resource
                   ...
                   Core.QueryParam "customer" Core.Text Core.:>
                     Core.QueryParam "domain" Core.Text Core.:>
                       Core.QueryParam "maxResults" Core.Int32 Core.:>
                         Core.QueryParam "orderBy" GroupsListOrderBy Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "query" Core.Text Core.:>
                               Core.QueryParam "sortOrder" GroupsListSortOrder Core.:>
...
data DirectoryGroupsList = DirectoryGroupsList
    ...
    , callback :: (Core.Maybe Core.Text)
      -- | The unique ID for the customer\'s Google Workspace account. In case of a multi-domain account, to fetch all groups for a customer, use this field instead of @domain@. You can also use the @my_customer@ alias to represent your account\'s @customerId@. The @customerId@ is also returned as part of the <https://developers.google.com/workspace/admin/directory/v1/reference/users Users> resource. You must provide either the @customer@ or the @domain@ parameter.
...
newDirectoryGroupsList 
    ::  DirectoryGroupsList
newDirectoryGroupsList
  = DirectoryGroupsList{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        customer = Core.Nothing, domain = Core.Nothing, maxResults = 200,
