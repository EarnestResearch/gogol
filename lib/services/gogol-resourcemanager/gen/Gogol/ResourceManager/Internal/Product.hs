...
instance Core.FromJSON CreateFolderMetadata where
        parseJSON
          = Core.withObject "CreateFolderMetadata"
              (\ o ->
                 CreateFolderMetadata Core.<$>
...
newCreateProjectMetadata =
  CreateProjectMetadata
    {createTime = Core.Nothing, gettable = Core.Nothing, ready = Core.Nothing}

instance Core.FromJSON CreateProjectMetadata where
        parseJSON
          = Core.withObject "CreateProjectMetadata"
              (\ o ->
                 CreateProjectMetadata Core.<$>
...
instance Core.FromJSON CreateTagBindingMetadata where
        parseJSON
          = Core.withObject "CreateTagBindingMetadata"
...
instance Core.FromJSON CreateTagKeyMetadata where
        parseJSON
          = Core.withObject "CreateTagKeyMetadata"
...
instance Core.FromJSON CreateTagValueMetadata where
        parseJSON
          = Core.withObject "CreateTagValueMetadata"
...
instance Core.FromJSON DeleteFolderMetadata where
        parseJSON
          = Core.withObject "DeleteFolderMetadata"
...
instance Core.FromJSON DeleteOrganizationMetadata
         where
        parseJSON
          = Core.withObject "DeleteOrganizationMetadata"
...
instance Core.FromJSON DeleteProjectMetadata where
        parseJSON
          = Core.withObject "DeleteProjectMetadata"
...
instance Core.FromJSON DeleteTagBindingMetadata where
        parseJSON
          = Core.withObject "DeleteTagBindingMetadata"
...
instance Core.FromJSON DeleteTagKeyMetadata where
        parseJSON
          = Core.withObject "DeleteTagKeyMetadata"
...
instance Core.FromJSON DeleteTagValueMetadata where
        parseJSON
          = Core.withObject "DeleteTagValueMetadata"
...
instance Core.FromJSON EffectiveTag where
        parseJSON
          = Core.withObject "EffectiveTag"
              (\ o ->
                 EffectiveTag Core.<$>
                   (o Core..:? "inherited") Core.<*>
                     (o Core..:? "namespacedTagKey")
          ...
          = Core.object
              (Core.catMaybes
                 [("inherited" Core..=) Core.<$> inherited,
                  ("namespacedTagKey" Core..=) Core.<$>
                    namespacedTagKey,
                  ("namespacedTagValue" Core..=) Core.<$>
                    namespacedTagValue,
                  ("tagKey" Core..=) Core.<$> tagKey,
                  ("tagKeyParentName" Core..=) Core.<$>
                    tagKeyParentName,
...
instance Core.FromJSON FolderOperation where
        parseJSON
          = Core.withObject "FolderOperation"
              (\ o ->
                 FolderOperation Core.<$>
                   (o Core..:? "destinationParent") Core.<*>
                     (o Core..:? "displayName")
                     Core.<*> (o Core..:? "operationType")
                     Core.<*> (o Core..:? "sourceParent"))
...
instance Core.FromJSON FolderOperationError where
        parseJSON
          = Core.withObject "FolderOperationError"
              (\ o ->
                 FolderOperationError Core.<$>
                   (o Core..:? "errorMessageId"))
...
newListEffectiveTagsResponse =
  ListEffectiveTagsResponse
    {effectiveTags = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListEffectiveTagsResponse
         where
        parseJSON
          = Core.withObject "ListEffectiveTagsResponse"
              (\ o ->
                 ListEffectiveTagsResponse Core.<$>
                   (o Core..:? "effectiveTags") Core.<*>
...
instance Core.FromJSON ListLiensResponse where
        parseJSON
          = Core.withObject "ListLiensResponse"
              (\ o ->
                 ListLiensResponse Core.<$>
                   (o Core..:? "liens") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListProjectsResponse where
        parseJSON
          = Core.withObject "ListProjectsResponse"
              (\ o ->
...
newListTagBindingsResponse =
  ListTagBindingsResponse
    {nextPageToken = Core.Nothing, tagBindings = Core.Nothing}

instance Core.FromJSON ListTagBindingsResponse where
        parseJSON
          = Core.withObject "ListTagBindingsResponse"
              (\ o ->
                 ListTagBindingsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "tagBindings"))
...
instance Core.FromJSON ListTagHoldsResponse where
        parseJSON
          = Core.withObject "ListTagHoldsResponse"
              (\ o ->
                 ListTagHoldsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "tagHolds"))
...
instance Core.FromJSON ListTagKeysResponse where
        parseJSON
          = Core.withObject "ListTagKeysResponse"
              (\ o ->
                 ListTagKeysResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "tagKeys"))
...
instance Core.FromJSON ListTagValuesResponse where
        parseJSON
          = Core.withObject "ListTagValuesResponse"
              (\ o ->
                 ListTagValuesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "tagValues"))
...
instance Core.FromJSON MoveFolderMetadata where
        parseJSON
          = Core.withObject "MoveFolderMetadata"
              (\ o ->
                 MoveFolderMetadata Core.<$>
                   (o Core..:? "destinationParent") Core.<*>
                     (o Core..:? "displayName")
                     Core.<*> (o Core..:? "sourceParent"))
...
instance Core.FromJSON MoveFolderRequest where
        parseJSON
          = Core.withObject "MoveFolderRequest"
              (\ o ->
                 MoveFolderRequest Core.<$>
                   (o Core..:? "destinationParent"))
...
instance Core.FromJSON MoveProjectMetadata where
        parseJSON
          = Core.withObject "MoveProjectMetadata"
...
instance Core.FromJSON MoveProjectRequest where
        parseJSON
          = Core.withObject "MoveProjectRequest"
              (\ o ->
                 MoveProjectRequest Core.<$>
                   (o Core..:? "destinationParent"))
...
instance Core.FromJSON Project_Labels where
        parseJSON
          = Core.withObject "Project_Labels"
              (\ o ->
...
instance Core.FromJSON ProjectCreationStatus where
        parseJSON
          = Core.withObject "ProjectCreationStatus"
              (\ o ->
                 ProjectCreationStatus Core.<$>
                   (o Core..:? "createTime") Core.<*>
                     (o Core..:? "gettable")
                     Core.<*> (o Core..:? "ready"))
...
instance Core.FromJSON SearchFoldersResponse where
        parseJSON
          = Core.withObject "SearchFoldersResponse"
              (\ o ->
                 SearchFoldersResponse Core.<$>
                   (o Core..:? "folders") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newSearchOrganizationsResponse =
  SearchOrganizationsResponse
    {nextPageToken = Core.Nothing, organizations = Core.Nothing}

instance Core.FromJSON SearchOrganizationsResponse
         where
        parseJSON
          = Core.withObject "SearchOrganizationsResponse"
              (\ o ->
                 SearchOrganizationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "organizations"))

instance Core.ToJSON SearchOrganizationsResponse
         where
...
instance Core.FromJSON SearchProjectsResponse where
        parseJSON
          = Core.withObject "SearchProjectsResponse"
              (\ o ->
                 SearchProjectsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "projects"))
...
data TagBinding = TagBinding
    ...
    , tagValue :: (Core.Maybe Core.Text)
      -- | The namespaced name for the TagValue of the TagBinding. Must be in the format @{parent_id}\/{tag_key_short_name}\/{short_name}@. For methods that support TagValue namespaced name, only one of tag/value/namespaced/name or tag/value may be filled. Requests with both fields will be rejected.
    , tagValueNamespacedName :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newTagBinding =
  TagBinding
    ...
    , parent = Core.Nothing
    , tagValue = Core.Nothing
    , tagValueNamespacedName = Core.Nothing
    }

instance Core.FromJSON TagBinding where
        parseJSON
          = Core.withObject "TagBinding"
              (\ o ->
                 TagBinding Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "parent")
                     Core.<*> (o Core..:? "tagValue")
                     Core.<*> (o Core..:? "tagValueNamespacedName"))
          ...
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ("parent" Core..=) Core.<$> parent,
                  ("tagValue" Core..=) Core.<$> tagValue,
                  ("tagValueNamespacedName" Core..=) Core.<$>
...
instance Core.FromJSON TagKey_PurposeData where
        parseJSON
          = Core.withObject "TagKey_PurposeData"
              (\ o ->
...
instance Core.FromJSON UndeleteFolderMetadata where
        parseJSON
          = Core.withObject "UndeleteFolderMetadata"
...
instance Core.FromJSON UndeleteFolderRequest where
        parseJSON
          = Core.withObject "UndeleteFolderRequest"
...
instance Core.FromJSON UndeleteOrganizationMetadata
         where
        parseJSON
          = Core.withObject "UndeleteOrganizationMetadata"
              (\ o -> Core.pure UndeleteOrganizationMetadata)

instance Core.ToJSON UndeleteOrganizationMetadata
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON UndeleteProjectMetadata where
        parseJSON
          = Core.withObject "UndeleteProjectMetadata"
...
instance Core.FromJSON UndeleteProjectRequest where
        parseJSON
          = Core.withObject "UndeleteProjectRequest"
...
instance Core.FromJSON UpdateFolderMetadata where
        parseJSON
          = Core.withObject "UpdateFolderMetadata"
...
instance Core.FromJSON UpdateProjectMetadata where
        parseJSON
          = Core.withObject "UpdateProjectMetadata"
...
instance Core.FromJSON UpdateTagKeyMetadata where
        parseJSON
          = Core.withObject "UpdateTagKeyMetadata"
...
instance Core.FromJSON UpdateTagValueMetadata where
        parseJSON
          = Core.withObject "UpdateTagValueMetadata"
