...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.modifyAssignees@.
module Gogol.Classroom.Courses.Announcements.ModifyAssignees
    (
    -- * Resource
     ...
     "v1" Core.:>
       "courses" Core.:>
         Core.Capture "courseId" Core.Text Core.:>
           "announcements" Core.:>
             Core.CaptureMode "id" "modifyAssignees" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ModifyAnnouncementAssigneesRequest
...
newClassroomCoursesAnnouncementsModifyAssignees courseId id payload
  = ClassroomCoursesAnnouncementsModifyAssignees{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing, courseId = courseId,
...
instance Core.GoogleRequest
           ClassroomCoursesAnnouncementsModifyAssignees
         where
        type Rs ClassroomCoursesAnnouncementsModifyAssignees = Announcement
        type Scopes ClassroomCoursesAnnouncementsModifyAssignees =
             '[Classroom'Announcements]
        requestClient ClassroomCoursesAnnouncementsModifyAssignees{..}
          = go courseId id xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesAnnouncementsModifyAssigneesResource)
                      Core.mempty
