...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.modifyAssignees@.
module Gogol.Classroom.Courses.CourseWork.ModifyAssignees
    (
    -- * Resource
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ModifyCourseWorkAssigneesRequest Core.:>
                             Core.Post '[Core.JSON] CourseWork
...
newClassroomCoursesCourseWorkModifyAssignees courseId id payload
  = ClassroomCoursesCourseWorkModifyAssignees{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              courseId = courseId, id = id, payload = payload,
...
instance Core.GoogleRequest
        ...
        type Scopes ClassroomCoursesCourseWorkModifyAssignees =
