...
newAddOnAttachment 
    ::  AddOnAttachment
newAddOnAttachment
  = AddOnAttachment{copyHistory = Core.Nothing,
                    courseId = Core.Nothing, dueDate = Core.Nothing,
                    dueTime = Core.Nothing, id = Core.Nothing, itemId = Core.Nothing,
                    maxPoints = Core.Nothing, postId = Core.Nothing,
                    studentViewUri = Core.Nothing, studentWorkReviewUri = Core.Nothing,
                    teacherViewUri = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON AddOnAttachment where
        parseJSON
          = Core.withObject "AddOnAttachment"
              (\ o ->
                 AddOnAttachment Core.<$>
                   (o Core..:? "copyHistory") Core.<*> (o Core..:? "courseId")
                     Core.<*> (o Core..:? "dueDate")
                     Core.<*> (o Core..:? "dueTime")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "itemId")
...
newAddOnAttachmentStudentSubmission 
    :: 
                                    AddOnAttachmentStudentSubmission
newAddOnAttachmentStudentSubmission
  = AddOnAttachmentStudentSubmission{pointsEarned = Core.Nothing,
                                     postSubmissionState = Core.Nothing}
instance Core.FromJSON AddOnAttachmentStudentSubmission where
        parseJSON
...
instance Core.ToJSON AddOnAttachmentStudentSubmission where
        toJSON AddOnAttachmentStudentSubmission{..}
          = Core.object
              (Core.catMaybes
                 [("pointsEarned" Core..=) Core.<$> pointsEarned,
                  ("postSubmissionState" Core..=) Core.<$> postSubmissionState])
...
newAddOnContext 
    ::  AddOnContext
newAddOnContext
  = AddOnContext{courseId = Core.Nothing, itemId = Core.Nothing,
                 postId = Core.Nothing, studentContext = Core.Nothing,
                 supportsStudentWork = Core.Nothing, teacherContext = Core.Nothing}
instance Core.FromJSON AddOnContext where
        parseJSON
          = Core.withObject "AddOnContext"
              (\ o ->
                 AddOnContext Core.<$>
                   (o Core..:? "courseId") Core.<*> (o Core..:? "itemId") Core.<*>
                     (o Core..:? "postId")
          ...
          = Core.object
              (Core.catMaybes
                 [("courseId" Core..=) Core.<$> courseId,
                  ...
                  ("supportsStudentWork" Core..=) Core.<$> supportsStudentWork,
...
newAnnouncement 
    ::  Announcement
newAnnouncement
  = Announcement{alternateLink = Core.Nothing,
                 assigneeMode = Core.Nothing, courseId = Core.Nothing,
                 creationTime = Core.Nothing, creatorUserId = Core.Nothing,
                 id = Core.Nothing, individualStudentsOptions = Core.Nothing,
                 materials = Core.Nothing, scheduledTime = Core.Nothing,
                 state = Core.Nothing, text = Core.Nothing,
...
instance Core.FromJSON Announcement where
        parseJSON
          = Core.withObject "Announcement"
              (\ o ->
                 Announcement Core.<$>
                   (o Core..:? "alternateLink") Core.<*> (o Core..:? "assigneeMode")
          ...
          = Core.object
              (Core.catMaybes
                 [("alternateLink" Core..=) Core.<$> alternateLink,
                  ...
                  ("state" Core..=) Core.<$> state, ("text" Core..=) Core.<$> text,
...
instance Core.FromJSON Assignment where
        parseJSON
          = Core.withObject "Assignment"
              (\ o -> Assignment Core.<$> (o Core..:? "studentWorkFolder"))

instance Core.ToJSON Assignment where
        toJSON Assignment{..}
          = Core.object
              (Core.catMaybes
                 [("studentWorkFolder" Core..=) Core.<$> studentWorkFolder])
...
newAttachment 
    ::  Attachment
newAttachment
  = Attachment{driveFile = Core.Nothing, form = Core.Nothing,
               link = Core.Nothing, youTubeVideo = Core.Nothing}
instance Core.FromJSON Attachment where
        parseJSON
          = Core.withObject "Attachment"
              (\ o ->
                 Attachment Core.<$>
                   (o Core..:? "driveFile") Core.<*> (o Core..:? "form") Core.<*>
                     (o Core..:? "link")
          ...
          = Core.object
              (Core.catMaybes
                 [("driveFile" Core..=) Core.<$> driveFile,
                  ("form" Core..=) Core.<$> form, ("link" Core..=) Core.<$> link,
...
instance Core.FromJSON CloudPubsubTopic where
        parseJSON
          = Core.withObject "CloudPubsubTopic"
              (\ o -> CloudPubsubTopic Core.<$> (o Core..:? "topicName"))

instance Core.ToJSON CloudPubsubTopic where
        toJSON CloudPubsubTopic{..}
          = Core.object
              (Core.catMaybes [("topicName" Core..=) Core.<$> topicName])
...
newCopyHistory 
    ::  CopyHistory
newCopyHistory
  = CopyHistory{attachmentId = Core.Nothing, courseId = Core.Nothing,
                itemId = Core.Nothing, postId = Core.Nothing}
instance Core.FromJSON CopyHistory where
        parseJSON
          = Core.withObject "CopyHistory"
              (\ o ->
                 CopyHistory Core.<$>
                   (o Core..:? "attachmentId") Core.<*> (o Core..:? "courseId")
                     Core.<*> (o Core..:? "itemId")
                     Core.<*> (o Core..:? "postId"))
...
newCourse 
    ::  Course
newCourse
  = Course{alternateLink = Core.Nothing, calendarId = Core.Nothing,
           courseGroupEmail = Core.Nothing, courseMaterialSets = Core.Nothing,
           courseState = Core.Nothing, creationTime = Core.Nothing,
           description = Core.Nothing, descriptionHeading = Core.Nothing,
           enrollmentCode = Core.Nothing, gradebookSettings = Core.Nothing,
           guardiansEnabled = Core.Nothing, id = Core.Nothing,
           name = Core.Nothing, ownerId = Core.Nothing, room = Core.Nothing,
           section = Core.Nothing, teacherFolder = Core.Nothing,
           teacherGroupEmail = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON Course where
        parseJSON
          = Core.withObject "Course"
              (\ o ->
                 Course Core.<$>
                   (o Core..:? "alternateLink") Core.<*> (o Core..:? "calendarId")
          ...
          = Core.object
              (Core.catMaybes
                 [("alternateLink" Core..=) Core.<$> alternateLink,
                  ...
                  ("courseGroupEmail" Core..=) Core.<$> courseGroupEmail,
                  ("courseMaterialSets" Core..=) Core.<$> courseMaterialSets,
                  ("courseState" Core..=) Core.<$> courseState,
                  ("creationTime" Core..=) Core.<$> creationTime,
                  ("description" Core..=) Core.<$> description,
                  ("descriptionHeading" Core..=) Core.<$> descriptionHeading,
                  ("enrollmentCode" Core..=) Core.<$> enrollmentCode,
                  ("gradebookSettings" Core..=) Core.<$> gradebookSettings,
                  ("guardiansEnabled" Core..=) Core.<$> guardiansEnabled,
                  ...
                  ("teacherGroupEmail" Core..=) Core.<$> teacherGroupEmail,
                  ("updateTime" Core..=) Core.<$> updateTime])
...
newCourseMaterial 
    ::  CourseMaterial
newCourseMaterial
  = CourseMaterial{driveFile = Core.Nothing, form = Core.Nothing,
                   link = Core.Nothing, youTubeVideo = Core.Nothing}
          ...
          = Core.withObject "CourseMaterialSet"
              (\ o ->
                 CourseMaterialSet Core.<$>
                   (o Core..:? "materials") Core.<*> (o Core..:? "title"))
...
data CourseWork = CourseWork
    ...
    , gradingPeriodId :: (Core.Maybe Core.Text)
...
newCourseWork 
    ::  CourseWork
newCourseWork
  = CourseWork{alternateLink = Core.Nothing,
               assigneeMode = Core.Nothing, assignment = Core.Nothing,
               associatedWithDeveloper = Core.Nothing, courseId = Core.Nothing,
               creationTime = Core.Nothing, creatorUserId = Core.Nothing,
               description = Core.Nothing, dueDate = Core.Nothing,
               dueTime = Core.Nothing, gradeCategory = Core.Nothing,
               gradingPeriodId = Core.Nothing, id = Core.Nothing,
               individualStudentsOptions = Core.Nothing, materials = Core.Nothing,
               maxPoints = Core.Nothing, multipleChoiceQuestion = Core.Nothing,
               scheduledTime = Core.Nothing, state = Core.Nothing,
               submissionModificationMode = Core.Nothing, title = Core.Nothing,
               topicId = Core.Nothing, updateTime = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("alternateLink" Core..=) Core.<$> alternateLink,
                  ...
                  ("gradingPeriodId" Core..=) Core.<$> gradingPeriodId,
                  ("id" Core..=) Core.<$> id,
                  ("individualStudentsOptions" Core..=) Core.<$>
                    individualStudentsOptions,
                  ("materials" Core..=) Core.<$> materials,
                  ("maxPoints" Core..=) Core.<$> maxPoints,
                  ("multipleChoiceQuestion" Core..=) Core.<$> multipleChoiceQuestion,
                  ("scheduledTime" Core..=) Core.<$> scheduledTime,
...
newCourseWorkChangesInfo 
    ::  CourseWorkChangesInfo
newCourseWorkChangesInfo
  = CourseWorkChangesInfo{courseId = Core.Nothing}
instance Core.FromJSON CourseWorkChangesInfo where
        parseJSON
          = Core.withObject "CourseWorkChangesInfo"
              (\ o -> CourseWorkChangesInfo Core.<$> (o Core..:? "courseId"))
...
newCourseWorkMaterial 
    ::  CourseWorkMaterial
newCourseWorkMaterial
  = CourseWorkMaterial{alternateLink = Core.Nothing,
                       assigneeMode = Core.Nothing, courseId = Core.Nothing,
                       creationTime = Core.Nothing, creatorUserId = Core.Nothing,
                       description = Core.Nothing, id = Core.Nothing,
                       individualStudentsOptions = Core.Nothing, materials = Core.Nothing,
                       scheduledTime = Core.Nothing, state = Core.Nothing,
                       title = Core.Nothing, topicId = Core.Nothing,
                       updateTime = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("alternateLink" Core..=) Core.<$> alternateLink,
                  ...
                  ("materials" Core..=) Core.<$> materials,
                  ("scheduledTime" Core..=) Core.<$> scheduledTime,
                  ("state" Core..=) Core.<$> state, ("title" Core..=) Core.<$> title,
                  ("topicId" Core..=) Core.<$> topicId,
                  ("updateTime" Core..=) Core.<$> updateTime])
...
newCriterion 
    ::  Criterion
newCriterion
  = Criterion{description = Core.Nothing, id = Core.Nothing,
              levels = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON Criterion where
        parseJSON
          = Core.withObject "Criterion"
              (\ o ->
                 Criterion Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "levels")
                     Core.<*> (o Core..:? "title"))
...
instance Core.ToJSON Criterion where
        toJSON Criterion{..}
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("id" Core..=) Core.<$> id, ("levels" Core..=) Core.<$> levels,
                  ("title" Core..=) Core.<$> title])
...
newDriveFile 
    ::  DriveFile
newDriveFile
  = DriveFile{alternateLink = Core.Nothing, id = Core.Nothing,
              thumbnailUrl = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON DriveFile where
        parseJSON
          = Core.withObject "DriveFile"
              (\ o ->
                 DriveFile Core.<$>
                   (o Core..:? "alternateLink") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "thumbnailUrl")
                     Core.<*> (o Core..:? "title"))
...
newDriveFolder 
    ::  DriveFolder
newDriveFolder
  = DriveFolder{alternateLink = Core.Nothing, id = Core.Nothing,
                title = Core.Nothing}
...
instance Core.ToJSON DriveFolder where
        toJSON DriveFolder{..}
          = Core.object
              (Core.catMaybes
                 [("alternateLink" Core..=) Core.<$> alternateLink,
                  ("id" Core..=) Core.<$> id, ("title" Core..=) Core.<$> title])
...
newFeed 
    ::  Feed
newFeed
  = Feed{courseRosterChangesInfo = Core.Nothing,
         courseWorkChangesInfo = Core.Nothing, feedType = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("courseRosterChangesInfo" Core..=) Core.<$>
                    courseRosterChangesInfo,
                  ("courseWorkChangesInfo" Core..=) Core.<$> courseWorkChangesInfo,
...
newForm 
    ::  Form
newForm
  = Form{formUrl = Core.Nothing, responseUrl = Core.Nothing,
         thumbnailUrl = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON Form where
        parseJSON
          = Core.withObject "Form"
              (\ o ->
                 Form Core.<$>
                   (o Core..:? "formUrl") Core.<*> (o Core..:? "responseUrl") Core.<*>
                     (o Core..:? "thumbnailUrl")
                     Core.<*> (o Core..:? "title"))
...
-- | Gemini Gem link.
--
-- /See:/ 'newGeminiGem' smart constructor.
data GeminiGem = GeminiGem
    {
      -- | Gems resource id.
      id :: (Core.Maybe Core.Text)
...
-- | Creates a value of 'GeminiGem' with the minimum fields required to make a request.
newGeminiGem 
    ::  GeminiGem
newGeminiGem
  = GeminiGem{id = Core.Nothing, title = Core.Nothing,
              url = Core.Nothing}
instance Core.FromJSON GeminiGem where
        parseJSON
          = Core.withObject "GeminiGem"
              (\ o ->
                 GeminiGem Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "title") Core.<*>
                     (o Core..:? "url"))

instance Core.ToJSON GeminiGem where
        toJSON GeminiGem{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("title" Core..=) Core.<$> title,
...
instance Core.FromJSON GlobalPermission where
        parseJSON
          = Core.withObject "GlobalPermission"
              (\ o -> GlobalPermission Core.<$> (o Core..:? "permission"))

instance Core.ToJSON GlobalPermission where
        toJSON GlobalPermission{..}
          = Core.object
              (Core.catMaybes [("permission" Core..=) Core.<$> permission])
...
newGradeCategory 
    ::  GradeCategory
newGradeCategory
  = GradeCategory{defaultGradeDenominator = Core.Nothing,
                  id = Core.Nothing, name = Core.Nothing, weight = Core.Nothing}
instance Core.FromJSON GradeCategory where
        parseJSON
          = Core.withObject "GradeCategory"
              (\ o ->
                 GradeCategory Core.<$>
                   (o Core..:? "defaultGradeDenominator") Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "weight"))
...
newGradeHistory 
    ::  GradeHistory
newGradeHistory
  = GradeHistory{actorUserId = Core.Nothing,
                 gradeChangeType = Core.Nothing, gradeTimestamp = Core.Nothing,
                 maxPoints = Core.Nothing, pointsEarned = Core.Nothing}
instance Core.FromJSON GradeHistory where
        parseJSON
          = Core.withObject "GradeHistory"
              (\ o ->
                 GradeHistory Core.<$>
                   (o Core..:? "actorUserId") Core.<*> (o Core..:? "gradeChangeType")
...
newGradebookSettings 
    ::  GradebookSettings
newGradebookSettings
  = GradebookSettings{calculationType = Core.Nothing,
                      displaySetting = Core.Nothing, gradeCategories = Core.Nothing}
...
instance Core.ToJSON GradebookSettings where
        toJSON GradebookSettings{..}
          = Core.object
              (Core.catMaybes
                 [("calculationType" Core..=) Core.<$> calculationType,
                  ("displaySetting" Core..=) Core.<$> displaySetting,
                  ("gradeCategories" Core..=) Core.<$> gradeCategories])


-- | An individual grading period. Grading periods must not have overlapping date ranges and must be listed in chronological order. For example, if the end/date of a grading period is 2024-01-25, then the start/date of the next grading period must be 2024-01-26 or later. Each grading period must have a unique title within a course.
--
-- /See:/ 'newGradingPeriod' smart constructor.
...
-- | Creates a value of 'GradingPeriod' with the minimum fields required to make a request.
newGradingPeriod 
    ::  GradingPeriod
newGradingPeriod
  = GradingPeriod{endDate = Core.Nothing, id = Core.Nothing,
                  startDate = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON GradingPeriod where
        parseJSON
          = Core.withObject "GradingPeriod"
              (\ o ->
                 GradingPeriod Core.<$>
                   (o Core..:? "endDate") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "startDate")
                     Core.<*> (o Core..:? "title"))

instance Core.ToJSON GradingPeriod where
        toJSON GradingPeriod{..}
          = Core.object
              (Core.catMaybes
                 [("endDate" Core..=) Core.<$> endDate, ("id" Core..=) Core.<$> id,
...
--
-- /See:/ 'newGradingPeriodSettings' smart constructor.
data GradingPeriodSettings = GradingPeriodSettings
    {
      ...
      applyToExistingCoursework :: (Core.Maybe Core.Bool)
    ...
    , gradingPeriods :: (Core.Maybe [GradingPeriod])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GradingPeriodSettings' with the minimum fields required to make a request.
newGradingPeriodSettings 
    ::  GradingPeriodSettings
newGradingPeriodSettings
  = GradingPeriodSettings{applyToExistingCoursework = Core.Nothing,
                          gradingPeriods = Core.Nothing}
instance Core.FromJSON GradingPeriodSettings where
        parseJSON
          = Core.withObject "GradingPeriodSettings"
              (\ o ->
                 GradingPeriodSettings Core.<$>
                   (o Core..:? "applyToExistingCoursework") Core.<*>
                     (o Core..:? "gradingPeriods"))

instance Core.ToJSON GradingPeriodSettings where
        toJSON GradingPeriodSettings{..}
          = Core.object
              (Core.catMaybes
                 [("applyToExistingCoursework" Core..=) Core.<$>
                    applyToExistingCoursework,
                  ("gradingPeriods" Core..=) Core.<$> gradingPeriods])
...
newGuardian 
    ::  Guardian
newGuardian
  = Guardian{guardianId = Core.Nothing,
             guardianProfile = Core.Nothing, invitedEmailAddress = Core.Nothing,
...
instance Core.FromJSON Guardian where
        parseJSON
          = Core.withObject "Guardian"
              (\ o ->
                 Guardian Core.<$>
                   (o Core..:? "guardianId") Core.<*> (o Core..:? "guardianProfile")
          ...
          = Core.object
              (Core.catMaybes
                 [("guardianId" Core..=) Core.<$> guardianId,
                  ...
                  ("invitedEmailAddress" Core..=) Core.<$> invitedEmailAddress,
...
newGuardianInvitation 
    ::  GuardianInvitation
newGuardianInvitation
  = GuardianInvitation{creationTime = Core.Nothing,
                       invitationId = Core.Nothing, invitedEmailAddress = Core.Nothing,
                       state = Core.Nothing, studentId = Core.Nothing}
instance Core.FromJSON GuardianInvitation where
        parseJSON
          = Core.withObject "GuardianInvitation"
              (\ o ->
                 GuardianInvitation Core.<$>
                   (o Core..:? "creationTime") Core.<*> (o Core..:? "invitationId")
                     Core.<*> (o Core..:? "invitedEmailAddress")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "studentId"))
...
instance Core.FromJSON IndividualStudentsOptions where
        parseJSON
          = Core.withObject "IndividualStudentsOptions"
              (\ o ->
                 IndividualStudentsOptions Core.<$> (o Core..:? "studentIds"))

instance Core.ToJSON IndividualStudentsOptions where
        toJSON IndividualStudentsOptions{..}
          = Core.object
              (Core.catMaybes [("studentIds" Core..=) Core.<$> studentIds])
...
newInvitation 
    ::  Invitation
newInvitation
  = Invitation{courseId = Core.Nothing, id = Core.Nothing,
               role' = Core.Nothing, userId = Core.Nothing}
instance Core.FromJSON Invitation where
        parseJSON
          = Core.withObject "Invitation"
              (\ o ->
                 Invitation Core.<$>
                   (o Core..:? "courseId") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "role")
                     Core.<*> (o Core..:? "userId"))
...
instance Core.ToJSON Invitation where
        toJSON Invitation{..}
          = Core.object
              (Core.catMaybes
                 [("courseId" Core..=) Core.<$> courseId,
                  ("id" Core..=) Core.<$> id, ("role" Core..=) Core.<$> role',
...
newLevel 
    ::  Level
newLevel
  = Level{description = Core.Nothing, id = Core.Nothing,
          points = Core.Nothing, title = Core.Nothing}
...
instance Core.ToJSON Level where
        toJSON Level{..}
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("id" Core..=) Core.<$> id, ("points" Core..=) Core.<$> points,
                  ("title" Core..=) Core.<$> title])
...
newLink 
    ::  Link
newLink
  = Link{thumbnailUrl = Core.Nothing, title = Core.Nothing,
         url = Core.Nothing}
instance Core.FromJSON Link where
        parseJSON
          = Core.withObject "Link"
              (\ o ->
                 Link Core.<$>
                   (o Core..:? "thumbnailUrl") Core.<*> (o Core..:? "title") Core.<*>
                     (o Core..:? "url"))
...
newListAddOnAttachmentsResponse 
    ::  ListAddOnAttachmentsResponse
newListAddOnAttachmentsResponse
  = ListAddOnAttachmentsResponse{addOnAttachments = Core.Nothing,
                                 nextPageToken = Core.Nothing}
instance Core.FromJSON ListAddOnAttachmentsResponse where
        parseJSON
...
instance Core.ToJSON ListAddOnAttachmentsResponse where
        toJSON ListAddOnAttachmentsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("addOnAttachments" Core..=) Core.<$> addOnAttachments,
...
newListAnnouncementsResponse 
    ::  ListAnnouncementsResponse
newListAnnouncementsResponse
  = ListAnnouncementsResponse{announcements = Core.Nothing,
                              nextPageToken = Core.Nothing}
instance Core.FromJSON ListAnnouncementsResponse where
        parseJSON
          = Core.withObject "ListAnnouncementsResponse"
              (\ o ->
                 ListAnnouncementsResponse Core.<$>
                   (o Core..:? "announcements") Core.<*> (o Core..:? "nextPageToken"))
...
newListCourseAliasesResponse 
    ::  ListCourseAliasesResponse
newListCourseAliasesResponse
  = ListCourseAliasesResponse{aliases = Core.Nothing,
                              nextPageToken = Core.Nothing}
instance Core.FromJSON ListCourseAliasesResponse where
        parseJSON
          = Core.withObject "ListCourseAliasesResponse"
              (\ o ->
                 ListCourseAliasesResponse Core.<$>
                   (o Core..:? "aliases") Core.<*> (o Core..:? "nextPageToken"))
...
newListCourseWorkMaterialResponse 
    ::  ListCourseWorkMaterialResponse
newListCourseWorkMaterialResponse
  = ListCourseWorkMaterialResponse{courseWorkMaterial = Core.Nothing,
                                   nextPageToken = Core.Nothing}
instance Core.FromJSON ListCourseWorkMaterialResponse where
        parseJSON
...
instance Core.ToJSON ListCourseWorkMaterialResponse where
        toJSON ListCourseWorkMaterialResponse{..}
          = Core.object
              (Core.catMaybes
                 [("courseWorkMaterial" Core..=) Core.<$> courseWorkMaterial,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListCourseWorkResponse 
    ::  ListCourseWorkResponse
newListCourseWorkResponse
  = ListCourseWorkResponse{courseWork = Core.Nothing,
                           nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListCourseWorkResponse"
              (\ o ->
                 ListCourseWorkResponse Core.<$>
                   (o Core..:? "courseWork") Core.<*> (o Core..:? "nextPageToken"))
...
newListCoursesResponse 
    ::  ListCoursesResponse
newListCoursesResponse
  = ListCoursesResponse{courses = Core.Nothing,
                        nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListCoursesResponse"
              (\ o ->
                 ListCoursesResponse Core.<$>
                   (o Core..:? "courses") Core.<*> (o Core..:? "nextPageToken"))
...
newListGuardianInvitationsResponse
  = ListGuardianInvitationsResponse{guardianInvitations =
                                      Core.Nothing,
                                    nextPageToken = Core.Nothing}
instance Core.FromJSON ListGuardianInvitationsResponse where
        parseJSON
...
instance Core.ToJSON ListGuardianInvitationsResponse where
        toJSON ListGuardianInvitationsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("guardianInvitations" Core..=) Core.<$> guardianInvitations,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListGuardiansResponse 
    ::  ListGuardiansResponse
newListGuardiansResponse
  = ListGuardiansResponse{guardians = Core.Nothing,
                          nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListGuardiansResponse"
              (\ o ->
                 ListGuardiansResponse Core.<$>
                   (o Core..:? "guardians") Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListInvitationsResponse"
              (\ o ->
                 ListInvitationsResponse Core.<$>
                   (o Core..:? "invitations") Core.<*> (o Core..:? "nextPageToken"))
...
newListStudentSubmissionsResponse 
    ::  ListStudentSubmissionsResponse
newListStudentSubmissionsResponse
  = ListStudentSubmissionsResponse{nextPageToken = Core.Nothing,
                                   studentSubmissions = Core.Nothing}
instance Core.FromJSON ListStudentSubmissionsResponse where
        parseJSON
...
instance Core.ToJSON ListStudentSubmissionsResponse where
        toJSON ListStudentSubmissionsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("studentSubmissions" Core..=) Core.<$> studentSubmissions])
...
newListTopicResponse 
    ::  ListTopicResponse
newListTopicResponse
  = ListTopicResponse{nextPageToken = Core.Nothing,
                      topic = Core.Nothing}
          ...
          = Core.withObject "ListTopicResponse"
              (\ o ->
                 ListTopicResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "topic"))
...
data Material = Material
    ...
    , notebook :: (Core.Maybe NotebookLmNotebook)
...
newMaterial 
    ::  Material
newMaterial
  = Material{driveFile = Core.Nothing, form = Core.Nothing,
             gem = Core.Nothing, link = Core.Nothing, notebook = Core.Nothing,
...
instance Core.ToJSON Material where
        toJSON Material{..}
          = Core.object
              (Core.catMaybes
                 [("driveFile" Core..=) Core.<$> driveFile,
                  ("form" Core..=) Core.<$> form, ("gem" Core..=) Core.<$> gem,
                  ("link" Core..=) Core.<$> link,
                  ("notebook" Core..=) Core.<$> notebook,
                  ("youtubeVideo" Core..=) Core.<$> youtubeVideo])
...
newModifyAnnouncementAssigneesRequest 
    :: 
                                      ModifyAnnouncementAssigneesRequest
newModifyAnnouncementAssigneesRequest
  = ModifyAnnouncementAssigneesRequest{assigneeMode = Core.Nothing,
                                       modifyIndividualStudentsOptions = Core.Nothing}
instance Core.FromJSON ModifyAnnouncementAssigneesRequest where
        parseJSON
          = Core.withObject "ModifyAnnouncementAssigneesRequest"
              (\ o ->
                 ModifyAnnouncementAssigneesRequest Core.<$>
                   (o Core..:? "assigneeMode") Core.<*>
                     (o Core..:? "modifyIndividualStudentsOptions"))

instance Core.ToJSON ModifyAnnouncementAssigneesRequest where
...
instance Core.FromJSON ModifyAttachmentsRequest where
        parseJSON
          = Core.withObject "ModifyAttachmentsRequest"
              (\ o ->
                 ModifyAttachmentsRequest Core.<$> (o Core..:? "addAttachments"))
...
newModifyCourseWorkAssigneesRequest 
    :: 
                                    ModifyCourseWorkAssigneesRequest
newModifyCourseWorkAssigneesRequest
  = ModifyCourseWorkAssigneesRequest{assigneeMode = Core.Nothing,
                                     modifyIndividualStudentsOptions = Core.Nothing}
instance Core.FromJSON ModifyCourseWorkAssigneesRequest where
        parseJSON
...
instance Core.ToJSON ModifyCourseWorkAssigneesRequest where
...
newModifyIndividualStudentsOptions 
    :: 
                                   ModifyIndividualStudentsOptions
newModifyIndividualStudentsOptions
  = ModifyIndividualStudentsOptions{addStudentIds = Core.Nothing,
                                    removeStudentIds = Core.Nothing}
instance Core.FromJSON ModifyIndividualStudentsOptions where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("addStudentIds" Core..=) Core.<$> addStudentIds,
                  ("removeStudentIds" Core..=) Core.<$> removeStudentIds])
...
newName 
    ::  Name
newName
  = Name{familyName = Core.Nothing, fullName = Core.Nothing,
...
instance Core.FromJSON Name where
        parseJSON
          = Core.withObject "Name"
              (\ o ->
                 Name Core.<$>
                   (o Core..:? "familyName") Core.<*> (o Core..:? "fullName") Core.<*>
                     (o Core..:? "givenName"))
...
--
-- /See:/ 'newNotebookLmNotebook' smart constructor.
data NotebookLmNotebook = NotebookLmNotebook
    {
...
-- | Creates a value of 'NotebookLmNotebook' with the minimum fields required to make a request.
newNotebookLmNotebook 
    ::  NotebookLmNotebook
newNotebookLmNotebook
  = NotebookLmNotebook{id = Core.Nothing, title = Core.Nothing,
                       url = Core.Nothing}
instance Core.FromJSON NotebookLmNotebook where
        parseJSON
          = Core.withObject "NotebookLmNotebook"
              (\ o ->
                 NotebookLmNotebook Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "title") Core.<*>
                     (o Core..:? "url"))

instance Core.ToJSON NotebookLmNotebook where
        toJSON NotebookLmNotebook{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("title" Core..=) Core.<$> title,
                  ("url" Core..=) Core.<$> url])
...
newReclaimStudentSubmissionRequest
  = ReclaimStudentSubmissionRequest
instance Core.FromJSON ReclaimStudentSubmissionRequest where
        parseJSON
          = Core.withObject "ReclaimStudentSubmissionRequest"
              (\ o -> Core.pure ReclaimStudentSubmissionRequest)

instance Core.ToJSON ReclaimStudentSubmissionRequest where
        toJSON = Core.const Core.emptyObject
...
newRegistration 
    ::  Registration
newRegistration
  = Registration{cloudPubsubTopic = Core.Nothing,
                 expiryTime = Core.Nothing, feed = Core.Nothing,
...
instance Core.FromJSON Registration where
        parseJSON
          = Core.withObject "Registration"
              (\ o ->
                 Registration Core.<$>
                   (o Core..:? "cloudPubsubTopic") Core.<*> (o Core..:? "expiryTime")
                     Core.<*> (o Core..:? "feed")
...
instance Core.FromJSON ReturnStudentSubmissionRequest where
        parseJSON
          = Core.withObject "ReturnStudentSubmissionRequest"
              (\ o -> Core.pure ReturnStudentSubmissionRequest)

instance Core.ToJSON ReturnStudentSubmissionRequest where
        toJSON = Core.const Core.emptyObject
...
newRubric 
    ::  Rubric
newRubric
  = Rubric{courseId = Core.Nothing, courseWorkId = Core.Nothing,
           creationTime = Core.Nothing, criteria = Core.Nothing,
           id = Core.Nothing, sourceSpreadsheetId = Core.Nothing,
           updateTime = Core.Nothing}
instance Core.FromJSON Rubric where
        parseJSON
          = Core.withObject "Rubric"
              (\ o ->
                 Rubric Core.<$>
                   (o Core..:? "courseId") Core.<*> (o Core..:? "courseWorkId")
                     Core.<*> (o Core..:? "creationTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("courseId" Core..=) Core.<$> courseId,
                  ...
                  ("creationTime" Core..=) Core.<$> creationTime,
                  ("criteria" Core..=) Core.<$> criteria, ("id" Core..=) Core.<$> id,
                  ("sourceSpreadsheetId" Core..=) Core.<$> sourceSpreadsheetId,
                  ("updateTime" Core..=) Core.<$> updateTime])
...
newRubricGrade 
    ::  RubricGrade
newRubricGrade
  = RubricGrade{criterionId = Core.Nothing, levelId = Core.Nothing,
                points = Core.Nothing}
instance Core.FromJSON RubricGrade where
        parseJSON
          = Core.withObject "RubricGrade"
              (\ o ->
                 RubricGrade Core.<$>
                   (o Core..:? "criterionId") Core.<*> (o Core..:? "levelId") Core.<*>
                     (o Core..:? "points"))
...
newSharedDriveFile 
    ::  SharedDriveFile
newSharedDriveFile
  = SharedDriveFile{driveFile = Core.Nothing,
                    shareMode = Core.Nothing}
instance Core.FromJSON SharedDriveFile where
        parseJSON
          = Core.withObject "SharedDriveFile"
              (\ o ->
                 SharedDriveFile Core.<$>
                   (o Core..:? "driveFile") Core.<*> (o Core..:? "shareMode"))
...
newStateHistory 
    ::  StateHistory
newStateHistory
  = StateHistory{actorUserId = Core.Nothing, state = Core.Nothing,
...
instance Core.FromJSON StateHistory where
        parseJSON
          = Core.withObject "StateHistory"
              (\ o ->
                 StateHistory Core.<$>
                   (o Core..:? "actorUserId") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "stateTimestamp"))
...
newStudent 
    ::  Student
newStudent
  = Student{courseId = Core.Nothing, profile = Core.Nothing,
            studentWorkFolder = Core.Nothing, userId = Core.Nothing}
instance Core.FromJSON Student where
        parseJSON
          = Core.withObject "Student"
              (\ o ->
                 Student Core.<$>
                   (o Core..:? "courseId") Core.<*> (o Core..:? "profile") Core.<*>
                     (o Core..:? "studentWorkFolder")
                     Core.<*> (o Core..:? "userId"))
...
instance Core.FromJSON StudentContext where
        parseJSON
          = Core.withObject "StudentContext"
              (\ o -> StudentContext Core.<$> (o Core..:? "submissionId"))

instance Core.ToJSON StudentContext where
        toJSON StudentContext{..}
          = Core.object
              (Core.catMaybes [("submissionId" Core..=) Core.<$> submissionId])
...
newStudentSubmission 
    ::  StudentSubmission
newStudentSubmission
  = StudentSubmission{alternateLink = Core.Nothing,
                      assignedGrade = Core.Nothing, assignedRubricGrades = Core.Nothing,
                      assignmentSubmission = Core.Nothing,
                      associatedWithDeveloper = Core.Nothing, courseId = Core.Nothing,
                      courseWorkId = Core.Nothing, courseWorkType = Core.Nothing,
                      creationTime = Core.Nothing, draftGrade = Core.Nothing,
                      draftRubricGrades = Core.Nothing, id = Core.Nothing,
                      late = Core.Nothing, multipleChoiceSubmission = Core.Nothing,
                      shortAnswerSubmission = Core.Nothing, state = Core.Nothing,
                      submissionHistory = Core.Nothing, updateTime = Core.Nothing,
                      userId = Core.Nothing}
          ...
          = Core.withObject "StudentSubmission"
              (\ o ->
                 StudentSubmission Core.<$>
                   (o Core..:? "alternateLink") Core.<*> (o Core..:? "assignedGrade")
          ...
          = Core.object
              (Core.catMaybes
                 [("alternateLink" Core..=) Core.<$> alternateLink,
                  ...
                  ("assignedRubricGrades" Core..=) Core.<$> assignedRubricGrades,
                  ("assignmentSubmission" Core..=) Core.<$> assignmentSubmission,
                  ("associatedWithDeveloper" Core..=) Core.<$>
                    associatedWithDeveloper,
                  ("courseId" Core..=) Core.<$> courseId,
                  ("courseWorkId" Core..=) Core.<$> courseWorkId,
                  ...
                  ("draftRubricGrades" Core..=) Core.<$> draftRubricGrades,
                  ("id" Core..=) Core.<$> id, ("late" Core..=) Core.<$> late,
                  ("multipleChoiceSubmission" Core..=) Core.<$>
                    multipleChoiceSubmission,
                  ("shortAnswerSubmission" Core..=) Core.<$> shortAnswerSubmission,
                  ("state" Core..=) Core.<$> state,
                  ("submissionHistory" Core..=) Core.<$> submissionHistory,
                  ("updateTime" Core..=) Core.<$> updateTime,
                  ("userId" Core..=) Core.<$> userId])
...
instance Core.FromJSON StudentSubmission_AssignedRubricGrades where
        parseJSON
          = Core.withObject "StudentSubmission_AssignedRubricGrades"
              (\ o ->
                 StudentSubmission_AssignedRubricGrades Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON StudentSubmission_AssignedRubricGrades where
...
instance Core.FromJSON StudentSubmission_DraftRubricGrades where
        parseJSON
          = Core.withObject "StudentSubmission_DraftRubricGrades"
              (\ o ->
                 StudentSubmission_DraftRubricGrades Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON StudentSubmission_DraftRubricGrades where
...
newSubmissionHistory 
    ::  SubmissionHistory
newSubmissionHistory
  = SubmissionHistory{gradeHistory = Core.Nothing,
          ...
          = Core.withObject "SubmissionHistory"
              (\ o ->
                 SubmissionHistory Core.<$>
                   (o Core..:? "gradeHistory") Core.<*> (o Core..:? "stateHistory"))
...
newTeacher 
    ::  Teacher
newTeacher
  = Teacher{courseId = Core.Nothing, profile = Core.Nothing,
            userId = Core.Nothing}
...
newTopic 
    ::  Topic
newTopic
  = Topic{courseId = Core.Nothing, name = Core.Nothing,
          topicId = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON Topic where
        parseJSON
          = Core.withObject "Topic"
              (\ o ->
                 Topic Core.<$>
                   (o Core..:? "courseId") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "topicId")
                     Core.<*> (o Core..:? "updateTime"))
...
instance Core.FromJSON TurnInStudentSubmissionRequest where
        parseJSON
          = Core.withObject "TurnInStudentSubmissionRequest"
              (\ o -> Core.pure TurnInStudentSubmissionRequest)

instance Core.ToJSON TurnInStudentSubmissionRequest where
        toJSON = Core.const Core.emptyObject
...
newUserProfile 
    ::  UserProfile
newUserProfile
  = UserProfile{emailAddress = Core.Nothing, id = Core.Nothing,
                name = Core.Nothing, permissions = Core.Nothing,
                photoUrl = Core.Nothing, verifiedTeacher = Core.Nothing}
instance Core.FromJSON UserProfile where
        parseJSON
          = Core.withObject "UserProfile"
              (\ o ->
                 UserProfile Core.<$>
                   (o Core..:? "emailAddress") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("emailAddress" Core..=) Core.<$> emailAddress,
                  ...
                  ("verifiedTeacher" Core..=) Core.<$> verifiedTeacher])
...
newYouTubeVideo 
    ::  YouTubeVideo
newYouTubeVideo
  = YouTubeVideo{alternateLink = Core.Nothing, id = Core.Nothing,
                 thumbnailUrl = Core.Nothing, title = Core.Nothing}
