...
newBigtableAdminProjectsLocationsList name
  = BigtableAdminProjectsLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest BigtableAdminProjectsLocationsList
         where
        type Rs BigtableAdminProjectsLocationsList = ListLocationsResponse
        type Scopes BigtableAdminProjectsLocationsList =
