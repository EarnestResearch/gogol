...
newAppProfile 
    ::  AppProfile
newAppProfile
  = AppProfile{dataBoostIsolationReadOnly = Core.Nothing,
               description = Core.Nothing, etag = Core.Nothing,
               multiClusterRoutingUseAny = Core.Nothing, name = Core.Nothing,
               priority = Core.Nothing, singleClusterRouting = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("dataBoostIsolationReadOnly" Core..=) Core.<$>
                  ...
                  ("singleClusterRouting" Core..=) Core.<$> singleClusterRouting,
                  ("standardIsolation" Core..=) Core.<$> standardIsolation])
...
newAuthorizedView 
    ::  AuthorizedView
newAuthorizedView
  = AuthorizedView{deletionProtection = Core.Nothing,
...
instance Core.FromJSON AuthorizedView where
        parseJSON
          = Core.withObject "AuthorizedView"
              (\ o ->
                 AuthorizedView Core.<$>
                   (o Core..:? "deletionProtection") Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "name")
...
instance Core.ToJSON AuthorizedView where
        toJSON AuthorizedView{..}
          = Core.object
              (Core.catMaybes
                 [("deletionProtection" Core..=) Core.<$> deletionProtection,
...
newAutomatedBackupPolicy 
    ::  AutomatedBackupPolicy
newAutomatedBackupPolicy
  = AutomatedBackupPolicy{frequency = Core.Nothing,
          ...
          = Core.withObject "AutomatedBackupPolicy"
              (\ o ->
                 AutomatedBackupPolicy Core.<$>
                   (o Core..:? "frequency") Core.<*> (o Core..:? "retentionPeriod"))
...
newAutoscalingLimits 
    ::  AutoscalingLimits
newAutoscalingLimits
  = AutoscalingLimits{maxServeNodes = Core.Nothing,
                      minServeNodes = Core.Nothing}
instance Core.FromJSON AutoscalingLimits where
        parseJSON
          = Core.withObject "AutoscalingLimits"
              (\ o ->
                 AutoscalingLimits Core.<$>
                   (o Core..:? "maxServeNodes") Core.<*> (o Core..:? "minServeNodes"))
...
instance Core.ToJSON AutoscalingTargets where
        toJSON AutoscalingTargets{..}
          = Core.object
              (Core.catMaybes
                 [("cpuUtilizationPercent" Core..=) Core.<$> cpuUtilizationPercent,
...
newBackup 
    ::  Backup
newBackup
  = Backup{backupType = Core.Nothing, encryptionInfo = Core.Nothing,
           endTime = Core.Nothing, expireTime = Core.Nothing,
           hotToStandardTime = Core.Nothing, name = Core.Nothing,
           sizeBytes = Core.Nothing, sourceBackup = Core.Nothing,
           sourceTable = Core.Nothing, startTime = Core.Nothing,
           state = Core.Nothing}
instance Core.FromJSON Backup where
        parseJSON
          = Core.withObject "Backup"
              (\ o ->
                 Backup Core.<$>
                   (o Core..:? "backupType") Core.<*> (o Core..:? "encryptionInfo")
                     Core.<*> (o Core..:? "endTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("backupType" Core..=) Core.<$> backupType,
                  ...
                  ("hotToStandardTime" Core..=) Core.<$> hotToStandardTime,
                  ("name" Core..=) Core.<$> name,
...
newBackupInfo 
    ::  BackupInfo
newBackupInfo
  = BackupInfo{backup = Core.Nothing, endTime = Core.Nothing,
               sourceBackup = Core.Nothing, sourceTable = Core.Nothing,
...
instance Core.FromJSON BackupInfo where
        parseJSON
          = Core.withObject "BackupInfo"
              (\ o ->
                 BackupInfo Core.<$>
                   (o Core..:? "backup") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "sourceBackup")
                     Core.<*> (o Core..:? "sourceTable")
                     Core.<*> (o Core..:? "startTime"))
...
newChangeStreamConfig 
    ::  ChangeStreamConfig
newChangeStreamConfig
  = ChangeStreamConfig{retentionPeriod = Core.Nothing}
instance Core.FromJSON ChangeStreamConfig where
        parseJSON
          = Core.withObject "ChangeStreamConfig"
              (\ o -> ChangeStreamConfig Core.<$> (o Core..:? "retentionPeriod"))
...
instance Core.ToJSON CheckConsistencyRequest where
        toJSON CheckConsistencyRequest{..}
          = Core.object
              (Core.catMaybes
                 [("consistencyToken" Core..=) Core.<$> consistencyToken,
...
instance Core.FromJSON CheckConsistencyResponse where
        parseJSON
          = Core.withObject "CheckConsistencyResponse"
              (\ o ->
                 CheckConsistencyResponse Core.<$> (o Core..:? "consistent"))

instance Core.ToJSON CheckConsistencyResponse where
        toJSON CheckConsistencyResponse{..}
          = Core.object
              (Core.catMaybes [("consistent" Core..=) Core.<$> consistent])
...
newCluster 
    ::  Cluster
newCluster
  = Cluster{clusterConfig = Core.Nothing,
            defaultStorageType = Core.Nothing, encryptionConfig = Core.Nothing,
            location = Core.Nothing, name = Core.Nothing,
            nodeScalingFactor = Core.Nothing, serveNodes = Core.Nothing,
            state = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("clusterConfig" Core..=) Core.<$> clusterConfig,
                  ("defaultStorageType" Core..=) Core.<$> defaultStorageType,
...
newClusterAutoscalingConfig 
    ::  ClusterAutoscalingConfig
newClusterAutoscalingConfig
  = ClusterAutoscalingConfig{autoscalingLimits = Core.Nothing,
...
newClusterConfig 
    ::  ClusterConfig
newClusterConfig
  = ClusterConfig{clusterAutoscalingConfig = Core.Nothing}
instance Core.FromJSON ClusterConfig where
        parseJSON
          = Core.withObject "ClusterConfig"
              (\ o ->
                 ClusterConfig Core.<$> (o Core..:? "clusterAutoscalingConfig"))
...
newClusterState 
    ::  ClusterState
newClusterState
  = ClusterState{encryptionInfo = Core.Nothing,
                 replicationState = Core.Nothing}
...
instance Core.ToJSON ClusterState where
        toJSON ClusterState{..}
          = Core.object
              (Core.catMaybes
                 [("encryptionInfo" Core..=) Core.<$> encryptionInfo,
                  ("replicationState" Core..=) Core.<$> replicationState])
...
newColumnFamily 
    ::  ColumnFamily
newColumnFamily
  = ColumnFamily{gcRule = Core.Nothing, stats = Core.Nothing,
...
instance Core.FromJSON ColumnFamily where
        parseJSON
          = Core.withObject "ColumnFamily"
              (\ o ->
                 ColumnFamily Core.<$>
                   (o Core..:? "gcRule") Core.<*> (o Core..:? "stats") Core.<*>
                     (o Core..:? "valueType"))
...
newColumnFamilyStats 
    ::  ColumnFamilyStats
newColumnFamilyStats
  = ColumnFamilyStats{averageCellsPerColumn = Core.Nothing,
              ...
              (\ o ->
                 ColumnFamilyStats Core.<$>
                   (o Core..:? "averageCellsPerColumn") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "logicalDataBytes" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON ColumnFamilyStats where
        toJSON ColumnFamilyStats{..}
          = Core.object
              (Core.catMaybes
                 [("averageCellsPerColumn" Core..=) Core.<$> averageCellsPerColumn,
                  ("averageColumnsPerRow" Core..=) Core.<$> averageColumnsPerRow,
                  ("logicalDataBytes" Core..=) Core.. Core.AsText Core.<$>
                    logicalDataBytes])
...
newCopyBackupMetadata 
    ::  CopyBackupMetadata
newCopyBackupMetadata
  = CopyBackupMetadata{name = Core.Nothing, progress = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ...
                  ("sourceBackupInfo" Core..=) Core.<$> sourceBackupInfo])
...
newCreateAuthorizedViewMetadata 
    ::  CreateAuthorizedViewMetadata
newCreateAuthorizedViewMetadata
  = CreateAuthorizedViewMetadata{finishTime = Core.Nothing,
                                 originalRequest = Core.Nothing, requestTime = Core.Nothing}
instance Core.FromJSON CreateAuthorizedViewMetadata where
        parseJSON
          = Core.withObject "CreateAuthorizedViewMetadata"
              (\ o ->
                 CreateAuthorizedViewMetadata Core.<$>
                   (o Core..:? "finishTime") Core.<*> (o Core..:? "originalRequest")
                     Core.<*> (o Core..:? "requestTime"))

instance Core.ToJSON CreateAuthorizedViewMetadata where
...
newCreateAuthorizedViewRequest 
    ::  CreateAuthorizedViewRequest
newCreateAuthorizedViewRequest
  = CreateAuthorizedViewRequest{authorizedView = Core.Nothing,
                                authorizedViewId = Core.Nothing, parent = Core.Nothing}
instance Core.FromJSON CreateAuthorizedViewRequest where
        parseJSON
...
instance Core.ToJSON CreateAuthorizedViewRequest where
        toJSON CreateAuthorizedViewRequest{..}
          = Core.object
              (Core.catMaybes
                 [("authorizedView" Core..=) Core.<$> authorizedView,
                  ("authorizedViewId" Core..=) Core.<$> authorizedViewId,
...
newCreateBackupMetadata 
    ::  CreateBackupMetadata
newCreateBackupMetadata
  = CreateBackupMetadata{endTime = Core.Nothing, name = Core.Nothing,
                         sourceTable = Core.Nothing, startTime = Core.Nothing}
          ...
          = Core.withObject "CreateBackupMetadata"
              (\ o ->
                 CreateBackupMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "sourceTable")
                     Core.<*> (o Core..:? "startTime"))
...
newCreateClusterMetadata 
    ::  CreateClusterMetadata
newCreateClusterMetadata
  = CreateClusterMetadata{finishTime = Core.Nothing,
                          originalRequest = Core.Nothing, requestTime = Core.Nothing,
                          tables = Core.Nothing}
...
instance Core.FromJSON CreateClusterMetadata_Tables where
        parseJSON
          = Core.withObject "CreateClusterMetadata_Tables"
              (\ o ->
                 CreateClusterMetadata_Tables Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON CreateClusterMetadata_Tables where
        toJSON CreateClusterMetadata_Tables{..} = Core.toJSON additional
...
newCreateInstanceMetadata 
    ::  CreateInstanceMetadata
newCreateInstanceMetadata
  = CreateInstanceMetadata{finishTime = Core.Nothing,
                           originalRequest = Core.Nothing, requestTime = Core.Nothing}
...
newCreateInstanceRequest 
    ::  CreateInstanceRequest
newCreateInstanceRequest
  = CreateInstanceRequest{clusters = Core.Nothing,
                          instance' = Core.Nothing, instanceId = Core.Nothing,
                          parent = Core.Nothing}
          ...
          = Core.withObject "CreateInstanceRequest"
              (\ o ->
                 CreateInstanceRequest Core.<$>
                   (o Core..:? "clusters") Core.<*> (o Core..:? "instance") Core.<*>
                     (o Core..:? "instanceId")
                     Core.<*> (o Core..:? "parent"))
...
instance Core.FromJSON CreateInstanceRequest_Clusters where
        parseJSON
          = Core.withObject "CreateInstanceRequest_Clusters"
              (\ o ->
                 CreateInstanceRequest_Clusters Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON CreateInstanceRequest_Clusters where
        toJSON CreateInstanceRequest_Clusters{..} = Core.toJSON additional


-- | The metadata for the Operation returned by CreateLogicalView.
--
-- /See:/ 'newCreateLogicalViewMetadata' smart constructor.
data CreateLogicalViewMetadata = CreateLogicalViewMetadata
    {
      -- | If set, the time at which this operation finished or was canceled.
      endTime :: (Core.Maybe Core.DateTime)
      -- | The request that prompted the initiation of this CreateLogicalView operation.
    , originalRequest :: (Core.Maybe CreateLogicalViewRequest)
      -- | The time at which this operation started.
    , startTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CreateLogicalViewMetadata' with the minimum fields required to make a request.
newCreateLogicalViewMetadata 
    ::  CreateLogicalViewMetadata
newCreateLogicalViewMetadata
  = CreateLogicalViewMetadata{endTime = Core.Nothing,
                              originalRequest = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON CreateLogicalViewMetadata where
        parseJSON
          = Core.withObject "CreateLogicalViewMetadata"
              (\ o ->
                 CreateLogicalViewMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "originalRequest")
                     Core.<*> (o Core..:? "startTime"))

instance Core.ToJSON CreateLogicalViewMetadata where
        toJSON CreateLogicalViewMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("endTime" Core..=) Core.<$> endTime,
                  ("originalRequest" Core..=) Core.<$> originalRequest,
...
--
-- /See:/ 'newCreateLogicalViewRequest' smart constructor.
data CreateLogicalViewRequest = CreateLogicalViewRequest
    {
      -- | Required. The logical view to create.
      logicalView :: (Core.Maybe LogicalView)
...
-- | Creates a value of 'CreateLogicalViewRequest' with the minimum fields required to make a request.
newCreateLogicalViewRequest 
    ::  CreateLogicalViewRequest
newCreateLogicalViewRequest
  = CreateLogicalViewRequest{logicalView = Core.Nothing,
                             logicalViewId = Core.Nothing, parent = Core.Nothing}
instance Core.FromJSON CreateLogicalViewRequest where
        parseJSON
          = Core.withObject "CreateLogicalViewRequest"
              (\ o ->
                 CreateLogicalViewRequest Core.<$>
                   (o Core..:? "logicalView") Core.<*> (o Core..:? "logicalViewId")
                     Core.<*> (o Core..:? "parent"))

instance Core.ToJSON CreateLogicalViewRequest where
        toJSON CreateLogicalViewRequest{..}
          = Core.object
              (Core.catMaybes
                 [("logicalView" Core..=) Core.<$> logicalView,
                  ("logicalViewId" Core..=) Core.<$> logicalViewId,
                  ("parent" Core..=) Core.<$> parent])


-- | The metadata for the Operation returned by CreateMaterializedView.
--
-- /See:/ 'newCreateMaterializedViewMetadata' smart constructor.
data CreateMaterializedViewMetadata = CreateMaterializedViewMetadata
    {
      -- | If set, the time at which this operation finished or was canceled.
      endTime :: (Core.Maybe Core.DateTime)
      -- | The request that prompted the initiation of this CreateMaterializedView operation.
    , originalRequest :: (Core.Maybe CreateMaterializedViewRequest)
      -- | The time at which this operation started.
    , startTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CreateMaterializedViewMetadata' with the minimum fields required to make a request.
newCreateMaterializedViewMetadata 
    ::  CreateMaterializedViewMetadata
newCreateMaterializedViewMetadata
  = CreateMaterializedViewMetadata{endTime = Core.Nothing,
                                   originalRequest = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON CreateMaterializedViewMetadata where
        parseJSON
          = Core.withObject "CreateMaterializedViewMetadata"
              (\ o ->
                 CreateMaterializedViewMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "originalRequest")
                     Core.<*> (o Core..:? "startTime"))

instance Core.ToJSON CreateMaterializedViewMetadata where
        toJSON CreateMaterializedViewMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("endTime" Core..=) Core.<$> endTime,
                  ("originalRequest" Core..=) Core.<$> originalRequest,
...
--
-- /See:/ 'newCreateMaterializedViewRequest' smart constructor.
data CreateMaterializedViewRequest = CreateMaterializedViewRequest
    {
...
-- | Creates a value of 'CreateMaterializedViewRequest' with the minimum fields required to make a request.
newCreateMaterializedViewRequest 
    ::  CreateMaterializedViewRequest
newCreateMaterializedViewRequest
  = CreateMaterializedViewRequest{materializedView = Core.Nothing,
                                  materializedViewId = Core.Nothing, parent = Core.Nothing}
instance Core.FromJSON CreateMaterializedViewRequest where
        parseJSON
          = Core.withObject "CreateMaterializedViewRequest"
              (\ o ->
                 CreateMaterializedViewRequest Core.<$>
                   (o Core..:? "materializedView") Core.<*>
                     (o Core..:? "materializedViewId")
                     Core.<*> (o Core..:? "parent"))

instance Core.ToJSON CreateMaterializedViewRequest where
        toJSON CreateMaterializedViewRequest{..}
          = Core.object
              (Core.catMaybes
                 [("materializedView" Core..=) Core.<$> materializedView,
                  ("materializedViewId" Core..=) Core.<$> materializedViewId,
                  ("parent" Core..=) Core.<$> parent])
...
newCreateTableRequest 
    ::  CreateTableRequest
newCreateTableRequest
  = CreateTableRequest{initialSplits = Core.Nothing,
                       table = Core.Nothing, tableId = Core.Nothing}
instance Core.FromJSON CreateTableRequest where
        parseJSON
          = Core.withObject "CreateTableRequest"
              (\ o ->
                 CreateTableRequest Core.<$>
                   (o Core..:? "initialSplits") Core.<*> (o Core..:? "table") Core.<*>
                     (o Core..:? "tableId"))
...
instance Core.FromJSON DataBoostIsolationReadOnly where
        parseJSON
...
instance Core.ToJSON DataBoostIsolationReadOnly where
        toJSON DataBoostIsolationReadOnly{..}
          = Core.object
              (Core.catMaybes
                 [("computeBillingOwner" Core..=) Core.<$> computeBillingOwner])
...
newDropRowRangeRequest 
    ::  DropRowRangeRequest
newDropRowRangeRequest
  = DropRowRangeRequest{deleteAllDataFromTable = Core.Nothing,
...
newGcRule 
    ::  GcRule
newGcRule
  = GcRule{intersection = Core.Nothing, maxAge = Core.Nothing,
           maxNumVersions = Core.Nothing, union = Core.Nothing}
instance Core.FromJSON GcRule where
        parseJSON
          = Core.withObject "GcRule"
              (\ o ->
                 GcRule Core.<$>
                   (o Core..:? "intersection") Core.<*> (o Core..:? "maxAge") Core.<*>
                     (o Core..:? "maxNumVersions")
                     Core.<*> (o Core..:? "union"))
...
newGenerateConsistencyTokenRequest
  = GenerateConsistencyTokenRequest
instance Core.FromJSON GenerateConsistencyTokenRequest where
        parseJSON
...
instance Core.FromJSON GenerateConsistencyTokenResponse where
        parseJSON
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleBigtableAdminV2AuthorizedViewFamilySubsets"
              (\ o ->
                 GoogleBigtableAdminV2AuthorizedViewFamilySubsets Core.<$>
...
instance Core.ToJSON
           GoogleBigtableAdminV2AuthorizedViewFamilySubsets
         where
        toJSON GoogleBigtableAdminV2AuthorizedViewFamilySubsets{..}
          = Core.object
              (Core.catMaybes
                 [("qualifierPrefixes" Core..=) Core.<$> qualifierPrefixes,
...
newGoogleBigtableAdminV2AuthorizedViewSubsetView 
    :: 
                                                 GoogleBigtableAdminV2AuthorizedViewSubsetView
newGoogleBigtableAdminV2AuthorizedViewSubsetView
  = GoogleBigtableAdminV2AuthorizedViewSubsetView{familySubsets =
                                                    Core.Nothing,
                                                  rowPrefixes = Core.Nothing}
instance Core.FromJSON
           GoogleBigtableAdminV2AuthorizedViewSubsetView
         where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2AuthorizedViewSubsetView"
              (\ o ->
                 GoogleBigtableAdminV2AuthorizedViewSubsetView Core.<$>
                   (o Core..:? "familySubsets") Core.<*> (o Core..:? "rowPrefixes"))

instance Core.ToJSON GoogleBigtableAdminV2AuthorizedViewSubsetView
         where
        toJSON GoogleBigtableAdminV2AuthorizedViewSubsetView{..}
          = Core.object
              (Core.catMaybes
...
newGoogleBigtableAdminV2AuthorizedViewSubsetView_FamilySubsets
  additional
  = GoogleBigtableAdminV2AuthorizedViewSubsetView_FamilySubsets{additional
                                                                  = additional}
instance Core.FromJSON
           GoogleBigtableAdminV2AuthorizedViewSubsetView_FamilySubsets
         where
...
newGoogleBigtableAdminV2TypeAggregate 
    :: 
                                      GoogleBigtableAdminV2TypeAggregate
newGoogleBigtableAdminV2TypeAggregate
  = GoogleBigtableAdminV2TypeAggregate{hllppUniqueCount =
                                         Core.Nothing,
                                       inputType = Core.Nothing, max = Core.Nothing,
                                       min = Core.Nothing, stateType = Core.Nothing,
                                       sum = Core.Nothing}
instance Core.FromJSON GoogleBigtableAdminV2TypeAggregate where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeAggregate"
              (\ o ->
                 GoogleBigtableAdminV2TypeAggregate Core.<$>
                   (o Core..:? "hllppUniqueCount") Core.<*> (o Core..:? "inputType")
                     Core.<*> (o Core..:? "max")
                     Core.<*> (o Core..:? "min")
                     Core.<*> (o Core..:? "stateType")
                     Core.<*> (o Core..:? "sum"))

instance Core.ToJSON GoogleBigtableAdminV2TypeAggregate where
        toJSON GoogleBigtableAdminV2TypeAggregate{..}
          = Core.object
              (Core.catMaybes
                 [("hllppUniqueCount" Core..=) Core.<$> hllppUniqueCount,
...
newGoogleBigtableAdminV2TypeAggregateMax
  = GoogleBigtableAdminV2TypeAggregateMax
instance Core.FromJSON GoogleBigtableAdminV2TypeAggregateMax where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeAggregateMax"
              (\ o -> Core.pure GoogleBigtableAdminV2TypeAggregateMax)

instance Core.ToJSON GoogleBigtableAdminV2TypeAggregateMax where
        toJSON = Core.const Core.emptyObject
...
newGoogleBigtableAdminV2TypeAggregateMin
  = GoogleBigtableAdminV2TypeAggregateMin
instance Core.FromJSON GoogleBigtableAdminV2TypeAggregateMin where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeAggregateMin"
              (\ o -> Core.pure GoogleBigtableAdminV2TypeAggregateMin)

instance Core.ToJSON GoogleBigtableAdminV2TypeAggregateMin where
        toJSON = Core.const Core.emptyObject
...
newGoogleBigtableAdminV2TypeAggregateSum
  = GoogleBigtableAdminV2TypeAggregateSum
instance Core.FromJSON GoogleBigtableAdminV2TypeAggregateSum where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeAggregateSum"
              (\ o -> Core.pure GoogleBigtableAdminV2TypeAggregateSum)

instance Core.ToJSON GoogleBigtableAdminV2TypeAggregateSum where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON GoogleBigtableAdminV2TypeArray where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeArray"
              (\ o ->
                 GoogleBigtableAdminV2TypeArray Core.<$> (o Core..:? "elementType"))

instance Core.ToJSON GoogleBigtableAdminV2TypeArray where
        toJSON GoogleBigtableAdminV2TypeArray{..}
          = Core.object
              (Core.catMaybes [("elementType" Core..=) Core.<$> elementType])
...
instance Core.FromJSON GoogleBigtableAdminV2TypeBool where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeBool"
              (\ o -> Core.pure GoogleBigtableAdminV2TypeBool)

instance Core.ToJSON GoogleBigtableAdminV2TypeBool where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON GoogleBigtableAdminV2TypeBytes where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeBytes"
              (\ o ->
                 GoogleBigtableAdminV2TypeBytes Core.<$> (o Core..:? "encoding"))

instance Core.ToJSON GoogleBigtableAdminV2TypeBytes where
...
instance Core.FromJSON GoogleBigtableAdminV2TypeBytesEncoding where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeBytesEncoding"
              (\ o ->
                 GoogleBigtableAdminV2TypeBytesEncoding Core.<$> (o Core..:? "raw"))

instance Core.ToJSON GoogleBigtableAdminV2TypeBytesEncoding where
        toJSON GoogleBigtableAdminV2TypeBytesEncoding{..}
          = Core.object (Core.catMaybes [("raw" Core..=) Core.<$> raw])
...
newGoogleBigtableAdminV2TypeBytesEncodingRaw 
    :: 
                                             GoogleBigtableAdminV2TypeBytesEncodingRaw
newGoogleBigtableAdminV2TypeBytesEncodingRaw
  = GoogleBigtableAdminV2TypeBytesEncodingRaw{escapeNulls =
                                                Core.Nothing}
instance Core.FromJSON GoogleBigtableAdminV2TypeBytesEncodingRaw
         where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeBytesEncodingRaw"
              (\ o ->
                 GoogleBigtableAdminV2TypeBytesEncodingRaw Core.<$>
                   (o Core..:? "escapeNulls"))

instance Core.ToJSON GoogleBigtableAdminV2TypeBytesEncodingRaw
         where
...
instance Core.FromJSON GoogleBigtableAdminV2TypeDate where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeDate"
              (\ o -> Core.pure GoogleBigtableAdminV2TypeDate)

instance Core.ToJSON GoogleBigtableAdminV2TypeDate where
        toJSON = Core.const Core.emptyObject
...
newGoogleBigtableAdminV2TypeFloat32
  = GoogleBigtableAdminV2TypeFloat32
instance Core.FromJSON GoogleBigtableAdminV2TypeFloat32 where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeFloat32"
              (\ o -> Core.pure GoogleBigtableAdminV2TypeFloat32)

instance Core.ToJSON GoogleBigtableAdminV2TypeFloat32 where
        toJSON = Core.const Core.emptyObject
...
newGoogleBigtableAdminV2TypeFloat64
  = GoogleBigtableAdminV2TypeFloat64
instance Core.FromJSON GoogleBigtableAdminV2TypeFloat64 where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeFloat64"
              (\ o -> Core.pure GoogleBigtableAdminV2TypeFloat64)

instance Core.ToJSON GoogleBigtableAdminV2TypeFloat64 where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON GoogleBigtableAdminV2TypeInt64 where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeInt64"
              (\ o ->
                 GoogleBigtableAdminV2TypeInt64 Core.<$> (o Core..:? "encoding"))

instance Core.ToJSON GoogleBigtableAdminV2TypeInt64 where
...
instance Core.FromJSON GoogleBigtableAdminV2TypeInt64Encoding where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeInt64Encoding"
              (\ o ->
                 GoogleBigtableAdminV2TypeInt64Encoding Core.<$>
                   (o Core..:? "bigEndianBytes") Core.<*>
                     (o Core..:? "orderedCodeBytes"))
...
newGoogleBigtableAdminV2TypeInt64EncodingBigEndianBytes 
    :: 
                                                        GoogleBigtableAdminV2TypeInt64EncodingBigEndianBytes
newGoogleBigtableAdminV2TypeInt64EncodingBigEndianBytes
  = GoogleBigtableAdminV2TypeInt64EncodingBigEndianBytes{bytesType =
                                                           Core.Nothing}
instance Core.FromJSON
           GoogleBigtableAdminV2TypeInt64EncodingBigEndianBytes
         where
        parseJSON
          = Core.withObject
              "GoogleBigtableAdminV2TypeInt64EncodingBigEndianBytes"
              (\ o ->
                 GoogleBigtableAdminV2TypeInt64EncodingBigEndianBytes Core.<$>
                   (o Core..:? "bytesType"))
...
newGoogleBigtableAdminV2TypeMap 
    ::  GoogleBigtableAdminV2TypeMap
newGoogleBigtableAdminV2TypeMap
  = GoogleBigtableAdminV2TypeMap{keyType = Core.Nothing,
                                 valueType = Core.Nothing}
instance Core.FromJSON GoogleBigtableAdminV2TypeMap where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeMap"
              (\ o ->
                 GoogleBigtableAdminV2TypeMap Core.<$>
                   (o Core..:? "keyType") Core.<*> (o Core..:? "valueType"))

instance Core.ToJSON GoogleBigtableAdminV2TypeMap where
...
instance Core.FromJSON GoogleBigtableAdminV2TypeString where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeString"
              (\ o ->
                 GoogleBigtableAdminV2TypeString Core.<$> (o Core..:? "encoding"))

instance Core.ToJSON GoogleBigtableAdminV2TypeString where
...
newGoogleBigtableAdminV2TypeStringEncoding 
    :: 
                                           GoogleBigtableAdminV2TypeStringEncoding
newGoogleBigtableAdminV2TypeStringEncoding
  = GoogleBigtableAdminV2TypeStringEncoding{utf8Bytes = Core.Nothing,
                                            utf8Raw = Core.Nothing}
instance Core.FromJSON GoogleBigtableAdminV2TypeStringEncoding
         where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeStringEncoding"
              (\ o ->
                 GoogleBigtableAdminV2TypeStringEncoding Core.<$>
                   (o Core..:? "utf8Bytes") Core.<*> (o Core..:? "utf8Raw"))

instance Core.ToJSON GoogleBigtableAdminV2TypeStringEncoding where
...
newGoogleBigtableAdminV2TypeStringEncodingUtf8Bytes 
    :: 
                                                    GoogleBigtableAdminV2TypeStringEncodingUtf8Bytes
newGoogleBigtableAdminV2TypeStringEncodingUtf8Bytes
  = GoogleBigtableAdminV2TypeStringEncodingUtf8Bytes{nullEscapeChar =
                                                       Core.Nothing}
instance Core.FromJSON
           GoogleBigtableAdminV2TypeStringEncodingUtf8Bytes
         where
        parseJSON
          = Core.withObject
              "GoogleBigtableAdminV2TypeStringEncodingUtf8Bytes"
              (\ o ->
                 GoogleBigtableAdminV2TypeStringEncodingUtf8Bytes Core.<$>
                   (o Core..:? "nullEscapeChar"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeStringEncodingUtf8Raw"
              (\ o -> Core.pure GoogleBigtableAdminV2TypeStringEncodingUtf8Raw)
...
newGoogleBigtableAdminV2TypeStruct 
    :: 
                                   GoogleBigtableAdminV2TypeStruct
newGoogleBigtableAdminV2TypeStruct
  = GoogleBigtableAdminV2TypeStruct{encoding = Core.Nothing,
                                    fields = Core.Nothing}
          ...
          = Core.withObject "GoogleBigtableAdminV2TypeStruct"
              (\ o ->
                 GoogleBigtableAdminV2TypeStruct Core.<$>
                   (o Core..:? "encoding") Core.<*> (o Core..:? "fields"))
...
newGoogleBigtableAdminV2TypeStructEncoding 
    :: 
                                           GoogleBigtableAdminV2TypeStructEncoding
newGoogleBigtableAdminV2TypeStructEncoding
  = GoogleBigtableAdminV2TypeStructEncoding{delimitedBytes =
                                              Core.Nothing,
                                            orderedCodeBytes = Core.Nothing,
                                            singleton = Core.Nothing}
instance Core.FromJSON GoogleBigtableAdminV2TypeStructEncoding
         where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeStructEncoding"
              (\ o ->
                 GoogleBigtableAdminV2TypeStructEncoding Core.<$>
                   (o Core..:? "delimitedBytes") Core.<*>
                     (o Core..:? "orderedCodeBytes")
...
newGoogleBigtableAdminV2TypeStructEncodingDelimitedBytes 
    :: 
                                                         GoogleBigtableAdminV2TypeStructEncodingDelimitedBytes
newGoogleBigtableAdminV2TypeStructEncodingDelimitedBytes
  = GoogleBigtableAdminV2TypeStructEncodingDelimitedBytes{delimiter =
                                                            Core.Nothing}
instance Core.FromJSON
           GoogleBigtableAdminV2TypeStructEncodingDelimitedBytes
         where
        parseJSON
          = Core.withObject
              "GoogleBigtableAdminV2TypeStructEncodingDelimitedBytes"
              (\ o ->
                 GoogleBigtableAdminV2TypeStructEncodingDelimitedBytes Core.<$>
                   (o Core..:? "delimiter"))
...
newGoogleBigtableAdminV2TypeStructField 
    :: 
                                        GoogleBigtableAdminV2TypeStructField
newGoogleBigtableAdminV2TypeStructField
  = GoogleBigtableAdminV2TypeStructField{fieldName = Core.Nothing,
                                         type' = Core.Nothing}
instance Core.FromJSON GoogleBigtableAdminV2TypeStructField where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeStructField"
              (\ o ->
                 GoogleBigtableAdminV2TypeStructField Core.<$>
                   (o Core..:? "fieldName") Core.<*> (o Core..:? "type"))

instance Core.ToJSON GoogleBigtableAdminV2TypeStructField where
...
instance Core.FromJSON GoogleBigtableAdminV2TypeTimestamp where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeTimestamp"
              (\ o ->
                 GoogleBigtableAdminV2TypeTimestamp Core.<$>
                   (o Core..:? "encoding"))
...
newGoogleBigtableAdminV2TypeTimestampEncoding 
    :: 
                                              GoogleBigtableAdminV2TypeTimestampEncoding
newGoogleBigtableAdminV2TypeTimestampEncoding
  = GoogleBigtableAdminV2TypeTimestampEncoding{unixMicrosInt64 =
                                                 Core.Nothing}
instance Core.FromJSON GoogleBigtableAdminV2TypeTimestampEncoding
         where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeTimestampEncoding"
              (\ o ->
                 GoogleBigtableAdminV2TypeTimestampEncoding Core.<$>
                   (o Core..:? "unixMicrosInt64"))

instance Core.ToJSON GoogleBigtableAdminV2TypeTimestampEncoding
         where
...
newHotTablet 
    ::  HotTablet
newHotTablet
  = HotTablet{endKey = Core.Nothing, endTime = Core.Nothing,
              name = Core.Nothing, nodeCpuUsagePercent = Core.Nothing,
              startKey = Core.Nothing, startTime = Core.Nothing,
...
instance Core.FromJSON HotTablet where
        parseJSON
          = Core.withObject "HotTablet"
              (\ o ->
                 HotTablet Core.<$>
                   (o Core..:? "endKey") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("endKey" Core..=) Core.<$> endKey,
                  ("endTime" Core..=) Core.<$> endTime,
                  ("name" Core..=) Core.<$> name,
                  ("nodeCpuUsagePercent" Core..=) Core.<$> nodeCpuUsagePercent,
...
newInstance 
    ::  Instance
newInstance
  = Instance{createTime = Core.Nothing, displayName = Core.Nothing,
...
instance Core.FromJSON Instance where
        parseJSON
          = Core.withObject "Instance"
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
...
newListAppProfilesResponse 
    ::  ListAppProfilesResponse
newListAppProfilesResponse
  = ListAppProfilesResponse{appProfiles = Core.Nothing,
                            failedLocations = Core.Nothing, nextPageToken = Core.Nothing}
instance Core.FromJSON ListAppProfilesResponse where
        parseJSON
          = Core.withObject "ListAppProfilesResponse"
              (\ o ->
                 ListAppProfilesResponse Core.<$>
                   (o Core..:? "appProfiles") Core.<*> (o Core..:? "failedLocations")
...
newListAuthorizedViewsResponse 
    ::  ListAuthorizedViewsResponse
newListAuthorizedViewsResponse
  = ListAuthorizedViewsResponse{authorizedViews = Core.Nothing,
                                nextPageToken = Core.Nothing}
instance Core.FromJSON ListAuthorizedViewsResponse where
        parseJSON
...
instance Core.ToJSON ListAuthorizedViewsResponse where
        toJSON ListAuthorizedViewsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("authorizedViews" Core..=) Core.<$> authorizedViews,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
          ...
          = Core.withObject "ListClustersResponse"
              (\ o ->
                 ListClustersResponse Core.<$>
                   (o Core..:? "clusters") Core.<*> (o Core..:? "failedLocations")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newListHotTabletsResponse 
    ::  ListHotTabletsResponse
newListHotTabletsResponse
  = ListHotTabletsResponse{hotTablets = Core.Nothing,
                           nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListHotTabletsResponse"
              (\ o ->
                 ListHotTabletsResponse Core.<$>
                   (o Core..:? "hotTablets") Core.<*> (o Core..:? "nextPageToken"))
...
newListInstancesResponse 
    ::  ListInstancesResponse
newListInstancesResponse
  = ListInstancesResponse{failedLocations = Core.Nothing,
                          instances = Core.Nothing, nextPageToken = Core.Nothing}
instance Core.FromJSON ListInstancesResponse where
        parseJSON
          = Core.withObject "ListInstancesResponse"
              (\ o ->
                 ListInstancesResponse Core.<$>
                   (o Core..:? "failedLocations") Core.<*> (o Core..:? "instances")
                     Core.<*> (o Core..:? "nextPageToken"))
...
--
-- /See:/ 'newListLogicalViewsResponse' smart constructor.
data ListLogicalViewsResponse = ListLogicalViewsResponse
    {
      -- | The list of requested logical views.
      logicalViews :: (Core.Maybe [LogicalView])
      -- | A token, which can be sent as @page_token@ to retrieve the next page. If this field is omitted, there are no subsequent pages.
    , nextPageToken :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ListLogicalViewsResponse' with the minimum fields required to make a request.
newListLogicalViewsResponse 
    ::  ListLogicalViewsResponse
newListLogicalViewsResponse
  = ListLogicalViewsResponse{logicalViews = Core.Nothing,
                             nextPageToken = Core.Nothing}
instance Core.FromJSON ListLogicalViewsResponse where
        parseJSON
          = Core.withObject "ListLogicalViewsResponse"
              (\ o ->
                 ListLogicalViewsResponse Core.<$>
                   (o Core..:? "logicalViews") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON ListLogicalViewsResponse where
        toJSON ListLogicalViewsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("logicalViews" Core..=) Core.<$> logicalViews,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])


-- | Response message for BigtableInstanceAdmin.ListMaterializedViews.
--
-- /See:/ 'newListMaterializedViewsResponse' smart constructor.
data ListMaterializedViewsResponse = ListMaterializedViewsResponse
    {
      -- | The list of requested materialized views.
      materializedViews :: (Core.Maybe [MaterializedView])
      -- | A token, which can be sent as @page_token@ to retrieve the next page. If this field is omitted, there are no subsequent pages.
    , nextPageToken :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ListMaterializedViewsResponse' with the minimum fields required to make a request.
newListMaterializedViewsResponse 
    ::  ListMaterializedViewsResponse
newListMaterializedViewsResponse
  = ListMaterializedViewsResponse{materializedViews = Core.Nothing,
                                  nextPageToken = Core.Nothing}
instance Core.FromJSON ListMaterializedViewsResponse where
        parseJSON
          = Core.withObject "ListMaterializedViewsResponse"
              (\ o ->
                 ListMaterializedViewsResponse Core.<$>
                   (o Core..:? "materializedViews") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListMaterializedViewsResponse where
        toJSON ListMaterializedViewsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("materializedViews" Core..=) Core.<$> materializedViews,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListTablesResponse 
    ::  ListTablesResponse
newListTablesResponse
  = ListTablesResponse{nextPageToken = Core.Nothing,
                       tables = Core.Nothing}
          ...
          = Core.withObject "ListTablesResponse"
              (\ o ->
                 ListTablesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "tables"))
...
--
-- /See:/ 'newLogicalView' smart constructor.
data LogicalView = LogicalView
    {
...
-- | Creates a value of 'LogicalView' with the minimum fields required to make a request.
newLogicalView 
    ::  LogicalView
newLogicalView
  = LogicalView{deletionProtection = Core.Nothing,
                etag = Core.Nothing, name = Core.Nothing, query = Core.Nothing}
instance Core.FromJSON LogicalView where
        parseJSON
          = Core.withObject "LogicalView"
              (\ o ->
                 LogicalView Core.<$>
                   (o Core..:? "deletionProtection") Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "name")
...
instance Core.ToJSON LogicalView where
        toJSON LogicalView{..}
          = Core.object
              (Core.catMaybes
                 [("deletionProtection" Core..=) Core.<$> deletionProtection,
...
newMaterializedView 
    ::  MaterializedView
newMaterializedView
  = MaterializedView{deletionProtection = Core.Nothing,
                     etag = Core.Nothing, name = Core.Nothing, query = Core.Nothing}
...
newModification 
    ::  Modification
newModification
  = Modification{create = Core.Nothing, drop = Core.Nothing,
                 id = Core.Nothing, update = Core.Nothing,
...
instance Core.FromJSON Modification where
        parseJSON
          = Core.withObject "Modification"
              (\ o ->
                 Modification Core.<$>
                   (o Core..:? "create") Core.<*> (o Core..:? "drop") Core.<*>
                     (o Core..:? "id")
                     Core.<*> (o Core..:? "update")
          ...
          = Core.object
              (Core.catMaybes
                 [("create" Core..=) Core.<$> create,
                  ("drop" Core..=) Core.<$> drop, ("id" Core..=) Core.<$> id,
...
newModifyColumnFamiliesRequest 
    ::  ModifyColumnFamiliesRequest
newModifyColumnFamiliesRequest
  = ModifyColumnFamiliesRequest{ignoreWarnings = Core.Nothing,
                                modifications = Core.Nothing}
          ...
          = Core.withObject "MultiClusterRoutingUseAny"
              (\ o ->
                 MultiClusterRoutingUseAny Core.<$>
                   (o Core..:? "clusterIds") Core.<*> (o Core..:? "rowAffinity"))
...
newOptimizeRestoredTableMetadata 
    ::  OptimizeRestoredTableMetadata
newOptimizeRestoredTableMetadata
  = OptimizeRestoredTableMetadata{name = Core.Nothing,
...
newPartialUpdateClusterMetadata 
    ::  PartialUpdateClusterMetadata
newPartialUpdateClusterMetadata
  = PartialUpdateClusterMetadata{finishTime = Core.Nothing,
                                 originalRequest = Core.Nothing, requestTime = Core.Nothing}
...
newPartialUpdateClusterRequest 
    ::  PartialUpdateClusterRequest
newPartialUpdateClusterRequest
  = PartialUpdateClusterRequest{cluster = Core.Nothing,
                                updateMask = Core.Nothing}
          ...
          = Core.withObject "PartialUpdateClusterRequest"
              (\ o ->
                 PartialUpdateClusterRequest Core.<$>
                   (o Core..:? "cluster") Core.<*> (o Core..:? "updateMask"))
...
newPartialUpdateInstanceRequest 
    ::  PartialUpdateInstanceRequest
newPartialUpdateInstanceRequest
  = PartialUpdateInstanceRequest{instance' = Core.Nothing,
                                 updateMask = Core.Nothing}
          ...
          = Core.withObject "PartialUpdateInstanceRequest"
              (\ o ->
                 PartialUpdateInstanceRequest Core.<$>
                   (o Core..:? "instance") Core.<*> (o Core..:? "updateMask"))
...
newRestoreTableMetadata 
    ::  RestoreTableMetadata
newRestoreTableMetadata
  = RestoreTableMetadata{backupInfo = Core.Nothing,
                         name = Core.Nothing, optimizeTableOperationName = Core.Nothing,
          ...
          = Core.withObject "RestoreTableMetadata"
              (\ o ->
                 RestoreTableMetadata Core.<$>
                   (o Core..:? "backupInfo") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "optimizeTableOperationName")
...
newRestoreTableRequest 
    ::  RestoreTableRequest
newRestoreTableRequest
  = RestoreTableRequest{backup = Core.Nothing,
          ...
          = Core.withObject "RestoreTableRequest"
              (\ o ->
                 RestoreTableRequest Core.<$>
                   (o Core..:? "backup") Core.<*> (o Core..:? "tableId"))
...
instance Core.FromJSON RowAffinity where
        parseJSON
          = Core.withObject "RowAffinity" (\ o -> Core.pure RowAffinity)
...
newSingleClusterRouting 
    ::  SingleClusterRouting
newSingleClusterRouting
  = SingleClusterRouting{allowTransactionalWrites = Core.Nothing,
...
instance Core.FromJSON StandardIsolation where
        parseJSON
          = Core.withObject "StandardIsolation"
              (\ o -> StandardIsolation Core.<$> (o Core..:? "priority"))

instance Core.ToJSON StandardIsolation where
        toJSON StandardIsolation{..}
          = Core.object
              (Core.catMaybes [("priority" Core..=) Core.<$> priority])
...
data Table = Table
    ...
    , restoreInfo :: (Core.Maybe RestoreInfo)
      -- | The row key schema for this table. The schema is used to decode the raw row key bytes into a structured format. The order of field declarations in this schema is important, as it reflects how the raw row key bytes are structured. Currently, this only affects how the key is read via a GoogleSQL query from the ExecuteQuery API. For a SQL query, the /key column is still read as raw bytes. But queries can reference the key fields by name, which will be decoded from /key using provided type and encoding. Queries that reference key fields will fail if they encounter an invalid row key. For example, if /key = \"some/id#2024-04-30#\\x00\\x13\\x00\\xf3\" with the following schema: { fields { field/name: \"id\" type { string { encoding: utf8/bytes {} } } } fields { field/name: \"date\" type { string { encoding: utf8/bytes {} } } } fields { field/name: \"product/code\" type { int64 { encoding: big/endian/bytes {} } } } encoding { delimited/bytes { delimiter: \"#\" } } } The decoded key parts would be: id = \"some/id\",
      -- date = \"2024-04-30\", product/code = 1245427 The query \"SELECT /key, product/code FROM table\" will return two columns: \/------------------------------------------------------\\ | /key | product/code | | --------------------------------------|--------------| | \"some/id#2024-04-30#\\x00\\x13\\x00\\xf3\" | 1245427 | ------------------------------------------------------\/ The schema has the following invariants: (1) The decoded field values are order-preserved. For read, the field values will be decoded in sorted mode from the raw bytes. (2) Every field in the schema must specify a non-empty name. (3) Every field must specify a type with an associated encoding. The type is limited to scalar types only: Array, Map, Aggregate, and Struct are not allowed. (4) The field names must not collide with existing column family names and reserved keywords \"/key\" and \"/timestamp\". The following update operations are allowed for row/key/schema: - Update from an empty schema to a new schema. - Remove the existing
      -- schema. This operation requires setting the @ignore_warnings@ flag to @true@, since it might be a backward incompatible change. Without the flag, the update request will fail with an INVALID_ARGUMENT error. Any other row key schema update operation (e.g. update existing schema columns names or types) is currently unsupported.
    , rowKeySchema :: (Core.Maybe GoogleBigtableAdminV2TypeStruct)
    ...
    , tieredStorageConfig :: (Core.Maybe TieredStorageConfig)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newTable 
    ::  Table
newTable
  = Table{automatedBackupPolicy = Core.Nothing,
          changeStreamConfig = Core.Nothing, clusterStates = Core.Nothing,
          columnFamilies = Core.Nothing, deletionProtection = Core.Nothing,
          granularity = Core.Nothing, name = Core.Nothing,
          restoreInfo = Core.Nothing, rowKeySchema = Core.Nothing,
          stats = Core.Nothing, tieredStorageConfig = Core.Nothing}
              ...
              (\ o ->
                 Table Core.<$>
                   (o Core..:? "automatedBackupPolicy") Core.<*>
                     ...
                     Core.<*> (o Core..:? "rowKeySchema")
                     Core.<*> (o Core..:? "stats")
                     Core.<*> (o Core..:? "tieredStorageConfig"))

instance Core.ToJSON Table where
        toJSON Table{..}
          = Core.object
              (Core.catMaybes
                 [("automatedBackupPolicy" Core..=) Core.<$> automatedBackupPolicy,
                  ("changeStreamConfig" Core..=) Core.<$> changeStreamConfig,
                  ...
                  ("rowKeySchema" Core..=) Core.<$> rowKeySchema,
                  ("stats" Core..=) Core.<$> stats,
                  ("tieredStorageConfig" Core..=) Core.<$> tieredStorageConfig])
...
instance Core.FromJSON Table_ClusterStates where
        parseJSON
          = Core.withObject "Table_ClusterStates"
              (\ o -> Table_ClusterStates Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Table_ClusterStates where
        toJSON Table_ClusterStates{..} = Core.toJSON additional
...
instance Core.FromJSON Table_ColumnFamilies where
        parseJSON
          = Core.withObject "Table_ColumnFamilies"
              (\ o -> Table_ColumnFamilies Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Table_ColumnFamilies where
        toJSON Table_ColumnFamilies{..} = Core.toJSON additional
...
newTableProgress 
    ::  TableProgress
newTableProgress
  = TableProgress{estimatedCopiedBytes = Core.Nothing,
                  estimatedSizeBytes = Core.Nothing, state = Core.Nothing}
...
instance Core.ToJSON TableProgress where
        toJSON TableProgress{..}
          = Core.object
              (Core.catMaybes
                 [("estimatedCopiedBytes" Core..=) Core.. Core.AsText Core.<$>
...
newTableStats 
    ::  TableStats
newTableStats
  = TableStats{averageCellsPerColumn = Core.Nothing,
               averageColumnsPerRow = Core.Nothing,
               logicalDataBytes = Core.Nothing, rowCount = Core.Nothing}
...
--
-- /See:/ 'newTieredStorageConfig' smart constructor.
newtype TieredStorageConfig = TieredStorageConfig
    {
      ...
      infrequentAccess :: (Core.Maybe TieredStorageRule)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'TieredStorageConfig' with the minimum fields required to make a request.
newTieredStorageConfig 
    ::  TieredStorageConfig
newTieredStorageConfig
  = TieredStorageConfig{infrequentAccess = Core.Nothing}
instance Core.FromJSON TieredStorageConfig where
        parseJSON
          = Core.withObject "TieredStorageConfig"
              (\ o ->
                 TieredStorageConfig Core.<$> (o Core..:? "infrequentAccess"))

instance Core.ToJSON TieredStorageConfig where
        toJSON TieredStorageConfig{..}
          = Core.object
              (Core.catMaybes
                 [("infrequentAccess" Core..=) Core.<$> infrequentAccess])


-- | Rule to specify what data is stored in a storage tier.
--
-- /See:/ 'newTieredStorageRule' smart constructor.
newtype TieredStorageRule = TieredStorageRule
    {
      -- | Include cells older than the given age. For the infrequent access tier, this value must be at least 30 days.
      includeIfOlderThan :: (Core.Maybe Core.Duration)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'TieredStorageRule' with the minimum fields required to make a request.
newTieredStorageRule 
    ::  TieredStorageRule
newTieredStorageRule
  = TieredStorageRule{includeIfOlderThan = Core.Nothing}
instance Core.FromJSON TieredStorageRule where
        parseJSON
          = Core.withObject "TieredStorageRule"
              (\ o ->
                 TieredStorageRule Core.<$> (o Core..:? "includeIfOlderThan"))

instance Core.ToJSON TieredStorageRule where
        toJSON TieredStorageRule{..}
          = Core.object
              (Core.catMaybes
                 [("includeIfOlderThan" Core..=) Core.<$> includeIfOlderThan])
...
newType 
    ::  Type
newType
  = Type{aggregateType = Core.Nothing, arrayType = Core.Nothing,
         boolType = Core.Nothing, bytesType = Core.Nothing,
         dateType = Core.Nothing, float32Type = Core.Nothing,
         float64Type = Core.Nothing, int64Type = Core.Nothing,
         mapType = Core.Nothing, stringType = Core.Nothing,
         structType = Core.Nothing, timestampType = Core.Nothing}
instance Core.FromJSON Type where
        parseJSON
          = Core.withObject "Type"
              (\ o ->
                 Type Core.<$>
                   (o Core..:? "aggregateType") Core.<*> (o Core..:? "arrayType")
...
newUndeleteTableMetadata 
    ::  UndeleteTableMetadata
newUndeleteTableMetadata
  = UndeleteTableMetadata{endTime = Core.Nothing,
...
newUpdateAuthorizedViewMetadata 
    ::  UpdateAuthorizedViewMetadata
newUpdateAuthorizedViewMetadata
  = UpdateAuthorizedViewMetadata{finishTime = Core.Nothing,
                                 originalRequest = Core.Nothing, requestTime = Core.Nothing}
instance Core.FromJSON UpdateAuthorizedViewMetadata where
        parseJSON
...
instance Core.ToJSON UpdateAuthorizedViewMetadata where
...
newUpdateAuthorizedViewRequest 
    ::  UpdateAuthorizedViewRequest
newUpdateAuthorizedViewRequest
  = UpdateAuthorizedViewRequest{authorizedView = Core.Nothing,
                                ignoreWarnings = Core.Nothing, updateMask = Core.Nothing}
instance Core.FromJSON UpdateAuthorizedViewRequest where
        parseJSON
...
instance Core.ToJSON UpdateAuthorizedViewRequest where
...
newUpdateClusterMetadata 
    ::  UpdateClusterMetadata
newUpdateClusterMetadata
  = UpdateClusterMetadata{finishTime = Core.Nothing,
                          originalRequest = Core.Nothing, requestTime = Core.Nothing}
...
newUpdateInstanceMetadata 
    ::  UpdateInstanceMetadata
newUpdateInstanceMetadata
  = UpdateInstanceMetadata{finishTime = Core.Nothing,
                           originalRequest = Core.Nothing, requestTime = Core.Nothing}
...
--
-- /See:/ 'newUpdateLogicalViewMetadata' smart constructor.
data UpdateLogicalViewMetadata = UpdateLogicalViewMetadata
    {
      -- | If set, the time at which this operation finished or was canceled.
      endTime :: (Core.Maybe Core.DateTime)
      -- | The request that prompted the initiation of this UpdateLogicalView operation.
    , originalRequest :: (Core.Maybe UpdateLogicalViewRequest)
      -- | The time at which this operation was started.
    , startTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'UpdateLogicalViewMetadata' with the minimum fields required to make a request.
newUpdateLogicalViewMetadata 
    ::  UpdateLogicalViewMetadata
newUpdateLogicalViewMetadata
  = UpdateLogicalViewMetadata{endTime = Core.Nothing,
                              originalRequest = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON UpdateLogicalViewMetadata where
        parseJSON
          = Core.withObject "UpdateLogicalViewMetadata"
              (\ o ->
                 UpdateLogicalViewMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "originalRequest")
                     Core.<*> (o Core..:? "startTime"))

instance Core.ToJSON UpdateLogicalViewMetadata where
        toJSON UpdateLogicalViewMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("endTime" Core..=) Core.<$> endTime,
                  ("originalRequest" Core..=) Core.<$> originalRequest,
...
--
-- /See:/ 'newUpdateLogicalViewRequest' smart constructor.
data UpdateLogicalViewRequest = UpdateLogicalViewRequest
    {
...
-- | Creates a value of 'UpdateLogicalViewRequest' with the minimum fields required to make a request.
newUpdateLogicalViewRequest 
    ::  UpdateLogicalViewRequest
newUpdateLogicalViewRequest
  = UpdateLogicalViewRequest{logicalView = Core.Nothing,
                             updateMask = Core.Nothing}
instance Core.FromJSON UpdateLogicalViewRequest where
        parseJSON
          = Core.withObject "UpdateLogicalViewRequest"
              (\ o ->
                 UpdateLogicalViewRequest Core.<$>
                   (o Core..:? "logicalView") Core.<*> (o Core..:? "updateMask"))

instance Core.ToJSON UpdateLogicalViewRequest where
        toJSON UpdateLogicalViewRequest{..}
          = Core.object
              (Core.catMaybes
                 [("logicalView" Core..=) Core.<$> logicalView,
                  ("updateMask" Core..=) Core.<$> updateMask])
...
newUpdateTableMetadata 
    ::  UpdateTableMetadata
newUpdateTableMetadata
  = UpdateTableMetadata{endTime = Core.Nothing, name = Core.Nothing,
                        startTime = Core.Nothing}
