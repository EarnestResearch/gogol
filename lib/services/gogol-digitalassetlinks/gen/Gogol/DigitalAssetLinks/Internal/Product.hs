...
newAndroidAppAsset 
    ::  AndroidAppAsset
newAndroidAppAsset
  = AndroidAppAsset{certificate = Core.Nothing,
          ...
          = Core.withObject "AndroidAppAsset"
              (\ o ->
                 AndroidAppAsset Core.<$>
                   (o Core..:? "certificate") Core.<*> (o Core..:? "packageName"))
...
instance Core.FromJSON Asset where
        parseJSON
          = Core.withObject "Asset"
              (\ o ->
                 Asset Core.<$>
                   (o Core..:? "androidApp") Core.<*> (o Core..:? "web"))
...
data BulkCheckRequest = BulkCheckRequest
    ...
    , returnRelationExtensions :: (Core.Maybe Core.Bool)
...
newBulkCheckRequest 
    ::  BulkCheckRequest
newBulkCheckRequest
  = BulkCheckRequest{defaultRelation = Core.Nothing,
                     defaultSource = Core.Nothing, defaultTarget = Core.Nothing,
                     returnRelationExtensions = Core.Nothing, statements = Core.Nothing}
instance Core.FromJSON BulkCheckRequest where
        parseJSON
          = Core.withObject "BulkCheckRequest"
              (\ o ->
                 BulkCheckRequest Core.<$>
                   (o Core..:? "defaultRelation") Core.<*>
                     (o Core..:? "defaultSource")
                     Core.<*> (o Core..:? "defaultTarget")
                     Core.<*> (o Core..:? "returnRelationExtensions")
          ...
          = Core.object
              (Core.catMaybes
                 [("defaultRelation" Core..=) Core.<$> defaultRelation,
                  ...
                  ("returnRelationExtensions" Core..=) Core.<$>
...
newBulkCheckResponse 
    ::  BulkCheckResponse
newBulkCheckResponse
  = BulkCheckResponse{bulkErrorCode = Core.Nothing,
          ...
          = Core.withObject "BulkCheckResponse"
              (\ o ->
                 BulkCheckResponse Core.<$>
                   (o Core..:? "bulkErrorCode") Core.<*> (o Core..:? "checkResults"))
...
newCertificateInfo 
    ::  CertificateInfo
newCertificateInfo
  = CertificateInfo{sha256Fingerprint = Core.Nothing}
instance Core.FromJSON CertificateInfo where
        parseJSON
          = Core.withObject "CertificateInfo"
              (\ o -> CertificateInfo Core.<$> (o Core..:? "sha256Fingerprint"))
...
data CheckResponse = CheckResponse
    ...
    , relationExtensions :: (Core.Maybe [CheckResponse_RelationExtensionsItem])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newCheckResponse 
    ::  CheckResponse
newCheckResponse
  = CheckResponse{debugString = Core.Nothing,
                  errorCode = Core.Nothing, linked = Core.Nothing,
                  maxAge = Core.Nothing, relationExtensions = Core.Nothing}
instance Core.FromJSON CheckResponse where
        parseJSON
          = Core.withObject "CheckResponse"
              (\ o ->
                 CheckResponse Core.<$>
                   (o Core..:? "debugString") Core.<*> (o Core..:? "errorCode")
                     Core.<*> (o Core..:? "linked")
                     Core.<*> (o Core..:? "maxAge")
                     Core.<*> (o Core..:? "relationExtensions"))
          ...
          = Core.object
              (Core.catMaybes
                 [("debugString" Core..=) Core.<$> debugString,
                  ...
                  ("relationExtensions" Core..=) Core.<$> relationExtensions])


--
-- /See:/ 'newCheckResponse_RelationExtensionsItem' smart constructor.
newtype CheckResponse_RelationExtensionsItem = CheckResponse_RelationExtensionsItem
    {
...
-- | Creates a value of 'CheckResponse_RelationExtensionsItem' with the minimum fields required to make a request.
newCheckResponse_RelationExtensionsItem 
    :: 
                                        Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. See 'additional'.
    -> CheckResponse_RelationExtensionsItem
newCheckResponse_RelationExtensionsItem additional
  = CheckResponse_RelationExtensionsItem{additional = additional}
instance Core.FromJSON CheckResponse_RelationExtensionsItem where
        parseJSON
          = Core.withObject "CheckResponse_RelationExtensionsItem"
              (\ o ->
                 CheckResponse_RelationExtensionsItem Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON CheckResponse_RelationExtensionsItem where
        toJSON CheckResponse_RelationExtensionsItem{..}
...
newListResponse 
    ::  ListResponse
newListResponse
  = ListResponse{debugString = Core.Nothing,
                 errorCode = Core.Nothing, maxAge = Core.Nothing,
...
data Statement = Statement
    {
      ...
      -- | Statements may specify relation level extensions\/payloads to express more details when declaring permissions to grant from the source asset to the target asset. These relation extensions should be specified in the @relation_extensions@ object, keyed by the relation type they\'re associated with. { relation: [\"delegate/permission\/common.handle/all/urls\"], target: {...}, relation/extensions: { \"delegate/permission\/common.handle/all/urls\": { ...handle/all/urls specific payload specified here... } } } When requested, and specified in the statement file, the API will return relation/extensions associated with the statement\'s relation type. i.e. the API will only return relation/extensions specified for \"delegate/permission\/common.handle/all/urls\" if this statement object\'s relation type is \"delegate/permission\/common.handle/all_urls\".
    , relationExtensions :: (Core.Maybe Statement_RelationExtensions)
...
newStatement 
    ::  Statement
newStatement
  = Statement{relation = Core.Nothing,
              relationExtensions = Core.Nothing, source = Core.Nothing,
              target = Core.Nothing}
instance Core.FromJSON Statement where
        parseJSON
          = Core.withObject "Statement"
              (\ o ->
                 Statement Core.<$>
                   (o Core..:? "relation") Core.<*> (o Core..:? "relationExtensions")
                     Core.<*> (o Core..:? "source")
                     Core.<*> (o Core..:? "target"))
...
-- | Statements may specify relation level extensions\/payloads to express more details when declaring permissions to grant from the source asset to the target asset. These relation extensions should be specified in the @relation_extensions@ object, keyed by the relation type they\'re associated with. { relation: [\"delegate/permission\/common.handle/all/urls\"], target: {...}, relation/extensions: { \"delegate/permission\/common.handle/all/urls\": { ...handle/all/urls specific payload specified here... } } } When requested, and specified in the statement file, the API will return relation/extensions associated with the statement\'s relation type. i.e. the API will only return relation/extensions specified for \"delegate/permission\/common.handle/all/urls\" if this statement object\'s relation type is \"delegate/permission\/common.handle/all_urls\".
--
-- /See:/ 'newStatement_RelationExtensions' smart constructor.
newtype Statement_RelationExtensions = Statement_RelationExtensions
    {
      -- | Properties of the object.
      additional :: (Core.HashMap Core.Text Core.Value)
    }
...
-- | Creates a value of 'Statement_RelationExtensions' with the minimum fields required to make a request.
newStatement_RelationExtensions 
    :: 
                                Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. See 'additional'.
    -> Statement_RelationExtensions
newStatement_RelationExtensions additional
  = Statement_RelationExtensions{additional = additional}
instance Core.FromJSON Statement_RelationExtensions where
        parseJSON
          = Core.withObject "Statement_RelationExtensions"
              (\ o ->
                 Statement_RelationExtensions Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Statement_RelationExtensions where
        toJSON Statement_RelationExtensions{..} = Core.toJSON additional
...
newStatementTemplate 
    ::  StatementTemplate
newStatementTemplate
  = StatementTemplate{relation = Core.Nothing, source = Core.Nothing,
                      target = Core.Nothing}
          ...
          = Core.withObject "StatementTemplate"
              (\ o ->
                 StatementTemplate Core.<$>
                   (o Core..:? "relation") Core.<*> (o Core..:? "source") Core.<*>
                     (o Core..:? "target"))
...
instance Core.ToJSON WebAsset where
        toJSON WebAsset{..}
          = Core.object (Core.catMaybes [("site" Core..=) Core.<$> site])
