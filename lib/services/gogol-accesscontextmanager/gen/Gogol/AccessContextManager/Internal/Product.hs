...
instance Core.FromJSON AccessContextManagerOperationMetadata where
        parseJSON
          = Core.withObject "AccessContextManagerOperationMetadata"
...
newAccessPolicy 
    ::  AccessPolicy
newAccessPolicy
  = AccessPolicy{etag = Core.Nothing, name = Core.Nothing,
                 parent = Core.Nothing, scopes = Core.Nothing, title = Core.Nothing}
...
newAccessSettings 
    ::  AccessSettings
newAccessSettings
  = AccessSettings{accessLevels = Core.Nothing,
...
newApiOperation 
    ::  ApiOperation
newApiOperation
  = ApiOperation{methodSelectors = Core.Nothing,
                 serviceName = Core.Nothing}
instance Core.FromJSON ApiOperation where
        parseJSON
          = Core.withObject "ApiOperation"
              (\ o ->
                 ApiOperation Core.<$>
...
instance Core.FromJSON Application where
        parseJSON
          = Core.withObject "Application"
              (\ o ->
                 Application Core.<$>
                   (o Core..:? "clientId") Core.<*> (o Core..:? "name"))
...
newAuthorizedOrgsDesc 
    ::  AuthorizedOrgsDesc
newAuthorizedOrgsDesc
  = AuthorizedOrgsDesc{assetType = Core.Nothing,
                       authorizationDirection = Core.Nothing,
                       authorizationType = Core.Nothing, name = Core.Nothing,
                       orgs = Core.Nothing}
instance Core.FromJSON AuthorizedOrgsDesc where
        parseJSON
          = Core.withObject "AuthorizedOrgsDesc"
              (\ o ->
                 AuthorizedOrgsDesc Core.<$>
                   (o Core..:? "assetType") Core.<*>
                     (o Core..:? "authorizationDirection")
          ...
          = Core.object
              (Core.catMaybes
                 [("assetType" Core..=) Core.<$> assetType,
                  ...
                  ("name" Core..=) Core.<$> name, ("orgs" Core..=) Core.<$> orgs])
...
newBasicLevel 
    ::  BasicLevel
newBasicLevel
  = BasicLevel{combiningFunction = Core.Nothing,
               conditions = Core.Nothing}
instance Core.FromJSON BasicLevel where
        parseJSON
          = Core.withObject "BasicLevel"
              (\ o ->
                 BasicLevel Core.<$>
...
instance Core.ToJSON ClientScope where
        toJSON ClientScope{..}
          = Core.object
              (Core.catMaybes
                 [("restrictedClientApplication" Core..=) Core.<$>
...
instance Core.FromJSON CommitServicePerimetersRequest where
        parseJSON
          = Core.withObject "CommitServicePerimetersRequest"
              (\ o ->
...
instance Core.FromJSON CommitServicePerimetersResponse where
        parseJSON
          = Core.withObject "CommitServicePerimetersResponse"
              (\ o ->
                 CommitServicePerimetersResponse Core.<$>
                   (o Core..:? "servicePerimeters"))
...
newCondition 
    ::  Condition
newCondition
  = Condition{devicePolicy = Core.Nothing,
              ipSubnetworks = Core.Nothing, members = Core.Nothing,
              negate = Core.Nothing, regions = Core.Nothing,
...
newDevicePolicy 
    ::  DevicePolicy
newDevicePolicy
  = DevicePolicy{allowedDeviceManagementLevels = Core.Nothing,
                 allowedEncryptionStatuses = Core.Nothing,
                 osConstraints = Core.Nothing, requireAdminApproval = Core.Nothing,
                 requireCorpOwned = Core.Nothing, requireScreenlock = Core.Nothing}
instance Core.FromJSON DevicePolicy where
        parseJSON
          = Core.withObject "DevicePolicy"
              (\ o ->
                 DevicePolicy Core.<$>
...
newEgressFrom 
    ::  EgressFrom
newEgressFrom
  = EgressFrom{identities = Core.Nothing,
               identityType = Core.Nothing, sourceRestriction = Core.Nothing,
               sources = Core.Nothing}
instance Core.FromJSON EgressFrom where
        parseJSON
          = Core.withObject "EgressFrom"
              (\ o ->
                 EgressFrom Core.<$>
...
newEgressTo 
    ::  EgressTo
newEgressTo
  = EgressTo{externalResources = Core.Nothing,
             operations = Core.Nothing, resources = Core.Nothing,
             roles = Core.Nothing}
instance Core.FromJSON EgressTo where
        parseJSON
          = Core.withObject "EgressTo"
              (\ o ->
                 EgressTo Core.<$>
...
newGcpUserAccessBinding 
    ::  GcpUserAccessBinding
newGcpUserAccessBinding
  = GcpUserAccessBinding{accessLevels = Core.Nothing,
                         dryRunAccessLevels = Core.Nothing, groupKey = Core.Nothing,
                         name = Core.Nothing, restrictedClientApplications = Core.Nothing,
                         scopedAccessSettings = Core.Nothing,
                         sessionSettings = Core.Nothing}
instance Core.FromJSON GcpUserAccessBinding where
        parseJSON
          = Core.withObject "GcpUserAccessBinding"
              (\ o ->
                 GcpUserAccessBinding Core.<$>
                   (o Core..:? "accessLevels") Core.<*>
                     (o Core..:? "dryRunAccessLevels")
          ...
          = Core.object
              (Core.catMaybes
                 [("accessLevels" Core..=) Core.<$> accessLevels,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("restrictedClientApplications" Core..=) Core.<$>
...
instance Core.FromJSON GcpUserAccessBindingOperationMetadata where
        parseJSON
          = Core.withObject "GcpUserAccessBindingOperationMetadata"
...
newIngressFrom 
    ::  IngressFrom
newIngressFrom
  = IngressFrom{identities = Core.Nothing,
                identityType = Core.Nothing, sources = Core.Nothing}
instance Core.FromJSON IngressFrom where
        parseJSON
          = Core.withObject "IngressFrom"
              (\ o ->
                 IngressFrom Core.<$>
                   (o Core..:? "identities") Core.<*> (o Core..:? "identityType")
                     Core.<*> (o Core..:? "sources"))
...
newIngressPolicy 
    ::  IngressPolicy
newIngressPolicy
  = IngressPolicy{ingressFrom = Core.Nothing,
                  ingressTo = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON IngressPolicy where
        parseJSON
          = Core.withObject "IngressPolicy"
              (\ o ->
                 IngressPolicy Core.<$>
...
newIngressSource 
    ::  IngressSource
newIngressSource
  = IngressSource{accessLevel = Core.Nothing,
                  resource = Core.Nothing}
instance Core.FromJSON IngressSource where
        parseJSON
          = Core.withObject "IngressSource"
              (\ o ->
                 IngressSource Core.<$>
                   (o Core..:? "accessLevel") Core.<*> (o Core..:? "resource"))
...
newListAccessLevelsResponse 
    ::  ListAccessLevelsResponse
newListAccessLevelsResponse
  = ListAccessLevelsResponse{accessLevels = Core.Nothing,
                             nextPageToken = Core.Nothing}
instance Core.FromJSON ListAccessLevelsResponse where
        parseJSON
          = Core.withObject "ListAccessLevelsResponse"
              (\ o ->
                 ListAccessLevelsResponse Core.<$>
                   (o Core..:? "accessLevels") Core.<*> (o Core..:? "nextPageToken"))
...
newListAccessPoliciesResponse 
    ::  ListAccessPoliciesResponse
newListAccessPoliciesResponse
  = ListAccessPoliciesResponse{accessPolicies = Core.Nothing,
                               nextPageToken = Core.Nothing}
instance Core.FromJSON ListAccessPoliciesResponse where
        parseJSON
          = Core.withObject "ListAccessPoliciesResponse"
              (\ o ->
                 ListAccessPoliciesResponse Core.<$>
                   (o Core..:? "accessPolicies") Core.<*>
...
newListAuthorizedOrgsDescsResponse 
    :: 
                                   ListAuthorizedOrgsDescsResponse
newListAuthorizedOrgsDescsResponse
  = ListAuthorizedOrgsDescsResponse{authorizedOrgsDescs =
                                      Core.Nothing,
                                    nextPageToken = Core.Nothing}
instance Core.FromJSON ListAuthorizedOrgsDescsResponse where
        parseJSON
          = Core.withObject "ListAuthorizedOrgsDescsResponse"
              (\ o ->
                 ListAuthorizedOrgsDescsResponse Core.<$>
                   (o Core..:? "authorizedOrgsDescs") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListGcpUserAccessBindingsResponse where
        parseJSON
          = Core.withObject "ListGcpUserAccessBindingsResponse"
              (\ o ->
                 ListGcpUserAccessBindingsResponse Core.<$>
                   (o Core..:? "gcpUserAccessBindings") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListServicePerimetersResponse 
    ::  ListServicePerimetersResponse
newListServicePerimetersResponse
  = ListServicePerimetersResponse{nextPageToken = Core.Nothing,
                                  servicePerimeters = Core.Nothing}
instance Core.FromJSON ListServicePerimetersResponse where
        parseJSON
          = Core.withObject "ListServicePerimetersResponse"
              (\ o ->
                 ListServicePerimetersResponse Core.<$>
...
newListSupportedServicesResponse 
    ::  ListSupportedServicesResponse
newListSupportedServicesResponse
  = ListSupportedServicesResponse{nextPageToken = Core.Nothing,
                                  supportedServices = Core.Nothing}
instance Core.FromJSON ListSupportedServicesResponse where
        parseJSON
          = Core.withObject "ListSupportedServicesResponse"
              (\ o ->
                 ListSupportedServicesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "supportedServices"))
...
instance Core.FromJSON MethodSelector where
        parseJSON
          = Core.withObject "MethodSelector"
              (\ o ->
                 MethodSelector Core.<$>
...
newOsConstraint 
    ::  OsConstraint
newOsConstraint
  = OsConstraint{minimumVersion = Core.Nothing,
                 osType = Core.Nothing, requireVerifiedChromeOs = Core.Nothing}
instance Core.FromJSON OsConstraint where
        parseJSON
          = Core.withObject "OsConstraint"
              (\ o ->
                 OsConstraint Core.<$>
...
newReplaceAccessLevelsRequest 
    ::  ReplaceAccessLevelsRequest
newReplaceAccessLevelsRequest
  = ReplaceAccessLevelsRequest{accessLevels = Core.Nothing,
                               etag = Core.Nothing}
instance Core.FromJSON ReplaceAccessLevelsRequest where
        parseJSON
          = Core.withObject "ReplaceAccessLevelsRequest"
              (\ o ->
                 ReplaceAccessLevelsRequest Core.<$>
                   (o Core..:? "accessLevels") Core.<*> (o Core..:? "etag"))
...
instance Core.FromJSON ReplaceAccessLevelsResponse where
        parseJSON
          = Core.withObject "ReplaceAccessLevelsResponse"
              (\ o ->
...
newReplaceServicePerimetersRequest 
    :: 
                                   ReplaceServicePerimetersRequest
newReplaceServicePerimetersRequest
  = ReplaceServicePerimetersRequest{etag = Core.Nothing,
                                    servicePerimeters = Core.Nothing}
instance Core.FromJSON ReplaceServicePerimetersRequest where
        parseJSON
          = Core.withObject "ReplaceServicePerimetersRequest"
              (\ o ->
                 ReplaceServicePerimetersRequest Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "servicePerimeters"))
...
instance Core.FromJSON ReplaceServicePerimetersResponse where
        parseJSON
          = Core.withObject "ReplaceServicePerimetersResponse"
              (\ o ->
                 ReplaceServicePerimetersResponse Core.<$>
                   (o Core..:? "servicePerimeters"))
...
newScopedAccessSettings 
    ::  ScopedAccessSettings
newScopedAccessSettings
  = ScopedAccessSettings{activeSettings = Core.Nothing,
                         dryRunSettings = Core.Nothing, scope = Core.Nothing}
instance Core.FromJSON ScopedAccessSettings where
        parseJSON
          = Core.withObject "ScopedAccessSettings"
              (\ o ->
                 ScopedAccessSettings Core.<$>
                   (o Core..:? "activeSettings") Core.<*>
                     (o Core..:? "dryRunSettings")
                     Core.<*> (o Core..:? "scope"))
...
newServicePerimeter 
    ::  ServicePerimeter
newServicePerimeter
  = ServicePerimeter{description = Core.Nothing, etag = Core.Nothing,
                     name = Core.Nothing, perimeterType = Core.Nothing,
                     spec = Core.Nothing, status = Core.Nothing, title = Core.Nothing,
                     useExplicitDryRunSpec = Core.Nothing}
instance Core.FromJSON ServicePerimeter where
        parseJSON
          = Core.withObject "ServicePerimeter"
              (\ o ->
...
newServicePerimeterConfig 
    ::  ServicePerimeterConfig
newServicePerimeterConfig
  = ServicePerimeterConfig{accessLevels = Core.Nothing,
                           egressPolicies = Core.Nothing, ingressPolicies = Core.Nothing,
                           resources = Core.Nothing, restrictedServices = Core.Nothing,
                           vpcAccessibleServices = Core.Nothing}
instance Core.FromJSON ServicePerimeterConfig where
        parseJSON
          = Core.withObject "ServicePerimeterConfig"
              (\ o ->
                 ServicePerimeterConfig Core.<$>
...
newSessionSettings 
    ::  SessionSettings
newSessionSettings
  = SessionSettings{maxInactivity = Core.Nothing,
                    sessionLength = Core.Nothing, sessionLengthEnabled = Core.Nothing,
                    sessionReauthMethod = Core.Nothing, useOidcMaxAge = Core.Nothing}
instance Core.FromJSON SessionSettings where
        parseJSON
          = Core.withObject "SessionSettings"
              (\ o ->
                 SessionSettings Core.<$>
                   (o Core..:? "maxInactivity") Core.<*> (o Core..:? "sessionLength")
...
newSupportedService 
    ::  SupportedService
newSupportedService
  = SupportedService{availableOnRestrictedVip = Core.Nothing,
                     knownLimitations = Core.Nothing, name = Core.Nothing,
                     serviceSupportStage = Core.Nothing, supportStage = Core.Nothing,
                     supportedMethods = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON SupportedService where
        parseJSON
          = Core.withObject "SupportedService"
              (\ o ->
                 SupportedService Core.<$>
                   (o Core..:? "availableOnRestrictedVip") Core.<*>
                     (o Core..:? "knownLimitations")
                     Core.<*> (o Core..:? "name")
...
instance Core.ToJSON SupportedService where
        toJSON SupportedService{..}
          = Core.object
              (Core.catMaybes
                 [("availableOnRestrictedVip" Core..=) Core.<$>
...
newVpcAccessibleServices 
    ::  VpcAccessibleServices
newVpcAccessibleServices
  = VpcAccessibleServices{allowedServices = Core.Nothing,
                          enableRestriction = Core.Nothing}
instance Core.FromJSON VpcAccessibleServices where
        parseJSON
          = Core.withObject "VpcAccessibleServices"
              (\ o ->
...
instance Core.FromJSON VpcNetworkSource where
        parseJSON
          = Core.withObject "VpcNetworkSource"
