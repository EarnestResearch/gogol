...
instance Core.FromJSON AccessLevel where
        parseJSON
          = Core.withObject "AccessLevel"
              (\ o ->
                 AccessLevel Core.<$>
                   (o Core..:? "basic") Core.<*> (o Core..:? "custom")
          ...
          = Core.object
              (Core.catMaybes
                 [("assetType" Core..=) Core.<$> assetType,
                  ("authorizationDirection" Core..=) Core.<$>
                    authorizationDirection,
                  ("authorizationType" Core..=) Core.<$>
                    authorizationType,
                  ("name" Core..=) Core.<$> name,
                  ("orgs" Core..=) Core.<$> orgs])
...
instance Core.FromJSON CommitServicePerimetersRequest
         where
        parseJSON
          = Core.withObject "CommitServicePerimetersRequest"
              (\ o ->
                 CommitServicePerimetersRequest Core.<$>
                   (o Core..:? "etag"))

instance Core.ToJSON CommitServicePerimetersRequest
         where
...
instance Core.ToJSON CommitServicePerimetersResponse
         where
        toJSON CommitServicePerimetersResponse{..}
          = Core.object
              (Core.catMaybes
                 [("servicePerimeters" Core..=) Core.<$>
                    servicePerimeters])
...
instance Core.FromJSON Condition where
        parseJSON
          = Core.withObject "Condition"
              (\ o ->
                 Condition Core.<$>
                   (o Core..:? "devicePolicy") Core.<*>
                     (o Core..:? "ipSubnetworks")
                     Core.<*> (o Core..:? "members")
                     Core.<*> (o Core..:? "negate")
                     Core.<*> (o Core..:? "regions")
          ...
          = Core.object
              (Core.catMaybes
                 [("devicePolicy" Core..=) Core.<$> devicePolicy,
                  ...
                  ("requiredAccessLevels" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("allowedDeviceManagementLevels" Core..=) Core.<$>
                  ...
                  ("requireAdminApproval" Core..=) Core.<$>
                    requireAdminApproval,
                  ("requireCorpOwned" Core..=) Core.<$>
                    requireCorpOwned,
                  ("requireScreenlock" Core..=) Core.<$>
                    requireScreenlock])
...
newListAccessLevelsResponse =
  ListAccessLevelsResponse
    {accessLevels = Core.Nothing, nextPageToken = Core.Nothing}
...
newListAccessPoliciesResponse =
  ListAccessPoliciesResponse
    {accessPolicies = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListAccessPoliciesResponse
         where
        parseJSON
...
newListAuthorizedOrgsDescsResponse =
  ListAuthorizedOrgsDescsResponse
    {authorizedOrgsDescs = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.ToJSON ListAuthorizedOrgsDescsResponse
         where
        toJSON ListAuthorizedOrgsDescsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("authorizedOrgsDescs" Core..=) Core.<$>
                    authorizedOrgsDescs,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListGcpUserAccessBindingsResponse =
  ListGcpUserAccessBindingsResponse
    {gcpUserAccessBindings = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON ListGcpUserAccessBindingsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("gcpUserAccessBindings" Core..=) Core.<$>
...
newListServicePerimetersResponse =
  ListServicePerimetersResponse
    {nextPageToken = Core.Nothing, servicePerimeters = Core.Nothing}

instance Core.FromJSON ListServicePerimetersResponse
         where
        parseJSON
...
instance Core.ToJSON ListServicePerimetersResponse
         where
...
instance Core.FromJSON ReplaceAccessLevelsRequest
         where
        parseJSON
...
instance Core.FromJSON ReplaceAccessLevelsResponse
         where
        parseJSON
          = Core.withObject "ReplaceAccessLevelsResponse"
              (\ o ->
                 ReplaceAccessLevelsResponse Core.<$>
                   (o Core..:? "accessLevels"))

instance Core.ToJSON ReplaceAccessLevelsResponse
         where
...
newReplaceServicePerimetersRequest =
  ReplaceServicePerimetersRequest
    {etag = Core.Nothing, servicePerimeters = Core.Nothing}
...
instance Core.ToJSON ReplaceServicePerimetersRequest
         where
...
instance Core.ToJSON ReplaceServicePerimetersResponse
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ...
                  ("title" Core..=) Core.<$> title,
                  ("useExplicitDryRunSpec" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("accessLevels" Core..=) Core.<$> accessLevels,
                  ...
                  ("resources" Core..=) Core.<$> resources,
                  ("restrictedServices" Core..=) Core.<$>
                    restrictedServices,
                  ("vpcAccessibleServices" Core..=) Core.<$>
                    vpcAccessibleServices])
...
newVpcAccessibleServices =
  VpcAccessibleServices
    {allowedServices = Core.Nothing, enableRestriction = Core.Nothing}
...
instance Core.ToJSON VpcAccessibleServices where
        toJSON VpcAccessibleServices{..}
          = Core.object
              (Core.catMaybes
                 [("allowedServices" Core..=) Core.<$>
                    allowedServices,
                  ("enableRestriction" Core..=) Core.<$>
                    enableRestriction])
