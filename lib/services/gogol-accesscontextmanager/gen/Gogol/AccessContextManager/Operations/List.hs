...
newAccessContextManagerOperationsList name
  = AccessContextManagerOperationsList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       filter = Core.Nothing, name = name, pageSize = Core.Nothing,
                                       pageToken = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AccessContextManagerOperationsList
         where
        type Rs AccessContextManagerOperationsList = ListOperationsResponse
        type Scopes AccessContextManagerOperationsList =
        ...
        requestClient AccessContextManagerOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessContextManagerOperationsListResource)
                      Core.mempty
