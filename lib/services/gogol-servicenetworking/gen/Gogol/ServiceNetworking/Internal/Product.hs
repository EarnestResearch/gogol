...
instance Core.FromJSON AddDnsRecordSetMetadata where
        parseJSON
          = Core.withObject "AddDnsRecordSetMetadata"
...
newAddDnsRecordSetRequest 
    ::  AddDnsRecordSetRequest
newAddDnsRecordSetRequest
  = AddDnsRecordSetRequest{consumerNetwork = Core.Nothing,
                           dnsRecordSet = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON AddDnsRecordSetRequest where
        parseJSON
          = Core.withObject "AddDnsRecordSetRequest"
              (\ o ->
                 AddDnsRecordSetRequest Core.<$>
                   (o Core..:? "consumerNetwork") Core.<*> (o Core..:? "dnsRecordSet")
                     Core.<*> (o Core..:? "zone"))
...
instance Core.FromJSON AddDnsZoneMetadata where
        parseJSON
          = Core.withObject "AddDnsZoneMetadata"
...
newAddDnsZoneRequest 
    ::  AddDnsZoneRequest
newAddDnsZoneRequest
  = AddDnsZoneRequest{consumerNetwork = Core.Nothing,
                      dnsSuffix = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON AddDnsZoneRequest where
        parseJSON
          = Core.withObject "AddDnsZoneRequest"
              (\ o ->
                 AddDnsZoneRequest Core.<$>
                   (o Core..:? "consumerNetwork") Core.<*> (o Core..:? "dnsSuffix")
                     Core.<*> (o Core..:? "name"))
...
newAddDnsZoneResponse 
    ::  AddDnsZoneResponse
newAddDnsZoneResponse
  = AddDnsZoneResponse{consumerPeeringZone = Core.Nothing,
                       producerPrivateZone = Core.Nothing}
instance Core.FromJSON AddDnsZoneResponse where
        parseJSON
          = Core.withObject "AddDnsZoneResponse"
              (\ o ->
                 AddDnsZoneResponse Core.<$>
                   (o Core..:? "consumerPeeringZone") Core.<*>
                     (o Core..:? "producerPrivateZone"))

instance Core.ToJSON AddDnsZoneResponse where
        toJSON AddDnsZoneResponse{..}
          = Core.object
              (Core.catMaybes
                 [("consumerPeeringZone" Core..=) Core.<$> consumerPeeringZone,
                  ("producerPrivateZone" Core..=) Core.<$> producerPrivateZone])
...
instance Core.FromJSON AddRolesMetadata where
        parseJSON
          = Core.withObject "AddRolesMetadata"
...
newAddRolesRequest 
    ::  AddRolesRequest
newAddRolesRequest
  = AddRolesRequest{consumerNetwork = Core.Nothing,
                    policyBinding = Core.Nothing}
instance Core.FromJSON AddRolesRequest where
        parseJSON
          = Core.withObject "AddRolesRequest"
              (\ o ->
                 AddRolesRequest Core.<$>
                   (o Core..:? "consumerNetwork") Core.<*>
                     (o Core..:? "policyBinding"))
...
newAddRolesResponse 
    ::  AddRolesResponse
newAddRolesResponse
  = AddRolesResponse{policyBinding = Core.Nothing}
instance Core.FromJSON AddRolesResponse where
        parseJSON
          = Core.withObject "AddRolesResponse"
              (\ o -> AddRolesResponse Core.<$> (o Core..:? "policyBinding"))

instance Core.ToJSON AddRolesResponse where
        toJSON AddRolesResponse{..}
          = Core.object
              (Core.catMaybes [("policyBinding" Core..=) Core.<$> policyBinding])
...
data AddSubnetworkRequest = AddSubnetworkRequest
    ...
    , description :: (Core.Maybe Core.Text)
      -- | Optional. The url of an Internal Range. Eg: @projects\/\/locations\/global\/internalRanges\/@. If specified, it means that the subnetwork cidr will be created using the combination of requested/address\/ip/prefix_length. Note that the subnet cidr has to be within the cidr range of this Internal Range.
    , internalRange :: (Core.Maybe Core.Text)
    ...
    , purpose :: (Core.Maybe Core.Text)
      -- | Required. The name of a <https://cloud.google.com/compute/docs/regions-zones region> for the subnet, such @europe-west1@.
    ...
    , secondaryIpRangeSpecs :: (Core.Maybe [SecondaryIpRangeSpec])
      -- | Optional. Skips validating if the requested/address is in use by SN VPC’s peering group. Compute Engine will still perform this check and fail the request if the requested/address is in use. Note that Compute Engine does not check for the existence of dynamic routes when performing this check. Caller of this API should make sure that there are no dynamic routes overlapping with the requested/address\/prefix/length IP address range otherwise the created subnet could cause misrouting.
    , skipRequestedAddressValidation :: (Core.Maybe Core.Bool)
      -- | Required. A name for the new subnet. For information about the naming requirements, see <https://cloud.google.com/compute/docs/reference/rest/v1/subnetworks subnetwork> in the Compute API documentation.
    ...
    , subnetworkUsers :: (Core.Maybe [Core.Text])
      -- | Optional. Specifies if Service Networking should use a custom time bucket for GCE idempotency. If false, Service Networking uses a 300 second (5 minute) GCE idempotency window. If true, Service Networking uses a custom idempotency window provided by the user in field compute/idempotency/window.
...
newAddSubnetworkRequest 
    ::  AddSubnetworkRequest
newAddSubnetworkRequest
  = AddSubnetworkRequest{allowSubnetCidrRoutesOverlap = Core.Nothing,
                         checkServiceNetworkingUsePermission = Core.Nothing,
                         computeIdempotencyWindow = Core.Nothing, consumer = Core.Nothing,
                         consumerNetwork = Core.Nothing, description = Core.Nothing,
                         internalRange = Core.Nothing, ipPrefixLength = Core.Nothing,
                         outsideAllocationPublicIpRange = Core.Nothing,
                         privateIpv6GoogleAccess = Core.Nothing, purpose = Core.Nothing,
                         region = Core.Nothing, requestedAddress = Core.Nothing,
                         requestedRanges = Core.Nothing, role' = Core.Nothing,
                         secondaryIpRangeSpecs = Core.Nothing,
                         skipRequestedAddressValidation = Core.Nothing,
                         subnetwork = Core.Nothing, subnetworkUsers = Core.Nothing,
                         useCustomComputeIdempotencyWindow = Core.Nothing}
instance Core.FromJSON AddSubnetworkRequest where
        parseJSON
          = Core.withObject "AddSubnetworkRequest"
              (\ o ->
                 AddSubnetworkRequest Core.<$>
                   (o Core..:? "allowSubnetCidrRoutesOverlap") Core.<*>
                     (o Core..:? "checkServiceNetworkingUsePermission")
                     Core.<*> (o Core..:? "computeIdempotencyWindow")
                     Core.<*> (o Core..:? "consumer")
                     Core.<*> (o Core..:? "consumerNetwork")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "internalRange")
                     ...
                     Core.<*> (o Core..:? "skipRequestedAddressValidation")
...
--
-- /See:/ 'newCleanupConnectionMetadata' smart constructor.
data CleanupConnectionMetadata = CleanupConnectionMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CleanupConnectionMetadata' with the minimum fields required to make a request.
newCleanupConnectionMetadata 
    ::  CleanupConnectionMetadata
newCleanupConnectionMetadata = CleanupConnectionMetadata
instance Core.FromJSON CleanupConnectionMetadata where
        parseJSON
          = Core.withObject "CleanupConnectionMetadata"
              (\ o -> Core.pure CleanupConnectionMetadata)

instance Core.ToJSON CleanupConnectionMetadata where
        toJSON = Core.const Core.emptyObject
...
newCloudSQLConfig 
    ::  CloudSQLConfig
newCloudSQLConfig
  = CloudSQLConfig{service = Core.Nothing,
                   umbrellaNetwork = Core.Nothing, umbrellaProject = Core.Nothing}
instance Core.FromJSON CloudSQLConfig where
        parseJSON
          = Core.withObject "CloudSQLConfig"
              (\ o ->
                 CloudSQLConfig Core.<$>
                   (o Core..:? "service") Core.<*> (o Core..:? "umbrellaNetwork")
                     Core.<*>
                     (o Core..:? "umbrellaProject" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("service" Core..=) Core.<$> service,
                  ...
                  ("umbrellaProject" Core..=) Core.. Core.AsText Core.<$>
                    umbrellaProject])
...
newConnection 
    ::  Connection
newConnection
  = Connection{network = Core.Nothing, peering = Core.Nothing,
               reservedPeeringRanges = Core.Nothing, service = Core.Nothing}
instance Core.FromJSON Connection where
        parseJSON
          = Core.withObject "Connection"
              (\ o ->
                 Connection Core.<$>
                   (o Core..:? "network") Core.<*> (o Core..:? "peering") Core.<*>
                     (o Core..:? "reservedPeeringRanges")
                     Core.<*> (o Core..:? "service"))
          ...
          = Core.object
              (Core.catMaybes
                 [("network" Core..=) Core.<$> network,
                  ...
                  ("reservedPeeringRanges" Core..=) Core.<$> reservedPeeringRanges,
                  ("service" Core..=) Core.<$> service])
...
newConsumerConfig 
    ::  ConsumerConfig
newConsumerConfig
  = ConsumerConfig{cloudsqlConfigs = Core.Nothing,
                   ...
                   producerNetwork = Core.Nothing, reservedRanges = Core.Nothing,
                   usedIpRanges = Core.Nothing,
                   vpcScReferenceArchitectureEnabled = Core.Nothing}
instance Core.FromJSON ConsumerConfig where
        parseJSON
          = Core.withObject "ConsumerConfig"
              (\ o ->
                 ConsumerConfig Core.<$>
                   (o Core..:? "cloudsqlConfigs") Core.<*>
                     (o Core..:? "consumerExportCustomRoutes")
...
instance Core.ToJSON ConsumerConfig where
        toJSON ConsumerConfig{..}
          = Core.object
              (Core.catMaybes
                 [("cloudsqlConfigs" Core..=) Core.<$> cloudsqlConfigs,
                  ("consumerExportCustomRoutes" Core..=) Core.<$>
                    consumerExportCustomRoutes,
                  ("consumerExportSubnetRoutesWithPublicIp" Core..=) Core.<$>
                    consumerExportSubnetRoutesWithPublicIp,
                  ("consumerImportCustomRoutes" Core..=) Core.<$>
                    consumerImportCustomRoutes,
                  ("consumerImportSubnetRoutesWithPublicIp" Core..=) Core.<$>
                    consumerImportSubnetRoutesWithPublicIp,
                  ("producerExportCustomRoutes" Core..=) Core.<$>
                    producerExportCustomRoutes,
                  ("producerExportSubnetRoutesWithPublicIp" Core..=) Core.<$>
                    producerExportSubnetRoutesWithPublicIp,
                  ("producerImportCustomRoutes" Core..=) Core.<$>
                    producerImportCustomRoutes,
                  ("producerImportSubnetRoutesWithPublicIp" Core..=) Core.<$>
                  ...
                  ("vpcScReferenceArchitectureEnabled" Core..=) Core.<$>
...
instance Core.FromJSON ConsumerConfigMetadata where
        parseJSON
          = Core.withObject "ConsumerConfigMetadata"
...
instance Core.FromJSON ConsumerProject where
        parseJSON
          = Core.withObject "ConsumerProject"
              (\ o ->
                 ConsumerProject Core.<$>
                   (o Core..:? "projectNum" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON ConsumerProject where
        toJSON ConsumerProject{..}
          = Core.object
              (Core.catMaybes
                 [("projectNum" Core..=) Core.. Core.AsText Core.<$> projectNum])
...
instance Core.FromJSON DeleteConnectionMetadata where
        parseJSON
          = Core.withObject "DeleteConnectionMetadata"
...
instance Core.FromJSON DeleteConnectionRequest where
        parseJSON
          = Core.withObject "DeleteConnectionRequest"
              (\ o ->
                 DeleteConnectionRequest Core.<$> (o Core..:? "consumerNetwork"))
...
instance Core.FromJSON DeletePeeredDnsDomainMetadata where
        parseJSON
          = Core.withObject "DeletePeeredDnsDomainMetadata"
...
instance Core.FromJSON DisableVpcServiceControlsRequest where
        parseJSON
          = Core.withObject "DisableVpcServiceControlsRequest"
              (\ o ->
                 DisableVpcServiceControlsRequest Core.<$>
                   (o Core..:? "consumerNetwork"))
...
newDnsRecordSet 
    ::  DnsRecordSet
newDnsRecordSet
  = DnsRecordSet{data' = Core.Nothing, domain = Core.Nothing,
                 ttl = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON DnsRecordSet where
        parseJSON
          = Core.withObject "DnsRecordSet"
              (\ o ->
                 DnsRecordSet Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "domain") Core.<*>
                     (o Core..:? "ttl")
                     Core.<*> (o Core..:? "type"))
...
instance Core.ToJSON DnsRecordSet where
        toJSON DnsRecordSet{..}
          = Core.object
              (Core.catMaybes
                 [("data" Core..=) Core.<$> data',
                  ("domain" Core..=) Core.<$> domain, ("ttl" Core..=) Core.<$> ttl,
                  ("type" Core..=) Core.<$> type'])
...
instance Core.FromJSON DnsZone where
        parseJSON
          = Core.withObject "DnsZone"
              (\ o ->
                 DnsZone Core.<$>
                   (o Core..:? "dnsSuffix") Core.<*> (o Core..:? "name"))
...
--
-- /See:/ 'newDnsZonePair' smart constructor.
data DnsZonePair = DnsZonePair
    {
...
-- | Creates a value of 'DnsZonePair' with the minimum fields required to make a request.
newDnsZonePair 
    ::  DnsZonePair
newDnsZonePair
  = DnsZonePair{consumerPeeringZone = Core.Nothing,
                producerPrivateZone = Core.Nothing}
instance Core.FromJSON DnsZonePair where
        parseJSON
          = Core.withObject "DnsZonePair"
              (\ o ->
                 DnsZonePair Core.<$>
                   (o Core..:? "consumerPeeringZone") Core.<*>
                     (o Core..:? "producerPrivateZone"))

instance Core.ToJSON DnsZonePair where
        toJSON DnsZonePair{..}
          = Core.object
              (Core.catMaybes
                 [("consumerPeeringZone" Core..=) Core.<$> consumerPeeringZone,
...
instance Core.FromJSON EnableVpcServiceControlsRequest where
        parseJSON
          = Core.withObject "EnableVpcServiceControlsRequest"
              (\ o ->
                 EnableVpcServiceControlsRequest Core.<$>
                   (o Core..:? "consumerNetwork"))
...
-- | Represents managed DNS zones created in the shared Producer host and consumer projects.
--
-- /See:/ 'newGetDnsZoneResponse' smart constructor.
data GetDnsZoneResponse = GetDnsZoneResponse
    {
      -- | The DNS peering zone created in the consumer project.
      consumerPeeringZone :: (Core.Maybe DnsZone)
      -- | The private DNS zone created in the shared producer host project.
...
-- | Creates a value of 'GetDnsZoneResponse' with the minimum fields required to make a request.
newGetDnsZoneResponse 
    ::  GetDnsZoneResponse
newGetDnsZoneResponse
  = GetDnsZoneResponse{consumerPeeringZone = Core.Nothing,
                       producerPrivateZone = Core.Nothing}
instance Core.FromJSON GetDnsZoneResponse where
        parseJSON
          = Core.withObject "GetDnsZoneResponse"
              (\ o ->
                 GetDnsZoneResponse Core.<$>
                   (o Core..:? "consumerPeeringZone") Core.<*>
                     (o Core..:? "producerPrivateZone"))

instance Core.ToJSON GetDnsZoneResponse where
        toJSON GetDnsZoneResponse{..}
          = Core.object
              (Core.catMaybes
                 [("consumerPeeringZone" Core..=) Core.<$> consumerPeeringZone,
                  ("producerPrivateZone" Core..=) Core.<$> producerPrivateZone])
...
newGoogleCloudServicenetworkingV1ConsumerConfigReservedRange 
    :: 
                                                             GoogleCloudServicenetworkingV1ConsumerConfigReservedRange
newGoogleCloudServicenetworkingV1ConsumerConfigReservedRange
  = GoogleCloudServicenetworkingV1ConsumerConfigReservedRange{address
                                                                = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudServicenetworkingV1ConsumerConfigReservedRange"
              (\ o ->
                 GoogleCloudServicenetworkingV1ConsumerConfigReservedRange Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "ipPrefixLength")
                     Core.<*> (o Core..:? "name"))
...
newGoogleCloudServicenetworkingV1betaConnection 
    :: 
                                                GoogleCloudServicenetworkingV1betaConnection
newGoogleCloudServicenetworkingV1betaConnection
  = GoogleCloudServicenetworkingV1betaConnection{network =
                                                   Core.Nothing,
                                                 peering = Core.Nothing,
                                                 reservedPeeringRanges = Core.Nothing,
                                                 service = Core.Nothing}
instance Core.FromJSON GoogleCloudServicenetworkingV1betaConnection
         where
        parseJSON
          = Core.withObject "GoogleCloudServicenetworkingV1betaConnection"
              (\ o ->
                 GoogleCloudServicenetworkingV1betaConnection Core.<$>
                   (o Core..:? "network") Core.<*> (o Core..:? "peering") Core.<*>
                     (o Core..:? "reservedPeeringRanges")
                     Core.<*> (o Core..:? "service"))

instance Core.ToJSON GoogleCloudServicenetworkingV1betaConnection
         where
        toJSON GoogleCloudServicenetworkingV1betaConnection{..}
          = Core.object
              (Core.catMaybes
                 [("network" Core..=) Core.<$> network,
                  ("peering" Core..=) Core.<$> peering,
...
newGoogleCloudServicenetworkingV1betaSubnetwork 
    :: 
                                                GoogleCloudServicenetworkingV1betaSubnetwork
newGoogleCloudServicenetworkingV1betaSubnetwork
  = GoogleCloudServicenetworkingV1betaSubnetwork{ipCidrRange =
                                                   Core.Nothing,
                                                 name = Core.Nothing, network = Core.Nothing,
                                                 outsideAllocation = Core.Nothing}
instance Core.FromJSON GoogleCloudServicenetworkingV1betaSubnetwork
         where
        parseJSON
          = Core.withObject "GoogleCloudServicenetworkingV1betaSubnetwork"
              (\ o ->
                 GoogleCloudServicenetworkingV1betaSubnetwork Core.<$>
                   (o Core..:? "ipCidrRange") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "network")
                     Core.<*> (o Core..:? "outsideAllocation"))

instance Core.ToJSON GoogleCloudServicenetworkingV1betaSubnetwork
         where
        toJSON GoogleCloudServicenetworkingV1betaSubnetwork{..}
          = Core.object
              (Core.catMaybes
                 [("ipCidrRange" Core..=) Core.<$> ipCidrRange,
                  ("name" Core..=) Core.<$> name,
                  ("network" Core..=) Core.<$> network,
                  ("outsideAllocation" Core..=) Core.<$> outsideAllocation])
...
instance Core.FromJSON ListConnectionsResponse where
        parseJSON
          = Core.withObject "ListConnectionsResponse"
              (\ o ->
                 ListConnectionsResponse Core.<$> (o Core..:? "connections"))
...
--
-- /See:/ 'newListDnsRecordSetsResponse' smart constructor.
newtype ListDnsRecordSetsResponse = ListDnsRecordSetsResponse
    {
      -- | DNS record Set Resource
      dnsRecordSets :: (Core.Maybe [DnsRecordSet])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ListDnsRecordSetsResponse' with the minimum fields required to make a request.
newListDnsRecordSetsResponse 
    ::  ListDnsRecordSetsResponse
newListDnsRecordSetsResponse
  = ListDnsRecordSetsResponse{dnsRecordSets = Core.Nothing}
instance Core.FromJSON ListDnsRecordSetsResponse where
        parseJSON
          = Core.withObject "ListDnsRecordSetsResponse"
              (\ o ->
                 ListDnsRecordSetsResponse Core.<$> (o Core..:? "dnsRecordSets"))

instance Core.ToJSON ListDnsRecordSetsResponse where
        toJSON ListDnsRecordSetsResponse{..}
          = Core.object
              (Core.catMaybes [("dnsRecordSets" Core..=) Core.<$> dnsRecordSets])


-- | Represents all DNS zones in the shared producer host project and the matching peering zones in the consumer project.
--
-- /See:/ 'newListDnsZonesResponse' smart constructor.
newtype ListDnsZonesResponse = ListDnsZonesResponse
    {
      ...
      dnsZonePairs :: (Core.Maybe [DnsZonePair])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ListDnsZonesResponse' with the minimum fields required to make a request.
newListDnsZonesResponse 
    ::  ListDnsZonesResponse
newListDnsZonesResponse
  = ListDnsZonesResponse{dnsZonePairs = Core.Nothing}
instance Core.FromJSON ListDnsZonesResponse where
        parseJSON
          = Core.withObject "ListDnsZonesResponse"
              (\ o -> ListDnsZonesResponse Core.<$> (o Core..:? "dnsZonePairs"))

instance Core.ToJSON ListDnsZonesResponse where
        toJSON ListDnsZonesResponse{..}
          = Core.object
              (Core.catMaybes [("dnsZonePairs" Core..=) Core.<$> dnsZonePairs])
...
instance Core.FromJSON ListPeeredDnsDomainsResponse where
        parseJSON
          = Core.withObject "ListPeeredDnsDomainsResponse"
              (\ o ->
                 ListPeeredDnsDomainsResponse Core.<$>
                   (o Core..:? "peeredDnsDomains"))

instance Core.ToJSON ListPeeredDnsDomainsResponse where
        toJSON ListPeeredDnsDomainsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("peeredDnsDomains" Core..=) Core.<$> peeredDnsDomains])
...
newPartialDeleteConnectionMetadata
  = PartialDeleteConnectionMetadata
instance Core.FromJSON PartialDeleteConnectionMetadata where
        parseJSON
          = Core.withObject "PartialDeleteConnectionMetadata"
...
instance Core.FromJSON PeeredDnsDomain where
        parseJSON
          = Core.withObject "PeeredDnsDomain"
              (\ o ->
                 PeeredDnsDomain Core.<$>
                   (o Core..:? "dnsSuffix") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON PeeredDnsDomainMetadata where
        parseJSON
          = Core.withObject "PeeredDnsDomainMetadata"
...
data PhpSettings = PhpSettings
    {
      -- | Some settings.
      common :: (Core.Maybe CommonLanguageSettings)
      -- | The package name to use in Php. Clobbers the php/namespace option set in the protobuf. This should be used __only__ by APIs who have already set the language/settings.php.package/name\" field in gapic.yaml. API teams should use the protobuf php/namespace option where possible. Example of a YAML configuration:: publishing: library/settings: php/settings: library_package: Google\\Cloud\\PubSub\\V1
    , libraryPackage :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newPhpSettings 
    ::  PhpSettings
newPhpSettings
  = PhpSettings{common = Core.Nothing, libraryPackage = Core.Nothing}
...
newPolicyBinding 
    ::  PolicyBinding
newPolicyBinding
  = PolicyBinding{member = Core.Nothing, role' = Core.Nothing}
instance Core.FromJSON PolicyBinding where
        parseJSON
          = Core.withObject "PolicyBinding"
              (\ o ->
                 PolicyBinding Core.<$>
                   (o Core..:? "member") Core.<*> (o Core..:? "role"))
...
newRange 
    ::  Range
newRange
  = Range{ipCidrRange = Core.Nothing, network = Core.Nothing}
instance Core.FromJSON Range where
        parseJSON
          = Core.withObject "Range"
              (\ o ->
                 Range Core.<$>
                   (o Core..:? "ipCidrRange") Core.<*> (o Core..:? "network"))
...
newRangeReservation 
    ::  RangeReservation
newRangeReservation
  = RangeReservation{ipPrefixLength = Core.Nothing,
...
instance Core.FromJSON RangeReservation where
        parseJSON
          = Core.withObject "RangeReservation"
              (\ o ->
                 RangeReservation Core.<$>
                   (o Core..:? "ipPrefixLength") Core.<*>
                     (o Core..:? "requestedRanges")
        ...
        toJSON RangeReservation{..}
          = Core.object
              (Core.catMaybes
                 [("ipPrefixLength" Core..=) Core.<$> ipPrefixLength,
                  ("requestedRanges" Core..=) Core.<$> requestedRanges,
                  ("secondaryRangeIpPrefixLengths" Core..=) Core.<$>
                    secondaryRangeIpPrefixLengths,
                  ("subnetworkCandidates" Core..=) Core.<$> subnetworkCandidates])
...
instance Core.FromJSON RemoveDnsRecordSetMetadata where
        parseJSON
          = Core.withObject "RemoveDnsRecordSetMetadata"
...
newRemoveDnsRecordSetRequest 
    ::  RemoveDnsRecordSetRequest
newRemoveDnsRecordSetRequest
  = RemoveDnsRecordSetRequest{consumerNetwork = Core.Nothing,
                              dnsRecordSet = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON RemoveDnsRecordSetRequest where
        parseJSON
          = Core.withObject "RemoveDnsRecordSetRequest"
              (\ o ->
                 RemoveDnsRecordSetRequest Core.<$>
                   (o Core..:? "consumerNetwork") Core.<*> (o Core..:? "dnsRecordSet")
                     Core.<*> (o Core..:? "zone"))
...
instance Core.FromJSON RemoveDnsRecordSetResponse where
        parseJSON
          = Core.withObject "RemoveDnsRecordSetResponse"
...
instance Core.FromJSON RemoveDnsZoneMetadata where
        parseJSON
          = Core.withObject "RemoveDnsZoneMetadata"
...
newRemoveDnsZoneRequest 
    ::  RemoveDnsZoneRequest
newRemoveDnsZoneRequest
  = RemoveDnsZoneRequest{consumerNetwork = Core.Nothing,
                         name = Core.Nothing}
instance Core.FromJSON RemoveDnsZoneRequest where
        parseJSON
          = Core.withObject "RemoveDnsZoneRequest"
              (\ o ->
                 RemoveDnsZoneRequest Core.<$>
                   (o Core..:? "consumerNetwork") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON RemoveDnsZoneResponse where
        parseJSON
          = Core.withObject "RemoveDnsZoneResponse"
...
newRoute 
    ::  Route
newRoute
  = Route{destRange = Core.Nothing, name = Core.Nothing,
          network = Core.Nothing, nextHopGateway = Core.Nothing}
instance Core.FromJSON Route where
        parseJSON
          = Core.withObject "Route"
              (\ o ->
                 Route Core.<$>
                   (o Core..:? "destRange") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "network")
...
newSearchRangeRequest 
    ::  SearchRangeRequest
newSearchRangeRequest
  = SearchRangeRequest{ipPrefixLength = Core.Nothing,
                       network = Core.Nothing}
instance Core.FromJSON SearchRangeRequest where
        parseJSON
          = Core.withObject "SearchRangeRequest"
              (\ o ->
                 SearchRangeRequest Core.<$>
                   (o Core..:? "ipPrefixLength") Core.<*> (o Core..:? "network"))
...
newSecondaryIpRange 
    ::  SecondaryIpRange
newSecondaryIpRange
  = SecondaryIpRange{ipCidrRange = Core.Nothing,
                     rangeName = Core.Nothing}
instance Core.FromJSON SecondaryIpRange where
        parseJSON
          = Core.withObject "SecondaryIpRange"
              (\ o ->
...
newSecondaryIpRangeSpec 
    ::  SecondaryIpRangeSpec
newSecondaryIpRangeSpec
  = SecondaryIpRangeSpec{ipPrefixLength = Core.Nothing,
                         outsideAllocationPublicIpRange = Core.Nothing,
                         rangeName = Core.Nothing, requestedAddress = Core.Nothing}
instance Core.FromJSON SecondaryIpRangeSpec where
        parseJSON
          = Core.withObject "SecondaryIpRangeSpec"
              (\ o ->
                 SecondaryIpRangeSpec Core.<$>
                   (o Core..:? "ipPrefixLength") Core.<*>
                     (o Core..:? "outsideAllocationPublicIpRange")
...
newService 
    ::  Service
newService
  = Service{apis = Core.Nothing, aspects = Core.Nothing,
...
newSubnetwork 
    ::  Subnetwork
newSubnetwork
  = Subnetwork{ipCidrRange = Core.Nothing, name = Core.Nothing,
               network = Core.Nothing, outsideAllocation = Core.Nothing,
               region = Core.Nothing, secondaryIpRanges = Core.Nothing}
instance Core.FromJSON Subnetwork where
        parseJSON
          = Core.withObject "Subnetwork"
              (\ o ->
                 Subnetwork Core.<$>
                   (o Core..:? "ipCidrRange") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "network")
...
instance Core.FromJSON UpdateConsumerConfigRequest where
        parseJSON
          = Core.withObject "UpdateConsumerConfigRequest"
              (\ o ->
                 UpdateConsumerConfigRequest Core.<$> (o Core..:? "consumerConfig"))
...
instance Core.FromJSON UpdateDnsRecordSetMetadata where
        parseJSON
          = Core.withObject "UpdateDnsRecordSetMetadata"
...
newUpdateDnsRecordSetRequest 
    ::  UpdateDnsRecordSetRequest
newUpdateDnsRecordSetRequest
  = UpdateDnsRecordSetRequest{consumerNetwork = Core.Nothing,
                              existingDnsRecordSet = Core.Nothing,
                              newDnsRecordSet' = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON UpdateDnsRecordSetRequest where
        parseJSON
          = Core.withObject "UpdateDnsRecordSetRequest"
              (\ o ->
                 UpdateDnsRecordSetRequest Core.<$>
                   (o Core..:? "consumerNetwork") Core.<*>
                     (o Core..:? "existingDnsRecordSet")
...
instance Core.ToJSON UpdateDnsRecordSetRequest where
        toJSON UpdateDnsRecordSetRequest{..}
          = Core.object
              (Core.catMaybes
                 [("consumerNetwork" Core..=) Core.<$> consumerNetwork,
                  ("existingDnsRecordSet" Core..=) Core.<$> existingDnsRecordSet,
                  ("newDnsRecordSet" Core..=) Core.<$> newDnsRecordSet',
                  ("zone" Core..=) Core.<$> zone])
...
newValidateConsumerConfigRequest 
    ::  ValidateConsumerConfigRequest
newValidateConsumerConfigRequest
  = ValidateConsumerConfigRequest{checkServiceNetworkingUsePermission
                                    = Core.Nothing,
                                  consumerNetwork = Core.Nothing, consumerProject = Core.Nothing,
                                  rangeReservation = Core.Nothing, validateNetwork = Core.Nothing}
instance Core.FromJSON ValidateConsumerConfigRequest where
        parseJSON
          = Core.withObject "ValidateConsumerConfigRequest"
              (\ o ->
                 ValidateConsumerConfigRequest Core.<$>
                   (o Core..:? "checkServiceNetworkingUsePermission") Core.<*>
                     (o Core..:? "consumerNetwork")
          ...
          = Core.object
              (Core.catMaybes
                 [("checkServiceNetworkingUsePermission" Core..=) Core.<$>
                  ...
                  ("rangeReservation" Core..=) Core.<$> rangeReservation,
                  ("validateNetwork" Core..=) Core.<$> validateNetwork])
...
newValidateConsumerConfigResponse 
    ::  ValidateConsumerConfigResponse
newValidateConsumerConfigResponse
  = ValidateConsumerConfigResponse{existingSubnetworkCandidates =
                                     Core.Nothing,
                                   isValid = Core.Nothing, validationError = Core.Nothing}
instance Core.FromJSON ValidateConsumerConfigResponse where
        parseJSON
          = Core.withObject "ValidateConsumerConfigResponse"
              (\ o ->
                 ValidateConsumerConfigResponse Core.<$>
                   (o Core..:? "existingSubnetworkCandidates") Core.<*>
                     (o Core..:? "isValid")
...
instance Core.ToJSON ValidateConsumerConfigResponse where
        toJSON ValidateConsumerConfigResponse{..}
          = Core.object
              (Core.catMaybes
                 [("existingSubnetworkCandidates" Core..=) Core.<$>
                    existingSubnetworkCandidates,
                  ("isValid" Core..=) Core.<$> isValid,
                  ("validationError" Core..=) Core.<$> validationError])


-- | Response for the get VPC Service Controls request.
--
-- /See:/ 'newVpcServiceControls' smart constructor.
newtype VpcServiceControls = VpcServiceControls
    {
...
-- | Creates a value of 'VpcServiceControls' with the minimum fields required to make a request.
newVpcServiceControls 
    ::  VpcServiceControls
newVpcServiceControls = VpcServiceControls{enabled = Core.Nothing}
instance Core.FromJSON VpcServiceControls where
        parseJSON
          = Core.withObject "VpcServiceControls"
              (\ o -> VpcServiceControls Core.<$> (o Core..:? "enabled"))

instance Core.ToJSON VpcServiceControls where
        toJSON VpcServiceControls{..}
          = Core.object
