...
newAddDnsZoneResponse =
  AddDnsZoneResponse
    {consumerPeeringZone = Core.Nothing, producerPrivateZone = Core.Nothing}
...
instance Core.ToJSON AddDnsZoneResponse where
        toJSON AddDnsZoneResponse{..}
          = Core.object
              (Core.catMaybes
                 [("consumerPeeringZone" Core..=) Core.<$>
                    consumerPeeringZone,
                  ("producerPrivateZone" Core..=) Core.<$>
                    producerPrivateZone])
              ...
              (\ o ->
                 AddSubnetworkRequest Core.<$>
                   (o Core..:? "allowSubnetCidrRoutesOverlap") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "useCustomComputeIdempotencyWindow"))
          ...
          = Core.object
              (Core.catMaybes
                 [("allowSubnetCidrRoutesOverlap" Core..=) Core.<$>
                  ...
                  ("requestedAddress" Core..=) Core.<$>
                    requestedAddress,
                  ("requestedRanges" Core..=) Core.<$> requestedRanges,
                  ("role" Core..=) Core.<$> role',
                  ("secondaryIpRangeSpecs" Core..=) Core.<$>
        ...
        parseJSON
          = Core.withObject "CloudSQLConfig"
              (\ o ->
                 CloudSQLConfig Core.<$>
                   (o Core..:? "service") Core.<*>
                     (o Core..:? "umbrellaNetwork")
                     Core.<*>
                     (o Core..:? "umbrellaProject" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("network" Core..=) Core.<$> network,
                  ...
                  ("reservedPeeringRanges" Core..=) Core.<$>
...
instance Core.ToJSON ConsumerProject where
        toJSON ConsumerProject{..}
          = Core.object
              (Core.catMaybes
                 [("projectNum" Core..=) Core.. Core.AsText Core.<$>
                    projectNum])
...
instance Core.FromJSON DeletePeeredDnsDomainMetadata
         where
        parseJSON
          = Core.withObject "DeletePeeredDnsDomainMetadata"
              (\ o -> Core.pure DeletePeeredDnsDomainMetadata)

instance Core.ToJSON DeletePeeredDnsDomainMetadata
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.ToJSON DisableVpcServiceControlsRequest
         where
...
instance Core.ToJSON EnableVpcServiceControlsRequest
         where
...
newGoogleCloudServicenetworkingV1ConsumerConfigReservedRange =
  GoogleCloudServicenetworkingV1ConsumerConfigReservedRange
    {address = Core.Nothing, ipPrefixLength = Core.Nothing, name = Core.Nothing}
...
instance Core.FromJSON ListPeeredDnsDomainsResponse
         where
        parseJSON
...
instance Core.ToJSON ListPeeredDnsDomainsResponse
         where
        toJSON ListPeeredDnsDomainsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("peeredDnsDomains" Core..=) Core.<$>
                    peeredDnsDomains])
...
instance Core.ToJSON PartialDeleteConnectionMetadata
         where
        toJSON = Core.const Core.emptyObject
          ...
          = Core.object
              (Core.catMaybes
                 [("ipPrefixLength" Core..=) Core.<$> ipPrefixLength,
                  ...
                  ("subnetworkCandidates" Core..=) Core.<$>
...
instance Core.FromJSON RemoveDnsRecordSetMetadata
         where
        parseJSON
...
instance Core.FromJSON RemoveDnsRecordSetRequest
         where
        parseJSON
...
instance Core.FromJSON RemoveDnsRecordSetResponse
         where
        parseJSON
...
instance Core.FromJSON Route where
        parseJSON
          = Core.withObject "Route"
              (\ o ->
                 Route Core.<$>
                   (o Core..:? "destRange") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "network")
...
instance Core.FromJSON UpdateConsumerConfigRequest
         where
        parseJSON
          = Core.withObject "UpdateConsumerConfigRequest"
              (\ o ->
                 UpdateConsumerConfigRequest Core.<$>
                   (o Core..:? "consumerConfig"))

instance Core.ToJSON UpdateConsumerConfigRequest
         where
...
instance Core.FromJSON UpdateDnsRecordSetMetadata
         where
        parseJSON
...
instance Core.FromJSON UpdateDnsRecordSetRequest
         where
        parseJSON
        ...
        toJSON UpdateDnsRecordSetRequest{..}
          = Core.object
              (Core.catMaybes
                 [("consumerNetwork" Core..=) Core.<$>
                    consumerNetwork,
                  ("existingDnsRecordSet" Core..=) Core.<$>
                    existingDnsRecordSet,
                  ("newDnsRecordSet" Core..=) Core.<$>
                    newDnsRecordSet',
                  ("zone" Core..=) Core.<$> zone])
...
instance Core.FromJSON ValidateConsumerConfigRequest
         where
        parseJSON
...
instance Core.ToJSON ValidateConsumerConfigRequest
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("checkServiceNetworkingUsePermission" Core..=)
                  ...
                  ("rangeReservation" Core..=) Core.<$>
                    rangeReservation,
                  ("validateNetwork" Core..=) Core.<$>
                    validateNetwork])
...
instance Core.FromJSON ValidateConsumerConfigResponse
         where
        parseJSON
...
instance Core.ToJSON ValidateConsumerConfigResponse
         where
