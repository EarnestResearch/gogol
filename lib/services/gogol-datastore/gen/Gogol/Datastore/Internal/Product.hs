...
newAggregationQuery 
    ::  AggregationQuery
newAggregationQuery
  = AggregationQuery{aggregations = Core.Nothing,
                     nestedQuery = Core.Nothing}
instance Core.FromJSON AggregationQuery where
        parseJSON
          = Core.withObject "AggregationQuery"
              (\ o ->
                 AggregationQuery Core.<$>
                   (o Core..:? "aggregations") Core.<*> (o Core..:? "nestedQuery"))
...
instance Core.FromJSON AggregationResult_AggregateProperties where
        parseJSON
          = Core.withObject "AggregationResult_AggregateProperties"
              (\ o ->
                 AggregationResult_AggregateProperties Core.<$>
...
newAggregationResultBatch 
    ::  AggregationResultBatch
newAggregationResultBatch
  = AggregationResultBatch{aggregationResults = Core.Nothing,
                           moreResults = Core.Nothing, readTime = Core.Nothing}
instance Core.FromJSON AggregationResultBatch where
        parseJSON
          = Core.withObject "AggregationResultBatch"
              (\ o ->
                 AggregationResultBatch Core.<$>
                   (o Core..:? "aggregationResults") Core.<*>
                     (o Core..:? "moreResults")
...
newAllocateIdsRequest 
    ::  AllocateIdsRequest
newAllocateIdsRequest
  = AllocateIdsRequest{databaseId = Core.Nothing,
                       keys = Core.Nothing}
instance Core.FromJSON AllocateIdsRequest where
        parseJSON
          = Core.withObject "AllocateIdsRequest"
              (\ o ->
                 AllocateIdsRequest Core.<$>
                   (o Core..:? "databaseId") Core.<*> (o Core..:? "keys"))
...
instance Core.FromJSON AllocateIdsResponse where
        parseJSON
          = Core.withObject "AllocateIdsResponse"
...
newBeginTransactionRequest 
    ::  BeginTransactionRequest
newBeginTransactionRequest
  = BeginTransactionRequest{databaseId = Core.Nothing,
...
newCommitRequest 
    ::  CommitRequest
newCommitRequest
  = CommitRequest{databaseId = Core.Nothing, mode = Core.Nothing,
                  mutations = Core.Nothing, singleUseTransaction = Core.Nothing,
...
instance Core.FromJSON CommitRequest where
        parseJSON
          = Core.withObject "CommitRequest"
              (\ o ->
                 CommitRequest Core.<$>
                   (o Core..:? "databaseId") Core.<*> (o Core..:? "mode") Core.<*>
                     (o Core..:? "mutations")
...
newCommitResponse
  = CommitResponse{commitTime = Core.Nothing,
                   indexUpdates = Core.Nothing, mutationResults = Core.Nothing}
instance Core.FromJSON CommitResponse where
        parseJSON
          = Core.withObject "CommitResponse"
              (\ o ->
                 CommitResponse Core.<$>
                   (o Core..:? "commitTime") Core.<*> (o Core..:? "indexUpdates")
...
instance Core.FromJSON Entity where
        parseJSON
          = Core.withObject "Entity"
              (\ o ->
                 Entity Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "properties"))
...
instance Core.FromJSON Entity_Properties where
        parseJSON
          = Core.withObject "Entity_Properties"
...
newEntityResult 
    ::  EntityResult
newEntityResult
  = EntityResult{createTime = Core.Nothing, cursor = Core.Nothing,
                 entity = Core.Nothing, updateTime = Core.Nothing,
                 version = Core.Nothing}
instance Core.FromJSON EntityResult where
        parseJSON
          = Core.withObject "EntityResult"
              (\ o ->
                 EntityResult Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "cursor") Core.<*>
                     (o Core..:? "entity")
...
newFindNearest
  = FindNearest{distanceMeasure = Core.Nothing,
                ...
                queryVector = Core.Nothing, vectorProperty = Core.Nothing}
...
newGoogleDatastoreAdminV1CommonMetadata 
    :: 
                                        GoogleDatastoreAdminV1CommonMetadata
newGoogleDatastoreAdminV1CommonMetadata
  = GoogleDatastoreAdminV1CommonMetadata{endTime = Core.Nothing,
...
instance Core.FromJSON GoogleDatastoreAdminV1CommonMetadata where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1CommonMetadata"
              (\ o ->
                 GoogleDatastoreAdminV1CommonMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "labels") Core.<*>
...
newGoogleDatastoreAdminV1CommonMetadata_Labels additional
  = GoogleDatastoreAdminV1CommonMetadata_Labels{additional =
                                                  additional}
instance Core.FromJSON GoogleDatastoreAdminV1CommonMetadata_Labels
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1CommonMetadata_Labels"
              (\ o ->
                 GoogleDatastoreAdminV1CommonMetadata_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GoogleDatastoreAdminV1CommonMetadata_Labels
         where
...
newGoogleDatastoreAdminV1DatastoreFirestoreMigrationMetadata 
    :: 
                                                             GoogleDatastoreAdminV1DatastoreFirestoreMigrationMetadata
newGoogleDatastoreAdminV1DatastoreFirestoreMigrationMetadata
  = GoogleDatastoreAdminV1DatastoreFirestoreMigrationMetadata{migrationState
                                                                = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDatastoreAdminV1DatastoreFirestoreMigrationMetadata"
              (\ o ->
                 GoogleDatastoreAdminV1DatastoreFirestoreMigrationMetadata Core.<$>
                   (o Core..:? "migrationState") Core.<*>
                     (o Core..:? "migrationStep"))
...
newGoogleDatastoreAdminV1EntityFilter 
    :: 
                                      GoogleDatastoreAdminV1EntityFilter
newGoogleDatastoreAdminV1EntityFilter
  = GoogleDatastoreAdminV1EntityFilter{kinds = Core.Nothing,
                                       namespaceIds = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1EntityFilter where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1EntityFilter"
              (\ o ->
                 GoogleDatastoreAdminV1EntityFilter Core.<$>
                   (o Core..:? "kinds") Core.<*> (o Core..:? "namespaceIds"))
...
newGoogleDatastoreAdminV1ExportEntitiesMetadata 
    :: 
                                                GoogleDatastoreAdminV1ExportEntitiesMetadata
newGoogleDatastoreAdminV1ExportEntitiesMetadata
  = GoogleDatastoreAdminV1ExportEntitiesMetadata{common =
                                                   Core.Nothing,
                                                 entityFilter = Core.Nothing,
                                                 outputUrlPrefix = Core.Nothing,
                                                 progressBytes = Core.Nothing,
                                                 progressEntities = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1ExportEntitiesMetadata
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1ExportEntitiesMetadata"
              (\ o ->
                 GoogleDatastoreAdminV1ExportEntitiesMetadata Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "entityFilter") Core.<*>
                     (o Core..:? "outputUrlPrefix")
                     Core.<*> (o Core..:? "progressBytes")
                     Core.<*> (o Core..:? "progressEntities"))

instance Core.ToJSON GoogleDatastoreAdminV1ExportEntitiesMetadata
         where
...
newGoogleDatastoreAdminV1ExportEntitiesRequest 
    :: 
                                               GoogleDatastoreAdminV1ExportEntitiesRequest
newGoogleDatastoreAdminV1ExportEntitiesRequest
  = GoogleDatastoreAdminV1ExportEntitiesRequest{entityFilter =
                                                  Core.Nothing,
                                                labels = Core.Nothing,
                                                outputUrlPrefix = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1ExportEntitiesRequest
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1ExportEntitiesRequest"
              (\ o ->
                 GoogleDatastoreAdminV1ExportEntitiesRequest Core.<$>
                   (o Core..:? "entityFilter") Core.<*> (o Core..:? "labels") Core.<*>
                     (o Core..:? "outputUrlPrefix"))

instance Core.ToJSON GoogleDatastoreAdminV1ExportEntitiesRequest
         where
...
newGoogleDatastoreAdminV1ExportEntitiesRequest_Labels additional
  = GoogleDatastoreAdminV1ExportEntitiesRequest_Labels{additional =
                                                         additional}
instance Core.FromJSON
           GoogleDatastoreAdminV1ExportEntitiesRequest_Labels
         where
        parseJSON
          = Core.withObject
              "GoogleDatastoreAdminV1ExportEntitiesRequest_Labels"
              (\ o ->
                 GoogleDatastoreAdminV1ExportEntitiesRequest_Labels Core.<$>
                   (Core.parseJSONObject o))
...
newGoogleDatastoreAdminV1ExportEntitiesResponse 
    :: 
                                                GoogleDatastoreAdminV1ExportEntitiesResponse
newGoogleDatastoreAdminV1ExportEntitiesResponse
  = GoogleDatastoreAdminV1ExportEntitiesResponse{outputUrl =
                                                   Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1ExportEntitiesResponse
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1ExportEntitiesResponse"
              (\ o ->
                 GoogleDatastoreAdminV1ExportEntitiesResponse Core.<$>
                   (o Core..:? "outputUrl"))

instance Core.ToJSON GoogleDatastoreAdminV1ExportEntitiesResponse
         where
...
newGoogleDatastoreAdminV1ImportEntitiesMetadata 
    :: 
                                                GoogleDatastoreAdminV1ImportEntitiesMetadata
newGoogleDatastoreAdminV1ImportEntitiesMetadata
  = GoogleDatastoreAdminV1ImportEntitiesMetadata{common =
                                                   Core.Nothing,
                                                 entityFilter = Core.Nothing,
                                                 inputUrl = Core.Nothing,
                                                 progressBytes = Core.Nothing,
                                                 progressEntities = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1ImportEntitiesMetadata
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1ImportEntitiesMetadata"
              (\ o ->
                 GoogleDatastoreAdminV1ImportEntitiesMetadata Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "entityFilter") Core.<*>
                     (o Core..:? "inputUrl")
                     Core.<*> (o Core..:? "progressBytes")
                     Core.<*> (o Core..:? "progressEntities"))

instance Core.ToJSON GoogleDatastoreAdminV1ImportEntitiesMetadata
         where
...
newGoogleDatastoreAdminV1ImportEntitiesRequest 
    :: 
                                               GoogleDatastoreAdminV1ImportEntitiesRequest
newGoogleDatastoreAdminV1ImportEntitiesRequest
  = GoogleDatastoreAdminV1ImportEntitiesRequest{entityFilter =
                                                  Core.Nothing,
                                                inputUrl = Core.Nothing, labels = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1ImportEntitiesRequest
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1ImportEntitiesRequest"
              (\ o ->
                 GoogleDatastoreAdminV1ImportEntitiesRequest Core.<$>
                   (o Core..:? "entityFilter") Core.<*> (o Core..:? "inputUrl")
                     Core.<*> (o Core..:? "labels"))

instance Core.ToJSON GoogleDatastoreAdminV1ImportEntitiesRequest
         where
...
newGoogleDatastoreAdminV1ImportEntitiesRequest_Labels additional
  = GoogleDatastoreAdminV1ImportEntitiesRequest_Labels{additional =
                                                         additional}
instance Core.FromJSON
           GoogleDatastoreAdminV1ImportEntitiesRequest_Labels
         where
        parseJSON
          = Core.withObject
              "GoogleDatastoreAdminV1ImportEntitiesRequest_Labels"
              (\ o ->
                 GoogleDatastoreAdminV1ImportEntitiesRequest_Labels Core.<$>
                   (Core.parseJSONObject o))
...
newGoogleDatastoreAdminV1Index 
    ::  GoogleDatastoreAdminV1Index
newGoogleDatastoreAdminV1Index
  = GoogleDatastoreAdminV1Index{ancestor = Core.Nothing,
                                indexId = Core.Nothing, kind = Core.Nothing,
                                projectId = Core.Nothing, properties = Core.Nothing,
                                state = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1Index where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1Index"
              (\ o ->
                 GoogleDatastoreAdminV1Index Core.<$>
                   (o Core..:? "ancestor") Core.<*> (o Core..:? "indexId") Core.<*>
                     (o Core..:? "kind")
...
newGoogleDatastoreAdminV1IndexOperationMetadata 
    :: 
                                                GoogleDatastoreAdminV1IndexOperationMetadata
newGoogleDatastoreAdminV1IndexOperationMetadata
  = GoogleDatastoreAdminV1IndexOperationMetadata{common =
                                                   Core.Nothing,
                                                 indexId = Core.Nothing,
                                                 progressEntities = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1IndexOperationMetadata
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1IndexOperationMetadata"
              (\ o ->
                 GoogleDatastoreAdminV1IndexOperationMetadata Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "indexId") Core.<*>
                     (o Core..:? "progressEntities"))

instance Core.ToJSON GoogleDatastoreAdminV1IndexOperationMetadata
         where
...
newGoogleDatastoreAdminV1IndexedProperty 
    :: 
                                         GoogleDatastoreAdminV1IndexedProperty
newGoogleDatastoreAdminV1IndexedProperty
  = GoogleDatastoreAdminV1IndexedProperty{direction = Core.Nothing,
                                          name = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1IndexedProperty where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1IndexedProperty"
              (\ o ->
                 GoogleDatastoreAdminV1IndexedProperty Core.<$>
                   (o Core..:? "direction") Core.<*> (o Core..:? "name"))
...
newGoogleDatastoreAdminV1ListIndexesResponse 
    :: 
                                             GoogleDatastoreAdminV1ListIndexesResponse
newGoogleDatastoreAdminV1ListIndexesResponse
  = GoogleDatastoreAdminV1ListIndexesResponse{indexes = Core.Nothing,
                                              nextPageToken = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1ListIndexesResponse
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1ListIndexesResponse"
              (\ o ->
                 GoogleDatastoreAdminV1ListIndexesResponse Core.<$>
                   (o Core..:? "indexes") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON GoogleDatastoreAdminV1ListIndexesResponse
         where
...
newGoogleDatastoreAdminV1MigrationProgressEvent 
    :: 
                                                GoogleDatastoreAdminV1MigrationProgressEvent
newGoogleDatastoreAdminV1MigrationProgressEvent
  = GoogleDatastoreAdminV1MigrationProgressEvent{prepareStepDetails =
                                                   Core.Nothing,
                                                 redirectWritesStepDetails = Core.Nothing,
                                                 step = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1MigrationProgressEvent
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1MigrationProgressEvent"
              (\ o ->
                 GoogleDatastoreAdminV1MigrationProgressEvent Core.<$>
                   (o Core..:? "prepareStepDetails") Core.<*>
                     (o Core..:? "redirectWritesStepDetails")
                     Core.<*> (o Core..:? "step"))

instance Core.ToJSON GoogleDatastoreAdminV1MigrationProgressEvent
         where
        toJSON GoogleDatastoreAdminV1MigrationProgressEvent{..}
          = Core.object
              (Core.catMaybes
                 [("prepareStepDetails" Core..=) Core.<$> prepareStepDetails,
                  ("redirectWritesStepDetails" Core..=) Core.<$>
...
instance Core.FromJSON GoogleDatastoreAdminV1MigrationStateEvent
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1MigrationStateEvent"
              (\ o ->
                 GoogleDatastoreAdminV1MigrationStateEvent Core.<$>
                   (o Core..:? "state"))

instance Core.ToJSON GoogleDatastoreAdminV1MigrationStateEvent
         where
...
newGoogleDatastoreAdminV1PrepareStepDetails 
    :: 
                                            GoogleDatastoreAdminV1PrepareStepDetails
newGoogleDatastoreAdminV1PrepareStepDetails
  = GoogleDatastoreAdminV1PrepareStepDetails{concurrencyMode =
                                               Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1PrepareStepDetails
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1PrepareStepDetails"
              (\ o ->
                 GoogleDatastoreAdminV1PrepareStepDetails Core.<$>
...
newGoogleDatastoreAdminV1Progress 
    ::  GoogleDatastoreAdminV1Progress
newGoogleDatastoreAdminV1Progress
  = GoogleDatastoreAdminV1Progress{workCompleted = Core.Nothing,
                                   workEstimated = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1Progress where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1Progress"
              (\ o ->
                 GoogleDatastoreAdminV1Progress Core.<$>
                   (o Core..:? "workCompleted" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "workEstimated" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON GoogleDatastoreAdminV1Progress where
        toJSON GoogleDatastoreAdminV1Progress{..}
          = Core.object
              (Core.catMaybes
                 [("workCompleted" Core..=) Core.. Core.AsText Core.<$>
                    workCompleted,
                  ("workEstimated" Core..=) Core.. Core.AsText Core.<$>
                    workEstimated])
...
newGoogleDatastoreAdminV1RedirectWritesStepDetails 
    :: 
                                                   GoogleDatastoreAdminV1RedirectWritesStepDetails
newGoogleDatastoreAdminV1RedirectWritesStepDetails
  = GoogleDatastoreAdminV1RedirectWritesStepDetails{concurrencyMode =
                                                      Core.Nothing}
instance Core.FromJSON
           GoogleDatastoreAdminV1RedirectWritesStepDetails
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1RedirectWritesStepDetails"
              (\ o ->
                 GoogleDatastoreAdminV1RedirectWritesStepDetails Core.<$>
                   (o Core..:? "concurrencyMode"))
...
newGoogleDatastoreAdminV1beta1CommonMetadata 
    :: 
                                             GoogleDatastoreAdminV1beta1CommonMetadata
newGoogleDatastoreAdminV1beta1CommonMetadata
  = GoogleDatastoreAdminV1beta1CommonMetadata{endTime = Core.Nothing,
                                              labels = Core.Nothing, operationType = Core.Nothing,
                                              startTime = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1beta1CommonMetadata
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1beta1CommonMetadata"
              (\ o ->
                 GoogleDatastoreAdminV1beta1CommonMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "labels") Core.<*>
                     (o Core..:? "operationType")
                     Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "state"))

instance Core.ToJSON GoogleDatastoreAdminV1beta1CommonMetadata
         where
...
newGoogleDatastoreAdminV1beta1CommonMetadata_Labels additional
  = GoogleDatastoreAdminV1beta1CommonMetadata_Labels{additional =
                                                       additional}
instance Core.FromJSON
           GoogleDatastoreAdminV1beta1CommonMetadata_Labels
         where
        parseJSON
          = Core.withObject
              "GoogleDatastoreAdminV1beta1CommonMetadata_Labels"
              (\ o ->
                 GoogleDatastoreAdminV1beta1CommonMetadata_Labels Core.<$>
                   (Core.parseJSONObject o))
...
newGoogleDatastoreAdminV1beta1EntityFilter 
    :: 
                                           GoogleDatastoreAdminV1beta1EntityFilter
newGoogleDatastoreAdminV1beta1EntityFilter
  = GoogleDatastoreAdminV1beta1EntityFilter{kinds = Core.Nothing,
                                            namespaceIds = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1beta1EntityFilter
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1beta1EntityFilter"
              (\ o ->
                 GoogleDatastoreAdminV1beta1EntityFilter Core.<$>
                   (o Core..:? "kinds") Core.<*> (o Core..:? "namespaceIds"))
...
newGoogleDatastoreAdminV1beta1ExportEntitiesMetadata 
    :: 
                                                     GoogleDatastoreAdminV1beta1ExportEntitiesMetadata
newGoogleDatastoreAdminV1beta1ExportEntitiesMetadata
  = GoogleDatastoreAdminV1beta1ExportEntitiesMetadata{common =
                                                        Core.Nothing,
                                                      entityFilter = Core.Nothing,
                                                      outputUrlPrefix = Core.Nothing,
                                                      progressBytes = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDatastoreAdminV1beta1ExportEntitiesMetadata"
              (\ o ->
                 GoogleDatastoreAdminV1beta1ExportEntitiesMetadata Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "entityFilter") Core.<*>
                     (o Core..:? "outputUrlPrefix")
                     Core.<*> (o Core..:? "progressBytes")
                     Core.<*> (o Core..:? "progressEntities"))
...
newGoogleDatastoreAdminV1beta1ExportEntitiesResponse 
    :: 
                                                     GoogleDatastoreAdminV1beta1ExportEntitiesResponse
newGoogleDatastoreAdminV1beta1ExportEntitiesResponse
  = GoogleDatastoreAdminV1beta1ExportEntitiesResponse{outputUrl =
                                                        Core.Nothing}
instance Core.FromJSON
           GoogleDatastoreAdminV1beta1ExportEntitiesResponse
         where
        parseJSON
          = Core.withObject
              "GoogleDatastoreAdminV1beta1ExportEntitiesResponse"
              (\ o ->
                 GoogleDatastoreAdminV1beta1ExportEntitiesResponse Core.<$>
                   (o Core..:? "outputUrl"))
...
newGoogleDatastoreAdminV1beta1ImportEntitiesMetadata 
    :: 
                                                     GoogleDatastoreAdminV1beta1ImportEntitiesMetadata
newGoogleDatastoreAdminV1beta1ImportEntitiesMetadata
  = GoogleDatastoreAdminV1beta1ImportEntitiesMetadata{common =
                                                        Core.Nothing,
                                                      entityFilter = Core.Nothing,
                                                      inputUrl = Core.Nothing,
                                                      progressBytes = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDatastoreAdminV1beta1ImportEntitiesMetadata"
              (\ o ->
                 GoogleDatastoreAdminV1beta1ImportEntitiesMetadata Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "entityFilter") Core.<*>
                     (o Core..:? "inputUrl")
                     Core.<*> (o Core..:? "progressBytes")
                     Core.<*> (o Core..:? "progressEntities"))
...
newGoogleDatastoreAdminV1beta1Progress 
    :: 
                                       GoogleDatastoreAdminV1beta1Progress
newGoogleDatastoreAdminV1beta1Progress
  = GoogleDatastoreAdminV1beta1Progress{workCompleted = Core.Nothing,
                                        workEstimated = Core.Nothing}
instance Core.FromJSON GoogleDatastoreAdminV1beta1Progress where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1beta1Progress"
              (\ o ->
                 GoogleDatastoreAdminV1beta1Progress Core.<$>
                   (o Core..:? "workCompleted" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "workEstimated" Core.<&> Core.fmap Core.fromAsText))
...
newGqlQuery 
    ::  GqlQuery
newGqlQuery
  = GqlQuery{allowLiterals = Core.Nothing,
             namedBindings = Core.Nothing, positionalBindings = Core.Nothing,
             queryString = Core.Nothing}
instance Core.FromJSON GqlQuery where
        parseJSON
          = Core.withObject "GqlQuery"
              (\ o ->
                 GqlQuery Core.<$>
                   (o Core..:? "allowLiterals") Core.<*> (o Core..:? "namedBindings")
...
instance Core.FromJSON GqlQuery_NamedBindings where
        parseJSON
          = Core.withObject "GqlQuery_NamedBindings"
...
instance Core.FromJSON GqlQueryParameter where
        parseJSON
          = Core.withObject "GqlQueryParameter"
              (\ o ->
                 GqlQueryParameter Core.<$>
                   (o Core..:? "cursor") Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON KindExpression where
        parseJSON
          = Core.withObject "KindExpression"
...
newLookupRequest 
    ::  LookupRequest
newLookupRequest
  = LookupRequest{databaseId = Core.Nothing, keys = Core.Nothing,
                  propertyMask = Core.Nothing, readOptions = Core.Nothing}
instance Core.FromJSON LookupRequest where
        parseJSON
          = Core.withObject "LookupRequest"
              (\ o ->
                 LookupRequest Core.<$>
                   (o Core..:? "databaseId") Core.<*> (o Core..:? "keys") Core.<*>
                     (o Core..:? "propertyMask")
...
newLookupResponse 
    ::  LookupResponse
newLookupResponse
  = LookupResponse{deferred = Core.Nothing, found = Core.Nothing,
                   missing = Core.Nothing, readTime = Core.Nothing,
                   transaction = Core.Nothing}
instance Core.FromJSON LookupResponse where
        parseJSON
          = Core.withObject "LookupResponse"
              (\ o ->
                 LookupResponse Core.<$>
                   (o Core..:? "deferred") Core.<*> (o Core..:? "found") Core.<*>
                     (o Core..:? "missing")
                     Core.<*> (o Core..:? "readTime")
                     Core.<*> (o Core..:? "transaction"))
...
newMutation 
    ::  Mutation
newMutation
  = Mutation{baseVersion = Core.Nothing,
             conflictResolutionStrategy = Core.Nothing, delete = Core.Nothing,
             insert = Core.Nothing, propertyMask = Core.Nothing,
             propertyTransforms = Core.Nothing, update = Core.Nothing,
             updateTime = Core.Nothing, upsert = Core.Nothing}
instance Core.FromJSON Mutation where
        parseJSON
          = Core.withObject "Mutation"
              (\ o ->
                 Mutation Core.<$>
                   (o Core..:? "baseVersion" Core.<&> Core.fmap Core.fromAsText)
...
newMutationResult 
    ::  MutationResult
newMutationResult
  = MutationResult{conflictDetected = Core.Nothing,
                   createTime = Core.Nothing, key = Core.Nothing,
                   transformResults = Core.Nothing, updateTime = Core.Nothing,
                   version = Core.Nothing}
instance Core.FromJSON MutationResult where
        parseJSON
          = Core.withObject "MutationResult"
              (\ o ->
                 MutationResult Core.<$>
                   (o Core..:? "conflictDetected") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "key")
...
newPartitionId 
    ::  PartitionId
newPartitionId
  = PartitionId{databaseId = Core.Nothing,
                namespaceId = Core.Nothing, projectId = Core.Nothing}
instance Core.FromJSON PartitionId where
        parseJSON
          = Core.withObject "PartitionId"
              (\ o ->
                 PartitionId Core.<$>
                   (o Core..:? "databaseId") Core.<*> (o Core..:? "namespaceId")
                     Core.<*> (o Core..:? "projectId"))
...
newPathElement 
    ::  PathElement
newPathElement
  = PathElement{id = Core.Nothing, kind = Core.Nothing,
                name = Core.Nothing}
instance Core.FromJSON PathElement where
        parseJSON
          = Core.withObject "PathElement"
              (\ o ->
                 PathElement Core.<$>
...
newPropertyFilter 
    ::  PropertyFilter
newPropertyFilter
  = PropertyFilter{op = Core.Nothing, property = Core.Nothing,
                   value = Core.Nothing}
instance Core.FromJSON PropertyFilter where
        parseJSON
          = Core.withObject "PropertyFilter"
              (\ o ->
                 PropertyFilter Core.<$>
                   (o Core..:? "op") Core.<*> (o Core..:? "property") Core.<*>
                     (o Core..:? "value"))
...
instance Core.FromJSON PropertyOrder where
        parseJSON
          = Core.withObject "PropertyOrder"
              (\ o ->
                 PropertyOrder Core.<$>
                   (o Core..:? "direction") Core.<*> (o Core..:? "property"))
...
instance Core.FromJSON PropertyReference where
        parseJSON
          = Core.withObject "PropertyReference"
...
newPropertyTransform 
    ::  PropertyTransform
newPropertyTransform
  = PropertyTransform{appendMissingElements = Core.Nothing,
                      increment = Core.Nothing, maximum = Core.Nothing,
                      minimum = Core.Nothing, property = Core.Nothing,
                      removeAllFromArray = Core.Nothing, setToServerValue = Core.Nothing}
instance Core.FromJSON PropertyTransform where
        parseJSON
          = Core.withObject "PropertyTransform"
              (\ o ->
                 PropertyTransform Core.<$>
...
newQuery 
    ::  Query
newQuery
  = Query{distinctOn = Core.Nothing, endCursor = Core.Nothing,
          filter = Core.Nothing, findNearest = Core.Nothing,
          kind = Core.Nothing, limit = Core.Nothing, offset = Core.Nothing,
          order = Core.Nothing, projection = Core.Nothing,
          startCursor = Core.Nothing}
instance Core.FromJSON Query where
        parseJSON
          = Core.withObject "Query"
              (\ o ->
                 Query Core.<$>
                   (o Core..:? "distinctOn") Core.<*> (o Core..:? "endCursor")
                     Core.<*> (o Core..:? "filter")
          ...
          = Core.object
              (Core.catMaybes
                 [("distinctOn" Core..=) Core.<$> distinctOn,
                  ...
                  ("kind" Core..=) Core.<$> kind, ("limit" Core..=) Core.<$> limit,
...
newQueryResultBatch 
    ::  QueryResultBatch
newQueryResultBatch
  = QueryResultBatch{endCursor = Core.Nothing,
                     entityResultType = Core.Nothing, entityResults = Core.Nothing,
                     moreResults = Core.Nothing, readTime = Core.Nothing,
                     skippedCursor = Core.Nothing, skippedResults = Core.Nothing,
                     snapshotVersion = Core.Nothing}
instance Core.FromJSON QueryResultBatch where
        parseJSON
          = Core.withObject "QueryResultBatch"
              (\ o ->
                 QueryResultBatch Core.<$>
                   (o Core..:? "endCursor") Core.<*> (o Core..:? "entityResultType")
                     ...
                     Core.<*>
                     (o Core..:? "snapshotVersion" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("endCursor" Core..=) Core.<$> endCursor,
                  ...
                  ("snapshotVersion" Core..=) Core.. Core.AsText Core.<$>
                    snapshotVersion])
...
newReadOptions 
    ::  ReadOptions
newReadOptions
  = ReadOptions{newTransaction' = Core.Nothing,
                readConsistency = Core.Nothing, readTime = Core.Nothing,
                transaction = Core.Nothing}
instance Core.FromJSON ReadOptions where
        parseJSON
          = Core.withObject "ReadOptions"
              (\ o ->
                 ReadOptions Core.<$>
                   (o Core..:? "newTransaction") Core.<*>
                     (o Core..:? "readConsistency")
                     Core.<*> (o Core..:? "readTime")
                     Core.<*> (o Core..:? "transaction"))
...
instance Core.FromJSON ReserveIdsRequest where
        parseJSON
          = Core.withObject "ReserveIdsRequest"
              (\ o ->
                 ReserveIdsRequest Core.<$>
                   (o Core..:? "databaseId") Core.<*> (o Core..:? "keys"))
...
instance Core.FromJSON ReserveIdsResponse where
        parseJSON
          = Core.withObject "ReserveIdsResponse"
...
newRollbackRequest 
    ::  RollbackRequest
newRollbackRequest
  = RollbackRequest{databaseId = Core.Nothing,
                    transaction = Core.Nothing}
instance Core.FromJSON RollbackRequest where
        parseJSON
          = Core.withObject "RollbackRequest"
              (\ o ->
                 RollbackRequest Core.<$>
                   (o Core..:? "databaseId") Core.<*> (o Core..:? "transaction"))
...
instance Core.FromJSON RollbackResponse where
        parseJSON
          = Core.withObject "RollbackResponse"
...
newRunAggregationQueryRequest 
    ::  RunAggregationQueryRequest
newRunAggregationQueryRequest
  = RunAggregationQueryRequest{aggregationQuery = Core.Nothing,
                               databaseId = Core.Nothing, explainOptions = Core.Nothing,
                               gqlQuery = Core.Nothing, partitionId = Core.Nothing,
          ...
          = Core.withObject "RunAggregationQueryRequest"
              (\ o ->
                 RunAggregationQueryRequest Core.<$>
                   (o Core..:? "aggregationQuery") Core.<*> (o Core..:? "databaseId")
...
newRunAggregationQueryResponse 
    ::  RunAggregationQueryResponse
newRunAggregationQueryResponse
  = RunAggregationQueryResponse{batch = Core.Nothing,
                                explainMetrics = Core.Nothing, query = Core.Nothing,
                                transaction = Core.Nothing}
          ...
          = Core.withObject "RunAggregationQueryResponse"
              (\ o ->
                 RunAggregationQueryResponse Core.<$>
                   (o Core..:? "batch") Core.<*> (o Core..:? "explainMetrics")
                     Core.<*> (o Core..:? "query")
                     Core.<*> (o Core..:? "transaction"))
...
newRunQueryRequest 
    ::  RunQueryRequest
newRunQueryRequest
  = RunQueryRequest{databaseId = Core.Nothing,
                    explainOptions = Core.Nothing, gqlQuery = Core.Nothing,
                    partitionId = Core.Nothing, propertyMask = Core.Nothing,
                    query = Core.Nothing, readOptions = Core.Nothing}
instance Core.FromJSON RunQueryRequest where
        parseJSON
          = Core.withObject "RunQueryRequest"
              (\ o ->
                 RunQueryRequest Core.<$>
                   (o Core..:? "databaseId") Core.<*> (o Core..:? "explainOptions")
                     Core.<*> (o Core..:? "gqlQuery")
                     Core.<*> (o Core..:? "partitionId")
                     Core.<*> (o Core..:? "propertyMask")
                     Core.<*> (o Core..:? "query")
...
newRunQueryResponse 
    ::  RunQueryResponse
newRunQueryResponse
  = RunQueryResponse{batch = Core.Nothing,
                     explainMetrics = Core.Nothing, query = Core.Nothing,
                     transaction = Core.Nothing}
...
newValue 
    ::  Value
newValue
  = Value{arrayValue = Core.Nothing, blobValue = Core.Nothing,
          booleanValue = Core.Nothing, doubleValue = Core.Nothing,
          entityValue = Core.Nothing, excludeFromIndexes = Core.Nothing,
          geoPointValue = Core.Nothing, integerValue = Core.Nothing,
          keyValue = Core.Nothing, meaning = Core.Nothing,
          nullValue = Core.Nothing, stringValue = Core.Nothing,
...
instance Core.FromJSON Value where
        parseJSON
          = Core.withObject "Value"
              (\ o ->
                 Value Core.<$>
                   (o Core..:? "arrayValue") Core.<*> (o Core..:? "blobValue")
