...
instance Core.FromJSON Aggregation where
        parseJSON
          = Core.withObject "Aggregation"
              (\ o ->
                 Aggregation Core.<$>
                   (o Core..:? "alias") Core.<*> (o Core..:? "count"))
...
instance Core.FromJSON AggregationResult where
        parseJSON
          = Core.withObject "AggregationResult"
              (\ o ->
                 AggregationResult Core.<$>
                   (o Core..:? "aggregateProperties"))

instance Core.ToJSON AggregationResult where
        toJSON AggregationResult{..}
          = Core.object
              (Core.catMaybes
                 [("aggregateProperties" Core..=) Core.<$>
                    aggregateProperties])
...
newBeginTransactionRequest =
  BeginTransactionRequest
    {databaseId = Core.Nothing, transactionOptions = Core.Nothing}
...
newGoogleDatastoreAdminV1DatastoreFirestoreMigrationMetadata =
  GoogleDatastoreAdminV1DatastoreFirestoreMigrationMetadata
    {migrationState = Core.Nothing, migrationStep = Core.Nothing}
...
newGoogleDatastoreAdminV1EntityFilter =
  GoogleDatastoreAdminV1EntityFilter
    {kinds = Core.Nothing, namespaceIds = Core.Nothing}
...
instance Core.ToJSON GoogleDatastoreAdminV1Index
         where
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleDatastoreAdminV1IndexOperationMetadata Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "indexId")
                     Core.<*> (o Core..:? "progressEntities"))
...
newGoogleDatastoreAdminV1IndexedProperty =
  GoogleDatastoreAdminV1IndexedProperty
    {direction = Core.Nothing, name = Core.Nothing}
...
newGoogleDatastoreAdminV1Progress =
  GoogleDatastoreAdminV1Progress
    {workCompleted = Core.Nothing, workEstimated = Core.Nothing}

instance Core.FromJSON GoogleDatastoreAdminV1Progress
         where
        parseJSON
          = Core.withObject "GoogleDatastoreAdminV1Progress"
              (\ o ->
                 GoogleDatastoreAdminV1Progress Core.<$>
                   (o Core..:? "workCompleted" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "workEstimated" Core.<&>
                        Core.fmap Core.fromAsText))

instance Core.ToJSON GoogleDatastoreAdminV1Progress
         where
...
instance Core.FromJSON GqlQuery where
        parseJSON
          = Core.withObject "GqlQuery"
              (\ o ->
                 GqlQuery Core.<$>
                   (o Core..:? "allowLiterals") Core.<*>
                     (o Core..:? "namedBindings")
...
newLookupRequest =
  LookupRequest
    {databaseId = Core.Nothing, keys = Core.Nothing, readOptions = Core.Nothing}
...
instance Core.FromJSON LookupResponse where
        parseJSON
          = Core.withObject "LookupResponse"
              (\ o ->
                 LookupResponse Core.<$>
                   (o Core..:? "deferred") Core.<*> (o Core..:? "found")
                     Core.<*> (o Core..:? "missing")
                     Core.<*> (o Core..:? "readTime")
                     Core.<*> (o Core..:? "transaction"))
...
instance Core.ToJSON Mutation where
        toJSON Mutation{..}
          = Core.object
              (Core.catMaybes
                 [("baseVersion" Core..=) Core.. Core.AsText Core.<$>
                    baseVersion,
...
newPropertyFilter =
  PropertyFilter
    {op = Core.Nothing, property = Core.Nothing, value = Core.Nothing}
...
instance Core.FromJSON PropertyFilter where
        parseJSON
          = Core.withObject "PropertyFilter"
              (\ o ->
                 PropertyFilter Core.<$>
                   (o Core..:? "op") Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "value"))
          ...
          = Core.withObject "QueryResultBatch"
              (\ o ->
                 QueryResultBatch Core.<$>
                   (o Core..:? "endCursor") Core.<*>
                     (o Core..:? "entityResultType")
...
instance Core.FromJSON ReadWrite where
        parseJSON
          = Core.withObject "ReadWrite"
              (\ o ->
                 ReadWrite Core.<$>
                   (o Core..:? "previousTransaction"))

instance Core.ToJSON ReadWrite where
        toJSON ReadWrite{..}
          = Core.object
              (Core.catMaybes
                 [("previousTransaction" Core..=) Core.<$>
                    previousTransaction])
...
instance Core.FromJSON RunAggregationQueryRequest
         where
        parseJSON
          = Core.withObject "RunAggregationQueryRequest"
              (\ o ->
                 RunAggregationQueryRequest Core.<$>
                   (o Core..:? "aggregationQuery") Core.<*>
                     (o Core..:? "databaseId")
...
newRunAggregationQueryResponse =
  RunAggregationQueryResponse
    {batch = Core.Nothing, query = Core.Nothing, transaction = Core.Nothing}

instance Core.FromJSON RunAggregationQueryResponse
         where
        parseJSON
          = Core.withObject "RunAggregationQueryResponse"
              (\ o ->
                 RunAggregationQueryResponse Core.<$>
                   (o Core..:? "batch") Core.<*> (o Core..:? "query")
                     Core.<*> (o Core..:? "transaction"))

instance Core.ToJSON RunAggregationQueryResponse
         where
