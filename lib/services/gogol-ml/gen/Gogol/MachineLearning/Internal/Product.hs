...
newGoogleCloudMlV1_HyperparameterOutput_HyperparameterMetric =
  GoogleCloudMlV1_HyperparameterOutput_HyperparameterMetric
    {objectiveValue = Core.Nothing, trainingStep = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("objectiveValue" Core..=) Core.<$> objectiveValue,
                  ("trainingStep" Core..=) Core.. Core.AsText Core.<$>
                    trainingStep])
...
newGoogleCloudMlV1_Measurement_Metric =
  GoogleCloudMlV1_Measurement_Metric
    {metric = Core.Nothing, value = Core.Nothing}
...
newGoogleCloudMlV1_StudyConfig_MetricSpec =
  GoogleCloudMlV1_StudyConfig_MetricSpec
    {goal = Core.Nothing, metric = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON GoogleCloudMlV1_StudyConfig_ParameterSpec{..}
          = Core.object
              (Core.catMaybes
                 [("categoricalValueSpec" Core..=) Core.<$>
                    categoricalValueSpec,
                  ("childParameterSpecs" Core..=) Core.<$>
                    childParameterSpecs,
                  ("discreteValueSpec" Core..=) Core.<$>
                    discreteValueSpec,
                  ("doubleValueSpec" Core..=) Core.<$> doubleValueSpec,
                  ("integerValueSpec" Core..=) Core.<$>
                    integerValueSpec,
                  ("parameter" Core..=) Core.<$> parameter,
                  ("parentCategoricalValues" Core..=) Core.<$>
                    parentCategoricalValues,
                  ("parentDiscreteValues" Core..=) Core.<$>
...
instance Core.ToJSON GoogleCloudMlV1_Trial_Parameter
         where
...
newGoogleCloudMlV1__AcceleratorConfig =
  GoogleCloudMlV1__AcceleratorConfig
    {count = Core.Nothing, type' = Core.Nothing}
...
newGoogleCloudMlV1__AutoScaling =
  GoogleCloudMlV1__AutoScaling
    {maxNodes = Core.Nothing, metrics = Core.Nothing, minNodes = Core.Nothing}

instance Core.FromJSON GoogleCloudMlV1__AutoScaling
         where
        parseJSON
          = Core.withObject "GoogleCloudMlV1__AutoScaling"
              (\ o ->
                 GoogleCloudMlV1__AutoScaling Core.<$>
                   (o Core..:? "maxNodes") Core.<*>
                     (o Core..:? "metrics")
                     Core.<*> (o Core..:? "minNodes"))

instance Core.ToJSON GoogleCloudMlV1__AutoScaling
         where
...
newGoogleCloudMlV1__Capability =
  GoogleCloudMlV1__Capability
    {availableAccelerators = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON GoogleCloudMlV1__Capability
         where
        parseJSON
          = Core.withObject "GoogleCloudMlV1__Capability"
              (\ o ->
                 GoogleCloudMlV1__Capability Core.<$>
                   (o Core..:? "availableAccelerators") Core.<*>
                     (o Core..:? "type"))

instance Core.ToJSON GoogleCloudMlV1__Capability
         where
        toJSON GoogleCloudMlV1__Capability{..}
          = Core.object
              (Core.catMaybes
                 [("availableAccelerators" Core..=) Core.<$>
...
newGoogleCloudMlV1__CheckTrialEarlyStoppingStateMetatdata =
  GoogleCloudMlV1__CheckTrialEarlyStoppingStateMetatdata
    {createTime = Core.Nothing, study = Core.Nothing, trial = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON GoogleCloudMlV1__CompleteTrialRequest{..}
          = Core.object
              (Core.catMaybes
                 [("finalMeasurement" Core..=) Core.<$>
                    finalMeasurement,
                  ("infeasibleReason" Core..=) Core.<$>
                    infeasibleReason,
                  ("trialInfeasible" Core..=) Core.<$>
                    trialInfeasible])
...
instance Core.FromJSON GoogleCloudMlV1__ContainerPort
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudMlV1__ContainerPort
         where
...
instance Core.FromJSON GoogleCloudMlV1__ContainerSpec
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudMlV1__ContainerSpec
         where
...
instance Core.FromJSON GoogleCloudMlV1__DiskConfig
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudMlV1__DiskConfig
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "GoogleCloudMlV1__ExplainRequest"
              (\ o ->
                 GoogleCloudMlV1__ExplainRequest Core.<$>
                   (o Core..:? "httpBody"))

instance Core.ToJSON GoogleCloudMlV1__ExplainRequest
         where
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudMlV1__ExplanationConfig Core.<$>
                   (o Core..:? "integratedGradientsAttribution")
          ...
          = Core.object
              (Core.catMaybes
                 [("algorithm" Core..=) Core.<$> algorithm,
                  ...
                  ("maxParallelTrials" Core..=) Core.<$>
                    maxParallelTrials,
                  ("maxTrials" Core..=) Core.<$> maxTrials,
                  ("params" Core..=) Core.<$> params,
                  ("resumePreviousJobId" Core..=) Core.<$>
                    resumePreviousJobId])
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("jobPosition" Core..=) Core.. Core.AsText Core.<$>
                    jobPosition,
                  ("labels" Core..=) Core.<$> labels,
                  ("predictionInput" Core..=) Core.<$> predictionInput,
                  ("predictionOutput" Core..=) Core.<$>
                    predictionOutput,
                  ("startTime" Core..=) Core.<$> startTime,
                  ("state" Core..=) Core.<$> state,
...
instance Core.FromJSON GoogleCloudMlV1__Job_Labels
         where
        parseJSON
          = Core.withObject "GoogleCloudMlV1__Job_Labels"
              (\ o ->
                 GoogleCloudMlV1__Job_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GoogleCloudMlV1__Job_Labels
         where
...
newGoogleCloudMlV1__ListModelsResponse =
  GoogleCloudMlV1__ListModelsResponse
    {models = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudMlV1__ListTrialsResponse"
              (\ o ->
                 GoogleCloudMlV1__ListTrialsResponse Core.<$>
                   (o Core..:? "trials"))
...
newGoogleCloudMlV1__ListVersionsResponse =
  GoogleCloudMlV1__ListVersionsResponse
    {nextPageToken = Core.Nothing, versions = Core.Nothing}
...
instance Core.FromJSON GoogleCloudMlV1__Location
         where
        parseJSON
          = Core.withObject "GoogleCloudMlV1__Location"
              (\ o ->
                 GoogleCloudMlV1__Location Core.<$>
                   (o Core..:? "capabilities") Core.<*>
                     (o Core..:? "name"))
...
instance Core.FromJSON GoogleCloudMlV1__ManualScaling
         where
        parseJSON
          = Core.withObject "GoogleCloudMlV1__ManualScaling"
              (\ o ->
                 GoogleCloudMlV1__ManualScaling Core.<$>
                   (o Core..:? "nodes"))

instance Core.ToJSON GoogleCloudMlV1__ManualScaling
         where
...
instance Core.FromJSON GoogleCloudMlV1__Measurement
         where
        parseJSON
          = Core.withObject "GoogleCloudMlV1__Measurement"
              (\ o ->
                 GoogleCloudMlV1__Measurement Core.<$>
                   (o Core..:? "elapsedTime") Core.<*>
                     (o Core..:? "metrics")
                     Core.<*>
                     (o Core..:? "stepCount" Core.<&>
                        Core.fmap Core.fromAsText))

instance Core.ToJSON GoogleCloudMlV1__Measurement
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("elapsedTime" Core..=) Core.<$> elapsedTime,
                  ("metrics" Core..=) Core.<$> metrics,
                  ("stepCount" Core..=) Core.. Core.AsText Core.<$>
                    stepCount])
...
instance Core.FromJSON GoogleCloudMlV1__MetricSpec
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudMlV1__MetricSpec
         where
          ...
          = Core.withObject "GoogleCloudMlV1__Model"
              (\ o ->
                 GoogleCloudMlV1__Model Core.<$>
                   (o Core..:? "defaultVersion") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "onlinePredictionConsoleLogging")
...
instance Core.FromJSON GoogleCloudMlV1__Model_Labels
         where
        parseJSON
          = Core.withObject "GoogleCloudMlV1__Model_Labels"
              (\ o ->
                 GoogleCloudMlV1__Model_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GoogleCloudMlV1__Model_Labels
         where
...
instance Core.FromJSON GoogleCloudMlV1__ParameterSpec
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudMlV1__ParameterSpec
         where
        toJSON GoogleCloudMlV1__ParameterSpec{..}
          = Core.object
              (Core.catMaybes
                 [("categoricalValues" Core..=) Core.<$>
                    categoricalValues,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "GoogleCloudMlV1__PredictRequest"
              (\ o ->
                 GoogleCloudMlV1__PredictRequest Core.<$>
                   (o Core..:? "httpBody"))

instance Core.ToJSON GoogleCloudMlV1__PredictRequest
         where
...
instance Core.ToJSON GoogleCloudMlV1__PredictionInput
         where
          ...
          = Core.withObject "GoogleCloudMlV1__PredictionOutput"
              (\ o ->
                 GoogleCloudMlV1__PredictionOutput Core.<$>
                   (o Core..:? "errorCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "nodeHours")
                     Core.<*> (o Core..:? "outputPath")
                     Core.<*>
                     (o Core..:? "predictionCount" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON
        ...
        toJSON GoogleCloudMlV1__PredictionOutput{..}
          = Core.object
              (Core.catMaybes
                 [("errorCount" Core..=) Core.. Core.AsText Core.<$>
                    errorCount,
...
instance Core.FromJSON GoogleCloudMlV1__ReplicaConfig
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudMlV1__ReplicaConfig
         where
...
newGoogleCloudMlV1__RequestLoggingConfig =
  GoogleCloudMlV1__RequestLoggingConfig
    {bigqueryTableName = Core.Nothing, samplingPercentage = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON GoogleCloudMlV1__RequestLoggingConfig{..}
          = Core.object
              (Core.catMaybes
                 [("bigqueryTableName" Core..=) Core.<$>
                    bigqueryTableName,
                  ("samplingPercentage" Core..=) Core.<$>
                    samplingPercentage])
...
instance Core.FromJSON GoogleCloudMlV1__RouteMap
         where
        parseJSON
...
instance Core.FromJSON GoogleCloudMlV1__Scheduling
         where
        parseJSON
          = Core.withObject "GoogleCloudMlV1__Scheduling"
              (\ o ->
                 GoogleCloudMlV1__Scheduling Core.<$>
                   (o Core..:? "maxRunningTime") Core.<*>
                     (o Core..:? "maxWaitTime")
                     Core.<*> (o Core..:? "priority"))

instance Core.ToJSON GoogleCloudMlV1__Scheduling
         where
...
instance Core.FromJSON GoogleCloudMlV1__StudyConfig
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudMlV1__StudyConfig
         where
...
newGoogleCloudMlV1__SuggestTrialsRequest =
  GoogleCloudMlV1__SuggestTrialsRequest
    {clientId = Core.Nothing, suggestionCount = Core.Nothing}
...
instance Core.FromJSON GoogleCloudMlV1__TrainingInput
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudMlV1__TrainingInput
         where
...
instance Core.ToJSON GoogleCloudMlV1__TrainingOutput
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("builtInAlgorithmOutput" Core..=) Core.<$>
                  ...
                  ("hyperparameterMetricTag" Core..=) Core.<$>
                    hyperparameterMetricTag,
                  ("isBuiltInAlgorithmJob" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("acceleratorConfig" Core..=) Core.<$>
                  ...
                  ("errorMessage" Core..=) Core.<$> errorMessage,
                  ("etag" Core..=) Core.<$> etag,
                  ("explanationConfig" Core..=) Core.<$>
                    explanationConfig,
                  ("framework" Core..=) Core.<$> framework,
                  ("isDefault" Core..=) Core.<$> isDefault,
                  ("labels" Core..=) Core.<$> labels,
                  ("lastMigrationModelId" Core..=) Core.<$>
                    lastMigrationModelId,
                  ("lastMigrationTime" Core..=) Core.<$>
                    lastMigrationTime,
                  ...
                  ("pythonVersion" Core..=) Core.<$> pythonVersion,
                  ("requestLoggingConfig" Core..=) Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "GoogleCloudMlV1__Version_Labels"
              (\ o ->
                 GoogleCloudMlV1__Version_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GoogleCloudMlV1__Version_Labels
         where
...
instance Core.ToJSON GoogleCloudMlV1__XraiAttribution
         where
...
instance Core.FromJSON GoogleIamV1__AuditLogConfig
         where
        parseJSON
...
instance Core.ToJSON GoogleIamV1__AuditLogConfig
         where
...
instance Core.ToJSON GoogleIamV1__SetIamPolicyRequest
         where
...
instance Core.FromJSON GoogleLongrunning__Operation
         where
        parseJSON
...
instance Core.ToJSON GoogleLongrunning__Operation
         where
...
instance Core.FromJSON GoogleRpc__Status_DetailsItem
         where
        parseJSON
          = Core.withObject "GoogleRpc__Status_DetailsItem"
              (\ o ->
                 GoogleRpc__Status_DetailsItem Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GoogleRpc__Status_DetailsItem
         where
