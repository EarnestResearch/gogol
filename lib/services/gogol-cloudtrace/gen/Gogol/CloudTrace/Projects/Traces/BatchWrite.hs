                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BatchWriteSpansRequest Core.:>
...
newCloudTraceProjectsTracesBatchWrite name payload
  = CloudTraceProjectsTracesBatchWrite{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, payload = payload, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudTraceProjectsTracesBatchWrite
         where
        type Rs CloudTraceProjectsTracesBatchWrite = Empty
        type Scopes CloudTraceProjectsTracesBatchWrite =
