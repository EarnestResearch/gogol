...
instance Core.FromJSON AccessDeniedPageSettings where
        parseJSON
          = Core.withObject "AccessDeniedPageSettings"
              (\ o ->
                 AccessDeniedPageSettings Core.<$>
                   (o Core..:? "accessDeniedPageUri") Core.<*>
                     (o Core..:? "generateTroubleshootingUri")
                     Core.<*>
                     (o Core..:? "remediationTokenGenerationEnabled"))

instance Core.ToJSON AccessDeniedPageSettings where
        toJSON AccessDeniedPageSettings{..}
          = Core.object
              (Core.catMaybes
                 [("accessDeniedPageUri" Core..=) Core.<$>
                    accessDeniedPageUri,
                  ("generateTroubleshootingUri" Core..=) Core.<$>
...
instance Core.FromJSON AccessSettings where
        parseJSON
          = Core.withObject "AccessSettings"
              (\ o ->
                 AccessSettings Core.<$>
                   (o Core..:? "allowedDomainsSettings") Core.<*>
                     (o Core..:? "corsSettings")
...
instance Core.FromJSON AllowedDomainsSettings where
        parseJSON
          = Core.withObject "AllowedDomainsSettings"
              (\ o ->
...
instance Core.FromJSON ApplicationSettings where
        parseJSON
          = Core.withObject "ApplicationSettings"
              (\ o ->
                 ApplicationSettings Core.<$>
                   (o Core..:? "accessDeniedPageSettings") Core.<*>
                     (o Core..:? "attributePropagationSettings")
...
instance Core.ToJSON ApplicationSettings where
        toJSON ApplicationSettings{..}
          = Core.object
              (Core.catMaybes
                 [("accessDeniedPageSettings" Core..=) Core.<$>
                    accessDeniedPageSettings,
                  ("attributePropagationSettings" Core..=) Core.<$>
                    attributePropagationSettings,
...
instance Core.FromJSON AttributePropagationSettings
         where
        parseJSON
          = Core.withObject "AttributePropagationSettings"
              (\ o ->
...
instance Core.ToJSON AttributePropagationSettings
         where
...
instance Core.FromJSON Brand where
        parseJSON
          = Core.withObject "Brand"
              (\ o ->
                 Brand Core.<$>
                   (o Core..:? "applicationTitle") Core.<*>
                     (o Core..:? "name")
...
instance Core.FromJSON CorsSettings where
        parseJSON
          = Core.withObject "CorsSettings"
              (\ o ->
                 CorsSettings Core.<$>
                   (o Core..:? "allowHttpOptions"))

instance Core.ToJSON CorsSettings where
        toJSON CorsSettings{..}
          = Core.object
              (Core.catMaybes
                 [("allowHttpOptions" Core..=) Core.<$>
                    allowHttpOptions])
...
instance Core.FromJSON GcipSettings where
        parseJSON
          = Core.withObject "GcipSettings"
              (\ o ->
                 GcipSettings Core.<$>
                   (o Core..:? "loginPageUri") Core.<*>
                     (o Core..:? "tenantIds"))
...
instance Core.FromJSON IapSettings where
        parseJSON
          = Core.withObject "IapSettings"
              (\ o ->
                 IapSettings Core.<$>
                   (o Core..:? "accessSettings") Core.<*>
                     (o Core..:? "applicationSettings")
                     Core.<*> (o Core..:? "name"))
...
newIdentityAwareProxyClient =
  IdentityAwareProxyClient
    {displayName = Core.Nothing, name = Core.Nothing, secret = Core.Nothing}

instance Core.FromJSON IdentityAwareProxyClient where
        parseJSON
          = Core.withObject "IdentityAwareProxyClient"
              (\ o ->
                 IdentityAwareProxyClient Core.<$>
...
instance Core.FromJSON ListBrandsResponse where
        parseJSON
          = Core.withObject "ListBrandsResponse"
              (\ o ->
...
newListIdentityAwareProxyClientsResponse =
  ListIdentityAwareProxyClientsResponse
    {identityAwareProxyClients = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ListIdentityAwareProxyClientsResponse"
              (\ o ->
                 ListIdentityAwareProxyClientsResponse Core.<$>
                   (o Core..:? "identityAwareProxyClients") Core.<*>
...
instance Core.ToJSON
        ...
        toJSON ListIdentityAwareProxyClientsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("identityAwareProxyClients" Core..=) Core.<$>
...
newListTunnelDestGroupsResponse =
  ListTunnelDestGroupsResponse
    {nextPageToken = Core.Nothing, tunnelDestGroups = Core.Nothing}

instance Core.FromJSON ListTunnelDestGroupsResponse
         where
        parseJSON
          = Core.withObject "ListTunnelDestGroupsResponse"
              (\ o ->
                 ListTunnelDestGroupsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "tunnelDestGroups"))

instance Core.ToJSON ListTunnelDestGroupsResponse
         where
        toJSON ListTunnelDestGroupsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("tunnelDestGroups" Core..=) Core.<$>
                    tunnelDestGroups])
...
instance Core.FromJSON PolicyDelegationSettings where
        parseJSON
          = Core.withObject "PolicyDelegationSettings"
              (\ o ->
                 PolicyDelegationSettings Core.<$>
                   (o Core..:? "iamPermission") Core.<*>
                     (o Core..:? "iamServiceName")
...
instance Core.FromJSON PolicyName where
        parseJSON
          = Core.withObject "PolicyName"
              (\ o ->
                 PolicyName Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "region")
                     Core.<*> (o Core..:? "type"))
...
newReauthSettings =
  ReauthSettings
    {maxAge = Core.Nothing, method = Core.Nothing, policyType = Core.Nothing}

instance Core.FromJSON ReauthSettings where
        parseJSON
          = Core.withObject "ReauthSettings"
              (\ o ->
                 ReauthSettings Core.<$>
                   (o Core..:? "maxAge") Core.<*> (o Core..:? "method")
...
newTunnelDestGroup =
  TunnelDestGroup
    {cidrs = Core.Nothing, fqdns = Core.Nothing, name = Core.Nothing}

instance Core.FromJSON TunnelDestGroup where
        parseJSON
          = Core.withObject "TunnelDestGroup"
              (\ o ->
                 TunnelDestGroup Core.<$>
                   (o Core..:? "cidrs") Core.<*> (o Core..:? "fqdns")
                     Core.<*> (o Core..:? "name"))
