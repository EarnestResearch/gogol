...
newCertVerification 
    ::  CertVerification
newCertVerification
  = CertVerification{dns = Core.Nothing, http = Core.Nothing}
...
instance Core.ToJSON CertVerification where
        toJSON CertVerification{..}
          = Core.object
              (Core.catMaybes
                 [("dns" Core..=) Core.<$> dns, ("http" Core..=) Core.<$> http])
...
newCustomDomainMetadata 
    ::  CustomDomainMetadata
newCustomDomainMetadata
  = CustomDomainMetadata{certState = Core.Nothing,
                         hostState = Core.Nothing, issues = Core.Nothing,
                         liveMigrationSteps = Core.Nothing, ownershipState = Core.Nothing,
          ...
          = Core.withObject "CustomDomainMetadata"
              (\ o ->
                 CustomDomainMetadata Core.<$>
                   (o Core..:? "certState") Core.<*> (o Core..:? "hostState") Core.<*>
                     (o Core..:? "issues")
          ...
          = Core.object
              (Core.catMaybes
                 [("certState" Core..=) Core.<$> certState,
                  ...
                  ("liveMigrationSteps" Core..=) Core.<$> liveMigrationSteps,
                  ("ownershipState" Core..=) Core.<$> ownershipState,
                  ("quickSetupUpdates" Core..=) Core.<$> quickSetupUpdates])
...
newDnsRecord 
    ::  DnsRecord
newDnsRecord
  = DnsRecord{domainName = Core.Nothing, rdata = Core.Nothing,
              requiredAction = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON DnsRecord where
        parseJSON
          = Core.withObject "DnsRecord"
              (\ o ->
                 DnsRecord Core.<$>
                   (o Core..:? "domainName") Core.<*> (o Core..:? "rdata") Core.<*>
                     (o Core..:? "requiredAction")
                     Core.<*> (o Core..:? "type"))
...
newDnsRecordSet 
    ::  DnsRecordSet
newDnsRecordSet
  = DnsRecordSet{checkError = Core.Nothing,
                 domainName = Core.Nothing, records = Core.Nothing}
instance Core.FromJSON DnsRecordSet where
        parseJSON
          = Core.withObject "DnsRecordSet"
              (\ o ->
                 DnsRecordSet Core.<$>
                   (o Core..:? "checkError") Core.<*> (o Core..:? "domainName")
                     Core.<*> (o Core..:? "records"))
...
newDnsUpdates 
    ::  DnsUpdates
newDnsUpdates
  = DnsUpdates{checkTime = Core.Nothing, desired = Core.Nothing,
...
instance Core.FromJSON DnsUpdates where
        parseJSON
          = Core.withObject "DnsUpdates"
              (\ o ->
                 DnsUpdates Core.<$>
                   (o Core..:? "checkTime") Core.<*> (o Core..:? "desired") Core.<*>
                     (o Core..:? "discovered"))
...
newHttpUpdate 
    ::  HttpUpdate
newHttpUpdate
  = HttpUpdate{checkError = Core.Nothing, desired = Core.Nothing,
               discovered = Core.Nothing, lastCheckTime = Core.Nothing,
               path = Core.Nothing}
instance Core.FromJSON HttpUpdate where
        parseJSON
          = Core.withObject "HttpUpdate"
              (\ o ->
                 HttpUpdate Core.<$>
                   (o Core..:? "checkError") Core.<*> (o Core..:? "desired") Core.<*>
                     (o Core..:? "discovered")
...
newLiveMigrationStep 
    ::  LiveMigrationStep
newLiveMigrationStep
  = LiveMigrationStep{certVerification = Core.Nothing,
                      dnsUpdates = Core.Nothing, issues = Core.Nothing,
                      state = Core.Nothing}
          ...
          = Core.withObject "LiveMigrationStep"
              (\ o ->
                 LiveMigrationStep Core.<$>
                   (o Core..:? "certVerification") Core.<*> (o Core..:? "dnsUpdates")
                     Core.<*> (o Core..:? "issues")
                     Core.<*> (o Core..:? "state"))
...
instance Core.ToJSON LiveMigrationStep where
        toJSON LiveMigrationStep{..}
          = Core.object
              (Core.catMaybes
                 [("certVerification" Core..=) Core.<$> certVerification,
