               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "completedMax" Core.Text Core.:>
                       Core.QueryParam "completedMin" Core.Text Core.:>
                         Core.QueryParam "dueMax" Core.Text Core.:>
                           Core.QueryParam "dueMin" Core.Text Core.:>
                             Core.QueryParam "maxResults" Core.Int32 Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "showCompleted" Core.Bool
                                   Core.:>
                                   Core.QueryParam "showDeleted" Core.Bool
                                     Core.:>
                                     Core.QueryParam "showHidden" Core.Bool
                                       Core.:>
                                       Core.QueryParam "updatedMin" Core.Text
                                         Core.:>
...
instance Core.GoogleRequest TasksTasksList where
        ...
        type Scopes TasksTasksList =
             '[Tasks'FullControl, Tasks'Readonly]
        requestClient TasksTasksList{..}
          = go tasklist xgafv accessToken callback completedMax
              completedMin
              dueMax
              dueMin
              maxResults
