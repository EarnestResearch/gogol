...
instance Core.FromJSON DeleteEventsResponse where
        parseJSON
          = Core.withObject "DeleteEventsResponse"
...
instance Core.FromJSON ErrorContext where
        parseJSON
          = Core.withObject "ErrorContext"
              (\ o ->
                 ErrorContext Core.<$>
                   (o Core..:? "httpRequest") Core.<*>
                     (o Core..:? "reportLocation")
...
instance Core.FromJSON ErrorGroup where
        parseJSON
          = Core.withObject "ErrorGroup"
              (\ o ->
                 ErrorGroup Core.<$>
                   (o Core..:? "groupId") Core.<*> (o Core..:? "name")
...
instance Core.FromJSON ErrorGroupStats where
        parseJSON
          = Core.withObject "ErrorGroupStats"
              (\ o ->
                 ErrorGroupStats Core.<$>
                   (o Core..:? "affectedServices") Core.<*>
                     (o Core..:? "affectedUsersCount" Core.<&>
...
instance Core.FromJSON HttpRequestContext where
        parseJSON
          = Core.withObject "HttpRequestContext"
              (\ o ->
                 HttpRequestContext Core.<$>
                   (o Core..:? "method") Core.<*>
                     (o Core..:? "referrer")
...
instance Core.FromJSON ListEventsResponse where
        parseJSON
          = Core.withObject "ListEventsResponse"
              (\ o ->
                 ListEventsResponse Core.<$>
                   (o Core..:? "errorEvents") Core.<*>
...
instance Core.FromJSON ListGroupStatsResponse where
        parseJSON
          = Core.withObject "ListGroupStatsResponse"
              (\ o ->
                 ListGroupStatsResponse Core.<$>
                   (o Core..:? "errorGroupStats") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "timeRangeBegin"))
...
instance Core.FromJSON ReportErrorEventResponse where
        parseJSON
          = Core.withObject "ReportErrorEventResponse"
...
data ReportedErrorEvent = ReportedErrorEvent
    ...
    , eventTime :: (Core.Maybe Core.DateTime)
      ...
      -- <https://msdn.microsoft.com/en-us/library/system.exception.tostring.aspx Exception.ToString()>. * __PHP__: Must be prefixed with @\"PHP (Notice|Parse error|Fatal error|Warning): \"@ and contain the result of <https://php.net/manual/en/exception.tostring.php (string)$exception>. * __Go__: Must be the return value of <https://golang.org/pkg/runtime/debug/#Stack runtime.Stack()>.
    , message :: (Core.Maybe Core.Text)
...
instance Core.FromJSON ReportedErrorEvent where
        parseJSON
          = Core.withObject "ReportedErrorEvent"
              (\ o ->
                 ReportedErrorEvent Core.<$>
                   (o Core..:? "context") Core.<*>
                     (o Core..:? "eventTime")
                     Core.<*> (o Core..:? "message")
                     Core.<*> (o Core..:? "serviceContext"))
...
instance Core.FromJSON ServiceContext where
        parseJSON
          = Core.withObject "ServiceContext"
              (\ o ->
                 ServiceContext Core.<$>
...
newTimedCount =
  TimedCount
    {count = Core.Nothing, endTime = Core.Nothing, startTime = Core.Nothing}

instance Core.FromJSON TimedCount where
        parseJSON
          = Core.withObject "TimedCount"
              (\ o ->
                 TimedCount Core.<$>
                   (o Core..:? "count" Core.<&>
                      Core.fmap Core.fromAsText)
