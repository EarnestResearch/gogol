               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ErrorGroup Core.:>
                       Core.Put '[Core.JSON] ErrorGroup
...
instance Core.GoogleRequest
           CloudErrorReportingProjectsGroupsUpdate
         where
        type Rs CloudErrorReportingProjectsGroupsUpdate =
             ErrorGroup
        type Scopes CloudErrorReportingProjectsGroupsUpdate =
