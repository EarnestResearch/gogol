                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] ReportedErrorEvent Core.:>
                         Core.Post '[Core.JSON] ReportErrorEventResponse
...
instance Core.GoogleRequest
           CloudErrorReportingProjectsEventsReport
         where
        type Rs CloudErrorReportingProjectsEventsReport =
             ReportErrorEventResponse
        type Scopes CloudErrorReportingProjectsEventsReport =
             '[CloudPlatform'FullControl]
        requestClient
          CloudErrorReportingProjectsEventsReport{..}
          = go projectName xgafv accessToken callback
              uploadType
              uploadProtocol
