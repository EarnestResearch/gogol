                 ...
                 Core.QueryParam "alignmentTime" Core.DateTime Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParams "groupId" Core.Text Core.:>
                       Core.QueryParam "order" ProjectsGroupStatsListOrder
                         Core.:>
...
instance Core.GoogleRequest
           CloudErrorReportingProjectsGroupStatsList
         where
        type Rs CloudErrorReportingProjectsGroupStatsList =
             ListGroupStatsResponse
        type Scopes CloudErrorReportingProjectsGroupStatsList
