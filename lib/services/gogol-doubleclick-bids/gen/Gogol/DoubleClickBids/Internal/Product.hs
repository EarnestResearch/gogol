...
newChannelGrouping =
  ChannelGrouping
    {fallbackName = Core.Nothing, name = Core.Nothing, rules = Core.Nothing}
...
instance Core.FromJSON DataRange where
        parseJSON
          = Core.withObject "DataRange"
              (\ o ->
                 DataRange Core.<$>
                   (o Core..:? "customEndDate") Core.<*>
                     (o Core..:? "customStartDate")
                     Core.<*> (o Core..:? "range"))
...
instance Core.FromJSON ListQueriesResponse where
        parseJSON
          = Core.withObject "ListQueriesResponse"
              (\ o ->
                 ListQueriesResponse Core.<$>
...
instance Core.FromJSON Options where
        parseJSON
          = Core.withObject "Options"
              (\ o ->
                 Options Core.<$>
                   (o Core..:? "includeOnlyTargetedUserLists") Core.<*>
                     (o Core..:? "pathQueryOptions"))

instance Core.ToJSON Options where
        toJSON Options{..}
          = Core.object
              (Core.catMaybes
                 [("includeOnlyTargetedUserLists" Core..=) Core.<$>
                    includeOnlyTargetedUserLists,
                  ("pathQueryOptions" Core..=) Core.<$>
                    pathQueryOptions])
...
data Parameters = Parameters
    ...
    , options :: (Core.Maybe Options)
      -- | The type of the report. The type of the report will dictate what dimesions, filters, and metrics can be used. __Warning:__ The @AUDIENCE_COMPOSITION@ report type will be deprecated in Display & Video 360 on __June 8, 2023__. Once deprecated, you will no longer be able to create new or retrieve existing Query and Report resources of this type.
...
instance Core.FromJSON PathQueryOptions where
        parseJSON
          = Core.withObject "PathQueryOptions"
              (\ o ->
                 PathQueryOptions Core.<$>
                   (o Core..:? "channelGrouping") Core.<*>
                     (o Core..:? "pathFilters"))
...
newPathQueryOptionsFilter =
  PathQueryOptionsFilter
    {filter = Core.Nothing, match = Core.Nothing, values = Core.Nothing}

instance Core.FromJSON PathQueryOptionsFilter where
        parseJSON
          = Core.withObject "PathQueryOptionsFilter"
              (\ o ->
                 PathQueryOptionsFilter Core.<$>
                   (o Core..:? "filter") Core.<*> (o Core..:? "match")
                     Core.<*> (o Core..:? "values"))
          ...
          = Core.object
              (Core.catMaybes
                 [("metadata" Core..=) Core.<$> metadata,
                  ...
                  ("queryId" Core..=) Core.. Core.AsText Core.<$>
                    queryId,
...
instance Core.FromJSON QueryMetadata where
        parseJSON
          = Core.withObject "QueryMetadata"
              (\ o ->
                 QueryMetadata Core.<$>
                   (o Core..:? "dataRange") Core.<*>
                     (o Core..:? "format")
...
instance Core.FromJSON Report where
        parseJSON
          = Core.withObject "Report"
              (\ o ->
                 Report Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "params"))
...
instance Core.FromJSON ReportMetadata where
        parseJSON
          = Core.withObject "ReportMetadata"
              (\ o ->
                 ReportMetadata Core.<$>
                   (o Core..:? "googleCloudStoragePath") Core.<*>
                     (o Core..:? "reportDataEndDate")
...
instance Core.ToJSON ReportMetadata where
        toJSON ReportMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("googleCloudStoragePath" Core..=) Core.<$>
                    googleCloudStoragePath,
                  ("reportDataEndDate" Core..=) Core.<$>
                    reportDataEndDate,
                  ("reportDataStartDate" Core..=) Core.<$>
                    reportDataStartDate,
...
newReportStatus =
  ReportStatus
    {finishTime = Core.Nothing, format = Core.Nothing, state = Core.Nothing}

instance Core.FromJSON ReportStatus where
        parseJSON
          = Core.withObject "ReportStatus"
              (\ o ->
                 ReportStatus Core.<$>
