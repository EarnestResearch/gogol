...
newAggregateBucket 
    ::  AggregateBucket
newAggregateBucket
  = AggregateBucket{activity = Core.Nothing, dataset = Core.Nothing,
                    endTimeMillis = Core.Nothing, session = Core.Nothing,
                    startTimeMillis = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON AggregateBucket where
        parseJSON
          = Core.withObject "AggregateBucket"
              (\ o ->
                 AggregateBucket Core.<$>
                   (o Core..:? "activity") Core.<*> (o Core..:? "dataset") Core.<*>
                     (o Core..:? "endTimeMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "session")
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("activity" Core..=) Core.<$> activity,
                  ...
                  ("endTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    endTimeMillis,
...
newAggregateBy 
    ::  AggregateBy
newAggregateBy
  = AggregateBy{dataSourceId = Core.Nothing,
                dataTypeName = Core.Nothing}
instance Core.FromJSON AggregateBy where
        parseJSON
          = Core.withObject "AggregateBy"
              (\ o ->
                 AggregateBy Core.<$>
                   (o Core..:? "dataSourceId") Core.<*> (o Core..:? "dataTypeName"))
...
newAggregateRequest 
    ::  AggregateRequest
newAggregateRequest
  = AggregateRequest{aggregateBy = Core.Nothing,
                     bucketByActivitySegment = Core.Nothing,
                     bucketByActivityType = Core.Nothing,
                     bucketBySession = Core.Nothing, bucketByTime = Core.Nothing,
...
instance Core.FromJSON AggregateRequest where
        parseJSON
          = Core.withObject "AggregateRequest"
              (\ o ->
                 AggregateRequest Core.<$>
                   (o Core..:? "aggregateBy") Core.<*>
                     (o Core..:? "bucketByActivitySegment")
          ...
          = Core.object
              (Core.catMaybes
                 [("aggregateBy" Core..=) Core.<$> aggregateBy,
                  ("bucketByActivitySegment" Core..=) Core.<$>
                  ...
                  ("endTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    endTimeMillis,
                  ("filteredDataQualityStandard" Core..=) Core.<$>
...
instance Core.FromJSON AggregateResponse where
        parseJSON
          = Core.withObject "AggregateResponse"
...
newApplication 
    ::  Application
newApplication
  = Application{detailsUrl = Core.Nothing, name = Core.Nothing,
                packageName = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON Application where
        parseJSON
          = Core.withObject "Application"
              (\ o ->
                 Application Core.<$>
                   (o Core..:? "detailsUrl") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "packageName")
                     Core.<*> (o Core..:? "version"))
...
newBucketByActivity 
    ::  BucketByActivity
newBucketByActivity
  = BucketByActivity{activityDataSourceId = Core.Nothing,
                     minDurationMillis = Core.Nothing}
instance Core.FromJSON BucketByActivity where
        parseJSON
          = Core.withObject "BucketByActivity"
              (\ o ->
                 BucketByActivity Core.<$>
                   (o Core..:? "activityDataSourceId") Core.<*>
                     (o Core..:? "minDurationMillis" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("activityDataSourceId" Core..=) Core.<$> activityDataSourceId,
                  ("minDurationMillis" Core..=) Core.. Core.AsText Core.<$>
                    minDurationMillis])
...
instance Core.FromJSON BucketBySession where
        parseJSON
          = Core.withObject "BucketBySession"
              (\ o ->
                 BucketBySession Core.<$>
                   (o Core..:? "minDurationMillis" Core.<&>
                      Core.fmap Core.fromAsText))
...
newBucketByTime 
    ::  BucketByTime
newBucketByTime
  = BucketByTime{durationMillis = Core.Nothing,
                 period = Core.Nothing}
instance Core.FromJSON BucketByTime where
        parseJSON
          = Core.withObject "BucketByTime"
              (\ o ->
                 BucketByTime Core.<$>
...
newBucketByTimePeriod 
    ::  BucketByTimePeriod
newBucketByTimePeriod
  = BucketByTimePeriod{timeZoneId = Core.Nothing,
                       type' = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON BucketByTimePeriod where
        parseJSON
          = Core.withObject "BucketByTimePeriod"
              (\ o ->
                 BucketByTimePeriod Core.<$>
                   (o Core..:? "timeZoneId") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "value"))
...
newDataPoint 
    ::  DataPoint
newDataPoint
  = DataPoint{computationTimeMillis = Core.Nothing,
              dataTypeName = Core.Nothing, endTimeNanos = Core.Nothing,
              modifiedTimeMillis = Core.Nothing,
              originDataSourceId = Core.Nothing,
              rawTimestampNanos = Core.Nothing, startTimeNanos = Core.Nothing,
              value = Core.Nothing}
instance Core.FromJSON DataPoint where
        parseJSON
          = Core.withObject "DataPoint"
              (\ o ->
                 DataPoint Core.<$>
                   (o Core..:? "computationTimeMillis" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "dataTypeName")
                     Core.<*>
                     (o Core..:? "endTimeNanos" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "modifiedTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "originDataSourceId")
                     Core.<*>
                     (o Core..:? "rawTimestampNanos" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "startTimeNanos" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "value"))
...
instance Core.ToJSON DataPoint where
        toJSON DataPoint{..}
          = Core.object
              (Core.catMaybes
                 [("computationTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    computationTimeMillis,
                  ("dataTypeName" Core..=) Core.<$> dataTypeName,
                  ("endTimeNanos" Core..=) Core.. Core.AsText Core.<$> endTimeNanos,
                  ("modifiedTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    modifiedTimeMillis,
                  ("originDataSourceId" Core..=) Core.<$> originDataSourceId,
                  ("rawTimestampNanos" Core..=) Core.. Core.AsText Core.<$>
                    rawTimestampNanos,
                  ("startTimeNanos" Core..=) Core.. Core.AsText Core.<$>
                    startTimeNanos,
...
newDataSource 
    ::  DataSource
newDataSource
  = DataSource{application = Core.Nothing,
               dataQualityStandard = Core.Nothing, dataStreamId = Core.Nothing,
               dataStreamName = Core.Nothing, dataType = Core.Nothing,
               device = Core.Nothing, name = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON DataSource where
        parseJSON
          = Core.withObject "DataSource"
              (\ o ->
                 DataSource Core.<$>
                   (o Core..:? "application") Core.<*>
                     (o Core..:? "dataQualityStandard")
          ...
          = Core.object
              (Core.catMaybes
                 [("application" Core..=) Core.<$> application,
                  ...
                  ("device" Core..=) Core.<$> device, ("name" Core..=) Core.<$> name,
                  ("type" Core..=) Core.<$> type'])
...
instance Core.FromJSON DataType where
        parseJSON
          = Core.withObject "DataType"
              (\ o ->
                 DataType Core.<$>
                   (o Core..:? "field") Core.<*> (o Core..:? "name"))
...
newDataTypeField 
    ::  DataTypeField
newDataTypeField
  = DataTypeField{format = Core.Nothing, name = Core.Nothing,
                  optional = Core.Nothing}
instance Core.FromJSON DataTypeField where
        parseJSON
          = Core.withObject "DataTypeField"
              (\ o ->
                 DataTypeField Core.<$>
                   (o Core..:? "format") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "optional"))
...
newDataset 
    ::  Dataset
newDataset
  = Dataset{dataSourceId = Core.Nothing, maxEndTimeNs = Core.Nothing,
            minStartTimeNs = Core.Nothing, nextPageToken = Core.Nothing,
            point = Core.Nothing}
              ...
              (\ o ->
                 Dataset Core.<$>
                   (o Core..:? "dataSourceId") Core.<*>
                     (o Core..:? "maxEndTimeNs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minStartTimeNs" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("dataSourceId" Core..=) Core.<$> dataSourceId,
                  ...
                  ("minStartTimeNs" Core..=) Core.. Core.AsText Core.<$>
                    minStartTimeNs,
...
newDevice 
    ::  Device
newDevice
  = Device{manufacturer = Core.Nothing, model = Core.Nothing,
           type' = Core.Nothing, uid = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON Device where
        parseJSON
          = Core.withObject "Device"
              (\ o ->
                 Device Core.<$>
                   (o Core..:? "manufacturer") Core.<*> (o Core..:? "model") Core.<*>
                     (o Core..:? "type")
                     Core.<*> (o Core..:? "uid")
                     Core.<*> (o Core..:? "version"))
...
newListDataPointChangesResponse 
    ::  ListDataPointChangesResponse
newListDataPointChangesResponse
  = ListDataPointChangesResponse{dataSourceId = Core.Nothing,
                                 deletedDataPoint = Core.Nothing, insertedDataPoint = Core.Nothing,
                                 nextPageToken = Core.Nothing}
instance Core.FromJSON ListDataPointChangesResponse where
        parseJSON
          = Core.withObject "ListDataPointChangesResponse"
              (\ o ->
                 ListDataPointChangesResponse Core.<$>
                   (o Core..:? "dataSourceId") Core.<*>
                     (o Core..:? "deletedDataPoint")
...
newListSessionsResponse 
    ::  ListSessionsResponse
newListSessionsResponse
  = ListSessionsResponse{deletedSession = Core.Nothing,
                         hasMoreData = Core.Nothing, nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListSessionsResponse"
              (\ o ->
                 ListSessionsResponse Core.<$>
                   (o Core..:? "deletedSession") Core.<*> (o Core..:? "hasMoreData")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "session"))
...
newSession 
    ::  Session
newSession
  = Session{activeTimeMillis = Core.Nothing,
            activityType = Core.Nothing, application = Core.Nothing,
            description = Core.Nothing, endTimeMillis = Core.Nothing,
            id = Core.Nothing, modifiedTimeMillis = Core.Nothing,
            name = Core.Nothing, startTimeMillis = Core.Nothing}
instance Core.FromJSON Session where
        parseJSON
          = Core.withObject "Session"
              (\ o ->
                 Session Core.<$>
                   (o Core..:? "activeTimeMillis" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON Session where
        toJSON Session{..}
          = Core.object
              (Core.catMaybes
                 [("activeTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    activeTimeMillis,
...
newValue 
    ::  Value
newValue
  = Value{fpVal = Core.Nothing, intVal = Core.Nothing,
          mapVal = Core.Nothing, stringVal = Core.Nothing}
instance Core.FromJSON Value where
        parseJSON
          = Core.withObject "Value"
              (\ o ->
                 Value Core.<$>
                   (o Core..:? "fpVal") Core.<*> (o Core..:? "intVal") Core.<*>
                     (o Core..:? "mapVal")
...
instance Core.FromJSON ValueMapValEntry where
        parseJSON
          = Core.withObject "ValueMapValEntry"
              (\ o ->
                 ValueMapValEntry Core.<$>
