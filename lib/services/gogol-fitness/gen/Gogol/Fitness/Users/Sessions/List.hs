             ...
             "sessions" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParams "activityType" Core.Int32 Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "endTime" Core.Text Core.:>
                         Core.QueryParam "includeDeleted" Core.Bool Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "startTime" Core.Text Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] ListSessionsResponse
...
newFitnessUsersSessionsList userId
  = FitnessUsersSessionsList{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, activityType = Core.Nothing,
                             callback = Core.Nothing, endTime = Core.Nothing,
                             includeDeleted = Core.Nothing, pageToken = Core.Nothing,
                             startTime = Core.Nothing, uploadType = Core.Nothing,
                             uploadProtocol = Core.Nothing, userId = userId}
instance Core.GoogleRequest FitnessUsersSessionsList where
        type Rs FitnessUsersSessionsList = ListSessionsResponse
        type Scopes FitnessUsersSessionsList =
             '[Fitness'Activity'Read, Fitness'Activity'Write,
               Fitness'BloodGlucose'Read, Fitness'BloodGlucose'Write,
               Fitness'BloodPressure'Read, Fitness'BloodPressure'Write,
               Fitness'Body'Read, Fitness'Body'Write,
               Fitness'BodyTemperature'Read, Fitness'BodyTemperature'Write,
               ...
               Fitness'OxygenSaturation'Read, Fitness'OxygenSaturation'Write,
               Fitness'ReproductiveHealth'Read, Fitness'ReproductiveHealth'Write,
               Fitness'Sleep'Read, Fitness'Sleep'Write]
        requestClient FitnessUsersSessionsList{..}
          = go userId xgafv accessToken (activityType Core.^. Core._Default)
              callback
              endTime
              includeDeleted
              pageToken
