...
newAnalyzeEntitySentimentRequest =
  AnalyzeEntitySentimentRequest
    {document = Core.Nothing, encodingType = Core.Nothing}

instance Core.FromJSON AnalyzeEntitySentimentRequest
         where
        parseJSON
          = Core.withObject "AnalyzeEntitySentimentRequest"
              (\ o ->
                 AnalyzeEntitySentimentRequest Core.<$>
                   (o Core..:? "document") Core.<*>
                     (o Core..:? "encodingType"))

instance Core.ToJSON AnalyzeEntitySentimentRequest
         where
...
newAnalyzeEntitySentimentResponse =
  AnalyzeEntitySentimentResponse
    {entities = Core.Nothing, language = Core.Nothing}

instance Core.FromJSON AnalyzeEntitySentimentResponse
         where
        parseJSON
          = Core.withObject "AnalyzeEntitySentimentResponse"
              (\ o ->
                 AnalyzeEntitySentimentResponse Core.<$>
                   (o Core..:? "entities") Core.<*>
                     (o Core..:? "language"))

instance Core.ToJSON AnalyzeEntitySentimentResponse
         where
...
instance Core.FromJSON AnalyzeSentimentRequest where
        parseJSON
          = Core.withObject "AnalyzeSentimentRequest"
              (\ o ->
                 AnalyzeSentimentRequest Core.<$>
                   (o Core..:? "document") Core.<*>
                     (o Core..:? "encodingType"))
...
instance Core.FromJSON AnalyzeSentimentResponse where
        parseJSON
          = Core.withObject "AnalyzeSentimentResponse"
              (\ o ->
                 AnalyzeSentimentResponse Core.<$>
                   (o Core..:? "documentSentiment") Core.<*>
                     (o Core..:? "language")
...
instance Core.FromJSON AnalyzeSyntaxRequest where
        parseJSON
          = Core.withObject "AnalyzeSyntaxRequest"
              (\ o ->
                 AnalyzeSyntaxRequest Core.<$>
                   (o Core..:? "document") Core.<*>
                     (o Core..:? "encodingType"))
...
newAnalyzeSyntaxResponse =
  AnalyzeSyntaxResponse
    {language = Core.Nothing, sentences = Core.Nothing, tokens = Core.Nothing}

instance Core.FromJSON AnalyzeSyntaxResponse where
        parseJSON
          = Core.withObject "AnalyzeSyntaxResponse"
              (\ o ->
                 AnalyzeSyntaxResponse Core.<$>
...
instance Core.FromJSON AnnotateTextRequest where
        parseJSON
          = Core.withObject "AnnotateTextRequest"
              (\ o ->
                 AnnotateTextRequest Core.<$>
                   (o Core..:? "document") Core.<*>
                     (o Core..:? "encodingType")
...
instance Core.FromJSON AnnotateTextResponse where
        parseJSON
          = Core.withObject "AnnotateTextResponse"
              (\ o ->
                 AnnotateTextResponse Core.<$>
                   (o Core..:? "categories") Core.<*>
                     (o Core..:? "documentSentiment")
...
instance Core.FromJSON ClassificationCategory where
        parseJSON
          = Core.withObject "ClassificationCategory"
              (\ o ->
                 ClassificationCategory Core.<$>
...
instance Core.FromJSON ClassificationModelOptions
         where
        parseJSON
          = Core.withObject "ClassificationModelOptions"
              (\ o ->
...
newClassifyTextRequest =
  ClassifyTextRequest
    {classificationModelOptions = Core.Nothing, document = Core.Nothing}

instance Core.FromJSON ClassifyTextRequest where
        parseJSON
          = Core.withObject "ClassifyTextRequest"
              (\ o ->
                 ClassifyTextRequest Core.<$>
                   (o Core..:? "classificationModelOptions") Core.<*>
                     (o Core..:? "document"))
...
instance Core.ToJSON ClassifyTextRequest where
        toJSON ClassifyTextRequest{..}
          = Core.object
              (Core.catMaybes
                 [("classificationModelOptions" Core..=) Core.<$>
                    classificationModelOptions,
                  ("document" Core..=) Core.<$> document])
...
instance Core.FromJSON ClassifyTextResponse where
        parseJSON
          = Core.withObject "ClassifyTextResponse"
              (\ o ->
                 ClassifyTextResponse Core.<$>
                   (o Core..:? "categories"))
...
instance Core.FromJSON DependencyEdge where
        parseJSON
          = Core.withObject "DependencyEdge"
              (\ o ->
                 DependencyEdge Core.<$>
                   (o Core..:? "headTokenIndex") Core.<*>
                     (o Core..:? "label"))
...
instance Core.FromJSON Entity_Metadata where
        parseJSON
          = Core.withObject "Entity_Metadata"
              (\ o ->
...
newEntityMention =
  EntityMention
    {sentiment = Core.Nothing, text = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON EntityMention where
        parseJSON
          = Core.withObject "EntityMention"
              (\ o ->
                 EntityMention Core.<$>
                   (o Core..:? "sentiment") Core.<*> (o Core..:? "text")
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("classificationModelOptions" Core..=) Core.<$>
                  ...
                  ("extractDocumentSentiment" Core..=) Core.<$>
                    extractDocumentSentiment,
                  ("extractEntities" Core..=) Core.<$> extractEntities,
                  ("extractEntitySentiment" Core..=) Core.<$>
...
instance Core.FromJSON PartOfSpeech where
        parseJSON
          = Core.withObject "PartOfSpeech"
              (\ o ->
                 PartOfSpeech Core.<$>
                   (o Core..:? "aspect") Core.<*> (o Core..:? "case")
                     Core.<*> (o Core..:? "form")
                     Core.<*> (o Core..:? "gender")
                     Core.<*> (o Core..:? "mood")
                     Core.<*> (o Core..:? "number")
...
instance Core.FromJSON Sentence where
        parseJSON
          = Core.withObject "Sentence"
              (\ o ->
                 Sentence Core.<$>
                   (o Core..:? "sentiment") Core.<*>
                     (o Core..:? "text"))
...
instance Core.FromJSON V2Model where
        parseJSON
          = Core.withObject "V2Model"
              (\ o ->
                 V2Model Core.<$>
                   (o Core..:? "contentCategoriesVersion"))

instance Core.ToJSON V2Model where
        toJSON V2Model{..}
          = Core.object
              (Core.catMaybes
                 [("contentCategoriesVersion" Core..=) Core.<$>
