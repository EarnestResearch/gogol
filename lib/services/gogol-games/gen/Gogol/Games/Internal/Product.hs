...
instance Core.FromJSON AchievementDefinition where
        parseJSON
          = Core.withObject "AchievementDefinition"
              (\ o ->
                 AchievementDefinition Core.<$>
                   (o Core..:? "achievementType") Core.<*>
                     (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "experiencePoints" Core.<&>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "AchievementDefinitionsListResponse"
              (\ o ->
                 AchievementDefinitionsListResponse Core.<$>
...
instance Core.FromJSON AchievementIncrementResponse
         where
        parseJSON
          = Core.withObject "AchievementIncrementResponse"
              (\ o ->
                 AchievementIncrementResponse Core.<$>
                   (o Core..:? "currentSteps") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "newlyUnlocked"))

instance Core.ToJSON AchievementIncrementResponse
         where
...
instance Core.FromJSON AchievementRevealResponse
         where
        parseJSON
          = Core.withObject "AchievementRevealResponse"
              (\ o ->
                 AchievementRevealResponse Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "AchievementSetStepsAtLeastResponse"
              (\ o ->
                 AchievementSetStepsAtLeastResponse Core.<$>
                   (o Core..:? "currentSteps") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "newlyUnlocked"))
...
instance Core.FromJSON AchievementUnlockResponse
         where
        parseJSON
          = Core.withObject "AchievementUnlockResponse"
              (\ o ->
                 AchievementUnlockResponse Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "newlyUnlocked"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "AchievementUpdateMultipleRequest"
              (\ o ->
                 AchievementUpdateMultipleRequest Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "updates"))

instance Core.ToJSON AchievementUpdateMultipleRequest
         where
...
newAchievementUpdateMultipleResponse =
  AchievementUpdateMultipleResponse
    {kind = Core.Nothing, updatedAchievements = Core.Nothing}

instance Core.FromJSON
           AchievementUpdateMultipleResponse
         where
        parseJSON
          = Core.withObject "AchievementUpdateMultipleResponse"
              (\ o ->
                 AchievementUpdateMultipleResponse Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "updatedAchievements"))
...
instance Core.FromJSON AchievementUpdateRequest where
        parseJSON
          = Core.withObject "AchievementUpdateRequest"
              (\ o ->
                 AchievementUpdateRequest Core.<$>
                   (o Core..:? "achievementId") Core.<*>
                     (o Core..:? "incrementPayload")
                     Core.<*> (o Core..:? "kind")
          ...
          = Core.object
              (Core.catMaybes
                 [("achievementId" Core..=) Core.<$> achievementId,
                  ("incrementPayload" Core..=) Core.<$>
                    incrementPayload,
                  ("kind" Core..=) Core.<$> kind,
                  ("setStepsAtLeastPayload" Core..=) Core.<$>
...
instance Core.FromJSON AchievementUpdateResponse
         where
        parseJSON
          = Core.withObject "AchievementUpdateResponse"
              (\ o ->
                 AchievementUpdateResponse Core.<$>
                   (o Core..:? "achievementId") Core.<*>
                     (o Core..:? "currentState")
              ...
              (\ o ->
                 Application Core.<$>
                   (o Core..:? "achievement_count") Core.<*>
                     ...
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "lastUpdatedTimestamp" Core.<&>
                        Core.fmap Core.fromAsText)
...
newApplicationCategory =
  ApplicationCategory
    {kind = Core.Nothing, primary = Core.Nothing, secondary = Core.Nothing}

instance Core.FromJSON ApplicationCategory where
        parseJSON
          = Core.withObject "ApplicationCategory"
              (\ o ->
                 ApplicationCategory Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "primary")
...
instance Core.FromJSON ApplicationPlayerId where
        parseJSON
          = Core.withObject "ApplicationPlayerId"
              (\ o ->
                 ApplicationPlayerId Core.<$>
...
instance Core.FromJSON ApplicationVerifyResponse
         where
        parseJSON
          = Core.withObject "ApplicationVerifyResponse"
              (\ o ->
                 ApplicationVerifyResponse Core.<$>
                   (o Core..:? "alternate_player_id") Core.<*>
                     (o Core..:? "kind")
...
instance Core.FromJSON CategoryListResponse where
        parseJSON
          = Core.withObject "CategoryListResponse"
              (\ o ->
                 CategoryListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newEventBatchRecordFailure =
  EventBatchRecordFailure
    {failureCause = Core.Nothing, kind = Core.Nothing, range = Core.Nothing}

instance Core.FromJSON EventBatchRecordFailure where
        parseJSON
          = Core.withObject "EventBatchRecordFailure"
              (\ o ->
                 EventBatchRecordFailure Core.<$>
                   (o Core..:? "failureCause") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "range"))
...
instance Core.FromJSON EventChild where
        parseJSON
          = Core.withObject "EventChild"
              (\ o ->
                 EventChild Core.<$>
                   (o Core..:? "childId") Core.<*> (o Core..:? "kind"))
...
instance Core.FromJSON EventDefinition where
        parseJSON
          = Core.withObject "EventDefinition"
              (\ o ->
                 EventDefinition Core.<$>
                   (o Core..:? "childEvents") Core.<*>
                     (o Core..:? "description")
...
instance Core.FromJSON EventDefinitionListResponse
         where
        parseJSON
          = Core.withObject "EventDefinitionListResponse"
              (\ o ->
                 EventDefinitionListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON EventDefinitionListResponse
         where
...
instance Core.FromJSON EventPeriodRange where
        parseJSON
          = Core.withObject "EventPeriodRange"
              (\ o ->
                 EventPeriodRange Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "periodEndMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "periodStartMillis" Core.<&>
                        Core.fmap Core.fromAsText))
...
newEventPeriodUpdate =
  EventPeriodUpdate
    {kind = Core.Nothing, timePeriod = Core.Nothing, updates = Core.Nothing}

instance Core.FromJSON EventPeriodUpdate where
        parseJSON
          = Core.withObject "EventPeriodUpdate"
              (\ o ->
                 EventPeriodUpdate Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "timePeriod")
                     Core.<*> (o Core..:? "updates"))
...
newEventRecordFailure =
  EventRecordFailure
    {eventId = Core.Nothing, failureCause = Core.Nothing, kind = Core.Nothing}

instance Core.FromJSON EventRecordFailure where
        parseJSON
          = Core.withObject "EventRecordFailure"
              (\ o ->
                 EventRecordFailure Core.<$>
                   (o Core..:? "eventId") Core.<*>
                     (o Core..:? "failureCause")
                     Core.<*> (o Core..:? "kind"))
...
instance Core.FromJSON EventRecordRequest where
        parseJSON
          = Core.withObject "EventRecordRequest"
              (\ o ->
                 EventRecordRequest Core.<$>
                   (o Core..:? "currentTimeMillis" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "requestId" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("currentTimeMillis" Core..=) Core.. Core.AsText
                  ...
                  ("kind" Core..=) Core.<$> kind,
                  ("requestId" Core..=) Core.. Core.AsText Core.<$>
                    requestId,
...
instance Core.FromJSON EventUpdateRequest where
        parseJSON
          = Core.withObject "EventUpdateRequest"
              (\ o ->
                 EventUpdateRequest Core.<$>
                   (o Core..:? "definitionId") Core.<*>
                     (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "updateCount" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("definitionId" Core..=) Core.<$> definitionId,
                  ("kind" Core..=) Core.<$> kind,
                  ("updateCount" Core..=) Core.. Core.AsText Core.<$>
                    updateCount])
...
instance Core.FromJSON EventUpdateResponse where
        parseJSON
          = Core.withObject "EventUpdateResponse"
              (\ o ->
                 EventUpdateResponse Core.<$>
                   (o Core..:? "batchFailures") Core.<*>
                     (o Core..:? "eventFailures")
                     Core.<*> (o Core..:? "kind")
...
newGamesAchievementIncrement =
  GamesAchievementIncrement
    {kind = Core.Nothing, requestId = Core.Nothing, steps = Core.Nothing}

instance Core.FromJSON GamesAchievementIncrement
         where
        parseJSON
          = Core.withObject "GamesAchievementIncrement"
              (\ o ->
                 GamesAchievementIncrement Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "requestId" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "steps"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GamesAchievementSetStepsAtLeast"
              (\ o ->
                 GamesAchievementSetStepsAtLeast Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "steps"))

instance Core.ToJSON GamesAchievementSetStepsAtLeast
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GetMultipleApplicationPlayerIdsResponse"
              (\ o ->
                 GetMultipleApplicationPlayerIdsResponse Core.<$>
                   (o Core..:? "playerIds"))
...
instance Core.FromJSON ImageAsset where
        parseJSON
          = Core.withObject "ImageAsset"
              (\ o ->
                 ImageAsset Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "url")
                     Core.<*> (o Core..:? "width"))
...
instance Core.FromJSON Instance where
        parseJSON
          = Core.withObject "Instance"
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "acquisitionUri") Core.<*>
                     (o Core..:? "androidInstance")
...
instance Core.FromJSON InstanceAndroidDetails where
        parseJSON
          = Core.withObject "InstanceAndroidDetails"
              (\ o ->
                 InstanceAndroidDetails Core.<$>
                   (o Core..:? "enablePiracyCheck") Core.<*>
                     (o Core..:? "kind")
...
instance Core.FromJSON InstanceIosDetails where
        parseJSON
          = Core.withObject "InstanceIosDetails"
              (\ o ->
                 InstanceIosDetails Core.<$>
                   (o Core..:? "bundleIdentifier") Core.<*>
                     (o Core..:? "itunesAppId")
                     Core.<*> (o Core..:? "kind")
...
instance Core.ToJSON InstanceIosDetails where
        toJSON InstanceIosDetails{..}
          = Core.object
              (Core.catMaybes
                 [("bundleIdentifier" Core..=) Core.<$>
                    bundleIdentifier,
                  ("itunesAppId" Core..=) Core.<$> itunesAppId,
                  ("kind" Core..=) Core.<$> kind,
                  ("preferredForIpad" Core..=) Core.<$>
                    preferredForIpad,
                  ("preferredForIphone" Core..=) Core.<$>
                    preferredForIphone,
...
newInstanceWebDetails =
  InstanceWebDetails
    {kind = Core.Nothing, launchUrl = Core.Nothing, preferred = Core.Nothing}

instance Core.FromJSON InstanceWebDetails where
        parseJSON
          = Core.withObject "InstanceWebDetails"
              (\ o ->
                 InstanceWebDetails Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "launchUrl")
                     Core.<*> (o Core..:? "preferred"))
...
instance Core.FromJSON Leaderboard where
        parseJSON
          = Core.withObject "Leaderboard"
              (\ o ->
                 Leaderboard Core.<$>
                   (o Core..:? "iconUrl") Core.<*> (o Core..:? "id")
...
instance Core.FromJSON LeaderboardEntry where
        parseJSON
          = Core.withObject "LeaderboardEntry"
              (\ o ->
                 LeaderboardEntry Core.<$>
                   (o Core..:? "formattedScore") Core.<*>
                     (o Core..:? "formattedScoreRank")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "player")
                     Core.<*>
                     (o Core..:? "scoreRank" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "scoreTag")
                     Core.<*>
                     (o Core..:? "scoreValue" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "timeSpan")
                     Core.<*>
                     (o Core..:? "writeTimestampMillis" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("formattedScore" Core..=) Core.<$> formattedScore,
                  ("formattedScoreRank" Core..=) Core.<$>
                    formattedScoreRank,
                  ("kind" Core..=) Core.<$> kind,
                  ("player" Core..=) Core.<$> player,
                  ("scoreRank" Core..=) Core.. Core.AsText Core.<$>
                    scoreRank,
                  ("scoreTag" Core..=) Core.<$> scoreTag,
                  ("scoreValue" Core..=) Core.. Core.AsText Core.<$>
                    scoreValue,
...
instance Core.FromJSON LeaderboardListResponse where
        parseJSON
          = Core.withObject "LeaderboardListResponse"
              (\ o ->
                 LeaderboardListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON LeaderboardScoreRank where
        parseJSON
          = Core.withObject "LeaderboardScoreRank"
              (\ o ->
                 LeaderboardScoreRank Core.<$>
                   (o Core..:? "formattedNumScores") Core.<*>
                     (o Core..:? "formattedRank")
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "numScores" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "rank" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON LeaderboardScoreRank where
        toJSON LeaderboardScoreRank{..}
          = Core.object
              (Core.catMaybes
                 [("formattedNumScores" Core..=) Core.<$>
                    formattedNumScores,
                  ("formattedRank" Core..=) Core.<$> formattedRank,
                  ("kind" Core..=) Core.<$> kind,
                  ("numScores" Core..=) Core.. Core.AsText Core.<$>
                    numScores,
...
instance Core.FromJSON LeaderboardScores where
        parseJSON
          = Core.withObject "LeaderboardScores"
              (\ o ->
                 LeaderboardScores Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*>
                     (o Core..:? "numScores" Core.<&>
...
instance Core.FromJSON MetagameConfig where
        parseJSON
          = Core.withObject "MetagameConfig"
              (\ o ->
                 MetagameConfig Core.<$>
...
instance Core.FromJSON PlayerAchievement where
        parseJSON
          = Core.withObject "PlayerAchievement"
              (\ o ->
                 PlayerAchievement Core.<$>
                   (o Core..:? "achievementState") Core.<*>
                     (o Core..:? "currentSteps")
                     Core.<*>
                     (o Core..:? "experiencePoints" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON PlayerAchievement where
        toJSON PlayerAchievement{..}
          = Core.object
              (Core.catMaybes
                 [("achievementState" Core..=) Core.<$>
                    achievementState,
                  ("currentSteps" Core..=) Core.<$> currentSteps,
                  ("experiencePoints" Core..=) Core.. Core.AsText
                    Core.<$> experiencePoints,
                  ("formattedCurrentStepsString" Core..=) Core.<$>
...
instance Core.FromJSON PlayerAchievementListResponse
         where
        parseJSON
          = Core.withObject "PlayerAchievementListResponse"
              (\ o ->
                 PlayerAchievementListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON PlayerAchievementListResponse
         where
...
instance Core.FromJSON PlayerEvent where
        parseJSON
          = Core.withObject "PlayerEvent"
              (\ o ->
                 PlayerEvent Core.<$>
                   (o Core..:? "definitionId") Core.<*>
                     (o Core..:? "formattedNumEvents")
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "numEvents" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "playerId"))
...
instance Core.ToJSON PlayerEvent where
        toJSON PlayerEvent{..}
          = Core.object
              (Core.catMaybes
                 [("definitionId" Core..=) Core.<$> definitionId,
                  ("formattedNumEvents" Core..=) Core.<$>
                    formattedNumEvents,
                  ("kind" Core..=) Core.<$> kind,
                  ("numEvents" Core..=) Core.. Core.AsText Core.<$>
                    numEvents,
                  ("playerId" Core..=) Core.<$> playerId])
...
instance Core.FromJSON PlayerEventListResponse where
        parseJSON
          = Core.withObject "PlayerEventListResponse"
              (\ o ->
                 PlayerEventListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON PlayerExperienceInfo where
        parseJSON
          = Core.withObject "PlayerExperienceInfo"
              (\ o ->
                 PlayerExperienceInfo Core.<$>
                   (o Core..:? "currentExperiencePoints" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "currentLevel")
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "lastLevelUpTimestampMillis" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.FromJSON PlayerLeaderboardScore where
        parseJSON
          = Core.withObject "PlayerLeaderboardScore"
              (\ o ->
                 PlayerLeaderboardScore Core.<$>
                   (o Core..:? "friendsRank") Core.<*>
                     (o Core..:? "kind")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "PlayerLeaderboardScoreListResponse"
              (\ o ->
                 PlayerLeaderboardScoreListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "player"))
...
instance Core.FromJSON PlayerLevel where
        parseJSON
          = Core.withObject "PlayerLevel"
              (\ o ->
                 PlayerLevel Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "level")
                     Core.<*>
                     (o Core..:? "maxExperiencePoints" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minExperiencePoints" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.FromJSON PlayerListResponse where
        parseJSON
          = Core.withObject "PlayerListResponse"
              (\ o ->
                 PlayerListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON PlayerScoreListResponse where
        parseJSON
          = Core.withObject "PlayerScoreListResponse"
              (\ o ->
                 PlayerScoreListResponse Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "submittedScores"))
...
instance Core.FromJSON PlayerScoreResponse where
        parseJSON
          = Core.withObject "PlayerScoreResponse"
              (\ o ->
                 PlayerScoreResponse Core.<$>
                   (o Core..:? "beatenScoreTimeSpans") Core.<*>
                     (o Core..:? "formattedScore")
                     Core.<*> (o Core..:? "kind")
...
instance Core.ToJSON PlayerScoreResponse where
        toJSON PlayerScoreResponse{..}
          = Core.object
              (Core.catMaybes
                 [("beatenScoreTimeSpans" Core..=) Core.<$>
...
instance Core.FromJSON PlayerScoreSubmissionList
         where
        parseJSON
          = Core.withObject "PlayerScoreSubmissionList"
              (\ o ->
                 PlayerScoreSubmissionList Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "scores"))
          ...
          = Core.withObject "ProfileSettings"
              (\ o ->
                 ProfileSettings Core.<$>
                   (o Core..:? "friendsListVisibility") Core.<*>
                     (o Core..:? "kind")
...
instance Core.ToJSON ProfileSettings where
        toJSON ProfileSettings{..}
          = Core.object
              (Core.catMaybes
                 [("friendsListVisibility" Core..=) Core.<$>
...
instance Core.FromJSON RevisionCheckResponse where
        parseJSON
          = Core.withObject "RevisionCheckResponse"
              (\ o ->
                 RevisionCheckResponse Core.<$>
...
newScopedPlayerIds =
  ScopedPlayerIds
    {developerPlayerKey = Core.Nothing, gamePlayerId = Core.Nothing}

instance Core.FromJSON ScopedPlayerIds where
        parseJSON
          = Core.withObject "ScopedPlayerIds"
              (\ o ->
                 ScopedPlayerIds Core.<$>
                   (o Core..:? "developerPlayerKey") Core.<*>
                     (o Core..:? "gamePlayerId"))
...
instance Core.FromJSON ScoreSubmission where
        parseJSON
          = Core.withObject "ScoreSubmission"
              (\ o ->
                 ScoreSubmission Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "leaderboardId")
                     Core.<*>
                     (o Core..:? "score" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "scoreTag")
              ...
              (\ o ->
                 Snapshot Core.<$>
                   (o Core..:? "coverImage") Core.<*>
                     ...
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "lastModifiedMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "progressValue" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "title")
                     Core.<*> (o Core..:? "type")
          ...
          = Core.object
              (Core.catMaybes
                 [("coverImage" Core..=) Core.<$> coverImage,
                  ...
                  ("progressValue" Core..=) Core.. Core.AsText Core.<$>
                    progressValue,
                  ("title" Core..=) Core.<$> title,
                  ("type" Core..=) Core.<$> type',
...
instance Core.FromJSON SnapshotListResponse where
        parseJSON
          = Core.withObject "SnapshotListResponse"
              (\ o ->
                 SnapshotListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON StatsResponse where
        parseJSON
          = Core.withObject "StatsResponse"
              (\ o ->
                 StatsResponse Core.<$>
                   (o Core..:? "avg_session_length_minutes") Core.<*>
                     (o Core..:? "churn_probability")
...
instance Core.ToJSON StatsResponse where
        toJSON StatsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("avg_session_length_minutes" Core..=) Core.<$>
                    avgSessionLengthMinutes,
                  ("churn_probability" Core..=) Core.<$>
                    churnProbability,
                  ("days_since_last_played" Core..=) Core.<$>
                    daysSinceLastPlayed,
                  ("high_spender_probability" Core..=) Core.<$>
                    highSpenderProbability,
                  ("kind" Core..=) Core.<$> kind,
                  ("num_purchases" Core..=) Core.<$> numPurchases,
                  ("num_sessions" Core..=) Core.<$> numSessions,
                  ("num_sessions_percentile" Core..=) Core.<$>
                    numSessionsPercentile,
                  ("spend_percentile" Core..=) Core.<$>
                    spendPercentile,
                  ("spend_probability" Core..=) Core.<$>
                    spendProbability,
                  ("total_spend_next_28_days" Core..=) Core.<$>
