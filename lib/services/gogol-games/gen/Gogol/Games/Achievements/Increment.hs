       ...
       "v1" Core.:>
         "achievements" Core.:>
           Core.Capture "achievementId" Core.Text Core.:>
             "increment" Core.:>
               Core.QueryParam "stepsToIncrement" Core.Int32 Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "requestId" Core.Int64 Core.:>
...
instance Core.GoogleRequest
           GamesAchievementsIncrement
         where
        type Rs GamesAchievementsIncrement =
             AchievementIncrementResponse
        type Scopes GamesAchievementsIncrement =
             '[Games'FullControl]
        requestClient GamesAchievementsIncrement{..}
          = go achievementId (Core.Just stepsToIncrement) xgafv
              accessToken
              callback
              requestId
              uploadType
