       ...
       "v1" Core.:>
         "leaderboards" Core.:>
           Core.Capture "leaderboardId" Core.Text Core.:>
             "scores" Core.:>
               Core.QueryParam "score" Core.Int64 Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "language" Core.Text Core.:>
                         Core.QueryParam "scoreTag" Core.Text Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Post '[Core.JSON] PlayerScoreResponse
...
instance Core.GoogleRequest GamesScoresSubmit where
        ...
        requestClient GamesScoresSubmit{..}
          = go leaderboardId (Core.Just score) xgafv
              accessToken
              callback
              language
              scoreTag
