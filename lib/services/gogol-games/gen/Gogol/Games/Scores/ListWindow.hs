       ...
       "v1" Core.:>
         "leaderboards" Core.:>
           Core.Capture "leaderboardId" Core.Text Core.:>
             "window" Core.:>
               Core.Capture "collection" ScoresListWindowCollection
                 Core.:>
                 Core.QueryParam "timeSpan" ScoresListWindowTimeSpan
                   Core.:>
                         ...
                         Core.QueryParam "language" Core.Text Core.:>
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "resultsAbove" Core.Int32 Core.:>
                                 Core.QueryParam "returnTopIfAbsent" Core.Bool
                                   Core.:>
                                   Core.QueryParam "uploadType" Core.Text
                                     ...
                                     Core.QueryParam "upload_protocol" Core.Text
                                       ...
                                       Core.QueryParam "alt" Core.AltJSON
                                         Core.:>
                                         Core.Get '[Core.JSON] LeaderboardScores
...
instance Core.GoogleRequest GamesScoresListWindow
         where
        type Rs GamesScoresListWindow = LeaderboardScores
        type Scopes GamesScoresListWindow =
             '[Games'FullControl]
        requestClient GamesScoresListWindow{..}
          = go leaderboardId collection (Core.Just timeSpan)
              xgafv
              accessToken
              callback
              language
