...
-- |
-- Module      : Gogol.SQLAdmin.Sql.Databases.Delete
...
newSqlDatabasesDelete database instance' project
  = SqlDatabasesDelete{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, callback = Core.Nothing,
                       database = database, instance' = instance', project = project,
...
instance Core.GoogleRequest SqlDatabasesDelete where
        ...
        type Scopes SqlDatabasesDelete =
             '[CloudPlatform'FullControl, Sqlservice'Admin]
        requestClient SqlDatabasesDelete{..}
          = go project instance' database xgafv accessToken callback
              uploadType
              uploadProtocol
