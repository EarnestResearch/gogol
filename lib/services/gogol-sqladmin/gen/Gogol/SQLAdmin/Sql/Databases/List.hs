...
-- |
-- Module      : Gogol.SQLAdmin.Sql.Databases.List
...
-- 'SqlDatabasesList' request conforms to.
type SqlDatabasesListResource =
     "v1" Core.:>
       "projects" Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] DatabasesListResponse

-- | Lists databases in the specified Cloud SQL instance.
--
-- /See:/ 'newSqlDatabasesList' smart constructor.
data SqlDatabasesList = SqlDatabasesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'SqlDatabasesList' with the minimum fields required to make a request.
newSqlDatabasesList 
    ::  Core.Text
    ...
    -> SqlDatabasesList
newSqlDatabasesList instance' project
  = SqlDatabasesList{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     instance' = instance', project = project,
                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SqlDatabasesList where
        type Rs SqlDatabasesList = DatabasesListResponse
        type Scopes SqlDatabasesList =
        ...
        requestClient SqlDatabasesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SqlDatabasesListResource)
                      Core.mempty
