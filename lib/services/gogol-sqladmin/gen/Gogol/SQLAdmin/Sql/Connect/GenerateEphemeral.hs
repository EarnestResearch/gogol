     ...
     "v1" Core.:>
       "projects" Core.:>
         Core.Capture "project" Core.Text Core.:>
           "instances" Core.:>
             Core.CaptureMode "instance" "generateEphemeralCert" Core.Text
               Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] GenerateEphemeralCertRequest Core.:>
                             Core.Post '[Core.JSON] GenerateEphemeralCertResponse
...
newSqlConnectGenerateEphemeral instance' payload project
  = SqlConnectGenerateEphemeral{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SqlConnectGenerateEphemeral where
        ...
        type Scopes SqlConnectGenerateEphemeral =
