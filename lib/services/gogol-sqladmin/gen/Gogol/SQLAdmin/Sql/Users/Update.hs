...
newSqlUsersUpdate instance' payload project
  = SqlUsersUpdate{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, host = Core.Nothing,
                   instance' = instance', name = Core.Nothing, payload = payload,
...
instance Core.GoogleRequest SqlUsersUpdate where
        ...
        type Scopes SqlUsersUpdate =
             '[CloudPlatform'FullControl, Sqlservice'Admin]
        requestClient SqlUsersUpdate{..}
          = go project instance' xgafv accessToken callback host name
              uploadType
              uploadProtocol
