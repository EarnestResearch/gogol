             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "instance" Core.Text Core.:>
                     Core.QueryParam "maxResults" Core.Word32 Core.:>
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] OperationsListResponse
...
newSqlOperationsList project
  = SqlOperationsList{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, callback = Core.Nothing,
                      instance' = Core.Nothing, maxResults = Core.Nothing,
...
instance Core.GoogleRequest SqlOperationsList where
        ...
        type Scopes SqlOperationsList =
             '[CloudPlatform'FullControl, Sqlservice'Admin]
        requestClient SqlOperationsList{..}
          = go project xgafv accessToken callback instance' maxResults
              pageToken
              uploadType
              uploadProtocol
