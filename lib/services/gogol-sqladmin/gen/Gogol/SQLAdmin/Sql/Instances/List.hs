                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] InstancesListResponse
...
newSqlInstancesList project
  = SqlInstancesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SqlInstancesList where
        ...
        type Scopes SqlInstancesList =
             '[CloudPlatform'FullControl, Sqlservice'Admin]
        requestClient SqlInstancesList{..}
          = go project xgafv accessToken callback filter maxResults pageToken
              uploadType
              uploadProtocol
