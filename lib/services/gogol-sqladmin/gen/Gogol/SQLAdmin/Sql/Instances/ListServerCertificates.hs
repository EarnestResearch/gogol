                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] InstancesListServerCertificatesResponse
...
newSqlInstancesListServerCertificates instance' project
  = SqlInstancesListServerCertificates{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       instance' = instance', project = project,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SqlInstancesListServerCertificates
         where
        type Rs SqlInstancesListServerCertificates =
             InstancesListServerCertificatesResponse
        type Scopes SqlInstancesListServerCertificates =
