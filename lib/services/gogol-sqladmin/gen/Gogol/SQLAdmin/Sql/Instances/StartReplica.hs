...
newSqlInstancesStartReplica instance' project
  = SqlInstancesStartReplica{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             instance' = instance', project = project,
                             uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SqlInstancesStartReplica where
        ...
        requestClient SqlInstancesStartReplica{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SqlInstancesStartReplicaResource)
                      Core.mempty
