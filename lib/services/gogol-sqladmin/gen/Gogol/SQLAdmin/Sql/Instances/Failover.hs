                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] InstancesFailoverRequest Core.:>
...
newSqlInstancesFailover instance' payload project
  = SqlInstancesFailover{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SqlInstancesFailover where
        ...
        type Scopes SqlInstancesFailover =
        ...
        requestClient SqlInstancesFailover{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SqlInstancesFailoverResource)
                      Core.mempty
