...
-- |
-- Module      : Gogol.SQLAdmin.Sql.Instances.Export
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] InstancesExportRequest Core.:>
...
newSqlInstancesExport instance' payload project
  = SqlInstancesExport{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SqlInstancesExport where
        ...
        type Scopes SqlInstancesExport = '[CloudPlatform'FullControl]
