                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] InstancesAcquireSsrsLeaseRequest Core.:>
                               Core.Post '[Core.JSON] SqlInstancesAcquireSsrsLeaseResponse
...
newSqlInstancesAcquireSsrsLease instance' payload project
  = SqlInstancesAcquireSsrsLease{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SqlInstancesAcquireSsrsLease where
        type Rs SqlInstancesAcquireSsrsLease =
             SqlInstancesAcquireSsrsLeaseResponse
        type Scopes SqlInstancesAcquireSsrsLease =
