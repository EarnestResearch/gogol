                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] InstancesRotateServerCertificateRequest
...
newSqlInstancesRotateServerCertificate instance' payload project
  = SqlInstancesRotateServerCertificate{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        instance' = instance', payload = payload, project = project,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SqlInstancesRotateServerCertificate
         where
        type Rs SqlInstancesRotateServerCertificate = Operation
        type Scopes SqlInstancesRotateServerCertificate =
