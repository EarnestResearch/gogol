                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] InstancesDemoteMasterRequest Core.:>
...
newSqlInstancesDemoteMaster instance' payload project
  = SqlInstancesDemoteMaster{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SqlInstancesDemoteMaster where
        ...
        type Scopes SqlInstancesDemoteMaster =
        ...
        requestClient SqlInstancesDemoteMaster{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SqlInstancesDemoteMasterResource)
                      Core.mempty
