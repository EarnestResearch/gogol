                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "dbTimeout" Core.Duration Core.:>
...
newSqlInstancesSwitchover instance' project
  = SqlInstancesSwitchover{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           dbTimeout = Core.Nothing, instance' = instance', project = project,
...
instance Core.GoogleRequest SqlInstancesSwitchover where
        ...
        type Scopes SqlInstancesSwitchover =
             '[CloudPlatform'FullControl, Sqlservice'Admin]
        requestClient SqlInstancesSwitchover{..}
          = go project instance' xgafv accessToken callback dbTimeout
              uploadType
              uploadProtocol
