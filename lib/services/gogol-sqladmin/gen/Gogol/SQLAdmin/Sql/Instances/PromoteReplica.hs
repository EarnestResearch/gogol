                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "failover" Core.Bool Core.:>
...
newSqlInstancesPromoteReplica instance' project
  = SqlInstancesPromoteReplica{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               failover = Core.Nothing, instance' = instance', project = project,
...
instance Core.GoogleRequest SqlInstancesPromoteReplica where
        ...
        requestClient SqlInstancesPromoteReplica{..}
          = go project instance' xgafv accessToken callback failover
              uploadType
              uploadProtocol
