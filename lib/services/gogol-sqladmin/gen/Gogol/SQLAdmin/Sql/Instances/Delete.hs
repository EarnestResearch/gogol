               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "enableFinalBackup" Core.Bool Core.:>
                       Core.QueryParam "finalBackupDescription" Core.Text Core.:>
                         Core.QueryParam "finalBackupExpiryTime" Core.DateTime Core.:>
                           Core.QueryParam "finalBackupTtlDays" Core.Int64 Core.:>
...
instance Core.GoogleRequest SqlInstancesDelete where
        ...
        type Scopes SqlInstancesDelete =
             '[CloudPlatform'FullControl, Sqlservice'Admin]
        requestClient SqlInstancesDelete{..}
          = go project instance' xgafv accessToken callback enableFinalBackup
