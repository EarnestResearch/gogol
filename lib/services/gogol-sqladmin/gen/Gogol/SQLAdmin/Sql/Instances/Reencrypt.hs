                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] InstancesReencryptRequest Core.:>
...
instance Core.GoogleRequest SqlInstancesReencrypt where
        ...
        requestClient SqlInstancesReencrypt{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SqlInstancesReencryptResource)
                      Core.mempty
