...
newSqlBackupRunsGet id instance' project
  = SqlBackupRunsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SqlBackupRunsGet where
        ...
        type Scopes SqlBackupRunsGet =
             '[CloudPlatform'FullControl, Sqlservice'Admin]
        requestClient SqlBackupRunsGet{..}
          = go project instance' id xgafv accessToken callback uploadType
              uploadProtocol
