                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] SqlInstancesResetReplicaSizeRequest
...
newSqlProjectsInstancesResetReplicaSize instance' payload project
  = SqlProjectsInstancesResetReplicaSize{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         instance' = instance', payload = payload,
                                         project = project, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SqlProjectsInstancesResetReplicaSize
         where
        type Rs SqlProjectsInstancesResetReplicaSize = Operation
        type Scopes SqlProjectsInstancesResetReplicaSize =
