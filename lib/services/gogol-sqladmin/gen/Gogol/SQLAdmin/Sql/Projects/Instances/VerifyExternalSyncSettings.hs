...
newSqlProjectsInstancesVerifyExternalSyncSettings 
    ...
    -> SqlProjectsInstancesVerifyExternalSyncSettings
newSqlProjectsInstancesVerifyExternalSyncSettings instance' payload
  project
  = SqlProjectsInstancesVerifyExternalSyncSettings{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           SqlProjectsInstancesVerifyExternalSyncSettings
         where
        type Rs SqlProjectsInstancesVerifyExternalSyncSettings =
             SqlInstancesVerifyExternalSyncSettingsResponse
        type Scopes SqlProjectsInstancesVerifyExternalSyncSettings =
