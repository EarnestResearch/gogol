                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] SqlInstancesGetLatestRecoveryTimeResponse
...
newSqlProjectsInstancesGetLatestRecoveryTime instance' project
  = SqlProjectsInstancesGetLatestRecoveryTime{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           SqlProjectsInstancesGetLatestRecoveryTime
         where
        type Rs SqlProjectsInstancesGetLatestRecoveryTime =
             SqlInstancesGetLatestRecoveryTimeResponse
        type Scopes SqlProjectsInstancesGetLatestRecoveryTime =
