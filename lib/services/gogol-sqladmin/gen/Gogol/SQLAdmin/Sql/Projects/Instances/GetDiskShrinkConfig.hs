                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] SqlInstancesGetDiskShrinkConfigResponse
...
newSqlProjectsInstancesGetDiskShrinkConfig instance' project
  = SqlProjectsInstancesGetDiskShrinkConfig{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            instance' = instance', project = project,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SqlProjectsInstancesGetDiskShrinkConfig
         where
        ...
        requestClient SqlProjectsInstancesGetDiskShrinkConfig{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SqlProjectsInstancesGetDiskShrinkConfigResource)
                      Core.mempty
