                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] SqlInstancesStartExternalSyncRequest
...
newSqlProjectsInstancesStartExternalSync instance' payload project
  = SqlProjectsInstancesStartExternalSync{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          instance' = instance', payload = payload,
                                          project = project, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SqlProjectsInstancesStartExternalSync
         where
        type Rs SqlProjectsInstancesStartExternalSync = Operation
        type Scopes SqlProjectsInstancesStartExternalSync =
             '[CloudPlatform'FullControl, Sqlservice'Admin]
        requestClient SqlProjectsInstancesStartExternalSync{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SqlProjectsInstancesStartExternalSyncResource)
                      Core.mempty
