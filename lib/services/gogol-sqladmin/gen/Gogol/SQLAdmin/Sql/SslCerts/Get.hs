         ...
         Core.Capture "project" Core.Text Core.:>
           "instances" Core.:>
             Core.Capture "instance" Core.Text Core.:>
               "sslCerts" Core.:>
                 Core.Capture "sha1Fingerprint" Core.Text Core.:>
...
newSqlSslCertsGet instance' project sha1Fingerprint
  = SqlSslCertsGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, instance' = instance', project = project,
                   sha1Fingerprint = sha1Fingerprint, uploadType = Core.Nothing,
                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SqlSslCertsGet where
        type Rs SqlSslCertsGet = SslCert
        type Scopes SqlSslCertsGet =
             '[CloudPlatform'FullControl, Sqlservice'Admin]
        requestClient SqlSslCertsGet{..}
          = go project instance' sha1Fingerprint xgafv accessToken callback
              uploadType
              uploadProtocol
