...
newAclEntry 
    ::  AclEntry
newAclEntry
  = AclEntry{expirationTime = Core.Nothing, kind = Core.Nothing,
             name = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON AclEntry where
        parseJSON
          = Core.withObject "AclEntry"
              (\ o ->
                 AclEntry Core.<$>
                   (o Core..:? "expirationTime") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "value"))
...
newAcquireSsrsLeaseContext 
    ::  AcquireSsrsLeaseContext
newAcquireSsrsLeaseContext
  = AcquireSsrsLeaseContext{duration = Core.Nothing,
                            reportDatabase = Core.Nothing, serviceLogin = Core.Nothing,
                            setupLogin = Core.Nothing}
instance Core.FromJSON AcquireSsrsLeaseContext where
        parseJSON
          = Core.withObject "AcquireSsrsLeaseContext"
              (\ o ->
                 AcquireSsrsLeaseContext Core.<$>
                   (o Core..:? "duration") Core.<*> (o Core..:? "reportDatabase")
...
newApiWarning 
    ::  ApiWarning
newApiWarning
  = ApiWarning{code = Core.Nothing, message = Core.Nothing,
               region = Core.Nothing}
instance Core.FromJSON ApiWarning where
        parseJSON
          = Core.withObject "ApiWarning"
              (\ o ->
                 ApiWarning Core.<$>
...
newAvailableDatabaseVersion 
    ::  AvailableDatabaseVersion
newAvailableDatabaseVersion
  = AvailableDatabaseVersion{displayName = Core.Nothing,
                             majorVersion = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON AvailableDatabaseVersion where
        parseJSON
          = Core.withObject "AvailableDatabaseVersion"
              (\ o ->
                 AvailableDatabaseVersion Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "majorVersion")
                     Core.<*> (o Core..:? "name"))
...
data Backup = Backup
    ...
    , databaseVersion :: (Core.Maybe Backup_DatabaseVersion)
...
newBackup 
    ::  Backup
newBackup
  = Backup{backupInterval = Core.Nothing, backupKind = Core.Nothing,
           backupRun = Core.Nothing, databaseVersion = Core.Nothing,
           description = Core.Nothing, error = Core.Nothing,
           expiryTime = Core.Nothing, instance' = Core.Nothing,
           instanceDeletionTime = Core.Nothing,
           instanceSettings = Core.Nothing, kind = Core.Nothing,
           kmsKey = Core.Nothing, kmsKeyVersion = Core.Nothing,
           location = Core.Nothing, maxChargeableBytes = Core.Nothing,
           name = Core.Nothing, satisfiesPzi = Core.Nothing,
           satisfiesPzs = Core.Nothing, selfLink = Core.Nothing,
           state = Core.Nothing, timeZone = Core.Nothing,
           ttlDays = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Backup where
        parseJSON
          = Core.withObject "Backup"
              (\ o ->
                 Backup Core.<$>
                   (o Core..:? "backupInterval") Core.<*> (o Core..:? "backupKind")
                     ...
                     Core.<*>
                     (o Core..:? "maxChargeableBytes" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("backupInterval" Core..=) Core.<$> backupInterval,
                  ...
                  ("kind" Core..=) Core.<$> kind, ("kmsKey" Core..=) Core.<$> kmsKey,
                  ("kmsKeyVersion" Core..=) Core.<$> kmsKeyVersion,
                  ("location" Core..=) Core.<$> location,
                  ("maxChargeableBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxChargeableBytes,
                  ("name" Core..=) Core.<$> name,
...
data BackupConfiguration = BackupConfiguration
    ...
    , backupTier :: (Core.Maybe BackupConfiguration_BackupTier)
...
newBackupConfiguration 
    ::  BackupConfiguration
newBackupConfiguration
  = BackupConfiguration{backupRetentionSettings = Core.Nothing,
                        backupTier = Core.Nothing, binaryLogEnabled = Core.Nothing,
                        enabled = Core.Nothing, kind = Core.Nothing,
                        location = Core.Nothing, pointInTimeRecoveryEnabled = Core.Nothing,
...
instance Core.FromJSON BackupConfiguration where
        parseJSON
          = Core.withObject "BackupConfiguration"
              (\ o ->
                 BackupConfiguration Core.<$>
                   (o Core..:? "backupRetentionSettings") Core.<*>
                     (o Core..:? "backupTier")
...
instance Core.ToJSON BackupConfiguration where
        toJSON BackupConfiguration{..}
          = Core.object
              (Core.catMaybes
                 [("backupRetentionSettings" Core..=) Core.<$>
                    backupRetentionSettings,
                  ("backupTier" Core..=) Core.<$> backupTier,
                  ("binaryLogEnabled" Core..=) Core.<$> binaryLogEnabled,
                  ("enabled" Core..=) Core.<$> enabled,
                  ("kind" Core..=) Core.<$> kind,
                  ("location" Core..=) Core.<$> location,
                  ("pointInTimeRecoveryEnabled" Core..=) Core.<$>
                    pointInTimeRecoveryEnabled,
                  ("replicationLogArchivingEnabled" Core..=) Core.<$>
                    replicationLogArchivingEnabled,
                  ("startTime" Core..=) Core.<$> startTime,
                  ("transactionLogRetentionDays" Core..=) Core.<$>
                    transactionLogRetentionDays,
                  ("transactionalLogStorageState" Core..=) Core.<$>
...
instance Core.FromJSON BackupContext where
        parseJSON
          = Core.withObject "BackupContext"
              (\ o ->
                 BackupContext Core.<$>
                   (o Core..:? "backupId" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "name"))
...
newBackupReencryptionConfig 
    ::  BackupReencryptionConfig
newBackupReencryptionConfig
  = BackupReencryptionConfig{backupLimit = Core.Nothing,
                             backupType = Core.Nothing}
instance Core.FromJSON BackupReencryptionConfig where
        parseJSON
          = Core.withObject "BackupReencryptionConfig"
              (\ o ->
                 BackupReencryptionConfig Core.<$>
                   (o Core..:? "backupLimit") Core.<*> (o Core..:? "backupType"))
...
newBackupRetentionSettings 
    ::  BackupRetentionSettings
newBackupRetentionSettings
  = BackupRetentionSettings{retainedBackups = Core.Nothing,
                            retentionUnit = Core.Nothing}
instance Core.FromJSON BackupRetentionSettings where
        parseJSON
          = Core.withObject "BackupRetentionSettings"
              (\ o ->
                 BackupRetentionSettings Core.<$>
                   (o Core..:? "retainedBackups") Core.<*>
                     (o Core..:? "retentionUnit"))
...
data BackupRun = BackupRun
    ...
    , databaseVersion :: (Core.Maybe BackupRun_DatabaseVersion)
...
newBackupRun 
    ::  BackupRun
newBackupRun
  = BackupRun{backupKind = Core.Nothing,
              databaseVersion = Core.Nothing, description = Core.Nothing,
              diskEncryptionConfiguration = Core.Nothing,
              diskEncryptionStatus = Core.Nothing, endTime = Core.Nothing,
              enqueuedTime = Core.Nothing, error = Core.Nothing,
              id = Core.Nothing, instance' = Core.Nothing, kind = Core.Nothing,
              location = Core.Nothing, maxChargeableBytes = Core.Nothing,
              selfLink = Core.Nothing, startTime = Core.Nothing,
              status = Core.Nothing, timeZone = Core.Nothing,
              type' = Core.Nothing, windowStartTime = Core.Nothing}
instance Core.FromJSON BackupRun where
        parseJSON
          = Core.withObject "BackupRun"
              (\ o ->
                 BackupRun Core.<$>
                   (o Core..:? "backupKind") Core.<*> (o Core..:? "databaseVersion")
                     Core.<*> (o Core..:? "description")
          ...
          = Core.object
              (Core.catMaybes
                 [("backupKind" Core..=) Core.<$> backupKind,
                  ("databaseVersion" Core..=) Core.<$> databaseVersion,
                  ("description" Core..=) Core.<$> description,
                  ("diskEncryptionConfiguration" Core..=) Core.<$>
                    diskEncryptionConfiguration,
...
newBackupRunsListResponse 
    ::  BackupRunsListResponse
newBackupRunsListResponse
  = BackupRunsListResponse{items = Core.Nothing, kind = Core.Nothing,
                           nextPageToken = Core.Nothing}
instance Core.FromJSON BackupRunsListResponse where
        parseJSON
          = Core.withObject "BackupRunsListResponse"
              (\ o ->
                 BackupRunsListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
...
newBinLogCoordinates 
    ::  BinLogCoordinates
newBinLogCoordinates
  = BinLogCoordinates{binLogFileName = Core.Nothing,
                      binLogPosition = Core.Nothing, kind = Core.Nothing}
instance Core.FromJSON BinLogCoordinates where
        parseJSON
          = Core.withObject "BinLogCoordinates"
              (\ o ->
                 BinLogCoordinates Core.<$>
                   (o Core..:? "binLogFileName") Core.<*>
                     (o Core..:? "binLogPosition" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "kind"))
          ...
          = Core.object
              (Core.catMaybes
                 [("binLogFileName" Core..=) Core.<$> binLogFileName,
                  ("binLogPosition" Core..=) Core.. Core.AsText Core.<$>
                    binLogPosition,
                  ("kind" Core..=) Core.<$> kind])
...
newCloneContext 
    ::  CloneContext
newCloneContext
  = CloneContext{allocatedIpRange = Core.Nothing,
                 binLogCoordinates = Core.Nothing, databaseNames = Core.Nothing,
                 destinationInstanceName = Core.Nothing, kind = Core.Nothing,
                 pitrTimestampMs = Core.Nothing, pointInTime = Core.Nothing,
                 preferredSecondaryZone = Core.Nothing,
                 preferredZone = Core.Nothing}
instance Core.FromJSON CloneContext where
        parseJSON
          = Core.withObject "CloneContext"
              (\ o ->
                 CloneContext Core.<$>
                   (o Core..:? "allocatedIpRange") Core.<*>
                     (o Core..:? "binLogCoordinates")
                     Core.<*> (o Core..:? "databaseNames")
                     Core.<*> (o Core..:? "destinationInstanceName")
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "pitrTimestampMs" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("allocatedIpRange" Core..=) Core.<$> allocatedIpRange,
                  ...
                  ("destinationInstanceName" Core..=) Core.<$>
                    destinationInstanceName,
                  ("kind" Core..=) Core.<$> kind,
                  ("pitrTimestampMs" Core..=) Core.. Core.AsText Core.<$>
                    pitrTimestampMs,
...
--
-- /See:/ 'newConnectPoolNodeConfig' smart constructor.
data ConnectPoolNodeConfig = ConnectPoolNodeConfig
    {
...
-- | Creates a value of 'ConnectPoolNodeConfig' with the minimum fields required to make a request.
newConnectPoolNodeConfig 
    ::  ConnectPoolNodeConfig
newConnectPoolNodeConfig
  = ConnectPoolNodeConfig{dnsName = Core.Nothing,
                          dnsNames = Core.Nothing, ipAddresses = Core.Nothing,
                          name = Core.Nothing}
instance Core.FromJSON ConnectPoolNodeConfig where
        parseJSON
          = Core.withObject "ConnectPoolNodeConfig"
              (\ o ->
                 ConnectPoolNodeConfig Core.<$>
                   (o Core..:? "dnsName") Core.<*> (o Core..:? "dnsNames") Core.<*>
                     (o Core..:? "ipAddresses")
                     Core.<*> (o Core..:? "name"))

instance Core.ToJSON ConnectPoolNodeConfig where
        toJSON ConnectPoolNodeConfig{..}
          = Core.object
              (Core.catMaybes
...
data ConnectSettings = ConnectSettings
    ...
    , nodes :: (Core.Maybe [ConnectPoolNodeConfig])
...
newConnectSettings 
    ::  ConnectSettings
newConnectSettings
  = ConnectSettings{backendType = Core.Nothing,
                    customSubjectAlternativeNames = Core.Nothing,
                    databaseVersion = Core.Nothing, dnsName = Core.Nothing,
                    dnsNames = Core.Nothing, ipAddresses = Core.Nothing,
                    kind = Core.Nothing, nodeCount = Core.Nothing,
                    nodes = Core.Nothing, pscEnabled = Core.Nothing,
                    region = Core.Nothing, serverCaCert = Core.Nothing,
                    serverCaMode = Core.Nothing}
instance Core.FromJSON ConnectSettings where
        parseJSON
          = Core.withObject "ConnectSettings"
              (\ o ->
                 ConnectSettings Core.<$>
                   (o Core..:? "backendType") Core.<*>
                     (o Core..:? "customSubjectAlternativeNames")
                     Core.<*> (o Core..:? "databaseVersion")
                     Core.<*> (o Core..:? "dnsName")
          ...
          = Core.object
              (Core.catMaybes
                 [("backendType" Core..=) Core.<$> backendType,
                  ("customSubjectAlternativeNames" Core..=) Core.<$>
...
--
-- /See:/ 'newConnectionPoolConfig' smart constructor.
data ConnectionPoolConfig = ConnectionPoolConfig
    {
      -- | Whether managed connection pooling is enabled.
      connectionPoolingEnabled :: (Core.Maybe Core.Bool)
      -- | Optional. List of connection pool configuration flags.
    , flags :: (Core.Maybe [ConnectionPoolFlags])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ConnectionPoolConfig' with the minimum fields required to make a request.
newConnectionPoolConfig 
    ::  ConnectionPoolConfig
newConnectionPoolConfig
  = ConnectionPoolConfig{connectionPoolingEnabled = Core.Nothing,
                         flags = Core.Nothing}
instance Core.FromJSON ConnectionPoolConfig where
        parseJSON
          = Core.withObject "ConnectionPoolConfig"
              (\ o ->
                 ConnectionPoolConfig Core.<$>
                   (o Core..:? "connectionPoolingEnabled") Core.<*>
                     (o Core..:? "flags"))

instance Core.ToJSON ConnectionPoolConfig where
        toJSON ConnectionPoolConfig{..}
          = Core.object
              (Core.catMaybes
                 [("connectionPoolingEnabled" Core..=) Core.<$>
...
--
-- /See:/ 'newConnectionPoolFlags' smart constructor.
data ConnectionPoolFlags = ConnectionPoolFlags
    {
...
-- | Creates a value of 'ConnectionPoolFlags' with the minimum fields required to make a request.
newConnectionPoolFlags 
    ::  ConnectionPoolFlags
newConnectionPoolFlags
  = ConnectionPoolFlags{name = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON ConnectionPoolFlags where
        parseJSON
          = Core.withObject "ConnectionPoolFlags"
              (\ o ->
                 ConnectionPoolFlags Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "value"))

instance Core.ToJSON ConnectionPoolFlags where
        toJSON ConnectionPoolFlags{..}
          = Core.object
              (Core.catMaybes
...
instance Core.FromJSON DataCacheConfig where
        parseJSON
          = Core.withObject "DataCacheConfig"
...
newDatabase 
    ::  Database
newDatabase
  = Database{charset = Core.Nothing, collation = Core.Nothing,
             etag = Core.Nothing, instance' = Core.Nothing, kind = Core.Nothing,
             name = Core.Nothing, project = Core.Nothing,
             selfLink = Core.Nothing, sqlserverDatabaseDetails = Core.Nothing}
instance Core.FromJSON Database where
        parseJSON
          = Core.withObject "Database"
              (\ o ->
                 Database Core.<$>
                   (o Core..:? "charset") Core.<*> (o Core..:? "collation") Core.<*>
                     (o Core..:? "etag")
                     Core.<*> (o Core..:? "instance")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("charset" Core..=) Core.<$> charset,
                  ...
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("sqlserverDatabaseDetails" Core..=) Core.<$>
                    sqlserverDatabaseDetails])
...
data DatabaseInstance = DatabaseInstance
    ...
    , clearNetwork :: (Core.Maybe Core.Bool)
    ...
    , nodeCount :: (Core.Maybe Core.Int32)
      -- | Output only. Entries containing information about each read pool node of the read pool.
    , nodes :: (Core.Maybe [PoolNodeConfig])
...
newDatabaseInstance 
    ::  DatabaseInstance
newDatabaseInstance
  = DatabaseInstance{availableMaintenanceVersions = Core.Nothing,
                     backendType = Core.Nothing, clearNetwork = Core.Nothing,
                     connectionName = Core.Nothing, createTime = Core.Nothing,
                     currentDiskSize = Core.Nothing,
                     databaseInstalledVersion = Core.Nothing,
                     databaseVersion = Core.Nothing,
                     diskEncryptionConfiguration = Core.Nothing,
                     diskEncryptionStatus = Core.Nothing, dnsName = Core.Nothing,
                     dnsNames = Core.Nothing, etag = Core.Nothing,
                     failoverReplica = Core.Nothing, gceZone = Core.Nothing,
                     geminiConfig = Core.Nothing,
                     includeReplicasForMajorVersionUpgrade = Core.Nothing,
                     instanceType = Core.Nothing, ipAddresses = Core.Nothing,
                     ipv6Address = Core.Nothing, kind = Core.Nothing,
                     maintenanceVersion = Core.Nothing,
                     masterInstanceName = Core.Nothing, maxDiskSize = Core.Nothing,
                     name = Core.Nothing, nodeCount = Core.Nothing,
                     nodes = Core.Nothing, onPremisesConfiguration = Core.Nothing,
                     outOfDiskReport = Core.Nothing, primaryDnsName = Core.Nothing,
                     project = Core.Nothing, pscServiceAttachmentLink = Core.Nothing,
                     region = Core.Nothing, replicaConfiguration = Core.Nothing,
                     replicaNames = Core.Nothing, replicationCluster = Core.Nothing,
                     rootPassword = Core.Nothing, satisfiesPzi = Core.Nothing,
                     satisfiesPzs = Core.Nothing, scheduledMaintenance = Core.Nothing,
                     secondaryGceZone = Core.Nothing, selfLink = Core.Nothing,
                     serverCaCert = Core.Nothing,
                     serviceAccountEmailAddress = Core.Nothing, settings = Core.Nothing,
                     sqlNetworkArchitecture = Core.Nothing, state = Core.Nothing,
                     suspensionReason = Core.Nothing,
                     switchTransactionLogsToCloudStorageEnabled = Core.Nothing,
                     tags = Core.Nothing, upgradableDatabaseVersions = Core.Nothing,
                     writeEndpoint = Core.Nothing}
instance Core.FromJSON DatabaseInstance where
        parseJSON
          = Core.withObject "DatabaseInstance"
              (\ o ->
                 DatabaseInstance Core.<$>
                   (o Core..:? "availableMaintenanceVersions") Core.<*>
                     (o Core..:? "backendType")
                     Core.<*> (o Core..:? "clearNetwork")
                     Core.<*> (o Core..:? "connectionName")
                     Core.<*> (o Core..:? "createTime")
                     Core.<*>
                     (o Core..:? "currentDiskSize" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "maxDiskSize" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "nodeCount")
                     Core.<*> (o Core..:? "nodes")
...
instance Core.ToJSON DatabaseInstance where
        toJSON DatabaseInstance{..}
          = Core.object
              (Core.catMaybes
                 [("availableMaintenanceVersions" Core..=) Core.<$>
                    availableMaintenanceVersions,
                  ("backendType" Core..=) Core.<$> backendType,
                  ("clearNetwork" Core..=) Core.<$> clearNetwork,
                  ("connectionName" Core..=) Core.<$> connectionName,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("currentDiskSize" Core..=) Core.. Core.AsText Core.<$>
                    currentDiskSize,
                  ("databaseInstalledVersion" Core..=) Core.<$>
                  ...
                  ("includeReplicasForMajorVersionUpgrade" Core..=) Core.<$>
                  ...
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("serverCaCert" Core..=) Core.<$> serverCaCert,
                  ("serviceAccountEmailAddress" Core..=) Core.<$>
                  ...
                  ("switchTransactionLogsToCloudStorageEnabled" Core..=) Core.<$>
                    switchTransactionLogsToCloudStorageEnabled,
                  ("tags" Core..=) Core.<$> tags,
                  ("upgradableDatabaseVersions" Core..=) Core.<$>
...
newDatabaseInstance_FailoverReplica 
    :: 
                                    DatabaseInstance_FailoverReplica
newDatabaseInstance_FailoverReplica
  = DatabaseInstance_FailoverReplica{available = Core.Nothing,
                                     name = Core.Nothing}
instance Core.FromJSON DatabaseInstance_FailoverReplica where
        parseJSON
          = Core.withObject "DatabaseInstance_FailoverReplica"
              (\ o ->
                 DatabaseInstance_FailoverReplica Core.<$>
                   (o Core..:? "available") Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON DatabaseInstance_Tags where
        parseJSON
          = Core.withObject "DatabaseInstance_Tags"
...
instance Core.FromJSON DatabasesListResponse where
        parseJSON
          = Core.withObject "DatabasesListResponse"
              (\ o ->
                 DatabasesListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind"))
...
newDemoteContext 
    ::  DemoteContext
newDemoteContext
  = DemoteContext{kind = Core.Nothing,
                  sourceRepresentativeInstanceName = Core.Nothing}
instance Core.FromJSON DemoteContext where
        parseJSON
          = Core.withObject "DemoteContext"
              (\ o ->
                 DemoteContext Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "sourceRepresentativeInstanceName"))
...
instance Core.ToJSON DemoteContext where
        toJSON DemoteContext{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ("sourceRepresentativeInstanceName" Core..=) Core.<$>
...
newDemoteMasterConfiguration 
    ::  DemoteMasterConfiguration
newDemoteMasterConfiguration
  = DemoteMasterConfiguration{kind = Core.Nothing,
                              mysqlReplicaConfiguration = Core.Nothing}
instance Core.FromJSON DemoteMasterConfiguration where
        parseJSON
          = Core.withObject "DemoteMasterConfiguration"
              (\ o ->
                 DemoteMasterConfiguration Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "mysqlReplicaConfiguration"))
...
instance Core.ToJSON DemoteMasterConfiguration where
        toJSON DemoteMasterConfiguration{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ("mysqlReplicaConfiguration" Core..=) Core.<$>
                    mysqlReplicaConfiguration])
...
newDemoteMasterContext 
    ::  DemoteMasterContext
newDemoteMasterContext
  = DemoteMasterContext{kind = Core.Nothing,
...
instance Core.FromJSON DemoteMasterContext where
        parseJSON
          = Core.withObject "DemoteMasterContext"
              (\ o ->
                 DemoteMasterContext Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "masterInstanceName")
                     Core.<*> (o Core..:? "replicaConfiguration")
...
newDemoteMasterMySqlReplicaConfiguration
  = DemoteMasterMySqlReplicaConfiguration{caCertificate =
                                          ...
                                          clientKey = Core.Nothing, kind = Core.Nothing,
                                          password = Core.Nothing, username = Core.Nothing}
instance Core.FromJSON DemoteMasterMySqlReplicaConfiguration where
        parseJSON
          = Core.withObject "DemoteMasterMySqlReplicaConfiguration"
              (\ o ->
                 DemoteMasterMySqlReplicaConfiguration Core.<$>
                   (o Core..:? "caCertificate") Core.<*>
                     (o Core..:? "clientCertificate")
...
newDenyMaintenancePeriod 
    ::  DenyMaintenancePeriod
newDenyMaintenancePeriod
  = DenyMaintenancePeriod{endDate = Core.Nothing,
                          startDate = Core.Nothing, time = Core.Nothing}
instance Core.FromJSON DenyMaintenancePeriod where
        parseJSON
          = Core.withObject "DenyMaintenancePeriod"
              (\ o ->
                 DenyMaintenancePeriod Core.<$>
                   (o Core..:? "endDate") Core.<*> (o Core..:? "startDate") Core.<*>
                     (o Core..:? "time"))
...
newDiskEncryptionConfiguration 
    ::  DiskEncryptionConfiguration
newDiskEncryptionConfiguration
  = DiskEncryptionConfiguration{kind = Core.Nothing,
                                kmsKeyName = Core.Nothing}
instance Core.FromJSON DiskEncryptionConfiguration where
        parseJSON
          = Core.withObject "DiskEncryptionConfiguration"
              (\ o ->
                 DiskEncryptionConfiguration Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "kmsKeyName"))
...
newDiskEncryptionStatus 
    ::  DiskEncryptionStatus
newDiskEncryptionStatus
  = DiskEncryptionStatus{kind = Core.Nothing,
                         kmsKeyVersionName = Core.Nothing}
instance Core.FromJSON DiskEncryptionStatus where
        parseJSON
          = Core.withObject "DiskEncryptionStatus"
              (\ o ->
                 DiskEncryptionStatus Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "kmsKeyVersionName"))
...
newDnsNameMapping 
    ::  DnsNameMapping
newDnsNameMapping
  = DnsNameMapping{connectionType = Core.Nothing,
                   dnsScope = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON DnsNameMapping where
        parseJSON
          = Core.withObject "DnsNameMapping"
              (\ o ->
                 DnsNameMapping Core.<$>
                   (o Core..:? "connectionType") Core.<*> (o Core..:? "dnsScope")
                     Core.<*> (o Core..:? "name"))
...
newExportContext 
    ::  ExportContext
newExportContext
  = ExportContext{bakExportOptions = Core.Nothing,
                  csvExportOptions = Core.Nothing, databases = Core.Nothing,
                  fileType = Core.Nothing, kind = Core.Nothing,
                  offload = Core.Nothing, sqlExportOptions = Core.Nothing,
                  tdeExportOptions = Core.Nothing, uri = Core.Nothing}
instance Core.FromJSON ExportContext where
        parseJSON
          = Core.withObject "ExportContext"
              (\ o ->
                 ExportContext Core.<$>
                   (o Core..:? "bakExportOptions") Core.<*>
                     (o Core..:? "csvExportOptions")
...
newExportContext_BakExportOptions 
    ::  ExportContext_BakExportOptions
newExportContext_BakExportOptions
  = ExportContext_BakExportOptions{bakType = Core.Nothing,
                                   copyOnly = Core.Nothing, differentialBase = Core.Nothing,
                                   exportLogEndTime = Core.Nothing,
                                   exportLogStartTime = Core.Nothing, stripeCount = Core.Nothing,
                                   striped = Core.Nothing}
instance Core.FromJSON ExportContext_BakExportOptions where
        parseJSON
          = Core.withObject "ExportContext_BakExportOptions"
              (\ o ->
                 ExportContext_BakExportOptions Core.<$>
                   (o Core..:? "bakType") Core.<*> (o Core..:? "copyOnly") Core.<*>
                     (o Core..:? "differentialBase")
...
newExportContext_CsvExportOptions 
    ::  ExportContext_CsvExportOptions
newExportContext_CsvExportOptions
  = ExportContext_CsvExportOptions{escapeCharacter = Core.Nothing,
                                   fieldsTerminatedBy = Core.Nothing,
                                   linesTerminatedBy = Core.Nothing, quoteCharacter = Core.Nothing,
                                   selectQuery = Core.Nothing}
instance Core.FromJSON ExportContext_CsvExportOptions where
        parseJSON
          = Core.withObject "ExportContext_CsvExportOptions"
              (\ o ->
                 ExportContext_CsvExportOptions Core.<$>
                   (o Core..:? "escapeCharacter") Core.<*>
                     (o Core..:? "fieldsTerminatedBy")
...
newExportContext_SqlExportOptions 
    ::  ExportContext_SqlExportOptions
newExportContext_SqlExportOptions
  = ExportContext_SqlExportOptions{mysqlExportOptions = Core.Nothing,
                                   parallel = Core.Nothing, postgresExportOptions = Core.Nothing,
                                   schemaOnly = Core.Nothing, tables = Core.Nothing,
                                   threads = Core.Nothing}
instance Core.FromJSON ExportContext_SqlExportOptions where
        parseJSON
          = Core.withObject "ExportContext_SqlExportOptions"
              (\ o ->
                 ExportContext_SqlExportOptions Core.<$>
                   (o Core..:? "mysqlExportOptions") Core.<*> (o Core..:? "parallel")
...
newExportContext_SqlExportOptions_MysqlExportOptions 
    :: 
                                                     ExportContext_SqlExportOptions_MysqlExportOptions
newExportContext_SqlExportOptions_MysqlExportOptions
  = ExportContext_SqlExportOptions_MysqlExportOptions{masterData =
                                                        Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ExportContext_SqlExportOptions_MysqlExportOptions"
              (\ o ->
                 ExportContext_SqlExportOptions_MysqlExportOptions Core.<$>
                   (o Core..:? "masterData"))
...
newExportContext_SqlExportOptions_PostgresExportOptions 
    :: 
                                                        ExportContext_SqlExportOptions_PostgresExportOptions
newExportContext_SqlExportOptions_PostgresExportOptions
  = ExportContext_SqlExportOptions_PostgresExportOptions{clean =
                                                           Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ExportContext_SqlExportOptions_PostgresExportOptions"
              (\ o ->
                 ExportContext_SqlExportOptions_PostgresExportOptions Core.<$>
                   (o Core..:? "clean") Core.<*> (o Core..:? "ifExists"))
...
newExportContext_TdeExportOptions 
    ::  ExportContext_TdeExportOptions
newExportContext_TdeExportOptions
  = ExportContext_TdeExportOptions{certificatePath = Core.Nothing,
                                   name = Core.Nothing, privateKeyPassword = Core.Nothing,
                                   privateKeyPath = Core.Nothing}
instance Core.FromJSON ExportContext_TdeExportOptions where
        parseJSON
          = Core.withObject "ExportContext_TdeExportOptions"
              (\ o ->
                 ExportContext_TdeExportOptions Core.<$>
                   (o Core..:? "certificatePath") Core.<*> (o Core..:? "name")
...
instance Core.FromJSON ExternalSyncSelectedObject where
        parseJSON
          = Core.withObject "ExternalSyncSelectedObject"
              (\ o ->
...
newFailoverContext 
    ::  FailoverContext
newFailoverContext
  = FailoverContext{kind = Core.Nothing,
                    settingsVersion = Core.Nothing}
instance Core.FromJSON FailoverContext where
        parseJSON
          = Core.withObject "FailoverContext"
              (\ o ->
                 FailoverContext Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "settingsVersion" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.ToJSON FailoverContext where
        toJSON FailoverContext{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ("settingsVersion" Core..=) Core.. Core.AsText Core.<$>
                    settingsVersion])
...
data Flag = Flag
    ...
    , appliesTo :: (Core.Maybe [Flag_AppliesToItem])
      -- | Scope of flag.
    , flagScope :: (Core.Maybe Flag_FlagScope)
    ...
    , recommendedIntValue :: (Core.Maybe Core.Int64)
      -- | Recommended string value in string format for UI display.
    , recommendedStringValue :: (Core.Maybe Core.Text)
...
newFlag 
    ::  Flag
newFlag
  = Flag{allowedIntValues = Core.Nothing,
         allowedStringValues = Core.Nothing, appliesTo = Core.Nothing,
         flagScope = Core.Nothing, inBeta = Core.Nothing,
         kind = Core.Nothing, maxValue = Core.Nothing,
         minValue = Core.Nothing, name = Core.Nothing,
         recommendedIntValue = Core.Nothing,
         recommendedStringValue = Core.Nothing,
         requiresRestart = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Flag where
        parseJSON
          = Core.withObject "Flag"
              (\ o ->
                 Flag Core.<$>
                   (o Core..:? "allowedIntValues" Core.<&>
                      Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*> (o Core..:? "allowedStringValues")
                     Core.<*> (o Core..:? "appliesTo")
                     Core.<*> (o Core..:? "flagScope")
                     Core.<*> (o Core..:? "inBeta")
                     Core.<*> (o Core..:? "kind")
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "recommendedIntValue" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "recommendedStringValue")
...
instance Core.ToJSON Flag where
        toJSON Flag{..}
          = Core.object
              (Core.catMaybes
                 [("allowedIntValues" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    allowedIntValues,
                  ("allowedStringValues" Core..=) Core.<$> allowedStringValues,
                  ("appliesTo" Core..=) Core.<$> appliesTo,
                  ("flagScope" Core..=) Core.<$> flagScope,
                  ("inBeta" Core..=) Core.<$> inBeta, ("kind" Core..=) Core.<$> kind,
                  ("maxValue" Core..=) Core.. Core.AsText Core.<$> maxValue,
                  ("minValue" Core..=) Core.. Core.AsText Core.<$> minValue,
                  ("name" Core..=) Core.<$> name,
                  ("recommendedIntValue" Core..=) Core.. Core.AsText Core.<$>
                    recommendedIntValue,
                  ("recommendedStringValue" Core..=) Core.<$> recommendedStringValue,
...
instance Core.FromJSON FlagsListResponse where
        parseJSON
          = Core.withObject "FlagsListResponse"
              (\ o ->
                 FlagsListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind"))
...
newGeminiInstanceConfig 
    ::  GeminiInstanceConfig
newGeminiInstanceConfig
  = GeminiInstanceConfig{activeQueryEnabled = Core.Nothing,
                         entitled = Core.Nothing, flagRecommenderEnabled = Core.Nothing,
...
instance Core.FromJSON GeminiInstanceConfig where
        parseJSON
          = Core.withObject "GeminiInstanceConfig"
              (\ o ->
                 GeminiInstanceConfig Core.<$>
                   (o Core..:? "activeQueryEnabled") Core.<*> (o Core..:? "entitled")
...
newGenerateEphemeralCertRequest 
    ::  GenerateEphemeralCertRequest
newGenerateEphemeralCertRequest
  = GenerateEphemeralCertRequest{accessToken = Core.Nothing,
                                 publicKey = Core.Nothing, readTime = Core.Nothing,
                                 validDuration = Core.Nothing}
instance Core.FromJSON GenerateEphemeralCertRequest where
        parseJSON
          = Core.withObject "GenerateEphemeralCertRequest"
              (\ o ->
                 GenerateEphemeralCertRequest Core.<$>
                   (o Core..:? "access_token") Core.<*> (o Core..:? "public_key")
...
instance Core.FromJSON GenerateEphemeralCertResponse where
        parseJSON
          = Core.withObject "GenerateEphemeralCertResponse"
              (\ o ->
                 GenerateEphemeralCertResponse Core.<$>
                   (o Core..:? "ephemeralCert"))
...
newImportContext 
    ::  ImportContext
newImportContext
  = ImportContext{bakImportOptions = Core.Nothing,
                  csvImportOptions = Core.Nothing, database = Core.Nothing,
                  fileType = Core.Nothing, importUser = Core.Nothing,
                  kind = Core.Nothing, sqlImportOptions = Core.Nothing,
                  tdeImportOptions = Core.Nothing, uri = Core.Nothing}
instance Core.FromJSON ImportContext where
        parseJSON
          = Core.withObject "ImportContext"
              (\ o ->
                 ImportContext Core.<$>
                   (o Core..:? "bakImportOptions") Core.<*>
                     (o Core..:? "csvImportOptions")
...
newImportContext_BakImportOptions 
    ::  ImportContext_BakImportOptions
newImportContext_BakImportOptions
  = ImportContext_BakImportOptions{bakType = Core.Nothing,
                                   encryptionOptions = Core.Nothing, noRecovery = Core.Nothing,
                                   recoveryOnly = Core.Nothing, stopAt = Core.Nothing,
                                   stopAtMark = Core.Nothing, striped = Core.Nothing}
instance Core.FromJSON ImportContext_BakImportOptions where
        parseJSON
          = Core.withObject "ImportContext_BakImportOptions"
              (\ o ->
                 ImportContext_BakImportOptions Core.<$>
                   (o Core..:? "bakType") Core.<*> (o Core..:? "encryptionOptions")
...
newImportContext_BakImportOptions_EncryptionOptions 
    :: 
                                                    ImportContext_BakImportOptions_EncryptionOptions
newImportContext_BakImportOptions_EncryptionOptions
  = ImportContext_BakImportOptions_EncryptionOptions{certPath =
                                                       Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ImportContext_BakImportOptions_EncryptionOptions"
              (\ o ->
                 ImportContext_BakImportOptions_EncryptionOptions Core.<$>
                   (o Core..:? "certPath") Core.<*> (o Core..:? "keepEncrypted")
...
newImportContext_CsvImportOptions 
    ::  ImportContext_CsvImportOptions
newImportContext_CsvImportOptions
  = ImportContext_CsvImportOptions{columns = Core.Nothing,
...
instance Core.FromJSON ImportContext_CsvImportOptions where
        parseJSON
          = Core.withObject "ImportContext_CsvImportOptions"
              (\ o ->
                 ImportContext_CsvImportOptions Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "escapeCharacter")
...
newImportContext_SqlImportOptions 
    ::  ImportContext_SqlImportOptions
newImportContext_SqlImportOptions
  = ImportContext_SqlImportOptions{parallel = Core.Nothing,
                                   postgresImportOptions = Core.Nothing, threads = Core.Nothing}
instance Core.FromJSON ImportContext_SqlImportOptions where
        parseJSON
          = Core.withObject "ImportContext_SqlImportOptions"
              (\ o ->
                 ImportContext_SqlImportOptions Core.<$>
                   (o Core..:? "parallel") Core.<*>
                     (o Core..:? "postgresImportOptions")
                     Core.<*> (o Core..:? "threads"))
...
newImportContext_SqlImportOptions_PostgresImportOptions 
    :: 
                                                        ImportContext_SqlImportOptions_PostgresImportOptions
newImportContext_SqlImportOptions_PostgresImportOptions
  = ImportContext_SqlImportOptions_PostgresImportOptions{clean =
                                                           Core.Nothing,
                                                         ifExists = Core.Nothing}
instance Core.FromJSON
           ImportContext_SqlImportOptions_PostgresImportOptions
        ...
        parseJSON
          = Core.withObject
              "ImportContext_SqlImportOptions_PostgresImportOptions"
              (\ o ->
                 ImportContext_SqlImportOptions_PostgresImportOptions Core.<$>
                   (o Core..:? "clean") Core.<*> (o Core..:? "ifExists"))
...
newImportContext_TdeImportOptions 
    ::  ImportContext_TdeImportOptions
newImportContext_TdeImportOptions
  = ImportContext_TdeImportOptions{certificatePath = Core.Nothing,
                                   name = Core.Nothing, privateKeyPassword = Core.Nothing,
                                   privateKeyPath = Core.Nothing}
instance Core.FromJSON ImportContext_TdeImportOptions where
        parseJSON
          = Core.withObject "ImportContext_TdeImportOptions"
              (\ o ->
                 ImportContext_TdeImportOptions Core.<$>
                   (o Core..:? "certificatePath") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "privateKeyPassword")
                     Core.<*> (o Core..:? "privateKeyPath"))
...
newInsightsConfig 
    ::  InsightsConfig
newInsightsConfig
  = InsightsConfig{queryInsightsEnabled = Core.Nothing,
...
instance Core.FromJSON InsightsConfig where
        parseJSON
          = Core.withObject "InsightsConfig"
              (\ o ->
                 InsightsConfig Core.<$>
                   (o Core..:? "queryInsightsEnabled") Core.<*>
                     (o Core..:? "queryPlansPerMinute")
...
newInstanceReference 
    ::  InstanceReference
newInstanceReference
  = InstanceReference{name = Core.Nothing, project = Core.Nothing,
                      region = Core.Nothing}
          ...
          = Core.withObject "InstanceReference"
              (\ o ->
                 InstanceReference Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "project") Core.<*>
                     (o Core..:? "region"))
...
instance Core.FromJSON InstancesAcquireSsrsLeaseRequest where
        parseJSON
          = Core.withObject "InstancesAcquireSsrsLeaseRequest"
              (\ o ->
                 InstancesAcquireSsrsLeaseRequest Core.<$>
                   (o Core..:? "acquireSsrsLeaseContext"))

instance Core.ToJSON InstancesAcquireSsrsLeaseRequest where
        toJSON InstancesAcquireSsrsLeaseRequest{..}
          = Core.object
              (Core.catMaybes
                 [("acquireSsrsLeaseContext" Core..=) Core.<$>
                    acquireSsrsLeaseContext])
...
instance Core.FromJSON InstancesCloneRequest where
        parseJSON
          = Core.withObject "InstancesCloneRequest"
...
instance Core.FromJSON InstancesDemoteMasterRequest where
        parseJSON
          = Core.withObject "InstancesDemoteMasterRequest"
              (\ o ->
                 InstancesDemoteMasterRequest Core.<$>
                   (o Core..:? "demoteMasterContext"))
...
instance Core.FromJSON InstancesDemoteRequest where
        parseJSON
          = Core.withObject "InstancesDemoteRequest"
              (\ o ->
...
instance Core.FromJSON InstancesExportRequest where
        parseJSON
          = Core.withObject "InstancesExportRequest"
              (\ o ->
...
instance Core.FromJSON InstancesFailoverRequest where
        parseJSON
          = Core.withObject "InstancesFailoverRequest"
              (\ o ->
...
instance Core.FromJSON InstancesImportRequest where
        parseJSON
          = Core.withObject "InstancesImportRequest"
              (\ o ->
...
newInstancesListResponse 
    ::  InstancesListResponse
newInstancesListResponse
  = InstancesListResponse{items = Core.Nothing, kind = Core.Nothing,
                          nextPageToken = Core.Nothing, warnings = Core.Nothing}
instance Core.FromJSON InstancesListResponse where
        parseJSON
          = Core.withObject "InstancesListResponse"
              (\ o ->
                 InstancesListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken")
...
newInstancesListServerCasResponse 
    ::  InstancesListServerCasResponse
newInstancesListServerCasResponse
  = InstancesListServerCasResponse{activeVersion = Core.Nothing,
                                   certs = Core.Nothing, kind = Core.Nothing}
instance Core.FromJSON InstancesListServerCasResponse where
        parseJSON
          = Core.withObject "InstancesListServerCasResponse"
              (\ o ->
                 InstancesListServerCasResponse Core.<$>
                   (o Core..:? "activeVersion") Core.<*> (o Core..:? "certs") Core.<*>
                     (o Core..:? "kind"))
          ...
          = Core.object
              (Core.catMaybes
                 [("activeVersion" Core..=) Core.<$> activeVersion,
                  ("certs" Core..=) Core.<$> certs, ("kind" Core..=) Core.<$> kind])
...
newInstancesListServerCertificatesResponse 
    :: 
                                           InstancesListServerCertificatesResponse
newInstancesListServerCertificatesResponse
  = InstancesListServerCertificatesResponse{activeVersion =
                                              Core.Nothing,
                                            caCerts = Core.Nothing, kind = Core.Nothing,
                                            serverCerts = Core.Nothing}
instance Core.FromJSON InstancesListServerCertificatesResponse
         where
        parseJSON
          = Core.withObject "InstancesListServerCertificatesResponse"
              (\ o ->
                 InstancesListServerCertificatesResponse Core.<$>
                   (o Core..:? "activeVersion") Core.<*> (o Core..:? "caCerts")
                     Core.<*> (o Core..:? "kind")
...
instance Core.FromJSON InstancesReencryptRequest where
        parseJSON
          = Core.withObject "InstancesReencryptRequest"
              (\ o ->
                 InstancesReencryptRequest Core.<$>
                   (o Core..:? "backupReencryptionConfig"))

instance Core.ToJSON InstancesReencryptRequest where
        toJSON InstancesReencryptRequest{..}
          = Core.object
              (Core.catMaybes
                 [("backupReencryptionConfig" Core..=) Core.<$>
                    backupReencryptionConfig])
...
data InstancesRestoreBackupRequest = InstancesRestoreBackupRequest
    {
      ...
      -- | The name of the backup that\'s used to restore a Cloud SQL instance: Format: \"projects\/{project-id}\/locations\/{location}\/backupVaults\/{backupvault}\/dataSources\/{datasource}\/backups\/{backup-uid}\". Only one of restore/backup/context, backup, backupdr_backup can be passed to the input.
    , backupdrBackup :: (Core.Maybe Core.Text)
...
newInstancesRestoreBackupRequest 
    ::  InstancesRestoreBackupRequest
newInstancesRestoreBackupRequest
  = InstancesRestoreBackupRequest{backup = Core.Nothing,
                                  backupdrBackup = Core.Nothing,
...
instance Core.FromJSON InstancesRestoreBackupRequest where
        parseJSON
          = Core.withObject "InstancesRestoreBackupRequest"
              (\ o ->
                 InstancesRestoreBackupRequest Core.<$>
                   (o Core..:? "backup") Core.<*> (o Core..:? "backupdrBackup")
          ...
          = Core.object
              (Core.catMaybes
                 [("backup" Core..=) Core.<$> backup,
                  ("backupdrBackup" Core..=) Core.<$> backupdrBackup,
                  ("restoreBackupContext" Core..=) Core.<$> restoreBackupContext,
                  ("restoreInstanceSettings" Core..=) Core.<$>
...
instance Core.FromJSON InstancesRotateServerCaRequest where
        parseJSON
          = Core.withObject "InstancesRotateServerCaRequest"
              (\ o ->
                 InstancesRotateServerCaRequest Core.<$>
                   (o Core..:? "rotateServerCaContext"))
...
newInstancesRotateServerCertificateRequest 
    :: 
                                           InstancesRotateServerCertificateRequest
newInstancesRotateServerCertificateRequest
  = InstancesRotateServerCertificateRequest{rotateServerCertificateContext
                                              = Core.Nothing}
instance Core.FromJSON InstancesRotateServerCertificateRequest
         where
        parseJSON
          = Core.withObject "InstancesRotateServerCertificateRequest"
              (\ o ->
                 InstancesRotateServerCertificateRequest Core.<$>
                   (o Core..:? "rotateServerCertificateContext"))

instance Core.ToJSON InstancesRotateServerCertificateRequest where
        toJSON InstancesRotateServerCertificateRequest{..}
          = Core.object
              (Core.catMaybes
                 [("rotateServerCertificateContext" Core..=) Core.<$>
                    rotateServerCertificateContext])
...
instance Core.FromJSON InstancesTruncateLogRequest where
        parseJSON
          = Core.withObject "InstancesTruncateLogRequest"
              (\ o ->
                 InstancesTruncateLogRequest Core.<$>
                   (o Core..:? "truncateLogContext"))
...
newIpConfiguration 
    ::  IpConfiguration
newIpConfiguration
  = IpConfiguration{allocatedIpRange = Core.Nothing,
                    authorizedNetworks = Core.Nothing,
                    customSubjectAlternativeNames = Core.Nothing,
                    enablePrivatePathForGoogleCloudServices = Core.Nothing,
                    ipv4Enabled = Core.Nothing, privateNetwork = Core.Nothing,
                    pscConfig = Core.Nothing, requireSsl = Core.Nothing,
                    serverCaMode = Core.Nothing, serverCaPool = Core.Nothing,
                    sslMode = Core.Nothing}
instance Core.FromJSON IpConfiguration where
        parseJSON
          = Core.withObject "IpConfiguration"
              (\ o ->
                 IpConfiguration Core.<$>
                   (o Core..:? "allocatedIpRange") Core.<*>
                     (o Core..:? "authorizedNetworks")
          ...
          = Core.object
              (Core.catMaybes
                 [("allocatedIpRange" Core..=) Core.<$> allocatedIpRange,
                  ...
                  ("customSubjectAlternativeNames" Core..=) Core.<$>
                    customSubjectAlternativeNames,
                  ("enablePrivatePathForGoogleCloudServices" Core..=) Core.<$>
...
newIpMapping 
    ::  IpMapping
newIpMapping
  = IpMapping{ipAddress = Core.Nothing, timeToRetire = Core.Nothing,
              type' = Core.Nothing}
instance Core.FromJSON IpMapping where
        parseJSON
          = Core.withObject "IpMapping"
              (\ o ->
                 IpMapping Core.<$>
                   (o Core..:? "ipAddress") Core.<*> (o Core..:? "timeToRetire")
                     Core.<*> (o Core..:? "type"))
...
newLocationPreference 
    ::  LocationPreference
newLocationPreference
  = LocationPreference{followGaeApplication = Core.Nothing,
                       kind = Core.Nothing, secondaryZone = Core.Nothing,
                       zone = Core.Nothing}
instance Core.FromJSON LocationPreference where
        parseJSON
          = Core.withObject "LocationPreference"
              (\ o ->
                 LocationPreference Core.<$>
                   (o Core..:? "followGaeApplication") Core.<*> (o Core..:? "kind")
...
newMaintenanceWindow 
    ::  MaintenanceWindow
newMaintenanceWindow
  = MaintenanceWindow{day = Core.Nothing, hour = Core.Nothing,
                      kind = Core.Nothing, updateTrack = Core.Nothing}
instance Core.FromJSON MaintenanceWindow where
        parseJSON
          = Core.withObject "MaintenanceWindow"
              (\ o ->
                 MaintenanceWindow Core.<$>
                   (o Core..:? "day") Core.<*> (o Core..:? "hour") Core.<*>
                     (o Core..:? "kind")
...
instance Core.ToJSON MaintenanceWindow where
        toJSON MaintenanceWindow{..}
          = Core.object
              (Core.catMaybes
                 [("day" Core..=) Core.<$> day, ("hour" Core..=) Core.<$> hour,
                  ("kind" Core..=) Core.<$> kind,
...
newMySqlReplicaConfiguration 
    ::  MySqlReplicaConfiguration
newMySqlReplicaConfiguration
  = MySqlReplicaConfiguration{caCertificate = Core.Nothing,
                              clientCertificate = Core.Nothing, clientKey = Core.Nothing,
                              connectRetryInterval = Core.Nothing, dumpFilePath = Core.Nothing,
                              kind = Core.Nothing, masterHeartbeatPeriod = Core.Nothing,
                              password = Core.Nothing, sslCipher = Core.Nothing,
                              username = Core.Nothing, verifyServerCertificate = Core.Nothing}
instance Core.FromJSON MySqlReplicaConfiguration where
        parseJSON
          = Core.withObject "MySqlReplicaConfiguration"
              (\ o ->
                 MySqlReplicaConfiguration Core.<$>
                   (o Core..:? "caCertificate") Core.<*>
                     ...
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "masterHeartbeatPeriod" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "password")
          ...
          = Core.object
              (Core.catMaybes
                 [("caCertificate" Core..=) Core.<$> caCertificate,
                  ...
                  ("kind" Core..=) Core.<$> kind,
                  ("masterHeartbeatPeriod" Core..=) Core.. Core.AsText Core.<$>
                    masterHeartbeatPeriod,
                  ("password" Core..=) Core.<$> password,
                  ("sslCipher" Core..=) Core.<$> sslCipher,
                  ("username" Core..=) Core.<$> username,
                  ("verifyServerCertificate" Core..=) Core.<$>
...
instance Core.FromJSON MySqlSyncConfig where
        parseJSON
          = Core.withObject "MySqlSyncConfig"
...
newOnPremisesConfiguration 
    ::  OnPremisesConfiguration
newOnPremisesConfiguration
  = OnPremisesConfiguration{caCertificate = Core.Nothing,
                            clientCertificate = Core.Nothing, clientKey = Core.Nothing,
                            dumpFilePath = Core.Nothing, hostPort = Core.Nothing,
                            kind = Core.Nothing, password = Core.Nothing,
                            selectedObjects = Core.Nothing, sourceInstance = Core.Nothing,
                            sslOption = Core.Nothing, username = Core.Nothing}
instance Core.FromJSON OnPremisesConfiguration where
        parseJSON
          = Core.withObject "OnPremisesConfiguration"
              (\ o ->
...
newOperation 
    ::  Operation
newOperation
  = Operation{acquireSsrsLeaseContext = Core.Nothing,
              apiWarning = Core.Nothing, backupContext = Core.Nothing,
              endTime = Core.Nothing, error = Core.Nothing,
              exportContext = Core.Nothing, importContext = Core.Nothing,
              insertTime = Core.Nothing, kind = Core.Nothing,
              name = Core.Nothing, operationType = Core.Nothing,
              selfLink = Core.Nothing, startTime = Core.Nothing,
              status = Core.Nothing, subOperationType = Core.Nothing,
              targetId = Core.Nothing, targetLink = Core.Nothing,
              targetProject = Core.Nothing, user = Core.Nothing}
instance Core.FromJSON Operation where
        parseJSON
          = Core.withObject "Operation"
              (\ o ->
                 Operation Core.<$>
                   (o Core..:? "acquireSsrsLeaseContext") Core.<*>
                     (o Core..:? "apiWarning")
...
newOperationError 
    ::  OperationError
newOperationError
  = OperationError{code = Core.Nothing, kind = Core.Nothing,
...
instance Core.FromJSON OperationErrors where
        parseJSON
          = Core.withObject "OperationErrors"
              (\ o ->
                 OperationErrors Core.<$>
                   (o Core..:? "errors") Core.<*> (o Core..:? "kind"))
...
newOperationMetadata 
    ::  OperationMetadata
newOperationMetadata
  = OperationMetadata{apiVersion = Core.Nothing,
                      cancelRequested = Core.Nothing, createTime = Core.Nothing,
                      endTime = Core.Nothing, statusDetail = Core.Nothing,
                      target = Core.Nothing, verb = Core.Nothing}
instance Core.FromJSON OperationMetadata where
        parseJSON
          = Core.withObject "OperationMetadata"
              (\ o ->
                 OperationMetadata Core.<$>
                   (o Core..:? "apiVersion") Core.<*> (o Core..:? "cancelRequested")
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "endTime")
...
newOperationsListResponse 
    ::  OperationsListResponse
newOperationsListResponse
  = OperationsListResponse{items = Core.Nothing, kind = Core.Nothing,
                           nextPageToken = Core.Nothing}
...
newPasswordStatus 
    ::  PasswordStatus
newPasswordStatus
  = PasswordStatus{locked = Core.Nothing,
                   passwordExpirationTime = Core.Nothing}
instance Core.FromJSON PasswordStatus where
        parseJSON
          = Core.withObject "PasswordStatus"
              (\ o ->
                 PasswordStatus Core.<$>
                   (o Core..:? "locked") Core.<*>
                     (o Core..:? "passwordExpirationTime"))
          ...
          = Core.object
              (Core.catMaybes
                 [("locked" Core..=) Core.<$> locked,
                  ("passwordExpirationTime" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("complexity" Core..=) Core.<$> complexity,
                  ("disallowCompromisedCredentials" Core..=) Core.<$>
                    disallowCompromisedCredentials,
                  ("disallowUsernameSubstring" Core..=) Core.<$>
...
instance Core.FromJSON PerformDiskShrinkContext where
        parseJSON
          = Core.withObject "PerformDiskShrinkContext"
              (\ o ->
                 PerformDiskShrinkContext Core.<$>
                   (o Core..:? "targetSizeGb" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON PerformDiskShrinkContext where
        toJSON PerformDiskShrinkContext{..}
          = Core.object
              (Core.catMaybes
                 [("targetSizeGb" Core..=) Core.. Core.AsText Core.<$>
                    targetSizeGb])


-- | The context to perform a point-in-time recovery of an instance managed by Google Cloud Backup and Disaster Recovery.
--
-- /See:/ 'newPointInTimeRestoreContext' smart constructor.
data PointInTimeRestoreContext = PointInTimeRestoreContext
    {
      -- | Optional. The name of the allocated IP range for the internal IP Cloud SQL instance. For example: \"google-managed-services-default\". If you set this, then Cloud SQL creates the IP address for the cloned instance in the allocated range. This range must comply with <https://tools.ietf.org/html/rfc1035 RFC 1035> standards. Specifically, the name must be 1-63 characters long and match the regular expression <%5B-a-z0-9%5D*%5Ba-z0-9%5D a-z>?. Reserved for future use. http:\/\/go\/speckle-subnet-picker-clone
      allocatedIpRange :: (Core.Maybe Core.Text)
...
-- | Creates a value of 'PointInTimeRestoreContext' with the minimum fields required to make a request.
newPointInTimeRestoreContext 
    ::  PointInTimeRestoreContext
newPointInTimeRestoreContext
  = PointInTimeRestoreContext{allocatedIpRange = Core.Nothing,
                              datasource = Core.Nothing, pointInTime = Core.Nothing,
                              preferredSecondaryZone = Core.Nothing,
                              preferredZone = Core.Nothing, privateNetwork = Core.Nothing,
                              targetInstance = Core.Nothing}
instance Core.FromJSON PointInTimeRestoreContext where
        parseJSON
          = Core.withObject "PointInTimeRestoreContext"
              (\ o ->
                 PointInTimeRestoreContext Core.<$>
                   (o Core..:? "allocatedIpRange") Core.<*> (o Core..:? "datasource")
                     Core.<*> (o Core..:? "pointInTime")
                     Core.<*> (o Core..:? "preferredSecondaryZone")
                     Core.<*> (o Core..:? "preferredZone")
                     Core.<*> (o Core..:? "privateNetwork")
...
instance Core.ToJSON PointInTimeRestoreContext where
        toJSON PointInTimeRestoreContext{..}
          = Core.object
              (Core.catMaybes
                 [("allocatedIpRange" Core..=) Core.<$> allocatedIpRange,
...
-- | Details of a single read pool node of a read pool.
--
-- /See:/ 'newPoolNodeConfig' smart constructor.
data PoolNodeConfig = PoolNodeConfig
    {
      -- | Output only. The DNS name of the read pool node.
      dnsName :: (Core.Maybe Core.Text)
      -- | Output only. The list of DNS names used by this read pool node.
    ...
    , state :: (Core.Maybe PoolNodeConfig_State)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PoolNodeConfig' with the minimum fields required to make a request.
newPoolNodeConfig 
    ::  PoolNodeConfig
newPoolNodeConfig
  = PoolNodeConfig{dnsName = Core.Nothing, dnsNames = Core.Nothing,
                   gceZone = Core.Nothing, ipAddresses = Core.Nothing,
                   name = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON PoolNodeConfig where
        parseJSON
          = Core.withObject "PoolNodeConfig"
              (\ o ->
                 PoolNodeConfig Core.<$>
                   (o Core..:? "dnsName") Core.<*> (o Core..:? "dnsNames") Core.<*>
                     (o Core..:? "gceZone")
...
instance Core.ToJSON PoolNodeConfig where
        toJSON PoolNodeConfig{..}
          = Core.object
              (Core.catMaybes
                 [("dnsName" Core..=) Core.<$> dnsName,
                  ("dnsNames" Core..=) Core.<$> dnsNames,
                  ("gceZone" Core..=) Core.<$> gceZone,
                  ("ipAddresses" Core..=) Core.<$> ipAddresses,
                  ("name" Core..=) Core.<$> name, ("state" Core..=) Core.<$> state])
...
newPscAutoConnectionConfig 
    ::  PscAutoConnectionConfig
newPscAutoConnectionConfig
  = PscAutoConnectionConfig{consumerNetwork = Core.Nothing,
                            consumerNetworkStatus = Core.Nothing,
                            consumerProject = Core.Nothing, ipAddress = Core.Nothing,
                            status = Core.Nothing}
instance Core.FromJSON PscAutoConnectionConfig where
        parseJSON
          = Core.withObject "PscAutoConnectionConfig"
              (\ o ->
                 PscAutoConnectionConfig Core.<$>
                   (o Core..:? "consumerNetwork") Core.<*>
                     (o Core..:? "consumerNetworkStatus")
...
data PscConfig = PscConfig
    ...
    , networkAttachmentUri :: (Core.Maybe Core.Text)
...
newPscConfig 
    ::  PscConfig
newPscConfig
  = PscConfig{allowedConsumerProjects = Core.Nothing,
              networkAttachmentUri = Core.Nothing,
              pscAutoConnections = Core.Nothing, pscEnabled = Core.Nothing}
instance Core.FromJSON PscConfig where
        parseJSON
          = Core.withObject "PscConfig"
              (\ o ->
                 PscConfig Core.<$>
                   (o Core..:? "allowedConsumerProjects") Core.<*>
                     (o Core..:? "networkAttachmentUri")
...
instance Core.ToJSON PscConfig where
        toJSON PscConfig{..}
          = Core.object
              (Core.catMaybes
                 [("allowedConsumerProjects" Core..=) Core.<$>
                    allowedConsumerProjects,
                  ("networkAttachmentUri" Core..=) Core.<$> networkAttachmentUri,
...
newReplicaConfiguration 
    ::  ReplicaConfiguration
newReplicaConfiguration
  = ReplicaConfiguration{cascadableReplica = Core.Nothing,
                         failoverTarget = Core.Nothing, kind = Core.Nothing,
                         mysqlReplicaConfiguration = Core.Nothing}
instance Core.FromJSON ReplicaConfiguration where
        parseJSON
          = Core.withObject "ReplicaConfiguration"
              (\ o ->
                 ReplicaConfiguration Core.<$>
                   (o Core..:? "cascadableReplica") Core.<*>
                     (o Core..:? "failoverTarget")
                     Core.<*> (o Core..:? "kind")
...
newReplicationCluster 
    ::  ReplicationCluster
newReplicationCluster
  = ReplicationCluster{drReplica = Core.Nothing,
                       failoverDrReplicaName = Core.Nothing,
                       psaWriteEndpoint = Core.Nothing}
instance Core.FromJSON ReplicationCluster where
        parseJSON
          = Core.withObject "ReplicationCluster"
              (\ o ->
                 ReplicationCluster Core.<$>
                   (o Core..:? "drReplica") Core.<*>
                     (o Core..:? "failoverDrReplicaName")
...
newReschedule 
    ::  Reschedule
newReschedule
  = Reschedule{rescheduleType = Core.Nothing,
               scheduleTime = Core.Nothing}
instance Core.FromJSON Reschedule where
        parseJSON
          = Core.withObject "Reschedule"
              (\ o ->
                 Reschedule Core.<$>
                   (o Core..:? "rescheduleType") Core.<*> (o Core..:? "scheduleTime"))
...
newRestoreBackupContext 
    ::  RestoreBackupContext
newRestoreBackupContext
  = RestoreBackupContext{backupRunId = Core.Nothing,
                         instanceId = Core.Nothing, kind = Core.Nothing,
                         project = Core.Nothing}
instance Core.FromJSON RestoreBackupContext where
        parseJSON
          = Core.withObject "RestoreBackupContext"
              (\ o ->
                 RestoreBackupContext Core.<$>
                   (o Core..:? "backupRunId" Core.<&> Core.fmap Core.fromAsText)
...
newRotateServerCaContext 
    ::  RotateServerCaContext
newRotateServerCaContext
  = RotateServerCaContext{kind = Core.Nothing,
                          nextVersion = Core.Nothing}
instance Core.FromJSON RotateServerCaContext where
        parseJSON
          = Core.withObject "RotateServerCaContext"
              (\ o ->
                 RotateServerCaContext Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "nextVersion"))
...
newRotateServerCertificateContext 
    ::  RotateServerCertificateContext
newRotateServerCertificateContext
  = RotateServerCertificateContext{kind = Core.Nothing,
                                   nextVersion = Core.Nothing}
instance Core.FromJSON RotateServerCertificateContext where
        parseJSON
          = Core.withObject "RotateServerCertificateContext"
              (\ o ->
...
instance Core.FromJSON SelectedObjects where
        parseJSON
          = Core.withObject "SelectedObjects"
...
data Settings = Settings
    ...
    , connectionPoolConfig :: (Core.Maybe ConnectionPoolConfig)
    ...
    , dataDiskProvisionedIops :: (Core.Maybe Core.Int64)
    ...
    , dataDiskProvisionedThroughput :: (Core.Maybe Core.Int64)
...
newSettings 
    ::  Settings
newSettings
  = Settings{activationPolicy = Core.Nothing,
             ...
             backupConfiguration = Core.Nothing, collation = Core.Nothing,
             ...
             dataDiskProvisionedIops = Core.Nothing,
             dataDiskProvisionedThroughput = Core.Nothing,
             dataDiskSizeGb = Core.Nothing, dataDiskType = Core.Nothing,
             databaseFlags = Core.Nothing,
             databaseReplicationEnabled = Core.Nothing,
             deletionProtectionEnabled = Core.Nothing,
             denyMaintenancePeriods = Core.Nothing, edition = Core.Nothing,
             enableDataplexIntegration = Core.Nothing,
             enableGoogleMlIntegration = Core.Nothing,
             insightsConfig = Core.Nothing, ipConfiguration = Core.Nothing,
             kind = Core.Nothing, locationPreference = Core.Nothing,
             ...
             storageAutoResizeLimit = Core.Nothing, tier = Core.Nothing,
             timeZone = Core.Nothing, userLabels = Core.Nothing}
instance Core.FromJSON Settings where
        parseJSON
          = Core.withObject "Settings"
              (\ o ->
                 Settings Core.<$>
                   (o Core..:? "activationPolicy") Core.<*>
                     (o Core..:? "activeDirectoryConfig")
                     ...
                     Core.<*> (o Core..:? "connectionPoolConfig")
                     Core.<*> (o Core..:? "connectorEnforcement")
                     Core.<*> (o Core..:? "crashSafeReplicationEnabled")
                     Core.<*> (o Core..:? "dataCacheConfig")
                     Core.<*>
                     (o Core..:? "dataDiskProvisionedIops" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "dataDiskProvisionedThroughput" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "dataDiskSizeGb" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "storageAutoResizeLimit" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "tier")
                     Core.<*> (o Core..:? "timeZone")
              ...
              (Core.catMaybes
                 [("activationPolicy" Core..=) Core.<$> activationPolicy,
                  ...
                  ("advancedMachineFeatures" Core..=) Core.<$>
                    advancedMachineFeatures,
                  ("authorizedGaeApplications" Core..=) Core.<$>
                    authorizedGaeApplications,
                  ("availabilityType" Core..=) Core.<$> availabilityType,
                  ("backupConfiguration" Core..=) Core.<$> backupConfiguration,
                  ("collation" Core..=) Core.<$> collation,
                  ("connectionPoolConfig" Core..=) Core.<$> connectionPoolConfig,
                  ("connectorEnforcement" Core..=) Core.<$> connectorEnforcement,
                  ("crashSafeReplicationEnabled" Core..=) Core.<$>
                    crashSafeReplicationEnabled,
                  ("dataCacheConfig" Core..=) Core.<$> dataCacheConfig,
                  ("dataDiskProvisionedIops" Core..=) Core.. Core.AsText Core.<$>
                    dataDiskProvisionedIops,
                  ("dataDiskProvisionedThroughput" Core..=) Core.. Core.AsText
                    Core.<$> dataDiskProvisionedThroughput,
                  ("dataDiskSizeGb" Core..=) Core.. Core.AsText Core.<$>
                    dataDiskSizeGb,
                  ("dataDiskType" Core..=) Core.<$> dataDiskType,
                  ("databaseFlags" Core..=) Core.<$> databaseFlags,
                  ("databaseReplicationEnabled" Core..=) Core.<$>
                    databaseReplicationEnabled,
                  ("deletionProtectionEnabled" Core..=) Core.<$>
                    deletionProtectionEnabled,
                  ("denyMaintenancePeriods" Core..=) Core.<$> denyMaintenancePeriods,
                  ("edition" Core..=) Core.<$> edition,
                  ("enableDataplexIntegration" Core..=) Core.<$>
                    enableDataplexIntegration,
                  ("enableGoogleMlIntegration" Core..=) Core.<$>
                  ...
                  ("passwordValidationPolicy" Core..=) Core.<$>
                    passwordValidationPolicy,
                  ("pricingPlan" Core..=) Core.<$> pricingPlan,
                  ("replicationLagMaxSeconds" Core..=) Core.<$>
                  ...
                  ("storageAutoResizeLimit" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON Settings_UserLabels where
        parseJSON
          = Core.withObject "Settings_UserLabels"
...
newSqlActiveDirectoryConfig 
    ::  SqlActiveDirectoryConfig
newSqlActiveDirectoryConfig
  = SqlActiveDirectoryConfig{domain = Core.Nothing,
                             kind = Core.Nothing}
instance Core.FromJSON SqlActiveDirectoryConfig where
        parseJSON
          = Core.withObject "SqlActiveDirectoryConfig"
              (\ o ->
                 SqlActiveDirectoryConfig Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "kind"))
...
newSqlExternalSyncSettingError 
    ::  SqlExternalSyncSettingError
newSqlExternalSyncSettingError
  = SqlExternalSyncSettingError{detail = Core.Nothing,
                                kind = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON SqlExternalSyncSettingError where
        parseJSON
          = Core.withObject "SqlExternalSyncSettingError"
              (\ o ->
                 SqlExternalSyncSettingError Core.<$>
                   (o Core..:? "detail") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "type"))
...
instance Core.FromJSON SqlInstancesAcquireSsrsLeaseResponse where
        parseJSON
          = Core.withObject "SqlInstancesAcquireSsrsLeaseResponse"
              (\ o ->
                 SqlInstancesAcquireSsrsLeaseResponse Core.<$>
                   (o Core..:? "operationId"))
...
newSqlInstancesGetDiskShrinkConfigResponse 
    :: 
                                           SqlInstancesGetDiskShrinkConfigResponse
newSqlInstancesGetDiskShrinkConfigResponse
  = SqlInstancesGetDiskShrinkConfigResponse{kind = Core.Nothing,
                                            message = Core.Nothing,
                                            minimalTargetSizeGb = Core.Nothing}
instance Core.FromJSON SqlInstancesGetDiskShrinkConfigResponse
         where
        parseJSON
          = Core.withObject "SqlInstancesGetDiskShrinkConfigResponse"
              (\ o ->
                 SqlInstancesGetDiskShrinkConfigResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "message") Core.<*>
                     (o Core..:? "minimalTargetSizeGb" Core.<&>
                        Core.fmap Core.fromAsText))
        ...
        toJSON SqlInstancesGetDiskShrinkConfigResponse{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ("message" Core..=) Core.<$> message,
                  ("minimalTargetSizeGb" Core..=) Core.. Core.AsText Core.<$>
                    minimalTargetSizeGb])
...
newSqlInstancesGetLatestRecoveryTimeResponse 
    :: 
                                             SqlInstancesGetLatestRecoveryTimeResponse
newSqlInstancesGetLatestRecoveryTimeResponse
  = SqlInstancesGetLatestRecoveryTimeResponse{kind = Core.Nothing,
                                              latestRecoveryTime = Core.Nothing}
instance Core.FromJSON SqlInstancesGetLatestRecoveryTimeResponse
         where
        parseJSON
          = Core.withObject "SqlInstancesGetLatestRecoveryTimeResponse"
              (\ o ->
                 SqlInstancesGetLatestRecoveryTimeResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "latestRecoveryTime"))

instance Core.ToJSON SqlInstancesGetLatestRecoveryTimeResponse
         where
...
instance Core.FromJSON SqlInstancesReleaseSsrsLeaseResponse where
        parseJSON
          = Core.withObject "SqlInstancesReleaseSsrsLeaseResponse"
              (\ o ->
                 SqlInstancesReleaseSsrsLeaseResponse Core.<$>
                   (o Core..:? "operationId"))
...
newSqlInstancesRescheduleMaintenanceRequestBody
  = SqlInstancesRescheduleMaintenanceRequestBody{reschedule =
                                                   Core.Nothing}
instance Core.FromJSON SqlInstancesRescheduleMaintenanceRequestBody
         where
        parseJSON
          = Core.withObject "SqlInstancesRescheduleMaintenanceRequestBody"
              (\ o ->
                 SqlInstancesRescheduleMaintenanceRequestBody Core.<$>
                   (o Core..:? "reschedule"))

instance Core.ToJSON SqlInstancesRescheduleMaintenanceRequestBody
         where
...
instance Core.FromJSON SqlInstancesResetReplicaSizeRequest where
        parseJSON
          = Core.withObject "SqlInstancesResetReplicaSizeRequest"
...
newSqlInstancesStartExternalSyncRequest
  = SqlInstancesStartExternalSyncRequest{migrationType =
                                         ...
                                         skipVerification = Core.Nothing, syncMode = Core.Nothing,
                                         syncParallelLevel = Core.Nothing}
instance Core.FromJSON SqlInstancesStartExternalSyncRequest where
        parseJSON
          = Core.withObject "SqlInstancesStartExternalSyncRequest"
              (\ o ->
                 SqlInstancesStartExternalSyncRequest Core.<$>
                   (o Core..:? "migrationType") Core.<*>
                     (o Core..:? "mysqlSyncConfig")
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "SqlInstancesVerifyExternalSyncSettingsRequest"
              (\ o ->
                 SqlInstancesVerifyExternalSyncSettingsRequest Core.<$>
                   (o Core..:? "migrationType") Core.<*>
                     (o Core..:? "mysqlSyncConfig")
                     Core.<*> (o Core..:? "selectedObjects")
                     Core.<*> (o Core..:? "syncMode")
...
instance Core.ToJSON SqlInstancesVerifyExternalSyncSettingsRequest
         where
...
newSqlInstancesVerifyExternalSyncSettingsResponse
  = SqlInstancesVerifyExternalSyncSettingsResponse{errors =
                                                     Core.Nothing,
                                                   kind = Core.Nothing, warnings = Core.Nothing}
instance Core.FromJSON
           SqlInstancesVerifyExternalSyncSettingsResponse
         where
        parseJSON
          = Core.withObject "SqlInstancesVerifyExternalSyncSettingsResponse"
              (\ o ->
                 SqlInstancesVerifyExternalSyncSettingsResponse Core.<$>
                   (o Core..:? "errors") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "warnings"))

instance Core.ToJSON SqlInstancesVerifyExternalSyncSettingsResponse
         where
...
instance Core.FromJSON SqlOutOfDiskReport where
        parseJSON
          = Core.withObject "SqlOutOfDiskReport"
              (\ o ->
                 SqlOutOfDiskReport Core.<$>
                   (o Core..:? "sqlMinRecommendedIncreaseSizeGb") Core.<*>
                     (o Core..:? "sqlOutOfDiskState"))

instance Core.ToJSON SqlOutOfDiskReport where
        toJSON SqlOutOfDiskReport{..}
          = Core.object
              (Core.catMaybes
                 [("sqlMinRecommendedIncreaseSizeGb" Core..=) Core.<$>
...
newSqlScheduledMaintenance 
    ::  SqlScheduledMaintenance
newSqlScheduledMaintenance
  = SqlScheduledMaintenance{canDefer = Core.Nothing,
                            canReschedule = Core.Nothing, scheduleDeadlineTime = Core.Nothing,
                            startTime = Core.Nothing}
instance Core.FromJSON SqlScheduledMaintenance where
        parseJSON
          = Core.withObject "SqlScheduledMaintenance"
              (\ o ->
                 SqlScheduledMaintenance Core.<$>
                   (o Core..:? "canDefer") Core.<*> (o Core..:? "canReschedule")
...
newSqlServerAuditConfig
  = SqlServerAuditConfig{bucket = Core.Nothing, kind = Core.Nothing,
                         retentionInterval = Core.Nothing, uploadInterval = Core.Nothing}
instance Core.FromJSON SqlServerAuditConfig where
        parseJSON
          = Core.withObject "SqlServerAuditConfig"
              (\ o ->
                 SqlServerAuditConfig Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "retentionInterval")
...
newSqlServerDatabaseDetails 
    ::  SqlServerDatabaseDetails
newSqlServerDatabaseDetails
  = SqlServerDatabaseDetails{compatibilityLevel = Core.Nothing,
                             recoveryModel = Core.Nothing}
instance Core.FromJSON SqlServerDatabaseDetails where
        parseJSON
          = Core.withObject "SqlServerDatabaseDetails"
              (\ o ->
                 SqlServerDatabaseDetails Core.<$>
                   (o Core..:? "compatibilityLevel") Core.<*>
                     (o Core..:? "recoveryModel"))
...
newSqlServerUserDetails 
    ::  SqlServerUserDetails
newSqlServerUserDetails
  = SqlServerUserDetails{disabled = Core.Nothing,
                         serverRoles = Core.Nothing}
instance Core.FromJSON SqlServerUserDetails where
        parseJSON
          = Core.withObject "SqlServerUserDetails"
              (\ o ->
                 SqlServerUserDetails Core.<$>
                   (o Core..:? "disabled") Core.<*> (o Core..:? "serverRoles"))
...
instance Core.FromJSON SqlSubOperationType where
        parseJSON
          = Core.withObject "SqlSubOperationType"
              (\ o ->
...
newSslCert 
    ::  SslCert
newSslCert
  = SslCert{cert = Core.Nothing, certSerialNumber = Core.Nothing,
            commonName = Core.Nothing, createTime = Core.Nothing,
            expirationTime = Core.Nothing, instance' = Core.Nothing,
            kind = Core.Nothing, selfLink = Core.Nothing,
            sha1Fingerprint = Core.Nothing}
instance Core.FromJSON SslCert where
        parseJSON
          = Core.withObject "SslCert"
              (\ o ->
                 SslCert Core.<$>
                   (o Core..:? "cert") Core.<*> (o Core..:? "certSerialNumber")
...
newSslCertDetail 
    ::  SslCertDetail
newSslCertDetail
  = SslCertDetail{certInfo = Core.Nothing,
                  certPrivateKey = Core.Nothing}
instance Core.FromJSON SslCertDetail where
        parseJSON
          = Core.withObject "SslCertDetail"
              (\ o ->
                 SslCertDetail Core.<$>
                   (o Core..:? "certInfo") Core.<*> (o Core..:? "certPrivateKey"))
...
newSslCertsCreateEphemeralRequest 
    ::  SslCertsCreateEphemeralRequest
newSslCertsCreateEphemeralRequest
  = SslCertsCreateEphemeralRequest{accessToken = Core.Nothing,
                                   publicKey = Core.Nothing}
instance Core.FromJSON SslCertsCreateEphemeralRequest where
        parseJSON
          = Core.withObject "SslCertsCreateEphemeralRequest"
              (\ o ->
                 SslCertsCreateEphemeralRequest Core.<$>
                   (o Core..:? "access_token") Core.<*> (o Core..:? "public_key"))
...
instance Core.FromJSON SslCertsInsertRequest where
        parseJSON
          = Core.withObject "SslCertsInsertRequest"
...
newSslCertsInsertResponse 
    ::  SslCertsInsertResponse
newSslCertsInsertResponse
  = SslCertsInsertResponse{clientCert = Core.Nothing,
                           kind = Core.Nothing, operation = Core.Nothing,
                           serverCaCert = Core.Nothing}
instance Core.FromJSON SslCertsInsertResponse where
        parseJSON
          = Core.withObject "SslCertsInsertResponse"
              (\ o ->
                 SslCertsInsertResponse Core.<$>
                   (o Core..:? "clientCert") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "operation")
                     Core.<*> (o Core..:? "serverCaCert"))
...
instance Core.FromJSON SslCertsListResponse where
        parseJSON
          = Core.withObject "SslCertsListResponse"
              (\ o ->
                 SslCertsListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind"))
...
newTier 
    ::  Tier
newTier
  = Tier{diskQuota = Core.Nothing, rAM = Core.Nothing,
         kind = Core.Nothing, region = Core.Nothing, tier = Core.Nothing}
instance Core.FromJSON Tier where
        parseJSON
          = Core.withObject "Tier"
              (\ o ->
                 Tier Core.<$>
                   (o Core..:? "DiskQuota" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("DiskQuota" Core..=) Core.. Core.AsText Core.<$> diskQuota,
                  ...
                  ("kind" Core..=) Core.<$> kind, ("region" Core..=) Core.<$> region,
                  ("tier" Core..=) Core.<$> tier])
...
instance Core.FromJSON TiersListResponse where
        parseJSON
          = Core.withObject "TiersListResponse"
              (\ o ->
                 TiersListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind"))
...
instance Core.FromJSON TruncateLogContext where
        parseJSON
          = Core.withObject "TruncateLogContext"
              (\ o ->
                 TruncateLogContext Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "logType"))
...
newUser 
    ::  User
newUser
  = User{dualPasswordType = Core.Nothing, etag = Core.Nothing,
         host = Core.Nothing, instance' = Core.Nothing, kind = Core.Nothing,
         name = Core.Nothing, password = Core.Nothing,
         passwordPolicy = Core.Nothing, project = Core.Nothing,
         sqlserverUserDetails = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User"
              (\ o ->
                 User Core.<$>
                   (o Core..:? "dualPasswordType") Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "host")
                     Core.<*> (o Core..:? "instance")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("dualPasswordType" Core..=) Core.<$> dualPasswordType,
                  ("etag" Core..=) Core.<$> etag, ("host" Core..=) Core.<$> host,
                  ("instance" Core..=) Core.<$> instance',
                  ("kind" Core..=) Core.<$> kind, ("name" Core..=) Core.<$> name,
                  ("password" Core..=) Core.<$> password,
...
newUserPasswordValidationPolicy 
    ::  UserPasswordValidationPolicy
newUserPasswordValidationPolicy
  = UserPasswordValidationPolicy{allowedFailedAttempts =
                                   Core.Nothing,
                                 enableFailedAttemptsCheck = Core.Nothing,
                                 enablePasswordVerification = Core.Nothing,
                                 passwordExpirationDuration = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON UserPasswordValidationPolicy where
        parseJSON
          = Core.withObject "UserPasswordValidationPolicy"
              (\ o ->
                 UserPasswordValidationPolicy Core.<$>
                   (o Core..:? "allowedFailedAttempts") Core.<*>
                     (o Core..:? "enableFailedAttemptsCheck")
          ...
          = Core.object
              (Core.catMaybes
                 [("allowedFailedAttempts" Core..=) Core.<$> allowedFailedAttempts,
                  ("enableFailedAttemptsCheck" Core..=) Core.<$>
                    enableFailedAttemptsCheck,
                  ("enablePasswordVerification" Core..=) Core.<$>
                    enablePasswordVerification,
                  ("passwordExpirationDuration" Core..=) Core.<$>
...
newUsersListResponse 
    ::  UsersListResponse
newUsersListResponse
  = UsersListResponse{items = Core.Nothing, kind = Core.Nothing,
                      nextPageToken = Core.Nothing}
instance Core.FromJSON UsersListResponse where
        parseJSON
          = Core.withObject "UsersListResponse"
              (\ o ->
                 UsersListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken"))
