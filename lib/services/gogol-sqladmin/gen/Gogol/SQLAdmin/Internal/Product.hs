...
newApiWarning =
  ApiWarning
    {code = Core.Nothing, message = Core.Nothing, region = Core.Nothing}
              ...
              (\ o ->
                 BackupConfiguration Core.<$>
                   (o Core..:? "backupRetentionSettings") Core.<*>
                     (o Core..:? "binaryLogEnabled")
                     Core.<*> (o Core..:? "enabled")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "pointInTimeRecoveryEnabled")
                     Core.<*>
                     (o Core..:? "replicationLogArchivingEnabled")
...
instance Core.ToJSON BackupContext where
        toJSON BackupContext{..}
          = Core.object
              (Core.catMaybes
                 [("backupId" Core..=) Core.. Core.AsText Core.<$>
                    backupId,
                  ("kind" Core..=) Core.<$> kind])
...
newBackupRetentionSettings =
  BackupRetentionSettings
    {retainedBackups = Core.Nothing, retentionUnit = Core.Nothing}
              ...
              (Core.catMaybes
                 [("backupKind" Core..=) Core.<$> backupKind,
                  ...
                  ("diskEncryptionConfiguration" Core..=) Core.<$>
                    diskEncryptionConfiguration,
                  ("diskEncryptionStatus" Core..=) Core.<$>
                    diskEncryptionStatus,
...
instance Core.ToJSON CloneContext where
        toJSON CloneContext{..}
          = Core.object
              (Core.catMaybes
                 [("allocatedIpRange" Core..=) Core.<$>
                    allocatedIpRange,
                  ("binLogCoordinates" Core..=) Core.<$>
                    binLogCoordinates,
          ...
          = Core.object
              (Core.catMaybes
                 [("availableMaintenanceVersions" Core..=) Core.<$>
                  ...
                  ("kind" Core..=) Core.<$> kind,
                  ("maintenanceVersion" Core..=) Core.<$>
                    maintenanceVersion,
                  ("masterInstanceName" Core..=) Core.<$>
                    masterInstanceName,
                  ("maxDiskSize" Core..=) Core.. Core.AsText Core.<$>
                    maxDiskSize,
                  ("name" Core..=) Core.<$> name,
...
newDatabaseInstance_FailoverReplica =
  DatabaseInstance_FailoverReplica
    {available = Core.Nothing, name = Core.Nothing}
          ...
          = Core.withObject "DatabaseInstance_FailoverReplica"
              (\ o ->
                 DatabaseInstance_FailoverReplica Core.<$>
                   (o Core..:? "available") Core.<*>
                     (o Core..:? "name"))

instance Core.ToJSON DatabaseInstance_FailoverReplica
         where
...
newDemoteMasterConfiguration =
  DemoteMasterConfiguration
    {kind = Core.Nothing, mysqlReplicaConfiguration = Core.Nothing}

instance Core.FromJSON DemoteMasterConfiguration
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ...
                  ("replicaConfiguration" Core..=) Core.<$>
                    replicaConfiguration,
                  ("skipReplicationSetup" Core..=) Core.<$>
                    skipReplicationSetup,
                  ("verifyGtidConsistency" Core..=) Core.<$>
...
newDenyMaintenancePeriod =
  DenyMaintenancePeriod
    {endDate = Core.Nothing, startDate = Core.Nothing, time = Core.Nothing}
...
instance Core.FromJSON DiskEncryptionConfiguration
         where
        parseJSON
...
instance Core.ToJSON DiskEncryptionConfiguration
         where
...
data ExportContext_BakExportOptions = ExportContext_BakExportOptions
    {
      ...
      -- | Whether or not the export will be exeucted with COPY/ONLY, SQL Server only deprecated as the behavior should default to copy/only = true use differential_base instead
...
instance Core.FromJSON ExportContext_BakExportOptions
         where
        parseJSON
...
instance Core.ToJSON ExportContext_BakExportOptions
         where
...
instance Core.FromJSON ExportContext_CsvExportOptions
         where
        parseJSON
...
instance Core.ToJSON ExportContext_CsvExportOptions
         where
        toJSON ExportContext_CsvExportOptions{..}
          = Core.object
              (Core.catMaybes
                 [("escapeCharacter" Core..=) Core.<$>
                    escapeCharacter,
                  ("fieldsTerminatedBy" Core..=) Core.<$>
                    fieldsTerminatedBy,
                  ("linesTerminatedBy" Core..=) Core.<$>
                    linesTerminatedBy,
...
instance Core.FromJSON ExportContext_SqlExportOptions
         where
        parseJSON
          = Core.withObject "ExportContext_SqlExportOptions"
              (\ o ->
                 ExportContext_SqlExportOptions Core.<$>
                   (o Core..:? "mysqlExportOptions") Core.<*>
                     (o Core..:? "schemaOnly")
                     Core.<*> (o Core..:? "tables"))

instance Core.ToJSON ExportContext_SqlExportOptions
         where
        toJSON ExportContext_SqlExportOptions{..}
          = Core.object
              (Core.catMaybes
                 [("mysqlExportOptions" Core..=) Core.<$>
                    mysqlExportOptions,
...
instance Core.ToJSON Flag where
        toJSON Flag{..}
          = Core.object
              (Core.catMaybes
                 [("allowedIntValues" Core..=) Core..
                    Core.fmap Core.AsText
                    Core.<$> allowedIntValues,
                  ("allowedStringValues" Core..=) Core.<$>
                    allowedStringValues,
                  ("appliesTo" Core..=) Core.<$> appliesTo,
                  ("inBeta" Core..=) Core.<$> inBeta,
                  ("kind" Core..=) Core.<$> kind,
                  ("maxValue" Core..=) Core.. Core.AsText Core.<$>
                    maxValue,
                  ("minValue" Core..=) Core.. Core.AsText Core.<$>
                    minValue,
                  ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON GenerateEphemeralCertRequest
         where
        parseJSON
          = Core.withObject "GenerateEphemeralCertRequest"
              (\ o ->
                 GenerateEphemeralCertRequest Core.<$>
                   (o Core..:? "access_token") Core.<*>
                     (o Core..:? "public_key")
                     Core.<*> (o Core..:? "readTime")
                     Core.<*> (o Core..:? "validDuration"))

instance Core.ToJSON GenerateEphemeralCertRequest
         where
...
instance Core.FromJSON GenerateEphemeralCertResponse
         where
        parseJSON
...
instance Core.ToJSON GenerateEphemeralCertResponse
         where
...
instance Core.ToJSON ImportContext where
        toJSON ImportContext{..}
          = Core.object
              (Core.catMaybes
                 [("bakImportOptions" Core..=) Core.<$>
                    bakImportOptions,
                  ("csvImportOptions" Core..=) Core.<$>
                    csvImportOptions,
...
instance Core.FromJSON ImportContext_BakImportOptions
         where
        parseJSON
          = Core.withObject "ImportContext_BakImportOptions"
              (\ o ->
                 ImportContext_BakImportOptions Core.<$>
                   (o Core..:? "bakType") Core.<*>
                     (o Core..:? "encryptionOptions")
                     Core.<*> (o Core..:? "noRecovery")
                     Core.<*> (o Core..:? "recoveryOnly")
                     Core.<*> (o Core..:? "striped"))

instance Core.ToJSON ImportContext_BakImportOptions
         where
        toJSON ImportContext_BakImportOptions{..}
          = Core.object
              (Core.catMaybes
                 [("bakType" Core..=) Core.<$> bakType,
                  ("encryptionOptions" Core..=) Core.<$>
                    encryptionOptions,
...
instance Core.FromJSON ImportContext_CsvImportOptions
         where
        parseJSON
          = Core.withObject "ImportContext_CsvImportOptions"
              (\ o ->
                 ImportContext_CsvImportOptions Core.<$>
                   (o Core..:? "columns") Core.<*>
                     (o Core..:? "escapeCharacter")
                     Core.<*> (o Core..:? "fieldsTerminatedBy")
                     Core.<*> (o Core..:? "linesTerminatedBy")
                     Core.<*> (o Core..:? "quoteCharacter")
                     Core.<*> (o Core..:? "table"))

instance Core.ToJSON ImportContext_CsvImportOptions
         where
...
instance Core.ToJSON InsightsConfig where
        toJSON InsightsConfig{..}
          = Core.object
              (Core.catMaybes
                 [("queryInsightsEnabled" Core..=) Core.<$>
                    queryInsightsEnabled,
                  ("queryPlansPerMinute" Core..=) Core.<$>
                    queryPlansPerMinute,
                  ("queryStringLength" Core..=) Core.<$>
                    queryStringLength,
                  ("recordApplicationTags" Core..=) Core.<$>
                    recordApplicationTags,
                  ("recordClientAddress" Core..=) Core.<$>
                    recordClientAddress])
...
newInstanceReference =
  InstanceReference
    {name = Core.Nothing, project = Core.Nothing, region = Core.Nothing}
          ...
          = Core.withObject "InstanceReference"
              (\ o ->
                 InstanceReference Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "project")
                     Core.<*> (o Core..:? "region"))
...
instance Core.FromJSON InstancesDemoteMasterRequest
         where
        parseJSON
...
instance Core.ToJSON InstancesDemoteMasterRequest
         where
        toJSON InstancesDemoteMasterRequest{..}
          = Core.object
              (Core.catMaybes
                 [("demoteMasterContext" Core..=) Core.<$>
                    demoteMasterContext])
...
instance Core.FromJSON InstancesExportRequest where
        parseJSON
          = Core.withObject "InstancesExportRequest"
              (\ o ->
                 InstancesExportRequest Core.<$>
                   (o Core..:? "exportContext"))
...
instance Core.FromJSON InstancesImportRequest where
        parseJSON
          = Core.withObject "InstancesImportRequest"
              (\ o ->
                 InstancesImportRequest Core.<$>
                   (o Core..:? "importContext"))
...
newInstancesListServerCasResponse =
  InstancesListServerCasResponse
    {activeVersion = Core.Nothing, certs = Core.Nothing, kind = Core.Nothing}

instance Core.FromJSON InstancesListServerCasResponse
         where
        parseJSON
          = Core.withObject "InstancesListServerCasResponse"
              (\ o ->
                 InstancesListServerCasResponse Core.<$>
                   (o Core..:? "activeVersion") Core.<*>
                     (o Core..:? "certs")
                     Core.<*> (o Core..:? "kind"))

instance Core.ToJSON InstancesListServerCasResponse
         where
...
instance Core.FromJSON InstancesRestoreBackupRequest
         where
        parseJSON
          = Core.withObject "InstancesRestoreBackupRequest"
              (\ o ->
                 InstancesRestoreBackupRequest Core.<$>
                   (o Core..:? "restoreBackupContext"))

instance Core.ToJSON InstancesRestoreBackupRequest
         where
        toJSON InstancesRestoreBackupRequest{..}
          = Core.object
              (Core.catMaybes
                 [("restoreBackupContext" Core..=) Core.<$>
                    restoreBackupContext])
...
instance Core.FromJSON InstancesRotateServerCaRequest
         where
        parseJSON
...
instance Core.ToJSON InstancesRotateServerCaRequest
         where
        toJSON InstancesRotateServerCaRequest{..}
          = Core.object
              (Core.catMaybes
                 [("rotateServerCaContext" Core..=) Core.<$>
                    rotateServerCaContext])
...
instance Core.FromJSON InstancesTruncateLogRequest
         where
        parseJSON
...
instance Core.ToJSON InstancesTruncateLogRequest
         where
        toJSON InstancesTruncateLogRequest{..}
          = Core.object
              (Core.catMaybes
                 [("truncateLogContext" Core..=) Core.<$>
                    truncateLogContext])
          ...
          = Core.withObject "LocationPreference"
              (\ o ->
                 LocationPreference Core.<$>
                   (o Core..:? "followGaeApplication") Core.<*>
                     (o Core..:? "kind")
...
instance Core.ToJSON LocationPreference where
        toJSON LocationPreference{..}
          = Core.object
              (Core.catMaybes
                 [("followGaeApplication" Core..=) Core.<$>
...
instance Core.FromJSON MySqlReplicaConfiguration
         where
        parseJSON
              ...
              (Core.catMaybes
                 [("caCertificate" Core..=) Core.<$> caCertificate,
                  ("clientCertificate" Core..=) Core.<$>
                    clientCertificate,
                  ("clientKey" Core..=) Core.<$> clientKey,
                  ("connectRetryInterval" Core..=) Core.<$>
              ...
              (\ o ->
                 PasswordValidationPolicy Core.<$>
                   (o Core..:? "complexity") Core.<*>
                     (o Core..:? "disallowUsernameSubstring")
          ...
          = Core.object
              (Core.catMaybes
                 [("complexity" Core..=) Core.<$> complexity,
                  ...
                  ("enablePasswordPolicy" Core..=) Core.<$>
                    enablePasswordPolicy,
                  ("minLength" Core..=) Core.<$> minLength,
                  ("passwordChangeInterval" Core..=) Core.<$>
...
instance Core.ToJSON RestoreBackupContext where
        toJSON RestoreBackupContext{..}
          = Core.object
              (Core.catMaybes
                 [("backupRunId" Core..=) Core.. Core.AsText Core.<$>
                    backupRunId,
...
instance Core.ToJSON Settings where
        toJSON Settings{..}
          = Core.object
              (Core.catMaybes
                 [("activationPolicy" Core..=) Core.<$>
                    activationPolicy,
                  ("activeDirectoryConfig" Core..=) Core.<$>
                    activeDirectoryConfig,
                  ("advancedMachineFeatures" Core..=) Core.<$>
                    advancedMachineFeatures,
                  ("authorizedGaeApplications" Core..=) Core.<$>
                    authorizedGaeApplications,
                  ("availabilityType" Core..=) Core.<$>
                    availabilityType,
                  ("backupConfiguration" Core..=) Core.<$>
                    backupConfiguration,
                  ("collation" Core..=) Core.<$> collation,
                  ("connectorEnforcement" Core..=) Core.<$>
                  ...
                  ("denyMaintenancePeriods" Core..=) Core.<$>
                    denyMaintenancePeriods,
                  ("insightsConfig" Core..=) Core.<$> insightsConfig,
                  ("ipConfiguration" Core..=) Core.<$> ipConfiguration,
                  ("kind" Core..=) Core.<$> kind,
                  ("locationPreference" Core..=) Core.<$>
                    locationPreference,
                  ("maintenanceWindow" Core..=) Core.<$>
                    maintenanceWindow,
                  ...
                  ("settingsVersion" Core..=) Core.. Core.AsText
                    Core.<$> settingsVersion,
                  ("sqlServerAuditConfig" Core..=) Core.<$>
                    sqlServerAuditConfig,
                  ("storageAutoResize" Core..=) Core.<$>
                    storageAutoResize,
...
newSqlExternalSyncSettingError =
  SqlExternalSyncSettingError
    {detail = Core.Nothing, kind = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON SqlExternalSyncSettingError
         where
        parseJSON
          = Core.withObject "SqlExternalSyncSettingError"
              (\ o ->
                 SqlExternalSyncSettingError Core.<$>
                   (o Core..:? "detail") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "type"))

instance Core.ToJSON SqlExternalSyncSettingError
         where
          ...
          = Core.withObject
              ...
              (\ o ->
                 SqlInstancesGetDiskShrinkConfigResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "message")
                     Core.<*>
          ...
          = Core.withObject
              ...
              (\ o ->
                 SqlInstancesStartExternalSyncRequest Core.<$>
                   (o Core..:? "mysqlSyncConfig") Core.<*>
                     (o Core..:? "skipVerification")
...
instance Core.ToJSON
        ...
        toJSON SqlInstancesStartExternalSyncRequest{..}
          = Core.object
              (Core.catMaybes
                 [("mysqlSyncConfig" Core..=) Core.<$>
                    mysqlSyncConfig,
                  ("skipVerification" Core..=) Core.<$>
                    skipVerification,
          ...
          = Core.object
              (Core.catMaybes
                 [("mysqlSyncConfig" Core..=) Core.<$>
                    mysqlSyncConfig,
                  ("syncMode" Core..=) Core.<$> syncMode,
                  ("verifyConnectionOnly" Core..=) Core.<$>
                    verifyConnectionOnly,
                  ("verifyReplicationOnly" Core..=) Core.<$>
...
newSqlInstancesVerifyExternalSyncSettingsResponse =
  SqlInstancesVerifyExternalSyncSettingsResponse
    {errors = Core.Nothing, kind = Core.Nothing, warnings = Core.Nothing}
          ...
          = Core.withObject "SqlOutOfDiskReport"
              (\ o ->
                 SqlOutOfDiskReport Core.<$>
                   (o Core..:? "sqlMinRecommendedIncreaseSizeGb")
          ...
          = Core.object
              (Core.catMaybes
                 [("canDefer" Core..=) Core.<$> canDefer,
                  ...
                  ("scheduleDeadlineTime" Core..=) Core.<$>
          ...
          = Core.withObject "SqlServerAuditConfig"
              (\ o ->
                 SqlServerAuditConfig Core.<$>
                   (o Core..:? "bucket") Core.<*> (o Core..:? "kind")
...
newSqlServerDatabaseDetails =
  SqlServerDatabaseDetails
    {compatibilityLevel = Core.Nothing, recoveryModel = Core.Nothing}
...
instance Core.FromJSON SslCertDetail where
        parseJSON
          = Core.withObject "SslCertDetail"
              (\ o ->
                 SslCertDetail Core.<$>
                   (o Core..:? "certInfo") Core.<*>
                     (o Core..:? "certPrivateKey"))
...
newSslCertsCreateEphemeralRequest =
  SslCertsCreateEphemeralRequest
    {accessToken = Core.Nothing, publicKey = Core.Nothing}

instance Core.FromJSON SslCertsCreateEphemeralRequest
         where
        parseJSON
...
instance Core.ToJSON SslCertsCreateEphemeralRequest
         where
...
instance Core.FromJSON Tier where
        parseJSON
          = Core.withObject "Tier"
              (\ o ->
                 Tier Core.<$>
                   (o Core..:? "DiskQuota" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "RAM" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "region")
                     Core.<*> (o Core..:? "tier"))
...
instance Core.ToJSON Tier where
        toJSON Tier{..}
          = Core.object
              (Core.catMaybes
                 [("DiskQuota" Core..=) Core.. Core.AsText Core.<$>
                    diskQuota,
          ...
          = Core.object
              (Core.catMaybes
                 [("dualPasswordType" Core..=) Core.<$>
                  ...
                  ("project" Core..=) Core.<$> project,
                  ("sqlserverUserDetails" Core..=) Core.<$>
                    sqlserverUserDetails,
                  ("type" Core..=) Core.<$> type'])
...
instance Core.FromJSON UserPasswordValidationPolicy
         where
        parseJSON
...
instance Core.ToJSON UserPasswordValidationPolicy
         where
        toJSON UserPasswordValidationPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("allowedFailedAttempts" Core..=) Core.<$>
