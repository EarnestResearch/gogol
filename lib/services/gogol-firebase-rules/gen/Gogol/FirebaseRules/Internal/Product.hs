...
instance Core.FromJSON ExpressionReport where
        parseJSON
          = Core.withObject "ExpressionReport"
              (\ o ->
                 ExpressionReport Core.<$>
                   (o Core..:? "children") Core.<*>
                     (o Core..:? "sourcePosition")
                     Core.<*> (o Core..:? "values"))
...
instance Core.FromJSON FunctionCall where
        parseJSON
          = Core.withObject "FunctionCall"
              (\ o ->
                 FunctionCall Core.<$>
                   (o Core..:? "args") Core.<*> (o Core..:? "function"))
...
newFunctionMock =
  FunctionMock
    {args = Core.Nothing, function = Core.Nothing, result = Core.Nothing}

instance Core.FromJSON FunctionMock where
        parseJSON
          = Core.withObject "FunctionMock"
              (\ o ->
                 FunctionMock Core.<$>
                   (o Core..:? "args") Core.<*> (o Core..:? "function")
                     Core.<*> (o Core..:? "result"))
...
instance Core.FromJSON GetReleaseExecutableResponse
         where
        parseJSON
          = Core.withObject "GetReleaseExecutableResponse"
              (\ o ->
                 GetReleaseExecutableResponse Core.<$>
                   (o Core..:? "executable") Core.<*>
                     (o Core..:? "executableVersion")
                     Core.<*> (o Core..:? "language")
                     Core.<*> (o Core..:? "rulesetName")
                     Core.<*> (o Core..:? "syncTime")
                     Core.<*> (o Core..:? "updateTime"))

instance Core.ToJSON GetReleaseExecutableResponse
         where
        toJSON GetReleaseExecutableResponse{..}
          = Core.object
              (Core.catMaybes
                 [("executable" Core..=) Core.<$> executable,
                  ("executableVersion" Core..=) Core.<$>
                    executableVersion,
...
instance Core.FromJSON ListReleasesResponse where
        parseJSON
          = Core.withObject "ListReleasesResponse"
              (\ o ->
                 ListReleasesResponse Core.<$>
...
instance Core.FromJSON ListRulesetsResponse where
        parseJSON
          = Core.withObject "ListRulesetsResponse"
              (\ o ->
                 ListRulesetsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "rulesets"))
...
instance Core.FromJSON SourcePosition where
        parseJSON
          = Core.withObject "SourcePosition"
              (\ o ->
                 SourcePosition Core.<$>
                   (o Core..:? "column") Core.<*>
                     (o Core..:? "currentOffset")
...
instance Core.FromJSON TestCase where
        parseJSON
          = Core.withObject "TestCase"
              (\ o ->
                 TestCase Core.<$>
                   (o Core..:? "expectation") Core.<*>
                     (o Core..:? "expressionReportLevel")
          ...
          = Core.object
              (Core.catMaybes
                 [("expectation" Core..=) Core.<$> expectation,
                  ("expressionReportLevel" Core..=) Core.<$>
...
instance Core.FromJSON TestResult where
        parseJSON
          = Core.withObject "TestResult"
              (\ o ->
                 TestResult Core.<$>
                   (o Core..:? "debugMessages") Core.<*>
                     (o Core..:? "errorPosition")
          ...
          = Core.object
              (Core.catMaybes
                 [("debugMessages" Core..=) Core.<$> debugMessages,
                  ...
                  ("expressionReports" Core..=) Core.<$>
                    expressionReports,
                  ("functionCalls" Core..=) Core.<$> functionCalls,
                  ("state" Core..=) Core.<$> state,
                  ("visitedExpressions" Core..=) Core.<$>
                    visitedExpressions])
...
instance Core.FromJSON TestRulesetRequest where
        parseJSON
          = Core.withObject "TestRulesetRequest"
              (\ o ->
                 TestRulesetRequest Core.<$>
                   (o Core..:? "source") Core.<*>
                     (o Core..:? "testSuite"))
...
instance Core.FromJSON TestRulesetResponse where
        parseJSON
          = Core.withObject "TestRulesetResponse"
              (\ o ->
                 TestRulesetResponse Core.<$>
                   (o Core..:? "issues") Core.<*>
                     (o Core..:? "testResults"))
...
instance Core.FromJSON UpdateReleaseRequest where
        parseJSON
          = Core.withObject "UpdateReleaseRequest"
              (\ o ->
                 UpdateReleaseRequest Core.<$>
                   (o Core..:? "release") Core.<*>
                     (o Core..:? "updateMask"))
...
instance Core.FromJSON ValueCount where
        parseJSON
          = Core.withObject "ValueCount"
              (\ o ->
                 ValueCount Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON VisitedExpression where
        parseJSON
          = Core.withObject "VisitedExpression"
              (\ o ->
                 VisitedExpression Core.<$>
                   (o Core..:? "sourcePosition") Core.<*>
                     (o Core..:? "value"))
