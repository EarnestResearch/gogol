...
type FirebaseRulesProjectsReleasesGetExecutableResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "getExecutable" Core.Text
         Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "executableVersion"
                 ProjectsReleasesGetExecutableExecutableVersion
                 Core.:>
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GetReleaseExecutableResponse
...
instance Core.GoogleRequest
           FirebaseRulesProjectsReleasesGetExecutable
         where
        type Rs FirebaseRulesProjectsReleasesGetExecutable =
