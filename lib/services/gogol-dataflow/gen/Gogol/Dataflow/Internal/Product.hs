...
module Gogol.Dataflow.Internal.Product
  (
    ...
    GetWorkerStacktracesRequest (..),
    newGetWorkerStacktracesRequest,

    -- * GetWorkerStacktracesResponse
    GetWorkerStacktracesResponse (..),
    newGetWorkerStacktracesResponse,
...
newApproximateProgress 
    ::  ApproximateProgress
newApproximateProgress
  = ApproximateProgress{percentComplete = Core.Nothing,
                        position = Core.Nothing, remainingTime = Core.Nothing}
instance Core.FromJSON ApproximateProgress where
        parseJSON
          = Core.withObject "ApproximateProgress"
              (\ o ->
                 ApproximateProgress Core.<$>
                   (o Core..:? "percentComplete") Core.<*> (o Core..:? "position")
...
newApproximateReportedProgress 
    ::  ApproximateReportedProgress
newApproximateReportedProgress
  = ApproximateReportedProgress{consumedParallelism = Core.Nothing,
                                fractionConsumed = Core.Nothing, position = Core.Nothing,
...
newApproximateSplitRequest 
    ::  ApproximateSplitRequest
newApproximateSplitRequest
  = ApproximateSplitRequest{fractionConsumed = Core.Nothing,
                            fractionOfRemainder = Core.Nothing, position = Core.Nothing}
...
newAutoscalingEvent 
    ::  AutoscalingEvent
newAutoscalingEvent
  = AutoscalingEvent{currentNumWorkers = Core.Nothing,
                     description = Core.Nothing, eventType = Core.Nothing,
                     targetNumWorkers = Core.Nothing, time = Core.Nothing,
          ...
          = Core.withObject "AutoscalingEvent"
              (\ o ->
                 AutoscalingEvent Core.<$>
                   (o Core..:? "currentNumWorkers" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "eventType")
                     Core.<*>
                     (o Core..:? "targetNumWorkers" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "time")
...
instance Core.ToJSON AutoscalingEvent where
        toJSON AutoscalingEvent{..}
          = Core.object
              (Core.catMaybes
                 [("currentNumWorkers" Core..=) Core.. Core.AsText Core.<$>
                    currentNumWorkers,
                  ("description" Core..=) Core.<$> description,
                  ("eventType" Core..=) Core.<$> eventType,
                  ("targetNumWorkers" Core..=) Core.. Core.AsText Core.<$>
                    targetNumWorkers,
                  ("time" Core..=) Core.<$> time,
...
newAutoscalingSettings 
    ::  AutoscalingSettings
newAutoscalingSettings
  = AutoscalingSettings{algorithm = Core.Nothing,
          ...
          = Core.withObject "AutoscalingSettings"
              (\ o ->
                 AutoscalingSettings Core.<$>
                   (o Core..:? "algorithm") Core.<*> (o Core..:? "maxNumWorkers"))
...
newBase2Exponent 
    ::  Base2Exponent
newBase2Exponent
  = Base2Exponent{numberOfBuckets = Core.Nothing,
                  scale = Core.Nothing}
instance Core.FromJSON Base2Exponent where
        parseJSON
          = Core.withObject "Base2Exponent"
              (\ o ->
                 Base2Exponent Core.<$>
                   (o Core..:? "numberOfBuckets") Core.<*> (o Core..:? "scale"))
...
newBigQueryIODetails 
    ::  BigQueryIODetails
newBigQueryIODetails
  = BigQueryIODetails{dataset = Core.Nothing,
                      projectId = Core.Nothing, query = Core.Nothing,
                      table = Core.Nothing}
          ...
          = Core.withObject "BigQueryIODetails"
              (\ o ->
                 BigQueryIODetails Core.<$>
                   (o Core..:? "dataset") Core.<*> (o Core..:? "projectId") Core.<*>
                     (o Core..:? "query")
                     Core.<*> (o Core..:? "table"))
...
newBigTableIODetails 
    ::  BigTableIODetails
newBigTableIODetails
  = BigTableIODetails{instanceId = Core.Nothing,
          ...
          = Core.withObject "BigTableIODetails"
              (\ o ->
                 BigTableIODetails Core.<$>
                   (o Core..:? "instanceId") Core.<*> (o Core..:? "projectId")
                     Core.<*> (o Core..:? "tableId"))
...
newBoundedTrie 
    ::  BoundedTrie
newBoundedTrie
  = BoundedTrie{bound = Core.Nothing, root = Core.Nothing,
                singleton = Core.Nothing}
instance Core.FromJSON BoundedTrie where
        parseJSON
          = Core.withObject "BoundedTrie"
              (\ o ->
                 BoundedTrie Core.<$>
                   (o Core..:? "bound") Core.<*> (o Core..:? "root") Core.<*>
                     (o Core..:? "singleton"))
...
instance Core.ToJSON BoundedTrie where
        toJSON BoundedTrie{..}
          = Core.object
              (Core.catMaybes
                 [("bound" Core..=) Core.<$> bound, ("root" Core..=) Core.<$> root,
...
newBoundedTrieNode 
    ::  BoundedTrieNode
newBoundedTrieNode
  = BoundedTrieNode{children = Core.Nothing,
                    truncated = Core.Nothing}
instance Core.FromJSON BoundedTrieNode where
        parseJSON
          = Core.withObject "BoundedTrieNode"
              (\ o ->
                 BoundedTrieNode Core.<$>
                   (o Core..:? "children") Core.<*> (o Core..:? "truncated"))
...
instance Core.FromJSON BoundedTrieNode_Children where
        parseJSON
          = Core.withObject "BoundedTrieNode_Children"
...
instance Core.FromJSON BucketOptions where
        parseJSON
          = Core.withObject "BucketOptions"
              (\ o ->
                 BucketOptions Core.<$>
                   (o Core..:? "exponential") Core.<*> (o Core..:? "linear"))
...
newCPUTime 
    ::  CPUTime
newCPUTime
  = CPUTime{rate = Core.Nothing, timestamp = Core.Nothing,
...
instance Core.FromJSON CPUTime where
        parseJSON
          = Core.withObject "CPUTime"
              (\ o ->
                 CPUTime Core.<$>
                   (o Core..:? "rate") Core.<*> (o Core..:? "timestamp") Core.<*>
                     (o Core..:? "totalMs" Core.<&> Core.fmap Core.fromAsText))
...
newComponentSource 
    ::  ComponentSource
newComponentSource
  = ComponentSource{name = Core.Nothing,
...
newComponentTransform 
    ::  ComponentTransform
newComponentTransform
  = ComponentTransform{name = Core.Nothing,
                       originalTransform = Core.Nothing, userName = Core.Nothing}
instance Core.FromJSON ComponentTransform where
        parseJSON
          = Core.withObject "ComponentTransform"
              (\ o ->
                 ComponentTransform Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "originalTransform")
                     Core.<*> (o Core..:? "userName"))
...
newComputationTopology 
    ::  ComputationTopology
newComputationTopology
  = ComputationTopology{computationId = Core.Nothing,
                        inputs = Core.Nothing, keyRanges = Core.Nothing,
                        outputs = Core.Nothing, stateFamilies = Core.Nothing,
          ...
          = Core.withObject "ComputationTopology"
              (\ o ->
                 ComputationTopology Core.<$>
                   (o Core..:? "computationId") Core.<*> (o Core..:? "inputs")
...
instance Core.FromJSON ConcatPosition where
        parseJSON
          = Core.withObject "ConcatPosition"
              (\ o ->
                 ConcatPosition Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "position"))
...
newContainerSpec 
    ::  ContainerSpec
newContainerSpec
  = ContainerSpec{defaultEnvironment = Core.Nothing,
                  image = Core.Nothing, imageRepositoryCertPath = Core.Nothing,
                  imageRepositoryPasswordSecretId = Core.Nothing,
                  imageRepositoryUsernameSecretId = Core.Nothing,
                  metadata = Core.Nothing, sdkInfo = Core.Nothing}
instance Core.FromJSON ContainerSpec where
        parseJSON
          = Core.withObject "ContainerSpec"
              (\ o ->
                 ContainerSpec Core.<$>
                   (o Core..:? "defaultEnvironment") Core.<*> (o Core..:? "image")
          ...
          = Core.object
              (Core.catMaybes
                 [("defaultEnvironment" Core..=) Core.<$> defaultEnvironment,
                  ...
                  ("imageRepositoryCertPath" Core..=) Core.<$>
                    imageRepositoryCertPath,
                  ("imageRepositoryPasswordSecretId" Core..=) Core.<$>
                    imageRepositoryPasswordSecretId,
                  ("imageRepositoryUsernameSecretId" Core..=) Core.<$>
...
newCounterMetadata 
    ::  CounterMetadata
newCounterMetadata
  = CounterMetadata{description = Core.Nothing, kind = Core.Nothing,
                    otherUnits = Core.Nothing, standardUnits = Core.Nothing}
instance Core.FromJSON CounterMetadata where
        parseJSON
          = Core.withObject "CounterMetadata"
              (\ o ->
                 CounterMetadata Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "otherUnits")
...
newCounterStructuredName 
    ::  CounterStructuredName
newCounterStructuredName
  = CounterStructuredName{componentStepName = Core.Nothing,
                          executionStepName = Core.Nothing, inputIndex = Core.Nothing,
                          name = Core.Nothing, origin = Core.Nothing,
                          originNamespace = Core.Nothing,
                          originalRequestingStepName = Core.Nothing,
                          originalStepName = Core.Nothing, portion = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("componentStepName" Core..=) Core.<$> componentStepName,
                  ...
                  ("name" Core..=) Core.<$> name, ("origin" Core..=) Core.<$> origin,
...
newCounterStructuredNameAndMetadata 
    :: 
                                    CounterStructuredNameAndMetadata
newCounterStructuredNameAndMetadata
  = CounterStructuredNameAndMetadata{metadata = Core.Nothing,
                                     name = Core.Nothing}
...
newCounterUpdate 
    ::  CounterUpdate
newCounterUpdate
  = CounterUpdate{boolean = Core.Nothing, boundedTrie = Core.Nothing,
                  cumulative = Core.Nothing, distribution = Core.Nothing,
                  floatingPoint = Core.Nothing, floatingPointList = Core.Nothing,
                  floatingPointMean = Core.Nothing, integer = Core.Nothing,
                  integerGauge = Core.Nothing, integerList = Core.Nothing,
                  integerMean = Core.Nothing, internal = Core.Nothing,
                  nameAndKind = Core.Nothing, shortId = Core.Nothing,
...
instance Core.FromJSON CounterUpdate where
        parseJSON
          = Core.withObject "CounterUpdate"
              (\ o ->
                 CounterUpdate Core.<$>
                   (o Core..:? "boolean") Core.<*> (o Core..:? "boundedTrie") Core.<*>
                     (o Core..:? "cumulative")
...
newCreateJobFromTemplateRequest 
    ::  CreateJobFromTemplateRequest
newCreateJobFromTemplateRequest
  = CreateJobFromTemplateRequest{environment = Core.Nothing,
                                 gcsPath = Core.Nothing, jobName = Core.Nothing,
                                 location = Core.Nothing, parameters = Core.Nothing}
          ...
          = Core.withObject "CreateJobFromTemplateRequest"
              (\ o ->
                 CreateJobFromTemplateRequest Core.<$>
                   (o Core..:? "environment") Core.<*> (o Core..:? "gcsPath") Core.<*>
                     (o Core..:? "jobName")
...
instance Core.FromJSON CreateJobFromTemplateRequest_Parameters
         where
        parseJSON
          = Core.withObject "CreateJobFromTemplateRequest_Parameters"
              (\ o ->
...
newDataDiskAssignment 
    ::  DataDiskAssignment
newDataDiskAssignment
  = DataDiskAssignment{dataDisks = Core.Nothing,
          ...
          = Core.withObject "DataDiskAssignment"
              (\ o ->
                 DataDiskAssignment Core.<$>
                   (o Core..:? "dataDisks") Core.<*> (o Core..:? "vmInstance"))
...
instance Core.FromJSON DataSamplingConfig where
        parseJSON
          = Core.withObject "DataSamplingConfig"
...
newDataSamplingReport 
    ::  DataSamplingReport
newDataSamplingReport
  = DataSamplingReport{bytesWrittenDelta = Core.Nothing,
...
instance Core.FromJSON DataSamplingReport where
        parseJSON
          = Core.withObject "DataSamplingReport"
              (\ o ->
                 DataSamplingReport Core.<$>
                   (o Core..:? "bytesWrittenDelta" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "elementsSampledBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "elementsSampledCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "exceptionsSampledCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "pcollectionsSampledCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "persistenceErrorsCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "translationErrorsCount" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON DataSamplingReport where
        toJSON DataSamplingReport{..}
          = Core.object
              (Core.catMaybes
                 [("bytesWrittenDelta" Core..=) Core.. Core.AsText Core.<$>
                    bytesWrittenDelta,
                  ("elementsSampledBytes" Core..=) Core.. Core.AsText Core.<$>
                    elementsSampledBytes,
                  ("elementsSampledCount" Core..=) Core.. Core.AsText Core.<$>
                    elementsSampledCount,
                  ("exceptionsSampledCount" Core..=) Core.. Core.AsText Core.<$>
                    exceptionsSampledCount,
                  ("pcollectionsSampledCount" Core..=) Core.. Core.AsText Core.<$>
                    pcollectionsSampledCount,
                  ("persistenceErrorsCount" Core..=) Core.. Core.AsText Core.<$>
                    persistenceErrorsCount,
                  ("translationErrorsCount" Core..=) Core.. Core.AsText Core.<$>
...
newDataflowGaugeValue 
    ::  DataflowGaugeValue
newDataflowGaugeValue
  = DataflowGaugeValue{measuredTime = Core.Nothing,
                       value = Core.Nothing}
instance Core.FromJSON DataflowGaugeValue where
        parseJSON
          = Core.withObject "DataflowGaugeValue"
              (\ o ->
                 DataflowGaugeValue Core.<$>
                   (o Core..:? "measuredTime") Core.<*>
                     (o Core..:? "value" Core.<&> Core.fmap Core.fromAsText))
...
newDataflowHistogramValue 
    ::  DataflowHistogramValue
newDataflowHistogramValue
  = DataflowHistogramValue{bucketCounts = Core.Nothing,
                           bucketOptions = Core.Nothing, count = Core.Nothing,
                           outlierStats = Core.Nothing}
instance Core.FromJSON DataflowHistogramValue where
        parseJSON
          = Core.withObject "DataflowHistogramValue"
              (\ o ->
                 DataflowHistogramValue Core.<$>
                   (o Core..:? "bucketCounts" Core.<&>
...
instance Core.ToJSON DataflowHistogramValue where
        toJSON DataflowHistogramValue{..}
          = Core.object
              (Core.catMaybes
                 [("bucketCounts" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    bucketCounts,
...
newDatastoreIODetails 
    ::  DatastoreIODetails
newDatastoreIODetails
  = DatastoreIODetails{namespace = Core.Nothing,
          ...
          = Core.withObject "DatastoreIODetails"
              (\ o ->
                 DatastoreIODetails Core.<$>
                   (o Core..:? "namespace") Core.<*> (o Core..:? "projectId"))
...
newDebugOptions 
    ::  DebugOptions
newDebugOptions
  = DebugOptions{dataSampling = Core.Nothing,
...
newDerivedSource 
    ::  DerivedSource
newDerivedSource
  = DerivedSource{derivationMode = Core.Nothing,
                  source = Core.Nothing}
instance Core.FromJSON DerivedSource where
        parseJSON
          = Core.withObject "DerivedSource"
              (\ o ->
                 DerivedSource Core.<$>
                   (o Core..:? "derivationMode") Core.<*> (o Core..:? "source"))
...
newDisk 
    ::  Disk
newDisk
  = Disk{diskType = Core.Nothing, mountPoint = Core.Nothing,
         sizeGb = Core.Nothing}
instance Core.FromJSON Disk where
        parseJSON
          = Core.withObject "Disk"
              (\ o ->
                 Disk Core.<$>
                   (o Core..:? "diskType") Core.<*> (o Core..:? "mountPoint") Core.<*>
                     (o Core..:? "sizeGb"))
...
newDisplayData 
    ::  DisplayData
newDisplayData
  = DisplayData{boolValue = Core.Nothing,
                durationValue = Core.Nothing, floatValue = Core.Nothing,
                int64Value = Core.Nothing, javaClassValue = Core.Nothing,
                key = Core.Nothing, label = Core.Nothing, namespace = Core.Nothing,
                shortStrValue = Core.Nothing, strValue = Core.Nothing,
                timestampValue = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON DisplayData where
        parseJSON
          = Core.withObject "DisplayData"
              (\ o ->
                 DisplayData Core.<$>
                   (o Core..:? "boolValue") Core.<*> (o Core..:? "durationValue")
                     Core.<*> (o Core..:? "floatValue")
                     Core.<*>
                     (o Core..:? "int64Value" Core.<&> Core.fmap Core.fromAsText)
...
newDistributionUpdate 
    ::  DistributionUpdate
newDistributionUpdate
  = DistributionUpdate{count = Core.Nothing,
                       histogram = Core.Nothing, max = Core.Nothing, min = Core.Nothing,
                       sum = Core.Nothing, sumOfSquares = Core.Nothing}
instance Core.FromJSON DistributionUpdate where
        parseJSON
          = Core.withObject "DistributionUpdate"
              (\ o ->
                 DistributionUpdate Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "histogram") Core.<*>
                     (o Core..:? "max")
                     Core.<*> (o Core..:? "min")
                     Core.<*> (o Core..:? "sum")
...
newDynamicSourceSplit 
    ::  DynamicSourceSplit
newDynamicSourceSplit
  = DynamicSourceSplit{primary = Core.Nothing,
          ...
          = Core.withObject "DynamicSourceSplit"
              (\ o ->
                 DynamicSourceSplit Core.<$>
                   (o Core..:? "primary") Core.<*> (o Core..:? "residual"))
...
data Environment = Environment
    ...
    , usePublicIps :: (Core.Maybe Core.Bool)
...
newEnvironment 
    ::  Environment
newEnvironment
  = Environment{clusterManagerApiService = Core.Nothing,
                dataset = Core.Nothing, debugOptions = Core.Nothing,
                ...
                serviceKmsKeyName = Core.Nothing, serviceOptions = Core.Nothing,
                shuffleMode = Core.Nothing, streamingMode = Core.Nothing,
                tempStoragePrefix = Core.Nothing, usePublicIps = Core.Nothing,
                useStreamingEngineResourceBasedBilling = Core.Nothing,
                userAgent = Core.Nothing, version = Core.Nothing,
                workerPools = Core.Nothing, workerRegion = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("clusterManagerApiService" Core..=) Core.<$>
                  ...
                  ("usePublicIps" Core..=) Core.<$> usePublicIps,
                  ("useStreamingEngineResourceBasedBilling" Core..=) Core.<$>
...
newExecutionStageState 
    ::  ExecutionStageState
newExecutionStageState
  = ExecutionStageState{currentStateTime = Core.Nothing,
...
newExecutionStageSummary 
    ::  ExecutionStageSummary
newExecutionStageSummary
  = ExecutionStageSummary{componentSource = Core.Nothing,
                          componentTransform = Core.Nothing, id = Core.Nothing,
                          inputSource = Core.Nothing, kind = Core.Nothing,
                          name = Core.Nothing, outputSource = Core.Nothing,
          ...
          = Core.withObject "ExecutionStageSummary"
              (\ o ->
                 ExecutionStageSummary Core.<$>
                   (o Core..:? "componentSource") Core.<*>
                     (o Core..:? "componentTransform")
                     Core.<*> (o Core..:? "id")
...
data FlexTemplateRuntimeEnvironment = FlexTemplateRuntimeEnvironment
    ...
    , additionalPipelineOptions :: (Core.Maybe [Core.Text])
...
newFlexTemplateRuntimeEnvironment
  = FlexTemplateRuntimeEnvironment{additionalExperiments =
                                     Core.Nothing,
                                   additionalPipelineOptions = Core.Nothing,
                                   additionalUserLabels = Core.Nothing,
                                   autoscalingAlgorithm = Core.Nothing, diskSizeGb = Core.Nothing,
                                   dumpHeapOnOom = Core.Nothing,
                                   enableLauncherVmSerialPortLogging = Core.Nothing,
                                   enableStreamingEngine = Core.Nothing, flexrsGoal = Core.Nothing,
                                   ipConfiguration = Core.Nothing, kmsKeyName = Core.Nothing,
                                   launcherMachineType = Core.Nothing, machineType = Core.Nothing,
                                   maxWorkers = Core.Nothing, network = Core.Nothing,
                                   numWorkers = Core.Nothing, saveHeapDumpsToGcsPath = Core.Nothing,
                                   sdkContainerImage = Core.Nothing,
                                   serviceAccountEmail = Core.Nothing,
                                   stagingLocation = Core.Nothing, streamingMode = Core.Nothing,
                                   subnetwork = Core.Nothing, tempLocation = Core.Nothing,
                                   workerRegion = Core.Nothing, workerZone = Core.Nothing,
                                   zone = Core.Nothing}
              ...
              (\ o ->
                 FlexTemplateRuntimeEnvironment Core.<$>
                   (o Core..:? "additionalExperiments") Core.<*>
                     (o Core..:? "additionalPipelineOptions")
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalExperiments" Core..=) Core.<$> additionalExperiments,
                  ("additionalPipelineOptions" Core..=) Core.<$>
                  ...
                  ("enableLauncherVmSerialPortLogging" Core..=) Core.<$>
...
newFlexTemplateRuntimeEnvironment_AdditionalUserLabels additional
  = FlexTemplateRuntimeEnvironment_AdditionalUserLabels{additional =
                                                          additional}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "FlexTemplateRuntimeEnvironment_AdditionalUserLabels"
              (\ o ->
                 FlexTemplateRuntimeEnvironment_AdditionalUserLabels Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON GPUUsage where
        parseJSON
          = Core.withObject "GPUUsage"
              (\ o ->
                 GPUUsage Core.<$>
                   (o Core..:? "timestamp") Core.<*> (o Core..:? "utilization"))
...
instance Core.FromJSON GPUUtilization where
        parseJSON
          = Core.withObject "GPUUtilization"
...
newGetDebugConfigRequest 
    ::  GetDebugConfigRequest
newGetDebugConfigRequest
  = GetDebugConfigRequest{componentId = Core.Nothing,
                          location = Core.Nothing, workerId = Core.Nothing}
instance Core.FromJSON GetDebugConfigRequest where
        parseJSON
          = Core.withObject "GetDebugConfigRequest"
              (\ o ->
                 GetDebugConfigRequest Core.<$>
                   (o Core..:? "componentId") Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "workerId"))
...
newGetTemplateResponse 
    ::  GetTemplateResponse
newGetTemplateResponse
  = GetTemplateResponse{metadata = Core.Nothing,
                        runtimeMetadata = Core.Nothing, status = Core.Nothing,
          ...
          = Core.withObject "GetTemplateResponse"
              (\ o ->
                 GetTemplateResponse Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "runtimeMetadata")
                     Core.<*> (o Core..:? "status")
...
--
-- /See:/ 'newGetWorkerStacktracesRequest' smart constructor.
newtype GetWorkerStacktracesRequest = GetWorkerStacktracesRequest
    {
...
-- | Creates a value of 'GetWorkerStacktracesRequest' with the minimum fields required to make a request.
newGetWorkerStacktracesRequest 
    ::  GetWorkerStacktracesRequest
newGetWorkerStacktracesRequest
  = GetWorkerStacktracesRequest{workerId = Core.Nothing}
instance Core.FromJSON GetWorkerStacktracesRequest where
        parseJSON
          = Core.withObject "GetWorkerStacktracesRequest"
              (\ o ->
                 GetWorkerStacktracesRequest Core.<$> (o Core..:? "workerId"))

instance Core.ToJSON GetWorkerStacktracesRequest where
        toJSON GetWorkerStacktracesRequest{..}
          = Core.object
              (Core.catMaybes [("workerId" Core..=) Core.<$> workerId])


-- | Response to get worker stacktraces from debug capture.
--
-- /See:/ 'newGetWorkerStacktracesResponse' smart constructor.
newtype GetWorkerStacktracesResponse = GetWorkerStacktracesResponse
    {
...
-- | Creates a value of 'GetWorkerStacktracesResponse' with the minimum fields required to make a request.
newGetWorkerStacktracesResponse 
    ::  GetWorkerStacktracesResponse
newGetWorkerStacktracesResponse
  = GetWorkerStacktracesResponse{sdks = Core.Nothing}
instance Core.FromJSON GetWorkerStacktracesResponse where
        parseJSON
          = Core.withObject "GetWorkerStacktracesResponse"
              (\ o -> GetWorkerStacktracesResponse Core.<$> (o Core..:? "sdks"))

instance Core.ToJSON GetWorkerStacktracesResponse where
        toJSON GetWorkerStacktracesResponse{..}
          = Core.object (Core.catMaybes [("sdks" Core..=) Core.<$> sdks])
...
newHistogram 
    ::  Histogram
newHistogram
  = Histogram{bucketCounts = Core.Nothing,
...
instance Core.FromJSON HotKeyDebuggingInfo where
        parseJSON
          = Core.withObject "HotKeyDebuggingInfo"
              (\ o ->
...
instance Core.FromJSON HotKeyDebuggingInfo_DetectedHotKeys where
        parseJSON
          = Core.withObject "HotKeyDebuggingInfo_DetectedHotKeys"
              (\ o ->
                 HotKeyDebuggingInfo_DetectedHotKeys Core.<$>
                   (Core.parseJSONObject o))
...
newHotKeyDetection 
    ::  HotKeyDetection
newHotKeyDetection
  = HotKeyDetection{hotKeyAge = Core.Nothing,
                    systemName = Core.Nothing, userStepName = Core.Nothing}
instance Core.FromJSON HotKeyDetection where
        parseJSON
          = Core.withObject "HotKeyDetection"
              (\ o ->
                 HotKeyDetection Core.<$>
                   (o Core..:? "hotKeyAge") Core.<*> (o Core..:? "systemName")
...
newHotKeyInfo 
    ::  HotKeyInfo
newHotKeyInfo
  = HotKeyInfo{hotKeyAge = Core.Nothing, key = Core.Nothing,
               keyTruncated = Core.Nothing}
instance Core.FromJSON HotKeyInfo where
        parseJSON
          = Core.withObject "HotKeyInfo"
              (\ o ->
                 HotKeyInfo Core.<$>
                   (o Core..:? "hotKeyAge") Core.<*> (o Core..:? "key") Core.<*>
                     (o Core..:? "keyTruncated"))
...
newInstructionInput 
    ::  InstructionInput
newInstructionInput
  = InstructionInput{outputNum = Core.Nothing,
...
newInstructionOutput 
    ::  InstructionOutput
newInstructionOutput
  = InstructionOutput{codec = Core.Nothing, name = Core.Nothing,
                      onlyCountKeyBytes = Core.Nothing,
                      onlyCountValueBytes = Core.Nothing, originalName = Core.Nothing,
          ...
          = Core.withObject "InstructionOutput"
              (\ o ->
                 InstructionOutput Core.<$>
                   (o Core..:? "codec") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "onlyCountKeyBytes")
...
instance Core.ToJSON InstructionOutput where
        toJSON InstructionOutput{..}
          = Core.object
              (Core.catMaybes
                 [("codec" Core..=) Core.<$> codec, ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON IntegerGauge where
        parseJSON
          = Core.withObject "IntegerGauge"
              (\ o ->
                 IntegerGauge Core.<$>
                   (o Core..:? "timestamp") Core.<*> (o Core..:? "value"))
...
newJob 
    ::  Job
newJob
  = Job{clientRequestId = Core.Nothing, createTime = Core.Nothing,
        createdFromSnapshotId = Core.Nothing, currentState = Core.Nothing,
        currentStateTime = Core.Nothing, environment = Core.Nothing,
        executionInfo = Core.Nothing, id = Core.Nothing,
        jobMetadata = Core.Nothing, labels = Core.Nothing,
        location = Core.Nothing, name = Core.Nothing,
        pipelineDescription = Core.Nothing, projectId = Core.Nothing,
        replaceJobId = Core.Nothing, replacedByJobId = Core.Nothing,
        requestedState = Core.Nothing,
        runtimeUpdatableParams = Core.Nothing, satisfiesPzi = Core.Nothing,
        satisfiesPzs = Core.Nothing, serviceResources = Core.Nothing,
        stageStates = Core.Nothing, startTime = Core.Nothing,
        steps = Core.Nothing, stepsLocation = Core.Nothing,
        tempFiles = Core.Nothing, transformNameMapping = Core.Nothing,
        type' = Core.Nothing}
instance Core.FromJSON Job where
        parseJSON
          = Core.withObject "Job"
              (\ o ->
                 Job Core.<$>
                   (o Core..:? "clientRequestId") Core.<*> (o Core..:? "createTime")
...
newJobExecutionDetails 
    ::  JobExecutionDetails
newJobExecutionDetails
  = JobExecutionDetails{nextPageToken = Core.Nothing,
                        stages = Core.Nothing}
          ...
          = Core.withObject "JobExecutionDetails"
              (\ o ->
                 JobExecutionDetails Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "stages"))
...
newJobMessage 
    ::  JobMessage
newJobMessage
  = JobMessage{id = Core.Nothing, messageImportance = Core.Nothing,
               messageText = Core.Nothing, time = Core.Nothing}
instance Core.FromJSON JobMessage where
        parseJSON
          = Core.withObject "JobMessage"
              (\ o ->
                 JobMessage Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "messageImportance")
...
newJobMetadata 
    ::  JobMetadata
newJobMetadata
  = JobMetadata{bigTableDetails = Core.Nothing,
                bigqueryDetails = Core.Nothing, datastoreDetails = Core.Nothing,
                fileDetails = Core.Nothing, pubsubDetails = Core.Nothing,
                sdkVersion = Core.Nothing, spannerDetails = Core.Nothing,
...
instance Core.FromJSON JobMetadata where
        parseJSON
          = Core.withObject "JobMetadata"
              (\ o ->
                 JobMetadata Core.<$>
                   (o Core..:? "bigTableDetails") Core.<*>
                     (o Core..:? "bigqueryDetails")
...
instance Core.FromJSON JobMetadata_UserDisplayProperties where
        parseJSON
          = Core.withObject "JobMetadata_UserDisplayProperties"
              (\ o ->
                 JobMetadata_UserDisplayProperties Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON JobMetrics where
        parseJSON
          = Core.withObject "JobMetrics"
              (\ o ->
                 JobMetrics Core.<$>
                   (o Core..:? "metricTime") Core.<*> (o Core..:? "metrics"))
...
newKeyRangeDataDiskAssignment 
    ::  KeyRangeDataDiskAssignment
newKeyRangeDataDiskAssignment
  = KeyRangeDataDiskAssignment{dataDisk = Core.Nothing,
                               end = Core.Nothing, start = Core.Nothing}
          ...
          = Core.withObject "KeyRangeDataDiskAssignment"
              (\ o ->
                 KeyRangeDataDiskAssignment Core.<$>
                   (o Core..:? "dataDisk") Core.<*> (o Core..:? "end") Core.<*>
                     (o Core..:? "start"))
...
newKeyRangeLocation 
    ::  KeyRangeLocation
newKeyRangeLocation
  = KeyRangeLocation{dataDisk = Core.Nothing,
                     deliveryEndpoint = Core.Nothing,
                     deprecatedPersistentDirectory = Core.Nothing, end = Core.Nothing,
                     start = Core.Nothing}
          ...
          = Core.withObject "KeyRangeLocation"
              (\ o ->
                 KeyRangeLocation Core.<$>
                   (o Core..:? "dataDisk") Core.<*> (o Core..:? "deliveryEndpoint")
...
newLaunchFlexTemplateParameter 
    ::  LaunchFlexTemplateParameter
newLaunchFlexTemplateParameter
  = LaunchFlexTemplateParameter{containerSpec = Core.Nothing,
                                containerSpecGcsPath = Core.Nothing, environment = Core.Nothing,
                                jobName = Core.Nothing, launchOptions = Core.Nothing,
                                parameters = Core.Nothing, transformNameMappings = Core.Nothing,
                                update = Core.Nothing}
...
newLaunchFlexTemplateParameter_LaunchOptions additional
  = LaunchFlexTemplateParameter_LaunchOptions{additional =
                                                additional}
instance Core.FromJSON LaunchFlexTemplateParameter_LaunchOptions
         where
        parseJSON
          = Core.withObject "LaunchFlexTemplateParameter_LaunchOptions"
              (\ o ->
                 LaunchFlexTemplateParameter_LaunchOptions Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON LaunchFlexTemplateParameter_LaunchOptions
         where
...
instance Core.FromJSON LaunchFlexTemplateParameter_Parameters where
        parseJSON
          = Core.withObject "LaunchFlexTemplateParameter_Parameters"
              (\ o ->
...
newLaunchFlexTemplateParameter_TransformNameMappings additional
  = LaunchFlexTemplateParameter_TransformNameMappings{additional =
                                                        additional}
instance Core.FromJSON
           LaunchFlexTemplateParameter_TransformNameMappings
         where
        parseJSON
          = Core.withObject
              "LaunchFlexTemplateParameter_TransformNameMappings"
              (\ o ->
                 LaunchFlexTemplateParameter_TransformNameMappings Core.<$>
                   (Core.parseJSONObject o))
...
newLaunchFlexTemplateRequest 
    ::  LaunchFlexTemplateRequest
newLaunchFlexTemplateRequest
  = LaunchFlexTemplateRequest{launchParameter = Core.Nothing,
...
newLaunchTemplateParameters 
    ::  LaunchTemplateParameters
newLaunchTemplateParameters
  = LaunchTemplateParameters{environment = Core.Nothing,
                             jobName = Core.Nothing, parameters = Core.Nothing,
                             transformNameMapping = Core.Nothing, update = Core.Nothing}
          ...
          = Core.withObject "LaunchTemplateParameters"
              (\ o ->
                 LaunchTemplateParameters Core.<$>
                   (o Core..:? "environment") Core.<*> (o Core..:? "jobName") Core.<*>
                     (o Core..:? "parameters")
                     Core.<*> (o Core..:? "transformNameMapping")
                     Core.<*> (o Core..:? "update"))
...
instance Core.FromJSON LaunchTemplateParameters_Parameters where
        parseJSON
          = Core.withObject "LaunchTemplateParameters_Parameters"
              (\ o ->
...
newLaunchTemplateParameters_TransformNameMapping additional
  = LaunchTemplateParameters_TransformNameMapping{additional =
                                                    additional}
instance Core.FromJSON
           LaunchTemplateParameters_TransformNameMapping
         where
        parseJSON
          = Core.withObject "LaunchTemplateParameters_TransformNameMapping"
              (\ o ->
                 LaunchTemplateParameters_TransformNameMapping Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON LaunchTemplateParameters_TransformNameMapping
         where
...
newLeaseWorkItemRequest 
    ::  LeaseWorkItemRequest
newLeaseWorkItemRequest
  = LeaseWorkItemRequest{currentWorkerTime = Core.Nothing,
                         location = Core.Nothing, projectNumber = Core.Nothing,
                         requestedLeaseDuration = Core.Nothing,
                         unifiedWorkerRequest = Core.Nothing, workItemTypes = Core.Nothing,
                         workerCapabilities = Core.Nothing, workerId = Core.Nothing}
instance Core.FromJSON LeaseWorkItemRequest where
        parseJSON
          = Core.withObject "LeaseWorkItemRequest"
              (\ o ->
                 LeaseWorkItemRequest Core.<$>
                   (o Core..:? "currentWorkerTime") Core.<*> (o Core..:? "location")
                     Core.<*>
                     (o Core..:? "projectNumber" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("currentWorkerTime" Core..=) Core.<$> currentWorkerTime,
                  ("location" Core..=) Core.<$> location,
                  ("projectNumber" Core..=) Core.. Core.AsText Core.<$>
                    projectNumber,
...
newLeaseWorkItemRequest_UnifiedWorkerRequest additional
  = LeaseWorkItemRequest_UnifiedWorkerRequest{additional =
                                                additional}
instance Core.FromJSON LeaseWorkItemRequest_UnifiedWorkerRequest
         where
        parseJSON
          = Core.withObject "LeaseWorkItemRequest_UnifiedWorkerRequest"
              (\ o ->
                 LeaseWorkItemRequest_UnifiedWorkerRequest Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON LeaseWorkItemRequest_UnifiedWorkerRequest
         where
...
newLeaseWorkItemResponse 
    ::  LeaseWorkItemResponse
newLeaseWorkItemResponse
  = LeaseWorkItemResponse{unifiedWorkerResponse = Core.Nothing,
...
newLeaseWorkItemResponse_UnifiedWorkerResponse additional
  = LeaseWorkItemResponse_UnifiedWorkerResponse{additional =
                                                  additional}
instance Core.FromJSON LeaseWorkItemResponse_UnifiedWorkerResponse
         where
        parseJSON
          = Core.withObject "LeaseWorkItemResponse_UnifiedWorkerResponse"
              (\ o ->
                 LeaseWorkItemResponse_UnifiedWorkerResponse Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON LeaseWorkItemResponse_UnifiedWorkerResponse
         where
...
newLinear 
    ::  Linear
newLinear
  = Linear{numberOfBuckets = Core.Nothing, start = Core.Nothing,
           width = Core.Nothing}
instance Core.FromJSON Linear where
        parseJSON
          = Core.withObject "Linear"
              (\ o ->
                 Linear Core.<$>
                   (o Core..:? "numberOfBuckets") Core.<*> (o Core..:? "start")
                     Core.<*> (o Core..:? "width"))
...
newListJobMessagesResponse 
    ::  ListJobMessagesResponse
newListJobMessagesResponse
  = ListJobMessagesResponse{autoscalingEvents = Core.Nothing,
                            jobMessages = Core.Nothing, nextPageToken = Core.Nothing}
instance Core.FromJSON ListJobMessagesResponse where
        parseJSON
          = Core.withObject "ListJobMessagesResponse"
              (\ o ->
                 ListJobMessagesResponse Core.<$>
                   (o Core..:? "autoscalingEvents") Core.<*>
                     (o Core..:? "jobMessages")
...
newListJobsResponse 
    ::  ListJobsResponse
newListJobsResponse
  = ListJobsResponse{failedLocation = Core.Nothing,
          ...
          = Core.withObject "ListJobsResponse"
              (\ o ->
                 ListJobsResponse Core.<$>
                   (o Core..:? "failedLocation") Core.<*> (o Core..:? "jobs") Core.<*>
...
newMapTask 
    ::  MapTask
newMapTask
  = MapTask{counterPrefix = Core.Nothing,
            instructions = Core.Nothing, stageName = Core.Nothing,
            systemName = Core.Nothing}
instance Core.FromJSON MapTask where
        parseJSON
          = Core.withObject "MapTask"
              (\ o ->
                 MapTask Core.<$>
                   (o Core..:? "counterPrefix") Core.<*> (o Core..:? "instructions")
...
newMemInfo 
    ::  MemInfo
newMemInfo
  = MemInfo{currentLimitBytes = Core.Nothing,
            currentOoms = Core.Nothing, currentRssBytes = Core.Nothing,
            timestamp = Core.Nothing, totalGbMs = Core.Nothing}
instance Core.FromJSON MemInfo where
        parseJSON
          = Core.withObject "MemInfo"
              (\ o ->
                 MemInfo Core.<$>
                   (o Core..:? "currentLimitBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "currentOoms" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "currentRssBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "timestamp")
                     Core.<*>
                     (o Core..:? "totalGbMs" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON MemInfo where
        toJSON MemInfo{..}
          = Core.object
              (Core.catMaybes
                 [("currentLimitBytes" Core..=) Core.. Core.AsText Core.<$>
                    currentLimitBytes,
                  ("currentOoms" Core..=) Core.. Core.AsText Core.<$> currentOoms,
                  ("currentRssBytes" Core..=) Core.. Core.AsText Core.<$>
                    currentRssBytes,
                  ("timestamp" Core..=) Core.<$> timestamp,
              ...
              (\ o ->
                 MetricShortId Core.<$>
                   (o Core..:? "metricIndex") Core.<*>
                     (o Core..:? "shortId" Core.<&> Core.fmap Core.fromAsText))
...
newMetricStructuredName 
    ::  MetricStructuredName
newMetricStructuredName
  = MetricStructuredName{context = Core.Nothing, name = Core.Nothing,
                         origin = Core.Nothing}
          ...
          = Core.withObject "MetricStructuredName"
              (\ o ->
                 MetricStructuredName Core.<$>
                   (o Core..:? "context") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "origin"))
...
data MetricUpdate = MetricUpdate
    {
      ...
      boundedTrie :: (Core.Maybe Core.Value)
...
newMetricUpdate 
    ::  MetricUpdate
newMetricUpdate
  = MetricUpdate{boundedTrie = Core.Nothing,
                 cumulative = Core.Nothing, distribution = Core.Nothing,
                 gauge = Core.Nothing, internal = Core.Nothing, kind = Core.Nothing,
                 meanCount = Core.Nothing, meanSum = Core.Nothing,
                 name = Core.Nothing, scalar = Core.Nothing, set = Core.Nothing,
                 trie = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON MetricUpdate where
        parseJSON
          = Core.withObject "MetricUpdate"
              (\ o ->
                 MetricUpdate Core.<$>
                   (o Core..:? "boundedTrie") Core.<*> (o Core..:? "cumulative")
                     Core.<*> (o Core..:? "distribution")
                     Core.<*> (o Core..:? "gauge")
                     Core.<*> (o Core..:? "internal")
                     Core.<*> (o Core..:? "kind")
          ...
          = Core.object
              (Core.catMaybes
                 [("boundedTrie" Core..=) Core.<$> boundedTrie,
                  ...
                  ("name" Core..=) Core.<$> name, ("scalar" Core..=) Core.<$> scalar,
                  ("set" Core..=) Core.<$> set, ("trie" Core..=) Core.<$> trie,
...
newMetricValue 
    ::  MetricValue
newMetricValue
  = MetricValue{metric = Core.Nothing, metricLabels = Core.Nothing,
                valueGauge64 = Core.Nothing, valueHistogram = Core.Nothing,
...
instance Core.FromJSON MetricValue where
        parseJSON
          = Core.withObject "MetricValue"
              (\ o ->
                 MetricValue Core.<$>
                   (o Core..:? "metric") Core.<*> (o Core..:? "metricLabels") Core.<*>
                     (o Core..:? "valueGauge64")
                     Core.<*> (o Core..:? "valueHistogram")
                     Core.<*>
                     (o Core..:? "valueInt64" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.FromJSON MetricValue_MetricLabels where
        parseJSON
          = Core.withObject "MetricValue_MetricLabels"
...
newOutlierStats 
    ::  OutlierStats
newOutlierStats
  = OutlierStats{overflowCount = Core.Nothing,
                 overflowMean = Core.Nothing, underflowCount = Core.Nothing,
                 underflowMean = Core.Nothing}
instance Core.FromJSON OutlierStats where
        parseJSON
          = Core.withObject "OutlierStats"
              (\ o ->
                 OutlierStats Core.<$>
                   (o Core..:? "overflowCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "overflowMean")
                     Core.<*>
                     (o Core..:? "underflowCount" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON OutlierStats where
        toJSON OutlierStats{..}
          = Core.object
              (Core.catMaybes
                 [("overflowCount" Core..=) Core.. Core.AsText Core.<$>
                    overflowCount,
                  ("overflowMean" Core..=) Core.<$> overflowMean,
                  ("underflowCount" Core..=) Core.. Core.AsText Core.<$>
                    underflowCount,
...
newParDoInstruction 
    ::  ParDoInstruction
newParDoInstruction
  = ParDoInstruction{input = Core.Nothing,
                     multiOutputInfos = Core.Nothing, numOutputs = Core.Nothing,
                     sideInputs = Core.Nothing, userFn = Core.Nothing}
instance Core.FromJSON ParDoInstruction where
        parseJSON
          = Core.withObject "ParDoInstruction"
              (\ o ->
                 ParDoInstruction Core.<$>
                   (o Core..:? "input") Core.<*> (o Core..:? "multiOutputInfos")
...
newParallelInstruction 
    ::  ParallelInstruction
newParallelInstruction
  = ParallelInstruction{flatten = Core.Nothing, name = Core.Nothing,
                        originalName = Core.Nothing, outputs = Core.Nothing,
                        parDo = Core.Nothing, partialGroupByKey = Core.Nothing,
                        read = Core.Nothing, systemName = Core.Nothing,
                        write = Core.Nothing}
          ...
          = Core.withObject "ParallelInstruction"
              (\ o ->
                 ParallelInstruction Core.<$>
                   (o Core..:? "flatten") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "originalName")
                     Core.<*> (o Core..:? "outputs")
                     Core.<*> (o Core..:? "parDo")
...
newParameterMetadata 
    ::  ParameterMetadata
newParameterMetadata
  = ParameterMetadata{customMetadata = Core.Nothing,
                      defaultValue = Core.Nothing, enumOptions = Core.Nothing,
                      groupName = Core.Nothing, helpText = Core.Nothing,
                      hiddenUi = Core.Nothing, isOptional = Core.Nothing,
                      label = Core.Nothing, name = Core.Nothing,
                      paramType = Core.Nothing, parentName = Core.Nothing,
                      parentTriggerValues = Core.Nothing, regexes = Core.Nothing}
instance Core.FromJSON ParameterMetadata where
        parseJSON
          = Core.withObject "ParameterMetadata"
              (\ o ->
                 ParameterMetadata Core.<$>
                   (o Core..:? "customMetadata") Core.<*> (o Core..:? "defaultValue")
...
newParameterMetadataEnumOption 
    ::  ParameterMetadataEnumOption
newParameterMetadataEnumOption
  = ParameterMetadataEnumOption{description = Core.Nothing,
                                label = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON ParameterMetadataEnumOption where
        parseJSON
          = Core.withObject "ParameterMetadataEnumOption"
              (\ o ->
                 ParameterMetadataEnumOption Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "label") Core.<*>
                     (o Core..:? "value"))
          ...
          = Core.withObject "PartialGroupByKeyInstruction"
              (\ o ->
                 PartialGroupByKeyInstruction Core.<$>
                   (o Core..:? "input") Core.<*> (o Core..:? "inputElementCodec")
          ...
          = Core.object
              (Core.catMaybes
                 [("input" Core..=) Core.<$> input,
                  ...
                  ("originalCombineValuesInputStoreName" Core..=) Core.<$>
...
newPartialGroupByKeyInstruction_InputElementCodec additional
  = PartialGroupByKeyInstruction_InputElementCodec{additional =
                                                     additional}
instance Core.FromJSON
           PartialGroupByKeyInstruction_InputElementCodec
         where
        parseJSON
          = Core.withObject "PartialGroupByKeyInstruction_InputElementCodec"
              (\ o ->
                 PartialGroupByKeyInstruction_InputElementCodec Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON PartialGroupByKeyInstruction_InputElementCodec
         where
...
newPartialGroupByKeyInstruction_ValueCombiningFn additional
  = PartialGroupByKeyInstruction_ValueCombiningFn{additional =
                                                    additional}
instance Core.FromJSON
           PartialGroupByKeyInstruction_ValueCombiningFn
         where
        parseJSON
          = Core.withObject "PartialGroupByKeyInstruction_ValueCombiningFn"
              (\ o ->
                 PartialGroupByKeyInstruction_ValueCombiningFn Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON PartialGroupByKeyInstruction_ValueCombiningFn
         where
...
newPerStepNamespaceMetrics 
    ::  PerStepNamespaceMetrics
newPerStepNamespaceMetrics
  = PerStepNamespaceMetrics{metricValues = Core.Nothing,
                            metricsNamespace = Core.Nothing, originalStep = Core.Nothing}
instance Core.FromJSON PerStepNamespaceMetrics where
        parseJSON
          = Core.withObject "PerStepNamespaceMetrics"
              (\ o ->
                 PerStepNamespaceMetrics Core.<$>
                   (o Core..:? "metricValues") Core.<*>
                     (o Core..:? "metricsNamespace")
...
instance Core.FromJSON PerWorkerMetrics where
        parseJSON
          = Core.withObject "PerWorkerMetrics"
              (\ o ->
...
instance Core.ToJSON PerWorkerMetrics where
        toJSON PerWorkerMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("perStepNamespaceMetrics" Core..=) Core.<$>
                    perStepNamespaceMetrics])
...
newPipelineDescription 
    ::  PipelineDescription
newPipelineDescription
  = PipelineDescription{displayData = Core.Nothing,
          ...
          = Core.withObject "PipelineDescription"
              (\ o ->
                 PipelineDescription Core.<$>
                   (o Core..:? "displayData") Core.<*>
                     (o Core..:? "executionPipelineStage")
...
newPosition 
    ::  Position
newPosition
  = Position{byteOffset = Core.Nothing,
             concatPosition = Core.Nothing, end = Core.Nothing,
             key = Core.Nothing, recordIndex = Core.Nothing,
...
instance Core.FromJSON Position where
        parseJSON
          = Core.withObject "Position"
              (\ o ->
                 Position Core.<$>
                   (o Core..:? "byteOffset" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "concatPosition")
                     Core.<*> (o Core..:? "end")
                     Core.<*> (o Core..:? "key")
                     Core.<*>
                     (o Core..:? "recordIndex" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("byteOffset" Core..=) Core.. Core.AsText Core.<$> byteOffset,
                  ...
                  ("end" Core..=) Core.<$> end, ("key" Core..=) Core.<$> key,
...
newProgressTimeseries 
    ::  ProgressTimeseries
newProgressTimeseries
  = ProgressTimeseries{currentProgress = Core.Nothing,
          ...
          = Core.withObject "ProgressTimeseries"
              (\ o ->
                 ProgressTimeseries Core.<$>
                   (o Core..:? "currentProgress") Core.<*> (o Core..:? "dataPoints"))
...
newPubSubIODetails 
    ::  PubSubIODetails
newPubSubIODetails
  = PubSubIODetails{subscription = Core.Nothing,
                    topic = Core.Nothing}
          ...
          = Core.withObject "PubSubIODetails"
              (\ o ->
                 PubSubIODetails Core.<$>
                   (o Core..:? "subscription") Core.<*> (o Core..:? "topic"))
...
newPubsubLocation 
    ::  PubsubLocation
newPubsubLocation
  = PubsubLocation{dropLateData = Core.Nothing,
                   dynamicDestinations = Core.Nothing, idLabel = Core.Nothing,
                   subscription = Core.Nothing, timestampLabel = Core.Nothing,
                   topic = Core.Nothing, trackingSubscription = Core.Nothing,
...
newPubsubSnapshotMetadata 
    ::  PubsubSnapshotMetadata
newPubsubSnapshotMetadata
  = PubsubSnapshotMetadata{expireTime = Core.Nothing,
                           snapshotName = Core.Nothing, topicName = Core.Nothing}
instance Core.FromJSON PubsubSnapshotMetadata where
        parseJSON
          = Core.withObject "PubsubSnapshotMetadata"
              (\ o ->
                 PubsubSnapshotMetadata Core.<$>
                   (o Core..:? "expireTime") Core.<*> (o Core..:? "snapshotName")
...
newReportWorkItemStatusRequest 
    ::  ReportWorkItemStatusRequest
newReportWorkItemStatusRequest
  = ReportWorkItemStatusRequest{currentWorkerTime = Core.Nothing,
                                location = Core.Nothing, projectNumber = Core.Nothing,
                                unifiedWorkerRequest = Core.Nothing,
                                workItemStatuses = Core.Nothing, workerId = Core.Nothing}
...
newReportWorkItemStatusRequest_UnifiedWorkerRequest additional
  = ReportWorkItemStatusRequest_UnifiedWorkerRequest{additional =
                                                       additional}
instance Core.FromJSON
           ReportWorkItemStatusRequest_UnifiedWorkerRequest
         where
        parseJSON
          = Core.withObject
              "ReportWorkItemStatusRequest_UnifiedWorkerRequest"
              (\ o ->
                 ReportWorkItemStatusRequest_UnifiedWorkerRequest Core.<$>
                   (Core.parseJSONObject o))
...
newReportWorkItemStatusResponse 
    ::  ReportWorkItemStatusResponse
newReportWorkItemStatusResponse
  = ReportWorkItemStatusResponse{unifiedWorkerResponse =
                                   Core.Nothing,
...
newReportWorkItemStatusResponse_UnifiedWorkerResponse additional
  = ReportWorkItemStatusResponse_UnifiedWorkerResponse{additional =
                                                         additional}
instance Core.FromJSON
           ReportWorkItemStatusResponse_UnifiedWorkerResponse
         where
        parseJSON
          = Core.withObject
              "ReportWorkItemStatusResponse_UnifiedWorkerResponse"
              (\ o ->
                 ReportWorkItemStatusResponse_UnifiedWorkerResponse Core.<$>
                   (Core.parseJSONObject o))
...
newReportedParallelism 
    ::  ReportedParallelism
newReportedParallelism
  = ReportedParallelism{isInfinite = Core.Nothing,
                        value = Core.Nothing}
          ...
          = Core.withObject "ReportedParallelism"
              (\ o ->
                 ReportedParallelism Core.<$>
                   (o Core..:? "isInfinite") Core.<*> (o Core..:? "value"))
...
newResourceUtilizationReport 
    ::  ResourceUtilizationReport
newResourceUtilizationReport
  = ResourceUtilizationReport{containers = Core.Nothing,
                              cpuTime = Core.Nothing, gpuUsage = Core.Nothing,
          ...
          = Core.withObject "ResourceUtilizationReport"
              (\ o ->
                 ResourceUtilizationReport Core.<$>
                   (o Core..:? "containers") Core.<*> (o Core..:? "cpuTime") Core.<*>
                     (o Core..:? "gpuUsage")
...
instance Core.FromJSON ResourceUtilizationReport_Containers where
        parseJSON
          = Core.withObject "ResourceUtilizationReport_Containers"
              (\ o ->
...
newRuntimeEnvironment 
    ::  RuntimeEnvironment
newRuntimeEnvironment
  = RuntimeEnvironment{additionalExperiments = Core.Nothing,
                       additionalPipelineOptions = Core.Nothing,
                       additionalUserLabels = Core.Nothing,
                       bypassTempDirValidation = Core.Nothing, diskSizeGb = Core.Nothing,
                       enableStreamingEngine = Core.Nothing,
                       ipConfiguration = Core.Nothing, kmsKeyName = Core.Nothing,
                       machineType = Core.Nothing, maxWorkers = Core.Nothing,
                       network = Core.Nothing, numWorkers = Core.Nothing,
                       serviceAccountEmail = Core.Nothing, streamingMode = Core.Nothing,
                       subnetwork = Core.Nothing, tempLocation = Core.Nothing,
                       workerRegion = Core.Nothing, workerZone = Core.Nothing,
                       zone = Core.Nothing}
...
instance Core.FromJSON RuntimeEnvironment_AdditionalUserLabels
         where
        parseJSON
          = Core.withObject "RuntimeEnvironment_AdditionalUserLabels"
              (\ o ->
...
newRuntimeMetadata 
    ::  RuntimeMetadata
newRuntimeMetadata
  = RuntimeMetadata{parameters = Core.Nothing,
          ...
          = Core.withObject "RuntimeMetadata"
              (\ o ->
                 RuntimeMetadata Core.<$>
                   (o Core..:? "parameters") Core.<*> (o Core..:? "sdkInfo"))
...
newRuntimeUpdatableParams 
    ::  RuntimeUpdatableParams
newRuntimeUpdatableParams
  = RuntimeUpdatableParams{maxNumWorkers = Core.Nothing,
                           minNumWorkers = Core.Nothing, workerUtilizationHint = Core.Nothing}
instance Core.FromJSON RuntimeUpdatableParams where
        parseJSON
          = Core.withObject "RuntimeUpdatableParams"
              (\ o ->
                 RuntimeUpdatableParams Core.<$>
                   (o Core..:? "maxNumWorkers") Core.<*> (o Core..:? "minNumWorkers")
...
instance Core.FromJSON SDKInfo where
        parseJSON
          = Core.withObject "SDKInfo"
              (\ o ->
                 SDKInfo Core.<$>
                   (o Core..:? "language") Core.<*> (o Core..:? "version"))
...
--
-- /See:/ 'newSdk' smart constructor.
data Sdk = Sdk
    {
      -- | The SDK harness id.
      sdkId :: (Core.Maybe Core.Text)
      -- | The stacktraces for the processes running on the SDK harness.
    , stacks :: (Core.Maybe [Stack])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'Sdk' with the minimum fields required to make a request.
newSdk 
    ::  Sdk
newSdk = Sdk{sdkId = Core.Nothing, stacks = Core.Nothing}
instance Core.FromJSON Sdk where
        parseJSON
          = Core.withObject "Sdk"
              (\ o ->
                 Sdk Core.<$> (o Core..:? "sdkId") Core.<*> (o Core..:? "stacks"))

instance Core.ToJSON Sdk where
        toJSON Sdk{..}
          = Core.object
              (Core.catMaybes
                 [("sdkId" Core..=) Core.<$> sdkId,
                  ("stacks" Core..=) Core.<$> stacks])
...
newSdkBug 
    ::  SdkBug
newSdkBug
  = SdkBug{severity = Core.Nothing, type' = Core.Nothing,
           uri = Core.Nothing}
instance Core.FromJSON SdkBug where
        parseJSON
          = Core.withObject "SdkBug"
              (\ o ->
                 SdkBug Core.<$>
                   (o Core..:? "severity") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "uri"))
...
newSdkHarnessContainerImage 
    ::  SdkHarnessContainerImage
newSdkHarnessContainerImage
  = SdkHarnessContainerImage{capabilities = Core.Nothing,
                             containerImage = Core.Nothing, environmentId = Core.Nothing,
          ...
          = Core.withObject "SdkHarnessContainerImage"
              (\ o ->
                 SdkHarnessContainerImage Core.<$>
                   (o Core..:? "capabilities") Core.<*> (o Core..:? "containerImage")
...
newSdkVersion 
    ::  SdkVersion
newSdkVersion
  = SdkVersion{bugs = Core.Nothing, sdkSupportStatus = Core.Nothing,
               version = Core.Nothing, versionDisplayName = Core.Nothing}
instance Core.FromJSON SdkVersion where
        parseJSON
          = Core.withObject "SdkVersion"
              (\ o ->
                 SdkVersion Core.<$>
                   (o Core..:? "bugs") Core.<*> (o Core..:? "sdkSupportStatus")
                     Core.<*> (o Core..:? "version")
...
newSendDebugCaptureRequest 
    ::  SendDebugCaptureRequest
newSendDebugCaptureRequest
  = SendDebugCaptureRequest{componentId = Core.Nothing,
                            data' = Core.Nothing, dataFormat = Core.Nothing,
                            location = Core.Nothing, workerId = Core.Nothing}
          ...
          = Core.withObject "SendDebugCaptureRequest"
              (\ o ->
                 SendDebugCaptureRequest Core.<$>
                   (o Core..:? "componentId") Core.<*> (o Core..:? "data") Core.<*>
                     (o Core..:? "dataFormat")
                     Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "workerId"))
...
newSendWorkerMessagesRequest 
    ::  SendWorkerMessagesRequest
newSendWorkerMessagesRequest
  = SendWorkerMessagesRequest{location = Core.Nothing,
          ...
          = Core.withObject "SendWorkerMessagesRequest"
              (\ o ->
                 SendWorkerMessagesRequest Core.<$>
                   (o Core..:? "location") Core.<*> (o Core..:? "workerMessages"))
...
newSeqMapTask 
    ::  SeqMapTask
newSeqMapTask
  = SeqMapTask{inputs = Core.Nothing, name = Core.Nothing,
               outputInfos = Core.Nothing, stageName = Core.Nothing,
               systemName = Core.Nothing, userFn = Core.Nothing}
instance Core.FromJSON SeqMapTask where
        parseJSON
          = Core.withObject "SeqMapTask"
              (\ o ->
                 SeqMapTask Core.<$>
                   (o Core..:? "inputs") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "outputInfos")
                     Core.<*> (o Core..:? "stageName")
                     Core.<*> (o Core..:? "systemName")
                     Core.<*> (o Core..:? "userFn"))
...
instance Core.FromJSON ServiceResources where
        parseJSON
          = Core.withObject "ServiceResources"
...
instance Core.FromJSON ShellTask where
        parseJSON
          = Core.withObject "ShellTask"
              (\ o ->
                 ShellTask Core.<$>
                   (o Core..:? "command") Core.<*> (o Core..:? "exitCode"))
...
newSideInputInfo 
    ::  SideInputInfo
newSideInputInfo
  = SideInputInfo{kind = Core.Nothing, sources = Core.Nothing,
                  tag = Core.Nothing}
instance Core.FromJSON SideInputInfo where
        parseJSON
          = Core.withObject "SideInputInfo"
              (\ o ->
                 SideInputInfo Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "sources") Core.<*>
                     (o Core..:? "tag"))
...
newSnapshot 
    ::  Snapshot
newSnapshot
  = Snapshot{creationTime = Core.Nothing, description = Core.Nothing,
             diskSizeBytes = Core.Nothing, id = Core.Nothing,
             projectId = Core.Nothing, pubsubMetadata = Core.Nothing,
             region = Core.Nothing, sourceJobId = Core.Nothing,
             state = Core.Nothing, ttl = Core.Nothing}
instance Core.FromJSON Snapshot where
        parseJSON
          = Core.withObject "Snapshot"
              (\ o ->
                 Snapshot Core.<$>
                   (o Core..:? "creationTime") Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "diskSizeBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "projectId")
...
newSnapshotJobRequest 
    ::  SnapshotJobRequest
newSnapshotJobRequest
  = SnapshotJobRequest{description = Core.Nothing,
                       location = Core.Nothing, snapshotSources = Core.Nothing,
                       ttl = Core.Nothing}
          ...
          = Core.withObject "SnapshotJobRequest"
              (\ o ->
                 SnapshotJobRequest Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "location")
...
newSource 
    ::  Source
newSource
  = Source{baseSpecs = Core.Nothing, codec = Core.Nothing,
           doesNotNeedSplitting = Core.Nothing, metadata = Core.Nothing,
           spec = Core.Nothing}
instance Core.FromJSON Source where
        parseJSON
          = Core.withObject "Source"
              (\ o ->
                 Source Core.<$>
                   (o Core..:? "baseSpecs") Core.<*> (o Core..:? "codec") Core.<*>
                     (o Core..:? "doesNotNeedSplitting")
                     Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "spec"))
...
newSourceFork 
    ::  SourceFork
newSourceFork
  = SourceFork{primary = Core.Nothing, primarySource = Core.Nothing,
               residual = Core.Nothing, residualSource = Core.Nothing}
instance Core.FromJSON SourceFork where
        parseJSON
          = Core.withObject "SourceFork"
              (\ o ->
                 SourceFork Core.<$>
                   (o Core..:? "primary") Core.<*> (o Core..:? "primarySource")
...
newSourceMetadata 
    ::  SourceMetadata
newSourceMetadata
  = SourceMetadata{estimatedSizeBytes = Core.Nothing,
                   infinite = Core.Nothing, producesSortedKeys = Core.Nothing}
...
instance Core.ToJSON SourceMetadata where
        toJSON SourceMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("estimatedSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    estimatedSizeBytes,
...
newSourceOperationRequest 
    ::  SourceOperationRequest
newSourceOperationRequest
  = SourceOperationRequest{getMetadata = Core.Nothing,
                           name = Core.Nothing, originalName = Core.Nothing,
                           split = Core.Nothing, stageName = Core.Nothing,
                           systemName = Core.Nothing}
          ...
          = Core.withObject "SourceOperationRequest"
              (\ o ->
                 SourceOperationRequest Core.<$>
                   (o Core..:? "getMetadata") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "originalName")
                     Core.<*> (o Core..:? "split")
                     Core.<*> (o Core..:? "stageName")
                     Core.<*> (o Core..:? "systemName"))
...
newSourceOperationResponse 
    ::  SourceOperationResponse
newSourceOperationResponse
  = SourceOperationResponse{getMetadata = Core.Nothing,
                            split = Core.Nothing}
          ...
          = Core.withObject "SourceOperationResponse"
              (\ o ->
                 SourceOperationResponse Core.<$>
                   (o Core..:? "getMetadata") Core.<*> (o Core..:? "split"))
...
newSourceSplitOptions 
    ::  SourceSplitOptions
newSourceSplitOptions
  = SourceSplitOptions{desiredBundleSizeBytes = Core.Nothing,
              ...
              (\ o ->
                 SourceSplitOptions Core.<$>
                   (o Core..:? "desiredBundleSizeBytes" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "desiredShardSizeBytes" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON SourceSplitOptions where
        toJSON SourceSplitOptions{..}
          = Core.object
              (Core.catMaybes
                 [("desiredBundleSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    desiredBundleSizeBytes,
                  ("desiredShardSizeBytes" Core..=) Core.. Core.AsText Core.<$>
          ...
          = Core.withObject "SourceSplitRequest"
              (\ o ->
                 SourceSplitRequest Core.<$>
                   (o Core..:? "options") Core.<*> (o Core..:? "source"))
...
newSourceSplitResponse 
    ::  SourceSplitResponse
newSourceSplitResponse
  = SourceSplitResponse{bundles = Core.Nothing,
                        outcome = Core.Nothing, shards = Core.Nothing}
instance Core.FromJSON SourceSplitResponse where
        parseJSON
          = Core.withObject "SourceSplitResponse"
              (\ o ->
                 SourceSplitResponse Core.<$>
                   (o Core..:? "bundles") Core.<*> (o Core..:? "outcome") Core.<*>
                     (o Core..:? "shards"))
...
newSourceSplitShard 
    ::  SourceSplitShard
newSourceSplitShard
  = SourceSplitShard{derivationMode = Core.Nothing,
                     source = Core.Nothing}
...
newSpannerIODetails 
    ::  SpannerIODetails
newSpannerIODetails
  = SpannerIODetails{databaseId = Core.Nothing,
                     instanceId = Core.Nothing, projectId = Core.Nothing}
instance Core.FromJSON SpannerIODetails where
        parseJSON
          = Core.withObject "SpannerIODetails"
              (\ o ->
                 SpannerIODetails Core.<$>
                   (o Core..:? "databaseId") Core.<*> (o Core..:? "instanceId")
                     Core.<*> (o Core..:? "projectId"))
...
instance Core.FromJSON SplitInt64 where
        parseJSON
          = Core.withObject "SplitInt64"
              (\ o ->
                 SplitInt64 Core.<$>
                   (o Core..:? "highBits") Core.<*> (o Core..:? "lowBits"))
...
data Stack = Stack
    {
      -- | The raw stack trace.
      stackContent :: (Core.Maybe Core.Text)
    ...
    , threadCount :: (Core.Maybe Core.Int32)
      -- | Thread name. For example, \"CommitThread-0,10,main\"
    , threadName :: (Core.Maybe Core.Text)
      -- | The state of the thread. For example, \"WAITING\".
    , threadState :: (Core.Maybe Core.Text)
...
newStack 
    ::  Stack
newStack
  = Stack{stackContent = Core.Nothing, threadCount = Core.Nothing,
          threadName = Core.Nothing, threadState = Core.Nothing,
          timestamp = Core.Nothing}
instance Core.FromJSON Stack where
        parseJSON
          = Core.withObject "Stack"
              (\ o ->
                 Stack Core.<$>
                   (o Core..:? "stackContent") Core.<*> (o Core..:? "threadCount")
                     Core.<*> (o Core..:? "threadName")
                     Core.<*> (o Core..:? "threadState")
                     Core.<*> (o Core..:? "timestamp"))

instance Core.ToJSON Stack where
        toJSON Stack{..}
          = Core.object
              (Core.catMaybes
                 [("stackContent" Core..=) Core.<$> stackContent,
                  ("threadCount" Core..=) Core.<$> threadCount,
                  ("threadName" Core..=) Core.<$> threadName,
                  ("threadState" Core..=) Core.<$> threadState,
                  ("timestamp" Core..=) Core.<$> timestamp])
...
newStageExecutionDetails 
    ::  StageExecutionDetails
newStageExecutionDetails
  = StageExecutionDetails{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "StageExecutionDetails"
              (\ o ->
                 StageExecutionDetails Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "workers"))
...
newStageSource 
    ::  StageSource
newStageSource
  = StageSource{name = Core.Nothing,
                originalTransformOrCollection = Core.Nothing,
                sizeBytes = Core.Nothing, userName = Core.Nothing}
...
newStageSummary 
    ::  StageSummary
newStageSummary
  = StageSummary{endTime = Core.Nothing, metrics = Core.Nothing,
                 progress = Core.Nothing, stageId = Core.Nothing,
...
instance Core.FromJSON StageSummary where
        parseJSON
          = Core.withObject "StageSummary"
              (\ o ->
                 StageSummary Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "metrics") Core.<*>
                     (o Core..:? "progress")
                     Core.<*> (o Core..:? "stageId")
                     Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "state")
...
newStateFamilyConfig 
    ::  StateFamilyConfig
newStateFamilyConfig
  = StateFamilyConfig{isRead = Core.Nothing,
          ...
          = Core.withObject "StateFamilyConfig"
              (\ o ->
                 StateFamilyConfig Core.<$>
                   (o Core..:? "isRead") Core.<*> (o Core..:? "stateFamily"))
...
newStep 
    ::  Step
newStep
  = Step{kind = Core.Nothing, name = Core.Nothing,
...
newStraggler 
    ::  Straggler
newStraggler
  = Straggler{batchStraggler = Core.Nothing,
              streamingStraggler = Core.Nothing}
instance Core.FromJSON Straggler where
        parseJSON
          = Core.withObject "Straggler"
              (\ o ->
                 Straggler Core.<$>
                   (o Core..:? "batchStraggler") Core.<*>
                     (o Core..:? "streamingStraggler"))
...
instance Core.FromJSON StragglerDebuggingInfo where
        parseJSON
          = Core.withObject "StragglerDebuggingInfo"
...
instance Core.FromJSON StragglerInfo where
        parseJSON
          = Core.withObject "StragglerInfo"
              (\ o ->
                 StragglerInfo Core.<$>
                   (o Core..:? "causes") Core.<*> (o Core..:? "startTime"))
...
instance Core.FromJSON StragglerInfo_Causes where
        parseJSON
          = Core.withObject "StragglerInfo_Causes"
...
newStragglerSummary 
    ::  StragglerSummary
newStragglerSummary
  = StragglerSummary{recentStragglers = Core.Nothing,
                     stragglerCauseCount = Core.Nothing,
                     totalStragglerCount = Core.Nothing}
instance Core.FromJSON StragglerSummary where
        parseJSON
          = Core.withObject "StragglerSummary"
              (\ o ->
                 StragglerSummary Core.<$>
                   (o Core..:? "recentStragglers") Core.<*>
                     (o Core..:? "stragglerCauseCount")
                     Core.<*>
                     (o Core..:? "totalStragglerCount" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("recentStragglers" Core..=) Core.<$> recentStragglers,
                  ...
                  ("totalStragglerCount" Core..=) Core.. Core.AsText Core.<$>
                    totalStragglerCount])
...
instance Core.FromJSON StragglerSummary_StragglerCauseCount where
        parseJSON
          = Core.withObject "StragglerSummary_StragglerCauseCount"
              (\ o ->
                 StragglerSummary_StragglerCauseCount Core.<$>
                   (Core.parseJSONObject o))
...
newStreamLocation 
    ::  StreamLocation
newStreamLocation
  = StreamLocation{customSourceLocation = Core.Nothing,
                   pubsubLocation = Core.Nothing, sideInputLocation = Core.Nothing,
...
newStreamingComputationConfig 
    ::  StreamingComputationConfig
newStreamingComputationConfig
  = StreamingComputationConfig{computationId = Core.Nothing,
                               instructions = Core.Nothing, stageName = Core.Nothing,
                               systemName = Core.Nothing,
          ...
          = Core.withObject "StreamingComputationConfig"
              (\ o ->
                 StreamingComputationConfig Core.<$>
                   (o Core..:? "computationId") Core.<*> (o Core..:? "instructions")
                     Core.<*> (o Core..:? "stageName")
                     Core.<*> (o Core..:? "systemName")
...
newStreamingComputationConfig_TransformUserNameToStateFamily
  additional
  = StreamingComputationConfig_TransformUserNameToStateFamily{additional
                                                                = additional}
instance Core.FromJSON
           StreamingComputationConfig_TransformUserNameToStateFamily
         where
        parseJSON
          = Core.withObject
              "StreamingComputationConfig_TransformUserNameToStateFamily"
              (\ o ->
                 StreamingComputationConfig_TransformUserNameToStateFamily Core.<$>
                   (Core.parseJSONObject o))
...
newStreamingComputationRanges 
    ::  StreamingComputationRanges
newStreamingComputationRanges
  = StreamingComputationRanges{computationId = Core.Nothing,
...
newStreamingComputationTask 
    ::  StreamingComputationTask
newStreamingComputationTask
  = StreamingComputationTask{computationRanges = Core.Nothing,
                             dataDisks = Core.Nothing, taskType = Core.Nothing}
          ...
          = Core.withObject "StreamingComputationTask"
              (\ o ->
                 StreamingComputationTask Core.<$>
                   (o Core..:? "computationRanges") Core.<*> (o Core..:? "dataDisks")
...
newStreamingConfigTask 
    ::  StreamingConfigTask
newStreamingConfigTask
  = StreamingConfigTask{commitStreamChunkSizeBytes = Core.Nothing,
              ...
              (\ o ->
                 StreamingConfigTask Core.<$>
                   (o Core..:? "commitStreamChunkSizeBytes" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "getDataStreamChunkSizeBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxWorkItemCommitBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "windmillServicePort" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON StreamingConfigTask where
        toJSON StreamingConfigTask{..}
          = Core.object
              (Core.catMaybes
                 [("commitStreamChunkSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    commitStreamChunkSizeBytes,
                  ("getDataStreamChunkSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    getDataStreamChunkSizeBytes,
                  ("maxWorkItemCommitBytes" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("userWorkerRunnerV1Settings" Core..=) Core.<$>
                    userWorkerRunnerV1Settings,
                  ("userWorkerRunnerV2Settings" Core..=) Core.<$>
                    userWorkerRunnerV2Settings,
                  ("windmillServiceEndpoint" Core..=) Core.<$>
                    windmillServiceEndpoint,
                  ("windmillServicePort" Core..=) Core.. Core.AsText Core.<$>
                    windmillServicePort])
...
newStreamingConfigTask_UserStepToStateFamilyNameMap additional
  = StreamingConfigTask_UserStepToStateFamilyNameMap{additional =
                                                       additional}
instance Core.FromJSON
           StreamingConfigTask_UserStepToStateFamilyNameMap
         where
        parseJSON
          = Core.withObject
              "StreamingConfigTask_UserStepToStateFamilyNameMap"
              (\ o ->
                 StreamingConfigTask_UserStepToStateFamilyNameMap Core.<$>
                   (Core.parseJSONObject o))
...
newStreamingOperationalLimits 
    ::  StreamingOperationalLimits
newStreamingOperationalLimits
  = StreamingOperationalLimits{maxBagElementBytes = Core.Nothing,
                               maxGlobalDataBytes = Core.Nothing, maxKeyBytes = Core.Nothing,
                               maxProductionOutputBytes = Core.Nothing,
                               maxSortedListElementBytes = Core.Nothing,
                               maxSourceStateBytes = Core.Nothing, maxTagBytes = Core.Nothing,
                               maxValueBytes = Core.Nothing}
instance Core.FromJSON StreamingOperationalLimits where
        parseJSON
          = Core.withObject "StreamingOperationalLimits"
              (\ o ->
                 StreamingOperationalLimits Core.<$>
                   (o Core..:? "maxBagElementBytes" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxGlobalDataBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxKeyBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxProductionOutputBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxSortedListElementBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxSourceStateBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxTagBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxValueBytes" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON StreamingOperationalLimits where
        toJSON StreamingOperationalLimits{..}
          = Core.object
              (Core.catMaybes
                 [("maxBagElementBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxBagElementBytes,
                  ("maxGlobalDataBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxGlobalDataBytes,
                  ("maxKeyBytes" Core..=) Core.. Core.AsText Core.<$> maxKeyBytes,
                  ("maxProductionOutputBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxProductionOutputBytes,
                  ("maxSortedListElementBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxSortedListElementBytes,
                  ("maxSourceStateBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxSourceStateBytes,
                  ("maxTagBytes" Core..=) Core.. Core.AsText Core.<$> maxTagBytes,
                  ("maxValueBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxValueBytes])
...
newStreamingScalingReport 
    ::  StreamingScalingReport
newStreamingScalingReport
  = StreamingScalingReport{activeBundleCount = Core.Nothing,
                           activeThreadCount = Core.Nothing,
                           maximumBundleCount = Core.Nothing, maximumBytes = Core.Nothing,
...
instance Core.FromJSON StreamingScalingReport where
        parseJSON
          = Core.withObject "StreamingScalingReport"
              (\ o ->
                 StreamingScalingReport Core.<$>
                   (o Core..:? "activeBundleCount") Core.<*>
                     (o Core..:? "activeThreadCount")
                     Core.<*> (o Core..:? "maximumBundleCount")
                     Core.<*>
                     (o Core..:? "maximumBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "maximumBytesCount")
                     Core.<*> (o Core..:? "maximumThreadCount")
                     Core.<*> (o Core..:? "outstandingBundleCount")
                     Core.<*>
                     (o Core..:? "outstandingBytes" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("activeBundleCount" Core..=) Core.<$> activeBundleCount,
                  ...
                  ("outstandingBytes" Core..=) Core.. Core.AsText Core.<$>
                    outstandingBytes,
...
instance Core.FromJSON StreamingScalingReportResponse where
        parseJSON
          = Core.withObject "StreamingScalingReportResponse"
              (\ o ->
                 StreamingScalingReportResponse Core.<$>
                   (o Core..:? "maximumThreadCount"))
...
newStreamingSetupTask 
    ::  StreamingSetupTask
newStreamingSetupTask
  = StreamingSetupTask{drain = Core.Nothing,
                       receiveWorkPort = Core.Nothing, snapshotConfig = Core.Nothing,
          ...
          = Core.withObject "StreamingSetupTask"
              (\ o ->
                 StreamingSetupTask Core.<$>
                   (o Core..:? "drain") Core.<*> (o Core..:? "receiveWorkPort")
...
newStreamingSideInputLocation 
    ::  StreamingSideInputLocation
newStreamingSideInputLocation
  = StreamingSideInputLocation{stateFamily = Core.Nothing,
                               tag = Core.Nothing}
          ...
          = Core.withObject "StreamingSideInputLocation"
              (\ o ->
                 StreamingSideInputLocation Core.<$>
                   (o Core..:? "stateFamily") Core.<*> (o Core..:? "tag"))
...
newStreamingStragglerInfo 
    ::  StreamingStragglerInfo
newStreamingStragglerInfo
  = StreamingStragglerInfo{dataWatermarkLag = Core.Nothing,
                           endTime = Core.Nothing, startTime = Core.Nothing,
                           systemWatermarkLag = Core.Nothing, workerName = Core.Nothing}
instance Core.FromJSON StreamingStragglerInfo where
        parseJSON
          = Core.withObject "StreamingStragglerInfo"
              (\ o ->
                 StreamingStragglerInfo Core.<$>
                   (o Core..:? "dataWatermarkLag") Core.<*> (o Core..:? "endTime")
                     Core.<*> (o Core..:? "startTime")
...
newStructuredMessage 
    ::  StructuredMessage
newStructuredMessage
  = StructuredMessage{messageKey = Core.Nothing,
                      messageText = Core.Nothing, parameters = Core.Nothing}
instance Core.FromJSON StructuredMessage where
        parseJSON
          = Core.withObject "StructuredMessage"
              (\ o ->
                 StructuredMessage Core.<$>
                   (o Core..:? "messageKey") Core.<*> (o Core..:? "messageText")
                     Core.<*> (o Core..:? "parameters"))
...
newTaskRunnerSettings 
    ::  TaskRunnerSettings
newTaskRunnerSettings
  = TaskRunnerSettings{alsologtostderr = Core.Nothing,
                       baseTaskDir = Core.Nothing, baseUrl = Core.Nothing,
                       commandlinesFileName = Core.Nothing,
                       continueOnException = Core.Nothing,
                       dataflowApiVersion = Core.Nothing, harnessCommand = Core.Nothing,
                       languageHint = Core.Nothing, logDir = Core.Nothing,
                       logToSerialconsole = Core.Nothing,
                       logUploadLocation = Core.Nothing, oauthScopes = Core.Nothing,
                       parallelWorkerSettings = Core.Nothing,
                       streamingWorkerMainClass = Core.Nothing, taskGroup = Core.Nothing,
                       taskUser = Core.Nothing, tempStoragePrefix = Core.Nothing,
                       vmId = Core.Nothing, workflowFileName = Core.Nothing}
instance Core.FromJSON TaskRunnerSettings where
        parseJSON
          = Core.withObject "TaskRunnerSettings"
              (\ o ->
                 TaskRunnerSettings Core.<$>
                   (o Core..:? "alsologtostderr") Core.<*> (o Core..:? "baseTaskDir")
                     Core.<*> (o Core..:? "baseUrl")
...
newTemplateMetadata 
    ::  TemplateMetadata
newTemplateMetadata
  = TemplateMetadata{defaultStreamingMode = Core.Nothing,
                     description = Core.Nothing, name = Core.Nothing,
                     parameters = Core.Nothing, streaming = Core.Nothing,
                     supportsAtLeastOnce = Core.Nothing,
                     supportsExactlyOnce = Core.Nothing, yamlDefinition = Core.Nothing}
instance Core.FromJSON TemplateMetadata where
        parseJSON
          = Core.withObject "TemplateMetadata"
              (\ o ->
                 TemplateMetadata Core.<$>
                   (o Core..:? "defaultStreamingMode") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "parameters")
...
newTopologyConfig 
    ::  TopologyConfig
newTopologyConfig
  = TopologyConfig{computations = Core.Nothing,
...
instance Core.FromJSON TopologyConfig where
        parseJSON
          = Core.withObject "TopologyConfig"
              (\ o ->
                 TopologyConfig Core.<$>
                   (o Core..:? "computations") Core.<*>
                     (o Core..:? "dataDiskAssignments")
...
newTopologyConfig_UserStageToComputationNameMap additional
  = TopologyConfig_UserStageToComputationNameMap{additional =
                                                   additional}
instance Core.FromJSON TopologyConfig_UserStageToComputationNameMap
         where
        parseJSON
          = Core.withObject "TopologyConfig_UserStageToComputationNameMap"
              (\ o ->
                 TopologyConfig_UserStageToComputationNameMap Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON TopologyConfig_UserStageToComputationNameMap
         where
...
newTransformSummary 
    ::  TransformSummary
newTransformSummary
  = TransformSummary{displayData = Core.Nothing, id = Core.Nothing,
                     inputCollectionName = Core.Nothing, kind = Core.Nothing,
                     name = Core.Nothing, outputCollectionName = Core.Nothing}
instance Core.FromJSON TransformSummary where
        parseJSON
          = Core.withObject "TransformSummary"
              (\ o ->
                 TransformSummary Core.<$>
                   (o Core..:? "displayData") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "inputCollectionName")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "name")
...
newWorkItem 
    ::  WorkItem
newWorkItem
  = WorkItem{configuration = Core.Nothing, id = Core.Nothing,
             initialReportIndex = Core.Nothing, jobId = Core.Nothing,
             leaseExpireTime = Core.Nothing, mapTask = Core.Nothing,
             packages = Core.Nothing, projectId = Core.Nothing,
             reportStatusInterval = Core.Nothing, seqMapTask = Core.Nothing,
             shellTask = Core.Nothing, sourceOperationTask = Core.Nothing,
              ...
              (\ o ->
                 WorkItem Core.<$>
                   (o Core..:? "configuration") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "initialReportIndex" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "jobId")
          ...
          = Core.object
              (Core.catMaybes
                 [("configuration" Core..=) Core.<$> configuration,
                  ...
                  ("initialReportIndex" Core..=) Core.. Core.AsText Core.<$>
                    initialReportIndex,
...
newWorkItemDetails 
    ::  WorkItemDetails
newWorkItemDetails
  = WorkItemDetails{attemptId = Core.Nothing, endTime = Core.Nothing,
                    metrics = Core.Nothing, progress = Core.Nothing,
                    startTime = Core.Nothing, state = Core.Nothing,
                    stragglerInfo = Core.Nothing, taskId = Core.Nothing}
instance Core.FromJSON WorkItemDetails where
        parseJSON
          = Core.withObject "WorkItemDetails"
              (\ o ->
                 WorkItemDetails Core.<$>
                   (o Core..:? "attemptId") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "metrics")
...
newWorkItemServiceState 
    ::  WorkItemServiceState
newWorkItemServiceState
  = WorkItemServiceState{completeWorkStatus = Core.Nothing,
                         harnessData = Core.Nothing, hotKeyDetection = Core.Nothing,
                         leaseExpireTime = Core.Nothing, metricShortId = Core.Nothing,
                         nextReportIndex = Core.Nothing,
                         reportStatusInterval = Core.Nothing, splitRequest = Core.Nothing,
              ...
              (\ o ->
                 WorkItemServiceState Core.<$>
                   (o Core..:? "completeWorkStatus") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "nextReportIndex" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "reportStatusInterval")
          ...
          = Core.object
              (Core.catMaybes
                 [("completeWorkStatus" Core..=) Core.<$> completeWorkStatus,
                  ...
                  ("nextReportIndex" Core..=) Core.. Core.AsText Core.<$>
                    nextReportIndex,
                  ("reportStatusInterval" Core..=) Core.<$> reportStatusInterval,
...
newWorkItemStatus 
    ::  WorkItemStatus
newWorkItemStatus
  = WorkItemStatus{completed = Core.Nothing,
                   counterUpdates = Core.Nothing, dynamicSourceSplit = Core.Nothing,
                   errors = Core.Nothing, metricUpdates = Core.Nothing,
                   progress = Core.Nothing, reportIndex = Core.Nothing,
                   reportedProgress = Core.Nothing,
                   requestedLeaseDuration = Core.Nothing, sourceFork = Core.Nothing,
...
instance Core.FromJSON WorkItemStatus where
        parseJSON
          = Core.withObject "WorkItemStatus"
              (\ o ->
                 WorkItemStatus Core.<$>
                   (o Core..:? "completed") Core.<*> (o Core..:? "counterUpdates")
                     Core.<*> (o Core..:? "dynamicSourceSplit")
                     Core.<*> (o Core..:? "errors")
                     Core.<*> (o Core..:? "metricUpdates")
                     Core.<*> (o Core..:? "progress")
                     Core.<*>
                     (o Core..:? "reportIndex" Core.<&> Core.fmap Core.fromAsText)
...
newWorkerDetails 
    ::  WorkerDetails
newWorkerDetails
  = WorkerDetails{workItems = Core.Nothing,
...
instance Core.FromJSON WorkerDetails where
        parseJSON
          = Core.withObject "WorkerDetails"
              (\ o ->
                 WorkerDetails Core.<$>
                   (o Core..:? "workItems") Core.<*> (o Core..:? "workerName"))
...
newWorkerHealthReport 
    ::  WorkerHealthReport
newWorkerHealthReport
  = WorkerHealthReport{msg = Core.Nothing, pods = Core.Nothing,
                       reportInterval = Core.Nothing, vmBrokenCode = Core.Nothing,
                       vmIsBroken = Core.Nothing, vmIsHealthy = Core.Nothing,
          ...
          = Core.withObject "WorkerHealthReport"
              (\ o ->
                 WorkerHealthReport Core.<$>
                   (o Core..:? "msg") Core.<*> (o Core..:? "pods") Core.<*>
...
instance Core.ToJSON WorkerHealthReport where
        toJSON WorkerHealthReport{..}
          = Core.object
              (Core.catMaybes
                 [("msg" Core..=) Core.<$> msg, ("pods" Core..=) Core.<$> pods,
...
newWorkerLifecycleEvent 
    ::  WorkerLifecycleEvent
newWorkerLifecycleEvent
  = WorkerLifecycleEvent{containerStartTime = Core.Nothing,
                         event = Core.Nothing, metadata = Core.Nothing}
instance Core.FromJSON WorkerLifecycleEvent where
        parseJSON
          = Core.withObject "WorkerLifecycleEvent"
              (\ o ->
                 WorkerLifecycleEvent Core.<$>
                   (o Core..:? "containerStartTime") Core.<*> (o Core..:? "event")
                     Core.<*> (o Core..:? "metadata"))
...
newWorkerMessage 
    ::  WorkerMessage
newWorkerMessage
  = WorkerMessage{dataSamplingReport = Core.Nothing,
                  labels = Core.Nothing, perWorkerMetrics = Core.Nothing,
                  streamingScalingReport = Core.Nothing, time = Core.Nothing,
                  workerHealthReport = Core.Nothing,
                  workerLifecycleEvent = Core.Nothing,
                  workerMessageCode = Core.Nothing, workerMetrics = Core.Nothing,
...
instance Core.FromJSON WorkerMessage where
        parseJSON
          = Core.withObject "WorkerMessage"
              (\ o ->
                 WorkerMessage Core.<$>
                   (o Core..:? "dataSamplingReport") Core.<*> (o Core..:? "labels")
          ...
          = Core.object
              (Core.catMaybes
                 [("dataSamplingReport" Core..=) Core.<$> dataSamplingReport,
                  ...
                  ("workerThreadScalingReport" Core..=) Core.<$>
                    workerThreadScalingReport])
          ...
          = Core.withObject "WorkerMessageCode"
              (\ o ->
                 WorkerMessageCode Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "parameters"))
...
newWorkerMessageResponse 
    ::  WorkerMessageResponse
newWorkerMessageResponse
  = WorkerMessageResponse{streamingScalingReportResponse =
                            Core.Nothing,
          ...
          = Core.withObject "WorkerMessageResponse"
              (\ o ->
                 WorkerMessageResponse Core.<$>
                   (o Core..:? "streamingScalingReportResponse") Core.<*>
                     (o Core..:? "workerHealthReportResponse")
...
instance Core.ToJSON WorkerMessageResponse where
        toJSON WorkerMessageResponse{..}
          = Core.object
              (Core.catMaybes
                 [("streamingScalingReportResponse" Core..=) Core.<$>
                    streamingScalingReportResponse,
                  ...
                  ("workerShutdownNoticeResponse" Core..=) Core.<$>
                    workerShutdownNoticeResponse,
                  ("workerThreadScalingReportResponse" Core..=) Core.<$>
                    workerThreadScalingReportResponse])
...
newWorkerPool 
    ::  WorkerPool
newWorkerPool
  = WorkerPool{autoscalingSettings = Core.Nothing,
               dataDisks = Core.Nothing, defaultPackageSet = Core.Nothing,
               diskSizeGb = Core.Nothing, diskSourceImage = Core.Nothing,
               diskType = Core.Nothing, ipConfiguration = Core.Nothing,
               kind = Core.Nothing, machineType = Core.Nothing,
               metadata = Core.Nothing, network = Core.Nothing,
               numThreadsPerWorker = Core.Nothing, numWorkers = Core.Nothing,
               onHostMaintenance = Core.Nothing, packages = Core.Nothing,
               poolArgs = Core.Nothing, sdkHarnessContainerImages = Core.Nothing,
               subnetwork = Core.Nothing, taskrunnerSettings = Core.Nothing,
               teardownPolicy = Core.Nothing,
               workerHarnessContainerImage = Core.Nothing, zone = Core.Nothing}
...
newWorkerSettings 
    ::  WorkerSettings
newWorkerSettings
  = WorkerSettings{baseUrl = Core.Nothing,
                   reportingEnabled = Core.Nothing, servicePath = Core.Nothing,
                   shuffleServicePath = Core.Nothing,
                   tempStoragePrefix = Core.Nothing, workerId = Core.Nothing}
instance Core.FromJSON WorkerSettings where
        parseJSON
          = Core.withObject "WorkerSettings"
              (\ o ->
                 WorkerSettings Core.<$>
                   (o Core..:? "baseUrl") Core.<*> (o Core..:? "reportingEnabled")
...
instance Core.FromJSON WorkerThreadScalingReport where
        parseJSON
          = Core.withObject "WorkerThreadScalingReport"
              (\ o ->
                 WorkerThreadScalingReport Core.<$>
                   (o Core..:? "currentThreadCount"))
