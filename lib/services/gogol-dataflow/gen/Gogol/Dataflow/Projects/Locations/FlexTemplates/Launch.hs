                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] LaunchFlexTemplateRequest
                               Core.:>
                               Core.Post '[Core.JSON] LaunchFlexTemplateResponse
...
newDataflowProjectsLocationsFlexTemplatesLaunch 
    ...
    -> DataflowProjectsLocationsFlexTemplatesLaunch
newDataflowProjectsLocationsFlexTemplatesLaunch location payload projectId =
  DataflowProjectsLocationsFlexTemplatesLaunch
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           DataflowProjectsLocationsFlexTemplatesLaunch
         where
        type Rs DataflowProjectsLocationsFlexTemplatesLaunch
