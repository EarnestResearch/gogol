             ...
             Core.Capture "location" Core.Text Core.:>
               "jobs" Core.:>
                 Core.Capture "jobId" Core.Text Core.:>
                   "stages" Core.:>
                     Core.Capture "stageId" Core.Text Core.:>
...
newDataflowProjectsLocationsJobsStagesGetExecutionDetails 
    ...
    -> DataflowProjectsLocationsJobsStagesGetExecutionDetails
newDataflowProjectsLocationsJobsStagesGetExecutionDetails jobId location projectId stageId =
  DataflowProjectsLocationsJobsStagesGetExecutionDetails
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient
          DataflowProjectsLocationsJobsStagesGetExecutionDetails{..}
          = go projectId location jobId stageId xgafv
              accessToken
              callback
              endTime
              pageSize
