                       ...
                       Core.QueryParam "replaceJobId" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "view" ProjectsLocationsJobsCreateView Core.:>
...
newDataflowProjectsLocationsJobsCreate location payload projectId
  = DataflowProjectsLocationsJobsCreate{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        location = location, payload = payload,
                                        projectId = projectId, replaceJobId = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                        view = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsLocationsJobsCreate
         where
        type Rs DataflowProjectsLocationsJobsCreate = Job
        type Scopes DataflowProjectsLocationsJobsCreate =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient DataflowProjectsLocationsJobsCreate{..}
          = go projectId location xgafv accessToken callback replaceJobId
              uploadType
              uploadProtocol
              view
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataflowProjectsLocationsJobsCreateResource)
                      Core.mempty
