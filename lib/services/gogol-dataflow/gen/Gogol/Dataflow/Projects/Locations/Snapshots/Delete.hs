...
-- |
-- Module      : Gogol.Dataflow.Projects.Locations.Snapshots.Delete
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Delete '[Core.JSON] DeleteSnapshotResponse
...
instance Core.GoogleRequest
           DataflowProjectsLocationsSnapshotsDelete
         where
        type Rs DataflowProjectsLocationsSnapshotsDelete =
             DeleteSnapshotResponse
        type Scopes DataflowProjectsLocationsSnapshotsDelete
             =
             '[CloudPlatform'FullControl, Compute'FullControl,
               Compute'Readonly, Userinfo'Email]
        requestClient
          DataflowProjectsLocationsSnapshotsDelete{..}
          = go projectId location snapshotId xgafv accessToken
              callback
              uploadType
              uploadProtocol
