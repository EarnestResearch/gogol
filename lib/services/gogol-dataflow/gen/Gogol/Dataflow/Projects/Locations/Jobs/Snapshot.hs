         ...
         Core.Capture "projectId" Core.Text Core.:>
           "locations" Core.:>
             Core.Capture "location" Core.Text Core.:>
               "jobs" Core.:>
                 Core.CaptureMode "jobId" "snapshot" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] SnapshotJobRequest
...
instance Core.GoogleRequest
           DataflowProjectsLocationsJobsSnapshot
         where
        type Rs DataflowProjectsLocationsJobsSnapshot =
             Snapshot
        type Scopes DataflowProjectsLocationsJobsSnapshot =
