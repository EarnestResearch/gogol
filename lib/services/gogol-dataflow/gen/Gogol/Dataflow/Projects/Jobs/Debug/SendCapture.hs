                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] SendDebugCaptureRequest
                                 Core.:>
                                 Core.Post '[Core.JSON] SendDebugCaptureResponse
...
instance Core.GoogleRequest
           DataflowProjectsJobsDebugSendCapture
         where
        type Rs DataflowProjectsJobsDebugSendCapture =
             SendDebugCaptureResponse
        type Scopes DataflowProjectsJobsDebugSendCapture =
