                     ...
                     Core.QueryParam "location" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "view" ProjectsJobsGetView Core.:>
...
instance Core.GoogleRequest DataflowProjectsJobsGet
         where
        type Rs DataflowProjectsJobsGet = Job
        type Scopes DataflowProjectsJobsGet =
        ...
        requestClient DataflowProjectsJobsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataflowProjectsJobsGetResource)
                      Core.mempty
