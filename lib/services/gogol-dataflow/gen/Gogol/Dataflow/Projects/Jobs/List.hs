             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "filter" ProjectsJobsListFilter
                     Core.:>
                           ...
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text
                                 Core.:>
                                 Core.QueryParam "view" ProjectsJobsListView
                                   Core.:>
...
instance Core.GoogleRequest DataflowProjectsJobsList
         where
        type Rs DataflowProjectsJobsList = ListJobsResponse
        type Scopes DataflowProjectsJobsList =
