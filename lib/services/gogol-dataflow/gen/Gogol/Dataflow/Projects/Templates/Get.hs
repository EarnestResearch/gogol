                     ...
                     Core.QueryParam "location" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "view" ProjectsTemplatesGetView
                             Core.:>
...
instance Core.GoogleRequest
           DataflowProjectsTemplatesGet
         where
        type Rs DataflowProjectsTemplatesGet =
             GetTemplateResponse
        type Scopes DataflowProjectsTemplatesGet =
             '[CloudPlatform'FullControl, Compute'FullControl,
               Compute'Readonly, Userinfo'Email]
        requestClient DataflowProjectsTemplatesGet{..}
          = go projectId xgafv accessToken callback gcsPath
              location
              uploadType
              uploadProtocol
              view
