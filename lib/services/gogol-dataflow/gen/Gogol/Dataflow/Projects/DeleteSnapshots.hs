               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "location" Core.Text Core.:>
                     Core.QueryParam "snapshotId" Core.Text Core.:>
...
instance Core.GoogleRequest
           DataflowProjectsDeleteSnapshots
         where
        type Rs DataflowProjectsDeleteSnapshots =
             DeleteSnapshotResponse
        type Scopes DataflowProjectsDeleteSnapshots =
             '[CloudPlatform'FullControl, Compute'FullControl,
               Compute'Readonly, Userinfo'Email]
        requestClient DataflowProjectsDeleteSnapshots{..}
          = go projectId xgafv accessToken callback location
              snapshotId
              uploadType
              uploadProtocol
