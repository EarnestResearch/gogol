...
type ScriptScriptsRunResource =
     "v1" Core.:>
       "scripts" Core.:>
         Core.CaptureMode "scriptId" "run" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] ExecutionRequest Core.:>
...
instance Core.GoogleRequest ScriptScriptsRun where
        ...
        type Scopes ScriptScriptsRun =
             '[Gmail'FullControl, Calendar'Feeds'FullControl,
               M8'Feeds'FullControl, Admin'Directory'Group,
               Admin'Directory'User, Documents'FullControl,
               Drive'FullControl, Forms'FullControl,
               Forms'Currentonly, Groups'FullControl,
               Spreadsheets'FullControl, Userinfo'Email]
