...
instance Core.FromJSON Content where
        parseJSON
          = Core.withObject "Content"
              (\ o ->
                 Content Core.<$>
                   (o Core..:? "files") Core.<*> (o Core..:? "scriptId"))
...
newCreateProjectRequest 
    ::  CreateProjectRequest
newCreateProjectRequest
  = CreateProjectRequest{parentId = Core.Nothing,
                         title = Core.Nothing}
instance Core.FromJSON CreateProjectRequest where
        parseJSON
          = Core.withObject "CreateProjectRequest"
              (\ o ->
                 CreateProjectRequest Core.<$>
                   (o Core..:? "parentId") Core.<*> (o Core..:? "title"))
...
newDeployment 
    ::  Deployment
newDeployment
  = Deployment{deploymentConfig = Core.Nothing,
               deploymentId = Core.Nothing, entryPoints = Core.Nothing,
...
instance Core.ToJSON Deployment where
        toJSON Deployment{..}
          = Core.object
              (Core.catMaybes
                 [("deploymentConfig" Core..=) Core.<$> deploymentConfig,
...
newDeploymentConfig 
    ::  DeploymentConfig
newDeploymentConfig
  = DeploymentConfig{description = Core.Nothing,
                     manifestFileName = Core.Nothing, scriptId = Core.Nothing,
                     versionNumber = Core.Nothing}
instance Core.FromJSON DeploymentConfig where
        parseJSON
          = Core.withObject "DeploymentConfig"
              (\ o ->
                 DeploymentConfig Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "manifestFileName")
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("manifestFileName" Core..=) Core.<$> manifestFileName,
                  ("scriptId" Core..=) Core.<$> scriptId,
...
newEntryPoint 
    ::  EntryPoint
newEntryPoint
  = EntryPoint{addOn = Core.Nothing, entryPointType = Core.Nothing,
               executionApi = Core.Nothing, webApp = Core.Nothing}
instance Core.FromJSON EntryPoint where
        parseJSON
          = Core.withObject "EntryPoint"
              (\ o ->
                 EntryPoint Core.<$>
                   (o Core..:? "addOn") Core.<*> (o Core..:? "entryPointType")
...
newExecutionError 
    ::  ExecutionError
newExecutionError
  = ExecutionError{errorMessage = Core.Nothing,
                   errorType = Core.Nothing, scriptStackTraceElements = Core.Nothing}
instance Core.FromJSON ExecutionError where
        parseJSON
          = Core.withObject "ExecutionError"
              (\ o ->
                 ExecutionError Core.<$>
                   (o Core..:? "errorMessage") Core.<*> (o Core..:? "errorType")
          ...
          = Core.object
              (Core.catMaybes
                 [("errorMessage" Core..=) Core.<$> errorMessage,
                  ...
                  ("scriptStackTraceElements" Core..=) Core.<$>
...
newExecutionRequest 
    ::  ExecutionRequest
newExecutionRequest
  = ExecutionRequest{devMode = Core.Nothing, function = Core.Nothing,
                     parameters = Core.Nothing, sessionState = Core.Nothing}
instance Core.FromJSON ExecutionRequest where
        parseJSON
          = Core.withObject "ExecutionRequest"
              (\ o ->
                 ExecutionRequest Core.<$>
                   (o Core..:? "devMode") Core.<*> (o Core..:? "function") Core.<*>
                     (o Core..:? "parameters")
...
instance Core.FromJSON ExecutionResponse where
        parseJSON
          = Core.withObject "ExecutionResponse"
              (\ o -> ExecutionResponse Core.<$> (o Core..:? "result"))
...
newFile 
    ::  File
newFile
  = File{createTime = Core.Nothing, functionSet = Core.Nothing,
         lastModifyUser = Core.Nothing, name = Core.Nothing,
         source = Core.Nothing, type' = Core.Nothing,
         updateTime = Core.Nothing}
instance Core.FromJSON File where
        parseJSON
          = Core.withObject "File"
              (\ o ->
                 File Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "functionSet")
...
newGoogleAppsScriptTypeAddOnEntryPoint 
    :: 
                                       GoogleAppsScriptTypeAddOnEntryPoint
newGoogleAppsScriptTypeAddOnEntryPoint
  = GoogleAppsScriptTypeAddOnEntryPoint{addOnType = Core.Nothing,
                                        description = Core.Nothing, helpUrl = Core.Nothing,
                                        postInstallTipUrl = Core.Nothing,
                                        reportIssueUrl = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON GoogleAppsScriptTypeAddOnEntryPoint where
        parseJSON
          = Core.withObject "GoogleAppsScriptTypeAddOnEntryPoint"
              (\ o ->
                 GoogleAppsScriptTypeAddOnEntryPoint Core.<$>
                   (o Core..:? "addOnType") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "helpUrl")
                     Core.<*> (o Core..:? "postInstallTipUrl")
                     Core.<*> (o Core..:? "reportIssueUrl")
                     Core.<*> (o Core..:? "title"))

instance Core.ToJSON GoogleAppsScriptTypeAddOnEntryPoint where
          ...
          = Core.object
              (Core.catMaybes
                 [("addOnType" Core..=) Core.<$> addOnType,
                  ...
                  ("postInstallTipUrl" Core..=) Core.<$> postInstallTipUrl,
...
instance Core.FromJSON GoogleAppsScriptTypeExecutionApiConfig where
        parseJSON
          = Core.withObject "GoogleAppsScriptTypeExecutionApiConfig"
              (\ o ->
                 GoogleAppsScriptTypeExecutionApiConfig Core.<$>
                   (o Core..:? "access"))

instance Core.ToJSON GoogleAppsScriptTypeExecutionApiConfig where
        toJSON GoogleAppsScriptTypeExecutionApiConfig{..}
          = Core.object (Core.catMaybes [("access" Core..=) Core.<$> access])
...
newGoogleAppsScriptTypeExecutionApiEntryPoint 
    :: 
                                              GoogleAppsScriptTypeExecutionApiEntryPoint
newGoogleAppsScriptTypeExecutionApiEntryPoint
  = GoogleAppsScriptTypeExecutionApiEntryPoint{entryPointConfig =
                                                 Core.Nothing}
instance Core.FromJSON GoogleAppsScriptTypeExecutionApiEntryPoint
         where
        parseJSON
          = Core.withObject "GoogleAppsScriptTypeExecutionApiEntryPoint"
              (\ o ->
                 GoogleAppsScriptTypeExecutionApiEntryPoint Core.<$>
                   (o Core..:? "entryPointConfig"))

instance Core.ToJSON GoogleAppsScriptTypeExecutionApiEntryPoint
         where
        toJSON GoogleAppsScriptTypeExecutionApiEntryPoint{..}
          = Core.object
              (Core.catMaybes
                 [("entryPointConfig" Core..=) Core.<$> entryPointConfig])
...
newGoogleAppsScriptTypeFunction 
    ::  GoogleAppsScriptTypeFunction
newGoogleAppsScriptTypeFunction
  = GoogleAppsScriptTypeFunction{name = Core.Nothing,
                                 parameters = Core.Nothing}
instance Core.FromJSON GoogleAppsScriptTypeFunction where
        parseJSON
          = Core.withObject "GoogleAppsScriptTypeFunction"
              (\ o ->
                 GoogleAppsScriptTypeFunction Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "parameters"))
...
instance Core.FromJSON GoogleAppsScriptTypeFunctionSet where
        parseJSON
          = Core.withObject "GoogleAppsScriptTypeFunctionSet"
              (\ o ->
                 GoogleAppsScriptTypeFunctionSet Core.<$> (o Core..:? "values"))
...
data GoogleAppsScriptTypeProcess = GoogleAppsScriptTypeProcess
    ...
    , runtimeVersion :: (Core.Maybe GoogleAppsScriptTypeProcess_RuntimeVersion)
...
newGoogleAppsScriptTypeProcess 
    ::  GoogleAppsScriptTypeProcess
newGoogleAppsScriptTypeProcess
  = GoogleAppsScriptTypeProcess{duration = Core.Nothing,
                                functionName = Core.Nothing, processStatus = Core.Nothing,
                                processType = Core.Nothing, projectName = Core.Nothing,
                                runtimeVersion = Core.Nothing, startTime = Core.Nothing,
                                userAccessLevel = Core.Nothing}
instance Core.FromJSON GoogleAppsScriptTypeProcess where
        parseJSON
          = Core.withObject "GoogleAppsScriptTypeProcess"
              (\ o ->
                 GoogleAppsScriptTypeProcess Core.<$>
                   (o Core..:? "duration") Core.<*> (o Core..:? "functionName")
          ...
          = Core.object
              (Core.catMaybes
                 [("duration" Core..=) Core.<$> duration,
                  ...
                  ("userAccessLevel" Core..=) Core.<$> userAccessLevel])
...
newGoogleAppsScriptTypeUser 
    ::  GoogleAppsScriptTypeUser
newGoogleAppsScriptTypeUser
  = GoogleAppsScriptTypeUser{domain = Core.Nothing,
                             email = Core.Nothing, name = Core.Nothing, photoUrl = Core.Nothing}
instance Core.FromJSON GoogleAppsScriptTypeUser where
        parseJSON
          = Core.withObject "GoogleAppsScriptTypeUser"
              (\ o ->
                 GoogleAppsScriptTypeUser Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "email") Core.<*>
                     (o Core..:? "name")
...
newGoogleAppsScriptTypeWebAppConfig 
    :: 
                                    GoogleAppsScriptTypeWebAppConfig
newGoogleAppsScriptTypeWebAppConfig
  = GoogleAppsScriptTypeWebAppConfig{access = Core.Nothing,
                                     executeAs = Core.Nothing}
instance Core.FromJSON GoogleAppsScriptTypeWebAppConfig where
        parseJSON
          = Core.withObject "GoogleAppsScriptTypeWebAppConfig"
              (\ o ->
                 GoogleAppsScriptTypeWebAppConfig Core.<$>
                   (o Core..:? "access") Core.<*> (o Core..:? "executeAs"))
...
newGoogleAppsScriptTypeWebAppEntryPoint 
    :: 
                                        GoogleAppsScriptTypeWebAppEntryPoint
newGoogleAppsScriptTypeWebAppEntryPoint
  = GoogleAppsScriptTypeWebAppEntryPoint{entryPointConfig =
                                           Core.Nothing,
                                         url = Core.Nothing}
instance Core.FromJSON GoogleAppsScriptTypeWebAppEntryPoint where
        parseJSON
          = Core.withObject "GoogleAppsScriptTypeWebAppEntryPoint"
              (\ o ->
                 GoogleAppsScriptTypeWebAppEntryPoint Core.<$>
                   (o Core..:? "entryPointConfig") Core.<*> (o Core..:? "url"))

instance Core.ToJSON GoogleAppsScriptTypeWebAppEntryPoint where
...
instance Core.FromJSON ListDeploymentsResponse where
        parseJSON
          = Core.withObject "ListDeploymentsResponse"
              (\ o ->
...
newListScriptProcessesResponse 
    ::  ListScriptProcessesResponse
newListScriptProcessesResponse
  = ListScriptProcessesResponse{nextPageToken = Core.Nothing,
                                processes = Core.Nothing}
instance Core.FromJSON ListScriptProcessesResponse where
        parseJSON
          = Core.withObject "ListScriptProcessesResponse"
              (\ o ->
                 ListScriptProcessesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "processes"))
...
newListUserProcessesResponse 
    ::  ListUserProcessesResponse
newListUserProcessesResponse
  = ListUserProcessesResponse{nextPageToken = Core.Nothing,
                              processes = Core.Nothing}
instance Core.FromJSON ListUserProcessesResponse where
        parseJSON
          = Core.withObject "ListUserProcessesResponse"
              (\ o ->
                 ListUserProcessesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "processes"))
...
newMetrics 
    ::  Metrics
newMetrics
  = Metrics{activeUsers = Core.Nothing,
            failedExecutions = Core.Nothing, totalExecutions = Core.Nothing}
instance Core.FromJSON Metrics where
        parseJSON
          = Core.withObject "Metrics"
              (\ o ->
                 Metrics Core.<$>
                   (o Core..:? "activeUsers") Core.<*> (o Core..:? "failedExecutions")
          ...
          = Core.object
              (Core.catMaybes
                 [("activeUsers" Core..=) Core.<$> activeUsers,
                  ("failedExecutions" Core..=) Core.<$> failedExecutions,
                  ("totalExecutions" Core..=) Core.<$> totalExecutions])
...
newMetricsValue 
    ::  MetricsValue
newMetricsValue
  = MetricsValue{endTime = Core.Nothing, startTime = Core.Nothing,
                 value = Core.Nothing}
instance Core.FromJSON MetricsValue where
        parseJSON
          = Core.withObject "MetricsValue"
              (\ o ->
                 MetricsValue Core.<$>
...
newProject 
    ::  Project
newProject
  = Project{createTime = Core.Nothing, creator = Core.Nothing,
            lastModifyUser = Core.Nothing, parentId = Core.Nothing,
            scriptId = Core.Nothing, title = Core.Nothing,
            updateTime = Core.Nothing}
...
newScriptStackTraceElement 
    ::  ScriptStackTraceElement
newScriptStackTraceElement
  = ScriptStackTraceElement{function = Core.Nothing,
                            lineNumber = Core.Nothing}
instance Core.FromJSON ScriptStackTraceElement where
        parseJSON
          = Core.withObject "ScriptStackTraceElement"
              (\ o ->
                 ScriptStackTraceElement Core.<$>
                   (o Core..:? "function") Core.<*> (o Core..:? "lineNumber"))
...
instance Core.FromJSON UpdateDeploymentRequest where
        parseJSON
          = Core.withObject "UpdateDeploymentRequest"
              (\ o ->
                 UpdateDeploymentRequest Core.<$> (o Core..:? "deploymentConfig"))
...
newVersion 
    ::  Version
newVersion
  = Version{createTime = Core.Nothing, description = Core.Nothing,
            scriptId = Core.Nothing, versionNumber = Core.Nothing}
