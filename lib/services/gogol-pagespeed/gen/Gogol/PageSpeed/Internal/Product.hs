...
instance Core.FromJSON AuditRefs where
        parseJSON
          = Core.withObject "AuditRefs"
              (\ o ->
                 AuditRefs Core.<$>
                   (o Core..:? "acronym") Core.<*> (o Core..:? "group")
                     Core.<*> (o Core..:? "id")
...
instance Core.FromJSON Categories where
        parseJSON
          = Core.withObject "Categories"
              (\ o ->
                 Categories Core.<$>
                   (o Core..:? "accessibility") Core.<*>
                     (o Core..:? "best-practices")
...
instance Core.FromJSON CategoryGroupV5 where
        parseJSON
          = Core.withObject "CategoryGroupV5"
              (\ o ->
                 CategoryGroupV5 Core.<$>
...
instance Core.FromJSON ConfigSettings where
        parseJSON
          = Core.withObject "ConfigSettings"
              (\ o ->
                 ConfigSettings Core.<$>
                   (o Core..:? "channel") Core.<*>
                     (o Core..:? "emulatedFormFactor")
...
instance Core.FromJSON Environment_Credits where
        parseJSON
          = Core.withObject "Environment_Credits"
              (\ o ->
                 Environment_Credits Core.<$>
...
instance Core.FromJSON I18n where
        parseJSON
          = Core.withObject "I18n"
              (\ o ->
                 I18n Core.<$>
                   (o Core..:? "rendererFormattedStrings"))

instance Core.ToJSON I18n where
        toJSON I18n{..}
          = Core.object
              (Core.catMaybes
                 [("rendererFormattedStrings" Core..=) Core.<$>
                    rendererFormattedStrings])
...
instance Core.FromJSON LighthouseAuditResultV5 where
        parseJSON
          = Core.withObject "LighthouseAuditResultV5"
              (\ o ->
                 LighthouseAuditResultV5 Core.<$>
                   (o Core..:? "description") Core.<*>
                     (o Core..:? "details")
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "LighthouseAuditResultV5_Details"
              (\ o ->
                 LighthouseAuditResultV5_Details Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON LighthouseAuditResultV5_Details
         where
...
instance Core.FromJSON LighthouseCategoryV5 where
        parseJSON
          = Core.withObject "LighthouseCategoryV5"
              (\ o ->
                 LighthouseCategoryV5 Core.<$>
                   (o Core..:? "auditRefs") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "id")
...
instance Core.FromJSON LighthouseResultV5 where
        parseJSON
          = Core.withObject "LighthouseResultV5"
              (\ o ->
                 LighthouseResultV5 Core.<$>
                   (o Core..:? "audits") Core.<*>
                     (o Core..:? "categories")
          ...
          = Core.object
              (Core.catMaybes
                 [("audits" Core..=) Core.<$> audits,
                  ...
                  ("finalDisplayedUrl" Core..=) Core.<$>
                    finalDisplayedUrl,
                  ("finalUrl" Core..=) Core.<$> finalUrl,
                  ("fullPageScreenshot" Core..=) Core.<$>
                    fullPageScreenshot,
                  ("i18n" Core..=) Core.<$> i18n,
                  ("lighthouseVersion" Core..=) Core.<$>
                    lighthouseVersion,
...
instance Core.FromJSON LighthouseResultV5_Audits
         where
        parseJSON
          = Core.withObject "LighthouseResultV5_Audits"
              (\ o ->
                 LighthouseResultV5_Audits Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "LighthouseResultV5_CategoryGroups"
              (\ o ->
                 LighthouseResultV5_CategoryGroups Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "PagespeedApiLoadingExperienceV5"
              (\ o ->
                 PagespeedApiLoadingExperienceV5 Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "initial_url")
                     Core.<*> (o Core..:? "metrics")
                     Core.<*> (o Core..:? "origin_fallback")
                     Core.<*> (o Core..:? "overall_category"))

instance Core.ToJSON PagespeedApiLoadingExperienceV5
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "PagespeedApiLoadingExperienceV5_Metrics"
              (\ o ->
                 PagespeedApiLoadingExperienceV5_Metrics Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "PagespeedApiPagespeedResponseV5"
              (\ o ->
                 PagespeedApiPagespeedResponseV5 Core.<$>
                   (o Core..:? "analysisUTCTimestamp") Core.<*>
                     (o Core..:? "captchaResult")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind")
...
instance Core.ToJSON PagespeedApiPagespeedResponseV5
         where
        toJSON PagespeedApiPagespeedResponseV5{..}
          = Core.object
              (Core.catMaybes
                 [("analysisUTCTimestamp" Core..=) Core.<$>
                    analysisUTCTimestamp,
                  ("captchaResult" Core..=) Core.<$> captchaResult,
                  ("id" Core..=) Core.<$> id,
                  ("kind" Core..=) Core.<$> kind,
                  ("lighthouseResult" Core..=) Core.<$>
                    lighthouseResult,
                  ("loadingExperience" Core..=) Core.<$>
                    loadingExperience,
                  ("originLoadingExperience" Core..=) Core.<$>
...
instance Core.FromJSON PagespeedVersion where
        parseJSON
          = Core.withObject "PagespeedVersion"
              (\ o ->
                 PagespeedVersion Core.<$>
...
instance Core.FromJSON RendererFormattedStrings where
        parseJSON
          = Core.withObject "RendererFormattedStrings"
              (\ o ->
                 RendererFormattedStrings Core.<$>
                   (o Core..:? "auditGroupExpandTooltip") Core.<*>
                     (o Core..:? "calculatorLink")
                     ...
                     Core.<*>
                     (o Core..:? "lsPerformanceCategoryDescription")
                     Core.<*> (o Core..:? "manualAuditsGroupTitle")
                     Core.<*> (o Core..:? "notApplicableAuditsGroupTitle")
                     Core.<*>
                     (o Core..:? "opportunityResourceColumnLabel")
                     ...
                     Core.<*>
                     (o Core..:? "runtimeSettingsNetworkThrottling")
...
instance Core.ToJSON RendererFormattedStrings where
        toJSON RendererFormattedStrings{..}
          = Core.object
              (Core.catMaybes
                 [("auditGroupExpandTooltip" Core..=) Core.<$>
                    auditGroupExpandTooltip,
                  ("calculatorLink" Core..=) Core.<$> calculatorLink,
                  ("crcInitialNavigation" Core..=) Core.<$>
                    crcInitialNavigation,
                  ("crcLongestDurationLabel" Core..=) Core.<$>
                    crcLongestDurationLabel,
                  ("dropdownCopyJSON" Core..=) Core.<$>
                    dropdownCopyJSON,
                  ("dropdownDarkTheme" Core..=) Core.<$>
                    dropdownDarkTheme,
                  ("dropdownPrintExpanded" Core..=) Core.<$>
                    dropdownPrintExpanded,
                  ("dropdownPrintSummary" Core..=) Core.<$>
                    dropdownPrintSummary,
                  ("dropdownSaveGist" Core..=) Core.<$>
                    dropdownSaveGist,
                  ("dropdownSaveHTML" Core..=) Core.<$>
                    dropdownSaveHTML,
                  ("dropdownSaveJSON" Core..=) Core.<$>
                    dropdownSaveJSON,
                  ("dropdownViewer" Core..=) Core.<$> dropdownViewer,
                  ("errorLabel" Core..=) Core.<$> errorLabel,
                  ("errorMissingAuditInfo" Core..=) Core.<$>
                    errorMissingAuditInfo,
                  ("footerIssue" Core..=) Core.<$> footerIssue,
                  ("labDataTitle" Core..=) Core.<$> labDataTitle,
                  ("lsPerformanceCategoryDescription" Core..=) Core.<$>
                    lsPerformanceCategoryDescription,
                  ("manualAuditsGroupTitle" Core..=) Core.<$>
                    manualAuditsGroupTitle,
                  ("notApplicableAuditsGroupTitle" Core..=) Core.<$>
                    notApplicableAuditsGroupTitle,
                  ("opportunityResourceColumnLabel" Core..=) Core.<$>
                    opportunityResourceColumnLabel,
                  ("opportunitySavingsColumnLabel" Core..=) Core.<$>
                    opportunitySavingsColumnLabel,
                  ("passedAuditsGroupTitle" Core..=) Core.<$>
                    passedAuditsGroupTitle,
                  ("runtimeDesktopEmulation" Core..=) Core.<$>
                    runtimeDesktopEmulation,
                  ("runtimeMobileEmulation" Core..=) Core.<$>
                    runtimeMobileEmulation,
                  ("runtimeNoEmulation" Core..=) Core.<$>
                    runtimeNoEmulation,
                  ("runtimeSettingsAxeVersion" Core..=) Core.<$>
                    runtimeSettingsAxeVersion,
                  ("runtimeSettingsBenchmark" Core..=) Core.<$>
                    runtimeSettingsBenchmark,
                  ("runtimeSettingsCPUThrottling" Core..=) Core.<$>
                    runtimeSettingsCPUThrottling,
                  ("runtimeSettingsChannel" Core..=) Core.<$>
                    runtimeSettingsChannel,
                  ("runtimeSettingsDevice" Core..=) Core.<$>
                    runtimeSettingsDevice,
                  ("runtimeSettingsFetchTime" Core..=) Core.<$>
                    runtimeSettingsFetchTime,
                  ("runtimeSettingsNetworkThrottling" Core..=) Core.<$>
                    runtimeSettingsNetworkThrottling,
                  ("runtimeSettingsTitle" Core..=) Core.<$>
                    runtimeSettingsTitle,
                  ("runtimeSettingsUA" Core..=) Core.<$>
                    runtimeSettingsUA,
                  ("runtimeSettingsUANetwork" Core..=) Core.<$>
                    runtimeSettingsUANetwork,
                  ("runtimeSettingsUrl" Core..=) Core.<$>
                    runtimeSettingsUrl,
                  ("runtimeUnknown" Core..=) Core.<$> runtimeUnknown,
                  ("scorescaleLabel" Core..=) Core.<$> scorescaleLabel,
                  ("showRelevantAudits" Core..=) Core.<$>
                    showRelevantAudits,
                  ("snippetCollapseButtonLabel" Core..=) Core.<$>
                    snippetCollapseButtonLabel,
                  ("snippetExpandButtonLabel" Core..=) Core.<$>
                    snippetExpandButtonLabel,
                  ("thirdPartyResourcesLabel" Core..=) Core.<$>
                    thirdPartyResourcesLabel,
                  ("throttlingProvided" Core..=) Core.<$>
                    throttlingProvided,
                  ("toplevelWarningsMessage" Core..=) Core.<$>
                    toplevelWarningsMessage,
                  ("varianceDisclaimer" Core..=) Core.<$>
                    varianceDisclaimer,
                  ("viewTreemapLabel" Core..=) Core.<$>
                    viewTreemapLabel,
                  ("warningAuditsGroupTitle" Core..=) Core.<$>
...
instance Core.FromJSON StackPack where
        parseJSON
          = Core.withObject "StackPack"
              (\ o ->
                 StackPack Core.<$>
                   (o Core..:? "descriptions") Core.<*>
                     (o Core..:? "iconDataURL")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "title"))
...
instance Core.FromJSON StackPack_Descriptions where
        parseJSON
          = Core.withObject "StackPack_Descriptions"
              (\ o ->
                 StackPack_Descriptions Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON UserPageLoadMetricV5 where
        parseJSON
          = Core.withObject "UserPageLoadMetricV5"
              (\ o ->
                 UserPageLoadMetricV5 Core.<$>
                   (o Core..:? "category") Core.<*>
                     (o Core..:? "distributions")
                     Core.<*> (o Core..:? "formFactor")
                     Core.<*> (o Core..:? "median")
