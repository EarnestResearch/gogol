                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] LandingPage Core.:>
                               Core.Patch '[Core.JSON] LandingPage
...
newDFAReportingAdvertiserLandingPagesPatch id payload profileId
  = DFAReportingAdvertiserLandingPagesPatch{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            id = id, payload = payload, profileId = profileId,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingAdvertiserLandingPagesPatch
         where
        type Rs DFAReportingAdvertiserLandingPagesPatch = LandingPage
        type Scopes DFAReportingAdvertiserLandingPagesPatch =
