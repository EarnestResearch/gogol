                             ...
                             Core.QueryParam "maxResults" Core.Int32 Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "searchString" Core.Text Core.:>
                                   Core.QueryParam "sortField" AdvertiserLandingPagesListSortField
                                     Core.:>
                                     Core.QueryParam "sortOrder" AdvertiserLandingPagesListSortOrder
                                       Core.:>
...
newDFAReportingAdvertiserLandingPagesList profileId
  = DFAReportingAdvertiserLandingPagesList{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, advertiserIds = Core.Nothing,
                                           archived = Core.Nothing, callback = Core.Nothing,
                                           campaignIds = Core.Nothing, ids = Core.Nothing,
                                           maxResults = 1000, pageToken = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingAdvertiserLandingPagesList
         where
        type Rs DFAReportingAdvertiserLandingPagesList =
             AdvertiserLandingPagesListResponse
        type Scopes DFAReportingAdvertiserLandingPagesList =
