           ...
           Core.Capture "profileId" Core.Int64 Core.:>
             "sites" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "acceptsInStreamVideoPlacements" Core.Bool Core.:>
                   Core.QueryParam "acceptsInterstitialPlacements" Core.Bool Core.:>
                     Core.QueryParam "acceptsPublisherPaidPlacements" Core.Bool Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "adWordsSite" Core.Bool Core.:>
                                     ...
                                     Core.QueryParam "maxResults" Core.Int32 Core.:>
                                       Core.QueryParam "pageToken" Core.Text Core.:>
                                         Core.QueryParam "searchString" Core.Text Core.:>
                                           Core.QueryParam "sortField" SitesListSortField Core.:>
                                             Core.QueryParam "sortOrder" SitesListSortOrder Core.:>
                                               Core.QueryParam "subaccountId" Core.Int64 Core.:>
                                                 Core.QueryParam "unmappedSite" Core.Bool Core.:>
...
newDFAReportingSitesList profileId
  = DFAReportingSitesList{xgafv = Core.Nothing,
                          ...
                          accessToken = Core.Nothing, adWordsSite = Core.Nothing,
                          approved = Core.Nothing, callback = Core.Nothing,
                          campaignIds = Core.Nothing, directorySiteIds = Core.Nothing,
                          ids = Core.Nothing, maxResults = 1000, pageToken = Core.Nothing,
                          profileId = profileId, searchString = Core.Nothing,
                          sortField = SitesListSortField_ID,
                          sortOrder = SitesListSortOrder_Ascending,
                          subaccountId = Core.Nothing, unmappedSite = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingSitesList where
        ...
        requestClient DFAReportingSitesList{..}
          = go profileId xgafv acceptsInStreamVideoPlacements
