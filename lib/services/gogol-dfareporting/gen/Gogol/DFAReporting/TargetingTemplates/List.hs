                         ...
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "searchString" Core.Text Core.:>
                               Core.QueryParam "sortField" TargetingTemplatesListSortField Core.:>
                                 Core.QueryParam "sortOrder" TargetingTemplatesListSortOrder Core.:>
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] TargetingTemplatesListResponse
...
newDFAReportingTargetingTemplatesList profileId
  = DFAReportingTargetingTemplatesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingTargetingTemplatesList
         where
