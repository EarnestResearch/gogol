                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ConversionsBatchUpdateRequest Core.:>
                               Core.Post '[Core.JSON] ConversionsBatchUpdateResponse
...
newDFAReportingConversionsBatchupdate payload profileId
  = DFAReportingConversionsBatchupdate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, profileId = profileId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingConversionsBatchupdate
         where
