                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ConversionsBatchInsertRequest Core.:>
                               Core.Post '[Core.JSON] ConversionsBatchInsertResponse
...
newDFAReportingConversionsBatchinsert payload profileId
  = DFAReportingConversionsBatchinsert{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, profileId = profileId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingConversionsBatchinsert
         where
        type Rs DFAReportingConversionsBatchinsert =
             ConversionsBatchInsertResponse
        type Scopes DFAReportingConversionsBatchinsert =
