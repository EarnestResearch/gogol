                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] TvCampaignDetail
...
newDFAReportingTvCampaignDetailsGet id profileId
  = DFAReportingTvCampaignDetailsGet{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, accountId = Core.Nothing,
                                     callback = Core.Nothing, id = id, profileId = profileId,
...
instance Core.GoogleRequest DFAReportingTvCampaignDetailsGet where
        ...
        type Scopes DFAReportingTvCampaignDetailsGet =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingTvCampaignDetailsGet{..}
          = go profileId id xgafv accessToken accountId callback uploadType
              uploadProtocol
