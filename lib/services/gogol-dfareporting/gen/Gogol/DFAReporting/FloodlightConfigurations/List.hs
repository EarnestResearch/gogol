                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] FloodlightConfigurationsListResponse
...
newDFAReportingFloodlightConfigurationsList profileId
  = DFAReportingFloodlightConfigurationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DFAReportingFloodlightConfigurationsList
         where
        type Rs DFAReportingFloodlightConfigurationsList =
             FloodlightConfigurationsListResponse
        type Scopes DFAReportingFloodlightConfigurationsList =
