                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] FloodlightConfiguration Core.:>
                             Core.Put '[Core.JSON] FloodlightConfiguration
...
newDFAReportingFloodlightConfigurationsUpdate payload profileId
  = DFAReportingFloodlightConfigurationsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DFAReportingFloodlightConfigurationsUpdate
         where
        type Rs DFAReportingFloodlightConfigurationsUpdate =
             FloodlightConfiguration
        type Scopes DFAReportingFloodlightConfigurationsUpdate =
