                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] FloodlightConfiguration Core.:>
                               Core.Patch '[Core.JSON] FloodlightConfiguration
...
newDFAReportingFloodlightConfigurationsPatch id payload profileId
  = DFAReportingFloodlightConfigurationsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DFAReportingFloodlightConfigurationsPatch
         where
        type Rs DFAReportingFloodlightConfigurationsPatch =
             FloodlightConfiguration
        type Scopes DFAReportingFloodlightConfigurationsPatch =
