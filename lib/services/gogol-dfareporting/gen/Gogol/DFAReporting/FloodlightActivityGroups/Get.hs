                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] FloodlightActivityGroup
...
newDFAReportingFloodlightActivityGroupsGet id profileId
  = DFAReportingFloodlightActivityGroupsGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            id = id, profileId = profileId,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingFloodlightActivityGroupsGet
         where
        type Rs DFAReportingFloodlightActivityGroupsGet =
             FloodlightActivityGroup
        type Scopes DFAReportingFloodlightActivityGroupsGet =
