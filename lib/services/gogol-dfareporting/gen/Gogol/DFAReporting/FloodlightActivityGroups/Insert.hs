                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] FloodlightActivityGroup Core.:>
                             Core.Post '[Core.JSON] FloodlightActivityGroup
...
newDFAReportingFloodlightActivityGroupsInsert payload profileId
  = DFAReportingFloodlightActivityGroupsInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DFAReportingFloodlightActivityGroupsInsert
         where
        type Rs DFAReportingFloodlightActivityGroupsInsert =
             FloodlightActivityGroup
        type Scopes DFAReportingFloodlightActivityGroupsInsert =
