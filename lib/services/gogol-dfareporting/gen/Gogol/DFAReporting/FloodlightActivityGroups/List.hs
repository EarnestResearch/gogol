                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "advertiserId" Core.Int64 Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "floodlightConfigurationId" Core.Int64 Core.:>
                           ...
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "searchString" Core.Text Core.:>
                                 Core.QueryParam "sortField" FloodlightActivityGroupsListSortField
                                   Core.:>
                                   Core.QueryParam "sortOrder" FloodlightActivityGroupsListSortOrder
                                     Core.:>
                                     Core.QueryParam "type" FloodlightActivityGroupsListType Core.:>
...
newDFAReportingFloodlightActivityGroupsList profileId
  = DFAReportingFloodlightActivityGroupsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DFAReportingFloodlightActivityGroupsList
         where
        type Rs DFAReportingFloodlightActivityGroupsList =
             FloodlightActivityGroupsListResponse
        type Scopes DFAReportingFloodlightActivityGroupsList =
