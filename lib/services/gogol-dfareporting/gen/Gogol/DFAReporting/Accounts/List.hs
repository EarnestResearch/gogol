                         ...
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "searchString" Core.Text Core.:>
                               Core.QueryParam "sortField" AccountsListSortField Core.:>
                                 Core.QueryParam "sortOrder" AccountsListSortOrder Core.:>
...
newDFAReportingAccountsList profileId
  = DFAReportingAccountsList{xgafv = Core.Nothing,
                             ...
                             searchString = Core.Nothing, sortField = AccountsListSortField_ID,
...
instance Core.GoogleRequest DFAReportingAccountsList where
        ...
        type Scopes DFAReportingAccountsList =
