                               ...
                               Core.QueryParams "orderId" Core.Int64 Core.:>
                                 Core.QueryParam "pageToken" Core.Text Core.:>
                                   Core.QueryParams "siteId" Core.Int64 Core.:>
                                     Core.QueryParam "sortField" InventoryItemsListSortField Core.:>
                                       Core.QueryParam "sortOrder" InventoryItemsListSortOrder
                                         Core.:>
                                         Core.QueryParam "type" InventoryItemsListType Core.:>
                                           Core.QueryParam "uploadType" Core.Text Core.:>
                                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                                 Core.Get '[Core.JSON] InventoryItemsListResponse
...
newDFAReportingInventoryItemsList profileId projectId
  = DFAReportingInventoryItemsList{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   ids = Core.Nothing, inPlan = Core.Nothing, maxResults = 1000,
                                   orderId = Core.Nothing, pageToken = Core.Nothing,
