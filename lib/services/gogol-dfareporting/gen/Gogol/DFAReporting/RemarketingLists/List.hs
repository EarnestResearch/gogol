                   ...
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "active" Core.Bool Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "floodlightActivityId" Core.Int64 Core.:>
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "name" Core.Text Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "sortField" RemarketingListsListSortField Core.:>
                                   Core.QueryParam "sortOrder" RemarketingListsListSortOrder Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] RemarketingListsListResponse
...
newDFAReportingRemarketingListsList advertiserId profileId
  = DFAReportingRemarketingListsList{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, active = Core.Nothing,
                                     advertiserId = advertiserId, callback = Core.Nothing,
                                     floodlightActivityId = Core.Nothing, maxResults = 1000,
                                     name = Core.Nothing, pageToken = Core.Nothing,
                                     profileId = profileId,
