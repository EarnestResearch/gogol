                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] RemarketingList Core.:>
                             Core.Put '[Core.JSON] RemarketingList
...
newDFAReportingRemarketingListsUpdate payload profileId
  = DFAReportingRemarketingListsUpdate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, profileId = profileId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingRemarketingListsUpdate
         where
        type Rs DFAReportingRemarketingListsUpdate = RemarketingList
        type Scopes DFAReportingRemarketingListsUpdate =
