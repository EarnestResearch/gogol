                       ...
                       Core.QueryParam "maxResults" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "searchString" Core.Text Core.:>
                             Core.QueryParam "sortField" SubaccountsListSortField Core.:>
                               Core.QueryParam "sortOrder" SubaccountsListSortOrder Core.:>
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] SubaccountsListResponse
...
newDFAReportingSubaccountsList profileId
  = DFAReportingSubaccountsList{xgafv = Core.Nothing,
