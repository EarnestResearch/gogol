                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Post '[Core.JSON] FloodlightActivitiesGenerateTagResponse
...
newDFAReportingFloodlightActivitiesGeneratetag profileId
  = DFAReportingFloodlightActivitiesGeneratetag{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DFAReportingFloodlightActivitiesGeneratetag
         where
        type Rs DFAReportingFloodlightActivitiesGeneratetag =
             FloodlightActivitiesGenerateTagResponse
        type Scopes DFAReportingFloodlightActivitiesGeneratetag =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingFloodlightActivitiesGeneratetag{..}
          = go profileId xgafv accessToken callback floodlightActivityId
              uploadType
              uploadProtocol
