                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] FloodlightActivity
...
newDFAReportingFloodlightActivitiesGet id profileId
  = DFAReportingFloodlightActivitiesGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        id = id, profileId = profileId, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingFloodlightActivitiesGet
         where
        type Rs DFAReportingFloodlightActivitiesGet = FloodlightActivity
        type Scopes DFAReportingFloodlightActivitiesGet =
