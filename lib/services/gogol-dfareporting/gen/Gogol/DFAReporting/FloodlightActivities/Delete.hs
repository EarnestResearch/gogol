...
newDFAReportingFloodlightActivitiesDelete id profileId
  = DFAReportingFloodlightActivitiesDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           id = id, profileId = profileId,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingFloodlightActivitiesDelete
         where
        type Rs DFAReportingFloodlightActivitiesDelete = ()
        type Scopes DFAReportingFloodlightActivitiesDelete =
