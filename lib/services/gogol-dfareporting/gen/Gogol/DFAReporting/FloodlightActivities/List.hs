                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "advertiserId" Core.Int64 Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParams "floodlightActivityGroupIds" Core.Int64 Core.:>
                         Core.QueryParam "floodlightActivityGroupName" Core.Text Core.:>
                           Core.QueryParam "floodlightActivityGroupTagString" Core.Text
                             Core.:>
                                       ...
                                       Core.QueryParam "searchString" Core.Text Core.:>
                                         Core.QueryParam "sortField"
                                           ...
                                           Core.QueryParam "sortOrder"
                                             ...
                                             Core.:>
                                             Core.QueryParam "tagString" Core.Text Core.:>
...
newDFAReportingFloodlightActivitiesList profileId
  = DFAReportingFloodlightActivitiesList{xgafv = Core.Nothing,
                                         ...
                                         tagString = Core.Nothing, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingFloodlightActivitiesList
         where
