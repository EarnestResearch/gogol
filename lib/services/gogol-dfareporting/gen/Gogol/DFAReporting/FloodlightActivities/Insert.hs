                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] FloodlightActivity Core.:>
                             Core.Post '[Core.JSON] FloodlightActivity
...
newDFAReportingFloodlightActivitiesInsert payload profileId
  = DFAReportingFloodlightActivitiesInsert{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           payload = payload, profileId = profileId,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingFloodlightActivitiesInsert
         where
        type Rs DFAReportingFloodlightActivitiesInsert = FloodlightActivity
        type Scopes DFAReportingFloodlightActivitiesInsert =
