                         ...
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] FloodlightActivity Core.:>
                               Core.Patch '[Core.JSON] FloodlightActivity
...
newDFAReportingFloodlightActivitiesPatch id payload profileId
  = DFAReportingFloodlightActivitiesPatch{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          id = id, payload = payload, profileId = profileId,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingFloodlightActivitiesPatch
         where
        type Rs DFAReportingFloodlightActivitiesPatch = FloodlightActivity
        type Scopes DFAReportingFloodlightActivitiesPatch =
