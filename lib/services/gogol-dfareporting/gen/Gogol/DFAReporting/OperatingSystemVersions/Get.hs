                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] OperatingSystemVersion
...
newDFAReportingOperatingSystemVersionsGet id profileId
  = DFAReportingOperatingSystemVersionsGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           id = id, profileId = profileId,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingOperatingSystemVersionsGet
         where
        type Rs DFAReportingOperatingSystemVersionsGet =
             OperatingSystemVersion
        type Scopes DFAReportingOperatingSystemVersionsGet =
