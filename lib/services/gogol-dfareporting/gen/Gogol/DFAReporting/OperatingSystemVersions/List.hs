                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] OperatingSystemVersionsListResponse
...
newDFAReportingOperatingSystemVersionsList profileId
  = DFAReportingOperatingSystemVersionsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            profileId = profileId, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingOperatingSystemVersionsList
         where
        type Rs DFAReportingOperatingSystemVersionsList =
             OperatingSystemVersionsListResponse
        type Scopes DFAReportingOperatingSystemVersionsList =
