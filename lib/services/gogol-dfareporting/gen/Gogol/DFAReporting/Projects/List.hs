                         ...
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "searchString" Core.Text Core.:>
                               Core.QueryParam "sortField" ProjectsListSortField Core.:>
                                 Core.QueryParam "sortOrder" ProjectsListSortOrder Core.:>
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] ProjectsListResponse
...
newDFAReportingProjectsList profileId
  = DFAReportingProjectsList{xgafv = Core.Nothing,
                             ...
                             searchString = Core.Nothing, sortField = ProjectsListSortField_ID,
...
instance Core.GoogleRequest DFAReportingProjectsList where
        ...
        type Scopes DFAReportingProjectsList =
