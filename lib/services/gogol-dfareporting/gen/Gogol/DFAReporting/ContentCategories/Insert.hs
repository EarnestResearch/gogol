                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ContentCategory Core.:>
                             Core.Post '[Core.JSON] ContentCategory
...
newDFAReportingContentCategoriesInsert payload profileId
  = DFAReportingContentCategoriesInsert{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, profileId = profileId,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingContentCategoriesInsert
         where
        type Rs DFAReportingContentCategoriesInsert = ContentCategory
        type Scopes DFAReportingContentCategoriesInsert =
