                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ContentCategory Core.:>
                             Core.Put '[Core.JSON] ContentCategory
...
newDFAReportingContentCategoriesUpdate payload profileId
  = DFAReportingContentCategoriesUpdate{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, profileId = profileId,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingContentCategoriesUpdate
         where
        type Rs DFAReportingContentCategoriesUpdate = ContentCategory
        type Scopes DFAReportingContentCategoriesUpdate =
