                       ...
                       Core.QueryParam "maxResults" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "searchString" Core.Text Core.:>
                             Core.QueryParam "sortField" ContentCategoriesListSortField Core.:>
                               Core.QueryParam "sortOrder" ContentCategoriesListSortOrder Core.:>
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ContentCategoriesListResponse
...
newDFAReportingContentCategoriesList profileId
  = DFAReportingContentCategoriesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingContentCategoriesList where
        type Rs DFAReportingContentCategoriesList =
             ContentCategoriesListResponse
        type Scopes DFAReportingContentCategoriesList =
