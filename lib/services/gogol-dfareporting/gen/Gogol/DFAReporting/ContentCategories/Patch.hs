                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ContentCategory Core.:>
                               Core.Patch '[Core.JSON] ContentCategory
...
newDFAReportingContentCategoriesPatch id payload profileId
  = DFAReportingContentCategoriesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingContentCategoriesPatch
         where
        type Rs DFAReportingContentCategoriesPatch = ContentCategory
        type Scopes DFAReportingContentCategoriesPatch =
