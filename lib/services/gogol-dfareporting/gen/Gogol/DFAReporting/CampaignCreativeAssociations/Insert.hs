       ...
       "v4" Core.:>
         "userprofiles" Core.:>
           Core.Capture "profileId" Core.Int64 Core.:>
             "campaigns" Core.:>
               Core.Capture "campaignId" Core.Int64 Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] CampaignCreativeAssociation Core.:>
                                 Core.Post '[Core.JSON] CampaignCreativeAssociation
...
newDFAReportingCampaignCreativeAssociationsInsert 
    ...
    -> DFAReportingCampaignCreativeAssociationsInsert
newDFAReportingCampaignCreativeAssociationsInsert campaignId
  payload profileId
  = DFAReportingCampaignCreativeAssociationsInsert{xgafv =
                                                     Core.Nothing,
                                                   accessToken = Core.Nothing,
                                                   callback = Core.Nothing, campaignId = campaignId,
...
instance Core.GoogleRequest
           DFAReportingCampaignCreativeAssociationsInsert
         where
        type Rs DFAReportingCampaignCreativeAssociationsInsert =
             CampaignCreativeAssociation
        type Scopes DFAReportingCampaignCreativeAssociationsInsert =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingCampaignCreativeAssociationsInsert{..}
          = go profileId campaignId xgafv accessToken callback uploadType
              uploadProtocol
