                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] CampaignCreativeAssociationsListResponse
...
newDFAReportingCampaignCreativeAssociationsList 
    ...
    -> DFAReportingCampaignCreativeAssociationsList
newDFAReportingCampaignCreativeAssociationsList campaignId
  profileId
  = DFAReportingCampaignCreativeAssociationsList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           DFAReportingCampaignCreativeAssociationsList
         where
        type Rs DFAReportingCampaignCreativeAssociationsList =
             CampaignCreativeAssociationsListResponse
        type Scopes DFAReportingCampaignCreativeAssociationsList =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingCampaignCreativeAssociationsList{..}
          = go profileId campaignId xgafv accessToken callback
