                     ...
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "campaignId" Core.Int64 Core.:>
                         Core.QueryParams "placementIds" Core.Int64 Core.:>
                           Core.QueryParams "tagFormats" PlacementsGeneratetagsTagFormats
                             Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Post '[Core.JSON] PlacementsGenerateTagsResponse
...
newDFAReportingPlacementsGeneratetags profileId
  = DFAReportingPlacementsGeneratetags{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       campaignId = Core.Nothing, placementIds = Core.Nothing,
                                       profileId = profileId, tagFormats = Core.Nothing,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingPlacementsGeneratetags
         where
        type Rs DFAReportingPlacementsGeneratetags =
             PlacementsGenerateTagsResponse
        type Scopes DFAReportingPlacementsGeneratetags =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingPlacementsGeneratetags{..}
          = go profileId xgafv accessToken callback campaignId
