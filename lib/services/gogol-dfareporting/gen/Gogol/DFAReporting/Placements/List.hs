             ...
             "placements" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParams "activeStatus" PlacementsListActiveStatus Core.:>
                     Core.QueryParams "advertiserIds" Core.Int64 Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParams "campaignIds" Core.Int64 Core.:>
                           Core.QueryParams "compatibilities" PlacementsListCompatibilities
                             Core.:>
                             Core.QueryParams "contentCategoryIds" Core.Int64 Core.:>
                               Core.QueryParams "directorySiteIds" Core.Int64 Core.:>
                                 Core.QueryParams "groupIds" Core.Int64 Core.:>
                                   Core.QueryParams "ids" Core.Int64 Core.:>
                                     Core.QueryParam "maxEndDate" Core.Text Core.:>
                                       Core.QueryParam "maxResults" Core.Int32 Core.:>
                                         Core.QueryParam "maxStartDate" Core.Text Core.:>
                                           Core.QueryParam "minEndDate" Core.Text Core.:>
                                             Core.QueryParam "minStartDate" Core.Text Core.:>
                                               Core.QueryParam "pageToken" Core.Text Core.:>
                                                 Core.QueryParam "paymentSource"
                                                   PlacementsListPaymentSource
                                                   Core.:>
                                                   Core.QueryParams "placementStrategyIds"
                                                     Core.Int64
                                                     Core.:>
                                                     Core.QueryParams "pricingTypes"
                                                       PlacementsListPricingTypes
                                                       Core.:>
                                                       Core.QueryParam "searchString" Core.Text
                                                         Core.:>
                                                         Core.QueryParams "siteIds" Core.Int64
                                                           Core.:>
                                                           Core.QueryParams "sizeIds" Core.Int64
                                                             Core.:>
...
newDFAReportingPlacementsList profileId
  = DFAReportingPlacementsList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, activeStatus = Core.Nothing,
                               advertiserIds = Core.Nothing, callback = Core.Nothing,
                               campaignIds = Core.Nothing, compatibilities = Core.Nothing,
                               contentCategoryIds = Core.Nothing, directorySiteIds = Core.Nothing,
                               groupIds = Core.Nothing, ids = Core.Nothing,
                               maxEndDate = Core.Nothing, maxResults = 1000,
                               maxStartDate = Core.Nothing, minEndDate = Core.Nothing,
                               minStartDate = Core.Nothing, pageToken = Core.Nothing,
                               paymentSource = Core.Nothing, placementStrategyIds = Core.Nothing,
                               pricingTypes = Core.Nothing, profileId = profileId,
                               searchString = Core.Nothing, siteIds = Core.Nothing,
                               sizeIds = Core.Nothing, sortField = PlacementsListSortField_ID,
...
instance Core.GoogleRequest DFAReportingPlacementsList where
        ...
        type Scopes DFAReportingPlacementsList =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingPlacementsList{..}
          = go profileId xgafv accessToken
