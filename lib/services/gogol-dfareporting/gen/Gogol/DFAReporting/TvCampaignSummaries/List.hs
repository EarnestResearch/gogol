                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] TvCampaignSummariesListResponse
...
newDFAReportingTvCampaignSummariesList profileId
  = DFAReportingTvCampaignSummariesList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, accountId = Core.Nothing,
                                        callback = Core.Nothing, name = Core.Nothing,
                                        profileId = profileId, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingTvCampaignSummariesList
         where
        ...
        requestClient DFAReportingTvCampaignSummariesList{..}
          = go profileId xgafv accessToken accountId callback name uploadType
              uploadProtocol
