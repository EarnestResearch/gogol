                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] PlacementStrategy Core.:>
                             Core.Post '[Core.JSON] PlacementStrategy
...
newDFAReportingPlacementStrategiesInsert payload profileId
  = DFAReportingPlacementStrategiesInsert{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, profileId = profileId,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingPlacementStrategiesInsert
         where
        type Rs DFAReportingPlacementStrategiesInsert = PlacementStrategy
        type Scopes DFAReportingPlacementStrategiesInsert =
