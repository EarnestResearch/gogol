                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] PlacementStrategy Core.:>
                             Core.Put '[Core.JSON] PlacementStrategy
...
newDFAReportingPlacementStrategiesUpdate payload profileId
  = DFAReportingPlacementStrategiesUpdate{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, profileId = profileId,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingPlacementStrategiesUpdate
         where
        type Rs DFAReportingPlacementStrategiesUpdate = PlacementStrategy
        type Scopes DFAReportingPlacementStrategiesUpdate =
