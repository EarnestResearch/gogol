                       ...
                       Core.QueryParam "maxResults" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "searchString" Core.Text Core.:>
                             Core.QueryParam "sortField" PlacementStrategiesListSortField
                               Core.:>
                               Core.QueryParam "sortOrder" PlacementStrategiesListSortOrder
                                 Core.:>
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] PlacementStrategiesListResponse
...
newDFAReportingPlacementStrategiesList profileId
  = DFAReportingPlacementStrategiesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingPlacementStrategiesList
         where
        type Rs DFAReportingPlacementStrategiesList =
             PlacementStrategiesListResponse
        type Scopes DFAReportingPlacementStrategiesList =
