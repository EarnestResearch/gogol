                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] PlacementStrategy Core.:>
                               Core.Patch '[Core.JSON] PlacementStrategy
...
newDFAReportingPlacementStrategiesPatch id payload profileId
  = DFAReportingPlacementStrategiesPatch{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         id = id, payload = payload, profileId = profileId,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingPlacementStrategiesPatch
         where
        type Rs DFAReportingPlacementStrategiesPatch = PlacementStrategy
        type Scopes DFAReportingPlacementStrategiesPatch =
