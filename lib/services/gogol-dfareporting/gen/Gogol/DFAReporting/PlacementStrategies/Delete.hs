...
newDFAReportingPlacementStrategiesDelete id profileId
  = DFAReportingPlacementStrategiesDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          id = id, profileId = profileId, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingPlacementStrategiesDelete
         where
        type Rs DFAReportingPlacementStrategiesDelete = ()
        type Scopes DFAReportingPlacementStrategiesDelete =
