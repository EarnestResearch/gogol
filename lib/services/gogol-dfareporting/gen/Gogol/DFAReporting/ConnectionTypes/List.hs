                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ConnectionTypesListResponse
...
newDFAReportingConnectionTypesList profileId
  = DFAReportingConnectionTypesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingConnectionTypesList where
        type Rs DFAReportingConnectionTypesList =
             ConnectionTypesListResponse
        type Scopes DFAReportingConnectionTypesList =
