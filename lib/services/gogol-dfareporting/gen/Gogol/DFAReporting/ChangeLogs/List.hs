             ...
             "changeLogs" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "action" ChangeLogsListAction Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParams "ids" Core.Int64 Core.:>
                         Core.QueryParam "maxChangeTime" Core.Text Core.:>
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "minChangeTime" Core.Text Core.:>
                               Core.QueryParams "objectIds" Core.Int64 Core.:>
                                 Core.QueryParam "objectType" ChangeLogsListObjectType Core.:>
                                   Core.QueryParam "pageToken" Core.Text Core.:>
                                     Core.QueryParam "searchString" Core.Text Core.:>
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParams "userProfileIds" Core.Int64 Core.:>
                                             Core.QueryParam "alt" Core.AltJSON Core.:>
                                               Core.Get '[Core.JSON] ChangeLogsListResponse
...
newDFAReportingChangeLogsList profileId
  = DFAReportingChangeLogsList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, action = Core.Nothing,
                               callback = Core.Nothing, ids = Core.Nothing,
                               maxChangeTime = Core.Nothing, maxResults = 1000,
                               minChangeTime = Core.Nothing, objectIds = Core.Nothing,
                               objectType = Core.Nothing, pageToken = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingChangeLogsList where
        ...
        type Scopes DFAReportingChangeLogsList =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingChangeLogsList{..}
          = go profileId xgafv accessToken action callback
