                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] DynamicTargetingKey Core.:>
                             Core.Post '[Core.JSON] DynamicTargetingKey
...
newDFAReportingDynamicTargetingKeysInsert payload profileId
  = DFAReportingDynamicTargetingKeysInsert{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           payload = payload, profileId = profileId,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingDynamicTargetingKeysInsert
         where
        type Rs DFAReportingDynamicTargetingKeysInsert =
             DynamicTargetingKey
        type Scopes DFAReportingDynamicTargetingKeysInsert =
