       ...
       "v4" Core.:>
         "userprofiles" Core.:>
           Core.Capture "profileId" Core.Int64 Core.:>
             "dynamicTargetingKeys" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "advertiserId" Core.Int64 Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParams "names" Core.Text Core.:>
                         Core.QueryParam "objectId" Core.Int64 Core.:>
                           Core.QueryParam "objectType" DynamicTargetingKeysListObjectType
                             Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] DynamicTargetingKeysListResponse
...
newDFAReportingDynamicTargetingKeysList profileId
  = DFAReportingDynamicTargetingKeysList{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, advertiserId = Core.Nothing,
                                         callback = Core.Nothing, names = Core.Nothing,
                                         objectId = Core.Nothing, objectType = Core.Nothing,
                                         profileId = profileId, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingDynamicTargetingKeysList
         where
        type Rs DFAReportingDynamicTargetingKeysList =
             DynamicTargetingKeysListResponse
        type Scopes DFAReportingDynamicTargetingKeysList =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingDynamicTargetingKeysList{..}
          = go profileId xgafv accessToken advertiserId callback
