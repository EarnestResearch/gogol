                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] CreativeFieldValue Core.:>
                                 Core.Post '[Core.JSON] CreativeFieldValue
...
newDFAReportingCreativeFieldValuesInsert 
    ...
    -> DFAReportingCreativeFieldValuesInsert
newDFAReportingCreativeFieldValuesInsert creativeFieldId payload
  profileId
  = DFAReportingCreativeFieldValuesInsert{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          creativeFieldId = creativeFieldId, payload = payload,
                                          profileId = profileId, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingCreativeFieldValuesInsert
         where
        type Rs DFAReportingCreativeFieldValuesInsert = CreativeFieldValue
        type Scopes DFAReportingCreativeFieldValuesInsert =
