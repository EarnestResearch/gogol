                           ...
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] CreativeFieldValue Core.:>
                                 Core.Put '[Core.JSON] CreativeFieldValue
...
newDFAReportingCreativeFieldValuesUpdate 
    ...
    -> DFAReportingCreativeFieldValuesUpdate
newDFAReportingCreativeFieldValuesUpdate creativeFieldId payload
  profileId
  = DFAReportingCreativeFieldValuesUpdate{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          creativeFieldId = creativeFieldId, payload = payload,
                                          profileId = profileId, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingCreativeFieldValuesUpdate
         where
        type Rs DFAReportingCreativeFieldValuesUpdate = CreativeFieldValue
        type Scopes DFAReportingCreativeFieldValuesUpdate =
