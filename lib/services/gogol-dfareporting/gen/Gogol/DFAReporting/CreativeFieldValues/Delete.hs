...
newDFAReportingCreativeFieldValuesDelete 
    ...
    -> DFAReportingCreativeFieldValuesDelete
newDFAReportingCreativeFieldValuesDelete creativeFieldId id
  profileId
  = DFAReportingCreativeFieldValuesDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          creativeFieldId = creativeFieldId, id = id,
                                          profileId = profileId, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingCreativeFieldValuesDelete
         where
        type Rs DFAReportingCreativeFieldValuesDelete = ()
        type Scopes DFAReportingCreativeFieldValuesDelete =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingCreativeFieldValuesDelete{..}
          = go profileId creativeFieldId id xgafv accessToken callback
              uploadType
              uploadProtocol
