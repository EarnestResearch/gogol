                           ...
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "searchString" Core.Text Core.:>
                                 Core.QueryParam "sortField" CreativeFieldValuesListSortField
                                   Core.:>
                                   Core.QueryParam "sortOrder" CreativeFieldValuesListSortOrder
                                     Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] CreativeFieldValuesListResponse
...
newDFAReportingCreativeFieldValuesList creativeFieldId profileId
  = DFAReportingCreativeFieldValuesList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        creativeFieldId = creativeFieldId, ids = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingCreativeFieldValuesList
         where
        type Rs DFAReportingCreativeFieldValuesList =
             CreativeFieldValuesListResponse
        type Scopes DFAReportingCreativeFieldValuesList =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingCreativeFieldValuesList{..}
          = go profileId creativeFieldId xgafv accessToken callback
