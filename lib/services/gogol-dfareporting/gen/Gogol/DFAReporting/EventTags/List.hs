                     ...
                     Core.QueryParam "advertiserId" Core.Int64 Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "campaignId" Core.Int64 Core.:>
                           Core.QueryParam "definitionsOnly" Core.Bool Core.:>
                             Core.QueryParam "enabled" Core.Bool Core.:>
                               Core.QueryParams "eventTagTypes" EventTagsListEventTagTypes Core.:>
                                 Core.QueryParams "ids" Core.Int64 Core.:>
                                   Core.QueryParam "searchString" Core.Text Core.:>
                                     Core.QueryParam "sortField" EventTagsListSortField Core.:>
                                       Core.QueryParam "sortOrder" EventTagsListSortOrder Core.:>
                                         Core.QueryParam "uploadType" Core.Text Core.:>
                                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                                             Core.QueryParam "alt" Core.AltJSON Core.:>
                                               Core.Get '[Core.JSON] EventTagsListResponse
...
newDFAReportingEventTagsList profileId
  = DFAReportingEventTagsList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, adId = Core.Nothing,
                              advertiserId = Core.Nothing, callback = Core.Nothing,
                              campaignId = Core.Nothing, definitionsOnly = Core.Nothing,
                              enabled = Core.Nothing, eventTagTypes = Core.Nothing,
                              ids = Core.Nothing, profileId = profileId,
                              searchString = Core.Nothing, sortField = EventTagsListSortField_ID,
...
instance Core.GoogleRequest DFAReportingEventTagsList where
        ...
        type Scopes DFAReportingEventTagsList =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingEventTagsList{..}
          = go profileId xgafv accessToken adId advertiserId callback
              campaignId
              definitionsOnly
              enabled
