                       ...
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "active" Core.Bool Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "dfpNetworkCode" Core.Text Core.:>
                                 ...
                                 Core.QueryParam "maxResults" Core.Int32 Core.:>
                                   Core.QueryParam "pageToken" Core.Text Core.:>
                                     Core.QueryParam "searchString" Core.Text Core.:>
                                       Core.QueryParam "sortField" DirectorySitesListSortField
                                         Core.:>
                                         Core.QueryParam "sortOrder" DirectorySitesListSortOrder
                                           Core.:>
                                           Core.QueryParam "uploadType" Core.Text Core.:>
                                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                                 Core.Get '[Core.JSON] DirectorySitesListResponse
...
newDFAReportingDirectorySitesList profileId
  = DFAReportingDirectorySitesList{xgafv = Core.Nothing,
                                   ...
                                   callback = Core.Nothing, dfpNetworkCode = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingDirectorySitesList where
        ...
        type Scopes DFAReportingDirectorySitesList =
