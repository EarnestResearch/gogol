                         ...
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "searchString" Core.Text Core.:>
                               Core.QueryParam "sortField" AccountUserProfilesListSortField
                                 Core.:>
                                 Core.QueryParam "sortOrder" AccountUserProfilesListSortOrder
                                   Core.:>
                                   Core.QueryParam "subaccountId" Core.Int64 Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "userRoleId" Core.Int64 Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] AccountUserProfilesListResponse
...
newDFAReportingAccountUserProfilesList profileId
  = DFAReportingAccountUserProfilesList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, active = Core.Nothing,
                                        callback = Core.Nothing, ids = Core.Nothing,
                                        ...
                                        uploadProtocol = Core.Nothing, userRoleId = Core.Nothing}
instance Core.GoogleRequest DFAReportingAccountUserProfilesList
         where
        type Rs DFAReportingAccountUserProfilesList =
             AccountUserProfilesListResponse
        type Scopes DFAReportingAccountUserProfilesList =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingAccountUserProfilesList{..}
          = go profileId xgafv accessToken active callback
