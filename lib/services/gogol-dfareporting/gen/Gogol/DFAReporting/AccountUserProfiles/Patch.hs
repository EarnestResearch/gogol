                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] AccountUserProfile Core.:>
                               Core.Patch '[Core.JSON] AccountUserProfile
...
newDFAReportingAccountUserProfilesPatch id payload profileId
  = DFAReportingAccountUserProfilesPatch{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         id = id, payload = payload, profileId = profileId,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingAccountUserProfilesPatch
         where
        type Rs DFAReportingAccountUserProfilesPatch = AccountUserProfile
        type Scopes DFAReportingAccountUserProfilesPatch =
