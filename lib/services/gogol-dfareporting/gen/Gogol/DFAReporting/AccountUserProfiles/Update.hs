                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AccountUserProfile Core.:>
                             Core.Put '[Core.JSON] AccountUserProfile
...
newDFAReportingAccountUserProfilesUpdate payload profileId
  = DFAReportingAccountUserProfilesUpdate{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, profileId = profileId,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingAccountUserProfilesUpdate
         where
        type Rs DFAReportingAccountUserProfilesUpdate = AccountUserProfile
        type Scopes DFAReportingAccountUserProfilesUpdate =
