                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] AccountUserProfile
...
newDFAReportingAccountUserProfilesGet id profileId
  = DFAReportingAccountUserProfilesGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing, id = id,
                                       profileId = profileId, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingAccountUserProfilesGet
         where
        type Rs DFAReportingAccountUserProfilesGet = AccountUserProfile
        type Scopes DFAReportingAccountUserProfilesGet =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingAccountUserProfilesGet{..}
          = go profileId id xgafv accessToken callback uploadType
              uploadProtocol
