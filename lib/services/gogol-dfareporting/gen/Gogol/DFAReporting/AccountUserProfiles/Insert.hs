                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AccountUserProfile Core.:>
                             Core.Post '[Core.JSON] AccountUserProfile
...
newDFAReportingAccountUserProfilesInsert payload profileId
  = DFAReportingAccountUserProfilesInsert{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, profileId = profileId,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingAccountUserProfilesInsert
         where
        type Rs DFAReportingAccountUserProfilesInsert = AccountUserProfile
        type Scopes DFAReportingAccountUserProfilesInsert =
