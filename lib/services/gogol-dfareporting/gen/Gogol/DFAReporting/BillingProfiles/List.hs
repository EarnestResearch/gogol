                           ...
                           Core.QueryParam "name" Core.Text Core.:>
                             Core.QueryParam "onlySuggestion" Core.Bool Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "sortField" BillingProfilesListSortField Core.:>
                                   Core.QueryParam "sortOrder" BillingProfilesListSortOrder Core.:>
                                     Core.QueryParams "status" BillingProfilesListStatus Core.:>
                                       Core.QueryParams "subaccountIds" Core.Int64 Core.:>
                                         Core.QueryParam "uploadType" Core.Text Core.:>
                                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                                             Core.QueryParam "alt" Core.AltJSON Core.:>
                                               Core.Get '[Core.JSON] BillingProfilesListResponse
...
newDFAReportingBillingProfilesList profileId
  = DFAReportingBillingProfilesList{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    currencyCode = Core.Nothing, ids = Core.Nothing,
                                    maxResults = 1000, name = Core.Nothing,
                                    onlySuggestion = Core.Nothing, pageToken = Core.Nothing,
                                    profileId = profileId,
                                    sortField = BillingProfilesListSortField_ID,
                                    sortOrder = BillingProfilesListSortOrder_Ascending,
                                    status = Core.Nothing, subaccountIds = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingBillingProfilesList where
        ...
        requestClient DFAReportingBillingProfilesList{..}
          = go profileId xgafv accessToken callback currencyCode
