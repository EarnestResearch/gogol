       ...
       "v4" Core.:>
         "userprofiles" Core.:>
           Core.Capture "profileId" Core.Int64 Core.:>
             "countries" Core.:>
               Core.Capture "dartId" Core.Int64 Core.:>
...
newDFAReportingCountriesGet dartId profileId
  = DFAReportingCountriesGet{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             dartId = dartId, profileId = profileId, uploadType = Core.Nothing,
                             uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingCountriesGet where
        type Rs DFAReportingCountriesGet = Country
        type Scopes DFAReportingCountriesGet =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingCountriesGet{..}
          = go profileId dartId xgafv accessToken callback uploadType
              uploadProtocol
