...
newDFAReportingFilesGet fileId reportId
  = DFAReportingFilesGet{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         fileId = fileId, reportId = reportId, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingFilesGet where
        ...
        requestClient DFAReportingFilesGet{..}
          = go reportId fileId xgafv accessToken callback uploadType
              uploadProtocol
