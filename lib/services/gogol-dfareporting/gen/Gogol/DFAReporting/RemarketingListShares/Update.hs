                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] RemarketingListShare Core.:>
                             Core.Put '[Core.JSON] RemarketingListShare
...
newDFAReportingRemarketingListSharesUpdate payload profileId
  = DFAReportingRemarketingListSharesUpdate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, profileId = profileId,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingRemarketingListSharesUpdate
         where
        type Rs DFAReportingRemarketingListSharesUpdate =
             RemarketingListShare
        type Scopes DFAReportingRemarketingListSharesUpdate =
