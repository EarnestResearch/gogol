...
newDFAReportingRemarketingListSharesGet profileId remarketingListId
  = DFAReportingRemarketingListSharesGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         profileId = profileId,
                                         remarketingListId = remarketingListId,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingRemarketingListSharesGet
         where
        ...
        requestClient DFAReportingRemarketingListSharesGet{..}
          = go profileId remarketingListId xgafv accessToken callback
              uploadType
              uploadProtocol
