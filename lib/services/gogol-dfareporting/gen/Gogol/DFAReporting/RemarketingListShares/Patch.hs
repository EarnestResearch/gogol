                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] RemarketingListShare Core.:>
                               Core.Patch '[Core.JSON] RemarketingListShare
...
newDFAReportingRemarketingListSharesPatch id payload profileId
  = DFAReportingRemarketingListSharesPatch{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           id = id, payload = payload, profileId = profileId,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingRemarketingListSharesPatch
         where
        type Rs DFAReportingRemarketingListSharesPatch =
             RemarketingListShare
        type Scopes DFAReportingRemarketingListSharesPatch =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingRemarketingListSharesPatch{..}
          = go profileId (Core.Just id) xgafv accessToken callback uploadType
              uploadProtocol
