                     ...
                     Core.QueryParam "advertiserId" Core.Int64 Core.:>
                       Core.QueryParam "archived" Core.Bool Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "campaignId" Core.Int64 Core.:>
                             Core.QueryParams "companionCreativeIds" Core.Int64 Core.:>
                               Core.QueryParams "creativeFieldIds" Core.Int64 Core.:>
                                 Core.QueryParams "ids" Core.Int64 Core.:>
                                   Core.QueryParam "maxResults" Core.Int32 Core.:>
                                     Core.QueryParam "pageToken" Core.Text Core.:>
                                       Core.QueryParams "renderingIds" Core.Int64 Core.:>
                                         Core.QueryParam "searchString" Core.Text Core.:>
                                           Core.QueryParams "sizeIds" Core.Int64 Core.:>
                                             Core.QueryParam "sortField" CreativesListSortField
                                               Core.:>
                                               Core.QueryParam "sortOrder" CreativesListSortOrder
                                                 Core.:>
                                                 Core.QueryParam "studioCreativeId" Core.Int64
                                                   Core.:>
                                                   Core.QueryParams "types" CreativesListTypes
                                                     Core.:>
...
newDFAReportingCreativesList profileId
  = DFAReportingCreativesList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, active = Core.Nothing,
                              advertiserId = Core.Nothing, archived = Core.Nothing,
                              callback = Core.Nothing, campaignId = Core.Nothing,
                              companionCreativeIds = Core.Nothing,
                              creativeFieldIds = Core.Nothing, ids = Core.Nothing,
                              maxResults = 1000, pageToken = Core.Nothing, profileId = profileId,
                              renderingIds = Core.Nothing, searchString = Core.Nothing,
                              sizeIds = Core.Nothing, sortField = CreativesListSortField_ID,
                              sortOrder = CreativesListSortOrder_Ascending,
                              studioCreativeId = Core.Nothing, types = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingCreativesList where
        ...
        type Scopes DFAReportingCreativesList =
