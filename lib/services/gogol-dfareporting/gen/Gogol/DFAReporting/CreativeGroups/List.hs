                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParams "advertiserIds" Core.Int64 Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "groupNumber" Core.Int32 Core.:>
                           ...
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "searchString" Core.Text Core.:>
                                 Core.QueryParam "sortField" CreativeGroupsListSortField Core.:>
                                   Core.QueryParam "sortOrder" CreativeGroupsListSortOrder Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] CreativeGroupsListResponse
...
newDFAReportingCreativeGroupsList profileId
  = DFAReportingCreativeGroupsList{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, advertiserIds = Core.Nothing,
                                   callback = Core.Nothing, groupNumber = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingCreativeGroupsList where
        ...
        type Scopes DFAReportingCreativeGroupsList =
