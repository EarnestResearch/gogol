                       ...
                       Core.QueryParam "maxResults" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "searchString" Core.Text Core.:>
                             Core.QueryParam "sortField" AdvertiserGroupsListSortField Core.:>
                               Core.QueryParam "sortOrder" AdvertiserGroupsListSortOrder Core.:>
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] AdvertiserGroupsListResponse
...
newDFAReportingAdvertiserGroupsList profileId
  = DFAReportingAdvertiserGroupsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingAdvertiserGroupsList where
        type Rs DFAReportingAdvertiserGroupsList =
             AdvertiserGroupsListResponse
        type Scopes DFAReportingAdvertiserGroupsList =
