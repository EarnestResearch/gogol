                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AdvertiserGroup Core.:>
                             Core.Post '[Core.JSON] AdvertiserGroup
...
newDFAReportingAdvertiserGroupsInsert payload profileId
  = DFAReportingAdvertiserGroupsInsert{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, profileId = profileId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingAdvertiserGroupsInsert
         where
        type Rs DFAReportingAdvertiserGroupsInsert = AdvertiserGroup
        type Scopes DFAReportingAdvertiserGroupsInsert =
