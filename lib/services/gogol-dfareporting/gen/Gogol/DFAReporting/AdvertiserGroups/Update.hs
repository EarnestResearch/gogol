                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AdvertiserGroup Core.:>
                             Core.Put '[Core.JSON] AdvertiserGroup
...
newDFAReportingAdvertiserGroupsUpdate payload profileId
  = DFAReportingAdvertiserGroupsUpdate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, profileId = profileId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingAdvertiserGroupsUpdate
         where
        type Rs DFAReportingAdvertiserGroupsUpdate = AdvertiserGroup
        type Scopes DFAReportingAdvertiserGroupsUpdate =
