                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] BillingAssignment Core.:>
...
newDFAReportingBillingAssignmentsInsert 
    ...
    -> DFAReportingBillingAssignmentsInsert
newDFAReportingBillingAssignmentsInsert billingProfileId payload
  profileId
  = DFAReportingBillingAssignmentsInsert{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing,
                                         billingProfileId = billingProfileId,
                                         callback = Core.Nothing, payload = payload,
                                         profileId = profileId, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingBillingAssignmentsInsert
         where
        ...
        requestClient DFAReportingBillingAssignmentsInsert{..}
          = go profileId billingProfileId xgafv accessToken callback
              uploadType
              uploadProtocol
