                             ...
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "searchString" Core.Text Core.:>
                                 Core.QueryParams "siteId" Core.Int64 Core.:>
                                   Core.QueryParam "sortField" OrdersListSortField Core.:>
                                     Core.QueryParam "sortOrder" OrdersListSortOrder Core.:>
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] OrdersListResponse
