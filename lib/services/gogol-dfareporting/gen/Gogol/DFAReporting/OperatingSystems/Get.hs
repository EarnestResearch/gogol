                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] OperatingSystem
...
newDFAReportingOperatingSystemsGet dartId profileId
  = DFAReportingOperatingSystemsGet{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    dartId = dartId, profileId = profileId,
...
instance Core.GoogleRequest DFAReportingOperatingSystemsGet where
        ...
        type Scopes DFAReportingOperatingSystemsGet =
