                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] OperatingSystemsListResponse
...
newDFAReportingOperatingSystemsList profileId
  = DFAReportingOperatingSystemsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingOperatingSystemsList where
        type Rs DFAReportingOperatingSystemsList =
             OperatingSystemsListResponse
        type Scopes DFAReportingOperatingSystemsList =
