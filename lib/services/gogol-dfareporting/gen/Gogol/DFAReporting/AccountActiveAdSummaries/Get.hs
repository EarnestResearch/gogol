...
newDFAReportingAccountActiveAdSummariesGet 
    ...
    -> DFAReportingAccountActiveAdSummariesGet
newDFAReportingAccountActiveAdSummariesGet profileId
  summaryAccountId
  = DFAReportingAccountActiveAdSummariesGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            profileId = profileId,
                                            summaryAccountId = summaryAccountId,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingAccountActiveAdSummariesGet
         where
        ...
        requestClient DFAReportingAccountActiveAdSummariesGet{..}
          = go profileId summaryAccountId xgafv accessToken callback
              uploadType
              uploadProtocol
