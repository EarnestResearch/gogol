                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] AdvertiserInvoicesListResponse
...
newDFAReportingAdvertiserInvoicesList advertiserId profileId
  = DFAReportingAdvertiserInvoicesList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, advertiserId = advertiserId,
                                       callback = Core.Nothing, issueMonth = Core.Nothing,
                                       maxResults = 1000, pageToken = Core.Nothing,
                                       profileId = profileId, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingAdvertiserInvoicesList
         where
        ...
        requestClient DFAReportingAdvertiserInvoicesList{..}
          = go profileId advertiserId xgafv accessToken callback issueMonth
