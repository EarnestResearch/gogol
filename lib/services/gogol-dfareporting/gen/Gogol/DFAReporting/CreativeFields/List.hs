                         ...
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "searchString" Core.Text Core.:>
                               Core.QueryParam "sortField" CreativeFieldsListSortField Core.:>
                                 Core.QueryParam "sortOrder" CreativeFieldsListSortOrder Core.:>
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] CreativeFieldsListResponse
...
newDFAReportingCreativeFieldsList profileId
  = DFAReportingCreativeFieldsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingCreativeFieldsList where
        ...
        type Scopes DFAReportingCreativeFieldsList =
