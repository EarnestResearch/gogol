       ...
       "v4" Core.:>
         "userprofiles" Core.:>
           Core.Capture "profileId" Core.Int64 Core.:>
             "postalCodes" Core.:>
               Core.Capture "code" Core.Text Core.:>
...
newDFAReportingPostalCodesGet code profileId
  = DFAReportingPostalCodesGet{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing, code = code,
...
instance Core.GoogleRequest DFAReportingPostalCodesGet where
        ...
        type Scopes DFAReportingPostalCodesGet =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingPostalCodesGet{..}
          = go profileId code xgafv accessToken callback uploadType
              uploadProtocol
