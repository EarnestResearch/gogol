                   ...
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "maxResults" Core.Int32 Core.:>
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParam "scope" ReportsListScope Core.:>
                           Core.QueryParam "sortField" ReportsListSortField Core.:>
                             Core.QueryParam "sortOrder" ReportsListSortOrder Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] ReportList
...
newDFAReportingReportsList profileId
  = DFAReportingReportsList{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing,
                            maxResults = 10, pageToken = Core.Nothing, profileId = profileId,
...
instance Core.GoogleRequest DFAReportingReportsList where
        ...
        requestClient DFAReportingReportsList{..}
          = go profileId xgafv accessToken callback (Core.Just maxResults)
              pageToken
              (Core.Just scope)
              (Core.Just sortField)
              (Core.Just sortOrder)
