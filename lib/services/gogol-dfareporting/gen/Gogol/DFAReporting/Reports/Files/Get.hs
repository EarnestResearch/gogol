...
newDFAReportingReportsFilesGet fileId profileId reportId
  = DFAReportingReportsFilesGet{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                fileId = fileId, profileId = profileId, reportId = reportId,
...
instance Core.GoogleRequest DFAReportingReportsFilesGet where
        ...
        type Scopes DFAReportingReportsFilesGet =
             '[Dfareporting'FullControl]
        requestClient DFAReportingReportsFilesGet{..}
          = go profileId reportId fileId xgafv accessToken callback
              uploadType
              uploadProtocol
...
instance Core.GoogleRequest
         ...
         where
        type Rs (Core.MediaDownload DFAReportingReportsFilesGet) =
             Core.Stream
        type Scopes (Core.MediaDownload DFAReportingReportsFilesGet) =
