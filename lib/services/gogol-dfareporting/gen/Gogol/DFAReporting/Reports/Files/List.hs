                       ...
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "sortField" ReportsFilesListSortField Core.:>
                               Core.QueryParam "sortOrder" ReportsFilesListSortOrder Core.:>
...
newDFAReportingReportsFilesList profileId reportId
  = DFAReportingReportsFilesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingReportsFilesList where
        ...
        type Scopes DFAReportingReportsFilesList =
