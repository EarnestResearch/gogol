...
newDFAReportingReportsPatch payload profileId reportId
  = DFAReportingReportsPatch{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             payload = payload, profileId = profileId, reportId = reportId,
...
instance Core.GoogleRequest DFAReportingReportsPatch where
        ...
        requestClient DFAReportingReportsPatch{..}
          = go profileId reportId xgafv accessToken callback uploadType
              uploadProtocol
