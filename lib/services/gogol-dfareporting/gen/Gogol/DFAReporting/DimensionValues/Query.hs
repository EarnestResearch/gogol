                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] DimensionValueRequest Core.:>
...
newDFAReportingDimensionValuesQuery payload profileId
  = DFAReportingDimensionValuesQuery{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     maxResults = 100, pageToken = Core.Nothing, payload = payload,
