                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParams "advertiserGroupIds" Core.Int64 Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParams "floodlightConfigurationIds" Core.Int64 Core.:>
                         Core.QueryParams "ids" Core.Int64 Core.:>
                           Core.QueryParam "includeAdvertisersWithoutGroupsOnly" Core.Bool
                             Core.:>
                             Core.QueryParam "maxResults" Core.Int32 Core.:>
                               Core.QueryParam "onlyParent" Core.Bool Core.:>
                                 Core.QueryParam "pageToken" Core.Text Core.:>
                                   Core.QueryParam "searchString" Core.Text Core.:>
                                     Core.QueryParam "sortField" AdvertisersListSortField Core.:>
                                       Core.QueryParam "sortOrder" AdvertisersListSortOrder Core.:>
                                         Core.QueryParam "status" AdvertisersListStatus Core.:>
                                           Core.QueryParam "subaccountId" Core.Int64 Core.:>
                                             Core.QueryParam "uploadType" Core.Text Core.:>
                                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                                   Core.Get '[Core.JSON] AdvertisersListResponse
...
newDFAReportingAdvertisersList profileId
  = DFAReportingAdvertisersList{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, advertiserGroupIds = Core.Nothing,
                                callback = Core.Nothing, floodlightConfigurationIds = Core.Nothing,
                                ids = Core.Nothing,
                                includeAdvertisersWithoutGroupsOnly = Core.Nothing,
                                maxResults = 1000, onlyParent = Core.Nothing,
                                pageToken = Core.Nothing, profileId = profileId,
...
instance Core.GoogleRequest DFAReportingAdvertisersList where
        ...
        type Scopes DFAReportingAdvertisersList =
