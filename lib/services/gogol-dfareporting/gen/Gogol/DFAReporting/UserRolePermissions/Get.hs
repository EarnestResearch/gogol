                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] UserRolePermission
...
newDFAReportingUserRolePermissionsGet id profileId
  = DFAReportingUserRolePermissionsGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing, id = id,
                                       profileId = profileId, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingUserRolePermissionsGet
         where
        type Rs DFAReportingUserRolePermissionsGet = UserRolePermission
        type Scopes DFAReportingUserRolePermissionsGet =
