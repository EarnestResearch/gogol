                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] UserRolePermissionsListResponse
...
newDFAReportingUserRolePermissionsList profileId
  = DFAReportingUserRolePermissionsList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        ids = Core.Nothing, profileId = profileId,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingUserRolePermissionsList
         where
        type Rs DFAReportingUserRolePermissionsList =
             UserRolePermissionsListResponse
        type Scopes DFAReportingUserRolePermissionsList =
