                         ...
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "name" Core.Text Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "sortField" TargetableRemarketingListsListSortField
                                 Core.:>
                                 Core.QueryParam "sortOrder" TargetableRemarketingListsListSortOrder
                                   Core.:>
...
newDFAReportingTargetableRemarketingListsList 
    ...
    -> DFAReportingTargetableRemarketingListsList
newDFAReportingTargetableRemarketingListsList advertiserId
  profileId
  = DFAReportingTargetableRemarketingListsList{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, active = Core.Nothing,
                                               advertiserId = advertiserId, callback = Core.Nothing,
                                               maxResults = 1000, name = Core.Nothing,
...
instance Core.GoogleRequest
           DFAReportingTargetableRemarketingListsList
         where
        type Rs DFAReportingTargetableRemarketingListsList =
             TargetableRemarketingListsListResponse
        type Scopes DFAReportingTargetableRemarketingListsList =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingTargetableRemarketingListsList{..}
          = go profileId (Core.Just advertiserId) xgafv accessToken active
              callback
