                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] TargetableRemarketingList
...
newDFAReportingTargetableRemarketingListsGet id profileId
  = DFAReportingTargetableRemarketingListsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DFAReportingTargetableRemarketingListsGet
         where
        type Rs DFAReportingTargetableRemarketingListsGet =
             TargetableRemarketingList
        type Scopes DFAReportingTargetableRemarketingListsGet =
