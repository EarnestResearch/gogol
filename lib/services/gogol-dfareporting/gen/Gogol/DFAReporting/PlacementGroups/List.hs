       ...
       "v4" Core.:>
         "userprofiles" Core.:>
           Core.Capture "profileId" Core.Int64 Core.:>
             "placementGroups" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParams "activeStatus" PlacementGroupsListActiveStatus
                     Core.:>
...
newDFAReportingPlacementGroupsList profileId
  = DFAReportingPlacementGroupsList{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, activeStatus = Core.Nothing,
                                    advertiserIds = Core.Nothing, callback = Core.Nothing,
                                    campaignIds = Core.Nothing, contentCategoryIds = Core.Nothing,
                                    directorySiteIds = Core.Nothing, ids = Core.Nothing,
                                    maxEndDate = Core.Nothing, maxResults = 800,
...
instance Core.GoogleRequest DFAReportingPlacementGroupsList where
        type Rs DFAReportingPlacementGroupsList =
             PlacementGroupsListResponse
        type Scopes DFAReportingPlacementGroupsList =
