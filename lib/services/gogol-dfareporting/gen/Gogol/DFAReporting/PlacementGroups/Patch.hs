                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] PlacementGroup Core.:>
                               Core.Patch '[Core.JSON] PlacementGroup
...
newDFAReportingPlacementGroupsPatch id payload profileId
  = DFAReportingPlacementGroupsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingPlacementGroupsPatch where
        ...
        type Scopes DFAReportingPlacementGroupsPatch =
