               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParams "directories" MobileAppsListDirectories Core.:>
                       Core.QueryParams "ids" Core.Text Core.:>
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] MobileAppsListResponse
...
newDFAReportingMobileAppsList profileId
  = DFAReportingMobileAppsList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               directories = Core.Nothing, ids = Core.Nothing, maxResults = 1000,
                               pageToken = Core.Nothing, profileId = profileId,
                               searchString = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingMobileAppsList where
        ...
        type Scopes DFAReportingMobileAppsList =
