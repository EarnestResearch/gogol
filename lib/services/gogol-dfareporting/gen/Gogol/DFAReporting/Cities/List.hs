               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParams "countryDartIds" Core.Int64 Core.:>
                       Core.QueryParams "dartIds" Core.Int64 Core.:>
                         Core.QueryParam "namePrefix" Core.Text Core.:>
                           Core.QueryParams "regionDartIds" Core.Int64 Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] CitiesListResponse
...
newDFAReportingCitiesList profileId
  = DFAReportingCitiesList{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           countryDartIds = Core.Nothing, dartIds = Core.Nothing,
                           namePrefix = Core.Nothing, profileId = profileId,
                           regionDartIds = Core.Nothing, uploadType = Core.Nothing,
