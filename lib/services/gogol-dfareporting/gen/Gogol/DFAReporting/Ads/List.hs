                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "active" Core.Bool Core.:>
                     Core.QueryParam "advertiserId" Core.Int64 Core.:>
                       Core.QueryParam "archived" Core.Bool Core.:>
                         Core.QueryParams "audienceSegmentIds" Core.Int64 Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParams "campaignIds" Core.Int64 Core.:>
                               Core.QueryParam "compatibility" AdsListCompatibility Core.:>
                                 Core.QueryParams "creativeIds" Core.Int64 Core.:>
                                   Core.QueryParams "creativeOptimizationConfigurationIds"
                                     Core.Int64
                                     Core.:>
                                     Core.QueryParam "dynamicClickTracker" Core.Bool Core.:>
                                       Core.QueryParams "ids" Core.Int64 Core.:>
                                         Core.QueryParams "landingPageIds" Core.Int64 Core.:>
                                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                                             Core.QueryParam "overriddenEventTagId" Core.Int64
                                               Core.:>
                                               Core.QueryParam "pageToken" Core.Text Core.:>
                                                 Core.QueryParams "placementIds" Core.Int64 Core.:>
                                                   Core.QueryParams "remarketingListIds" Core.Int64
                                                     Core.:>
                                                     Core.QueryParam "searchString" Core.Text
                                                       Core.:>
                                                       Core.QueryParams "sizeIds" Core.Int64 Core.:>
                                                         Core.QueryParam "sortField"
                                                           ...
                                                           Core.QueryParam "sortOrder"
                                                             AdsListSortOrder
                                                             Core.:>
                                                             Core.QueryParam "sslCompliant"
                                                               Core.Bool
                                                               Core.:>
                                                               Core.QueryParam "sslRequired"
                                                                 Core.Bool
                                                                 Core.:>
                                                                 Core.QueryParams "type" AdsListType
                                                                   Core.:>
...
newDFAReportingAdsList profileId
  = DFAReportingAdsList{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, active = Core.Nothing,
                        advertiserId = Core.Nothing, archived = Core.Nothing,
                        audienceSegmentIds = Core.Nothing, callback = Core.Nothing,
                        campaignIds = Core.Nothing, compatibility = Core.Nothing,
                        creativeIds = Core.Nothing,
                        creativeOptimizationConfigurationIds = Core.Nothing,
                        dynamicClickTracker = Core.Nothing, ids = Core.Nothing,
                        landingPageIds = Core.Nothing, maxResults = 1000,
                        overriddenEventTagId = Core.Nothing, pageToken = Core.Nothing,
                        placementIds = Core.Nothing, profileId = profileId,
                        remarketingListIds = Core.Nothing, searchString = Core.Nothing,
                        sizeIds = Core.Nothing, sortField = AdsListSortField_ID,
                        sortOrder = AdsListSortOrder_Ascending,
                        sslCompliant = Core.Nothing, sslRequired = Core.Nothing,
                        type' = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DFAReportingAdsList where
        ...
        requestClient DFAReportingAdsList{..}
          = go profileId xgafv accessToken active advertiserId archived
