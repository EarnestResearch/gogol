             ...
             "userRoles" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "accountUserRoleOnly" Core.Bool Core.:>
                         ...
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "searchString" Core.Text Core.:>
                               Core.QueryParam "sortField" UserRolesListSortField Core.:>
                                 Core.QueryParam "sortOrder" UserRolesListSortOrder Core.:>
                                   Core.QueryParam "subaccountId" Core.Int64 Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] UserRolesListResponse
...
newDFAReportingUserRolesList profileId
  = DFAReportingUserRolesList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, accountUserRoleOnly = Core.Nothing,
                              callback = Core.Nothing, ids = Core.Nothing, maxResults = 1000,
                              pageToken = Core.Nothing, profileId = profileId,
                              searchString = Core.Nothing, sortField = UserRolesListSortField_ID,
...
instance Core.GoogleRequest DFAReportingUserRolesList where
        ...
        requestClient DFAReportingUserRolesList{..}
          = go profileId xgafv accessToken accountUserRoleOnly callback
