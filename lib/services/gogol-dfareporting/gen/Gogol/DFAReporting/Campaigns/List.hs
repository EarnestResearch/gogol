             ...
             "campaigns" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParams "advertiserGroupIds" Core.Int64 Core.:>
                     Core.QueryParams "advertiserIds" Core.Int64 Core.:>
                       Core.QueryParam "archived" Core.Bool Core.:>
                         Core.QueryParam "atLeastOneOptimizationActivity" Core.Bool Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParams "excludedIds" Core.Int64 Core.:>
                               Core.QueryParams "ids" Core.Int64 Core.:>
                                 Core.QueryParam "maxResults" Core.Int32 Core.:>
                                   Core.QueryParam "overriddenEventTagId" Core.Int64 Core.:>
                                     Core.QueryParam "pageToken" Core.Text Core.:>
                                       Core.QueryParam "searchString" Core.Text Core.:>
                                         Core.QueryParam "sortField" CampaignsListSortField Core.:>
                                           Core.QueryParam "sortOrder" CampaignsListSortOrder
                                             Core.:>
                                             Core.QueryParam "subaccountId" Core.Int64 Core.:>
                                               Core.QueryParam "uploadType" Core.Text Core.:>
                                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                                     Core.Get '[Core.JSON] CampaignsListResponse
...
newDFAReportingCampaignsList profileId
  = DFAReportingCampaignsList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, advertiserGroupIds = Core.Nothing,
                              advertiserIds = Core.Nothing, archived = Core.Nothing,
                              atLeastOneOptimizationActivity = Core.Nothing,
                              callback = Core.Nothing, excludedIds = Core.Nothing,
                              ids = Core.Nothing, maxResults = 1000,
                              overriddenEventTagId = Core.Nothing, pageToken = Core.Nothing,
                              profileId = profileId, searchString = Core.Nothing,
                              sortField = CampaignsListSortField_ID,
                              sortOrder = CampaignsListSortOrder_Ascending,
                              subaccountId = Core.Nothing, uploadType = Core.Nothing,
                              uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DFAReportingCampaignsList where
        type Rs DFAReportingCampaignsList = CampaignsListResponse
        type Scopes DFAReportingCampaignsList =
