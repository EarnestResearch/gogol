                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] UserRolePermissionGroupsListResponse
...
newDFAReportingUserRolePermissionGroupsList profileId
  = DFAReportingUserRolePermissionGroupsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DFAReportingUserRolePermissionGroupsList
         where
        type Rs DFAReportingUserRolePermissionGroupsList =
             UserRolePermissionGroupsListResponse
        type Scopes DFAReportingUserRolePermissionGroupsList =
