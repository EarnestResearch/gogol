...
newServiceManagementOperationsList 
    :: 
                                   ServiceManagementOperationsList
newServiceManagementOperationsList
  = ServiceManagementOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ServiceManagementOperationsList where
        type Rs ServiceManagementOperationsList = ListOperationsResponse
        type Scopes ServiceManagementOperationsList =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceManagementOperationsList{..}
          = go xgafv accessToken callback filter name pageSize pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceManagementOperationsListResource)
                      Core.mempty
