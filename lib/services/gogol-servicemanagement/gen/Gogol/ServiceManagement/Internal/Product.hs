...
newConfigChange 
    ::  ConfigChange
newConfigChange
  = ConfigChange{advices = Core.Nothing, changeType = Core.Nothing,
                 element = Core.Nothing, newValue' = Core.Nothing,
                 oldValue = Core.Nothing}
instance Core.FromJSON ConfigChange where
        parseJSON
          = Core.withObject "ConfigChange"
              (\ o ->
                 ConfigChange Core.<$>
                   (o Core..:? "advices") Core.<*> (o Core..:? "changeType") Core.<*>
                     (o Core..:? "element")
...
newConfigFile 
    ::  ConfigFile
newConfigFile
  = ConfigFile{fileContents = Core.Nothing, filePath = Core.Nothing,
...
instance Core.FromJSON ConfigFile where
        parseJSON
          = Core.withObject "ConfigFile"
              (\ o ->
                 ConfigFile Core.<$>
                   (o Core..:? "fileContents") Core.<*> (o Core..:? "filePath")
...
instance Core.FromJSON ConfigSource where
        parseJSON
          = Core.withObject "ConfigSource"
              (\ o ->
                 ConfigSource Core.<$>
                   (o Core..:? "files") Core.<*> (o Core..:? "id"))
...
instance Core.FromJSON DeleteServiceStrategy where
        parseJSON
          = Core.withObject "DeleteServiceStrategy"
...
newDiagnostic 
    ::  Diagnostic
newDiagnostic
  = Diagnostic{kind = Core.Nothing, location = Core.Nothing,
               message = Core.Nothing}
instance Core.FromJSON Diagnostic where
        parseJSON
          = Core.withObject "Diagnostic"
              (\ o ->
                 Diagnostic Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "location") Core.<*>
                     (o Core..:? "message"))
...
newFlowErrorDetails 
    ::  FlowErrorDetails
newFlowErrorDetails
  = FlowErrorDetails{exceptionType = Core.Nothing,
                     flowStepId = Core.Nothing}
instance Core.FromJSON FlowErrorDetails where
        parseJSON
          = Core.withObject "FlowErrorDetails"
              (\ o ->
                 FlowErrorDetails Core.<$>
                   (o Core..:? "exceptionType") Core.<*> (o Core..:? "flowStepId"))
...
newGenerateConfigReportRequest 
    ::  GenerateConfigReportRequest
newGenerateConfigReportRequest
  = GenerateConfigReportRequest{newConfig' = Core.Nothing,
                                oldConfig = Core.Nothing}
instance Core.FromJSON GenerateConfigReportRequest where
        parseJSON
          = Core.withObject "GenerateConfigReportRequest"
              (\ o ->
                 GenerateConfigReportRequest Core.<$>
                   (o Core..:? "newConfig") Core.<*> (o Core..:? "oldConfig"))
...
instance Core.FromJSON GenerateConfigReportRequest_NewConfig where
        parseJSON
          = Core.withObject "GenerateConfigReportRequest_NewConfig"
              (\ o ->
                 GenerateConfigReportRequest_NewConfig Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON GenerateConfigReportRequest_OldConfig where
        parseJSON
          = Core.withObject "GenerateConfigReportRequest_OldConfig"
              (\ o ->
                 GenerateConfigReportRequest_OldConfig Core.<$>
                   (Core.parseJSONObject o))
...
newGenerateConfigReportResponse 
    ::  GenerateConfigReportResponse
newGenerateConfigReportResponse
  = GenerateConfigReportResponse{changeReports = Core.Nothing,
                                 diagnostics = Core.Nothing, id = Core.Nothing,
                                 serviceName = Core.Nothing}
instance Core.FromJSON GenerateConfigReportResponse where
        parseJSON
          = Core.withObject "GenerateConfigReportResponse"
              (\ o ->
                 GenerateConfigReportResponse Core.<$>
                   (o Core..:? "changeReports") Core.<*> (o Core..:? "diagnostics")
                     Core.<*> (o Core..:? "id")
...
newListServiceConfigsResponse 
    ::  ListServiceConfigsResponse
newListServiceConfigsResponse
  = ListServiceConfigsResponse{nextPageToken = Core.Nothing,
                               serviceConfigs = Core.Nothing}
instance Core.FromJSON ListServiceConfigsResponse where
        parseJSON
          = Core.withObject "ListServiceConfigsResponse"
              (\ o ->
                 ListServiceConfigsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "serviceConfigs"))
...
newListServiceRolloutsResponse 
    ::  ListServiceRolloutsResponse
newListServiceRolloutsResponse
  = ListServiceRolloutsResponse{nextPageToken = Core.Nothing,
                                rollouts = Core.Nothing}
instance Core.FromJSON ListServiceRolloutsResponse where
        parseJSON
          = Core.withObject "ListServiceRolloutsResponse"
              (\ o ->
                 ListServiceRolloutsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "rollouts"))
...
newManagedService 
    ::  ManagedService
newManagedService
  = ManagedService{producerProjectId = Core.Nothing,
                   serviceName = Core.Nothing}
instance Core.FromJSON ManagedService where
        parseJSON
          = Core.withObject "ManagedService"
              (\ o ->
                 ManagedService Core.<$>
                   (o Core..:? "producerProjectId") Core.<*>
                     (o Core..:? "serviceName"))
...
newOperationInfo 
    ::  OperationInfo
newOperationInfo
  = OperationInfo{metadataType = Core.Nothing,
                  responseType = Core.Nothing}
instance Core.FromJSON OperationInfo where
        parseJSON
          = Core.withObject "OperationInfo"
              (\ o ->
                 OperationInfo Core.<$>
                   (o Core..:? "metadataType") Core.<*> (o Core..:? "responseType"))
...
newOperationMetadata 
    ::  OperationMetadata
newOperationMetadata
  = OperationMetadata{progressPercentage = Core.Nothing,
                      resourceNames = Core.Nothing, startTime = Core.Nothing,
                      steps = Core.Nothing}
...
instance Core.FromJSON ResourceReference where
        parseJSON
          = Core.withObject "ResourceReference"
              (\ o ->
                 ResourceReference Core.<$>
                   (o Core..:? "childType") Core.<*> (o Core..:? "type"))
...
newRollout 
    ::  Rollout
newRollout
  = Rollout{createTime = Core.Nothing, createdBy = Core.Nothing,
            deleteServiceStrategy = Core.Nothing, rolloutId = Core.Nothing,
            serviceName = Core.Nothing, status = Core.Nothing,
            trafficPercentStrategy = Core.Nothing, universe = Core.Nothing}
instance Core.FromJSON Rollout where
        parseJSON
          = Core.withObject "Rollout"
              (\ o ->
                 Rollout Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "createdBy")
                     Core.<*> (o Core..:? "deleteServiceStrategy")
                     Core.<*> (o Core..:? "rolloutId")
                     Core.<*> (o Core..:? "serviceName")
                     Core.<*> (o Core..:? "status")
                     Core.<*> (o Core..:? "trafficPercentStrategy")
                     Core.<*> (o Core..:? "universe"))
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("trafficPercentStrategy" Core..=) Core.<$> trafficPercentStrategy,
                  ("universe" Core..=) Core.<$> universe])
...
instance Core.FromJSON Step where
        parseJSON
          = Core.withObject "Step"
              (\ o ->
                 Step Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "status"))
...
newSubmitConfigSourceRequest 
    ::  SubmitConfigSourceRequest
newSubmitConfigSourceRequest
  = SubmitConfigSourceRequest{configSource = Core.Nothing,
                              validateOnly = Core.Nothing}
instance Core.FromJSON SubmitConfigSourceRequest where
        parseJSON
          = Core.withObject "SubmitConfigSourceRequest"
              (\ o ->
                 SubmitConfigSourceRequest Core.<$>
                   (o Core..:? "configSource") Core.<*> (o Core..:? "validateOnly"))
...
instance Core.FromJSON SubmitConfigSourceResponse where
        parseJSON
          = Core.withObject "SubmitConfigSourceResponse"
              (\ o ->
...
instance Core.FromJSON TrafficPercentStrategy where
        parseJSON
          = Core.withObject "TrafficPercentStrategy"
...
instance Core.FromJSON TrafficPercentStrategy_Percentages where
        parseJSON
          = Core.withObject "TrafficPercentStrategy_Percentages"
              (\ o ->
                 TrafficPercentStrategy_Percentages Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON UndeleteServiceResponse where
        parseJSON
          = Core.withObject "UndeleteServiceResponse"
