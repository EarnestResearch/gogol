...
newConfigSource 
    ::  ConfigSource
newConfigSource = ConfigSource {files = Core.Nothing, id = Core.Nothing}
...
newDiagnostic =
  Diagnostic
    {kind = Core.Nothing, location = Core.Nothing, message = Core.Nothing}
...
instance Core.FromJSON Diagnostic where
        parseJSON
          = Core.withObject "Diagnostic"
              (\ o ->
                 Diagnostic Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "message"))
...
newFlowErrorDetails 
    ::  FlowErrorDetails
newFlowErrorDetails =
  FlowErrorDetails {exceptionType = Core.Nothing, flowStepId = Core.Nothing}
...
newGenerateConfigReportRequest =
  GenerateConfigReportRequest
    {newConfig' = Core.Nothing, oldConfig = Core.Nothing}

instance Core.FromJSON GenerateConfigReportRequest
         where
        parseJSON
          = Core.withObject "GenerateConfigReportRequest"
              (\ o ->
                 GenerateConfigReportRequest Core.<$>
                   (o Core..:? "newConfig") Core.<*>
                     (o Core..:? "oldConfig"))

instance Core.ToJSON GenerateConfigReportRequest
         where
...
instance Core.FromJSON GenerateConfigReportResponse
         where
        parseJSON
          = Core.withObject "GenerateConfigReportResponse"
              (\ o ->
                 GenerateConfigReportResponse Core.<$>
                   (o Core..:? "changeReports") Core.<*>
                     (o Core..:? "diagnostics")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "serviceName"))

instance Core.ToJSON GenerateConfigReportResponse
         where
...
newListServiceConfigsResponse =
  ListServiceConfigsResponse
    {nextPageToken = Core.Nothing, serviceConfigs = Core.Nothing}

instance Core.FromJSON ListServiceConfigsResponse
         where
        parseJSON
...
newListServiceRolloutsResponse =
  ListServiceRolloutsResponse
    {nextPageToken = Core.Nothing, rollouts = Core.Nothing}

instance Core.FromJSON ListServiceRolloutsResponse
         where
        parseJSON
...
instance Core.ToJSON ListServiceRolloutsResponse
         where
...
newManagedService 
    ::  ManagedService
newManagedService =
  ManagedService {producerProjectId = Core.Nothing, serviceName = Core.Nothing}
...
newOperationInfo 
    ::  OperationInfo
newOperationInfo =
  OperationInfo {metadataType = Core.Nothing, responseType = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("deleteServiceStrategy" Core..=) Core.<$>
                    deleteServiceStrategy,
                  ("rolloutId" Core..=) Core.<$> rolloutId,
                  ("serviceName" Core..=) Core.<$> serviceName,
                  ("status" Core..=) Core.<$> status,
                  ("trafficPercentStrategy" Core..=) Core.<$>
                    trafficPercentStrategy])
...
newSubmitConfigSourceRequest =
  SubmitConfigSourceRequest
    {configSource = Core.Nothing, validateOnly = Core.Nothing}

instance Core.FromJSON SubmitConfigSourceRequest
         where
        parseJSON
...
instance Core.FromJSON SubmitConfigSourceResponse
         where
        parseJSON
          = Core.withObject "SubmitConfigSourceResponse"
              (\ o ->
                 SubmitConfigSourceResponse Core.<$>
                   (o Core..:? "serviceConfig"))
...
newTrafficPercentStrategy 
    ::  TrafficPercentStrategy
newTrafficPercentStrategy = TrafficPercentStrategy {percentages = Core.Nothing}
...
instance Core.ToJSON TrafficPercentStrategy where
        toJSON TrafficPercentStrategy{..}
          = Core.object
              (Core.catMaybes
                 [("percentages" Core..=) Core.<$> percentages])
...
newUndeleteServiceResponse 
    ::  UndeleteServiceResponse
newUndeleteServiceResponse = UndeleteServiceResponse {service = Core.Nothing}

instance Core.FromJSON UndeleteServiceResponse where
        parseJSON
          = Core.withObject "UndeleteServiceResponse"
              (\ o ->
                 UndeleteServiceResponse Core.<$>
                   (o Core..:? "service"))
