...
newBigQueryDataTransferProjectsLocationsList name
  = BigQueryDataTransferProjectsLocationsList{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              extraLocationTypes = Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsLocationsList
         where
        type Rs BigQueryDataTransferProjectsLocationsList =
             ListLocationsResponse
        type Scopes BigQueryDataTransferProjectsLocationsList =
             '[Bigquery'FullControl, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient BigQueryDataTransferProjectsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigQueryDataTransferProjectsLocationsListResource)
                      Core.mempty
