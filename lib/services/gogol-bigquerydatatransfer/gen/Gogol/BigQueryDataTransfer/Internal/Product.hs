...
instance Core.FromJSON CheckValidCredsResponse where
        parseJSON
          = Core.withObject "CheckValidCredsResponse"
              (\ o ->
                 CheckValidCredsResponse Core.<$>
                   (o Core..:? "hasValidCreds"))
          ...
          = Core.object
              (Core.catMaybes
                 [("allowedValues" Core..=) Core.<$> allowedValues,
                  ...
                  ("type" Core..=) Core.<$> type',
                  ("validationDescription" Core..=) Core.<$>
                    validationDescription,
                  ("validationHelpUrl" Core..=) Core.<$>
                    validationHelpUrl,
                  ("validationRegex" Core..=) Core.<$>
                    validationRegex])
...
instance Core.FromJSON EnrollDataSourcesRequest where
        parseJSON
          = Core.withObject "EnrollDataSourcesRequest"
              (\ o ->
                 EnrollDataSourcesRequest Core.<$>
                   (o Core..:? "dataSourceIds"))
...
newListDataSourcesResponse =
  ListDataSourcesResponse
    {dataSources = Core.Nothing, nextPageToken = Core.Nothing}
...
newListTransferConfigsResponse =
  ListTransferConfigsResponse
    {nextPageToken = Core.Nothing, transferConfigs = Core.Nothing}

instance Core.FromJSON ListTransferConfigsResponse
         where
        parseJSON
...
instance Core.ToJSON ListTransferConfigsResponse
         where
        toJSON ListTransferConfigsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("transferConfigs" Core..=) Core.<$>
                    transferConfigs])
...
newListTransferLogsResponse =
  ListTransferLogsResponse
    {nextPageToken = Core.Nothing, transferMessages = Core.Nothing}
...
newListTransferRunsResponse =
  ListTransferRunsResponse
    {nextPageToken = Core.Nothing, transferRuns = Core.Nothing}
...
instance Core.ToJSON ScheduleOptions where
        toJSON ScheduleOptions{..}
          = Core.object
              (Core.catMaybes
                 [("disableAutoScheduling" Core..=) Core.<$>
...
instance Core.FromJSON ScheduleTransferRunsRequest
         where
        parseJSON
...
instance Core.ToJSON ScheduleTransferRunsRequest
         where
...
instance Core.FromJSON ScheduleTransferRunsResponse
         where
        parseJSON
          = Core.withObject "ScheduleTransferRunsResponse"
              (\ o ->
                 ScheduleTransferRunsResponse Core.<$>
                   (o Core..:? "runs"))

instance Core.ToJSON ScheduleTransferRunsResponse
         where
...
newStartManualTransferRunsRequest =
  StartManualTransferRunsRequest
    {requestedRunTime = Core.Nothing, requestedTimeRange = Core.Nothing}

instance Core.FromJSON StartManualTransferRunsRequest
         where
        parseJSON
...
instance Core.ToJSON StartManualTransferRunsRequest
         where
        toJSON StartManualTransferRunsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("requestedRunTime" Core..=) Core.<$>
                    requestedRunTime,
                  ("requestedTimeRange" Core..=) Core.<$>
                    requestedTimeRange])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "StartManualTransferRunsResponse"
              (\ o ->
                 StartManualTransferRunsResponse Core.<$>
                   (o Core..:? "runs"))

instance Core.ToJSON StartManualTransferRunsResponse
         where
...
instance Core.ToJSON TransferConfig where
        toJSON TransferConfig{..}
          = Core.object
              (Core.catMaybes
                 [("dataRefreshWindowDays" Core..=) Core.<$>
                    dataRefreshWindowDays,
                  ("dataSourceId" Core..=) Core.<$> dataSourceId,
                  ("datasetRegion" Core..=) Core.<$> datasetRegion,
                  ("destinationDatasetId" Core..=) Core.<$>
                    destinationDatasetId,
                  ("disabled" Core..=) Core.<$> disabled,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("emailPreferences" Core..=) Core.<$>
                    emailPreferences,
                  ("name" Core..=) Core.<$> name,
