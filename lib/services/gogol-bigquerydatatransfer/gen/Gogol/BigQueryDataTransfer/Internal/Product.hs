...
instance Core.FromJSON CheckValidCredsRequest where
        parseJSON
          = Core.withObject "CheckValidCredsRequest"
...
instance Core.FromJSON CheckValidCredsResponse where
        parseJSON
          = Core.withObject "CheckValidCredsResponse"
              (\ o ->
                 CheckValidCredsResponse Core.<$> (o Core..:? "hasValidCreds"))

instance Core.ToJSON CheckValidCredsResponse where
        toJSON CheckValidCredsResponse{..}
          = Core.object
              (Core.catMaybes [("hasValidCreds" Core..=) Core.<$> hasValidCreds])
...
newDataSource 
    ::  DataSource
newDataSource
  = DataSource{authorizationType = Core.Nothing,
               clientId = Core.Nothing, dataRefreshType = Core.Nothing,
               dataSourceId = Core.Nothing,
               defaultDataRefreshWindowDays = Core.Nothing,
               defaultSchedule = Core.Nothing, description = Core.Nothing,
               displayName = Core.Nothing, helpUrl = Core.Nothing,
               manualRunsDisabled = Core.Nothing,
               minimumScheduleInterval = Core.Nothing, name = Core.Nothing,
               parameters = Core.Nothing, scopes = Core.Nothing,
               supportsCustomSchedule = Core.Nothing,
               supportsMultipleTransfers = Core.Nothing,
               transferType = Core.Nothing, updateDeadlineSeconds = Core.Nothing}
instance Core.FromJSON DataSource where
        parseJSON
          = Core.withObject "DataSource"
              (\ o ->
                 DataSource Core.<$>
                   (o Core..:? "authorizationType") Core.<*> (o Core..:? "clientId")
          ...
          = Core.object
              (Core.catMaybes
                 [("authorizationType" Core..=) Core.<$> authorizationType,
                  ...
                  ("defaultDataRefreshWindowDays" Core..=) Core.<$>
                    defaultDataRefreshWindowDays,
                  ("defaultSchedule" Core..=) Core.<$> defaultSchedule,
                  ("description" Core..=) Core.<$> description,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("helpUrl" Core..=) Core.<$> helpUrl,
                  ("manualRunsDisabled" Core..=) Core.<$> manualRunsDisabled,
                  ("minimumScheduleInterval" Core..=) Core.<$>
                    minimumScheduleInterval,
                  ("name" Core..=) Core.<$> name,
                  ("parameters" Core..=) Core.<$> parameters,
                  ("scopes" Core..=) Core.<$> scopes,
                  ("supportsCustomSchedule" Core..=) Core.<$> supportsCustomSchedule,
                  ("supportsMultipleTransfers" Core..=) Core.<$>
                    supportsMultipleTransfers,
                  ("transferType" Core..=) Core.<$> transferType,
                  ("updateDeadlineSeconds" Core..=) Core.<$> updateDeadlineSeconds])
...
newDataSourceParameter 
    ::  DataSourceParameter
newDataSourceParameter
  = DataSourceParameter{allowedValues = Core.Nothing,
                        deprecated = Core.Nothing, description = Core.Nothing,
                        displayName = Core.Nothing, fields = Core.Nothing,
                        immutable = Core.Nothing, maxValue = Core.Nothing,
                        minValue = Core.Nothing, paramId = Core.Nothing,
                        recurse = Core.Nothing, repeated = Core.Nothing,
                        required = Core.Nothing, type' = Core.Nothing,
                        validationDescription = Core.Nothing,
                        validationHelpUrl = Core.Nothing, validationRegex = Core.Nothing}
instance Core.FromJSON DataSourceParameter where
        parseJSON
          = Core.withObject "DataSourceParameter"
              (\ o ->
                 DataSourceParameter Core.<$>
                   (o Core..:? "allowedValues") Core.<*> (o Core..:? "deprecated")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "fields")
          ...
          = Core.object
              (Core.catMaybes
                 [("allowedValues" Core..=) Core.<$> allowedValues,
                  ...
                  ("type" Core..=) Core.<$> type',
                  ("validationDescription" Core..=) Core.<$> validationDescription,
                  ("validationHelpUrl" Core..=) Core.<$> validationHelpUrl,
                  ("validationRegex" Core..=) Core.<$> validationRegex])
...
newEmailPreferences 
    ::  EmailPreferences
newEmailPreferences
  = EmailPreferences{enableFailureEmail = Core.Nothing}
instance Core.FromJSON EmailPreferences where
        parseJSON
          = Core.withObject "EmailPreferences"
              (\ o ->
                 EmailPreferences Core.<$> (o Core..:? "enableFailureEmail"))

instance Core.ToJSON EmailPreferences where
        toJSON EmailPreferences{..}
          = Core.object
              (Core.catMaybes
                 [("enableFailureEmail" Core..=) Core.<$> enableFailureEmail])
...
instance Core.FromJSON EnrollDataSourcesRequest where
        parseJSON
          = Core.withObject "EnrollDataSourcesRequest"
              (\ o ->
                 EnrollDataSourcesRequest Core.<$> (o Core..:? "dataSourceIds"))

instance Core.ToJSON EnrollDataSourcesRequest where
        toJSON EnrollDataSourcesRequest{..}
          = Core.object
              (Core.catMaybes [("dataSourceIds" Core..=) Core.<$> dataSourceIds])


-- | Options customizing EventDriven transfers schedule.
--
-- /See:/ 'newEventDrivenSchedule' smart constructor.
newtype EventDrivenSchedule = EventDrivenSchedule
    {
      ...
      pubsubSubscription :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'EventDrivenSchedule' with the minimum fields required to make a request.
newEventDrivenSchedule 
    ::  EventDrivenSchedule
newEventDrivenSchedule
  = EventDrivenSchedule{pubsubSubscription = Core.Nothing}
instance Core.FromJSON EventDrivenSchedule where
        parseJSON
          = Core.withObject "EventDrivenSchedule"
              (\ o ->
                 EventDrivenSchedule Core.<$> (o Core..:? "pubsubSubscription"))

instance Core.ToJSON EventDrivenSchedule where
        toJSON EventDrivenSchedule{..}
          = Core.object
              (Core.catMaybes
                 [("pubsubSubscription" Core..=) Core.<$> pubsubSubscription])
...
instance Core.FromJSON ListDataSourcesResponse where
        parseJSON
          = Core.withObject "ListDataSourcesResponse"
              (\ o ->
                 ListDataSourcesResponse Core.<$>
                   (o Core..:? "dataSources") Core.<*> (o Core..:? "nextPageToken"))
...
newListTransferConfigsResponse 
    ::  ListTransferConfigsResponse
newListTransferConfigsResponse
  = ListTransferConfigsResponse{nextPageToken = Core.Nothing,
                                transferConfigs = Core.Nothing}
instance Core.FromJSON ListTransferConfigsResponse where
        parseJSON
          = Core.withObject "ListTransferConfigsResponse"
              (\ o ->
                 ListTransferConfigsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "transferConfigs"))
...
instance Core.ToJSON ListTransferConfigsResponse where
        toJSON ListTransferConfigsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("transferConfigs" Core..=) Core.<$> transferConfigs])
...
newListTransferLogsResponse 
    ::  ListTransferLogsResponse
newListTransferLogsResponse
  = ListTransferLogsResponse{nextPageToken = Core.Nothing,
                             transferMessages = Core.Nothing}
instance Core.FromJSON ListTransferLogsResponse where
        parseJSON
          = Core.withObject "ListTransferLogsResponse"
              (\ o ->
                 ListTransferLogsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "transferMessages"))
...
instance Core.ToJSON ListTransferLogsResponse where
        toJSON ListTransferLogsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("transferMessages" Core..=) Core.<$> transferMessages])
...
newListTransferRunsResponse 
    ::  ListTransferRunsResponse
newListTransferRunsResponse
  = ListTransferRunsResponse{nextPageToken = Core.Nothing,
                             transferRuns = Core.Nothing}
instance Core.FromJSON ListTransferRunsResponse where
        parseJSON
          = Core.withObject "ListTransferRunsResponse"
              (\ o ->
                 ListTransferRunsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "transferRuns"))
...
--
-- /See:/ 'newManualSchedule' smart constructor.
data ManualSchedule = ManualSchedule
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ManualSchedule' with the minimum fields required to make a request.
newManualSchedule 
    ::  ManualSchedule
newManualSchedule = ManualSchedule
instance Core.FromJSON ManualSchedule where
        parseJSON
          = Core.withObject "ManualSchedule"
              (\ o -> Core.pure ManualSchedule)

instance Core.ToJSON ManualSchedule where
        toJSON = Core.const Core.emptyObject
...
newScheduleOptions 
    ::  ScheduleOptions
newScheduleOptions
  = ScheduleOptions{disableAutoScheduling = Core.Nothing,
                    endTime = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON ScheduleOptions where
        parseJSON
          = Core.withObject "ScheduleOptions"
              (\ o ->
                 ScheduleOptions Core.<$>
                   (o Core..:? "disableAutoScheduling") Core.<*>
                     (o Core..:? "endTime")
...
instance Core.ToJSON ScheduleOptions where
        toJSON ScheduleOptions{..}
          = Core.object
              (Core.catMaybes
                 [("disableAutoScheduling" Core..=) Core.<$> disableAutoScheduling,
...
--
-- /See:/ 'newScheduleOptionsV2' smart constructor.
data ScheduleOptionsV2 = ScheduleOptionsV2
    {
      -- | Event driven transfer schedule options. If set, the transfer will be scheduled upon events arrial.
      eventDrivenSchedule :: (Core.Maybe EventDrivenSchedule)
      -- | Manual transfer schedule. If set, the transfer run will not be auto-scheduled by the system, unless the client invokes StartManualTransferRuns. This is equivalent to disable/auto/scheduling = true.
    , manualSchedule :: (Core.Maybe ManualSchedule)
      -- | Time based transfer schedule options. This is the default schedule option.
    , timeBasedSchedule :: (Core.Maybe TimeBasedSchedule)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ScheduleOptionsV2' with the minimum fields required to make a request.
newScheduleOptionsV2 
    ::  ScheduleOptionsV2
newScheduleOptionsV2
  = ScheduleOptionsV2{eventDrivenSchedule = Core.Nothing,
                      manualSchedule = Core.Nothing, timeBasedSchedule = Core.Nothing}
instance Core.FromJSON ScheduleOptionsV2 where
        parseJSON
          = Core.withObject "ScheduleOptionsV2"
              (\ o ->
                 ScheduleOptionsV2 Core.<$>
                   (o Core..:? "eventDrivenSchedule") Core.<*>
                     (o Core..:? "manualSchedule")
                     Core.<*> (o Core..:? "timeBasedSchedule"))

instance Core.ToJSON ScheduleOptionsV2 where
        toJSON ScheduleOptionsV2{..}
          = Core.object
              (Core.catMaybes
                 [("eventDrivenSchedule" Core..=) Core.<$> eventDrivenSchedule,
                  ("manualSchedule" Core..=) Core.<$> manualSchedule,
                  ("timeBasedSchedule" Core..=) Core.<$> timeBasedSchedule])
...
newScheduleTransferRunsRequest 
    ::  ScheduleTransferRunsRequest
newScheduleTransferRunsRequest
  = ScheduleTransferRunsRequest{endTime = Core.Nothing,
                                startTime = Core.Nothing}
instance Core.FromJSON ScheduleTransferRunsRequest where
        parseJSON
          = Core.withObject "ScheduleTransferRunsRequest"
              (\ o ->
                 ScheduleTransferRunsRequest Core.<$>
...
instance Core.FromJSON ScheduleTransferRunsResponse where
        parseJSON
          = Core.withObject "ScheduleTransferRunsResponse"
              (\ o -> ScheduleTransferRunsResponse Core.<$> (o Core..:? "runs"))

instance Core.ToJSON ScheduleTransferRunsResponse where
        toJSON ScheduleTransferRunsResponse{..}
          = Core.object (Core.catMaybes [("runs" Core..=) Core.<$> runs])
...
data StartManualTransferRunsRequest = StartManualTransferRunsRequest
    {
      -- | A run/time timestamp for historical data files or reports that are scheduled to be transferred by the scheduled transfer run. requested/run_time must be a past time and cannot include future time values.
      requestedRunTime :: (Core.Maybe Core.DateTime)
      -- | A time/range start and end timestamp for historical data files or reports that are scheduled to be transferred by the scheduled transfer run. requested/time_range must be a past time and cannot include future time values.
...
newStartManualTransferRunsRequest 
    ::  StartManualTransferRunsRequest
newStartManualTransferRunsRequest
  = StartManualTransferRunsRequest{requestedRunTime = Core.Nothing,
                                   requestedTimeRange = Core.Nothing}
instance Core.FromJSON StartManualTransferRunsRequest where
        parseJSON
          = Core.withObject "StartManualTransferRunsRequest"
              (\ o ->
                 StartManualTransferRunsRequest Core.<$>
                   (o Core..:? "requestedRunTime") Core.<*>
                     (o Core..:? "requestedTimeRange"))

instance Core.ToJSON StartManualTransferRunsRequest where
        toJSON StartManualTransferRunsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("requestedRunTime" Core..=) Core.<$> requestedRunTime,
                  ("requestedTimeRange" Core..=) Core.<$> requestedTimeRange])
...
instance Core.FromJSON StartManualTransferRunsResponse where
        parseJSON
          = Core.withObject "StartManualTransferRunsResponse"
              (\ o ->
                 StartManualTransferRunsResponse Core.<$> (o Core..:? "runs"))
...
--
-- /See:/ 'newTimeBasedSchedule' smart constructor.
data TimeBasedSchedule = TimeBasedSchedule
    {
...
-- | Creates a value of 'TimeBasedSchedule' with the minimum fields required to make a request.
newTimeBasedSchedule 
    ::  TimeBasedSchedule
newTimeBasedSchedule
  = TimeBasedSchedule{endTime = Core.Nothing,
                      schedule = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON TimeBasedSchedule where
        parseJSON
          = Core.withObject "TimeBasedSchedule"
              (\ o ->
                 TimeBasedSchedule Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "schedule") Core.<*>
                     (o Core..:? "startTime"))

instance Core.ToJSON TimeBasedSchedule where
        toJSON TimeBasedSchedule{..}
          = Core.object
              (Core.catMaybes
                 [("endTime" Core..=) Core.<$> endTime,
...
newTimeRange 
    ::  TimeRange
newTimeRange
  = TimeRange{endTime = Core.Nothing, startTime = Core.Nothing}
...
data TransferConfig = TransferConfig
    ...
    , scheduleOptionsV2 :: (Core.Maybe ScheduleOptionsV2)
...
newTransferConfig 
    ::  TransferConfig
newTransferConfig
  = TransferConfig{dataRefreshWindowDays = Core.Nothing,
                   dataSourceId = Core.Nothing, datasetRegion = Core.Nothing,
                   destinationDatasetId = Core.Nothing, disabled = Core.Nothing,
                   displayName = Core.Nothing, emailPreferences = Core.Nothing,
                   encryptionConfiguration = Core.Nothing, error = Core.Nothing,
                   name = Core.Nothing, nextRunTime = Core.Nothing,
                   notificationPubsubTopic = Core.Nothing, ownerInfo = Core.Nothing,
                   params = Core.Nothing, schedule = Core.Nothing,
                   scheduleOptions = Core.Nothing, scheduleOptionsV2 = Core.Nothing,
                   state = Core.Nothing, updateTime = Core.Nothing,
                   userId = Core.Nothing}
instance Core.FromJSON TransferConfig where
        parseJSON
          = Core.withObject "TransferConfig"
              (\ o ->
                 TransferConfig Core.<$>
                   (o Core..:? "dataRefreshWindowDays") Core.<*>
                     (o Core..:? "dataSourceId")
...
instance Core.ToJSON TransferConfig where
        toJSON TransferConfig{..}
          = Core.object
              (Core.catMaybes
                 [("dataRefreshWindowDays" Core..=) Core.<$> dataRefreshWindowDays,
                  ("dataSourceId" Core..=) Core.<$> dataSourceId,
                  ("datasetRegion" Core..=) Core.<$> datasetRegion,
                  ("destinationDatasetId" Core..=) Core.<$> destinationDatasetId,
                  ("disabled" Core..=) Core.<$> disabled,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("emailPreferences" Core..=) Core.<$> emailPreferences,
                  ...
                  ("scheduleOptionsV2" Core..=) Core.<$> scheduleOptionsV2,
...
instance Core.FromJSON TransferConfig_Params where
        parseJSON
          = Core.withObject "TransferConfig_Params"
              (\ o -> TransferConfig_Params Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON TransferConfig_Params where
        toJSON TransferConfig_Params{..} = Core.toJSON additional
...
newTransferMessage 
    ::  TransferMessage
newTransferMessage
  = TransferMessage{messageText = Core.Nothing,
                    messageTime = Core.Nothing, severity = Core.Nothing}
instance Core.FromJSON TransferMessage where
        parseJSON
          = Core.withObject "TransferMessage"
              (\ o ->
                 TransferMessage Core.<$>
                   (o Core..:? "messageText") Core.<*> (o Core..:? "messageTime")
...
newTransferRun 
    ::  TransferRun
newTransferRun
  = TransferRun{dataSourceId = Core.Nothing,
                destinationDatasetId = Core.Nothing,
                emailPreferences = Core.Nothing, endTime = Core.Nothing,
                errorStatus = Core.Nothing, name = Core.Nothing,
                notificationPubsubTopic = Core.Nothing, params = Core.Nothing,
                runTime = Core.Nothing, schedule = Core.Nothing,
                scheduleTime = Core.Nothing, startTime = Core.Nothing,
                state = Core.Nothing, updateTime = Core.Nothing,
                userId = Core.Nothing}
instance Core.FromJSON TransferRun where
        parseJSON
          = Core.withObject "TransferRun"
              (\ o ->
                 TransferRun Core.<$>
                   (o Core..:? "dataSourceId") Core.<*>
                     (o Core..:? "destinationDatasetId")
                     Core.<*> (o Core..:? "emailPreferences")
                     Core.<*> (o Core..:? "endTime")
...
newTransferRun_Params 
    :: 
       ...
       -- ^  Properties of the object. See 'additional'.
    -> TransferRun_Params
newTransferRun_Params additional
  = TransferRun_Params{additional = additional}
instance Core.FromJSON TransferRun_Params where
        parseJSON
          = Core.withObject "TransferRun_Params"
              (\ o -> TransferRun_Params Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON TransferRun_Params where
        toJSON TransferRun_Params{..} = Core.toJSON additional


-- | A request to unenroll a set of data sources so they are no longer visible in the BigQuery UI\'s @Transfer@ tab.
--
-- /See:/ 'newUnenrollDataSourcesRequest' smart constructor.
newtype UnenrollDataSourcesRequest = UnenrollDataSourcesRequest
    {
...
-- | Creates a value of 'UnenrollDataSourcesRequest' with the minimum fields required to make a request.
newUnenrollDataSourcesRequest 
    ::  UnenrollDataSourcesRequest
newUnenrollDataSourcesRequest
  = UnenrollDataSourcesRequest{dataSourceIds = Core.Nothing}
instance Core.FromJSON UnenrollDataSourcesRequest where
        parseJSON
          = Core.withObject "UnenrollDataSourcesRequest"
              (\ o ->
                 UnenrollDataSourcesRequest Core.<$> (o Core..:? "dataSourceIds"))

instance Core.ToJSON UnenrollDataSourcesRequest where
        toJSON UnenrollDataSourcesRequest{..}
          = Core.object
              (Core.catMaybes [("dataSourceIds" Core..=) Core.<$> dataSourceIds])
