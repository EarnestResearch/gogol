         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "groupKey.id" Core.Text Core.:>
                 Core.QueryParam "groupKey.namespace" Core.Text
                   Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] LookupGroupNameResponse
...
instance Core.GoogleRequest CloudIdentityGroupsLookup
         where
        type Rs CloudIdentityGroupsLookup =
             LookupGroupNameResponse
        type Scopes CloudIdentityGroupsLookup =
             '[CloudIdentity'Groups,
               CloudIdentity'Groups'Readonly,
               CloudPlatform'FullControl]
        requestClient CloudIdentityGroupsLookup{..}
          = go xgafv accessToken callback groupKeyId
              groupKeyNamespace
              uploadType
              uploadProtocol
