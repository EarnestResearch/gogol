...
instance Core.GoogleRequest
        ...
        requestClient
          CloudIdentityDevicesDeviceUsersLookup{..}
          = go parent xgafv accessToken androidId callback
              pageSize
              pageToken
              rawResourceId
              uploadType
