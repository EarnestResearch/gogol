...
type CloudIdentityDevicesDeviceUsersLookupResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "lookup" Core.Text Core.:>
               ...
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "pageSize" Core.Int32 Core.:>
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "rawResourceId" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "userId" Core.Text Core.:>
...
newCloudIdentityDevicesDeviceUsersLookup parent
  = CloudIdentityDevicesDeviceUsersLookup{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, androidId = Core.Nothing,
                                          callback = Core.Nothing, pageSize = Core.Nothing,
                                          pageToken = Core.Nothing, parent = parent,
                                          rawResourceId = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing, userId = Core.Nothing}
instance Core.GoogleRequest CloudIdentityDevicesDeviceUsersLookup
         where
        type Rs CloudIdentityDevicesDeviceUsersLookup =
             GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse
        type Scopes CloudIdentityDevicesDeviceUsersLookup =
             '[CloudIdentity'Devices'Lookup]
        requestClient CloudIdentityDevicesDeviceUsersLookup{..}
          = go parent xgafv accessToken androidId callback pageSize pageToken
              rawResourceId
              uploadType
              uploadProtocol
              userId
