...
instance Core.FromJSON AddIdpCredentialOperationMetadata where
        parseJSON
          = Core.withObject "AddIdpCredentialOperationMetadata"
              (\ o ->
                 AddIdpCredentialOperationMetadata Core.<$> (o Core..:? "state"))

instance Core.ToJSON AddIdpCredentialOperationMetadata where
...
instance Core.FromJSON CheckTransitiveMembershipResponse where
        parseJSON
...
instance Core.ToJSON CheckTransitiveMembershipResponse where
        toJSON CheckTransitiveMembershipResponse{..}
          = Core.object
              (Core.catMaybes [("hasMembership" Core..=) Core.<$> hasMembership])
...
newCreateInboundSamlSsoProfileOperationMetadata 
    :: 
                                                CreateInboundSamlSsoProfileOperationMetadata
newCreateInboundSamlSsoProfileOperationMetadata
  = CreateInboundSamlSsoProfileOperationMetadata{state =
                                                   Core.Nothing}
instance Core.FromJSON CreateInboundSamlSsoProfileOperationMetadata
         where
        parseJSON
          = Core.withObject "CreateInboundSamlSsoProfileOperationMetadata"
              (\ o ->
                 CreateInboundSamlSsoProfileOperationMetadata Core.<$>
                   (o Core..:? "state"))

instance Core.ToJSON CreateInboundSamlSsoProfileOperationMetadata
         where
        toJSON CreateInboundSamlSsoProfileOperationMetadata{..}
          = Core.object (Core.catMaybes [("state" Core..=) Core.<$> state])
...
newCreateInboundSsoAssignmentOperationMetadata
  = CreateInboundSsoAssignmentOperationMetadata
instance Core.FromJSON CreateInboundSsoAssignmentOperationMetadata
         where
        parseJSON
          = Core.withObject "CreateInboundSsoAssignmentOperationMetadata"
              (\ o -> Core.pure CreateInboundSsoAssignmentOperationMetadata)

instance Core.ToJSON CreateInboundSsoAssignmentOperationMetadata
         where
        toJSON = Core.const Core.emptyObject
...
newDeleteIdpCredentialOperationMetadata
  = DeleteIdpCredentialOperationMetadata
instance Core.FromJSON DeleteIdpCredentialOperationMetadata where
        parseJSON
          = Core.withObject "DeleteIdpCredentialOperationMetadata"
              (\ o -> Core.pure DeleteIdpCredentialOperationMetadata)

instance Core.ToJSON DeleteIdpCredentialOperationMetadata where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON DeleteInboundSamlSsoProfileOperationMetadata
         where
        parseJSON
          = Core.withObject "DeleteInboundSamlSsoProfileOperationMetadata"
              (\ o -> Core.pure DeleteInboundSamlSsoProfileOperationMetadata)

instance Core.ToJSON DeleteInboundSamlSsoProfileOperationMetadata
         where
        toJSON = Core.const Core.emptyObject
...
newDeleteInboundSsoAssignmentOperationMetadata
  = DeleteInboundSsoAssignmentOperationMetadata
instance Core.FromJSON DeleteInboundSsoAssignmentOperationMetadata
         where
        parseJSON
          = Core.withObject "DeleteInboundSsoAssignmentOperationMetadata"
              (\ o -> Core.pure DeleteInboundSsoAssignmentOperationMetadata)

instance Core.ToJSON DeleteInboundSsoAssignmentOperationMetadata
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON DsaPublicKeyInfo where
        parseJSON
          = Core.withObject "DsaPublicKeyInfo"
              (\ o -> DsaPublicKeyInfo Core.<$> (o Core..:? "keySize"))

instance Core.ToJSON DsaPublicKeyInfo where
        toJSON DsaPublicKeyInfo{..}
          = Core.object
              (Core.catMaybes [("keySize" Core..=) Core.<$> keySize])
...
newDynamicGroupMetadata 
    ::  DynamicGroupMetadata
newDynamicGroupMetadata
  = DynamicGroupMetadata{queries = Core.Nothing,
                         status = Core.Nothing}
          ...
          = Core.withObject "DynamicGroupMetadata"
              (\ o ->
                 DynamicGroupMetadata Core.<$>
                   (o Core..:? "queries") Core.<*> (o Core..:? "status"))
...
newDynamicGroupQuery 
    ::  DynamicGroupQuery
newDynamicGroupQuery
  = DynamicGroupQuery{query = Core.Nothing,
          ...
          = Core.withObject "DynamicGroupQuery"
              (\ o ->
                 DynamicGroupQuery Core.<$>
                   (o Core..:? "query") Core.<*> (o Core..:? "resourceType"))
...
newEntityKey 
    ::  EntityKey
newEntityKey
  = EntityKey{id = Core.Nothing, namespace = Core.Nothing}
...
instance Core.FromJSON ExpiryDetail where
        parseJSON
          = Core.withObject "ExpiryDetail"
              (\ o -> ExpiryDetail Core.<$> (o Core..:? "expireTime"))
...
newGetMembershipGraphResponse 
    ::  GetMembershipGraphResponse
newGetMembershipGraphResponse
  = GetMembershipGraphResponse{adjacencyList = Core.Nothing,
                               groups = Core.Nothing}
          ...
          = Core.withObject "GetMembershipGraphResponse"
              (\ o ->
                 GetMembershipGraphResponse Core.<$>
                   (o Core..:? "adjacencyList") Core.<*> (o Core..:? "groups"))
...
newGoogleAppsCloudidentityDevicesV1AndroidAttributes 
    :: 
                                                     GoogleAppsCloudidentityDevicesV1AndroidAttributes
newGoogleAppsCloudidentityDevicesV1AndroidAttributes
  = GoogleAppsCloudidentityDevicesV1AndroidAttributes{ctsProfileMatch
                                                        = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1AndroidAttributes"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1AndroidAttributes Core.<$>
...
instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1AndroidAttributes
         where
        toJSON GoogleAppsCloudidentityDevicesV1AndroidAttributes{..}
          = Core.object
              (Core.catMaybes
                 [("ctsProfileMatch" Core..=) Core.<$> ctsProfileMatch,
                  ("enabledUnknownSources" Core..=) Core.<$> enabledUnknownSources,
                  ("hasPotentiallyHarmfulApps" Core..=) Core.<$>
                    hasPotentiallyHarmfulApps,
                  ("ownerProfileAccount" Core..=) Core.<$> ownerProfileAccount,
                  ("ownershipPrivilege" Core..=) Core.<$> ownershipPrivilege,
...
newGoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequest 
    :: 
                                                            GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequest
newGoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequest
  = GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequest{customer
                                                               = Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequest
         where
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequest"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequest Core.<$>
                   (o Core..:? "customer"))
...
instance Core.ToJSON
        ...
        toJSON GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequest{..}
          = Core.object
              (Core.catMaybes [("customer" Core..=) Core.<$> customer])
...
newGoogleAppsCloudidentityDevicesV1ApproveDeviceUserResponse 
    :: 
                                                             GoogleAppsCloudidentityDevicesV1ApproveDeviceUserResponse
newGoogleAppsCloudidentityDevicesV1ApproveDeviceUserResponse
  = GoogleAppsCloudidentityDevicesV1ApproveDeviceUserResponse{deviceUser
                                                                = Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1ApproveDeviceUserResponse
         where
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1ApproveDeviceUserResponse"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1ApproveDeviceUserResponse Core.<$>
                   (o Core..:? "deviceUser"))
...
instance Core.ToJSON
        ...
        toJSON
          GoogleAppsCloudidentityDevicesV1ApproveDeviceUserResponse{..}
          = Core.object
              (Core.catMaybes [("deviceUser" Core..=) Core.<$> deviceUser])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1BlockDeviceUserMetadata"
              (\ o ->
                 Core.pure GoogleAppsCloudidentityDevicesV1BlockDeviceUserMetadata)
...
newGoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest 
    :: 
                                                          GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest
newGoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest
  = GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest{customer =
                                                             Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest
         where
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest Core.<$>
                   (o Core..:? "customer"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest
         where
        toJSON GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest{..}
          = Core.object
              (Core.catMaybes [("customer" Core..=) Core.<$> customer])
...
newGoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse 
    :: 
                                                           GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse
newGoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse
  = GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse{deviceUser
                                                              = Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse
         where
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse Core.<$>
                   (o Core..:? "deviceUser"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse
         where
        toJSON GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse{..}
          = Core.object
              (Core.catMaybes [("deviceUser" Core..=) Core.<$> deviceUser])
...
newGoogleAppsCloudidentityDevicesV1BrowserAttributes 
    :: 
                                                     GoogleAppsCloudidentityDevicesV1BrowserAttributes
newGoogleAppsCloudidentityDevicesV1BrowserAttributes
  = GoogleAppsCloudidentityDevicesV1BrowserAttributes{chromeBrowserInfo
                                                        = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1BrowserAttributes"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1BrowserAttributes Core.<$>
...
instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1BrowserAttributes
         where
        toJSON GoogleAppsCloudidentityDevicesV1BrowserAttributes{..}
          = Core.object
              (Core.catMaybes
                 [("chromeBrowserInfo" Core..=) Core.<$> chromeBrowserInfo,
                  ("chromeProfileId" Core..=) Core.<$> chromeProfileId,
                  ("lastProfileSyncTime" Core..=) Core.<$> lastProfileSyncTime])
...
newGoogleAppsCloudidentityDevicesV1BrowserInfo 
    :: 
                                               GoogleAppsCloudidentityDevicesV1BrowserInfo
newGoogleAppsCloudidentityDevicesV1BrowserInfo
  = GoogleAppsCloudidentityDevicesV1BrowserInfo{browserManagementState
                                                  = Core.Nothing,
...
instance Core.FromJSON GoogleAppsCloudidentityDevicesV1BrowserInfo
         where
        parseJSON
          = Core.withObject "GoogleAppsCloudidentityDevicesV1BrowserInfo"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1BrowserInfo Core.<$>
                   (o Core..:? "browserManagementState") Core.<*>
                     ...
                     Core.<*> (o Core..:? "isBulkDataEntryAnalysisEnabled")
                     Core.<*> (o Core..:? "isChromeCleanupEnabled")
                     Core.<*> (o Core..:? "isChromeRemoteDesktopAppBlocked")
                     Core.<*> (o Core..:? "isFileDownloadAnalysisEnabled")
                     Core.<*> (o Core..:? "isFileUploadAnalysisEnabled")
                     Core.<*> (o Core..:? "isRealtimeUrlCheckEnabled")
                     Core.<*> (o Core..:? "isSecurityEventAnalysisEnabled")
                     Core.<*> (o Core..:? "isSiteIsolationEnabled")
                     Core.<*> (o Core..:? "isThirdPartyBlockingEnabled")
                     Core.<*> (o Core..:? "passwordProtectionWarningTrigger")
                     Core.<*> (o Core..:? "safeBrowsingProtectionLevel"))

instance Core.ToJSON GoogleAppsCloudidentityDevicesV1BrowserInfo
         where
        toJSON GoogleAppsCloudidentityDevicesV1BrowserInfo{..}
          = Core.object
              (Core.catMaybes
                 [("browserManagementState" Core..=) Core.<$>
                  ...
                  ("isChromeCleanupEnabled" Core..=) Core.<$> isChromeCleanupEnabled,
                  ...
                  ("isSiteIsolationEnabled" Core..=) Core.<$> isSiteIsolationEnabled,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1CancelWipeDeviceMetadata"
              (\ o ->
                 Core.pure GoogleAppsCloudidentityDevicesV1CancelWipeDeviceMetadata)
...
newGoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequest 
    :: 
                                                           GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequest
newGoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequest
  = GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequest{customer
                                                              = Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequest
         where
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequest"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequest Core.<$>
                   (o Core..:? "customer"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequest
         where
        toJSON GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequest{..}
          = Core.object
              (Core.catMaybes [("customer" Core..=) Core.<$> customer])
...
newGoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse 
    :: 
                                                            GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse
newGoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse
  = GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse{device =
                                                               Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse
         where
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse Core.<$>
                   (o Core..:? "device"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse
         where
        toJSON GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse{..}
...
newGoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest 
    :: 
                                                               GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest
newGoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest
  = GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest{customer
                                                                  = Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest
         where
...
newGoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserResponse 
    :: 
                                                                GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserResponse
newGoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserResponse
  = GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserResponse{deviceUser
                                                                   = Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserResponse
         where
...
newGoogleAppsCloudidentityDevicesV1CertificateAttributes 
    :: 
                                                         GoogleAppsCloudidentityDevicesV1CertificateAttributes
newGoogleAppsCloudidentityDevicesV1CertificateAttributes
  = GoogleAppsCloudidentityDevicesV1CertificateAttributes{certificateTemplate
                                                            = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1CertificateAttributes"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1CertificateAttributes Core.<$>
...
instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1CertificateAttributes
         where
        toJSON GoogleAppsCloudidentityDevicesV1CertificateAttributes{..}
          = Core.object
              (Core.catMaybes
                 [("certificateTemplate" Core..=) Core.<$> certificateTemplate,
                  ...
                  ("validityExpirationTime" Core..=) Core.<$> validityExpirationTime,
                  ("validityStartTime" Core..=) Core.<$> validityStartTime])
...
newGoogleAppsCloudidentityDevicesV1CertificateTemplate 
    :: 
                                                       GoogleAppsCloudidentityDevicesV1CertificateTemplate
newGoogleAppsCloudidentityDevicesV1CertificateTemplate
  = GoogleAppsCloudidentityDevicesV1CertificateTemplate{id =
                                                          Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1CertificateTemplate"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1CertificateTemplate Core.<$>
...
instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1CertificateTemplate
         where
        toJSON GoogleAppsCloudidentityDevicesV1CertificateTemplate{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id,
...
newGoogleAppsCloudidentityDevicesV1ClientState 
    :: 
                                               GoogleAppsCloudidentityDevicesV1ClientState
newGoogleAppsCloudidentityDevicesV1ClientState
  = GoogleAppsCloudidentityDevicesV1ClientState{assetTags =
                                                  Core.Nothing,
                                                complianceState = Core.Nothing,
                                                createTime = Core.Nothing, customId = Core.Nothing,
                                                etag = Core.Nothing, healthScore = Core.Nothing,
                                                keyValuePairs = Core.Nothing,
                                                lastUpdateTime = Core.Nothing,
                                                managed = Core.Nothing, name = Core.Nothing,
                                                ownerType = Core.Nothing,
                                                scoreReason = Core.Nothing}
instance Core.FromJSON GoogleAppsCloudidentityDevicesV1ClientState
         where
        parseJSON
          = Core.withObject "GoogleAppsCloudidentityDevicesV1ClientState"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1ClientState Core.<$>
                   (o Core..:? "assetTags") Core.<*> (o Core..:? "complianceState")
...
instance Core.ToJSON GoogleAppsCloudidentityDevicesV1ClientState
         where
        toJSON GoogleAppsCloudidentityDevicesV1ClientState{..}
          = Core.object
              (Core.catMaybes
...
newGoogleAppsCloudidentityDevicesV1ClientState_KeyValuePairs
  additional
  = GoogleAppsCloudidentityDevicesV1ClientState_KeyValuePairs{additional
                                                                = additional}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1ClientState_KeyValuePairs
         where
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1ClientState_KeyValuePairs"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1ClientState_KeyValuePairs Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1CreateDeviceMetadata"
              (\ o ->
                 Core.pure GoogleAppsCloudidentityDevicesV1CreateDeviceMetadata)
...
newGoogleAppsCloudidentityDevicesV1CustomAttributeValue 
    :: 
                                                        GoogleAppsCloudidentityDevicesV1CustomAttributeValue
newGoogleAppsCloudidentityDevicesV1CustomAttributeValue
  = GoogleAppsCloudidentityDevicesV1CustomAttributeValue{boolValue =
                                                           Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1CustomAttributeValue"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1CustomAttributeValue Core.<$>
                   (o Core..:? "boolValue") Core.<*> (o Core..:? "numberValue")
                     Core.<*> (o Core..:? "stringValue"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1CustomAttributeValue
         where
        toJSON GoogleAppsCloudidentityDevicesV1CustomAttributeValue{..}
          = Core.object
              (Core.catMaybes
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1DeleteDeviceMetadata"
              (\ o ->
                 Core.pure GoogleAppsCloudidentityDevicesV1DeleteDeviceMetadata)
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1DeleteDeviceUserMetadata"
              (\ o ->
                 Core.pure GoogleAppsCloudidentityDevicesV1DeleteDeviceUserMetadata)
...
newGoogleAppsCloudidentityDevicesV1Device 
    :: 
                                          GoogleAppsCloudidentityDevicesV1Device
newGoogleAppsCloudidentityDevicesV1Device
  = GoogleAppsCloudidentityDevicesV1Device{androidSpecificAttributes
                                             = Core.Nothing,
                                           assetTag = Core.Nothing, basebandVersion = Core.Nothing,
                                           bootloaderVersion = Core.Nothing, brand = Core.Nothing,
                                           buildNumber = Core.Nothing,
                                           compromisedState = Core.Nothing,
                                           createTime = Core.Nothing, deviceId = Core.Nothing,
                                           ...
                                           hostname = Core.Nothing, imei = Core.Nothing,
                                           ...
                                           networkOperator = Core.Nothing, osVersion = Core.Nothing,
                                           otherAccounts = Core.Nothing, ownerType = Core.Nothing,
                                           releaseVersion = Core.Nothing,
                                           securityPatchTime = Core.Nothing,
                                           serialNumber = Core.Nothing,
                                           unifiedDeviceId = Core.Nothing,
                                           wifiMacAddresses = Core.Nothing}
instance Core.FromJSON GoogleAppsCloudidentityDevicesV1Device where
        parseJSON
          = Core.withObject "GoogleAppsCloudidentityDevicesV1Device"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1Device Core.<$>
                   (o Core..:? "androidSpecificAttributes") Core.<*>
                     ...
                     Core.<*> (o Core..:? "endpointVerificationSpecificAttributes")
...
instance Core.ToJSON GoogleAppsCloudidentityDevicesV1Device where
          ...
          = Core.object
              (Core.catMaybes
                 [("androidSpecificAttributes" Core..=) Core.<$>
                  ...
                  ("compromisedState" Core..=) Core.<$> compromisedState,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("deviceId" Core..=) Core.<$> deviceId,
                  ("deviceType" Core..=) Core.<$> deviceType,
                  ("enabledDeveloperOptions" Core..=) Core.<$>
                    enabledDeveloperOptions,
                  ("enabledUsbDebugging" Core..=) Core.<$> enabledUsbDebugging,
                  ("encryptionState" Core..=) Core.<$> encryptionState,
                  ("endpointVerificationSpecificAttributes" Core..=) Core.<$>
                  ...
                  ("securityPatchTime" Core..=) Core.<$> securityPatchTime,
                  ("serialNumber" Core..=) Core.<$> serialNumber,
                  ("unifiedDeviceId" Core..=) Core.<$> unifiedDeviceId,
                  ("wifiMacAddresses" Core..=) Core.<$> wifiMacAddresses])
...
newGoogleAppsCloudidentityDevicesV1DeviceUser 
    :: 
                                              GoogleAppsCloudidentityDevicesV1DeviceUser
newGoogleAppsCloudidentityDevicesV1DeviceUser
  = GoogleAppsCloudidentityDevicesV1DeviceUser{compromisedState =
                                                 Core.Nothing,
                                               createTime = Core.Nothing,
                                               firstSyncTime = Core.Nothing,
                                               languageCode = Core.Nothing,
                                               lastSyncTime = Core.Nothing,
                                               managementState = Core.Nothing, name = Core.Nothing,
                                               passwordState = Core.Nothing,
                                               userAgent = Core.Nothing, userEmail = Core.Nothing}
instance Core.FromJSON GoogleAppsCloudidentityDevicesV1DeviceUser
         where
        parseJSON
          = Core.withObject "GoogleAppsCloudidentityDevicesV1DeviceUser"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1DeviceUser Core.<$>
                   (o Core..:? "compromisedState") Core.<*> (o Core..:? "createTime")
...
newGoogleAppsCloudidentityDevicesV1EndpointVerificationSpecificAttributes 
    :: 
                                                                          GoogleAppsCloudidentityDevicesV1EndpointVerificationSpecificAttributes
newGoogleAppsCloudidentityDevicesV1EndpointVerificationSpecificAttributes
  = GoogleAppsCloudidentityDevicesV1EndpointVerificationSpecificAttributes{additionalSignals
                                                                             = Core.Nothing,
                                                                           browserAttributes =
                                                                             Core.Nothing,
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalSignals" Core..=) Core.<$> additionalSignals,
                  ("browserAttributes" Core..=) Core.<$> browserAttributes,
                  ("certificateAttributes" Core..=) Core.<$> certificateAttributes])
...
newGoogleAppsCloudidentityDevicesV1EndpointVerificationSpecificAttributes_AdditionalSignals
  additional
  = GoogleAppsCloudidentityDevicesV1EndpointVerificationSpecificAttributes_AdditionalSignals{additional
                                                                                               =
                                                                                               additional}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1EndpointVerificationSpecificAttributes_AdditionalSignals
...
newGoogleAppsCloudidentityDevicesV1ListClientStatesResponse 
    :: 
                                                            GoogleAppsCloudidentityDevicesV1ListClientStatesResponse
newGoogleAppsCloudidentityDevicesV1ListClientStatesResponse
  = GoogleAppsCloudidentityDevicesV1ListClientStatesResponse{clientStates
                                                               = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1ListClientStatesResponse"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1ListClientStatesResponse Core.<$>
                   (o Core..:? "clientStates") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1ListClientStatesResponse
         where
        toJSON GoogleAppsCloudidentityDevicesV1ListClientStatesResponse{..}
          = Core.object
              (Core.catMaybes
...
newGoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse 
    :: 
                                                           GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse
newGoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse
  = GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse{deviceUsers
                                                              = Core.Nothing,
                                                            nextPageToken = Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse Core.<$>
                   (o Core..:? "deviceUsers") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse
         where
        toJSON GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse{..}
          = Core.object
              (Core.catMaybes
...
newGoogleAppsCloudidentityDevicesV1ListDevicesResponse 
    :: 
                                                       GoogleAppsCloudidentityDevicesV1ListDevicesResponse
newGoogleAppsCloudidentityDevicesV1ListDevicesResponse
  = GoogleAppsCloudidentityDevicesV1ListDevicesResponse{devices =
                                                          Core.Nothing,
                                                        nextPageToken = Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1ListDevicesResponse
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1ListDevicesResponse"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1ListDevicesResponse Core.<$>
                   (o Core..:? "devices") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1ListDevicesResponse
         where
        toJSON GoogleAppsCloudidentityDevicesV1ListDevicesResponse{..}
          = Core.object
              (Core.catMaybes
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1ListEndpointAppsMetadata"
              (\ o ->
                 Core.pure GoogleAppsCloudidentityDevicesV1ListEndpointAppsMetadata)
...
newGoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse 
    :: 
                                                                 GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse
newGoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse
  = GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse{customer
                                                                    = Core.Nothing,
                                                                  names = Core.Nothing,
                                                                  nextPageToken = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse
                   Core.<$>
                   (o Core..:? "customer") Core.<*> (o Core..:? "names") Core.<*>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1UpdateDeviceMetadata"
              (\ o ->
                 Core.pure GoogleAppsCloudidentityDevicesV1UpdateDeviceMetadata)
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1WipeDeviceMetadata"
              (\ o ->
                 Core.pure GoogleAppsCloudidentityDevicesV1WipeDeviceMetadata)
...
newGoogleAppsCloudidentityDevicesV1WipeDeviceRequest 
    :: 
                                                     GoogleAppsCloudidentityDevicesV1WipeDeviceRequest
newGoogleAppsCloudidentityDevicesV1WipeDeviceRequest
  = GoogleAppsCloudidentityDevicesV1WipeDeviceRequest{customer =
                                                        Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1WipeDeviceRequest"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1WipeDeviceRequest Core.<$>
                   (o Core..:? "customer") Core.<*> (o Core..:? "removeResetLock"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1WipeDeviceRequest
         where
        toJSON GoogleAppsCloudidentityDevicesV1WipeDeviceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("customer" Core..=) Core.<$> customer,
                  ("removeResetLock" Core..=) Core.<$> removeResetLock])
...
newGoogleAppsCloudidentityDevicesV1WipeDeviceResponse 
    :: 
                                                      GoogleAppsCloudidentityDevicesV1WipeDeviceResponse
newGoogleAppsCloudidentityDevicesV1WipeDeviceResponse
  = GoogleAppsCloudidentityDevicesV1WipeDeviceResponse{device =
                                                         Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1WipeDeviceResponse
         where
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1WipeDeviceResponse"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1WipeDeviceResponse Core.<$>
                   (o Core..:? "device"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1WipeDeviceResponse
         where
        toJSON GoogleAppsCloudidentityDevicesV1WipeDeviceResponse{..}
          = Core.object (Core.catMaybes [("device" Core..=) Core.<$> device])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1WipeDeviceUserMetadata"
              (\ o ->
                 Core.pure GoogleAppsCloudidentityDevicesV1WipeDeviceUserMetadata)
...
newGoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest 
    :: 
                                                         GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest
newGoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest
  = GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest{customer =
                                                            Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest
         where
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest Core.<$>
                   (o Core..:? "customer"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest
         where
        toJSON GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest{..}
          = Core.object
              (Core.catMaybes [("customer" Core..=) Core.<$> customer])
...
newGoogleAppsCloudidentityDevicesV1WipeDeviceUserResponse 
    :: 
                                                          GoogleAppsCloudidentityDevicesV1WipeDeviceUserResponse
newGoogleAppsCloudidentityDevicesV1WipeDeviceUserResponse
  = GoogleAppsCloudidentityDevicesV1WipeDeviceUserResponse{deviceUser
                                                             = Core.Nothing}
instance Core.FromJSON
           GoogleAppsCloudidentityDevicesV1WipeDeviceUserResponse
         where
        parseJSON
          = Core.withObject
              "GoogleAppsCloudidentityDevicesV1WipeDeviceUserResponse"
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1WipeDeviceUserResponse Core.<$>
                   (o Core..:? "deviceUser"))

instance Core.ToJSON
           GoogleAppsCloudidentityDevicesV1WipeDeviceUserResponse
         where
        toJSON GoogleAppsCloudidentityDevicesV1WipeDeviceUserResponse{..}
          = Core.object
              (Core.catMaybes [("deviceUser" Core..=) Core.<$> deviceUser])
...
newGroup 
    ::  Group
newGroup
  = Group{additionalGroupKeys = Core.Nothing,
          createTime = Core.Nothing, description = Core.Nothing,
          displayName = Core.Nothing, dynamicGroupMetadata = Core.Nothing,
          groupKey = Core.Nothing, labels = Core.Nothing,
          name = Core.Nothing, parent = Core.Nothing,
...
instance Core.ToJSON Group where
        toJSON Group{..}
          = Core.object
              (Core.catMaybes
                 [("additionalGroupKeys" Core..=) Core.<$> additionalGroupKeys,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("description" Core..=) Core.<$> description,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("dynamicGroupMetadata" Core..=) Core.<$> dynamicGroupMetadata,
...
instance Core.FromJSON Group_Labels where
        parseJSON
          = Core.withObject "Group_Labels"
              (\ o -> Group_Labels Core.<$> (Core.parseJSONObject o))
...
newGroupRelation 
    ::  GroupRelation
newGroupRelation
  = GroupRelation{displayName = Core.Nothing, group' = Core.Nothing,
                  groupKey = Core.Nothing, labels = Core.Nothing,
                  relationType = Core.Nothing, roles = Core.Nothing}
instance Core.FromJSON GroupRelation where
        parseJSON
          = Core.withObject "GroupRelation"
              (\ o ->
                 GroupRelation Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "group") Core.<*>
                     (o Core..:? "groupKey")
                     Core.<*> (o Core..:? "labels")
...
instance Core.FromJSON GroupRelation_Labels where
        parseJSON
          = Core.withObject "GroupRelation_Labels"
              (\ o -> GroupRelation_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON GroupRelation_Labels where
        toJSON GroupRelation_Labels{..} = Core.toJSON additional
...
newIdpCredential 
    ::  IdpCredential
newIdpCredential
  = IdpCredential{dsaKeyInfo = Core.Nothing, name = Core.Nothing,
                  rsaKeyInfo = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON IdpCredential where
        parseJSON
          = Core.withObject "IdpCredential"
              (\ o ->
                 IdpCredential Core.<$>
                   (o Core..:? "dsaKeyInfo") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "rsaKeyInfo")
                     Core.<*> (o Core..:? "updateTime"))
...
newInboundSamlSsoProfile 
    ::  InboundSamlSsoProfile
newInboundSamlSsoProfile
  = InboundSamlSsoProfile{customer = Core.Nothing,
                          displayName = Core.Nothing, idpConfig = Core.Nothing,
                          name = Core.Nothing, spConfig = Core.Nothing}
instance Core.FromJSON InboundSamlSsoProfile where
        parseJSON
          = Core.withObject "InboundSamlSsoProfile"
              (\ o ->
                 InboundSamlSsoProfile Core.<$>
                   (o Core..:? "customer") Core.<*> (o Core..:? "displayName")
...
newInboundSsoAssignment 
    ::  InboundSsoAssignment
newInboundSsoAssignment
  = InboundSsoAssignment{customer = Core.Nothing,
                         name = Core.Nothing, rank = Core.Nothing,
                         samlSsoInfo = Core.Nothing, signInBehavior = Core.Nothing,
                         ssoMode = Core.Nothing, targetGroup = Core.Nothing,
          ...
          = Core.withObject "InboundSsoAssignment"
              (\ o ->
                 InboundSsoAssignment Core.<$>
                   (o Core..:? "customer") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "rank")
...
instance Core.ToJSON InboundSsoAssignment where
        toJSON InboundSsoAssignment{..}
          = Core.object
              (Core.catMaybes
                 [("customer" Core..=) Core.<$> customer,
                  ("name" Core..=) Core.<$> name, ("rank" Core..=) Core.<$> rank,
...
instance Core.FromJSON IsInvitableUserResponse where
        parseJSON
          = Core.withObject "IsInvitableUserResponse"
              (\ o ->
                 IsInvitableUserResponse Core.<$> (o Core..:? "isInvitableUser"))

instance Core.ToJSON IsInvitableUserResponse where
        toJSON IsInvitableUserResponse{..}
          = Core.object
              (Core.catMaybes
                 [("isInvitableUser" Core..=) Core.<$> isInvitableUser])
          ...
          = Core.withObject "ListGroupsResponse"
              (\ o ->
                 ListGroupsResponse Core.<$>
                   (o Core..:? "groups") Core.<*> (o Core..:? "nextPageToken"))
...
newListIdpCredentialsResponse 
    ::  ListIdpCredentialsResponse
newListIdpCredentialsResponse
  = ListIdpCredentialsResponse{idpCredentials = Core.Nothing,
                               nextPageToken = Core.Nothing}
...
newListInboundSamlSsoProfilesResponse 
    :: 
                                      ListInboundSamlSsoProfilesResponse
newListInboundSamlSsoProfilesResponse
  = ListInboundSamlSsoProfilesResponse{inboundSamlSsoProfiles =
                                         Core.Nothing,
                                       nextPageToken = Core.Nothing}
instance Core.FromJSON ListInboundSamlSsoProfilesResponse where
        parseJSON
          = Core.withObject "ListInboundSamlSsoProfilesResponse"
              (\ o ->
                 ListInboundSamlSsoProfilesResponse Core.<$>
                   (o Core..:? "inboundSamlSsoProfiles") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListInboundSamlSsoProfilesResponse where
...
newListInboundSsoAssignmentsResponse 
    :: 
                                     ListInboundSsoAssignmentsResponse
newListInboundSsoAssignmentsResponse
  = ListInboundSsoAssignmentsResponse{inboundSsoAssignments =
                                        Core.Nothing,
                                      nextPageToken = Core.Nothing}
instance Core.FromJSON ListInboundSsoAssignmentsResponse where
        parseJSON
...
instance Core.ToJSON ListInboundSsoAssignmentsResponse where
        toJSON ListInboundSsoAssignmentsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("inboundSsoAssignments" Core..=) Core.<$> inboundSsoAssignments,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListUserInvitationsResponse 
    ::  ListUserInvitationsResponse
newListUserInvitationsResponse
  = ListUserInvitationsResponse{nextPageToken = Core.Nothing,
...
instance Core.ToJSON ListUserInvitationsResponse where
        toJSON ListUserInvitationsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("userInvitations" Core..=) Core.<$> userInvitations])
...
instance Core.FromJSON LookupMembershipNameResponse where
        parseJSON
          = Core.withObject "LookupMembershipNameResponse"
              (\ o -> LookupMembershipNameResponse Core.<$> (o Core..:? "name"))
...
newMemberRelation 
    ::  MemberRelation
newMemberRelation
  = MemberRelation{member = Core.Nothing,
                   preferredMemberKey = Core.Nothing, relationType = Core.Nothing,
                   roles = Core.Nothing}
instance Core.FromJSON MemberRelation where
        parseJSON
          = Core.withObject "MemberRelation"
              (\ o ->
                 MemberRelation Core.<$>
                   (o Core..:? "member") Core.<*> (o Core..:? "preferredMemberKey")
                     Core.<*> (o Core..:? "relationType")
                     Core.<*> (o Core..:? "roles"))
          ...
          = Core.object
              (Core.catMaybes
                 [("member" Core..=) Core.<$> member,
                  ("preferredMemberKey" Core..=) Core.<$> preferredMemberKey,
                  ("relationType" Core..=) Core.<$> relationType,
                  ("roles" Core..=) Core.<$> roles])
...
newMemberRestriction 
    ::  MemberRestriction
newMemberRestriction
  = MemberRestriction{evaluation = Core.Nothing,
                      query = Core.Nothing}
          ...
          = Core.withObject "MemberRestriction"
              (\ o ->
                 MemberRestriction Core.<$>
                   (o Core..:? "evaluation") Core.<*> (o Core..:? "query"))
...
newMembership 
    ::  Membership
newMembership
  = Membership{createTime = Core.Nothing,
               deliverySetting = Core.Nothing, name = Core.Nothing,
               preferredMemberKey = Core.Nothing, roles = Core.Nothing,
               type' = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON Membership where
        parseJSON
          = Core.withObject "Membership"
              (\ o ->
                 Membership Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "deliverySetting")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("preferredMemberKey" Core..=) Core.<$> preferredMemberKey,
                  ("roles" Core..=) Core.<$> roles, ("type" Core..=) Core.<$> type',
                  ("updateTime" Core..=) Core.<$> updateTime])
...
newMembershipAdjacencyList 
    ::  MembershipAdjacencyList
newMembershipAdjacencyList
  = MembershipAdjacencyList{edges = Core.Nothing,
                            group' = Core.Nothing}
...
newMembershipRelation 
    ::  MembershipRelation
newMembershipRelation
  = MembershipRelation{description = Core.Nothing,
                       displayName = Core.Nothing, group' = Core.Nothing,
                       groupKey = Core.Nothing, labels = Core.Nothing,
                       membership = Core.Nothing, roles = Core.Nothing}
...
instance Core.FromJSON MembershipRelation_Labels where
        parseJSON
          = Core.withObject "MembershipRelation_Labels"
              (\ o ->
                 MembershipRelation_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON MembershipRelation_Labels where
        toJSON MembershipRelation_Labels{..} = Core.toJSON additional
...
newMembershipRole 
    ::  MembershipRole
newMembershipRole
  = MembershipRole{expiryDetail = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON MembershipRole where
        parseJSON
          = Core.withObject "MembershipRole"
              (\ o ->
                 MembershipRole Core.<$>
                   (o Core..:? "expiryDetail") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "restrictionEvaluations"))
...
instance Core.FromJSON MembershipRoleRestrictionEvaluation where
        parseJSON
          = Core.withObject "MembershipRoleRestrictionEvaluation"
              (\ o ->
                 MembershipRoleRestrictionEvaluation Core.<$> (o Core..:? "state"))

instance Core.ToJSON MembershipRoleRestrictionEvaluation where
...
newModifyMembershipRolesRequest 
    ::  ModifyMembershipRolesRequest
newModifyMembershipRolesRequest
  = ModifyMembershipRolesRequest{addRoles = Core.Nothing,
                                 removeRoles = Core.Nothing, updateRolesParams = Core.Nothing}
          ...
          = Core.withObject "ModifyMembershipRolesRequest"
              (\ o ->
                 ModifyMembershipRolesRequest Core.<$>
                   (o Core..:? "addRoles") Core.<*> (o Core..:? "removeRoles")
          ...
          = Core.object
              (Core.catMaybes
                 [("addRoles" Core..=) Core.<$> addRoles,
                  ...
                  ("updateRolesParams" Core..=) Core.<$> updateRolesParams])
...
instance Core.FromJSON ModifyMembershipRolesResponse where
        parseJSON
          = Core.withObject "ModifyMembershipRolesResponse"
              (\ o ->
                 ModifyMembershipRolesResponse Core.<$> (o Core..:? "membership"))
...
newPolicy 
    ::  Policy
newPolicy
  = Policy{customer = Core.Nothing, name = Core.Nothing,
           policyQuery = Core.Nothing, setting = Core.Nothing,
           type' = Core.Nothing}
...
newPolicyQuery 
    ::  PolicyQuery
newPolicyQuery
  = PolicyQuery{group' = Core.Nothing, orgUnit = Core.Nothing,
                query = Core.Nothing, sortOrder = Core.Nothing}
instance Core.FromJSON PolicyQuery where
        parseJSON
          = Core.withObject "PolicyQuery"
              (\ o ->
                 PolicyQuery Core.<$>
                   (o Core..:? "group") Core.<*> (o Core..:? "orgUnit") Core.<*>
                     (o Core..:? "query")
...
newRestrictionEvaluations 
    ::  RestrictionEvaluations
newRestrictionEvaluations
  = RestrictionEvaluations{memberRestrictionEvaluation =
                             Core.Nothing}
...
instance Core.FromJSON RsaPublicKeyInfo where
        parseJSON
          = Core.withObject "RsaPublicKeyInfo"
              (\ o -> RsaPublicKeyInfo Core.<$> (o Core..:? "keySize"))
...
newSamlIdpConfig 
    ::  SamlIdpConfig
newSamlIdpConfig
  = SamlIdpConfig{changePasswordUri = Core.Nothing,
                  entityId = Core.Nothing, logoutRedirectUri = Core.Nothing,
...
instance Core.FromJSON SamlIdpConfig where
        parseJSON
          = Core.withObject "SamlIdpConfig"
              (\ o ->
                 SamlIdpConfig Core.<$>
                   (o Core..:? "changePasswordUri") Core.<*> (o Core..:? "entityId")
...
instance Core.ToJSON SamlIdpConfig where
        toJSON SamlIdpConfig{..}
          = Core.object
              (Core.catMaybes
                 [("changePasswordUri" Core..=) Core.<$> changePasswordUri,
                  ("entityId" Core..=) Core.<$> entityId,
                  ("logoutRedirectUri" Core..=) Core.<$> logoutRedirectUri,
...
newSamlSpConfig 
    ::  SamlSpConfig
newSamlSpConfig
  = SamlSpConfig{assertionConsumerServiceUri = Core.Nothing,
...
instance Core.FromJSON SamlSsoInfo where
        parseJSON
          = Core.withObject "SamlSsoInfo"
              (\ o -> SamlSsoInfo Core.<$> (o Core..:? "inboundSamlSsoProfile"))

instance Core.ToJSON SamlSsoInfo where
        toJSON SamlSsoInfo{..}
          = Core.object
              (Core.catMaybes
                 [("inboundSamlSsoProfile" Core..=) Core.<$> inboundSamlSsoProfile])
...
newSearchDirectGroupsResponse 
    ::  SearchDirectGroupsResponse
newSearchDirectGroupsResponse
  = SearchDirectGroupsResponse{memberships = Core.Nothing,
                               nextPageToken = Core.Nothing}
...
newSearchGroupsResponse 
    ::  SearchGroupsResponse
newSearchGroupsResponse
  = SearchGroupsResponse{groups = Core.Nothing,
                         nextPageToken = Core.Nothing}
...
newSearchTransitiveGroupsResponse 
    ::  SearchTransitiveGroupsResponse
newSearchTransitiveGroupsResponse
  = SearchTransitiveGroupsResponse{memberships = Core.Nothing,
                                   nextPageToken = Core.Nothing}
...
newSearchTransitiveMembershipsResponse 
    :: 
                                       SearchTransitiveMembershipsResponse
newSearchTransitiveMembershipsResponse
  = SearchTransitiveMembershipsResponse{memberships = Core.Nothing,
                                        nextPageToken = Core.Nothing}
instance Core.FromJSON SearchTransitiveMembershipsResponse where
        parseJSON
          = Core.withObject "SearchTransitiveMembershipsResponse"
              (\ o ->
                 SearchTransitiveMembershipsResponse Core.<$>
                   (o Core..:? "memberships") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON SearchTransitiveMembershipsResponse where
...
newSecuritySettings 
    ::  SecuritySettings
newSecuritySettings
  = SecuritySettings{memberRestriction = Core.Nothing,
                     name = Core.Nothing}
          ...
          = Core.withObject "SecuritySettings"
              (\ o ->
                 SecuritySettings Core.<$>
                   (o Core..:? "memberRestriction") Core.<*> (o Core..:? "name"))

instance Core.ToJSON SecuritySettings where
        toJSON SecuritySettings{..}
          = Core.object
              (Core.catMaybes
                 [("memberRestriction" Core..=) Core.<$> memberRestriction,
                  ("name" Core..=) Core.<$> name])
...
instance Core.FromJSON Setting where
        parseJSON
          = Core.withObject "Setting"
              (\ o ->
                 Setting Core.<$> (o Core..:? "type") Core.<*> (o Core..:? "value"))
...
newSetting_Value 
    :: 
       ...
       -- ^  Properties of the object. See 'additional'.
    -> Setting_Value
newSetting_Value additional
  = Setting_Value{additional = additional}
instance Core.FromJSON Setting_Value where
        parseJSON
          = Core.withObject "Setting_Value"
              (\ o -> Setting_Value Core.<$> (Core.parseJSONObject o))
...
newSignInBehavior 
    ::  SignInBehavior
newSignInBehavior
  = SignInBehavior{redirectCondition = Core.Nothing}
instance Core.FromJSON SignInBehavior where
        parseJSON
          = Core.withObject "SignInBehavior"
              (\ o -> SignInBehavior Core.<$> (o Core..:? "redirectCondition"))

instance Core.ToJSON SignInBehavior where
        toJSON SignInBehavior{..}
          = Core.object
              (Core.catMaybes
                 [("redirectCondition" Core..=) Core.<$> redirectCondition])
...
newUpdateInboundSamlSsoProfileOperationMetadata 
    :: 
                                                UpdateInboundSamlSsoProfileOperationMetadata
newUpdateInboundSamlSsoProfileOperationMetadata
  = UpdateInboundSamlSsoProfileOperationMetadata{state =
                                                   Core.Nothing}
instance Core.FromJSON UpdateInboundSamlSsoProfileOperationMetadata
         where
        parseJSON
          = Core.withObject "UpdateInboundSamlSsoProfileOperationMetadata"
              (\ o ->
                 UpdateInboundSamlSsoProfileOperationMetadata Core.<$>
                   (o Core..:? "state"))

instance Core.ToJSON UpdateInboundSamlSsoProfileOperationMetadata
         where
        toJSON UpdateInboundSamlSsoProfileOperationMetadata{..}
          = Core.object (Core.catMaybes [("state" Core..=) Core.<$> state])
...
newUpdateInboundSsoAssignmentOperationMetadata
  = UpdateInboundSsoAssignmentOperationMetadata
instance Core.FromJSON UpdateInboundSsoAssignmentOperationMetadata
         where
        parseJSON
          = Core.withObject "UpdateInboundSsoAssignmentOperationMetadata"
              (\ o -> Core.pure UpdateInboundSsoAssignmentOperationMetadata)

instance Core.ToJSON UpdateInboundSsoAssignmentOperationMetadata
         where
        toJSON = Core.const Core.emptyObject
...
newUpdateMembershipRolesParams 
    ::  UpdateMembershipRolesParams
newUpdateMembershipRolesParams
  = UpdateMembershipRolesParams{fieldMask = Core.Nothing,
...
newUserInvitation 
    ::  UserInvitation
newUserInvitation
  = UserInvitation{mailsSentCount = Core.Nothing,
...
instance Core.FromJSON UserInvitation where
        parseJSON
          = Core.withObject "UserInvitation"
              (\ o ->
                 UserInvitation Core.<$>
                   (o Core..:? "mailsSentCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "updateTime"))
...
instance Core.ToJSON UserInvitation where
        toJSON UserInvitation{..}
          = Core.object
              (Core.catMaybes
                 [("mailsSentCount" Core..=) Core.. Core.AsText Core.<$>
                    mailsSentCount,
