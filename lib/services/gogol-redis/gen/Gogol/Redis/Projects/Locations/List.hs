...
type RedisProjectsLocationsListResource =
     "v1" Core.:>
...
-- | Lists information about the supported locations for this service.
--
-- /See:/ 'newRedisProjectsLocationsList' smart constructor.
data RedisProjectsLocationsList = RedisProjectsLocationsList
    {
      -- | V1 error format.
...
-- | Creates a value of 'RedisProjectsLocationsList' with the minimum fields required to make a request.
newRedisProjectsLocationsList 
    :: 
                              Core.Text
       -- ^  The resource that owns the locations collection, if applicable. See 'name'.
    -> RedisProjectsLocationsList
newRedisProjectsLocationsList name
  = RedisProjectsLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest RedisProjectsLocationsList where
        type Rs RedisProjectsLocationsList = ListLocationsResponse
        type Scopes RedisProjectsLocationsList =
        ...
        requestClient RedisProjectsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy RedisProjectsLocationsListResource)
                      Core.mempty
