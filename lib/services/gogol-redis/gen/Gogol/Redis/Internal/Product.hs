...
newAutomatedBackupConfig 
    ::  AutomatedBackupConfig
newAutomatedBackupConfig
  = AutomatedBackupConfig{automatedBackupMode = Core.Nothing,
                          fixedFrequencySchedule = Core.Nothing, retention = Core.Nothing}
instance Core.FromJSON AutomatedBackupConfig where
        parseJSON
          = Core.withObject "AutomatedBackupConfig"
              (\ o ->
                 AutomatedBackupConfig Core.<$>
                   (o Core..:? "automatedBackupMode") Core.<*>
                     (o Core..:? "fixedFrequencySchedule")
...
newAvailabilityConfiguration 
    ::  AvailabilityConfiguration
newAvailabilityConfiguration
  = AvailabilityConfiguration{automaticFailoverRoutingConfigured =
                                Core.Nothing,
...
instance Core.FromJSON AvailabilityConfiguration where
        parseJSON
          = Core.withObject "AvailabilityConfiguration"
              (\ o ->
                 AvailabilityConfiguration Core.<$>
                   (o Core..:? "automaticFailoverRoutingConfigured") Core.<*>
                     (o Core..:? "availabilityType")
...
instance Core.ToJSON AvailabilityConfiguration where
        toJSON AvailabilityConfiguration{..}
          = Core.object
              (Core.catMaybes
                 [("automaticFailoverRoutingConfigured" Core..=) Core.<$>
                    automaticFailoverRoutingConfigured,
                  ("availabilityType" Core..=) Core.<$> availabilityType,
                  ("crossRegionReplicaConfigured" Core..=) Core.<$>
                    crossRegionReplicaConfigured,
                  ("externalReplicaConfigured" Core..=) Core.<$>
                    externalReplicaConfigured,
                  ("promotableReplicaConfigured" Core..=) Core.<$>
...
newBackup 
    ::  Backup
newBackup
  = Backup{backupFiles = Core.Nothing, backupType = Core.Nothing,
           cluster = Core.Nothing, clusterUid = Core.Nothing,
           createTime = Core.Nothing, encryptionInfo = Core.Nothing,
           engineVersion = Core.Nothing, expireTime = Core.Nothing,
           name = Core.Nothing, nodeType = Core.Nothing,
           replicaCount = Core.Nothing, shardCount = Core.Nothing,
           state = Core.Nothing, totalSizeBytes = Core.Nothing,
           uid = Core.Nothing}
instance Core.FromJSON Backup where
        parseJSON
          = Core.withObject "Backup"
              (\ o ->
                 Backup Core.<$>
                   (o Core..:? "backupFiles") Core.<*> (o Core..:? "backupType")
                     Core.<*> (o Core..:? "cluster")
                     ...
                     Core.<*> (o Core..:? "state")
                     Core.<*>
                     (o Core..:? "totalSizeBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "uid"))
          ...
          = Core.object
              (Core.catMaybes
                 [("backupFiles" Core..=) Core.<$> backupFiles,
                  ...
                  ("totalSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    totalSizeBytes,
                  ("uid" Core..=) Core.<$> uid])
...
instance Core.FromJSON BackupClusterRequest where
        parseJSON
          = Core.withObject "BackupClusterRequest"
              (\ o ->
                 BackupClusterRequest Core.<$>
                   (o Core..:? "backupId") Core.<*> (o Core..:? "ttl"))
...
newBackupCollection 
    ::  BackupCollection
newBackupCollection
  = BackupCollection{cluster = Core.Nothing,
                     clusterUid = Core.Nothing, createTime = Core.Nothing,
                     kmsKey = Core.Nothing, name = Core.Nothing, uid = Core.Nothing}
instance Core.FromJSON BackupCollection where
        parseJSON
          = Core.withObject "BackupCollection"
              (\ o ->
                 BackupCollection Core.<$>
                   (o Core..:? "cluster") Core.<*> (o Core..:? "clusterUid") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "kmsKey")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "uid"))
          ...
          = Core.object
              (Core.catMaybes
                 [("cluster" Core..=) Core.<$> cluster,
                  ("clusterUid" Core..=) Core.<$> clusterUid,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("kmsKey" Core..=) Core.<$> kmsKey, ("name" Core..=) Core.<$> name,
                  ("uid" Core..=) Core.<$> uid])
...
newBackupConfiguration 
    ::  BackupConfiguration
newBackupConfiguration
  = BackupConfiguration{automatedBackupEnabled = Core.Nothing,
          ...
          = Core.withObject "BackupConfiguration"
              (\ o ->
                 BackupConfiguration Core.<$>
                   (o Core..:? "automatedBackupEnabled") Core.<*>
                     (o Core..:? "backupRetentionSettings")
...
instance Core.ToJSON BackupConfiguration where
        toJSON BackupConfiguration{..}
          = Core.object
              (Core.catMaybes
                 [("automatedBackupEnabled" Core..=) Core.<$>
...
newBackupFile 
    ::  BackupFile
newBackupFile
  = BackupFile{createTime = Core.Nothing, fileName = Core.Nothing,
               sizeBytes = Core.Nothing}
instance Core.FromJSON BackupFile where
        parseJSON
          = Core.withObject "BackupFile"
              (\ o ->
                 BackupFile Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "fileName") Core.<*>
...
newBackupRun 
    ::  BackupRun
newBackupRun
  = BackupRun{endTime = Core.Nothing, error = Core.Nothing,
...
instance Core.FromJSON BackupRun where
        parseJSON
          = Core.withObject "BackupRun"
              (\ o ->
                 BackupRun Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "error") Core.<*>
                     (o Core..:? "startTime")
                     Core.<*> (o Core..:? "status"))
...
newCertificateAuthority 
    ::  CertificateAuthority
newCertificateAuthority
  = CertificateAuthority{managedServerCa = Core.Nothing,
                         name = Core.Nothing}
instance Core.FromJSON CertificateAuthority where
        parseJSON
          = Core.withObject "CertificateAuthority"
              (\ o ->
                 CertificateAuthority Core.<$>
                   (o Core..:? "managedServerCa") Core.<*> (o Core..:? "name"))
...
data Cluster = Cluster
    ...
    , simulateMaintenanceEvent :: (Core.Maybe Core.Bool)
...
newCluster 
    ::  Cluster
newCluster
  = Cluster{asyncClusterEndpointsDeletionEnabled = Core.Nothing,
            authorizationMode = Core.Nothing,
            automatedBackupConfig = Core.Nothing,
            backupCollection = Core.Nothing, clusterEndpoints = Core.Nothing,
            createTime = Core.Nothing,
            crossClusterReplicationConfig = Core.Nothing,
            deletionProtectionEnabled = Core.Nothing,
            discoveryEndpoints = Core.Nothing, encryptionInfo = Core.Nothing,
            gcsSource = Core.Nothing, kmsKey = Core.Nothing,
            maintenancePolicy = Core.Nothing,
            maintenanceSchedule = Core.Nothing,
            managedBackupSource = Core.Nothing, name = Core.Nothing,
            nodeType = Core.Nothing, ondemandMaintenance = Core.Nothing,
            persistenceConfig = Core.Nothing, preciseSizeGb = Core.Nothing,
            pscConfigs = Core.Nothing, pscConnections = Core.Nothing,
            pscServiceAttachments = Core.Nothing, redisConfigs = Core.Nothing,
            replicaCount = Core.Nothing, shardCount = Core.Nothing,
            simulateMaintenanceEvent = Core.Nothing, sizeGb = Core.Nothing,
            state = Core.Nothing, stateInfo = Core.Nothing,
            transitEncryptionMode = Core.Nothing, uid = Core.Nothing,
...
instance Core.FromJSON Cluster where
        parseJSON
          = Core.withObject "Cluster"
              (\ o ->
                 Cluster Core.<$>
                   (o Core..:? "asyncClusterEndpointsDeletionEnabled") Core.<*>
                     (o Core..:? "authorizationMode")
                     ...
                     Core.<*> (o Core..:? "replicaCount")
                     Core.<*> (o Core..:? "shardCount")
                     Core.<*> (o Core..:? "simulateMaintenanceEvent")
                     Core.<*> (o Core..:? "sizeGb")
                     Core.<*> (o Core..:? "state")
...
instance Core.ToJSON Cluster where
        toJSON Cluster{..}
          = Core.object
              (Core.catMaybes
                 [("asyncClusterEndpointsDeletionEnabled" Core..=) Core.<$>
                  ...
                  ("createTime" Core..=) Core.<$> createTime,
                  ("crossClusterReplicationConfig" Core..=) Core.<$>
                    crossClusterReplicationConfig,
                  ...
                  ("replicaCount" Core..=) Core.<$> replicaCount,
                  ("shardCount" Core..=) Core.<$> shardCount,
                  ("simulateMaintenanceEvent" Core..=) Core.<$>
                  ...
                  ("uid" Core..=) Core.<$> uid,
                  ("zoneDistributionConfig" Core..=) Core.<$>
                    zoneDistributionConfig])
...
instance Core.FromJSON Cluster_RedisConfigs where
        parseJSON
          = Core.withObject "Cluster_RedisConfigs"
...
instance Core.FromJSON ClusterEndpoint where
        parseJSON
          = Core.withObject "ClusterEndpoint"
...
newClusterMaintenancePolicy 
    ::  ClusterMaintenancePolicy
newClusterMaintenancePolicy
  = ClusterMaintenancePolicy{createTime = Core.Nothing,
                             updateTime = Core.Nothing, weeklyMaintenanceWindow = Core.Nothing}
instance Core.FromJSON ClusterMaintenancePolicy where
        parseJSON
          = Core.withObject "ClusterMaintenancePolicy"
              (\ o ->
                 ClusterMaintenancePolicy Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "updateTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("weeklyMaintenanceWindow" Core..=) Core.<$>
                    weeklyMaintenanceWindow])
...
newClusterMaintenanceSchedule 
    ::  ClusterMaintenanceSchedule
newClusterMaintenanceSchedule
  = ClusterMaintenanceSchedule{endTime = Core.Nothing,
                               startTime = Core.Nothing}
instance Core.FromJSON ClusterMaintenanceSchedule where
        parseJSON
          = Core.withObject "ClusterMaintenanceSchedule"
              (\ o ->
                 ClusterMaintenanceSchedule Core.<$>
...
newClusterPersistenceConfig 
    ::  ClusterPersistenceConfig
newClusterPersistenceConfig
  = ClusterPersistenceConfig{aofConfig = Core.Nothing,
                             mode = Core.Nothing, rdbConfig = Core.Nothing}
instance Core.FromJSON ClusterPersistenceConfig where
        parseJSON
          = Core.withObject "ClusterPersistenceConfig"
              (\ o ->
                 ClusterPersistenceConfig Core.<$>
                   (o Core..:? "aofConfig") Core.<*> (o Core..:? "mode") Core.<*>
                     (o Core..:? "rdbConfig"))
...
newClusterWeeklyMaintenanceWindow 
    ::  ClusterWeeklyMaintenanceWindow
newClusterWeeklyMaintenanceWindow
  = ClusterWeeklyMaintenanceWindow{day = Core.Nothing,
                                   startTime = Core.Nothing}
instance Core.FromJSON ClusterWeeklyMaintenanceWindow where
        parseJSON
          = Core.withObject "ClusterWeeklyMaintenanceWindow"
              (\ o ->
                 ClusterWeeklyMaintenanceWindow Core.<$>
                   (o Core..:? "day") Core.<*> (o Core..:? "startTime"))
...
instance Core.FromJSON Compliance where
        parseJSON
          = Core.withObject "Compliance"
              (\ o ->
                 Compliance Core.<$>
                   (o Core..:? "standard") Core.<*> (o Core..:? "version"))
...
newConnectionDetail 
    ::  ConnectionDetail
newConnectionDetail
  = ConnectionDetail{pscAutoConnection = Core.Nothing,
                     pscConnection = Core.Nothing}
instance Core.FromJSON ConnectionDetail where
        parseJSON
          = Core.withObject "ConnectionDetail"
              (\ o ->
                 ConnectionDetail Core.<$>
                   (o Core..:? "pscAutoConnection") Core.<*>
                     (o Core..:? "pscConnection"))
...
newCrossClusterReplicationConfig 
    ::  CrossClusterReplicationConfig
newCrossClusterReplicationConfig
  = CrossClusterReplicationConfig{clusterRole = Core.Nothing,
                                  membership = Core.Nothing, primaryCluster = Core.Nothing,
                                  secondaryClusters = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON CrossClusterReplicationConfig where
        parseJSON
          = Core.withObject "CrossClusterReplicationConfig"
              (\ o ->
                 CrossClusterReplicationConfig Core.<$>
                   (o Core..:? "clusterRole") Core.<*> (o Core..:? "membership")
...
instance Core.FromJSON CustomMetadataData where
        parseJSON
          = Core.withObject "CustomMetadataData"
              (\ o ->
                 CustomMetadataData Core.<$>
                   (o Core..:? "internalResourceMetadata"))

instance Core.ToJSON CustomMetadataData where
        toJSON CustomMetadataData{..}
          = Core.object
              (Core.catMaybes
                 [("internalResourceMetadata" Core..=) Core.<$>
                    internalResourceMetadata])
...
newDatabaseResourceFeed 
    ::  DatabaseResourceFeed
newDatabaseResourceFeed
  = DatabaseResourceFeed{feedTimestamp = Core.Nothing,
                         feedType = Core.Nothing, observabilityMetricData = Core.Nothing,
                         recommendationSignalData = Core.Nothing,
                         resourceHealthSignalData = Core.Nothing, resourceId = Core.Nothing,
                         resourceMetadata = Core.Nothing}
instance Core.FromJSON DatabaseResourceFeed where
        parseJSON
          = Core.withObject "DatabaseResourceFeed"
              (\ o ->
                 DatabaseResourceFeed Core.<$>
                   (o Core..:? "feedTimestamp") Core.<*> (o Core..:? "feedType")
          ...
          = Core.object
              (Core.catMaybes
                 [("feedTimestamp" Core..=) Core.<$> feedTimestamp,
                  ...
                  ("observabilityMetricData" Core..=) Core.<$>
                    observabilityMetricData,
                  ("recommendationSignalData" Core..=) Core.<$>
                    recommendationSignalData,
                  ("resourceHealthSignalData" Core..=) Core.<$>
...
newDatabaseResourceHealthSignalData 
    :: 
                                    DatabaseResourceHealthSignalData
newDatabaseResourceHealthSignalData
  = DatabaseResourceHealthSignalData{additionalMetadata =
                                       Core.Nothing,
                                     compliance = Core.Nothing, description = Core.Nothing,
                                     eventTime = Core.Nothing, externalUri = Core.Nothing,
                                     location = Core.Nothing, name = Core.Nothing,
                                     provider = Core.Nothing, resourceContainer = Core.Nothing,
                                     resourceName = Core.Nothing, signalClass = Core.Nothing,
                                     signalId = Core.Nothing, signalSeverity = Core.Nothing,
                                     signalType = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON DatabaseResourceHealthSignalData where
        parseJSON
          = Core.withObject "DatabaseResourceHealthSignalData"
              (\ o ->
                 DatabaseResourceHealthSignalData Core.<$>
                   (o Core..:? "additionalMetadata") Core.<*>
                     (o Core..:? "compliance")
...
newDatabaseResourceHealthSignalData_AdditionalMetadata additional
  = DatabaseResourceHealthSignalData_AdditionalMetadata{additional =
                                                          additional}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "DatabaseResourceHealthSignalData_AdditionalMetadata"
              (\ o ->
                 DatabaseResourceHealthSignalData_AdditionalMetadata Core.<$>
...
newDatabaseResourceId 
    ::  DatabaseResourceId
newDatabaseResourceId
  = DatabaseResourceId{provider = Core.Nothing,
                       providerDescription = Core.Nothing, resourceType = Core.Nothing,
                       uniqueId = Core.Nothing}
instance Core.FromJSON DatabaseResourceId where
        parseJSON
          = Core.withObject "DatabaseResourceId"
              (\ o ->
                 DatabaseResourceId Core.<$>
                   (o Core..:? "provider") Core.<*> (o Core..:? "providerDescription")
...
newDatabaseResourceMetadata 
    ::  DatabaseResourceMetadata
newDatabaseResourceMetadata
  = DatabaseResourceMetadata{availabilityConfiguration =
                               Core.Nothing,
                             backupConfiguration = Core.Nothing, backupRun = Core.Nothing,
                             creationTime = Core.Nothing, currentState = Core.Nothing,
                             customMetadata = Core.Nothing, edition = Core.Nothing,
                             entitlements = Core.Nothing, expectedState = Core.Nothing,
                             gcbdrConfiguration = Core.Nothing, id = Core.Nothing,
                             instanceType = Core.Nothing, location = Core.Nothing,
                             machineConfiguration = Core.Nothing,
                             primaryResourceId = Core.Nothing,
                             primaryResourceLocation = Core.Nothing, product = Core.Nothing,
                             resourceContainer = Core.Nothing, resourceName = Core.Nothing,
                             suspensionReason = Core.Nothing, tagsSet = Core.Nothing,
                             updationTime = Core.Nothing, userLabelSet = Core.Nothing}
instance Core.FromJSON DatabaseResourceMetadata where
        parseJSON
          = Core.withObject "DatabaseResourceMetadata"
              (\ o ->
                 DatabaseResourceMetadata Core.<$>
                   (o Core..:? "availabilityConfiguration") Core.<*>
                     (o Core..:? "backupConfiguration")
...
instance Core.ToJSON DatabaseResourceMetadata where
        toJSON DatabaseResourceMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("availabilityConfiguration" Core..=) Core.<$>
                    availabilityConfiguration,
                  ...
                  ("primaryResourceLocation" Core..=) Core.<$>
...
newDatabaseResourceRecommendationSignalData 
    :: 
                                            DatabaseResourceRecommendationSignalData
newDatabaseResourceRecommendationSignalData
  = DatabaseResourceRecommendationSignalData{additionalMetadata =
                                               Core.Nothing,
                                             ...
                                             resourceName = Core.Nothing, signalType = Core.Nothing}
instance Core.FromJSON DatabaseResourceRecommendationSignalData
         where
        parseJSON
          = Core.withObject "DatabaseResourceRecommendationSignalData"
              (\ o ->
                 DatabaseResourceRecommendationSignalData Core.<$>
                   (o Core..:? "additionalMetadata") Core.<*>
                     (o Core..:? "lastRefreshTime")
...
newDatabaseResourceRecommendationSignalData_AdditionalMetadata
  additional
  = DatabaseResourceRecommendationSignalData_AdditionalMetadata{additional
                                                                  = additional}
instance Core.FromJSON
           DatabaseResourceRecommendationSignalData_AdditionalMetadata
         where
...
newDiscoveryEndpoint 
    ::  DiscoveryEndpoint
newDiscoveryEndpoint
  = DiscoveryEndpoint{address = Core.Nothing, port = Core.Nothing,
                      pscConfig = Core.Nothing}
instance Core.FromJSON DiscoveryEndpoint where
        parseJSON
          = Core.withObject "DiscoveryEndpoint"
              (\ o ->
                 DiscoveryEndpoint Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "port") Core.<*>
                     (o Core..:? "pscConfig"))
...
newEncryptionInfo 
    ::  EncryptionInfo
newEncryptionInfo
  = EncryptionInfo{encryptionType = Core.Nothing,
                   kmsKeyPrimaryState = Core.Nothing, kmsKeyVersions = Core.Nothing,
...
instance Core.FromJSON EncryptionInfo where
        parseJSON
          = Core.withObject "EncryptionInfo"
              (\ o ->
                 EncryptionInfo Core.<$>
                   (o Core..:? "encryptionType") Core.<*>
                     (o Core..:? "kmsKeyPrimaryState")
...
newEntitlement 
    ::  Entitlement
newEntitlement
  = Entitlement{entitlementState = Core.Nothing,
                type' = Core.Nothing}
instance Core.FromJSON Entitlement where
        parseJSON
          = Core.withObject "Entitlement"
              (\ o ->
                 Entitlement Core.<$>
                   (o Core..:? "entitlementState") Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON ExportBackupRequest where
        parseJSON
          = Core.withObject "ExportBackupRequest"
...
instance Core.FromJSON ExportInstanceRequest where
        parseJSON
          = Core.withObject "ExportInstanceRequest"
...
instance Core.FromJSON FailoverInstanceRequest where
        parseJSON
          = Core.withObject "FailoverInstanceRequest"
              (\ o ->
...
instance Core.FromJSON FixedFrequencySchedule where
        parseJSON
          = Core.withObject "FixedFrequencySchedule"
...
instance Core.FromJSON GCBDRConfiguration where
        parseJSON
          = Core.withObject "GCBDRConfiguration"
...
instance Core.FromJSON GcsBackupSource where
        parseJSON
          = Core.withObject "GcsBackupSource"
...
instance Core.FromJSON GoogleCloudRedisV1LocationMetadata where
        parseJSON
          = Core.withObject "GoogleCloudRedisV1LocationMetadata"
              (\ o ->
                 GoogleCloudRedisV1LocationMetadata Core.<$>
                   (o Core..:? "availableZones"))
...
newGoogleCloudRedisV1LocationMetadata_AvailableZones additional
  = GoogleCloudRedisV1LocationMetadata_AvailableZones{additional =
                                                        additional}
instance Core.FromJSON
           GoogleCloudRedisV1LocationMetadata_AvailableZones
         where
        parseJSON
          = Core.withObject
              "GoogleCloudRedisV1LocationMetadata_AvailableZones"
              (\ o ->
                 GoogleCloudRedisV1LocationMetadata_AvailableZones Core.<$>
                   (Core.parseJSONObject o))
...
newGoogleCloudRedisV1OperationMetadata 
    :: 
                                       GoogleCloudRedisV1OperationMetadata
newGoogleCloudRedisV1OperationMetadata
  = GoogleCloudRedisV1OperationMetadata{apiVersion = Core.Nothing,
...
instance Core.FromJSON GoogleCloudRedisV1OperationMetadata where
        parseJSON
          = Core.withObject "GoogleCloudRedisV1OperationMetadata"
              (\ o ->
                 GoogleCloudRedisV1OperationMetadata Core.<$>
...
instance Core.FromJSON GoogleCloudRedisV1ZoneMetadata where
        parseJSON
          = Core.withObject "GoogleCloudRedisV1ZoneMetadata"
...
instance Core.FromJSON ImportInstanceRequest where
        parseJSON
          = Core.withObject "ImportInstanceRequest"
...
newInstance 
    ::  Instance
newInstance
  = Instance{alternativeLocationId = Core.Nothing,
             authEnabled = Core.Nothing, authorizedNetwork = Core.Nothing,
             availableMaintenanceVersions = Core.Nothing,
             connectMode = Core.Nothing, createTime = Core.Nothing,
             currentLocationId = Core.Nothing,
             customerManagedKey = Core.Nothing, displayName = Core.Nothing,
             host = Core.Nothing, labels = Core.Nothing,
             locationId = Core.Nothing, maintenancePolicy = Core.Nothing,
             maintenanceSchedule = Core.Nothing,
             maintenanceVersion = Core.Nothing, memorySizeGb = Core.Nothing,
             name = Core.Nothing, nodes = Core.Nothing,
             persistenceConfig = Core.Nothing,
             persistenceIamIdentity = Core.Nothing, port = Core.Nothing,
             readEndpoint = Core.Nothing, readEndpointPort = Core.Nothing,
             readReplicasMode = Core.Nothing, redisConfigs = Core.Nothing,
             redisVersion = Core.Nothing, replicaCount = Core.Nothing,
             reservedIpRange = Core.Nothing, satisfiesPzi = Core.Nothing,
             satisfiesPzs = Core.Nothing, secondaryIpRange = Core.Nothing,
             serverCaCerts = Core.Nothing, state = Core.Nothing,
             statusMessage = Core.Nothing, suspensionReasons = Core.Nothing,
             tags = Core.Nothing, tier = Core.Nothing,
...
instance Core.FromJSON Instance where
        parseJSON
          = Core.withObject "Instance"
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "alternativeLocationId") Core.<*>
                     (o Core..:? "authEnabled")
          ...
          = Core.object
              (Core.catMaybes
                 [("alternativeLocationId" Core..=) Core.<$> alternativeLocationId,
                  ...
                  ("host" Core..=) Core.<$> host, ("labels" Core..=) Core.<$> labels,
...
instance Core.FromJSON Instance_RedisConfigs where
        parseJSON
          = Core.withObject "Instance_RedisConfigs"
...
-- | Optional. Input only. Immutable. Tag keys\/values directly bound to this resource. For example: \"123\/environment\": \"production\", \"123\/costCenter\": \"marketing\"
--
-- /See:/ 'newInstance_Tags' smart constructor.
newtype Instance_Tags = Instance_Tags
    {
...
-- | Creates a value of 'Instance_Tags' with the minimum fields required to make a request.
newInstance_Tags 
    :: 
                 Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Instance_Tags
newInstance_Tags additional
  = Instance_Tags{additional = additional}
instance Core.FromJSON Instance_Tags where
        parseJSON
          = Core.withObject "Instance_Tags"
              (\ o -> Instance_Tags Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Instance_Tags where
        toJSON Instance_Tags{..} = Core.toJSON additional
...
instance Core.FromJSON InstanceAuthString where
        parseJSON
          = Core.withObject "InstanceAuthString"
...
newInternalResourceMetadata 
    ::  InternalResourceMetadata
newInternalResourceMetadata
  = InternalResourceMetadata{backupConfiguration = Core.Nothing,
                             backupRun = Core.Nothing,
                             isDeletionProtectionEnabled = Core.Nothing, product = Core.Nothing,
                             resourceId = Core.Nothing, resourceName = Core.Nothing}
instance Core.FromJSON InternalResourceMetadata where
        parseJSON
          = Core.withObject "InternalResourceMetadata"
              (\ o ->
                 InternalResourceMetadata Core.<$>
                   (o Core..:? "backupConfiguration") Core.<*>
                     (o Core..:? "backupRun")
        ...
        toJSON InternalResourceMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("backupConfiguration" Core..=) Core.<$> backupConfiguration,
                  ("backupRun" Core..=) Core.<$> backupRun,
                  ("isDeletionProtectionEnabled" Core..=) Core.<$>
...
newListBackupCollectionsResponse 
    ::  ListBackupCollectionsResponse
newListBackupCollectionsResponse
  = ListBackupCollectionsResponse{backupCollections = Core.Nothing,
                                  nextPageToken = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListBackupCollectionsResponse where
        parseJSON
          = Core.withObject "ListBackupCollectionsResponse"
              (\ o ->
                 ListBackupCollectionsResponse Core.<$>
                   (o Core..:? "backupCollections") Core.<*>
...
newMachineConfiguration 
    ::  MachineConfiguration
newMachineConfiguration
  = MachineConfiguration{cpuCount = Core.Nothing,
                         memorySizeInBytes = Core.Nothing, shardCount = Core.Nothing,
                         vcpuCount = Core.Nothing}
instance Core.FromJSON MachineConfiguration where
        parseJSON
          = Core.withObject "MachineConfiguration"
              (\ o ->
                 MachineConfiguration Core.<$>
                   (o Core..:? "cpuCount") Core.<*>
                     (o Core..:? "memorySizeInBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "shardCount")
          ...
          = Core.object
              (Core.catMaybes
                 [("cpuCount" Core..=) Core.<$> cpuCount,
                  ("memorySizeInBytes" Core..=) Core.. Core.AsText Core.<$>
                    memorySizeInBytes,
                  ("shardCount" Core..=) Core.<$> shardCount,
...
newMaintenancePolicy 
    ::  MaintenancePolicy
newMaintenancePolicy
  = MaintenancePolicy{createTime = Core.Nothing,
                      description = Core.Nothing, updateTime = Core.Nothing,
...
newMaintenanceSchedule 
    ::  MaintenanceSchedule
newMaintenanceSchedule
  = MaintenanceSchedule{canReschedule = Core.Nothing,
                        endTime = Core.Nothing, scheduleDeadlineTime = Core.Nothing,
                        startTime = Core.Nothing}
instance Core.FromJSON MaintenanceSchedule where
        parseJSON
          = Core.withObject "MaintenanceSchedule"
              (\ o ->
                 MaintenanceSchedule Core.<$>
                   (o Core..:? "canReschedule") Core.<*> (o Core..:? "endTime")
...
instance Core.FromJSON ManagedBackupSource where
        parseJSON
          = Core.withObject "ManagedBackupSource"
...
instance Core.FromJSON ManagedCertificateAuthority where
        parseJSON
          = Core.withObject "ManagedCertificateAuthority"
              (\ o ->
...
newMembership 
    ::  Membership
newMembership
  = Membership{primaryCluster = Core.Nothing,
...
instance Core.FromJSON Membership where
        parseJSON
          = Core.withObject "Membership"
              (\ o ->
                 Membership Core.<$>
                   (o Core..:? "primaryCluster") Core.<*>
                     (o Core..:? "secondaryClusters"))
...
newObservabilityMetricData 
    ::  ObservabilityMetricData
newObservabilityMetricData
  = ObservabilityMetricData{aggregationType = Core.Nothing,
                            metricType = Core.Nothing, observationTime = Core.Nothing,
                            resourceName = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON ObservabilityMetricData where
        parseJSON
          = Core.withObject "ObservabilityMetricData"
              (\ o ->
                 ObservabilityMetricData Core.<$>
                   (o Core..:? "aggregationType") Core.<*> (o Core..:? "metricType")
...
newOperationError 
    ::  OperationError
newOperationError
  = OperationError{code = Core.Nothing, errorType = Core.Nothing,
...
instance Core.FromJSON OperationError where
        parseJSON
          = Core.withObject "OperationError"
              (\ o ->
                 OperationError Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "errorType") Core.<*>
                     (o Core..:? "message"))
...
newOperationMetadata
  = OperationMetadata{apiVersion = Core.Nothing,
                      ...
                      requestedCancellation = Core.Nothing, statusMessage = Core.Nothing,
                      target = Core.Nothing, verb = Core.Nothing}
          ...
          = Core.withObject "OperationMetadata"
              (\ o ->
                 OperationMetadata Core.<$>
                   (o Core..:? "apiVersion") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "endTime")
...
newPersistenceConfig 
    ::  PersistenceConfig
newPersistenceConfig
  = PersistenceConfig{persistenceMode = Core.Nothing,
...
instance Core.FromJSON PersistenceConfig where
        parseJSON
          = Core.withObject "PersistenceConfig"
              (\ o ->
                 PersistenceConfig Core.<$>
                   (o Core..:? "persistenceMode") Core.<*>
                     (o Core..:? "rdbNextSnapshotTime")
...
newProduct 
    ::  Product
newProduct
  = Product{engine = Core.Nothing, type' = Core.Nothing,
...
instance Core.FromJSON Product where
        parseJSON
          = Core.withObject "Product"
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "engine") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "version"))
...
newPscAutoConnection 
    ::  PscAutoConnection
newPscAutoConnection
  = PscAutoConnection{address = Core.Nothing,
                      connectionType = Core.Nothing, forwardingRule = Core.Nothing,
                      network = Core.Nothing, projectId = Core.Nothing,
                      pscConnectionId = Core.Nothing, pscConnectionStatus = Core.Nothing,
                      serviceAttachment = Core.Nothing}
instance Core.FromJSON PscAutoConnection where
        parseJSON
          = Core.withObject "PscAutoConnection"
              (\ o ->
                 PscAutoConnection Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "connectionType")
...
newPscConnection 
    ::  PscConnection
newPscConnection
  = PscConnection{address = Core.Nothing,
                  connectionType = Core.Nothing, forwardingRule = Core.Nothing,
                  network = Core.Nothing, port = Core.Nothing,
                  projectId = Core.Nothing, pscConnectionId = Core.Nothing,
                  pscConnectionStatus = Core.Nothing,
                  serviceAttachment = Core.Nothing}
instance Core.FromJSON PscConnection where
        parseJSON
          = Core.withObject "PscConnection"
              (\ o ->
                 PscConnection Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "connectionType")
                     Core.<*> (o Core..:? "forwardingRule")
...
newPscServiceAttachment 
    ::  PscServiceAttachment
newPscServiceAttachment
  = PscServiceAttachment{connectionType = Core.Nothing,
                         serviceAttachment = Core.Nothing}
instance Core.FromJSON PscServiceAttachment where
        parseJSON
          = Core.withObject "PscServiceAttachment"
              (\ o ->
                 PscServiceAttachment Core.<$>
                   (o Core..:? "connectionType") Core.<*>
                     (o Core..:? "serviceAttachment"))
...
newRDBConfig 
    ::  RDBConfig
newRDBConfig
  = RDBConfig{rdbSnapshotPeriod = Core.Nothing,
              rdbSnapshotStartTime = Core.Nothing}
instance Core.FromJSON RDBConfig where
        parseJSON
          = Core.withObject "RDBConfig"
              (\ o ->
                 RDBConfig Core.<$>
                   (o Core..:? "rdbSnapshotPeriod") Core.<*>
                     (o Core..:? "rdbSnapshotStartTime"))
...
newReconciliationOperationMetadata 
    :: 
                                   ReconciliationOperationMetadata
newReconciliationOperationMetadata
  = ReconciliationOperationMetadata{deleteResource = Core.Nothing,
                                    exclusiveAction = Core.Nothing}
instance Core.FromJSON ReconciliationOperationMetadata where
        parseJSON
          = Core.withObject "ReconciliationOperationMetadata"
              (\ o ->
                 ReconciliationOperationMetadata Core.<$>
                   (o Core..:? "deleteResource") Core.<*>
                     (o Core..:? "exclusiveAction"))
...
instance Core.FromJSON RemoteCluster where
        parseJSON
          = Core.withObject "RemoteCluster"
              (\ o ->
                 RemoteCluster Core.<$>
                   (o Core..:? "cluster") Core.<*> (o Core..:? "uid"))
...
instance Core.FromJSON RescheduleClusterMaintenanceRequest where
        parseJSON
          = Core.withObject "RescheduleClusterMaintenanceRequest"
              (\ o ->
                 RescheduleClusterMaintenanceRequest Core.<$>
...
newRescheduleMaintenanceRequest 
    ::  RescheduleMaintenanceRequest
newRescheduleMaintenanceRequest
  = RescheduleMaintenanceRequest{rescheduleType = Core.Nothing,
                                 scheduleTime = Core.Nothing}
instance Core.FromJSON RescheduleMaintenanceRequest where
        parseJSON
          = Core.withObject "RescheduleMaintenanceRequest"
              (\ o ->
                 RescheduleMaintenanceRequest Core.<$>
                   (o Core..:? "rescheduleType") Core.<*> (o Core..:? "scheduleTime"))
...
newRetentionSettings 
    ::  RetentionSettings
newRetentionSettings
  = RetentionSettings{durationBasedRetention = Core.Nothing,
                      quantityBasedRetention = Core.Nothing,
                      retentionUnit = Core.Nothing, timeBasedRetention = Core.Nothing,
                      timestampBasedRetentionTime = Core.Nothing}
instance Core.FromJSON RetentionSettings where
        parseJSON
          = Core.withObject "RetentionSettings"
              (\ o ->
                 RetentionSettings Core.<$>
                   (o Core..:? "durationBasedRetention") Core.<*>
                     (o Core..:? "quantityBasedRetention")
...
instance Core.ToJSON RetentionSettings where
        toJSON RetentionSettings{..}
          = Core.object
              (Core.catMaybes
                 [("durationBasedRetention" Core..=) Core.<$>
                  ...
                  ("timestampBasedRetentionTime" Core..=) Core.<$>
...
newTlsCertificate 
    ::  TlsCertificate
newTlsCertificate
  = TlsCertificate{cert = Core.Nothing, createTime = Core.Nothing,
                   expireTime = Core.Nothing, serialNumber = Core.Nothing,
                   sha1Fingerprint = Core.Nothing}
instance Core.FromJSON TlsCertificate where
        parseJSON
          = Core.withObject "TlsCertificate"
              (\ o ->
                 TlsCertificate Core.<$>
                   (o Core..:? "cert") Core.<*> (o Core..:? "createTime") Core.<*>
                     (o Core..:? "expireTime")
...
newTypedValue 
    ::  TypedValue
newTypedValue
  = TypedValue{boolValue = Core.Nothing, doubleValue = Core.Nothing,
               int64Value = Core.Nothing, stringValue = Core.Nothing}
instance Core.FromJSON TypedValue where
        parseJSON
          = Core.withObject "TypedValue"
              (\ o ->
                 TypedValue Core.<$>
                   (o Core..:? "boolValue") Core.<*> (o Core..:? "doubleValue")
                     Core.<*>
...
newUpdateInfo 
    ::  UpdateInfo
newUpdateInfo
  = UpdateInfo{targetNodeType = Core.Nothing,
               targetReplicaCount = Core.Nothing, targetShardCount = Core.Nothing}
instance Core.FromJSON UpdateInfo where
        parseJSON
          = Core.withObject "UpdateInfo"
              (\ o ->
                 UpdateInfo Core.<$>
                   (o Core..:? "targetNodeType") Core.<*>
                     (o Core..:? "targetReplicaCount")
...
instance Core.FromJSON UpgradeInstanceRequest where
        parseJSON
          = Core.withObject "UpgradeInstanceRequest"
              (\ o ->
...
instance Core.FromJSON UserLabels_Labels where
        parseJSON
          = Core.withObject "UserLabels_Labels"
...
newWeeklyMaintenanceWindow 
    ::  WeeklyMaintenanceWindow
newWeeklyMaintenanceWindow
  = WeeklyMaintenanceWindow{day = Core.Nothing,
                            duration = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON WeeklyMaintenanceWindow where
        parseJSON
          = Core.withObject "WeeklyMaintenanceWindow"
              (\ o ->
                 WeeklyMaintenanceWindow Core.<$>
                   (o Core..:? "day") Core.<*> (o Core..:? "duration") Core.<*>
                     (o Core..:? "startTime"))
...
instance Core.FromJSON ZoneDistributionConfig where
        parseJSON
          = Core.withObject "ZoneDistributionConfig"
              (\ o ->
                 ZoneDistributionConfig Core.<$>
                   (o Core..:? "mode") Core.<*> (o Core..:? "zone"))
