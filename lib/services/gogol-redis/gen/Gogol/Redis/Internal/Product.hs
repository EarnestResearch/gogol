...
instance Core.FromJSON FailoverInstanceRequest where
        parseJSON
          = Core.withObject "FailoverInstanceRequest"
              (\ o ->
                 FailoverInstanceRequest Core.<$>
                   (o Core..:? "dataProtectionMode"))

instance Core.ToJSON FailoverInstanceRequest where
        toJSON FailoverInstanceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("dataProtectionMode" Core..=) Core.<$>
                    dataProtectionMode])
...
instance Core.FromJSON GoogleCloudRedisV1ZoneMetadata
         where
        parseJSON
          = Core.withObject "GoogleCloudRedisV1ZoneMetadata"
              (\ o -> Core.pure GoogleCloudRedisV1ZoneMetadata)

instance Core.ToJSON GoogleCloudRedisV1ZoneMetadata
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.ToJSON Instance where
        toJSON Instance{..}
          = Core.object
              (Core.catMaybes
                 [("alternativeLocationId" Core..=) Core.<$>
                    alternativeLocationId,
                  ("authEnabled" Core..=) Core.<$> authEnabled,
                  ("authorizedNetwork" Core..=) Core.<$>
                    authorizedNetwork,
                  ("availableMaintenanceVersions" Core..=) Core.<$>
                    availableMaintenanceVersions,
                  ("connectMode" Core..=) Core.<$> connectMode,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("currentLocationId" Core..=) Core.<$>
                    currentLocationId,
                  ("customerManagedKey" Core..=) Core.<$>
                    customerManagedKey,
                  ...
                  ("persistenceConfig" Core..=) Core.<$>
                    persistenceConfig,
                  ("persistenceIamIdentity" Core..=) Core.<$>
                    persistenceIamIdentity,
                  ("port" Core..=) Core.<$> port,
                  ("readEndpoint" Core..=) Core.<$> readEndpoint,
                  ("readEndpointPort" Core..=) Core.<$>
                    readEndpointPort,
                  ("readReplicasMode" Core..=) Core.<$>
                    readReplicasMode,
                  ...
                  ("suspensionReasons" Core..=) Core.<$>
                    suspensionReasons,
                  ("tier" Core..=) Core.<$> tier,
                  ("transitEncryptionMode" Core..=) Core.<$>
...
instance Core.ToJSON PersistenceConfig where
        toJSON PersistenceConfig{..}
          = Core.object
              (Core.catMaybes
                 [("persistenceMode" Core..=) Core.<$>
                    persistenceMode,
                  ("rdbNextSnapshotTime" Core..=) Core.<$>
                    rdbNextSnapshotTime,
                  ("rdbSnapshotPeriod" Core..=) Core.<$>
                    rdbSnapshotPeriod,
                  ("rdbSnapshotStartTime" Core..=) Core.<$>
...
newReconciliationOperationMetadata =
  ReconciliationOperationMetadata
    {deleteResource = Core.Nothing, exclusiveAction = Core.Nothing}
...
instance Core.ToJSON ReconciliationOperationMetadata
         where
        toJSON ReconciliationOperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("deleteResource" Core..=) Core.<$> deleteResource,
                  ("exclusiveAction" Core..=) Core.<$>
                    exclusiveAction])
...
newRescheduleMaintenanceRequest =
  RescheduleMaintenanceRequest
    {rescheduleType = Core.Nothing, scheduleTime = Core.Nothing}

instance Core.FromJSON RescheduleMaintenanceRequest
         where
        parseJSON
...
instance Core.ToJSON RescheduleMaintenanceRequest
         where
