...
newAddTenantProjectRequest 
    ::  AddTenantProjectRequest
newAddTenantProjectRequest =
  AddTenantProjectRequest {projectConfig = Core.Nothing, tag = Core.Nothing}
...
newApplyTenantProjectConfigRequest =
  ApplyTenantProjectConfigRequest
    {projectConfig = Core.Nothing, tag = Core.Nothing}
...
instance Core.ToJSON ApplyTenantProjectConfigRequest
         where
...
instance Core.FromJSON AttachTenantProjectRequest
         where
        parseJSON
...
instance Core.ToJSON AttachTenantProjectRequest where
        toJSON AttachTenantProjectRequest{..}
          = Core.object
              (Core.catMaybes
                 [("externalResource" Core..=) Core.<$>
                    externalResource,
                  ("reservedResource" Core..=) Core.<$>
                    reservedResource,
                  ("tag" Core..=) Core.<$> tag])
...
instance Core.FromJSON BillingConfig where
        parseJSON
          = Core.withObject "BillingConfig"
              (\ o ->
                 BillingConfig Core.<$> (o Core..:? "billingAccount"))
...
instance Core.FromJSON CreateTenancyUnitRequest where
        parseJSON
          = Core.withObject "CreateTenancyUnitRequest"
              (\ o ->
                 CreateTenancyUnitRequest Core.<$>
                   (o Core..:? "tenancyUnitId"))

instance Core.ToJSON CreateTenancyUnitRequest where
        toJSON CreateTenancyUnitRequest{..}
          = Core.object
              (Core.catMaybes
                 [("tenancyUnitId" Core..=) Core.<$> tenancyUnitId])
...
newDeleteTenantProjectRequest 
    ::  DeleteTenantProjectRequest
newDeleteTenantProjectRequest = DeleteTenantProjectRequest {tag = Core.Nothing}

instance Core.FromJSON DeleteTenantProjectRequest
         where
        parseJSON
          = Core.withObject "DeleteTenantProjectRequest"
              (\ o ->
                 DeleteTenantProjectRequest Core.<$>
                   (o Core..:? "tag"))
...
newListTenancyUnitsResponse =
  ListTenancyUnitsResponse
    {nextPageToken = Core.Nothing, tenancyUnits = Core.Nothing}
...
newPolicyBinding 
    ::  PolicyBinding
newPolicyBinding = PolicyBinding {members = Core.Nothing, role' = Core.Nothing}
...
newRemoveTenantProjectRequest 
    ::  RemoveTenantProjectRequest
newRemoveTenantProjectRequest = RemoveTenantProjectRequest {tag = Core.Nothing}

instance Core.FromJSON RemoveTenantProjectRequest
         where
        parseJSON
          = Core.withObject "RemoveTenantProjectRequest"
              (\ o ->
                 RemoveTenantProjectRequest Core.<$>
                   (o Core..:? "tag"))
...
instance Core.FromJSON SearchTenancyUnitsResponse
         where
        parseJSON
...
newServiceAccountConfig =
  ServiceAccountConfig
    {accountId = Core.Nothing, tenantProjectRoles = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("billingConfig" Core..=) Core.<$> billingConfig,
                  ...
                  ("labels" Core..=) Core.<$> labels,
                  ("serviceAccountConfig" Core..=) Core.<$>
                    serviceAccountConfig,
                  ("services" Core..=) Core.<$> services,
                  ("tenantProjectPolicy" Core..=) Core.<$>
                    tenantProjectPolicy])
...
instance Core.FromJSON TenantProjectConfig_Labels
         where
        parseJSON
          = Core.withObject "TenantProjectConfig_Labels"
              (\ o ->
                 TenantProjectConfig_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON TenantProjectConfig_Labels where
        toJSON TenantProjectConfig_Labels{..}
          = Core.toJSON additional
...
newTenantProjectPolicy 
    ::  TenantProjectPolicy
newTenantProjectPolicy = TenantProjectPolicy {policyBindings = Core.Nothing}

instance Core.FromJSON TenantProjectPolicy where
        parseJSON
          = Core.withObject "TenantProjectPolicy"
              (\ o ->
                 TenantProjectPolicy Core.<$>
                   (o Core..:? "policyBindings"))
...
newTenantResource =
  TenantResource
    {resource = Core.Nothing, status = Core.Nothing, tag = Core.Nothing}
...
instance Core.FromJSON UndeleteTenantProjectRequest
         where
        parseJSON
          = Core.withObject "UndeleteTenantProjectRequest"
              (\ o ->
                 UndeleteTenantProjectRequest Core.<$>
                   (o Core..:? "tag"))

instance Core.ToJSON UndeleteTenantProjectRequest
         where
...
instance Core.FromJSON V1AddVisibilityLabelsResponse
         where
        parseJSON
          = Core.withObject "V1AddVisibilityLabelsResponse"
              (\ o ->
                 V1AddVisibilityLabelsResponse Core.<$>
                   (o Core..:? "labels"))

instance Core.ToJSON V1AddVisibilityLabelsResponse
         where
...
newV1Beta1BatchCreateProducerOverridesResponse 
    ::  V1Beta1BatchCreateProducerOverridesResponse
newV1Beta1BatchCreateProducerOverridesResponse =
  V1Beta1BatchCreateProducerOverridesResponse {overrides = Core.Nothing}
...
instance Core.FromJSON V1Beta1DisableConsumerResponse
         where
        parseJSON
          = Core.withObject "V1Beta1DisableConsumerResponse"
              (\ o -> Core.pure V1Beta1DisableConsumerResponse)

instance Core.ToJSON V1Beta1DisableConsumerResponse
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON V1Beta1EnableConsumerResponse
         where
        parseJSON
          = Core.withObject "V1Beta1EnableConsumerResponse"
              (\ o -> Core.pure V1Beta1EnableConsumerResponse)

instance Core.ToJSON V1Beta1EnableConsumerResponse
         where
        toJSON = Core.const Core.emptyObject
...
newV1Beta1ImportProducerQuotaPoliciesResponse 
    ::  V1Beta1ImportProducerQuotaPoliciesResponse
newV1Beta1ImportProducerQuotaPoliciesResponse =
  V1Beta1ImportProducerQuotaPoliciesResponse {policies = Core.Nothing}
...
instance Core.FromJSON V1Beta1ProducerQuotaPolicy
         where
        parseJSON
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "V1Beta1QuotaOverride_Dimensions"
              (\ o ->
                 V1Beta1QuotaOverride_Dimensions Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON V1Beta1QuotaOverride_Dimensions
         where
        toJSON V1Beta1QuotaOverride_Dimensions{..}
          = Core.toJSON additional
...
instance Core.FromJSON V1Beta1RefreshConsumerResponse
         where
        parseJSON
          = Core.withObject "V1Beta1RefreshConsumerResponse"
              (\ o -> Core.pure V1Beta1RefreshConsumerResponse)

instance Core.ToJSON V1Beta1RefreshConsumerResponse
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON V1DisableConsumerResponse
         where
        parseJSON
...
newV1GenerateDefaultIdentityResponse =
  V1GenerateDefaultIdentityResponse
    {attachStatus = Core.Nothing, identity = Core.Nothing, role' = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "V1GenerateServiceAccountResponse"
              (\ o ->
                 V1GenerateServiceAccountResponse Core.<$>
                   (o Core..:? "account"))

instance Core.ToJSON V1GenerateServiceAccountResponse
         where
...
instance Core.FromJSON V1RefreshConsumerResponse
         where
        parseJSON
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "V1RemoveVisibilityLabelsResponse"
              (\ o ->
                 V1RemoveVisibilityLabelsResponse Core.<$>
                   (o Core..:? "labels"))

instance Core.ToJSON V1RemoveVisibilityLabelsResponse
         where
