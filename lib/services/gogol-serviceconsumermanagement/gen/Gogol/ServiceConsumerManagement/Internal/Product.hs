...
newAddTenantProjectRequest 
    ::  AddTenantProjectRequest
newAddTenantProjectRequest
  = AddTenantProjectRequest{projectConfig = Core.Nothing,
                            tag = Core.Nothing}
instance Core.FromJSON AddTenantProjectRequest where
        parseJSON
          = Core.withObject "AddTenantProjectRequest"
              (\ o ->
                 AddTenantProjectRequest Core.<$>
                   (o Core..:? "projectConfig") Core.<*> (o Core..:? "tag"))
...
newApplyTenantProjectConfigRequest 
    :: 
                                   ApplyTenantProjectConfigRequest
newApplyTenantProjectConfigRequest
  = ApplyTenantProjectConfigRequest{projectConfig = Core.Nothing,
                                    tag = Core.Nothing}
instance Core.FromJSON ApplyTenantProjectConfigRequest where
        parseJSON
          = Core.withObject "ApplyTenantProjectConfigRequest"
              (\ o ->
                 ApplyTenantProjectConfigRequest Core.<$>
                   (o Core..:? "projectConfig") Core.<*> (o Core..:? "tag"))
...
newAttachTenantProjectRequest 
    ::  AttachTenantProjectRequest
newAttachTenantProjectRequest
  = AttachTenantProjectRequest{externalResource = Core.Nothing,
                               reservedResource = Core.Nothing, tag = Core.Nothing}
instance Core.FromJSON AttachTenantProjectRequest where
        parseJSON
          = Core.withObject "AttachTenantProjectRequest"
              (\ o ->
                 AttachTenantProjectRequest Core.<$>
                   (o Core..:? "externalResource") Core.<*>
                     (o Core..:? "reservedResource")
                     Core.<*> (o Core..:? "tag"))
...
instance Core.FromJSON CreateTenancyUnitRequest where
        parseJSON
          = Core.withObject "CreateTenancyUnitRequest"
              (\ o ->
...
instance Core.FromJSON DeleteTenantProjectRequest where
        parseJSON
          = Core.withObject "DeleteTenantProjectRequest"
...
newListTenancyUnitsResponse 
    ::  ListTenancyUnitsResponse
newListTenancyUnitsResponse
  = ListTenancyUnitsResponse{nextPageToken = Core.Nothing,
                             tenancyUnits = Core.Nothing}
instance Core.FromJSON ListTenancyUnitsResponse where
        parseJSON
          = Core.withObject "ListTenancyUnitsResponse"
              (\ o ->
                 ListTenancyUnitsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "tenancyUnits"))
...
instance Core.FromJSON PolicyBinding where
        parseJSON
          = Core.withObject "PolicyBinding"
              (\ o ->
                 PolicyBinding Core.<$>
                   (o Core..:? "members") Core.<*> (o Core..:? "role"))
...
instance Core.FromJSON RemoveTenantProjectRequest where
        parseJSON
          = Core.withObject "RemoveTenantProjectRequest"
...
newSearchTenancyUnitsResponse 
    ::  SearchTenancyUnitsResponse
newSearchTenancyUnitsResponse
  = SearchTenancyUnitsResponse{nextPageToken = Core.Nothing,
                               tenancyUnits = Core.Nothing}
instance Core.FromJSON SearchTenancyUnitsResponse where
        parseJSON
          = Core.withObject "SearchTenancyUnitsResponse"
              (\ o ->
                 SearchTenancyUnitsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "tenancyUnits"))
...
newServiceAccountConfig 
    ::  ServiceAccountConfig
newServiceAccountConfig
  = ServiceAccountConfig{accountId = Core.Nothing,
                         tenantProjectRoles = Core.Nothing}
instance Core.FromJSON ServiceAccountConfig where
        parseJSON
          = Core.withObject "ServiceAccountConfig"
              (\ o ->
                 ServiceAccountConfig Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "tenantProjectRoles"))
...
newTenancyUnit 
    ::  TenancyUnit
newTenancyUnit
  = TenancyUnit{consumer = Core.Nothing, createTime = Core.Nothing,
                name = Core.Nothing, service = Core.Nothing,
                tenantResources = Core.Nothing}
instance Core.FromJSON TenancyUnit where
        parseJSON
          = Core.withObject "TenancyUnit"
              (\ o ->
                 TenancyUnit Core.<$>
                   (o Core..:? "consumer") Core.<*> (o Core..:? "createTime") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "service")
...
newTenantProjectConfig 
    ::  TenantProjectConfig
newTenantProjectConfig
  = TenantProjectConfig{billingConfig = Core.Nothing,
                        folder = Core.Nothing, labels = Core.Nothing,
                        serviceAccountConfig = Core.Nothing, services = Core.Nothing,
                        tenantProjectPolicy = Core.Nothing}
instance Core.FromJSON TenantProjectConfig where
        parseJSON
          = Core.withObject "TenantProjectConfig"
              (\ o ->
                 TenantProjectConfig Core.<$>
                   (o Core..:? "billingConfig") Core.<*> (o Core..:? "folder")
                     Core.<*> (o Core..:? "labels")
...
instance Core.FromJSON TenantProjectConfig_Labels where
        parseJSON
          = Core.withObject "TenantProjectConfig_Labels"
              (\ o ->
...
instance Core.FromJSON TenantProjectPolicy where
        parseJSON
          = Core.withObject "TenantProjectPolicy"
...
newTenantResource 
    ::  TenantResource
newTenantResource
  = TenantResource{resource = Core.Nothing, status = Core.Nothing,
                   tag = Core.Nothing}
instance Core.FromJSON TenantResource where
        parseJSON
          = Core.withObject "TenantResource"
              (\ o ->
                 TenantResource Core.<$>
                   (o Core..:? "resource") Core.<*> (o Core..:? "status") Core.<*>
                     (o Core..:? "tag"))
...
instance Core.FromJSON UndeleteTenantProjectRequest where
        parseJSON
          = Core.withObject "UndeleteTenantProjectRequest"
...
instance Core.FromJSON V1AddVisibilityLabelsResponse where
        parseJSON
          = Core.withObject "V1AddVisibilityLabelsResponse"
              (\ o ->
...
newV1Beta1BatchCreateProducerOverridesResponse 
    :: 
                                               V1Beta1BatchCreateProducerOverridesResponse
newV1Beta1BatchCreateProducerOverridesResponse
  = V1Beta1BatchCreateProducerOverridesResponse{overrides =
                                                  Core.Nothing}
instance Core.FromJSON V1Beta1BatchCreateProducerOverridesResponse
         where
        parseJSON
          = Core.withObject "V1Beta1BatchCreateProducerOverridesResponse"
              (\ o ->
                 V1Beta1BatchCreateProducerOverridesResponse Core.<$>
                   (o Core..:? "overrides"))

instance Core.ToJSON V1Beta1BatchCreateProducerOverridesResponse
         where
...
instance Core.FromJSON V1Beta1DisableConsumerResponse where
        parseJSON
          = Core.withObject "V1Beta1DisableConsumerResponse"
...
instance Core.FromJSON V1Beta1EnableConsumerResponse where
        parseJSON
          = Core.withObject "V1Beta1EnableConsumerResponse"
...
instance Core.FromJSON V1Beta1GenerateServiceIdentityResponse where
        parseJSON
          = Core.withObject "V1Beta1GenerateServiceIdentityResponse"
              (\ o ->
                 V1Beta1GenerateServiceIdentityResponse Core.<$>
                   (o Core..:? "identity"))
...
instance Core.FromJSON V1Beta1ImportProducerOverridesResponse where
        parseJSON
          = Core.withObject "V1Beta1ImportProducerOverridesResponse"
              (\ o ->
                 V1Beta1ImportProducerOverridesResponse Core.<$>
                   (o Core..:? "overrides"))
...
newV1Beta1ImportProducerQuotaPoliciesResponse 
    :: 
                                              V1Beta1ImportProducerQuotaPoliciesResponse
newV1Beta1ImportProducerQuotaPoliciesResponse
  = V1Beta1ImportProducerQuotaPoliciesResponse{policies =
                                                 Core.Nothing}
instance Core.FromJSON V1Beta1ImportProducerQuotaPoliciesResponse
         where
        parseJSON
          = Core.withObject "V1Beta1ImportProducerQuotaPoliciesResponse"
              (\ o ->
                 V1Beta1ImportProducerQuotaPoliciesResponse Core.<$>
                   (o Core..:? "policies"))

instance Core.ToJSON V1Beta1ImportProducerQuotaPoliciesResponse
         where
...
newV1Beta1ProducerQuotaPolicy 
    ::  V1Beta1ProducerQuotaPolicy
newV1Beta1ProducerQuotaPolicy
  = V1Beta1ProducerQuotaPolicy{container = Core.Nothing,
...
instance Core.FromJSON V1Beta1ProducerQuotaPolicy where
        parseJSON
          = Core.withObject "V1Beta1ProducerQuotaPolicy"
              (\ o ->
                 V1Beta1ProducerQuotaPolicy Core.<$>
...
instance Core.FromJSON V1Beta1ProducerQuotaPolicy_Dimensions where
        parseJSON
          = Core.withObject "V1Beta1ProducerQuotaPolicy_Dimensions"
              (\ o ->
                 V1Beta1ProducerQuotaPolicy_Dimensions Core.<$>
                   (Core.parseJSONObject o))
...
newV1Beta1QuotaOverride 
    ::  V1Beta1QuotaOverride
newV1Beta1QuotaOverride
  = V1Beta1QuotaOverride{adminOverrideAncestor = Core.Nothing,
                         dimensions = Core.Nothing, metric = Core.Nothing,
                         name = Core.Nothing, overrideValue = Core.Nothing,
                         unit = Core.Nothing}
instance Core.FromJSON V1Beta1QuotaOverride where
        parseJSON
          = Core.withObject "V1Beta1QuotaOverride"
              (\ o ->
                 V1Beta1QuotaOverride Core.<$>
...
instance Core.FromJSON V1Beta1QuotaOverride_Dimensions where
        parseJSON
          = Core.withObject "V1Beta1QuotaOverride_Dimensions"
              (\ o ->
...
instance Core.FromJSON V1Beta1RefreshConsumerResponse where
        parseJSON
          = Core.withObject "V1Beta1RefreshConsumerResponse"
...
newV1Beta1ServiceIdentity 
    ::  V1Beta1ServiceIdentity
newV1Beta1ServiceIdentity
  = V1Beta1ServiceIdentity{email = Core.Nothing, name = Core.Nothing,
                           tag = Core.Nothing, uniqueId = Core.Nothing}
instance Core.FromJSON V1Beta1ServiceIdentity where
        parseJSON
          = Core.withObject "V1Beta1ServiceIdentity"
              (\ o ->
                 V1Beta1ServiceIdentity Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "tag")
...
newV1DefaultIdentity 
    ::  V1DefaultIdentity
newV1DefaultIdentity
  = V1DefaultIdentity{email = Core.Nothing, name = Core.Nothing,
                      tag = Core.Nothing, uniqueId = Core.Nothing}
instance Core.FromJSON V1DefaultIdentity where
        parseJSON
          = Core.withObject "V1DefaultIdentity"
              (\ o ->
                 V1DefaultIdentity Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "tag")
                     Core.<*> (o Core..:? "uniqueId"))
...
instance Core.FromJSON V1DisableConsumerResponse where
        parseJSON
          = Core.withObject "V1DisableConsumerResponse"
...
instance Core.FromJSON V1EnableConsumerResponse where
        parseJSON
          = Core.withObject "V1EnableConsumerResponse"
...
newV1GenerateDefaultIdentityResponse 
    :: 
                                     V1GenerateDefaultIdentityResponse
newV1GenerateDefaultIdentityResponse
  = V1GenerateDefaultIdentityResponse{attachStatus = Core.Nothing,
                                      identity = Core.Nothing, role' = Core.Nothing}
instance Core.FromJSON V1GenerateDefaultIdentityResponse where
        parseJSON
          = Core.withObject "V1GenerateDefaultIdentityResponse"
              (\ o ->
                 V1GenerateDefaultIdentityResponse Core.<$>
                   (o Core..:? "attachStatus") Core.<*> (o Core..:? "identity")
                     Core.<*> (o Core..:? "role"))
...
instance Core.FromJSON V1GenerateServiceAccountResponse where
        parseJSON
          = Core.withObject "V1GenerateServiceAccountResponse"
              (\ o ->
...
instance Core.FromJSON V1RefreshConsumerResponse where
        parseJSON
          = Core.withObject "V1RefreshConsumerResponse"
...
instance Core.FromJSON V1RemoveVisibilityLabelsResponse where
        parseJSON
          = Core.withObject "V1RemoveVisibilityLabelsResponse"
              (\ o ->
...
newV1ServiceAccount 
    ::  V1ServiceAccount
newV1ServiceAccount
  = V1ServiceAccount{email = Core.Nothing,
                     iamAccountName = Core.Nothing, name = Core.Nothing,
                     tag = Core.Nothing, uniqueId = Core.Nothing}
instance Core.FromJSON V1ServiceAccount where
        parseJSON
          = Core.withObject "V1ServiceAccount"
              (\ o ->
                 V1ServiceAccount Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "iamAccountName")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "tag")
                     Core.<*> (o Core..:? "uniqueId"))
