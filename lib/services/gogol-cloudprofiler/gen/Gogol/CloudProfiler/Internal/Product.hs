...
instance Core.FromJSON CreateProfileRequest where
        parseJSON
          = Core.withObject "CreateProfileRequest"
              (\ o ->
                 CreateProfileRequest Core.<$>
...
newDeployment =
  Deployment
    {labels = Core.Nothing, projectId = Core.Nothing, target = Core.Nothing}
...
instance Core.FromJSON Deployment_Labels where
        parseJSON
          = Core.withObject "Deployment_Labels"
              (\ o ->
...
instance Core.FromJSON Profile_Labels where
        parseJSON
          = Core.withObject "Profile_Labels"
              (\ o ->
