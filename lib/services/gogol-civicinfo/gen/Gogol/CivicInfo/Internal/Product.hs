...
instance Core.FromJSON AdministrationRegion where
        parseJSON
          = Core.withObject "AdministrationRegion"
              (\ o ->
                 AdministrationRegion Core.<$>
...
instance Core.FromJSON AdministrativeBody where
        parseJSON
          = Core.withObject "AdministrativeBody"
              (\ o ->
                 AdministrativeBody Core.<$>
                   (o Core..:? "absenteeVotingInfoUrl") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "electionRegistrationConfirmationUrl")
...
instance Core.FromJSON Candidate where
        parseJSON
          = Core.withObject "Candidate"
              (\ o ->
                 Candidate Core.<$>
                   (o Core..:? "candidateUrl") Core.<*>
                     (o Core..:? "channels")
                     Core.<*> (o Core..:? "email")
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "orderOnBallot" Core.<&>
...
instance Core.FromJSON Contest where
        parseJSON
          = Core.withObject "Contest"
              (\ o ->
                 Contest Core.<$>
                   (o Core..:? "ballotPlacement" Core.<&>
                      Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "level")
                     Core.<*>
                     (o Core..:? "numberElected" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numberVotingFor" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "office")
          ...
          = Core.object
              (Core.catMaybes
                 [("ballotPlacement" Core..=) Core.. Core.AsText
                  ...
                  ("referendumConStatement" Core..=) Core.<$>
                  ...
                  ("referendumProStatement" Core..=) Core.<$>
                    referendumProStatement,
                  ("referendumSubtitle" Core..=) Core.<$>
                    referendumSubtitle,
...
newDivisionSearchResponse =
  DivisionSearchResponse
    {kind = "civicinfo#divisionSearchResponse", results = Core.Nothing}

instance Core.FromJSON DivisionSearchResponse where
        parseJSON
          = Core.withObject "DivisionSearchResponse"
              (\ o ->
                 DivisionSearchResponse Core.<$>
                   (o Core..:? "kind" Core..!=
...
newDivisionSearchResult =
  DivisionSearchResult
    {aliases = Core.Nothing, name = Core.Nothing, ocdId = Core.Nothing}

instance Core.FromJSON DivisionSearchResult where
        parseJSON
          = Core.withObject "DivisionSearchResult"
              (\ o ->
                 DivisionSearchResult Core.<$>
                   (o Core..:? "aliases") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "ocdId"))
...
instance Core.FromJSON ElectionOfficial where
        parseJSON
          = Core.withObject "ElectionOfficial"
              (\ o ->
                 ElectionOfficial Core.<$>
...
newElectionsQueryResponse =
  ElectionsQueryResponse
    {elections = Core.Nothing, kind = "civicinfo#electionsQueryResponse"}

instance Core.FromJSON ElectionsQueryResponse where
        parseJSON
          = Core.withObject "ElectionsQueryResponse"
              (\ o ->
                 ElectionsQueryResponse Core.<$>
...
newElectoralDistrict =
  ElectoralDistrict
    {id = Core.Nothing, name = Core.Nothing, scope = Core.Nothing}

instance Core.FromJSON ElectoralDistrict where
        parseJSON
          = Core.withObject "ElectoralDistrict"
              (\ o ->
                 ElectoralDistrict Core.<$>
...
newFeatureIdProto =
  FeatureIdProto
    {cellId = Core.Nothing, fprint = Core.Nothing, temporaryData = Core.Nothing}

instance Core.FromJSON FeatureIdProto where
        parseJSON
          = Core.withObject "FeatureIdProto"
              (\ o ->
                 FeatureIdProto Core.<$>
                   (o Core..:? "cellId" Core.<&>
                      Core.fmap Core.fromAsText)
...
instance Core.ToJSON FeatureIdProto where
        toJSON FeatureIdProto{..}
          = Core.object
              (Core.catMaybes
                 [("cellId" Core..=) Core.. Core.AsText Core.<$>
                    cellId,
                  ("fprint" Core..=) Core.. Core.AsText Core.<$>
                    fprint,
...
instance Core.FromJSON GeocodingSummary where
        parseJSON
          = Core.withObject "GeocodingSummary"
              (\ o ->
                 GeocodingSummary Core.<$>
                   (o Core..:? "addressUnderstood") Core.<*>
                     (o Core..:? "featureId")
...
instance Core.FromJSON GeographicDivision where
        parseJSON
          = Core.withObject "GeographicDivision"
              (\ o ->
                 GeographicDivision Core.<$>
                   (o Core..:? "alsoKnownAs") Core.<*>
                     (o Core..:? "name")
...
instance Core.FromJSON Office where
        parseJSON
          = Core.withObject "Office"
              (\ o ->
                 Office Core.<$>
                   (o Core..:? "divisionId") Core.<*>
                     (o Core..:? "levels")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON PollingLocation where
        parseJSON
          = Core.withObject "PollingLocation"
              (\ o ->
                 PollingLocation Core.<$>
                   (o Core..:? "address") Core.<*>
                     (o Core..:? "endDate")
          ...
          = Core.object
              (Core.catMaybes
                 [("administrationRegionId" Core..=) Core.<$>
                  ...
                  ("datasetId" Core..=) Core.. Core.AsText Core.<$>
                    datasetId,
                  ("earlyVoteSiteId" Core..=) Core.<$> earlyVoteSiteId,
                  ("electoralDistrictId" Core..=) Core.<$>
                    electoralDistrictId,
                  ("id" Core..=) Core.<$> id,
                  ...
                  ("ocdId" Core..=) Core.<$> ocdId,
                  ("pollingLocationId" Core..=) Core.<$>
                    pollingLocationId,
                  ("spatialBoundaryId" Core..=) Core.<$>
                    spatialBoundaryId,
...
newRepresentativeInfoData =
  RepresentativeInfoData
    {divisions = Core.Nothing, offices = Core.Nothing, officials = Core.Nothing}

instance Core.FromJSON RepresentativeInfoData where
        parseJSON
          = Core.withObject "RepresentativeInfoData"
              (\ o ->
                 RepresentativeInfoData Core.<$>
                   (o Core..:? "divisions") Core.<*>
                     (o Core..:? "offices")
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "RepresentativeInfoData_Divisions"
              (\ o ->
                 RepresentativeInfoData_Divisions Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON RepresentativeInfoData_Divisions
         where
...
instance Core.FromJSON RepresentativeInfoResponse
         where
        parseJSON
          = Core.withObject "RepresentativeInfoResponse"
              (\ o ->
                 RepresentativeInfoResponse Core.<$>
                   (o Core..:? "divisions") Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RepresentativeInfoResponse_Divisions"
              (\ o ->
                 RepresentativeInfoResponse_Divisions Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON SimpleAddressType where
        parseJSON
          = Core.withObject "SimpleAddressType"
              (\ o ->
                 SimpleAddressType Core.<$>
                   (o Core..:? "city") Core.<*> (o Core..:? "line1")
                     Core.<*> (o Core..:? "line2")
                     Core.<*> (o Core..:? "line3")
...
instance Core.FromJSON VoterInfoResponse where
        parseJSON
          = Core.withObject "VoterInfoResponse"
              (\ o ->
                 VoterInfoResponse Core.<$>
                   (o Core..:? "contests") Core.<*>
                     (o Core..:? "dropOffLocations")
