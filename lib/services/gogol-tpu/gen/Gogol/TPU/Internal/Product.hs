...
newAcceleratorType 
    ::  AcceleratorType
newAcceleratorType
  = AcceleratorType{acceleratorConfigs = Core.Nothing,
          ...
          = Core.withObject "AcceleratorType"
              (\ o ->
                 AcceleratorType Core.<$>
                   (o Core..:? "acceleratorConfigs") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "type"))
...
instance Core.ToJSON AcceleratorType where
        toJSON AcceleratorType{..}
          = Core.object
              (Core.catMaybes
                 [("acceleratorConfigs" Core..=) Core.<$> acceleratorConfigs,
...
instance Core.FromJSON AcceptedData where
        parseJSON
          = Core.withObject "AcceptedData" (\ o -> Core.pure AcceptedData)
...
instance Core.FromJSON AccessConfig where
        parseJSON
          = Core.withObject "AccessConfig"
              (\ o -> AccessConfig Core.<$> (o Core..:? "externalIp"))

instance Core.ToJSON AccessConfig where
        toJSON AccessConfig{..}
          = Core.object
              (Core.catMaybes [("externalIp" Core..=) Core.<$> externalIp])
...
instance Core.FromJSON ActiveData where
        parseJSON
          = Core.withObject "ActiveData" (\ o -> Core.pure ActiveData)
...
newAttachedDisk 
    ::  AttachedDisk
newAttachedDisk
  = AttachedDisk{mode = Core.Nothing, sourceDisk = Core.Nothing}
instance Core.FromJSON AttachedDisk where
        parseJSON
          = Core.withObject "AttachedDisk"
              (\ o ->
                 AttachedDisk Core.<$>
                   (o Core..:? "mode") Core.<*> (o Core..:? "sourceDisk"))
...
instance Core.FromJSON CreatingData where
        parseJSON
          = Core.withObject "CreatingData" (\ o -> Core.pure CreatingData)
...
instance Core.FromJSON DeletingData where
        parseJSON
          = Core.withObject "DeletingData" (\ o -> Core.pure DeletingData)
...
instance Core.ToJSON FailedData where
        toJSON FailedData{..}
          = Core.object (Core.catMaybes [("error" Core..=) Core.<$> error])
...
instance Core.FromJSON GenerateServiceIdentityResponse where
        parseJSON
          = Core.withObject "GenerateServiceIdentityResponse"
              (\ o ->
                 GenerateServiceIdentityResponse Core.<$> (o Core..:? "identity"))
...
newGetGuestAttributesRequest 
    ::  GetGuestAttributesRequest
newGetGuestAttributesRequest
  = GetGuestAttributesRequest{queryPath = Core.Nothing,
                              workerIds = Core.Nothing}
          ...
          = Core.withObject "GetGuestAttributesRequest"
              (\ o ->
                 GetGuestAttributesRequest Core.<$>
                   (o Core..:? "queryPath") Core.<*> (o Core..:? "workerIds"))
...
instance Core.FromJSON GetGuestAttributesResponse where
        parseJSON
          = Core.withObject "GetGuestAttributesResponse"
              (\ o ->
                 GetGuestAttributesResponse Core.<$> (o Core..:? "guestAttributes"))

instance Core.ToJSON GetGuestAttributesResponse where
        toJSON GetGuestAttributesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("guestAttributes" Core..=) Core.<$> guestAttributes])
...
instance Core.FromJSON Guaranteed where
        parseJSON
          = Core.withObject "Guaranteed"
              (\ o -> Guaranteed Core.<$> (o Core..:? "minDuration"))

instance Core.ToJSON Guaranteed where
        toJSON Guaranteed{..}
          = Core.object
              (Core.catMaybes [("minDuration" Core..=) Core.<$> minDuration])
...
newGuestAttributes 
    ::  GuestAttributes
newGuestAttributes
  = GuestAttributes{queryPath = Core.Nothing,
          ...
          = Core.withObject "GuestAttributes"
              (\ o ->
                 GuestAttributes Core.<$>
                   (o Core..:? "queryPath") Core.<*> (o Core..:? "queryValue"))
...
newGuestAttributesEntry 
    ::  GuestAttributesEntry
newGuestAttributesEntry
  = GuestAttributesEntry{key = Core.Nothing,
                         namespace = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON GuestAttributesEntry where
        parseJSON
          = Core.withObject "GuestAttributesEntry"
              (\ o ->
                 GuestAttributesEntry Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "namespace") Core.<*>
                     (o Core..:? "value"))
...
newListAcceleratorTypesResponse 
    ::  ListAcceleratorTypesResponse
newListAcceleratorTypesResponse
  = ListAcceleratorTypesResponse{acceleratorTypes = Core.Nothing,
...
newListNodesResponse 
    ::  ListNodesResponse
newListNodesResponse
  = ListNodesResponse{nextPageToken = Core.Nothing,
                      nodes = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListNodesResponse where
        parseJSON
          = Core.withObject "ListNodesResponse"
              (\ o ->
                 ListNodesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "nodes") Core.<*>
                     (o Core..:? "unreachable"))
...
newListQueuedResourcesResponse 
    ::  ListQueuedResourcesResponse
newListQueuedResourcesResponse
  = ListQueuedResourcesResponse{nextPageToken = Core.Nothing,
                                queuedResources = Core.Nothing, unreachable = Core.Nothing}
instance Core.FromJSON ListQueuedResourcesResponse where
        parseJSON
...
instance Core.ToJSON ListQueuedResourcesResponse where
...
newListRuntimeVersionsResponse 
    ::  ListRuntimeVersionsResponse
newListRuntimeVersionsResponse
  = ListRuntimeVersionsResponse{nextPageToken = Core.Nothing,
                                runtimeVersions = Core.Nothing, unreachable = Core.Nothing}
...
newMultisliceParams 
    ::  MultisliceParams
newMultisliceParams
  = MultisliceParams{nodeCount = Core.Nothing,
                     nodeIdPrefix = Core.Nothing}
instance Core.FromJSON MultisliceParams where
        parseJSON
          = Core.withObject "MultisliceParams"
              (\ o ->
                 MultisliceParams Core.<$>
                   (o Core..:? "nodeCount") Core.<*> (o Core..:? "nodeIdPrefix"))
...
newNetworkConfig 
    ::  NetworkConfig
newNetworkConfig
  = NetworkConfig{canIpForward = Core.Nothing,
                  enableExternalIps = Core.Nothing, network = Core.Nothing,
                  queueCount = Core.Nothing, subnetwork = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("canIpForward" Core..=) Core.<$> canIpForward,
                  ("enableExternalIps" Core..=) Core.<$> enableExternalIps,
...
newNetworkEndpoint 
    ::  NetworkEndpoint
newNetworkEndpoint
  = NetworkEndpoint{accessConfig = Core.Nothing,
                    ipAddress = Core.Nothing, port = Core.Nothing}
instance Core.FromJSON NetworkEndpoint where
        parseJSON
          = Core.withObject "NetworkEndpoint"
              (\ o ->
                 NetworkEndpoint Core.<$>
                   (o Core..:? "accessConfig") Core.<*> (o Core..:? "ipAddress")
                     Core.<*> (o Core..:? "port"))
...
data Node = Node
    ...
    , upcomingMaintenance :: (Core.Maybe UpcomingMaintenance)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newNode 
    ::  Node
newNode
  = Node{acceleratorConfig = Core.Nothing,
         acceleratorType = Core.Nothing, apiVersion = Core.Nothing,
         cidrBlock = Core.Nothing, createTime = Core.Nothing,
         dataDisks = Core.Nothing, description = Core.Nothing,
         health = Core.Nothing, healthDescription = Core.Nothing,
         id = Core.Nothing, labels = Core.Nothing, metadata = Core.Nothing,
         multisliceNode = Core.Nothing, name = Core.Nothing,
         networkConfig = Core.Nothing, networkConfigs = Core.Nothing,
         networkEndpoints = Core.Nothing, queuedResource = Core.Nothing,
         runtimeVersion = Core.Nothing, schedulingConfig = Core.Nothing,
         serviceAccount = Core.Nothing,
         shieldedInstanceConfig = Core.Nothing, state = Core.Nothing,
         symptoms = Core.Nothing, tags = Core.Nothing,
         upcomingMaintenance = Core.Nothing}
              ...
              (\ o ->
                 Node Core.<$>
                   (o Core..:? "acceleratorConfig") Core.<*>
                     ...
                     Core.<*> (o Core..:? "tags")
                     Core.<*> (o Core..:? "upcomingMaintenance"))
          ...
          = Core.object
              (Core.catMaybes
                 [("acceleratorConfig" Core..=) Core.<$> acceleratorConfig,
                  ...
                  ("healthDescription" Core..=) Core.<$> healthDescription,
                  ...
                  ("schedulingConfig" Core..=) Core.<$> schedulingConfig,
                  ...
                  ("tags" Core..=) Core.<$> tags,
                  ("upcomingMaintenance" Core..=) Core.<$> upcomingMaintenance])
...
instance Core.FromJSON Node_Labels where
        parseJSON
          = Core.withObject "Node_Labels"
              (\ o -> Node_Labels Core.<$> (Core.parseJSONObject o))
...
newNode_Metadata 
    :: 
       ...
       -- ^  See 'additional'.
    -> Node_Metadata
newNode_Metadata additional
  = Node_Metadata{additional = additional}
instance Core.FromJSON Node_Metadata where
        parseJSON
          = Core.withObject "Node_Metadata"
              (\ o -> Node_Metadata Core.<$> (Core.parseJSONObject o))
...
newNodeSpec 
    ::  NodeSpec
newNodeSpec
  = NodeSpec{multisliceParams = Core.Nothing, node = Core.Nothing,
             nodeId = Core.Nothing, parent = Core.Nothing}
instance Core.FromJSON NodeSpec where
        parseJSON
          = Core.withObject "NodeSpec"
              (\ o ->
                 NodeSpec Core.<$>
                   (o Core..:? "multisliceParams") Core.<*> (o Core..:? "node")
                     Core.<*> (o Core..:? "nodeId")
                     Core.<*> (o Core..:? "parent"))
...
instance Core.ToJSON NodeSpec where
        toJSON NodeSpec{..}
          = Core.object
              (Core.catMaybes
                 [("multisliceParams" Core..=) Core.<$> multisliceParams,
                  ("node" Core..=) Core.<$> node, ("nodeId" Core..=) Core.<$> nodeId,
...
newQueuedResource 
    ::  QueuedResource
newQueuedResource
  = QueuedResource{createTime = Core.Nothing,
                   guaranteed = Core.Nothing, name = Core.Nothing,
                   queueingPolicy = Core.Nothing, reservationName = Core.Nothing,
                   spot = Core.Nothing, state = Core.Nothing, tpu = Core.Nothing}
instance Core.FromJSON QueuedResource where
        parseJSON
          = Core.withObject "QueuedResource"
              (\ o ->
                 QueuedResource Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "guaranteed")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("spot" Core..=) Core.<$> spot, ("state" Core..=) Core.<$> state,
                  ("tpu" Core..=) Core.<$> tpu])
...
newQueuedResourceState 
    ::  QueuedResourceState
newQueuedResourceState
  = QueuedResourceState{acceptedData = Core.Nothing,
                        activeData = Core.Nothing, creatingData = Core.Nothing,
                        deletingData = Core.Nothing, failedData = Core.Nothing,
                        provisioningData = Core.Nothing, state = Core.Nothing,
                        stateInitiator = Core.Nothing, suspendedData = Core.Nothing,
          ...
          = Core.withObject "QueuedResourceState"
              (\ o ->
                 QueuedResourceState Core.<$>
                   (o Core..:? "acceptedData") Core.<*> (o Core..:? "activeData")
          ...
          = Core.object
              (Core.catMaybes
                 [("acceptedData" Core..=) Core.<$> acceptedData,
                  ...
                  ("provisioningData" Core..=) Core.<$> provisioningData,
                  ("state" Core..=) Core.<$> state,
...
newQueueingPolicy 
    ::  QueueingPolicy
newQueueingPolicy
  = QueueingPolicy{validAfterDuration = Core.Nothing,
                   validAfterTime = Core.Nothing, validInterval = Core.Nothing,
                   validUntilDuration = Core.Nothing, validUntilTime = Core.Nothing}
...
instance Core.ToJSON QueueingPolicy where
        toJSON QueueingPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("validAfterDuration" Core..=) Core.<$> validAfterDuration,
                  ("validAfterTime" Core..=) Core.<$> validAfterTime,
                  ("validInterval" Core..=) Core.<$> validInterval,
                  ("validUntilDuration" Core..=) Core.<$> validUntilDuration,
...
instance Core.FromJSON ResetQueuedResourceRequest where
        parseJSON
...
newRuntimeVersion 
    ::  RuntimeVersion
newRuntimeVersion
  = RuntimeVersion{name = Core.Nothing, version = Core.Nothing}
...
newSchedulingConfig 
    ::  SchedulingConfig
newSchedulingConfig
  = SchedulingConfig{preemptible = Core.Nothing,
                     reserved = Core.Nothing, spot = Core.Nothing}
instance Core.FromJSON SchedulingConfig where
        parseJSON
          = Core.withObject "SchedulingConfig"
              (\ o ->
                 SchedulingConfig Core.<$>
                   (o Core..:? "preemptible") Core.<*> (o Core..:? "reserved")
                     Core.<*> (o Core..:? "spot"))
...
newServiceAccount 
    ::  ServiceAccount
newServiceAccount
  = ServiceAccount{email = Core.Nothing, scope = Core.Nothing}
...
instance Core.FromJSON ServiceIdentity where
        parseJSON
          = Core.withObject "ServiceIdentity"
              (\ o -> ServiceIdentity Core.<$> (o Core..:? "email"))
...
instance Core.FromJSON ShieldedInstanceConfig where
        parseJSON
          = Core.withObject "ShieldedInstanceConfig"
              (\ o ->
                 ShieldedInstanceConfig Core.<$> (o Core..:? "enableSecureBoot"))
...
instance Core.FromJSON Spot where
        parseJSON = Core.withObject "Spot" (\ o -> Core.pure Spot)
...
instance Core.FromJSON SuspendedData where
        parseJSON
          = Core.withObject "SuspendedData" (\ o -> Core.pure SuspendedData)
...
newSymptom 
    ::  Symptom
newSymptom
  = Symptom{createTime = Core.Nothing, details = Core.Nothing,
            symptomType = Core.Nothing, workerId = Core.Nothing}
instance Core.FromJSON Symptom where
        parseJSON
          = Core.withObject "Symptom"
              (\ o ->
                 Symptom Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "details") Core.<*>
                     (o Core..:? "symptomType")
...
instance Core.ToJSON Tpu where
        toJSON Tpu{..}
          = Core.object
              (Core.catMaybes [("nodeSpec" Core..=) Core.<$> nodeSpec])


-- | Upcoming Maintenance notification information.
--
-- /See:/ 'newUpcomingMaintenance' smart constructor.
data UpcomingMaintenance = UpcomingMaintenance
    {
      -- | Indicates if the maintenance can be customer triggered.
      canReschedule :: (Core.Maybe Core.Bool)
      -- | The latest time for the planned maintenance window to start. This timestamp value is in RFC3339 text format.
    , latestWindowStartTime :: (Core.Maybe Core.Text)
      -- | The status of the maintenance.
    , maintenanceStatus :: (Core.Maybe UpcomingMaintenance_MaintenanceStatus)
      -- | Defines the type of maintenance.
    , type' :: (Core.Maybe UpcomingMaintenance_Type)
      -- | The time by which the maintenance disruption will be completed. This timestamp value is in RFC3339 text format.
    , windowEndTime :: (Core.Maybe Core.Text)
      -- | The current start time of the maintenance window. This timestamp value is in RFC3339 text format.
    , windowStartTime :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'UpcomingMaintenance' with the minimum fields required to make a request.
newUpcomingMaintenance 
    ::  UpcomingMaintenance
newUpcomingMaintenance
  = UpcomingMaintenance{canReschedule = Core.Nothing,
                        latestWindowStartTime = Core.Nothing,
                        maintenanceStatus = Core.Nothing, type' = Core.Nothing,
                        windowEndTime = Core.Nothing, windowStartTime = Core.Nothing}
instance Core.FromJSON UpcomingMaintenance where
        parseJSON
          = Core.withObject "UpcomingMaintenance"
              (\ o ->
                 UpcomingMaintenance Core.<$>
                   (o Core..:? "canReschedule") Core.<*>
                     (o Core..:? "latestWindowStartTime")
                     Core.<*> (o Core..:? "maintenanceStatus")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "windowEndTime")
                     Core.<*> (o Core..:? "windowStartTime"))

instance Core.ToJSON UpcomingMaintenance where
        toJSON UpcomingMaintenance{..}
          = Core.object
              (Core.catMaybes
                 [("canReschedule" Core..=) Core.<$> canReschedule,
                  ("latestWindowStartTime" Core..=) Core.<$> latestWindowStartTime,
                  ("maintenanceStatus" Core..=) Core.<$> maintenanceStatus,
                  ("type" Core..=) Core.<$> type',
                  ("windowEndTime" Core..=) Core.<$> windowEndTime,
