...
newTPUProjectsLocationsOperationsList name
  = TPUProjectsLocationsOperationsList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       filter = Core.Nothing, name = name, pageSize = Core.Nothing,
                                       pageToken = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TPUProjectsLocationsOperationsList
         where
        type Rs TPUProjectsLocationsOperationsList = ListOperationsResponse
        ...
        requestClient TPUProjectsLocationsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TPUProjectsLocationsOperationsListResource)
                      Core.mempty
