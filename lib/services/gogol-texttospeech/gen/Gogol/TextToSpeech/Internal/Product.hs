...
newAudioConfig 
    ::  AudioConfig
newAudioConfig
  = AudioConfig{audioEncoding = Core.Nothing,
                effectsProfileId = Core.Nothing, pitch = Core.Nothing,
                sampleRateHertz = Core.Nothing, speakingRate = Core.Nothing,
...
newCustomPronunciationParams 
    ::  CustomPronunciationParams
newCustomPronunciationParams
  = CustomPronunciationParams{phoneticEncoding = Core.Nothing,
                              phrase = Core.Nothing, pronunciation = Core.Nothing}
instance Core.FromJSON CustomPronunciationParams where
        parseJSON
          = Core.withObject "CustomPronunciationParams"
              (\ o ->
                 CustomPronunciationParams Core.<$>
                   (o Core..:? "phoneticEncoding") Core.<*> (o Core..:? "phrase")
...
instance Core.ToJSON CustomPronunciationParams where
        toJSON CustomPronunciationParams{..}
          = Core.object
              (Core.catMaybes
                 [("phoneticEncoding" Core..=) Core.<$> phoneticEncoding,
...
newCustomPronunciations 
    ::  CustomPronunciations
newCustomPronunciations
  = CustomPronunciations{pronunciations = Core.Nothing}
instance Core.FromJSON CustomPronunciations where
        parseJSON
          = Core.withObject "CustomPronunciations"
              (\ o ->
                 CustomPronunciations Core.<$> (o Core..:? "pronunciations"))
...
newGoogleCloudTexttospeechV1SynthesizeLongAudioMetadata 
    :: 
                                                        GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata
newGoogleCloudTexttospeechV1SynthesizeLongAudioMetadata
  = GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata{lastUpdateTime
                                                           = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata"
              (\ o ->
                 GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata Core.<$>
...
instance Core.ToJSON
           GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata
         where
        toJSON GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata{..}
          = Core.object
              (Core.catMaybes
...
instance Core.FromJSON ListVoicesResponse where
        parseJSON
          = Core.withObject "ListVoicesResponse"
              (\ o -> ListVoicesResponse Core.<$> (o Core..:? "voices"))

instance Core.ToJSON ListVoicesResponse where
        toJSON ListVoicesResponse{..}
          = Core.object (Core.catMaybes [("voices" Core..=) Core.<$> voices])
...
instance Core.FromJSON MultiSpeakerMarkup where
        parseJSON
          = Core.withObject "MultiSpeakerMarkup"
              (\ o -> MultiSpeakerMarkup Core.<$> (o Core..:? "turns"))

instance Core.ToJSON MultiSpeakerMarkup where
        toJSON MultiSpeakerMarkup{..}
          = Core.object (Core.catMaybes [("turns" Core..=) Core.<$> turns])
...
newSynthesisInput 
    ::  SynthesisInput
newSynthesisInput
  = SynthesisInput{customPronunciations = Core.Nothing,
                   markup = Core.Nothing, multiSpeakerMarkup = Core.Nothing,
                   ssml = Core.Nothing, text = Core.Nothing}
instance Core.FromJSON SynthesisInput where
        parseJSON
          = Core.withObject "SynthesisInput"
              (\ o ->
                 SynthesisInput Core.<$>
                   (o Core..:? "customPronunciations") Core.<*> (o Core..:? "markup")
                     Core.<*> (o Core..:? "multiSpeakerMarkup")
                     Core.<*> (o Core..:? "ssml")
                     Core.<*> (o Core..:? "text"))
...
instance Core.ToJSON SynthesisInput where
        toJSON SynthesisInput{..}
          = Core.object
              (Core.catMaybes
                 [("customPronunciations" Core..=) Core.<$> customPronunciations,
                  ("markup" Core..=) Core.<$> markup,
                  ("multiSpeakerMarkup" Core..=) Core.<$> multiSpeakerMarkup,
...
newSynthesizeLongAudioMetadata 
    ::  SynthesizeLongAudioMetadata
newSynthesizeLongAudioMetadata
  = SynthesizeLongAudioMetadata{lastUpdateTime = Core.Nothing,
                                progressPercentage = Core.Nothing, startTime = Core.Nothing}
...
newSynthesizeLongAudioRequest 
    ::  SynthesizeLongAudioRequest
newSynthesizeLongAudioRequest
  = SynthesizeLongAudioRequest{audioConfig = Core.Nothing,
                               input = Core.Nothing, outputGcsUri = Core.Nothing,
                               voice = Core.Nothing}
          ...
          = Core.withObject "SynthesizeLongAudioRequest"
              (\ o ->
                 SynthesizeLongAudioRequest Core.<$>
                   (o Core..:? "audioConfig") Core.<*> (o Core..:? "input") Core.<*>
                     (o Core..:? "outputGcsUri")
                     Core.<*> (o Core..:? "voice"))
...
newSynthesizeSpeechRequest 
    ::  SynthesizeSpeechRequest
newSynthesizeSpeechRequest
  = SynthesizeSpeechRequest{advancedVoiceOptions = Core.Nothing,
                            audioConfig = Core.Nothing, input = Core.Nothing,
                            voice = Core.Nothing}
...
instance Core.ToJSON SynthesizeSpeechRequest where
        toJSON SynthesizeSpeechRequest{..}
          = Core.object
              (Core.catMaybes
                 [("advancedVoiceOptions" Core..=) Core.<$> advancedVoiceOptions,
                  ("audioConfig" Core..=) Core.<$> audioConfig,
                  ("input" Core..=) Core.<$> input,
                  ("voice" Core..=) Core.<$> voice])
...
instance Core.FromJSON SynthesizeSpeechResponse where
        parseJSON
          = Core.withObject "SynthesizeSpeechResponse"
              (\ o ->
                 SynthesizeSpeechResponse Core.<$> (o Core..:? "audioContent"))
...
instance Core.FromJSON Turn where
        parseJSON
          = Core.withObject "Turn"
              (\ o ->
                 Turn Core.<$> (o Core..:? "speaker") Core.<*> (o Core..:? "text"))
...
newVoice 
    ::  Voice
newVoice
  = Voice{languageCodes = Core.Nothing, name = Core.Nothing,
          naturalSampleRateHertz = Core.Nothing, ssmlGender = Core.Nothing}
instance Core.FromJSON Voice where
        parseJSON
          = Core.withObject "Voice"
              (\ o ->
                 Voice Core.<$>
                   (o Core..:? "languageCodes") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "naturalSampleRateHertz")
          ...
          = Core.object
              (Core.catMaybes
                 [("languageCodes" Core..=) Core.<$> languageCodes,
                  ("name" Core..=) Core.<$> name,
                  ("naturalSampleRateHertz" Core..=) Core.<$> naturalSampleRateHertz,
