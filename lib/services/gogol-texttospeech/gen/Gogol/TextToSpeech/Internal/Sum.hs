  ...
  (
    ...
    CustomPronunciationParams_PhoneticEncoding
      (
        ...
        CustomPronunciationParams_PhoneticEncoding_PHONETICENCODINGJAPANESEYOMIGANA,
        CustomPronunciationParams_PhoneticEncoding_PHONETICENCODINGPINYIN,
        ..
      ),
...
-- | M4A audio.
pattern AudioConfig_AudioEncoding_M4A :: AudioConfig_AudioEncoding
pattern AudioConfig_AudioEncoding_M4A = AudioConfig_AudioEncoding "M4A"
...
pattern CustomPronunciationParams_PhoneticEncoding_PHONETICENCODINGJAPANESEYOMIGANA :: CustomPronunciationParams_PhoneticEncoding
pattern CustomPronunciationParams_PhoneticEncoding_PHONETICENCODINGJAPANESEYOMIGANA = CustomPronunciationParams_PhoneticEncoding "PHONETIC_ENCODING_JAPANESE_YOMIGANA"
...
pattern CustomPronunciationParams_PhoneticEncoding_PHONETICENCODINGPINYIN :: CustomPronunciationParams_PhoneticEncoding
pattern CustomPronunciationParams_PhoneticEncoding_PHONETICENCODINGPINYIN = CustomPronunciationParams_PhoneticEncoding "PHONETIC_ENCODING_PINYIN"
