                     ...
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "customerId" Core.Text Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "parameters" Core.Text Core.:>
...
instance Core.GoogleRequest
        ...
        type Scopes ReportsCustomerUsageReportsGet =
             '[Admin'Reports'Usage'Readonly]
        requestClient ReportsCustomerUsageReportsGet{..}
          = go date xgafv accessToken callback customerId
              pageToken
              parameters
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ReportsCustomerUsageReportsGetResource)
                      Core.mempty
