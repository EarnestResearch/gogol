              ...
              (\ o ->
                 Activity Core.<$>
                   (o Core..:? "actor") Core.<*> (o Core..:? "etag")
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#reports#activity")
...
newActivity_EventsItem =
  Activity_EventsItem
    {name = Core.Nothing, parameters = Core.Nothing, type' = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("boolValue" Core..=) Core.<$> boolValue,
                  ...
                  ("multiIntValue" Core..=) Core..
                    Core.fmap Core.AsText
                    Core.<$> multiIntValue,
                  ("multiMessageValue" Core..=) Core.<$>
                    multiMessageValue,
...
instance Core.FromJSON UsageReport where
        parseJSON
          = Core.withObject "UsageReport"
              (\ o ->
                 UsageReport Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "entity")
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON UsageReport_ParametersItem
         where
        parseJSON
...
instance Core.FromJSON UsageReports_WarningsItem
         where
        parseJSON
