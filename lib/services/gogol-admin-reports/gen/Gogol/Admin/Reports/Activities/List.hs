...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @reports.activities.list@.
module Gogol.Admin.Reports.Activities.List
    (
    -- * Resource
           ...
           "activity" Core.:>
             "users" Core.:>
               Core.Capture "userKey" Core.Text Core.:>
                 "applications" Core.:>
                   Core.Capture "applicationName" ActivitiesListApplicationName
                     Core.:>
...
newReportsActivitiesList applicationName userKey
  = ReportsActivitiesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ReportsActivitiesList where
        ...
        type Scopes ReportsActivitiesList = '[Admin'Reports'Audit'Readonly]
        requestClient ReportsActivitiesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ReportsActivitiesListResource)
                      Core.mempty
