                                 ...
                                 Core.QueryParam "endTime" Core.Text Core.:>
                                   Core.QueryParam "eventName" Core.Text Core.:>
                                     Core.QueryParam "filters" Core.Text Core.:>
                                       Core.QueryParam "groupIdFilter" Core.Text
                                         Core.:>
                                         Core.QueryParam "maxResults" Core.Int32
                                           Core.:>
                                           Core.QueryParam "orgUnitID" Core.Text
                                             Core.:>
                                             Core.QueryParam "pageToken"
                                               Core.Text
                                               Core.:>
                                               Core.QueryParam "startTime"
                                                 Core.Text
                                                 Core.:>
