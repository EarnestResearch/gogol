                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] GoogleCloudLocationListLocationsResponse
...
newDialogFlowProjectsLocationsList name
  = DialogFlowProjectsLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DialogFlowProjectsLocationsList where
        type Rs DialogFlowProjectsLocationsList =
             GoogleCloudLocationListLocationsResponse
        type Scopes DialogFlowProjectsLocationsList =
