     ...
     "books" Core.:>
       "v1" Core.:>
         "mylibrary" Core.:>
           "annotations" Core.:>
             "summary" Core.:>
               Core.QueryParams "layerIds" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Post '[Core.JSON] AnnotationsSummary
...
instance Core.GoogleRequest
           BooksMylibraryAnnotationsSummary
         where
        type Rs BooksMylibraryAnnotationsSummary =
             AnnotationsSummary
        type Scopes BooksMylibraryAnnotationsSummary =
             '[Books'FullControl]
        requestClient BooksMylibraryAnnotationsSummary{..}
          = go layerIds (Core.Just volumeId) xgafv accessToken
              callback
              uploadType
              uploadProtocol
