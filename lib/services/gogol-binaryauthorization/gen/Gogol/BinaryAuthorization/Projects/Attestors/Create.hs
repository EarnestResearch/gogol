         ...
         "attestors" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "attestorId" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Attestor Core.:>
                           Core.Post '[Core.JSON] Attestor
...
instance Core.GoogleRequest
           BinaryAuthorizationProjectsAttestorsCreate
         where
        type Rs BinaryAuthorizationProjectsAttestorsCreate =
             Attestor
        type Scopes
               BinaryAuthorizationProjectsAttestorsCreate
        ...
        requestClient
          BinaryAuthorizationProjectsAttestorsCreate{..}
          = go parent xgafv accessToken attestorId callback
              uploadType
              uploadProtocol
