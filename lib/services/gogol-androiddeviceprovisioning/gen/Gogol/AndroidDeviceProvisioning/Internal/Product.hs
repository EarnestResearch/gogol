...
-- |
-- Module      : Gogol.AndroidDeviceProvisioning.Internal.Product
...
instance Core.FromJSON ClaimDeviceRequest where
        parseJSON
          = Core.withObject "ClaimDeviceRequest"
              (\ o ->
                 ClaimDeviceRequest Core.<$>
                   (o Core..:? "customerId" Core.<&>
...
instance Core.ToJSON ClaimDeviceRequest where
        toJSON ClaimDeviceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("customerId" Core..=) Core.. Core.AsText Core.<$>
                    customerId,
                  ("deviceIdentifier" Core..=) Core.<$>
                    deviceIdentifier,
                  ("deviceMetadata" Core..=) Core.<$> deviceMetadata,
                  ("googleWorkspaceCustomerId" Core..=) Core.<$>
                    googleWorkspaceCustomerId,
                  ("preProvisioningToken" Core..=) Core.<$>
...
instance Core.FromJSON ClaimDeviceResponse where
        parseJSON
          = Core.withObject "ClaimDeviceResponse"
              (\ o ->
                 ClaimDeviceResponse Core.<$>
...
instance Core.ToJSON ClaimDeviceResponse where
        toJSON ClaimDeviceResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deviceId" Core..=) Core.. Core.AsText Core.<$>
                    deviceId,
...
instance Core.FromJSON ClaimDevicesRequest where
        parseJSON
          = Core.withObject "ClaimDevicesRequest"
              (\ o ->
...
instance Core.FromJSON Company where
        parseJSON
          = Core.withObject "Company"
              (\ o ->
                 Company Core.<$>
                   (o Core..:? "adminEmails") Core.<*>
                     (o Core..:? "companyId" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("adminEmails" Core..=) Core.<$> adminEmails,
                  ("companyId" Core..=) Core.. Core.AsText Core.<$>
                    companyId,
                  ("companyName" Core..=) Core.<$> companyName,
                  ("googleWorkspaceAccount" Core..=) Core.<$>
                    googleWorkspaceAccount,
                  ("languageCode" Core..=) Core.<$> languageCode,
                  ("name" Core..=) Core.<$> name,
                  ("ownerEmails" Core..=) Core.<$> ownerEmails,
                  ("skipWelcomeEmail" Core..=) Core.<$>
                    skipWelcomeEmail,
...
data Configuration = Configuration
    ...
    , forcedResetTime :: (Core.Maybe Core.Duration)
...
instance Core.FromJSON Configuration where
        parseJSON
          = Core.withObject "Configuration"
              (\ o ->
                 Configuration Core.<$>
                   (o Core..:? "companyName") Core.<*>
                     (o Core..:? "configurationId" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("companyName" Core..=) Core.<$> companyName,
                  ...
                  ("forcedResetTime" Core..=) Core.<$> forcedResetTime,
...
instance Core.FromJSON CreateCustomerRequest where
        parseJSON
          = Core.withObject "CreateCustomerRequest"
              (\ o ->
...
newCustomerApplyConfigurationRequest =
  CustomerApplyConfigurationRequest
    {configuration = Core.Nothing, device = Core.Nothing}

instance Core.FromJSON
           CustomerApplyConfigurationRequest
         where
        parseJSON
          = Core.withObject "CustomerApplyConfigurationRequest"
              (\ o ->
                 CustomerApplyConfigurationRequest Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "CustomerListConfigurationsResponse"
              (\ o ->
                 CustomerListConfigurationsResponse Core.<$>
...
newCustomerListCustomersResponse =
  CustomerListCustomersResponse
    {customers = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON CustomerListCustomersResponse
         where
        parseJSON
          = Core.withObject "CustomerListCustomersResponse"
              (\ o ->
                 CustomerListCustomersResponse Core.<$>
                   (o Core..:? "customers") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON CustomerListCustomersResponse
         where
...
instance Core.FromJSON CustomerListDevicesResponse
         where
        parseJSON
          = Core.withObject "CustomerListDevicesResponse"
              (\ o ->
                 CustomerListDevicesResponse Core.<$>
                   (o Core..:? "devices") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON CustomerListDevicesResponse
         where
...
instance Core.FromJSON CustomerListDpcsResponse where
        parseJSON
          = Core.withObject "CustomerListDpcsResponse"
              (\ o ->
                 CustomerListDpcsResponse Core.<$>
                   (o Core..:? "dpcs"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "CustomerRemoveConfigurationRequest"
              (\ o ->
                 CustomerRemoveConfigurationRequest Core.<$>
                   (o Core..:? "device"))
...
instance Core.FromJSON CustomerUnclaimDeviceRequest
         where
        parseJSON
          = Core.withObject "CustomerUnclaimDeviceRequest"
              (\ o ->
                 CustomerUnclaimDeviceRequest Core.<$>
                   (o Core..:? "device"))

instance Core.ToJSON CustomerUnclaimDeviceRequest
         where
...
instance Core.FromJSON DeviceClaim where
        parseJSON
          = Core.withObject "DeviceClaim"
              (\ o ->
                 DeviceClaim Core.<$>
                   (o Core..:? "additionalService") Core.<*>
                     (o Core..:? "googleWorkspaceCustomerId")
                     Core.<*>
                     (o Core..:? "ownerCompanyId" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "resellerId" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "sectionType")
...
instance Core.ToJSON DeviceClaim where
        toJSON DeviceClaim{..}
          = Core.object
              (Core.catMaybes
                 [("additionalService" Core..=) Core.<$>
                    additionalService,
                  ("googleWorkspaceCustomerId" Core..=) Core.<$>
                    googleWorkspaceCustomerId,
                  ("ownerCompanyId" Core..=) Core.. Core.AsText
                    Core.<$> ownerCompanyId,
                  ("resellerId" Core..=) Core.. Core.AsText Core.<$>
                    resellerId,
                  ("sectionType" Core..=) Core.<$> sectionType,
                  ("vacationModeExpireTime" Core..=) Core.<$>
                    vacationModeExpireTime,
                  ("vacationModeStartTime" Core..=) Core.<$>
...
instance Core.FromJSON DeviceIdentifier where
        parseJSON
          = Core.withObject "DeviceIdentifier"
              (\ o ->
                 DeviceIdentifier Core.<$>
                   (o Core..:? "chromeOsAttestedDeviceId") Core.<*>
                     (o Core..:? "deviceType")
                     Core.<*> (o Core..:? "imei")
...
instance Core.ToJSON DeviceIdentifier where
        toJSON DeviceIdentifier{..}
          = Core.object
              (Core.catMaybes
                 [("chromeOsAttestedDeviceId" Core..=) Core.<$>
...
newDeviceMetadata_Entries 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> DeviceMetadata_Entries
newDeviceMetadata_Entries additional =
  DeviceMetadata_Entries {additional = additional}

instance Core.FromJSON DeviceMetadata_Entries where
        parseJSON
          = Core.withObject "DeviceMetadata_Entries"
              (\ o ->
                 DeviceMetadata_Entries Core.<$>
...
instance Core.FromJSON DeviceReference where
        parseJSON
          = Core.withObject "DeviceReference"
              (\ o ->
                 DeviceReference Core.<$>
                   (o Core..:? "deviceId" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "deviceIdentifier"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "DevicesLongRunningOperationMetadata"
              (\ o ->
                 DevicesLongRunningOperationMetadata Core.<$>
                   (o Core..:? "devicesCount") Core.<*>
                     (o Core..:? "processingStatus")
...
newDevicesLongRunningOperationResponse =
  DevicesLongRunningOperationResponse
    {perDeviceStatus = Core.Nothing, successCount = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "DevicesLongRunningOperationResponse"
              (\ o ->
                 DevicesLongRunningOperationResponse Core.<$>
                   (o Core..:? "perDeviceStatus") Core.<*>
                     (o Core..:? "successCount"))
...
instance Core.FromJSON Dpc where
        parseJSON
          = Core.withObject "Dpc"
              (\ o ->
                 Dpc Core.<$>
                   (o Core..:? "dpcName") Core.<*> (o Core..:? "name")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "FindDevicesByDeviceIdentifierRequest"
              (\ o ->
                 FindDevicesByDeviceIdentifierRequest Core.<$>
                   (o Core..:? "deviceIdentifier") Core.<*>
                     (o Core..:? "limit" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "FindDevicesByDeviceIdentifierResponse"
              (\ o ->
                 FindDevicesByDeviceIdentifierResponse Core.<$>
                   (o Core..:? "devices") Core.<*>
                     (o Core..:? "nextPageToken")
...
instance Core.FromJSON FindDevicesByOwnerRequest
         where
        parseJSON
          = Core.withObject "FindDevicesByOwnerRequest"
              (\ o ->
                 FindDevicesByOwnerRequest Core.<$>
                   (o Core..:? "customerId" Core.<&>
...
instance Core.FromJSON FindDevicesByOwnerResponse
         where
        parseJSON
          = Core.withObject "FindDevicesByOwnerResponse"
              (\ o ->
                 FindDevicesByOwnerResponse Core.<$>
                   (o Core..:? "devices") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
...
newGoogleWorkspaceAccount =
  GoogleWorkspaceAccount
    {customerId = Core.Nothing, preProvisioningTokens = Core.Nothing}

instance Core.FromJSON GoogleWorkspaceAccount where
        parseJSON
          = Core.withObject "GoogleWorkspaceAccount"
              (\ o ->
                 GoogleWorkspaceAccount Core.<$>
                   (o Core..:? "customerId") Core.<*>
                     (o Core..:? "preProvisioningTokens"))
          ...
          = Core.object
              (Core.catMaybes
                 [("customerId" Core..=) Core.<$> customerId,
                  ("preProvisioningTokens" Core..=) Core.<$>
...
instance Core.FromJSON ListCustomersResponse where
        parseJSON
          = Core.withObject "ListCustomersResponse"
              (\ o ->
                 ListCustomersResponse Core.<$>
                   (o Core..:? "customers") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
...
instance Core.FromJSON ListVendorCustomersResponse
         where
        parseJSON
          = Core.withObject "ListVendorCustomersResponse"
              (\ o ->
                 ListVendorCustomersResponse Core.<$>
                   (o Core..:? "customers") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))

instance Core.ToJSON ListVendorCustomersResponse
         where
...
instance Core.FromJSON ListVendorsResponse where
        parseJSON
          = Core.withObject "ListVendorsResponse"
              (\ o ->
                 ListVendorsResponse Core.<$>
...
instance Core.FromJSON OperationPerDevice where
        parseJSON
          = Core.withObject "OperationPerDevice"
              (\ o ->
                 OperationPerDevice Core.<$>
                   (o Core..:? "claim") Core.<*> (o Core..:? "result")
                     Core.<*> (o Core..:? "unclaim")
...
instance Core.FromJSON PartnerUnclaim where
        parseJSON
          = Core.withObject "PartnerUnclaim"
              (\ o ->
                 PartnerUnclaim Core.<$>
                   (o Core..:? "deviceId" Core.<&>
                      Core.fmap Core.fromAsText)
...
instance Core.FromJSON PerDeviceStatusInBatch where
        parseJSON
          = Core.withObject "PerDeviceStatusInBatch"
              (\ o ->
                 PerDeviceStatusInBatch Core.<$>
                   (o Core..:? "deviceId" Core.<&>
                      Core.fmap Core.fromAsText)
...
instance Core.FromJSON UnclaimDeviceRequest where
        parseJSON
          = Core.withObject "UnclaimDeviceRequest"
              (\ o ->
                 UnclaimDeviceRequest Core.<$>
                   (o Core..:? "deviceId" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "deviceIdentifier")
                     Core.<*> (o Core..:? "sectionType")
...
instance Core.FromJSON UnclaimDevicesRequest where
        parseJSON
          = Core.withObject "UnclaimDevicesRequest"
              (\ o ->
                 UnclaimDevicesRequest Core.<$>
                   (o Core..:? "unclaims"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "UpdateDeviceMetadataInBatchRequest"
              (\ o ->
                 UpdateDeviceMetadataInBatchRequest Core.<$>
                   (o Core..:? "updates"))
...
instance Core.FromJSON UpdateDeviceMetadataRequest
         where
        parseJSON
          = Core.withObject "UpdateDeviceMetadataRequest"
              (\ o ->
                 UpdateDeviceMetadataRequest Core.<$>
                   (o Core..:? "deviceMetadata"))

instance Core.ToJSON UpdateDeviceMetadataRequest
         where
...
instance Core.FromJSON UpdateMetadataArguments where
        parseJSON
          = Core.withObject "UpdateMetadataArguments"
              (\ o ->
                 UpdateMetadataArguments Core.<$>
                   (o Core..:? "deviceId" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "deviceIdentifier")
                     Core.<*> (o Core..:? "deviceMetadata"))
