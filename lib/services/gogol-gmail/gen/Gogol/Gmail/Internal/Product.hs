...
instance Core.FromJSON AutoForwarding where
        parseJSON
          = Core.withObject "AutoForwarding"
              (\ o ->
                 AutoForwarding Core.<$>
                   (o Core..:? "disposition") Core.<*>
                     (o Core..:? "emailAddress")
                     Core.<*> (o Core..:? "enabled"))
...
newBatchDeleteMessagesRequest 
    ::  BatchDeleteMessagesRequest
newBatchDeleteMessagesRequest = BatchDeleteMessagesRequest {ids = Core.Nothing}

instance Core.FromJSON BatchDeleteMessagesRequest
         where
        parseJSON
          = Core.withObject "BatchDeleteMessagesRequest"
              (\ o ->
                 BatchDeleteMessagesRequest Core.<$>
                   (o Core..:? "ids"))

instance Core.ToJSON BatchDeleteMessagesRequest where
        toJSON BatchDeleteMessagesRequest{..}
          = Core.object
              (Core.catMaybes [("ids" Core..=) Core.<$> ids])
...
instance Core.FromJSON BatchModifyMessagesRequest
         where
        parseJSON
          = Core.withObject "BatchModifyMessagesRequest"
              (\ o ->
                 BatchModifyMessagesRequest Core.<$>
                   (o Core..:? "addLabelIds") Core.<*>
                     (o Core..:? "ids")
...
instance Core.FromJSON CseIdentity where
        parseJSON
          = Core.withObject "CseIdentity"
              (\ o ->
                 CseIdentity Core.<$>
                   (o Core..:? "emailAddress") Core.<*>
                     (o Core..:? "primaryKeyPairId"))
...
instance Core.FromJSON CseKeyPair where
        parseJSON
          = Core.withObject "CseKeyPair"
              (\ o ->
                 CseKeyPair Core.<$>
                   (o Core..:? "disableTime") Core.<*>
                     (o Core..:? "enablementState")
          ...
          = Core.object
              (Core.catMaybes
                 [("disableTime" Core..=) Core.<$> disableTime,
                  ...
                  ("privateKeyMetadata" Core..=) Core.<$>
                    privateKeyMetadata,
                  ("subjectEmailAddresses" Core..=) Core.<$>
...
newCsePrivateKeyMetadata =
  CsePrivateKeyMetadata
    {kaclsKeyMetadata = Core.Nothing, privateKeyMetadataId = Core.Nothing}

instance Core.FromJSON CsePrivateKeyMetadata where
        parseJSON
          = Core.withObject "CsePrivateKeyMetadata"
              (\ o ->
                 CsePrivateKeyMetadata Core.<$>
                   (o Core..:? "kaclsKeyMetadata") Core.<*>
                     (o Core..:? "privateKeyMetadataId"))

instance Core.ToJSON CsePrivateKeyMetadata where
        toJSON CsePrivateKeyMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("kaclsKeyMetadata" Core..=) Core.<$>
                    kaclsKeyMetadata,
                  ("privateKeyMetadataId" Core..=) Core.<$>
...
newDelegate 
    ::  Delegate
newDelegate =
  Delegate {delegateEmail = Core.Nothing, verificationStatus = Core.Nothing}

instance Core.FromJSON Delegate where
        parseJSON
          = Core.withObject "Delegate"
              (\ o ->
                 Delegate Core.<$>
                   (o Core..:? "delegateEmail") Core.<*>
                     (o Core..:? "verificationStatus"))
...
instance Core.FromJSON DisableCseKeyPairRequest where
        parseJSON
          = Core.withObject "DisableCseKeyPairRequest"
...
instance Core.FromJSON Draft where
        parseJSON
          = Core.withObject "Draft"
              (\ o ->
                 Draft Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "message"))
...
instance Core.FromJSON EnableCseKeyPairRequest where
        parseJSON
          = Core.withObject "EnableCseKeyPairRequest"
...
newFilter 
    ::  Filter
newFilter =
  Filter {action = Core.Nothing, criteria = Core.Nothing, id = Core.Nothing}
...
newForwardingAddress =
  ForwardingAddress
    {forwardingEmail = Core.Nothing, verificationStatus = Core.Nothing}

instance Core.FromJSON ForwardingAddress where
        parseJSON
          = Core.withObject "ForwardingAddress"
              (\ o ->
                 ForwardingAddress Core.<$>
                   (o Core..:? "forwardingEmail") Core.<*>
                     (o Core..:? "verificationStatus"))
...
newHistoryLabelAdded 
    ::  HistoryLabelAdded
newHistoryLabelAdded =
  HistoryLabelAdded {labelIds = Core.Nothing, message = Core.Nothing}

instance Core.FromJSON HistoryLabelAdded where
        parseJSON
          = Core.withObject "HistoryLabelAdded"
              (\ o ->
                 HistoryLabelAdded Core.<$>
                   (o Core..:? "labelIds") Core.<*>
                     (o Core..:? "message"))
...
newHistoryLabelRemoved 
    ::  HistoryLabelRemoved
newHistoryLabelRemoved =
  HistoryLabelRemoved {labelIds = Core.Nothing, message = Core.Nothing}

instance Core.FromJSON HistoryLabelRemoved where
        parseJSON
          = Core.withObject "HistoryLabelRemoved"
              (\ o ->
                 HistoryLabelRemoved Core.<$>
                   (o Core..:? "labelIds") Core.<*>
                     (o Core..:? "message"))
...
newHistoryMessageAdded 
    ::  HistoryMessageAdded
newHistoryMessageAdded = HistoryMessageAdded {message = Core.Nothing}

instance Core.FromJSON HistoryMessageAdded where
        parseJSON
          = Core.withObject "HistoryMessageAdded"
              (\ o ->
                 HistoryMessageAdded Core.<$> (o Core..:? "message"))
...
newHistoryMessageDeleted 
    ::  HistoryMessageDeleted
newHistoryMessageDeleted = HistoryMessageDeleted {message = Core.Nothing}

instance Core.FromJSON HistoryMessageDeleted where
        parseJSON
          = Core.withObject "HistoryMessageDeleted"
              (\ o ->
                 HistoryMessageDeleted Core.<$>
                   (o Core..:? "message"))
...
instance Core.FromJSON ImapSettings where
        parseJSON
          = Core.withObject "ImapSettings"
              (\ o ->
                 ImapSettings Core.<$>
                   (o Core..:? "autoExpunge") Core.<*>
                     (o Core..:? "enabled")
...
instance Core.FromJSON KaclsKeyMetadata where
        parseJSON
          = Core.withObject "KaclsKeyMetadata"
              (\ o ->
                 KaclsKeyMetadata Core.<$>
                   (o Core..:? "kaclsData") Core.<*>
                     (o Core..:? "kaclsUri"))
          ...
          = Core.object
              (Core.catMaybes
                 [("color" Core..=) Core.<$> color,
                  ("id" Core..=) Core.<$> id,
                  ("labelListVisibility" Core..=) Core.<$>
                    labelListVisibility,
                  ("messageListVisibility" Core..=) Core.<$>
...
newLabelColor 
    ::  LabelColor
newLabelColor =
  LabelColor {backgroundColor = Core.Nothing, textColor = Core.Nothing}

instance Core.FromJSON LabelColor where
        parseJSON
          = Core.withObject "LabelColor"
              (\ o ->
                 LabelColor Core.<$>
...
newLanguageSettings 
    ::  LanguageSettings
newLanguageSettings = LanguageSettings {displayLanguage = Core.Nothing}

instance Core.FromJSON LanguageSettings where
        parseJSON
          = Core.withObject "LanguageSettings"
              (\ o ->
                 LanguageSettings Core.<$>
                   (o Core..:? "displayLanguage"))

instance Core.ToJSON LanguageSettings where
        toJSON LanguageSettings{..}
          = Core.object
              (Core.catMaybes
                 [("displayLanguage" Core..=) Core.<$>
                    displayLanguage])
...
newListCseIdentitiesResponse =
  ListCseIdentitiesResponse
    {cseIdentities = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListCseIdentitiesResponse
         where
        parseJSON
          = Core.withObject "ListCseIdentitiesResponse"
              (\ o ->
                 ListCseIdentitiesResponse Core.<$>
                   (o Core..:? "cseIdentities") Core.<*>
...
newListCseKeyPairsResponse =
  ListCseKeyPairsResponse
    {cseKeyPairs = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListCseKeyPairsResponse where
        parseJSON
          = Core.withObject "ListCseKeyPairsResponse"
              (\ o ->
                 ListCseKeyPairsResponse Core.<$>
                   (o Core..:? "cseKeyPairs") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListDelegatesResponse 
    ::  ListDelegatesResponse
newListDelegatesResponse = ListDelegatesResponse {delegates = Core.Nothing}

instance Core.FromJSON ListDelegatesResponse where
        parseJSON
          = Core.withObject "ListDelegatesResponse"
              (\ o ->
                 ListDelegatesResponse Core.<$>
                   (o Core..:? "delegates"))
...
instance Core.FromJSON ListDraftsResponse where
        parseJSON
          = Core.withObject "ListDraftsResponse"
              (\ o ->
                 ListDraftsResponse Core.<$>
                   (o Core..:? "drafts") Core.<*>
                     (o Core..:? "nextPageToken")
...
instance Core.FromJSON ListFiltersResponse where
        parseJSON
          = Core.withObject "ListFiltersResponse"
              (\ o ->
...
newListForwardingAddressesResponse 
    ::  ListForwardingAddressesResponse
newListForwardingAddressesResponse =
  ListForwardingAddressesResponse {forwardingAddresses = Core.Nothing}

instance Core.FromJSON
           ListForwardingAddressesResponse
         where
        parseJSON
          = Core.withObject "ListForwardingAddressesResponse"
              (\ o ->
                 ListForwardingAddressesResponse Core.<$>
                   (o Core..:? "forwardingAddresses"))

instance Core.ToJSON ListForwardingAddressesResponse
         where
        toJSON ListForwardingAddressesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("forwardingAddresses" Core..=) Core.<$>
                    forwardingAddresses])
...
instance Core.FromJSON ListHistoryResponse where
        parseJSON
          = Core.withObject "ListHistoryResponse"
              (\ o ->
                 ListHistoryResponse Core.<$>
                   (o Core..:? "history") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("history" Core..=) Core.<$> history,
                  ("historyId" Core..=) Core.. Core.AsText Core.<$>
                    historyId,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
instance Core.FromJSON ListLabelsResponse where
        parseJSON
          = Core.withObject "ListLabelsResponse"
              (\ o ->
...
instance Core.FromJSON ListSendAsResponse where
        parseJSON
          = Core.withObject "ListSendAsResponse"
              (\ o ->
...
instance Core.ToJSON ListSendAsResponse where
        toJSON ListSendAsResponse{..}
          = Core.object
              (Core.catMaybes [("sendAs" Core..=) Core.<$> sendAs])
...
newListSmimeInfoResponse 
    ::  ListSmimeInfoResponse
newListSmimeInfoResponse = ListSmimeInfoResponse {smimeInfo = Core.Nothing}

instance Core.FromJSON ListSmimeInfoResponse where
        parseJSON
          = Core.withObject "ListSmimeInfoResponse"
              (\ o ->
                 ListSmimeInfoResponse Core.<$>
                   (o Core..:? "smimeInfo"))
...
instance Core.FromJSON ListThreadsResponse where
        parseJSON
          = Core.withObject "ListThreadsResponse"
              (\ o ->
                 ListThreadsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "resultSizeEstimate")
                     Core.<*> (o Core..:? "threads"))
          ...
          = Core.object
              (Core.catMaybes
                 [("historyId" Core..=) Core.. Core.AsText Core.<$>
                    historyId,
                  ("id" Core..=) Core.<$> id,
                  ("internalDate" Core..=) Core.. Core.AsText Core.<$>
                    internalDate,
                  ("labelIds" Core..=) Core.<$> labelIds,
...
instance Core.FromJSON MessagePart where
        parseJSON
          = Core.withObject "MessagePart"
              (\ o ->
                 MessagePart Core.<$>
                   (o Core..:? "body") Core.<*> (o Core..:? "filename")
                     Core.<*> (o Core..:? "headers")
...
newMessagePartBody =
  MessagePartBody
    {attachmentId = Core.Nothing, data' = Core.Nothing, size = Core.Nothing}

instance Core.FromJSON MessagePartBody where
        parseJSON
          = Core.withObject "MessagePartBody"
              (\ o ->
                 MessagePartBody Core.<$>
...
instance Core.FromJSON MessagePartHeader where
        parseJSON
          = Core.withObject "MessagePartHeader"
              (\ o ->
                 MessagePartHeader Core.<$>
...
newModifyMessageRequest =
  ModifyMessageRequest
    {addLabelIds = Core.Nothing, removeLabelIds = Core.Nothing}

instance Core.FromJSON ModifyMessageRequest where
        parseJSON
          = Core.withObject "ModifyMessageRequest"
              (\ o ->
                 ModifyMessageRequest Core.<$>
                   (o Core..:? "addLabelIds") Core.<*>
                     (o Core..:? "removeLabelIds"))
...
instance Core.FromJSON ModifyThreadRequest where
        parseJSON
          = Core.withObject "ModifyThreadRequest"
              (\ o ->
                 ModifyThreadRequest Core.<$>
                   (o Core..:? "addLabelIds") Core.<*>
                     (o Core..:? "removeLabelIds"))
...
instance Core.FromJSON ObliterateCseKeyPairRequest
         where
        parseJSON
          = Core.withObject "ObliterateCseKeyPairRequest"
              (\ o -> Core.pure ObliterateCseKeyPairRequest)

instance Core.ToJSON ObliterateCseKeyPairRequest
         where
        toJSON = Core.const Core.emptyObject
...
newPopSettings 
    ::  PopSettings
newPopSettings =
  PopSettings {accessWindow = Core.Nothing, disposition = Core.Nothing}

instance Core.FromJSON PopSettings where
        parseJSON
          = Core.withObject "PopSettings"
              (\ o ->
                 PopSettings Core.<$>
                   (o Core..:? "accessWindow") Core.<*>
                     (o Core..:? "disposition"))
...
instance Core.FromJSON SmimeInfo where
        parseJSON
          = Core.withObject "SmimeInfo"
              (\ o ->
                 SmimeInfo Core.<$>
                   (o Core..:? "encryptedKeyPassword") Core.<*>
...
instance Core.ToJSON SmimeInfo where
        toJSON SmimeInfo{..}
          = Core.object
              (Core.catMaybes
                 [("encryptedKeyPassword" Core..=) Core.<$>
...
instance Core.FromJSON SmtpMsa where
        parseJSON
          = Core.withObject "SmtpMsa"
              (\ o ->
                 SmtpMsa Core.<$>
                   (o Core..:? "host") Core.<*> (o Core..:? "password")
                     Core.<*> (o Core..:? "port")
...
instance Core.FromJSON VacationSettings where
        parseJSON
          = Core.withObject "VacationSettings"
              (\ o ->
                 VacationSettings Core.<$>
                   (o Core..:? "enableAutoReply") Core.<*>
                     (o Core..:? "endTime" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON VacationSettings where
        toJSON VacationSettings{..}
          = Core.object
              (Core.catMaybes
                 [("enableAutoReply" Core..=) Core.<$>
                    enableAutoReply,
                  ("endTime" Core..=) Core.. Core.AsText Core.<$>
                    endTime,
                  ("responseBodyHtml" Core..=) Core.<$>
                    responseBodyHtml,
                  ("responseBodyPlainText" Core..=) Core.<$>
                    responseBodyPlainText,
                  ("responseSubject" Core..=) Core.<$> responseSubject,
                  ("restrictToContacts" Core..=) Core.<$>
                    restrictToContacts,
                  ("restrictToDomain" Core..=) Core.<$>
                    restrictToDomain,
...
instance Core.FromJSON WatchRequest where
        parseJSON
          = Core.withObject "WatchRequest"
              (\ o ->
                 WatchRequest Core.<$>
                   (o Core..:? "labelFilterAction") Core.<*>
                     (o Core..:? "labelIds")
...
newWatchResponse 
    ::  WatchResponse
newWatchResponse =
  WatchResponse {expiration = Core.Nothing, historyId = Core.Nothing}

instance Core.FromJSON WatchResponse where
        parseJSON
          = Core.withObject "WatchResponse"
              (\ o ->
                 WatchResponse Core.<$>
                   (o Core..:? "expiration" Core.<&>
                      Core.fmap Core.fromAsText)
