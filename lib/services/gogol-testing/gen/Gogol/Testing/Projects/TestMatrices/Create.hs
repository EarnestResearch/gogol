                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] TestMatrix Core.:>
                             Core.Post '[Core.JSON] TestMatrix
...
instance Core.GoogleRequest
           TestingProjectsTestMatricesCreate
         where
        type Rs TestingProjectsTestMatricesCreate =
             TestMatrix
        type Scopes TestingProjectsTestMatricesCreate =
             '[CloudPlatform'FullControl]
        requestClient TestingProjectsTestMatricesCreate{..}
          = go projectId xgafv accessToken callback requestId
              uploadType
              uploadProtocol
