...
instance Core.ToJSON Account where
        toJSON Account{..}
          = Core.object
              (Core.catMaybes [("googleAuto" Core..=) Core.<$> googleAuto])
...
newAndroidDevice 
    ::  AndroidDevice
newAndroidDevice
  = AndroidDevice{androidModelId = Core.Nothing,
                  androidVersionId = Core.Nothing, locale = Core.Nothing,
                  orientation = Core.Nothing}
instance Core.FromJSON AndroidDevice where
        parseJSON
          = Core.withObject "AndroidDevice"
              (\ o ->
                 AndroidDevice Core.<$>
                   (o Core..:? "androidModelId") Core.<*>
                     (o Core..:? "androidVersionId")
                     Core.<*> (o Core..:? "locale")
          ...
          = Core.object
              (Core.catMaybes
                 [("androidModelId" Core..=) Core.<$> androidModelId,
                  ("androidVersionId" Core..=) Core.<$> androidVersionId,
...
newAndroidDeviceCatalog 
    ::  AndroidDeviceCatalog
newAndroidDeviceCatalog
  = AndroidDeviceCatalog{models = Core.Nothing,
                         runtimeConfiguration = Core.Nothing, versions = Core.Nothing}
instance Core.FromJSON AndroidDeviceCatalog where
        parseJSON
          = Core.withObject "AndroidDeviceCatalog"
              (\ o ->
                 AndroidDeviceCatalog Core.<$>
                   (o Core..:? "models") Core.<*> (o Core..:? "runtimeConfiguration")
...
newAndroidDeviceList 
    ::  AndroidDeviceList
newAndroidDeviceList
  = AndroidDeviceList{androidDevices = Core.Nothing}
instance Core.FromJSON AndroidDeviceList where
        parseJSON
          = Core.withObject "AndroidDeviceList"
              (\ o -> AndroidDeviceList Core.<$> (o Core..:? "androidDevices"))
...
newAndroidInstrumentationTest 
    ::  AndroidInstrumentationTest
newAndroidInstrumentationTest
  = AndroidInstrumentationTest{appApk = Core.Nothing,
                               appBundle = Core.Nothing, appPackageId = Core.Nothing,
                               orchestratorOption = Core.Nothing, shardingOption = Core.Nothing,
                               testApk = Core.Nothing, testPackageId = Core.Nothing,
                               testRunnerClass = Core.Nothing, testTargets = Core.Nothing}
instance Core.FromJSON AndroidInstrumentationTest where
        parseJSON
          = Core.withObject "AndroidInstrumentationTest"
              (\ o ->
                 AndroidInstrumentationTest Core.<$>
                   (o Core..:? "appApk") Core.<*> (o Core..:? "appBundle") Core.<*>
                     (o Core..:? "appPackageId")
          ...
          = Core.object
              (Core.catMaybes
                 [("appApk" Core..=) Core.<$> appApk,
                  ...
                  ("orchestratorOption" Core..=) Core.<$> orchestratorOption,
...
newAndroidMatrix 
    ::  AndroidMatrix
newAndroidMatrix
  = AndroidMatrix{androidModelIds = Core.Nothing,
                  androidVersionIds = Core.Nothing, locales = Core.Nothing,
                  orientations = Core.Nothing}
instance Core.FromJSON AndroidMatrix where
        parseJSON
          = Core.withObject "AndroidMatrix"
              (\ o ->
                 AndroidMatrix Core.<$>
                   (o Core..:? "androidModelIds") Core.<*>
                     (o Core..:? "androidVersionIds")
                     Core.<*> (o Core..:? "locales")
...
instance Core.ToJSON AndroidMatrix where
        toJSON AndroidMatrix{..}
          = Core.object
              (Core.catMaybes
                 [("androidModelIds" Core..=) Core.<$> androidModelIds,
                  ("androidVersionIds" Core..=) Core.<$> androidVersionIds,
...
data AndroidModel = AndroidModel
    {
      ...
      accessDeniedReasons :: (Core.Maybe [AndroidModel_AccessDeniedReasonsItem])
...
newAndroidModel 
    ::  AndroidModel
newAndroidModel
  = AndroidModel{accessDeniedReasons = Core.Nothing,
                 brand = Core.Nothing, codename = Core.Nothing, form = Core.Nothing,
                 formFactor = Core.Nothing, id = Core.Nothing,
                 labInfo = Core.Nothing, lowFpsVideoRecording = Core.Nothing,
                 manufacturer = Core.Nothing, name = Core.Nothing,
                 perVersionInfo = Core.Nothing, screenDensity = Core.Nothing,
                 screenX = Core.Nothing, screenY = Core.Nothing,
                 supportedAbis = Core.Nothing, supportedVersionIds = Core.Nothing,
                 tags = Core.Nothing, thumbnailUrl = Core.Nothing}
instance Core.FromJSON AndroidModel where
        parseJSON
          = Core.withObject "AndroidModel"
              (\ o ->
                 AndroidModel Core.<$>
                   (o Core..:? "accessDeniedReasons") Core.<*> (o Core..:? "brand")
...
instance Core.ToJSON AndroidModel where
        toJSON AndroidModel{..}
          = Core.object
              (Core.catMaybes
                 [("accessDeniedReasons" Core..=) Core.<$> accessDeniedReasons,
                  ("brand" Core..=) Core.<$> brand,
                  ("codename" Core..=) Core.<$> codename,
                  ("form" Core..=) Core.<$> form,
                  ("formFactor" Core..=) Core.<$> formFactor,
                  ("id" Core..=) Core.<$> id, ("labInfo" Core..=) Core.<$> labInfo,
                  ("lowFpsVideoRecording" Core..=) Core.<$> lowFpsVideoRecording,
                  ...
                  ("supportedVersionIds" Core..=) Core.<$> supportedVersionIds,
                  ("tags" Core..=) Core.<$> tags,
...
newAndroidRoboTest 
    ::  AndroidRoboTest
newAndroidRoboTest
  = AndroidRoboTest{appApk = Core.Nothing, appBundle = Core.Nothing,
                    appInitialActivity = Core.Nothing, appPackageId = Core.Nothing,
                    maxDepth = Core.Nothing, maxSteps = Core.Nothing,
                    roboDirectives = Core.Nothing, roboMode = Core.Nothing,
                    roboScript = Core.Nothing, startingIntents = Core.Nothing}
instance Core.FromJSON AndroidRoboTest where
        parseJSON
          = Core.withObject "AndroidRoboTest"
              (\ o ->
                 AndroidRoboTest Core.<$>
                   (o Core..:? "appApk") Core.<*> (o Core..:? "appBundle") Core.<*>
                     (o Core..:? "appInitialActivity")
        ...
        toJSON AndroidRoboTest{..}
          = Core.object
              (Core.catMaybes
                 [("appApk" Core..=) Core.<$> appApk,
                  ("appBundle" Core..=) Core.<$> appBundle,
                  ("appInitialActivity" Core..=) Core.<$> appInitialActivity,
                  ("appPackageId" Core..=) Core.<$> appPackageId,
                  ...
                  ("startingIntents" Core..=) Core.<$> startingIntents])
...
newAndroidRuntimeConfiguration 
    ::  AndroidRuntimeConfiguration
newAndroidRuntimeConfiguration
  = AndroidRuntimeConfiguration{locales = Core.Nothing,
                                orientations = Core.Nothing}
instance Core.FromJSON AndroidRuntimeConfiguration where
        parseJSON
          = Core.withObject "AndroidRuntimeConfiguration"
              (\ o ->
                 AndroidRuntimeConfiguration Core.<$>
                   (o Core..:? "locales") Core.<*> (o Core..:? "orientations"))
...
newAndroidTestLoop 
    ::  AndroidTestLoop
newAndroidTestLoop
  = AndroidTestLoop{appApk = Core.Nothing, appBundle = Core.Nothing,
                    appPackageId = Core.Nothing, scenarioLabels = Core.Nothing,
                    scenarios = Core.Nothing}
instance Core.FromJSON AndroidTestLoop where
        parseJSON
          = Core.withObject "AndroidTestLoop"
              (\ o ->
                 AndroidTestLoop Core.<$>
                   (o Core..:? "appApk") Core.<*> (o Core..:? "appBundle") Core.<*>
                     (o Core..:? "appPackageId")
...
newAndroidVersion 
    ::  AndroidVersion
newAndroidVersion
  = AndroidVersion{apiLevel = Core.Nothing, codeName = Core.Nothing,
                   distribution = Core.Nothing, id = Core.Nothing,
                   releaseDate = Core.Nothing, tags = Core.Nothing,
                   versionString = Core.Nothing}
instance Core.FromJSON AndroidVersion where
        parseJSON
          = Core.withObject "AndroidVersion"
              (\ o ->
                 AndroidVersion Core.<$>
                   (o Core..:? "apiLevel") Core.<*> (o Core..:? "codeName") Core.<*>
                     (o Core..:? "distribution")
                     Core.<*> (o Core..:? "id")
...
instance Core.FromJSON Apk where
        parseJSON
          = Core.withObject "Apk"
              (\ o ->
                 Apk Core.<$>
                   (o Core..:? "location") Core.<*> (o Core..:? "packageName"))
...
instance Core.FromJSON ApkDetail where
        parseJSON
          = Core.withObject "ApkDetail"
              (\ o -> ApkDetail Core.<$> (o Core..:? "apkManifest"))

instance Core.ToJSON ApkDetail where
        toJSON ApkDetail{..}
          = Core.object
              (Core.catMaybes [("apkManifest" Core..=) Core.<$> apkManifest])
...
data ApkManifest = ApkManifest
    ...
    , usesPermissionTags :: (Core.Maybe [UsesPermissionTag])
...
newApkManifest 
    ::  ApkManifest
newApkManifest
  = ApkManifest{applicationLabel = Core.Nothing,
                intentFilters = Core.Nothing, maxSdkVersion = Core.Nothing,
                metadata = Core.Nothing, minSdkVersion = Core.Nothing,
                packageName = Core.Nothing, services = Core.Nothing,
                targetSdkVersion = Core.Nothing, usesFeature = Core.Nothing,
                usesPermission = Core.Nothing, usesPermissionTags = Core.Nothing,
                versionCode = Core.Nothing, versionName = Core.Nothing}
instance Core.FromJSON ApkManifest where
        parseJSON
          = Core.withObject "ApkManifest"
              (\ o ->
                 ApkManifest Core.<$>
                   (o Core..:? "applicationLabel") Core.<*>
                     (o Core..:? "intentFilters")
                     ...
                     Core.<*> (o Core..:? "usesPermissionTags")
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("applicationLabel" Core..=) Core.<$> applicationLabel,
                  ...
                  ("usesPermissionTags" Core..=) Core.<$> usesPermissionTags,
...
instance Core.FromJSON AppBundle where
        parseJSON
          = Core.withObject "AppBundle"
              (\ o -> AppBundle Core.<$> (o Core..:? "bundleLocation"))
...
--
-- /See:/ 'newCancelDeviceSessionRequest' smart constructor.
data CancelDeviceSessionRequest = CancelDeviceSessionRequest
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CancelDeviceSessionRequest' with the minimum fields required to make a request.
newCancelDeviceSessionRequest 
    ::  CancelDeviceSessionRequest
newCancelDeviceSessionRequest = CancelDeviceSessionRequest
instance Core.FromJSON CancelDeviceSessionRequest where
        parseJSON
          = Core.withObject "CancelDeviceSessionRequest"
              (\ o -> Core.pure CancelDeviceSessionRequest)

instance Core.ToJSON CancelDeviceSessionRequest where
...
instance Core.FromJSON CancelTestMatrixResponse where
        parseJSON
          = Core.withObject "CancelTestMatrixResponse"
              (\ o -> CancelTestMatrixResponse Core.<$> (o Core..:? "testState"))

instance Core.ToJSON CancelTestMatrixResponse where
        toJSON CancelTestMatrixResponse{..}
          = Core.object
              (Core.catMaybes [("testState" Core..=) Core.<$> testState])
...
instance Core.FromJSON ClientInfo where
        parseJSON
          = Core.withObject "ClientInfo"
              (\ o ->
                 ClientInfo Core.<$>
                   (o Core..:? "clientInfoDetails") Core.<*> (o Core..:? "name"))

instance Core.ToJSON ClientInfo where
        toJSON ClientInfo{..}
          = Core.object
              (Core.catMaybes
                 [("clientInfoDetails" Core..=) Core.<$> clientInfoDetails,
                  ("name" Core..=) Core.<$> name])
...
instance Core.FromJSON ClientInfoDetail where
        parseJSON
          = Core.withObject "ClientInfoDetail"
              (\ o ->
                 ClientInfoDetail Core.<$>
...
newDeviceFile 
    ::  DeviceFile
newDeviceFile
  = DeviceFile{obbFile = Core.Nothing, regularFile = Core.Nothing}
instance Core.FromJSON DeviceFile where
        parseJSON
          = Core.withObject "DeviceFile"
              (\ o ->
                 DeviceFile Core.<$>
                   (o Core..:? "obbFile") Core.<*> (o Core..:? "regularFile"))
...
newDeviceIpBlock 
    ::  DeviceIpBlock
newDeviceIpBlock
  = DeviceIpBlock{addedDate = Core.Nothing, block = Core.Nothing,
                  form = Core.Nothing}
instance Core.FromJSON DeviceIpBlock where
        parseJSON
          = Core.withObject "DeviceIpBlock"
              (\ o ->
                 DeviceIpBlock Core.<$>
                   (o Core..:? "addedDate") Core.<*> (o Core..:? "block") Core.<*>
                     (o Core..:? "form"))
          ...
          = Core.object
              (Core.catMaybes
                 [("addedDate" Core..=) Core.<$> addedDate,
                  ("block" Core..=) Core.<$> block, ("form" Core..=) Core.<$> form])
...
newDeviceIpBlockCatalog 
    ::  DeviceIpBlockCatalog
newDeviceIpBlockCatalog
  = DeviceIpBlockCatalog{ipBlocks = Core.Nothing}
instance Core.FromJSON DeviceIpBlockCatalog where
        parseJSON
          = Core.withObject "DeviceIpBlockCatalog"
              (\ o -> DeviceIpBlockCatalog Core.<$> (o Core..:? "ipBlocks"))

instance Core.ToJSON DeviceIpBlockCatalog where
        toJSON DeviceIpBlockCatalog{..}
          = Core.object
              (Core.catMaybes [("ipBlocks" Core..=) Core.<$> ipBlocks])


-- | Protobuf message describing the device message, used from several RPCs.
--
-- /See:/ 'newDeviceSession' smart constructor.
data DeviceSession = DeviceSession
    {
      -- | Output only. The timestamp that the session first became ACTIVE.
      activeStartTime :: (Core.Maybe Core.DateTime)
...
-- | Creates a value of 'DeviceSession' with the minimum fields required to make a request.
newDeviceSession 
    ::  DeviceSession
newDeviceSession
  = DeviceSession{activeStartTime = Core.Nothing,
                  androidDevice = Core.Nothing, createTime = Core.Nothing,
                  displayName = Core.Nothing, expireTime = Core.Nothing,
                  inactivityTimeout = Core.Nothing, name = Core.Nothing,
                  state = Core.Nothing, stateHistories = Core.Nothing,
                  ttl = Core.Nothing}
instance Core.FromJSON DeviceSession where
        parseJSON
          = Core.withObject "DeviceSession"
              (\ o ->
                 DeviceSession Core.<$>
                   (o Core..:? "activeStartTime") Core.<*>
                     (o Core..:? "androidDevice")
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "expireTime")
                     Core.<*> (o Core..:? "inactivityTimeout")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "stateHistories")
                     Core.<*> (o Core..:? "ttl"))

instance Core.ToJSON DeviceSession where
        toJSON DeviceSession{..}
          = Core.object
              (Core.catMaybes
                 [("activeStartTime" Core..=) Core.<$> activeStartTime,
                  ("androidDevice" Core..=) Core.<$> androidDevice,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("expireTime" Core..=) Core.<$> expireTime,
                  ("inactivityTimeout" Core..=) Core.<$> inactivityTimeout,
                  ("name" Core..=) Core.<$> name, ("state" Core..=) Core.<$> state,
                  ("stateHistories" Core..=) Core.<$> stateHistories,
                  ("ttl" Core..=) Core.<$> ttl])
...
--
-- /See:/ 'newDirectAccessVersionInfo' smart constructor.
data DirectAccessVersionInfo = DirectAccessVersionInfo
    {
      ...
      directAccessSupported :: (Core.Maybe Core.Bool)
    ...
    , minimumAndroidStudioVersion :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DirectAccessVersionInfo' with the minimum fields required to make a request.
newDirectAccessVersionInfo 
    ::  DirectAccessVersionInfo
newDirectAccessVersionInfo
  = DirectAccessVersionInfo{directAccessSupported = Core.Nothing,
                            minimumAndroidStudioVersion = Core.Nothing}
instance Core.FromJSON DirectAccessVersionInfo where
        parseJSON
          = Core.withObject "DirectAccessVersionInfo"
              (\ o ->
                 DirectAccessVersionInfo Core.<$>
                   (o Core..:? "directAccessSupported") Core.<*>
                     (o Core..:? "minimumAndroidStudioVersion"))

instance Core.ToJSON DirectAccessVersionInfo where
        toJSON DirectAccessVersionInfo{..}
          = Core.object
              (Core.catMaybes
                 [("directAccessSupported" Core..=) Core.<$> directAccessSupported,
                  ("minimumAndroidStudioVersion" Core..=) Core.<$>
...
newDistribution 
    ::  Distribution
newDistribution
  = Distribution{marketShare = Core.Nothing,
                 measurementTime = Core.Nothing}
instance Core.FromJSON Distribution where
        parseJSON
          = Core.withObject "Distribution"
              (\ o ->
                 Distribution Core.<$>
                   (o Core..:? "marketShare") Core.<*> (o Core..:? "measurementTime"))
          ...
          = Core.object
              (Core.catMaybes
                 [("marketShare" Core..=) Core.<$> marketShare,
                  ("measurementTime" Core..=) Core.<$> measurementTime])
...
newEnvironment 
    ::  Environment
newEnvironment
  = Environment{androidDevice = Core.Nothing,
                iosDevice = Core.Nothing}
instance Core.FromJSON Environment where
        parseJSON
          = Core.withObject "Environment"
              (\ o ->
                 Environment Core.<$>
                   (o Core..:? "androidDevice") Core.<*> (o Core..:? "iosDevice"))
...
newEnvironmentMatrix 
    ::  EnvironmentMatrix
newEnvironmentMatrix
  = EnvironmentMatrix{androidDeviceList = Core.Nothing,
                      androidMatrix = Core.Nothing, iosDeviceList = Core.Nothing}
instance Core.FromJSON EnvironmentMatrix where
        parseJSON
          = Core.withObject "EnvironmentMatrix"
              (\ o ->
                 EnvironmentMatrix Core.<$>
                   (o Core..:? "androidDeviceList") Core.<*>
                     (o Core..:? "androidMatrix")
...
instance Core.ToJSON EnvironmentMatrix where
        toJSON EnvironmentMatrix{..}
          = Core.object
              (Core.catMaybes
                 [("androidDeviceList" Core..=) Core.<$> androidDeviceList,
...
instance Core.FromJSON EnvironmentVariable where
        parseJSON
          = Core.withObject "EnvironmentVariable"
              (\ o ->
...
instance Core.FromJSON FileReference where
        parseJSON
          = Core.withObject "FileReference"
              (\ o -> FileReference Core.<$> (o Core..:? "gcsPath"))

instance Core.ToJSON FileReference where
        toJSON FileReference{..}
          = Core.object
              (Core.catMaybes [("gcsPath" Core..=) Core.<$> gcsPath])
...
newGetApkDetailsResponse 
    ::  GetApkDetailsResponse
newGetApkDetailsResponse
  = GetApkDetailsResponse{apkDetail = Core.Nothing}
instance Core.FromJSON GetApkDetailsResponse where
        parseJSON
          = Core.withObject "GetApkDetailsResponse"
              (\ o -> GetApkDetailsResponse Core.<$> (o Core..:? "apkDetail"))

instance Core.ToJSON GetApkDetailsResponse where
        toJSON GetApkDetailsResponse{..}
          = Core.object
              (Core.catMaybes [("apkDetail" Core..=) Core.<$> apkDetail])
...
instance Core.FromJSON GoogleAuto where
        parseJSON
          = Core.withObject "GoogleAuto" (\ o -> Core.pure GoogleAuto)
...
instance Core.FromJSON GoogleCloudStorage where
        parseJSON
          = Core.withObject "GoogleCloudStorage"
              (\ o -> GoogleCloudStorage Core.<$> (o Core..:? "gcsPath"))
...
newIntentFilter 
    ::  IntentFilter
newIntentFilter
  = IntentFilter{actionNames = Core.Nothing,
                 categoryNames = Core.Nothing, mimeType = Core.Nothing}
instance Core.FromJSON IntentFilter where
        parseJSON
          = Core.withObject "IntentFilter"
              (\ o ->
                 IntentFilter Core.<$>
                   (o Core..:? "actionNames") Core.<*> (o Core..:? "categoryNames")
...
newIosDevice 
    ::  IosDevice
newIosDevice
  = IosDevice{iosModelId = Core.Nothing, iosVersionId = Core.Nothing,
              locale = Core.Nothing, orientation = Core.Nothing}
instance Core.FromJSON IosDevice where
        parseJSON
          = Core.withObject "IosDevice"
              (\ o ->
                 IosDevice Core.<$>
                   (o Core..:? "iosModelId") Core.<*> (o Core..:? "iosVersionId")
                     Core.<*> (o Core..:? "locale")
                     Core.<*> (o Core..:? "orientation"))
...
newIosDeviceFile 
    ::  IosDeviceFile
newIosDeviceFile
  = IosDeviceFile{bundleId = Core.Nothing, content = Core.Nothing,
                  devicePath = Core.Nothing}
instance Core.FromJSON IosDeviceFile where
        parseJSON
          = Core.withObject "IosDeviceFile"
              (\ o ->
                 IosDeviceFile Core.<$>
                   (o Core..:? "bundleId") Core.<*> (o Core..:? "content") Core.<*>
                     (o Core..:? "devicePath"))
...
instance Core.FromJSON IosDeviceList where
        parseJSON
          = Core.withObject "IosDeviceList"
              (\ o -> IosDeviceList Core.<$> (o Core..:? "iosDevices"))

instance Core.ToJSON IosDeviceList where
        toJSON IosDeviceList{..}
          = Core.object
              (Core.catMaybes [("iosDevices" Core..=) Core.<$> iosDevices])
...
newIosModel 
    ::  IosModel
newIosModel
  = IosModel{deviceCapabilities = Core.Nothing,
             formFactor = Core.Nothing, id = Core.Nothing, name = Core.Nothing,
             perVersionInfo = Core.Nothing, screenDensity = Core.Nothing,
             screenX = Core.Nothing, screenY = Core.Nothing,
             supportedVersionIds = Core.Nothing, tags = Core.Nothing}
instance Core.FromJSON IosModel where
        parseJSON
          = Core.withObject "IosModel"
              (\ o ->
                 IosModel Core.<$>
                   (o Core..:? "deviceCapabilities") Core.<*>
                     (o Core..:? "formFactor")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "perVersionInfo")
...
instance Core.ToJSON IosModel where
        toJSON IosModel{..}
          = Core.object
              (Core.catMaybes
                 [("deviceCapabilities" Core..=) Core.<$> deviceCapabilities,
                  ("formFactor" Core..=) Core.<$> formFactor,
...
--
-- /See:/ 'newIosRoboTest' smart constructor.
data IosRoboTest = IosRoboTest
    {
...
-- | Creates a value of 'IosRoboTest' with the minimum fields required to make a request.
newIosRoboTest 
    ::  IosRoboTest
newIosRoboTest
  = IosRoboTest{appBundleId = Core.Nothing, appIpa = Core.Nothing,
                roboScript = Core.Nothing}
instance Core.FromJSON IosRoboTest where
        parseJSON
          = Core.withObject "IosRoboTest"
              (\ o ->
                 IosRoboTest Core.<$>
                   (o Core..:? "appBundleId") Core.<*> (o Core..:? "appIpa") Core.<*>
                     (o Core..:? "roboScript"))

instance Core.ToJSON IosRoboTest where
        toJSON IosRoboTest{..}
          = Core.object
              (Core.catMaybes
...
newIosRuntimeConfiguration 
    ::  IosRuntimeConfiguration
newIosRuntimeConfiguration
  = IosRuntimeConfiguration{locales = Core.Nothing,
                            orientations = Core.Nothing}
instance Core.FromJSON IosRuntimeConfiguration where
        parseJSON
          = Core.withObject "IosRuntimeConfiguration"
              (\ o ->
                 IosRuntimeConfiguration Core.<$>
                   (o Core..:? "locales") Core.<*> (o Core..:? "orientations"))
...
newIosTestLoop 
    ::  IosTestLoop
newIosTestLoop
  = IosTestLoop{appBundleId = Core.Nothing, appIpa = Core.Nothing,
                scenarios = Core.Nothing}
instance Core.FromJSON IosTestLoop where
        parseJSON
          = Core.withObject "IosTestLoop"
              (\ o ->
                 IosTestLoop Core.<$>
                   (o Core..:? "appBundleId") Core.<*> (o Core..:? "appIpa") Core.<*>
                     (o Core..:? "scenarios"))
...
newIosTestSetup 
    ::  IosTestSetup
newIosTestSetup
  = IosTestSetup{additionalIpas = Core.Nothing,
                 networkProfile = Core.Nothing, pullDirectories = Core.Nothing,
                 pushFiles = Core.Nothing}
instance Core.FromJSON IosTestSetup where
        parseJSON
          = Core.withObject "IosTestSetup"
              (\ o ->
                 IosTestSetup Core.<$>
                   (o Core..:? "additionalIpas") Core.<*>
                     (o Core..:? "networkProfile")
...
newIosVersion 
    ::  IosVersion
newIosVersion
  = IosVersion{id = Core.Nothing, majorVersion = Core.Nothing,
               minorVersion = Core.Nothing,
               supportedXcodeVersionIds = Core.Nothing, tags = Core.Nothing}
instance Core.FromJSON IosVersion where
        parseJSON
          = Core.withObject "IosVersion"
              (\ o ->
                 IosVersion Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "majorVersion") Core.<*>
                     (o Core..:? "minorVersion")
          ...
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id,
                  ...
                  ("supportedXcodeVersionIds" Core..=) Core.<$>
...
newIosXcTest 
    ::  IosXcTest
newIosXcTest
  = IosXcTest{appBundleId = Core.Nothing,
              testSpecialEntitlements = Core.Nothing, testsZip = Core.Nothing,
              xcodeVersion = Core.Nothing, xctestrun = Core.Nothing}
instance Core.FromJSON IosXcTest where
        parseJSON
          = Core.withObject "IosXcTest"
              (\ o ->
                 IosXcTest Core.<$>
                   (o Core..:? "appBundleId") Core.<*>
                     (o Core..:? "testSpecialEntitlements")
...
instance Core.ToJSON IosXcTest where
        toJSON IosXcTest{..}
          = Core.object
              (Core.catMaybes
                 [("appBundleId" Core..=) Core.<$> appBundleId,
                  ("testSpecialEntitlements" Core..=) Core.<$>
...
instance Core.FromJSON LabInfo where
        parseJSON
          = Core.withObject "LabInfo"
              (\ o ->
                 LabInfo Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "regionCode"))
...
instance Core.FromJSON LauncherActivityIntent where
        parseJSON
          = Core.withObject "LauncherActivityIntent"
...
--
-- /See:/ 'newListDeviceSessionsResponse' smart constructor.
data ListDeviceSessionsResponse = ListDeviceSessionsResponse
    {
      -- | The sessions matching the specified filter in the given cloud project.
      deviceSessions :: (Core.Maybe [DeviceSession])
      -- | A token, which can be sent as @page_token@ to retrieve the next page. If this field is omitted, there are no subsequent pages.
    , nextPageToken :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ListDeviceSessionsResponse' with the minimum fields required to make a request.
newListDeviceSessionsResponse 
    ::  ListDeviceSessionsResponse
newListDeviceSessionsResponse
  = ListDeviceSessionsResponse{deviceSessions = Core.Nothing,
                               nextPageToken = Core.Nothing}
instance Core.FromJSON ListDeviceSessionsResponse where
        parseJSON
          = Core.withObject "ListDeviceSessionsResponse"
              (\ o ->
                 ListDeviceSessionsResponse Core.<$>
                   (o Core..:? "deviceSessions") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListDeviceSessionsResponse where
        toJSON ListDeviceSessionsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deviceSessions" Core..=) Core.<$> deviceSessions,
...
newLocale 
    ::  Locale
newLocale
  = Locale{id = Core.Nothing, name = Core.Nothing,
           region = Core.Nothing, tags = Core.Nothing}
instance Core.FromJSON Locale where
        parseJSON
          = Core.withObject "Locale"
              (\ o ->
                 Locale Core.<$>
...
newManualSharding 
    ::  ManualSharding
newManualSharding
  = ManualSharding{testTargetsForShard = Core.Nothing}
instance Core.FromJSON ManualSharding where
        parseJSON
          = Core.withObject "ManualSharding"
              (\ o -> ManualSharding Core.<$> (o Core..:? "testTargetsForShard"))

instance Core.ToJSON ManualSharding where
        toJSON ManualSharding{..}
          = Core.object
              (Core.catMaybes
                 [("testTargetsForShard" Core..=) Core.<$> testTargetsForShard])


-- | Describes a single error or issue with a matrix.
--
-- /See:/ 'newMatrixErrorDetail' smart constructor.
data MatrixErrorDetail = MatrixErrorDetail
    {
      ...
      -- | Output only. The reason for the error. This is a constant value in UPPER/SNAKE/CASE that identifies the cause of the error.
    , reason :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'MatrixErrorDetail' with the minimum fields required to make a request.
newMatrixErrorDetail 
    ::  MatrixErrorDetail
newMatrixErrorDetail
  = MatrixErrorDetail{message = Core.Nothing, reason = Core.Nothing}
instance Core.FromJSON MatrixErrorDetail where
        parseJSON
          = Core.withObject "MatrixErrorDetail"
              (\ o ->
                 MatrixErrorDetail Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "reason"))

instance Core.ToJSON MatrixErrorDetail where
        toJSON MatrixErrorDetail{..}
          = Core.object
              (Core.catMaybes
...
newNetworkConfiguration 
    ::  NetworkConfiguration
newNetworkConfiguration
  = NetworkConfiguration{downRule = Core.Nothing, id = Core.Nothing,
                         upRule = Core.Nothing}
instance Core.FromJSON NetworkConfiguration where
        parseJSON
          = Core.withObject "NetworkConfiguration"
              (\ o ->
                 NetworkConfiguration Core.<$>
                   (o Core..:? "downRule") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "upRule"))
          ...
          = Core.object
              (Core.catMaybes
                 [("downRule" Core..=) Core.<$> downRule,
                  ("id" Core..=) Core.<$> id, ("upRule" Core..=) Core.<$> upRule])
...
instance Core.FromJSON NetworkConfigurationCatalog where
        parseJSON
          = Core.withObject "NetworkConfigurationCatalog"
              (\ o ->
                 NetworkConfigurationCatalog Core.<$> (o Core..:? "configurations"))
...
--
-- /See:/ 'newNoActivityIntent' smart constructor.
data NoActivityIntent = NoActivityIntent
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'NoActivityIntent' with the minimum fields required to make a request.
newNoActivityIntent 
    ::  NoActivityIntent
newNoActivityIntent = NoActivityIntent
instance Core.FromJSON NoActivityIntent where
        parseJSON
          = Core.withObject "NoActivityIntent"
              (\ o -> Core.pure NoActivityIntent)

instance Core.ToJSON NoActivityIntent where
        toJSON = Core.const Core.emptyObject
...
newObbFile 
    ::  ObbFile
newObbFile
  = ObbFile{obb = Core.Nothing, obbFileName = Core.Nothing}
instance Core.FromJSON ObbFile where
        parseJSON
          = Core.withObject "ObbFile"
              (\ o ->
                 ObbFile Core.<$>
                   (o Core..:? "obb") Core.<*> (o Core..:? "obbFileName"))
...
newOrientation 
    ::  Orientation
newOrientation
  = Orientation{id = Core.Nothing, name = Core.Nothing,
                tags = Core.Nothing}
instance Core.FromJSON Orientation where
        parseJSON
          = Core.withObject "Orientation"
              (\ o ->
                 Orientation Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "tags"))
...
data PerAndroidVersionInfo = PerAndroidVersionInfo
    ...
    , directAccessVersionInfo :: (Core.Maybe DirectAccessVersionInfo)
      -- | Output only. The estimated wait time for a single interactive device session using Direct Access.
    , interactiveDeviceAvailabilityEstimate :: (Core.Maybe Core.Duration)
      -- | An Android version.
...
newPerAndroidVersionInfo 
    ::  PerAndroidVersionInfo
newPerAndroidVersionInfo
  = PerAndroidVersionInfo{deviceCapacity = Core.Nothing,
                          directAccessVersionInfo = Core.Nothing,
                          interactiveDeviceAvailabilityEstimate = Core.Nothing,
                          versionId = Core.Nothing}
instance Core.FromJSON PerAndroidVersionInfo where
        parseJSON
          = Core.withObject "PerAndroidVersionInfo"
              (\ o ->
                 PerAndroidVersionInfo Core.<$>
                   (o Core..:? "deviceCapacity") Core.<*>
                     (o Core..:? "directAccessVersionInfo")
                     Core.<*> (o Core..:? "interactiveDeviceAvailabilityEstimate")
          ...
          = Core.object
              (Core.catMaybes
                 [("deviceCapacity" Core..=) Core.<$> deviceCapacity,
                  ("directAccessVersionInfo" Core..=) Core.<$>
                    directAccessVersionInfo,
                  ("interactiveDeviceAvailabilityEstimate" Core..=) Core.<$>
...
newPerIosVersionInfo 
    ::  PerIosVersionInfo
newPerIosVersionInfo
  = PerIosVersionInfo{deviceCapacity = Core.Nothing,
                      versionId = Core.Nothing}
instance Core.FromJSON PerIosVersionInfo where
        parseJSON
          = Core.withObject "PerIosVersionInfo"
              (\ o ->
                 PerIosVersionInfo Core.<$>
                   (o Core..:? "deviceCapacity") Core.<*> (o Core..:? "versionId"))
...
newProvidedSoftwareCatalog 
    ::  ProvidedSoftwareCatalog
newProvidedSoftwareCatalog
  = ProvidedSoftwareCatalog{androidxOrchestratorVersion =
                              Core.Nothing,
                            orchestratorVersion = Core.Nothing}
instance Core.FromJSON ProvidedSoftwareCatalog where
        parseJSON
          = Core.withObject "ProvidedSoftwareCatalog"
              (\ o ->
                 ProvidedSoftwareCatalog Core.<$>
                   (o Core..:? "androidxOrchestratorVersion") Core.<*>
                     (o Core..:? "orchestratorVersion"))

instance Core.ToJSON ProvidedSoftwareCatalog where
        toJSON ProvidedSoftwareCatalog{..}
          = Core.object
              (Core.catMaybes
                 [("androidxOrchestratorVersion" Core..=) Core.<$>
                    androidxOrchestratorVersion,
                  ("orchestratorVersion" Core..=) Core.<$> orchestratorVersion])
...
newRegularFile 
    ::  RegularFile
newRegularFile
  = RegularFile{content = Core.Nothing, devicePath = Core.Nothing}
instance Core.FromJSON RegularFile where
        parseJSON
          = Core.withObject "RegularFile"
              (\ o ->
                 RegularFile Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "devicePath"))
...
newResultStorage 
    ::  ResultStorage
newResultStorage
  = ResultStorage{googleCloudStorage = Core.Nothing,
                  resultsUrl = Core.Nothing, toolResultsExecution = Core.Nothing,
                  toolResultsHistory = Core.Nothing}
instance Core.FromJSON ResultStorage where
        parseJSON
          = Core.withObject "ResultStorage"
              (\ o ->
                 ResultStorage Core.<$>
                   (o Core..:? "googleCloudStorage") Core.<*>
                     (o Core..:? "resultsUrl")
...
instance Core.ToJSON ResultStorage where
        toJSON ResultStorage{..}
          = Core.object
              (Core.catMaybes
                 [("googleCloudStorage" Core..=) Core.<$> googleCloudStorage,
                  ("resultsUrl" Core..=) Core.<$> resultsUrl,
                  ("toolResultsExecution" Core..=) Core.<$> toolResultsExecution,
                  ("toolResultsHistory" Core..=) Core.<$> toolResultsHistory])
...
newRoboDirective 
    ::  RoboDirective
newRoboDirective
  = RoboDirective{actionType = Core.Nothing,
                  inputText = Core.Nothing, resourceName = Core.Nothing}
instance Core.FromJSON RoboDirective where
        parseJSON
          = Core.withObject "RoboDirective"
              (\ o ->
                 RoboDirective Core.<$>
                   (o Core..:? "actionType") Core.<*> (o Core..:? "inputText")
...
data RoboStartingIntent = RoboStartingIntent
    {
      ...
      -- | Skips the starting activity
    , noActivity :: (Core.Maybe NoActivityIntent)
...
newRoboStartingIntent 
    ::  RoboStartingIntent
newRoboStartingIntent
  = RoboStartingIntent{launcherActivity = Core.Nothing,
                       noActivity = Core.Nothing, startActivity = Core.Nothing,
                       timeout = Core.Nothing}
instance Core.FromJSON RoboStartingIntent where
        parseJSON
          = Core.withObject "RoboStartingIntent"
              (\ o ->
                 RoboStartingIntent Core.<$>
                   (o Core..:? "launcherActivity") Core.<*> (o Core..:? "noActivity")
...
instance Core.ToJSON RoboStartingIntent where
        toJSON RoboStartingIntent{..}
          = Core.object
              (Core.catMaybes
                 [("launcherActivity" Core..=) Core.<$> launcherActivity,
                  ("noActivity" Core..=) Core.<$> noActivity,
...
data Service = Service
    {
      ...
      intentFilter :: (Core.Maybe [IntentFilter])
      -- | The android:name value
    , name :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newService 
    ::  Service
newService
  = Service{intentFilter = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON Service where
        parseJSON
          = Core.withObject "Service"
              (\ o ->
                 Service Core.<$>
                   (o Core..:? "intentFilter") Core.<*> (o Core..:? "name"))

instance Core.ToJSON Service where
        toJSON Service{..}
          = Core.object
              (Core.catMaybes
                 [("intentFilter" Core..=) Core.<$> intentFilter,
                  ("name" Core..=) Core.<$> name])


-- | A message encapsulating a series of Session states and the time that the DeviceSession first entered those states.
--
-- /See:/ 'newSessionStateEvent' smart constructor.
data SessionStateEvent = SessionStateEvent
    {
      -- | Output only. The time that the session_state first encountered that state.
      eventTime :: (Core.Maybe Core.DateTime)
      -- | Output only. The session_state tracked by this event
    , sessionState :: (Core.Maybe SessionStateEvent_SessionState)
      -- | Output only. A human-readable message to explain the state.
    , stateMessage :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SessionStateEvent' with the minimum fields required to make a request.
newSessionStateEvent 
    ::  SessionStateEvent
newSessionStateEvent
  = SessionStateEvent{eventTime = Core.Nothing,
                      sessionState = Core.Nothing, stateMessage = Core.Nothing}
instance Core.FromJSON SessionStateEvent where
        parseJSON
          = Core.withObject "SessionStateEvent"
              (\ o ->
                 SessionStateEvent Core.<$>
                   (o Core..:? "eventTime") Core.<*> (o Core..:? "sessionState")
                     Core.<*> (o Core..:? "stateMessage"))

instance Core.ToJSON SessionStateEvent where
        toJSON SessionStateEvent{..}
          = Core.object
              (Core.catMaybes
...
data Shard = Shard
    {
      ...
      estimatedShardDuration :: (Core.Maybe Core.Duration)
...
newShard 
    ::  Shard
newShard
  = Shard{estimatedShardDuration = Core.Nothing,
          numShards = Core.Nothing, shardIndex = Core.Nothing,
          testTargetsForShard = Core.Nothing}
instance Core.FromJSON Shard where
        parseJSON
          = Core.withObject "Shard"
              (\ o ->
                 Shard Core.<$>
                   (o Core..:? "estimatedShardDuration") Core.<*>
                     (o Core..:? "numShards")
...
instance Core.ToJSON Shard where
        toJSON Shard{..}
          = Core.object
              (Core.catMaybes
                 [("estimatedShardDuration" Core..=) Core.<$>
...
data ShardingOption = ShardingOption
    ...
    , smartSharding :: (Core.Maybe SmartSharding)
...
newShardingOption 
    ::  ShardingOption
newShardingOption
  = ShardingOption{manualSharding = Core.Nothing,
                   smartSharding = Core.Nothing, uniformSharding = Core.Nothing}
instance Core.FromJSON ShardingOption where
        parseJSON
          = Core.withObject "ShardingOption"
              (\ o ->
                 ShardingOption Core.<$>
                   (o Core..:? "manualSharding") Core.<*> (o Core..:? "smartSharding")
          ...
          = Core.object
              (Core.catMaybes
                 [("manualSharding" Core..=) Core.<$> manualSharding,
                  ("smartSharding" Core..=) Core.<$> smartSharding,
                  ("uniformSharding" Core..=) Core.<$> uniformSharding])


-- | Shards test based on previous test case timing records.
--
-- /See:/ 'newSmartSharding' smart constructor.
newtype SmartSharding = SmartSharding
    {
      ...
      -- available, the default test case duration is 15 seconds. Because the actual shard duration can exceed the targeted shard duration, we recommend that you set the targeted value at least 5 minutes less than the maximum allowed test timeout (45 minutes for physical devices and 60 minutes for virtual), or that you use the custom test timeout value that you set. This approach avoids cancelling the shard before all tests can finish. Note that there is a limit for maximum number of shards. When you select one or more physical devices, the number of shards must be \<= 50. When you select one or more ARM virtual devices, it must be \<= 200. When you select only x86 virtual devices, it must be \<= 500. To guarantee at least one test case for per shard, the number of shards will not exceed the number of test cases. Each shard created counts toward daily test quota.
      targetedShardDuration :: (Core.Maybe Core.Duration)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SmartSharding' with the minimum fields required to make a request.
newSmartSharding 
    ::  SmartSharding
newSmartSharding
  = SmartSharding{targetedShardDuration = Core.Nothing}
instance Core.FromJSON SmartSharding where
        parseJSON
          = Core.withObject "SmartSharding"
              (\ o ->
                 SmartSharding Core.<$> (o Core..:? "targetedShardDuration"))

instance Core.ToJSON SmartSharding where
        toJSON SmartSharding{..}
          = Core.object
              (Core.catMaybes
                 [("targetedShardDuration" Core..=) Core.<$> targetedShardDuration])
...
newStartActivityIntent 
    ::  StartActivityIntent
newStartActivityIntent
  = StartActivityIntent{action = Core.Nothing,
                        categories = Core.Nothing, uri = Core.Nothing}
instance Core.FromJSON StartActivityIntent where
        parseJSON
          = Core.withObject "StartActivityIntent"
              (\ o ->
                 StartActivityIntent Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "categories") Core.<*>
                     (o Core..:? "uri"))
...
instance Core.FromJSON SystraceSetup where
        parseJSON
          = Core.withObject "SystraceSetup"
              (\ o -> SystraceSetup Core.<$> (o Core..:? "durationSeconds"))
...
newTestDetails 
    ::  TestDetails
newTestDetails
  = TestDetails{errorMessage = Core.Nothing,
                progressMessages = Core.Nothing}
instance Core.FromJSON TestDetails where
        parseJSON
          = Core.withObject "TestDetails"
              (\ o ->
                 TestDetails Core.<$>
                   (o Core..:? "errorMessage") Core.<*>
                     (o Core..:? "progressMessages"))
          ...
          = Core.object
              (Core.catMaybes
                 [("errorMessage" Core..=) Core.<$> errorMessage,
                  ("progressMessages" Core..=) Core.<$> progressMessages])
...
newTestEnvironmentCatalog 
    ::  TestEnvironmentCatalog
newTestEnvironmentCatalog
  = TestEnvironmentCatalog{androidDeviceCatalog = Core.Nothing,
...
instance Core.FromJSON TestEnvironmentCatalog where
        parseJSON
          = Core.withObject "TestEnvironmentCatalog"
              (\ o ->
                 TestEnvironmentCatalog Core.<$>
                   (o Core..:? "androidDeviceCatalog") Core.<*>
                     (o Core..:? "deviceIpBlockCatalog")
...
instance Core.ToJSON TestEnvironmentCatalog where
        toJSON TestEnvironmentCatalog{..}
          = Core.object
              (Core.catMaybes
                 [("androidDeviceCatalog" Core..=) Core.<$> androidDeviceCatalog,
                  ("deviceIpBlockCatalog" Core..=) Core.<$> deviceIpBlockCatalog,
                  ("iosDeviceCatalog" Core..=) Core.<$> iosDeviceCatalog,
                  ("networkConfigurationCatalog" Core..=) Core.<$>
                    networkConfigurationCatalog,
                  ("softwareCatalog" Core..=) Core.<$> softwareCatalog])
...
newTestExecution 
    ::  TestExecution
newTestExecution
  = TestExecution{environment = Core.Nothing, id = Core.Nothing,
                  matrixId = Core.Nothing, projectId = Core.Nothing,
                  shard = Core.Nothing, state = Core.Nothing,
                  testDetails = Core.Nothing, testSpecification = Core.Nothing,
                  timestamp = Core.Nothing, toolResultsStep = Core.Nothing}
instance Core.FromJSON TestExecution where
        parseJSON
          = Core.withObject "TestExecution"
              (\ o ->
                 TestExecution Core.<$>
                   (o Core..:? "environment") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "matrixId")
          ...
          = Core.object
              (Core.catMaybes
                 [("environment" Core..=) Core.<$> environment,
                  ("id" Core..=) Core.<$> id, ("matrixId" Core..=) Core.<$> matrixId,
                  ("projectId" Core..=) Core.<$> projectId,
                  ("shard" Core..=) Core.<$> shard, ("state" Core..=) Core.<$> state,
                  ("testDetails" Core..=) Core.<$> testDetails,
                  ("testSpecification" Core..=) Core.<$> testSpecification,
                  ("timestamp" Core..=) Core.<$> timestamp,
                  ("toolResultsStep" Core..=) Core.<$> toolResultsStep])
...
data TestMatrix = TestMatrix
    ...
    , extendedInvalidMatrixDetails :: (Core.Maybe [MatrixErrorDetail])
...
newTestMatrix 
    ::  TestMatrix
newTestMatrix
  = TestMatrix{clientInfo = Core.Nothing,
               environmentMatrix = Core.Nothing,
               extendedInvalidMatrixDetails = Core.Nothing,
               failFast = Core.Nothing, flakyTestAttempts = Core.Nothing,
               invalidMatrixDetails = Core.Nothing, outcomeSummary = Core.Nothing,
               projectId = Core.Nothing, resultStorage = Core.Nothing,
               state = Core.Nothing, testExecutions = Core.Nothing,
               testMatrixId = Core.Nothing, testSpecification = Core.Nothing,
               timestamp = Core.Nothing}
instance Core.FromJSON TestMatrix where
        parseJSON
          = Core.withObject "TestMatrix"
              (\ o ->
                 TestMatrix Core.<$>
                   (o Core..:? "clientInfo") Core.<*> (o Core..:? "environmentMatrix")
                     Core.<*> (o Core..:? "extendedInvalidMatrixDetails")
          ...
          = Core.object
              (Core.catMaybes
                 [("clientInfo" Core..=) Core.<$> clientInfo,
                  ("environmentMatrix" Core..=) Core.<$> environmentMatrix,
                  ("extendedInvalidMatrixDetails" Core..=) Core.<$>
                    extendedInvalidMatrixDetails,
                  ("failFast" Core..=) Core.<$> failFast,
                  ("flakyTestAttempts" Core..=) Core.<$> flakyTestAttempts,
                  ("invalidMatrixDetails" Core..=) Core.<$> invalidMatrixDetails,
...
data TestSetup = TestSetup
    ...
    , initialSetupApks :: (Core.Maybe [Apk])
      -- | The network traffic profile used for running the test. Available network profiles can be queried by using the NETWORK_CONFIGURATION environment type when calling TestEnvironmentDiscoveryService.GetTestEnvironmentCatalog.
    , networkProfile :: (Core.Maybe Core.Text)
...
newTestSetup 
    ::  TestSetup
newTestSetup
  = TestSetup{account = Core.Nothing, additionalApks = Core.Nothing,
              directoriesToPull = Core.Nothing,
              dontAutograntPermissions = Core.Nothing,
              environmentVariables = Core.Nothing, filesToPush = Core.Nothing,
              initialSetupApks = Core.Nothing, networkProfile = Core.Nothing,
              systrace = Core.Nothing}
instance Core.FromJSON TestSetup where
        parseJSON
          = Core.withObject "TestSetup"
              (\ o ->
                 TestSetup Core.<$>
                   (o Core..:? "account") Core.<*> (o Core..:? "additionalApks")
                     Core.<*> (o Core..:? "directoriesToPull")
                     Core.<*> (o Core..:? "dontAutograntPermissions")
                     Core.<*> (o Core..:? "environmentVariables")
                     Core.<*> (o Core..:? "filesToPush")
                     Core.<*> (o Core..:? "initialSetupApks")
          ...
          = Core.object
              (Core.catMaybes
                 [("account" Core..=) Core.<$> account,
                  ...
                  ("directoriesToPull" Core..=) Core.<$> directoriesToPull,
                  ("dontAutograntPermissions" Core..=) Core.<$>
                    dontAutograntPermissions,
                  ("environmentVariables" Core..=) Core.<$> environmentVariables,
                  ("filesToPush" Core..=) Core.<$> filesToPush,
                  ("initialSetupApks" Core..=) Core.<$> initialSetupApks,
                  ("networkProfile" Core..=) Core.<$> networkProfile,
...
data TestSpecification = TestSpecification
    ...
    , disableVideoRecording :: (Core.Maybe Core.Bool)
      -- | An iOS Robo test.
    , iosRoboTest :: (Core.Maybe IosRoboTest)
...
newTestSpecification 
    ::  TestSpecification
newTestSpecification
  = TestSpecification{androidInstrumentationTest = Core.Nothing,
                      androidRoboTest = Core.Nothing, androidTestLoop = Core.Nothing,
                      disablePerformanceMetrics = Core.Nothing,
                      disableVideoRecording = Core.Nothing, iosRoboTest = Core.Nothing,
                      iosTestLoop = Core.Nothing, iosTestSetup = Core.Nothing,
                      iosXcTest = Core.Nothing, testSetup = Core.Nothing,
                      testTimeout = Core.Nothing}
instance Core.FromJSON TestSpecification where
        parseJSON
          = Core.withObject "TestSpecification"
              (\ o ->
                 TestSpecification Core.<$>
                   (o Core..:? "androidInstrumentationTest") Core.<*>
                     (o Core..:? "androidRoboTest")
                     Core.<*> (o Core..:? "androidTestLoop")
                     Core.<*> (o Core..:? "disablePerformanceMetrics")
                     Core.<*> (o Core..:? "disableVideoRecording")
                     Core.<*> (o Core..:? "iosRoboTest")
...
instance Core.ToJSON TestSpecification where
        toJSON TestSpecification{..}
          = Core.object
              (Core.catMaybes
                 [("androidInstrumentationTest" Core..=) Core.<$>
                    androidInstrumentationTest,
                  ("androidRoboTest" Core..=) Core.<$> androidRoboTest,
                  ("androidTestLoop" Core..=) Core.<$> androidTestLoop,
                  ("disablePerformanceMetrics" Core..=) Core.<$>
                    disablePerformanceMetrics,
                  ("disableVideoRecording" Core..=) Core.<$> disableVideoRecording,
                  ("iosRoboTest" Core..=) Core.<$> iosRoboTest,
...
newTestTargetsForShard 
    ::  TestTargetsForShard
newTestTargetsForShard
  = TestTargetsForShard{testTargets = Core.Nothing}
instance Core.FromJSON TestTargetsForShard where
        parseJSON
          = Core.withObject "TestTargetsForShard"
              (\ o -> TestTargetsForShard Core.<$> (o Core..:? "testTargets"))

instance Core.ToJSON TestTargetsForShard where
        toJSON TestTargetsForShard{..}
          = Core.object
              (Core.catMaybes [("testTargets" Core..=) Core.<$> testTargets])
...
newToolResultsExecution 
    ::  ToolResultsExecution
newToolResultsExecution
  = ToolResultsExecution{executionId = Core.Nothing,
                         historyId = Core.Nothing, projectId = Core.Nothing}
instance Core.FromJSON ToolResultsExecution where
        parseJSON
          = Core.withObject "ToolResultsExecution"
              (\ o ->
                 ToolResultsExecution Core.<$>
                   (o Core..:? "executionId") Core.<*> (o Core..:? "historyId")
                     Core.<*> (o Core..:? "projectId"))
...
newToolResultsHistory 
    ::  ToolResultsHistory
newToolResultsHistory
  = ToolResultsHistory{historyId = Core.Nothing,
                       projectId = Core.Nothing}
instance Core.FromJSON ToolResultsHistory where
        parseJSON
          = Core.withObject "ToolResultsHistory"
              (\ o ->
                 ToolResultsHistory Core.<$>
                   (o Core..:? "historyId") Core.<*> (o Core..:? "projectId"))
...
newToolResultsStep 
    ::  ToolResultsStep
newToolResultsStep
  = ToolResultsStep{executionId = Core.Nothing,
                    historyId = Core.Nothing, projectId = Core.Nothing,
                    stepId = Core.Nothing}
instance Core.FromJSON ToolResultsStep where
        parseJSON
          = Core.withObject "ToolResultsStep"
              (\ o ->
...
newTrafficRule 
    ::  TrafficRule
newTrafficRule
  = TrafficRule{bandwidth = Core.Nothing, burst = Core.Nothing,
                delay = Core.Nothing, packetDuplicationRatio = Core.Nothing,
                packetLossRatio = Core.Nothing}
instance Core.FromJSON TrafficRule where
        parseJSON
          = Core.withObject "TrafficRule"
              (\ o ->
                 TrafficRule Core.<$>
                   (o Core..:? "bandwidth") Core.<*> (o Core..:? "burst") Core.<*>
                     (o Core..:? "delay")
          ...
          = Core.object
              (Core.catMaybes
                 [("bandwidth" Core..=) Core.<$> bandwidth,
                  ("burst" Core..=) Core.<$> burst, ("delay" Core..=) Core.<$> delay,
                  ("packetDuplicationRatio" Core..=) Core.<$> packetDuplicationRatio,
                  ("packetLossRatio" Core..=) Core.<$> packetLossRatio])
...
instance Core.FromJSON UniformSharding where
        parseJSON
          = Core.withObject "UniformSharding"
              (\ o -> UniformSharding Core.<$> (o Core..:? "numShards"))

instance Core.ToJSON UniformSharding where
        toJSON UniformSharding{..}
          = Core.object
              (Core.catMaybes [("numShards" Core..=) Core.<$> numShards])
...
newUsesFeature 
    ::  UsesFeature
newUsesFeature
  = UsesFeature{isRequired = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON UsesFeature where
        parseJSON
          = Core.withObject "UsesFeature"
              (\ o ->
                 UsesFeature Core.<$>
                   (o Core..:? "isRequired") Core.<*> (o Core..:? "name"))
...
--
-- /See:/ 'newUsesPermissionTag' smart constructor.
data UsesPermissionTag = UsesPermissionTag
    {
      -- | The android:name value
      maxSdkVersion :: (Core.Maybe Core.Int32)
      -- | The android:name value
...
-- | Creates a value of 'UsesPermissionTag' with the minimum fields required to make a request.
newUsesPermissionTag 
    ::  UsesPermissionTag
newUsesPermissionTag
  = UsesPermissionTag{maxSdkVersion = Core.Nothing,
                      name = Core.Nothing}
instance Core.FromJSON UsesPermissionTag where
        parseJSON
          = Core.withObject "UsesPermissionTag"
              (\ o ->
                 UsesPermissionTag Core.<$>
                   (o Core..:? "maxSdkVersion") Core.<*> (o Core..:? "name"))

instance Core.ToJSON UsesPermissionTag where
        toJSON UsesPermissionTag{..}
          = Core.object
              (Core.catMaybes
                 [("maxSdkVersion" Core..=) Core.<$> maxSdkVersion,
                  ("name" Core..=) Core.<$> name])
...
newXcodeVersion 
    ::  XcodeVersion
newXcodeVersion
  = XcodeVersion{tags = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON XcodeVersion where
        parseJSON
          = Core.withObject "XcodeVersion"
              (\ o ->
                 XcodeVersion Core.<$>
                   (o Core..:? "tags") Core.<*> (o Core..:? "version"))
