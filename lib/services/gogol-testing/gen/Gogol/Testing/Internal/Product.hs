          ...
          = Core.object
              (Core.catMaybes
                 [("models" Core..=) Core.<$> models,
                  ("runtimeConfiguration" Core..=) Core.<$>
...
instance Core.FromJSON AndroidInstrumentationTest
         where
        parseJSON
...
instance Core.ToJSON AndroidMatrix where
        toJSON AndroidMatrix{..}
          = Core.object
              (Core.catMaybes
                 [("androidModelIds" Core..=) Core.<$>
                    androidModelIds,
                  ("androidVersionIds" Core..=) Core.<$>
                    androidVersionIds,
...
instance Core.FromJSON AndroidModel where
        parseJSON
          = Core.withObject "AndroidModel"
              (\ o ->
                 AndroidModel Core.<$>
                   (o Core..:? "brand") Core.<*> (o Core..:? "codename")
                     Core.<*> (o Core..:? "form")
          ...
          = Core.object
              (Core.catMaybes
                 [("brand" Core..=) Core.<$> brand,
                  ...
                  ("id" Core..=) Core.<$> id,
                  ("lowFpsVideoRecording" Core..=) Core.<$>
...
newAndroidRuntimeConfiguration =
  AndroidRuntimeConfiguration
    {locales = Core.Nothing, orientations = Core.Nothing}

instance Core.FromJSON AndroidRuntimeConfiguration
         where
        parseJSON
...
instance Core.ToJSON AndroidRuntimeConfiguration
         where
...
newDeviceIpBlock =
  DeviceIpBlock
    {addedDate = Core.Nothing, block = Core.Nothing, form = Core.Nothing}
...
instance Core.FromJSON Distribution where
        parseJSON
          = Core.withObject "Distribution"
              (\ o ->
                 Distribution Core.<$>
                   (o Core..:? "marketShare") Core.<*>
                     (o Core..:? "measurementTime"))
...
instance Core.FromJSON IntentFilter where
        parseJSON
          = Core.withObject "IntentFilter"
              (\ o ->
                 IntentFilter Core.<$>
                   (o Core..:? "actionNames") Core.<*>
                     (o Core..:? "categoryNames")
...
newIosDeviceFile =
  IosDeviceFile
    {bundleId = Core.Nothing, content = Core.Nothing, devicePath = Core.Nothing}
...
newNetworkConfiguration =
  NetworkConfiguration
    {downRule = Core.Nothing, id = Core.Nothing, upRule = Core.Nothing}
          ...
          = Core.withObject "NetworkConfiguration"
              (\ o ->
                 NetworkConfiguration Core.<$>
                   (o Core..:? "downRule") Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "upRule"))
...
instance Core.FromJSON NetworkConfigurationCatalog
         where
        parseJSON
          = Core.withObject "NetworkConfigurationCatalog"
              (\ o ->
                 NetworkConfigurationCatalog Core.<$>
                   (o Core..:? "configurations"))

instance Core.ToJSON NetworkConfigurationCatalog
         where
...
newPerAndroidVersionInfo =
  PerAndroidVersionInfo
    {deviceCapacity = Core.Nothing, versionId = Core.Nothing}
...
instance Core.ToJSON ResultStorage where
        toJSON ResultStorage{..}
          = Core.object
              (Core.catMaybes
                 [("googleCloudStorage" Core..=) Core.<$>
                    googleCloudStorage,
                  ("resultsUrl" Core..=) Core.<$> resultsUrl,
                  ("toolResultsExecution" Core..=) Core.<$>
                    toolResultsExecution,
                  ("toolResultsHistory" Core..=) Core.<$>
                    toolResultsHistory])
          ...
          = Core.withObject "RoboStartingIntent"
              (\ o ->
                 RoboStartingIntent Core.<$>
                   (o Core..:? "launcherActivity") Core.<*>
                     (o Core..:? "startActivity")
                     Core.<*> (o Core..:? "timeout"))
...
newService 
    ::  Service
newService = Service {intentFilter = Core.Nothing, name = Core.Nothing}
...
newShard =
  Shard
    { estimatedShardDuration = Core.Nothing
...
newShardingOption =
  ShardingOption
    { manualSharding = Core.Nothing
    , smartSharding = Core.Nothing
    , uniformSharding = Core.Nothing
    }
...
instance Core.FromJSON ShardingOption where
        parseJSON
          = Core.withObject "ShardingOption"
              (\ o ->
                 ShardingOption Core.<$>
                   (o Core..:? "manualSharding") Core.<*>
                     (o Core..:? "smartSharding")
...
newSmartSharding 
    ::  SmartSharding
newSmartSharding = SmartSharding {targetedShardDuration = Core.Nothing}
...
newStartActivityIntent =
  StartActivityIntent
    {action = Core.Nothing, categories = Core.Nothing, uri = Core.Nothing}
...
instance Core.ToJSON TestEnvironmentCatalog where
        toJSON TestEnvironmentCatalog{..}
          = Core.object
              (Core.catMaybes
                 [("androidDeviceCatalog" Core..=) Core.<$>
                    androidDeviceCatalog,
                  ("deviceIpBlockCatalog" Core..=) Core.<$>
                    deviceIpBlockCatalog,
                  ("iosDeviceCatalog" Core..=) Core.<$>
                    iosDeviceCatalog,
                  ("networkConfigurationCatalog" Core..=) Core.<$>
                    networkConfigurationCatalog,
                  ("softwareCatalog" Core..=) Core.<$>
                    softwareCatalog])
...
instance Core.FromJSON TestExecution where
        parseJSON
          = Core.withObject "TestExecution"
              (\ o ->
                 TestExecution Core.<$>
                   (o Core..:? "environment") Core.<*> (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("environment" Core..=) Core.<$> environment,
                  ...
                  ("testSpecification" Core..=) Core.<$>
                    testSpecification,
                  ("timestamp" Core..=) Core.<$> timestamp,
                  ("toolResultsStep" Core..=) Core.<$>
                    toolResultsStep])
          ...
          = Core.object
              (Core.catMaybes
                 [("clientInfo" Core..=) Core.<$> clientInfo,
                  ("environmentMatrix" Core..=) Core.<$>
                    environmentMatrix,
                  ("failFast" Core..=) Core.<$> failFast,
                  ("flakyTestAttempts" Core..=) Core.<$>
                    flakyTestAttempts,
                  ("invalidMatrixDetails" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("androidInstrumentationTest" Core..=) Core.<$>
                  ...
                  ("disableVideoRecording" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("bandwidth" Core..=) Core.<$> bandwidth,
                  ...
                  ("packetDuplicationRatio" Core..=) Core.<$>
                    packetDuplicationRatio,
                  ("packetLossRatio" Core..=) Core.<$>
                    packetLossRatio])
