...
instance Core.FromJSON CryptoKeyConfig where
        parseJSON
          = Core.withObject "CryptoKeyConfig"
              (\ o ->
...
instance Core.FromJSON EventPublishConfig where
        parseJSON
          = Core.withObject "EventPublishConfig"
              (\ o ->
                 EventPublishConfig Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "topic"))
          ...
          = Core.object
              (Core.catMaybes
                 [("accelerators" Core..=) Core.<$> accelerators,
                  ...
                  ("availableVersion" Core..=) Core.<$>
                    availableVersion,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("cryptoKeyConfig" Core..=) Core.<$> cryptoKeyConfig,
                  ("dataprocServiceAccount" Core..=) Core.<$>
                    dataprocServiceAccount,
                  ("description" Core..=) Core.<$> description,
                  ("disabledReason" Core..=) Core.<$> disabledReason,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("enableRbac" Core..=) Core.<$> enableRbac,
                  ("enableStackdriverLogging" Core..=) Core.<$>
                    enableStackdriverLogging,
                  ("enableStackdriverMonitoring" Core..=) Core.<$>
                    enableStackdriverMonitoring,
                  ("enableZoneSeparation" Core..=) Core.<$>
                    enableZoneSeparation,
                  ("eventPublishConfig" Core..=) Core.<$>
                    eventPublishConfig,
...
newInstance_Options 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Instance_Options
newInstance_Options additional = Instance_Options {additional = additional}

instance Core.FromJSON Instance_Options where
        parseJSON
          = Core.withObject "Instance_Options"
              (\ o ->
...
newListAvailableVersionsResponse =
  ListAvailableVersionsResponse
    {availableVersions = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListAvailableVersionsResponse
         where
        parseJSON
          = Core.withObject "ListAvailableVersionsResponse"
              (\ o ->
                 ListAvailableVersionsResponse Core.<$>
                   (o Core..:? "availableVersions") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListAvailableVersionsResponse
         where
        toJSON ListAvailableVersionsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("availableVersions" Core..=) Core.<$>
                    availableVersions,
...
newListDnsPeeringsResponse =
  ListDnsPeeringsResponse
    {dnsPeerings = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListDnsPeeringsResponse where
        parseJSON
          = Core.withObject "ListDnsPeeringsResponse"
              (\ o ->
                 ListDnsPeeringsResponse Core.<$>
                   (o Core..:? "dnsPeerings") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OperationMetadata_AdditionalStatus"
              (\ o ->
                 OperationMetadata_AdditionalStatus Core.<$>
...
instance Core.FromJSON RestartInstanceRequest where
        parseJSON
          = Core.withObject "RestartInstanceRequest"
