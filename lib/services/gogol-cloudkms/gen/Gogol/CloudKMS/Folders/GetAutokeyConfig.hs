...
newCloudKMSFoldersGetAutokeyConfig name
  = CloudKMSFoldersGetAutokeyConfig{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudKMSFoldersGetAutokeyConfig where
        type Rs CloudKMSFoldersGetAutokeyConfig = AutokeyConfig
        ...
        requestClient CloudKMSFoldersGetAutokeyConfig{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudKMSFoldersGetAutokeyConfigResource)
                      Core.mempty
