...
instance Core.FromJSON AsymmetricDecryptResponse
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("data" Core..=) Core.<$> data',
                  ...
                  ("digestCrc32c" Core..=) Core.. Core.AsText Core.<$>
                    digestCrc32c])
          ...
          = Core.withObject "AsymmetricSignResponse"
              (\ o ->
                 AsymmetricSignResponse Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "protectionLevel")
                     Core.<*> (o Core..:? "signature")
                     Core.<*>
                     (o Core..:? "signatureCrc32c" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ...
                  ("verifiedDataCrc32c" Core..=) Core.<$>
                    verifiedDataCrc32c,
                  ("verifiedDigestCrc32c" Core..=) Core.<$>
          ...
          = Core.withObject "CertificateChains"
              (\ o ->
                 CertificateChains Core.<$>
                   (o Core..:? "caviumCerts") Core.<*>
                     (o Core..:? "googleCardCerts")
          ...
          = Core.object
              (Core.catMaybes
                 [("caviumCerts" Core..=) Core.<$> caviumCerts,
                  ...
                  ("googlePartitionCerts" Core..=) Core.<$>
              ...
              (\ o ->
                 CryptoKeyVersion Core.<$>
                   (o Core..:? "algorithm") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "externalDestructionFailureReason")
                     Core.<*>
                     (o Core..:? "externalProtectionLevelOptions")
...
newCryptoKeyVersionTemplate =
  CryptoKeyVersionTemplate
    {algorithm = Core.Nothing, protectionLevel = Core.Nothing}
              ...
              (\ o ->
                 DecryptRequest Core.<$>
                   (o Core..:? "additionalAuthenticatedData") Core.<*>
                     (o Core..:? "additionalAuthenticatedDataCrc32c"
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalAuthenticatedData" Core..=) Core.<$>
                  ...
                  ("additionalAuthenticatedDataCrc32c" Core..=) Core..
                    Core.AsText
...
instance Core.FromJSON DestroyCryptoKeyVersionRequest
         where
        parseJSON
          = Core.withObject "DestroyCryptoKeyVersionRequest"
              (\ o -> Core.pure DestroyCryptoKeyVersionRequest)

instance Core.ToJSON DestroyCryptoKeyVersionRequest
         where
...
instance Core.FromJSON Digest where
        parseJSON
          = Core.withObject "Digest"
              (\ o ->
                 Digest Core.<$>
                   (o Core..:? "sha256") Core.<*> (o Core..:? "sha384")
                     Core.<*> (o Core..:? "sha512"))
...
instance Core.FromJSON EkmConfig where
        parseJSON
          = Core.withObject "EkmConfig"
              (\ o ->
                 EkmConfig Core.<$>
                   (o Core..:? "defaultEkmConnection") Core.<*>
                     (o Core..:? "name"))
...
instance Core.ToJSON EkmConfig where
        toJSON EkmConfig{..}
          = Core.object
              (Core.catMaybes
                 [("defaultEkmConnection" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("etag" Core..=) Core.<$> etag,
                  ("keyManagementMode" Core..=) Core.<$>
                    keyManagementMode,
                  ("name" Core..=) Core.<$> name,
                  ("serviceResolvers" Core..=) Core.<$>
                    serviceResolvers])
...
newExternalProtectionLevelOptions =
  ExternalProtectionLevelOptions
    {ekmConnectionKeyPath = Core.Nothing, externalKeyUri = Core.Nothing}

instance Core.FromJSON ExternalProtectionLevelOptions
         where
        parseJSON
...
instance Core.ToJSON ExternalProtectionLevelOptions
         where
        toJSON ExternalProtectionLevelOptions{..}
          = Core.object
              (Core.catMaybes
                 [("ekmConnectionKeyPath" Core..=) Core.<$>
...
newGenerateRandomBytesRequest =
  GenerateRandomBytesRequest
    {lengthBytes = Core.Nothing, protectionLevel = Core.Nothing}

instance Core.FromJSON GenerateRandomBytesRequest
         where
        parseJSON
          = Core.withObject "GenerateRandomBytesRequest"
              (\ o ->
                 GenerateRandomBytesRequest Core.<$>
                   (o Core..:? "lengthBytes") Core.<*>
                     (o Core..:? "protectionLevel"))
...
instance Core.FromJSON GenerateRandomBytesResponse
         where
        parseJSON
...
instance Core.ToJSON GenerateRandomBytesResponse
         where
...
instance Core.FromJSON ImportCryptoKeyVersionRequest
         where
        parseJSON
          = Core.withObject "ImportCryptoKeyVersionRequest"
              (\ o ->
                 ImportCryptoKeyVersionRequest Core.<$>
                   (o Core..:? "algorithm") Core.<*>
                     (o Core..:? "cryptoKeyVersion")
                     Core.<*> (o Core..:? "importJob")
                     Core.<*> (o Core..:? "rsaAesWrappedKey")
                     Core.<*> (o Core..:? "wrappedKey"))

instance Core.ToJSON ImportCryptoKeyVersionRequest
         where
        toJSON ImportCryptoKeyVersionRequest{..}
          = Core.object
              (Core.catMaybes
                 [("algorithm" Core..=) Core.<$> algorithm,
                  ("cryptoKeyVersion" Core..=) Core.<$>
                    cryptoKeyVersion,
                  ("importJob" Core..=) Core.<$> importJob,
                  ("rsaAesWrappedKey" Core..=) Core.<$>
                    rsaAesWrappedKey,
...
newKeyOperationAttestation =
  KeyOperationAttestation
    {certChains = Core.Nothing, content = Core.Nothing, format = Core.Nothing}
...
instance Core.FromJSON ListCryptoKeyVersionsResponse
         where
        parseJSON
...
instance Core.ToJSON ListCryptoKeyVersionsResponse
         where
        toJSON ListCryptoKeyVersionsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("cryptoKeyVersions" Core..=) Core.<$>
                    cryptoKeyVersions,
...
instance Core.FromJSON ListEkmConnectionsResponse
         where
        parseJSON
          = Core.withObject "ListEkmConnectionsResponse"
              (\ o ->
                 ListEkmConnectionsResponse Core.<$>
                   (o Core..:? "ekmConnections") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
...
instance Core.ToJSON MacSignResponse where
        toJSON MacSignResponse{..}
          = Core.object
              (Core.catMaybes
                 [("mac" Core..=) Core.<$> mac,
                  ("macCrc32c" Core..=) Core.. Core.AsText Core.<$>
                    macCrc32c,
                  ("name" Core..=) Core.<$> name,
                  ("protectionLevel" Core..=) Core.<$> protectionLevel,
                  ("verifiedDataCrc32c" Core..=) Core.<$>
...
instance Core.FromJSON PublicKey where
        parseJSON
          = Core.withObject "PublicKey"
              (\ o ->
                 PublicKey Core.<$>
                   (o Core..:? "algorithm") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "pem")
                     Core.<*>
                     (o Core..:? "pemCrc32c" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "protectionLevel"))
          ...
          = Core.object
              (Core.catMaybes
                 [("algorithm" Core..=) Core.<$> algorithm,
                  ("name" Core..=) Core.<$> name,
                  ("pem" Core..=) Core.<$> pem,
                  ("pemCrc32c" Core..=) Core.. Core.AsText Core.<$>
                    pemCrc32c,
                  ("protectionLevel" Core..=) Core.<$>
                    protectionLevel])
...
instance Core.FromJSON RestoreCryptoKeyVersionRequest
         where
        parseJSON
          = Core.withObject "RestoreCryptoKeyVersionRequest"
              (\ o -> Core.pure RestoreCryptoKeyVersionRequest)

instance Core.ToJSON RestoreCryptoKeyVersionRequest
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON VerifyConnectivityResponse
         where
        parseJSON
