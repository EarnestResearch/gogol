...
module Gogol.CloudKMS.Internal.Product
  (
    ...
    KeyAccessJustificationsEnrollmentConfig (..),
    newKeyAccessJustificationsEnrollmentConfig,
    ...
    KeyAccessJustificationsPolicyConfig (..),
    newKeyAccessJustificationsPolicyConfig,
    ...
    ShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse (..),
    newShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse,

    -- * ShowEffectiveKeyAccessJustificationsPolicyConfigResponse
    ShowEffectiveKeyAccessJustificationsPolicyConfigResponse (..),
    newShowEffectiveKeyAccessJustificationsPolicyConfigResponse,
...
newAsymmetricDecryptRequest 
    ::  AsymmetricDecryptRequest
newAsymmetricDecryptRequest
  = AsymmetricDecryptRequest{ciphertext = Core.Nothing,
                             ciphertextCrc32c = Core.Nothing}
instance Core.FromJSON AsymmetricDecryptRequest where
        parseJSON
          = Core.withObject "AsymmetricDecryptRequest"
              (\ o ->
                 AsymmetricDecryptRequest Core.<$>
                   (o Core..:? "ciphertext") Core.<*>
                     (o Core..:? "ciphertextCrc32c" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("ciphertext" Core..=) Core.<$> ciphertext,
                  ("ciphertextCrc32c" Core..=) Core.. Core.AsText Core.<$>
                    ciphertextCrc32c])
...
newAsymmetricDecryptResponse 
    ::  AsymmetricDecryptResponse
newAsymmetricDecryptResponse
  = AsymmetricDecryptResponse{plaintext = Core.Nothing,
                              plaintextCrc32c = Core.Nothing, protectionLevel = Core.Nothing,
                              verifiedCiphertextCrc32c = Core.Nothing}
instance Core.FromJSON AsymmetricDecryptResponse where
        parseJSON
          = Core.withObject "AsymmetricDecryptResponse"
              (\ o ->
                 AsymmetricDecryptResponse Core.<$>
                   (o Core..:? "plaintext") Core.<*>
                     (o Core..:? "plaintextCrc32c" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("plaintext" Core..=) Core.<$> plaintext,
                  ("plaintextCrc32c" Core..=) Core.. Core.AsText Core.<$>
                    plaintextCrc32c,
                  ("protectionLevel" Core..=) Core.<$> protectionLevel,
                  ("verifiedCiphertextCrc32c" Core..=) Core.<$>
...
newAsymmetricSignRequest 
    ::  AsymmetricSignRequest
newAsymmetricSignRequest
  = AsymmetricSignRequest{data' = Core.Nothing,
                          dataCrc32c = Core.Nothing, digest = Core.Nothing,
                          digestCrc32c = Core.Nothing}
instance Core.FromJSON AsymmetricSignRequest where
        parseJSON
          = Core.withObject "AsymmetricSignRequest"
              (\ o ->
                 AsymmetricSignRequest Core.<$>
                   (o Core..:? "data") Core.<*>
                     (o Core..:? "dataCrc32c" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "digest")
                     Core.<*>
                     (o Core..:? "digestCrc32c" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("data" Core..=) Core.<$> data',
                  ...
                  ("digestCrc32c" Core..=) Core.. Core.AsText Core.<$> digestCrc32c])
...
newAsymmetricSignResponse 
    ::  AsymmetricSignResponse
newAsymmetricSignResponse
  = AsymmetricSignResponse{name = Core.Nothing,
                           protectionLevel = Core.Nothing, signature = Core.Nothing,
                           signatureCrc32c = Core.Nothing, verifiedDataCrc32c = Core.Nothing,
                           verifiedDigestCrc32c = Core.Nothing}
instance Core.FromJSON AsymmetricSignResponse where
        parseJSON
          = Core.withObject "AsymmetricSignResponse"
              (\ o ->
                 AsymmetricSignResponse Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "protectionLevel")
                     Core.<*> (o Core..:? "signature")
                     Core.<*>
                     (o Core..:? "signatureCrc32c" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ...
                  ("signatureCrc32c" Core..=) Core.. Core.AsText Core.<$>
                    signatureCrc32c,
                  ("verifiedDataCrc32c" Core..=) Core.<$> verifiedDataCrc32c,
                  ("verifiedDigestCrc32c" Core..=) Core.<$> verifiedDigestCrc32c])
...
--
-- /See:/ 'newAutokeyConfig' smart constructor.
data AutokeyConfig = AutokeyConfig
    {
    ...
    , keyProject :: (Core.Maybe Core.Text)
      -- | Identifier. Name of the AutokeyConfig resource, e.g. @folders\/{FOLDER_NUMBER}\/autokeyConfig@.
    , name :: (Core.Maybe Core.Text)
      -- | Output only. The state for the AutokeyConfig.
    , state :: (Core.Maybe AutokeyConfig_State)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AutokeyConfig' with the minimum fields required to make a request.
newAutokeyConfig 
    ::  AutokeyConfig
newAutokeyConfig
  = AutokeyConfig{etag = Core.Nothing, keyProject = Core.Nothing,
                  name = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON AutokeyConfig where
        parseJSON
          = Core.withObject "AutokeyConfig"
              (\ o ->
                 AutokeyConfig Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "keyProject") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "state"))

instance Core.ToJSON AutokeyConfig where
        toJSON AutokeyConfig{..}
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag,
                  ("keyProject" Core..=) Core.<$> keyProject,
...
newCertificate 
    ::  Certificate
newCertificate
  = Certificate{issuer = Core.Nothing, notAfterTime = Core.Nothing,
                notBeforeTime = Core.Nothing, parsed = Core.Nothing,
                rawDer = Core.Nothing, serialNumber = Core.Nothing,
                sha256Fingerprint = Core.Nothing, subject = Core.Nothing,
                subjectAlternativeDnsNames = Core.Nothing}
instance Core.FromJSON Certificate where
        parseJSON
          = Core.withObject "Certificate"
              (\ o ->
                 Certificate Core.<$>
                   (o Core..:? "issuer") Core.<*> (o Core..:? "notAfterTime") Core.<*>
                     (o Core..:? "notBeforeTime")
                     Core.<*> (o Core..:? "parsed")
                     Core.<*> (o Core..:? "rawDer")
          ...
          = Core.object
              (Core.catMaybes
                 [("issuer" Core..=) Core.<$> issuer,
                  ...
                  ("sha256Fingerprint" Core..=) Core.<$> sha256Fingerprint,
                  ("subject" Core..=) Core.<$> subject,
                  ("subjectAlternativeDnsNames" Core..=) Core.<$>
...
newCertificateChains 
    ::  CertificateChains
newCertificateChains
  = CertificateChains{caviumCerts = Core.Nothing,
                      googleCardCerts = Core.Nothing,
                      googlePartitionCerts = Core.Nothing}
instance Core.FromJSON CertificateChains where
        parseJSON
          = Core.withObject "CertificateChains"
              (\ o ->
                 CertificateChains Core.<$>
                   (o Core..:? "caviumCerts") Core.<*> (o Core..:? "googleCardCerts")
...
newChecksummedData 
    ::  ChecksummedData
newChecksummedData
  = ChecksummedData{crc32cChecksum = Core.Nothing,
                    data' = Core.Nothing}
instance Core.FromJSON ChecksummedData where
        parseJSON
          = Core.withObject "ChecksummedData"
              (\ o ->
                 ChecksummedData Core.<$>
                   (o Core..:? "crc32cChecksum" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "data"))
...
instance Core.ToJSON ChecksummedData where
        toJSON ChecksummedData{..}
          = Core.object
              (Core.catMaybes
                 [("crc32cChecksum" Core..=) Core.. Core.AsText Core.<$>
                    crc32cChecksum,
                  ("data" Core..=) Core.<$> data'])
...
data CryptoKey = CryptoKey
    ...
    , keyAccessJustificationsPolicy :: (Core.Maybe KeyAccessJustificationsPolicy)
...
newCryptoKey 
    ::  CryptoKey
newCryptoKey
  = CryptoKey{createTime = Core.Nothing,
              cryptoKeyBackend = Core.Nothing,
              destroyScheduledDuration = Core.Nothing, importOnly = Core.Nothing,
              keyAccessJustificationsPolicy = Core.Nothing,
              labels = Core.Nothing, name = Core.Nothing,
              nextRotationTime = Core.Nothing, primary = Core.Nothing,
              purpose = Core.Nothing, rotationPeriod = Core.Nothing,
              versionTemplate = Core.Nothing}
instance Core.FromJSON CryptoKey where
        parseJSON
          = Core.withObject "CryptoKey"
              (\ o ->
                 CryptoKey Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "cryptoKeyBackend")
                     Core.<*> (o Core..:? "destroyScheduledDuration")
                     Core.<*> (o Core..:? "importOnly")
                     Core.<*> (o Core..:? "keyAccessJustificationsPolicy")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("cryptoKeyBackend" Core..=) Core.<$> cryptoKeyBackend,
                  ("destroyScheduledDuration" Core..=) Core.<$>
                    destroyScheduledDuration,
                  ("importOnly" Core..=) Core.<$> importOnly,
                  ("keyAccessJustificationsPolicy" Core..=) Core.<$>
                    keyAccessJustificationsPolicy,
                  ...
                  ("versionTemplate" Core..=) Core.<$> versionTemplate])
...
newCryptoKey_Labels 
    :: 
       ...
       -- ^  See 'additional'.
    -> CryptoKey_Labels
newCryptoKey_Labels additional
  = CryptoKey_Labels{additional = additional}
instance Core.FromJSON CryptoKey_Labels where
        parseJSON
          = Core.withObject "CryptoKey_Labels"
              (\ o -> CryptoKey_Labels Core.<$> (Core.parseJSONObject o))
...
newCryptoKeyVersion 
    ::  CryptoKeyVersion
newCryptoKeyVersion
  = CryptoKeyVersion{algorithm = Core.Nothing,
                     attestation = Core.Nothing, createTime = Core.Nothing,
                     destroyEventTime = Core.Nothing, destroyTime = Core.Nothing,
                     ...
                     importFailureReason = Core.Nothing, importJob = Core.Nothing,
                     importTime = Core.Nothing, name = Core.Nothing,
                     protectionLevel = Core.Nothing, reimportEligible = Core.Nothing,
                     state = Core.Nothing}
instance Core.FromJSON CryptoKeyVersion where
        parseJSON
          = Core.withObject "CryptoKeyVersion"
              (\ o ->
                 CryptoKeyVersion Core.<$>
                   (o Core..:? "algorithm") Core.<*> (o Core..:? "attestation")
          ...
          = Core.object
              (Core.catMaybes
                 [("algorithm" Core..=) Core.<$> algorithm,
                  ...
                  ("createTime" Core..=) Core.<$> createTime,
                  ("destroyEventTime" Core..=) Core.<$> destroyEventTime,
                  ("destroyTime" Core..=) Core.<$> destroyTime,
                  ("externalDestructionFailureReason" Core..=) Core.<$>
                    externalDestructionFailureReason,
                  ("externalProtectionLevelOptions" Core..=) Core.<$>
                    externalProtectionLevelOptions,
                  ("generateTime" Core..=) Core.<$> generateTime,
                  ("generationFailureReason" Core..=) Core.<$>
                    generationFailureReason,
                  ("importFailureReason" Core..=) Core.<$> importFailureReason,
                  ("importJob" Core..=) Core.<$> importJob,
                  ("importTime" Core..=) Core.<$> importTime,
                  ("name" Core..=) Core.<$> name,
                  ("protectionLevel" Core..=) Core.<$> protectionLevel,
                  ("reimportEligible" Core..=) Core.<$> reimportEligible,
...
newCryptoKeyVersionTemplate 
    ::  CryptoKeyVersionTemplate
newCryptoKeyVersionTemplate
  = CryptoKeyVersionTemplate{algorithm = Core.Nothing,
                             protectionLevel = Core.Nothing}
instance Core.FromJSON CryptoKeyVersionTemplate where
        parseJSON
          = Core.withObject "CryptoKeyVersionTemplate"
              (\ o ->
                 CryptoKeyVersionTemplate Core.<$>
                   (o Core..:? "algorithm") Core.<*> (o Core..:? "protectionLevel"))
...
newDecryptRequest 
    ::  DecryptRequest
newDecryptRequest
  = DecryptRequest{additionalAuthenticatedData = Core.Nothing,
                   additionalAuthenticatedDataCrc32c = Core.Nothing,
                   ciphertext = Core.Nothing, ciphertextCrc32c = Core.Nothing}
instance Core.FromJSON DecryptRequest where
        parseJSON
          = Core.withObject "DecryptRequest"
              (\ o ->
                 DecryptRequest Core.<$>
                   (o Core..:? "additionalAuthenticatedData") Core.<*>
                     (o Core..:? "additionalAuthenticatedDataCrc32c" Core.<&>
...
instance Core.ToJSON DecryptRequest where
        toJSON DecryptRequest{..}
          = Core.object
              (Core.catMaybes
                 [("additionalAuthenticatedData" Core..=) Core.<$>
                    additionalAuthenticatedData,
                  ("additionalAuthenticatedDataCrc32c" Core..=) Core.. Core.AsText
...
newDecryptResponse 
    ::  DecryptResponse
newDecryptResponse
  = DecryptResponse{plaintext = Core.Nothing,
                    plaintextCrc32c = Core.Nothing, protectionLevel = Core.Nothing,
                    usedPrimary = Core.Nothing}
instance Core.FromJSON DecryptResponse where
        parseJSON
          = Core.withObject "DecryptResponse"
              (\ o ->
                 DecryptResponse Core.<$>
                   (o Core..:? "plaintext") Core.<*>
                     (o Core..:? "plaintextCrc32c" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "protectionLevel")
...
instance Core.FromJSON DestroyCryptoKeyVersionRequest where
        parseJSON
          = Core.withObject "DestroyCryptoKeyVersionRequest"
...
newDigest 
    ::  Digest
newDigest
  = Digest{sha256 = Core.Nothing, sha384 = Core.Nothing,
           sha512 = Core.Nothing}
instance Core.FromJSON Digest where
        parseJSON
          = Core.withObject "Digest"
              (\ o ->
                 Digest Core.<$>
                   (o Core..:? "sha256") Core.<*> (o Core..:? "sha384") Core.<*>
                     (o Core..:? "sha512"))
...
newEkmConfig 
    ::  EkmConfig
newEkmConfig
  = EkmConfig{defaultEkmConnection = Core.Nothing,
              name = Core.Nothing}
instance Core.FromJSON EkmConfig where
        parseJSON
          = Core.withObject "EkmConfig"
              (\ o ->
                 EkmConfig Core.<$>
                   (o Core..:? "defaultEkmConnection") Core.<*> (o Core..:? "name"))

instance Core.ToJSON EkmConfig where
        toJSON EkmConfig{..}
          = Core.object
              (Core.catMaybes
                 [("defaultEkmConnection" Core..=) Core.<$> defaultEkmConnection,
                  ("name" Core..=) Core.<$> name])
...
newEkmConnection 
    ::  EkmConnection
newEkmConnection
  = EkmConnection{createTime = Core.Nothing,
                  cryptoSpacePath = Core.Nothing, etag = Core.Nothing,
                  keyManagementMode = Core.Nothing, name = Core.Nothing,
                  serviceResolvers = Core.Nothing}
instance Core.FromJSON EkmConnection where
        parseJSON
          = Core.withObject "EkmConnection"
              (\ o ->
                 EkmConnection Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "cryptoSpacePath")
                     Core.<*> (o Core..:? "etag")
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("etag" Core..=) Core.<$> etag,
                  ("keyManagementMode" Core..=) Core.<$> keyManagementMode,
                  ("name" Core..=) Core.<$> name,
                  ("serviceResolvers" Core..=) Core.<$> serviceResolvers])
...
newEncryptRequest 
    ::  EncryptRequest
newEncryptRequest
  = EncryptRequest{additionalAuthenticatedData = Core.Nothing,
                   additionalAuthenticatedDataCrc32c = Core.Nothing,
                   plaintext = Core.Nothing, plaintextCrc32c = Core.Nothing}
instance Core.FromJSON EncryptRequest where
        parseJSON
          = Core.withObject "EncryptRequest"
              (\ o ->
                 EncryptRequest Core.<$>
                   (o Core..:? "additionalAuthenticatedData") Core.<*>
                     (o Core..:? "additionalAuthenticatedDataCrc32c" Core.<&>
...
newEncryptResponse 
    ::  EncryptResponse
newEncryptResponse
  = EncryptResponse{ciphertext = Core.Nothing,
                    ciphertextCrc32c = Core.Nothing, name = Core.Nothing,
                    protectionLevel = Core.Nothing,
...
instance Core.FromJSON EncryptResponse where
        parseJSON
          = Core.withObject "EncryptResponse"
              (\ o ->
                 EncryptResponse Core.<$>
                   (o Core..:? "ciphertext") Core.<*>
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "protectionLevel")
                     Core.<*> (o Core..:? "verifiedAdditionalAuthenticatedDataCrc32c")
          ...
          = Core.object
              (Core.catMaybes
                 [("ciphertext" Core..=) Core.<$> ciphertext,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("protectionLevel" Core..=) Core.<$> protectionLevel,
                  ("verifiedAdditionalAuthenticatedDataCrc32c" Core..=) Core.<$>
                    verifiedAdditionalAuthenticatedDataCrc32c,
                  ("verifiedPlaintextCrc32c" Core..=) Core.<$>
...
instance Core.FromJSON ExternalProtectionLevelOptions where
        parseJSON
          = Core.withObject "ExternalProtectionLevelOptions"
              (\ o ->
                 ExternalProtectionLevelOptions Core.<$>
                   (o Core..:? "ekmConnectionKeyPath") Core.<*>
                     (o Core..:? "externalKeyUri"))

instance Core.ToJSON ExternalProtectionLevelOptions where
        toJSON ExternalProtectionLevelOptions{..}
          = Core.object
              (Core.catMaybes
                 [("ekmConnectionKeyPath" Core..=) Core.<$> ekmConnectionKeyPath,
...
newGenerateRandomBytesRequest 
    ::  GenerateRandomBytesRequest
newGenerateRandomBytesRequest
  = GenerateRandomBytesRequest{lengthBytes = Core.Nothing,
                               protectionLevel = Core.Nothing}
instance Core.FromJSON GenerateRandomBytesRequest where
        parseJSON
          = Core.withObject "GenerateRandomBytesRequest"
              (\ o ->
                 GenerateRandomBytesRequest Core.<$>
                   (o Core..:? "lengthBytes") Core.<*> (o Core..:? "protectionLevel"))
...
newGenerateRandomBytesResponse 
    ::  GenerateRandomBytesResponse
newGenerateRandomBytesResponse
  = GenerateRandomBytesResponse{data' = Core.Nothing,
                                dataCrc32c = Core.Nothing}
instance Core.FromJSON GenerateRandomBytesResponse where
        parseJSON
          = Core.withObject "GenerateRandomBytesResponse"
              (\ o ->
                 GenerateRandomBytesResponse Core.<$>
                   (o Core..:? "data") Core.<*>
                     (o Core..:? "dataCrc32c" Core.<&> Core.fmap Core.fromAsText))
...
newImportCryptoKeyVersionRequest 
    ::  ImportCryptoKeyVersionRequest
newImportCryptoKeyVersionRequest
  = ImportCryptoKeyVersionRequest{algorithm = Core.Nothing,
                                  cryptoKeyVersion = Core.Nothing, importJob = Core.Nothing,
                                  rsaAesWrappedKey = Core.Nothing, wrappedKey = Core.Nothing}
instance Core.FromJSON ImportCryptoKeyVersionRequest where
        parseJSON
          = Core.withObject "ImportCryptoKeyVersionRequest"
              (\ o ->
                 ImportCryptoKeyVersionRequest Core.<$>
                   (o Core..:? "algorithm") Core.<*> (o Core..:? "cryptoKeyVersion")
                     Core.<*> (o Core..:? "importJob")
...
instance Core.ToJSON ImportCryptoKeyVersionRequest where
        toJSON ImportCryptoKeyVersionRequest{..}
          = Core.object
              (Core.catMaybes
                 [("algorithm" Core..=) Core.<$> algorithm,
                  ("cryptoKeyVersion" Core..=) Core.<$> cryptoKeyVersion,
                  ("importJob" Core..=) Core.<$> importJob,
                  ("rsaAesWrappedKey" Core..=) Core.<$> rsaAesWrappedKey,
...
newImportJob 
    ::  ImportJob
newImportJob
  = ImportJob{attestation = Core.Nothing, createTime = Core.Nothing,
              expireEventTime = Core.Nothing, expireTime = Core.Nothing,
              generateTime = Core.Nothing, importMethod = Core.Nothing,
              name = Core.Nothing, protectionLevel = Core.Nothing,
              publicKey = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON ImportJob where
        parseJSON
          = Core.withObject "ImportJob"
              (\ o ->
                 ImportJob Core.<$>
                   (o Core..:? "attestation") Core.<*> (o Core..:? "createTime")
...
--
-- /See:/ 'newKeyAccessJustificationsEnrollmentConfig' smart constructor.
data KeyAccessJustificationsEnrollmentConfig = KeyAccessJustificationsEnrollmentConfig
    {
      -- | Whether the project has KAJ logging enabled.
      auditLogging :: (Core.Maybe Core.Bool)
      -- | Whether the project is enrolled in KAJ policy enforcement.
    , policyEnforcement :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'KeyAccessJustificationsEnrollmentConfig' with the minimum fields required to make a request.
newKeyAccessJustificationsEnrollmentConfig 
    :: 
                                           KeyAccessJustificationsEnrollmentConfig
newKeyAccessJustificationsEnrollmentConfig
  = KeyAccessJustificationsEnrollmentConfig{auditLogging =
                                              Core.Nothing,
                                            policyEnforcement = Core.Nothing}
instance Core.FromJSON KeyAccessJustificationsEnrollmentConfig
         where
        parseJSON
          = Core.withObject "KeyAccessJustificationsEnrollmentConfig"
              (\ o ->
                 KeyAccessJustificationsEnrollmentConfig Core.<$>
                   (o Core..:? "auditLogging") Core.<*>
                     (o Core..:? "policyEnforcement"))

instance Core.ToJSON KeyAccessJustificationsEnrollmentConfig where
        toJSON KeyAccessJustificationsEnrollmentConfig{..}
          = Core.object
              (Core.catMaybes
                 [("auditLogging" Core..=) Core.<$> auditLogging,
                  ("policyEnforcement" Core..=) Core.<$> policyEnforcement])
...
--
-- /See:/ 'newKeyAccessJustificationsPolicy' smart constructor.
newtype KeyAccessJustificationsPolicy = KeyAccessJustificationsPolicy
    {
      ...
      allowedAccessReasons :: (Core.Maybe
   [KeyAccessJustificationsPolicy_AllowedAccessReasonsItem])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'KeyAccessJustificationsPolicy' with the minimum fields required to make a request.
newKeyAccessJustificationsPolicy 
    ::  KeyAccessJustificationsPolicy
newKeyAccessJustificationsPolicy
  = KeyAccessJustificationsPolicy{allowedAccessReasons =
                                    Core.Nothing}
instance Core.FromJSON KeyAccessJustificationsPolicy where
        parseJSON
          = Core.withObject "KeyAccessJustificationsPolicy"
              (\ o ->
                 KeyAccessJustificationsPolicy Core.<$>
                   (o Core..:? "allowedAccessReasons"))

instance Core.ToJSON KeyAccessJustificationsPolicy where
        toJSON KeyAccessJustificationsPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("allowedAccessReasons" Core..=) Core.<$> allowedAccessReasons])


-- | A singleton configuration for Key Access Justifications policies.
--
-- /See:/ 'newKeyAccessJustificationsPolicyConfig' smart constructor.
data KeyAccessJustificationsPolicyConfig = KeyAccessJustificationsPolicyConfig
    {
      ...
      defaultKeyAccessJustificationPolicy :: (Core.Maybe KeyAccessJustificationsPolicy)
...
-- | Creates a value of 'KeyAccessJustificationsPolicyConfig' with the minimum fields required to make a request.
newKeyAccessJustificationsPolicyConfig 
    :: 
                                       KeyAccessJustificationsPolicyConfig
newKeyAccessJustificationsPolicyConfig
  = KeyAccessJustificationsPolicyConfig{defaultKeyAccessJustificationPolicy
                                          = Core.Nothing,
                                        name = Core.Nothing}
instance Core.FromJSON KeyAccessJustificationsPolicyConfig where
        parseJSON
          = Core.withObject "KeyAccessJustificationsPolicyConfig"
              (\ o ->
                 KeyAccessJustificationsPolicyConfig Core.<$>
                   (o Core..:? "defaultKeyAccessJustificationPolicy") Core.<*>
                     (o Core..:? "name"))

instance Core.ToJSON KeyAccessJustificationsPolicyConfig where
        toJSON KeyAccessJustificationsPolicyConfig{..}
          = Core.object
              (Core.catMaybes
                 [("defaultKeyAccessJustificationPolicy" Core..=) Core.<$>
...
--
-- /See:/ 'newKeyHandle' smart constructor.
data KeyHandle = KeyHandle
    {
    ...
    , resourceTypeSelector :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'KeyHandle' with the minimum fields required to make a request.
newKeyHandle 
    ::  KeyHandle
newKeyHandle
  = KeyHandle{kmsKey = Core.Nothing, name = Core.Nothing,
              resourceTypeSelector = Core.Nothing}
instance Core.FromJSON KeyHandle where
        parseJSON
          = Core.withObject "KeyHandle"
              (\ o ->
                 KeyHandle Core.<$>
                   (o Core..:? "kmsKey") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "resourceTypeSelector"))

instance Core.ToJSON KeyHandle where
        toJSON KeyHandle{..}
          = Core.object
              (Core.catMaybes
                 [("kmsKey" Core..=) Core.<$> kmsKey,
                  ("name" Core..=) Core.<$> name,
                  ("resourceTypeSelector" Core..=) Core.<$> resourceTypeSelector])
...
newKeyOperationAttestation 
    ::  KeyOperationAttestation
newKeyOperationAttestation
  = KeyOperationAttestation{certChains = Core.Nothing,
                            content = Core.Nothing, format = Core.Nothing}
instance Core.FromJSON KeyOperationAttestation where
        parseJSON
          = Core.withObject "KeyOperationAttestation"
              (\ o ->
                 KeyOperationAttestation Core.<$>
                   (o Core..:? "certChains") Core.<*> (o Core..:? "content") Core.<*>
                     (o Core..:? "format"))
...
newKeyRing 
    ::  KeyRing
newKeyRing
  = KeyRing{createTime = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON KeyRing where
        parseJSON
          = Core.withObject "KeyRing"
              (\ o ->
                 KeyRing Core.<$>
...
newListCryptoKeyVersionsResponse 
    ::  ListCryptoKeyVersionsResponse
newListCryptoKeyVersionsResponse
  = ListCryptoKeyVersionsResponse{cryptoKeyVersions = Core.Nothing,
                                  nextPageToken = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON ListCryptoKeyVersionsResponse where
        parseJSON
          = Core.withObject "ListCryptoKeyVersionsResponse"
              (\ o ->
                 ListCryptoKeyVersionsResponse Core.<$>
                   (o Core..:? "cryptoKeyVersions") Core.<*>
...
instance Core.ToJSON ListCryptoKeyVersionsResponse where
        toJSON ListCryptoKeyVersionsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("cryptoKeyVersions" Core..=) Core.<$> cryptoKeyVersions,
...
newListCryptoKeysResponse 
    ::  ListCryptoKeysResponse
newListCryptoKeysResponse
  = ListCryptoKeysResponse{cryptoKeys = Core.Nothing,
                           nextPageToken = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON ListCryptoKeysResponse where
        parseJSON
          = Core.withObject "ListCryptoKeysResponse"
              (\ o ->
                 ListCryptoKeysResponse Core.<$>
                   (o Core..:? "cryptoKeys") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
...
newListEkmConnectionsResponse 
    ::  ListEkmConnectionsResponse
newListEkmConnectionsResponse
  = ListEkmConnectionsResponse{ekmConnections = Core.Nothing,
                               nextPageToken = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON ListEkmConnectionsResponse where
        parseJSON
          = Core.withObject "ListEkmConnectionsResponse"
              (\ o ->
                 ListEkmConnectionsResponse Core.<$>
                   (o Core..:? "ekmConnections") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
...
newListImportJobsResponse 
    ::  ListImportJobsResponse
newListImportJobsResponse
  = ListImportJobsResponse{importJobs = Core.Nothing,
                           nextPageToken = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON ListImportJobsResponse where
        parseJSON
          = Core.withObject "ListImportJobsResponse"
              (\ o ->
                 ListImportJobsResponse Core.<$>
                   (o Core..:? "importJobs") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
...
--
-- /See:/ 'newListKeyHandlesResponse' smart constructor.
data ListKeyHandlesResponse = ListKeyHandlesResponse
    {
      -- | Resulting KeyHandles.
      keyHandles :: (Core.Maybe [KeyHandle])
...
-- | Creates a value of 'ListKeyHandlesResponse' with the minimum fields required to make a request.
newListKeyHandlesResponse 
    ::  ListKeyHandlesResponse
newListKeyHandlesResponse
  = ListKeyHandlesResponse{keyHandles = Core.Nothing,
                           nextPageToken = Core.Nothing}
instance Core.FromJSON ListKeyHandlesResponse where
        parseJSON
          = Core.withObject "ListKeyHandlesResponse"
              (\ o ->
                 ListKeyHandlesResponse Core.<$>
                   (o Core..:? "keyHandles") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON ListKeyHandlesResponse where
        toJSON ListKeyHandlesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("keyHandles" Core..=) Core.<$> keyHandles,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListKeyRingsResponse 
    ::  ListKeyRingsResponse
newListKeyRingsResponse
  = ListKeyRingsResponse{keyRings = Core.Nothing,
                         nextPageToken = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON ListKeyRingsResponse where
        parseJSON
          = Core.withObject "ListKeyRingsResponse"
              (\ o ->
                 ListKeyRingsResponse Core.<$>
                   (o Core..:? "keyRings") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
...
newLocationMetadata 
    ::  LocationMetadata
newLocationMetadata
  = LocationMetadata{ekmAvailable = Core.Nothing,
                     hsmAvailable = Core.Nothing}
instance Core.FromJSON LocationMetadata where
        parseJSON
          = Core.withObject "LocationMetadata"
              (\ o ->
                 LocationMetadata Core.<$>
                   (o Core..:? "ekmAvailable") Core.<*> (o Core..:? "hsmAvailable"))
...
instance Core.FromJSON MacSignRequest where
        parseJSON
          = Core.withObject "MacSignRequest"
              (\ o ->
                 MacSignRequest Core.<$>
                   (o Core..:? "data") Core.<*>
                     (o Core..:? "dataCrc32c" Core.<&> Core.fmap Core.fromAsText))
...
newMacSignResponse 
    ::  MacSignResponse
newMacSignResponse
  = MacSignResponse{mac = Core.Nothing, macCrc32c = Core.Nothing,
                    name = Core.Nothing, protectionLevel = Core.Nothing,
                    verifiedDataCrc32c = Core.Nothing}
instance Core.FromJSON MacSignResponse where
        parseJSON
          = Core.withObject "MacSignResponse"
              (\ o ->
                 MacSignResponse Core.<$>
                   (o Core..:? "mac") Core.<*>
                     (o Core..:? "macCrc32c" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "protectionLevel")
                     Core.<*> (o Core..:? "verifiedDataCrc32c"))
...
instance Core.ToJSON MacSignResponse where
        toJSON MacSignResponse{..}
          = Core.object
              (Core.catMaybes
                 [("mac" Core..=) Core.<$> mac,
                  ("macCrc32c" Core..=) Core.. Core.AsText Core.<$> macCrc32c,
                  ("name" Core..=) Core.<$> name,
                  ("protectionLevel" Core..=) Core.<$> protectionLevel,
                  ("verifiedDataCrc32c" Core..=) Core.<$> verifiedDataCrc32c])
...
newMacVerifyRequest 
    ::  MacVerifyRequest
newMacVerifyRequest
  = MacVerifyRequest{data' = Core.Nothing, dataCrc32c = Core.Nothing,
                     mac = Core.Nothing, macCrc32c = Core.Nothing}
instance Core.FromJSON MacVerifyRequest where
        parseJSON
          = Core.withObject "MacVerifyRequest"
              (\ o ->
                 MacVerifyRequest Core.<$>
                   (o Core..:? "data") Core.<*>
                     (o Core..:? "dataCrc32c" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "mac")
                     Core.<*>
...
newMacVerifyResponse 
    ::  MacVerifyResponse
newMacVerifyResponse
  = MacVerifyResponse{name = Core.Nothing,
                      protectionLevel = Core.Nothing, success = Core.Nothing,
                      verifiedDataCrc32c = Core.Nothing,
                      verifiedMacCrc32c = Core.Nothing,
                      verifiedSuccessIntegrity = Core.Nothing}
instance Core.FromJSON MacVerifyResponse where
        parseJSON
          = Core.withObject "MacVerifyResponse"
              (\ o ->
                 MacVerifyResponse Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "protectionLevel")
                     Core.<*> (o Core..:? "success")
                     Core.<*> (o Core..:? "verifiedDataCrc32c")
          ...
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ...
                  ("verifiedDataCrc32c" Core..=) Core.<$> verifiedDataCrc32c,
                  ("verifiedMacCrc32c" Core..=) Core.<$> verifiedMacCrc32c,
                  ("verifiedSuccessIntegrity" Core..=) Core.<$>
...
newPublicKey 
    ::  PublicKey
newPublicKey
  = PublicKey{algorithm = Core.Nothing, name = Core.Nothing,
              pem = Core.Nothing, pemCrc32c = Core.Nothing,
              protectionLevel = Core.Nothing, publicKey = Core.Nothing,
              publicKeyFormat = Core.Nothing}
instance Core.FromJSON PublicKey where
        parseJSON
          = Core.withObject "PublicKey"
              (\ o ->
                 PublicKey Core.<$>
                   (o Core..:? "algorithm") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "pem")
                     Core.<*>
                     (o Core..:? "pemCrc32c" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "protectionLevel")
                     Core.<*> (o Core..:? "publicKey")
...
instance Core.ToJSON PublicKey where
        toJSON PublicKey{..}
          = Core.object
              (Core.catMaybes
                 [("algorithm" Core..=) Core.<$> algorithm,
                  ("name" Core..=) Core.<$> name, ("pem" Core..=) Core.<$> pem,
...
--
-- /See:/ 'newRawDecryptRequest' smart constructor.
data RawDecryptRequest = RawDecryptRequest
    {
      -- | Optional. Optional data that must match the data originally supplied in RawEncryptRequest.additional/authenticated/data.
      additionalAuthenticatedData :: (Core.Maybe Core.Base64)
    ...
    , initializationVector :: (Core.Maybe Core.Base64)
    ...
    , initializationVectorCrc32c :: (Core.Maybe Core.Int64)
    ...
    , tagLength :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RawDecryptRequest' with the minimum fields required to make a request.
newRawDecryptRequest 
    ::  RawDecryptRequest
newRawDecryptRequest
  = RawDecryptRequest{additionalAuthenticatedData = Core.Nothing,
                      additionalAuthenticatedDataCrc32c = Core.Nothing,
                      ciphertext = Core.Nothing, ciphertextCrc32c = Core.Nothing,
                      initializationVector = Core.Nothing,
                      initializationVectorCrc32c = Core.Nothing,
                      tagLength = Core.Nothing}
instance Core.FromJSON RawDecryptRequest where
        parseJSON
          = Core.withObject "RawDecryptRequest"
              (\ o ->
                 RawDecryptRequest Core.<$>
                   (o Core..:? "additionalAuthenticatedData") Core.<*>
                     (o Core..:? "additionalAuthenticatedDataCrc32c" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "ciphertext")
                     Core.<*>
                     (o Core..:? "ciphertextCrc32c" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "initializationVector")
                     Core.<*>
                     (o Core..:? "initializationVectorCrc32c" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "tagLength"))

instance Core.ToJSON RawDecryptRequest where
        toJSON RawDecryptRequest{..}
          = Core.object
              (Core.catMaybes
                 [("additionalAuthenticatedData" Core..=) Core.<$>
                    additionalAuthenticatedData,
                  ...
                  ("initializationVectorCrc32c" Core..=) Core.. Core.AsText Core.<$>
                    initializationVectorCrc32c,
                  ("tagLength" Core..=) Core.<$> tagLength])


-- | Response message for KeyManagementService.RawDecrypt.
--
-- /See:/ 'newRawDecryptResponse' smart constructor.
data RawDecryptResponse = RawDecryptResponse
    {
      -- | The decrypted data.
      plaintext :: (Core.Maybe Core.Base64)
    ...
    , plaintextCrc32c :: (Core.Maybe Core.Int64)
      -- | The ProtectionLevel of the CryptoKeyVersion used in decryption.
    , protectionLevel :: (Core.Maybe RawDecryptResponse_ProtectionLevel)
      -- | Integrity verification field. A flag indicating whether RawDecryptRequest.additional/authenticated/data/crc32c was received by KeyManagementService and used for the integrity verification of additional/authenticated/data. A false value of this field indicates either that \/\/ RawDecryptRequest.additional/authenticated/data/crc32c was left unset or that it was not delivered to KeyManagementService. If you\'ve set RawDecryptRequest.additional/authenticated/data_crc32c but this field is still false, discard the response and perform a limited number of retries.
    , verifiedAdditionalAuthenticatedDataCrc32c :: (Core.Maybe Core.Bool)
      -- | Integrity verification field. A flag indicating whether RawDecryptRequest.ciphertext/crc32c was received by KeyManagementService and used for the integrity verification of the ciphertext. A false value of this field indicates either that RawDecryptRequest.ciphertext/crc32c was left unset or that it was not delivered to KeyManagementService. If you\'ve set RawDecryptRequest.ciphertext_crc32c but this field is still false, discard the response and perform a limited number of retries.
    , verifiedCiphertextCrc32c :: (Core.Maybe Core.Bool)
    ...
    , verifiedInitializationVectorCrc32c :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RawDecryptResponse' with the minimum fields required to make a request.
newRawDecryptResponse 
    ::  RawDecryptResponse
newRawDecryptResponse
  = RawDecryptResponse{plaintext = Core.Nothing,
                       plaintextCrc32c = Core.Nothing, protectionLevel = Core.Nothing,
                       verifiedAdditionalAuthenticatedDataCrc32c = Core.Nothing,
                       verifiedCiphertextCrc32c = Core.Nothing,
                       verifiedInitializationVectorCrc32c = Core.Nothing}
instance Core.FromJSON RawDecryptResponse where
        parseJSON
          = Core.withObject "RawDecryptResponse"
              (\ o ->
                 RawDecryptResponse Core.<$>
                   (o Core..:? "plaintext") Core.<*>
                     (o Core..:? "plaintextCrc32c" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "protectionLevel")
                     Core.<*> (o Core..:? "verifiedAdditionalAuthenticatedDataCrc32c")
                     Core.<*> (o Core..:? "verifiedCiphertextCrc32c")
                     Core.<*> (o Core..:? "verifiedInitializationVectorCrc32c"))

instance Core.ToJSON RawDecryptResponse where
...
-- | Creates a value of 'RawEncryptRequest' with the minimum fields required to make a request.
newRawEncryptRequest 
    ::  RawEncryptRequest
newRawEncryptRequest
  = RawEncryptRequest{additionalAuthenticatedData = Core.Nothing,
                      additionalAuthenticatedDataCrc32c = Core.Nothing,
                      initializationVector = Core.Nothing,
                      initializationVectorCrc32c = Core.Nothing,
                      plaintext = Core.Nothing, plaintextCrc32c = Core.Nothing}
instance Core.FromJSON RawEncryptRequest where
        parseJSON
          = Core.withObject "RawEncryptRequest"
              (\ o ->
                 RawEncryptRequest Core.<$>
                   (o Core..:? "additionalAuthenticatedData") Core.<*>
                     (o Core..:? "additionalAuthenticatedDataCrc32c" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "initializationVector")
...
instance Core.ToJSON RawEncryptRequest where
        toJSON RawEncryptRequest{..}
          = Core.object
              (Core.catMaybes
                 [("additionalAuthenticatedData" Core..=) Core.<$>
                    additionalAuthenticatedData,
...
--
-- /See:/ 'newRawEncryptResponse' smart constructor.
data RawEncryptResponse = RawEncryptResponse
    {
    ...
    , initializationVector :: (Core.Maybe Core.Base64)
      -- | Integrity verification field. A CRC32C checksum of the returned RawEncryptResponse.initialization/vector. An integrity check of initialization/vector can be performed by computing the CRC32C checksum of initialization_vector and comparing your results to this field. Discard the response in case of non-matching checksum values, and perform a limited number of retries. A persistent mismatch may indicate an issue in your computation of the CRC32C checksum. Note: This field is defined as int64 for reasons of compatibility across different languages. However, it is a non-negative integer, which will never exceed 2^32-1, and can be safely downconverted to uint32 in languages that support this type.
    , initializationVectorCrc32c :: (Core.Maybe Core.Int64)
      -- | The resource name of the CryptoKeyVersion used in encryption. Check this field to verify that the intended resource was used for encryption.
    , name :: (Core.Maybe Core.Text)
      -- | The ProtectionLevel of the CryptoKeyVersion used in encryption.
    , protectionLevel :: (Core.Maybe RawEncryptResponse_ProtectionLevel)
      -- | The length of the authentication tag that is appended to the end of the ciphertext.
    , tagLength :: (Core.Maybe Core.Int32)
      -- | Integrity verification field. A flag indicating whether RawEncryptRequest.additional/authenticated/data/crc32c was received by KeyManagementService and used for the integrity verification of additional/authenticated/data. A false value of this field indicates either that \/\/ RawEncryptRequest.additional/authenticated/data/crc32c was left unset or that it was not delivered to KeyManagementService. If you\'ve set RawEncryptRequest.additional/authenticated/data_crc32c but this field is still false, discard the response and perform a limited number of retries.
    , verifiedAdditionalAuthenticatedDataCrc32c :: (Core.Maybe Core.Bool)
    ...
    , verifiedInitializationVectorCrc32c :: (Core.Maybe Core.Bool)
      -- | Integrity verification field. A flag indicating whether RawEncryptRequest.plaintext/crc32c was received by KeyManagementService and used for the integrity verification of the plaintext. A false value of this field indicates either that RawEncryptRequest.plaintext/crc32c was left unset or that it was not delivered to KeyManagementService. If you\'ve set RawEncryptRequest.plaintext_crc32c but this field is still false, discard the response and perform a limited number of retries.
    , verifiedPlaintextCrc32c :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RawEncryptResponse' with the minimum fields required to make a request.
newRawEncryptResponse 
    ::  RawEncryptResponse
newRawEncryptResponse
  = RawEncryptResponse{ciphertext = Core.Nothing,
                       ciphertextCrc32c = Core.Nothing,
                       initializationVector = Core.Nothing,
                       initializationVectorCrc32c = Core.Nothing, name = Core.Nothing,
                       protectionLevel = Core.Nothing, tagLength = Core.Nothing,
                       verifiedAdditionalAuthenticatedDataCrc32c = Core.Nothing,
                       verifiedInitializationVectorCrc32c = Core.Nothing,
                       verifiedPlaintextCrc32c = Core.Nothing}
instance Core.FromJSON RawEncryptResponse where
        parseJSON
          = Core.withObject "RawEncryptResponse"
              (\ o ->
                 RawEncryptResponse Core.<$>
                   (o Core..:? "ciphertext") Core.<*>
                     (o Core..:? "ciphertextCrc32c" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "initializationVector")
                     Core.<*>
...
instance Core.ToJSON RawEncryptResponse where
        toJSON RawEncryptResponse{..}
          = Core.object
              (Core.catMaybes
                 [("ciphertext" Core..=) Core.<$> ciphertext,
                  ("ciphertextCrc32c" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON RestoreCryptoKeyVersionRequest where
        parseJSON
          = Core.withObject "RestoreCryptoKeyVersionRequest"
...
newServiceResolver 
    ::  ServiceResolver
newServiceResolver
  = ServiceResolver{endpointFilter = Core.Nothing,
                    hostname = Core.Nothing, serverCertificates = Core.Nothing,
                    serviceDirectoryService = Core.Nothing}
instance Core.FromJSON ServiceResolver where
        parseJSON
          = Core.withObject "ServiceResolver"
              (\ o ->
                 ServiceResolver Core.<$>
                   (o Core..:? "endpointFilter") Core.<*> (o Core..:? "hostname")
          ...
          = Core.object
              (Core.catMaybes
                 [("endpointFilter" Core..=) Core.<$> endpointFilter,
                  ...
                  ("serverCertificates" Core..=) Core.<$> serverCertificates,
                  ("serviceDirectoryService" Core..=) Core.<$>
...
--
-- /See:/ 'newShowEffectiveAutokeyConfigResponse' smart constructor.
newtype ShowEffectiveAutokeyConfigResponse = ShowEffectiveAutokeyConfigResponse
    {
...
-- | Creates a value of 'ShowEffectiveAutokeyConfigResponse' with the minimum fields required to make a request.
newShowEffectiveAutokeyConfigResponse 
    :: 
                                      ShowEffectiveAutokeyConfigResponse
newShowEffectiveAutokeyConfigResponse
  = ShowEffectiveAutokeyConfigResponse{keyProject = Core.Nothing}
instance Core.FromJSON ShowEffectiveAutokeyConfigResponse where
        parseJSON
          = Core.withObject "ShowEffectiveAutokeyConfigResponse"
              (\ o ->
                 ShowEffectiveAutokeyConfigResponse Core.<$>
                   (o Core..:? "keyProject"))

instance Core.ToJSON ShowEffectiveAutokeyConfigResponse where
        toJSON ShowEffectiveAutokeyConfigResponse{..}
          = Core.object
              (Core.catMaybes [("keyProject" Core..=) Core.<$> keyProject])


-- | Response message for KeyAccessJustificationsConfig.ShowEffectiveKeyAccessJustificationsEnrollmentConfig
--
-- /See:/ 'newShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse' smart constructor.
data ShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse = ShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse
    {
      -- | The effective KeyAccessJustificationsEnrollmentConfig for external keys.
      externalConfig :: (Core.Maybe KeyAccessJustificationsEnrollmentConfig)
      -- | The effective KeyAccessJustificationsEnrollmentConfig for hardware keys.
    , hardwareConfig :: (Core.Maybe KeyAccessJustificationsEnrollmentConfig)
      -- | The effective KeyAccessJustificationsEnrollmentConfig for software keys.
    , softwareConfig :: (Core.Maybe KeyAccessJustificationsEnrollmentConfig)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse' with the minimum fields required to make a request.
newShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse 
    :: 
                                                                ShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse
newShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse
  = ShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse{externalConfig
                                                                   = Core.Nothing,
                                                                 hardwareConfig = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 ShowEffectiveKeyAccessJustificationsEnrollmentConfigResponse
                   Core.<$>
                   (o Core..:? "externalConfig") Core.<*>
                     (o Core..:? "hardwareConfig")
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("externalConfig" Core..=) Core.<$> externalConfig,
                  ("hardwareConfig" Core..=) Core.<$> hardwareConfig,
...
--
-- /See:/ 'newShowEffectiveKeyAccessJustificationsPolicyConfigResponse' smart constructor.
newtype ShowEffectiveKeyAccessJustificationsPolicyConfigResponse = ShowEffectiveKeyAccessJustificationsPolicyConfigResponse
    {
      -- | The effective KeyAccessJustificationsPolicyConfig.
      effectiveKajPolicy :: (Core.Maybe KeyAccessJustificationsPolicyConfig)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ShowEffectiveKeyAccessJustificationsPolicyConfigResponse' with the minimum fields required to make a request.
newShowEffectiveKeyAccessJustificationsPolicyConfigResponse 
    :: 
                                                            ShowEffectiveKeyAccessJustificationsPolicyConfigResponse
newShowEffectiveKeyAccessJustificationsPolicyConfigResponse
  = ShowEffectiveKeyAccessJustificationsPolicyConfigResponse{effectiveKajPolicy
                                                               = Core.Nothing}
instance Core.FromJSON
           ShowEffectiveKeyAccessJustificationsPolicyConfigResponse
         where
        parseJSON
          = Core.withObject
              "ShowEffectiveKeyAccessJustificationsPolicyConfigResponse"
              (\ o ->
                 ShowEffectiveKeyAccessJustificationsPolicyConfigResponse Core.<$>
                   (o Core..:? "effectiveKajPolicy"))

instance Core.ToJSON
           ShowEffectiveKeyAccessJustificationsPolicyConfigResponse
         where
        toJSON ShowEffectiveKeyAccessJustificationsPolicyConfigResponse{..}
          = Core.object
              (Core.catMaybes
                 [("effectiveKajPolicy" Core..=) Core.<$> effectiveKajPolicy])
...
newUpdateCryptoKeyPrimaryVersionRequest
  = UpdateCryptoKeyPrimaryVersionRequest{cryptoKeyVersionId =
                                           Core.Nothing}
instance Core.FromJSON UpdateCryptoKeyPrimaryVersionRequest where
        parseJSON
          = Core.withObject "UpdateCryptoKeyPrimaryVersionRequest"
              (\ o ->
                 UpdateCryptoKeyPrimaryVersionRequest Core.<$>
                   (o Core..:? "cryptoKeyVersionId"))

instance Core.ToJSON UpdateCryptoKeyPrimaryVersionRequest where
        toJSON UpdateCryptoKeyPrimaryVersionRequest{..}
          = Core.object
              (Core.catMaybes
                 [("cryptoKeyVersionId" Core..=) Core.<$> cryptoKeyVersionId])


-- | Response message for EkmService.VerifyConnectivity.
--
-- /See:/ 'newVerifyConnectivityResponse' smart constructor.
data VerifyConnectivityResponse = VerifyConnectivityResponse
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'VerifyConnectivityResponse' with the minimum fields required to make a request.
newVerifyConnectivityResponse 
    ::  VerifyConnectivityResponse
newVerifyConnectivityResponse = VerifyConnectivityResponse
instance Core.FromJSON VerifyConnectivityResponse where
        parseJSON
          = Core.withObject "VerifyConnectivityResponse"
              (\ o -> Core.pure VerifyConnectivityResponse)

instance Core.ToJSON VerifyConnectivityResponse where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON WrappingPublicKey where
        parseJSON
          = Core.withObject "WrappingPublicKey"
              (\ o -> WrappingPublicKey Core.<$> (o Core..:? "pem"))

instance Core.ToJSON WrappingPublicKey where
        toJSON WrappingPublicKey{..}
          = Core.object (Core.catMaybes [("pem" Core..=) Core.<$> pem])
