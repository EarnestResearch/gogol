...
--
-- Creates an ad unit. This method can only be used by projects enabled for the <https://developers.google.com/adsense/platforms/ AdSense for Platforms> product. Note that ad units can only be created for ad clients with an \"AFC\" product code. For more info see the </adsense/management/reference/rest/v2/accounts.adclients AdClient resource>. For now, this method can only be used to create @DISPLAY@ ad units. See: https:\/\/support.google.com\/adsense\/answer\/9183566
--
...
instance Core.GoogleRequest
           AdSenseAccountsAdclientsAdunitsCreate
         where
        type Rs AdSenseAccountsAdclientsAdunitsCreate =
             AdUnit
        type Scopes AdSenseAccountsAdclientsAdunitsCreate =
             '[Adsense'FullControl]
        requestClient
          AdSenseAccountsAdclientsAdunitsCreate{..}
