...
instance Core.FromJSON AdBlockingRecoveryTag where
        parseJSON
          = Core.withObject "AdBlockingRecoveryTag"
              (\ o ->
                 AdBlockingRecoveryTag Core.<$>
                   (o Core..:? "errorProtectionCode") Core.<*>
                     (o Core..:? "tag"))
          ...
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ...
                  ("reportingDimensionId" Core..=) Core.<$>
...
newAdClientAdCode =
  AdClientAdCode
    {adCode = Core.Nothing, ampBody = Core.Nothing, ampHead = Core.Nothing}

instance Core.FromJSON AdClientAdCode where
        parseJSON
          = Core.withObject "AdClientAdCode"
              (\ o ->
                 AdClientAdCode Core.<$>
                   (o Core..:? "adCode") Core.<*> (o Core..:? "ampBody")
                     Core.<*> (o Core..:? "ampHead"))
...
instance Core.FromJSON AdUnit where
        parseJSON
          = Core.withObject "AdUnit"
              (\ o ->
                 AdUnit Core.<$>
                   (o Core..:? "contentAdsSettings") Core.<*>
                     (o Core..:? "displayName")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "reportingDimensionId")
                     Core.<*> (o Core..:? "state"))
...
instance Core.FromJSON ContentAdsSettings where
        parseJSON
          = Core.withObject "ContentAdsSettings"
              (\ o ->
                 ContentAdsSettings Core.<$>
                   (o Core..:? "size") Core.<*> (o Core..:? "type"))
...
newHeader =
  Header
    {currencyCode = Core.Nothing, name = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON ListAdClientsResponse where
        parseJSON
          = Core.withObject "ListAdClientsResponse"
              (\ o ->
                 ListAdClientsResponse Core.<$>
                   (o Core..:? "adClients") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListAdUnitsResponse where
        parseJSON
          = Core.withObject "ListAdUnitsResponse"
              (\ o ->
                 ListAdUnitsResponse Core.<$>
                   (o Core..:? "adUnits") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListChildAccountsResponse =
  ListChildAccountsResponse
    {accounts = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListChildAccountsResponse
         where
        parseJSON
          = Core.withObject "ListChildAccountsResponse"
              (\ o ->
                 ListChildAccountsResponse Core.<$>
                   (o Core..:? "accounts") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListCustomChannelsResponse =
  ListCustomChannelsResponse
    {customChannels = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListCustomChannelsResponse
         where
        parseJSON
          = Core.withObject "ListCustomChannelsResponse"
              (\ o ->
                 ListCustomChannelsResponse Core.<$>
                   (o Core..:? "customChannels") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListLinkedAdUnitsResponse =
  ListLinkedAdUnitsResponse
    {adUnits = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListLinkedAdUnitsResponse
         where
        parseJSON
          = Core.withObject "ListLinkedAdUnitsResponse"
              (\ o ->
                 ListLinkedAdUnitsResponse Core.<$>
                   (o Core..:? "adUnits") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ListLinkedCustomChannelsResponse"
              (\ o ->
                 ListLinkedCustomChannelsResponse Core.<$>
                   (o Core..:? "customChannels") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListLinkedCustomChannelsResponse
         where
...
instance Core.FromJSON ListPaymentsResponse where
        parseJSON
          = Core.withObject "ListPaymentsResponse"
              (\ o ->
                 ListPaymentsResponse Core.<$>
                   (o Core..:? "payments"))
...
newListSavedReportsResponse =
  ListSavedReportsResponse
    {nextPageToken = Core.Nothing, savedReports = Core.Nothing}

instance Core.FromJSON ListSavedReportsResponse where
        parseJSON
          = Core.withObject "ListSavedReportsResponse"
              (\ o ->
                 ListSavedReportsResponse Core.<$>
...
instance Core.FromJSON ListSitesResponse where
        parseJSON
          = Core.withObject "ListSitesResponse"
              (\ o ->
                 ListSitesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sites"))
...
newListUrlChannelsResponse =
  ListUrlChannelsResponse
    {nextPageToken = Core.Nothing, urlChannels = Core.Nothing}

instance Core.FromJSON ListUrlChannelsResponse where
        parseJSON
          = Core.withObject "ListUrlChannelsResponse"
              (\ o ->
                 ListUrlChannelsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "urlChannels"))
...
instance Core.FromJSON Payment where
        parseJSON
          = Core.withObject "Payment"
              (\ o ->
                 Payment Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "date")
                     Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON ReportResult where
        parseJSON
          = Core.withObject "ReportResult"
              (\ o ->
                 ReportResult Core.<$>
                   (o Core..:? "averages") Core.<*>
                     (o Core..:? "endDate")
                     Core.<*> (o Core..:? "headers")
                     Core.<*> (o Core..:? "rows")
                     Core.<*> (o Core..:? "startDate")
                     Core.<*>
                     (o Core..:? "totalMatchedRows" Core.<&>
...
instance Core.FromJSON SavedReport where
        parseJSON
          = Core.withObject "SavedReport"
              (\ o ->
                 SavedReport Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "title"))
...
instance Core.FromJSON UrlChannel where
        parseJSON
          = Core.withObject "UrlChannel"
              (\ o ->
                 UrlChannel Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "reportingDimensionId")
