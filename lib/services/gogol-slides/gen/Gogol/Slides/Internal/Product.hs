...
instance Core.FromJSON AffineTransform where
        parseJSON
          = Core.withObject "AffineTransform"
              (\ o ->
                 AffineTransform Core.<$>
                   (o Core..:? "scaleX") Core.<*> (o Core..:? "scaleY")
                     Core.<*> (o Core..:? "shearX")
                     Core.<*> (o Core..:? "shearY")
...
instance Core.FromJSON AutoText where
        parseJSON
          = Core.withObject "AutoText"
              (\ o ->
                 AutoText Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "style")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON Autofit where
        parseJSON
          = Core.withObject "Autofit"
              (\ o ->
                 Autofit Core.<$>
                   (o Core..:? "autofitType") Core.<*>
                     (o Core..:? "fontScale")
          ...
          = Core.object
              (Core.catMaybes
                 [("autofitType" Core..=) Core.<$> autofitType,
                  ...
                  ("lineSpacingReduction" Core..=) Core.<$>
...
instance Core.FromJSON BatchUpdatePresentationRequest
         where
        parseJSON
          = Core.withObject "BatchUpdatePresentationRequest"
              (\ o ->
                 BatchUpdatePresentationRequest Core.<$>
                   (o Core..:? "requests") Core.<*>
                     (o Core..:? "writeControl"))

instance Core.ToJSON BatchUpdatePresentationRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "BatchUpdatePresentationResponse"
              (\ o ->
                 BatchUpdatePresentationResponse Core.<$>
                   (o Core..:? "presentationId") Core.<*>
                     (o Core..:? "replies")
                     Core.<*> (o Core..:? "writeControl"))

instance Core.ToJSON BatchUpdatePresentationResponse
         where
...
newColorStop =
  ColorStop
    {alpha = Core.Nothing, color = Core.Nothing, position = Core.Nothing}

instance Core.FromJSON ColorStop where
        parseJSON
          = Core.withObject "ColorStop"
              (\ o ->
                 ColorStop Core.<$>
                   (o Core..:? "alpha") Core.<*> (o Core..:? "color")
...
instance Core.FromJSON CreateImageRequest where
        parseJSON
          = Core.withObject "CreateImageRequest"
              (\ o ->
                 CreateImageRequest Core.<$>
                   (o Core..:? "elementProperties") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "url"))
...
instance Core.FromJSON CreateImageResponse where
        parseJSON
          = Core.withObject "CreateImageResponse"
              (\ o ->
...
instance Core.FromJSON CreateLineRequest where
        parseJSON
          = Core.withObject "CreateLineRequest"
              (\ o ->
                 CreateLineRequest Core.<$>
                   (o Core..:? "category") Core.<*>
                     (o Core..:? "elementProperties")
...
instance Core.FromJSON CreateLineResponse where
        parseJSON
          = Core.withObject "CreateLineResponse"
              (\ o ->
...
instance Core.FromJSON CreateShapeRequest where
        parseJSON
          = Core.withObject "CreateShapeRequest"
              (\ o ->
                 CreateShapeRequest Core.<$>
                   (o Core..:? "elementProperties") Core.<*>
                     (o Core..:? "objectId")
...
instance Core.FromJSON CreateShapeResponse where
        parseJSON
          = Core.withObject "CreateShapeResponse"
              (\ o ->
...
instance Core.FromJSON CreateSheetsChartRequest where
        parseJSON
          = Core.withObject "CreateSheetsChartRequest"
              (\ o ->
                 CreateSheetsChartRequest Core.<$>
                   (o Core..:? "chartId") Core.<*>
                     (o Core..:? "elementProperties")
...
instance Core.FromJSON CreateSheetsChartResponse
         where
        parseJSON
          = Core.withObject "CreateSheetsChartResponse"
              (\ o ->
                 CreateSheetsChartResponse Core.<$>
                   (o Core..:? "objectId"))
...
instance Core.FromJSON CreateSlideRequest where
        parseJSON
          = Core.withObject "CreateSlideRequest"
              (\ o ->
                 CreateSlideRequest Core.<$>
                   (o Core..:? "insertionIndex") Core.<*>
                     (o Core..:? "objectId")
          ...
          = Core.object
              (Core.catMaybes
                 [("insertionIndex" Core..=) Core.<$> insertionIndex,
                  ("objectId" Core..=) Core.<$> objectId,
                  ("placeholderIdMappings" Core..=) Core.<$>
                    placeholderIdMappings,
                  ("slideLayoutReference" Core..=) Core.<$>
...
instance Core.FromJSON CreateSlideResponse where
        parseJSON
          = Core.withObject "CreateSlideResponse"
              (\ o ->
...
instance Core.FromJSON CreateTableResponse where
        parseJSON
          = Core.withObject "CreateTableResponse"
              (\ o ->
...
instance Core.FromJSON CreateVideoRequest where
        parseJSON
          = Core.withObject "CreateVideoRequest"
              (\ o ->
                 CreateVideoRequest Core.<$>
                   (o Core..:? "elementProperties") Core.<*>
                     (o Core..:? "id")
                     Core.<*> (o Core..:? "objectId")
                     Core.<*> (o Core..:? "source"))
...
instance Core.FromJSON CreateVideoResponse where
        parseJSON
          = Core.withObject "CreateVideoResponse"
              (\ o ->
...
instance Core.FromJSON DeleteObjectRequest where
        parseJSON
          = Core.withObject "DeleteObjectRequest"
              (\ o ->
...
newDeleteTableColumnRequest =
  DeleteTableColumnRequest
    {cellLocation = Core.Nothing, tableObjectId = Core.Nothing}
...
instance Core.FromJSON DeleteTextRequest where
        parseJSON
          = Core.withObject "DeleteTextRequest"
              (\ o ->
                 DeleteTextRequest Core.<$>
                   (o Core..:? "cellLocation") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "textRange"))
...
instance Core.FromJSON DuplicateObjectRequest where
        parseJSON
          = Core.withObject "DuplicateObjectRequest"
              (\ o ->
                 DuplicateObjectRequest Core.<$>
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "DuplicateObjectRequest_ObjectIds"
              (\ o ->
                 DuplicateObjectRequest_ObjectIds Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DuplicateObjectRequest_ObjectIds
         where
...
instance Core.FromJSON DuplicateObjectResponse where
        parseJSON
          = Core.withObject "DuplicateObjectResponse"
              (\ o ->
                 DuplicateObjectResponse Core.<$>
                   (o Core..:? "objectId"))
...
newGroupObjectsRequest =
  GroupObjectsRequest
    {childrenObjectIds = Core.Nothing, groupObjectId = Core.Nothing}

instance Core.FromJSON GroupObjectsRequest where
        parseJSON
          = Core.withObject "GroupObjectsRequest"
              (\ o ->
                 GroupObjectsRequest Core.<$>
                   (o Core..:? "childrenObjectIds") Core.<*>
                     (o Core..:? "groupObjectId"))

instance Core.ToJSON GroupObjectsRequest where
        toJSON GroupObjectsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("childrenObjectIds" Core..=) Core.<$>
                    childrenObjectIds,
...
instance Core.FromJSON GroupObjectsResponse where
        parseJSON
          = Core.withObject "GroupObjectsResponse"
              (\ o ->
                 GroupObjectsResponse Core.<$>
                   (o Core..:? "objectId"))
...
instance Core.FromJSON Image where
        parseJSON
          = Core.withObject "Image"
              (\ o ->
                 Image Core.<$>
                   (o Core..:? "contentUrl") Core.<*>
                     (o Core..:? "imageProperties")
...
instance Core.FromJSON InsertTableColumnsRequest
         where
        parseJSON
          = Core.withObject "InsertTableColumnsRequest"
              (\ o ->
                 InsertTableColumnsRequest Core.<$>
                   (o Core..:? "cellLocation") Core.<*>
                     (o Core..:? "insertRight")
                     Core.<*> (o Core..:? "number")
...
instance Core.FromJSON InsertTableRowsRequest where
        parseJSON
          = Core.withObject "InsertTableRowsRequest"
              (\ o ->
                 InsertTableRowsRequest Core.<$>
                   (o Core..:? "cellLocation") Core.<*>
                     (o Core..:? "insertBelow")
                     Core.<*> (o Core..:? "number")
                     Core.<*> (o Core..:? "tableObjectId"))
...
instance Core.FromJSON LayoutPlaceholderIdMapping
         where
        parseJSON
          = Core.withObject "LayoutPlaceholderIdMapping"
              (\ o ->
                 LayoutPlaceholderIdMapping Core.<$>
                   (o Core..:? "layoutPlaceholder") Core.<*>
                     (o Core..:? "layoutPlaceholderObjectId")
                     Core.<*> (o Core..:? "objectId"))
...
instance Core.ToJSON LayoutPlaceholderIdMapping where
        toJSON LayoutPlaceholderIdMapping{..}
          = Core.object
              (Core.catMaybes
                 [("layoutPlaceholder" Core..=) Core.<$>
                    layoutPlaceholder,
                  ("layoutPlaceholderObjectId" Core..=) Core.<$>
...
instance Core.FromJSON LayoutProperties where
        parseJSON
          = Core.withObject "LayoutProperties"
              (\ o ->
                 LayoutProperties Core.<$>
                   (o Core..:? "displayName") Core.<*>
                     (o Core..:? "masterObjectId")
                     Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON LayoutReference where
        parseJSON
          = Core.withObject "LayoutReference"
              (\ o ->
                 LayoutReference Core.<$>
                   (o Core..:? "layoutId") Core.<*>
                     (o Core..:? "predefinedLayout"))
...
instance Core.FromJSON Line where
        parseJSON
          = Core.withObject "Line"
              (\ o ->
                 Line Core.<$>
                   (o Core..:? "lineCategory") Core.<*>
                     (o Core..:? "lineProperties")
...
newLineConnection =
  LineConnection
    {connectedObjectId = Core.Nothing, connectionSiteIndex = Core.Nothing}

instance Core.FromJSON LineConnection where
        parseJSON
          = Core.withObject "LineConnection"
              (\ o ->
                 LineConnection Core.<$>
                   (o Core..:? "connectedObjectId") Core.<*>
                     (o Core..:? "connectionSiteIndex"))

instance Core.ToJSON LineConnection where
        toJSON LineConnection{..}
          = Core.object
              (Core.catMaybes
                 [("connectedObjectId" Core..=) Core.<$>
                    connectedObjectId,
                  ("connectionSiteIndex" Core..=) Core.<$>
                    connectionSiteIndex])
...
instance Core.FromJSON LineProperties where
        parseJSON
          = Core.withObject "LineProperties"
              (\ o ->
                 LineProperties Core.<$>
                   (o Core..:? "dashStyle") Core.<*>
                     (o Core..:? "endArrow")
...
instance Core.FromJSON List_NestingLevel where
        parseJSON
          = Core.withObject "List_NestingLevel"
              (\ o ->
...
instance Core.FromJSON MasterProperties where
        parseJSON
          = Core.withObject "MasterProperties"
              (\ o ->
...
instance Core.FromJSON NotesProperties where
        parseJSON
          = Core.withObject "NotesProperties"
              (\ o ->
                 NotesProperties Core.<$>
                   (o Core..:? "speakerNotesObjectId"))

instance Core.ToJSON NotesProperties where
        toJSON NotesProperties{..}
          = Core.object
              (Core.catMaybes
                 [("speakerNotesObjectId" Core..=) Core.<$>
...
instance Core.FromJSON Page where
        parseJSON
          = Core.withObject "Page"
              (\ o ->
                 Page Core.<$>
                   (o Core..:? "layoutProperties") Core.<*>
                     (o Core..:? "masterProperties")
...
instance Core.ToJSON Page where
        toJSON Page{..}
          = Core.object
              (Core.catMaybes
                 [("layoutProperties" Core..=) Core.<$>
                    layoutProperties,
                  ("masterProperties" Core..=) Core.<$>
                    masterProperties,
...
instance Core.FromJSON PageBackgroundFill where
        parseJSON
          = Core.withObject "PageBackgroundFill"
              (\ o ->
                 PageBackgroundFill Core.<$>
                   (o Core..:? "propertyState") Core.<*>
                     (o Core..:? "solidFill")
        ...
        toJSON PageBackgroundFill{..}
          = Core.object
              (Core.catMaybes
                 [("propertyState" Core..=) Core.<$> propertyState,
                  ("solidFill" Core..=) Core.<$> solidFill,
                  ("stretchedPictureFill" Core..=) Core.<$>
                    stretchedPictureFill])
...
newPageElementProperties =
  PageElementProperties
    {pageObjectId = Core.Nothing, size = Core.Nothing, transform = Core.Nothing}

instance Core.FromJSON PageElementProperties where
        parseJSON
          = Core.withObject "PageElementProperties"
              (\ o ->
                 PageElementProperties Core.<$>
                   (o Core..:? "pageObjectId") Core.<*>
                     (o Core..:? "size")
                     Core.<*> (o Core..:? "transform"))
...
instance Core.FromJSON PageProperties where
        parseJSON
          = Core.withObject "PageProperties"
              (\ o ->
                 PageProperties Core.<$>
                   (o Core..:? "colorScheme") Core.<*>
                     (o Core..:? "pageBackgroundFill"))
...
instance Core.FromJSON ParagraphMarker where
        parseJSON
          = Core.withObject "ParagraphMarker"
              (\ o ->
                 ParagraphMarker Core.<$>
                   (o Core..:? "bullet") Core.<*> (o Core..:? "style"))
...
newPlaceholder =
  Placeholder
    {index = Core.Nothing, parentObjectId = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON Placeholder where
        parseJSON
          = Core.withObject "Placeholder"
              (\ o ->
                 Placeholder Core.<$>
                   (o Core..:? "index") Core.<*>
                     (o Core..:? "parentObjectId")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON Presentation where
        parseJSON
          = Core.withObject "Presentation"
              (\ o ->
                 Presentation Core.<$>
                   (o Core..:? "layouts") Core.<*> (o Core..:? "locale")
                     Core.<*> (o Core..:? "masters")
...
newRange =
  Range
    {endIndex = Core.Nothing, startIndex = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON RefreshSheetsChartRequest
         where
        parseJSON
          = Core.withObject "RefreshSheetsChartRequest"
              (\ o ->
                 RefreshSheetsChartRequest Core.<$>
                   (o Core..:? "objectId"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ReplaceAllShapesWithImageRequest"
              (\ o ->
                 ReplaceAllShapesWithImageRequest Core.<$>
...
instance Core.ToJSON ReplaceAllShapesWithImageRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ReplaceAllShapesWithImageResponse"
              (\ o ->
                 ReplaceAllShapesWithImageResponse Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ReplaceAllShapesWithSheetsChartRequest"
              (\ o ->
                 ReplaceAllShapesWithSheetsChartRequest Core.<$>
                   (o Core..:? "chartId") Core.<*>
                     (o Core..:? "containsText")
                     Core.<*> (o Core..:? "linkingMode")
                     Core.<*> (o Core..:? "pageObjectIds")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ReplaceAllShapesWithSheetsChartResponse"
              (\ o ->
                 ReplaceAllShapesWithSheetsChartResponse Core.<$>
                   (o Core..:? "occurrencesChanged"))
              ...
              (\ o ->
                 Request' Core.<$>
                   (o Core..:? "createImage") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "replaceAllShapesWithSheetsChart")
          ...
          = Core.object
              (Core.catMaybes
                 [("createImage" Core..=) Core.<$> createImage,
                  ...
                  ("insertTableColumns" Core..=) Core.<$>
                    insertTableColumns,
                  ("insertTableRows" Core..=) Core.<$> insertTableRows,
                  ("insertText" Core..=) Core.<$> insertText,
                  ("mergeTableCells" Core..=) Core.<$> mergeTableCells,
                  ("refreshSheetsChart" Core..=) Core.<$>
                    refreshSheetsChart,
                  ("replaceAllShapesWithImage" Core..=) Core.<$>
                    replaceAllShapesWithImage,
                  ("replaceAllShapesWithSheetsChart" Core..=) Core.<$>
                  ...
                  ("unmergeTableCells" Core..=) Core.<$>
                    unmergeTableCells,
                  ("updateImageProperties" Core..=) Core.<$>
                    updateImageProperties,
                  ("updateLineCategory" Core..=) Core.<$>
                    updateLineCategory,
                  ("updateLineProperties" Core..=) Core.<$>
                    updateLineProperties,
                  ("updatePageElementAltText" Core..=) Core.<$>
                    updatePageElementAltText,
                  ("updatePageElementTransform" Core..=) Core.<$>
                    updatePageElementTransform,
                  ("updatePageElementsZOrder" Core..=) Core.<$>
                    updatePageElementsZOrder,
                  ("updatePageProperties" Core..=) Core.<$>
                    updatePageProperties,
                  ("updateParagraphStyle" Core..=) Core.<$>
                    updateParagraphStyle,
                  ("updateShapeProperties" Core..=) Core.<$>
                    updateShapeProperties,
                  ("updateSlideProperties" Core..=) Core.<$>
                    updateSlideProperties,
                  ("updateSlidesPosition" Core..=) Core.<$>
                    updateSlidesPosition,
                  ("updateTableBorderProperties" Core..=) Core.<$>
                    updateTableBorderProperties,
                  ("updateTableCellProperties" Core..=) Core.<$>
                    updateTableCellProperties,
                  ("updateTableColumnProperties" Core..=) Core.<$>
                    updateTableColumnProperties,
                  ("updateTableRowProperties" Core..=) Core.<$>
                    updateTableRowProperties,
                  ("updateTextStyle" Core..=) Core.<$> updateTextStyle,
                  ("updateVideoProperties" Core..=) Core.<$>
...
instance Core.FromJSON RerouteLineRequest where
        parseJSON
          = Core.withObject "RerouteLineRequest"
              (\ o ->
...
instance Core.FromJSON Shape where
        parseJSON
          = Core.withObject "Shape"
              (\ o ->
                 Shape Core.<$>
                   (o Core..:? "placeholder") Core.<*>
                     (o Core..:? "shapeProperties")
                     Core.<*> (o Core..:? "shapeType")
                     Core.<*> (o Core..:? "text"))
...
instance Core.FromJSON ShapeBackgroundFill where
        parseJSON
          = Core.withObject "ShapeBackgroundFill"
              (\ o ->
...
instance Core.FromJSON ShapeProperties where
        parseJSON
          = Core.withObject "ShapeProperties"
              (\ o ->
                 ShapeProperties Core.<$>
                   (o Core..:? "autofit") Core.<*>
                     (o Core..:? "contentAlignment")
                     Core.<*> (o Core..:? "link")
                     Core.<*> (o Core..:? "outline")
                     Core.<*> (o Core..:? "shadow")
        ...
        toJSON SheetsChart{..}
          = Core.object
              (Core.catMaybes
                 [("chartId" Core..=) Core.<$> chartId,
                  ("contentUrl" Core..=) Core.<$> contentUrl,
                  ("sheetsChartProperties" Core..=) Core.<$>
                    sheetsChartProperties,
                  ("spreadsheetId" Core..=) Core.<$> spreadsheetId])
...
instance Core.FromJSON SlideProperties where
        parseJSON
          = Core.withObject "SlideProperties"
              (\ o ->
                 SlideProperties Core.<$>
                   (o Core..:? "isSkipped") Core.<*>
                     (o Core..:? "layoutObjectId")
...
instance Core.FromJSON StretchedPictureFill where
        parseJSON
          = Core.withObject "StretchedPictureFill"
              (\ o ->
...
newTableBorderCell =
  TableBorderCell
    {location = Core.Nothing, tableBorderProperties = Core.Nothing}

instance Core.FromJSON TableBorderCell where
        parseJSON
          = Core.withObject "TableBorderCell"
              (\ o ->
                 TableBorderCell Core.<$>
                   (o Core..:? "location") Core.<*>
                     (o Core..:? "tableBorderProperties"))
          ...
          = Core.object
              (Core.catMaybes
                 [("location" Core..=) Core.<$> location,
                  ("tableBorderProperties" Core..=) Core.<$>
                    tableBorderProperties])
...
instance Core.FromJSON TableBorderFill where
        parseJSON
          = Core.withObject "TableBorderFill"
              (\ o ->
...
instance Core.FromJSON TableBorderProperties where
        parseJSON
          = Core.withObject "TableBorderProperties"
              (\ o ->
                 TableBorderProperties Core.<$>
                   (o Core..:? "dashStyle") Core.<*>
                     (o Core..:? "tableBorderFill")
                     Core.<*> (o Core..:? "weight"))
...
instance Core.FromJSON TableBorderRow where
        parseJSON
          = Core.withObject "TableBorderRow"
              (\ o ->
                 TableBorderRow Core.<$>
                   (o Core..:? "tableBorderCells"))

instance Core.ToJSON TableBorderRow where
        toJSON TableBorderRow{..}
          = Core.object
              (Core.catMaybes
                 [("tableBorderCells" Core..=) Core.<$>
                    tableBorderCells])
...
newTableCellBackgroundFill =
  TableCellBackgroundFill
    {propertyState = Core.Nothing, solidFill = Core.Nothing}

instance Core.FromJSON TableCellBackgroundFill where
        parseJSON
          = Core.withObject "TableCellBackgroundFill"
              (\ o ->
...
newTableCellProperties =
  TableCellProperties
    {contentAlignment = Core.Nothing, tableCellBackgroundFill = Core.Nothing}

instance Core.FromJSON TableCellProperties where
        parseJSON
          = Core.withObject "TableCellProperties"
              (\ o ->
                 TableCellProperties Core.<$>
                   (o Core..:? "contentAlignment") Core.<*>
                     (o Core..:? "tableCellBackgroundFill"))
        ...
        toJSON TableCellProperties{..}
          = Core.object
              (Core.catMaybes
                 [("contentAlignment" Core..=) Core.<$>
                    contentAlignment,
                  ("tableCellBackgroundFill" Core..=) Core.<$>
                    tableCellBackgroundFill])
...
newTableRange =
  TableRange
    {columnSpan = Core.Nothing, location = Core.Nothing, rowSpan = Core.Nothing}
...
instance Core.FromJSON TableRowProperties where
        parseJSON
          = Core.withObject "TableRowProperties"
              (\ o ->
...
instance Core.FromJSON TextContent_Lists where
        parseJSON
          = Core.withObject "TextContent_Lists"
              (\ o ->
...
newThumbnail =
  Thumbnail
    {contentUrl = Core.Nothing, height = Core.Nothing, width = Core.Nothing}
...
instance Core.FromJSON UngroupObjectsRequest where
        parseJSON
          = Core.withObject "UngroupObjectsRequest"
              (\ o ->
                 UngroupObjectsRequest Core.<$>
                   (o Core..:? "objectIds"))
...
instance Core.FromJSON UpdateImagePropertiesRequest
         where
        parseJSON
          = Core.withObject "UpdateImagePropertiesRequest"
              (\ o ->
                 UpdateImagePropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "imageProperties")
                     Core.<*> (o Core..:? "objectId"))

instance Core.ToJSON UpdateImagePropertiesRequest
         where
...
newUpdateLineCategoryRequest =
  UpdateLineCategoryRequest
    {lineCategory = Core.Nothing, objectId = Core.Nothing}

instance Core.FromJSON UpdateLineCategoryRequest
         where
        parseJSON
          = Core.withObject "UpdateLineCategoryRequest"
              (\ o ->
                 UpdateLineCategoryRequest Core.<$>
                   (o Core..:? "lineCategory") Core.<*>
                     (o Core..:? "objectId"))
...
instance Core.FromJSON UpdateLinePropertiesRequest
         where
        parseJSON
          = Core.withObject "UpdateLinePropertiesRequest"
              (\ o ->
                 UpdateLinePropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "lineProperties")
                     Core.<*> (o Core..:? "objectId"))

instance Core.ToJSON UpdateLinePropertiesRequest
         where
...
newUpdatePageElementAltTextRequest =
  UpdatePageElementAltTextRequest
    {description = Core.Nothing, objectId = Core.Nothing, title = Core.Nothing}

instance Core.FromJSON
           UpdatePageElementAltTextRequest
         where
        parseJSON
          = Core.withObject "UpdatePageElementAltTextRequest"
              (\ o ->
                 UpdatePageElementAltTextRequest Core.<$>
                   (o Core..:? "description") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "title"))

instance Core.ToJSON UpdatePageElementAltTextRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "UpdatePageElementTransformRequest"
              (\ o ->
                 UpdatePageElementTransformRequest Core.<$>
                   (o Core..:? "applyMode") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "transform"))
...
newUpdatePageElementsZOrderRequest =
  UpdatePageElementsZOrderRequest
    {operation = Core.Nothing, pageElementObjectIds = Core.Nothing}

instance Core.FromJSON
           UpdatePageElementsZOrderRequest
         where
        parseJSON
          = Core.withObject "UpdatePageElementsZOrderRequest"
              (\ o ->
                 UpdatePageElementsZOrderRequest Core.<$>
                   (o Core..:? "operation") Core.<*>
                     (o Core..:? "pageElementObjectIds"))

instance Core.ToJSON UpdatePageElementsZOrderRequest
         where
        toJSON UpdatePageElementsZOrderRequest{..}
          = Core.object
              (Core.catMaybes
                 [("operation" Core..=) Core.<$> operation,
                  ("pageElementObjectIds" Core..=) Core.<$>
...
instance Core.FromJSON UpdatePagePropertiesRequest
         where
        parseJSON
          = Core.withObject "UpdatePagePropertiesRequest"
              (\ o ->
                 UpdatePagePropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "pageProperties"))

instance Core.ToJSON UpdatePagePropertiesRequest
         where
...
instance Core.FromJSON UpdateShapePropertiesRequest
         where
        parseJSON
          = Core.withObject "UpdateShapePropertiesRequest"
              (\ o ->
                 UpdateShapePropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "shapeProperties"))

instance Core.ToJSON UpdateShapePropertiesRequest
         where
...
instance Core.FromJSON UpdateSlidePropertiesRequest
         where
        parseJSON
          = Core.withObject "UpdateSlidePropertiesRequest"
              (\ o ->
                 UpdateSlidePropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "slideProperties"))

instance Core.ToJSON UpdateSlidePropertiesRequest
         where
...
newUpdateSlidesPositionRequest =
  UpdateSlidesPositionRequest
    {insertionIndex = Core.Nothing, slideObjectIds = Core.Nothing}

instance Core.FromJSON UpdateSlidesPositionRequest
         where
        parseJSON
          = Core.withObject "UpdateSlidesPositionRequest"
              (\ o ->
                 UpdateSlidesPositionRequest Core.<$>
                   (o Core..:? "insertionIndex") Core.<*>
                     (o Core..:? "slideObjectIds"))

instance Core.ToJSON UpdateSlidesPositionRequest
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "UpdateTableBorderPropertiesRequest"
              (\ o ->
                 UpdateTableBorderPropertiesRequest Core.<$>
                   (o Core..:? "borderPosition") Core.<*>
                     (o Core..:? "fields")
                     Core.<*> (o Core..:? "objectId")
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "UpdateTableCellPropertiesRequest"
              (\ o ->
                 UpdateTableCellPropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "tableCellProperties")
                     Core.<*> (o Core..:? "tableRange"))

instance Core.ToJSON UpdateTableCellPropertiesRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "UpdateTableRowPropertiesRequest"
              (\ o ->
                 UpdateTableRowPropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "rowIndices")
                     Core.<*> (o Core..:? "tableRowProperties"))

instance Core.ToJSON UpdateTableRowPropertiesRequest
         where
...
instance Core.FromJSON UpdateVideoPropertiesRequest
         where
        parseJSON
          = Core.withObject "UpdateVideoPropertiesRequest"
              (\ o ->
                 UpdateVideoPropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "videoProperties"))

instance Core.ToJSON UpdateVideoPropertiesRequest
         where
...
instance Core.FromJSON VideoProperties where
        parseJSON
          = Core.withObject "VideoProperties"
              (\ o ->
                 VideoProperties Core.<$>
                   (o Core..:? "autoPlay") Core.<*> (o Core..:? "end")
                     Core.<*> (o Core..:? "mute")
                     Core.<*> (o Core..:? "outline")
                     Core.<*> (o Core..:? "start"))
