          ...
          = Core.object
              (Core.catMaybes
                 [("context" Core..=) Core.<$> context,
                  ("cropHintsAnnotation" Core..=) Core.<$>
                    cropHintsAnnotation,
                  ("error" Core..=) Core.<$> error,
                  ("faceAnnotations" Core..=) Core.<$> faceAnnotations,
                  ("fullTextAnnotation" Core..=) Core.<$>
                    fullTextAnnotation,
                  ("imagePropertiesAnnotation" Core..=) Core.<$>
                    imagePropertiesAnnotation,
                  ("labelAnnotations" Core..=) Core.<$>
                    labelAnnotations,
                  ("landmarkAnnotations" Core..=) Core.<$>
                    landmarkAnnotations,
                  ("localizedObjectAnnotations" Core..=) Core.<$>
                    localizedObjectAnnotations,
                  ("logoAnnotations" Core..=) Core.<$> logoAnnotations,
                  ("productSearchResults" Core..=) Core.<$>
                    productSearchResults,
                  ("safeSearchAnnotation" Core..=) Core.<$>
                    safeSearchAnnotation,
...
instance Core.FromJSON AsyncAnnotateFileResponse
         where
        parseJSON
          = Core.withObject "AsyncAnnotateFileResponse"
              (\ o ->
                 AsyncAnnotateFileResponse Core.<$>
                   (o Core..:? "outputConfig"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "AsyncBatchAnnotateFilesResponse"
              (\ o ->
                 AsyncBatchAnnotateFilesResponse Core.<$>
                   (o Core..:? "responses"))

instance Core.ToJSON AsyncBatchAnnotateFilesResponse
         where
...
instance Core.ToJSON AsyncBatchAnnotateImagesResponse
         where
...
instance Core.FromJSON BatchAnnotateFilesResponse
         where
        parseJSON
          = Core.withObject "BatchAnnotateFilesResponse"
              (\ o ->
                 BatchAnnotateFilesResponse Core.<$>
                   (o Core..:? "responses"))
...
newBatchOperationMetadata =
  BatchOperationMetadata
    {endTime = Core.Nothing, state = Core.Nothing, submitTime = Core.Nothing}
          ...
          = Core.withObject "BatchOperationMetadata"
              (\ o ->
                 BatchOperationMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "state")
...
newBoundingPoly 
    ::  BoundingPoly
newBoundingPoly =
  BoundingPoly {normalizedVertices = Core.Nothing, vertices = Core.Nothing}
...
newColorInfo =
  ColorInfo
    {color = Core.Nothing, pixelFraction = Core.Nothing, score = Core.Nothing}
...
newCropHintsAnnotation 
    ::  CropHintsAnnotation
newCropHintsAnnotation = CropHintsAnnotation {cropHints = Core.Nothing}

instance Core.FromJSON CropHintsAnnotation where
        parseJSON
          = Core.withObject "CropHintsAnnotation"
              (\ o ->
                 CropHintsAnnotation Core.<$>
                   (o Core..:? "cropHints"))
...
newDetectedBreak 
    ::  DetectedBreak
newDetectedBreak = DetectedBreak {isPrefix = Core.Nothing, type' = Core.Nothing}
...
newDominantColorsAnnotation 
    ::  DominantColorsAnnotation
newDominantColorsAnnotation = DominantColorsAnnotation {colors = Core.Nothing}

instance Core.FromJSON DominantColorsAnnotation where
        parseJSON
          = Core.withObject "DominantColorsAnnotation"
              (\ o ->
                 DominantColorsAnnotation Core.<$>
                   (o Core..:? "colors"))
...
instance Core.ToJSON FaceAnnotation where
        toJSON FaceAnnotation{..}
          = Core.object
              (Core.catMaybes
                 [("angerLikelihood" Core..=) Core.<$>
                    angerLikelihood,
                  ("blurredLikelihood" Core..=) Core.<$>
                    blurredLikelihood,
                  ("boundingPoly" Core..=) Core.<$> boundingPoly,
                  ("detectionConfidence" Core..=) Core.<$>
                    detectionConfidence,
                  ("fdBoundingPoly" Core..=) Core.<$> fdBoundingPoly,
                  ("headwearLikelihood" Core..=) Core.<$>
                    headwearLikelihood,
                  ("joyLikelihood" Core..=) Core.<$> joyLikelihood,
                  ("landmarkingConfidence" Core..=) Core.<$>
                    landmarkingConfidence,
                  ("landmarks" Core..=) Core.<$> landmarks,
                  ("panAngle" Core..=) Core.<$> panAngle,
                  ("rollAngle" Core..=) Core.<$> rollAngle,
                  ("sorrowLikelihood" Core..=) Core.<$>
                    sorrowLikelihood,
                  ("surpriseLikelihood" Core..=) Core.<$>
                    surpriseLikelihood,
...
instance Core.ToJSON GoogleCloudVisionV1p1beta1Block
         where
...
newGoogleCloudVisionV1p1beta1CropHintsAnnotation 
    ::  GoogleCloudVisionV1p1beta1CropHintsAnnotation
newGoogleCloudVisionV1p1beta1CropHintsAnnotation =
  GoogleCloudVisionV1p1beta1CropHintsAnnotation {cropHints = Core.Nothing}
...
newGoogleCloudVisionV1p1beta1DominantColorsAnnotation 
    ::  GoogleCloudVisionV1p1beta1DominantColorsAnnotation
newGoogleCloudVisionV1p1beta1DominantColorsAnnotation =
  GoogleCloudVisionV1p1beta1DominantColorsAnnotation {colors = Core.Nothing}
...
newGoogleCloudVisionV1p1beta1FaceAnnotationLandmark =
  GoogleCloudVisionV1p1beta1FaceAnnotationLandmark
    {position = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1GcsSource"
              (\ o ->
                 GoogleCloudVisionV1p1beta1GcsSource Core.<$>
                   (o Core..:? "uri"))
...
newGoogleCloudVisionV1p1beta1ImageAnnotationContext =
  GoogleCloudVisionV1p1beta1ImageAnnotationContext
    {pageNumber = Core.Nothing, uri = Core.Nothing}
...
newGoogleCloudVisionV1p1beta1ImageProperties 
    ::  GoogleCloudVisionV1p1beta1ImageProperties
newGoogleCloudVisionV1p1beta1ImageProperties =
  GoogleCloudVisionV1p1beta1ImageProperties {dominantColors = Core.Nothing}
...
newGoogleCloudVisionV1p1beta1InputConfig =
  GoogleCloudVisionV1p1beta1InputConfig
    {content = Core.Nothing, gcsSource = Core.Nothing, mimeType = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON GoogleCloudVisionV1p1beta1LocationInfo{..}
          = Core.object
              (Core.catMaybes [("latLng" Core..=) Core.<$> latLng])
...
newGoogleCloudVisionV1p1beta1OutputConfig =
  GoogleCloudVisionV1p1beta1OutputConfig
    {batchSize = Core.Nothing, gcsDestination = Core.Nothing}
...
instance Core.FromJSON GoogleCloudVisionV1p1beta1Page
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudVisionV1p1beta1Page
         where
...
newGoogleCloudVisionV1p1beta1Position =
  GoogleCloudVisionV1p1beta1Position
    {x = Core.Nothing, y = Core.Nothing, z = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("indexTime" Core..=) Core.<$> indexTime,
                  ("productGroupedResults" Core..=) Core.<$>
...
newGoogleCloudVisionV1p1beta1ProductSearchResultsResult =
  GoogleCloudVisionV1p1beta1ProductSearchResultsResult
    {image = Core.Nothing, product = Core.Nothing, score = Core.Nothing}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVisionV1p1beta1ProductSearchResultsResult
                   Core.<$>
                   (o Core..:? "image") Core.<*> (o Core..:? "product")
                     Core.<*> (o Core..:? "score"))
...
newGoogleCloudVisionV1p1beta1Property =
  GoogleCloudVisionV1p1beta1Property
    {name = Core.Nothing, uint64Value = Core.Nothing, value = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON GoogleCloudVisionV1p1beta1Property{..}
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ("uint64Value" Core..=) Core.. Core.AsText Core.<$>
                    uint64Value,
                  ("value" Core..=) Core.<$> value])
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVisionV1p1beta1SafeSearchAnnotation
                   Core.<$>
                   (o Core..:? "adult") Core.<*> (o Core..:? "medical")
                     Core.<*> (o Core..:? "racy")
                     Core.<*> (o Core..:? "spoof")
...
instance Core.ToJSON GoogleCloudVisionV1p1beta1Symbol
         where
...
newGoogleCloudVisionV1p1beta1TextAnnotation =
  GoogleCloudVisionV1p1beta1TextAnnotation
    {pages = Core.Nothing, text = Core.Nothing}
...
newGoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak =
  GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak
    {isPrefix = Core.Nothing, type' = Core.Nothing}
...
newGoogleCloudVisionV1p1beta1TextAnnotationTextProperty =
  GoogleCloudVisionV1p1beta1TextAnnotationTextProperty
    {detectedBreak = Core.Nothing, detectedLanguages = Core.Nothing}
...
newGoogleCloudVisionV1p1beta1Vertex 
    ::  GoogleCloudVisionV1p1beta1Vertex
newGoogleCloudVisionV1p1beta1Vertex =
  GoogleCloudVisionV1p1beta1Vertex {x = Core.Nothing, y = Core.Nothing}
...
instance Core.ToJSON GoogleCloudVisionV1p1beta1Vertex
         where
...
instance Core.ToJSON
        ...
        toJSON GoogleCloudVisionV1p1beta1WebDetection{..}
          = Core.object
              (Core.catMaybes
                 [("bestGuessLabels" Core..=) Core.<$>
                    bestGuessLabels,
                  ("fullMatchingImages" Core..=) Core.<$>
                    fullMatchingImages,
                  ("pagesWithMatchingImages" Core..=) Core.<$>
                    pagesWithMatchingImages,
                  ("partialMatchingImages" Core..=) Core.<$>
                    partialMatchingImages,
                  ("visuallySimilarImages" Core..=) Core.<$>
...
newGoogleCloudVisionV1p1beta1WebDetectionWebEntity =
  GoogleCloudVisionV1p1beta1WebDetectionWebEntity
    {description = Core.Nothing, entityId = Core.Nothing, score = Core.Nothing}
...
newGoogleCloudVisionV1p1beta1WebDetectionWebLabel =
  GoogleCloudVisionV1p1beta1WebDetectionWebLabel
    {label = Core.Nothing, languageCode = Core.Nothing}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVisionV1p1beta1WebDetectionWebPage
                   Core.<$>
                   (o Core..:? "fullMatchingImages") Core.<*>
                     (o Core..:? "pageTitle")
                     Core.<*> (o Core..:? "partialMatchingImages")
                     Core.<*> (o Core..:? "score")
                     Core.<*> (o Core..:? "url"))
...
instance Core.FromJSON GoogleCloudVisionV1p1beta1Word
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudVisionV1p1beta1Word
         where
...
newGoogleCloudVisionV1p2beta1AnnotateImageRequest =
  GoogleCloudVisionV1p2beta1AnnotateImageRequest
    {features = Core.Nothing, image = Core.Nothing, imageContext = Core.Nothing}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVisionV1p2beta1AnnotateImageRequest
                   Core.<$>
                   (o Core..:? "features") Core.<*> (o Core..:? "image")
...
newGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest =
  GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest
    {parent = Core.Nothing, requests = Core.Nothing}
...
instance Core.ToJSON GoogleCloudVisionV1p2beta1Block
         where
...
newGoogleCloudVisionV1p2beta1CropHintsAnnotation 
    ::  GoogleCloudVisionV1p2beta1CropHintsAnnotation
newGoogleCloudVisionV1p2beta1CropHintsAnnotation =
  GoogleCloudVisionV1p2beta1CropHintsAnnotation {cropHints = Core.Nothing}
...
newGoogleCloudVisionV1p2beta1CropHintsParams 
    ::  GoogleCloudVisionV1p2beta1CropHintsParams
newGoogleCloudVisionV1p2beta1CropHintsParams =
  GoogleCloudVisionV1p2beta1CropHintsParams {aspectRatios = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON GoogleCloudVisionV1p2beta1CropHintsParams{..}
          = Core.object
              (Core.catMaybes
                 [("aspectRatios" Core..=) Core.<$> aspectRatios])
...
newGoogleCloudVisionV1p2beta1DominantColorsAnnotation 
    ::  GoogleCloudVisionV1p2beta1DominantColorsAnnotation
newGoogleCloudVisionV1p2beta1DominantColorsAnnotation =
  GoogleCloudVisionV1p2beta1DominantColorsAnnotation {colors = Core.Nothing}
...
newGoogleCloudVisionV1p2beta1Feature =
  GoogleCloudVisionV1p2beta1Feature
    {maxResults = Core.Nothing, model = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1GcsSource"
              (\ o ->
                 GoogleCloudVisionV1p2beta1GcsSource Core.<$>
                   (o Core..:? "uri"))
...
newGoogleCloudVisionV1p2beta1Image =
  GoogleCloudVisionV1p2beta1Image
    {content = Core.Nothing, source = Core.Nothing}
...
instance Core.ToJSON GoogleCloudVisionV1p2beta1Image
         where
...
instance Core.ToJSON
        ...
        toJSON GoogleCloudVisionV1p2beta1ImageContext{..}
          = Core.object
              (Core.catMaybes
                 [("cropHintsParams" Core..=) Core.<$>
                    cropHintsParams,
                  ("languageHints" Core..=) Core.<$> languageHints,
                  ("latLongRect" Core..=) Core.<$> latLongRect,
                  ("productSearchParams" Core..=) Core.<$>
                    productSearchParams,
                  ("textDetectionParams" Core..=) Core.<$>
                    textDetectionParams,
                  ("webDetectionParams" Core..=) Core.<$>
                    webDetectionParams])
...
newGoogleCloudVisionV1p2beta1ImageProperties 
    ::  GoogleCloudVisionV1p2beta1ImageProperties
newGoogleCloudVisionV1p2beta1ImageProperties =
  GoogleCloudVisionV1p2beta1ImageProperties {dominantColors = Core.Nothing}
...
newGoogleCloudVisionV1p2beta1ImageSource =
  GoogleCloudVisionV1p2beta1ImageSource
    {gcsImageUri = Core.Nothing, imageUri = Core.Nothing}
...
newGoogleCloudVisionV1p2beta1LatLongRect =
  GoogleCloudVisionV1p2beta1LatLongRect
    {maxLatLng = Core.Nothing, minLatLng = Core.Nothing}
...
instance Core.FromJSON GoogleCloudVisionV1p2beta1Page
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudVisionV1p2beta1Page
         where
...
instance Core.ToJSON GoogleCloudVisionV1p2beta1Symbol
         where
...
newGoogleCloudVisionV1p2beta1Vertex 
    ::  GoogleCloudVisionV1p2beta1Vertex
newGoogleCloudVisionV1p2beta1Vertex =
  GoogleCloudVisionV1p2beta1Vertex {x = Core.Nothing, y = Core.Nothing}
...
instance Core.ToJSON GoogleCloudVisionV1p2beta1Vertex
         where
...
newGoogleCloudVisionV1p2beta1WebDetectionParams =
  GoogleCloudVisionV1p2beta1WebDetectionParams
    {includeGeoResults = Core.Nothing}
...
instance Core.FromJSON GoogleCloudVisionV1p2beta1Word
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudVisionV1p2beta1Word
         where
...
instance Core.ToJSON GoogleCloudVisionV1p3beta1Block
         where
...
newGoogleCloudVisionV1p3beta1CropHintsAnnotation 
    ::  GoogleCloudVisionV1p3beta1CropHintsAnnotation
newGoogleCloudVisionV1p3beta1CropHintsAnnotation =
  GoogleCloudVisionV1p3beta1CropHintsAnnotation {cropHints = Core.Nothing}
...
newGoogleCloudVisionV1p3beta1DominantColorsAnnotation 
    ::  GoogleCloudVisionV1p3beta1DominantColorsAnnotation
newGoogleCloudVisionV1p3beta1DominantColorsAnnotation =
  GoogleCloudVisionV1p3beta1DominantColorsAnnotation {colors = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1GcsSource"
              (\ o ->
                 GoogleCloudVisionV1p3beta1GcsSource Core.<$>
                   (o Core..:? "uri"))
...
newGoogleCloudVisionV1p3beta1ImageProperties 
    ::  GoogleCloudVisionV1p3beta1ImageProperties
newGoogleCloudVisionV1p3beta1ImageProperties =
  GoogleCloudVisionV1p3beta1ImageProperties {dominantColors = Core.Nothing}
...
newGoogleCloudVisionV1p3beta1ImportProductSetsResponse =
  GoogleCloudVisionV1p3beta1ImportProductSetsResponse
    {referenceImages = Core.Nothing, statuses = Core.Nothing}
...
instance Core.FromJSON GoogleCloudVisionV1p3beta1Page
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudVisionV1p3beta1Page
         where
...
newGoogleCloudVisionV1p3beta1ReferenceImage =
  GoogleCloudVisionV1p3beta1ReferenceImage
    {boundingPolys = Core.Nothing, name = Core.Nothing, uri = Core.Nothing}
...
instance Core.ToJSON GoogleCloudVisionV1p3beta1Symbol
         where
...
newGoogleCloudVisionV1p3beta1Vertex 
    ::  GoogleCloudVisionV1p3beta1Vertex
newGoogleCloudVisionV1p3beta1Vertex =
  GoogleCloudVisionV1p3beta1Vertex {x = Core.Nothing, y = Core.Nothing}
...
instance Core.ToJSON GoogleCloudVisionV1p3beta1Vertex
         where
...
instance Core.FromJSON GoogleCloudVisionV1p3beta1Word
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudVisionV1p3beta1Word
         where
...
instance Core.ToJSON GoogleCloudVisionV1p4beta1Block
         where
...
newGoogleCloudVisionV1p4beta1CropHintsAnnotation 
    ::  GoogleCloudVisionV1p4beta1CropHintsAnnotation
newGoogleCloudVisionV1p4beta1CropHintsAnnotation =
  GoogleCloudVisionV1p4beta1CropHintsAnnotation {cropHints = Core.Nothing}
...
newGoogleCloudVisionV1p4beta1DominantColorsAnnotation 
    ::  GoogleCloudVisionV1p4beta1DominantColorsAnnotation
newGoogleCloudVisionV1p4beta1DominantColorsAnnotation =
  GoogleCloudVisionV1p4beta1DominantColorsAnnotation {colors = Core.Nothing}
...
newGoogleCloudVisionV1p4beta1FaceRecognitionResult =
  GoogleCloudVisionV1p4beta1FaceRecognitionResult
    {celebrity = Core.Nothing, confidence = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1GcsSource"
              (\ o ->
                 GoogleCloudVisionV1p4beta1GcsSource Core.<$>
                   (o Core..:? "uri"))
...
newGoogleCloudVisionV1p4beta1ImageProperties 
    ::  GoogleCloudVisionV1p4beta1ImageProperties
newGoogleCloudVisionV1p4beta1ImageProperties =
  GoogleCloudVisionV1p4beta1ImageProperties {dominantColors = Core.Nothing}
...
instance Core.FromJSON GoogleCloudVisionV1p4beta1Page
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudVisionV1p4beta1Page
         where
...
instance Core.ToJSON GoogleCloudVisionV1p4beta1Symbol
         where
...
newGoogleCloudVisionV1p4beta1Vertex 
    ::  GoogleCloudVisionV1p4beta1Vertex
newGoogleCloudVisionV1p4beta1Vertex =
  GoogleCloudVisionV1p4beta1Vertex {x = Core.Nothing, y = Core.Nothing}
...
instance Core.ToJSON GoogleCloudVisionV1p4beta1Vertex
         where
...
instance Core.FromJSON GoogleCloudVisionV1p4beta1Word
         where
        parseJSON
...
instance Core.ToJSON GoogleCloudVisionV1p4beta1Word
         where
...
newImageAnnotationContext 
    ::  ImageAnnotationContext
newImageAnnotationContext =
  ImageAnnotationContext {pageNumber = Core.Nothing, uri = Core.Nothing}
...
instance Core.FromJSON ImportProductSetsResponse
         where
        parseJSON
...
newLandmark 
    ::  Landmark
newLandmark = Landmark {position = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON LocalizedObjectAnnotation
         where
        parseJSON
...
newNormalizedVertex 
    ::  NormalizedVertex
newNormalizedVertex = NormalizedVertex {x = Core.Nothing, y = Core.Nothing}
...
newOutputConfig 
    ::  OutputConfig
newOutputConfig =
  OutputConfig {batchSize = Core.Nothing, gcsDestination = Core.Nothing}
...
newPosition 
    ::  Position
newPosition = Position {x = Core.Nothing, y = Core.Nothing, z = Core.Nothing}
...
newResult 
    ::  Result
newResult =
  Result {image = Core.Nothing, product = Core.Nothing, score = Core.Nothing}
...
newTextAnnotation 
    ::  TextAnnotation
newTextAnnotation = TextAnnotation {pages = Core.Nothing, text = Core.Nothing}
...
newTextProperty 
    ::  TextProperty
newTextProperty =
  TextProperty {detectedBreak = Core.Nothing, detectedLanguages = Core.Nothing}
...
newWebLabel 
    ::  WebLabel
newWebLabel = WebLabel {label = Core.Nothing, languageCode = Core.Nothing}
