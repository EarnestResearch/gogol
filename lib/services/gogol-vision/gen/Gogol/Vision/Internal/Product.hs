...
newAnnotateFileResponse 
    ::  AnnotateFileResponse
newAnnotateFileResponse
  = AnnotateFileResponse{error = Core.Nothing,
                         inputConfig = Core.Nothing, responses = Core.Nothing,
                         totalPages = Core.Nothing}
instance Core.FromJSON AnnotateFileResponse where
        parseJSON
          = Core.withObject "AnnotateFileResponse"
              (\ o ->
                 AnnotateFileResponse Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "inputConfig") Core.<*>
                     (o Core..:? "responses")
...
newAnnotateImageResponse 
    ::  AnnotateImageResponse
newAnnotateImageResponse
  = AnnotateImageResponse{context = Core.Nothing,
                          cropHintsAnnotation = Core.Nothing, error = Core.Nothing,
                          faceAnnotations = Core.Nothing, fullTextAnnotation = Core.Nothing,
                          ...
                          textAnnotations = Core.Nothing, webDetection = Core.Nothing}
instance Core.FromJSON AnnotateImageResponse where
        parseJSON
          = Core.withObject "AnnotateImageResponse"
              (\ o ->
                 AnnotateImageResponse Core.<$>
                   (o Core..:? "context") Core.<*> (o Core..:? "cropHintsAnnotation")
                     Core.<*> (o Core..:? "error")
...
instance Core.FromJSON AsyncAnnotateFileResponse where
        parseJSON
          = Core.withObject "AsyncAnnotateFileResponse"
              (\ o ->
...
instance Core.FromJSON AsyncBatchAnnotateFilesResponse where
        parseJSON
          = Core.withObject "AsyncBatchAnnotateFilesResponse"
              (\ o ->
...
instance Core.FromJSON AsyncBatchAnnotateImagesResponse where
        parseJSON
          = Core.withObject "AsyncBatchAnnotateImagesResponse"
              (\ o ->
                 AsyncBatchAnnotateImagesResponse Core.<$>
                   (o Core..:? "outputConfig"))
...
instance Core.FromJSON BatchAnnotateFilesResponse where
        parseJSON
          = Core.withObject "BatchAnnotateFilesResponse"
              (\ o ->
...
newBatchOperationMetadata 
    ::  BatchOperationMetadata
newBatchOperationMetadata
  = BatchOperationMetadata{endTime = Core.Nothing,
                           state = Core.Nothing, submitTime = Core.Nothing}
instance Core.FromJSON BatchOperationMetadata where
        parseJSON
          = Core.withObject "BatchOperationMetadata"
              (\ o ->
                 BatchOperationMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "submitTime"))
...
newBlock 
    ::  Block
newBlock
  = Block{blockType = Core.Nothing, boundingBox = Core.Nothing,
          confidence = Core.Nothing, paragraphs = Core.Nothing,
          property = Core.Nothing}
instance Core.FromJSON Block where
        parseJSON
          = Core.withObject "Block"
              (\ o ->
                 Block Core.<$>
                   (o Core..:? "blockType") Core.<*> (o Core..:? "boundingBox")
...
newBoundingPoly 
    ::  BoundingPoly
newBoundingPoly
  = BoundingPoly{normalizedVertices = Core.Nothing,
                 vertices = Core.Nothing}
instance Core.FromJSON BoundingPoly where
        parseJSON
          = Core.withObject "BoundingPoly"
              (\ o ->
                 BoundingPoly Core.<$>
                   (o Core..:? "normalizedVertices") Core.<*> (o Core..:? "vertices"))
...
newColor 
    ::  Color
newColor
  = Color{alpha = Core.Nothing, blue = Core.Nothing,
...
instance Core.FromJSON Color where
        parseJSON
          = Core.withObject "Color"
              (\ o ->
                 Color Core.<$>
                   (o Core..:? "alpha") Core.<*> (o Core..:? "blue") Core.<*>
                     (o Core..:? "green")
                     Core.<*> (o Core..:? "red"))
...
instance Core.ToJSON Color where
        toJSON Color{..}
          = Core.object
              (Core.catMaybes
                 [("alpha" Core..=) Core.<$> alpha, ("blue" Core..=) Core.<$> blue,
                  ("green" Core..=) Core.<$> green, ("red" Core..=) Core.<$> red])
...
newColorInfo 
    ::  ColorInfo
newColorInfo
  = ColorInfo{color = Core.Nothing, pixelFraction = Core.Nothing,
              score = Core.Nothing}
instance Core.FromJSON ColorInfo where
        parseJSON
          = Core.withObject "ColorInfo"
              (\ o ->
                 ColorInfo Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "pixelFraction") Core.<*>
                     (o Core..:? "score"))
...
newCropHint 
    ::  CropHint
newCropHint
  = CropHint{boundingPoly = Core.Nothing, confidence = Core.Nothing,
             importanceFraction = Core.Nothing}
instance Core.FromJSON CropHint where
        parseJSON
          = Core.withObject "CropHint"
              (\ o ->
                 CropHint Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "confidence")
...
instance Core.FromJSON CropHintsAnnotation where
        parseJSON
          = Core.withObject "CropHintsAnnotation"
...
instance Core.FromJSON DetectedBreak where
        parseJSON
          = Core.withObject "DetectedBreak"
              (\ o ->
                 DetectedBreak Core.<$>
                   (o Core..:? "isPrefix") Core.<*> (o Core..:? "type"))
...
newDetectedLanguage 
    ::  DetectedLanguage
newDetectedLanguage
  = DetectedLanguage{confidence = Core.Nothing,
                     languageCode = Core.Nothing}
instance Core.FromJSON DetectedLanguage where
        parseJSON
          = Core.withObject "DetectedLanguage"
              (\ o ->
                 DetectedLanguage Core.<$>
                   (o Core..:? "confidence") Core.<*> (o Core..:? "languageCode"))
...
instance Core.FromJSON DominantColorsAnnotation where
        parseJSON
          = Core.withObject "DominantColorsAnnotation"
...
newEntityAnnotation 
    ::  EntityAnnotation
newEntityAnnotation
  = EntityAnnotation{boundingPoly = Core.Nothing,
                     confidence = Core.Nothing, description = Core.Nothing,
                     locale = Core.Nothing, locations = Core.Nothing,
                     mid = Core.Nothing, properties = Core.Nothing,
                     score = Core.Nothing, topicality = Core.Nothing}
instance Core.FromJSON EntityAnnotation where
        parseJSON
          = Core.withObject "EntityAnnotation"
              (\ o ->
                 EntityAnnotation Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "confidence")
...
newFaceAnnotation 
    ::  FaceAnnotation
newFaceAnnotation
  = FaceAnnotation{angerLikelihood = Core.Nothing,
                   blurredLikelihood = Core.Nothing, boundingPoly = Core.Nothing,
                   detectionConfidence = Core.Nothing, fdBoundingPoly = Core.Nothing,
                   headwearLikelihood = Core.Nothing, joyLikelihood = Core.Nothing,
                   landmarkingConfidence = Core.Nothing, landmarks = Core.Nothing,
                   panAngle = Core.Nothing, rollAngle = Core.Nothing,
                   sorrowLikelihood = Core.Nothing, surpriseLikelihood = Core.Nothing,
                   tiltAngle = Core.Nothing, underExposedLikelihood = Core.Nothing}
instance Core.FromJSON FaceAnnotation where
        parseJSON
          = Core.withObject "FaceAnnotation"
              (\ o ->
                 FaceAnnotation Core.<$>
                   (o Core..:? "angerLikelihood") Core.<*>
                     (o Core..:? "blurredLikelihood")
          ...
          = Core.object
              (Core.catMaybes
                 [("angerLikelihood" Core..=) Core.<$> angerLikelihood,
                  ...
                  ("underExposedLikelihood" Core..=) Core.<$>
...
newGoogleCloudVisionV1p1beta1AnnotateFileResponse 
    :: 
                                                  GoogleCloudVisionV1p1beta1AnnotateFileResponse
newGoogleCloudVisionV1p1beta1AnnotateFileResponse
  = GoogleCloudVisionV1p1beta1AnnotateFileResponse{error =
                                                     Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1AnnotateFileResponse"
              (\ o ->
                 GoogleCloudVisionV1p1beta1AnnotateFileResponse Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "inputConfig") Core.<*>
                     (o Core..:? "responses")
                     Core.<*> (o Core..:? "totalPages"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1AnnotateFileResponse
         where
...
newGoogleCloudVisionV1p1beta1AnnotateImageResponse 
    :: 
                                                   GoogleCloudVisionV1p1beta1AnnotateImageResponse
newGoogleCloudVisionV1p1beta1AnnotateImageResponse
  = GoogleCloudVisionV1p1beta1AnnotateImageResponse{context =
                                                      Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1AnnotateImageResponse"
              (\ o ->
                 GoogleCloudVisionV1p1beta1AnnotateImageResponse Core.<$>
                   (o Core..:? "context") Core.<*> (o Core..:? "cropHintsAnnotation")
                     Core.<*> (o Core..:? "error")
                     Core.<*> (o Core..:? "faceAnnotations")
                     Core.<*> (o Core..:? "fullTextAnnotation")
...
newGoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse 
    :: 
                                                       GoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse
newGoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse
  = GoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse{outputConfig
                                                          = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse"
              (\ o ->
                 GoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse Core.<$>
                   (o Core..:? "outputConfig"))
...
newGoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesResponse 
    :: 
                                                             GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesResponse
newGoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesResponse
  = GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesResponse{responses
                                                                = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesResponse"
              (\ o ->
                 GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesResponse Core.<$>
                   (o Core..:? "responses"))
...
newGoogleCloudVisionV1p1beta1Block 
    :: 
                                   GoogleCloudVisionV1p1beta1Block
newGoogleCloudVisionV1p1beta1Block
  = GoogleCloudVisionV1p1beta1Block{blockType = Core.Nothing,
                                    boundingBox = Core.Nothing, confidence = Core.Nothing,
                                    paragraphs = Core.Nothing, property = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1Block where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1Block"
              (\ o ->
                 GoogleCloudVisionV1p1beta1Block Core.<$>
                   (o Core..:? "blockType") Core.<*> (o Core..:? "boundingBox")
                     Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "paragraphs")
                     Core.<*> (o Core..:? "property"))
...
newGoogleCloudVisionV1p1beta1BoundingPoly 
    :: 
                                          GoogleCloudVisionV1p1beta1BoundingPoly
newGoogleCloudVisionV1p1beta1BoundingPoly
  = GoogleCloudVisionV1p1beta1BoundingPoly{normalizedVertices =
                                             Core.Nothing,
                                           vertices = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1BoundingPoly where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1BoundingPoly"
              (\ o ->
                 GoogleCloudVisionV1p1beta1BoundingPoly Core.<$>
                   (o Core..:? "normalizedVertices") Core.<*> (o Core..:? "vertices"))
...
newGoogleCloudVisionV1p1beta1ColorInfo 
    :: 
                                       GoogleCloudVisionV1p1beta1ColorInfo
newGoogleCloudVisionV1p1beta1ColorInfo
  = GoogleCloudVisionV1p1beta1ColorInfo{color = Core.Nothing,
                                        pixelFraction = Core.Nothing, score = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1ColorInfo where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1ColorInfo"
              (\ o ->
                 GoogleCloudVisionV1p1beta1ColorInfo Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "pixelFraction") Core.<*>
                     (o Core..:? "score"))
...
newGoogleCloudVisionV1p1beta1CropHint 
    :: 
                                      GoogleCloudVisionV1p1beta1CropHint
newGoogleCloudVisionV1p1beta1CropHint
  = GoogleCloudVisionV1p1beta1CropHint{boundingPoly = Core.Nothing,
                                       confidence = Core.Nothing, importanceFraction = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1CropHint where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1CropHint"
              (\ o ->
                 GoogleCloudVisionV1p1beta1CropHint Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "importanceFraction"))
...
newGoogleCloudVisionV1p1beta1CropHintsAnnotation 
    :: 
                                                 GoogleCloudVisionV1p1beta1CropHintsAnnotation
newGoogleCloudVisionV1p1beta1CropHintsAnnotation
  = GoogleCloudVisionV1p1beta1CropHintsAnnotation{cropHints =
                                                    Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1CropHintsAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1CropHintsAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p1beta1CropHintsAnnotation Core.<$>
                   (o Core..:? "cropHints"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1CropHintsAnnotation
         where
...
newGoogleCloudVisionV1p1beta1DominantColorsAnnotation 
    :: 
                                                      GoogleCloudVisionV1p1beta1DominantColorsAnnotation
newGoogleCloudVisionV1p1beta1DominantColorsAnnotation
  = GoogleCloudVisionV1p1beta1DominantColorsAnnotation{colors =
                                                         Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1DominantColorsAnnotation
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1DominantColorsAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p1beta1DominantColorsAnnotation Core.<$>
                   (o Core..:? "colors"))
...
newGoogleCloudVisionV1p1beta1EntityAnnotation 
    :: 
                                              GoogleCloudVisionV1p1beta1EntityAnnotation
newGoogleCloudVisionV1p1beta1EntityAnnotation
  = GoogleCloudVisionV1p1beta1EntityAnnotation{boundingPoly =
                                                 Core.Nothing,
                                               confidence = Core.Nothing,
                                               description = Core.Nothing, locale = Core.Nothing,
                                               locations = Core.Nothing, mid = Core.Nothing,
                                               properties = Core.Nothing, score = Core.Nothing,
                                               topicality = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1EntityAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1EntityAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p1beta1EntityAnnotation Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "locale")
                     Core.<*> (o Core..:? "locations")
...
instance Core.ToJSON GoogleCloudVisionV1p1beta1EntityAnnotation
         where
...
newGoogleCloudVisionV1p1beta1FaceAnnotation 
    :: 
                                            GoogleCloudVisionV1p1beta1FaceAnnotation
newGoogleCloudVisionV1p1beta1FaceAnnotation
  = GoogleCloudVisionV1p1beta1FaceAnnotation{angerLikelihood =
                                               Core.Nothing,
                                             ...
                                             landmarks = Core.Nothing, panAngle = Core.Nothing,
...
instance Core.FromJSON GoogleCloudVisionV1p1beta1FaceAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1FaceAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p1beta1FaceAnnotation Core.<$>
                   (o Core..:? "angerLikelihood") Core.<*>
                     (o Core..:? "blurredLikelihood")
                     Core.<*> (o Core..:? "boundingPoly")
                     Core.<*> (o Core..:? "detectionConfidence")
...
newGoogleCloudVisionV1p1beta1FaceAnnotationLandmark 
    :: 
                                                    GoogleCloudVisionV1p1beta1FaceAnnotationLandmark
newGoogleCloudVisionV1p1beta1FaceAnnotationLandmark
  = GoogleCloudVisionV1p1beta1FaceAnnotationLandmark{position =
                                                       Core.Nothing,
                                                     type' = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1FaceAnnotationLandmark
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1FaceAnnotationLandmark"
              (\ o ->
                 GoogleCloudVisionV1p1beta1FaceAnnotationLandmark Core.<$>
                   (o Core..:? "position") Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON GoogleCloudVisionV1p1beta1GcsDestination
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1GcsDestination"
              (\ o ->
                 GoogleCloudVisionV1p1beta1GcsDestination Core.<$>
                   (o Core..:? "uri"))
...
instance Core.FromJSON GoogleCloudVisionV1p1beta1GcsSource where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1GcsSource"
              (\ o ->
...
newGoogleCloudVisionV1p1beta1ImageAnnotationContext 
    :: 
                                                    GoogleCloudVisionV1p1beta1ImageAnnotationContext
newGoogleCloudVisionV1p1beta1ImageAnnotationContext
  = GoogleCloudVisionV1p1beta1ImageAnnotationContext{pageNumber =
                                                       Core.Nothing,
                                                     uri = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1ImageAnnotationContext
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1ImageAnnotationContext"
              (\ o ->
                 GoogleCloudVisionV1p1beta1ImageAnnotationContext Core.<$>
                   (o Core..:? "pageNumber") Core.<*> (o Core..:? "uri"))
...
newGoogleCloudVisionV1p1beta1ImageProperties 
    :: 
                                             GoogleCloudVisionV1p1beta1ImageProperties
newGoogleCloudVisionV1p1beta1ImageProperties
  = GoogleCloudVisionV1p1beta1ImageProperties{dominantColors =
                                                Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1ImageProperties
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1ImageProperties"
              (\ o ->
                 GoogleCloudVisionV1p1beta1ImageProperties Core.<$>
                   (o Core..:? "dominantColors"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1ImageProperties
         where
...
newGoogleCloudVisionV1p1beta1InputConfig 
    :: 
                                         GoogleCloudVisionV1p1beta1InputConfig
newGoogleCloudVisionV1p1beta1InputConfig
  = GoogleCloudVisionV1p1beta1InputConfig{content = Core.Nothing,
                                          gcsSource = Core.Nothing, mimeType = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1InputConfig where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1InputConfig"
              (\ o ->
                 GoogleCloudVisionV1p1beta1InputConfig Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "gcsSource") Core.<*>
                     (o Core..:? "mimeType"))
...
newGoogleCloudVisionV1p1beta1LocalizedObjectAnnotation 
    :: 
                                                       GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation
newGoogleCloudVisionV1p1beta1LocalizedObjectAnnotation
  = GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation{boundingPoly
                                                          = Core.Nothing,
                                                        languageCode = Core.Nothing,
                                                        mid = Core.Nothing, name = Core.Nothing,
                                                        score = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "mid")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "score"))
        ...
        toJSON GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation{..}
          = Core.object
              (Core.catMaybes
                 [("boundingPoly" Core..=) Core.<$> boundingPoly,
                  ("languageCode" Core..=) Core.<$> languageCode,
                  ("mid" Core..=) Core.<$> mid, ("name" Core..=) Core.<$> name,
                  ("score" Core..=) Core.<$> score])
...
instance Core.FromJSON GoogleCloudVisionV1p1beta1LocationInfo where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1LocationInfo"
              (\ o ->
                 GoogleCloudVisionV1p1beta1LocationInfo Core.<$>
                   (o Core..:? "latLng"))
...
newGoogleCloudVisionV1p1beta1NormalizedVertex 
    :: 
                                              GoogleCloudVisionV1p1beta1NormalizedVertex
newGoogleCloudVisionV1p1beta1NormalizedVertex
  = GoogleCloudVisionV1p1beta1NormalizedVertex{x = Core.Nothing,
                                               y = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1NormalizedVertex
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1NormalizedVertex"
              (\ o ->
                 GoogleCloudVisionV1p1beta1NormalizedVertex Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1NormalizedVertex
         where
...
newGoogleCloudVisionV1p1beta1OperationMetadata 
    :: 
                                               GoogleCloudVisionV1p1beta1OperationMetadata
newGoogleCloudVisionV1p1beta1OperationMetadata
  = GoogleCloudVisionV1p1beta1OperationMetadata{createTime =
                                                  Core.Nothing,
                                                state = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1OperationMetadata
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1OperationMetadata"
              (\ o ->
                 GoogleCloudVisionV1p1beta1OperationMetadata Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "updateTime"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1OperationMetadata
         where
...
newGoogleCloudVisionV1p1beta1OutputConfig 
    :: 
                                          GoogleCloudVisionV1p1beta1OutputConfig
newGoogleCloudVisionV1p1beta1OutputConfig
  = GoogleCloudVisionV1p1beta1OutputConfig{batchSize = Core.Nothing,
                                           gcsDestination = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1OutputConfig where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1OutputConfig"
              (\ o ->
                 GoogleCloudVisionV1p1beta1OutputConfig Core.<$>
                   (o Core..:? "batchSize") Core.<*> (o Core..:? "gcsDestination"))
...
newGoogleCloudVisionV1p1beta1Page 
    ::  GoogleCloudVisionV1p1beta1Page
newGoogleCloudVisionV1p1beta1Page
  = GoogleCloudVisionV1p1beta1Page{blocks = Core.Nothing,
                                   confidence = Core.Nothing, height = Core.Nothing,
                                   property = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1Page where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1Page"
              (\ o ->
                 GoogleCloudVisionV1p1beta1Page Core.<$>
                   (o Core..:? "blocks") Core.<*> (o Core..:? "confidence") Core.<*>
                     (o Core..:? "height")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "width"))
...
newGoogleCloudVisionV1p1beta1Paragraph 
    :: 
                                       GoogleCloudVisionV1p1beta1Paragraph
newGoogleCloudVisionV1p1beta1Paragraph
  = GoogleCloudVisionV1p1beta1Paragraph{boundingBox = Core.Nothing,
                                        confidence = Core.Nothing, property = Core.Nothing,
                                        words = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1Paragraph where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1Paragraph"
              (\ o ->
                 GoogleCloudVisionV1p1beta1Paragraph Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "words"))
...
newGoogleCloudVisionV1p1beta1Position 
    :: 
                                      GoogleCloudVisionV1p1beta1Position
newGoogleCloudVisionV1p1beta1Position
  = GoogleCloudVisionV1p1beta1Position{x = Core.Nothing,
                                       y = Core.Nothing, z = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1Position where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1Position"
              (\ o ->
                 GoogleCloudVisionV1p1beta1Position Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y") Core.<*>
                     (o Core..:? "z"))
...
newGoogleCloudVisionV1p1beta1Product 
    :: 
                                     GoogleCloudVisionV1p1beta1Product
newGoogleCloudVisionV1p1beta1Product
  = GoogleCloudVisionV1p1beta1Product{description = Core.Nothing,
                                      displayName = Core.Nothing, name = Core.Nothing,
                                      productCategory = Core.Nothing, productLabels = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1Product where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1Product"
              (\ o ->
                 GoogleCloudVisionV1p1beta1Product Core.<$>
...
newGoogleCloudVisionV1p1beta1ProductKeyValue 
    :: 
                                             GoogleCloudVisionV1p1beta1ProductKeyValue
newGoogleCloudVisionV1p1beta1ProductKeyValue
  = GoogleCloudVisionV1p1beta1ProductKeyValue{key = Core.Nothing,
                                              value = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1ProductKeyValue
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1ProductKeyValue"
              (\ o ->
                 GoogleCloudVisionV1p1beta1ProductKeyValue Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "value"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1ProductKeyValue
         where
...
data GoogleCloudVisionV1p1beta1ProductSearchResults = GoogleCloudVisionV1p1beta1ProductSearchResults
    ...
    , productGroupedResults :: (Core.Maybe
   [GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult])
...
newGoogleCloudVisionV1p1beta1ProductSearchResults 
    :: 
                                                  GoogleCloudVisionV1p1beta1ProductSearchResults
newGoogleCloudVisionV1p1beta1ProductSearchResults
  = GoogleCloudVisionV1p1beta1ProductSearchResults{indexTime =
                                                     Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1ProductSearchResults"
              (\ o ->
                 GoogleCloudVisionV1p1beta1ProductSearchResults Core.<$>
                   (o Core..:? "indexTime") Core.<*>
                     (o Core..:? "productGroupedResults")
                     Core.<*> (o Core..:? "results"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1ProductSearchResults
         where
...
newGoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult 
    :: 
                                                               GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult
newGoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult
  = GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult{boundingPoly
                                                                  = Core.Nothing,
...
newGoogleCloudVisionV1p1beta1ProductSearchResultsObjectAnnotation 
    :: 
                                                                  GoogleCloudVisionV1p1beta1ProductSearchResultsObjectAnnotation
newGoogleCloudVisionV1p1beta1ProductSearchResultsObjectAnnotation
  = GoogleCloudVisionV1p1beta1ProductSearchResultsObjectAnnotation{languageCode
                                                                     = Core.Nothing,
                                                                   mid = Core.Nothing,
                                                                   name = Core.Nothing,
                                                                   score = Core.Nothing}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVisionV1p1beta1ProductSearchResultsObjectAnnotation
                   Core.<$>
                   (o Core..:? "languageCode") Core.<*> (o Core..:? "mid") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "score"))
...
newGoogleCloudVisionV1p1beta1ProductSearchResultsResult 
    :: 
                                                        GoogleCloudVisionV1p1beta1ProductSearchResultsResult
newGoogleCloudVisionV1p1beta1ProductSearchResultsResult
  = GoogleCloudVisionV1p1beta1ProductSearchResultsResult{image =
                                                           Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1ProductSearchResultsResult"
              (\ o ->
                 GoogleCloudVisionV1p1beta1ProductSearchResultsResult Core.<$>
                   (o Core..:? "image") Core.<*> (o Core..:? "product") Core.<*>
                     (o Core..:? "score"))
...
newGoogleCloudVisionV1p1beta1Property 
    :: 
                                      GoogleCloudVisionV1p1beta1Property
newGoogleCloudVisionV1p1beta1Property
  = GoogleCloudVisionV1p1beta1Property{name = Core.Nothing,
                                       uint64Value = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1Property where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1Property"
              (\ o ->
                 GoogleCloudVisionV1p1beta1Property Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "uint64Value" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "value"))
...
newGoogleCloudVisionV1p1beta1SafeSearchAnnotation 
    :: 
                                                  GoogleCloudVisionV1p1beta1SafeSearchAnnotation
newGoogleCloudVisionV1p1beta1SafeSearchAnnotation
  = GoogleCloudVisionV1p1beta1SafeSearchAnnotation{adult =
                                                     Core.Nothing,
                                                   medical = Core.Nothing, racy = Core.Nothing,
                                                   spoof = Core.Nothing, violence = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1SafeSearchAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1SafeSearchAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p1beta1SafeSearchAnnotation Core.<$>
                   (o Core..:? "adult") Core.<*> (o Core..:? "medical") Core.<*>
                     (o Core..:? "racy")
                     Core.<*> (o Core..:? "spoof")
                     Core.<*> (o Core..:? "violence"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1SafeSearchAnnotation
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("adult" Core..=) Core.<$> adult,
                  ...
                  ("racy" Core..=) Core.<$> racy, ("spoof" Core..=) Core.<$> spoof,
...
newGoogleCloudVisionV1p1beta1Symbol 
    :: 
                                    GoogleCloudVisionV1p1beta1Symbol
newGoogleCloudVisionV1p1beta1Symbol
  = GoogleCloudVisionV1p1beta1Symbol{boundingBox = Core.Nothing,
                                     confidence = Core.Nothing, property = Core.Nothing,
                                     text = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1Symbol where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1Symbol"
              (\ o ->
                 GoogleCloudVisionV1p1beta1Symbol Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "text"))
...
newGoogleCloudVisionV1p1beta1TextAnnotation 
    :: 
                                            GoogleCloudVisionV1p1beta1TextAnnotation
newGoogleCloudVisionV1p1beta1TextAnnotation
  = GoogleCloudVisionV1p1beta1TextAnnotation{pages = Core.Nothing,
                                             text = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1TextAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1TextAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p1beta1TextAnnotation Core.<$>
                   (o Core..:? "pages") Core.<*> (o Core..:? "text"))
...
newGoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak 
    :: 
                                                         GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak
newGoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak
  = GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak{isPrefix =
                                                            Core.Nothing,
                                                          type' = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak"
              (\ o ->
                 GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak Core.<$>
                   (o Core..:? "isPrefix") Core.<*> (o Core..:? "type"))
...
newGoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage 
    :: 
                                                            GoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage
newGoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage
  = GoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage{confidence
                                                               = Core.Nothing,
                                                             languageCode = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage"
              (\ o ->
                 GoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage Core.<$>
                   (o Core..:? "confidence") Core.<*> (o Core..:? "languageCode"))
...
newGoogleCloudVisionV1p1beta1TextAnnotationTextProperty 
    :: 
                                                        GoogleCloudVisionV1p1beta1TextAnnotationTextProperty
newGoogleCloudVisionV1p1beta1TextAnnotationTextProperty
  = GoogleCloudVisionV1p1beta1TextAnnotationTextProperty{detectedBreak
                                                           = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p1beta1TextAnnotationTextProperty"
              (\ o ->
                 GoogleCloudVisionV1p1beta1TextAnnotationTextProperty Core.<$>
...
newGoogleCloudVisionV1p1beta1Vertex 
    :: 
                                    GoogleCloudVisionV1p1beta1Vertex
newGoogleCloudVisionV1p1beta1Vertex
  = GoogleCloudVisionV1p1beta1Vertex{x = Core.Nothing,
                                     y = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1Vertex where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1Vertex"
              (\ o ->
                 GoogleCloudVisionV1p1beta1Vertex Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y"))
...
newGoogleCloudVisionV1p1beta1WebDetection 
    :: 
                                          GoogleCloudVisionV1p1beta1WebDetection
newGoogleCloudVisionV1p1beta1WebDetection
  = GoogleCloudVisionV1p1beta1WebDetection{bestGuessLabels =
                                             Core.Nothing,
...
instance Core.FromJSON GoogleCloudVisionV1p1beta1WebDetection where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1WebDetection"
              (\ o ->
                 GoogleCloudVisionV1p1beta1WebDetection Core.<$>
                   (o Core..:? "bestGuessLabels") Core.<*>
                     (o Core..:? "fullMatchingImages")
          ...
          = Core.object
              (Core.catMaybes
                 [("bestGuessLabels" Core..=) Core.<$> bestGuessLabels,
                  ...
                  ("pagesWithMatchingImages" Core..=) Core.<$>
...
newGoogleCloudVisionV1p1beta1WebDetectionWebEntity 
    :: 
                                                   GoogleCloudVisionV1p1beta1WebDetectionWebEntity
newGoogleCloudVisionV1p1beta1WebDetectionWebEntity
  = GoogleCloudVisionV1p1beta1WebDetectionWebEntity{description =
                                                      Core.Nothing,
                                                    entityId = Core.Nothing, score = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1WebDetectionWebEntity
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1WebDetectionWebEntity"
              (\ o ->
                 GoogleCloudVisionV1p1beta1WebDetectionWebEntity Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "entityId")
                     Core.<*> (o Core..:? "score"))
...
newGoogleCloudVisionV1p1beta1WebDetectionWebImage 
    :: 
                                                  GoogleCloudVisionV1p1beta1WebDetectionWebImage
newGoogleCloudVisionV1p1beta1WebDetectionWebImage
  = GoogleCloudVisionV1p1beta1WebDetectionWebImage{score =
                                                     Core.Nothing,
                                                   url = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1WebDetectionWebImage
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1WebDetectionWebImage"
              (\ o ->
                 GoogleCloudVisionV1p1beta1WebDetectionWebImage Core.<$>
                   (o Core..:? "score") Core.<*> (o Core..:? "url"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1WebDetectionWebImage
         where
...
newGoogleCloudVisionV1p1beta1WebDetectionWebLabel 
    :: 
                                                  GoogleCloudVisionV1p1beta1WebDetectionWebLabel
newGoogleCloudVisionV1p1beta1WebDetectionWebLabel
  = GoogleCloudVisionV1p1beta1WebDetectionWebLabel{label =
                                                     Core.Nothing,
                                                   languageCode = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1WebDetectionWebLabel
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1WebDetectionWebLabel"
              (\ o ->
                 GoogleCloudVisionV1p1beta1WebDetectionWebLabel Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "languageCode"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1WebDetectionWebLabel
         where
...
newGoogleCloudVisionV1p1beta1WebDetectionWebPage 
    :: 
                                                 GoogleCloudVisionV1p1beta1WebDetectionWebPage
newGoogleCloudVisionV1p1beta1WebDetectionWebPage
  = GoogleCloudVisionV1p1beta1WebDetectionWebPage{fullMatchingImages
                                                    = Core.Nothing,
                                                  pageTitle = Core.Nothing,
                                                  partialMatchingImages = Core.Nothing,
                                                  score = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p1beta1WebDetectionWebPage
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1WebDetectionWebPage"
              (\ o ->
                 GoogleCloudVisionV1p1beta1WebDetectionWebPage Core.<$>
                   (o Core..:? "fullMatchingImages") Core.<*> (o Core..:? "pageTitle")
                     Core.<*> (o Core..:? "partialMatchingImages")
                     Core.<*> (o Core..:? "score")
                     Core.<*> (o Core..:? "url"))

instance Core.ToJSON GoogleCloudVisionV1p1beta1WebDetectionWebPage
         where
...
newGoogleCloudVisionV1p1beta1Word 
    ::  GoogleCloudVisionV1p1beta1Word
newGoogleCloudVisionV1p1beta1Word
  = GoogleCloudVisionV1p1beta1Word{boundingBox = Core.Nothing,
                                   confidence = Core.Nothing, property = Core.Nothing,
                                   symbols = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p1beta1Word where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p1beta1Word"
              (\ o ->
                 GoogleCloudVisionV1p1beta1Word Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "symbols"))
...
newGoogleCloudVisionV1p2beta1AnnotateFileRequest 
    :: 
                                                 GoogleCloudVisionV1p2beta1AnnotateFileRequest
newGoogleCloudVisionV1p2beta1AnnotateFileRequest
  = GoogleCloudVisionV1p2beta1AnnotateFileRequest{features =
                                                    Core.Nothing,
                                                  imageContext = Core.Nothing,
                                                  inputConfig = Core.Nothing, pages = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1AnnotateFileRequest
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1AnnotateFileRequest"
              (\ o ->
                 GoogleCloudVisionV1p2beta1AnnotateFileRequest Core.<$>
                   (o Core..:? "features") Core.<*> (o Core..:? "imageContext")
                     Core.<*> (o Core..:? "inputConfig")
                     Core.<*> (o Core..:? "pages"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1AnnotateFileRequest
         where
...
newGoogleCloudVisionV1p2beta1AnnotateFileResponse 
    :: 
                                                  GoogleCloudVisionV1p2beta1AnnotateFileResponse
newGoogleCloudVisionV1p2beta1AnnotateFileResponse
  = GoogleCloudVisionV1p2beta1AnnotateFileResponse{error =
                                                     Core.Nothing,
                                                   inputConfig = Core.Nothing,
                                                   responses = Core.Nothing,
                                                   totalPages = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1AnnotateFileResponse"
              (\ o ->
                 GoogleCloudVisionV1p2beta1AnnotateFileResponse Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "inputConfig") Core.<*>
                     (o Core..:? "responses")
                     Core.<*> (o Core..:? "totalPages"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1AnnotateFileResponse
         where
...
newGoogleCloudVisionV1p2beta1AnnotateImageRequest 
    :: 
                                                  GoogleCloudVisionV1p2beta1AnnotateImageRequest
newGoogleCloudVisionV1p2beta1AnnotateImageRequest
  = GoogleCloudVisionV1p2beta1AnnotateImageRequest{features =
                                                     Core.Nothing,
                                                   image = Core.Nothing,
                                                   imageContext = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1AnnotateImageRequest"
              (\ o ->
                 GoogleCloudVisionV1p2beta1AnnotateImageRequest Core.<$>
                   (o Core..:? "features") Core.<*> (o Core..:? "image") Core.<*>
                     (o Core..:? "imageContext"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1AnnotateImageRequest
         where
...
newGoogleCloudVisionV1p2beta1AnnotateImageResponse 
    :: 
                                                   GoogleCloudVisionV1p2beta1AnnotateImageResponse
newGoogleCloudVisionV1p2beta1AnnotateImageResponse
  = GoogleCloudVisionV1p2beta1AnnotateImageResponse{context =
                                                      Core.Nothing,
                                                    cropHintsAnnotation = Core.Nothing,
                                                    error = Core.Nothing,
                                                    faceAnnotations = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1AnnotateImageResponse"
              (\ o ->
                 GoogleCloudVisionV1p2beta1AnnotateImageResponse Core.<$>
                   (o Core..:? "context") Core.<*> (o Core..:? "cropHintsAnnotation")
                     Core.<*> (o Core..:? "error")
                     Core.<*> (o Core..:? "faceAnnotations")
                     Core.<*> (o Core..:? "fullTextAnnotation")
...
newGoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest 
    :: 
                                                      GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest
newGoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest
  = GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest{features =
                                                         Core.Nothing,
                                                       imageContext = Core.Nothing,
                                                       inputConfig = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest"
              (\ o ->
                 GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest Core.<$>
                   (o Core..:? "features") Core.<*> (o Core..:? "imageContext")
                     Core.<*> (o Core..:? "inputConfig")
...
newGoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse 
    :: 
                                                       GoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse
newGoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse
  = GoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse{outputConfig
                                                          = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse"
              (\ o ->
                 GoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse Core.<$>
                   (o Core..:? "outputConfig"))
...
newGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest 
    :: 
                                                            GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest
newGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest
  = GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest{labels =
                                                               Core.Nothing,
                                                             parent = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest"
              (\ o ->
                 GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "parent") Core.<*>
                     (o Core..:? "requests"))
...
newGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest_Labels
  additional
  = GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest_Labels{additional
                                                                      = additional}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest_Labels
         where
...
newGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponse 
    :: 
                                                             GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponse
newGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponse
  = GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponse{responses
                                                                = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponse"
              (\ o ->
                 GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponse Core.<$>
                   (o Core..:? "responses"))
...
newGoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest 
    :: 
                                                             GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest
newGoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest
  = GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest{labels
                                                                = Core.Nothing,
                                                              outputConfig = Core.Nothing,
                                                              parent = Core.Nothing,
                                                              requests = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest"
              (\ o ->
                 GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "outputConfig") Core.<*>
                     (o Core..:? "parent")
...
newGoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest_Labels
  additional
  = GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest_Labels{additional
                                                                       = additional}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest_Labels
         where
...
newGoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest 
    :: 
                                                       GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest
newGoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest
  = GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest{labels =
                                                          Core.Nothing,
                                                        parent = Core.Nothing,
                                                        requests = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest"
              (\ o ->
                 GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "parent") Core.<*>
                     (o Core..:? "requests"))
...
newGoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest_Labels
  additional
  = GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest_Labels{additional
                                                                 = additional}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest_Labels
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest_Labels"
              (\ o ->
                 GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest_Labels Core.<$>
...
newGoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse 
    :: 
                                                        GoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse
newGoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse
  = GoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse{responses =
                                                           Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse"
              (\ o ->
                 GoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse Core.<$>
                   (o Core..:? "responses"))
...
newGoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest 
    :: 
                                                        GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest
newGoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest
  = GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest{labels =
                                                           Core.Nothing,
                                                         parent = Core.Nothing,
                                                         requests = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest"
              (\ o ->
                 GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "parent") Core.<*>
                     (o Core..:? "requests"))
...
newGoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest_Labels
  additional
  = GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest_Labels{additional
                                                                  = additional}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest_Labels
         where
...
newGoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse 
    :: 
                                                         GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse
newGoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse
  = GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse{responses =
                                                            Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse"
              (\ o ->
                 GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse Core.<$>
                   (o Core..:? "responses"))
...
newGoogleCloudVisionV1p2beta1Block 
    :: 
                                   GoogleCloudVisionV1p2beta1Block
newGoogleCloudVisionV1p2beta1Block
  = GoogleCloudVisionV1p2beta1Block{blockType = Core.Nothing,
                                    boundingBox = Core.Nothing, confidence = Core.Nothing,
                                    paragraphs = Core.Nothing, property = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Block where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Block"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Block Core.<$>
                   (o Core..:? "blockType") Core.<*> (o Core..:? "boundingBox")
                     Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "paragraphs")
                     Core.<*> (o Core..:? "property"))
...
newGoogleCloudVisionV1p2beta1BoundingPoly 
    :: 
                                          GoogleCloudVisionV1p2beta1BoundingPoly
newGoogleCloudVisionV1p2beta1BoundingPoly
  = GoogleCloudVisionV1p2beta1BoundingPoly{normalizedVertices =
                                             Core.Nothing,
                                           vertices = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1BoundingPoly where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1BoundingPoly"
              (\ o ->
                 GoogleCloudVisionV1p2beta1BoundingPoly Core.<$>
                   (o Core..:? "normalizedVertices") Core.<*> (o Core..:? "vertices"))
...
newGoogleCloudVisionV1p2beta1ColorInfo 
    :: 
                                       GoogleCloudVisionV1p2beta1ColorInfo
newGoogleCloudVisionV1p2beta1ColorInfo
  = GoogleCloudVisionV1p2beta1ColorInfo{color = Core.Nothing,
                                        pixelFraction = Core.Nothing, score = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1ColorInfo where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1ColorInfo"
              (\ o ->
                 GoogleCloudVisionV1p2beta1ColorInfo Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "pixelFraction") Core.<*>
                     (o Core..:? "score"))
...
newGoogleCloudVisionV1p2beta1CropHint 
    :: 
                                      GoogleCloudVisionV1p2beta1CropHint
newGoogleCloudVisionV1p2beta1CropHint
  = GoogleCloudVisionV1p2beta1CropHint{boundingPoly = Core.Nothing,
                                       confidence = Core.Nothing, importanceFraction = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1CropHint where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1CropHint"
              (\ o ->
                 GoogleCloudVisionV1p2beta1CropHint Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "importanceFraction"))
...
newGoogleCloudVisionV1p2beta1CropHintsAnnotation 
    :: 
                                                 GoogleCloudVisionV1p2beta1CropHintsAnnotation
newGoogleCloudVisionV1p2beta1CropHintsAnnotation
  = GoogleCloudVisionV1p2beta1CropHintsAnnotation{cropHints =
                                                    Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1CropHintsAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1CropHintsAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p2beta1CropHintsAnnotation Core.<$>
                   (o Core..:? "cropHints"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1CropHintsAnnotation
         where
...
newGoogleCloudVisionV1p2beta1CropHintsParams 
    :: 
                                             GoogleCloudVisionV1p2beta1CropHintsParams
newGoogleCloudVisionV1p2beta1CropHintsParams
  = GoogleCloudVisionV1p2beta1CropHintsParams{aspectRatios =
                                                Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1CropHintsParams
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1CropHintsParams"
              (\ o ->
                 GoogleCloudVisionV1p2beta1CropHintsParams Core.<$>
                   (o Core..:? "aspectRatios"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1CropHintsParams
         where
...
newGoogleCloudVisionV1p2beta1DominantColorsAnnotation 
    :: 
                                                      GoogleCloudVisionV1p2beta1DominantColorsAnnotation
newGoogleCloudVisionV1p2beta1DominantColorsAnnotation
  = GoogleCloudVisionV1p2beta1DominantColorsAnnotation{colors =
                                                         Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1DominantColorsAnnotation
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1DominantColorsAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p2beta1DominantColorsAnnotation Core.<$>
                   (o Core..:? "colors"))
...
newGoogleCloudVisionV1p2beta1EntityAnnotation 
    :: 
                                              GoogleCloudVisionV1p2beta1EntityAnnotation
newGoogleCloudVisionV1p2beta1EntityAnnotation
  = GoogleCloudVisionV1p2beta1EntityAnnotation{boundingPoly =
                                                 Core.Nothing,
                                               confidence = Core.Nothing,
                                               description = Core.Nothing, locale = Core.Nothing,
                                               locations = Core.Nothing, mid = Core.Nothing,
                                               properties = Core.Nothing, score = Core.Nothing,
                                               topicality = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1EntityAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1EntityAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p2beta1EntityAnnotation Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "locale")
                     Core.<*> (o Core..:? "locations")
...
instance Core.ToJSON GoogleCloudVisionV1p2beta1EntityAnnotation
         where
...
newGoogleCloudVisionV1p2beta1FaceAnnotation 
    :: 
                                            GoogleCloudVisionV1p2beta1FaceAnnotation
newGoogleCloudVisionV1p2beta1FaceAnnotation
  = GoogleCloudVisionV1p2beta1FaceAnnotation{angerLikelihood =
                                               Core.Nothing,
                                             blurredLikelihood = Core.Nothing,
                                             boundingPoly = Core.Nothing,
                                             detectionConfidence = Core.Nothing,
                                             ...
                                             tiltAngle = Core.Nothing,
                                             underExposedLikelihood = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1FaceAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1FaceAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p2beta1FaceAnnotation Core.<$>
                   (o Core..:? "angerLikelihood") Core.<*>
                     (o Core..:? "blurredLikelihood")
                     Core.<*> (o Core..:? "boundingPoly")
                     Core.<*> (o Core..:? "detectionConfidence")
...
newGoogleCloudVisionV1p2beta1FaceAnnotationLandmark 
    :: 
                                                    GoogleCloudVisionV1p2beta1FaceAnnotationLandmark
newGoogleCloudVisionV1p2beta1FaceAnnotationLandmark
  = GoogleCloudVisionV1p2beta1FaceAnnotationLandmark{position =
                                                       Core.Nothing,
                                                     type' = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1FaceAnnotationLandmark
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1FaceAnnotationLandmark"
              (\ o ->
                 GoogleCloudVisionV1p2beta1FaceAnnotationLandmark Core.<$>
                   (o Core..:? "position") Core.<*> (o Core..:? "type"))
...
newGoogleCloudVisionV1p2beta1Feature 
    :: 
                                     GoogleCloudVisionV1p2beta1Feature
newGoogleCloudVisionV1p2beta1Feature
  = GoogleCloudVisionV1p2beta1Feature{maxResults = Core.Nothing,
                                      model = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Feature where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Feature"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Feature Core.<$>
                   (o Core..:? "maxResults") Core.<*> (o Core..:? "model") Core.<*>
                     (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("maxResults" Core..=) Core.<$> maxResults,
                  ("model" Core..=) Core.<$> model, ("type" Core..=) Core.<$> type'])
...
instance Core.FromJSON GoogleCloudVisionV1p2beta1GcsDestination
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1GcsDestination"
              (\ o ->
                 GoogleCloudVisionV1p2beta1GcsDestination Core.<$>
                   (o Core..:? "uri"))
...
instance Core.FromJSON GoogleCloudVisionV1p2beta1GcsSource where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1GcsSource"
              (\ o ->
...
newGoogleCloudVisionV1p2beta1Image 
    :: 
                                   GoogleCloudVisionV1p2beta1Image
newGoogleCloudVisionV1p2beta1Image
  = GoogleCloudVisionV1p2beta1Image{content = Core.Nothing,
                                    source = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Image where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Image"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Image Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "source"))
...
newGoogleCloudVisionV1p2beta1ImageAnnotationContext 
    :: 
                                                    GoogleCloudVisionV1p2beta1ImageAnnotationContext
newGoogleCloudVisionV1p2beta1ImageAnnotationContext
  = GoogleCloudVisionV1p2beta1ImageAnnotationContext{pageNumber =
                                                       Core.Nothing,
                                                     uri = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1ImageAnnotationContext
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1ImageAnnotationContext"
              (\ o ->
                 GoogleCloudVisionV1p2beta1ImageAnnotationContext Core.<$>
                   (o Core..:? "pageNumber") Core.<*> (o Core..:? "uri"))
...
newGoogleCloudVisionV1p2beta1ImageContext 
    :: 
                                          GoogleCloudVisionV1p2beta1ImageContext
newGoogleCloudVisionV1p2beta1ImageContext
  = GoogleCloudVisionV1p2beta1ImageContext{cropHintsParams =
                                             Core.Nothing,
                                           languageHints = Core.Nothing, latLongRect = Core.Nothing,
...
instance Core.FromJSON GoogleCloudVisionV1p2beta1ImageContext where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1ImageContext"
              (\ o ->
                 GoogleCloudVisionV1p2beta1ImageContext Core.<$>
                   (o Core..:? "cropHintsParams") Core.<*>
                     (o Core..:? "languageHints")
...
newGoogleCloudVisionV1p2beta1ImageProperties 
    :: 
                                             GoogleCloudVisionV1p2beta1ImageProperties
newGoogleCloudVisionV1p2beta1ImageProperties
  = GoogleCloudVisionV1p2beta1ImageProperties{dominantColors =
                                                Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1ImageProperties
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1ImageProperties"
              (\ o ->
                 GoogleCloudVisionV1p2beta1ImageProperties Core.<$>
                   (o Core..:? "dominantColors"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1ImageProperties
         where
...
newGoogleCloudVisionV1p2beta1ImageSource 
    :: 
                                         GoogleCloudVisionV1p2beta1ImageSource
newGoogleCloudVisionV1p2beta1ImageSource
  = GoogleCloudVisionV1p2beta1ImageSource{gcsImageUri = Core.Nothing,
                                          imageUri = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1ImageSource where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1ImageSource"
              (\ o ->
                 GoogleCloudVisionV1p2beta1ImageSource Core.<$>
                   (o Core..:? "gcsImageUri") Core.<*> (o Core..:? "imageUri"))
...
newGoogleCloudVisionV1p2beta1InputConfig 
    :: 
                                         GoogleCloudVisionV1p2beta1InputConfig
newGoogleCloudVisionV1p2beta1InputConfig
  = GoogleCloudVisionV1p2beta1InputConfig{content = Core.Nothing,
                                          gcsSource = Core.Nothing, mimeType = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1InputConfig where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1InputConfig"
              (\ o ->
                 GoogleCloudVisionV1p2beta1InputConfig Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "gcsSource") Core.<*>
                     (o Core..:? "mimeType"))
...
newGoogleCloudVisionV1p2beta1LatLongRect 
    :: 
                                         GoogleCloudVisionV1p2beta1LatLongRect
newGoogleCloudVisionV1p2beta1LatLongRect
  = GoogleCloudVisionV1p2beta1LatLongRect{maxLatLng = Core.Nothing,
                                          minLatLng = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1LatLongRect where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1LatLongRect"
              (\ o ->
                 GoogleCloudVisionV1p2beta1LatLongRect Core.<$>
                   (o Core..:? "maxLatLng") Core.<*> (o Core..:? "minLatLng"))
...
newGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation 
    :: 
                                                       GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation
newGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation
  = GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation{boundingPoly
                                                          = Core.Nothing,
                                                        languageCode = Core.Nothing,
                                                        mid = Core.Nothing, name = Core.Nothing,
                                                        score = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "mid")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "score"))
...
instance Core.FromJSON GoogleCloudVisionV1p2beta1LocationInfo where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1LocationInfo"
              (\ o ->
                 GoogleCloudVisionV1p2beta1LocationInfo Core.<$>
                   (o Core..:? "latLng"))
...
newGoogleCloudVisionV1p2beta1NormalizedVertex 
    :: 
                                              GoogleCloudVisionV1p2beta1NormalizedVertex
newGoogleCloudVisionV1p2beta1NormalizedVertex
  = GoogleCloudVisionV1p2beta1NormalizedVertex{x = Core.Nothing,
                                               y = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1NormalizedVertex
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1NormalizedVertex"
              (\ o ->
                 GoogleCloudVisionV1p2beta1NormalizedVertex Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1NormalizedVertex
         where
...
newGoogleCloudVisionV1p2beta1OperationMetadata 
    :: 
                                               GoogleCloudVisionV1p2beta1OperationMetadata
newGoogleCloudVisionV1p2beta1OperationMetadata
  = GoogleCloudVisionV1p2beta1OperationMetadata{createTime =
                                                  Core.Nothing,
                                                state = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1OperationMetadata
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1OperationMetadata"
              (\ o ->
                 GoogleCloudVisionV1p2beta1OperationMetadata Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "updateTime"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1OperationMetadata
         where
...
newGoogleCloudVisionV1p2beta1OutputConfig 
    :: 
                                          GoogleCloudVisionV1p2beta1OutputConfig
newGoogleCloudVisionV1p2beta1OutputConfig
  = GoogleCloudVisionV1p2beta1OutputConfig{batchSize = Core.Nothing,
                                           gcsDestination = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1OutputConfig where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1OutputConfig"
              (\ o ->
                 GoogleCloudVisionV1p2beta1OutputConfig Core.<$>
                   (o Core..:? "batchSize") Core.<*> (o Core..:? "gcsDestination"))
...
newGoogleCloudVisionV1p2beta1Page 
    ::  GoogleCloudVisionV1p2beta1Page
newGoogleCloudVisionV1p2beta1Page
  = GoogleCloudVisionV1p2beta1Page{blocks = Core.Nothing,
                                   confidence = Core.Nothing, height = Core.Nothing,
                                   property = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Page where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Page"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Page Core.<$>
                   (o Core..:? "blocks") Core.<*> (o Core..:? "confidence") Core.<*>
                     (o Core..:? "height")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "width"))
...
newGoogleCloudVisionV1p2beta1Paragraph 
    :: 
                                       GoogleCloudVisionV1p2beta1Paragraph
newGoogleCloudVisionV1p2beta1Paragraph
  = GoogleCloudVisionV1p2beta1Paragraph{boundingBox = Core.Nothing,
                                        confidence = Core.Nothing, property = Core.Nothing,
                                        words = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Paragraph where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Paragraph"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Paragraph Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "words"))
...
newGoogleCloudVisionV1p2beta1Position 
    :: 
                                      GoogleCloudVisionV1p2beta1Position
newGoogleCloudVisionV1p2beta1Position
  = GoogleCloudVisionV1p2beta1Position{x = Core.Nothing,
                                       y = Core.Nothing, z = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Position where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Position"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Position Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y") Core.<*>
                     (o Core..:? "z"))
...
newGoogleCloudVisionV1p2beta1Product 
    :: 
                                     GoogleCloudVisionV1p2beta1Product
newGoogleCloudVisionV1p2beta1Product
  = GoogleCloudVisionV1p2beta1Product{description = Core.Nothing,
                                      displayName = Core.Nothing, name = Core.Nothing,
                                      productCategory = Core.Nothing, productLabels = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Product where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Product"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Product Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "productCategory")
                     Core.<*> (o Core..:? "productLabels"))
...
newGoogleCloudVisionV1p2beta1ProductKeyValue 
    :: 
                                             GoogleCloudVisionV1p2beta1ProductKeyValue
newGoogleCloudVisionV1p2beta1ProductKeyValue
  = GoogleCloudVisionV1p2beta1ProductKeyValue{key = Core.Nothing,
                                              value = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1ProductKeyValue
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1ProductKeyValue"
              (\ o ->
                 GoogleCloudVisionV1p2beta1ProductKeyValue Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "value"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1ProductKeyValue
         where
...
newGoogleCloudVisionV1p2beta1ProductSearchParams 
    :: 
                                                 GoogleCloudVisionV1p2beta1ProductSearchParams
newGoogleCloudVisionV1p2beta1ProductSearchParams
  = GoogleCloudVisionV1p2beta1ProductSearchParams{boundingPoly =
                                                    Core.Nothing,
                                                  filter = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1ProductSearchParams"
              (\ o ->
                 GoogleCloudVisionV1p2beta1ProductSearchParams Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "filter") Core.<*>
                     (o Core..:? "productCategories")
                     Core.<*> (o Core..:? "productSet"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1ProductSearchParams
         where
...
newGoogleCloudVisionV1p2beta1ProductSearchResults 
    :: 
                                                  GoogleCloudVisionV1p2beta1ProductSearchResults
newGoogleCloudVisionV1p2beta1ProductSearchResults
  = GoogleCloudVisionV1p2beta1ProductSearchResults{indexTime =
                                                     Core.Nothing,
                                                   productGroupedResults = Core.Nothing,
                                                   results = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1ProductSearchResults"
              (\ o ->
                 GoogleCloudVisionV1p2beta1ProductSearchResults Core.<$>
                   (o Core..:? "indexTime") Core.<*>
                     (o Core..:? "productGroupedResults")
                     Core.<*> (o Core..:? "results"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1ProductSearchResults
         where
...
newGoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult 
    :: 
                                                               GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult
newGoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult
  = GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult{boundingPoly
                                                                  = Core.Nothing,
                                                                objectAnnotations = Core.Nothing,
                                                                results = Core.Nothing}
instance Core.FromJSON
...
newGoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation 
    :: 
                                                                  GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation
newGoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation
  = GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation{languageCode
                                                                     = Core.Nothing,
                                                                   mid = Core.Nothing,
                                                                   name = Core.Nothing,
                                                                   score = Core.Nothing}
...
newGoogleCloudVisionV1p2beta1ProductSearchResultsResult 
    :: 
                                                        GoogleCloudVisionV1p2beta1ProductSearchResultsResult
newGoogleCloudVisionV1p2beta1ProductSearchResultsResult
  = GoogleCloudVisionV1p2beta1ProductSearchResultsResult{image =
                                                           Core.Nothing,
                                                         product = Core.Nothing,
                                                         score = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1ProductSearchResultsResult"
              (\ o ->
                 GoogleCloudVisionV1p2beta1ProductSearchResultsResult Core.<$>
                   (o Core..:? "image") Core.<*> (o Core..:? "product") Core.<*>
                     (o Core..:? "score"))
...
newGoogleCloudVisionV1p2beta1Property 
    :: 
                                      GoogleCloudVisionV1p2beta1Property
newGoogleCloudVisionV1p2beta1Property
  = GoogleCloudVisionV1p2beta1Property{name = Core.Nothing,
                                       uint64Value = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Property where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Property"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Property Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "uint64Value" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "value"))
...
newGoogleCloudVisionV1p2beta1SafeSearchAnnotation 
    :: 
                                                  GoogleCloudVisionV1p2beta1SafeSearchAnnotation
newGoogleCloudVisionV1p2beta1SafeSearchAnnotation
  = GoogleCloudVisionV1p2beta1SafeSearchAnnotation{adult =
                                                     Core.Nothing,
                                                   medical = Core.Nothing, racy = Core.Nothing,
                                                   spoof = Core.Nothing, violence = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1SafeSearchAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p2beta1SafeSearchAnnotation Core.<$>
                   (o Core..:? "adult") Core.<*> (o Core..:? "medical") Core.<*>
                     (o Core..:? "racy")
                     Core.<*> (o Core..:? "spoof")
                     Core.<*> (o Core..:? "violence"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1SafeSearchAnnotation
         where
...
newGoogleCloudVisionV1p2beta1Symbol 
    :: 
                                    GoogleCloudVisionV1p2beta1Symbol
newGoogleCloudVisionV1p2beta1Symbol
  = GoogleCloudVisionV1p2beta1Symbol{boundingBox = Core.Nothing,
                                     confidence = Core.Nothing, property = Core.Nothing,
                                     text = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Symbol where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Symbol"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Symbol Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "text"))
...
newGoogleCloudVisionV1p2beta1TextAnnotation 
    :: 
                                            GoogleCloudVisionV1p2beta1TextAnnotation
newGoogleCloudVisionV1p2beta1TextAnnotation
  = GoogleCloudVisionV1p2beta1TextAnnotation{pages = Core.Nothing,
                                             text = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1TextAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1TextAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p2beta1TextAnnotation Core.<$>
                   (o Core..:? "pages") Core.<*> (o Core..:? "text"))
...
newGoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak 
    :: 
                                                         GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak
newGoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak
  = GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak{isPrefix =
                                                            Core.Nothing,
                                                          type' = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak"
              (\ o ->
                 GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak Core.<$>
                   (o Core..:? "isPrefix") Core.<*> (o Core..:? "type"))
...
newGoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage 
    :: 
                                                            GoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage
newGoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage
  = GoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage{confidence
                                                               = Core.Nothing,
                                                             languageCode = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage"
              (\ o ->
                 GoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage Core.<$>
                   (o Core..:? "confidence") Core.<*> (o Core..:? "languageCode"))
...
newGoogleCloudVisionV1p2beta1TextAnnotationTextProperty 
    :: 
                                                        GoogleCloudVisionV1p2beta1TextAnnotationTextProperty
newGoogleCloudVisionV1p2beta1TextAnnotationTextProperty
  = GoogleCloudVisionV1p2beta1TextAnnotationTextProperty{detectedBreak
                                                           = Core.Nothing,
                                                         detectedLanguages = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1TextAnnotationTextProperty
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p2beta1TextAnnotationTextProperty"
              (\ o ->
                 GoogleCloudVisionV1p2beta1TextAnnotationTextProperty Core.<$>
                   (o Core..:? "detectedBreak") Core.<*>
                     (o Core..:? "detectedLanguages"))
...
newGoogleCloudVisionV1p2beta1TextDetectionParams 
    :: 
                                                 GoogleCloudVisionV1p2beta1TextDetectionParams
newGoogleCloudVisionV1p2beta1TextDetectionParams
  = GoogleCloudVisionV1p2beta1TextDetectionParams{advancedOcrOptions
                                                    = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1TextDetectionParams"
              (\ o ->
                 GoogleCloudVisionV1p2beta1TextDetectionParams Core.<$>
                   (o Core..:? "advancedOcrOptions") Core.<*>
                     (o Core..:? "enableTextDetectionConfidenceScore"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1TextDetectionParams
         where
        toJSON GoogleCloudVisionV1p2beta1TextDetectionParams{..}
          = Core.object
              (Core.catMaybes
                 [("advancedOcrOptions" Core..=) Core.<$> advancedOcrOptions,
                  ("enableTextDetectionConfidenceScore" Core..=) Core.<$>
...
newGoogleCloudVisionV1p2beta1Vertex 
    :: 
                                    GoogleCloudVisionV1p2beta1Vertex
newGoogleCloudVisionV1p2beta1Vertex
  = GoogleCloudVisionV1p2beta1Vertex{x = Core.Nothing,
                                     y = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Vertex where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Vertex"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Vertex Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y"))
...
newGoogleCloudVisionV1p2beta1WebDetection 
    :: 
                                          GoogleCloudVisionV1p2beta1WebDetection
newGoogleCloudVisionV1p2beta1WebDetection
  = GoogleCloudVisionV1p2beta1WebDetection{bestGuessLabels =
                                             Core.Nothing,
                                           fullMatchingImages = Core.Nothing,
                                           pagesWithMatchingImages = Core.Nothing,
                                           partialMatchingImages = Core.Nothing,
...
instance Core.FromJSON GoogleCloudVisionV1p2beta1WebDetection where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1WebDetection"
              (\ o ->
                 GoogleCloudVisionV1p2beta1WebDetection Core.<$>
                   (o Core..:? "bestGuessLabels") Core.<*>
                     (o Core..:? "fullMatchingImages")
                     Core.<*> (o Core..:? "pagesWithMatchingImages")
                     Core.<*> (o Core..:? "partialMatchingImages")
...
newGoogleCloudVisionV1p2beta1WebDetectionParams 
    :: 
                                                GoogleCloudVisionV1p2beta1WebDetectionParams
newGoogleCloudVisionV1p2beta1WebDetectionParams
  = GoogleCloudVisionV1p2beta1WebDetectionParams{includeGeoResults =
                                                   Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1WebDetectionParams
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1WebDetectionParams"
              (\ o ->
                 GoogleCloudVisionV1p2beta1WebDetectionParams Core.<$>
                   (o Core..:? "includeGeoResults"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1WebDetectionParams
         where
...
newGoogleCloudVisionV1p2beta1WebDetectionWebEntity 
    :: 
                                                   GoogleCloudVisionV1p2beta1WebDetectionWebEntity
newGoogleCloudVisionV1p2beta1WebDetectionWebEntity
  = GoogleCloudVisionV1p2beta1WebDetectionWebEntity{description =
                                                      Core.Nothing,
                                                    entityId = Core.Nothing, score = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1WebDetectionWebEntity
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1WebDetectionWebEntity"
              (\ o ->
                 GoogleCloudVisionV1p2beta1WebDetectionWebEntity Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "entityId")
                     Core.<*> (o Core..:? "score"))
...
newGoogleCloudVisionV1p2beta1WebDetectionWebImage 
    :: 
                                                  GoogleCloudVisionV1p2beta1WebDetectionWebImage
newGoogleCloudVisionV1p2beta1WebDetectionWebImage
  = GoogleCloudVisionV1p2beta1WebDetectionWebImage{score =
                                                     Core.Nothing,
                                                   url = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1WebDetectionWebImage
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1WebDetectionWebImage"
              (\ o ->
                 GoogleCloudVisionV1p2beta1WebDetectionWebImage Core.<$>
                   (o Core..:? "score") Core.<*> (o Core..:? "url"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1WebDetectionWebImage
         where
...
newGoogleCloudVisionV1p2beta1WebDetectionWebLabel 
    :: 
                                                  GoogleCloudVisionV1p2beta1WebDetectionWebLabel
newGoogleCloudVisionV1p2beta1WebDetectionWebLabel
  = GoogleCloudVisionV1p2beta1WebDetectionWebLabel{label =
                                                     Core.Nothing,
                                                   languageCode = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p2beta1WebDetectionWebLabel
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1WebDetectionWebLabel"
              (\ o ->
                 GoogleCloudVisionV1p2beta1WebDetectionWebLabel Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "languageCode"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1WebDetectionWebLabel
         where
...
newGoogleCloudVisionV1p2beta1WebDetectionWebPage 
    :: 
                                                 GoogleCloudVisionV1p2beta1WebDetectionWebPage
newGoogleCloudVisionV1p2beta1WebDetectionWebPage
  = GoogleCloudVisionV1p2beta1WebDetectionWebPage{fullMatchingImages
                                                    = Core.Nothing,
                                                  pageTitle = Core.Nothing,
                                                  partialMatchingImages = Core.Nothing,
                                                  score = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1WebDetectionWebPage"
              (\ o ->
                 GoogleCloudVisionV1p2beta1WebDetectionWebPage Core.<$>
                   (o Core..:? "fullMatchingImages") Core.<*> (o Core..:? "pageTitle")
                     Core.<*> (o Core..:? "partialMatchingImages")
                     Core.<*> (o Core..:? "score")
                     Core.<*> (o Core..:? "url"))

instance Core.ToJSON GoogleCloudVisionV1p2beta1WebDetectionWebPage
         where
...
newGoogleCloudVisionV1p2beta1Word 
    ::  GoogleCloudVisionV1p2beta1Word
newGoogleCloudVisionV1p2beta1Word
  = GoogleCloudVisionV1p2beta1Word{boundingBox = Core.Nothing,
                                   confidence = Core.Nothing, property = Core.Nothing,
                                   symbols = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p2beta1Word where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p2beta1Word"
              (\ o ->
                 GoogleCloudVisionV1p2beta1Word Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "symbols"))
...
newGoogleCloudVisionV1p3beta1AnnotateFileResponse 
    :: 
                                                  GoogleCloudVisionV1p3beta1AnnotateFileResponse
newGoogleCloudVisionV1p3beta1AnnotateFileResponse
  = GoogleCloudVisionV1p3beta1AnnotateFileResponse{error =
                                                     Core.Nothing,
                                                   inputConfig = Core.Nothing,
                                                   responses = Core.Nothing,
                                                   totalPages = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1AnnotateFileResponse"
              (\ o ->
                 GoogleCloudVisionV1p3beta1AnnotateFileResponse Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "inputConfig") Core.<*>
                     (o Core..:? "responses")
                     Core.<*> (o Core..:? "totalPages"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1AnnotateFileResponse
         where
...
newGoogleCloudVisionV1p3beta1AnnotateImageResponse 
    :: 
                                                   GoogleCloudVisionV1p3beta1AnnotateImageResponse
newGoogleCloudVisionV1p3beta1AnnotateImageResponse
  = GoogleCloudVisionV1p3beta1AnnotateImageResponse{context =
                                                      Core.Nothing,
                                                    cropHintsAnnotation = Core.Nothing,
                                                    error = Core.Nothing,
                                                    faceAnnotations = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1AnnotateImageResponse"
              (\ o ->
                 GoogleCloudVisionV1p3beta1AnnotateImageResponse Core.<$>
                   (o Core..:? "context") Core.<*> (o Core..:? "cropHintsAnnotation")
                     Core.<*> (o Core..:? "error")
                     Core.<*> (o Core..:? "faceAnnotations")
                     Core.<*> (o Core..:? "fullTextAnnotation")
...
newGoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse 
    :: 
                                                       GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse
newGoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse
  = GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse{outputConfig
                                                          = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse"
              (\ o ->
                 GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse Core.<$>
                   (o Core..:? "outputConfig"))
...
newGoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse 
    :: 
                                                             GoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse
newGoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse
  = GoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse{responses
                                                                = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse"
              (\ o ->
                 GoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse Core.<$>
                   (o Core..:? "responses"))
...
newGoogleCloudVisionV1p3beta1BatchOperationMetadata 
    :: 
                                                    GoogleCloudVisionV1p3beta1BatchOperationMetadata
newGoogleCloudVisionV1p3beta1BatchOperationMetadata
  = GoogleCloudVisionV1p3beta1BatchOperationMetadata{endTime =
                                                       Core.Nothing,
                                                     state = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1BatchOperationMetadata"
              (\ o ->
                 GoogleCloudVisionV1p3beta1BatchOperationMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "submitTime"))
...
newGoogleCloudVisionV1p3beta1Block 
    :: 
                                   GoogleCloudVisionV1p3beta1Block
newGoogleCloudVisionV1p3beta1Block
  = GoogleCloudVisionV1p3beta1Block{blockType = Core.Nothing,
                                    boundingBox = Core.Nothing, confidence = Core.Nothing,
                                    paragraphs = Core.Nothing, property = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1Block where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1Block"
              (\ o ->
                 GoogleCloudVisionV1p3beta1Block Core.<$>
                   (o Core..:? "blockType") Core.<*> (o Core..:? "boundingBox")
                     Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "paragraphs")
                     Core.<*> (o Core..:? "property"))
...
newGoogleCloudVisionV1p3beta1BoundingPoly 
    :: 
                                          GoogleCloudVisionV1p3beta1BoundingPoly
newGoogleCloudVisionV1p3beta1BoundingPoly
  = GoogleCloudVisionV1p3beta1BoundingPoly{normalizedVertices =
                                             Core.Nothing,
                                           vertices = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1BoundingPoly where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1BoundingPoly"
              (\ o ->
                 GoogleCloudVisionV1p3beta1BoundingPoly Core.<$>
                   (o Core..:? "normalizedVertices") Core.<*> (o Core..:? "vertices"))
...
newGoogleCloudVisionV1p3beta1ColorInfo 
    :: 
                                       GoogleCloudVisionV1p3beta1ColorInfo
newGoogleCloudVisionV1p3beta1ColorInfo
  = GoogleCloudVisionV1p3beta1ColorInfo{color = Core.Nothing,
                                        pixelFraction = Core.Nothing, score = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1ColorInfo where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1ColorInfo"
              (\ o ->
                 GoogleCloudVisionV1p3beta1ColorInfo Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "pixelFraction") Core.<*>
                     (o Core..:? "score"))
...
newGoogleCloudVisionV1p3beta1CropHint 
    :: 
                                      GoogleCloudVisionV1p3beta1CropHint
newGoogleCloudVisionV1p3beta1CropHint
  = GoogleCloudVisionV1p3beta1CropHint{boundingPoly = Core.Nothing,
                                       confidence = Core.Nothing, importanceFraction = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1CropHint where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1CropHint"
              (\ o ->
                 GoogleCloudVisionV1p3beta1CropHint Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "importanceFraction"))
...
newGoogleCloudVisionV1p3beta1CropHintsAnnotation 
    :: 
                                                 GoogleCloudVisionV1p3beta1CropHintsAnnotation
newGoogleCloudVisionV1p3beta1CropHintsAnnotation
  = GoogleCloudVisionV1p3beta1CropHintsAnnotation{cropHints =
                                                    Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1CropHintsAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1CropHintsAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p3beta1CropHintsAnnotation Core.<$>
                   (o Core..:? "cropHints"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1CropHintsAnnotation
         where
...
newGoogleCloudVisionV1p3beta1DominantColorsAnnotation 
    :: 
                                                      GoogleCloudVisionV1p3beta1DominantColorsAnnotation
newGoogleCloudVisionV1p3beta1DominantColorsAnnotation
  = GoogleCloudVisionV1p3beta1DominantColorsAnnotation{colors =
                                                         Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1DominantColorsAnnotation
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1DominantColorsAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p3beta1DominantColorsAnnotation Core.<$>
                   (o Core..:? "colors"))
...
newGoogleCloudVisionV1p3beta1EntityAnnotation 
    :: 
                                              GoogleCloudVisionV1p3beta1EntityAnnotation
newGoogleCloudVisionV1p3beta1EntityAnnotation
  = GoogleCloudVisionV1p3beta1EntityAnnotation{boundingPoly =
                                                 Core.Nothing,
                                               confidence = Core.Nothing,
                                               description = Core.Nothing, locale = Core.Nothing,
                                               locations = Core.Nothing, mid = Core.Nothing,
                                               properties = Core.Nothing, score = Core.Nothing,
                                               topicality = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1EntityAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1EntityAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p3beta1EntityAnnotation Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "locale")
                     Core.<*> (o Core..:? "locations")
...
instance Core.ToJSON GoogleCloudVisionV1p3beta1EntityAnnotation
         where
...
newGoogleCloudVisionV1p3beta1FaceAnnotation 
    :: 
                                            GoogleCloudVisionV1p3beta1FaceAnnotation
newGoogleCloudVisionV1p3beta1FaceAnnotation
  = GoogleCloudVisionV1p3beta1FaceAnnotation{angerLikelihood =
                                               Core.Nothing,
                                             blurredLikelihood = Core.Nothing,
                                             boundingPoly = Core.Nothing,
                                             detectionConfidence = Core.Nothing,
                                             ...
                                             tiltAngle = Core.Nothing,
                                             underExposedLikelihood = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1FaceAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1FaceAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p3beta1FaceAnnotation Core.<$>
                   (o Core..:? "angerLikelihood") Core.<*>
                     (o Core..:? "blurredLikelihood")
                     Core.<*> (o Core..:? "boundingPoly")
                     Core.<*> (o Core..:? "detectionConfidence")
...
newGoogleCloudVisionV1p3beta1FaceAnnotationLandmark 
    :: 
                                                    GoogleCloudVisionV1p3beta1FaceAnnotationLandmark
newGoogleCloudVisionV1p3beta1FaceAnnotationLandmark
  = GoogleCloudVisionV1p3beta1FaceAnnotationLandmark{position =
                                                       Core.Nothing,
                                                     type' = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1FaceAnnotationLandmark
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1FaceAnnotationLandmark"
              (\ o ->
                 GoogleCloudVisionV1p3beta1FaceAnnotationLandmark Core.<$>
                   (o Core..:? "position") Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON GoogleCloudVisionV1p3beta1GcsDestination
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1GcsDestination"
              (\ o ->
                 GoogleCloudVisionV1p3beta1GcsDestination Core.<$>
                   (o Core..:? "uri"))
...
instance Core.FromJSON GoogleCloudVisionV1p3beta1GcsSource where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1GcsSource"
              (\ o ->
...
newGoogleCloudVisionV1p3beta1ImageAnnotationContext 
    :: 
                                                    GoogleCloudVisionV1p3beta1ImageAnnotationContext
newGoogleCloudVisionV1p3beta1ImageAnnotationContext
  = GoogleCloudVisionV1p3beta1ImageAnnotationContext{pageNumber =
                                                       Core.Nothing,
                                                     uri = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1ImageAnnotationContext
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1ImageAnnotationContext"
              (\ o ->
                 GoogleCloudVisionV1p3beta1ImageAnnotationContext Core.<$>
                   (o Core..:? "pageNumber") Core.<*> (o Core..:? "uri"))
...
newGoogleCloudVisionV1p3beta1ImageProperties 
    :: 
                                             GoogleCloudVisionV1p3beta1ImageProperties
newGoogleCloudVisionV1p3beta1ImageProperties
  = GoogleCloudVisionV1p3beta1ImageProperties{dominantColors =
                                                Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1ImageProperties
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1ImageProperties"
              (\ o ->
                 GoogleCloudVisionV1p3beta1ImageProperties Core.<$>
                   (o Core..:? "dominantColors"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1ImageProperties
         where
...
newGoogleCloudVisionV1p3beta1ImportProductSetsResponse 
    :: 
                                                       GoogleCloudVisionV1p3beta1ImportProductSetsResponse
newGoogleCloudVisionV1p3beta1ImportProductSetsResponse
  = GoogleCloudVisionV1p3beta1ImportProductSetsResponse{referenceImages
                                                          = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1ImportProductSetsResponse"
              (\ o ->
                 GoogleCloudVisionV1p3beta1ImportProductSetsResponse Core.<$>
                   (o Core..:? "referenceImages") Core.<*> (o Core..:? "statuses"))
...
newGoogleCloudVisionV1p3beta1InputConfig 
    :: 
                                         GoogleCloudVisionV1p3beta1InputConfig
newGoogleCloudVisionV1p3beta1InputConfig
  = GoogleCloudVisionV1p3beta1InputConfig{content = Core.Nothing,
                                          gcsSource = Core.Nothing, mimeType = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1InputConfig where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1InputConfig"
              (\ o ->
                 GoogleCloudVisionV1p3beta1InputConfig Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "gcsSource") Core.<*>
                     (o Core..:? "mimeType"))
...
newGoogleCloudVisionV1p3beta1LocalizedObjectAnnotation 
    :: 
                                                       GoogleCloudVisionV1p3beta1LocalizedObjectAnnotation
newGoogleCloudVisionV1p3beta1LocalizedObjectAnnotation
  = GoogleCloudVisionV1p3beta1LocalizedObjectAnnotation{boundingPoly
                                                          = Core.Nothing,
                                                        languageCode = Core.Nothing,
                                                        mid = Core.Nothing, name = Core.Nothing,
                                                        score = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1LocalizedObjectAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p3beta1LocalizedObjectAnnotation Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "mid")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "score"))
...
instance Core.FromJSON GoogleCloudVisionV1p3beta1LocationInfo where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1LocationInfo"
              (\ o ->
                 GoogleCloudVisionV1p3beta1LocationInfo Core.<$>
                   (o Core..:? "latLng"))
...
newGoogleCloudVisionV1p3beta1NormalizedVertex 
    :: 
                                              GoogleCloudVisionV1p3beta1NormalizedVertex
newGoogleCloudVisionV1p3beta1NormalizedVertex
  = GoogleCloudVisionV1p3beta1NormalizedVertex{x = Core.Nothing,
                                               y = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1NormalizedVertex
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1NormalizedVertex"
              (\ o ->
                 GoogleCloudVisionV1p3beta1NormalizedVertex Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1NormalizedVertex
         where
...
newGoogleCloudVisionV1p3beta1OperationMetadata 
    :: 
                                               GoogleCloudVisionV1p3beta1OperationMetadata
newGoogleCloudVisionV1p3beta1OperationMetadata
  = GoogleCloudVisionV1p3beta1OperationMetadata{createTime =
                                                  Core.Nothing,
                                                state = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1OperationMetadata
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1OperationMetadata"
              (\ o ->
                 GoogleCloudVisionV1p3beta1OperationMetadata Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "updateTime"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1OperationMetadata
         where
...
newGoogleCloudVisionV1p3beta1OutputConfig 
    :: 
                                          GoogleCloudVisionV1p3beta1OutputConfig
newGoogleCloudVisionV1p3beta1OutputConfig
  = GoogleCloudVisionV1p3beta1OutputConfig{batchSize = Core.Nothing,
                                           gcsDestination = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1OutputConfig where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1OutputConfig"
              (\ o ->
                 GoogleCloudVisionV1p3beta1OutputConfig Core.<$>
                   (o Core..:? "batchSize") Core.<*> (o Core..:? "gcsDestination"))
...
newGoogleCloudVisionV1p3beta1Page 
    ::  GoogleCloudVisionV1p3beta1Page
newGoogleCloudVisionV1p3beta1Page
  = GoogleCloudVisionV1p3beta1Page{blocks = Core.Nothing,
                                   confidence = Core.Nothing, height = Core.Nothing,
                                   property = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1Page where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1Page"
              (\ o ->
                 GoogleCloudVisionV1p3beta1Page Core.<$>
                   (o Core..:? "blocks") Core.<*> (o Core..:? "confidence") Core.<*>
                     (o Core..:? "height")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "width"))
...
newGoogleCloudVisionV1p3beta1Paragraph 
    :: 
                                       GoogleCloudVisionV1p3beta1Paragraph
newGoogleCloudVisionV1p3beta1Paragraph
  = GoogleCloudVisionV1p3beta1Paragraph{boundingBox = Core.Nothing,
                                        confidence = Core.Nothing, property = Core.Nothing,
                                        words = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1Paragraph where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1Paragraph"
              (\ o ->
                 GoogleCloudVisionV1p3beta1Paragraph Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "words"))
...
newGoogleCloudVisionV1p3beta1Position 
    :: 
                                      GoogleCloudVisionV1p3beta1Position
newGoogleCloudVisionV1p3beta1Position
  = GoogleCloudVisionV1p3beta1Position{x = Core.Nothing,
                                       y = Core.Nothing, z = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1Position where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1Position"
              (\ o ->
                 GoogleCloudVisionV1p3beta1Position Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y") Core.<*>
                     (o Core..:? "z"))
...
newGoogleCloudVisionV1p3beta1Product 
    :: 
                                     GoogleCloudVisionV1p3beta1Product
newGoogleCloudVisionV1p3beta1Product
  = GoogleCloudVisionV1p3beta1Product{description = Core.Nothing,
                                      displayName = Core.Nothing, name = Core.Nothing,
                                      productCategory = Core.Nothing, productLabels = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1Product where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1Product"
              (\ o ->
                 GoogleCloudVisionV1p3beta1Product Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "productCategory")
                     Core.<*> (o Core..:? "productLabels"))
...
newGoogleCloudVisionV1p3beta1ProductKeyValue 
    :: 
                                             GoogleCloudVisionV1p3beta1ProductKeyValue
newGoogleCloudVisionV1p3beta1ProductKeyValue
  = GoogleCloudVisionV1p3beta1ProductKeyValue{key = Core.Nothing,
                                              value = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1ProductKeyValue
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1ProductKeyValue"
              (\ o ->
                 GoogleCloudVisionV1p3beta1ProductKeyValue Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "value"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1ProductKeyValue
         where
...
newGoogleCloudVisionV1p3beta1ProductSearchResults 
    :: 
                                                  GoogleCloudVisionV1p3beta1ProductSearchResults
newGoogleCloudVisionV1p3beta1ProductSearchResults
  = GoogleCloudVisionV1p3beta1ProductSearchResults{indexTime =
                                                     Core.Nothing,
                                                   productGroupedResults = Core.Nothing,
                                                   results = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1ProductSearchResults"
              (\ o ->
                 GoogleCloudVisionV1p3beta1ProductSearchResults Core.<$>
                   (o Core..:? "indexTime") Core.<*>
                     (o Core..:? "productGroupedResults")
                     Core.<*> (o Core..:? "results"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1ProductSearchResults
         where
...
newGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult 
    :: 
                                                               GoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult
newGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult
  = GoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult{boundingPoly
                                                                  = Core.Nothing,
                                                                objectAnnotations = Core.Nothing,
                                                                results = Core.Nothing}
instance Core.FromJSON
...
newGoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotation 
    :: 
                                                                  GoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotation
newGoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotation
  = GoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotation{languageCode
                                                                     = Core.Nothing,
                                                                   mid = Core.Nothing,
                                                                   name = Core.Nothing,
                                                                   score = Core.Nothing}
...
newGoogleCloudVisionV1p3beta1ProductSearchResultsResult 
    :: 
                                                        GoogleCloudVisionV1p3beta1ProductSearchResultsResult
newGoogleCloudVisionV1p3beta1ProductSearchResultsResult
  = GoogleCloudVisionV1p3beta1ProductSearchResultsResult{image =
                                                           Core.Nothing,
                                                         product = Core.Nothing,
                                                         score = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1ProductSearchResultsResult"
              (\ o ->
                 GoogleCloudVisionV1p3beta1ProductSearchResultsResult Core.<$>
                   (o Core..:? "image") Core.<*> (o Core..:? "product") Core.<*>
                     (o Core..:? "score"))
...
newGoogleCloudVisionV1p3beta1Property 
    :: 
                                      GoogleCloudVisionV1p3beta1Property
newGoogleCloudVisionV1p3beta1Property
  = GoogleCloudVisionV1p3beta1Property{name = Core.Nothing,
                                       uint64Value = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1Property where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1Property"
              (\ o ->
                 GoogleCloudVisionV1p3beta1Property Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "uint64Value" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "value"))
...
newGoogleCloudVisionV1p3beta1ReferenceImage 
    :: 
                                            GoogleCloudVisionV1p3beta1ReferenceImage
newGoogleCloudVisionV1p3beta1ReferenceImage
  = GoogleCloudVisionV1p3beta1ReferenceImage{boundingPolys =
                                               Core.Nothing,
                                             name = Core.Nothing, uri = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1ReferenceImage
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1ReferenceImage"
              (\ o ->
                 GoogleCloudVisionV1p3beta1ReferenceImage Core.<$>
                   (o Core..:? "boundingPolys") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "uri"))
          ...
          = Core.object
              (Core.catMaybes
                 [("boundingPolys" Core..=) Core.<$> boundingPolys,
                  ("name" Core..=) Core.<$> name, ("uri" Core..=) Core.<$> uri])
...
newGoogleCloudVisionV1p3beta1SafeSearchAnnotation 
    :: 
                                                  GoogleCloudVisionV1p3beta1SafeSearchAnnotation
newGoogleCloudVisionV1p3beta1SafeSearchAnnotation
  = GoogleCloudVisionV1p3beta1SafeSearchAnnotation{adult =
                                                     Core.Nothing,
                                                   medical = Core.Nothing, racy = Core.Nothing,
                                                   spoof = Core.Nothing, violence = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1SafeSearchAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p3beta1SafeSearchAnnotation Core.<$>
                   (o Core..:? "adult") Core.<*> (o Core..:? "medical") Core.<*>
                     (o Core..:? "racy")
                     Core.<*> (o Core..:? "spoof")
                     Core.<*> (o Core..:? "violence"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1SafeSearchAnnotation
         where
...
newGoogleCloudVisionV1p3beta1Symbol 
    :: 
                                    GoogleCloudVisionV1p3beta1Symbol
newGoogleCloudVisionV1p3beta1Symbol
  = GoogleCloudVisionV1p3beta1Symbol{boundingBox = Core.Nothing,
                                     confidence = Core.Nothing, property = Core.Nothing,
                                     text = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1Symbol where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1Symbol"
              (\ o ->
                 GoogleCloudVisionV1p3beta1Symbol Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "text"))
...
newGoogleCloudVisionV1p3beta1TextAnnotation 
    :: 
                                            GoogleCloudVisionV1p3beta1TextAnnotation
newGoogleCloudVisionV1p3beta1TextAnnotation
  = GoogleCloudVisionV1p3beta1TextAnnotation{pages = Core.Nothing,
                                             text = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1TextAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1TextAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p3beta1TextAnnotation Core.<$>
                   (o Core..:? "pages") Core.<*> (o Core..:? "text"))
...
newGoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak 
    :: 
                                                         GoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak
newGoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak
  = GoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak{isPrefix =
                                                            Core.Nothing,
                                                          type' = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak"
              (\ o ->
                 GoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak Core.<$>
                   (o Core..:? "isPrefix") Core.<*> (o Core..:? "type"))
...
newGoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage 
    :: 
                                                            GoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage
newGoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage
  = GoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage{confidence
                                                               = Core.Nothing,
                                                             languageCode = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage"
              (\ o ->
                 GoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage Core.<$>
                   (o Core..:? "confidence") Core.<*> (o Core..:? "languageCode"))
...
newGoogleCloudVisionV1p3beta1TextAnnotationTextProperty 
    :: 
                                                        GoogleCloudVisionV1p3beta1TextAnnotationTextProperty
newGoogleCloudVisionV1p3beta1TextAnnotationTextProperty
  = GoogleCloudVisionV1p3beta1TextAnnotationTextProperty{detectedBreak
                                                           = Core.Nothing,
                                                         detectedLanguages = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1TextAnnotationTextProperty
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p3beta1TextAnnotationTextProperty"
              (\ o ->
                 GoogleCloudVisionV1p3beta1TextAnnotationTextProperty Core.<$>
                   (o Core..:? "detectedBreak") Core.<*>
                     (o Core..:? "detectedLanguages"))
...
newGoogleCloudVisionV1p3beta1Vertex 
    :: 
                                    GoogleCloudVisionV1p3beta1Vertex
newGoogleCloudVisionV1p3beta1Vertex
  = GoogleCloudVisionV1p3beta1Vertex{x = Core.Nothing,
                                     y = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1Vertex where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1Vertex"
              (\ o ->
                 GoogleCloudVisionV1p3beta1Vertex Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y"))
...
newGoogleCloudVisionV1p3beta1WebDetection 
    :: 
                                          GoogleCloudVisionV1p3beta1WebDetection
newGoogleCloudVisionV1p3beta1WebDetection
  = GoogleCloudVisionV1p3beta1WebDetection{bestGuessLabels =
                                             Core.Nothing,
                                           fullMatchingImages = Core.Nothing,
                                           pagesWithMatchingImages = Core.Nothing,
                                           partialMatchingImages = Core.Nothing,
...
instance Core.FromJSON GoogleCloudVisionV1p3beta1WebDetection where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1WebDetection"
              (\ o ->
                 GoogleCloudVisionV1p3beta1WebDetection Core.<$>
                   (o Core..:? "bestGuessLabels") Core.<*>
                     (o Core..:? "fullMatchingImages")
                     Core.<*> (o Core..:? "pagesWithMatchingImages")
                     Core.<*> (o Core..:? "partialMatchingImages")
...
newGoogleCloudVisionV1p3beta1WebDetectionWebEntity 
    :: 
                                                   GoogleCloudVisionV1p3beta1WebDetectionWebEntity
newGoogleCloudVisionV1p3beta1WebDetectionWebEntity
  = GoogleCloudVisionV1p3beta1WebDetectionWebEntity{description =
                                                      Core.Nothing,
                                                    entityId = Core.Nothing, score = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1WebDetectionWebEntity
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1WebDetectionWebEntity"
              (\ o ->
                 GoogleCloudVisionV1p3beta1WebDetectionWebEntity Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "entityId")
                     Core.<*> (o Core..:? "score"))
...
newGoogleCloudVisionV1p3beta1WebDetectionWebImage 
    :: 
                                                  GoogleCloudVisionV1p3beta1WebDetectionWebImage
newGoogleCloudVisionV1p3beta1WebDetectionWebImage
  = GoogleCloudVisionV1p3beta1WebDetectionWebImage{score =
                                                     Core.Nothing,
                                                   url = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1WebDetectionWebImage
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1WebDetectionWebImage"
              (\ o ->
                 GoogleCloudVisionV1p3beta1WebDetectionWebImage Core.<$>
                   (o Core..:? "score") Core.<*> (o Core..:? "url"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1WebDetectionWebImage
         where
...
newGoogleCloudVisionV1p3beta1WebDetectionWebLabel 
    :: 
                                                  GoogleCloudVisionV1p3beta1WebDetectionWebLabel
newGoogleCloudVisionV1p3beta1WebDetectionWebLabel
  = GoogleCloudVisionV1p3beta1WebDetectionWebLabel{label =
                                                     Core.Nothing,
                                                   languageCode = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p3beta1WebDetectionWebLabel
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1WebDetectionWebLabel"
              (\ o ->
                 GoogleCloudVisionV1p3beta1WebDetectionWebLabel Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "languageCode"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1WebDetectionWebLabel
         where
...
newGoogleCloudVisionV1p3beta1WebDetectionWebPage 
    :: 
                                                 GoogleCloudVisionV1p3beta1WebDetectionWebPage
newGoogleCloudVisionV1p3beta1WebDetectionWebPage
  = GoogleCloudVisionV1p3beta1WebDetectionWebPage{fullMatchingImages
                                                    = Core.Nothing,
                                                  pageTitle = Core.Nothing,
                                                  partialMatchingImages = Core.Nothing,
                                                  score = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1WebDetectionWebPage"
              (\ o ->
                 GoogleCloudVisionV1p3beta1WebDetectionWebPage Core.<$>
                   (o Core..:? "fullMatchingImages") Core.<*> (o Core..:? "pageTitle")
                     Core.<*> (o Core..:? "partialMatchingImages")
                     Core.<*> (o Core..:? "score")
                     Core.<*> (o Core..:? "url"))

instance Core.ToJSON GoogleCloudVisionV1p3beta1WebDetectionWebPage
         where
...
newGoogleCloudVisionV1p3beta1Word 
    ::  GoogleCloudVisionV1p3beta1Word
newGoogleCloudVisionV1p3beta1Word
  = GoogleCloudVisionV1p3beta1Word{boundingBox = Core.Nothing,
                                   confidence = Core.Nothing, property = Core.Nothing,
                                   symbols = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p3beta1Word where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p3beta1Word"
              (\ o ->
                 GoogleCloudVisionV1p3beta1Word Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "symbols"))
...
newGoogleCloudVisionV1p4beta1AnnotateFileResponse 
    :: 
                                                  GoogleCloudVisionV1p4beta1AnnotateFileResponse
newGoogleCloudVisionV1p4beta1AnnotateFileResponse
  = GoogleCloudVisionV1p4beta1AnnotateFileResponse{error =
                                                     Core.Nothing,
                                                   inputConfig = Core.Nothing,
                                                   responses = Core.Nothing,
                                                   totalPages = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1AnnotateFileResponse"
              (\ o ->
                 GoogleCloudVisionV1p4beta1AnnotateFileResponse Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "inputConfig") Core.<*>
                     (o Core..:? "responses")
                     Core.<*> (o Core..:? "totalPages"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1AnnotateFileResponse
         where
...
newGoogleCloudVisionV1p4beta1AnnotateImageResponse 
    :: 
                                                   GoogleCloudVisionV1p4beta1AnnotateImageResponse
newGoogleCloudVisionV1p4beta1AnnotateImageResponse
  = GoogleCloudVisionV1p4beta1AnnotateImageResponse{context =
                                                      Core.Nothing,
                                                    cropHintsAnnotation = Core.Nothing,
                                                    error = Core.Nothing,
                                                    faceAnnotations = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1AnnotateImageResponse"
              (\ o ->
                 GoogleCloudVisionV1p4beta1AnnotateImageResponse Core.<$>
                   (o Core..:? "context") Core.<*> (o Core..:? "cropHintsAnnotation")
                     Core.<*> (o Core..:? "error")
                     Core.<*> (o Core..:? "faceAnnotations")
                     Core.<*> (o Core..:? "fullTextAnnotation")
...
newGoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse 
    :: 
                                                       GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse
newGoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse
  = GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse{outputConfig
                                                          = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse"
              (\ o ->
                 GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse Core.<$>
                   (o Core..:? "outputConfig"))
...
newGoogleCloudVisionV1p4beta1AsyncBatchAnnotateFilesResponse 
    :: 
                                                             GoogleCloudVisionV1p4beta1AsyncBatchAnnotateFilesResponse
newGoogleCloudVisionV1p4beta1AsyncBatchAnnotateFilesResponse
  = GoogleCloudVisionV1p4beta1AsyncBatchAnnotateFilesResponse{responses
                                                                = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1AsyncBatchAnnotateFilesResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1AsyncBatchAnnotateFilesResponse"
              (\ o ->
                 GoogleCloudVisionV1p4beta1AsyncBatchAnnotateFilesResponse Core.<$>
                   (o Core..:? "responses"))
...
newGoogleCloudVisionV1p4beta1AsyncBatchAnnotateImagesResponse 
    :: 
                                                              GoogleCloudVisionV1p4beta1AsyncBatchAnnotateImagesResponse
newGoogleCloudVisionV1p4beta1AsyncBatchAnnotateImagesResponse
  = GoogleCloudVisionV1p4beta1AsyncBatchAnnotateImagesResponse{outputConfig
                                                                 = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1AsyncBatchAnnotateImagesResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1AsyncBatchAnnotateImagesResponse"
              (\ o ->
                 GoogleCloudVisionV1p4beta1AsyncBatchAnnotateImagesResponse Core.<$>
                   (o Core..:? "outputConfig"))
...
newGoogleCloudVisionV1p4beta1BatchAnnotateFilesResponse 
    :: 
                                                        GoogleCloudVisionV1p4beta1BatchAnnotateFilesResponse
newGoogleCloudVisionV1p4beta1BatchAnnotateFilesResponse
  = GoogleCloudVisionV1p4beta1BatchAnnotateFilesResponse{responses =
                                                           Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1BatchAnnotateFilesResponse
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1BatchAnnotateFilesResponse"
              (\ o ->
                 GoogleCloudVisionV1p4beta1BatchAnnotateFilesResponse Core.<$>
                   (o Core..:? "responses"))
...
newGoogleCloudVisionV1p4beta1BatchOperationMetadata 
    :: 
                                                    GoogleCloudVisionV1p4beta1BatchOperationMetadata
newGoogleCloudVisionV1p4beta1BatchOperationMetadata
  = GoogleCloudVisionV1p4beta1BatchOperationMetadata{endTime =
                                                       Core.Nothing,
                                                     state = Core.Nothing,
                                                     submitTime = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1BatchOperationMetadata"
              (\ o ->
                 GoogleCloudVisionV1p4beta1BatchOperationMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "submitTime"))
...
newGoogleCloudVisionV1p4beta1Block 
    :: 
                                   GoogleCloudVisionV1p4beta1Block
newGoogleCloudVisionV1p4beta1Block
  = GoogleCloudVisionV1p4beta1Block{blockType = Core.Nothing,
                                    boundingBox = Core.Nothing, confidence = Core.Nothing,
                                    paragraphs = Core.Nothing, property = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1Block where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1Block"
              (\ o ->
                 GoogleCloudVisionV1p4beta1Block Core.<$>
                   (o Core..:? "blockType") Core.<*> (o Core..:? "boundingBox")
                     Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "paragraphs")
                     Core.<*> (o Core..:? "property"))
...
newGoogleCloudVisionV1p4beta1BoundingPoly 
    :: 
                                          GoogleCloudVisionV1p4beta1BoundingPoly
newGoogleCloudVisionV1p4beta1BoundingPoly
  = GoogleCloudVisionV1p4beta1BoundingPoly{normalizedVertices =
                                             Core.Nothing,
                                           vertices = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1BoundingPoly where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1BoundingPoly"
              (\ o ->
                 GoogleCloudVisionV1p4beta1BoundingPoly Core.<$>
                   (o Core..:? "normalizedVertices") Core.<*> (o Core..:? "vertices"))
...
newGoogleCloudVisionV1p4beta1Celebrity 
    :: 
                                       GoogleCloudVisionV1p4beta1Celebrity
newGoogleCloudVisionV1p4beta1Celebrity
  = GoogleCloudVisionV1p4beta1Celebrity{description = Core.Nothing,
                                        displayName = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1Celebrity where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1Celebrity"
              (\ o ->
                 GoogleCloudVisionV1p4beta1Celebrity Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "name"))
...
newGoogleCloudVisionV1p4beta1ColorInfo 
    :: 
                                       GoogleCloudVisionV1p4beta1ColorInfo
newGoogleCloudVisionV1p4beta1ColorInfo
  = GoogleCloudVisionV1p4beta1ColorInfo{color = Core.Nothing,
                                        pixelFraction = Core.Nothing, score = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1ColorInfo where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1ColorInfo"
              (\ o ->
                 GoogleCloudVisionV1p4beta1ColorInfo Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "pixelFraction") Core.<*>
                     (o Core..:? "score"))
...
newGoogleCloudVisionV1p4beta1CropHint 
    :: 
                                      GoogleCloudVisionV1p4beta1CropHint
newGoogleCloudVisionV1p4beta1CropHint
  = GoogleCloudVisionV1p4beta1CropHint{boundingPoly = Core.Nothing,
                                       confidence = Core.Nothing, importanceFraction = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1CropHint where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1CropHint"
              (\ o ->
                 GoogleCloudVisionV1p4beta1CropHint Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "importanceFraction"))
...
newGoogleCloudVisionV1p4beta1CropHintsAnnotation 
    :: 
                                                 GoogleCloudVisionV1p4beta1CropHintsAnnotation
newGoogleCloudVisionV1p4beta1CropHintsAnnotation
  = GoogleCloudVisionV1p4beta1CropHintsAnnotation{cropHints =
                                                    Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1CropHintsAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1CropHintsAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p4beta1CropHintsAnnotation Core.<$>
                   (o Core..:? "cropHints"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1CropHintsAnnotation
         where
...
newGoogleCloudVisionV1p4beta1DominantColorsAnnotation 
    :: 
                                                      GoogleCloudVisionV1p4beta1DominantColorsAnnotation
newGoogleCloudVisionV1p4beta1DominantColorsAnnotation
  = GoogleCloudVisionV1p4beta1DominantColorsAnnotation{colors =
                                                         Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1DominantColorsAnnotation
         where
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1DominantColorsAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p4beta1DominantColorsAnnotation Core.<$>
                   (o Core..:? "colors"))
...
newGoogleCloudVisionV1p4beta1EntityAnnotation 
    :: 
                                              GoogleCloudVisionV1p4beta1EntityAnnotation
newGoogleCloudVisionV1p4beta1EntityAnnotation
  = GoogleCloudVisionV1p4beta1EntityAnnotation{boundingPoly =
                                                 Core.Nothing,
                                               confidence = Core.Nothing,
                                               description = Core.Nothing, locale = Core.Nothing,
                                               locations = Core.Nothing, mid = Core.Nothing,
                                               properties = Core.Nothing, score = Core.Nothing,
                                               topicality = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1EntityAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1EntityAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p4beta1EntityAnnotation Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "locale")
                     Core.<*> (o Core..:? "locations")
...
instance Core.ToJSON GoogleCloudVisionV1p4beta1EntityAnnotation
         where
...
newGoogleCloudVisionV1p4beta1FaceAnnotation 
    :: 
                                            GoogleCloudVisionV1p4beta1FaceAnnotation
newGoogleCloudVisionV1p4beta1FaceAnnotation
  = GoogleCloudVisionV1p4beta1FaceAnnotation{angerLikelihood =
                                               Core.Nothing,
                                             blurredLikelihood = Core.Nothing,
                                             boundingPoly = Core.Nothing,
                                             detectionConfidence = Core.Nothing,
                                             ...
                                             tiltAngle = Core.Nothing,
                                             underExposedLikelihood = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1FaceAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1FaceAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p4beta1FaceAnnotation Core.<$>
                   (o Core..:? "angerLikelihood") Core.<*>
                     (o Core..:? "blurredLikelihood")
                     Core.<*> (o Core..:? "boundingPoly")
                     Core.<*> (o Core..:? "detectionConfidence")
...
newGoogleCloudVisionV1p4beta1FaceAnnotationLandmark 
    :: 
                                                    GoogleCloudVisionV1p4beta1FaceAnnotationLandmark
newGoogleCloudVisionV1p4beta1FaceAnnotationLandmark
  = GoogleCloudVisionV1p4beta1FaceAnnotationLandmark{position =
                                                       Core.Nothing,
                                                     type' = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1FaceAnnotationLandmark
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1FaceAnnotationLandmark"
              (\ o ->
                 GoogleCloudVisionV1p4beta1FaceAnnotationLandmark Core.<$>
                   (o Core..:? "position") Core.<*> (o Core..:? "type"))
...
newGoogleCloudVisionV1p4beta1FaceRecognitionResult 
    :: 
                                                   GoogleCloudVisionV1p4beta1FaceRecognitionResult
newGoogleCloudVisionV1p4beta1FaceRecognitionResult
  = GoogleCloudVisionV1p4beta1FaceRecognitionResult{celebrity =
                                                      Core.Nothing,
                                                    confidence = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1FaceRecognitionResult
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1FaceRecognitionResult"
              (\ o ->
                 GoogleCloudVisionV1p4beta1FaceRecognitionResult Core.<$>
                   (o Core..:? "celebrity") Core.<*> (o Core..:? "confidence"))
...
instance Core.FromJSON GoogleCloudVisionV1p4beta1GcsDestination
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1GcsDestination"
              (\ o ->
                 GoogleCloudVisionV1p4beta1GcsDestination Core.<$>
                   (o Core..:? "uri"))
...
instance Core.FromJSON GoogleCloudVisionV1p4beta1GcsSource where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1GcsSource"
              (\ o ->
...
newGoogleCloudVisionV1p4beta1ImageAnnotationContext 
    :: 
                                                    GoogleCloudVisionV1p4beta1ImageAnnotationContext
newGoogleCloudVisionV1p4beta1ImageAnnotationContext
  = GoogleCloudVisionV1p4beta1ImageAnnotationContext{pageNumber =
                                                       Core.Nothing,
                                                     uri = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1ImageAnnotationContext
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1ImageAnnotationContext"
              (\ o ->
                 GoogleCloudVisionV1p4beta1ImageAnnotationContext Core.<$>
                   (o Core..:? "pageNumber") Core.<*> (o Core..:? "uri"))
...
newGoogleCloudVisionV1p4beta1ImageProperties 
    :: 
                                             GoogleCloudVisionV1p4beta1ImageProperties
newGoogleCloudVisionV1p4beta1ImageProperties
  = GoogleCloudVisionV1p4beta1ImageProperties{dominantColors =
                                                Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1ImageProperties
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1ImageProperties"
              (\ o ->
                 GoogleCloudVisionV1p4beta1ImageProperties Core.<$>
                   (o Core..:? "dominantColors"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1ImageProperties
         where
...
newGoogleCloudVisionV1p4beta1ImportProductSetsResponse 
    :: 
                                                       GoogleCloudVisionV1p4beta1ImportProductSetsResponse
newGoogleCloudVisionV1p4beta1ImportProductSetsResponse
  = GoogleCloudVisionV1p4beta1ImportProductSetsResponse{referenceImages
                                                          = Core.Nothing,
                                                        statuses = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1ImportProductSetsResponse
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1ImportProductSetsResponse"
              (\ o ->
                 GoogleCloudVisionV1p4beta1ImportProductSetsResponse Core.<$>
                   (o Core..:? "referenceImages") Core.<*> (o Core..:? "statuses"))
...
newGoogleCloudVisionV1p4beta1InputConfig 
    :: 
                                         GoogleCloudVisionV1p4beta1InputConfig
newGoogleCloudVisionV1p4beta1InputConfig
  = GoogleCloudVisionV1p4beta1InputConfig{content = Core.Nothing,
                                          gcsSource = Core.Nothing, mimeType = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1InputConfig where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1InputConfig"
              (\ o ->
                 GoogleCloudVisionV1p4beta1InputConfig Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "gcsSource") Core.<*>
                     (o Core..:? "mimeType"))
...
newGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation 
    :: 
                                                       GoogleCloudVisionV1p4beta1LocalizedObjectAnnotation
newGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation
  = GoogleCloudVisionV1p4beta1LocalizedObjectAnnotation{boundingPoly
                                                          = Core.Nothing,
                                                        languageCode = Core.Nothing,
                                                        mid = Core.Nothing, name = Core.Nothing,
                                                        score = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1LocalizedObjectAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p4beta1LocalizedObjectAnnotation Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "mid")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "score"))
...
instance Core.FromJSON GoogleCloudVisionV1p4beta1LocationInfo where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1LocationInfo"
              (\ o ->
                 GoogleCloudVisionV1p4beta1LocationInfo Core.<$>
                   (o Core..:? "latLng"))
...
newGoogleCloudVisionV1p4beta1NormalizedVertex 
    :: 
                                              GoogleCloudVisionV1p4beta1NormalizedVertex
newGoogleCloudVisionV1p4beta1NormalizedVertex
  = GoogleCloudVisionV1p4beta1NormalizedVertex{x = Core.Nothing,
                                               y = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1NormalizedVertex
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1NormalizedVertex"
              (\ o ->
                 GoogleCloudVisionV1p4beta1NormalizedVertex Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1NormalizedVertex
         where
...
newGoogleCloudVisionV1p4beta1OperationMetadata 
    :: 
                                               GoogleCloudVisionV1p4beta1OperationMetadata
newGoogleCloudVisionV1p4beta1OperationMetadata
  = GoogleCloudVisionV1p4beta1OperationMetadata{createTime =
                                                  Core.Nothing,
                                                state = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1OperationMetadata
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1OperationMetadata"
              (\ o ->
                 GoogleCloudVisionV1p4beta1OperationMetadata Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "updateTime"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1OperationMetadata
         where
...
newGoogleCloudVisionV1p4beta1OutputConfig 
    :: 
                                          GoogleCloudVisionV1p4beta1OutputConfig
newGoogleCloudVisionV1p4beta1OutputConfig
  = GoogleCloudVisionV1p4beta1OutputConfig{batchSize = Core.Nothing,
                                           gcsDestination = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1OutputConfig where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1OutputConfig"
              (\ o ->
                 GoogleCloudVisionV1p4beta1OutputConfig Core.<$>
                   (o Core..:? "batchSize") Core.<*> (o Core..:? "gcsDestination"))
...
newGoogleCloudVisionV1p4beta1Page 
    ::  GoogleCloudVisionV1p4beta1Page
newGoogleCloudVisionV1p4beta1Page
  = GoogleCloudVisionV1p4beta1Page{blocks = Core.Nothing,
                                   confidence = Core.Nothing, height = Core.Nothing,
                                   property = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1Page where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1Page"
              (\ o ->
                 GoogleCloudVisionV1p4beta1Page Core.<$>
                   (o Core..:? "blocks") Core.<*> (o Core..:? "confidence") Core.<*>
                     (o Core..:? "height")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "width"))
...
newGoogleCloudVisionV1p4beta1Paragraph 
    :: 
                                       GoogleCloudVisionV1p4beta1Paragraph
newGoogleCloudVisionV1p4beta1Paragraph
  = GoogleCloudVisionV1p4beta1Paragraph{boundingBox = Core.Nothing,
                                        confidence = Core.Nothing, property = Core.Nothing,
                                        words = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1Paragraph where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1Paragraph"
              (\ o ->
                 GoogleCloudVisionV1p4beta1Paragraph Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "words"))
...
newGoogleCloudVisionV1p4beta1Position 
    :: 
                                      GoogleCloudVisionV1p4beta1Position
newGoogleCloudVisionV1p4beta1Position
  = GoogleCloudVisionV1p4beta1Position{x = Core.Nothing,
                                       y = Core.Nothing, z = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1Position where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1Position"
              (\ o ->
                 GoogleCloudVisionV1p4beta1Position Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y") Core.<*>
                     (o Core..:? "z"))
...
newGoogleCloudVisionV1p4beta1Product 
    :: 
                                     GoogleCloudVisionV1p4beta1Product
newGoogleCloudVisionV1p4beta1Product
  = GoogleCloudVisionV1p4beta1Product{description = Core.Nothing,
                                      displayName = Core.Nothing, name = Core.Nothing,
                                      productCategory = Core.Nothing, productLabels = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1Product where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1Product"
              (\ o ->
                 GoogleCloudVisionV1p4beta1Product Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "productCategory")
                     Core.<*> (o Core..:? "productLabels"))
...
newGoogleCloudVisionV1p4beta1ProductKeyValue 
    :: 
                                             GoogleCloudVisionV1p4beta1ProductKeyValue
newGoogleCloudVisionV1p4beta1ProductKeyValue
  = GoogleCloudVisionV1p4beta1ProductKeyValue{key = Core.Nothing,
                                              value = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1ProductKeyValue
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1ProductKeyValue"
              (\ o ->
                 GoogleCloudVisionV1p4beta1ProductKeyValue Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "value"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1ProductKeyValue
         where
...
newGoogleCloudVisionV1p4beta1ProductSearchResults 
    :: 
                                                  GoogleCloudVisionV1p4beta1ProductSearchResults
newGoogleCloudVisionV1p4beta1ProductSearchResults
  = GoogleCloudVisionV1p4beta1ProductSearchResults{indexTime =
                                                     Core.Nothing,
                                                   productGroupedResults = Core.Nothing,
                                                   results = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1ProductSearchResults"
              (\ o ->
                 GoogleCloudVisionV1p4beta1ProductSearchResults Core.<$>
                   (o Core..:? "indexTime") Core.<*>
                     (o Core..:? "productGroupedResults")
                     Core.<*> (o Core..:? "results"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1ProductSearchResults
         where
...
newGoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult 
    :: 
                                                               GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult
newGoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult
  = GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult{boundingPoly
                                                                  = Core.Nothing,
                                                                objectAnnotations = Core.Nothing,
                                                                results = Core.Nothing}
instance Core.FromJSON
...
newGoogleCloudVisionV1p4beta1ProductSearchResultsObjectAnnotation 
    :: 
                                                                  GoogleCloudVisionV1p4beta1ProductSearchResultsObjectAnnotation
newGoogleCloudVisionV1p4beta1ProductSearchResultsObjectAnnotation
  = GoogleCloudVisionV1p4beta1ProductSearchResultsObjectAnnotation{languageCode
                                                                     = Core.Nothing,
                                                                   mid = Core.Nothing,
                                                                   name = Core.Nothing,
                                                                   score = Core.Nothing}
...
newGoogleCloudVisionV1p4beta1ProductSearchResultsResult 
    :: 
                                                        GoogleCloudVisionV1p4beta1ProductSearchResultsResult
newGoogleCloudVisionV1p4beta1ProductSearchResultsResult
  = GoogleCloudVisionV1p4beta1ProductSearchResultsResult{image =
                                                           Core.Nothing,
                                                         product = Core.Nothing,
                                                         score = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1ProductSearchResultsResult"
              (\ o ->
                 GoogleCloudVisionV1p4beta1ProductSearchResultsResult Core.<$>
                   (o Core..:? "image") Core.<*> (o Core..:? "product") Core.<*>
                     (o Core..:? "score"))
...
newGoogleCloudVisionV1p4beta1Property 
    :: 
                                      GoogleCloudVisionV1p4beta1Property
newGoogleCloudVisionV1p4beta1Property
  = GoogleCloudVisionV1p4beta1Property{name = Core.Nothing,
                                       uint64Value = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1Property where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1Property"
              (\ o ->
                 GoogleCloudVisionV1p4beta1Property Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "uint64Value" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "value"))
...
newGoogleCloudVisionV1p4beta1ReferenceImage 
    :: 
                                            GoogleCloudVisionV1p4beta1ReferenceImage
newGoogleCloudVisionV1p4beta1ReferenceImage
  = GoogleCloudVisionV1p4beta1ReferenceImage{boundingPolys =
                                               Core.Nothing,
                                             name = Core.Nothing, uri = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1ReferenceImage
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1ReferenceImage"
              (\ o ->
                 GoogleCloudVisionV1p4beta1ReferenceImage Core.<$>
                   (o Core..:? "boundingPolys") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "uri"))
...
newGoogleCloudVisionV1p4beta1SafeSearchAnnotation 
    :: 
                                                  GoogleCloudVisionV1p4beta1SafeSearchAnnotation
newGoogleCloudVisionV1p4beta1SafeSearchAnnotation
  = GoogleCloudVisionV1p4beta1SafeSearchAnnotation{adult =
                                                     Core.Nothing,
                                                   medical = Core.Nothing, racy = Core.Nothing,
                                                   spoof = Core.Nothing, violence = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1SafeSearchAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p4beta1SafeSearchAnnotation Core.<$>
                   (o Core..:? "adult") Core.<*> (o Core..:? "medical") Core.<*>
                     (o Core..:? "racy")
                     Core.<*> (o Core..:? "spoof")
                     Core.<*> (o Core..:? "violence"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1SafeSearchAnnotation
         where
...
newGoogleCloudVisionV1p4beta1Symbol 
    :: 
                                    GoogleCloudVisionV1p4beta1Symbol
newGoogleCloudVisionV1p4beta1Symbol
  = GoogleCloudVisionV1p4beta1Symbol{boundingBox = Core.Nothing,
                                     confidence = Core.Nothing, property = Core.Nothing,
                                     text = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1Symbol where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1Symbol"
              (\ o ->
                 GoogleCloudVisionV1p4beta1Symbol Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "text"))
...
newGoogleCloudVisionV1p4beta1TextAnnotation 
    :: 
                                            GoogleCloudVisionV1p4beta1TextAnnotation
newGoogleCloudVisionV1p4beta1TextAnnotation
  = GoogleCloudVisionV1p4beta1TextAnnotation{pages = Core.Nothing,
                                             text = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1TextAnnotation
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1TextAnnotation"
              (\ o ->
                 GoogleCloudVisionV1p4beta1TextAnnotation Core.<$>
                   (o Core..:? "pages") Core.<*> (o Core..:? "text"))
...
newGoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak 
    :: 
                                                         GoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak
newGoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak
  = GoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak{isPrefix =
                                                            Core.Nothing,
                                                          type' = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak"
              (\ o ->
                 GoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak Core.<$>
                   (o Core..:? "isPrefix") Core.<*> (o Core..:? "type"))
...
newGoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage 
    :: 
                                                            GoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage
newGoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage
  = GoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage{confidence
                                                               = Core.Nothing,
                                                             languageCode = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage"
              (\ o ->
                 GoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage Core.<$>
                   (o Core..:? "confidence") Core.<*> (o Core..:? "languageCode"))
...
newGoogleCloudVisionV1p4beta1TextAnnotationTextProperty 
    :: 
                                                        GoogleCloudVisionV1p4beta1TextAnnotationTextProperty
newGoogleCloudVisionV1p4beta1TextAnnotationTextProperty
  = GoogleCloudVisionV1p4beta1TextAnnotationTextProperty{detectedBreak
                                                           = Core.Nothing,
                                                         detectedLanguages = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1TextAnnotationTextProperty
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudVisionV1p4beta1TextAnnotationTextProperty"
              (\ o ->
                 GoogleCloudVisionV1p4beta1TextAnnotationTextProperty Core.<$>
                   (o Core..:? "detectedBreak") Core.<*>
                     (o Core..:? "detectedLanguages"))
...
newGoogleCloudVisionV1p4beta1Vertex 
    :: 
                                    GoogleCloudVisionV1p4beta1Vertex
newGoogleCloudVisionV1p4beta1Vertex
  = GoogleCloudVisionV1p4beta1Vertex{x = Core.Nothing,
                                     y = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1Vertex where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1Vertex"
              (\ o ->
                 GoogleCloudVisionV1p4beta1Vertex Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y"))
...
newGoogleCloudVisionV1p4beta1WebDetection 
    :: 
                                          GoogleCloudVisionV1p4beta1WebDetection
newGoogleCloudVisionV1p4beta1WebDetection
  = GoogleCloudVisionV1p4beta1WebDetection{bestGuessLabels =
                                             Core.Nothing,
                                           fullMatchingImages = Core.Nothing,
                                           pagesWithMatchingImages = Core.Nothing,
                                           partialMatchingImages = Core.Nothing,
...
instance Core.FromJSON GoogleCloudVisionV1p4beta1WebDetection where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1WebDetection"
              (\ o ->
                 GoogleCloudVisionV1p4beta1WebDetection Core.<$>
                   (o Core..:? "bestGuessLabels") Core.<*>
                     (o Core..:? "fullMatchingImages")
                     Core.<*> (o Core..:? "pagesWithMatchingImages")
                     Core.<*> (o Core..:? "partialMatchingImages")
...
newGoogleCloudVisionV1p4beta1WebDetectionWebEntity 
    :: 
                                                   GoogleCloudVisionV1p4beta1WebDetectionWebEntity
newGoogleCloudVisionV1p4beta1WebDetectionWebEntity
  = GoogleCloudVisionV1p4beta1WebDetectionWebEntity{description =
                                                      Core.Nothing,
                                                    entityId = Core.Nothing, score = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1WebDetectionWebEntity
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1WebDetectionWebEntity"
              (\ o ->
                 GoogleCloudVisionV1p4beta1WebDetectionWebEntity Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "entityId")
                     Core.<*> (o Core..:? "score"))
...
newGoogleCloudVisionV1p4beta1WebDetectionWebImage 
    :: 
                                                  GoogleCloudVisionV1p4beta1WebDetectionWebImage
newGoogleCloudVisionV1p4beta1WebDetectionWebImage
  = GoogleCloudVisionV1p4beta1WebDetectionWebImage{score =
                                                     Core.Nothing,
                                                   url = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1WebDetectionWebImage
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1WebDetectionWebImage"
              (\ o ->
                 GoogleCloudVisionV1p4beta1WebDetectionWebImage Core.<$>
                   (o Core..:? "score") Core.<*> (o Core..:? "url"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1WebDetectionWebImage
         where
...
newGoogleCloudVisionV1p4beta1WebDetectionWebLabel 
    :: 
                                                  GoogleCloudVisionV1p4beta1WebDetectionWebLabel
newGoogleCloudVisionV1p4beta1WebDetectionWebLabel
  = GoogleCloudVisionV1p4beta1WebDetectionWebLabel{label =
                                                     Core.Nothing,
                                                   languageCode = Core.Nothing}
instance Core.FromJSON
           GoogleCloudVisionV1p4beta1WebDetectionWebLabel
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1WebDetectionWebLabel"
              (\ o ->
                 GoogleCloudVisionV1p4beta1WebDetectionWebLabel Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "languageCode"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1WebDetectionWebLabel
         where
...
newGoogleCloudVisionV1p4beta1WebDetectionWebPage 
    :: 
                                                 GoogleCloudVisionV1p4beta1WebDetectionWebPage
newGoogleCloudVisionV1p4beta1WebDetectionWebPage
  = GoogleCloudVisionV1p4beta1WebDetectionWebPage{fullMatchingImages
                                                    = Core.Nothing,
                                                  pageTitle = Core.Nothing,
                                                  partialMatchingImages = Core.Nothing,
                                                  score = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1WebDetectionWebPage"
              (\ o ->
                 GoogleCloudVisionV1p4beta1WebDetectionWebPage Core.<$>
                   (o Core..:? "fullMatchingImages") Core.<*> (o Core..:? "pageTitle")
                     Core.<*> (o Core..:? "partialMatchingImages")
                     Core.<*> (o Core..:? "score")
                     Core.<*> (o Core..:? "url"))

instance Core.ToJSON GoogleCloudVisionV1p4beta1WebDetectionWebPage
         where
...
newGoogleCloudVisionV1p4beta1Word 
    ::  GoogleCloudVisionV1p4beta1Word
newGoogleCloudVisionV1p4beta1Word
  = GoogleCloudVisionV1p4beta1Word{boundingBox = Core.Nothing,
                                   confidence = Core.Nothing, property = Core.Nothing,
                                   symbols = Core.Nothing}
instance Core.FromJSON GoogleCloudVisionV1p4beta1Word where
        parseJSON
          = Core.withObject "GoogleCloudVisionV1p4beta1Word"
              (\ o ->
                 GoogleCloudVisionV1p4beta1Word Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "symbols"))
...
newGroupedResult 
    ::  GroupedResult
newGroupedResult
  = GroupedResult{boundingPoly = Core.Nothing,
                  objectAnnotations = Core.Nothing, results = Core.Nothing}
instance Core.FromJSON GroupedResult where
        parseJSON
          = Core.withObject "GroupedResult"
              (\ o ->
                 GroupedResult Core.<$>
                   (o Core..:? "boundingPoly") Core.<*>
                     (o Core..:? "objectAnnotations")
...
newImageAnnotationContext 
    ::  ImageAnnotationContext
newImageAnnotationContext
  = ImageAnnotationContext{pageNumber = Core.Nothing,
                           uri = Core.Nothing}
instance Core.FromJSON ImageAnnotationContext where
        parseJSON
          = Core.withObject "ImageAnnotationContext"
              (\ o ->
                 ImageAnnotationContext Core.<$>
                   (o Core..:? "pageNumber") Core.<*> (o Core..:? "uri"))
...
instance Core.FromJSON ImageProperties where
        parseJSON
          = Core.withObject "ImageProperties"
...
newImportProductSetsResponse 
    ::  ImportProductSetsResponse
newImportProductSetsResponse
  = ImportProductSetsResponse{referenceImages = Core.Nothing,
                              statuses = Core.Nothing}
instance Core.FromJSON ImportProductSetsResponse where
        parseJSON
          = Core.withObject "ImportProductSetsResponse"
              (\ o ->
                 ImportProductSetsResponse Core.<$>
                   (o Core..:? "referenceImages") Core.<*> (o Core..:? "statuses"))
...
newInputConfig 
    ::  InputConfig
newInputConfig
  = InputConfig{content = Core.Nothing, gcsSource = Core.Nothing,
                mimeType = Core.Nothing}
instance Core.FromJSON InputConfig where
        parseJSON
          = Core.withObject "InputConfig"
              (\ o ->
                 InputConfig Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "gcsSource") Core.<*>
                     (o Core..:? "mimeType"))
...
newLocalizedObjectAnnotation 
    ::  LocalizedObjectAnnotation
newLocalizedObjectAnnotation
  = LocalizedObjectAnnotation{boundingPoly = Core.Nothing,
                              languageCode = Core.Nothing, mid = Core.Nothing,
                              name = Core.Nothing, score = Core.Nothing}
instance Core.FromJSON LocalizedObjectAnnotation where
        parseJSON
          = Core.withObject "LocalizedObjectAnnotation"
              (\ o ->
                 LocalizedObjectAnnotation Core.<$>
                   (o Core..:? "boundingPoly") Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "mid")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "score"))
...
instance Core.FromJSON NormalizedVertex where
        parseJSON
          = Core.withObject "NormalizedVertex"
              (\ o ->
                 NormalizedVertex Core.<$>
                   (o Core..:? "x") Core.<*> (o Core..:? "y"))
...
newObjectAnnotation 
    ::  ObjectAnnotation
newObjectAnnotation
  = ObjectAnnotation{languageCode = Core.Nothing, mid = Core.Nothing,
                     name = Core.Nothing, score = Core.Nothing}
instance Core.FromJSON ObjectAnnotation where
        parseJSON
          = Core.withObject "ObjectAnnotation"
              (\ o ->
                 ObjectAnnotation Core.<$>
                   (o Core..:? "languageCode") Core.<*> (o Core..:? "mid") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "score"))
...
newOperationMetadata 
    ::  OperationMetadata
newOperationMetadata
  = OperationMetadata{createTime = Core.Nothing,
                      state = Core.Nothing, updateTime = Core.Nothing}
...
newOutputConfig 
    ::  OutputConfig
newOutputConfig
  = OutputConfig{batchSize = Core.Nothing,
                 gcsDestination = Core.Nothing}
instance Core.FromJSON OutputConfig where
        parseJSON
          = Core.withObject "OutputConfig"
              (\ o ->
                 OutputConfig Core.<$>
                   (o Core..:? "batchSize") Core.<*> (o Core..:? "gcsDestination"))
...
newPage 
    ::  Page
newPage
  = Page{blocks = Core.Nothing, confidence = Core.Nothing,
         height = Core.Nothing, property = Core.Nothing,
         width = Core.Nothing}
...
newParagraph 
    ::  Paragraph
newParagraph
  = Paragraph{boundingBox = Core.Nothing, confidence = Core.Nothing,
              property = Core.Nothing, words = Core.Nothing}
instance Core.FromJSON Paragraph where
        parseJSON
          = Core.withObject "Paragraph"
              (\ o ->
                 Paragraph Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
...
newProduct 
    ::  Product
newProduct
  = Product{description = Core.Nothing, displayName = Core.Nothing,
            name = Core.Nothing, productCategory = Core.Nothing,
...
newProductSearchResults 
    ::  ProductSearchResults
newProductSearchResults
  = ProductSearchResults{indexTime = Core.Nothing,
                         productGroupedResults = Core.Nothing, results = Core.Nothing}
instance Core.FromJSON ProductSearchResults where
        parseJSON
          = Core.withObject "ProductSearchResults"
              (\ o ->
                 ProductSearchResults Core.<$>
                   (o Core..:? "indexTime") Core.<*>
                     (o Core..:? "productGroupedResults")
                     Core.<*> (o Core..:? "results"))
...
newProperty 
    ::  Property
newProperty
  = Property{name = Core.Nothing, uint64Value = Core.Nothing,
             value = Core.Nothing}
instance Core.FromJSON Property where
        parseJSON
          = Core.withObject "Property"
              (\ o ->
                 Property Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "uint64Value" Core.<&> Core.fmap Core.fromAsText)
...
newReferenceImage 
    ::  ReferenceImage
newReferenceImage
  = ReferenceImage{boundingPolys = Core.Nothing, name = Core.Nothing,
                   uri = Core.Nothing}
instance Core.FromJSON ReferenceImage where
        parseJSON
          = Core.withObject "ReferenceImage"
              (\ o ->
                 ReferenceImage Core.<$>
                   (o Core..:? "boundingPolys") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "uri"))
...
newResult 
    ::  Result
newResult
  = Result{image = Core.Nothing, product = Core.Nothing,
           score = Core.Nothing}
...
newSafeSearchAnnotation 
    ::  SafeSearchAnnotation
newSafeSearchAnnotation
  = SafeSearchAnnotation{adult = Core.Nothing,
                         medical = Core.Nothing, racy = Core.Nothing, spoof = Core.Nothing,
                         violence = Core.Nothing}
instance Core.FromJSON SafeSearchAnnotation where
        parseJSON
          = Core.withObject "SafeSearchAnnotation"
              (\ o ->
                 SafeSearchAnnotation Core.<$>
                   (o Core..:? "adult") Core.<*> (o Core..:? "medical") Core.<*>
                     (o Core..:? "racy")
                     Core.<*> (o Core..:? "spoof")
                     Core.<*> (o Core..:? "violence"))
...
newSymbol 
    ::  Symbol
newSymbol
  = Symbol{boundingBox = Core.Nothing, confidence = Core.Nothing,
           property = Core.Nothing, text = Core.Nothing}
instance Core.FromJSON Symbol where
        parseJSON
          = Core.withObject "Symbol"
              (\ o ->
                 Symbol Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
...
instance Core.FromJSON TextAnnotation where
        parseJSON
          = Core.withObject "TextAnnotation"
              (\ o ->
                 TextAnnotation Core.<$>
                   (o Core..:? "pages") Core.<*> (o Core..:? "text"))
...
newTextProperty 
    ::  TextProperty
newTextProperty
  = TextProperty{detectedBreak = Core.Nothing,
                 detectedLanguages = Core.Nothing}
instance Core.FromJSON TextProperty where
        parseJSON
          = Core.withObject "TextProperty"
              (\ o ->
                 TextProperty Core.<$>
                   (o Core..:? "detectedBreak") Core.<*>
                     (o Core..:? "detectedLanguages"))
...
newWebDetection 
    ::  WebDetection
newWebDetection
  = WebDetection{bestGuessLabels = Core.Nothing,
                 fullMatchingImages = Core.Nothing,
                 pagesWithMatchingImages = Core.Nothing,
                 partialMatchingImages = Core.Nothing,
                 visuallySimilarImages = Core.Nothing, webEntities = Core.Nothing}
instance Core.FromJSON WebDetection where
        parseJSON
          = Core.withObject "WebDetection"
              (\ o ->
                 WebDetection Core.<$>
                   (o Core..:? "bestGuessLabels") Core.<*>
                     (o Core..:? "fullMatchingImages")
...
newWebEntity 
    ::  WebEntity
newWebEntity
  = WebEntity{description = Core.Nothing, entityId = Core.Nothing,
              score = Core.Nothing}
instance Core.FromJSON WebEntity where
        parseJSON
          = Core.withObject "WebEntity"
              (\ o ->
                 WebEntity Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "entityId")
                     Core.<*> (o Core..:? "score"))
...
newWebPage 
    ::  WebPage
newWebPage
  = WebPage{fullMatchingImages = Core.Nothing,
            pageTitle = Core.Nothing, partialMatchingImages = Core.Nothing,
            score = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON WebPage where
        parseJSON
          = Core.withObject "WebPage"
              (\ o ->
                 WebPage Core.<$>
                   (o Core..:? "fullMatchingImages") Core.<*> (o Core..:? "pageTitle")
                     Core.<*> (o Core..:? "partialMatchingImages")
...
newWord 
    ::  Word
newWord
  = Word{boundingBox = Core.Nothing, confidence = Core.Nothing,
         property = Core.Nothing, symbols = Core.Nothing}
instance Core.FromJSON Word where
        parseJSON
          = Core.withObject "Word"
              (\ o ->
                 Word Core.<$>
                   (o Core..:? "boundingBox") Core.<*> (o Core..:? "confidence")
                     Core.<*> (o Core..:? "property")
