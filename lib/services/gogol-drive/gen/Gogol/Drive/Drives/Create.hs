...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.drives.create@.
module Gogol.Drive.Drives.Create
    (
    -- * Resource
...
newDriveDrivesCreate payload requestId
  = DriveDrivesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DriveDrivesCreate where
        ...
        requestClient DriveDrivesCreate{..}
          = go (Core.Just requestId) xgafv accessToken callback uploadType
              uploadProtocol
