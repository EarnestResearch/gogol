...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.drives.delete@.
module Gogol.Drive.Drives.Delete
    (
    -- * Resource
           ...
           Core.Capture "driveId" Core.Text Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "allowItemDeletion" Core.Bool Core.:>
...
newDriveDrivesDelete driveId
  = DriveDrivesDelete{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, allowItemDeletion = Core.False,
                      callback = Core.Nothing, driveId = driveId,
...
instance Core.GoogleRequest DriveDrivesDelete where
        ...
        requestClient DriveDrivesDelete{..}
          = go driveId xgafv accessToken (Core.Just allowItemDeletion)
              callback
              uploadType
              uploadProtocol
