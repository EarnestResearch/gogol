...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.drives.unhide@.
module Gogol.Drive.Drives.Unhide
    (
    -- * Resource
...
newDriveDrivesUnhide driveId
  = DriveDrivesUnhide{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, callback = Core.Nothing,
                      driveId = driveId, uploadType = Core.Nothing,
