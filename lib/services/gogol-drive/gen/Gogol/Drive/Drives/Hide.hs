...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.drives.hide@.
module Gogol.Drive.Drives.Hide
    (
    -- * Resource
...
newDriveDrivesHide driveId
  = DriveDrivesHide{xgafv = Core.Nothing, accessToken = Core.Nothing,
