...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.drives.update@.
module Gogol.Drive.Drives.Update
    (
    -- * Resource
...
newDriveDrivesUpdate driveId payload
  = DriveDrivesUpdate{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, callback = Core.Nothing,
                      driveId = driveId, payload = payload, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DriveDrivesUpdate where
        ...
        requestClient DriveDrivesUpdate{..}
          = go driveId xgafv accessToken callback uploadType uploadProtocol
