...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.drives.get@.
module Gogol.Drive.Drives.Get
    (
    -- * Resource
...
newDriveDrivesGet driveId
  = DriveDrivesGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
