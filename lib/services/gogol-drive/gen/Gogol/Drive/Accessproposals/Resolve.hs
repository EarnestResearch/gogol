...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.accessproposals.resolve@.
module Gogol.Drive.Accessproposals.Resolve
    (
    -- * Resource
         ...
         "files" Core.:>
           Core.Capture "fileId" Core.Text Core.:>
             "accessproposals" Core.:>
               Core.CaptureMode "proposalId" "resolve" Core.Text Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ResolveAccessProposalRequest Core.:>
                               Core.Post '[Core.JSON] ()
...
newDriveAccessproposalsResolve fileId payload proposalId
  = DriveAccessproposalsResolve{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                fileId = fileId, payload = payload, proposalId = proposalId,
...
instance Core.GoogleRequest DriveAccessproposalsResolve where
        ...
        requestClient DriveAccessproposalsResolve{..}
          = go fileId proposalId xgafv accessToken callback uploadType
              uploadProtocol
