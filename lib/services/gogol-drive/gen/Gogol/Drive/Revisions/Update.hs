...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.revisions.update@.
module Gogol.Drive.Revisions.Update
    (
    -- * Resource
...
newDriveRevisionsUpdate fileId payload revisionId
  = DriveRevisionsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DriveRevisionsUpdate where
        ...
        requestClient DriveRevisionsUpdate{..}
          = go fileId revisionId xgafv accessToken callback uploadType
              uploadProtocol
