...
newAbout 
    ::  About
newAbout
  = About{appInstalled = Core.Nothing,
          canCreateDrives = Core.Nothing, canCreateTeamDrives = Core.Nothing,
          driveThemes = Core.Nothing, exportFormats = Core.Nothing,
          folderColorPalette = Core.Nothing, importFormats = Core.Nothing,
          kind = "drive#about", maxImportSizes = Core.Nothing,
          maxUploadSize = Core.Nothing, storageQuota = Core.Nothing,
          teamDriveThemes = Core.Nothing, user = Core.Nothing}
instance Core.FromJSON About where
        parseJSON
          = Core.withObject "About"
              (\ o ->
                 About Core.<$>
                   (o Core..:? "appInstalled") Core.<*> (o Core..:? "canCreateDrives")
                     ...
                     Core.<*>
                     (o Core..:? "maxUploadSize" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("appInstalled" Core..=) Core.<$> appInstalled,
                  ...
                  ("canCreateTeamDrives" Core..=) Core.<$> canCreateTeamDrives,
                  ("driveThemes" Core..=) Core.<$> driveThemes,
                  ("exportFormats" Core..=) Core.<$> exportFormats,
                  ("folderColorPalette" Core..=) Core.<$> folderColorPalette,
...
newAbout_DriveThemesItem 
    ::  About_DriveThemesItem
newAbout_DriveThemesItem
  = About_DriveThemesItem{backgroundImageLink = Core.Nothing,
                          colorRgb = Core.Nothing, id = Core.Nothing}
instance Core.FromJSON About_DriveThemesItem where
        parseJSON
          = Core.withObject "About_DriveThemesItem"
              (\ o ->
                 About_DriveThemesItem Core.<$>
                   (o Core..:? "backgroundImageLink") Core.<*> (o Core..:? "colorRgb")
                     Core.<*> (o Core..:? "id"))
...
instance Core.ToJSON About_DriveThemesItem where
        toJSON About_DriveThemesItem{..}
          = Core.object
              (Core.catMaybes
                 [("backgroundImageLink" Core..=) Core.<$> backgroundImageLink,
...
instance Core.FromJSON About_ExportFormats where
        parseJSON
          = Core.withObject "About_ExportFormats"
              (\ o -> About_ExportFormats Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON About_ExportFormats where
        toJSON About_ExportFormats{..} = Core.toJSON additional
...
instance Core.FromJSON About_ImportFormats where
        parseJSON
          = Core.withObject "About_ImportFormats"
              (\ o -> About_ImportFormats Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON About_ImportFormats where
        toJSON About_ImportFormats{..} = Core.toJSON additional
...
instance Core.FromJSON About_MaxImportSizes where
        parseJSON
          = Core.withObject "About_MaxImportSizes"
              (\ o -> About_MaxImportSizes Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON About_MaxImportSizes where
        toJSON About_MaxImportSizes{..} = Core.toJSON additional
...
newAbout_StorageQuota 
    ::  About_StorageQuota
newAbout_StorageQuota
  = About_StorageQuota{limit = Core.Nothing, usage = Core.Nothing,
                       usageInDrive = Core.Nothing, usageInDriveTrash = Core.Nothing}
instance Core.FromJSON About_StorageQuota where
        parseJSON
          = Core.withObject "About_StorageQuota"
              (\ o ->
                 About_StorageQuota Core.<$>
                   (o Core..:? "limit" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "usage" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "usageInDrive" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("limit" Core..=) Core.. Core.AsText Core.<$> limit,
                  ...
                  ("usageInDrive" Core..=) Core.. Core.AsText Core.<$> usageInDrive,
                  ("usageInDriveTrash" Core..=) Core.. Core.AsText Core.<$>
                    usageInDriveTrash])
...
newAbout_TeamDriveThemesItem 
    ::  About_TeamDriveThemesItem
newAbout_TeamDriveThemesItem
  = About_TeamDriveThemesItem{backgroundImageLink = Core.Nothing,
                              colorRgb = Core.Nothing, id = Core.Nothing}
...
newAccessProposal 
    ::  AccessProposal
newAccessProposal
  = AccessProposal{createTime = Core.Nothing, fileId = Core.Nothing,
                   proposalId = Core.Nothing, recipientEmailAddress = Core.Nothing,
                   requestMessage = Core.Nothing,
                   requesterEmailAddress = Core.Nothing, rolesAndViews = Core.Nothing}
instance Core.FromJSON AccessProposal where
        parseJSON
          = Core.withObject "AccessProposal"
              (\ o ->
                 AccessProposal Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "fileId") Core.<*>
                     (o Core..:? "proposalId")
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("recipientEmailAddress" Core..=) Core.<$> recipientEmailAddress,
                  ("requestMessage" Core..=) Core.<$> requestMessage,
                  ("requesterEmailAddress" Core..=) Core.<$> requesterEmailAddress,
...
newAccessProposalRoleAndView 
    ::  AccessProposalRoleAndView
newAccessProposalRoleAndView
  = AccessProposalRoleAndView{role' = Core.Nothing,
                              view = Core.Nothing}
instance Core.FromJSON AccessProposalRoleAndView where
        parseJSON
...
instance Core.ToJSON AccessProposalRoleAndView where
        toJSON AccessProposalRoleAndView{..}
          = Core.object
              (Core.catMaybes
                 [("role" Core..=) Core.<$> role', ("view" Core..=) Core.<$> view])
...
newApp 
    ::  App
newApp
  = App{authorized = Core.Nothing,
        createInFolderTemplate = Core.Nothing, createUrl = Core.Nothing,
        hasDriveWideScope = Core.Nothing, icons = Core.Nothing,
        id = Core.Nothing, installed = Core.Nothing, kind = "drive#app",
        longDescription = Core.Nothing, name = Core.Nothing,
        objectType = Core.Nothing, openUrlTemplate = Core.Nothing,
        primaryFileExtensions = Core.Nothing,
        primaryMimeTypes = Core.Nothing, productId = Core.Nothing,
        productUrl = Core.Nothing, secondaryFileExtensions = Core.Nothing,
        secondaryMimeTypes = Core.Nothing, shortDescription = Core.Nothing,
        supportsCreate = Core.Nothing, supportsImport = Core.Nothing,
        supportsMultiOpen = Core.Nothing,
        supportsOfflineCreate = Core.Nothing, useByDefault = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("authorized" Core..=) Core.<$> authorized,
                  ("createInFolderTemplate" Core..=) Core.<$> createInFolderTemplate,
                  ("createUrl" Core..=) Core.<$> createUrl,
                  ("hasDriveWideScope" Core..=) Core.<$> hasDriveWideScope,
                  ("icons" Core..=) Core.<$> icons, ("id" Core..=) Core.<$> id,
                  ...
                  ("primaryFileExtensions" Core..=) Core.<$> primaryFileExtensions,
                  ("primaryMimeTypes" Core..=) Core.<$> primaryMimeTypes,
                  ("productId" Core..=) Core.<$> productId,
                  ("productUrl" Core..=) Core.<$> productUrl,
                  ("secondaryFileExtensions" Core..=) Core.<$>
                    secondaryFileExtensions,
                  ("secondaryMimeTypes" Core..=) Core.<$> secondaryMimeTypes,
                  ...
                  ("supportsMultiOpen" Core..=) Core.<$> supportsMultiOpen,
                  ("supportsOfflineCreate" Core..=) Core.<$> supportsOfflineCreate,
...
newAppIcons 
    ::  AppIcons
newAppIcons
  = AppIcons{category = Core.Nothing, iconUrl = Core.Nothing,
             size = Core.Nothing}
instance Core.FromJSON AppIcons where
        parseJSON
          = Core.withObject "AppIcons"
              (\ o ->
                 AppIcons Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "iconUrl") Core.<*>
                     (o Core..:? "size"))
...
newAppList 
    ::  AppList
newAppList
  = AppList{defaultAppIds = Core.Nothing, items = Core.Nothing,
            kind = "drive#appList", selfLink = Core.Nothing}
instance Core.FromJSON AppList where
        parseJSON
          = Core.withObject "AppList"
              (\ o ->
                 AppList Core.<$>
                   (o Core..:? "defaultAppIds") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "drive#appList")
          ...
          = Core.object
              (Core.catMaybes
                 [("defaultAppIds" Core..=) Core.<$> defaultAppIds,
                  ("items" Core..=) Core.<$> items, Core.Just ("kind" Core..= kind),
...
newChange 
    ::  Change
newChange
  = Change{changeType = Core.Nothing, drive = Core.Nothing,
           driveId = Core.Nothing, file = Core.Nothing, fileId = Core.Nothing,
           kind = "drive#change", removed = Core.Nothing,
           teamDrive = Core.Nothing, teamDriveId = Core.Nothing,
           time = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Change where
        parseJSON
          = Core.withObject "Change"
              (\ o ->
                 Change Core.<$>
                   (o Core..:? "changeType") Core.<*> (o Core..:? "drive") Core.<*>
                     (o Core..:? "driveId")
                     Core.<*> (o Core..:? "file")
                     Core.<*> (o Core..:? "fileId")
...
newChangeList 
    ::  ChangeList
newChangeList
  = ChangeList{changes = Core.Nothing, kind = "drive#changeList",
               newStartPageToken' = Core.Nothing, nextPageToken = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("changes" Core..=) Core.<$> changes,
                  Core.Just ("kind" Core..= kind),
                  ("newStartPageToken" Core..=) Core.<$> newStartPageToken',
...
data Comment = Comment
    {
      -- | A region of the document represented as a JSON string. For details on defining anchor properties, refer to <https://developers.google.com/workspace/drive/api/v3/manage-comments Manage comments and replies>.
...
newComment 
    ::  Comment
newComment
  = Comment{anchor = Core.Nothing, author = Core.Nothing,
            content = Core.Nothing, createdTime = Core.Nothing,
            deleted = Core.Nothing, htmlContent = Core.Nothing,
            id = Core.Nothing, kind = "drive#comment",
            modifiedTime = Core.Nothing, quotedFileContent = Core.Nothing,
            replies = Core.Nothing, resolved = Core.Nothing}
instance Core.FromJSON Comment where
        parseJSON
          = Core.withObject "Comment"
              (\ o ->
                 Comment Core.<$>
                   (o Core..:? "anchor") Core.<*> (o Core..:? "author") Core.<*>
                     (o Core..:? "content")
          ...
          = Core.object
              (Core.catMaybes
                 [("anchor" Core..=) Core.<$> anchor,
                  ...
                  ("quotedFileContent" Core..=) Core.<$> quotedFileContent,
...
newComment_QuotedFileContent 
    ::  Comment_QuotedFileContent
newComment_QuotedFileContent
  = Comment_QuotedFileContent{mimeType = Core.Nothing,
                              value = Core.Nothing}
          ...
          = Core.withObject "Comment_QuotedFileContent"
              (\ o ->
                 Comment_QuotedFileContent Core.<$>
                   (o Core..:? "mimeType") Core.<*> (o Core..:? "value"))
...
newCommentList 
    ::  CommentList
newCommentList
  = CommentList{comments = Core.Nothing, kind = "drive#commentList",
...
newContentRestriction 
    ::  ContentRestriction
newContentRestriction
  = ContentRestriction{ownerRestricted = Core.Nothing,
                       readOnly = Core.Nothing, reason = Core.Nothing,
                       restrictingUser = Core.Nothing, restrictionTime = Core.Nothing,
                       systemRestricted = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON ContentRestriction where
        parseJSON
          = Core.withObject "ContentRestriction"
              (\ o ->
                 ContentRestriction Core.<$>
                   (o Core..:? "ownerRestricted") Core.<*> (o Core..:? "readOnly")
                     Core.<*> (o Core..:? "reason")
...
newDownloadRestriction 
    ::  DownloadRestriction
newDownloadRestriction
  = DownloadRestriction{restrictedForReaders = Core.Nothing,
                        restrictedForWriters = Core.Nothing}
instance Core.FromJSON DownloadRestriction where
        parseJSON
          = Core.withObject "DownloadRestriction"
              (\ o ->
                 DownloadRestriction Core.<$>
                   (o Core..:? "restrictedForReaders") Core.<*>
                     (o Core..:? "restrictedForWriters"))
...
newDrive 
    ::  Drive
newDrive
  = Drive{backgroundImageFile = Core.Nothing,
          backgroundImageLink = Core.Nothing, capabilities = Core.Nothing,
          colorRgb = Core.Nothing, createdTime = Core.Nothing,
          hidden = Core.Nothing, id = Core.Nothing, kind = "drive#drive",
          name = Core.Nothing, orgUnitId = Core.Nothing,
          restrictions = Core.Nothing, themeId = Core.Nothing}
...
instance Core.ToJSON Drive where
        toJSON Drive{..}
          = Core.object
              (Core.catMaybes
                 [("backgroundImageFile" Core..=) Core.<$> backgroundImageFile,
                  ("backgroundImageLink" Core..=) Core.<$> backgroundImageLink,
                  ("capabilities" Core..=) Core.<$> capabilities,
                  ("colorRgb" Core..=) Core.<$> colorRgb,
                  ("createdTime" Core..=) Core.<$> createdTime,
                  ("hidden" Core..=) Core.<$> hidden, ("id" Core..=) Core.<$> id,
...
newDrive_BackgroundImageFile 
    ::  Drive_BackgroundImageFile
newDrive_BackgroundImageFile
  = Drive_BackgroundImageFile{id = Core.Nothing,
                              width = Core.Nothing, xCoordinate = Core.Nothing,
          ...
          = Core.withObject "Drive_BackgroundImageFile"
              (\ o ->
                 Drive_BackgroundImageFile Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "width") Core.<*>
                     (o Core..:? "xCoordinate")
...
instance Core.ToJSON Drive_BackgroundImageFile where
        toJSON Drive_BackgroundImageFile{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("width" Core..=) Core.<$> width,
...
newDrive_Capabilities 
    ::  Drive_Capabilities
newDrive_Capabilities
  = Drive_Capabilities{canAddChildren = Core.Nothing,
                       ...
                       canChangeSharingFoldersRequiresOrganizerPermissionRestriction =
                         Core.Nothing,
                       canComment = Core.Nothing, canCopy = Core.Nothing,
                       canDeleteChildren = Core.Nothing, canDeleteDrive = Core.Nothing,
                       canDownload = Core.Nothing, canEdit = Core.Nothing,
                       canListChildren = Core.Nothing, canManageMembers = Core.Nothing,
                       canReadRevisions = Core.Nothing, canRename = Core.Nothing,
                       canRenameDrive = Core.Nothing,
                       canResetDriveRestrictions = Core.Nothing, canShare = Core.Nothing,
              ...
              (\ o ->
                 Drive_Capabilities Core.<$>
                   (o Core..:? "canAddChildren") Core.<*>
                     (o Core..:? "canChangeCopyRequiresWriterPermissionRestriction")
          ...
          = Core.object
              (Core.catMaybes
                 [("canAddChildren" Core..=) Core.<$> canAddChildren,
                  ("canChangeCopyRequiresWriterPermissionRestriction" Core..=)
                    Core.<$> canChangeCopyRequiresWriterPermissionRestriction,
                  ("canChangeDomainUsersOnlyRestriction" Core..=) Core.<$>
                    canChangeDomainUsersOnlyRestriction,
                  ("canChangeDriveBackground" Core..=) Core.<$>
                    canChangeDriveBackground,
                  ("canChangeDriveMembersOnlyRestriction" Core..=) Core.<$>
                  ...
                  ("canManageMembers" Core..=) Core.<$> canManageMembers,
                  ("canReadRevisions" Core..=) Core.<$> canReadRevisions,
                  ...
                  ("canTrashChildren" Core..=) Core.<$> canTrashChildren])
...
newDrive_Restrictions 
    ::  Drive_Restrictions
newDrive_Restrictions
  = Drive_Restrictions{adminManagedRestrictions = Core.Nothing,
                       copyRequiresWriterPermission = Core.Nothing,
                       domainUsersOnly = Core.Nothing, downloadRestriction = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("adminManagedRestrictions" Core..=) Core.<$>
                  ...
                  ("sharingFoldersRequiresOrganizerPermission" Core..=) Core.<$>
...
newDriveList 
    ::  DriveList
newDriveList
  = DriveList{drives = Core.Nothing, kind = "drive#driveList",
              nextPageToken = Core.Nothing}
...
newFile 
    ::  File
newFile
  = File{appProperties = Core.Nothing, capabilities = Core.Nothing,
         contentHints = Core.Nothing, contentRestrictions = Core.Nothing,
         copyRequiresWriterPermission = Core.Nothing,
         createdTime = Core.Nothing, description = Core.Nothing,
         driveId = Core.Nothing, explicitlyTrashed = Core.Nothing,
         exportLinks = Core.Nothing, fileExtension = Core.Nothing,
         folderColorRgb = Core.Nothing, fullFileExtension = Core.Nothing,
         hasAugmentedPermissions = Core.Nothing,
         hasThumbnail = Core.Nothing, headRevisionId = Core.Nothing,
         iconLink = Core.Nothing, id = Core.Nothing,
         imageMediaMetadata = Core.Nothing,
         inheritedPermissionsDisabled = Core.Nothing,
         isAppAuthorized = Core.Nothing, kind = "drive#file",
         labelInfo = Core.Nothing, lastModifyingUser = Core.Nothing,
         linkShareMetadata = Core.Nothing, md5Checksum = Core.Nothing,
         mimeType = Core.Nothing, modifiedByMe = Core.Nothing,
         modifiedByMeTime = Core.Nothing, modifiedTime = Core.Nothing,
         name = Core.Nothing, originalFilename = Core.Nothing,
         ownedByMe = Core.Nothing, owners = Core.Nothing,
         parents = Core.Nothing, permissionIds = Core.Nothing,
         permissions = Core.Nothing, properties = Core.Nothing,
         quotaBytesUsed = Core.Nothing, resourceKey = Core.Nothing,
         sha1Checksum = Core.Nothing, sha256Checksum = Core.Nothing,
         shared = Core.Nothing, sharedWithMeTime = Core.Nothing,
         sharingUser = Core.Nothing, shortcutDetails = Core.Nothing,
         size = Core.Nothing, spaces = Core.Nothing, starred = Core.Nothing,
         teamDriveId = Core.Nothing, thumbnailLink = Core.Nothing,
         thumbnailVersion = Core.Nothing, trashed = Core.Nothing,
         trashedTime = Core.Nothing, trashingUser = Core.Nothing,
         version = Core.Nothing, videoMediaMetadata = Core.Nothing,
         viewedByMe = Core.Nothing, viewedByMeTime = Core.Nothing,
         viewersCanCopyContent = Core.Nothing,
         webContentLink = Core.Nothing, webViewLink = Core.Nothing,
...
instance Core.FromJSON File where
        parseJSON
          = Core.withObject "File"
              (\ o ->
                 File Core.<$>
                   (o Core..:? "appProperties") Core.<*> (o Core..:? "capabilities")
                     ...
                     Core.<*>
                     (o Core..:? "quotaBytesUsed" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "thumbnailVersion" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "trashed")
          ...
          = Core.object
              (Core.catMaybes
                 [("appProperties" Core..=) Core.<$> appProperties,
                  ...
                  ("quotaBytesUsed" Core..=) Core.. Core.AsText Core.<$>
                    quotaBytesUsed,
                  ...
                  ("sharedWithMeTime" Core..=) Core.<$> sharedWithMeTime,
                  ...
                  ("thumbnailVersion" Core..=) Core.. Core.AsText Core.<$>
                    thumbnailVersion,
...
newFile_AppProperties 
    :: 
       ...
       -- ^  See 'additional'.
    -> File_AppProperties
newFile_AppProperties additional
  = File_AppProperties{additional = additional}
instance Core.FromJSON File_AppProperties where
        parseJSON
          = Core.withObject "File_AppProperties"
              (\ o -> File_AppProperties Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON File_AppProperties where
        toJSON File_AppProperties{..} = Core.toJSON additional
...
newFile_Capabilities 
    ::  File_Capabilities
newFile_Capabilities
  = File_Capabilities{canAcceptOwnership = Core.Nothing,
                      ...
                      canComment = Core.Nothing, canCopy = Core.Nothing,
                      canDelete = Core.Nothing, canDeleteChildren = Core.Nothing,
                      canDisableInheritedPermissions = Core.Nothing,
                      canDownload = Core.Nothing, canEdit = Core.Nothing,
                      canEnableInheritedPermissions = Core.Nothing,
                      canListChildren = Core.Nothing, canModifyContent = Core.Nothing,
                      ...
                      canMoveTeamDriveItem = Core.Nothing, canReadDrive = Core.Nothing,
                      canReadLabels = Core.Nothing, canReadRevisions = Core.Nothing,
                      canReadTeamDrive = Core.Nothing, canRemoveChildren = Core.Nothing,
                      canRemoveContentRestriction = Core.Nothing,
                      canRemoveMyDriveParent = Core.Nothing, canRename = Core.Nothing,
                      canShare = Core.Nothing, canTrash = Core.Nothing,
                      canTrashChildren = Core.Nothing, canUntrash = Core.Nothing}
              ...
              (\ o ->
                 File_Capabilities Core.<$>
                   (o Core..:? "canAcceptOwnership") Core.<*>
                     ...
                     Core.<*> (o Core..:? "canModifyOwnerContentRestriction")
...
instance Core.ToJSON File_Capabilities where
        toJSON File_Capabilities{..}
          = Core.object
              (Core.catMaybes
                 [("canAcceptOwnership" Core..=) Core.<$> canAcceptOwnership,
                  ("canAddChildren" Core..=) Core.<$> canAddChildren,
                  ("canAddFolderFromAnotherDrive" Core..=) Core.<$>
                    canAddFolderFromAnotherDrive,
                  ("canAddMyDriveParent" Core..=) Core.<$> canAddMyDriveParent,
                  ("canChangeCopyRequiresWriterPermission" Core..=) Core.<$>
                  ...
                  ("canMoveItemOutOfDrive" Core..=) Core.<$> canMoveItemOutOfDrive,
                  ("canMoveItemOutOfTeamDrive" Core..=) Core.<$>
                    canMoveItemOutOfTeamDrive,
                  ("canMoveItemWithinDrive" Core..=) Core.<$> canMoveItemWithinDrive,
                  ("canMoveItemWithinTeamDrive" Core..=) Core.<$>
                    canMoveItemWithinTeamDrive,
                  ("canMoveTeamDriveItem" Core..=) Core.<$> canMoveTeamDriveItem,
                  ("canReadDrive" Core..=) Core.<$> canReadDrive,
                  ("canReadLabels" Core..=) Core.<$> canReadLabels,
                  ("canReadRevisions" Core..=) Core.<$> canReadRevisions,
                  ("canReadTeamDrive" Core..=) Core.<$> canReadTeamDrive,
                  ("canRemoveChildren" Core..=) Core.<$> canRemoveChildren,
                  ("canRemoveContentRestriction" Core..=) Core.<$>
                    canRemoveContentRestriction,
                  ("canRemoveMyDriveParent" Core..=) Core.<$> canRemoveMyDriveParent,
                  ("canRename" Core..=) Core.<$> canRename,
                  ("canShare" Core..=) Core.<$> canShare,
...
newFile_ContentHints 
    ::  File_ContentHints
newFile_ContentHints
  = File_ContentHints{indexableText = Core.Nothing,
          ...
          = Core.withObject "File_ContentHints"
              (\ o ->
                 File_ContentHints Core.<$>
                   (o Core..:? "indexableText") Core.<*> (o Core..:? "thumbnail"))
...
newFile_ContentHints_Thumbnail 
    ::  File_ContentHints_Thumbnail
newFile_ContentHints_Thumbnail
  = File_ContentHints_Thumbnail{image = Core.Nothing,
          ...
          = Core.withObject "File_ContentHints_Thumbnail"
              (\ o ->
                 File_ContentHints_Thumbnail Core.<$>
                   (o Core..:? "image") Core.<*> (o Core..:? "mimeType"))
...
newFile_ExportLinks 
    :: 
       ...
       -- ^  See 'additional'.
    -> File_ExportLinks
newFile_ExportLinks additional
  = File_ExportLinks{additional = additional}
instance Core.FromJSON File_ExportLinks where
        parseJSON
          = Core.withObject "File_ExportLinks"
              (\ o -> File_ExportLinks Core.<$> (Core.parseJSONObject o))
...
newFile_ImageMediaMetadata 
    ::  File_ImageMediaMetadata
newFile_ImageMediaMetadata
  = File_ImageMediaMetadata{aperture = Core.Nothing,
                            cameraMake = Core.Nothing, cameraModel = Core.Nothing,
                            colorSpace = Core.Nothing, exposureBias = Core.Nothing,
                            exposureMode = Core.Nothing, exposureTime = Core.Nothing,
                            flashUsed = Core.Nothing, focalLength = Core.Nothing,
                            height = Core.Nothing, isoSpeed = Core.Nothing,
                            lens = Core.Nothing, location = Core.Nothing,
                            maxApertureValue = Core.Nothing, meteringMode = Core.Nothing,
                            rotation = Core.Nothing, sensor = Core.Nothing,
                            subjectDistance = Core.Nothing, time = Core.Nothing,
                            whiteBalance = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON File_ImageMediaMetadata where
        parseJSON
          = Core.withObject "File_ImageMediaMetadata"
              (\ o ->
                 File_ImageMediaMetadata Core.<$>
                   (o Core..:? "aperture") Core.<*> (o Core..:? "cameraMake") Core.<*>
                     (o Core..:? "cameraModel")
          ...
          = Core.object
              (Core.catMaybes
                 [("aperture" Core..=) Core.<$> aperture,
                  ...
                  ("maxApertureValue" Core..=) Core.<$> maxApertureValue,
...
newFile_ImageMediaMetadata_Location 
    :: 
                                    File_ImageMediaMetadata_Location
newFile_ImageMediaMetadata_Location
  = File_ImageMediaMetadata_Location{altitude = Core.Nothing,
                                     latitude = Core.Nothing, longitude = Core.Nothing}
instance Core.FromJSON File_ImageMediaMetadata_Location where
        parseJSON
          = Core.withObject "File_ImageMediaMetadata_Location"
              (\ o ->
                 File_ImageMediaMetadata_Location Core.<$>
                   (o Core..:? "altitude") Core.<*> (o Core..:? "latitude") Core.<*>
                     (o Core..:? "longitude"))
...
instance Core.FromJSON File_LabelInfo where
        parseJSON
          = Core.withObject "File_LabelInfo"
              (\ o -> File_LabelInfo Core.<$> (o Core..:? "labels"))
...
newFile_LinkShareMetadata 
    ::  File_LinkShareMetadata
newFile_LinkShareMetadata
  = File_LinkShareMetadata{securityUpdateEligible = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("securityUpdateEligible" Core..=) Core.<$>
                  ...
                  ("securityUpdateEnabled" Core..=) Core.<$> securityUpdateEnabled])
...
newFile_Properties 
    :: 
       ...
       -- ^  See 'additional'.
    -> File_Properties
newFile_Properties additional
  = File_Properties{additional = additional}
instance Core.FromJSON File_Properties where
        parseJSON
          = Core.withObject "File_Properties"
              (\ o -> File_Properties Core.<$> (Core.parseJSONObject o))
...
newFile_ShortcutDetails 
    ::  File_ShortcutDetails
newFile_ShortcutDetails
  = File_ShortcutDetails{targetId = Core.Nothing,
                         targetMimeType = Core.Nothing, targetResourceKey = Core.Nothing}
instance Core.FromJSON File_ShortcutDetails where
        parseJSON
          = Core.withObject "File_ShortcutDetails"
              (\ o ->
                 File_ShortcutDetails Core.<$>
                   (o Core..:? "targetId") Core.<*> (o Core..:? "targetMimeType")
          ...
          = Core.object
              (Core.catMaybes
                 [("targetId" Core..=) Core.<$> targetId,
                  ...
                  ("targetResourceKey" Core..=) Core.<$> targetResourceKey])
...
newFile_VideoMediaMetadata 
    ::  File_VideoMediaMetadata
newFile_VideoMediaMetadata
  = File_VideoMediaMetadata{durationMillis = Core.Nothing,
...
newFileList 
    ::  FileList
newFileList
  = FileList{files = Core.Nothing, incompleteSearch = Core.Nothing,
             kind = "drive#fileList", nextPageToken = Core.Nothing}
instance Core.FromJSON FileList where
        parseJSON
          = Core.withObject "FileList"
              (\ o ->
                 FileList Core.<$>
                   (o Core..:? "files") Core.<*> (o Core..:? "incompleteSearch")
          ...
          = Core.object
              (Core.catMaybes
                 [("files" Core..=) Core.<$> files,
                  ("incompleteSearch" Core..=) Core.<$> incompleteSearch,
                  Core.Just ("kind" Core..= kind),
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newGeneratedIds 
    ::  GeneratedIds
newGeneratedIds
  = GeneratedIds{ids = Core.Nothing, kind = "drive#generatedIds",
                 space = Core.Nothing}
...
instance Core.ToJSON GeneratedIds where
        toJSON GeneratedIds{..}
          = Core.object
              (Core.catMaybes
                 [("ids" Core..=) Core.<$> ids, Core.Just ("kind" Core..= kind),
...
newLabel 
    ::  Label
newLabel
  = Label{fields = Core.Nothing, id = Core.Nothing,
          kind = Core.Nothing, revisionId = Core.Nothing}
instance Core.FromJSON Label where
        parseJSON
          = Core.withObject "Label"
              (\ o ->
                 Label Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind")
...
instance Core.ToJSON Label where
        toJSON Label{..}
          = Core.object
              (Core.catMaybes
                 [("fields" Core..=) Core.<$> fields, ("id" Core..=) Core.<$> id,
                  ("kind" Core..=) Core.<$> kind,
...
instance Core.FromJSON Label_Fields where
        parseJSON
          = Core.withObject "Label_Fields"
              (\ o -> Label_Fields Core.<$> (Core.parseJSONObject o))
...
newLabelField 
    ::  LabelField
newLabelField
  = LabelField{dateString = Core.Nothing, id = Core.Nothing,
               integer = Core.Nothing, kind = Core.Nothing,
               selection = Core.Nothing, text = Core.Nothing, user = Core.Nothing,
...
instance Core.FromJSON LabelField where
        parseJSON
          = Core.withObject "LabelField"
              (\ o ->
                 LabelField Core.<$>
                   (o Core..:? "dateString") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "integer" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("dateString" Core..=) Core.<$> dateString,
                  ("id" Core..=) Core.<$> id,
                  ("integer" Core..=) Core.. Core.fmap Core.AsText Core.<$> integer,
                  ("kind" Core..=) Core.<$> kind,
                  ("selection" Core..=) Core.<$> selection,
                  ("text" Core..=) Core.<$> text, ("user" Core..=) Core.<$> user,
...
newLabelFieldModification 
    ::  LabelFieldModification
newLabelFieldModification
  = LabelFieldModification{fieldId = Core.Nothing,
                           kind = Core.Nothing, setDateValues = Core.Nothing,
                           setIntegerValues = Core.Nothing, setSelectionValues = Core.Nothing,
                           setTextValues = Core.Nothing, setUserValues = Core.Nothing,
          ...
          = Core.withObject "LabelFieldModification"
              (\ o ->
                 LabelFieldModification Core.<$>
                   (o Core..:? "fieldId") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "setDateValues")
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("fieldId" Core..=) Core.<$> fieldId,
                  ...
                  ("setIntegerValues" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    setIntegerValues,
                  ("setSelectionValues" Core..=) Core.<$> setSelectionValues,
...
newLabelList 
    ::  LabelList
newLabelList
  = LabelList{kind = Core.Nothing, labels = Core.Nothing,
              nextPageToken = Core.Nothing}
instance Core.FromJSON LabelList where
        parseJSON
          = Core.withObject "LabelList"
              (\ o ->
                 LabelList Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "labels") Core.<*>
...
newLabelModification 
    ::  LabelModification
newLabelModification
  = LabelModification{fieldModifications = Core.Nothing,
                      kind = Core.Nothing, labelId = Core.Nothing,
          ...
          = Core.withObject "LabelModification"
              (\ o ->
                 LabelModification Core.<$>
                   (o Core..:? "fieldModifications") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "labelId")
...
instance Core.ToJSON LabelModification where
        toJSON LabelModification{..}
          = Core.object
              (Core.catMaybes
                 [("fieldModifications" Core..=) Core.<$> fieldModifications,
                  ("kind" Core..=) Core.<$> kind,
...
newListAccessProposalsResponse 
    ::  ListAccessProposalsResponse
newListAccessProposalsResponse
  = ListAccessProposalsResponse{accessProposals = Core.Nothing,
                                nextPageToken = Core.Nothing}
instance Core.FromJSON ListAccessProposalsResponse where
        parseJSON
...
instance Core.ToJSON ListAccessProposalsResponse where
        toJSON ListAccessProposalsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("accessProposals" Core..=) Core.<$> accessProposals,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newModifyLabelsRequest 
    ::  ModifyLabelsRequest
newModifyLabelsRequest
  = ModifyLabelsRequest{kind = Core.Nothing,
          ...
          = Core.withObject "ModifyLabelsRequest"
              (\ o ->
                 ModifyLabelsRequest Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "labelModifications"))
...
instance Core.ToJSON ModifyLabelsRequest where
        toJSON ModifyLabelsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ("labelModifications" Core..=) Core.<$> labelModifications])
...
newModifyLabelsResponse 
    ::  ModifyLabelsResponse
newModifyLabelsResponse
  = ModifyLabelsResponse{kind = Core.Nothing,
          ...
          = Core.withObject "ModifyLabelsResponse"
              (\ o ->
                 ModifyLabelsResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "modifiedLabels"))
...
newPermission 
    ::  Permission
newPermission
  = Permission{allowFileDiscovery = Core.Nothing,
               deleted = Core.Nothing, displayName = Core.Nothing,
               domain = Core.Nothing, emailAddress = Core.Nothing,
               expirationTime = Core.Nothing, id = Core.Nothing,
               inheritedPermissionsDisabled = Core.Nothing,
               kind = "drive#permission", pendingOwner = Core.Nothing,
               permissionDetails = Core.Nothing, photoLink = Core.Nothing,
               role' = Core.Nothing, teamDrivePermissionDetails = Core.Nothing,
               type' = Core.Nothing, view = Core.Nothing}
instance Core.FromJSON Permission where
        parseJSON
          = Core.withObject "Permission"
              (\ o ->
                 Permission Core.<$>
                   (o Core..:? "allowFileDiscovery") Core.<*> (o Core..:? "deleted")
...
instance Core.ToJSON Permission where
        toJSON Permission{..}
          = Core.object
              (Core.catMaybes
                 [("allowFileDiscovery" Core..=) Core.<$> allowFileDiscovery,
                  ("deleted" Core..=) Core.<$> deleted,
...
newPermission_PermissionDetailsItem 
    :: 
                                    Permission_PermissionDetailsItem
newPermission_PermissionDetailsItem
  = Permission_PermissionDetailsItem{inherited = Core.Nothing,
                                     inheritedFrom = Core.Nothing, permissionType = Core.Nothing,
                                     role' = Core.Nothing}
instance Core.FromJSON Permission_PermissionDetailsItem where
        parseJSON
          = Core.withObject "Permission_PermissionDetailsItem"
              (\ o ->
                 Permission_PermissionDetailsItem Core.<$>
                   (o Core..:? "inherited") Core.<*> (o Core..:? "inheritedFrom")
...
newPermission_TeamDrivePermissionDetailsItem 
    :: 
                                             Permission_TeamDrivePermissionDetailsItem
newPermission_TeamDrivePermissionDetailsItem
  = Permission_TeamDrivePermissionDetailsItem{inherited =
                                                Core.Nothing,
                                              inheritedFrom = Core.Nothing, role' = Core.Nothing,
                                              teamDrivePermissionType = Core.Nothing}
instance Core.FromJSON Permission_TeamDrivePermissionDetailsItem
         where
        parseJSON
          = Core.withObject "Permission_TeamDrivePermissionDetailsItem"
              (\ o ->
...
instance Core.ToJSON Permission_TeamDrivePermissionDetailsItem
         where
...
newPermissionList 
    ::  PermissionList
newPermissionList
  = PermissionList{kind = "drive#permissionList",
                   nextPageToken = Core.Nothing, permissions = Core.Nothing}
instance Core.FromJSON PermissionList where
        parseJSON
          = Core.withObject "PermissionList"
              (\ o ->
                 PermissionList Core.<$>
                   (o Core..:? "kind" Core..!= "drive#permissionList") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "permissions"))
...
newReply 
    ::  Reply
newReply
  = Reply{action = Core.Nothing, author = Core.Nothing,
          content = Core.Nothing, createdTime = Core.Nothing,
          deleted = Core.Nothing, htmlContent = Core.Nothing,
          id = Core.Nothing, kind = "drive#reply",
...
instance Core.FromJSON Reply where
        parseJSON
          = Core.withObject "Reply"
              (\ o ->
                 Reply Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "author") Core.<*>
                     (o Core..:? "content")
                     Core.<*> (o Core..:? "createdTime")
                     Core.<*> (o Core..:? "deleted")
                     Core.<*> (o Core..:? "htmlContent")
...
newReplyList 
    ::  ReplyList
newReplyList
  = ReplyList{kind = "drive#replyList", nextPageToken = Core.Nothing,
...
instance Core.FromJSON ReplyList where
        parseJSON
          = Core.withObject "ReplyList"
              (\ o ->
                 ReplyList Core.<$>
                   (o Core..:? "kind" Core..!= "drive#replyList") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "replies"))
...
newResolveAccessProposalRequest 
    ::  ResolveAccessProposalRequest
newResolveAccessProposalRequest
  = ResolveAccessProposalRequest{action = Core.Nothing,
                                 role' = Core.Nothing, sendNotification = Core.Nothing,
                                 view = Core.Nothing}
instance Core.FromJSON ResolveAccessProposalRequest where
        parseJSON
          = Core.withObject "ResolveAccessProposalRequest"
              (\ o ->
                 ResolveAccessProposalRequest Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "role") Core.<*>
                     (o Core..:? "sendNotification")
                     Core.<*> (o Core..:? "view"))

instance Core.ToJSON ResolveAccessProposalRequest where
...
newRevision 
    ::  Revision
newRevision
  = Revision{exportLinks = Core.Nothing, id = Core.Nothing,
             keepForever = Core.Nothing, kind = "drive#revision",
             lastModifyingUser = Core.Nothing, md5Checksum = Core.Nothing,
             mimeType = Core.Nothing, modifiedTime = Core.Nothing,
             originalFilename = Core.Nothing, publishAuto = Core.Nothing,
             published = Core.Nothing, publishedLink = Core.Nothing,
             publishedOutsideDomain = Core.Nothing, size = Core.Nothing}
instance Core.FromJSON Revision where
        parseJSON
          = Core.withObject "Revision"
              (\ o ->
                 Revision Core.<$>
                   (o Core..:? "exportLinks") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "keepForever")
          ...
          = Core.object
              (Core.catMaybes
                 [("exportLinks" Core..=) Core.<$> exportLinks,
                  ...
                  ("publishedOutsideDomain" Core..=) Core.<$> publishedOutsideDomain,
                  ("size" Core..=) Core.. Core.AsText Core.<$> size])
...
instance Core.FromJSON Revision_ExportLinks where
        parseJSON
          = Core.withObject "Revision_ExportLinks"
              (\ o -> Revision_ExportLinks Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Revision_ExportLinks where
        toJSON Revision_ExportLinks{..} = Core.toJSON additional
...
newRevisionList 
    ::  RevisionList
newRevisionList
  = RevisionList{kind = "drive#revisionList",
...
instance Core.FromJSON RevisionList where
        parseJSON
          = Core.withObject "RevisionList"
              (\ o ->
                 RevisionList Core.<$>
                   (o Core..:? "kind" Core..!= "drive#revisionList") Core.<*>
                     (o Core..:? "nextPageToken")
...
newStartPageToken 
    ::  StartPageToken
newStartPageToken
  = StartPageToken{kind = "drive#startPageToken",
                   startPageToken = Core.Nothing}
instance Core.FromJSON StartPageToken where
        parseJSON
          = Core.withObject "StartPageToken"
              (\ o ->
                 StartPageToken Core.<$>
                   (o Core..:? "kind" Core..!= "drive#startPageToken") Core.<*>
                     (o Core..:? "startPageToken"))
...
newTeamDrive 
    ::  TeamDrive
newTeamDrive
  = TeamDrive{backgroundImageFile = Core.Nothing,
              backgroundImageLink = Core.Nothing, capabilities = Core.Nothing,
              colorRgb = Core.Nothing, createdTime = Core.Nothing,
              id = Core.Nothing, kind = "drive#teamDrive", name = Core.Nothing,
              orgUnitId = Core.Nothing, restrictions = Core.Nothing,
...
newTeamDrive_BackgroundImageFile 
    ::  TeamDrive_BackgroundImageFile
newTeamDrive_BackgroundImageFile
  = TeamDrive_BackgroundImageFile{id = Core.Nothing,
                                  width = Core.Nothing, xCoordinate = Core.Nothing,
                                  yCoordinate = Core.Nothing}
...
newTeamDrive_Capabilities 
    ::  TeamDrive_Capabilities
newTeamDrive_Capabilities
  = TeamDrive_Capabilities{canAddChildren = Core.Nothing,
                           canChangeCopyRequiresWriterPermissionRestriction = Core.Nothing,
                           canChangeDomainUsersOnlyRestriction = Core.Nothing,
                           canChangeSharingFoldersRequiresOrganizerPermissionRestriction =
                             Core.Nothing,
                           ...
                           canDeleteTeamDrive = Core.Nothing, canDownload = Core.Nothing,
                           canEdit = Core.Nothing, canListChildren = Core.Nothing,
                           canManageMembers = Core.Nothing, canReadRevisions = Core.Nothing,
                           canRemoveChildren = Core.Nothing, canRename = Core.Nothing,
                           canRenameTeamDrive = Core.Nothing,
                           canResetTeamDriveRestrictions = Core.Nothing,
                           canShare = Core.Nothing, canTrashChildren = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("canAddChildren" Core..=) Core.<$> canAddChildren,
                  ...
                  ("canChangeTeamMembersOnlyRestriction" Core..=) Core.<$>
                    canChangeTeamMembersOnlyRestriction,
                  ("canComment" Core..=) Core.<$> canComment,
                  ("canCopy" Core..=) Core.<$> canCopy,
                  ("canDeleteChildren" Core..=) Core.<$> canDeleteChildren,
                  ("canDeleteTeamDrive" Core..=) Core.<$> canDeleteTeamDrive,
                  ("canDownload" Core..=) Core.<$> canDownload,
                  ("canEdit" Core..=) Core.<$> canEdit,
                  ("canListChildren" Core..=) Core.<$> canListChildren,
                  ("canManageMembers" Core..=) Core.<$> canManageMembers,
                  ...
                  ("canRemoveChildren" Core..=) Core.<$> canRemoveChildren,
                  ("canRename" Core..=) Core.<$> canRename,
                  ("canRenameTeamDrive" Core..=) Core.<$> canRenameTeamDrive,
...
newTeamDrive_Restrictions 
    ::  TeamDrive_Restrictions
newTeamDrive_Restrictions
  = TeamDrive_Restrictions{adminManagedRestrictions = Core.Nothing,
                           copyRequiresWriterPermission = Core.Nothing,
                           domainUsersOnly = Core.Nothing, downloadRestriction = Core.Nothing,
                           sharingFoldersRequiresOrganizerPermission = Core.Nothing,
...
newTeamDriveList 
    ::  TeamDriveList
newTeamDriveList
  = TeamDriveList{kind = "drive#teamDriveList",
                  nextPageToken = Core.Nothing, teamDrives = Core.Nothing}
instance Core.FromJSON TeamDriveList where
        parseJSON
          = Core.withObject "TeamDriveList"
              (\ o ->
                 TeamDriveList Core.<$>
                   (o Core..:? "kind" Core..!= "drive#teamDriveList") Core.<*>
                     (o Core..:? "nextPageToken")
...
newUser
  = User{displayName = Core.Nothing, emailAddress = Core.Nothing,
         kind = "drive#user", me = Core.Nothing,
         permissionId = Core.Nothing, photoLink = Core.Nothing}
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User"
              (\ o ->
                 User Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "emailAddress")
        ...
        toJSON User{..}
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ("emailAddress" Core..=) Core.<$> emailAddress,
                  Core.Just ("kind" Core..= kind), ("me" Core..=) Core.<$> me,
