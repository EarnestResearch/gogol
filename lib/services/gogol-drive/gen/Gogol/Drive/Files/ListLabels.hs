...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.files.listLabels@.
module Gogol.Drive.Files.ListLabels
    (
    -- * Resource
...
newDriveFilesListLabels fileId
  = DriveFilesListLabels{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         fileId = fileId, maxResults = 100, pageToken = Core.Nothing,
...
instance Core.GoogleRequest DriveFilesListLabels where
        ...
        type Scopes DriveFilesListLabels =
             '[Drive'FullControl, Drive'File, Drive'Meet'Readonly,
               Drive'Metadata, Drive'Metadata'Readonly, Drive'Readonly]
        requestClient DriveFilesListLabels{..}
          = go fileId xgafv accessToken callback (Core.Just maxResults)
              pageToken
              uploadType
              uploadProtocol
