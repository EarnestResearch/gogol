...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.files.copy@.
module Gogol.Drive.Files.Copy
    (
    -- * Resource
...
newDriveFilesCopy fileId payload
  = DriveFilesCopy{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, enforceSingleParent = Core.False,
                   fileId = fileId, ignoreDefaultVisibility = Core.False,
