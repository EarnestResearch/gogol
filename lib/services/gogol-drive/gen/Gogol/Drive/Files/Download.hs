...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.files.download@.
module Gogol.Drive.Files.Download
    (
    -- * Resource
                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "mimeType" Core.Text Core.:>
                       Core.QueryParam "revisionId" Core.Text Core.:>
...
newDriveFilesDownload fileId
  = DriveFilesDownload{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, callback = Core.Nothing,
                       fileId = fileId, mimeType = Core.Nothing,
                       revisionId = Core.Nothing, uploadType = Core.Nothing,
                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DriveFilesDownload where
        type Rs DriveFilesDownload = Operation
        type Scopes DriveFilesDownload =
             '[Drive'FullControl, Drive'File, Drive'Readonly]
        requestClient DriveFilesDownload{..}
          = go fileId xgafv accessToken callback mimeType revisionId
              uploadType
              uploadProtocol
