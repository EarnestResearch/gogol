...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.files.watch@.
module Gogol.Drive.Files.Watch
    (
    -- * Resource
...
newDriveFilesWatch fileId payload
  = DriveFilesWatch{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    acknowledgeAbuse = Core.False, callback = Core.Nothing,
                    fileId = fileId, includeLabels = Core.Nothing,
                    includePermissionsForView = Core.Nothing, payload = payload,
