...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.files.emptyTrash@.
module Gogol.Drive.Files.EmptyTrash
    (
    -- * Resource
...
newDriveFilesEmptyTrash 
    ::  DriveFilesEmptyTrash
newDriveFilesEmptyTrash
  = DriveFilesEmptyTrash{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         driveId = Core.Nothing, enforceSingleParent = Core.False,
