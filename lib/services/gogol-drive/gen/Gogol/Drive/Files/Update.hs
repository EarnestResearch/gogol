...
--
-- Updates a file\'s metadata and\/or content. When calling this method, only populate fields in the request that you want to modify. When updating fields, some fields might be changed automatically, such as @modifiedDate@. This method supports patch semantics. This method supports an /\/upload/ URI and accepts uploaded media with the following characteristics: - /Maximum file size:/ 5,120 GB - /Accepted Media MIME types:/@*\/*@ Note: Specify a valid MIME type, rather than the literal @*\/*@ value. The literal @*\/*@ is only used to indicate that any valid MIME type can be uploaded. For more information on uploading files, see </workspace/drive/api/guides/manage-uploads Upload file data>.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.files.update@.
module Gogol.Drive.Files.Update
    (
    -- * Resource
...
newDriveFilesUpdate fileId payload
  = DriveFilesUpdate{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, addParents = Core.Nothing,
                     callback = Core.Nothing, enforceSingleParent = Core.False,
                     fileId = fileId, includeLabels = Core.Nothing,
                     includePermissionsForView = Core.Nothing,
                     keepRevisionForever = Core.False, ocrLanguage = Core.Nothing,
                     payload = payload, removeParents = Core.Nothing,
                     supportsAllDrives = Core.False, supportsTeamDrives = Core.False,
...
instance Core.GoogleRequest DriveFilesUpdate where
        ...
        type Scopes DriveFilesUpdate =
             '[Drive'FullControl, Drive'Appdata, Drive'File, Drive'Metadata,
               Drive'Scripts]
