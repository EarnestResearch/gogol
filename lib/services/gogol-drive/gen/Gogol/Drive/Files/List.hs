...
--
-- Lists the user\'s files. This method accepts the @q@ parameter, which is a search query combining one or more search terms. For more information, see the </workspace/drive/api/guides/search-files Search for files & folders> guide. /Note:/ This method returns /all/ files by default, including trashed files. If you don\'t want trashed files to appear in the list, use the @trashed=false@ query parameter to remove trashed files from the results.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.files.list@.
module Gogol.Drive.Files.List
    (
    -- * Resource
           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "corpora" Core.Text Core.:>
                   Core.QueryParam "corpus" FilesListCorpus Core.:>
                     Core.QueryParam "driveId" Core.Text Core.:>
                       Core.QueryParam "includeItemsFromAllDrives" Core.Bool Core.:>
                         Core.QueryParam "includeLabels" Core.Text Core.:>
                           Core.QueryParam "includePermissionsForView" Core.Text Core.:>
                             Core.QueryParam "includeTeamDriveItems" Core.Bool Core.:>
...
newDriveFilesList 
    ::  DriveFilesList
newDriveFilesList
  = DriveFilesList{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, corpora = Core.Nothing,
                   corpus = Core.Nothing, driveId = Core.Nothing,
                   includeItemsFromAllDrives = Core.False,
                   includeLabels = Core.Nothing,
                   includePermissionsForView = Core.Nothing,
                   includeTeamDriveItems = Core.False, orderBy = Core.Nothing,
                   pageSize = 100, pageToken = Core.Nothing, q = Core.Nothing,
                   spaces = "drive", supportsAllDrives = Core.False,
                   supportsTeamDrives = Core.False, teamDriveId = Core.Nothing,
...
instance Core.GoogleRequest DriveFilesList where
        ...
        requestClient DriveFilesList{..}
          = go xgafv accessToken callback corpora corpus driveId
