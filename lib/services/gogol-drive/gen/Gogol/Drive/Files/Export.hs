...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.files.export@.
module Gogol.Drive.Files.Export
    (
    -- * Resource
...
newDriveFilesExport fileId mimeType
  = DriveFilesExport{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     fileId = fileId, mimeType = mimeType, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DriveFilesExport where
        ...
        requestClient DriveFilesExport{..}
          = go fileId (Core.Just mimeType) xgafv accessToken callback
              uploadType
              uploadProtocol
...
instance Core.GoogleRequest (Core.MediaDownload DriveFilesExport)
         where
