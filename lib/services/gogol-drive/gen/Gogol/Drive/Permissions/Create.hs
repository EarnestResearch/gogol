...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.permissions.create@.
module Gogol.Drive.Permissions.Create
    (
    -- * Resource
                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "emailMessage" Core.Text Core.:>
                       Core.QueryParam "enforceExpansiveAccess" Core.Bool Core.:>
                         Core.QueryParam "enforceSingleParent" Core.Bool Core.:>
                           Core.QueryParam "moveToNewOwnersRoot" Core.Bool Core.:>
                             Core.QueryParam "sendNotificationEmail" Core.Bool Core.:>
                                   ...
                                   Core.QueryParam "transferOwnership" Core.Bool Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "useDomainAdminAccess" Core.Bool Core.:>
...
newDrivePermissionsCreate fileId payload
  = DrivePermissionsCreate{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           emailMessage = Core.Nothing, enforceExpansiveAccess = Core.False,
                           enforceSingleParent = Core.False, fileId = fileId,
                           moveToNewOwnersRoot = Core.False, payload = payload,
                           sendNotificationEmail = Core.Nothing,
                           supportsAllDrives = Core.False, supportsTeamDrives = Core.False,
                           transferOwnership = Core.False, uploadType = Core.Nothing,
                           uploadProtocol = Core.Nothing, useDomainAdminAccess = Core.False}
instance Core.GoogleRequest DrivePermissionsCreate where
        ...
        requestClient DrivePermissionsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DrivePermissionsCreateResource)
                      Core.mempty
