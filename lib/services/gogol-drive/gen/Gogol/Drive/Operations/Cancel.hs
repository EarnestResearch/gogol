...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.operations.cancel@.
module Gogol.Drive.Operations.Cancel
    (
    -- * Resource
...
newDriveOperationsCancel name
  = DriveOperationsCancel{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DriveOperationsCancel where
        ...
        type Scopes DriveOperationsCancel =
