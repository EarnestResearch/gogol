...
instance Core.FromJSON AbuseDetected where
        parseJSON
          = Core.withObject "AbuseDetected"
              (\ o ->
                 AbuseDetected Core.<$>
                   (o Core..:? "additionalDetails") Core.<*>
                     (o Core..:? "product")
...
newApnsCertificateExpirationInfo =
  ApnsCertificateExpirationInfo
    {appleId = Core.Nothing, expirationTime = Core.Nothing, uid = Core.Nothing}

instance Core.FromJSON ApnsCertificateExpirationInfo
         where
        parseJSON
          = Core.withObject "ApnsCertificateExpirationInfo"
              (\ o ->
                 ApnsCertificateExpirationInfo Core.<$>
                   (o Core..:? "appleId") Core.<*>
                     (o Core..:? "expirationTime")
                     Core.<*> (o Core..:? "uid"))

instance Core.ToJSON ApnsCertificateExpirationInfo
         where
...
newBatchDeleteAlertsResponse_FailedAlertStatus additional =
  BatchDeleteAlertsResponse_FailedAlertStatus {additional = additional}
...
newBatchUndeleteAlertsResponse_FailedAlertStatus additional =
  BatchUndeleteAlertsResponse_FailedAlertStatus {additional = additional}
          ...
          = Core.withObject "DeviceCompromised"
              (\ o ->
                 DeviceCompromised Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "events"))
...
newEntity 
    ::  Entity
newEntity =
  Entity {link = Core.Nothing, name = Core.Nothing, values = Core.Nothing}
...
newEntityList =
  EntityList
    {entities = Core.Nothing, headers = Core.Nothing, name = Core.Nothing}

instance Core.FromJSON EntityList where
        parseJSON
          = Core.withObject "EntityList"
              (\ o ->
                 EntityList Core.<$>
...
instance Core.FromJSON PrimaryAdminChangedEvent where
        parseJSON
          = Core.withObject "PrimaryAdminChangedEvent"
              (\ o ->
                 PrimaryAdminChangedEvent Core.<$>
                   (o Core..:? "domain") Core.<*>
                     (o Core..:? "previousAdminEmail")
...
instance Core.ToJSON PrimaryAdminChangedEvent where
        toJSON PrimaryAdminChangedEvent{..}
          = Core.object
              (Core.catMaybes
                 [("domain" Core..=) Core.<$> domain,
                  ("previousAdminEmail" Core..=) Core.<$>
                    previousAdminEmail,
                  ("updatedAdminEmail" Core..=) Core.<$>
                    updatedAdminEmail])
...
instance Core.FromJSON RequestInfo where
        parseJSON
          = Core.withObject "RequestInfo"
              (\ o ->
                 RequestInfo Core.<$>
                   (o Core..:? "appDeveloperEmail") Core.<*>
                     (o Core..:? "appKey")
                     Core.<*>
                     (o Core..:? "numberOfRequests" Core.<&>
...
instance Core.FromJSON SSOProfileCreatedEvent where
        parseJSON
          = Core.withObject "SSOProfileCreatedEvent"
              (\ o ->
...
instance Core.ToJSON SSOProfileCreatedEvent where
        toJSON SSOProfileCreatedEvent{..}
          = Core.object
              (Core.catMaybes
                 [("inboundSsoProfileName" Core..=) Core.<$>
...
instance Core.FromJSON SSOProfileDeletedEvent where
        parseJSON
          = Core.withObject "SSOProfileDeletedEvent"
              (\ o ->
...
instance Core.FromJSON SSOProfileUpdatedEvent where
        parseJSON
          = Core.withObject "SSOProfileUpdatedEvent"
              (\ o ->
                 SSOProfileUpdatedEvent Core.<$>
                   (o Core..:? "inboundSsoProfileChanges") Core.<*>
                     (o Core..:? "inboundSsoProfileName"))
...
instance Core.ToJSON SSOProfileUpdatedEvent where
        toJSON SSOProfileUpdatedEvent{..}
          = Core.object
              (Core.catMaybes
                 [("inboundSsoProfileChanges" Core..=) Core.<$>
...
instance Core.FromJSON SensitiveAdminAction where
        parseJSON
          = Core.withObject "SensitiveAdminAction"
              (\ o ->
                 SensitiveAdminAction Core.<$>
                   (o Core..:? "actorEmail") Core.<*>
                     (o Core..:? "eventTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("actorEmail" Core..=) Core.<$> actorEmail,
                  ...
                  ("primaryAdminChangedEvent" Core..=) Core.<$>
                    primaryAdminChangedEvent,
                  ("ssoProfileCreatedEvent" Core..=) Core.<$>
                    ssoProfileCreatedEvent,
                  ("ssoProfileDeletedEvent" Core..=) Core.<$>
                    ssoProfileDeletedEvent,
                  ("ssoProfileUpdatedEvent" Core..=) Core.<$>
                    ssoProfileUpdatedEvent,
                  ("superAdminPasswordResetEvent" Core..=) Core.<$>
                    superAdminPasswordResetEvent])
...
instance Core.FromJSON SuperAdminPasswordResetEvent
         where
        parseJSON
          = Core.withObject "SuperAdminPasswordResetEvent"
              (\ o ->
                 SuperAdminPasswordResetEvent Core.<$>
                   (o Core..:? "userEmail"))

instance Core.ToJSON SuperAdminPasswordResetEvent
         where
...
instance Core.FromJSON TransferMisconfiguration where
        parseJSON
          = Core.withObject "TransferMisconfiguration"
              (\ o ->
...
instance Core.FromJSON VoiceMisconfiguration where
        parseJSON
          = Core.withObject "VoiceMisconfiguration"
              (\ o ->
                 VoiceMisconfiguration Core.<$>
                   (o Core..:? "entityName") Core.<*>
                     (o Core..:? "entityType")
                     Core.<*> (o Core..:? "fixUri")
          ...
          = Core.object
              (Core.catMaybes
                 [("entityName" Core..=) Core.<$> entityName,
                  ...
                  ("membersMisconfiguration" Core..=) Core.<$>
                    membersMisconfiguration,
                  ("transferMisconfiguration" Core..=) Core.<$>
                    transferMisconfiguration,
                  ("voicemailMisconfiguration" Core..=) Core.<$>
                    voicemailMisconfiguration])
...
instance Core.FromJSON VoicemailMisconfiguration
         where
        parseJSON
          = Core.withObject "VoicemailMisconfiguration"
              (\ o ->
...
instance Core.FromJSON VoicemailRecipientError where
        parseJSON
          = Core.withObject "VoicemailRecipientError"
              (\ o ->
                 VoicemailRecipientError Core.<$>
                   (o Core..:? "email") Core.<*>
                     (o Core..:? "invalidReason"))
