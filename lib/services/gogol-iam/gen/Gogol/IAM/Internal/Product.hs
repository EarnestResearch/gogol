...
instance Core.FromJSON GoogleIamAdminV1AuditData
         where
        parseJSON
          = Core.withObject "GoogleIamAdminV1AuditData"
              (\ o ->
                 GoogleIamAdminV1AuditData Core.<$>
                   (o Core..:? "permissionDelta"))

instance Core.ToJSON GoogleIamAdminV1AuditData where
        toJSON GoogleIamAdminV1AuditData{..}
          = Core.object
              (Core.catMaybes
                 [("permissionDelta" Core..=) Core.<$>
                    permissionDelta])
...
newGoogleIamAdminV1AuditDataPermissionDelta =
  GoogleIamAdminV1AuditDataPermissionDelta
    {addedPermissions = Core.Nothing, removedPermissions = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIamAdminV1AuditDataPermissionDelta"
              (\ o ->
                 GoogleIamAdminV1AuditDataPermissionDelta Core.<$>
                   (o Core..:? "addedPermissions") Core.<*>
                     (o Core..:? "removedPermissions"))
...
instance Core.ToJSON
        ...
        toJSON GoogleIamAdminV1AuditDataPermissionDelta{..}
          = Core.object
              (Core.catMaybes
                 [("addedPermissions" Core..=) Core.<$>
                    addedPermissions,
                  ("removedPermissions" Core..=) Core.<$>
                    removedPermissions])
...
instance Core.FromJSON GoogleIamV1BindingDelta where
        parseJSON
          = Core.withObject "GoogleIamV1BindingDelta"
              (\ o ->
                 GoogleIamV1BindingDelta Core.<$>
                   (o Core..:? "action") Core.<*>
                     (o Core..:? "condition")
                     Core.<*> (o Core..:? "member")
                     Core.<*> (o Core..:? "role"))
...
instance Core.FromJSON GoogleIamV1LoggingAuditData
         where
        parseJSON
          = Core.withObject "GoogleIamV1LoggingAuditData"
              (\ o ->
                 GoogleIamV1LoggingAuditData Core.<$>
                   (o Core..:? "policyDelta"))

instance Core.ToJSON GoogleIamV1LoggingAuditData
         where
...
instance Core.FromJSON GoogleIamV1PolicyDelta where
        parseJSON
          = Core.withObject "GoogleIamV1PolicyDelta"
              (\ o ->
                 GoogleIamV1PolicyDelta Core.<$>
                   (o Core..:? "bindingDeltas"))
...
instance Core.FromJSON GoogleIamV2DenyRule where
        parseJSON
          = Core.withObject "GoogleIamV2DenyRule"
              (\ o ->
                 GoogleIamV2DenyRule Core.<$>
                   (o Core..:? "denialCondition") Core.<*>
                     (o Core..:? "deniedPermissions")
...
instance Core.ToJSON GoogleIamV2DenyRule where
        toJSON GoogleIamV2DenyRule{..}
          = Core.object
              (Core.catMaybes
                 [("denialCondition" Core..=) Core.<$>
                    denialCondition,
                  ("deniedPermissions" Core..=) Core.<$>
                    deniedPermissions,
                  ("deniedPrincipals" Core..=) Core.<$>
                    deniedPrincipals,
                  ("exceptionPermissions" Core..=) Core.<$>
                    exceptionPermissions,
                  ("exceptionPrincipals" Core..=) Core.<$>
                    exceptionPrincipals])
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleIamV2ListPoliciesResponse"
              (\ o ->
                 GoogleIamV2ListPoliciesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "policies"))

instance Core.ToJSON GoogleIamV2ListPoliciesResponse
         where
...
instance Core.FromJSON GoogleIamV2Policy where
        parseJSON
          = Core.withObject "GoogleIamV2Policy"
              (\ o ->
                 GoogleIamV2Policy Core.<$>
...
instance Core.FromJSON GoogleIamV2Policy_Annotations
         where
        parseJSON
          = Core.withObject "GoogleIamV2Policy_Annotations"
              (\ o ->
                 GoogleIamV2Policy_Annotations Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GoogleIamV2Policy_Annotations
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleIamV2PolicyOperationMetadata"
              (\ o ->
                 GoogleIamV2PolicyOperationMetadata Core.<$>
                   (o Core..:? "createTime"))
...
instance Core.FromJSON GoogleIamV2PolicyRule where
        parseJSON
          = Core.withObject "GoogleIamV2PolicyRule"
              (\ o ->
                 GoogleIamV2PolicyRule Core.<$>
                   (o Core..:? "denyRule") Core.<*>
                     (o Core..:? "description"))
