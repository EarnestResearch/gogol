...
-- |
-- Module      : Gogol.FireStore.Projects.Locations.List
...
newFireStoreProjectsLocationsList name
  = FireStoreProjectsLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest FireStoreProjectsLocationsList where
        type Rs FireStoreProjectsLocationsList = ListLocationsResponse
        type Scopes FireStoreProjectsLocationsList =
        ...
        requestClient FireStoreProjectsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy FireStoreProjectsLocationsListResource)
                      Core.mempty
