...
newFireStoreProjectsDatabasesOperationsList name
  = FireStoreProjectsDatabasesOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesOperationsList
         where
        type Rs FireStoreProjectsDatabasesOperationsList =
             GoogleLongrunningListOperationsResponse
        type Scopes FireStoreProjectsDatabasesOperationsList =
             '[CloudPlatform'FullControl, Datastore'FullControl]
        requestClient FireStoreProjectsDatabasesOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FireStoreProjectsDatabasesOperationsListResource)
                      Core.mempty
