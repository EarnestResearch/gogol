...
-- Lists documents.
--
-- /See:/ <https://cloud.google.com/firestore Cloud Firestore API Reference> for @firestore.projects.databases.documents.listDocuments@.
module Gogol.FireStore.Projects.Databases.Documents.ListDocuments
    (
    -- * Resource
...
-- | A resource alias for @firestore.projects.databases.documents.listDocuments@ method which the
-- 'FireStoreProjectsDatabasesDocumentsListDocuments' request conforms to.
type FireStoreProjectsDatabasesDocumentsListDocumentsResource
     =
     "v1" Core.:>
                     ...
                     Core.QueryParam "pageSize" Core.Int32 Core.:>
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParam "readTime" Core.DateTime Core.:>
                           Core.QueryParam "showMissing" Core.Bool Core.:>
                             Core.QueryParam "transaction" Core.Base64 Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text
                                   Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] ListDocumentsResponse

-- | Lists documents.
--
-- /See:/ 'newFireStoreProjectsDatabasesDocumentsListDocuments' smart constructor.
data FireStoreProjectsDatabasesDocumentsListDocuments = FireStoreProjectsDatabasesDocumentsListDocuments
    {
      -- | V1 error format.
...
-- | Creates a value of 'FireStoreProjectsDatabasesDocumentsListDocuments' with the minimum fields required to make a request.
newFireStoreProjectsDatabasesDocumentsListDocuments 
    ::  Core.Text
    ...
    -> Core.Text
       -- ^  Required. The parent resource name. In the format: @projects\/{project_id}\/databases\/{database_id}\/documents@ or @projects\/{project_id}\/databases\/{database_id}\/documents\/{document_path}@. For example: @projects\/my-project\/databases\/my-database\/documents@ or @projects\/my-project\/databases\/my-database\/documents\/chatrooms\/my-chatroom@ See 'parent'.
    -> FireStoreProjectsDatabasesDocumentsListDocuments
newFireStoreProjectsDatabasesDocumentsListDocuments collectionId parent =
  FireStoreProjectsDatabasesDocumentsListDocuments
    { xgafv = Core.Nothing
