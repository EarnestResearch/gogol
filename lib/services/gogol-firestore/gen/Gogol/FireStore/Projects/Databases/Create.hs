           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "databaseId" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleFirestoreAdminV1Database Core.:>
...
newFireStoreProjectsDatabasesCreate parent payload
  = FireStoreProjectsDatabasesCreate{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     databaseId = Core.Nothing, parent = parent, payload = payload,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FireStoreProjectsDatabasesCreate where
        type Rs FireStoreProjectsDatabasesCreate =
             GoogleLongrunningOperation
        type Scopes FireStoreProjectsDatabasesCreate =
             '[CloudPlatform'FullControl, Datastore'FullControl]
        requestClient FireStoreProjectsDatabasesCreate{..}
          = go parent xgafv accessToken callback databaseId uploadType
              uploadProtocol
