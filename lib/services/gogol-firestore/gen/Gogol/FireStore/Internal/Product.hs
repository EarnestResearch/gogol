...
module Gogol.FireStore.Internal.Product
  (
    ...
    -- * GoogleFirestoreAdminV1Database_Tags
    GoogleFirestoreAdminV1Database_Tags (..),
    newGoogleFirestoreAdminV1Database_Tags,
    ...
    GoogleFirestoreAdminV1DisableUserCredsRequest (..),
    newGoogleFirestoreAdminV1DisableUserCredsRequest,

    -- * GoogleFirestoreAdminV1EnableUserCredsRequest
    GoogleFirestoreAdminV1EnableUserCredsRequest (..),
    newGoogleFirestoreAdminV1EnableUserCredsRequest,
    ...
    GoogleFirestoreAdminV1ListUserCredsResponse (..),
    newGoogleFirestoreAdminV1ListUserCredsResponse,
    ...
    GoogleFirestoreAdminV1ResetUserPasswordRequest (..),
    newGoogleFirestoreAdminV1ResetUserPasswordRequest,

    -- * GoogleFirestoreAdminV1ResourceIdentity
    GoogleFirestoreAdminV1ResourceIdentity (..),
    newGoogleFirestoreAdminV1ResourceIdentity,
    ...
    -- * GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags
    GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags (..),
    newGoogleFirestoreAdminV1RestoreDatabaseRequest_Tags,
    ...
    GoogleFirestoreAdminV1UserCreds (..),
    newGoogleFirestoreAdminV1UserCreds,
...
newAggregation 
    ::  Aggregation
newAggregation
  = Aggregation{alias = Core.Nothing, avg = Core.Nothing,
                count = Core.Nothing, sum = Core.Nothing}
instance Core.FromJSON Aggregation where
        parseJSON
          = Core.withObject "Aggregation"
              (\ o ->
                 Aggregation Core.<$>
                   (o Core..:? "alias") Core.<*> (o Core..:? "avg") Core.<*>
                     (o Core..:? "count")
                     Core.<*> (o Core..:? "sum"))
...
instance Core.ToJSON Aggregation where
        toJSON Aggregation{..}
          = Core.object
              (Core.catMaybes
                 [("alias" Core..=) Core.<$> alias, ("avg" Core..=) Core.<$> avg,
...
instance Core.FromJSON AggregationResult where
        parseJSON
          = Core.withObject "AggregationResult"
...
instance Core.FromJSON AggregationResult_AggregateFields where
        parseJSON
          = Core.withObject "AggregationResult_AggregateFields"
              (\ o ->
                 AggregationResult_AggregateFields Core.<$>
...
newBatchGetDocumentsRequest 
    ::  BatchGetDocumentsRequest
newBatchGetDocumentsRequest
  = BatchGetDocumentsRequest{documents = Core.Nothing,
                             mask = Core.Nothing, newTransaction' = Core.Nothing,
                             readTime = Core.Nothing, transaction = Core.Nothing}
          ...
          = Core.withObject "BatchGetDocumentsRequest"
              (\ o ->
                 BatchGetDocumentsRequest Core.<$>
                   (o Core..:? "documents") Core.<*> (o Core..:? "mask") Core.<*>
                     (o Core..:? "newTransaction")
...
newBatchGetDocumentsResponse 
    ::  BatchGetDocumentsResponse
newBatchGetDocumentsResponse
  = BatchGetDocumentsResponse{found = Core.Nothing,
                              missing = Core.Nothing, readTime = Core.Nothing,
          ...
          = Core.withObject "BatchGetDocumentsResponse"
              (\ o ->
                 BatchGetDocumentsResponse Core.<$>
                   (o Core..:? "found") Core.<*> (o Core..:? "missing") Core.<*>
                     (o Core..:? "readTime")
                     Core.<*> (o Core..:? "transaction"))
          ...
          = Core.withObject "BatchWriteRequest"
              (\ o ->
                 BatchWriteRequest Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "writes"))
...
newBatchWriteResponse 
    ::  BatchWriteResponse
newBatchWriteResponse
  = BatchWriteResponse{status = Core.Nothing,
          ...
          = Core.withObject "BatchWriteResponse"
              (\ o ->
                 BatchWriteResponse Core.<$>
                   (o Core..:? "status") Core.<*> (o Core..:? "writeResults"))
...
instance Core.FromJSON BitSequence where
        parseJSON
          = Core.withObject "BitSequence"
              (\ o ->
                 BitSequence Core.<$>
                   (o Core..:? "bitmap") Core.<*> (o Core..:? "padding"))
...
instance Core.FromJSON BloomFilter where
        parseJSON
          = Core.withObject "BloomFilter"
              (\ o ->
                 BloomFilter Core.<$>
                   (o Core..:? "bits") Core.<*> (o Core..:? "hashCount"))
...
newCollectionSelector 
    ::  CollectionSelector
newCollectionSelector
  = CollectionSelector{allDescendants = Core.Nothing,
          ...
          = Core.withObject "CollectionSelector"
              (\ o ->
                 CollectionSelector Core.<$>
                   (o Core..:? "allDescendants") Core.<*> (o Core..:? "collectionId"))
...
instance Core.FromJSON CommitRequest where
        parseJSON
          = Core.withObject "CommitRequest"
              (\ o ->
                 CommitRequest Core.<$>
                   (o Core..:? "transaction") Core.<*> (o Core..:? "writes"))
...
newCommitResponse 
    ::  CommitResponse
newCommitResponse
  = CommitResponse{commitTime = Core.Nothing,
                   writeResults = Core.Nothing}
instance Core.FromJSON CommitResponse where
        parseJSON
          = Core.withObject "CommitResponse"
              (\ o ->
                 CommitResponse Core.<$>
                   (o Core..:? "commitTime") Core.<*> (o Core..:? "writeResults"))
...
instance Core.FromJSON Count where
        parseJSON
          = Core.withObject "Count"
              (\ o ->
                 Count Core.<$>
                   (o Core..:? "upTo" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.FromJSON Cursor where
        parseJSON
          = Core.withObject "Cursor"
              (\ o ->
                 Cursor Core.<$>
                   (o Core..:? "before") Core.<*> (o Core..:? "values"))
...
newDocument 
    ::  Document
newDocument
  = Document{createTime = Core.Nothing, fields = Core.Nothing,
...
instance Core.FromJSON Document where
        parseJSON
          = Core.withObject "Document"
              (\ o ->
                 Document Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "fields") Core.<*>
                     (o Core..:? "name")
...
newDocumentChange 
    ::  DocumentChange
newDocumentChange
  = DocumentChange{document = Core.Nothing,
                   removedTargetIds = Core.Nothing, targetIds = Core.Nothing}
instance Core.FromJSON DocumentChange where
        parseJSON
          = Core.withObject "DocumentChange"
              (\ o ->
                 DocumentChange Core.<$>
                   (o Core..:? "document") Core.<*> (o Core..:? "removedTargetIds")
...
newDocumentDelete 
    ::  DocumentDelete
newDocumentDelete
  = DocumentDelete{document = Core.Nothing, readTime = Core.Nothing,
...
instance Core.FromJSON DocumentDelete where
        parseJSON
          = Core.withObject "DocumentDelete"
              (\ o ->
                 DocumentDelete Core.<$>
                   (o Core..:? "document") Core.<*> (o Core..:? "readTime") Core.<*>
                     (o Core..:? "removedTargetIds"))
...
newDocumentRemove 
    ::  DocumentRemove
newDocumentRemove
  = DocumentRemove{document = Core.Nothing, readTime = Core.Nothing,
                   removedTargetIds = Core.Nothing}
...
newDocumentTransform 
    ::  DocumentTransform
newDocumentTransform
  = DocumentTransform{document = Core.Nothing,
          ...
          = Core.withObject "DocumentTransform"
              (\ o ->
                 DocumentTransform Core.<$>
                   (o Core..:? "document") Core.<*> (o Core..:? "fieldTransforms"))
...
newExecutionStats 
    ::  ExecutionStats
newExecutionStats
  = ExecutionStats{debugStats = Core.Nothing,
                   executionDuration = Core.Nothing, readOperations = Core.Nothing,
                   resultsReturned = Core.Nothing}
instance Core.FromJSON ExecutionStats where
        parseJSON
          = Core.withObject "ExecutionStats"
              (\ o ->
                 ExecutionStats Core.<$>
                   (o Core..:? "debugStats") Core.<*> (o Core..:? "executionDuration")
                     Core.<*>
                     (o Core..:? "readOperations" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "resultsReturned" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("debugStats" Core..=) Core.<$> debugStats,
                  ...
                  ("readOperations" Core..=) Core.. Core.AsText Core.<$>
                    readOperations,
                  ("resultsReturned" Core..=) Core.. Core.AsText Core.<$>
                    resultsReturned])
...
instance Core.FromJSON ExecutionStats_DebugStats where
        parseJSON
          = Core.withObject "ExecutionStats_DebugStats"
              (\ o ->
          ...
          = Core.withObject "ExistenceFilter"
              (\ o ->
                 ExistenceFilter Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "targetId") Core.<*>
                     (o Core..:? "unchangedNames"))
...
newExplainMetrics 
    ::  ExplainMetrics
newExplainMetrics
  = ExplainMetrics{executionStats = Core.Nothing,
                   planSummary = Core.Nothing}
instance Core.FromJSON ExplainMetrics where
        parseJSON
          = Core.withObject "ExplainMetrics"
              (\ o ->
                 ExplainMetrics Core.<$>
                   (o Core..:? "executionStats") Core.<*> (o Core..:? "planSummary"))
...
instance Core.FromJSON ExplainOptions where
        parseJSON
          = Core.withObject "ExplainOptions"
...
newFieldFilter 
    ::  FieldFilter
newFieldFilter
  = FieldFilter{field = Core.Nothing, op = Core.Nothing,
                value = Core.Nothing}
instance Core.FromJSON FieldFilter where
        parseJSON
          = Core.withObject "FieldFilter"
              (\ o ->
                 FieldFilter Core.<$>
                   (o Core..:? "field") Core.<*> (o Core..:? "op") Core.<*>
                     (o Core..:? "value"))
...
newFieldTransform 
    ::  FieldTransform
newFieldTransform
  = FieldTransform{appendMissingElements = Core.Nothing,
                   fieldPath = Core.Nothing, increment = Core.Nothing,
                   maximum = Core.Nothing, minimum = Core.Nothing,
                   removeAllFromArray = Core.Nothing, setToServerValue = Core.Nothing}
...
newFilter 
    ::  Filter
newFilter
  = Filter{compositeFilter = Core.Nothing,
           fieldFilter = Core.Nothing, unaryFilter = Core.Nothing}
instance Core.FromJSON Filter where
        parseJSON
          = Core.withObject "Filter"
              (\ o ->
                 Filter Core.<$>
                   (o Core..:? "compositeFilter") Core.<*> (o Core..:? "fieldFilter")
...
newFindNearest 
    ::  FindNearest
newFindNearest
  = FindNearest{distanceMeasure = Core.Nothing,
                distanceResultField = Core.Nothing,
                distanceThreshold = Core.Nothing, limit = Core.Nothing,
                queryVector = Core.Nothing, vectorField = Core.Nothing}
instance Core.FromJSON FindNearest where
        parseJSON
          = Core.withObject "FindNearest"
              (\ o ->
                 FindNearest Core.<$>
                   (o Core..:? "distanceMeasure") Core.<*>
                     (o Core..:? "distanceResultField")
...
newGoogleFirestoreAdminV1Backup 
    ::  GoogleFirestoreAdminV1Backup
newGoogleFirestoreAdminV1Backup
  = GoogleFirestoreAdminV1Backup{database = Core.Nothing,
                                 databaseUid = Core.Nothing, expireTime = Core.Nothing,
                                 name = Core.Nothing, snapshotTime = Core.Nothing,
                                 state = Core.Nothing, stats = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1Backup where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1Backup"
              (\ o ->
                 GoogleFirestoreAdminV1Backup Core.<$>
                   (o Core..:? "database") Core.<*> (o Core..:? "databaseUid")
...
newGoogleFirestoreAdminV1BackupSchedule 
    :: 
                                        GoogleFirestoreAdminV1BackupSchedule
newGoogleFirestoreAdminV1BackupSchedule
  = GoogleFirestoreAdminV1BackupSchedule{createTime = Core.Nothing,
                                         dailyRecurrence = Core.Nothing, name = Core.Nothing,
                                         retention = Core.Nothing, updateTime = Core.Nothing,
                                         weeklyRecurrence = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1BackupSchedule where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1BackupSchedule"
              (\ o ->
                 GoogleFirestoreAdminV1BackupSchedule Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "dailyRecurrence")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON GoogleFirestoreAdminV1BackupSource where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1BackupSource"
              (\ o ->
...
newGoogleFirestoreAdminV1BulkDeleteDocumentsMetadata 
    :: 
                                                     GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata
newGoogleFirestoreAdminV1BulkDeleteDocumentsMetadata
  = GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata{collectionIds =
                                                        Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata"
              (\ o ->
                 GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata Core.<$>
                   (o Core..:? "collectionIds") Core.<*> (o Core..:? "endTime")
...
newGoogleFirestoreAdminV1BulkDeleteDocumentsRequest 
    :: 
                                                    GoogleFirestoreAdminV1BulkDeleteDocumentsRequest
newGoogleFirestoreAdminV1BulkDeleteDocumentsRequest
  = GoogleFirestoreAdminV1BulkDeleteDocumentsRequest{collectionIds =
                                                       Core.Nothing,
                                                     namespaceIds = Core.Nothing}
instance Core.FromJSON
           GoogleFirestoreAdminV1BulkDeleteDocumentsRequest
        ...
        parseJSON
          = Core.withObject
              "GoogleFirestoreAdminV1BulkDeleteDocumentsRequest"
              (\ o ->
                 GoogleFirestoreAdminV1BulkDeleteDocumentsRequest Core.<$>
                   (o Core..:? "collectionIds") Core.<*> (o Core..:? "namespaceIds"))
...
newGoogleFirestoreAdminV1CmekConfig 
    :: 
                                    GoogleFirestoreAdminV1CmekConfig
newGoogleFirestoreAdminV1CmekConfig
  = GoogleFirestoreAdminV1CmekConfig{activeKeyVersion = Core.Nothing,
                                     kmsKeyName = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1CmekConfig where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1CmekConfig"
              (\ o ->
                 GoogleFirestoreAdminV1CmekConfig Core.<$>
                   (o Core..:? "activeKeyVersion") Core.<*> (o Core..:? "kmsKeyName"))
...
newGoogleFirestoreAdminV1CreateDatabaseMetadata
  = GoogleFirestoreAdminV1CreateDatabaseMetadata
instance Core.FromJSON GoogleFirestoreAdminV1CreateDatabaseMetadata
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1CreateDatabaseMetadata"
              (\ o -> Core.pure GoogleFirestoreAdminV1CreateDatabaseMetadata)

instance Core.ToJSON GoogleFirestoreAdminV1CreateDatabaseMetadata
         where
        toJSON = Core.const Core.emptyObject
...
newGoogleFirestoreAdminV1CustomerManagedEncryptionOptions 
    :: 
                                                          GoogleFirestoreAdminV1CustomerManagedEncryptionOptions
newGoogleFirestoreAdminV1CustomerManagedEncryptionOptions
  = GoogleFirestoreAdminV1CustomerManagedEncryptionOptions{kmsKeyName
                                                             = Core.Nothing}
instance Core.FromJSON
           GoogleFirestoreAdminV1CustomerManagedEncryptionOptions
         where
        parseJSON
          = Core.withObject
              "GoogleFirestoreAdminV1CustomerManagedEncryptionOptions"
              (\ o ->
                 GoogleFirestoreAdminV1CustomerManagedEncryptionOptions Core.<$>
                   (o Core..:? "kmsKeyName"))
...
instance Core.FromJSON GoogleFirestoreAdminV1DailyRecurrence where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1DailyRecurrence"
...
data GoogleFirestoreAdminV1Database = GoogleFirestoreAdminV1Database
   ...
   GoogleFirestoreAdminV1Database_AppEngineIntegrationMode)
    ...
    , databaseEdition :: (Core.Maybe GoogleFirestoreAdminV1Database_DatabaseEdition)
    ...
    , pointInTimeRecoveryEnablement :: (Core.Maybe
   GoogleFirestoreAdminV1Database_PointInTimeRecoveryEnablement)
    ...
    , tags :: (Core.Maybe GoogleFirestoreAdminV1Database_Tags)
...
newGoogleFirestoreAdminV1Database 
    ::  GoogleFirestoreAdminV1Database
newGoogleFirestoreAdminV1Database
  = GoogleFirestoreAdminV1Database{appEngineIntegrationMode =
                                     Core.Nothing,
                                   cmekConfig = Core.Nothing, concurrencyMode = Core.Nothing,
                                   createTime = Core.Nothing, databaseEdition = Core.Nothing,
                                   deleteProtectionState = Core.Nothing, deleteTime = Core.Nothing,
                                   earliestVersionTime = Core.Nothing, etag = Core.Nothing,
                                   freeTier = Core.Nothing, keyPrefix = Core.Nothing,
                                   locationId = Core.Nothing, name = Core.Nothing,
                                   pointInTimeRecoveryEnablement = Core.Nothing,
                                   previousId = Core.Nothing, sourceInfo = Core.Nothing,
                                   tags = Core.Nothing, type' = Core.Nothing, uid = Core.Nothing,
                                   updateTime = Core.Nothing, versionRetentionPeriod = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("appEngineIntegrationMode" Core..=) Core.<$>
                  ...
                  ("createTime" Core..=) Core.<$> createTime,
                  ("databaseEdition" Core..=) Core.<$> databaseEdition,
                  ...
                  ("etag" Core..=) Core.<$> etag,
                  ("freeTier" Core..=) Core.<$> freeTier,
                  ("keyPrefix" Core..=) Core.<$> keyPrefix,
                  ("locationId" Core..=) Core.<$> locationId,
                  ("name" Core..=) Core.<$> name,
                  ("pointInTimeRecoveryEnablement" Core..=) Core.<$>
...
-- | Optional. Input only. Immutable. Tag keys\/values directly bound to this resource. For example: \"123\/environment\": \"production\", \"123\/costCenter\": \"marketing\"
--
-- /See:/ 'newGoogleFirestoreAdminV1Database_Tags' smart constructor.
newtype GoogleFirestoreAdminV1Database_Tags = GoogleFirestoreAdminV1Database_Tags
    {
...
-- | Creates a value of 'GoogleFirestoreAdminV1Database_Tags' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1Database_Tags 
    :: 
                                       Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> GoogleFirestoreAdminV1Database_Tags
newGoogleFirestoreAdminV1Database_Tags additional
  = GoogleFirestoreAdminV1Database_Tags{additional = additional}
instance Core.FromJSON GoogleFirestoreAdminV1Database_Tags where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1Database_Tags"
              (\ o ->
                 GoogleFirestoreAdminV1Database_Tags Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GoogleFirestoreAdminV1Database_Tags where
        toJSON GoogleFirestoreAdminV1Database_Tags{..}
          = Core.toJSON additional
...
newGoogleFirestoreAdminV1DeleteDatabaseMetadata
  = GoogleFirestoreAdminV1DeleteDatabaseMetadata
instance Core.FromJSON GoogleFirestoreAdminV1DeleteDatabaseMetadata
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1DeleteDatabaseMetadata"
              (\ o -> Core.pure GoogleFirestoreAdminV1DeleteDatabaseMetadata)

instance Core.ToJSON GoogleFirestoreAdminV1DeleteDatabaseMetadata
         where
        toJSON = Core.const Core.emptyObject
...
--
-- /See:/ 'newGoogleFirestoreAdminV1DisableUserCredsRequest' smart constructor.
data GoogleFirestoreAdminV1DisableUserCredsRequest = GoogleFirestoreAdminV1DisableUserCredsRequest
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleFirestoreAdminV1DisableUserCredsRequest' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1DisableUserCredsRequest 
    :: 
                                                 GoogleFirestoreAdminV1DisableUserCredsRequest
newGoogleFirestoreAdminV1DisableUserCredsRequest
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1DisableUserCredsRequest"
              (\ o -> Core.pure GoogleFirestoreAdminV1DisableUserCredsRequest)

instance Core.ToJSON GoogleFirestoreAdminV1DisableUserCredsRequest
         where
        toJSON = Core.const Core.emptyObject
...
--
-- /See:/ 'newGoogleFirestoreAdminV1EnableUserCredsRequest' smart constructor.
data GoogleFirestoreAdminV1EnableUserCredsRequest = GoogleFirestoreAdminV1EnableUserCredsRequest
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleFirestoreAdminV1EnableUserCredsRequest' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1EnableUserCredsRequest 
    :: 
                                                GoogleFirestoreAdminV1EnableUserCredsRequest
newGoogleFirestoreAdminV1EnableUserCredsRequest
  = GoogleFirestoreAdminV1EnableUserCredsRequest
instance Core.FromJSON GoogleFirestoreAdminV1EnableUserCredsRequest
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1EnableUserCredsRequest"
              (\ o -> Core.pure GoogleFirestoreAdminV1EnableUserCredsRequest)

instance Core.ToJSON GoogleFirestoreAdminV1EnableUserCredsRequest
         where
        toJSON = Core.const Core.emptyObject
...
newGoogleFirestoreAdminV1EncryptionConfig 
    :: 
                                          GoogleFirestoreAdminV1EncryptionConfig
newGoogleFirestoreAdminV1EncryptionConfig
  = GoogleFirestoreAdminV1EncryptionConfig{customerManagedEncryption
                                             = Core.Nothing,
...
instance Core.FromJSON GoogleFirestoreAdminV1EncryptionConfig where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1EncryptionConfig"
              (\ o ->
                 GoogleFirestoreAdminV1EncryptionConfig Core.<$>
                   (o Core..:? "customerManagedEncryption") Core.<*>
                     (o Core..:? "googleDefaultEncryption")
          ...
          = Core.object
              (Core.catMaybes
                 [("customerManagedEncryption" Core..=) Core.<$>
                  ...
                  ("googleDefaultEncryption" Core..=) Core.<$>
...
newGoogleFirestoreAdminV1ExportDocumentsMetadata 
    :: 
                                                 GoogleFirestoreAdminV1ExportDocumentsMetadata
newGoogleFirestoreAdminV1ExportDocumentsMetadata
  = GoogleFirestoreAdminV1ExportDocumentsMetadata{collectionIds =
                                                    Core.Nothing,
                                                  endTime = Core.Nothing,
                                                  namespaceIds = Core.Nothing,
                                                  operationState = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ExportDocumentsMetadata"
              (\ o ->
                 GoogleFirestoreAdminV1ExportDocumentsMetadata Core.<$>
                   (o Core..:? "collectionIds") Core.<*> (o Core..:? "endTime")
                     Core.<*> (o Core..:? "namespaceIds")
                     Core.<*> (o Core..:? "operationState")
...
instance Core.ToJSON GoogleFirestoreAdminV1ExportDocumentsMetadata
         where
...
newGoogleFirestoreAdminV1ExportDocumentsRequest 
    :: 
                                                GoogleFirestoreAdminV1ExportDocumentsRequest
newGoogleFirestoreAdminV1ExportDocumentsRequest
  = GoogleFirestoreAdminV1ExportDocumentsRequest{collectionIds =
                                                   Core.Nothing,
                                                 namespaceIds = Core.Nothing,
                                                 outputUriPrefix = Core.Nothing,
                                                 snapshotTime = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1ExportDocumentsRequest
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ExportDocumentsRequest"
              (\ o ->
...
instance Core.ToJSON GoogleFirestoreAdminV1ExportDocumentsRequest
         where
...
newGoogleFirestoreAdminV1ExportDocumentsResponse 
    :: 
                                                 GoogleFirestoreAdminV1ExportDocumentsResponse
newGoogleFirestoreAdminV1ExportDocumentsResponse
  = GoogleFirestoreAdminV1ExportDocumentsResponse{outputUriPrefix =
                                                    Core.Nothing}
instance Core.FromJSON
           GoogleFirestoreAdminV1ExportDocumentsResponse
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ExportDocumentsResponse"
              (\ o ->
                 GoogleFirestoreAdminV1ExportDocumentsResponse Core.<$>
                   (o Core..:? "outputUriPrefix"))

instance Core.ToJSON GoogleFirestoreAdminV1ExportDocumentsResponse
         where
...
newGoogleFirestoreAdminV1Field 
    ::  GoogleFirestoreAdminV1Field
newGoogleFirestoreAdminV1Field
  = GoogleFirestoreAdminV1Field{indexConfig = Core.Nothing,
                                name = Core.Nothing, ttlConfig = Core.Nothing}
          ...
          = Core.withObject "GoogleFirestoreAdminV1Field"
              (\ o ->
                 GoogleFirestoreAdminV1Field Core.<$>
                   (o Core..:? "indexConfig") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "ttlConfig"))
...
newGoogleFirestoreAdminV1FieldOperationMetadata 
    :: 
                                                GoogleFirestoreAdminV1FieldOperationMetadata
newGoogleFirestoreAdminV1FieldOperationMetadata
  = GoogleFirestoreAdminV1FieldOperationMetadata{endTime =
                                                   Core.Nothing,
                                                 field = Core.Nothing,
...
instance Core.FromJSON GoogleFirestoreAdminV1FieldOperationMetadata
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1FieldOperationMetadata"
              (\ o ->
                 GoogleFirestoreAdminV1FieldOperationMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "field") Core.<*>
                     (o Core..:? "indexConfigDeltas")
                     Core.<*> (o Core..:? "progressBytes")
                     Core.<*> (o Core..:? "progressDocuments")
                     Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "state")
...
instance Core.ToJSON GoogleFirestoreAdminV1FieldOperationMetadata
         where
...
instance Core.FromJSON GoogleFirestoreAdminV1FlatIndex where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1FlatIndex"
...
newGoogleFirestoreAdminV1ImportDocumentsMetadata 
    :: 
                                                 GoogleFirestoreAdminV1ImportDocumentsMetadata
newGoogleFirestoreAdminV1ImportDocumentsMetadata
  = GoogleFirestoreAdminV1ImportDocumentsMetadata{collectionIds =
                                                    Core.Nothing,
                                                  endTime = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ImportDocumentsMetadata"
              (\ o ->
                 GoogleFirestoreAdminV1ImportDocumentsMetadata Core.<$>
                   (o Core..:? "collectionIds") Core.<*> (o Core..:? "endTime")
...
instance Core.ToJSON GoogleFirestoreAdminV1ImportDocumentsMetadata
         where
...
newGoogleFirestoreAdminV1ImportDocumentsRequest 
    :: 
                                                GoogleFirestoreAdminV1ImportDocumentsRequest
newGoogleFirestoreAdminV1ImportDocumentsRequest
  = GoogleFirestoreAdminV1ImportDocumentsRequest{collectionIds =
                                                   Core.Nothing,
                                                 inputUriPrefix = Core.Nothing,
                                                 namespaceIds = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1ImportDocumentsRequest
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ImportDocumentsRequest"
              (\ o ->
                 GoogleFirestoreAdminV1ImportDocumentsRequest Core.<$>
                   (o Core..:? "collectionIds") Core.<*> (o Core..:? "inputUriPrefix")
                     Core.<*> (o Core..:? "namespaceIds"))

instance Core.ToJSON GoogleFirestoreAdminV1ImportDocumentsRequest
         where
...
data GoogleFirestoreAdminV1Index = GoogleFirestoreAdminV1Index
    ...
    , density :: (Core.Maybe GoogleFirestoreAdminV1Index_Density)
...
newGoogleFirestoreAdminV1Index 
    ::  GoogleFirestoreAdminV1Index
newGoogleFirestoreAdminV1Index
  = GoogleFirestoreAdminV1Index{apiScope = Core.Nothing,
                                density = Core.Nothing, fields = Core.Nothing,
                                multikey = Core.Nothing, name = Core.Nothing,
                                queryScope = Core.Nothing, shardCount = Core.Nothing,
                                state = Core.Nothing}
          ...
          = Core.withObject "GoogleFirestoreAdminV1Index"
              (\ o ->
                 GoogleFirestoreAdminV1Index Core.<$>
                   (o Core..:? "apiScope") Core.<*> (o Core..:? "density") Core.<*>
                     (o Core..:? "fields")
                     Core.<*> (o Core..:? "multikey")
                     Core.<*> (o Core..:? "name")
...
newGoogleFirestoreAdminV1IndexConfig 
    :: 
                                     GoogleFirestoreAdminV1IndexConfig
newGoogleFirestoreAdminV1IndexConfig
  = GoogleFirestoreAdminV1IndexConfig{ancestorField = Core.Nothing,
                                      indexes = Core.Nothing, reverting = Core.Nothing,
          ...
          = Core.withObject "GoogleFirestoreAdminV1IndexConfig"
              (\ o ->
                 GoogleFirestoreAdminV1IndexConfig Core.<$>
                   (o Core..:? "ancestorField") Core.<*> (o Core..:? "indexes")
...
newGoogleFirestoreAdminV1IndexConfigDelta 
    :: 
                                          GoogleFirestoreAdminV1IndexConfigDelta
newGoogleFirestoreAdminV1IndexConfigDelta
  = GoogleFirestoreAdminV1IndexConfigDelta{changeType = Core.Nothing,
                                           index = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1IndexConfigDelta where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1IndexConfigDelta"
              (\ o ->
                 GoogleFirestoreAdminV1IndexConfigDelta Core.<$>
                   (o Core..:? "changeType") Core.<*> (o Core..:? "index"))
...
newGoogleFirestoreAdminV1IndexField 
    :: 
                                    GoogleFirestoreAdminV1IndexField
newGoogleFirestoreAdminV1IndexField
  = GoogleFirestoreAdminV1IndexField{arrayConfig = Core.Nothing,
                                     fieldPath = Core.Nothing, order = Core.Nothing,
          ...
          = Core.withObject "GoogleFirestoreAdminV1IndexField"
              (\ o ->
                 GoogleFirestoreAdminV1IndexField Core.<$>
                   (o Core..:? "arrayConfig") Core.<*> (o Core..:? "fieldPath")
                     Core.<*> (o Core..:? "order")
...
newGoogleFirestoreAdminV1IndexOperationMetadata
  = GoogleFirestoreAdminV1IndexOperationMetadata{endTime =
                                                   Core.Nothing,
                                                 index = Core.Nothing, progressBytes = Core.Nothing,
                                                 progressDocuments = Core.Nothing,
                                                 startTime = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1IndexOperationMetadata
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1IndexOperationMetadata"
              (\ o ->
                 GoogleFirestoreAdminV1IndexOperationMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "index") Core.<*>
                     (o Core..:? "progressBytes")
                     Core.<*> (o Core..:? "progressDocuments")
                     Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "state"))

instance Core.ToJSON GoogleFirestoreAdminV1IndexOperationMetadata
         where
...
newGoogleFirestoreAdminV1ListBackupSchedulesResponse 
    :: 
                                                     GoogleFirestoreAdminV1ListBackupSchedulesResponse
newGoogleFirestoreAdminV1ListBackupSchedulesResponse
  = GoogleFirestoreAdminV1ListBackupSchedulesResponse{backupSchedules
                                                        = Core.Nothing}
instance Core.FromJSON
           GoogleFirestoreAdminV1ListBackupSchedulesResponse
         where
        parseJSON
          = Core.withObject
              "GoogleFirestoreAdminV1ListBackupSchedulesResponse"
              (\ o ->
                 GoogleFirestoreAdminV1ListBackupSchedulesResponse Core.<$>
                   (o Core..:? "backupSchedules"))
...
newGoogleFirestoreAdminV1ListBackupsResponse 
    :: 
                                             GoogleFirestoreAdminV1ListBackupsResponse
newGoogleFirestoreAdminV1ListBackupsResponse
  = GoogleFirestoreAdminV1ListBackupsResponse{backups = Core.Nothing,
                                              unreachable = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1ListBackupsResponse
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ListBackupsResponse"
              (\ o ->
                 GoogleFirestoreAdminV1ListBackupsResponse Core.<$>
                   (o Core..:? "backups") Core.<*> (o Core..:? "unreachable"))

instance Core.ToJSON GoogleFirestoreAdminV1ListBackupsResponse
         where
...
newGoogleFirestoreAdminV1ListDatabasesResponse 
    :: 
                                               GoogleFirestoreAdminV1ListDatabasesResponse
newGoogleFirestoreAdminV1ListDatabasesResponse
  = GoogleFirestoreAdminV1ListDatabasesResponse{databases =
                                                  Core.Nothing,
                                                unreachable = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1ListDatabasesResponse
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ListDatabasesResponse"
              (\ o ->
                 GoogleFirestoreAdminV1ListDatabasesResponse Core.<$>
                   (o Core..:? "databases") Core.<*> (o Core..:? "unreachable"))

instance Core.ToJSON GoogleFirestoreAdminV1ListDatabasesResponse
         where
...
newGoogleFirestoreAdminV1ListFieldsResponse 
    :: 
                                            GoogleFirestoreAdminV1ListFieldsResponse
newGoogleFirestoreAdminV1ListFieldsResponse
  = GoogleFirestoreAdminV1ListFieldsResponse{fields = Core.Nothing,
                                             nextPageToken = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1ListFieldsResponse
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ListFieldsResponse"
              (\ o ->
                 GoogleFirestoreAdminV1ListFieldsResponse Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "nextPageToken"))
...
newGoogleFirestoreAdminV1ListIndexesResponse 
    :: 
                                             GoogleFirestoreAdminV1ListIndexesResponse
newGoogleFirestoreAdminV1ListIndexesResponse
  = GoogleFirestoreAdminV1ListIndexesResponse{indexes = Core.Nothing,
                                              nextPageToken = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1ListIndexesResponse
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ListIndexesResponse"
              (\ o ->
                 GoogleFirestoreAdminV1ListIndexesResponse Core.<$>
                   (o Core..:? "indexes") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON GoogleFirestoreAdminV1ListIndexesResponse
         where
...
--
-- /See:/ 'newGoogleFirestoreAdminV1ListUserCredsResponse' smart constructor.
newtype GoogleFirestoreAdminV1ListUserCredsResponse = GoogleFirestoreAdminV1ListUserCredsResponse
    {
      -- | The user creds for the database.
      userCreds :: (Core.Maybe [GoogleFirestoreAdminV1UserCreds])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleFirestoreAdminV1ListUserCredsResponse' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1ListUserCredsResponse 
    :: 
                                               GoogleFirestoreAdminV1ListUserCredsResponse
newGoogleFirestoreAdminV1ListUserCredsResponse
  = GoogleFirestoreAdminV1ListUserCredsResponse{userCreds =
                                                  Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1ListUserCredsResponse
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ListUserCredsResponse"
              (\ o ->
                 GoogleFirestoreAdminV1ListUserCredsResponse Core.<$>
                   (o Core..:? "userCreds"))

instance Core.ToJSON GoogleFirestoreAdminV1ListUserCredsResponse
         where
        toJSON GoogleFirestoreAdminV1ListUserCredsResponse{..}
          = Core.object
              (Core.catMaybes [("userCreds" Core..=) Core.<$> userCreds])
...
instance Core.FromJSON GoogleFirestoreAdminV1LocationMetadata where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1LocationMetadata"
...
newGoogleFirestoreAdminV1Progress 
    ::  GoogleFirestoreAdminV1Progress
newGoogleFirestoreAdminV1Progress
  = GoogleFirestoreAdminV1Progress{completedWork = Core.Nothing,
          ...
          = Core.withObject "GoogleFirestoreAdminV1Progress"
              (\ o ->
                 GoogleFirestoreAdminV1Progress Core.<$>
                   (o Core..:? "completedWork" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "estimatedWork" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON GoogleFirestoreAdminV1Progress where
        toJSON GoogleFirestoreAdminV1Progress{..}
          = Core.object
              (Core.catMaybes
                 [("completedWork" Core..=) Core.. Core.AsText Core.<$>
                    completedWork,
...
--
-- /See:/ 'newGoogleFirestoreAdminV1ResetUserPasswordRequest' smart constructor.
data GoogleFirestoreAdminV1ResetUserPasswordRequest = GoogleFirestoreAdminV1ResetUserPasswordRequest
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleFirestoreAdminV1ResetUserPasswordRequest' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1ResetUserPasswordRequest 
    :: 
                                                  GoogleFirestoreAdminV1ResetUserPasswordRequest
newGoogleFirestoreAdminV1ResetUserPasswordRequest
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ResetUserPasswordRequest"
              (\ o -> Core.pure GoogleFirestoreAdminV1ResetUserPasswordRequest)

instance Core.ToJSON GoogleFirestoreAdminV1ResetUserPasswordRequest
         where
        toJSON = Core.const Core.emptyObject
...
--
-- /See:/ 'newGoogleFirestoreAdminV1ResourceIdentity' smart constructor.
newtype GoogleFirestoreAdminV1ResourceIdentity = GoogleFirestoreAdminV1ResourceIdentity
    {
...
-- | Creates a value of 'GoogleFirestoreAdminV1ResourceIdentity' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1ResourceIdentity 
    :: 
                                          GoogleFirestoreAdminV1ResourceIdentity
newGoogleFirestoreAdminV1ResourceIdentity
  = GoogleFirestoreAdminV1ResourceIdentity{principal = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1ResourceIdentity where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1ResourceIdentity"
              (\ o ->
                 GoogleFirestoreAdminV1ResourceIdentity Core.<$>
                   (o Core..:? "principal"))

instance Core.ToJSON GoogleFirestoreAdminV1ResourceIdentity where
        toJSON GoogleFirestoreAdminV1ResourceIdentity{..}
          = Core.object
              (Core.catMaybes [("principal" Core..=) Core.<$> principal])
...
newGoogleFirestoreAdminV1RestoreDatabaseMetadata 
    :: 
                                                 GoogleFirestoreAdminV1RestoreDatabaseMetadata
newGoogleFirestoreAdminV1RestoreDatabaseMetadata
  = GoogleFirestoreAdminV1RestoreDatabaseMetadata{backup =
                                                    Core.Nothing,
                                                  database = Core.Nothing, endTime = Core.Nothing,
                                                  operationState = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1RestoreDatabaseMetadata"
              (\ o ->
                 GoogleFirestoreAdminV1RestoreDatabaseMetadata Core.<$>
                   (o Core..:? "backup") Core.<*> (o Core..:? "database") Core.<*>
                     (o Core..:? "endTime")
                     Core.<*> (o Core..:? "operationState")
                     Core.<*> (o Core..:? "progressPercentage")
                     Core.<*> (o Core..:? "startTime"))

instance Core.ToJSON GoogleFirestoreAdminV1RestoreDatabaseMetadata
         where
...
data GoogleFirestoreAdminV1RestoreDatabaseRequest = GoogleFirestoreAdminV1RestoreDatabaseRequest
    ...
    , tags :: (Core.Maybe GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleFirestoreAdminV1RestoreDatabaseRequest 
    :: 
                                                GoogleFirestoreAdminV1RestoreDatabaseRequest
newGoogleFirestoreAdminV1RestoreDatabaseRequest
  = GoogleFirestoreAdminV1RestoreDatabaseRequest{backup =
                                                   Core.Nothing,
                                                 databaseId = Core.Nothing,
                                                 encryptionConfig = Core.Nothing,
                                                 tags = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1RestoreDatabaseRequest
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1RestoreDatabaseRequest"
              (\ o ->
                 GoogleFirestoreAdminV1RestoreDatabaseRequest Core.<$>
                   (o Core..:? "backup") Core.<*> (o Core..:? "databaseId") Core.<*>
                     (o Core..:? "encryptionConfig")
                     Core.<*> (o Core..:? "tags"))

instance Core.ToJSON GoogleFirestoreAdminV1RestoreDatabaseRequest
         where
...
-- | Optional. Immutable. Tags to be bound to the restored database. The tags should be provided in the format of @tagKeys\/{tag_key_id} -> tagValues\/{tag_value_id}@.
--
-- /See:/ 'newGoogleFirestoreAdminV1RestoreDatabaseRequest_Tags' smart constructor.
newtype GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags = GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags
    {
...
-- | Creates a value of 'GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1RestoreDatabaseRequest_Tags 
    :: 
                                                     Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags
newGoogleFirestoreAdminV1RestoreDatabaseRequest_Tags additional
  = GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags{additional =
                                                        additional}
instance Core.FromJSON
           GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags
         where
        parseJSON
          = Core.withObject
              "GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags"
              (\ o ->
                 GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags
         where
        toJSON GoogleFirestoreAdminV1RestoreDatabaseRequest_Tags{..}
          = Core.toJSON additional
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1SourceEncryptionOptions"
              (\ o -> Core.pure GoogleFirestoreAdminV1SourceEncryptionOptions)

instance Core.ToJSON GoogleFirestoreAdminV1SourceEncryptionOptions
         where
        toJSON = Core.const Core.emptyObject
...
newGoogleFirestoreAdminV1SourceInfo 
    :: 
                                    GoogleFirestoreAdminV1SourceInfo
newGoogleFirestoreAdminV1SourceInfo
  = GoogleFirestoreAdminV1SourceInfo{backup = Core.Nothing,
                                     operation = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1SourceInfo where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1SourceInfo"
              (\ o ->
                 GoogleFirestoreAdminV1SourceInfo Core.<$>
                   (o Core..:? "backup") Core.<*> (o Core..:? "operation"))
...
newGoogleFirestoreAdminV1Stats 
    ::  GoogleFirestoreAdminV1Stats
newGoogleFirestoreAdminV1Stats
  = GoogleFirestoreAdminV1Stats{documentCount = Core.Nothing,
                                indexCount = Core.Nothing, sizeBytes = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1Stats where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1Stats"
              (\ o ->
                 GoogleFirestoreAdminV1Stats Core.<$>
                   (o Core..:? "documentCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "indexCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.ToJSON GoogleFirestoreAdminV1Stats where
        toJSON GoogleFirestoreAdminV1Stats{..}
          = Core.object
              (Core.catMaybes
                 [("documentCount" Core..=) Core.. Core.AsText Core.<$>
                    documentCount,
...
instance Core.FromJSON GoogleFirestoreAdminV1TtlConfig where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1TtlConfig"
              (\ o ->
...
instance Core.FromJSON GoogleFirestoreAdminV1TtlConfigDelta where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1TtlConfigDelta"
              (\ o ->
                 GoogleFirestoreAdminV1TtlConfigDelta Core.<$>
                   (o Core..:? "changeType"))
...
newGoogleFirestoreAdminV1UpdateDatabaseMetadata
  = GoogleFirestoreAdminV1UpdateDatabaseMetadata
instance Core.FromJSON GoogleFirestoreAdminV1UpdateDatabaseMetadata
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1UpdateDatabaseMetadata"
              (\ o -> Core.pure GoogleFirestoreAdminV1UpdateDatabaseMetadata)

instance Core.ToJSON GoogleFirestoreAdminV1UpdateDatabaseMetadata
         where
        toJSON = Core.const Core.emptyObject
...
--
-- /See:/ 'newGoogleFirestoreAdminV1UserCreds' smart constructor.
data GoogleFirestoreAdminV1UserCreds = GoogleFirestoreAdminV1UserCreds
    {
    ...
    , resourceIdentity :: (Core.Maybe GoogleFirestoreAdminV1ResourceIdentity)
    ...
    , securePassword :: (Core.Maybe Core.Text)
      -- | Output only. Whether the user creds are enabled or disabled. Defaults to ENABLED on creation.
    , state :: (Core.Maybe GoogleFirestoreAdminV1UserCreds_State)
      -- | Output only. The time the user creds were last updated.
    , updateTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleFirestoreAdminV1UserCreds' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1UserCreds 
    :: 
                                   GoogleFirestoreAdminV1UserCreds
newGoogleFirestoreAdminV1UserCreds
  = GoogleFirestoreAdminV1UserCreds{createTime = Core.Nothing,
                                    name = Core.Nothing, resourceIdentity = Core.Nothing,
                                    securePassword = Core.Nothing, state = Core.Nothing,
                                    updateTime = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1UserCreds where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1UserCreds"
              (\ o ->
                 GoogleFirestoreAdminV1UserCreds Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "resourceIdentity")
                     Core.<*> (o Core..:? "securePassword")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "updateTime"))

instance Core.ToJSON GoogleFirestoreAdminV1UserCreds where
        toJSON GoogleFirestoreAdminV1UserCreds{..}
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("name" Core..=) Core.<$> name,
                  ("resourceIdentity" Core..=) Core.<$> resourceIdentity,
                  ("securePassword" Core..=) Core.<$> securePassword,
                  ("state" Core..=) Core.<$> state,
                  ("updateTime" Core..=) Core.<$> updateTime])
...
newGoogleFirestoreAdminV1VectorConfig 
    :: 
                                      GoogleFirestoreAdminV1VectorConfig
newGoogleFirestoreAdminV1VectorConfig
  = GoogleFirestoreAdminV1VectorConfig{dimension = Core.Nothing,
                                       flat = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1VectorConfig where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1VectorConfig"
              (\ o ->
                 GoogleFirestoreAdminV1VectorConfig Core.<$>
                   (o Core..:? "dimension") Core.<*> (o Core..:? "flat"))
...
instance Core.FromJSON GoogleFirestoreAdminV1WeeklyRecurrence where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1WeeklyRecurrence"
              (\ o ->
...
newGoogleLongrunningCancelOperationRequest
  = GoogleLongrunningCancelOperationRequest
instance Core.FromJSON GoogleLongrunningCancelOperationRequest
         where
        parseJSON
          = Core.withObject "GoogleLongrunningCancelOperationRequest"
...
newListCollectionIdsRequest 
    ::  ListCollectionIdsRequest
newListCollectionIdsRequest
  = ListCollectionIdsRequest{pageSize = Core.Nothing,
                             pageToken = Core.Nothing, readTime = Core.Nothing}
          ...
          = Core.withObject "ListCollectionIdsRequest"
              (\ o ->
                 ListCollectionIdsRequest Core.<$>
                   (o Core..:? "pageSize") Core.<*> (o Core..:? "pageToken") Core.<*>
                     (o Core..:? "readTime"))
...
newListCollectionIdsResponse 
    ::  ListCollectionIdsResponse
newListCollectionIdsResponse
  = ListCollectionIdsResponse{collectionIds = Core.Nothing,
                              nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListCollectionIdsResponse"
              (\ o ->
                 ListCollectionIdsResponse Core.<$>
                   (o Core..:? "collectionIds") Core.<*> (o Core..:? "nextPageToken"))
...
newListDocumentsResponse 
    ::  ListDocumentsResponse
newListDocumentsResponse
  = ListDocumentsResponse{documents = Core.Nothing,
                          nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListDocumentsResponse"
              (\ o ->
                 ListDocumentsResponse Core.<$>
                   (o Core..:? "documents") Core.<*> (o Core..:? "nextPageToken"))
...
newListenRequest 
    ::  ListenRequest
newListenRequest
  = ListenRequest{addTarget = Core.Nothing, labels = Core.Nothing,
...
instance Core.FromJSON ListenRequest where
        parseJSON
          = Core.withObject "ListenRequest"
              (\ o ->
                 ListenRequest Core.<$>
                   (o Core..:? "addTarget") Core.<*> (o Core..:? "labels") Core.<*>
                     (o Core..:? "removeTarget"))
...
newListenResponse 
    ::  ListenResponse
newListenResponse
  = ListenResponse{documentChange = Core.Nothing,
                   documentDelete = Core.Nothing, documentRemove = Core.Nothing,
                   filter = Core.Nothing, targetChange = Core.Nothing}
...
instance Core.FromJSON Order where
        parseJSON
          = Core.withObject "Order"
              (\ o ->
                 Order Core.<$>
                   (o Core..:? "direction") Core.<*> (o Core..:? "field"))
...
newPartitionQueryRequest 
    ::  PartitionQueryRequest
newPartitionQueryRequest
  = PartitionQueryRequest{pageSize = Core.Nothing,
                          pageToken = Core.Nothing, partitionCount = Core.Nothing,
                          readTime = Core.Nothing, structuredQuery = Core.Nothing}
          ...
          = Core.withObject "PartitionQueryRequest"
              (\ o ->
                 PartitionQueryRequest Core.<$>
                   (o Core..:? "pageSize") Core.<*> (o Core..:? "pageToken") Core.<*>
                     (o Core..:? "partitionCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "readTime")
        ...
        toJSON PartitionQueryRequest{..}
          = Core.object
              (Core.catMaybes
                 [("pageSize" Core..=) Core.<$> pageSize,
                  ("pageToken" Core..=) Core.<$> pageToken,
                  ("partitionCount" Core..=) Core.. Core.AsText Core.<$>
                    partitionCount,
                  ("readTime" Core..=) Core.<$> readTime,
...
newPartitionQueryResponse 
    ::  PartitionQueryResponse
newPartitionQueryResponse
  = PartitionQueryResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "PartitionQueryResponse"
              (\ o ->
                 PartitionQueryResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "partitions"))
...
instance Core.FromJSON PlanSummary_IndexesUsedItem where
        parseJSON
          = Core.withObject "PlanSummary_IndexesUsedItem"
              (\ o ->
...
instance Core.FromJSON Precondition where
        parseJSON
          = Core.withObject "Precondition"
              (\ o ->
                 Precondition Core.<$>
                   (o Core..:? "exists") Core.<*> (o Core..:? "updateTime"))
...
newQueryTarget 
    ::  QueryTarget
newQueryTarget
  = QueryTarget{parent = Core.Nothing,
...
instance Core.FromJSON QueryTarget where
        parseJSON
          = Core.withObject "QueryTarget"
              (\ o ->
                 QueryTarget Core.<$>
                   (o Core..:? "parent") Core.<*> (o Core..:? "structuredQuery"))
...
newRunAggregationQueryRequest 
    ::  RunAggregationQueryRequest
newRunAggregationQueryRequest
  = RunAggregationQueryRequest{explainOptions = Core.Nothing,
                               newTransaction' = Core.Nothing, readTime = Core.Nothing,
                               structuredAggregationQuery = Core.Nothing,
                               transaction = Core.Nothing}
instance Core.FromJSON RunAggregationQueryRequest where
        parseJSON
          = Core.withObject "RunAggregationQueryRequest"
              (\ o ->
                 RunAggregationQueryRequest Core.<$>
                   (o Core..:? "explainOptions") Core.<*>
                     (o Core..:? "newTransaction")
                     Core.<*> (o Core..:? "readTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("explainOptions" Core..=) Core.<$> explainOptions,
                  ("newTransaction" Core..=) Core.<$> newTransaction',
                  ("readTime" Core..=) Core.<$> readTime,
                  ("structuredAggregationQuery" Core..=) Core.<$>
                    structuredAggregationQuery,
                  ("transaction" Core..=) Core.<$> transaction])
...
newRunAggregationQueryResponse 
    ::  RunAggregationQueryResponse
newRunAggregationQueryResponse
  = RunAggregationQueryResponse{explainMetrics = Core.Nothing,
                                readTime = Core.Nothing, result = Core.Nothing,
                                transaction = Core.Nothing}
instance Core.FromJSON RunAggregationQueryResponse where
        parseJSON
          = Core.withObject "RunAggregationQueryResponse"
              (\ o ->
                 RunAggregationQueryResponse Core.<$>
                   (o Core..:? "explainMetrics") Core.<*> (o Core..:? "readTime")
                     Core.<*> (o Core..:? "result")
                     Core.<*> (o Core..:? "transaction"))
...
newRunQueryRequest 
    ::  RunQueryRequest
newRunQueryRequest
  = RunQueryRequest{explainOptions = Core.Nothing,
                    newTransaction' = Core.Nothing, readTime = Core.Nothing,
                    structuredQuery = Core.Nothing, transaction = Core.Nothing}
...
newRunQueryResponse 
    ::  RunQueryResponse
newRunQueryResponse
  = RunQueryResponse{document = Core.Nothing, done = Core.Nothing,
                     explainMetrics = Core.Nothing, readTime = Core.Nothing,
                     skippedResults = Core.Nothing, transaction = Core.Nothing}
instance Core.FromJSON RunQueryResponse where
        parseJSON
          = Core.withObject "RunQueryResponse"
              (\ o ->
                 RunQueryResponse Core.<$>
                   (o Core..:? "document") Core.<*> (o Core..:? "done") Core.<*>
                     (o Core..:? "explainMetrics")
                     Core.<*> (o Core..:? "readTime")
...
newStructuredAggregationQuery 
    ::  StructuredAggregationQuery
newStructuredAggregationQuery
  = StructuredAggregationQuery{aggregations = Core.Nothing,
                               structuredQuery = Core.Nothing}
instance Core.FromJSON StructuredAggregationQuery where
        parseJSON
          = Core.withObject "StructuredAggregationQuery"
              (\ o ->
                 StructuredAggregationQuery Core.<$>
                   (o Core..:? "aggregations") Core.<*>
...
newStructuredQuery 
    ::  StructuredQuery
newStructuredQuery
  = StructuredQuery{endAt = Core.Nothing, findNearest = Core.Nothing,
                    from = Core.Nothing, limit = Core.Nothing, offset = Core.Nothing,
                    orderBy = Core.Nothing, select = Core.Nothing,
                    startAt = Core.Nothing, where' = Core.Nothing}
instance Core.FromJSON StructuredQuery where
        parseJSON
          = Core.withObject "StructuredQuery"
              (\ o ->
                 StructuredQuery Core.<$>
                   (o Core..:? "endAt") Core.<*> (o Core..:? "findNearest") Core.<*>
                     (o Core..:? "from")
                     Core.<*> (o Core..:? "limit")
                     Core.<*> (o Core..:? "offset")
                     Core.<*> (o Core..:? "orderBy")
          ...
          = Core.object
              (Core.catMaybes
                 [("endAt" Core..=) Core.<$> endAt,
                  ...
                  ("from" Core..=) Core.<$> from, ("limit" Core..=) Core.<$> limit,
...
newTarget 
    ::  Target
newTarget
  = Target{documents = Core.Nothing, expectedCount = Core.Nothing,
           once = Core.Nothing, query = Core.Nothing, readTime = Core.Nothing,
           resumeToken = Core.Nothing, targetId = Core.Nothing}
instance Core.FromJSON Target where
        parseJSON
          = Core.withObject "Target"
              (\ o ->
                 Target Core.<$>
                   (o Core..:? "documents") Core.<*> (o Core..:? "expectedCount")
                     Core.<*> (o Core..:? "once")
                     Core.<*> (o Core..:? "query")
                     Core.<*> (o Core..:? "readTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("documents" Core..=) Core.<$> documents,
                  ...
                  ("once" Core..=) Core.<$> once, ("query" Core..=) Core.<$> query,
                  ("readTime" Core..=) Core.<$> readTime,
...
newTargetChange 
    ::  TargetChange
newTargetChange
  = TargetChange{cause = Core.Nothing, readTime = Core.Nothing,
                 resumeToken = Core.Nothing, targetChangeType = Core.Nothing,
...
instance Core.FromJSON TargetChange where
        parseJSON
          = Core.withObject "TargetChange"
              (\ o ->
                 TargetChange Core.<$>
                   (o Core..:? "cause") Core.<*> (o Core..:? "readTime") Core.<*>
                     (o Core..:? "resumeToken")
...
newTransactionOptions 
    ::  TransactionOptions
newTransactionOptions
  = TransactionOptions{readOnly = Core.Nothing,
          ...
          = Core.withObject "TransactionOptions"
              (\ o ->
                 TransactionOptions Core.<$>
                   (o Core..:? "readOnly") Core.<*> (o Core..:? "readWrite"))
...
newValue 
    ::  Value
newValue
  = Value{arrayValue = Core.Nothing, booleanValue = Core.Nothing,
          bytesValue = Core.Nothing, doubleValue = Core.Nothing,
          geoPointValue = Core.Nothing, integerValue = Core.Nothing,
          mapValue = Core.Nothing, nullValue = Core.Nothing,
          referenceValue = Core.Nothing, stringValue = Core.Nothing,
...
instance Core.FromJSON Value where
        parseJSON
          = Core.withObject "Value"
              (\ o ->
                 Value Core.<$>
                   (o Core..:? "arrayValue") Core.<*> (o Core..:? "booleanValue")
...
newWrite 
    ::  Write
newWrite
  = Write{currentDocument = Core.Nothing, delete = Core.Nothing,
          transform = Core.Nothing, update = Core.Nothing,
          updateMask = Core.Nothing, updateTransforms = Core.Nothing}
instance Core.FromJSON Write where
        parseJSON
          = Core.withObject "Write"
              (\ o ->
                 Write Core.<$>
                   (o Core..:? "currentDocument") Core.<*> (o Core..:? "delete")
...
newWriteRequest 
    ::  WriteRequest
newWriteRequest
  = WriteRequest{labels = Core.Nothing, streamId = Core.Nothing,
                 streamToken = Core.Nothing, writes = Core.Nothing}
instance Core.FromJSON WriteRequest where
        parseJSON
          = Core.withObject "WriteRequest"
              (\ o ->
                 WriteRequest Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "streamId") Core.<*>
                     (o Core..:? "streamToken")
                     Core.<*> (o Core..:? "writes"))
...
newWriteResponse 
    ::  WriteResponse
newWriteResponse
  = WriteResponse{commitTime = Core.Nothing, streamId = Core.Nothing,
                  streamToken = Core.Nothing, writeResults = Core.Nothing}
instance Core.FromJSON WriteResponse where
        parseJSON
          = Core.withObject "WriteResponse"
              (\ o ->
                 WriteResponse Core.<$>
                   (o Core..:? "commitTime") Core.<*> (o Core..:? "streamId") Core.<*>
                     (o Core..:? "streamToken")
...
newWriteResult 
    ::  WriteResult
newWriteResult
  = WriteResult{transformResults = Core.Nothing,
                updateTime = Core.Nothing}
instance Core.FromJSON WriteResult where
        parseJSON
          = Core.withObject "WriteResult"
              (\ o ->
                 WriteResult Core.<$>
                   (o Core..:? "transformResults") Core.<*> (o Core..:? "updateTime"))
