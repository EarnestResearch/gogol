          ...
          = Core.withObject "BatchGetDocumentsRequest"
              (\ o ->
                 BatchGetDocumentsRequest Core.<$>
                   (o Core..:? "documents") Core.<*> (o Core..:? "mask")
...
newBitSequence 
    ::  BitSequence
newBitSequence = BitSequence {bitmap = Core.Nothing, padding = Core.Nothing}
...
newBloomFilter 
    ::  BloomFilter
newBloomFilter = BloomFilter {bits = Core.Nothing, hashCount = Core.Nothing}
...
newDocument_Fields 
    ::  Core.HashMap Core.Text Value
       -- ^  See 'additional'.
    -> Document_Fields
newDocument_Fields additional = Document_Fields {additional = additional}
          ...
          = Core.withObject "ExistenceFilter"
              (\ o ->
                 ExistenceFilter Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "targetId")
...
instance Core.FromJSON GoogleFirestoreAdminV1Backup
         where
        parseJSON
...
instance Core.ToJSON GoogleFirestoreAdminV1Backup
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleFirestoreAdminV1DailyRecurrence"
              (\ o ->
                 Core.pure GoogleFirestoreAdminV1DailyRecurrence)
          ...
          = Core.object
              (Core.catMaybes
                 [("appEngineIntegrationMode" Core..=) Core.<$>
                  ...
                  ("createTime" Core..=) Core.<$> createTime,
                  ("deleteProtectionState" Core..=) Core.<$>
...
newGoogleFirestoreAdminV1Field =
  GoogleFirestoreAdminV1Field
    {indexConfig = Core.Nothing, name = Core.Nothing, ttlConfig = Core.Nothing}
...
newGoogleFirestoreAdminV1ListBackupsResponse =
  GoogleFirestoreAdminV1ListBackupsResponse
    {backups = Core.Nothing, unreachable = Core.Nothing}
...
newGoogleFirestoreAdminV1RestoreDatabaseRequest =
  GoogleFirestoreAdminV1RestoreDatabaseRequest
    {backup = Core.Nothing, databaseId = Core.Nothing}
...
instance Core.FromJSON GoogleFirestoreAdminV1Stats
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1Stats"
              (\ o ->
                 GoogleFirestoreAdminV1Stats Core.<$>
                   (o Core..:? "documentCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "indexCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "sizeBytes" Core.<&>
                        Core.fmap Core.fromAsText))

instance Core.ToJSON GoogleFirestoreAdminV1Stats
         where
        toJSON GoogleFirestoreAdminV1Stats{..}
          = Core.object
              (Core.catMaybes
                 [("documentCount" Core..=) Core.. Core.AsText
                    Core.<$> documentCount,
                  ("indexCount" Core..=) Core.. Core.AsText Core.<$>
                    indexCount,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1TtlConfig"
              (\ o ->
                 GoogleFirestoreAdminV1TtlConfig Core.<$>
                   (o Core..:? "state"))

instance Core.ToJSON GoogleFirestoreAdminV1TtlConfig
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleFirestoreAdminV1WeeklyRecurrence"
              (\ o ->
                 GoogleFirestoreAdminV1WeeklyRecurrence Core.<$>
                   (o Core..:? "day"))
...
instance Core.ToJSON
        ...
        toJSON GoogleFirestoreAdminV1WeeklyRecurrence{..}
          = Core.object
              (Core.catMaybes [("day" Core..=) Core.<$> day])
...
newListCollectionIdsRequest =
  ListCollectionIdsRequest
    {pageSize = Core.Nothing, pageToken = Core.Nothing, readTime = Core.Nothing}
...
newMapValue_Fields 
    ::  Core.HashMap Core.Text Value
       -- ^  See 'additional'.
    -> MapValue_Fields
newMapValue_Fields additional = MapValue_Fields {additional = additional}
...
newRunAggregationQueryResponse =
  RunAggregationQueryResponse
    {readTime = Core.Nothing, result = Core.Nothing, transaction = Core.Nothing}
...
newStructuredAggregationQuery =
  StructuredAggregationQuery
    {aggregations = Core.Nothing, structuredQuery = Core.Nothing}

instance Core.FromJSON StructuredAggregationQuery
         where
        parseJSON
