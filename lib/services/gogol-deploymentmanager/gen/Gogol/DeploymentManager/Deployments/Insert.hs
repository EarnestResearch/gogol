                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] Deployment Core.:>
...
instance Core.GoogleRequest
           DeploymentManagerDeploymentsInsert
         where
        type Rs DeploymentManagerDeploymentsInsert =
             Operation
        type Scopes DeploymentManagerDeploymentsInsert =
             '[CloudPlatform'FullControl, Ndev'Cloudman]
        requestClient DeploymentManagerDeploymentsInsert{..}
          = go project xgafv accessToken callback
