...
module Gogol.DeploymentManager.Internal.Product
  (
    ...
    SetAutoscalerLinkOperationMetadata (..),
    newSetAutoscalerLinkOperationMetadata,
...
newBulkInsertOperationStatus 
    ::  BulkInsertOperationStatus
newBulkInsertOperationStatus
  = BulkInsertOperationStatus{createdVmCount = Core.Nothing,
                              deletedVmCount = Core.Nothing,
                              failedToCreateVmCount = Core.Nothing, status = Core.Nothing,
                              targetVmCount = Core.Nothing}
instance Core.FromJSON BulkInsertOperationStatus where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("createdVmCount" Core..=) Core.<$> createdVmCount,
                  ...
                  ("failedToCreateVmCount" Core..=) Core.<$> failedToCreateVmCount,
...
newDebugInfo 
    ::  DebugInfo
newDebugInfo
  = DebugInfo{detail = Core.Nothing, stackEntries = Core.Nothing}
instance Core.FromJSON DebugInfo where
        parseJSON
          = Core.withObject "DebugInfo"
              (\ o ->
                 DebugInfo Core.<$>
                   (o Core..:? "detail") Core.<*> (o Core..:? "stackEntries"))
...
newDeployment 
    ::  Deployment
newDeployment
  = Deployment{description = Core.Nothing,
               fingerprint = Core.Nothing, id = Core.Nothing,
               insertTime = Core.Nothing, labels = Core.Nothing,
               manifest = Core.Nothing, name = Core.Nothing,
               operation = Core.Nothing, selfLink = Core.Nothing,
               target = Core.Nothing, update = Core.Nothing,
...
instance Core.FromJSON Deployment where
        parseJSON
          = Core.withObject "Deployment"
              (\ o ->
                 Deployment Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "fingerprint")
...
newDeploymentUpdate 
    ::  DeploymentUpdate
newDeploymentUpdate
  = DeploymentUpdate{description = Core.Nothing,
                     labels = Core.Nothing, manifest = Core.Nothing}
...
newDeploymentUpdateLabelEntry 
    ::  DeploymentUpdateLabelEntry
newDeploymentUpdateLabelEntry
  = DeploymentUpdateLabelEntry{key = Core.Nothing,
                               value = Core.Nothing}
...
instance Core.FromJSON DeploymentsCancelPreviewRequest where
        parseJSON
...
instance Core.ToJSON DeploymentsCancelPreviewRequest where
        toJSON DeploymentsCancelPreviewRequest{..}
          = Core.object
              (Core.catMaybes [("fingerprint" Core..=) Core.<$> fingerprint])
...
newDeploymentsListResponse 
    ::  DeploymentsListResponse
newDeploymentsListResponse
  = DeploymentsListResponse{deployments = Core.Nothing,
          ...
          = Core.withObject "DeploymentsListResponse"
              (\ o ->
                 DeploymentsListResponse Core.<$>
                   (o Core..:? "deployments") Core.<*> (o Core..:? "nextPageToken"))
...
newDeploymentsStopRequest 
    ::  DeploymentsStopRequest
newDeploymentsStopRequest
  = DeploymentsStopRequest{fingerprint = Core.Nothing}
instance Core.FromJSON DeploymentsStopRequest where
        parseJSON
          = Core.withObject "DeploymentsStopRequest"
              (\ o -> DeploymentsStopRequest Core.<$> (o Core..:? "fingerprint"))
...
newErrorInfo 
    ::  ErrorInfo
newErrorInfo
  = ErrorInfo{domain = Core.Nothing, metadatas = Core.Nothing,
              reason = Core.Nothing}
instance Core.FromJSON ErrorInfo where
        parseJSON
          = Core.withObject "ErrorInfo"
              (\ o ->
                 ErrorInfo Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "metadatas") Core.<*>
                     (o Core..:? "reason"))
...
instance Core.FromJSON ErrorInfo_Metadatas where
        parseJSON
          = Core.withObject "ErrorInfo_Metadatas"
              (\ o -> ErrorInfo_Metadatas Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON ErrorInfo_Metadatas where
        toJSON ErrorInfo_Metadatas{..} = Core.toJSON additional
...
newGlobalSetPolicyRequest 
    ::  GlobalSetPolicyRequest
newGlobalSetPolicyRequest
  = GlobalSetPolicyRequest{bindings = Core.Nothing,
                           etag = Core.Nothing, policy = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("bindings" Core..=) Core.<$> bindings,
                  ("etag" Core..=) Core.<$> etag, ("policy" Core..=) Core.<$> policy,
...
instance Core.ToJSON Help where
        toJSON Help{..}
          = Core.object (Core.catMaybes [("links" Core..=) Core.<$> links])
...
newHelpLink 
    ::  HelpLink
newHelpLink
  = HelpLink{description = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON HelpLink where
        parseJSON
          = Core.withObject "HelpLink"
              (\ o ->
                 HelpLink Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "url"))
...
newImportFile 
    ::  ImportFile
newImportFile
  = ImportFile{content = Core.Nothing, name = Core.Nothing}
...
data InstancesBulkInsertOperationMetadata = InstancesBulkInsertOperationMetadata
    {
...
newInstancesBulkInsertOperationMetadata 
    :: 
                                        InstancesBulkInsertOperationMetadata
newInstancesBulkInsertOperationMetadata
  = InstancesBulkInsertOperationMetadata{machineType = Core.Nothing,
                                         perLocationStatus = Core.Nothing}
instance Core.FromJSON InstancesBulkInsertOperationMetadata where
        parseJSON
          = Core.withObject "InstancesBulkInsertOperationMetadata"
              (\ o ->
                 InstancesBulkInsertOperationMetadata Core.<$>
                   (o Core..:? "machineType") Core.<*>
                     (o Core..:? "perLocationStatus"))

instance Core.ToJSON InstancesBulkInsertOperationMetadata where
        toJSON InstancesBulkInsertOperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("machineType" Core..=) Core.<$> machineType,
                  ("perLocationStatus" Core..=) Core.<$> perLocationStatus])
...
newInstancesBulkInsertOperationMetadata_PerLocationStatus
  additional
  = InstancesBulkInsertOperationMetadata_PerLocationStatus{additional
                                                             = additional}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "InstancesBulkInsertOperationMetadata_PerLocationStatus"
              (\ o ->
                 InstancesBulkInsertOperationMetadata_PerLocationStatus Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           InstancesBulkInsertOperationMetadata_PerLocationStatus
         where
        toJSON InstancesBulkInsertOperationMetadata_PerLocationStatus{..}
          ...
          = Core.withObject "LocalizedMessage"
              (\ o ->
                 LocalizedMessage Core.<$>
                   (o Core..:? "locale") Core.<*> (o Core..:? "message"))
...
newManifest 
    ::  Manifest
newManifest
  = Manifest{config = Core.Nothing, expandedConfig = Core.Nothing,
             id = Core.Nothing, imports = Core.Nothing,
             insertTime = Core.Nothing, layout = Core.Nothing,
             manifestSizeBytes = Core.Nothing,
             manifestSizeLimitBytes = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Manifest where
        parseJSON
          = Core.withObject "Manifest"
              (\ o ->
                 Manifest Core.<$>
                   (o Core..:? "config") Core.<*> (o Core..:? "expandedConfig")
                     Core.<*> (o Core..:? "id" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "imports")
                     Core.<*> (o Core..:? "insertTime")
                     Core.<*> (o Core..:? "layout")
                     Core.<*>
                     (o Core..:? "manifestSizeBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("config" Core..=) Core.<$> config,
                  ...
                  ("manifestSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    manifestSizeBytes,
                  ("manifestSizeLimitBytes" Core..=) Core.. Core.AsText Core.<$>
...
newManifestsListResponse 
    ::  ManifestsListResponse
newManifestsListResponse
  = ManifestsListResponse{manifests = Core.Nothing,
                          nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ManifestsListResponse"
              (\ o ->
                 ManifestsListResponse Core.<$>
                   (o Core..:? "manifests") Core.<*> (o Core..:? "nextPageToken"))
...
data Operation = Operation
    ...
    , setAutoscalerLinkOperationMetadata :: (Core.Maybe SetAutoscalerLinkOperationMetadata)
...
newOperation 
    ::  Operation
newOperation
  = Operation{clientOperationId = Core.Nothing,
              creationTimestamp = Core.Nothing, description = Core.Nothing,
              endTime = Core.Nothing, error = Core.Nothing,
              httpErrorMessage = Core.Nothing,
              httpErrorStatusCode = Core.Nothing, id = Core.Nothing,
              insertTime = Core.Nothing,
              instancesBulkInsertOperationMetadata = Core.Nothing,
              kind = "compute#operation", name = Core.Nothing,
              operationGroupId = Core.Nothing, operationType = Core.Nothing,
              progress = Core.Nothing, region = Core.Nothing,
              selfLink = Core.Nothing, selfLinkWithId = Core.Nothing,
              setAutoscalerLinkOperationMetadata = Core.Nothing,
              setCommonInstanceMetadataOperationMetadata = Core.Nothing,
              startTime = Core.Nothing, status = Core.Nothing,
              statusMessage = Core.Nothing, targetId = Core.Nothing,
              targetLink = Core.Nothing, user = Core.Nothing,
              warnings = Core.Nothing, zone = Core.Nothing}
              ...
              (\ o ->
                 Operation Core.<$>
                   (o Core..:? "clientOperationId") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "insertTime")
                     Core.<*> (o Core..:? "instancesBulkInsertOperationMetadata")
                     ...
                     Core.<*> (o Core..:? "setAutoscalerLinkOperationMetadata")
                     Core.<*> (o Core..:? "setCommonInstanceMetadataOperationMetadata")
                     Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "status")
                     Core.<*> (o Core..:? "statusMessage")
                     Core.<*> (o Core..:? "targetId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON Operation where
        toJSON Operation{..}
          = Core.object
              (Core.catMaybes
                 [("clientOperationId" Core..=) Core.<$> clientOperationId,
                  ("creationTimestamp" Core..=) Core.<$> creationTimestamp,
                  ("description" Core..=) Core.<$> description,
                  ("endTime" Core..=) Core.<$> endTime,
                  ("error" Core..=) Core.<$> error,
                  ("httpErrorMessage" Core..=) Core.<$> httpErrorMessage,
                  ("httpErrorStatusCode" Core..=) Core.<$> httpErrorStatusCode,
                  ("id" Core..=) Core.. Core.AsText Core.<$> id,
                  ("insertTime" Core..=) Core.<$> insertTime,
                  ("instancesBulkInsertOperationMetadata" Core..=) Core.<$>
                    instancesBulkInsertOperationMetadata,
                  ...
                  ("setAutoscalerLinkOperationMetadata" Core..=) Core.<$>
                    setAutoscalerLinkOperationMetadata,
                  ("setCommonInstanceMetadataOperationMetadata" Core..=) Core.<$>
                    setCommonInstanceMetadataOperationMetadata,
                  ("startTime" Core..=) Core.<$> startTime,
                  ("status" Core..=) Core.<$> status,
                  ("statusMessage" Core..=) Core.<$> statusMessage,
                  ("targetId" Core..=) Core.. Core.AsText Core.<$> targetId,
...
instance Core.FromJSON Operation_Error where
        parseJSON
          = Core.withObject "Operation_Error"
              (\ o -> Operation_Error Core.<$> (o Core..:? "errors"))
...
newOperation_Error_ErrorsItem 
    ::  Operation_Error_ErrorsItem
newOperation_Error_ErrorsItem
  = Operation_Error_ErrorsItem{arguments = Core.Nothing,
                               code = Core.Nothing, debugInfo = Core.Nothing,
                               errorDetails = Core.Nothing, location = Core.Nothing,
          ...
          = Core.withObject "Operation_Error_ErrorsItem"
              (\ o ->
                 Operation_Error_ErrorsItem Core.<$>
                   (o Core..:? "arguments") Core.<*> (o Core..:? "code") Core.<*>
                     (o Core..:? "debugInfo")
...
newOperation_Error_ErrorsItem_ErrorDetailsItem 
    :: 
                                               Operation_Error_ErrorsItem_ErrorDetailsItem
newOperation_Error_ErrorsItem_ErrorDetailsItem
  = Operation_Error_ErrorsItem_ErrorDetailsItem{errorInfo =
                                                  Core.Nothing,
                                                help = Core.Nothing,
                                                localizedMessage = Core.Nothing,
                                                quotaInfo = Core.Nothing}
instance Core.FromJSON Operation_Error_ErrorsItem_ErrorDetailsItem
         where
        parseJSON
          = Core.withObject "Operation_Error_ErrorsItem_ErrorDetailsItem"
              (\ o ->
                 Operation_Error_ErrorsItem_ErrorDetailsItem Core.<$>
                   (o Core..:? "errorInfo") Core.<*> (o Core..:? "help") Core.<*>
                     (o Core..:? "localizedMessage")
                     Core.<*> (o Core..:? "quotaInfo"))

instance Core.ToJSON Operation_Error_ErrorsItem_ErrorDetailsItem
         where
        toJSON Operation_Error_ErrorsItem_ErrorDetailsItem{..}
          = Core.object
              (Core.catMaybes
                 [("errorInfo" Core..=) Core.<$> errorInfo,
                  ("help" Core..=) Core.<$> help,
                  ("localizedMessage" Core..=) Core.<$> localizedMessage,
...
newOperation_WarningsItem 
    ::  Operation_WarningsItem
newOperation_WarningsItem
  = Operation_WarningsItem{code = Core.Nothing, data' = Core.Nothing,
                           message = Core.Nothing}
...
newOperation_WarningsItem_DataItem 
    :: 
                                   Operation_WarningsItem_DataItem
newOperation_WarningsItem_DataItem
  = Operation_WarningsItem_DataItem{key = Core.Nothing,
                                    value = Core.Nothing}
instance Core.FromJSON Operation_WarningsItem_DataItem where
        parseJSON
...
newOperationsListResponse 
    ::  OperationsListResponse
newOperationsListResponse
  = OperationsListResponse{nextPageToken = Core.Nothing,
...
newQuotaExceededInfo 
    ::  QuotaExceededInfo
newQuotaExceededInfo
  = QuotaExceededInfo{dimensions = Core.Nothing,
                      futureLimit = Core.Nothing, limit = Core.Nothing,
                      limitName = Core.Nothing, metricName = Core.Nothing,
          ...
          = Core.withObject "QuotaExceededInfo"
              (\ o ->
                 QuotaExceededInfo Core.<$>
                   (o Core..:? "dimensions") Core.<*> (o Core..:? "futureLimit")
                     Core.<*> (o Core..:? "limit")
...
instance Core.FromJSON QuotaExceededInfo_Dimensions where
        parseJSON
          = Core.withObject "QuotaExceededInfo_Dimensions"
              (\ o ->
                 QuotaExceededInfo_Dimensions Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON QuotaExceededInfo_Dimensions where
        toJSON QuotaExceededInfo_Dimensions{..} = Core.toJSON additional
...
newResource 
    ::  Resource
newResource
  = Resource{accessControl = Core.Nothing,
             finalProperties = Core.Nothing, id = Core.Nothing,
             insertTime = Core.Nothing, manifest = Core.Nothing,
             name = Core.Nothing, properties = Core.Nothing,
             type' = Core.Nothing, update = Core.Nothing,
             updateTime = Core.Nothing, url = Core.Nothing,
...
newResource_WarningsItem 
    ::  Resource_WarningsItem
newResource_WarningsItem
  = Resource_WarningsItem{code = Core.Nothing, data' = Core.Nothing,
                          message = Core.Nothing}
...
newResource_WarningsItem_DataItem 
    ::  Resource_WarningsItem_DataItem
newResource_WarningsItem_DataItem
  = Resource_WarningsItem_DataItem{key = Core.Nothing,
                                   value = Core.Nothing}
...
newResourceUpdate 
    ::  ResourceUpdate
newResourceUpdate
  = ResourceUpdate{accessControl = Core.Nothing,
                   error = Core.Nothing, finalProperties = Core.Nothing,
                   intent = Core.Nothing, manifest = Core.Nothing,
                   properties = Core.Nothing, state = Core.Nothing,
                   warnings = Core.Nothing}
instance Core.FromJSON ResourceUpdate where
        parseJSON
          = Core.withObject "ResourceUpdate"
              (\ o ->
                 ResourceUpdate Core.<$>
                   (o Core..:? "accessControl") Core.<*> (o Core..:? "error") Core.<*>
                     (o Core..:? "finalProperties")
                     Core.<*> (o Core..:? "intent")
                     Core.<*> (o Core..:? "manifest")
                     Core.<*> (o Core..:? "properties")
...
newResourceUpdate_Error_ErrorsItem 
    :: 
                                   ResourceUpdate_Error_ErrorsItem
newResourceUpdate_Error_ErrorsItem
  = ResourceUpdate_Error_ErrorsItem{arguments = Core.Nothing,
                                    code = Core.Nothing, debugInfo = Core.Nothing,
                                    errorDetails = Core.Nothing, location = Core.Nothing,
                                    message = Core.Nothing}
instance Core.FromJSON ResourceUpdate_Error_ErrorsItem where
        parseJSON
...
newResourceUpdate_Error_ErrorsItem_ErrorDetailsItem 
    :: 
                                                    ResourceUpdate_Error_ErrorsItem_ErrorDetailsItem
newResourceUpdate_Error_ErrorsItem_ErrorDetailsItem
  = ResourceUpdate_Error_ErrorsItem_ErrorDetailsItem{errorInfo =
                                                       Core.Nothing,
                                                     help = Core.Nothing,
                                                     localizedMessage = Core.Nothing,
                                                     quotaInfo = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ResourceUpdate_Error_ErrorsItem_ErrorDetailsItem"
              (\ o ->
                 ResourceUpdate_Error_ErrorsItem_ErrorDetailsItem Core.<$>
                   (o Core..:? "errorInfo") Core.<*> (o Core..:? "help") Core.<*>
                     (o Core..:? "localizedMessage")
                     Core.<*> (o Core..:? "quotaInfo"))
...
instance Core.ToJSON
           ResourceUpdate_Error_ErrorsItem_ErrorDetailsItem
         where
        toJSON ResourceUpdate_Error_ErrorsItem_ErrorDetailsItem{..}
          = Core.object
              (Core.catMaybes
                 [("errorInfo" Core..=) Core.<$> errorInfo,
                  ("help" Core..=) Core.<$> help,
...
newResourceUpdate_WarningsItem 
    ::  ResourceUpdate_WarningsItem
newResourceUpdate_WarningsItem
  = ResourceUpdate_WarningsItem{code = Core.Nothing,
...
newResourceUpdate_WarningsItem_DataItem 
    :: 
                                        ResourceUpdate_WarningsItem_DataItem
newResourceUpdate_WarningsItem_DataItem
  = ResourceUpdate_WarningsItem_DataItem{key = Core.Nothing,
                                         value = Core.Nothing}
instance Core.FromJSON ResourceUpdate_WarningsItem_DataItem where
        parseJSON
          = Core.withObject "ResourceUpdate_WarningsItem_DataItem"
              (\ o ->
                 ResourceUpdate_WarningsItem_DataItem Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "value"))

instance Core.ToJSON ResourceUpdate_WarningsItem_DataItem where
...
newResourcesListResponse 
    ::  ResourcesListResponse
newResourcesListResponse
  = ResourcesListResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ResourcesListResponse"
              (\ o ->
                 ResourcesListResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "resources"))
...
--
-- /See:/ 'newSetAutoscalerLinkOperationMetadata' smart constructor.
newtype SetAutoscalerLinkOperationMetadata = SetAutoscalerLinkOperationMetadata
    {
      -- | List of zonal IGM IDs part of the RMIG.
      zonalIgmIds :: (Core.Maybe [Core.Int64])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SetAutoscalerLinkOperationMetadata' with the minimum fields required to make a request.
newSetAutoscalerLinkOperationMetadata 
    :: 
                                      SetAutoscalerLinkOperationMetadata
newSetAutoscalerLinkOperationMetadata
  = SetAutoscalerLinkOperationMetadata{zonalIgmIds = Core.Nothing}
instance Core.FromJSON SetAutoscalerLinkOperationMetadata where
        parseJSON
          = Core.withObject "SetAutoscalerLinkOperationMetadata"
              (\ o ->
                 SetAutoscalerLinkOperationMetadata Core.<$>
                   (o Core..:? "zonalIgmIds" Core.<&>
                      Core.fmap (Core.fmap Core.fromAsText)))

instance Core.ToJSON SetAutoscalerLinkOperationMetadata where
        toJSON SetAutoscalerLinkOperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("zonalIgmIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    zonalIgmIds])
...
newSetCommonInstanceMetadataOperationMetadata
  = SetCommonInstanceMetadataOperationMetadata{clientOperationId =
                                                 Core.Nothing,
                                               perLocationOperations = Core.Nothing}
instance Core.FromJSON SetCommonInstanceMetadataOperationMetadata
         where
        parseJSON
          = Core.withObject "SetCommonInstanceMetadataOperationMetadata"
              (\ o ->
                 SetCommonInstanceMetadataOperationMetadata Core.<$>
                   (o Core..:? "clientOperationId") Core.<*>
                     (o Core..:? "perLocationOperations"))

instance Core.ToJSON SetCommonInstanceMetadataOperationMetadata
         where
        toJSON SetCommonInstanceMetadataOperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("clientOperationId" Core..=) Core.<$> clientOperationId,
                  ("perLocationOperations" Core..=) Core.<$> perLocationOperations])
...
newSetCommonInstanceMetadataOperationMetadata_PerLocationOperations
  additional
  = SetCommonInstanceMetadataOperationMetadata_PerLocationOperations{additional
                                                                       = additional}
instance Core.FromJSON
           SetCommonInstanceMetadataOperationMetadata_PerLocationOperations
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 SetCommonInstanceMetadataOperationMetadataPerLocationOperationInfo
                   Core.<$> (o Core..:? "error") Core.<*> (o Core..:? "state"))
...
newTargetConfiguration 
    ::  TargetConfiguration
newTargetConfiguration
  = TargetConfiguration{config = Core.Nothing,
          ...
          = Core.withObject "TargetConfiguration"
              (\ o ->
                 TargetConfiguration Core.<$>
                   (o Core..:? "config") Core.<*> (o Core..:? "imports"))
...
newTestPermissionsRequest 
    ::  TestPermissionsRequest
newTestPermissionsRequest
  = TestPermissionsRequest{permissions = Core.Nothing}
...
instance Core.FromJSON TestPermissionsResponse where
        parseJSON
          = Core.withObject "TestPermissionsResponse"
              (\ o ->
                 TestPermissionsResponse Core.<$> (o Core..:? "permissions"))
...
newType 
    ::  Type
newType
  = Type{id = Core.Nothing, insertTime = Core.Nothing,
...
newTypesListResponse 
    ::  TypesListResponse
newTypesListResponse
  = TypesListResponse{nextPageToken = Core.Nothing,
                      types = Core.Nothing}
          ...
          = Core.withObject "TypesListResponse"
              (\ o ->
                 TypesListResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "types"))
