...
instance Core.FromJSON AbsoluteDateRange where
        parseJSON
          = Core.withObject "AbsoluteDateRange"
              (\ o ->
...
instance Core.FromJSON AcceptProposalRequest where
        parseJSON
          = Core.withObject "AcceptProposalRequest"
              (\ o ->
                 AcceptProposalRequest Core.<$>
                   (o Core..:? "proposalRevision" Core.<&>
...
newAdTechnologyProviders =
  AdTechnologyProviders
    {detectedProviderIds = Core.Nothing, hasUnidentifiedProvider = Core.Nothing}

instance Core.FromJSON AdTechnologyProviders where
        parseJSON
          = Core.withObject "AdTechnologyProviders"
              (\ o ->
                 AdTechnologyProviders Core.<$>
                   (o Core..:? "detectedProviderIds" Core.<&>
...
instance Core.ToJSON AdTechnologyProviders where
        toJSON AdTechnologyProviders{..}
          = Core.object
              (Core.catMaybes
                 [("detectedProviderIds" Core..=) Core..
                    Core.fmap Core.AsText
                    Core.<$> detectedProviderIds,
                  ("hasUnidentifiedProvider" Core..=) Core.<$>
...
instance Core.FromJSON AddDealAssociationRequest
         where
        parseJSON
          = Core.withObject "AddDealAssociationRequest"
              (\ o ->
                 AddDealAssociationRequest Core.<$>
                   (o Core..:? "association"))
...
instance Core.FromJSON AddNoteRequest where
        parseJSON
          = Core.withObject "AddNoteRequest"
...
instance Core.FromJSON AuctionContext where
        parseJSON
          = Core.withObject "AuctionContext"
              (\ o ->
...
instance Core.FromJSON BidMetricsRow where
        parseJSON
          = Core.withObject "BidMetricsRow"
              (\ o ->
                 BidMetricsRow Core.<$>
                   (o Core..:? "bids") Core.<*>
                     (o Core..:? "bidsInAuction")
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "BidResponseWithoutBidsStatusRow"
              (\ o ->
                 BidResponseWithoutBidsStatusRow Core.<$>
                   (o Core..:? "impressionCount") Core.<*>
                     (o Core..:? "rowDimensions")
                     Core.<*> (o Core..:? "status"))

instance Core.ToJSON BidResponseWithoutBidsStatusRow
         where
        toJSON BidResponseWithoutBidsStatusRow{..}
          = Core.object
              (Core.catMaybes
                 [("impressionCount" Core..=) Core.<$>
                    impressionCount,
                  ("rowDimensions" Core..=) Core.<$> rowDimensions,
...
instance Core.FromJSON CalloutStatusRow where
        parseJSON
          = Core.withObject "CalloutStatusRow"
              (\ o ->
                 CalloutStatusRow Core.<$>
                   (o Core..:? "calloutStatusId") Core.<*>
                     (o Core..:? "impressionCount")
                     Core.<*> (o Core..:? "rowDimensions"))
...
instance Core.FromJSON CancelNegotiationRequest where
        parseJSON
          = Core.withObject "CancelNegotiationRequest"
          ...
          = Core.object
              (Core.catMaybes
                 [("clientAccountId" Core..=) Core.. Core.AsText
                  ...
                  ("entityId" Core..=) Core.. Core.AsText Core.<$>
                    entityId,
          ...
          = Core.object
              (Core.catMaybes
                 [("clientAccountId" Core..=) Core.. Core.AsText
                  ...
                  ("status" Core..=) Core.<$> status,
                  ("userId" Core..=) Core.. Core.AsText Core.<$>
                    userId])
...
instance Core.FromJSON ClientUserInvitation where
        parseJSON
          = Core.withObject "ClientUserInvitation"
              (\ o ->
                 ClientUserInvitation Core.<$>
                   (o Core..:? "clientAccountId" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "email")
                     Core.<*>
                     (o Core..:? "invitationId" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("clientAccountId" Core..=) Core.. Core.AsText
                    Core.<$> clientAccountId,
                  ("email" Core..=) Core.<$> email,
                  ("invitationId" Core..=) Core.. Core.AsText Core.<$>
                    invitationId])
...
instance Core.FromJSON CompleteSetupRequest where
        parseJSON
          = Core.withObject "CompleteSetupRequest"
...
instance Core.FromJSON ContactInformation where
        parseJSON
          = Core.withObject "ContactInformation"
              (\ o ->
                 ContactInformation Core.<$>
...
newCorrection =
  Correction
    {contexts = Core.Nothing, details = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON Correction where
        parseJSON
          = Core.withObject "Correction"
              (\ o ->
                 Correction Core.<$>
                   (o Core..:? "contexts") Core.<*>
                     (o Core..:? "details")
                     Core.<*> (o Core..:? "type"))
              ...
              (\ o ->
                 Creative Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "detectedAdvertiserIds" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
...
instance Core.ToJSON Creative where
        toJSON Creative{..}
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("adChoicesDestinationUrl" Core..=) Core.<$>
                    adChoicesDestinationUrl,
                  ("adTechnologyProviders" Core..=) Core.<$>
                    adTechnologyProviders,
                  ("advertiserName" Core..=) Core.<$> advertiserName,
                  ("agencyId" Core..=) Core.. Core.AsText Core.<$>
                    agencyId,
                  ("apiUpdateTime" Core..=) Core.<$> apiUpdateTime,
                  ("attributes" Core..=) Core.<$> attributes,
                  ("clickThroughUrls" Core..=) Core.<$>
                    clickThroughUrls,
                  ("corrections" Core..=) Core.<$> corrections,
                  ("creativeId" Core..=) Core.<$> creativeId,
                  ("dealsStatus" Core..=) Core.<$> dealsStatus,
                  ("declaredClickThroughUrls" Core..=) Core.<$>
                    declaredClickThroughUrls,
                  ("detectedAdvertiserIds" Core..=) Core..
                    Core.fmap Core.AsText
                    Core.<$> detectedAdvertiserIds,
                  ("detectedDomains" Core..=) Core.<$> detectedDomains,
                  ("detectedLanguages" Core..=) Core.<$>
                    detectedLanguages,
                  ("detectedProductCategories" Core..=) Core.<$>
                    detectedProductCategories,
                  ("detectedSensitiveCategories" Core..=) Core.<$>
                    detectedSensitiveCategories,
                  ("html" Core..=) Core.<$> html,
                  ("impressionTrackingUrls" Core..=) Core.<$>
                    impressionTrackingUrls,
                  ("native" Core..=) Core.<$> native,
                  ("openAuctionStatus" Core..=) Core.<$>
                    openAuctionStatus,
                  ("restrictedCategories" Core..=) Core.<$>
                    restrictedCategories,
                  ("servingRestrictions" Core..=) Core.<$>
                    servingRestrictions,
...
instance Core.FromJSON CreativeDealAssociation where
        parseJSON
          = Core.withObject "CreativeDealAssociation"
              (\ o ->
                 CreativeDealAssociation Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "creativeId")
                     Core.<*> (o Core..:? "dealsId"))
...
instance Core.FromJSON CreativeRestrictions where
        parseJSON
          = Core.withObject "CreativeRestrictions"
              (\ o ->
                 CreativeRestrictions Core.<$>
                   (o Core..:? "creativeFormat") Core.<*>
                     (o Core..:? "creativeSpecifications")
          ...
          = Core.object
              (Core.catMaybes
                 [("creativeFormat" Core..=) Core.<$> creativeFormat,
                  ("creativeSpecifications" Core..=) Core.<$>
                    creativeSpecifications,
                  ("skippableAdType" Core..=) Core.<$>
                    skippableAdType])
...
instance Core.FromJSON CreativeSize where
        parseJSON
          = Core.withObject "CreativeSize"
              (\ o ->
                 CreativeSize Core.<$>
                   (o Core..:? "allowedFormats") Core.<*>
                     (o Core..:? "companionSizes")
...
newCreativeSpecification =
  CreativeSpecification
    {creativeCompanionSizes = Core.Nothing, creativeSize = Core.Nothing}

instance Core.FromJSON CreativeSpecification where
        parseJSON
          = Core.withObject "CreativeSpecification"
              (\ o ->
                 CreativeSpecification Core.<$>
                   (o Core..:? "creativeCompanionSizes") Core.<*>
                     (o Core..:? "creativeSize"))
...
instance Core.ToJSON CreativeSpecification where
        toJSON CreativeSpecification{..}
          = Core.object
              (Core.catMaybes
                 [("creativeCompanionSizes" Core..=) Core.<$>
...
instance Core.FromJSON CreativeStatusRow where
        parseJSON
          = Core.withObject "CreativeStatusRow"
              (\ o ->
                 CreativeStatusRow Core.<$>
                   (o Core..:? "bidCount") Core.<*>
                     (o Core..:? "creativeStatusId")
                     Core.<*> (o Core..:? "rowDimensions"))
...
newCriteriaTargeting =
  CriteriaTargeting
    {excludedCriteriaIds = Core.Nothing, targetedCriteriaIds = Core.Nothing}

instance Core.FromJSON CriteriaTargeting where
        parseJSON
          = Core.withObject "CriteriaTargeting"
              (\ o ->
                 CriteriaTargeting Core.<$>
                   (o Core..:? "excludedCriteriaIds" Core.<&>
                      Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*>
                     (o Core..:? "targetedCriteriaIds" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText)))
...
instance Core.ToJSON CriteriaTargeting where
        toJSON CriteriaTargeting{..}
          = Core.object
              (Core.catMaybes
                 [("excludedCriteriaIds" Core..=) Core..
                    Core.fmap Core.AsText
                    Core.<$> excludedCriteriaIds,
                  ("targetedCriteriaIds" Core..=) Core..
                    Core.fmap Core.AsText
...
newDayPart =
  DayPart
    {dayOfWeek = Core.Nothing, endTime = Core.Nothing, startTime = Core.Nothing}

instance Core.FromJSON DayPart where
        parseJSON
          = Core.withObject "DayPart"
              (\ o ->
                 DayPart Core.<$>
                   (o Core..:? "dayOfWeek") Core.<*>
                     (o Core..:? "endTime")
...
instance Core.FromJSON Deal where
        parseJSON
          = Core.withObject "Deal"
              (\ o ->
                 Deal Core.<$>
                   (o Core..:? "availableEndTime") Core.<*>
                     (o Core..:? "availableStartTime")
                     Core.<*> (o Core..:? "buyerPrivateData")
                     Core.<*> (o Core..:? "createProductId")
                     Core.<*>
                     (o Core..:? "createProductRevision" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "creativePreApprovalPolicy")
                     Core.<*> (o Core..:? "creativeRestrictions")
                     Core.<*>
                     (o Core..:? "creativeSafeFrameCompatibility")
                     Core.<*> (o Core..:? "dealId")
...
instance Core.ToJSON Deal where
        toJSON Deal{..}
          = Core.object
              (Core.catMaybes
                 [("availableEndTime" Core..=) Core.<$>
                    availableEndTime,
                  ("availableStartTime" Core..=) Core.<$>
                    availableStartTime,
                  ("buyerPrivateData" Core..=) Core.<$>
                    buyerPrivateData,
                  ("createProductId" Core..=) Core.<$> createProductId,
                  ("createProductRevision" Core..=) Core.. Core.AsText
                    Core.<$> createProductRevision,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("creativePreApprovalPolicy" Core..=) Core.<$>
                    creativePreApprovalPolicy,
                  ("creativeRestrictions" Core..=) Core.<$>
                    creativeRestrictions,
                  ("creativeSafeFrameCompatibility" Core..=) Core.<$>
                    creativeSafeFrameCompatibility,
                  ("dealId" Core..=) Core.<$> dealId,
                  ("dealServingMetadata" Core..=) Core.<$>
                    dealServingMetadata,
                  ...
                  ("programmaticCreativeSource" Core..=) Core.<$>
                    programmaticCreativeSource,
                  ("proposalId" Core..=) Core.<$> proposalId,
                  ("sellerContacts" Core..=) Core.<$> sellerContacts,
                  ("syndicationProduct" Core..=) Core.<$>
                    syndicationProduct,
                  ("targeting" Core..=) Core.<$> targeting,
                  ("targetingCriterion" Core..=) Core.<$>
                    targetingCriterion,
                  ("updateTime" Core..=) Core.<$> updateTime,
                  ("webPropertyCode" Core..=) Core.<$>
                    webPropertyCode])
...
instance Core.FromJSON DealPauseStatus where
        parseJSON
          = Core.withObject "DealPauseStatus"
              (\ o ->
                 DealPauseStatus Core.<$>
                   (o Core..:? "buyerPauseReason") Core.<*>
...
instance Core.FromJSON DealTerms where
        parseJSON
          = Core.withObject "DealTerms"
              (\ o ->
                 DealTerms Core.<$>
                   (o Core..:? "brandingType") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "estimatedGrossSpend")
                     Core.<*>
                     (o Core..:? "estimatedImpressionsPerDay" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("brandingType" Core..=) Core.<$> brandingType,
                  ("description" Core..=) Core.<$> description,
                  ("estimatedGrossSpend" Core..=) Core.<$>
                    estimatedGrossSpend,
                  ("estimatedImpressionsPerDay" Core..=) Core..
                    Core.AsText
                    Core.<$> estimatedImpressionsPerDay,
                  ("guaranteedFixedPriceTerms" Core..=) Core.<$>
                    guaranteedFixedPriceTerms,
                  ("nonGuaranteedAuctionTerms" Core..=) Core.<$>
                    nonGuaranteedAuctionTerms,
                  ("nonGuaranteedFixedPriceTerms" Core..=) Core.<$>
                    nonGuaranteedFixedPriceTerms,
...
instance Core.FromJSON DeliveryControl where
        parseJSON
          = Core.withObject "DeliveryControl"
              (\ o ->
                 DeliveryControl Core.<$>
                   (o Core..:? "creativeBlockingLevel") Core.<*>
                     (o Core..:? "deliveryRateType")
...
instance Core.ToJSON DeliveryControl where
        toJSON DeliveryControl{..}
          = Core.object
              (Core.catMaybes
                 [("creativeBlockingLevel" Core..=) Core.<$>
                    creativeBlockingLevel,
                  ("deliveryRateType" Core..=) Core.<$>
                    deliveryRateType,
...
instance Core.FromJSON FilterSet where
        parseJSON
          = Core.withObject "FilterSet"
              (\ o ->
                 FilterSet Core.<$>
                   (o Core..:? "absoluteDateRange") Core.<*>
                     (o Core..:? "breakdownDimensions")
                     Core.<*> (o Core..:? "creativeId")
                     Core.<*>
                     (o Core..:? "dealId" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON FilterSet where
        toJSON FilterSet{..}
          = Core.object
              (Core.catMaybes
                 [("absoluteDateRange" Core..=) Core.<$>
                    absoluteDateRange,
                  ("breakdownDimensions" Core..=) Core.<$>
                    breakdownDimensions,
                  ("creativeId" Core..=) Core.<$> creativeId,
                  ("dealId" Core..=) Core.. Core.AsText Core.<$>
                    dealId,
                  ...
                  ("publisherIdentifiers" Core..=) Core.<$>
                    publisherIdentifiers,
                  ("realtimeTimeRange" Core..=) Core.<$>
                    realtimeTimeRange,
                  ("relativeDateRange" Core..=) Core.<$>
                    relativeDateRange,
                  ("sellerNetworkIds" Core..=) Core.<$>
                    sellerNetworkIds,
                  ("timeSeriesGranularity" Core..=) Core.<$>
...
instance Core.FromJSON FilteredBidCreativeRow where
        parseJSON
          = Core.withObject "FilteredBidCreativeRow"
              (\ o ->
                 FilteredBidCreativeRow Core.<$>
                   (o Core..:? "bidCount") Core.<*>
                     (o Core..:? "creativeId")
                     Core.<*> (o Core..:? "rowDimensions"))
...
instance Core.FromJSON FilteredBidDetailRow where
        parseJSON
          = Core.withObject "FilteredBidDetailRow"
              (\ o ->
                 FilteredBidDetailRow Core.<$>
                   (o Core..:? "bidCount") Core.<*>
                     (o Core..:? "detail")
...
newFirstPartyMobileApplicationTargeting =
  FirstPartyMobileApplicationTargeting
    {excludedAppIds = Core.Nothing, targetedAppIds = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "FirstPartyMobileApplicationTargeting"
              (\ o ->
                 FirstPartyMobileApplicationTargeting Core.<$>
                   (o Core..:? "excludedAppIds") Core.<*>
                     (o Core..:? "targetedAppIds"))
...
instance Core.FromJSON GuaranteedFixedPriceTerms
         where
        parseJSON
          = Core.withObject "GuaranteedFixedPriceTerms"
              (\ o ->
                 GuaranteedFixedPriceTerms Core.<$>
                   (o Core..:? "fixedPrices") Core.<*>
                     (o Core..:? "guaranteedImpressions" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "guaranteedLooks" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "impressionCap" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minimumDailyLooks" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "percentShareOfVoice" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("fixedPrices" Core..=) Core.<$> fixedPrices,
                  ...
                  ("impressionCap" Core..=) Core.. Core.AsText Core.<$>
                    impressionCap,
...
newHtmlContent =
  HtmlContent
    {height = Core.Nothing, snippet = Core.Nothing, width = Core.Nothing}

instance Core.FromJSON HtmlContent where
        parseJSON
          = Core.withObject "HtmlContent"
              (\ o ->
                 HtmlContent Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "snippet")
                     Core.<*> (o Core..:? "width"))
...
instance Core.FromJSON ImpressionMetricsRow where
        parseJSON
          = Core.withObject "ImpressionMetricsRow"
              (\ o ->
                 ImpressionMetricsRow Core.<$>
                   (o Core..:? "availableImpressions") Core.<*>
                     (o Core..:? "bidRequests")
...
instance Core.ToJSON ImpressionMetricsRow where
        toJSON ImpressionMetricsRow{..}
          = Core.object
              (Core.catMaybes
                 [("availableImpressions" Core..=) Core.<$>
                    availableImpressions,
                  ("bidRequests" Core..=) Core.<$> bidRequests,
                  ("inventoryMatches" Core..=) Core.<$>
                    inventoryMatches,
                  ("responsesWithBids" Core..=) Core.<$>
                    responsesWithBids,
                  ("rowDimensions" Core..=) Core.<$> rowDimensions,
                  ("successfulResponses" Core..=) Core.<$>
                    successfulResponses])
...
instance Core.FromJSON InventorySizeTargeting where
        parseJSON
          = Core.withObject "InventorySizeTargeting"
              (\ o ->
                 InventorySizeTargeting Core.<$>
                   (o Core..:? "excludedInventorySizes") Core.<*>
                     (o Core..:? "targetedInventorySizes"))

instance Core.ToJSON InventorySizeTargeting where
        toJSON InventorySizeTargeting{..}
          = Core.object
              (Core.catMaybes
                 [("excludedInventorySizes" Core..=) Core.<$>
                    excludedInventorySizes,
                  ("targetedInventorySizes" Core..=) Core.<$>
...
newListBidMetricsResponse =
  ListBidMetricsResponse
    {bidMetricsRows = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListBidMetricsResponse where
        parseJSON
          = Core.withObject "ListBidMetricsResponse"
              (\ o ->
                 ListBidMetricsResponse Core.<$>
                   (o Core..:? "bidMetricsRows") Core.<*>
...
newListBidResponseErrorsResponse =
  ListBidResponseErrorsResponse
    {calloutStatusRows = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListBidResponseErrorsResponse
         where
        parseJSON
          = Core.withObject "ListBidResponseErrorsResponse"
              (\ o ->
                 ListBidResponseErrorsResponse Core.<$>
                   (o Core..:? "calloutStatusRows") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListBidResponseErrorsResponse
         where
        toJSON ListBidResponseErrorsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("calloutStatusRows" Core..=) Core.<$>
                    calloutStatusRows,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ListBidResponsesWithoutBidsResponse"
              (\ o ->
                 ListBidResponsesWithoutBidsResponse Core.<$>
                   (o Core..:? "bidResponseWithoutBidsStatusRows")
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ListClientUserInvitationsResponse"
              (\ o ->
                 ListClientUserInvitationsResponse Core.<$>
...
instance Core.FromJSON ListClientUsersResponse where
        parseJSON
          = Core.withObject "ListClientUsersResponse"
              (\ o ->
                 ListClientUsersResponse Core.<$>
...
newListCreativeStatusBreakdownByCreativeResponse =
  ListCreativeStatusBreakdownByCreativeResponse
    {filteredBidCreativeRows = Core.Nothing, nextPageToken = Core.Nothing}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 ListCreativeStatusBreakdownByCreativeResponse
                   Core.<$>
                   (o Core..:? "filteredBidCreativeRows") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("filteredBidCreativeRows" Core..=) Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ListCreativeStatusBreakdownByDetailResponse"
              (\ o ->
                 ListCreativeStatusBreakdownByDetailResponse Core.<$>
                   (o Core..:? "detailType") Core.<*>
                     (o Core..:? "filteredBidDetailRows")
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.object
              (Core.catMaybes
                 [("detailType" Core..=) Core.<$> detailType,
                  ("filteredBidDetailRows" Core..=) Core.<$>
...
instance Core.FromJSON ListCreativesResponse where
        parseJSON
          = Core.withObject "ListCreativesResponse"
              (\ o ->
                 ListCreativesResponse Core.<$>
                   (o Core..:? "creatives") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListDealAssociationsResponse =
  ListDealAssociationsResponse
    {associations = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListDealAssociationsResponse
         where
        parseJSON
          = Core.withObject "ListDealAssociationsResponse"
              (\ o ->
                 ListDealAssociationsResponse Core.<$>
                   (o Core..:? "associations") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListDealAssociationsResponse
         where
...
newListFilterSetsResponse =
  ListFilterSetsResponse
    {filterSets = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListFilterSetsResponse where
        parseJSON
          = Core.withObject "ListFilterSetsResponse"
              (\ o ->
                 ListFilterSetsResponse Core.<$>
                   (o Core..:? "filterSets") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ListFilteredBidRequestsResponse"
              (\ o ->
                 ListFilteredBidRequestsResponse Core.<$>
                   (o Core..:? "calloutStatusRows") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListFilteredBidRequestsResponse
         where
...
newListFilteredBidsResponse =
  ListFilteredBidsResponse
    {creativeStatusRows = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListFilteredBidsResponse where
        parseJSON
          = Core.withObject "ListFilteredBidsResponse"
              (\ o ->
                 ListFilteredBidsResponse Core.<$>
                   (o Core..:? "creativeStatusRows") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListImpressionMetricsResponse =
  ListImpressionMetricsResponse
    {impressionMetricsRows = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListImpressionMetricsResponse
         where
        parseJSON
          = Core.withObject "ListImpressionMetricsResponse"
              (\ o ->
                 ListImpressionMetricsResponse Core.<$>
                   (o Core..:? "impressionMetricsRows") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListImpressionMetricsResponse
         where
        toJSON ListImpressionMetricsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("impressionMetricsRows" Core..=) Core.<$>
...
instance Core.FromJSON ListLosingBidsResponse where
        parseJSON
          = Core.withObject "ListLosingBidsResponse"
              (\ o ->
                 ListLosingBidsResponse Core.<$>
                   (o Core..:? "creativeStatusRows") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ListNonBillableWinningBidsResponse"
              (\ o ->
                 ListNonBillableWinningBidsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "nonBillableWinningBidStatusRows"))
...
instance Core.ToJSON
        ...
        toJSON ListNonBillableWinningBidsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("nonBillableWinningBidStatusRows" Core..=) Core.<$>
...
instance Core.FromJSON ListProductsResponse where
        parseJSON
          = Core.withObject "ListProductsResponse"
              (\ o ->
                 ListProductsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "products"))
...
instance Core.FromJSON ListProposalsResponse where
        parseJSON
          = Core.withObject "ListProposalsResponse"
              (\ o ->
                 ListProposalsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "proposals"))
...
newListPublisherProfilesResponse =
  ListPublisherProfilesResponse
    {nextPageToken = Core.Nothing, publisherProfiles = Core.Nothing}

instance Core.FromJSON ListPublisherProfilesResponse
         where
        parseJSON
          = Core.withObject "ListPublisherProfilesResponse"
              (\ o ->
                 ListPublisherProfilesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "publisherProfiles"))

instance Core.ToJSON ListPublisherProfilesResponse
         where
        toJSON ListPublisherProfilesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("publisherProfiles" Core..=) Core.<$>
                    publisherProfiles])
...
instance Core.FromJSON LocationContext where
        parseJSON
          = Core.withObject "LocationContext"
              (\ o ->
                 LocationContext Core.<$>
                   (o Core..:? "geoCriteriaIds"))
...
instance Core.FromJSON MarketplaceTargeting where
        parseJSON
          = Core.withObject "MarketplaceTargeting"
              (\ o ->
                 MarketplaceTargeting Core.<$>
                   (o Core..:? "geoTargeting") Core.<*>
                     (o Core..:? "inventorySizeTargeting")
          ...
          = Core.object
              (Core.catMaybes
                 [("geoTargeting" Core..=) Core.<$> geoTargeting,
                  ("inventorySizeTargeting" Core..=) Core.<$>
                    inventorySizeTargeting,
                  ("placementTargeting" Core..=) Core.<$>
                    placementTargeting,
          ...
          = Core.object
              (Core.catMaybes
                 [("value" Core..=) Core.. Core.AsText Core.<$> value,
                  ("variance" Core..=) Core.. Core.AsText Core.<$>
                    variance])
...
instance Core.FromJSON MobileApplicationTargeting
         where
        parseJSON
          = Core.withObject "MobileApplicationTargeting"
              (\ o ->
                 MobileApplicationTargeting Core.<$>
                   (o Core..:? "firstPartyTargeting"))

instance Core.ToJSON MobileApplicationTargeting where
        toJSON MobileApplicationTargeting{..}
          = Core.object
              (Core.catMaybes
                 [("firstPartyTargeting" Core..=) Core.<$>
                    firstPartyTargeting])
...
instance Core.FromJSON NativeContent where
        parseJSON
          = Core.withObject "NativeContent"
              (\ o ->
                 NativeContent Core.<$>
                   (o Core..:? "advertiserName") Core.<*>
                     (o Core..:? "appIcon")
                     Core.<*> (o Core..:? "body")
...
instance Core.FromJSON NonBillableWinningBidStatusRow
         where
        parseJSON
          = Core.withObject "NonBillableWinningBidStatusRow"
              (\ o ->
                 NonBillableWinningBidStatusRow Core.<$>
                   (o Core..:? "bidCount") Core.<*>
                     (o Core..:? "rowDimensions")
                     Core.<*> (o Core..:? "status"))

instance Core.ToJSON NonBillableWinningBidStatusRow
         where
...
instance Core.FromJSON NonGuaranteedAuctionTerms
         where
        parseJSON
          = Core.withObject "NonGuaranteedAuctionTerms"
              (\ o ->
                 NonGuaranteedAuctionTerms Core.<$>
                   (o Core..:? "autoOptimizePrivateAuction") Core.<*>
                     (o Core..:? "reservePricesPerBuyer"))

instance Core.ToJSON NonGuaranteedAuctionTerms where
        toJSON NonGuaranteedAuctionTerms{..}
          = Core.object
              (Core.catMaybes
                 [("autoOptimizePrivateAuction" Core..=) Core.<$>
                    autoOptimizePrivateAuction,
                  ("reservePricesPerBuyer" Core..=) Core.<$>
...
instance Core.FromJSON NonGuaranteedFixedPriceTerms
         where
        parseJSON
          = Core.withObject "NonGuaranteedFixedPriceTerms"
              (\ o ->
                 NonGuaranteedFixedPriceTerms Core.<$>
                   (o Core..:? "fixedPrices"))

instance Core.ToJSON NonGuaranteedFixedPriceTerms
         where
...
instance Core.FromJSON OperatingSystemTargeting where
        parseJSON
          = Core.withObject "OperatingSystemTargeting"
              (\ o ->
                 OperatingSystemTargeting Core.<$>
                   (o Core..:? "operatingSystemCriteria") Core.<*>
                     (o Core..:? "operatingSystemVersionCriteria"))

instance Core.ToJSON OperatingSystemTargeting where
        toJSON OperatingSystemTargeting{..}
          = Core.object
              (Core.catMaybes
                 [("operatingSystemCriteria" Core..=) Core.<$>
                    operatingSystemCriteria,
                  ("operatingSystemVersionCriteria" Core..=) Core.<$>
...
newPauseProposalDealsRequest =
  PauseProposalDealsRequest
    {externalDealIds = Core.Nothing, reason = Core.Nothing}

instance Core.FromJSON PauseProposalDealsRequest
         where
        parseJSON
          = Core.withObject "PauseProposalDealsRequest"
              (\ o ->
                 PauseProposalDealsRequest Core.<$>
                   (o Core..:? "externalDealIds") Core.<*>
                     (o Core..:? "reason"))
...
instance Core.FromJSON PauseProposalRequest where
        parseJSON
          = Core.withObject "PauseProposalRequest"
              (\ o ->
...
newPlacementTargeting =
  PlacementTargeting
    {mobileApplicationTargeting = Core.Nothing, urlTargeting = Core.Nothing}

instance Core.FromJSON PlacementTargeting where
        parseJSON
          = Core.withObject "PlacementTargeting"
              (\ o ->
                 PlacementTargeting Core.<$>
                   (o Core..:? "mobileApplicationTargeting") Core.<*>
                     (o Core..:? "urlTargeting"))
...
instance Core.ToJSON PlacementTargeting where
        toJSON PlacementTargeting{..}
          = Core.object
              (Core.catMaybes
                 [("mobileApplicationTargeting" Core..=) Core.<$>
                    mobileApplicationTargeting,
...
instance Core.FromJSON PlatformContext where
        parseJSON
          = Core.withObject "PlatformContext"
              (\ o ->
...
newPricePerBuyer =
  PricePerBuyer
    {advertiserIds = Core.Nothing, buyer = Core.Nothing, price = Core.Nothing}

instance Core.FromJSON PricePerBuyer where
        parseJSON
          = Core.withObject "PricePerBuyer"
              (\ o ->
                 PricePerBuyer Core.<$>
                   (o Core..:? "advertiserIds") Core.<*>
                     (o Core..:? "buyer")
                     Core.<*> (o Core..:? "price"))
...
instance Core.FromJSON Proposal where
        parseJSON
          = Core.withObject "Proposal"
              (\ o ->
                 Proposal Core.<$>
                   (o Core..:? "billedBuyer") Core.<*>
                     (o Core..:? "buyer")
...
instance Core.FromJSON PublisherProfile where
        parseJSON
          = Core.withObject "PublisherProfile"
              (\ o ->
                 PublisherProfile Core.<$>
                   (o Core..:? "audienceDescription") Core.<*>
                     (o Core..:? "buyerPitchStatement")
...
instance Core.ToJSON PublisherProfile where
        toJSON PublisherProfile{..}
          = Core.object
              (Core.catMaybes
                 [("audienceDescription" Core..=) Core.<$>
                    audienceDescription,
                  ("buyerPitchStatement" Core..=) Core.<$>
                    buyerPitchStatement,
                  ("directDealsContact" Core..=) Core.<$>
                    directDealsContact,
                  ("displayName" Core..=) Core.<$> displayName,
                  ...
                  ("programmaticDealsContact" Core..=) Core.<$>
...
newPublisherProfileMobileApplication =
  PublisherProfileMobileApplication
    {appStore = Core.Nothing, externalAppId = Core.Nothing, name = Core.Nothing}

instance Core.FromJSON
           PublisherProfileMobileApplication
         where
        parseJSON
          = Core.withObject "PublisherProfileMobileApplication"
              (\ o ->
                 PublisherProfileMobileApplication Core.<$>
                   (o Core..:? "appStore") Core.<*>
                     (o Core..:? "externalAppId")
                     Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON RealtimeTimeRange where
        parseJSON
          = Core.withObject "RealtimeTimeRange"
              (\ o ->
                 RealtimeTimeRange Core.<$>
                   (o Core..:? "startTimestamp"))
...
instance Core.FromJSON RelativeDateRange where
        parseJSON
          = Core.withObject "RelativeDateRange"
              (\ o ->
                 RelativeDateRange Core.<$>
                   (o Core..:? "durationDays") Core.<*>
                     (o Core..:? "offsetDays"))
...
instance Core.FromJSON RemoveDealAssociationRequest
         where
        parseJSON
          = Core.withObject "RemoveDealAssociationRequest"
              (\ o ->
                 RemoveDealAssociationRequest Core.<$>
                   (o Core..:? "association"))

instance Core.ToJSON RemoveDealAssociationRequest
         where
...
instance Core.FromJSON ResumeProposalDealsRequest
         where
        parseJSON
          = Core.withObject "ResumeProposalDealsRequest"
              (\ o ->
                 ResumeProposalDealsRequest Core.<$>
                   (o Core..:? "externalDealIds"))
...
instance Core.FromJSON ResumeProposalRequest where
        parseJSON
          = Core.withObject "ResumeProposalRequest"
...
newRowDimensions =
  RowDimensions
    {publisherIdentifier = Core.Nothing, timeInterval = Core.Nothing}

instance Core.FromJSON RowDimensions where
        parseJSON
          = Core.withObject "RowDimensions"
              (\ o ->
                 RowDimensions Core.<$>
                   (o Core..:? "publisherIdentifier") Core.<*>
                     (o Core..:? "timeInterval"))
...
instance Core.FromJSON ServingContext where
        parseJSON
          = Core.withObject "ServingContext"
              (\ o ->
                 ServingContext Core.<$>
                   (o Core..:? "all") Core.<*> (o Core..:? "appType")
...
instance Core.FromJSON ServingRestriction where
        parseJSON
          = Core.withObject "ServingRestriction"
              (\ o ->
                 ServingRestriction Core.<$>
                   (o Core..:? "contexts") Core.<*>
                     (o Core..:? "disapproval")
...
instance Core.FromJSON StopWatchingCreativeRequest
         where
        parseJSON
          = Core.withObject "StopWatchingCreativeRequest"
              (\ o -> Core.pure StopWatchingCreativeRequest)

instance Core.ToJSON StopWatchingCreativeRequest
         where
        toJSON = Core.const Core.emptyObject
...
newTargetingCriteria =
  TargetingCriteria
    {exclusions = Core.Nothing, inclusions = Core.Nothing, key = Core.Nothing}

instance Core.FromJSON TargetingCriteria where
        parseJSON
          = Core.withObject "TargetingCriteria"
              (\ o ->
                 TargetingCriteria Core.<$>
                   (o Core..:? "exclusions") Core.<*>
                     (o Core..:? "inclusions")
                     Core.<*> (o Core..:? "key"))
...
instance Core.FromJSON TargetingValue where
        parseJSON
          = Core.withObject "TargetingValue"
              (\ o ->
                 TargetingValue Core.<$>
                   (o Core..:? "creativeSizeValue") Core.<*>
                     (o Core..:? "dayPartTargetingValue")
                     Core.<*>
                     (o Core..:? "longValue" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON TargetingValue where
        toJSON TargetingValue{..}
          = Core.object
              (Core.catMaybes
                 [("creativeSizeValue" Core..=) Core.<$>
                    creativeSizeValue,
                  ("dayPartTargetingValue" Core..=) Core.<$>
                    dayPartTargetingValue,
                  ("longValue" Core..=) Core.. Core.AsText Core.<$>
                    longValue,
          ...
          = Core.withObject "TechnologyTargeting"
              (\ o ->
                 TechnologyTargeting Core.<$>
                   (o Core..:? "deviceCapabilityTargeting") Core.<*>
                     (o Core..:? "deviceCategoryTargeting")
...
instance Core.ToJSON TechnologyTargeting where
        toJSON TechnologyTargeting{..}
          = Core.object
              (Core.catMaybes
                 [("deviceCapabilityTargeting" Core..=) Core.<$>
                    deviceCapabilityTargeting,
                  ("deviceCategoryTargeting" Core..=) Core.<$>
                    deviceCategoryTargeting,
                  ("operatingSystemTargeting" Core..=) Core.<$>
                    operatingSystemTargeting])
...
instance Core.FromJSON UrlTargeting where
        parseJSON
          = Core.withObject "UrlTargeting"
              (\ o ->
                 UrlTargeting Core.<$>
                   (o Core..:? "excludedUrls") Core.<*>
                     (o Core..:? "targetedUrls"))
...
instance Core.FromJSON VideoContent where
        parseJSON
          = Core.withObject "VideoContent"
              (\ o ->
                 VideoContent Core.<$>
                   (o Core..:? "videoUrl") Core.<*>
                     (o Core..:? "videoVastXml"))
...
newVideoTargeting =
  VideoTargeting
    {excludedPositionTypes = Core.Nothing, targetedPositionTypes = Core.Nothing}

instance Core.FromJSON VideoTargeting where
        parseJSON
          = Core.withObject "VideoTargeting"
              (\ o ->
                 VideoTargeting Core.<$>
                   (o Core..:? "excludedPositionTypes") Core.<*>
                     (o Core..:? "targetedPositionTypes"))

instance Core.ToJSON VideoTargeting where
        toJSON VideoTargeting{..}
          = Core.object
              (Core.catMaybes
                 [("excludedPositionTypes" Core..=) Core.<$>
                    excludedPositionTypes,
                  ("targetedPositionTypes" Core..=) Core.<$>
...
instance Core.FromJSON WatchCreativeRequest where
        parseJSON
          = Core.withObject "WatchCreativeRequest"
              (\ o ->
