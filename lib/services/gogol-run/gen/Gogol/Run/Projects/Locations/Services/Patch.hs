                     ...
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "validateOnly" Core.Bool Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] GoogleCloudRunV2Service Core.:>
...
newRunProjectsLocationsServicesPatch name payload
  = RunProjectsLocationsServicesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest RunProjectsLocationsServicesPatch where
        type Rs RunProjectsLocationsServicesPatch =
             GoogleLongrunningOperation
        type Scopes RunProjectsLocationsServicesPatch =
