               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudRunV2WorkerPool
...
newRunProjectsLocationsWorkerPoolsGet name
  = RunProjectsLocationsWorkerPoolsGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsWorkerPoolsGet
         where
        type Rs RunProjectsLocationsWorkerPoolsGet =
             GoogleCloudRunV2WorkerPool
        type Scopes RunProjectsLocationsWorkerPoolsGet =
