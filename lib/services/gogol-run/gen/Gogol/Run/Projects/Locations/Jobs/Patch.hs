                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "validateOnly" Core.Bool Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudRunV2Job Core.:>
...
instance Core.GoogleRequest
           RunProjectsLocationsJobsPatch
         where
        type Rs RunProjectsLocationsJobsPatch =
             GoogleLongrunningOperation
        type Scopes RunProjectsLocationsJobsPatch =
        ...
        requestClient RunProjectsLocationsJobsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsJobsPatchResource)
                      Core.mempty
