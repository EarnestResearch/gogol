                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "validateOnly" Core.Bool Core.:>
                       Core.QueryParam "workerPoolId" Core.Text Core.:>
...
newRunProjectsLocationsWorkerPoolsCreate parent payload
  = RunProjectsLocationsWorkerPoolsCreate{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          parent = parent, payload = payload,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                          validateOnly = Core.Nothing, workerPoolId = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsWorkerPoolsCreate
         where
        type Rs RunProjectsLocationsWorkerPoolsCreate =
             GoogleLongrunningOperation
        type Scopes RunProjectsLocationsWorkerPoolsCreate =
