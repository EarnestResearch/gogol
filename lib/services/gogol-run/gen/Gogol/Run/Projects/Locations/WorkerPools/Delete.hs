...
newRunProjectsLocationsWorkerPoolsDelete name
  = RunProjectsLocationsWorkerPoolsDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          etag = Core.Nothing, name = name,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                          validateOnly = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsWorkerPoolsDelete
         where
        type Rs RunProjectsLocationsWorkerPoolsDelete =
             GoogleLongrunningOperation
        type Scopes RunProjectsLocationsWorkerPoolsDelete =
