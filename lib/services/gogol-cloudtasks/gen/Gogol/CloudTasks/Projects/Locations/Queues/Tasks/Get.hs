...
newCloudTasksProjectsLocationsQueuesTasksGet name
  = CloudTasksProjectsLocationsQueuesTasksGet{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              name = name, responseView = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudTasksProjectsLocationsQueuesTasksGet =
             '[CloudPlatform'FullControl]
        requestClient CloudTasksProjectsLocationsQueuesTasksGet{..}
          = go name xgafv accessToken callback responseView uploadType
              uploadProtocol
