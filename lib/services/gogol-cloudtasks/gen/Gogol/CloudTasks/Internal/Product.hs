...
newAppEngineHttpRequest 
    ::  AppEngineHttpRequest
newAppEngineHttpRequest
  = AppEngineHttpRequest{appEngineRouting = Core.Nothing,
...
newAttempt 
    ::  Attempt
newAttempt
  = Attempt{dispatchTime = Core.Nothing,
            responseStatus = Core.Nothing, responseTime = Core.Nothing,
...
instance Core.FromJSON Attempt where
        parseJSON
          = Core.withObject "Attempt"
              (\ o ->
                 Attempt Core.<$>
                   (o Core..:? "dispatchTime") Core.<*> (o Core..:? "responseStatus")
...
instance Core.FromJSON BufferTaskRequest where
        parseJSON
          = Core.withObject "BufferTaskRequest"
...
instance Core.FromJSON BufferTaskResponse where
        parseJSON
          = Core.withObject "BufferTaskResponse"
...
instance Core.FromJSON CmekConfig where
        parseJSON
          = Core.withObject "CmekConfig"
              (\ o ->
                 CmekConfig Core.<$>
                   (o Core..:? "kmsKey") Core.<*> (o Core..:? "name"))
...
newCreateTaskRequest 
    ::  CreateTaskRequest
newCreateTaskRequest
  = CreateTaskRequest{responseView = Core.Nothing,
                      task = Core.Nothing}
          ...
          = Core.withObject "CreateTaskRequest"
              (\ o ->
                 CreateTaskRequest Core.<$>
                   (o Core..:? "responseView") Core.<*> (o Core..:? "task"))
...
instance Core.FromJSON HeaderOverride where
        parseJSON
          = Core.withObject "HeaderOverride"
...
newHttpRequest 
    ::  HttpRequest
newHttpRequest
  = HttpRequest{body = Core.Nothing, headers = Core.Nothing,
                httpMethod = Core.Nothing, oauthToken = Core.Nothing,
                oidcToken = Core.Nothing, url = Core.Nothing}
...
newHttpTarget 
    ::  HttpTarget
newHttpTarget
  = HttpTarget{headerOverrides = Core.Nothing,
               httpMethod = Core.Nothing, oauthToken = Core.Nothing,
               oidcToken = Core.Nothing, uriOverride = Core.Nothing}
instance Core.FromJSON HttpTarget where
        parseJSON
          = Core.withObject "HttpTarget"
              (\ o ->
                 HttpTarget Core.<$>
                   (o Core..:? "headerOverrides") Core.<*> (o Core..:? "httpMethod")
                     Core.<*> (o Core..:? "oauthToken")
                     Core.<*> (o Core..:? "oidcToken")
...
newListQueuesResponse 
    ::  ListQueuesResponse
newListQueuesResponse
  = ListQueuesResponse{nextPageToken = Core.Nothing,
                       queues = Core.Nothing}
          ...
          = Core.withObject "ListQueuesResponse"
              (\ o ->
                 ListQueuesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "queues"))
...
newListTasksResponse 
    ::  ListTasksResponse
newListTasksResponse
  = ListTasksResponse{nextPageToken = Core.Nothing,
                      tasks = Core.Nothing}
...
newQueue 
    ::  Queue
newQueue
  = Queue{appEngineRoutingOverride = Core.Nothing,
          httpTarget = Core.Nothing, name = Core.Nothing,
          purgeTime = Core.Nothing, rateLimits = Core.Nothing,
          retryConfig = Core.Nothing,
          stackdriverLoggingConfig = Core.Nothing, state = Core.Nothing}
...
newRateLimits 
    ::  RateLimits
newRateLimits
  = RateLimits{maxBurstSize = Core.Nothing,
...
newRetryConfig 
    ::  RetryConfig
newRetryConfig
  = RetryConfig{maxAttempts = Core.Nothing,
                maxBackoff = Core.Nothing, maxDoublings = Core.Nothing,
                maxRetryDuration = Core.Nothing, minBackoff = Core.Nothing}
instance Core.FromJSON RetryConfig where
        parseJSON
          = Core.withObject "RetryConfig"
              (\ o ->
                 RetryConfig Core.<$>
                   (o Core..:? "maxAttempts") Core.<*> (o Core..:? "maxBackoff")
...
newTask 
    ::  Task
newTask
  = Task{appEngineHttpRequest = Core.Nothing,
         createTime = Core.Nothing, dispatchCount = Core.Nothing,
         dispatchDeadline = Core.Nothing, firstAttempt = Core.Nothing,
         httpRequest = Core.Nothing, lastAttempt = Core.Nothing,
         name = Core.Nothing, responseCount = Core.Nothing,
         scheduleTime = Core.Nothing, view = Core.Nothing}
...
newUriOverride 
    ::  UriOverride
newUriOverride
  = UriOverride{host = Core.Nothing, pathOverride = Core.Nothing,
                port = Core.Nothing, queryOverride = Core.Nothing,
                scheme = Core.Nothing, uriOverrideEnforceMode = Core.Nothing}
instance Core.FromJSON UriOverride where
        parseJSON
          = Core.withObject "UriOverride"
              (\ o ->
                 UriOverride Core.<$>
                   (o Core..:? "host") Core.<*> (o Core..:? "pathOverride") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("host" Core..=) Core.<$> host,
                  ...
                  ("uriOverrideEnforceMode" Core..=) Core.<$>
