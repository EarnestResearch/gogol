...
data AlertsBatchUndelete =
  AlertsBatchUndelete'
    ...
    , _abuPayload :: !GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsRequest
...
-- * 'abuCallback'
alertsBatchUndelete
    :: GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsRequest -- ^ 'abuPayload'
    -> AlertsBatchUndelete
...
abuPayload :: Lens' AlertsBatchUndelete GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsRequest
abuPayload
