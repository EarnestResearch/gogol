...
data AlertsBatchDelete =
  AlertsBatchDelete'
    ...
    , _abdPayload :: !GoogleAppsAlertcenterV1beta1BatchDeleteAlertsRequest
...
-- * 'abdCallback'
alertsBatchDelete
    :: GoogleAppsAlertcenterV1beta1BatchDeleteAlertsRequest -- ^ 'abdPayload'
    -> AlertsBatchDelete
...
abdPayload :: Lens' AlertsBatchDelete GoogleAppsAlertcenterV1beta1BatchDeleteAlertsRequest
abdPayload
