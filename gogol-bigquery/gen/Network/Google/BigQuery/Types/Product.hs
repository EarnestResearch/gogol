...
data JobStatistics =
  JobStatistics'
    ...
    , _jsSessionInfoTemplate :: !(Maybe SessionInfo)
...
jobStatistics =
  JobStatistics'
    ...
    , _jsSessionInfoTemplate = Nothing
...
-- of one.
jsSessionInfoTemplate :: Lens' JobStatistics (Maybe SessionInfo)
jsSessionInfoTemplate
  = lens _jsSessionInfoTemplate
      (\ s a -> s{_jsSessionInfoTemplate = a})
