...
-- | Cloud Run fully managed: supported A Cloud Secret Manager secret
...
-- | Cloud Run fully managed: supported The name of the secret in Cloud
...
-- An alias definition has the form: :projects\/\/secrets\/. If multiple
-- alias definitions are needed, they must be separated by commas. The
-- alias definitions must be set on the run.googleapis.com\/secrets
-- annotation. Cloud Run for Anthos: supported The name of the secret in
-- the pod\'s namespace to select from.
...
-- | (Optional) Cloud Run fully managed: supported. Selects a key (version)
...
-- | Cloud Run fully managed: supported The secret\'s value will be presented
-- as the content of a file whose name is defined in the item path. If no
-- items are defined, the name of the file is the secret_name. Cloud Run
-- for Anthos: supported The contents of the target Secret\'s Data field
-- will be presented in a volume as files using the keys in the Data field
-- as the file names.
--
...
-- will expose a file whose name is the secret_name. If specified, the key
-- will be used as the version to fetch from Cloud Secret Manager and the
...
-- container\'s filesystem. Only supports SecretVolumeSources. Cloud Run
...
-- | (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos:
-- not supported Startup probe of application within the container. All
...
-- within the container at which the volume should be mounted. Must not
-- contain \':\'.
...
-- | Cloud Run fully managed: supported Cloud Run for Anthos: supported Maps
...
-- relative path of the file to map the key to. May not be an absolute
