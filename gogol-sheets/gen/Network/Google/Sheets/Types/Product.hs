...
-- | The link destination of the text, if any. Setting a link in a format run
-- will clear an existing cell-level link. When a link is set, the text
-- foreground color will be set to the default link color and the text will
-- be underlined. If these fields are modified in the same request, those
