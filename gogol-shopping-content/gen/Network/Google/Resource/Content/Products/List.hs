...
data ProductsList =
  ProductsList'
    ...
    , _ppIncludeInvalidInsertedItems :: !(Maybe Bool)
...
productsList pPpMerchantId_ =
  ProductsList'
    ...
    , _ppIncludeInvalidInsertedItems = Nothing
...
-- is false).
ppIncludeInvalidInsertedItems :: Lens' ProductsList (Maybe Bool)
ppIncludeInvalidInsertedItems
  = lens _ppIncludeInvalidInsertedItems
      (\ s a -> s{_ppIncludeInvalidInsertedItems = a})
...
instance GoogleRequest ProductsList where
        ...
        requestClient ProductsList'{..}
          = go _ppMerchantId _ppXgafv _ppUploadProtocol
              _ppAccessToken
              _ppUploadType
              _ppIncludeInvalidInsertedItems
              _ppPageToken
              _ppMaxResults
              _ppCallback
              (Just AltJSON)
